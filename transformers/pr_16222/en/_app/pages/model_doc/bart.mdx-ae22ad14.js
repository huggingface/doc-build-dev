...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16222/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ia=new H({}),da=new q({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16222/src/transformers/models/bart/modeling_bart.py#L1265",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16222/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16222/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ha=new q({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16222/src/transformers/models/bart/modeling_bart.py#L1304",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16222/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16222/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16222/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16222/src/transformers/models/bart/modeling_flax_bart.py#L1320",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16222/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16222/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16222/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
`),qi=a(Jr,"CODE",{});var t2=s(qi);_h=i(t2,"forced_bos_token_id=0"),t2.forEach(t),gh=i(Jr,`. This only works, however, if the string you pass to
`),$i=a(Jr,"CODE",{});var o2=s($i);kh=i(o2,"fairseq.encode"),o2.forEach(t),bh=i(Jr," starts with a space."),Jr.forEach(t),yh=l(qt),yr=a(qt,"LI",{});var jy=s(yr);vr=a(jy,"A",{href:!0});var n2=s(vr);vh=i(n2,"generate()"),n2.forEach(t),Th=i(jy,` should be used for conditional generation tasks like
summarization, see the example in that docstrings.`),jy.forEach(t),wh=l(qt),Jt=a(qt,"LI",{});var Xr=s(Jt);xh=i(Xr,"Models that load the "),ji=a(Xr,"EM",{});var a2=s(ji);zh=i(a2,"facebook/bart-large-cnn"),a2.forEach(t),Fh=i(Xr," weights will not have a "),Mi=a(Xr,"CODE",{});var s2=s(Mi);Bh=i(s2,"mask_token_id"),s2.forEach(t),qh=i(Xr,`, or be able to perform
mask-filling tasks.`),Xr.forEach(t),qt.forEach(t),ac=l(o),Xt=a(o,"H2",{class:!0});var Lc=s(Xt);Po=a(Lc,"A",{id:!0,class:!0,href:!0});var r2=s(Po);Pi=a(r2,"SPAN",{});var i2=s(Pi);f(jn.$$.fragment,i2),i2.forEach(t),r2.forEach(t),$h=l(Lc),Ei=a(Lc,"SPAN",{});var d2=s(Ei);jh=i(d2,"Mask Filling"),d2.forEach(t),Lc.forEach(t),sc=l(o),gt=a(o,"P",{});var Kr=s(gt);Mh=i(Kr,"The "),Ci=a(Kr,"CODE",{});var l2=s(Ci);Ph=i(l2,"facebook/bart-base"),l2.forEach(t),Eh=i(Kr," and "),Ai=a(Kr,"CODE",{});var c2=s(Ai);Ch=i(c2,"facebook/bart-large"),c2.forEach(t),Ah=i(Kr," checkpoints can be used to fill multi-token masks."),Kr.forEach(t),rc=l(o),f(Mn.$$.fragment,o),ic=l(o),Kt=a(o,"H2",{class:!0});var Gc=s(Kt);Eo=a(Gc,"A",{id:!0,class:!0,href:!0});var p2=s(Eo);Si=a(p2,"SPAN",{});var h2=s(Si);f(Pn.$$.fragment,h2),h2.forEach(t),p2.forEach(t),Sh=l(Gc),Ii=a(Gc,"SPAN",{});var u2=s(Ii);Ih=i(u2,"BartConfig"),u2.forEach(t),Gc.forEach(t),dc=l(o),we=a(o,"DIV",{class:!0});var $t=s(we);f(En.$$.fragment,$t),Oh=l($t),Zt=a($t,"P",{});var Zr=s(Zt);Nh=i(Zr,"This is the configuration class to store the configuration of a "),Tr=a(Zr,"A",{href:!0});var m2=s(Tr);Dh=i(m2,"BartModel"),m2.forEach(t),Lh=i(Zr,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),Cn=a(Zr,"A",{href:!0,rel:!0});var f2=s(Cn);Gh=i(f2,"facebook/bart-large"),f2.forEach(t),Wh=i(Zr," architecture."),Zr.forEach(t),Rh=l($t),Yt=a($t,"P",{});var Yr=s(Yt);Uh=i(Yr,"Configuration objects inherit from "),wr=a(Yr,"A",{href:!0});var _2=s(wr);Hh=i(_2,"PretrainedConfig"),_2.forEach(t),Qh=i(Yr,` and can be used to control the model outputs. Read the
documentation from `),xr=a(Yr,"A",{href:!0});var g2=s(xr);Vh=i(g2,"PretrainedConfig"),g2.forEach(t),Jh=i(Yr," for more information."),Yr.forEach(t),Xh=l($t),Oi=a($t,"P",{});var k2=s(Oi);Kh=i(k2,"Example:"),k2.forEach(t),Zh=l($t),f(An.$$.fragment,$t),$t.forEach(t),lc=l(o),eo=a(o,"H2",{class:!0});var Wc=s(eo);Co=a(Wc,"A",{id:!0,class:!0,href:!0});var b2=s(Co);Ni=a(b2,"SPAN",{});var y2=s(Ni);f(Sn.$$.fragment,y2),y2.forEach(t),b2.forEach(t),Yh=l(Wc),Di=a(Wc,"SPAN",{});var v2=s(Di);eu=i(v2,"BartTokenizer"),v2.forEach(t),Wc.forEach(t),cc=l(o),E=a(o,"DIV",{class:!0});var L=s(E);f(In.$$.fragment,L),tu=l(L),Li=a(L,"P",{});var T2=s(Li);ou=i(T2,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),T2.forEach(t),nu=l(L),Gi=a(L,"P",{});var w2=s(Gi);au=i(w2,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),w2.forEach(t),su=l(L),f(On.$$.fragment,L),ru=l(L),Nn=a(L,"P",{});var Rc=s(Nn);iu=i(Rc,"You can get around that behavior by passing "),Wi=a(Rc,"CODE",{});var x2=s(Wi);du=i(x2,"add_prefix_space=True"),x2.forEach(t),lu=i(Rc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Rc.forEach(t),cu=l(L),f(Ao.$$.fragment,L),pu=l(L),Dn=a(L,"P",{});var Uc=s(Dn);hu=i(Uc,"This tokenizer inherits from "),zr=a(Uc,"A",{href:!0});var z2=s(zr);uu=i(z2,"PreTrainedTokenizer"),z2.forEach(t),mu=i(Uc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Uc.forEach(t),fu=l(L),kt=a(L,"DIV",{class:!0});var ei=s(kt);f(Ln.$$.fragment,ei),_u=l(ei),Ri=a(ei,"P",{});var F2=s(Ri);gu=i(F2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),F2.forEach(t),ku=l(ei),Gn=a(ei,"UL",{});var Hc=s(Gn);Fr=a(Hc,"LI",{});var My=s(Fr);bu=i(My,"single sequence: "),Ui=a(My,"CODE",{});var B2=s(Ui);yu=i(B2,"<s> X </s>"),B2.forEach(t),My.forEach(t),vu=l(Hc),Br=a(Hc,"LI",{});var Py=s(Br);Tu=i(Py,"pair of sequences: "),Hi=a(Py,"CODE",{});var q2=s(Hi);wu=i(q2,"<s> A </s></s> B </s>"),q2.forEach(t),Py.forEach(t),Hc.forEach(t),ei.forEach(t),xu=l(L),So=a(L,"DIV",{class:!0});var Qc=s(So);f(Wn.$$.fragment,Qc),zu=l(Qc),Qi=a(Qc,"P",{});var $2=s(Qi);Fu=i($2,"Converts a sequence of tokens (string) in a single string."),$2.forEach(t),Qc.forEach(t),Bu=l(L),Io=a(L,"DIV",{class:!0});var Vc=s(Io);f(Rn.$$.fragment,Vc),qu=l(Vc),Vi=a(Vc,"P",{});var j2=s(Vi);$u=i(j2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),j2.forEach(t),Vc.forEach(t),ju=l(L),Oo=a(L,"DIV",{class:!0});var Jc=s(Oo);f(Un.$$.fragment,Jc),Mu=l(Jc),Hn=a(Jc,"P",{});var Xc=s(Hn);Pu=i(Xc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ji=a(Xc,"CODE",{});var M2=s(Ji);Eu=i(M2,"prepare_for_model"),M2.forEach(t),Cu=i(Xc," method."),Xc.forEach(t),Jc.forEach(t),L.forEach(t),pc=l(o),to=a(o,"H2",{class:!0});var Kc=s(to);No=a(Kc,"A",{id:!0,class:!0,href:!0});var P2=s(No);Xi=a(P2,"SPAN",{});var E2=s(Xi);f(Qn.$$.fragment,E2),E2.forEach(t),P2.forEach(t),Au=l(Kc),Ki=a(Kc,"SPAN",{});var C2=s(Ki);Su=i(C2,"BartTokenizerFast"),C2.forEach(t),Kc.forEach(t),hc=l(o),G=a(o,"DIV",{class:!0});var me=s(G);f(Vn.$$.fragment,me),Iu=l(me),Jn=a(me,"P",{});var Zc=s(Jn);Ou=i(Zc,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),Zi=a(Zc,"EM",{});var A2=s(Zi);Nu=i(A2,"tokenizers"),A2.forEach(t),Du=i(Zc,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),Zc.forEach(t),Lu=l(me),Yi=a(me,"P",{});var S2=s(Yi);Gu=i(S2,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),S2.forEach(t),Wu=l(me),f(Xn.$$.fragment,me),Ru=l(me),Kn=a(me,"P",{});var Yc=s(Kn);Uu=i(Yc,"You can get around that behavior by passing "),ed=a(Yc,"CODE",{});var I2=s(ed);Hu=i(I2,"add_prefix_space=True"),I2.forEach(t),Qu=i(Yc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Yc.forEach(t),Vu=l(me),f(Do.$$.fragment,me),Ju=l(me),Zn=a(me,"P",{});var ep=s(Zn);Xu=i(ep,"This tokenizer inherits from "),qr=a(ep,"A",{href:!0});var O2=s(qr);Ku=i(O2,"PreTrainedTokenizerFast"),O2.forEach(t),Zu=i(ep,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),ep.forEach(t),Yu=l(me),Lo=a(me,"DIV",{class:!0});var tp=s(Lo);f(Yn.$$.fragment,tp),em=l(tp),td=a(tp,"P",{});var N2=s(td);tm=i(N2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),N2.forEach(t),tp.forEach(t),me.forEach(t),uc=l(o),oo=a(o,"H2",{class:!0});var op=s(oo);Go=a(op,"A",{id:!0,class:!0,href:!0});var D2=s(Go);od=a(D2,"SPAN",{});var L2=s(od);f(ea.$$.fragment,L2),L2.forEach(t),D2.forEach(t),om=l(op),nd=a(op,"SPAN",{});var G2=s(nd);nm=i(G2,"BartModel"),G2.forEach(t),op.forEach(t),mc=l(o),Xe=a(o,"DIV",{class:!0});var gn=s(Xe);f(ta.$$.fragment,gn),am=l(gn),oa=a(gn,"P",{});var np=s(oa);sm=i(np,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),$r=a(np,"A",{href:!0});var W2=s($r);rm=i(W2,"PreTrainedModel"),W2.forEach(t),im=i(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),np.forEach(t),dm=l(gn),na=a(gn,"P",{});var ap=s(na);lm=i(ap,"This model is also a PyTorch "),aa=a(ap,"A",{href:!0,rel:!0});var R2=s(aa);cm=i(R2,"torch.nn.Module"),R2.forEach(t),pm=i(ap,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ap.forEach(t),hm=l(gn),Pe=a(gn,"DIV",{class:!0});var jt=s(Pe);f(sa.$$.fragment,jt),um=l(jt),no=a(jt,"P",{});var ti=s(no);mm=i(ti,"The "),jr=a(ti,"A",{href:!0});var U2=s(jr);fm=i(U2,"BartModel"),U2.forEach(t),_m=i(ti," forward method, overrides the "),ad=a(ti,"CODE",{});var H2=s(ad);gm=i(H2,"__call__"),H2.forEach(t),km=i(ti," special method."),ti.forEach(t),bm=l(jt),f(Wo.$$.fragment,jt),ym=l(jt),sd=a(jt,"P",{});var Q2=s(sd);vm=i(Q2,"Example:"),Q2.forEach(t),Tm=l(jt),f(ra.$$.fragment,jt),jt.forEach(t),gn.forEach(t),fc=l(o),ao=a(o,"H2",{class:!0});var sp=s(ao);Ro=a(sp,"A",{id:!0,class:!0,href:!0});var V2=s(Ro);rd=a(V2,"SPAN",{});var J2=s(rd);f(ia.$$.fragment,J2),J2.forEach(t),V2.forEach(t),wm=l(sp),id=a(sp,"SPAN",{});var X2=s(id);xm=i(X2,"BartForConditionalGeneration"),X2.forEach(t),sp.forEach(t),_c=l(o),Ke=a(o,"DIV",{class:!0});var kn=s(Ke);f(da.$$.fragment,kn),zm=l(kn),la=a(kn,"P",{});var rp=s(la);Fm=i(rp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Mr=a(rp,"A",{href:!0});var K2=s(Mr);Bm=i(K2,"PreTrainedModel"),K2.forEach(t),qm=i(rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rp.forEach(t),$m=l(kn),ca=a(kn,"P",{});var ip=s(ca);jm=i(ip,"This model is also a PyTorch "),pa=a(ip,"A",{href:!0,rel:!0});var Z2=s(pa);Mm=i(Z2,"torch.nn.Module"),Z2.forEach(t),Pm=i(ip,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),Em=l(kn),Z=a(kn,"DIV",{class:!0});var Ne=s(Z);f(ha.$$.fragment,Ne),Cm=l(Ne),so=a(Ne,"P",{});var oi=s(so);Am=i(oi,"The "),Pr=a(oi,"A",{href:!0});var Y2=s(Pr);Sm=i(Y2,"BartForConditionalGeneration"),Y2.forEach(t),Im=i(oi," forward method, overrides the "),dd=a(oi,"CODE",{});var ev=s(dd);Om=i(ev,"__call__"),ev.forEach(t),Nm=i(oi," special method."),oi.forEach(t),Dm=l(Ne),f(Uo.$$.fragment,Ne),Lm=l(Ne),ld=a(Ne,"P",{});var tv=s(ld);Gm=i(tv,"Summarization example:"),tv.forEach(t),Wm=l(Ne),f(ua.$$.fragment,Ne),Rm=l(Ne),cd=a(Ne,"P",{});var ov=s(cd);Um=i(ov,"Mask filling example:"),ov.forEach(t),Hm=l(Ne),f(ma.$$.fragment,Ne),Ne.forEach(t),kn.forEach(t),gc=l(o),ro=a(o,"H2",{class:!0});var dp=s(ro);Ho=a(dp,"A",{id:!0,class:!0,href:!0});var nv=s(Ho);pd=a(nv,"SPAN",{});var av=s(pd);f(fa.$$.fragment,av),av.forEach(t),nv.forEach(t),Qm=l(dp),hd=a(dp,"SPAN",{});var sv=s(hd);Vm=i(sv,"BartForSequenceClassification"),sv.forEach(t),dp.forEach(t),kc=l(o),xe=a(o,"DIV",{class:!0});var Mt=s(xe);f(_a.$$.fragment,Mt),Jm=l(Mt),ud=a(Mt,"P",{});var rv=s(ud);Xm=i(rv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
