...
first positional argument :`),te=l(),E=a("ul"),J=a("li"),ge=n("a single Tensor with "),B=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
tensors in the first argument of the model call function: `),W=r(C,"CODE",{});var Ne=i(W);fe=s(Ne,"model(inputs)"),Ne.forEach(t),ie=s(C,"."),C.forEach(t),L=d(h),A=r(h,"P",{});var Je=i(A);ee=s(Je,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Je.forEach(t),te=d(h),E=r(h,"UL",{});var z=i(E);J=r(z,"LI",{});var Q=i(J);ge=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var pe=i(B);le=s(pe,"input_ids"),pe.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,x,G),e(x,X),e(x,O),e(O,Z),e(x,me),e(x,W),e(W,fe),e(x,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,E,G),e(E,J),e(J,ge),e(J,B),e(B,le),e(J,Y),e(J,H),e(H,oe),e(E,_e),e(E,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(E,ye),e(E,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(x),h&&t(L),h&&t(A),h&&t(te),h&&t(E)}}}function cg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function pg(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,W,fe,ie,L,A,ee,te,E,J,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),x=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),E=a("ul"),J=a("li"),ge=n("a single Tensor with "),B=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),x=r(h,"P",{});var C=i(x);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),E=r(h,"UL",{});var z=i(E);J=r(z,"LI",{});var Q=i(J);ge=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var pe=i(B);le=s(pe,"input_ids"),pe.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,x,G),e(x,X),e(x,O),e(O,Z),e(x,me),e(x,W),e(W,fe),e(x,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,E,G),e(E,J),e(J,ge),e(J,B),e(B,le),e(J,Y),e(J,H),e(H,oe),e(E,_e),e(E,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(E,ye),e(E,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(x),h&&t(L),h&&t(A),h&&t(te),h&&t(E)}}}function hg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function ug(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,W,fe,ie,L,A,ee,te,E,J,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),x=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),E=a("ul"),J=a("li"),ge=n("a single Tensor with "),B=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),x=r(h,"P",{});var C=i(x);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),E=r(h,"UL",{});var z=i(E);J=r(z,"LI",{});var Q=i(J);ge=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var pe=i(B);le=s(pe,"input_ids"),pe.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,x,G),e(x,X),e(x,O),e(O,Z),e(x,me),e(x,W),e(W,fe),e(x,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,E,G),e(E,J),e(J,ge),e(J,B),e(B,le),e(J,Y),e(J,H),e(H,oe),e(E,_e),e(E,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(E,ye),e(E,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(x),h&&t(L),h&&t(A),h&&t(te),h&&t(E)}}}function mg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function fg(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,W,fe,ie,L,A,ee,te,E,J,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),x=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),E=a("ul"),J=a("li"),ge=n("a single Tensor with "),B=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),x=r(h,"P",{});var C=i(x);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),E=r(h,"UL",{});var z=i(E);J=r(z,"LI",{});var Q=i(J);ge=s(Q,"a single Tensor with "),B=r(Q,"CODE",{});var pe=i(B);le=s(pe,"input_ids"),pe.forEach(t),Y=s(Q," only and nothing else: "),H=r(Q,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,x,G),e(x,X),e(x,O),e(O,Z),e(x,me),e(x,W),e(W,fe),e(x,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,E,G),e(E,J),e(J,ge),e(J,B),e(B,le),e(J,Y),e(J,H),e(H,oe),e(E,_e),e(E,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(E,ye),e(E,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(x),h&&t(L),h&&t(A),h&&t(te),h&&t(E)}}}function gg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function yg(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,W,fe,ie,L,A,ee,te,E,J,ge,B,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se,h,G,V,Ae,Ie,C,Le,Ne,Je,z,Q,pe,Fe,D,Se,ke,we,De,Ks,pt,Ai,Eo,Ii,Li,Xs,Ni,Si,Ys,Di,Oi,Mr,$t,Kt,Zs,Jo,Wi,ea,Ui,qr,Xt,Qi,ms,Bi,Hi,Cr,Mo,zr,fs,Ri,Ar,qo,Ir,Ft,Yt,ta,Co,Vi,oa,Ki,Lr,Ye,zo,Xi,Ze,Yi,gs,Zi,el,Ao,tl,ol,_s,nl,sl,Ts,al,rl,il,na,ll,dl,Io,Nr,jt,Zt,sa,Lo,cl,aa,pl,Sr,ht,No,hl,So,ul,Do,ml,fl,gl,Oe,Oo,_l,Gt,Tl,ys,yl,vl,ra,kl,wl,bl,eo,Pl,ia,$l,Fl,Wo,Dr,xt,to,la,Uo,jl,da,Gl,Or,et,Qo,xl,ca,El,Jl,Bo,Ml,Ho,ql,Cl,zl,We,Ro,Al,Et,Il,vs,Ll,Nl,pa,Sl,Dl,Ol,oo,Wl,ha,Ul,Ql,Vo,Wr,Jt,no,ua,Ko,Bl,ma,Hl,Ur,je,Xo,Rl,fa,Vl,Kl,ks,ws,Xl,Yl,Zl,tt,ed,ga,td,od,_a,nd,sd,Ta,ad,rd,ya,id,ld,dd,Yo,cd,Zo,pd,hd,ud,ne,en,md,Mt,fd,bs,gd,_d,va,Td,yd,vd,so,kd,ka,wd,bd,tn,Pd,on,$d,wa,Fd,jd,nn,Gd,sn,Qr,qt,ao,ba,an,xd,Pa,Ed,Br,ot,rn,Jd,Ct,Md,$a,qd,Cd,Fa,zd,Ad,Id,ln,Ld,dn,Nd,Sd,Dd,Me,cn,Od,zt,Wd,Ps,Ud,Qd,ja,Bd,Hd,Rd,ro,Vd,Ga,Kd,Xd,pn,Yd,hn,Hr,At,io,xa,un,Zd,Ea,ec,Rr,Ge,mn,tc,Ja,oc,nc,fn,sc,$s,ac,rc,ic,gn,lc,_n,dc,cc,pc,lo,hc,Ue,Tn,uc,It,mc,Fs,fc,gc,Ma,_c,Tc,yc,co,vc,qa,kc,wc,yn,Vr,Lt,po,Ca,vn,bc,za,Pc,Kr,xe,kn,$c,Aa,Fc,jc,wn,Gc,js,xc,Ec,Jc,bn,Mc,Pn,qc,Cc,zc,ho,Ac,Qe,$n,Ic,Nt,Lc,Gs,Nc,Sc,Ia,Dc,Oc,Wc,uo,Uc,La,Qc,Bc,Fn,Xr,St,mo,Na,jn,Hc,Sa,Rc,Yr,ae,Gn,Vc,Da,Kc,Xc,xs,Es,Yc,Zc,ep,nt,tp,Oa,op,np,Wa,sp,ap,Ua,rp,ip,Qa,lp,dp,cp,xn,pp,Js,hp,up,mp,En,fp,Jn,gp,_p,Tp,fo,yp,qe,Mn,vp,Dt,kp,Ms,wp,bp,Ba,Pp,$p,Fp,go,jp,Ha,Gp,xp,qn,Ep,Cn,Zr,Ot,_o,Ra,zn,Jp,Va,Mp,ei,Ee,An,qp,Wt,Cp,Ka,zp,Ap,Xa,Ip,Lp,Np,In,Sp,qs,Dp,Op,Wp,Ln,Up,Nn,Qp,Bp,Hp,To,Rp,Ce,Sn,Vp,Ut,Kp,Cs,Xp,Yp,Ya,Zp,eh,th,yo,oh,Za,nh,sh,Dn,ah,On,ti,Qt,vo,er,Wn,rh,tr,ih,oi,be,Un,lh,or,dh,ch,Qn,ph,zs,hh,uh,mh,Bn,fh,Hn,gh,_h,Th,nr,yh,vh,ut,sr,Rn,kh,wh,ar,Vn,bh,Ph,rr,Kn,$h,Fh,ir,Xn,jh,Gh,Be,Yn,xh,Bt,Eh,lr,Jh,Mh,dr,qh,Ch,zh,ko,Ah,cr,Ih,Lh,Zn,ni,Ht,wo,pr,es,Nh,hr,Sh,si,Pe,ts,Dh,ur,Oh,Wh,os,Uh,As,Qh,Bh,Hh,ns,Rh,ss,Vh,Kh,Xh,mr,Yh,Zh,mt,fr,as,eu,tu,gr,rs,ou,nu,_r,is,su,au,Tr,ls,ru,iu,He,ds,lu,Rt,du,yr,cu,pu,vr,hu,uu,mu,bo,fu,kr,gu,_u,cs,ai;return T=new Xe({}),Z=new Xe({}),z=new he({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">... </span>)`}}),Jo=new Xe({}),Mo=new he({props:{code:`from transformers import AutoModelForCausalLM, AutoTokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16944/en/model_doc/gptj#transformers.GPTJModel">GPTJModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTJConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 2048) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/configuration_gptj.py#L33"}}),Io=new he({props:{code:`from transformers import GPTJModel, GPTJConfig
...
Whether or not to return a <a href="/docs/transformers/pr_16944/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_gptj.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16944/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16944/en/model_doc/gptj#transformers.GPTJConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16944/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_gptj.py#L712"}}),Ro=new re({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16944/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16944/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_gptj.py#L781",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16944/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_gptj.py#L903",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16944/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_gptj.py#L1014"}}),cn=new re({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16944/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16944/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_gptj.py#L1030",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16944/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16944/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_tf_gptj.py#L652",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16944/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_tf_gptj.py#L759",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16944/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_tf_gptj.py#L863",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/gptj/modeling_tf_gptj.py#L986",returnDescription:`
<p>A <a
...
causal language model trained on `),J=a("a"),ge=n("the Pile"),B=n(" dataset."),le=l(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),_e=n("Stella Biderman"),M=n("."),de=l(),N=a("p"),Te=n("Tips:"),ce=l(),S=a("ul"),U=a("li"),ye=n("To load "),q=a("a"),ve=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
12.1GB of CPU RAM to load the model.`),Je=l(),v(z.$$.fragment),Q=l(),pe=a("ul"),Fe=a("li"),D=a("p"),Se=n(`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
...
size, the tokenizer for `),Eo=a("a"),Ii=n("GPT-J"),Li=n(` contains 143 extra tokens
`),Xs=a("code"),Ni=n("<|extratoken_1|>... <|extratoken_143|>"),Si=n(", so the "),Ys=a("code"),Di=n("vocab_size"),Oi=n(" of tokenizer also becomes 50400."),Mr=l(),$t=a("h3"),Kt=a("a"),Zs=a("span"),v(Jo.$$.fragment),Wi=l(),ea=a("span"),Ui=n("Generation"),qr=l(),Xt=a("p"),Qi=n("The "),ms=a("a"),Bi=n("generate()"),Hi=n(` method can be used to generate text using GPT-J
...
`),Ao=a("a"),tl=n("EleutherAI/gpt-j-6B"),ol=n(` architecture. Configuration objects inherit from
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ud=l(),ne=a("div"),v(en.$$.fragment),md=l(),Mt=a("p"),fd=n("The "),bs=a("a"),gd=n("GPTJForSequenceClassification"),_d=n(" forward method, overrides the "),va=a("code"),Td=n("__call__"),yd=n(" special method."),vd=l(),v(so.$$.fragment),kd=l(),ka=a("p"),wd=n("Example of single-label classification:"),bd=l(),v(tn.$$.fragment),Pd=l(),v(on.$$.fragment),$d=l(),wa=a("p"),Fd=n("Example of multi-label classification:"),jd=l(),v(nn.$$.fragment),Gd=l(),v(sn.$$.fragment),Qr=l(),qt=a("h2"),ao=a("a"),ba=a("span"),v(an.$$.fragment),xd=l(),Pa=a("span"),Ed=n("GPTJForQuestionAnswering"),Br=l(),ot=a("div"),v(rn.$$.fragment),Jd=l(),Ct=a("p"),Md=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
behavior.`),pc=l(),v(lo.$$.fragment),hc=l(),Ue=a("div"),v(Tn.$$.fragment),uc=l(),It=a("p"),mc=n("The "),Fs=a("a"),fc=n("TFGPTJModel"),gc=n(" forward method, overrides the "),Ma=a("code"),_c=n("__call__"),Tc=n(" special method."),yc=l(),v(co.$$.fragment),vc=l(),qa=a("p"),kc=n("Example:"),wc=l(),v(yn.$$.fragment),Vr=l(),Lt=a("h2"),po=a("a"),Ca=a("span"),v(vn.$$.fragment),bc=l(),za=a("span"),Pc=n("TFGPTJForCausalLM"),Kr=l(),xe=a("div"),v(kn.$$.fragment),$c=l(),Aa=a("p"),Fc=n("The GPT-J Model transformer with a language modeling head on top."),jc=l(),wn=a("p"),Gc=n("This model inherits from "),js=a("a"),xc=n("TFPreTrainedModel"),Ec=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc=l(),bn=a("p"),Mc=n("This model is also a "),Pn=a("a"),qc=n("tf.keras.Model"),Cc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zc=l(),v(ho.$$.fragment),Ac=l(),Qe=a("div"),v($n.$$.fragment),Ic=l(),Nt=a("p"),Lc=n("The "),Gs=a("a"),Nc=n("TFGPTJForCausalLM"),Sc=n(" forward method, overrides the "),Ia=a("code"),Dc=n("__call__"),Oc=n(" special method."),Wc=l(),v(uo.$$.fragment),Uc=l(),La=a("p"),Qc=n("Example:"),Bc=l(),v(Fn.$$.fragment),Xr=l(),St=a("h2"),mo=a("a"),Na=a("span"),v(jn.$$.fragment),Hc=l(),Sa=a("span"),Rc=n("TFGPTJForSequenceClassification"),Yr=l(),ae=a("div"),v(Gn.$$.fragment),Vc=l(),Da=a("p"),Kc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Xc=l(),xs=a("p"),Es=a("a"),Yc=n("GPTJForSequenceClassification"),Zc=n(` uses the last token in order to do the classification, as other causal models
...
each row of the batch).`),cp=l(),xn=a("p"),pp=n("This model inherits from "),Js=a("a"),hp=n("TFPreTrainedModel"),up=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mp=l(),En=a("p"),fp=n("This model is also a "),Jn=a("a"),gp=n("tf.keras.Model"),_p=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp=l(),v(fo.$$.fragment),yp=l(),qe=a("div"),v(Mn.$$.fragment),vp=l(),Dt=a("p"),kp=n("The "),Ms=a("a"),wp=n("TFGPTJForSequenceClassification"),bp=n(" forward method, overrides the "),Ba=a("code"),Pp=n("__call__"),$p=n(" special method."),Fp=l(),v(go.$$.fragment),jp=l(),Ha=a("p"),Gp=n("Example:"),xp=l(),v(qn.$$.fragment),Ep=l(),v(Cn.$$.fragment),Zr=l(),Ot=a("h2"),_o=a("a"),Ra=a("span"),v(zn.$$.fragment),Jp=l(),Va=a("span"),Mp=n("TFGPTJForQuestionAnswering"),ei=l(),Ee=a("div"),v(An.$$.fragment),qp=l(),Wt=a("p"),Cp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),ft.forEach(t),ku.forEach(t),Je=d(o),k(z.$$.fragment,o),Q=d(o),pe=r(o,"UL",{});var ri=i(pe);Fe=r(ri,"LI",{});var Fu=i(Fe);D=r(Fu,"P",{});var Tu=i(D);Se=s(Tu,`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
optimizer for example makes four copies of the model: model, gradients, average and squared average of the gradients.
So it would need at least 4x model size GPU memory, even with mixed precision as gradient updates are in fp32. This
is not including the activations and data batches, which would again require some more GPU RAM. So one should explore
solutions such as DeepSpeed, to train/fine-tune the model. Another option is to use the original codebase to
...
tokens are added for the sake of efficiency on TPUs. To avoid the mis-match between embedding matrix size and vocab
size, the tokenizer for `),Eo=r(Po,"A",{href:!0,rel:!0});var xu=i(Eo);Ii=s(xu,"GPT-J"),xu.forEach(t),Li=s(Po,` contains 143 extra tokens
`),Xs=r(Po,"CODE",{});var Eu=i(Xs);Ni=s(Eu,"<|extratoken_1|>... <|extratoken_143|>"),Eu.forEach(t),Si=s(Po,", so the "),Ys=r(Po,"CODE",{});var Ju=i(Ys);Di=s(Ju,"vocab_size"),Ju.forEach(t),Oi=s(Po," of tokenizer also becomes 50400."),Po.forEach(t),Gu.forEach(t),ri.forEach(t),Mr=d(o),$t=r(o,"H3",{class:!0});var ii=i($t);Kt=r(ii,"A",{id:!0,class:!0,href:!0});var Mu=i(Kt);Zs=r(Mu,"SPAN",{});var qu=i(Zs);k(Jo.$$.fragment,qu),qu.forEach(t),Mu.forEach(t),Wi=d(ii),ea=r(ii,"SPAN",{});var Cu=i(ea);Ui=s(Cu,"Generation"),Cu.forEach(t),ii.forEach(t),qr=d(o),Xt=r(o,"P",{});var li=i(Xt);Qi=s(li,"The "),ms=r(li,"A",{href:!0});var zu=i(ms);Bi=s(zu,"generate()"),zu.forEach(t),Hi=s(li,` method can be used to generate text using GPT-J
...
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the GPT-J
`),Ao=r(gt,"A",{href:!0,rel:!0});var Du=i(Ao);tl=s(Du,"EleutherAI/gpt-j-6B"),Du.forEach(t),ol=s(gt,` architecture. Configuration objects inherit from
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_i.forEach(t),Dd=d(jo),Me=r(jo,"DIV",{class:!0});var at=i(Me);k(cn.$$.fragment,at),Od=d(at),zt=r(at,"P",{});var Os=i(zt);Wd=s(Os,"The "),Ps=r(Os,"A",{href:!0});var Fm=i(Ps);Ud=s(Fm,"GPTJForQuestionAnswering"),Fm.forEach(t),Qd=s(Os," forward method, overrides the "),ja=r(Os,"CODE",{});var jm=i(ja);Bd=s(jm,"__call__"),jm.forEach(t),Hd=s(Os," special method."),Os.forEach(t),Rd=d(at),k(ro.$$.fragment,at),Vd=d(at),Ga=r(at,"P",{});var Gm=i(Ga);Kd=s(Gm,"Example:"),Gm.forEach(t),Xd=d(at),k(pn.$$.fragment,at),Yd=d(at),k(hn.$$.fragment,at),at.forEach(t),jo.forEach(t),Hr=d(o),At=r(o,"H2",{class:!0});var Ti=i(At);io=r(Ti,"A",{id:!0,class:!0,href:!0});var xm=i(io);xa=r(xm,"SPAN",{});var Em=i(xa);k(un.$$.fragment,Em),Em.forEach(t),xm.forEach(t),Zd=d(Ti),Ea=r(Ti,"SPAN",{});var Jm=i(Ea);ec=s(Jm,"TFGPTJModel"),Jm.forEach(t),Ti.forEach(t),Rr=d(o),Ge=r(o,"DIV",{class:!0});var rt=i(Ge);k(mn.$$.fragment,rt),tc=d(rt),Ja=r(rt,"P",{});var Mm=i(Ja);oc=s(Mm,"The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Mm.forEach(t),nc=d(rt),fn=r(rt,"P",{});var yi=i(fn);sc=s(yi,"This model inherits from "),$s=r(yi,"A",{href:!0});var qm=i($s);ac=s(qm,"TFPreTrainedModel"),qm.forEach(t),rc=s(yi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
each row of the batch).`),wt.forEach(t),cp=d(ze),xn=r(ze,"P",{});var $i=i(xn);pp=s($i,"This model inherits from "),Js=r($i,"A",{href:!0});var of=i(Js);hp=s(of,"TFPreTrainedModel"),of.forEach(t),up=s($i,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$i.forEach(t),mp=d(ze),En=r(ze,"P",{});var Fi=i(En);fp=s(Fi,"This model is also a "),Jn=r(Fi,"A",{href:!0,rel:!0});var nf=i(Jn);gp=s(nf,"tf.keras.Model"),nf.forEach(t),_p=s(Fi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),Tp=d(ze),k(fo.$$.fragment,ze),yp=d(ze),qe=r(ze,"DIV",{class:!0});var lt=i(qe);k(Mn.$$.fragment,lt),vp=d(lt),Dt=r(lt,"P",{});var Qs=i(Dt);kp=s(Qs,"The "),Ms=r(Qs,"A",{href:!0});var sf=i(Ms);wp=s(sf,"TFGPTJForSequenceClassification"),sf.forEach(t),bp=s(Qs," forward method, overrides the "),Ba=r(Qs,"CODE",{});var af=i(Ba);Pp=s(af,"__call__"),af.forEach(t),$p=s(Qs," special method."),Qs.forEach(t),Fp=d(lt),k(go.$$.fragment,lt),jp=d(lt),Ha=r(lt,"P",{});var rf=i(Ha);Gp=s(rf,"Example:"),rf.forEach(t),xp=d(lt),k(qn.$$.fragment,lt),Ep=d(lt),k(Cn.$$.fragment,lt),lt.forEach(t),ze.forEach(t),Zr=d(o),Ot=r(o,"H2",{class:!0});var ji=i(Ot);_o=r(ji,"A",{id:!0,class:!0,href:!0});var lf=i(_o);Ra=r(lf,"SPAN",{});var df=i(Ra);k(zn.$$.fragment,df),df.forEach(t),lf.forEach(t),Jp=d(ji),Va=r(ji,"SPAN",{});var cf=i(Va);Mp=s(cf,"TFGPTJForQuestionAnswering"),cf.forEach(t),ji.forEach(t),ei=d(o),Ee=r(o,"DIV",{class:!0});var dt=i(Ee);k(An.$$.fragment,dt),qp=d(dt),Wt=r(dt,"P",{});var Bs=i(Wt);Cp=s(Bs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
