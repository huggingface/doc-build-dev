...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16944/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16944/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
...
refer to this superclass for more information regarding those methods.`),cf.forEach(t),Kg=h(Xe),Ll=s(Xe,"DIV",{class:!0});var K2=a(Ll);y(Ea.$$.fragment,K2),K2.forEach(t),Xe.forEach(t),gm=h(o),_o=s(o,"H2",{class:!0});var pf=a(_o);yn=s(pf,"A",{id:!0,class:!0,href:!0});var G2=a(yn);sc=s(G2,"SPAN",{});var X2=a(sc);y(za.$$.fragment,X2),X2.forEach(t),G2.forEach(t),Gg=h(pf),ac=s(pf,"SPAN",{});var Y2=a(ac);Xg=i(Y2,"RobertaModel"),Y2.forEach(t),pf.forEach(t),_m=h(o),Ae=s(o,"DIV",{class:!0});var Ye=a(Ae);y(qa.$$.fragment,Ye),Yg=h(Ye),rc=s(Ye,"P",{});var Z2=a(rc);Zg=i(Z2,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Z2.forEach(t),e_=h(Ye),Ca=s(Ye,"P",{});var hf=a(Ca);t_=i(hf,"This model inherits from "),Al=s(hf,"A",{href:!0});var e4=a(Al);o_=i(e4,"PreTrainedModel"),e4.forEach(t),n_=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),s_=h(Ye),ja=s(Ye,"P",{});var mf=a(ja);a_=i(mf,"This model is also a PyTorch "),Pa=s(mf,"A",{href:!0,rel:!0});var t4=a(Pa);r_=i(t4,"torch.nn.Module"),t4.forEach(t),i_=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),ic=s(ff,"EM",{});var o4=a(ic);c_=i(o4,`Attention is
all you need`),o4.forEach(t),p_=i(ff,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),ff.forEach(t),h_=h(Ye),Ue=s(Ye,"P",{});var mt=a(Ue);m_=i(mt,"To behave as an decoder the model needs to be initialized with the "),lc=s(mt,"CODE",{});var n4=a(lc);f_=i(n4,"is_decoder"),n4.forEach(t),u_=i(mt,` argument of the configuration set
to `),dc=s(mt,"CODE",{});var s4=a(dc);g_=i(s4,"True"),s4.forEach(t),__=i(mt,". To be used in a Seq2Seq model, the model needs to initialized with both "),cc=s(mt,"CODE",{});var a4=a(cc);b_=i(a4,"is_decoder"),a4.forEach(t),k_=i(mt,` argument and
`),pc=s(mt,"CODE",{});var r4=a(pc);v_=i(r4,"add_cross_attention"),r4.forEach(t),T_=i(mt," set to "),hc=s(mt,"CODE",{});var i4=a(hc);y_=i(i4,"True"),i4.forEach(t),w_=i(mt,"; an "),mc=s(mt,"CODE",{});var l4=a(mc);$_=i(l4,"encoder_hidden_states"),l4.forEach(t),F_=i(mt," is then expected as an input to the forward pass."),mt.forEach(t),x_=h(Ye),wn=s(Ye,"P",{});var lm=a(wn);R_=i(lm,".. _"),fc=s(lm,"EM",{});var d4=a(fc);M_=i(d4,"Attention is all you need"),d4.forEach(t),E_=i(lm,": "),Aa=s(lm,"A",{href:!0,rel:!0});var c4=a(Aa);z_=i(c4,"https://arxiv.org/abs/1706.03762"),c4.forEach(t),lm.forEach(t),q_=h(Ye),yt=s(Ye,"DIV",{class:!0});var Hs=a(yt);y(Oa.$$.fragment,Hs),C_=h(Hs),bo=s(Hs,"P",{});var bd=a(bo);j_=i(bd,"The "),Ol=s(bd,"A",{href:!0});var p4=a(Ol);P_=i(p4,"RobertaModel"),p4.forEach(t),L_=i(bd," forward method, overrides the "),uc=s(bd,"CODE",{});var h4=a(uc);A_=i(h4,"__call__"),h4.forEach(t),O_=i(bd," special method."),bd.forEach(t),N_=h(Hs),y($n.$$.fragment,Hs),I_=h(Hs),y(Fn.$$.fragment,Hs),Hs.forEach(t),Ye.forEach(t),bm=h(o),ko=s(o,"H2",{class:!0});var uf=a(ko);xn=s(uf,"A",{id:!0,class:!0,href:!0});var m4=a(xn);gc=s(m4,"SPAN",{});var f4=a(gc);y(Na.$$.fragment,f4),f4.forEach(t),m4.forEach(t),D_=h(uf),_c=s(uf,"SPAN",{});var u4=a(_c);S_=i(u4,"RobertaForCausalLM"),u4.forEach(t),uf.forEach(t),km=h(o),et=s(o,"DIV",{class:!0});var Yt=a(et);y(Ia.$$.fragment,Yt),W_=h(Yt),Da=s(Yt,"P",{});var gf=a(Da);B_=i(gf,"RoBERTa Model with a "),bc=s(gf,"CODE",{});var g4=a(bc);U_=i(g4,"language modeling"),g4.forEach(t),H_=i(gf," head on top for CLM fine-tuning."),gf.forEach(t),Q_=h(Yt),Sa=s(Yt,"P",{});var _f=a(Sa);V_=i(_f,"This model inherits from "),Nl=s(_f,"A",{href:!0});var _4=a(Nl);J_=i(_4,"PreTrainedModel"),_4.forEach(t),K_=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_f.forEach(t),G_=h(Yt),Wa=s(Yt,"P",{});var bf=a(Wa);X_=i(bf,"This model is also a PyTorch "),Ba=s(bf,"A",{href:!0,rel:!0});var b4=a(Ba);Y_=i(b4,"torch.nn.Module"),b4.forEach(t),Z_=i(bf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bf.forEach(t),eb=h(Yt),wt=s(Yt,"DIV",{class:!0});var Qs=a(wt);y(Ua.$$.fragment,Qs),tb=h(Qs),vo=s(Qs,"P",{});var kd=a(vo);ob=i(kd,"The "),Il=s(kd,"A",{href:!0});var k4=a(Il);nb=i(k4,"RobertaForCausalLM"),k4.forEach(t),sb=i(kd," forward method, overrides the "),kc=s(kd,"CODE",{});var v4=a(kc);ab=i(v4,"__call__"),v4.forEach(t),rb=i(kd," special method."),kd.forEach(t),ib=h(Qs),y(Rn.$$.fragment,Qs),lb=h(Qs),y(Mn.$$.fragment,Qs),Qs.forEach(t),Yt.forEach(t),vm=h(o),To=s(o,"H2",{class:!0});var kf=a(To);En=s(kf,"A",{id:!0,class:!0,href:!0});var T4=a(En);vc=s(T4,"SPAN",{});var y4=a(vc);y(Ha.$$.fragment,y4),y4.forEach(t),T4.forEach(t),db=h(kf),Tc=s(kf,"SPAN",{});var w4=a(Tc);cb=i(w4,"RobertaForMaskedLM"),w4.forEach(t),kf.forEach(t),Tm=h(o),tt=s(o,"DIV",{class:!0});var Zt=a(tt);y(Qa.$$.fragment,Zt),pb=h(Zt),Va=s(Zt,"P",{});var vf=a(Va);hb=i(vf,"RoBERTa Model with a "),yc=s(vf,"CODE",{});var $4=a(yc);mb=i($4,"language modeling"),$4.forEach(t),fb=i(vf," head on top."),vf.forEach(t),ub=h(Zt),Ja=s(Zt,"P",{});var Tf=a(Ja);gb=i(Tf,"This model inherits from "),Dl=s(Tf,"A",{href:!0});var F4=a(Dl);_b=i(F4,"PreTrainedModel"),F4.forEach(t),bb=i(Tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tf.forEach(t),kb=h(Zt),Ka=s(Zt,"P",{});var yf=a(Ka);vb=i(yf,"This model is also a PyTorch "),Ga=s(yf,"A",{href:!0,rel:!0});var x4=a(Ga);Tb=i(x4,"torch.nn.Module"),x4.forEach(t),yb=i(yf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yf.forEach(t),wb=h(Zt),rt=s(Zt,"DIV",{class:!0});var eo=a(rt);y(Xa.$$.fragment,eo),$b=h(eo),yo=s(eo,"P",{});var vd=a(yo);Fb=i(vd,"The "),Sl=s(vd,"A",{href:!0});var R4=a(Sl);xb=i(R4,"RobertaForMaskedLM"),R4.forEach(t),Rb=i(vd," forward method, overrides the "),wc=s(vd,"CODE",{});var M4=a(wc);Mb=i(M4,"__call__"),M4.forEach(t),Eb=i(vd," special method."),vd.forEach(t),zb=h(eo),y(zn.$$.fragment,eo),qb=h(eo),y(qn.$$.fragment,eo),Cb=h(eo),y(Cn.$$.fragment,eo),eo.forEach(t),Zt.forEach(t),ym=h(o),wo=s(o,"H2",{class:!0});var wf=a(wo);jn=s(wf,"A",{id:!0,class:!0,href:!0});var E4=a(jn);$c=s(E4,"SPAN",{});var z4=a($c);y(Ya.$$.fragment,z4),z4.forEach(t),E4.forEach(t),jb=h(wf),Fc=s(wf,"SPAN",{});var q4=a(Fc);Pb=i(q4,"RobertaForSequenceClassification"),q4.forEach(t),wf.forEach(t),wm=h(o),ot=s(o,"DIV",{class:!0});var to=a(ot);y(Za.$$.fragment,to),Lb=h(to),xc=s(to,"P",{});var C4=a(xc);Ab=i(C4,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C4.forEach(t),Ob=h(to),er=s(to,"P",{});var $f=a(er);Nb=i($f,"This model inherits from "),Wl=s($f,"A",{href:!0});var j4=a(Wl);Ib=i(j4,"PreTrainedModel"),j4.forEach(t),Db=i($f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f.forEach(t),Sb=h(to),tr=s(to,"P",{});var Ff=a(tr);Wb=i(Ff,"This model is also a PyTorch "),or=s(Ff,"A",{href:!0,rel:!0});var P4=a(or);Bb=i(P4,"torch.nn.Module"),P4.forEach(t),Ub=i(Ff,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ff.forEach(t),Hb=h(to),Be=s(to,"DIV",{class:!0});var ft=a(Be);y(nr.$$.fragment,ft),Qb=h(ft),$o=s(ft,"P",{});var Td=a($o);Vb=i(Td,"The "),Bl=s(Td,"A",{href:!0});var L4=a(Bl);Jb=i(L4,"RobertaForSequenceClassification"),L4.forEach(t),Kb=i(Td," forward method, overrides the "),Rc=s(Td,"CODE",{});var A4=a(Rc);Gb=i(A4,"__call__"),A4.forEach(t),Xb=i(Td," special method."),Td.forEach(t),Yb=h(ft),y(Pn.$$.fragment,ft),Zb=h(ft),y(Ln.$$.fragment,ft),ek=h(ft),y(An.$$.fragment,ft),tk=h(ft),y(On.$$.fragment,ft),ok=h(ft),y(Nn.$$.fragment,ft),ft.forEach(t),to.forEach(t),$m=h(o),Fo=s(o,"H2",{class:!0});var xf=a(Fo);In=s(xf,"A",{id:!0,class:!0,href:!0});var O4=a(In);Mc=s(O4,"SPAN",{});var N4=a(Mc);y(sr.$$.fragment,N4),N4.forEach(t),O4.forEach(t),nk=h(xf),Ec=s(xf,"SPAN",{});var I4=a(Ec);sk=i(I4,"RobertaForMultipleChoice"),I4.forEach(t),xf.forEach(t),Fm=h(o),nt=s(o,"DIV",{class:!0});var oo=a(nt);y(ar.$$.fragment,oo),ak=h(oo),zc=s(oo,"P",{});var D4=a(zc);rk=i(D4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D4.forEach(t),ik=h(oo),rr=s(oo,"P",{});var Rf=a(rr);lk=i(Rf,"This model inherits from "),Ul=s(Rf,"A",{href:!0});var S4=a(Ul);dk=i(S4,"PreTrainedModel"),S4.forEach(t),ck=i(Rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rf.forEach(t),pk=h(oo),ir=s(oo,"P",{});var Mf=a(ir);hk=i(Mf,"This model is also a PyTorch "),lr=s(Mf,"A",{href:!0,rel:!0});var W4=a(lr);mk=i(W4,"torch.nn.Module"),W4.forEach(t),fk=i(Mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mf.forEach(t),uk=h(oo),$t=s(oo,"DIV",{class:!0});var Vs=a($t);y(dr.$$.fragment,Vs),gk=h(Vs),xo=s(Vs,"P",{});var yd=a(xo);_k=i(yd,"The "),Hl=s(yd,"A",{href:!0});var B4=a(Hl);bk=i(B4,"RobertaForMultipleChoice"),B4.forEach(t),kk=i(yd," forward method, overrides the "),qc=s(yd,"CODE",{});var U4=a(qc);vk=i(U4,"__call__"),U4.forEach(t),Tk=i(yd," special method."),yd.forEach(t),yk=h(Vs),y(Dn.$$.fragment,Vs),wk=h(Vs),y(Sn.$$.fragment,Vs),Vs.forEach(t),oo.forEach(t),xm=h(o),Ro=s(o,"H2",{class:!0});var Ef=a(Ro);Wn=s(Ef,"A",{id:!0,class:!0,href:!0});var H4=a(Wn);Cc=s(H4,"SPAN",{});var Q4=a(Cc);y(cr.$$.fragment,Q4),Q4.forEach(t),H4.forEach(t),$k=h(Ef),jc=s(Ef,"SPAN",{});var V4=a(jc);Fk=i(V4,"RobertaForTokenClassification"),V4.forEach(t),Ef.forEach(t),Rm=h(o),st=s(o,"DIV",{class:!0});var no=a(st);y(pr.$$.fragment,no),xk=h(no),Pc=s(no,"P",{});var J4=a(Pc);Rk=i(J4,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),J4.forEach(t),Mk=h(no),hr=s(no,"P",{});var zf=a(hr);Ek=i(zf,"This model inherits from "),Ql=s(zf,"A",{href:!0});var K4=a(Ql);zk=i(K4,"PreTrainedModel"),K4.forEach(t),qk=i(zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zf.forEach(t),Ck=h(no),mr=s(no,"P",{});var qf=a(mr);jk=i(qf,"This model is also a PyTorch "),fr=s(qf,"A",{href:!0,rel:!0});var G4=a(fr);Pk=i(G4,"torch.nn.Module"),G4.forEach(t),Lk=i(qf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qf.forEach(t),Ak=h(no),it=s(no,"DIV",{class:!0});var so=a(it);y(ur.$$.fragment,so),Ok=h(so),Mo=s(so,"P",{});var wd=a(Mo);Nk=i(wd,"The "),Vl=s(wd,"A",{href:!0});var X4=a(Vl);Ik=i(X4,"RobertaForTokenClassification"),X4.forEach(t),Dk=i(wd," forward method, overrides the "),Lc=s(wd,"CODE",{});var Y4=a(Lc);Sk=i(Y4,"__call__"),Y4.forEach(t),Wk=i(wd," special method."),wd.forEach(t),Bk=h(so),y(Bn.$$.fragment,so),Uk=h(so),y(Un.$$.fragment,so),Hk=h(so),y(Hn.$$.fragment,so),so.forEach(t),no.forEach(t),Mm=h(o),Eo=s(o,"H2",{class:!0});var Cf=a(Eo);Qn=s(Cf,"A",{id:!0,class:!0,href:!0});var Z4=a(Qn);Ac=s(Z4,"SPAN",{});var eF=a(Ac);y(gr.$$.fragment,eF),eF.forEach(t),Z4.forEach(t),Qk=h(Cf),Oc=s(Cf,"SPAN",{});var tF=a(Oc);Vk=i(tF,"RobertaForQuestionAnswering"),tF.forEach(t),Cf.forEach(t),Em=h(o),at=s(o,"DIV",{class:!0});var ao=a(at);y(_r.$$.fragment,ao),Jk=h(ao),zo=s(ao,"P",{});var $d=a(zo);Kk=i($d,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Of.forEach(t),zv=h(Pt),y(Xn.$$.fragment,Pt),qv=h(Pt),Ft=s(Pt,"DIV",{class:!0});var Js=a(Ft);y(Rr.$$.fragment,Js),Cv=h(Js),jo=s(Js,"P",{});var xd=a(jo);jv=i(xd,"The "),Xl=s(xd,"A",{href:!0});var fF=a(Xl);Pv=i(fF,"TFRobertaModel"),fF.forEach(t),Lv=i(xd," forward method, overrides the "),Uc=s(xd,"CODE",{});var uF=a(Uc);Av=i(uF,"__call__"),uF.forEach(t),Ov=i(xd," special method."),xd.forEach(t),Nv=h(Js),y(Yn.$$.fragment,Js),Iv=h(Js),y(Zn.$$.fragment,Js),Js.forEach(t),Pt.forEach(t),Cm=h(o),Po=s(o,"H2",{class:!0});var Nf=a(Po);es=s(Nf,"A",{id:!0,class:!0,href:!0});var gF=a(es);Hc=s(gF,"SPAN",{});var _F=a(Hc);y(Mr.$$.fragment,_F),_F.forEach(t),gF.forEach(t),Dv=h(Nf),Qc=s(Nf,"SPAN",{});var bF=a(Qc);Sv=i(bF,"TFRobertaForCausalLM"),bF.forEach(t),Nf.forEach(t),jm=h(o),Lo=s(o,"DIV",{class:!0});var If=a(Lo);y(Er.$$.fragment,If),Wv=h(If),xt=s(If,"DIV",{class:!0});var Ks=a(xt);y(zr.$$.fragment,Ks),Bv=h(Ks),Ao=s(Ks,"P",{});var Rd=a(Ao);Uv=i(Rd,"The "),Yl=s(Rd,"A",{href:!0});var kF=a(Yl);Hv=i(kF,"TFRobertaForCausalLM"),kF.forEach(t),Qv=i(Rd," forward method, overrides the "),Vc=s(Rd,"CODE",{});var vF=a(Vc);Vv=i(vF,"__call__"),vF.forEach(t),Jv=i(Rd," special method."),Rd.forEach(t),Kv=h(Ks),y(ts.$$.fragment,Ks),Gv=h(Ks),y(os.$$.fragment,Ks),Ks.forEach(t),If.forEach(t),Pm=h(o),Oo=s(o,"H2",{class:!0});var Df=a(Oo);ns=s(Df,"A",{id:!0,class:!0,href:!0});var TF=a(ns);Jc=s(TF,"SPAN",{});var yF=a(Jc);y(qr.$$.fragment,yF),yF.forEach(t),TF.forEach(t),Xv=h(Df),Kc=s(Df,"SPAN",{});var wF=a(Kc);Yv=i(wF,"TFRobertaForMaskedLM"),wF.forEach(t),Df.forEach(t),Lm=h(o),Qe=s(o,"DIV",{class:!0});var Lt=a(Qe);y(Cr.$$.fragment,Lt),Zv=h(Lt),jr=s(Lt,"P",{});var Sf=a(jr);eT=i(Sf,"RoBERTa Model with a "),Gc=s(Sf,"CODE",{});var $F=a(Gc);tT=i($F,"language modeling"),$F.forEach(t),oT=i(Sf," head on top."),Sf.forEach(t),nT=h(Lt),Pr=s(Lt,"P",{});var Wf=a(Pr);sT=i(Wf,"This model inherits from "),Zl=s(Wf,"A",{href:!0});var FF=a(Zl);aT=i(FF,"TFPreTrainedModel"),FF.forEach(t),rT=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),iT=h(Lt),Lr=s(Lt,"P",{});var Bf=a(Lr);lT=i(Bf,"This model is also a "),Ar=s(Bf,"A",{href:!0,rel:!0});var xF=a(Ar);dT=i(xF,"tf.keras.Model"),xF.forEach(t),cT=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),pT=h(Lt),y(ss.$$.fragment,Lt),hT=h(Lt),dt=s(Lt,"DIV",{class:!0});var io=a(dt);y(Or.$$.fragment,io),mT=h(io),No=s(io,"P",{});var Md=a(No);fT=i(Md,"The "),ed=s(Md,"A",{href:!0});var RF=a(ed);uT=i(RF,"TFRobertaForMaskedLM"),RF.forEach(t),gT=i(Md," forward method, overrides the "),Xc=s(Md,"CODE",{});var MF=a(Xc);_T=i(MF,"__call__"),MF.forEach(t),bT=i(Md," special method."),Md.forEach(t),kT=h(io),y(as.$$.fragment,io),vT=h(io),y(rs.$$.fragment,io),TT=h(io),y(is.$$.fragment,io),io.forEach(t),Lt.forEach(t),Am=h(o),Io=s(o,"H2",{class:!0});var Uf=a(Io);ls=s(Uf,"A",{id:!0,class:!0,href:!0});var EF=a(ls);Yc=s(EF,"SPAN",{});var zF=a(Yc);y(Nr.$$.fragment,zF),zF.forEach(t),EF.forEach(t),yT=h(Uf),Zc=s(Uf,"SPAN",{});var qF=a(Zc);wT=i(qF,"TFRobertaForSequenceClassification"),qF.forEach(t),Uf.forEach(t),Om=h(o),Ve=s(o,"DIV",{class:!0});var At=a(Ve);y(Ir.$$.fragment,At),$T=h(At),ep=s(At,"P",{});var CF=a(ep);FT=i(CF,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),CF.forEach(t),xT=h(At),Dr=s(At,"P",{});var Hf=a(Dr);RT=i(Hf,"This model inherits from "),td=s(Hf,"A",{href:!0});var jF=a(td);MT=i(jF,"TFPreTrainedModel"),jF.forEach(t),ET=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hf.forEach(t),zT=h(At),Sr=s(At,"P",{});var Qf=a(Sr);qT=i(Qf,"This model is also a "),Wr=s(Qf,"A",{href:!0,rel:!0});var PF=a(Wr);CT=i(PF,"tf.keras.Model"),PF.forEach(t),jT=i(Qf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qf.forEach(t),PT=h(At),y(ds.$$.fragment,At),LT=h(At),ct=s(At,"DIV",{class:!0});var lo=a(ct);y(Br.$$.fragment,lo),AT=h(lo),Do=s(lo,"P",{});var Ed=a(Do);OT=i(Ed,"The "),od=s(Ed,"A",{href:!0});var LF=a(od);NT=i(LF,"TFRobertaForSequenceClassification"),LF.forEach(t),IT=i(Ed," forward method, overrides the "),tp=s(Ed,"CODE",{});var AF=a(tp);DT=i(AF,"__call__"),AF.forEach(t),ST=i(Ed," special method."),Ed.forEach(t),WT=h(lo),y(cs.$$.fragment,lo),BT=h(lo),y(ps.$$.fragment,lo),UT=h(lo),y(hs.$$.fragment,lo),lo.forEach(t),At.forEach(t),Nm=h(o),So=s(o,"H2",{class:!0});var Vf=a(So);ms=s(Vf,"A",{id:!0,class:!0,href:!0});var OF=a(ms);op=s(OF,"SPAN",{});var NF=a(op);y(Ur.$$.fragment,NF),NF.forEach(t),OF.forEach(t),HT=h(Vf),np=s(Vf,"SPAN",{});var IF=a(np);QT=i(IF,"TFRobertaForMultipleChoice"),IF.forEach(t),Vf.forEach(t),Im=h(o),Je=s(o,"DIV",{class:!0});var Ot=a(Je);y(Hr.$$.fragment,Ot),VT=h(Ot),sp=s(Ot,"P",{});var DF=a(sp);JT=i(DF,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DF.forEach(t),KT=h(Ot),Qr=s(Ot,"P",{});var Jf=a(Qr);GT=i(Jf,"This model inherits from "),nd=s(Jf,"A",{href:!0});var SF=a(nd);XT=i(SF,"TFPreTrainedModel"),SF.forEach(t),YT=i(Jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jf.forEach(t),ZT=h(Ot),Vr=s(Ot,"P",{});var Kf=a(Vr);ey=i(Kf,"This model is also a "),Jr=s(Kf,"A",{href:!0,rel:!0});var WF=a(Jr);ty=i(WF,"tf.keras.Model"),WF.forEach(t),oy=i(Kf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kf.forEach(t),ny=h(Ot),y(fs.$$.fragment,Ot),sy=h(Ot),Rt=s(Ot,"DIV",{class:!0});var Gs=a(Rt);y(Kr.$$.fragment,Gs),ay=h(Gs),Wo=s(Gs,"P",{});var zd=a(Wo);ry=i(zd,"The "),sd=s(zd,"A",{href:!0});var BF=a(sd);iy=i(BF,"TFRobertaForMultipleChoice"),BF.forEach(t),ly=i(zd," forward method, overrides the "),ap=s(zd,"CODE",{});var UF=a(ap);dy=i(UF,"__call__"),UF.forEach(t),cy=i(zd," special method."),zd.forEach(t),py=h(Gs),y(us.$$.fragment,Gs),hy=h(Gs),y(gs.$$.fragment,Gs),Gs.forEach(t),Ot.forEach(t),Dm=h(o),Bo=s(o,"H2",{class:!0});var Gf=a(Bo);_s=s(Gf,"A",{id:!0,class:!0,href:!0});var HF=a(_s);rp=s(HF,"SPAN",{});var QF=a(rp);y(Gr.$$.fragment,QF),QF.forEach(t),HF.forEach(t),my=h(Gf),ip=s(Gf,"SPAN",{});var VF=a(ip);fy=i(VF,"TFRobertaForTokenClassification"),VF.forEach(t),Gf.forEach(t),Sm=h(o),Ke=s(o,"DIV",{class:!0});var Nt=a(Ke);y(Xr.$$.fragment,Nt),uy=h(Nt),lp=s(Nt,"P",{});var JF=a(lp);gy=i(JF,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),JF.forEach(t),_y=h(Nt),Yr=s(Nt,"P",{});var Xf=a(Yr);by=i(Xf,"This model inherits from "),ad=s(Xf,"A",{href:!0});var KF=a(ad);ky=i(KF,"TFPreTrainedModel"),KF.forEach(t),vy=i(Xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xf.forEach(t),Ty=h(Nt),Zr=s(Nt,"P",{});var Yf=a(Zr);yy=i(Yf,"This model is also a "),ei=s(Yf,"A",{href:!0,rel:!0});var GF=a(ei);wy=i(GF,"tf.keras.Model"),GF.forEach(t),$y=i(Yf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yf.forEach(t),Fy=h(Nt),y(bs.$$.fragment,Nt),xy=h(Nt),pt=s(Nt,"DIV",{class:!0});var co=a(pt);y(ti.$$.fragment,co),Ry=h(co),Uo=s(co,"P",{});var qd=a(Uo);My=i(qd,"The "),rd=s(qd,"A",{href:!0});var XF=a(rd);Ey=i(XF,"TFRobertaForTokenClassification"),XF.forEach(t),zy=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var YF=a(dp);qy=i(YF,"__call__"),YF.forEach(t),Cy=i(qd," special method."),qd.forEach(t),jy=h(co),y(ks.$$.fragment,co),Py=h(co),y(vs.$$.fragment,co),Ly=h(co),y(Ts.$$.fragment,co),co.forEach(t),Nt.forEach(t),Wm=h(o),Ho=s(o,"H2",{class:!0});var Zf=a(Ho);ys=s(Zf,"A",{id:!0,class:!0,href:!0});var ZF=a(ys);cp=s(ZF,"SPAN",{});var e0=a(cp);y(oi.$$.fragment,e0),e0.forEach(t),ZF.forEach(t),Ay=h(Zf),pp=s(Zf,"SPAN",{});var t0=a(pp);Oy=i(t0,"TFRobertaForQuestionAnswering"),t0.forEach(t),Zf.forEach(t),Bm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);y(ni.$$.fragment,It),Ny=h(It),Qo=s(It,"P",{});var Cd=a(Qo);Iy=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Cd,"CODE",{});var o0=a(hp);Dy=i(o0,"span start logits"),o0.forEach(t),Sy=i(Cd," and "),mp=s(Cd,"CODE",{});var n0=a(mp);Wy=i(n0,"span end logits"),n0.forEach(t),By=i(Cd,")."),Cd.forEach(t),Uy=h(It),si=s(It,"P",{});var eu=a(si);Hy=i(eu,"This model inherits from "),id=s(eu,"A",{href:!0});var s0=a(id);Qy=i(s0,"TFPreTrainedModel"),s0.forEach(t),Vy=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),Jy=h(It),ai=s(It,"P",{});var tu=a(ai);Ky=i(tu,"This model is also a "),ri=s(tu,"A",{href:!0,rel:!0});var a0=a(ri);Gy=i(a0,"tf.keras.Model"),a0.forEach(t),Xy=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Yy=h(It),y(ws.$$.fragment,It),Zy=h(It),ht=s(It,"DIV",{class:!0});var po=a(ht);y(ii.$$.fragment,po),ew=h(po),Vo=s(po,"P",{});var jd=a(Vo);tw=i(jd,"The "),ld=s(jd,"A",{href:!0});var r0=a(ld);ow=i(r0,"TFRobertaForQuestionAnswering"),r0.forEach(t),nw=i(jd," forward method, overrides the "),fp=s(jd,"CODE",{});var i0=a(fp);sw=i(i0,"__call__"),i0.forEach(t),aw=i(jd," special method."),jd.forEach(t),rw=h(po),y($s.$$.fragment,po),iw=h(po),y(Fs.$$.fragment,po),lw=h(po),y(xs.$$.fragment,po),po.forEach(t),It.forEach(t),Um=h(o),Jo=s(o,"H2",{class:!0});var ou=a(Jo);Rs=s(ou,"A",{id:!0,class:!0,href:!0});var l0=a(Rs);up=s(l0,"SPAN",{});var d0=a(up);y(li.$$.fragment,d0),d0.forEach(t),l0.forEach(t),dw=h(ou),gp=s(ou,"SPAN",{});var c0=a(gp);cw=i(c0,"FlaxRobertaModel"),c0.forEach(t),ou.forEach(t),Hm=h(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(di.$$.fragment,ut),pw=h(ut),_p=s(ut,"P",{});var p0=a(_p);hw=i(p0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),p0.forEach(t),mw=h(ut),ci=s(ut,"P",{});var nu=a(ci);fw=i(nu,"This model inherits from "),dd=s(nu,"A",{href:!0});var h0=a(dd);uw=i(h0,"FlaxPreTrainedModel"),h0.forEach(t),gw=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),nu.forEach(t),_w=h(ut),pi=s(ut,"P",{});var su=a(pi);bw=i(su,"This model is also a Flax Linen "),hi=s(su,"A",{href:!0,rel:!0});var m0=a(hi);kw=i(m0,"flax.linen.Module"),m0.forEach(t),vw=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),Tw=h(ut),bp=s(ut,"P",{});var f0=a(bp);yw=i(f0,"Finally, this model supports inherent JAX features such as:"),f0.forEach(t),ww=h(ut),St=s(ut,"UL",{});var Xs=a(St);kp=s(Xs,"LI",{});var u0=a(kp);mi=s(u0,"A",{href:!0,rel:!0});var g0=a(mi);$w=i(g0,"Just-In-Time (JIT) compilation"),g0.forEach(t),u0.forEach(t),Fw=h(Xs),vp=s(Xs,"LI",{});var _0=a(vp);fi=s(_0,"A",{href:!0,rel:!0});var b0=a(fi);xw=i(b0,"Automatic Differentiation"),b0.forEach(t),_0.forEach(t),Rw=h(Xs),Tp=s(Xs,"LI",{});var k0=a(Tp);ui=s(k0,"A",{href:!0,rel:!0});var v0=a(ui);Mw=i(v0,"Vectorization"),v0.forEach(t),k0.forEach(t),Ew=h(Xs),yp=s(Xs,"LI",{});var T0=a(yp);gi=s(T0,"A",{href:!0,rel:!0});var y0=a(gi);zw=i(y0,"Parallelization"),y0.forEach(t),T0.forEach(t),Xs.forEach(t),qw=h(ut),Mt=s(ut,"DIV",{class:!0});var Ys=a(Mt);y(_i.$$.fragment,Ys),Cw=h(Ys),Ko=s(Ys,"P",{});var Pd=a(Ko);jw=i(Pd,"The "),wp=s(Pd,"CODE",{});var w0=a(wp);Pw=i(w0,"FlaxRobertaPreTrainedModel"),w0.forEach(t),Lw=i(Pd," forward method, overrides the "),$p=s(Pd,"CODE",{});var $0=a($p);Aw=i($0,"__call__"),$0.forEach(t),Ow=i(Pd," special method."),Pd.forEach(t),Nw=h(Ys),y(Ms.$$.fragment,Ys),Iw=h(Ys),y(Es.$$.fragment,Ys),Ys.forEach(t),ut.forEach(t),Qm=h(o),Go=s(o,"H2",{class:!0});var au=a(Go);zs=s(au,"A",{id:!0,class:!0,href:!0});var F0=a(zs);Fp=s(F0,"SPAN",{});var x0=a(Fp);y(bi.$$.fragment,x0),x0.forEach(t),F0.forEach(t),Dw=h(au),xp=s(au,"SPAN",{});var R0=a(xp);Sw=i(R0,"FlaxRobertaForMaskedLM"),R0.forEach(t),au.forEach(t),Vm=h(o),Ne=s(o,"DIV",{class:!0});var gt=a(Ne);y(ki.$$.fragment,gt),Ww=h(gt),vi=s(gt,"P",{});var ru=a(vi);Bw=i(ru,"RoBERTa Model with a "),Rp=s(ru,"CODE",{});var M0=a(Rp);Uw=i(M0,"language modeling"),M0.forEach(t),Hw=i(ru," head on top."),ru.forEach(t),Qw=h(gt),Ti=s(gt,"P",{});var iu=a(Ti);Vw=i(iu,"This model inherits from "),cd=s(iu,"A",{href:!0});var E0=a(cd);Jw=i(E0,"FlaxPreTrainedModel"),E0.forEach(t),Kw=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Gw=h(gt),yi=s(gt,"P",{});var lu=a(yi);Xw=i(lu,"This model is also a Flax Linen "),wi=s(lu,"A",{href:!0,rel:!0});var z0=a(wi);Yw=i(z0,"flax.linen.Module"),z0.forEach(t),Zw=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),e1=h(gt),Mp=s(gt,"P",{});var q0=a(Mp);t1=i(q0,"Finally, this model supports inherent JAX features such as:"),q0.forEach(t),o1=h(gt),Wt=s(gt,"UL",{});var Zs=a(Wt);Ep=s(Zs,"LI",{});var C0=a(Ep);$i=s(C0,"A",{href:!0,rel:!0});var j0=a($i);n1=i(j0,"Just-In-Time (JIT) compilation"),j0.forEach(t),C0.forEach(t),s1=h(Zs),zp=s(Zs,"LI",{});var P0=a(zp);Fi=s(P0,"A",{href:!0,rel:!0});var L0=a(Fi);a1=i(L0,"Automatic Differentiation"),L0.forEach(t),P0.forEach(t),r1=h(Zs),qp=s(Zs,"LI",{});var A0=a(qp);xi=s(A0,"A",{href:!0,rel:!0});var O0=a(xi);i1=i(O0,"Vectorization"),O0.forEach(t),A0.forEach(t),l1=h(Zs),Cp=s(Zs,"LI",{});var N0=a(Cp);Ri=s(N0,"A",{href:!0,rel:!0});var I0=a(Ri);d1=i(I0,"Parallelization"),I0.forEach(t),N0.forEach(t),Zs.forEach(t),c1=h(gt),Et=s(gt,"DIV",{class:!0});var ea=a(Et);y(Mi.$$.fragment,ea),p1=h(ea),Xo=s(ea,"P",{});var Ld=a(Xo);h1=i(Ld,"The "),jp=s(Ld,"CODE",{});var D0=a(jp);m1=i(D0,"FlaxRobertaPreTrainedModel"),D0.forEach(t),f1=i(Ld," forward method, overrides the "),Pp=s(Ld,"CODE",{});var S0=a(Pp);u1=i(S0,"__call__"),S0.forEach(t),g1=i(Ld," special method."),Ld.forEach(t),_1=h(ea),y(qs.$$.fragment,ea),b1=h(ea),y(Cs.$$.fragment,ea),ea.forEach(t),gt.forEach(t),Jm=h(o),Yo=s(o,"H2",{class:!0});var du=a(Yo);js=s(du,"A",{id:!0,class:!0,href:!0});var W0=a(js);Lp=s(W0,"SPAN",{});var B0=a(Lp);y(Ei.$$.fragment,B0),B0.forEach(t),W0.forEach(t),k1=h(du),Ap=s(du,"SPAN",{});var U0=a(Ap);v1=i(U0,"FlaxRobertaForSequenceClassification"),U0.forEach(t),du.forEach(t),Km=h(o),Ie=s(o,"DIV",{class:!0});var _t=a(Ie);y(zi.$$.fragment,_t),T1=h(_t),Op=s(_t,"P",{});var H0=a(Op);y1=i(H0,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),H0.forEach(t),w1=h(_t),qi=s(_t,"P",{});var cu=a(qi);$1=i(cu,"This model inherits from "),pd=s(cu,"A",{href:!0});var Q0=a(pd);F1=i(Q0,"FlaxPreTrainedModel"),Q0.forEach(t),x1=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),cu.forEach(t),R1=h(_t),Ci=s(_t,"P",{});var pu=a(Ci);M1=i(pu,"This model is also a Flax Linen "),ji=s(pu,"A",{href:!0,rel:!0});var V0=a(ji);E1=i(V0,"flax.linen.Module"),V0.forEach(t),z1=i(pu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),q1=h(_t),Np=s(_t,"P",{});var J0=a(Np);C1=i(J0,"Finally, this model supports inherent JAX features such as:"),J0.forEach(t),j1=h(_t),Bt=s(_t,"UL",{});var ta=a(Bt);Ip=s(ta,"LI",{});var K0=a(Ip);Pi=s(K0,"A",{href:!0,rel:!0});var G0=a(Pi);P1=i(G0,"Just-In-Time (JIT) compilation"),G0.forEach(t),K0.forEach(t),L1=h(ta),Dp=s(ta,"LI",{});var X0=a(Dp);Li=s(X0,"A",{href:!0,rel:!0});var Y0=a(Li);A1=i(Y0,"Automatic Differentiation"),Y0.forEach(t),X0.forEach(t),O1=h(ta),Sp=s(ta,"LI",{});var Z0=a(Sp);Ai=s(Z0,"A",{href:!0,rel:!0});var ex=a(Ai);N1=i(ex,"Vectorization"),ex.forEach(t),Z0.forEach(t),I1=h(ta),Wp=s(ta,"LI",{});var tx=a(Wp);Oi=s(tx,"A",{href:!0,rel:!0});var ox=a(Oi);D1=i(ox,"Parallelization"),ox.forEach(t),tx.forEach(t),ta.forEach(t),S1=h(_t),zt=s(_t,"DIV",{class:!0});var oa=a(zt);y(Ni.$$.fragment,oa),W1=h(oa),Zo=s(oa,"P",{});var Ad=a(Zo);B1=i(Ad,"The "),Bp=s(Ad,"CODE",{});var nx=a(Bp);U1=i(nx,"FlaxRobertaPreTrainedModel"),nx.forEach(t),H1=i(Ad," forward method, overrides the "),Up=s(Ad,"CODE",{});var sx=a(Up);Q1=i(sx,"__call__"),sx.forEach(t),V1=i(Ad," special method."),Ad.forEach(t),J1=h(oa),y(Ps.$$.fragment,oa),K1=h(oa),y(Ls.$$.fragment,oa),oa.forEach(t),_t.forEach(t),Gm=h(o),en=s(o,"H2",{class:!0});var hu=a(en);As=s(hu,"A",{id:!0,class:!0,href:!0});var ax=a(As);Hp=s(ax,"SPAN",{});var rx=a(Hp);y(Ii.$$.fragment,rx),rx.forEach(t),ax.forEach(t),G1=h(hu),Qp=s(hu,"SPAN",{});var ix=a(Qp);X1=i(ix,"FlaxRobertaForMultipleChoice"),ix.forEach(t),hu.forEach(t),Xm=h(o),De=s(o,"DIV",{class:!0});var bt=a(De);y(Di.$$.fragment,bt),Y1=h(bt),Vp=s(bt,"P",{});var lx=a(Vp);Z1=i(lx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
