...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16944/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16944/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16944/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16944/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16944/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16944/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16944/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16944/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16944/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16944/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16944/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16944/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16944/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16944/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16944/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16944/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16944/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16944/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16944/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16944/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16944/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16944/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16944/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
splitting and wordpiece.`),ea.forEach(t),Gg=p(oo),ja=s(oo,"P",{});var Vl=a(ja);Xg=i(Vl,"Refer to superclass "),nd=s(Vl,"A",{href:!0});var Wm=a(nd);Yg=i(Wm,"BertTokenizerFast"),Wm.forEach(t),Zg=i(Vl," for usage examples and documentation concerning parameters."),Vl.forEach(t),oo.forEach(t),Gm=p(o),vo=s(o,"H2",{class:!0});var Bl=a(vo);En=s(Bl,"A",{id:!0,class:!0,href:!0});var Um=a(En);yc=s(Um,"SPAN",{});var Rm=a(yc);y(qa.$$.fragment,Rm),Rm.forEach(t),Um.forEach(t),e_=p(Bl),Ec=s(Bl,"SPAN",{});var Hm=a(Ec);t_=i(Hm,"Electra specific outputs"),Hm.forEach(t),Bl.forEach(t),Xm=p(o),To=s(o,"DIV",{class:!0});var Qf=a(To);y(Pa.$$.fragment,Qf),o_=p(Qf),Aa=s(Qf,"P",{});var Vf=a(Aa);n_=i(Vf,"Output type of "),sd=s(Vf,"A",{href:!0});var X2=a(sd);s_=i(X2,"ElectraForPreTraining"),X2.forEach(t),a_=i(Vf,"."),Vf.forEach(t),Qf.forEach(t),Ym=p(o),bo=s(o,"DIV",{class:!0});var Bf=a(bo);y(Oa.$$.fragment,Bf),r_=p(Bf),La=s(Bf,"P",{});var Kf=a(La);i_=i(Kf,"Output type of "),ad=s(Kf,"A",{href:!0});var Y2=a(ad);l_=i(Y2,"TFElectraForPreTraining"),Y2.forEach(t),d_=i(Kf,"."),Kf.forEach(t),Bf.forEach(t),Zm=p(o),yo=s(o,"H2",{class:!0});var Jf=a(yo);wn=s(Jf,"A",{id:!0,class:!0,href:!0});var Z2=a(wn);wc=s(Z2,"SPAN",{});var e4=a(wc);y(Na.$$.fragment,e4),e4.forEach(t),Z2.forEach(t),c_=p(Jf),$c=s(Jf,"SPAN",{});var t4=a($c);p_=i(t4,"ElectraModel"),t4.forEach(t),Jf.forEach(t),ef=p(o),Ze=s(o,"DIV",{class:!0});var no=a(Ze);y(Ia.$$.fragment,no),h_=p(no),Fc=s(no,"P",{});var o4=a(Fc);m_=i(o4,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),o4.forEach(t),f_=p(no),Sa=s(no,"P",{});var Gf=a(Sa);u_=i(Gf,"This model inherits from "),rd=s(Gf,"A",{href:!0});var n4=a(rd);g_=i(n4,"PreTrainedModel"),n4.forEach(t),__=i(Gf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gf.forEach(t),k_=p(no),Da=s(no,"P",{});var Xf=a(Da);v_=i(Xf,"This model is also a PyTorch "),Wa=s(Xf,"A",{href:!0,rel:!0});var s4=a(Wa);T_=i(s4,"torch.nn.Module"),s4.forEach(t),b_=i(Xf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xf.forEach(t),y_=p(no),Et=s(no,"DIV",{class:!0});var ta=a(Et);y(Ua.$$.fragment,ta),E_=p(ta),Eo=s(ta,"P",{});var Rd=a(Eo);w_=i(Rd,"The "),id=s(Rd,"A",{href:!0});var a4=a(id);$_=i(a4,"ElectraModel"),a4.forEach(t),F_=i(Rd," forward method, overrides the "),xc=s(Rd,"CODE",{});var r4=a(xc);x_=i(r4,"__call__"),r4.forEach(t),M_=i(Rd," special method."),Rd.forEach(t),z_=p(ta),y($n.$$.fragment,ta),C_=p(ta),y(Fn.$$.fragment,ta),ta.forEach(t),no.forEach(t),tf=p(o),wo=s(o,"H2",{class:!0});var Yf=a(wo);xn=s(Yf,"A",{id:!0,class:!0,href:!0});var i4=a(xn);Mc=s(i4,"SPAN",{});var l4=a(Mc);y(Ra.$$.fragment,l4),l4.forEach(t),i4.forEach(t),j_=p(Yf),zc=s(Yf,"SPAN",{});var d4=a(zc);q_=i(d4,"ElectraForPreTraining"),d4.forEach(t),Yf.forEach(t),of=p(o),He=s(o,"DIV",{class:!0});var Nt=a(He);y(Ha.$$.fragment,Nt),P_=p(Nt),Cc=s(Nt,"P",{});var c4=a(Cc);A_=i(c4,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),c4.forEach(t),O_=p(Nt),jc=s(Nt,"P",{});var p4=a(jc);L_=i(p4,"It is recommended to load the discriminator checkpoint into that model."),p4.forEach(t),N_=p(Nt),Qa=s(Nt,"P",{});var Zf=a(Qa);I_=i(Zf,"This model inherits from "),ld=s(Zf,"A",{href:!0});var h4=a(ld);S_=i(h4,"PreTrainedModel"),h4.forEach(t),D_=i(Zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zf.forEach(t),W_=p(Nt),Va=s(Nt,"P",{});var eu=a(Va);U_=i(eu,"This model is also a PyTorch "),Ba=s(eu,"A",{href:!0,rel:!0});var m4=a(Ba);R_=i(m4,"torch.nn.Module"),m4.forEach(t),H_=i(eu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eu.forEach(t),Q_=p(Nt),wt=s(Nt,"DIV",{class:!0});var oa=a(wt);y(Ka.$$.fragment,oa),V_=p(oa),$o=s(oa,"P",{});var Hd=a($o);B_=i(Hd,"The "),dd=s(Hd,"A",{href:!0});var f4=a(dd);K_=i(f4,"ElectraForPreTraining"),f4.forEach(t),J_=i(Hd," forward method, overrides the "),qc=s(Hd,"CODE",{});var u4=a(qc);G_=i(u4,"__call__"),u4.forEach(t),X_=i(Hd," special method."),Hd.forEach(t),Y_=p(oa),y(Mn.$$.fragment,oa),Z_=p(oa),y(zn.$$.fragment,oa),oa.forEach(t),Nt.forEach(t),nf=p(o),Fo=s(o,"H2",{class:!0});var tu=a(Fo);Cn=s(tu,"A",{id:!0,class:!0,href:!0});var g4=a(Cn);Pc=s(g4,"SPAN",{});var _4=a(Pc);y(Ja.$$.fragment,_4),_4.forEach(t),g4.forEach(t),ek=p(tu),Ac=s(tu,"SPAN",{});var k4=a(Ac);tk=i(k4,"ElectraForCausalLM"),k4.forEach(t),tu.forEach(t),sf=p(o),et=s(o,"DIV",{class:!0});var so=a(et);y(Ga.$$.fragment,so),ok=p(so),Xa=s(so,"P",{});var ou=a(Xa);nk=i(ou,"ELECTRA Model with a "),Oc=s(ou,"CODE",{});var v4=a(Oc);sk=i(v4,"language modeling"),v4.forEach(t),ak=i(ou," head on top for CLM fine-tuning."),ou.forEach(t),rk=p(so),Ya=s(so,"P",{});var nu=a(Ya);ik=i(nu,"This model inherits from "),cd=s(nu,"A",{href:!0});var T4=a(cd);lk=i(T4,"PreTrainedModel"),T4.forEach(t),dk=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nu.forEach(t),ck=p(so),Za=s(so,"P",{});var su=a(Za);pk=i(su,"This model is also a PyTorch "),er=s(su,"A",{href:!0,rel:!0});var b4=a(er);hk=i(b4,"torch.nn.Module"),b4.forEach(t),mk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),fk=p(so),$t=s(so,"DIV",{class:!0});var na=a($t);y(tr.$$.fragment,na),uk=p(na),xo=s(na,"P",{});var Qd=a(xo);gk=i(Qd,"The "),pd=s(Qd,"A",{href:!0});var y4=a(pd);_k=i(y4,"ElectraForCausalLM"),y4.forEach(t),kk=i(Qd," forward method, overrides the "),Lc=s(Qd,"CODE",{});var E4=a(Lc);vk=i(E4,"__call__"),E4.forEach(t),Tk=i(Qd," special method."),Qd.forEach(t),bk=p(na),y(jn.$$.fragment,na),yk=p(na),y(qn.$$.fragment,na),na.forEach(t),so.forEach(t),af=p(o),Mo=s(o,"H2",{class:!0});var au=a(Mo);Pn=s(au,"A",{id:!0,class:!0,href:!0});var w4=a(Pn);Nc=s(w4,"SPAN",{});var $4=a(Nc);y(or.$$.fragment,$4),$4.forEach(t),w4.forEach(t),Ek=p(au),Ic=s(au,"SPAN",{});var F4=a(Ic);wk=i(F4,"ElectraForMaskedLM"),F4.forEach(t),au.forEach(t),rf=p(o),Qe=s(o,"DIV",{class:!0});var It=a(Qe);y(nr.$$.fragment,It),$k=p(It),Sc=s(It,"P",{});var x4=a(Sc);Fk=i(x4,"Electra model with a language modeling head on top."),x4.forEach(t),xk=p(It),Dc=s(It,"P",{});var M4=a(Dc);Mk=i(M4,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),M4.forEach(t),zk=p(It),sr=s(It,"P",{});var ru=a(sr);Ck=i(ru,"This model inherits from "),hd=s(ru,"A",{href:!0});var z4=a(hd);jk=i(z4,"PreTrainedModel"),z4.forEach(t),qk=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ru.forEach(t),Pk=p(It),ar=s(It,"P",{});var iu=a(ar);Ak=i(iu,"This model is also a PyTorch "),rr=s(iu,"A",{href:!0,rel:!0});var C4=a(rr);Ok=i(C4,"torch.nn.Module"),C4.forEach(t),Lk=i(iu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),iu.forEach(t),Nk=p(It),st=s(It,"DIV",{class:!0});var ao=a(st);y(ir.$$.fragment,ao),Ik=p(ao),zo=s(ao,"P",{});var Vd=a(zo);Sk=i(Vd,"The "),md=s(Vd,"A",{href:!0});var j4=a(md);Dk=i(j4,"ElectraForMaskedLM"),j4.forEach(t),Wk=i(Vd," forward method, overrides the "),Wc=s(Vd,"CODE",{});var q4=a(Wc);Uk=i(q4,"__call__"),q4.forEach(t),Rk=i(Vd," special method."),Vd.forEach(t),Hk=p(ao),y(An.$$.fragment,ao),Qk=p(ao),y(On.$$.fragment,ao),Vk=p(ao),y(Ln.$$.fragment,ao),ao.forEach(t),It.forEach(t),lf=p(o),Co=s(o,"H2",{class:!0});var lu=a(Co);Nn=s(lu,"A",{id:!0,class:!0,href:!0});var P4=a(Nn);Uc=s(P4,"SPAN",{});var A4=a(Uc);y(lr.$$.fragment,A4),A4.forEach(t),P4.forEach(t),Bk=p(lu),Rc=s(lu,"SPAN",{});var O4=a(Rc);Kk=i(O4,"ElectraForSequenceClassification"),O4.forEach(t),lu.forEach(t),df=p(o),tt=s(o,"DIV",{class:!0});var ro=a(tt);y(dr.$$.fragment,ro),Jk=p(ro),Hc=s(ro,"P",{});var L4=a(Hc);Gk=i(L4,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),L4.forEach(t),Xk=p(ro),cr=s(ro,"P",{});var du=a(cr);Yk=i(du,"This model inherits from "),fd=s(du,"A",{href:!0});var N4=a(fd);Zk=i(N4,"PreTrainedModel"),N4.forEach(t),ev=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),du.forEach(t),tv=p(ro),pr=s(ro,"P",{});var cu=a(pr);ov=i(cu,"This model is also a PyTorch "),hr=s(cu,"A",{href:!0,rel:!0});var I4=a(hr);nv=i(I4,"torch.nn.Module"),I4.forEach(t),sv=i(cu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cu.forEach(t),av=p(ro),Re=s(ro,"DIV",{class:!0});var pt=a(Re);y(mr.$$.fragment,pt),rv=p(pt),jo=s(pt,"P",{});var Bd=a(jo);iv=i(Bd,"The "),ud=s(Bd,"A",{href:!0});var S4=a(ud);lv=i(S4,"ElectraForSequenceClassification"),S4.forEach(t),dv=i(Bd," forward method, overrides the "),Qc=s(Bd,"CODE",{});var D4=a(Qc);cv=i(D4,"__call__"),D4.forEach(t),pv=i(Bd," special method."),Bd.forEach(t),hv=p(pt),y(In.$$.fragment,pt),mv=p(pt),y(Sn.$$.fragment,pt),fv=p(pt),y(Dn.$$.fragment,pt),uv=p(pt),y(Wn.$$.fragment,pt),gv=p(pt),y(Un.$$.fragment,pt),pt.forEach(t),ro.forEach(t),cf=p(o),qo=s(o,"H2",{class:!0});var pu=a(qo);Rn=s(pu,"A",{id:!0,class:!0,href:!0});var W4=a(Rn);Vc=s(W4,"SPAN",{});var U4=a(Vc);y(fr.$$.fragment,U4),U4.forEach(t),W4.forEach(t),_v=p(pu),Bc=s(pu,"SPAN",{});var R4=a(Bc);kv=i(R4,"ElectraForMultipleChoice"),R4.forEach(t),pu.forEach(t),pf=p(o),ot=s(o,"DIV",{class:!0});var io=a(ot);y(ur.$$.fragment,io),vv=p(io),Kc=s(io,"P",{});var H4=a(Kc);Tv=i(H4,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),H4.forEach(t),bv=p(io),gr=s(io,"P",{});var hu=a(gr);yv=i(hu,"This model inherits from "),gd=s(hu,"A",{href:!0});var Q4=a(gd);Ev=i(Q4,"PreTrainedModel"),Q4.forEach(t),wv=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hu.forEach(t),$v=p(io),_r=s(io,"P",{});var mu=a(_r);Fv=i(mu,"This model is also a PyTorch "),kr=s(mu,"A",{href:!0,rel:!0});var V4=a(kr);xv=i(V4,"torch.nn.Module"),V4.forEach(t),Mv=i(mu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mu.forEach(t),zv=p(io),Ft=s(io,"DIV",{class:!0});var sa=a(Ft);y(vr.$$.fragment,sa),Cv=p(sa),Po=s(sa,"P",{});var Kd=a(Po);jv=i(Kd,"The "),_d=s(Kd,"A",{href:!0});var B4=a(_d);qv=i(B4,"ElectraForMultipleChoice"),B4.forEach(t),Pv=i(Kd," forward method, overrides the "),Jc=s(Kd,"CODE",{});var K4=a(Jc);Av=i(K4,"__call__"),K4.forEach(t),Ov=i(Kd," special method."),Kd.forEach(t),Lv=p(sa),y(Hn.$$.fragment,sa),Nv=p(sa),y(Qn.$$.fragment,sa),sa.forEach(t),io.forEach(t),hf=p(o),Ao=s(o,"H2",{class:!0});var fu=a(Ao);Vn=s(fu,"A",{id:!0,class:!0,href:!0});var J4=a(Vn);Gc=s(J4,"SPAN",{});var G4=a(Gc);y(Tr.$$.fragment,G4),G4.forEach(t),J4.forEach(t),Iv=p(fu),Xc=s(fu,"SPAN",{});var X4=a(Xc);Sv=i(X4,"ElectraForTokenClassification"),X4.forEach(t),fu.forEach(t),mf=p(o),Ve=s(o,"DIV",{class:!0});var St=a(Ve);y(br.$$.fragment,St),Dv=p(St),Yc=s(St,"P",{});var Y4=a(Yc);Wv=i(Y4,"Electra model with a token classification head on top."),Y4.forEach(t),Uv=p(St),Zc=s(St,"P",{});var Z4=a(Zc);Rv=i(Z4,"Both the discriminator and generator may be loaded into this model."),Z4.forEach(t),Hv=p(St),yr=s(St,"P",{});var uu=a(yr);Qv=i(uu,"This model inherits from "),kd=s(uu,"A",{href:!0});var eF=a(kd);Vv=i(eF,"PreTrainedModel"),eF.forEach(t),Bv=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),Kv=p(St),Er=s(St,"P",{});var gu=a(Er);Jv=i(gu,"This model is also a PyTorch "),wr=s(gu,"A",{href:!0,rel:!0});var tF=a(wr);Gv=i(tF,"torch.nn.Module"),tF.forEach(t),Xv=i(gu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gu.forEach(t),Yv=p(St),at=s(St,"DIV",{class:!0});var lo=a(at);y($r.$$.fragment,lo),Zv=p(lo),Oo=s(lo,"P",{});var Jd=a(Oo);eT=i(Jd,"The "),vd=s(Jd,"A",{href:!0});var oF=a(vd);tT=i(oF,"ElectraForTokenClassification"),oF.forEach(t),oT=i(Jd," forward method, overrides the "),ep=s(Jd,"CODE",{});var nF=a(ep);nT=i(nF,"__call__"),nF.forEach(t),sT=i(Jd," special method."),Jd.forEach(t),aT=p(lo),y(Bn.$$.fragment,lo),rT=p(lo),y(Kn.$$.fragment,lo),iT=p(lo),y(Jn.$$.fragment,lo),lo.forEach(t),St.forEach(t),ff=p(o),Lo=s(o,"H2",{class:!0});var _u=a(Lo);Gn=s(_u,"A",{id:!0,class:!0,href:!0});var sF=a(Gn);tp=s(sF,"SPAN",{});var aF=a(tp);y(Fr.$$.fragment,aF),aF.forEach(t),sF.forEach(t),lT=p(_u),op=s(_u,"SPAN",{});var rF=a(op);dT=i(rF,"ElectraForQuestionAnswering"),rF.forEach(t),_u.forEach(t),uf=p(o),nt=s(o,"DIV",{class:!0});var co=a(nt);y(xr.$$.fragment,co),cT=p(co),No=s(co,"P",{});var Gd=a(No);pT=i(Gd,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),np=s(Gd,"CODE",{});var iF=a(np);hT=i(iF,"span start logits"),iF.forEach(t),mT=i(Gd," and "),sp=s(Gd,"CODE",{});var lF=a(sp);fT=i(lF,"span end logits"),lF.forEach(t),uT=i(Gd,")."),Gd.forEach(t),gT=p(co),Mr=s(co,"P",{});var ku=a(Mr);_T=i(ku,"This model inherits from "),Td=s(ku,"A",{href:!0});var dF=a(Td);kT=i(dF,"PreTrainedModel"),dF.forEach(t),vT=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),TT=p(co),zr=s(co,"P",{});var vu=a(zr);bT=i(vu,"This model is also a PyTorch "),Cr=s(vu,"A",{href:!0,rel:!0});var cF=a(Cr);yT=i(cF,"torch.nn.Module"),cF.forEach(t),ET=i(vu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vu.forEach(t),wT=p(co),rt=s(co,"DIV",{class:!0});var po=a(rt);y(jr.$$.fragment,po),$T=p(po),Io=s(po,"P",{});var Xd=a(Io);FT=i(Xd,"The "),bd=s(Xd,"A",{href:!0});var pF=a(bd);xT=i(pF,"ElectraForQuestionAnswering"),pF.forEach(t),MT=i(Xd," forward method, overrides the "),ap=s(Xd,"CODE",{});var hF=a(ap);zT=i(hF,"__call__"),hF.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=p(po),y(Xn.$$.fragment,po),qT=p(po),y(Yn.$$.fragment,po),PT=p(po),y(Zn.$$.fragment,po),po.forEach(t),co.forEach(t),gf=p(o),So=s(o,"H2",{class:!0});var Tu=a(So);es=s(Tu,"A",{id:!0,class:!0,href:!0});var mF=a(es);rp=s(mF,"SPAN",{});var fF=a(rp);y(qr.$$.fragment,fF),fF.forEach(t),mF.forEach(t),AT=p(Tu),ip=s(Tu,"SPAN",{});var uF=a(ip);OT=i(uF,"TFElectraModel"),uF.forEach(t),Tu.forEach(t),_f=p(o),Be=s(o,"DIV",{class:!0});var Dt=a(Be);y(Pr.$$.fragment,Dt),LT=p(Dt),lp=s(Dt,"P",{});var gF=a(lp);NT=i(gF,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),gF.forEach(t),IT=p(Dt),Ar=s(Dt,"P",{});var bu=a(Ar);ST=i(bu,"This model inherits from "),yd=s(bu,"A",{href:!0});var _F=a(yd);DT=i(_F,"TFPreTrainedModel"),_F.forEach(t),WT=i(bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bu.forEach(t),UT=p(Dt),Or=s(Dt,"P",{});var yu=a(Or);RT=i(yu,"This model is also a "),Lr=s(yu,"A",{href:!0,rel:!0});var kF=a(Lr);HT=i(kF,"tf.keras.Model"),kF.forEach(t),QT=i(yu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yu.forEach(t),VT=p(Dt),y(ts.$$.fragment,Dt),BT=p(Dt),xt=s(Dt,"DIV",{class:!0});var aa=a(xt);y(Nr.$$.fragment,aa),KT=p(aa),Do=s(aa,"P",{});var Yd=a(Do);JT=i(Yd,"The "),Ed=s(Yd,"A",{href:!0});var vF=a(Ed);GT=i(vF,"TFElectraModel"),vF.forEach(t),XT=i(Yd," forward method, overrides the "),dp=s(Yd,"CODE",{});var TF=a(dp);YT=i(TF,"__call__"),TF.forEach(t),ZT=i(Yd," special method."),Yd.forEach(t),eb=p(aa),y(os.$$.fragment,aa),tb=p(aa),y(ns.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),kf=p(o),Wo=s(o,"H2",{class:!0});var Eu=a(Wo);ss=s(Eu,"A",{id:!0,class:!0,href:!0});var bF=a(ss);cp=s(bF,"SPAN",{});var yF=a(cp);y(Ir.$$.fragment,yF),yF.forEach(t),bF.forEach(t),ob=p(Eu),pp=s(Eu,"SPAN",{});var EF=a(pp);nb=i(EF,"TFElectraForPreTraining"),EF.forEach(t),Eu.forEach(t),vf=p(o),Oe=s(o,"DIV",{class:!0});var ht=a(Oe);y(Sr.$$.fragment,ht),sb=p(ht),hp=s(ht,"P",{});var wF=a(hp);ab=i(wF,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),wF.forEach(t),rb=p(ht),mp=s(ht,"P",{});var $F=a(mp);ib=i($F,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),gb=p(ht),y(as.$$.fragment,ht),_b=p(ht),Mt=s(ht,"DIV",{class:!0});var ra=a(Mt);y(Rr.$$.fragment,ra),kb=p(ra),Uo=s(ra,"P",{});var Zd=a(Uo);vb=i(Zd,"The "),$d=s(Zd,"A",{href:!0});var MF=a($d);Tb=i(MF,"TFElectraForPreTraining"),MF.forEach(t),bb=i(Zd," forward method, overrides the "),fp=s(Zd,"CODE",{});var zF=a(fp);yb=i(zF,"__call__"),zF.forEach(t),Eb=i(Zd," special method."),Zd.forEach(t),wb=p(ra),y(rs.$$.fragment,ra),$b=p(ra),y(is.$$.fragment,ra),ra.forEach(t),ht.forEach(t),Tf=p(o),Ro=s(o,"H2",{class:!0});var Fu=a(Ro);ls=s(Fu,"A",{id:!0,class:!0,href:!0});var CF=a(ls);up=s(CF,"SPAN",{});var jF=a(up);y(Hr.$$.fragment,jF),jF.forEach(t),CF.forEach(t),Fb=p(Fu),gp=s(Fu,"SPAN",{});var qF=a(gp);xb=i(qF,"TFElectraForMaskedLM"),qF.forEach(t),Fu.forEach(t),bf=p(o),Le=s(o,"DIV",{class:!0});var mt=a(Le);y(Qr.$$.fragment,mt),Mb=p(mt),_p=s(mt,"P",{});var PF=a(_p);zb=i(PF,"Electra model with a language modeling head on top."),PF.forEach(t),Cb=p(mt),kp=s(mt,"P",{});var AF=a(kp);jb=i(AF,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mu.forEach(t),Db=p(mt),y(ds.$$.fragment,mt),Wb=p(mt),it=s(mt,"DIV",{class:!0});var ho=a(it);y(Jr.$$.fragment,ho),Ub=p(ho),Ho=s(ho,"P",{});var ec=a(Ho);Rb=i(ec,"The "),xd=s(ec,"A",{href:!0});var NF=a(xd);Hb=i(NF,"TFElectraForMaskedLM"),NF.forEach(t),Qb=i(ec," forward method, overrides the "),vp=s(ec,"CODE",{});var IF=a(vp);Vb=i(IF,"__call__"),IF.forEach(t),Bb=i(ec," special method."),ec.forEach(t),Kb=p(ho),y(cs.$$.fragment,ho),Jb=p(ho),y(ps.$$.fragment,ho),Gb=p(ho),y(hs.$$.fragment,ho),ho.forEach(t),mt.forEach(t),yf=p(o),Qo=s(o,"H2",{class:!0});var zu=a(Qo);ms=s(zu,"A",{id:!0,class:!0,href:!0});var SF=a(ms);Tp=s(SF,"SPAN",{});var DF=a(Tp);y(Gr.$$.fragment,DF),DF.forEach(t),SF.forEach(t),Xb=p(zu),bp=s(zu,"SPAN",{});var WF=a(bp);Yb=i(WF,"TFElectraForSequenceClassification"),WF.forEach(t),zu.forEach(t),Ef=p(o),Ke=s(o,"DIV",{class:!0});var Wt=a(Ke);y(Xr.$$.fragment,Wt),Zb=p(Wt),yp=s(Wt,"P",{});var UF=a(yp);ey=i(UF,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=p(Wt),y(fs.$$.fragment,Wt),cy=p(Wt),lt=s(Wt,"DIV",{class:!0});var mo=a(lt);y(ti.$$.fragment,mo),py=p(mo),Vo=s(mo,"P",{});var tc=a(Vo);hy=i(tc,"The "),zd=s(tc,"A",{href:!0});var QF=a(zd);my=i(QF,"TFElectraForSequenceClassification"),QF.forEach(t),fy=i(tc," forward method, overrides the "),Ep=s(tc,"CODE",{});var VF=a(Ep);uy=i(VF,"__call__"),VF.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=p(mo),y(us.$$.fragment,mo),ky=p(mo),y(gs.$$.fragment,mo),vy=p(mo),y(_s.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),wf=p(o),Bo=s(o,"H2",{class:!0});var qu=a(Bo);ks=s(qu,"A",{id:!0,class:!0,href:!0});var BF=a(ks);wp=s(BF,"SPAN",{});var KF=a(wp);y(oi.$$.fragment,KF),KF.forEach(t),BF.forEach(t),Ty=p(qu),$p=s(qu,"SPAN",{});var JF=a($p);by=i(JF,"TFElectraForMultipleChoice"),JF.forEach(t),qu.forEach(t),$f=p(o),Je=s(o,"DIV",{class:!0});var Ut=a(Je);y(ni.$$.fragment,Ut),yy=p(Ut),Fp=s(Ut,"P",{});var GF=a(Fp);Ey=i(GF,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
