import{S as du,i as iu,s as cu,e as n,k as i,w as y,t as s,M as pu,c as a,d as o,m as c,a as r,x as v,h as l,b as m,F as e,g as _,y as T,q as w,o as $,B as S,v as mu,L as Xe}from"../../chunks/vendor-6b77c823.js";import{T as qn}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-1088f2fb.js";import{C as Ye}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as xe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Je}from"../../chunks/ExampleCodeBlock-5212b321.js";function hu(z){let p,k,f,h,b;return h=new Ye({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">512</span>]`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(h.$$.fragment)},l(d){p=a(d,"P",{});var u=r(p);k=l(u,"Example:"),u.forEach(o),f=c(d),v(h.$$.fragment,d)},m(d,u){_(d,p,u),e(p,k),_(d,f,u),T(h,d,u),b=!0},p:Xe,i(d){b||(w(h.$$.fragment,d),b=!0)},o(d){$(h.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(h,d)}}}function _u(z){let p,k,f,h,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),h=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var u=r(p);k=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(u,"CODE",{});var F=r(f);h=l(F,"Module"),F.forEach(o),b=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),H=a(ve,"CODE",{});var Te=r(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ve.forEach(o),Y.forEach(o)},m(x,q){_(x,p,q),e(p,k),_(x,f,q),_(x,h,q),e(h,b),e(b,d),e(h,u),e(h,F),e(F,Ce),_(x,he,q),_(x,B,q),e(B,je),e(B,W),e(W,Oe),e(B,Pe),e(B,R),e(R,Le),e(B,Ne),_(x,V,q),_(x,Q,q),e(Q,Ie),_(x,Z,q),_(x,j,q),e(j,L),e(L,ue),e(L,ae),e(ae,Be),e(L,J),e(L,D),e(D,be),e(j,re),e(j,N),e(N,ke),e(N,se),e(se,ze),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,Fe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(h),x&&o(he),x&&o(B),x&&o(V),x&&o(Q),x&&o(Z),x&&o(j)}}}function yu(z){let p,k,f,h,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),h=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var u=r(p);k=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(u,"CODE",{});var F=r(f);h=l(F,"Module"),F.forEach(o),b=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(d,u){_(d,p,u),e(p,k),e(p,f),e(f,h),e(p,b)},d(d){d&&o(p)}}}function vu(z){let p,k,f,h,b;return h=new Ye({props:{code:`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(h.$$.fragment)},l(d){p=a(d,"P",{});var u=r(p);k=l(u,"Example:"),u.forEach(o),f=c(d),v(h.$$.fragment,d)},m(d,u){_(d,p,u),e(p,k),_(d,f,u),T(h,d,u),b=!0},p:Xe,i(d){b||(w(h.$$.fragment,d),b=!0)},o(d){$(h.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(h,d)}}}function xu(z){let p,k,f,h,b;return h=new Ye({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(h.$$.fragment)},l(d){p=a(d,"P",{});var u=r(p);k=l(u,"Example:"),u.forEach(o),f=c(d),v(h.$$.fragment,d)},m(d,u){_(d,p,u),e(p,k),_(d,f,u),T(h,d,u),b=!0},p:Xe,i(d){b||(w(h.$$.fragment,d),b=!0)},o(d){$(h.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(h,d)}}}function qu(z){let p,k,f,h,b,d,u,F,Ce,he,B,je,W,Oe,Pe,R,Le,Ne,V,Q,Ie,Z,j,L,ue,ae,Be,J,D,be,re,N,ke,se,ze,ee,le,de,Ae,X,Fe,H,De,x,q,ie,Ze,Re,O,eo,ye,oo,Y,G,to,no,oe,ce,fe,ve,Te,ml,sa,hl,cs,we,ht,ul,ao,fl,En,_l,gl,ut,bl,kl,yl,ro,vl,Mn,Tl,wl,Cn,$l,Sl,xl,wo,ps,so,$o,la,ft,Bl,da,zl,ms,U,_t,Fl,ia,ql,El,gt,Ml,jn,Cl,jl,Ol,He,bt,Pl,ca,Ll,Nl,pa,Il,Al,So,kt,Dl,lo,Gl,ma,Ul,Wl,ha,Rl,Hl,Kl,Ke,yt,Vl,On,Ql,Pn,Jl,Xl,ua,Yl,Zl,Ln,vt,hs,io,xo,fa,Tt,ed,_a,od,us,Ge,wt,td,$t,nd,ga,ad,rd,sd,Bo,St,ld,ba,dd,fs,co,zo,ka,xt,id,ya,cd,_s,$e,Bt,pd,zt,md,Nn,hd,ud,fd,Ft,_d,qt,gd,bd,kd,qe,Et,yd,po,vd,In,Td,wd,va,$d,Sd,xd,Fo,Bd,qo,gs,mo,Eo,Ta,Mt,zd,wa,Fd,bs,Se,Ct,qd,jt,Ed,An,Md,Cd,jd,Ot,Od,Pt,Pd,Ld,Nd,Ee,Lt,Id,ho,Ad,Dn,Dd,Gd,$a,Ud,Wd,Rd,Mo,Hd,Co,ks,uo,jo,Sa,Nt,Kd,xa,Vd,ys,fo,It,Qd,Oo,At,Jd,Po,vs,_o,Lo,Ba,Dt,Xd,za,Yd,Ts,pe,Gt,Zd,Ut,ei,Gn,oi,ti,ni,Wt,ai,Rt,ri,si,li,No,di,Me,Ht,ii,go,ci,Un,pi,mi,Fa,hi,ui,fi,Io,_i,Ao,ws,bo,Do,qa,Kt,gi,Ea,bi,$s,me,Vt,ki,Qt,yi,Wn,vi,Ti,wi,Jt,$i,Xt,Si,xi,Bi,Go,zi,P,Yt,Fi,ko,qi,Rn,Ei,Mi,Ma,Ci,ji,Oi,Uo,Pi,Ca,Li,Ni,ja,Oa,Pa,La,Ii,Ai,Na,Ia,Aa,Da,Di,Gi,Ga,Ua,Wa,Ra,Ui,Wi,Ha,Ka,Va,Zt,Ri,Qa,Hi,Ki,Vi,Ja,Xa,Ya,Za,Qi,Ss,yo,Wo,er,en,Ji,or,Xi,xs,I,on,Yi,tn,Zi,Hn,ec,oc,tc,nn,nc,an,ac,rc,sc,tr,lc,dc,Ue,nr,rn,ic,cc,ar,sn,pc,mc,rr,ln,hc,uc,sr,dn,fc,_c,Ro,cn,gc,Ho,bc,Ko,pn,kc,Vo,yc,Qo,mn,vc,Jo,Bs,vo,Xo,lr,hn,Tc,dr,wc,zs,A,un,$c,fn,Sc,Kn,xc,Bc,zc,_n,Fc,gn,qc,Ec,Mc,ir,Cc,jc,We,cr,bn,Oc,Pc,pr,kn,Lc,Nc,mr,yn,Ic,Ac,hr,vn,Dc,Gc,E,Tn,Uc,To,Wc,ur,Rc,Hc,fr,Kc,Vc,Qc,Yo,Jc,_r,Xc,Yc,gr,br,kr,yr,Zc,ep,vr,Tr,wr,$r,op,tp,Sr,xr,Br,zr,np,ap,Fr,qr,wn,Zo,et,Er,$n,rp,Mr,sp,lp,Cr,dp,ip,jr,cp,pp,Or,Pr,Lr,Nr,mp,hp,Ir,Ar,Dr,Gr,up,fp,Ur,Wr,Rr,Hr,_p,gp,Kr,Vr,Qr,Jr,bp,kp,ot,Sn,yp,tt,vp,nt,xn,Tp,at,Fs;return d=new xe({}),re=new xe({}),Te=new xe({}),ht=new C({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/tokenization_utils.py#L842",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/blenderbot_small/tokenization_blenderbot_small_fast.py#L96",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1246",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1123",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1231",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16944/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L972",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16944/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1035",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16944/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16944/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1307",returnDescription:`
<p>A <a
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[Fu]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=i(),f=n("h1"),h=n("a"),b=n("span"),y(d.$$.fragment),u=i(),F=n("span"),Ce=s("Blenderbot Small"),he=i(),B=n("p"),je=s("Note that "),W=n("a"),Oe=s("BlenderbotSmallModel"),Pe=s(` and
...
`),ue=n("a"),ae=s("BlenderbotForConditionalGeneration"),Be=i(),J=n("h2"),D=n("a"),be=n("span"),y(re.$$.fragment),N=i(),ke=n("span"),se=s("Overview"),ze=i(),ee=n("p"),le=s("The Blender chatbot model was proposed in "),de=n("a"),Ae=s("Recipes for building an open-domain chatbot"),X=s(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
found `),G=n("a"),to=s("here"),no=s(" ."),oe=i(),ce=n("h2"),fe=n("a"),ve=n("span"),y(Te.$$.fragment),ml=i(),sa=n("span"),hl=s("BlenderbotSmallConfig"),cs=i(),we=n("div"),y(ht.$$.fragment),ul=i(),ao=n("p"),fl=s("This is the configuration class to store the configuration of a "),En=n("a"),_l=s("BlenderbotSmallModel"),gl=s(`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
`),ut=n("a"),bl=s("facebook/blenderbot_small-90M"),kl=s(" architecture."),yl=i(),ro=n("p"),vl=s("Configuration objects inherit from "),Mn=n("a"),Tl=s("PretrainedConfig"),wl=s(` and can be used to control the model outputs. Read the
documentation from `),Cn=n("a"),$l=s("PretrainedConfig"),Sl=s(" for more information."),xl=i(),y(wo.$$.fragment),ps=i(),so=n("h2"),$o=n("a"),la=n("span"),y(ft.$$.fragment),Bl=i(),da=n("span"),zl=s("BlenderbotSmallTokenizer"),ms=i(),U=n("div"),y(_t.$$.fragment),Fl=i(),ia=n("p"),ql=s("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),El=i(),gt=n("p"),Ml=s("This tokenizer inherits from "),jn=n("a"),Cl=s("PreTrainedTokenizer"),jl=s(` which contains most of the main methods. Users should refer to
...
special tokens using the tokenizer `),ma=n("code"),Ul=s("prepare_for_model"),Wl=s(" or "),ha=n("code"),Rl=s("encode_plus"),Hl=s(" methods."),Kl=i(),Ke=n("div"),y(yt.$$.fragment),Vl=i(),On=n("p"),Ql=s("Create the token type IDs corresponding to the sequences passed. "),Pn=n("a"),Jl=s(`What are token type
IDs?`),Xl=i(),ua=n("p"),Yl=s("Should be overridden in a subclass if the model has a special way of building those."),Zl=i(),Ln=n("div"),y(vt.$$.fragment),hs=i(),io=n("h2"),xo=n("a"),fa=n("span"),y(Tt.$$.fragment),ed=i(),_a=n("span"),od=s("BlenderbotSmallTokenizerFast"),us=i(),Ge=n("div"),y(wt.$$.fragment),td=i(),$t=n("p"),nd=s("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=n("em"),ad=s("tokenizers"),rd=s(" library)."),sd=i(),Bo=n("div"),y(St.$$.fragment),ld=i(),ba=n("p"),dd=s(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),fs=i(),co=n("h2"),zo=n("a"),ka=n("span"),y(xt.$$.fragment),id=i(),ya=n("span"),cd=s("BlenderbotSmallModel"),_s=i(),$e=n("div"),y(Bt.$$.fragment),pd=i(),zt=n("p"),md=s(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),y(Lt.$$.fragment),Id=i(),ho=n("p"),Ad=s("The "),Dn=n("a"),Dd=s("BlenderbotSmallForConditionalGeneration"),Gd=s(" forward method, overrides the "),$a=n("code"),Ud=s("__call__"),Wd=s(" special method."),Rd=i(),y(Mo.$$.fragment),Hd=i(),y(Co.$$.fragment),ks=i(),uo=n("h2"),jo=n("a"),Sa=n("span"),y(Nt.$$.fragment),Kd=i(),xa=n("span"),Vd=s("BlenderbotSmallForCausalLM"),ys=i(),fo=n("div"),y(It.$$.fragment),Qd=i(),Oo=n("div"),y(At.$$.fragment),Jd=i(),y(Po.$$.fragment),vs=i(),_o=n("h2"),Lo=n("a"),Ba=n("span"),y(Dt.$$.fragment),Xd=i(),za=n("span"),Yd=s("TFBlenderbotSmallModel"),Ts=i(),pe=n("div"),y(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=s(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
behavior.`),li=i(),y(No.$$.fragment),di=i(),Me=n("div"),y(Ht.$$.fragment),ii=i(),go=n("p"),ci=s("The "),Un=n("a"),pi=s("TFBlenderbotSmallModel"),mi=s(" forward method, overrides the "),Fa=n("code"),hi=s("__call__"),ui=s(" special method."),fi=i(),y(Io.$$.fragment),_i=i(),y(Ao.$$.fragment),ws=i(),bo=n("h2"),Do=n("a"),qa=n("span"),y(Kt.$$.fragment),gi=i(),Ea=n("span"),bi=s("TFBlenderbotSmallForConditionalGeneration"),$s=i(),me=n("div"),y(Vt.$$.fragment),ki=i(),Qt=n("p"),yi=s(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),gp=i(),Kr=n("blockquote"),Vr=n("blockquote"),Qr=n("blockquote"),Jr=n("p"),bp=s("tokenizer.decode(predictions).split()"),kp=i(),ot=n("div"),y(Sn.$$.fragment),yp=i(),y(tt.$$.fragment),vp=i(),nt=n("div"),y(xn.$$.fragment),Tp=i(),y(at.$$.fragment),this.h()},l(t){const g=pu('[data-svelte="svelte-1phssyn"]',document.head);p=a(g,"META",{name:!0,content:!0}),g.forEach(o),k=c(t),f=a(t,"H1",{class:!0});var Bn=r(f);h=a(Bn,"A",{id:!0,class:!0,href:!0});var Xr=r(h);b=a(Xr,"SPAN",{});var Yr=r(b);v(d.$$.fragment,Yr),Yr.forEach(o),Xr.forEach(o),u=c(Bn),F=a(Bn,"SPAN",{});var Zr=r(F);Ce=l(Zr,"Blenderbot Small"),Zr.forEach(o),Bn.forEach(o),he=c(t),B=a(t,"P",{});var _e=r(B);je=l(_e,"Note that "),W=a(_e,"A",{href:!0});var es=r(W);Oe=l(es,"BlenderbotSmallModel"),es.forEach(o),Pe=l(_e,` and
...
documentation from `),Cn=a(Jn,"A",{href:!0});var jp=r(Cn);$l=l(jp,"PretrainedConfig"),jp.forEach(o),Sl=l(Jn," for more information."),Jn.forEach(o),xl=c(rt),v(wo.$$.fragment,rt),rt.forEach(o),ps=c(t),so=a(t,"H2",{class:!0});var Es=r(so);$o=a(Es,"A",{id:!0,class:!0,href:!0});var Op=r($o);la=a(Op,"SPAN",{});var Pp=r(la);v(ft.$$.fragment,Pp),Pp.forEach(o),Op.forEach(o),Bl=c(Es),da=a(Es,"SPAN",{});var Lp=r(da);zl=l(Lp,"BlenderbotSmallTokenizer"),Lp.forEach(o),Es.forEach(o),ms=c(t),U=a(t,"DIV",{class:!0});var ge=r(U);v(_t.$$.fragment,ge),Fl=c(ge),ia=a(ge,"P",{});var Np=r(ia);ql=l(Np,"Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),Np.forEach(o),El=c(ge),gt=a(ge,"P",{});var Ms=r(gt);Ml=l(Ms,"This tokenizer inherits from "),jn=a(Ms,"A",{href:!0});var Ip=r(jn);Cl=l(Ip,"PreTrainedTokenizer"),Ip.forEach(o),jl=l(Ms,` which contains most of the main methods. Users should refer to
...
IDs?`),Wp.forEach(o),wp.forEach(o),Xl=c(Zn),ua=a(Zn,"P",{});var Rp=r(ua);Yl=l(Rp,"Should be overridden in a subclass if the model has a special way of building those."),Rp.forEach(o),Zn.forEach(o),Zl=c(ge),Ln=a(ge,"DIV",{class:!0});var Hp=r(Ln);v(vt.$$.fragment,Hp),Hp.forEach(o),ge.forEach(o),hs=c(t),io=a(t,"H2",{class:!0});var js=r(io);xo=a(js,"A",{id:!0,class:!0,href:!0});var Kp=r(xo);fa=a(Kp,"SPAN",{});var Vp=r(fa);v(Tt.$$.fragment,Vp),Vp.forEach(o),Kp.forEach(o),ed=c(js),_a=a(js,"SPAN",{});var Qp=r(_a);od=l(Qp,"BlenderbotSmallTokenizerFast"),Qp.forEach(o),js.forEach(o),us=c(t),Ge=a(t,"DIV",{class:!0});var ea=r(Ge);v(wt.$$.fragment,ea),td=c(ea),$t=a(ea,"P",{});var Os=r($t);nd=l(Os,"Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=a(Os,"EM",{});var Jp=r(ga);ad=l(Jp,"tokenizers"),Jp.forEach(o),rd=l(Os," library)."),Os.forEach(o),sd=c(ea),Bo=a(ea,"DIV",{class:!0});var Ps=r(Bo);v(St.$$.fragment,Ps),ld=c(Ps),ba=a(Ps,"P",{});var Xp=r(ba);dd=l(Xp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),Xp.forEach(o),Ps.forEach(o),ea.forEach(o),fs=c(t),co=a(t,"H2",{class:!0});var Ls=r(co);zo=a(Ls,"A",{id:!0,class:!0,href:!0});var Yp=r(zo);ka=a(Yp,"SPAN",{});var Zp=r(ka);v(xt.$$.fragment,Zp),Zp.forEach(o),Yp.forEach(o),id=c(Ls),ya=a(Ls,"SPAN",{});var em=r(ya);cd=l(em,"BlenderbotSmallModel"),em.forEach(o),Ls.forEach(o),_s=c(t),$e=a(t,"DIV",{class:!0});var st=r($e);v(Bt.$$.fragment,st),pd=c(st),zt=a(st,"P",{});var Ns=r(zt);md=l(Ns,`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Is.forEach(o),kd=c(st),qe=a(st,"DIV",{class:!0});var lt=r(qe);v(Et.$$.fragment,lt),yd=c(lt),po=a(lt,"P",{});var oa=r(po);vd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=r(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),va=a(oa,"CODE",{});var am=r(va);$d=l(am,"__call__"),am.forEach(o),Sd=l(oa," special method."),oa.forEach(o),xd=c(lt),v(Fo.$$.fragment,lt),Bd=c(lt),v(qo.$$.fragment,lt),lt.forEach(o),st.forEach(o),gs=c(t),mo=a(t,"H2",{class:!0});var As=r(mo);Eo=a(As,"A",{id:!0,class:!0,href:!0});var rm=r(Eo);Ta=a(rm,"SPAN",{});var sm=r(Ta);v(Mt.$$.fragment,sm),sm.forEach(o),rm.forEach(o),zd=c(As),wa=a(As,"SPAN",{});var lm=r(wa);Fd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),As.forEach(o),bs=c(t),Se=a(t,"DIV",{class:!0});var dt=r(Se);v(Ct.$$.fragment,dt),qd=c(dt),jt=a(dt,"P",{});var Ds=r(jt);Ed=l(Ds,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gs.forEach(o),Nd=c(dt),Ee=a(dt,"DIV",{class:!0});var it=r(Ee);v(Lt.$$.fragment,it),Id=c(it),ho=a(it,"P",{});var ta=r(ho);Ad=l(ta,"The "),Dn=a(ta,"A",{href:!0});var cm=r(Dn);Dd=l(cm,"BlenderbotSmallForConditionalGeneration"),cm.forEach(o),Gd=l(ta," forward method, overrides the "),$a=a(ta,"CODE",{});var pm=r($a);Ud=l(pm,"__call__"),pm.forEach(o),Wd=l(ta," special method."),ta.forEach(o),Rd=c(it),v(Mo.$$.fragment,it),Hd=c(it),v(Co.$$.fragment,it),it.forEach(o),dt.forEach(o),ks=c(t),uo=a(t,"H2",{class:!0});var Us=r(uo);jo=a(Us,"A",{id:!0,class:!0,href:!0});var mm=r(jo);Sa=a(mm,"SPAN",{});var hm=r(Sa);v(Nt.$$.fragment,hm),hm.forEach(o),mm.forEach(o),Kd=c(Us),xa=a(Us,"SPAN",{});var um=r(xa);Vd=l(um,"BlenderbotSmallForCausalLM"),um.forEach(o),Us.forEach(o),ys=c(t),fo=a(t,"DIV",{class:!0});var Ws=r(fo);v(It.$$.fragment,Ws),Qd=c(Ws),Oo=a(Ws,"DIV",{class:!0});var Rs=r(Oo);v(At.$$.fragment,Rs),Jd=c(Rs),v(Po.$$.fragment,Rs),Rs.forEach(o),Ws.forEach(o),vs=c(t),_o=a(t,"H2",{class:!0});var Hs=r(_o);Lo=a(Hs,"A",{id:!0,class:!0,href:!0});var fm=r(Lo);Ba=a(fm,"SPAN",{});var _m=r(Ba);v(Dt.$$.fragment,_m),_m.forEach(o),fm.forEach(o),Xd=c(Hs),za=a(Hs,"SPAN",{});var gm=r(za);Yd=l(gm,"TFBlenderbotSmallModel"),gm.forEach(o),Hs.forEach(o),Ts=c(t),pe=a(t,"DIV",{class:!0});var Ve=r(pe);v(Gt.$$.fragment,Ve),Zd=c(Ve),Ut=a(Ve,"P",{});var Ks=r(Ut);ei=l(Ks,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vs.forEach(o),li=c(Ve),v(No.$$.fragment,Ve),di=c(Ve),Me=a(Ve,"DIV",{class:!0});var ct=r(Me);v(Ht.$$.fragment,ct),ii=c(ct),go=a(ct,"P",{});var na=r(go);ci=l(na,"The "),Un=a(na,"A",{href:!0});var ym=r(Un);pi=l(ym,"TFBlenderbotSmallModel"),ym.forEach(o),mi=l(na," forward method, overrides the "),Fa=a(na,"CODE",{});var vm=r(Fa);hi=l(vm,"__call__"),vm.forEach(o),ui=l(na," special method."),na.forEach(o),fi=c(ct),v(Io.$$.fragment,ct),_i=c(ct),v(Ao.$$.fragment,ct),ct.forEach(o),Ve.forEach(o),ws=c(t),bo=a(t,"H2",{class:!0});var Qs=r(bo);Do=a(Qs,"A",{id:!0,class:!0,href:!0});var Tm=r(Do);qa=a(Tm,"SPAN",{});var wm=r(qa);v(Kt.$$.fragment,wm),wm.forEach(o),Tm.forEach(o),gi=c(Qs),Ea=a(Qs,"SPAN",{});var $m=r(Ea);bi=l($m,"TFBlenderbotSmallForConditionalGeneration"),$m.forEach(o),Qs.forEach(o),$s=c(t),me=a(t,"DIV",{class:!0});var Qe=r(me);v(Vt.$$.fragment,Qe),ki=c(Qe),Qt=a(Qe,"P",{});var Js=r(Qt);yi=l(Js,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ll.forEach(o),Mc=c(ne),ir=a(ne,"P",{});var fh=r(ir);Cc=l(fh,"Finally, this model supports inherent JAX features such as:"),fh.forEach(o),jc=c(ne),We=a(ne,"UL",{});var mt=r(We);cr=a(mt,"LI",{});var _h=r(cr);bn=a(_h,"A",{href:!0,rel:!0});var gh=r(bn);Oc=l(gh,"Just-In-Time (JIT) compilation"),gh.forEach(o),_h.forEach(o),Pc=c(mt),pr=a(mt,"LI",{});var bh=r(pr);kn=a(bh,"A",{href:!0,rel:!0});var kh=r(kn);Lc=l(kh,"Automatic Differentiation"),kh.forEach(o),bh.forEach(o),Nc=c(mt),mr=a(mt,"LI",{});var yh=r(mr);yn=a(yh,"A",{href:!0,rel:!0});var vh=r(yn);Ic=l(vh,"Vectorization"),vh.forEach(o),yh.forEach(o),Ac=c(mt),hr=a(mt,"LI",{});var Th=r(hr);vn=a(Th,"A",{href:!0,rel:!0});var wh=r(vn);Dc=l(wh,"Parallelization"),wh.forEach(o),Th.forEach(o),mt.forEach(o),Gc=c(ne),E=a(ne,"DIV",{class:!0});var M=r(E);v(Tn.$$.fragment,M),Uc=c(M),To=a(M,"P",{});var ra=r(To);Wc=l(ra,"The "),ur=a(ra,"CODE",{});var $h=r(ur);Rc=l($h,"FlaxBlenderbotSmallPreTrainedModel"),$h.forEach(o),Hc=l(ra," forward method, overrides the "),fr=a(ra,"CODE",{});var Sh=r(fr);Kc=l(Sh,"__call__"),Sh.forEach(o),Vc=l(ra," special method."),ra.forEach(o),Qc=c(M),v(Yo.$$.fragment,M),Jc=c(M),_r=a(M,"P",{});var xh=r(_r);Xc=l(xh,"Summarization example:"),xh.forEach(o),Yc=c(M),gr=a(M,"BLOCKQUOTE",{});var Bh=r(gr);br=a(Bh,"BLOCKQUOTE",{});var zh=r(br);kr=a(zh,"BLOCKQUOTE",{});var Fh=r(kr);yr=a(Fh,"P",{});var qh=r(yr);Zc=l(qh,"from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration"),qh.forEach(o),Fh.forEach(o),zh.forEach(o),Bh.forEach(o),ep=c(M),vr=a(M,"BLOCKQUOTE",{});var Eh=r(vr);Tr=a(Eh,"BLOCKQUOTE",{});var Mh=r(Tr);wr=a(Mh,"BLOCKQUOTE",{});var Ch=r(wr);$r=a(Ch,"P",{});var jh=r($r);op=l(jh,`model = FlaxBlenderbotSmallForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>>
