...
Whether or not to return a <a href="/docs/transformers/pr_8/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/deit/modeling_deit.py#L497",returnDescription:`
<p>A <a
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/deit/modeling_deit.py#L591",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/deit/modeling_deit.py#L698",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_8/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/deit/modeling_deit.py#L852",returnDescription:`
