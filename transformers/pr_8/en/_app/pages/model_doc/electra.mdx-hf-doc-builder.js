...
<p>Indices can be obtained using <a href="/docs/transformers/pr_8/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_8/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_8/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_8/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),Us=new ye({props:{$$slots:{default:[hC]},$$scope:{ctx:x}}}),Rs=new ie({props:{anchor:"transformers.FlaxElectraForPreTraining.__call__.example",$$slots:{default:[mC]},$$scope:{ctx:x}}}),Xi=new we({}),Yi=new I({props:{name:"class transformers.FlaxElectraForCausalLM",anchor:"transformers.FlaxElectraForCausalLM",parameters:[{name:"config",val:": ElectraConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxElectraForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_8/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Qs=new ye({props:{$$slots:{default:[uC]},$$scope:{ctx:x}}}),Bs=new ie({props:{anchor:"transformers.FlaxElectraForCausalLM.__call__.example",$$slots:{default:[fC]},$$scope:{ctx:x}}}),il=new we({}),ll=new I({props:{name:"class transformers.FlaxElectraForMaskedLM",anchor:"transformers.FlaxElectraForMaskedLM",parameters:[{name:"config",val:": ElectraConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_8/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$1=c(),Rh=n("p"),F1=r("Finally, this model supports inherent JAX features such as:"),x1=c(),Xt=n("ul"),Hh=n("li"),ml=n("a"),M1=r("Just-In-Time (JIT) compilation"),z1=c(),Qh=n("li"),ul=n("a"),j1=r("Automatic Differentiation"),C1=c(),Bh=n("li"),fl=n("a"),q1=r("Vectorization"),P1=c(),Vh=n("li"),gl=n("a"),A1=r("Parallelization"),O1=c(),Ot=n("div"),b(_l.$$.fragment),L1=c(),hn=n("p"),N1=r("The "),Kh=n("code"),I1=r("FlaxElectraPreTrainedModel"),D1=r(" forward method, overrides the "),Jh=n("code"),S1=r("__call__"),W1=r(" special method."),U1=c(),b(Ks.$$.fragment),R1=c(),b(Js.$$.fragment),vf=c(),mn=n("h2"),Gs=n("a"),Gh=n("span"),b(kl.$$.fragment),H1=c(),Xh=n("span"),Q1=r("FlaxElectraForSequenceClassification"),Tf=c(),We=n("div"),b(vl.$$.fragment),B1=c(),Yh=n("p"),V1=r(`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),SE=p(ft),y(zs.$$.fragment,ft),WE=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),UE=p(ko),en=s(ko,"P",{});var xc=a(en);RE=i(xc,"The "),oc=s(xc,"A",{href:!0});var EM=a(oc);HE=i(EM,"TFElectraForTokenClassification"),EM.forEach(t),QE=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var wM=a(nh);BE=i(wM,"__call__"),wM.forEach(t),VE=i(xc," special method."),xc.forEach(t),KE=p(ko),y(js.$$.fragment,ko),JE=p(ko),y(Cs.$$.fragment,ko),GE=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $M=a(Ps);sh=s($M,"SPAN",{});var FM=a(sh);y($i.$$.fragment,FM),FM.forEach(t),$M.forEach(t),XE=p(vg),ah=s(vg,"SPAN",{});var xM=a(ah);YE=i(xM,"TFElectraForQuestionAnswering"),xM.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Bt=a(Xe);y(Fi.$$.fragment,Bt),ZE=p(Bt),on=s(Bt,"P",{});var Mc=a(on);ew=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var MM=a(rh);tw=i(MM,"span start logits"),MM.forEach(t),ow=i(Mc," and "),ih=s(Mc,"CODE",{});var zM=a(ih);nw=i(zM,"span end logits"),zM.forEach(t),sw=i(Mc,")."),Mc.forEach(t),aw=p(Bt),xi=s(Bt,"P",{});var Tg=a(xi);rw=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var jM=a(nc);iw=i(jM,"TFPreTrainedModel"),jM.forEach(t),lw=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dw=p(Bt),Mi=s(Bt,"P",{});var bg=a(Mi);cw=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var CM=a(zi);pw=i(CM,"tf.keras.Model"),CM.forEach(t),hw=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mw=p(Bt),y(As.$$.fragment,Bt),uw=p(Bt),pt=s(Bt,"DIV",{class:!0});var vo=a(pt);y(ji.$$.fragment,vo),fw=p(vo),nn=s(vo,"P",{});var zc=a(nn);gw=i(zc,"The "),sc=s(zc,"A",{href:!0});var qM=a(sc);_w=i(qM,"TFElectraForQuestionAnswering"),qM.forEach(t),kw=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var PM=a(lh);vw=i(PM,"__call__"),PM.forEach(t),Tw=i(zc," special method."),zc.forEach(t),bw=p(vo),y(Os.$$.fragment,vo),yw=p(vo),y(Ls.$$.fragment,vo),Ew=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Bt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var AM=a(Is);dh=s(AM,"SPAN",{});var OM=a(dh);y(Ci.$$.fragment,OM),OM.forEach(t),AM.forEach(t),ww=p(yg),ch=s(yg,"SPAN",{});var LM=a(ch);$w=i(LM,"FlaxElectraModel"),LM.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),Fw=p(gt),ph=s(gt,"P",{});var NM=a(ph);xw=i(NM,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),NM.forEach(t),Mw=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zw=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var IM=a(ac);jw=i(IM,"FlaxPreTrainedModel"),IM.forEach(t),Cw=i(Eg,`. Check the superclass documentation for the generic methods the
...
`),tl=s(jg,"A",{href:!0,rel:!0});var Tz=a(tl);H$=i(Tz,"flax.nn.Module"),Tz.forEach(t),Q$=i(jg,` subclass. Use it as a
