...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_8/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_8/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`),Bi=n("a"),m$=r("flax.nn.Module"),u$=r(` subclass. Use it as a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$1=c(),Rh=n("p"),F1=r("Finally, this model supports inherent JAX features such as:"),x1=c(),Xt=n("ul"),Hh=n("li"),ml=n("a"),M1=r("Just-In-Time (JIT) compilation"),z1=c(),Bh=n("li"),ul=n("a"),C1=r("Automatic Differentiation"),j1=c(),Qh=n("li"),fl=n("a"),q1=r("Vectorization"),P1=c(),Vh=n("li"),gl=n("a"),A1=r("Parallelization"),O1=c(),Ot=n("div"),b(_l.$$.fragment),L1=c(),hn=n("p"),N1=r("The "),Kh=n("code"),I1=r("FlaxElectraPreTrainedModel"),D1=r(" forward method, overrides the "),Jh=n("code"),S1=r("__call__"),W1=r(" special method."),U1=c(),b(Ks.$$.fragment),R1=c(),b(Js.$$.fragment),vf=c(),mn=n("h2"),Gs=n("a"),Gh=n("span"),b(kl.$$.fragment),H1=c(),Xh=n("span"),B1=r("FlaxElectraForSequenceClassification"),Tf=c(),We=n("div"),b(vl.$$.fragment),Q1=c(),Yh=n("p"),V1=r(`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),SE=p(ft),y(zs.$$.fragment,ft),WE=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),UE=p(ko),en=s(ko,"P",{});var xc=a(en);RE=i(xc,"The "),oc=s(xc,"A",{href:!0});var EM=a(oc);HE=i(EM,"TFElectraForTokenClassification"),EM.forEach(t),BE=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var wM=a(nh);QE=i(wM,"__call__"),wM.forEach(t),VE=i(xc," special method."),xc.forEach(t),KE=p(ko),y(Cs.$$.fragment,ko),JE=p(ko),y(js.$$.fragment,ko),GE=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $M=a(Ps);sh=s($M,"SPAN",{});var FM=a(sh);y($i.$$.fragment,FM),FM.forEach(t),$M.forEach(t),XE=p(vg),ah=s(vg,"SPAN",{});var xM=a(ah);YE=i(xM,"TFElectraForQuestionAnswering"),xM.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Qt=a(Xe);y(Fi.$$.fragment,Qt),ZE=p(Qt),on=s(Qt,"P",{});var Mc=a(on);ew=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var MM=a(rh);tw=i(MM,"span start logits"),MM.forEach(t),ow=i(Mc," and "),ih=s(Mc,"CODE",{});var zM=a(ih);nw=i(zM,"span end logits"),zM.forEach(t),sw=i(Mc,")."),Mc.forEach(t),aw=p(Qt),xi=s(Qt,"P",{});var Tg=a(xi);rw=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var CM=a(nc);iw=i(CM,"TFPreTrainedModel"),CM.forEach(t),lw=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dw=p(Qt),Mi=s(Qt,"P",{});var bg=a(Mi);cw=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var jM=a(zi);pw=i(jM,"tf.keras.Model"),jM.forEach(t),hw=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mw=p(Qt),y(As.$$.fragment,Qt),uw=p(Qt),pt=s(Qt,"DIV",{class:!0});var vo=a(pt);y(Ci.$$.fragment,vo),fw=p(vo),nn=s(vo,"P",{});var zc=a(nn);gw=i(zc,"The "),sc=s(zc,"A",{href:!0});var qM=a(sc);_w=i(qM,"TFElectraForQuestionAnswering"),qM.forEach(t),kw=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var PM=a(lh);vw=i(PM,"__call__"),PM.forEach(t),Tw=i(zc," special method."),zc.forEach(t),bw=p(vo),y(Os.$$.fragment,vo),yw=p(vo),y(Ls.$$.fragment,vo),Ew=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Qt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var AM=a(Is);dh=s(AM,"SPAN",{});var OM=a(dh);y(ji.$$.fragment,OM),OM.forEach(t),AM.forEach(t),ww=p(yg),ch=s(yg,"SPAN",{});var LM=a(ch);$w=i(LM,"FlaxElectraModel"),LM.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),Fw=p(gt),ph=s(gt,"P",{});var NM=a(ph);xw=i(NM,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),NM.forEach(t),Mw=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zw=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var IM=a(ac);Cw=i(IM,"FlaxPreTrainedModel"),IM.forEach(t),jw=i(Eg,`. Check the superclass documentation for the generic methods the
...
`),Bi=s(xg,"A",{href:!0,rel:!0});var nz=a(Bi);m$=i(nz,"flax.nn.Module"),nz.forEach(t),u$=i(xg,` subclass. Use it as a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$1=p(kt),Rh=s(kt,"P",{});var Iz=a(Rh);F1=i(Iz,"Finally, this model supports inherent JAX features such as:"),Iz.forEach(t),x1=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var Dz=a(Hh);ml=s(Dz,"A",{href:!0,rel:!0});var Sz=a(ml);M1=i(Sz,"Just-In-Time (JIT) compilation"),Sz.forEach(t),Dz.forEach(t),z1=p(Ea),Bh=s(Ea,"LI",{});var Wz=a(Bh);ul=s(Wz,"A",{href:!0,rel:!0});var Uz=a(ul);C1=i(Uz,"Automatic Differentiation"),Uz.forEach(t),Wz.forEach(t),j1=p(Ea),Qh=s(Ea,"LI",{});var Rz=a(Qh);fl=s(Rz,"A",{href:!0,rel:!0});var Hz=a(fl);q1=i(Hz,"Vectorization"),Hz.forEach(t),Rz.forEach(t),P1=p(Ea),Vh=s(Ea,"LI",{});var Bz=a(Vh);gl=s(Bz,"A",{href:!0,rel:!0});var Qz=a(gl);A1=i(Qz,"Parallelization"),Qz.forEach(t),Bz.forEach(t),Ea.forEach(t),O1=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L1=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N1=i(Pc,"The "),Kh=s(Pc,"CODE",{});var Vz=a(Kh);I1=i(Vz,"FlaxElectraPreTrainedModel"),Vz.forEach(t),D1=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var Kz=a(Jh);S1=i(Kz,"__call__"),Kz.forEach(t),W1=i(Pc," special method."),Pc.forEach(t),U1=p(wa),y(Ks.$$.fragment,wa),R1=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var Jz=a(Gs);Gh=s(Jz,"SPAN",{});var Gz=a(Gh);y(kl.$$.fragment,Gz),Gz.forEach(t),Jz.forEach(t),H1=p(Og),Xh=s(Og,"SPAN",{});var Xz=a(Xh);B1=i(Xz,"FlaxElectraForSequenceClassification"),Xz.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Q1=p(vt),Yh=s(vt,"P",{});var Yz=a(Yh);V1=i(Yz,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
