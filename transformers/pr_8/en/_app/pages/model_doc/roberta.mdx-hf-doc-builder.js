...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),t$=h(gt),yi=s(gt,"P",{});var Iu=a(yi);o$=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var MR=a(wi);n$=i(MR,"flax.linen.Module"),MR.forEach(t),s$=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),a$=h(gt),Bp=s(gt,"P",{});var ER=a(Bp);r$=i(ER,"Finally, this model supports inherent JAX features such as:"),ER.forEach(t),i$=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zR=a(Up);$i=s(zR,"A",{href:!0,rel:!0});var qR=a($i);l$=i(qR,"Just-In-Time (JIT) compilation"),qR.forEach(t),zR.forEach(t),d$=h(ra),Hp=s(ra,"LI",{});var CR=a(Hp);Fi=s(CR,"A",{href:!0,rel:!0});var jR=a(Fi);c$=i(jR,"Automatic Differentiation"),jR.forEach(t),CR.forEach(t),p$=h(ra),Qp=s(ra,"LI",{});var PR=a(Qp);xi=s(PR,"A",{href:!0,rel:!0});var LR=a(xi);h$=i(LR,"Vectorization"),LR.forEach(t),PR.forEach(t),m$=h(ra),Jp=s(ra,"LI",{});var AR=a(Jp);Ri=s(AR,"A",{href:!0,rel:!0});var OR=a(Ri);f$=i(OR,"Parallelization"),OR.forEach(t),AR.forEach(t),ra.forEach(t),u$=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),g$=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_$=i(sc,"The "),Vp=s(sc,"CODE",{});var NR=a(Vp);b$=i(NR,"FlaxRobertaPreTrainedModel"),NR.forEach(t),k$=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var IR=a(Kp);v$=i(IR,"__call__"),IR.forEach(t),T$=i(sc," special method."),sc.forEach(t),y$=h(ia),y(Ps.$$.fragment,ia),w$=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var DR=a(As);Gp=s(DR,"SPAN",{});var SR=a(Gp);y(Ei.$$.fragment,SR),SR.forEach(t),DR.forEach(t),$$=h(Du),Xp=s(Du,"SPAN",{});var WR=a(Xp);F$=i(WR,"FlaxRobertaForCausalLM"),WR.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),x$=h(_t),Yp=s(_t,"P",{});var BR=a(Yp);R$=i(BR,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),BR.forEach(t),M$=h(_t),qi=s(_t,"P",{});var Su=a(qi);E$=i(Su,"This model inherits from "),jd=s(Su,"A",{href:!0});var UR=a(jd);z$=i(UR,"FlaxPreTrainedModel"),UR.forEach(t),q$=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Su.forEach(t),C$=h(_t),Ci=s(_t,"P",{});var Wu=a(Ci);j$=i(Wu,"This model is also a Flax Linen "),ji=s(Wu,"A",{href:!0,rel:!0});var HR=a(ji);P$=i(HR,"flax.linen.Module"),HR.forEach(t),L$=i(Wu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),A$=h(_t),Zp=s(_t,"P",{});var QR=a(Zp);O$=i(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),N$=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var JR=a(eh);Pi=s(JR,"A",{href:!0,rel:!0});var VR=a(Pi);I$=i(VR,"Just-In-Time (JIT) compilation"),VR.forEach(t),JR.forEach(t),D$=h(la),th=s(la,"LI",{});var KR=a(th);Li=s(KR,"A",{href:!0,rel:!0});var GR=a(Li);S$=i(GR,"Automatic Differentiation"),GR.forEach(t),KR.forEach(t),W$=h(la),oh=s(la,"LI",{});var XR=a(oh);Ai=s(XR,"A",{href:!0,rel:!0});var YR=a(Ai);B$=i(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),U$=h(la),nh=s(la,"LI",{});var ZR=a(nh);Oi=s(ZR,"A",{href:!0,rel:!0});var eM=a(Oi);H$=i(eM,"Parallelization"),eM.forEach(t),ZR.forEach(t),la.forEach(t),Q$=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);y(Ni.$$.fragment,da),J$=h(da),tn=s(da,"P",{});var ac=a(tn);V$=i(ac,"The "),sh=s(ac,"CODE",{});var tM=a(sh);K$=i(tM,"FlaxRobertaPreTrainedModel"),tM.forEach(t),G$=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oM=a(ah);X$=i(oM,"__call__"),oM.forEach(t),Y$=i(ac," special method."),ac.forEach(t),Z$=h(da),y(Os.$$.fragment,da),e1=h(da),y(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nM=a(Is);rh=s(nM,"SPAN",{});var sM=a(rh);y(Ii.$$.fragment,sM),sM.forEach(t),nM.forEach(t),t1=h(Bu),ih=s(Bu,"SPAN",{});var aM=a(ih);o1=i(aM,"FlaxRobertaForMaskedLM"),aM.forEach(t),Bu.forEach(t),qf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);y(Di.$$.fragment,bt),n1=h(bt),Si=s(bt,"P",{});var Uu=a(Si);s1=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rM=a(lh);a1=i(rM,"language modeling"),rM.forEach(t),r1=i(Uu," head on top."),Uu.forEach(t),i1=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);l1=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iM=a(Pd);d1=i(iM,"FlaxPreTrainedModel"),iM.forEach(t),c1=i(Hu,`. Check the superclass documentation for the generic methods the
