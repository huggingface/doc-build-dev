...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_8/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_8/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_8/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_8/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=p(),Zp=n("p"),O$=r("Finally, this model supports inherent JAX features such as:"),N$=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),I$=r("Just-In-Time (JIT) compilation"),D$=p(),th=n("li"),Li=n("a"),S$=r("Automatic Differentiation"),W$=p(),oh=n("li"),Ai=n("a"),B$=r("Vectorization"),U$=p(),nh=n("li"),Oi=n("a"),H$=r("Parallelization"),Q$=p(),qt=n("div"),T(Ni.$$.fragment),J$=p(),tn=n("p"),V$=r("The "),sh=n("code"),K$=r("FlaxRobertaPreTrainedModel"),G$=r(" forward method, overrides the "),ah=n("code"),X$=r("__call__"),Y$=r(" special method."),Z$=p(),T(Os.$$.fragment),e1=p(),T(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),T(Ii.$$.fragment),t1=p(),ih=n("span"),o1=r("FlaxRobertaForMaskedLM"),qf=p(),Ie=n("div"),T(Di.$$.fragment),n1=p(),Si=n("p"),s1=r("RoBERTa Model with a "),lh=n("code"),a1=r("language modeling"),r1=r(" head on top."),i1=p(),Wi=n("p"),l1=r("This model inherits from "),Pd=n("a"),d1=r("FlaxPreTrainedModel"),c1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),p1=p(),Bi=n("p"),h1=r("This model is also a Flax Linen "),Ui=n("a"),u1=r("flax.linen.Module"),f1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),m1=p(),dh=n("p"),g1=r("Finally, this model supports inherent JAX features such as:"),_1=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),b1=r("Just-In-Time (JIT) compilation"),k1=p(),ph=n("li"),Qi=n("a"),v1=r("Automatic Differentiation"),T1=p(),hh=n("li"),Ji=n("a"),y1=r("Vectorization"),w1=p(),uh=n("li"),Vi=n("a"),$1=r("Parallelization"),F1=p(),Ct=n("div"),T(Ki.$$.fragment),x1=p(),nn=n("p"),R1=r("The "),fh=n("code"),M1=r("FlaxRobertaPreTrainedModel"),E1=r(" forward method, overrides the "),mh=n("code"),z1=r("__call__"),q1=r(" special method."),C1=p(),T(Ds.$$.fragment),j1=p(),T(Ss.$$.fragment),Cf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),T(Gi.$$.fragment),P1=p(),_h=n("span"),L1=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),T(Xi.$$.fragment),A1=p(),bh=n("p"),O1=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Am.forEach(t),Aw=h(Wt),y(Es.$$.fragment,Wt),Ow=h(Wt),ut=s(Wt,"DIV",{class:!0});var mo=a(ut);y(bi.$$.fragment,mo),Nw=h(mo),Xo=s(mo,"P",{});var nc=a(Xo);Iw=i(nc,"The "),qd=s(nc,"A",{href:!0});var TR=a(qd);Dw=i(TR,"TFRobertaForQuestionAnswering"),TR.forEach(t),Sw=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yR=a(Ip);Ww=i(yR,"__call__"),yR.forEach(t),Bw=i(nc," special method."),nc.forEach(t),Uw=h(mo),y(zs.$$.fragment,mo),Hw=h(mo),y(qs.$$.fragment,mo),Qw=h(mo),y(Cs.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Om=a(Yo);js=s(Om,"A",{id:!0,class:!0,href:!0});var wR=a(js);Dp=s(wR,"SPAN",{});var $R=a(Dp);y(ki.$$.fragment,$R),$R.forEach(t),wR.forEach(t),Jw=h(Om),Sp=s(Om,"SPAN",{});var FR=a(Sp);Vw=i(FR,"FlaxRobertaModel"),FR.forEach(t),Om.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Kw=h(gt),Wp=s(gt,"P",{});var xR=a(Wp);Gw=i(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),Xw=h(gt),Ti=s(gt,"P",{});var Nm=a(Ti);Yw=i(Nm,"This model inherits from "),Cd=s(Nm,"A",{href:!0});var RR=a(Cd);Zw=i(RR,"FlaxPreTrainedModel"),RR.forEach(t),e$=i(Nm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nm.forEach(t),t$=h(gt),yi=s(gt,"P",{});var Im=a(yi);o$=i(Im,"This model is also a Flax Linen "),wi=s(Im,"A",{href:!0,rel:!0});var MR=a(wi);n$=i(MR,"flax.linen.Module"),MR.forEach(t),s$=i(Im,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Im.forEach(t),a$=h(gt),Bp=s(gt,"P",{});var ER=a(Bp);r$=i(ER,"Finally, this model supports inherent JAX features such as:"),ER.forEach(t),i$=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zR=a(Up);$i=s(zR,"A",{href:!0,rel:!0});var qR=a($i);l$=i(qR,"Just-In-Time (JIT) compilation"),qR.forEach(t),zR.forEach(t),d$=h(ra),Hp=s(ra,"LI",{});var CR=a(Hp);Fi=s(CR,"A",{href:!0,rel:!0});var jR=a(Fi);c$=i(jR,"Automatic Differentiation"),jR.forEach(t),CR.forEach(t),p$=h(ra),Qp=s(ra,"LI",{});var PR=a(Qp);xi=s(PR,"A",{href:!0,rel:!0});var LR=a(xi);h$=i(LR,"Vectorization"),LR.forEach(t),PR.forEach(t),u$=h(ra),Jp=s(ra,"LI",{});var AR=a(Jp);Ri=s(AR,"A",{href:!0,rel:!0});var OR=a(Ri);f$=i(OR,"Parallelization"),OR.forEach(t),AR.forEach(t),ra.forEach(t),m$=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),g$=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_$=i(sc,"The "),Vp=s(sc,"CODE",{});var NR=a(Vp);b$=i(NR,"FlaxRobertaPreTrainedModel"),NR.forEach(t),k$=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var IR=a(Kp);v$=i(IR,"__call__"),IR.forEach(t),T$=i(sc," special method."),sc.forEach(t),y$=h(ia),y(Ps.$$.fragment,ia),w$=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Dm=a(en);As=s(Dm,"A",{id:!0,class:!0,href:!0});var DR=a(As);Gp=s(DR,"SPAN",{});var SR=a(Gp);y(Ei.$$.fragment,SR),SR.forEach(t),DR.forEach(t),$$=h(Dm),Xp=s(Dm,"SPAN",{});var WR=a(Xp);F$=i(WR,"FlaxRobertaForCausalLM"),WR.forEach(t),Dm.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),x$=h(_t),Yp=s(_t,"P",{});var BR=a(Yp);R$=i(BR,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),BR.forEach(t),M$=h(_t),qi=s(_t,"P",{});var Sm=a(qi);E$=i(Sm,"This model inherits from "),jd=s(Sm,"A",{href:!0});var UR=a(jd);z$=i(UR,"FlaxPreTrainedModel"),UR.forEach(t),q$=i(Sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Sm.forEach(t),C$=h(_t),Ci=s(_t,"P",{});var Wm=a(Ci);j$=i(Wm,"This model is also a Flax Linen "),ji=s(Wm,"A",{href:!0,rel:!0});var HR=a(ji);P$=i(HR,"flax.linen.Module"),HR.forEach(t),L$=i(Wm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wm.forEach(t),A$=h(_t),Zp=s(_t,"P",{});var QR=a(Zp);O$=i(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),N$=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var JR=a(eh);Pi=s(JR,"A",{href:!0,rel:!0});var VR=a(Pi);I$=i(VR,"Just-In-Time (JIT) compilation"),VR.forEach(t),JR.forEach(t),D$=h(la),th=s(la,"LI",{});var KR=a(th);Li=s(KR,"A",{href:!0,rel:!0});var GR=a(Li);S$=i(GR,"Automatic Differentiation"),GR.forEach(t),KR.forEach(t),W$=h(la),oh=s(la,"LI",{});var XR=a(oh);Ai=s(XR,"A",{href:!0,rel:!0});var YR=a(Ai);B$=i(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),U$=h(la),nh=s(la,"LI",{});var ZR=a(nh);Oi=s(ZR,"A",{href:!0,rel:!0});var eM=a(Oi);H$=i(eM,"Parallelization"),eM.forEach(t),ZR.forEach(t),la.forEach(t),Q$=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);y(Ni.$$.fragment,da),J$=h(da),tn=s(da,"P",{});var ac=a(tn);V$=i(ac,"The "),sh=s(ac,"CODE",{});var tM=a(sh);K$=i(tM,"FlaxRobertaPreTrainedModel"),tM.forEach(t),G$=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oM=a(ah);X$=i(oM,"__call__"),oM.forEach(t),Y$=i(ac," special method."),ac.forEach(t),Z$=h(da),y(Os.$$.fragment,da),e1=h(da),y(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bm=a(on);Is=s(Bm,"A",{id:!0,class:!0,href:!0});var nM=a(Is);rh=s(nM,"SPAN",{});var sM=a(rh);y(Ii.$$.fragment,sM),sM.forEach(t),nM.forEach(t),t1=h(Bm),ih=s(Bm,"SPAN",{});var aM=a(ih);o1=i(aM,"FlaxRobertaForMaskedLM"),aM.forEach(t),Bm.forEach(t),qf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);y(Di.$$.fragment,bt),n1=h(bt),Si=s(bt,"P",{});var Um=a(Si);s1=i(Um,"RoBERTa Model with a "),lh=s(Um,"CODE",{});var rM=a(lh);a1=i(rM,"language modeling"),rM.forEach(t),r1=i(Um," head on top."),Um.forEach(t),i1=h(bt),Wi=s(bt,"P",{});var Hm=a(Wi);l1=i(Hm,"This model inherits from "),Pd=s(Hm,"A",{href:!0});var iM=a(Pd);d1=i(iM,"FlaxPreTrainedModel"),iM.forEach(t),c1=i(Hm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hm.forEach(t),p1=h(bt),Bi=s(bt,"P",{});var Qm=a(Bi);h1=i(Qm,"This model is also a Flax Linen "),Ui=s(Qm,"A",{href:!0,rel:!0});var lM=a(Ui);u1=i(lM,"flax.linen.Module"),lM.forEach(t),f1=i(Qm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qm.forEach(t),m1=h(bt),dh=s(bt,"P",{});var dM=a(dh);g1=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_1=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);b1=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),k1=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var uM=a(Qi);v1=i(uM,"Automatic Differentiation"),uM.forEach(t),hM.forEach(t),T1=h(ca),hh=s(ca,"LI",{});var fM=a(hh);Ji=s(fM,"A",{href:!0,rel:!0});var mM=a(Ji);y1=i(mM,"Vectorization"),mM.forEach(t),fM.forEach(t),w1=h(ca),uh=s(ca,"LI",{});var gM=a(uh);Vi=s(gM,"A",{href:!0,rel:!0});var _M=a(Vi);$1=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),F1=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);y(Ki.$$.fragment,pa),x1=h(pa),nn=s(pa,"P",{});var rc=a(nn);R1=i(rc,"The "),fh=s(rc,"CODE",{});var bM=a(fh);M1=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),E1=i(rc," forward method, overrides the "),mh=s(rc,"CODE",{});var kM=a(mh);z1=i(kM,"__call__"),kM.forEach(t),q1=i(rc," special method."),rc.forEach(t),C1=h(pa),y(Ds.$$.fragment,pa),j1=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),Cf=h(o),sn=s(o,"H2",{class:!0});var Jm=a(sn);Ws=s(Jm,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var TM=a(gh);y(Gi.$$.fragment,TM),TM.forEach(t),vM.forEach(t),P1=h(Jm),_h=s(Jm,"SPAN",{});var yM=a(_h);L1=i(yM,"FlaxRobertaForSequenceClassification"),yM.forEach(t),Jm.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A1=h(kt),bh=s(kt,"P",{});var wM=a(bh);O1=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wM.forEach(t),N1=h(kt),Yi=s(kt,"P",{});var Vm=a(Yi);I1=i(Vm,"This model inherits from "),Ld=s(Vm,"A",{href:!0});var $M=a(Ld);D1=i($M,"FlaxPreTrainedModel"),$M.forEach(t),S1=i(Vm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vm.forEach(t),W1=h(kt),Zi=s(kt,"P",{});var Km=a(Zi);B1=i(Km,"This model is also a Flax Linen "),el=s(Km,"A",{href:!0,rel:!0});var FM=a(el);U1=i(FM,"flax.linen.Module"),FM.forEach(t),H1=i(Km,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Km.forEach(t),Q1=h(kt),kh=s(kt,"P",{});var xM=a(kh);J1=i(xM,"Finally, this model supports inherent JAX features such as:"),xM.forEach(t),V1=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RM=a(vh);tl=s(RM,"A",{href:!0,rel:!0});var MM=a(tl);K1=i(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),RM.forEach(t),G1=h(ha),Th=s(ha,"LI",{});var EM=a(Th);ol=s(EM,"A",{href:!0,rel:!0});var zM=a(ol);X1=i(zM,"Automatic Differentiation"),zM.forEach(t),EM.forEach(t),Y1=h(ha),yh=s(ha,"LI",{});var qM=a(yh);nl=s(qM,"A",{href:!0,rel:!0});var CM=a(nl);Z1=i(CM,"Vectorization"),CM.forEach(t),qM.forEach(t),e2=h(ha),wh=s(ha,"LI",{});var jM=a(wh);sl=s(jM,"A",{href:!0,rel:!0});var PM=a(sl);t2=i(PM,"Parallelization"),PM.forEach(t),jM.forEach(t),ha.forEach(t),o2=h(kt),jt=s(kt,"DIV",{class:!0});var ua=a(jt);y(al.$$.fragment,ua),n2=h(ua),an=s(ua,"P",{});var ic=a(an);s2=i(ic,"The "),$h=s(ic,"CODE",{});var LM=a($h);a2=i(LM,"FlaxRobertaPreTrainedModel"),LM.forEach(t),r2=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AM=a(Fh);i2=i(AM,"__call__"),AM.forEach(t),l2=i(ic," special method."),ic.forEach(t),d2=h(ua),y(Bs.$$.fragment,ua),c2=h(ua),y(Us.$$.fragment,ua),ua.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gm=a(rn);Hs=s(Gm,"A",{id:!0,class:!0,href:!0});var OM=a(Hs);xh=s(OM,"SPAN",{});var NM=a(xh);y(rl.$$.fragment,NM),NM.forEach(t),OM.forEach(t),p2=h(Gm),Rh=s(Gm,"SPAN",{});var IM=a(Rh);h2=i(IM,"FlaxRobertaForMultipleChoice"),IM.forEach(t),Gm.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),u2=h(vt),Mh=s(vt,"P",{});var DM=a(Mh);f2=i(DM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
