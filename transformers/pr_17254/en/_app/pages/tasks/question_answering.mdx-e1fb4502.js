import{S as za,i as Ca,s as Pa,e as l,k as _,w as b,t as r,M as Fa,c as i,d as e,m as g,a as p,x as q,h as o,b as w,G as t,g as f,y,q as E,o as A,B as T,v as Sa,L as Da}from"../../chunks/vendor-316217a5.js";import{T as Wt}from"../../chunks/Tip-27e9fea0.js";import{Y as Aa}from"../../chunks/Youtube-ce8d689b.js";import{I as Kt}from"../../chunks/IconCopyLink-40460835.js";import{C as ls}from"../../chunks/CodeBlock-8418a95e.js";import{F as Ta,M as Xt}from"../../chunks/Markdown-57fe20b0.js";function Ma(F){let a,u,n,d,j;return{c(){a=l("p"),u=r("See the question answering "),n=l("a"),d=r("task page"),j=r(" for more information about other forms of question answering and their associated models, datasets, and metrics."),this.h()},l($){a=i($,"P",{});var x=p(a);u=o(x,"See the question answering "),n=i(x,"A",{href:!0,rel:!0});var z=p(n);d=o(z,"task page"),z.forEach(e),j=o(x," for more information about other forms of question answering and their associated models, datasets, and metrics."),x.forEach(e),this.h()},h(){w(n,"href","https://huggingface.co/tasks/question-answering"),w(n,"rel","nofollow")},m($,x){f($,a,x),t(a,u),t(a,n),t(n,d),t(a,j)},d($){$&&e(a)}}}function La(F){let a,u;return a=new ls({props:{code:`from transformers import DefaultDataCollator
