import{S as Pz,i as Cz,s as Sz,e as n,k as d,w as m,t as r,M as Az,c as a,d as t,m as l,a as s,x as f,h as i,b as c,F as e,g as h,y as _,q as g,o as k,B as b}from"../../chunks/vendor-4833417e.js";import{T as at}from"../../chunks/Tip-fffd6df1.js";import{D as q}from"../../chunks/Docstring-4f315ed9.js";import{C as F}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as U}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Iz(E){let u,z,v,M,x;return{c(){u=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),M=r("Module"),x=r(`
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16109/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),_r=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16109/src/transformers/models/mbart/modeling_flax_mbart.py#L1343",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16109/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16109/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16109/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16109/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16109/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sy=d(),Mc=n("p"),Ay=r("Finally, this model supports inherent JAX features such as:"),Iy=d(),ft=n("ul"),wc=n("li"),ir=n("a"),Ny=r("Just-In-Time (JIT) compilation"),Oy=d(),xc=n("li"),dr=n("a"),Dy=r("Automatic Differentiation"),Ly=d(),zc=n("li"),lr=n("a"),Gy=r("Vectorization"),Wy=d(),qc=n("li"),cr=n("a"),Ry=r("Parallelization"),Uy=d(),te=n("div"),m(pr.$$.fragment),Xy=d(),$o=n("p"),Hy=r("The "),Bc=n("code"),Vy=r("FlaxMBartPreTrainedModel"),Qy=r("forward method, overrides the "),$c=n("code"),Jy=r("__call__"),Ky=r(" special method."),Zy=d(),m(kn.$$.fragment),Yy=d(),Fc=n("p"),e1=r("Summarization example:"),t1=d(),m(hr.$$.fragment),o1=d(),jc=n("p"),n1=r("Mask filling example:"),a1=d(),m(ur.$$.fragment),s1=d(),xt=n("div"),m(mr.$$.fragment),r1=d(),Ec=n("p"),i1=r("Example:"),d1=d(),m(fr.$$.fragment),l1=d(),zt=n("div"),m(_r.$$.fragment),c1=d(),Pc=n("p"),p1=r("Example:"),h1=d(),m(gr.$$.fragment),rh=d(),Fo=n("h2"),bn=n("a"),Cc=n("span"),m(kr.$$.fragment),u1=d(),Sc=n("span"),m1=r("FlaxMBartForSequenceClassification"),ih=d(),I=n("div"),m(br.$$.fragment),f1=d(),Ac=n("p"),_1=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),x1=d(),Ic=n("p"),z1=r("Finally, this model supports inherent JAX features such as:"),q1=d(),_t=n("ul"),Nc=n("li"),Mr=n("a"),B1=r("Just-In-Time (JIT) compilation"),$1=d(),Oc=n("li"),wr=n("a"),F1=r("Automatic Differentiation"),j1=d(),Dc=n("li"),xr=n("a"),E1=r("Vectorization"),P1=d(),Lc=n("li"),zr=n("a"),C1=r("Parallelization"),S1=d(),Oe=n("div"),m(qr.$$.fragment),A1=d(),jo=n("p"),I1=r("The "),Gc=n("code"),N1=r("FlaxMBartPreTrainedModel"),O1=r("forward method, overrides the "),Wc=n("code"),D1=r("__call__"),L1=r(" special method."),G1=d(),m(vn.$$.fragment),W1=d(),Rc=n("p"),R1=r("Example:"),U1=d(),m(Br.$$.fragment),X1=d(),qt=n("div"),m($r.$$.fragment),H1=d(),Uc=n("p"),V1=r("Example:"),Q1=d(),m(Fr.$$.fragment),J1=d(),Bt=n("div"),m(jr.$$.fragment),K1=d(),Xc=n("p"),Z1=r("Example:"),Y1=d(),m(Er.$$.fragment),dh=d(),Eo=n("h2"),yn=n("a"),Hc=n("span"),m(Pr.$$.fragment),eT=d(),Vc=n("span"),tT=r("FlaxMBartForQuestionAnswering"),lh=d(),N=n("div"),m(Cr.$$.fragment),oT=d(),Po=n("p"),nT=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
target text format is `),Ve=a(jt,"CODE",{});var tM=s(Ve);Kt=i(tM,"[tgt_lang_code] X [eos]"),tM.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var oM=s(rd);Pu=i(oM,"bos"),oM.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Su=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var UT=s(Cn);id=a(UT,"STRONG",{});var nM=s(id);Au=i(nM,"call"),nM.forEach(t),Iu=i(UT,"()"),UT.forEach(t),Nu=i(Ei,` will encode source text format, and it should be wrapped
...
adding special tokens. The special tokens depend on calling set_lang.`),fw.forEach(t),o_=l(Pt),pa=a(Pt,"P",{});var qh=s(pa);n_=i(qh,"An MBART sequence has the following format, where "),Qd=a(qh,"CODE",{});var _w=s(Qd);a_=i(_w,"X"),_w.forEach(t),s_=i(qh," represents the sequence:"),qh.forEach(t),r_=l(Pt),ha=a(Pt,"UL",{});var Bh=s(ha);ua=a(Bh,"LI",{});var $h=s(ua);Jd=a($h,"CODE",{});var gw=s(Jd);i_=i(gw,"input_ids"),gw.forEach(t),d_=i($h," (for encoder) "),Kd=a($h,"CODE",{});var kw=s(Kd);l_=i(kw,"X [eos, src_lang_code]"),kw.forEach(t),$h.forEach(t),c_=l(Bh),ma=a(Bh,"LI",{});var Fh=s(ma);Zd=a(Fh,"CODE",{});var bw=s(Zd);p_=i(bw,"decoder_input_ids"),bw.forEach(t),h_=i(Fh,": (for decoder) "),Yd=a(Fh,"CODE",{});var vw=s(Yd);u_=i(vw,"X [eos, tgt_lang_code]"),vw.forEach(t),Fh.forEach(t),Bh.forEach(t),m_=l(Pt),el=a(Pt,"P",{});var yw=s(el);f_=i(yw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
make use of token type ids, therefore a list of zeros is returned.`),Tw.forEach(t),jh.forEach(t),b_=l(H),Wo=a(H,"DIV",{class:!0});var Eh=s(Wo);f(_a.$$.fragment,Eh),v_=l(Eh),ol=a(Eh,"P",{});var Mw=s(ol);y_=i(Mw,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),Mw.forEach(t),Eh.forEach(t),T_=l(H),Ro=a(H,"DIV",{class:!0});var Ph=s(Ro);f(ga.$$.fragment,Ph),M_=l(Ph),nl=a(Ph,"P",{});var ww=s(nl);w_=i(ww,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),ww.forEach(t),Ph.forEach(t),H.forEach(t),Np=l(o),io=a(o,"H2",{class:!0});var Ch=s(io);Uo=a(Ch,"A",{id:!0,class:!0,href:!0});var xw=s(Uo);al=a(xw,"SPAN",{});var zw=s(al);f(ka.$$.fragment,zw),zw.forEach(t),xw.forEach(t),x_=l(Ch),sl=a(Ch,"SPAN",{});var qw=s(sl);z_=i(qw,"MBart50Tokenizer"),qw.forEach(t),Ch.forEach(t),Op=l(o),S=a(o,"DIV",{class:!0});var V=s(S);f(ba.$$.fragment,V),q_=l(V),va=a(V,"P",{});var Sh=s(va);B_=i(Sh,"Construct a MBart50 tokenizer. Based on "),ya=a(Sh,"A",{href:!0,rel:!0});var Bw=s(ya);$_=i(Bw,"SentencePiece"),Bw.forEach(t),F_=i(Sh,"."),Sh.forEach(t),j_=l(V),Ta=a(V,"P",{});var Ah=s(Ta);E_=i(Ah,"This tokenizer inherits from "),mi=a(Ah,"A",{href:!0});var $w=s(mi);P_=i($w,"PreTrainedTokenizer"),$w.forEach(t),C_=i(Ah,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ah.forEach(t),S_=l(V),rl=a(V,"P",{});var Fw=s(rl);A_=i(Fw,"Examples:"),Fw.forEach(t),I_=l(V),f(Ma.$$.fragment,V),N_=l(V),ot=a(V,"DIV",{class:!0});var qn=s(ot);f(wa.$$.fragment,qn),O_=l(qn),xa=a(qn,"P",{});var Ih=s(xa);D_=i(Ih,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),il=a(Ih,"CODE",{});var jw=s(il);L_=i(jw,"X"),jw.forEach(t),G_=i(Ih," represents the sequence:"),Ih.forEach(t),W_=l(qn),za=a(qn,"UL",{});var Nh=s(za);qa=a(Nh,"LI",{});var Oh=s(qa);dl=a(Oh,"CODE",{});var Ew=s(dl);R_=i(Ew,"input_ids"),Ew.forEach(t),U_=i(Oh," (for encoder) "),ll=a(Oh,"CODE",{});var Pw=s(ll);X_=i(Pw,"[src_lang_code] X [eos]"),Pw.forEach(t),Oh.forEach(t),H_=l(Nh),Ba=a(Nh,"LI",{});var Dh=s(Ba);cl=a(Dh,"CODE",{});var Cw=s(cl);V_=i(Cw,"labels"),Cw.forEach(t),Q_=i(Dh,": (for decoder) "),pl=a(Dh,"CODE",{});var Sw=s(pl);J_=i(Sw,"[tgt_lang_code] X [eos]"),Sw.forEach(t),Dh.forEach(t),Nh.forEach(t),K_=l(qn),hl=a(qn,"P",{});var Aw=s(hl);Z_=i(Aw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Aw.forEach(t),qn.forEach(t),Y_=l(V),Xo=a(V,"DIV",{class:!0});var Lh=s(Xo);f($a.$$.fragment,Lh),eg=l(Lh),ul=a(Lh,"P",{});var Iw=s(ul);tg=i(Iw,"Converts a sequence of tokens (strings for sub-words) in a single string."),Iw.forEach(t),Lh.forEach(t),og=l(V),Ho=a(V,"DIV",{class:!0});var Gh=s(Ho);f(Fa.$$.fragment,Gh),ng=l(Gh),ja=a(Gh,"P",{});var Wh=s(ja);ag=i(Wh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ml=a(Wh,"CODE",{});var Nw=s(ml);sg=i(Nw,"prepare_for_model"),Nw.forEach(t),rg=i(Wh," method."),Wh.forEach(t),Gh.forEach(t),ig=l(V),Vo=a(V,"DIV",{class:!0});var Rh=s(Vo);f(Ea.$$.fragment,Rh),dg=l(Rh),fl=a(Rh,"P",{});var Ow=s(fl);lg=i(Ow,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),Ow.forEach(t),Rh.forEach(t),cg=l(V),Qo=a(V,"DIV",{class:!0});var Uh=s(Qo);f(Pa.$$.fragment,Uh),pg=l(Uh),_l=a(Uh,"P",{});var Dw=s(_l);hg=i(Dw,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),Dw.forEach(t),Uh.forEach(t),V.forEach(t),Dp=l(o),lo=a(o,"H2",{class:!0});var Xh=s(lo);Jo=a(Xh,"A",{id:!0,class:!0,href:!0});var Lw=s(Jo);gl=a(Lw,"SPAN",{});var Gw=s(gl);f(Ca.$$.fragment,Gw),Gw.forEach(t),Lw.forEach(t),ug=l(Xh),kl=a(Xh,"SPAN",{});var Ww=s(kl);mg=i(Ww,"MBart50TokenizerFast"),Ww.forEach(t),Xh.forEach(t),Lp=l(o),G=a(o,"DIV",{class:!0});var ue=s(G);f(Sa.$$.fragment,ue),fg=l(ue),co=a(ue,"P",{});var Ni=s(co);_g=i(Ni,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),bl=a(Ni,"EM",{});var Rw=s(bl);gg=i(Rw,"tokenizers"),Rw.forEach(t),kg=i(Ni,` library). Based on
`),Aa=a(Ni,"A",{href:!0,rel:!0});var Uw=s(Aa);bg=i(Uw,"BPE"),Uw.forEach(t),vg=i(Ni,"."),Ni.forEach(t),yg=l(ue),Ia=a(ue,"P",{});var Hh=s(Ia);Tg=i(Hh,"This tokenizer inherits from "),fi=a(Hh,"A",{href:!0});var Xw=s(fi);Mg=i(Xw,"PreTrainedTokenizerFast"),Xw.forEach(t),wg=i(Hh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hh.forEach(t),xg=l(ue),vl=a(ue,"P",{});var Hw=s(vl);zg=i(Hw,"Examples:"),Hw.forEach(t),qg=l(ue),f(Na.$$.fragment,ue),Bg=l(ue),Ce=a(ue,"DIV",{class:!0});var Ct=s(Ce);f(Oa.$$.fragment,Ct),$g=l(Ct),yl=a(Ct,"P",{});var Vw=s(yl);Fg=i(Vw,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),Vw.forEach(t),jg=l(Ct),Da=a(Ct,"P",{});var Vh=s(Da);Eg=i(Vh,"An MBART-50 sequence has the following format, where "),Tl=a(Vh,"CODE",{});var Qw=s(Tl);Pg=i(Qw,"X"),Qw.forEach(t),Cg=i(Vh," represents the sequence:"),Vh.forEach(t),Sg=l(Ct),La=a(Ct,"UL",{});var Qh=s(La);Ga=a(Qh,"LI",{});var Jh=s(Ga);Ml=a(Jh,"CODE",{});var Jw=s(Ml);Ag=i(Jw,"input_ids"),Jw.forEach(t),Ig=i(Jh," (for encoder) "),wl=a(Jh,"CODE",{});var Kw=s(wl);Ng=i(Kw,"[src_lang_code] X [eos]"),Kw.forEach(t),Jh.forEach(t),Og=l(Qh),Wa=a(Qh,"LI",{});var Kh=s(Wa);xl=a(Kh,"CODE",{});var Zw=s(xl);Dg=i(Zw,"labels"),Zw.forEach(t),Lg=i(Kh,": (for decoder) "),zl=a(Kh,"CODE",{});var Yw=s(zl);Gg=i(Yw,"[tgt_lang_code] X [eos]"),Yw.forEach(t),Kh.forEach(t),Qh.forEach(t),Wg=l(Ct),ql=a(Ct,"P",{});var e0=s(ql);Rg=i(e0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Oi=s(ho);lk=i(Oi,"The "),gi=a(Oi,"A",{href:!0});var d0=s(gi);ck=i(d0,"MBartModel"),d0.forEach(t),pk=i(Oi," forward method, overrides the "),El=a(Oi,"CODE",{});var l0=s(El);hk=i(l0,"__call__"),l0.forEach(t),uk=i(Oi," special method."),Oi.forEach(t),mk=l(St),f(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var c0=s(Pl);_k=i(c0,"Example:"),c0.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p0=s(tn);Cl=a(p0,"SPAN",{});var h0=s(Cl);f(Ya.$$.fragment,h0),h0.forEach(t),p0.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var u0=s(Sl);bk=i(u0,"MBartForConditionalGeneration"),u0.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);f(es.$$.fragment,$n),vk=l($n),ts=a($n,"P",{});var au=s(ts);yk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l($n),os=a($n,"P",{});var su=s(os);xk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var f0=s(ns);zk=i(f0,"torch.nn.Module"),f0.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l($n),Z=a($n,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),$k=l(Le),mo=a(Le,"P",{});var Di=s(mo);Fk=i(Di,"The "),bi=a(Di,"A",{href:!0});var _0=s(bi);jk=i(_0,"MBartForConditionalGeneration"),_0.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var g0=s(Al);Pk=i(g0,"__call__"),g0.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(on.$$.fragment,Le),Ak=l(Le),Il=a(Le,"P",{});var k0=s(Il);Ik=i(k0,"Translation example:"),k0.forEach(t),Nk=l(Le),f(ss.$$.fragment,Le),Ok=l(Le),Nl=a(Le,"P",{});var b0=s(Nl);Dk=i(b0,"Mask filling example:"),b0.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),$n.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var v0=s(nn);Ol=a(v0,"SPAN",{});var y0=s(Ol);f(is.$$.fragment,y0),y0.forEach(t),v0.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T0=s(Dl);Wk=i(T0,"MBartForQuestionAnswering"),T0.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var M0=s(Ll);Xk=i(M0,"span start logits"),M0.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var w0=s(Gl);Vk=i(w0,"span end logits"),w0.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(At),ls=a(At,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),vi=a(iu,"A",{href:!0});var x0=s(vi);Zk=i(x0,"PreTrainedModel"),x0.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var It=s(Ae);f(hs.$$.fragment,It),sb=l(It),go=a(It,"P",{});var Gi=s(go);rb=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var q0=s(yi);ib=i(q0,"MBartForQuestionAnswering"),q0.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var B0=s(Wl);lb=i(B0,"__call__"),B0.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(It),f(an.$$.fragment,It),hb=l(It),Rl=a(It,"P",{});var $0=s(Rl);ub=i($0,"Example:"),$0.forEach(t),mb=l(It),f(us.$$.fragment,It),It.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var F0=s(sn);Ul=a(F0,"SPAN",{});var j0=s(Ul);f(ms.$$.fragment,j0),j0.forEach(t),F0.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E0=s(Xl);_b=i(E0,"MBartForSequenceClassification"),E0.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var Nt=s(Be);f(fs.$$.fragment,Nt),gb=l(Nt),Hl=a(Nt,"P",{});var P0=s(Hl);kb=i(P0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(Nt),gs=a(Nt,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var S0=s(ks);xb=i(S0,"torch.nn.Module"),S0.forEach(t),zb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);$b=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var A0=s(Mi);Fb=i(A0,"MBartForSequenceClassification"),A0.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var I0=s(Vl);Eb=i(I0,"__call__"),I0.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var N0=s(Ql);Ab=i(N0,"Example of single-label classification:"),N0.forEach(t),Ib=l(Ge),f(vs.$$.fragment,Ge),Nb=l(Ge),Jl=a(Ge,"P",{});var O0=s(Jl);Ob=i(O0,"Example of multi-label classification:"),O0.forEach(t),Db=l(Ge),f(ys.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Jp=l(o),vo=a(o,"H2",{class:!0});var hu=s(vo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D0=s(dn);Kl=a(D0,"SPAN",{});var L0=s(Kl);f(Ts.$$.fragment,L0),L0.forEach(t),D0.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G0=s(Zl);Gb=i(G0,"MBartForCausalLM"),G0.forEach(t),hu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var uu=s(yo);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var W0=s(Yl);Ub=i(W0,"Example:"),W0.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var R0=s(ln);ec=a(R0,"SPAN",{});var U0=s(ec);f(zs.$$.fragment,U0),U0.forEach(t),R0.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X0=s(tc);Vb=i(X0,"TFMBartModel"),X0.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);f(qs.$$.fragment,Ot),Qb=l(Ot),Bs=a(Ot,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nv=l(Ot),f(cn.$$.fragment,Ot),av=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),sv=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);rv=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q0=s(xi);iv=i(Q0,"TFMBartModel"),Q0.forEach(t),dv=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J0=s(oc);lv=i(J0,"__call__"),J0.forEach(t),cv=i(Ui," special method."),Ui.forEach(t),pv=l(Dt),f(pn.$$.fragment,Dt),hv=l(Dt),nc=a(Dt,"P",{});var K0=s(nc);uv=i(K0,"Example:"),K0.forEach(t),mv=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z0=s(hn);ac=a(Z0,"SPAN",{});var Y0=s(ac);f(Ps.$$.fragment,Y0),Y0.forEach(t),Z0.forEach(t),fv=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_v=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gv=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);kv=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var tx=s(zi);bv=i(tx,"TFPreTrainedModel"),tx.forEach(t),vv=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),yv=l(Lt),As=a(Lt,"P",{});var bu=s(As);Tv=i(bu,"This model is also a "),Is=a(bu,"A",{href:!0,rel:!0});var ox=s(Is);Mv=i(ox,"tf.keras.Model"),ox.forEach(t),wv=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),xv=l(Lt),f(un.$$.fragment,Lt),zv=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Ns.$$.fragment,We),qv=l(We),xo=a(We,"P",{});var Xi=s(xo);Bv=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var nx=s(qi);$v=i(nx,"TFMBartForConditionalGeneration"),nx.forEach(t),Fv=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var ax=s(rc);jv=i(ax,"__call__"),ax.forEach(t),Ev=i(Xi," special method."),Xi.forEach(t),Pv=l(We),f(mn.$$.fragment,We),Cv=l(We),ic=a(We,"P",{});var sx=s(ic);Sv=i(sx,"Summarization example:"),sx.forEach(t),Av=l(We),f(Os.$$.fragment,We),Iv=l(We),dc=a(We,"P",{});var rx=s(dc);Nv=i(rx,"Mask filling example:"),rx.forEach(t),Ov=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),oh=l(o),zo=a(o,"H2",{class:!0});var vu=s(zo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var ix=s(fn);lc=a(ix,"SPAN",{});var dx=s(lc);f(Ls.$$.fragment,dx),dx.forEach(t),ix.forEach(t),Dv=l(vu),cc=a(vu,"SPAN",{});var lx=s(cc);Lv=i(lx,"FlaxMBartModel"),lx.forEach(t),vu.forEach(t),nh=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),Gv=l(me),Ws=a(me,"P",{});var yu=s(Ws);Wv=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=a(yu,"A",{href:!0});var cx=s(Bi);Rv=i(cx,"FlaxPreTrainedModel"),cx.forEach(t),Uv=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),rr=a(xu,"A",{href:!0,rel:!0});var Fx=s(rr);Py=i(Fx,"flax.nn.Module"),Fx.forEach(t),Cy=i(xu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sy=l(fe),Mc=a(fe,"P",{});var jx=s(Mc);Ay=i(jx,"Finally, this model supports inherent JAX features such as:"),jx.forEach(t),Iy=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var Ex=s(wc);ir=a(Ex,"A",{href:!0,rel:!0});var Px=s(ir);Ny=i(Px,"Just-In-Time (JIT) compilation"),Px.forEach(t),Ex.forEach(t),Oy=l(jn),xc=a(jn,"LI",{});var Cx=s(xc);dr=a(Cx,"A",{href:!0,rel:!0});var Sx=s(dr);Dy=i(Sx,"Automatic Differentiation"),Sx.forEach(t),Cx.forEach(t),Ly=l(jn),zc=a(jn,"LI",{});var Ax=s(zc);lr=a(Ax,"A",{href:!0,rel:!0});var Ix=s(lr);Gy=i(Ix,"Vectorization"),Ix.forEach(t),Ax.forEach(t),Wy=l(jn),qc=a(jn,"LI",{});var Nx=s(qc);cr=a(Nx,"A",{href:!0,rel:!0});var Ox=s(cr);Ry=i(Ox,"Parallelization"),Ox.forEach(t),Nx.forEach(t),jn.forEach(t),Uy=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xy=l(Re),$o=a(Re,"P",{});var Ji=s($o);Hy=i(Ji,"The "),Bc=a(Ji,"CODE",{});var Dx=s(Bc);Vy=i(Dx,"FlaxMBartPreTrainedModel"),Dx.forEach(t),Qy=i(Ji,"forward method, overrides the "),$c=a(Ji,"CODE",{});var Lx=s($c);Jy=i(Lx,"__call__"),Lx.forEach(t),Ky=i(Ji," special method."),Ji.forEach(t),Zy=l(Re),f(kn.$$.fragment,Re),Yy=l(Re),Fc=a(Re,"P",{});var Gx=s(Fc);e1=i(Gx,"Summarization example:"),Gx.forEach(t),t1=l(Re),f(hr.$$.fragment,Re),o1=l(Re),jc=a(Re,"P",{});var Wx=s(jc);n1=i(Wx,"Mask filling example:"),Wx.forEach(t),a1=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),s1=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),r1=l(Ki),Ec=a(Ki,"P",{});var Rx=s(Ec);i1=i(Rx,"Example:"),Rx.forEach(t),d1=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),l1=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),c1=l(Zi),Pc=a(Zi,"P",{});var Ux=s(Pc);p1=i(Ux,"Example:"),Ux.forEach(t),h1=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),Fo=a(o,"H2",{class:!0});var zu=s(Fo);bn=a(zu,"A",{id:!0,class:!0,href:!0});var Xx=s(bn);Cc=a(Xx,"SPAN",{});var Hx=s(Cc);f(kr.$$.fragment,Hx),Hx.forEach(t),Xx.forEach(t),u1=l(zu),Sc=a(zu,"SPAN",{});var Vx=s(Sc);m1=i(Vx,"FlaxMBartForSequenceClassification"),Vx.forEach(t),zu.forEach(t),ih=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(br.$$.fragment,oe),f1=l(oe),Ac=a(oe,"P",{});var Qx=s(Ac);_1=i(Qx,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Qx.forEach(t),g1=l(oe),vr=a(oe,"P",{});var qu=s(vr);k1=i(qu,"This model inherits from "),Fi=a(qu,"A",{href:!0});var Jx=s(Fi);b1=i(Jx,"FlaxPreTrainedModel"),Jx.forEach(t),v1=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),y1=l(oe),yr=a(oe,"P",{});var Bu=s(yr);T1=i(Bu,`This model is also a Flax Linen
`),Tr=a(Bu,"A",{href:!0,rel:!0});var Kx=s(Tr);M1=i(Kx,"flax.nn.Module"),Kx.forEach(t),w1=i(Bu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),x1=l(oe),Ic=a(oe,"P",{});var Zx=s(Ic);z1=i(Zx,"Finally, this model supports inherent JAX features such as:"),Zx.forEach(t),q1=l(oe),_t=a(oe,"UL",{});var En=s(_t);Nc=a(En,"LI",{});var Yx=s(Nc);Mr=a(Yx,"A",{href:!0,rel:!0});var ez=s(Mr);B1=i(ez,"Just-In-Time (JIT) compilation"),ez.forEach(t),Yx.forEach(t),$1=l(En),Oc=a(En,"LI",{});var tz=s(Oc);wr=a(tz,"A",{href:!0,rel:!0});var oz=s(wr);F1=i(oz,"Automatic Differentiation"),oz.forEach(t),tz.forEach(t),j1=l(En),Dc=a(En,"LI",{});var nz=s(Dc);xr=a(nz,"A",{href:!0,rel:!0});var az=s(xr);E1=i(az,"Vectorization"),az.forEach(t),nz.forEach(t),P1=l(En),Lc=a(En,"LI",{});var sz=s(Lc);zr=a(sz,"A",{href:!0,rel:!0});var rz=s(zr);C1=i(rz,"Parallelization"),rz.forEach(t),sz.forEach(t),En.forEach(t),S1=l(oe),Oe=a(oe,"DIV",{class:!0});var Wt=s(Oe);f(qr.$$.fragment,Wt),A1=l(Wt),jo=a(Wt,"P",{});var Yi=s(jo);I1=i(Yi,"The "),Gc=a(Yi,"CODE",{});var iz=s(Gc);N1=i(iz,"FlaxMBartPreTrainedModel"),iz.forEach(t),O1=i(Yi,"forward method, overrides the "),Wc=a(Yi,"CODE",{});var dz=s(Wc);D1=i(dz,"__call__"),dz.forEach(t),L1=i(Yi," special method."),Yi.forEach(t),G1=l(Wt),f(vn.$$.fragment,Wt),W1=l(Wt),Rc=a(Wt,"P",{});var lz=s(Rc);R1=i(lz,"Example:"),lz.forEach(t),U1=l(Wt),f(Br.$$.fragment,Wt),Wt.forEach(t),X1=l(oe),qt=a(oe,"DIV",{class:!0});var ed=s(qt);f($r.$$.fragment,ed),H1=l(ed),Uc=a(ed,"P",{});var cz=s(Uc);V1=i(cz,"Example:"),cz.forEach(t),Q1=l(ed),f(Fr.$$.fragment,ed),ed.forEach(t),J1=l(oe),Bt=a(oe,"DIV",{class:!0});var td=s(Bt);f(jr.$$.fragment,td),K1=l(td),Xc=a(td,"P",{});var pz=s(Xc);Z1=i(pz,"Example:"),pz.forEach(t),Y1=l(td),f(Er.$$.fragment,td),td.forEach(t),oe.forEach(t),dh=l(o),Eo=a(o,"H2",{class:!0});var $u=s(Eo);yn=a($u,"A",{id:!0,class:!0,href:!0});var hz=s(yn);Hc=a(hz,"SPAN",{});var uz=s(Hc);f(Pr.$$.fragment,uz),uz.forEach(t),hz.forEach(t),eT=l($u),Vc=a($u,"SPAN",{});var mz=s(Vc);tT=i(mz,"FlaxMBartForQuestionAnswering"),mz.forEach(t),$u.forEach(t),lh=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Cr.$$.fragment,ne),oT=l(ne),Po=a(ne,"P",{});var od=s(Po);nT=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
