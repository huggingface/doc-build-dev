...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16445/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16445/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16445/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16445/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16445/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),bp=new w({}),{c(){y=o("meta"),C=u(),b=o("h1"),k=o("a"),ee=o("span"),f(z.$$.fragment),x=u(),se=o("span"),R=a("DeepSpeed Integration"),ae=u(),S=o("p"),E=o("a"),q=a("DeepSpeed"),Es=a(" implements everything described in the "),V=o("a"),qs=a("ZeRO paper"),L4=a(". Currently it provides full support for:"),Bj=u(),I=o("ol"),sf=o("li"),M4=a("Optimizer state partitioning (ZeRO stage 1)"),Z4=u(),tf=o("li"),N4=a("Gradient partitioning (ZeRO stage 2)"),H4=u(),af=o("li"),B4=a("Parameter partitioning (ZeRO stage 3)"),W4=u(),nf=o("li"),F4=a("Custom mixed precision training handling"),V4=u(),of=o("li"),Y4=a("A range of fast CUDA-extension-based optimizers"),K4=u(),lf=o("li"),J4=a("ZeRO-Offload to CPU and NVMe"),Wj=u(),Se=o("p"),X4=a("ZeRO-Offload has its own dedicated paper: "),ao=o("a"),Q4=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),e6=a(". And NVMe-support is described in the paper "),no=o("a"),s6=a(`ZeRO-Infinity: Breaking the GPU
...
install `),gf=o("em"),e5=a("libaio-dev"),s5=a(" system-wide)."),vg=u(),Dt=o("p"),t5=a("Edit "),wf=o("code"),a5=a("TORCH_CUDA_ARCH_LIST"),n5=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),jg=u(),f(_o.$$.fragment),gg=u(),Pe=o("p"),o5=a("So if you get "),yf=o("code"),l5=a("8, 6"),r5=a(", then use "),bf=o("code"),p5=a('TORCH_CUDA_ARCH_LIST="8.6"'),i5=a(`. If you have multiple different cards, you can list all
of them like so `),Ef=o("code"),u5=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),wg=u(),ti=o("p"),c5=a("If you need to use the same setup on multiple machines, make a binary wheel:"),yg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h5=a("it will generate something like "),qf=o("code"),f5=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d5=a(` which now you can install
as `),$f=o("code"),m5=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_5=a(" locally or on any other machine."),Eg=u(),zt=o("p"),v5=a("Again, remember to ensure to adjust "),kf=o("code"),j5=a("TORCH_CUDA_ARCH_LIST"),g5=a(" to the target architectures."),qg=u(),Ue=o("p"),w5=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Pf=o("strong"),y5=a("Compute Capabilities"),b5=a(` (same as arch in this
context) `),jo=o("a"),E5=a("here"),q5=a("."),$g=u(),ai=o("p"),$5=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k5=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(wo.$$.fragment),zg=u(),oi=o("p"),P5=a("If the output is:"),Og=u(),f(yo.$$.fragment),Tg=u(),Ot=o("p"),D5=a("then you know that this card\u2019s arch is "),Df=o("code"),z5=a("8.6"),O5=a("."),Ag=u(),Tt=o("p"),T5=a("You can also leave "),zf=o("code"),A5=a("TORCH_CUDA_ARCH_LIST"),S5=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Sg=u(),At=o("p"),C5=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=o("a"),x5=a("Deepspeed"),R5=a(","),Cg=u(),li=o("a"),xg=u(),Ps=o("h3"),St=o("a"),Of=o("span"),f(Eo.$$.fragment),I5=u(),Tf=o("span"),U5=a("Deployment with multiple GPUs"),Rg=u(),Ct=o("p"),G5=a("To deploy this feature with multiple GPUs adjust the "),ri=o("a"),L5=a("Trainer"),M5=a(` command line arguments as
following:`),Ig=u(),xt=o("ol"),Ds=o("li"),Z5=a("replace "),Af=o("code"),N5=a("python -m torch.distributed.launch"),H5=a(" with "),Sf=o("code"),B5=a("deepspeed"),W5=a("."),F5=u(),De=o("li"),V5=a("add a new argument "),Cf=o("code"),Y5=a("--deepspeed ds_config.json"),K5=a(", where "),xf=o("code"),J5=a("ds_config.json"),X5=a(` is the DeepSpeed configuration file as
documented `),qo=o("a"),Q5=a("here"),e$=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s$=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t$=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a$=a("Unlike, "),Rf=o("code"),n$=a("torch.distributed.launch"),o$=a(" where you have to specify how many GPUs to use with "),If=o("code"),l$=a("--nproc_per_node"),r$=a(`, with the
`),Uf=o("code"),p$=a("deepspeed"),i$=a(" launcher you don\u2019t have to use the corresponding "),Gf=o("code"),u$=a("--num_gpus"),c$=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=o("a"),h$=a("here"),f$=a("."),Ng=u(),ne=o("p"),d$=a("In fact, you can continue using "),Lf=o("code"),m$=a("-m torch.distributed.launch"),_$=a(` with DeepSpeed as long as you don\u2019t need to use
`),Mf=o("code"),v$=a("deepspeed"),j$=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Zf=o("code"),g$=a("deepspeed"),w$=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Hg=u(),Rt=o("p"),y$=a("Here is an example of running "),Nf=o("code"),b$=a("run_translation.py"),E$=a(" under DeepSpeed deploying all available GPUs:"),Bg=u(),f(Do.$$.fragment),Wg=u(),It=o("p"),q$=a("Note that in the DeepSpeed documentation you are likely to see "),Hf=o("code"),$$=a("--deepspeed --deepspeed_config ds_config.json"),k$=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Fg=u(),Ut=o("p"),P$=a("For some practical usage examples, please, see this "),zo=o("a"),D$=a("post"),z$=a("."),Vg=u(),ui=o("a"),Yg=u(),zs=o("h3"),Gt=o("a"),Bf=o("span"),f(Oo.$$.fragment),O$=u(),Wf=o("span"),T$=a("Deployment with one GPU"),Kg=u(),Lt=o("p"),A$=a("To deploy DeepSpeed with one GPU adjust the "),ci=o("a"),S$=a("Trainer"),C$=a(" command line arguments as follows:"),Jg=u(),f(To.$$.fragment),Xg=u(),Ge=o("p"),x$=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Ff=o("code"),R$=a("--num_gpus=1"),I$=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=o("a"),U$=a("documentation"),G$=a(" discusses the launcher options."),Qg=u(),hi=o("p"),L$=a("Why would you want to use DeepSpeed with just one GPU?"),ew=u(),Mt=o("ol"),Vf=o("li"),M$=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),Z$=u(),Yf=o("li"),N$=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),sw=u(),fi=o("p"),H$=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),tw=u(),f(So.$$.fragment),aw=u(),di=o("p"),B$=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),nw=u(),Zt=o("p"),W$=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F$=a("post"),V$=a("."),ow=u(),mi=o("p"),Y$=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),lw=u(),_i=o("p"),K$=a("Notes:"),rw=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J$=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=o("code"),X$=a("CUDA_VISIBLE_DEVICES"),Q$=a(` to limit
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Op=o("a"),vG=a("DeepSpeed GitHub"),jG=a("."),this.h()},l(e){const p=MK('[data-svelte="svelte-1phssyn"]',document.head);y=l(p,"META",{name:!0,content:!0}),p.forEach(t),C=c(e),b=l(e,"H1",{class:!0});var Tp=r(b);k=l(Tp,"A",{id:!0,class:!0,href:!0});var Uj=r(k);ee=l(Uj,"SPAN",{});var Gj=r(ee);d(z.$$.fragment,Gj),Gj.forEach(t),Uj.forEach(t),x=c(Tp),se=l(Tp,"SPAN",{});var $G=r(se);R=n($G,"DeepSpeed Integration"),$G.forEach(t),Tp.forEach(t),ae=c(e),S=l(e,"P",{});var Lj=r(S);E=l(Lj,"A",{href:!0,rel:!0});var kG=r(E);q=n(kG,"DeepSpeed"),kG.forEach(t),Es=n(Lj," implements everything described in the "),V=l(Lj,"A",{href:!0,rel:!0});var PG=r(V);qs=n(PG,"ZeRO paper"),PG.forEach(t),L4=n(Lj,". Currently it provides full support for:"),Lj.forEach(t),Bj=c(e),I=l(e,"OL",{});var je=r(I);sf=l(je,"LI",{});var DG=r(sf);M4=n(DG,"Optimizer state partitioning (ZeRO stage 1)"),DG.forEach(t),Z4=c(je),tf=l(je,"LI",{});var zG=r(tf);N4=n(zG,"Gradient partitioning (ZeRO stage 2)"),zG.forEach(t),H4=c(je),af=l(je,"LI",{});var OG=r(af);B4=n(OG,"Parameter partitioning (ZeRO stage 3)"),OG.forEach(t),W4=c(je),nf=l(je,"LI",{});var TG=r(nf);F4=n(TG,"Custom mixed precision training handling"),TG.forEach(t),V4=c(je),of=l(je,"LI",{});var AG=r(of);Y4=n(AG,"A range of fast CUDA-extension-based optimizers"),AG.forEach(t),K4=c(je),lf=l(je,"LI",{});var SG=r(lf);J4=n(SG,"ZeRO-Offload to CPU and NVMe"),SG.forEach(t),je.forEach(t),Wj=c(e),Se=l(e,"P",{});var rh=r(Se);X4=n(rh,"ZeRO-Offload has its own dedicated paper: "),ao=l(rh,"A",{href:!0,rel:!0});var CG=r(ao);Q4=n(CG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),CG.forEach(t),e6=n(rh,". And NVMe-support is described in the paper "),no=l(rh,"A",{href:!0,rel:!0});var xG=r(no);s6=n(xG,`ZeRO-Infinity: Breaking the GPU
...
install `),gf=l(uh,"EM",{});var dL=r(gf);e5=n(dL,"libaio-dev"),dL.forEach(t),s5=n(uh," system-wide)."),uh.forEach(t),vg=c(e),Dt=l(e,"P",{});var cE=r(Dt);t5=n(cE,"Edit "),wf=l(cE,"CODE",{});var mL=r(wf);a5=n(mL,"TORCH_CUDA_ARCH_LIST"),mL.forEach(t),n5=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),cE.forEach(t),jg=c(e),d(_o.$$.fragment,e),gg=c(e),Pe=l(e,"P",{});var Ap=r(Pe);o5=n(Ap,"So if you get "),yf=l(Ap,"CODE",{});var _L=r(yf);l5=n(_L,"8, 6"),_L.forEach(t),r5=n(Ap,", then use "),bf=l(Ap,"CODE",{});var vL=r(bf);p5=n(vL,'TORCH_CUDA_ARCH_LIST="8.6"'),vL.forEach(t),i5=n(Ap,`. If you have multiple different cards, you can list all
of them like so `),Ef=l(Ap,"CODE",{});var jL=r(Ef);u5=n(jL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),jL.forEach(t),Ap.forEach(t),wg=c(e),ti=l(e,"P",{});var gL=r(ti);c5=n(gL,"If you need to use the same setup on multiple machines, make a binary wheel:"),gL.forEach(t),yg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h5=n(ch,"it will generate something like "),qf=l(ch,"CODE",{});var wL=r(qf);f5=n(wL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wL.forEach(t),d5=n(ch,` which now you can install
as `),$f=l(ch,"CODE",{});var yL=r($f);m5=n(yL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),yL.forEach(t),_5=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),zt=l(e,"P",{});var hE=r(zt);v5=n(hE,"Again, remember to ensure to adjust "),kf=l(hE,"CODE",{});var bL=r(kf);j5=n(bL,"TORCH_CUDA_ARCH_LIST"),bL.forEach(t),g5=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);w5=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Pf=l(hh,"STRONG",{});var EL=r(Pf);y5=n(EL,"Compute Capabilities"),EL.forEach(t),b5=n(hh,` (same as arch in this
context) `),jo=l(hh,"A",{href:!0,rel:!0});var qL=r(jo);E5=n(qL,"here"),qL.forEach(t),q5=n(hh,"."),hh.forEach(t),$g=c(e),ai=l(e,"P",{});var $L=r(ai);$5=n($L,"You can check the archs pytorch was built with using:"),$L.forEach(t),kg=c(e),d(go.$$.fragment,e),Pg=c(e),ni=l(e,"P",{});var kL=r(ni);k5=n(kL,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),kL.forEach(t),Dg=c(e),d(wo.$$.fragment,e),zg=c(e),oi=l(e,"P",{});var PL=r(oi);P5=n(PL,"If the output is:"),PL.forEach(t),Og=c(e),d(yo.$$.fragment,e),Tg=c(e),Ot=l(e,"P",{});var fE=r(Ot);D5=n(fE,"then you know that this card\u2019s arch is "),Df=l(fE,"CODE",{});var DL=r(Df);z5=n(DL,"8.6"),DL.forEach(t),O5=n(fE,"."),fE.forEach(t),Ag=c(e),Tt=l(e,"P",{});var dE=r(Tt);T5=n(dE,"You can also leave "),zf=l(dE,"CODE",{});var zL=r(zf);A5=n(zL,"TORCH_CUDA_ARCH_LIST"),zL.forEach(t),S5=n(dE,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),dE.forEach(t),Sg=c(e),At=l(e,"P",{});var mE=r(At);C5=n(mE,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=l(mE,"A",{href:!0,rel:!0});var OL=r(bo);x5=n(OL,"Deepspeed"),OL.forEach(t),R5=n(mE,","),mE.forEach(t),Cg=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),xg=c(e),Ps=l(e,"H3",{class:!0});var _E=r(Ps);St=l(_E,"A",{id:!0,class:!0,href:!0});var TL=r(St);Of=l(TL,"SPAN",{});var AL=r(Of);d(Eo.$$.fragment,AL),AL.forEach(t),TL.forEach(t),I5=c(_E),Tf=l(_E,"SPAN",{});var SL=r(Tf);U5=n(SL,"Deployment with multiple GPUs"),SL.forEach(t),_E.forEach(t),Rg=c(e),Ct=l(e,"P",{});var vE=r(Ct);G5=n(vE,"To deploy this feature with multiple GPUs adjust the "),ri=l(vE,"A",{href:!0});var CL=r(ri);L5=n(CL,"Trainer"),CL.forEach(t),M5=n(vE,` command line arguments as
following:`),vE.forEach(t),Ig=c(e),xt=l(e,"OL",{});var jE=r(xt);Ds=l(jE,"LI",{});var fh=r(Ds);Z5=n(fh,"replace "),Af=l(fh,"CODE",{});var xL=r(Af);N5=n(xL,"python -m torch.distributed.launch"),xL.forEach(t),H5=n(fh," with "),Sf=l(fh,"CODE",{});var RL=r(Sf);B5=n(RL,"deepspeed"),RL.forEach(t),W5=n(fh,"."),fh.forEach(t),F5=c(jE),De=l(jE,"LI",{});var Mn=r(De);V5=n(Mn,"add a new argument "),Cf=l(Mn,"CODE",{});var IL=r(Cf);Y5=n(IL,"--deepspeed ds_config.json"),IL.forEach(t),K5=n(Mn,", where "),xf=l(Mn,"CODE",{});var UL=r(xf);J5=n(UL,"ds_config.json"),UL.forEach(t),X5=n(Mn,` is the DeepSpeed configuration file as
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var GL=r(qo);Q5=n(GL,"here"),GL.forEach(t),e$=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var LL=r(pi);s$=n(LL,"Therefore, if your original command line looked as follows:"),LL.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ML=r(ii);t$=n(ML,"Now it should be:"),ML.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var we=r(U);a$=n(we,"Unlike, "),Rf=l(we,"CODE",{});var ZL=r(Rf);n$=n(ZL,"torch.distributed.launch"),ZL.forEach(t),o$=n(we," where you have to specify how many GPUs to use with "),If=l(we,"CODE",{});var NL=r(If);l$=n(NL,"--nproc_per_node"),NL.forEach(t),r$=n(we,`, with the
`),Uf=l(we,"CODE",{});var HL=r(Uf);p$=n(HL,"deepspeed"),HL.forEach(t),i$=n(we," launcher you don\u2019t have to use the corresponding "),Gf=l(we,"CODE",{});var BL=r(Gf);u$=n(BL,"--num_gpus"),BL.forEach(t),c$=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=l(we,"A",{href:!0,rel:!0});var WL=r(Po);h$=n(WL,"here"),WL.forEach(t),f$=n(we,"."),we.forEach(t),Ng=c(e),ne=l(e,"P",{});var Zn=r(ne);d$=n(Zn,"In fact, you can continue using "),Lf=l(Zn,"CODE",{});var FL=r(Lf);m$=n(FL,"-m torch.distributed.launch"),FL.forEach(t),_$=n(Zn,` with DeepSpeed as long as you don\u2019t need to use
`),Mf=l(Zn,"CODE",{});var VL=r(Mf);v$=n(VL,"deepspeed"),VL.forEach(t),j$=n(Zn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Zf=l(Zn,"CODE",{});var YL=r(Zf);g$=n(YL,"deepspeed"),YL.forEach(t),w$=n(Zn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Zn.forEach(t),Hg=c(e),Rt=l(e,"P",{});var gE=r(Rt);y$=n(gE,"Here is an example of running "),Nf=l(gE,"CODE",{});var KL=r(Nf);b$=n(KL,"run_translation.py"),KL.forEach(t),E$=n(gE," under DeepSpeed deploying all available GPUs:"),gE.forEach(t),Bg=c(e),d(Do.$$.fragment,e),Wg=c(e),It=l(e,"P",{});var wE=r(It);q$=n(wE,"Note that in the DeepSpeed documentation you are likely to see "),Hf=l(wE,"CODE",{});var JL=r(Hf);$$=n(JL,"--deepspeed --deepspeed_config ds_config.json"),JL.forEach(t),k$=n(wE,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),wE.forEach(t),Fg=c(e),Ut=l(e,"P",{});var yE=r(Ut);P$=n(yE,"For some practical usage examples, please, see this "),zo=l(yE,"A",{href:!0,rel:!0});var XL=r(zo);D$=n(XL,"post"),XL.forEach(t),z$=n(yE,"."),yE.forEach(t),Vg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Yg=c(e),zs=l(e,"H3",{class:!0});var bE=r(zs);Gt=l(bE,"A",{id:!0,class:!0,href:!0});var QL=r(Gt);Bf=l(QL,"SPAN",{});var eM=r(Bf);d(Oo.$$.fragment,eM),eM.forEach(t),QL.forEach(t),O$=c(bE),Wf=l(bE,"SPAN",{});var sM=r(Wf);T$=n(sM,"Deployment with one GPU"),sM.forEach(t),bE.forEach(t),Kg=c(e),Lt=l(e,"P",{});var EE=r(Lt);A$=n(EE,"To deploy DeepSpeed with one GPU adjust the "),ci=l(EE,"A",{href:!0});var tM=r(ci);S$=n(tM,"Trainer"),tM.forEach(t),C$=n(EE," command line arguments as follows:"),EE.forEach(t),Jg=c(e),d(To.$$.fragment,e),Xg=c(e),Ge=l(e,"P",{});var dh=r(Ge);x$=n(dh,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Ff=l(dh,"CODE",{});var aM=r(Ff);R$=n(aM,"--num_gpus=1"),aM.forEach(t),I$=n(dh,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=l(dh,"A",{href:!0,rel:!0});var nM=r(Ao);U$=n(nM,"documentation"),nM.forEach(t),G$=n(dh," discusses the launcher options."),dh.forEach(t),Qg=c(e),hi=l(e,"P",{});var oM=r(hi);L$=n(oM,"Why would you want to use DeepSpeed with just one GPU?"),oM.forEach(t),ew=c(e),Mt=l(e,"OL",{});var qE=r(Mt);Vf=l(qE,"LI",{});var lM=r(Vf);M$=n(lM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),lM.forEach(t),Z$=c(qE),Yf=l(qE,"LI",{});var rM=r(Yf);N$=n(rM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),rM.forEach(t),qE.forEach(t),sw=c(e),fi=l(e,"P",{});var pM=r(fi);H$=n(pM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),pM.forEach(t),tw=c(e),d(So.$$.fragment,e),aw=c(e),di=l(e,"P",{});var iM=r(di);B$=n(iM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),iM.forEach(t),nw=c(e),Zt=l(e,"P",{});var $E=r(Zt);W$=n($E,"For a practical usage example of this type of deployment, please, see this "),Co=l($E,"A",{href:!0,rel:!0});var uM=r(Co);F$=n(uM,"post"),uM.forEach(t),V$=n($E,"."),$E.forEach(t),ow=c(e),mi=l(e,"P",{});var cM=r(mi);Y$=n(cM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),cM.forEach(t),lw=c(e),_i=l(e,"P",{});var hM=r(_i);K$=n(hM,"Notes:"),hM.forEach(t),rw=c(e),vi=l(e,"UL",{});var fM=r(vi);Os=l(fM,"LI",{});var mh=r(Os);xo=l(mh,"P",{});var kE=r(xo);J$=n(kE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=l(kE,"CODE",{});var dM=r(Kf);X$=n(dM,"CUDA_VISIBLE_DEVICES"),dM.forEach(t),Q$=n(kE,` to limit
...
`),fv=l(W,"CODE",{});var FF=r(fv);GC=n(FF,"from_pretrained"),FF.forEach(t),LC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),T3=c(e),d(zr.$$.fragment,e),A3=c(e),hn=l(e,"P",{});var o4=r(hn);MC=n(o4,"If you\u2019re using the official example scripts and your command line arguments include "),dv=l(o4,"CODE",{});var VF=r(dv);ZC=n(VF,"--deepspeed ds_config.json"),VF.forEach(t),NC=n(o4,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),o4.forEach(t),S3=c(e),dc=l(e,"P",{});var YF=r(dc);HC=n(YF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),YF.forEach(t),C3=c(e),fn=l(e,"P",{});var l4=r(fn);BC=n(l4,"For full details on this method and other related features please refer to "),Or=l(l4,"A",{href:!0,rel:!0});var KF=r(Or);WC=n(KF,"Constructing Massive Models"),KF.forEach(t),FC=n(l4,"."),l4.forEach(t),x3=c(e),fe=l(e,"P",{});var Jn=r(fe);VC=n(Jn,"Also when loading fp16-pretrained models, you will want to tell "),mv=l(Jn,"CODE",{});var JF=r(mv);YC=n(JF,"from_pretrained"),JF.forEach(t),KC=n(Jn,` to use
`),_v=l(Jn,"CODE",{});var XF=r(_v);JC=n(XF,"torch_dtype=torch.float16"),XF.forEach(t),XC=n(Jn,". For details, please, see "),mc=l(Jn,"A",{href:!0});var QF=r(mc);QC=n(QF,"from_pretrained-torch-dtype"),QF.forEach(t),ex=n(Jn,"."),Jn.forEach(t),R3=c(e),nt=l(e,"H4",{class:!0});var r4=r(nt);dn=l(r4,"A",{id:!0,class:!0,href:!0});var eV=r(dn);vv=l(eV,"SPAN",{});var sV=r(vv);d(Tr.$$.fragment,sV),sV.forEach(t),eV.forEach(t),sx=c(r4),jv=l(r4,"SPAN",{});var tV=r(jv);tx=n(tV,"Gathering Parameters"),tV.forEach(t),r4.forEach(t),I3=c(e),Ar=l(e,"P",{});var bG=r(Ar);ax=n(bG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=l(bG,"A",{href:!0,rel:!0});var aV=r(Sr);nx=n(aV,"Gathering Parameters"),aV.forEach(t),bG.forEach(t),U3=c(e),mn=l(e,"P",{});var p4=r(mn);ox=n(p4,`We do however use it internally in several places, one such example is when loading pretrained model weights in
`),gv=l(p4,"CODE",{});var nV=r(gv);lx=n(nV,"from_pretrained"),nV.forEach(t),rx=n(p4,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
...
dump the `),Cc=l(Xn,"A",{href:!0});var UV=r(Cc);Yx=n(UV,"TrainingArguments"),UV.forEach(t),Kx=n(Xn," as it has dozens of entries that are irrelevant."),Xn.forEach(t),xV.forEach(t),Jx=c($e),Nr=l($e,"LI",{});var m4=r(Nr);Av=l(m4,"P",{});var GV=r(Av);Xx=n(GV,"Output of:"),GV.forEach(t),Qx=c(m4),d(Hr.$$.fragment,m4),m4.forEach(t),eR=c($e),Sv=l($e,"LI",{});var LV=r(Sv);Br=l(LV,"P",{});var _4=r(Br);sR=n(_4,`If possible include a link to a Google Colab notebook that we can reproduce the problem with. You can use this
`),Wr=l(_4,"A",{href:!0,rel:!0});var MV=r(Wr);tR=n(MV,"notebook"),MV.forEach(t),aR=n(_4,` as
a starting point.`),_4.forEach(t),LV.forEach(t),nR=c($e),Cv=l($e,"LI",{});var ZV=r(Cv);xv=l(ZV,"P",{});var NV=r(xv);oR=n(NV,"Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),NV.forEach(t),ZV.forEach(t),lR=c($e),Rv=l($e,"LI",{});var HV=r(Rv);Fr=l(HV,"P",{});var v4=r(Fr);rR=n(v4,"If possible try to use one of the existing "),Vr=l(v4,"A",{href:!0,rel:!0});var BV=r(Vr);pR=n(BV,"examples"),BV.forEach(t),iR=n(v4," to reproduce the problem with."),v4.forEach(t),HV.forEach(t),$e.forEach(t),f0=c(e),xc=l(e,"P",{});var WV=r(xc);uR=n(WV,"Things to consider:"),WV.forEach(t),d0=c(e),bn=l(e,"UL",{});var j4=r(bn);pt=l(j4,"LI",{});var Hh=r(pt);Iv=l(Hh,"P",{});var FV=r(Iv);cR=n(FV,"Deepspeed is often not the cause of the problem."),FV.forEach(t),hR=c(Hh),Uv=l(Hh,"P",{});var VV=r(Uv);fR=n(VV,`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
exception and you can see that DeepSpeed modules are involved, first re-test your setup without DeepSpeed in it.
And only if the problem persists then do mentioned Deepspeed and supply all the required details.`),YV.forEach(t),Hh.forEach(t),_R=c(j4),Lv=l(j4,"LI",{});var KV=r(Lv);Yr=l(KV,"P",{});var g4=r(Yr);vR=n(g4,`If it\u2019s clear to you that the issue is in the DeepSpeed core and not the integration part, please file the Issue
directly with `),Kr=l(g4,"A",{href:!0,rel:!0});var JV=r(Kr);jR=n(JV,"Deepspeed"),JV.forEach(t),gR=n(g4,`. If you aren\u2019t sure, please do not worry,
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),g4.forEach(t),KV.forEach(t),j4.forEach(t),m0=c(e),it=l(e,"H3",{class:!0});var w4=r(it);En=l(w4,"A",{id:!0,class:!0,href:!0});var XV=r(En);Mv=l(XV,"SPAN",{});var QV=r(Mv);d(Jr.$$.fragment,QV),QV.forEach(t),XV.forEach(t),wR=c(w4),Zv=l(w4,"SPAN",{});var eY=r(Zv);yR=n(eY,"Troubleshooting"),eY.forEach(t),w4.forEach(t),_0=c(e),ut=l(e,"H4",{class:!0});var y4=r(ut);qn=l(y4,"A",{id:!0,class:!0,href:!0});var sY=r(qn);Nv=l(sY,"SPAN",{});var tY=r(Nv);d(Xr.$$.fragment,tY),tY.forEach(t),sY.forEach(t),bR=c(y4),Qr=l(y4,"SPAN",{});var b4=r(Qr);ER=n(b4,"the "),Hv=l(b4,"CODE",{});var aY=r(Hv);qR=n(aY,"deepspeed"),aY.forEach(t),$R=n(b4," process gets killed at startup without a traceback"),b4.forEach(t),y4.forEach(t),v0=c(e),B=l(e,"P",{});var ke=r(B);kR=n(ke,"If the "),Bv=l(ke,"CODE",{});var nY=r(Bv);PR=n(nY,"deepspeed"),nY.forEach(t),DR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
