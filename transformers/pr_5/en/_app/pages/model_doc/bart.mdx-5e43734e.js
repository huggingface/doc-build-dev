...
elements depending on the configuration (<a
  href="/docs/transformers/pr_5/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ia=new H({}),da=new q({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_5/src/transformers/models/bart/modeling_bart.py#L1265",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_5/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_5/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ha=new q({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_5/src/transformers/models/bart/modeling_bart.py#L1304",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_5/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_5/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_5/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_5/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_5/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_5/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_5/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_5/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_5/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_5/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_5/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_5/src/transformers/models/bart/modeling_flax_bart.py#L1320",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_5/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_5/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_5/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_5/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_5/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_5/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_5/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_5/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_5/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xp.forEach(t),og=l(fe),Id=a(fe,"P",{});var JT=s(Id);ng=i(JT,"Finally, this model supports inherent JAX features such as:"),JT.forEach(t),ag=l(fe),pt=a(fe,"UL",{});var bn=s(pt);Od=a(bn,"LI",{});var XT=s(Od);es=a(XT,"A",{href:!0,rel:!0});var KT=s(es);sg=i(KT,"Just-In-Time (JIT) compilation"),KT.forEach(t),XT.forEach(t),rg=l(bn),Nd=a(bn,"LI",{});var ZT=s(Nd);ts=a(ZT,"A",{href:!0,rel:!0});var YT=s(ts);ig=i(YT,"Automatic Differentiation"),YT.forEach(t),ZT.forEach(t),dg=l(bn),Dd=a(bn,"LI",{});var ew=s(Dd);os=a(ew,"A",{href:!0,rel:!0});var tw=s(os);lg=i(tw,"Vectorization"),tw.forEach(t),ew.forEach(t),cg=l(bn),Ld=a(bn,"LI",{});var ow=s(Ld);ns=a(ow,"A",{href:!0,rel:!0});var nw=s(ns);pg=i(nw,"Parallelization"),nw.forEach(t),ow.forEach(t),bn.forEach(t),hg=l(fe),Ae=a(fe,"DIV",{class:!0});var It=s(Ae);f(as.$$.fragment,It),ug=l(It),bo=a(It,"P",{});var li=s(bo);mg=i(li,"The "),Gd=a(li,"CODE",{});var aw=s(Gd);fg=i(aw,"FlaxBartPreTrainedModel"),aw.forEach(t),_g=i(li,"forward method, overrides the "),Wd=a(li,"CODE",{});var sw=s(Wd);gg=i(sw,"__call__"),sw.forEach(t),kg=i(li," special method."),li.forEach(t),bg=l(It),f(an.$$.fragment,It),yg=l(It),Rd=a(It,"P",{});var rw=s(Rd);vg=i(rw,"Example:"),rw.forEach(t),Tg=l(It),f(ss.$$.fragment,It),It.forEach(t),wg=l(fe),yt=a(fe,"DIV",{class:!0});var ci=s(yt);f(rs.$$.fragment,ci),xg=l(ci),Ud=a(ci,"P",{});var iw=s(Ud);zg=i(iw,"Example:"),iw.forEach(t),Fg=l(ci),f(is.$$.fragment,ci),ci.forEach(t),Bg=l(fe),vt=a(fe,"DIV",{class:!0});var pi=s(vt);f(ds.$$.fragment,pi),qg=l(pi),Hd=a(pi,"P",{});var dw=s(Hd);$g=i(dw,"Example:"),dw.forEach(t),jg=l(pi),f(ls.$$.fragment,pi),pi.forEach(t),fe.forEach(t),$c=l(o),yo=a(o,"H2",{class:!0});var zp=s(yo);sn=a(zp,"A",{id:!0,class:!0,href:!0});var lw=s(sn);Qd=a(lw,"SPAN",{});var cw=s(Qd);f(cs.$$.fragment,cw),cw.forEach(t),lw.forEach(t),Mg=l(zp),Vd=a(zp,"SPAN",{});var pw=s(Vd);Pg=i(pw,"FlaxBartForConditionalGeneration"),pw.forEach(t),zp.forEach(t),jc=l(o),R=a(o,"DIV",{class:!0});var _e=s(R);f(ps.$$.fragment,_e),Eg=l(_e),hs=a(_e,"P",{});var Fp=s(hs);Cg=i(Fp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(Fp,"A",{href:!0});var hw=s(Gr);Ag=i(hw,"FlaxPreTrainedModel"),hw.forEach(t),Sg=i(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp.forEach(t),Ig=l(_e),us=a(_e,"P",{});var Bp=s(us);Og=i(Bp,`This model is also a Flax Linen
`),ms=a(Bp,"A",{href:!0,rel:!0});var uw=s(ms);Ng=i(uw,"flax.nn.Module"),uw.forEach(t),Dg=i(Bp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bp.forEach(t),Lg=l(_e),Jd=a(_e,"P",{});var mw=s(Jd);Gg=i(mw,"Finally, this model supports inherent JAX features such as:"),mw.forEach(t),Wg=l(_e),ht=a(_e,"UL",{});var yn=s(ht);Xd=a(yn,"LI",{});var fw=s(Xd);fs=a(fw,"A",{href:!0,rel:!0});var _w=s(fs);Rg=i(_w,"Just-In-Time (JIT) compilation"),_w.forEach(t),fw.forEach(t),Ug=l(yn),Kd=a(yn,"LI",{});var gw=s(Kd);_s=a(gw,"A",{href:!0,rel:!0});var kw=s(_s);Hg=i(kw,"Automatic Differentiation"),kw.forEach(t),gw.forEach(t),Qg=l(yn),Zd=a(yn,"LI",{});var bw=s(Zd);gs=a(bw,"A",{href:!0,rel:!0});var yw=s(gs);Vg=i(yw,"Vectorization"),yw.forEach(t),bw.forEach(t),Jg=l(yn),Yd=a(yn,"LI",{});var vw=s(Yd);ks=a(vw,"A",{href:!0,rel:!0});var Tw=s(ks);Xg=i(Tw,"Parallelization"),Tw.forEach(t),vw.forEach(t),yn.forEach(t),Kg=l(_e),te=a(_e,"DIV",{class:!0});var Ge=s(te);f(bs.$$.fragment,Ge),Zg=l(Ge),vo=a(Ge,"P",{});var hi=s(vo);Yg=i(hi,"The "),el=a(hi,"CODE",{});var ww=s(el);ek=i(ww,"FlaxBartPreTrainedModel"),ww.forEach(t),tk=i(hi,"forward method, overrides the "),tl=a(hi,"CODE",{});var xw=s(tl);ok=i(xw,"__call__"),xw.forEach(t),nk=i(hi," special method."),hi.forEach(t),ak=l(Ge),f(rn.$$.fragment,Ge),sk=l(Ge),ol=a(Ge,"P",{});var zw=s(ol);rk=i(zw,"Summarization example:"),zw.forEach(t),ik=l(Ge),f(ys.$$.fragment,Ge),dk=l(Ge),nl=a(Ge,"P",{});var Fw=s(nl);lk=i(Fw,"Mask filling example:"),Fw.forEach(t),ck=l(Ge),f(vs.$$.fragment,Ge),Ge.forEach(t),pk=l(_e),Tt=a(_e,"DIV",{class:!0});var ui=s(Tt);f(Ts.$$.fragment,ui),hk=l(ui),al=a(ui,"P",{});var Bw=s(al);uk=i(Bw,"Example:"),Bw.forEach(t),mk=l(ui),f(ws.$$.fragment,ui),ui.forEach(t),fk=l(_e),wt=a(_e,"DIV",{class:!0});var mi=s(wt);f(xs.$$.fragment,mi),_k=l(mi),sl=a(mi,"P",{});var qw=s(sl);gk=i(qw,"Example:"),qw.forEach(t),kk=l(mi),f(zs.$$.fragment,mi),mi.forEach(t),_e.forEach(t),Mc=l(o),To=a(o,"H2",{class:!0});var qp=s(To);dn=a(qp,"A",{id:!0,class:!0,href:!0});var $w=s(dn);rl=a($w,"SPAN",{});var jw=s(rl);f(Fs.$$.fragment,jw),jw.forEach(t),$w.forEach(t),bk=l(qp),il=a(qp,"SPAN",{});var Mw=s(il);yk=i(Mw,"FlaxBartForSequenceClassification"),Mw.forEach(t),qp.forEach(t),Pc=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(Bs.$$.fragment,oe),vk=l(oe),dl=a(oe,"P",{});var Pw=s(dl);Tk=i(Pw,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Mk=l(oe),ll=a(oe,"P",{});var Aw=s(ll);Pk=i(Aw,"Finally, this model supports inherent JAX features such as:"),Aw.forEach(t),Ek=l(oe),ut=a(oe,"UL",{});var vn=s(ut);cl=a(vn,"LI",{});var Sw=s(cl);Ms=a(Sw,"A",{href:!0,rel:!0});var Iw=s(Ms);Ck=i(Iw,"Just-In-Time (JIT) compilation"),Iw.forEach(t),Sw.forEach(t),Ak=l(vn),pl=a(vn,"LI",{});var Ow=s(pl);Ps=a(Ow,"A",{href:!0,rel:!0});var Nw=s(Ps);Sk=i(Nw,"Automatic Differentiation"),Nw.forEach(t),Ow.forEach(t),Ik=l(vn),hl=a(vn,"LI",{});var Dw=s(hl);Es=a(Dw,"A",{href:!0,rel:!0});var Lw=s(Es);Ok=i(Lw,"Vectorization"),Lw.forEach(t),Dw.forEach(t),Nk=l(vn),ul=a(vn,"LI",{});var Gw=s(ul);Cs=a(Gw,"A",{href:!0,rel:!0});var Ww=s(Cs);Dk=i(Ww,"Parallelization"),Ww.forEach(t),Gw.forEach(t),vn.forEach(t),Lk=l(oe),Se=a(oe,"DIV",{class:!0});var Ot=s(Se);f(As.$$.fragment,Ot),Gk=l(Ot),wo=a(Ot,"P",{});var fi=s(wo);Wk=i(fi,"The "),ml=a(fi,"CODE",{});var Rw=s(ml);Rk=i(Rw,"FlaxBartPreTrainedModel"),Rw.forEach(t),Uk=i(fi,"forward method, overrides the "),fl=a(fi,"CODE",{});var Uw=s(fl);Hk=i(Uw,"__call__"),Uw.forEach(t),Qk=i(fi," special method."),fi.forEach(t),Vk=l(Ot),f(ln.$$.fragment,Ot),Jk=l(Ot),_l=a(Ot,"P",{});var Hw=s(_l);Xk=i(Hw,"Example:"),Hw.forEach(t),Kk=l(Ot),f(Ss.$$.fragment,Ot),Ot.forEach(t),Zk=l(oe),xt=a(oe,"DIV",{class:!0});var _i=s(xt);f(Is.$$.fragment,_i),Yk=l(_i),gl=a(_i,"P",{});var Qw=s(gl);eb=i(Qw,"Example:"),Qw.forEach(t),tb=l(_i),f(Os.$$.fragment,_i),_i.forEach(t),ob=l(oe),zt=a(oe,"DIV",{class:!0});var gi=s(zt);f(Ns.$$.fragment,gi),nb=l(gi),kl=a(gi,"P",{});var Vw=s(kl);ab=i(Vw,"Example:"),Vw.forEach(t),sb=l(gi),f(Ds.$$.fragment,gi),gi.forEach(t),oe.forEach(t),Ec=l(o),xo=a(o,"H2",{class:!0});var Mp=s(xo);cn=a(Mp,"A",{id:!0,class:!0,href:!0});var Jw=s(cn);bl=a(Jw,"SPAN",{});var Xw=s(bl);f(Ls.$$.fragment,Xw),Xw.forEach(t),Jw.forEach(t),rb=l(Mp),yl=a(Mp,"SPAN",{});var Kw=s(yl);ib=i(Kw,"FlaxBartForQuestionAnswering"),Kw.forEach(t),Mp.forEach(t),Cc=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);f(Gs.$$.fragment,ne),db=l(ne),zo=a(ne,"P",{});var ki=s(zo);lb=i(ki,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),vl=a(ki,"CODE",{});var Zw=s(vl);cb=i(Zw,"span start logits"),Zw.forEach(t),pb=i(ki," and "),Tl=a(ki,"CODE",{});var Yw=s(Tl);hb=i(Yw,"span end logits"),Yw.forEach(t),ub=i(ki,")."),ki.forEach(t),mb=l(ne),Ws=a(ne,"P",{});var Pp=s(Ws);fb=i(Pp,"This model inherits from "),Rr=a(Pp,"A",{href:!0});var e1=s(Rr);_b=i(e1,"FlaxPreTrainedModel"),e1.forEach(t),gb=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
