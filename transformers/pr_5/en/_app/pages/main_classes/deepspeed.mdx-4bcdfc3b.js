...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_5/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_5/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_5/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_5/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_5/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
Memory Wall for Extreme Scale Deep Learning`),X$=a("."),Bj=u(),Ip=o("p"),Q$=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),Wj=u(),Up=o("p"),e5=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),Fj=u(),Et=o("p"),s5=a("\u{1F917} Transformers integrates "),no=o("a"),t5=a("DeepSpeed"),a5=a(" via 2 options:"),Vj=u(),qt=o("ol"),oo=o("li"),n5=a("Integration of the core DeepSpeed features via "),Gp=o("a"),o5=a("Trainer"),l5=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),r5=u(),Y=o("li"),p5=a("If you don\u2019t use "),Lp=o("a"),i5=a("Trainer"),u5=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),lf=o("code"),c5=a("from_pretrained"),h5=a(" and "),rf=o("code"),f5=a("from_config"),d5=a(` include integration of essential
parts of DeepSpeed like `),pf=o("code"),m5=a("zero.Init"),_5=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Mp=o("a"),v5=a("deepspeed-non-trainer-integration"),j5=a("."),Yj=u(),Zp=o("p"),g5=a("What is integrated:"),Kj=u(),Np=o("p"),w5=a("Training:"),Jj=u(),Hp=o("ol"),uf=o("li"),y5=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),Xj=u(),Bp=o("p"),b5=a("Inference:"),Qj=u(),Wp=o("ol"),lo=o("li"),E5=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Fp=o("a"),q5=a("deepspeed-zero-inference"),$5=a("."),eg=u(),Vp=o("p"),k5=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),sg=u(),Yp=o("a"),tg=u(),ks=o("h2"),$t=o("a"),cf=o("span"),f(ro.$$.fragment),P5=u(),hf=o("span"),D5=a("Trainer Deepspeed Integration"),ag=u(),Kp=o("a"),ng=u(),Ps=o("h3"),kt=o("a"),ff=o("span"),f(po.$$.fragment),z5=u(),df=o("span"),O5=a("Installation"),og=u(),Jp=o("p"),T5=a("Install the library via pypi:"),lg=u(),f(io.$$.fragment),rg=u(),Ce=o("p"),A5=a("or via "),mf=o("code"),S5=a("transformers"),C5=a("\u2019 "),_f=o("code"),x5=a("extras"),R5=a(":"),pg=u(),f(uo.$$.fragment),ig=u(),xe=o("p"),I5=a("or find more details on "),co=o("a"),U5=a("the DeepSpeed\u2019s GitHub page"),G5=a(` and
`),ho=o("a"),L5=a("advanced install"),M5=a("."),ug=u(),Pt=o("p"),Z5=a("If you\u2019re still struggling with the build, first make sure to read "),Xp=o("a"),N5=a("zero-install-notes"),H5=a("."),cg=u(),Qp=o("p"),B5=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),hg=u(),ei=o("p"),W5=a("To make a local build for DeepSpeed:"),fg=u(),f(fo.$$.fragment),dg=u(),Re=o("p"),F5=a("If you intend to use NVMe offload you will also need to include "),vf=o("code"),V5=a("DS_BUILD_AIO=1"),Y5=a(` in the instructions above (and also
install `),jf=o("em"),K5=a("libaio-dev"),J5=a(" system-wide)."),mg=u(),Dt=o("p"),X5=a("Edit "),gf=o("code"),Q5=a("TORCH_CUDA_ARCH_LIST"),e6=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
Memory Wall for Extreme Scale Deep Learning`),DG.forEach(t),X$=n(lh,"."),lh.forEach(t),Bj=c(e),Ip=l(e,"P",{});var zG=r(Ip);Q$=n(zG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),zG.forEach(t),Wj=c(e),Up=l(e,"P",{});var OG=r(Up);e5=n(OG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),OG.forEach(t),Fj=c(e),Et=l(e,"P",{});var sE=r(Et);s5=n(sE,"\u{1F917} Transformers integrates "),no=l(sE,"A",{href:!0,rel:!0});var TG=r(no);t5=n(TG,"DeepSpeed"),TG.forEach(t),a5=n(sE," via 2 options:"),sE.forEach(t),Vj=c(e),qt=l(e,"OL",{});var tE=r(qt);oo=l(tE,"LI",{});var aE=r(oo);n5=n(aE,"Integration of the core DeepSpeed features via "),Gp=l(aE,"A",{href:!0});var AG=r(Gp);o5=n(AG,"Trainer"),AG.forEach(t),l5=n(aE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),aE.forEach(t),r5=c(tE),Y=l(tE,"LI",{});var ge=r(Y);p5=n(ge,"If you don\u2019t use "),Lp=l(ge,"A",{href:!0});var SG=r(Lp);i5=n(SG,"Trainer"),SG.forEach(t),u5=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),lf=l(ge,"CODE",{});var CG=r(lf);c5=n(CG,"from_pretrained"),CG.forEach(t),h5=n(ge," and "),rf=l(ge,"CODE",{});var xG=r(rf);f5=n(xG,"from_config"),xG.forEach(t),d5=n(ge,` include integration of essential
parts of DeepSpeed like `),pf=l(ge,"CODE",{});var RG=r(pf);m5=n(RG,"zero.Init"),RG.forEach(t),_5=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Mp=l(ge,"A",{href:!0});var IG=r(Mp);v5=n(IG,"deepspeed-non-trainer-integration"),IG.forEach(t),j5=n(ge,"."),ge.forEach(t),tE.forEach(t),Yj=c(e),Zp=l(e,"P",{});var UG=r(Zp);g5=n(UG,"What is integrated:"),UG.forEach(t),Kj=c(e),Np=l(e,"P",{});var GG=r(Np);w5=n(GG,"Training:"),GG.forEach(t),Jj=c(e),Hp=l(e,"OL",{});var LG=r(Hp);uf=l(LG,"LI",{});var MG=r(uf);y5=n(MG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),MG.forEach(t),LG.forEach(t),Xj=c(e),Bp=l(e,"P",{});var ZG=r(Bp);b5=n(ZG,"Inference:"),ZG.forEach(t),Qj=c(e),Wp=l(e,"OL",{});var NG=r(Wp);lo=l(NG,"LI",{});var nE=r(lo);E5=n(nE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Fp=l(nE,"A",{href:!0});var HG=r(Fp);q5=n(HG,"deepspeed-zero-inference"),HG.forEach(t),$5=n(nE,"."),nE.forEach(t),NG.forEach(t),eg=c(e),Vp=l(e,"P",{});var BG=r(Vp);k5=n(BG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),BG.forEach(t),sg=c(e),Yp=l(e,"A",{id:!0}),r(Yp).forEach(t),tg=c(e),ks=l(e,"H2",{class:!0});var oE=r(ks);$t=l(oE,"A",{id:!0,class:!0,href:!0});var WG=r($t);cf=l(WG,"SPAN",{});var FG=r(cf);d(ro.$$.fragment,FG),FG.forEach(t),WG.forEach(t),P5=c(oE),hf=l(oE,"SPAN",{});var VG=r(hf);D5=n(VG,"Trainer Deepspeed Integration"),VG.forEach(t),oE.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),Ps=l(e,"H3",{class:!0});var lE=r(Ps);kt=l(lE,"A",{id:!0,class:!0,href:!0});var YG=r(kt);ff=l(YG,"SPAN",{});var KG=r(ff);d(po.$$.fragment,KG),KG.forEach(t),YG.forEach(t),z5=c(lE),df=l(lE,"SPAN",{});var JG=r(df);O5=n(JG,"Installation"),JG.forEach(t),lE.forEach(t),og=c(e),Jp=l(e,"P",{});var XG=r(Jp);T5=n(XG,"Install the library via pypi:"),XG.forEach(t),lg=c(e),d(io.$$.fragment,e),rg=c(e),Ce=l(e,"P",{});var rh=r(Ce);A5=n(rh,"or via "),mf=l(rh,"CODE",{});var QG=r(mf);S5=n(QG,"transformers"),QG.forEach(t),C5=n(rh,"\u2019 "),_f=l(rh,"CODE",{});var eL=r(_f);x5=n(eL,"extras"),eL.forEach(t),R5=n(rh,":"),rh.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),xe=l(e,"P",{});var ph=r(xe);I5=n(ph,"or find more details on "),co=l(ph,"A",{href:!0,rel:!0});var sL=r(co);U5=n(sL,"the DeepSpeed\u2019s GitHub page"),sL.forEach(t),G5=n(ph,` and
`),ho=l(ph,"A",{href:!0,rel:!0});var tL=r(ho);L5=n(tL,"advanced install"),tL.forEach(t),M5=n(ph,"."),ph.forEach(t),ug=c(e),Pt=l(e,"P",{});var rE=r(Pt);Z5=n(rE,"If you\u2019re still struggling with the build, first make sure to read "),Xp=l(rE,"A",{href:!0});var aL=r(Xp);N5=n(aL,"zero-install-notes"),aL.forEach(t),H5=n(rE,"."),rE.forEach(t),cg=c(e),Qp=l(e,"P",{});var nL=r(Qp);B5=n(nL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),nL.forEach(t),hg=c(e),ei=l(e,"P",{});var oL=r(ei);W5=n(oL,"To make a local build for DeepSpeed:"),oL.forEach(t),fg=c(e),d(fo.$$.fragment,e),dg=c(e),Re=l(e,"P",{});var ih=r(Re);F5=n(ih,"If you intend to use NVMe offload you will also need to include "),vf=l(ih,"CODE",{});var lL=r(vf);V5=n(lL,"DS_BUILD_AIO=1"),lL.forEach(t),Y5=n(ih,` in the instructions above (and also
install `),jf=l(ih,"EM",{});var rL=r(jf);K5=n(rL,"libaio-dev"),rL.forEach(t),J5=n(ih," system-wide)."),ih.forEach(t),mg=c(e),Dt=l(e,"P",{});var pE=r(Dt);X5=n(pE,"Edit "),gf=l(pE,"CODE",{});var pL=r(gf);Q5=n(pL,"TORCH_CUDA_ARCH_LIST"),pL.forEach(t),e6=n(pE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
