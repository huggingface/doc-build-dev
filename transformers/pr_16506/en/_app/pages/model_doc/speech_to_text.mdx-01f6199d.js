...
methods above for more information.`),this.h()},l(N){p=a(N,"P",{});var z=i(p);q=s(z,`This class method is simply calling the feature extractor
`),f=a(z,"A",{href:!0});var E=i(f);g=s(E,"from_pretrained()"),E.forEach(t),S=s(z,` and the tokenizer
`),_=a(z,"CODE",{});var I=i(_);w=s(I,"from_pretrained"),I.forEach(t),$=s(z,` methods. Please refer to the docstrings of the
methods above for more information.`),z.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/pr_16506/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(N,z){h(N,p,z),e(p,q),e(p,f),e(f,g),e(p,S),e(p,_),e(_,w),e(p,$)},d(N){N&&t(p)}}}function Th(V){let p,q,f,g,S,_,w,$;return{c(){p=r("p"),q=n("This class method is simply calling "),f=r("a"),g=n("save_pretrained()"),S=n(` and
`),_=r("code"),w=n("save_pretrained"),$=n(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(N){p=a(N,"P",{});var z=i(p);q=s(z,"This class method is simply calling "),f=a(z,"A",{href:!0});var E=i(f);g=s(E,"save_pretrained()"),E.forEach(t),S=s(z,` and
`),_=a(z,"CODE",{});var I=i(_);w=s(I,"save_pretrained"),I.forEach(t),$=s(z,`. Please refer to the docstrings of the methods
above for more information.`),z.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/pr_16506/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(N,z){h(N,p,z),e(p,q),e(p,f),e(f,g),e(p,S),e(p,_),e(_,w),e(p,$)},d(N){N&&t(p)}}}function vh(V){let p,q,f,g,S;return{c(){p=r("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),g=n("Module"),S=n(`
...
the latter silently ignores them.`)},l(_){p=a(_,"P",{});var w=i(p);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){h(_,p,w),e(p,q),e(p,f),e(f,g),e(p,S)},d(_){_&&t(p)}}}function xh(V){let p,q,f,g,S,_,w,$,N,z,E,I,H,ee,Fe,K,Ce,$e,M,B,te,ke,P,j,Pe,oe,ne,je,se,re,Me,O,Ee,L,Ne,ae,ie,Ae,de,J,De,Z,Y;return{c(){p=r("p"),q=n("TF 2.0 models accepts two formats as inputs:"),f=c(),g=r("ul"),S=r("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=r("li"),N=n("having all inputs as a list, tuple or dict in the first positional arguments."),z=c(),E=r("p"),I=n("This second option is useful when using "),H=r("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
...
`),Z=a(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(u,F){h(u,p,F),e(p,q),h(u,f,F),h(u,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,N),h(u,z,F),h(u,E,F),e(E,I),e(E,H),e(H,ee),e(E,Fe),e(E,K),e(K,Ce),e(E,$e),h(u,M,F),h(u,B,F),e(B,te),h(u,ke,F),h(u,P,F),e(P,j),e(j,Pe),e(j,oe),e(oe,ne),e(j,je),e(j,se),e(se,re),e(P,Me),e(P,O),e(O,Ee),e(O,L),e(L,Ne),e(O,ae),e(O,ie),e(ie,Ae),e(P,de),e(P,J),e(J,De),e(J,Z),e(Z,Y)},d(u){u&&t(p),u&&t(f),u&&t(g),u&&t(z),u&&t(E),u&&t(M),u&&t(B),u&&t(ke),u&&t(P)}}}function yh(V){let p,q,f,g,S;return{c(){p=r("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=a(_,"P",{});var w=i(p);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){h(_,p,w),e(p,q),e(p,f),e(f,g),e(p,S)},d(_){_&&t(p)}}}function kh(V){let p,q,f,g,S,_,w,$,N,z,E,I,H,ee,Fe,K,Ce,$e,M,B,te,ke,P,j,Pe,oe,ne,je,se,re,Me,O,Ee,L,Ne,ae,ie,Ae,de,J,De,Z,Y;return{c(){p=r("p"),q=n("TF 2.0 models accepts two formats as inputs:"),f=c(),g=r("ul"),S=r("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=r("li"),N=n("having all inputs as a list, tuple or dict in the first positional arguments."),z=c(),E=r("p"),I=n("This second option is useful when using "),H=r("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=r("code"),Ce=n("model(inputs)"),$e=n("."),M=c(),B=r("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ke=c(),P=r("ul"),j=r("li"),Pe=n("a single Tensor with "),oe=r("code"),ne=n("input_ids"),je=n(" only and nothing else: "),se=r("code"),re=n("model(input_ids)"),Me=c(),O=r("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r("code"),Ne=n("model([input_ids, attention_mask])"),ae=n(" or "),ie=r("code"),Ae=n("model([input_ids, attention_mask, token_type_ids])"),de=c(),J=r("li"),De=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){p=a(u,"P",{});var F=i(p);q=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),f=l(u),g=a(u,"UL",{});var X=i(g);S=a(X,"LI",{});var st=i(S);_=s(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(X),$=a(X,"LI",{});var Ie=i($);N=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),X.forEach(t),z=l(u),E=a(u,"P",{});var Q=i(E);I=s(Q,"This second option is useful when using "),H=a(Q,"CODE",{});var We=i(H);ee=s(We,"tf.keras.Model.fit"),We.forEach(t),Fe=s(Q,` method which currently requires having all the
...
first positional argument :`),rt.forEach(t),ke=l(u),P=a(u,"UL",{});var G=i(P);j=a(G,"LI",{});var ce=i(j);Pe=s(ce,"a single Tensor with "),oe=a(ce,"CODE",{});var at=i(oe);ne=s(at,"input_ids"),at.forEach(t),je=s(ce," only and nothing else: "),se=a(ce,"CODE",{});var Ve=i(se);re=s(Ve,"model(input_ids)"),Ve.forEach(t),ce.forEach(t),Me=l(G),O=a(G,"LI",{});var C=i(O);Ee=s(C,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a(C,"CODE",{});var it=i(L);Ne=s(it,"model([input_ids, attention_mask])"),it.forEach(t),ae=s(C," or "),ie=a(C,"CODE",{});var qe=i(ie);Ae=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),C.forEach(t),de=l(G),J=a(G,"LI",{});var Le=i(J);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(u,F){h(u,p,F),e(p,q),h(u,f,F),h(u,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,N),h(u,z,F),h(u,E,F),e(E,I),e(E,H),e(H,ee),e(E,Fe),e(E,K),e(K,Ce),e(E,$e),h(u,M,F),h(u,B,F),e(B,te),h(u,ke,F),h(u,P,F),e(P,j),e(j,Pe),e(j,oe),e(oe,ne),e(j,je),e(j,se),e(se,re),e(P,Me),e(P,O),e(O,Ee),e(O,L),e(L,Ne),e(O,ae),e(O,ie),e(ie,Ae),e(P,de),e(P,J),e(J,De),e(J,Z),e(Z,Y)},d(u){u&&t(p),u&&t(f),u&&t(g),u&&t(z),u&&t(E),u&&t(M),u&&t(B),u&&t(ke),u&&t(P)}}}function wh(V){let p,q,f,g,S;return{c(){p=r("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=a(_,"P",{});var w=i(p);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){h(_,p,w),e(p,q),e(p,f),e(f,g),e(p,S)},d(_){_&&t(p)}}}function Sh(V){let p,q,f,g,S,_,w,$,N,z,E,I,H,ee,Fe,K,Ce,$e,M,B,te,ke,P,j,Pe,oe,ne,je,se,re,Me,O,Ee,L,Ne,ae,ie,Ae,de,J,De,Z,Y,u,F,X,st,Ie,Q,We,_e,rt,G,ce,at,Ve,C,it,qe,Le,dt,pn,ta,oa,hn,na,sa,mn,ra,aa,Zs,U,ia,Yn,da,ca,Xn,la,pa,Qn,ha,ma,Zn,ua,fa,es,_a,ga,Xt,Ta,va,ts,ba,er,un,os,xa,tr,Qt,or,fn,Zt,ns,ya,ka,le,wa,ss,Sa,$a,rs,Ea,qa,as,za,Fa,is,Ca,Pa,ds,ja,Ma,nr,eo,sr,kt,Na,to,Aa,Da,rr,ct,wt,cs,oo,Ia,ls,La,ar,pe,no,Oa,lt,Ga,_n,Ua,Wa,so,Va,Ra,Ha,pt,Ka,gn,Ba,Ja,Tn,Ya,Xa,Qa,ps,Za,ei,ro,ir,ht,St,hs,ao,ti,ms,oi,dr,W,io,ni,us,si,ri,co,ai,vn,ii,di,ci,$t,lo,li,fs,pi,hi,Et,po,mi,ho,ui,_s,fi,_i,gi,Re,mo,Ti,bn,vi,xn,bi,xi,gs,yi,ki,yn,uo,cr,mt,qt,Ts,fo,wi,vs,Si,lr,he,_o,$i,bs,Ei,qi,go,zi,kn,Fi,Ci,Pi,xs,ji,Mi,zt,To,Ni,ys,Ai,pr,ut,Ft,ks,vo,Di,ws,Ii,hr,A,bo,Li,Ss,Oi,Gi,ge,wn,Ui,Wi,Sn,Vi,Ri,$n,Hi,Ki,xo,$s,Bi,Ji,Yi,En,Xi,Qi,Zi,Ct,yo,ed,Oe,td,ko,Es,od,nd,sd,qn,rd,ad,wo,qs,id,dd,cd,ld,He,So,pd,zs,hd,md,Pt,ud,Ke,$o,fd,Eo,_d,zn,gd,Td,vd,jt,bd,Mt,qo,xd,zo,yd,Fn,kd,wd,Sd,Nt,Fo,$d,Co,Ed,Cn,qd,zd,Fd,At,Po,Cd,Fs,Pd,mr,ft,Dt,Cs,jo,jd,Ps,Md,ur,we,Mo,Nd,No,Ad,Pn,Dd,Id,Ld,Ao,Od,Do,Gd,Ud,Wd,Te,Io,Vd,_t,Rd,jn,Hd,Kd,js,Bd,Jd,Yd,It,Xd,Ms,Qd,Zd,Lo,fr,gt,Lt,Ns,Oo,ec,As,tc,_r,Se,Go,oc,Uo,nc,Mn,sc,rc,ac,Wo,ic,Vo,dc,cc,lc,ve,Ro,pc,Tt,hc,Nn,mc,uc,Ds,fc,_c,gc,Ot,Tc,Is,vc,bc,Ho,gr,vt,Gt,Ls,Ko,xc,Os,yc,Tr,me,Bo,kc,Jo,wc,An,Sc,$c,Ec,Yo,qc,Xo,zc,Fc,Cc,Ut,Pc,be,Qo,jc,bt,Mc,Dn,Nc,Ac,Gs,Dc,Ic,Lc,Wt,Oc,Us,Gc,Uc,Zo,vr,xt,Vt,Ws,en,Wc,Vs,Vc,br,ue,tn,Rc,on,Hc,In,Kc,Bc,Jc,nn,Yc,sn,Xc,Qc,Zc,Rt,el,xe,rn,tl,yt,ol,Ln,nl,sl,Rs,rl,al,il,Ht,dl,Hs,cl,ll,an,xr;return _=new Ue({}),ee=new Ue({}),X=new Ue({}),Qt=new ln({props:{code:`import torch
...
only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16506/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1284",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16506/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
>transformers.modeling_outputs.Seq2SeqLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16506/src/transformers/models/speech_to_text/modeling_tf_speech_to_text.py#L1240",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16506/src/transformers/models/speech_to_text/modeling_tf_speech_to_text.py#L1333",returnDescription:`
<p>A <a
...
IDs?`),xi=c(),gs=r("p"),yi=n("Should be overridden in a subclass if the model has a special way of building those."),ki=c(),yn=r("div"),T(uo.$$.fragment),cr=c(),mt=r("h2"),qt=r("a"),Ts=r("span"),T(fo.$$.fragment),wi=c(),vs=r("span"),Si=n("Speech2TextFeatureExtractor"),lr=c(),he=r("div"),T(_o.$$.fragment),$i=c(),bs=r("p"),Ei=n("Constructs a Speech2Text feature extractor."),qi=c(),go=r("p"),zi=n("This feature extractor inherits from "),kn=r("a"),Fi=n("Speech2TextFeatureExtractor"),Ci=n(` which contains most of the main methods. Users
...
mean and variance normalization to the extracted features.`),Mi=c(),zt=r("div"),T(To.$$.fragment),Ni=c(),ys=r("p"),Ai=n("Main method to featurize and prepare for the model one or several sequence(s). sequences."),pr=c(),ut=r("h2"),Ft=r("a"),ks=r("span"),T(vo.$$.fragment),Di=c(),ws=r("span"),Ii=n("Speech2TextProcessor"),hr=c(),A=r("div"),T(bo.$$.fragment),Li=c(),Ss=r("p"),Oi=n(`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
information.`),ld=c(),He=r("div"),T(So.$$.fragment),pd=c(),zs=r("p"),hd=n("Instantiate a processor associated with a pretrained model."),md=c(),T(Pt.$$.fragment),ud=c(),Ke=r("div"),T($o.$$.fragment),fd=c(),Eo=r("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=r("a"),gd=n("from_pretrained()"),Td=n(" method."),vd=c(),T(jt.$$.fragment),bd=c(),Mt=r("div"),T(qo.$$.fragment),xd=c(),zo=r("p"),yd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r("a"),kd=n("batch_decode()"),wd=n(`. Please
refer to the docstring of this method for more information.`),Sd=c(),Nt=r("div"),T(Fo.$$.fragment),$d=c(),Co=r("p"),Ed=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Cn=r("a"),qd=n("decode()"),zd=n(`. Please refer
to the docstring of this method for more information.`),Fd=c(),At=r("div"),T(Po.$$.fragment),Cd=c(),Fs=r("p"),Pd=n(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
...
predicted token ids.`),Je.forEach(t),Zs=l(o),U=a(o,"P",{});var fe=i(U);ia=s(fe,"The feature extractor depends on "),Yn=a(fe,"CODE",{});var zl=i(Yn);da=s(zl,"torchaudio"),zl.forEach(t),ca=s(fe," and the tokenizer depends on "),Xn=a(fe,"CODE",{});var Fl=i(Xn);la=s(Fl,"sentencepiece"),Fl.forEach(t),pa=s(fe,` so be sure to
install those packages before running the examples. You could either install those as extra speech dependencies with
...
mean and variance normalization to the extracted features.`),fp.forEach(t),Mi=l(Xe),zt=a(Xe,"DIV",{class:!0});var Mr=i(zt);v(To.$$.fragment,Mr),Ni=l(Mr),ys=a(Mr,"P",{});var _p=i(ys);Ai=s(_p,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),_p.forEach(t),Mr.forEach(t),Xe.forEach(t),pr=l(o),ut=a(o,"H2",{class:!0});var Nr=i(ut);Ft=a(Nr,"A",{id:!0,class:!0,href:!0});var gp=i(Ft);ks=a(gp,"SPAN",{});var Tp=i(ks);v(vo.$$.fragment,Tp),Tp.forEach(t),gp.forEach(t),Di=l(Nr),ws=a(Nr,"SPAN",{});var vp=i(ws);Ii=s(vp,"Speech2TextProcessor"),vp.forEach(t),Nr.forEach(t),hr=l(o),A=a(o,"DIV",{class:!0});var R=i(A);v(bo.$$.fragment,R),Li=l(R),Ss=a(R,"P",{});var bp=i(Ss);Oi=s(bp,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
information.`),Kt.forEach(t),Ar.forEach(t),ld=l(R),He=a(R,"DIV",{class:!0});var Vn=i(He);v(So.$$.fragment,Vn),pd=l(Vn),zs=a(Vn,"P",{});var zp=i(zs);hd=s(zp,"Instantiate a processor associated with a pretrained model."),zp.forEach(t),md=l(Vn),v(Pt.$$.fragment,Vn),Vn.forEach(t),ud=l(R),Ke=a(R,"DIV",{class:!0});var Rn=i(Ke);v($o.$$.fragment,Rn),fd=l(Rn),Eo=a(Rn,"P",{});var Dr=i(Eo);_d=s(Dr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=a(Dr,"A",{href:!0});var Fp=i(zn);gd=s(Fp,"from_pretrained()"),Fp.forEach(t),Td=s(Dr," method."),Dr.forEach(t),vd=l(Rn),v(jt.$$.fragment,Rn),Rn.forEach(t),bd=l(R),Mt=a(R,"DIV",{class:!0});var Ir=i(Mt);v(qo.$$.fragment,Ir),xd=l(Ir),zo=a(Ir,"P",{});var Lr=i(zo);yd=s(Lr,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=a(Lr,"A",{href:!0});var Cp=i(Fn);kd=s(Cp,"batch_decode()"),Cp.forEach(t),wd=s(Lr,`. Please
refer to the docstring of this method for more information.`),Lr.forEach(t),Ir.forEach(t),Sd=l(R),Nt=a(R,"DIV",{class:!0});var Or=i(Nt);v(Fo.$$.fragment,Or),$d=l(Or),Co=a(Or,"P",{});var Gr=i(Co);Ed=s(Gr,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Cn=a(Gr,"A",{href:!0});var Pp=i(Cn);qd=s(Pp,"decode()"),Pp.forEach(t),zd=s(Gr,`. Please refer
to the docstring of this method for more information.`),Gr.forEach(t),Or.forEach(t),Fd=l(R),At=a(R,"DIV",{class:!0});var Ur=i(At);v(Po.$$.fragment,Ur),Cd=l(Ur),Fs=a(Ur,"P",{});var jp=i(Fs);Pd=s(jp,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
