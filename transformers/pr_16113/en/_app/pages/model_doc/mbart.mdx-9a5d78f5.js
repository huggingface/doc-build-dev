...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16113/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16113/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jb=d(),L=n("div"),u(ys.$$.fragment),Eb=d(),bo=n("p"),Pb=r("The "),zi=n("a"),Cb=r("MBartForSequenceClassification"),Sb=r(" forward method, overrides the "),Kl=n("code"),Ab=r("__call__"),Ob=r(" special method."),Ib=d(),u(rn.$$.fragment),Nb=d(),Zl=n("p"),Db=r("Example of single-label classification:"),Lb=d(),u(vs.$$.fragment),Gb=d(),u(Ts.$$.fragment),Wb=d(),Yl=n("p"),Rb=r("Example of multi-label classification:"),Ub=d(),u(Ms.$$.fragment),Xb=d(),u(ws.$$.fragment),Yp=d(),yo=n("h2"),dn=n("a"),ec=n("span"),u(xs.$$.fragment),Hb=d(),tc=n("span"),Vb=r("MBartForCausalLM"),eh=d(),vo=n("div"),u(zs.$$.fragment),Qb=d(),Mt=n("div"),u(qs.$$.fragment),Jb=d(),oc=n("p"),Kb=r("Example:"),Zb=d(),u(Bs.$$.fragment),th=d(),To=n("h2"),ln=n("a"),nc=n("span"),u($s.$$.fragment),Yb=d(),ac=n("span"),e1=r("TFMBartModel"),oh=d(),je=n("div"),u(Fs.$$.fragment),t1=d(),js=n("p"),o1=r(`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=n("a"),n1=r("TFPreTrainedModel"),a1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),s1=d(),Es=n("p"),r1=r("This model is also a "),Ps=n("a"),i1=r("tf.keras.Model"),d1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),l1=d(),u(cn.$$.fragment),c1=d(),Ie=n("div"),u(Cs.$$.fragment),p1=d(),Mo=n("p"),h1=r("The "),Bi=n("a"),u1=r("TFMBartModel"),m1=r(" forward method, overrides the "),sc=n("code"),f1=r("__call__"),_1=r(" special method."),g1=d(),u(pn.$$.fragment),k1=d(),rc=n("p"),b1=r("Example:"),y1=d(),u(Ss.$$.fragment),nh=d(),wo=n("h2"),hn=n("a"),ic=n("span"),u(As.$$.fragment),v1=d(),dc=n("span"),T1=r("TFMBartForConditionalGeneration"),ah=d(),Ee=n("div"),u(Os.$$.fragment),M1=d(),Is=n("p"),w1=r(`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),$i=n("a"),x1=r("TFPreTrainedModel"),z1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),q1=d(),Ns=n("p"),B1=r("This model is also a "),Ds=n("a"),$1=r("tf.keras.Model"),F1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j1=d(),u(un.$$.fragment),E1=d(),ee=n("div"),u(Ls.$$.fragment),P1=d(),xo=n("p"),C1=r("The "),Fi=n("a"),S1=r("TFMBartForConditionalGeneration"),A1=r(" forward method, overrides the "),lc=n("code"),O1=r("__call__"),I1=r(" special method."),N1=d(),u(mn.$$.fragment),D1=d(),cc=n("p"),L1=r("Summarization example:"),G1=d(),u(Gs.$$.fragment),W1=d(),pc=n("p"),R1=r("Mask filling example:"),U1=d(),u(Ws.$$.fragment),sh=d(),zo=n("h2"),fn=n("a"),hc=n("span"),u(Rs.$$.fragment),X1=d(),uc=n("span"),H1=r("FlaxMBartModel"),rh=d(),R=n("div"),u(Us.$$.fragment),V1=d(),Xs=n("p"),Q1=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ji=n("a"),J1=r("FlaxPreTrainedModel"),K1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Z1=d(),Hs=n("p"),Y1=r(`This model is also a Flax Linen
`),Vs=n("a"),ey=r("flax.nn.Module"),ty=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),oy=d(),mc=n("p"),ny=r("Finally, this model supports inherent JAX features such as:"),ay=d(),ft=n("ul"),fc=n("li"),Qs=n("a"),sy=r("Just-In-Time (JIT) compilation"),ry=d(),_c=n("li"),Js=n("a"),iy=r("Automatic Differentiation"),dy=d(),gc=n("li"),Ks=n("a"),ly=r("Vectorization"),cy=d(),kc=n("li"),Zs=n("a"),py=r("Parallelization"),hy=d(),Ne=n("div"),u(Ys.$$.fragment),uy=d(),qo=n("p"),my=r("The "),bc=n("code"),fy=r("FlaxMBartPreTrainedModel"),_y=r("forward method, overrides the "),yc=n("code"),gy=r("__call__"),ky=r(" special method."),by=d(),u(_n.$$.fragment),yy=d(),vc=n("p"),vy=r("Example:"),Ty=d(),u(er.$$.fragment),My=d(),wt=n("div"),u(tr.$$.fragment),wy=d(),Tc=n("p"),xy=r("Example:"),zy=d(),u(or.$$.fragment),qy=d(),xt=n("div"),u(nr.$$.fragment),By=d(),Mc=n("p"),$y=r("Example:"),Fy=d(),u(ar.$$.fragment),ih=d(),Bo=n("h2"),gn=n("a"),wc=n("span"),u(sr.$$.fragment),jy=d(),xc=n("span"),Ey=r("FlaxMBartForConditionalGeneration"),dh=d(),U=n("div"),u(rr.$$.fragment),Py=d(),ir=n("p"),Cy=r(`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Ei=n("a"),Sy=r("FlaxPreTrainedModel"),Ay=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Oy=d(),dr=n("p"),Iy=r(`This model is also a Flax Linen
`),lr=n("a"),Ny=r("flax.nn.Module"),Dy=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ly=d(),zc=n("p"),Gy=r("Finally, this model supports inherent JAX features such as:"),Wy=d(),_t=n("ul"),qc=n("li"),cr=n("a"),Ry=r("Just-In-Time (JIT) compilation"),Uy=d(),Bc=n("li"),pr=n("a"),Xy=r("Automatic Differentiation"),Hy=d(),$c=n("li"),hr=n("a"),Vy=r("Vectorization"),Qy=d(),Fc=n("li"),ur=n("a"),Jy=r("Parallelization"),Ky=d(),te=n("div"),u(mr.$$.fragment),Zy=d(),$o=n("p"),Yy=r("The "),jc=n("code"),ev=r("FlaxMBartPreTrainedModel"),tv=r("forward method, overrides the "),Ec=n("code"),ov=r("__call__"),nv=r(" special method."),av=d(),u(kn.$$.fragment),sv=d(),Pc=n("p"),rv=r("Summarization example:"),iv=d(),u(fr.$$.fragment),dv=d(),Cc=n("p"),lv=r("Mask filling example:"),cv=d(),u(_r.$$.fragment),pv=d(),zt=n("div"),u(gr.$$.fragment),hv=d(),Sc=n("p"),uv=r("Example:"),mv=d(),u(kr.$$.fragment),fv=d(),qt=n("div"),u(br.$$.fragment),_v=d(),Ac=n("p"),gv=r("Example:"),kv=d(),u(yr.$$.fragment),lh=d(),Fo=n("h2"),bn=n("a"),Oc=n("span"),u(vr.$$.fragment),bv=d(),Ic=n("span"),yv=r("FlaxMBartForSequenceClassification"),ch=d(),O=n("div"),u(Tr.$$.fragment),vv=d(),Nc=n("p"),Tv=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Mv=d(),Mr=n("p"),wv=r("This model inherits from "),Pi=n("a"),xv=r("FlaxPreTrainedModel"),zv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qv=d(),wr=n("p"),Bv=r(`This model is also a Flax Linen
`),xr=n("a"),$v=r("flax.nn.Module"),Fv=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jv=d(),Dc=n("p"),Ev=r("Finally, this model supports inherent JAX features such as:"),Pv=d(),gt=n("ul"),Lc=n("li"),zr=n("a"),Cv=r("Just-In-Time (JIT) compilation"),Sv=d(),Gc=n("li"),qr=n("a"),Av=r("Automatic Differentiation"),Ov=d(),Wc=n("li"),Br=n("a"),Iv=r("Vectorization"),Nv=d(),Rc=n("li"),$r=n("a"),Dv=r("Parallelization"),Lv=d(),De=n("div"),u(Fr.$$.fragment),Gv=d(),jo=n("p"),Wv=r("The "),Uc=n("code"),Rv=r("FlaxMBartPreTrainedModel"),Uv=r("forward method, overrides the "),Xc=n("code"),Xv=r("__call__"),Hv=r(" special method."),Vv=d(),u(yn.$$.fragment),Qv=d(),Hc=n("p"),Jv=r("Example:"),Kv=d(),u(jr.$$.fragment),Zv=d(),Bt=n("div"),u(Er.$$.fragment),Yv=d(),Vc=n("p"),eT=r("Example:"),tT=d(),u(Pr.$$.fragment),oT=d(),$t=n("div"),u(Cr.$$.fragment),nT=d(),Qc=n("p"),aT=r("Example:"),sT=d(),u(Sr.$$.fragment),ph=d(),Eo=n("h2"),vn=n("a"),Jc=n("span"),u(Ar.$$.fragment),rT=d(),Kc=n("span"),iT=r("FlaxMBartForQuestionAnswering"),hh=d(),I=n("div"),u(Or.$$.fragment),dT=d(),Po=n("p"),lT=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mu.forEach(t),jb=l(It),L=a(It,"DIV",{class:!0});var oe=s(L);m(ys.$$.fragment,oe),Eb=l(oe),bo=a(oe,"P",{});var Xi=s(bo);Pb=i(Xi,"The "),zi=a(Xi,"A",{href:!0});var Gx=s(zi);Cb=i(Gx,"MBartForSequenceClassification"),Gx.forEach(t),Sb=i(Xi," forward method, overrides the "),Kl=a(Xi,"CODE",{});var Wx=s(Kl);Ab=i(Wx,"__call__"),Wx.forEach(t),Ob=i(Xi," special method."),Xi.forEach(t),Ib=l(oe),m(rn.$$.fragment,oe),Nb=l(oe),Zl=a(oe,"P",{});var Rx=s(Zl);Db=i(Rx,"Example of single-label classification:"),Rx.forEach(t),Lb=l(oe),m(vs.$$.fragment,oe),Gb=l(oe),m(Ts.$$.fragment,oe),Wb=l(oe),Yl=a(oe,"P",{});var Ux=s(Yl);Rb=i(Ux,"Example of multi-label classification:"),Ux.forEach(t),Ub=l(oe),m(Ms.$$.fragment,oe),Xb=l(oe),m(ws.$$.fragment,oe),oe.forEach(t),It.forEach(t),Yp=l(o),yo=a(o,"H2",{class:!0});var fu=s(yo);dn=a(fu,"A",{id:!0,class:!0,href:!0});var Xx=s(dn);ec=a(Xx,"SPAN",{});var Hx=s(ec);m(xs.$$.fragment,Hx),Hx.forEach(t),Xx.forEach(t),Hb=l(fu),tc=a(fu,"SPAN",{});var Vx=s(tc);Vb=i(Vx,"MBartForCausalLM"),Vx.forEach(t),fu.forEach(t),eh=l(o),vo=a(o,"DIV",{class:!0});var _u=s(vo);m(zs.$$.fragment,_u),Qb=l(_u),Mt=a(_u,"DIV",{class:!0});var Hi=s(Mt);m(qs.$$.fragment,Hi),Jb=l(Hi),oc=a(Hi,"P",{});var Qx=s(oc);Kb=i(Qx,"Example:"),Qx.forEach(t),Zb=l(Hi),m(Bs.$$.fragment,Hi),Hi.forEach(t),_u.forEach(t),th=l(o),To=a(o,"H2",{class:!0});var gu=s(To);ln=a(gu,"A",{id:!0,class:!0,href:!0});var Jx=s(ln);nc=a(Jx,"SPAN",{});var Kx=s(nc);m($s.$$.fragment,Kx),Kx.forEach(t),Jx.forEach(t),Yb=l(gu),ac=a(gu,"SPAN",{});var Zx=s(ac);e1=i(Zx,"TFMBartModel"),Zx.forEach(t),gu.forEach(t),oh=l(o),je=a(o,"DIV",{class:!0});var Nt=s(je);m(Fs.$$.fragment,Nt),t1=l(Nt),js=a(Nt,"P",{});var ku=s(js);o1=i(ku,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(ku,"A",{href:!0});var Yx=s(qi);n1=i(Yx,"TFPreTrainedModel"),Yx.forEach(t),a1=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),s1=l(Nt),Es=a(Nt,"P",{});var bu=s(Es);r1=i(bu,"This model is also a "),Ps=a(bu,"A",{href:!0,rel:!0});var ez=s(Ps);i1=i(ez,"tf.keras.Model"),ez.forEach(t),d1=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),l1=l(Nt),m(cn.$$.fragment,Nt),c1=l(Nt),Ie=a(Nt,"DIV",{class:!0});var Dt=s(Ie);m(Cs.$$.fragment,Dt),p1=l(Dt),Mo=a(Dt,"P",{});var Vi=s(Mo);h1=i(Vi,"The "),Bi=a(Vi,"A",{href:!0});var tz=s(Bi);u1=i(tz,"TFMBartModel"),tz.forEach(t),m1=i(Vi," forward method, overrides the "),sc=a(Vi,"CODE",{});var oz=s(sc);f1=i(oz,"__call__"),oz.forEach(t),_1=i(Vi," special method."),Vi.forEach(t),g1=l(Dt),m(pn.$$.fragment,Dt),k1=l(Dt),rc=a(Dt,"P",{});var nz=s(rc);b1=i(nz,"Example:"),nz.forEach(t),y1=l(Dt),m(Ss.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),nh=l(o),wo=a(o,"H2",{class:!0});var yu=s(wo);hn=a(yu,"A",{id:!0,class:!0,href:!0});var az=s(hn);ic=a(az,"SPAN",{});var sz=s(ic);m(As.$$.fragment,sz),sz.forEach(t),az.forEach(t),v1=l(yu),dc=a(yu,"SPAN",{});var rz=s(dc);T1=i(rz,"TFMBartForConditionalGeneration"),rz.forEach(t),yu.forEach(t),ah=l(o),Ee=a(o,"DIV",{class:!0});var Lt=s(Ee);m(Os.$$.fragment,Lt),M1=l(Lt),Is=a(Lt,"P",{});var vu=s(Is);w1=i(vu,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),$i=a(vu,"A",{href:!0});var iz=s($i);x1=i(iz,"TFPreTrainedModel"),iz.forEach(t),z1=i(vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vu.forEach(t),q1=l(Lt),Ns=a(Lt,"P",{});var Tu=s(Ns);B1=i(Tu,"This model is also a "),Ds=a(Tu,"A",{href:!0,rel:!0});var dz=s(Ds);$1=i(dz,"tf.keras.Model"),dz.forEach(t),F1=i(Tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tu.forEach(t),j1=l(Lt),m(un.$$.fragment,Lt),E1=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);m(Ls.$$.fragment,We),P1=l(We),xo=a(We,"P",{});var Qi=s(xo);C1=i(Qi,"The "),Fi=a(Qi,"A",{href:!0});var lz=s(Fi);S1=i(lz,"TFMBartForConditionalGeneration"),lz.forEach(t),A1=i(Qi," forward method, overrides the "),lc=a(Qi,"CODE",{});var cz=s(lc);O1=i(cz,"__call__"),cz.forEach(t),I1=i(Qi," special method."),Qi.forEach(t),N1=l(We),m(mn.$$.fragment,We),D1=l(We),cc=a(We,"P",{});var pz=s(cc);L1=i(pz,"Summarization example:"),pz.forEach(t),G1=l(We),m(Gs.$$.fragment,We),W1=l(We),pc=a(We,"P",{});var hz=s(pc);R1=i(hz,"Mask filling example:"),hz.forEach(t),U1=l(We),m(Ws.$$.fragment,We),We.forEach(t),Lt.forEach(t),sh=l(o),zo=a(o,"H2",{class:!0});var Mu=s(zo);fn=a(Mu,"A",{id:!0,class:!0,href:!0});var uz=s(fn);hc=a(uz,"SPAN",{});var mz=s(hc);m(Rs.$$.fragment,mz),mz.forEach(t),uz.forEach(t),X1=l(Mu),uc=a(Mu,"SPAN",{});var fz=s(uc);H1=i(fz,"FlaxMBartModel"),fz.forEach(t),Mu.forEach(t),rh=l(o),R=a(o,"DIV",{class:!0});var _e=s(R);m(Us.$$.fragment,_e),V1=l(_e),Xs=a(_e,"P",{});var wu=s(Xs);Q1=i(wu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ji=a(wu,"A",{href:!0});var _z=s(ji);J1=i(_z,"FlaxPreTrainedModel"),_z.forEach(t),K1=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),Z1=l(_e),Hs=a(_e,"P",{});var xu=s(Hs);Y1=i(xu,`This model is also a Flax Linen
`),Vs=a(xu,"A",{href:!0,rel:!0});var gz=s(Vs);ey=i(gz,"flax.nn.Module"),gz.forEach(t),ty=i(xu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),oy=l(_e),mc=a(_e,"P",{});var kz=s(mc);ny=i(kz,"Finally, this model supports inherent JAX features such as:"),kz.forEach(t),ay=l(_e),ft=a(_e,"UL",{});var Fn=s(ft);fc=a(Fn,"LI",{});var bz=s(fc);Qs=a(bz,"A",{href:!0,rel:!0});var yz=s(Qs);sy=i(yz,"Just-In-Time (JIT) compilation"),yz.forEach(t),bz.forEach(t),ry=l(Fn),_c=a(Fn,"LI",{});var vz=s(_c);Js=a(vz,"A",{href:!0,rel:!0});var Tz=s(Js);iy=i(Tz,"Automatic Differentiation"),Tz.forEach(t),vz.forEach(t),dy=l(Fn),gc=a(Fn,"LI",{});var Mz=s(gc);Ks=a(Mz,"A",{href:!0,rel:!0});var wz=s(Ks);ly=i(wz,"Vectorization"),wz.forEach(t),Mz.forEach(t),cy=l(Fn),kc=a(Fn,"LI",{});var xz=s(kc);Zs=a(xz,"A",{href:!0,rel:!0});var zz=s(Zs);py=i(zz,"Parallelization"),zz.forEach(t),xz.forEach(t),Fn.forEach(t),hy=l(_e),Ne=a(_e,"DIV",{class:!0});var Gt=s(Ne);m(Ys.$$.fragment,Gt),uy=l(Gt),qo=a(Gt,"P",{});var Ji=s(qo);my=i(Ji,"The "),bc=a(Ji,"CODE",{});var qz=s(bc);fy=i(qz,"FlaxMBartPreTrainedModel"),qz.forEach(t),_y=i(Ji,"forward method, overrides the "),yc=a(Ji,"CODE",{});var Bz=s(yc);gy=i(Bz,"__call__"),Bz.forEach(t),ky=i(Ji," special method."),Ji.forEach(t),by=l(Gt),m(_n.$$.fragment,Gt),yy=l(Gt),vc=a(Gt,"P",{});var $z=s(vc);vy=i($z,"Example:"),$z.forEach(t),Ty=l(Gt),m(er.$$.fragment,Gt),Gt.forEach(t),My=l(_e),wt=a(_e,"DIV",{class:!0});var Ki=s(wt);m(tr.$$.fragment,Ki),wy=l(Ki),Tc=a(Ki,"P",{});var Fz=s(Tc);xy=i(Fz,"Example:"),Fz.forEach(t),zy=l(Ki),m(or.$$.fragment,Ki),Ki.forEach(t),qy=l(_e),xt=a(_e,"DIV",{class:!0});var Zi=s(xt);m(nr.$$.fragment,Zi),By=l(Zi),Mc=a(Zi,"P",{});var jz=s(Mc);$y=i(jz,"Example:"),jz.forEach(t),Fy=l(Zi),m(ar.$$.fragment,Zi),Zi.forEach(t),_e.forEach(t),ih=l(o),Bo=a(o,"H2",{class:!0});var zu=s(Bo);gn=a(zu,"A",{id:!0,class:!0,href:!0});var Ez=s(gn);wc=a(Ez,"SPAN",{});var Pz=s(wc);m(sr.$$.fragment,Pz),Pz.forEach(t),Ez.forEach(t),jy=l(zu),xc=a(zu,"SPAN",{});var Cz=s(xc);Ey=i(Cz,"FlaxMBartForConditionalGeneration"),Cz.forEach(t),zu.forEach(t),dh=l(o),U=a(o,"DIV",{class:!0});var ge=s(U);m(rr.$$.fragment,ge),Py=l(ge),ir=a(ge,"P",{});var qu=s(ir);Cy=i(qu,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Ei=a(qu,"A",{href:!0});var Sz=s(Ei);Sy=i(Sz,"FlaxPreTrainedModel"),Sz.forEach(t),Ay=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),Oy=l(ge),dr=a(ge,"P",{});var Bu=s(dr);Iy=i(Bu,`This model is also a Flax Linen
`),lr=a(Bu,"A",{href:!0,rel:!0});var Az=s(lr);Ny=i(Az,"flax.nn.Module"),Az.forEach(t),Dy=i(Bu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),Ly=l(ge),zc=a(ge,"P",{});var Oz=s(zc);Gy=i(Oz,"Finally, this model supports inherent JAX features such as:"),Oz.forEach(t),Wy=l(ge),_t=a(ge,"UL",{});var jn=s(_t);qc=a(jn,"LI",{});var Iz=s(qc);cr=a(Iz,"A",{href:!0,rel:!0});var Nz=s(cr);Ry=i(Nz,"Just-In-Time (JIT) compilation"),Nz.forEach(t),Iz.forEach(t),Uy=l(jn),Bc=a(jn,"LI",{});var Dz=s(Bc);pr=a(Dz,"A",{href:!0,rel:!0});var Lz=s(pr);Xy=i(Lz,"Automatic Differentiation"),Lz.forEach(t),Dz.forEach(t),Hy=l(jn),$c=a(jn,"LI",{});var Gz=s($c);hr=a(Gz,"A",{href:!0,rel:!0});var Wz=s(hr);Vy=i(Wz,"Vectorization"),Wz.forEach(t),Gz.forEach(t),Qy=l(jn),Fc=a(jn,"LI",{});var Rz=s(Fc);ur=a(Rz,"A",{href:!0,rel:!0});var Uz=s(ur);Jy=i(Uz,"Parallelization"),Uz.forEach(t),Rz.forEach(t),jn.forEach(t),Ky=l(ge),te=a(ge,"DIV",{class:!0});var Re=s(te);m(mr.$$.fragment,Re),Zy=l(Re),$o=a(Re,"P",{});var Yi=s($o);Yy=i(Yi,"The "),jc=a(Yi,"CODE",{});var Xz=s(jc);ev=i(Xz,"FlaxMBartPreTrainedModel"),Xz.forEach(t),tv=i(Yi,"forward method, overrides the "),Ec=a(Yi,"CODE",{});var Hz=s(Ec);ov=i(Hz,"__call__"),Hz.forEach(t),nv=i(Yi," special method."),Yi.forEach(t),av=l(Re),m(kn.$$.fragment,Re),sv=l(Re),Pc=a(Re,"P",{});var Vz=s(Pc);rv=i(Vz,"Summarization example:"),Vz.forEach(t),iv=l(Re),m(fr.$$.fragment,Re),dv=l(Re),Cc=a(Re,"P",{});var Qz=s(Cc);lv=i(Qz,"Mask filling example:"),Qz.forEach(t),cv=l(Re),m(_r.$$.fragment,Re),Re.forEach(t),pv=l(ge),zt=a(ge,"DIV",{class:!0});var ed=s(zt);m(gr.$$.fragment,ed),hv=l(ed),Sc=a(ed,"P",{});var Jz=s(Sc);uv=i(Jz,"Example:"),Jz.forEach(t),mv=l(ed),m(kr.$$.fragment,ed),ed.forEach(t),fv=l(ge),qt=a(ge,"DIV",{class:!0});var td=s(qt);m(br.$$.fragment,td),_v=l(td),Ac=a(td,"P",{});var Kz=s(Ac);gv=i(Kz,"Example:"),Kz.forEach(t),kv=l(td),m(yr.$$.fragment,td),td.forEach(t),ge.forEach(t),lh=l(o),Fo=a(o,"H2",{class:!0});var $u=s(Fo);bn=a($u,"A",{id:!0,class:!0,href:!0});var Zz=s(bn);Oc=a(Zz,"SPAN",{});var Yz=s(Oc);m(vr.$$.fragment,Yz),Yz.forEach(t),Zz.forEach(t),bv=l($u),Ic=a($u,"SPAN",{});var e2=s(Ic);yv=i(e2,"FlaxMBartForSequenceClassification"),e2.forEach(t),$u.forEach(t),ch=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);m(Tr.$$.fragment,ne),vv=l(ne),Nc=a(ne,"P",{});var t2=s(Nc);Tv=i(t2,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),t2.forEach(t),Mv=l(ne),Mr=a(ne,"P",{});var Fu=s(Mr);wv=i(Fu,"This model inherits from "),Pi=a(Fu,"A",{href:!0});var o2=s(Pi);xv=i(o2,"FlaxPreTrainedModel"),o2.forEach(t),zv=i(Fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fu.forEach(t),qv=l(ne),wr=a(ne,"P",{});var ju=s(wr);Bv=i(ju,`This model is also a Flax Linen
`),xr=a(ju,"A",{href:!0,rel:!0});var n2=s(xr);$v=i(n2,"flax.nn.Module"),n2.forEach(t),Fv=i(ju,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ju.forEach(t),jv=l(ne),Dc=a(ne,"P",{});var a2=s(Dc);Ev=i(a2,"Finally, this model supports inherent JAX features such as:"),a2.forEach(t),Pv=l(ne),gt=a(ne,"UL",{});var En=s(gt);Lc=a(En,"LI",{});var s2=s(Lc);zr=a(s2,"A",{href:!0,rel:!0});var r2=s(zr);Cv=i(r2,"Just-In-Time (JIT) compilation"),r2.forEach(t),s2.forEach(t),Sv=l(En),Gc=a(En,"LI",{});var i2=s(Gc);qr=a(i2,"A",{href:!0,rel:!0});var d2=s(qr);Av=i(d2,"Automatic Differentiation"),d2.forEach(t),i2.forEach(t),Ov=l(En),Wc=a(En,"LI",{});var l2=s(Wc);Br=a(l2,"A",{href:!0,rel:!0});var c2=s(Br);Iv=i(c2,"Vectorization"),c2.forEach(t),l2.forEach(t),Nv=l(En),Rc=a(En,"LI",{});var p2=s(Rc);$r=a(p2,"A",{href:!0,rel:!0});var h2=s($r);Dv=i(h2,"Parallelization"),h2.forEach(t),p2.forEach(t),En.forEach(t),Lv=l(ne),De=a(ne,"DIV",{class:!0});var Wt=s(De);m(Fr.$$.fragment,Wt),Gv=l(Wt),jo=a(Wt,"P",{});var od=s(jo);Wv=i(od,"The "),Uc=a(od,"CODE",{});var u2=s(Uc);Rv=i(u2,"FlaxMBartPreTrainedModel"),u2.forEach(t),Uv=i(od,"forward method, overrides the "),Xc=a(od,"CODE",{});var m2=s(Xc);Xv=i(m2,"__call__"),m2.forEach(t),Hv=i(od," special method."),od.forEach(t),Vv=l(Wt),m(yn.$$.fragment,Wt),Qv=l(Wt),Hc=a(Wt,"P",{});var f2=s(Hc);Jv=i(f2,"Example:"),f2.forEach(t),Kv=l(Wt),m(jr.$$.fragment,Wt),Wt.forEach(t),Zv=l(ne),Bt=a(ne,"DIV",{class:!0});var nd=s(Bt);m(Er.$$.fragment,nd),Yv=l(nd),Vc=a(nd,"P",{});var _2=s(Vc);eT=i(_2,"Example:"),_2.forEach(t),tT=l(nd),m(Pr.$$.fragment,nd),nd.forEach(t),oT=l(ne),$t=a(ne,"DIV",{class:!0});var ad=s($t);m(Cr.$$.fragment,ad),nT=l(ad),Qc=a(ad,"P",{});var g2=s(Qc);aT=i(g2,"Example:"),g2.forEach(t),sT=l(ad),m(Sr.$$.fragment,ad),ad.forEach(t),ne.forEach(t),ph=l(o),Eo=a(o,"H2",{class:!0});var Eu=s(Eo);vn=a(Eu,"A",{id:!0,class:!0,href:!0});var k2=s(vn);Jc=a(k2,"SPAN",{});var b2=s(Jc);m(Ar.$$.fragment,b2),b2.forEach(t),k2.forEach(t),rT=l(Eu),Kc=a(Eu,"SPAN",{});var y2=s(Kc);iT=i(y2,"FlaxMBartForQuestionAnswering"),y2.forEach(t),Eu.forEach(t),hh=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);m(Or.$$.fragment,ae),dT=l(ae),Po=a(ae,"P",{});var sd=s(Po);lT=i(sd,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
