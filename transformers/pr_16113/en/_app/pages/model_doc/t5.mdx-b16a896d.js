...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16113/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Ws=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16113/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/t5/modeling_t5.py#L1808",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16113/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16113/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[ww]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_input_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"encoder_outputs",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/t5/modeling_tf_t5.py#L1311",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16113/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16113/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[zw]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/t5/modeling_tf_t5.py#L1617",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16113/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16113/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16113/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
behavior.`),BT=d(),f(Yn.$$.fragment),WT=d(),Ze=o("div"),f(ha.$$.fragment),RT=d(),_n=o("p"),HT=r("The "),Pr=o("a"),VT=r("TFT5Model"),KT=r(" forward method, overrides the "),cl=o("code"),YT=r("__call__"),ZT=r(" special method."),JT=d(),f(Zn.$$.fragment),XT=d(),pl=o("p"),QT=r("Examples:"),e1=d(),f(ua.$$.fragment),Cc=d(),gn=o("h2"),Jn=o("a"),hl=o("span"),f(ma.$$.fragment),t1=d(),ul=o("span"),n1=r("TFT5ForConditionalGeneration"),Nc=d(),le=o("div"),f(fa.$$.fragment),o1=d(),_a=o("p"),s1=r("T5 Model with a "),ml=o("code"),a1=r("language modeling"),r1=r(" head on top."),i1=d(),ga=o("p"),d1=r("The T5 model was proposed in "),Ta=o("a"),l1=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),c1=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),p1=d(),ka=o("p"),h1=r("This model inherits from "),Cr=o("a"),u1=r("TFPreTrainedModel"),m1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),f1=d(),va=o("p"),_1=r("This model is also a "),ba=o("a"),g1=r("tf.keras.Model"),T1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),k1=d(),f(Xn.$$.fragment),v1=d(),Je=o("div"),f(ya.$$.fragment),b1=d(),Tn=o("p"),y1=r("The "),Nr=o("a"),w1=r("TFT5ForConditionalGeneration"),x1=r(" forward method, overrides the "),fl=o("code"),z1=r("__call__"),$1=r(" special method."),q1=d(),f(Qn.$$.fragment),E1=d(),_l=o("p"),j1=r("Examples:"),F1=d(),f(wa.$$.fragment),Oc=d(),kn=o("h2"),eo=o("a"),gl=o("span"),f(xa.$$.fragment),M1=d(),Tl=o("span"),P1=r("TFT5EncoderModel"),Lc=d(),ce=o("div"),f(za.$$.fragment),C1=d(),kl=o("p"),N1=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),O1=d(),$a=o("p"),L1=r("The T5 model was proposed in "),qa=o("a"),A1=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),B1=d(),ja=o("p"),W1=r("This model is also a "),Fa=o("a"),R1=r("tf.keras.Model"),H1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),V1=d(),f(to.$$.fragment),K1=d(),Xe=o("div"),f(Ma.$$.fragment),Y1=d(),vn=o("p"),Z1=r("The "),Lr=o("a"),J1=r("TFT5EncoderModel"),X1=r(" forward method, overrides the "),vl=o("code"),Q1=r("__call__"),ek=r(" special method."),tk=d(),f(no.$$.fragment),nk=d(),bl=o("p"),ok=r("Examples:"),sk=d(),f(Pa.$$.fragment),Ac=d(),bn=o("h2"),oo=o("a"),yl=o("span"),f(Ca.$$.fragment),ak=d(),wl=o("span"),rk=r("FlaxT5Model"),Ic=d(),lt=o("div"),f(Na.$$.fragment),ik=d(),Qe=o("div"),f(Oa.$$.fragment),dk=d(),yn=o("p"),lk=r("The "),xl=o("code"),ck=r("FlaxT5PreTrainedModel"),pk=r("forward method, overrides the "),zl=o("code"),hk=r("__call__"),uk=r(" special method."),mk=d(),f(so.$$.fragment),fk=d(),$l=o("p"),_k=r("Example:"),gk=d(),f(La.$$.fragment),Tk=d(),Mt=o("div"),f(Aa.$$.fragment),kk=d(),ql=o("p"),vk=r("Example:"),bk=d(),f(Ia.$$.fragment),yk=d(),Pt=o("div"),f(Da.$$.fragment),wk=d(),El=o("p"),xk=r("Example:"),zk=d(),f(Sa.$$.fragment),Dc=d(),wn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),$k=d(),Fl=o("span"),qk=r("FlaxT5ForConditionalGeneration"),Sc=d(),ct=o("div"),f(Ua.$$.fragment),Ek=d(),et=o("div"),f(Ba.$$.fragment),jk=d(),xn=o("p"),Fk=r("The "),Ml=o("code"),Mk=r("FlaxT5PreTrainedModel"),Pk=r("forward method, overrides the "),Pl=o("code"),Ck=r("__call__"),Nk=r(" special method."),Ok=d(),f(ro.$$.fragment),Lk=d(),Cl=o("p"),Ak=r("Example:"),Ik=d(),f(Wa.$$.fragment),Dk=d(),Ct=o("div"),f(Ra.$$.fragment),Sk=d(),Nl=o("p"),Gk=r("Example:"),Uk=d(),f(Ha.$$.fragment),Bk=d(),Nt=o("div"),f(Va.$$.fragment),Wk=d(),Ol=o("p"),Rk=r("Example:"),Hk=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_w('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),$=l(n),b=s(n,"H1",{class:!0});var Ya=a(b);w=s(Ya,"A",{id:!0,class:!0,href:!0});var Ll=a(w);z=s(Ll,"SPAN",{});var Al=a(z);_(x.$$.fragment,Al),Al.forEach(t),Ll.forEach(t),y=l(Ya),q=s(Ya,"SPAN",{});var Il=a(q);qe=i(Il,"T5"),Il.forEach(t),Ya.forEach(t),oe=l(n),E=s(n,"H2",{class:!0});var Za=a(E);ee=s(Za,"A",{id:!0,class:!0,href:!0});var Dl=a(ee);S=s(Dl,"SPAN",{});var Sl=a(S);_(se.$$.fragment,Sl),Sl.forEach(t),Dl.forEach(t),Ee=l(Za),G=s(Za,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Za.forEach(t),ve=l(n),U=s(n,"P",{});var Ja=a(U);A=i(Ja,"The T5 model was presented in "),ae=s(Ja,"A",{href:!0,rel:!0});var Ul=a(ae);pe=i(Ul,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Ul.forEach(t),F=i(Ja,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),Ja.forEach(t),C=l(n),he=s(n,"P",{});var Bl=a(he);K=i(Bl,"The abstract from the paper is the following:"),Bl.forEach(t),be=l(n),ue=s(n,"P",{});var Xk=a(ue);B=s(Xk,"EM",{});var Qk=a(B);Fe=i(Qk,`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
task, has emerged as a powerful technique in natural language processing (NLP). The effectiveness of transfer learning
has given rise to a diversity of approaches, methodology, and practice. In this paper, we explore the landscape of
transfer learning techniques for NLP by introducing a unified framework that converts every language problem into a
text-to-text format. Our systematic study compares pretraining objectives, architectures, unlabeled datasets, transfer
...
with scale and our new \u201CColossal Clean Crawled Corpus\u201D, we achieve state-of-the-art results on many benchmarks covering
summarization, question answering, text classification, and more. To facilitate future work on transfer learning for
NLP, we release our dataset, pre-trained models, and code.`),Qk.forEach(t),Xk.forEach(t),ye=l(n),P=s(n,"P",{});var ev=a(P);Me=i(ev,"Tips:"),ev.forEach(t),H=l(n),V=s(n,"UL",{});var Ar=a(V);me=s(Ar,"LI",{});var tv=a(me);N=s(tv,"P",{});var Ir=a(N);Pe=i(Ir,`T5 is an encoder-decoder model pre-trained on a multi-task mixture of unsupervised and supervised tasks and for which
each task is converted into a text-to-text format. T5 works well on a variety of tasks out-of-the-box by prepending a
different prefix to the input corresponding to each task, e.g., for translation: `),fe=s(Ir,"EM",{});var nv=a(fe);I=i(nv,"translate English to German: \u2026"),nv.forEach(t),Ce=i(Ir,`,
for summarization: `),W=s(Ir,"EM",{});var ov=a(W);Ne=i(ov,"summarize: \u2026"),ov.forEach(t),m=i(Ir,"."),Ir.forEach(t),tv.forEach(t),j=l(Ar),te=s(Ar,"LI",{});var sv=a(te);Se=s(sv,"P",{});var av=a(Se);pt=i(av,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),av.forEach(t),sv.forEach(t),D=l(Ar),Ge=s(Ar,"LI",{});var rv=a(Ge);ne=s(rv,"P",{});var io=a(ne);ht=i(io,"See the "),O=s(io,"A",{href:!0});var iv=a(O);Y=i(iv,"training"),iv.forEach(t),ut=i(io,", "),Oe=s(io,"A",{href:!0});var dv=a(Oe);Z=i(dv,"inference"),dv.forEach(t),mt=i(io," and "),Le=s(io,"A",{href:!0});var lv=a(Le);Ae=i(lv,"scripts"),lv.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rv.forEach(t),Ar.forEach(t),Vl=l(n),Xa=s(n,"P",{});var cv=a(Xa);Dp=i(cv,"T5 comes in different sizes:"),cv.forEach(t),Kl=l(n),Ue=s(n,"UL",{});var Ot=a(Ue);di=s(Ot,"LI",{});var pv=a(di);li=s(pv,"P",{});var hv=a(li);To=s(hv,"A",{href:!0,rel:!0});var uv=a(To);Sp=i(uv,"t5-small"),uv.forEach(t),hv.forEach(t),pv.forEach(t),Gp=l(Ot),ci=s(Ot,"LI",{});var mv=a(ci);pi=s(mv,"P",{});var fv=a(pi);ko=s(fv,"A",{href:!0,rel:!0});var _v=a(ko);Up=i(_v,"t5-base"),_v.forEach(t),fv.forEach(t),mv.forEach(t),Bp=l(Ot),hi=s(Ot,"LI",{});var gv=a(hi);ui=s(gv,"P",{});var Tv=a(ui);vo=s(Tv,"A",{href:!0,rel:!0});var kv=a(vo);Wp=i(kv,"t5-large"),kv.forEach(t),Tv.forEach(t),gv.forEach(t),Rp=l(Ot),mi=s(Ot,"LI",{});var vv=a(mi);fi=s(vv,"P",{});var bv=a(fi);bo=s(bv,"A",{href:!0,rel:!0});var yv=a(bo);Hp=i(yv,"t5-3b"),yv.forEach(t),bv.forEach(t),vv.forEach(t),Vp=l(Ot),_i=s(Ot,"LI",{});var wv=a(_i);Qa=s(wv,"P",{});var Vk=a(Qa);yo=s(Vk,"A",{href:!0,rel:!0});var xv=a(yo);Kp=i(xv,"t5-11b"),xv.forEach(t),Yp=i(Vk,"."),Vk.forEach(t),wv.forEach(t),Ot.forEach(t),Yl=l(n),er=s(n,"P",{});var zv=a(er);Zp=i(zv,"Based on the original T5 model, Google has released some follow-up works:"),zv.forEach(t),Zl=l(n),$t=s(n,"UL",{});var Dr=a($t);gi=s(Dr,"LI",{});var $v=a(gi);zn=s($v,"P",{});var Wl=a(zn);Ti=s(Wl,"STRONG",{});var qv=a(Ti);Jp=i(qv,"T5v1.1"),qv.forEach(t),Xp=i(Wl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=s(Wl,"A",{href:!0});var Ev=a(tr);Qp=i(Ev,"here"),Ev.forEach(t),eh=i(Wl,"."),Wl.forEach(t),$v.forEach(t),th=l(Dr),ki=s(Dr,"LI",{});var jv=a(ki);$n=s(jv,"P",{});var Rl=a($n);vi=s(Rl,"STRONG",{});var Fv=a(vi);nh=i(Fv,"mT5"),Fv.forEach(t),oh=i(Rl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=s(Rl,"A",{href:!0});var Mv=a(nr);sh=i(Mv,"here"),Mv.forEach(t),ah=i(Rl,"."),Rl.forEach(t),jv.forEach(t),rh=l(Dr),bi=s(Dr,"LI",{});var Pv=a(bi);qn=s(Pv,"P",{});var Hl=a(qn);yi=s(Hl,"STRONG",{});var Cv=a(yi);ih=i(Cv,"byT5"),Cv.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Nv=a(or);lh=i(Nv,"here"),Nv.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Pv.forEach(t),Dr.forEach(t),Jl=l(n),En=s(n,"P",{});var Uc=a(En);ph=i(Uc,"All checkpoints can be found on the "),wo=s(Uc,"A",{href:!0,rel:!0});var Ov=a(wo);hh=i(Ov,"hub"),Ov.forEach(t),uh=i(Uc,"."),Uc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var Lv=a(xo);fh=i(Lv,"thomwolf"),Lv.forEach(t),_h=i(Sr,". The original code can be found "),zo=s(Sr,"A",{href:!0,rel:!0});var Av=a(zo);gh=i(Av,"here"),Av.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Bc=a(Zt);jn=s(Bc,"A",{id:!0,class:!0,href:!0});var Iv=a(jn);wi=s(Iv,"SPAN",{});var Dv=a(wi);_($o.$$.fragment,Dv),Dv.forEach(t),Iv.forEach(t),kh=l(Bc),xi=s(Bc,"SPAN",{});var Sv=a(xi);vh=i(Sv,"Training"),Sv.forEach(t),Bc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
sequence is then appended by the EOS token and corresponds to the `),qi=s(lo,"CODE",{});var Bv=a(qi);$h=i(Bv,"labels"),Bv.forEach(t),qh=i(lo,`. The PAD token is hereby used as the
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),lo.forEach(t),nc=l(n),Fn=s(n,"P",{});var Wc=a(Fn);Eh=i(Wc,"One can use "),ar=s(Wc,"A",{href:!0});var Wv=a(ar);jh=i(Wv,"T5ForConditionalGeneration"),Wv.forEach(t),Fh=i(Wc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Wc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var Lt=a(dt);Ei=s(Lt,"P",{});var Rv=a(Ei);Mh=i(Rv,"Unsupervised denoising training"),Rv.forEach(t),Ph=l(Lt),_e=s(Lt,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var Hv=a(ji);Nh=i(Hv,"a.k.a"),Hv.forEach(t),Oh=i(tt,` unique mask tokens) and
...
`),Pi=s(tt,"CODE",{});var Yv=a(Pi);Sh=i(Yv,"<extra_id_1>"),Yv.forEach(t),Gh=i(tt,", \u2026 up to "),Ci=s(tt,"CODE",{});var Zv=a(Ci);Uh=i(Zv,"<extra_id_99>"),Zv.forEach(t),Bh=i(tt,`. As a default, 100 sentinel tokens are available in
`),rr=s(tt,"A",{href:!0});var Jv=a(rr);Wh=i(Jv,"T5Tokenizer"),Jv.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(Lt),Ni=s(Lt,"P",{});var Xv=a(Ni);Vh=i(Xv,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qp.forEach(t),BT=l(at),_(Yn.$$.fragment,at),WT=l(at),Ze=s(at,"DIV",{class:!0});var Rt=a(Ze);_(ha.$$.fragment,Rt),RT=l(Rt),_n=s(Rt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Pr=s(Qr,"A",{href:!0});var E5=a(Pr);VT=i(E5,"TFT5Model"),E5.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var j5=a(cl);YT=i(j5,"__call__"),j5.forEach(t),ZT=i(Qr," special method."),Qr.forEach(t),JT=l(Rt),_(Zn.$$.fragment,Rt),XT=l(Rt),pl=s(Rt,"P",{});var F5=a(pl);QT=i(F5,"Examples:"),F5.forEach(t),e1=l(Rt),_(ua.$$.fragment,Rt),Rt.forEach(t),at.forEach(t),Cc=l(n),gn=s(n,"H2",{class:!0});var Ep=a(gn);Jn=s(Ep,"A",{id:!0,class:!0,href:!0});var M5=a(Jn);hl=s(M5,"SPAN",{});var P5=a(hl);_(ma.$$.fragment,P5),P5.forEach(t),M5.forEach(t),t1=l(Ep),ul=s(Ep,"SPAN",{});var C5=a(ul);n1=i(C5,"TFT5ForConditionalGeneration"),C5.forEach(t),Ep.forEach(t),Nc=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),o1=l(rt),_a=s(rt,"P",{});var jp=a(_a);s1=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var N5=a(ml);a1=i(N5,"language modeling"),N5.forEach(t),r1=i(jp," head on top."),jp.forEach(t),i1=l(rt),ga=s(rt,"P",{});var Fp=a(ga);d1=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var O5=a(Ta);l1=i(O5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),O5.forEach(t),c1=i(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Fp.forEach(t),p1=l(rt),ka=s(rt,"P",{});var Mp=a(ka);h1=i(Mp,"This model inherits from "),Cr=s(Mp,"A",{href:!0});var L5=a(Cr);u1=i(L5,"TFPreTrainedModel"),L5.forEach(t),m1=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp.forEach(t),f1=l(rt),va=s(rt,"P",{});var Pp=a(va);_1=i(Pp,"This model is also a "),ba=s(Pp,"A",{href:!0,rel:!0});var A5=a(ba);g1=i(A5,"tf.keras.Model"),A5.forEach(t),T1=i(Pp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),k1=l(rt),_(Xn.$$.fragment,rt),v1=l(rt),Je=s(rt,"DIV",{class:!0});var Ht=a(Je);_(ya.$$.fragment,Ht),b1=l(Ht),Tn=s(Ht,"P",{});var ei=a(Tn);y1=i(ei,"The "),Nr=s(ei,"A",{href:!0});var I5=a(Nr);w1=i(I5,"TFT5ForConditionalGeneration"),I5.forEach(t),x1=i(ei," forward method, overrides the "),fl=s(ei,"CODE",{});var D5=a(fl);z1=i(D5,"__call__"),D5.forEach(t),$1=i(ei," special method."),ei.forEach(t),q1=l(Ht),_(Qn.$$.fragment,Ht),E1=l(Ht),_l=s(Ht,"P",{});var S5=a(_l);j1=i(S5,"Examples:"),S5.forEach(t),F1=l(Ht),_(wa.$$.fragment,Ht),Ht.forEach(t),rt.forEach(t),Oc=l(n),kn=s(n,"H2",{class:!0});var Cp=a(kn);eo=s(Cp,"A",{id:!0,class:!0,href:!0});var G5=a(eo);gl=s(G5,"SPAN",{});var U5=a(gl);_(xa.$$.fragment,U5),U5.forEach(t),G5.forEach(t),M1=l(Cp),Tl=s(Cp,"SPAN",{});var B5=a(Tl);P1=i(B5,"TFT5EncoderModel"),B5.forEach(t),Cp.forEach(t),Lc=l(n),ce=s(n,"DIV",{class:!0});var it=a(ce);_(za.$$.fragment,it),C1=l(it),kl=s(it,"P",{});var W5=a(kl);N1=i(W5,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),W5.forEach(t),O1=l(it),$a=s(it,"P",{});var Np=a($a);L1=i(Np,"The T5 model was proposed in "),qa=s(Np,"A",{href:!0,rel:!0});var R5=a(qa);A1=i(R5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
