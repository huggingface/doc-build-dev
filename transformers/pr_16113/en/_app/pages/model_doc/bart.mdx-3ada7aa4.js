...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),Bs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16113/src/transformers/models/bart/modeling_flax_bart.py#L1319",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16113/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
object can be found in this `),Fn=a(fn,"A",{href:!0,rel:!0});var Xy=s(Fn);Jp=i(Xy,"forum discussion"),Xy.forEach(t),Xp=i(fn,"."),fn.forEach(t),Kp=l(Xr),jo=a(Xr,"LI",{});var nc=s(jo);Bn=a(nc,"A",{href:!0,rel:!0});var Ky=s(Bn);Zp=i(Ky,"Distilled checkpoints"),Ky.forEach(t),Yp=i(nc," are described in this "),qn=a(nc,"A",{href:!0,rel:!0});var Zy=s(qn);eh=i(Zy,"paper"),Zy.forEach(t),th=i(nc,"."),nc.forEach(t),Xr.forEach(t),sc=l(o),Ht=a(o,"H2",{class:!0});var Wc=s(Ht);Mo=a(Wc,"A",{id:!0,class:!0,href:!0});var Yy=s(Mo);Bi=a(Yy,"SPAN",{});var e1=s(Bi);f($n.$$.fragment,e1),e1.forEach(t),Yy.forEach(t),oh=l(Wc),qi=a(Wc,"SPAN",{});var t1=s(qi);nh=i(t1,"Implementation Notes"),t1.forEach(t),Wc.forEach(t),rc=l(o),Ee=a(o,"UL",{});var $t=s(Ee);pt=a($t,"LI",{});var _n=s(pt);ah=i(_n,"Bart doesn\u2019t use "),$i=a(_n,"CODE",{});var o1=s($i);sh=i(o1,"token_type_ids"),o1.forEach(t),rh=i(_n," for sequence classification. Use "),yr=a(_n,"A",{href:!0});var n1=s(yr);ih=i(n1,"BartTokenizer"),n1.forEach(t),dh=i(_n,` or
`),Tr=a(_n,"A",{href:!0});var a1=s(Tr);lh=i(a1,"encode()"),a1.forEach(t),ch=i(_n," to get the proper splitting."),_n.forEach(t),ph=l($t),Qt=a($t,"LI",{});var Kr=s(Qt);hh=i(Kr,"The forward pass of "),vr=a(Kr,"A",{href:!0});var s1=s(vr);uh=i(s1,"BartModel"),s1.forEach(t),mh=i(Kr," will create the "),ji=a(Kr,"CODE",{});var r1=s(ji);fh=i(r1,"decoder_input_ids"),r1.forEach(t),_h=i(Kr,` if they are not passed.
...
`),Mi=a(Zr,"CODE",{});var i1=s(Mi);bh=i(i1,"forced_bos_token_id=0"),i1.forEach(t),yh=i(Zr,`. This only works, however, if the string you pass to
`),Pi=a(Zr,"CODE",{});var d1=s(Pi);Th=i(d1,"fairseq.encode"),d1.forEach(t),vh=i(Zr," starts with a space."),Zr.forEach(t),wh=l($t),wr=a($t,"LI",{});var Oy=s(wr);xr=a(Oy,"A",{href:!0});var l1=s(xr);xh=i(l1,"generate()"),l1.forEach(t),zh=i(Oy,` should be used for conditional generation tasks like
summarization, see the example in that docstrings.`),Oy.forEach(t),Fh=l($t),Jt=a($t,"LI",{});var Yr=s(Jt);Bh=i(Yr,"Models that load the "),Ei=a(Yr,"EM",{});var c1=s(Ei);qh=i(c1,"facebook/bart-large-cnn"),c1.forEach(t),$h=i(Yr," weights will not have a "),Ci=a(Yr,"CODE",{});var p1=s(Ci);jh=i(p1,"mask_token_id"),p1.forEach(t),Mh=i(Yr,`, or be able to perform
mask-filling tasks.`),Yr.forEach(t),$t.forEach(t),ic=l(o),Xt=a(o,"H2",{class:!0});var Uc=s(Xt);Po=a(Uc,"A",{id:!0,class:!0,href:!0});var h1=s(Po);Ai=a(h1,"SPAN",{});var u1=s(Ai);f(jn.$$.fragment,u1),u1.forEach(t),h1.forEach(t),Ph=l(Uc),Oi=a(Uc,"SPAN",{});var m1=s(Oi);Eh=i(m1,"Mask Filling"),m1.forEach(t),Uc.forEach(t),dc=l(o),kt=a(o,"P",{});var ei=s(kt);Ch=i(ei,"The "),Si=a(ei,"CODE",{});var f1=s(Si);Ah=i(f1,"facebook/bart-base"),f1.forEach(t),Oh=i(ei," and "),Ii=a(ei,"CODE",{});var _1=s(Ii);Sh=i(_1,"facebook/bart-large"),_1.forEach(t),Ih=i(ei," checkpoints can be used to fill multi-token masks."),ei.forEach(t),lc=l(o),f(Mn.$$.fragment,o),cc=l(o),Kt=a(o,"H2",{class:!0});var Rc=s(Kt);Eo=a(Rc,"A",{id:!0,class:!0,href:!0});var g1=s(Eo);Ni=a(g1,"SPAN",{});var k1=s(Ni);f(Pn.$$.fragment,k1),k1.forEach(t),g1.forEach(t),Nh=l(Rc),Li=a(Rc,"SPAN",{});var b1=s(Li);Lh=i(b1,"BartConfig"),b1.forEach(t),Rc.forEach(t),pc=l(o),ze=a(o,"DIV",{class:!0});var jt=s(ze);f(En.$$.fragment,jt),Dh=l(jt),Zt=a(jt,"P",{});var ti=s(Zt);Gh=i(ti,"This is the configuration class to store the configuration of a "),zr=a(ti,"A",{href:!0});var y1=s(zr);Wh=i(y1,"BartModel"),y1.forEach(t),Uh=i(ti,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),Cn=a(ti,"A",{href:!0,rel:!0});var T1=s(Cn);Rh=i(T1,"facebook/bart-large"),T1.forEach(t),Hh=i(ti," architecture."),ti.forEach(t),Qh=l(jt),Yt=a(jt,"P",{});var oi=s(Yt);Vh=i(oi,"Configuration objects inherit from "),Fr=a(oi,"A",{href:!0});var v1=s(Fr);Jh=i(v1,"PretrainedConfig"),v1.forEach(t),Xh=i(oi,` and can be used to control the model outputs. Read the
documentation from `),Br=a(oi,"A",{href:!0});var w1=s(Br);Kh=i(w1,"PretrainedConfig"),w1.forEach(t),Zh=i(oi," for more information."),oi.forEach(t),Yh=l(jt),Di=a(jt,"P",{});var x1=s(Di);eu=i(x1,"Example:"),x1.forEach(t),tu=l(jt),f(An.$$.fragment,jt),jt.forEach(t),hc=l(o),eo=a(o,"H2",{class:!0});var Hc=s(eo);Co=a(Hc,"A",{id:!0,class:!0,href:!0});var z1=s(Co);Gi=a(z1,"SPAN",{});var F1=s(Gi);f(On.$$.fragment,F1),F1.forEach(t),z1.forEach(t),ou=l(Hc),Wi=a(Hc,"SPAN",{});var B1=s(Wi);nu=i(B1,"BartTokenizer"),B1.forEach(t),Hc.forEach(t),uc=l(o),E=a(o,"DIV",{class:!0});var G=s(E);f(Sn.$$.fragment,G),au=l(G),Ui=a(G,"P",{});var q1=s(Ui);su=i(q1,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),q1.forEach(t),ru=l(G),Ri=a(G,"P",{});var $1=s(Ri);iu=i($1,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),$1.forEach(t),du=l(G),f(In.$$.fragment,G),lu=l(G),Nn=a(G,"P",{});var Qc=s(Nn);cu=i(Qc,"You can get around that behavior by passing "),Hi=a(Qc,"CODE",{});var j1=s(Hi);pu=i(j1,"add_prefix_space=True"),j1.forEach(t),hu=i(Qc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Qc.forEach(t),uu=l(G),f(Ao.$$.fragment,G),mu=l(G),Ln=a(G,"P",{});var Vc=s(Ln);fu=i(Vc,"This tokenizer inherits from "),qr=a(Vc,"A",{href:!0});var M1=s(qr);_u=i(M1,"PreTrainedTokenizer"),M1.forEach(t),gu=i(Vc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Vc.forEach(t),ku=l(G),bt=a(G,"DIV",{class:!0});var ni=s(bt);f(Dn.$$.fragment,ni),bu=l(ni),Qi=a(ni,"P",{});var P1=s(Qi);yu=i(P1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),P1.forEach(t),Tu=l(ni),Gn=a(ni,"UL",{});var Jc=s(Gn);$r=a(Jc,"LI",{});var Sy=s($r);vu=i(Sy,"single sequence: "),Vi=a(Sy,"CODE",{});var E1=s(Vi);wu=i(E1,"<s> X </s>"),E1.forEach(t),Sy.forEach(t),xu=l(Jc),jr=a(Jc,"LI",{});var Iy=s(jr);zu=i(Iy,"pair of sequences: "),Ji=a(Iy,"CODE",{});var C1=s(Ji);Fu=i(C1,"<s> A </s></s> B </s>"),C1.forEach(t),Iy.forEach(t),Jc.forEach(t),ni.forEach(t),Bu=l(G),Oo=a(G,"DIV",{class:!0});var Xc=s(Oo);f(Wn.$$.fragment,Xc),qu=l(Xc),Xi=a(Xc,"P",{});var A1=s(Xi);$u=i(A1,"Converts a sequence of tokens (string) in a single string."),A1.forEach(t),Xc.forEach(t),ju=l(G),So=a(G,"DIV",{class:!0});var Kc=s(So);f(Un.$$.fragment,Kc),Mu=l(Kc),Ki=a(Kc,"P",{});var O1=s(Ki);Pu=i(O1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),O1.forEach(t),Kc.forEach(t),Eu=l(G),Io=a(G,"DIV",{class:!0});var Zc=s(Io);f(Rn.$$.fragment,Zc),Cu=l(Zc),Hn=a(Zc,"P",{});var Yc=s(Hn);Au=i(Yc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Zi=a(Yc,"CODE",{});var S1=s(Zi);Ou=i(S1,"prepare_for_model"),S1.forEach(t),Su=i(Yc," method."),Yc.forEach(t),Zc.forEach(t),G.forEach(t),mc=l(o),to=a(o,"H2",{class:!0});var ep=s(to);No=a(ep,"A",{id:!0,class:!0,href:!0});var I1=s(No);Yi=a(I1,"SPAN",{});var N1=s(Yi);f(Qn.$$.fragment,N1),N1.forEach(t),I1.forEach(t),Iu=l(ep),ed=a(ep,"SPAN",{});var L1=s(ed);Nu=i(L1,"BartTokenizerFast"),L1.forEach(t),ep.forEach(t),fc=l(o),W=a(o,"DIV",{class:!0});var _e=s(W);f(Vn.$$.fragment,_e),Lu=l(_e),Jn=a(_e,"P",{});var tp=s(Jn);Du=i(tp,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),td=a(tp,"EM",{});var D1=s(td);Gu=i(D1,"tokenizers"),D1.forEach(t),Wu=i(tp,` library), derived from the GPT-2 tokenizer,
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),op.forEach(t),Ku=l(_e),f(Lo.$$.fragment,_e),Zu=l(_e),Zn=a(_e,"P",{});var np=s(Zn);Yu=i(np,"This tokenizer inherits from "),Mr=a(np,"A",{href:!0});var U1=s(Mr);em=i(U1,"PreTrainedTokenizerFast"),U1.forEach(t),tm=i(np,` which contains most of the main methods. Users should
...
This model inherits from `),Pr=a(rp,"A",{href:!0});var J1=s(Pr);lm=i(J1,"PreTrainedModel"),J1.forEach(t),cm=i(rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),fm=l(gn),Ce=a(gn,"DIV",{class:!0});var Mt=s(Ce);f(sa.$$.fragment,Mt),_m=l(Mt),no=a(Mt,"P",{});var ai=s(no);gm=i(ai,"The "),Er=a(ai,"A",{href:!0});var K1=s(Er);km=i(K1,"BartModel"),K1.forEach(t),bm=i(ai," forward method, overrides the "),id=a(ai,"CODE",{});var Z1=s(id);ym=i(Z1,"__call__"),Z1.forEach(t),Tm=i(ai," special method."),ai.forEach(t),vm=l(Mt),f(Wo.$$.fragment,Mt),wm=l(Mt),dd=a(Mt,"P",{});var Y1=s(dd);xm=i(Y1,"Example:"),Y1.forEach(t),zm=l(Mt),f(ra.$$.fragment,Mt),Mt.forEach(t),gn.forEach(t),kc=l(o),ao=a(o,"H2",{class:!0});var dp=s(ao);Uo=a(dp,"A",{id:!0,class:!0,href:!0});var eT=s(Uo);ld=a(eT,"SPAN",{});var tT=s(ld);f(ia.$$.fragment,tT),tT.forEach(t),eT.forEach(t),Fm=l(dp),cd=a(dp,"SPAN",{});var oT=s(cd);Bm=i(oT,"BartForConditionalGeneration"),oT.forEach(t),dp.forEach(t),bc=l(o),Ke=a(o,"DIV",{class:!0});var kn=s(Ke);f(da.$$.fragment,kn),qm=l(kn),la=a(kn,"P",{});var lp=s(la);$m=i(lp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Cr=a(lp,"A",{href:!0});var nT=s(Cr);jm=i(nT,"PreTrainedModel"),nT.forEach(t),Mm=i(lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp.forEach(t),Pm=l(kn),ca=a(kn,"P",{});var cp=s(ca);Em=i(cp,"This model is also a PyTorch "),pa=a(cp,"A",{href:!0,rel:!0});var aT=s(pa);Cm=i(aT,"torch.nn.Module"),aT.forEach(t),Am=i(cp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),Om=l(kn),Y=a(kn,"DIV",{class:!0});var Le=s(Y);f(ha.$$.fragment,Le),Sm=l(Le),so=a(Le,"P",{});var si=s(so);Im=i(si,"The "),Ar=a(si,"A",{href:!0});var sT=s(Ar);Nm=i(sT,"BartForConditionalGeneration"),sT.forEach(t),Lm=i(si," forward method, overrides the "),pd=a(si,"CODE",{});var rT=s(pd);Dm=i(rT,"__call__"),rT.forEach(t),Gm=i(si," special method."),si.forEach(t),Wm=l(Le),f(Ro.$$.fragment,Le),Um=l(Le),hd=a(Le,"P",{});var iT=s(hd);Rm=i(iT,"Summarization example:"),iT.forEach(t),Hm=l(Le),f(ua.$$.fragment,Le),Qm=l(Le),ud=a(Le,"P",{});var dT=s(ud);Vm=i(dT,"Mask filling example:"),dT.forEach(t),Jm=l(Le),f(ma.$$.fragment,Le),Le.forEach(t),kn.forEach(t),yc=l(o),ro=a(o,"H2",{class:!0});var pp=s(ro);Ho=a(pp,"A",{id:!0,class:!0,href:!0});var lT=s(Ho);md=a(lT,"SPAN",{});var cT=s(md);f(fa.$$.fragment,cT),cT.forEach(t),lT.forEach(t),Xm=l(pp),fd=a(pp,"SPAN",{});var pT=s(fd);Km=i(pT,"BartForSequenceClassification"),pT.forEach(t),pp.forEach(t),Tc=l(o),Fe=a(o,"DIV",{class:!0});var Pt=s(Fe);f(_a.$$.fragment,Pt),Zm=l(Pt),_d=a(Pt,"P",{});var hT=s(_d);Ym=i(hT,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),hT.forEach(t),ef=l(Pt),ga=a(Pt,"P",{});var hp=s(ga);tf=i(hp,"This model inherits from "),Or=a(hp,"A",{href:!0});var uT=s(Or);of=i(uT,"PreTrainedModel"),uT.forEach(t),nf=i(hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),af=l(Pt),ka=a(Pt,"P",{});var up=s(ka);sf=i(up,"This model is also a PyTorch "),ba=a(up,"A",{href:!0,rel:!0});var mT=s(ba);rf=i(mT,"torch.nn.Module"),mT.forEach(t),df=i(up,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),lf=l(Pt),D=a(Pt,"DIV",{class:!0});var oe=s(D);f(ya.$$.fragment,oe),cf=l(oe),io=a(oe,"P",{});var ri=s(io);pf=i(ri,"The "),Sr=a(ri,"A",{href:!0});var fT=s(Sr);hf=i(fT,"BartForSequenceClassification"),fT.forEach(t),uf=i(ri," forward method, overrides the "),gd=a(ri,"CODE",{});var _T=s(gd);mf=i(_T,"__call__"),_T.forEach(t),ff=i(ri," special method."),ri.forEach(t),_f=l(oe),f(Qo.$$.fragment,oe),gf=l(oe),kd=a(oe,"P",{});var gT=s(kd);kf=i(gT,"Example of single-label classification:"),gT.forEach(t),bf=l(oe),f(Ta.$$.fragment,oe),yf=l(oe),f(va.$$.fragment,oe),Tf=l(oe),bd=a(oe,"P",{});var kT=s(bd);vf=i(kT,"Example of multi-label classification:"),kT.forEach(t),wf=l(oe),f(wa.$$.fragment,oe),xf=l(oe),f(xa.$$.fragment,oe),oe.forEach(t),Pt.forEach(t),vc=l(o),lo=a(o,"H2",{class:!0});var mp=s(lo);Vo=a(mp,"A",{id:!0,class:!0,href:!0});var bT=s(Vo);yd=a(bT,"SPAN",{});var yT=s(yd);f(za.$$.fragment,yT),yT.forEach(t),bT.forEach(t),zf=l(mp),Td=a(mp,"SPAN",{});var TT=s(Td);Ff=i(TT,"BartForQuestionAnswering"),TT.forEach(t),mp.forEach(t),wc=l(o),Be=a(o,"DIV",{class:!0});var Et=s(Be);f(Fa.$$.fragment,Et),Bf=l(Et),co=a(Et,"P",{});var ii=s(co);qf=i(ii,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),vd=a(ii,"CODE",{});var vT=s(vd);$f=i(vT,"span start logits"),vT.forEach(t),jf=i(ii," and "),wd=a(ii,"CODE",{});var wT=s(wd);Mf=i(wT,"span end logits"),wT.forEach(t),Pf=i(ii,")."),ii.forEach(t),Ef=l(Et),Ba=a(Et,"P",{});var fp=s(Ba);Cf=i(fp,"This model inherits from "),Ir=a(fp,"A",{href:!0});var xT=s(Ir);Af=i(xT,"PreTrainedModel"),xT.forEach(t),Of=i(fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),Sf=l(Et),qa=a(Et,"P",{});var _p=s(qa);If=i(_p,"This model is also a PyTorch "),$a=a(_p,"A",{href:!0,rel:!0});var zT=s($a);Nf=i(zT,"torch.nn.Module"),zT.forEach(t),Lf=i(_p,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p.forEach(t),Df=l(Et),fe=a(Et,"DIV",{class:!0});var et=s(fe);f(ja.$$.fragment,et),Gf=l(et),po=a(et,"P",{});var di=s(po);Wf=i(di,"The "),Nr=a(di,"A",{href:!0});var FT=s(Nr);Uf=i(FT,"BartForQuestionAnswering"),FT.forEach(t),Rf=i(di," forward method, overrides the "),xd=a(di,"CODE",{});var BT=s(xd);Hf=i(BT,"__call__"),BT.forEach(t),Qf=i(di," special method."),di.forEach(t),Vf=l(et),f(Jo.$$.fragment,et),Jf=l(et),zd=a(et,"P",{});var qT=s(zd);Xf=i(qT,"Example:"),qT.forEach(t),Kf=l(et),f(Ma.$$.fragment,et),Zf=l(et),f(Pa.$$.fragment,et),et.forEach(t),Et.forEach(t),xc=l(o),ho=a(o,"H2",{class:!0});var gp=s(ho);Xo=a(gp,"A",{id:!0,class:!0,href:!0});var $T=s(Xo);Fd=a($T,"SPAN",{});var jT=s(Fd);f(Ea.$$.fragment,jT),jT.forEach(t),$T.forEach(t),Yf=l(gp),Bd=a(gp,"SPAN",{});var MT=s(Bd);e_=i(MT,"BartForCausalLM"),MT.forEach(t),gp.forEach(t),zc=l(o),uo=a(o,"DIV",{class:!0});var kp=s(uo);f(Ca.$$.fragment,kp),t_=l(kp),yt=a(kp,"DIV",{class:!0});var li=s(yt);f(Aa.$$.fragment,li),o_=l(li),qd=a(li,"P",{});var PT=s(qd);n_=i(PT,"Example:"),PT.forEach(t),a_=l(li),f(Oa.$$.fragment,li),li.forEach(t),kp.forEach(t),Fc=l(o),mo=a(o,"H2",{class:!0});var bp=s(mo);Ko=a(bp,"A",{id:!0,class:!0,href:!0});var ET=s(Ko);$d=a(ET,"SPAN",{});var CT=s($d);f(Sa.$$.fragment,CT),CT.forEach(t),ET.forEach(t),s_=l(bp),jd=a(bp,"SPAN",{});var AT=s(jd);r_=i(AT,"TFBartModel"),AT.forEach(t),bp.forEach(t),Bc=l(o),qe=a(o,"DIV",{class:!0});var Ct=s(qe);f(Ia.$$.fragment,Ct),i_=l(Ct),Na=a(Ct,"P",{});var yp=s(Na);d_=i(yp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Lr=a(yp,"A",{href:!0});var OT=s(Lr);l_=i(OT,"TFPreTrainedModel"),OT.forEach(t),c_=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),p_=l(Ct),La=a(Ct,"P",{});var Tp=s(La);h_=i(Tp,"This model is also a "),Da=a(Tp,"A",{href:!0,rel:!0});var ST=s(Da);u_=i(ST,"tf.keras.Model"),ST.forEach(t),m_=i(Tp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp.forEach(t),f_=l(Ct),f(Zo.$$.fragment,Ct),__=l(Ct),Ae=a(Ct,"DIV",{class:!0});var At=s(Ae);f(Ga.$$.fragment,At),g_=l(At),fo=a(At,"P",{});var ci=s(fo);k_=i(ci,"The "),Dr=a(ci,"A",{href:!0});var IT=s(Dr);b_=i(IT,"TFBartModel"),IT.forEach(t),y_=i(ci," forward method, overrides the "),Md=a(ci,"CODE",{});var NT=s(Md);T_=i(NT,"__call__"),NT.forEach(t),v_=i(ci," special method."),ci.forEach(t),w_=l(At),f(Yo.$$.fragment,At),x_=l(At),Pd=a(At,"P",{});var LT=s(Pd);z_=i(LT,"Example:"),LT.forEach(t),F_=l(At),f(Wa.$$.fragment,At),At.forEach(t),Ct.forEach(t),qc=l(o),_o=a(o,"H2",{class:!0});var vp=s(_o);en=a(vp,"A",{id:!0,class:!0,href:!0});var DT=s(en);Ed=a(DT,"SPAN",{});var GT=s(Ed);f(Ua.$$.fragment,GT),GT.forEach(t),DT.forEach(t),B_=l(vp),Cd=a(vp,"SPAN",{});var WT=s(Cd);q_=i(WT,"TFBartForConditionalGeneration"),WT.forEach(t),vp.forEach(t),$c=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);f(Ra.$$.fragment,Ot),$_=l(Ot),Ha=a(Ot,"P",{});var wp=s(Ha);j_=i(wp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(wp,"A",{href:!0});var UT=s(Gr);M_=i(UT,"TFPreTrainedModel"),UT.forEach(t),P_=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp.forEach(t),E_=l(Ot),Qa=a(Ot,"P",{});var xp=s(Qa);C_=i(xp,"This model is also a "),Va=a(xp,"A",{href:!0,rel:!0});var RT=s(Va);A_=i(RT,"tf.keras.Model"),RT.forEach(t),O_=i(xp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xp.forEach(t),S_=l(Ot),f(tn.$$.fragment,Ot),I_=l(Ot),ee=a(Ot,"DIV",{class:!0});var De=s(ee);f(Ja.$$.fragment,De),N_=l(De),go=a(De,"P",{});var pi=s(go);L_=i(pi,"The "),Wr=a(pi,"A",{href:!0});var HT=s(Wr);D_=i(HT,"TFBartForConditionalGeneration"),HT.forEach(t),G_=i(pi," forward method, overrides the "),Ad=a(pi,"CODE",{});var QT=s(Ad);W_=i(QT,"__call__"),QT.forEach(t),U_=i(pi," special method."),pi.forEach(t),R_=l(De),f(on.$$.fragment,De),H_=l(De),Od=a(De,"P",{});var VT=s(Od);Q_=i(VT,"Summarization example:"),VT.forEach(t),V_=l(De),f(Xa.$$.fragment,De),J_=l(De),Sd=a(De,"P",{});var JT=s(Sd);X_=i(JT,"Mask filling example:"),JT.forEach(t),K_=l(De),f(Ka.$$.fragment,De),De.forEach(t),Ot.forEach(t),jc=l(o),ko=a(o,"H2",{class:!0});var zp=s(ko);nn=a(zp,"A",{id:!0,class:!0,href:!0});var XT=s(nn);Id=a(XT,"SPAN",{});var KT=s(Id);f(Za.$$.fragment,KT),KT.forEach(t),XT.forEach(t),Z_=l(zp),Nd=a(zp,"SPAN",{});var ZT=s(Nd);Y_=i(ZT,"FlaxBartModel"),ZT.forEach(t),zp.forEach(t),Mc=l(o),U=a(o,"DIV",{class:!0});var ge=s(U);f(Ya.$$.fragment,ge),eg=l(ge),es=a(ge,"P",{});var Fp=s(es);tg=i(Fp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Ur=a(Fp,"A",{href:!0});var YT=s(Ur);og=i(YT,"FlaxPreTrainedModel"),YT.forEach(t),ng=i(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp.forEach(t),ag=l(ge),ts=a(ge,"P",{});var Bp=s(ts);sg=i(Bp,`This model is also a Flax Linen
`),os=a(Bp,"A",{href:!0,rel:!0});var ev=s(os);rg=i(ev,"flax.nn.Module"),ev.forEach(t),ig=i(Bp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bp.forEach(t),dg=l(ge),Ld=a(ge,"P",{});var tv=s(Ld);lg=i(tv,"Finally, this model supports inherent JAX features such as:"),tv.forEach(t),cg=l(ge),ht=a(ge,"UL",{});var bn=s(ht);Dd=a(bn,"LI",{});var ov=s(Dd);ns=a(ov,"A",{href:!0,rel:!0});var nv=s(ns);pg=i(nv,"Just-In-Time (JIT) compilation"),nv.forEach(t),ov.forEach(t),hg=l(bn),Gd=a(bn,"LI",{});var av=s(Gd);as=a(av,"A",{href:!0,rel:!0});var sv=s(as);ug=i(sv,"Automatic Differentiation"),sv.forEach(t),av.forEach(t),mg=l(bn),Wd=a(bn,"LI",{});var rv=s(Wd);ss=a(rv,"A",{href:!0,rel:!0});var iv=s(ss);fg=i(iv,"Vectorization"),iv.forEach(t),rv.forEach(t),_g=l(bn),Ud=a(bn,"LI",{});var dv=s(Ud);rs=a(dv,"A",{href:!0,rel:!0});var lv=s(rs);gg=i(lv,"Parallelization"),lv.forEach(t),dv.forEach(t),bn.forEach(t),kg=l(ge),Oe=a(ge,"DIV",{class:!0});var St=s(Oe);f(is.$$.fragment,St),bg=l(St),bo=a(St,"P",{});var hi=s(bo);yg=i(hi,"The "),Rd=a(hi,"CODE",{});var cv=s(Rd);Tg=i(cv,"FlaxBartPreTrainedModel"),cv.forEach(t),vg=i(hi,"forward method, overrides the "),Hd=a(hi,"CODE",{});var pv=s(Hd);wg=i(pv,"__call__"),pv.forEach(t),xg=i(hi," special method."),hi.forEach(t),zg=l(St),f(an.$$.fragment,St),Fg=l(St),Qd=a(St,"P",{});var hv=s(Qd);Bg=i(hv,"Example:"),hv.forEach(t),qg=l(St),f(ds.$$.fragment,St),St.forEach(t),$g=l(ge),Tt=a(ge,"DIV",{class:!0});var ui=s(Tt);f(ls.$$.fragment,ui),jg=l(ui),Vd=a(ui,"P",{});var uv=s(Vd);Mg=i(uv,"Example:"),uv.forEach(t),Pg=l(ui),f(cs.$$.fragment,ui),ui.forEach(t),Eg=l(ge),vt=a(ge,"DIV",{class:!0});var mi=s(vt);f(ps.$$.fragment,mi),Cg=l(mi),Jd=a(mi,"P",{});var mv=s(Jd);Ag=i(mv,"Example:"),mv.forEach(t),Og=l(mi),f(hs.$$.fragment,mi),mi.forEach(t),ge.forEach(t),Pc=l(o),yo=a(o,"H2",{class:!0});var qp=s(yo);sn=a(qp,"A",{id:!0,class:!0,href:!0});var fv=s(sn);Xd=a(fv,"SPAN",{});var _v=s(Xd);f(us.$$.fragment,_v),_v.forEach(t),fv.forEach(t),Sg=l(qp),Kd=a(qp,"SPAN",{});var gv=s(Kd);Ig=i(gv,"FlaxBartForConditionalGeneration"),gv.forEach(t),qp.forEach(t),Ec=l(o),R=a(o,"DIV",{class:!0});var ke=s(R);f(ms.$$.fragment,ke),Ng=l(ke),fs=a(ke,"P",{});var $p=s(fs);Lg=i($p,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rr=a($p,"A",{href:!0});var kv=s(Rr);Dg=i(kv,"FlaxPreTrainedModel"),kv.forEach(t),Gg=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),Wg=l(ke),_s=a(ke,"P",{});var jp=s(_s);Ug=i(jp,`This model is also a Flax Linen
`),gs=a(jp,"A",{href:!0,rel:!0});var bv=s(gs);Rg=i(bv,"flax.nn.Module"),bv.forEach(t),Hg=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Qg=l(ke),Zd=a(ke,"P",{});var yv=s(Zd);Vg=i(yv,"Finally, this model supports inherent JAX features such as:"),yv.forEach(t),Jg=l(ke),ut=a(ke,"UL",{});var yn=s(ut);Yd=a(yn,"LI",{});var Tv=s(Yd);ks=a(Tv,"A",{href:!0,rel:!0});var vv=s(ks);Xg=i(vv,"Just-In-Time (JIT) compilation"),vv.forEach(t),Tv.forEach(t),Kg=l(yn),el=a(yn,"LI",{});var wv=s(el);bs=a(wv,"A",{href:!0,rel:!0});var xv=s(bs);Zg=i(xv,"Automatic Differentiation"),xv.forEach(t),wv.forEach(t),Yg=l(yn),tl=a(yn,"LI",{});var zv=s(tl);ys=a(zv,"A",{href:!0,rel:!0});var Fv=s(ys);ek=i(Fv,"Vectorization"),Fv.forEach(t),zv.forEach(t),tk=l(yn),ol=a(yn,"LI",{});var Bv=s(ol);Ts=a(Bv,"A",{href:!0,rel:!0});var qv=s(Ts);ok=i(qv,"Parallelization"),qv.forEach(t),Bv.forEach(t),yn.forEach(t),nk=l(ke),te=a(ke,"DIV",{class:!0});var Ge=s(te);f(vs.$$.fragment,Ge),ak=l(Ge),To=a(Ge,"P",{});var fi=s(To);sk=i(fi,"The "),nl=a(fi,"CODE",{});var $v=s(nl);rk=i($v,"FlaxBartPreTrainedModel"),$v.forEach(t),ik=i(fi,"forward method, overrides the "),al=a(fi,"CODE",{});var jv=s(al);dk=i(jv,"__call__"),jv.forEach(t),lk=i(fi," special method."),fi.forEach(t),ck=l(Ge),f(rn.$$.fragment,Ge),pk=l(Ge),sl=a(Ge,"P",{});var Mv=s(sl);hk=i(Mv,"Summarization example:"),Mv.forEach(t),uk=l(Ge),f(ws.$$.fragment,Ge),mk=l(Ge),rl=a(Ge,"P",{});var Pv=s(rl);fk=i(Pv,"Mask filling example:"),Pv.forEach(t),_k=l(Ge),f(xs.$$.fragment,Ge),Ge.forEach(t),gk=l(ke),wt=a(ke,"DIV",{class:!0});var _i=s(wt);f(zs.$$.fragment,_i),kk=l(_i),il=a(_i,"P",{});var Ev=s(il);bk=i(Ev,"Example:"),Ev.forEach(t),yk=l(_i),f(Fs.$$.fragment,_i),_i.forEach(t),Tk=l(ke),xt=a(ke,"DIV",{class:!0});var gi=s(xt);f(Bs.$$.fragment,gi),vk=l(gi),dl=a(gi,"P",{});var Cv=s(dl);wk=i(Cv,"Example:"),Cv.forEach(t),xk=l(gi),f(qs.$$.fragment,gi),gi.forEach(t),ke.forEach(t),Cc=l(o),vo=a(o,"H2",{class:!0});var Mp=s(vo);dn=a(Mp,"A",{id:!0,class:!0,href:!0});var Av=s(dn);ll=a(Av,"SPAN",{});var Ov=s(ll);f($s.$$.fragment,Ov),Ov.forEach(t),Av.forEach(t),zk=l(Mp),cl=a(Mp,"SPAN",{});var Sv=s(cl);Fk=i(Sv,"FlaxBartForSequenceClassification"),Sv.forEach(t),Mp.forEach(t),Ac=l(o),S=a(o,"DIV",{class:!0});var ne=s(S);f(js.$$.fragment,ne),Bk=l(ne),pl=a(ne,"P",{});var Iv=s(pl);qk=i(Iv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Iv.forEach(t),$k=l(ne),Ms=a(ne,"P",{});var Pp=s(Ms);jk=i(Pp,"This model inherits from "),Hr=a(Pp,"A",{href:!0});var Nv=s(Hr);Mk=i(Nv,"FlaxPreTrainedModel"),Nv.forEach(t),Pk=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pp.forEach(t),Ek=l(ne),Ps=a(ne,"P",{});var Ep=s(Ps);Ck=i(Ep,`This model is also a Flax Linen
`),Es=a(Ep,"A",{href:!0,rel:!0});var Lv=s(Es);Ak=i(Lv,"flax.nn.Module"),Lv.forEach(t),Ok=i(Ep,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ep.forEach(t),Sk=l(ne),hl=a(ne,"P",{});var Dv=s(hl);Ik=i(Dv,"Finally, this model supports inherent JAX features such as:"),Dv.forEach(t),Nk=l(ne),mt=a(ne,"UL",{});var Tn=s(mt);ul=a(Tn,"LI",{});var Gv=s(ul);Cs=a(Gv,"A",{href:!0,rel:!0});var Wv=s(Cs);Lk=i(Wv,"Just-In-Time (JIT) compilation"),Wv.forEach(t),Gv.forEach(t),Dk=l(Tn),ml=a(Tn,"LI",{});var Uv=s(ml);As=a(Uv,"A",{href:!0,rel:!0});var Rv=s(As);Gk=i(Rv,"Automatic Differentiation"),Rv.forEach(t),Uv.forEach(t),Wk=l(Tn),fl=a(Tn,"LI",{});var Hv=s(fl);Os=a(Hv,"A",{href:!0,rel:!0});var Qv=s(Os);Uk=i(Qv,"Vectorization"),Qv.forEach(t),Hv.forEach(t),Rk=l(Tn),_l=a(Tn,"LI",{});var Vv=s(_l);Ss=a(Vv,"A",{href:!0,rel:!0});var Jv=s(Ss);Hk=i(Jv,"Parallelization"),Jv.forEach(t),Vv.forEach(t),Tn.forEach(t),Qk=l(ne),Se=a(ne,"DIV",{class:!0});var It=s(Se);f(Is.$$.fragment,It),Vk=l(It),wo=a(It,"P",{});var ki=s(wo);Jk=i(ki,"The "),gl=a(ki,"CODE",{});var Xv=s(gl);Xk=i(Xv,"FlaxBartPreTrainedModel"),Xv.forEach(t),Kk=i(ki,"forward method, overrides the "),kl=a(ki,"CODE",{});var Kv=s(kl);Zk=i(Kv,"__call__"),Kv.forEach(t),Yk=i(ki," special method."),ki.forEach(t),eb=l(It),f(ln.$$.fragment,It),tb=l(It),bl=a(It,"P",{});var Zv=s(bl);ob=i(Zv,"Example:"),Zv.forEach(t),nb=l(It),f(Ns.$$.fragment,It),It.forEach(t),ab=l(ne),zt=a(ne,"DIV",{class:!0});var bi=s(zt);f(Ls.$$.fragment,bi),sb=l(bi),yl=a(bi,"P",{});var Yv=s(yl);rb=i(Yv,"Example:"),Yv.forEach(t),ib=l(bi),f(Ds.$$.fragment,bi),bi.forEach(t),db=l(ne),Ft=a(ne,"DIV",{class:!0});var yi=s(Ft);f(Gs.$$.fragment,yi),lb=l(yi),Tl=a(yi,"P",{});var ew=s(Tl);cb=i(ew,"Example:"),ew.forEach(t),pb=l(yi),f(Ws.$$.fragment,yi),yi.forEach(t),ne.forEach(t),Oc=l(o),xo=a(o,"H2",{class:!0});var Cp=s(xo);cn=a(Cp,"A",{id:!0,class:!0,href:!0});var tw=s(cn);vl=a(tw,"SPAN",{});var ow=s(vl);f(Us.$$.fragment,ow),ow.forEach(t),tw.forEach(t),hb=l(Cp),wl=a(Cp,"SPAN",{});var nw=s(wl);ub=i(nw,"FlaxBartForQuestionAnswering"),nw.forEach(t),Cp.forEach(t),Sc=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);f(Rs.$$.fragment,ae),mb=l(ae),zo=a(ae,"P",{});var Ti=s(zo);fb=i(Ti,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
