...
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/generation_utils.py#L1669",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/generation_tf_utils.py#L1979",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_15770/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15770/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_15770/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_15770/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/pr_15770/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
`),Si=s(Tc,"CODE",{});var XT=a(Si);zh=i(XT,"[from_pretrained()](/docs/transformers/pr_15770/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),XT.forEach(t),Dh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d(j),Nt=s(j,"DIV",{class:!0});var jc=a(Nt);m(_o.$$.fragment,jc),Gh=d(jc),Ni=s(jc,"P",{});var RT=a(Ni);Sh=i(RT,"Set model\u2019s input embeddings."),RT.forEach(t),jc.forEach(t),Nh=d(j),Be=s(j,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var YT=a(Ci);Ih=i(YT,"Tie the weights between the input embeddings and the output embeddings."),YT.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var $c=a(bo);Wh=i($c,"If the "),Ii=s($c,"CODE",{});var KT=a(Ii);Uh=i(KT,"torchscript"),KT.forEach(t),Hh=i($c,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
embeddings`),J2.forEach(t),Rc.forEach(t),Tb=d(k),an=s(k,"DIV",{class:!0});var Yc=a(an);m(Zo.$$.fragment,Yc),jb=d(Yc),Dl=s(Yc,"P",{});var Q2=a(Dl);$b=i(Q2,"Get the concatenated _prefix name of the bias from the model name to the parent layer"),Q2.forEach(t),Yc.forEach(t),Mb=d(k),rn=s(k,"DIV",{class:!0});var Kc=a(rn);m(Jo.$$.fragment,Kc),Pb=d(Kc),Al=s(Kc,"P",{});var e0=a(Al);Eb=i(e0,`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),e0.forEach(t),Kc.forEach(t),Lb=d(k),ln=s(k,"DIV",{class:!0});var Zc=a(ln);m(Qo.$$.fragment,Zc),qb=d(Zc),Gl=s(Zc,"P",{});var t0=a(Gl);Fb=i(t0,"Prunes heads of the base model."),t0.forEach(t),Zc.forEach(t),Ob=d(k),Ve=s(k,"DIV",{class:!0});var qr=a(Ve);m(es.$$.fragment,qr),zb=d(qr),ts=s(qr,"P",{});var Jc=a(ts);Db=i(Jc,"Resizes input token embeddings matrix of the model if "),Sl=s(Jc,"CODE",{});var n0=a(Sl);Ab=i(n0,"new_num_tokens != config.vocab_size"),n0.forEach(t),Gb=i(Jc,"."),Jc.forEach(t),Sb=d(qr),ns=s(qr,"P",{});var Qc=a(ns);Nb=i(Qc,"Takes care of tying weights embeddings afterwards if the model class has a "),Nl=s(Qc,"CODE",{});var o0=a(Nl);Cb=i(o0,"tie_weights()"),o0.forEach(t),Ib=i(Qc," method."),Qc.forEach(t),qr.forEach(t),Bb=d(k),dn=s(k,"DIV",{class:!0});var em=a(dn);m(os.$$.fragment,em),Wb=d(em),ss=s(em,"P",{});var tm=a(ss);Ub=i(tm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),or=s(tm,"A",{href:!0});var s0=a(or);Hb=i(s0,"from_pretrained()"),s0.forEach(t),Vb=i(tm," class method."),tm.forEach(t),em.forEach(t),Xb=d(k),pn=s(k,"DIV",{class:!0});var nm=a(pn);m(as.$$.fragment,nm),Rb=d(nm),Cl=s(nm,"P",{});var a0=a(Cl);Yb=i(a0,"Method used for serving the model."),a0.forEach(t),nm.forEach(t),Kb=d(k),cn=s(k,"DIV",{class:!0});var om=a(cn);m(rs.$$.fragment,om),Zb=d(om),Il=s(om,"P",{});var r0=a(Il);Jb=i(r0,"Prepare the output of the saved model. Each model must implement this function."),r0.forEach(t),om.forEach(t),Qb=d(k),mn=s(k,"DIV",{class:!0});var sm=a(mn);m(is.$$.fragment,sm),ev=d(sm),Bl=s(sm,"P",{});var i0=a(Bl);tv=i(i0,"Set all the bias in the LM head."),i0.forEach(t),sm.forEach(t),nv=d(k),un=s(k,"DIV",{class:!0});var am=a(un);m(ls.$$.fragment,am),ov=d(am),Wl=s(am,"P",{});var l0=a(Wl);sv=i(l0,"Set model\u2019s input embeddings"),l0.forEach(t),am.forEach(t),av=d(k),gn=s(k,"DIV",{class:!0});var rm=a(gn);m(ds.$$.fragment,rm),rv=d(rm),Ul=s(rm,"P",{});var d0=a(Ul);iv=i(d0,"Set model\u2019s output embeddings"),d0.forEach(t),rm.forEach(t),lv=d(k),hn=s(k,"DIV",{class:!0});var im=a(hn);m(ps.$$.fragment,im),dv=d(im),Hl=s(im,"P",{});var p0=a(Hl);pv=i(p0,"A modification of Keras\u2019s default test_step that cleans up the printed metrics when we use a dummy loss."),p0.forEach(t),im.forEach(t),cv=d(k),ce=s(k,"DIV",{class:!0});var Fn=a(ce);m(cs.$$.fragment,Fn),mv=d(Fn),oe=s(Fn,"P",{});var Ke=a(oe);uv=i(Ke,"A modification of Keras\u2019s default "),Vl=s(Ke,"CODE",{});var c0=a(Vl);gv=i(c0,"train_step"),c0.forEach(t),hv=i(Ke,` that cleans up the printed metrics when we use a dummy loss. If
a user specifies a loss at model compile time, this function behaves as the original Keras `),Xl=s(Ke,"CODE",{});var m0=a(Xl);_v=i(m0,"train_step"),m0.forEach(t),fv=i(Ke,`. In
this case, it expects the same `),Rl=s(Ke,"CODE",{});var u0=a(Rl);bv=i(u0,"data"),u0.forEach(t),vv=i(Ke," as the original function (i.e. "),Yl=s(Ke,"CODE",{});var g0=a(Yl);yv=i(g0,"(inputs, labels)"),g0.forEach(t),kv=i(Ke,")."),Ke.forEach(t),xv=d(Fn),ut=s(Fn,"P",{});var Fr=a(ut);wv=i(Fr,`However, when the model is compiled without specifying the loss AND the expected label columns are passed as
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var h0=a(Kl);Tv=i(h0,"data"),h0.forEach(t),jv=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var _0=a(Zl);$v=i(_0,"(inputs,)"),_0.forEach(t),Mv=i(Fr,"."),Fr.forEach(t),Pv=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);Ev=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var f0=a(Jl);Lv=i(f0,"loss"),f0.forEach(t),qv=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var b0=a(Ql);Fv=i(b0,"loss"),b0.forEach(t),Ov=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jp=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);_n=s(lm,"A",{id:!0,class:!0,href:!0});var v0=a(_n);ed=s(v0,"SPAN",{});var y0=a(ed);m(ms.$$.fragment,y0),y0.forEach(t),v0.forEach(t),zv=d(lm),td=s(lm,"SPAN",{});var k0=a(td);Dv=i(k0,"TFModelUtilsMixin"),k0.forEach(t),lm.forEach(t),Qp=d(n),Pe=s(n,"DIV",{class:!0});var zr=a(Pe);m(us.$$.fragment,zr),Av=d(zr),gs=s(zr,"P",{});var dm=a(gs);Gv=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var x0=a(nd);Sv=i(x0,"tf.keras.Model"),x0.forEach(t),Nv=i(dm,", to be used as a mixin."),dm.forEach(t),Cv=d(zr),fn=s(zr,"DIV",{class:!0});var pm=a(fn);m(hs.$$.fragment,pm),Iv=d(pm),od=s(pm,"P",{});var w0=a(od);Bv=i(w0,"Get the number of (optionally, trainable) parameters in the model."),w0.forEach(t),pm.forEach(t),zr.forEach(t),ec=d(n),_t=s(n,"H2",{class:!0});var cm=a(_t);bn=s(cm,"A",{id:!0,class:!0,href:!0});var T0=a(bn);sd=s(T0,"SPAN",{});var j0=a(sd);m(_s.$$.fragment,j0),j0.forEach(t),T0.forEach(t),Wv=d(cm),ad=s(cm,"SPAN",{});var $0=a(ad);Uv=i($0,"FlaxPreTrainedModel"),$0.forEach(t),cm.forEach(t),tc=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(fs.$$.fragment,q),Hv=d(q),rd=s(q,"P",{});var M0=a(rd);Vv=i(M0,"Base class for all models."),M0.forEach(t),Xv=d(q),sr=s(q,"P",{});var Dw=a(sr);ar=s(Dw,"A",{href:!0});var P0=a(ar);Rv=i(P0,"FlaxPreTrainedModel"),P0.forEach(t),Yv=i(Dw,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),Dw.forEach(t),Kv=d(q),id=s(q,"P",{});var E0=a(id);Zv=i(E0,"Class attributes (overridden by derived classes):"),E0.forEach(t),Jv=d(q),ft=s(q,"UL",{});var Dr=a(ft);Xe=s(Dr,"LI",{});var Da=a(Xe);ld=s(Da,"STRONG",{});var L0=a(ld);Qv=i(L0,"config_class"),L0.forEach(t),ey=i(Da," ("),rr=s(Da,"A",{href:!0});var q0=a(rr);ty=i(q0,"PretrainedConfig"),q0.forEach(t),ny=i(Da,") \u2014 A subclass of "),ir=s(Da,"A",{href:!0});var F0=a(ir);oy=i(F0,"PretrainedConfig"),F0.forEach(t),sy=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),ay=d(Dr),vn=s(Dr,"LI",{});var qp=a(vn);dd=s(qp,"STRONG",{});var O0=a(dd);ry=i(O0,"base_model_prefix"),O0.forEach(t),iy=i(qp," ("),pd=s(qp,"CODE",{});var z0=a(pd);ly=i(z0,"str"),z0.forEach(t),dy=i(qp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qp.forEach(t),py=d(Dr),R=s(Dr,"LI",{});var De=a(R);cd=s(De,"STRONG",{});var D0=a(cd);cy=i(D0,"main_input_name"),D0.forEach(t),my=i(De," ("),md=s(De,"CODE",{});var A0=a(md);uy=i(A0,"str"),A0.forEach(t),gy=i(De,") \u2014 The name of the principal input to the model (often "),ud=s(De,"CODE",{});var G0=a(ud);hy=i(G0,"input_ids"),G0.forEach(t),_y=i(De,` for NLP
models, `),gd=s(De,"CODE",{});var S0=a(gd);fy=i(S0,"pixel_values"),S0.forEach(t),by=i(De," for vision models and "),hd=s(De,"CODE",{});var N0=a(hd);vy=i(N0,"input_values"),N0.forEach(t),yy=i(De," for speech models)."),De.forEach(t),Dr.forEach(t),ky=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),xy=d(On),vs=s(On,"P",{});var mm=a(vs);wy=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=s(mm,"CODE",{});var C0=a(_d);Ty=i(C0,"repo_path_or_name"),C0.forEach(t),jy=i(mm,"."),mm.forEach(t),$y=d(On),fd=s(On,"P",{});var I0=a(fd);My=i(I0,"Examples:"),I0.forEach(t),Py=d(On),m(ys.$$.fragment,On),On.forEach(t),Ey=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Ly=d(Te),bd=s(Te,"P",{});var B0=a(bd);qy=i(B0,"Instantiate a pretrained flax model from a pre-trained model configuration."),B0.forEach(t),Fy=d(Te),xs=s(Te,"P",{});var um=a(xs);Oy=i(um,"The warning "),vd=s(um,"EM",{});var W0=a(vd);zy=i(W0,"Weights from XXX not initialized from pretrained model"),W0.forEach(t),Dy=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),um.forEach(t),Ay=d(Te),ws=s(Te,"P",{});var gm=a(ws);Gy=i(gm,"The warning "),yd=s(gm,"EM",{});var U0=a(yd);Sy=i(U0,"Weights from XXX not used in YYY"),U0.forEach(t),Ny=i(gm,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),gm.forEach(t),Cy=d(Te),kd=s(Te,"P",{});var H0=a(kd);Iy=i(H0,"Examples:"),H0.forEach(t),By=d(Te),m(Ts.$$.fragment,Te),Te.forEach(t),Wy=d(q),Re=s(q,"DIV",{class:!0});var Ar=a(Re);m(js.$$.fragment,Ar),Uy=d(Ar),xd=s(Ar,"P",{});var V0=a(xd);Hy=i(V0,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V0.forEach(t),Vy=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),Xy=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m($s.$$.fragment,hm),Ry=d(hm),Ms=s(hm,"P",{});var _m=a(Ms);Yy=i(_m,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(_m,"CODE",{});var X0=a(wd);Ky=i(X0,"[from_pretrained()](/docs/transformers/pr_15770/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),X0.forEach(t),Zy=i(_m," class method"),_m.forEach(t),hm.forEach(t),Jy=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Qy=d(Ze),se=s(Ze,"P",{});var Je=a(se);e1=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var R0=a(Td);t1=i(R0,"params"),R0.forEach(t),n1=i(Je," to "),jd=s(Je,"CODE",{});var Y0=a(jd);o1=i(Y0,"jax.numpy.bfloat16"),Y0.forEach(t),s1=i(Je,". This returns a new "),$d=s(Je,"CODE",{});var K0=a($d);a1=i(K0,"params"),K0.forEach(t),r1=i(Je,` tree and does not cast
the `),Md=s(Je,"CODE",{});var Z0=a(Md);i1=i(Z0,"params"),Z0.forEach(t),l1=i(Je," in place."),Je.forEach(t),d1=d(Ze),Pd=s(Ze,"P",{});var J0=a(Pd);p1=i(J0,`This method can be used on TPU to explicitly convert the model parameters to bfloat16 precision to do full
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),J0.forEach(t),c1=d(Ze),Ed=s(Ze,"P",{});var Q0=a(Ed);m1=i(Q0,"Examples:"),Q0.forEach(t),u1=d(Ze),m(Es.$$.fragment,Ze),Ze.forEach(t),g1=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Ls.$$.fragment,Qe),h1=d(Qe),ae=s(Qe,"P",{});var et=a(ae);_1=i(et,"Cast the floating-point "),Ld=s(et,"CODE",{});var ej=a(Ld);f1=i(ej,"parmas"),ej.forEach(t),b1=i(et," to "),qd=s(et,"CODE",{});var tj=a(qd);v1=i(tj,"jax.numpy.float16"),tj.forEach(t),y1=i(et,". This returns a new "),Fd=s(et,"CODE",{});var nj=a(Fd);k1=i(nj,"params"),nj.forEach(t),x1=i(et,` tree and does not cast the
...
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var lj=a(Sd);G1=i(lj,"params"),lj.forEach(t),S1=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var dj=a(Nd);N1=i(dj,"params"),dj.forEach(t),C1=i(tt," in place."),tt.forEach(t),I1=d(zn),Cd=s(zn,"P",{});var pj=a(Cd);B1=i(pj,"Examples:"),pj.forEach(t),W1=d(zn),m(Os.$$.fragment,zn),zn.forEach(t),q.forEach(t),nc=d(n),bt=s(n,"H2",{class:!0});var fm=a(bt);xn=s(fm,"A",{id:!0,class:!0,href:!0});var cj=a(xn);Id=s(cj,"SPAN",{});var mj=a(Id);m(zs.$$.fragment,mj),mj.forEach(t),cj.forEach(t),U1=d(fm),Bd=s(fm,"SPAN",{});var uj=a(Bd);H1=i(uj,"Generation"),uj.forEach(t),fm.forEach(t),oc=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(Ds.$$.fragment,F),V1=d(F),As=s(F,"P",{});var bm=a(As);X1=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var gj=a(lr);R1=i(gj,"PreTrainedModel"),gj.forEach(t),Y1=i(bm,"."),bm.forEach(t),K1=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Z1=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);J1=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var hj=a(dr);Q1=i(hj,"PreTrainedModel"),hj.forEach(t),ek=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),tk=d(F),ge=s(F,"DIV",{class:!0});var Dn=a(ge);m(Ns.$$.fragment,Dn),nk=d(Dn),Wd=s(Dn,"P",{});var _j=a(Wd);ok=i(_j,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),_j.forEach(t),sk=d(Dn),Ud=s(Dn,"P",{});var fj=a(Ud);ak=i(fj,"Examples:"),fj.forEach(t),rk=d(Dn),m(Cs.$$.fragment,Dn),Dn.forEach(t),ik=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),lk=d(An),Hd=s(An,"P",{});var bj=a(Hd);dk=i(bj,"Generates sequences for models with a language modeling head using beam search decoding."),bj.forEach(t),pk=d(An),Vd=s(An,"P",{});var vj=a(Vd);ck=i(vj,"Examples:"),vj.forEach(t),mk=d(An),m(Bs.$$.fragment,An),An.forEach(t),uk=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),gk=d(km),Xd=s(km,"P",{});var yj=a(Xd);hk=i(yj,`compute the transition probabilities of sequences given generation
scores and beam indices`),yj.forEach(t),km.forEach(t),_k=d(F),_e=s(F,"DIV",{class:!0});var Gn=a(_e);m(Us.$$.fragment,Gn),fk=d(Gn),Rd=s(Gn,"P",{});var kj=a(Rd);bk=i(kj,"Generates sequences for models with a language modeling head using beam search decoding."),kj.forEach(t),vk=d(Gn),Yd=s(Gn,"P",{});var xj=a(Yd);yk=i(xj,"Examples:"),xj.forEach(t),kk=d(Gn),m(Hs.$$.fragment,Gn),Gn.forEach(t),xk=d(F),U=s(F,"DIV",{class:!0});var je=a(U);m(Vs.$$.fragment,je),wk=d(je),Kd=s(je,"P",{});var wj=a(Kd);Tk=i(wj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),wj.forEach(t),jk=d(je),vt=s(je,"P",{});var Gr=a(vt);$k=i(Gr,"Apart from "),Zd=s(Gr,"CODE",{});var Tj=a(Zd);Mk=i(Tj,"inputs"),Tj.forEach(t),Pk=i(Gr,`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=s(Gr,"A",{href:!0});var jj=a(pr);Ek=i(jj,"PretrainedConfig"),jj.forEach(t),Lk=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),qk=d(je),Xs=s(je,"P",{});var xm=a(Xs);Fk=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var $j=a(Rs);Ok=i($j,`this blog
post`),$j.forEach(t),zk=i(xm,"."),xm.forEach(t),Dk=d(je),Jd=s(je,"P",{});var Mj=a(Jd);Ak=i(Mj,"Examples:"),Mj.forEach(t),Gk=d(je),m(Ys.$$.fragment,je),je.forEach(t),Sk=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),Nk=d(Sn),Qd=s(Sn,"P",{});var Pj=a(Qd);Ck=i(Pj,"Generates sequences for models with a language modeling head using greedy decoding."),Pj.forEach(t),Ik=d(Sn),ep=s(Sn,"P",{});var Ej=a(ep);Bk=i(Ej,"Examples:"),Ej.forEach(t),Wk=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),Uk=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),Hk=d(Nn),tp=s(Nn,"P",{});var Lj=a(tp);Vk=i(Lj,"Generates sequences for models with a language modeling head using beam search decoding."),Lj.forEach(t),Xk=d(Nn),np=s(Nn,"P",{});var qj=a(np);Rk=i(qj,"Examples:"),qj.forEach(t),Yk=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),Kk=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Zk=d(wm),ta=s(wm,"P",{});var Tm=a(ta);Jk=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var Fj=a(cr);Qk=i(Fj,"PreTrainedModel"),Fj.forEach(t),ex=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),tx=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),nx=d(Cn),op=s(Cn,"P",{});var Oj=a(op);ox=i(Oj,"Generates sequences for models with a language modeling head using multinomial sampling."),Oj.forEach(t),sx=d(Cn),sp=s(Cn,"P",{});var zj=a(sp);ax=i(zj,"Examples:"),zj.forEach(t),rx=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),ix=d(J),aa=s(J,"P",{});var jm=a(aa);lx=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var Dj=a(mr);dx=i(Dj,"TFPreTrainedModel"),Dj.forEach(t),px=i(jm,"."),jm.forEach(t),cx=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),mx=d($m),ia=s($m,"P",{});var Mm=a(ia);ux=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var Aj=a(ur);gx=i(Aj,"PreTrainedModel"),Aj.forEach(t),hx=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),_x=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),fx=d(Q),ap=s(Q,"P",{});var Gj=a(ap);bx=i(Gj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),Sj.forEach(t),xx=i(Pm,"."),Pm.forEach(t),wx=d(Q),Ee=s(Q,"P",{});var In=a(Ee);Tx=i(In,"Apart from "),rp=s(In,"CODE",{});var Nj=a(rp);jx=i(Nj,"input_ids"),Nj.forEach(t),$x=i(In," and "),ip=s(In,"CODE",{});var Cj=a(ip);Mx=i(Cj,"attention_mask"),Cj.forEach(t),Px=i(In,`, all the arguments below will default to the value of the attribute
