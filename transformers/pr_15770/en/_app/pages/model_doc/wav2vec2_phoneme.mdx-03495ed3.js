import{S as Et,i as qt,s as $t,e as n,k as c,w as q,t as s,L as Lt,c as r,d as t,m as l,a,x as $,h as i,b as p,J as o,g as h,y as L,K as Ft,q as F,o as I,B as A}from"../../chunks/vendor-9e2b328e.js";import{D as ze}from"../../chunks/Docstring-50fd6873.js";import{I as Yo}from"../../chunks/IconCopyLink-fd0e58fd.js";function It(Ze){let v,Y,_,g,ie,B,Ke,ce,Ge,Pe,T,y,le,N,Ye,de,eo,xe,z,oo,D,to,no,Ce,ee,ro,We,oe,pe,ao,Ve,te,so,Ee,f,he,io,co,me,lo,po,S,ho,ne,mo,fo,uo,fe,_o,go,ue,vo,qe,P,ko,O,bo,To,$e,R,wo,U,yo,Le,x,zo,M,Po,xo,Fe,C,Co,_e,Wo,Vo,Ie,w,W,ge,H,Eo,ve,qo,Ae,m,X,$o,ke,Lo,Fo,j,Io,re,Ao,Bo,No,V,J,Do,be,So,Oo,E,Q,Ro,Te,Uo,Mo,k,Z,Ho,we,Xo,jo,K,Jo,ye,Qo,Zo,Ko,ae,G,Be;return B=new Yo({}),N=new Yo({}),H=new Yo({}),X=new ze({props:{name:"class transformers.Wav2Vec2PhonemeCTCTokenizer",anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"phone_delimiter_token",val:" = ' '"},{name:"word_delimiter_token",val:" = None"},{name:"do_phonemize",val:" = True"},{name:"phonemizer_lang",val:" = 'en-us'"},{name:"phonemizer_backend",val:" = 'espeak'"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L87",parametersDescription:[{anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`}}),Z=new ze({props:{name:"decode",anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.decode",parameters:[{name:"token_ids",val:": typing.Union[int, typing.List[int], ForwardRef('np.ndarray'), ForwardRef('torch.Tensor'), ForwardRef('tf.Tensor')]"},{name:"skip_special_tokens",val:": bool = False"},{name:"clean_up_tokenization_spaces",val:": bool = True"},{name:"output_char_offsets",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L430",parametersDescription:[{anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.decode.token_ids",description:`<strong>token_ids</strong> (<code>Union[int, List[int], np.ndarray, torch.Tensor, tf.Tensor]</code>) &#x2014;
...
`}}),G=new ze({props:{name:"phonemize",anchor:"transformers.Wav2Vec2PhonemeCTCTokenizer.phonemize",parameters:[{name:"text",val:": str"},{name:"phonemizer_lang",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L233"}}),{c(){v=n("meta"),Y=c(),_=n("h1"),g=n("a"),ie=n("span"),q(B.$$.fragment),Ke=c(),ce=n("span"),Ge=s("Wav2Vec2Phoneme"),Pe=c(),T=n("h2"),y=n("a"),le=n("span"),q(N.$$.fragment),Ye=c(),de=n("span"),eo=s("Overview"),xe=c(),z=n("p"),oo=s("The Wav2Vec2Phoneme model was proposed in "),D=n("a"),to=s(`Simple and Effective Zero-shot Cross-lingual Phoneme Recognition (Xu et al.,
...
the superclass for more information regarding such methods.`),No=c(),V=n("div"),q(J.$$.fragment),Do=c(),be=n("p"),So=s(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),Oo=c(),E=n("div"),q(Q.$$.fragment),Ro=c(),Te=n("p"),Uo=s("Convert a list of lists of token ids into a list of strings by calling decode."),Mo=c(),k=n("div"),q(Z.$$.fragment),Ho=c(),we=n("p"),Xo=s(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),jo=c(),K=n("p"),Jo=s("Similar to doing "),ye=n("code"),Qo=s("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Zo=s("."),Ko=c(),ae=n("div"),q(G.$$.fragment),this.h()},l(e){const d=Lt('[data-svelte="svelte-1phssyn"]',document.head);v=r(d,"META",{name:!0,content:!0}),d.forEach(t),Y=l(e),_=r(e,"H1",{class:!0});var Ne=a(_);g=r(Ne,"A",{id:!0,class:!0,href:!0});var et=a(g);ie=r(et,"SPAN",{});var ot=a(ie);$(B.$$.fragment,ot),ot.forEach(t),et.forEach(t),Ke=l(Ne),ce=r(Ne,"SPAN",{});var tt=a(ce);Ge=i(tt,"Wav2Vec2Phoneme"),tt.forEach(t),Ne.forEach(t),Pe=l(e),T=r(e,"H2",{class:!0});var De=a(T);y=r(De,"A",{id:!0,class:!0,href:!0});var nt=a(y);le=r(nt,"SPAN",{});var rt=a(le);$(N.$$.fragment,rt),rt.forEach(t),nt.forEach(t),Ye=l(De),de=r(De,"SPAN",{});var at=a(de);eo=i(at,"Overview"),at.forEach(t),De.forEach(t),xe=l(e),z=r(e,"P",{});var Se=a(z);oo=i(Se,"The Wav2Vec2Phoneme model was proposed in "),D=r(Se,"A",{href:!0,rel:!0});var st=a(D);to=i(st,`Simple and Effective Zero-shot Cross-lingual Phoneme Recognition (Xu et al.,
