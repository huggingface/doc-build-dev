...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var g=a(u);z=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);_=i($,"Module"),$.forEach(t),w=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(x,g){h(x,u,g),e(u,z),e(u,f),e(f,_),e(u,w)},d(x){x&&t(u)}}}function ff(C){let u,z,f,_,w,x,g,$,Ae,ue,q,ke,X,Se,Q,ee,Oe,je,G,A,qe,L,E,F,te,ne,ve,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,We,O,H,m,j,ye,ot,be,D,st,at,Re,I,ie,rt,Be,U,it,dt,de,xe,wi,Xo,zi,$i,ji,lt,hn,qi,Ps,Ei,Pi,Fi,un,Ni,Fs,Ci,Li,Ii,ct,Ai,Ns,Si,Oi,Cs,Hi,Di,Ui,Ls,mn,Wi,Is,Ri,Bi,Vi,As,fn,Gi,_n,Ji,Yi,er,pt,Ct,Ss,gn,Ki,Os,Zi,tr,Ee,Qo,Xi,Hs,Qi,ed,kn,td,vn,nd,od,sd,ht,ad,Ds,rd,id,Us,dd,ld,cd,Ws,pd,nr,ut,Lt,Rs,Tn,hd,Bs,ud,or,Je,Vs,md,fd,Gs,Mn,_d,gd,Js,yn,kd,sr,mt,It,Ys,bn,vd,Ks,Td,ar,Pe,xn,Md,Zs,yd,bd,xd,wn,wd,Xs,zd,$d,jd,zn,qd,$n,Ed,Pd,Fd,jn,Nd,Qs,Cd,Ld,rr,At,Id,qn,Ad,Sd,ir,En,dr,es,Od,lr,Pn,cr,ft,St,ea,Fn,Hd,ta,Dd,pr,ts,Ud,hr,Nn,ur,ns,Wd,mr,Cn,fr,_t,Ot,na,Ln,Rd,oa,Bd,_r,le,In,Vd,gt,Gd,os,Jd,Yd,An,Kd,Zd,Xd,kt,Qd,ss,el,tl,as,nl,ol,sl,sa,al,rl,Sn,gr,vt,Ht,aa,On,il,ra,dl,kr,W,Hn,ll,Dn,cl,Un,pl,hl,ul,Wn,ml,rs,fl,_l,gl,ia,kl,vl,Rn,Tl,Dt,Bn,Ml,da,yl,vr,Tt,Ut,la,Vn,bl,ca,xl,Tr,we,Gn,wl,Jn,zl,is,$l,jl,ql,Yn,El,Kn,Pl,Fl,Nl,me,Zn,Cl,Mt,Ll,ds,Il,Al,pa,Sl,Ol,Hl,Wt,Dl,ha,Ul,Wl,Xn,Mr,yt,Rt,ua,Qn,Rl,ma,Bl,yr,ze,eo,Vl,to,Gl,ls,Jl,Yl,Kl,no,Zl,oo,Xl,Ql,ec,Y,so,tc,bt,nc,cs,oc,sc,fa,ac,rc,ic,Bt,dc,ao,lc,ro,cc,pc,hc,_a,uc,mc,io,br,xt,Vt,ga,lo,fc,ka,_c,xr,wt,co,gc,Ye,po,kc,va,vc,Tc,ho,wr,zt,Gt,Ta,uo,Mc,Ma,yc,zr,ce,mo,bc,fo,xc,ps,wc,zc,$c,_o,jc,go,qc,Ec,Pc,Jt,Fc,fe,ko,Nc,$t,Cc,hs,Lc,Ic,ya,Ac,Sc,Oc,Yt,Hc,ba,Dc,Uc,vo,$r,jt,Kt,xa,To,Wc,wa,Rc,jr,pe,Mo,Bc,yo,Vc,us,Gc,Jc,Yc,bo,Kc,xo,Zc,Xc,Qc,Zt,ep,K,wo,tp,qt,np,ms,op,sp,za,ap,rp,ip,Xt,dp,zo,lp,$o,cp,pp,hp,$a,up,mp,jo,qr,Et,Qt,ja,qo,fp,qa,_p,Er,R,Eo,gp,Po,kp,fs,vp,Tp,Mp,Fo,yp,No,bp,xp,wp,Ea,zp,$p,Ve,Pa,Co,jp,qp,Fa,Lo,Ep,Pp,Na,Io,Fp,Np,Ca,Ao,Cp,Lp,_e,So,Ip,Pt,Ap,La,Sp,Op,Ia,Hp,Dp,Up,en,Wp,Aa,Rp,Bp,Oo,Pr,Ft,tn,Sa,Ho,Vp,Oa,Gp,Fr,B,Do,Jp,Uo,Yp,_s,Kp,Zp,Xp,Wo,Qp,Ro,eh,th,nh,Ha,oh,sh,Ge,Da,Bo,ah,rh,Ua,Vo,ih,dh,Wa,Go,lh,ch,Ra,Jo,ph,hh,ge,Yo,uh,Nt,mh,Ba,fh,_h,Va,gh,kh,vh,nn,Th,Ga,Mh,yh,Ko,Nr;return x=new he({}),te=new he({}),gn=new he({}),Tn=new he({}),bn=new he({}),En=new $e({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
this superclass for more information regarding those methods.`),gl=d(),ia=o("p"),kl=r("Examples:"),vl=d(),k(Rn.$$.fragment),Tl=d(),Dt=o("div"),k(Bn.$$.fragment),Ml=d(),da=o("p"),yl=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
and behavior.`),Nl=d(),me=o("div"),k(Zn.$$.fragment),Cl=d(),Mt=o("p"),Ll=r("The "),ds=o("a"),Il=r("MarianModel"),Al=r(" forward method, overrides the "),pa=o("code"),Sl=r("__call__"),Ol=r(" special method."),Hl=d(),k(Wt.$$.fragment),Dl=d(),ha=o("p"),Ul=r("Example:"),Wl=d(),k(Xn.$$.fragment),Mr=d(),yt=o("h2"),Rt=o("a"),ua=o("span"),k(Qn.$$.fragment),Rl=d(),ma=o("span"),Bl=r("MarianMTModel"),yr=d(),ze=o("div"),k(eo.$$.fragment),Vl=d(),to=o("p"),Gl=r(`The Marian Model with a language modeling head. Can be used for summarization.
...
behavior.`),Pc=d(),k(Jt.$$.fragment),Fc=d(),fe=o("div"),k(ko.$$.fragment),Nc=d(),$t=o("p"),Cc=r("The "),hs=o("a"),Lc=r("TFMarianModel"),Ic=r(" forward method, overrides the "),ya=o("code"),Ac=r("__call__"),Sc=r(" special method."),Oc=d(),k(Yt.$$.fragment),Hc=d(),ba=o("p"),Dc=r("Example:"),Uc=d(),k(vo.$$.fragment),$r=d(),jt=o("h2"),Kt=o("a"),xa=o("span"),k(To.$$.fragment),Wc=d(),wa=o("span"),Rc=r("TFMarianMTModel"),jr=d(),pe=o("div"),k(Mo.$$.fragment),Bc=d(),yo=o("p"),Vc=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
...
fine-tuning experiments and integration tests.`),su.forEach(t),fd=l(Ms),Gs=s(Ms,"LI",{});var au=a(Gs);Mn=s(au,"A",{href:!0,rel:!0});var ru=a(Mn);_d=i(ru,"Fine-tune on GPU"),ru.forEach(t),au.forEach(t),gd=l(Ms),Js=s(Ms,"LI",{});var iu=a(Js);yn=s(iu,"A",{href:!0,rel:!0});var du=a(yn);kd=i(du,"Fine-tune on GPU with pytorch-lightning"),du.forEach(t),iu.forEach(t),Ms.forEach(t),sr=l(n),mt=s(n,"H2",{class:!0});var Br=a(mt);It=s(Br,"A",{id:!0,class:!0,href:!0});var lu=a(It);Ys=s(lu,"SPAN",{});var cu=a(Ys);v(bn.$$.fragment,cu),cu.forEach(t),lu.forEach(t),vd=l(Br),Ks=s(Br,"SPAN",{});var pu=a(Ks);Td=i(pu,"Multilingual Models"),pu.forEach(t),Br.forEach(t),ar=l(n),Pe=s(n,"UL",{});var an=a(Pe);xn=s(an,"LI",{});var Vr=a(xn);Md=i(Vr,"All model names use the following format: "),Zs=s(Vr,"CODE",{});var hu=a(Zs);yd=i(hu,"Helsinki-NLP/opus-mt-{src}-{tgt}"),hu.forEach(t),bd=i(Vr,":"),Vr.forEach(t),xd=l(an),wn=s(an,"LI",{});var Gr=a(wn);wd=i(Gr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
group:`),Mu.forEach(t),hr=l(n),v(Nn.$$.fragment,n),ur=l(n),ns=s(n,"P",{});var yu=a(ns);Wd=i(yu,"Example of translating english to many romance languages, using old-style 2 character language codes"),yu.forEach(t),mr=l(n),v(Cn.$$.fragment,n),fr=l(n),_t=s(n,"H2",{class:!0});var Xr=a(_t);Ot=s(Xr,"A",{id:!0,class:!0,href:!0});var bu=a(Ot);na=s(bu,"SPAN",{});var xu=a(na);v(Ln.$$.fragment,xu),xu.forEach(t),bu.forEach(t),Rd=l(Xr),oa=s(Xr,"SPAN",{});var wu=a(oa);Bd=i(wu,"MarianConfig"),wu.forEach(t),Xr.forEach(t),_r=l(n),le=s(n,"DIV",{class:!0});var Ke=a(le);v(In.$$.fragment,Ke),Vd=l(Ke),gt=s(Ke,"P",{});var ys=a(gt);Gd=i(ys,"This is the configuration class to store the configuration of a "),os=s(ys,"A",{href:!0});var zu=a(os);Jd=i(zu,"MarianModel"),zu.forEach(t),Yd=i(ys,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
...
models are listed `),$o=s(ki,"A",{href:!0,rel:!0});var Tm=a($o);cp=i(Tm,"here"),Tm.forEach(t),pp=i(ki,"."),ki.forEach(t),hp=l(Ce),$a=s(Ce,"P",{});var Mm=a($a);up=i(Mm,"Examples:"),Mm.forEach(t),mp=l(Ce),v(jo.$$.fragment,Ce),Ce.forEach(t),et.forEach(t),qr=l(n),Et=s(n,"H2",{class:!0});var vi=a(Et);Qt=s(vi,"A",{id:!0,class:!0,href:!0});var ym=a(Qt);ja=s(ym,"SPAN",{});var bm=a(ja);v(qo.$$.fragment,bm),bm.forEach(t),ym.forEach(t),fp=l(vi),qa=s(vi,"SPAN",{});var xm=a(qa);_p=i(xm,"FlaxMarianModel"),xm.forEach(t),vi.forEach(t),Er=l(n),R=s(n,"DIV",{class:!0});var Le=a(R);v(Eo.$$.fragment,Le),gp=l(Le),Po=s(Le,"P",{});var Ti=a(Po);kp=i(Ti,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
