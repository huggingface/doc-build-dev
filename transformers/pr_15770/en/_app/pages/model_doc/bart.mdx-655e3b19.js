import{S as ZT,i as YT,s as e1,e as n,k as d,w as m,t as r,L as t1,c as a,d as t,m as l,a as s,x as f,h as i,b as c,J as e,g as u,y as _,q as g,o as k,B as b}from"../../chunks/vendor-9e2b328e.js";import{T as De}from"../../chunks/Tip-76f97a76.js";import{D as F}from"../../chunks/Docstring-50fd6873.js";import{C as P}from"../../chunks/CodeBlock-88e23343.js";import{I as J}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function o1(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("When used with "),y=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer will add a space before each word (even the first one).")},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"When used with "),y=a(v,"CODE",{});var B=s(y);w=i(B,"is_split_into_words=True"),B.forEach(t),x=i(v,", this tokenizer will add a space before each word (even the first one)."),v.forEach(t)},m(T,v){u(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function n1(j){let p,q,y,w,x,T,v,B;return{c(){p=n("p"),q=r("When used with "),y=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer needs to be instantiated with "),T=n("code"),v=r("add_prefix_space=True"),B=r(".")},l(ne){p=a(ne,"P",{});var A=s(p);q=i(A,"When used with "),y=a(A,"CODE",{});var $=s(y);w=i($,"is_split_into_words=True"),$.forEach(t),x=i(A,", this tokenizer needs to be instantiated with "),T=a(A,"CODE",{});var le=s(T);v=i(le,"add_prefix_space=True"),le.forEach(t),B=i(A,"."),A.forEach(t)},m(ne,A){u(ne,p,A),e(p,q),e(p,y),e(y,w),e(p,x),e(p,T),e(T,v),e(p,B)},d(ne){ne&&t(p)}}}function a1(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
...
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){u(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function r1(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){u(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function i1(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){u(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function c1(j){let p,q,y,w,x,T,v,B,ne,A,$,le,_e,Ke,ge,ke,Ze,Je,H,N,Le,ae,C,S,Ye,ce,pe,et,Q,tt,ot,D,Be,be,Xe,X,se,nt,at,V,st,ye,Ge;return{c(){p=n("p"),q=r("TF 2.0 models accepts two formats as inputs:"),y=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),v=d(),B=n("li"),ne=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),le=r("This second option is useful when using "),_e=n("code"),Ke=r("tf.keras.Model.fit"),ge=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ke=n("code"),Ze=r("model(inputs)"),Je=r("."),H=d(),N=n("p"),Le=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ae=d(),C=n("ul"),S=n("li"),Ye=r("a single Tensor with "),ce=n("code"),pe=r("input_ids"),et=r(" only and nothing else: "),Q=n("code"),tt=r("model(input_ids)"),ot=d(),D=n("li"),Be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),be=n("code"),Xe=r("model([input_ids, attention_mask])"),X=r(" or "),se=n("code"),nt=r("model([input_ids, attention_mask, token_type_ids])"),at=d(),V=n("li"),st=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=n("code"),Ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=a(z,"P",{});var M=s(p);q=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),y=l(z),w=a(z,"UL",{});var U=s(w);x=a(U,"LI",{});var St=s(x);T=i(St,"having all inputs as keyword arguments (like PyTorch models), or"),St.forEach(t),v=l(U),B=a(U,"LI",{});var We=s(B);ne=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),U.forEach(t),A=l(z),$=a(z,"P",{});var re=s($);le=i(re,"This second option is useful when using "),_e=a(re,"CODE",{});var It=s(_e);Ke=i(It,"tf.keras.Model.fit"),It.forEach(t),ge=i(re,` method which currently requires having all the
...
first positional argument :`),Ot.forEach(t),ae=l(z),C=a(z,"UL",{});var ie=s(C);S=a(ie,"LI",{});var he=s(S);Ye=i(he,"a single Tensor with "),ce=a(he,"CODE",{});var ve=s(ce);pe=i(ve,"input_ids"),ve.forEach(t),et=i(he," only and nothing else: "),Q=a(he,"CODE",{});var Fe=s(Q);tt=i(Fe,"model(input_ids)"),Fe.forEach(t),he.forEach(t),ot=l(ie),D=a(ie,"LI",{});var de=s(D);Be=i(de,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),be=a(de,"CODE",{});var Ue=s(be);Xe=i(Ue,"model([input_ids, attention_mask])"),Ue.forEach(t),X=i(de," or "),se=a(de,"CODE",{});var Nt=s(se);nt=i(Nt,"model([input_ids, attention_mask, token_type_ids])"),Nt.forEach(t),de.forEach(t),at=l(ie),V=a(ie,"LI",{});var He=s(V);st=i(He,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a(He,"CODE",{});var Dt=s(ye);Ge=i(Dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Dt.forEach(t),He.forEach(t),ie.forEach(t)},m(z,M){u(z,p,M),e(p,q),u(z,y,M),u(z,w,M),e(w,x),e(x,T),e(w,v),e(w,B),e(B,ne),u(z,A,M),u(z,$,M),e($,le),e($,_e),e(_e,Ke),e($,ge),e($,ke),e(ke,Ze),e($,Je),u(z,H,M),u(z,N,M),e(N,Le),u(z,ae,M),u(z,C,M),e(C,S),e(S,Ye),e(S,ce),e(ce,pe),e(S,et),e(S,Q),e(Q,tt),e(C,ot),e(C,D),e(D,Be),e(D,be),e(be,Xe),e(D,X),e(D,se),e(se,nt),e(C,at),e(C,V),e(V,st),e(V,ye),e(ye,Ge)},d(z){z&&t(p),z&&t(y),z&&t(w),z&&t(A),z&&t($),z&&t(H),z&&t(N),z&&t(ae),z&&t(C)}}}function p1(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){u(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function m1(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){u(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function f1(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){u(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function _1(j){let p,q,y,w,x,T,v,B,ne,A,$,le,_e,Ke,ge,ke,Ze,Je,H,N,Le,ae,C,S,Ye,ce,pe,et,Q,tt,ot,D,Be,be,Xe,X,se,nt,at,V,st,ye,Ge,z,M,U,St,We,re,It,Re,Ot,ie,he,ve,Fe,de,Ue,Nt,He,Dt,vl,ht,un,Zc,mn,Yc,ep,tp,rt,op,Vs,np,ap,ei,sp,rp,fn,ip,dp,lp,To,_n,cp,pp,gn,hp,up,Tl,Lt,wo,ti,kn,mp,oi,fp,wl,$e,it,_p,ni,gp,kp,Js,bp,yp,Xs,vp,Tp,wp,Gt,xp,Ks,zp,qp,ai,Bp,Fp,$p,Wt,jp,si,Mp,Ep,ri,Pp,Cp,Ap,Zs,Ys,Sp,Ip,Op,Rt,Np,ii,Dp,Lp,di,Gp,Wp,xl,Ut,xo,li,bn,Rp,ci,Up,zl,ut,Hp,pi,Qp,Vp,hi,Jp,Xp,ql,yn,Bl,Ht,zo,ui,vn,Kp,mi,Zp,Fl,Te,Tn,Yp,Qt,eh,er,th,oh,wn,nh,ah,sh,Vt,rh,tr,ih,dh,or,lh,ch,ph,fi,hh,uh,xn,$l,Jt,qo,_i,zn,mh,gi,fh,jl,E,qn,_h,ki,gh,kh,bi,bh,yh,Bn,vh,Fn,Th,yi,wh,xh,zh,Bo,qh,$n,Bh,nr,Fh,$h,jh,mt,jn,Mh,vi,Eh,Ph,Mn,ar,Ch,Ti,Ah,Sh,sr,Ih,wi,Oh,Nh,Fo,En,Dh,xi,Lh,Gh,$o,Pn,Wh,zi,Rh,Uh,jo,Cn,Hh,An,Qh,qi,Vh,Jh,Ml,Xt,Mo,Bi,Sn,Xh,Fi,Kh,El,G,In,Zh,On,Yh,$i,eu,tu,ou,ji,nu,au,Nn,su,Dn,ru,Mi,iu,du,lu,Eo,cu,Ln,pu,rr,hu,uu,mu,Po,Gn,fu,Ei,_u,Pl,Kt,Co,Pi,Wn,gu,Ci,ku,Cl,Qe,Rn,bu,Un,yu,ir,vu,Tu,wu,Hn,xu,Qn,zu,qu,Bu,je,Vn,Fu,Zt,$u,dr,ju,Mu,Ai,Eu,Pu,Cu,Ao,Au,Si,Su,Iu,Jn,Al,Yt,So,Ii,Xn,Ou,Oi,Nu,Sl,Ve,Kn,Du,Zn,Lu,lr,Gu,Wu,Ru,Yn,Uu,ea,Hu,Qu,Vu,K,ta,Ju,eo,Xu,cr,Ku,Zu,Ni,Yu,em,tm,Io,om,Di,nm,am,oa,sm,Li,rm,im,na,Il,to,Oo,Gi,aa,dm,Wi,lm,Ol,we,sa,cm,Ri,pm,hm,ra,um,pr,mm,fm,_m,ia,gm,da,km,bm,ym,Z,la,vm,oo,Tm,hr,wm,xm,Ui,zm,qm,Bm,No,Fm,Hi,$m,jm,ca,Mm,Qi,Em,Pm,pa,Nl,no,Do,Vi,ha,Cm,Ji,Am,Dl,xe,ua,Sm,ao,Im,Xi,Om,Nm,Ki,Dm,Lm,Gm,ma,Wm,ur,Rm,Um,Hm,fa,Qm,_a,Vm,Jm,Xm,Me,ga,Km,so,Zm,mr,Ym,ef,Zi,tf,of,nf,Lo,af,Yi,sf,rf,ka,Ll,ro,Go,ed,ba,df,td,lf,Gl,io,ya,cf,ft,va,pf,od,hf,uf,Ta,Wl,lo,Wo,nd,wa,mf,ad,ff,Rl,ze,xa,_f,za,gf,fr,kf,bf,yf,qa,vf,Ba,Tf,wf,xf,Ro,zf,Ee,Fa,qf,co,Bf,_r,Ff,$f,sd,jf,Mf,Ef,Uo,Pf,rd,Cf,Af,$a,Ul,po,Ho,id,ja,Sf,dd,If,Hl,qe,Ma,Of,Ea,Nf,gr,Df,Lf,Gf,Pa,Wf,Ca,Rf,Uf,Hf,Qo,Qf,Y,Aa,Vf,ho,Jf,kr,Xf,Kf,ld,Zf,Yf,e_,Vo,t_,cd,o_,n_,Sa,a_,pd,s_,r_,Ia,Ql,uo,Jo,hd,Oa,i_,ud,d_,Vl,W,Na,l_,Da,c_,br,p_,h_,u_,La,m_,Ga,f_,__,g_,md,k_,b_,dt,fd,Wa,y_,v_,_d,Ra,T_,w_,gd,Ua,x_,z_,kd,Ha,q_,B_,Pe,Qa,F_,mo,$_,bd,j_,M_,yd,E_,P_,C_,Xo,A_,vd,S_,I_,Va,O_,_t,Ja,N_,Td,D_,L_,Xa,G_,gt,Ka,W_,wd,R_,U_,Za,Jl,fo,Ko,xd,Ya,H_,zd,Q_,Xl,R,es,V_,ts,J_,yr,X_,K_,Z_,os,Y_,ns,eg,tg,og,qd,ng,ag,lt,Bd,as,sg,rg,Fd,ss,ig,dg,$d,rs,lg,cg,jd,is,pg,hg,ee,ds,ug,_o,mg,Md,fg,_g,Ed,gg,kg,bg,Zo,yg,Pd,vg,Tg,ls,wg,Cd,xg,zg,cs,qg,kt,ps,Bg,Ad,Fg,$g,hs,jg,bt,us,Mg,Sd,Eg,Pg,ms,Kl,go,Yo,Id,fs,Cg,Od,Ag,Zl,I,_s,Sg,Nd,Ig,Og,gs,Ng,vr,Dg,Lg,Gg,ks,Wg,bs,Rg,Ug,Hg,Dd,Qg,Vg,ct,Ld,ys,Jg,Xg,Gd,vs,Kg,Zg,Wd,Ts,Yg,ek,Rd,ws,tk,ok,Ce,xs,nk,ko,ak,Ud,sk,rk,Hd,ik,dk,lk,en,ck,Qd,pk,hk,zs,uk,yt,qs,mk,Vd,fk,_k,Bs,gk,vt,Fs,kk,Jd,bk,yk,$s,Yl,bo,tn,Xd,js,vk,Kd,Tk,ec,O,Ms,wk,yo,xk,Zd,zk,qk,Yd,Bk,Fk,$k,Es,jk,Tr,Mk,Ek,Pk,Ps,Ck,Cs,Ak,Sk,Ik,el,Ok,Nk,pt,tl,As,Dk,Lk,ol,Ss,Gk,Wk,nl,Is,Rk,Uk,al,Os,Hk,Qk,Ae,Ns,Vk,vo,Jk,sl,Xk,Kk,rl,Zk,Yk,eb,on,tb,il,ob,nb,Ds,ab,Tt,Ls,sb,dl,rb,ib,Gs,db,wt,Ws,lb,ll,cb,pb,Rs,tc;return T=new J({}),ae=new J({}),Ue=new J({}),kn=new J({}),bn=new J({}),yn=new P({props:{code:`from transformers import BartForConditionalGeneration, BartTokenizer
...
of up to 6 ROUGE.`),M=d(),U=n("p"),St=r("This model was contributed by "),We=n("a"),re=r("sshleifer"),It=r(". The Authors\u2019 code can be found "),Re=n("a"),Ot=r("here"),ie=r("."),he=d(),ve=n("h3"),Fe=n("a"),de=n("span"),m(Ue.$$.fragment),Nt=d(),He=n("span"),Dt=r("Examples"),vl=d(),ht=n("ul"),un=n("li"),Zc=r(`Examples and scripts for fine-tuning BART and other models for sequence to sequence tasks can be found in
...
`),Xs=n("a"),vp=r("encode()"),Tp=r(" to get the proper splitting."),wp=d(),Gt=n("li"),xp=r("The forward pass of "),Ks=n("a"),zp=r("BartModel"),qp=r(" will create the "),ai=n("code"),Bp=r("decoder_input_ids"),Fp=r(` if they are not passed.
...
mask-filling tasks.`),xl=d(),Ut=n("h2"),xo=n("a"),li=n("span"),m(bn.$$.fragment),Rp=d(),ci=n("span"),Up=r("Mask Filling"),zl=d(),ut=n("p"),Hp=r("The "),pi=n("code"),Qp=r("facebook/bart-base"),Vp=r(" and "),hi=n("code"),Jp=r("facebook/bart-large"),Xp=r(" checkpoints can be used to fill multi-token masks."),ql=d(),m(yn.$$.fragment),Bl=d(),Ht=n("h2"),zo=n("a"),ui=n("span"),m(vn.$$.fragment),Kp=d(),mi=n("span"),Zp=r("BartConfig"),Fl=d(),Te=n("div"),m(Tn.$$.fragment),Yp=d(),Qt=n("p"),eh=r("This is the configuration class to store the configuration of a "),er=n("a"),th=r("BartModel"),oh=r(`. It is used to instantiate a BART
...
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),yh=d(),m(Bn.$$.fragment),vh=d(),Fn=n("p"),Th=r("You can get around that behavior by passing "),yi=n("code"),wh=r("add_prefix_space=True"),xh=r(` when instantiating this tokenizer or when you
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ym=d(),Z=n("div"),m(la.$$.fragment),vm=d(),oo=n("p"),Tm=r("The "),hr=n("a"),wm=r("BartForSequenceClassification"),xm=r(" forward method, overrides the "),Ui=n("code"),zm=r("__call__"),qm=r(" special method."),Bm=d(),m(No.$$.fragment),Fm=d(),Hi=n("p"),$m=r("Example of single-label classification:"),jm=d(),m(ca.$$.fragment),Mm=d(),Qi=n("p"),Em=r("Example of multi-label classification:"),Pm=d(),m(pa.$$.fragment),Nl=d(),no=n("h2"),Do=n("a"),Vi=n("span"),m(ha.$$.fragment),Cm=d(),Ji=n("span"),Am=r("BartForQuestionAnswering"),Dl=d(),xe=n("div"),m(ua.$$.fragment),Sm=d(),ao=n("p"),Im=r(`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yf=d(),qa=n("p"),vf=r("This model is also a "),Ba=n("a"),Tf=r("tf.keras.Model"),wf=r(` subclass. Use it
...
tasks.`),Og=d(),gs=n("p"),Ng=r("This model inherits from "),vr=n("a"),Dg=r("FlaxPreTrainedModel"),Lg=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gg=d(),ks=n("p"),Wg=r(`This model is also a Flax Linen
`),bs=n("a"),Rg=r("flax.nn.Module"),Ug=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Hg=d(),Dd=n("p"),Qg=r("Finally, this model supports inherent JAX features such as:"),Vg=d(),ct=n("ul"),Ld=n("li"),ys=n("a"),Jg=r("Just-In-Time (JIT) compilation"),Xg=d(),Gd=n("li"),vs=n("a"),Kg=r("Automatic Differentiation"),Zg=d(),Wd=n("li"),Ts=n("a"),Yg=r("Vectorization"),ek=d(),Rd=n("li"),ws=n("a"),tk=r("Parallelization"),ok=d(),Ce=n("div"),m(xs.$$.fragment),nk=d(),ko=n("p"),ak=r("The "),Ud=n("code"),sk=r("FlaxBartPreTrainedModel"),rk=r("forward method, overrides the "),Hd=n("code"),ik=r("__call__"),dk=r(" special method."),lk=d(),m(en.$$.fragment),ck=d(),Qd=n("p"),pk=r("Example:"),hk=d(),m(zs.$$.fragment),uk=d(),yt=n("div"),m(qs.$$.fragment),mk=d(),Vd=n("p"),fk=r("Example:"),_k=d(),m(Bs.$$.fragment),gk=d(),vt=n("div"),m(Fs.$$.fragment),kk=d(),Jd=n("p"),bk=r("Example:"),yk=d(),m($s.$$.fragment),Yl=d(),bo=n("h2"),tn=n("a"),Xd=n("span"),m(js.$$.fragment),vk=d(),Kd=n("span"),Tk=r("FlaxBartForQuestionAnswering"),ec=d(),O=n("div"),m(Ms.$$.fragment),wk=d(),yo=n("p"),xk=r(`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
`),si=a(Br,"CODE",{});var Ib=s(si);Mp=i(Ib,"force_bos_token_to_be_generated=True"),Ib.forEach(t),Ep=i(Br,`. This only works, however, if the string you pass to
...
documentation from `),or=a(Mr,"A",{href:!0});var Yb=s(or);lh=i(Yb,"PretrainedConfig"),Yb.forEach(t),ch=i(Mr," for more information."),Mr.forEach(t),ph=l(zt),fi=a(zt,"P",{});var ey=s(fi);hh=i(ey,"Example:"),ey.forEach(t),uh=l(zt),f(xn.$$.fragment,zt),zt.forEach(t),$l=l(o),Jt=a(o,"H2",{class:!0});var ic=s(Jt);qo=a(ic,"A",{id:!0,class:!0,href:!0});var ty=s(qo);_i=a(ty,"SPAN",{});var oy=s(_i);f(zn.$$.fragment,oy),oy.forEach(t),ty.forEach(t),mh=l(ic),gi=a(ic,"SPAN",{});var ny=s(gi);fh=i(ny,"BartTokenizer"),ny.forEach(t),ic.forEach(t),jl=l(o),E=a(o,"DIV",{class:!0});var L=s(E);f(qn.$$.fragment,L),_h=l(L),ki=a(L,"P",{});var ay=s(ki);gh=i(ay,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),ay.forEach(t),kh=l(L),bi=a(L,"P",{});var sy=s(bi);bh=i(sy,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),sy.forEach(t),yh=l(L),f(Bn.$$.fragment,L),vh=l(L),Fn=a(L,"P",{});var dc=s(Fn);Th=i(dc,"You can get around that behavior by passing "),yi=a(dc,"CODE",{});var ry=s(yi);wh=i(ry,"add_prefix_space=True"),ry.forEach(t),xh=i(dc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),dc.forEach(t),zh=l(L),f(Bo.$$.fragment,L),qh=l(L),$n=a(L,"P",{});var lc=s($n);Bh=i(lc,"This tokenizer inherits from "),nr=a(lc,"A",{href:!0});var iy=s(nr);Fh=i(iy,"PreTrainedTokenizer"),iy.forEach(t),$h=i(lc,` which contains most of the main methods. Users should refer to
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vc.forEach(t),wu=l(rn),Hn=a(rn,"P",{});var Tc=s(Hn);xu=i(Tc,"This model is also a PyTorch "),Qn=a(Tc,"A",{href:!0,rel:!0});var qy=s(Qn);zu=i(qy,"torch.nn.Module"),qy.forEach(t),qu=i(Tc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc.forEach(t),Bu=l(rn),je=a(rn,"DIV",{class:!0});var qt=s(je);f(Vn.$$.fragment,qt),Fu=l(qt),Zt=a(qt,"P",{});var Pr=s(Zt);$u=i(Pr,"The "),dr=a(Pr,"A",{href:!0});var By=s(dr);ju=i(By,"BartModel"),By.forEach(t),Mu=i(Pr," forward method, overrides the "),Ai=a(Pr,"CODE",{});var Fy=s(Ai);Eu=i(Fy,"__call__"),Fy.forEach(t),Pu=i(Pr," special method."),Pr.forEach(t),Cu=l(qt),f(Ao.$$.fragment,qt),Au=l(qt),Si=a(qt,"P",{});var $y=s(Si);Su=i($y,"Example:"),$y.forEach(t),Iu=l(qt),f(Jn.$$.fragment,qt),qt.forEach(t),rn.forEach(t),Al=l(o),Yt=a(o,"H2",{class:!0});var wc=s(Yt);So=a(wc,"A",{id:!0,class:!0,href:!0});var jy=s(So);Ii=a(jy,"SPAN",{});var My=s(Ii);f(Xn.$$.fragment,My),My.forEach(t),jy.forEach(t),Ou=l(wc),Oi=a(wc,"SPAN",{});var Ey=s(Oi);Nu=i(Ey,"BartForConditionalGeneration"),Ey.forEach(t),wc.forEach(t),Sl=l(o),Ve=a(o,"DIV",{class:!0});var dn=s(Ve);f(Kn.$$.fragment,dn),Du=l(dn),Zn=a(dn,"P",{});var xc=s(Zn);Lu=i(xc,`The BART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zc.forEach(t),Vu=l(dn),K=a(dn,"DIV",{class:!0});var Se=s(K);f(ta.$$.fragment,Se),Ju=l(Se),eo=a(Se,"P",{});var Cr=s(eo);Xu=i(Cr,"The "),cr=a(Cr,"A",{href:!0});var Ay=s(cr);Ku=i(Ay,"BartForConditionalGeneration"),Ay.forEach(t),Zu=i(Cr," forward method, overrides the "),Ni=a(Cr,"CODE",{});var Sy=s(Ni);Yu=i(Sy,"__call__"),Sy.forEach(t),em=i(Cr," special method."),Cr.forEach(t),tm=l(Se),f(Io.$$.fragment,Se),om=l(Se),Di=a(Se,"P",{});var Iy=s(Di);nm=i(Iy,"Summarization example:"),Iy.forEach(t),am=l(Se),f(oa.$$.fragment,Se),sm=l(Se),Li=a(Se,"P",{});var Oy=s(Li);rm=i(Oy,"Mask filling example:"),Oy.forEach(t),im=l(Se),f(na.$$.fragment,Se),Se.forEach(t),dn.forEach(t),Il=l(o),to=a(o,"H2",{class:!0});var qc=s(to);Oo=a(qc,"A",{id:!0,class:!0,href:!0});var Ny=s(Oo);Gi=a(Ny,"SPAN",{});var Dy=s(Gi);f(aa.$$.fragment,Dy),Dy.forEach(t),Ny.forEach(t),dm=l(qc),Wi=a(qc,"SPAN",{});var Ly=s(Wi);lm=i(Ly,"BartForSequenceClassification"),Ly.forEach(t),qc.forEach(t),Ol=l(o),we=a(o,"DIV",{class:!0});var Bt=s(we);f(sa.$$.fragment,Bt),cm=l(Bt),Ri=a(Bt,"P",{});var Gy=s(Ri);pm=i(Gy,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Gy.forEach(t),hm=l(Bt),ra=a(Bt,"P",{});var Bc=s(ra);um=i(Bc,"This model inherits from "),pr=a(Bc,"A",{href:!0});var Wy=s(pr);mm=i(Wy,"PreTrainedModel"),Wy.forEach(t),fm=i(Bc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bc.forEach(t),_m=l(Bt),ia=a(Bt,"P",{});var Fc=s(ia);gm=i(Fc,"This model is also a PyTorch "),da=a(Fc,"A",{href:!0,rel:!0});var Ry=s(da);km=i(Ry,"torch.nn.Module"),Ry.forEach(t),bm=i(Fc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fc.forEach(t),ym=l(Bt),Z=a(Bt,"DIV",{class:!0});var Ie=s(Z);f(la.$$.fragment,Ie),vm=l(Ie),oo=a(Ie,"P",{});var Ar=s(oo);Tm=i(Ar,"The "),hr=a(Ar,"A",{href:!0});var Uy=s(hr);wm=i(Uy,"BartForSequenceClassification"),Uy.forEach(t),xm=i(Ar," forward method, overrides the "),Ui=a(Ar,"CODE",{});var Hy=s(Ui);zm=i(Hy,"__call__"),Hy.forEach(t),qm=i(Ar," special method."),Ar.forEach(t),Bm=l(Ie),f(No.$$.fragment,Ie),Fm=l(Ie),Hi=a(Ie,"P",{});var Qy=s(Hi);$m=i(Qy,"Example of single-label classification:"),Qy.forEach(t),jm=l(Ie),f(ca.$$.fragment,Ie),Mm=l(Ie),Qi=a(Ie,"P",{});var Vy=s(Qi);Em=i(Vy,"Example of multi-label classification:"),Vy.forEach(t),Pm=l(Ie),f(pa.$$.fragment,Ie),Ie.forEach(t),Bt.forEach(t),Nl=l(o),no=a(o,"H2",{class:!0});var $c=s(no);Do=a($c,"A",{id:!0,class:!0,href:!0});var Jy=s(Do);Vi=a(Jy,"SPAN",{});var Xy=s(Vi);f(ha.$$.fragment,Xy),Xy.forEach(t),Jy.forEach(t),Cm=l($c),Ji=a($c,"SPAN",{});var Ky=s(Ji);Am=i(Ky,"BartForQuestionAnswering"),Ky.forEach(t),$c.forEach(t),Dl=l(o),xe=a(o,"DIV",{class:!0});var Ft=s(xe);f(ua.$$.fragment,Ft),Sm=l(Ft),ao=a(Ft,"P",{});var Sr=s(ao);Im=i(Sr,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Xi=a(Sr,"CODE",{});var Zy=s(Xi);Om=i(Zy,"span start logits"),Zy.forEach(t),Nm=i(Sr," and "),Ki=a(Sr,"CODE",{});var Yy=s(Ki);Dm=i(Yy,"span end logits"),Yy.forEach(t),Lm=i(Sr,")."),Sr.forEach(t),Gm=l(Ft),ma=a(Ft,"P",{});var jc=s(ma);Wm=i(jc,"This model inherits from "),ur=a(jc,"A",{href:!0});var ev=s(ur);Rm=i(ev,"PreTrainedModel"),ev.forEach(t),Um=i(jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mc.forEach(t),Xm=l(Ft),Me=a(Ft,"DIV",{class:!0});var $t=s(Me);f(ga.$$.fragment,$t),Km=l($t),so=a($t,"P",{});var Ir=s(so);Zm=i(Ir,"The "),mr=a(Ir,"A",{href:!0});var ov=s(mr);Ym=i(ov,"BartForQuestionAnswering"),ov.forEach(t),ef=i(Ir," forward method, overrides the "),Zi=a(Ir,"CODE",{});var nv=s(Zi);tf=i(nv,"__call__"),nv.forEach(t),of=i(Ir," special method."),Ir.forEach(t),nf=l($t),f(Lo.$$.fragment,$t),af=l($t),Yi=a($t,"P",{});var av=s(Yi);sf=i(av,"Example:"),av.forEach(t),rf=l($t),f(ka.$$.fragment,$t),$t.forEach(t),Ft.forEach(t),Ll=l(o),ro=a(o,"H2",{class:!0});var Ec=s(ro);Go=a(Ec,"A",{id:!0,class:!0,href:!0});var sv=s(Go);ed=a(sv,"SPAN",{});var rv=s(ed);f(ba.$$.fragment,rv),rv.forEach(t),sv.forEach(t),df=l(Ec),td=a(Ec,"SPAN",{});var iv=s(td);lf=i(iv,"BartForCausalLM"),iv.forEach(t),Ec.forEach(t),Gl=l(o),io=a(o,"DIV",{class:!0});var Pc=s(io);f(ya.$$.fragment,Pc),cf=l(Pc),ft=a(Pc,"DIV",{class:!0});var Or=s(ft);f(va.$$.fragment,Or),pf=l(Or),od=a(Or,"P",{});var dv=s(od);hf=i(dv,"Example:"),dv.forEach(t),uf=l(Or),f(Ta.$$.fragment,Or),Or.forEach(t),Pc.forEach(t),Wl=l(o),lo=a(o,"H2",{class:!0});var Cc=s(lo);Wo=a(Cc,"A",{id:!0,class:!0,href:!0});var lv=s(Wo);nd=a(lv,"SPAN",{});var cv=s(nd);f(wa.$$.fragment,cv),cv.forEach(t),lv.forEach(t),mf=l(Cc),ad=a(Cc,"SPAN",{});var pv=s(ad);ff=i(pv,"TFBartModel"),pv.forEach(t),Cc.forEach(t),Rl=l(o),ze=a(o,"DIV",{class:!0});var jt=s(ze);f(xa.$$.fragment,jt),_f=l(jt),za=a(jt,"P",{});var Ac=s(za);gf=i(Ac,`The bare BART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),yf=l(jt),qa=a(jt,"P",{});var Sc=s(qa);vf=i(Sc,"This model is also a "),Ba=a(Sc,"A",{href:!0,rel:!0});var uv=s(Ba);Tf=i(uv,"tf.keras.Model"),uv.forEach(t),wf=i(Sc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sc.forEach(t),xf=l(jt),f(Ro.$$.fragment,jt),zf=l(jt),Ee=a(jt,"DIV",{class:!0});var Mt=s(Ee);f(Fa.$$.fragment,Mt),qf=l(Mt),co=a(Mt,"P",{});var Nr=s(co);Bf=i(Nr,"The "),_r=a(Nr,"A",{href:!0});var mv=s(_r);Ff=i(mv,"TFBartModel"),mv.forEach(t),$f=i(Nr," forward method, overrides the "),sd=a(Nr,"CODE",{});var fv=s(sd);jf=i(fv,"__call__"),fv.forEach(t),Mf=i(Nr," special method."),Nr.forEach(t),Ef=l(Mt),f(Uo.$$.fragment,Mt),Pf=l(Mt),rd=a(Mt,"P",{});var _v=s(rd);Cf=i(_v,"Example:"),_v.forEach(t),Af=l(Mt),f($a.$$.fragment,Mt),Mt.forEach(t),jt.forEach(t),Ul=l(o),po=a(o,"H2",{class:!0});var Ic=s(po);Ho=a(Ic,"A",{id:!0,class:!0,href:!0});var gv=s(Ho);id=a(gv,"SPAN",{});var kv=s(id);f(ja.$$.fragment,kv),kv.forEach(t),gv.forEach(t),Sf=l(Ic),dd=a(Ic,"SPAN",{});var bv=s(dd);If=i(bv,"TFBartForConditionalGeneration"),bv.forEach(t),Ic.forEach(t),Hl=l(o),qe=a(o,"DIV",{class:!0});var Et=s(qe);f(Ma.$$.fragment,Et),Of=l(Et),Ea=a(Et,"P",{});var Oc=s(Ea);Nf=i(Oc,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),gr=a(Oc,"A",{href:!0});var yv=s(gr);Df=i(yv,"TFPreTrainedModel"),yv.forEach(t),Lf=i(Oc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Oc.forEach(t),Gf=l(Et),Pa=a(Et,"P",{});var Nc=s(Pa);Wf=i(Nc,"This model is also a "),Ca=a(Nc,"A",{href:!0,rel:!0});var vv=s(Ca);Rf=i(vv,"tf.keras.Model"),vv.forEach(t),Uf=i(Nc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nc.forEach(t),Hf=l(Et),f(Qo.$$.fragment,Et),Qf=l(Et),Y=a(Et,"DIV",{class:!0});var Oe=s(Y);f(Aa.$$.fragment,Oe),Vf=l(Oe),ho=a(Oe,"P",{});var Dr=s(ho);Jf=i(Dr,"The "),kr=a(Dr,"A",{href:!0});var Tv=s(kr);Xf=i(Tv,"TFBartForConditionalGeneration"),Tv.forEach(t),Kf=i(Dr," forward method, overrides the "),ld=a(Dr,"CODE",{});var wv=s(ld);Zf=i(wv,"__call__"),wv.forEach(t),Yf=i(Dr," special method."),Dr.forEach(t),e_=l(Oe),f(Vo.$$.fragment,Oe),t_=l(Oe),cd=a(Oe,"P",{});var xv=s(cd);o_=i(xv,"Summarization example:"),xv.forEach(t),n_=l(Oe),f(Sa.$$.fragment,Oe),a_=l(Oe),pd=a(Oe,"P",{});var zv=s(pd);s_=i(zv,"Mask filling example:"),zv.forEach(t),r_=l(Oe),f(Ia.$$.fragment,Oe),Oe.forEach(t),Et.forEach(t),Ql=l(o),uo=a(o,"H2",{class:!0});var Dc=s(uo);Jo=a(Dc,"A",{id:!0,class:!0,href:!0});var qv=s(Jo);hd=a(qv,"SPAN",{});var Bv=s(hd);f(Oa.$$.fragment,Bv),Bv.forEach(t),qv.forEach(t),i_=l(Dc),ud=a(Dc,"SPAN",{});var Fv=s(ud);d_=i(Fv,"FlaxBartModel"),Fv.forEach(t),Dc.forEach(t),Vl=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Na.$$.fragment,me),l_=l(me),Da=a(me,"P",{});var Lc=s(Da);c_=i(Lc,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
