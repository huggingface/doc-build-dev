...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15770/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[yw]},$$scope:{ctx:N}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/models/t5/modeling_tf_t5.py#L1355",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15770/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15770/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15770/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15770/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[$w]},$$scope:{ctx:N}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15770/src/transformers/models/t5/modeling_tf_t5.py#L1630",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kk=d(),f(Xn.$$.fragment),vk=d(),Ze=o("div"),f(ya.$$.fragment),bk=d(),Tn=o("p"),yk=r("The "),Ar=o("a"),wk=r("TFT5ForConditionalGeneration"),$k=r(" forward method, overrides the "),fl=o("code"),zk=r("__call__"),xk=r(" special method."),Ek=d(),f(Qn.$$.fragment),qk=d(),_l=o("p"),jk=r("Examples:"),Fk=d(),f(wa.$$.fragment),Lc=d(),kn=o("h2"),eo=o("a"),gl=o("span"),f($a.$$.fragment),Mk=d(),Tl=o("span"),Pk=r("TFT5EncoderModel"),Nc=d(),ce=o("div"),f(za.$$.fragment),Ck=d(),kl=o("p"),Ak=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Lk=d(),xa=o("p"),Nk=r("The T5 model was proposed in "),Ea=o("a"),Ik=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Dk=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Sk=d(),qa=o("p"),Ok=r("This model inherits from "),Lr=o("a"),Gk=r("TFPreTrainedModel"),Bk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uk=d(),ja=o("p"),Wk=r("This model is also a "),Fa=o("a"),Rk=r("tf.keras.Model"),Hk=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vk=d(),f(to.$$.fragment),Kk=d(),Xe=o("div"),f(Ma.$$.fragment),Yk=d(),vn=o("p"),Jk=r("The "),Nr=o("a"),Zk=r("TFT5EncoderModel"),Xk=r(" forward method, overrides the "),vl=o("code"),Qk=r("__call__"),ev=r(" special method."),tv=d(),f(no.$$.fragment),nv=d(),bl=o("p"),ov=r("Examples:"),sv=d(),f(Pa.$$.fragment),Ic=d(),bn=o("h2"),oo=o("a"),yl=o("span"),f(Ca.$$.fragment),av=d(),wl=o("span"),rv=r("FlaxT5Model"),Dc=d(),lt=o("div"),f(Aa.$$.fragment),iv=d(),Qe=o("div"),f(La.$$.fragment),dv=d(),yn=o("p"),lv=r("The "),$l=o("code"),cv=r("FlaxT5PreTrainedModel"),pv=r("forward method, overrides the "),zl=o("code"),hv=r("__call__"),uv=r(" special method."),mv=d(),f(so.$$.fragment),fv=d(),xl=o("p"),_v=r("Example:"),gv=d(),f(Na.$$.fragment),Tv=d(),Mt=o("div"),f(Ia.$$.fragment),kv=d(),El=o("p"),vv=r("Example:"),bv=d(),f(Da.$$.fragment),yv=d(),Pt=o("div"),f(Sa.$$.fragment),wv=d(),ql=o("p"),$v=r("Example:"),zv=d(),f(Oa.$$.fragment),Sc=d(),wn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),xv=d(),Fl=o("span"),Ev=r("FlaxT5ForConditionalGeneration"),Oc=d(),ct=o("div"),f(Ba.$$.fragment),qv=d(),et=o("div"),f(Ua.$$.fragment),jv=d(),$n=o("p"),Fv=r("The "),Ml=o("code"),Mv=r("FlaxT5PreTrainedModel"),Pv=r("forward method, overrides the "),Pl=o("code"),Cv=r("__call__"),Av=r(" special method."),Lv=d(),f(ro.$$.fragment),Nv=d(),Cl=o("p"),Iv=r("Example:"),Dv=d(),f(Wa.$$.fragment),Sv=d(),Ct=o("div"),f(Ra.$$.fragment),Ov=d(),Al=o("p"),Gv=r("Example:"),Bv=d(),f(Ha.$$.fragment),Uv=d(),At=o("div"),f(Va.$$.fragment),Wv=d(),Ll=o("p"),Rv=r("Example:"),Hv=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_w('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),x=l(n),b=s(n,"H1",{class:!0});var Ya=a(b);w=s(Ya,"A",{id:!0,class:!0,href:!0});var Nl=a(w);z=s(Nl,"SPAN",{});var Il=a(z);_($.$$.fragment,Il),Il.forEach(t),Nl.forEach(t),y=l(Ya),E=s(Ya,"SPAN",{});var Dl=a(E);Ee=i(Dl,"T5"),Dl.forEach(t),Ya.forEach(t),oe=l(n),q=s(n,"H2",{class:!0});var Ja=a(q);ee=s(Ja,"A",{id:!0,class:!0,href:!0});var Sl=a(ee);O=s(Sl,"SPAN",{});var Ol=a(O);_(se.$$.fragment,Ol),Ol.forEach(t),Sl.forEach(t),qe=l(Ja),G=s(Ja,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Ja.forEach(t),ve=l(n),B=s(n,"P",{});var Za=a(B);I=i(Za,"The T5 model was presented in "),ae=s(Za,"A",{href:!0,rel:!0});var Bl=a(ae);pe=i(Bl,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Bl.forEach(t),F=i(Za,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),W=s(Dr,"EM",{});var o5=a(W);Ae=i(o5,"summarize: \u2026"),o5.forEach(t),m=i(Dr,"."),Dr.forEach(t),t5.forEach(t),j=l(Ir),te=s(Ir,"LI",{});var s5=a(te);Oe=s(s5,"P",{});var a5=a(Oe);pt=i(a5,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),a5.forEach(t),s5.forEach(t),S=l(Ir),Ge=s(Ir,"LI",{});var r5=a(Ge);ne=s(r5,"P",{});var io=a(ne);ht=i(io,"See the "),L=s(io,"A",{href:!0});var i5=a(L);Y=i(i5,"training"),i5.forEach(t),ut=i(io,", "),Le=s(io,"A",{href:!0});var d5=a(Le);J=i(d5,"inference"),d5.forEach(t),mt=i(io," and "),Ne=s(io,"A",{href:!0});var l5=a(Ne);Ie=i(l5,"scripts"),l5.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),r5.forEach(t),Ir.forEach(t),Vl=l(n),Xa=s(n,"P",{});var c5=a(Xa);Sp=i(c5,"T5 comes in different sizes:"),c5.forEach(t),Kl=l(n),Be=s(n,"UL",{});var Lt=a(Be);di=s(Lt,"LI",{});var p5=a(di);li=s(p5,"P",{});var h5=a(li);To=s(h5,"A",{href:!0,rel:!0});var u5=a(To);Op=i(u5,"t5-small"),u5.forEach(t),h5.forEach(t),p5.forEach(t),Gp=l(Lt),ci=s(Lt,"LI",{});var m5=a(ci);pi=s(m5,"P",{});var f5=a(pi);ko=s(f5,"A",{href:!0,rel:!0});var _5=a(ko);Bp=i(_5,"t5-base"),_5.forEach(t),f5.forEach(t),m5.forEach(t),Up=l(Lt),hi=s(Lt,"LI",{});var g5=a(hi);ui=s(g5,"P",{});var T5=a(ui);vo=s(T5,"A",{href:!0,rel:!0});var k5=a(vo);Wp=i(k5,"t5-large"),k5.forEach(t),T5.forEach(t),g5.forEach(t),Rp=l(Lt),mi=s(Lt,"LI",{});var v5=a(mi);fi=s(v5,"P",{});var b5=a(fi);bo=s(b5,"A",{href:!0,rel:!0});var y5=a(bo);Hp=i(y5,"t5-3b"),y5.forEach(t),b5.forEach(t),v5.forEach(t),Vp=l(Lt),_i=s(Lt,"LI",{});var w5=a(_i);Qa=s(w5,"P",{});var Vv=a(Qa);yo=s(Vv,"A",{href:!0,rel:!0});var $5=a(yo);Kp=i($5,"t5-11b"),$5.forEach(t),Yp=i(Vv,"."),Vv.forEach(t),w5.forEach(t),Lt.forEach(t),Yl=l(n),er=s(n,"P",{});var z5=a(er);Jp=i(z5,"Based on the original T5 model, Google has released some follow-up works:"),z5.forEach(t),Jl=l(n),xt=s(n,"UL",{});var Sr=a(xt);gi=s(Sr,"LI",{});var x5=a(gi);zn=s(x5,"P",{});var Wl=a(zn);Ti=s(Wl,"STRONG",{});var E5=a(Ti);Zp=i(E5,"T5v1.1"),E5.forEach(t),Xp=i(Wl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var A5=a(or);lh=i(A5,"here"),A5.forEach(t),ch=i(Hl,"."),Hl.forEach(t),P5.forEach(t),Sr.forEach(t),Zl=l(n),qn=s(n,"P",{});var Bc=a(qn);ph=i(Bc,"All checkpoints can be found on the "),wo=s(Bc,"A",{href:!0,rel:!0});var L5=a(wo);hh=i(L5,"hub"),L5.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),Et=s(n,"P",{});var Or=a(Et);mh=i(Or,"This model was contributed by "),$o=s(Or,"A",{href:!0,rel:!0});var N5=a($o);fh=i(N5,"thomwolf"),N5.forEach(t),_h=i(Or,". The original code can be found "),zo=s(Or,"A",{href:!0,rel:!0});var I5=a(zo);gh=i(I5,"here"),I5.forEach(t),Th=i(Or,"."),Or.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Jt=s(n,"H2",{class:!0});var Uc=a(Jt);jn=s(Uc,"A",{id:!0,class:!0,href:!0});var D5=a(jn);wi=s(D5,"SPAN",{});var S5=a(wi);_(xo.$$.fragment,S5),S5.forEach(t),D5.forEach(t),kh=l(Uc),$i=s(Uc,"SPAN",{});var O5=a($i);vh=i(O5,"Training"),O5.forEach(t),Uc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),Wc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var Nt=a(dt);qi=s(Nt,"P",{});var R5=a(qi);Mh=i(R5,"Unsupervised denoising training"),R5.forEach(t),Ph=l(Nt),_e=s(Nt,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var H5=a(ji);Ah=i(H5,"a.k.a"),H5.forEach(t),Lh=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=s(tt,"EM",{});var V5=a(Fi);Nh=i(V5,"real"),V5.forEach(t),Ih=i(tt,` masked tokens. Each
...
`),rr=s(tt,"A",{href:!0});var Z5=a(rr);Wh=i(Z5,"T5Tokenizer"),Z5.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(Nt),Ai=s(Nt,"P",{});var X5=a(Ai);Vh=i(X5,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),X5.forEach(t),Kh=l(Nt),_(Eo.$$.fragment,Nt),Yh=l(Nt),qo=s(Nt,"P",{});var Hc=a(qo);Jh=i(Hc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=s(Hc,"A",{href:!0,rel:!0});var Q5=a(jo);Zh=i(Q5,"run_t5_mlm_flax.py"),Q5.forEach(t),Xh=i(Hc,` script in the Examples
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ep.forEach(t),UT=l(at),_(Yn.$$.fragment,at),WT=l(at),Je=s(at,"DIV",{class:!0});var Rt=a(Je);_(ha.$$.fragment,Rt),RT=l(Rt),_n=s(Rt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Pr=s(Qr,"A",{href:!0});var qy=a(Pr);VT=i(qy,"TFT5Model"),qy.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var jy=a(cl);YT=i(jy,"__call__"),jy.forEach(t),JT=i(Qr," special method."),Qr.forEach(t),ZT=l(Rt),_(Jn.$$.fragment,Rt),XT=l(Rt),pl=s(Rt,"P",{});var Fy=a(pl);QT=i(Fy,"Examples:"),Fy.forEach(t),ek=l(Rt),_(ua.$$.fragment,Rt),Rt.forEach(t),at.forEach(t),Cc=l(n),gn=s(n,"H2",{class:!0});var qp=a(gn);Zn=s(qp,"A",{id:!0,class:!0,href:!0});var My=a(Zn);hl=s(My,"SPAN",{});var Py=a(hl);_(ma.$$.fragment,Py),Py.forEach(t),My.forEach(t),tk=l(qp),ul=s(qp,"SPAN",{});var Cy=a(ul);nk=i(Cy,"TFT5ForConditionalGeneration"),Cy.forEach(t),qp.forEach(t),Ac=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),ok=l(rt),_a=s(rt,"P",{});var jp=a(_a);sk=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var Ay=a(ml);ak=i(Ay,"language modeling"),Ay.forEach(t),rk=i(jp," head on top."),jp.forEach(t),ik=l(rt),ga=s(rt,"P",{});var Fp=a(ga);dk=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var Ly=a(Ta);lk=i(Ly,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ly.forEach(t),ck=i(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Fp.forEach(t),pk=l(rt),ka=s(rt,"P",{});var Mp=a(ka);hk=i(Mp,"This model inherits from "),Cr=s(Mp,"A",{href:!0});var Ny=a(Cr);uk=i(Ny,"TFPreTrainedModel"),Ny.forEach(t),mk=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
