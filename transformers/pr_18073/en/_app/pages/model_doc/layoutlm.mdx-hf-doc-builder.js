...
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/pr_18073/en/model_doc/layoutlm#transformers.LayoutLMModel">LayoutLMModel</a>.`,name:"vocab_size"},{anchor:"transformers.LayoutLMConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
If set to <code>True</code>, the model will return a <a href="/docs/transformers/pr_18073/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_layoutlm.py#L729",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18073/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18073/en/model_doc/layoutlm#transformers.LayoutLMConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_layoutlm.py#L870",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_layoutlm.py#L994",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18073/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_layoutlm.py#L1117"}}),Ln=new _e({props:{name:"forward",anchor:"transformers.LayoutLMForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18073/en/model_doc/layoutlm#transformers.LayoutLMTokenizer">LayoutLMTokenizer</a>. See <a href="/docs/transformers/pr_18073/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18073/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_layoutlm.py#L1131",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L910",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18073/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1032",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1155",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1285",returnDescription:`
<p>A <a
...
`),Io=a("a"),ki=n("microsoft/layoutlm-base-uncased"),Li=n(" architecture."),wi=c(),lt=a("p"),Ti=n("Configuration objects inherit from "),ns=a("a"),vi=n("BertConfig"),Mi=n(` and can be used to control the model outputs. Read the
...
behavior.`),pl=c(),Ae=a("div"),L(Zo.$$.fragment),ul=c(),ut=a("p"),hl=n("The "),ps=a("a"),ml=n("LayoutLMModel"),fl=n(" forward method, overrides the "),Zs=a("code"),gl=n("__call__"),_l=n(" special method."),yl=c(),L(Dt.$$.fragment),bl=c(),L(At.$$.fragment),Ja=c(),ht=a("h2"),Ut=a("a"),Gs=a("span"),L(Go.$$.fragment),kl=c(),Js=a("span"),Ll=n("LayoutLMForMaskedLM"),Qa=c(),Oe=a("div"),L(Jo.$$.fragment),wl=c(),mt=a("p"),Tl=n("LayoutLM Model with a "),Qs=a("code"),vl=n("language modeling"),Ml=n(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$d=c(),We=a("div"),L(Ln.$$.fragment),xd=c(),kt=a("p"),jd=n("The "),ms=a("a"),Fd=n("LayoutLMForTokenClassification"),zd=n(" forward method, overrides the "),ra=a("code"),Ed=n("__call__"),qd=n(" special method."),Cd=c(),L(Xt.$$.fragment),Pd=c(),L(Yt.$$.fragment),sr=c(),Lt=a("h2"),Zt=a("a"),ia=a("span"),L(wn.$$.fragment),Nd=c(),la=a("span"),Sd=n("TFLayoutLMModel"),ar=c(),Le=a("div"),L(Tn.$$.fragment),Id=c(),da=a("p"),Od=n("The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Dd=c(),vn=a("p"),Ad=n("This model inherits from "),fs=a("a"),Ud=n("TFPreTrainedModel"),Bd=n(`. Check the superclass documentation for the generic methods the
...
LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the LayoutLM
`),Io=r(Ms,"A",{href:!0,rel:!0});var Np=i(Io);ki=s(Np,"microsoft/layoutlm-base-uncased"),Np.forEach(t),Li=s(Ms," architecture."),Ms.forEach(t),wi=p(mo),lt=r(mo,"P",{});var $s=i(lt);Ti=s($s,"Configuration objects inherit from "),ns=r($s,"A",{href:!0});var Sp=i(ns);vi=s(Sp,"BertConfig"),Sp.forEach(t),Mi=s($s,` and can be used to control the model outputs. Read the
documentation from `),ss=r($s,"A",{href:!0});var Ip=i(ss);$i=s(Ip,"BertConfig"),Ip.forEach(t),xi=s($s," for more information."),$s.forEach(t),ji=p(mo),w(Ct.$$.fragment,mo),mo.forEach(t),Ka=p(o),dt=r(o,"H2",{class:!0});var mr=i(dt);Pt=r(mr,"A",{id:!0,class:!0,href:!0});var Op=i(Pt);Bs=r(Op,"SPAN",{});var Dp=i(Bs);w(Oo.$$.fragment,Dp),Dp.forEach(t),Op.forEach(t),Fi=p(mr),Ws=r(mr,"SPAN",{});var Ap=i(Ws);zi=s(Ap,"LayoutLMTokenizer"),Ap.forEach(t),mr.forEach(t),Va=p(o),Ne=r(o,"DIV",{class:!0});var fo=i(Ne);w(Do.$$.fragment,fo),Ei=p(fo),Hs=r(fo,"P",{});var Up=i(Hs);qi=s(Up,"Constructs a LayoutLM tokenizer."),Up.forEach(t),Ci=p(fo),Nt=r(fo,"P",{});var Ia=i(Nt);as=r(Ia,"A",{href:!0});var Bp=i(as);Pi=s(Bp,"LayoutLMTokenizer"),Bp.forEach(t),Ni=s(Ia," is identical to "),rs=r(Ia,"A",{href:!0});var Wp=i(rs);Si=s(Wp,"BertTokenizer"),Wp.forEach(t),Ii=s(Ia,` and runs end-to-end tokenization: punctuation splitting +
wordpiece.`),Ia.forEach(t),Oi=p(fo),Ao=r(fo,"P",{});var fr=i(Ao);Di=s(fr,"Refer to superclass "),is=r(fr,"A",{href:!0});var Hp=i(is);Ai=s(Hp,"BertTokenizer"),Hp.forEach(t),Ui=s(fr," for usage examples and documentation concerning parameters."),fr.forEach(t),fo.forEach(t),Xa=p(o),ct=r(o,"H2",{class:!0});var gr=i(ct);St=r(gr,"A",{id:!0,class:!0,href:!0});var Rp=i(St);Rs=r(Rp,"SPAN",{});var Kp=i(Rs);w(Uo.$$.fragment,Kp),Kp.forEach(t),Rp.forEach(t),Bi=p(gr),Ks=r(gr,"SPAN",{});var Vp=i(Ks);Wi=s(Vp,"LayoutLMTokenizerFast"),Vp.forEach(t),gr.forEach(t),Ya=p(o),Se=r(o,"DIV",{class:!0});var go=i(Se);w(Bo.$$.fragment,go),Hi=p(go),Vs=r(go,"P",{});var Xp=i(Vs);Ri=s(Xp,"Constructs a \u201CFast\u201D LayoutLMTokenizer."),Xp.forEach(t),Ki=p(go),It=r(go,"P",{});var Oa=i(It);ls=r(Oa,"A",{href:!0});var Yp=i(ls);Vi=s(Yp,"LayoutLMTokenizerFast"),Yp.forEach(t),Xi=s(Oa," is identical to "),ds=r(Oa,"A",{href:!0});var Zp=i(ds);Yi=s(Zp,"BertTokenizerFast"),Zp.forEach(t),Zi=s(Oa,` and runs end-to-end tokenization: punctuation
splitting + wordpiece.`),Oa.forEach(t),Gi=p(go),Wo=r(go,"P",{});var _r=i(Wo);Ji=s(_r,"Refer to superclass "),cs=r(_r,"A",{href:!0});var Gp=i(cs);Qi=s(Gp,"BertTokenizerFast"),Gp.forEach(t),el=s(_r," for usage examples and documentation concerning parameters."),_r.forEach(t),go.forEach(t),Za=p(o),pt=r(o,"H2",{class:!0});var yr=i(pt);Ot=r(yr,"A",{id:!0,class:!0,href:!0});var Jp=i(Ot);Xs=r(Jp,"SPAN",{});var Qp=i(Xs);w(Ho.$$.fragment,Qp),Qp.forEach(t),Jp.forEach(t),tl=p(yr),Ys=r(yr,"SPAN",{});var eu=i(Ys);ol=s(eu,"LayoutLMModel"),eu.forEach(t),yr.forEach(t),Ga=p(o),Ie=r(o,"DIV",{class:!0});var _o=i(Ie);w(Ro.$$.fragment,_o),nl=p(_o),Ko=r(_o,"P",{});var br=i(Ko);sl=s(br,`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kr.forEach(t),pl=p(_o),Ae=r(_o,"DIV",{class:!0});var yo=i(Ae);w(Zo.$$.fragment,yo),ul=p(yo),ut=r(yo,"P",{});var xs=i(ut);hl=s(xs,"The "),ps=r(xs,"A",{href:!0});var nu=i(ps);ml=s(nu,"LayoutLMModel"),nu.forEach(t),fl=s(xs," forward method, overrides the "),Zs=r(xs,"CODE",{});var su=i(Zs);gl=s(su,"__call__"),su.forEach(t),_l=s(xs," special method."),xs.forEach(t),yl=p(yo),w(Dt.$$.fragment,yo),bl=p(yo),w(At.$$.fragment,yo),yo.forEach(t),_o.forEach(t),Ja=p(o),ht=r(o,"H2",{class:!0});var Lr=i(ht);Ut=r(Lr,"A",{id:!0,class:!0,href:!0});var au=i(Ut);Gs=r(au,"SPAN",{});var ru=i(Gs);w(Go.$$.fragment,ru),ru.forEach(t),au.forEach(t),kl=p(Lr),Js=r(Lr,"SPAN",{});var iu=i(Js);Ll=s(iu,"LayoutLMForMaskedLM"),iu.forEach(t),Lr.forEach(t),Qa=p(o),Oe=r(o,"DIV",{class:!0});var bo=i(Oe);w(Jo.$$.fragment,bo),wl=p(bo),mt=r(bo,"P",{});var js=i(mt);Tl=s(js,"LayoutLM Model with a "),Qs=r(js,"CODE",{});var lu=i(Qs);vl=s(lu,"language modeling"),lu.forEach(t),Ml=s(js,` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fr.forEach(t),$d=p(at),We=r(at,"DIV",{class:!0});var wo=i(We);w(Ln.$$.fragment,wo),xd=p(wo),kt=r(wo,"P",{});var qs=i(kt);jd=s(qs,"The "),ms=r(qs,"A",{href:!0});var ju=i(ms);Fd=s(ju,"LayoutLMForTokenClassification"),ju.forEach(t),zd=s(qs," forward method, overrides the "),ra=r(qs,"CODE",{});var Fu=i(ra);Ed=s(Fu,"__call__"),Fu.forEach(t),qd=s(qs," special method."),qs.forEach(t),Cd=p(wo),w(Xt.$$.fragment,wo),Pd=p(wo),w(Yt.$$.fragment,wo),wo.forEach(t),at.forEach(t),sr=p(o),Lt=r(o,"H2",{class:!0});var zr=i(Lt);Zt=r(zr,"A",{id:!0,class:!0,href:!0});var zu=i(Zt);ia=r(zu,"SPAN",{});var Eu=i(ia);w(wn.$$.fragment,Eu),Eu.forEach(t),zu.forEach(t),Nd=p(zr),la=r(zr,"SPAN",{});var qu=i(la);Sd=s(qu,"TFLayoutLMModel"),qu.forEach(t),zr.forEach(t),ar=p(o),Le=r(o,"DIV",{class:!0});var Ye=i(Le);w(Tn.$$.fragment,Ye),Id=p(Ye),da=r(Ye,"P",{});var Cu=i(da);Od=s(Cu,"The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Cu.forEach(t),Dd=p(Ye),vn=r(Ye,"P",{});var Er=i(vn);Ad=s(Er,"This model inherits from "),fs=r(Er,"A",{href:!0});var Pu=i(fs);Ud=s(Pu,"TFPreTrainedModel"),Pu.forEach(t),Bd=s(Er,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
