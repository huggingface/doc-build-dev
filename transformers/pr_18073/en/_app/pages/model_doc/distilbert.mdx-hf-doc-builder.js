...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18073/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_18073/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18073/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18073/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18073/src/transformers/models/distilbert/modeling_tf_distilbert.py#L522"}}),$o=new be({props:{$$slots:{default:[w2]},$$scope:{ctx:x}}}),Cr=new H({props:{name:"call",anchor:"transformers.TFDistilBertModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFDistilBertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18073/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_18073/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18073/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Ho=new be({props:{$$slots:{default:[W2]},$$scope:{ctx:x}}}),Ko=new re({props:{anchor:"transformers.TFDistilBertForQuestionAnswering.call.example",$$slots:{default:[Q2]},$$scope:{ctx:x}}}),Vo=new re({props:{anchor:"transformers.TFDistilBertForQuestionAnswering.call.example-2",$$slots:{default:[R2]},$$scope:{ctx:x}}}),pa=new Te({}),ha=new H({props:{name:"class transformers.FlaxDistilBertModel",anchor:"transformers.FlaxDistilBertModel",parameters:[{name:"config",val:": DistilBertConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18073/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18073/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18073/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18073/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),sn=new be({props:{$$slots:{default:[J2]},$$scope:{ctx:x}}}),on=new re({props:{anchor:"transformers.FlaxDistilBertForSequenceClassification.__call__.example",$$slots:{default:[G2]},$$scope:{ctx:x}}}),Wa=new Te({}),Qa=new H({props:{name:"class transformers.FlaxDistilBertForMultipleChoice",anchor:"transformers.FlaxDistilBertForMultipleChoice",parameters:[{name:"config",val:": DistilBertConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18073/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),dn=new be({props:{$$slots:{default:[Z2]},$$scope:{ctx:x}}}),cn=new re({props:{anchor:"transformers.FlaxDistilBertForTokenClassification.__call__.example",$$slots:{default:[eF]},$$scope:{ctx:x}}}),li=new Te({}),di=new H({props:{name:"class transformers.FlaxDistilBertForQuestionAnswering",anchor:"transformers.FlaxDistilBertForQuestionAnswering",parameters:[{name:"config",val:": DistilBertConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxDistilBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18073/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tT=h(nt),ac=n(nt,"P",{});var Ry=r(ac);sT=i(Ry,"Finally, this model supports inherent JAX features such as:"),Ry.forEach(t),oT=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var Uy=r(ic);Oa=n(Uy,"A",{href:!0,rel:!0});var Hy=r(Oa);nT=i(Hy,"Just-In-Time (JIT) compilation"),Hy.forEach(t),Uy.forEach(t),rT=h(yn),lc=n(yn,"LI",{});var Ky=r(lc);Na=n(Ky,"A",{href:!0,rel:!0});var Vy=r(Na);aT=i(Vy,"Automatic Differentiation"),Vy.forEach(t),Ky.forEach(t),iT=h(yn),dc=n(yn,"LI",{});var Jy=r(dc);La=n(Jy,"A",{href:!0,rel:!0});var Gy=r(La);lT=i(Gy,"Vectorization"),Gy.forEach(t),Jy.forEach(t),dT=h(yn),cc=n(yn,"LI",{});var Xy=r(cc);Sa=n(Xy,"A",{href:!0,rel:!0});var Yy=r(Sa);cT=i(Yy,"Parallelization"),Yy.forEach(t),Xy.forEach(t),yn.forEach(t),pT=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),hT=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);uT=i(Bl,"The "),pc=n(Bl,"CODE",{});var Zy=r(pc);fT=i(Zy,"FlaxDistilBertPreTrainedModel"),Zy.forEach(t),mT=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var e0=r(hc);gT=i(e0,"__call__"),e0.forEach(t),_T=i(Bl," special method."),Bl.forEach(t),bT=h(Fn),$(sn.$$.fragment,Fn),vT=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var t0=r(nn);uc=n(t0,"SPAN",{});var s0=r(uc);$(Wa.$$.fragment,s0),s0.forEach(t),t0.forEach(t),kT=h(fu),fc=n(fu,"SPAN",{});var o0=r(fc);TT=i(o0,"FlaxDistilBertForMultipleChoice"),o0.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$T=h(rt),mc=n(rt,"P",{});var n0=r(mc);wT=i(n0,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),n0.forEach(t),yT=h(rt),Ra=n(rt,"P",{});var mu=r(Ra);FT=i(mu,"This model inherits from "),dl=n(mu,"A",{href:!0});var r0=r(dl);DT=i(r0,"FlaxPreTrainedModel"),r0.forEach(t),xT=i(mu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mu.forEach(t),BT=h(rt),Ua=n(rt,"P",{});var gu=r(Ua);MT=i(gu,"This model is also a Flax Linen "),Ha=n(gu,"A",{href:!0,rel:!0});var a0=r(Ha);ET=i(a0,"flax.linen.Module"),a0.forEach(t),zT=i(gu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jT=h(rt),gc=n(rt,"P",{});var i0=r(gc);CT=i(i0,"Finally, this model supports inherent JAX features such as:"),i0.forEach(t),qT=h(rt),jt=n(rt,"UL",{});var Dn=r(jt);_c=n(Dn,"LI",{});var l0=r(_c);Ka=n(l0,"A",{href:!0,rel:!0});var d0=r(Ka);PT=i(d0,"Just-In-Time (JIT) compilation"),d0.forEach(t),l0.forEach(t),AT=h(Dn),bc=n(Dn,"LI",{});var c0=r(bc);Va=n(c0,"A",{href:!0,rel:!0});var p0=r(Va);OT=i(p0,"Automatic Differentiation"),p0.forEach(t),c0.forEach(t),NT=h(Dn),vc=n(Dn,"LI",{});var h0=r(vc);Ja=n(h0,"A",{href:!0,rel:!0});var u0=r(Ja);LT=i(u0,"Vectorization"),u0.forEach(t),h0.forEach(t),ST=h(Dn),kc=n(Dn,"LI",{});var f0=r(kc);Ga=n(f0,"A",{href:!0,rel:!0});var m0=r(Ga);IT=i(m0,"Parallelization"),m0.forEach(t),f0.forEach(t),Dn.forEach(t),WT=h(rt),vt=n(rt,"DIV",{class:!0});var xn=r(vt);$(Xa.$$.fragment,xn),QT=h(xn),Os=n(xn,"P",{});var Ml=r(Os);RT=i(Ml,"The "),Tc=n(Ml,"CODE",{});var g0=r(Tc);UT=i(g0,"FlaxDistilBertPreTrainedModel"),g0.forEach(t),HT=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _0=r($c);KT=i(_0,"__call__"),_0.forEach(t),VT=i(Ml," special method."),Ml.forEach(t),JT=h(xn),$(rn.$$.fragment,xn),GT=h(xn),$(an.$$.fragment,xn),xn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var b0=r(ln);wc=n(b0,"SPAN",{});var v0=r(wc);$(Ya.$$.fragment,v0),v0.forEach(t),b0.forEach(t),XT=h(_u),yc=n(_u,"SPAN",{});var k0=r(yc);YT=i(k0,"FlaxDistilBertForTokenClassification"),k0.forEach(t),_u.forEach(t),fh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),ZT=h(at),Fc=n(at,"P",{});var T0=r(Fc);e$=i(T0,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),vu.forEach(t),d$=h(at),Dc=n(at,"P",{});var y0=r(Dc);c$=i(y0,"Finally, this model supports inherent JAX features such as:"),y0.forEach(t),p$=h(at),Ct=n(at,"UL",{});var Bn=r(Ct);xc=n(Bn,"LI",{});var F0=r(xc);oi=n(F0,"A",{href:!0,rel:!0});var D0=r(oi);h$=i(D0,"Just-In-Time (JIT) compilation"),D0.forEach(t),F0.forEach(t),u$=h(Bn),Bc=n(Bn,"LI",{});var x0=r(Bc);ni=n(x0,"A",{href:!0,rel:!0});var B0=r(ni);f$=i(B0,"Automatic Differentiation"),B0.forEach(t),x0.forEach(t),m$=h(Bn),Mc=n(Bn,"LI",{});var M0=r(Mc);ri=n(M0,"A",{href:!0,rel:!0});var E0=r(ri);g$=i(E0,"Vectorization"),E0.forEach(t),M0.forEach(t),_$=h(Bn),Ec=n(Bn,"LI",{});var z0=r(Ec);ai=n(z0,"A",{href:!0,rel:!0});var j0=r(ai);b$=i(j0,"Parallelization"),j0.forEach(t),z0.forEach(t),Bn.forEach(t),v$=h(at),kt=n(at,"DIV",{class:!0});var Mn=r(kt);$(ii.$$.fragment,Mn),k$=h(Mn),Ls=n(Mn,"P",{});var El=r(Ls);T$=i(El,"The "),zc=n(El,"CODE",{});var C0=r(zc);$$=i(C0,"FlaxDistilBertPreTrainedModel"),C0.forEach(t),w$=i(El," forward method, overrides the "),jc=n(El,"CODE",{});var q0=r(jc);y$=i(q0,"__call__"),q0.forEach(t),F$=i(El," special method."),El.forEach(t),D$=h(Mn),$(dn.$$.fragment,Mn),x$=h(Mn),$(cn.$$.fragment,Mn),Mn.forEach(t),at.forEach(t),mh=h(s),Ss=n(s,"H2",{class:!0});var ku=r(Ss);pn=n(ku,"A",{id:!0,class:!0,href:!0});var P0=r(pn);Cc=n(P0,"SPAN",{});var A0=r(Cc);$(li.$$.fragment,A0),A0.forEach(t),P0.forEach(t),B$=h(ku),qc=n(ku,"SPAN",{});var O0=r(qc);M$=i(O0,"FlaxDistilBertForQuestionAnswering"),O0.forEach(t),ku.forEach(t),gh=h(s),qe=n(s,"DIV",{class:!0});var it=r(qe);$(di.$$.fragment,it),E$=h(it),Is=n(it,"P",{});var zl=r(Is);z$=i(zl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
