...
and configure `),ki=o("a"),e7=a("TrainingArguments"),s7=a(" based on that. The steps are:"),$y=u(),sa=o("ol"),nd=o("li"),t7=a("Create or load the DeepSpeed configuration to be used as a master configuration"),a7=u(),Wo=o("li"),n7=a("Create the "),Pi=o("a"),o7=a("TrainingArguments"),l7=a(" object based on these values"),ky=u(),oe=o("p"),r7=a("Do note that some values, such as "),od=o("code"),p7=a("scheduler.params.total_num_steps"),i7=a(` are calculated by
`),zi=o("a"),u7=a("Trainer"),c7=a(" during "),ld=o("code"),h7=a("train"),f7=a(", but you can of course do the math yourself."),Py=u(),Di=o("a"),zy=u(),Ss=o("h3"),ta=o("a"),rd=o("span"),f(Fo.$$.fragment),d7=u(),pd=o("span"),m7=a("ZeRO"),Dy=u(),Vo=o("p"),Yo=o("a"),_7=a("Zero Redundancy Optimizer (ZeRO)"),v7=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),Oy=u(),Ze=o("p"),j7=a("The "),id=o("code"),w7=a("zero_optimization"),y7=a(" section of the configuration file is the most important part ("),Ko=o("a"),g7=a("docs"),b7=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),Ay=u(),aa=o("p"),q7=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Oi=o("a"),E7=a("Trainer"),$7=a(` provides
no equivalent command line arguments.`),Ty=u(),Ai=o("p"),k7=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),Sy=u(),Ti=o("a"),Cy=u(),Cs=o("h4"),na=o("a"),ud=o("span"),f(Jo.$$.fragment),P7=u(),cd=o("span"),z7=a("ZeRO-2 Config"),xy=u(),Si=o("p"),D7=a("The following is an example of configuration for ZeRO stage 2:"),Ry=u(),f(Xo.$$.fragment),Iy=u(),Ci=o("p"),hd=o("strong"),O7=a("Performance tuning:"),Uy=u(),Ne=o("ul"),xs=o("li"),A7=a("enabling "),fd=o("code"),T7=a("offload_optimizer"),S7=a(" should reduce GPU RAM usage (it requires "),dd=o("code"),C7=a('"stage": 2'),x7=a(")"),R7=u(),G=o("li"),md=o("code"),I7=a('"overlap_comm": true'),U7=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),_d=o("code"),G7=a("overlap_comm"),M7=a(` uses 4.5x
the `),vd=o("code"),L7=a("allgather_bucket_size"),Z7=a(" and "),jd=o("code"),N7=a("reduce_bucket_size"),H7=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),wd=o("code"),B7=a("5e8 x 2Bytes x 2 x 4.5"),W7=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),yd=o("code"),F7=a("2e8"),V7=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),Y7=u(),gd=o("li"),K7=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),Gy=u(),He=o("p"),J7=a("Additionally, "),bd=o("code"),X7=a("deepspeed==0.4.4"),Q7=a(" added a new option "),qd=o("code"),ek=a("round_robin_gradients"),sk=a(" which you can enable with:"),My=u(),f(Qo.$$.fragment),Ly=u(),xi=o("p"),tk=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),Zy=u(),Ri=o("a"),Ny=u(),Rs=o("h4"),oa=o("a"),Ed=o("span"),f(el.$$.fragment),ak=u(),$d=o("span"),nk=a("ZeRO-3 Config"),Hy=u(),Ii=o("p"),ok=a("The following is an example of configuration for ZeRO stage 3:"),By=u(),f(sl.$$.fragment),Wy=u(),V=o("p"),lk=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
...
and configure `),ki=l(_q,"A",{href:!0});var nL=r(ki);e7=n(nL,"TrainingArguments"),nL.forEach(t),s7=n(_q," based on that. The steps are:"),_q.forEach(t),$y=c(e),sa=l(e,"OL",{});var vq=r(sa);nd=l(vq,"LI",{});var oL=r(nd);t7=n(oL,"Create or load the DeepSpeed configuration to be used as a master configuration"),oL.forEach(t),a7=c(vq),Wo=l(vq,"LI",{});var jq=r(Wo);n7=n(jq,"Create the "),Pi=l(jq,"A",{href:!0});var lL=r(Pi);o7=n(lL,"TrainingArguments"),lL.forEach(t),l7=n(jq," object based on these values"),jq.forEach(t),vq.forEach(t),ky=c(e),oe=l(e,"P",{});var Rn=r(oe);r7=n(Rn,"Do note that some values, such as "),od=l(Rn,"CODE",{});var rL=r(od);p7=n(rL,"scheduler.params.total_num_steps"),rL.forEach(t),i7=n(Rn,` are calculated by
`),zi=l(Rn,"A",{href:!0});var pL=r(zi);u7=n(pL,"Trainer"),pL.forEach(t),c7=n(Rn," during "),ld=l(Rn,"CODE",{});var iL=r(ld);h7=n(iL,"train"),iL.forEach(t),f7=n(Rn,", but you can of course do the math yourself."),Rn.forEach(t),Py=c(e),Di=l(e,"A",{id:!0}),r(Di).forEach(t),zy=c(e),Ss=l(e,"H3",{class:!0});var wq=r(Ss);ta=l(wq,"A",{id:!0,class:!0,href:!0});var uL=r(ta);rd=l(uL,"SPAN",{});var cL=r(rd);d(Fo.$$.fragment,cL),cL.forEach(t),uL.forEach(t),d7=c(wq),pd=l(wq,"SPAN",{});var hL=r(pd);m7=n(hL,"ZeRO"),hL.forEach(t),wq.forEach(t),Dy=c(e),Vo=l(e,"P",{});var vU=r(Vo);Yo=l(vU,"A",{href:!0,rel:!0});var fL=r(Yo);_7=n(fL,"Zero Redundancy Optimizer (ZeRO)"),fL.forEach(t),v7=n(vU,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),vU.forEach(t),Oy=c(e),Ze=l(e,"P",{});var rh=r(Ze);j7=n(rh,"The "),id=l(rh,"CODE",{});var dL=r(id);w7=n(dL,"zero_optimization"),dL.forEach(t),y7=n(rh," section of the configuration file is the most important part ("),Ko=l(rh,"A",{href:!0,rel:!0});var mL=r(Ko);g7=n(mL,"docs"),mL.forEach(t),b7=n(rh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),rh.forEach(t),Ay=c(e),aa=l(e,"P",{});var yq=r(aa);q7=n(yq,"This section has to be configured exclusively via DeepSpeed configuration - the "),Oi=l(yq,"A",{href:!0});var _L=r(Oi);E7=n(_L,"Trainer"),_L.forEach(t),$7=n(yq,` provides
no equivalent command line arguments.`),yq.forEach(t),Ty=c(e),Ai=l(e,"P",{});var vL=r(Ai);k7=n(vL,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),vL.forEach(t),Sy=c(e),Ti=l(e,"A",{id:!0}),r(Ti).forEach(t),Cy=c(e),Cs=l(e,"H4",{class:!0});var gq=r(Cs);na=l(gq,"A",{id:!0,class:!0,href:!0});var jL=r(na);ud=l(jL,"SPAN",{});var wL=r(ud);d(Jo.$$.fragment,wL),wL.forEach(t),jL.forEach(t),P7=c(gq),cd=l(gq,"SPAN",{});var yL=r(cd);z7=n(yL,"ZeRO-2 Config"),yL.forEach(t),gq.forEach(t),xy=c(e),Si=l(e,"P",{});var gL=r(Si);D7=n(gL,"The following is an example of configuration for ZeRO stage 2:"),gL.forEach(t),Ry=c(e),d(Xo.$$.fragment,e),Iy=c(e),Ci=l(e,"P",{});var bL=r(Ci);hd=l(bL,"STRONG",{});var qL=r(hd);O7=n(qL,"Performance tuning:"),qL.forEach(t),bL.forEach(t),Uy=c(e),Ne=l(e,"UL",{});var ph=r(Ne);xs=l(ph,"LI",{});var ih=r(xs);A7=n(ih,"enabling "),fd=l(ih,"CODE",{});var EL=r(fd);T7=n(EL,"offload_optimizer"),EL.forEach(t),S7=n(ih," should reduce GPU RAM usage (it requires "),dd=l(ih,"CODE",{});var $L=r(dd);C7=n($L,'"stage": 2'),$L.forEach(t),x7=n(ih,")"),ih.forEach(t),R7=c(ph),G=l(ph,"LI",{});var se=r(G);md=l(se,"CODE",{});var kL=r(md);I7=n(kL,'"overlap_comm": true'),kL.forEach(t),U7=n(se," trades off increased GPU RAM usage to lower all-reduce latency. "),_d=l(se,"CODE",{});var PL=r(_d);G7=n(PL,"overlap_comm"),PL.forEach(t),M7=n(se,` uses 4.5x
the `),vd=l(se,"CODE",{});var zL=r(vd);L7=n(zL,"allgather_bucket_size"),zL.forEach(t),Z7=n(se," and "),jd=l(se,"CODE",{});var DL=r(jd);N7=n(DL,"reduce_bucket_size"),DL.forEach(t),H7=n(se,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),wd=l(se,"CODE",{});var OL=r(wd);B7=n(OL,"5e8 x 2Bytes x 2 x 4.5"),OL.forEach(t),W7=n(se,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),yd=l(se,"CODE",{});var AL=r(yd);F7=n(AL,"2e8"),AL.forEach(t),V7=n(se,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),se.forEach(t),Y7=c(ph),gd=l(ph,"LI",{});var TL=r(gd);K7=n(TL,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),TL.forEach(t),ph.forEach(t),Gy=c(e),He=l(e,"P",{});var uh=r(He);J7=n(uh,"Additionally, "),bd=l(uh,"CODE",{});var SL=r(bd);X7=n(SL,"deepspeed==0.4.4"),SL.forEach(t),Q7=n(uh," added a new option "),qd=l(uh,"CODE",{});var CL=r(qd);ek=n(CL,"round_robin_gradients"),CL.forEach(t),sk=n(uh," which you can enable with:"),uh.forEach(t),My=c(e),d(Qo.$$.fragment,e),Ly=c(e),xi=l(e,"P",{});var xL=r(xi);tk=n(xL,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),xL.forEach(t),Zy=c(e),Ri=l(e,"A",{id:!0}),r(Ri).forEach(t),Ny=c(e),Rs=l(e,"H4",{class:!0});var bq=r(Rs);oa=l(bq,"A",{id:!0,class:!0,href:!0});var RL=r(oa);Ed=l(RL,"SPAN",{});var IL=r(Ed);d(el.$$.fragment,IL),IL.forEach(t),RL.forEach(t),ak=c(bq),$d=l(bq,"SPAN",{});var UL=r($d);nk=n(UL,"ZeRO-3 Config"),UL.forEach(t),bq.forEach(t),Hy=c(e),Ii=l(e,"P",{});var GL=r(Ii);ok=n(GL,"The following is an example of configuration for ZeRO stage 3:"),GL.forEach(t),By=c(e),d(sl.$$.fragment,e),Wy=c(e),V=l(e,"P",{});var ws=r(V);lk=n(ws,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
