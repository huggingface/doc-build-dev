...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(f.$$.fragment)},l(i){h=s(i,"P",{});var u=d(h);x=r(u,"Example:"),u.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,u){g(i,h,u),e(h,x),g(i,_,u),E(f,i,u),v=!0},p:mt,i(i){v||(T(f.$$.fragment,i),v=!0)},o(i){y(f.$$.fragment,i),v=!1},d(i){i&&t(h),i&&t(_),k(f,i)}}}function dh(F){let h,x,_,f,v,i,u,I,qa,yr,ne,ye,gn,to,Fa,un,za,kr,$,Pa,ht,Aa,Ca,_n,Sa,Ia,ft,La,Na,gt,Oa,Ra,ut,Ba,Ga,_t,Wa,Ha,vn,Ua,Za,vt,Ya,Ja,bt,Ka,Qa,wt,Xa,es,Et,os,ts,xr,ke,ns,no,rs,as,$r,xe,ss,Tt,ds,is,jr,J,cs,yt,ls,ps,kt,ms,hs,Mr,re,$e,bn,ro,fs,ao,gs,wn,us,_s,Vr,Z,xt,vs,bs,$t,ws,Es,jt,Ts,ys,Dr,so,qr,ae,je,En,io,ks,co,xs,Tn,$s,js,Fr,M,Mt,Ms,Vs,yn,Ds,qs,Vt,Fs,zs,kn,Ps,As,xn,Cs,Ss,$n,Is,Ls,Dt,Ns,Os,Me,Rs,jn,Bs,Gs,Mn,Ws,Hs,qt,Us,Zs,zr,lo,Pr,se,Ve,Vn,po,Ys,mo,Js,Dn,Ks,Qs,Ar,L,Xs,qn,ed,od,Ft,td,nd,Fn,rd,ad,Cr,De,sd,zn,dd,id,Sr,ho,Ir,de,qe,Pn,fo,cd,go,ld,An,pd,md,Lr,ie,Cn,hd,fd,Sn,gd,ud,Nr,uo,Or,ce,Fe,In,_o,_d,Ln,vd,Rr,N,bd,Nn,wd,Ed,On,Td,yd,Rn,kd,xd,Br,vo,Gr,K,$d,bo,jd,Md,wo,Vd,Dd,Wr,le,ze,Bn,Eo,qd,Gn,Fd,Hr,S,To,zd,Pe,zt,Pd,Ad,Pt,Cd,Sd,Id,pe,Ld,At,Nd,Od,Ct,Rd,Bd,Gd,Ae,Wd,Ce,yo,Hd,ko,Ud,St,Zd,Yd,Jd,Se,xo,Kd,me,Qd,Wn,Xd,ei,Hn,oi,ti,Ur,he,Ie,Un,$o,ni,Zn,ri,Zr,V,jo,ai,fe,si,It,di,ii,Lt,ci,li,pi,Mo,mi,Vo,hi,fi,gi,Do,ui,qo,_i,vi,bi,Yn,wi,Ei,Fo,Ti,Nt,yi,ki,xi,zo,$i,Po,ji,Mi,Vi,Q,Ot,Di,qi,Jn,Fi,zi,Kn,Pi,Ai,Ci,O,Ao,Si,ge,Ii,Rt,Li,Ni,Qn,Oi,Ri,Bi,Le,Gi,Ne,Wi,R,Co,Hi,Xn,Ui,Zi,ue,Yi,er,Ji,Ki,or,Qi,Xi,ec,Oe,Yr,_e,Re,tr,So,oc,nr,tc,Jr,D,Io,nc,ve,rc,Bt,ac,sc,Gt,dc,ic,cc,Lo,lc,No,pc,mc,hc,Oo,fc,Ro,gc,uc,_c,rr,vc,bc,Bo,wc,Wt,Ec,Tc,yc,Go,kc,Wo,xc,$c,jc,X,Ht,Mc,Vc,Ut,Dc,qc,Zt,Fc,zc,Pc,B,Ho,Ac,be,Cc,Yt,Sc,Ic,ar,Lc,Nc,Oc,Be,Rc,Ge,Bc,ee,Uo,Gc,sr,Wc,Hc,We,Kr,we,He,dr,Zo,Uc,ir,Zc,Qr,q,Yo,Yc,Ee,Jc,Jt,Kc,Qc,Kt,Xc,el,ol,Jo,tl,Ko,nl,rl,al,Qo,sl,Xo,dl,il,cl,cr,ll,pl,et,ml,Qt,hl,fl,gl,ot,ul,tt,_l,vl,bl,oe,Xt,wl,El,lr,Tl,yl,pr,kl,xl,$l,G,nt,jl,Te,Ml,en,Vl,Dl,mr,ql,Fl,zl,Ue,Pl,Ze,Al,te,rt,Cl,hr,Sl,Il,Ye,Xr;return i=new Y({}),to=new Y({}),ro=new Y({}),so=new U({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
`}}),xo=new H({props:{name:"to_dict",anchor:"transformers.VisionEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_18271/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L110",returnDescription:`
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18271/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L724"}}),Ye=new pt({props:{anchor:"transformers.FlaxVisionEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[sh]},$$scope:{ctx:F}}}),{c(){h=a("meta"),x=l(),_=a("h1"),f=a("a"),v=a("span"),b(i.$$.fragment),u=l(),I=a("span"),qa=n("Vision Encoder Decoder Models"),yr=l(),ne=a("h2"),ye=a("a"),gn=a("span"),b(to.$$.fragment),Fa=l(),un=a("span"),za=n("Overview"),kr=l(),$=a("p"),Pa=n("The "),ht=a("a"),Aa=n("VisionEncoderDecoderModel"),Ca=n(` can be used to initialize an image-to-text model with any
pretrained Transformer-based vision model as the encoder (`),_n=a("em"),Sa=n("e.g."),Ia=l(),ft=a("a"),La=n("ViT"),Na=n(", "),gt=a("a"),Oa=n("BEiT"),Ra=n(", "),ut=a("a"),Ba=n("DeiT"),Ga=n(", "),_t=a("a"),Wa=n("Swin"),Ha=n(`)
and any pretrained language model as the decoder (`),vn=a("em"),Ua=n("e.g."),Za=l(),vt=a("a"),Ya=n("RoBERTa"),Ja=n(", "),bt=a("a"),Ka=n("GPT2"),Qa=n(", "),wt=a("a"),Xa=n("BERT"),es=n(", "),Et=a("a"),os=n("DistilBERT"),ts=n(")."),xr=l(),ke=a("p"),ns=n(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
the caption. Another example is optical character recognition. Refer to `),yt=a("a"),ls=n("TrOCR"),ps=n(", which is an instance of "),kt=a("a"),ms=n("VisionEncoderDecoderModel"),hs=n("."),Mr=l(),re=a("h2"),$e=a("a"),bn=a("span"),b(ro.$$.fragment),fs=l(),ao=a("span"),gs=n("Randomly initializing "),wn=a("code"),us=n("VisionEncoderDecoderModel"),_s=n(" from model configurations."),Vr=l(),Z=a("p"),xt=a("a"),vs=n("VisionEncoderDecoderModel"),bs=n(" can be randomly initialized from an encoder and a decoder config. In the following example, we show how to do this using the default "),$t=a("a"),ws=n("ViTModel"),Es=n(` configuration for the encoder
and the default `),jt=a("a"),Ts=n("BertModel"),ys=n(" configuration for the decoder."),Dr=l(),b(so.$$.fragment),qr=l(),ae=a("h2"),je=a("a"),En=a("span"),b(io.$$.fragment),ks=l(),co=a("span"),xs=n("Initialising "),Tn=a("code"),$s=n("VisionEncoderDecoderModel"),js=n(" from a pretrained encoder and a pretrained decoder."),Fr=l(),M=a("p"),Mt=a("a"),Ms=n("VisionEncoderDecoderModel"),Vs=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained Transformer-based vision model, "),yn=a("em"),Ds=n("e.g."),qs=l(),Vt=a("a"),Fs=n("Swin"),zs=n(", can serve as the encoder and both pretrained auto-encoding models, "),kn=a("em"),Ps=n("e.g."),As=n(" BERT, pretrained causal language models, "),xn=a("em"),Cs=n("e.g."),Ss=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),$n=a("em"),Is=n("e.g."),Ls=n(` decoder of BART, can be used as the decoder.
...
were contributed by `),wo=a("a"),Vd=n("ydshieh"),Dd=n("."),Wr=l(),le=a("h2"),ze=a("a"),Bn=a("span"),b(Eo.$$.fragment),qd=l(),Gn=a("span"),Fd=n("VisionEncoderDecoderConfig"),Hr=l(),S=a("div"),b(To.$$.fragment),zd=l(),Pe=a("p"),zt=a("a"),Pd=n("VisionEncoderDecoderConfig"),Ad=n(` is the configuration class to store the configuration of a
`),Pt=a("a"),Cd=n("VisionEncoderDecoderModel"),Sd=n(`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
specified arguments, defining the encoder and decoder configs.`),Id=l(),pe=a("p"),Ld=n("Configuration objects inherit from "),At=a("a"),Nd=n("PretrainedConfig"),Od=n(` and can be used to control the model outputs. Read the
documentation from `),Ct=a("a"),Rd=n("PretrainedConfig"),Bd=n(" for more information."),Gd=l(),b(Ae.$$.fragment),Wd=l(),Ce=a("div"),b(yo.$$.fragment),Hd=l(),ko=a("p"),Ud=n("Instantiate a "),St=a("a"),Zd=n("VisionEncoderDecoderConfig"),Yd=n(` (or a derived class) from a pre-trained encoder model
...
`),It=a("a"),di=n("from_pretrained()"),ii=n(" function and the decoder is loaded via "),Lt=a("a"),ci=n("from_pretrained()"),li=n(`
...
other models (see the examples for more information).`),Ei=l(),Fo=a("p"),Ti=n("This model inherits from "),Nt=a("a"),yi=n("PreTrainedModel"),ki=n(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Vi=l(),Q=a("p"),Ot=a("a"),Di=n("VisionEncoderDecoderModel"),qi=n(` is a generic model class that will be instantiated as a transformer architecture with
...
:meth`),Kn=a("em"),Pi=n("~transformers.AutoModelForCausalLM.from_pretrained"),Ai=n(" class method for the decoder."),Ci=l(),O=a("div"),b(Ao.$$.fragment),Si=l(),ge=a("p"),Ii=n("The "),Rt=a("a"),Li=n("VisionEncoderDecoderModel"),Ni=n(" forward method, overrides the "),Qn=a("code"),Oi=n("__call__"),Ri=n(" special method."),Bi=l(),b(Le.$$.fragment),Gi=l(),b(Ne.$$.fragment),Wi=l(),R=a("div"),b(Co.$$.fragment),Hi=l(),Xn=a("p"),Ui=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Bt=a("a"),ac=n("from_pretrained()"),sc=n(" function and the decoder is loaded via "),Gt=a("a"),dc=n("from_pretrained()"),ic=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
other models (see the examples for more information).`),bc=l(),Bo=a("p"),wc=n("This model inherits from "),Wt=a("a"),Ec=n("TFPreTrainedModel"),Tc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yc=l(),Go=a("p"),kc=n("This model is also a "),Wo=a("a"),xc=n("tf.keras.Model"),$c=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jc=l(),X=a("p"),Ht=a("a"),Mc=n("TFVisionEncoderDecoderModel"),Vc=n(` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Ut=a("a"),Dc=n("from_pretrained()"),qc=n(` class method for the encoder and
`),Zt=a("a"),Fc=n("from_pretrained()"),zc=n(" class method for the decoder."),Pc=l(),B=a("div"),b(Ho.$$.fragment),Ac=l(),be=a("p"),Cc=n("The "),Yt=a("a"),Sc=n("TFVisionEncoderDecoderModel"),Ic=n(" forward method, overrides the "),ar=a("code"),Lc=n("__call__"),Nc=n(" special method."),Oc=l(),b(Be.$$.fragment),Rc=l(),b(Ge.$$.fragment),Bc=l(),ee=a("div"),b(Uo.$$.fragment),Gc=l(),sr=a("p"),Wc=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Jt=a("a"),Kc=n("from_pretrained()"),Qc=n(" function and the decoder is loaded via "),Kt=a("a"),Xc=n("from_pretrained()"),el=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
other models (see the examples for more information).`),pl=l(),et=a("p"),ml=n("This model inherits from "),Qt=a("a"),hl=n("FlaxPreTrainedModel"),fl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gl=l(),ot=a("p"),ul=n(`This model is also a Flax Linen
`),tt=a("a"),_l=n("flax.nn.Module"),vl=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bl=l(),oe=a("p"),Xt=a("a"),wl=n("FlaxVisionEncoderDecoderModel"),El=n(` is a generic model class that will be instantiated as a transformer architecture
...
for the encoder and :meth`),pr=a("em"),kl=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),xl=n(" class method for the decoder."),$l=l(),G=a("div"),b(nt.$$.fragment),jl=l(),Te=a("p"),Ml=n("The "),en=a("a"),Vl=n("FlaxVisionEncoderDecoderModel"),Dl=n(" forward method, overrides the "),mr=a("code"),ql=n("__call__"),Fl=n(" special method."),zl=l(),b(Ue.$$.fragment),Pl=l(),b(Ze.$$.fragment),Al=l(),te=a("div"),b(rt.$$.fragment),Cl=l(),hr=a("p"),Sl=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Il=l(),b(Ye.$$.fragment),this.h()},l(o){const m=Ym('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(t),x=p(o),_=s(o,"H1",{class:!0});var at=d(_);f=s(at,"A",{id:!0,class:!0,href:!0});var fr=d(f);v=s(fr,"SPAN",{});var gr=d(v);w(i.$$.fragment,gr),gr.forEach(t),fr.forEach(t),u=p(at),I=s(at,"SPAN",{});var ur=d(I);qa=r(ur,"Vision Encoder Decoder Models"),ur.forEach(t),at.forEach(t),yr=p(o),ne=s(o,"H2",{class:!0});var st=d(ne);ye=s(st,"A",{id:!0,class:!0,href:!0});var _r=d(ye);gn=s(_r,"SPAN",{});var vr=d(gn);w(to.$$.fragment,vr),vr.forEach(t),_r.forEach(t),Fa=p(st),un=s(st,"SPAN",{});var br=d(un);za=r(br,"Overview"),br.forEach(t),st.forEach(t),kr=p(o),$=s(o,"P",{});var j=d($);Pa=r(j,"The "),ht=s(j,"A",{href:!0});var wr=d(ht);Aa=r(wr,"VisionEncoderDecoderModel"),wr.forEach(t),Ca=r(j,` can be used to initialize an image-to-text model with any
pretrained Transformer-based vision model as the encoder (`),_n=s(j,"EM",{});var Ol=d(_n);Sa=r(Ol,"e.g."),Ol.forEach(t),Ia=p(j),ft=s(j,"A",{href:!0});var Rl=d(ft);La=r(Rl,"ViT"),Rl.forEach(t),Na=r(j,", "),gt=s(j,"A",{href:!0});var Bl=d(gt);Oa=r(Bl,"BEiT"),Bl.forEach(t),Ra=r(j,", "),ut=s(j,"A",{href:!0});var Gl=d(ut);Ba=r(Gl,"DeiT"),Gl.forEach(t),Ga=r(j,", "),_t=s(j,"A",{href:!0});var Wl=d(_t);Wa=r(Wl,"Swin"),Wl.forEach(t),Ha=r(j,`)
and any pretrained language model as the decoder (`),vn=s(j,"EM",{});var Hl=d(vn);Ua=r(Hl,"e.g."),Hl.forEach(t),Za=p(j),vt=s(j,"A",{href:!0});var Ul=d(vt);Ya=r(Ul,"RoBERTa"),Ul.forEach(t),Ja=r(j,", "),bt=s(j,"A",{href:!0});var Zl=d(bt);Ka=r(Zl,"GPT2"),Zl.forEach(t),Qa=r(j,", "),wt=s(j,"A",{href:!0});var Yl=d(wt);Xa=r(Yl,"BERT"),Yl.forEach(t),es=r(j,", "),Et=s(j,"A",{href:!0});var Jl=d(Et);os=r(Jl,"DistilBERT"),Jl.forEach(t),ts=r(j,")."),j.forEach(t),xr=p(o),ke=s(o,"P",{});var ea=d(ke);ns=r(ea,`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
images) and `),On=s(Ke,"CODE",{});var Cp=d(On);Td=r(Cp,"labels"),Cp.forEach(t),yd=r(Ke," (which are the "),Rn=s(Ke,"CODE",{});var Sp=d(Rn);kd=r(Sp,"input_ids"),Sp.forEach(t),xd=r(Ke," of the encoded target sequence)."),Ke.forEach(t),Br=p(o),w(vo.$$.fragment,o),Gr=p(o),K=s(o,"P",{});var tn=d(K);$d=r(tn,"This model was contributed by "),bo=s(tn,"A",{href:!0,rel:!0});var Ip=d(bo);jd=r(Ip,"nielsr"),Ip.forEach(t),Md=r(tn,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=s(tn,"A",{href:!0,rel:!0});var Lp=d(wo);Vd=r(Lp,"ydshieh"),Lp.forEach(t),Dd=r(tn,"."),tn.forEach(t),Wr=p(o),le=s(o,"H2",{class:!0});var ma=d(le);ze=s(ma,"A",{id:!0,class:!0,href:!0});var Np=d(ze);Bn=s(Np,"SPAN",{});var Op=d(Bn);w(Eo.$$.fragment,Op),Op.forEach(t),Np.forEach(t),qd=p(ma),Gn=s(ma,"SPAN",{});var Rp=d(Gn);Fd=r(Rp,"VisionEncoderDecoderConfig"),Rp.forEach(t),ma.forEach(t),Hr=p(o),S=s(o,"DIV",{class:!0});var W=d(S);w(To.$$.fragment,W),zd=p(W),Pe=s(W,"P",{});var Tr=d(Pe);zt=s(Tr,"A",{href:!0});var Bp=d(zt);Pd=r(Bp,"VisionEncoderDecoderConfig"),Bp.forEach(t),Ad=r(Tr,` is the configuration class to store the configuration of a
`),Pt=s(Tr,"A",{href:!0});var Gp=d(Pt);Cd=r(Gp,"VisionEncoderDecoderModel"),Gp.forEach(t),Sd=r(Tr,`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
specified arguments, defining the encoder and decoder configs.`),Tr.forEach(t),Id=p(W),pe=s(W,"P",{});var nn=d(pe);Ld=r(nn,"Configuration objects inherit from "),At=s(nn,"A",{href:!0});var Wp=d(At);Nd=r(Wp,"PretrainedConfig"),Wp.forEach(t),Od=r(nn,` and can be used to control the model outputs. Read the
documentation from `),Ct=s(nn,"A",{href:!0});var Hp=d(Ct);Rd=r(Hp,"PretrainedConfig"),Hp.forEach(t),Bd=r(nn," for more information."),nn.forEach(t),Gd=p(W),w(Ae.$$.fragment,W),Wd=p(W),Ce=s(W,"DIV",{class:!0});var ha=d(Ce);w(yo.$$.fragment,ha),Hd=p(ha),ko=s(ha,"P",{});var fa=d(ko);Ud=r(fa,"Instantiate a "),St=s(fa,"A",{href:!0});var Up=d(St);Zd=r(Up,"VisionEncoderDecoderConfig"),Up.forEach(t),Yd=r(fa,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),fa.forEach(t),ha.forEach(t),Jd=p(W),Se=s(W,"DIV",{class:!0});var ga=d(Se);w(xo.$$.fragment,ga),Kd=p(ga),me=s(ga,"P",{});var rn=d(me);Qd=r(rn,"Serializes this instance to a Python dictionary. Override the default "),Wn=s(rn,"EM",{});var Zp=d(Wn);Xd=r(Zp,"to_dict()"),Zp.forEach(t),ei=r(rn," from "),Hn=s(rn,"EM",{});var Yp=d(Hn);oi=r(Yp,"PretrainedConfig"),Yp.forEach(t),ti=r(rn,"."),rn.forEach(t),ga.forEach(t),W.forEach(t),Ur=p(o),he=s(o,"H2",{class:!0});var ua=d(he);Ie=s(ua,"A",{id:!0,class:!0,href:!0});var Jp=d(Ie);Un=s(Jp,"SPAN",{});var Kp=d(Un);w($o.$$.fragment,Kp),Kp.forEach(t),Jp.forEach(t),ni=p(ua),Zn=s(ua,"SPAN",{});var Qp=d(Zn);ri=r(Qp,"VisionEncoderDecoderModel"),Qp.forEach(t),ua.forEach(t),Zr=p(o),V=s(o,"DIV",{class:!0});var P=d(V);w(jo.$$.fragment,P),ai=p(P),fe=s(P,"P",{});var an=d(fe);si=r(an,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),It=s(an,"A",{href:!0});var Xp=d(It);di=r(Xp,"from_pretrained()"),Xp.forEach(t),ii=r(an," function and the decoder is loaded via "),Lt=s(an,"A",{href:!0});var em=d(Lt);ci=r(em,"from_pretrained()"),em.forEach(t),li=r(an,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),an.forEach(t),pi=p(P),Mo=s(P,"P",{});var _a=d(Mo);mi=r(_a,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
other models (see the examples for more information).`),nm.forEach(t),Ei=p(P),Fo=s(P,"P",{});var ba=d(Fo);Ti=r(ba,"This model inherits from "),Nt=s(ba,"A",{href:!0});var rm=d(Nt);yi=r(rm,"PreTrainedModel"),rm.forEach(t),ki=r(ba,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wa.forEach(t),Vi=p(P),Q=s(P,"P",{});var it=d(Q);Ot=s(it,"A",{href:!0});var sm=d(Ot);Di=r(sm,"VisionEncoderDecoderModel"),sm.forEach(t),qi=r(it,` is a generic model class that will be instantiated as a transformer architecture with
one of the base vision model classes of the library as encoder and another one as decoder when created with the
...
:meth`),Kn=s(it,"EM",{});var im=d(Kn);Pi=r(im,"~transformers.AutoModelForCausalLM.from_pretrained"),im.forEach(t),Ai=r(it," class method for the decoder."),it.forEach(t),Ci=p(P),O=s(P,"DIV",{class:!0});var Qe=d(O);w(Ao.$$.fragment,Qe),Si=p(Qe),ge=s(Qe,"P",{});var sn=d(ge);Ii=r(sn,"The "),Rt=s(sn,"A",{href:!0});var cm=d(Rt);Li=r(cm,"VisionEncoderDecoderModel"),cm.forEach(t),Ni=r(sn," forward method, overrides the "),Qn=s(sn,"CODE",{});var lm=d(Qn);Oi=r(lm,"__call__"),lm.forEach(t),Ri=r(sn," special method."),sn.forEach(t),Bi=p(Qe),w(Le.$$.fragment,Qe),Gi=p(Qe),w(Ne.$$.fragment,Qe),Qe.forEach(t),Wi=p(P),R=s(P,"DIV",{class:!0});var Xe=d(R);w(Co.$$.fragment,Xe),Hi=p(Xe),Xn=s(Xe,"P",{});var pm=d(Xn);Ui=r(pm,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),pm.forEach(t),Zi=p(Xe),ue=s(Xe,"P",{});var dn=d(ue);Yi=r(dn,"The model is set in evaluation mode by default using "),er=s(dn,"CODE",{});var mm=d(er);Ji=r(mm,"model.eval()"),mm.forEach(t),Ki=r(dn,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),or=s(dn,"CODE",{});var hm=d(or);Qi=r(hm,"model.train()"),hm.forEach(t),Xi=r(dn,"."),dn.forEach(t),ec=p(Xe),w(Oe.$$.fragment,Xe),Xe.forEach(t),P.forEach(t),Yr=p(o),_e=s(o,"H2",{class:!0});var Ea=d(_e);Re=s(Ea,"A",{id:!0,class:!0,href:!0});var fm=d(Re);tr=s(fm,"SPAN",{});var gm=d(tr);w(So.$$.fragment,gm),gm.forEach(t),fm.forEach(t),oc=p(Ea),nr=s(Ea,"SPAN",{});var um=d(nr);tc=r(um,"TFVisionEncoderDecoderModel"),um.forEach(t),Ea.forEach(t),Jr=p(o),D=s(o,"DIV",{class:!0});var A=d(D);w(Io.$$.fragment,A),nc=p(A),ve=s(A,"P",{});var cn=d(ve);rc=r(cn,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Bt=s(cn,"A",{href:!0});var _m=d(Bt);ac=r(_m,"from_pretrained()"),_m.forEach(t),sc=r(cn," function and the decoder is loaded via "),Gt=s(cn,"A",{href:!0});var vm=d(Gt);dc=r(vm,"from_pretrained()"),vm.forEach(t),ic=r(cn,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),cn.forEach(t),cc=p(A),Lo=s(A,"P",{});var Ta=d(Lo);lc=r(Ta,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
other models (see the examples for more information).`),Em.forEach(t),bc=p(A),Bo=s(A,"P",{});var ka=d(Bo);wc=r(ka,"This model inherits from "),Wt=s(ka,"A",{href:!0});var Tm=d(Wt);Ec=r(Tm,"TFPreTrainedModel"),Tm.forEach(t),Tc=r(ka,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xa.forEach(t),jc=p(A),X=s(A,"P",{});var ct=d(X);Ht=s(ct,"A",{href:!0});var km=d(Ht);Mc=r(km,"TFVisionEncoderDecoderModel"),km.forEach(t),Vc=r(ct,` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Ut=s(ct,"A",{href:!0});var xm=d(Ut);Dc=r(xm,"from_pretrained()"),xm.forEach(t),qc=r(ct,` class method for the encoder and
`),Zt=s(ct,"A",{href:!0});var $m=d(Zt);Fc=r($m,"from_pretrained()"),$m.forEach(t),zc=r(ct," class method for the decoder."),ct.forEach(t),Pc=p(A),B=s(A,"DIV",{class:!0});var eo=d(B);w(Ho.$$.fragment,eo),Ac=p(eo),be=s(eo,"P",{});var ln=d(be);Cc=r(ln,"The "),Yt=s(ln,"A",{href:!0});var jm=d(Yt);Sc=r(jm,"TFVisionEncoderDecoderModel"),jm.forEach(t),Ic=r(ln," forward method, overrides the "),ar=s(ln,"CODE",{});var Mm=d(ar);Lc=r(Mm,"__call__"),Mm.forEach(t),Nc=r(ln," special method."),ln.forEach(t),Oc=p(eo),w(Be.$$.fragment,eo),Rc=p(eo),w(Ge.$$.fragment,eo),eo.forEach(t),Bc=p(A),ee=s(A,"DIV",{class:!0});var pn=d(ee);w(Uo.$$.fragment,pn),Gc=p(pn),sr=s(pn,"P",{});var Vm=d(sr);Wc=r(Vm,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Vm.forEach(t),Hc=p(pn),w(We.$$.fragment,pn),pn.forEach(t),A.forEach(t),Kr=p(o),we=s(o,"H2",{class:!0});var $a=d(we);He=s($a,"A",{id:!0,class:!0,href:!0});var Dm=d(He);dr=s(Dm,"SPAN",{});var qm=d(dr);w(Zo.$$.fragment,qm),qm.forEach(t),Dm.forEach(t),Uc=p($a),ir=s($a,"SPAN",{});var Fm=d(ir);Zc=r(Fm,"FlaxVisionEncoderDecoderModel"),Fm.forEach(t),$a.forEach(t),Qr=p(o),q=s(o,"DIV",{class:!0});var C=d(q);w(Yo.$$.fragment,C),Yc=p(C),Ee=s(C,"P",{});var mn=d(Ee);Jc=r(mn,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Jt=s(mn,"A",{href:!0});var zm=d(Jt);Kc=r(zm,"from_pretrained()"),zm.forEach(t),Qc=r(mn," function and the decoder is loaded via "),Kt=s(mn,"A",{href:!0});var Pm=d(Kt);Xc=r(Pm,"from_pretrained()"),Pm.forEach(t),el=r(mn,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),mn.forEach(t),ol=p(C),Jo=s(C,"P",{});var ja=d(Jo);tl=r(ja,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
other models (see the examples for more information).`),Sm.forEach(t),pl=p(C),et=s(C,"P",{});var Va=d(et);ml=r(Va,"This model inherits from "),Qt=s(Va,"A",{href:!0});var Im=d(Qt);hl=r(Im,"FlaxPreTrainedModel"),Im.forEach(t),fl=r(Va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Da.forEach(t),bl=p(C),oe=s(C,"P",{});var lt=d(oe);Xt=s(lt,"A",{href:!0});var Nm=d(Xt);wl=r(Nm,"FlaxVisionEncoderDecoderModel"),Nm.forEach(t),El=r(lt,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base vision model classes of the library as encoder module and
