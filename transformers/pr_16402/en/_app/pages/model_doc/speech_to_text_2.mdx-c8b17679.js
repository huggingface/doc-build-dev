...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){m=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(f){m=n(f,"P",{});var S=c(m);E=s(S,"Example:"),S.forEach(o),u=d(f),v(_.$$.fragment,f)},m(f,S){h(f,m,S),e(m,E),h(f,u,S),T(_,f,S),w=!0},p:ei,i(f){w||(x(_.$$.fragment,f),w=!0)},o(f){k(_.$$.fragment,f),w=!1},d(f){f&&o(m),f&&o(u),b(_,f)}}}function di(H){let m,E,u,_,w,f,S,W,q,y,M,F,oo,ze,jr,ro,Cr,Ao,J,qr,vt,Mr,Fr,Pe,Ar,Lr,Lo,z,Dr,so,Wr,Ir,ao,Vr,Nr,Tt,Or,Ur,xt,Rr,Br,kt,Hr,Jr,no,Gr,Kr,Do,ne,Qr,je,Xr,Yr,Wo,ce,Zr,Ce,es,ts,Io,bt,os,Vo,G,qe,rs,Me,ss,as,ns,Fe,cs,St,is,ls,ds,Ae,ps,Le,hs,fs,No,Z,ie,co,De,ms,io,us,Oo,K,_s,wt,gs,vs,$t,Ts,xs,Uo,C,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,Pt,zs,Ps,jt,js,Cs,Ro,Ct,lo,qs,Bo,We,Ho,qt,Ie,po,Ms,Fs,ho,As,Jo,Ve,Go,le,Ls,Ne,Ds,Ws,Ko,ee,de,fo,Oe,Is,mo,Vs,Qo,I,Ue,Ns,te,Os,Mt,Us,Rs,Re,Bs,Hs,Js,oe,Gs,Ft,Ks,Qs,At,Xs,Ys,Zs,pe,Xo,re,he,uo,Be,ea,_o,ta,Yo,j,He,oa,go,ra,sa,Je,aa,Lt,na,ca,ia,fe,Ge,la,vo,da,pa,Q,Ke,ha,To,fa,ma,Qe,ua,xo,_a,ga,va,Dt,Xe,Zo,se,me,ko,Ye,Ta,bo,xa,er,$,Ze,ka,So,ba,Sa,A,Wt,wa,$a,It,ya,Ea,Vt,za,Pa,et,wo,ja,Ca,qa,Nt,Ma,Fa,Aa,ue,tt,La,U,Da,$o,Wa,Ia,Ot,Va,Na,ot,yo,Oa,Ua,Ra,Ba,X,rt,Ha,Eo,Ja,Ga,_e,Ka,Y,st,Qa,at,Xa,Ut,Ya,Za,en,ge,tn,ve,nt,on,ct,rn,Rt,sn,an,nn,Te,it,cn,lt,ln,Bt,dn,pn,hn,xe,dt,fn,zo,mn,tr,ae,ke,Po,pt,un,jo,_n,or,V,ht,gn,R,vn,Ht,Tn,xn,Co,kn,bn,Jt,Sn,wn,$n,ft,yn,mt,En,zn,Pn,be,ut,jn,Se,rr;return f=new gt({}),ze=new gt({}),De=new gt({}),We=new Pr({props:{code:`import torch
