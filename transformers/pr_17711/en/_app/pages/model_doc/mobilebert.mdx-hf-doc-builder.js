...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_17711/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_17711/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17711/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_mobilebert.py#L950",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1059",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1145",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1255",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1466",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1568",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1358",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17711/en/model_doc/mobilebert#transformers.MobileBertTokenizer">MobileBertTokenizer</a>. See <a href="/docs/transformers/pr_17711/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/main_classes/output#transformers.modeling_tf_outputs.TFNextSentencePredictorOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jc.forEach(t),dm=m(Et),zs=a(Et,"P",{});var Nc=i(zs);cm=s(Nc,"This model is also a PyTorch "),qs=a(Nc,"A",{href:!0,rel:!0});var tT=i(qs);pm=s(tT,"torch.nn.Module"),tT.forEach(t),hm=s(Nc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nc.forEach(t),mm=m(Et),lt=a(Et,"DIV",{class:!0});var es=i(lt);y(Ps.$$.fragment,es),um=m(es),Zt=a(es,"P",{});var ui=i(Zt);fm=s(ui,"The "),Sa=a(ui,"A",{href:!0});var oT=i(Sa);gm=s(oT,"MobileBertForPreTraining"),oT.forEach(t),_m=s(ui," forward method, overrides the "),Yi=a(ui,"CODE",{});var nT=i(Yi);bm=s(nT,"__call__"),nT.forEach(t),Tm=s(ui," special method."),ui.forEach(t),km=m(es),y(Ro.$$.fragment,es),vm=m(es),y(Uo.$$.fragment,es),es.forEach(t),Et.forEach(t),Gd=m(o),Xt=a(o,"H2",{class:!0});var Oc=i(Xt);Ho=a(Oc,"A",{id:!0,class:!0,href:!0});var sT=i(Ho);Ji=a(sT,"SPAN",{});var rT=i(Ji);y(Cs.$$.fragment,rT),rT.forEach(t),sT.forEach(t),ym=m(Oc),Zi=a(Oc,"SPAN",{});var aT=i(Zi);wm=s(aT,"MobileBertForMaskedLM"),aT.forEach(t),Oc.forEach(t),Yd=m(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);y(js.$$.fragment,xt),Mm=m(xt),Ns=a(xt,"P",{});var Sc=i(Ns);$m=s(Sc,"MobileBert Model with a "),Xi=a(Sc,"CODE",{});var iT=i(Xi);Fm=s(iT,"language modeling"),iT.forEach(t),Bm=s(Sc," head on top."),Sc.forEach(t),Em=m(xt),Os=a(xt,"P",{});var Ac=i(Os);xm=s(Ac,"This model inherits from "),Aa=a(Ac,"A",{href:!0});var lT=i(Aa);zm=s(lT,"PreTrainedModel"),lT.forEach(t),qm=s(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),Pm=m(xt),Ss=a(xt,"P",{});var Ic=i(Ss);Cm=s(Ic,"This model is also a PyTorch "),As=a(Ic,"A",{href:!0,rel:!0});var dT=i(As);jm=s(dT,"torch.nn.Module"),dT.forEach(t),Nm=s(Ic,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Om=m(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sm=m(zt),eo=a(zt,"P",{});var fi=i(eo);Am=s(fi,"The "),Ia=a(fi,"A",{href:!0});var cT=i(Ia);Im=s(cT,"MobileBertForMaskedLM"),cT.forEach(t),Lm=s(fi," forward method, overrides the "),el=a(fi,"CODE",{});var pT=i(el);Dm=s(pT,"__call__"),pT.forEach(t),Wm=s(fi," special method."),fi.forEach(t),Rm=m(zt),y(Qo.$$.fragment,zt),Um=m(zt),y(Ko.$$.fragment,zt),Hm=m(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=m(o),to=a(o,"H2",{class:!0});var Lc=i(to);Go=a(Lc,"A",{id:!0,class:!0,href:!0});var hT=i(Go);tl=a(hT,"SPAN",{});var mT=i(tl);y(Ls.$$.fragment,mT),mT.forEach(t),hT.forEach(t),Qm=m(Lc),ol=a(Lc,"SPAN",{});var uT=i(ol);Km=s(uT,"MobileBertForNextSentencePrediction"),uT.forEach(t),Lc.forEach(t),Zd=m(o),He=a(o,"DIV",{class:!0});var qt=i(He);y(Ds.$$.fragment,qt),Vm=m(qt),Ws=a(qt,"P",{});var Dc=i(Ws);Gm=s(Dc,"MobileBert Model with a "),nl=a(Dc,"CODE",{});var fT=i(nl);Ym=s(fT,"next sentence prediction (classification)"),fT.forEach(t),Jm=s(Dc," head on top."),Dc.forEach(t),Zm=m(qt),Rs=a(qt,"P",{});var Wc=i(Rs);Xm=s(Wc,"This model inherits from "),La=a(Wc,"A",{href:!0});var gT=i(La);eu=s(gT,"PreTrainedModel"),gT.forEach(t),tu=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wc.forEach(t),ou=m(qt),Us=a(qt,"P",{});var Rc=i(Us);nu=s(Rc,"This model is also a PyTorch "),Hs=a(Rc,"A",{href:!0,rel:!0});var _T=i(Hs);su=s(_T,"torch.nn.Module"),_T.forEach(t),ru=s(Rc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(t),au=m(qt),dt=a(qt,"DIV",{class:!0});var ts=i(dt);y(Qs.$$.fragment,ts),iu=m(ts),oo=a(ts,"P",{});var gi=i(oo);lu=s(gi,"The "),Da=a(gi,"A",{href:!0});var bT=i(Da);du=s(bT,"MobileBertForNextSentencePrediction"),bT.forEach(t),cu=s(gi," forward method, overrides the "),sl=a(gi,"CODE",{});var TT=i(sl);pu=s(TT,"__call__"),TT.forEach(t),hu=s(gi," special method."),gi.forEach(t),mu=m(ts),y(Yo.$$.fragment,ts),uu=m(ts),y(Jo.$$.fragment,ts),ts.forEach(t),qt.forEach(t),Xd=m(o),no=a(o,"H2",{class:!0});var Uc=i(no);Zo=a(Uc,"A",{id:!0,class:!0,href:!0});var kT=i(Zo);rl=a(kT,"SPAN",{});var vT=i(rl);y(Ks.$$.fragment,vT),vT.forEach(t),kT.forEach(t),fu=m(Uc),al=a(Uc,"SPAN",{});var yT=i(al);gu=s(yT,"MobileBertForSequenceClassification"),yT.forEach(t),Uc.forEach(t),ec=m(o),Qe=a(o,"DIV",{class:!0});var Pt=i(Qe);y(Vs.$$.fragment,Pt),_u=m(Pt),il=a(Pt,"P",{});var wT=i(il);bu=s(wT,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wT.forEach(t),Tu=m(Pt),Gs=a(Pt,"P",{});var Hc=i(Gs);ku=s(Hc,"This model inherits from "),Wa=a(Hc,"A",{href:!0});var MT=i(Wa);vu=s(MT,"PreTrainedModel"),MT.forEach(t),yu=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hc.forEach(t),wu=m(Pt),Ys=a(Pt,"P",{});var Qc=i(Ys);Mu=s(Qc,"This model is also a PyTorch "),Js=a(Qc,"A",{href:!0,rel:!0});var $T=i(Js);$u=s($T,"torch.nn.Module"),$T.forEach(t),Fu=s(Qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=m(Pt),Ce=a(Pt,"DIV",{class:!0});var nt=i(Ce);y(Zs.$$.fragment,nt),Eu=m(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var FT=i(Ra);zu=s(FT,"MobileBertForSequenceClassification"),FT.forEach(t),qu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var BT=i(ll);Pu=s(BT,"__call__"),BT.forEach(t),Cu=s(_i," special method."),_i.forEach(t),ju=m(nt),y(Xo.$$.fragment,nt),Nu=m(nt),y(en.$$.fragment,nt),Ou=m(nt),y(tn.$$.fragment,nt),Su=m(nt),y(on.$$.fragment,nt),Au=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),Pt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var ET=i(sn);dl=a(ET,"SPAN",{});var xT=i(dl);y(Xs.$$.fragment,xT),xT.forEach(t),ET.forEach(t),Iu=m(Kc),cl=a(Kc,"SPAN",{});var zT=i(cl);Lu=s(zT,"MobileBertForMultipleChoice"),zT.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var Ct=i(Ke);y(er.$$.fragment,Ct),Du=m(Ct),pl=a(Ct,"P",{});var qT=i(pl);Wu=s(qT,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),qT.forEach(t),Ru=m(Ct),tr=a(Ct,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var PT=i(Ua);Hu=s(PT,"PreTrainedModel"),PT.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),xl=a(wi,"CODE",{});var pk=i(xl);xg=s(pk,"next sentence prediction (classification)"),pk.forEach(t),zg=s(wi," head."),wi.forEach(t),qg=m(_t),$r=a(_t,"P",{});var ap=i($r);Pg=s(ap,"This model inherits from "),Za=a(ap,"A",{href:!0});var hk=i(Za);Cg=s(hk,"TFPreTrainedModel"),hk.forEach(t),jg=s(ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip.forEach(t),Ig=m(_t),y(vn.$$.fragment,_t),Lg=m(_t),ht=a(_t,"DIV",{class:!0});var ss=i(ht);y(Er.$$.fragment,ss),Dg=m(ss),_o=a(ss,"P",{});var Mi=i(_o);Wg=s(Mi,"The "),Xa=a(Mi,"A",{href:!0});var uk=i(Xa);Rg=s(uk,"TFMobileBertForPreTraining"),uk.forEach(t),Ug=s(Mi," forward method, overrides the "),zl=a(Mi,"CODE",{});var fk=i(zl);Hg=s(fk,"__call__"),fk.forEach(t),Qg=s(Mi," special method."),Mi.forEach(t),Kg=m(ss),y(yn.$$.fragment,ss),Vg=m(ss),y(wn.$$.fragment,ss),ss.forEach(t),_t.forEach(t),pc=m(o),bo=a(o,"H2",{class:!0});var lp=i(bo);Mn=a(lp,"A",{id:!0,class:!0,href:!0});var gk=i(Mn);ql=a(gk,"SPAN",{});var _k=i(ql);y(xr.$$.fragment,_k),_k.forEach(t),gk.forEach(t),Gg=m(lp),Pl=a(lp,"SPAN",{});var bk=i(Pl);Yg=s(bk,"TFMobileBertForMaskedLM"),bk.forEach(t),lp.forEach(t),hc=m(o),Se=a(o,"DIV",{class:!0});var bt=i(Se);y(zr.$$.fragment,bt),Jg=m(bt),qr=a(bt,"P",{});var dp=i(qr);Zg=s(dp,"MobileBert Model with a "),Cl=a(dp,"CODE",{});var Tk=i(Cl);Xg=s(Tk,"language modeling"),Tk.forEach(t),e_=s(dp," head on top."),dp.forEach(t),t_=m(bt),Pr=a(bt,"P",{});var cp=i(Pr);o_=s(cp,"This model inherits from "),ei=a(cp,"A",{href:!0});var kk=i(ei);n_=s(kk,"TFPreTrainedModel"),kk.forEach(t),s_=s(cp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=m(Tt),Lr=a(Tt,"P",{});var fp=i(Lr);q_=s(fp,"This model is also a "),Dr=a(fp,"A",{href:!0,rel:!0});var xk=i(Dr);P_=s(xk,"tf.keras.Model"),xk.forEach(t),C_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),j_=m(Tt),y(zn.$$.fragment,Tt),N_=m(Tt),mt=a(Tt,"DIV",{class:!0});var rs=i(mt);y(Wr.$$.fragment,rs),O_=m(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zk=i(ni);A_=s(zk,"TFMobileBertForNextSentencePrediction"),zk.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var qk=i(Al);L_=s(qk,"__call__"),qk.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=m(rs),y(qn.$$.fragment,rs),R_=m(rs),y(Pn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=m(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var Pk=i(Cn);Il=a(Pk,"SPAN",{});var Ck=i(Il);y(Rr.$$.fragment,Ck),Ck.forEach(t),Pk.forEach(t),U_=m(gp),Ll=a(gp,"SPAN",{});var jk=i(Ll);H_=s(jk,"TFMobileBertForSequenceClassification"),jk.forEach(t),gp.forEach(t),gc=m(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=m(kt),Dl=a(kt,"P",{});var Nk=i(Dl);K_=s(Nk,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
