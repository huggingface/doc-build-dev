...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,u){w(l,p,u),b=!0},p:je,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function im($){let l,b,p,u,T,i,f,D,Ne,pe,F,Z,W,ee,Pe,H,Ie,qe,I,V,te,Te,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,M,S,G,Qe,We,N,He,ne,ve;return{c(){l=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),T=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Ne=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),W=a("code"),ee=n("tf.keras.Model.fit"),Pe=n(` method which currently requires having all the
...
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),We=c(),N=a("li"),He=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),ve=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);T=r(se,"LI",{});var nt=d(T);i=s(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(se),D=r(se,"LI",{});var st=d(D);Ne=s(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var P=d(F);Z=s(P,"This second option is useful when using "),W=r(P,"CODE",{});var at=d(W);ee=s(at,"tf.keras.Model.fit"),at.forEach(t),Pe=s(P,` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r(P,"CODE",{});var rt=d(H);Ie=s(rt,"model(inputs)"),rt.forEach(t),qe=s(P,"."),P.forEach(t),I=h(q),V=r(q,"P",{});var Fe=d(V);te=s(Fe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),K=r(re,"CODE",{});var it=d(K);M=s(it,"model([input_ids, attention_mask])"),it.forEach(t),S=s(re," or "),G=r(re,"CODE",{});var de=d(G);Qe=s(de,"model([input_ids, attention_mask, token_type_ids])"),de.forEach(t),re.forEach(t),We=h(U),N=r(U,"LI",{});var Ve=d(N);He=s(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=r(Ve,"CODE",{});var Re=d(ne);ve=s(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),U.forEach(t)},m(q,z){g(q,l,z),e(l,b),g(q,p,z),g(q,u,z),e(u,T),e(T,i),e(u,f),e(u,D),e(D,Ne),g(q,pe,z),g(q,F,z),e(F,Z),e(F,W),e(W,ee),e(F,Pe),e(F,H),e(H,Ie),e(F,qe),g(q,I,z),g(q,V,z),e(V,te),g(q,Te,z),g(q,C,z),e(C,j),e(j,ue),e(j,oe),e(oe,$e),e(j,me),e(j,R),e(R,Ge),e(C,De),e(C,O),e(O,Be),e(O,K),e(K,M),e(O,S),e(O,G),e(G,Qe),e(C,We),e(C,N),e(N,He),e(N,ne),e(ne,ve)},d(q){q&&t(l),q&&t(p),q&&t(u),q&&t(pe),q&&t(F),q&&t(I),q&&t(V),q&&t(Te),q&&t(C)}}}function lm($){let l,b,p,u,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function hm($){let l,b,p,u,T,i,f,D,Ne,pe,F,Z,W,ee,Pe,H,Ie,qe,I,V,te,Te,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,M,S,G,Qe,We,N,He,ne,ve;return{c(){l=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),T=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Ne=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),W=a("code"),ee=n("tf.keras.Model.fit"),Pe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),V=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=c(),C=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),R=a("code"),Ge=n("model(input_ids)"),De=c(),O=a("li"),Be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),We=c(),N=a("li"),He=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),ve=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);T=r(se,"LI",{});var nt=d(T);i=s(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(se),D=r(se,"LI",{});var st=d(D);Ne=s(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var P=d(F);Z=s(P,"This second option is useful when using "),W=r(P,"CODE",{});var at=d(W);ee=s(at,"tf.keras.Model.fit"),at.forEach(t),Pe=s(P,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),Te=h(q),C=r(q,"UL",{});var U=d(C);j=r(U,"LI",{});var ae=d(j);ue=s(ae,"a single Tensor with "),oe=r(ae,"CODE",{});var ze=d(oe);$e=s(ze,"input_ids"),ze.forEach(t),me=s(ae," only and nothing else: "),R=r(ae,"CODE",{});var dt=d(R);Ge=s(dt,"model(input_ids)"),dt.forEach(t),ae.forEach(t),De=h(U),O=r(U,"LI",{});var re=d(O);Be=s(re,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=r(re,"CODE",{});var it=d(K);M=s(it,"model([input_ids, attention_mask])"),it.forEach(t),S=s(re," or "),G=r(re,"CODE",{});var de=d(G);Qe=s(de,"model([input_ids, attention_mask, token_type_ids])"),de.forEach(t),re.forEach(t),We=h(U),N=r(U,"LI",{});var Ve=d(N);He=s(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=r(Ve,"CODE",{});var Re=d(ne);ve=s(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),U.forEach(t)},m(q,z){g(q,l,z),e(l,b),g(q,p,z),g(q,u,z),e(u,T),e(T,i),e(u,f),e(u,D),e(D,Ne),g(q,pe,z),g(q,F,z),e(F,Z),e(F,W),e(W,ee),e(F,Pe),e(F,H),e(H,Ie),e(F,qe),g(q,I,z),g(q,V,z),e(V,te),g(q,Te,z),g(q,C,z),e(C,j),e(j,ue),e(j,oe),e(oe,$e),e(j,me),e(j,R),e(R,Ge),e(C,De),e(C,O),e(O,Be),e(O,K),e(K,M),e(O,S),e(O,G),e(G,Qe),e(C,We),e(C,N),e(N,He),e(N,ne),e(ne,ve)},d(q){q&&t(l),q&&t(p),q&&t(u),q&&t(pe),q&&t(F),q&&t(I),q&&t(V),q&&t(Te),q&&t(C)}}}function pm($){let l,b,p,u,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Examples:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function mm($){let l,b,p,u,T,i,f,D,Ne,pe,F,Z,W,ee,Pe,H,Ie,qe,I,V,te,Te,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,M,S,G,Qe,We,N,He,ne,ve,q,z,se,nt,st,P,at,rt,Fe,U,ae,ze,dt,re,it,de,Ve,Re,rd,dd,qs,id,ld,cd,ke,hd,$s,pd,ud,Ds,md,fd,Qn,_d,gd,Fs,bd,Td,vd,X,kd,zs,wd,yd,xs,Ed,Ld,Wn,qd,$d,Ms,Dd,Fd,Ss,zd,xd,Cs,Md,Sd,Cd,Ue,Od,Os,jd,Ad,js,Nd,Pd,As,Id,Gd,Bd,$o,Qd,Do,Wd,Hd,Vd,Fo,Rd,zo,Ud,Xd,Ha,jt,Jd,xo,Zd,Kd,Va,lt,At,Ns,Mo,Yd,Ps,ei,Ra,we,So,ti,ct,oi,Hn,ni,si,Co,ai,ri,di,ht,ii,Vn,li,ci,Rn,hi,pi,ui,Nt,Ua,pt,Pt,Is,Oo,mi,Gs,fi,Xa,A,jo,_i,Bs,gi,bi,It,Un,Ti,vi,Xn,ki,wi,yi,Ao,Ei,Jn,Li,qi,$i,Xe,No,Di,Qs,Fi,zi,Po,Zn,xi,Ws,Mi,Si,Kn,Ci,Hs,Oi,ji,Gt,Io,Ai,Go,Ni,Vs,Pi,Ii,Gi,Bt,Bo,Bi,Rs,Qi,Wi,Yn,Qo,Ja,ut,Qt,Us,Wo,Hi,Xs,Vi,Za,ye,Ho,Ri,Vo,Ui,Js,Xi,Ji,Zi,Wt,es,Ki,Yi,ts,el,tl,ol,Ro,nl,os,sl,al,Ka,mt,Ht,Zs,Uo,rl,Ks,dl,Ya,ft,Xo,il,Ys,ll,er,_t,Jo,cl,ea,hl,tr,gt,Zo,pl,ta,ul,or,bt,Ko,ml,oa,fl,nr,Tt,Yo,_l,na,gl,sr,vt,en,bl,sa,Tl,ar,kt,tn,vl,aa,kl,rr,wt,on,wl,ra,yl,dr,yt,Vt,da,nn,El,ia,Ll,ir,Ee,sn,ql,an,$l,ns,Dl,Fl,zl,rn,xl,dn,Ml,Sl,Cl,xe,ln,Ol,Et,jl,ss,Al,Nl,la,Pl,Il,Gl,Rt,Bl,Ut,lr,Lt,Xt,ca,cn,Ql,ha,Wl,cr,Le,hn,Hl,pn,Vl,as,Rl,Ul,Xl,un,Jl,mn,Zl,Kl,Yl,fe,fn,ec,qt,tc,rs,oc,nc,pa,sc,ac,rc,Jt,dc,Zt,ic,Kt,hr,$t,Yt,ua,_n,lc,ma,cc,pr,ie,gn,hc,fa,pc,uc,bn,mc,ds,fc,_c,gc,Tn,bc,vn,Tc,vc,kc,B,kn,wc,Dt,yc,is,Ec,Lc,_a,qc,$c,Dc,eo,Fc,to,zc,oo,xc,no,Mc,so,ur,Ft,ao,ga,wn,Sc,ba,Cc,mr,le,yn,Oc,zt,jc,Ta,Ac,Nc,va,Pc,Ic,Gc,En,Bc,ls,Qc,Wc,Hc,Ln,Vc,qn,Rc,Uc,Xc,_e,$n,Jc,xt,Zc,cs,Kc,Yc,ka,eh,th,oh,ro,nh,io,sh,lo,fr,Mt,co,wa,Dn,ah,ya,rh,_r,ce,Fn,dh,zn,ih,hs,lh,ch,hh,xn,ph,Mn,uh,mh,fh,ho,_h,Me,Sn,gh,St,bh,ps,Th,vh,Ea,kh,wh,yh,po,Eh,uo,gr,Ct,mo,La,Cn,Lh,qa,qh,br,he,On,$h,jn,Dh,us,Fh,zh,xh,An,Mh,Nn,Sh,Ch,Oh,fo,jh,Se,Pn,Ah,Ot,Nh,ms,Ph,Ih,$a,Gh,Bh,Qh,_o,Wh,go,Tr;return i=new Ce({}),ee=new Ce({}),Mo=new Ce({}),So=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/led/modeling_tf_led.py#L1408"}}),on=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/pr_17711/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17711/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17711/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/led/modeling_led.py#L2201",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17711/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/led/modeling_led.py#L2341",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/led/modeling_led.py#L2503",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/led/modeling_led.py#L2630",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/led/modeling_tf_led.py#L2244",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17711/src/transformers/models/led/modeling_tf_led.py#L2353",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17711/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
`),N=a("a"),He=n("BartForConditionalGeneration"),ne=n(" exchanging the traditional "),ve=a("em"),q=n("self-attention"),z=n(` layer with
`),se=a("em"),nt=n("Longformer"),st=n("\u2019s "),P=a("em"),at=n("chunked self-attention"),rt=n(" layer. "),Fe=a("a"),U=n("LEDTokenizer"),ae=n(` is an alias of
...
documentation from `),Rn=a("a"),hi=n("PretrainedConfig"),pi=n(" for more information."),ui=c(),v(Nt.$$.fragment),Ua=c(),pt=a("h2"),Pt=a("a"),Is=a("span"),v(Oo.$$.fragment),mi=c(),Gs=a("span"),fi=n("LEDTokenizer"),Xa=c(),A=a("div"),v(jo.$$.fragment),_i=c(),Bs=a("p"),gi=n("Construct a LED tokenizer."),bi=c(),It=a("p"),Un=a("a"),Ti=n("LEDTokenizer"),vi=n(" is identical to "),Xn=a("a"),ki=n("BartTokenizer"),wi=n(` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),yi=c(),Ao=a("p"),Ei=n("Refer to superclass "),Jn=a("a"),Li=n("BartTokenizer"),qi=n(" for usage examples and documentation concerning parameters."),$i=c(),Xe=a("div"),v(No.$$.fragment),Di=c(),Qs=a("p"),Fi=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),zi=c(),Po=a("ul"),Zn=a("li"),xi=n("single sequence: "),Ws=a("code"),Mi=n("<s> X </s>"),Si=c(),Kn=a("li"),Ci=n("pair of sequences: "),Hs=a("code"),Oi=n("<s> A </s></s> B </s>"),ji=c(),Gt=a("div"),v(Io.$$.fragment),Ai=c(),Go=a("p"),Ni=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Vs=a("code"),Pi=n("prepare_for_model"),Ii=n(" method."),Gi=c(),Bt=a("div"),v(Bo.$$.fragment),Bi=c(),Rs=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Cl=c(),xe=a("div"),v(ln.$$.fragment),Ol=c(),Et=a("p"),jl=n("The "),ss=a("a"),Al=n("LEDModel"),Nl=n(" forward method, overrides the "),la=a("code"),Pl=n("__call__"),Il=n(" special method."),Gl=c(),v(Rt.$$.fragment),Bl=c(),v(Ut.$$.fragment),lr=c(),Lt=a("h2"),Xt=a("a"),ca=a("span"),v(cn.$$.fragment),Ql=c(),ha=a("span"),Wl=n("LEDForConditionalGeneration"),cr=c(),Le=a("div"),v(hn.$$.fragment),Hl=c(),pn=a("p"),Vl=n(`The LED Model with a language modeling head. Can be used for summarization.
...
on top of the hidden-states output to compute `),Ta=a("code"),Ac=n("span start logits"),Nc=n(" and "),va=a("code"),Pc=n("span end logits"),Ic=n(")."),Gc=c(),En=a("p"),Bc=n("This model inherits from "),ls=a("a"),Qc=n("PreTrainedModel"),Wc=n(`. See the superclass documentation for the generic methods the library
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xh=c(),An=a("p"),Mh=n("This model is also a "),Nn=a("a"),Sh=n("tf.keras.Model"),Ch=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oh=c(),v(fo.$$.fragment),jh=c(),Se=a("div"),v(Pn.$$.fragment),Ah=c(),Ot=a("p"),Nh=n("The "),ms=a("a"),Ph=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),$a=a("code"),Gh=n("__call__"),Bh=n(" special method."),Qh=c(),v(_o.$$.fragment),Wh=c(),v(go.$$.fragment),this.h()},l(o){const _=Vu('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),p=r(o,"H1",{class:!0});var In=d(p);u=r(In,"A",{id:!0,class:!0,href:!0});var Da=d(u);T=r(Da,"SPAN",{});var Fa=d(T);k(i.$$.fragment,Fa),Fa.forEach(t),Da.forEach(t),f=h(In),D=r(In,"SPAN",{});var za=d(D);Ne=s(za,"LED"),za.forEach(t),In.forEach(t),pe=h(o),F=r(o,"H2",{class:!0});var Gn=d(F);Z=r(Gn,"A",{id:!0,class:!0,href:!0});var xa=d(Z);W=r(xa,"SPAN",{});var Ma=d(W);k(ee.$$.fragment,Ma),Ma.forEach(t),xa.forEach(t),Pe=h(Gn),H=r(Gn,"SPAN",{});var Sa=d(H);Ie=s(Sa,"Overview"),Sa.forEach(t),Gn.forEach(t),qe=h(o),I=r(o,"P",{});var Bn=d(I);V=s(Bn,"The LED model was proposed in "),te=r(Bn,"A",{href:!0,rel:!0});var Ca=d(te);Te=s(Ca,"Longformer: The Long-Document Transformer"),Ca.forEach(t),C=s(Bn,` by Iz
...
WikiHop and TriviaQA. We finally introduce the Longformer-Encoder-Decoder (LED), a Longformer variant for supporting
long document generative sequence-to-sequence tasks, and demonstrate its effectiveness on the arXiv summarization
dataset.`),Aa.forEach(t),ja.forEach(t),De=h(o),O=r(o,"P",{});var Na=d(O);Be=s(Na,"Tips:"),Na.forEach(t),K=h(o),M=r(o,"UL",{});var J=d(M);S=r(J,"LI",{});var Q=d(S);G=r(Q,"A",{href:!0});var Pa=d(G);Qe=s(Pa,"LEDForConditionalGeneration"),Pa.forEach(t),We=s(Q,` is an extension of
`),N=r(Q,"A",{href:!0});var Ia=d(N);He=s(Ia,"BartForConditionalGeneration"),Ia.forEach(t),ne=s(Q," exchanging the traditional "),ve=r(Q,"EM",{});var Ga=d(ve);q=s(Ga,"self-attention"),Ga.forEach(t),z=s(Q,` layer with
`),se=r(Q,"EM",{});var Ba=d(se);nt=s(Ba,"Longformer"),Ba.forEach(t),st=s(Q,"\u2019s "),P=r(Q,"EM",{});var Rh=d(P);at=s(Rh,"chunked self-attention"),Rh.forEach(t),rt=s(Q," layer. "),Fe=r(Q,"A",{href:!0});var Uh=d(Fe);U=s(Uh,"LEDTokenizer"),Uh.forEach(t),ae=s(Q,` is an alias of
...
documentation from `),Rn=r(gs,"A",{href:!0});var vp=d(Rn);hi=s(vp,"PretrainedConfig"),vp.forEach(t),pi=s(gs," for more information."),gs.forEach(t),ui=h(To),k(Nt.$$.fragment,To),To.forEach(t),Ua=h(o),pt=r(o,"H2",{class:!0});var Er=d(pt);Pt=r(Er,"A",{id:!0,class:!0,href:!0});var kp=d(Pt);Is=r(kp,"SPAN",{});var wp=d(Is);k(Oo.$$.fragment,wp),wp.forEach(t),kp.forEach(t),mi=h(Er),Gs=r(Er,"SPAN",{});var yp=d(Gs);fi=s(yp,"LEDTokenizer"),yp.forEach(t),Er.forEach(t),Xa=h(o),A=r(o,"DIV",{class:!0});var Y=d(A);k(jo.$$.fragment,Y),_i=h(Y),Bs=r(Y,"P",{});var Ep=d(Bs);gi=s(Ep,"Construct a LED tokenizer."),Ep.forEach(t),bi=h(Y),It=r(Y,"P",{});var Qa=d(It);Un=r(Qa,"A",{href:!0});var Lp=d(Un);Ti=s(Lp,"LEDTokenizer"),Lp.forEach(t),vi=s(Qa," is identical to "),Xn=r(Qa,"A",{href:!0});var qp=d(Xn);ki=s(qp,"BartTokenizer"),qp.forEach(t),wi=s(Qa,` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),Qa.forEach(t),yi=h(Y),Ao=r(Y,"P",{});var Lr=d(Ao);Ei=s(Lr,"Refer to superclass "),Jn=r(Lr,"A",{href:!0});var $p=d(Jn);Li=s($p,"BartTokenizer"),$p.forEach(t),qi=s(Lr," for usage examples and documentation concerning parameters."),Lr.forEach(t),$i=h(Y),Xe=r(Y,"DIV",{class:!0});var bs=d(Xe);k(No.$$.fragment,bs),Di=h(bs),Qs=r(bs,"P",{});var Dp=d(Qs);Fi=s(Dp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),Dp.forEach(t),zi=h(bs),Po=r(bs,"UL",{});var qr=d(Po);Zn=r(qr,"LI",{});var Hh=d(Zn);xi=s(Hh,"single sequence: "),Ws=r(Hh,"CODE",{});var Fp=d(Ws);Mi=s(Fp,"<s> X </s>"),Fp.forEach(t),Hh.forEach(t),Si=h(qr),Kn=r(qr,"LI",{});var Vh=d(Kn);Ci=s(Vh,"pair of sequences: "),Hs=r(Vh,"CODE",{});var zp=d(Hs);Oi=s(zp,"<s> A </s></s> B </s>"),zp.forEach(t),Vh.forEach(t),qr.forEach(t),bs.forEach(t),ji=h(Y),Gt=r(Y,"DIV",{class:!0});var $r=d(Gt);k(Io.$$.fragment,$r),Ai=h($r),Go=r($r,"P",{});var Dr=d(Go);Ni=s(Dr,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Vs=r(Dr,"CODE",{});var xp=d(Vs);Pi=s(xp,"prepare_for_model"),xp.forEach(t),Ii=s(Dr," method."),Dr.forEach(t),$r.forEach(t),Gi=h(Y),Bt=r(Y,"DIV",{class:!0});var Fr=d(Bt);k(Bo.$$.fragment,Fr),Bi=h(Fr),Rs=r(Fr,"P",{});var Mp=d(Rs);Qi=s(Mp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Mp.forEach(t),Fr.forEach(t),Wi=h(Y),Yn=r(Y,"DIV",{class:!0});var Sp=d(Yn);k(Qo.$$.fragment,Sp),Sp.forEach(t),Y.forEach(t),Ja=h(o),ut=r(o,"H2",{class:!0});var zr=d(ut);Qt=r(zr,"A",{id:!0,class:!0,href:!0});var Cp=d(Qt);Us=r(Cp,"SPAN",{});var Op=d(Us);k(Wo.$$.fragment,Op),Op.forEach(t),Cp.forEach(t),Hi=h(zr),Xs=r(zr,"SPAN",{});var jp=d(Xs);Vi=s(jp,"LEDTokenizerFast"),jp.forEach(t),zr.forEach(t),Za=h(o),ye=r(o,"DIV",{class:!0});var vo=d(ye);k(Ho.$$.fragment,vo),Ri=h(vo),Vo=r(vo,"P",{});var xr=d(Vo);Ui=s(xr,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Js=r(xr,"EM",{});var Ap=d(Js);Xi=s(Ap,"tokenizers"),Ap.forEach(t),Ji=s(xr," library)."),xr.forEach(t),Zi=h(vo),Wt=r(vo,"P",{});var Wa=d(Wt);es=r(Wa,"A",{href:!0});var Np=d(es);Ki=s(Np,"LEDTokenizerFast"),Np.forEach(t),Yi=s(Wa," is identical to "),ts=r(Wa,"A",{href:!0});var Pp=d(ts);el=s(Pp,"BartTokenizerFast"),Pp.forEach(t),tl=s(Wa,` and runs end-to-end tokenization: punctuation splitting
...
decoding.`),Hp.forEach(t),Or.forEach(t),tr=h(o),gt=r(o,"DIV",{class:!0});var jr=d(gt);k(Zo.$$.fragment,jr),pl=h(jr),ta=r(jr,"P",{});var Vp=d(ta);ul=s(Vp,"Base class for sequence-to-sequence language models outputs."),Vp.forEach(t),jr.forEach(t),or=h(o),bt=r(o,"DIV",{class:!0});var Ar=d(bt);k(Ko.$$.fragment,Ar),ml=h(Ar),oa=r(Ar,"P",{});var Rp=d(oa);fl=s(Rp,"Base class for outputs of sequence-to-sequence sentence classification models."),Rp.forEach(t),Ar.forEach(t),nr=h(o),Tt=r(o,"DIV",{class:!0});var Nr=d(Tt);k(Yo.$$.fragment,Nr),_l=h(Nr),na=r(Nr,"P",{});var Up=d(na);gl=s(Up,"Base class for outputs of sequence-to-sequence question answering models."),Up.forEach(t),Nr.forEach(t),sr=h(o),vt=r(o,"DIV",{class:!0});var Pr=d(vt);k(en.$$.fragment,Pr),bl=h(Pr),sa=r(Pr,"P",{});var Xp=d(sa);Tl=s(Xp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Xp.forEach(t),Pr.forEach(t),ar=h(o),kt=r(o,"DIV",{class:!0});var Ir=d(kt);k(tn.$$.fragment,Ir),vl=h(Ir),aa=r(Ir,"P",{});var Jp=d(aa);kl=s(Jp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Wr.forEach(t),Cl=h(ko),xe=r(ko,"DIV",{class:!0});var wo=d(xe);k(ln.$$.fragment,wo),Ol=h(wo),Et=r(wo,"P",{});var Ts=d(Et);jl=s(Ts,"The "),ss=r(Ts,"A",{href:!0});var nu=d(ss);Al=s(nu,"LEDModel"),nu.forEach(t),Nl=s(Ts," forward method, overrides the "),la=r(Ts,"CODE",{});var su=d(la);Pl=s(su,"__call__"),su.forEach(t),Il=s(Ts," special method."),Ts.forEach(t),Gl=h(wo),k(Rt.$$.fragment,wo),Bl=h(wo),k(Ut.$$.fragment,wo),wo.forEach(t),ko.forEach(t),lr=h(o),Lt=r(o,"H2",{class:!0});var Hr=d(Lt);Xt=r(Hr,"A",{id:!0,class:!0,href:!0});var au=d(Xt);ca=r(au,"SPAN",{});var ru=d(ca);k(cn.$$.fragment,ru),ru.forEach(t),au.forEach(t),Ql=h(Hr),ha=r(Hr,"SPAN",{});var du=d(ha);Wl=s(du,"LEDForConditionalGeneration"),du.forEach(t),Hr.forEach(t),cr=h(o),Le=r(o,"DIV",{class:!0});var yo=d(Le);k(hn.$$.fragment,yo),Hl=h(yo),pn=r(yo,"P",{});var Vr=d(pn);Vl=s(Vr,`The LED Model with a language modeling head. Can be used for summarization.
