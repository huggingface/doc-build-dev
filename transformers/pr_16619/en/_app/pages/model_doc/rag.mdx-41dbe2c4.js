...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);x=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);q=o(R,"Module"),R.forEach(n),y=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,x),e(p,m),e(m,q),e(p,y)},d(g){g&&n(p)}}}function bT(M){let p,x,m,q,y,g,h,R,ti,Da,$e,ot,Fr,Ct,oi,zr,ni,Ia,an,ri,Wa,nt,si,Lt,ai,di,Ha,dn,ii,Ba,cn,$r,ci,Qa,rt,li,St,pi,hi,Ua,Ee,st,Er,Dt,ui,jr,mi,Va,de,It,gi,me,ln,_i,fi,Mr,vi,bi,pn,Ti,wi,hn,ki,qi,yi,at,Wt,xi,Ht,Ri,un,Fi,zi,$i,dt,Bt,Ei,Qt,ji,mn,Mi,Gi,Ka,je,it,Gr,Ut,Ai,Ar,Pi,Ya,Me,Vt,Ni,ct,Kt,Oi,Pr,Ci,Ja,Ge,lt,Nr,Yt,Li,Or,Si,Xa,Ae,Jt,Di,Cr,Ii,Za,Xt,Zt,ed,Pe,pt,Lr,eo,Wi,Sr,Hi,td,X,to,Bi,Dr,Qi,Ui,Ir,Vi,Ki,oo,Yi,ht,no,Ji,Wr,Xi,Zi,ut,ro,ec,Ne,tc,Hr,oc,nc,Br,rc,sc,ac,mt,so,dc,ao,ic,Qr,cc,lc,od,Oe,gt,Ur,io,pc,Vr,hc,nd,L,co,uc,Ce,mc,gn,gc,_c,Kr,fc,vc,bc,_t,Tc,Yr,wc,kc,ie,qc,Jr,yc,xc,_n,Rc,Fc,Xr,zc,$c,fn,Ec,jc,Mc,G,Gc,vn,Ac,Pc,Zr,Nc,Oc,es,Cc,Lc,ts,Sc,Dc,os,Ic,Wc,bn,Hc,Bc,ns,Qc,Uc,Tn,Vc,Kc,wn,Yc,Jc,rs,Xc,Zc,el,lo,tl,kn,ol,nl,rl,po,sl,ho,al,dl,il,ee,uo,cl,Le,ll,qn,pl,hl,ss,ul,ml,gl,ft,_l,as,fl,vl,mo,rd,Se,vt,ds,go,bl,is,Tl,sd,$,_o,wl,De,kl,yn,ql,yl,cs,xl,Rl,Fl,bt,zl,ls,$l,El,ps,jl,Ml,ce,Gl,hs,Al,Pl,xn,Nl,Ol,us,Cl,Ll,Rn,Sl,Dl,Il,A,Wl,Fn,Hl,Bl,ms,Ql,Ul,gs,Vl,Kl,_s,Yl,Jl,fs,Xl,Zl,zn,ep,tp,vs,op,np,$n,rp,sp,En,ap,dp,bs,ip,cp,lp,fo,pp,jn,hp,up,mp,vo,gp,bo,_p,fp,vp,te,To,bp,Ie,Tp,Mn,wp,kp,Ts,qp,yp,xp,Tt,Rp,ws,Fp,zp,wo,$p,wt,ko,Ep,qo,jp,Gn,Mp,Gp,ad,We,kt,ks,yo,Ap,qs,Pp,dd,E,xo,Np,He,Op,An,Cp,Lp,ys,Sp,Dp,Ip,qt,Wp,xs,Hp,Bp,Rs,Qp,Up,le,Vp,Fs,Kp,Yp,Pn,Jp,Xp,zs,Zp,eh,Nn,th,oh,nh,P,rh,On,sh,ah,$s,dh,ih,Es,ch,lh,js,ph,hh,Ms,uh,mh,Cn,gh,_h,Gs,fh,vh,Ln,bh,Th,Sn,wh,kh,As,qh,yh,xh,Ro,Rh,Dn,Fh,zh,$h,Fo,Eh,zo,jh,Mh,Gh,oe,$o,Ah,Be,Ph,In,Nh,Oh,Ps,Ch,Lh,Sh,yt,Dh,Ns,Ih,Wh,Eo,Hh,xt,jo,Bh,Os,Qh,id,Qe,Rt,Cs,Mo,Uh,Ls,Vh,cd,N,Go,Kh,Ue,Yh,Wn,Jh,Xh,Ss,Zh,eu,tu,Ft,ou,Ds,nu,ru,pe,su,Is,au,du,Hn,iu,cu,Ws,lu,pu,Bn,hu,uu,mu,S,gu,Qn,_u,fu,Hs,vu,bu,Bs,Tu,wu,Qs,ku,qu,Us,yu,xu,Un,Ru,Fu,Vs,zu,$u,Vn,Eu,ju,Ks,Mu,Gu,Au,Ao,Pu,Kn,Nu,Ou,Cu,Po,Lu,No,Su,Du,Iu,Ys,Wu,Hu,ne,Oo,Bu,Ve,Qu,Yn,Uu,Vu,Js,Ku,Yu,Ju,zt,Xu,Xs,Zu,em,Co,ld,Ke,$t,Zs,Lo,tm,ea,om,pd,F,So,nm,Ye,rm,Jn,sm,am,ta,dm,im,cm,Et,lm,oa,pm,hm,na,um,mm,he,gm,ra,_m,fm,Xn,vm,bm,sa,Tm,wm,Zn,km,qm,ym,D,xm,er,Rm,Fm,aa,zm,$m,da,Em,jm,ia,Mm,Gm,ca,Am,Pm,tr,Nm,Om,la,Cm,Lm,or,Sm,Dm,pa,Im,Wm,Hm,Do,Bm,nr,Qm,Um,Vm,Io,Km,Wo,Ym,Jm,Xm,ha,Zm,eg,re,Ho,tg,Je,og,rr,ng,rg,ua,sg,ag,dg,jt,ig,ma,cg,lg,Bo,pg,Mt,Qo,hg,Uo,ug,sr,mg,gg,hd,Xe,Gt,ga,Vo,_g,_a,fg,ud,z,Ko,vg,Ze,bg,ar,Tg,wg,fa,kg,qg,yg,At,xg,va,Rg,Fg,ba,zg,$g,ue,Eg,Ta,jg,Mg,dr,Gg,Ag,wa,Pg,Ng,ir,Og,Cg,Lg,I,Sg,cr,Dg,Ig,ka,Wg,Hg,qa,Bg,Qg,ya,Ug,Vg,xa,Kg,Yg,lr,Jg,Xg,Ra,Zg,e_,pr,t_,o_,Fa,n_,r_,s_,Yo,a_,hr,d_,i_,c_,Jo,l_,Xo,p_,h_,u_,za,m_,g_,se,Zo,__,et,f_,ur,v_,b_,$a,T_,w_,k_,Pt,q_,Ea,y_,x_,en,R_,Nt,tn,F_,ja,z_,md;return g=new _e({}),Ct=new _e({}),Dt=new _e({}),It=new j({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16619/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
<a href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"doc_sep"},{anchor:"transformers.RagConfig.n_docs",description:`<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to 5) &#x2014;
...
<a href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"retrieval_batch_size"},{anchor:"transformers.RagConfig.dataset",description:`<strong>dataset</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;wiki_dpr&quot;</code>) &#x2014;
...
generator_tokenizer.`,name:"question_encoder_tokenizer"},{anchor:"transformers.RagRetriever.generator_tokenizer",description:`<strong>generator_tokenizer</strong> (<a href="/docs/transformers/pr_16619/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.RagConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(input_ids=inputs[<span class="hljs-string">&quot;input_ids&quot;</span>])`}}),go=new _e({}),_o=new j({props:{name:"class transformers.RagSequenceForGeneration",anchor:"transformers.RagSequenceForGeneration",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"question_encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"generator",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"retriever",val:": typing.Optional[transformers.models.rag.retrieval_rag.RagRetriever] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16619/src/transformers/models/rag/modeling_rag.py#L737",parametersDescription:[{anchor:"transformers.RagSequenceForGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_16619/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate)</code>
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/pr_16619/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],returnDescription:`
<p>The generated
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_16619/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
`,returnType:`
<p><code>torch.LongTensor</code> of shape <code>(batch_size * num_return_sequences, sequence_length)</code></p>
`}}),Mo=new _e({}),Go=new j({props:{name:"class transformers.TFRagModel",anchor:"transformers.TFRagModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16619/src/transformers/models/rag/modeling_tf_rag.py#L483",parametersDescription:[{anchor:"transformers.TFRagModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.TFRagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagSequenceForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16619/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16619/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_16619/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
...
`),Sn=r("a"),wh=t("T5ForConditionalGeneration"),kh=t(" as the "),As=r("code"),qh=t("generator"),yh=t("."),xh=c(),Ro=r("p"),Rh=t("This model inherits from "),Dn=r("a"),Fh=t("PreTrainedModel"),zh=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$h=c(),Fo=r("p"),Eh=t("This model is also a PyTorch "),zo=r("a"),jh=t("torch.nn.Module"),Mh=t(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gh=c(),oe=r("div"),f($o.$$.fragment),Ah=c(),Be=r("p"),Ph=t("The "),In=r("a"),Nh=t("RagTokenForGeneration"),Oh=t(" forward method, overrides the "),Ps=r("code"),Ch=t("__call__"),Lh=t(" special method."),Sh=c(),f(yt.$$.fragment),Dh=c(),Ns=r("p"),Ih=t("Example:"),Wh=c(),f(Eo.$$.fragment),Hh=c(),xt=r("div"),f(jo.$$.fragment),Bh=c(),Os=r("p"),Qh=t("Implements RAG token decoding."),id=c(),Qe=r("h2"),Rt=r("a"),Cs=r("span"),f(Mo.$$.fragment),Uh=c(),Ls=r("span"),Vh=t("TFRagModel"),cd=c(),N=r("div"),f(Go.$$.fragment),Kh=c(),Ue=r("p"),Yh=t("The "),Wn=r("a"),Jh=t("TFRagModel"),Xh=t(" forward method, overrides the "),Ss=r("code"),Zh=t("__call__"),eu=t(" special method."),tu=c(),f(Ft.$$.fragment),ou=c(),Ds=r("p"),nu=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
