import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as ma,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as T,v as fa}from"../../chunks/vendor-6b77c823.js";import{T as ca}from"../../chunks/Tip-39098574.js";import{D as Ue}from"../../chunks/Docstring-abef54e3.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as vt}from"../../chunks/IconCopyLink-7a11ce68.js";function ga(He){let u,D,m,B,x;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(w,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(y,w){p(y,u,w),e(u,D),e(u,m),e(m,B),e(u,x)},d(y){y&&o(u)}}}function _a(He){let u,D,m,B,x;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=n("Module"),x=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(w,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(y,w){p(y,u,w),e(u,D),e(u,m),e(m,B),e(u,x)},d(y){y&&o(u)}}}function ba(He){let u,D,m,B,x,y,w,S,Do,Kt,R,Y,kt,ie,So,Tt,Mo,Qt,M,Ao,Ve,No,Fo,de,Lo,Oo,Xt,Je,Io,Yt,Ke,yt,Ro,Zt,Qe,Wo,eo,Xe,le,Uo,Ye,Ho,Vo,to,ce,oo,Ze,he,Jo,et,Ko,Qo,no,pe,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,N,an,ue,dn,ln,me,cn,hn,io,W,ee,Bt,fe,pn,zt,un,lo,$,ge,mn,_e,fn,$t,gn,_n,bn,U,vn,rt,kn,Tn,st,yn,wn,En,Gt,Bn,zn,be,co,H,te,qt,ve,$n,Pt,Gn,ho,C,ke,qn,Te,Pn,ye,jn,xn,Cn,we,Dn,at,Sn,Mn,An,it,Ee,po,V,oe,jt,Be,Nn,xt,Fn,uo,f,ze,Ln,Ct,On,In,$e,Rn,dt,Wn,Un,Hn,Ge,Vn,qe,Jn,Kn,Qn,Pe,Xn,je,Yn,Zn,er,J,tr,lt,or,nr,xe,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,mr,fr,Nt,gr,_r,Ft,br,vr,kr,q,Ce,Tr,K,yr,ct,wr,Er,Lt,Br,zr,$r,ne,Gr,Ot,qr,Pr,De,mo,Q,re,It,Se,jr,Rt,xr,fo,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Ne,Nr,ht,Fr,Lr,Or,Fe,Ir,Le,Rr,Wr,Ur,P,Oe,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,go;return y=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16619/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),D=l(),m=s("h1"),B=s("a"),x=s("span"),g(y.$$.fragment),w=l(),S=s("span"),Do=n("BertGeneration"),Kt=l(),R=s("h2"),Y=s("a"),kt=s("span"),g(ie.$$.fragment),So=l(),Tt=s("span"),Mo=n("Overview"),Qt=l(),M=s("p"),Ao=n(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ve=s("a"),No=n("EncoderDecoderModel"),Fo=n(" as proposed in "),de=s("a"),Lo=n(`Leveraging Pre-trained Checkpoints for Sequence Generation
...
found `),me=s("a"),cn=n("here"),hn=n("."),io=l(),W=s("h2"),ee=s("a"),Bt=s("span"),g(fe.$$.fragment),pn=l(),zt=s("span"),un=n("BertGenerationConfig"),lo=l(),$=s("div"),g(ge.$$.fragment),mn=l(),_e=s("p"),fn=n("This is the configuration class to store the configuration of a "),$t=s("code"),gn=n("BertGenerationPreTrainedModel"),_n=n(`. It is used to
...
this superclass for more information regarding those methods.`),An=l(),it=s("div"),g(Ee.$$.fragment),po=l(),V=s("h2"),oe=s("a"),jt=s("span"),g(Be.$$.fragment),Nn=l(),xt=s("span"),Fn=n("BertGenerationEncoder"),uo=l(),f=s("div"),g(ze.$$.fragment),Ln=l(),Ct=s("p"),On=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=l(),$e=s("p"),Rn=n("This model inherits from "),dt=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
`),At=s("code"),mr=n("add_cross_attention"),fr=n(" set to "),Nt=s("code"),gr=n("True"),_r=n("; an "),Ft=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=l(),q=s("div"),g(Ce.$$.fragment),Tr=l(),K=s("p"),yr=n("The "),ct=s("a"),wr=n("BertGenerationEncoder"),Er=n(" forward method, overrides the "),Lt=s("code"),Br=n("__call__"),zr=n(" special method."),$r=l(),g(ne.$$.fragment),Gr=l(),Ot=s("p"),qr=n("Example:"),Pr=l(),g(De.$$.fragment),mo=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Se.$$.fragment),jr=l(),Rt=s("span"),xr=n("BertGenerationDecoder"),fo=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=n("BertGeneration Model with a "),Wt=s("code"),Sr=n("language modeling"),Mr=n(" head on top for CLM fine-tuning."),Ar=l(),Ne=s("p"),Nr=n("This model inherits from "),ht=s("a"),Fr=n("PreTrainedModel"),Lr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Or=l(),Fe=s("p"),Ir=n("This model is also a PyTorch "),Le=s("a"),Rr=n("torch.nn.Module"),Wr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ur=l(),P=s("div"),g(Oe.$$.fragment),Hr=l(),X=s("p"),Vr=n("The "),pt=s("a"),Jr=n("BertGenerationDecoder"),Kr=n(" forward method, overrides the "),Ut=s("code"),Qr=n("__call__"),Xr=n(" special method."),Yr=l(),g(se.$$.fragment),Zr=l(),Ht=s("p"),es=n("Example:"),ts=l(),g(Ie.$$.fragment),this.h()},l(t){const h=ma('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(o),D=c(t),m=a(t,"H1",{class:!0});var Re=i(m);B=a(Re,"A",{id:!0,class:!0,href:!0});var Vt=i(B);x=a(Vt,"SPAN",{});var os=i(x);_(y.$$.fragment,os),os.forEach(o),Vt.forEach(o),w=c(Re),S=a(Re,"SPAN",{});var ns=i(S);Do=r(ns,"BertGeneration"),ns.forEach(o),Re.forEach(o),Kt=c(t),R=a(t,"H2",{class:!0});var _o=i(R);Y=a(_o,"A",{id:!0,class:!0,href:!0});var rs=i(Y);kt=a(rs,"SPAN",{});var ss=i(kt);_(ie.$$.fragment,ss),ss.forEach(o),rs.forEach(o),So=c(_o),Tt=a(_o,"SPAN",{});var as=i(Tt);Mo=r(as,"Overview"),as.forEach(o),_o.forEach(o),Qt=c(t),M=a(t,"P",{});var ut=i(M);Ao=r(ut,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ve=a(ut,"A",{href:!0});var is=i(Ve);No=r(is,"EncoderDecoderModel"),is.forEach(o),Fo=r(ut," as proposed in "),de=a(ut,"A",{href:!0,rel:!0});var ds=i(de);Lo=r(ds,`Leveraging Pre-trained Checkpoints for Sequence Generation
...
`),At=a(j,"CODE",{});var Ks=i(At);mr=r(Ks,"add_cross_attention"),Ks.forEach(o),fr=r(j," set to "),Nt=a(j,"CODE",{});var Qs=i(Nt);gr=r(Qs,"True"),Qs.forEach(o),_r=r(j,"; an "),Ft=a(j,"CODE",{});var Xs=i(Ft);br=r(Xs,"encoder_hidden_states"),Xs.forEach(o),vr=r(j," is then expected as an input to the forward pass."),j.forEach(o),kr=c(z),q=a(z,"DIV",{class:!0});var L=i(q);_(Ce.$$.fragment,L),Tr=c(L),K=a(L,"P",{});var _t=i(K);yr=r(_t,"The "),ct=a(_t,"A",{href:!0});var Ys=i(ct);wr=r(Ys,"BertGenerationEncoder"),Ys.forEach(o),Er=r(_t," forward method, overrides the "),Lt=a(_t,"CODE",{});var Zs=i(Lt);Br=r(Zs,"__call__"),Zs.forEach(o),zr=r(_t," special method."),_t.forEach(o),$r=c(L),_(ne.$$.fragment,L),Gr=c(L),Ot=a(L,"P",{});var ea=i(Ot);qr=r(ea,"Example:"),ea.forEach(o),Pr=c(L),_(De.$$.fragment,L),L.forEach(o),z.forEach(o),mo=c(t),Q=a(t,"H2",{class:!0});var Po=i(Q);re=a(Po,"A",{id:!0,class:!0,href:!0});var ta=i(re);It=a(ta,"SPAN",{});var oa=i(It);_(Se.$$.fragment,oa),oa.forEach(o),ta.forEach(o),jr=c(Po),Rt=a(Po,"SPAN",{});var na=i(Rt);xr=r(na,"BertGenerationDecoder"),na.forEach(o),Po.forEach(o),fo=c(t),G=a(t,"DIV",{class:!0});var O=i(G);_(Me.$$.fragment,O),Cr=c(O),Ae=a(O,"P",{});var jo=i(Ae);Dr=r(jo,"BertGeneration Model with a "),Wt=a(jo,"CODE",{});var ra=i(Wt);Sr=r(ra,"language modeling"),ra.forEach(o),Mr=r(jo," head on top for CLM fine-tuning."),jo.forEach(o),Ar=c(O),Ne=a(O,"P",{});var xo=i(Ne);Nr=r(xo,"This model inherits from "),ht=a(xo,"A",{href:!0});var sa=i(ht);Fr=r(sa,"PreTrainedModel"),sa.forEach(o),Lr=r(xo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xo.forEach(o),Or=c(O),Fe=a(O,"P",{});var Co=i(Fe);Ir=r(Co,"This model is also a PyTorch "),Le=a(Co,"A",{href:!0,rel:!0});var aa=i(Le);Rr=r(aa,"torch.nn.Module"),aa.forEach(o),Wr=r(Co,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Co.forEach(o),Ur=c(O),P=a(O,"DIV",{class:!0});var I=i(P);_(Oe.$$.fragment,I),Hr=c(I),X=a(I,"P",{});var bt=i(X);Vr=r(bt,"The "),pt=a(bt,"A",{href:!0});var ia=i(pt);Jr=r(ia,"BertGenerationDecoder"),ia.forEach(o),Kr=r(bt," forward method, overrides the "),Ut=a(bt,"CODE",{});var da=i(Ut);Qr=r(da,"__call__"),da.forEach(o),Xr=r(bt," special method."),bt.forEach(o),Yr=c(I),_(se.$$.fragment,I),Zr=c(I),Ht=a(I,"P",{});var la=i(Ht);es=r(la,"Example:"),la.forEach(o),ts=c(I),_(Ie.$$.fragment,I),I.forEach(o),O.forEach(o),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(va)),d(B,"id","bertgeneration"),d(B,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(B,"href","#bertgeneration"),d(m,"class","relative group"),d(Y,"id","overview"),d(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Y,"href","#overview"),d(R,"class","relative group"),d(Ve,"href","/docs/transformers/pr_16619/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(de,"href","https://arxiv.org/abs/1907.12461"),d(de,"rel","nofollow"),d(Ye,"href","/docs/transformers/pr_16619/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(et,"href","/docs/transformers/pr_16619/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(ot,"href","/docs/transformers/pr_16619/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(nt,"href","/docs/transformers/pr_16619/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(ue,"href","https://huggingface.co/patrickvonplaten"),d(ue,"rel","nofollow"),d(me,"href","https://tfhub.dev/s?module-type=text-generation&subtype=module,placeholder"),d(me,"rel","nofollow"),d(ee,"id","transformers.BertGenerationConfig"),d(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ee,"href","#transformers.BertGenerationConfig"),d(W,"class","relative group"),d(rt,"href","/docs/transformers/pr_16619/en/main_classes/configuration#transformers.PretrainedConfig"),d(st,"href","/docs/transformers/pr_16619/en/main_classes/configuration#transformers.PretrainedConfig"),d($,"class","docstring"),d(te,"id","transformers.BertGenerationTokenizer"),d(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(te,"href","#transformers.BertGenerationTokenizer"),d(H,"class","relative group"),d(ye,"href","https://github.com/google/sentencepiece"),d(ye,"rel","nofollow"),d(at,"href","/docs/transformers/pr_16619/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d(it,"class","docstring"),d(C,"class","docstring"),d(oe,"id","transformers.BertGenerationEncoder"),d(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(oe,"href","#transformers.BertGenerationEncoder"),d(V,"class","relative group"),d(dt,"href","/docs/transformers/pr_16619/en/main_classes/model#transformers.PreTrainedModel"),d(qe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(qe,"rel","nofollow"),d(je,"href","https://arxiv.org/abs/1706.03762"),d(je,"rel","nofollow"),d(lt,"href","/docs/transformers/pr_16619/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(xe,"href","https://arxiv.org/abs/1907.12461"),d(xe,"rel","nofollow"),d(ct,"href","/docs/transformers/pr_16619/en/model_doc/bert-generation#transformers.BertGenerationEncoder"),d(q,"class","docstring"),d(f,"class","docstring"),d(re,"id","transformers.BertGenerationDecoder"),d(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(re,"href","#transformers.BertGenerationDecoder"),d(Q,"class","relative group"),d(ht,"href","/docs/transformers/pr_16619/en/main_classes/model#transformers.PreTrainedModel"),d(Le,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Le,"rel","nofollow"),d(pt,"href","/docs/transformers/pr_16619/en/model_doc/bert-generation#transformers.BertGenerationDecoder"),d(P,"class","docstring"),d(G,"class","docstring")},m(t,h){e(document.head,u),p(t,D,h),p(t,m,h),e(m,B),e(B,x),b(y,x,null),e(m,w),e(m,S),e(S,Do),p(t,Kt,h),p(t,R,h),e(R,Y),e(Y,kt),b(ie,kt,null),e(R,So),e(R,Tt),e(Tt,Mo),p(t,Qt,h),p(t,M,h),e(M,Ao),e(M,Ve),e(Ve,No),e(M,Fo),e(M,de),e(de,Lo),e(M,Oo),p(t,Xt,h),p(t,Je,h),e(Je,Io),p(t,Yt,h),p(t,Ke,h),e(Ke,yt),e(yt,Ro),p(t,Zt,h),p(t,Qe,h),e(Qe,Wo),p(t,eo,h),p(t,Xe,h),e(Xe,le),e(le,Uo),e(le,Ye),e(Ye,Ho),e(le,Vo),p(t,to,h),b(ce,t,h),p(t,oo,h),p(t,Ze,h),e(Ze,he),e(he,Jo),e(he,et),e(et,Ko),e(he,Qo),p(t,no,h),b(pe,t,h),p(t,ro,h),p(t,tt,h),e(tt,Xo),p(t,so,h),p(t,Z,h),e(Z,A),e(A,ot),e(ot,Yo),e(A,Zo),e(A,nt),e(nt,en),e(A,tn),e(A,wt),e(wt,on),e(A,nn),e(Z,rn),e(Z,Et),e(Et,sn),p(t,ao,h),p(t,N,h),e(N,an),e(N,ue),e(ue,dn),e(N,ln),e(N,me),e(me,cn),e(N,hn),p(t,io,h),p(t,W,h),e(W,ee),e(ee,Bt),b(fe,Bt,null),e(W,pn),e(W,zt),e(zt,un),p(t,lo,h),p(t,$,h),b(ge,$,null),e($,mn),e($,_e),e(_e,fn),e(_e,$t),e($t,gn),e(_e,_n),e($,bn),e($,U),e(U,vn),e(U,rt),e(rt,kn),e(U,Tn),e(U,st),e(st,yn),e(U,wn),e($,En),e($,Gt),e(Gt,Bn),e($,zn),b(be,$,null),p(t,co,h),p(t,H,h),e(H,te),e(te,qt),b(ve,qt,null),e(H,$n),e(H,Pt),e(Pt,Gn),p(t,ho,h),p(t,C,h),b(ke,C,null),e(C,qn),e(C,Te),e(Te,Pn),e(Te,ye),e(ye,jn),e(Te,xn),e(C,Cn),e(C,we),e(we,Dn),e(we,at),e(at,Sn),e(we,Mn),e(C,An),e(C,it),b(Ee,it,null),p(t,po,h),p(t,V,h),e(V,oe),e(oe,jt),b(Be,jt,null),e(V,Nn),e(V,xt),e(xt,Fn),p(t,uo,h),p(t,f,h),b(ze,f,null),e(f,Ln),e(f,Ct),e(Ct,On),e(f,In),e(f,$e),e($e,Rn),e($e,dt),e(dt,Wn),e($e,Un),e(f,Hn),e(f,Ge),e(Ge,Vn),e(Ge,qe),e(qe,Jn),e(Ge,Kn),e(f,Qn),e(f,Pe),e(Pe,Xn),e(Pe,je),e(je,Yn),e(Pe,Zn),e(f,er),e(f,J),e(J,tr),e(J,lt),e(lt,or),e(J,nr),e(J,xe),e(xe,rr),e(J,sr),e(f,ar),e(f,E),e(E,ir),e(E,Dt),e(Dt,dr),e(E,lr),e(E,St),e(St,cr),e(E,hr),e(E,Mt),e(Mt,pr),e(E,ur),e(E,At),e(At,mr),e(E,fr),e(E,Nt),e(Nt,gr),e(E,_r),e(E,Ft),e(Ft,br),e(E,vr),e(f,kr),e(f,q),b(Ce,q,null),e(q,Tr),e(q,K),e(K,yr),e(K,ct),e(ct,wr),e(K,Er),e(K,Lt),e(Lt,Br),e(K,zr),e(q,$r),b(ne,q,null),e(q,Gr),e(q,Ot),e(Ot,qr),e(q,Pr),b(De,q,null),p(t,mo,h),p(t,Q,h),e(Q,re),e(re,It),b(Se,It,null),e(Q,jr),e(Q,Rt),e(Rt,xr),p(t,fo,h),p(t,G,h),b(Me,G,null),e(G,Cr),e(G,Ae),e(Ae,Dr),e(Ae,Wt),e(Wt,Sr),e(Ae,Mr),e(G,Ar),e(G,Ne),e(Ne,Nr),e(Ne,ht),e(ht,Fr),e(Ne,Lr),e(G,Or),e(G,Fe),e(Fe,Ir),e(Fe,Le),e(Le,Rr),e(Fe,Wr),e(G,Ur),e(G,P),b(Oe,P,null),e(P,Hr),e(P,X),e(X,Vr),e(X,pt),e(pt,Jr),e(X,Kr),e(X,Ut),e(Ut,Qr),e(X,Xr),e(P,Yr),b(se,P,null),e(P,Zr),e(P,Ht),e(Ht,es),e(P,ts),b(Ie,P,null),go=!0},p(t,[h]){const Re={};h&2&&(Re.$$scope={dirty:h,ctx:t}),ne.$set(Re);const Vt={};h&2&&(Vt.$$scope={dirty:h,ctx:t}),se.$set(Vt)},i(t){go||(v(y.$$.fragment,t),v(ie.$$.fragment,t),v(ce.$$.fragment,t),v(pe.$$.fragment,t),v(fe.$$.fragment,t),v(ge.$$.fragment,t),v(be.$$.fragment,t),v(ve.$$.fragment,t),v(ke.$$.fragment,t),v(Ee.$$.fragment,t),v(Be.$$.fragment,t),v(ze.$$.fragment,t),v(Ce.$$.fragment,t),v(ne.$$.fragment,t),v(De.$$.fragment,t),v(Se.$$.fragment,t),v(Me.$$.fragment,t),v(Oe.$$.fragment,t),v(se.$$.fragment,t),v(Ie.$$.fragment,t),go=!0)},o(t){k(y.$$.fragment,t),k(ie.$$.fragment,t),k(ce.$$.fragment,t),k(pe.$$.fragment,t),k(fe.$$.fragment,t),k(ge.$$.fragment,t),k(be.$$.fragment,t),k(ve.$$.fragment,t),k(ke.$$.fragment,t),k(Ee.$$.fragment,t),k(Be.$$.fragment,t),k(ze.$$.fragment,t),k(Ce.$$.fragment,t),k(ne.$$.fragment,t),k(De.$$.fragment,t),k(Se.$$.fragment,t),k(Me.$$.fragment,t),k(Oe.$$.fragment,t),k(se.$$.fragment,t),k(Ie.$$.fragment,t),go=!1},d(t){o(u),t&&o(D),t&&o(m),T(y),t&&o(Kt),t&&o(R),T(ie),t&&o(Qt),t&&o(M),t&&o(Xt),t&&o(Je),t&&o(Yt),t&&o(Ke),t&&o(Zt),t&&o(Qe),t&&o(eo),t&&o(Xe),t&&o(to),T(ce,t),t&&o(oo),t&&o(Ze),t&&o(no),T(pe,t),t&&o(ro),t&&o(tt),t&&o(so),t&&o(Z),t&&o(ao),t&&o(N),t&&o(io),t&&o(W),T(fe),t&&o(lo),t&&o($),T(ge),T(be),t&&o(co),t&&o(H),T(ve),t&&o(ho),t&&o(C),T(ke),T(Ee),t&&o(po),t&&o(V),T(Be),t&&o(uo),t&&o(f),T(ze),T(Ce),T(ne),T(De),t&&o(mo),t&&o(Q),T(Se),t&&o(fo),t&&o(G),T(Me),T(Oe),T(se),T(Ie)}}}const va={local:"bertgeneration",sections:[{local:"overview",title:"Overview"},{local:"transformers.BertGenerationConfig",title:"BertGenerationConfig"},{local:"transformers.BertGenerationTokenizer",title:"BertGenerationTokenizer"},{local:"transformers.BertGenerationEncoder",title:"BertGenerationEncoder"},{local:"transformers.BertGenerationDecoder",title:"BertGenerationDecoder"}],title:"BertGeneration"};function ka(He){return fa(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class za extends ha{constructor(u){super();pa(this,u,ka,ba,ua,{})}}export{za as default,va as metadata};
