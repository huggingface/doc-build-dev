...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17533/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17533/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17533/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qv=p(),dt=n("div"),y(qr.$$.fragment),Vv=p(),Lo=n("p"),Jv=r("The "),bd=n("a"),Kv=r("RobertaForQuestionAnswering"),Gv=r(" forward method, overrides the "),pp=n("code"),Xv=r("__call__"),Yv=r(" special method."),Zv=p(),y(Zn.$$.fragment),ey=p(),y(es.$$.fragment),ty=p(),y(ts.$$.fragment),hf=p(),Ao=n("h2"),os=n("a"),hp=n("span"),y(jr.$$.fragment),oy=p(),mp=n("span"),ny=r("TFRobertaModel"),mf=p(),Qe=n("div"),y(Pr.$$.fragment),sy=p(),fp=n("p"),ay=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),ry=p(),Lr=n("p"),iy=r("This model inherits from "),kd=n("a"),ly=r("TFPreTrainedModel"),dy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cy=p(),Ar=n("p"),py=r("This model is also a "),Or=n("a"),hy=r("tf.keras.Model"),my=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fy=p(),y(ns.$$.fragment),uy=p(),Rt=n("div"),y(Nr.$$.fragment),gy=p(),Oo=n("p"),_y=r("The "),vd=n("a"),by=r("TFRobertaModel"),ky=r(" forward method, overrides the "),up=n("code"),vy=r("__call__"),yy=r(" special method."),Ty=p(),y(ss.$$.fragment),wy=p(),y(as.$$.fragment),ff=p(),No=n("h2"),rs=n("a"),gp=n("span"),y(Ir.$$.fragment),$y=p(),_p=n("span"),Fy=r("TFRobertaForCausalLM"),uf=p(),Io=n("div"),y(Dr.$$.fragment),xy=p(),Mt=n("div"),y(Sr.$$.fragment),Ry=p(),Do=n("p"),My=r("The "),yd=n("a"),Ey=r("TFRobertaForCausalLM"),zy=r(" forward method, overrides the "),bp=n("code"),Cy=r("__call__"),qy=r(" special method."),jy=p(),y(is.$$.fragment),Py=p(),y(ls.$$.fragment),gf=p(),So=n("h2"),ds=n("a"),kp=n("span"),y(Wr.$$.fragment),Ly=p(),vp=n("span"),Ay=r("TFRobertaForMaskedLM"),_f=p(),Ve=n("div"),y(Br.$$.fragment),Oy=p(),Ur=n("p"),Ny=r("RoBERTa Model with a "),yp=n("code"),Iy=r("language modeling"),Dy=r(" head on top."),Sy=p(),Hr=n("p"),Wy=r("This model inherits from "),Td=n("a"),By=r("TFPreTrainedModel"),Uy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hy=p(),Qr=n("p"),Qy=r("This model is also a "),Vr=n("a"),Vy=r("tf.keras.Model"),Jy=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ky=p(),y(cs.$$.fragment),Gy=p(),ct=n("div"),y(Jr.$$.fragment),Xy=p(),Wo=n("p"),Yy=r("The "),wd=n("a"),Zy=r("TFRobertaForMaskedLM"),eT=r(" forward method, overrides the "),Tp=n("code"),tT=r("__call__"),oT=r(" special method."),nT=p(),y(ps.$$.fragment),sT=p(),y(hs.$$.fragment),aT=p(),y(ms.$$.fragment),bf=p(),Bo=n("h2"),fs=n("a"),wp=n("span"),y(Kr.$$.fragment),rT=p(),$p=n("span"),iT=r("TFRobertaForSequenceClassification"),kf=p(),Je=n("div"),y(Gr.$$.fragment),lT=p(),Fp=n("p"),dT=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bT=p(),y(us.$$.fragment),kT=p(),pt=n("div"),y(ei.$$.fragment),vT=p(),Uo=n("p"),yT=r("The "),Fd=n("a"),TT=r("TFRobertaForSequenceClassification"),wT=r(" forward method, overrides the "),xp=n("code"),$T=r("__call__"),FT=r(" special method."),xT=p(),y(gs.$$.fragment),RT=p(),y(_s.$$.fragment),MT=p(),y(bs.$$.fragment),vf=p(),Ho=n("h2"),ks=n("a"),Rp=n("span"),y(ti.$$.fragment),ET=p(),Mp=n("span"),zT=r("TFRobertaForMultipleChoice"),yf=p(),Ke=n("div"),y(oi.$$.fragment),CT=p(),Ep=n("p"),qT=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ST=p(),y(vs.$$.fragment),WT=p(),Et=n("div"),y(ri.$$.fragment),BT=p(),Qo=n("p"),UT=r("The "),Rd=n("a"),HT=r("TFRobertaForMultipleChoice"),QT=r(" forward method, overrides the "),zp=n("code"),VT=r("__call__"),JT=r(" special method."),KT=p(),y(ys.$$.fragment),GT=p(),y(Ts.$$.fragment),Tf=p(),Vo=n("h2"),ws=n("a"),Cp=n("span"),y(ii.$$.fragment),XT=p(),qp=n("span"),YT=r("TFRobertaForTokenClassification"),wf=p(),Ge=n("div"),y(li.$$.fragment),ZT=p(),jp=n("p"),ew=r(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dw=p(),y($s.$$.fragment),cw=p(),ht=n("div"),y(hi.$$.fragment),pw=p(),Jo=n("p"),hw=r("The "),Ed=n("a"),mw=r("TFRobertaForTokenClassification"),fw=r(" forward method, overrides the "),Pp=n("code"),uw=r("__call__"),gw=r(" special method."),_w=p(),y(Fs.$$.fragment),bw=p(),y(xs.$$.fragment),kw=p(),y(Rs.$$.fragment),$f=p(),Ko=n("h2"),Ms=n("a"),Lp=n("span"),y(mi.$$.fragment),vw=p(),Ap=n("span"),yw=r("TFRobertaForQuestionAnswering"),Ff=p(),Xe=n("div"),y(fi.$$.fragment),Tw=p(),Go=n("p"),ww=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Aw=p(),y(Es.$$.fragment),Ow=p(),mt=n("div"),y(bi.$$.fragment),Nw=p(),Xo=n("p"),Iw=r("The "),Cd=n("a"),Dw=r("TFRobertaForQuestionAnswering"),Sw=r(" forward method, overrides the "),Ip=n("code"),Ww=r("__call__"),Bw=r(" special method."),Uw=p(),y(zs.$$.fragment),Hw=p(),y(Cs.$$.fragment),Qw=p(),y(qs.$$.fragment),xf=p(),Yo=n("h2"),js=n("a"),Dp=n("span"),y(ki.$$.fragment),Vw=p(),Sp=n("span"),Jw=r("FlaxRobertaModel"),Rf=p(),Oe=n("div"),y(vi.$$.fragment),Kw=p(),Wp=n("p"),Gw=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Xw=p(),yi=n("p"),Yw=r("This model inherits from "),qd=n("a"),Zw=r("FlaxPreTrainedModel"),e1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),t1=p(),Ti=n("p"),o1=r("This model is also a Flax Linen "),wi=n("a"),n1=r("flax.linen.Module"),s1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),a1=p(),Bp=n("p"),r1=r("Finally, this model supports inherent JAX features such as:"),i1=p(),Ut=n("ul"),Up=n("li"),$i=n("a"),l1=r("Just-In-Time (JIT) compilation"),d1=p(),Hp=n("li"),Fi=n("a"),c1=r("Automatic Differentiation"),p1=p(),Qp=n("li"),xi=n("a"),h1=r("Vectorization"),m1=p(),Vp=n("li"),Ri=n("a"),f1=r("Parallelization"),u1=p(),zt=n("div"),y(Mi.$$.fragment),g1=p(),Zo=n("p"),_1=r("The "),Jp=n("code"),b1=r("FlaxRobertaPreTrainedModel"),k1=r(" forward method, overrides the "),Kp=n("code"),v1=r("__call__"),y1=r(" special method."),T1=p(),y(Ps.$$.fragment),w1=p(),y(Ls.$$.fragment),Mf=p(),en=n("h2"),As=n("a"),Gp=n("span"),y(Ei.$$.fragment),$1=p(),Xp=n("span"),F1=r("FlaxRobertaForCausalLM"),Ef=p(),Ne=n("div"),y(zi.$$.fragment),x1=p(),Yp=n("p"),R1=r(`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A1=p(),Zp=n("p"),O1=r("Finally, this model supports inherent JAX features such as:"),N1=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),I1=r("Just-In-Time (JIT) compilation"),D1=p(),th=n("li"),Li=n("a"),S1=r("Automatic Differentiation"),W1=p(),oh=n("li"),Ai=n("a"),B1=r("Vectorization"),U1=p(),nh=n("li"),Oi=n("a"),H1=r("Parallelization"),Q1=p(),Ct=n("div"),y(Ni.$$.fragment),V1=p(),tn=n("p"),J1=r("The "),sh=n("code"),K1=r("FlaxRobertaPreTrainedModel"),G1=r(" forward method, overrides the "),ah=n("code"),X1=r("__call__"),Y1=r(" special method."),Z1=p(),y(Os.$$.fragment),e$=p(),y(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),y(Ii.$$.fragment),t$=p(),ih=n("span"),o$=r("FlaxRobertaForMaskedLM"),Cf=p(),Ie=n("div"),y(Di.$$.fragment),n$=p(),Si=n("p"),s$=r("RoBERTa Model with a "),lh=n("code"),a$=r("language modeling"),r$=r(" head on top."),i$=p(),Wi=n("p"),l$=r("This model inherits from "),Pd=n("a"),d$=r("FlaxPreTrainedModel"),c$=r(`. Check the superclass documentation for the generic methods the
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Uf.forEach(t),M_=h(Ye),T(Rn.$$.fragment,Ye),E_=h(Ye),Ia=s(Ye,"P",{});var Hf=a(Ia);z_=i(Hf,"This tokenizer inherits from "),nd=s(Hf,"A",{href:!0});var d0=a(nd);C_=i(d0,"PreTrainedTokenizerFast"),d0.forEach(t),q_=i(Hf,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hf.forEach(t),j_=h(Ye),sd=s(Ye,"DIV",{class:!0});var c0=a(sd);T(Da.$$.fragment,c0),c0.forEach(t),Ye.forEach(t),Xm=h(o),yo=s(o,"H2",{class:!0});var Qf=a(yo);Mn=s(Qf,"A",{id:!0,class:!0,href:!0});var p0=a(Mn);Ec=s(p0,"SPAN",{});var h0=a(Ec);T(Sa.$$.fragment,h0),h0.forEach(t),p0.forEach(t),P_=h(Qf),zc=s(Qf,"SPAN",{});var m0=a(zc);L_=i(m0,"RobertaModel"),m0.forEach(t),Qf.forEach(t),Ym=h(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);T(Wa.$$.fragment,Ze),A_=h(Ze),Cc=s(Ze,"P",{});var f0=a(Cc);O_=i(f0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),f0.forEach(t),N_=h(Ze),Ba=s(Ze,"P",{});var Vf=a(Ba);I_=i(Vf,"This model inherits from "),ad=s(Vf,"A",{href:!0});var u0=a(ad);D_=i(u0,"PreTrainedModel"),u0.forEach(t),S_=i(Vf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),Ac=s(ft,"CODE",{});var y0=a(Ac);sb=i(y0,"add_cross_attention"),y0.forEach(t),ab=i(ft," set to "),Oc=s(ft,"CODE",{});var T0=a(Oc);rb=i(T0,"True"),T0.forEach(t),ib=i(ft,"; an "),Nc=s(ft,"CODE",{});var w0=a(Nc);lb=i(w0,"encoder_hidden_states"),w0.forEach(t),db=i(ft," is then expected as an input to the forward pass."),ft.forEach(t),cb=h(Ze),En=s(Ze,"P",{});var Bm=a(En);pb=i(Bm,".. _"),Ic=s(Bm,"EM",{});var $0=a(Ic);hb=i($0,"Attention is all you need"),$0.forEach(t),mb=i(Bm,": "),Va=s(Bm,"A",{href:!0,rel:!0});var F0=a(Va);fb=i(F0,"https://arxiv.org/abs/1706.03762"),F0.forEach(t),Bm.forEach(t),ub=h(Ze),$t=s(Ze,"DIV",{class:!0});var ea=a($t);T(Ja.$$.fragment,ea),gb=h(ea),To=s(ea,"P",{});var Wd=a(To);_b=i(Wd,"The "),rd=s(Wd,"A",{href:!0});var x0=a(rd);bb=i(x0,"RobertaModel"),x0.forEach(t),kb=i(Wd," forward method, overrides the "),Dc=s(Wd,"CODE",{});var R0=a(Dc);vb=i(R0,"__call__"),R0.forEach(t),yb=i(Wd," special method."),Wd.forEach(t),Tb=h(ea),T(zn.$$.fragment,ea),wb=h(ea),T(Cn.$$.fragment,ea),ea.forEach(t),Ze.forEach(t),Zm=h(o),wo=s(o,"H2",{class:!0});var Gf=a(wo);qn=s(Gf,"A",{id:!0,class:!0,href:!0});var M0=a(qn);Sc=s(M0,"SPAN",{});var E0=a(Sc);T(Ka.$$.fragment,E0),E0.forEach(t),M0.forEach(t),$b=h(Gf),Wc=s(Gf,"SPAN",{});var z0=a(Wc);Fb=i(z0,"RobertaForCausalLM"),z0.forEach(t),Gf.forEach(t),ef=h(o),tt=s(o,"DIV",{class:!0});var oo=a(tt);T(Ga.$$.fragment,oo),xb=h(oo),Xa=s(oo,"P",{});var Xf=a(Xa);Rb=i(Xf,"RoBERTa Model with a "),Bc=s(Xf,"CODE",{});var C0=a(Bc);Mb=i(C0,"language modeling"),C0.forEach(t),Eb=i(Xf," head on top for CLM fine-tuning."),Xf.forEach(t),zb=h(oo),Ya=s(oo,"P",{});var Yf=a(Ya);Cb=i(Yf,"This model inherits from "),id=s(Yf,"A",{href:!0});var q0=a(id);qb=i(q0,"PreTrainedModel"),q0.forEach(t),jb=i(Yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nu.forEach(t),ik=h(no),it=s(no,"DIV",{class:!0});var so=a(it);T(lr.$$.fragment,so),lk=h(so),xo=s(so,"P",{});var Ud=a(xo);dk=i(Ud,"The "),cd=s(Ud,"A",{href:!0});var W0=a(cd);ck=i(W0,"RobertaForMaskedLM"),W0.forEach(t),pk=i(Ud," forward method, overrides the "),Jc=s(Ud,"CODE",{});var B0=a(Jc);hk=i(B0,"__call__"),B0.forEach(t),mk=i(Ud," special method."),Ud.forEach(t),fk=h(so),T(An.$$.fragment,so),uk=h(so),T(On.$$.fragment,so),gk=h(so),T(Nn.$$.fragment,so),so.forEach(t),no.forEach(t),nf=h(o),Ro=s(o,"H2",{class:!0});var su=a(Ro);In=s(su,"A",{id:!0,class:!0,href:!0});var U0=a(In);Kc=s(U0,"SPAN",{});var H0=a(Kc);T(dr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),_k=h(su),Gc=s(su,"SPAN",{});var Q0=a(Gc);bk=i(Q0,"RobertaForSequenceClassification"),Q0.forEach(t),su.forEach(t),sf=h(o),nt=s(o,"DIV",{class:!0});var ao=a(nt);T(cr.$$.fragment,ao),kk=h(ao),Xc=s(ao,"P",{});var V0=a(Xc);vk=i(V0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V0.forEach(t),yk=h(ao),pr=s(ao,"P",{});var au=a(pr);Tk=i(au,"This model inherits from "),pd=s(au,"A",{href:!0});var J0=a(pd);wk=i(J0,"PreTrainedModel"),J0.forEach(t),$k=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var ut=a(Ue);T(fr.$$.fragment,ut),zk=h(ut),Mo=s(ut,"P",{});var Hd=a(Mo);Ck=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var G0=a(hd);qk=i(G0,"RobertaForSequenceClassification"),G0.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var X0=a(Yc);Pk=i(X0,"__call__"),X0.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(ut),T(Dn.$$.fragment,ut),Ok=h(ut),T(Sn.$$.fragment,ut),Nk=h(ut),T(Wn.$$.fragment,ut),Ik=h(ut),T(Bn.$$.fragment,ut),Dk=h(ut),T(Un.$$.fragment,ut),ut.forEach(t),ao.forEach(t),af=h(o),Eo=s(o,"H2",{class:!0});var iu=a(Eo);Hn=s(iu,"A",{id:!0,class:!0,href:!0});var Y0=a(Hn);Zc=s(Y0,"SPAN",{});var Z0=a(Zc);T(ur.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),Sk=h(iu),ep=s(iu,"SPAN",{});var e3=a(ep);Wk=i(e3,"RobertaForMultipleChoice"),e3.forEach(t),iu.forEach(t),rf=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);T(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var t3=a(tp);Uk=i(t3,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t3.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lu=a(_r);Qk=i(lu,"This model inherits from "),md=s(lu,"A",{href:!0});var o3=a(md);Vk=i(o3,"PreTrainedModel"),o3.forEach(t),Jk=i(lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lu.forEach(t),Kk=h(ro),br=s(ro,"P",{});var du=a(br);Gk=i(du,"This model is also a PyTorch "),kr=s(du,"A",{href:!0,rel:!0});var n3=a(kr);Xk=i(n3,"torch.nn.Module"),n3.forEach(t),Yk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);T(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s3=a(fd);ov=i(s3,"RobertaForMultipleChoice"),s3.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a3=a(op);sv=i(a3,"__call__"),a3.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),T(Qn.$$.fragment,oa),iv=h(oa),T(Vn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),Co=s(o,"H2",{class:!0});var cu=a(Co);Jn=s(cu,"A",{id:!0,class:!0,href:!0});var r3=a(Jn);np=s(r3,"SPAN",{});var i3=a(np);T(yr.$$.fragment,i3),i3.forEach(t),r3.forEach(t),lv=h(cu),sp=s(cu,"SPAN",{});var l3=a(sp);dv=i(l3,"RobertaForTokenClassification"),l3.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);T(Tr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var d3=a(ap);pv=i(d3,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d3.forEach(t),hv=h(io),wr=s(io,"P",{});var pu=a(wr);mv=i(pu,"This model inherits from "),ud=s(pu,"A",{href:!0});var c3=a(ud);fv=i(c3,"PreTrainedModel"),c3.forEach(t),uv=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),gv=h(io),$r=s(io,"P",{});var hu=a($r);_v=i(hu,"This model is also a PyTorch "),Fr=s(hu,"A",{href:!0,rel:!0});var p3=a(Fr);bv=i(p3,"torch.nn.Module"),p3.forEach(t),kv=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);T(xr.$$.fragment,lo),yv=h(lo),qo=s(lo,"P",{});var Vd=a(qo);Tv=i(Vd,"The "),gd=s(Vd,"A",{href:!0});var h3=a(gd);wv=i(h3,"RobertaForTokenClassification"),h3.forEach(t),$v=i(Vd," forward method, overrides the "),rp=s(Vd,"CODE",{});var m3=a(rp);Fv=i(m3,"__call__"),m3.forEach(t),xv=i(Vd," special method."),Vd.forEach(t),Rv=h(lo),T(Kn.$$.fragment,lo),Mv=h(lo),T(Gn.$$.fragment,lo),Ev=h(lo),T(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var f3=a(Yn);ip=s(f3,"SPAN",{});var u3=a(ip);T(Rr.$$.fragment,u3),u3.forEach(t),f3.forEach(t),zv=h(mu),lp=s(mu,"SPAN",{});var g3=a(lp);Cv=i(g3,"RobertaForQuestionAnswering"),g3.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);T(Mr.$$.fragment,co),qv=h(co),Po=s(co,"P",{});var Jd=a(Po);jv=i(Jd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Jd,"CODE",{});var _3=a(dp);Pv=i(_3,"span start logits"),_3.forEach(t),Lv=i(Jd," and "),cp=s(Jd,"CODE",{});var b3=a(cp);Av=i(b3,"span end logits"),b3.forEach(t),Ov=i(Jd,")."),Jd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fu=a(Er);Iv=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var k3=a(_d);Dv=i(k3,"PreTrainedModel"),k3.forEach(t),Sv=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Wv=h(co),zr=s(co,"P",{});var uu=a(zr);Bv=i(uu,"This model is also a PyTorch "),Cr=s(uu,"A",{href:!0,rel:!0});var v3=a(Cr);Uv=i(v3,"torch.nn.Module"),v3.forEach(t),Hv=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);T(qr.$$.fragment,po),Vv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Jv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var y3=a(bd);Kv=i(y3,"RobertaForQuestionAnswering"),y3.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var T3=a(pp);Xv=i(T3,"__call__"),T3.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),T(Zn.$$.fragment,po),ey=h(po),T(es.$$.fragment,po),ty=h(po),T(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w3=a(os);hp=s(w3,"SPAN",{});var $3=a(hp);T(jr.$$.fragment,$3),$3.forEach(t),w3.forEach(t),oy=h(gu),mp=s(gu,"SPAN",{});var F3=a(mp);ny=i(F3,"TFRobertaModel"),F3.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);T(Pr.$$.fragment,Ot),sy=h(Ot),fp=s(Ot,"P",{});var x3=a(fp);ay=i(x3,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x3.forEach(t),ry=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iy=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R3=a(kd);ly=i(R3,"TFPreTrainedModel"),R3.forEach(t),dy=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),cy=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);py=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var M3=a(Or);hy=i(M3,"tf.keras.Model"),M3.forEach(t),my=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fy=h(Ot),T(ns.$$.fragment,Ot),uy=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);T(Nr.$$.fragment,na),gy=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_y=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E3=a(vd);by=i(E3,"TFRobertaModel"),E3.forEach(t),ky=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z3=a(up);vy=i(z3,"__call__"),z3.forEach(t),yy=i(Gd," special method."),Gd.forEach(t),Ty=h(na),T(ss.$$.fragment,na),wy=h(na),T(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var C3=a(rs);gp=s(C3,"SPAN",{});var q3=a(gp);T(Ir.$$.fragment,q3),q3.forEach(t),C3.forEach(t),$y=h(ku),_p=s(ku,"SPAN",{});var j3=a(_p);Fy=i(j3,"TFRobertaForCausalLM"),j3.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);T(Dr.$$.fragment,vu),xy=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);T(Sr.$$.fragment,sa),Ry=h(sa),Do=s(sa,"P",{});var Xd=a(Do);My=i(Xd,"The "),yd=s(Xd,"A",{href:!0});var P3=a(yd);Ey=i(P3,"TFRobertaForCausalLM"),P3.forEach(t),zy=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L3=a(bp);Cy=i(L3,"__call__"),L3.forEach(t),qy=i(Xd," special method."),Xd.forEach(t),jy=h(sa),T(is.$$.fragment,sa),Py=h(sa),T(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var yu=a(So);ds=s(yu,"A",{id:!0,class:!0,href:!0});var A3=a(ds);kp=s(A3,"SPAN",{});var O3=a(kp);T(Wr.$$.fragment,O3),O3.forEach(t),A3.forEach(t),Ly=h(yu),vp=s(yu,"SPAN",{});var N3=a(vp);Ay=i(N3,"TFRobertaForMaskedLM"),N3.forEach(t),yu.forEach(t),_f=h(o),Ve=s(o,"DIV",{class:!0});var Nt=a(Ve);T(Br.$$.fragment,Nt),Oy=h(Nt),Ur=s(Nt,"P",{});var Tu=a(Ur);Ny=i(Tu,"RoBERTa Model with a "),yp=s(Tu,"CODE",{});var I3=a(yp);Iy=i(I3,"language modeling"),I3.forEach(t),Dy=i(Tu," head on top."),Tu.forEach(t),Sy=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);Wy=i(wu,"This model inherits from "),Td=s(wu,"A",{href:!0});var D3=a(Td);By=i(D3,"TFPreTrainedModel"),D3.forEach(t),Uy=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),Hy=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Qy=i($u,"This model is also a "),Vr=s($u,"A",{href:!0,rel:!0});var S3=a(Vr);Vy=i(S3,"tf.keras.Model"),S3.forEach(t),Jy=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),Ky=h(Nt),T(cs.$$.fragment,Nt),Gy=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);T(Jr.$$.fragment,ho),Xy=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Yy=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W3=a(wd);Zy=i(W3,"TFRobertaForMaskedLM"),W3.forEach(t),eT=i(Yd," forward method, overrides the "),Tp=s(Yd,"CODE",{});var B3=a(Tp);tT=i(B3,"__call__"),B3.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),T(ps.$$.fragment,ho),sT=h(ho),T(hs.$$.fragment,ho),aT=h(ho),T(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U3=a(fs);wp=s(U3,"SPAN",{});var H3=a(wp);T(Kr.$$.fragment,H3),H3.forEach(t),U3.forEach(t),rT=h(Fu),$p=s(Fu,"SPAN",{});var Q3=a($p);iT=i(Q3,"TFRobertaForSequenceClassification"),Q3.forEach(t),Fu.forEach(t),kf=h(o),Je=s(o,"DIV",{class:!0});var It=a(Je);T(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var V3=a(Fp);dT=i(V3,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V3.forEach(t),cT=h(It),Xr=s(It,"P",{});var xu=a(Xr);pT=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var J3=a($d);hT=i(J3,"TFPreTrainedModel"),J3.forEach(t),mT=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),fT=h(It),Yr=s(It,"P",{});var Ru=a(Yr);uT=i(Ru,"This model is also a "),Zr=s(Ru,"A",{href:!0,rel:!0});var K3=a(Zr);gT=i(K3,"tf.keras.Model"),K3.forEach(t),_T=i(Ru,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),T(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G3=a(Fd);TT=i(G3,"TFRobertaForSequenceClassification"),G3.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X3=a(xp);$T=i(X3,"__call__"),X3.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),T(gs.$$.fragment,mo),RT=h(mo),T(_s.$$.fragment,mo),MT=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y3=a(ks);Rp=s(Y3,"SPAN",{});var Z3=a(Rp);T(ti.$$.fragment,Z3),Z3.forEach(t),Y3.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zT=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),CT=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);qT=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tx.forEach(t),jT=h(Dt),ni=s(Dt,"P",{});var Eu=a(ni);PT=i(Eu,"This model inherits from "),xd=s(Eu,"A",{href:!0});var ox=a(xd);LT=i(ox,"TFPreTrainedModel"),ox.forEach(t),AT=i(Eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eu.forEach(t),OT=h(Dt),si=s(Dt,"P",{});var zu=a(si);NT=i(zu,"This model is also a "),ai=s(zu,"A",{href:!0,rel:!0});var nx=a(ai);IT=i(nx,"tf.keras.Model"),nx.forEach(t),DT=i(zu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),T(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sx=a(Rd);HT=i(sx,"TFRobertaForMultipleChoice"),sx.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var ax=a(zp);VT=i(ax,"__call__"),ax.forEach(t),JT=i(ec," special method."),ec.forEach(t),KT=h(aa),T(ys.$$.fragment,aa),GT=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var rx=a(ws);Cp=s(rx,"SPAN",{});var ix=a(Cp);T(ii.$$.fragment,ix),ix.forEach(t),rx.forEach(t),XT=h(Cu),qp=s(Cu,"SPAN",{});var lx=a(qp);YT=i(lx,"TFRobertaForTokenClassification"),lx.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var dx=a(jp);ew=i(dx,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dx.forEach(t),tw=h(St),di=s(St,"P",{});var qu=a(di);ow=i(qu,"This model inherits from "),Md=s(qu,"A",{href:!0});var cx=a(Md);nw=i(cx,"TFPreTrainedModel"),cx.forEach(t),sw=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),aw=h(St),ci=s(St,"P",{});var ju=a(ci);rw=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var px=a(pi);iw=i(px,"tf.keras.Model"),px.forEach(t),lw=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dw=h(St),T($s.$$.fragment,St),cw=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);T(hi.$$.fragment,fo),pw=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hw=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hx=a(Ed);mw=i(hx,"TFRobertaForTokenClassification"),hx.forEach(t),fw=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mx=a(Pp);uw=i(mx,"__call__"),mx.forEach(t),gw=i(tc," special method."),tc.forEach(t),_w=h(fo),T(Fs.$$.fragment,fo),bw=h(fo),T(xs.$$.fragment,fo),kw=h(fo),T(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fx=a(Ms);Lp=s(fx,"SPAN",{});var ux=a(Lp);T(mi.$$.fragment,ux),ux.forEach(t),fx.forEach(t),vw=h(Pu),Ap=s(Pu,"SPAN",{});var gx=a(Ap);yw=i(gx,"TFRobertaForQuestionAnswering"),gx.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);T(fi.$$.fragment,Wt),Tw=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);ww=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _x=a(Op);$w=i(_x,"span start logits"),_x.forEach(t),Fw=i(oc," and "),Np=s(oc,"CODE",{});var bx=a(Np);xw=i(bx,"span end logits"),bx.forEach(t),Rw=i(oc,")."),oc.forEach(t),Mw=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ew=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var kx=a(zd);zw=i(kx,"TFPreTrainedModel"),kx.forEach(t),Cw=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),qw=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jw=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var vx=a(_i);Pw=i(vx,"tf.keras.Model"),vx.forEach(t),Lw=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Aw=h(Wt),T(Es.$$.fragment,Wt),Ow=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),Nw=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iw=i(nc,"The "),Cd=s(nc,"A",{href:!0});var yx=a(Cd);Dw=i(yx,"TFRobertaForQuestionAnswering"),yx.forEach(t),Sw=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var Tx=a(Ip);Ww=i(Tx,"__call__"),Tx.forEach(t),Bw=i(nc," special method."),nc.forEach(t),Uw=h(uo),T(zs.$$.fragment,uo),Hw=h(uo),T(Cs.$$.fragment,uo),Qw=h(uo),T(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wx=a(js);Dp=s(wx,"SPAN",{});var $x=a(Dp);T(ki.$$.fragment,$x),$x.forEach(t),wx.forEach(t),Vw=h(Ou),Sp=s(Ou,"SPAN",{});var Fx=a(Sp);Jw=i(Fx,"FlaxRobertaModel"),Fx.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),Kw=h(gt),Wp=s(gt,"P",{});var xx=a(Wp);Gw=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),Xw=h(gt),yi=s(gt,"P",{});var Nu=a(yi);Yw=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var Rx=a(qd);Zw=i(Rx,"FlaxPreTrainedModel"),Rx.forEach(t),e1=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),t1=h(gt),Ti=s(gt,"P",{});var Iu=a(Ti);o1=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var Mx=a(wi);n1=i(Mx,"flax.linen.Module"),Mx.forEach(t),s1=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),a1=h(gt),Bp=s(gt,"P",{});var Ex=a(Bp);r1=i(Ex,"Finally, this model supports inherent JAX features such as:"),Ex.forEach(t),i1=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zx=a(Up);$i=s(zx,"A",{href:!0,rel:!0});var Cx=a($i);l1=i(Cx,"Just-In-Time (JIT) compilation"),Cx.forEach(t),zx.forEach(t),d1=h(ra),Hp=s(ra,"LI",{});var qx=a(Hp);Fi=s(qx,"A",{href:!0,rel:!0});var jx=a(Fi);c1=i(jx,"Automatic Differentiation"),jx.forEach(t),qx.forEach(t),p1=h(ra),Qp=s(ra,"LI",{});var Px=a(Qp);xi=s(Px,"A",{href:!0,rel:!0});var Lx=a(xi);h1=i(Lx,"Vectorization"),Lx.forEach(t),Px.forEach(t),m1=h(ra),Vp=s(ra,"LI",{});var Ax=a(Vp);Ri=s(Ax,"A",{href:!0,rel:!0});var Ox=a(Ri);f1=i(Ox,"Parallelization"),Ox.forEach(t),Ax.forEach(t),ra.forEach(t),u1=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);T(Mi.$$.fragment,ia),g1=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_1=i(sc,"The "),Jp=s(sc,"CODE",{});var Nx=a(Jp);b1=i(Nx,"FlaxRobertaPreTrainedModel"),Nx.forEach(t),k1=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var Ix=a(Kp);v1=i(Ix,"__call__"),Ix.forEach(t),y1=i(sc," special method."),sc.forEach(t),T1=h(ia),T(Ps.$$.fragment,ia),w1=h(ia),T(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var Dx=a(As);Gp=s(Dx,"SPAN",{});var Sx=a(Gp);T(Ei.$$.fragment,Sx),Sx.forEach(t),Dx.forEach(t),$1=h(Du),Xp=s(Du,"SPAN",{});var Wx=a(Xp);F1=i(Wx,"FlaxRobertaForCausalLM"),Wx.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);T(zi.$$.fragment,_t),x1=h(_t),Yp=s(_t,"P",{});var Bx=a(Yp);R1=i(Bx,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),Bx.forEach(t),M1=h(_t),Ci=s(_t,"P",{});var Su=a(Ci);E1=i(Su,"This model inherits from "),jd=s(Su,"A",{href:!0});var Ux=a(jd);z1=i(Ux,"FlaxPreTrainedModel"),Ux.forEach(t),C1=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Su.forEach(t),q1=h(_t),qi=s(_t,"P",{});var Wu=a(qi);j1=i(Wu,"This model is also a Flax Linen "),ji=s(Wu,"A",{href:!0,rel:!0});var Hx=a(ji);P1=i(Hx,"flax.linen.Module"),Hx.forEach(t),L1=i(Wu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),A1=h(_t),Zp=s(_t,"P",{});var Qx=a(Zp);O1=i(Qx,"Finally, this model supports inherent JAX features such as:"),Qx.forEach(t),N1=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var Vx=a(eh);Pi=s(Vx,"A",{href:!0,rel:!0});var Jx=a(Pi);I1=i(Jx,"Just-In-Time (JIT) compilation"),Jx.forEach(t),Vx.forEach(t),D1=h(la),th=s(la,"LI",{});var Kx=a(th);Li=s(Kx,"A",{href:!0,rel:!0});var Gx=a(Li);S1=i(Gx,"Automatic Differentiation"),Gx.forEach(t),Kx.forEach(t),W1=h(la),oh=s(la,"LI",{});var Xx=a(oh);Ai=s(Xx,"A",{href:!0,rel:!0});var Yx=a(Ai);B1=i(Yx,"Vectorization"),Yx.forEach(t),Xx.forEach(t),U1=h(la),nh=s(la,"LI",{});var Zx=a(nh);Oi=s(Zx,"A",{href:!0,rel:!0});var eR=a(Oi);H1=i(eR,"Parallelization"),eR.forEach(t),Zx.forEach(t),la.forEach(t),Q1=h(_t),Ct=s(_t,"DIV",{class:!0});var da=a(Ct);T(Ni.$$.fragment,da),V1=h(da),tn=s(da,"P",{});var ac=a(tn);J1=i(ac,"The "),sh=s(ac,"CODE",{});var tR=a(sh);K1=i(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),G1=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oR=a(ah);X1=i(oR,"__call__"),oR.forEach(t),Y1=i(ac," special method."),ac.forEach(t),Z1=h(da),T(Os.$$.fragment,da),e$=h(da),T(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nR=a(Is);rh=s(nR,"SPAN",{});var sR=a(rh);T(Ii.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t$=h(Bu),ih=s(Bu,"SPAN",{});var aR=a(ih);o$=i(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Bu.forEach(t),Cf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);T(Di.$$.fragment,bt),n$=h(bt),Si=s(bt,"P",{});var Uu=a(Si);s$=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rR=a(lh);a$=i(rR,"language modeling"),rR.forEach(t),r$=i(Uu," head on top."),Uu.forEach(t),i$=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);l$=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iR=a(Pd);d$=i(iR,"FlaxPreTrainedModel"),iR.forEach(t),c$=i(Hu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u$=h(bt),dh=s(bt,"P",{});var dR=a(dh);g$=i(dR,"Finally, this model supports inherent JAX features such as:"),dR.forEach(t),_$=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cR=a(ch);Hi=s(cR,"A",{href:!0,rel:!0});var pR=a(Hi);b$=i(pR,"Just-In-Time (JIT) compilation"),pR.forEach(t),cR.forEach(t),k$=h(ca),ph=s(ca,"LI",{});var hR=a(ph);Qi=s(hR,"A",{href:!0,rel:!0});var mR=a(Qi);v$=i(mR,"Automatic Differentiation"),mR.forEach(t),hR.forEach(t),y$=h(ca),hh=s(ca,"LI",{});var fR=a(hh);Vi=s(fR,"A",{href:!0,rel:!0});var uR=a(Vi);T$=i(uR,"Vectorization"),uR.forEach(t),fR.forEach(t),w$=h(ca),mh=s(ca,"LI",{});var gR=a(mh);Ji=s(gR,"A",{href:!0,rel:!0});var _R=a(Ji);$$=i(_R,"Parallelization"),_R.forEach(t),gR.forEach(t),ca.forEach(t),F$=h(bt),qt=s(bt,"DIV",{class:!0});var pa=a(qt);T(Ki.$$.fragment,pa),x$=h(pa),nn=s(pa,"P",{});var rc=a(nn);R$=i(rc,"The "),fh=s(rc,"CODE",{});var bR=a(fh);M$=i(bR,"FlaxRobertaPreTrainedModel"),bR.forEach(t),E$=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kR=a(uh);z$=i(kR,"__call__"),kR.forEach(t),C$=i(rc," special method."),rc.forEach(t),q$=h(pa),T(Ds.$$.fragment,pa),j$=h(pa),T(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qf=h(o),sn=s(o,"H2",{class:!0});var Vu=a(sn);Ws=s(Vu,"A",{id:!0,class:!0,href:!0});var vR=a(Ws);gh=s(vR,"SPAN",{});var yR=a(gh);T(Gi.$$.fragment,yR),yR.forEach(t),vR.forEach(t),P$=h(Vu),_h=s(Vu,"SPAN",{});var TR=a(_h);L$=i(TR,"FlaxRobertaForSequenceClassification"),TR.forEach(t),Vu.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);T(Xi.$$.fragment,kt),A$=h(kt),bh=s(kt,"P",{});var wR=a(bh);O$=i(wR,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q$=h(kt),kh=s(kt,"P",{});var xR=a(kh);V$=i(xR,"Finally, this model supports inherent JAX features such as:"),xR.forEach(t),J$=h(kt),Vt=s(kt,"UL",{});var ha=a(Vt);vh=s(ha,"LI",{});var RR=a(vh);tl=s(RR,"A",{href:!0,rel:!0});var MR=a(tl);K$=i(MR,"Just-In-Time (JIT) compilation"),MR.forEach(t),RR.forEach(t),G$=h(ha),yh=s(ha,"LI",{});var ER=a(yh);ol=s(ER,"A",{href:!0,rel:!0});var zR=a(ol);X$=i(zR,"Automatic Differentiation"),zR.forEach(t),ER.forEach(t),Y$=h(ha),Th=s(ha,"LI",{});var CR=a(Th);nl=s(CR,"A",{href:!0,rel:!0});var qR=a(nl);Z$=i(qR,"Vectorization"),qR.forEach(t),CR.forEach(t),e2=h(ha),wh=s(ha,"LI",{});var jR=a(wh);sl=s(jR,"A",{href:!0,rel:!0});var PR=a(sl);t2=i(PR,"Parallelization"),PR.forEach(t),jR.forEach(t),ha.forEach(t),o2=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n2=h(ma),an=s(ma,"P",{});var ic=a(an);s2=i(ic,"The "),$h=s(ic,"CODE",{});var LR=a($h);a2=i(LR,"FlaxRobertaPreTrainedModel"),LR.forEach(t),r2=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AR=a(Fh);i2=i(AR,"__call__"),AR.forEach(t),l2=i(ic," special method."),ic.forEach(t),d2=h(ma),T(Bs.$$.fragment,ma),c2=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OR=a(Hs);xh=s(OR,"SPAN",{});var NR=a(xh);T(rl.$$.fragment,NR),NR.forEach(t),OR.forEach(t),p2=h(Gu),Rh=s(Gu,"SPAN",{});var IR=a(Rh);h2=i(IR,"FlaxRobertaForMultipleChoice"),IR.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m2=h(vt),Mh=s(vt,"P",{});var DR=a(Mh);f2=i(DR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
