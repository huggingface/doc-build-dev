import{S as yF,i as $F,s as DF,e as o,k as l,w as b,t as a,M as FF,c as n,d as t,m as d,a as r,x as T,h as i,b as c,F as e,g as u,y as k,q as w,o as y,B as $,v as BF}from"../../chunks/vendor-6b77c823.js";import{T as ge}from"../../chunks/Tip-39098574.js";import{D as Q}from"../../chunks/Docstring-abef54e3.js";import{C as re}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as be}from"../../chunks/IconCopyLink-7a11ce68.js";function MF(j){let p,F,g,v,D;return{c(){p=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),v=a("Module"),D=a(`
...
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var f=r(p);F=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(f,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),D=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(_,f){u(_,p,f),e(p,F),e(p,g),e(g,v),e(p,D)},d(_){_&&t(p)}}}function YF(j){let p,F,g,v,D,_,f,B,ce,K,E,G,L,X,pe,S,he,ae,N,q,Y,V,x,z,ue,W,se,fe,R,ie,ee,A,le,I,oe,me,P,te,U,de,h,M,J,_e,ke,O,ve,we,ye,C,H,$e,De,Z,Fe,ne,Be,ku,wp,bt,wu,Yo,yu,$u,Zo,Du,Fu,en,Bu,Mu,yp,as,Js,Fl,tn,Eu,Bl,xu,$p,Ve,sn,zu,Ct,ju,vi,Cu,Pu,bi,qu,Au,on,Ou,Nu,Iu,is,Lu,Ti,Su,Wu,ki,Ru,Uu,Hu,Ml,Qu,Ku,nn,Dp,ls,Gs,El,rn,Vu,xl,Ju,Fp,_t,an,Gu,zl,Xu,Yu,Xs,wi,Zu,ef,yi,tf,sf,of,ln,nf,$i,rf,af,Bp,ds,Ys,jl,dn,lf,Cl,df,Mp,vt,cn,cf,pn,pf,Pl,hf,uf,ff,Zs,Di,mf,gf,Fi,_f,vf,bf,hn,Tf,Bi,kf,wf,Ep,cs,eo,ql,un,yf,Al,$f,xp,Je,fn,Df,Ol,Ff,Bf,mn,Mf,Mi,Ef,xf,zf,gn,jf,_n,Cf,Pf,qf,tt,vn,Af,ps,Of,Ei,Nf,If,Nl,Lf,Sf,Wf,to,Rf,Il,Uf,Hf,bn,zp,hs,so,Ll,Tn,Qf,Sl,Kf,jp,Ge,kn,Vf,wn,Jf,Wl,Gf,Xf,Yf,yn,Zf,xi,em,tm,sm,$n,om,Dn,nm,rm,am,Se,Fn,im,us,lm,zi,dm,cm,Rl,pm,hm,um,oo,fm,Ul,mm,gm,Bn,_m,Mn,Cp,fs,no,Hl,En,vm,Ql,bm,Pp,Xe,xn,Tm,Kl,km,wm,zn,ym,ji,$m,Dm,Fm,jn,Bm,Cn,Mm,Em,xm,Te,Pn,zm,ms,jm,Ci,Cm,Pm,Vl,qm,Am,Om,ro,Nm,Jl,Im,Lm,qn,Sm,An,Wm,Gl,Rm,Um,On,Hm,Nn,qp,gs,ao,Xl,In,Qm,Yl,Km,Ap,Ye,Ln,Vm,Zl,Jm,Gm,Sn,Xm,Pi,Ym,Zm,eg,Wn,tg,Rn,sg,og,ng,st,Un,rg,_s,ag,qi,ig,lg,ed,dg,cg,pg,io,hg,td,ug,fg,Hn,Op,vs,lo,sd,Qn,mg,od,gg,Np,Ze,Kn,_g,nd,vg,bg,Vn,Tg,Ai,kg,wg,yg,Jn,$g,Gn,Dg,Fg,Bg,We,Xn,Mg,bs,Eg,Oi,xg,zg,rd,jg,Cg,Pg,co,qg,ad,Ag,Og,Yn,Ng,Zn,Ip,Ts,po,id,er,Ig,ld,Lg,Lp,et,tr,Sg,ks,Wg,dd,Rg,Ug,cd,Hg,Qg,Kg,sr,Vg,Ni,Jg,Gg,Xg,or,Yg,nr,Zg,e_,t_,Re,rr,s_,ws,o_,Ii,n_,r_,pd,a_,i_,l_,ho,d_,hd,c_,p_,ar,h_,ir,Sp,ys,uo,ud,lr,u_,fd,f_,Wp,qe,dr,m_,md,g_,__,cr,v_,Li,b_,T_,k_,pr,w_,hr,y_,$_,D_,fo,F_,ot,ur,B_,$s,M_,Si,E_,x_,gd,z_,j_,C_,mo,P_,_d,q_,A_,fr,Rp,Ds,go,vd,mr,O_,bd,N_,Up,Ae,gr,I_,_r,L_,Td,S_,W_,R_,vr,U_,Wi,H_,Q_,K_,br,V_,Tr,J_,G_,X_,_o,Y_,Ue,kr,Z_,Fs,e1,Ri,t1,s1,kd,o1,n1,r1,vo,a1,wd,i1,l1,wr,d1,yr,Hp,Bs,bo,yd,$r,c1,$d,p1,Qp,Oe,Dr,h1,Dd,u1,f1,Fr,m1,Ui,g1,_1,v1,Br,b1,Mr,T1,k1,w1,To,y1,He,Er,$1,Ms,D1,Hi,F1,B1,Fd,M1,E1,x1,ko,z1,Bd,j1,C1,xr,P1,zr,Kp,Es,wo,Md,jr,q1,Ed,A1,Vp,Ne,Cr,O1,xd,N1,I1,Pr,L1,Qi,S1,W1,R1,qr,U1,Ar,H1,Q1,K1,yo,V1,nt,Or,J1,xs,G1,Ki,X1,Y1,zd,Z1,ev,tv,$o,sv,jd,ov,nv,Nr,Jp,zs,Do,Cd,Ir,rv,Pd,av,Gp,Ie,Lr,iv,qd,lv,dv,Sr,cv,Vi,pv,hv,uv,Wr,fv,Rr,mv,gv,_v,Fo,vv,Qe,Ur,bv,js,Tv,Ji,kv,wv,Ad,yv,$v,Dv,Bo,Fv,Od,Bv,Mv,Hr,Ev,Qr,Xp,Cs,Mo,Nd,Kr,xv,Id,zv,Yp,Le,Vr,jv,Ps,Cv,Ld,Pv,qv,Sd,Av,Ov,Nv,Jr,Iv,Gi,Lv,Sv,Wv,Gr,Rv,Xr,Uv,Hv,Qv,Eo,Kv,Ke,Yr,Vv,qs,Jv,Xi,Gv,Xv,Wd,Yv,Zv,eb,xo,tb,Rd,sb,ob,Zr,nb,ea,Zp,As,zo,Ud,ta,rb,Hd,ab,eh,Me,sa,ib,Qd,lb,db,oa,cb,Yi,pb,hb,ub,na,fb,ra,mb,gb,_b,Kd,vb,bb,Pt,Vd,aa,Tb,kb,Jd,ia,wb,yb,Gd,la,$b,Db,Xd,da,Fb,Bb,rt,ca,Mb,Os,Eb,Yd,xb,zb,Zd,jb,Cb,Pb,jo,qb,ec,Ab,Ob,pa,th,Ns,Co,tc,ha,Nb,sc,Ib,sh,Ee,ua,Lb,fa,Sb,oc,Wb,Rb,Ub,ma,Hb,Zi,Qb,Kb,Vb,ga,Jb,_a,Gb,Xb,Yb,nc,Zb,eT,qt,rc,va,tT,sT,ac,ba,oT,nT,ic,Ta,rT,aT,lc,ka,iT,lT,at,wa,dT,Is,cT,dc,pT,hT,cc,uT,fT,mT,Po,gT,pc,_T,vT,ya,oh,Ls,qo,hc,$a,bT,uc,TT,nh,xe,Da,kT,fc,wT,yT,Fa,$T,el,DT,FT,BT,Ba,MT,Ma,ET,xT,zT,mc,jT,CT,At,gc,Ea,PT,qT,_c,xa,AT,OT,vc,za,NT,IT,bc,ja,LT,ST,it,Ca,WT,Ss,RT,Tc,UT,HT,kc,QT,KT,VT,Ao,JT,wc,GT,XT,Pa,rh,Ws,Oo,yc,qa,YT,$c,ZT,ah,ze,Aa,ek,Dc,tk,sk,Oa,ok,tl,nk,rk,ak,Na,ik,Ia,lk,dk,ck,Fc,pk,hk,Ot,Bc,La,uk,fk,Mc,Sa,mk,gk,Ec,Wa,_k,vk,xc,Ra,bk,Tk,lt,Ua,kk,Rs,wk,zc,yk,$k,jc,Dk,Fk,Bk,No,Mk,Cc,Ek,xk,Ha,ih,Us,Io,Pc,Qa,zk,qc,jk,lh,je,Ka,Ck,Ac,Pk,qk,Va,Ak,sl,Ok,Nk,Ik,Ja,Lk,Ga,Sk,Wk,Rk,Oc,Uk,Hk,Nt,Nc,Xa,Qk,Kk,Ic,Ya,Vk,Jk,Lc,Za,Gk,Xk,Sc,ei,Yk,Zk,dt,ti,ew,Hs,tw,Wc,sw,ow,Rc,nw,rw,aw,Lo,iw,Uc,lw,dw,si,dh,Qs,So,Hc,oi,cw,Qc,pw,ch,Ce,ni,hw,Ks,uw,Kc,fw,mw,Vc,gw,_w,vw,ri,bw,ol,Tw,kw,ww,ai,yw,ii,$w,Dw,Fw,Jc,Bw,Mw,It,Gc,li,Ew,xw,Xc,di,zw,jw,Yc,ci,Cw,Pw,Zc,pi,qw,Aw,ct,hi,Ow,Vs,Nw,ep,Iw,Lw,tp,Sw,Ww,Rw,Wo,Uw,sp,Hw,Qw,ui,ph;return _=new be({}),X=new be({}),tn=new be({}),sn=new Q({props:{name:"class transformers.DistilBertConfig",anchor:"transformers.DistilBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"max_position_embeddings",val:" = 512"},{name:"sinusoidal_pos_embds",val:" = False"},{name:"n_layers",val:" = 6"},{name:"n_heads",val:" = 12"},{name:"dim",val:" = 768"},{name:"hidden_dim",val:" = 3072"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"activation",val:" = 'gelu'"},{name:"initializer_range",val:" = 0.02"},{name:"qa_dropout",val:" = 0.1"},{name:"seq_classif_dropout",val:" = 0.2"},{name:"pad_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/distilbert/configuration_distilbert.py#L37",parametersDescription:[{anchor:"transformers.DistilBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
<a href="/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new re({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
`}}),ko=new ge({props:{$$slots:{default:[IF]},$$scope:{ctx:j}}}),xr=new re({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForSequenceClassification
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ti=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16148/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
study.`),P=l(),te=o("p"),U=a("Tips:"),de=l(),h=o("ul"),M=o("li"),J=a("DistilBERT doesn\u2019t have "),_e=o("code"),ke=a("token_type_ids"),O=a(`, you don\u2019t need to indicate which token belongs to which segment. Just
separate your segments with the separation token `),ve=o("code"),we=a("tokenizer.sep_token"),ye=a(" (or "),C=o("code"),H=a("[SEP]"),$e=a(")."),De=l(),Z=o("li"),Fe=a("DistilBERT doesn\u2019t have options to select the input positions ("),ne=o("code"),Be=a("position_ids"),ku=a(` input). This could be added if
...
`),on=o("a"),Ou=a("distilbert-base-uncased"),Nu=a(" architecture."),Iu=l(),is=o("p"),Lu=a("Configuration objects inherit from "),Ti=o("a"),Su=a("PretrainedConfig"),Wu=a(` and can be used to control the model outputs. Read the
documentation from `),ki=o("a"),Ru=a("PretrainedConfig"),Uu=a(" for more information."),Hu=l(),Ml=o("p"),Qu=a("Examples:"),Ku=l(),b(nn.$$.fragment),Dp=l(),ls=o("h2"),Gs=o("a"),El=o("span"),b(rn.$$.fragment),Vu=l(),xl=o("span"),Ju=a("DistilBertTokenizer"),Fp=l(),_t=o("div"),b(an.$$.fragment),Gu=l(),zl=o("p"),Xu=a("Construct a DistilBERT tokenizer."),Yu=l(),Xs=o("p"),wi=o("a"),Zu=a("DistilBertTokenizer"),ef=a(" is identical to "),yi=o("a"),tf=a("BertTokenizer"),sf=a(` and runs end-to-end tokenization: punctuation splitting
...
splitting and wordpiece.`),bf=l(),hn=o("p"),Tf=a("Refer to superclass "),Bi=o("a"),kf=a("BertTokenizerFast"),wf=a(" for usage examples and documentation concerning parameters."),Ep=l(),cs=o("h2"),eo=o("a"),ql=o("span"),b(un.$$.fragment),yf=l(),Al=o("span"),$f=a("DistilBertModel"),xp=l(),Je=o("div"),b(fn.$$.fragment),Df=l(),Ol=o("p"),Ff=a("The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),Bf=l(),mn=o("p"),Mf=a("This model inherits from "),Mi=o("a"),Ef=a("PreTrainedModel"),xf=a(`. Check the superclass documentation for the generic methods the
...
for Named-Entity-Recognition (NER) tasks.`),bg=l(),Vn=o("p"),Tg=a("This model inherits from "),Ai=o("a"),kg=a("PreTrainedModel"),wg=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yg=l(),Jn=o("p"),$g=a("This model is also a PyTorch "),Gn=o("a"),Dg=a("torch.nn.Module"),Fg=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bg=l(),We=o("div"),b(Xn.$$.fragment),Mg=l(),bs=o("p"),Eg=a("The "),Oi=o("a"),xg=a("DistilBertForTokenClassification"),zg=a(" forward method, overrides the "),rd=o("code"),jg=a("__call__"),Cg=a(" special method."),Pg=l(),b(co.$$.fragment),qg=l(),ad=o("p"),Ag=a("Example:"),Og=l(),b(Yn.$$.fragment),Ng=l(),b(Zn.$$.fragment),Ip=l(),Ts=o("h2"),po=o("a"),id=o("span"),b(er.$$.fragment),Ig=l(),ld=o("span"),Lg=a("DistilBertForQuestionAnswering"),Lp=l(),et=o("div"),b(tr.$$.fragment),Sg=l(),ks=o("p"),Wg=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),v1=l(),Br=o("p"),b1=a("This model is also a "),Mr=o("a"),T1=a("tf.keras.Model"),k1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),w1=l(),b(To.$$.fragment),y1=l(),He=o("div"),b(Er.$$.fragment),$1=l(),Ms=o("p"),D1=a("The "),Hi=o("a"),F1=a("TFDistilBertForSequenceClassification"),B1=a(" forward method, overrides the "),Fd=o("code"),M1=a("__call__"),E1=a(" special method."),x1=l(),b(ko.$$.fragment),z1=l(),Bd=o("p"),j1=a("Example:"),C1=l(),b(xr.$$.fragment),P1=l(),b(zr.$$.fragment),Kp=l(),Es=o("h2"),wo=o("a"),Md=o("span"),b(jr.$$.fragment),q1=l(),Ed=o("span"),A1=a("TFDistilBertForMultipleChoice"),Vp=l(),Ne=o("div"),b(Cr.$$.fragment),O1=l(),xd=o("p"),N1=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yb=l(),nc=o("p"),Zb=a("Finally, this model supports inherent JAX features such as:"),eT=l(),qt=o("ul"),rc=o("li"),va=o("a"),tT=a("Just-In-Time (JIT) compilation"),sT=l(),ac=o("li"),ba=o("a"),oT=a("Automatic Differentiation"),nT=l(),ic=o("li"),Ta=o("a"),rT=a("Vectorization"),aT=l(),lc=o("li"),ka=o("a"),iT=a("Parallelization"),lT=l(),at=o("div"),b(wa.$$.fragment),dT=l(),Is=o("p"),cT=a("The "),dc=o("code"),pT=a("FlaxDistilBertPreTrainedModel"),hT=a("forward method, overrides the "),cc=o("code"),uT=a("__call__"),fT=a(" special method."),mT=l(),b(Po.$$.fragment),gT=l(),pc=o("p"),_T=a("Example:"),vT=l(),b(ya.$$.fragment),oh=l(),Ls=o("h2"),qo=o("a"),hc=o("span"),b($a.$$.fragment),bT=l(),uc=o("span"),TT=a("FlaxDistilBertForSequenceClassification"),nh=l(),xe=o("div"),b(Da.$$.fragment),kT=l(),fc=o("p"),wT=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),zT=l(),mc=o("p"),jT=a("Finally, this model supports inherent JAX features such as:"),CT=l(),At=o("ul"),gc=o("li"),Ea=o("a"),PT=a("Just-In-Time (JIT) compilation"),qT=l(),_c=o("li"),xa=o("a"),AT=a("Automatic Differentiation"),OT=l(),vc=o("li"),za=o("a"),NT=a("Vectorization"),IT=l(),bc=o("li"),ja=o("a"),LT=a("Parallelization"),ST=l(),it=o("div"),b(Ca.$$.fragment),WT=l(),Ss=o("p"),RT=a("The "),Tc=o("code"),UT=a("FlaxDistilBertPreTrainedModel"),HT=a("forward method, overrides the "),kc=o("code"),QT=a("__call__"),KT=a(" special method."),VT=l(),b(Ao.$$.fragment),JT=l(),wc=o("p"),GT=a("Example:"),XT=l(),b(Pa.$$.fragment),rh=l(),Ws=o("h2"),Oo=o("a"),yc=o("span"),b(qa.$$.fragment),YT=l(),$c=o("span"),ZT=a("FlaxDistilBertForMultipleChoice"),ah=l(),ze=o("div"),b(Aa.$$.fragment),ek=l(),Dc=o("p"),tk=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),sk=l(),Oa=o("p"),ok=a("This model inherits from "),tl=o("a"),nk=a("FlaxPreTrainedModel"),rk=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ak=l(),Na=o("p"),ik=a("This model is also a Flax Linen "),Ia=o("a"),lk=a("flax.linen.Module"),dk=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ck=l(),Fc=o("p"),pk=a("Finally, this model supports inherent JAX features such as:"),hk=l(),Ot=o("ul"),Bc=o("li"),La=o("a"),uk=a("Just-In-Time (JIT) compilation"),fk=l(),Mc=o("li"),Sa=o("a"),mk=a("Automatic Differentiation"),gk=l(),Ec=o("li"),Wa=o("a"),_k=a("Vectorization"),vk=l(),xc=o("li"),Ra=o("a"),bk=a("Parallelization"),Tk=l(),lt=o("div"),b(Ua.$$.fragment),kk=l(),Rs=o("p"),wk=a("The "),zc=o("code"),yk=a("FlaxDistilBertPreTrainedModel"),$k=a("forward method, overrides the "),jc=o("code"),Dk=a("__call__"),Fk=a(" special method."),Bk=l(),b(No.$$.fragment),Mk=l(),Cc=o("p"),Ek=a("Example:"),xk=l(),b(Ha.$$.fragment),ih=l(),Us=o("h2"),Io=o("a"),Pc=o("span"),b(Qa.$$.fragment),zk=l(),qc=o("span"),jk=a("FlaxDistilBertForTokenClassification"),lh=l(),je=o("div"),b(Ka.$$.fragment),Ck=l(),Ac=o("p"),Pk=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),qk=l(),Va=o("p"),Ak=a("This model inherits from "),sl=o("a"),Ok=a("FlaxPreTrainedModel"),Nk=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Ik=l(),Ja=o("p"),Lk=a("This model is also a Flax Linen "),Ga=o("a"),Sk=a("flax.linen.Module"),Wk=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Rk=l(),Oc=o("p"),Uk=a("Finally, this model supports inherent JAX features such as:"),Hk=l(),Nt=o("ul"),Nc=o("li"),Xa=o("a"),Qk=a("Just-In-Time (JIT) compilation"),Kk=l(),Ic=o("li"),Ya=o("a"),Vk=a("Automatic Differentiation"),Jk=l(),Lc=o("li"),Za=o("a"),Gk=a("Vectorization"),Xk=l(),Sc=o("li"),ei=o("a"),Yk=a("Parallelization"),Zk=l(),dt=o("div"),b(ti.$$.fragment),ew=l(),Hs=o("p"),tw=a("The "),Wc=o("code"),sw=a("FlaxDistilBertPreTrainedModel"),ow=a("forward method, overrides the "),Rc=o("code"),nw=a("__call__"),rw=a(" special method."),aw=l(),b(Lo.$$.fragment),iw=l(),Uc=o("p"),lw=a("Example:"),dw=l(),b(si.$$.fragment),dh=l(),Qs=o("h2"),So=o("a"),Hc=o("span"),b(oi.$$.fragment),cw=l(),Qc=o("span"),pw=a("FlaxDistilBertForQuestionAnswering"),ch=l(),Ce=o("div"),b(ni.$$.fragment),hw=l(),Ks=o("p"),uw=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Kc=o("code"),fw=a("span start logits"),mw=a(" and "),Vc=o("code"),gw=a("span end logits"),_w=a(")."),vw=l(),ri=o("p"),bw=a("This model inherits from "),ol=o("a"),Tw=a("FlaxPreTrainedModel"),kw=a(`. Check the superclass documentation for the generic methods the
...
distillation and cosine-distance losses. Our smaller, faster and lighter model is cheaper to pre-train and we
demonstrate its capabilities for on-device computations in a proof-of-concept experiment and a comparative on-device
study.`),fp.forEach(t),up.forEach(t),P=d(s),te=n(s,"P",{});var mp=r(te);U=i(mp,"Tips:"),mp.forEach(t),de=d(s),h=n(s,"UL",{});var gi=r(h);M=n(gi,"LI",{});var St=r(M);J=i(St,"DistilBERT doesn\u2019t have "),_e=n(St,"CODE",{});var gp=r(_e);ke=i(gp,"token_type_ids"),gp.forEach(t),O=i(St,`, you don\u2019t need to indicate which token belongs to which segment. Just
separate your segments with the separation token `),ve=n(St,"CODE",{});var _p=r(ve);we=i(_p,"tokenizer.sep_token"),_p.forEach(t),ye=i(St," (or "),C=n(St,"CODE",{});var vp=r(C);H=i(vp,"[SEP]"),vp.forEach(t),$e=i(St,")."),St.forEach(t),De=d(gi),Z=n(gi,"LI",{});var _i=r(Z);Fe=i(_i,"DistilBERT doesn\u2019t have options to select the input positions ("),ne=n(_i,"CODE",{});var bp=r(ne);Be=i(bp,"position_ids"),bp.forEach(t),ku=i(_i,` input). This could be added if
...
contributed by `),Zo=n(Wt,"A",{href:!0,rel:!0});var Vw=r(Zo);Du=i(Vw,"kamalkraj"),Vw.forEach(t),Fu=i(Wt,". The original code can be found "),en=n(Wt,"A",{href:!0,rel:!0});var Jw=r(en);Bu=i(Jw,"here"),Jw.forEach(t),Mu=i(Wt,"."),Wt.forEach(t),yp=d(s),as=n(s,"H2",{class:!0});var hh=r(as);Js=n(hh,"A",{id:!0,class:!0,href:!0});var Gw=r(Js);Fl=n(Gw,"SPAN",{});var Xw=r(Fl);T(tn.$$.fragment,Xw),Xw.forEach(t),Gw.forEach(t),Eu=d(hh),Bl=n(hh,"SPAN",{});var Yw=r(Bl);xu=i(Yw,"DistilBertConfig"),Yw.forEach(t),hh.forEach(t),$p=d(s),Ve=n(s,"DIV",{class:!0});var Rt=r(Ve);T(sn.$$.fragment,Rt),zu=d(Rt),Ct=n(Rt,"P",{});var Ro=r(Ct);ju=i(Ro,"This is the configuration class to store the configuration of a "),vi=n(Ro,"A",{href:!0});var Zw=r(vi);Cu=i(Zw,"DistilBertModel"),Zw.forEach(t),Pu=i(Ro," or a "),bi=n(Ro,"A",{href:!0});var ey=r(bi);qu=i(ey,"TFDistilBertModel"),ey.forEach(t),Au=i(Ro,`. It
is used to instantiate a DistilBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the DistilBERT
`),on=n(Ro,"A",{href:!0,rel:!0});var ty=r(on);Ou=i(ty,"distilbert-base-uncased"),ty.forEach(t),Nu=i(Ro," architecture."),Ro.forEach(t),Iu=d(Rt),is=n(Rt,"P",{});var nl=r(is);Lu=i(nl,"Configuration objects inherit from "),Ti=n(nl,"A",{href:!0});var sy=r(Ti);Su=i(sy,"PretrainedConfig"),sy.forEach(t),Wu=i(nl,` and can be used to control the model outputs. Read the
documentation from `),ki=n(nl,"A",{href:!0});var oy=r(ki);Ru=i(oy,"PretrainedConfig"),oy.forEach(t),Uu=i(nl," for more information."),nl.forEach(t),Hu=d(Rt),Ml=n(Rt,"P",{});var ny=r(Ml);Qu=i(ny,"Examples:"),ny.forEach(t),Ku=d(Rt),T(nn.$$.fragment,Rt),Rt.forEach(t),Dp=d(s),ls=n(s,"H2",{class:!0});var uh=r(ls);Gs=n(uh,"A",{id:!0,class:!0,href:!0});var ry=r(Gs);El=n(ry,"SPAN",{});var ay=r(El);T(rn.$$.fragment,ay),ay.forEach(t),ry.forEach(t),Vu=d(uh),xl=n(uh,"SPAN",{});var iy=r(xl);Ju=i(iy,"DistilBertTokenizer"),iy.forEach(t),uh.forEach(t),Fp=d(s),_t=n(s,"DIV",{class:!0});var Uo=r(_t);T(an.$$.fragment,Uo),Gu=d(Uo),zl=n(Uo,"P",{});var ly=r(zl);Xu=i(ly,"Construct a DistilBERT tokenizer."),ly.forEach(t),Yu=d(Uo),Xs=n(Uo,"P",{});var Tp=r(Xs);wi=n(Tp,"A",{href:!0});var dy=r(wi);Zu=i(dy,"DistilBertTokenizer"),dy.forEach(t),ef=i(Tp," is identical to "),yi=n(Tp,"A",{href:!0});var cy=r(yi);tf=i(cy,"BertTokenizer"),cy.forEach(t),sf=i(Tp,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Tp.forEach(t),of=d(Uo),ln=n(Uo,"P",{});var fh=r(ln);nf=i(fh,"Refer to superclass "),$i=n(fh,"A",{href:!0});var py=r($i);rf=i(py,"BertTokenizer"),py.forEach(t),af=i(fh," for usage examples and documentation concerning parameters."),fh.forEach(t),Uo.forEach(t),Bp=d(s),ds=n(s,"H2",{class:!0});var mh=r(ds);Ys=n(mh,"A",{id:!0,class:!0,href:!0});var hy=r(Ys);jl=n(hy,"SPAN",{});var uy=r(jl);T(dn.$$.fragment,uy),uy.forEach(t),hy.forEach(t),lf=d(mh),Cl=n(mh,"SPAN",{});var fy=r(Cl);df=i(fy,"DistilBertTokenizerFast"),fy.forEach(t),mh.forEach(t),Mp=d(s),vt=n(s,"DIV",{class:!0});var Ho=r(vt);T(cn.$$.fragment,Ho),cf=d(Ho),pn=n(Ho,"P",{});var gh=r(pn);pf=i(gh,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),Pl=n(gh,"EM",{});var my=r(Pl);hf=i(my,"tokenizers"),my.forEach(t),uf=i(gh," library)."),gh.forEach(t),ff=d(Ho),Zs=n(Ho,"P",{});var kp=r(Zs);Di=n(kp,"A",{href:!0});var gy=r(Di);mf=i(gy,"DistilBertTokenizerFast"),gy.forEach(t),gf=i(kp," is identical to "),Fi=n(kp,"A",{href:!0});var _y=r(Fi);_f=i(_y,"BertTokenizerFast"),_y.forEach(t),vf=i(kp,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),kp.forEach(t),bf=d(Ho),hn=n(Ho,"P",{});var _h=r(hn);Tf=i(_h,"Refer to superclass "),Bi=n(_h,"A",{href:!0});var vy=r(Bi);kf=i(vy,"BertTokenizerFast"),vy.forEach(t),wf=i(_h," for usage examples and documentation concerning parameters."),_h.forEach(t),Ho.forEach(t),Ep=d(s),cs=n(s,"H2",{class:!0});var vh=r(cs);eo=n(vh,"A",{id:!0,class:!0,href:!0});var by=r(eo);ql=n(by,"SPAN",{});var Ty=r(ql);T(un.$$.fragment,Ty),Ty.forEach(t),by.forEach(t),yf=d(vh),Al=n(vh,"SPAN",{});var ky=r(Al);$f=i(ky,"DistilBertModel"),ky.forEach(t),vh.forEach(t),xp=d(s),Je=n(s,"DIV",{class:!0});var Ut=r(Je);T(fn.$$.fragment,Ut),Df=d(Ut),Ol=n(Ut,"P",{});var wy=r(Ol);Ff=i(wy,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),wy.forEach(t),Bf=d(Ut),mn=n(Ut,"P",{});var bh=r(mn);Mf=i(bh,"This model inherits from "),Mi=n(bh,"A",{href:!0});var yy=r(Mi);Ef=i(yy,"PreTrainedModel"),yy.forEach(t),xf=i(bh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bh.forEach(t),zf=d(Ut),gn=n(Ut,"P",{});var Th=r(gn);jf=i(Th,"This model is also a PyTorch "),_n=n(Th,"A",{href:!0,rel:!0});var $y=r(_n);Cf=i($y,"torch.nn.Module"),$y.forEach(t),Pf=i(Th,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Th.forEach(t),qf=d(Ut),tt=n(Ut,"DIV",{class:!0});var Ht=r(tt);T(vn.$$.fragment,Ht),Af=d(Ht),ps=n(Ht,"P",{});var rl=r(ps);Of=i(rl,"The "),Ei=n(rl,"A",{href:!0});var Dy=r(Ei);Nf=i(Dy,"DistilBertModel"),Dy.forEach(t),If=i(rl," forward method, overrides the "),Nl=n(rl,"CODE",{});var Fy=r(Nl);Lf=i(Fy,"__call__"),Fy.forEach(t),Sf=i(rl," special method."),rl.forEach(t),Wf=d(Ht),T(to.$$.fragment,Ht),Rf=d(Ht),Il=n(Ht,"P",{});var By=r(Il);Uf=i(By,"Example:"),By.forEach(t),Hf=d(Ht),T(bn.$$.fragment,Ht),Ht.forEach(t),Ut.forEach(t),zp=d(s),hs=n(s,"H2",{class:!0});var kh=r(hs);so=n(kh,"A",{id:!0,class:!0,href:!0});var My=r(so);Ll=n(My,"SPAN",{});var Ey=r(Ll);T(Tn.$$.fragment,Ey),Ey.forEach(t),My.forEach(t),Qf=d(kh),Sl=n(kh,"SPAN",{});var xy=r(Sl);Kf=i(xy,"DistilBertForMaskedLM"),xy.forEach(t),kh.forEach(t),jp=d(s),Ge=n(s,"DIV",{class:!0});var Qt=r(Ge);T(kn.$$.fragment,Qt),Vf=d(Qt),wn=n(Qt,"P",{});var wh=r(wn);Jf=i(wh,"DistilBert Model with a "),Wl=n(wh,"CODE",{});var zy=r(Wl);Gf=i(zy,"masked language modeling"),zy.forEach(t),Xf=i(wh," head on top."),wh.forEach(t),Yf=d(Qt),yn=n(Qt,"P",{});var yh=r(yn);Zf=i(yh,"This model inherits from "),xi=n(yh,"A",{href:!0});var jy=r(xi);em=i(jy,"PreTrainedModel"),jy.forEach(t),tm=i(yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),am=d(Qt),Se=n(Qt,"DIV",{class:!0});var Tt=r(Se);T(Fn.$$.fragment,Tt),im=d(Tt),us=n(Tt,"P",{});var al=r(us);lm=i(al,"The "),zi=n(al,"A",{href:!0});var Py=r(zi);dm=i(Py,"DistilBertForMaskedLM"),Py.forEach(t),cm=i(al," forward method, overrides the "),Rl=n(al,"CODE",{});var qy=r(Rl);pm=i(qy,"__call__"),qy.forEach(t),hm=i(al," special method."),al.forEach(t),um=d(Tt),T(oo.$$.fragment,Tt),fm=d(Tt),Ul=n(Tt,"P",{});var Ay=r(Ul);mm=i(Ay,"Example:"),Ay.forEach(t),gm=d(Tt),T(Bn.$$.fragment,Tt),_m=d(Tt),T(Mn.$$.fragment,Tt),Tt.forEach(t),Qt.forEach(t),Cp=d(s),fs=n(s,"H2",{class:!0});var Dh=r(fs);no=n(Dh,"A",{id:!0,class:!0,href:!0});var Oy=r(no);Hl=n(Oy,"SPAN",{});var Ny=r(Hl);T(En.$$.fragment,Ny),Ny.forEach(t),Oy.forEach(t),vm=d(Dh),Ql=n(Dh,"SPAN",{});var Iy=r(Ql);bm=i(Iy,"DistilBertForSequenceClassification"),Iy.forEach(t),Dh.forEach(t),Pp=d(s),Xe=n(s,"DIV",{class:!0});var Kt=r(Xe);T(xn.$$.fragment,Kt),Tm=d(Kt),Kl=n(Kt,"P",{});var Ly=r(Kl);km=i(Ly,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bh.forEach(t),xm=d(Kt),Te=n(Kt,"DIV",{class:!0});var Pe=r(Te);T(Pn.$$.fragment,Pe),zm=d(Pe),ms=n(Pe,"P",{});var il=r(ms);jm=i(il,"The "),Ci=n(il,"A",{href:!0});var Ry=r(Ci);Cm=i(Ry,"DistilBertForSequenceClassification"),Ry.forEach(t),Pm=i(il," forward method, overrides the "),Vl=n(il,"CODE",{});var Uy=r(Vl);qm=i(Uy,"__call__"),Uy.forEach(t),Am=i(il," special method."),il.forEach(t),Om=d(Pe),T(ro.$$.fragment,Pe),Nm=d(Pe),Jl=n(Pe,"P",{});var Hy=r(Jl);Im=i(Hy,"Example of single-label classification:"),Hy.forEach(t),Lm=d(Pe),T(qn.$$.fragment,Pe),Sm=d(Pe),T(An.$$.fragment,Pe),Wm=d(Pe),Gl=n(Pe,"P",{});var Qy=r(Gl);Rm=i(Qy,"Example of multi-label classification:"),Qy.forEach(t),Um=d(Pe),T(On.$$.fragment,Pe),Hm=d(Pe),T(Nn.$$.fragment,Pe),Pe.forEach(t),Kt.forEach(t),qp=d(s),gs=n(s,"H2",{class:!0});var Mh=r(gs);ao=n(Mh,"A",{id:!0,class:!0,href:!0});var Ky=r(ao);Xl=n(Ky,"SPAN",{});var Vy=r(Xl);T(In.$$.fragment,Vy),Vy.forEach(t),Ky.forEach(t),Qm=d(Mh),Yl=n(Mh,"SPAN",{});var Jy=r(Yl);Km=i(Jy,"DistilBertForMultipleChoice"),Jy.forEach(t),Mh.forEach(t),Ap=d(s),Ye=n(s,"DIV",{class:!0});var Vt=r(Ye);T(Ln.$$.fragment,Vt),Vm=d(Vt),Zl=n(Vt,"P",{});var Gy=r(Zl);Jm=i(Gy,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh.forEach(t),ng=d(Vt),st=n(Vt,"DIV",{class:!0});var Jt=r(st);T(Un.$$.fragment,Jt),rg=d(Jt),_s=n(Jt,"P",{});var ll=r(_s);ag=i(ll,"The "),qi=n(ll,"A",{href:!0});var Zy=r(qi);ig=i(Zy,"DistilBertForMultipleChoice"),Zy.forEach(t),lg=i(ll," forward method, overrides the "),ed=n(ll,"CODE",{});var e$=r(ed);dg=i(e$,"__call__"),e$.forEach(t),cg=i(ll," special method."),ll.forEach(t),pg=d(Jt),T(io.$$.fragment,Jt),hg=d(Jt),td=n(Jt,"P",{});var t$=r(td);ug=i(t$,"Examples:"),t$.forEach(t),fg=d(Jt),T(Hn.$$.fragment,Jt),Jt.forEach(t),Vt.forEach(t),Op=d(s),vs=n(s,"H2",{class:!0});var zh=r(vs);lo=n(zh,"A",{id:!0,class:!0,href:!0});var s$=r(lo);sd=n(s$,"SPAN",{});var o$=r(sd);T(Qn.$$.fragment,o$),o$.forEach(t),s$.forEach(t),mg=d(zh),od=n(zh,"SPAN",{});var n$=r(od);gg=i(n$,"DistilBertForTokenClassification"),n$.forEach(t),zh.forEach(t),Np=d(s),Ze=n(s,"DIV",{class:!0});var Gt=r(Ze);T(Kn.$$.fragment,Gt),_g=d(Gt),nd=n(Gt,"P",{});var r$=r(nd);vg=i(r$,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),r$.forEach(t),bg=d(Gt),Vn=n(Gt,"P",{});var jh=r(Vn);Tg=i(jh,"This model inherits from "),Ai=n(jh,"A",{href:!0});var a$=r(Ai);kg=i(a$,"PreTrainedModel"),a$.forEach(t),wg=i(jh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ch.forEach(t),Bg=d(Gt),We=n(Gt,"DIV",{class:!0});var kt=r(We);T(Xn.$$.fragment,kt),Mg=d(kt),bs=n(kt,"P",{});var dl=r(bs);Eg=i(dl,"The "),Oi=n(dl,"A",{href:!0});var l$=r(Oi);xg=i(l$,"DistilBertForTokenClassification"),l$.forEach(t),zg=i(dl," forward method, overrides the "),rd=n(dl,"CODE",{});var d$=r(rd);jg=i(d$,"__call__"),d$.forEach(t),Cg=i(dl," special method."),dl.forEach(t),Pg=d(kt),T(co.$$.fragment,kt),qg=d(kt),ad=n(kt,"P",{});var c$=r(ad);Ag=i(c$,"Example:"),c$.forEach(t),Og=d(kt),T(Yn.$$.fragment,kt),Ng=d(kt),T(Zn.$$.fragment,kt),kt.forEach(t),Gt.forEach(t),Ip=d(s),Ts=n(s,"H2",{class:!0});var Ph=r(Ts);po=n(Ph,"A",{id:!0,class:!0,href:!0});var p$=r(po);id=n(p$,"SPAN",{});var h$=r(id);T(er.$$.fragment,h$),h$.forEach(t),p$.forEach(t),Ig=d(Ph),ld=n(Ph,"SPAN",{});var u$=r(ld);Lg=i(u$,"DistilBertForQuestionAnswering"),u$.forEach(t),Ph.forEach(t),Lp=d(s),et=n(s,"DIV",{class:!0});var Xt=r(et);T(tr.$$.fragment,Xt),Sg=d(Xt),ks=n(Xt,"P",{});var cl=r(ks);Wg=i(cl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ah.forEach(t),t_=d(Xt),Re=n(Xt,"DIV",{class:!0});var wt=r(Re);T(rr.$$.fragment,wt),s_=d(wt),ws=n(wt,"P",{});var pl=r(ws);o_=i(pl,"The "),Ii=n(pl,"A",{href:!0});var v$=r(Ii);n_=i(v$,"DistilBertForQuestionAnswering"),v$.forEach(t),r_=i(pl," forward method, overrides the "),pd=n(pl,"CODE",{});var b$=r(pd);a_=i(b$,"__call__"),b$.forEach(t),i_=i(pl," special method."),pl.forEach(t),l_=d(wt),T(ho.$$.fragment,wt),d_=d(wt),hd=n(wt,"P",{});var T$=r(hd);c_=i(T$,"Example:"),T$.forEach(t),p_=d(wt),T(ar.$$.fragment,wt),h_=d(wt),T(ir.$$.fragment,wt),wt.forEach(t),Xt.forEach(t),Sp=d(s),ys=n(s,"H2",{class:!0});var Oh=r(ys);uo=n(Oh,"A",{id:!0,class:!0,href:!0});var k$=r(uo);ud=n(k$,"SPAN",{});var w$=r(ud);T(lr.$$.fragment,w$),w$.forEach(t),k$.forEach(t),u_=d(Oh),fd=n(Oh,"SPAN",{});var y$=r(fd);f_=i(y$,"TFDistilBertModel"),y$.forEach(t),Oh.forEach(t),Wp=d(s),qe=n(s,"DIV",{class:!0});var yt=r(qe);T(dr.$$.fragment,yt),m_=d(yt),md=n(yt,"P",{});var $$=r(md);g_=i($$,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),$$.forEach(t),__=d(yt),cr=n(yt,"P",{});var Nh=r(cr);v_=i(Nh,"This model inherits from "),Li=n(Nh,"A",{href:!0});var D$=r(Li);b_=i(D$,"TFPreTrainedModel"),D$.forEach(t),T_=i(Nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nh.forEach(t),k_=d(yt),pr=n(yt,"P",{});var Ih=r(pr);w_=i(Ih,"This model is also a "),hr=n(Ih,"A",{href:!0,rel:!0});var F$=r(hr);y_=i(F$,"tf.keras.Model"),F$.forEach(t),$_=i(Ih,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),D_=d(yt),T(fo.$$.fragment,yt),F_=d(yt),ot=n(yt,"DIV",{class:!0});var Yt=r(ot);T(ur.$$.fragment,Yt),B_=d(Yt),$s=n(Yt,"P",{});var hl=r($s);M_=i(hl,"The "),Si=n(hl,"A",{href:!0});var B$=r(Si);E_=i(B$,"TFDistilBertModel"),B$.forEach(t),x_=i(hl," forward method, overrides the "),gd=n(hl,"CODE",{});var M$=r(gd);z_=i(M$,"__call__"),M$.forEach(t),j_=i(hl," special method."),hl.forEach(t),C_=d(Yt),T(mo.$$.fragment,Yt),P_=d(Yt),_d=n(Yt,"P",{});var E$=r(_d);q_=i(E$,"Example:"),E$.forEach(t),A_=d(Yt),T(fr.$$.fragment,Yt),Yt.forEach(t),yt.forEach(t),Rp=d(s),Ds=n(s,"H2",{class:!0});var Lh=r(Ds);go=n(Lh,"A",{id:!0,class:!0,href:!0});var x$=r(go);vd=n(x$,"SPAN",{});var z$=r(vd);T(mr.$$.fragment,z$),z$.forEach(t),x$.forEach(t),O_=d(Lh),bd=n(Lh,"SPAN",{});var j$=r(bd);N_=i(j$,"TFDistilBertForMaskedLM"),j$.forEach(t),Lh.forEach(t),Up=d(s),Ae=n(s,"DIV",{class:!0});var $t=r(Ae);T(gr.$$.fragment,$t),I_=d($t),_r=n($t,"P",{});var Sh=r(_r);L_=i(Sh,"DistilBert Model with a "),Td=n(Sh,"CODE",{});var C$=r(Td);S_=i(C$,"masked language modeling"),C$.forEach(t),W_=i(Sh," head on top."),Sh.forEach(t),R_=d($t),vr=n($t,"P",{});var Wh=r(vr);U_=i(Wh,"This model inherits from "),Wi=n(Wh,"A",{href:!0});var P$=r(Wi);H_=i(P$,"TFPreTrainedModel"),P$.forEach(t),Q_=i(Wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wh.forEach(t),K_=d($t),br=n($t,"P",{});var Rh=r(br);V_=i(Rh,"This model is also a "),Tr=n(Rh,"A",{href:!0,rel:!0});var q$=r(Tr);J_=i(q$,"tf.keras.Model"),q$.forEach(t),G_=i(Rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),X_=d($t),T(_o.$$.fragment,$t),Y_=d($t),Ue=n($t,"DIV",{class:!0});var Dt=r(Ue);T(kr.$$.fragment,Dt),Z_=d(Dt),Fs=n(Dt,"P",{});var ul=r(Fs);e1=i(ul,"The "),Ri=n(ul,"A",{href:!0});var A$=r(Ri);t1=i(A$,"TFDistilBertForMaskedLM"),A$.forEach(t),s1=i(ul," forward method, overrides the "),kd=n(ul,"CODE",{});var O$=r(kd);o1=i(O$,"__call__"),O$.forEach(t),n1=i(ul," special method."),ul.forEach(t),r1=d(Dt),T(vo.$$.fragment,Dt),a1=d(Dt),wd=n(Dt,"P",{});var N$=r(wd);i1=i(N$,"Example:"),N$.forEach(t),l1=d(Dt),T(wr.$$.fragment,Dt),d1=d(Dt),T(yr.$$.fragment,Dt),Dt.forEach(t),$t.forEach(t),Hp=d(s),Bs=n(s,"H2",{class:!0});var Uh=r(Bs);bo=n(Uh,"A",{id:!0,class:!0,href:!0});var I$=r(bo);yd=n(I$,"SPAN",{});var L$=r(yd);T($r.$$.fragment,L$),L$.forEach(t),I$.forEach(t),c1=d(Uh),$d=n(Uh,"SPAN",{});var S$=r($d);p1=i(S$,"TFDistilBertForSequenceClassification"),S$.forEach(t),Uh.forEach(t),Qp=d(s),Oe=n(s,"DIV",{class:!0});var Ft=r(Oe);T(Dr.$$.fragment,Ft),h1=d(Ft),Dd=n(Ft,"P",{});var W$=r(Dd);u1=i(W$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh.forEach(t),v1=d(Ft),Br=n(Ft,"P",{});var Qh=r(Br);b1=i(Qh,"This model is also a "),Mr=n(Qh,"A",{href:!0,rel:!0});var U$=r(Mr);T1=i(U$,"tf.keras.Model"),U$.forEach(t),k1=i(Qh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qh.forEach(t),w1=d(Ft),T(To.$$.fragment,Ft),y1=d(Ft),He=n(Ft,"DIV",{class:!0});var Bt=r(He);T(Er.$$.fragment,Bt),$1=d(Bt),Ms=n(Bt,"P",{});var fl=r(Ms);D1=i(fl,"The "),Hi=n(fl,"A",{href:!0});var H$=r(Hi);F1=i(H$,"TFDistilBertForSequenceClassification"),H$.forEach(t),B1=i(fl," forward method, overrides the "),Fd=n(fl,"CODE",{});var Q$=r(Fd);M1=i(Q$,"__call__"),Q$.forEach(t),E1=i(fl," special method."),fl.forEach(t),x1=d(Bt),T(ko.$$.fragment,Bt),z1=d(Bt),Bd=n(Bt,"P",{});var K$=r(Bd);j1=i(K$,"Example:"),K$.forEach(t),C1=d(Bt),T(xr.$$.fragment,Bt),P1=d(Bt),T(zr.$$.fragment,Bt),Bt.forEach(t),Ft.forEach(t),Kp=d(s),Es=n(s,"H2",{class:!0});var Kh=r(Es);wo=n(Kh,"A",{id:!0,class:!0,href:!0});var V$=r(wo);Md=n(V$,"SPAN",{});var J$=r(Md);T(jr.$$.fragment,J$),J$.forEach(t),V$.forEach(t),q1=d(Kh),Ed=n(Kh,"SPAN",{});var G$=r(Ed);A1=i(G$,"TFDistilBertForMultipleChoice"),G$.forEach(t),Kh.forEach(t),Vp=d(s),Ne=n(s,"DIV",{class:!0});var Mt=r(Ne);T(Cr.$$.fragment,Mt),O1=d(Mt),xd=n(Mt,"P",{});var X$=r(xd);N1=i(X$,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jh.forEach(t),K1=d(Mt),T(yo.$$.fragment,Mt),V1=d(Mt),nt=n(Mt,"DIV",{class:!0});var Zt=r(nt);T(Or.$$.fragment,Zt),J1=d(Zt),xs=n(Zt,"P",{});var ml=r(xs);G1=i(ml,"The "),Ki=n(ml,"A",{href:!0});var eD=r(Ki);X1=i(eD,"TFDistilBertForMultipleChoice"),eD.forEach(t),Y1=i(ml," forward method, overrides the "),zd=n(ml,"CODE",{});var tD=r(zd);Z1=i(tD,"__call__"),tD.forEach(t),ev=i(ml," special method."),ml.forEach(t),tv=d(Zt),T($o.$$.fragment,Zt),sv=d(Zt),jd=n(Zt,"P",{});var sD=r(jd);ov=i(sD,"Example:"),sD.forEach(t),nv=d(Zt),T(Nr.$$.fragment,Zt),Zt.forEach(t),Mt.forEach(t),Jp=d(s),zs=n(s,"H2",{class:!0});var Gh=r(zs);Do=n(Gh,"A",{id:!0,class:!0,href:!0});var oD=r(Do);Cd=n(oD,"SPAN",{});var nD=r(Cd);T(Ir.$$.fragment,nD),nD.forEach(t),oD.forEach(t),rv=d(Gh),Pd=n(Gh,"SPAN",{});var rD=r(Pd);av=i(rD,"TFDistilBertForTokenClassification"),rD.forEach(t),Gh.forEach(t),Gp=d(s),Ie=n(s,"DIV",{class:!0});var Et=r(Ie);T(Lr.$$.fragment,Et),iv=d(Et),qd=n(Et,"P",{});var aD=r(qd);lv=i(aD,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yh.forEach(t),_v=d(Et),T(Fo.$$.fragment,Et),vv=d(Et),Qe=n(Et,"DIV",{class:!0});var xt=r(Qe);T(Ur.$$.fragment,xt),bv=d(xt),js=n(xt,"P",{});var gl=r(js);Tv=i(gl,"The "),Ji=n(gl,"A",{href:!0});var dD=r(Ji);kv=i(dD,"TFDistilBertForTokenClassification"),dD.forEach(t),wv=i(gl," forward method, overrides the "),Ad=n(gl,"CODE",{});var cD=r(Ad);yv=i(cD,"__call__"),cD.forEach(t),$v=i(gl," special method."),gl.forEach(t),Dv=d(xt),T(Bo.$$.fragment,xt),Fv=d(xt),Od=n(xt,"P",{});var pD=r(Od);Bv=i(pD,"Example:"),pD.forEach(t),Mv=d(xt),T(Hr.$$.fragment,xt),Ev=d(xt),T(Qr.$$.fragment,xt),xt.forEach(t),Et.forEach(t),Xp=d(s),Cs=n(s,"H2",{class:!0});var Zh=r(Cs);Mo=n(Zh,"A",{id:!0,class:!0,href:!0});var hD=r(Mo);Nd=n(hD,"SPAN",{});var uD=r(Nd);T(Kr.$$.fragment,uD),uD.forEach(t),hD.forEach(t),xv=d(Zh),Id=n(Zh,"SPAN",{});var fD=r(Id);zv=i(fD,"TFDistilBertForQuestionAnswering"),fD.forEach(t),Zh.forEach(t),Yp=d(s),Le=n(s,"DIV",{class:!0});var zt=r(Le);T(Vr.$$.fragment,zt),jv=d(zt),Ps=n(zt,"P",{});var _l=r(Ps);Cv=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Qv=d(zt),T(Eo.$$.fragment,zt),Kv=d(zt),Ke=n(zt,"DIV",{class:!0});var jt=r(Ke);T(Yr.$$.fragment,jt),Vv=d(jt),qs=n(jt,"P",{});var vl=r(qs);Jv=i(vl,"The "),Xi=n(vl,"A",{href:!0});var bD=r(Xi);Gv=i(bD,"TFDistilBertForQuestionAnswering"),bD.forEach(t),Xv=i(vl," forward method, overrides the "),Wd=n(vl,"CODE",{});var TD=r(Wd);Yv=i(TD,"__call__"),TD.forEach(t),Zv=i(vl," special method."),vl.forEach(t),eb=d(jt),T(xo.$$.fragment,jt),tb=d(jt),Rd=n(jt,"P",{});var kD=r(Rd);sb=i(kD,"Example:"),kD.forEach(t),ob=d(jt),T(Zr.$$.fragment,jt),nb=d(jt),T(ea.$$.fragment,jt),jt.forEach(t),zt.forEach(t),Zp=d(s),As=n(s,"H2",{class:!0});var su=r(As);zo=n(su,"A",{id:!0,class:!0,href:!0});var wD=r(zo);Ud=n(wD,"SPAN",{});var yD=r(Ud);T(ta.$$.fragment,yD),yD.forEach(t),wD.forEach(t),rb=d(su),Hd=n(su,"SPAN",{});var $D=r(Hd);ab=i($D,"FlaxDistilBertModel"),$D.forEach(t),su.forEach(t),eh=d(s),Me=n(s,"DIV",{class:!0});var pt=r(Me);T(sa.$$.fragment,pt),ib=d(pt),Qd=n(pt,"P",{});var DD=r(Qd);lb=i(DD,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),DD.forEach(t),db=d(pt),oa=n(pt,"P",{});var ou=r(oa);cb=i(ou,"This model inherits from "),Yi=n(ou,"A",{href:!0});var FD=r(Yi);pb=i(FD,"FlaxPreTrainedModel"),FD.forEach(t),hb=i(ou,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),nu.forEach(t),_b=d(pt),Kd=n(pt,"P",{});var MD=r(Kd);vb=i(MD,"Finally, this model supports inherent JAX features such as:"),MD.forEach(t),bb=d(pt),Pt=n(pt,"UL",{});var Qo=r(Pt);Vd=n(Qo,"LI",{});var ED=r(Vd);aa=n(ED,"A",{href:!0,rel:!0});var xD=r(aa);Tb=i(xD,"Just-In-Time (JIT) compilation"),xD.forEach(t),ED.forEach(t),kb=d(Qo),Jd=n(Qo,"LI",{});var zD=r(Jd);ia=n(zD,"A",{href:!0,rel:!0});var jD=r(ia);wb=i(jD,"Automatic Differentiation"),jD.forEach(t),zD.forEach(t),yb=d(Qo),Gd=n(Qo,"LI",{});var CD=r(Gd);la=n(CD,"A",{href:!0,rel:!0});var PD=r(la);$b=i(PD,"Vectorization"),PD.forEach(t),CD.forEach(t),Db=d(Qo),Xd=n(Qo,"LI",{});var qD=r(Xd);da=n(qD,"A",{href:!0,rel:!0});var AD=r(da);Fb=i(AD,"Parallelization"),AD.forEach(t),qD.forEach(t),Qo.forEach(t),Bb=d(pt),rt=n(pt,"DIV",{class:!0});var es=r(rt);T(ca.$$.fragment,es),Mb=d(es),Os=n(es,"P",{});var bl=r(Os);Eb=i(bl,"The "),Yd=n(bl,"CODE",{});var OD=r(Yd);xb=i(OD,"FlaxDistilBertPreTrainedModel"),OD.forEach(t),zb=i(bl,"forward method, overrides the "),Zd=n(bl,"CODE",{});var ND=r(Zd);jb=i(ND,"__call__"),ND.forEach(t),Cb=i(bl," special method."),bl.forEach(t),Pb=d(es),T(jo.$$.fragment,es),qb=d(es),ec=n(es,"P",{});var ID=r(ec);Ab=i(ID,"Example:"),ID.forEach(t),Ob=d(es),T(pa.$$.fragment,es),es.forEach(t),pt.forEach(t),th=d(s),Ns=n(s,"H2",{class:!0});var ru=r(Ns);Co=n(ru,"A",{id:!0,class:!0,href:!0});var LD=r(Co);tc=n(LD,"SPAN",{});var SD=r(tc);T(ha.$$.fragment,SD),SD.forEach(t),LD.forEach(t),Nb=d(ru),sc=n(ru,"SPAN",{});var WD=r(sc);Ib=i(WD,"FlaxDistilBertForMaskedLM"),WD.forEach(t),ru.forEach(t),sh=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);T(ua.$$.fragment,ht),Lb=d(ht),fa=n(ht,"P",{});var au=r(fa);Sb=i(au,"DistilBert Model with a "),oc=n(au,"CODE",{});var RD=r(oc);Wb=i(RD,"language modeling"),RD.forEach(t),Rb=i(au," head on top."),au.forEach(t),Ub=d(ht),ma=n(ht,"P",{});var iu=r(ma);Hb=i(iu,"This model inherits from "),Zi=n(iu,"A",{href:!0});var UD=r(Zi);Qb=i(UD,"FlaxPreTrainedModel"),UD.forEach(t),Kb=i(iu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Yb=d(ht),nc=n(ht,"P",{});var QD=r(nc);Zb=i(QD,"Finally, this model supports inherent JAX features such as:"),QD.forEach(t),eT=d(ht),qt=n(ht,"UL",{});var Ko=r(qt);rc=n(Ko,"LI",{});var KD=r(rc);va=n(KD,"A",{href:!0,rel:!0});var VD=r(va);tT=i(VD,"Just-In-Time (JIT) compilation"),VD.forEach(t),KD.forEach(t),sT=d(Ko),ac=n(Ko,"LI",{});var JD=r(ac);ba=n(JD,"A",{href:!0,rel:!0});var GD=r(ba);oT=i(GD,"Automatic Differentiation"),GD.forEach(t),JD.forEach(t),nT=d(Ko),ic=n(Ko,"LI",{});var XD=r(ic);Ta=n(XD,"A",{href:!0,rel:!0});var YD=r(Ta);rT=i(YD,"Vectorization"),YD.forEach(t),XD.forEach(t),aT=d(Ko),lc=n(Ko,"LI",{});var ZD=r(lc);ka=n(ZD,"A",{href:!0,rel:!0});var e2=r(ka);iT=i(e2,"Parallelization"),e2.forEach(t),ZD.forEach(t),Ko.forEach(t),lT=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);T(wa.$$.fragment,ts),dT=d(ts),Is=n(ts,"P",{});var Tl=r(Is);cT=i(Tl,"The "),dc=n(Tl,"CODE",{});var t2=r(dc);pT=i(t2,"FlaxDistilBertPreTrainedModel"),t2.forEach(t),hT=i(Tl,"forward method, overrides the "),cc=n(Tl,"CODE",{});var s2=r(cc);uT=i(s2,"__call__"),s2.forEach(t),fT=i(Tl," special method."),Tl.forEach(t),mT=d(ts),T(Po.$$.fragment,ts),gT=d(ts),pc=n(ts,"P",{});var o2=r(pc);_T=i(o2,"Example:"),o2.forEach(t),vT=d(ts),T(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ls=n(s,"H2",{class:!0});var du=r(Ls);qo=n(du,"A",{id:!0,class:!0,href:!0});var n2=r(qo);hc=n(n2,"SPAN",{});var r2=r(hc);T($a.$$.fragment,r2),r2.forEach(t),n2.forEach(t),bT=d(du),uc=n(du,"SPAN",{});var a2=r(uc);TT=i(a2,"FlaxDistilBertForSequenceClassification"),a2.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);T(Da.$$.fragment,ut),kT=d(ut),fc=n(ut,"P",{});var i2=r(fc);wT=i(i2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),zT=d(ut),mc=n(ut,"P",{});var c2=r(mc);jT=i(c2,"Finally, this model supports inherent JAX features such as:"),c2.forEach(t),CT=d(ut),At=n(ut,"UL",{});var Vo=r(At);gc=n(Vo,"LI",{});var p2=r(gc);Ea=n(p2,"A",{href:!0,rel:!0});var h2=r(Ea);PT=i(h2,"Just-In-Time (JIT) compilation"),h2.forEach(t),p2.forEach(t),qT=d(Vo),_c=n(Vo,"LI",{});var u2=r(_c);xa=n(u2,"A",{href:!0,rel:!0});var f2=r(xa);AT=i(f2,"Automatic Differentiation"),f2.forEach(t),u2.forEach(t),OT=d(Vo),vc=n(Vo,"LI",{});var m2=r(vc);za=n(m2,"A",{href:!0,rel:!0});var g2=r(za);NT=i(g2,"Vectorization"),g2.forEach(t),m2.forEach(t),IT=d(Vo),bc=n(Vo,"LI",{});var _2=r(bc);ja=n(_2,"A",{href:!0,rel:!0});var v2=r(ja);LT=i(v2,"Parallelization"),v2.forEach(t),_2.forEach(t),Vo.forEach(t),ST=d(ut),it=n(ut,"DIV",{class:!0});var ss=r(it);T(Ca.$$.fragment,ss),WT=d(ss),Ss=n(ss,"P",{});var kl=r(Ss);RT=i(kl,"The "),Tc=n(kl,"CODE",{});var b2=r(Tc);UT=i(b2,"FlaxDistilBertPreTrainedModel"),b2.forEach(t),HT=i(kl,"forward method, overrides the "),kc=n(kl,"CODE",{});var T2=r(kc);QT=i(T2,"__call__"),T2.forEach(t),KT=i(kl," special method."),kl.forEach(t),VT=d(ss),T(Ao.$$.fragment,ss),JT=d(ss),wc=n(ss,"P",{});var k2=r(wc);GT=i(k2,"Example:"),k2.forEach(t),XT=d(ss),T(Pa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),rh=d(s),Ws=n(s,"H2",{class:!0});var hu=r(Ws);Oo=n(hu,"A",{id:!0,class:!0,href:!0});var w2=r(Oo);yc=n(w2,"SPAN",{});var y2=r(yc);T(qa.$$.fragment,y2),y2.forEach(t),w2.forEach(t),YT=d(hu),$c=n(hu,"SPAN",{});var $2=r($c);ZT=i($2,"FlaxDistilBertForMultipleChoice"),$2.forEach(t),hu.forEach(t),ah=d(s),ze=n(s,"DIV",{class:!0});var ft=r(ze);T(Aa.$$.fragment,ft),ek=d(ft),Dc=n(ft,"P",{});var D2=r(Dc);tk=i(D2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),D2.forEach(t),sk=d(ft),Oa=n(ft,"P",{});var uu=r(Oa);ok=i(uu,"This model inherits from "),tl=n(uu,"A",{href:!0});var F2=r(tl);nk=i(F2,"FlaxPreTrainedModel"),F2.forEach(t),rk=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),uu.forEach(t),ak=d(ft),Na=n(ft,"P",{});var fu=r(Na);ik=i(fu,"This model is also a Flax Linen "),Ia=n(fu,"A",{href:!0,rel:!0});var B2=r(Ia);lk=i(B2,"flax.linen.Module"),B2.forEach(t),dk=i(fu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),fu.forEach(t),ck=d(ft),Fc=n(ft,"P",{});var M2=r(Fc);pk=i(M2,"Finally, this model supports inherent JAX features such as:"),M2.forEach(t),hk=d(ft),Ot=n(ft,"UL",{});var Jo=r(Ot);Bc=n(Jo,"LI",{});var E2=r(Bc);La=n(E2,"A",{href:!0,rel:!0});var x2=r(La);uk=i(x2,"Just-In-Time (JIT) compilation"),x2.forEach(t),E2.forEach(t),fk=d(Jo),Mc=n(Jo,"LI",{});var z2=r(Mc);Sa=n(z2,"A",{href:!0,rel:!0});var j2=r(Sa);mk=i(j2,"Automatic Differentiation"),j2.forEach(t),z2.forEach(t),gk=d(Jo),Ec=n(Jo,"LI",{});var C2=r(Ec);Wa=n(C2,"A",{href:!0,rel:!0});var P2=r(Wa);_k=i(P2,"Vectorization"),P2.forEach(t),C2.forEach(t),vk=d(Jo),xc=n(Jo,"LI",{});var q2=r(xc);Ra=n(q2,"A",{href:!0,rel:!0});var A2=r(Ra);bk=i(A2,"Parallelization"),A2.forEach(t),q2.forEach(t),Jo.forEach(t),Tk=d(ft),lt=n(ft,"DIV",{class:!0});var os=r(lt);T(Ua.$$.fragment,os),kk=d(os),Rs=n(os,"P",{});var wl=r(Rs);wk=i(wl,"The "),zc=n(wl,"CODE",{});var O2=r(zc);yk=i(O2,"FlaxDistilBertPreTrainedModel"),O2.forEach(t),$k=i(wl,"forward method, overrides the "),jc=n(wl,"CODE",{});var N2=r(jc);Dk=i(N2,"__call__"),N2.forEach(t),Fk=i(wl," special method."),wl.forEach(t),Bk=d(os),T(No.$$.fragment,os),Mk=d(os),Cc=n(os,"P",{});var I2=r(Cc);Ek=i(I2,"Example:"),I2.forEach(t),xk=d(os),T(Ha.$$.fragment,os),os.forEach(t),ft.forEach(t),ih=d(s),Us=n(s,"H2",{class:!0});var mu=r(Us);Io=n(mu,"A",{id:!0,class:!0,href:!0});var L2=r(Io);Pc=n(L2,"SPAN",{});var S2=r(Pc);T(Qa.$$.fragment,S2),S2.forEach(t),L2.forEach(t),zk=d(mu),qc=n(mu,"SPAN",{});var W2=r(qc);jk=i(W2,"FlaxDistilBertForTokenClassification"),W2.forEach(t),mu.forEach(t),lh=d(s),je=n(s,"DIV",{class:!0});var mt=r(je);T(Ka.$$.fragment,mt),Ck=d(mt),Ac=n(mt,"P",{});var R2=r(Ac);Pk=i(R2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R2.forEach(t),qk=d(mt),Va=n(mt,"P",{});var gu=r(Va);Ak=i(gu,"This model inherits from "),sl=n(gu,"A",{href:!0});var U2=r(sl);Ok=i(U2,"FlaxPreTrainedModel"),U2.forEach(t),Nk=i(gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),gu.forEach(t),Ik=d(mt),Ja=n(mt,"P",{});var _u=r(Ja);Lk=i(_u,"This model is also a Flax Linen "),Ga=n(_u,"A",{href:!0,rel:!0});var H2=r(Ga);Sk=i(H2,"flax.linen.Module"),H2.forEach(t),Wk=i(_u,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_u.forEach(t),Rk=d(mt),Oc=n(mt,"P",{});var Q2=r(Oc);Uk=i(Q2,"Finally, this model supports inherent JAX features such as:"),Q2.forEach(t),Hk=d(mt),Nt=n(mt,"UL",{});var Go=r(Nt);Nc=n(Go,"LI",{});var K2=r(Nc);Xa=n(K2,"A",{href:!0,rel:!0});var V2=r(Xa);Qk=i(V2,"Just-In-Time (JIT) compilation"),V2.forEach(t),K2.forEach(t),Kk=d(Go),Ic=n(Go,"LI",{});var J2=r(Ic);Ya=n(J2,"A",{href:!0,rel:!0});var G2=r(Ya);Vk=i(G2,"Automatic Differentiation"),G2.forEach(t),J2.forEach(t),Jk=d(Go),Lc=n(Go,"LI",{});var X2=r(Lc);Za=n(X2,"A",{href:!0,rel:!0});var Y2=r(Za);Gk=i(Y2,"Vectorization"),Y2.forEach(t),X2.forEach(t),Xk=d(Go),Sc=n(Go,"LI",{});var Z2=r(Sc);ei=n(Z2,"A",{href:!0,rel:!0});var eF=r(ei);Yk=i(eF,"Parallelization"),eF.forEach(t),Z2.forEach(t),Go.forEach(t),Zk=d(mt),dt=n(mt,"DIV",{class:!0});var ns=r(dt);T(ti.$$.fragment,ns),ew=d(ns),Hs=n(ns,"P",{});var yl=r(Hs);tw=i(yl,"The "),Wc=n(yl,"CODE",{});var tF=r(Wc);sw=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),ow=i(yl,"forward method, overrides the "),Rc=n(yl,"CODE",{});var sF=r(Rc);nw=i(sF,"__call__"),sF.forEach(t),rw=i(yl," special method."),yl.forEach(t),aw=d(ns),T(Lo.$$.fragment,ns),iw=d(ns),Uc=n(ns,"P",{});var oF=r(Uc);lw=i(oF,"Example:"),oF.forEach(t),dw=d(ns),T(si.$$.fragment,ns),ns.forEach(t),mt.forEach(t),dh=d(s),Qs=n(s,"H2",{class:!0});var vu=r(Qs);So=n(vu,"A",{id:!0,class:!0,href:!0});var nF=r(So);Hc=n(nF,"SPAN",{});var rF=r(Hc);T(oi.$$.fragment,rF),rF.forEach(t),nF.forEach(t),cw=d(vu),Qc=n(vu,"SPAN",{});var aF=r(Qc);pw=i(aF,"FlaxDistilBertForQuestionAnswering"),aF.forEach(t),vu.forEach(t),ch=d(s),Ce=n(s,"DIV",{class:!0});var gt=r(Ce);T(ni.$$.fragment,gt),hw=d(gt),Ks=n(gt,"P",{});var $l=r(Ks);uw=i($l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Kc=n($l,"CODE",{});var iF=r(Kc);fw=i(iF,"span start logits"),iF.forEach(t),mw=i($l," and "),Vc=n($l,"CODE",{});var lF=r(Vc);gw=i(lF,"span end logits"),lF.forEach(t),_w=i($l,")."),$l.forEach(t),vw=d(gt),ri=n(gt,"P",{});var bu=r(ri);bw=i(bu,"This model inherits from "),ol=n(bu,"A",{href:!0});var dF=r(ol);Tw=i(dF,"FlaxPreTrainedModel"),dF.forEach(t),kw=i(bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),bu.forEach(t),ww=d(gt),ai=n(gt,"P",{});var Tu=r(ai);yw=i(Tu,"This model is also a Flax Linen "),ii=n(Tu,"A",{href:!0,rel:!0});var cF=r(ii);$w=i(cF,"flax.linen.Module"),cF.forEach(t),Dw=i(Tu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Tu.forEach(t),Fw=d(gt),Jc=n(gt,"P",{});var pF=r(Jc);Bw=i(pF,"Finally, this model supports inherent JAX features such as:"),pF.forEach(t),Mw=d(gt),It=n(gt,"UL",{});var Xo=r(It);Gc=n(Xo,"LI",{});var hF=r(Gc);li=n(hF,"A",{href:!0,rel:!0});var uF=r(li);Ew=i(uF,"Just-In-Time (JIT) compilation"),uF.forEach(t),hF.forEach(t),xw=d(Xo),Xc=n(Xo,"LI",{});var fF=r(Xc);di=n(fF,"A",{href:!0,rel:!0});var mF=r(di);zw=i(mF,"Automatic Differentiation"),mF.forEach(t),fF.forEach(t),jw=d(Xo),Yc=n(Xo,"LI",{});var gF=r(Yc);ci=n(gF,"A",{href:!0,rel:!0});var _F=r(ci);Cw=i(_F,"Vectorization"),_F.forEach(t),gF.forEach(t),Pw=d(Xo),Zc=n(Xo,"LI",{});var vF=r(Zc);pi=n(vF,"A",{href:!0,rel:!0});var bF=r(pi);qw=i(bF,"Parallelization"),bF.forEach(t),vF.forEach(t),Xo.forEach(t),Aw=d(gt),ct=n(gt,"DIV",{class:!0});var rs=r(ct);T(hi.$$.fragment,rs),Ow=d(rs),Vs=n(rs,"P",{});var Dl=r(Vs);Nw=i(Dl,"The "),ep=n(Dl,"CODE",{});var TF=r(ep);Iw=i(TF,"FlaxDistilBertPreTrainedModel"),TF.forEach(t),Lw=i(Dl,"forward method, overrides the "),tp=n(Dl,"CODE",{});var kF=r(tp);Sw=i(kF,"__call__"),kF.forEach(t),Ww=i(Dl," special method."),Dl.forEach(t),Rw=d(rs),T(Wo.$$.fragment,rs),Uw=d(rs),sp=n(rs,"P",{});var wF=r(sp);Hw=i(wF,"Example:"),wF.forEach(t),Qw=d(rs),T(ui.$$.fragment,rs),rs.forEach(t),gt.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(ZF)),c(v,"id","distilbert"),c(v,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(v,"href","#distilbert"),c(g,"class","relative group"),c(G,"id","overview"),c(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(G,"href","#overview"),c(E,"class","relative group"),c(Y,"href","https://medium.com/huggingface/distilbert-8cf3380435b5"),c(Y,"rel","nofollow"),c(z,"href","https://arxiv.org/abs/1910.01108"),c(z,"rel","nofollow"),c(Yo,"href","https://huggingface.co/victorsanh"),c(Yo,"rel","nofollow"),c(Zo,"href","https://huggingface.co/kamalkraj"),c(Zo,"rel","nofollow"),c(en,"href","https://github.com/huggingface/transformers/tree/main/examples/research_projects/distillation"),c(en,"rel","nofollow"),c(Js,"id","transformers.DistilBertConfig"),c(Js,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Js,"href","#transformers.DistilBertConfig"),c(as,"class","relative group"),c(vi,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertModel"),c(bi,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.TFDistilBertModel"),c(on,"href","https://huggingface.co/distilbert-base-uncased"),c(on,"rel","nofollow"),c(Ti,"href","/docs/transformers/pr_16148/en/main_classes/configuration#transformers.PretrainedConfig"),c(ki,"href","/docs/transformers/pr_16148/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ve,"class","docstring"),c(Gs,"id","transformers.DistilBertTokenizer"),c(Gs,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Gs,"href","#transformers.DistilBertTokenizer"),c(ls,"class","relative group"),c(wi,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertTokenizer"),c(yi,"href","/docs/transformers/pr_16148/en/model_doc/bert#transformers.BertTokenizer"),c($i,"href","/docs/transformers/pr_16148/en/model_doc/bert#transformers.BertTokenizer"),c(_t,"class","docstring"),c(Ys,"id","transformers.DistilBertTokenizerFast"),c(Ys,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ys,"href","#transformers.DistilBertTokenizerFast"),c(ds,"class","relative group"),c(Di,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertTokenizerFast"),c(Fi,"href","/docs/transformers/pr_16148/en/model_doc/bert#transformers.BertTokenizerFast"),c(Bi,"href","/docs/transformers/pr_16148/en/model_doc/bert#transformers.BertTokenizerFast"),c(vt,"class","docstring"),c(eo,"id","transformers.DistilBertModel"),c(eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(eo,"href","#transformers.DistilBertModel"),c(cs,"class","relative group"),c(Mi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),c(_n,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(_n,"rel","nofollow"),c(Ei,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertModel"),c(tt,"class","docstring"),c(Je,"class","docstring"),c(so,"id","transformers.DistilBertForMaskedLM"),c(so,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(so,"href","#transformers.DistilBertForMaskedLM"),c(hs,"class","relative group"),c(xi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),c(Dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Dn,"rel","nofollow"),c(zi,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertForMaskedLM"),c(Se,"class","docstring"),c(Ge,"class","docstring"),c(no,"id","transformers.DistilBertForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.DistilBertForSequenceClassification"),c(fs,"class","relative group"),c(ji,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),c(Cn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Cn,"rel","nofollow"),c(Ci,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification"),c(Te,"class","docstring"),c(Xe,"class","docstring"),c(ao,"id","transformers.DistilBertForMultipleChoice"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.DistilBertForMultipleChoice"),c(gs,"class","relative group"),c(Pi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),c(Rn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Rn,"rel","nofollow"),c(qi,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertForMultipleChoice"),c(st,"class","docstring"),c(Ye,"class","docstring"),c(lo,"id","transformers.DistilBertForTokenClassification"),c(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(lo,"href","#transformers.DistilBertForTokenClassification"),c(vs,"class","relative group"),c(Ai,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),c(Gn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Gn,"rel","nofollow"),c(Oi,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertForTokenClassification"),c(We,"class","docstring"),c(Ze,"class","docstring"),c(po,"id","transformers.DistilBertForQuestionAnswering"),c(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(po,"href","#transformers.DistilBertForQuestionAnswering"),c(Ts,"class","relative group"),c(Ni,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),c(nr,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(nr,"rel","nofollow"),c(Ii,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.DistilBertForQuestionAnswering"),c(Re,"class","docstring"),c(et,"class","docstring"),c(uo,"id","transformers.TFDistilBertModel"),c(uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(uo,"href","#transformers.TFDistilBertModel"),c(ys,"class","relative group"),c(Li,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.TFPreTrainedModel"),c(hr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(hr,"rel","nofollow"),c(Si,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.TFDistilBertModel"),c(ot,"class","docstring"),c(qe,"class","docstring"),c(go,"id","transformers.TFDistilBertForMaskedLM"),c(go,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(go,"href","#transformers.TFDistilBertForMaskedLM"),c(Ds,"class","relative group"),c(Wi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.TFPreTrainedModel"),c(Tr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Tr,"rel","nofollow"),c(Ri,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.TFDistilBertForMaskedLM"),c(Ue,"class","docstring"),c(Ae,"class","docstring"),c(bo,"id","transformers.TFDistilBertForSequenceClassification"),c(bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(bo,"href","#transformers.TFDistilBertForSequenceClassification"),c(Bs,"class","relative group"),c(Ui,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.TFPreTrainedModel"),c(Mr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Mr,"rel","nofollow"),c(Hi,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.TFDistilBertForSequenceClassification"),c(He,"class","docstring"),c(Oe,"class","docstring"),c(wo,"id","transformers.TFDistilBertForMultipleChoice"),c(wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(wo,"href","#transformers.TFDistilBertForMultipleChoice"),c(Es,"class","relative group"),c(Qi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.TFPreTrainedModel"),c(Ar,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Ar,"rel","nofollow"),c(Ki,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.TFDistilBertForMultipleChoice"),c(nt,"class","docstring"),c(Ne,"class","docstring"),c(Do,"id","transformers.TFDistilBertForTokenClassification"),c(Do,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Do,"href","#transformers.TFDistilBertForTokenClassification"),c(zs,"class","relative group"),c(Vi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.TFPreTrainedModel"),c(Rr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Rr,"rel","nofollow"),c(Ji,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.TFDistilBertForTokenClassification"),c(Qe,"class","docstring"),c(Ie,"class","docstring"),c(Mo,"id","transformers.TFDistilBertForQuestionAnswering"),c(Mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mo,"href","#transformers.TFDistilBertForQuestionAnswering"),c(Cs,"class","relative group"),c(Gi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.TFPreTrainedModel"),c(Xr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Xr,"rel","nofollow"),c(Xi,"href","/docs/transformers/pr_16148/en/model_doc/distilbert#transformers.TFDistilBertForQuestionAnswering"),c(Ke,"class","docstring"),c(Le,"class","docstring"),c(zo,"id","transformers.FlaxDistilBertModel"),c(zo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(zo,"href","#transformers.FlaxDistilBertModel"),c(As,"class","relative group"),c(Yi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(ra,"href","https://flax.readthedocs.io/en/latest/flax.linen.html#module"),c(ra,"rel","nofollow"),c(aa,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(aa,"rel","nofollow"),c(ia,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(ia,"rel","nofollow"),c(la,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(la,"rel","nofollow"),c(da,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(da,"rel","nofollow"),c(rt,"class","docstring"),c(Me,"class","docstring"),c(Co,"id","transformers.FlaxDistilBertForMaskedLM"),c(Co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Co,"href","#transformers.FlaxDistilBertForMaskedLM"),c(Ns,"class","relative group"),c(Zi,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(_a,"href","https://flax.readthedocs.io/en/latest/flax.linen.html#module"),c(_a,"rel","nofollow"),c(va,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(va,"rel","nofollow"),c(ba,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(ba,"rel","nofollow"),c(Ta,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Ta,"rel","nofollow"),c(ka,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(ka,"rel","nofollow"),c(at,"class","docstring"),c(Ee,"class","docstring"),c(qo,"id","transformers.FlaxDistilBertForSequenceClassification"),c(qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qo,"href","#transformers.FlaxDistilBertForSequenceClassification"),c(Ls,"class","relative group"),c(el,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Ma,"href","https://flax.readthedocs.io/en/latest/flax.linen.html#module"),c(Ma,"rel","nofollow"),c(Ea,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Ea,"rel","nofollow"),c(xa,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(xa,"rel","nofollow"),c(za,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(za,"rel","nofollow"),c(ja,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(ja,"rel","nofollow"),c(it,"class","docstring"),c(xe,"class","docstring"),c(Oo,"id","transformers.FlaxDistilBertForMultipleChoice"),c(Oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Oo,"href","#transformers.FlaxDistilBertForMultipleChoice"),c(Ws,"class","relative group"),c(tl,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Ia,"href","https://flax.readthedocs.io/en/latest/flax.linen.html#module"),c(Ia,"rel","nofollow"),c(La,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(La,"rel","nofollow"),c(Sa,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Sa,"rel","nofollow"),c(Wa,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Wa,"rel","nofollow"),c(Ra,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Ra,"rel","nofollow"),c(lt,"class","docstring"),c(ze,"class","docstring"),c(Io,"id","transformers.FlaxDistilBertForTokenClassification"),c(Io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Io,"href","#transformers.FlaxDistilBertForTokenClassification"),c(Us,"class","relative group"),c(sl,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Ga,"href","https://flax.readthedocs.io/en/latest/flax.linen.html#module"),c(Ga,"rel","nofollow"),c(Xa,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Xa,"rel","nofollow"),c(Ya,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Ya,"rel","nofollow"),c(Za,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Za,"rel","nofollow"),c(ei,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(ei,"rel","nofollow"),c(dt,"class","docstring"),c(je,"class","docstring"),c(So,"id","transformers.FlaxDistilBertForQuestionAnswering"),c(So,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(So,"href","#transformers.FlaxDistilBertForQuestionAnswering"),c(Qs,"class","relative group"),c(ol,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(ii,"href","https://flax.readthedocs.io/en/latest/flax.linen.html#module"),c(ii,"rel","nofollow"),c(li,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(li,"rel","nofollow"),c(di,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(di,"rel","nofollow"),c(ci,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(ci,"rel","nofollow"),c(pi,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(pi,"rel","nofollow"),c(ct,"class","docstring"),c(Ce,"class","docstring")},m(s,m){e(document.head,p),u(s,F,m),u(s,g,m),e(g,v),e(v,D),k(_,D,null),e(g,f),e(g,B),e(B,ce),u(s,K,m),u(s,E,m),e(E,G),e(G,L),k(X,L,null),e(E,pe),e(E,S),e(S,he),u(s,ae,m),u(s,N,m),e(N,q),e(N,Y),e(Y,V),e(N,x),e(N,z),e(z,ue),e(N,W),e(N,se),e(se,fe),e(N,R),u(s,ie,m),u(s,ee,m),e(ee,A),u(s,le,m),u(s,I,m),e(I,oe),e(oe,me),u(s,P,m),u(s,te,m),e(te,U),u(s,de,m),u(s,h,m),e(h,M),e(M,J),e(M,_e),e(_e,ke),e(M,O),e(M,ve),e(ve,we),e(M,ye),e(M,C),e(C,H),e(M,$e),e(h,De),e(h,Z),e(Z,Fe),e(Z,ne),e(ne,Be),e(Z,ku),u(s,wp,m),u(s,bt,m),e(bt,wu),e(bt,Yo),e(Yo,yu),e(bt,$u),e(bt,Zo),e(Zo,Du),e(bt,Fu),e(bt,en),e(en,Bu),e(bt,Mu),u(s,yp,m),u(s,as,m),e(as,Js),e(Js,Fl),k(tn,Fl,null),e(as,Eu),e(as,Bl),e(Bl,xu),u(s,$p,m),u(s,Ve,m),k(sn,Ve,null),e(Ve,zu),e(Ve,Ct),e(Ct,ju),e(Ct,vi),e(vi,Cu),e(Ct,Pu),e(Ct,bi),e(bi,qu),e(Ct,Au),e(Ct,on),e(on,Ou),e(Ct,Nu),e(Ve,Iu),e(Ve,is),e(is,Lu),e(is,Ti),e(Ti,Su),e(is,Wu),e(is,ki),e(ki,Ru),e(is,Uu),e(Ve,Hu),e(Ve,Ml),e(Ml,Qu),e(Ve,Ku),k(nn,Ve,null),u(s,Dp,m),u(s,ls,m),e(ls,Gs),e(Gs,El),k(rn,El,null),e(ls,Vu),e(ls,xl),e(xl,Ju),u(s,Fp,m),u(s,_t,m),k(an,_t,null),e(_t,Gu),e(_t,zl),e(zl,Xu),e(_t,Yu),e(_t,Xs),e(Xs,wi),e(wi,Zu),e(Xs,ef),e(Xs,yi),e(yi,tf),e(Xs,sf),e(_t,of),e(_t,ln),e(ln,nf),e(ln,$i),e($i,rf),e(ln,af),u(s,Bp,m),u(s,ds,m),e(ds,Ys),e(Ys,jl),k(dn,jl,null),e(ds,lf),e(ds,Cl),e(Cl,df),u(s,Mp,m),u(s,vt,m),k(cn,vt,null),e(vt,cf),e(vt,pn),e(pn,pf),e(pn,Pl),e(Pl,hf),e(pn,uf),e(vt,ff),e(vt,Zs),e(Zs,Di),e(Di,mf),e(Zs,gf),e(Zs,Fi),e(Fi,_f),e(Zs,vf),e(vt,bf),e(vt,hn),e(hn,Tf),e(hn,Bi),e(Bi,kf),e(hn,wf),u(s,Ep,m),u(s,cs,m),e(cs,eo),e(eo,ql),k(un,ql,null),e(cs,yf),e(cs,Al),e(Al,$f),u(s,xp,m),u(s,Je,m),k(fn,Je,null),e(Je,Df),e(Je,Ol),e(Ol,Ff),e(Je,Bf),e(Je,mn),e(mn,Mf),e(mn,Mi),e(Mi,Ef),e(mn,xf),e(Je,zf),e(Je,gn),e(gn,jf),e(gn,_n),e(_n,Cf),e(gn,Pf),e(Je,qf),e(Je,tt),k(vn,tt,null),e(tt,Af),e(tt,ps),e(ps,Of),e(ps,Ei),e(Ei,Nf),e(ps,If),e(ps,Nl),e(Nl,Lf),e(ps,Sf),e(tt,Wf),k(to,tt,null),e(tt,Rf),e(tt,Il),e(Il,Uf),e(tt,Hf),k(bn,tt,null),u(s,zp,m),u(s,hs,m),e(hs,so),e(so,Ll),k(Tn,Ll,null),e(hs,Qf),e(hs,Sl),e(Sl,Kf),u(s,jp,m),u(s,Ge,m),k(kn,Ge,null),e(Ge,Vf),e(Ge,wn),e(wn,Jf),e(wn,Wl),e(Wl,Gf),e(wn,Xf),e(Ge,Yf),e(Ge,yn),e(yn,Zf),e(yn,xi),e(xi,em),e(yn,tm),e(Ge,sm),e(Ge,$n),e($n,om),e($n,Dn),e(Dn,nm),e($n,rm),e(Ge,am),e(Ge,Se),k(Fn,Se,null),e(Se,im),e(Se,us),e(us,lm),e(us,zi),e(zi,dm),e(us,cm),e(us,Rl),e(Rl,pm),e(us,hm),e(Se,um),k(oo,Se,null),e(Se,fm),e(Se,Ul),e(Ul,mm),e(Se,gm),k(Bn,Se,null),e(Se,_m),k(Mn,Se,null),u(s,Cp,m),u(s,fs,m),e(fs,no),e(no,Hl),k(En,Hl,null),e(fs,vm),e(fs,Ql),e(Ql,bm),u(s,Pp,m),u(s,Xe,m),k(xn,Xe,null),e(Xe,Tm),e(Xe,Kl),e(Kl,km),e(Xe,wm),e(Xe,zn),e(zn,ym),e(zn,ji),e(ji,$m),e(zn,Dm),e(Xe,Fm),e(Xe,jn),e(jn,Bm),e(jn,Cn),e(Cn,Mm),e(jn,Em),e(Xe,xm),e(Xe,Te),k(Pn,Te,null),e(Te,zm),e(Te,ms),e(ms,jm),e(ms,Ci),e(Ci,Cm),e(ms,Pm),e(ms,Vl),e(Vl,qm),e(ms,Am),e(Te,Om),k(ro,Te,null),e(Te,Nm),e(Te,Jl),e(Jl,Im),e(Te,Lm),k(qn,Te,null),e(Te,Sm),k(An,Te,null),e(Te,Wm),e(Te,Gl),e(Gl,Rm),e(Te,Um),k(On,Te,null),e(Te,Hm),k(Nn,Te,null),u(s,qp,m),u(s,gs,m),e(gs,ao),e(ao,Xl),k(In,Xl,null),e(gs,Qm),e(gs,Yl),e(Yl,Km),u(s,Ap,m),u(s,Ye,m),k(Ln,Ye,null),e(Ye,Vm),e(Ye,Zl),e(Zl,Jm),e(Ye,Gm),e(Ye,Sn),e(Sn,Xm),e(Sn,Pi),e(Pi,Ym),e(Sn,Zm),e(Ye,eg),e(Ye,Wn),e(Wn,tg),e(Wn,Rn),e(Rn,sg),e(Wn,og),e(Ye,ng),e(Ye,st),k(Un,st,null),e(st,rg),e(st,_s),e(_s,ag),e(_s,qi),e(qi,ig),e(_s,lg),e(_s,ed),e(ed,dg),e(_s,cg),e(st,pg),k(io,st,null),e(st,hg),e(st,td),e(td,ug),e(st,fg),k(Hn,st,null),u(s,Op,m),u(s,vs,m),e(vs,lo),e(lo,sd),k(Qn,sd,null),e(vs,mg),e(vs,od),e(od,gg),u(s,Np,m),u(s,Ze,m),k(Kn,Ze,null),e(Ze,_g),e(Ze,nd),e(nd,vg),e(Ze,bg),e(Ze,Vn),e(Vn,Tg),e(Vn,Ai),e(Ai,kg),e(Vn,wg),e(Ze,yg),e(Ze,Jn),e(Jn,$g),e(Jn,Gn),e(Gn,Dg),e(Jn,Fg),e(Ze,Bg),e(Ze,We),k(Xn,We,null),e(We,Mg),e(We,bs),e(bs,Eg),e(bs,Oi),e(Oi,xg),e(bs,zg),e(bs,rd),e(rd,jg),e(bs,Cg),e(We,Pg),k(co,We,null),e(We,qg),e(We,ad),e(ad,Ag),e(We,Og),k(Yn,We,null),e(We,Ng),k(Zn,We,null),u(s,Ip,m),u(s,Ts,m),e(Ts,po),e(po,id),k(er,id,null),e(Ts,Ig),e(Ts,ld),e(ld,Lg),u(s,Lp,m),u(s,et,m),k(tr,et,null),e(et,Sg),e(et,ks),e(ks,Wg),e(ks,dd),e(dd,Rg),e(ks,Ug),e(ks,cd),e(cd,Hg),e(ks,Qg),e(et,Kg),e(et,sr),e(sr,Vg),e(sr,Ni),e(Ni,Jg),e(sr,Gg),e(et,Xg),e(et,or),e(or,Yg),e(or,nr),e(nr,Zg),e(or,e_),e(et,t_),e(et,Re),k(rr,Re,null),e(Re,s_),e(Re,ws),e(ws,o_),e(ws,Ii),e(Ii,n_),e(ws,r_),e(ws,pd),e(pd,a_),e(ws,i_),e(Re,l_),k(ho,Re,null),e(Re,d_),e(Re,hd),e(hd,c_),e(Re,p_),k(ar,Re,null),e(Re,h_),k(ir,Re,null),u(s,Sp,m),u(s,ys,m),e(ys,uo),e(uo,ud),k(lr,ud,null),e(ys,u_),e(ys,fd),e(fd,f_),u(s,Wp,m),u(s,qe,m),k(dr,qe,null),e(qe,m_),e(qe,md),e(md,g_),e(qe,__),e(qe,cr),e(cr,v_),e(cr,Li),e(Li,b_),e(cr,T_),e(qe,k_),e(qe,pr),e(pr,w_),e(pr,hr),e(hr,y_),e(pr,$_),e(qe,D_),k(fo,qe,null),e(qe,F_),e(qe,ot),k(ur,ot,null),e(ot,B_),e(ot,$s),e($s,M_),e($s,Si),e(Si,E_),e($s,x_),e($s,gd),e(gd,z_),e($s,j_),e(ot,C_),k(mo,ot,null),e(ot,P_),e(ot,_d),e(_d,q_),e(ot,A_),k(fr,ot,null),u(s,Rp,m),u(s,Ds,m),e(Ds,go),e(go,vd),k(mr,vd,null),e(Ds,O_),e(Ds,bd),e(bd,N_),u(s,Up,m),u(s,Ae,m),k(gr,Ae,null),e(Ae,I_),e(Ae,_r),e(_r,L_),e(_r,Td),e(Td,S_),e(_r,W_),e(Ae,R_),e(Ae,vr),e(vr,U_),e(vr,Wi),e(Wi,H_),e(vr,Q_),e(Ae,K_),e(Ae,br),e(br,V_),e(br,Tr),e(Tr,J_),e(br,G_),e(Ae,X_),k(_o,Ae,null),e(Ae,Y_),e(Ae,Ue),k(kr,Ue,null),e(Ue,Z_),e(Ue,Fs),e(Fs,e1),e(Fs,Ri),e(Ri,t1),e(Fs,s1),e(Fs,kd),e(kd,o1),e(Fs,n1),e(Ue,r1),k(vo,Ue,null),e(Ue,a1),e(Ue,wd),e(wd,i1),e(Ue,l1),k(wr,Ue,null),e(Ue,d1),k(yr,Ue,null),u(s,Hp,m),u(s,Bs,m),e(Bs,bo),e(bo,yd),k($r,yd,null),e(Bs,c1),e(Bs,$d),e($d,p1),u(s,Qp,m),u(s,Oe,m),k(Dr,Oe,null),e(Oe,h1),e(Oe,Dd),e(Dd,u1),e(Oe,f1),e(Oe,Fr),e(Fr,m1),e(Fr,Ui),e(Ui,g1),e(Fr,_1),e(Oe,v1),e(Oe,Br),e(Br,b1),e(Br,Mr),e(Mr,T1),e(Br,k1),e(Oe,w1),k(To,Oe,null),e(Oe,y1),e(Oe,He),k(Er,He,null),e(He,$1),e(He,Ms),e(Ms,D1),e(Ms,Hi),e(Hi,F1),e(Ms,B1),e(Ms,Fd),e(Fd,M1),e(Ms,E1),e(He,x1),k(ko,He,null),e(He,z1),e(He,Bd),e(Bd,j1),e(He,C1),k(xr,He,null),e(He,P1),k(zr,He,null),u(s,Kp,m),u(s,Es,m),e(Es,wo),e(wo,Md),k(jr,Md,null),e(Es,q1),e(Es,Ed),e(Ed,A1),u(s,Vp,m),u(s,Ne,m),k(Cr,Ne,null),e(Ne,O1),e(Ne,xd),e(xd,N1),e(Ne,I1),e(Ne,Pr),e(Pr,L1),e(Pr,Qi),e(Qi,S1),e(Pr,W1),e(Ne,R1),e(Ne,qr),e(qr,U1),e(qr,Ar),e(Ar,H1),e(qr,Q1),e(Ne,K1),k(yo,Ne,null),e(Ne,V1),e(Ne,nt),k(Or,nt,null),e(nt,J1),e(nt,xs),e(xs,G1),e(xs,Ki),e(Ki,X1),e(xs,Y1),e(xs,zd),e(zd,Z1),e(xs,ev),e(nt,tv),k($o,nt,null),e(nt,sv),e(nt,jd),e(jd,ov),e(nt,nv),k(Nr,nt,null),u(s,Jp,m),u(s,zs,m),e(zs,Do),e(Do,Cd),k(Ir,Cd,null),e(zs,rv),e(zs,Pd),e(Pd,av),u(s,Gp,m),u(s,Ie,m),k(Lr,Ie,null),e(Ie,iv),e(Ie,qd),e(qd,lv),e(Ie,dv),e(Ie,Sr),e(Sr,cv),e(Sr,Vi),e(Vi,pv),e(Sr,hv),e(Ie,uv),e(Ie,Wr),e(Wr,fv),e(Wr,Rr),e(Rr,mv),e(Wr,gv),e(Ie,_v),k(Fo,Ie,null),e(Ie,vv),e(Ie,Qe),k(Ur,Qe,null),e(Qe,bv),e(Qe,js),e(js,Tv),e(js,Ji),e(Ji,kv),e(js,wv),e(js,Ad),e(Ad,yv),e(js,$v),e(Qe,Dv),k(Bo,Qe,null),e(Qe,Fv),e(Qe,Od),e(Od,Bv),e(Qe,Mv),k(Hr,Qe,null),e(Qe,Ev),k(Qr,Qe,null),u(s,Xp,m),u(s,Cs,m),e(Cs,Mo),e(Mo,Nd),k(Kr,Nd,null),e(Cs,xv),e(Cs,Id),e(Id,zv),u(s,Yp,m),u(s,Le,m),k(Vr,Le,null),e(Le,jv),e(Le,Ps),e(Ps,Cv),e(Ps,Ld),e(Ld,Pv),e(Ps,qv),e(Ps,Sd),e(Sd,Av),e(Ps,Ov),e(Le,Nv),e(Le,Jr),e(Jr,Iv),e(Jr,Gi),e(Gi,Lv),e(Jr,Sv),e(Le,Wv),e(Le,Gr),e(Gr,Rv),e(Gr,Xr),e(Xr,Uv),e(Gr,Hv),e(Le,Qv),k(Eo,Le,null),e(Le,Kv),e(Le,Ke),k(Yr,Ke,null),e(Ke,Vv),e(Ke,qs),e(qs,Jv),e(qs,Xi),e(Xi,Gv),e(qs,Xv),e(qs,Wd),e(Wd,Yv),e(qs,Zv),e(Ke,eb),k(xo,Ke,null),e(Ke,tb),e(Ke,Rd),e(Rd,sb),e(Ke,ob),k(Zr,Ke,null),e(Ke,nb),k(ea,Ke,null),u(s,Zp,m),u(s,As,m),e(As,zo),e(zo,Ud),k(ta,Ud,null),e(As,rb),e(As,Hd),e(Hd,ab),u(s,eh,m),u(s,Me,m),k(sa,Me,null),e(Me,ib),e(Me,Qd),e(Qd,lb),e(Me,db),e(Me,oa),e(oa,cb),e(oa,Yi),e(Yi,pb),e(oa,hb),e(Me,ub),e(Me,na),e(na,fb),e(na,ra),e(ra,mb),e(na,gb),e(Me,_b),e(Me,Kd),e(Kd,vb),e(Me,bb),e(Me,Pt),e(Pt,Vd),e(Vd,aa),e(aa,Tb),e(Pt,kb),e(Pt,Jd),e(Jd,ia),e(ia,wb),e(Pt,yb),e(Pt,Gd),e(Gd,la),e(la,$b),e(Pt,Db),e(Pt,Xd),e(Xd,da),e(da,Fb),e(Me,Bb),e(Me,rt),k(ca,rt,null),e(rt,Mb),e(rt,Os),e(Os,Eb),e(Os,Yd),e(Yd,xb),e(Os,zb),e(Os,Zd),e(Zd,jb),e(Os,Cb),e(rt,Pb),k(jo,rt,null),e(rt,qb),e(rt,ec),e(ec,Ab),e(rt,Ob),k(pa,rt,null),u(s,th,m),u(s,Ns,m),e(Ns,Co),e(Co,tc),k(ha,tc,null),e(Ns,Nb),e(Ns,sc),e(sc,Ib),u(s,sh,m),u(s,Ee,m),k(ua,Ee,null),e(Ee,Lb),e(Ee,fa),e(fa,Sb),e(fa,oc),e(oc,Wb),e(fa,Rb),e(Ee,Ub),e(Ee,ma),e(ma,Hb),e(ma,Zi),e(Zi,Qb),e(ma,Kb),e(Ee,Vb),e(Ee,ga),e(ga,Jb),e(ga,_a),e(_a,Gb),e(ga,Xb),e(Ee,Yb),e(Ee,nc),e(nc,Zb),e(Ee,eT),e(Ee,qt),e(qt,rc),e(rc,va),e(va,tT),e(qt,sT),e(qt,ac),e(ac,ba),e(ba,oT),e(qt,nT),e(qt,ic),e(ic,Ta),e(Ta,rT),e(qt,aT),e(qt,lc),e(lc,ka),e(ka,iT),e(Ee,lT),e(Ee,at),k(wa,at,null),e(at,dT),e(at,Is),e(Is,cT),e(Is,dc),e(dc,pT),e(Is,hT),e(Is,cc),e(cc,uT),e(Is,fT),e(at,mT),k(Po,at,null),e(at,gT),e(at,pc),e(pc,_T),e(at,vT),k(ya,at,null),u(s,oh,m),u(s,Ls,m),e(Ls,qo),e(qo,hc),k($a,hc,null),e(Ls,bT),e(Ls,uc),e(uc,TT),u(s,nh,m),u(s,xe,m),k(Da,xe,null),e(xe,kT),e(xe,fc),e(fc,wT),e(xe,yT),e(xe,Fa),e(Fa,$T),e(Fa,el),e(el,DT),e(Fa,FT),e(xe,BT),e(xe,Ba),e(Ba,MT),e(Ba,Ma),e(Ma,ET),e(Ba,xT),e(xe,zT),e(xe,mc),e(mc,jT),e(xe,CT),e(xe,At),e(At,gc),e(gc,Ea),e(Ea,PT),e(At,qT),e(At,_c),e(_c,xa),e(xa,AT),e(At,OT),e(At,vc),e(vc,za),e(za,NT),e(At,IT),e(At,bc),e(bc,ja),e(ja,LT),e(xe,ST),e(xe,it),k(Ca,it,null),e(it,WT),e(it,Ss),e(Ss,RT),e(Ss,Tc),e(Tc,UT),e(Ss,HT),e(Ss,kc),e(kc,QT),e(Ss,KT),e(it,VT),k(Ao,it,null),e(it,JT),e(it,wc),e(wc,GT),e(it,XT),k(Pa,it,null),u(s,rh,m),u(s,Ws,m),e(Ws,Oo),e(Oo,yc),k(qa,yc,null),e(Ws,YT),e(Ws,$c),e($c,ZT),u(s,ah,m),u(s,ze,m),k(Aa,ze,null),e(ze,ek),e(ze,Dc),e(Dc,tk),e(ze,sk),e(ze,Oa),e(Oa,ok),e(Oa,tl),e(tl,nk),e(Oa,rk),e(ze,ak),e(ze,Na),e(Na,ik),e(Na,Ia),e(Ia,lk),e(Na,dk),e(ze,ck),e(ze,Fc),e(Fc,pk),e(ze,hk),e(ze,Ot),e(Ot,Bc),e(Bc,La),e(La,uk),e(Ot,fk),e(Ot,Mc),e(Mc,Sa),e(Sa,mk),e(Ot,gk),e(Ot,Ec),e(Ec,Wa),e(Wa,_k),e(Ot,vk),e(Ot,xc),e(xc,Ra),e(Ra,bk),e(ze,Tk),e(ze,lt),k(Ua,lt,null),e(lt,kk),e(lt,Rs),e(Rs,wk),e(Rs,zc),e(zc,yk),e(Rs,$k),e(Rs,jc),e(jc,Dk),e(Rs,Fk),e(lt,Bk),k(No,lt,null),e(lt,Mk),e(lt,Cc),e(Cc,Ek),e(lt,xk),k(Ha,lt,null),u(s,ih,m),u(s,Us,m),e(Us,Io),e(Io,Pc),k(Qa,Pc,null),e(Us,zk),e(Us,qc),e(qc,jk),u(s,lh,m),u(s,je,m),k(Ka,je,null),e(je,Ck),e(je,Ac),e(Ac,Pk),e(je,qk),e(je,Va),e(Va,Ak),e(Va,sl),e(sl,Ok),e(Va,Nk),e(je,Ik),e(je,Ja),e(Ja,Lk),e(Ja,Ga),e(Ga,Sk),e(Ja,Wk),e(je,Rk),e(je,Oc),e(Oc,Uk),e(je,Hk),e(je,Nt),e(Nt,Nc),e(Nc,Xa),e(Xa,Qk),e(Nt,Kk),e(Nt,Ic),e(Ic,Ya),e(Ya,Vk),e(Nt,Jk),e(Nt,Lc),e(Lc,Za),e(Za,Gk),e(Nt,Xk),e(Nt,Sc),e(Sc,ei),e(ei,Yk),e(je,Zk),e(je,dt),k(ti,dt,null),e(dt,ew),e(dt,Hs),e(Hs,tw),e(Hs,Wc),e(Wc,sw),e(Hs,ow),e(Hs,Rc),e(Rc,nw),e(Hs,rw),e(dt,aw),k(Lo,dt,null),e(dt,iw),e(dt,Uc),e(Uc,lw),e(dt,dw),k(si,dt,null),u(s,dh,m),u(s,Qs,m),e(Qs,So),e(So,Hc),k(oi,Hc,null),e(Qs,cw),e(Qs,Qc),e(Qc,pw),u(s,ch,m),u(s,Ce,m),k(ni,Ce,null),e(Ce,hw),e(Ce,Ks),e(Ks,uw),e(Ks,Kc),e(Kc,fw),e(Ks,mw),e(Ks,Vc),e(Vc,gw),e(Ks,_w),e(Ce,vw),e(Ce,ri),e(ri,bw),e(ri,ol),e(ol,Tw),e(ri,kw),e(Ce,ww),e(Ce,ai),e(ai,yw),e(ai,ii),e(ii,$w),e(ai,Dw),e(Ce,Fw),e(Ce,Jc),e(Jc,Bw),e(Ce,Mw),e(Ce,It),e(It,Gc),e(Gc,li),e(li,Ew),e(It,xw),e(It,Xc),e(Xc,di),e(di,zw),e(It,jw),e(It,Yc),e(Yc,ci),e(ci,Cw),e(It,Pw),e(It,Zc),e(Zc,pi),e(pi,qw),e(Ce,Aw),e(Ce,ct),k(hi,ct,null),e(ct,Ow),e(ct,Vs),e(Vs,Nw),e(Vs,ep),e(ep,Iw),e(Vs,Lw),e(Vs,tp),e(tp,Sw),e(Vs,Ww),e(ct,Rw),k(Wo,ct,null),e(ct,Uw),e(ct,sp),e(sp,Hw),e(ct,Qw),k(ui,ct,null),ph=!0},p(s,[m]){const fi={};m&2&&(fi.$$scope={dirty:m,ctx:s}),to.$set(fi);const op={};m&2&&(op.$$scope={dirty:m,ctx:s}),oo.$set(op);const np={};m&2&&(np.$$scope={dirty:m,ctx:s}),ro.$set(np);const rp={};m&2&&(rp.$$scope={dirty:m,ctx:s}),io.$set(rp);const mi={};m&2&&(mi.$$scope={dirty:m,ctx:s}),co.$set(mi);const ap={};m&2&&(ap.$$scope={dirty:m,ctx:s}),ho.$set(ap);const ip={};m&2&&(ip.$$scope={dirty:m,ctx:s}),fo.$set(ip);const lp={};m&2&&(lp.$$scope={dirty:m,ctx:s}),mo.$set(lp);const Lt={};m&2&&(Lt.$$scope={dirty:m,ctx:s}),_o.$set(Lt);const dp={};m&2&&(dp.$$scope={dirty:m,ctx:s}),vo.$set(dp);const cp={};m&2&&(cp.$$scope={dirty:m,ctx:s}),To.$set(cp);const pp={};m&2&&(pp.$$scope={dirty:m,ctx:s}),ko.$set(pp);const hp={};m&2&&(hp.$$scope={dirty:m,ctx:s}),yo.$set(hp);const up={};m&2&&(up.$$scope={dirty:m,ctx:s}),$o.$set(up);const fp={};m&2&&(fp.$$scope={dirty:m,ctx:s}),Fo.$set(fp);const mp={};m&2&&(mp.$$scope={dirty:m,ctx:s}),Bo.$set(mp);const gi={};m&2&&(gi.$$scope={dirty:m,ctx:s}),Eo.$set(gi);const St={};m&2&&(St.$$scope={dirty:m,ctx:s}),xo.$set(St);const gp={};m&2&&(gp.$$scope={dirty:m,ctx:s}),jo.$set(gp);const _p={};m&2&&(_p.$$scope={dirty:m,ctx:s}),Po.$set(_p);const vp={};m&2&&(vp.$$scope={dirty:m,ctx:s}),Ao.$set(vp);const _i={};m&2&&(_i.$$scope={dirty:m,ctx:s}),No.$set(_i);const bp={};m&2&&(bp.$$scope={dirty:m,ctx:s}),Lo.$set(bp);const Wt={};m&2&&(Wt.$$scope={dirty:m,ctx:s}),Wo.$set(Wt)},i(s){ph||(w(_.$$.fragment,s),w(X.$$.fragment,s),w(tn.$$.fragment,s),w(sn.$$.fragment,s),w(nn.$$.fragment,s),w(rn.$$.fragment,s),w(an.$$.fragment,s),w(dn.$$.fragment,s),w(cn.$$.fragment,s),w(un.$$.fragment,s),w(fn.$$.fragment,s),w(vn.$$.fragment,s),w(to.$$.fragment,s),w(bn.$$.fragment,s),w(Tn.$$.fragment,s),w(kn.$$.fragment,s),w(Fn.$$.fragment,s),w(oo.$$.fragment,s),w(Bn.$$.fragment,s),w(Mn.$$.fragment,s),w(En.$$.fragment,s),w(xn.$$.fragment,s),w(Pn.$$.fragment,s),w(ro.$$.fragment,s),w(qn.$$.fragment,s),w(An.$$.fragment,s),w(On.$$.fragment,s),w(Nn.$$.fragment,s),w(In.$$.fragment,s),w(Ln.$$.fragment,s),w(Un.$$.fragment,s),w(io.$$.fragment,s),w(Hn.$$.fragment,s),w(Qn.$$.fragment,s),w(Kn.$$.fragment,s),w(Xn.$$.fragment,s),w(co.$$.fragment,s),w(Yn.$$.fragment,s),w(Zn.$$.fragment,s),w(er.$$.fragment,s),w(tr.$$.fragment,s),w(rr.$$.fragment,s),w(ho.$$.fragment,s),w(ar.$$.fragment,s),w(ir.$$.fragment,s),w(lr.$$.fragment,s),w(dr.$$.fragment,s),w(fo.$$.fragment,s),w(ur.$$.fragment,s),w(mo.$$.fragment,s),w(fr.$$.fragment,s),w(mr.$$.fragment,s),w(gr.$$.fragment,s),w(_o.$$.fragment,s),w(kr.$$.fragment,s),w(vo.$$.fragment,s),w(wr.$$.fragment,s),w(yr.$$.fragment,s),w($r.$$.fragment,s),w(Dr.$$.fragment,s),w(To.$$.fragment,s),w(Er.$$.fragment,s),w(ko.$$.fragment,s),w(xr.$$.fragment,s),w(zr.$$.fragment,s),w(jr.$$.fragment,s),w(Cr.$$.fragment,s),w(yo.$$.fragment,s),w(Or.$$.fragment,s),w($o.$$.fragment,s),w(Nr.$$.fragment,s),w(Ir.$$.fragment,s),w(Lr.$$.fragment,s),w(Fo.$$.fragment,s),w(Ur.$$.fragment,s),w(Bo.$$.fragment,s),w(Hr.$$.fragment,s),w(Qr.$$.fragment,s),w(Kr.$$.fragment,s),w(Vr.$$.fragment,s),w(Eo.$$.fragment,s),w(Yr.$$.fragment,s),w(xo.$$.fragment,s),w(Zr.$$.fragment,s),w(ea.$$.fragment,s),w(ta.$$.fragment,s),w(sa.$$.fragment,s),w(ca.$$.fragment,s),w(jo.$$.fragment,s),w(pa.$$.fragment,s),w(ha.$$.fragment,s),w(ua.$$.fragment,s),w(wa.$$.fragment,s),w(Po.$$.fragment,s),w(ya.$$.fragment,s),w($a.$$.fragment,s),w(Da.$$.fragment,s),w(Ca.$$.fragment,s),w(Ao.$$.fragment,s),w(Pa.$$.fragment,s),w(qa.$$.fragment,s),w(Aa.$$.fragment,s),w(Ua.$$.fragment,s),w(No.$$.fragment,s),w(Ha.$$.fragment,s),w(Qa.$$.fragment,s),w(Ka.$$.fragment,s),w(ti.$$.fragment,s),w(Lo.$$.fragment,s),w(si.$$.fragment,s),w(oi.$$.fragment,s),w(ni.$$.fragment,s),w(hi.$$.fragment,s),w(Wo.$$.fragment,s),w(ui.$$.fragment,s),ph=!0)},o(s){y(_.$$.fragment,s),y(X.$$.fragment,s),y(tn.$$.fragment,s),y(sn.$$.fragment,s),y(nn.$$.fragment,s),y(rn.$$.fragment,s),y(an.$$.fragment,s),y(dn.$$.fragment,s),y(cn.$$.fragment,s),y(un.$$.fragment,s),y(fn.$$.fragment,s),y(vn.$$.fragment,s),y(to.$$.fragment,s),y(bn.$$.fragment,s),y(Tn.$$.fragment,s),y(kn.$$.fragment,s),y(Fn.$$.fragment,s),y(oo.$$.fragment,s),y(Bn.$$.fragment,s),y(Mn.$$.fragment,s),y(En.$$.fragment,s),y(xn.$$.fragment,s),y(Pn.$$.fragment,s),y(ro.$$.fragment,s),y(qn.$$.fragment,s),y(An.$$.fragment,s),y(On.$$.fragment,s),y(Nn.$$.fragment,s),y(In.$$.fragment,s),y(Ln.$$.fragment,s),y(Un.$$.fragment,s),y(io.$$.fragment,s),y(Hn.$$.fragment,s),y(Qn.$$.fragment,s),y(Kn.$$.fragment,s),y(Xn.$$.fragment,s),y(co.$$.fragment,s),y(Yn.$$.fragment,s),y(Zn.$$.fragment,s),y(er.$$.fragment,s),y(tr.$$.fragment,s),y(rr.$$.fragment,s),y(ho.$$.fragment,s),y(ar.$$.fragment,s),y(ir.$$.fragment,s),y(lr.$$.fragment,s),y(dr.$$.fragment,s),y(fo.$$.fragment,s),y(ur.$$.fragment,s),y(mo.$$.fragment,s),y(fr.$$.fragment,s),y(mr.$$.fragment,s),y(gr.$$.fragment,s),y(_o.$$.fragment,s),y(kr.$$.fragment,s),y(vo.$$.fragment,s),y(wr.$$.fragment,s),y(yr.$$.fragment,s),y($r.$$.fragment,s),y(Dr.$$.fragment,s),y(To.$$.fragment,s),y(Er.$$.fragment,s),y(ko.$$.fragment,s),y(xr.$$.fragment,s),y(zr.$$.fragment,s),y(jr.$$.fragment,s),y(Cr.$$.fragment,s),y(yo.$$.fragment,s),y(Or.$$.fragment,s),y($o.$$.fragment,s),y(Nr.$$.fragment,s),y(Ir.$$.fragment,s),y(Lr.$$.fragment,s),y(Fo.$$.fragment,s),y(Ur.$$.fragment,s),y(Bo.$$.fragment,s),y(Hr.$$.fragment,s),y(Qr.$$.fragment,s),y(Kr.$$.fragment,s),y(Vr.$$.fragment,s),y(Eo.$$.fragment,s),y(Yr.$$.fragment,s),y(xo.$$.fragment,s),y(Zr.$$.fragment,s),y(ea.$$.fragment,s),y(ta.$$.fragment,s),y(sa.$$.fragment,s),y(ca.$$.fragment,s),y(jo.$$.fragment,s),y(pa.$$.fragment,s),y(ha.$$.fragment,s),y(ua.$$.fragment,s),y(wa.$$.fragment,s),y(Po.$$.fragment,s),y(ya.$$.fragment,s),y($a.$$.fragment,s),y(Da.$$.fragment,s),y(Ca.$$.fragment,s),y(Ao.$$.fragment,s),y(Pa.$$.fragment,s),y(qa.$$.fragment,s),y(Aa.$$.fragment,s),y(Ua.$$.fragment,s),y(No.$$.fragment,s),y(Ha.$$.fragment,s),y(Qa.$$.fragment,s),y(Ka.$$.fragment,s),y(ti.$$.fragment,s),y(Lo.$$.fragment,s),y(si.$$.fragment,s),y(oi.$$.fragment,s),y(ni.$$.fragment,s),y(hi.$$.fragment,s),y(Wo.$$.fragment,s),y(ui.$$.fragment,s),ph=!1},d(s){t(p),s&&t(F),s&&t(g),$(_),s&&t(K),s&&t(E),$(X),s&&t(ae),s&&t(N),s&&t(ie),s&&t(ee),s&&t(le),s&&t(I),s&&t(P),s&&t(te),s&&t(de),s&&t(h),s&&t(wp),s&&t(bt),s&&t(yp),s&&t(as),$(tn),s&&t($p),s&&t(Ve),$(sn),$(nn),s&&t(Dp),s&&t(ls),$(rn),s&&t(Fp),s&&t(_t),$(an),s&&t(Bp),s&&t(ds),$(dn),s&&t(Mp),s&&t(vt),$(cn),s&&t(Ep),s&&t(cs),$(un),s&&t(xp),s&&t(Je),$(fn),$(vn),$(to),$(bn),s&&t(zp),s&&t(hs),$(Tn),s&&t(jp),s&&t(Ge),$(kn),$(Fn),$(oo),$(Bn),$(Mn),s&&t(Cp),s&&t(fs),$(En),s&&t(Pp),s&&t(Xe),$(xn),$(Pn),$(ro),$(qn),$(An),$(On),$(Nn),s&&t(qp),s&&t(gs),$(In),s&&t(Ap),s&&t(Ye),$(Ln),$(Un),$(io),$(Hn),s&&t(Op),s&&t(vs),$(Qn),s&&t(Np),s&&t(Ze),$(Kn),$(Xn),$(co),$(Yn),$(Zn),s&&t(Ip),s&&t(Ts),$(er),s&&t(Lp),s&&t(et),$(tr),$(rr),$(ho),$(ar),$(ir),s&&t(Sp),s&&t(ys),$(lr),s&&t(Wp),s&&t(qe),$(dr),$(fo),$(ur),$(mo),$(fr),s&&t(Rp),s&&t(Ds),$(mr),s&&t(Up),s&&t(Ae),$(gr),$(_o),$(kr),$(vo),$(wr),$(yr),s&&t(Hp),s&&t(Bs),$($r),s&&t(Qp),s&&t(Oe),$(Dr),$(To),$(Er),$(ko),$(xr),$(zr),s&&t(Kp),s&&t(Es),$(jr),s&&t(Vp),s&&t(Ne),$(Cr),$(yo),$(Or),$($o),$(Nr),s&&t(Jp),s&&t(zs),$(Ir),s&&t(Gp),s&&t(Ie),$(Lr),$(Fo),$(Ur),$(Bo),$(Hr),$(Qr),s&&t(Xp),s&&t(Cs),$(Kr),s&&t(Yp),s&&t(Le),$(Vr),$(Eo),$(Yr),$(xo),$(Zr),$(ea),s&&t(Zp),s&&t(As),$(ta),s&&t(eh),s&&t(Me),$(sa),$(ca),$(jo),$(pa),s&&t(th),s&&t(Ns),$(ha),s&&t(sh),s&&t(Ee),$(ua),$(wa),$(Po),$(ya),s&&t(oh),s&&t(Ls),$($a),s&&t(nh),s&&t(xe),$(Da),$(Ca),$(Ao),$(Pa),s&&t(rh),s&&t(Ws),$(qa),s&&t(ah),s&&t(ze),$(Aa),$(Ua),$(No),$(Ha),s&&t(ih),s&&t(Us),$(Qa),s&&t(lh),s&&t(je),$(Ka),$(ti),$(Lo),$(si),s&&t(dh),s&&t(Qs),$(oi),s&&t(ch),s&&t(Ce),$(ni),$(hi),$(Wo),$(ui)}}}const ZF={local:"distilbert",sections:[{local:"overview",title:"Overview"},{local:"transformers.DistilBertConfig",title:"DistilBertConfig"},{local:"transformers.DistilBertTokenizer",title:"DistilBertTokenizer"},{local:"transformers.DistilBertTokenizerFast",title:"DistilBertTokenizerFast"},{local:"transformers.DistilBertModel",title:"DistilBertModel"},{local:"transformers.DistilBertForMaskedLM",title:"DistilBertForMaskedLM"},{local:"transformers.DistilBertForSequenceClassification",title:"DistilBertForSequenceClassification"},{local:"transformers.DistilBertForMultipleChoice",title:"DistilBertForMultipleChoice"},{local:"transformers.DistilBertForTokenClassification",title:"DistilBertForTokenClassification"},{local:"transformers.DistilBertForQuestionAnswering",title:"DistilBertForQuestionAnswering"},{local:"transformers.TFDistilBertModel",title:"TFDistilBertModel"},{local:"transformers.TFDistilBertForMaskedLM",title:"TFDistilBertForMaskedLM"},{local:"transformers.TFDistilBertForSequenceClassification",title:"TFDistilBertForSequenceClassification"},{local:"transformers.TFDistilBertForMultipleChoice",title:"TFDistilBertForMultipleChoice"},{local:"transformers.TFDistilBertForTokenClassification",title:"TFDistilBertForTokenClassification"},{local:"transformers.TFDistilBertForQuestionAnswering",title:"TFDistilBertForQuestionAnswering"},{local:"transformers.FlaxDistilBertModel",title:"FlaxDistilBertModel"},{local:"transformers.FlaxDistilBertForMaskedLM",title:"FlaxDistilBertForMaskedLM"},{local:"transformers.FlaxDistilBertForSequenceClassification",title:"FlaxDistilBertForSequenceClassification"},{local:"transformers.FlaxDistilBertForMultipleChoice",title:"FlaxDistilBertForMultipleChoice"},{local:"transformers.FlaxDistilBertForTokenClassification",title:"FlaxDistilBertForTokenClassification"},{local:"transformers.FlaxDistilBertForQuestionAnswering",title:"FlaxDistilBertForQuestionAnswering"}],title:"DistilBERT"};function e4(j){return BF(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class a4 extends yF{constructor(p){super();$F(this,p,e4,YF,DF,{})}}export{a4 as default,ZF as metadata};
