...
`}}),ae=new ks({props:{$$slots:{default:[Ca]},$$scope:{ctx:X}}}),ke=new ft({props:{code:`from transformers import Wav2Vec2Processor, SEWDModel
import torch
...
`}}),ie=new ks({props:{$$slots:{default:[Ta]},$$scope:{ctx:X}}}),Fe=new ft({props:{code:`from transformers import Wav2Vec2Processor, SEWDForCTC
from datasets import load_dataset
import torch
...
`}}),de=new ks({props:{$$slots:{default:[$a]},$$scope:{ctx:X}}}),He=new ft({props:{code:`from transformers import Wav2Vec2FeatureExtractor, SEWDForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){m=n("meta"),k=d(),h=n("h1"),S=n("a"),W=n("span"),_(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Vt=d(),I=n("h2"),Z=n("a"),ut=n("span"),_(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),Lt=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),pe=n("a"),Eo=r(`Performance-Efficiency Trade-offs
...
documentation from `),et=n("a"),Jo=r("PretrainedConfig"),Qo=r(" for more information."),Bo=d(),yt=n("p"),Yo=r("Example:"),Go=d(),_(_e.$$.fragment),Jt=d(),R=n("h2"),se=n("a"),Et=n("span"),_(ve.$$.fragment),Xo=d(),St=n("span"),Zo=r("SEWDModel"),Qt=d(),q=n("div"),_(we.$$.fragment),en=d(),be=n("p"),tn=r(`The bare SEW-D Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),fn=d(),P=n("div"),_(De.$$.fragment),hn=d(),U=n("p"),un=r("The "),ot=n("a"),gn=r("SEWDModel"),_n=r(" forward method, overrides the "),Wt=n("code"),vn=r("__call__"),wn=r(" special method."),bn=d(),_(ae.$$.fragment),yn=d(),Dt=n("p"),En=r("Example:"),Sn=d(),_(ke.$$.fragment),Bt=d(),J=n("h2"),re=n("a"),kt=n("span"),_(Ce.$$.fragment),Wn=d(),Ct=n("span"),Dn=r("SEWDForCTC"),Yt=d(),x=n("div"),_(Te.$$.fragment),kn=d(),Q=n("p"),Cn=r("SEW-D Model with a "),Tt=n("code"),Tn=r("language modeling"),$n=r(` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),On=d(),C=n("div"),_(Pe.$$.fragment),In=d(),B=n("p"),Nn=r("The "),st=n("a"),Kn=r("SEWDForCTC"),Hn=r(" forward method, overrides the "),$t=n("code"),Rn=r("__call__"),Un=r(" special method."),Jn=d(),_(ie.$$.fragment),Qn=d(),qt=n("p"),Bn=r("Example:"),Yn=d(),_(Fe.$$.fragment),Gn=d(),_(Me.$$.fragment),Gt=d(),Y=n("h2"),le=n("a"),xt=n("span"),_(ze.$$.fragment),Xn=d(),jt=n("span"),Zn=r("SEWDForSequenceClassification"),Xt=d(),D=n("div"),_(Ae.$$.fragment),es=d(),Pt=n("p"),ts=r(`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),hs=d(),T=n("div"),_(Ke.$$.fragment),us=d(),G=n("p"),gs=r("The "),rt=n("a"),_s=r("SEWDForSequenceClassification"),vs=r(" forward method, overrides the "),Ft=n("code"),ws=r("__call__"),bs=r(" special method."),ys=d(),_(de.$$.fragment),Es=d(),Mt=n("p"),Ss=r("Example:"),Ws=d(),_(He.$$.fragment),Ds=d(),_(Re.$$.fragment),this.h()},l(t){const p=Da('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),k=c(t),h=s(t,"H1",{class:!0});var Ue=a(h);S=s(Ue,"A",{id:!0,class:!0,href:!0});var zt=a(S);W=s(zt,"SPAN",{});var At=a(W);v(u.$$.fragment,At),At.forEach(o),zt.forEach(o),g=c(Ue),j=s(Ue,"SPAN",{});var Cs=a(j);vo=i(Cs,"SEW-D"),Cs.forEach(o),Ue.forEach(o),Vt=c(t),I=s(t,"H2",{class:!0});var eo=a(I);Z=s(eo,"A",{id:!0,class:!0,href:!0});var Ts=a(Z);ut=s(Ts,"SPAN",{});var $s=a(ut);v(ce.$$.fragment,$s),$s.forEach(o),Ts.forEach(o),wo=c(eo),gt=s(eo,"SPAN",{});var qs=a(gt);bo=i(qs,"Overview"),qs.forEach(o),eo.forEach(o),Lt=c(t),ee=s(t,"P",{});var to=a(ee);yo=i(to,"SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),pe=s(to,"A",{href:!0,rel:!0});var xs=a(pe);Eo=i(xs,`Performance-Efficiency Trade-offs
...
using `),Ge=s(no,"A",{href:!0});var As=a(Ge);qo=i(As,"Wav2Vec2CTCTokenizer"),As.forEach(o),xo=i(no,"."),no.forEach(o),oo.forEach(o),Ht=c(t),oe=s(t,"P",{});var so=a(oe);jo=i(so,"This model was contributed by "),fe=s(so,"A",{href:!0,rel:!0});var Vs=a(fe);Po=i(Vs,"anton-l"),Vs.forEach(o),Fo=i(so,"."),so.forEach(o),Rt=c(t),N=s(t,"H2",{class:!0});var ao=a(N);ne=s(ao,"A",{id:!0,class:!0,href:!0});var Ls=a(ne);wt=s(Ls,"SPAN",{});var Os=a(wt);v(he.$$.fragment,Os),Os.forEach(o),Ls.forEach(o),Mo=c(ao),bt=s(ao,"SPAN",{});var Is=a(bt);zo=i(Is,"SEWDConfig"),Is.forEach(o),ao.forEach(o),Ut=c(t),$=s(t,"DIV",{class:!0});var A=a($);v(ue.$$.fragment,A),Ao=c(A),K=s(A,"P",{});var it=a(K);Vo=i(it,"This is the configuration class to store the configuration of a "),Xe=s(it,"A",{href:!0});var Ns=a(Xe);Lo=i(Ns,"SEWDModel"),Ns.forEach(o),Oo=i(it,`. It is used to instantiate a SEW-D
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the SEW-D
`),ge=s(it,"A",{href:!0,rel:!0});var Ks=a(ge);Io=i(Ks,"asapp/sew-d-tiny-100k"),Ks.forEach(o),No=i(it," architecture."),it.forEach(o),Ko=c(A),H=s(A,"P",{});var lt=a(H);Ho=i(lt,"Configuration objects inherit from "),Ze=s(lt,"A",{href:!0});var Hs=a(Ze);Ro=i(Hs,"PretrainedConfig"),Hs.forEach(o),Uo=i(lt,` and can be used to control the model outputs. Read the
documentation from `),et=s(lt,"A",{href:!0});var Rs=a(et);Jo=i(Rs,"PretrainedConfig"),Rs.forEach(o),Qo=i(lt," for more information."),lt.forEach(o),Bo=c(A),yt=s(A,"P",{});var Us=a(yt);Yo=i(Us,"Example:"),Us.forEach(o),Go=c(A),v(_e.$$.fragment,A),A.forEach(o),Jt=c(t),R=s(t,"H2",{class:!0});var ro=a(R);se=s(ro,"A",{id:!0,class:!0,href:!0});var Js=a(se);Et=s(Js,"SPAN",{});var Qs=a(Et);v(ve.$$.fragment,Qs),Qs.forEach(o),Js.forEach(o),Xo=c(ro),St=s(ro,"SPAN",{});var Bs=a(St);Zo=i(Bs,"SEWDModel"),Bs.forEach(o),ro.forEach(o),Qt=c(t),q=s(t,"DIV",{class:!0});var V=a(q);v(we.$$.fragment,V),en=c(V),be=s(V,"P",{});var io=a(be);tn=i(io,`The bare SEW-D Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(V),P=s(V,"DIV",{class:!0});var L=a(P);v(De.$$.fragment,L),hn=c(L),U=s(L,"P",{});var dt=a(U);un=i(dt,"The "),ot=s(dt,"A",{href:!0});var Zs=a(ot);gn=i(Zs,"SEWDModel"),Zs.forEach(o),_n=i(dt," forward method, overrides the "),Wt=s(dt,"CODE",{});var ea=a(Wt);vn=i(ea,"__call__"),ea.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(L),v(ae.$$.fragment,L),yn=c(L),Dt=s(L,"P",{});var ta=a(Dt);En=i(ta,"Example:"),ta.forEach(o),Sn=c(L),v(ke.$$.fragment,L),L.forEach(o),V.forEach(o),Bt=c(t),J=s(t,"H2",{class:!0});var po=a(J);re=s(po,"A",{id:!0,class:!0,href:!0});var oa=a(re);kt=s(oa,"SPAN",{});var na=a(kt);v(Ce.$$.fragment,na),na.forEach(o),oa.forEach(o),Wn=c(po),Ct=s(po,"SPAN",{});var sa=a(Ct);Dn=i(sa,"SEWDForCTC"),sa.forEach(o),po.forEach(o),Yt=c(t),x=s(t,"DIV",{class:!0});var O=a(x);v(Te.$$.fragment,O),kn=c(O),Q=s(O,"P",{});var ct=a(Q);Cn=i(ct,"SEW-D Model with a "),Tt=s(ct,"CODE",{});var aa=a(Tt);Tn=i(aa,"language modeling"),aa.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),On=c(O),C=s(O,"DIV",{class:!0});var F=a(C);v(Pe.$$.fragment,F),In=c(F),B=s(F,"P",{});var pt=a(B);Nn=i(pt,"The "),st=s(pt,"A",{href:!0});var da=a(st);Kn=i(da,"SEWDForCTC"),da.forEach(o),Hn=i(pt," forward method, overrides the "),$t=s(pt,"CODE",{});var ca=a($t);Rn=i(ca,"__call__"),ca.forEach(o),Un=i(pt," special method."),pt.forEach(o),Jn=c(F),v(ie.$$.fragment,F),Qn=c(F),qt=s(F,"P",{});var pa=a(qt);Bn=i(pa,"Example:"),pa.forEach(o),Yn=c(F),v(Fe.$$.fragment,F),Gn=c(F),v(Me.$$.fragment,F),F.forEach(o),O.forEach(o),Gt=c(t),Y=s(t,"H2",{class:!0});var ho=a(Y);le=s(ho,"A",{id:!0,class:!0,href:!0});var ma=a(le);xt=s(ma,"SPAN",{});var fa=a(xt);v(ze.$$.fragment,fa),fa.forEach(o),ma.forEach(o),Xn=c(ho),jt=s(ho,"SPAN",{});var ha=a(jt);Zn=i(ha,"SEWDForSequenceClassification"),ha.forEach(o),ho.forEach(o),Xt=c(t),D=s(t,"DIV",{class:!0});var M=a(D);v(Ae.$$.fragment,M),es=c(M),Pt=s(M,"P",{});var ua=a(Pt);ts=i(ua,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o.forEach(o),hs=c(M),T=s(M,"DIV",{class:!0});var z=a(T);v(Ke.$$.fragment,z),us=c(z),G=s(z,"P",{});var mt=a(G);gs=i(mt,"The "),rt=s(mt,"A",{href:!0});var wa=a(rt);_s=i(wa,"SEWDForSequenceClassification"),wa.forEach(o),vs=i(mt," forward method, overrides the "),Ft=s(mt,"CODE",{});var ba=a(Ft);ws=i(ba,"__call__"),ba.forEach(o),bs=i(mt," special method."),mt.forEach(o),ys=c(z),v(de.$$.fragment,z),Es=c(z),Mt=s(z,"P",{});var ya=a(Mt);Ss=i(ya,"Example:"),ya.forEach(o),Ws=c(z),v(He.$$.fragment,z),Ds=c(z),v(Re.$$.fragment,z),z.forEach(o),M.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(xa)),l(S,"id","sewd"),l(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(S,"href","#sewd"),l(h,"class","relative group"),l(Z,"id","overview"),l(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Z,"href","#overview"),l(I,"class","relative group"),l(pe,"href","https://arxiv.org/abs/2109.06870"),l(pe,"rel","nofollow"),l(Ge,"href","/docs/transformers/pr_16148/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),l(fe,"href","https://huggingface.co/anton-l"),l(fe,"rel","nofollow"),l(ne,"id","transformers.SEWDConfig"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.SEWDConfig"),l(N,"class","relative group"),l(Xe,"href","/docs/transformers/pr_16148/en/model_doc/sew-d#transformers.SEWDModel"),l(ge,"href","https://huggingface.co/asapp/sew-d-tiny-100k"),l(ge,"rel","nofollow"),l(Ze,"href","/docs/transformers/pr_16148/en/main_classes/configuration#transformers.PretrainedConfig"),l(et,"href","/docs/transformers/pr_16148/en/main_classes/configuration#transformers.PretrainedConfig"),l($,"class","docstring"),l(se,"id","transformers.SEWDModel"),l(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(se,"href","#transformers.SEWDModel"),l(R,"class","relative group"),l(ye,"href","https://arxiv.org/abs/2109.06870"),l(ye,"rel","nofollow"),l(tt,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),l(We,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(We,"rel","nofollow"),l(ot,"href","/docs/transformers/pr_16148/en/model_doc/sew-d#transformers.SEWDModel"),l(P,"class","docstring"),l(q,"class","docstring"),l(re,"id","transformers.SEWDForCTC"),l(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(re,"href","#transformers.SEWDForCTC"),l(J,"class","relative group"),l($e,"href","https://arxiv.org/abs/2109.06870"),l($e,"rel","nofollow"),l(nt,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),l(je,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(je,"rel","nofollow"),l(st,"href","/docs/transformers/pr_16148/en/model_doc/sew-d#transformers.SEWDForCTC"),l(C,"class","docstring"),l(x,"class","docstring"),l(le,"id","transformers.SEWDForSequenceClassification"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.SEWDForSequenceClassification"),l(Y,"class","relative group"),l(Le,"href","https://arxiv.org/abs/2109.06870"),l(Le,"rel","nofollow"),l(at,"href","/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel"),l(Ne,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ne,"rel","nofollow"),l(rt,"href","/docs/transformers/pr_16148/en/model_doc/sew-d#transformers.SEWDForSequenceClassification"),l(T,"class","docstring"),l(D,"class","docstring")},m(t,p){e(document.head,m),f(t,k,p),f(t,h,p),e(h,S),e(S,W),w(u,W,null),e(h,g),e(h,j),e(j,vo),f(t,Vt,p),f(t,I,p),e(I,Z),e(Z,ut),w(ce,ut,null),e(I,wo),e(I,gt),e(gt,bo),f(t,Lt,p),f(t,ee,p),e(ee,yo),e(ee,pe),e(pe,Eo),e(ee,So),f(t,Ot,p),f(t,Qe,p),e(Qe,Wo),f(t,It,p),f(t,Be,p),e(Be,_t),e(_t,Do),f(t,Nt,p),f(t,Ye,p),e(Ye,ko),f(t,Kt,p),f(t,te,p),e(te,vt),e(vt,Co),e(te,To),e(te,me),e(me,$o),e(me,Ge),e(Ge,qo),e(me,xo),f(t,Ht,p),f(t,oe,p),e(oe,jo),e(oe,fe),e(fe,Po),e(oe,Fo),f(t,Rt,p),f(t,N,p),e(N,ne),e(ne,wt),w(he,wt,null),e(N,Mo),e(N,bt),e(bt,zo),f(t,Ut,p),f(t,$,p),w(ue,$,null),e($,Ao),e($,K),e(K,Vo),e(K,Xe),e(Xe,Lo),e(K,Oo),e(K,ge),e(ge,Io),e(K,No),e($,Ko),e($,H),e(H,Ho),e(H,Ze),e(Ze,Ro),e(H,Uo),e(H,et),e(et,Jo),e(H,Qo),e($,Bo),e($,yt),e(yt,Yo),e($,Go),w(_e,$,null),f(t,Jt,p),f(t,R,p),e(R,se),e(se,Et),w(ve,Et,null),e(R,Xo),e(R,St),e(St,Zo),f(t,Qt,p),f(t,q,p),w(we,q,null),e(q,en),e(q,be),e(be,tn),e(be,ye),e(ye,on),e(be,nn),e(q,sn),e(q,Ee),e(Ee,an),e(Ee,tt),e(tt,rn),e(Ee,ln),e(q,dn),e(q,Se),e(Se,cn),e(Se,We),e(We,pn),e(Se,mn),e(q,fn),e(q,P),w(De,P,null),e(P,hn),e(P,U),e(U,un),e(U,ot),e(ot,gn),e(U,_n),e(U,Wt),e(Wt,vn),e(U,wn),e(P,bn),w(ae,P,null),e(P,yn),e(P,Dt),e(Dt,En),e(P,Sn),w(ke,P,null),f(t,Bt,p),f(t,J,p),e(J,re),e(re,kt),w(Ce,kt,null),e(J,Wn),e(J,Ct),e(Ct,Dn),f(t,Yt,p),f(t,x,p),w(Te,x,null),e(x,kn),e(x,Q),e(Q,Cn),e(Q,Tt),e(Tt,Tn),e(Q,$n),e(Q,$e),e($e,qn),e(Q,xn),e(x,jn),e(x,qe),e(qe,Pn),e(qe,nt),e(nt,Fn),e(qe,Mn),e(x,zn),e(x,xe),e(xe,An),e(xe,je),e(je,Vn),e(xe,Ln),e(x,On),e(x,C),w(Pe,C,null),e(C,In),e(C,B),e(B,Nn),e(B,st),e(st,Kn),e(B,Hn),e(B,$t),e($t,Rn),e(B,Un),e(C,Jn),w(ie,C,null),e(C,Qn),e(C,qt),e(qt,Bn),e(C,Yn),w(Fe,C,null),e(C,Gn),w(Me,C,null),f(t,Gt,p),f(t,Y,p),e(Y,le),e(le,xt),w(ze,xt,null),e(Y,Xn),e(Y,jt),e(jt,Zn),f(t,Xt,p),f(t,D,p),w(Ae,D,null),e(D,es),e(D,Pt),e(Pt,ts),e(D,os),e(D,Ve),e(Ve,ns),e(Ve,Le),e(Le,ss),e(Ve,as),e(D,rs),e(D,Oe),e(Oe,is),e(Oe,at),e(at,ls),e(Oe,ds),e(D,cs),e(D,Ie),e(Ie,ps),e(Ie,Ne),e(Ne,ms),e(Ie,fs),e(D,hs),e(D,T),w(Ke,T,null),e(T,us),e(T,G),e(G,gs),e(G,rt),e(rt,_s),e(G,vs),e(G,Ft),e(Ft,ws),e(G,bs),e(T,ys),w(de,T,null),e(T,Es),e(T,Mt),e(Mt,Ss),e(T,Ws),w(He,T,null),e(T,Ds),w(Re,T,null),Zt=!0},p(t,[p]){const Ue={};p&2&&(Ue.$$scope={dirty:p,ctx:t}),ae.$set(Ue);const zt={};p&2&&(zt.$$scope={dirty:p,ctx:t}),ie.$set(zt);const At={};p&2&&(At.$$scope={dirty:p,ctx:t}),de.$set(At)},i(t){Zt||(b(u.$$.fragment,t),b(ce.$$.fragment,t),b(he.$$.fragment,t),b(ue.$$.fragment,t),b(_e.$$.fragment,t),b(ve.$$.fragment,t),b(we.$$.fragment,t),b(De.$$.fragment,t),b(ae.$$.fragment,t),b(ke.$$.fragment,t),b(Ce.$$.fragment,t),b(Te.$$.fragment,t),b(Pe.$$.fragment,t),b(ie.$$.fragment,t),b(Fe.$$.fragment,t),b(Me.$$.fragment,t),b(ze.$$.fragment,t),b(Ae.$$.fragment,t),b(Ke.$$.fragment,t),b(de.$$.fragment,t),b(He.$$.fragment,t),b(Re.$$.fragment,t),Zt=!0)},o(t){y(u.$$.fragment,t),y(ce.$$.fragment,t),y(he.$$.fragment,t),y(ue.$$.fragment,t),y(_e.$$.fragment,t),y(ve.$$.fragment,t),y(we.$$.fragment,t),y(De.$$.fragment,t),y(ae.$$.fragment,t),y(ke.$$.fragment,t),y(Ce.$$.fragment,t),y(Te.$$.fragment,t),y(Pe.$$.fragment,t),y(ie.$$.fragment,t),y(Fe.$$.fragment,t),y(Me.$$.fragment,t),y(ze.$$.fragment,t),y(Ae.$$.fragment,t),y(Ke.$$.fragment,t),y(de.$$.fragment,t),y(He.$$.fragment,t),y(Re.$$.fragment,t),Zt=!1},d(t){o(m),t&&o(k),t&&o(h),E(u),t&&o(Vt),t&&o(I),E(ce),t&&o(Lt),t&&o(ee),t&&o(Ot),t&&o(Qe),t&&o(It),t&&o(Be),t&&o(Nt),t&&o(Ye),t&&o(Kt),t&&o(te),t&&o(Ht),t&&o(oe),t&&o(Rt),t&&o(N),E(he),t&&o(Ut),t&&o($),E(ue),E(_e),t&&o(Jt),t&&o(R),E(ve),t&&o(Qt),t&&o(q),E(we),E(De),E(ae),E(ke),t&&o(Bt),t&&o(J),E(Ce),t&&o(Yt),t&&o(x),E(Te),E(Pe),E(ie),E(Fe),E(Me),t&&o(Gt),t&&o(Y),E(ze),t&&o(Xt),t&&o(D),E(Ae),E(Ke),E(de),E(He),E(Re)}}}const xa={local:"sewd",sections:[{local:"overview",title:"Overview"},{local:"transformers.SEWDConfig",title:"SEWDConfig"},{local:"transformers.SEWDModel",title:"SEWDModel"},{local:"transformers.SEWDForCTC",title:"SEWDForCTC"},{local:"transformers.SEWDForSequenceClassification",title:"SEWDForSequenceClassification"}],title:"SEW-D"};function ja(X){return ka(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Va extends Ea{constructor(m){super();Sa(this,m,ja,qa,Wa,{})}}export{Va as default,xa as metadata};
