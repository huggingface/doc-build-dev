...
Whether or not to return a <a href="/docs/transformers/pr_16148/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16148/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Us=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_t5.py#L1808",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16148/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Whether or not to return a <a href="/docs/transformers/pr_16148/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16148/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[ww]},$$scope:{ctx:A}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_tf_t5.py#L1357",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16148/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16148/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16148/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[zw]},$$scope:{ctx:A}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_tf_t5.py#L1688",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16148/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;Studies have been shown that owning a dog is good for you&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>).input_ids  <span class="hljs-comment"># Batch size 1</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(input_ids)`}}),Ca=new ve({}),Oa=new M({props:{name:"class transformers.FlaxT5Model",anchor:"transformers.FlaxT5Model",parameters:[{name:"config",val:": T5Config"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_flax_t5.py#L1326"}}),La=new M({props:{name:"__call__",anchor:"transformers.FlaxT5PreTrainedModel.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": ndarray = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_flax_t5.py#L958",parametersDescription:[{anchor:"transformers.FlaxT5PreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16148/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>A <a
  href="/docs/transformers/pr_16148/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ga=new ve({}),Ba=new M({props:{name:"class transformers.FlaxT5ForConditionalGeneration",anchor:"transformers.FlaxT5ForConditionalGeneration",parameters:[{name:"config",val:": T5Config"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_flax_t5.py#L1466"}}),Wa=new M({props:{name:"__call__",anchor:"transformers.FlaxT5PreTrainedModel.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": ndarray = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_flax_t5.py#L958",parametersDescription:[{anchor:"transformers.FlaxT5PreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16148/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, return_tensors=<span class="hljs-string">&quot;np&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),Va=new M({props:{name:"decode",anchor:"transformers.FlaxT5ForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16148/src/transformers/models/t5/modeling_flax_t5.py#L1469",parametersDescription:[{anchor:"transformers.FlaxT5ForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16148/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16148/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
with scale and our new \u201CColossal Clean Crawled Corpus\u201D, we achieve state-of-the-art results on many benchmarks covering
summarization, question answering, text classification, and more. To facilitate future work on transfer learning for
NLP, we release our dataset, pre-trained models, and code.`),Qk.forEach(t),Xk.forEach(t),ye=l(n),P=s(n,"P",{});var e1=a(P);Me=i(e1,"Tips:"),e1.forEach(t),H=l(n),V=s(n,"UL",{});var Ir=a(V);me=s(Ir,"LI",{});var t1=a(me);O=s(t1,"P",{});var Nr=a(O);Pe=i(Nr,`T5 is an encoder-decoder model pre-trained on a multi-task mixture of unsupervised and supervised tasks and for which
each task is converted into a text-to-text format. T5 works well on a variety of tasks out-of-the-box by prepending a
different prefix to the input corresponding to each task, e.g., for translation: `),fe=s(Nr,"EM",{});var n1=a(fe);N=i(n1,"translate English to German: \u2026"),n1.forEach(t),Ce=i(Nr,`,
for summarization: `),U=s(Nr,"EM",{});var o1=a(U);Oe=i(o1,"summarize: \u2026"),o1.forEach(t),m=i(Nr,"."),Nr.forEach(t),t1.forEach(t),j=l(Ir),te=s(Ir,"LI",{});var s1=a(te);Se=s(s1,"P",{});var a1=a(Se);pt=i(a1,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),a1.forEach(t),s1.forEach(t),D=l(Ir),Ge=s(Ir,"LI",{});var r1=a(Ge);ne=s(r1,"P",{});var io=a(ne);ht=i(io,"See the "),L=s(io,"A",{href:!0});var i1=a(L);Y=i(i1,"training"),i1.forEach(t),ut=i(io,", "),Le=s(io,"A",{href:!0});var d1=a(Le);Z=i(d1,"inference"),d1.forEach(t),mt=i(io," and "),Ae=s(io,"A",{href:!0});var l1=a(Ae);Ie=i(l1,"scripts"),l1.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),r1.forEach(t),Ir.forEach(t),Vl=l(n),Xa=s(n,"P",{});var c1=a(Xa);Dp=i(c1,"T5 comes in different sizes:"),c1.forEach(t),Kl=l(n),Be=s(n,"UL",{});var Lt=a(Be);di=s(Lt,"LI",{});var p1=a(di);li=s(p1,"P",{});var h1=a(li);To=s(h1,"A",{href:!0,rel:!0});var u1=a(To);Sp=i(u1,"t5-small"),u1.forEach(t),h1.forEach(t),p1.forEach(t),Gp=l(Lt),ci=s(Lt,"LI",{});var m1=a(ci);pi=s(m1,"P",{});var f1=a(pi);vo=s(f1,"A",{href:!0,rel:!0});var _1=a(vo);Bp=i(_1,"t5-base"),_1.forEach(t),f1.forEach(t),m1.forEach(t),Wp=l(Lt),hi=s(Lt,"LI",{});var g1=a(hi);ui=s(g1,"P",{});var T1=a(ui);ko=s(T1,"A",{href:!0,rel:!0});var v1=a(ko);Up=i(v1,"t5-large"),v1.forEach(t),T1.forEach(t),g1.forEach(t),Rp=l(Lt),mi=s(Lt,"LI",{});var k1=a(mi);fi=s(k1,"P",{});var b1=a(fi);bo=s(b1,"A",{href:!0,rel:!0});var y1=a(bo);Hp=i(y1,"t5-3b"),y1.forEach(t),b1.forEach(t),k1.forEach(t),Vp=l(Lt),_i=s(Lt,"LI",{});var w1=a(_i);Qa=s(w1,"P",{});var Vk=a(Qa);yo=s(Vk,"A",{href:!0,rel:!0});var x1=a(yo);Kp=i(x1,"t5-11b"),x1.forEach(t),Yp=i(Vk,"."),Vk.forEach(t),w1.forEach(t),Lt.forEach(t),Yl=l(n),er=s(n,"P",{});var z1=a(er);Zp=i(z1,"Based on the original T5 model, Google has released some follow-up works:"),z1.forEach(t),Zl=l(n),$t=s(n,"UL",{});var Dr=a($t);gi=s(Dr,"LI",{});var $1=a(gi);zn=s($1,"P",{});var Ul=a(zn);Ti=s(Ul,"STRONG",{});var q1=a(Ti);Jp=i(q1,"T5v1.1"),q1.forEach(t),Xp=i(Ul,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=s(Ul,"A",{href:!0});var E1=a(tr);Qp=i(E1,"here"),E1.forEach(t),eh=i(Ul,"."),Ul.forEach(t),$1.forEach(t),th=l(Dr),vi=s(Dr,"LI",{});var j1=a(vi);$n=s(j1,"P",{});var Rl=a($n);ki=s(Rl,"STRONG",{});var F1=a(ki);nh=i(F1,"mT5"),F1.forEach(t),oh=i(Rl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=s(Rl,"A",{href:!0});var M1=a(nr);sh=i(M1,"here"),M1.forEach(t),ah=i(Rl,"."),Rl.forEach(t),j1.forEach(t),rh=l(Dr),bi=s(Dr,"LI",{});var P1=a(bi);qn=s(P1,"P",{});var Hl=a(qn);yi=s(Hl,"STRONG",{});var C1=a(yi);ih=i(C1,"byT5"),C1.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var O1=a(or);lh=i(O1,"here"),O1.forEach(t),ch=i(Hl,"."),Hl.forEach(t),P1.forEach(t),Dr.forEach(t),Jl=l(n),En=s(n,"P",{});var Bc=a(En);ph=i(Bc,"All checkpoints can be found on the "),wo=s(Bc,"A",{href:!0,rel:!0});var L1=a(wo);hh=i(L1,"hub"),L1.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var A1=a(xo);fh=i(A1,"thomwolf"),A1.forEach(t),_h=i(Sr,". The original code can be found "),zo=s(Sr,"A",{href:!0,rel:!0});var I1=a(zo);gh=i(I1,"here"),I1.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Wc=a(Zt);jn=s(Wc,"A",{id:!0,class:!0,href:!0});var N1=a(jn);wi=s(N1,"SPAN",{});var D1=a(wi);_($o.$$.fragment,D1),D1.forEach(t),N1.forEach(t),vh=l(Wc),xi=s(Wc,"SPAN",{});var S1=a(xi);kh=i(S1,"Training"),S1.forEach(t),Wc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
start-sequence token and fed to the decoder using the `),$i=s(lo,"CODE",{});var B1=a($i);xh=i(B1,"decoder_input_ids"),B1.forEach(t),zh=i(lo,`. In teacher-forcing style, the target
sequence is then appended by the EOS token and corresponds to the `),qi=s(lo,"CODE",{});var W1=a(qi);$h=i(W1,"labels"),W1.forEach(t),qh=i(lo,`. The PAD token is hereby used as the
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),lo.forEach(t),nc=l(n),Fn=s(n,"P",{});var Uc=a(Fn);Eh=i(Uc,"One can use "),ar=s(Uc,"A",{href:!0});var U1=a(ar);jh=i(U1,"T5ForConditionalGeneration"),U1.forEach(t),Fh=i(Uc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Uc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var At=a(dt);Ei=s(At,"P",{});var R1=a(Ei);Mh=i(R1,"Unsupervised denoising training"),R1.forEach(t),Ph=l(At),_e=s(At,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var H1=a(ji);Oh=i(H1,"a.k.a"),H1.forEach(t),Lh=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=s(tt,"EM",{});var V1=a(Fi);Ah=i(V1,"real"),V1.forEach(t),Ih=i(tt,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Mi=s(tt,"CODE",{});var K1=a(Mi);Nh=i(K1,"<extra_id_0>"),K1.forEach(t),Dh=i(tt,`,
`),Pi=s(tt,"CODE",{});var Y1=a(Pi);Sh=i(Y1,"<extra_id_1>"),Y1.forEach(t),Gh=i(tt,", \u2026 up to "),Ci=s(tt,"CODE",{});var Z1=a(Ci);Bh=i(Z1,"<extra_id_99>"),Z1.forEach(t),Wh=i(tt,`. As a default, 100 sentinel tokens are available in
`),rr=s(tt,"A",{href:!0});var J1=a(rr);Uh=i(J1,"T5Tokenizer"),J1.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(At),Oi=s(At,"P",{});var X1=a(Oi);Vh=i(X1,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),X1.forEach(t),Kh=l(At),_(qo.$$.fragment,At),Yh=l(At),Eo=s(At,"P",{});var Hc=a(Eo);Zh=i(Hc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=s(Hc,"A",{href:!0,rel:!0});var Q1=a(jo);Jh=i(Q1,"run_t5_mlm_flax.py"),Q1.forEach(t),Xh=i(Hc,` script in the Examples
directory.`),Hc.forEach(t),At.forEach(t),Qh=l(Rc),ge=s(Rc,"LI",{});var nt=a(ge);Li=s(nt,"P",{});var eb=a(Li);eu=i(eb,"Supervised training"),eb.forEach(t),tu=l(nt),Ai=s(nt,"P",{});var tb=a(Ai);nu=i(tb,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
...
`),Ni=s(we,"CODE",{});var ob=a(Ni);du=i(ob,"input_ids"),ob.forEach(t),lu=i(we," of the encoded input sequence) and "),Di=s(we,"CODE",{});var sb=a(Di);cu=i(sb,"labels"),sb.forEach(t),pu=i(we," (which are the "),Si=s(we,"CODE",{});var ab=a(Si);hu=i(ab,"input_ids"),ab.forEach(t),uu=i(we,` of the encoded
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Ui=s(Gr,"CODE",{});var lb=a(Ui);yu=i(lb,"max_source_length"),lb.forEach(t),wu=i(Gr," and "),Ri=s(Gr,"CODE",{});var cb=a(Ri);xu=i(cb,"max_target_length"),cb.forEach(t),zu=i(Gr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
...
of the `),Ki=s(ot,"CODE",{});var ub=a(Ki);Pu=i(ub,"CrossEntropyLoss"),ub.forEach(t),Cu=i(ot,". In Flax, one can use the "),Yi=s(ot,"CODE",{});var mb=a(Yi);Ou=i(mb,"decoder_attention_mask"),mb.forEach(t),Lu=i(ot,` to ignore padded tokens from
the loss (see the `),Mo=s(ot,"A",{href:!0,rel:!0});var fb=a(Mo);Au=i(fb,"Flax summarization script"),fb.forEach(t),Iu=i(ot,` for details). We also pass
`),Zi=s(ot,"CODE",{});var _b=a(Zi);Nu=i(_b,"attention_mask"),_b.forEach(t),Du=i(ot,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),ot.forEach(t),Su=l(nt),_(Po.$$.fragment,nt),nt.forEach(t),Rc.forEach(t),sc=l(n),ir=s(n,"P",{});var gb=a(ir);Gu=i(gb,"Additional training tips:"),gb.forEach(t),ac=l(n),Et=s(n,"UL",{});var Br=a(Et);Ji=s(Br,"LI",{});var Tb=a(Ji);Co=s(Tb,"P",{});var Vc=a(Co);Bu=i(Vc,"T5 models need a slightly higher learning rate than the default one set in the "),Xi=s(Vc,"CODE",{});var vb=a(Xi);Wu=i(vb,"Trainer"),vb.forEach(t),Uu=i(Vc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Vc.forEach(t),Tb.forEach(t),Ru=l(Br),Qi=s(Br,"LI",{});var kb=a(Qi);Xt=s(kb,"P",{});var Wr=a(Xt);Hu=i(Wr,"According to "),Oo=s(Wr,"A",{href:!0,rel:!0});var bb=a(Oo);Vu=i(bb,"this forum post"),bb.forEach(t),Ku=i(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Lo=s(Wr,"A",{href:!0,rel:!0});var yb=a(Lo);Yu=i(yb,"paper"),yb.forEach(t),Zu=i(Wr,` for the task prefixes
used).`),Wr.forEach(t),kb.forEach(t),Ju=l(Br),ed=s(Br,"LI",{});var wb=a(ed);Ao=s(wb,"P",{});var Kc=a(Ao);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
`),cr=s(It,"A",{href:!0});var Cb=a(cr);fm=i(Cb,"generate()"),Cb.forEach(t),_m=i(It,", make sure you start it with the "),rd=s(It,"CODE",{});var Ob=a(rd);gm=i(Ob,"pad_token_id"),Ob.forEach(t),Tm=i(It,"."),It.forEach(t),pc=l(n),pr=s(n,"P",{});var Lb=a(pr);vm=i(Lb,"The example above only shows a single example. You can also do batched inference, like so:"),Lb.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Zc=a(en);Cn=s(Zc,"A",{id:!0,class:!0,href:!0});var Ab=a(Cn);id=s(Ab,"SPAN",{});var Ib=a(id);_(Bo.$$.fragment,Ib),Ib.forEach(t),Ab.forEach(t),km=l(Zc),dd=s(Zc,"SPAN",{});var Nb=a(dd);bm=i(Nb,"Performance"),Nb.forEach(t),Zc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);ym=i(po,"If you\u2019d like a faster training and inference performance, install "),Wo=s(po,"A",{href:!0,rel:!0});var Db=a(Wo);wm=i(Db,"apex"),Db.forEach(t),xm=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var Sb=a(ld);zm=i(Sb,"apex.normalization.FusedRMSNorm"),Sb.forEach(t),$m=i(po," instead of "),cd=s(po,"CODE",{});var Gb=a(cd);qm=i(Gb,"T5LayerNorm"),Gb.forEach(t),Em=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Jc=a(tn);On=s(Jc,"A",{id:!0,class:!0,href:!0});var Bb=a(On);pd=s(Bb,"SPAN",{});var Wb=a(pd);_(Uo.$$.fragment,Wb),Wb.forEach(t),Bb.forEach(t),jm=l(Jc),hd=s(Jc,"SPAN",{});var Ub=a(hd);Fm=i(Ub,"Example scripts"),Ub.forEach(t),Jc.forEach(t),gc=l(n),ur=s(n,"P",{});var Rb=a(ur);Mm=i(Rb,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rb.forEach(t),Tc=l(n),Ln=s(n,"UL",{});var Xc=a(Ln);ud=s(Xc,"LI",{});var Hb=a(ud);nn=s(Hb,"P",{});var Ur=a(nn);Pm=i(Ur,"pre-training: the "),Ro=s(Ur,"A",{href:!0,rel:!0});var Vb=a(Ro);Cm=i(Vb,"run_t5_mlm_flax.py"),Vb.forEach(t),Om=i(Ur,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Ur,"A",{href:!0,rel:!0});var Kb=a(Ho);Lm=i(Kb,"t5_tokenizer_model.py"),Kb.forEach(t),Am=i(Ur,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Ur.forEach(t),Hb.forEach(t),Im=l(Xc),md=s(Xc,"LI",{});var Yb=a(md);Ne=s(Yb,"P",{});var yt=a(Ne);Nm=i(yt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(yt,"A",{href:!0,rel:!0});var Zb=a(Vo);Dm=i(Zb,"PyTorch"),Zb.forEach(t),Sm=i(yt,", "),Ko=s(yt,"A",{href:!0,rel:!0});var Jb=a(Ko);Gm=i(Jb,"Tensorflow"),Jb.forEach(t),Bm=i(yt,", and "),Yo=s(yt,"A",{href:!0,rel:!0});var Xb=a(Yo);Wm=i(Xb,"Flax"),Xb.forEach(t),Um=i(yt,`) and translation scripts
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l(xe),ws=s(xe,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var L5=a(zr);k_=i(L5,"PreTrainedModel"),L5.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),y_=l(xe),xs=s(xe,"P",{});var mp=a(xs);w_=i(mp,"This model is also a PyTorch "),zs=s(mp,"A",{href:!0,rel:!0});var A5=a(zs);x_=i(A5,"torch.nn.Module"),A5.forEach(t),z_=i(mp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),$_=l(xe),Ue=s(xe,"DIV",{class:!0});var Dt=a(Ue);_($s.$$.fragment,Dt),q_=l(Dt),cn=s(Dt,"P",{});var Zr=a(cn);E_=i(Zr,"The "),$r=s(Zr,"A",{href:!0});var I5=a($r);j_=i(I5,"T5Model"),I5.forEach(t),F_=i(Zr," forward method, overrides the "),Od=s(Zr,"CODE",{});var N5=a(Od);M_=i(N5,"__call__"),N5.forEach(t),P_=i(Zr," special method."),Zr.forEach(t),C_=l(Dt),_(Wn.$$.fragment,Dt),O_=l(Dt),Ld=s(Dt,"P",{});var D5=a(Ld);L_=i(D5,"Example:"),D5.forEach(t),A_=l(Dt),_(qs.$$.fragment,Dt),Dt.forEach(t),I_=l(xe),Re=s(xe,"DIV",{class:!0});var St=a(Re);_(Es.$$.fragment,St),N_=l(St),Ad=s(St,"P",{});var S5=a(Ad);D_=i(S5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),S5.forEach(t),S_=l(St),Id=s(St,"P",{});var G5=a(Id);G_=i(G5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),G5.forEach(t),B_=l(St),Nd=s(St,"P",{});var B5=a(Nd);W_=i(B5,"Example:"),B5.forEach(t),U_=l(St),_(js.$$.fragment,St),St.forEach(t),R_=l(xe),vt=s(xe,"DIV",{class:!0});var uo=a(vt);_(Fs.$$.fragment,uo),H_=l(uo),Dd=s(uo,"P",{});var W5=a(Dd);V_=i(W5,"Moves the model to cpu from a model parallel state."),W5.forEach(t),K_=l(uo),Sd=s(uo,"P",{});var U5=a(Sd);Y_=i(U5,"Example:"),U5.forEach(t),Z_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),xe.forEach(t),qc=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Un=s(fp,"A",{id:!0,class:!0,href:!0});var R5=a(Un);Gd=s(R5,"SPAN",{});var H5=a(Gd);_(Ps.$$.fragment,H5),H5.forEach(t),R5.forEach(t),J_=l(fp),Bd=s(fp,"SPAN",{});var V5=a(Bd);X_=i(V5,"T5ForConditionalGeneration"),V5.forEach(t),fp.forEach(t),Ec=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),Os=s(ze,"P",{});var _p=a(Os);eg=i(_p,"T5 Model with a "),Wd=s(_p,"CODE",{});var K5=a(Wd);tg=i(K5,"language modeling"),K5.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),Ls=s(ze,"P",{});var gp=a(Ls);sg=i(gp,"The T5 model was proposed in "),As=s(gp,"A",{href:!0,rel:!0});var Y5=a(As);ag=i(Y5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),zp.forEach(t),LT=l(at),la=s(at,"P",{});var $p=a(la);AT=i($p,"This model inherits from "),Mr=s($p,"A",{href:!0});var $y=a(Mr);IT=i($y,"TFPreTrainedModel"),$y.forEach(t),NT=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
