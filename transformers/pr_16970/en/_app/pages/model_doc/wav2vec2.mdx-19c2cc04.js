...
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){_(l,c,u),e(c,b),e(c,f),e(f,h),e(c,v)},d(l){l&&t(c)}}}function My(W){let c,b,f,h,v;return h=new ue({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForSequenceClassification
from datasets import load_dataset
import torch
...
first positional argument :`),qe.forEach(t),Se=p(V),M=s(V,"UL",{});var X=n(M);I=s(X,"LI",{});var G=n(I);Fe=i(G,"a single Tensor with "),ve=s(G,"CODE",{});var At=n(ve);He=i(At,"input_values"),At.forEach(t),Ce=i(G," only and nothing else: "),oe=s(G,"CODE",{});var mt=n(oe);lt=i(mt,"model(inputs_ids)"),mt.forEach(t),G.forEach(t),Re=p(X),L=s(X,"LI",{});var Te=n(L);ct=i(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(Te,"CODE",{});var xt=n(de);pe=i(xt,"model([input_values, attention_mask])"),xt.forEach(t),Ne=i(Te," or "),be=s(Te,"CODE",{});var J=n(be);dt=i(J,"model([input_values, attention_mask, token_type_ids])"),J.forEach(t),Te.forEach(t),we=p(X),ae=s(X,"LI",{});var $e=n(ae);Ee=i($e,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=s($e,"CODE",{});var Ot=n(ye);pt=i(Ot,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ot.forEach(t),$e.forEach(t),X.forEach(t)},m(V,E){_(V,c,E),e(c,b),_(V,f,E),_(V,h,E),e(h,v),e(v,l),e(h,u),e(h,j),e(j,D),_(V,P,E),_(V,C,E),e(C,A),e(C,O),e(O,R),e(C,S),e(C,q),e(q,je),e(C,ge),_(V,B,E),_(V,U,E),e(U,_e),_(V,Se,E),_(V,M,E),e(M,I),e(I,Fe),e(I,ve),e(ve,He),e(I,Ce),e(I,oe),e(oe,lt),e(M,Re),e(M,L),e(L,ct),e(L,de),e(de,pe),e(L,Ne),e(L,be),e(be,dt),e(M,we),e(M,ae),e(ae,Ee),e(ae,ye),e(ye,pt)},d(V){V&&t(c),V&&t(f),V&&t(h),V&&t(P),V&&t(C),V&&t(B),V&&t(U),V&&t(Se),V&&t(M)}}}function Ry(W){let c,b,f,h,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
instance of <a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/tokenization_utils_base.py#L2374",returnDescription:`
<p>A <a
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L488",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L418",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16970/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),is=new ee({}),ls=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16970/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),ds=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/processing_wav2vec2.py#L66"}}),hs=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/processing_wav2vec2.py#L75"}}),fs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/processing_wav2vec2.py#L47"}}),us=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_16970/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_16970/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_16970/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L229",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L346",returnDescription:`
<p><code>Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16970/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1688",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16970/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777"}}),gn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",returnDescription:`
<p>A <a
...
`}}),ta=new me({props:{$$slots:{default:[Py]},$$scope:{ctx:W}}}),oa=new he({props:{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.example",$$slots:{default:[My]},$$scope:{ctx:W}}}),aa=new he({props:{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.example-2",$$slots:{default:[zy]},$$scope:{ctx:W}}}),_n=new ee({}),vn=new F({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16970/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1900"}}),$n=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2117",returnDescription:`
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16970/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1428"}}),fa=new me({props:{$$slots:{default:[Iy]},$$scope:{ctx:W}}}),Hn=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",returnDescription:`
<p>A <a
...
`}}),ua=new me({props:{$$slots:{default:[By]},$$scope:{ctx:W}}}),ga=new he({props:{anchor:"transformers.TFWav2Vec2Model.call.example",$$slots:{default:[Uy]},$$scope:{ctx:W}}}),Rn=new ee({}),Xn=new F({props:{name:"class transformers.TFWav2Vec2ForCTC",anchor:"transformers.TFWav2Vec2ForCTC",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16970/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1531"}}),va=new me({props:{$$slots:{default:[Hy]},$$scope:{ctx:W}}}),Qn=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16970/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16970/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",returnDescription:`
<p>A <a
...
`}}),ba=new me({props:{$$slots:{default:[Ry]},$$scope:{ctx:W}}}),wa=new he({props:{anchor:"transformers.TFWav2Vec2ForCTC.call.example",$$slots:{default:[Xy]},$$scope:{ctx:W}}}),Yn=new ee({}),er=new F({props:{name:"class transformers.FlaxWav2Vec2Model",anchor:"transformers.FlaxWav2Vec2Model",parameters:[{name:"config",val:": Wav2Vec2Config"},{name:"input_shape",val:": typing.Tuple = (1, 1024)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<a href="/docs/transformers/pr_16970/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1055"}}),dr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_16970/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L887",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16970/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16970/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1319"}}),qr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_16970/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16970/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16970/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
`}}),ja=new me({props:{$$slots:{default:[Qy]},$$scope:{ctx:W}}}),Fa=new he({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[Yy]},$$scope:{ctx:W}}}),{c(){c=a("meta"),b=d(),f=a("h1"),h=a("a"),v=a("span"),w(l.$$.fragment),u=d(),j=a("span"),D=r("Wav2Vec2"),P=d(),C=a("h2"),A=a("a"),O=a("span"),w(R.$$.fragment),S=d(),q=a("span"),je=r("Overview"),ge=d(),B=a("p"),U=r("The Wav2Vec2 model was proposed in "),_e=a("a"),Se=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),M=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),I=d(),Fe=a("p"),ve=r("The abstract from the paper is the following:"),He=d(),Ce=a("p"),oe=a("em"),lt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Tp.forEach(t),Cu=p(Ct),Ge=s(Ct,"DIV",{class:!0});var Aa=n(Ge);y(en.$$.fragment,Aa),Eu=p(Aa),Jt=s(Aa,"P",{});var Li=n(Jt);qu=i(Li,"The "),hi=s(Li,"A",{href:!0});var c0=n(hi);Pu=i(c0,"Wav2Vec2Model"),c0.forEach(t),Mu=i(Li," forward method, overrides the "),zl=s(Li,"CODE",{});var d0=n(zl);zu=i(d0,"__call__"),d0.forEach(t),Au=i(Li," special method."),Li.forEach(t),Ou=p(Aa),y(Go.$$.fragment,Aa),Lu=p(Aa),y(Jo.$$.fragment,Aa),Aa.forEach(t),Ct.forEach(t),yd=p(o),Zt=s(o,"H2",{class:!0});var $p=n(Zt);Zo=s($p,"A",{id:!0,class:!0,href:!0});var p0=n(Zo);Al=s(p0,"SPAN",{});var m0=n(Al);y(tn.$$.fragment,m0),m0.forEach(t),p0.forEach(t),Du=p($p),Ol=s($p,"SPAN",{});var h0=n(Ol);Su=i(h0,"Wav2Vec2ForCTC"),h0.forEach(t),$p.forEach(t),kd=p(o),We=s(o,"DIV",{class:!0});var Et=n(We);y(on.$$.fragment,Et),Nu=p(Et),Kt=s(Et,"P",{});var Di=n(Kt);Iu=i(Di,"Wav2Vec2 Model with a "),Ll=s(Di,"CODE",{});var f0=n(Ll);Bu=i(f0,"language modeling"),f0.forEach(t),Uu=i(Di,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),an=s(Di,"A",{href:!0,rel:!0});var u0=n(an);Hu=i(u0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),u0.forEach(t),Ru=i(Di,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cp.forEach(t),Vg=p(at),ze=s(at,"DIV",{class:!0});var Pt=n(ze);y(gn.$$.fragment,Pt),jg=p(Pt),eo=s(Pt,"P",{});var Ni=n(eo);Fg=i(Ni,"The "),_i=s(Ni,"A",{href:!0});var V0=n(_i);Cg=i(V0,"Wav2Vec2ForSequenceClassification"),V0.forEach(t),Eg=i(Ni," forward method, overrides the "),Bl=s(Ni,"CODE",{});var j0=n(Bl);qg=i(j0,"__call__"),j0.forEach(t),Pg=i(Ni," special method."),Ni.forEach(t),Mg=p(Pt),y(ta.$$.fragment,Pt),zg=p(Pt),y(oa.$$.fragment,Pt),Ag=p(Pt),y(aa.$$.fragment,Pt),Pt.forEach(t),at.forEach(t),xd=p(o),to=s(o,"H2",{class:!0});var Ep=n(to);sa=s(Ep,"A",{id:!0,class:!0,href:!0});var F0=n(sa);Ul=s(F0,"SPAN",{});var C0=n(Ul);y(_n.$$.fragment,C0),C0.forEach(t),F0.forEach(t),Og=p(Ep),Hl=s(Ep,"SPAN",{});var E0=n(Hl);Lg=i(E0,"Wav2Vec2ForAudioFrameClassification"),E0.forEach(t),Ep.forEach(t),Wd=p(o),re=s(o,"DIV",{class:!0});var st=n(re);y(vn.$$.fragment,st),Dg=p(st),Rl=s(st,"P",{});var q0=n(Rl);Sg=i(q0,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),q0.forEach(t),Ng=p(st),bn=s(st,"P",{});var qp=n(bn);Ig=i(qp,"Wav2Vec2 was proposed in "),wn=s(qp,"A",{href:!0,rel:!0});var P0=n(wn);Bg=i(P0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),P0.forEach(t),Ug=i(qp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),qp.forEach(t),Hg=p(st),yn=s(st,"P",{});var Pp=n(yn);Rg=i(Pp,"This model inherits from "),vi=s(Pp,"A",{href:!0});var M0=n(vi);Xg=i(M0,"PreTrainedModel"),M0.forEach(t),Gg=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Pp.forEach(t),Jg=p(st),kn=s(st,"P",{});var Mp=n(kn);Zg=i(Mp,"This model is a PyTorch "),Tn=s(Mp,"A",{href:!0,rel:!0});var z0=n(Tn);Kg=i(z0,"torch.nn.Module"),z0.forEach(t),Qg=i(Mp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Mp.forEach(t),Yg=p(st),Je=s(st,"DIV",{class:!0});var Oa=n(Je);y($n.$$.fragment,Oa),e_=p(Oa),oo=s(Oa,"P",{});var Ii=n(oo);t_=i(Ii,"The "),bi=s(Ii,"A",{href:!0});var A0=n(bi);o_=i(A0,"Wav2Vec2ForAudioFrameClassification"),A0.forEach(t),a_=i(Ii," forward method, overrides the "),Xl=s(Ii,"CODE",{});var O0=n(Xl);s_=i(O0,"__call__"),O0.forEach(t),n_=i(Ii," special method."),Ii.forEach(t),r_=p(Oa),y(na.$$.fragment,Oa),i_=p(Oa),y(ra.$$.fragment,Oa),Oa.forEach(t),st.forEach(t),Vd=p(o),ao=s(o,"H2",{class:!0});var zp=n(ao);ia=s(zp,"A",{id:!0,class:!0,href:!0});var L0=n(ia);Gl=s(L0,"SPAN",{});var D0=n(Gl);y(xn.$$.fragment,D0),D0.forEach(t),L0.forEach(t),l_=p(zp),Jl=s(zp,"SPAN",{});var S0=n(Jl);c_=i(S0,"Wav2Vec2ForXVector"),S0.forEach(t),zp.forEach(t),jd=p(o),ie=s(o,"DIV",{class:!0});var nt=n(ie);y(Wn.$$.fragment,nt),d_=p(nt),Zl=s(nt,"P",{});var N0=n(Zl);p_=i(N0,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),N0.forEach(t),m_=p(nt),Vn=s(nt,"P",{});var Ap=n(Vn);h_=i(Ap,"Wav2Vec2 was proposed in "),jn=s(Ap,"A",{href:!0,rel:!0});var I0=n(jn);f_=i(I0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lp.forEach(t),$_=p(nt),Ze=s(nt,"DIV",{class:!0});var La=n(Ze);y(qn.$$.fragment,La),x_=p(La),so=s(La,"P",{});var Bi=n(so);W_=i(Bi,"The "),yi=s(Bi,"A",{href:!0});var H0=n(yi);V_=i(H0,"Wav2Vec2ForXVector"),H0.forEach(t),j_=i(Bi," forward method, overrides the "),Kl=s(Bi,"CODE",{});var R0=n(Kl);F_=i(R0,"__call__"),R0.forEach(t),C_=i(Bi," special method."),Bi.forEach(t),E_=p(La),y(la.$$.fragment,La),q_=p(La),y(ca.$$.fragment,La),La.forEach(t),nt.forEach(t),Fd=p(o),no=s(o,"H2",{class:!0});var Dp=n(no);da=s(Dp,"A",{id:!0,class:!0,href:!0});var X0=n(da);Ql=s(X0,"SPAN",{});var G0=n(Ql);y(Pn.$$.fragment,G0),G0.forEach(t),X0.forEach(t),P_=p(Dp),Yl=s(Dp,"SPAN",{});var J0=n(Yl);M_=i(J0,"Wav2Vec2ForPreTraining"),J0.forEach(t),Dp.forEach(t),Cd=p(o),Ve=s(o,"DIV",{class:!0});var Mt=n(Ve);y(Mn.$$.fragment,Mt),z_=p(Mt),ro=s(Mt,"P",{});var Ui=n(ro);A_=i(Ui,"Wav2Vec2 Model with a quantizer and "),ec=s(Ui,"CODE",{});var Z0=n(ec);O_=i(Z0,"VQ"),Z0.forEach(t),L_=i(Ui,` head on top.
Wav2Vec2 was proposed in `),zn=s(Ui,"A",{href:!0,rel:!0});var K0=n(zn);D_=i(K0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),K0.forEach(t),S_=i(Ui,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ui.forEach(t),N_=p(Mt),An=s(Mt,"P",{});var Sp=n(An);I_=i(Sp,"This model inherits from "),ki=s(Sp,"A",{href:!0});var Q0=n(ki);B_=i(Q0,"PreTrainedModel"),Q0.forEach(t),U_=i(Sp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Sp.forEach(t),H_=p(Mt),On=s(Mt,"P",{});var Np=n(On);R_=i(Np,"This model is a PyTorch "),Ln=s(Np,"A",{href:!0,rel:!0});var Y0=n(Ln);X_=i(Y0,"torch.nn.Module"),Y0.forEach(t),G_=i(Np,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Np.forEach(t),J_=p(Mt),Ke=s(Mt,"DIV",{class:!0});var Da=n(Ke);y(Dn.$$.fragment,Da),Z_=p(Da),io=s(Da,"P",{});var Hi=n(io);K_=i(Hi,"The "),Ti=s(Hi,"A",{href:!0});var e1=n(Ti);Q_=i(e1,"Wav2Vec2ForPreTraining"),e1.forEach(t),Y_=i(Hi," forward method, overrides the "),tc=s(Hi,"CODE",{});var t1=n(tc);ev=i(t1,"__call__"),t1.forEach(t),tv=i(Hi," special method."),Hi.forEach(t),ov=p(Da),y(pa.$$.fragment,Da),av=p(Da),y(ma.$$.fragment,Da),Da.forEach(t),Mt.forEach(t),Ed=p(o),lo=s(o,"H2",{class:!0});var Ip=n(lo);ha=s(Ip,"A",{id:!0,class:!0,href:!0});var o1=n(ha);oc=s(o1,"SPAN",{});var a1=n(oc);y(Sn.$$.fragment,a1),a1.forEach(t),o1.forEach(t),sv=p(Ip),ac=s(Ip,"SPAN",{});var s1=n(ac);nv=i(s1,"TFWav2Vec2Model"),s1.forEach(t),Ip.forEach(t),qd=p(o),le=s(o,"DIV",{class:!0});var rt=n(le);y(Nn.$$.fragment,rt),rv=p(rt),sc=s(rt,"P",{});var n1=n(sc);iv=i(n1,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),n1.forEach(t),lv=p(rt),In=s(rt,"P",{});var Bp=n(In);cv=i(Bp,"This model inherits from "),$i=s(Bp,"A",{href:!0});var r1=n($i);dv=i(r1,"TFPreTrainedModel"),r1.forEach(t),pv=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Up.forEach(t),gv=p(rt),y(fa.$$.fragment,rt),_v=p(rt),Qe=s(rt,"DIV",{class:!0});var Sa=n(Qe);y(Hn.$$.fragment,Sa),vv=p(Sa),co=s(Sa,"P",{});var Ri=n(co);bv=i(Ri,"The "),xi=s(Ri,"A",{href:!0});var l1=n(xi);wv=i(l1,"TFWav2Vec2Model"),l1.forEach(t),yv=i(Ri," forward method, overrides the "),nc=s(Ri,"CODE",{});var c1=n(nc);kv=i(c1,"__call__"),c1.forEach(t),Tv=i(Ri," special method."),Ri.forEach(t),$v=p(Sa),y(ua.$$.fragment,Sa),xv=p(Sa),y(ga.$$.fragment,Sa),Sa.forEach(t),rt.forEach(t),Pd=p(o),po=s(o,"H2",{class:!0});var Hp=n(po);_a=s(Hp,"A",{id:!0,class:!0,href:!0});var d1=n(_a);rc=s(d1,"SPAN",{});var p1=n(rc);y(Rn.$$.fragment,p1),p1.forEach(t),d1.forEach(t),Wv=p(Hp),ic=s(Hp,"SPAN",{});var m1=n(ic);Vv=i(m1,"TFWav2Vec2ForCTC"),m1.forEach(t),Hp.forEach(t),Md=p(o),ce=s(o,"DIV",{class:!0});var it=n(ce);y(Xn.$$.fragment,it),jv=p(it),Gn=s(it,"P",{});var Rp=n(Gn);Fv=i(Rp,"TFWav2Vec2 Model with a "),lc=s(Rp,"CODE",{});var h1=n(lc);Cv=i(h1,"language modeling"),h1.forEach(t),Ev=i(Rp," head on top for Connectionist Temporal Classification (CTC)."),Rp.forEach(t),qv=p(it),Jn=s(it,"P",{});var Xp=n(Jn);Pv=i(Xp,"This model inherits from "),Wi=s(Xp,"A",{href:!0});var f1=n(Wi);Mv=i(f1,"TFPreTrainedModel"),f1.forEach(t),zv=i(Xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gp.forEach(t),Sv=p(it),y(va.$$.fragment,it),Nv=p(it),Ye=s(it,"DIV",{class:!0});var Na=n(Ye);y(Qn.$$.fragment,Na),Iv=p(Na),mo=s(Na,"P",{});var Xi=n(mo);Bv=i(Xi,"The "),Vi=s(Xi,"A",{href:!0});var g1=n(Vi);Uv=i(g1,"TFWav2Vec2ForCTC"),g1.forEach(t),Hv=i(Xi," forward method, overrides the "),cc=s(Xi,"CODE",{});var _1=n(cc);Rv=i(_1,"__call__"),_1.forEach(t),Xv=i(Xi," special method."),Xi.forEach(t),Gv=p(Na),y(ba.$$.fragment,Na),Jv=p(Na),y(wa.$$.fragment,Na),Na.forEach(t),it.forEach(t),zd=p(o),ho=s(o,"H2",{class:!0});var Jp=n(ho);ya=s(Jp,"A",{id:!0,class:!0,href:!0});var v1=n(ya);dc=s(v1,"SPAN",{});var b1=n(dc);y(Yn.$$.fragment,b1),b1.forEach(t),v1.forEach(t),Zv=p(Jp),pc=s(Jp,"SPAN",{});var w1=n(pc);Kv=i(w1,"FlaxWav2Vec2Model"),w1.forEach(t),Jp.forEach(t),Ad=p(o),K=s(o,"DIV",{class:!0});var Oe=n(K);y(er.$$.fragment,Oe),Qv=p(Oe),tr=s(Oe,"P",{});var Zp=n(tr);Yv=i(Zp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),tm.forEach(t),H2=p(Le),kc=s(Le,"P",{});var I1=n(kc);R2=i(I1,"Finally, this model supports inherent JAX features such as:"),I1.forEach(t),X2=p(Le),wt=s(Le,"UL",{});var Ua=n(wt);Tc=s(Ua,"LI",{});var B1=n(Tc);_r=s(B1,"A",{href:!0,rel:!0});var U1=n(_r);G2=i(U1,"Just-In-Time (JIT) compilation"),U1.forEach(t),B1.forEach(t),J2=p(Ua),$c=s(Ua,"LI",{});var H1=n($c);vr=s(H1,"A",{href:!0,rel:!0});var R1=n(vr);Z2=i(R1,"Automatic Differentiation"),R1.forEach(t),H1.forEach(t),K2=p(Ua),xc=s(Ua,"LI",{});var X1=n(xc);br=s(X1,"A",{href:!0,rel:!0});var G1=n(br);Q2=i(G1,"Vectorization"),G1.forEach(t),X1.forEach(t),Y2=p(Ua),Wc=s(Ua,"LI",{});var J1=n(Wc);wr=s(J1,"A",{href:!0,rel:!0});var Z1=n(wr);eb=i(Z1,"Parallelization"),Z1.forEach(t),J1.forEach(t),Ua.forEach(t),tb=p(Le),tt=s(Le,"DIV",{class:!0});var Ha=n(tt);y(yr.$$.fragment,Ha),ob=p(Ha),_o=s(Ha,"P",{});var Zi=n(_o);ab=i(Zi,"The "),Vc=s(Zi,"CODE",{});var K1=n(Vc);sb=i(K1,"FlaxWav2Vec2PreTrainedModel"),K1.forEach(t),nb=i(Zi," forward method, overrides the "),jc=s(Zi,"CODE",{});var Q1=n(jc);rb=i(Q1,"__call__"),Q1.forEach(t),ib=i(Zi," special method."),Zi.forEach(t),lb=p(Ha),y(xa.$$.fragment,Ha),cb=p(Ha),y(Wa.$$.fragment,Ha),Ha.forEach(t),Le.forEach(t),Dd=p(o),vo=s(o,"H2",{class:!0});var om=n(vo);Va=s(om,"A",{id:!0,class:!0,href:!0});var Y1=n(Va);Fc=s(Y1,"SPAN",{});var ey=n(Fc);y(kr.$$.fragment,ey),ey.forEach(t),Y1.forEach(t),db=p(om),Cc=s(om,"SPAN",{});var ty=n(Cc);pb=i(ty,"FlaxWav2Vec2ForPreTraining"),ty.forEach(t),om.forEach(t),Sd=p(o),Y=s(o,"DIV",{class:!0});var De=n(Y);y(Tr.$$.fragment,De),mb=p(De),bo=s(De,"P",{});var Ki=n(bo);hb=i(Ki,"Wav2Vec2 Model with a quantizer and "),Ec=s(Ki,"CODE",{});var oy=n(Ec);fb=i(oy,"VQ"),oy.forEach(t),ub=i(Ki,` head on top.
