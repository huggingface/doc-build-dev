import{S as xb,i as zb,s as qb,e as a,k as l,w as y,t as o,M as Cb,c as r,d as t,m as d,a as i,x as F,h as n,b as h,F as e,g as u,y as M,q as $,o as L,B as E}from"../../chunks/vendor-4833417e.js";import{T as Ee}from"../../chunks/Tip-fffd6df1.js";import{D as ie}from"../../chunks/Docstring-4f315ed9.js";import{C as nt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Oe}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Pb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
...
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,J),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,K,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,G),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(K),c&&t(z)}}}function Wb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Ob(O){let p,k,m,g,v,b,f,w,le,Y,x,J,H,Z,de,Q,ce,se,U,X,ee,K,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,G,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),G=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),K=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);G=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,J),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,K,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,G),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(K),c&&t(z)}}}function Hb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Qb(O){let p,k,m,g,v,b,f,w,le,Y,x,J,H,Z,de,Q,ce,se,U,X,ee,K,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,G,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),G=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),K=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);G=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,J),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,K,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,G),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(K),c&&t(z)}}}function Bb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Rb(O){let p,k,m,g,v,b,f,w,le,Y,x,J,H,Z,de,Q,ce,se,U,X,ee,K,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,G,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),G=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),K=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);G=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,J),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,K,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,G),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(K),c&&t(z)}}}function Ub(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Vb(O){let p,k,m,g,v,b,f,w,le,Y,x,J,H,Z,de,Q,ce,se,U,X,ee,K,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,G,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),G=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),K=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);G=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,J),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,K,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,G),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(K),c&&t(z)}}}function Yb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Kb(O){let p,k,m,g,v,b,f,w,le,Y,x,J,H,Z,de,Q,ce,se,U,X,ee,K,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,G,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),x=a("p"),J=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=a("ul"),C=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),q=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),ue=o("model([input_ids, attention_mask])"),me=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),G=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),m=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),x=r(c,"P",{});var P=i(x);J=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all the
...
first positional argument :`),_e.forEach(t),K=d(c),z=r(c,"UL",{});var A=i(z);C=r(A,"LI",{});var D=i(C);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),q=r(A,"LI",{});var W=i(q);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);ue=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),me=n(W," or "),I=r(W,"CODE",{});var Le=i(I);fe=n(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);G=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){u(c,p,T),e(p,k),u(c,m,T),u(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),u(c,Y,T),u(c,x,T),e(x,J),e(x,H),e(H,Z),e(x,de),e(x,Q),e(Q,ce),e(x,se),u(c,U,T),u(c,X,T),e(X,ee),u(c,K,T),u(c,z,T),e(z,C),e(C,te),e(C,R),e(R,ae),e(C,oe),e(C,B),e(B,pe),e(z,re),e(z,q),e(q,he),e(q,N),e(N,ue),e(q,me),e(q,I),e(I,fe),e(z,ge),e(z,j),e(j,G),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(m),c&&t(g),c&&t(Y),c&&t(x),c&&t(U),c&&t(X),c&&t(K),c&&t(z)}}}function Gb(O){let p,k,m,g,v;return{c(){p=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=o("Module"),v=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var w=i(m);g=n(w,"Module"),w.forEach(t),v=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(b,f){u(b,p,f),e(p,k),e(p,m),e(m,g),e(p,v)},d(b){b&&t(p)}}}function Jb(O){let p,k,m,g,v,b,f,w,le,Y,x,J,H,Z,de,Q,ce,se,U,X,ee,K,z,C,te,R,ae,oe,B,pe,re,q,he,N,ue,me,I,fe,ge,j,G,S,ne,c,T,V,we,Te,P,ke,ye,_e,A,D,Fe,Me,W,$e,Le,be,ve,Jl,Bs,Zl,ed,Rs,td,od,xi,Ct,co,Ba,Ro,nd,Ra,sd,zi,st,Uo,ad,Ua,rd,id,_t,Va,ld,dd,Ya,cd,pd,bt,hd,Ka,ud,md,Ga,fd,gd,Ja,_d,bd,vd,Vo,kd,Za,Td,wd,yd,Yo,Fd,Us,Md,$d,qi,Pt,po,er,Ko,Ld,tr,Ed,Ci,He,Go,xd,or,zd,qd,Jo,Cd,Vs,Pd,jd,Xd,Zo,Ad,en,Sd,Nd,Id,Qe,tn,Dd,jt,Wd,Ys,Od,Hd,nr,Qd,Bd,Rd,ho,Ud,sr,Vd,Yd,on,Pi,Xt,uo,ar,nn,Kd,rr,Gd,ji,ze,sn,Jd,ir,Zd,ec,an,tc,Ks,oc,nc,sc,rn,ac,ln,rc,ic,lc,dn,dc,Gs,cc,pc,hc,Be,cn,uc,At,mc,Js,fc,gc,lr,_c,bc,vc,mo,kc,dr,Tc,wc,pn,Xi,St,fo,cr,hn,yc,pr,Fc,Ai,qe,un,Mc,hr,$c,Lc,mn,Ec,Zs,xc,zc,qc,fn,Cc,gn,Pc,jc,Xc,_n,Ac,ea,Sc,Nc,Ic,xe,bn,Dc,Nt,Wc,ta,Oc,Hc,ur,Qc,Bc,Rc,go,Uc,mr,Vc,Yc,vn,Kc,fr,Gc,Jc,kn,Si,It,_o,gr,Tn,Zc,_r,ep,Ni,Ce,wn,tp,br,op,np,yn,sp,oa,ap,rp,ip,Fn,lp,Mn,dp,cp,pp,$n,hp,na,up,mp,fp,Re,Ln,gp,Dt,_p,sa,bp,vp,vr,kp,Tp,wp,bo,yp,kr,Fp,Mp,En,Ii,Wt,vo,Tr,xn,$p,wr,Lp,Di,Pe,zn,Ep,yr,xp,zp,qn,qp,aa,Cp,Pp,jp,Cn,Xp,Pn,Ap,Sp,Np,jn,Ip,ra,Dp,Wp,Op,Ue,Xn,Hp,Ot,Qp,ia,Bp,Rp,Fr,Up,Vp,Yp,ko,Kp,Mr,Gp,Jp,An,Wi,Ht,To,$r,Sn,Zp,Lr,eh,Oi,je,Nn,th,Qt,oh,Er,nh,sh,xr,ah,rh,ih,In,lh,la,dh,ch,ph,Dn,hh,Wn,uh,mh,fh,On,gh,da,_h,bh,vh,Ve,Hn,kh,Bt,Th,ca,wh,yh,zr,Fh,Mh,$h,wo,Lh,qr,Eh,xh,Qn,Hi,Rt,yo,Cr,Bn,zh,Pr,qh,Qi,Xe,Rn,Ch,Ut,Ph,jr,jh,Xh,Xr,Ah,Sh,Nh,Un,Ih,pa,Dh,Wh,Oh,Vn,Hh,Yn,Qh,Bh,Rh,Kn,Uh,ha,Vh,Yh,Kh,Ye,Gn,Gh,Vt,Jh,ua,Zh,eu,Ar,tu,ou,nu,Fo,su,Sr,au,ru,Jn,Bi,Yt,Mo,Nr,Zn,iu,Ir,lu,Ri,Ae,es,du,Dr,cu,pu,ts,hu,ma,uu,mu,fu,os,gu,ns,_u,bu,vu,$o,ku,Ke,ss,Tu,Kt,wu,fa,yu,Fu,Wr,Mu,$u,Lu,Lo,Eu,Or,xu,zu,as,Ui,Gt,Eo,Hr,rs,qu,Qr,Cu,Vi,Se,is,Pu,Br,ju,Xu,ls,Au,ga,Su,Nu,Iu,ds,Du,cs,Wu,Ou,Hu,xo,Qu,Ge,ps,Bu,Jt,Ru,_a,Uu,Vu,Rr,Yu,Ku,Gu,zo,Ju,Ur,Zu,em,hs,Yi,Zt,qo,Vr,us,tm,Yr,om,Ki,Ne,ms,nm,Kr,sm,am,fs,rm,ba,im,lm,dm,gs,cm,_s,pm,hm,um,Co,mm,Je,bs,fm,eo,gm,va,_m,bm,Gr,vm,km,Tm,Po,wm,Jr,ym,Fm,vs,Gi,to,jo,Zr,ks,Mm,ei,$m,Ji,Ie,Ts,Lm,ti,Em,xm,ws,zm,ka,qm,Cm,Pm,ys,jm,Fs,Xm,Am,Sm,Xo,Nm,Ze,Ms,Im,oo,Dm,Ta,Wm,Om,oi,Hm,Qm,Bm,Ao,Rm,ni,Um,Vm,$s,Zi,no,So,si,Ls,Ym,ai,Km,el,De,Es,Gm,ri,Jm,Zm,xs,ef,wa,tf,of,nf,zs,sf,qs,af,rf,lf,No,df,et,Cs,cf,so,pf,ya,hf,uf,ii,mf,ff,gf,Io,_f,li,bf,vf,Ps,tl,ao,Do,di,js,kf,ci,Tf,ol,We,Xs,wf,ro,yf,pi,Ff,Mf,hi,$f,Lf,Ef,As,xf,Fa,zf,qf,Cf,Ss,Pf,Ns,jf,Xf,Af,Wo,Sf,tt,Is,Nf,io,If,Ma,Df,Wf,ui,Of,Hf,Qf,Oo,Bf,mi,Rf,Uf,Ds,nl;return b=new Oe({}),Z=new Oe({}),c=new Oe({}),ke=new ie({props:{name:"class transformers.FlaubertConfig",anchor:"transformers.FlaubertConfig",parameters:[{name:"layerdrop",val:" = 0.0"},{name:"pre_norm",val:" = False"},{name:"pad_token_id",val:" = 2"},{name:"bos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/flaubert/configuration_flaubert.py#L31",parametersDescription:[{anchor:"transformers.FlaubertConfig.pre_norm",description:`<strong>pre_norm</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),tn=new ie({props:{name:"forward",anchor:"transformers.FlaubertModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/flaubert/modeling_flaubert.py#L147",parametersDescription:[{anchor:"transformers.FlaubertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/flaubert#transformers.FlaubertTokenizer">FlaubertTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16105/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16105/en/model_doc/flaubert#transformers.FlaubertConfig"
...
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16105/en/model_doc/xlm#transformers.XLMConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bn=new ie({props:{name:"forward",anchor:"transformers.XLMForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/xlm/modeling_xlm.py#L789",parametersDescription:[{anchor:"transformers.XLMForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/xlm#transformers.XLMTokenizer">XLMTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),xn=new Oe({}),zn=new ie({props:{name:"class transformers.FlaubertForTokenClassification",anchor:"transformers.FlaubertForTokenClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/flaubert/modeling_flaubert.py#L370",parametersDescription:[{anchor:"transformers.FlaubertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16105/en/model_doc/flaubert#transformers.FlaubertConfig">FlaubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new ie({props:{name:"forward",anchor:"transformers.XLMForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/xlm/modeling_xlm.py#L1118",parametersDescription:[{anchor:"transformers.XLMForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/xlm#transformers.XLMTokenizer">XLMTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Hn=new ie({props:{name:"forward",anchor:"transformers.XLMForQuestionAnsweringSimple.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/xlm/modeling_xlm.py#L890",parametersDescription:[{anchor:"transformers.XLMForQuestionAnsweringSimple.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/xlm#transformers.XLMTokenizer">XLMTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Gn=new ie({props:{name:"forward",anchor:"transformers.XLMForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"is_impossible",val:" = None"},{name:"cls_index",val:" = None"},{name:"p_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/xlm/modeling_xlm.py#L995",parametersDescription:[{anchor:"transformers.XLMForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/xlm#transformers.XLMTokenizer">XLMTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16105/en/model_doc/xlm#transformers.models.xlm.modeling_xlm.XLMForQuestionAnsweringOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$o=new Ee({props:{$$slots:{default:[Db]},$$scope:{ctx:O}}}),ss=new ie({props:{name:"call",anchor:"transformers.TFFlaubertModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/flaubert/modeling_tf_flaubert.py#L237",parametersDescription:[{anchor:"transformers.TFFlaubertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/flaubert#transformers.FlaubertTokenizer">FlaubertTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16105/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
`}}),zo=new Ee({props:{$$slots:{default:[Hb]},$$scope:{ctx:O}}}),hs=new nt({props:{code:`from transformers import FlaubertTokenizer, TFFlaubertWithLMHeadModel
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Co=new Ee({props:{$$slots:{default:[Qb]},$$scope:{ctx:O}}}),bs=new ie({props:{name:"call",anchor:"transformers.TFXLMForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/xlm/modeling_tf_xlm.py#L947",parametersDescription:[{anchor:"transformers.TFXLMForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),No=new Ee({props:{$$slots:{default:[Vb]},$$scope:{ctx:O}}}),Cs=new ie({props:{name:"call",anchor:"transformers.TFXLMForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/xlm/modeling_tf_xlm.py#L1223",parametersDescription:[{anchor:"transformers.TFXLMForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16105/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Wo=new Ee({props:{$$slots:{default:[Kb]},$$scope:{ctx:O}}}),Is=new ie({props:{name:"call",anchor:"transformers.TFXLMForQuestionAnsweringSimple.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"langs",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"lengths",val:" = None"},{name:"cache",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16105/src/transformers/models/xlm/modeling_tf_xlm.py#L1327",parametersDescription:[{anchor:"transformers.TFXLMForQuestionAnsweringSimple.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16105/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16105/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>answer = <span class="hljs-string">&quot; &quot;</span>.join(all_tokens[tf.math.argmax(start_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] : tf.math.argmax(end_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] + <span class="hljs-number">1</span>])`}}),{c(){p=a("meta"),k=l(),m=a("h1"),g=a("a"),v=a("span"),y(b.$$.fragment),f=l(),w=a("span"),le=o("FlauBERT"),Y=l(),x=a("h2"),J=a("a"),H=a("span"),y(Z.$$.fragment),de=l(),Q=a("span"),ce=o("Overview"),se=l(),U=a("p"),X=o("The FlauBERT model was proposed in the paper "),ee=a("a"),K=o("FlauBERT: Unsupervised Language Model Pre-training for French"),z=o(` by Hang Le et al. It\u2019s a transformer model pretrained using a masked language
...
and behavior.`),Id=l(),Qe=a("div"),y(tn.$$.fragment),Dd=l(),jt=a("p"),Wd=o("The "),Ys=a("a"),Od=o("FlaubertModel"),Hd=o(" forward method, overrides the "),nr=a("code"),Qd=o("__call__"),Bd=o(" special method."),Rd=l(),y(ho.$$.fragment),Ud=l(),sr=a("p"),Vd=o("Example:"),Yd=l(),y(on.$$.fragment),Pi=l(),Xt=a("h2"),uo=a("a"),ar=a("span"),y(nn.$$.fragment),Kd=l(),rr=a("span"),Gd=o("FlaubertWithLMHeadModel"),ji=l(),ze=a("div"),y(sn.$$.fragment),Jd=l(),ir=a("p"),Zd=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
alongside usage examples.`),fp=l(),Re=a("div"),y(Ln.$$.fragment),gp=l(),Dt=a("p"),_p=o("The "),sa=a("a"),bp=o("XLMForMultipleChoice"),vp=o(" forward method, overrides the "),vr=a("code"),kp=o("__call__"),Tp=o(" special method."),wp=l(),y(bo.$$.fragment),yp=l(),kr=a("p"),Fp=o("Example:"),Mp=l(),y(En.$$.fragment),Ii=l(),Wt=a("h2"),vo=a("a"),Tr=a("span"),y(xn.$$.fragment),$p=l(),wr=a("span"),Lp=o("FlaubertForTokenClassification"),Di=l(),Pe=a("div"),y(zn.$$.fragment),Ep=l(),yr=a("p"),xp=o(`Flaubert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
layers on top of the hidden-states output to compute `),Er=a("code"),nh=o("span start logits"),sh=o(" and "),xr=a("code"),ah=o("span end logits"),rh=o(")."),ih=l(),In=a("p"),lh=o("This model inherits from "),la=a("a"),dh=o("PreTrainedModel"),ch=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation alongside usage examples.`),vh=l(),Ve=a("div"),y(Hn.$$.fragment),kh=l(),Bt=a("p"),Th=o("The "),ca=a("a"),wh=o("XLMForQuestionAnsweringSimple"),yh=o(" forward method, overrides the "),zr=a("code"),Fh=o("__call__"),Mh=o(" special method."),$h=l(),y(wo.$$.fragment),Lh=l(),qr=a("p"),Eh=o("Example:"),xh=l(),y(Qn.$$.fragment),Hi=l(),Rt=a("h2"),yo=a("a"),Cr=a("span"),y(Bn.$$.fragment),zh=l(),Pr=a("span"),qh=o("FlaubertForQuestionAnswering"),Qi=l(),Xe=a("div"),y(Rn.$$.fragment),Ch=l(),Ut=a("p"),Ph=o(`Flaubert Model with a beam-search span classification head on top for extractive question-answering tasks like
...
behavior.`),vu=l(),y($o.$$.fragment),ku=l(),Ke=a("div"),y(ss.$$.fragment),Tu=l(),Kt=a("p"),wu=o("The "),fa=a("a"),yu=o("TFFlaubertModel"),Fu=o(" forward method, overrides the "),Wr=a("code"),Mu=o("__call__"),$u=o(" special method."),Lu=l(),y(Lo.$$.fragment),Eu=l(),Or=a("p"),xu=o("Example:"),zu=l(),y(as.$$.fragment),Ui=l(),Gt=a("h2"),Eo=a("a"),Hr=a("span"),y(rs.$$.fragment),qu=l(),Qr=a("span"),Cu=o("TFFlaubertWithLMHeadModel"),Vi=l(),Se=a("div"),y(is.$$.fragment),Pu=l(),Br=a("p"),ju=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
softmax) e.g. for RocStories/SWAG tasks.`),xm=l(),ws=a("p"),zm=o("This model inherits from "),ka=a("a"),qm=o("TFPreTrainedModel"),Cm=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regarding arguments.`),rl.forEach(t),Ho.forEach(t),qi=d(s),Pt=r(s,"H2",{class:!0});var il=i(Pt);po=r(il,"A",{id:!0,class:!0,href:!0});var cg=i(po);er=r(cg,"SPAN",{});var pg=i(er);F(Ko.$$.fragment,pg),pg.forEach(t),cg.forEach(t),Ld=d(il),tr=r(il,"SPAN",{});var hg=i(tr);Ed=n(hg,"FlaubertModel"),hg.forEach(t),il.forEach(t),Ci=d(s),He=r(s,"DIV",{class:!0});var vt=i(He);F(Go.$$.fragment,vt),xd=d(vt),or=r(vt,"P",{});var ug=i(or);zd=n(ug,"The bare Flaubert Model transformer outputting raw hidden-states without any specific head on top."),ug.forEach(t),qd=d(vt),Jo=r(vt,"P",{});var ll=i(Jo);Cd=n(ll,"This model inherits from "),Vs=r(ll,"A",{href:!0});var mg=i(Vs);Pd=n(mg,"PreTrainedModel"),mg.forEach(t),jd=n(ll,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dl.forEach(t),Id=d(vt),Qe=r(vt,"DIV",{class:!0});var kt=i(Qe);F(tn.$$.fragment,kt),Dd=d(kt),jt=r(kt,"P",{});var xa=i(jt);Wd=n(xa,"The "),Ys=r(xa,"A",{href:!0});var gg=i(Ys);Od=n(gg,"FlaubertModel"),gg.forEach(t),Hd=n(xa," forward method, overrides the "),nr=r(xa,"CODE",{});var _g=i(nr);Qd=n(_g,"__call__"),_g.forEach(t),Bd=n(xa," special method."),xa.forEach(t),Rd=d(kt),F(ho.$$.fragment,kt),Ud=d(kt),sr=r(kt,"P",{});var bg=i(sr);Vd=n(bg,"Example:"),bg.forEach(t),Yd=d(kt),F(on.$$.fragment,kt),kt.forEach(t),vt.forEach(t),Pi=d(s),Xt=r(s,"H2",{class:!0});var cl=i(Xt);uo=r(cl,"A",{id:!0,class:!0,href:!0});var vg=i(uo);ar=r(vg,"SPAN",{});var kg=i(ar);F(nn.$$.fragment,kg),kg.forEach(t),vg.forEach(t),Kd=d(cl),rr=r(cl,"SPAN",{});var Tg=i(rr);Gd=n(Tg,"FlaubertWithLMHeadModel"),Tg.forEach(t),cl.forEach(t),ji=d(s),ze=r(s,"DIV",{class:!0});var at=i(ze);F(sn.$$.fragment,at),Jd=d(at),ir=r(at,"P",{});var wg=i(ir);Zd=n(wg,`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
alongside usage examples.`),ul.forEach(t),hc=d(at),Be=r(at,"DIV",{class:!0});var Tt=i(Be);F(cn.$$.fragment,Tt),uc=d(Tt),At=r(Tt,"P",{});var za=i(At);mc=n(za,"The "),Js=r(za,"A",{href:!0});var $g=i(Js);fc=n($g,"XLMWithLMHeadModel"),$g.forEach(t),gc=n(za," forward method, overrides the "),lr=r(za,"CODE",{});var Lg=i(lr);_c=n(Lg,"__call__"),Lg.forEach(t),bc=n(za," special method."),za.forEach(t),vc=d(Tt),F(mo.$$.fragment,Tt),kc=d(Tt),dr=r(Tt,"P",{});var Eg=i(dr);Tc=n(Eg,"Example:"),Eg.forEach(t),wc=d(Tt),F(pn.$$.fragment,Tt),Tt.forEach(t),at.forEach(t),Xi=d(s),St=r(s,"H2",{class:!0});var ml=i(St);fo=r(ml,"A",{id:!0,class:!0,href:!0});var xg=i(fo);cr=r(xg,"SPAN",{});var zg=i(cr);F(hn.$$.fragment,zg),zg.forEach(t),xg.forEach(t),yc=d(ml),pr=r(ml,"SPAN",{});var qg=i(pr);Fc=n(qg,"FlaubertForSequenceClassification"),qg.forEach(t),ml.forEach(t),Ai=d(s),qe=r(s,"DIV",{class:!0});var rt=i(qe);F(un.$$.fragment,rt),Mc=d(rt),hr=r(rt,"P",{});var Cg=i(hr);$c=n(Cg,`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
...
layers on top of the hidden-states output to compute `),Er=r(ja,"CODE",{});var d_=i(Er);nh=n(d_,"span start logits"),d_.forEach(t),sh=n(ja," and "),xr=r(ja,"CODE",{});var c_=i(xr);ah=n(c_,"span end logits"),c_.forEach(t),rh=n(ja,")."),ja.forEach(t),ih=d(dt),In=r(dt,"P",{});var Ll=i(In);lh=n(Ll,"This model inherits from "),la=r(Ll,"A",{href:!0});var p_=i(la);dh=n(p_,"PreTrainedModel"),p_.forEach(t),ch=n(Ll,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),El.forEach(t),fh=d(dt),On=r(dt,"P",{});var xl=i(On);gh=n(xl,"This class overrides "),da=r(xl,"A",{href:!0});var u_=i(da);_h=n(u_,"XLMForQuestionAnsweringSimple"),u_.forEach(t),bh=n(xl,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),xl.forEach(t),vh=d(dt),Ve=r(dt,"DIV",{class:!0});var Ft=i(Ve);F(Hn.$$.fragment,Ft),kh=d(Ft),Bt=r(Ft,"P",{});var Xa=i(Bt);Th=n(Xa,"The "),ca=r(Xa,"A",{href:!0});var m_=i(ca);wh=n(m_,"XLMForQuestionAnsweringSimple"),m_.forEach(t),yh=n(Xa," forward method, overrides the "),zr=r(Xa,"CODE",{});var f_=i(zr);Fh=n(f_,"__call__"),f_.forEach(t),Mh=n(Xa," special method."),Xa.forEach(t),$h=d(Ft),F(wo.$$.fragment,Ft),Lh=d(Ft),qr=r(Ft,"P",{});var g_=i(qr);Eh=n(g_,"Example:"),g_.forEach(t),xh=d(Ft),F(Qn.$$.fragment,Ft),Ft.forEach(t),dt.forEach(t),Hi=d(s),Rt=r(s,"H2",{class:!0});var zl=i(Rt);yo=r(zl,"A",{id:!0,class:!0,href:!0});var __=i(yo);Cr=r(__,"SPAN",{});var b_=i(Cr);F(Bn.$$.fragment,b_),b_.forEach(t),__.forEach(t),zh=d(zl),Pr=r(zl,"SPAN",{});var v_=i(Pr);qh=n(v_,"FlaubertForQuestionAnswering"),v_.forEach(t),zl.forEach(t),Qi=d(s),Xe=r(s,"DIV",{class:!0});var ct=i(Xe);F(Rn.$$.fragment,ct),Ch=d(ct),Ut=r(ct,"P",{});var Aa=i(Ut);Ph=n(Aa,`Flaubert Model with a beam-search span classification head on top for extractive question-answering tasks like
...
alongside usage examples.`),Pl.forEach(t),Kh=d(ct),Ye=r(ct,"DIV",{class:!0});var Mt=i(Ye);F(Gn.$$.fragment,Mt),Gh=d(Mt),Vt=r(Mt,"P",{});var Sa=i(Vt);Jh=n(Sa,"The "),ua=r(Sa,"A",{href:!0});var M_=i(ua);Zh=n(M_,"XLMForQuestionAnswering"),M_.forEach(t),eu=n(Sa," forward method, overrides the "),Ar=r(Sa,"CODE",{});var $_=i(Ar);tu=n($_,"__call__"),$_.forEach(t),ou=n(Sa," special method."),Sa.forEach(t),nu=d(Mt),F(Fo.$$.fragment,Mt),su=d(Mt),Sr=r(Mt,"P",{});var L_=i(Sr);au=n(L_,"Example:"),L_.forEach(t),ru=d(Mt),F(Jn.$$.fragment,Mt),Mt.forEach(t),ct.forEach(t),Bi=d(s),Yt=r(s,"H2",{class:!0});var jl=i(Yt);Mo=r(jl,"A",{id:!0,class:!0,href:!0});var E_=i(Mo);Nr=r(E_,"SPAN",{});var x_=i(Nr);F(Zn.$$.fragment,x_),x_.forEach(t),E_.forEach(t),iu=d(jl),Ir=r(jl,"SPAN",{});var z_=i(Ir);lu=n(z_,"TFFlaubertModel"),z_.forEach(t),jl.forEach(t),Ri=d(s),Ae=r(s,"DIV",{class:!0});var pt=i(Ae);F(es.$$.fragment,pt),du=d(pt),Dr=r(pt,"P",{});var q_=i(Dr);cu=n(q_,"The bare Flaubert Model transformer outputting raw hidden-states without any specific head on top."),q_.forEach(t),pu=d(pt),ts=r(pt,"P",{});var Xl=i(ts);hu=n(Xl,"This model inherits from "),ma=r(Xl,"A",{href:!0});var C_=i(ma);uu=n(C_,"TFPreTrainedModel"),C_.forEach(t),mu=n(Xl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Il.forEach(t),Hu=d(ht),F(xo.$$.fragment,ht),Qu=d(ht),Ge=r(ht,"DIV",{class:!0});var Lt=i(Ge);F(ps.$$.fragment,Lt),Bu=d(Lt),Jt=r(Lt,"P",{});var Ia=i(Jt);Ru=n(Ia,"The "),_a=r(Ia,"A",{href:!0});var H_=i(_a);Uu=n(H_,"TFFlaubertWithLMHeadModel"),H_.forEach(t),Vu=n(Ia," forward method, overrides the "),Rr=r(Ia,"CODE",{});var Q_=i(Rr);Yu=n(Q_,"__call__"),Q_.forEach(t),Ku=n(Ia," special method."),Ia.forEach(t),Gu=d(Lt),F(zo.$$.fragment,Lt),Ju=d(Lt),Ur=r(Lt,"P",{});var B_=i(Ur);Zu=n(B_,"Example:"),B_.forEach(t),em=d(Lt),F(hs.$$.fragment,Lt),Lt.forEach(t),ht.forEach(t),Yi=d(s),Zt=r(s,"H2",{class:!0});var Dl=i(Zt);qo=r(Dl,"A",{id:!0,class:!0,href:!0});var R_=i(qo);Vr=r(R_,"SPAN",{});var U_=i(Vr);F(us.$$.fragment,U_),U_.forEach(t),R_.forEach(t),tm=d(Dl),Yr=r(Dl,"SPAN",{});var V_=i(Yr);om=n(V_,"TFFlaubertForSequenceClassification"),V_.forEach(t),Dl.forEach(t),Ki=d(s),Ne=r(s,"DIV",{class:!0});var ut=i(Ne);F(ms.$$.fragment,ut),nm=d(ut),Kr=r(ut,"P",{});var Y_=i(Kr);sm=n(Y_,`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
...
softmax) e.g. for RocStories/SWAG tasks.`),sb.forEach(t),xm=d(mt),ws=r(mt,"P",{});var Ql=i(ws);zm=n(Ql,"This model inherits from "),ka=r(Ql,"A",{href:!0});var ab=i(ka);qm=n(ab,"TFPreTrainedModel"),ab.forEach(t),Cm=n(Ql,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bl.forEach(t),Sm=d(mt),F(Xo.$$.fragment,mt),Nm=d(mt),Ze=r(mt,"DIV",{class:!0});var xt=i(Ze);F(Ms.$$.fragment,xt),Im=d(xt),oo=r(xt,"P",{});var Wa=i(oo);Dm=n(Wa,"The "),Ta=r(Wa,"A",{href:!0});var ib=i(Ta);Wm=n(ib,"TFXLMForMultipleChoice"),ib.forEach(t),Om=n(Wa," forward method, overrides the "),oi=r(Wa,"CODE",{});var lb=i(oi);Hm=n(lb,"__call__"),lb.forEach(t),Qm=n(Wa," special method."),Wa.forEach(t),Bm=d(xt),F(Ao.$$.fragment,xt),Rm=d(xt),ni=r(xt,"P",{});var db=i(ni);Um=n(db,"Example:"),db.forEach(t),Vm=d(xt),F($s.$$.fragment,xt),xt.forEach(t),mt.forEach(t),Zi=d(s),no=r(s,"H2",{class:!0});var Rl=i(no);So=r(Rl,"A",{id:!0,class:!0,href:!0});var cb=i(So);si=r(cb,"SPAN",{});var pb=i(si);F(Ls.$$.fragment,pb),pb.forEach(t),cb.forEach(t),Ym=d(Rl),ai=r(Rl,"SPAN",{});var hb=i(ai);Km=n(hb,"TFFlaubertForTokenClassification"),hb.forEach(t),Rl.forEach(t),el=d(s),De=r(s,"DIV",{class:!0});var ft=i(De);F(Es.$$.fragment,ft),Gm=d(ft),ri=r(ft,"P",{});var ub=i(ri);Jm=n(ub,`Flaubert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
