...
[<span class="hljs-number">1</span>, <span class="hljs-number">8</span>, <span class="hljs-number">50267</span>]`}}),{c(){d=n("p"),g=r("Example:"),l=p(),k(f.$$.fragment)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Example:"),_.forEach(o),l=h(c),b(f.$$.fragment,c)},m(c,_){v(c,d,_),e(d,g),v(c,l,_),w(f,c,_),$=!0},p:ee,i(c){$||(y(f.$$.fragment,c),$=!0)},o(c){T(f.$$.fragment,c),$=!1},d(c){c&&o(d),c&&o(l),M(f,c)}}}function Ap(z){let d,g,l,f,$,c,_,q,re,V,W,Y,Yo,dt,ya,Xo,Ta,ms,$e,Ma,lt,$a,za,us,ko,xa,fs,Q,Zo,qa,Fa,Ko,Ca,Pa,en,ja,Ea,tn,Ia,gs,bo,Aa,_s,H,ct,La,pt,Oa,Sa,Na,ht,Da,on,Ua,Va,Ba,mt,Ra,nn,Ga,Wa,Qa,ie,Ha,ut,Ja,Ya,sn,Xa,Za,vs,te,Ka,ft,er,tr,gt,or,nr,ks,de,ze,an,_t,sr,rn,ar,bs,vt,ws,wo,rr,ys,kt,Ts,oe,ir,dn,dr,lr,bt,cr,pr,Ms,wt,$s,le,xe,ln,yt,hr,cn,mr,zs,B,Tt,ur,ce,fr,yo,gr,_r,Mt,vr,kr,br,pe,wr,To,yr,Tr,Mo,Mr,$r,zr,qe,xs,he,Fe,pn,$t,xr,hn,qr,qs,x,zt,Fr,mn,Cr,Pr,un,jr,Er,Ce,Ir,xt,Ar,fn,Lr,Or,Sr,Pe,Nr,qt,Dr,$o,Ur,Vr,Br,ne,Ft,Rr,gn,Gr,Wr,Ct,zo,Qr,_n,Hr,Jr,xo,Yr,vn,Xr,Zr,je,Pt,Kr,kn,ei,ti,Ee,jt,oi,bn,ni,si,Ie,Et,ai,It,ri,wn,ii,di,Fs,me,Ae,yn,At,li,Tn,ci,Cs,C,Lt,pi,Ot,hi,Mn,mi,ui,fi,$n,gi,_i,Le,vi,St,ki,zn,bi,wi,yi,Oe,Ti,Nt,Mi,qo,$i,zi,xi,Se,Dt,qi,xn,Fi,Ps,ue,Ne,qn,Ut,Ci,Fn,Pi,js,R,Vt,ji,Bt,Ei,Fo,Ii,Ai,Li,Rt,Oi,Gt,Si,Ni,Di,J,Wt,Ui,fe,Vi,Co,Bi,Ri,Cn,Gi,Wi,Qi,De,Hi,Ue,Es,ge,Ve,Pn,Qt,Ji,jn,Yi,Is,G,Ht,Xi,Jt,Zi,Po,Ki,ed,td,Yt,od,Xt,nd,sd,ad,P,Zt,rd,_e,id,jo,dd,ld,En,cd,pd,hd,Be,md,In,ud,fd,An,gd,_d,Re,vd,Ln,kd,bd,Ge,As,ve,We,On,Kt,wd,Sn,yd,Ls,N,eo,Td,Nn,Md,$d,to,zd,Eo,xd,qd,Fd,oo,Cd,no,Pd,jd,Ed,j,so,Id,ke,Ad,Io,Ld,Od,Dn,Sd,Nd,Dd,Qe,Ud,Un,Vd,Bd,ao,Rd,Vn,Gd,Wd,Qd,He,Hd,Bn,Jd,Yd,Je,Os,be,Ye,Rn,ro,Xd,Gn,Zd,Ss,D,io,Kd,we,el,Wn,tl,ol,Qn,nl,sl,al,lo,rl,Ao,il,dl,ll,co,cl,po,pl,hl,ml,E,ho,ul,ye,fl,Lo,gl,_l,Hn,vl,kl,bl,Xe,wl,Jn,yl,Tl,Oo,Ml,Yn,$l,zl,Ze,xl,Xn,ql,Fl,Ke,Ns,Te,et,Zn,mo,Cl,Kn,Pl,Ds,Me,uo,jl,tt,fo,El,ot,Us;return c=new Z({}),dt=new Z({}),_t=new Z({}),vt=new U({props:{code:`from transformers import MvpTokenizer, MvpForConditionalGeneration
...
model = MvpForConditionalGeneration.from_pretrained("RUCAIBox/mvp")
# the number of trainable parameters
sum(p.numel() for p in model.parameters() if p.requires_grad)`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> MvpForConditionalGeneration
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the number of trainable parameters</span>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp.py#L325",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Pt=new I({props:{name:"convert_tokens_to_string",anchor:"transformers.MvpTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp.py#L290"}}),jt=new I({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.MvpTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MvpTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp.py#L377",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp.py#L350",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp_fast.py#L265",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
make use of token type ids, therefore a list of zeros is returned.`),Ps=p(),ue=n("h2"),Ne=n("a"),qn=n("span"),k(Ut.$$.fragment),Ci=p(),Fn=n("span"),Pi=r("MvpModel"),js=p(),R=n("div"),k(Vt.$$.fragment),ji=p(),Bt=n("p"),Ei=r(`The bare MVP Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Di=p(),J=n("div"),k(Wt.$$.fragment),Ui=p(),fe=n("p"),Vi=r("The "),Co=n("a"),Bi=r("MvpModel"),Ri=r(" forward method, overrides the "),Cn=n("code"),Gi=r("__call__"),Wi=r(" special method."),Qi=p(),k(De.$$.fragment),Hi=p(),k(Ue.$$.fragment),Es=p(),ge=n("h2"),Ve=n("a"),Pn=n("span"),k(Qt.$$.fragment),Ji=p(),jn=n("span"),Yi=r("MvpForConditionalGeneration"),Is=p(),G=n("div"),k(Ht.$$.fragment),Xi=p(),Jt=n("p"),Zi=r(`The MVP Model with a language modeling head. Can be used for various text generation tasks.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ad=p(),P=n("div"),k(Zt.$$.fragment),rd=p(),_e=n("p"),id=r("The "),jo=n("a"),dd=r("MvpForConditionalGeneration"),ld=r(" forward method, overrides the "),En=n("code"),cd=r("__call__"),pd=r(" special method."),hd=p(),k(Be.$$.fragment),md=p(),In=n("p"),ud=r("Example of summarization:"),fd=p(),An=n("p"),gd=r("Fine-tuning a model"),_d=p(),k(Re.$$.fragment),vd=p(),Ln=n("p"),kd=r("Inference after the model fine-tuned"),bd=p(),k(Ge.$$.fragment),As=p(),ve=n("h2"),We=n("a"),On=n("span"),k(Kt.$$.fragment),wd=p(),Sn=n("span"),yd=r("MvpForSequenceClassification"),Ls=p(),N=n("div"),k(eo.$$.fragment),Td=p(),Nn=n("p"),Md=r(`Mvp model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
