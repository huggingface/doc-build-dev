...
[<span class="hljs-number">1</span>, <span class="hljs-number">8</span>, <span class="hljs-number">50267</span>]`}}),{c(){d=n("p"),g=r("Example:"),l=p(),k(f.$$.fragment)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Example:"),_.forEach(o),l=h(c),b(f.$$.fragment,c)},m(c,_){v(c,d,_),e(d,g),v(c,l,_),w(f,c,_),$=!0},p:ee,i(c){$||(y(f.$$.fragment,c),$=!0)},o(c){T(f.$$.fragment,c),$=!1},d(c){c&&o(d),c&&o(l),M(f,c)}}}function Ap(z){let d,g,l,f,$,c,_,q,re,U,W,Y,Yo,dt,ya,Xo,Ta,ms,$e,Ma,lt,$a,za,us,ko,xa,fs,Q,Zo,qa,Ca,Ko,Fa,Pa,en,ja,Ea,tn,Ia,gs,bo,Aa,_s,H,ct,La,pt,Oa,Sa,Na,ht,Da,on,Ba,Ua,Va,mt,Ra,nn,Ga,Wa,Qa,ie,Ha,ut,Ja,Ya,sn,Xa,Za,vs,te,Ka,ft,er,tr,gt,or,nr,ks,de,ze,an,_t,sr,rn,ar,bs,vt,ws,wo,rr,ys,kt,Ts,oe,ir,dn,dr,lr,bt,cr,pr,Ms,wt,$s,le,xe,ln,yt,hr,cn,mr,zs,V,Tt,ur,ce,fr,yo,gr,_r,Mt,vr,kr,br,pe,wr,To,yr,Tr,Mo,Mr,$r,zr,qe,xs,he,Ce,pn,$t,xr,hn,qr,qs,x,zt,Cr,mn,Fr,Pr,un,jr,Er,Fe,Ir,xt,Ar,fn,Lr,Or,Sr,Pe,Nr,qt,Dr,$o,Br,Ur,Vr,ne,Ct,Rr,gn,Gr,Wr,Ft,zo,Qr,_n,Hr,Jr,xo,Yr,vn,Xr,Zr,je,Pt,Kr,kn,ei,ti,Ee,jt,oi,bn,ni,si,Ie,Et,ai,It,ri,wn,ii,di,Cs,me,Ae,yn,At,li,Tn,ci,Fs,F,Lt,pi,Ot,hi,Mn,mi,ui,fi,$n,gi,_i,Le,vi,St,ki,zn,bi,wi,yi,Oe,Ti,Nt,Mi,qo,$i,zi,xi,Se,Dt,qi,xn,Ci,Ps,ue,Ne,qn,Bt,Fi,Cn,Pi,js,R,Ut,ji,Vt,Ei,Co,Ii,Ai,Li,Rt,Oi,Gt,Si,Ni,Di,J,Wt,Bi,fe,Ui,Fo,Vi,Ri,Fn,Gi,Wi,Qi,De,Hi,Be,Es,ge,Ue,Pn,Qt,Ji,jn,Yi,Is,G,Ht,Xi,Jt,Zi,Po,Ki,ed,td,Yt,od,Xt,nd,sd,ad,P,Zt,rd,_e,id,jo,dd,ld,En,cd,pd,hd,Ve,md,In,ud,fd,An,gd,_d,Re,vd,Ln,kd,bd,Ge,As,ve,We,On,Kt,wd,Sn,yd,Ls,N,eo,Td,Nn,Md,$d,to,zd,Eo,xd,qd,Cd,oo,Fd,no,Pd,jd,Ed,j,so,Id,ke,Ad,Io,Ld,Od,Dn,Sd,Nd,Dd,Qe,Bd,Bn,Ud,Vd,ao,Rd,Un,Gd,Wd,Qd,He,Hd,Vn,Jd,Yd,Je,Os,be,Ye,Rn,ro,Xd,Gn,Zd,Ss,D,io,Kd,we,el,Wn,tl,ol,Qn,nl,sl,al,lo,rl,Ao,il,dl,ll,co,cl,po,pl,hl,ml,E,ho,ul,ye,fl,Lo,gl,_l,Hn,vl,kl,bl,Xe,wl,Jn,yl,Tl,Oo,Ml,Yn,$l,zl,Ze,xl,Xn,ql,Cl,Ke,Ns,Te,et,Zn,mo,Fl,Kn,Pl,Ds,Me,uo,jl,tt,fo,El,ot,Bs;return c=new Z({}),dt=new Z({}),_t=new Z({}),vt=new B({props:{code:`from transformers import MvpTokenizer, MvpForConditionalGeneration
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Bt=new Z({}),Ut=new I({props:{name:"class transformers.MvpModel",anchor:"transformers.MvpModel",parameters:[{name:"config",val:": MvpConfig"}],parametersDescription:[{anchor:"transformers.MvpModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpTokenizer">MvpTokenizer</a>. See <a href="/docs/transformers/pr_17787/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1615"}}),Qe=new Jo({props:{$$slots:{default:[qp]},$$scope:{ctx:z}}}),He=new K({props:{anchor:"transformers.MvpForSequenceClassification.forward.example",$$slots:{default:[Cp]},$$scope:{ctx:z}}}),Je=new K({props:{anchor:"transformers.MvpForSequenceClassification.forward.example-2",$$slots:{default:[Fp]},$$scope:{ctx:z}}}),ro=new Z({}),io=new I({props:{name:"class transformers.MvpForQuestionAnswering",anchor:"transformers.MvpForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MvpForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
...
this superclass for more information regarding those methods.`),Vr=p(),ne=n("div"),k(Ct.$$.fragment),Rr=p(),gn=n("p"),Gr=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
make use of token type ids, therefore a list of zeros is returned.`),Ps=p(),ue=n("h2"),Ne=n("a"),qn=n("span"),k(Bt.$$.fragment),Fi=p(),Cn=n("span"),Pi=r("MvpModel"),js=p(),R=n("div"),k(Ut.$$.fragment),ji=p(),Vt=n("p"),Ei=r(`The bare MVP Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ad=p(),P=n("div"),k(Zt.$$.fragment),rd=p(),_e=n("p"),id=r("The "),jo=n("a"),dd=r("MvpForConditionalGeneration"),ld=r(" forward method, overrides the "),En=n("code"),cd=r("__call__"),pd=r(" special method."),hd=p(),k(Ve.$$.fragment),md=p(),In=n("p"),ud=r("Example of summarization:"),fd=p(),An=n("p"),gd=r("Fine-tuning a model"),_d=p(),k(Re.$$.fragment),vd=p(),Ln=n("p"),kd=r("Inference after the model fine-tuned"),bd=p(),k(Ge.$$.fragment),As=p(),ve=n("h2"),We=n("a"),On=n("span"),k(Kt.$$.fragment),wd=p(),Sn=n("span"),yd=r("MvpForSequenceClassification"),Ls=p(),N=n("div"),k(eo.$$.fragment),Td=p(),Nn=n("p"),Md=r(`Mvp model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ed=p(),j=n("div"),k(so.$$.fragment),Id=p(),ke=n("p"),Ad=r("The "),Io=n("a"),Ld=r("MvpForSequenceClassification"),Od=r(" forward method, overrides the "),Dn=n("code"),Sd=r("__call__"),Nd=r(" special method."),Dd=p(),k(Qe.$$.fragment),Bd=p(),Bn=n("p"),Ud=r("Example of single-label classification:"),Vd=p(),ao=n("p"),Rd=r("Fine-tuning a model on "),Un=n("code"),Gd=r("num_labels"),Wd=r(" classes"),Qd=p(),k(He.$$.fragment),Hd=p(),Vn=n("p"),Jd=r("Inference after the model fine-tuned"),Yd=p(),k(Je.$$.fragment),Os=p(),be=n("h2"),Ye=n("a"),Rn=n("span"),k(ro.$$.fragment),Xd=p(),Gn=n("span"),Zd=r("MvpForQuestionAnswering"),Ss=p(),D=n("div"),k(io.$$.fragment),Kd=p(),we=n("p"),el=r(`MVP Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
this superclass for more information regarding those methods.`),Js.forEach(o),Vr=h(C),ne=s(C,"DIV",{class:!0});var Vo=a(ne);b(Ct.$$.fragment,Vo),Rr=h(Vo),gn=s(Vo,"P",{});var cc=a(gn);Gr=i(cc,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
