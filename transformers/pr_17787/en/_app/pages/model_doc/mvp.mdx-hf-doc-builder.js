...
tokenizer.batch_decode(generated_ids, skip_special_tokens=True)`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> torch.no_grad():
<span class="hljs-meta">... </span>    generated_ids = model.generate(**inputs)

<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(generated_ids, skip_special_tokens=<span class="hljs-literal">True</span>)`}}),{c(){k(d.$$.fragment)},l(l){b(d.$$.fragment,l)},m(l,f){w(d,l,f),g=!0},p:ee,i(l){g||(y(d.$$.fragment,l),g=!0)},o(l){T(d.$$.fragment,l),g=!1},d(l){M(d,l)}}}function qp(z){let d,g,l,f,$;return{c(){d=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),l=n("code"),f=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),l=s(_,"CODE",{});var q=a(l);f=i(q,"Module"),q.forEach(o),$=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),l=s(_,"CODE",{});var q=a(l);f=i(q,"Module"),q.forEach(o),$=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(c,_){v(c,d,_),e(d,g),e(d,l),e(l,f),e(d,$)},d(c){c&&o(d)}}}function Ep(z){let d,g;return d=new U({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(d.$$.fragment)},l(l){b(d.$$.fragment,l)},m(l,f){w(d,l,f),g=!0},p:ee,i(l){g||(y(d.$$.fragment,l),g=!0)},o(l){T(d.$$.fragment,l),g=!1},d(l){M(d,l)}}}function jp(z){let d,g;return d=new U({props:{code:`with torch.no_grad():
    outputs = model(**inputs)
...
tokenizer.decode(predict_answer_tokens)`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> torch.no_grad():
<span class="hljs-meta">... </span>    outputs = model(**inputs)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predict_answer_tokens)`}}),{c(){k(d.$$.fragment)},l(l){b(d.$$.fragment,l)},m(l,f){w(d,l,f),g=!0},p:ee,i(l){g||(y(d.$$.fragment,l),g=!0)},o(l){T(d.$$.fragment,l),g=!1},d(l){M(d,l)}}}function Ip(z){let d,g,l,f,$;return f=new U({props:{code:`from transformers import MvpTokenizer, MvpForCausalLM
...
[<span class="hljs-number">1</span>, <span class="hljs-number">8</span>, <span class="hljs-number">50267</span>]`}}),{c(){d=n("p"),g=r("Example:"),l=p(),k(f.$$.fragment)},l(c){d=s(c,"P",{});var _=a(d);g=i(_,"Example:"),_.forEach(o),l=h(c),b(f.$$.fragment,c)},m(c,_){v(c,d,_),e(d,g),v(c,l,_),w(f,c,_),$=!0},p:ee,i(c){$||(y(f.$$.fragment,c),$=!0)},o(c){T(f.$$.fragment,c),$=!1},d(c){c&&o(d),c&&o(l),M(f,c)}}}function Ap(z){let d,g,l,f,$,c,_,q,re,V,W,Y,Yo,dt,ya,Xo,Ta,ms,$e,Ma,lt,$a,za,us,ko,xa,fs,Q,Zo,qa,Fa,Ko,Ca,Pa,en,Ea,ja,tn,Ia,gs,bo,Aa,_s,H,ct,La,pt,Oa,Sa,Na,ht,Da,on,Ua,Va,Ba,mt,Ra,nn,Ga,Wa,Qa,ie,Ha,ut,Ja,Ya,sn,Xa,Za,vs,te,Ka,ft,er,tr,gt,or,nr,ks,de,ze,an,_t,sr,rn,ar,bs,vt,ws,wo,rr,ys,kt,Ts,oe,ir,dn,dr,lr,bt,cr,pr,Ms,wt,$s,le,xe,ln,yt,hr,cn,mr,zs,B,Tt,ur,ce,fr,yo,gr,_r,Mt,vr,kr,br,pe,wr,To,yr,Tr,Mo,Mr,$r,zr,qe,xs,he,Fe,pn,$t,xr,hn,qr,qs,x,zt,Fr,mn,Cr,Pr,un,Er,jr,Ce,Ir,xt,Ar,fn,Lr,Or,Sr,Pe,Nr,qt,Dr,$o,Ur,Vr,Br,ne,Ft,Rr,gn,Gr,Wr,Ct,zo,Qr,_n,Hr,Jr,xo,Yr,vn,Xr,Zr,Ee,Pt,Kr,kn,ei,ti,je,Et,oi,bn,ni,si,Ie,jt,ai,It,ri,wn,ii,di,Fs,me,Ae,yn,At,li,Tn,ci,Cs,C,Lt,pi,Ot,hi,Mn,mi,ui,fi,$n,gi,_i,Le,vi,St,ki,zn,bi,wi,yi,Oe,Ti,Nt,Mi,qo,$i,zi,xi,Se,Dt,qi,xn,Fi,Ps,ue,Ne,qn,Ut,Ci,Fn,Pi,Es,R,Vt,Ei,Bt,ji,Fo,Ii,Ai,Li,Rt,Oi,Gt,Si,Ni,Di,J,Wt,Ui,fe,Vi,Co,Bi,Ri,Cn,Gi,Wi,Qi,De,Hi,Ue,js,ge,Ve,Pn,Qt,Ji,En,Yi,Is,G,Ht,Xi,Jt,Zi,Po,Ki,ed,td,Yt,od,Xt,nd,sd,ad,P,Zt,rd,_e,id,Eo,dd,ld,jn,cd,pd,hd,Be,md,In,ud,fd,An,gd,_d,Re,vd,Ln,kd,bd,Ge,As,ve,We,On,Kt,wd,Sn,yd,Ls,N,eo,Td,Nn,Md,$d,to,zd,jo,xd,qd,Fd,oo,Cd,no,Pd,Ed,jd,E,so,Id,ke,Ad,Io,Ld,Od,Dn,Sd,Nd,Dd,Qe,Ud,Un,Vd,Bd,ao,Rd,Vn,Gd,Wd,Qd,He,Hd,Bn,Jd,Yd,Je,Os,be,Ye,Rn,ro,Xd,Gn,Zd,Ss,D,io,Kd,we,el,Wn,tl,ol,Qn,nl,sl,al,lo,rl,Ao,il,dl,ll,co,cl,po,pl,hl,ml,j,ho,ul,ye,fl,Lo,gl,_l,Hn,vl,kl,bl,Xe,wl,Jn,yl,Tl,Oo,Ml,Yn,$l,zl,Ze,xl,Xn,ql,Fl,Ke,Ns,Te,et,Zn,mo,Cl,Kn,Pl,Ds,Me,uo,El,tt,fo,jl,ot,Us;return c=new Z({}),dt=new Z({}),_t=new Z({}),vt=new U({props:{code:`from transformers import MvpTokenizer, MvpForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = MvpForConditionalGeneration.from_pretrained(<span class="hljs-string">&quot;RUCAIBox/mvp&quot;</span>, use_prompt=<span class="hljs-literal">True</span>, lightweight_tuning=<span class="hljs-literal">True</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># lightweight tuning with task-specific prompts</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = MvpForConditionalGeneration.from_pretrained(<span class="hljs-string">&quot;RUCAIBox/mtl-data-to-text&quot;</span>, lightweight_tuning=<span class="hljs-literal">True</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># original Prefix-tuning</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = MvpForConditionalGeneration.from_pretrained(
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;facebook/bart-large&quot;</span>, use_prompt=<span class="hljs-literal">True</span>, lightweight_tuning=<span class="hljs-literal">True</span>
<span class="hljs-meta">... </span>)`}}),yt=new Z({}),Tt=new I({props:{name:"class transformers.MvpConfig",anchor:"transformers.MvpConfig",parameters:[{name:"vocab_size",val:" = 50267"},{name:"max_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"is_encoder_decoder",val:" = True"},{name:"decoder_start_token_id",val:" = 2"},{name:"forced_bos_token_id",val:" = 0"},{name:"forced_eos_token_id",val:" = 2"},{name:"use_prompt",val:" = False"},{name:"prompt_length",val:" = 100"},{name:"prompt_mid_dim",val:" = 800"},{name:"lightweight_tuning",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MvpConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50267) &#x2014;
Vocabulary size of the MVP model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpModel">MvpModel</a> or <code>TFMvpModel</code>.`,name:"vocab_size"},{anchor:"transformers.MvpConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"},{anchor:"transformers.MvpConfig.forced_bos_token_id",description:`<strong>forced_bos_token_id</strong> (<code>int</code>, <em>optional</em>, defaults to 0) &#x2014;
The id of the token to force as the first generated token after the <code>decoder_start_token_id</code>. Usually set
to <code>bos_token_id</code>.`,name:"forced_bos_token_id"},{anchor:"transformers.MvpConfig.forced_eos_token_id",description:`<strong>forced_eos_token_id</strong> (<code>int</code>, <em>optional</em>, defaults to 2) &#x2014;
...
Dimensionality of the &#x201C;intermediate&#x201D; layer in prompt.`,name:"prompt_mid_dim"},{anchor:"transformers.MvpConfig.lightweight",description:`<strong>lightweight</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether or not to use prompt lightweight tuning.`,name:"lightweight"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/configuration_mvp.py#L34"}}),qe=new K({props:{anchor:"transformers.MvpConfig.example",$$slots:{default:[vp]},$$scope:{ctx:z}}}),$t=new Z({}),zt=new I({props:{name:"class transformers.MvpTokenizer",anchor:"transformers.MvpTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MvpTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp.py#L323",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Pt=new I({props:{name:"convert_tokens_to_string",anchor:"transformers.MvpTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp.py#L288"}}),Et=new I({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.MvpTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MvpTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp.py#L348",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/tokenization_mvp_fast.py#L262",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ut=new Z({}),Vt=new I({props:{name:"class transformers.MvpModel",anchor:"transformers.MvpModel",parameters:[{name:"config",val:": MvpConfig"}],parametersDescription:[{anchor:"transformers.MvpModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_17787/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1290"}}),Wt=new I({props:{name:"forward",anchor:"transformers.MvpModel.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MvpModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpTokenizer">MvpTokenizer</a>. See <a href="/docs/transformers/pr_17787/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1466",returnDescription:`
<p>A <a
...
`}}),Be=new Jo({props:{$$slots:{default:[$p]},$$scope:{ctx:z}}}),Re=new K({props:{anchor:"transformers.MvpForConditionalGeneration.forward.example",$$slots:{default:[zp]},$$scope:{ctx:z}}}),Ge=new K({props:{anchor:"transformers.MvpForConditionalGeneration.forward.example-2",$$slots:{default:[xp]},$$scope:{ctx:z}}}),Kt=new Z({}),eo=new I({props:{name:"class transformers.MvpForSequenceClassification",anchor:"transformers.MvpForSequenceClassification",parameters:[{name:"config",val:": MvpConfig"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MvpForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_17787/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1596"}}),so=new I({props:{name:"forward",anchor:"transformers.MvpForSequenceClassification.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MvpForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpTokenizer">MvpTokenizer</a>. See <a href="/docs/transformers/pr_17787/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17787/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1616"}}),Qe=new Jo({props:{$$slots:{default:[qp]},$$scope:{ctx:z}}}),He=new K({props:{anchor:"transformers.MvpForSequenceClassification.forward.example",$$slots:{default:[Fp]},$$scope:{ctx:z}}}),Je=new K({props:{anchor:"transformers.MvpForSequenceClassification.forward.example-2",$$slots:{default:[Cp]},$$scope:{ctx:z}}}),ro=new Z({}),io=new I({props:{name:"class transformers.MvpForQuestionAnswering",anchor:"transformers.MvpForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MvpForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_17787/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1723"}}),ho=new I({props:{name:"forward",anchor:"transformers.MvpForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": Tensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MvpForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpTokenizer">MvpTokenizer</a>. See <a href="/docs/transformers/pr_17787/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17787/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1741"}}),Xe=new Jo({props:{$$slots:{default:[Pp]},$$scope:{ctx:z}}}),Ze=new K({props:{anchor:"transformers.MvpForQuestionAnswering.forward.example",$$slots:{default:[Ep]},$$scope:{ctx:z}}}),Ke=new K({props:{anchor:"transformers.MvpForQuestionAnswering.forward.example-2",$$slots:{default:[jp]},$$scope:{ctx:z}}}),mo=new Z({}),uo=new I({props:{name:"class transformers.MvpForCausalLM",anchor:"transformers.MvpForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1852"}}),fo=new I({props:{name:"forward",anchor:"transformers.MvpForCausalLM.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MvpForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17787/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17787/src/transformers/models/mvp/modeling_mvp.py#L1887",returnDescription:`
<p>A <a
...
this superclass for more information regarding those methods.`),Br=p(),ne=n("div"),k(Ft.$$.fragment),Rr=p(),gn=n("p"),Gr=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A MVP sequence has the following format:`),Wr=p(),Ct=n("ul"),zo=n("li"),Qr=r("single sequence: "),_n=n("code"),Hr=r("<s> X </s>"),Jr=p(),xo=n("li"),Yr=r("pair of sequences: "),vn=n("code"),Xr=r("<s> A </s></s> B </s>"),Zr=p(),Ee=n("div"),k(Pt.$$.fragment),Kr=p(),kn=n("p"),ei=r("Converts a sequence of tokens (string) in a single string."),ti=p(),je=n("div"),k(Et.$$.fragment),oi=p(),bn=n("p"),ni=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. MVP does not
make use of token type ids, therefore a list of zeros is returned.`),si=p(),Ie=n("div"),k(jt.$$.fragment),ai=p(),It=n("p"),ri=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned.`),Ps=p(),ue=n("h2"),Ne=n("a"),qn=n("span"),k(Ut.$$.fragment),Ci=p(),Fn=n("span"),Pi=r("MvpModel"),Es=p(),R=n("div"),k(Vt.$$.fragment),Ei=p(),Bt=n("p"),ji=r(`The bare MVP Model outputting raw hidden-states without any specific head on top.
...
etc.)`),Li=p(),Rt=n("p"),Oi=r("This model is also a PyTorch "),Gt=n("a"),Si=r("torch.nn.Module"),Ni=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Di=p(),J=n("div"),k(Wt.$$.fragment),Ui=p(),fe=n("p"),Vi=r("The "),Co=n("a"),Bi=r("MvpModel"),Ri=r(" forward method, overrides the "),Cn=n("code"),Gi=r("__call__"),Wi=r(" special method."),Qi=p(),k(De.$$.fragment),Hi=p(),k(Ue.$$.fragment),js=p(),ge=n("h2"),Ve=n("a"),Pn=n("span"),k(Qt.$$.fragment),Ji=p(),En=n("span"),Yi=r("MvpForConditionalGeneration"),Is=p(),G=n("div"),k(Ht.$$.fragment),Xi=p(),Jt=n("p"),Zi=r(`The MVP Model with a language modeling head. Can be used for various text generation tasks.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ad=p(),P=n("div"),k(Zt.$$.fragment),rd=p(),_e=n("p"),id=r("The "),Eo=n("a"),dd=r("MvpForConditionalGeneration"),ld=r(" forward method, overrides the "),jn=n("code"),cd=r("__call__"),pd=r(" special method."),hd=p(),k(Be.$$.fragment),md=p(),In=n("p"),ud=r("Example of summarization:"),fd=p(),An=n("p"),gd=r("Fine-tuning a model"),_d=p(),k(Re.$$.fragment),vd=p(),Ln=n("p"),kd=r("Inference after the model fine-tuned"),bd=p(),k(Ge.$$.fragment),As=p(),ve=n("h2"),We=n("a"),On=n("span"),k(Kt.$$.fragment),wd=p(),Sn=n("span"),yd=r("MvpForSequenceClassification"),Ls=p(),N=n("div"),k(eo.$$.fragment),Td=p(),Nn=n("p"),Md=r(`Mvp model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),$d=p(),to=n("p"),zd=r("This model inherits from "),jo=n("a"),xd=r("PreTrainedModel"),qd=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fd=p(),oo=n("p"),Cd=r("This model is also a PyTorch "),no=n("a"),Pd=r("torch.nn.Module"),Ed=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jd=p(),E=n("div"),k(so.$$.fragment),Id=p(),ke=n("p"),Ad=r("The "),Io=n("a"),Ld=r("MvpForSequenceClassification"),Od=r(" forward method, overrides the "),Dn=n("code"),Sd=r("__call__"),Nd=r(" special method."),Dd=p(),k(Qe.$$.fragment),Ud=p(),Un=n("p"),Vd=r("Example of single-label classification:"),Bd=p(),ao=n("p"),Rd=r("Fine-tuning a model on "),Vn=n("code"),Gd=r("num_labels"),Wd=r(" classes"),Qd=p(),k(He.$$.fragment),Hd=p(),Bn=n("p"),Jd=r("Inference after the model fine-tuned"),Yd=p(),k(Je.$$.fragment),Os=p(),be=n("h2"),Ye=n("a"),Rn=n("span"),k(ro.$$.fragment),Xd=p(),Gn=n("span"),Zd=r("MvpForQuestionAnswering"),Ss=p(),D=n("div"),k(io.$$.fragment),Kd=p(),we=n("p"),el=r(`MVP Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
this superclass for more information regarding those methods.`),Js.forEach(o),Br=h(F),ne=s(F,"DIV",{class:!0});var Bo=a(ne);b(Ft.$$.fragment,Bo),Rr=h(Bo),gn=s(Bo,"P",{});var cc=a(gn);Gr=i(cc,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A MVP sequence has the following format:`),cc.forEach(o),Wr=h(Bo),Ct=s(Bo,"UL",{});var Ys=a(Ct);zo=s(Ys,"LI",{});var Il=a(zo);Qr=i(Il,"single sequence: "),_n=s(Il,"CODE",{});var pc=a(_n);Hr=i(pc,"<s> X </s>"),pc.forEach(o),Il.forEach(o),Jr=h(Ys),xo=s(Ys,"LI",{});var Al=a(xo);Yr=i(Al,"pair of sequences: "),vn=s(Al,"CODE",{});var hc=a(vn);Xr=i(hc,"<s> A </s></s> B </s>"),hc.forEach(o),Al.forEach(o),Ys.forEach(o),Bo.forEach(o),Zr=h(F),Ee=s(F,"DIV",{class:!0});var Xs=a(Ee);b(Pt.$$.fragment,Xs),Kr=h(Xs),kn=s(Xs,"P",{});var mc=a(kn);ei=i(mc,"Converts a sequence of tokens (string) in a single string."),mc.forEach(o),Xs.forEach(o),ti=h(F),je=s(F,"DIV",{class:!0});var Zs=a(je);b(Et.$$.fragment,Zs),oi=h(Zs),bn=s(Zs,"P",{});var uc=a(bn);ni=i(uc,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. MVP does not
make use of token type ids, therefore a list of zeros is returned.`),uc.forEach(o),Zs.forEach(o),si=h(F),Ie=s(F,"DIV",{class:!0});var Ks=a(Ie);b(jt.$$.fragment,Ks),ai=h(Ks),It=s(Ks,"P",{});var ea=a(It);ri=i(ea,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned.`),Tc.forEach(o),aa.forEach(o),A.forEach(o),Ps=h(t),ue=s(t,"H2",{class:!0});var ra=a(ue);Ne=s(ra,"A",{id:!0,class:!0,href:!0});var Mc=a(Ne);qn=s(Mc,"SPAN",{});var $c=a(qn);b(Ut.$$.fragment,$c),$c.forEach(o),Mc.forEach(o),Ci=h(ra),Fn=s(ra,"SPAN",{});var zc=a(Fn);Pi=i(zc,"MvpModel"),zc.forEach(o),ra.forEach(o),Es=h(t),R=s(t,"DIV",{class:!0});var at=a(R);b(Vt.$$.fragment,at),Ei=h(at),Bt=s(at,"P",{});var ia=a(Bt);ji=i(ia,`The bare MVP Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ia.forEach(o),Li=h(at),Rt=s(at,"P",{});var da=a(Rt);Oi=i(da,"This model is also a PyTorch "),Gt=s(da,"A",{href:!0,rel:!0});var qc=a(Gt);Si=i(qc,"torch.nn.Module"),qc.forEach(o),Ni=i(da,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),da.forEach(o),Di=h(at),J=s(at,"DIV",{class:!0});var rt=a(J);b(Wt.$$.fragment,rt),Ui=h(rt),fe=s(rt,"P",{});var Ro=a(fe);Vi=i(Ro,"The "),Co=s(Ro,"A",{href:!0});var Fc=a(Co);Bi=i(Fc,"MvpModel"),Fc.forEach(o),Ri=i(Ro," forward method, overrides the "),Cn=s(Ro,"CODE",{});var Cc=a(Cn);Gi=i(Cc,"__call__"),Cc.forEach(o),Wi=i(Ro," special method."),Ro.forEach(o),Qi=h(rt),b(De.$$.fragment,rt),Hi=h(rt),b(Ue.$$.fragment,rt),rt.forEach(o),at.forEach(o),js=h(t),ge=s(t,"H2",{class:!0});var la=a(ge);Ve=s(la,"A",{id:!0,class:!0,href:!0});var Pc=a(Ve);Pn=s(Pc,"SPAN",{});var Ec=a(Pn);b(Qt.$$.fragment,Ec),Ec.forEach(o),Pc.forEach(o),Ji=h(la),En=s(la,"SPAN",{});var jc=a(En);Yi=i(jc,"MvpForConditionalGeneration"),jc.forEach(o),la.forEach(o),Is=h(t),G=s(t,"DIV",{class:!0});var it=a(G);b(Ht.$$.fragment,it),Xi=h(it),Jt=s(it,"P",{});var ca=a(Jt);Zi=i(ca,`The MVP Model with a language modeling head. Can be used for various text generation tasks.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pa.forEach(o),ad=h(it),P=s(it,"DIV",{class:!0});var L=a(P);b(Zt.$$.fragment,L),rd=h(L),_e=s(L,"P",{});var Go=a(_e);id=i(Go,"The "),Eo=s(Go,"A",{href:!0});var Lc=a(Eo);dd=i(Lc,"MvpForConditionalGeneration"),Lc.forEach(o),ld=i(Go," forward method, overrides the "),jn=s(Go,"CODE",{});var Oc=a(jn);cd=i(Oc,"__call__"),Oc.forEach(o),pd=i(Go," special method."),Go.forEach(o),hd=h(L),b(Be.$$.fragment,L),md=h(L),In=s(L,"P",{});var Sc=a(In);ud=i(Sc,"Example of summarization:"),Sc.forEach(o),fd=h(L),An=s(L,"P",{});var Nc=a(An);gd=i(Nc,"Fine-tuning a model"),Nc.forEach(o),_d=h(L),b(Re.$$.fragment,L),vd=h(L),Ln=s(L,"P",{});var Dc=a(Ln);kd=i(Dc,"Inference after the model fine-tuned"),Dc.forEach(o),bd=h(L),b(Ge.$$.fragment,L),L.forEach(o),it.forEach(o),As=h(t),ve=s(t,"H2",{class:!0});var ha=a(ve);We=s(ha,"A",{id:!0,class:!0,href:!0});var Uc=a(We);On=s(Uc,"SPAN",{});var Vc=a(On);b(Kt.$$.fragment,Vc),Vc.forEach(o),Uc.forEach(o),wd=h(ha),Sn=s(ha,"SPAN",{});var Bc=a(Sn);yd=i(Bc,"MvpForSequenceClassification"),Bc.forEach(o),ha.forEach(o),Ls=h(t),N=s(t,"DIV",{class:!0});var se=a(N);b(eo.$$.fragment,se),Td=h(se),Nn=s(se,"P",{});var Rc=a(Nn);Md=i(Rc,`Mvp model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Rc.forEach(o),$d=h(se),to=s(se,"P",{});var ma=a(to);zd=i(ma,"This model inherits from "),jo=s(ma,"A",{href:!0});var Gc=a(jo);xd=i(Gc,"PreTrainedModel"),Gc.forEach(o),qd=i(ma,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ma.forEach(o),Fd=h(se),oo=s(se,"P",{});var ua=a(oo);Cd=i(ua,"This model is also a PyTorch "),no=s(ua,"A",{href:!0,rel:!0});var Wc=a(no);Pd=i(Wc,"torch.nn.Module"),Wc.forEach(o),Ed=i(ua,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ua.forEach(o),jd=h(se),E=s(se,"DIV",{class:!0});var O=a(E);b(so.$$.fragment,O),Id=h(O),ke=s(O,"P",{});var Wo=a(ke);Ad=i(Wo,"The "),Io=s(Wo,"A",{href:!0});var Qc=a(Io);Ld=i(Qc,"MvpForSequenceClassification"),Qc.forEach(o),Od=i(Wo," forward method, overrides the "),Dn=s(Wo,"CODE",{});var Hc=a(Dn);Sd=i(Hc,"__call__"),Hc.forEach(o),Nd=i(Wo," special method."),Wo.forEach(o),Dd=h(O),b(Qe.$$.fragment,O),Ud=h(O),Un=s(O,"P",{});var Jc=a(Un);Vd=i(Jc,"Example of single-label classification:"),Jc.forEach(o),Bd=h(O),ao=s(O,"P",{});var fa=a(ao);Rd=i(fa,"Fine-tuning a model on "),Vn=s(fa,"CODE",{});var Yc=a(Vn);Gd=i(Yc,"num_labels"),Yc.forEach(o),Wd=i(fa," classes"),fa.forEach(o),Qd=h(O),b(He.$$.fragment,O),Hd=h(O),Bn=s(O,"P",{});var Xc=a(Bn);Jd=i(Xc,"Inference after the model fine-tuned"),Xc.forEach(o),Yd=h(O),b(Je.$$.fragment,O),O.forEach(o),se.forEach(o),Os=h(t),be=s(t,"H2",{class:!0});var ga=a(be);Ye=s(ga,"A",{id:!0,class:!0,href:!0});var Zc=a(Ye);Rn=s(Zc,"SPAN",{});var Kc=a(Rn);b(ro.$$.fragment,Kc),Kc.forEach(o),Zc.forEach(o),Xd=h(ga),Gn=s(ga,"SPAN",{});var ep=a(Gn);Zd=i(ep,"MvpForQuestionAnswering"),ep.forEach(o),ga.forEach(o),Ss=h(t),D=s(t,"DIV",{class:!0});var ae=a(D);b(io.$$.fragment,ae),Kd=h(ae),we=s(ae,"P",{});var Qo=a(we);el=i(Qo,`MVP Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),va.forEach(o),ml=h(ae),j=s(ae,"DIV",{class:!0});var S=a(j);b(ho.$$.fragment,S),ul=h(S),ye=s(S,"P",{});var Ho=a(ye);fl=i(Ho,"The "),Lo=s(Ho,"A",{href:!0});var ap=a(Lo);gl=i(ap,"MvpForQuestionAnswering"),ap.forEach(o),_l=i(Ho," forward method, overrides the "),Hn=s(Ho,"CODE",{});var rp=a(Hn);vl=i(rp,"__call__"),rp.forEach(o),kl=i(Ho," special method."),Ho.forEach(o),bl=h(S),b(Xe.$$.fragment,S),wl=h(S),Jn=s(S,"P",{});var ip=a(Jn);yl=i(ip,"Example:"),ip.forEach(o),Tl=h(S),Oo=s(S,"P",{});var Ll=a(Oo);Ml=i(Ll,`Fine-tuning a model for extrative question answering, and our model also supports generative question answering
using `),Yn=s(Ll,"CODE",{});var dp=a(Yn);$l=i(dp,"BartForConditionalGeneration"),dp.forEach(o),Ll.forEach(o),zl=h(S),b(Ze.$$.fragment,S),xl=h(S),Xn=s(S,"P",{});var lp=a(Xn);ql=i(lp,"Inference after the model fine-tuned"),lp.forEach(o),Fl=h(S),b(Ke.$$.fragment,S),S.forEach(o),ae.forEach(o),Ns=h(t),Te=s(t,"H2",{class:!0});var ka=a(Te);et=s(ka,"A",{id:!0,class:!0,href:!0});var cp=a(et);Zn=s(cp,"SPAN",{});var pp=a(Zn);b(mo.$$.fragment,pp),pp.forEach(o),cp.forEach(o),Cl=h(ka),Kn=s(ka,"SPAN",{});var hp=a(Kn);Pl=i(hp,"MvpForCausalLM"),hp.forEach(o),ka.forEach(o),Ds=h(t),Me=s(t,"DIV",{class:!0});var ba=a(Me);b(uo.$$.fragment,ba),El=h(ba),tt=s(ba,"DIV",{class:!0});var wa=a(tt);b(fo.$$.fragment,wa),jl=h(wa),b(ot.$$.fragment,wa),wa.forEach(o),ba.forEach(o),this.h()},h(){m(d,"name","hf:doc:metadata"),m(d,"content",JSON.stringify(Lp)),m(f,"id","mvp"),m(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(f,"href","#mvp"),m(l,"class","relative group"),m(Y,"id","overview"),m(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Y,"href","#overview"),m(W,"class","relative group"),m(lt,"href","https://github.com/RUCAIBox/MVP"),m(lt,"rel","nofollow"),m(pt,"href","https://huggingface.co/models?filter=mvp"),m(pt,"rel","nofollow"),m(ut,"href","https://arxiv.org/abs/2101.00190"),m(ut,"rel","nofollow"),m(ft,"href","https://huggingface.co/StevenTang"),m(ft,"rel","nofollow"),m(gt,"href","https://github.com/RUCAIBox/MVP"),m(gt,"rel","nofollow"),m(ze,"id","examples"),m(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ze,"href","#examples"),m(de,"class","relative group"),m(bt,"href","https://arxiv.org/abs/2101.00190"),m(bt,"rel","nofollow"),m(xe,"id","transformers.MvpConfig"),m(xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(xe,"href","#transformers.MvpConfig"),m(le,"class","relative group"),m(yo,"href","/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpModel"),m(Mt,"href","https://huggingface.co/RUCAIBox/mvp"),m(Mt,"rel","nofollow"),m(To,"href","/docs/transformers/pr_17787/en/main_classes/configuration#transformers.PretrainedConfig"),m(Mo,"href","/docs/transformers/pr_17787/en/main_classes/configuration#transformers.PretrainedConfig"),m(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Fe,"id","transformers.MvpTokenizer"),m(Fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Fe,"href","#transformers.MvpTokenizer"),m(he,"class","relative group"),m($o,"href","/docs/transformers/pr_17787/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ae,"id","transformers.MvpTokenizerFast"),m(Ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ae,"href","#transformers.MvpTokenizerFast"),m(me,"class","relative group"),m(qo,"href","/docs/transformers/pr_17787/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),m(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ne,"id","transformers.MvpModel"),m(Ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ne,"href","#transformers.MvpModel"),m(ue,"class","relative group"),m(Fo,"href","/docs/transformers/pr_17787/en/main_classes/model#transformers.PreTrainedModel"),m(Gt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Gt,"rel","nofollow"),m(Co,"href","/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpModel"),m(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ve,"id","transformers.MvpForConditionalGeneration"),m(Ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ve,"href","#transformers.MvpForConditionalGeneration"),m(ge,"class","relative group"),m(Po,"href","/docs/transformers/pr_17787/en/main_classes/model#transformers.PreTrainedModel"),m(Xt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Xt,"rel","nofollow"),m(Eo,"href","/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpForConditionalGeneration"),m(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(We,"id","transformers.MvpForSequenceClassification"),m(We,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(We,"href","#transformers.MvpForSequenceClassification"),m(ve,"class","relative group"),m(jo,"href","/docs/transformers/pr_17787/en/main_classes/model#transformers.PreTrainedModel"),m(no,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(no,"rel","nofollow"),m(Io,"href","/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpForSequenceClassification"),m(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ye,"id","transformers.MvpForQuestionAnswering"),m(Ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ye,"href","#transformers.MvpForQuestionAnswering"),m(be,"class","relative group"),m(Ao,"href","/docs/transformers/pr_17787/en/main_classes/model#transformers.PreTrainedModel"),m(po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(po,"rel","nofollow"),m(Lo,"href","/docs/transformers/pr_17787/en/model_doc/mvp#transformers.MvpForQuestionAnswering"),m(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(et,"id","transformers.MvpForCausalLM"),m(et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(et,"href","#transformers.MvpForCausalLM"),m(Te,"class","relative group"),m(tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,u){e(document.head,d),v(t,g,u),v(t,l,u),e(l,f),e(f,$),w(c,$,null),e(l,_),e(l,q),e(q,re),v(t,V,u),v(t,W,u),e(W,Y),e(Y,Yo),w(dt,Yo,null),e(W,ya),e(W,Xo),e(Xo,Ta),v(t,ms,u),v(t,$e,u),e($e,Ma),e($e,lt),e(lt,$a),e($e,za),v(t,us,u),v(t,ko,u),e(ko,xa),v(t,fs,u),v(t,Q,u),e(Q,Zo),e(Zo,qa),e(Q,Fa),e(Q,Ko),e(Ko,Ca),e(Q,Pa),e(Q,en),e(en,Ea),e(Q,ja),e(Q,tn),e(tn,Ia),v(t,gs,u),v(t,bo,u),e(bo,Aa),v(t,_s,u),v(t,H,u),e(H,ct),e(ct,La),e(ct,pt),e(pt,Oa),e(ct,Sa),e(H,Na),e(H,ht),e(ht,Da),e(ht,on),e(on,Ua),e(ht,Va),e(H,Ba),e(H,mt),e(mt,Ra),e(mt,nn),e(nn,Ga),e(mt,Wa),e(H,Qa),e(H,ie),e(ie,Ha),e(ie,ut),e(ut,Ja),e(ie,Ya),e(ie,sn),e(sn,Xa),e(ie,Za),v(t,vs,u),v(t,te,u),e(te,Ka),e(te,ft),e(ft,er),e(te,tr),e(te,gt),e(gt,or),e(te,nr),v(t,ks,u),v(t,de,u),e(de,ze),e(ze,an),w(_t,an,null),e(de,sr),e(de,rn),e(rn,ar),v(t,bs,u),w(vt,t,u),v(t,ws,u),v(t,wo,u),e(wo,rr),v(t,ys,u),w(kt,t,u),v(t,Ts,u),v(t,oe,u),e(oe,ir),e(oe,dn),e(dn,dr),e(oe,lr),e(oe,bt),e(bt,cr),e(oe,pr),v(t,Ms,u),w(wt,t,u),v(t,$s,u),v(t,le,u),e(le,xe),e(xe,ln),w(yt,ln,null),e(le,hr),e(le,cn),e(cn,mr),v(t,zs,u),v(t,B,u),w(Tt,B,null),e(B,ur),e(B,ce),e(ce,fr),e(ce,yo),e(yo,gr),e(ce,_r),e(ce,Mt),e(Mt,vr),e(ce,kr),e(B,br),e(B,pe),e(pe,wr),e(pe,To),e(To,yr),e(pe,Tr),e(pe,Mo),e(Mo,Mr),e(pe,$r),e(B,zr),w(qe,B,null),v(t,xs,u),v(t,he,u),e(he,Fe),e(Fe,pn),w($t,pn,null),e(he,xr),e(he,hn),e(hn,qr),v(t,qs,u),v(t,x,u),w(zt,x,null),e(x,Fr),e(x,mn),e(mn,Cr),e(x,Pr),e(x,un),e(un,Er),e(x,jr),w(Ce,x,null),e(x,Ir),e(x,xt),e(xt,Ar),e(xt,fn),e(fn,Lr),e(xt,Or),e(x,Sr),w(Pe,x,null),e(x,Nr),e(x,qt),e(qt,Dr),e(qt,$o),e($o,Ur),e(qt,Vr),e(x,Br),e(x,ne),w(Ft,ne,null),e(ne,Rr),e(ne,gn),e(gn,Gr),e(ne,Wr),e(ne,Ct),e(Ct,zo),e(zo,Qr),e(zo,_n),e(_n,Hr),e(Ct,Jr),e(Ct,xo),e(xo,Yr),e(xo,vn),e(vn,Xr),e(x,Zr),e(x,Ee),w(Pt,Ee,null),e(Ee,Kr),e(Ee,kn),e(kn,ei),e(x,ti),e(x,je),w(Et,je,null),e(je,oi),e(je,bn),e(bn,ni),e(x,si),e(x,Ie),w(jt,Ie,null),e(Ie,ai),e(Ie,It),e(It,ri),e(It,wn),e(wn,ii),e(It,di),v(t,Fs,u),v(t,me,u),e(me,Ae),e(Ae,yn),w(At,yn,null),e(me,li),e(me,Tn),e(Tn,ci),v(t,Cs,u),v(t,C,u),w(Lt,C,null),e(C,pi),e(C,Ot),e(Ot,hi),e(Ot,Mn),e(Mn,mi),e(Ot,ui),e(C,fi),e(C,$n),e($n,gi),e(C,_i),w(Le,C,null),e(C,vi),e(C,St),e(St,ki),e(St,zn),e(zn,bi),e(St,wi),e(C,yi),w(Oe,C,null),e(C,Ti),e(C,Nt),e(Nt,Mi),e(Nt,qo),e(qo,$i),e(Nt,zi),e(C,xi),e(C,Se),w(Dt,Se,null),e(Se,qi),e(Se,xn),e(xn,Fi),v(t,Ps,u),v(t,ue,u),e(ue,Ne),e(Ne,qn),w(Ut,qn,null),e(ue,Ci),e(ue,Fn),e(Fn,Pi),v(t,Es,u),v(t,R,u),w(Vt,R,null),e(R,Ei),e(R,Bt),e(Bt,ji),e(Bt,Fo),e(Fo,Ii),e(Bt,Ai),e(R,Li),e(R,Rt),e(Rt,Oi),e(Rt,Gt),e(Gt,Si),e(Rt,Ni),e(R,Di),e(R,J),w(Wt,J,null),e(J,Ui),e(J,fe),e(fe,Vi),e(fe,Co),e(Co,Bi),e(fe,Ri),e(fe,Cn),e(Cn,Gi),e(fe,Wi),e(J,Qi),w(De,J,null),e(J,Hi),w(Ue,J,null),v(t,js,u),v(t,ge,u),e(ge,Ve),e(Ve,Pn),w(Qt,Pn,null),e(ge,Ji),e(ge,En),e(En,Yi),v(t,Is,u),v(t,G,u),w(Ht,G,null),e(G,Xi),e(G,Jt),e(Jt,Zi),e(Jt,Po),e(Po,Ki),e(Jt,ed),e(G,td),e(G,Yt),e(Yt,od),e(Yt,Xt),e(Xt,nd),e(Yt,sd),e(G,ad),e(G,P),w(Zt,P,null),e(P,rd),e(P,_e),e(_e,id),e(_e,Eo),e(Eo,dd),e(_e,ld),e(_e,jn),e(jn,cd),e(_e,pd),e(P,hd),w(Be,P,null),e(P,md),e(P,In),e(In,ud),e(P,fd),e(P,An),e(An,gd),e(P,_d),w(Re,P,null),e(P,vd),e(P,Ln),e(Ln,kd),e(P,bd),w(Ge,P,null),v(t,As,u),v(t,ve,u),e(ve,We),e(We,On),w(Kt,On,null),e(ve,wd),e(ve,Sn),e(Sn,yd),v(t,Ls,u),v(t,N,u),w(eo,N,null),e(N,Td),e(N,Nn),e(Nn,Md),e(N,$d),e(N,to),e(to,zd),e(to,jo),e(jo,xd),e(to,qd),e(N,Fd),e(N,oo),e(oo,Cd),e(oo,no),e(no,Pd),e(oo,Ed),e(N,jd),e(N,E),w(so,E,null),e(E,Id),e(E,ke),e(ke,Ad),e(ke,Io),e(Io,Ld),e(ke,Od),e(ke,Dn),e(Dn,Sd),e(ke,Nd),e(E,Dd),w(Qe,E,null),e(E,Ud),e(E,Un),e(Un,Vd),e(E,Bd),e(E,ao),e(ao,Rd),e(ao,Vn),e(Vn,Gd),e(ao,Wd),e(E,Qd),w(He,E,null),e(E,Hd),e(E,Bn),e(Bn,Jd),e(E,Yd),w(Je,E,null),v(t,Os,u),v(t,be,u),e(be,Ye),e(Ye,Rn),w(ro,Rn,null),e(be,Xd),e(be,Gn),e(Gn,Zd),v(t,Ss,u),v(t,D,u),w(io,D,null),e(D,Kd),e(D,we),e(we,el),e(we,Wn),e(Wn,tl),e(we,ol),e(we,Qn),e(Qn,nl),e(we,sl),e(D,al),e(D,lo),e(lo,rl),e(lo,Ao),e(Ao,il),e(lo,dl),e(D,ll),e(D,co),e(co,cl),e(co,po),e(po,pl),e(co,hl),e(D,ml),e(D,j),w(ho,j,null),e(j,ul),e(j,ye),e(ye,fl),e(ye,Lo),e(Lo,gl),e(ye,_l),e(ye,Hn),e(Hn,vl),e(ye,kl),e(j,bl),w(Xe,j,null),e(j,wl),e(j,Jn),e(Jn,yl),e(j,Tl),e(j,Oo),e(Oo,Ml),e(Oo,Yn),e(Yn,$l),e(j,zl),w(Ze,j,null),e(j,xl),e(j,Xn),e(Xn,ql),e(j,Fl),w(Ke,j,null),v(t,Ns,u),v(t,Te,u),e(Te,et),e(et,Zn),w(mo,Zn,null),e(Te,Cl),e(Te,Kn),e(Kn,Pl),v(t,Ds,u),v(t,Me,u),w(uo,Me,null),e(Me,El),e(Me,tt),w(fo,tt,null),e(tt,jl),w(ot,tt,null),Us=!0},p(t,[u]){const go={};u&2&&(go.$$scope={dirty:u,ctx:t}),qe.$set(go);const es={};u&2&&(es.$$scope={dirty:u,ctx:t}),Ce.$set(es);const ts={};u&2&&(ts.$$scope={dirty:u,ctx:t}),Pe.$set(ts);const os={};u&2&&(os.$$scope={dirty:u,ctx:t}),Le.$set(os);const _o={};u&2&&(_o.$$scope={dirty:u,ctx:t}),Oe.$set(_o);const ns={};u&2&&(ns.$$scope={dirty:u,ctx:t}),De.$set(ns);const ss={};u&2&&(ss.$$scope={dirty:u,ctx:t}),Ue.$set(ss);const as={};u&2&&(as.$$scope={dirty:u,ctx:t}),Be.$set(as);const vo={};u&2&&(vo.$$scope={dirty:u,ctx:t}),Re.$set(vo);const rs={};u&2&&(rs.$$scope={dirty:u,ctx:t}),Ge.$set(rs);const is={};u&2&&(is.$$scope={dirty:u,ctx:t}),Qe.$set(is);const X={};u&2&&(X.$$scope={dirty:u,ctx:t}),He.$set(X);const ds={};u&2&&(ds.$$scope={dirty:u,ctx:t}),Je.$set(ds);const ls={};u&2&&(ls.$$scope={dirty:u,ctx:t}),Xe.$set(ls);const cs={};u&2&&(cs.$$scope={dirty:u,ctx:t}),Ze.$set(cs);const ps={};u&2&&(ps.$$scope={dirty:u,ctx:t}),Ke.$set(ps);const hs={};u&2&&(hs.$$scope={dirty:u,ctx:t}),ot.$set(hs)},i(t){Us||(y(c.$$.fragment,t),y(dt.$$.fragment,t),y(_t.$$.fragment,t),y(vt.$$.fragment,t),y(kt.$$.fragment,t),y(wt.$$.fragment,t),y(yt.$$.fragment,t),y(Tt.$$.fragment,t),y(qe.$$.fragment,t),y($t.$$.fragment,t),y(zt.$$.fragment,t),y(Ce.$$.fragment,t),y(Pe.$$.fragment,t),y(Ft.$$.fragment,t),y(Pt.$$.fragment,t),y(Et.$$.fragment,t),y(jt.$$.fragment,t),y(At.$$.fragment,t),y(Lt.$$.fragment,t),y(Le.$$.fragment,t),y(Oe.$$.fragment,t),y(Dt.$$.fragment,t),y(Ut.$$.fragment,t),y(Vt.$$.fragment,t),y(Wt.$$.fragment,t),y(De.$$.fragment,t),y(Ue.$$.fragment,t),y(Qt.$$.fragment,t),y(Ht.$$.fragment,t),y(Zt.$$.fragment,t),y(Be.$$.fragment,t),y(Re.$$.fragment,t),y(Ge.$$.fragment,t),y(Kt.$$.fragment,t),y(eo.$$.fragment,t),y(so.$$.fragment,t),y(Qe.$$.fragment,t),y(He.$$.fragment,t),y(Je.$$.fragment,t),y(ro.$$.fragment,t),y(io.$$.fragment,t),y(ho.$$.fragment,t),y(Xe.$$.fragment,t),y(Ze.$$.fragment,t),y(Ke.$$.fragment,t),y(mo.$$.fragment,t),y(uo.$$.fragment,t),y(fo.$$.fragment,t),y(ot.$$.fragment,t),Us=!0)},o(t){T(c.$$.fragment,t),T(dt.$$.fragment,t),T(_t.$$.fragment,t),T(vt.$$.fragment,t),T(kt.$$.fragment,t),T(wt.$$.fragment,t),T(yt.$$.fragment,t),T(Tt.$$.fragment,t),T(qe.$$.fragment,t),T($t.$$.fragment,t),T(zt.$$.fragment,t),T(Ce.$$.fragment,t),T(Pe.$$.fragment,t),T(Ft.$$.fragment,t),T(Pt.$$.fragment,t),T(Et.$$.fragment,t),T(jt.$$.fragment,t),T(At.$$.fragment,t),T(Lt.$$.fragment,t),T(Le.$$.fragment,t),T(Oe.$$.fragment,t),T(Dt.$$.fragment,t),T(Ut.$$.fragment,t),T(Vt.$$.fragment,t),T(Wt.$$.fragment,t),T(De.$$.fragment,t),T(Ue.$$.fragment,t),T(Qt.$$.fragment,t),T(Ht.$$.fragment,t),T(Zt.$$.fragment,t),T(Be.$$.fragment,t),T(Re.$$.fragment,t),T(Ge.$$.fragment,t),T(Kt.$$.fragment,t),T(eo.$$.fragment,t),T(so.$$.fragment,t),T(Qe.$$.fragment,t),T(He.$$.fragment,t),T(Je.$$.fragment,t),T(ro.$$.fragment,t),T(io.$$.fragment,t),T(ho.$$.fragment,t),T(Xe.$$.fragment,t),T(Ze.$$.fragment,t),T(Ke.$$.fragment,t),T(mo.$$.fragment,t),T(uo.$$.fragment,t),T(fo.$$.fragment,t),T(ot.$$.fragment,t),Us=!1},d(t){o(d),t&&o(g),t&&o(l),M(c),t&&o(V),t&&o(W),M(dt),t&&o(ms),t&&o($e),t&&o(us),t&&o(ko),t&&o(fs),t&&o(Q),t&&o(gs),t&&o(bo),t&&o(_s),t&&o(H),t&&o(vs),t&&o(te),t&&o(ks),t&&o(de),M(_t),t&&o(bs),M(vt,t),t&&o(ws),t&&o(wo),t&&o(ys),M(kt,t),t&&o(Ts),t&&o(oe),t&&o(Ms),M(wt,t),t&&o($s),t&&o(le),M(yt),t&&o(zs),t&&o(B),M(Tt),M(qe),t&&o(xs),t&&o(he),M($t),t&&o(qs),t&&o(x),M(zt),M(Ce),M(Pe),M(Ft),M(Pt),M(Et),M(jt),t&&o(Fs),t&&o(me),M(At),t&&o(Cs),t&&o(C),M(Lt),M(Le),M(Oe),M(Dt),t&&o(Ps),t&&o(ue),M(Ut),t&&o(Es),t&&o(R),M(Vt),M(Wt),M(De),M(Ue),t&&o(js),t&&o(ge),M(Qt),t&&o(Is),t&&o(G),M(Ht),M(Zt),M(Be),M(Re),M(Ge),t&&o(As),t&&o(ve),M(Kt),t&&o(Ls),t&&o(N),M(eo),M(so),M(Qe),M(He),M(Je),t&&o(Os),t&&o(be),M(ro),t&&o(Ss),t&&o(D),M(io),M(ho),M(Xe),M(Ze),M(Ke),t&&o(Ns),t&&o(Te),M(mo),t&&o(Ds),t&&o(Me),M(uo),M(fo),M(ot)}}}const Lp={local:"mvp",sections:[{local:"overview",title:"Overview"},{local:"examples",title:"Examples"},{local:"transformers.MvpConfig",title:"MvpConfig"},{local:"transformers.MvpTokenizer",title:"MvpTokenizer"},{local:"transformers.MvpTokenizerFast",title:"MvpTokenizerFast"},{local:"transformers.MvpModel",title:"MvpModel"},{local:"transformers.MvpForConditionalGeneration",title:"MvpForConditionalGeneration"},{local:"transformers.MvpForSequenceClassification",title:"MvpForSequenceClassification"},{local:"transformers.MvpForQuestionAnswering",title:"MvpForQuestionAnswering"},{local:"transformers.MvpForCausalLM",title:"MvpForCausalLM"}],title:"MVP"};function Op(z){return _p(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Rp extends mp{constructor(d){super();up(this,d,Op,Ap,fp,{})}}export{Rp as default,Lp as metadata};
