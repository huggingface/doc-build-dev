import{S as Nr,i as Br,s as Or,e as n,k as d,w as _,t as r,M as Wr,c as s,d as t,m as c,a,x as v,h as i,b as l,F as e,g as h,y as x,q as T,o as E,B as b,v as Rr}from"../../chunks/vendor-6b77c823.js";import{T as Sr}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-abef54e3.js";import{C as ya}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Vt}from"../../chunks/IconCopyLink-7a11ce68.js";function Ur(et){let m,q,g,$,A;return{c(){m=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),$=r("Module"),A=r(`
...
the latter silently ignores them.`)},l(j){m=s(j,"P",{});var D=a(m);q=i(D,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(D,"CODE",{});var L=a(g);$=i(L,"Module"),L.forEach(t),A=i(D,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),D.forEach(t)},m(j,D){h(j,m,D),e(m,q),e(m,g),e(g,$),e(m,A)},d(j){j&&t(m)}}}function Hr(et){let m,q,g,$,A,j,D,L,Lo,no,J,ee,Dt,he,So,$t,No,so,u,Bo,tt,Oo,Wo,Pt,Ro,Uo,ot,Jo,Ho,nt,Zo,Go,st,Xo,Ko,Mt,Qo,Yo,at,en,tn,rt,on,nn,ao,te,sn,fe,an,rn,ro,H,oe,zt,ue,ln,Ct,dn,io,w,ge,cn,B,it,pn,mn,lt,hn,fn,dt,un,gn,_n,Z,vn,ct,xn,Tn,pt,En,bn,jn,Ft,wn,yn,_e,kn,ne,ve,Vn,xe,Dn,mt,$n,Pn,Mn,se,Te,zn,Ee,Cn,ht,Fn,In,lo,G,ae,It,be,An,At,qn,co,P,je,Ln,qt,Sn,Nn,M,ft,Bn,On,ut,Wn,Rn,gt,Un,Jn,Lt,Hn,Zn,_t,Gn,Xn,Kn,re,we,Qn,ye,Yn,vt,es,ts,os,ie,ke,ns,Ve,ss,xt,as,rs,po,X,le,St,De,is,Nt,ls,mo,y,$e,ds,Pe,cs,Bt,ps,ms,hs,Me,fs,ze,us,gs,_s,Ot,vs,xs,Ce,Ts,Tt,Es,bs,js,Fe,ws,Ie,ys,ks,Vs,z,Ae,Ds,K,$s,Et,Ps,Ms,Wt,zs,Cs,Fs,de,Is,Rt,As,qs,qe,ho,Q,ce,Ut,Le,Ls,Jt,Ss,fo,f,Se,Ns,Ne,Bs,Ht,Os,Ws,Rs,Be,Us,Oe,Js,Hs,Zs,Zt,Gs,Xs,We,Ks,bt,Qs,Ys,ea,Re,ta,Ue,oa,na,sa,Gt,aa,ra,S,Xt,Je,ia,la,Kt,He,da,ca,Qt,Ze,pa,ma,Yt,Ge,ha,fa,C,Xe,ua,Y,ga,jt,_a,va,eo,xa,Ta,Ea,pe,ba,to,ja,wa,Ke,uo;return j=new Vt({}),he=new Vt({}),ue=new Vt({}),ge=new U({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L28",parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config_dict",description:`<strong>text_config_dict</strong> (<code>dict</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = VisionTextDualEncoderModel.from_pretrained(<span class="hljs-string">&quot;vit-bert&quot;</span>, config=vision_text_config)`}}),ve=new U({props:{name:"from_vision_text_configs",anchor:"transformers.VisionTextDualEncoderConfig.from_vision_text_configs",parameters:[{name:"vision_config",val:": PretrainedConfig"},{name:"text_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L105",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig"
>VisionTextDualEncoderConfig</a></p>
`}}),Te=new U({props:{name:"to_dict",anchor:"transformers.VisionTextDualEncoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L117",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, any]</code></p>
`}}),be=new Vt({}),je=new U({props:{name:"class transformers.VisionTextDualEncoderProcessor",anchor:"transformers.VisionTextDualEncoderProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L23",parametersDescription:[{anchor:"transformers.VisionTextDualEncoderProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/pr_16446/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>) &#x2014;
The feature extractor is a required input.`,name:"feature_extractor"},{anchor:"transformers.VisionTextDualEncoderProcessor.tokenizer",description:`<strong>tokenizer</strong> (<a href="/docs/transformers/pr_16446/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
The tokenizer is a required input.`,name:"tokenizer"}]}}),we=new U({props:{name:"batch_decode",anchor:"transformers.VisionTextDualEncoderProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L98"}}),ke=new U({props:{name:"decode",anchor:"transformers.VisionTextDualEncoderProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L105"}}),De=new Vt({}),$e=new U({props:{name:"class transformers.VisionTextDualEncoderModel",anchor:"transformers.VisionTextDualEncoderModel",parameters:[{name:"config",val:": typing.Optional[transformers.models.vision_text_dual_encoder.configuration_vision_text_dual_encoder.VisionTextDualEncoderConfig] = None"},{name:"vision_model",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"text_model",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/modeling_vision_text_dual_encoder.py#L162",parametersDescription:[{anchor:"transformers.VisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16446/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16446/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ae=new U({props:{name:"forward",anchor:"transformers.VisionTextDualEncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"return_loss",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/modeling_vision_text_dual_encoder.py#L294",parametersDescription:[{anchor:"transformers.VisionTextDualEncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16446/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_16446/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
a feature extractor (e.g. if you use ViT as the encoder, you should use <a href="/docs/transformers/pr_16446/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>). See
<a href="/docs/transformers/pr_16446/en/model_doc/vit#transformers.ViTFeatureExtractor.__call__">ViTFeatureExtractor.<strong>call</strong>()</a> for details.`,name:"pixel_values"},{anchor:"transformers.VisionTextDualEncoderModel.forward.return_loss",description:`<strong>return_loss</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
<li><strong>text_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_16446/en/model_doc/clip#transformers.CLIPTextModel"
>CLIPTextModel</a>.</li>
<li><strong>image_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The image embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_16446/en/model_doc/clip#transformers.CLIPVisionModel"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = logits_per_image.softmax(dim=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),Le=new Vt({}),Se=new U({props:{name:"class transformers.FlaxVisionTextDualEncoderModel",anchor:"transformers.FlaxVisionTextDualEncoderModel",parameters:[{name:"config",val:": VisionTextDualEncoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16446/src/transformers/models/vision_text_dual_encoder/modeling_flax_vision_text_dual_encoder.py#L218",parametersDescription:[{anchor:"transformers.FlaxVisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig">VisionTextDualEncoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16446/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxVisionTextDualEncoderModel.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16446/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
...
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16446/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16446/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16446/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<a
  href="/docs/transformers/pr_16446/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
<a
  href="/docs/transformers/pr_16446/en/model_doc/clip#transformers.FlaxCLIPVisionModel"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){m=n("meta"),q=d(),g=n("h1"),$=n("a"),A=n("span"),_(j.$$.fragment),D=d(),L=n("span"),Lo=r("VisionTextDualEncoder"),no=d(),J=n("h2"),ee=n("a"),Dt=n("span"),_(he.$$.fragment),So=d(),$t=n("span"),No=r("Overview"),so=d(),u=n("p"),Bo=r("The "),tt=n("a"),Oo=r("VisionTextDualEncoderModel"),Wo=r(` can be used to initialize a vision-text dual encoder model with
...
new zero-shot vision tasks such as image classification or retrieval.`),ro=d(),H=n("h2"),oe=n("a"),zt=n("span"),_(ue.$$.fragment),ln=d(),Ct=n("span"),dn=r("VisionTextDualEncoderConfig"),io=d(),w=n("div"),_(ge.$$.fragment),cn=d(),B=n("p"),it=n("a"),pn=r("VisionTextDualEncoderConfig"),mn=r(` is the configuration class to store the configuration of a
...
documentation from `),pt=n("a"),En=r("PretrainedConfig"),bn=r(" for more information."),jn=d(),Ft=n("p"),wn=r("Examples:"),yn=d(),_(_e.$$.fragment),kn=d(),ne=n("div"),_(ve.$$.fragment),Vn=d(),xe=n("p"),Dn=r("Instantiate a "),mt=n("a"),$n=r("VisionTextDualEncoderConfig"),Pn=r(` (or a derived class) from text model configuration and vision
model configuration.`),Mn=d(),se=n("div"),_(Te.$$.fragment),zn=d(),Ee=n("p"),Cn=r("Serializes this instance to a Python dictionary. Override the default "),ht=n("a"),Fn=r("to_dict()"),In=r("."),lo=d(),G=n("h2"),ae=n("a"),It=n("span"),_(be.$$.fragment),An=d(),At=n("span"),qn=r("VisionTextDualEncoderProcessor"),co=d(),P=n("div"),_(je.$$.fragment),Ln=d(),qt=n("p"),Sn=r(`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
processor.`),Nn=d(),M=n("p"),ft=n("a"),Bn=r("VisionTextDualEncoderProcessor"),On=r(" offers all the functionalities of "),ut=n("a"),Wn=r("AutoFeatureExtractor"),Rn=r(` and
...
Please refer to the docstring of this method for more information.`),po=d(),X=n("h2"),le=n("a"),St=n("span"),_(De.$$.fragment),is=d(),Nt=n("span"),ls=r("VisionTextDualEncoderModel"),mo=d(),y=n("div"),_($e.$$.fragment),ds=d(),Pe=n("p"),cs=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
...
models (see the examples for more information).`),xs=d(),Ce=n("p"),Ts=r("This model inherits from "),Tt=n("a"),Es=r("PreTrainedModel"),bs=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Vs=d(),z=n("div"),_(Ae.$$.fragment),Ds=d(),K=n("p"),$s=r("The "),Et=n("a"),Ps=r("VisionTextDualEncoderModel"),Ms=r(" forward method, overrides the "),Wt=n("code"),zs=r("__call__"),Cs=r(" special method."),Fs=d(),_(de.$$.fragment),Is=d(),Rt=n("p"),As=r("Examples:"),qs=d(),_(qe.$$.fragment),ho=d(),Q=n("h2"),ce=n("a"),Ut=n("span"),_(Le.$$.fragment),Ls=d(),Jt=n("span"),Ss=r("FlaxVisionTextDualEncoderModel"),fo=d(),f=n("div"),_(Se.$$.fragment),Ns=d(),Ne=n("p"),Bs=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),Ht=n("code"),Os=r("from_pretrained()"),Ws=r(`method. The projection layers are automatically added to the model and
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Rs=d(),Be=n("p"),Us=r("In "),Oe=n("a"),Js=r("LiT: Zero-Shot Transfer with Locked-image Text Tuning"),Hs=r(` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
...
models (see the examples for more information).`),Xs=d(),We=n("p"),Ks=r("This model inherits from "),bt=n("a"),Qs=r("PreTrainedModel"),Ys=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ea=d(),Re=n("p"),ta=r("This model is also a Flax Linen "),Ue=n("a"),oa=r("flax.linen.Module"),na=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),sa=d(),Gt=n("p"),aa=r("Finally, this model supports inherent JAX features such as:"),ra=d(),S=n("ul"),Xt=n("li"),Je=n("a"),ia=r("Just-In-Time (JIT) compilation"),la=d(),Kt=n("li"),He=n("a"),da=r("Automatic Differentiation"),ca=d(),Qt=n("li"),Ze=n("a"),pa=r("Vectorization"),ma=d(),Yt=n("li"),Ge=n("a"),ha=r("Parallelization"),fa=d(),C=n("div"),_(Xe.$$.fragment),ua=d(),Y=n("p"),ga=r("The "),jt=n("a"),_a=r("FlaxVisionTextDualEncoderModel"),va=r(" forward method, overrides the "),eo=n("code"),xa=r("__call__"),Ta=r(" special method."),Ea=d(),_(pe.$$.fragment),ba=d(),to=n("p"),ja=r("Examples:"),wa=d(),_(Ke.$$.fragment),this.h()},l(o){const p=Wr('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(t),q=c(o),g=s(o,"H1",{class:!0});var Qe=a(g);$=s(Qe,"A",{id:!0,class:!0,href:!0});var oo=a($);A=s(oo,"SPAN",{});var ka=a(A);v(j.$$.fragment,ka),ka.forEach(t),oo.forEach(t),D=c(Qe),L=s(Qe,"SPAN",{});var Va=a(L);Lo=i(Va,"VisionTextDualEncoder"),Va.forEach(t),Qe.forEach(t),no=c(o),J=s(o,"H2",{class:!0});var go=a(J);ee=s(go,"A",{id:!0,class:!0,href:!0});var Da=a(ee);Dt=s(Da,"SPAN",{});var $a=a(Dt);v(he.$$.fragment,$a),$a.forEach(t),Da.forEach(t),So=c(go),$t=s(go,"SPAN",{});var Pa=a($t);No=i(Pa,"Overview"),Pa.forEach(t),go.forEach(t),so=c(o),u=s(o,"P",{});var k=a(u);Bo=i(k,"The "),tt=s(k,"A",{href:!0});var Ma=a(tt);Oo=i(Ma,"VisionTextDualEncoderModel"),Ma.forEach(t),Wo=i(k,` can be used to initialize a vision-text dual encoder model with
any pretrained vision autoencoding model as the vision encoder (`),Pt=s(k,"EM",{});var za=a(Pt);Ro=i(za,"e.g."),za.forEach(t),Uo=c(k),ot=s(k,"A",{href:!0});var Ca=a(ot);Jo=i(Ca,"ViT"),Ca.forEach(t),Ho=i(k,", "),nt=s(k,"A",{href:!0});var Fa=a(nt);Zo=i(Fa,"BEiT"),Fa.forEach(t),Go=i(k,", "),st=s(k,"A",{href:!0});var Ia=a(st);Xo=i(Ia,"DeiT"),Ia.forEach(t),Ko=i(k,") and any pretrained text autoencoding model as the text encoder ("),Mt=s(k,"EM",{});var Aa=a(Mt);Qo=i(Aa,"e.g."),Aa.forEach(t),Yo=c(k),at=s(k,"A",{href:!0});var qa=a(at);en=i(qa,"RoBERTa"),qa.forEach(t),tn=i(k,", "),rt=s(k,"A",{href:!0});var La=a(rt);on=i(La,"BERT"),La.forEach(t),nn=i(k,`). Two projection layers are added on top of both the vision and text encoder to project the output embeddings
to a shared latent space. The projection layers are randomly initialized so the model should be fine-tuned on a
downstream task. This model can be used to align the vision-text embeddings using CLIP like contrastive image-text
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment on
new zero-shot vision tasks such as image classification or retrieval.`),_o.forEach(t),ro=c(o),H=s(o,"H2",{class:!0});var vo=a(H);oe=s(vo,"A",{id:!0,class:!0,href:!0});var Na=a(oe);zt=s(Na,"SPAN",{});var Ba=a(zt);v(ue.$$.fragment,Ba),Ba.forEach(t),Na.forEach(t),ln=c(vo),Ct=s(vo,"SPAN",{});var Oa=a(Ct);dn=i(Oa,"VisionTextDualEncoderConfig"),Oa.forEach(t),vo.forEach(t),io=c(o),w=s(o,"DIV",{class:!0});var F=a(w);v(ge.$$.fragment,F),cn=c(F),B=s(F,"P",{});var Ye=a(B);it=s(Ye,"A",{href:!0});var Wa=a(it);pn=i(Wa,"VisionTextDualEncoderConfig"),Wa.forEach(t),mn=i(Ye,` is the configuration class to store the configuration of a
...
specified arguments, defining the text model and vision model configs.`),Ye.forEach(t),_n=c(F),Z=s(F,"P",{});var wt=a(Z);vn=i(wt,"Configuration objects inherit from "),ct=s(wt,"A",{href:!0});var Ja=a(ct);xn=i(Ja,"PretrainedConfig"),Ja.forEach(t),Tn=i(wt,` and can be used to control the model outputs. Read the
documentation from `),pt=s(wt,"A",{href:!0});var Ha=a(pt);En=i(Ha,"PretrainedConfig"),Ha.forEach(t),bn=i(wt," for more information."),wt.forEach(t),jn=c(F),Ft=s(F,"P",{});var Za=a(Ft);wn=i(Za,"Examples:"),Za.forEach(t),yn=c(F),v(_e.$$.fragment,F),kn=c(F),ne=s(F,"DIV",{class:!0});var xo=a(ne);v(ve.$$.fragment,xo),Vn=c(xo),xe=s(xo,"P",{});var To=a(xe);Dn=i(To,"Instantiate a "),mt=s(To,"A",{href:!0});var Ga=a(mt);$n=i(Ga,"VisionTextDualEncoderConfig"),Ga.forEach(t),Pn=i(To,` (or a derived class) from text model configuration and vision
model configuration.`),To.forEach(t),xo.forEach(t),Mn=c(F),se=s(F,"DIV",{class:!0});var Eo=a(se);v(Te.$$.fragment,Eo),zn=c(Eo),Ee=s(Eo,"P",{});var bo=a(Ee);Cn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=s(bo,"A",{href:!0});var Xa=a(ht);Fn=i(Xa,"to_dict()"),Xa.forEach(t),In=i(bo,"."),bo.forEach(t),Eo.forEach(t),F.forEach(t),lo=c(o),G=s(o,"H2",{class:!0});var jo=a(G);ae=s(jo,"A",{id:!0,class:!0,href:!0});var Ka=a(ae);It=s(Ka,"SPAN",{});var Qa=a(It);v(be.$$.fragment,Qa),Qa.forEach(t),Ka.forEach(t),An=c(jo),At=s(jo,"SPAN",{});var Ya=a(At);qn=i(Ya,"VisionTextDualEncoderProcessor"),Ya.forEach(t),jo.forEach(t),co=c(o),P=s(o,"DIV",{class:!0});var O=a(P);v(je.$$.fragment,O),Ln=c(O),qt=s(O,"P",{});var er=a(qt);Sn=i(er,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
processor.`),er.forEach(t),Nn=c(O),M=s(O,"P",{});var N=a(M);ft=s(N,"A",{href:!0});var tr=a(ft);Bn=i(tr,"VisionTextDualEncoderProcessor"),tr.forEach(t),On=i(N," offers all the functionalities of "),ut=s(N,"A",{href:!0});var or=a(ut);Wn=i(or,"AutoFeatureExtractor"),or.forEach(t),Rn=i(N,` and
...
`),_t=s(N,"A",{href:!0});var ar=a(_t);Gn=i(ar,"decode()"),ar.forEach(t),Xn=i(N," for more information."),N.forEach(t),Kn=c(O),re=s(O,"DIV",{class:!0});var wo=a(re);v(we.$$.fragment,wo),Qn=c(wo),ye=s(wo,"P",{});var yo=a(ye);Yn=i(yo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
`),vt=s(yo,"A",{href:!0});var rr=a(vt);es=i(rr,"batch_decode()"),rr.forEach(t),ts=i(yo,". Please refer to the docstring of this method for more information."),yo.forEach(t),wo.forEach(t),os=c(O),ie=s(O,"DIV",{class:!0});var ko=a(ie);v(ke.$$.fragment,ko),ns=c(ko),Ve=s(ko,"P",{});var Vo=a(Ve);ss=i(Vo,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),xt=s(Vo,"A",{href:!0});var ir=a(xt);as=i(ir,"decode()"),ir.forEach(t),rs=i(Vo,`.
Please refer to the docstring of this method for more information.`),Vo.forEach(t),ko.forEach(t),O.forEach(t),po=c(o),X=s(o,"H2",{class:!0});var Do=a(X);le=s(Do,"A",{id:!0,class:!0,href:!0});var lr=a(le);St=s(lr,"SPAN",{});var dr=a(St);v(De.$$.fragment,dr),dr.forEach(t),lr.forEach(t),is=c(Do),Nt=s(Do,"SPAN",{});var cr=a(Nt);ls=i(cr,"VisionTextDualEncoderModel"),cr.forEach(t),Do.forEach(t),mo=c(o),y=s(o,"DIV",{class:!0});var I=a(y);v($e.$$.fragment,I),ds=c(I),Pe=s(I,"P",{});var $o=a(Pe);cs=i($o,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
on new zero-shot vision tasks such as image classification or retrieval.`),Po.forEach(t),_s=c(I),Ot=s(I,"P",{});var hr=a(Ot);vs=i(hr,`After such a Vision-Text-Dual-Encoder model has been trained/fine-tuned, it can be saved/loaded just like any other
models (see the examples for more information).`),hr.forEach(t),xs=c(I),Ce=s(I,"P",{});var Mo=a(Ce);Ts=i(Mo,"This model inherits from "),Tt=s(Mo,"A",{href:!0});var fr=a(Tt);Es=i(fr,"PreTrainedModel"),fr.forEach(t),bs=i(Mo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zo.forEach(t),Vs=c(I),z=s(I,"DIV",{class:!0});var W=a(z);v(Ae.$$.fragment,W),Ds=c(W),K=s(W,"P",{});var yt=a(K);$s=i(yt,"The "),Et=s(yt,"A",{href:!0});var gr=a(Et);Ps=i(gr,"VisionTextDualEncoderModel"),gr.forEach(t),Ms=i(yt," forward method, overrides the "),Wt=s(yt,"CODE",{});var _r=a(Wt);zs=i(_r,"__call__"),_r.forEach(t),Cs=i(yt," special method."),yt.forEach(t),Fs=c(W),v(de.$$.fragment,W),Is=c(W),Rt=s(W,"P",{});var vr=a(Rt);As=i(vr,"Examples:"),vr.forEach(t),qs=c(W),v(qe.$$.fragment,W),W.forEach(t),I.forEach(t),ho=c(o),Q=s(o,"H2",{class:!0});var Co=a(Q);ce=s(Co,"A",{id:!0,class:!0,href:!0});var xr=a(ce);Ut=s(xr,"SPAN",{});var Tr=a(Ut);v(Le.$$.fragment,Tr),Tr.forEach(t),xr.forEach(t),Ls=c(Co),Jt=s(Co,"SPAN",{});var Er=a(Jt);Ss=i(Er,"FlaxVisionTextDualEncoderModel"),Er.forEach(t),Co.forEach(t),fo=c(o),f=s(o,"DIV",{class:!0});var V=a(f);v(Se.$$.fragment,V),Ns=c(V),Ne=s(V,"P",{});var Fo=a(Ne);Bs=i(Fo,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Fo.forEach(t),Rs=c(V),Be=s(V,"P",{});var Io=a(Be);Us=i(Io,"In "),Oe=s(Io,"A",{href:!0,rel:!0});var jr=a(Oe);Js=i(jr,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),jr.forEach(t),Hs=i(Io,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
...
models (see the examples for more information).`),wr.forEach(t),Xs=c(V),We=s(V,"P",{});var Ao=a(We);Ks=i(Ao,"This model inherits from "),bt=s(Ao,"A",{href:!0});var yr=a(bt);Qs=i(yr,"PreTrainedModel"),yr.forEach(t),Ys=i(Ao,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),qo.forEach(t),sa=c(V),Gt=s(V,"P",{});var Vr=a(Gt);aa=i(Vr,"Finally, this model supports inherent JAX features such as:"),Vr.forEach(t),ra=c(V),S=s(V,"UL",{});var me=a(S);Xt=s(me,"LI",{});var Dr=a(Xt);Je=s(Dr,"A",{href:!0,rel:!0});var $r=a(Je);ia=i($r,"Just-In-Time (JIT) compilation"),$r.forEach(t),Dr.forEach(t),la=c(me),Kt=s(me,"LI",{});var Pr=a(Kt);He=s(Pr,"A",{href:!0,rel:!0});var Mr=a(He);da=i(Mr,"Automatic Differentiation"),Mr.forEach(t),Pr.forEach(t),ca=c(me),Qt=s(me,"LI",{});var zr=a(Qt);Ze=s(zr,"A",{href:!0,rel:!0});var Cr=a(Ze);pa=i(Cr,"Vectorization"),Cr.forEach(t),zr.forEach(t),ma=c(me),Yt=s(me,"LI",{});var Fr=a(Yt);Ge=s(Fr,"A",{href:!0,rel:!0});var Ir=a(Ge);ha=i(Ir,"Parallelization"),Ir.forEach(t),Fr.forEach(t),me.forEach(t),fa=c(V),C=s(V,"DIV",{class:!0});var R=a(C);v(Xe.$$.fragment,R),ua=c(R),Y=s(R,"P",{});var kt=a(Y);ga=i(kt,"The "),jt=s(kt,"A",{href:!0});var Ar=a(jt);_a=i(Ar,"FlaxVisionTextDualEncoderModel"),Ar.forEach(t),va=i(kt," forward method, overrides the "),eo=s(kt,"CODE",{});var qr=a(eo);xa=i(qr,"__call__"),qr.forEach(t),Ta=i(kt," special method."),kt.forEach(t),Ea=c(R),v(pe.$$.fragment,R),ba=c(R),to=s(R,"P",{});var Lr=a(to);ja=i(Lr,"Examples:"),Lr.forEach(t),wa=c(R),v(Ke.$$.fragment,R),R.forEach(t),V.forEach(t),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(Zr)),l($,"id","visiontextdualencoder"),l($,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l($,"href","#visiontextdualencoder"),l(g,"class","relative group"),l(ee,"id","overview"),l(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ee,"href","#overview"),l(J,"class","relative group"),l(tt,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel"),l(ot,"href","vit"),l(nt,"href","beit"),l(st,"href","deit"),l(at,"href","roberta"),l(rt,"href","bert"),l(fe,"href","https://arxiv.org/abs/2111.07991"),l(fe,"rel","nofollow"),l(oe,"id","transformers.VisionTextDualEncoderConfig"),l(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(oe,"href","#transformers.VisionTextDualEncoderConfig"),l(H,"class","relative group"),l(it,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig"),l(lt,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel"),l(dt,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel"),l(ct,"href","/docs/transformers/pr_16446/en/main_classes/configuration#transformers.PretrainedConfig"),l(pt,"href","/docs/transformers/pr_16446/en/main_classes/configuration#transformers.PretrainedConfig"),l(mt,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig"),l(ne,"class","docstring"),l(ht,"href","/docs/transformers/pr_16446/en/main_classes/configuration#transformers.PretrainedConfig.to_dict"),l(se,"class","docstring"),l(w,"class","docstring"),l(ae,"id","transformers.VisionTextDualEncoderProcessor"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.VisionTextDualEncoderProcessor"),l(G,"class","relative group"),l(ft,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderProcessor"),l(ut,"href","/docs/transformers/pr_16446/en/model_doc/auto#transformers.AutoFeatureExtractor"),l(gt,"href","/docs/transformers/pr_16446/en/model_doc/auto#transformers.AutoTokenizer"),l(_t,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderProcessor.decode"),l(vt,"href","/docs/transformers/pr_16446/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode"),l(re,"class","docstring"),l(xt,"href","/docs/transformers/pr_16446/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode"),l(ie,"class","docstring"),l(P,"class","docstring"),l(le,"id","transformers.VisionTextDualEncoderModel"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.VisionTextDualEncoderModel"),l(X,"class","relative group"),l(ze,"href","https://arxiv.org/abs/2111.07991"),l(ze,"rel","nofollow"),l(Tt,"href","/docs/transformers/pr_16446/en/main_classes/model#transformers.PreTrainedModel"),l(Ie,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ie,"rel","nofollow"),l(Et,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel"),l(z,"class","docstring"),l(y,"class","docstring"),l(ce,"id","transformers.FlaxVisionTextDualEncoderModel"),l(ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ce,"href","#transformers.FlaxVisionTextDualEncoderModel"),l(Q,"class","relative group"),l(Oe,"href","https://arxiv.org/abs/2111.07991"),l(Oe,"rel","nofollow"),l(bt,"href","/docs/transformers/pr_16446/en/main_classes/model#transformers.PreTrainedModel"),l(Ue,"href","https://flax.readthedocs.io/en/latest/flax.linen.html#module"),l(Ue,"rel","nofollow"),l(Je,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),l(Je,"rel","nofollow"),l(He,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),l(He,"rel","nofollow"),l(Ze,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),l(Ze,"rel","nofollow"),l(Ge,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),l(Ge,"rel","nofollow"),l(jt,"href","/docs/transformers/pr_16446/en/model_doc/vision-text-dual-encoder#transformers.FlaxVisionTextDualEncoderModel"),l(C,"class","docstring"),l(f,"class","docstring")},m(o,p){e(document.head,m),h(o,q,p),h(o,g,p),e(g,$),e($,A),x(j,A,null),e(g,D),e(g,L),e(L,Lo),h(o,no,p),h(o,J,p),e(J,ee),e(ee,Dt),x(he,Dt,null),e(J,So),e(J,$t),e($t,No),h(o,so,p),h(o,u,p),e(u,Bo),e(u,tt),e(tt,Oo),e(u,Wo),e(u,Pt),e(Pt,Ro),e(u,Uo),e(u,ot),e(ot,Jo),e(u,Ho),e(u,nt),e(nt,Zo),e(u,Go),e(u,st),e(st,Xo),e(u,Ko),e(u,Mt),e(Mt,Qo),e(u,Yo),e(u,at),e(at,en),e(u,tn),e(u,rt),e(rt,on),e(u,nn),h(o,ao,p),h(o,te,p),e(te,sn),e(te,fe),e(fe,an),e(te,rn),h(o,ro,p),h(o,H,p),e(H,oe),e(oe,zt),x(ue,zt,null),e(H,ln),e(H,Ct),e(Ct,dn),h(o,io,p),h(o,w,p),x(ge,w,null),e(w,cn),e(w,B),e(B,it),e(it,pn),e(B,mn),e(B,lt),e(lt,hn),e(B,fn),e(B,dt),e(dt,un),e(B,gn),e(w,_n),e(w,Z),e(Z,vn),e(Z,ct),e(ct,xn),e(Z,Tn),e(Z,pt),e(pt,En),e(Z,bn),e(w,jn),e(w,Ft),e(Ft,wn),e(w,yn),x(_e,w,null),e(w,kn),e(w,ne),x(ve,ne,null),e(ne,Vn),e(ne,xe),e(xe,Dn),e(xe,mt),e(mt,$n),e(xe,Pn),e(w,Mn),e(w,se),x(Te,se,null),e(se,zn),e(se,Ee),e(Ee,Cn),e(Ee,ht),e(ht,Fn),e(Ee,In),h(o,lo,p),h(o,G,p),e(G,ae),e(ae,It),x(be,It,null),e(G,An),e(G,At),e(At,qn),h(o,co,p),h(o,P,p),x(je,P,null),e(P,Ln),e(P,qt),e(qt,Sn),e(P,Nn),e(P,M),e(M,ft),e(ft,Bn),e(M,On),e(M,ut),e(ut,Wn),e(M,Rn),e(M,gt),e(gt,Un),e(M,Jn),e(M,Lt),e(Lt,Hn),e(M,Zn),e(M,_t),e(_t,Gn),e(M,Xn),e(P,Kn),e(P,re),x(we,re,null),e(re,Qn),e(re,ye),e(ye,Yn),e(ye,vt),e(vt,es),e(ye,ts),e(P,os),e(P,ie),x(ke,ie,null),e(ie,ns),e(ie,Ve),e(Ve,ss),e(Ve,xt),e(xt,as),e(Ve,rs),h(o,po,p),h(o,X,p),e(X,le),e(le,St),x(De,St,null),e(X,is),e(X,Nt),e(Nt,ls),h(o,mo,p),h(o,y,p),x($e,y,null),e(y,ds),e(y,Pe),e(Pe,cs),e(Pe,Bt),e(Bt,ps),e(Pe,ms),e(y,hs),e(y,Me),e(Me,fs),e(Me,ze),e(ze,us),e(Me,gs),e(y,_s),e(y,Ot),e(Ot,vs),e(y,xs),e(y,Ce),e(Ce,Ts),e(Ce,Tt),e(Tt,Es),e(Ce,bs),e(y,js),e(y,Fe),e(Fe,ws),e(Fe,Ie),e(Ie,ys),e(Fe,ks),e(y,Vs),e(y,z),x(Ae,z,null),e(z,Ds),e(z,K),e(K,$s),e(K,Et),e(Et,Ps),e(K,Ms),e(K,Wt),e(Wt,zs),e(K,Cs),e(z,Fs),x(de,z,null),e(z,Is),e(z,Rt),e(Rt,As),e(z,qs),x(qe,z,null),h(o,ho,p),h(o,Q,p),e(Q,ce),e(ce,Ut),x(Le,Ut,null),e(Q,Ls),e(Q,Jt),e(Jt,Ss),h(o,fo,p),h(o,f,p),x(Se,f,null),e(f,Ns),e(f,Ne),e(Ne,Bs),e(Ne,Ht),e(Ht,Os),e(Ne,Ws),e(f,Rs),e(f,Be),e(Be,Us),e(Be,Oe),e(Oe,Js),e(Be,Hs),e(f,Zs),e(f,Zt),e(Zt,Gs),e(f,Xs),e(f,We),e(We,Ks),e(We,bt),e(bt,Qs),e(We,Ys),e(f,ea),e(f,Re),e(Re,ta),e(Re,Ue),e(Ue,oa),e(Re,na),e(f,sa),e(f,Gt),e(Gt,aa),e(f,ra),e(f,S),e(S,Xt),e(Xt,Je),e(Je,ia),e(S,la),e(S,Kt),e(Kt,He),e(He,da),e(S,ca),e(S,Qt),e(Qt,Ze),e(Ze,pa),e(S,ma),e(S,Yt),e(Yt,Ge),e(Ge,ha),e(f,fa),e(f,C),x(Xe,C,null),e(C,ua),e(C,Y),e(Y,ga),e(Y,jt),e(jt,_a),e(Y,va),e(Y,eo),e(eo,xa),e(Y,Ta),e(C,Ea),x(pe,C,null),e(C,ba),e(C,to),e(to,ja),e(C,wa),x(Ke,C,null),uo=!0},p(o,[p]){const Qe={};p&2&&(Qe.$$scope={dirty:p,ctx:o}),de.$set(Qe);const oo={};p&2&&(oo.$$scope={dirty:p,ctx:o}),pe.$set(oo)},i(o){uo||(T(j.$$.fragment,o),T(he.$$.fragment,o),T(ue.$$.fragment,o),T(ge.$$.fragment,o),T(_e.$$.fragment,o),T(ve.$$.fragment,o),T(Te.$$.fragment,o),T(be.$$.fragment,o),T(je.$$.fragment,o),T(we.$$.fragment,o),T(ke.$$.fragment,o),T(De.$$.fragment,o),T($e.$$.fragment,o),T(Ae.$$.fragment,o),T(de.$$.fragment,o),T(qe.$$.fragment,o),T(Le.$$.fragment,o),T(Se.$$.fragment,o),T(Xe.$$.fragment,o),T(pe.$$.fragment,o),T(Ke.$$.fragment,o),uo=!0)},o(o){E(j.$$.fragment,o),E(he.$$.fragment,o),E(ue.$$.fragment,o),E(ge.$$.fragment,o),E(_e.$$.fragment,o),E(ve.$$.fragment,o),E(Te.$$.fragment,o),E(be.$$.fragment,o),E(je.$$.fragment,o),E(we.$$.fragment,o),E(ke.$$.fragment,o),E(De.$$.fragment,o),E($e.$$.fragment,o),E(Ae.$$.fragment,o),E(de.$$.fragment,o),E(qe.$$.fragment,o),E(Le.$$.fragment,o),E(Se.$$.fragment,o),E(Xe.$$.fragment,o),E(pe.$$.fragment,o),E(Ke.$$.fragment,o),uo=!1},d(o){t(m),o&&t(q),o&&t(g),b(j),o&&t(no),o&&t(J),b(he),o&&t(so),o&&t(u),o&&t(ao),o&&t(te),o&&t(ro),o&&t(H),b(ue),o&&t(io),o&&t(w),b(ge),b(_e),b(ve),b(Te),o&&t(lo),o&&t(G),b(be),o&&t(co),o&&t(P),b(je),b(we),b(ke),o&&t(po),o&&t(X),b(De),o&&t(mo),o&&t(y),b($e),b(Ae),b(de),b(qe),o&&t(ho),o&&t(Q),b(Le),o&&t(fo),o&&t(f),b(Se),b(Xe),b(pe),b(Ke)}}}const Zr={local:"visiontextdualencoder",sections:[{local:"overview",title:"Overview"},{local:"transformers.VisionTextDualEncoderConfig",title:"VisionTextDualEncoderConfig"},{local:"transformers.VisionTextDualEncoderProcessor",title:"VisionTextDualEncoderProcessor"},{local:"transformers.VisionTextDualEncoderModel",title:"VisionTextDualEncoderModel"},{local:"transformers.FlaxVisionTextDualEncoderModel",title:"FlaxVisionTextDualEncoderModel"}],title:"VisionTextDualEncoder"};function Gr(et){return Rr(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ti extends Nr{constructor(m){super();Br(this,m,Gr,Hr,Or,{})}}export{ti as default,Zr as metadata};
