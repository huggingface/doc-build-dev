import{S as r1,i as a1,s as i1,e as n,k as l,w as g,t as a,M as l1,c as s,d as o,m as d,a as r,x as _,h as i,b as c,F as e,g as m,y as v,q as P,o as T,B as I}from"../../chunks/vendor-4833417e.js";import{T as ce}from"../../chunks/Tip-fffd6df1.js";import{D as w}from"../../chunks/Docstring-4f315ed9.js";import{C as O}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as D}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function d1(x){let p,L,u,b,C;return{c(){p=n("p"),L=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),b=a("Module"),C=a(`
...
`),qe=s(Ae,"CODE",{});var rr=r(qe);_e=i(rr,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),rr.forEach(o),Ae.forEach(o),De.forEach(o)},m($,j){m($,p,j),e(p,L),m($,u,j),m($,b,j),e(b,C),e(C,y),e(b,f),e(b,k),e(k,Ho),m($,at,j),m($,M,j),e(M,ue),e(M,ye),e(ye,be),e(M,Ko),e(M,Ce),e(Ce,Go),e(M,Xt),m($,pe,j),m($,Me,j),e(Me,Le),m($,Zt,j),m($,H,j),e(H,he),e(he,je),e(he,it),e(it,Qt),e(he,Fe),e(he,ke),e(ke,Jo),e(H,Yt),e(H,A),e(A,ge),e(A,we),e(we,$e),e(A,Xo),e(A,xe),e(xe,Zo),e(H,eo),e(H,me),e(me,Qo),e(me,qe),e(qe,_e)},d($){$&&o(p),$&&o(u),$&&o(b),$&&o(at),$&&o(M),$&&o(pe),$&&o(Me),$&&o(Zt),$&&o(H)}}}function u1(x){let p,L,u,b,C;return{c(){p=n("p"),L=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),b=a("Module"),C=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=r(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var k=r(u);b=i(k,"Module"),k.forEach(o),C=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=r(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var k=r(u);b=i(k,"Module"),k.forEach(o),C=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){m(y,p,f),e(p,L),e(p,u),e(u,b),e(p,C)},d(y){y&&o(p)}}}function b1(x){let p,L,u,b,C,y,f,k,Ho,at,M,ue,ye,be,Ko,Ce,Go,Xt,pe,Me,Le,Zt,H,he,je,it,Qt,Fe,ke,Jo,Yt,A,ge,we,$e,Xo,xe,Zo,eo,me,Qo,qe,_e,$,j,to,Qs,Yo,E,Ys,lt,er,De,ve,tr,or,Pe,nr,sr,Ae,rr,xd,ar,Ed,zd,ir,Md,jd,nl,en,sl,Oe,Fd,tn,qd,Dd,on,Ad,Od,rl,dt,oo,pa,nn,Nd,ha,Vd,al,fe,sn,Sd,no,lr,Wd,Bd,dr,Ud,Rd,Hd,ct,Kd,cr,Gd,Jd,pr,Xd,Zd,Qd,so,rn,Yd,an,ec,hr,tc,oc,il,pt,ro,ma,ln,nc,fa,sc,ll,V,dn,rc,ht,ac,mr,ic,lc,cn,dc,cc,pc,mt,hc,fr,mc,fc,ur,uc,gc,_c,ua,vc,Pc,pn,dl,ft,ao,ga,hn,Tc,_a,Ic,cl,S,mn,yc,ut,bc,gr,Cc,Lc,fn,kc,wc,$c,gt,xc,_r,Ec,zc,vr,Mc,jc,Fc,va,qc,Dc,un,pl,_t,io,Pa,gn,Ac,Ta,Oc,hl,F,_n,Nc,Ia,Vc,Sc,vn,Wc,Pr,Bc,Uc,Rc,Te,Pn,Hc,ya,Kc,Gc,ba,Tr,Jc,Ca,Xc,Zc,La,Qc,Yc,lo,Tn,ep,In,tp,ka,op,np,sp,co,yn,rp,wa,ap,ip,Ir,bn,ml,vt,po,$a,Cn,lp,xa,dp,fl,W,Ln,cp,kn,pp,Ea,hp,mp,fp,wn,up,yr,gp,_p,vp,Ie,$n,Pp,za,Tp,Ip,Ma,br,yp,ja,bp,Cp,Fa,Lp,kp,ho,xn,wp,qa,$p,ul,Pt,mo,Da,En,xp,Aa,Ep,gl,B,zn,zp,Oa,Mp,jp,Mn,Fp,Cr,qp,Dp,Ap,fo,jn,Op,Fn,Np,Na,Vp,Sp,Wp,uo,qn,Bp,Tt,Up,Va,Rp,Hp,Sa,Kp,Gp,_l,It,go,Wa,Dn,Jp,Ba,Xp,vl,U,An,Zp,Ua,Qp,Yp,K,Lr,eh,th,kr,oh,nh,wr,sh,rh,Ra,ah,ih,$r,lh,dh,ch,_o,On,ph,Nn,hh,xr,mh,fh,uh,vo,Vn,gh,Sn,_h,Er,vh,Ph,Pl,yt,Po,Ha,Wn,Th,Ka,Ih,Tl,R,Bn,yh,Un,bh,Rn,Ch,Lh,kh,G,Hn,wh,bt,$h,zr,xh,Eh,Ga,zh,Mh,jh,To,Fh,Ja,qh,Dh,Kn,Ah,J,Gn,Oh,Ct,Nh,Mr,Vh,Sh,Xa,Wh,Bh,Uh,Io,Rh,Za,Hh,Kh,Jn,Gh,X,Xn,Jh,Lt,Xh,jr,Zh,Qh,Qa,Yh,em,tm,yo,om,Ya,nm,sm,Zn,Il,kt,bo,ei,Qn,rm,ti,am,yl,wt,Yn,im,Z,es,lm,$t,dm,Fr,cm,pm,oi,hm,mm,fm,Co,um,ni,gm,_m,ts,bl,xt,Lo,si,os,vm,ri,Pm,Cl,Et,ns,Tm,Q,ss,Im,zt,ym,qr,bm,Cm,ai,Lm,km,wm,ko,$m,ii,xm,Em,rs,Ll,Mt,wo,li,as,zm,di,Mm,kl,q,is,jm,ls,Fm,Dr,qm,Dm,Am,ds,Om,cs,Nm,Vm,Sm,$o,Wm,Y,ps,Bm,jt,Um,Ar,Rm,Hm,ci,Km,Gm,Jm,xo,Xm,pi,Zm,Qm,hs,Ym,ee,ms,ef,Ft,tf,Or,of,nf,hi,sf,rf,af,Eo,lf,mi,df,cf,fs,pf,te,us,hf,qt,mf,Nr,ff,uf,fi,gf,_f,vf,zo,Pf,ui,Tf,If,gs,wl,Dt,Mo,gi,_s,yf,_i,bf,$l,At,vs,Cf,oe,Ps,Lf,Ot,kf,Vr,wf,$f,vi,xf,Ef,zf,jo,Mf,Pi,jf,Ff,Ts,xl,Nt,Fo,Ti,Is,qf,Ii,Df,El,Vt,ys,Af,ne,bs,Of,St,Nf,Sr,Vf,Sf,yi,Wf,Bf,Uf,qo,Rf,bi,Hf,Kf,Cs,zl,Wt,Do,Ci,Ls,Gf,Li,Jf,Ml,z,ks,Xf,ws,Zf,Wr,Qf,Yf,eu,$s,tu,xs,ou,nu,su,ki,ru,au,Ee,wi,Es,iu,lu,$i,zs,du,cu,xi,Ms,pu,hu,Ei,js,mu,fu,se,Fs,uu,Bt,gu,zi,_u,vu,Mi,Pu,Tu,Iu,Ao,yu,ji,bu,Cu,qs,Lu,Ne,Ds,ku,Fi,wu,$u,As,xu,Ve,Os,Eu,qi,zu,Mu,Ns,jl,Ut,Oo,Di,Vs,ju,Ai,Fu,Fl,Rt,Ss,qu,re,Ws,Du,Ht,Au,Oi,Ou,Nu,Ni,Vu,Su,Wu,No,Bu,Vi,Uu,Ru,Bs,ql,Kt,Vo,Si,Us,Hu,Wi,Ku,Dl,Gt,Rs,Gu,ae,Hs,Ju,Jt,Xu,Bi,Zu,Qu,Ui,Yu,eg,tg,So,og,Ri,ng,sg,Ks,Al;return y=new D({}),be=new D({}),$e=new D({}),en=new O({props:{code:`from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = logits_per_image.softmax(dim=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),nn=new D({}),sn=new w({props:{name:"class transformers.CLIPConfig",anchor:"transformers.CLIPConfig",parameters:[{name:"text_config_dict",val:" = None"},{name:"vision_config_dict",val:" = None"},{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/configuration_clip.py#L209",parametersDescription:[{anchor:"transformers.CLIPConfig.text_config_dict",description:`<strong>text_config_dict</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
Dictionary of configuration options used to initialize <a href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.CLIPTextConfig">CLIPTextConfig</a>.`,name:"text_config_dict"},{anchor:"transformers.CLIPConfig.vision_config_dict",description:`<strong>vision_config_dict</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
...
testing).`,name:"initializer_factor"}]}}),pn=new O({props:{code:`from transformers import CLIPTextModel, CLIPTextConfig
...
A factor for initializing all weight matrices (should be kept to 1, used internally for initialization
testing).`,name:"initializer_factor"}]}}),un=new O({props:{code:`from transformers import CLIPVisionModel, CLIPVisionConfig
...
The filter to user for resampling.`,name:"resample"}]}}),Dn=new D({}),An=new w({props:{name:"class transformers.CLIPProcessor",anchor:"transformers.CLIPProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/processing_clip.py#L22",parametersDescription:[{anchor:"transformers.CLIPProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>) &#x2014;
The feature extractor is a required input.`,name:"feature_extractor"},{anchor:"transformers.CLIPProcessor.tokenizer",description:`<strong>tokenizer</strong> (<a href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.CLIPTokenizerFast">CLIPTokenizerFast</a>) &#x2014;
The tokenizer is a required input.`,name:"tokenizer"}]}}),On=new w({props:{name:"batch_decode",anchor:"transformers.CLIPProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/processing_clip.py#L95"}}),Vn=new w({props:{name:"decode",anchor:"transformers.CLIPProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/processing_clip.py#L102"}}),Wn=new D({}),Bn=new w({props:{name:"class transformers.CLIPModel",anchor:"transformers.CLIPModel",parameters:[{name:"config",val:": CLIPConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/modeling_clip.py#L842",parametersDescription:[{anchor:"transformers.CLIPModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.CLIPConfig">CLIPConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16106/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Hn=new w({props:{name:"forward",anchor:"transformers.CLIPModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"return_loss",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = False"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/modeling_clip.py#L957",parametersDescription:[{anchor:"transformers.CLIPModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<a href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See <code>CLIPFeatureExtractor.__call__()</code>for details.`,name:"pixel_values"},{anchor:"transformers.CLIPModel.forward.return_loss",description:`<strong>return_loss</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
`}}),To=new ce({props:{$$slots:{default:[d1]},$$scope:{ctx:x}}}),Kn=new O({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, CLIPModel
...
`}}),Io=new ce({props:{$$slots:{default:[c1]},$$scope:{ctx:x}}}),Jn=new O({props:{code:`from transformers import CLIPTokenizer, CLIPModel
...
`}}),yo=new ce({props:{$$slots:{default:[p1]},$$scope:{ctx:x}}}),Zn=new O({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, CLIPModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>image_features = model.get_image_features(**inputs)`}}),Qn=new D({}),Yn=new w({props:{name:"class transformers.CLIPTextModel",anchor:"transformers.CLIPTextModel",parameters:[{name:"config",val:": CLIPTextConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/modeling_clip.py#L678"}}),es=new w({props:{name:"forward",anchor:"transformers.CLIPTextModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/modeling_clip.py#L693",parametersDescription:[{anchor:"transformers.CLIPTextModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_16106/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16106/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Co=new ce({props:{$$slots:{default:[h1]},$$scope:{ctx:x}}}),ts=new O({props:{code:`from transformers import CLIPTokenizer, CLIPTextModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>pooled_output = outputs.pooler_output  <span class="hljs-comment"># pooled (EOS token) states</span>`}}),os=new D({}),ns=new w({props:{name:"class transformers.CLIPVisionModel",anchor:"transformers.CLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/modeling_clip.py#L789"}}),ss=new w({props:{name:"forward",anchor:"transformers.CLIPVisionModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/modeling_clip.py#L802",parametersDescription:[{anchor:"transformers.CLIPVisionModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
<p><a
  href="/docs/transformers/pr_16106/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),ko=new ce({props:{$$slots:{default:[m1]},$$scope:{ctx:x}}}),rs=new O({props:{code:`from PIL import Image
import requests
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See
...
<li><strong>text_embeds(<code>tf.Tensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.TFCLIPTextModel"
...
<a
  href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.TFCLIPVisionModel"
...
`}}),xo=new ce({props:{$$slots:{default:[u1]},$$scope:{ctx:x}}}),hs=new O({props:{code:`import tensorflow as tf
...
`}}),Eo=new ce({props:{$$slots:{default:[g1]},$$scope:{ctx:x}}}),fs=new O({props:{code:`from transformers import CLIPTokenizer, TFCLIPModel
...
`}}),zo=new ce({props:{$$slots:{default:[_1]},$$scope:{ctx:x}}}),gs=new O({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, TFCLIPModel
...
`}}),jo=new ce({props:{$$slots:{default:[v1]},$$scope:{ctx:x}}}),Ts=new O({props:{code:`from transformers import CLIPTokenizer, TFCLIPTextModel
...
<p><a
  href="/docs/transformers/pr_16106/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
>transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling</a> or <code>tuple(tf.Tensor)</code></p>
`}}),qo=new ce({props:{$$slots:{default:[P1]},$$scope:{ctx:x}}}),Cs=new O({props:{code:`from PIL import Image
import requests
...
`}}),Ao=new ce({props:{$$slots:{default:[T1]},$$scope:{ctx:x}}}),qs=new O({props:{code:`import jax
from PIL import Image
import requests
...
`}}),As=new O({props:{code:`from transformers import CLIPTokenizer, FlaxCLIPModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text_features = model.get_text_features(**inputs)`}}),Os=new w({props:{name:"get_image_features",anchor:"transformers.FlaxCLIPPreTrainedModel.get_image_features",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16106/src/transformers/models/clip/modeling_flax_clip.py#L849",parametersDescription:[{anchor:"transformers.FlaxCLIPPreTrainedModel.get_image_features.pixel_values",description:`<strong>pixel_values</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained
using <a href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See <code>CLIPFeatureExtractor.__call__()</code>for details.`,name:"pixel_values"}],returnDescription:`
<p>The image embeddings obtained by
applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_16106/en/model_doc/clip#transformers.FlaxCLIPVisionModel"
...
`}}),Ns=new O({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, FlaxCLIPModel
...
`}}),No=new ce({props:{$$slots:{default:[I1]},$$scope:{ctx:x}}}),Bs=new O({props:{code:`from transformers import CLIPTokenizer, FlaxCLIPTextModel
...
<p><a
  href="/docs/transformers/pr_16106/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),So=new ce({props:{$$slots:{default:[y1]},$$scope:{ctx:x}}}),Ks=new O({props:{code:`from PIL import Image
import requests
...
`),ar=n("a"),Ed=a("CLIPProcessor"),zd=a(" and "),ir=n("a"),Md=a("CLIPModel"),jd=a("."),nl=l(),g(en.$$.fragment),sl=l(),Oe=n("p"),Fd=a("This model was contributed by "),tn=n("a"),qd=a("valhalla"),Dd=a(". The original code can be found "),on=n("a"),Ad=a("here"),Od=a("."),rl=l(),dt=n("h2"),oo=n("a"),pa=n("span"),g(nn.$$.fragment),Nd=l(),ha=n("span"),Vd=a("CLIPConfig"),al=l(),fe=n("div"),g(sn.$$.fragment),Sd=l(),no=n("p"),lr=n("a"),Wd=a("CLIPConfig"),Bd=a(" is the configuration class to store the configuration of a "),dr=n("a"),Ud=a("CLIPModel"),Rd=a(`. It is used to instantiate
...
zeros is returned.`),ul=l(),Pt=n("h2"),mo=n("a"),Da=n("span"),g(En.$$.fragment),xp=l(),Aa=n("span"),Ep=a("CLIPFeatureExtractor"),gl=l(),B=n("div"),g(zn.$$.fragment),zp=l(),Oa=n("p"),Mp=a("Constructs a CLIP feature extractor."),jp=l(),Mn=n("p"),Fp=a("This feature extractor inherits from "),Cr=n("a"),qp=a("FeatureExtractionMixin"),Dp=a(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Ap=l(),fo=n("div"),g(jn.$$.fragment),Op=l(),Fn=n("p"),Np=a("Crops "),Na=n("code"),Vp=a("image"),Sp=a(` to the given size using a center crop. Note that if the image is too small to be cropped to the
...
`),Ra=n("code"),ah=a("__call__()"),ih=a("and "),$r=n("a"),lh=a("decode()"),dh=a(" for more information."),ch=l(),_o=n("div"),g(On.$$.fragment),ph=l(),Nn=n("p"),hh=a("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),xr=n("a"),mh=a("batch_decode()"),fh=a(`. Please
...
behavior.`),kh=l(),G=n("div"),g(Hn.$$.fragment),wh=l(),bt=n("p"),$h=a("The "),zr=n("a"),xh=a("CLIPModel"),Eh=a(" forward method, overrides the "),Ga=n("code"),zh=a("__call__"),Mh=a(" special method."),jh=l(),g(To.$$.fragment),Fh=l(),Ja=n("p"),qh=a("Examples:"),Dh=l(),g(Kn.$$.fragment),Ah=l(),J=n("div"),g(Gn.$$.fragment),Oh=l(),Ct=n("p"),Nh=a("The "),Mr=n("a"),Vh=a("CLIPModel"),Sh=a(" forward method, overrides the "),Xa=n("code"),Wh=a("__call__"),Bh=a(" special method."),Uh=l(),g(Io.$$.fragment),Rh=l(),Za=n("p"),Hh=a("Examples:"),Kh=l(),g(Jn.$$.fragment),Gh=l(),X=n("div"),g(Xn.$$.fragment),Jh=l(),Lt=n("p"),Xh=a("The "),jr=n("a"),Zh=a("CLIPModel"),Qh=a(" forward method, overrides the "),Qa=n("code"),Yh=a("__call__"),em=a(" special method."),tm=l(),g(yo.$$.fragment),om=l(),Ya=n("p"),nm=a("Examples:"),sm=l(),g(Zn.$$.fragment),Il=l(),kt=n("h2"),bo=n("a"),ei=n("span"),g(Qn.$$.fragment),rm=l(),ti=n("span"),am=a("CLIPTextModel"),yl=l(),wt=n("div"),g(Yn.$$.fragment),im=l(),Z=n("div"),g(es.$$.fragment),lm=l(),$t=n("p"),dm=a("The "),Fr=n("a"),cm=a("CLIPTextModel"),pm=a(" forward method, overrides the "),oi=n("code"),hm=a("__call__"),mm=a(" special method."),fm=l(),g(Co.$$.fragment),um=l(),ni=n("p"),gm=a("Examples:"),_m=l(),g(ts.$$.fragment),bl=l(),xt=n("h2"),Lo=n("a"),si=n("span"),g(os.$$.fragment),vm=l(),ri=n("span"),Pm=a("CLIPVisionModel"),Cl=l(),Et=n("div"),g(ns.$$.fragment),Tm=l(),Q=n("div"),g(ss.$$.fragment),Im=l(),zt=n("p"),ym=a("The "),qr=n("a"),bm=a("CLIPVisionModel"),Cm=a(" forward method, overrides the "),ai=n("code"),Lm=a("__call__"),km=a(" special method."),wm=l(),g(ko.$$.fragment),$m=l(),ii=n("p"),xm=a("Examples:"),Em=l(),g(rs.$$.fragment),Ll=l(),Mt=n("h2"),wo=n("a"),li=n("span"),g(as.$$.fragment),zm=l(),di=n("span"),Mm=a("TFCLIPModel"),kl=l(),q=n("div"),g(is.$$.fragment),jm=l(),ls=n("p"),Fm=a("This model inherits from "),Dr=n("a"),qm=a("TFPreTrainedModel"),Dm=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Am=l(),ds=n("p"),Om=a("This model is also a "),cs=n("a"),Nm=a("tf.keras.Model"),Vm=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sm=l(),g($o.$$.fragment),Wm=l(),Y=n("div"),g(ps.$$.fragment),Bm=l(),jt=n("p"),Um=a("The "),Ar=n("a"),Rm=a("TFCLIPModel"),Hm=a(" forward method, overrides the "),ci=n("code"),Km=a("__call__"),Gm=a(" special method."),Jm=l(),g(xo.$$.fragment),Xm=l(),pi=n("p"),Zm=a("Examples:"),Qm=l(),g(hs.$$.fragment),Ym=l(),ee=n("div"),g(ms.$$.fragment),ef=l(),Ft=n("p"),tf=a("The "),Or=n("a"),of=a("TFCLIPModel"),nf=a(" forward method, overrides the "),hi=n("code"),sf=a("__call__"),rf=a(" special method."),af=l(),g(Eo.$$.fragment),lf=l(),mi=n("p"),df=a("Examples:"),cf=l(),g(fs.$$.fragment),pf=l(),te=n("div"),g(us.$$.fragment),hf=l(),qt=n("p"),mf=a("The "),Nr=n("a"),ff=a("TFCLIPModel"),uf=a(" forward method, overrides the "),fi=n("code"),gf=a("__call__"),_f=a(" special method."),vf=l(),g(zo.$$.fragment),Pf=l(),ui=n("p"),Tf=a("Examples:"),If=l(),g(gs.$$.fragment),wl=l(),Dt=n("h2"),Mo=n("a"),gi=n("span"),g(_s.$$.fragment),yf=l(),_i=n("span"),bf=a("TFCLIPTextModel"),$l=l(),At=n("div"),g(vs.$$.fragment),Cf=l(),oe=n("div"),g(Ps.$$.fragment),Lf=l(),Ot=n("p"),kf=a("The "),Vr=n("a"),wf=a("TFCLIPTextModel"),$f=a(" forward method, overrides the "),vi=n("code"),xf=a("__call__"),Ef=a(" special method."),zf=l(),g(jo.$$.fragment),Mf=l(),Pi=n("p"),jf=a("Examples:"),Ff=l(),g(Ts.$$.fragment),xl=l(),Nt=n("h2"),Fo=n("a"),Ti=n("span"),g(Is.$$.fragment),qf=l(),Ii=n("span"),Df=a("TFCLIPVisionModel"),El=l(),Vt=n("div"),g(ys.$$.fragment),Af=l(),ne=n("div"),g(bs.$$.fragment),Of=l(),St=n("p"),Nf=a("The "),Sr=n("a"),Vf=a("TFCLIPVisionModel"),Sf=a(" forward method, overrides the "),yi=n("code"),Wf=a("__call__"),Bf=a(" special method."),Uf=l(),g(qo.$$.fragment),Rf=l(),bi=n("p"),Hf=a("Examples:"),Kf=l(),g(Cs.$$.fragment),zl=l(),Wt=n("h2"),Do=n("a"),Ci=n("span"),g(Ls.$$.fragment),Gf=l(),Li=n("span"),Jf=a("FlaxCLIPModel"),Ml=l(),z=n("div"),g(ks.$$.fragment),Xf=l(),ws=n("p"),Zf=a("This model inherits from "),Wr=n("a"),Qf=a("FlaxPreTrainedModel"),Yf=a(`. Check the superclass documentation for the generic methods the
...
classification. CLIP uses a ViT like transformer to get visual features and a causal language model to get the text
features. Both the text and visual features are then projected to a latent space with identical dimension. The dot
product between the projected image and text features is then used as a similar score.`),cg.forEach(o),qe=d(t),_e=s(t,"P",{});var Ol=r(_e);$=i(Ol,`To feed images to the Transformer encoder, each image is split into a sequence of fixed-size non-overlapping patches,
which are then linearly embedded. A [CLS] token is added to serve as representation of an entire image. The authors
also add absolute position embeddings, and feed the resulting sequence of vectors to a standard Transformer encoder.
The `),j=s(Ol,"A",{href:!0});var pg=r(j);to=i(pg,"CLIPFeatureExtractor"),pg.forEach(o),Qs=i(Ol," can be used to resize (or rescale) and normalize images for the model."),Ol.forEach(o),Yo=d(t),E=s(t,"P",{});var ie=r(E);Ys=i(ie,"The "),lt=s(ie,"A",{href:!0});var hg=r(lt);er=i(hg,"CLIPTokenizer"),hg.forEach(o),De=i(ie," is used to encode the text. The "),ve=s(ie,"A",{href:!0});var mg=r(ve);tr=i(mg,"CLIPProcessor"),mg.forEach(o),or=i(ie,` wraps
...
encode the text and prepare the images. The following example shows how to get the image-text similarity scores using
`),ar=s(ie,"A",{href:!0});var gg=r(ar);Ed=i(gg,"CLIPProcessor"),gg.forEach(o),zd=i(ie," and "),ir=s(ie,"A",{href:!0});var _g=r(ir);Md=i(_g,"CLIPModel"),_g.forEach(o),jd=i(ie,"."),ie.forEach(o),nl=d(t),_(en.$$.fragment,t),sl=d(t),Oe=s(t,"P",{});var Br=r(Oe);Fd=i(Br,"This model was contributed by "),tn=s(Br,"A",{href:!0,rel:!0});var vg=r(tn);qd=i(vg,"valhalla"),vg.forEach(o),Dd=i(Br,". The original code can be found "),on=s(Br,"A",{href:!0,rel:!0});var Pg=r(on);Ad=i(Pg,"here"),Pg.forEach(o),Od=i(Br,"."),Br.forEach(o),rl=d(t),dt=s(t,"H2",{class:!0});var Nl=r(dt);oo=s(Nl,"A",{id:!0,class:!0,href:!0});var Tg=r(oo);pa=s(Tg,"SPAN",{});var Ig=r(pa);_(nn.$$.fragment,Ig),Ig.forEach(o),Tg.forEach(o),Nd=d(Nl),ha=s(Nl,"SPAN",{});var yg=r(ha);Vd=i(yg,"CLIPConfig"),yg.forEach(o),Nl.forEach(o),al=d(t),fe=s(t,"DIV",{class:!0});var Wo=r(fe);_(sn.$$.fragment,Wo),Sd=d(Wo),no=s(Wo,"P",{});var ol=r(no);lr=s(ol,"A",{href:!0});var bg=r(lr);Wd=i(bg,"CLIPConfig"),bg.forEach(o),Bd=i(ol," is the configuration class to store the configuration of a "),dr=s(ol,"A",{href:!0});var Cg=r(dr);Ud=i(Cg,"CLIPModel"),Cg.forEach(o),Rd=i(ol,`. It is used to instantiate
...
documentation from `),vr=s(Gr,"A",{href:!0});var Wg=r(vr);Mc=i(Wg,"PretrainedConfig"),Wg.forEach(o),jc=i(Gr," for more information."),Gr.forEach(o),Fc=d(We),va=s(We,"P",{});var Bg=r(va);qc=i(Bg,"Example:"),Bg.forEach(o),Dc=d(We),_(un.$$.fragment,We),We.forEach(o),pl=d(t),_t=s(t,"H2",{class:!0});var Ul=r(_t);io=s(Ul,"A",{id:!0,class:!0,href:!0});var Ug=r(io);Pa=s(Ug,"SPAN",{});var Rg=r(Pa);_(gn.$$.fragment,Rg),Rg.forEach(o),Ug.forEach(o),Ac=d(Ul),Ta=s(Ul,"SPAN",{});var Hg=r(Ta);Oc=i(Hg,"CLIPTokenizer"),Hg.forEach(o),Ul.forEach(o),hl=d(t),F=s(t,"DIV",{class:!0});var le=r(F);_(_n.$$.fragment,le),Nc=d(le),Ia=s(le,"P",{});var Kg=r(Ia);Vc=i(Kg,"Construct a CLIP tokenizer. Based on byte-level Byte-Pair-Encoding."),Kg.forEach(o),Sc=d(le),vn=s(le,"P",{});var Rl=r(vn);Wc=i(Rl,"This tokenizer inherits from "),Pr=s(Rl,"A",{href:!0});var Gg=r(Pr);Bc=i(Gg,"PreTrainedTokenizer"),Gg.forEach(o),Uc=i(Rl,` which contains most of the main methods. Users should refer to
