import{S as Gr,i as Br,s as Wr,e as n,k as c,w as M,t as r,M as Hr,c as s,d as o,m as p,a,x as v,h as i,b as l,G as e,g as u,y as b,q as y,o as T,B as w,v as Ur,L as nn}from"../../chunks/vendor-hf-doc-builder.js";import{T as Nr}from"../../chunks/Tip-hf-doc-builder.js";import{D as B}from"../../chunks/Docstring-hf-doc-builder.js";import{C as qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as at}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as on}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vr(E){let m,$,g,f,k;return f=new qt({props:{code:`from transformers import M2M100Model, M2M100Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){m=n("p"),$=r("Translation example:"),g=c(),M(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Translation example:"),_.forEach(o),g=p(d),v(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),b(f,d,_),k=!0},p:nn,i(d){k||(y(f.$$.fragment,d),k=!0)},o(d){T(f.$$.fragment,d),k=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Qr(E){let m,$,g,f,k,d,_,I,sn,fo,W,Y,xt,be,an,Et,rn,_o,ee,dn,ye,ln,cn,go,rt,pn,ko,it,Ct,hn,Mo,te,mn,Te,un,fn,vo,H,oe,jt,we,_n,Pt,gn,bo,O,kn,Ft,Mn,vn,Ot,bn,yn,St,Tn,wn,yo,C,$n,dt,zn,qn,At,xn,En,Dt,Cn,jn,Lt,Pn,Fn,To,lt,It,On,wo,$e,$o,ct,ze,Nt,Sn,An,x,Dn,Gt,Ln,In,Bt,Nn,Gn,Wt,Bn,Wn,Ht,Hn,Un,Ut,Vn,Xn,zo,qe,qo,U,ne,Vt,xe,Rn,Xt,Jn,xo,j,Ee,Kn,V,Zn,pt,Qn,Yn,Ce,es,ts,os,X,ns,ht,ss,as,mt,rs,is,ds,se,Eo,R,ae,Rt,je,ls,Jt,cs,Co,z,Pe,ps,Fe,hs,Oe,ms,us,fs,Se,_s,ut,gs,ks,Ms,re,vs,S,Ae,bs,De,ys,Kt,Ts,ws,$s,Le,Ie,Zt,zs,qs,Qt,xs,Es,Ne,Yt,Cs,js,eo,Ps,Fs,to,Os,Ss,ie,Ge,As,Be,Ds,oo,Ls,Is,Ns,N,We,Gs,ft,Bs,_t,Ws,Hs,no,Us,Vs,gt,He,jo,J,de,so,Ue,Xs,ao,Rs,Po,P,Ve,Js,Xe,Ks,kt,Zs,Qs,Ys,Re,ea,Je,ta,oa,na,A,Ke,sa,K,aa,Mt,ra,ia,ro,da,la,ca,le,pa,ce,Fo,Z,pe,io,Ze,ha,lo,ma,Oo,F,Qe,ua,Ye,fa,vt,_a,ga,ka,et,Ma,tt,va,ba,ya,D,ot,Ta,Q,wa,bt,$a,za,co,qa,xa,Ea,he,Ca,me,So;return d=new at({}),be=new at({}),we=new at({}),$e=new qt({props:{code:`
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17888/en/model_doc/m2m_100#transformers.M2M100Model">M2M100Model</a> or`,name:"vocab_size"},{anchor:"transformers.M2M100Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/m2m_100/configuration_m2m_100.py#L34"}}),se=new on({props:{anchor:"transformers.M2M100Config.example",$$slots:{default:[Vr]},$$scope:{ctx:E}}}),je=new at({}),Pe=new B({props:{name:"class transformers.M2M100Tokenizer",anchor:"transformers.M2M100Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"spm_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"unk_token",val:" = '<unk>'"},{name:"language_codes",val:" = 'm2m100'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"num_madeup_words",val:" = 8"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/m2m_100/tokenization_m2m_100.py#L65"}}),re=new on({props:{anchor:"transformers.M2M100Tokenizer.example",$$slots:{default:[Xr]},$$scope:{ctx:E}}}),Ae=new B({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/m2m_100/tokenization_m2m_100.py#L258",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_17888/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/m2m_100/modeling_m2m_100.py#L1157",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17888/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17888/en/model_doc/m2m_100#transformers.M2M100Config"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/m2m_100/modeling_m2m_100.py#L1279",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17888/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),he=new Nr({props:{$$slots:{default:[Kr]},$$scope:{ctx:E}}}),me=new on({props:{anchor:"transformers.M2M100ForConditionalGeneration.forward.example",$$slots:{default:[Zr]},$$scope:{ctx:E}}}),{c(){m=n("meta"),$=c(),g=n("h1"),f=n("a"),k=n("span"),M(d.$$.fragment),_=c(),I=n("span"),sn=r("M2M100"),fo=c(),W=n("h2"),Y=n("a"),xt=n("span"),M(be.$$.fragment),an=c(),Et=n("span"),rn=r("Overview"),_o=c(),ee=n("p"),dn=r("The M2M100 model was proposed in "),ye=n("a"),ln=r("Beyond English-Centric Multilingual Machine Translation"),cn=r(` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
...
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),Mo=c(),te=n("p"),mn=r("This model was contributed by "),Te=n("a"),un=r("valhalla"),fn=r("."),vo=c(),H=n("h3"),oe=n("a"),jt=n("span"),M(we.$$.fragment),_n=c(),Pt=n("span"),gn=r("Training and Generation"),bo=c(),O=n("p"),kn=r(`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),Ft=n("code"),Mn=r("[lang_code] X [eos]"),vn=r(", where "),Ot=n("code"),bn=r("lang_code"),yn=r(` is source language
...
documentation from `),mt=n("a"),rs=r("PretrainedConfig"),is=r(" for more information."),ds=c(),M(se.$$.fragment),Eo=c(),R=n("h2"),ae=n("a"),Rt=n("span"),M(je.$$.fragment),ls=c(),Jt=n("span"),cs=r("M2M100Tokenizer"),Co=c(),z=n("div"),M(Pe.$$.fragment),ps=c(),Fe=n("p"),hs=r("Construct an M2M100 tokenizer. Based on "),Oe=n("a"),ms=r("SentencePiece"),us=r("."),fs=c(),Se=n("p"),_s=r("This tokenizer inherits from "),ut=n("a"),gs=r("PreTrainedTokenizer"),ks=r(` which contains most of the main methods. Users should refer to
...
and behavior.`),na=c(),A=n("div"),M(Ke.$$.fragment),sa=c(),K=n("p"),aa=r("The "),Mt=n("a"),ra=r("M2M100Model"),ia=r(" forward method, overrides the "),ro=n("code"),da=r("__call__"),la=r(" special method."),ca=c(),M(le.$$.fragment),pa=c(),M(ce.$$.fragment),Fo=c(),Z=n("h2"),pe=n("a"),io=n("span"),M(Ze.$$.fragment),ha=c(),lo=n("span"),ma=r("M2M100ForConditionalGeneration"),Oo=c(),F=n("div"),M(Qe.$$.fragment),ua=c(),Ye=n("p"),fa=r(`The M2M100 Model with a language modeling head. Can be used for summarization.
...
to create high quality models. Our focus on non-English-Centric models brings gains of more than 10 BLEU when directly
translating between non-English directions while performing competitively to the best single systems of WMT. We
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),Da.forEach(o),Aa.forEach(o),Mo=p(t),te=s(t,"P",{});var Do=a(te);mn=i(Do,"This model was contributed by "),Te=s(Do,"A",{href:!0,rel:!0});var La=a(Te);un=i(La,"valhalla"),La.forEach(o),fn=i(Do,"."),Do.forEach(o),vo=p(t),H=s(t,"H3",{class:!0});var Lo=a(H);oe=s(Lo,"A",{id:!0,class:!0,href:!0});var Ia=a(oe);jt=s(Ia,"SPAN",{});var Na=a(jt);v(we.$$.fragment,Na),Na.forEach(o),Ia.forEach(o),_n=p(Lo),Pt=s(Lo,"SPAN",{});var Ga=a(Pt);gn=i(Ga,"Training and Generation"),Ga.forEach(o),Lo.forEach(o),bo=p(t),O=s(t,"P",{});var ue=a(O);kn=i(ue,`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),Ft=s(ue,"CODE",{});var Ba=a(Ft);Mn=i(Ba,"[lang_code] X [eos]"),Ba.forEach(o),vn=i(ue,", where "),Ot=s(ue,"CODE",{});var Wa=a(Ot);bn=i(Wa,"lang_code"),Wa.forEach(o),yn=i(ue,` is source language
...
documentation from `),mt=s(Tt,"A",{href:!0});var cr=a(mt);rs=i(cr,"PretrainedConfig"),cr.forEach(o),is=i(Tt," for more information."),Tt.forEach(o),ds=p(fe),v(se.$$.fragment,fe),fe.forEach(o),Eo=p(t),R=s(t,"H2",{class:!0});var Go=a(R);ae=s(Go,"A",{id:!0,class:!0,href:!0});var pr=a(ae);Rt=s(pr,"SPAN",{});var hr=a(Rt);v(je.$$.fragment,hr),hr.forEach(o),pr.forEach(o),ls=p(Go),Jt=s(Go,"SPAN",{});var mr=a(Jt);cs=i(mr,"M2M100Tokenizer"),mr.forEach(o),Go.forEach(o),Co=p(t),z=s(t,"DIV",{class:!0});var q=a(z);v(Pe.$$.fragment,q),ps=p(q),Fe=s(q,"P",{});var Bo=a(Fe);hs=i(Bo,"Construct an M2M100 tokenizer. Based on "),Oe=s(Bo,"A",{href:!0,rel:!0});var ur=a(Oe);ms=i(ur,"SentencePiece"),ur.forEach(o),us=i(Bo,"."),Bo.forEach(o),fs=p(q),Se=s(q,"P",{});var Wo=a(Se);_s=i(Wo,"This tokenizer inherits from "),ut=s(Wo,"A",{href:!0});var fr=a(ut);gs=i(fr,"PreTrainedTokenizer"),fr.forEach(o),ks=i(Wo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Wo.forEach(o),Ms=p(q),v(re.$$.fragment,q),vs=p(q),S=s(q,"DIV",{class:!0});var _e=a(S);v(Ae.$$.fragment,_e),bs=p(_e),De=s(_e,"P",{});var Ho=a(De);ys=i(Ho,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Kt=s(Ho,"CODE",{});var _r=a(Kt);Ts=i(_r,"X"),_r.forEach(o),ws=i(Ho," represents the sequence:"),Ho.forEach(o),$s=p(_e),Le=s(_e,"UL",{});var Uo=a(Le);Ie=s(Uo,"LI",{});var Vo=a(Ie);Zt=s(Vo,"CODE",{});var gr=a(Zt);zs=i(gr,"input_ids"),gr.forEach(o),qs=i(Vo," (for encoder) "),Qt=s(Vo,"CODE",{});var kr=a(Qt);xs=i(kr,"X [eos, src_lang_code]"),kr.forEach(o),Vo.forEach(o),Es=p(Uo),Ne=s(Uo,"LI",{});var Xo=a(Ne);Yt=s(Xo,"CODE",{});var Mr=a(Yt);Cs=i(Mr,"decoder_input_ids"),Mr.forEach(o),js=i(Xo,": (for decoder) "),eo=s(Xo,"CODE",{});var vr=a(eo);Ps=i(vr,"X [eos, tgt_lang_code]"),vr.forEach(o),Xo.forEach(o),Uo.forEach(o),Fs=p(_e),to=s(_e,"P",{});var br=a(to);Os=i(br,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),br.forEach(o),_e.forEach(o),Ss=p(q),ie=s(q,"DIV",{class:!0});var Ro=a(ie);v(Ge.$$.fragment,Ro),As=p(Ro),Be=s(Ro,"P",{});var Jo=a(Be);Ds=i(Jo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),oo=s(Jo,"CODE",{});var yr=a(oo);Ls=i(yr,"prepare_for_model"),yr.forEach(o),Is=i(Jo," method."),Jo.forEach(o),Ro.forEach(o),Ns=p(q),N=s(q,"DIV",{class:!0});var wt=a(N);v(We.$$.fragment,wt),Gs=p(wt),ft=s(wt,"P",{});var ja=a(ft);Bs=i(ja,"Create the token type IDs corresponding to the sequences passed. "),_t=s(ja,"A",{href:!0});var Tr=a(_t);Ws=i(Tr,`What are token type
IDs?`),Tr.forEach(o),ja.forEach(o),Hs=p(wt),no=s(wt,"P",{});var wr=a(no);Us=i(wr,"Should be overridden in a subclass if the model has a special way of building those."),wr.forEach(o),wt.forEach(o),Vs=p(q),gt=s(q,"DIV",{class:!0});var $r=a(gt);v(He.$$.fragment,$r),$r.forEach(o),q.forEach(o),jo=p(t),J=s(t,"H2",{class:!0});var Ko=a(J);de=s(Ko,"A",{id:!0,class:!0,href:!0});var zr=a(de);so=s(zr,"SPAN",{});var qr=a(so);v(Ue.$$.fragment,qr),qr.forEach(o),zr.forEach(o),Xs=p(Ko),ao=s(Ko,"SPAN",{});var xr=a(ao);Rs=i(xr,"M2M100Model"),xr.forEach(o),Ko.forEach(o),Po=p(t),P=s(t,"DIV",{class:!0});var ge=a(P);v(Ve.$$.fragment,ge),Js=p(ge),Xe=s(ge,"P",{});var Zo=a(Xe);Ks=i(Zo,`The bare M2M100 Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qo.forEach(o),na=p(ge),A=s(ge,"DIV",{class:!0});var ke=a(A);v(Ke.$$.fragment,ke),sa=p(ke),K=s(ke,"P",{});var $t=a(K);aa=i($t,"The "),Mt=s($t,"A",{href:!0});var jr=a(Mt);ra=i(jr,"M2M100Model"),jr.forEach(o),ia=i($t," forward method, overrides the "),ro=s($t,"CODE",{});var Pr=a(ro);da=i(Pr,"__call__"),Pr.forEach(o),la=i($t," special method."),$t.forEach(o),ca=p(ke),v(le.$$.fragment,ke),pa=p(ke),v(ce.$$.fragment,ke),ke.forEach(o),ge.forEach(o),Fo=p(t),Z=s(t,"H2",{class:!0});var Yo=a(Z);pe=s(Yo,"A",{id:!0,class:!0,href:!0});var Fr=a(pe);io=s(Fr,"SPAN",{});var Or=a(io);v(Ze.$$.fragment,Or),Or.forEach(o),Fr.forEach(o),ha=p(Yo),lo=s(Yo,"SPAN",{});var Sr=a(lo);ma=i(Sr,"M2M100ForConditionalGeneration"),Sr.forEach(o),Yo.forEach(o),Oo=p(t),F=s(t,"DIV",{class:!0});var Me=a(F);v(Qe.$$.fragment,Me),ua=p(Me),Ye=s(Me,"P",{});var en=a(Ye);fa=i(en,`The M2M100 Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tn.forEach(o),ya=p(Me),D=s(Me,"DIV",{class:!0});var ve=a(D);v(ot.$$.fragment,ve),Ta=p(ve),Q=s(ve,"P",{});var zt=a(Q);wa=i(zt,"The "),bt=s(zt,"A",{href:!0});var Lr=a(bt);$a=i(Lr,"M2M100ForConditionalGeneration"),Lr.forEach(o),za=i(zt," forward method, overrides the "),co=s(zt,"CODE",{});var Ir=a(co);qa=i(Ir,"__call__"),Ir.forEach(o),xa=i(zt," special method."),zt.forEach(o),Ea=p(ve),v(he.$$.fragment,ve),Ca=p(ve),v(me.$$.fragment,ve),ve.forEach(o),Me.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(Yr)),l(f,"id","m2m100"),l(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(f,"href","#m2m100"),l(g,"class","relative group"),l(Y,"id","overview"),l(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Y,"href","#overview"),l(W,"class","relative group"),l(ye,"href","https://arxiv.org/abs/2010.11125"),l(ye,"rel","nofollow"),l(Te,"href","https://huggingface.co/valhalla"),l(Te,"rel","nofollow"),l(oe,"id","training-and-generation"),l(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(oe,"href","#training-and-generation"),l(H,"class","relative group"),l(dt,"href","/docs/transformers/pr_17888/en/model_doc/m2m_100#transformers.M2M100Tokenizer"),l(ne,"id","transformers.M2M100Config"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.M2M100Config"),l(U,"class","relative group"),l(pt,"href","/docs/transformers/pr_17888/en/model_doc/m2m_100#transformers.M2M100Model"),l(Ce,"href","https://huggingface.co/facebook/m2m100_418M"),l(Ce,"rel","nofollow"),l(ht,"href","/docs/transformers/pr_17888/en/main_classes/configuration#transformers.PretrainedConfig"),l(mt,"href","/docs/transformers/pr_17888/en/main_classes/configuration#transformers.PretrainedConfig"),l(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ae,"id","transformers.M2M100Tokenizer"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.M2M100Tokenizer"),l(R,"class","relative group"),l(Oe,"href","https://github.com/google/sentencepiece"),l(Oe,"rel","nofollow"),l(ut,"href","/docs/transformers/pr_17888/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(_t,"href","../glossary#token-type-ids"),l(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(de,"id","transformers.M2M100Model"),l(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(de,"href","#transformers.M2M100Model"),l(J,"class","relative group"),l(kt,"href","/docs/transformers/pr_17888/en/main_classes/model#transformers.PreTrainedModel"),l(Je,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Je,"rel","nofollow"),l(Mt,"href","/docs/transformers/pr_17888/en/model_doc/m2m_100#transformers.M2M100Model"),l(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(pe,"id","transformers.M2M100ForConditionalGeneration"),l(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(pe,"href","#transformers.M2M100ForConditionalGeneration"),l(Z,"class","relative group"),l(vt,"href","/docs/transformers/pr_17888/en/main_classes/model#transformers.PreTrainedModel"),l(tt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(tt,"rel","nofollow"),l(bt,"href","/docs/transformers/pr_17888/en/model_doc/m2m_100#transformers.M2M100ForConditionalGeneration"),l(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,h){e(document.head,m),u(t,$,h),u(t,g,h),e(g,f),e(f,k),b(d,k,null),e(g,_),e(g,I),e(I,sn),u(t,fo,h),u(t,W,h),e(W,Y),e(Y,xt),b(be,xt,null),e(W,an),e(W,Et),e(Et,rn),u(t,_o,h),u(t,ee,h),e(ee,dn),e(ee,ye),e(ye,ln),e(ee,cn),u(t,go,h),u(t,rt,h),e(rt,pn),u(t,ko,h),u(t,it,h),e(it,Ct),e(Ct,hn),u(t,Mo,h),u(t,te,h),e(te,mn),e(te,Te),e(Te,un),e(te,fn),u(t,vo,h),u(t,H,h),e(H,oe),e(oe,jt),b(we,jt,null),e(H,_n),e(H,Pt),e(Pt,gn),u(t,bo,h),u(t,O,h),e(O,kn),e(O,Ft),e(Ft,Mn),e(O,vn),e(O,Ot),e(Ot,bn),e(O,yn),e(O,St),e(St,Tn),e(O,wn),u(t,yo,h),u(t,C,h),e(C,$n),e(C,dt),e(dt,zn),e(C,qn),e(C,At),e(At,xn),e(C,En),e(C,Dt),e(Dt,Cn),e(C,jn),e(C,Lt),e(Lt,Pn),e(C,Fn),u(t,To,h),u(t,lt,h),e(lt,It),e(It,On),u(t,wo,h),b($e,t,h),u(t,$o,h),u(t,ct,h),e(ct,ze),e(ze,Nt),e(Nt,Sn),e(ze,An),e(ze,x),e(x,Dn),e(x,Gt),e(Gt,Ln),e(x,In),e(x,Bt),e(Bt,Nn),e(x,Gn),e(x,Wt),e(Wt,Bn),e(x,Wn),e(x,Ht),e(Ht,Hn),e(x,Un),e(x,Ut),e(Ut,Vn),e(x,Xn),u(t,zo,h),b(qe,t,h),u(t,qo,h),u(t,U,h),e(U,ne),e(ne,Vt),b(xe,Vt,null),e(U,Rn),e(U,Xt),e(Xt,Jn),u(t,xo,h),u(t,j,h),b(Ee,j,null),e(j,Kn),e(j,V),e(V,Zn),e(V,pt),e(pt,Qn),e(V,Yn),e(V,Ce),e(Ce,es),e(V,ts),e(j,os),e(j,X),e(X,ns),e(X,ht),e(ht,ss),e(X,as),e(X,mt),e(mt,rs),e(X,is),e(j,ds),b(se,j,null),u(t,Eo,h),u(t,R,h),e(R,ae),e(ae,Rt),b(je,Rt,null),e(R,ls),e(R,Jt),e(Jt,cs),u(t,Co,h),u(t,z,h),b(Pe,z,null),e(z,ps),e(z,Fe),e(Fe,hs),e(Fe,Oe),e(Oe,ms),e(Fe,us),e(z,fs),e(z,Se),e(Se,_s),e(Se,ut),e(ut,gs),e(Se,ks),e(z,Ms),b(re,z,null),e(z,vs),e(z,S),b(Ae,S,null),e(S,bs),e(S,De),e(De,ys),e(De,Kt),e(Kt,Ts),e(De,ws),e(S,$s),e(S,Le),e(Le,Ie),e(Ie,Zt),e(Zt,zs),e(Ie,qs),e(Ie,Qt),e(Qt,xs),e(Le,Es),e(Le,Ne),e(Ne,Yt),e(Yt,Cs),e(Ne,js),e(Ne,eo),e(eo,Ps),e(S,Fs),e(S,to),e(to,Os),e(z,Ss),e(z,ie),b(Ge,ie,null),e(ie,As),e(ie,Be),e(Be,Ds),e(Be,oo),e(oo,Ls),e(Be,Is),e(z,Ns),e(z,N),b(We,N,null),e(N,Gs),e(N,ft),e(ft,Bs),e(ft,_t),e(_t,Ws),e(N,Hs),e(N,no),e(no,Us),e(z,Vs),e(z,gt),b(He,gt,null),u(t,jo,h),u(t,J,h),e(J,de),e(de,so),b(Ue,so,null),e(J,Xs),e(J,ao),e(ao,Rs),u(t,Po,h),u(t,P,h),b(Ve,P,null),e(P,Js),e(P,Xe),e(Xe,Ks),e(Xe,kt),e(kt,Zs),e(Xe,Qs),e(P,Ys),e(P,Re),e(Re,ea),e(Re,Je),e(Je,ta),e(Re,oa),e(P,na),e(P,A),b(Ke,A,null),e(A,sa),e(A,K),e(K,aa),e(K,Mt),e(Mt,ra),e(K,ia),e(K,ro),e(ro,da),e(K,la),e(A,ca),b(le,A,null),e(A,pa),b(ce,A,null),u(t,Fo,h),u(t,Z,h),e(Z,pe),e(pe,io),b(Ze,io,null),e(Z,ha),e(Z,lo),e(lo,ma),u(t,Oo,h),u(t,F,h),b(Qe,F,null),e(F,ua),e(F,Ye),e(Ye,fa),e(Ye,vt),e(vt,_a),e(Ye,ga),e(F,ka),e(F,et),e(et,Ma),e(et,tt),e(tt,va),e(et,ba),e(F,ya),e(F,D),b(ot,D,null),e(D,Ta),e(D,Q),e(Q,wa),e(Q,bt),e(bt,$a),e(Q,za),e(Q,co),e(co,qa),e(Q,xa),e(D,Ea),b(he,D,null),e(D,Ca),b(me,D,null),So=!0},p(t,[h]){const nt={};h&2&&(nt.$$scope={dirty:h,ctx:t}),se.$set(nt);const po={};h&2&&(po.$$scope={dirty:h,ctx:t}),re.$set(po);const ho={};h&2&&(ho.$$scope={dirty:h,ctx:t}),le.$set(ho);const mo={};h&2&&(mo.$$scope={dirty:h,ctx:t}),ce.$set(mo);const st={};h&2&&(st.$$scope={dirty:h,ctx:t}),he.$set(st);const uo={};h&2&&(uo.$$scope={dirty:h,ctx:t}),me.$set(uo)},i(t){So||(y(d.$$.fragment,t),y(be.$$.fragment,t),y(we.$$.fragment,t),y($e.$$.fragment,t),y(qe.$$.fragment,t),y(xe.$$.fragment,t),y(Ee.$$.fragment,t),y(se.$$.fragment,t),y(je.$$.fragment,t),y(Pe.$$.fragment,t),y(re.$$.fragment,t),y(Ae.$$.fragment,t),y(Ge.$$.fragment,t),y(We.$$.fragment,t),y(He.$$.fragment,t),y(Ue.$$.fragment,t),y(Ve.$$.fragment,t),y(Ke.$$.fragment,t),y(le.$$.fragment,t),y(ce.$$.fragment,t),y(Ze.$$.fragment,t),y(Qe.$$.fragment,t),y(ot.$$.fragment,t),y(he.$$.fragment,t),y(me.$$.fragment,t),So=!0)},o(t){T(d.$$.fragment,t),T(be.$$.fragment,t),T(we.$$.fragment,t),T($e.$$.fragment,t),T(qe.$$.fragment,t),T(xe.$$.fragment,t),T(Ee.$$.fragment,t),T(se.$$.fragment,t),T(je.$$.fragment,t),T(Pe.$$.fragment,t),T(re.$$.fragment,t),T(Ae.$$.fragment,t),T(Ge.$$.fragment,t),T(We.$$.fragment,t),T(He.$$.fragment,t),T(Ue.$$.fragment,t),T(Ve.$$.fragment,t),T(Ke.$$.fragment,t),T(le.$$.fragment,t),T(ce.$$.fragment,t),T(Ze.$$.fragment,t),T(Qe.$$.fragment,t),T(ot.$$.fragment,t),T(he.$$.fragment,t),T(me.$$.fragment,t),So=!1},d(t){o(m),t&&o($),t&&o(g),w(d),t&&o(fo),t&&o(W),w(be),t&&o(_o),t&&o(ee),t&&o(go),t&&o(rt),t&&o(ko),t&&o(it),t&&o(Mo),t&&o(te),t&&o(vo),t&&o(H),w(we),t&&o(bo),t&&o(O),t&&o(yo),t&&o(C),t&&o(To),t&&o(lt),t&&o(wo),w($e,t),t&&o($o),t&&o(ct),t&&o(zo),w(qe,t),t&&o(qo),t&&o(U),w(xe),t&&o(xo),t&&o(j),w(Ee),w(se),t&&o(Eo),t&&o(R),w(je),t&&o(Co),t&&o(z),w(Pe),w(re),w(Ae),w(Ge),w(We),w(He),t&&o(jo),t&&o(J),w(Ue),t&&o(Po),t&&o(P),w(Ve),w(Ke),w(le),w(ce),t&&o(Fo),t&&o(Z),w(Ze),t&&o(Oo),t&&o(F),w(Qe),w(ot),w(he),w(me)}}}const Yr={local:"m2m100",sections:[{local:"overview",sections:[{local:"training-and-generation",title:"Training and Generation"}],title:"Overview"},{local:"transformers.M2M100Config",title:"M2M100Config"},{local:"transformers.M2M100Tokenizer",title:"M2M100Tokenizer"},{local:"transformers.M2M100Model",title:"M2M100Model"},{local:"transformers.M2M100ForConditionalGeneration",title:"M2M100ForConditionalGeneration"}],title:"M2M100"};function ei(E){return Ur(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ii extends Gr{constructor(m){super();Br(this,m,ei,Qr,Wr,{})}}export{ii as default,Yr as metadata};
