import{S as tn,i as nn,s as on,e as o,k as p,w as M,t as i,M as sn,c as s,d as n,m as u,a as r,x as $,h as a,b as l,G as t,g as d,y as P,L as rn,q as A,o as N,B as I,v as an}from"../../chunks/vendor-hf-doc-builder.js";import{D as xt}from"../../chunks/Docstring-hf-doc-builder.js";import{C as en}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as qt}from"../../chunks/IconCopyLink-hf-doc-builder.js";function ln(zt){let k,fe,y,w,ae,U,We,le,Ke,ge,v,T,ce,S,Re,de,De,_e,f,Fe,W,Oe,Be,K,je,Xe,ke,V,Ce,ye,G,Ye,ve,J,pe,He,be,Q,Ve,we,R,Te,L,Ge,Z,Je,Qe,Le,D,xe,x,Ze,ee,et,tt,qe,g,nt,F,ot,st,O,rt,it,ze,b,q,ue,B,at,me,lt,Ee,m,j,ct,h,dt,te,pt,ut,ne,mt,ht,X,ft,gt,_t,C,kt,oe,yt,vt,bt,z,Y,wt,he,Tt,Lt,se,H,Me;return U=new qt({}),S=new qt({}),R=new en({props:{code:"",highlighted:`<span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> LukeModel

model = LukeModel.from_pretrained(<span class="hljs-string">&quot;studio-ousia/mluke-base&quot;</span>)`}}),D=new en({props:{code:"",highlighted:`<span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> MLukeTokenizer
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.MLukeTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17888/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17888/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/mluke/tokenization_mluke.py#L367",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17888/en/main_classes/tokenizer#transformers.BatchEncoding"
...
<p><a
  href="/docs/transformers/pr_17888/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/mluke/tokenization_mluke.py#L1495"}}),{c(){k=o("meta"),fe=p(),y=o("h1"),w=o("a"),ae=o("span"),M(U.$$.fragment),We=p(),le=o("span"),Ke=i("mLUKE"),ge=p(),v=o("h2"),T=o("a"),ce=o("span"),M(S.$$.fragment),Re=p(),de=o("span"),De=i("Overview"),_e=p(),f=o("p"),Fe=i("The mLUKE model was proposed in "),W=o("a"),Oe=i("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Be=i(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
knowledge more likely than using only word representations.`),be=p(),Q=o("p"),Ve=i("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),we=p(),M(R.$$.fragment),Te=p(),L=o("p"),Ge=i("Note that mLUKE has its own tokenizer, "),Z=o("a"),Je=i("MLukeTokenizer"),Qe=i(". You can initialize it as follows:"),Le=p(),M(D.$$.fragment),xe=p(),x=o("p"),Ze=i("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=o("a"),et=i("LUKE\u2019s documentation page"),tt=i(` for all
tips, code examples and notebooks.`),qe=p(),g=o("p"),nt=i("This model was contributed by "),F=o("a"),ot=i("ryo0634"),st=i(". The original code can be found "),O=o("a"),rt=i("here"),it=i("."),ze=p(),b=o("h2"),q=o("a"),ue=o("span"),M(B.$$.fragment),at=p(),me=o("span"),lt=i("MLukeTokenizer"),Ee=p(),m=o("div"),M(j.$$.fragment),ct=p(),h=o("p"),dt=i("Adapted from "),te=o("a"),pt=i("XLMRobertaTokenizer"),ut=i(" and "),ne=o("a"),mt=i("LukeTokenizer"),ht=i(`. Based on
...
this superclass for more information regarding those methods.`),bt=p(),z=o("div"),M(Y.$$.fragment),wt=p(),he=o("p"),Tt=i(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Lt=p(),se=o("div"),M(H.$$.fragment),this.h()},l(e){const c=sn('[data-svelte="svelte-1phssyn"]',document.head);k=s(c,"META",{name:!0,content:!0}),c.forEach(n),fe=u(e),y=s(e,"H1",{class:!0});var $e=r(y);w=s($e,"A",{id:!0,class:!0,href:!0});var Et=r(w);ae=s(Et,"SPAN",{});var Mt=r(ae);$(U.$$.fragment,Mt),Mt.forEach(n),Et.forEach(n),We=u($e),le=s($e,"SPAN",{});var $t=r(le);Ke=a($t,"mLUKE"),$t.forEach(n),$e.forEach(n),ge=u(e),v=s(e,"H2",{class:!0});var Pe=r(v);T=s(Pe,"A",{id:!0,class:!0,href:!0});var Pt=r(T);ce=s(Pt,"SPAN",{});var At=r(ce);$(S.$$.fragment,At),At.forEach(n),Pt.forEach(n),Re=u(Pe),de=s(Pe,"SPAN",{});var Nt=r(de);De=a(Nt,"Overview"),Nt.forEach(n),Pe.forEach(n),_e=u(e),f=s(e,"P",{});var re=r(f);Fe=a(re,"The mLUKE model was proposed in "),W=s(re,"A",{href:!0,rel:!0});var It=r(W);Oe=a(It,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),It.forEach(n),Be=a(re,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
tips, code examples and notebooks.`),Ne.forEach(n),qe=u(e),g=s(e,"P",{});var ie=r(g);nt=a(ie,"This model was contributed by "),F=s(ie,"A",{href:!0,rel:!0});var Bt=r(F);ot=a(Bt,"ryo0634"),Bt.forEach(n),st=a(ie,". The original code can be found "),O=s(ie,"A",{href:!0,rel:!0});var jt=r(O);rt=a(jt,"here"),jt.forEach(n),it=a(ie,"."),ie.forEach(n),ze=u(e),b=s(e,"H2",{class:!0});var Ie=r(b);q=s(Ie,"A",{id:!0,class:!0,href:!0});var Xt=r(q);ue=s(Xt,"SPAN",{});var Ct=r(ue);$(B.$$.fragment,Ct),Ct.forEach(n),Xt.forEach(n),at=u(Ie),me=s(Ie,"SPAN",{});var Yt=r(me);lt=a(Yt,"MLukeTokenizer"),Yt.forEach(n),Ie.forEach(n),Ee=u(e),m=s(e,"DIV",{class:!0});var _=r(m);$(j.$$.fragment,_),ct=u(_),h=s(_,"P",{});var E=r(h);dt=a(E,"Adapted from "),te=s(E,"A",{href:!0});var Ht=r(te);pt=a(Ht,"XLMRobertaTokenizer"),Ht.forEach(n),ut=a(E," and "),ne=s(E,"A",{href:!0});var Vt=r(ne);mt=a(Vt,"LukeTokenizer"),Vt.forEach(n),ht=a(E,`. Based on
`),X=s(E,"A",{href:!0,rel:!0});var Gt=r(X);ft=a(Gt,"SentencePiece"),Gt.forEach(n),gt=a(E,"."),E.forEach(n),_t=u(_),C=s(_,"P",{});var Ue=r(C);kt=a(Ue,"This tokenizer inherits from "),oe=s(Ue,"A",{href:!0});var Jt=r(oe);yt=a(Jt,"PreTrainedTokenizer"),Jt.forEach(n),vt=a(Ue,` which contains most of the main methods. Users should refer to
