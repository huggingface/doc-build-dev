...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17888/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17888/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17888/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rm.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var mt=a(Ue);y(fr.$$.fragment,mt),zk=h(mt),Mo=s(mt,"P",{});var Hd=a(Mo);qk=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var G0=a(hd);Ck=i(G0,"RobertaForSequenceClassification"),G0.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var X0=a(Yc);Pk=i(X0,"__call__"),X0.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(mt),y(Dn.$$.fragment,mt),Ok=h(mt),y(Sn.$$.fragment,mt),Nk=h(mt),y(Wn.$$.fragment,mt),Ik=h(mt),y(Bn.$$.fragment,mt),Dk=h(mt),y(Un.$$.fragment,mt),mt.forEach(t),ao.forEach(t),af=h(o),Eo=s(o,"H2",{class:!0});var im=a(Eo);Hn=s(im,"A",{id:!0,class:!0,href:!0});var Y0=a(Hn);Zc=s(Y0,"SPAN",{});var Z0=a(Zc);y(mr.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),Sk=h(im),ep=s(im,"SPAN",{});var e8=a(ep);Wk=i(e8,"RobertaForMultipleChoice"),e8.forEach(t),im.forEach(t),rf=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);y(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var t8=a(tp);Uk=i(t8,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t8.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lm=a(_r);Qk=i(lm,"This model inherits from "),ud=s(lm,"A",{href:!0});var o8=a(ud);Jk=i(o8,"PreTrainedModel"),o8.forEach(t),Vk=i(lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lm.forEach(t),Kk=h(ro),br=s(ro,"P",{});var dm=a(br);Gk=i(dm,"This model is also a PyTorch "),kr=s(dm,"A",{href:!0,rel:!0});var n8=a(kr);Xk=i(n8,"torch.nn.Module"),n8.forEach(t),Yk=i(dm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s8=a(fd);ov=i(s8,"RobertaForMultipleChoice"),s8.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a8=a(op);sv=i(a8,"__call__"),a8.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),y(Qn.$$.fragment,oa),iv=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cm=a(qo);Vn=s(cm,"A",{id:!0,class:!0,href:!0});var r8=a(Vn);np=s(r8,"SPAN",{});var i8=a(np);y(Tr.$$.fragment,i8),i8.forEach(t),r8.forEach(t),lv=h(cm),sp=s(cm,"SPAN",{});var l8=a(sp);dv=i(l8,"RobertaForTokenClassification"),l8.forEach(t),cm.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var d8=a(ap);pv=i(d8,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d8.forEach(t),hv=h(io),wr=s(io,"P",{});var pm=a(wr);uv=i(pm,"This model inherits from "),md=s(pm,"A",{href:!0});var c8=a(md);fv=i(c8,"PreTrainedModel"),c8.forEach(t),mv=i(pm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pm.forEach(t),gv=h(io),$r=s(io,"P",{});var hm=a($r);_v=i(hm,"This model is also a PyTorch "),Fr=s(hm,"A",{href:!0,rel:!0});var p8=a(Fr);bv=i(p8,"torch.nn.Module"),p8.forEach(t),kv=i(hm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),Tv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);yv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h8=a(gd);wv=i(h8,"RobertaForTokenClassification"),h8.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var u8=a(rp);Fv=i(u8,"__call__"),u8.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),y(Kn.$$.fragment,lo),Mv=h(lo),y(Gn.$$.fragment,lo),Ev=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var um=a(jo);Yn=s(um,"A",{id:!0,class:!0,href:!0});var f8=a(Yn);ip=s(f8,"SPAN",{});var m8=a(ip);y(Rr.$$.fragment,m8),m8.forEach(t),f8.forEach(t),zv=h(um),lp=s(um,"SPAN",{});var g8=a(lp);qv=i(g8,"RobertaForQuestionAnswering"),g8.forEach(t),um.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _8=a(dp);Pv=i(_8,"span start logits"),_8.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var b8=a(cp);Av=i(b8,"span end logits"),b8.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fm=a(Er);Iv=i(fm,"This model inherits from "),_d=s(fm,"A",{href:!0});var k8=a(_d);Dv=i(k8,"PreTrainedModel"),k8.forEach(t),Sv=i(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fm.forEach(t),Wv=h(co),zr=s(co,"P",{});var mm=a(zr);Bv=i(mm,"This model is also a PyTorch "),qr=s(mm,"A",{href:!0,rel:!0});var v8=a(qr);Uv=i(v8,"torch.nn.Module"),v8.forEach(t),Hv=i(mm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mm.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T8=a(bd);Kv=i(T8,"RobertaForQuestionAnswering"),T8.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y8=a(pp);Xv=i(y8,"__call__"),y8.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),eT=h(po),y(es.$$.fragment,po),tT=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gm=a(Ao);os=s(gm,"A",{id:!0,class:!0,href:!0});var w8=a(os);hp=s(w8,"SPAN",{});var $8=a(hp);y(jr.$$.fragment,$8),$8.forEach(t),w8.forEach(t),oT=h(gm),up=s(gm,"SPAN",{});var F8=a(up);nT=i(F8,"TFRobertaModel"),F8.forEach(t),gm.forEach(t),uf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sT=h(Ot),fp=s(Ot,"P",{});var x8=a(fp);aT=i(x8,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x8.forEach(t),rT=h(Ot),Lr=s(Ot,"P",{});var _m=a(Lr);iT=i(_m,"This model inherits from "),kd=s(_m,"A",{href:!0});var R8=a(kd);lT=i(R8,"TFPreTrainedModel"),R8.forEach(t),dT=i(_m,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_m.forEach(t),cT=h(Ot),Ar=s(Ot,"P",{});var bm=a(Ar);pT=i(bm,"This model is also a "),Or=s(bm,"A",{href:!0,rel:!0});var M8=a(Or);hT=i(M8,"tf.keras.Model"),M8.forEach(t),uT=i(bm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bm.forEach(t),fT=h(Ot),y(ns.$$.fragment,Ot),mT=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gT=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_T=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E8=a(vd);bT=i(E8,"TFRobertaModel"),E8.forEach(t),kT=i(Gd," forward method, overrides the "),mp=s(Gd,"CODE",{});var z8=a(mp);vT=i(z8,"__call__"),z8.forEach(t),TT=i(Gd," special method."),Gd.forEach(t),yT=h(na),y(ss.$$.fragment,na),wT=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var km=a(No);rs=s(km,"A",{id:!0,class:!0,href:!0});var q8=a(rs);gp=s(q8,"SPAN",{});var C8=a(gp);y(Ir.$$.fragment,C8),C8.forEach(t),q8.forEach(t),$T=h(km),_p=s(km,"SPAN",{});var j8=a(_p);FT=i(j8,"TFRobertaForCausalLM"),j8.forEach(t),km.forEach(t),mf=h(o),Io=s(o,"DIV",{class:!0});var vm=a(Io);y(Dr.$$.fragment,vm),xT=h(vm),Mt=s(vm,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),RT=h(sa),Do=s(sa,"P",{});var Xd=a(Do);MT=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P8=a(Td);ET=i(P8,"TFRobertaForCausalLM"),P8.forEach(t),zT=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L8=a(bp);qT=i(L8,"__call__"),L8.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=h(sa),y(is.$$.fragment,sa),PT=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vm.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tm=a(So);ds=s(Tm,"A",{id:!0,class:!0,href:!0});var A8=a(ds);kp=s(A8,"SPAN",{});var O8=a(kp);y(Wr.$$.fragment,O8),O8.forEach(t),A8.forEach(t),LT=h(Tm),vp=s(Tm,"SPAN",{});var N8=a(vp);AT=i(N8,"TFRobertaForMaskedLM"),N8.forEach(t),Tm.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),OT=h(Nt),Ur=s(Nt,"P",{});var ym=a(Ur);NT=i(ym,"RoBERTa Model with a "),Tp=s(ym,"CODE",{});var I8=a(Tp);IT=i(I8,"language modeling"),I8.forEach(t),DT=i(ym," head on top."),ym.forEach(t),ST=h(Nt),Hr=s(Nt,"P",{});var wm=a(Hr);WT=i(wm,"This model inherits from "),yd=s(wm,"A",{href:!0});var D8=a(yd);BT=i(D8,"TFPreTrainedModel"),D8.forEach(t),UT=i(wm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wm.forEach(t),HT=h(Nt),Qr=s(Nt,"P",{});var $m=a(Qr);QT=i($m,"This model is also a "),Jr=s($m,"A",{href:!0,rel:!0});var S8=a(Jr);JT=i(S8,"tf.keras.Model"),S8.forEach(t),VT=i($m,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$m.forEach(t),KT=h(Nt),y(cs.$$.fragment,Nt),GT=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),XT=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);YT=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W8=a(wd);ZT=i(W8,"TFRobertaForMaskedLM"),W8.forEach(t),ey=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B8=a(yp);ty=i(B8,"__call__"),B8.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),y(ps.$$.fragment,ho),sy=h(ho),y(hs.$$.fragment,ho),ay=h(ho),y(us.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fm=a(Bo);fs=s(Fm,"A",{id:!0,class:!0,href:!0});var U8=a(fs);wp=s(U8,"SPAN",{});var H8=a(wp);y(Kr.$$.fragment,H8),H8.forEach(t),U8.forEach(t),ry=h(Fm),$p=s(Fm,"SPAN",{});var Q8=a($p);iy=i(Q8,"TFRobertaForSequenceClassification"),Q8.forEach(t),Fm.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var J8=a(Fp);dy=i(J8,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J8.forEach(t),cy=h(It),Xr=s(It,"P",{});var xm=a(Xr);py=i(xm,"This model inherits from "),$d=s(xm,"A",{href:!0});var V8=a($d);hy=i(V8,"TFPreTrainedModel"),V8.forEach(t),uy=i(xm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xm.forEach(t),fy=h(It),Yr=s(It,"P",{});var Rm=a(Yr);my=i(Rm,"This model is also a "),Zr=s(Rm,"A",{href:!0,rel:!0});var K8=a(Zr);gy=i(K8,"tf.keras.Model"),K8.forEach(t),_y=i(Rm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rm.forEach(t),by=h(It),y(ms.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vy=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);Ty=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G8=a(Fd);yy=i(G8,"TFRobertaForSequenceClassification"),G8.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X8=a(xp);$y=i(X8,"__call__"),X8.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(uo),y(gs.$$.fragment,uo),Ry=h(uo),y(_s.$$.fragment,uo),My=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mm=a(Ho);ks=s(Mm,"A",{id:!0,class:!0,href:!0});var Y8=a(ks);Rp=s(Y8,"SPAN",{});var Z8=a(Rp);y(ti.$$.fragment,Z8),Z8.forEach(t),Y8.forEach(t),Ey=h(Mm),Mp=s(Mm,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mm.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);Cy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
