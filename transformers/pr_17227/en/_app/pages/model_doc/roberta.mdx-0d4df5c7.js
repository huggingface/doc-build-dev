import{S as LM,i as AM,s as OM,e as n,k as p,w as y,t as r,M as NM,c as s,d as t,m as h,a,x as T,h as i,b as u,G as e,g as k,y as w,q as $,o as F,B as x,v as IM,L as Z}from"../../chunks/vendor-316217a5.js";import{T as fe}from"../../chunks/Tip-27e9fea0.js";import{D as P}from"../../chunks/Docstring-1fe4a33a.js";import{C as ee}from"../../chunks/CodeBlock-8418a95e.js";import{I as $e}from"../../chunks/IconCopyLink-40460835.js";import{E as Y}from"../../chunks/ExampleCodeBlock-32fc0037.js";function DM(R){let d,g,c,m,_;return m=new ee({props:{code:`from transformers import RobertaConfig, RobertaModel
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17227/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17227/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_17227/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17227/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17227/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17227/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17227/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ST=p(),y(vs.$$.fragment),WT=p(),Et=n("div"),y(ri.$$.fragment),BT=p(),Qo=n("p"),UT=r("The "),Rd=n("a"),HT=r("TFRobertaForMultipleChoice"),QT=r(" forward method, overrides the "),zp=n("code"),JT=r("__call__"),VT=r(" special method."),KT=p(),y(ys.$$.fragment),GT=p(),y(Ts.$$.fragment),Tf=p(),Jo=n("h2"),ws=n("a"),qp=n("span"),y(ii.$$.fragment),XT=p(),Cp=n("span"),YT=r("TFRobertaForTokenClassification"),wf=p(),Ge=n("div"),y(li.$$.fragment),ZT=p(),jp=n("p"),e2=r(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),t2=p(),di=n("p"),o2=r("This model inherits from "),Md=n("a"),n2=r("TFPreTrainedModel"),s2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),a2=p(),ci=n("p"),r2=r("This model is also a "),pi=n("a"),i2=r("tf.keras.Model"),l2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),d2=p(),y($s.$$.fragment),c2=p(),ht=n("div"),y(hi.$$.fragment),p2=p(),Vo=n("p"),h2=r("The "),Ed=n("a"),m2=r("TFRobertaForTokenClassification"),f2=r(" forward method, overrides the "),Pp=n("code"),u2=r("__call__"),g2=r(" special method."),_2=p(),y(Fs.$$.fragment),b2=p(),y(xs.$$.fragment),k2=p(),y(Rs.$$.fragment),$f=p(),Ko=n("h2"),Ms=n("a"),Lp=n("span"),y(mi.$$.fragment),v2=p(),Ap=n("span"),y2=r("TFRobertaForQuestionAnswering"),Ff=p(),Xe=n("div"),y(fi.$$.fragment),T2=p(),Go=n("p"),w2=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=n("code"),$2=r("span start logits"),F2=r(" and "),Np=n("code"),x2=r("span end logits"),R2=r(")."),M2=p(),ui=n("p"),E2=r("This model inherits from "),zd=n("a"),z2=r("TFPreTrainedModel"),q2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),C2=p(),gi=n("p"),j2=r("This model is also a "),_i=n("a"),P2=r("tf.keras.Model"),L2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),A2=p(),y(Es.$$.fragment),O2=p(),mt=n("div"),y(bi.$$.fragment),N2=p(),Xo=n("p"),I2=r("The "),qd=n("a"),D2=r("TFRobertaForQuestionAnswering"),S2=r(" forward method, overrides the "),Ip=n("code"),W2=r("__call__"),B2=r(" special method."),U2=p(),y(zs.$$.fragment),H2=p(),y(qs.$$.fragment),Q2=p(),y(Cs.$$.fragment),xf=p(),Yo=n("h2"),js=n("a"),Dp=n("span"),y(ki.$$.fragment),J2=p(),Sp=n("span"),V2=r("FlaxRobertaModel"),Rf=p(),Oe=n("div"),y(vi.$$.fragment),K2=p(),Wp=n("p"),G2=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),X2=p(),yi=n("p"),Y2=r("This model inherits from "),Cd=n("a"),Z2=r("FlaxPreTrainedModel"),ew=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Aw=p(),Zp=n("p"),Ow=r("Finally, this model supports inherent JAX features such as:"),Nw=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),Iw=r("Just-In-Time (JIT) compilation"),Dw=p(),th=n("li"),Li=n("a"),Sw=r("Automatic Differentiation"),Ww=p(),oh=n("li"),Ai=n("a"),Bw=r("Vectorization"),Uw=p(),nh=n("li"),Oi=n("a"),Hw=r("Parallelization"),Qw=p(),qt=n("div"),y(Ni.$$.fragment),Jw=p(),tn=n("p"),Vw=r("The "),sh=n("code"),Kw=r("FlaxRobertaPreTrainedModel"),Gw=r(" forward method, overrides the "),ah=n("code"),Xw=r("__call__"),Yw=r(" special method."),Zw=p(),y(Os.$$.fragment),e1=p(),y(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),y(Ii.$$.fragment),t1=p(),ih=n("span"),o1=r("FlaxRobertaForMaskedLM"),qf=p(),Ie=n("div"),y(Di.$$.fragment),n1=p(),Si=n("p"),s1=r("RoBERTa Model with a "),lh=n("code"),a1=r("language modeling"),r1=r(" head on top."),i1=p(),Wi=n("p"),l1=r("This model inherits from "),Pd=n("a"),d1=r("FlaxPreTrainedModel"),c1=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),u1=p(),dh=n("p"),g1=r("Finally, this model supports inherent JAX features such as:"),_1=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),b1=r("Just-In-Time (JIT) compilation"),k1=p(),ph=n("li"),Qi=n("a"),v1=r("Automatic Differentiation"),y1=p(),hh=n("li"),Ji=n("a"),T1=r("Vectorization"),w1=p(),mh=n("li"),Vi=n("a"),$1=r("Parallelization"),F1=p(),Ct=n("div"),y(Ki.$$.fragment),x1=p(),nn=n("p"),R1=r("The "),fh=n("code"),M1=r("FlaxRobertaPreTrainedModel"),E1=r(" forward method, overrides the "),uh=n("code"),z1=r("__call__"),q1=r(" special method."),C1=p(),y(Ds.$$.fragment),j1=p(),y(Ss.$$.fragment),Cf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),y(Gi.$$.fragment),P1=p(),_h=n("span"),L1=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),y(Xi.$$.fragment),A1=p(),bh=n("p"),O1=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w$=p(),Eh=n("p"),$$=r("Finally, this model supports inherent JAX features such as:"),F$=p(),Vt=n("ul"),zh=n("li"),pl=n("a"),x$=r("Just-In-Time (JIT) compilation"),R$=p(),qh=n("li"),hl=n("a"),M$=r("Automatic Differentiation"),E$=p(),Ch=n("li"),ml=n("a"),z$=r("Vectorization"),q$=p(),jh=n("li"),fl=n("a"),C$=r("Parallelization"),j$=p(),Pt=n("div"),y(ul.$$.fragment),P$=p(),ln=n("p"),L$=r("The "),Ph=n("code"),A$=r("FlaxRobertaPreTrainedModel"),O$=r(" forward method, overrides the "),Lh=n("code"),N$=r("__call__"),I$=r(" special method."),D$=p(),y(Qs.$$.fragment),S$=p(),y(Js.$$.fragment),Af=p(),dn=n("h2"),Vs=n("a"),Ah=n("span"),y(gl.$$.fragment),W$=p(),Oh=n("span"),B$=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),y(_l.$$.fragment),U$=p(),Nh=n("p"),H$=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Q$=p(),bl=n("p"),J$=r("This model inherits from "),Od=n("a"),V$=r("FlaxPreTrainedModel"),K$=r(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),T(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sR=a(Rd);HT=i(sR,"TFRobertaForMultipleChoice"),sR.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var aR=a(zp);JT=i(aR,"__call__"),aR.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=h(aa),T(ys.$$.fragment,aa),GT=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var rR=a(ws);qp=s(rR,"SPAN",{});var iR=a(qp);T(ii.$$.fragment,iR),iR.forEach(t),rR.forEach(t),XT=h(qu),Cp=s(qu,"SPAN",{});var lR=a(Cp);YT=i(lR,"TFRobertaForTokenClassification"),lR.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var dR=a(jp);e2=i(dR,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dR.forEach(t),t2=h(St),di=s(St,"P",{});var Cu=a(di);o2=i(Cu,"This model inherits from "),Md=s(Cu,"A",{href:!0});var cR=a(Md);n2=i(cR,"TFPreTrainedModel"),cR.forEach(t),s2=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),a2=h(St),ci=s(St,"P",{});var ju=a(ci);r2=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var pR=a(pi);i2=i(pR,"tf.keras.Model"),pR.forEach(t),l2=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),d2=h(St),T($s.$$.fragment,St),c2=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);T(hi.$$.fragment,fo),p2=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);h2=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hR=a(Ed);m2=i(hR,"TFRobertaForTokenClassification"),hR.forEach(t),f2=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mR=a(Pp);u2=i(mR,"__call__"),mR.forEach(t),g2=i(tc," special method."),tc.forEach(t),_2=h(fo),T(Fs.$$.fragment,fo),b2=h(fo),T(xs.$$.fragment,fo),k2=h(fo),T(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fR=a(Ms);Lp=s(fR,"SPAN",{});var uR=a(Lp);T(mi.$$.fragment,uR),uR.forEach(t),fR.forEach(t),v2=h(Pu),Ap=s(Pu,"SPAN",{});var gR=a(Ap);y2=i(gR,"TFRobertaForQuestionAnswering"),gR.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);T(fi.$$.fragment,Wt),T2=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);w2=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _R=a(Op);$2=i(_R,"span start logits"),_R.forEach(t),F2=i(oc," and "),Np=s(oc,"CODE",{});var bR=a(Np);x2=i(bR,"span end logits"),bR.forEach(t),R2=i(oc,")."),oc.forEach(t),M2=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);E2=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var kR=a(zd);z2=i(kR,"TFPreTrainedModel"),kR.forEach(t),q2=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),C2=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);j2=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var vR=a(_i);P2=i(vR,"tf.keras.Model"),vR.forEach(t),L2=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),A2=h(Wt),T(Es.$$.fragment,Wt),O2=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),N2=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);I2=i(nc,"The "),qd=s(nc,"A",{href:!0});var yR=a(qd);D2=i(yR,"TFRobertaForQuestionAnswering"),yR.forEach(t),S2=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var TR=a(Ip);W2=i(TR,"__call__"),TR.forEach(t),B2=i(nc," special method."),nc.forEach(t),U2=h(uo),T(zs.$$.fragment,uo),H2=h(uo),T(qs.$$.fragment,uo),Q2=h(uo),T(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wR=a(js);Dp=s(wR,"SPAN",{});var $R=a(Dp);T(ki.$$.fragment,$R),$R.forEach(t),wR.forEach(t),J2=h(Ou),Sp=s(Ou,"SPAN",{});var FR=a(Sp);V2=i(FR,"FlaxRobertaModel"),FR.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),K2=h(gt),Wp=s(gt,"P",{});var xR=a(Wp);G2=i(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),X2=h(gt),yi=s(gt,"P",{});var Nu=a(yi);Y2=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var RR=a(Cd);Z2=i(RR,"FlaxPreTrainedModel"),RR.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),Aw=h(_t),Zp=s(_t,"P",{});var QR=a(Zp);Ow=i(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),Nw=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var JR=a(eh);Pi=s(JR,"A",{href:!0,rel:!0});var VR=a(Pi);Iw=i(VR,"Just-In-Time (JIT) compilation"),VR.forEach(t),JR.forEach(t),Dw=h(la),th=s(la,"LI",{});var KR=a(th);Li=s(KR,"A",{href:!0,rel:!0});var GR=a(Li);Sw=i(GR,"Automatic Differentiation"),GR.forEach(t),KR.forEach(t),Ww=h(la),oh=s(la,"LI",{});var XR=a(oh);Ai=s(XR,"A",{href:!0,rel:!0});var YR=a(Ai);Bw=i(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),Uw=h(la),nh=s(la,"LI",{});var ZR=a(nh);Oi=s(ZR,"A",{href:!0,rel:!0});var e7=a(Oi);Hw=i(e7,"Parallelization"),e7.forEach(t),ZR.forEach(t),la.forEach(t),Qw=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);T(Ni.$$.fragment,da),Jw=h(da),tn=s(da,"P",{});var ac=a(tn);Vw=i(ac,"The "),sh=s(ac,"CODE",{});var t7=a(sh);Kw=i(t7,"FlaxRobertaPreTrainedModel"),t7.forEach(t),Gw=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var o7=a(ah);Xw=i(o7,"__call__"),o7.forEach(t),Yw=i(ac," special method."),ac.forEach(t),Zw=h(da),T(Os.$$.fragment,da),e1=h(da),T(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var n7=a(Is);rh=s(n7,"SPAN",{});var s7=a(rh);T(Ii.$$.fragment,s7),s7.forEach(t),n7.forEach(t),t1=h(Bu),ih=s(Bu,"SPAN",{});var a7=a(ih);o1=i(a7,"FlaxRobertaForMaskedLM"),a7.forEach(t),Bu.forEach(t),qf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);T(Di.$$.fragment,bt),n1=h(bt),Si=s(bt,"P",{});var Uu=a(Si);s1=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var r7=a(lh);a1=i(r7,"language modeling"),r7.forEach(t),r1=i(Uu," head on top."),Uu.forEach(t),i1=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);l1=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var i7=a(Pd);d1=i(i7,"FlaxPreTrainedModel"),i7.forEach(t),c1=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hu.forEach(t),p1=h(bt),Bi=s(bt,"P",{});var Qu=a(Bi);h1=i(Qu,"This model is also a Flax Linen "),Ui=s(Qu,"A",{href:!0,rel:!0});var l7=a(Ui);m1=i(l7,"flax.linen.Module"),l7.forEach(t),f1=i(Qu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u1=h(bt),dh=s(bt,"P",{});var d7=a(dh);g1=i(d7,"Finally, this model supports inherent JAX features such as:"),d7.forEach(t),_1=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var c7=a(ch);Hi=s(c7,"A",{href:!0,rel:!0});var p7=a(Hi);b1=i(p7,"Just-In-Time (JIT) compilation"),p7.forEach(t),c7.forEach(t),k1=h(ca),ph=s(ca,"LI",{});var h7=a(ph);Qi=s(h7,"A",{href:!0,rel:!0});var m7=a(Qi);v1=i(m7,"Automatic Differentiation"),m7.forEach(t),h7.forEach(t),y1=h(ca),hh=s(ca,"LI",{});var f7=a(hh);Ji=s(f7,"A",{href:!0,rel:!0});var u7=a(Ji);T1=i(u7,"Vectorization"),u7.forEach(t),f7.forEach(t),w1=h(ca),mh=s(ca,"LI",{});var g7=a(mh);Vi=s(g7,"A",{href:!0,rel:!0});var _7=a(Vi);$1=i(_7,"Parallelization"),_7.forEach(t),g7.forEach(t),ca.forEach(t),F1=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);T(Ki.$$.fragment,pa),x1=h(pa),nn=s(pa,"P",{});var rc=a(nn);R1=i(rc,"The "),fh=s(rc,"CODE",{});var b7=a(fh);M1=i(b7,"FlaxRobertaPreTrainedModel"),b7.forEach(t),E1=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var k7=a(uh);z1=i(k7,"__call__"),k7.forEach(t),q1=i(rc," special method."),rc.forEach(t),C1=h(pa),T(Ds.$$.fragment,pa),j1=h(pa),T(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),Cf=h(o),sn=s(o,"H2",{class:!0});var Ju=a(sn);Ws=s(Ju,"A",{id:!0,class:!0,href:!0});var v7=a(Ws);gh=s(v7,"SPAN",{});var y7=a(gh);T(Gi.$$.fragment,y7),y7.forEach(t),v7.forEach(t),P1=h(Ju),_h=s(Ju,"SPAN",{});var T7=a(_h);L1=i(T7,"FlaxRobertaForSequenceClassification"),T7.forEach(t),Ju.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);T(Xi.$$.fragment,kt),A1=h(kt),bh=s(kt,"P",{});var w7=a(bh);O1=i(w7,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),w7.forEach(t),N1=h(kt),Yi=s(kt,"P",{});var Vu=a(Yi);I1=i(Vu,"This model inherits from "),Ld=s(Vu,"A",{href:!0});var $7=a(Ld);D1=i($7,"FlaxPreTrainedModel"),$7.forEach(t),S1=i(Vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vu.forEach(t),W1=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);B1=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var F7=a(el);U1=i(F7,"flax.linen.Module"),F7.forEach(t),H1=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q1=h(kt),kh=s(kt,"P",{});var x7=a(kh);J1=i(x7,"Finally, this model supports inherent JAX features such as:"),x7.forEach(t),V1=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var R7=a(vh);tl=s(R7,"A",{href:!0,rel:!0});var M7=a(tl);K1=i(M7,"Just-In-Time (JIT) compilation"),M7.forEach(t),R7.forEach(t),G1=h(ha),yh=s(ha,"LI",{});var E7=a(yh);ol=s(E7,"A",{href:!0,rel:!0});var z7=a(ol);X1=i(z7,"Automatic Differentiation"),z7.forEach(t),E7.forEach(t),Y1=h(ha),Th=s(ha,"LI",{});var q7=a(Th);nl=s(q7,"A",{href:!0,rel:!0});var C7=a(nl);Z1=i(C7,"Vectorization"),C7.forEach(t),q7.forEach(t),e$=h(ha),wh=s(ha,"LI",{});var j7=a(wh);sl=s(j7,"A",{href:!0,rel:!0});var P7=a(sl);t$=i(P7,"Parallelization"),P7.forEach(t),j7.forEach(t),ha.forEach(t),o$=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n$=h(ma),an=s(ma,"P",{});var ic=a(an);s$=i(ic,"The "),$h=s(ic,"CODE",{});var L7=a($h);a$=i(L7,"FlaxRobertaPreTrainedModel"),L7.forEach(t),r$=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var A7=a(Fh);i$=i(A7,"__call__"),A7.forEach(t),l$=i(ic," special method."),ic.forEach(t),d$=h(ma),T(Bs.$$.fragment,ma),c$=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var O7=a(Hs);xh=s(O7,"SPAN",{});var N7=a(xh);T(rl.$$.fragment,N7),N7.forEach(t),O7.forEach(t),p$=h(Gu),Rh=s(Gu,"SPAN",{});var I7=a(Rh);h$=i(I7,"FlaxRobertaForMultipleChoice"),I7.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m$=h(vt),Mh=s(vt,"P",{});var D7=a(Mh);f$=i(D7,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D7.forEach(t),u$=h(vt),ll=s(vt,"P",{});var Xu=a(ll);g$=i(Xu,"This model inherits from "),Ad=s(Xu,"A",{href:!0});var S7=a(Ad);_$=i(S7,"FlaxPreTrainedModel"),S7.forEach(t),b$=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k$=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v$=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var W7=a(cl);y$=i(W7,"flax.linen.Module"),W7.forEach(t),T$=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w$=h(vt),Eh=s(vt,"P",{});var B7=a(Eh);$$=i(B7,"Finally, this model supports inherent JAX features such as:"),B7.forEach(t),F$=h(vt),Vt=s(vt,"UL",{});var fa=a(Vt);zh=s(fa,"LI",{});var U7=a(zh);pl=s(U7,"A",{href:!0,rel:!0});var H7=a(pl);x$=i(H7,"Just-In-Time (JIT) compilation"),H7.forEach(t),U7.forEach(t),R$=h(fa),qh=s(fa,"LI",{});var Q7=a(qh);hl=s(Q7,"A",{href:!0,rel:!0});var J7=a(hl);M$=i(J7,"Automatic Differentiation"),J7.forEach(t),Q7.forEach(t),E$=h(fa),Ch=s(fa,"LI",{});var V7=a(Ch);ml=s(V7,"A",{href:!0,rel:!0});var K7=a(ml);z$=i(K7,"Vectorization"),K7.forEach(t),V7.forEach(t),q$=h(fa),jh=s(fa,"LI",{});var G7=a(jh);fl=s(G7,"A",{href:!0,rel:!0});var X7=a(fl);C$=i(X7,"Parallelization"),X7.forEach(t),G7.forEach(t),fa.forEach(t),j$=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);T(ul.$$.fragment,ua),P$=h(ua),ln=s(ua,"P",{});var lc=a(ln);L$=i(lc,"The "),Ph=s(lc,"CODE",{});var Y7=a(Ph);A$=i(Y7,"FlaxRobertaPreTrainedModel"),Y7.forEach(t),O$=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var Z7=a(Lh);N$=i(Z7,"__call__"),Z7.forEach(t),I$=i(lc," special method."),lc.forEach(t),D$=h(ua),T(Qs.$$.fragment,ua),S$=h(ua),T(Js.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Vs=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Vs);Ah=s(eM,"SPAN",{});var tM=a(Ah);T(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W$=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B$=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var yt=a(We);T(_l.$$.fragment,yt),U$=h(yt),Nh=s(yt,"P",{});var nM=a(Nh);H$=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nM.forEach(t),Q$=h(yt),bl=s(yt,"P",{});var eg=a(bl);J$=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sM=a(Od);V$=i(sM,"FlaxPreTrainedModel"),sM.forEach(t),K$=i(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),G$=h(yt),kl=s(yt,"P",{});var tg=a(kl);X$=i(tg,"This model is also a Flax Linen "),vl=s(tg,"A",{href:!0,rel:!0});var aM=a(vl);Y$=i(aM,"flax.linen.Module"),aM.forEach(t),Z$=i(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
