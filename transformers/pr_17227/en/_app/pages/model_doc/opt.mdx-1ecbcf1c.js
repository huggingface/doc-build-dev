...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){c=n("p"),v=i("Example:"),_=h(),b(p.$$.fragment)},l(r){c=a(r,"P",{});var f=s(c);v=l(f,"Example:"),f.forEach(o),_=u(r),k(p.$$.fragment,r)},m(r,f){m(r,c,f),e(c,v),m(r,_,f),w(p,r,f),T=!0},p:To,i(r){T||(P(p.$$.fragment,r),T=!0)},o(r){$(p.$$.fragment,r),T=!1},d(r){r&&o(c),r&&o(_),O(p,r)}}}function Or(x){let c,v,_,p,T,r,f,C,st,pe,M,U,R,J,rt,K,it,Me,I,te,Z,Fe,N,D,oe,he,ze,ne,X,lt,Ee,j,dt,ae,H,Y,ue,fe,ct,se,pt,z,ht,y,q,Ce,qe,Yt,re,je,Qt,eo,S,me,to,ut,F,oo,ie,ft,no,mt,$n,On,gt,xn,Mn,_t,Fn,zn,Vo,ge,Le,yo,Tt,En,bo,Cn,Ro,G,vt,qn,_e,jn,ao,Ln,Nn,yt,An,In,Dn,Te,Sn,so,Gn,Wn,ro,Un,Hn,Bn,Ne,Jo,ve,Ae,ko,bt,Vn,wo,Rn,Ko,W,kt,Jn,wt,Kn,io,Zn,Xn,Yn,Pt,Qn,$t,ea,ta,oa,B,Ot,na,ye,aa,lo,sa,ra,Po,ia,la,da,Ie,ca,De,Zo,be,Se,$o,xt,pa,Oo,ha,Xo,ke,Mt,ua,Ge,Ft,fa,We,Yo,we,Ue,xo,zt,ma,Mo,ga,Qo,L,Et,_a,Ct,Ta,co,va,ya,ba,qt,ka,jt,wa,Pa,$a,He,Oa,V,Lt,xa,Pe,Ma,po,Fa,za,Fo,Ea,Ca,qa,Be,ja,Ve,en,$e,Re,zo,Nt,La,Eo,Na,tn,Oe,At,Aa,Je,It,Ia,Ke,on,xe,Ze,Co,Dt,Da,qo,Sa,nn,E,St,Ga,jo,Wa,Ua,Gt,Ha,ho,Ba,Va,Ra,Wt,Ja,Ut,Ka,Za,Xa,Lo,Ya,Qa,Q,No,Ht,es,ts,Ao,Bt,os,ns,Io,Vt,as,ss,Do,Rt,rs,is,Xe,Jt,ls,Ye,an;return r=new at({}),J=new at({}),Tt=new at({}),vt=new ee({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"max_position_embeddings",val:" = 2048"},{name:"do_layer_norm_before",val:" = True"},{name:"word_embed_proj_dim",val:" = None"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"num_attention_heads",val:" = 12"},{name:"activation_function",val:" = 'relu'"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17227/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/opt/modeling_opt.py#L756",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17227/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/opt/modeling_opt.py#L839",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/pr_17227/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/opt/modeling_flax_opt.py#L769"}}),Jt=new ee({props:{name:"__call__",anchor:"transformers.FlaxOPTForCausalLM.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"head_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"deterministic",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/vr_17227/src/transformers/models/opt/modeling_flax_opt.py#L579",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
<p><a
  href="/docs/transformers/pr_17227/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Ye=new _o({props:{anchor:"transformers.FlaxOPTForCausalLM.__call__.example",$$slots:{default:[$r]},$$scope:{ctx:x}}}),{c(){c=n("meta"),v=h(),_=n("h1"),p=n("a"),T=n("span"),b(r.$$.fragment),f=h(),C=n("span"),st=i("OPT"),pe=h(),M=n("h2"),U=n("a"),R=n("span"),b(J.$$.fragment),rt=h(),K=n("span"),it=i("Overview"),Me=h(),I=n("p"),te=i("The OPT model was proposed in "),Z=n("a"),Fe=i("Open Pre-trained Transformer Language Models"),N=i(` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),D=h(),oe=n("p"),he=i("The abstract from the paper is the following:"),ze=h(),ne=n("p"),X=n("em"),lt=i("Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),Ee=h(),j=n("p"),dt=i("Tips:"),ae=h(),H=n("ul"),Y=n("li"),ue=i("OPT has the same architecture as "),fe=n("code"),ct=i("BartDecoder"),se=i("."),pt=h(),z=n("li"),ht=i("Contrary to GPT2, OPT adds the EOS token "),y=n("code"),q=i("</s>"),Ce=i(" to the beginning of every prompt. "),qe=n("strong"),Yt=i("Note"),re=i(": Make sure to pass "),je=n("code"),Qt=i("use_fast=False"),eo=i(" when loading OPT\u2019s tokenizer with "),S=n("a"),me=i("AutoTokenizer"),to=i(" to get the correct tokenizer."),ut=h(),F=n("p"),oo=i("This model was contributed by "),ie=n("a"),ft=i("Arthur Zucker"),no=i(", "),mt=n("a"),$n=i("Younes Belkada"),On=i(", and "),gt=n("a"),xn=i("Patrick Von Platen"),Mn=i(`.
The original code can be found `),_t=n("a"),Fn=i("here"),zn=i("."),Vo=h(),ge=n("h2"),Le=n("a"),yo=n("span"),b(Tt.$$.fragment),En=h(),bo=n("span"),Cn=i("OPTConfig"),Ro=h(),G=n("div"),b(vt.$$.fragment),qn=h(),_e=n("p"),jn=i("This is the configuration class to store the configuration of a "),ao=n("a"),Ln=i("OPTModel"),Nn=i(`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
`),yt=n("a"),An=i("facebook/opt-350m"),In=i(" architecture."),Dn=h(),Te=n("p"),Sn=i("Configuration objects inherit from "),so=n("a"),Gn=i("PretrainedConfig"),Wn=i(` and can be used to control the model outputs. Read the
documentation from `),ro=n("a"),Un=i("PretrainedConfig"),Hn=i(" for more information."),Bn=h(),b(Ne.$$.fragment),Jo=h(),ve=n("h2"),Ae=n("a"),ko=n("span"),b(bt.$$.fragment),Vn=h(),wo=n("span"),Rn=i("OPTModel"),Ko=h(),W=n("div"),b(kt.$$.fragment),Jn=h(),wt=n("p"),Kn=i(`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),oa=h(),B=n("div"),b(Ot.$$.fragment),na=h(),ye=n("p"),aa=i("The "),lo=n("a"),sa=i("OPTModel"),ra=i(" forward method, overrides the "),Po=n("code"),ia=i("__call__"),la=i(" special method."),da=h(),b(Ie.$$.fragment),ca=h(),b(De.$$.fragment),Zo=h(),be=n("h2"),Se=n("a"),$o=n("span"),b(xt.$$.fragment),pa=h(),Oo=n("span"),ha=i("OPTForCausalLM"),Xo=h(),ke=n("div"),b(Mt.$$.fragment),ua=h(),Ge=n("div"),b(Ft.$$.fragment),fa=h(),b(We.$$.fragment),Yo=h(),we=n("h2"),Ue=n("a"),xo=n("span"),b(zt.$$.fragment),ma=h(),Mo=n("span"),ga=i("TFOPTModel"),Qo=h(),L=n("div"),b(Et.$$.fragment),_a=h(),Ct=n("p"),Ta=i(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),$a=h(),b(He.$$.fragment),Oa=h(),V=n("div"),b(Lt.$$.fragment),xa=h(),Pe=n("p"),Ma=i("The "),po=n("a"),Fa=i("TFOPTModel"),za=i(" forward method, overrides the "),Fo=n("code"),Ea=i("__call__"),Ca=i(" special method."),qa=h(),b(Be.$$.fragment),ja=h(),b(Ve.$$.fragment),en=h(),$e=n("h2"),Re=n("a"),zo=n("span"),b(Nt.$$.fragment),La=h(),Eo=n("span"),Na=i("FlaxOPTModel"),tn=h(),Oe=n("div"),b(At.$$.fragment),Aa=h(),Je=n("div"),b(It.$$.fragment),Ia=h(),b(Ke.$$.fragment),on=h(),xe=n("h2"),Ze=n("a"),Co=n("span"),b(Dt.$$.fragment),Da=h(),qo=n("span"),Sa=i("FlaxOPTForCausalLM"),nn=h(),E=n("div"),b(St.$$.fragment),Ga=h(),jo=n("p"),Wa=i(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
autoregressive tasks.`),Ua=h(),Gt=n("p"),Ha=i("This model inherits from "),ho=n("a"),Ba=i("FlaxPreTrainedModel"),Va=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ra=h(),Wt=n("p"),Ja=i(`This model is also a Flax Linen
`),Ut=n("a"),Ka=i("flax.nn.Module"),Za=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Xa=h(),Lo=n("p"),Ya=i("Finally, this model supports inherent JAX features such as:"),Qa=h(),Q=n("ul"),No=n("li"),Ht=n("a"),es=i("Just-In-Time (JIT) compilation"),ts=h(),Ao=n("li"),Bt=n("a"),os=i("Automatic Differentiation"),ns=h(),Io=n("li"),Vt=n("a"),as=i("Vectorization"),ss=h(),Do=n("li"),Rt=n("a"),rs=i("Parallelization"),is=h(),Xe=n("div"),b(Jt.$$.fragment),ls=h(),b(Ye.$$.fragment),this.h()},l(t){const g=mr('[data-svelte="svelte-1phssyn"]',document.head);c=a(g,"META",{name:!0,content:!0}),g.forEach(o),v=u(t),_=a(t,"H1",{class:!0});var Kt=s(_);p=a(Kt,"A",{id:!0,class:!0,href:!0});var So=s(p);T=a(So,"SPAN",{});var Go=s(T);k(r.$$.fragment,Go),Go.forEach(o),So.forEach(o),f=u(Kt),C=a(Kt,"SPAN",{});var Wo=s(C);st=l(Wo,"OPT"),Wo.forEach(o),Kt.forEach(o),pe=u(t),M=a(t,"H2",{class:!0});var Zt=s(M);U=a(Zt,"A",{id:!0,class:!0,href:!0});var Uo=s(U);R=a(Uo,"SPAN",{});var Ho=s(R);k(J.$$.fragment,Ho),Ho.forEach(o),Uo.forEach(o),rt=u(Zt),K=a(Zt,"SPAN",{});var Bo=s(K);it=l(Bo,"Overview"),Bo.forEach(o),Zt.forEach(o),Me=u(t),I=a(t,"P",{});var Xt=s(I);te=l(Xt,"The OPT model was proposed in "),Z=a(Xt,"A",{href:!0,rel:!0});var cs=s(Z);Fe=l(cs,"Open Pre-trained Transformer Language Models"),cs.forEach(o),N=l(Xt,` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),Xt.forEach(o),D=u(t),oe=a(t,"P",{});var ps=s(oe);he=l(ps,"The abstract from the paper is the following:"),ps.forEach(o),ze=u(t),ne=a(t,"P",{});var hs=s(ne);X=a(hs,"EM",{});var us=s(X);lt=l(us,"Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),us.forEach(o),hs.forEach(o),Ee=u(t),j=a(t,"P",{});var fs=s(j);dt=l(fs,"Tips:"),fs.forEach(o),ae=u(t),H=a(t,"UL",{});var sn=s(H);Y=a(sn,"LI",{});var rn=s(Y);ue=l(rn,"OPT has the same architecture as "),fe=a(rn,"CODE",{});var ms=s(fe);ct=l(ms,"BartDecoder"),ms.forEach(o),se=l(rn,"."),rn.forEach(o),pt=u(sn),z=a(sn,"LI",{});var le=s(z);ht=l(le,"Contrary to GPT2, OPT adds the EOS token "),y=a(le,"CODE",{});var gs=s(y);q=l(gs,"</s>"),gs.forEach(o),Ce=l(le," to the beginning of every prompt. "),qe=a(le,"STRONG",{});var _s=s(qe);Yt=l(_s,"Note"),_s.forEach(o),re=l(le,": Make sure to pass "),je=a(le,"CODE",{});var Ts=s(je);Qt=l(Ts,"use_fast=False"),Ts.forEach(o),eo=l(le," when loading OPT\u2019s tokenizer with "),S=a(le,"A",{href:!0});var vs=s(S);me=l(vs,"AutoTokenizer"),vs.forEach(o),to=l(le," to get the correct tokenizer."),le.forEach(o),sn.forEach(o),ut=u(t),F=a(t,"P",{});var de=s(F);oo=l(de,"This model was contributed by "),ie=a(de,"A",{href:!0,rel:!0});var ys=s(ie);ft=l(ys,"Arthur Zucker"),ys.forEach(o),no=l(de,", "),mt=a(de,"A",{href:!0,rel:!0});var bs=s(mt);$n=l(bs,"Younes Belkada"),bs.forEach(o),On=l(de,", and "),gt=a(de,"A",{href:!0,rel:!0});var ks=s(gt);xn=l(ks,"Patrick Von Platen"),ks.forEach(o),Mn=l(de,`.
The original code can be found `),_t=a(de,"A",{href:!0,rel:!0});var ws=s(_t);Fn=l(ws,"here"),ws.forEach(o),zn=l(de,"."),de.forEach(o),Vo=u(t),ge=a(t,"H2",{class:!0});var ln=s(ge);Le=a(ln,"A",{id:!0,class:!0,href:!0});var Ps=s(Le);yo=a(Ps,"SPAN",{});var $s=s(yo);k(Tt.$$.fragment,$s),$s.forEach(o),Ps.forEach(o),En=u(ln),bo=a(ln,"SPAN",{});var Os=s(bo);Cn=l(Os,"OPTConfig"),Os.forEach(o),ln.forEach(o),Ro=u(t),G=a(t,"DIV",{class:!0});var Qe=s(G);k(vt.$$.fragment,Qe),qn=u(Qe),_e=a(Qe,"P",{});var uo=s(_e);jn=l(uo,"This is the configuration class to store the configuration of a "),ao=a(uo,"A",{href:!0});var xs=s(ao);Ln=l(xs,"OPTModel"),xs.forEach(o),Nn=l(uo,`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
`),yt=a(uo,"A",{href:!0,rel:!0});var Ms=s(yt);An=l(Ms,"facebook/opt-350m"),Ms.forEach(o),In=l(uo," architecture."),uo.forEach(o),Dn=u(Qe),Te=a(Qe,"P",{});var fo=s(Te);Sn=l(fo,"Configuration objects inherit from "),so=a(fo,"A",{href:!0});var Fs=s(so);Gn=l(Fs,"PretrainedConfig"),Fs.forEach(o),Wn=l(fo,` and can be used to control the model outputs. Read the
documentation from `),ro=a(fo,"A",{href:!0});var zs=s(ro);Un=l(zs,"PretrainedConfig"),zs.forEach(o),Hn=l(fo," for more information."),fo.forEach(o),Bn=u(Qe),k(Ne.$$.fragment,Qe),Qe.forEach(o),Jo=u(t),ve=a(t,"H2",{class:!0});var dn=s(ve);Ae=a(dn,"A",{id:!0,class:!0,href:!0});var Es=s(Ae);ko=a(Es,"SPAN",{});var Cs=s(ko);k(bt.$$.fragment,Cs),Cs.forEach(o),Es.forEach(o),Vn=u(dn),wo=a(dn,"SPAN",{});var qs=s(wo);Rn=l(qs,"OPTModel"),qs.forEach(o),dn.forEach(o),Ko=u(t),W=a(t,"DIV",{class:!0});var et=s(W);k(kt.$$.fragment,et),Jn=u(et),wt=a(et,"P",{});var cn=s(wt);Kn=l(cn,`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pn.forEach(o),oa=u(et),B=a(et,"DIV",{class:!0});var tt=s(B);k(Ot.$$.fragment,tt),na=u(tt),ye=a(tt,"P",{});var mo=s(ye);aa=l(mo,"The "),lo=a(mo,"A",{href:!0});var Ns=s(lo);sa=l(Ns,"OPTModel"),Ns.forEach(o),ra=l(mo," forward method, overrides the "),Po=a(mo,"CODE",{});var As=s(Po);ia=l(As,"__call__"),As.forEach(o),la=l(mo," special method."),mo.forEach(o),da=u(tt),k(Ie.$$.fragment,tt),ca=u(tt),k(De.$$.fragment,tt),tt.forEach(o),et.forEach(o),Zo=u(t),be=a(t,"H2",{class:!0});var hn=s(be);Se=a(hn,"A",{id:!0,class:!0,href:!0});var Is=s(Se);$o=a(Is,"SPAN",{});var Ds=s($o);k(xt.$$.fragment,Ds),Ds.forEach(o),Is.forEach(o),pa=u(hn),Oo=a(hn,"SPAN",{});var Ss=s(Oo);ha=l(Ss,"OPTForCausalLM"),Ss.forEach(o),hn.forEach(o),Xo=u(t),ke=a(t,"DIV",{class:!0});var un=s(ke);k(Mt.$$.fragment,un),ua=u(un),Ge=a(un,"DIV",{class:!0});var fn=s(Ge);k(Ft.$$.fragment,fn),fa=u(fn),k(We.$$.fragment,fn),fn.forEach(o),un.forEach(o),Yo=u(t),we=a(t,"H2",{class:!0});var mn=s(we);Ue=a(mn,"A",{id:!0,class:!0,href:!0});var Gs=s(Ue);xo=a(Gs,"SPAN",{});var Ws=s(xo);k(zt.$$.fragment,Ws),Ws.forEach(o),Gs.forEach(o),ma=u(mn),Mo=a(mn,"SPAN",{});var Us=s(Mo);ga=l(Us,"TFOPTModel"),Us.forEach(o),mn.forEach(o),Qo=u(t),L=a(t,"DIV",{class:!0});var ce=s(L);k(Et.$$.fragment,ce),_a=u(ce),Ct=a(ce,"P",{});var gn=s(Ct);Ta=l(gn,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),co=a(gn,"A",{href:!0});var Hs=s(co);va=l(Hs,"TFPreTrainedModel"),Hs.forEach(o),ya=l(gn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gn.forEach(o),ba=u(ce),qt=a(ce,"P",{});var _n=s(qt);ka=l(_n,"This model is also a "),jt=a(_n,"A",{href:!0,rel:!0});var Bs=s(jt);wa=l(Bs,"tf.keras.Model"),Bs.forEach(o),Pa=l(_n,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_n.forEach(o),$a=u(ce),k(He.$$.fragment,ce),Oa=u(ce),V=a(ce,"DIV",{class:!0});var ot=s(V);k(Lt.$$.fragment,ot),xa=u(ot),Pe=a(ot,"P",{});var go=s(Pe);Ma=l(go,"The "),po=a(go,"A",{href:!0});var Vs=s(po);Fa=l(Vs,"TFOPTModel"),Vs.forEach(o),za=l(go," forward method, overrides the "),Fo=a(go,"CODE",{});var Rs=s(Fo);Ea=l(Rs,"__call__"),Rs.forEach(o),Ca=l(go," special method."),go.forEach(o),qa=u(ot),k(Be.$$.fragment,ot),ja=u(ot),k(Ve.$$.fragment,ot),ot.forEach(o),ce.forEach(o),en=u(t),$e=a(t,"H2",{class:!0});var Tn=s($e);Re=a(Tn,"A",{id:!0,class:!0,href:!0});var Js=s(Re);zo=a(Js,"SPAN",{});var Ks=s(zo);k(Nt.$$.fragment,Ks),Ks.forEach(o),Js.forEach(o),La=u(Tn),Eo=a(Tn,"SPAN",{});var Zs=s(Eo);Na=l(Zs,"FlaxOPTModel"),Zs.forEach(o),Tn.forEach(o),tn=u(t),Oe=a(t,"DIV",{class:!0});var vn=s(Oe);k(At.$$.fragment,vn),Aa=u(vn),Je=a(vn,"DIV",{class:!0});var yn=s(Je);k(It.$$.fragment,yn),Ia=u(yn),k(Ke.$$.fragment,yn),yn.forEach(o),vn.forEach(o),on=u(t),xe=a(t,"H2",{class:!0});var bn=s(xe);Ze=a(bn,"A",{id:!0,class:!0,href:!0});var Xs=s(Ze);Co=a(Xs,"SPAN",{});var Ys=s(Co);k(Dt.$$.fragment,Ys),Ys.forEach(o),Xs.forEach(o),Da=u(bn),qo=a(bn,"SPAN",{});var Qs=s(qo);Sa=l(Qs,"FlaxOPTForCausalLM"),Qs.forEach(o),bn.forEach(o),nn=u(t),E=a(t,"DIV",{class:!0});var A=s(E);k(St.$$.fragment,A),Ga=u(A),jo=a(A,"P",{});var er=s(jo);Wa=l(er,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
autoregressive tasks.`),er.forEach(o),Ua=u(A),Gt=a(A,"P",{});var kn=s(Gt);Ha=l(kn,"This model inherits from "),ho=a(kn,"A",{href:!0});var tr=s(ho);Ba=l(tr,"FlaxPreTrainedModel"),tr.forEach(o),Va=l(kn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kn.forEach(o),Ra=u(A),Wt=a(A,"P",{});var wn=s(Wt);Ja=l(wn,`This model is also a Flax Linen
`),Ut=a(wn,"A",{href:!0,rel:!0});var or=s(Ut);Ka=l(or,"flax.nn.Module"),or.forEach(o),Za=l(wn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wn.forEach(o),Xa=u(A),Lo=a(A,"P",{});var nr=s(Lo);Ya=l(nr,"Finally, this model supports inherent JAX features such as:"),nr.forEach(o),Qa=u(A),Q=a(A,"UL",{});var nt=s(Q);No=a(nt,"LI",{});var ar=s(No);Ht=a(ar,"A",{href:!0,rel:!0});var sr=s(Ht);es=l(sr,"Just-In-Time (JIT) compilation"),sr.forEach(o),ar.forEach(o),ts=u(nt),Ao=a(nt,"LI",{});var rr=s(Ao);Bt=a(rr,"A",{href:!0,rel:!0});var ir=s(Bt);os=l(ir,"Automatic Differentiation"),ir.forEach(o),rr.forEach(o),ns=u(nt),Io=a(nt,"LI",{});var lr=s(Io);Vt=a(lr,"A",{href:!0,rel:!0});var dr=s(Vt);as=l(dr,"Vectorization"),dr.forEach(o),lr.forEach(o),ss=u(nt),Do=a(nt,"LI",{});var cr=s(Do);Rt=a(cr,"A",{href:!0,rel:!0});var pr=s(Rt);rs=l(pr,"Parallelization"),pr.forEach(o),cr.forEach(o),nt.forEach(o),is=u(A),Xe=a(A,"DIV",{class:!0});var Pn=s(Xe);k(Jt.$$.fragment,Pn),ls=u(Pn),k(Ye.$$.fragment,Pn),Pn.forEach(o),A.forEach(o),this.h()},h(){d(c,"name","hf:doc:metadata"),d(c,"content",JSON.stringify(xr)),d(p,"id","opt"),d(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(p,"href","#opt"),d(_,"class","relative group"),d(U,"id","overview"),d(U,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(U,"href","#overview"),d(M,"class","relative group"),d(Z,"href","https://arxiv.org/pdf/2205.01068"),d(Z,"rel","nofollow"),d(S,"href","/docs/transformers/pr_17227/en/model_doc/auto#transformers.AutoTokenizer"),d(ie,"href","https://huggingface.co/ArthurZ"),d(ie,"rel","nofollow"),d(mt,"href","https://huggingface.co/ybelkada"),d(mt,"rel","nofollow"),d(gt,"href","https://huggingface.co/patrickvonplaten"),d(gt,"rel","nofollow"),d(_t,"href","https://github.com/facebookresearch/metaseq"),d(_t,"rel","nofollow"),d(Le,"id","transformers.OPTConfig"),d(Le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Le,"href","#transformers.OPTConfig"),d(ge,"class","relative group"),d(ao,"href","/docs/transformers/pr_17227/en/model_doc/opt#transformers.OPTModel"),d(yt,"href","https://huggingface.co/facebook/opt-350m"),d(yt,"rel","nofollow"),d(so,"href","/docs/transformers/pr_17227/en/main_classes/configuration#transformers.PretrainedConfig"),d(ro,"href","/docs/transformers/pr_17227/en/main_classes/configuration#transformers.PretrainedConfig"),d(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ae,"id","transformers.OPTModel"),d(Ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ae,"href","#transformers.OPTModel"),d(ve,"class","relative group"),d(io,"href","/docs/transformers/pr_17227/en/main_classes/model#transformers.PreTrainedModel"),d($t,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d($t,"rel","nofollow"),d(lo,"href","/docs/transformers/pr_17227/en/model_doc/opt#transformers.OPTModel"),d(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Se,"id","transformers.OPTForCausalLM"),d(Se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Se,"href","#transformers.OPTForCausalLM"),d(be,"class","relative group"),d(Ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ue,"id","transformers.TFOPTModel"),d(Ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ue,"href","#transformers.TFOPTModel"),d(we,"class","relative group"),d(co,"href","/docs/transformers/pr_17227/en/main_classes/model#transformers.TFPreTrainedModel"),d(jt,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),d(jt,"rel","nofollow"),d(po,"href","/docs/transformers/pr_17227/en/model_doc/opt#transformers.TFOPTModel"),d(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Re,"id","transformers.FlaxOPTModel"),d(Re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Re,"href","#transformers.FlaxOPTModel"),d($e,"class","relative group"),d(Je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ze,"id","transformers.FlaxOPTForCausalLM"),d(Ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ze,"href","#transformers.FlaxOPTForCausalLM"),d(xe,"class","relative group"),d(ho,"href","/docs/transformers/pr_17227/en/main_classes/model#transformers.FlaxPreTrainedModel"),d(Ut,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),d(Ut,"rel","nofollow"),d(Ht,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),d(Ht,"rel","nofollow"),d(Bt,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),d(Bt,"rel","nofollow"),d(Vt,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),d(Vt,"rel","nofollow"),d(Rt,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),d(Rt,"rel","nofollow"),d(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,g){e(document.head,c),m(t,v,g),m(t,_,g),e(_,p),e(p,T),w(r,T,null),e(_,f),e(_,C),e(C,st),m(t,pe,g),m(t,M,g),e(M,U),e(U,R),w(J,R,null),e(M,rt),e(M,K),e(K,it),m(t,Me,g),m(t,I,g),e(I,te),e(I,Z),e(Z,Fe),e(I,N),m(t,D,g),m(t,oe,g),e(oe,he),m(t,ze,g),m(t,ne,g),e(ne,X),e(X,lt),m(t,Ee,g),m(t,j,g),e(j,dt),m(t,ae,g),m(t,H,g),e(H,Y),e(Y,ue),e(Y,fe),e(fe,ct),e(Y,se),e(H,pt),e(H,z),e(z,ht),e(z,y),e(y,q),e(z,Ce),e(z,qe),e(qe,Yt),e(z,re),e(z,je),e(je,Qt),e(z,eo),e(z,S),e(S,me),e(z,to),m(t,ut,g),m(t,F,g),e(F,oo),e(F,ie),e(ie,ft),e(F,no),e(F,mt),e(mt,$n),e(F,On),e(F,gt),e(gt,xn),e(F,Mn),e(F,_t),e(_t,Fn),e(F,zn),m(t,Vo,g),m(t,ge,g),e(ge,Le),e(Le,yo),w(Tt,yo,null),e(ge,En),e(ge,bo),e(bo,Cn),m(t,Ro,g),m(t,G,g),w(vt,G,null),e(G,qn),e(G,_e),e(_e,jn),e(_e,ao),e(ao,Ln),e(_e,Nn),e(_e,yt),e(yt,An),e(_e,In),e(G,Dn),e(G,Te),e(Te,Sn),e(Te,so),e(so,Gn),e(Te,Wn),e(Te,ro),e(ro,Un),e(Te,Hn),e(G,Bn),w(Ne,G,null),m(t,Jo,g),m(t,ve,g),e(ve,Ae),e(Ae,ko),w(bt,ko,null),e(ve,Vn),e(ve,wo),e(wo,Rn),m(t,Ko,g),m(t,W,g),w(kt,W,null),e(W,Jn),e(W,wt),e(wt,Kn),e(wt,io),e(io,Zn),e(wt,Xn),e(W,Yn),e(W,Pt),e(Pt,Qn),e(Pt,$t),e($t,ea),e(Pt,ta),e(W,oa),e(W,B),w(Ot,B,null),e(B,na),e(B,ye),e(ye,aa),e(ye,lo),e(lo,sa),e(ye,ra),e(ye,Po),e(Po,ia),e(ye,la),e(B,da),w(Ie,B,null),e(B,ca),w(De,B,null),m(t,Zo,g),m(t,be,g),e(be,Se),e(Se,$o),w(xt,$o,null),e(be,pa),e(be,Oo),e(Oo,ha),m(t,Xo,g),m(t,ke,g),w(Mt,ke,null),e(ke,ua),e(ke,Ge),w(Ft,Ge,null),e(Ge,fa),w(We,Ge,null),m(t,Yo,g),m(t,we,g),e(we,Ue),e(Ue,xo),w(zt,xo,null),e(we,ma),e(we,Mo),e(Mo,ga),m(t,Qo,g),m(t,L,g),w(Et,L,null),e(L,_a),e(L,Ct),e(Ct,Ta),e(Ct,co),e(co,va),e(Ct,ya),e(L,ba),e(L,qt),e(qt,ka),e(qt,jt),e(jt,wa),e(qt,Pa),e(L,$a),w(He,L,null),e(L,Oa),e(L,V),w(Lt,V,null),e(V,xa),e(V,Pe),e(Pe,Ma),e(Pe,po),e(po,Fa),e(Pe,za),e(Pe,Fo),e(Fo,Ea),e(Pe,Ca),e(V,qa),w(Be,V,null),e(V,ja),w(Ve,V,null),m(t,en,g),m(t,$e,g),e($e,Re),e(Re,zo),w(Nt,zo,null),e($e,La),e($e,Eo),e(Eo,Na),m(t,tn,g),m(t,Oe,g),w(At,Oe,null),e(Oe,Aa),e(Oe,Je),w(It,Je,null),e(Je,Ia),w(Ke,Je,null),m(t,on,g),m(t,xe,g),e(xe,Ze),e(Ze,Co),w(Dt,Co,null),e(xe,Da),e(xe,qo),e(qo,Sa),m(t,nn,g),m(t,E,g),w(St,E,null),e(E,Ga),e(E,jo),e(jo,Wa),e(E,Ua),e(E,Gt),e(Gt,Ha),e(Gt,ho),e(ho,Ba),e(Gt,Va),e(E,Ra),e(E,Wt),e(Wt,Ja),e(Wt,Ut),e(Ut,Ka),e(Wt,Za),e(E,Xa),e(E,Lo),e(Lo,Ya),e(E,Qa),e(E,Q),e(Q,No),e(No,Ht),e(Ht,es),e(Q,ts),e(Q,Ao),e(Ao,Bt),e(Bt,os),e(Q,ns),e(Q,Io),e(Io,Vt),e(Vt,as),e(Q,ss),e(Q,Do),e(Do,Rt),e(Rt,rs),e(E,is),e(E,Xe),w(Jt,Xe,null),e(Xe,ls),w(Ye,Xe,null),an=!0},p(t,[g]){const Kt={};g&2&&(Kt.$$scope={dirty:g,ctx:t}),Ne.$set(Kt);const So={};g&2&&(So.$$scope={dirty:g,ctx:t}),Ie.$set(So);const Go={};g&2&&(Go.$$scope={dirty:g,ctx:t}),De.$set(Go);const Wo={};g&2&&(Wo.$$scope={dirty:g,ctx:t}),We.$set(Wo);const Zt={};g&2&&(Zt.$$scope={dirty:g,ctx:t}),He.$set(Zt);const Uo={};g&2&&(Uo.$$scope={dirty:g,ctx:t}),Be.$set(Uo);const Ho={};g&2&&(Ho.$$scope={dirty:g,ctx:t}),Ve.$set(Ho);const Bo={};g&2&&(Bo.$$scope={dirty:g,ctx:t}),Ke.$set(Bo);const Xt={};g&2&&(Xt.$$scope={dirty:g,ctx:t}),Ye.$set(Xt)},i(t){an||(P(r.$$.fragment,t),P(J.$$.fragment,t),P(Tt.$$.fragment,t),P(vt.$$.fragment,t),P(Ne.$$.fragment,t),P(bt.$$.fragment,t),P(kt.$$.fragment,t),P(Ot.$$.fragment,t),P(Ie.$$.fragment,t),P(De.$$.fragment,t),P(xt.$$.fragment,t),P(Mt.$$.fragment,t),P(Ft.$$.fragment,t),P(We.$$.fragment,t),P(zt.$$.fragment,t),P(Et.$$.fragment,t),P(He.$$.fragment,t),P(Lt.$$.fragment,t),P(Be.$$.fragment,t),P(Ve.$$.fragment,t),P(Nt.$$.fragment,t),P(At.$$.fragment,t),P(It.$$.fragment,t),P(Ke.$$.fragment,t),P(Dt.$$.fragment,t),P(St.$$.fragment,t),P(Jt.$$.fragment,t),P(Ye.$$.fragment,t),an=!0)},o(t){$(r.$$.fragment,t),$(J.$$.fragment,t),$(Tt.$$.fragment,t),$(vt.$$.fragment,t),$(Ne.$$.fragment,t),$(bt.$$.fragment,t),$(kt.$$.fragment,t),$(Ot.$$.fragment,t),$(Ie.$$.fragment,t),$(De.$$.fragment,t),$(xt.$$.fragment,t),$(Mt.$$.fragment,t),$(Ft.$$.fragment,t),$(We.$$.fragment,t),$(zt.$$.fragment,t),$(Et.$$.fragment,t),$(He.$$.fragment,t),$(Lt.$$.fragment,t),$(Be.$$.fragment,t),$(Ve.$$.fragment,t),$(Nt.$$.fragment,t),$(At.$$.fragment,t),$(It.$$.fragment,t),$(Ke.$$.fragment,t),$(Dt.$$.fragment,t),$(St.$$.fragment,t),$(Jt.$$.fragment,t),$(Ye.$$.fragment,t),an=!1},d(t){o(c),t&&o(v),t&&o(_),O(r),t&&o(pe),t&&o(M),O(J),t&&o(Me),t&&o(I),t&&o(D),t&&o(oe),t&&o(ze),t&&o(ne),t&&o(Ee),t&&o(j),t&&o(ae),t&&o(H),t&&o(ut),t&&o(F),t&&o(Vo),t&&o(ge),O(Tt),t&&o(Ro),t&&o(G),O(vt),O(Ne),t&&o(Jo),t&&o(ve),O(bt),t&&o(Ko),t&&o(W),O(kt),O(Ot),O(Ie),O(De),t&&o(Zo),t&&o(be),O(xt),t&&o(Xo),t&&o(ke),O(Mt),O(Ft),O(We),t&&o(Yo),t&&o(we),O(zt),t&&o(Qo),t&&o(L),O(Et),O(He),O(Lt),O(Be),O(Ve),t&&o(en),t&&o($e),O(Nt),t&&o(tn),t&&o(Oe),O(At),O(It),O(Ke),t&&o(on),t&&o(xe),O(Dt),t&&o(nn),t&&o(E),O(St),O(Jt),O(Ye)}}}const xr={local:"opt",sections:[{local:"overview",title:"Overview"},{local:"transformers.OPTConfig",title:"OPTConfig"},{local:"transformers.OPTModel",title:"OPTModel"},{local:"transformers.OPTForCausalLM",title:"OPTForCausalLM"},{local:"transformers.TFOPTModel",title:"TFOPTModel"},{local:"transformers.FlaxOPTModel",title:"FlaxOPTModel"},{local:"transformers.FlaxOPTForCausalLM",title:"FlaxOPTForCausalLM"}],title:"OPT"};function Mr(x){return gr(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Lr extends hr{constructor(c){super();ur(this,c,Mr,Or,fr,{})}}export{Lr as default,xr as metadata};
