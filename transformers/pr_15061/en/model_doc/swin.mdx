...
Tips:
- One can use the [AutoFeatureExtractor](/docs/transformers/pr_15061/en/model_doc/auto#transformers.AutoFeatureExtractor) API to prepare images for the model.
...
This is the configuration class to store the configuration of a [SwinModel](/docs/transformers/pr_15061/en/model_doc/swin#transformers.SwinModel). It is used to instantiate a Swin
...
<docstring><name>class transformers.SwinModel</name><anchor>transformers.SwinModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15061/src/transformers/models/swin/modeling_swin.py#L658</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([SwinConfig](/docs/transformers/pr_15061/en/model_doc/swin#transformers.SwinConfig)) -- Model configuration class with all the parameters of the model.
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SwinModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15061/src/transformers/models/swin/modeling_swin.py#L685</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [AutoFeatureExtractor](/docs/transformers/pr_15061/en/model_doc/auto#transformers.AutoFeatureExtractor). See
...
elements depending on the configuration ([SwinConfig](/docs/transformers/pr_15061/en/model_doc/swin#transformers.SwinConfig)) and inputs.
...
The [SwinModel](/docs/transformers/pr_15061/en/model_doc/swin#transformers.SwinModel) forward method, overrides the `__call__` special method.
...
<docstring><name>class transformers.SwinForImageClassification</name><anchor>transformers.SwinForImageClassification</anchor><source>https://github.com/huggingface/transformers/blob/pr_15061/src/transformers/models/swin/modeling_swin.py#L764</source><parameters>[{"name": "config", "val": ""}]</parameters><paramsdesc>- **config** ([SwinConfig](/docs/transformers/pr_15061/en/model_doc/swin#transformers.SwinConfig)) -- Model configuration class with all the parameters of the model.
  Initializing with a config file does not load the weights associated with the model, only the
  configuration. Check out the [from_pretrained()](/docs/transformers/pr_15061/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.</paramsdesc><paramgroups>0</paramgroups></docstring>
...
<div class="docstring">
<docstring><name>forward</name><anchor>transformers.SwinForImageClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15061/src/transformers/models/swin/modeling_swin.py#L779</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "head_mask", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [AutoFeatureExtractor](/docs/transformers/pr_15061/en/model_doc/auto#transformers.AutoFeatureExtractor). See
  `AutoFeatureExtractor.__call__()` for details.
- **head_mask** (`torch.FloatTensor` of shape `(num_heads,)` or `(num_layers, num_heads)`, *optional*) --
  Mask to nullify selected heads of the self-attention modules. Mask values selected in `[0, 1]`:
...
- **attentions** (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length,
  ...
  Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
  heads.</retdesc></docstring>
The [SwinForImageClassification](/docs/transformers/pr_15061/en/model_doc/swin#transformers.SwinForImageClassification) forward method, overrides the `__call__` special method.
