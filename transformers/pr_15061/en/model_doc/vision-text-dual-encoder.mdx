...
The [VisionTextDualEncoderModel](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel) can be used to initialize a vision-text dual encoder model with
...
[VisionTextDualEncoderConfig](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig) is the configuration class to store the configuration of a
...
<div class="docstring">
<docstring><name>from\_vision\_text\_configs</name><anchor>transformers.VisionTextDualEncoderConfig.from_vision_text_configs</anchor><source>https://github.com/huggingface/transformers/blob/pr_15061/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L105</source><parameters>[{"name": "vision_config", "val": ": PretrainedConfig"}, {"name": "text_config", "val": ": PretrainedConfig"}, {"name": "**kwargs", "val": ""}]</parameters><rettype>[VisionTextDualEncoderConfig](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig)</rettype><retdesc>An instance of a configuration object</retdesc></docstring>

Instantiate a [VisionTextDualEncoderConfig](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig) (or a derived class) from text model configuration and vision
model configuration.
...
[VisionTextDualEncoderProcessor](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderProcessor) offers all the functionalities of [AutoFeatureExtractor](/docs/transformers/pr_15061/en/model_doc/auto#transformers.AutoFeatureExtractor) and
[AutoTokenizer](/docs/transformers/pr_15061/en/model_doc/auto#transformers.AutoTokenizer). See the `__call__()` and
[decode()](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderProcessor.decode) for more information.
...
<div class="docstring">
<docstring><name>batch\_decode</name><anchor>transformers.VisionTextDualEncoderProcessor.batch_decode</anchor><source>https://github.com/huggingface/transformers/blob/pr_15061/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L172</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to VisionTextDualEncoderTokenizer's
[batch_decode()](/docs/transformers/pr_15061/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode). Please refer to the docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>decode</name><anchor>transformers.VisionTextDualEncoderProcessor.decode</anchor><source>https://github.com/huggingface/transformers/blob/pr_15061/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L179</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters></docstring>

This method forwards all its arguments to VisionTextDualEncoderTokenizer's [decode()](/docs/transformers/pr_15061/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode).
Please refer to the docstring of this method for more information.


</div>
<div class="docstring">
<docstring><name>from\_pretrained</name><anchor>transformers.VisionTextDualEncoderProcessor.from_pretrained</anchor><source>https://github.com/huggingface/transformers/blob/pr_15061/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L85</source><parameters>[{"name": "pretrained_model_name_or_path", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
  This can be either:
...
Instantiate a [VisionTextDualEncoderProcessor](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderProcessor) from a pretrained VisionTextDualEncoder processor.
...
[from_pretrained()](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderProcessor.from_pretrained) class method.
...
- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  ...
  a feature extractor (e.g. if you use ViT as the encoder, you should use [ViTFeatureExtractor](/docs/transformers/pr_15061/en/model_doc/vit#transformers.ViTFeatureExtractor)). See
...
elements depending on the configuration ([VisionTextDualEncoderConfig](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig)) and inputs.
...
The [VisionTextDualEncoderModel](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel) forward method, overrides the `__call__` special method.
...
The [FlaxVisionTextDualEncoderModel](/docs/transformers/pr_15061/en/model_doc/vision-text-dual-encoder#transformers.FlaxVisionTextDualEncoderModel) forward method, overrides the `__call__` special method.
