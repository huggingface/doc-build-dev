import{S as Pd,i as Ld,s as $d,e as n,k as u,w as v,t as i,M as qd,c as s,d as o,m,a,x as y,h as d,b as c,F as e,g as _,y as T,q as w,o as P,B as L,v as zd,L as ue}from"../../chunks/vendor-6b77c823.js";import{T as ii}from"../../chunks/Tip-39098574.js";import{D as I}from"../../chunks/Docstring-1088f2fb.js";import{C as W}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as pe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as he}from"../../chunks/ExampleCodeBlock-5212b321.js";function Bd($){let l,b,p,f,k;return f=new W({props:{code:`from transformers import PLBartModel, PLBartConfig
...
<span class="hljs-literal">True</span>`}}),{c(){l=n("p"),b=i("Example:"),p=u(),v(f.$$.fragment)},l(r){l=s(r,"P",{});var g=a(l);b=d(g,"Example:"),g.forEach(o),p=m(r),y(f.$$.fragment,r)},m(r,g){_(r,l,g),e(l,b),_(r,p,g),T(f,r,g),k=!0},p:ue,i(r){k||(w(f.$$.fragment,r),k=!0)},o(r){P(f.$$.fragment,r),k=!1},d(r){r&&o(l),r&&o(p),L(f,r)}}}function Dd($){let l,b,p,f,k,r,g,x,ns,rn,D,co,ss,as,Ge,rs,is,Re,ds,ls,dn,K,me,po,He,cs,ho,ps,ln,G,hs,Ue,us,ms,uo,fs,gs,cn,Nt,_s,pn,Ot,mo,bs,hn,R,ks,Ve,vs,ys,Je,Ts,ws,un,Q,fe,fo,Ke,Ps,go,Ls,mn,C,$s,_o,qs,zs,bo,Bs,xs,ko,Cs,Fs,vo,js,Es,fn,ge,Ms,Qe,Ss,As,gn,H,Ns,Ye,yo,Os,Is,Ds,It,Xs,Ws,_n,Dt,To,Gs,bn,Ze,kn,Xt,et,wo,Rs,Hs,Y,Us,Po,Vs,Js,Lo,Ks,Qs,vn,tt,yn,Z,_e,$o,ot,Ys,qo,Zs,Tn,E,nt,ea,ee,ta,Wt,oa,na,st,sa,aa,ra,te,ia,Gt,da,la,Rt,ca,pa,ha,be,wn,oe,ke,zo,at,ua,Bo,ma,Pn,q,rt,fa,xo,ga,_a,X,ba,Ht,ka,va,Ut,ya,Ta,it,wa,Pa,La,dt,$a,Co,qa,za,Ba,ve,xa,ye,lt,Ca,Fo,Fa,ja,A,ct,Ea,pt,Ma,jo,Sa,Aa,Na,ht,ut,Eo,Oa,Ia,Mo,Da,Xa,mt,So,Wa,Ga,Ao,Ra,Ha,No,Ua,Ln,ne,Te,Oo,ft,Va,Io,Ja,$n,M,gt,Ka,_t,Qa,Vt,Ya,Za,er,bt,tr,kt,or,nr,sr,N,vt,ar,se,rr,Jt,ir,dr,Do,lr,cr,pr,we,hr,Pe,qn,ae,Le,Xo,yt,ur,Wo,mr,zn,S,Tt,fr,wt,gr,Kt,_r,br,kr,Pt,vr,Lt,yr,Tr,wr,O,$t,Pr,re,Lr,Qt,$r,qr,Go,zr,Br,xr,$e,Cr,qe,Bn,ie,ze,Ro,qt,Fr,Ho,jr,xn,B,zt,Er,Uo,Mr,Sr,Bt,Ar,Yt,Nr,Or,Ir,xt,Dr,Ct,Xr,Wr,Gr,z,Ft,Rr,de,Hr,Zt,Ur,Vr,Vo,Jr,Kr,Qr,Be,Yr,xe,Zr,Ce,ei,Fe,ti,je,Cn,le,Ee,Jo,jt,oi,Ko,ni,Fn,ce,Et,si,Me,Mt,ai,Se,jn;return r=new pe({}),He=new pe({}),Ke=new pe({}),Ze=new W({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16886/en/model_doc/plbart#transformers.PLBartModel">PLBartModel</a>.`,name:"vocab_size"},{anchor:"transformers.PLBartConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16886/src/transformers/models/plbart/tokenization_plbart.py#L302",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16886/en/model_doc/plbart#transformers.PLBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16886/src/transformers/models/plbart/modeling_plbart.py#L1272",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16886/src/transformers/models/plbart/modeling_plbart.py#L1411",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16886/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16886/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16886/src/transformers/models/plbart/modeling_plbart.py#L1566",returnDescription:`
<p>A <a
...
`}}),Se=new he({props:{anchor:"transformers.PLBartForCausalLM.forward.example",$$slots:{default:[Id]},$$scope:{ctx:$}}}),{c(){l=n("meta"),b=u(),p=n("h1"),f=n("a"),k=n("span"),v(r.$$.fragment),g=u(),x=n("span"),ns=i("PLBart"),rn=u(),D=n("p"),co=n("strong"),ss=i("DISCLAIMER:"),as=i(" If you see something strange, file a "),Ge=n("a"),rs=i("Github Issue"),is=i(` and assign
`),Re=n("a"),ds=i("@gchhablani"),ls=i("."),dn=u(),K=n("h2"),me=n("a"),po=n("span"),v(He.$$.fragment),cs=u(),ho=n("span"),ps=i("Overview of PLBart"),ln=u(),G=n("p"),hs=i("The PLBART model was proposed in "),Ue=n("a"),us=i("Unified Pre-training for Program Understanding and Generation"),ms=i(` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
inside the context manager `),It=n("a"),Xs=i("as_target_tokenizer()"),Ws=i(" to encode target text format."),_n=u(),Dt=n("ul"),To=n("li"),Gs=i("Supervised training"),bn=u(),v(Ze.$$.fragment),kn=u(),Xt=n("ul"),et=n("li"),wo=n("p"),Rs=i("Generation"),Hs=u(),Y=n("p"),Us=i("While generating the target text set the "),Po=n("code"),Vs=i("decoder_start_token_id"),Js=i(` to the target language id. The following
example shows how to translate Python to English using the `),Lo=n("code"),Ks=i("uclanlp/plbart-python-en_XX"),Qs=i(" model."),vn=u(),v(tt.$$.fragment),yn=u(),Z=n("h2"),_e=n("a"),$o=n("span"),v(ot.$$.fragment),Ys=u(),qo=n("span"),Zs=i("PLBartConfig"),Tn=u(),E=n("div"),v(nt.$$.fragment),ea=u(),ee=n("p"),ta=i("This is the configuration class to store the configuration of a "),Wt=n("a"),oa=i("PLBartModel"),na=i(`. It is used to instantiate an
...
adding special tokens. An PLBART sequence has the following format, where `),jo=n("code"),Sa=i("X"),Aa=i(" represents the sequence:"),Na=u(),ht=n("ul"),ut=n("li"),Eo=n("code"),Oa=i("input_ids"),Ia=i(" (for encoder) "),Mo=n("code"),Da=i("X [eos, src_lang_code]"),Xa=u(),mt=n("li"),So=n("code"),Wa=i("decoder_input_ids"),Ga=i(": (for decoder) "),Ao=n("code"),Ra=i("X [eos, tgt_lang_code]"),Ha=u(),No=n("p"),Ua=i(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
inside the context manager `),It=s(oo,"A",{href:!0});var Pi=a(It);Xs=d(Pi,"as_target_tokenizer()"),Pi.forEach(o),Ws=d(oo," to encode target text format."),oo.forEach(o),_n=m(t),Dt=s(t,"UL",{});var Li=a(Dt);To=s(Li,"LI",{});var $i=a(To);Gs=d($i,"Supervised training"),$i.forEach(o),Li.forEach(o),bn=m(t),y(Ze.$$.fragment,t),kn=m(t),Xt=s(t,"UL",{});var qi=a(Xt);et=s(qi,"LI",{});var Sn=a(et);wo=s(Sn,"P",{});var zi=a(wo);Rs=d(zi,"Generation"),zi.forEach(o),Hs=m(Sn),Y=s(Sn,"P",{});var no=a(Y);Us=d(no,"While generating the target text set the "),Po=s(no,"CODE",{});var Bi=a(Po);Vs=d(Bi,"decoder_start_token_id"),Bi.forEach(o),Js=d(no,` to the target language id. The following
example shows how to translate Python to English using the `),Lo=s(no,"CODE",{});var xi=a(Lo);Ks=d(xi,"uclanlp/plbart-python-en_XX"),xi.forEach(o),Qs=d(no," model."),no.forEach(o),Sn.forEach(o),qi.forEach(o),vn=m(t),y(tt.$$.fragment,t),yn=m(t),Z=s(t,"H2",{class:!0});var An=a(Z);_e=s(An,"A",{id:!0,class:!0,href:!0});var Ci=a(_e);$o=s(Ci,"SPAN",{});var Fi=a($o);y(ot.$$.fragment,Fi),Fi.forEach(o),Ci.forEach(o),Ys=m(An),qo=s(An,"SPAN",{});var ji=a(qo);Zs=d(ji,"PLBartConfig"),ji.forEach(o),An.forEach(o),Tn=m(t),E=s(t,"DIV",{class:!0});var Ae=a(E);y(nt.$$.fragment,Ae),ea=m(Ae),ee=s(Ae,"P",{});var so=a(ee);ta=d(so,"This is the configuration class to store the configuration of a "),Wt=s(so,"A",{href:!0});var Ei=a(Wt);oa=d(Ei,"PLBartModel"),Ei.forEach(o),na=d(so,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
`),st=s(so,"A",{href:!0,rel:!0});var Mi=a(st);sa=d(Mi,"uclanlp/plbart-base"),Mi.forEach(o),aa=d(so," architecture."),so.forEach(o),ra=m(Ae),te=s(Ae,"P",{});var ao=a(te);ia=d(ao,"Configuration objects inherit from "),Gt=s(ao,"A",{href:!0});var Si=a(Gt);da=d(Si,"PretrainedConfig"),Si.forEach(o),la=d(ao,` and can be used to control the model outputs. Read the
documentation from `),Rt=s(ao,"A",{href:!0});var Ai=a(Rt);ca=d(Ai,"PretrainedConfig"),Ai.forEach(o),pa=d(ao," for more information."),ao.forEach(o),ha=m(Ae),y(be.$$.fragment,Ae),Ae.forEach(o),wn=m(t),oe=s(t,"H2",{class:!0});var Nn=a(oe);ke=s(Nn,"A",{id:!0,class:!0,href:!0});var Ni=a(ke);zo=s(Ni,"SPAN",{});var Oi=a(zo);y(at.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),ua=m(Nn),Bo=s(Nn,"SPAN",{});var Ii=a(Bo);ma=d(Ii,"PLBartTokenizer"),Ii.forEach(o),Nn.forEach(o),Pn=m(t),q=s(t,"DIV",{class:!0});var F=a(q);y(rt.$$.fragment,F),fa=m(F),xo=s(F,"P",{});var Di=a(xo);ga=d(Di,"Construct an PLBART tokenizer."),Di.forEach(o),_a=m(F),X=s(F,"P",{});var Ne=a(X);ba=d(Ne,"Adapted from "),Ht=s(Ne,"A",{href:!0});var Xi=a(Ht);ka=d(Xi,"RobertaTokenizer"),Xi.forEach(o),va=d(Ne," and "),Ut=s(Ne,"A",{href:!0});var Wi=a(Ut);ya=d(Wi,"XLNetTokenizer"),Wi.forEach(o),Ta=d(Ne,`. Based on
`),it=s(Ne,"A",{href:!0,rel:!0});var Gi=a(it);wa=d(Gi,"SentencePiece"),Gi.forEach(o),Pa=d(Ne,"."),Ne.forEach(o),La=m(F),dt=s(F,"P",{});var On=a(dt);$a=d(On,"The tokenization method is "),Co=s(On,"CODE",{});var Ri=a(Co);qa=d(Ri,"<tokens> <eos> <language code>"),Ri.forEach(o),za=d(On," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),On.forEach(o),Ba=m(F),y(ve.$$.fragment,F),xa=m(F),ye=s(F,"DIV",{class:!0});var In=a(ye);y(lt.$$.fragment,In),Ca=m(In),Fo=s(In,"P",{});var Hi=a(Fo);Fa=d(Hi,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
adding special tokens. An PLBART sequence has the following format, where `),jo=s(Dn,"CODE",{});var Ui=a(jo);Sa=d(Ui,"X"),Ui.forEach(o),Aa=d(Dn," represents the sequence:"),Dn.forEach(o),Na=m(Oe),ht=s(Oe,"UL",{});var Xn=a(ht);ut=s(Xn,"LI",{});var Wn=a(ut);Eo=s(Wn,"CODE",{});var Vi=a(Eo);Oa=d(Vi,"input_ids"),Vi.forEach(o),Ia=d(Wn," (for encoder) "),Mo=s(Wn,"CODE",{});var Ji=a(Mo);Da=d(Ji,"X [eos, src_lang_code]"),Ji.forEach(o),Wn.forEach(o),Xa=m(Xn),mt=s(Xn,"LI",{});var Gn=a(mt);So=s(Gn,"CODE",{});var Ki=a(So);Wa=d(Ki,"decoder_input_ids"),Ki.forEach(o),Ga=d(Gn,": (for decoder) "),Ao=s(Gn,"CODE",{});var Qi=a(Ao);Ra=d(Qi,"X [eos, tgt_lang_code]"),Qi.forEach(o),Gn.forEach(o),Xn.forEach(o),Ha=m(Oe),No=s(Oe,"P",{});var Yi=a(No);Ua=d(Yi,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Yi.forEach(o),Oe.forEach(o),F.forEach(o),Ln=m(t),ne=s(t,"H2",{class:!0});var Rn=a(ne);Te=s(Rn,"A",{id:!0,class:!0,href:!0});var Zi=a(Te);Oo=s(Zi,"SPAN",{});var ed=a(Oo);y(ft.$$.fragment,ed),ed.forEach(o),Zi.forEach(o),Va=m(Rn),Io=s(Rn,"SPAN",{});var td=a(Io);Ja=d(td,"PLBartModel"),td.forEach(o),Rn.forEach(o),$n=m(t),M=s(t,"DIV",{class:!0});var Ie=a(M);y(gt.$$.fragment,Ie),Ka=m(Ie),_t=s(Ie,"P",{});var Hn=a(_t);Qa=d(Hn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kn.forEach(o),wr=m(Xe),O=s(Xe,"DIV",{class:!0});var We=a(O);y($t.$$.fragment,We),Pr=m(We),re=s(We,"P",{});var io=a(re);Lr=d(io,"The "),Qt=s(io,"A",{href:!0});var pd=a(Qt);$r=d(pd,"PLBartForConditionalGeneration"),pd.forEach(o),qr=d(io," forward method, overrides the "),Go=s(io,"CODE",{});var hd=a(Go);zr=d(hd,"__call__"),hd.forEach(o),Br=d(io," special method."),io.forEach(o),xr=m(We),y($e.$$.fragment,We),Cr=m(We),y(qe.$$.fragment,We),We.forEach(o),Xe.forEach(o),Bn=m(t),ie=s(t,"H2",{class:!0});var Qn=a(ie);ze=s(Qn,"A",{id:!0,class:!0,href:!0});var ud=a(ze);Ro=s(ud,"SPAN",{});var md=a(Ro);y(qt.$$.fragment,md),md.forEach(o),ud.forEach(o),Fr=m(Qn),Ho=s(Qn,"SPAN",{});var fd=a(Ho);jr=d(fd,"PLBartForSequenceClassification"),fd.forEach(o),Qn.forEach(o),xn=m(t),B=s(t,"DIV",{class:!0});var J=a(B);y(zt.$$.fragment,J),Er=m(J),Uo=s(J,"P",{});var gd=a(Uo);Mr=d(gd,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
