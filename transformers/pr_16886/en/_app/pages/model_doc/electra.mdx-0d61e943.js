...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16886/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16886/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16886/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16886/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16886/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16886/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16886/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16886/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16886/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16886/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16886/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16886/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16886/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16886/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16886/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16886/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16886/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16886/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16886/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16886/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`),Qi=s(Gf,"A",{href:!0,rel:!0});var a6=a(Qi);lw=i(a6,"flax.nn.Module"),a6.forEach(t),dw=i(Gf,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Gf.forEach(t),cw=p(gt),lh=s(gt,"P",{});var r6=a(lh);pw=i(r6,"Finally, this model supports inherent JAX features such as:"),r6.forEach(t),hw=p(gt),Vt=s(gt,"UL",{});var ha=a(Vt);dh=s(ha,"LI",{});var i6=a(dh);Bi=s(i6,"A",{href:!0,rel:!0});var l6=a(Bi);mw=i(l6,"Just-In-Time (JIT) compilation"),l6.forEach(t),i6.forEach(t),uw=p(ha),ch=s(ha,"LI",{});var d6=a(ch);Vi=s(d6,"A",{href:!0,rel:!0});var c6=a(Vi);fw=i(c6,"Automatic Differentiation"),c6.forEach(t),d6.forEach(t),gw=p(ha),ph=s(ha,"LI",{});var p6=a(ph);Ki=s(p6,"A",{href:!0,rel:!0});var h6=a(Ki);_w=i(h6,"Vectorization"),h6.forEach(t),p6.forEach(t),kw=p(ha),hh=s(ha,"LI",{});var m6=a(hh);Ji=s(m6,"A",{href:!0,rel:!0});var u6=a(Ji);vw=i(u6,"Parallelization"),u6.forEach(t),m6.forEach(t),ha.forEach(t),Tw=p(gt),qt=s(gt,"DIV",{class:!0});var ma=a(qt);y(Gi.$$.fragment,ma),bw=p(ma),an=s(ma,"P",{});var lc=a(an);yw=i(lc,"The "),mh=s(lc,"CODE",{});var f6=a(mh);Ew=i(f6,"FlaxElectraPreTrainedModel"),f6.forEach(t),ww=i(lc," forward method, overrides the "),uh=s(lc,"CODE",{});var g6=a(uh);$w=i(g6,"__call__"),g6.forEach(t),Fw=i(lc," special method."),lc.forEach(t),xw=p(ma),y(Ss.$$.fragment,ma),Mw=p(ma),y(Ds.$$.fragment,ma),ma.forEach(t),gt.forEach(t),Ou=p(o),rn=s(o,"H2",{class:!0});var Xf=a(rn);Ws=s(Xf,"A",{id:!0,class:!0,href:!0});var _6=a(Ws);fh=s(_6,"SPAN",{});var k6=a(fh);y(Xi.$$.fragment,k6),k6.forEach(t),_6.forEach(t),zw=p(Xf),gh=s(Xf,"SPAN",{});var v6=a(gh);Cw=i(v6,"FlaxElectraForSequenceClassification"),v6.forEach(t),Xf.forEach(t),Lu=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),jw=p(_t),_h=s(_t,"P",{});var T6=a(_h);qw=i(T6,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),T6.forEach(t),Pw=p(_t),Zi=s(_t,"P",{});var Yf=a(Zi);Aw=i(Yf,"This model inherits from "),Sd=s(Yf,"A",{href:!0});var b6=a(Sd);Ow=i(b6,"FlaxPreTrainedModel"),b6.forEach(t),Lw=i(Yf,`. Check the superclass documentation for the generic methods the
...
`),tl=s(Zf,"A",{href:!0,rel:!0});var y6=a(tl);Sw=i(y6,"flax.nn.Module"),y6.forEach(t),Dw=i(Zf,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Zf.forEach(t),Ww=p(_t),kh=s(_t,"P",{});var E6=a(kh);Uw=i(E6,"Finally, this model supports inherent JAX features such as:"),E6.forEach(t),Rw=p(_t),Kt=s(_t,"UL",{});var ua=a(Kt);vh=s(ua,"LI",{});var w6=a(vh);ol=s(w6,"A",{href:!0,rel:!0});var $6=a(ol);Hw=i($6,"Just-In-Time (JIT) compilation"),$6.forEach(t),w6.forEach(t),Qw=p(ua),Th=s(ua,"LI",{});var F6=a(Th);nl=s(F6,"A",{href:!0,rel:!0});var x6=a(nl);Bw=i(x6,"Automatic Differentiation"),x6.forEach(t),F6.forEach(t),Vw=p(ua),bh=s(ua,"LI",{});var M6=a(bh);sl=s(M6,"A",{href:!0,rel:!0});var z6=a(sl);Kw=i(z6,"Vectorization"),z6.forEach(t),M6.forEach(t),Jw=p(ua),yh=s(ua,"LI",{});var C6=a(yh);al=s(C6,"A",{href:!0,rel:!0});var j6=a(al);Gw=i(j6,"Parallelization"),j6.forEach(t),C6.forEach(t),ua.forEach(t),Xw=p(_t),Pt=s(_t,"DIV",{class:!0});var fa=a(Pt);y(rl.$$.fragment,fa),Yw=p(fa),ln=s(fa,"P",{});var dc=a(ln);Zw=i(dc,"The "),Eh=s(dc,"CODE",{});var q6=a(Eh);e$=i(q6,"FlaxElectraPreTrainedModel"),q6.forEach(t),t$=i(dc," forward method, overrides the "),wh=s(dc,"CODE",{});var P6=a(wh);o$=i(P6,"__call__"),P6.forEach(t),n$=i(dc," special method."),dc.forEach(t),s$=p(fa),y(Us.$$.fragment,fa),a$=p(fa),y(Rs.$$.fragment,fa),fa.forEach(t),_t.forEach(t),Nu=p(o),dn=s(o,"H2",{class:!0});var eg=a(dn);Hs=s(eg,"A",{id:!0,class:!0,href:!0});var A6=a(Hs);$h=s(A6,"SPAN",{});var O6=a($h);y(il.$$.fragment,O6),O6.forEach(t),A6.forEach(t),r$=p(eg),Fh=s(eg,"SPAN",{});var L6=a(Fh);i$=i(L6,"FlaxElectraForMultipleChoice"),L6.forEach(t),eg.forEach(t),Iu=p(o),We=s(o,"DIV",{class:!0});var kt=a(We);y(ll.$$.fragment,kt),l$=p(kt),xh=s(kt,"P",{});var N6=a(xh);d$=i(N6,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),og.forEach(t),k$=p(kt),Mh=s(kt,"P",{});var D6=a(Mh);v$=i(D6,"Finally, this model supports inherent JAX features such as:"),D6.forEach(t),T$=p(kt),Jt=s(kt,"UL",{});var ga=a(Jt);zh=s(ga,"LI",{});var W6=a(zh);hl=s(W6,"A",{href:!0,rel:!0});var U6=a(hl);b$=i(U6,"Just-In-Time (JIT) compilation"),U6.forEach(t),W6.forEach(t),y$=p(ga),Ch=s(ga,"LI",{});var R6=a(Ch);ml=s(R6,"A",{href:!0,rel:!0});var H6=a(ml);E$=i(H6,"Automatic Differentiation"),H6.forEach(t),R6.forEach(t),w$=p(ga),jh=s(ga,"LI",{});var Q6=a(jh);ul=s(Q6,"A",{href:!0,rel:!0});var B6=a(ul);$$=i(B6,"Vectorization"),B6.forEach(t),Q6.forEach(t),F$=p(ga),qh=s(ga,"LI",{});var V6=a(qh);fl=s(V6,"A",{href:!0,rel:!0});var K6=a(fl);x$=i(K6,"Parallelization"),K6.forEach(t),V6.forEach(t),ga.forEach(t),M$=p(kt),At=s(kt,"DIV",{class:!0});var _a=a(At);y(gl.$$.fragment,_a),z$=p(_a),cn=s(_a,"P",{});var cc=a(cn);C$=i(cc,"The "),Ph=s(cc,"CODE",{});var J6=a(Ph);j$=i(J6,"FlaxElectraPreTrainedModel"),J6.forEach(t),q$=i(cc," forward method, overrides the "),Ah=s(cc,"CODE",{});var G6=a(Ah);P$=i(G6,"__call__"),G6.forEach(t),A$=i(cc," special method."),cc.forEach(t),O$=p(_a),y(Qs.$$.fragment,_a),L$=p(_a),y(Bs.$$.fragment,_a),_a.forEach(t),kt.forEach(t),Su=p(o),pn=s(o,"H2",{class:!0});var ng=a(pn);Vs=s(ng,"A",{id:!0,class:!0,href:!0});var X6=a(Vs);Oh=s(X6,"SPAN",{});var Y6=a(Oh);y(_l.$$.fragment,Y6),Y6.forEach(t),X6.forEach(t),N$=p(ng),Lh=s(ng,"SPAN",{});var Z6=a(Lh);I$=i(Z6,"FlaxElectraForTokenClassification"),Z6.forEach(t),ng.forEach(t),Du=p(o),Ae=s(o,"DIV",{class:!0});var Ye=a(Ae);y(kl.$$.fragment,Ye),S$=p(Ye),Nh=s(Ye,"P",{});var eM=a(Nh);D$=i(eM,"Electra model with a token classification head on top."),eM.forEach(t),W$=p(Ye),Ih=s(Ye,"P",{});var tM=a(Ih);U$=i(tM,"Both the discriminator and generator may be loaded into this model."),tM.forEach(t),R$=p(Ye),vl=s(Ye,"P",{});var sg=a(vl);H$=i(sg,"This model inherits from "),Wd=s(sg,"A",{href:!0});var oM=a(Wd);Q$=i(oM,"FlaxPreTrainedModel"),oM.forEach(t),B$=i(sg,`. Check the superclass documentation for the generic methods the
