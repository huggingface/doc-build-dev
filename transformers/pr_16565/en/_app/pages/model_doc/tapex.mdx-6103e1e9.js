import{S as Fo,i as Co,s as No,e as o,k as d,w as v,t as r,M as Io,c as n,d as a,m as p,a as s,x as k,h as i,b as c,F as t,g as h,y as T,L as Xo,q as w,o as y,B as q,v as Bo}from"../../chunks/vendor-6b77c823.js";import{D as Wa}from"../../chunks/Docstring-af1d0ae0.js";import{C as Ra}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _t}from"../../chunks/IconCopyLink-7a11ce68.js";function Do(Ma){let x,Me,A,S,ye,W,bt,qe,vt,Ue,z,L,xe,R,kt,Ae,Tt,Oe,F,wt,M,yt,qt,Ge,ne,xt,He,f,se,U,At,zt,Et,re,O,jt,Pt,$t,ie,G,St,Lt,Ft,le,H,Ct,Nt,Ve,ce,It,Je,de,ze,Xt,Ze,pe,Bt,Ke,g,Ee,Dt,Qt,je,Wt,Rt,E,Mt,Pe,Ut,Ot,$e,Gt,Ht,Vt,j,Jt,Se,Zt,Kt,Le,Yt,ea,Ye,P,C,Fe,V,ta,Ce,aa,et,_,oa,he,na,sa,ue,ra,ia,me,la,ca,tt,J,at,N,da,fe,pa,ha,ot,Z,nt,b,ua,ge,ma,fa,_e,ga,_a,st,K,rt,$,I,Ne,Y,ba,Ie,va,it,u,ee,ka,Xe,Ta,wa,Be,ya,qa,De,xa,Aa,Qe,za,Ea,We,ja,Pa,te,$a,be,Sa,La,Fa,X,ae,Ca,Re,Na,Ia,ve,oe,lt;return W=new _t({}),R=new _t({}),V=new _t({}),J=new Ra({props:{code:`from transformers import AutoTokenizer, AutoModelForSeq2SeqLM
import pandas as pd
...
Refused`}}),Y=new _t({}),ee=new Wa({props:{name:"class transformers.TapexTokenizer",anchor:"transformers.TapexTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"do_lower_case",val:" = True"},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"max_cell_length",val:" = 15"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16565/src/transformers/models/tapex/tokenization_tapex.py#L201",parametersDescription:[{anchor:"transformers.TapexTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.TapexTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code>, <code>TapexTruncationStrategy</code> or <a href="/docs/transformers/pr_16565/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, &#x2014;
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}]}}),oe=new Wa({props:{name:"save_vocabulary",anchor:"transformers.TapexTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16565/src/transformers/models/tapex/tokenization_tapex.py#L494"}}),{c(){x=o("meta"),Me=d(),A=o("h1"),S=o("a"),ye=o("span"),v(W.$$.fragment),bt=d(),qe=o("span"),vt=r("TAPEX"),Ue=d(),z=o("h2"),L=o("a"),xe=o("span"),v(R.$$.fragment),kt=d(),Ae=o("span"),Tt=r("Overview"),Oe=d(),F=o("p"),wt=r("The TAPEX model was proposed in "),M=o("a"),yt=r("TAPEX: Table Pre-training via Learning a Neural SQL Executor"),qt=r(` by Qian Liu,
...
which it can be fine-tuned to answer natural language questions related to tabular data, as well as performing table fact checking.`),Ge=d(),ne=o("p"),xt=r("TAPEX has been fine-tuned on several datasets:"),He=d(),f=o("ul"),se=o("li"),U=o("a"),At=r("SQA"),zt=r(" (Sequential Question Answering by Microsoft)"),Et=d(),re=o("li"),O=o("a"),jt=r("WTQ"),Pt=r(" (Wiki Table Questions by Stanford University)"),$t=d(),ie=o("li"),G=o("a"),St=r("WikiSQL"),Lt=r(" (by Salesforce)"),Ft=d(),le=o("li"),H=o("a"),Ct=r("TabFact"),Nt=r(" (by USCB NLP Lab)."),Ve=d(),ce=o("p"),It=r("The abstract from the paper is the following:"),Je=d(),de=o("p"),ze=o("em"),Xt=r(`Recent progress in language model pre-training has achieved a great success via leveraging large-scale unstructured textual data. However, it is
...
and to achieve new state-of-the-art results on various downstream tasks.`),Ze=d(),pe=o("p"),Bt=r("Tips:"),Ke=d(),g=o("ul"),Ee=o("li"),Dt=r("TAPEX is a generative (seq2seq) model. One can directly plug in the weights of TAPEX into a BART model."),Qt=d(),je=o("li"),Wt=r("TAPEX has checkpoints on the hub that are either pre-trained only, or fine-tuned on WTQ, SQA, WikiSQL and TabFact."),Rt=d(),E=o("li"),Mt=r("Sentences + tables are presented to the model as "),Pe=o("code"),Ut=r('sentence + " " + linearized table'),Ot=r(`. The linearized table has the following format:
`),$e=o("code"),Gt=r("col: col1 | col2 | col 3 row 1 : val1 | val2 | val3 row 2 : ..."),Ht=r("."),Vt=d(),j=o("li"),Jt=r(`TAPEX has its own tokenizer, that allows to prepare all data for the model easily. One can pass Pandas DataFrames and strings to the tokenizer,
...
to be used by TAPEX models. The format that the TAPEX tokenizer creates is the following:`),qa=d(),De=o("p"),xa=r("sentence col: col1 | col2 | col 3 row 1 : val1 | val2 | val3 row 2 : \u2026"),Aa=d(),Qe=o("p"),za=r(`The tokenizer supports a single table + single query, a single table and multiple queries (in which case the table
...
this superclass for more information regarding those methods.`),Fa=d(),X=o("div"),v(ae.$$.fragment),Ca=d(),Re=o("p"),Na=r("Main method to tokenize and prepare for the model one or several table-sequence pair(s)."),Ia=d(),ve=o("div"),v(oe.$$.fragment),this.h()},l(e){const l=Io('[data-svelte="svelte-1phssyn"]',document.head);x=n(l,"META",{name:!0,content:!0}),l.forEach(a),Me=p(e),A=n(e,"H1",{class:!0});var ct=s(A);S=n(ct,"A",{id:!0,class:!0,href:!0});var Ua=s(S);ye=n(Ua,"SPAN",{});var Oa=s(ye);k(W.$$.fragment,Oa),Oa.forEach(a),Ua.forEach(a),bt=p(ct),qe=n(ct,"SPAN",{});var Ga=s(qe);vt=i(Ga,"TAPEX"),Ga.forEach(a),ct.forEach(a),Ue=p(e),z=n(e,"H2",{class:!0});var dt=s(z);L=n(dt,"A",{id:!0,class:!0,href:!0});var Ha=s(L);xe=n(Ha,"SPAN",{});var Va=s(xe);k(R.$$.fragment,Va),Va.forEach(a),Ha.forEach(a),kt=p(dt),Ae=n(dt,"SPAN",{});var Ja=s(Ae);Tt=i(Ja,"Overview"),Ja.forEach(a),dt.forEach(a),Oe=p(e),F=n(e,"P",{});var pt=s(F);wt=i(pt,"The TAPEX model was proposed in "),M=n(pt,"A",{href:!0,rel:!0});var Za=s(M);yt=i(Za,"TAPEX: Table Pre-training via Learning a Neural SQL Executor"),Za.forEach(a),qt=i(pt,` by Qian Liu,
Bei Chen, Jiaqi Guo, Morteza Ziyadi, Zeqi Lin, Weizhu Chen, Jian-Guang Lou. TAPEX pre-trains a BART model to solve synthetic SQL queries, after
which it can be fine-tuned to answer natural language questions related to tabular data, as well as performing table fact checking.`),pt.forEach(a),Ge=p(e),ne=n(e,"P",{});var Ka=s(ne);xt=i(Ka,"TAPEX has been fine-tuned on several datasets:"),Ka.forEach(a),He=p(e),f=n(e,"UL",{});var B=s(f);se=n(B,"LI",{});var Xa=s(se);U=n(Xa,"A",{href:!0,rel:!0});var Ya=s(U);At=i(Ya,"SQA"),Ya.forEach(a),zt=i(Xa," (Sequential Question Answering by Microsoft)"),Xa.forEach(a),Et=p(B),re=n(B,"LI",{});var Ba=s(re);O=n(Ba,"A",{href:!0,rel:!0});var eo=s(O);jt=i(eo,"WTQ"),eo.forEach(a),Pt=i(Ba," (Wiki Table Questions by Stanford University)"),Ba.forEach(a),$t=p(B),ie=n(B,"LI",{});var Da=s(ie);G=n(Da,"A",{href:!0,rel:!0});var to=s(G);St=i(to,"WikiSQL"),to.forEach(a),Lt=i(Da," (by Salesforce)"),Da.forEach(a),Ft=p(B),le=n(B,"LI",{});var Qa=s(le);H=n(Qa,"A",{href:!0,rel:!0});var ao=s(H);Ct=i(ao,"TabFact"),ao.forEach(a),Nt=i(Qa," (by USCB NLP Lab)."),Qa.forEach(a),B.forEach(a),Ve=p(e),ce=n(e,"P",{});var oo=s(ce);It=i(oo,"The abstract from the paper is the following:"),oo.forEach(a),Je=p(e),de=n(e,"P",{});var no=s(de);ze=n(no,"EM",{});var so=s(ze);Xt=i(so,`Recent progress in language model pre-training has achieved a great success via leveraging large-scale unstructured textual data. However, it is
still a challenge to apply pre-training on structured tabular data due to the absence of large-scale high-quality tabular data. In this paper, we
propose TAPEX to show that table pre-training can be achieved by learning a neural SQL executor over a synthetic corpus, which is obtained by automatically
synthesizing executable SQL queries and their execution outputs. TAPEX addresses the data scarcity challenge via guiding the language model to mimic a SQL
executor on the diverse, large-scale and high-quality synthetic corpus. We evaluate TAPEX on four benchmark datasets. Experimental results demonstrate that
...
this superclass for more information regarding those methods.`),ft.forEach(a),Fa=p(m),X=n(m,"DIV",{class:!0});var gt=s(X);k(ae.$$.fragment,gt),Ca=p(gt),Re=n(gt,"P",{});var So=s(Re);Na=i(So,"Main method to tokenize and prepare for the model one or several table-sequence pair(s)."),So.forEach(a),gt.forEach(a),Ia=p(m),ve=n(m,"DIV",{class:!0});var Lo=s(ve);k(oe.$$.fragment,Lo),Lo.forEach(a),m.forEach(a),this.h()},h(){c(x,"name","hf:doc:metadata"),c(x,"content",JSON.stringify(Qo)),c(S,"id","tapex"),c(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(S,"href","#tapex"),c(A,"class","relative group"),c(L,"id","overview"),c(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(L,"href","#overview"),c(z,"class","relative group"),c(M,"href","https://arxiv.org/abs/2107.07653"),c(M,"rel","nofollow"),c(U,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),c(U,"rel","nofollow"),c(O,"href","https://github.com/ppasupat/WikiTableQuestions"),c(O,"rel","nofollow"),c(G,"href","https://github.com/salesforce/WikiSQL"),c(G,"rel","nofollow"),c(H,"href","https://tabfact.github.io/"),c(H,"rel","nofollow"),c(C,"id","usage-inference"),c(C,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(C,"href","#usage-inference"),c(P,"class","relative group"),c(he,"href","auto"),c(ue,"href","/docs/transformers/pr_16565/en/model_doc/tapex#transformers.TapexTokenizer"),c(me,"href","/docs/transformers/pr_16565/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(fe,"href","/docs/transformers/pr_16565/en/model_doc/tapex#transformers.TapexTokenizer"),c(ge,"href","/docs/transformers/pr_16565/en/model_doc/bart#transformers.BartForSequenceClassification"),c(_e,"href","auto"),c(I,"id","transformers.TapexTokenizer"),c(I,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(I,"href","#transformers.TapexTokenizer"),c($,"class","relative group"),c(be,"href","/docs/transformers/pr_16565/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(X,"class","docstring"),c(ve,"class","docstring"),c(u,"class","docstring")},m(e,l){t(document.head,x),h(e,Me,l),h(e,A,l),t(A,S),t(S,ye),T(W,ye,null),t(A,bt),t(A,qe),t(qe,vt),h(e,Ue,l),h(e,z,l),t(z,L),t(L,xe),T(R,xe,null),t(z,kt),t(z,Ae),t(Ae,Tt),h(e,Oe,l),h(e,F,l),t(F,wt),t(F,M),t(M,yt),t(F,qt),h(e,Ge,l),h(e,ne,l),t(ne,xt),h(e,He,l),h(e,f,l),t(f,se),t(se,U),t(U,At),t(se,zt),t(f,Et),t(f,re),t(re,O),t(O,jt),t(re,Pt),t(f,$t),t(f,ie),t(ie,G),t(G,St),t(ie,Lt),t(f,Ft),t(f,le),t(le,H),t(H,Ct),t(le,Nt),h(e,Ve,l),h(e,ce,l),t(ce,It),h(e,Je,l),h(e,de,l),t(de,ze),t(ze,Xt),h(e,Ze,l),h(e,pe,l),t(pe,Bt),h(e,Ke,l),h(e,g,l),t(g,Ee),t(Ee,Dt),t(g,Qt),t(g,je),t(je,Wt),t(g,Rt),t(g,E),t(E,Mt),t(E,Pe),t(Pe,Ut),t(E,Ot),t(E,$e),t($e,Gt),t(E,Ht),t(g,Vt),t(g,j),t(j,Jt),t(j,Se),t(Se,Zt),t(j,Kt),t(j,Le),t(Le,Yt),t(j,ea),h(e,Ye,l),h(e,P,l),t(P,C),t(C,Fe),T(V,Fe,null),t(P,ta),t(P,Ce),t(Ce,aa),h(e,et,l),h(e,_,l),t(_,oa),t(_,he),t(he,na),t(_,sa),t(_,ue),t(ue,ra),t(_,ia),t(_,me),t(me,la),t(_,ca),h(e,tt,l),T(J,e,l),h(e,at,l),h(e,N,l),t(N,da),t(N,fe),t(fe,pa),t(N,ha),h(e,ot,l),T(Z,e,l),h(e,nt,l),h(e,b,l),t(b,ua),t(b,ge),t(ge,ma),t(b,fa),t(b,_e),t(_e,ga),t(b,_a),h(e,st,l),T(K,e,l),h(e,rt,l),h(e,$,l),t($,I),t(I,Ne),T(Y,Ne,null),t($,ba),t($,Ie),t(Ie,va),h(e,it,l),h(e,u,l),T(ee,u,null),t(u,ka),t(u,Xe),t(Xe,Ta),t(u,wa),t(u,Be),t(Be,ya),t(u,qa),t(u,De),t(De,xa),t(u,Aa),t(u,Qe),t(Qe,za),t(u,Ea),t(u,We),t(We,ja),t(u,Pa),t(u,te),t(te,$a),t(te,be),t(be,Sa),t(te,La),t(u,Fa),t(u,X),T(ae,X,null),t(X,Ca),t(X,Re),t(Re,Na),t(u,Ia),t(u,ve),T(oe,ve,null),lt=!0},p:Xo,i(e){lt||(w(W.$$.fragment,e),w(R.$$.fragment,e),w(V.$$.fragment,e),w(J.$$.fragment,e),w(Z.$$.fragment,e),w(K.$$.fragment,e),w(Y.$$.fragment,e),w(ee.$$.fragment,e),w(ae.$$.fragment,e),w(oe.$$.fragment,e),lt=!0)},o(e){y(W.$$.fragment,e),y(R.$$.fragment,e),y(V.$$.fragment,e),y(J.$$.fragment,e),y(Z.$$.fragment,e),y(K.$$.fragment,e),y(Y.$$.fragment,e),y(ee.$$.fragment,e),y(ae.$$.fragment,e),y(oe.$$.fragment,e),lt=!1},d(e){a(x),e&&a(Me),e&&a(A),q(W),e&&a(Ue),e&&a(z),q(R),e&&a(Oe),e&&a(F),e&&a(Ge),e&&a(ne),e&&a(He),e&&a(f),e&&a(Ve),e&&a(ce),e&&a(Je),e&&a(de),e&&a(Ze),e&&a(pe),e&&a(Ke),e&&a(g),e&&a(Ye),e&&a(P),q(V),e&&a(et),e&&a(_),e&&a(tt),q(J,e),e&&a(at),e&&a(N),e&&a(ot),q(Z,e),e&&a(nt),e&&a(b),e&&a(st),q(K,e),e&&a(rt),e&&a($),q(Y),e&&a(it),e&&a(u),q(ee),q(ae),q(oe)}}}const Qo={local:"tapex",sections:[{local:"overview",title:"Overview"},{local:"usage-inference",title:"Usage: inference"},{local:"transformers.TapexTokenizer",title:"TapexTokenizer"}],title:"TAPEX"};function Wo(Ma){return Bo(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Go extends Fo{constructor(x){super();Co(this,x,Wo,Do,No,{})}}export{Go as default,Qo as metadata};
