...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17366/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17366/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17366/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u$=h(bt),dh=s(bt,"P",{});var d6=a(dh);g$=i(d6,"Finally, this model supports inherent JAX features such as:"),d6.forEach(t),_$=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var c6=a(ch);Hi=s(c6,"A",{href:!0,rel:!0});var p6=a(Hi);b$=i(p6,"Just-In-Time (JIT) compilation"),p6.forEach(t),c6.forEach(t),k$=h(ca),ph=s(ca,"LI",{});var h6=a(ph);Qi=s(h6,"A",{href:!0,rel:!0});var m6=a(Qi);v$=i(m6,"Automatic Differentiation"),m6.forEach(t),h6.forEach(t),y$=h(ca),hh=s(ca,"LI",{});var f6=a(hh);Ji=s(f6,"A",{href:!0,rel:!0});var u6=a(Ji);T$=i(u6,"Vectorization"),u6.forEach(t),f6.forEach(t),w$=h(ca),mh=s(ca,"LI",{});var g6=a(mh);Vi=s(g6,"A",{href:!0,rel:!0});var _6=a(Vi);$$=i(_6,"Parallelization"),_6.forEach(t),g6.forEach(t),ca.forEach(t),F$=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);T(Ki.$$.fragment,pa),x$=h(pa),nn=s(pa,"P",{});var rc=a(nn);R$=i(rc,"The "),fh=s(rc,"CODE",{});var b6=a(fh);M$=i(b6,"FlaxRobertaPreTrainedModel"),b6.forEach(t),E$=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var k6=a(uh);z$=i(k6,"__call__"),k6.forEach(t),q$=i(rc," special method."),rc.forEach(t),C$=h(pa),T(Ds.$$.fragment,pa),j$=h(pa),T(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),Cf=h(o),sn=s(o,"H2",{class:!0});var Ju=a(sn);Ws=s(Ju,"A",{id:!0,class:!0,href:!0});var v6=a(Ws);gh=s(v6,"SPAN",{});var y6=a(gh);T(Gi.$$.fragment,y6),y6.forEach(t),v6.forEach(t),P$=h(Ju),_h=s(Ju,"SPAN",{});var T6=a(_h);L$=i(T6,"FlaxRobertaForSequenceClassification"),T6.forEach(t),Ju.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);T(Xi.$$.fragment,kt),A$=h(kt),bh=s(kt,"P",{});var w6=a(bh);O$=i(w6,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
