...
[DataCollatorForLanguageModeling](/docs/transformers/pr_15262/en/main_classes/data_collator#transformers.DataCollatorForLanguageModeling)) also apply some random data augmentation (like random masking)
on the formed batch.
...
<docstring><name>class transformers.DataCollatorForSeq2Seq</name><anchor>transformers.DataCollatorForSeq2Seq</anchor><source>https://github.com/huggingface/transformers/blob/pr_15262/src/transformers/data/data_collator.py#L514</source><parameters>[{"name": "tokenizer", "val": ": PreTrainedTokenizerBase"}, {"name": "model", "val": ": typing.Optional[typing.Any] = None"}, {"name": "padding", "val": ": typing.Union[bool, str, transformers.file_utils.PaddingStrategy] = True"}, {"name": "max_length", "val": ": typing.Optional[int] = None"}, {"name": "pad_to_multiple_of", "val": ": typing.Optional[int] = None"}, {"name": "label_pad_token_id", "val": ": int = -100"}, {"name": "return_tensors", "val": ": str = 'pt'"}]</parameters><paramsdesc>- **tokenizer** ([PreTrainedTokenizer](/docs/transformers/pr_15262/en/main_classes/tokenizer#transformers.PreTrainedTokenizer) or [PreTrainedTokenizerFast](/docs/transformers/pr_15262/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast)) --
  The tokenizer used for encoding the data.
- **model** ([PreTrainedModel](/docs/transformers/pr_15262/en/main_classes/model#transformers.PreTrainedModel)) --
...
BatchEncoding, with the `"special_tokens_mask"` key, as returned by a [PreTrainedTokenizer](/docs/transformers/pr_15262/en/main_classes/tokenizer#transformers.PreTrainedTokenizer) or a
[PreTrainedTokenizerFast](/docs/transformers/pr_15262/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast) with the argument `return_special_tokens_mask=True`.
...
This collator relies on details of the implementation of subword tokenization by [BertTokenizer](/docs/transformers/pr_15262/en/model_doc/bert#transformers.BertTokenizer), specifically
...
<div class="docstring">
<docstring><name>tf\_mask\_tokens</name><anchor>transformers.DataCollatorForPermutationLanguageModeling.tf_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/pr_15262/src/transformers/data/data_collator.py#L1328</source><parameters>[{"name": "inputs", "val": ": typing.Any"}]</parameters></docstring>
