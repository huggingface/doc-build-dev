...
above for more information.`),q.forEach(t),this.h()},h(){m(f,"href","/docs/transformers/pr_7/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(D,q){_(D,c,q),e(c,b),e(c,f),e(f,h),e(c,v),e(c,l),e(l,u),e(c,j)},d(D){D&&t(c)}}}function y0(W){let c,b,f,h,v,l,u,j,D,q,C,A,O,H;return{c(){c=a("p"),b=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){_(l,c,u),e(c,b),e(c,f),e(f,h),e(c,v)},d(l){l&&t(c)}}}function R0(W){let c,b,f,h,v;return h=new ue({props:{code:`from transformers import Wav2Vec2Processor, FlaxWav2Vec2Model
from datasets import load_dataset
import soundfile as sf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>hidden_states = model(input_values).last_hidden_state`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(h.$$.fragment)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Example:"),u.forEach(t),f=p(l),y(h.$$.fragment,l)},m(l,u){_(l,c,u),e(c,b),_(l,f,u),k(h,l,u),v=!0},p:fe,i(l){v||(T(h.$$.fragment,l),v=!0)},o(l){$(h.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(h,l)}}}function H0(W){let c,b,f,h,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),ua=new me({props:{$$slots:{default:[D0]},$$scope:{ctx:W}}}),ga=new he({props:{anchor:"transformers.TFWav2Vec2Model.call.example",$$slots:{default:[S0]},$$scope:{ctx:W}}}),Rn=new ee({}),Hn=new F({props:{name:"class transformers.TFWav2Vec2ForCTC",anchor:"transformers.TFWav2Vec2ForCTC",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_7/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),ja=new me({props:{$$slots:{default:[G0]},$$scope:{ctx:W}}}),Fa=new he({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[J0]},$$scope:{ctx:W}}}),{c(){c=a("meta"),b=d(),f=a("h1"),h=a("a"),v=a("span"),w(l.$$.fragment),u=d(),j=a("span"),D=r("Wav2Vec2"),q=d(),C=a("h2"),A=a("a"),O=a("span"),w(H.$$.fragment),S=d(),P=a("span"),je=r("Overview"),ge=d(),B=a("p"),U=r("The Wav2Vec2 model was proposed in "),_e=a("a"),Se=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),z=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),I=d(),Fe=a("p"),ve=r("The abstract from the paper is the following:"),Re=d(),Ce=a("p"),oe=a("em"),lt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
Auli.`),Li.forEach(t),Bu=p(Et),an=s(Et,"P",{});var Tp=n(an);Uu=i(Tp,"This model inherits from "),hi=s(Tp,"A",{href:!0});var my=n(hi);Ru=i(my,"PreTrainedModel"),my.forEach(t),Hu=i(Tp,`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ip.forEach(t),mv=p(rt),y(fa.$$.fragment,rt),hv=p(rt),Qe=s(rt,"DIV",{class:!0});var Sa=n(Qe);y(Un.$$.fragment,Sa),fv=p(Sa),co=s(Sa,"P",{});var Ri=n(co);uv=i(Ri,"The "),$i=s(Ri,"A",{href:!0});var sk=n($i);gv=i(sk,"TFWav2Vec2Model"),sk.forEach(t),_v=i(Ri," forward method, overrides the "),sc=s(Ri,"CODE",{});var nk=n(sc);vv=i(nk,"__call__"),nk.forEach(t),bv=i(Ri," special method."),Ri.forEach(t),wv=p(Sa),y(ua.$$.fragment,Sa),yv=p(Sa),y(ga.$$.fragment,Sa),Sa.forEach(t),rt.forEach(t),Pd=p(o),po=s(o,"H2",{class:!0});var Bp=n(po);_a=s(Bp,"A",{id:!0,class:!0,href:!0});var rk=n(_a);nc=s(rk,"SPAN",{});var ik=n(nc);y(Rn.$$.fragment,ik),ik.forEach(t),rk.forEach(t),kv=p(Bp),rc=s(Bp,"SPAN",{});var lk=n(rc);Tv=i(lk,"TFWav2Vec2ForCTC"),lk.forEach(t),Bp.forEach(t),qd=p(o),ce=s(o,"DIV",{class:!0});var it=n(ce);y(Hn.$$.fragment,it),$v=p(it),Xn=s(it,"P",{});var Up=n(Xn);xv=i(Up,"TFWav2Vec2 Model with a "),ic=s(Up,"CODE",{});var ck=n(ic);Wv=i(ck,"language modeling"),ck.forEach(t),Vv=i(Up," head on top for Connectionist Temporal Classification (CTC)."),Up.forEach(t),jv=p(it),Gn=s(it,"P",{});var Rp=n(Gn);Fv=i(Rp,"This model inherits from "),xi=s(Rp,"A",{href:!0});var dk=n(xi);Cv=i(dk,"TFPreTrainedModel"),dk.forEach(t),Ev=i(Rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp.forEach(t),Pv=p(it),Jn=s(it,"P",{});var Hp=n(Jn);qv=i(Hp,"This model is also a "),Zn=s(Hp,"A",{href:!0,rel:!0});var pk=n(Zn);zv=i(pk,"tf.keras.Model"),pk.forEach(t),Mv=i(Hp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp.forEach(t),Av=p(it),y(va.$$.fragment,it),Ov=p(it),Ye=s(it,"DIV",{class:!0});var Na=n(Ye);y(Kn.$$.fragment,Na),Lv=p(Na),mo=s(Na,"P",{});var Hi=n(mo);Dv=i(Hi,"The "),Wi=s(Hi,"A",{href:!0});var mk=n(Wi);Sv=i(mk,"TFWav2Vec2ForCTC"),mk.forEach(t),Nv=i(Hi," forward method, overrides the "),lc=s(Hi,"CODE",{});var hk=n(lc);Iv=i(hk,"__call__"),hk.forEach(t),Bv=i(Hi," special method."),Hi.forEach(t),Uv=p(Na),y(ba.$$.fragment,Na),Rv=p(Na),y(wa.$$.fragment,Na),Na.forEach(t),it.forEach(t),zd=p(o),ho=s(o,"H2",{class:!0});var Xp=n(ho);ya=s(Xp,"A",{id:!0,class:!0,href:!0});var fk=n(ya);cc=s(fk,"SPAN",{});var uk=n(cc);y(Qn.$$.fragment,uk),uk.forEach(t),fk.forEach(t),Hv=p(Xp),dc=s(Xp,"SPAN",{});var gk=n(dc);Xv=i(gk,"FlaxWav2Vec2Model"),gk.forEach(t),Xp.forEach(t),Md=p(o),K=s(o,"DIV",{class:!0});var Oe=n(K);y(Yn.$$.fragment,Oe),Gv=p(Oe),er=s(Oe,"P",{});var Gp=n(er);Jv=i(Gp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Yp.forEach(t),N2=p(Le),yc=s(Le,"P",{});var Lk=n(yc);I2=i(Lk,"Finally, this model supports inherent JAX features such as:"),Lk.forEach(t),B2=p(Le),wt=s(Le,"UL",{});var Ua=n(wt);kc=s(Ua,"LI",{});var Dk=n(kc);gr=s(Dk,"A",{href:!0,rel:!0});var Sk=n(gr);U2=i(Sk,"Just-In-Time (JIT) compilation"),Sk.forEach(t),Dk.forEach(t),R2=p(Ua),Tc=s(Ua,"LI",{});var Nk=n(Tc);_r=s(Nk,"A",{href:!0,rel:!0});var Ik=n(_r);H2=i(Ik,"Automatic Differentiation"),Ik.forEach(t),Nk.forEach(t),X2=p(Ua),$c=s(Ua,"LI",{});var Bk=n($c);vr=s(Bk,"A",{href:!0,rel:!0});var Uk=n(vr);G2=i(Uk,"Vectorization"),Uk.forEach(t),Bk.forEach(t),J2=p(Ua),xc=s(Ua,"LI",{});var Rk=n(xc);br=s(Rk,"A",{href:!0,rel:!0});var Hk=n(br);Z2=i(Hk,"Parallelization"),Hk.forEach(t),Rk.forEach(t),Ua.forEach(t),K2=p(Le),tt=s(Le,"DIV",{class:!0});var Ra=n(tt);y(wr.$$.fragment,Ra),Q2=p(Ra),_o=s(Ra,"P",{});var Ji=n(_o);Y2=i(Ji,"The "),Wc=s(Ji,"CODE",{});var Xk=n(Wc);eb=i(Xk,"FlaxWav2Vec2PreTrainedModel"),Xk.forEach(t),tb=i(Ji," forward method, overrides the "),Vc=s(Ji,"CODE",{});var Gk=n(Vc);ob=i(Gk,"__call__"),Gk.forEach(t),ab=i(Ji," special method."),Ji.forEach(t),sb=p(Ra),y(xa.$$.fragment,Ra),nb=p(Ra),y(Wa.$$.fragment,Ra),Ra.forEach(t),Le.forEach(t),Ld=p(o),vo=s(o,"H2",{class:!0});var em=n(vo);Va=s(em,"A",{id:!0,class:!0,href:!0});var Jk=n(Va);jc=s(Jk,"SPAN",{});var Zk=n(jc);y(yr.$$.fragment,Zk),Zk.forEach(t),Jk.forEach(t),rb=p(em),Fc=s(em,"SPAN",{});var Kk=n(Fc);ib=i(Kk,"FlaxWav2Vec2ForPreTraining"),Kk.forEach(t),em.forEach(t),Dd=p(o),Y=s(o,"DIV",{class:!0});var De=n(Y);y(kr.$$.fragment,De),lb=p(De),bo=s(De,"P",{});var Zi=n(bo);cb=i(Zi,"Wav2Vec2 Model with a quantizer and "),Cc=s(Zi,"CODE",{});var Qk=n(Cc);db=i(Qk,"VQ"),Qk.forEach(t),pb=i(Zi,` head on top.
