import{S as dh,i as ih,s as ch,e as n,k as i,w as y,t as s,M as ph,c as a,d as o,m as c,a as r,x as v,h as l,b as m,G as e,g as _,y as T,q as w,o as S,B as $,v as mh,L as Xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Fn}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Je}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function uh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function hh(z){let p,k,f,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=r(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(d,h){_(d,p,h),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&o(p)}}}function fh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallTokenizer, BlenderbotSmallModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">512</span>]`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function _h(z){let p,k,f,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=r(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(d,h){_(d,p,h),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&o(p)}}}function gh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallTokenizer, BlenderbotSmallForConditionalGeneration
...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function kh(z){let p,k,f,u,b,d,h,q,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,Q,V,Ie,Z,j,L,he,ae,Be,J,D,be,re,N,ke,se,ze,ee,le,de,Ae,X,qe,H,De;return{c(){p=n("p"),k=s("TF 2.0 models accepts two formats as inputs:"),f=i(),u=n("ul"),b=n("li"),d=s("having all inputs as keyword arguments (like PyTorch models), or"),h=i(),q=n("li"),Ce=s("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),B=n("p"),je=s("This second option is useful when using "),W=n("code"),Oe=s("tf.keras.Model.fit"),Pe=s(` method which currently requires having all the
...
first positional argument :`),Z=i(),j=n("ul"),L=n("li"),he=s("a single Tensor with "),ae=n("code"),Be=s("input_ids"),J=s(" only and nothing else: "),D=n("code"),be=s("model(input_ids)"),re=i(),N=n("li"),ke=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),se=n("code"),ze=s("model([input_ids, attention_mask])"),ee=s(" or "),le=n("code"),de=s("model([input_ids, attention_mask, token_type_ids])"),Ae=i(),X=n("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),De=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=a(x,"P",{});var F=r(p);k=l(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),f=c(x),u=a(x,"UL",{});var ie=r(u);b=a(ie,"LI",{});var Ze=r(b);d=l(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(o),h=c(ie),q=a(ie,"LI",{});var Re=r(q);Ce=l(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=c(x),B=a(x,"P",{});var O=r(B);je=l(O,"This second option is useful when using "),W=a(O,"CODE",{});var eo=r(W);Oe=l(eo,"tf.keras.Model.fit"),eo.forEach(o),Pe=l(O,` method which currently requires having all the
...
`),se=a(oe,"CODE",{});var ce=r(se);ze=l(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=l(oe," or "),le=a(oe,"CODE",{});var fe=r(le);de=l(fe,"model([input_ids, attention_mask, token_type_ids])"),fe.forEach(o),oe.forEach(o),Ae=c(Y),X=a(Y,"LI",{});var ve=r(X);qe=l(ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=a(ve,"CODE",{});var Te=r(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ve.forEach(o),Y.forEach(o)},m(x,F){_(x,p,F),e(p,k),_(x,f,F),_(x,u,F),e(u,b),e(b,d),e(u,h),e(u,q),e(q,Ce),_(x,ue,F),_(x,B,F),e(B,je),e(B,W),e(W,Oe),e(B,Pe),e(B,R),e(R,Le),e(B,Ne),_(x,Q,F),_(x,V,F),e(V,Ie),_(x,Z,F),_(x,j,F),e(j,L),e(L,he),e(L,ae),e(ae,Be),e(L,J),e(L,D),e(D,be),e(j,re),e(j,N),e(N,ke),e(N,se),e(se,ze),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,qe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(u),x&&o(ue),x&&o(B),x&&o(Q),x&&o(V),x&&o(Z),x&&o(j)}}}function yh(z){let p,k,f,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=r(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(d,h){_(d,p,h),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&o(p)}}}function vh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Th(z){let p,k,f,u,b,d,h,q,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,Q,V,Ie,Z,j,L,he,ae,Be,J,D,be,re,N,ke,se,ze,ee,le,de,Ae,X,qe,H,De;return{c(){p=n("p"),k=s("TF 2.0 models accepts two formats as inputs:"),f=i(),u=n("ul"),b=n("li"),d=s("having all inputs as keyword arguments (like PyTorch models), or"),h=i(),q=n("li"),Ce=s("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),B=n("p"),je=s("This second option is useful when using "),W=n("code"),Oe=s("tf.keras.Model.fit"),Pe=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),Le=s("model(inputs)"),Ne=s("."),Q=i(),V=n("p"),Ie=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=i(),j=n("ul"),L=n("li"),he=s("a single Tensor with "),ae=n("code"),Be=s("input_ids"),J=s(" only and nothing else: "),D=n("code"),be=s("model(input_ids)"),re=i(),N=n("li"),ke=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),se=n("code"),ze=s("model([input_ids, attention_mask])"),ee=s(" or "),le=n("code"),de=s("model([input_ids, attention_mask, token_type_ids])"),Ae=i(),X=n("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),De=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=a(x,"P",{});var F=r(p);k=l(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),f=c(x),u=a(x,"UL",{});var ie=r(u);b=a(ie,"LI",{});var Ze=r(b);d=l(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(o),h=c(ie),q=a(ie,"LI",{});var Re=r(q);Ce=l(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=c(x),B=a(x,"P",{});var O=r(B);je=l(O,"This second option is useful when using "),W=a(O,"CODE",{});var eo=r(W);Oe=l(eo,"tf.keras.Model.fit"),eo.forEach(o),Pe=l(O,` method which currently requires having all the
...
first positional argument :`),oo.forEach(o),Z=c(x),j=a(x,"UL",{});var Y=r(j);L=a(Y,"LI",{});var G=r(L);he=l(G,"a single Tensor with "),ae=a(G,"CODE",{});var to=r(ae);Be=l(to,"input_ids"),to.forEach(o),J=l(G," only and nothing else: "),D=a(G,"CODE",{});var no=r(D);be=l(no,"model(input_ids)"),no.forEach(o),G.forEach(o),re=c(Y),N=a(Y,"LI",{});var oe=r(N);ke=l(oe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),se=a(oe,"CODE",{});var ce=r(se);ze=l(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=l(oe," or "),le=a(oe,"CODE",{});var fe=r(le);de=l(fe,"model([input_ids, attention_mask, token_type_ids])"),fe.forEach(o),oe.forEach(o),Ae=c(Y),X=a(Y,"LI",{});var ve=r(X);qe=l(ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=a(ve,"CODE",{});var Te=r(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ve.forEach(o),Y.forEach(o)},m(x,F){_(x,p,F),e(p,k),_(x,f,F),_(x,u,F),e(u,b),e(b,d),e(u,h),e(u,q),e(q,Ce),_(x,ue,F),_(x,B,F),e(B,je),e(B,W),e(W,Oe),e(B,Pe),e(B,R),e(R,Le),e(B,Ne),_(x,Q,F),_(x,V,F),e(V,Ie),_(x,Z,F),_(x,j,F),e(j,L),e(L,he),e(L,ae),e(ae,Be),e(L,J),e(L,D),e(D,be),e(j,re),e(j,N),e(N,ke),e(N,se),e(se,ze),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,qe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(u),x&&o(ue),x&&o(B),x&&o(Q),x&&o(V),x&&o(Z),x&&o(j)}}}function wh(z){let p,k,f,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=r(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(d,h){_(d,p,h),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&o(p)}}}function Sh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Bh(z){let p,k,f,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=r(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(d,h){_(d,p,h),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&o(p)}}}function zh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;np&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function qh(z){let p,k,f,u,b;return u=new Ye({props:{code:`import jax.numpy as jnp
from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=s("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=r(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Fh(z){let p,k,f,u,b,d,h,q,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,Q,V,Ie,Z,j,L,he,ae,Be,J,D,be,re,N,ke,se,ze,ee,le,de,Ae,X,qe,H,De,x,F,ie,Ze,Re,O,eo,ye,oo,Y,G,to,no,oe,ce,fe,ve,Te,ml,sa,ul,cs,we,ut,hl,ao,fl,En,_l,gl,ht,bl,kl,yl,ro,vl,Mn,Tl,wl,Cn,Sl,$l,xl,wo,ps,so,So,la,ft,Bl,da,zl,ms,U,_t,ql,ia,Fl,El,gt,Ml,jn,Cl,jl,Ol,He,bt,Pl,ca,Ll,Nl,pa,Il,Al,$o,kt,Dl,lo,Gl,ma,Ul,Wl,ua,Rl,Hl,Kl,Ke,yt,Ql,On,Vl,Pn,Jl,Xl,ha,Yl,Zl,Ln,vt,us,io,xo,fa,Tt,ed,_a,od,hs,Ge,wt,td,St,nd,ga,ad,rd,sd,Bo,$t,ld,ba,dd,fs,co,zo,ka,xt,id,ya,cd,_s,Se,Bt,pd,zt,md,Nn,ud,hd,fd,qt,_d,Ft,gd,bd,kd,Fe,Et,yd,po,vd,In,Td,wd,va,Sd,$d,xd,qo,Bd,Fo,gs,mo,Eo,Ta,Mt,zd,wa,qd,bs,$e,Ct,Fd,jt,Ed,An,Md,Cd,jd,Ot,Od,Pt,Pd,Ld,Nd,Ee,Lt,Id,uo,Ad,Dn,Dd,Gd,Sa,Ud,Wd,Rd,Mo,Hd,Co,ks,ho,jo,$a,Nt,Kd,xa,Qd,ys,fo,It,Vd,Oo,At,Jd,Po,vs,_o,Lo,Ba,Dt,Xd,za,Yd,Ts,pe,Gt,Zd,Ut,ei,Gn,oi,ti,ni,Wt,ai,Rt,ri,si,li,No,di,Me,Ht,ii,go,ci,Un,pi,mi,qa,ui,hi,fi,Io,_i,Ao,ws,bo,Do,Fa,Kt,gi,Ea,bi,Ss,me,Qt,ki,Vt,yi,Wn,vi,Ti,wi,Jt,Si,Xt,$i,xi,Bi,Go,zi,P,Yt,qi,ko,Fi,Rn,Ei,Mi,Ma,Ci,ji,Oi,Uo,Pi,Ca,Li,Ni,ja,Oa,Pa,La,Ii,Ai,Na,Ia,Aa,Da,Di,Gi,Ga,Ua,Wa,Ra,Ui,Wi,Ha,Ka,Qa,Zt,Ri,Va,Hi,Ki,Qi,Ja,Xa,Ya,Za,Vi,$s,yo,Wo,er,en,Ji,or,Xi,xs,I,on,Yi,tn,Zi,Hn,ec,oc,tc,nn,nc,an,ac,rc,sc,tr,lc,dc,Ue,nr,rn,ic,cc,ar,sn,pc,mc,rr,ln,uc,hc,sr,dn,fc,_c,Ro,cn,gc,Ho,bc,Ko,pn,kc,Qo,yc,Vo,mn,vc,Jo,Bs,vo,Xo,lr,un,Tc,dr,wc,zs,A,hn,Sc,fn,$c,Kn,xc,Bc,zc,_n,qc,gn,Fc,Ec,Mc,ir,Cc,jc,We,cr,bn,Oc,Pc,pr,kn,Lc,Nc,mr,yn,Ic,Ac,ur,vn,Dc,Gc,E,Tn,Uc,To,Wc,hr,Rc,Hc,fr,Kc,Qc,Vc,Yo,Jc,_r,Xc,Yc,gr,br,kr,yr,Zc,ep,vr,Tr,wr,Sr,op,tp,$r,xr,Br,zr,np,ap,qr,Fr,wn,Zo,et,Er,Sn,rp,Mr,sp,lp,Cr,dp,ip,jr,cp,pp,Or,Pr,Lr,Nr,mp,up,Ir,Ar,Dr,Gr,hp,fp,Ur,Wr,Rr,Hr,_p,gp,Kr,Qr,Vr,Jr,bp,kp,ot,$n,yp,tt,vp,nt,xn,Tp,at,qs;return d=new xe({}),re=new xe({}),Te=new xe({}),ut=new C({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/tokenization_blenderbot_small_fast.py#L98",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_7/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1108",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_7/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1251",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_7/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1266",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_7/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L972",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_7/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1035",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_7/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1151",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_7/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_7/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1307",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_7/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[qh]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=i(),f=n("h1"),u=n("a"),b=n("span"),y(d.$$.fragment),h=i(),q=n("span"),Ce=s("Blenderbot Small"),ue=i(),B=n("p"),je=s("Note that "),W=n("a"),Oe=s("BlenderbotSmallModel"),Pe=s(` and
...
`),he=n("a"),ae=s("BlenderbotForConditionalGeneration"),Be=i(),J=n("h2"),D=n("a"),be=n("span"),y(re.$$.fragment),N=i(),ke=n("span"),se=s("Overview"),ze=i(),ee=n("p"),le=s("The Blender chatbot model was proposed in "),de=n("a"),Ae=s("Recipes for building an open-domain chatbot"),X=s(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),qe=i(),H=n("p"),De=s("The abstract of the paper is the following:"),x=i(),F=n("p"),ie=n("em"),Ze=s(`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
...
documentation from `),Cn=n("a"),Sl=s("PretrainedConfig"),$l=s(" for more information."),xl=i(),y(wo.$$.fragment),ps=i(),so=n("h2"),So=n("a"),la=n("span"),y(ft.$$.fragment),Bl=i(),da=n("span"),zl=s("BlenderbotSmallTokenizer"),ms=i(),U=n("div"),y(_t.$$.fragment),ql=i(),ia=n("p"),Fl=s("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),El=i(),gt=n("p"),Ml=s("This tokenizer inherits from "),jn=n("a"),Cl=s("PreTrainedTokenizer"),jl=s(` which contains most of the main methods. Users should refer to
...
IDs?`),Xl=i(),ha=n("p"),Yl=s("Should be overridden in a subclass if the model has a special way of building those."),Zl=i(),Ln=n("div"),y(vt.$$.fragment),us=i(),io=n("h2"),xo=n("a"),fa=n("span"),y(Tt.$$.fragment),ed=i(),_a=n("span"),od=s("BlenderbotSmallTokenizerFast"),hs=i(),Ge=n("div"),y(wt.$$.fragment),td=i(),St=n("p"),nd=s("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=n("em"),ad=s("tokenizers"),rd=s(" library)."),sd=i(),Bo=n("div"),y($t.$$.fragment),ld=i(),ba=n("p"),dd=s(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),fs=i(),co=n("h2"),zo=n("a"),ka=n("span"),y(xt.$$.fragment),id=i(),ya=n("span"),cd=s("BlenderbotSmallModel"),_s=i(),Se=n("div"),y(Bt.$$.fragment),pd=i(),zt=n("p"),md=s(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
etc.)`),fd=i(),qt=n("p"),_d=s("This model is also a PyTorch "),Ft=n("a"),gd=s("torch.nn.Module"),bd=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kd=i(),Fe=n("div"),y(Et.$$.fragment),yd=i(),po=n("p"),vd=s("The "),In=n("a"),Td=s("BlenderbotSmallModel"),wd=s(" forward method, overrides the "),va=n("code"),Sd=s("__call__"),$d=s(" special method."),xd=i(),y(qo.$$.fragment),Bd=i(),y(Fo.$$.fragment),gs=i(),mo=n("h2"),Eo=n("a"),Ta=n("span"),y(Mt.$$.fragment),zd=i(),wa=n("span"),qd=s("BlenderbotSmallForConditionalGeneration"),bs=i(),$e=n("div"),y(Ct.$$.fragment),Fd=i(),jt=n("p"),Ed=s(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
behavior.`),li=i(),y(No.$$.fragment),di=i(),Me=n("div"),y(Ht.$$.fragment),ii=i(),go=n("p"),ci=s("The "),Un=n("a"),pi=s("TFBlenderbotSmallModel"),mi=s(" forward method, overrides the "),qa=n("code"),ui=s("__call__"),hi=s(" special method."),fi=i(),y(Io.$$.fragment),_i=i(),y(Ao.$$.fragment),ws=i(),bo=n("h2"),Do=n("a"),Fa=n("span"),y(Kt.$$.fragment),gi=i(),Ea=n("span"),bi=s("TFBlenderbotSmallForConditionalGeneration"),Ss=i(),me=n("div"),y(Qt.$$.fragment),ki=i(),Vt=n("p"),yi=s(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zc=i(),_n=n("p"),qc=s(`This model is also a Flax Linen
`),gn=n("a"),Fc=s("flax.nn.Module"),Ec=s(` subclass. Use it as a
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),ap=i(),qr=n("blockquote"),Fr=n("blockquote"),wn=n("blockquote"),Zo=n("h1"),et=n("a"),Er=n("span"),y(Sn.$$.fragment),rp=i(),Mr=n("span"),sp=s("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),lp=i(),Cr=n("p"),dp=s("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),ip=i(),jr=n("p"),cp=s("Mask filling example:"),pp=i(),Or=n("blockquote"),Pr=n("blockquote"),Lr=n("blockquote"),Nr=n("p"),mp=s(`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
...
`),he=a(_e,"A",{href:!0});var as=r(he);ae=l(as,"BlenderbotForConditionalGeneration"),as.forEach(o),_e.forEach(o),Be=c(t),J=a(t,"H2",{class:!0});var zn=r(J);D=a(zn,"A",{id:!0,class:!0,href:!0});var rs=r(D);be=a(rs,"SPAN",{});var ss=r(be);v(re.$$.fragment,ss),ss.forEach(o),rs.forEach(o),N=c(zn),ke=a(zn,"SPAN",{});var ls=r(ke);se=l(ls,"Overview"),ls.forEach(o),zn.forEach(o),ze=c(t),ee=a(t,"P",{});var qn=r(ee);le=l(qn,"The Blender chatbot model was proposed in "),de=a(qn,"A",{href:!0,rel:!0});var ds=r(de);Ae=l(ds,"Recipes for building an open-domain chatbot"),ds.forEach(o),X=l(qn,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),qn.forEach(o),qe=c(t),H=a(t,"P",{});var is=r(H);De=l(is,"The abstract of the paper is the following:"),is.forEach(o),x=c(t),F=a(t,"P",{});var Sp=r(F);ie=a(Sp,"EM",{});var $p=r(ie);Ze=l($p,`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
scaling neural models in the number of parameters and the size of the data they are trained on gives improved results,
we show that other ingredients are important for a high-performing chatbot. Good conversation requires a number of
skills that an expert conversationalist blends in a seamless way: providing engaging talking points and listening to
their partners, and displaying knowledge, empathy and personality appropriately, while maintaining a consistent
...
found `),G=a(Qn,"A",{href:!0,rel:!0});var Bp=r(G);to=l(Bp,"here"),Bp.forEach(o),no=l(Qn," ."),Qn.forEach(o),oe=c(t),ce=a(t,"H2",{class:!0});var Fs=r(ce);fe=a(Fs,"A",{id:!0,class:!0,href:!0});var zp=r(fe);ve=a(zp,"SPAN",{});var qp=r(ve);v(Te.$$.fragment,qp),qp.forEach(o),zp.forEach(o),ml=c(Fs),sa=a(Fs,"SPAN",{});var Fp=r(sa);ul=l(Fp,"BlenderbotSmallConfig"),Fp.forEach(o),Fs.forEach(o),cs=c(t),we=a(t,"DIV",{class:!0});var rt=r(we);v(ut.$$.fragment,rt),hl=c(rt),ao=a(rt,"P",{});var Vn=r(ao);fl=l(Vn,"This is the configuration class to store the configuration of a "),En=a(Vn,"A",{href:!0});var Ep=r(En);_l=l(Ep,"BlenderbotSmallModel"),Ep.forEach(o),gl=l(Vn,`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
...
documentation from `),Cn=a(Jn,"A",{href:!0});var jp=r(Cn);Sl=l(jp,"PretrainedConfig"),jp.forEach(o),$l=l(Jn," for more information."),Jn.forEach(o),xl=c(rt),v(wo.$$.fragment,rt),rt.forEach(o),ps=c(t),so=a(t,"H2",{class:!0});var Es=r(so);So=a(Es,"A",{id:!0,class:!0,href:!0});var Op=r(So);la=a(Op,"SPAN",{});var Pp=r(la);v(ft.$$.fragment,Pp),Pp.forEach(o),Op.forEach(o),Bl=c(Es),da=a(Es,"SPAN",{});var Lp=r(da);zl=l(Lp,"BlenderbotSmallTokenizer"),Lp.forEach(o),Es.forEach(o),ms=c(t),U=a(t,"DIV",{class:!0});var ge=r(U);v(_t.$$.fragment,ge),ql=c(ge),ia=a(ge,"P",{});var Np=r(ia);Fl=l(Np,"Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),Np.forEach(o),El=c(ge),gt=a(ge,"P",{});var Ms=r(gt);Ml=l(Ms,"This tokenizer inherits from "),jn=a(Ms,"A",{href:!0});var Ip=r(jn);Cl=l(Ip,"PreTrainedTokenizer"),Ip.forEach(o),jl=l(Ms,` which contains most of the main methods. Users should refer to
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ns.forEach(o),fd=c(st),qt=a(st,"P",{});var Is=r(qt);_d=l(Is,"This model is also a PyTorch "),Ft=a(Is,"A",{href:!0,rel:!0});var tm=r(Ft);gd=l(tm,"torch.nn.Module"),tm.forEach(o),bd=l(Is,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Is.forEach(o),kd=c(st),Fe=a(st,"DIV",{class:!0});var lt=r(Fe);v(Et.$$.fragment,lt),yd=c(lt),po=a(lt,"P",{});var oa=r(po);vd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=r(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),va=a(oa,"CODE",{});var am=r(va);Sd=l(am,"__call__"),am.forEach(o),$d=l(oa," special method."),oa.forEach(o),xd=c(lt),v(qo.$$.fragment,lt),Bd=c(lt),v(Fo.$$.fragment,lt),lt.forEach(o),st.forEach(o),gs=c(t),mo=a(t,"H2",{class:!0});var As=r(mo);Eo=a(As,"A",{id:!0,class:!0,href:!0});var rm=r(Eo);Ta=a(rm,"SPAN",{});var sm=r(Ta);v(Mt.$$.fragment,sm),sm.forEach(o),rm.forEach(o),zd=c(As),wa=a(As,"SPAN",{});var lm=r(wa);qd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),As.forEach(o),bs=c(t),$e=a(t,"DIV",{class:!0});var dt=r($e);v(Ct.$$.fragment,dt),Fd=c(dt),jt=a(dt,"P",{});var Ds=r(jt);Ed=l(Ds,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qs.forEach(o),li=c(Qe),v(No.$$.fragment,Qe),di=c(Qe),Me=a(Qe,"DIV",{class:!0});var ct=r(Me);v(Ht.$$.fragment,ct),ii=c(ct),go=a(ct,"P",{});var na=r(go);ci=l(na,"The "),Un=a(na,"A",{href:!0});var ym=r(Un);pi=l(ym,"TFBlenderbotSmallModel"),ym.forEach(o),mi=l(na," forward method, overrides the "),qa=a(na,"CODE",{});var vm=r(qa);ui=l(vm,"__call__"),vm.forEach(o),hi=l(na," special method."),na.forEach(o),fi=c(ct),v(Io.$$.fragment,ct),_i=c(ct),v(Ao.$$.fragment,ct),ct.forEach(o),Qe.forEach(o),ws=c(t),bo=a(t,"H2",{class:!0});var Vs=r(bo);Do=a(Vs,"A",{id:!0,class:!0,href:!0});var Tm=r(Do);Fa=a(Tm,"SPAN",{});var wm=r(Fa);v(Kt.$$.fragment,wm),wm.forEach(o),Tm.forEach(o),gi=c(Vs),Ea=a(Vs,"SPAN",{});var Sm=r(Ea);bi=l(Sm,"TFBlenderbotSmallForConditionalGeneration"),Sm.forEach(o),Vs.forEach(o),Ss=c(t),me=a(t,"DIV",{class:!0});var Ve=r(me);v(Qt.$$.fragment,Ve),ki=c(Ve),Vt=a(Ve,"P",{});var Js=r(Vt);yi=l(Js,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xs.forEach(o),Bi=c(Ve),v(Go.$$.fragment,Ve),zi=c(Ve),P=a(Ve,"DIV",{class:!0});var K=r(P);v(Yt.$$.fragment,K),qi=c(K),ko=a(K,"P",{});var aa=r(ko);Fi=l(aa,"The "),Rn=a(aa,"A",{href:!0});var Bm=r(Rn);Ei=l(Bm,"TFBlenderbotSmallForConditionalGeneration"),Bm.forEach(o),Mi=l(aa," forward method, overrides the "),Ma=a(aa,"CODE",{});var zm=r(Ma);Ci=l(zm,"__call__"),zm.forEach(o),ji=l(aa," special method."),aa.forEach(o),Oi=c(K),v(Uo.$$.fragment,K),Pi=c(K),Ca=a(K,"P",{});var qm=r(Ca);Li=l(qm,"Conversation example::"),qm.forEach(o),Ni=c(K),ja=a(K,"BLOCKQUOTE",{});var Fm=r(ja);Oa=a(Fm,"BLOCKQUOTE",{});var Em=r(Oa);Pa=a(Em,"BLOCKQUOTE",{});var Mm=r(Pa);La=a(Mm,"P",{});var Cm=r(La);Ii=l(Cm,`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
\u2018facebook/blenderbot_small-90M\u2019 >>> model = BlenderbotSmallForConditionalGeneration.from_pretrained(mname) >>>
tokenizer = BlenderbotSmallTokenizer.from_pretrained(mname)`),Cm.forEach(o),Mm.forEach(o),Em.forEach(o),Fm.forEach(o),Ai=c(K),Na=a(K,"BLOCKQUOTE",{});var jm=r(Na);Ia=a(jm,"BLOCKQUOTE",{});var Om=r(Ia);Aa=a(Om,"BLOCKQUOTE",{});var Pm=r(Aa);Da=a(Pm,"P",{});var Lm=r(Da);Di=l(Lm,`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs =
