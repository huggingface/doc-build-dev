...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Qc(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Yc(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Zc(J){let h,E,m,g,v,T,_,M,ge,Y,R,Q,A,Z,_e,O,Te,pe,x,j,ee,ne,F,q,ve,U,he,se,V,ue,ae,z,ke,H,re,be,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),ge=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),_e=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),Te=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ve=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),ke=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var k=i(h);E=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var fe=i(M);ge=s(fe,"having all inputs as a list, tuple or dict in the first positional arguments."),fe.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Fe=i(A);Z=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),_e=s(N,` method which currently requires having all the
tensors in the first argument of the model call function: `),O=r(N,"CODE",{});var Oe=i(O);Te=s(Oe,"model(inputs)"),Oe.forEach(t),pe=s(N,"."),N.forEach(t),x=d(p),j=r(p,"P",{});var He=i(j);ee=s(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);ve=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var qe=i(V);ue=s(qe,"model(inputs_ids)"),qe.forEach(t),P.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);ke=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=r(ye,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(p,k){u(p,h,k),e(h,E),u(p,m,k),u(p,g,k),e(g,v),e(v,T),e(g,_),e(g,M),e(M,ge),u(p,Y,k),u(p,R,k),e(R,Q),e(R,A),e(A,Z),e(R,_e),e(R,O),e(O,Te),e(R,pe),u(p,x,k),u(p,j,k),e(j,ee),u(p,ne,k),u(p,F,k),e(F,q),e(q,ve),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,ke),e(z,H),e(H,re),e(z,be),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function ep(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function tp(J){let h,E,m,g,v,T,_,M,ge,Y,R,Q,A,Z,_e,O,Te,pe,x,j,ee,ne,F,q,ve,U,he,se,V,ue,ae,z,ke,H,re,be,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),ge=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),_e=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),Te=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ve=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),ke=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),be=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var k=i(h);E=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var fe=i(M);ge=s(fe,"having all inputs as a list, tuple or dict in the first positional arguments."),fe.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Fe=i(A);Z=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),_e=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);ve=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var qe=i(V);ue=s(qe,"model(inputs_ids)"),qe.forEach(t),P.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);ke=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),be=s(K," or "),W=r(K,"CODE",{});var ze=i(W);S=s(ze,"model([input_ids, attention_mask, token_type_ids])"),ze.forEach(t),K.forEach(t),te=d(D),I=r(D,"LI",{});var ye=i(I);oe=s(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(ye,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(p,k){u(p,h,k),e(h,E),u(p,m,k),u(p,g,k),e(g,v),e(v,T),e(g,_),e(g,M),e(M,ge),u(p,Y,k),u(p,R,k),e(R,Q),e(R,A),e(A,Z),e(R,_e),e(R,O),e(O,Te),e(R,pe),u(p,x,k),u(p,j,k),e(j,ee),u(p,ne,k),u(p,F,k),e(F,q),e(q,ve),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,ke),e(z,H),e(H,re),e(z,be),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function op(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function np(J){let h,E,m,g,v,T,_,M,ge,Y,R,Q,A,Z,_e,O,Te,pe,x,j,ee,ne,F,q,ve,U,he,se,V,ue,ae,z,ke,H,re,be,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),ge=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),_e=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),Te=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ve=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),ke=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),be=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var k=i(h);E=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var fe=i(M);ge=s(fe,"having all inputs as a list, tuple or dict in the first positional arguments."),fe.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Fe=i(A);Z=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),_e=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);ve=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var qe=i(V);ue=s(qe,"model(inputs_ids)"),qe.forEach(t),P.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);ke=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),be=s(K," or "),W=r(K,"CODE",{});var ze=i(W);S=s(ze,"model([input_ids, attention_mask, token_type_ids])"),ze.forEach(t),K.forEach(t),te=d(D),I=r(D,"LI",{});var ye=i(I);oe=s(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(ye,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(p,k){u(p,h,k),e(h,E),u(p,m,k),u(p,g,k),e(g,v),e(v,T),e(g,_),e(g,M),e(M,ge),u(p,Y,k),u(p,R,k),e(R,Q),e(R,A),e(A,Z),e(R,_e),e(R,O),e(O,Te),e(R,pe),u(p,x,k),u(p,j,k),e(j,ee),u(p,ne,k),u(p,F,k),e(F,q),e(q,ve),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,ke),e(z,H),e(H,re),e(z,be),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function sp(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function ap(J){let h,E,m,g,v,T,_,M,ge,Y,R,Q,A,Z,_e,O,Te,pe,x,j,ee,ne,F,q,ve,U,he,se,V,ue,ae,z,ke,H,re,be,W,S,te,I,oe,G,Ce,p,k,ie,Ae,fe,N,Fe,Oe,He,D,P,We,qe,K,Be,ze,ye,Ue,Mn,ua,fa,Qo,En,ma,ga,$s,Je,_a,Gt,Ta,va,Kt,ka,ba,Rs,ct,Rt,Fn,Xt,Ca,qn,ya,Ms,we,Jt,wa,Xe,La,Yo,$a,Ra,Zo,Ma,Ea,Qt,Fa,qa,za,pt,Pa,en,xa,ja,tn,Sa,Ia,Na,zn,Da,Aa,Yt,Es,ht,Mt,Pn,Zt,Oa,xn,Ha,Fs,Ne,eo,Wa,jn,Ba,Ua,to,Va,on,Ga,Ka,Xa,nn,oo,qs,ut,Et,Sn,no,Ja,In,Qa,zs,Le,so,Ya,Nn,Za,er,ao,tr,sn,or,nr,sr,ro,ar,io,rr,ir,lr,Pe,lo,dr,ft,cr,an,pr,hr,Dn,ur,fr,mr,Ft,gr,An,_r,Tr,co,Ps,mt,qt,On,po,vr,Hn,kr,xs,$e,ho,br,Wn,Cr,yr,uo,wr,rn,Lr,$r,Rr,fo,Mr,mo,Er,Fr,qr,xe,go,zr,gt,Pr,ln,xr,jr,Bn,Sr,Ir,Nr,zt,Dr,Un,Ar,Or,_o,js,_t,Pt,Vn,To,Hr,Gn,Wr,Ss,Re,vo,Br,Me,Ur,dn,Vr,Gr,Kn,Kr,Xr,Xn,Jr,Qr,Jn,Yr,Zr,Qn,ei,ti,oi,ko,ni,cn,si,ai,ri,bo,ii,Co,li,di,ci,B,yo,pi,Tt,hi,pn,ui,fi,Yn,mi,gi,_i,xt,Ti,Zn,vi,ki,wo,bi,Lo,Ci,es,yi,wi,$o,Li,Ro,Is,vt,jt,ts,Mo,$i,os,Ri,Ns,de,Eo,Mi,ns,Ei,Fi,Fo,qi,hn,zi,Pi,xi,qo,ji,zo,Si,Ii,Ni,St,Di,je,Po,Ai,kt,Oi,un,Hi,Wi,ss,Bi,Ui,Vi,It,Gi,as,Ki,Xi,xo,Ds,bt,Nt,rs,jo,Ji,is,Qi,As,ce,So,Yi,ls,Zi,el,Io,tl,fn,ol,nl,sl,No,al,Do,rl,il,ll,Dt,dl,Se,Ao,cl,Ct,pl,mn,hl,ul,ds,fl,ml,gl,At,_l,cs,Tl,vl,Oo,Os,yt,Ot,ps,Ho,kl,hs,bl,Hs,X,Wo,Cl,us,yl,wl,gn,_n,Ll,$l,Rl,De,Ml,fs,El,Fl,ms,ql,zl,gs,Pl,xl,_s,jl,Sl,Il,Bo,Nl,Tn,Dl,Al,Ol,Uo,Hl,Vo,Wl,Bl,Ul,Ht,Vl,Ie,Go,Gl,wt,Kl,vn,Xl,Jl,Ts,Ql,Yl,Zl,Wt,ed,vs,td,od,Ko,Ws;return T=new dt({}),Z=new dt({}),Xt=new dt({}),Jt=new Ee({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16348/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/pr_16348/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new Ee({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16348/src/transformers/models/ctrl/modeling_ctrl.py#L353",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/pr_16348/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16348/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.CTRLConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16348/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),go=new Ee({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16348/src/transformers/models/ctrl/modeling_ctrl.py#L515",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16348/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16348/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new $t({props:{$$slots:{default:[Zc]},$$scope:{ctx:J}}}),Po=new Ee({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16348/src/transformers/models/ctrl/modeling_tf_ctrl.py#L522",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16348/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
`}}),It=new $t({props:{$$slots:{default:[ep]},$$scope:{ctx:J}}}),xo=new lt({props:{code:`from transformers import CTRLTokenizer, TFCTRLModel
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16348/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Dt=new $t({props:{$$slots:{default:[tp]},$$scope:{ctx:J}}}),Ao=new Ee({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16348/src/transformers/models/ctrl/modeling_tf_ctrl.py#L633",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16348/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
`}}),At=new $t({props:{$$slots:{default:[op]},$$scope:{ctx:J}}}),Oo=new lt({props:{code:`from transformers import CTRLTokenizer, TFCTRLLMHeadModel
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16348/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new $t({props:{$$slots:{default:[np]},$$scope:{ctx:J}}}),Go=new Ee({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16348/src/transformers/models/ctrl/modeling_tf_ctrl.py#L745",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
`}}),Wt=new $t({props:{$$slots:{default:[sp]},$$scope:{ctx:J}}}),Ko=new lt({props:{code:`from transformers import CTRLTokenizer, TFCTRLForSequenceClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=a("meta"),E=l(),m=a("h1"),g=a("a"),v=a("span"),b(T.$$.fragment),_=l(),M=a("span"),ge=n("CTRL"),Y=l(),R=a("h2"),Q=a("a"),A=a("span"),b(Z.$$.fragment),_e=l(),O=a("span"),Te=n("Overview"),pe=l(),x=a("p"),j=n("CTRL model was proposed in "),ee=a("a"),ne=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),ve=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
the left.`),Ae=l(),fe=a("li"),N=n(`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
...
TensorFlow models accepts `),ze=a("code"),ye=n("past"),Ue=n(" as input. Using the "),Mn=a("code"),ua=n("past_key_values"),fa=n(` value prevents the model from re-computing
pre-computed values in the context of text generation. See the `),Qo=a("a"),En=a("code"),ma=n("forward"),ga=n(`
...
`),Qt=a("a"),Fa=n("ctrl"),qa=n(" architecture from SalesForce."),za=l(),pt=a("p"),Pa=n("Configuration objects inherit from "),en=a("a"),xa=n("PretrainedConfig"),ja=n(` and can be used to control the model outputs. Read the
documentation from `),tn=a("a"),Sa=n("PretrainedConfig"),Ia=n(" for more information."),Na=l(),zn=a("p"),Da=n("Examples:"),Aa=l(),b(Yt.$$.fragment),Es=l(),ht=a("h2"),Mt=a("a"),Pn=a("span"),b(Zt.$$.fragment),Oa=l(),xn=a("span"),Ha=n("CTRLTokenizer"),Fs=l(),Ne=a("div"),b(eo.$$.fragment),Wa=l(),jn=a("p"),Ba=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Ua=l(),to=a("p"),Va=n("This tokenizer inherits from "),on=a("a"),Ga=n("PreTrainedTokenizer"),Ka=n(` which contains most of the main methods. Users should refer to
...
and behavior.`),lr=l(),Pe=a("div"),b(lo.$$.fragment),dr=l(),ft=a("p"),cr=n("The "),an=a("a"),pr=n("CTRLModel"),hr=n(" forward method, overrides the "),Dn=a("code"),ur=n("__call__"),fr=n(" special method."),mr=l(),b(Ft.$$.fragment),gr=l(),An=a("p"),_r=n("Example:"),Tr=l(),b(co.$$.fragment),Ps=l(),mt=a("h2"),qt=a("a"),On=a("span"),b(po.$$.fragment),vr=l(),Hn=a("span"),kr=n("CTRLLMHeadModel"),xs=l(),$e=a("div"),b(ho.$$.fragment),br=l(),Wn=a("p"),Cr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rr=l(),fo=a("p"),Mr=n("This model is also a PyTorch "),mo=a("a"),Er=n("torch.nn.Module"),Fr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ci=l(),B=a("div"),b(yo.$$.fragment),pi=l(),Tt=a("p"),hi=n("The "),pn=a("a"),ui=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Yn=a("code"),mi=n("__call__"),gi=n(" special method."),_i=l(),b(xt.$$.fragment),Ti=l(),Zn=a("p"),vi=n("Example of single-label classification:"),ki=l(),b(wo.$$.fragment),bi=l(),b(Lo.$$.fragment),Ci=l(),es=a("p"),yi=n("Example of multi-label classification:"),wi=l(),b($o.$$.fragment),Li=l(),b(Ro.$$.fragment),Is=l(),vt=a("h2"),jt=a("a"),ts=a("span"),b(Mo.$$.fragment),$i=l(),os=a("span"),Ri=n("TFCTRLModel"),Ns=l(),de=a("div"),b(Eo.$$.fragment),Mi=l(),ns=a("p"),Ei=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Fi=l(),Fo=a("p"),qi=n("This model inherits from "),hn=a("a"),zi=n("TFPreTrainedModel"),Pi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
embeddings).`),el=l(),Io=a("p"),tl=n("This model inherits from "),fn=a("a"),ol=n("TFPreTrainedModel"),nl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sl=l(),No=a("p"),al=n("This model is also a "),Do=a("a"),rl=n("tf.keras.Model"),il=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ll=l(),b(Dt.$$.fragment),dl=l(),Se=a("div"),b(Ao.$$.fragment),cl=l(),Ct=a("p"),pl=n("The "),mn=a("a"),hl=n("TFCTRLLMHeadModel"),ul=n(" forward method, overrides the "),ds=a("code"),fl=n("__call__"),ml=n(" special method."),gl=l(),b(At.$$.fragment),_l=l(),cs=a("p"),Tl=n("Example:"),vl=l(),b(Oo.$$.fragment),Os=l(),yt=a("h2"),Ot=a("a"),ps=a("span"),b(Ho.$$.fragment),kl=l(),hs=a("span"),bl=n("TFCTRLForSequenceClassification"),Hs=l(),X=a("div"),b(Wo.$$.fragment),Cl=l(),us=a("p"),yl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),wl=l(),gn=a("p"),_n=a("a"),Ll=n("TFCTRLForSequenceClassification"),$l=n(` uses the last token in order to do the classification, as other causal models
...
`),fs=a("code"),El=n("pad_token_id"),Fl=n(` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),ms=a("code"),ql=n("pad_token_id"),zl=n(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
more information.`),Bs.forEach(t),p=d(Bt),k=r(Bt,"LI",{});var pd=i(k);ie=s(pd,`CTRL is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
the left.`),pd.forEach(t),Ae=d(Bt),fe=r(Bt,"LI",{});var Us=i(fe);N=s(Us,`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows CTRL to generate syntactically coherent text as it can be
observed in the `),Fe=r(Us,"EM",{});var hd=i(Fe);Oe=s(hd,"run_generation.py"),hd.forEach(t),He=s(Us," example script."),Us.forEach(t),D=d(Bt),P=r(Bt,"LI",{});var Qe=i(P);We=s(Qe,"The PyTorch models can take the "),qe=r(Qe,"CODE",{});var ud=i(qe);K=s(ud,"past_key_values"),ud.forEach(t),Be=s(Qe,` as input, which is the previously computed key/value attention pairs.
TensorFlow models accepts `),ze=r(Qe,"CODE",{});var fd=i(ze);ye=s(fd,"past"),fd.forEach(t),Ue=s(Qe," as input. Using the "),Mn=r(Qe,"CODE",{});var md=i(Mn);ua=s(md,"past_key_values"),md.forEach(t),fa=s(Qe,` value prevents the model from re-computing
pre-computed values in the context of text generation. See the `),Qo=r(Qe,"A",{href:!0});var gd=i(Qo);En=r(gd,"CODE",{});var _d=i(En);ma=s(_d,"forward"),_d.forEach(t),gd.forEach(t),ga=s(Qe,`
...
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
`),Qt=r(Ut,"A",{href:!0,rel:!0});var Ld=i(Qt);Fa=s(Ld,"ctrl"),Ld.forEach(t),qa=s(Ut," architecture from SalesForce."),Ut.forEach(t),za=d(Ye),pt=r(Ye,"P",{});var bn=i(pt);Pa=s(bn,"Configuration objects inherit from "),en=r(bn,"A",{href:!0});var $d=i(en);xa=s($d,"PretrainedConfig"),$d.forEach(t),ja=s(bn,` and can be used to control the model outputs. Read the
documentation from `),tn=r(bn,"A",{href:!0});var Rd=i(tn);Sa=s(Rd,"PretrainedConfig"),Rd.forEach(t),Ia=s(bn," for more information."),bn.forEach(t),Na=d(Ye),zn=r(Ye,"P",{});var Md=i(zn);Da=s(Md,"Examples:"),Md.forEach(t),Aa=d(Ye),C(Yt.$$.fragment,Ye),Ye.forEach(t),Es=d(o),ht=r(o,"H2",{class:!0});var Gs=i(ht);Mt=r(Gs,"A",{id:!0,class:!0,href:!0});var Ed=i(Mt);Pn=r(Ed,"SPAN",{});var Fd=i(Pn);C(Zt.$$.fragment,Fd),Fd.forEach(t),Ed.forEach(t),Oa=d(Gs),xn=r(Gs,"SPAN",{});var qd=i(xn);Ha=s(qd,"CTRLTokenizer"),qd.forEach(t),Gs.forEach(t),Fs=d(o),Ne=r(o,"DIV",{class:!0});var Vt=i(Ne);C(eo.$$.fragment,Vt),Wa=d(Vt),jn=r(Vt,"P",{});var zd=i(jn);Ba=s(zd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),zd.forEach(t),Ua=d(Vt),to=r(Vt,"P",{});var Ks=i(to);Va=s(Ks,"This tokenizer inherits from "),on=r(Ks,"A",{href:!0});var Pd=i(on);Ga=s(Pd,"PreTrainedTokenizer"),Pd.forEach(t),Ka=s(Ks,` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qs.forEach(t),lr=d(Ze),Pe=r(Ze,"DIV",{class:!0});var et=i(Pe);C(lo.$$.fragment,et),dr=d(et),ft=r(et,"P",{});var Cn=i(ft);cr=s(Cn,"The "),an=r(Cn,"A",{href:!0});var Od=i(an);pr=s(Od,"CTRLModel"),Od.forEach(t),hr=s(Cn," forward method, overrides the "),Dn=r(Cn,"CODE",{});var Hd=i(Dn);ur=s(Hd,"__call__"),Hd.forEach(t),fr=s(Cn," special method."),Cn.forEach(t),mr=d(et),C(Ft.$$.fragment,et),gr=d(et),An=r(et,"P",{});var Wd=i(An);_r=s(Wd,"Example:"),Wd.forEach(t),Tr=d(et),C(co.$$.fragment,et),et.forEach(t),Ze.forEach(t),Ps=d(o),mt=r(o,"H2",{class:!0});var Ys=i(mt);qt=r(Ys,"A",{id:!0,class:!0,href:!0});var Bd=i(qt);On=r(Bd,"SPAN",{});var Ud=i(On);C(po.$$.fragment,Ud),Ud.forEach(t),Bd.forEach(t),vr=d(Ys),Hn=r(Ys,"SPAN",{});var Vd=i(Hn);kr=s(Vd,"CTRLLMHeadModel"),Vd.forEach(t),Ys.forEach(t),xs=d(o),$e=r(o,"DIV",{class:!0});var tt=i($e);C(ho.$$.fragment,tt),br=d(tt),Wn=r(tt,"P",{});var Gd=i(Wn);Cr=s(Gd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zs.forEach(t),Rr=d(tt),fo=r(tt,"P",{});var ea=i(fo);Mr=s(ea,"This model is also a PyTorch "),mo=r(ea,"A",{href:!0,rel:!0});var Xd=i(mo);Er=s(Xd,"torch.nn.Module"),Xd.forEach(t),Fr=s(ea,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),na.forEach(t),ci=d(nt),B=r(nt,"DIV",{class:!0});var le=i(B);C(yo.$$.fragment,le),pi=d(le),Tt=r(le,"P",{});var wn=i(Tt);hi=s(wn,"The "),pn=r(wn,"A",{href:!0});var dc=i(pn);ui=s(dc,"CTRLForSequenceClassification"),dc.forEach(t),fi=s(wn," forward method, overrides the "),Yn=r(wn,"CODE",{});var cc=i(Yn);mi=s(cc,"__call__"),cc.forEach(t),gi=s(wn," special method."),wn.forEach(t),_i=d(le),C(xt.$$.fragment,le),Ti=d(le),Zn=r(le,"P",{});var pc=i(Zn);vi=s(pc,"Example of single-label classification:"),pc.forEach(t),ki=d(le),C(wo.$$.fragment,le),bi=d(le),C(Lo.$$.fragment,le),Ci=d(le),es=r(le,"P",{});var hc=i(es);yi=s(hc,"Example of multi-label classification:"),hc.forEach(t),wi=d(le),C($o.$$.fragment,le),Li=d(le),C(Ro.$$.fragment,le),le.forEach(t),nt.forEach(t),Is=d(o),vt=r(o,"H2",{class:!0});var sa=i(vt);jt=r(sa,"A",{id:!0,class:!0,href:!0});var uc=i(jt);ts=r(uc,"SPAN",{});var fc=i(ts);C(Mo.$$.fragment,fc),fc.forEach(t),uc.forEach(t),$i=d(sa),os=r(sa,"SPAN",{});var mc=i(os);Ri=s(mc,"TFCTRLModel"),mc.forEach(t),sa.forEach(t),Ns=d(o),de=r(o,"DIV",{class:!0});var Ge=i(de);C(Eo.$$.fragment,Ge),Mi=d(Ge),ns=r(Ge,"P",{});var gc=i(ns);Ei=s(gc,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),gc.forEach(t),Fi=d(Ge),Fo=r(Ge,"P",{});var aa=i(Fo);qi=s(aa,"This model inherits from "),hn=r(aa,"A",{href:!0});var _c=i(hn);zi=s(_c,"TFPreTrainedModel"),_c.forEach(t),Pi=s(aa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
embeddings).`),Lc.forEach(t),el=d(Ke),Io=r(Ke,"P",{});var la=i(Io);tl=s(la,"This model inherits from "),fn=r(la,"A",{href:!0});var $c=i(fn);ol=s($c,"TFPreTrainedModel"),$c.forEach(t),nl=s(la,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),da.forEach(t),ll=d(Ke),C(Dt.$$.fragment,Ke),dl=d(Ke),Se=r(Ke,"DIV",{class:!0});var at=i(Se);C(Ao.$$.fragment,at),cl=d(at),Ct=r(at,"P",{});var $n=i(Ct);pl=s($n,"The "),mn=r($n,"A",{href:!0});var Mc=i(mn);hl=s(Mc,"TFCTRLLMHeadModel"),Mc.forEach(t),ul=s($n," forward method, overrides the "),ds=r($n,"CODE",{});var Ec=i(ds);fl=s(Ec,"__call__"),Ec.forEach(t),ml=s($n," special method."),$n.forEach(t),gl=d(at),C(At.$$.fragment,at),_l=d(at),cs=r(at,"P",{});var Fc=i(cs);Tl=s(Fc,"Example:"),Fc.forEach(t),vl=d(at),C(Oo.$$.fragment,at),at.forEach(t),Ke.forEach(t),Os=d(o),yt=r(o,"H2",{class:!0});var ca=i(yt);Ot=r(ca,"A",{id:!0,class:!0,href:!0});var qc=i(Ot);ps=r(qc,"SPAN",{});var zc=i(ps);C(Ho.$$.fragment,zc),zc.forEach(t),qc.forEach(t),kl=d(ca),hs=r(ca,"SPAN",{});var Pc=i(hs);bl=s(Pc,"TFCTRLForSequenceClassification"),Pc.forEach(t),ca.forEach(t),Hs=d(o),X=r(o,"DIV",{class:!0});var me=i(X);C(Wo.$$.fragment,me),Cl=d(me),us=r(me,"P",{});var xc=i(us);yl=s(xc,"The CTRL Model transformer with a sequence classification head on top (linear layer)."),xc.forEach(t),wl=d(me),gn=r(me,"P",{});var nd=i(gn);_n=r(nd,"A",{href:!0});var jc=i(_n);Ll=s(jc,"TFCTRLForSequenceClassification"),jc.forEach(t),$l=s(nd,` uses the last token in order to do the classification, as other causal models
(e.g. GPT-1, GPT-2) do.`),nd.forEach(t),Rl=d(me),De=r(me,"P",{});var rt=i(De);Ml=s(rt,`Since it does classification on the last token, it requires to know the position of the last token. If a
`),fs=r(rt,"CODE",{});var Sc=i(fs);El=s(Sc,"pad_token_id"),Sc.forEach(t),Fl=s(rt,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),ms=r(rt,"CODE",{});var Ic=i(ms);ql=s(Ic,"pad_token_id"),Ic.forEach(t),zl=s(rt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
each row of the batch).`),rt.forEach(t),Il=d(me),Bo=r(me,"P",{});var pa=i(Bo);Nl=s(pa,"This model inherits from "),Tn=r(pa,"A",{href:!0});var Ac=i(Tn);Dl=s(Ac,"TFPreTrainedModel"),Ac.forEach(t),Al=s(pa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pa.forEach(t),Ol=d(me),Uo=r(me,"P",{});var ha=i(Uo);Hl=s(ha,"This model is also a "),Vo=r(ha,"A",{href:!0,rel:!0});var Oc=i(Vo);Wl=s(Oc,"tf.keras.Model"),Oc.forEach(t),Bl=s(ha,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ha.forEach(t),Ul=d(me),C(Ht.$$.fragment,me),Vl=d(me),Ie=r(me,"DIV",{class:!0});var it=i(Ie);C(Go.$$.fragment,it),Gl=d(it),wt=r(it,"P",{});var Rn=i(wt);Kl=s(Rn,"The "),vn=r(Rn,"A",{href:!0});var Hc=i(vn);Xl=s(Hc,"TFCTRLForSequenceClassification"),Hc.forEach(t),Jl=s(Rn," forward method, overrides the "),Ts=r(Rn,"CODE",{});var Wc=i(Ts);Ql=s(Wc,"__call__"),Wc.forEach(t),Yl=s(Rn," special method."),Rn.forEach(t),Zl=d(it),C(Wt.$$.fragment,it),ed=d(it),vs=r(it,"P",{});var Bc=i(vs);td=s(Bc,"Example:"),Bc.forEach(t),od=d(it),C(Ko.$$.fragment,it),it.forEach(t),me.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(rp)),c(g,"id","ctrl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#ctrl"),c(m,"class","relative group"),c(Q,"id","overview"),c(Q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Q,"href","#overview"),c(R,"class","relative group"),c(ee,"href","https://arxiv.org/abs/1909.05858"),c(ee,"rel","nofollow"),c(oe,"href","https://github.com/salesforce/ctrl"),c(oe,"rel","nofollow"),c(Qo,"href","model_doc/ctrl#transformers.CTRLModel.forward"),c(Gt,"href","https://huggingface.co/keskarnitishr"),c(Gt,"rel","nofollow"),c(Kt,"href","https://github.com/salesforce/ctrl"),c(Kt,"rel","nofollow"),c(Rt,"id","transformers.CTRLConfig"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.CTRLConfig"),c(ct,"class","relative group"),c(Yo,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.CTRLModel"),c(Zo,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Qt,"href","https://huggingface.co/ctrl"),c(Qt,"rel","nofollow"),c(en,"href","/docs/transformers/pr_16348/en/main_classes/configuration#transformers.PretrainedConfig"),c(tn,"href","/docs/transformers/pr_16348/en/main_classes/configuration#transformers.PretrainedConfig"),c(we,"class","docstring"),c(Mt,"id","transformers.CTRLTokenizer"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.CTRLTokenizer"),c(ht,"class","relative group"),c(on,"href","/docs/transformers/pr_16348/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(nn,"class","docstring"),c(Ne,"class","docstring"),c(Et,"id","transformers.CTRLModel"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.CTRLModel"),c(ut,"class","relative group"),c(sn,"href","/docs/transformers/pr_16348/en/main_classes/model#transformers.PreTrainedModel"),c(io,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(io,"rel","nofollow"),c(an,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.CTRLModel"),c(Pe,"class","docstring"),c(Le,"class","docstring"),c(qt,"id","transformers.CTRLLMHeadModel"),c(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qt,"href","#transformers.CTRLLMHeadModel"),c(mt,"class","relative group"),c(rn,"href","/docs/transformers/pr_16348/en/main_classes/model#transformers.PreTrainedModel"),c(mo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(mo,"rel","nofollow"),c(ln,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.CTRLLMHeadModel"),c(xe,"class","docstring"),c($e,"class","docstring"),c(Pt,"id","transformers.CTRLForSequenceClassification"),c(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pt,"href","#transformers.CTRLForSequenceClassification"),c(_t,"class","relative group"),c(dn,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(cn,"href","/docs/transformers/pr_16348/en/main_classes/model#transformers.PreTrainedModel"),c(Co,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Co,"rel","nofollow"),c(pn,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(B,"class","docstring"),c(Re,"class","docstring"),c(jt,"id","transformers.TFCTRLModel"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.TFCTRLModel"),c(vt,"class","relative group"),c(hn,"href","/docs/transformers/pr_16348/en/main_classes/model#transformers.TFPreTrainedModel"),c(zo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(zo,"rel","nofollow"),c(un,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.TFCTRLModel"),c(je,"class","docstring"),c(de,"class","docstring"),c(Nt,"id","transformers.TFCTRLLMHeadModel"),c(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nt,"href","#transformers.TFCTRLLMHeadModel"),c(bt,"class","relative group"),c(fn,"href","/docs/transformers/pr_16348/en/main_classes/model#transformers.TFPreTrainedModel"),c(Do,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Do,"rel","nofollow"),c(mn,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.TFCTRLLMHeadModel"),c(Se,"class","docstring"),c(ce,"class","docstring"),c(Ot,"id","transformers.TFCTRLForSequenceClassification"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.TFCTRLForSequenceClassification"),c(yt,"class","relative group"),c(_n,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(Tn,"href","/docs/transformers/pr_16348/en/main_classes/model#transformers.TFPreTrainedModel"),c(Vo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Vo,"rel","nofollow"),c(vn,"href","/docs/transformers/pr_16348/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(Ie,"class","docstring"),c(X,"class","docstring")},m(o,f){e(document.head,h),u(o,E,f),u(o,m,f),e(m,g),e(g,v),y(T,v,null),e(m,_),e(m,M),e(M,ge),u(o,Y,f),u(o,R,f),e(R,Q),e(Q,A),y(Z,A,null),e(R,_e),e(R,O),e(O,Te),u(o,pe,f),u(o,x,f),e(x,j),e(x,ee),e(ee,ne),e(x,F),e(x,q),e(q,ve),e(x,U),u(o,he,f),u(o,se,f),e(se,V),u(o,ue,f),u(o,ae,f),e(ae,z),e(z,ke),u(o,H,f),u(o,re,f),e(re,be),u(o,W,f),u(o,S,f),e(S,te),e(te,I),e(te,oe),e(oe,G),e(te,Ce),e(S,p),e(S,k),e(k,ie),e(S,Ae),e(S,fe),e(fe,N),e(fe,Fe),e(Fe,Oe),e(fe,He),e(S,D),e(S,P),e(P,We),e(P,qe),e(qe,K),e(P,Be),e(P,ze),e(ze,ye),e(P,Ue),e(P,Mn),e(Mn,ua),e(P,fa),e(P,Qo),e(Qo,En),e(En,ma),e(P,ga),u(o,$s,f),u(o,Je,f),e(Je,_a),e(Je,Gt),e(Gt,Ta),e(Je,va),e(Je,Kt),e(Kt,ka),e(Je,ba),u(o,Rs,f),u(o,ct,f),e(ct,Rt),e(Rt,Fn),y(Xt,Fn,null),e(ct,Ca),e(ct,qn),e(qn,ya),u(o,Ms,f),u(o,we,f),y(Jt,we,null),e(we,wa),e(we,Xe),e(Xe,La),e(Xe,Yo),e(Yo,$a),e(Xe,Ra),e(Xe,Zo),e(Zo,Ma),e(Xe,Ea),e(Xe,Qt),e(Qt,Fa),e(Xe,qa),e(we,za),e(we,pt),e(pt,Pa),e(pt,en),e(en,xa),e(pt,ja),e(pt,tn),e(tn,Sa),e(pt,Ia),e(we,Na),e(we,zn),e(zn,Da),e(we,Aa),y(Yt,we,null),u(o,Es,f),u(o,ht,f),e(ht,Mt),e(Mt,Pn),y(Zt,Pn,null),e(ht,Oa),e(ht,xn),e(xn,Ha),u(o,Fs,f),u(o,Ne,f),y(eo,Ne,null),e(Ne,Wa),e(Ne,jn),e(jn,Ba),e(Ne,Ua),e(Ne,to),e(to,Va),e(to,on),e(on,Ga),e(to,Ka),e(Ne,Xa),e(Ne,nn),y(oo,nn,null),u(o,qs,f),u(o,ut,f),e(ut,Et),e(Et,Sn),y(no,Sn,null),e(ut,Ja),e(ut,In),e(In,Qa),u(o,zs,f),u(o,Le,f),y(so,Le,null),e(Le,Ya),e(Le,Nn),e(Nn,Za),e(Le,er),e(Le,ao),e(ao,tr),e(ao,sn),e(sn,or),e(ao,nr),e(Le,sr),e(Le,ro),e(ro,ar),e(ro,io),e(io,rr),e(ro,ir),e(Le,lr),e(Le,Pe),y(lo,Pe,null),e(Pe,dr),e(Pe,ft),e(ft,cr),e(ft,an),e(an,pr),e(ft,hr),e(ft,Dn),e(Dn,ur),e(ft,fr),e(Pe,mr),y(Ft,Pe,null),e(Pe,gr),e(Pe,An),e(An,_r),e(Pe,Tr),y(co,Pe,null),u(o,Ps,f),u(o,mt,f),e(mt,qt),e(qt,On),y(po,On,null),e(mt,vr),e(mt,Hn),e(Hn,kr),u(o,xs,f),u(o,$e,f),y(ho,$e,null),e($e,br),e($e,Wn),e(Wn,Cr),e($e,yr),e($e,uo),e(uo,wr),e(uo,rn),e(rn,Lr),e(uo,$r),e($e,Rr),e($e,fo),e(fo,Mr),e(fo,mo),e(mo,Er),e(fo,Fr),e($e,qr),e($e,xe),y(go,xe,null),e(xe,zr),e(xe,gt),e(gt,Pr),e(gt,ln),e(ln,xr),e(gt,jr),e(gt,Bn),e(Bn,Sr),e(gt,Ir),e(xe,Nr),y(zt,xe,null),e(xe,Dr),e(xe,Un),e(Un,Ar),e(xe,Or),y(_o,xe,null),u(o,js,f),u(o,_t,f),e(_t,Pt),e(Pt,Vn),y(To,Vn,null),e(_t,Hr),e(_t,Gn),e(Gn,Wr),u(o,Ss,f),u(o,Re,f),y(vo,Re,null),e(Re,Br),e(Re,Me),e(Me,Ur),e(Me,dn),e(dn,Vr),e(Me,Gr),e(Me,Kn),e(Kn,Kr),e(Me,Xr),e(Me,Xn),e(Xn,Jr),e(Me,Qr),e(Me,Jn),e(Jn,Yr),e(Me,Zr),e(Me,Qn),e(Qn,ei),e(Me,ti),e(Re,oi),e(Re,ko),e(ko,ni),e(ko,cn),e(cn,si),e(ko,ai),e(Re,ri),e(Re,bo),e(bo,ii),e(bo,Co),e(Co,li),e(bo,di),e(Re,ci),e(Re,B),y(yo,B,null),e(B,pi),e(B,Tt),e(Tt,hi),e(Tt,pn),e(pn,ui),e(Tt,fi),e(Tt,Yn),e(Yn,mi),e(Tt,gi),e(B,_i),y(xt,B,null),e(B,Ti),e(B,Zn),e(Zn,vi),e(B,ki),y(wo,B,null),e(B,bi),y(Lo,B,null),e(B,Ci),e(B,es),e(es,yi),e(B,wi),y($o,B,null),e(B,Li),y(Ro,B,null),u(o,Is,f),u(o,vt,f),e(vt,jt),e(jt,ts),y(Mo,ts,null),e(vt,$i),e(vt,os),e(os,Ri),u(o,Ns,f),u(o,de,f),y(Eo,de,null),e(de,Mi),e(de,ns),e(ns,Ei),e(de,Fi),e(de,Fo),e(Fo,qi),e(Fo,hn),e(hn,zi),e(Fo,Pi),e(de,xi),e(de,qo),e(qo,ji),e(qo,zo),e(zo,Si),e(qo,Ii),e(de,Ni),y(St,de,null),e(de,Di),e(de,je),y(Po,je,null),e(je,Ai),e(je,kt),e(kt,Oi),e(kt,un),e(un,Hi),e(kt,Wi),e(kt,ss),e(ss,Bi),e(kt,Ui),e(je,Vi),y(It,je,null),e(je,Gi),e(je,as),e(as,Ki),e(je,Xi),y(xo,je,null),u(o,Ds,f),u(o,bt,f),e(bt,Nt),e(Nt,rs),y(jo,rs,null),e(bt,Ji),e(bt,is),e(is,Qi),u(o,As,f),u(o,ce,f),y(So,ce,null),e(ce,Yi),e(ce,ls),e(ls,Zi),e(ce,el),e(ce,Io),e(Io,tl),e(Io,fn),e(fn,ol),e(Io,nl),e(ce,sl),e(ce,No),e(No,al),e(No,Do),e(Do,rl),e(No,il),e(ce,ll),y(Dt,ce,null),e(ce,dl),e(ce,Se),y(Ao,Se,null),e(Se,cl),e(Se,Ct),e(Ct,pl),e(Ct,mn),e(mn,hl),e(Ct,ul),e(Ct,ds),e(ds,fl),e(Ct,ml),e(Se,gl),y(At,Se,null),e(Se,_l),e(Se,cs),e(cs,Tl),e(Se,vl),y(Oo,Se,null),u(o,Os,f),u(o,yt,f),e(yt,Ot),e(Ot,ps),y(Ho,ps,null),e(yt,kl),e(yt,hs),e(hs,bl),u(o,Hs,f),u(o,X,f),y(Wo,X,null),e(X,Cl),e(X,us),e(us,yl),e(X,wl),e(X,gn),e(gn,_n),e(_n,Ll),e(gn,$l),e(X,Rl),e(X,De),e(De,Ml),e(De,fs),e(fs,El),e(De,Fl),e(De,ms),e(ms,ql),e(De,zl),e(De,gs),e(gs,Pl),e(De,xl),e(De,_s),e(_s,jl),e(De,Sl),e(X,Il),e(X,Bo),e(Bo,Nl),e(Bo,Tn),e(Tn,Dl),e(Bo,Al),e(X,Ol),e(X,Uo),e(Uo,Hl),e(Uo,Vo),e(Vo,Wl),e(Uo,Bl),e(X,Ul),y(Ht,X,null),e(X,Vl),e(X,Ie),y(Go,Ie,null),e(Ie,Gl),e(Ie,wt),e(wt,Kl),e(wt,vn),e(vn,Xl),e(wt,Jl),e(wt,Ts),e(Ts,Ql),e(wt,Yl),e(Ie,Zl),y(Wt,Ie,null),e(Ie,ed),e(Ie,vs),e(vs,td),e(Ie,od),y(Ko,Ie,null),Ws=!0},p(o,[f]){const Xo={};f&2&&(Xo.$$scope={dirty:f,ctx:o}),Ft.$set(Xo);const ks={};f&2&&(ks.$$scope={dirty:f,ctx:o}),zt.$set(ks);const bs={};f&2&&(bs.$$scope={dirty:f,ctx:o}),xt.$set(bs);const Cs={};f&2&&(Cs.$$scope={dirty:f,ctx:o}),St.$set(Cs);const Jo={};f&2&&(Jo.$$scope={dirty:f,ctx:o}),It.$set(Jo);const ys={};f&2&&(ys.$$scope={dirty:f,ctx:o}),Dt.$set(ys);const ws={};f&2&&(ws.$$scope={dirty:f,ctx:o}),At.$set(ws);const Ls={};f&2&&(Ls.$$scope={dirty:f,ctx:o}),Ht.$set(Ls);const Lt={};f&2&&(Lt.$$scope={dirty:f,ctx:o}),Wt.$set(Lt)},i(o){Ws||(w(T.$$.fragment,o),w(Z.$$.fragment,o),w(Xt.$$.fragment,o),w(Jt.$$.fragment,o),w(Yt.$$.fragment,o),w(Zt.$$.fragment,o),w(eo.$$.fragment,o),w(oo.$$.fragment,o),w(no.$$.fragment,o),w(so.$$.fragment,o),w(lo.$$.fragment,o),w(Ft.$$.fragment,o),w(co.$$.fragment,o),w(po.$$.fragment,o),w(ho.$$.fragment,o),w(go.$$.fragment,o),w(zt.$$.fragment,o),w(_o.$$.fragment,o),w(To.$$.fragment,o),w(vo.$$.fragment,o),w(yo.$$.fragment,o),w(xt.$$.fragment,o),w(wo.$$.fragment,o),w(Lo.$$.fragment,o),w($o.$$.fragment,o),w(Ro.$$.fragment,o),w(Mo.$$.fragment,o),w(Eo.$$.fragment,o),w(St.$$.fragment,o),w(Po.$$.fragment,o),w(It.$$.fragment,o),w(xo.$$.fragment,o),w(jo.$$.fragment,o),w(So.$$.fragment,o),w(Dt.$$.fragment,o),w(Ao.$$.fragment,o),w(At.$$.fragment,o),w(Oo.$$.fragment,o),w(Ho.$$.fragment,o),w(Wo.$$.fragment,o),w(Ht.$$.fragment,o),w(Go.$$.fragment,o),w(Wt.$$.fragment,o),w(Ko.$$.fragment,o),Ws=!0)},o(o){L(T.$$.fragment,o),L(Z.$$.fragment,o),L(Xt.$$.fragment,o),L(Jt.$$.fragment,o),L(Yt.$$.fragment,o),L(Zt.$$.fragment,o),L(eo.$$.fragment,o),L(oo.$$.fragment,o),L(no.$$.fragment,o),L(so.$$.fragment,o),L(lo.$$.fragment,o),L(Ft.$$.fragment,o),L(co.$$.fragment,o),L(po.$$.fragment,o),L(ho.$$.fragment,o),L(go.$$.fragment,o),L(zt.$$.fragment,o),L(_o.$$.fragment,o),L(To.$$.fragment,o),L(vo.$$.fragment,o),L(yo.$$.fragment,o),L(xt.$$.fragment,o),L(wo.$$.fragment,o),L(Lo.$$.fragment,o),L($o.$$.fragment,o),L(Ro.$$.fragment,o),L(Mo.$$.fragment,o),L(Eo.$$.fragment,o),L(St.$$.fragment,o),L(Po.$$.fragment,o),L(It.$$.fragment,o),L(xo.$$.fragment,o),L(jo.$$.fragment,o),L(So.$$.fragment,o),L(Dt.$$.fragment,o),L(Ao.$$.fragment,o),L(At.$$.fragment,o),L(Oo.$$.fragment,o),L(Ho.$$.fragment,o),L(Wo.$$.fragment,o),L(Ht.$$.fragment,o),L(Go.$$.fragment,o),L(Wt.$$.fragment,o),L(Ko.$$.fragment,o),Ws=!1},d(o){t(h),o&&t(E),o&&t(m),$(T),o&&t(Y),o&&t(R),$(Z),o&&t(pe),o&&t(x),o&&t(he),o&&t(se),o&&t(ue),o&&t(ae),o&&t(H),o&&t(re),o&&t(W),o&&t(S),o&&t($s),o&&t(Je),o&&t(Rs),o&&t(ct),$(Xt),o&&t(Ms),o&&t(we),$(Jt),$(Yt),o&&t(Es),o&&t(ht),$(Zt),o&&t(Fs),o&&t(Ne),$(eo),$(oo),o&&t(qs),o&&t(ut),$(no),o&&t(zs),o&&t(Le),$(so),$(lo),$(Ft),$(co),o&&t(Ps),o&&t(mt),$(po),o&&t(xs),o&&t($e),$(ho),$(go),$(zt),$(_o),o&&t(js),o&&t(_t),$(To),o&&t(Ss),o&&t(Re),$(vo),$(yo),$(xt),$(wo),$(Lo),$($o),$(Ro),o&&t(Is),o&&t(vt),$(Mo),o&&t(Ns),o&&t(de),$(Eo),$(St),$(Po),$(It),$(xo),o&&t(Ds),o&&t(bt),$(jo),o&&t(As),o&&t(ce),$(So),$(Dt),$(Ao),$(At),$(Oo),o&&t(Os),o&&t(yt),$(Ho),o&&t(Hs),o&&t(X),$(Wo),$(Ht),$(Go),$(Wt),$(Ko)}}}const rp={local:"ctrl",sections:[{local:"overview",title:"Overview"},{local:"transformers.CTRLConfig",title:"CTRLConfig"},{local:"transformers.CTRLTokenizer",title:"CTRLTokenizer"},{local:"transformers.CTRLModel",title:"CTRLModel"},{local:"transformers.CTRLLMHeadModel",title:"CTRLLMHeadModel"},{local:"transformers.CTRLForSequenceClassification",title:"CTRLForSequenceClassification"},{local:"transformers.TFCTRLModel",title:"TFCTRLModel"},{local:"transformers.TFCTRLLMHeadModel",title:"TFCTRLLMHeadModel"},{local:"transformers.TFCTRLForSequenceClassification",title:"TFCTRLForSequenceClassification"}],title:"CTRL"};function ip(J){return Xc(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class up extends Uc{constructor(h){super();Vc(this,h,ip,ap,Gc,{})}}export{up as default,rp as metadata};
