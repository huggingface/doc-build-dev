...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){m=n("p"),v=r("Examples:"),g=c(),T(f.$$.fragment)},l(d){m=s(d,"P",{});var h=a(m);v=i(h,"Examples:"),h.forEach(t),g=p(d),b(f.$$.fragment,d)},m(d,h){_(d,m,h),e(m,v),_(d,g,h),E(f,d,h),x=!0},p:va,i(d){x||($(f.$$.fragment,d),x=!0)},o(d){j(f.$$.fragment,d),x=!1},d(d){d&&t(m),d&&t(g),w(f,d)}}}function Nr(I){let m,v,g,f,x,d,h,S,qo,no,U,Y,Mt,_e,Lo,zt,So,so,k,No,ot,Oo,Bo,Ct,Wo,Ro,nt,Uo,Jo,st,Ho,Zo,at,Go,Xo,Ft,Ko,Qo,rt,Yo,en,it,tn,on,ao,ee,nn,xe,sn,an,ro,J,te,It,ve,rn,At,ln,io,M,Te,dn,B,lt,cn,pn,dt,mn,fn,ct,hn,un,gn,H,_n,pt,xn,vn,mt,Tn,bn,En,oe,$n,ne,be,jn,Ee,wn,ft,yn,kn,Vn,se,$e,Dn,je,Pn,ht,Mn,zn,lo,Z,ae,qt,we,Cn,Lt,Fn,co,z,ye,In,St,An,qn,C,ut,Ln,Sn,gt,Nn,On,_t,Bn,Wn,Nt,Rn,Un,xt,Jn,Hn,Zn,re,ke,Gn,Ve,Xn,vt,Kn,Qn,Yn,ie,De,es,Pe,ts,Tt,os,ns,po,G,le,Ot,Me,ss,Bt,as,mo,V,ze,rs,Ce,is,bt,ls,ds,cs,Fe,ps,Ie,ms,fs,hs,Wt,us,gs,Ae,_s,Et,xs,vs,Ts,qe,bs,Le,Es,$s,js,A,Se,ws,X,ys,$t,ks,Vs,Rt,Ds,Ps,Ms,de,zs,ce,fo,K,pe,Ut,Ne,Cs,Jt,Fs,ho,y,Oe,Is,Be,As,jt,qs,Ls,Ss,We,Ns,Re,Os,Bs,Ws,Ht,Rs,Us,Ue,Js,wt,Hs,Zs,Gs,Je,Xs,He,Ks,Qs,Ys,Zt,ea,ta,N,Gt,Ze,oa,na,Xt,Ge,sa,aa,Kt,Xe,ra,ia,Qt,Ke,la,da,q,Qe,ca,Q,pa,yt,ma,fa,Yt,ha,ua,ga,me,_a,fe,uo;return d=new Pt({}),_e=new Pt({}),ve=new Pt({}),Te=new R({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config_dict",description:`<strong>text_config_dict</strong> (<code>dict</code>) &#x2014;
...
Dictionary of keyword arguments.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17352/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L28"}}),oe=new xa({props:{anchor:"transformers.VisionTextDualEncoderConfig.example",$$slots:{default:[Ir]},$$scope:{ctx:I}}}),be=new R({props:{name:"from_vision_text_configs",anchor:"transformers.VisionTextDualEncoderConfig.from_vision_text_configs",parameters:[{name:"vision_config",val:": PretrainedConfig"},{name:"text_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17352/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L105",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/pr_17352/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig"
>VisionTextDualEncoderConfig</a></p>
`}}),$e=new R({props:{name:"to_dict",anchor:"transformers.VisionTextDualEncoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17352/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L117",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, any]</code></p>
`}}),we=new Pt({}),ye=new R({props:{name:"class transformers.VisionTextDualEncoderProcessor",anchor:"transformers.VisionTextDualEncoderProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/pr_17352/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>) &#x2014;
The feature extractor is a required input.`,name:"feature_extractor"},{anchor:"transformers.VisionTextDualEncoderProcessor.tokenizer",description:`<strong>tokenizer</strong> (<a href="/docs/transformers/pr_17352/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17352/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L23"}}),ke=new R({props:{name:"batch_decode",anchor:"transformers.VisionTextDualEncoderProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17352/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L98"}}),De=new R({props:{name:"decode",anchor:"transformers.VisionTextDualEncoderProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17352/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L105"}}),Me=new Pt({}),ze=new R({props:{name:"class transformers.VisionTextDualEncoderModel",anchor:"transformers.VisionTextDualEncoderModel",parameters:[{name:"config",val:": typing.Optional[transformers.models.vision_text_dual_encoder.configuration_vision_text_dual_encoder.VisionTextDualEncoderConfig] = None"},{name:"vision_model",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"text_model",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17352/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17352/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17352/src/transformers/models/vision_text_dual_encoder/modeling_vision_text_dual_encoder.py#L162"}}),Se=new R({props:{name:"forward",anchor:"transformers.VisionTextDualEncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"return_loss",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17352/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17352/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17352/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
a feature extractor (e.g. if you use ViT as the encoder, you should use <a href="/docs/transformers/pr_17352/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>). See
<a href="/docs/transformers/pr_17352/en/model_doc/vit#transformers.ViTFeatureExtractor.__call__">ViTFeatureExtractor.<strong>call</strong>()</a> for details.`,name:"pixel_values"},{anchor:"transformers.VisionTextDualEncoderModel.forward.return_loss",description:`<strong>return_loss</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17352/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17352/src/transformers/models/vision_text_dual_encoder/modeling_vision_text_dual_encoder.py#L294",returnDescription:`
...
<li><strong>text_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17352/en/model_doc/clip#transformers.CLIPTextModel"
>CLIPTextModel</a>.</li>
<li><strong>image_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The image embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17352/en/model_doc/clip#transformers.CLIPVisionModel"
...
`}}),de=new Dr({props:{$$slots:{default:[Ar]},$$scope:{ctx:I}}}),ce=new xa({props:{anchor:"transformers.VisionTextDualEncoderModel.forward.example",$$slots:{default:[qr]},$$scope:{ctx:I}}}),Ne=new Pt({}),Oe=new R({props:{name:"class transformers.FlaxVisionTextDualEncoderModel",anchor:"transformers.FlaxVisionTextDualEncoderModel",parameters:[{name:"config",val:": VisionTextDualEncoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxVisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17352/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig">VisionTextDualEncoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17352/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxVisionTextDualEncoderModel.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
<a
  href="/docs/transformers/pr_17352/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
<a
  href="/docs/transformers/pr_17352/en/model_doc/clip#transformers.FlaxCLIPVisionModel"
...
general usage and behavior.`),Ys=c(),Zt=n("p"),ea=r("Finally, this model supports inherent JAX features such as:"),ta=c(),N=n("ul"),Gt=n("li"),Ze=n("a"),oa=r("Just-In-Time (JIT) compilation"),na=c(),Xt=n("li"),Ge=n("a"),sa=r("Automatic Differentiation"),aa=c(),Kt=n("li"),Xe=n("a"),ra=r("Vectorization"),ia=c(),Qt=n("li"),Ke=n("a"),la=r("Parallelization"),da=c(),q=n("div"),T(Qe.$$.fragment),ca=c(),Q=n("p"),pa=r("The "),yt=n("a"),ma=r("FlaxVisionTextDualEncoderModel"),fa=r(" forward method, overrides the "),Yt=n("code"),ha=r("__call__"),ua=r(" special method."),ga=c(),T(me.$$.fragment),_a=c(),T(fe.$$.fragment),this.h()},l(o){const u=Cr('[data-svelte="svelte-1phssyn"]',document.head);m=s(u,"META",{name:!0,content:!0}),u.forEach(t),v=p(o),g=s(o,"H1",{class:!0});var Ye=a(g);f=s(Ye,"A",{id:!0,class:!0,href:!0});var eo=a(f);x=s(eo,"SPAN",{});var to=a(x);b(d.$$.fragment,to),to.forEach(t),eo.forEach(t),h=p(Ye),S=s(Ye,"SPAN",{});var oo=a(S);qo=i(oo,"VisionTextDualEncoder"),oo.forEach(t),Ye.forEach(t),no=p(o),U=s(o,"H2",{class:!0});var et=a(U);Y=s(et,"A",{id:!0,class:!0,href:!0});var ba=a(Y);Mt=s(ba,"SPAN",{});var Ea=a(Mt);b(_e.$$.fragment,Ea),Ea.forEach(t),ba.forEach(t),Lo=p(et),zt=s(et,"SPAN",{});var $a=a(zt);So=i($a,"Overview"),$a.forEach(t),et.forEach(t),so=p(o),k=s(o,"P",{});var D=a(k);No=i(D,"The "),ot=s(D,"A",{href:!0});var ja=a(ot);Oo=i(ja,"VisionTextDualEncoderModel"),ja.forEach(t),Bo=i(D,` can be used to initialize a vision-text dual encoder model with
...
documentation from `),mt=s(kt,"A",{href:!0});var Na=a(mt);Tn=i(Na,"PretrainedConfig"),Na.forEach(t),bn=i(kt," for more information."),kt.forEach(t),En=p(L),b(oe.$$.fragment,L),$n=p(L),ne=s(L,"DIV",{class:!0});var xo=a(ne);b(be.$$.fragment,xo),jn=p(xo),Ee=s(xo,"P",{});var vo=a(Ee);wn=i(vo,"Instantiate a "),ft=s(vo,"A",{href:!0});var Oa=a(ft);yn=i(Oa,"VisionTextDualEncoderConfig"),Oa.forEach(t),kn=i(vo,` (or a derived class) from text model configuration and vision
model configuration.`),vo.forEach(t),xo.forEach(t),Vn=p(L),se=s(L,"DIV",{class:!0});var To=a(se);b($e.$$.fragment,To),Dn=p(To),je=s(To,"P",{});var bo=a(je);Pn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=s(bo,"A",{href:!0});var Ba=a(ht);Mn=i(Ba,"to_dict()"),Ba.forEach(t),zn=i(bo,"."),bo.forEach(t),To.forEach(t),L.forEach(t),lo=p(o),Z=s(o,"H2",{class:!0});var Eo=a(Z);ae=s(Eo,"A",{id:!0,class:!0,href:!0});var Wa=a(ae);qt=s(Wa,"SPAN",{});var Ra=a(qt);b(we.$$.fragment,Ra),Ra.forEach(t),Wa.forEach(t),Cn=p(Eo),Lt=s(Eo,"SPAN",{});var Ua=a(Lt);Fn=i(Ua,"VisionTextDualEncoderProcessor"),Ua.forEach(t),Eo.forEach(t),co=p(o),z=s(o,"DIV",{class:!0});var W=a(z);b(ye.$$.fragment,W),In=p(W),St=s(W,"P",{});var Ja=a(St);An=i(Ja,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
`),xt=s(O,"A",{href:!0});var Ka=a(xt);Jn=i(Ka,"decode()"),Ka.forEach(t),Hn=i(O," for more information."),O.forEach(t),Zn=p(W),re=s(W,"DIV",{class:!0});var $o=a(re);b(ke.$$.fragment,$o),Gn=p($o),Ve=s($o,"P",{});var jo=a(Ve);Xn=i(jo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
