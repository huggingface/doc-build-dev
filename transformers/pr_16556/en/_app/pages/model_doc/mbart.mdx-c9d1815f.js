import{S as C5,i as E5,s as P5,e as n,k as d,w as u,t as r,M as S5,c as a,d as t,m as l,a as s,x as m,h as i,b as c,F as e,g as h,y as f,q as _,o as g,B as k,v as O5}from"../../chunks/vendor-6b77c823.js";import{T as st}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-abef54e3.js";import{C as $}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as X}from"../../chunks/IconCopyLink-7a11ce68.js";function A5(C){let b,z,v,M,x;return{c(){b=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),M=r("Module"),x=r(`
...
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var F=s(v);M=i(F,"Module"),F.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,M),e(b,x)},d(T){T&&t(b)}}}function W5(C){let b,z,v,M,x,T,y,F,rt,Ee,j,Re,ke,it,be,ye,dt,Ke,J,N,Xe,se,E,O,lt,pe,he,ct,K,pt,ht,D,Pe,ve,Ze,re,Te,we,ut,ie,Me,xe,Ye;return{c(){b=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=d(),M=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),F=n("li"),rt=r("having all inputs as a list, tuple or dict in the first positional arguments."),Ee=d(),j=n("p"),Re=r("This second option is useful when using "),ke=n("code"),it=r("tf.keras.Model.fit"),be=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ye=n("code"),dt=r("model(inputs)"),Ke=r("."),J=d(),N=n("p"),Xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),se=d(),E=n("ul"),O=n("li"),lt=r("a single Tensor with "),pe=n("code"),he=r("input_ids"),ct=r(" only and nothing else: "),K=n("code"),pt=r("model(input_ids)"),ht=d(),D=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ve=n("code"),Ze=r("model([input_ids, attention_mask])"),re=r(" or "),Te=n("code"),we=r("model([input_ids, attention_mask, token_type_ids])"),ut=d(),ie=n("li"),Me=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),xe=n("code"),Ye=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){b=a(w,"P",{});var B=s(b);z=i(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),v=l(w),M=a(w,"UL",{});var ze=s(M);x=a(ze,"LI",{});var Ve=s(x);T=i(Ve,"having all inputs as keyword arguments (like PyTorch models), or"),Ve.forEach(t),y=l(ze),F=a(ze,"LI",{});var Ut=s(F);rt=i(Ut,"having all inputs as a list, tuple or dict in the first positional arguments."),Ut.forEach(t),ze.forEach(t),Ee=l(w),j=a(w,"P",{});var Z=s(j);Re=i(Z,"This second option is useful when using "),ke=a(Z,"CODE",{});var Rt=s(ke);it=i(Rt,"tf.keras.Model.fit"),Rt.forEach(t),be=i(Z,` method which currently requires having all the
...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16556/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16556/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16556/en/model_doc/mbart#transformers.MBartConfig"
...
`}}),Yo=new st({props:{$$slots:{default:[A5]},$$scope:{ctx:C}}}),Za=new $({props:{code:`from transformers import MBartTokenizer, MBartModel
import torch
...
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16556/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16556/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16556/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16556/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16556/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16556/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16556/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16556/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$u.forEach(t),zT=l(ne),Ac=a(ne,"P",{});var Kx=s(Ac);qT=i(Kx,"Finally, this model supports inherent JAX features such as:"),Kx.forEach(t),FT=l(ne),gt=a(ne,"UL",{});var jn=s(gt);Ic=a(jn,"LI",{});var Zx=s(Ic);zr=a(Zx,"A",{href:!0,rel:!0});var Yx=s(zr);$T=i(Yx,"Just-In-Time (JIT) compilation"),Yx.forEach(t),Zx.forEach(t),BT=l(jn),Nc=a(jn,"LI",{});var e5=s(Nc);qr=a(e5,"A",{href:!0,rel:!0});var t5=s(qr);jT=i(t5,"Automatic Differentiation"),t5.forEach(t),e5.forEach(t),CT=l(jn),Dc=a(jn,"LI",{});var o5=s(Dc);Fr=a(o5,"A",{href:!0,rel:!0});var n5=s(Fr);ET=i(n5,"Vectorization"),n5.forEach(t),o5.forEach(t),PT=l(jn),Lc=a(jn,"LI",{});var a5=s(Lc);$r=a(a5,"A",{href:!0,rel:!0});var s5=s($r);ST=i(s5,"Parallelization"),s5.forEach(t),a5.forEach(t),jn.forEach(t),OT=l(ne),De=a(ne,"DIV",{class:!0});var Gt=s(De);m(Br.$$.fragment,Gt),AT=l(Gt),Bo=a(Gt,"P",{});var Yi=s(Bo);IT=i(Yi,"The "),Gc=a(Yi,"CODE",{});var r5=s(Gc);NT=i(r5,"FlaxMBartPreTrainedModel"),r5.forEach(t),DT=i(Yi,"forward method, overrides the "),Wc=a(Yi,"CODE",{});var i5=s(Wc);LT=i(i5,"__call__"),i5.forEach(t),GT=i(Yi," special method."),Yi.forEach(t),WT=l(Gt),m(bn.$$.fragment,Gt),UT=l(Gt),Uc=a(Gt,"P",{});var d5=s(Uc);RT=i(d5,"Example:"),d5.forEach(t),XT=l(Gt),m(jr.$$.fragment,Gt),Gt.forEach(t),VT=l(ne),qt=a(ne,"DIV",{class:!0});var ed=s(qt);m(Cr.$$.fragment,ed),QT=l(ed),Rc=a(ed,"P",{});var l5=s(Rc);HT=i(l5,"Example:"),l5.forEach(t),JT=l(ed),m(Er.$$.fragment,ed),ed.forEach(t),KT=l(ne),Ft=a(ne,"DIV",{class:!0});var td=s(Ft);m(Pr.$$.fragment,td),ZT=l(td),Xc=a(td,"P",{});var c5=s(Xc);YT=i(c5,"Example:"),c5.forEach(t),e1=l(td),m(Sr.$$.fragment,td),td.forEach(t),ne.forEach(t),dh=l(o),jo=a(o,"H2",{class:!0});var Bu=s(jo);yn=a(Bu,"A",{id:!0,class:!0,href:!0});var p5=s(yn);Vc=a(p5,"SPAN",{});var h5=s(Vc);m(Or.$$.fragment,h5),h5.forEach(t),p5.forEach(t),t1=l(Bu),Qc=a(Bu,"SPAN",{});var u5=s(Qc);o1=i(u5,"FlaxMBartForQuestionAnswering"),u5.forEach(t),Bu.forEach(t),lh=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);m(Ar.$$.fragment,ae),n1=l(ae),Co=a(ae,"P",{});var od=s(Co);a1=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
