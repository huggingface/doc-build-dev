...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17313/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17313/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17313/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17313/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Df.forEach(t),Yk=p(lo),xt=s(lo,"DIV",{class:!0});var ha=a(xt);y(hr.$$.fragment,ha),Zk=p(ha),Co=s(ha,"P",{});var fc=a(Co);e1=i(fc,"The "),Ad=s(fc,"A",{href:!0});var N3=a(Ad);t1=i(N3,"ElectraForCausalLM"),N3.forEach(t),o1=i(fc," forward method, overrides the "),ip=s(fc,"CODE",{});var I3=a(ip);n1=i(I3,"__call__"),I3.forEach(t),s1=i(fc," special method."),fc.forEach(t),a1=p(ha),y(Nn.$$.fragment,ha),r1=p(ha),y(In.$$.fragment,ha),ha.forEach(t),lo.forEach(t),Su=p(o),qo=s(o,"H2",{class:!0});var Sf=a(qo);Dn=s(Sf,"A",{id:!0,class:!0,href:!0});var D3=a(Dn);lp=s(D3,"SPAN",{});var S3=a(lp);y(mr.$$.fragment,S3),S3.forEach(t),D3.forEach(t),i1=p(Sf),dp=s(Sf,"SPAN",{});var W3=a(dp);l1=i(W3,"ElectraForMaskedLM"),W3.forEach(t),Sf.forEach(t),Wu=p(o),Qe=s(o,"DIV",{class:!0});var Wt=a(Qe);y(ur.$$.fragment,Wt),d1=p(Wt),cp=s(Wt,"P",{});var U3=a(cp);c1=i(U3,"Electra model with a language modeling head on top."),U3.forEach(t),p1=p(Wt),pp=s(Wt,"P",{});var B3=a(pp);h1=i(B3,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),B3.forEach(t),m1=p(Wt),fr=s(Wt,"P",{});var Wf=a(fr);u1=i(Wf,"This model inherits from "),Od=s(Wf,"A",{href:!0});var R3=a(Od);f1=i(R3,"PreTrainedModel"),R3.forEach(t),g1=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),_1=p(Wt),gr=s(Wt,"P",{});var Uf=a(gr);k1=i(Uf,"This model is also a PyTorch "),_r=s(Uf,"A",{href:!0,rel:!0});var H3=a(_r);v1=i(H3,"torch.nn.Module"),H3.forEach(t),T1=i(Uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),b1=p(Wt),at=s(Wt,"DIV",{class:!0});var co=a(at);y(kr.$$.fragment,co),y1=p(co),Po=s(co,"P",{});var gc=a(Po);E1=i(gc,"The "),Ld=s(gc,"A",{href:!0});var Q3=a(Ld);w1=i(Q3,"ElectraForMaskedLM"),Q3.forEach(t),$1=i(gc," forward method, overrides the "),hp=s(gc,"CODE",{});var V3=a(hp);F1=i(V3,"__call__"),V3.forEach(t),x1=i(gc," special method."),gc.forEach(t),M1=p(co),y(Sn.$$.fragment,co),z1=p(co),y(Wn.$$.fragment,co),j1=p(co),y(Un.$$.fragment,co),co.forEach(t),Wt.forEach(t),Uu=p(o),Ao=s(o,"H2",{class:!0});var Bf=a(Ao);Bn=s(Bf,"A",{id:!0,class:!0,href:!0});var K3=a(Bn);mp=s(K3,"SPAN",{});var J3=a(mp);y(vr.$$.fragment,J3),J3.forEach(t),K3.forEach(t),C1=p(Bf),up=s(Bf,"SPAN",{});var G3=a(up);q1=i(G3,"ElectraForSequenceClassification"),G3.forEach(t),Bf.forEach(t),Bu=p(o),ot=s(o,"DIV",{class:!0});var po=a(ot);y(Tr.$$.fragment,po),P1=p(po),fp=s(po,"P",{});var X3=a(fp);A1=i(X3,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X3.forEach(t),O1=p(po),br=s(po,"P",{});var Rf=a(br);L1=i(Rf,"This model inherits from "),Nd=s(Rf,"A",{href:!0});var Y3=a(Nd);N1=i(Y3,"PreTrainedModel"),Y3.forEach(t),I1=i(Rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rf.forEach(t),D1=p(po),yr=s(po,"P",{});var Hf=a(yr);S1=i(Hf,"This model is also a PyTorch "),Er=s(Hf,"A",{href:!0,rel:!0});var Z3=a(Er);W1=i(Z3,"torch.nn.Module"),Z3.forEach(t),U1=i(Hf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
