...
`}}),ye=new Go({props:{$$slots:{default:[Ma]},$$scope:{ctx:G}}}),we=new ft({props:{anchor:"transformers.GroupViTTextModel.forward.example",$$slots:{default:[Ca]},$$scope:{ctx:G}}}),lt=new Ae({}),pt=new O({props:{name:"class transformers.GroupViTVisionModel",anchor:"transformers.GroupViTVisionModel",parameters:[{name:"config",val:": GroupViTVisionConfig"}],source:"https://github.com/huggingface/transformers/blob/vr_17313/src/transformers/models/groupvit/modeling_groupvit.py#L1508"}}),dt=new O({props:{name:"forward",anchor:"transformers.GroupViTVisionModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GroupViTVisionModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
configs.`),jr=g(),W=n("p"),Pr=i("Configuration objects inherit from "),yt=n("a"),zr=i("PretrainedConfig"),qr=i(` and can be used to control the model outputs. Read the
...
vision model configuration.`),Ao=g(),B=n("h2"),ce=n("a"),Qt=n("span"),$(Re.$$.fragment),Fr=g(),Zt=n("span"),Wr=i("GroupViTTextConfig"),Oo=g(),E=n("div"),$(Ue.$$.fragment),Br=g(),H=n("p"),Hr=i("This is the configuration class to store the configuration of a "),eo=n("code"),Rr=i("GroupViTTextModel "),Ur=i(`. It is used to instantiate
...
instantiate a GroupViT model according to the specified arguments, defining the text model and vision model
configs.`),xo.forEach(o),jr=h(Me),W=s(Me,"P",{});var At=a(W);Pr=l(At,"Configuration objects inherit from "),yt=s(At,"A",{href:!0});var Ps=a(yt);zr=l(Ps,"PretrainedConfig"),Ps.forEach(o),qr=l(At,` and can be used to control the model outputs. Read the
