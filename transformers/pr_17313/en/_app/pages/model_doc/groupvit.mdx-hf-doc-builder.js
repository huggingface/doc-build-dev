...
<span class="hljs-meta">&gt;&gt;&gt; </span>pooled_output = outputs.pooler_output  <span class="hljs-comment"># pooled (EOS token) states</span>`}}),{c(){p=n("p"),T=i("Examples:"),u=g(),$(c.$$.fragment)},l(r){p=s(r,"P",{});var d=a(p);T=l(d,"Examples:"),d.forEach(o),u=h(r),b(c.$$.fragment,r)},m(r,d){v(r,p,d),e(p,T),v(r,u,d),V(c,r,d),_=!0},p:mt,i(r){_||(y(c.$$.fragment,r),_=!0)},o(r){w(c.$$.fragment,r),_=!1},d(r){r&&o(p),r&&o(u),x(c,r)}}}function Ea(G){let p,T,u,c,_;return{c(){p=n("p"),T=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){p=s(r,"P",{});var d=a(p);T=l(d,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(d,"CODE",{});var k=a(u);c=l(k,"Module"),k.forEach(o),_=l(d,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),d.forEach(o)},m(r,d){v(r,p,d),e(p,T),e(p,u),e(u,c),e(p,_)},d(r){r&&o(p)}}}function ja(G){let p,T,u,c,_;return c=new gt({props:{code:`from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooled_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){p=n("p"),T=i("Examples:"),u=g(),$(c.$$.fragment)},l(r){p=s(r,"P",{});var d=a(p);T=l(d,"Examples:"),d.forEach(o),u=h(r),b(c.$$.fragment,r)},m(r,d){v(r,p,d),e(p,T),v(r,u,d),V(c,r,d),_=!0},p:mt,i(r){_||(y(c.$$.fragment,r),_=!0)},o(r){w(c.$$.fragment,r),_=!1},d(r){r&&o(p),r&&o(u),x(c,r)}}}function Pa(G){let p,T,u,c,_,r,d,k,sr,ko,N,ie,Rt,Oe,ar,Ut,ir,Mo,L,lr,Le,pr,dr,ht,cr,ur,Co,_t,fr,Eo,vt,Jt,mr,jo,Tt,gr,Po,$t,De,hr,Xt,_r,vr,zo,D,Tr,Se,$r,br,Ne,Vr,yr,qo,F,le,Yt,Fe,wr,Kt,xr,Io,C,We,Gr,pe,bt,kr,Mr,Vt,Cr,Er,jr,W,Pr,yt,zr,qr,wt,Ir,Ar,Or,de,Be,Lr,He,Dr,xt,Sr,Nr,Ao,B,ce,Qt,Re,Fr,Zt,Wr,Oo,E,Ue,Br,H,Hr,eo,Rr,Ur,Je,Jr,Xr,Yr,R,Kr,Gt,Qr,Zr,kt,en,tn,on,ue,Lo,U,fe,to,Xe,rn,oo,nn,Do,j,Ye,sn,J,an,ro,ln,pn,Ke,dn,cn,un,X,fn,Mt,mn,gn,Ct,hn,_n,vn,me,So,Y,ge,no,Qe,Tn,so,$n,No,M,Ze,bn,et,Vn,tt,yn,wn,xn,P,ot,Gn,K,kn,Et,Mn,Cn,ao,En,jn,Pn,he,zn,_e,qn,z,rt,In,Q,An,jt,On,Ln,io,Dn,Sn,Nn,ve,Fn,Te,Wn,q,nt,Bn,Z,Hn,Pt,Rn,Un,lo,Jn,Xn,Yn,$e,Kn,be,Fo,ee,Ve,po,st,Qn,co,Zn,Wo,te,at,es,I,it,ts,oe,os,zt,rs,ns,uo,ss,as,is,ye,ls,we,Bo,re,xe,fo,lt,ps,mo,ds,Ho,ne,pt,cs,A,dt,us,se,fs,qt,ms,gs,go,hs,_s,vs,Ge,Ts,ke,Ro;return r=new Ae({}),Oe=new Ae({}),Fe=new Ae({}),We=new O({props:{name:"class transformers.GroupViTConfig",anchor:"transformers.GroupViTConfig",parameters:[{name:"text_config_dict",val:" = None"},{name:"vision_config_dict",val:" = None"},{name:"projection_dim",val:" = 256"},{name:"projection_intermediate_dim",val:" = 4096"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GroupViTConfig.text_config_dict",description:`<strong>text_config_dict</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
...
The standard deviation of the truncated_normal_initializer for initializing all weight matrices.`,name:"initializer_range"},{anchor:"transformers.GroupViTTextConfig.initializer_factor",description:`<strong>initializer_factor</strong> (<code>float</code>, <em>optional</em>, defaults to 1) &#x2014;
...
The standard deviation of the truncated_normal_initializer for initializing all weight matrices.`,name:"initializer_range"},{anchor:"transformers.GroupViTVisionConfig.initializer_factor",description:`<strong>initializer_factor</strong> (<code>float</code>, <em>optional</em>, defaults to 1) &#x2014;
A factor for initializing all weight matrices (should be kept to 1, used internally for initialization
...
`}}),ye=new Go({props:{$$slots:{default:[Ma]},$$scope:{ctx:G}}}),we=new ft({props:{anchor:"transformers.GroupViTTextModel.forward.example",$$slots:{default:[Ca]},$$scope:{ctx:G}}}),lt=new Ae({}),pt=new O({props:{name:"class transformers.GroupViTVisionModel",anchor:"transformers.GroupViTVisionModel",parameters:[{name:"config",val:": GroupViTVisionConfig"}],source:"https://github.com/huggingface/transformers/blob/vr_17313/src/transformers/models/groupvit/modeling_groupvit.py#L1514"}}),dt=new O({props:{name:"forward",anchor:"transformers.GroupViTVisionModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GroupViTVisionModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
<p><a
  href="/docs/transformers/pr_17313/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Ge=new Go({props:{$$slots:{default:[Ea]},$$scope:{ctx:G}}}),ke=new ft({props:{anchor:"transformers.GroupViTVisionModel.forward.example",$$slots:{default:[ja]},$$scope:{ctx:G}}}),{c(){p=n("meta"),T=g(),u=n("h1"),c=n("a"),_=n("span"),$(r.$$.fragment),d=g(),k=n("span"),sr=i("GroupViT"),ko=g(),N=n("h2"),ie=n("a"),Rt=n("span"),$(Oe.$$.fragment),ar=g(),Ut=n("span"),ir=i("Overview"),Mo=g(),L=n("p"),lr=i("The GroupViT model was proposed in "),Le=n("a"),pr=i("GroupViT: Semantic Segmentation Emerges from Text Supervision"),dr=i(` by Jiarui Xu, Shalini De Mello, Sifei Liu, Wonmin Byeon, Thomas Breuel, Jan Kautz, Xiaolong Wang.
Inspired by `),ht=n("a"),cr=i("CLIP"),ur=i(", GroupViT is a vision-language model that can perform zero-shot semantic segmentation on any given vocabulary categories."),Co=g(),_t=n("p"),fr=i("The abstract from the paper is the following:"),Eo=g(),vt=n("p"),Jt=n("em"),mr=i("Grouping and recognition are important components of visual scene understanding, e.g., for object detection and semantic segmentation. With end-to-end deep learning systems, grouping of image regions usually happens implicitly via top-down supervision from pixel-level recognition labels. Instead, in this paper, we propose to bring back the grouping mechanism into deep networks, which allows semantic segments to emerge automatically with only text supervision. We propose a hierarchical Grouping Vision Transformer (GroupViT), which goes beyond the regular grid structure representation and learns to group image regions into progressively larger arbitrary-shaped segments. We train GroupViT jointly with a text encoder on a large-scale image-text dataset via contrastive losses. With only text supervision and without any pixel-level annotations, GroupViT learns to group together semantic regions and successfully transfers to the task of semantic segmentation in a zero-shot manner, i.e., without any further fine-tuning. It achieves a zero-shot accuracy of 52.3% mIoU on the PASCAL VOC 2012 and 22.4% mIoU on PASCAL Context datasets, and performs competitively to state-of-the-art transfer-learning methods requiring greater levels of supervision."),jo=g(),Tt=n("p"),gr=i("Tips:"),Po=g(),$t=n("ul"),De=n("li"),hr=i("You may specify "),Xt=n("code"),_r=i("output_segmentation=True"),vr=i(" to get the segmentation logits of input texts."),zo=g(),D=n("p"),Tr=i("This model was contributed by "),Se=n("a"),$r=i("xvjiarui"),br=i(`.
The original code can be found `),Ne=n("a"),Vr=i("here"),yr=i("."),qo=g(),F=n("h2"),le=n("a"),Yt=n("span"),$(Fe.$$.fragment),wr=g(),Kt=n("span"),xr=i("GroupViTConfig"),Io=g(),C=n("div"),$(We.$$.fragment),Gr=g(),pe=n("p"),bt=n("a"),kr=i("GroupViTConfig"),Mr=i(" is the configuration class to store the configuration of a "),Vt=n("a"),Cr=i("GroupViTModel"),Er=i(`. It is used to
instantiate a GroupViT model according to the specified arguments, defining the text model and vision model configs.`),jr=g(),W=n("p"),Pr=i("Configuration objects inherit from "),yt=n("a"),zr=i("PretrainedConfig"),qr=i(` and can be used to control the model outputs. Read the
...
vision model configuration.`),Ao=g(),B=n("h2"),ce=n("a"),Qt=n("span"),$(Re.$$.fragment),Fr=g(),Zt=n("span"),Wr=i("GroupViTTextConfig"),Oo=g(),E=n("div"),$(Ue.$$.fragment),Br=g(),H=n("p"),Hr=i("This is the configuration class to store the configuration of a "),eo=n("code"),Rr=i("GroupViTTextModel "),Ur=i(`. It is used to instantiate an
...
documentation from `),kt=n("a"),en=i("PretrainedConfig"),tn=i(" for more information."),on=g(),$(ue.$$.fragment),Lo=g(),U=n("h2"),fe=n("a"),to=n("span"),$(Xe.$$.fragment),rn=g(),oo=n("span"),nn=i("GroupViTVisionConfig"),Do=g(),j=n("div"),$(Ye.$$.fragment),sn=g(),J=n("p"),an=i("This is the configuration class to store the configuration of a "),ro=n("code"),ln=i("GroupViTVisionModel "),pn=i(`. It is used to instantiate an
GroupViT model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the GroupViT
...
behavior.`),xn=g(),P=n("div"),$(ot.$$.fragment),Gn=g(),K=n("p"),kn=i("The "),Et=n("a"),Mn=i("GroupViTModel"),Cn=i(" forward method, overrides the "),ao=n("code"),En=i("__call__"),jn=i(" special method."),Pn=g(),$(he.$$.fragment),zn=g(),$(_e.$$.fragment),qn=g(),z=n("div"),$(rt.$$.fragment),In=g(),Q=n("p"),An=i("The "),jt=n("a"),On=i("GroupViTModel"),Ln=i(" forward method, overrides the "),io=n("code"),Dn=i("__call__"),Sn=i(" special method."),Nn=g(),$(ve.$$.fragment),Fn=g(),$(Te.$$.fragment),Wn=g(),q=n("div"),$(nt.$$.fragment),Bn=g(),Z=n("p"),Hn=i("The "),Pt=n("a"),Rn=i("GroupViTModel"),Un=i(" forward method, overrides the "),lo=n("code"),Jn=i("__call__"),Xn=i(" special method."),Yn=g(),$($e.$$.fragment),Kn=g(),$(be.$$.fragment),Fo=g(),ee=n("h2"),Ve=n("a"),po=n("span"),$(st.$$.fragment),Qn=g(),co=n("span"),Zn=i("GroupViTTextModel"),Wo=g(),te=n("div"),$(at.$$.fragment),es=g(),I=n("div"),$(it.$$.fragment),ts=g(),oe=n("p"),os=i("The "),zt=n("a"),rs=i("GroupViTTextModel"),ns=i(" forward method, overrides the "),uo=n("code"),ss=i("__call__"),as=i(" special method."),is=g(),$(ye.$$.fragment),ls=g(),$(we.$$.fragment),Bo=g(),re=n("h2"),xe=n("a"),fo=n("span"),$(lt.$$.fragment),ps=g(),mo=n("span"),ds=i("GroupViTVisionModel"),Ho=g(),ne=n("div"),$(pt.$$.fragment),cs=g(),A=n("div"),$(dt.$$.fragment),us=g(),se=n("p"),fs=i("The "),qt=n("a"),ms=i("GroupViTVisionModel"),gs=i(" forward method, overrides the "),go=n("code"),hs=i("__call__"),_s=i(" special method."),vs=g(),$(Ge.$$.fragment),Ts=g(),$(ke.$$.fragment),this.h()},l(t){const m=va('[data-svelte="svelte-1phssyn"]',document.head);p=s(m,"META",{name:!0,content:!0}),m.forEach(o),T=h(t),u=s(t,"H1",{class:!0});var ct=a(u);c=s(ct,"A",{id:!0,class:!0,href:!0});var ho=a(c);_=s(ho,"SPAN",{});var _o=a(_);b(r.$$.fragment,_o),_o.forEach(o),ho.forEach(o),d=h(ct),k=s(ct,"SPAN",{});var vo=a(k);sr=l(vo,"GroupViT"),vo.forEach(o),ct.forEach(o),ko=h(t),N=s(t,"H2",{class:!0});var ut=a(N);ie=s(ut,"A",{id:!0,class:!0,href:!0});var To=a(ie);Rt=s(To,"SPAN",{});var $o=a(Rt);b(Oe.$$.fragment,$o),$o.forEach(o),To.forEach(o),ar=h(ut),Ut=s(ut,"SPAN",{});var bo=a(Ut);ir=l(bo,"Overview"),bo.forEach(o),ut.forEach(o),Mo=h(t),L=s(t,"P",{});var ae=a(L);lr=l(ae,"The GroupViT model was proposed in "),Le=s(ae,"A",{href:!0,rel:!0});var Vo=a(Le);pr=l(Vo,"GroupViT: Semantic Segmentation Emerges from Text Supervision"),Vo.forEach(o),dr=l(ae,` by Jiarui Xu, Shalini De Mello, Sifei Liu, Wonmin Byeon, Thomas Breuel, Jan Kautz, Xiaolong Wang.
Inspired by `),ht=s(ae,"A",{href:!0});var yo=a(ht);cr=l(yo,"CLIP"),yo.forEach(o),ur=l(ae,", GroupViT is a vision-language model that can perform zero-shot semantic segmentation on any given vocabulary categories."),ae.forEach(o),Co=h(t),_t=s(t,"P",{});var wo=a(_t);fr=l(wo,"The abstract from the paper is the following:"),wo.forEach(o),Eo=h(t),vt=s(t,"P",{});var $s=a(vt);Jt=s($s,"EM",{});var bs=a(Jt);mr=l(bs,"Grouping and recognition are important components of visual scene understanding, e.g., for object detection and semantic segmentation. With end-to-end deep learning systems, grouping of image regions usually happens implicitly via top-down supervision from pixel-level recognition labels. Instead, in this paper, we propose to bring back the grouping mechanism into deep networks, which allows semantic segments to emerge automatically with only text supervision. We propose a hierarchical Grouping Vision Transformer (GroupViT), which goes beyond the regular grid structure representation and learns to group image regions into progressively larger arbitrary-shaped segments. We train GroupViT jointly with a text encoder on a large-scale image-text dataset via contrastive losses. With only text supervision and without any pixel-level annotations, GroupViT learns to group together semantic regions and successfully transfers to the task of semantic segmentation in a zero-shot manner, i.e., without any further fine-tuning. It achieves a zero-shot accuracy of 52.3% mIoU on the PASCAL VOC 2012 and 22.4% mIoU on PASCAL Context datasets, and performs competitively to state-of-the-art transfer-learning methods requiring greater levels of supervision."),bs.forEach(o),$s.forEach(o),jo=h(t),Tt=s(t,"P",{});var Vs=a(Tt);gr=l(Vs,"Tips:"),Vs.forEach(o),Po=h(t),$t=s(t,"UL",{});var ys=a($t);De=s(ys,"LI",{});var Uo=a(De);hr=l(Uo,"You may specify "),Xt=s(Uo,"CODE",{});var ws=a(Xt);_r=l(ws,"output_segmentation=True"),ws.forEach(o),vr=l(Uo," to get the segmentation logits of input texts."),Uo.forEach(o),ys.forEach(o),zo=h(t),D=s(t,"P",{});var It=a(D);Tr=l(It,"This model was contributed by "),Se=s(It,"A",{href:!0,rel:!0});var xs=a(Se);$r=l(xs,"xvjiarui"),xs.forEach(o),br=l(It,`.
The original code can be found `),Ne=s(It,"A",{href:!0,rel:!0});var Gs=a(Ne);Vr=l(Gs,"here"),Gs.forEach(o),yr=l(It,"."),It.forEach(o),qo=h(t),F=s(t,"H2",{class:!0});var Jo=a(F);le=s(Jo,"A",{id:!0,class:!0,href:!0});var ks=a(le);Yt=s(ks,"SPAN",{});var Ms=a(Yt);b(Fe.$$.fragment,Ms),Ms.forEach(o),ks.forEach(o),wr=h(Jo),Kt=s(Jo,"SPAN",{});var Cs=a(Kt);xr=l(Cs,"GroupViTConfig"),Cs.forEach(o),Jo.forEach(o),Io=h(t),C=s(t,"DIV",{class:!0});var Me=a(C);b(We.$$.fragment,Me),Gr=h(Me),pe=s(Me,"P",{});var xo=a(pe);bt=s(xo,"A",{href:!0});var Es=a(bt);kr=l(Es,"GroupViTConfig"),Es.forEach(o),Mr=l(xo," is the configuration class to store the configuration of a "),Vt=s(xo,"A",{href:!0});var js=a(Vt);Cr=l(js,"GroupViTModel"),js.forEach(o),Er=l(xo,`. It is used to
instantiate a GroupViT model according to the specified arguments, defining the text model and vision model configs.`),xo.forEach(o),jr=h(Me),W=s(Me,"P",{});var At=a(W);Pr=l(At,"Configuration objects inherit from "),yt=s(At,"A",{href:!0});var Ps=a(yt);zr=l(Ps,"PretrainedConfig"),Ps.forEach(o),qr=l(At,` and can be used to control the model outputs. Read the
...
vision model configuration.`),Yo.forEach(o),Xo.forEach(o),Me.forEach(o),Ao=h(t),B=s(t,"H2",{class:!0});var Ko=a(B);ce=s(Ko,"A",{id:!0,class:!0,href:!0});var Is=a(ce);Qt=s(Is,"SPAN",{});var As=a(Qt);b(Re.$$.fragment,As),As.forEach(o),Is.forEach(o),Fr=h(Ko),Zt=s(Ko,"SPAN",{});var Os=a(Zt);Wr=l(Os,"GroupViTTextConfig"),Os.forEach(o),Ko.forEach(o),Oo=h(t),E=s(t,"DIV",{class:!0});var Ce=a(E);b(Ue.$$.fragment,Ce),Br=h(Ce),H=s(Ce,"P",{});var Ot=a(H);Hr=l(Ot,"This is the configuration class to store the configuration of a "),eo=s(Ot,"CODE",{});var Ls=a(eo);Rr=l(Ls,"GroupViTTextModel "),Ls.forEach(o),Ur=l(Ot,`. It is used to instantiate an
GroupViT model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the GroupViT
