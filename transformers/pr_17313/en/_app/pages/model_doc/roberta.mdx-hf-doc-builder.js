...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17313/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17313/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);T(qr.$$.fragment,po),Vv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Jv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var y3=a(bd);Kv=i(y3,"RobertaForQuestionAnswering"),y3.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var T3=a(pp);Xv=i(T3,"__call__"),T3.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),T(Zn.$$.fragment,po),e1=h(po),T(es.$$.fragment,po),t1=h(po),T(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w3=a(os);hp=s(w3,"SPAN",{});var $3=a(hp);T(jr.$$.fragment,$3),$3.forEach(t),w3.forEach(t),o1=h(gu),mp=s(gu,"SPAN",{});var F3=a(mp);n1=i(F3,"TFRobertaModel"),F3.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);T(Pr.$$.fragment,Ot),s1=h(Ot),fp=s(Ot,"P",{});var x3=a(fp);a1=i(x3,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x3.forEach(t),r1=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);i1=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R3=a(kd);l1=i(R3,"TFPreTrainedModel"),R3.forEach(t),d1=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),c1=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);p1=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var M3=a(Or);h1=i(M3,"tf.keras.Model"),M3.forEach(t),m1=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),f1=h(Ot),T(ns.$$.fragment,Ot),u1=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);T(Nr.$$.fragment,na),g1=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_1=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E3=a(vd);b1=i(E3,"TFRobertaModel"),E3.forEach(t),k1=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z3=a(up);v1=i(z3,"__call__"),z3.forEach(t),y1=i(Gd," special method."),Gd.forEach(t),T1=h(na),T(ss.$$.fragment,na),w1=h(na),T(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var C3=a(rs);gp=s(C3,"SPAN",{});var q3=a(gp);T(Ir.$$.fragment,q3),q3.forEach(t),C3.forEach(t),$1=h(ku),_p=s(ku,"SPAN",{});var j3=a(_p);F1=i(j3,"TFRobertaForCausalLM"),j3.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);T(Dr.$$.fragment,vu),x1=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);T(Sr.$$.fragment,sa),R1=h(sa),Do=s(sa,"P",{});var Xd=a(Do);M1=i(Xd,"The "),yd=s(Xd,"A",{href:!0});var P3=a(yd);E1=i(P3,"TFRobertaForCausalLM"),P3.forEach(t),z1=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L3=a(bp);C1=i(L3,"__call__"),L3.forEach(t),q1=i(Xd," special method."),Xd.forEach(t),j1=h(sa),T(is.$$.fragment,sa),P1=h(sa),T(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var yu=a(So);ds=s(yu,"A",{id:!0,class:!0,href:!0});var A3=a(ds);kp=s(A3,"SPAN",{});var O3=a(kp);T(Wr.$$.fragment,O3),O3.forEach(t),A3.forEach(t),L1=h(yu),vp=s(yu,"SPAN",{});var N3=a(vp);A1=i(N3,"TFRobertaForMaskedLM"),N3.forEach(t),yu.forEach(t),_f=h(o),Ve=s(o,"DIV",{class:!0});var Nt=a(Ve);T(Br.$$.fragment,Nt),O1=h(Nt),Ur=s(Nt,"P",{});var Tu=a(Ur);N1=i(Tu,"RoBERTa Model with a "),yp=s(Tu,"CODE",{});var I3=a(yp);I1=i(I3,"language modeling"),I3.forEach(t),D1=i(Tu," head on top."),Tu.forEach(t),S1=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);W1=i(wu,"This model inherits from "),Td=s(wu,"A",{href:!0});var D3=a(Td);B1=i(D3,"TFPreTrainedModel"),D3.forEach(t),U1=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),H1=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Q1=i($u,"This model is also a "),Vr=s($u,"A",{href:!0,rel:!0});var S3=a(Vr);V1=i(S3,"tf.keras.Model"),S3.forEach(t),J1=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),K1=h(Nt),T(cs.$$.fragment,Nt),G1=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);T(Jr.$$.fragment,ho),X1=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Y1=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W3=a(wd);Z1=i(W3,"TFRobertaForMaskedLM"),W3.forEach(t),ey=i(Yd," forward method, overrides the "),Tp=s(Yd,"CODE",{});var B3=a(Tp);ty=i(B3,"__call__"),B3.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),T(ps.$$.fragment,ho),sy=h(ho),T(hs.$$.fragment,ho),ay=h(ho),T(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U3=a(fs);wp=s(U3,"SPAN",{});var H3=a(wp);T(Kr.$$.fragment,H3),H3.forEach(t),U3.forEach(t),ry=h(Fu),$p=s(Fu,"SPAN",{});var Q3=a($p);iy=i(Q3,"TFRobertaForSequenceClassification"),Q3.forEach(t),Fu.forEach(t),kf=h(o),Je=s(o,"DIV",{class:!0});var It=a(Je);T(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var V3=a(Fp);dy=i(V3,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V3.forEach(t),cy=h(It),Xr=s(It,"P",{});var xu=a(Xr);py=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var J3=a($d);hy=i(J3,"TFPreTrainedModel"),J3.forEach(t),my=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),fy=h(It),Yr=s(It,"P",{});var Ru=a(Yr);uy=i(Ru,"This model is also a "),Zr=s(Ru,"A",{href:!0,rel:!0});var K3=a(Zr);gy=i(K3,"tf.keras.Model"),K3.forEach(t),_y=i(Ru,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),by=h(It),T(us.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vy=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yy=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G3=a(Fd);Ty=i(G3,"TFRobertaForSequenceClassification"),G3.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X3=a(xp);$y=i(X3,"__call__"),X3.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(mo),T(gs.$$.fragment,mo),Ry=h(mo),T(_s.$$.fragment,mo),My=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y3=a(ks);Rp=s(Y3,"SPAN",{});var Z3=a(Rp);T(ti.$$.fragment,Z3),Z3.forEach(t),Y3.forEach(t),Ey=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),Cy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);qy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tx.forEach(t),jy=h(Dt),ni=s(Dt,"P",{});var Eu=a(ni);Py=i(Eu,"This model inherits from "),xd=s(Eu,"A",{href:!0});var ox=a(xd);Ly=i(ox,"TFPreTrainedModel"),ox.forEach(t),Ay=i(Eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eu.forEach(t),Oy=h(Dt),si=s(Dt,"P",{});var zu=a(si);Ny=i(zu,"This model is also a "),ai=s(zu,"A",{href:!0,rel:!0});var nx=a(ai);Iy=i(nx,"tf.keras.Model"),nx.forEach(t),Dy=i(zu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),Sy=h(Dt),T(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sx=a(Rd);Hy=i(sx,"TFRobertaForMultipleChoice"),sx.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var ax=a(zp);Vy=i(ax,"__call__"),ax.forEach(t),Jy=i(ec," special method."),ec.forEach(t),Ky=h(aa),T(ys.$$.fragment,aa),Gy=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var rx=a(ws);Cp=s(rx,"SPAN",{});var ix=a(Cp);T(ii.$$.fragment,ix),ix.forEach(t),rx.forEach(t),Xy=h(Cu),qp=s(Cu,"SPAN",{});var lx=a(qp);Yy=i(lx,"TFRobertaForTokenClassification"),lx.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var dx=a(jp);eT=i(dx,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dx.forEach(t),tT=h(St),di=s(St,"P",{});var qu=a(di);oT=i(qu,"This model inherits from "),Md=s(qu,"A",{href:!0});var cx=a(Md);nT=i(cx,"TFPreTrainedModel"),cx.forEach(t),sT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),aT=h(St),ci=s(St,"P",{});var ju=a(ci);rT=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var px=a(pi);iT=i(px,"tf.keras.Model"),px.forEach(t),lT=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dT=h(St),T($s.$$.fragment,St),cT=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);T(hi.$$.fragment,fo),pT=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hT=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hx=a(Ed);mT=i(hx,"TFRobertaForTokenClassification"),hx.forEach(t),fT=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mx=a(Pp);uT=i(mx,"__call__"),mx.forEach(t),gT=i(tc," special method."),tc.forEach(t),_T=h(fo),T(Fs.$$.fragment,fo),bT=h(fo),T(xs.$$.fragment,fo),kT=h(fo),T(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fx=a(Ms);Lp=s(fx,"SPAN",{});var ux=a(Lp);T(mi.$$.fragment,ux),ux.forEach(t),fx.forEach(t),vT=h(Pu),Ap=s(Pu,"SPAN",{});var gx=a(Ap);yT=i(gx,"TFRobertaForQuestionAnswering"),gx.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);T(fi.$$.fragment,Wt),TT=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wT=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _x=a(Op);$T=i(_x,"span start logits"),_x.forEach(t),FT=i(oc," and "),Np=s(oc,"CODE",{});var bx=a(Np);xT=i(bx,"span end logits"),bx.forEach(t),RT=i(oc,")."),oc.forEach(t),MT=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);ET=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var kx=a(zd);zT=i(kx,"TFPreTrainedModel"),kx.forEach(t),CT=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),qT=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jT=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var vx=a(_i);PT=i(vx,"tf.keras.Model"),vx.forEach(t),LT=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),AT=h(Wt),T(Es.$$.fragment,Wt),OT=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),NT=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);IT=i(nc,"The "),Cd=s(nc,"A",{href:!0});var yx=a(Cd);DT=i(yx,"TFRobertaForQuestionAnswering"),yx.forEach(t),ST=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var Tx=a(Ip);WT=i(Tx,"__call__"),Tx.forEach(t),BT=i(nc," special method."),nc.forEach(t),UT=h(uo),T(zs.$$.fragment,uo),HT=h(uo),T(Cs.$$.fragment,uo),QT=h(uo),T(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wx=a(js);Dp=s(wx,"SPAN",{});var $x=a(Dp);T(ki.$$.fragment,$x),$x.forEach(t),wx.forEach(t),VT=h(Ou),Sp=s(Ou,"SPAN",{});var Fx=a(Sp);JT=i(Fx,"FlaxRobertaModel"),Fx.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),KT=h(gt),Wp=s(gt,"P",{});var xx=a(Wp);GT=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),XT=h(gt),yi=s(gt,"P",{});var Nu=a(yi);YT=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var Rx=a(qd);ZT=i(Rx,"FlaxPreTrainedModel"),Rx.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),tw=h(gt),Ti=s(gt,"P",{});var Iu=a(Ti);ow=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var Mx=a(wi);nw=i(Mx,"flax.linen.Module"),Mx.forEach(t),sw=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),aw=h(gt),Bp=s(gt,"P",{});var Ex=a(Bp);rw=i(Ex,"Finally, this model supports inherent JAX features such as:"),Ex.forEach(t),iw=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zx=a(Up);$i=s(zx,"A",{href:!0,rel:!0});var Cx=a($i);lw=i(Cx,"Just-In-Time (JIT) compilation"),Cx.forEach(t),zx.forEach(t),dw=h(ra),Hp=s(ra,"LI",{});var qx=a(Hp);Fi=s(qx,"A",{href:!0,rel:!0});var jx=a(Fi);cw=i(jx,"Automatic Differentiation"),jx.forEach(t),qx.forEach(t),pw=h(ra),Qp=s(ra,"LI",{});var Px=a(Qp);xi=s(Px,"A",{href:!0,rel:!0});var Lx=a(xi);hw=i(Lx,"Vectorization"),Lx.forEach(t),Px.forEach(t),mw=h(ra),Vp=s(ra,"LI",{});var Ax=a(Vp);Ri=s(Ax,"A",{href:!0,rel:!0});var Ox=a(Ri);fw=i(Ox,"Parallelization"),Ox.forEach(t),Ax.forEach(t),ra.forEach(t),uw=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);T(Mi.$$.fragment,ia),gw=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_w=i(sc,"The "),Jp=s(sc,"CODE",{});var Nx=a(Jp);bw=i(Nx,"FlaxRobertaPreTrainedModel"),Nx.forEach(t),kw=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var Ix=a(Kp);vw=i(Ix,"__call__"),Ix.forEach(t),yw=i(sc," special method."),sc.forEach(t),Tw=h(ia),T(Ps.$$.fragment,ia),ww=h(ia),T(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var Dx=a(As);Gp=s(Dx,"SPAN",{});var Sx=a(Gp);T(Ei.$$.fragment,Sx),Sx.forEach(t),Dx.forEach(t),$w=h(Du),Xp=s(Du,"SPAN",{});var Wx=a(Xp);Fw=i(Wx,"FlaxRobertaForCausalLM"),Wx.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);T(zi.$$.fragment,_t),xw=h(_t),Yp=s(_t,"P",{});var Bx=a(Yp);Rw=i(Bx,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),Bx.forEach(t),Mw=h(_t),Ci=s(_t,"P",{});var Su=a(Ci);Ew=i(Su,"This model inherits from "),jd=s(Su,"A",{href:!0});var Ux=a(jd);zw=i(Ux,"FlaxPreTrainedModel"),Ux.forEach(t),Cw=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Su.forEach(t),qw=h(_t),qi=s(_t,"P",{});var Wu=a(qi);jw=i(Wu,"This model is also a Flax Linen "),ji=s(Wu,"A",{href:!0,rel:!0});var Hx=a(ji);Pw=i(Hx,"flax.linen.Module"),Hx.forEach(t),Lw=i(Wu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),Aw=h(_t),Zp=s(_t,"P",{});var Qx=a(Zp);Ow=i(Qx,"Finally, this model supports inherent JAX features such as:"),Qx.forEach(t),Nw=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var Vx=a(eh);Pi=s(Vx,"A",{href:!0,rel:!0});var Jx=a(Pi);Iw=i(Jx,"Just-In-Time (JIT) compilation"),Jx.forEach(t),Vx.forEach(t),Dw=h(la),th=s(la,"LI",{});var Kx=a(th);Li=s(Kx,"A",{href:!0,rel:!0});var Gx=a(Li);Sw=i(Gx,"Automatic Differentiation"),Gx.forEach(t),Kx.forEach(t),Ww=h(la),oh=s(la,"LI",{});var Xx=a(oh);Ai=s(Xx,"A",{href:!0,rel:!0});var Yx=a(Ai);Bw=i(Yx,"Vectorization"),Yx.forEach(t),Xx.forEach(t),Uw=h(la),nh=s(la,"LI",{});var Zx=a(nh);Oi=s(Zx,"A",{href:!0,rel:!0});var eR=a(Oi);Hw=i(eR,"Parallelization"),eR.forEach(t),Zx.forEach(t),la.forEach(t),Qw=h(_t),Ct=s(_t,"DIV",{class:!0});var da=a(Ct);T(Ni.$$.fragment,da),Vw=h(da),tn=s(da,"P",{});var ac=a(tn);Jw=i(ac,"The "),sh=s(ac,"CODE",{});var tR=a(sh);Kw=i(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),Gw=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oR=a(ah);Xw=i(oR,"__call__"),oR.forEach(t),Yw=i(ac," special method."),ac.forEach(t),Zw=h(da),T(Os.$$.fragment,da),e$=h(da),T(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nR=a(Is);rh=s(nR,"SPAN",{});var sR=a(rh);T(Ii.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t$=h(Bu),ih=s(Bu,"SPAN",{});var aR=a(ih);o$=i(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Bu.forEach(t),Cf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);T(Di.$$.fragment,bt),n$=h(bt),Si=s(bt,"P",{});var Uu=a(Si);s$=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rR=a(lh);a$=i(rR,"language modeling"),rR.forEach(t),r$=i(Uu," head on top."),Uu.forEach(t),i$=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);l$=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iR=a(Pd);d$=i(iR,"FlaxPreTrainedModel"),iR.forEach(t),c$=i(Hu,`. Check the superclass documentation for the generic methods the
