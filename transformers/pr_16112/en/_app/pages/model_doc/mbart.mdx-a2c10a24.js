...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16112/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16112/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16112/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16112/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16112/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16112/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Wz]},$$scope:{ctx:E}}}),Ns=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16112/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16112/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16112/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16112/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),_r=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16112/src/transformers/models/mbart/modeling_flax_mbart.py#L1343",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16112/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16112/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16112/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16112/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16112/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16112/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16112/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Ot),$s=a(Ot,"P",{});var _u=s($s);e1=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var Vw=s(Fs);t1=i(Vw,"tf.keras.Model"),Vw.forEach(t),o1=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),n1=l(Ot),f(cn.$$.fragment,Ot),a1=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),s1=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);r1=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Qw=s(xi);i1=i(Qw,"TFMBartModel"),Qw.forEach(t),d1=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var Jw=s(oc);l1=i(Jw,"__call__"),Jw.forEach(t),c1=i(Ui," special method."),Ui.forEach(t),p1=l(Dt),f(pn.$$.fragment,Dt),h1=l(Dt),nc=a(Dt,"P",{});var Kw=s(nc);u1=i(Kw,"Example:"),Kw.forEach(t),m1=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Zw=s(hn);ac=a(Zw,"SPAN",{});var Yw=s(ac);f(Ps.$$.fragment,Yw),Yw.forEach(t),Zw.forEach(t),f1=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_1=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),g1=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);k1=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var tx=s(zi);b1=i(tx,"TFPreTrainedModel"),tx.forEach(t),v1=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),y1=l(Lt),As=a(Lt,"P",{});var bu=s(As);T1=i(bu,"This model is also a "),Is=a(bu,"A",{href:!0,rel:!0});var ox=s(Is);M1=i(ox,"tf.keras.Model"),ox.forEach(t),w1=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),x1=l(Lt),f(un.$$.fragment,Lt),z1=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Ns.$$.fragment,We),q1=l(We),xo=a(We,"P",{});var Xi=s(xo);B1=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var nx=s(qi);$1=i(nx,"TFMBartForConditionalGeneration"),nx.forEach(t),F1=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var ax=s(rc);j1=i(ax,"__call__"),ax.forEach(t),E1=i(Xi," special method."),Xi.forEach(t),P1=l(We),f(mn.$$.fragment,We),C1=l(We),ic=a(We,"P",{});var sx=s(ic);S1=i(sx,"Summarization example:"),sx.forEach(t),A1=l(We),f(Os.$$.fragment,We),I1=l(We),dc=a(We,"P",{});var rx=s(dc);N1=i(rx,"Mask filling example:"),rx.forEach(t),O1=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),oh=l(o),zo=a(o,"H2",{class:!0});var vu=s(zo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var ix=s(fn);lc=a(ix,"SPAN",{});var dx=s(lc);f(Ls.$$.fragment,dx),dx.forEach(t),ix.forEach(t),D1=l(vu),cc=a(vu,"SPAN",{});var lx=s(cc);L1=i(lx,"FlaxMBartModel"),lx.forEach(t),vu.forEach(t),nh=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),G1=l(me),Ws=a(me,"P",{});var yu=s(Ws);W1=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=a(yu,"A",{href:!0});var cx=s(Bi);R1=i(cx,"FlaxPreTrainedModel"),cx.forEach(t),U1=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yu.forEach(t),X1=l(me),Rs=a(me,"P",{});var Tu=s(Rs);H1=i(Tu,`This model is also a Flax Linen
`),Us=a(Tu,"A",{href:!0,rel:!0});var px=s(Us);V1=i(px,"flax.nn.Module"),px.forEach(t),Q1=i(Tu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tu.forEach(t),J1=l(me),pc=a(me,"P",{});var hx=s(pc);K1=i(hx,"Finally, this model supports inherent JAX features such as:"),hx.forEach(t),Z1=l(me),mt=a(me,"UL",{});var Fn=s(mt);hc=a(Fn,"LI",{});var ux=s(hc);Xs=a(ux,"A",{href:!0,rel:!0});var mx=s(Xs);Y1=i(mx,"Just-In-Time (JIT) compilation"),mx.forEach(t),ux.forEach(t),ev=l(Fn),uc=a(Fn,"LI",{});var fx=s(uc);Hs=a(fx,"A",{href:!0,rel:!0});var _x=s(Hs);tv=i(_x,"Automatic Differentiation"),_x.forEach(t),fx.forEach(t),ov=l(Fn),mc=a(Fn,"LI",{});var gx=s(mc);Vs=a(gx,"A",{href:!0,rel:!0});var kx=s(Vs);nv=i(kx,"Vectorization"),kx.forEach(t),gx.forEach(t),av=l(Fn),fc=a(Fn,"LI",{});var bx=s(fc);Qs=a(bx,"A",{href:!0,rel:!0});var vx=s(Qs);sv=i(vx,"Parallelization"),vx.forEach(t),bx.forEach(t),Fn.forEach(t),rv=l(me),Ne=a(me,"DIV",{class:!0});var Gt=s(Ne);f(Js.$$.fragment,Gt),iv=l(Gt),qo=a(Gt,"P",{});var Hi=s(qo);dv=i(Hi,"The "),_c=a(Hi,"CODE",{});var yx=s(_c);lv=i(yx,"FlaxMBartPreTrainedModel"),yx.forEach(t),cv=i(Hi,"forward method, overrides the "),gc=a(Hi,"CODE",{});var Tx=s(gc);pv=i(Tx,"__call__"),Tx.forEach(t),hv=i(Hi," special method."),Hi.forEach(t),uv=l(Gt),f(_n.$$.fragment,Gt),mv=l(Gt),kc=a(Gt,"P",{});var Mx=s(kc);fv=i(Mx,"Example:"),Mx.forEach(t),_v=l(Gt),f(Ks.$$.fragment,Gt),Gt.forEach(t),gv=l(me),Mt=a(me,"DIV",{class:!0});var Vi=s(Mt);f(Zs.$$.fragment,Vi),kv=l(Vi),bc=a(Vi,"P",{});var wx=s(bc);bv=i(wx,"Example:"),wx.forEach(t),vv=l(Vi),f(Ys.$$.fragment,Vi),Vi.forEach(t),yv=l(me),wt=a(me,"DIV",{class:!0});var Qi=s(wt);f(er.$$.fragment,Qi),Tv=l(Qi),vc=a(Qi,"P",{});var xx=s(vc);Mv=i(xx,"Example:"),xx.forEach(t),wv=l(Qi),f(tr.$$.fragment,Qi),Qi.forEach(t),me.forEach(t),ah=l(o),Bo=a(o,"H2",{class:!0});var Mu=s(Bo);gn=a(Mu,"A",{id:!0,class:!0,href:!0});var zx=s(gn);yc=a(zx,"SPAN",{});var qx=s(yc);f(or.$$.fragment,qx),qx.forEach(t),zx.forEach(t),xv=l(Mu),Tc=a(Mu,"SPAN",{});var Bx=s(Tc);zv=i(Bx,"FlaxMBartForConditionalGeneration"),Bx.forEach(t),Mu.forEach(t),sh=l(o),R=a(o,"DIV",{class:!0});var fe=s(R);f(nr.$$.fragment,fe),qv=l(fe),ar=a(fe,"P",{});var wu=s(ar);Bv=i(wu,`The MMBart Model with a language modeling head. Can be used for summarization.
