import{S as X1,i as K1,s as Z1,e as a,k as h,w as y,t as i,M as Y1,c as s,d as t,m as u,a as r,x as v,h as d,b as f,F as e,g as k,y as T,q as w,o as $,B as x,v as eT,L as P}from"../../chunks/vendor-6b77c823.js";import{T as Fe}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-1088f2fb.js";import{C}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as V}from"../../chunks/IconCopyLink-7a11ce68.js";import{E}from"../../chunks/ExampleCodeBlock-5212b321.js";function tT(F){let l,g,m,c,_;return c=new C({props:{code:`from transformers import BartModel, BartConfig
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/tokenization_bart.py#L390",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
Whether the post processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/tokenization_bart_fast.py#L70"}}),Eo=new E({props:{anchor:"transformers.BartTokenizerFast.example",$$slots:{default:[aT]},$$scope:{ctx:F}}}),Po=new Fe({props:{$$slots:{default:[sT]},$$scope:{ctx:F}}}),Ma=new B({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/tokenization_bart_fast.py#L282",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_bart.py#L1168",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17188/en/model_doc/bart#transformers.BartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_bart.py#L1307",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_bart.py#L1450",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_bart.py#L1576",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_bart.py#L1725",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_tf_bart.py#L1142",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_tf_bart.py#L1251",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_flax_bart.py#L999",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_flax_bart.py#L1062",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_flax_bart.py#L1331",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_flax_bart.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17188/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17188/src/transformers/models/bart/modeling_flax_bart.py#L1802",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17188/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Fp.forEach(t),Zg=u(te),Rd=s(te,"P",{});var a1=r(Rd);Yg=d(a1,"Finally, this model supports inherent JAX features such as:"),a1.forEach(t),eb=u(te),ut=s(te,"UL",{});var ea=r(ut);Qd=s(ea,"LI",{});var s1=r(Qd);Hs=s(s1,"A",{href:!0,rel:!0});var r1=r(Hs);tb=d(r1,"Just-In-Time (JIT) compilation"),r1.forEach(t),s1.forEach(t),ob=u(ea),Hd=s(ea,"LI",{});var i1=r(Hd);Vs=s(i1,"A",{href:!0,rel:!0});var d1=r(Vs);nb=d(d1,"Automatic Differentiation"),d1.forEach(t),i1.forEach(t),ab=u(ea),Vd=s(ea,"LI",{});var l1=r(Vd);Js=s(l1,"A",{href:!0,rel:!0});var c1=r(Js);sb=d(c1,"Vectorization"),c1.forEach(t),l1.forEach(t),rb=u(ea),Jd=s(ea,"LI",{});var p1=r(Jd);Xs=s(p1,"A",{href:!0,rel:!0});var h1=r(Xs);ib=d(h1,"Parallelization"),h1.forEach(t),p1.forEach(t),ea.forEach(t),db=u(te),Ke=s(te,"DIV",{class:!0});var ta=r(Ke);v(Ks.$$.fragment,ta),lb=u(ta),po=s(ta,"P",{});var ki=r(po);cb=d(ki,"The "),Xd=s(ki,"CODE",{});var u1=r(Xd);pb=d(u1,"FlaxBartPreTrainedModel"),u1.forEach(t),hb=d(ki," forward method, overrides the "),Kd=s(ki,"CODE",{});var m1=r(Kd);ub=d(m1,"__call__"),m1.forEach(t),mb=d(ki," special method."),ki.forEach(t),fb=u(ta),v(qn.$$.fragment,ta),_b=u(ta),v(Bn.$$.fragment,ta),ta.forEach(t),gb=u(te),jn=s(te,"DIV",{class:!0});var zp=r(jn);v(Zs.$$.fragment,zp),bb=u(zp),v(Cn.$$.fragment,zp),zp.forEach(t),kb=u(te),Mn=s(te,"DIV",{class:!0});var qp=r(Mn);v(Ys.$$.fragment,qp),yb=u(qp),v(En.$$.fragment,qp),qp.forEach(t),te.forEach(t),zc=u(o),ho=s(o,"H2",{class:!0});var Bp=r(ho);Pn=s(Bp,"A",{id:!0,class:!0,href:!0});var f1=r(Pn);Zd=s(f1,"SPAN",{});var _1=r(Zd);v(er.$$.fragment,_1),_1.forEach(t),f1.forEach(t),vb=u(Bp),Yd=s(Bp,"SPAN",{});var g1=r(Yd);Tb=d(g1,"FlaxBartForQuestionAnswering"),g1.forEach(t),Bp.forEach(t),qc=u(o),L=s(o,"DIV",{class:!0});var oe=r(L);v(tr.$$.fragment,oe),wb=u(oe),uo=s(oe,"P",{});var yi=r(uo);$b=d(yi,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),el=s(yi,"CODE",{});var b1=r(el);xb=d(b1,"span start logits"),b1.forEach(t),Fb=d(yi," and "),tl=s(yi,"CODE",{});var k1=r(tl);zb=d(k1,"span end logits"),k1.forEach(t),qb=d(yi,")."),yi.forEach(t),Bb=u(oe),or=s(oe,"P",{});var jp=r(or);jb=d(jp,"This model inherits from "),oi=s(jp,"A",{href:!0});var y1=r(oi);Cb=d(y1,"FlaxPreTrainedModel"),y1.forEach(t),Mb=d(jp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Cp.forEach(t),Ob=u(oe),ol=s(oe,"P",{});var T1=r(ol);Ib=d(T1,"Finally, this model supports inherent JAX features such as:"),T1.forEach(t),Nb=u(oe),mt=s(oe,"UL",{});var oa=r(mt);nl=s(oa,"LI",{});var w1=r(nl);sr=s(w1,"A",{href:!0,rel:!0});var $1=r(sr);Lb=d($1,"Just-In-Time (JIT) compilation"),$1.forEach(t),w1.forEach(t),Db=u(oa),al=s(oa,"LI",{});var x1=r(al);rr=s(x1,"A",{href:!0,rel:!0});var F1=r(rr);Gb=d(F1,"Automatic Differentiation"),F1.forEach(t),x1.forEach(t),Wb=u(oa),sl=s(oa,"LI",{});var z1=r(sl);ir=s(z1,"A",{href:!0,rel:!0});var q1=r(ir);Ub=d(q1,"Vectorization"),q1.forEach(t),z1.forEach(t),Rb=u(oa),rl=s(oa,"LI",{});var B1=r(rl);dr=s(B1,"A",{href:!0,rel:!0});var j1=r(dr);Qb=d(j1,"Parallelization"),j1.forEach(t),B1.forEach(t),oa.forEach(t),Hb=u(oe),Ze=s(oe,"DIV",{class:!0});var na=r(Ze);v(lr.$$.fragment,na),Vb=u(na),mo=s(na,"P",{});var vi=r(mo);Jb=d(vi,"The "),il=s(vi,"CODE",{});var C1=r(il);Xb=d(C1,"FlaxBartPreTrainedModel"),C1.forEach(t),Kb=d(vi," forward method, overrides the "),dl=s(vi,"CODE",{});var M1=r(dl);Zb=d(M1,"__call__"),M1.forEach(t),Yb=d(vi," special method."),vi.forEach(t),ek=u(na),v(An.$$.fragment,na),tk=u(na),v(Sn.$$.fragment,na),na.forEach(t),ok=u(oe),On=s(oe,"DIV",{class:!0});var Mp=r(On);v(cr.$$.fragment,Mp),nk=u(Mp),v(In.$$.fragment,Mp),Mp.forEach(t),ak=u(oe),Nn=s(oe,"DIV",{class:!0});var Ep=r(Nn);v(pr.$$.fragment,Ep),sk=u(Ep),v(Ln.$$.fragment,Ep),Ep.forEach(t),oe.forEach(t),Bc=u(o),fo=s(o,"H2",{class:!0});var Pp=r(fo);Dn=s(Pp,"A",{id:!0,class:!0,href:!0});var E1=r(Dn);ll=s(E1,"SPAN",{});var P1=r(ll);v(hr.$$.fragment,P1),P1.forEach(t),E1.forEach(t),rk=u(Pp),cl=s(Pp,"SPAN",{});var A1=r(cl);ik=d(A1,"FlaxBartForCausalLM"),A1.forEach(t),Pp.forEach(t),jc=u(o),Z=s(o,"DIV",{class:!0});var Ae=r(Z);v(ur.$$.fragment,Ae),dk=u(Ae),pl=s(Ae,"P",{});var S1=r(pl);lk=d(S1,`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
e.g for autoregressive tasks.`),S1.forEach(t),ck=u(Ae),mr=s(Ae,"P",{});var Ap=r(mr);pk=d(Ap,"This model inherits from "),ni=s(Ap,"A",{href:!0});var O1=r(ni);hk=d(O1,"FlaxPreTrainedModel"),O1.forEach(t),uk=d(Ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
