import{S as Y1,i as Z1,s as J1,e as a,k as d,w as v,t as o,M as X1,c as r,d as t,m as c,a as i,x as k,h as s,b as h,F as e,g as m,y,q as w,o as $,B as x,v as Q1,L as ge}from"../../chunks/vendor-6b77c823.js";import{T as wt}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-1088f2fb.js";import{C as S}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as _e}from"../../chunks/ExampleCodeBlock-5212b321.js";function ey(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/tokenization_t5.py#L243",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/tokenization_t5.py#L183",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/tokenization_t5.py#L221",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/tokenization_t5_fast.py#L186",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/tokenization_t5_fast.py#L212",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17155/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17155/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17155/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17155/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_t5.py#L1345",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17155/en/model_doc/t5#transformers.T5Config"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_t5.py#L1301"}}),Mn=new _e({props:{anchor:"transformers.T5Model.parallelize.example",$$slots:{default:[ny]},$$scope:{ctx:j}}}),Us=new C({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_t5.py#L1313"}}),Cn=new _e({props:{anchor:"transformers.T5Model.deparallelize.example",$$slots:{default:[oy]},$$scope:{ctx:j}}}),Ws=new ve({}),Bs=new C({props:{name:"class transformers.T5ForConditionalGeneration",anchor:"transformers.T5ForConditionalGeneration",parameters:[{name:"config",val:": T5Config"}],parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17155/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17155/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"},{anchor:"transformers.T5ForConditionalGeneration.forward.labels",description:`<strong>labels</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size,)</code>, <em>optional</em>) &#x2014;
Labels for computing the sequence classification/regression loss. Indices should be in <code>[-100, 0, ..., config.vocab_size - 1]</code>. All labels set to <code>-100</code> are ignored (masked), the loss is only computed for
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_t5.py#L1539",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_t5.py#L1495"}}),Ln=new _e({props:{anchor:"transformers.T5ForConditionalGeneration.parallelize.example",$$slots:{default:[ry]},$$scope:{ctx:j}}}),Qs=new C({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_t5.py#L1508"}}),An=new _e({props:{anchor:"transformers.T5ForConditionalGeneration.deparallelize.example",$$slots:{default:[iy]},$$scope:{ctx:j}}}),ea=new ve({}),ta=new C({props:{name:"class transformers.T5EncoderModel",anchor:"transformers.T5EncoderModel",parameters:[{name:"config",val:": T5Config"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17155/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17155/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_t5.py#L1810",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17155/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_tf_t5.py#L1134",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_tf_t5.py#L1309",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_tf_t5.py#L1618",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17155/src/transformers/models/t5/modeling_flax_t5.py#L958",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_17155/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
for summarization: `),R=r(dn,"EM",{});var $d=i(R);Oe=s($d,"summarize: \u2026"),$d.forEach(t),z=s(dn,"."),dn.forEach(t),yd.forEach(t),F=c(ln),te=r(ln,"LI",{});var xd=i(te);Ge=r(xd,"P",{});var zd=i(Ge);et=s(zd,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),zd.forEach(t),xd.forEach(t),D=c(ln),Ue=r(ln,"LI",{});var jd=i(Ue);ne=r(jd,"P",{});var yt=i(ne);tt=s(yt,"See the "),L=r(yt,"A",{href:!0});var qd=i(L);Y=s(qd,"training"),qd.forEach(t),nt=s(yt,", "),Le=r(yt,"A",{href:!0});var Ed=i(Le);Z=s(Ed,"inference"),Ed.forEach(t),ot=s(yt," and "),Ae=r(yt,"A",{href:!0});var Fd=i(Ae);Ie=s(Fd,"scripts"),Fd.forEach(t),st=s(yt," sections below for all details regarding usage."),yt.forEach(t),jd.forEach(t),ln.forEach(t),Ld=c(n),Ka=r(n,"P",{});var Md=i(Ka);Hp=s(Md,"T5 comes in different sizes:"),Md.forEach(t),Ad=c(n),We=r(n,"UL",{});var Qe=i(We);ri=r(Qe,"LI",{});var Cd=i(ri);ii=r(Cd,"P",{});var p5=i(ii);Po=r(p5,"A",{href:!0,rel:!0});var h5=i(Po);Vp=s(h5,"t5-small"),h5.forEach(t),p5.forEach(t),Cd.forEach(t),Kp=c(Qe),li=r(Qe,"LI",{});var u5=i(li);di=r(u5,"P",{});var m5=i(di);No=r(m5,"A",{href:!0,rel:!0});var f5=i(No);Yp=s(f5,"t5-base"),f5.forEach(t),m5.forEach(t),u5.forEach(t),Zp=c(Qe),ci=r(Qe,"LI",{});var _5=i(ci);pi=r(_5,"P",{});var g5=i(pi);Oo=r(g5,"A",{href:!0,rel:!0});var T5=i(Oo);Jp=s(T5,"t5-large"),T5.forEach(t),g5.forEach(t),_5.forEach(t),Xp=c(Qe),hi=r(Qe,"LI",{});var b5=i(hi);ui=r(b5,"P",{});var v5=i(ui);Lo=r(v5,"A",{href:!0,rel:!0});var k5=i(Lo);Qp=s(k5,"t5-3b"),k5.forEach(t),v5.forEach(t),b5.forEach(t),eh=c(Qe),mi=r(Qe,"LI",{});var y5=i(mi);Ya=r(y5,"P",{});var r5=i(Ya);Ao=r(r5,"A",{href:!0,rel:!0});var w5=i(Ao);th=s(w5,"t5-11b"),w5.forEach(t),nh=s(r5,"."),r5.forEach(t),y5.forEach(t),Qe.forEach(t),Id=c(n),Za=r(n,"P",{});var $5=i(Za);oh=s($5,"Based on the original T5 model, Google has released some follow-up works:"),$5.forEach(t),Dd=c(n),$t=r(n,"UL",{});var Dr=i($t);fi=r(Dr,"LI",{});var x5=i(fi);cn=r(x5,"P",{});var Pd=i(cn);_i=r(Pd,"STRONG",{});var z5=i(_i);sh=s(z5,"T5v1.1"),z5.forEach(t),ah=s(Pd,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),Ja=r(Pd,"A",{href:!0});var j5=i(Ja);rh=s(j5,"here"),j5.forEach(t),ih=s(Pd,"."),Pd.forEach(t),x5.forEach(t),lh=c(Dr),gi=r(Dr,"LI",{});var q5=i(gi);pn=r(q5,"P",{});var Nd=i(pn);Ti=r(Nd,"STRONG",{});var E5=i(Ti);dh=s(E5,"mT5"),E5.forEach(t),ch=s(Nd,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),Xa=r(Nd,"A",{href:!0});var F5=i(Xa);ph=s(F5,"here"),F5.forEach(t),hh=s(Nd,"."),Nd.forEach(t),q5.forEach(t),uh=c(Dr),bi=r(Dr,"LI",{});var M5=i(bi);hn=r(M5,"P",{});var Od=i(hn);vi=r(Od,"STRONG",{});var C5=i(vi);mh=s(C5,"byT5"),C5.forEach(t),fh=s(Od,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),Qa=r(Od,"A",{href:!0});var P5=i(Qa);_h=s(P5,"here"),P5.forEach(t),gh=s(Od,"."),Od.forEach(t),M5.forEach(t),Dr.forEach(t),Sd=c(n),un=r(n,"P",{});var Hc=i(un);Th=s(Hc,"All checkpoints can be found on the "),Io=r(Hc,"A",{href:!0,rel:!0});var N5=i(Io);bh=s(N5,"hub"),N5.forEach(t),vh=s(Hc,"."),Hc.forEach(t),Gd=c(n),xt=r(n,"P",{});var Sr=i(xt);kh=s(Sr,"This model was contributed by "),Do=r(Sr,"A",{href:!0,rel:!0});var O5=i(Do);yh=s(O5,"thomwolf"),O5.forEach(t),wh=s(Sr,". The original code can be found "),So=r(Sr,"A",{href:!0,rel:!0});var L5=i(So);$h=s(L5,"here"),L5.forEach(t),xh=s(Sr,"."),Sr.forEach(t),Ud=c(n),er=r(n,"A",{id:!0}),i(er).forEach(t),Wd=c(n),Ot=r(n,"H2",{class:!0});var Vc=i(Ot);mn=r(Vc,"A",{id:!0,class:!0,href:!0});var A5=i(mn);ki=r(A5,"SPAN",{});var I5=i(ki);k(Go.$$.fragment,I5),I5.forEach(t),A5.forEach(t),zh=c(Vc),yi=r(Vc,"SPAN",{});var D5=i(yi);jh=s(D5,"Training"),D5.forEach(t),Vc.forEach(t),Bd=c(n),at=r(n,"P",{});var _o=i(at);qh=s(_o,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),wi=r(_o,"CODE",{});var S5=i(wi);Eh=s(S5,"input_ids"),S5.forEach(t),Fh=s(_o,`. The target sequence is shifted to the right, i.e., prepended by a
start-sequence token and fed to the decoder using the `),$i=r(_o,"CODE",{});var G5=i($i);Mh=s(G5,"decoder_input_ids"),G5.forEach(t),Ch=s(_o,`. In teacher-forcing style, the target
sequence is then appended by the EOS token and corresponds to the `),xi=r(_o,"CODE",{});var U5=i(xi);Ph=s(U5,"labels"),U5.forEach(t),Nh=s(_o,`. The PAD token is hereby used as the
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),_o.forEach(t),Rd=c(n),fn=r(n,"P",{});var Kc=i(fn);Oh=s(Kc,"One can use "),tr=r(Kc,"A",{href:!0});var W5=i(tr);Lh=s(W5,"T5ForConditionalGeneration"),W5.forEach(t),Ah=s(Kc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Kc.forEach(t),Hd=c(n),nr=r(n,"UL",{});var B5=i(nr);zi=r(B5,"LI",{});var R5=i(zi);Ih=s(R5,"Unsupervised denoising training"),R5.forEach(t),B5.forEach(t),Vd=c(n),me=r(n,"P",{});var Re=i(me);Dh=s(Re,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=r(Re,"EM",{});var H5=i(ji);Sh=s(H5,"a.k.a"),H5.forEach(t),Gh=s(Re,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),qi=r(Re,"EM",{});var V5=i(qi);Uh=s(V5,"real"),V5.forEach(t),Wh=s(Re,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Ei=r(Re,"CODE",{});var K5=i(Ei);Bh=s(K5,"<extra_id_0>"),K5.forEach(t),Rh=s(Re,`,
`),Fi=r(Re,"CODE",{});var Y5=i(Fi);Hh=s(Y5,"<extra_id_1>"),Y5.forEach(t),Vh=s(Re,", \u2026 up to "),Mi=r(Re,"CODE",{});var Z5=i(Mi);Kh=s(Z5,"<extra_id_99>"),Z5.forEach(t),Yh=s(Re,`. As a default, 100 sentinel tokens are available in
`),or=r(Re,"A",{href:!0});var J5=i(or);Zh=s(J5,"T5Tokenizer"),J5.forEach(t),Jh=s(Re,"."),Re.forEach(t),Kd=c(n),sr=r(n,"P",{});var X5=i(sr);Xh=s(X5,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),X5.forEach(t),Yd=c(n),k(Uo.$$.fragment,n),Zd=c(n),_n=r(n,"P",{});var Yc=i(_n);Qh=s(Yc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Wo=r(Yc,"A",{href:!0,rel:!0});var Q5=i(Wo);eu=s(Q5,"run_t5_mlm_flax.py"),Q5.forEach(t),tu=s(Yc,` script in the Examples
...
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),nv.forEach(t),Qd=c(n),k(Bo.$$.fragment,n),ec=c(n),oe=r(n,"P",{});var $e=i(oe);su=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Pi=r($e,"CODE",{});var ov=i(Pi);au=s(ov,"input_ids"),ov.forEach(t),ru=s($e,` (which are the
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Si=r(Gr,"CODE",{});var cv=i(Si);vu=s(cv,"max_source_length"),cv.forEach(t),ku=s(Gr," and "),Gi=r(Gr,"CODE",{});var pv=i(Gi);yu=s(pv,"max_target_length"),pv.forEach(t),wu=s(Gr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
...
ignored. The code example below illustrates all of this.`),He.forEach(t),oc=c(n),k(Ho.$$.fragment,n),sc=c(n),ir=r(n,"P",{});var Tv=i(ir);Au=s(Tv,"Additional training tips:"),Tv.forEach(t),ac=c(n),lr=r(n,"UL",{});var bv=i(lr);Vo=r(bv,"LI",{});var Zc=i(Vo);Iu=s(Zc,"T5 models need a slightly higher learning rate than the default one set in the "),Vi=r(Zc,"CODE",{});var vv=i(Vi);Du=s(vv,"Trainer"),vv.forEach(t),Su=s(Zc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Zc.forEach(t),bv.forEach(t),rc=c(n),jt=r(n,"P",{});var Ur=i(jt);Gu=s(Ur,"According to "),Ko=r(Ur,"A",{href:!0,rel:!0});var kv=i(Ko);Uu=s(kv,"this forum post"),kv.forEach(t),Wu=s(Ur,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),Jc.forEach(t),lc=c(n),dr=r(n,"A",{id:!0}),i(dr).forEach(t),dc=c(n),Lt=r(n,"H2",{class:!0});var Xc=i(Lt);Tn=r(Xc,"A",{id:!0,class:!0,href:!0});var $v=i(Tn);Yi=r($v,"SPAN",{});var xv=i(Yi);k(Zo.$$.fragment,xv),xv.forEach(t),$v.forEach(t),Yu=c(Xc),Zi=r(Xc,"SPAN",{});var zv=i(Zi);Zu=s(zv,"Inference"),zv.forEach(t),Xc.forEach(t),cc=c(n),rt=r(n,"P",{});var go=i(rt);Ju=s(go,"At inference time, it is recommended to use "),cr=r(go,"A",{href:!0});var jv=i(cr);Xu=s(jv,"generate()"),jv.forEach(t),Qu=s(go,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
...
`),pr=r(Pt,"A",{href:!0});var Cv=i(pr);dm=s(Cv,"generate()"),Cv.forEach(t),cm=s(Pt,", make sure you start it with the "),Qi=r(Pt,"CODE",{});var Pv=i(Qi);pm=s(Pv,"pad_token_id"),Pv.forEach(t),hm=s(Pt,"."),Pt.forEach(t),uc=c(n),hr=r(n,"P",{});var Nv=i(hr);um=s(Nv,"The example above only shows a single example. You can also do batched inference, like so:"),Nv.forEach(t),mc=c(n),k(es.$$.fragment,n),fc=c(n),ur=r(n,"P",{});var Ov=i(ur);mm=s(Ov,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),Ov.forEach(t),_c=c(n),k(ts.$$.fragment,n),gc=c(n),mr=r(n,"A",{id:!0}),i(mr).forEach(t),Tc=c(n),At=r(n,"H2",{class:!0});var Qc=i(At);bn=r(Qc,"A",{id:!0,class:!0,href:!0});var Lv=i(bn);el=r(Lv,"SPAN",{});var Av=i(el);k(ns.$$.fragment,Av),Av.forEach(t),Lv.forEach(t),fm=c(Qc),tl=r(Qc,"SPAN",{});var Iv=i(tl);_m=s(Iv,"Performance"),Iv.forEach(t),Qc.forEach(t),bc=c(n),it=r(n,"P",{});var To=i(it);gm=s(To,"If you\u2019d like a faster training and inference performance, install "),os=r(To,"A",{href:!0,rel:!0});var Dv=i(os);Tm=s(Dv,"apex"),Dv.forEach(t),bm=s(To," and then the model will automatically use "),nl=r(To,"CODE",{});var Sv=i(nl);vm=s(Sv,"apex.normalization.FusedRMSNorm"),Sv.forEach(t),km=s(To," instead of "),ol=r(To,"CODE",{});var Gv=i(ol);ym=s(Gv,"T5LayerNorm"),Gv.forEach(t),wm=s(To,". The former uses an optimized fused kernel which is several times faster than the latter."),To.forEach(t),vc=c(n),It=r(n,"H2",{class:!0});var ep=i(It);vn=r(ep,"A",{id:!0,class:!0,href:!0});var Uv=i(vn);sl=r(Uv,"SPAN",{});var Wv=i(sl);k(ss.$$.fragment,Wv),Wv.forEach(t),Uv.forEach(t),$m=c(ep),al=r(ep,"SPAN",{});var Bv=i(al);xm=s(Bv,"Example scripts"),Bv.forEach(t),ep.forEach(t),kc=c(n),fr=r(n,"P",{});var Rv=i(fr);zm=s(Rv,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rv.forEach(t),yc=c(n),kn=r(n,"UL",{});var tp=i(kn);rl=r(tp,"LI",{});var Hv=i(rl);Dt=r(Hv,"P",{});var Wr=i(Dt);jm=s(Wr,"pre-training: the "),as=r(Wr,"A",{href:!0,rel:!0});var Vv=i(as);qm=s(Vv,"run_t5_mlm_flax.py"),Vv.forEach(t),Em=s(Wr,`
...
(`),cs=r(bt,"A",{href:!0,rel:!0});var Qv=i(cs);Sm=s(Qv,"PyTorch"),Qv.forEach(t),Gm=s(bt," and "),ps=r(bt,"A",{href:!0,rel:!0});var ek=i(ps);Um=s(ek,"Tensorflow"),ek.forEach(t),Wm=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),Yv.forEach(t),tp.forEach(t),wc=c(n),St=r(n,"H2",{class:!0});var np=i(St);yn=r(np,"A",{id:!0,class:!0,href:!0});var tk=i(yn);ll=r(tk,"SPAN",{});var nk=i(ll);k(hs.$$.fragment,nk),nk.forEach(t),tk.forEach(t),Bm=c(np),dl=r(np,"SPAN",{});var ok=i(dl);Rm=s(ok,"T5Config"),ok.forEach(t),np.forEach(t),$c=c(n),vt=r(n,"DIV",{class:!0});var Br=i(vt);k(us.$$.fragment,Br),Hm=c(Br),kt=r(Br,"P",{});var bo=i(kt);Vm=s(bo,"This is the configuration class to store the configuration of a "),_r=r(bo,"A",{href:!0});var sk=i(_r);Km=s(sk,"T5Model"),sk.forEach(t),Ym=s(bo," or a "),gr=r(bo,"A",{href:!0});var ak=i(gr);Zm=s(ak,"TFT5Model"),ak.forEach(t),Jm=s(bo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ms=r(bo,"A",{href:!0,rel:!0});var rk=i(ms);Xm=s(rk,"t5-small"),rk.forEach(t),Qm=s(bo," architecture."),bo.forEach(t),ef=c(Br),Gt=r(Br,"P",{});var Rr=i(Gt);tf=s(Rr,"Configuration objects inherit from "),Tr=r(Rr,"A",{href:!0});var ik=i(Tr);nf=s(ik,"PretrainedConfig"),ik.forEach(t),of=s(Rr,` and can be used to control the model outputs. Read the
documentation from `),br=r(Rr,"A",{href:!0});var lk=i(br);sf=s(lk,"PretrainedConfig"),lk.forEach(t),af=s(Rr," for more information."),Rr.forEach(t),Br.forEach(t),xc=c(n),Ut=r(n,"H2",{class:!0});var op=i(Ut);wn=r(op,"A",{id:!0,class:!0,href:!0});var dk=i(wn);cl=r(dk,"SPAN",{});var ck=i(cl);k(fs.$$.fragment,ck),ck.forEach(t),dk.forEach(t),rf=c(op),pl=r(op,"SPAN",{});var pk=i(pl);lf=s(pk,"T5Tokenizer"),pk.forEach(t),op.forEach(t),zc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);k(_s.$$.fragment,Ve),df=c(Ve),gs=r(Ve,"P",{});var sp=i(gs);cf=s(sp,"Construct a T5 tokenizer. Based on "),Ts=r(sp,"A",{href:!0,rel:!0});var hk=i(Ts);pf=s(hk,"SentencePiece"),hk.forEach(t),hf=s(sp,"."),sp.forEach(t),uf=c(Ve),bs=r(Ve,"P",{});var ap=i(bs);mf=s(ap,"This tokenizer inherits from "),vr=r(ap,"A",{href:!0});var uk=i(vr);ff=s(uk,"PreTrainedTokenizer"),uk.forEach(t),_f=s(ap,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ap.forEach(t),gf=c(Ve),qt=r(Ve,"DIV",{class:!0});var Hr=i(qt);k(vs.$$.fragment,Hr),Tf=c(Hr),hl=r(Hr,"P",{});var mk=i(hl);bf=s(mk,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),mk.forEach(t),vf=c(Hr),ks=r(Hr,"UL",{});var rp=i(ks);kr=r(rp,"LI",{});var i5=i(kr);kf=s(i5,"single sequence: "),ul=r(i5,"CODE",{});var fk=i(ul);yf=s(fk,"X </s>"),fk.forEach(t),i5.forEach(t),wf=c(rp),yr=r(rp,"LI",{});var l5=i(yr);$f=s(l5,"pair of sequences: "),ml=r(l5,"CODE",{});var _k=i(ml);xf=s(_k,"A </s> B </s>"),_k.forEach(t),l5.forEach(t),rp.forEach(t),Hr.forEach(t),zf=c(Ve),$n=r(Ve,"DIV",{class:!0});var ip=i($n);k(ys.$$.fragment,ip),jf=c(ip),ws=r(ip,"P",{});var lp=i(ws);qf=s(lp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),fl=r(lp,"CODE",{});var gk=i(fl);Ef=s(gk,"prepare_for_model"),gk.forEach(t),Ff=s(lp," method."),lp.forEach(t),ip.forEach(t),Mf=c(Ve),xn=r(Ve,"DIV",{class:!0});var dp=i(xn);k($s.$$.fragment,dp),Cf=c(dp),_l=r(dp,"P",{});var Tk=i(_l);Pf=s(Tk,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Tk.forEach(t),dp.forEach(t),Nf=c(Ve),wr=r(Ve,"DIV",{class:!0});var bk=i(wr);k(xs.$$.fragment,bk),bk.forEach(t),Ve.forEach(t),jc=c(n),Wt=r(n,"H2",{class:!0});var cp=i(Wt);zn=r(cp,"A",{id:!0,class:!0,href:!0});var vk=i(zn);gl=r(vk,"SPAN",{});var kk=i(gl);k(zs.$$.fragment,kk),kk.forEach(t),vk.forEach(t),Of=c(cp),Tl=r(cp,"SPAN",{});var yk=i(Tl);Lf=s(yk,"T5TokenizerFast"),yk.forEach(t),cp.forEach(t),qc=c(n),Se=r(n,"DIV",{class:!0});var Nt=i(Se);k(js.$$.fragment,Nt),Af=c(Nt),Bt=r(Nt,"P",{});var Vr=i(Bt);If=s(Vr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),bl=r(Vr,"EM",{});var wk=i(bl);Df=s(wk,"tokenizers"),wk.forEach(t),Sf=s(Vr,` library). Based on
`),qs=r(Vr,"A",{href:!0,rel:!0});var $k=i(qs);Gf=s($k,"Unigram"),$k.forEach(t),Uf=s(Vr,"."),Vr.forEach(t),Wf=c(Nt),Es=r(Nt,"P",{});var pp=i(Es);Bf=s(pp,"This tokenizer inherits from "),$r=r(pp,"A",{href:!0});var xk=i($r);Rf=s(xk,"PreTrainedTokenizerFast"),xk.forEach(t),Hf=s(pp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),pp.forEach(t),Vf=c(Nt),Et=r(Nt,"DIV",{class:!0});var Kr=i(Et);k(Fs.$$.fragment,Kr),Kf=c(Kr),vl=r(Kr,"P",{});var zk=i(vl);Yf=s(zk,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),zk.forEach(t),Zf=c(Kr),Ms=r(Kr,"UL",{});var hp=i(Ms);xr=r(hp,"LI",{});var d5=i(xr);Jf=s(d5,"single sequence: "),kl=r(d5,"CODE",{});var jk=i(kl);Xf=s(jk,"X </s>"),jk.forEach(t),d5.forEach(t),Qf=c(hp),zr=r(hp,"LI",{});var c5=i(zr);e_=s(c5,"pair of sequences: "),yl=r(c5,"CODE",{});var qk=i(yl);t_=s(qk,"A </s> B </s>"),qk.forEach(t),c5.forEach(t),hp.forEach(t),Kr.forEach(t),n_=c(Nt),jn=r(Nt,"DIV",{class:!0});var up=i(jn);k(Cs.$$.fragment,up),o_=c(up),wl=r(up,"P",{});var Ek=i(wl);s_=s(Ek,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Ek.forEach(t),up.forEach(t),Nt.forEach(t),Ec=c(n),Rt=r(n,"H2",{class:!0});var mp=i(Rt);qn=r(mp,"A",{id:!0,class:!0,href:!0});var Fk=i(qn);$l=r(Fk,"SPAN",{});var Mk=i($l);k(Ps.$$.fragment,Mk),Mk.forEach(t),Fk.forEach(t),a_=c(mp),xl=r(mp,"SPAN",{});var Ck=i(xl);r_=s(Ck,"T5Model"),Ck.forEach(t),mp.forEach(t),Fc=c(n),J=r(n,"DIV",{class:!0});var xe=i(J);k(Ns.$$.fragment,xe),i_=c(xe),zl=r(xe,"P",{});var Pk=i(zl);l_=s(Pk,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Pk.forEach(t),d_=c(xe),Os=r(xe,"P",{});var fp=i(Os);c_=s(fp,"The T5 model was proposed in "),Ls=r(fp,"A",{href:!0,rel:!0});var Nk=i(Ls);p_=s(Nk,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Nk.forEach(t),h_=s(fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),fp.forEach(t),u_=c(xe),As=r(xe,"P",{});var _p=i(As);m_=s(_p,"This model inherits from "),jr=r(_p,"A",{href:!0});var Ok=i(jr);f_=s(Ok,"PreTrainedModel"),Ok.forEach(t),__=s(_p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_p.forEach(t),g_=c(xe),Is=r(xe,"P",{});var gp=i(Is);T_=s(gp,"This model is also a PyTorch "),Ds=r(gp,"A",{href:!0,rel:!0});var Lk=i(Ds);b_=s(Lk,"torch.nn.Module"),Lk.forEach(t),v_=s(gp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gp.forEach(t),k_=c(xe),lt=r(xe,"DIV",{class:!0});var vo=i(lt);k(Ss.$$.fragment,vo),y_=c(vo),Ht=r(vo,"P",{});var Yr=i(Ht);w_=s(Yr,"The "),qr=r(Yr,"A",{href:!0});var Ak=i(qr);$_=s(Ak,"T5Model"),Ak.forEach(t),x_=s(Yr," forward method, overrides the "),jl=r(Yr,"CODE",{});var Ik=i(jl);z_=s(Ik,"__call__"),Ik.forEach(t),j_=s(Yr," special method."),Yr.forEach(t),q_=c(vo),k(En.$$.fragment,vo),E_=c(vo),k(Fn.$$.fragment,vo),vo.forEach(t),F_=c(xe),dt=r(xe,"DIV",{class:!0});var ko=i(dt);k(Gs.$$.fragment,ko),M_=c(ko),ql=r(ko,"P",{});var Dk=i(ql);C_=s(Dk,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Dk.forEach(t),P_=c(ko),El=r(ko,"P",{});var Sk=i(El);N_=s(Sk,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Sk.forEach(t),O_=c(ko),k(Mn.$$.fragment,ko),ko.forEach(t),L_=c(xe),Ft=r(xe,"DIV",{class:!0});var Zr=i(Ft);k(Us.$$.fragment,Zr),A_=c(Zr),Fl=r(Zr,"P",{});var Gk=i(Fl);I_=s(Gk,"Moves the model to cpu from a model parallel state."),Gk.forEach(t),D_=c(Zr),k(Cn.$$.fragment,Zr),Zr.forEach(t),xe.forEach(t),Mc=c(n),Vt=r(n,"H2",{class:!0});var Tp=i(Vt);Pn=r(Tp,"A",{id:!0,class:!0,href:!0});var Uk=i(Pn);Ml=r(Uk,"SPAN",{});var Wk=i(Ml);k(Ws.$$.fragment,Wk),Wk.forEach(t),Uk.forEach(t),S_=c(Tp),Cl=r(Tp,"SPAN",{});var Bk=i(Cl);G_=s(Bk,"T5ForConditionalGeneration"),Bk.forEach(t),Tp.forEach(t),Cc=c(n),X=r(n,"DIV",{class:!0});var ze=i(X);k(Bs.$$.fragment,ze),U_=c(ze),Rs=r(ze,"P",{});var bp=i(Rs);W_=s(bp,"T5 Model with a "),Pl=r(bp,"CODE",{});var Rk=i(Pl);B_=s(Rk,"language modeling"),Rk.forEach(t),R_=s(bp," head on top."),bp.forEach(t),H_=c(ze),Hs=r(ze,"P",{});var vp=i(Hs);V_=s(vp,"The T5 model was proposed in "),Vs=r(vp,"A",{href:!0,rel:!0});var Hk=i(Vs);K_=s(Hk,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Hk.forEach(t),Y_=s(vp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),vp.forEach(t),Z_=c(ze),Ks=r(ze,"P",{});var kp=i(Ks);J_=s(kp,"This model inherits from "),Er=r(kp,"A",{href:!0});var Vk=i(Er);X_=s(Vk,"PreTrainedModel"),Vk.forEach(t),Q_=s(kp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kp.forEach(t),eg=c(ze),Ys=r(ze,"P",{});var yp=i(Ys);tg=s(yp,"This model is also a PyTorch "),Zs=r(yp,"A",{href:!0,rel:!0});var Kk=i(Zs);ng=s(Kk,"torch.nn.Module"),Kk.forEach(t),og=s(yp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yp.forEach(t),sg=c(ze),ct=r(ze,"DIV",{class:!0});var yo=i(ct);k(Js.$$.fragment,yo),ag=c(yo),Kt=r(yo,"P",{});var Jr=i(Kt);rg=s(Jr,"The "),Fr=r(Jr,"A",{href:!0});var Yk=i(Fr);ig=s(Yk,"T5ForConditionalGeneration"),Yk.forEach(t),lg=s(Jr," forward method, overrides the "),Nl=r(Jr,"CODE",{});var Zk=i(Nl);dg=s(Zk,"__call__"),Zk.forEach(t),cg=s(Jr," special method."),Jr.forEach(t),pg=c(yo),k(Nn.$$.fragment,yo),hg=c(yo),k(On.$$.fragment,yo),yo.forEach(t),ug=c(ze),pt=r(ze,"DIV",{class:!0});var wo=i(pt);k(Xs.$$.fragment,wo),mg=c(wo),Ol=r(wo,"P",{});var Jk=i(Ol);fg=s(Jk,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Jk.forEach(t),_g=c(wo),Ll=r(wo,"P",{});var Xk=i(Ll);gg=s(Xk,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Xk.forEach(t),Tg=c(wo),k(Ln.$$.fragment,wo),wo.forEach(t),bg=c(ze),Mt=r(ze,"DIV",{class:!0});var Xr=i(Mt);k(Qs.$$.fragment,Xr),vg=c(Xr),Al=r(Xr,"P",{});var Qk=i(Al);kg=s(Qk,"Moves the model to cpu from a model parallel state."),Qk.forEach(t),yg=c(Xr),k(An.$$.fragment,Xr),Xr.forEach(t),ze.forEach(t),Pc=c(n),Yt=r(n,"H2",{class:!0});var wp=i(Yt);In=r(wp,"A",{id:!0,class:!0,href:!0});var e1=i(In);Il=r(e1,"SPAN",{});var t1=i(Il);k(ea.$$.fragment,t1),t1.forEach(t),e1.forEach(t),wg=c(wp),Dl=r(wp,"SPAN",{});var n1=i(Dl);$g=s(n1,"T5EncoderModel"),n1.forEach(t),wp.forEach(t),Nc=c(n),Q=r(n,"DIV",{class:!0});var je=i(Q);k(ta.$$.fragment,je),xg=c(je),Sl=r(je,"P",{});var o1=i(Sl);zg=s(o1,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),o1.forEach(t),jg=c(je),na=r(je,"P",{});var $p=i(na);qg=s($p,"The T5 model was proposed in "),oa=r($p,"A",{href:!0,rel:!0});var s1=i(oa);Eg=s(s1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ep.forEach(t),_T=c(Ke),fa=r(Ke,"P",{});var Fp=i(fa);gT=s(Fp,"This model is also a "),_a=r(Fp,"A",{href:!0,rel:!0});var T1=i(_a);TT=s(T1,"tf.keras.Model"),T1.forEach(t),bT=s(Fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),vT=c(Ke),k(Bn.$$.fragment,Ke),kT=c(Ke),mt=r(Ke,"DIV",{class:!0});var zo=i(mt);k(ga.$$.fragment,zo),yT=c(zo),Xt=r(zo,"P",{});var ti=i(Xt);wT=s(ti,"The "),Nr=r(ti,"A",{href:!0});var b1=i(Nr);$T=s(b1,"TFT5Model"),b1.forEach(t),xT=s(ti," forward method, overrides the "),Kl=r(ti,"CODE",{});var v1=i(Kl);zT=s(v1,"__call__"),v1.forEach(t),jT=s(ti," special method."),ti.forEach(t),qT=c(zo),k(Rn.$$.fragment,zo),ET=c(zo),k(Hn.$$.fragment,zo),zo.forEach(t),Ke.forEach(t),Ac=c(n),Qt=r(n,"H2",{class:!0});var Mp=i(Qt);Vn=r(Mp,"A",{id:!0,class:!0,href:!0});var k1=i(Vn);Yl=r(k1,"SPAN",{});var y1=i(Yl);k(Ta.$$.fragment,y1),y1.forEach(t),k1.forEach(t),FT=c(Mp),Zl=r(Mp,"SPAN",{});var w1=i(Zl);MT=s(w1,"TFT5ForConditionalGeneration"),w1.forEach(t),Mp.forEach(t),Ic=c(n),de=r(n,"DIV",{class:!0});var Ye=i(de);k(ba.$$.fragment,Ye),CT=c(Ye),va=r(Ye,"P",{});var Cp=i(va);PT=s(Cp,"T5 Model with a "),Jl=r(Cp,"CODE",{});var $1=i(Jl);NT=s($1,"language modeling"),$1.forEach(t),OT=s(Cp," head on top."),Cp.forEach(t),LT=c(Ye),ka=r(Ye,"P",{});var Pp=i(ka);AT=s(Pp,"The T5 model was proposed in "),ya=r(Pp,"A",{href:!0,rel:!0});var x1=i(ya);IT=s(x1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
