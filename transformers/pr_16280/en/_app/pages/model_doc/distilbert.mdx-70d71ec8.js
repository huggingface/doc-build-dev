...
first positional argument :`),ye.forEach(t),V=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var H=r(z);ue=i(H,"a single Tensor with "),W=n(H,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),fe=i(H," only and nothing else: "),R=n(H,"CODE",{});var De=r(R);ie=i(De,"model(inputs_ids)"),De.forEach(t),H.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Z,"CODE",{});var Fe=r(I);oe=i(Fe,"model([input_ids, attention_mask])"),Fe.forEach(t),Z.forEach(t),me=d(C),P=n(C,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,D),e(D,_),e(v,f),e(v,B),e(B,ce),u(h,K,M),u(h,E,M),e(E,G),e(E,L),e(L,X),e(E,pe),e(E,S),e(S,he),e(E,ae),u(h,N,M),u(h,q,M),e(q,Y),u(h,V,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,fe),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,I),e(I,oe),e(x,me),e(x,P),e(P,te),e(P,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(K),h&&t(E),h&&t(N),h&&t(q),h&&t(V),h&&t(x)}}}function OD(j){let p,F,g,v,D;return{c(){p=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),v=a("Module"),D=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var f=r(p);F=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(f,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),D=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(_,f){u(_,p,f),e(p,F),e(p,g),e(g,v),e(p,D)},d(_){_&&t(p)}}}function ND(j){let p,F,g,v,D,_,f,B,ce,K,E,G,L,X,pe,S,he,ae,N,q,Y,V,x,z,ue,W,se,fe,R,ie,ee,A,le,I,oe,me,P,te,U,de;return{c(){p=o("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),D=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),B=o("li"),ce=a("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=o("p"),G=a("This second option is useful when using "),L=o("code"),X=a("tf.keras.Model.fit"),pe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=o("code"),he=a("model(inputs)"),ae=a("."),N=l(),q=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),V=l(),x=o("ul"),z=o("li"),ue=a("a single Tensor with "),W=o("code"),se=a("input_ids"),fe=a(" only and nothing else: "),R=o("code"),ie=a("model(inputs_ids)"),ee=l(),A=o("li"),le=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),oe=a("model([input_ids, attention_mask])"),me=l(),P=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=o("code"),de=a('model({"input_ids": input_ids})')},l(h){p=n(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=n(h,"UL",{});var J=r(v);D=n(J,"LI",{});var _e=r(D);_=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=d(J),B=n(J,"LI",{});var Te=r(B);ce=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),J.forEach(t),K=d(h),E=n(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),L=n(O,"CODE",{});var ve=r(L);X=i(ve,"tf.keras.Model.fit"),ve.forEach(t),pe=i(O,` method which currently requires having all the
...
first positional argument :`),ye.forEach(t),V=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var H=r(z);ue=i(H,"a single Tensor with "),W=n(H,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),fe=i(H," only and nothing else: "),R=n(H,"CODE",{});var De=r(R);ie=i(De,"model(inputs_ids)"),De.forEach(t),H.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Z,"CODE",{});var Fe=r(I);oe=i(Fe,"model([input_ids, attention_mask])"),Fe.forEach(t),Z.forEach(t),me=d(C),P=n(C,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,D),e(D,_),e(v,f),e(v,B),e(B,ce),u(h,K,M),u(h,E,M),e(E,G),e(E,L),e(L,X),e(E,pe),e(E,S),e(S,he),e(E,ae),u(h,N,M),u(h,q,M),e(q,Y),u(h,V,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,fe),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,I),e(I,oe),e(x,me),e(x,P),e(P,te),e(P,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(K),h&&t(E),h&&t(N),h&&t(q),h&&t(V),h&&t(x)}}}function ID(j){let p,F,g,v,D;return{c(){p=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),v=a("Module"),D=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var f=r(p);F=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(f,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),D=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(_,f){u(_,p,f),e(p,F),e(p,g),e(g,v),e(p,D)},d(_){_&&t(p)}}}function LD(j){let p,F,g,v,D,_,f,B,ce,K,E,G,L,X,pe,S,he,ae,N,q,Y,V,x,z,ue,W,se,fe,R,ie,ee,A,le,I,oe,me,P,te,U,de;return{c(){p=o("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),D=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),B=o("li"),ce=a("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=o("p"),G=a("This second option is useful when using "),L=o("code"),X=a("tf.keras.Model.fit"),pe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=o("code"),he=a("model(inputs)"),ae=a("."),N=l(),q=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),V=l(),x=o("ul"),z=o("li"),ue=a("a single Tensor with "),W=o("code"),se=a("input_ids"),fe=a(" only and nothing else: "),R=o("code"),ie=a("model(inputs_ids)"),ee=l(),A=o("li"),le=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),oe=a("model([input_ids, attention_mask])"),me=l(),P=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=o("code"),de=a('model({"input_ids": input_ids})')},l(h){p=n(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=n(h,"UL",{});var J=r(v);D=n(J,"LI",{});var _e=r(D);_=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=d(J),B=n(J,"LI",{});var Te=r(B);ce=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),J.forEach(t),K=d(h),E=n(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),L=n(O,"CODE",{});var ve=r(L);X=i(ve,"tf.keras.Model.fit"),ve.forEach(t),pe=i(O,` method which currently requires having all the
...
first positional argument :`),ye.forEach(t),V=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var H=r(z);ue=i(H,"a single Tensor with "),W=n(H,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),fe=i(H," only and nothing else: "),R=n(H,"CODE",{});var De=r(R);ie=i(De,"model(inputs_ids)"),De.forEach(t),H.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Z,"CODE",{});var Fe=r(I);oe=i(Fe,"model([input_ids, attention_mask])"),Fe.forEach(t),Z.forEach(t),me=d(C),P=n(C,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,D),e(D,_),e(v,f),e(v,B),e(B,ce),u(h,K,M),u(h,E,M),e(E,G),e(E,L),e(L,X),e(E,pe),e(E,S),e(S,he),e(E,ae),u(h,N,M),u(h,q,M),e(q,Y),u(h,V,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,fe),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,I),e(I,oe),e(x,me),e(x,P),e(P,te),e(P,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(K),h&&t(E),h&&t(N),h&&t(q),h&&t(V),h&&t(x)}}}function SD(j){let p,F,g,v,D;return{c(){p=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),v=a("Module"),D=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var f=r(p);F=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(f,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),D=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(_,f){u(_,p,f),e(p,F),e(p,g),e(g,v),e(p,D)},d(_){_&&t(p)}}}function WD(j){let p,F,g,v,D,_,f,B,ce,K,E,G,L,X,pe,S,he,ae,N,q,Y,V,x,z,ue,W,se,fe,R,ie,ee,A,le,I,oe,me,P,te,U,de;return{c(){p=o("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),D=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),B=o("li"),ce=a("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=o("p"),G=a("This second option is useful when using "),L=o("code"),X=a("tf.keras.Model.fit"),pe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=o("code"),he=a("model(inputs)"),ae=a("."),N=l(),q=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),V=l(),x=o("ul"),z=o("li"),ue=a("a single Tensor with "),W=o("code"),se=a("input_ids"),fe=a(" only and nothing else: "),R=o("code"),ie=a("model(inputs_ids)"),ee=l(),A=o("li"),le=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),oe=a("model([input_ids, attention_mask])"),me=l(),P=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=o("code"),de=a('model({"input_ids": input_ids})')},l(h){p=n(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=n(h,"UL",{});var J=r(v);D=n(J,"LI",{});var _e=r(D);_=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=d(J),B=n(J,"LI",{});var Te=r(B);ce=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),J.forEach(t),K=d(h),E=n(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),L=n(O,"CODE",{});var ve=r(L);X=i(ve,"tf.keras.Model.fit"),ve.forEach(t),pe=i(O,` method which currently requires having all the
...
first positional argument :`),ye.forEach(t),V=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var H=r(z);ue=i(H,"a single Tensor with "),W=n(H,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),fe=i(H," only and nothing else: "),R=n(H,"CODE",{});var De=r(R);ie=i(De,"model(inputs_ids)"),De.forEach(t),H.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Z,"CODE",{});var Fe=r(I);oe=i(Fe,"model([input_ids, attention_mask])"),Fe.forEach(t),Z.forEach(t),me=d(C),P=n(C,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,D),e(D,_),e(v,f),e(v,B),e(B,ce),u(h,K,M),u(h,E,M),e(E,G),e(E,L),e(L,X),e(E,pe),e(E,S),e(S,he),e(E,ae),u(h,N,M),u(h,q,M),e(q,Y),u(h,V,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,fe),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,I),e(I,oe),e(x,me),e(x,P),e(P,te),e(P,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(K),h&&t(E),h&&t(N),h&&t(q),h&&t(V),h&&t(x)}}}function RD(j){let p,F,g,v,D;return{c(){p=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),v=a("Module"),D=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var f=r(p);F=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(f,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),D=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(_,f){u(_,p,f),e(p,F),e(p,g),e(g,v),e(p,D)},d(_){_&&t(p)}}}function UD(j){let p,F,g,v,D,_,f,B,ce,K,E,G,L,X,pe,S,he,ae,N,q,Y,V,x,z,ue,W,se,fe,R,ie,ee,A,le,I,oe,me,P,te,U,de;return{c(){p=o("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),D=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),B=o("li"),ce=a("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=o("p"),G=a("This second option is useful when using "),L=o("code"),X=a("tf.keras.Model.fit"),pe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=o("code"),he=a("model(inputs)"),ae=a("."),N=l(),q=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),V=l(),x=o("ul"),z=o("li"),ue=a("a single Tensor with "),W=o("code"),se=a("input_ids"),fe=a(" only and nothing else: "),R=o("code"),ie=a("model(inputs_ids)"),ee=l(),A=o("li"),le=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),oe=a("model([input_ids, attention_mask])"),me=l(),P=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=o("code"),de=a('model({"input_ids": input_ids})')},l(h){p=n(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=n(h,"UL",{});var J=r(v);D=n(J,"LI",{});var _e=r(D);_=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=d(J),B=n(J,"LI",{});var Te=r(B);ce=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),J.forEach(t),K=d(h),E=n(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),L=n(O,"CODE",{});var ve=r(L);X=i(ve,"tf.keras.Model.fit"),ve.forEach(t),pe=i(O,` method which currently requires having all the
...
first positional argument :`),ye.forEach(t),V=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var H=r(z);ue=i(H,"a single Tensor with "),W=n(H,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),fe=i(H," only and nothing else: "),R=n(H,"CODE",{});var De=r(R);ie=i(De,"model(inputs_ids)"),De.forEach(t),H.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Z,"CODE",{});var Fe=r(I);oe=i(Fe,"model([input_ids, attention_mask])"),Fe.forEach(t),Z.forEach(t),me=d(C),P=n(C,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,D),e(D,_),e(v,f),e(v,B),e(B,ce),u(h,K,M),u(h,E,M),e(E,G),e(E,L),e(L,X),e(E,pe),e(E,S),e(S,he),e(E,ae),u(h,N,M),u(h,q,M),e(q,Y),u(h,V,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,fe),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,I),e(I,oe),e(x,me),e(x,P),e(P,te),e(P,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(K),h&&t(E),h&&t(N),h&&t(q),h&&t(V),h&&t(x)}}}function HD(j){let p,F,g,v,D;return{c(){p=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),v=a("Module"),D=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var f=r(p);F=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(f,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),D=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(_,f){u(_,p,f),e(p,F),e(p,g),e(g,v),e(p,D)},d(_){_&&t(p)}}}function QD(j){let p,F,g,v,D;return{c(){p=o("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),v=a("Module"),D=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var f=r(p);F=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(f,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),D=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<a href="/docs/transformers/pr_16280/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new re({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
`}}),ro=new ge({props:{$$slots:{default:[xD]},$$scope:{ctx:j}}}),qn=new re({props:{code:`import torch
...
`}}),io=new ge({props:{$$slots:{default:[zD]},$$scope:{ctx:j}}}),Hn=new re({props:{code:`from transformers import DistilBertTokenizer, DistilBertForMultipleChoice
import torch
...
`}}),mo=new ge({props:{$$slots:{default:[qD]},$$scope:{ctx:j}}}),fr=new re({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertModel
...
`}}),To=new ge({props:{$$slots:{default:[ID]},$$scope:{ctx:j}}}),xr=new re({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForSequenceClassification
import tensorflow as tf
...
`}}),$o=new ge({props:{$$slots:{default:[SD]},$$scope:{ctx:j}}}),Nr=new re({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForMultipleChoice
import tensorflow as tf
...
`}}),Bo=new ge({props:{$$slots:{default:[RD]},$$scope:{ctx:j}}}),Hr=new re({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForTokenClassification
import tensorflow as tf
...
`}}),xo=new ge({props:{$$slots:{default:[HD]},$$scope:{ctx:j}}}),Zr=new re({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForQuestionAnswering
import tensorflow as tf
...
Whether or not to return a <a href="/docs/transformers/pr_16280/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}]}}),jo=new ge({props:{$$slots:{default:[QD]},$$scope:{ctx:j}}}),pa=new re({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertModel
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16280/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wa=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16280/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16280/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16280/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16280/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
`}}),Po=new ge({props:{$$slots:{default:[KD]},$$scope:{ctx:j}}}),ya=new re({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForMaskedLM
...
`}}),Ao=new ge({props:{$$slots:{default:[VD]},$$scope:{ctx:j}}}),Pa=new re({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForSequenceClassification
...
`}}),No=new ge({props:{$$slots:{default:[JD]},$$scope:{ctx:j}}}),Ha=new re({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForMultipleChoice
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16280/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ti=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16280/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16280/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16280/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16280/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
`}}),Lo=new ge({props:{$$slots:{default:[GD]},$$scope:{ctx:j}}}),si=new re({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForTokenClassification
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16280/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hi=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16280/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16280/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16280/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16280/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Yk=d(ht),nc=n(ht,"P",{});var Q$=r(nc);Zk=i(Q$,"Finally, this model supports inherent JAX features such as:"),Q$.forEach(t),eT=d(ht),qt=n(ht,"UL",{});var Ko=r(qt);rc=n(Ko,"LI",{});var K$=r(rc);va=n(K$,"A",{href:!0,rel:!0});var V$=r(va);tT=i(V$,"Just-In-Time (JIT) compilation"),V$.forEach(t),K$.forEach(t),sT=d(Ko),ac=n(Ko,"LI",{});var J$=r(ac);ba=n(J$,"A",{href:!0,rel:!0});var G$=r(ba);oT=i(G$,"Automatic Differentiation"),G$.forEach(t),J$.forEach(t),nT=d(Ko),ic=n(Ko,"LI",{});var X$=r(ic);ka=n(X$,"A",{href:!0,rel:!0});var Y$=r(ka);rT=i(Y$,"Vectorization"),Y$.forEach(t),X$.forEach(t),aT=d(Ko),lc=n(Ko,"LI",{});var Z$=r(lc);Ta=n(Z$,"A",{href:!0,rel:!0});var e0=r(Ta);iT=i(e0,"Parallelization"),e0.forEach(t),Z$.forEach(t),Ko.forEach(t),lT=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);k(wa.$$.fragment,ts),dT=d(ts),Is=n(ts,"P",{});var kl=r(Is);cT=i(kl,"The "),dc=n(kl,"CODE",{});var t0=r(dc);pT=i(t0,"FlaxDistilBertPreTrainedModel"),t0.forEach(t),hT=i(kl,"forward method, overrides the "),cc=n(kl,"CODE",{});var s0=r(cc);uT=i(s0,"__call__"),s0.forEach(t),fT=i(kl," special method."),kl.forEach(t),mT=d(ts),k(Po.$$.fragment,ts),gT=d(ts),pc=n(ts,"P",{});var o0=r(pc);_T=i(o0,"Example:"),o0.forEach(t),vT=d(ts),k(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ls=n(s,"H2",{class:!0});var du=r(Ls);qo=n(du,"A",{id:!0,class:!0,href:!0});var n0=r(qo);hc=n(n0,"SPAN",{});var r0=r(hc);k($a.$$.fragment,r0),r0.forEach(t),n0.forEach(t),bT=d(du),uc=n(du,"SPAN",{});var a0=r(uc);kT=i(a0,"FlaxDistilBertForSequenceClassification"),a0.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);k(Da.$$.fragment,ut),TT=d(ut),fc=n(ut,"P",{});var i0=r(fc);wT=i(i0,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),i0.forEach(t),yT=d(ut),Fa=n(ut,"P",{});var cu=r(Fa);$T=i(cu,"This model inherits from "),el=n(cu,"A",{href:!0});var l0=r(el);DT=i(l0,"FlaxPreTrainedModel"),l0.forEach(t),FT=i(cu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),zT=d(ut),mc=n(ut,"P",{});var c0=r(mc);jT=i(c0,"Finally, this model supports inherent JAX features such as:"),c0.forEach(t),CT=d(ut),At=n(ut,"UL",{});var Vo=r(At);gc=n(Vo,"LI",{});var p0=r(gc);Ea=n(p0,"A",{href:!0,rel:!0});var h0=r(Ea);PT=i(h0,"Just-In-Time (JIT) compilation"),h0.forEach(t),p0.forEach(t),qT=d(Vo),_c=n(Vo,"LI",{});var u0=r(_c);xa=n(u0,"A",{href:!0,rel:!0});var f0=r(xa);AT=i(f0,"Automatic Differentiation"),f0.forEach(t),u0.forEach(t),OT=d(Vo),vc=n(Vo,"LI",{});var m0=r(vc);za=n(m0,"A",{href:!0,rel:!0});var g0=r(za);NT=i(g0,"Vectorization"),g0.forEach(t),m0.forEach(t),IT=d(Vo),bc=n(Vo,"LI",{});var _0=r(bc);ja=n(_0,"A",{href:!0,rel:!0});var v0=r(ja);LT=i(v0,"Parallelization"),v0.forEach(t),_0.forEach(t),Vo.forEach(t),ST=d(ut),it=n(ut,"DIV",{class:!0});var ss=r(it);k(Ca.$$.fragment,ss),WT=d(ss),Ss=n(ss,"P",{});var Tl=r(Ss);RT=i(Tl,"The "),kc=n(Tl,"CODE",{});var b0=r(kc);UT=i(b0,"FlaxDistilBertPreTrainedModel"),b0.forEach(t),HT=i(Tl,"forward method, overrides the "),Tc=n(Tl,"CODE",{});var k0=r(Tc);QT=i(k0,"__call__"),k0.forEach(t),KT=i(Tl," special method."),Tl.forEach(t),VT=d(ss),k(Ao.$$.fragment,ss),JT=d(ss),wc=n(ss,"P",{});var T0=r(wc);GT=i(T0,"Example:"),T0.forEach(t),XT=d(ss),k(Pa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),rh=d(s),Ws=n(s,"H2",{class:!0});var hu=r(Ws);Oo=n(hu,"A",{id:!0,class:!0,href:!0});var w0=r(Oo);yc=n(w0,"SPAN",{});var y0=r(yc);k(qa.$$.fragment,y0),y0.forEach(t),w0.forEach(t),YT=d(hu),$c=n(hu,"SPAN",{});var $0=r($c);ZT=i($0,"FlaxDistilBertForMultipleChoice"),$0.forEach(t),hu.forEach(t),ah=d(s),ze=n(s,"DIV",{class:!0});var ft=r(ze);k(Aa.$$.fragment,ft),ew=d(ft),Dc=n(ft,"P",{});var D0=r(Dc);tw=i(D0,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),D0.forEach(t),sw=d(ft),Oa=n(ft,"P",{});var uu=r(Oa);ow=i(uu,"This model inherits from "),tl=n(uu,"A",{href:!0});var F0=r(tl);nw=i(F0,"FlaxPreTrainedModel"),F0.forEach(t),rw=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),uu.forEach(t),aw=d(ft),Na=n(ft,"P",{});var fu=r(Na);iw=i(fu,"This model is also a Flax Linen "),Ia=n(fu,"A",{href:!0,rel:!0});var B0=r(Ia);lw=i(B0,"flax.linen.Module"),B0.forEach(t),dw=i(fu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),fu.forEach(t),cw=d(ft),Fc=n(ft,"P",{});var M0=r(Fc);pw=i(M0,"Finally, this model supports inherent JAX features such as:"),M0.forEach(t),hw=d(ft),Ot=n(ft,"UL",{});var Jo=r(Ot);Bc=n(Jo,"LI",{});var E0=r(Bc);La=n(E0,"A",{href:!0,rel:!0});var x0=r(La);uw=i(x0,"Just-In-Time (JIT) compilation"),x0.forEach(t),E0.forEach(t),fw=d(Jo),Mc=n(Jo,"LI",{});var z0=r(Mc);Sa=n(z0,"A",{href:!0,rel:!0});var j0=r(Sa);mw=i(j0,"Automatic Differentiation"),j0.forEach(t),z0.forEach(t),gw=d(Jo),Ec=n(Jo,"LI",{});var C0=r(Ec);Wa=n(C0,"A",{href:!0,rel:!0});var P0=r(Wa);_w=i(P0,"Vectorization"),P0.forEach(t),C0.forEach(t),vw=d(Jo),xc=n(Jo,"LI",{});var q0=r(xc);Ra=n(q0,"A",{href:!0,rel:!0});var A0=r(Ra);bw=i(A0,"Parallelization"),A0.forEach(t),q0.forEach(t),Jo.forEach(t),kw=d(ft),lt=n(ft,"DIV",{class:!0});var os=r(lt);k(Ua.$$.fragment,os),Tw=d(os),Rs=n(os,"P",{});var wl=r(Rs);ww=i(wl,"The "),zc=n(wl,"CODE",{});var O0=r(zc);yw=i(O0,"FlaxDistilBertPreTrainedModel"),O0.forEach(t),$w=i(wl,"forward method, overrides the "),jc=n(wl,"CODE",{});var N0=r(jc);Dw=i(N0,"__call__"),N0.forEach(t),Fw=i(wl," special method."),wl.forEach(t),Bw=d(os),k(No.$$.fragment,os),Mw=d(os),Cc=n(os,"P",{});var I0=r(Cc);Ew=i(I0,"Example:"),I0.forEach(t),xw=d(os),k(Ha.$$.fragment,os),os.forEach(t),ft.forEach(t),ih=d(s),Us=n(s,"H2",{class:!0});var mu=r(Us);Io=n(mu,"A",{id:!0,class:!0,href:!0});var L0=r(Io);Pc=n(L0,"SPAN",{});var S0=r(Pc);k(Qa.$$.fragment,S0),S0.forEach(t),L0.forEach(t),zw=d(mu),qc=n(mu,"SPAN",{});var W0=r(qc);jw=i(W0,"FlaxDistilBertForTokenClassification"),W0.forEach(t),mu.forEach(t),lh=d(s),je=n(s,"DIV",{class:!0});var mt=r(je);k(Ka.$$.fragment,mt),Cw=d(mt),Ac=n(mt,"P",{});var R0=r(Ac);Pw=i(R0,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R0.forEach(t),qw=d(mt),Va=n(mt,"P",{});var gu=r(Va);Aw=i(gu,"This model inherits from "),sl=n(gu,"A",{href:!0});var U0=r(sl);Ow=i(U0,"FlaxPreTrainedModel"),U0.forEach(t),Nw=i(gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),gu.forEach(t),Iw=d(mt),Ja=n(mt,"P",{});var _u=r(Ja);Lw=i(_u,"This model is also a Flax Linen "),Ga=n(_u,"A",{href:!0,rel:!0});var H0=r(Ga);Sw=i(H0,"flax.linen.Module"),H0.forEach(t),Ww=i(_u,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_u.forEach(t),Rw=d(mt),Oc=n(mt,"P",{});var Q0=r(Oc);Uw=i(Q0,"Finally, this model supports inherent JAX features such as:"),Q0.forEach(t),Hw=d(mt),Nt=n(mt,"UL",{});var Go=r(Nt);Nc=n(Go,"LI",{});var K0=r(Nc);Xa=n(K0,"A",{href:!0,rel:!0});var V0=r(Xa);Qw=i(V0,"Just-In-Time (JIT) compilation"),V0.forEach(t),K0.forEach(t),Kw=d(Go),Ic=n(Go,"LI",{});var J0=r(Ic);Ya=n(J0,"A",{href:!0,rel:!0});var G0=r(Ya);Vw=i(G0,"Automatic Differentiation"),G0.forEach(t),J0.forEach(t),Jw=d(Go),Lc=n(Go,"LI",{});var X0=r(Lc);Za=n(X0,"A",{href:!0,rel:!0});var Y0=r(Za);Gw=i(Y0,"Vectorization"),Y0.forEach(t),X0.forEach(t),Xw=d(Go),Sc=n(Go,"LI",{});var Z0=r(Sc);ei=n(Z0,"A",{href:!0,rel:!0});var eD=r(ei);Yw=i(eD,"Parallelization"),eD.forEach(t),Z0.forEach(t),Go.forEach(t),Zw=d(mt),dt=n(mt,"DIV",{class:!0});var ns=r(dt);k(ti.$$.fragment,ns),e1=d(ns),Hs=n(ns,"P",{});var yl=r(Hs);t1=i(yl,"The "),Wc=n(yl,"CODE",{});var tD=r(Wc);s1=i(tD,"FlaxDistilBertPreTrainedModel"),tD.forEach(t),o1=i(yl,"forward method, overrides the "),Rc=n(yl,"CODE",{});var sD=r(Rc);n1=i(sD,"__call__"),sD.forEach(t),r1=i(yl," special method."),yl.forEach(t),a1=d(ns),k(Lo.$$.fragment,ns),i1=d(ns),Uc=n(ns,"P",{});var oD=r(Uc);l1=i(oD,"Example:"),oD.forEach(t),d1=d(ns),k(si.$$.fragment,ns),ns.forEach(t),mt.forEach(t),dh=d(s),Qs=n(s,"H2",{class:!0});var vu=r(Qs);So=n(vu,"A",{id:!0,class:!0,href:!0});var nD=r(So);Hc=n(nD,"SPAN",{});var rD=r(Hc);k(oi.$$.fragment,rD),rD.forEach(t),nD.forEach(t),c1=d(vu),Qc=n(vu,"SPAN",{});var aD=r(Qc);p1=i(aD,"FlaxDistilBertForQuestionAnswering"),aD.forEach(t),vu.forEach(t),ch=d(s),Ce=n(s,"DIV",{class:!0});var gt=r(Ce);k(ni.$$.fragment,gt),h1=d(gt),Ks=n(gt,"P",{});var $l=r(Ks);u1=i($l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Kc=n($l,"CODE",{});var iD=r(Kc);f1=i(iD,"span start logits"),iD.forEach(t),m1=i($l," and "),Vc=n($l,"CODE",{});var lD=r(Vc);g1=i(lD,"span end logits"),lD.forEach(t),_1=i($l,")."),$l.forEach(t),v1=d(gt),ri=n(gt,"P",{});var bu=r(ri);b1=i(bu,"This model inherits from "),ol=n(bu,"A",{href:!0});var dD=r(ol);k1=i(dD,"FlaxPreTrainedModel"),dD.forEach(t),T1=i(bu,`. Check the superclass documentation for the generic methods the
