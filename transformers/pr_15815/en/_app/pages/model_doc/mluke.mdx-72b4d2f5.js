import{S as tn,i as nn,s as on,e as o,k as p,w as E,t as r,L as sn,c as s,d as n,m as u,a as i,x as $,h as a,b as l,J as t,g as d,y as A,K as rn,q as P,o as N,B as I}from"../../chunks/vendor-9e2b328e.js";import{D as xt}from"../../chunks/Docstring-50fd6873.js";import{C as en}from"../../chunks/CodeBlock-88e23343.js";import{I as zt}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function an(Se){let g,V,h,f,le,U,Ke,ce,De,_e,b,T,de,W,Re,pe,Fe,ge,k,Oe,S,Be,je,K,Xe,Ce,ke,J,Ye,ye,G,He,ve,Q,ue,Ve,be,Z,Je,we,D,Te,L,Ge,ee,Qe,Ze,Le,R,qe,q,et,te,tt,nt,xe,y,ot,F,st,it,O,rt,at,ze,w,x,me,B,lt,he,ct,Me,m,j,dt,_,pt,ne,ut,mt,oe,ht,ft,X,_t,gt,kt,C,yt,se,vt,bt,wt,z,Y,Tt,fe,Lt,qt,ie,H,Ee;return U=new zt({}),W=new zt({}),D=new en({props:{code:`from transformers import LukeModel
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.MLukeTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_15815/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_15815/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_15815/en/main_classes/tokenizer#transformers.BatchEncoding"
...
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15815/src/transformers/models/mluke/tokenization_mluke.py#L1493"}}),{c(){g=o("meta"),V=p(),h=o("h1"),f=o("a"),le=o("span"),E(U.$$.fragment),Ke=p(),ce=o("span"),De=r("mLUKE"),_e=p(),b=o("h2"),T=o("a"),de=o("span"),E(W.$$.fragment),Re=p(),pe=o("span"),Fe=r("Overview"),ge=p(),k=o("p"),Oe=r("The mLUKE model was proposed in "),S=o("a"),Be=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),je=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
