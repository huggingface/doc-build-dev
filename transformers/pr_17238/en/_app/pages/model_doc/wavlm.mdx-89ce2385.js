import{S as wl,i as yl,s as Ml,e as n,k as u,w,t as r,M as $l,c as s,d as o,m as f,a as l,x as y,h as i,b as c,F as e,g as _,y as M,q as $,o as W,B as k,v as Wl,L as fe}from"../../chunks/vendor-6b77c823.js";import{T as sa}from"../../chunks/Tip-39098574.js";import{D as I}from"../../chunks/Docstring-1088f2fb.js";import{C as ge}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as he}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as ue}from"../../chunks/ExampleCodeBlock-5212b321.js";function kl(L){let d,v,p,m,b;return m=new ge({props:{code:"",highlighted:""}}),{c(){d=n("p"),v=r("Example:"),p=u(),w(m.$$.fragment)},l(a){d=s(a,"P",{});var h=l(d);v=i(h,"Example:"),h.forEach(o),p=f(a),y(m.$$.fragment,a)},m(a,h){_(a,d,h),e(d,v),_(a,p,h),M(m,a,h),b=!0},p:fe,i(a){b||($(m.$$.fragment,a),b=!0)},o(a){W(m.$$.fragment,a),b=!1},d(a){a&&o(d),a&&o(p),k(m,a)}}}function Ll(L){let d,v,p,m,b;return m=new ge({props:{code:`from transformers import WavLMModel, WavLMConfig
...
<span class="hljs-string">&#x27;mister quilter is the aposle of the middle classes and we are glad to welcome his gospel&#x27;</span>`}}),{c(){d=n("p"),v=r("Example:"),p=u(),w(m.$$.fragment)},l(a){d=s(a,"P",{});var h=l(d);v=i(h,"Example:"),h.forEach(o),p=f(a),y(m.$$.fragment,a)},m(a,h){_(a,d,h),e(d,v),_(a,p,h),M(m,a,h),b=!0},p:fe,i(a){b||($(m.$$.fragment,a),b=!0)},o(a){W(m.$$.fragment,a),b=!1},d(a){a&&o(d),a&&o(p),k(m,a)}}}function xl(L){let d,v;return d=new ge({props:{code:`with processor.as_target_processor():
...
<span class="hljs-number">12.51</span>`}}),{c(){w(d.$$.fragment)},l(p){y(d.$$.fragment,p)},m(p,m){M(d,p,m),v=!0},p:fe,i(p){v||($(d.$$.fragment,p),v=!0)},o(p){W(d.$$.fragment,p),v=!1},d(p){k(d,p)}}}function ql(L){let d,v,p,m,b;return{c(){d=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),m=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=s(a,"P",{});var h=l(d);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(h,"CODE",{});var T=l(p);m=i(T,"Module"),T.forEach(o),b=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-string">&#x27;no&#x27;</span>`}}),{c(){d=n("p"),v=r("Example:"),p=u(),w(m.$$.fragment)},l(a){d=s(a,"P",{});var h=l(d);v=i(h,"Example:"),h.forEach(o),p=f(a),y(m.$$.fragment,a)},m(a,h){_(a,d,h),e(d,v),_(a,p,h),M(m,a,h),b=!0},p:fe,i(a){b||($(m.$$.fragment,a),b=!0)},o(a){W(m.$$.fragment,a),b=!1},d(a){a&&o(d),a&&o(p),k(m,a)}}}function Pl(L){let d,v;return d=new ge({props:{code:`# compute loss - target_label is e.g. "down"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">0.7</span>`}}),{c(){w(d.$$.fragment)},l(p){y(d.$$.fragment,p)},m(p,m){M(d,p,m),v=!0},p:fe,i(p){v||($(d.$$.fragment,p),v=!0)},o(p){W(d.$$.fragment,p),v=!1},d(p){k(d,p)}}}function Sl(L){let d,v,p,m,b;return{c(){d=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),m=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=s(a,"P",{});var h=l(d);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(h,"CODE",{});var T=l(p);m=i(T,"Module"),T.forEach(o),b=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
instance of <a href="/docs/transformers/pr_17238/en/model_doc/wavlm#transformers.WavLMForCTC">WavLMForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.WavLMConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_17238/en/model_doc/wavlm#transformers.WavLMForCTC">WavLMForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.WavLMConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17238/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/wavlm/modeling_wavlm.py#L1274",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17238/en/model_doc/wavlm#transformers.models.wavlm.modeling_wavlm.WavLMBaseModelOutput"
>transformers.models.wavlm.modeling_wavlm.WavLMBaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17238/en/model_doc/wavlm#transformers.WavLMConfig"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/wavlm/modeling_wavlm.py#L1382",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17238/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/wavlm/modeling_wavlm.py#L1517",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17238/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/wavlm/modeling_wavlm.py#L1639",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17238/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17238/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/wavlm/modeling_wavlm.py#L1754"}}),Nt=new I({props:{name:"forward",anchor:"transformers.WavLMForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.WavLMForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <code>WavLMProcessor</code> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/wavlm/modeling_wavlm.py#L1816",returnDescription:`
...
using `),Rt=n("a"),gn=r("Wav2Vec2CTCTokenizer"),_n=r("."),vn=u(),$o=n("li"),bn=r("WavLM performs especially well on speaker verification, speaker identification, and speaker diarization tasks."),ma=u(),be=n("p"),wn=r("Relevant checkpoints can be found under "),Ke=n("a"),yn=r("https://huggingface.co/models?other=wavlm"),Mn=r("."),ha=u(),U=n("p"),$n=r("This model was contributed by "),Re=n("a"),Wn=r("patrickvonplaten"),kn=r(`. The Authors\u2019 code can be
found `),Ze=n("a"),Ln=r("here"),Tn=r("."),ua=u(),Q=n("h2"),we=n("a"),Wo=n("span"),w(Qe.$$.fragment),Cn=u(),ko=n("span"),jn=r("WavLMConfig"),fa=u(),x=n("div"),w(Je.$$.fragment),Fn=u(),J=n("p"),xn=r("This is the configuration class to store the configuration of a "),Zt=n("a"),qn=r("WavLMModel"),En=r(`. It is used to instantiate an WavLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the WavLM
`),Ge=n("a"),Pn=r("microsoft/wavlm-base"),Sn=r(" architecture."),An=u(),G=n("p"),zn=r("Configuration objects inherit from "),Qt=n("a"),On=r("PretrainedConfig"),Dn=r(` and can be used to control the model outputs. Read the
documentation from `),Jt=n("a"),Vn=r("PretrainedConfig"),Nn=r(" for more information."),In=u(),w(ye.$$.fragment),Xn=u(),w(Me.$$.fragment),ga=u(),ee=n("h2"),$e=n("a"),Lo=n("span"),w(et.$$.fragment),Un=u(),To=n("span"),Bn=r("WavLM specific outputs"),_a=u(),te=n("div"),w(tt.$$.fragment),Yn=u(),ot=n("p"),Hn=r("Output type of "),Co=n("code"),Kn=r("WavLMBaseModelOutput"),Rn=r(", with potential hidden states and attentions."),va=u(),oe=n("h2"),We=n("a"),jo=n("span"),w(at.$$.fragment),Zn=u(),Fo=n("span"),Qn=r("WavLMModel"),ba=u(),q=n("div"),w(nt.$$.fragment),Jn=u(),st=n("p"),Gn=r(`The bare WavLM Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),cs=u(),A=n("div"),w(ct.$$.fragment),ps=u(),ae=n("p"),ms=r("The "),eo=n("a"),hs=r("WavLMModel"),us=r(" forward method, overrides the "),xo=n("code"),fs=r("__call__"),gs=r(" special method."),_s=u(),w(ke.$$.fragment),vs=u(),w(Le.$$.fragment),wa=u(),ne=n("h2"),Te=n("a"),qo=n("span"),w(pt.$$.fragment),bs=u(),Eo=n("span"),ws=r("WavLMForCTC"),ya=u(),E=n("div"),w(mt.$$.fragment),ys=u(),se=n("p"),Ms=r("WavLM Model with a "),Po=n("code"),$s=r("language modeling"),Ws=r(` head on top for Connectionist Temporal Classification (CTC).
WavLM was proposed in `),ht=n("a"),ks=r(`WavLM: Unified Speech Representation Learning with Labeled and Unlabeled
...
library implements for all its model (such as downloading or saving etc.).`),ar=u(),$t=n("p"),nr=r("This model is a PyTorch "),Wt=n("a"),sr=r("torch.nn.Module"),rr=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ir=u(),S=n("div"),w(kt.$$.fragment),lr=u(),le=n("p"),dr=r("The "),no=n("a"),cr=r("WavLMForSequenceClassification"),pr=r(" forward method, overrides the "),Do=n("code"),mr=r("__call__"),hr=r(" special method."),ur=u(),w(qe.$$.fragment),fr=u(),w(Ee.$$.fragment),gr=u(),w(Pe.$$.fragment),Wa=u(),de=n("h2"),Se=n("a"),Vo=n("span"),w(Lt.$$.fragment),_r=u(),No=n("span"),vr=r("WavLMForAudioFrameClassification"),ka=u(),j=n("div"),w(Tt.$$.fragment),br=u(),Io=n("p"),wr=r("WavLM Model with a frame classification head on top for tasks like Speaker Diarization."),yr=u(),Ct=n("p"),Mr=r("WavLM was proposed in "),jt=n("a"),$r=r(`WavLM: Unified Speech Representation Learning with Labeled and Unlabeled
Data`),Wr=r(` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),kr=u(),Ft=n("p"),Lr=r("This model inherits from "),so=n("a"),Tr=r("PreTrainedModel"),Cr=r(`. Check the superclass documentation for the generic methods the
...
using `),Rt=s(Fa,"A",{href:!0});var ui=l(Rt);gn=i(ui,"Wav2Vec2CTCTokenizer"),ui.forEach(o),_n=i(Fa,"."),Fa.forEach(o),vn=f(co),$o=s(co,"LI",{});var fi=l($o);bn=i(fi,"WavLM performs especially well on speaker verification, speaker identification, and speaker diarization tasks."),fi.forEach(o),co.forEach(o),ma=f(t),be=s(t,"P",{});var xa=l(be);wn=i(xa,"Relevant checkpoints can be found under "),Ke=s(xa,"A",{href:!0,rel:!0});var gi=l(Ke);yn=i(gi,"https://huggingface.co/models?other=wavlm"),gi.forEach(o),Mn=i(xa,"."),xa.forEach(o),ha=f(t),U=s(t,"P",{});var po=l(U);$n=i(po,"This model was contributed by "),Re=s(po,"A",{href:!0,rel:!0});var _i=l(Re);Wn=i(_i,"patrickvonplaten"),_i.forEach(o),kn=i(po,`. The Authors\u2019 code can be
found `),Ze=s(po,"A",{href:!0,rel:!0});var vi=l(Ze);Ln=i(vi,"here"),vi.forEach(o),Tn=i(po,"."),po.forEach(o),ua=f(t),Q=s(t,"H2",{class:!0});var qa=l(Q);we=s(qa,"A",{id:!0,class:!0,href:!0});var bi=l(we);Wo=s(bi,"SPAN",{});var wi=l(Wo);y(Qe.$$.fragment,wi),wi.forEach(o),bi.forEach(o),Cn=f(qa),ko=s(qa,"SPAN",{});var yi=l(ko);jn=i(yi,"WavLMConfig"),yi.forEach(o),qa.forEach(o),fa=f(t),x=s(t,"DIV",{class:!0});var B=l(x);y(Je.$$.fragment,B),Fn=f(B),J=s(B,"P",{});var mo=l(J);xn=i(mo,"This is the configuration class to store the configuration of a "),Zt=s(mo,"A",{href:!0});var Mi=l(Zt);qn=i(Mi,"WavLMModel"),Mi.forEach(o),En=i(mo,`. It is used to instantiate an WavLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the WavLM
`),Ge=s(mo,"A",{href:!0,rel:!0});var $i=l(Ge);Pn=i($i,"microsoft/wavlm-base"),$i.forEach(o),Sn=i(mo," architecture."),mo.forEach(o),An=f(B),G=s(B,"P",{});var ho=l(G);zn=i(ho,"Configuration objects inherit from "),Qt=s(ho,"A",{href:!0});var Wi=l(Qt);On=i(Wi,"PretrainedConfig"),Wi.forEach(o),Dn=i(ho,` and can be used to control the model outputs. Read the
documentation from `),Jt=s(ho,"A",{href:!0});var ki=l(Jt);Vn=i(ki,"PretrainedConfig"),ki.forEach(o),Nn=i(ho," for more information."),ho.forEach(o),In=f(B),y(ye.$$.fragment,B),Xn=f(B),y(Me.$$.fragment,B),B.forEach(o),ga=f(t),ee=s(t,"H2",{class:!0});var Ea=l(ee);$e=s(Ea,"A",{id:!0,class:!0,href:!0});var Li=l($e);Lo=s(Li,"SPAN",{});var Ti=l(Lo);y(et.$$.fragment,Ti),Ti.forEach(o),Li.forEach(o),Un=f(Ea),To=s(Ea,"SPAN",{});var Ci=l(To);Bn=i(Ci,"WavLM specific outputs"),Ci.forEach(o),Ea.forEach(o),_a=f(t),te=s(t,"DIV",{class:!0});var Pa=l(te);y(tt.$$.fragment,Pa),Yn=f(Pa),ot=s(Pa,"P",{});var Sa=l(ot);Hn=i(Sa,"Output type of "),Co=s(Sa,"CODE",{});var ji=l(Co);Kn=i(ji,"WavLMBaseModelOutput"),ji.forEach(o),Rn=i(Sa,", with potential hidden states and attentions."),Sa.forEach(o),Pa.forEach(o),va=f(t),oe=s(t,"H2",{class:!0});var Aa=l(oe);We=s(Aa,"A",{id:!0,class:!0,href:!0});var Fi=l(We);jo=s(Fi,"SPAN",{});var xi=l(jo);y(at.$$.fragment,xi),xi.forEach(o),Fi.forEach(o),Zn=f(Aa),Fo=s(Aa,"SPAN",{});var qi=l(Fo);Qn=i(qi,"WavLMModel"),qi.forEach(o),Aa.forEach(o),ba=f(t),q=s(t,"DIV",{class:!0});var Y=l(q);y(nt.$$.fragment,Y),Jn=f(Y),st=s(Y,"P",{});var za=l(st);Gn=i(za,`The bare WavLM Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Da.forEach(o),cs=f(Y),A=s(Y,"DIV",{class:!0});var Ne=l(A);y(ct.$$.fragment,Ne),ps=f(Ne),ae=s(Ne,"P",{});var uo=l(ae);ms=i(uo,"The "),eo=s(uo,"A",{href:!0});var Ai=l(eo);hs=i(Ai,"WavLMModel"),Ai.forEach(o),us=i(uo," forward method, overrides the "),xo=s(uo,"CODE",{});var zi=l(xo);fs=i(zi,"__call__"),zi.forEach(o),gs=i(uo," special method."),uo.forEach(o),_s=f(Ne),y(ke.$$.fragment,Ne),vs=f(Ne),y(Le.$$.fragment,Ne),Ne.forEach(o),Y.forEach(o),wa=f(t),ne=s(t,"H2",{class:!0});var Va=l(ne);Te=s(Va,"A",{id:!0,class:!0,href:!0});var Oi=l(Te);qo=s(Oi,"SPAN",{});var Di=l(qo);y(pt.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),bs=f(Va),Eo=s(Va,"SPAN",{});var Vi=l(Eo);ws=i(Vi,"WavLMForCTC"),Vi.forEach(o),Va.forEach(o),ya=f(t),E=s(t,"DIV",{class:!0});var H=l(E);y(mt.$$.fragment,H),ys=f(H),se=s(H,"P",{});var fo=l(se);Ms=i(fo,"WavLM Model with a "),Po=s(fo,"CODE",{});var Ni=l(Po);$s=i(Ni,"language modeling"),Ni.forEach(o),Ws=i(fo,` head on top for Connectionist Temporal Classification (CTC).
WavLM was proposed in `),ht=s(fo,"A",{href:!0,rel:!0});var Ii=l(ht);ks=i(Ii,`WavLM: Unified Speech Representation Learning with Labeled and Unlabeled
...
library implements for all its model (such as downloading or saving etc.).`),Ba.forEach(o),ar=f(D),$t=s(D,"P",{});var Ya=l($t);nr=i(Ya,"This model is a PyTorch "),Wt=s(Ya,"A",{href:!0,rel:!0});var Gi=l(Wt);sr=i(Gi,"torch.nn.Module"),Gi.forEach(o),rr=i(Ya,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ya.forEach(o),ir=f(D),S=s(D,"DIV",{class:!0});var R=l(S);y(kt.$$.fragment,R),lr=f(R),le=s(R,"P",{});var _o=l(le);dr=i(_o,"The "),no=s(_o,"A",{href:!0});var el=l(no);cr=i(el,"WavLMForSequenceClassification"),el.forEach(o),pr=i(_o," forward method, overrides the "),Do=s(_o,"CODE",{});var tl=l(Do);mr=i(tl,"__call__"),tl.forEach(o),hr=i(_o," special method."),_o.forEach(o),ur=f(R),y(qe.$$.fragment,R),fr=f(R),y(Ee.$$.fragment,R),gr=f(R),y(Pe.$$.fragment,R),R.forEach(o),D.forEach(o),Wa=f(t),de=s(t,"H2",{class:!0});var Ha=l(de);Se=s(Ha,"A",{id:!0,class:!0,href:!0});var ol=l(Se);Vo=s(ol,"SPAN",{});var al=l(Vo);y(Lt.$$.fragment,al),al.forEach(o),ol.forEach(o),_r=f(Ha),No=s(Ha,"SPAN",{});var nl=l(No);vr=i(nl,"WavLMForAudioFrameClassification"),nl.forEach(o),Ha.forEach(o),ka=f(t),j=s(t,"DIV",{class:!0});var V=l(j);y(Tt.$$.fragment,V),br=f(V),Io=s(V,"P",{});var sl=l(Io);wr=i(sl,"WavLM Model with a frame classification head on top for tasks like Speaker Diarization."),sl.forEach(o),yr=f(V),Ct=s(V,"P",{});var Ka=l(Ct);Mr=i(Ka,"WavLM was proposed in "),jt=s(Ka,"A",{href:!0,rel:!0});var rl=l(jt);$r=i(rl,`WavLM: Unified Speech Representation Learning with Labeled and Unlabeled
Data`),rl.forEach(o),Wr=i(Ka,` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei,
Michael Zeng, Xuedong Huang.`),Ka.forEach(o),kr=f(V),Ft=s(V,"P",{});var Ra=l(Ft);Lr=i(Ra,"This model inherits from "),so=s(Ra,"A",{href:!0});var il=l(so);Tr=i(il,"PreTrainedModel"),il.forEach(o),Cr=i(Ra,`. Check the superclass documentation for the generic methods the
