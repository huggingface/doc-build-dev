import{S as ls,i as ds,s as cs,e as a,k as h,w,t as i,M as ps,c as s,d as o,m as u,a as r,x as y,h as l,b as p,F as e,g as _,y as E,q as $,o as S,B as W,v as ms,L as _t}from"../../chunks/vendor-6b77c823.js";import{T as wa}from"../../chunks/Tip-39098574.js";import{D as Qe}from"../../chunks/Docstring-1088f2fb.js";import{C as vt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ut}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as gt}from"../../chunks/ExampleCodeBlock-5212b321.js";function fs(D){let d,v,c,m,b;return m=new vt({props:{code:`from transformers import SEWDModel, SEWDConfig
...
instance of <a href="/docs/transformers/pr_17238/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.SEWDConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_17238/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.SEWDConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17238/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/sew_d/modeling_sew_d.py#L1419",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17238/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17238/en/model_doc/sew-d#transformers.SEWDConfig"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/sew_d/modeling_sew_d.py#L1523",returnDescription:`
<p>A <a
...
`}}),ie=new wa({props:{$$slots:{default:[gs]},$$scope:{ctx:D}}}),le=new gt({props:{anchor:"transformers.SEWDForCTC.forward.example",$$slots:{default:[_s]},$$scope:{ctx:D}}}),de=new gt({props:{anchor:"transformers.SEWDForCTC.forward.example-2",$$slots:{default:[vs]},$$scope:{ctx:D}}}),Oe=new ut({}),Ve=new Qe({props:{name:"class transformers.SEWDForSequenceClassification",anchor:"transformers.SEWDForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.SEWDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17238/en/model_doc/sew-d#transformers.SEWDConfig">SEWDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17238/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/sew_d/modeling_sew_d.py#L1613"}}),Re=new Qe({props:{name:"forward",anchor:"transformers.SEWDForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.SEWDForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17238/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/sew_d/modeling_sew_d.py#L1658",returnDescription:`
<p>A <a
...
using `),Ze=a("a"),jo=i("Wav2Vec2CTCTokenizer"),Po=i("."),Jt=h(),ee=a("p"),Fo=i("This model was contributed by "),be=a("a"),Mo=i("anton-l"),zo=i("."),Qt=h(),I=a("h2"),te=a("a"),$t=a("span"),w(we.$$.fragment),Ao=h(),St=a("span"),Oo=i("SEWDConfig"),Yt=h(),P=a("div"),w(ye.$$.fragment),Vo=h(),N=a("p"),Lo=i("This is the configuration class to store the configuration of a "),et=a("a"),Io=i("SEWDModel"),No=i(`. It is used to instantiate a SEW-D
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),On=h(),q=a("div"),w(Ae.$$.fragment),Vn=h(),J=a("p"),Ln=i("The "),rt=a("a"),In=i("SEWDForCTC"),Nn=i(" forward method, overrides the "),qt=a("code"),Kn=i("__call__"),Hn=i(" special method."),Rn=h(),w(ie.$$.fragment),Un=h(),w(le.$$.fragment),Bn=h(),w(de.$$.fragment),to=h(),Q=a("h2"),ce=a("a"),jt=a("span"),w(Oe.$$.fragment),Jn=h(),Pt=a("span"),Qn=i("SEWDForSequenceClassification"),oo=h(),k=a("div"),w(Ve.$$.fragment),Yn=h(),Ft=a("p"),Gn=i(`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),Xn=h(),Le=a("p"),Zn=i("SEW-D was proposed in "),Ie=a("a"),ea=i(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
...
SEW-D was proposed in `),De=s(co,"A",{href:!0,rel:!0});var Va=r(De);on=l(Va,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),Va.forEach(o),nn=l(co,` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),co.forEach(o),an=u(z),ke=s(z,"P",{});var po=r(ke);sn=l(po,"This model inherits from "),nt=s(po,"A",{href:!0});var La=r(nt);rn=l(La,"PreTrainedModel"),La.forEach(o),ln=l(po,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),uo.forEach(o),On=u(A),q=s(A,"DIV",{class:!0});var O=r(q);y(Ae.$$.fragment,O),Vn=u(O),J=s(O,"P",{});var ft=r(J);Ln=l(ft,"The "),rt=s(ft,"A",{href:!0});var Ga=r(rt);In=l(Ga,"SEWDForCTC"),Ga.forEach(o),Nn=l(ft," forward method, overrides the "),qt=s(ft,"CODE",{});var Xa=r(qt);Kn=l(Xa,"__call__"),Xa.forEach(o),Hn=l(ft," special method."),ft.forEach(o),Rn=u(O),y(ie.$$.fragment,O),Un=u(O),y(le.$$.fragment,O),Bn=u(O),y(de.$$.fragment,O),O.forEach(o),A.forEach(o),to=u(t),Q=s(t,"H2",{class:!0});var go=r(Q);ce=s(go,"A",{id:!0,class:!0,href:!0});var Za=r(ce);jt=s(Za,"SPAN",{});var es=r(jt);y(Oe.$$.fragment,es),es.forEach(o),Za.forEach(o),Jn=u(go),Pt=s(go,"SPAN",{});var ts=r(Pt);Qn=l(ts,"SEWDForSequenceClassification"),ts.forEach(o),go.forEach(o),oo=u(t),k=s(t,"DIV",{class:!0});var M=r(k);y(Ve.$$.fragment,M),Yn=u(M),Ft=s(M,"P",{});var os=r(Ft);Gn=l(os,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),os.forEach(o),Xn=u(M),Le=s(M,"P",{});var _o=r(Le);Zn=l(_o,"SEW-D was proposed in "),Ie=s(_o,"A",{href:!0,rel:!0});var ns=r(Ie);ea=l(ns,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),bo.forEach(o),ca=u(M),j=s(M,"DIV",{class:!0});var V=r(j);y(Re.$$.fragment,V),pa=u(V),Y=s(V,"P",{});var ht=r(Y);ma=l(ht,"The "),lt=s(ht,"A",{href:!0});var rs=r(lt);fa=l(rs,"SEWDForSequenceClassification"),rs.forEach(o),ha=l(ht," forward method, overrides the "),Mt=s(ht,"CODE",{});var is=r(Mt);ua=l(is,"__call__"),is.forEach(o),ga=l(ht," special method."),ht.forEach(o),_a=u(V),y(pe.$$.fragment,V),va=u(V),y(me.$$.fragment,V),ba=u(V),y(fe.$$.fragment,V),V.forEach(o),M.forEach(o),this.h()},h(){p(d,"name","hf:doc:metadata"),p(d,"content",JSON.stringify($s)),p(m,"id","sewd"),p(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(m,"href","#sewd"),p(c,"class","relative group"),p(G,"id","overview"),p(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(G,"href","#overview"),p(L,"class","relative group"),p(_e,"href","https://arxiv.org/abs/2109.06870"),p(_e,"rel","nofollow"),p(Ze,"href","/docs/transformers/pr_17238/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),p(be,"href","https://huggingface.co/anton-l"),p(be,"rel","nofollow"),p(te,"id","transformers.SEWDConfig"),p(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(te,"href","#transformers.SEWDConfig"),p(I,"class","relative group"),p(et,"href","/docs/transformers/pr_17238/en/model_doc/sew-d#transformers.SEWDModel"),p(Ee,"href","https://huggingface.co/asapp/sew-d-tiny-100k"),p(Ee,"rel","nofollow"),p(tt,"href","/docs/transformers/pr_17238/en/main_classes/configuration#transformers.PretrainedConfig"),p(ot,"href","/docs/transformers/pr_17238/en/main_classes/configuration#transformers.PretrainedConfig"),p(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ne,"id","transformers.SEWDModel"),p(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ne,"href","#transformers.SEWDModel"),p(H,"class","relative group"),p(De,"href","https://arxiv.org/abs/2109.06870"),p(De,"rel","nofollow"),p(nt,"href","/docs/transformers/pr_17238/en/main_classes/model#transformers.PreTrainedModel"),p(Te,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Te,"rel","nofollow"),p(at,"href","/docs/transformers/pr_17238/en/model_doc/sew-d#transformers.SEWDModel"),p(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(re,"id","transformers.SEWDForCTC"),p(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(re,"href","#transformers.SEWDForCTC"),p(U,"class","relative group"),p(Pe,"href","https://arxiv.org/abs/2109.06870"),p(Pe,"rel","nofollow"),p(st,"href","/docs/transformers/pr_17238/en/main_classes/model#transformers.PreTrainedModel"),p(ze,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(ze,"rel","nofollow"),p(rt,"href","/docs/transformers/pr_17238/en/model_doc/sew-d#transformers.SEWDForCTC"),p(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ce,"id","transformers.SEWDForSequenceClassification"),p(ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ce,"href","#transformers.SEWDForSequenceClassification"),p(Q,"class","relative group"),p(Ie,"href","https://arxiv.org/abs/2109.06870"),p(Ie,"rel","nofollow"),p(it,"href","/docs/transformers/pr_17238/en/main_classes/model#transformers.PreTrainedModel"),p(He,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(He,"rel","nofollow"),p(lt,"href","/docs/transformers/pr_17238/en/model_doc/sew-d#transformers.SEWDForSequenceClassification"),p(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(k,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,f){e(document.head,d),_(t,v,f),_(t,c,f),e(c,m),e(m,b),E(n,b,null),e(c,g),e(c,x),e(x,wo),_(t,Nt,f),_(t,L,f),e(L,G),e(G,bt),E(ge,bt,null),e(L,yo),e(L,wt),e(wt,Eo),_(t,Kt,f),_(t,X,f),e(X,$o),e(X,_e),e(_e,So),e(X,Wo),_(t,Ht,f),_(t,Ye,f),e(Ye,Do),_(t,Rt,f),_(t,Ge,f),e(Ge,yt),e(yt,ko),_(t,Ut,f),_(t,Xe,f),e(Xe,Co),_(t,Bt,f),_(t,Z,f),e(Z,Et),e(Et,To),e(Z,xo),e(Z,ve),e(ve,qo),e(ve,Ze),e(Ze,jo),e(ve,Po),_(t,Jt,f),_(t,ee,f),e(ee,Fo),e(ee,be),e(be,Mo),e(ee,zo),_(t,Qt,f),_(t,I,f),e(I,te),e(te,$t),E(we,$t,null),e(I,Ao),e(I,St),e(St,Oo),_(t,Yt,f),_(t,P,f),E(ye,P,null),e(P,Vo),e(P,N),e(N,Lo),e(N,et),e(et,Io),e(N,No),e(N,Ee),e(Ee,Ko),e(N,Ho),e(P,Ro),e(P,K),e(K,Uo),e(K,tt),e(tt,Bo),e(K,Jo),e(K,ot),e(ot,Qo),e(K,Yo),e(P,Go),E(oe,P,null),_(t,Gt,f),_(t,H,f),e(H,ne),e(ne,Wt),E($e,Wt,null),e(H,Xo),e(H,Dt),e(Dt,Zo),_(t,Xt,f),_(t,C,f),E(Se,C,null),e(C,en),e(C,We),e(We,tn),e(We,De),e(De,on),e(We,nn),e(C,an),e(C,ke),e(ke,sn),e(ke,nt),e(nt,rn),e(ke,ln),e(C,dn),e(C,Ce),e(Ce,cn),e(Ce,Te),e(Te,pn),e(Ce,mn),e(C,fn),e(C,F),E(xe,F,null),e(F,hn),e(F,R),e(R,un),e(R,at),e(at,gn),e(R,_n),e(R,kt),e(kt,vn),e(R,bn),e(F,wn),E(ae,F,null),e(F,yn),E(se,F,null),_(t,Zt,f),_(t,U,f),e(U,re),e(re,Ct),E(qe,Ct,null),e(U,En),e(U,Tt),e(Tt,$n),_(t,eo,f),_(t,T,f),E(je,T,null),e(T,Sn),e(T,B),e(B,Wn),e(B,xt),e(xt,Dn),e(B,kn),e(B,Pe),e(Pe,Cn),e(B,Tn),e(T,xn),e(T,Fe),e(Fe,qn),e(Fe,st),e(st,jn),e(Fe,Pn),e(T,Fn),e(T,Me),e(Me,Mn),e(Me,ze),e(ze,zn),e(Me,An),e(T,On),e(T,q),E(Ae,q,null),e(q,Vn),e(q,J),e(J,Ln),e(J,rt),e(rt,In),e(J,Nn),e(J,qt),e(qt,Kn),e(J,Hn),e(q,Rn),E(ie,q,null),e(q,Un),E(le,q,null),e(q,Bn),E(de,q,null),_(t,to,f),_(t,Q,f),e(Q,ce),e(ce,jt),E(Oe,jt,null),e(Q,Jn),e(Q,Pt),e(Pt,Qn),_(t,oo,f),_(t,k,f),E(Ve,k,null),e(k,Yn),e(k,Ft),e(Ft,Gn),e(k,Xn),e(k,Le),e(Le,Zn),e(Le,Ie),e(Ie,ea),e(Le,ta),e(k,oa),e(k,Ne),e(Ne,na),e(Ne,it),e(it,aa),e(Ne,sa),e(k,ra),e(k,Ke),e(Ke,ia),e(Ke,He),e(He,la),e(Ke,da),e(k,ca),e(k,j),E(Re,j,null),e(j,pa),e(j,Y),e(Y,ma),e(Y,lt),e(lt,fa),e(Y,ha),e(Y,Mt),e(Mt,ua),e(Y,ga),e(j,_a),E(pe,j,null),e(j,va),E(me,j,null),e(j,ba),E(fe,j,null),no=!0},p(t,[f]){const Ue={};f&2&&(Ue.$$scope={dirty:f,ctx:t}),oe.$set(Ue);const zt={};f&2&&(zt.$$scope={dirty:f,ctx:t}),ae.$set(zt);const At={};f&2&&(At.$$scope={dirty:f,ctx:t}),se.$set(At);const Ot={};f&2&&(Ot.$$scope={dirty:f,ctx:t}),ie.$set(Ot);const Be={};f&2&&(Be.$$scope={dirty:f,ctx:t}),le.$set(Be);const Vt={};f&2&&(Vt.$$scope={dirty:f,ctx:t}),de.$set(Vt);const Lt={};f&2&&(Lt.$$scope={dirty:f,ctx:t}),pe.$set(Lt);const It={};f&2&&(It.$$scope={dirty:f,ctx:t}),me.$set(It);const Je={};f&2&&(Je.$$scope={dirty:f,ctx:t}),fe.$set(Je)},i(t){no||($(n.$$.fragment,t),$(ge.$$.fragment,t),$(we.$$.fragment,t),$(ye.$$.fragment,t),$(oe.$$.fragment,t),$($e.$$.fragment,t),$(Se.$$.fragment,t),$(xe.$$.fragment,t),$(ae.$$.fragment,t),$(se.$$.fragment,t),$(qe.$$.fragment,t),$(je.$$.fragment,t),$(Ae.$$.fragment,t),$(ie.$$.fragment,t),$(le.$$.fragment,t),$(de.$$.fragment,t),$(Oe.$$.fragment,t),$(Ve.$$.fragment,t),$(Re.$$.fragment,t),$(pe.$$.fragment,t),$(me.$$.fragment,t),$(fe.$$.fragment,t),no=!0)},o(t){S(n.$$.fragment,t),S(ge.$$.fragment,t),S(we.$$.fragment,t),S(ye.$$.fragment,t),S(oe.$$.fragment,t),S($e.$$.fragment,t),S(Se.$$.fragment,t),S(xe.$$.fragment,t),S(ae.$$.fragment,t),S(se.$$.fragment,t),S(qe.$$.fragment,t),S(je.$$.fragment,t),S(Ae.$$.fragment,t),S(ie.$$.fragment,t),S(le.$$.fragment,t),S(de.$$.fragment,t),S(Oe.$$.fragment,t),S(Ve.$$.fragment,t),S(Re.$$.fragment,t),S(pe.$$.fragment,t),S(me.$$.fragment,t),S(fe.$$.fragment,t),no=!1},d(t){o(d),t&&o(v),t&&o(c),W(n),t&&o(Nt),t&&o(L),W(ge),t&&o(Kt),t&&o(X),t&&o(Ht),t&&o(Ye),t&&o(Rt),t&&o(Ge),t&&o(Ut),t&&o(Xe),t&&o(Bt),t&&o(Z),t&&o(Jt),t&&o(ee),t&&o(Qt),t&&o(I),W(we),t&&o(Yt),t&&o(P),W(ye),W(oe),t&&o(Gt),t&&o(H),W($e),t&&o(Xt),t&&o(C),W(Se),W(xe),W(ae),W(se),t&&o(Zt),t&&o(U),W(qe),t&&o(eo),t&&o(T),W(je),W(Ae),W(ie),W(le),W(de),t&&o(to),t&&o(Q),W(Oe),t&&o(oo),t&&o(k),W(Ve),W(Re),W(pe),W(me),W(fe)}}}const $s={local:"sewd",sections:[{local:"overview",title:"Overview"},{local:"transformers.SEWDConfig",title:"SEWDConfig"},{local:"transformers.SEWDModel",title:"SEWDModel"},{local:"transformers.SEWDForCTC",title:"SEWDForCTC"},{local:"transformers.SEWDForSequenceClassification",title:"SEWDForSequenceClassification"}],title:"SEW-D"};function Ss(D){return ms(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class qs extends ls{constructor(d){super();ds(this,d,Ss,Es,cs,{})}}export{qs as default,$s as metadata};
