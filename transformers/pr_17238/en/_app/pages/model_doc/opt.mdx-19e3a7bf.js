import{S as On,i as $n,s as zn,e as n,k as f,w as b,t as i,M as Mn,c as a,d as t,m,a as r,x as k,h as d,b as l,F as o,g as u,y,q as P,o as w,B as O,v as Cn,L as Gt}from"../../chunks/vendor-6b77c823.js";import{T as xn}from"../../chunks/Tip-39098574.js";import{D as Qe}from"../../chunks/Docstring-1088f2fb.js";import{C as Bt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Xe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Wt}from"../../chunks/ExampleCodeBlock-5212b321.js";function En(E){let p,v,_,h,T;return h=new Bt({props:{code:`from transformers import OPTModel, OPTConfig
...
<span class="hljs-string">&quot;Hey, are you consciours? Can you talk to me?\\nI&#x27;m not consciours, but I can talk to you.&quot;</span>`}}),{c(){p=n("p"),v=i("Example:"),_=f(),b(h.$$.fragment)},l(s){p=a(s,"P",{});var g=r(p);v=d(g,"Example:"),g.forEach(t),_=m(s),k(h.$$.fragment,s)},m(s,g){u(s,p,g),o(p,v),u(s,_,g),y(h,s,g),T=!0},p:Gt,i(s){T||(P(h.$$.fragment,s),T=!0)},o(s){w(h.$$.fragment,s),T=!1},d(s){s&&t(p),s&&t(_),O(h,s)}}}function Ln(E){let p,v,_,h,T,s,g,G,$o,eo,j,B,Le,ne,zo,Ae,Mo,oo,H,Co,ae,xo,Eo,to,Pe,qo,no,we,Ie,Fo,ao,Oe,jo,ro,V,re,Lo,Ne,Ao,Io,No,z,So,Se,Do,Wo,De,Go,Bo,We,Ho,Vo,$e,Ro,Uo,so,$,Zo,se,Yo,Jo,ie,Ko,Qo,de,Xo,et,le,ot,tt,io,L,R,Ge,ce,nt,Be,at,lo,M,pe,rt,A,st,ze,it,dt,he,lt,ct,pt,I,ht,Me,ut,ft,Ce,mt,gt,_t,U,co,N,Z,He,ue,Tt,Ve,vt,po,C,fe,bt,me,kt,xe,yt,Pt,wt,ge,Ot,_e,$t,zt,Mt,x,Te,Ct,S,xt,Ee,Et,qt,Re,Ft,jt,Lt,Y,At,J,ho,D,K,Ue,ve,It,Ze,Nt,uo,W,be,St,Q,ke,Dt,X,fo;return s=new Xe({}),ne=new Xe({}),ce=new Xe({}),pe=new Qe({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"max_position_embeddings",val:" = 2048"},{name:"do_layer_norm_before",val:" = True"},{name:"word_embed_proj_dim",val:" = None"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"num_attention_heads",val:" = 12"},{name:"activation_function",val:" = 'relu'"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
Vocabulary size of the OPT model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17238/en/model_doc/opt#transformers.OPTModel">OPTModel</a>`,name:"vocab_size"},{anchor:"transformers.OPTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p>Indices can be obtained using <code>OPTTokenizer</code>. See <a href="/docs/transformers/pr_17238/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17238/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17238/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/opt/modeling_opt.py#L760",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17238/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17238/en/model_doc/opt#transformers.OPTConfig"
...
Whether or not to return a <a href="/docs/transformers/pr_17238/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17238/src/transformers/models/opt/modeling_opt.py#L843",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17238/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
`}}),X=new Wt({props:{anchor:"transformers.OPTForCausalLM.forward.example",$$slots:{default:[jn]},$$scope:{ctx:E}}}),{c(){p=n("meta"),v=f(),_=n("h1"),h=n("a"),T=n("span"),b(s.$$.fragment),g=f(),G=n("span"),$o=i("OPT"),eo=f(),j=n("h2"),B=n("a"),Le=n("span"),b(ne.$$.fragment),zo=f(),Ae=n("span"),Mo=i("Overview"),oo=f(),H=n("p"),Co=i("The OPT model was proposed in "),ae=n("a"),xo=i("Open Pre-trained Transformer Language Models"),Eo=i(` by Meta AI.
...
documentation from `),Ce=n("a"),mt=i("PretrainedConfig"),gt=i(" for more information."),_t=f(),b(U.$$.fragment),co=f(),N=n("h2"),Z=n("a"),He=n("span"),b(ue.$$.fragment),Tt=f(),Ve=n("span"),vt=i("OPTModel"),po=f(),C=n("div"),b(fe.$$.fragment),bt=f(),me=n("p"),kt=i(`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Mt=f(),x=n("div"),b(Te.$$.fragment),Ct=f(),S=n("p"),xt=i("The "),Ee=n("a"),Et=i("OPTModel"),qt=i(" forward method, overrides the "),Re=n("code"),Ft=i("__call__"),jt=i(" special method."),Lt=f(),b(Y.$$.fragment),At=f(),b(J.$$.fragment),ho=f(),D=n("h2"),K=n("a"),Ue=n("span"),b(ve.$$.fragment),It=f(),Ze=n("span"),Nt=i("OPTForCausalLM"),uo=f(),W=n("div"),b(be.$$.fragment),St=f(),Q=n("div"),b(ke.$$.fragment),Dt=f(),b(X.$$.fragment),this.h()},l(e){const c=Mn('[data-svelte="svelte-1phssyn"]',document.head);p=a(c,"META",{name:!0,content:!0}),c.forEach(t),v=m(e),_=a(e,"H1",{class:!0});var ye=r(_);h=a(ye,"A",{id:!0,class:!0,href:!0});var Ye=r(h);T=a(Ye,"SPAN",{});var Je=r(T);k(s.$$.fragment,Je),Je.forEach(t),Ye.forEach(t),g=m(ye),G=a(ye,"SPAN",{});var Ke=r(G);$o=d(Ke,"OPT"),Ke.forEach(t),ye.forEach(t),eo=m(e),j=a(e,"H2",{class:!0});var mo=r(j);B=a(mo,"A",{id:!0,class:!0,href:!0});var Ht=r(B);Le=a(Ht,"SPAN",{});var Vt=r(Le);k(ne.$$.fragment,Vt),Vt.forEach(t),Ht.forEach(t),zo=m(mo),Ae=a(mo,"SPAN",{});var Rt=r(Ae);Mo=d(Rt,"Overview"),Rt.forEach(t),mo.forEach(t),oo=m(e),H=a(e,"P",{});var go=r(H);Co=d(go,"The OPT model was proposed in "),ae=a(go,"A",{href:!0,rel:!0});var Ut=r(ae);xo=d(Ut,"Open Pre-trained Transformer Language Models"),Ut.forEach(t),Eo=d(go,` by Meta AI.
...
The original code can be found `),le=a(F,"A",{href:!0,rel:!0});var sn=r(le);ot=d(sn,"here"),sn.forEach(t),tt=d(F,"."),F.forEach(t),io=m(e),L=a(e,"H2",{class:!0});var vo=r(L);R=a(vo,"A",{id:!0,class:!0,href:!0});var dn=r(R);Ge=a(dn,"SPAN",{});var ln=r(Ge);k(ce.$$.fragment,ln),ln.forEach(t),dn.forEach(t),nt=m(vo),Be=a(vo,"SPAN",{});var cn=r(Be);at=d(cn,"OPTConfig"),cn.forEach(t),vo.forEach(t),lo=m(e),M=a(e,"DIV",{class:!0});var ee=r(M);k(pe.$$.fragment,ee),rt=m(ee),A=a(ee,"P",{});var qe=r(A);st=d(qe,"This is the configuration class to store the configuration of a "),ze=a(qe,"A",{href:!0});var pn=r(ze);it=d(pn,"OPTModel"),pn.forEach(t),dt=d(qe,`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
...
documentation from `),Ce=a(Fe,"A",{href:!0});var fn=r(Ce);mt=d(fn,"PretrainedConfig"),fn.forEach(t),gt=d(Fe," for more information."),Fe.forEach(t),_t=m(ee),k(U.$$.fragment,ee),ee.forEach(t),co=m(e),N=a(e,"H2",{class:!0});var bo=r(N);Z=a(bo,"A",{id:!0,class:!0,href:!0});var mn=r(Z);He=a(mn,"SPAN",{});var gn=r(He);k(ue.$$.fragment,gn),gn.forEach(t),mn.forEach(t),Tt=m(bo),Ve=a(bo,"SPAN",{});var _n=r(Ve);vt=d(_n,"OPTModel"),_n.forEach(t),bo.forEach(t),po=m(e),C=a(e,"DIV",{class:!0});var oe=r(C);k(fe.$$.fragment,oe),bt=m(oe),me=a(oe,"P",{});var ko=r(me);kt=d(ko,`The bare OPT Model outputting raw hidden-states without any specific head on top.
