...
`),Rp=o("a"),Q5=a("deepspeed-zero-inference"),e4=a("."),Aj=u(),Ip=o("p"),s4=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),Tj=u(),Up=o("a"),Sj=u(),qs=o("h2"),gt=o("a"),Kh=o("span"),f(so.$$.fragment),t4=u(),Jh=o("span"),a4=a("Trainer Deepspeed Integration"),Cj=u(),Gp=o("a"),xj=u(),Es=o("h3"),bt=o("a"),Xh=o("span"),f(to.$$.fragment),n4=u(),Qh=o("span"),o4=a("Installation"),Rj=u(),Mp=o("p"),l4=a("Install the library via pypi:"),Ij=u(),f(ao.$$.fragment),Uj=u(),Se=o("p"),r4=a("or via "),ef=o("code"),p4=a("transformers"),i4=a("\u2019 "),sf=o("code"),u4=a("extras"),c4=a(":"),Gj=u(),f(no.$$.fragment),Mj=u(),Ce=o("p"),h4=a("or find more details on "),oo=o("a"),f4=a("the DeepSpeed\u2019s GitHub page"),d4=a(` and
`),lo=o("a"),m4=a("advanced install"),_4=a("."),Lj=u(),qt=o("p"),v4=a("If you\u2019re still struggling with the build, first make sure to read "),Lp=o("a"),j4=a("zero-install-notes"),w4=a("."),Zj=u(),Zp=o("p"),y4=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),Nj=u(),Np=o("p"),g4=a("To make a local build for DeepSpeed:"),Hj=u(),f(ro.$$.fragment),Bj=u(),xe=o("p"),b4=a("If you intend to use NVMe offload you will also need to include "),tf=o("code"),q4=a("DS_BUILD_AIO=1"),E4=a(` in the instructions above (and also
install `),af=o("em"),$4=a("libaio-dev"),k4=a(" system-wide)."),Wj=u(),Et=o("p"),P4=a("Edit "),nf=o("code"),z4=a("TORCH_CUDA_ARCH_LIST"),D4=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),Fj=u(),f(po.$$.fragment),Vj=u(),ke=o("p"),O4=a("So if you get "),of=o("code"),A4=a("8, 6"),T4=a(", then use "),lf=o("code"),S4=a('TORCH_CUDA_ARCH_LIST="8.6"'),C4=a(`. If you have multiple different cards, you can list all
of them like so `),rf=o("code"),x4=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),Yj=u(),Hp=o("p"),R4=a("If you need to use the same setup on multiple machines, make a binary wheel:"),Kj=u(),f(io.$$.fragment),Jj=u(),Re=o("p"),I4=a("it will generate something like "),pf=o("code"),U4=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),G4=a(` which now you can install
as `),uf=o("code"),M4=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),L4=a(" locally or on any other machine."),Xj=u(),$t=o("p"),Z4=a("Again, remember to ensure to adjust "),cf=o("code"),N4=a("TORCH_CUDA_ARCH_LIST"),H4=a(" to the target architectures."),Qj=u(),Ie=o("p"),B4=a("You can find the complete list of NVIDIA GPUs and their corresponding "),hf=o("strong"),W4=a("Compute Capabilities"),F4=a(` (same as arch in this
context) `),uo=o("a"),V4=a("here"),Y4=a("."),ew=u(),Bp=o("p"),K4=a("You can check the archs pytorch was built with using:"),sw=u(),f(co.$$.fragment),tw=u(),Wp=o("p"),J4=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),aw=u(),f(ho.$$.fragment),nw=u(),Fp=o("p"),X4=a("If the output is:"),ow=u(),f(fo.$$.fragment),lw=u(),kt=o("p"),Q4=a("then you know that this card\u2019s arch is "),ff=o("code"),e6=a("8.6"),s6=a("."),rw=u(),Pt=o("p"),t6=a("You can also leave "),df=o("code"),a6=a("TORCH_CUDA_ARCH_LIST"),n6=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),pw=u(),zt=o("p"),o6=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=o("a"),l6=a("Deepspeed"),r6=a(","),iw=u(),Vp=o("a"),uw=u(),$s=o("h3"),Dt=o("a"),mf=o("span"),f(_o.$$.fragment),p6=u(),_f=o("span"),i6=a("Deployment with multiple GPUs"),cw=u(),Ot=o("p"),u6=a("To deploy this feature with multiple GPUs adjust the "),Yp=o("a"),c6=a("Trainer"),h6=a(` command line arguments as
following:`),hw=u(),At=o("ol"),ks=o("li"),f6=a("replace "),vf=o("code"),d6=a("python -m torch.distributed.launch"),m6=a(" with "),jf=o("code"),_6=a("deepspeed"),v6=a("."),j6=u(),Pe=o("li"),w6=a("add a new argument "),wf=o("code"),y6=a("--deepspeed ds_config.json"),g6=a(", where "),yf=o("code"),b6=a("ds_config.json"),q6=a(` is the DeepSpeed configuration file as
documented `),vo=o("a"),E6=a("here"),$6=a(". The file naming is up to you."),fw=u(),Kp=o("p"),k6=a("Therefore, if your original command line looked as follows:"),dw=u(),f(jo.$$.fragment),mw=u(),Jp=o("p"),P6=a("Now it should be:"),_w=u(),f(wo.$$.fragment),vw=u(),I=o("p"),z6=a("Unlike, "),gf=o("code"),D6=a("torch.distributed.launch"),O6=a(" where you have to specify how many GPUs to use with "),bf=o("code"),A6=a("--nproc_per_node"),T6=a(`, with the
`),qf=o("code"),S6=a("deepspeed"),C6=a(" launcher you don\u2019t have to use the corresponding "),Ef=o("code"),x6=a("--num_gpus"),R6=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=o("a"),I6=a("here"),U6=a("."),jw=u(),ae=o("p"),G6=a("In fact, you can continue using "),$f=o("code"),M6=a("-m torch.distributed.launch"),L6=a(` with DeepSpeed as long as you don\u2019t need to use
`),kf=o("code"),Z6=a("deepspeed"),N6=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Pf=o("code"),H6=a("deepspeed"),B6=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),ww=u(),Tt=o("p"),W6=a("Here is an example of running "),zf=o("code"),F6=a("run_translation.py"),V6=a(" under DeepSpeed deploying all available GPUs:"),yw=u(),f(go.$$.fragment),gw=u(),St=o("p"),Y6=a("Note that in the DeepSpeed documentation you are likely to see "),Df=o("code"),K6=a("--deepspeed --deepspeed_config ds_config.json"),J6=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),bw=u(),Ct=o("p"),X6=a("For some practical usage examples, please, see this "),bo=o("a"),Q6=a("post"),e$=a("."),qw=u(),Xp=o("a"),Ew=u(),Ps=o("h3"),xt=o("a"),Of=o("span"),f(qo.$$.fragment),s$=u(),Af=o("span"),t$=a("Deployment with one GPU"),$w=u(),Rt=o("p"),a$=a("To deploy DeepSpeed with one GPU adjust the "),Qp=o("a"),n$=a("Trainer"),o$=a(" command line arguments as follows:"),kw=u(),f(Eo.$$.fragment),Pw=u(),Ue=o("p"),l$=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Tf=o("code"),r$=a("--num_gpus=1"),p$=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),$o=o("a"),i$=a("documentation"),u$=a(" discusses the launcher options."),zw=u(),ei=o("p"),c$=a("Why would you want to use DeepSpeed with just one GPU?"),Dw=u(),It=o("ol"),Sf=o("li"),h$=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),f$=u(),Cf=o("li"),d$=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),Ow=u(),si=o("p"),m$=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),Aw=u(),f(ko.$$.fragment),Tw=u(),ti=o("p"),_$=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),Sw=u(),Ut=o("p"),v$=a("For a practical usage example of this type of deployment, please, see this "),Po=o("a"),j$=a("post"),w$=a("."),Cw=u(),ai=o("p"),y$=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),xw=u(),ni=o("p"),g$=a("Notes:"),Rw=u(),oi=o("ul"),zs=o("li"),zo=o("p"),b$=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),xf=o("code"),q$=a("CUDA_VISIBLE_DEVICES"),E$=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),$$=u(),f(Do.$$.fragment),k$=u(),Rf=o("p"),P$=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),Iw=u(),li=o("a"),Uw=u(),Ds=o("h3"),Gt=o("a"),If=o("span"),f(Oo.$$.fragment),z$=u(),Uf=o("span"),D$=a("Deployment in Notebooks"),Gw=u(),Mt=o("p"),O$=a("The problem with running notebook cells as a script is that there is no normal "),Gf=o("code"),A$=a("deepspeed"),T$=a(` launcher to rely on, so
under certain setups we have to emulate it.`),Mw=u(),ri=o("p"),S$=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),Lw=u(),f(Ao.$$.fragment),Zw=u(),Lt=o("p"),C$=a("Note: "),Mf=o("code"),x$=a("..."),R$=a(" stands for the normal arguments that you\u2019d pass to the functions."),Nw=u(),pi=o("p"),I$=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),Hw=u(),ii=o("p"),U$=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),Bw=u(),f(To.$$.fragment),Ww=u(),Ge=o("p"),G$=a("If the training script is in a normal file and not in the notebook cells, you can launch "),Lf=o("code"),M$=a("deepspeed"),L$=a(` normally via
shell from a cell. For example, to use `),Zf=o("code"),Z$=a("run_translation.py"),N$=a(" you would launch it with:"),Fw=u(),f(So.$$.fragment),Vw=u(),Zt=o("p"),H$=a("or with "),Nf=o("code"),B$=a("%%bash"),W$=a(" magic, where you can write a multi-line code for the shell program to run:"),Yw=u(),f(Co.$$.fragment),Kw=u(),ui=o("p"),F$=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),Jw=u(),Nt=o("p"),V$=a("Note: While "),Hf=o("code"),Y$=a("%%bash"),K$=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Xw=u(),ci=o("a"),Qw=u(),Os=o("h3"),Ht=o("a"),Bf=o("span"),f(xo.$$.fragment),J$=u(),Wf=o("span"),X$=a("Configuration"),ey=u(),Bt=o("p"),Q$=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
...
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(R0,"A",{href:!0});var YU=r(Rp);Q5=n(YU,"deepspeed-zero-inference"),YU.forEach(t),e4=n(R0,"."),R0.forEach(t),VU.forEach(t),Aj=c(e),Ip=l(e,"P",{});var KU=r(Ip);s4=n(KU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),KU.forEach(t),Tj=c(e),Up=l(e,"A",{id:!0}),r(Up).forEach(t),Sj=c(e),qs=l(e,"H2",{class:!0});var I0=r(qs);gt=l(I0,"A",{id:!0,class:!0,href:!0});var JU=r(gt);Kh=l(JU,"SPAN",{});var XU=r(Kh);d(so.$$.fragment,XU),XU.forEach(t),JU.forEach(t),t4=c(I0),Jh=l(I0,"SPAN",{});var QU=r(Jh);a4=n(QU,"Trainer Deepspeed Integration"),QU.forEach(t),I0.forEach(t),Cj=c(e),Gp=l(e,"A",{id:!0}),r(Gp).forEach(t),xj=c(e),Es=l(e,"H3",{class:!0});var U0=r(Es);bt=l(U0,"A",{id:!0,class:!0,href:!0});var eG=r(bt);Xh=l(eG,"SPAN",{});var sG=r(Xh);d(to.$$.fragment,sG),sG.forEach(t),eG.forEach(t),n4=c(U0),Qh=l(U0,"SPAN",{});var tG=r(Qh);o4=n(tG,"Installation"),tG.forEach(t),U0.forEach(t),Rj=c(e),Mp=l(e,"P",{});var aG=r(Mp);l4=n(aG,"Install the library via pypi:"),aG.forEach(t),Ij=c(e),d(ao.$$.fragment,e),Uj=c(e),Se=l(e,"P",{});var Kc=r(Se);r4=n(Kc,"or via "),ef=l(Kc,"CODE",{});var nG=r(ef);p4=n(nG,"transformers"),nG.forEach(t),i4=n(Kc,"\u2019 "),sf=l(Kc,"CODE",{});var oG=r(sf);u4=n(oG,"extras"),oG.forEach(t),c4=n(Kc,":"),Kc.forEach(t),Gj=c(e),d(no.$$.fragment,e),Mj=c(e),Ce=l(e,"P",{});var Jc=r(Ce);h4=n(Jc,"or find more details on "),oo=l(Jc,"A",{href:!0,rel:!0});var lG=r(oo);f4=n(lG,"the DeepSpeed\u2019s GitHub page"),lG.forEach(t),d4=n(Jc,` and
`),lo=l(Jc,"A",{href:!0,rel:!0});var rG=r(lo);m4=n(rG,"advanced install"),rG.forEach(t),_4=n(Jc,"."),Jc.forEach(t),Lj=c(e),qt=l(e,"P",{});var G0=r(qt);v4=n(G0,"If you\u2019re still struggling with the build, first make sure to read "),Lp=l(G0,"A",{href:!0});var pG=r(Lp);j4=n(pG,"zero-install-notes"),pG.forEach(t),w4=n(G0,"."),G0.forEach(t),Zj=c(e),Zp=l(e,"P",{});var iG=r(Zp);y4=n(iG,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),iG.forEach(t),Nj=c(e),Np=l(e,"P",{});var uG=r(Np);g4=n(uG,"To make a local build for DeepSpeed:"),uG.forEach(t),Hj=c(e),d(ro.$$.fragment,e),Bj=c(e),xe=l(e,"P",{});var Xc=r(xe);b4=n(Xc,"If you intend to use NVMe offload you will also need to include "),tf=l(Xc,"CODE",{});var cG=r(tf);q4=n(cG,"DS_BUILD_AIO=1"),cG.forEach(t),E4=n(Xc,` in the instructions above (and also
install `),af=l(Xc,"EM",{});var hG=r(af);$4=n(hG,"libaio-dev"),hG.forEach(t),k4=n(Xc," system-wide)."),Xc.forEach(t),Wj=c(e),Et=l(e,"P",{});var M0=r(Et);P4=n(M0,"Edit "),nf=l(M0,"CODE",{});var fG=r(nf);z4=n(fG,"TORCH_CUDA_ARCH_LIST"),fG.forEach(t),D4=n(M0,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),M0.forEach(t),Fj=c(e),d(po.$$.fragment,e),Vj=c(e),ke=l(e,"P",{});var yp=r(ke);O4=n(yp,"So if you get "),of=l(yp,"CODE",{});var dG=r(of);A4=n(dG,"8, 6"),dG.forEach(t),T4=n(yp,", then use "),lf=l(yp,"CODE",{});var mG=r(lf);S4=n(mG,'TORCH_CUDA_ARCH_LIST="8.6"'),mG.forEach(t),C4=n(yp,`. If you have multiple different cards, you can list all
of them like so `),rf=l(yp,"CODE",{});var _G=r(rf);x4=n(_G,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),_G.forEach(t),yp.forEach(t),Yj=c(e),Hp=l(e,"P",{});var vG=r(Hp);R4=n(vG,"If you need to use the same setup on multiple machines, make a binary wheel:"),vG.forEach(t),Kj=c(e),d(io.$$.fragment,e),Jj=c(e),Re=l(e,"P",{});var Qc=r(Re);I4=n(Qc,"it will generate something like "),pf=l(Qc,"CODE",{});var jG=r(pf);U4=n(jG,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),jG.forEach(t),G4=n(Qc,` which now you can install
as `),uf=l(Qc,"CODE",{});var wG=r(uf);M4=n(wG,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wG.forEach(t),L4=n(Qc," locally or on any other machine."),Qc.forEach(t),Xj=c(e),$t=l(e,"P",{});var L0=r($t);Z4=n(L0,"Again, remember to ensure to adjust "),cf=l(L0,"CODE",{});var yG=r(cf);N4=n(yG,"TORCH_CUDA_ARCH_LIST"),yG.forEach(t),H4=n(L0," to the target architectures."),L0.forEach(t),Qj=c(e),Ie=l(e,"P",{});var eh=r(Ie);B4=n(eh,"You can find the complete list of NVIDIA GPUs and their corresponding "),hf=l(eh,"STRONG",{});var gG=r(hf);W4=n(gG,"Compute Capabilities"),gG.forEach(t),F4=n(eh,` (same as arch in this
context) `),uo=l(eh,"A",{href:!0,rel:!0});var bG=r(uo);V4=n(bG,"here"),bG.forEach(t),Y4=n(eh,"."),eh.forEach(t),ew=c(e),Bp=l(e,"P",{});var qG=r(Bp);K4=n(qG,"You can check the archs pytorch was built with using:"),qG.forEach(t),sw=c(e),d(co.$$.fragment,e),tw=c(e),Wp=l(e,"P",{});var EG=r(Wp);J4=n(EG,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),EG.forEach(t),aw=c(e),d(ho.$$.fragment,e),nw=c(e),Fp=l(e,"P",{});var $G=r(Fp);X4=n($G,"If the output is:"),$G.forEach(t),ow=c(e),d(fo.$$.fragment,e),lw=c(e),kt=l(e,"P",{});var Z0=r(kt);Q4=n(Z0,"then you know that this card\u2019s arch is "),ff=l(Z0,"CODE",{});var kG=r(ff);e6=n(kG,"8.6"),kG.forEach(t),s6=n(Z0,"."),Z0.forEach(t),rw=c(e),Pt=l(e,"P",{});var N0=r(Pt);t6=n(N0,"You can also leave "),df=l(N0,"CODE",{});var PG=r(df);a6=n(PG,"TORCH_CUDA_ARCH_LIST"),PG.forEach(t),n6=n(N0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),N0.forEach(t),pw=c(e),zt=l(e,"P",{});var H0=r(zt);o6=n(H0,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=l(H0,"A",{href:!0,rel:!0});var zG=r(mo);l6=n(zG,"Deepspeed"),zG.forEach(t),r6=n(H0,","),H0.forEach(t),iw=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),uw=c(e),$s=l(e,"H3",{class:!0});var B0=r($s);Dt=l(B0,"A",{id:!0,class:!0,href:!0});var DG=r(Dt);mf=l(DG,"SPAN",{});var OG=r(mf);d(_o.$$.fragment,OG),OG.forEach(t),DG.forEach(t),p6=c(B0),_f=l(B0,"SPAN",{});var AG=r(_f);i6=n(AG,"Deployment with multiple GPUs"),AG.forEach(t),B0.forEach(t),cw=c(e),Ot=l(e,"P",{});var W0=r(Ot);u6=n(W0,"To deploy this feature with multiple GPUs adjust the "),Yp=l(W0,"A",{href:!0});var TG=r(Yp);c6=n(TG,"Trainer"),TG.forEach(t),h6=n(W0,` command line arguments as
following:`),W0.forEach(t),hw=c(e),At=l(e,"OL",{});var F0=r(At);ks=l(F0,"LI",{});var sh=r(ks);f6=n(sh,"replace "),vf=l(sh,"CODE",{});var SG=r(vf);d6=n(SG,"python -m torch.distributed.launch"),SG.forEach(t),m6=n(sh," with "),jf=l(sh,"CODE",{});var CG=r(jf);_6=n(CG,"deepspeed"),CG.forEach(t),v6=n(sh,"."),sh.forEach(t),j6=c(F0),Pe=l(F0,"LI",{});var Sn=r(Pe);w6=n(Sn,"add a new argument "),wf=l(Sn,"CODE",{});var xG=r(wf);y6=n(xG,"--deepspeed ds_config.json"),xG.forEach(t),g6=n(Sn,", where "),yf=l(Sn,"CODE",{});var RG=r(yf);b6=n(RG,"ds_config.json"),RG.forEach(t),q6=n(Sn,` is the DeepSpeed configuration file as
documented `),vo=l(Sn,"A",{href:!0,rel:!0});var IG=r(vo);E6=n(IG,"here"),IG.forEach(t),$6=n(Sn,". The file naming is up to you."),Sn.forEach(t),F0.forEach(t),fw=c(e),Kp=l(e,"P",{});var UG=r(Kp);k6=n(UG,"Therefore, if your original command line looked as follows:"),UG.forEach(t),dw=c(e),d(jo.$$.fragment,e),mw=c(e),Jp=l(e,"P",{});var GG=r(Jp);P6=n(GG,"Now it should be:"),GG.forEach(t),_w=c(e),d(wo.$$.fragment,e),vw=c(e),I=l(e,"P",{});var we=r(I);z6=n(we,"Unlike, "),gf=l(we,"CODE",{});var MG=r(gf);D6=n(MG,"torch.distributed.launch"),MG.forEach(t),O6=n(we," where you have to specify how many GPUs to use with "),bf=l(we,"CODE",{});var LG=r(bf);A6=n(LG,"--nproc_per_node"),LG.forEach(t),T6=n(we,`, with the
`),qf=l(we,"CODE",{});var ZG=r(qf);S6=n(ZG,"deepspeed"),ZG.forEach(t),C6=n(we," launcher you don\u2019t have to use the corresponding "),Ef=l(we,"CODE",{});var NG=r(Ef);x6=n(NG,"--num_gpus"),NG.forEach(t),R6=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=l(we,"A",{href:!0,rel:!0});var HG=r(yo);I6=n(HG,"here"),HG.forEach(t),U6=n(we,"."),we.forEach(t),jw=c(e),ae=l(e,"P",{});var Cn=r(ae);G6=n(Cn,"In fact, you can continue using "),$f=l(Cn,"CODE",{});var BG=r($f);M6=n(BG,"-m torch.distributed.launch"),BG.forEach(t),L6=n(Cn,` with DeepSpeed as long as you don\u2019t need to use
`),kf=l(Cn,"CODE",{});var WG=r(kf);Z6=n(WG,"deepspeed"),WG.forEach(t),N6=n(Cn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Pf=l(Cn,"CODE",{});var FG=r(Pf);H6=n(FG,"deepspeed"),FG.forEach(t),B6=n(Cn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Cn.forEach(t),ww=c(e),Tt=l(e,"P",{});var V0=r(Tt);W6=n(V0,"Here is an example of running "),zf=l(V0,"CODE",{});var VG=r(zf);F6=n(VG,"run_translation.py"),VG.forEach(t),V6=n(V0," under DeepSpeed deploying all available GPUs:"),V0.forEach(t),yw=c(e),d(go.$$.fragment,e),gw=c(e),St=l(e,"P",{});var Y0=r(St);Y6=n(Y0,"Note that in the DeepSpeed documentation you are likely to see "),Df=l(Y0,"CODE",{});var YG=r(Df);K6=n(YG,"--deepspeed --deepspeed_config ds_config.json"),YG.forEach(t),J6=n(Y0,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Y0.forEach(t),bw=c(e),Ct=l(e,"P",{});var K0=r(Ct);X6=n(K0,"For some practical usage examples, please, see this "),bo=l(K0,"A",{href:!0,rel:!0});var KG=r(bo);Q6=n(KG,"post"),KG.forEach(t),e$=n(K0,"."),K0.forEach(t),qw=c(e),Xp=l(e,"A",{id:!0}),r(Xp).forEach(t),Ew=c(e),Ps=l(e,"H3",{class:!0});var J0=r(Ps);xt=l(J0,"A",{id:!0,class:!0,href:!0});var JG=r(xt);Of=l(JG,"SPAN",{});var XG=r(Of);d(qo.$$.fragment,XG),XG.forEach(t),JG.forEach(t),s$=c(J0),Af=l(J0,"SPAN",{});var QG=r(Af);t$=n(QG,"Deployment with one GPU"),QG.forEach(t),J0.forEach(t),$w=c(e),Rt=l(e,"P",{});var X0=r(Rt);a$=n(X0,"To deploy DeepSpeed with one GPU adjust the "),Qp=l(X0,"A",{href:!0});var eM=r(Qp);n$=n(eM,"Trainer"),eM.forEach(t),o$=n(X0," command line arguments as follows:"),X0.forEach(t),kw=c(e),d(Eo.$$.fragment,e),Pw=c(e),Ue=l(e,"P",{});var th=r(Ue);l$=n(th,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Tf=l(th,"CODE",{});var sM=r(Tf);r$=n(sM,"--num_gpus=1"),sM.forEach(t),p$=n(th,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),$o=l(th,"A",{href:!0,rel:!0});var tM=r($o);i$=n(tM,"documentation"),tM.forEach(t),u$=n(th," discusses the launcher options."),th.forEach(t),zw=c(e),ei=l(e,"P",{});var aM=r(ei);c$=n(aM,"Why would you want to use DeepSpeed with just one GPU?"),aM.forEach(t),Dw=c(e),It=l(e,"OL",{});var Q0=r(It);Sf=l(Q0,"LI",{});var nM=r(Sf);h$=n(nM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),nM.forEach(t),f$=c(Q0),Cf=l(Q0,"LI",{});var oM=r(Cf);d$=n(oM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),oM.forEach(t),Q0.forEach(t),Ow=c(e),si=l(e,"P",{});var lM=r(si);m$=n(lM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),lM.forEach(t),Aw=c(e),d(ko.$$.fragment,e),Tw=c(e),ti=l(e,"P",{});var rM=r(ti);_$=n(rM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),rM.forEach(t),Sw=c(e),Ut=l(e,"P",{});var eq=r(Ut);v$=n(eq,"For a practical usage example of this type of deployment, please, see this "),Po=l(eq,"A",{href:!0,rel:!0});var pM=r(Po);j$=n(pM,"post"),pM.forEach(t),w$=n(eq,"."),eq.forEach(t),Cw=c(e),ai=l(e,"P",{});var iM=r(ai);y$=n(iM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),iM.forEach(t),xw=c(e),ni=l(e,"P",{});var uM=r(ni);g$=n(uM,"Notes:"),uM.forEach(t),Rw=c(e),oi=l(e,"UL",{});var cM=r(oi);zs=l(cM,"LI",{});var ah=r(zs);zo=l(ah,"P",{});var sq=r(zo);b$=n(sq,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),xf=l(sq,"CODE",{});var hM=r(xf);q$=n(hM,"CUDA_VISIBLE_DEVICES"),hM.forEach(t),E$=n(sq,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),sq.forEach(t),$$=c(ah),d(Do.$$.fragment,ah),k$=c(ah),Rf=l(ah,"P",{});var fM=r(Rf);P$=n(fM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),fM.forEach(t),ah.forEach(t),cM.forEach(t),Iw=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),Uw=c(e),Ds=l(e,"H3",{class:!0});var tq=r(Ds);Gt=l(tq,"A",{id:!0,class:!0,href:!0});var dM=r(Gt);If=l(dM,"SPAN",{});var mM=r(If);d(Oo.$$.fragment,mM),mM.forEach(t),dM.forEach(t),z$=c(tq),Uf=l(tq,"SPAN",{});var _M=r(Uf);D$=n(_M,"Deployment in Notebooks"),_M.forEach(t),tq.forEach(t),Gw=c(e),Mt=l(e,"P",{});var aq=r(Mt);O$=n(aq,"The problem with running notebook cells as a script is that there is no normal "),Gf=l(aq,"CODE",{});var vM=r(Gf);A$=n(vM,"deepspeed"),vM.forEach(t),T$=n(aq,` launcher to rely on, so
under certain setups we have to emulate it.`),aq.forEach(t),Mw=c(e),ri=l(e,"P",{});var jM=r(ri);S$=n(jM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),jM.forEach(t),Lw=c(e),d(Ao.$$.fragment,e),Zw=c(e),Lt=l(e,"P",{});var nq=r(Lt);C$=n(nq,"Note: "),Mf=l(nq,"CODE",{});var wM=r(Mf);x$=n(wM,"..."),wM.forEach(t),R$=n(nq," stands for the normal arguments that you\u2019d pass to the functions."),nq.forEach(t),Nw=c(e),pi=l(e,"P",{});var yM=r(pi);I$=n(yM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),yM.forEach(t),Hw=c(e),ii=l(e,"P",{});var gM=r(ii);U$=n(gM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),gM.forEach(t),Bw=c(e),d(To.$$.fragment,e),Ww=c(e),Ge=l(e,"P",{});var nh=r(Ge);G$=n(nh,"If the training script is in a normal file and not in the notebook cells, you can launch "),Lf=l(nh,"CODE",{});var bM=r(Lf);M$=n(bM,"deepspeed"),bM.forEach(t),L$=n(nh,` normally via
shell from a cell. For example, to use `),Zf=l(nh,"CODE",{});var qM=r(Zf);Z$=n(qM,"run_translation.py"),qM.forEach(t),N$=n(nh," you would launch it with:"),nh.forEach(t),Fw=c(e),d(So.$$.fragment,e),Vw=c(e),Zt=l(e,"P",{});var oq=r(Zt);H$=n(oq,"or with "),Nf=l(oq,"CODE",{});var EM=r(Nf);B$=n(EM,"%%bash"),EM.forEach(t),W$=n(oq," magic, where you can write a multi-line code for the shell program to run:"),oq.forEach(t),Yw=c(e),d(Co.$$.fragment,e),Kw=c(e),ui=l(e,"P",{});var $M=r(ui);F$=n($M,"In such case you don\u2019t need any of the code presented at the beginning of this section."),$M.forEach(t),Jw=c(e),Nt=l(e,"P",{});var lq=r(Nt);V$=n(lq,"Note: While "),Hf=l(lq,"CODE",{});var kM=r(Hf);Y$=n(kM,"%%bash"),kM.forEach(t),K$=n(lq,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),lq.forEach(t),Xw=c(e),ci=l(e,"A",{id:!0}),r(ci).forEach(t),Qw=c(e),Os=l(e,"H3",{class:!0});var rq=r(Os);Ht=l(rq,"A",{id:!0,class:!0,href:!0});var PM=r(Ht);Bf=l(PM,"SPAN",{});var zM=r(Bf);d(xo.$$.fragment,zM),zM.forEach(t),PM.forEach(t),J$=c(rq),Wf=l(rq,"SPAN",{});var DM=r(Wf);X$=n(DM,"Configuration"),DM.forEach(t),rq.forEach(t),ey=c(e),Bt=l(e,"P",{});var pq=r(Bt);Q$=n(pq,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
