...
first positional argument :`),Te=c(),O=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Ge=n("model(input_ids)"),De=c(),C=a("li"),Be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),He=c(),P=a("li"),We=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function hm($){let l,b,p,u,T,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,Te,O,j,ue,oe,$e,me,U,Ge,De,C,Be,K,M,S,G,Qe,He,P,We,ne,ve;return{c(){l=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),T=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),R=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=c(),O=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Ge=n("model(input_ids)"),De=c(),C=a("li"),Be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),He=c(),P=a("li"),We=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),ve=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);T=r(se,"LI",{});var nt=d(T);i=s(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(se),D=r(se,"LI",{});var st=d(D);Pe=s(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var N=d(F);Z=s(N,"This second option is useful when using "),H=r(N,"CODE",{});var at=d(H);ee=s(at,"tf.keras.Model.fit"),at.forEach(t),Ne=s(N,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Examples:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function mm($){let l,b,p,u,T,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,Te,O,j,ue,oe,$e,me,U,Ge,De,C,Be,K,M,S,G,Qe,He,P,We,ne,ve,q,z,se,nt,st,N,at,rt,Fe,V,ae,ze,dt,re,it,de,Re,Ue,rd,dd,qs,id,ld,cd,ke,hd,$s,pd,ud,Ds,md,fd,Qn,_d,gd,Fs,bd,Td,vd,X,kd,zs,wd,yd,xs,Ed,Ld,Hn,qd,$d,Ms,Dd,Fd,Ss,zd,xd,Os,Md,Sd,Od,Ve,Cd,Cs,jd,Ad,js,Pd,Nd,As,Id,Gd,Bd,$o,Qd,Do,Hd,Wd,Rd,Fo,Ud,zo,Vd,Xd,Wa,jt,Jd,xo,Zd,Kd,Ra,lt,At,Ps,Mo,Yd,Ns,ei,Ua,we,So,ti,ct,oi,Wn,ni,si,Oo,ai,ri,di,ht,ii,Rn,li,ci,Un,hi,pi,ui,Pt,Va,pt,Nt,Is,Co,mi,Gs,fi,Xa,A,jo,_i,Bs,gi,bi,It,Vn,Ti,vi,Xn,ki,wi,yi,Ao,Ei,Jn,Li,qi,$i,Xe,Po,Di,Qs,Fi,zi,No,Zn,xi,Hs,Mi,Si,Kn,Oi,Ws,Ci,ji,Gt,Io,Ai,Go,Pi,Rs,Ni,Ii,Gi,Bt,Bo,Bi,Us,Qi,Hi,Yn,Qo,Ja,ut,Qt,Vs,Ho,Wi,Xs,Ri,Za,ye,Wo,Ui,Ro,Vi,Js,Xi,Ji,Zi,Ht,es,Ki,Yi,ts,el,tl,ol,Uo,nl,os,sl,al,Ka,mt,Wt,Zs,Vo,rl,Ks,dl,Ya,ft,Xo,il,Ys,ll,er,_t,Jo,cl,ea,hl,tr,gt,Zo,pl,ta,ul,or,bt,Ko,ml,oa,fl,nr,Tt,Yo,_l,na,gl,sr,vt,en,bl,sa,Tl,ar,kt,tn,vl,aa,kl,rr,wt,on,wl,ra,yl,dr,yt,Rt,da,nn,El,ia,Ll,ir,Ee,sn,ql,an,$l,ns,Dl,Fl,zl,rn,xl,dn,Ml,Sl,Ol,xe,ln,Cl,Et,jl,ss,Al,Pl,la,Nl,Il,Gl,Ut,Bl,Vt,lr,Lt,Xt,ca,cn,Ql,ha,Hl,cr,Le,hn,Wl,pn,Rl,as,Ul,Vl,Xl,un,Jl,mn,Zl,Kl,Yl,fe,fn,ec,qt,tc,rs,oc,nc,pa,sc,ac,rc,Jt,dc,Zt,ic,Kt,hr,$t,Yt,ua,_n,lc,ma,cc,pr,ie,gn,hc,fa,pc,uc,bn,mc,ds,fc,_c,gc,Tn,bc,vn,Tc,vc,kc,B,kn,wc,Dt,yc,is,Ec,Lc,_a,qc,$c,Dc,eo,Fc,to,zc,oo,xc,no,Mc,so,ur,Ft,ao,ga,wn,Sc,ba,Oc,mr,le,yn,Cc,zt,jc,Ta,Ac,Pc,va,Nc,Ic,Gc,En,Bc,ls,Qc,Hc,Wc,Ln,Rc,qn,Uc,Vc,Xc,_e,$n,Jc,xt,Zc,cs,Kc,Yc,ka,eh,th,oh,ro,nh,io,sh,lo,fr,Mt,co,wa,Dn,ah,ya,rh,_r,ce,Fn,dh,zn,ih,hs,lh,ch,hh,xn,ph,Mn,uh,mh,fh,ho,_h,Me,Sn,gh,St,bh,ps,Th,vh,Ea,kh,wh,yh,po,Eh,uo,gr,Ot,mo,La,On,Lh,qa,qh,br,he,Cn,$h,jn,Dh,us,Fh,zh,xh,An,Mh,Pn,Sh,Oh,Ch,fo,jh,Se,Nn,Ah,Ct,Ph,ms,Nh,Ih,$a,Gh,Bh,Qh,_o,Hh,go,Tr;return i=new Oe({}),ee=new Oe({}),Mo=new Oe({}),So=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/configuration_led.py#L31"}}),Pt=new Ce({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Vu]},$$scope:{ctx:$}}}),Co=new Oe({}),jo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/tokenization_led.py#L43"}}),Po=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/modeling_tf_led.py#L1411"}}),on=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/pr_18154/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18154/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18154/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/modeling_led.py#L2201",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18154/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18154/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/modeling_led.py#L2341",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18154/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/modeling_led.py#L2503",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18154/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/modeling_led.py#L2630",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18154/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
configuration. Check out the <a href="/docs/transformers/pr_18154/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/modeling_tf_led.py#L2235"}}),ho=new qo({props:{$$slots:{default:[im]},$$scope:{ctx:$}}}),Sn=new x({props:{name:"call",anchor:"transformers.TFLEDModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput, NoneType] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLEDModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18154/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18154/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18154/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/modeling_tf_led.py#L2247",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18154/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18154/src/transformers/models/led/modeling_tf_led.py#L2358",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18154/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
Beltagy, Matthew E. Peters, Arman Cohan.`),j=c(),ue=a("p"),oe=n("The abstract from the paper is the following:"),$e=c(),me=a("p"),U=a("em"),Ge=n(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
dataset.`),De=c(),C=a("p"),Be=n("Tips:"),K=c(),M=a("ul"),S=a("li"),G=a("a"),Qe=n("LEDForConditionalGeneration"),He=n(` is an extension of
...
flag can be used to disable the caching mechanism to save memory.`),Bd=c(),$o=a("li"),Qd=n("A notebook showing how to evaluate LED, can be accessed "),Do=a("a"),Hd=n("here"),Wd=n("."),Rd=c(),Fo=a("li"),Ud=n("A notebook showing how to fine-tune LED, can be accessed "),zo=a("a"),Vd=n("here"),Xd=n("."),Wa=c(),jt=a("p"),Jd=n("This model was contributed by "),xo=a("a"),Zd=n("patrickvonplaten"),Kd=n("."),Ra=c(),lt=a("h2"),At=a("a"),Ps=a("span"),v(Mo.$$.fragment),Yd=c(),Ns=a("span"),ei=n("LEDConfig"),Ua=c(),we=a("div"),v(So.$$.fragment),ti=c(),ct=a("p"),oi=n("This is the configuration class to store the configuration of a "),Wn=a("a"),ni=n("LEDModel"),si=n(`. It is used to instantiate an LED
...
documentation from `),Un=a("a"),hi=n("PretrainedConfig"),pi=n(" for more information."),ui=c(),v(Pt.$$.fragment),Va=c(),pt=a("h2"),Nt=a("a"),Is=a("span"),v(Co.$$.fragment),mi=c(),Gs=a("span"),fi=n("LEDTokenizer"),Xa=c(),A=a("div"),v(jo.$$.fragment),_i=c(),Bs=a("p"),gi=n("Construct a LED tokenizer."),bi=c(),It=a("p"),Vn=a("a"),Ti=n("LEDTokenizer"),vi=n(" is identical to "),Xn=a("a"),ki=n("BartTokenizer"),wi=n(` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),zi=c(),No=a("ul"),Zn=a("li"),xi=n("single sequence: "),Hs=a("code"),Mi=n("<s> X </s>"),Si=c(),Kn=a("li"),Oi=n("pair of sequences: "),Ws=a("code"),Ci=n("<s> A </s></s> B </s>"),ji=c(),Gt=a("div"),v(Io.$$.fragment),Ai=c(),Go=a("p"),Pi=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Rs=a("code"),Ni=n("prepare_for_model"),Ii=n(" method."),Gi=c(),Bt=a("div"),v(Bo.$$.fragment),Bi=c(),Us=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ol=c(),xe=a("div"),v(ln.$$.fragment),Cl=c(),Et=a("p"),jl=n("The "),ss=a("a"),Al=n("LEDModel"),Pl=n(" forward method, overrides the "),la=a("code"),Nl=n("__call__"),Il=n(" special method."),Gl=c(),v(Ut.$$.fragment),Bl=c(),v(Vt.$$.fragment),lr=c(),Lt=a("h2"),Xt=a("a"),ca=a("span"),v(cn.$$.fragment),Ql=c(),ha=a("span"),Hl=n("LEDForConditionalGeneration"),cr=c(),Le=a("div"),v(hn.$$.fragment),Wl=c(),pn=a("p"),Rl=n(`The LED Model with a language modeling head. Can be used for summarization.
...
on top of the hidden-states output to compute `),Ta=a("code"),Ac=n("span start logits"),Pc=n(" and "),va=a("code"),Nc=n("span end logits"),Ic=n(")."),Gc=c(),En=a("p"),Bc=n("This model inherits from "),ls=a("a"),Qc=n("PreTrainedModel"),Hc=n(`. See the superclass documentation for the generic methods the library
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ch=c(),v(fo.$$.fragment),jh=c(),Se=a("div"),v(Nn.$$.fragment),Ah=c(),Ct=a("p"),Ph=n("The "),ms=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),$a=a("code"),Gh=n("__call__"),Bh=n(" special method."),Qh=c(),v(_o.$$.fragment),Hh=c(),v(go.$$.fragment),this.h()},l(o){const _=Ru('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),p=r(o,"H1",{class:!0});var In=d(p);u=r(In,"A",{id:!0,class:!0,href:!0});var Da=d(u);T=r(Da,"SPAN",{});var Fa=d(T);k(i.$$.fragment,Fa),Fa.forEach(t),Da.forEach(t),f=h(In),D=r(In,"SPAN",{});var za=d(D);Pe=s(za,"LED"),za.forEach(t),In.forEach(t),pe=h(o),F=r(o,"H2",{class:!0});var Gn=d(F);Z=r(Gn,"A",{id:!0,class:!0,href:!0});var xa=d(Z);H=r(xa,"SPAN",{});var Ma=d(H);k(ee.$$.fragment,Ma),Ma.forEach(t),xa.forEach(t),Ne=h(Gn),W=r(Gn,"SPAN",{});var Sa=d(W);Ie=s(Sa,"Overview"),Sa.forEach(t),Gn.forEach(t),qe=h(o),I=r(o,"P",{});var Bn=d(I);R=s(Bn,"The LED model was proposed in "),te=r(Bn,"A",{href:!0,rel:!0});var Oa=d(te);Te=s(Oa,"Longformer: The Long-Document Transformer"),Oa.forEach(t),O=s(Bn,` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),Bn.forEach(t),j=h(o),ue=r(o,"P",{});var Ca=d(ue);oe=s(Ca,"The abstract from the paper is the following:"),Ca.forEach(t),$e=h(o),me=r(o,"P",{});var ja=d(me);U=r(ja,"EM",{});var Aa=d(U);Ge=s(Aa,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
WikiHop and TriviaQA. We finally introduce the Longformer-Encoder-Decoder (LED), a Longformer variant for supporting
long document generative sequence-to-sequence tasks, and demonstrate its effectiveness on the arXiv summarization
dataset.`),Aa.forEach(t),ja.forEach(t),De=h(o),C=r(o,"P",{});var Pa=d(C);Be=s(Pa,"Tips:"),Pa.forEach(t),K=h(o),M=r(o,"UL",{});var J=d(M);S=r(J,"LI",{});var Q=d(S);G=r(Q,"A",{href:!0});var Na=d(G);Qe=s(Na,"LEDForConditionalGeneration"),Na.forEach(t),He=s(Q,` is an extension of
`),P=r(Q,"A",{href:!0});var Ia=d(P);We=s(Ia,"BartForConditionalGeneration"),Ia.forEach(t),ne=s(Q," exchanging the traditional "),ve=r(Q,"EM",{});var Ga=d(ve);q=s(Ga,"self-attention"),Ga.forEach(t),z=s(Q,` layer with
`),se=r(Q,"EM",{});var Ba=d(se);nt=s(Ba,"Longformer"),Ba.forEach(t),st=s(Q,"\u2019s "),N=r(Q,"EM",{});var Uh=d(N);at=s(Uh,"chunked self-attention"),Uh.forEach(t),rt=s(Q," layer. "),Fe=r(Q,"A",{href:!0});var Vh=d(Fe);V=s(Vh,"LEDTokenizer"),Vh.forEach(t),ae=s(Q,` is an alias of
...
special tokens using the tokenizer `),Rs=r(Dr,"CODE",{});var xp=d(Rs);Ni=s(xp,"prepare_for_model"),xp.forEach(t),Ii=s(Dr," method."),Dr.forEach(t),$r.forEach(t),Gi=h(Y),Bt=r(Y,"DIV",{class:!0});var Fr=d(Bt);k(Bo.$$.fragment,Fr),Bi=h(Fr),Us=r(Fr,"P",{});var Mp=d(Us);Qi=s(Mp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
...
decoding.`),Jp.forEach(t),Ir.forEach(t),rr=h(o),wt=r(o,"DIV",{class:!0});var Gr=d(wt);k(on.$$.fragment,Gr),wl=h(Gr),ra=r(Gr,"P",{});var Zp=d(ra);yl=s(Zp,"Base class for sequence-to-sequence language models outputs."),Zp.forEach(t),Gr.forEach(t),dr=h(o),yt=r(o,"H2",{class:!0});var Br=d(yt);Rt=r(Br,"A",{id:!0,class:!0,href:!0});var Kp=d(Rt);da=r(Kp,"SPAN",{});var Yp=d(da);k(nn.$$.fragment,Yp),Yp.forEach(t),Kp.forEach(t),El=h(Br),ia=r(Br,"SPAN",{});var eu=d(ia);Ll=s(eu,"LEDModel"),eu.forEach(t),Br.forEach(t),ir=h(o),Ee=r(o,"DIV",{class:!0});var ko=d(Ee);k(sn.$$.fragment,ko),ql=h(ko),an=r(ko,"P",{});var Qr=d(an);$l=s(Qr,`The bare LED Model outputting raw hidden-states without any specific head on top.
