...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17713/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17713/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17713/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_17713/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17713/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17713/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17713/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17713/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17713/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17713/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
behavior.`),f1=p(),T(ns.$$.fragment),u1=p(),Rt=n("div"),T(Nr.$$.fragment),g1=p(),Oo=n("p"),_1=r("The "),vd=n("a"),b1=r("TFRobertaModel"),k1=r(" forward method, overrides the "),up=n("code"),v1=r("__call__"),T1=r(" special method."),y1=p(),T(ss.$$.fragment),w1=p(),T(as.$$.fragment),ff=p(),No=n("h2"),rs=n("a"),gp=n("span"),T(Ir.$$.fragment),$1=p(),_p=n("span"),F1=r("TFRobertaForCausalLM"),uf=p(),Io=n("div"),T(Dr.$$.fragment),x1=p(),Mt=n("div"),T(Sr.$$.fragment),R1=p(),Do=n("p"),M1=r("The "),Td=n("a"),E1=r("TFRobertaForCausalLM"),z1=r(" forward method, overrides the "),bp=n("code"),C1=r("__call__"),q1=r(" special method."),j1=p(),T(is.$$.fragment),P1=p(),T(ls.$$.fragment),gf=p(),So=n("h2"),ds=n("a"),kp=n("span"),T(Wr.$$.fragment),L1=p(),vp=n("span"),A1=r("TFRobertaForMaskedLM"),_f=p(),Ve=n("div"),T(Br.$$.fragment),O1=p(),Ur=n("p"),N1=r("RoBERTa Model with a "),Tp=n("code"),I1=r("language modeling"),D1=r(" head on top."),S1=p(),Hr=n("p"),W1=r("This model inherits from "),yd=n("a"),B1=r("TFPreTrainedModel"),U1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),H1=p(),Qr=n("p"),Q1=r("This model is also a "),Vr=n("a"),V1=r("tf.keras.Model"),J1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),K1=p(),T(cs.$$.fragment),G1=p(),ct=n("div"),T(Jr.$$.fragment),X1=p(),Wo=n("p"),Y1=r("The "),wd=n("a"),Z1=r("TFRobertaForMaskedLM"),eT=r(" forward method, overrides the "),yp=n("code"),tT=r("__call__"),oT=r(" special method."),nT=p(),T(ps.$$.fragment),sT=p(),T(hs.$$.fragment),aT=p(),T(ms.$$.fragment),bf=p(),Bo=n("h2"),fs=n("a"),wp=n("span"),T(Kr.$$.fragment),rT=p(),$p=n("span"),iT=r("TFRobertaForSequenceClassification"),kf=p(),Je=n("div"),T(Gr.$$.fragment),lT=p(),Fp=n("p"),dT=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bT=p(),T(us.$$.fragment),kT=p(),pt=n("div"),T(ei.$$.fragment),vT=p(),Uo=n("p"),TT=r("The "),Fd=n("a"),yT=r("TFRobertaForSequenceClassification"),wT=r(" forward method, overrides the "),xp=n("code"),$T=r("__call__"),FT=r(" special method."),xT=p(),T(gs.$$.fragment),RT=p(),T(_s.$$.fragment),MT=p(),T(bs.$$.fragment),vf=p(),Ho=n("h2"),ks=n("a"),Rp=n("span"),T(ti.$$.fragment),ET=p(),Mp=n("span"),zT=r("TFRobertaForMultipleChoice"),Tf=p(),Ke=n("div"),T(oi.$$.fragment),CT=p(),Ep=n("p"),qT=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ST=p(),T(vs.$$.fragment),WT=p(),Et=n("div"),T(ri.$$.fragment),BT=p(),Qo=n("p"),UT=r("The "),Rd=n("a"),HT=r("TFRobertaForMultipleChoice"),QT=r(" forward method, overrides the "),zp=n("code"),VT=r("__call__"),JT=r(" special method."),KT=p(),T(Ts.$$.fragment),GT=p(),T(ys.$$.fragment),yf=p(),Vo=n("h2"),ws=n("a"),Cp=n("span"),T(ii.$$.fragment),XT=p(),qp=n("span"),YT=r("TFRobertaForTokenClassification"),wf=p(),Ge=n("div"),T(li.$$.fragment),ZT=p(),jp=n("p"),ey=r(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dy=p(),T($s.$$.fragment),cy=p(),ht=n("div"),T(hi.$$.fragment),py=p(),Jo=n("p"),hy=r("The "),Ed=n("a"),my=r("TFRobertaForTokenClassification"),fy=r(" forward method, overrides the "),Pp=n("code"),uy=r("__call__"),gy=r(" special method."),_y=p(),T(Fs.$$.fragment),by=p(),T(xs.$$.fragment),ky=p(),T(Rs.$$.fragment),$f=p(),Ko=n("h2"),Ms=n("a"),Lp=n("span"),T(mi.$$.fragment),vy=p(),Ap=n("span"),Ty=r("TFRobertaForQuestionAnswering"),Ff=p(),Xe=n("div"),T(fi.$$.fragment),yy=p(),Go=n("p"),wy=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=n("code"),$y=r("span start logits"),Fy=r(" and "),Np=n("code"),xy=r("span end logits"),Ry=r(")."),My=p(),ui=n("p"),Ey=r("This model inherits from "),zd=n("a"),zy=r("TFPreTrainedModel"),Cy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qy=p(),gi=n("p"),jy=r("This model is also a "),_i=n("a"),Py=r("tf.keras.Model"),Ly=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ay=p(),T(Es.$$.fragment),Oy=p(),mt=n("div"),T(bi.$$.fragment),Ny=p(),Xo=n("p"),Iy=r("The "),Cd=n("a"),Dy=r("TFRobertaForQuestionAnswering"),Sy=r(" forward method, overrides the "),Ip=n("code"),Wy=r("__call__"),By=r(" special method."),Uy=p(),T(zs.$$.fragment),Hy=p(),T(Cs.$$.fragment),Qy=p(),T(qs.$$.fragment),xf=p(),Yo=n("h2"),js=n("a"),Dp=n("span"),T(ki.$$.fragment),Vy=p(),Sp=n("span"),Jy=r("FlaxRobertaModel"),Rf=p(),Oe=n("div"),T(vi.$$.fragment),Ky=p(),Wp=n("p"),Gy=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Xy=p(),Ti=n("p"),Yy=r("This model inherits from "),qd=n("a"),Zy=r("FlaxPreTrainedModel"),ew=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Aw=p(),Zp=n("p"),Ow=r("Finally, this model supports inherent JAX features such as:"),Nw=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),Iw=r("Just-In-Time (JIT) compilation"),Dw=p(),th=n("li"),Li=n("a"),Sw=r("Automatic Differentiation"),Ww=p(),oh=n("li"),Ai=n("a"),Bw=r("Vectorization"),Uw=p(),nh=n("li"),Oi=n("a"),Hw=r("Parallelization"),Qw=p(),Ct=n("div"),T(Ni.$$.fragment),Vw=p(),tn=n("p"),Jw=r("The "),sh=n("code"),Kw=r("FlaxRobertaPreTrainedModel"),Gw=r(" forward method, overrides the "),ah=n("code"),Xw=r("__call__"),Yw=r(" special method."),Zw=p(),T(Os.$$.fragment),e$=p(),T(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),T(Ii.$$.fragment),t$=p(),ih=n("span"),o$=r("FlaxRobertaForMaskedLM"),Cf=p(),Ie=n("div"),T(Di.$$.fragment),n$=p(),Si=n("p"),s$=r("RoBERTa Model with a "),lh=n("code"),a$=r("language modeling"),r$=r(" head on top."),i$=p(),Wi=n("p"),l$=r("This model inherits from "),Pd=n("a"),d$=r("FlaxPreTrainedModel"),c$=r(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),K1=h(Nt),y(cs.$$.fragment,Nt),G1=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Jr.$$.fragment,ho),X1=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Y1=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var Wx=a(wd);Z1=i(Wx,"TFRobertaForMaskedLM"),Wx.forEach(t),eT=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var Bx=a(yp);tT=i(Bx,"__call__"),Bx.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),y(ps.$$.fragment,ho),sT=h(ho),y(hs.$$.fragment,ho),aT=h(ho),y(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var Ux=a(fs);wp=s(Ux,"SPAN",{});var Hx=a(wp);y(Kr.$$.fragment,Hx),Hx.forEach(t),Ux.forEach(t),rT=h(Fu),$p=s(Fu,"SPAN",{});var Qx=a($p);iT=i(Qx,"TFRobertaForSequenceClassification"),Qx.forEach(t),Fu.forEach(t),kf=h(o),Je=s(o,"DIV",{class:!0});var It=a(Je);y(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var Vx=a(Fp);dT=i(Vx,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),y(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);yT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),y(gs.$$.fragment,mo),RT=h(mo),y(_s.$$.fragment,mo),MT=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);y(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var eR=a(Mp);zT=i(eR,"TFRobertaForMultipleChoice"),eR.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),CT=h(Dt),Ep=s(Dt,"P",{});var tR=a(Ep);qT=i(tR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sR=a(Rd);HT=i(sR,"TFRobertaForMultipleChoice"),sR.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var aR=a(zp);VT=i(aR,"__call__"),aR.forEach(t),JT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var rR=a(ws);Cp=s(rR,"SPAN",{});var iR=a(Cp);y(ii.$$.fragment,iR),iR.forEach(t),rR.forEach(t),XT=h(Cu),qp=s(Cu,"SPAN",{});var lR=a(qp);YT=i(lR,"TFRobertaForTokenClassification"),lR.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var dR=a(jp);ey=i(dR,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dR.forEach(t),ty=h(St),di=s(St,"P",{});var qu=a(di);oy=i(qu,"This model inherits from "),Md=s(qu,"A",{href:!0});var cR=a(Md);ny=i(cR,"TFPreTrainedModel"),cR.forEach(t),sy=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),ay=h(St),ci=s(St,"P",{});var ju=a(ci);ry=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var pR=a(pi);iy=i(pR,"tf.keras.Model"),pR.forEach(t),ly=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),py=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hR=a(Ed);my=i(hR,"TFRobertaForTokenClassification"),hR.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mR=a(Pp);uy=i(mR,"__call__"),mR.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),y(Fs.$$.fragment,fo),by=h(fo),y(xs.$$.fragment,fo),ky=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fR=a(Ms);Lp=s(fR,"SPAN",{});var uR=a(Lp);y(mi.$$.fragment,uR),uR.forEach(t),fR.forEach(t),vy=h(Pu),Ap=s(Pu,"SPAN",{});var gR=a(Ap);Ty=i(gR,"TFRobertaForQuestionAnswering"),gR.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _R=a(Op);$y=i(_R,"span start logits"),_R.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var bR=a(Np);xy=i(bR,"span end logits"),bR.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ey=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var kR=a(zd);zy=i(kR,"TFPreTrainedModel"),kR.forEach(t),Cy=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),qy=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jy=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var vR=a(_i);Py=i(vR,"tf.keras.Model"),vR.forEach(t),Ly=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),Cd=s(nc,"A",{href:!0});var TR=a(Cd);Dy=i(TR,"TFRobertaForQuestionAnswering"),TR.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yR=a(Ip);Wy=i(yR,"__call__"),yR.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),y(zs.$$.fragment,uo),Hy=h(uo),y(Cs.$$.fragment,uo),Qy=h(uo),y(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wR=a(js);Dp=s(wR,"SPAN",{});var $R=a(Dp);y(ki.$$.fragment,$R),$R.forEach(t),wR.forEach(t),Vy=h(Ou),Sp=s(Ou,"SPAN",{});var FR=a(Sp);Jy=i(FR,"FlaxRobertaModel"),FR.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var xR=a(Wp);Gy=i(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yy=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var RR=a(qd);Zy=i(RR,"FlaxPreTrainedModel"),RR.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u$=h(bt),dh=s(bt,"P",{});var d7=a(dh);g$=i(d7,"Finally, this model supports inherent JAX features such as:"),d7.forEach(t),_$=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var c7=a(ch);Hi=s(c7,"A",{href:!0,rel:!0});var p7=a(Hi);b$=i(p7,"Just-In-Time (JIT) compilation"),p7.forEach(t),c7.forEach(t),k$=h(ca),ph=s(ca,"LI",{});var h7=a(ph);Qi=s(h7,"A",{href:!0,rel:!0});var m7=a(Qi);v$=i(m7,"Automatic Differentiation"),m7.forEach(t),h7.forEach(t),T$=h(ca),hh=s(ca,"LI",{});var f7=a(hh);Vi=s(f7,"A",{href:!0,rel:!0});var u7=a(Vi);y$=i(u7,"Vectorization"),u7.forEach(t),f7.forEach(t),w$=h(ca),mh=s(ca,"LI",{});var g7=a(mh);Ji=s(g7,"A",{href:!0,rel:!0});var _7=a(Ji);$$=i(_7,"Parallelization"),_7.forEach(t),g7.forEach(t),ca.forEach(t),F$=h(bt),qt=s(bt,"DIV",{class:!0});var pa=a(qt);y(Ki.$$.fragment,pa),x$=h(pa),nn=s(pa,"P",{});var rc=a(nn);R$=i(rc,"The "),fh=s(rc,"CODE",{});var b7=a(fh);M$=i(b7,"FlaxRobertaPreTrainedModel"),b7.forEach(t),E$=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var k7=a(uh);z$=i(k7,"__call__"),k7.forEach(t),C$=i(rc," special method."),rc.forEach(t),q$=h(pa),y(Ds.$$.fragment,pa),j$=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qf=h(o),sn=s(o,"H2",{class:!0});var Vu=a(sn);Ws=s(Vu,"A",{id:!0,class:!0,href:!0});var v7=a(Ws);gh=s(v7,"SPAN",{});var T7=a(gh);y(Gi.$$.fragment,T7),T7.forEach(t),v7.forEach(t),P$=h(Vu),_h=s(Vu,"SPAN",{});var y7=a(_h);L$=i(y7,"FlaxRobertaForSequenceClassification"),y7.forEach(t),Vu.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A$=h(kt),bh=s(kt,"P",{});var w7=a(bh);O$=i(w7,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q$=h(kt),kh=s(kt,"P",{});var x7=a(kh);V$=i(x7,"Finally, this model supports inherent JAX features such as:"),x7.forEach(t),J$=h(kt),Vt=s(kt,"UL",{});var ha=a(Vt);vh=s(ha,"LI",{});var R7=a(vh);tl=s(R7,"A",{href:!0,rel:!0});var M7=a(tl);K$=i(M7,"Just-In-Time (JIT) compilation"),M7.forEach(t),R7.forEach(t),G$=h(ha),Th=s(ha,"LI",{});var E7=a(Th);ol=s(E7,"A",{href:!0,rel:!0});var z7=a(ol);X$=i(z7,"Automatic Differentiation"),z7.forEach(t),E7.forEach(t),Y$=h(ha),yh=s(ha,"LI",{});var C7=a(yh);nl=s(C7,"A",{href:!0,rel:!0});var q7=a(nl);Z$=i(q7,"Vectorization"),q7.forEach(t),C7.forEach(t),e2=h(ha),wh=s(ha,"LI",{});var j7=a(wh);sl=s(j7,"A",{href:!0,rel:!0});var P7=a(sl);t2=i(P7,"Parallelization"),P7.forEach(t),j7.forEach(t),ha.forEach(t),o2=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);y(al.$$.fragment,ma),n2=h(ma),an=s(ma,"P",{});var ic=a(an);s2=i(ic,"The "),$h=s(ic,"CODE",{});var L7=a($h);a2=i(L7,"FlaxRobertaPreTrainedModel"),L7.forEach(t),r2=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var A7=a(Fh);i2=i(A7,"__call__"),A7.forEach(t),l2=i(ic," special method."),ic.forEach(t),d2=h(ma),y(Bs.$$.fragment,ma),c2=h(ma),y(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var O7=a(Hs);xh=s(O7,"SPAN",{});var N7=a(xh);y(rl.$$.fragment,N7),N7.forEach(t),O7.forEach(t),p2=h(Gu),Rh=s(Gu,"SPAN",{});var I7=a(Rh);h2=i(I7,"FlaxRobertaForMultipleChoice"),I7.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),m2=h(vt),Mh=s(vt,"P",{});var D7=a(Mh);f2=i(D7,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
