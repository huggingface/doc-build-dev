...
find more details in the discussion below.`),nw=u(),Nt=o("p"),W6=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F6=a("post"),V6=a("."),ow=u(),mi=o("p"),Y6=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),lw=u(),_i=o("p"),K6=a("Notes:"),rw=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J6=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=o("code"),X6=a("CUDA_VISIBLE_DEVICES"),Q6=a(` to limit
...
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var LL=r(qo);Q4=n(LL,"here"),LL.forEach(t),e6=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var ML=r(pi);s6=n(ML,"Therefore, if your original command line looked as follows:"),ML.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ZL=r(ii);t6=n(ZL,"Now it should be:"),ZL.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var we=r(U);a6=n(we,"Unlike, "),If=l(we,"CODE",{});var NL=r(If);n6=n(NL,"torch.distributed.launch"),NL.forEach(t),o6=n(we," where you have to specify how many GPUs to use with "),Uf=l(we,"CODE",{});var HL=r(Uf);l6=n(HL,"--nproc_per_node"),HL.forEach(t),r6=n(we,`, with the
`),Gf=l(we,"CODE",{});var BL=r(Gf);p6=n(BL,"deepspeed"),BL.forEach(t),i6=n(we," launcher you don\u2019t have to use the corresponding "),Lf=l(we,"CODE",{});var WL=r(Lf);u6=n(WL,"--num_gpus"),WL.forEach(t),c6=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=l(we,"A",{href:!0,rel:!0});var FL=r(Po);h6=n(FL,"here"),FL.forEach(t),f6=n(we,"."),we.forEach(t),Ng=c(e),ne=l(e,"P",{});var Zn=r(ne);d6=n(Zn,"In fact, you can continue using "),Mf=l(Zn,"CODE",{});var VL=r(Mf);m6=n(VL,"-m torch.distributed.launch"),VL.forEach(t),_6=n(Zn,` with DeepSpeed as long as you don\u2019t need to use
...
bigger models and data batches.`),pM.forEach(t),qE.forEach(t),sw=c(e),fi=l(e,"P",{});var iM=r(fi);H6=n(iM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),iM.forEach(t),tw=c(e),d(So.$$.fragment,e),aw=c(e),di=l(e,"P",{});var uM=r(di);B6=n(uM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),uM.forEach(t),nw=c(e),Nt=l(e,"P",{});var $E=r(Nt);W6=n($E,"For a practical usage example of this type of deployment, please, see this "),Co=l($E,"A",{href:!0,rel:!0});var cM=r(Co);F6=n(cM,"post"),cM.forEach(t),V6=n($E,"."),$E.forEach(t),ow=c(e),mi=l(e,"P",{});var hM=r(mi);Y6=n(hM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),hM.forEach(t),lw=c(e),_i=l(e,"P",{});var fM=r(_i);K6=n(fM,"Notes:"),fM.forEach(t),rw=c(e),vi=l(e,"UL",{});var dM=r(vi);Os=l(dM,"LI",{});var mh=r(Os);xo=l(mh,"P",{});var kE=r(xo);J6=n(kE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=l(kE,"CODE",{});var mM=r(Jf);X6=n(mM,"CUDA_VISIBLE_DEVICES"),mM.forEach(t),Q6=n(kE,` to limit
