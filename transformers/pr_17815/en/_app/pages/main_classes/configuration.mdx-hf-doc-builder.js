import{S as Es,i as xs,s as Ts,e as n,k as d,w as y,t as o,M as Ds,c as a,d as t,m as l,a as s,x as w,h as r,b as g,G as e,g as x,y as $,q as k,o as P,B as C,v as js,L as Ps}from"../../chunks/vendor-hf-doc-builder.js";import{T as $a}from"../../chunks/Tip-hf-doc-builder.js";import{D as T}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Cs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as $s}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ks}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function zs(z){let f,b,p,u,E;return{c(){f=n("p"),b=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
...
initialize a model does `),p=a(_,"STRONG",{});var q=s(p);u=r(q,"not"),q.forEach(t),E=r(_," load the model weights. It only affects the model\u2019s configuration."),_.forEach(t)},m(c,_){x(c,f,_),e(f,b),e(f,p),e(p,u),e(f,E)},d(c){c&&t(f)}}}function As(z){let f,b,p,u,E;return u=new Cs({props:{code:`
...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&quot;foo&quot;</span>: <span class="hljs-literal">False</span>}`}}),{c(){f=n("p"),b=o("Examples:"),p=d(),y(u.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=r(_,"Examples:"),_.forEach(t),p=l(c),w(u.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,p,_),$(u,c,_),E=!0},p:Ps,i(c){E||(k(u.$$.fragment,c),E=!0)},o(c){P(u.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(p),C(u,c)}}}function Ss(z){let f,b;return{c(){f=n("p"),b=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(p){f=a(p,"P",{});var u=s(f);b=r(u,"This API is experimental and may have some slight breaking changes in the next releases."),u.forEach(t)},m(p,u){x(p,f,u),e(f,b)},d(p){p&&t(f)}}}function Fs(z){let f,b,p,u,E,c,_,q,Do,ao,H,jo,Ge,zo,Ao,so,D,Oo,dt,qo,So,lt,Fo,Io,ct,Lo,No,ft,Wo,Mo,io,U,G,mt,$e,Bo,ht,Vo,lo,m,ke,Uo,pt,Ro,Jo,X,Ho,ut,Go,Xo,S,W,gt,Ko,Qo,_t,Yo,Zo,Xe,er,tr,or,j,bt,rr,nr,vt,ar,sr,Ke,ir,dr,Qe,lr,cr,Ye,fr,mr,hr,K,yt,pr,ur,wt,gr,_r,br,Q,$t,vr,yr,kt,wr,$r,kr,Pt,Pr,Cr,F,Y,Ct,Er,xr,Et,Tr,Dr,jr,Z,xt,zr,Ar,Tt,Or,qr,Sr,ee,Dt,Fr,Ir,jt,Lr,Nr,Wr,te,zt,Mr,Br,At,Vr,Ur,Rr,M,Pe,Jr,Ce,Hr,Ot,Gr,Xr,Kr,oe,Qr,re,Ee,Yr,I,Zr,qt,en,tn,St,on,rn,Ft,nn,an,sn,ne,xe,dn,Te,ln,Ze,cn,fn,mn,ae,De,hn,je,pn,et,un,gn,_n,A,ze,bn,Ae,vn,tt,yn,wn,$n,se,kn,ie,Pn,de,Oe,Cn,L,En,It,xn,Tn,ot,Dn,jn,Lt,zn,An,On,B,qe,qn,Se,Sn,Nt,Fn,In,Ln,le,Nn,ce,Fe,Wn,R,Mn,Wt,Bn,Vn,rt,Un,Rn,Jn,fe,Ie,Hn,Mt,Gn,Xn,me,Le,Kn,Bt,Qn,Yn,he,Ne,Zn,Vt,ea,ta,pe,We,oa,Ut,ra,na,ue,Me,aa,Be,sa,Rt,ia,da,la,O,Ve,ca,Ue,fa,Jt,ma,ha,pa,J,ua,Ht,ga,_a,Gt,ba,va,ya,Xt,wa,co;return c=new $s({}),$e=new $s({}),ke=new T({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
Store the string that was passed to <a href="/docs/transformers/pr_17815/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">PreTrainedModel.from_pretrained()</a> or
<a href="/docs/transformers/pr_17815/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">TFPreTrainedModel.from_pretrained()</a> as <code>pretrained_model_name_or_path</code> if the configuration was created
...
that can be used as decoder models within the <a href="/docs/transformers/pr_17815/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
Forward Chunking work?</a>.`,name:"chunk_size_feed_forward"}],source:"https://github.com/huggingface/transformers/blob/vr_17815/src/transformers/configuration_utils.py#L54",parameterGroups:[{title:"Parameters for sequence generation",parametersDescription:`
<ul>
...
Whether the model should return a <a
  href="/docs/transformers/pr_17815/en/main_classes/output#transformers.utils.ModelOutput"
...
Path to the JSON file containing the parameters.`,name:"json_file"}],source:"https://github.com/huggingface/transformers/blob/vr_17815/src/transformers/configuration_utils.py#L714",returnDescription:`
...
<a href="/docs/transformers/pr_17815/en/main_classes/configuration#transformers.PretrainedConfig.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
...
by the <code>return_unused_kwargs</code> keyword parameter.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17815/src/transformers/configuration_utils.py#L452",returnDescription:`
...
The identifier of the pre-trained checkpoint from which we want the dictionary of parameters.`,name:"pretrained_model_name_or_path"}],source:"https://github.com/huggingface/transformers/blob/vr_17815/src/transformers/configuration_utils.py#L535",returnDescription:`
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_17815/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_17815/src/transformers/configuration_utils.py#L406"}}),Ie=new T({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17815/src/transformers/configuration_utils.py#L774",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Le=new T({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17815/src/transformers/configuration_utils.py#L742",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
...
`),ft=n("code"),Wo=o("vocab_size"),Mo=o("."),io=d(),U=n("h2"),G=n("a"),mt=n("span"),y($e.$$.fragment),Bo=d(),ht=n("span"),Vo=o("PretrainedConfig"),lo=d(),m=n("div"),y(ke.$$.fragment),Uo=d(),pt=n("p"),Ro=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Jo=d(),y(X.$$.fragment),Ho=d(),ut=n("p"),Go=o("Class attributes (overridden by derived classes):"),Xo=d(),S=n("ul"),W=n("li"),gt=n("strong"),Ko=o("model_type"),Qo=o(" ("),_t=n("code"),Yo=o("str"),Zo=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
the correct object in `),Xe=n("a"),er=o("AutoConfig"),tr=o("."),or=d(),j=n("li"),bt=n("strong"),rr=o("is_composition"),nr=o(" ("),vt=n("code"),ar=o("bool"),sr=o(`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
config has to be initialized from two or more configs of type `),Ke=n("a"),ir=o("PretrainedConfig"),dr=o(` like:
`),Qe=n("a"),lr=o("EncoderDecoderConfig"),cr=o(" or "),Ye=n("a"),fr=o("~RagConfig"),mr=o("."),hr=d(),K=n("li"),yt=n("strong"),pr=o("keys_to_ignore_at_inference"),ur=o(" ("),wt=n("code"),gr=o("List[str]"),_r=o(`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),br=d(),Q=n("li"),$t=n("strong"),vr=o("attribute_map"),yr=o(" ("),kt=n("code"),wr=o("Dict[str, str]"),$r=o(`) \u2014 A dict that maps model specific attribute names to the standardized
...
model.`),Wr=d(),te=n("li"),zt=n("strong"),Mr=o("num_hidden_layers"),Br=o(" ("),At=n("code"),Vr=o("int"),Ur=o(") \u2014 The number of blocks in the model."),Rr=d(),M=n("div"),y(Pe.$$.fragment),Jr=d(),Ce=n("p"),Hr=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),Ot=n("code"),Gr=o("repo_path_or_name"),Xr=o("."),Kr=d(),y(oe.$$.fragment),Qr=d(),re=n("div"),y(Ee.$$.fragment),Yr=d(),I=n("p"),Zr=o("Checks whether the passed dictionary and its nested dicts have a "),qt=n("em"),en=o("torch_dtype"),tn=o(` key and if it\u2019s not None,
...
string, which can then be stored in the json format.`),sn=d(),ne=n("div"),y(xe.$$.fragment),dn=d(),Te=n("p"),ln=o("Instantiates a "),Ze=n("a"),cn=o("PretrainedConfig"),fn=o(" from a Python dictionary of parameters."),mn=d(),ae=n("div"),y(De.$$.fragment),hn=d(),je=n("p"),pn=o("Instantiates a "),et=n("a"),un=o("PretrainedConfig"),gn=o(" from the path to a JSON file of parameters."),_n=d(),A=n("div"),y(ze.$$.fragment),bn=d(),Ae=n("p"),vn=o("Instantiate a "),tt=n("a"),yn=o("PretrainedConfig"),wn=o(" (or a derived class) from a pretrained model configuration."),$n=d(),y(se.$$.fragment),kn=d(),y(ie.$$.fragment),Pn=d(),de=n("div"),y(Oe.$$.fragment),Cn=d(),L=n("p"),En=o("From a "),It=n("code"),xn=o("pretrained_model_name_or_path"),Tn=o(`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=n("a"),Dn=o("PretrainedConfig"),jn=o(" using "),Lt=n("code"),zn=o("from_dict"),An=o("."),On=d(),B=n("div"),y(qe.$$.fragment),qn=d(),Se=n("p"),Sn=o(`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Nt=n("code"),Fn=o("AutoConfig"),In=o("."),Ln=d(),y(le.$$.fragment),Nn=d(),ce=n("div"),y(Fe.$$.fragment),Wn=d(),R=n("p"),Mn=o("Save a configuration object to the directory "),Wt=n("code"),Bn=o("save_directory"),Vn=o(`, so that it can be re-loaded using the
`),rt=n("a"),Un=o("from_pretrained()"),Rn=o(" class method."),Jn=d(),fe=n("div"),y(Ie.$$.fragment),Hn=d(),Mt=n("p"),Gn=o("Serializes this instance to a Python dictionary."),Xn=d(),me=n("div"),y(Le.$$.fragment),Kn=d(),Bt=n("p"),Qn=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Yn=d(),he=n("div"),y(Ne.$$.fragment),Zn=d(),Vt=n("p"),ea=o("Save this instance to a JSON file."),ta=d(),pe=n("div"),y(We.$$.fragment),oa=d(),Ut=n("p"),ra=o("Serializes this instance to a JSON string."),na=d(),ue=n("div"),y(Me.$$.fragment),aa=d(),Be=n("p"),sa=o("Updates attributes of this class with attributes from "),Rt=n("code"),ia=o("config_dict"),da=o("."),la=d(),O=n("div"),y(Ve.$$.fragment),ca=d(),Ue=n("p"),fa=o("Updates attributes of this class with attributes from "),Jt=n("code"),ma=o("update_str"),ha=o("."),pa=d(),J=n("p"),ua=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=n("code"),ga=o("true"),_a=o(" or "),Gt=n("code"),ba=o("false"),va=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),ya=d(),Xt=n("p"),wa=o("The keys to change have to already exist in the config object."),this.h()},l(i){const v=Ds('[data-svelte="svelte-1phssyn"]',document.head);f=a(v,"META",{name:!0,content:!0}),v.forEach(t),b=l(i),p=a(i,"H1",{class:!0});var Re=s(p);u=a(Re,"A",{id:!0,class:!0,href:!0});var Kt=s(u);E=a(Kt,"SPAN",{});var Qt=s(E);w(c.$$.fragment,Qt),Qt.forEach(t),Kt.forEach(t),_=l(Re),q=a(Re,"SPAN",{});var Yt=s(q);Do=r(Yt,"Configuration"),Yt.forEach(t),Re.forEach(t),ao=l(i),H=a(i,"P",{});var Je=s(H);jo=r(Je,"The base class "),Ge=a(Je,"A",{href:!0});var ka=s(Ge);zo=r(ka,"PretrainedConfig"),ka.forEach(t),Ao=r(Je,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
from HuggingFace\u2019s AWS S3 repository).`),Je.forEach(t),so=l(i),D=a(i,"P",{});var V=s(D);Oo=r(V,`Each derived config class implements model specific attributes. Common attributes present in all config classes are:
`),dt=a(V,"CODE",{});var Pa=s(dt);qo=r(Pa,"hidden_size"),Pa.forEach(t),So=r(V,", "),lt=a(V,"CODE",{});var Ca=s(lt);Fo=r(Ca,"num_attention_heads"),Ca.forEach(t),Io=r(V,", and "),ct=a(V,"CODE",{});var Ea=s(ct);Lo=r(Ea,"num_hidden_layers"),Ea.forEach(t),No=r(V,`. Text models further implement:
`),ft=a(V,"CODE",{});var xa=s(ft);Wo=r(xa,"vocab_size"),xa.forEach(t),Mo=r(V,"."),V.forEach(t),io=l(i),U=a(i,"H2",{class:!0});var fo=s(U);G=a(fo,"A",{id:!0,class:!0,href:!0});var Ta=s(G);mt=a(Ta,"SPAN",{});var Da=s(mt);w($e.$$.fragment,Da),Da.forEach(t),Ta.forEach(t),Bo=l(fo),ht=a(fo,"SPAN",{});var ja=s(ht);Vo=r(ja,"PretrainedConfig"),ja.forEach(t),fo.forEach(t),lo=l(i),m=a(i,"DIV",{class:!0});var h=s(m);w(ke.$$.fragment,h),Uo=l(h),pt=a(h,"P",{});var za=s(pt);Ro=r(za,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
the correct object in `),Xe=a(He,"A",{href:!0});var Sa=s(Xe);er=r(Sa,"AutoConfig"),Sa.forEach(t),tr=r(He,"."),He.forEach(t),or=l(ge),j=a(ge,"LI",{});var N=s(j);bt=a(N,"STRONG",{});var Fa=s(bt);rr=r(Fa,"is_composition"),Fa.forEach(t),nr=r(N," ("),vt=a(N,"CODE",{});var Ia=s(vt);ar=r(Ia,"bool"),Ia.forEach(t),sr=r(N,`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
...
`),Qe=a(N,"A",{href:!0});var Na=s(Qe);lr=r(Na,"EncoderDecoderConfig"),Na.forEach(t),cr=r(N," or "),Ye=a(N,"A",{href:!0});var Wa=s(Ye);fr=r(Wa,"~RagConfig"),Wa.forEach(t),mr=r(N,"."),N.forEach(t),hr=l(ge),K=a(ge,"LI",{});var Zt=s(K);yt=a(Zt,"STRONG",{});var Ma=s(yt);pr=r(Ma,"keys_to_ignore_at_inference"),Ma.forEach(t),ur=r(Zt," ("),wt=a(Zt,"CODE",{});var Ba=s(wt);gr=r(Ba,"List[str]"),Ba.forEach(t),_r=r(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Zt.forEach(t),br=l(ge),Q=a(ge,"LI",{});var eo=s(Q);$t=a(eo,"STRONG",{});var Va=s($t);vr=r(Va,"attribute_map"),Va.forEach(t),yr=r(eo," ("),kt=a(eo,"CODE",{});var Ua=s(kt);wr=r(Ua,"Dict[str, str]"),Ua.forEach(t),$r=r(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
naming of attributes.`),eo.forEach(t),ge.forEach(t),kr=l(h),Pt=a(h,"P",{});var Ra=s(Pt);Pr=r(Ra,"Common attributes (present in all subclasses):"),Ra.forEach(t),Cr=l(h),F=a(h,"UL",{});var _e=s(F);Y=a(_e,"LI",{});var to=s(Y);Ct=a(to,"STRONG",{});var Ja=s(Ct);Er=r(Ja,"vocab_size"),Ja.forEach(t),xr=r(to," ("),Et=a(to,"CODE",{});var Ha=s(Et);Tr=r(Ha,"int"),Ha.forEach(t),Dr=r(to,`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
...
model.`),ro.forEach(t),Wr=l(_e),te=a(_e,"LI",{});var no=s(te);zt=a(no,"STRONG",{});var Ya=s(zt);Mr=r(Ya,"num_hidden_layers"),Ya.forEach(t),Br=r(no," ("),At=a(no,"CODE",{});var Za=s(At);Vr=r(Za,"int"),Za.forEach(t),Ur=r(no,") \u2014 The number of blocks in the model."),no.forEach(t),_e.forEach(t),Rr=l(h),M=a(h,"DIV",{class:!0});var nt=s(M);w(Pe.$$.fragment,nt),Jr=l(nt),Ce=a(nt,"P",{});var mo=s(Ce);Hr=r(mo,`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
string, which can then be stored in the json format.`),be.forEach(t),ho.forEach(t),sn=l(h),ne=a(h,"DIV",{class:!0});var po=s(ne);w(xe.$$.fragment,po),dn=l(po),Te=a(po,"P",{});var uo=s(Te);ln=r(uo,"Instantiates a "),Ze=a(uo,"A",{href:!0});var ns=s(Ze);cn=r(ns,"PretrainedConfig"),ns.forEach(t),fn=r(uo," from a Python dictionary of parameters."),uo.forEach(t),po.forEach(t),mn=l(h),ae=a(h,"DIV",{class:!0});var go=s(ae);w(De.$$.fragment,go),hn=l(go),je=a(go,"P",{});var _o=s(je);pn=r(_o,"Instantiates a "),et=a(_o,"A",{href:!0});var as=s(et);un=r(as,"PretrainedConfig"),as.forEach(t),gn=r(_o," from the path to a JSON file of parameters."),_o.forEach(t),go.forEach(t),_n=l(h),A=a(h,"DIV",{class:!0});var ve=s(A);w(ze.$$.fragment,ve),bn=l(ve),Ae=a(ve,"P",{});var bo=s(Ae);vn=r(bo,"Instantiate a "),tt=a(bo,"A",{href:!0});var ss=s(tt);yn=r(ss,"PretrainedConfig"),ss.forEach(t),wn=r(bo," (or a derived class) from a pretrained model configuration."),bo.forEach(t),$n=l(ve),w(se.$$.fragment,ve),kn=l(ve),w(ie.$$.fragment,ve),ve.forEach(t),Pn=l(h),de=a(h,"DIV",{class:!0});var vo=s(de);w(Oe.$$.fragment,vo),Cn=l(vo),L=a(vo,"P",{});var ye=s(L);En=r(ye,"From a "),It=a(ye,"CODE",{});var is=s(It);xn=r(is,"pretrained_model_name_or_path"),is.forEach(t),Tn=r(ye,`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=a(ye,"A",{href:!0});var ds=s(ot);Dn=r(ds,"PretrainedConfig"),ds.forEach(t),jn=r(ye," using "),Lt=a(ye,"CODE",{});var ls=s(Lt);zn=r(ls,"from_dict"),ls.forEach(t),An=r(ye,"."),ye.forEach(t),vo.forEach(t),On=l(h),B=a(h,"DIV",{class:!0});var at=s(B);w(qe.$$.fragment,at),qn=l(at),Se=a(at,"P",{});var yo=s(Se);Sn=r(yo,`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Nt=a(yo,"CODE",{});var cs=s(Nt);Fn=r(cs,"AutoConfig"),cs.forEach(t),In=r(yo,"."),yo.forEach(t),Ln=l(at),w(le.$$.fragment,at),at.forEach(t),Nn=l(h),ce=a(h,"DIV",{class:!0});var wo=s(ce);w(Fe.$$.fragment,wo),Wn=l(wo),R=a(wo,"P",{});var st=s(R);Mn=r(st,"Save a configuration object to the directory "),Wt=a(st,"CODE",{});var fs=s(Wt);Bn=r(fs,"save_directory"),fs.forEach(t),Vn=r(st,`, so that it can be re-loaded using the
`),rt=a(st,"A",{href:!0});var ms=s(rt);Un=r(ms,"from_pretrained()"),ms.forEach(t),Rn=r(st," class method."),st.forEach(t),wo.forEach(t),Jn=l(h),fe=a(h,"DIV",{class:!0});var $o=s(fe);w(Ie.$$.fragment,$o),Hn=l($o),Mt=a($o,"P",{});var hs=s(Mt);Gn=r(hs,"Serializes this instance to a Python dictionary."),hs.forEach(t),$o.forEach(t),Xn=l(h),me=a(h,"DIV",{class:!0});var ko=s(me);w(Le.$$.fragment,ko),Kn=l(ko),Bt=a(ko,"P",{});var ps=s(Bt);Qn=r(ps,`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),ps.forEach(t),ko.forEach(t),Yn=l(h),he=a(h,"DIV",{class:!0});var Po=s(he);w(Ne.$$.fragment,Po),Zn=l(Po),Vt=a(Po,"P",{});var us=s(Vt);ea=r(us,"Save this instance to a JSON file."),us.forEach(t),Po.forEach(t),ta=l(h),pe=a(h,"DIV",{class:!0});var Co=s(pe);w(We.$$.fragment,Co),oa=l(Co),Ut=a(Co,"P",{});var gs=s(Ut);ra=r(gs,"Serializes this instance to a JSON string."),gs.forEach(t),Co.forEach(t),na=l(h),ue=a(h,"DIV",{class:!0});var Eo=s(ue);w(Me.$$.fragment,Eo),aa=l(Eo),Be=a(Eo,"P",{});var xo=s(Be);sa=r(xo,"Updates attributes of this class with attributes from "),Rt=a(xo,"CODE",{});var _s=s(Rt);ia=r(_s,"config_dict"),_s.forEach(t),da=r(xo,"."),xo.forEach(t),Eo.forEach(t),la=l(h),O=a(h,"DIV",{class:!0});var we=s(O);w(Ve.$$.fragment,we),ca=l(we),Ue=a(we,"P",{});var To=s(Ue);fa=r(To,"Updates attributes of this class with attributes from "),Jt=a(To,"CODE",{});var bs=s(Jt);ma=r(bs,"update_str"),bs.forEach(t),ha=r(To,"."),To.forEach(t),pa=l(we),J=a(we,"P",{});var it=s(J);ua=r(it,"The expected format is ints, floats and strings as is, and for booleans use "),Ht=a(it,"CODE",{});var vs=s(Ht);ga=r(vs,"true"),vs.forEach(t),_a=r(it," or "),Gt=a(it,"CODE",{});var ys=s(Gt);ba=r(ys,"false"),ys.forEach(t),va=r(it,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),it.forEach(t),ya=l(we),Xt=a(we,"P",{});var ws=s(Xt);wa=r(ws,"The keys to change have to already exist in the config object."),ws.forEach(t),we.forEach(t),h.forEach(t),this.h()},h(){g(f,"name","hf:doc:metadata"),g(f,"content",JSON.stringify(Is)),g(u,"id","configuration"),g(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(u,"href","#configuration"),g(p,"class","relative group"),g(Ge,"href","/docs/transformers/pr_17815/en/main_classes/configuration#transformers.PretrainedConfig"),g(G,"id","transformers.PretrainedConfig"),g(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(G,"href","#transformers.PretrainedConfig"),g(U,"class","relative group"),g(Xe,"href","/docs/transformers/pr_17815/en/model_doc/auto#transformers.AutoConfig"),g(Ke,"href","/docs/transformers/pr_17815/en/main_classes/configuration#transformers.PretrainedConfig"),g(Qe,"href","/docs/transformers/pr_17815/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),g(Ye,"href","/docs/transformers/pr_17815/en/model_doc/rag#transformers.RagConfig"),g(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ze,"href","/docs/transformers/pr_17815/en/main_classes/configuration#transformers.PretrainedConfig"),g(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(et,"href","/docs/transformers/pr_17815/en/main_classes/configuration#transformers.PretrainedConfig"),g(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(tt,"href","/docs/transformers/pr_17815/en/main_classes/configuration#transformers.PretrainedConfig"),g(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ot,"href","/docs/transformers/pr_17815/en/main_classes/configuration#transformers.PretrainedConfig"),g(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(rt,"href","/docs/transformers/pr_17815/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),g(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(m,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,v){e(document.head,f),x(i,b,v),x(i,p,v),e(p,u),e(u,E),$(c,E,null),e(p,_),e(p,q),e(q,Do),x(i,ao,v),x(i,H,v),e(H,jo),e(H,Ge),e(Ge,zo),e(H,Ao),x(i,so,v),x(i,D,v),e(D,Oo),e(D,dt),e(dt,qo),e(D,So),e(D,lt),e(lt,Fo),e(D,Io),e(D,ct),e(ct,Lo),e(D,No),e(D,ft),e(ft,Wo),e(D,Mo),x(i,io,v),x(i,U,v),e(U,G),e(G,mt),$($e,mt,null),e(U,Bo),e(U,ht),e(ht,Vo),x(i,lo,v),x(i,m,v),$(ke,m,null),e(m,Uo),e(m,pt),e(pt,Ro),e(m,Jo),$(X,m,null),e(m,Ho),e(m,ut),e(ut,Go),e(m,Xo),e(m,S),e(S,W),e(W,gt),e(gt,Ko),e(W,Qo),e(W,_t),e(_t,Yo),e(W,Zo),e(W,Xe),e(Xe,er),e(W,tr),e(S,or),e(S,j),e(j,bt),e(bt,rr),e(j,nr),e(j,vt),e(vt,ar),e(j,sr),e(j,Ke),e(Ke,ir),e(j,dr),e(j,Qe),e(Qe,lr),e(j,cr),e(j,Ye),e(Ye,fr),e(j,mr),e(S,hr),e(S,K),e(K,yt),e(yt,pr),e(K,ur),e(K,wt),e(wt,gr),e(K,_r),e(S,br),e(S,Q),e(Q,$t),e($t,vr),e(Q,yr),e(Q,kt),e(kt,wr),e(Q,$r),e(m,kr),e(m,Pt),e(Pt,Pr),e(m,Cr),e(m,F),e(F,Y),e(Y,Ct),e(Ct,Er),e(Y,xr),e(Y,Et),e(Et,Tr),e(Y,Dr),e(F,jr),e(F,Z),e(Z,xt),e(xt,zr),e(Z,Ar),e(Z,Tt),e(Tt,Or),e(Z,qr),e(F,Sr),e(F,ee),e(ee,Dt),e(Dt,Fr),e(ee,Ir),e(ee,jt),e(jt,Lr),e(ee,Nr),e(F,Wr),e(F,te),e(te,zt),e(zt,Mr),e(te,Br),e(te,At),e(At,Vr),e(te,Ur),e(m,Rr),e(m,M),$(Pe,M,null),e(M,Jr),e(M,Ce),e(Ce,Hr),e(Ce,Ot),e(Ot,Gr),e(Ce,Xr),e(M,Kr),$(oe,M,null),e(m,Qr),e(m,re),$(Ee,re,null),e(re,Yr),e(re,I),e(I,Zr),e(I,qt),e(qt,en),e(I,tn),e(I,St),e(St,on),e(I,rn),e(I,Ft),e(Ft,nn),e(I,an),e(m,sn),e(m,ne),$(xe,ne,null),e(ne,dn),e(ne,Te),e(Te,ln),e(Te,Ze),e(Ze,cn),e(Te,fn),e(m,mn),e(m,ae),$(De,ae,null),e(ae,hn),e(ae,je),e(je,pn),e(je,et),e(et,un),e(je,gn),e(m,_n),e(m,A),$(ze,A,null),e(A,bn),e(A,Ae),e(Ae,vn),e(Ae,tt),e(tt,yn),e(Ae,wn),e(A,$n),$(se,A,null),e(A,kn),$(ie,A,null),e(m,Pn),e(m,de),$(Oe,de,null),e(de,Cn),e(de,L),e(L,En),e(L,It),e(It,xn),e(L,Tn),e(L,ot),e(ot,Dn),e(L,jn),e(L,Lt),e(Lt,zn),e(L,An),e(m,On),e(m,B),$(qe,B,null),e(B,qn),e(B,Se),e(Se,Sn),e(Se,Nt),e(Nt,Fn),e(Se,In),e(B,Ln),$(le,B,null),e(m,Nn),e(m,ce),$(Fe,ce,null),e(ce,Wn),e(ce,R),e(R,Mn),e(R,Wt),e(Wt,Bn),e(R,Vn),e(R,rt),e(rt,Un),e(R,Rn),e(m,Jn),e(m,fe),$(Ie,fe,null),e(fe,Hn),e(fe,Mt),e(Mt,Gn),e(m,Xn),e(m,me),$(Le,me,null),e(me,Kn),e(me,Bt),e(Bt,Qn),e(m,Yn),e(m,he),$(Ne,he,null),e(he,Zn),e(he,Vt),e(Vt,ea),e(m,ta),e(m,pe),$(We,pe,null),e(pe,oa),e(pe,Ut),e(Ut,ra),e(m,na),e(m,ue),$(Me,ue,null),e(ue,aa),e(ue,Be),e(Be,sa),e(Be,Rt),e(Rt,ia),e(Be,da),e(m,la),e(m,O),$(Ve,O,null),e(O,ca),e(O,Ue),e(Ue,fa),e(Ue,Jt),e(Jt,ma),e(Ue,ha),e(O,pa),e(O,J),e(J,ua),e(J,Ht),e(Ht,ga),e(J,_a),e(J,Gt),e(Gt,ba),e(J,va),e(O,ya),e(O,Xt),e(Xt,wa),co=!0},p(i,[v]){const Re={};v&2&&(Re.$$scope={dirty:v,ctx:i}),X.$set(Re);const Kt={};v&2&&(Kt.$$scope={dirty:v,ctx:i}),oe.$set(Kt);const Qt={};v&2&&(Qt.$$scope={dirty:v,ctx:i}),se.$set(Qt);const Yt={};v&2&&(Yt.$$scope={dirty:v,ctx:i}),ie.$set(Yt);const Je={};v&2&&(Je.$$scope={dirty:v,ctx:i}),le.$set(Je)},i(i){co||(k(c.$$.fragment,i),k($e.$$.fragment,i),k(ke.$$.fragment,i),k(X.$$.fragment,i),k(Pe.$$.fragment,i),k(oe.$$.fragment,i),k(Ee.$$.fragment,i),k(xe.$$.fragment,i),k(De.$$.fragment,i),k(ze.$$.fragment,i),k(se.$$.fragment,i),k(ie.$$.fragment,i),k(Oe.$$.fragment,i),k(qe.$$.fragment,i),k(le.$$.fragment,i),k(Fe.$$.fragment,i),k(Ie.$$.fragment,i),k(Le.$$.fragment,i),k(Ne.$$.fragment,i),k(We.$$.fragment,i),k(Me.$$.fragment,i),k(Ve.$$.fragment,i),co=!0)},o(i){P(c.$$.fragment,i),P($e.$$.fragment,i),P(ke.$$.fragment,i),P(X.$$.fragment,i),P(Pe.$$.fragment,i),P(oe.$$.fragment,i),P(Ee.$$.fragment,i),P(xe.$$.fragment,i),P(De.$$.fragment,i),P(ze.$$.fragment,i),P(se.$$.fragment,i),P(ie.$$.fragment,i),P(Oe.$$.fragment,i),P(qe.$$.fragment,i),P(le.$$.fragment,i),P(Fe.$$.fragment,i),P(Ie.$$.fragment,i),P(Le.$$.fragment,i),P(Ne.$$.fragment,i),P(We.$$.fragment,i),P(Me.$$.fragment,i),P(Ve.$$.fragment,i),co=!1},d(i){t(f),i&&t(b),i&&t(p),C(c),i&&t(ao),i&&t(H),i&&t(so),i&&t(D),i&&t(io),i&&t(U),C($e),i&&t(lo),i&&t(m),C(ke),C(X),C(Pe),C(oe),C(Ee),C(xe),C(De),C(ze),C(se),C(ie),C(Oe),C(qe),C(le),C(Fe),C(Ie),C(Le),C(Ne),C(We),C(Me),C(Ve)}}}const Is={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Ls(z){return js(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Rs extends Es{constructor(f){super();xs(this,f,Ls,Fs,Ts,{})}}export{Rs as default,Is as metadata};
