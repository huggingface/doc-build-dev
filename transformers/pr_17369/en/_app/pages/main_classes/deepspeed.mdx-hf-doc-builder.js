...
`),Pi=o("a"),e9=a("Trainer"),s9=a(" via "),Di=o("a"),t9=a("TrainingArguments"),a9=a(" then for the "),md=o("code"),n9=a("deepspeed"),o9=a(` argument you can
pass a nested `),_d=o("code"),l9=a("dict"),r9=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=o("a"),p9=a("TrainingArguments"),i9=a("."),Uy=u(),Oi=o("p"),u9=a("To summarize you can do:"),Gy=u(),f(Ko.$$.fragment),Ly=u(),Ti=o("p"),c9=a("or:"),My=u(),f(Jo.$$.fragment),Zy=u(),Ai=o("a"),Ny=u(),Cs=o("h3"),ta=o("a"),vd=o("span"),f(Xo.$$.fragment),h9=u(),jd=o("span"),f9=a("Shared Configuration"),Hy=u(),f(aa.$$.fragment),By=u(),Me=o("p"),d9=a("Some configuration values are required by both the "),Si=o("a"),m9=a("Trainer"),_9=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),v9=a("Trainer"),j9=a(" command line arguments."),Wy=u(),na=o("p"),g9=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),y9=a("Trainer"),w9=a(` do the majority
of configuration for you.`),Fy=u(),Ze=o("p"),b9=a("Therefore, in the rest of this guide you will find a special configuration value: "),gd=o("code"),E9=a("auto"),q9=a(`, which when set will be
...
`),Ri=o("a"),$9=a("Trainer"),k9=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),Vy=u(),Ii=o("p"),P9=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Yy=u(),oa=o("p"),D9=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),z9=a("TrainingArguments"),O9=a(" based on that. The steps are:"),Ky=u(),la=o("ol"),yd=o("li"),T9=a("Create or load the DeepSpeed configuration to be used as a master configuration"),A9=u(),Qo=o("li"),S9=a("Create the "),Gi=o("a"),C9=a("TrainingArguments"),x9=a(" object based on these values"),Jy=u(),le=o("p"),R9=a("Do note that some values, such as "),wd=o("code"),I9=a("scheduler.params.total_num_steps"),U9=a(` are calculated by
`),Li=o("a"),G9=a("Trainer"),L9=a(" during "),bd=o("code"),M9=a("train"),Z9=a(", but you can of course do the math yourself."),Xy=u(),Mi=o("a"),Qy=u(),xs=o("h3"),ra=o("a"),Ed=o("span"),f(el.$$.fragment),N9=u(),qd=o("span"),H9=a("ZeRO"),ew=u(),sl=o("p"),tl=o("a"),B9=a("Zero Redundancy Optimizer (ZeRO)"),W9=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sw=u(),Ne=o("p"),F9=a("The "),$d=o("code"),V9=a("zero_optimization"),Y9=a(" section of the configuration file is the most important part ("),al=o("a"),K9=a("docs"),J9=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),tw=u(),pa=o("p"),X9=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q9=a("Trainer"),e8=a(` provides
...
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(we,"A",{href:!0});var BM=r(Pi);e9=n(BM,"Trainer"),BM.forEach(t),s9=n(we," via "),Di=l(we,"A",{href:!0});var WM=r(Di);t9=n(WM,"TrainingArguments"),WM.forEach(t),a9=n(we," then for the "),md=l(we,"CODE",{});var FM=r(md);n9=n(FM,"deepspeed"),FM.forEach(t),o9=n(we,` argument you can
pass a nested `),_d=l(we,"CODE",{});var VM=r(_d);l9=n(VM,"dict"),VM.forEach(t),r9=n(we,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(we,"A",{href:!0});var YM=r(zi);p9=n(YM,"TrainingArguments"),YM.forEach(t),i9=n(we,"."),we.forEach(t),Uy=c(e),Oi=l(e,"P",{});var KM=r(Oi);u9=n(KM,"To summarize you can do:"),KM.forEach(t),Gy=c(e),d(Ko.$$.fragment,e),Ly=c(e),Ti=l(e,"P",{});var JM=r(Ti);c9=n(JM,"or:"),JM.forEach(t),My=c(e),d(Jo.$$.fragment,e),Zy=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Ny=c(e),Cs=l(e,"H3",{class:!0});var GE=r(Cs);ta=l(GE,"A",{id:!0,class:!0,href:!0});var XM=r(ta);vd=l(XM,"SPAN",{});var QM=r(vd);d(Xo.$$.fragment,QM),QM.forEach(t),XM.forEach(t),h9=c(GE),jd=l(GE,"SPAN",{});var eZ=r(jd);f9=n(eZ,"Shared Configuration"),eZ.forEach(t),GE.forEach(t),Hy=c(e),d(aa.$$.fragment,e),By=c(e),Me=l(e,"P",{});var vh=r(Me);d9=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var sZ=r(Si);m9=n(sZ,"Trainer"),sZ.forEach(t),_9=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var tZ=r(Ci);v9=n(tZ,"Trainer"),tZ.forEach(t),j9=n(vh," command line arguments."),vh.forEach(t),Wy=c(e),na=l(e,"P",{});var LE=r(na);g9=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var aZ=r(xi);y9=n(aZ,"Trainer"),aZ.forEach(t),w9=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fy=c(e),Ze=l(e,"P",{});var jh=r(Ze);b9=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),gd=l(jh,"CODE",{});var nZ=r(gd);E9=n(nZ,"auto"),nZ.forEach(t),q9=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),Ri=l(jh,"A",{href:!0});var oZ=r(Ri);$9=n(oZ,"Trainer"),oZ.forEach(t),k9=n(jh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vy=c(e),Ii=l(e,"P",{});var lZ=r(Ii);P9=n(lZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),lZ.forEach(t),Yy=c(e),oa=l(e,"P",{});var ME=r(oa);D9=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var rZ=r(Ui);z9=n(rZ,"TrainingArguments"),rZ.forEach(t),O9=n(ME," based on that. The steps are:"),ME.forEach(t),Ky=c(e),la=l(e,"OL",{});var ZE=r(la);yd=l(ZE,"LI",{});var pZ=r(yd);T9=n(pZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),pZ.forEach(t),A9=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);S9=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var iZ=r(Gi);C9=n(iZ,"TrainingArguments"),iZ.forEach(t),x9=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jy=c(e),le=l(e,"P",{});var Hn=r(le);R9=n(Hn,"Do note that some values, such as "),wd=l(Hn,"CODE",{});var uZ=r(wd);I9=n(uZ,"scheduler.params.total_num_steps"),uZ.forEach(t),U9=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var cZ=r(Li);G9=n(cZ,"Trainer"),cZ.forEach(t),L9=n(Hn," during "),bd=l(Hn,"CODE",{});var hZ=r(bd);M9=n(hZ,"train"),hZ.forEach(t),Z9=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xy=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qy=c(e),xs=l(e,"H3",{class:!0});var HE=r(xs);ra=l(HE,"A",{id:!0,class:!0,href:!0});var fZ=r(ra);Ed=l(fZ,"SPAN",{});var dZ=r(Ed);d(el.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),N9=c(HE),qd=l(HE,"SPAN",{});var mZ=r(qd);H9=n(mZ,"ZeRO"),mZ.forEach(t),HE.forEach(t),ew=c(e),sl=l(e,"P",{});var yG=r(sl);tl=l(yG,"A",{href:!0,rel:!0});var _Z=r(tl);B9=n(_Z,"Zero Redundancy Optimizer (ZeRO)"),_Z.forEach(t),W9=n(yG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),yG.forEach(t),sw=c(e),Ne=l(e,"P",{});var gh=r(Ne);F9=n(gh,"The "),$d=l(gh,"CODE",{});var vZ=r($d);V9=n(vZ,"zero_optimization"),vZ.forEach(t),Y9=n(gh," section of the configuration file is the most important part ("),al=l(gh,"A",{href:!0,rel:!0});var jZ=r(al);K9=n(jZ,"docs"),jZ.forEach(t),J9=n(gh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),tw=c(e),pa=l(e,"P",{});var BE=r(pa);X9=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var gZ=r(Zi);Q9=n(gZ,"Trainer"),gZ.forEach(t),e8=n(BE,` provides
