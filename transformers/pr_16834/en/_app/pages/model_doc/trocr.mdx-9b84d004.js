import{S as hi,i as pi,s as mi,e as s,k as c,w as C,t as o,M as fi,c as n,d as r,m as h,a as i,x as w,h as a,b as l,N as ui,F as e,g as m,y as k,q as $,o as y,B as O,v as gi,L as ci}from"../../chunks/vendor-6b77c823.js";import{T as li}from"../../chunks/Tip-39098574.js";import{D as Z}from"../../chunks/Docstring-1088f2fb.js";import{C as Bs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as jt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as di}from"../../chunks/ExampleCodeBlock-5212b321.js";function _i(S){let f,R,u,g,T;return g=new Bs({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){f=s("p"),R=o("Example:"),u=c(),C(g.$$.fragment)},l(p){f=n(p,"P",{});var _=i(f);R=a(_,"Example:"),_.forEach(r),u=h(p),w(g.$$.fragment,p)},m(p,_){m(p,f,_),e(f,R),m(p,u,_),k(g,p,_),T=!0},p:ci,i(p){T||($(g.$$.fragment,p),T=!0)},o(p){y(g.$$.fragment,p),T=!1},d(p){p&&r(f),p&&r(u),O(g,p)}}}function vi(S){let f,R,u,g,T,p,_,D;return{c(){f=s("p"),R=o(`This class method is simply calling the feature extractor
...
methods above for more information.`),this.h()},l(j){f=n(j,"P",{});var x=i(f);R=a(x,`This class method is simply calling the feature extractor
`),u=n(x,"A",{href:!0});var L=i(u);g=a(L,"from_pretrained()"),L.forEach(r),T=a(x,` and the tokenizer
`),p=n(x,"CODE",{});var F=i(p);_=a(F,"from_pretrained"),F.forEach(r),D=a(x,` methods. Please refer to the docstrings of the
methods above for more information.`),x.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/pr_16834/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(j,x){m(j,f,x),e(f,R),e(f,u),e(u,g),e(f,T),e(f,p),e(p,_),e(f,D)},d(j){j&&r(f)}}}function Ti(S){let f,R,u,g,T,p,_,D;return{c(){f=s("p"),R=o("This class method is simply calling "),u=s("a"),g=o("save_pretrained()"),T=o(` and
`),p=s("code"),_=o("save_pretrained"),D=o(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(j){f=n(j,"P",{});var x=i(f);R=a(x,"This class method is simply calling "),u=n(x,"A",{href:!0});var L=i(u);g=a(L,"save_pretrained()"),L.forEach(r),T=a(x,` and
`),p=n(x,"CODE",{});var F=i(p);_=a(F,"save_pretrained"),F.forEach(r),D=a(x,`. Please refer to the docstrings of the methods
above for more information.`),x.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/pr_16834/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(j,x){m(j,f,x),e(f,R),e(f,u),e(u,g),e(f,T),e(f,p),e(p,_),e(f,D)},d(j){j&&r(f)}}}function bi(S){let f,R,u,g,T;return g=new Bs({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){f=s("p"),R=o("Example:"),u=c(),C(g.$$.fragment)},l(p){f=n(p,"P",{});var _=i(f);R=a(_,"Example:"),_.forEach(r),u=h(p),w(g.$$.fragment,p)},m(p,_){m(p,f,_),e(f,R),m(p,u,_),k(g,p,_),T=!0},p:ci,i(p){T||($(g.$$.fragment,p),T=!0)},o(p){y(g.$$.fragment,p),T=!1},d(p){p&&r(f),p&&r(u),O(g,p)}}}function Ci(S){let f,R,u,g,T,p,_,D,j,x,L,F,Lt,$e,ro,zt,oo,ur,W,ao,ye,so,no,Oe,io,lo,gr,st,co,_r,nt,Ft,ho,vr,re,Us,Tr,oe,po,it,mo,fo,br,ae,uo,Dt,go,_o,Cr,H,vo,xe,To,bo,Re,Co,wo,wr,lt,ko,kr,B,Ee,$o,Pe,yo,Oo,xo,I,Ro,Me,Eo,Po,je,Mo,jo,Le,Lo,zo,Fo,ze,Do,dt,qo,Ao,$r,J,se,qt,Fe,Io,At,Vo,yr,U,No,It,So,Wo,ct,Ho,Bo,Or,v,Uo,Vt,Xo,Go,Nt,Zo,Jo,St,Yo,Ko,Wt,Qo,ea,ht,ta,ra,Ht,oa,aa,Bt,sa,na,Ut,ia,la,Xt,da,ca,xr,pt,Gt,ha,Rr,De,Er,ne,pa,qe,ma,fa,Pr,Y,ie,Zt,Ae,ua,Jt,ga,Mr,q,Ie,_a,K,va,mt,Ta,ba,Ve,Ca,wa,ka,Q,$a,ft,ya,Oa,ut,xa,Ra,Ea,le,jr,ee,de,Yt,Ne,Pa,Kt,Ma,Lr,b,Se,ja,Qt,La,za,P,gt,Fa,Da,er,qa,Aa,tr,Ia,Va,rr,Na,Sa,or,Wa,Ha,We,ar,Ba,Ua,Xa,_t,Ga,Za,Ja,ce,He,Ya,V,Ka,sr,Qa,es,vt,ts,rs,nr,os,as,ss,X,Be,ns,ir,is,ls,he,ds,G,Ue,cs,Xe,hs,Tt,ps,ms,fs,pe,us,me,Ge,gs,Ze,_s,bt,vs,Ts,bs,fe,Je,Cs,Ye,ws,Ct,ks,$s,ys,ue,Ke,Os,lr,xs,zr,te,ge,dr,Qe,Rs,cr,Es,Fr,A,et,Ps,N,Ms,wt,js,Ls,hr,zs,Fs,kt,Ds,qs,As,tt,Is,rt,Vs,Ns,Ss,_e,ot,Ws,ve,Dr;return p=new jt({}),$e=new jt({}),Fe=new jt({}),De=new Bs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16834/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/trocr/processing_trocr.py#L23"}}),He=new Z({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/trocr/processing_trocr.py#L44"}}),Be=new Z({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_16834/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/processing_utils.py#L94"}}),pe=new li({props:{$$slots:{default:[Ti]},$$scope:{ctx:S}}}),Ge=new Z({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/trocr/processing_trocr.py#L53"}}),Je=new Z({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/trocr/processing_trocr.py#L60"}}),Ke=new Z({props:{name:"as_target_processor",anchor:"transformers.TrOCRProcessor.as_target_processor",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/trocr/processing_trocr.py#L67"}}),Qe=new jt({}),et=new Z({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16834/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/trocr/modeling_trocr.py#L775"}}),ot=new Z({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/pr_16834/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16834/en/model_doc/trocr#transformers.TrOCRConfig"
...
tasks.`),vr=c(),re=s("img"),Tr=c(),oe=s("small"),po=o("TrOCR architecture. Taken from the "),it=s("a"),mo=o("original paper"),fo=o("."),br=c(),ae=s("p"),uo=o("Please refer to the "),Dt=s("code"),go=o("VisionEncoderDecoder"),_o=o(" class on how to use this model."),Cr=c(),H=s("p"),vo=o("This model was contributed by "),xe=s("a"),To=o("nielsr"),bo=o(`. The original code can be found
...
`),ct=s("a"),Ho=o("generate()"),Bo=o(" to autoregressively generate text given the input image."),Or=c(),v=s("p"),Uo=o("The ["),Vt=s("code"),Xo=o("ViTFeatureExtractor"),Go=o("/"),Nt=s("code"),Zo=o("DeiTFeatureExtractor"),Jo=o(`] class is responsible for preprocessing the input image and
...
`),ht=s("a"),ta=o("TrOCRProcessor"),ra=o(" wraps ["),Ht=s("code"),oa=o("ViTFeatureExtractor"),aa=o("/"),Bt=s("code"),sa=o("DeiTFeatureExtractor"),na=o("] and ["),Ut=s("code"),ia=o("RobertaTokenizer"),la=o("/"),Xt=s("code"),da=o("XLMRobertaTokenizer"),ca=o(`]
into a single instance to both extract the input features and decode the predicted token ids.`),xr=c(),pt=s("ul"),Gt=s("li"),ha=o("Step-by-step Optical Character Recognition (OCR)"),Rr=c(),C(De.$$.fragment),Er=c(),ne=s("p"),pa=o("See the "),qe=s("a"),ma=o("model hub"),fa=o(" to look for TrOCR checkpoints."),Pr=c(),Y=s("h2"),ie=s("a"),Zt=s("span"),C(Ae.$$.fragment),ua=c(),Jt=s("span"),ga=o("TrOCRConfig"),Mr=c(),q=s("div"),C(Ie.$$.fragment),_a=c(),K=s("p"),va=o("This is the configuration class to store the configuration of a "),mt=s("a"),Ta=o("TrOCRForCausalLM"),ba=o(`. It is used to instantiate an
...
[`),rr=s("code"),Na=o("RobertaTokenizer"),Sa=o("/"),or=s("code"),Wa=o("XLMRobertaTokenizer"),Ha=o("]. See the "),We=s("a"),ar=s("strong"),Ba=o("call"),Ua=o("()"),Xa=o(" and "),_t=s("a"),Ga=o("decode()"),Za=o(` for
...
`),nr=s("code"),os=o("__call__"),as=o(". Please refer to the doctsring of the above two methods for more information."),ss=c(),X=s("div"),C(Be.$$.fragment),ns=c(),ir=s("p"),is=o("Instantiate a processor associated with a pretrained model."),ls=c(),C(he.$$.fragment),ds=c(),G=s("div"),C(Ue.$$.fragment),cs=c(),Xe=s("p"),hs=o(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
into a single instance to both extract the input features and decode the predicted token ids.`),E.forEach(r),xr=h(t),pt=n(t,"UL",{});var On=i(pt);Gt=n(On,"LI",{});var xn=i(Gt);ha=a(xn,"Step-by-step Optical Character Recognition (OCR)"),xn.forEach(r),On.forEach(r),Rr=h(t),w(De.$$.fragment,t),Er=h(t),ne=n(t,"P",{});var Wr=i(ne);pa=a(Wr,"See the "),qe=n(Wr,"A",{href:!0,rel:!0});var Rn=i(qe);ma=a(Rn,"model hub"),Rn.forEach(r),fa=a(Wr," to look for TrOCR checkpoints."),Wr.forEach(r),Pr=h(t),Y=n(t,"H2",{class:!0});var Hr=i(Y);ie=n(Hr,"A",{id:!0,class:!0,href:!0});var En=i(ie);Zt=n(En,"SPAN",{});var Pn=i(Zt);w(Ae.$$.fragment,Pn),Pn.forEach(r),En.forEach(r),ua=h(Hr),Jt=n(Hr,"SPAN",{});var Mn=i(Jt);ga=a(Mn,"TrOCRConfig"),Mn.forEach(r),Hr.forEach(r),Mr=h(t),q=n(t,"DIV",{class:!0});var be=i(q);w(Ie.$$.fragment,be),_a=h(be),K=n(be,"P",{});var Rt=i(K);va=a(Rt,"This is the configuration class to store the configuration of a "),mt=n(Rt,"A",{href:!0});var jn=i(mt);Ta=a(jn,"TrOCRForCausalLM"),jn.forEach(r),ba=a(Rt,`. It is used to instantiate an
TrOCR model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the TrOCR
`),Ve=n(Rt,"A",{href:!0,rel:!0});var Ln=i(Ve);Ca=a(Ln,"microsoft/trocr-base-handwritten"),Ln.forEach(r),wa=a(Rt," architecture."),Rt.forEach(r),ka=h(be),Q=n(be,"P",{});var Et=i(Q);$a=a(Et,"Configuration objects inherit from "),ft=n(Et,"A",{href:!0});var zn=i(ft);ya=a(zn,"PretrainedConfig"),zn.forEach(r),Oa=a(Et,` and can be used to control the model outputs. Read the
...
`),nr=n(Ce,"CODE",{});var Zn=i(nr);os=a(Zn,"__call__"),Zn.forEach(r),as=a(Ce,". Please refer to the doctsring of the above two methods for more information."),Ce.forEach(r),Ur.forEach(r),ss=h(M),X=n(M,"DIV",{class:!0});var Pt=i(X);w(Be.$$.fragment,Pt),ns=h(Pt),ir=n(Pt,"P",{});var Jn=i(ir);is=a(Jn,"Instantiate a processor associated with a pretrained model."),Jn.forEach(r),ls=h(Pt),w(he.$$.fragment,Pt),Pt.forEach(r),ds=h(M),G=n(M,"DIV",{class:!0});var Mt=i(G);w(Ue.$$.fragment,Mt),cs=h(Mt),Xe=n(Mt,"P",{});var Xr=i(Xe);hs=a(Xr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
