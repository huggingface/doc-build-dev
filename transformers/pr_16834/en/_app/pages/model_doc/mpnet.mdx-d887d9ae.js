...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function T_(y){let l,g,c,p,b,d,f,E,le,V,z,X,D,G,de,W,ce,se,U,O,Y,B,q,x,Z,H,re,ee,R,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=n("p"),X=a("This second option is useful when using "),D=n("code"),G=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
...
first positional argument :`),B=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,V,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,B,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(V),u&&t(z),u&&t(U),u&&t(O),u&&t(B),u&&t(q)}}}function M_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=r(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),g=a("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function w_(y){let l,g,c,p,b,d,f,E,le,V,z,X,D,G,de,W,ce,se,U,O,Y,B,q,x,Z,H,re,ee,R,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=n("p"),X=a("This second option is useful when using "),D=n("code"),G=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),U=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),B=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=r(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),V=h(u),z=s(u,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),B=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,V,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,B,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(V),u&&t(z),u&&t(U),u&&t(O),u&&t(B),u&&t(q)}}}function P_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=r(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function F_(y){let l,g,c,p,b,d,f,E,le,V,z,X,D,G,de,W,ce,se,U,O,Y,B,q,x,Z,H,re,ee,R,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=n("p"),X=a("This second option is useful when using "),D=n("code"),G=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),U=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),B=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=r(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),V=h(u),z=s(u,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),B=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,V,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,B,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(V),u&&t(z),u&&t(U),u&&t(O),u&&t(B),u&&t(q)}}}function E_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=r(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function x_(y){let l,g,c,p,b,d,f,E,le,V,z,X,D,G,de,W,ce,se,U,O,Y,B,q,x,Z,H,re,ee,R,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=n("p"),X=a("This second option is useful when using "),D=n("code"),G=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),U=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),B=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=r(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),V=h(u),z=s(u,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),B=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,V,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,B,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(V),u&&t(z),u&&t(U),u&&t(O),u&&t(B),u&&t(q)}}}function C_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=r(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),g=a("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function L_(y){let l,g,c,p,b,d,f,E,le,V,z,X,D,G,de,W,ce,se,U,O,Y,B,q,x,Z,H,re,ee,R,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=n("p"),X=a("This second option is useful when using "),D=n("code"),G=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),U=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),B=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=r(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),V=h(u),z=s(u,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),B=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,V,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,B,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(V),u&&t(z),u&&t(U),u&&t(O),u&&t(B),u&&t(q)}}}function A_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=r(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function S_(y){let l,g,c,p,b,d,f,E,le,V,z,X,D,G,de,W,ce,se,U,O,Y,B,q,x,Z,H,re,ee,R,ae,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=n("p"),X=a("This second option is useful when using "),D=n("code"),G=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),U=m(),O=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),B=m(),q=n("ul"),x=n("li"),Z=a("a single Tensor with "),H=n("code"),re=a("input_ids"),ee=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),te=m(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=r(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),V=h(u),z=s(u,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=r(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),B=h(u),q=s(u,"UL",{});var A=r(q);x=s(A,"LI",{});var S=r(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=r(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,V,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,B,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(V),u&&t(z),u&&t(U),u&&t(O),u&&t(B),u&&t(q)}}}function D_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=r(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function H_(y){let l,g,c,p,b,d,f,E,le,V,z,X,D,G,de,W,ce,se,U,O,Y,B,q,x,Z,H,re,ee,R,ae,te,C,pe,Q,oe,me,L,ne,j,he,u,F,K,_e,Me,I,ke,$e,we,A,S,Pe,ge,fe,Ne,ie,ue,no,Kr,un,Gl,Xr,Yl,qi,Ge,gn,Zl,dt,ed,tr,td,od,or,nd,sd,_n,rd,ad,id,Nt,ld,nr,dd,cd,sr,pd,md,hd,so,xi,yt,ro,Jr,kn,fd,Gr,ud,Ci,Ee,bn,gd,vn,_d,rr,kd,bd,vd,ht,Tn,Td,Yr,Md,$d,Mn,ar,wd,Zr,Pd,Nd,ir,yd,ea,Fd,Ed,ao,$n,zd,wn,qd,ta,xd,Cd,jd,io,Pn,Ld,oa,Ad,Od,lr,Nn,ji,Ft,lo,na,yn,Id,sa,Sd,Li,Ye,Fn,Dd,En,Wd,ra,Qd,Hd,Rd,zn,Ud,dr,Vd,Bd,Kd,co,qn,Xd,aa,Jd,Ai,Et,po,ia,xn,Gd,la,Yd,Oi,Oe,Cn,Zd,da,ec,tc,jn,oc,cr,nc,sc,rc,Ln,ac,An,ic,lc,dc,Ze,On,cc,zt,pc,pr,mc,hc,ca,fc,uc,gc,mo,_c,ho,Ii,qt,fo,pa,In,kc,ma,bc,Si,xt,Sn,vc,He,Dn,Tc,Ct,Mc,mr,$c,wc,ha,Pc,Nc,yc,uo,Fc,go,Ec,_o,Di,jt,ko,fa,Wn,zc,ua,qc,Wi,Ie,Qn,xc,ga,Cc,jc,Hn,Lc,hr,Ac,Oc,Ic,Rn,Sc,Un,Dc,Wc,Qc,ye,Vn,Hc,Lt,Rc,fr,Uc,Vc,_a,Bc,Kc,Xc,bo,Jc,vo,Gc,To,Yc,Mo,Zc,$o,Qi,At,wo,ka,Bn,ep,ba,tp,Hi,Se,Kn,op,va,np,sp,Xn,rp,ur,ap,ip,lp,Jn,dp,Gn,cp,pp,mp,et,Yn,hp,Ot,fp,gr,up,gp,Ta,_p,kp,bp,Po,vp,No,Ri,It,yo,Ma,Zn,Tp,$a,Mp,Ui,De,es,$p,wa,wp,Pp,ts,Np,_r,yp,Fp,Ep,os,zp,ns,qp,xp,Cp,Re,ss,jp,St,Lp,kr,Ap,Op,Pa,Ip,Sp,Dp,Fo,Wp,Eo,Qp,zo,Vi,Dt,qo,Na,rs,Hp,ya,Rp,Bi,We,as,Up,Wt,Vp,Fa,Bp,Kp,Ea,Xp,Jp,Gp,is,Yp,br,Zp,em,tm,ls,om,ds,nm,sm,rm,Ue,cs,am,Qt,im,vr,lm,dm,za,cm,pm,mm,xo,hm,Co,fm,jo,Ki,Ht,Lo,qa,ps,um,xa,gm,Xi,ze,ms,_m,Ca,km,bm,hs,vm,Tr,Tm,Mm,$m,fs,wm,us,Pm,Nm,ym,Ao,Fm,tt,gs,Em,Rt,zm,Mr,qm,xm,ja,Cm,jm,Lm,Oo,Am,Io,Ji,Ut,So,La,_s,Om,Aa,Im,Gi,qe,ks,Sm,bs,Dm,Oa,Wm,Qm,Hm,vs,Rm,$r,Um,Vm,Bm,Ts,Km,Ms,Xm,Jm,Gm,Do,Ym,Ve,$s,Zm,Vt,eh,wr,th,oh,Ia,nh,sh,rh,Wo,ah,Qo,ih,Ho,Yi,Bt,Ro,Sa,ws,lh,Da,dh,Zi,xe,Ps,ch,Wa,ph,mh,Ns,hh,Pr,fh,uh,gh,ys,_h,Fs,kh,bh,vh,Uo,Th,Be,Es,Mh,Kt,$h,Nr,wh,Ph,Qa,Nh,yh,Fh,Vo,Eh,Bo,zh,Ko,el,Xt,Xo,Ha,zs,qh,Ra,xh,tl,Ce,qs,Ch,Ua,jh,Lh,xs,Ah,yr,Oh,Ih,Sh,Cs,Dh,js,Wh,Qh,Hh,Jo,Rh,ot,Ls,Uh,Jt,Vh,Fr,Bh,Kh,Va,Xh,Jh,Gh,Go,Yh,Yo,ol,Gt,Zo,Ba,As,Zh,Ka,ef,nl,je,Os,tf,Xa,of,nf,Is,sf,Er,rf,af,lf,Ss,df,Ds,cf,pf,mf,en,hf,Ke,Ws,ff,Yt,uf,zr,gf,_f,Ja,kf,bf,vf,tn,Tf,on,Mf,nn,sl,Zt,sn,Ga,Qs,$f,Ya,wf,rl,Le,Hs,Pf,eo,Nf,Za,yf,Ff,ei,Ef,zf,qf,Rs,xf,qr,Cf,jf,Lf,Us,Af,Vs,Of,If,Sf,rn,Df,Xe,Bs,Wf,to,Qf,xr,Hf,Rf,ti,Uf,Vf,Bf,an,Kf,ln,Xf,dn,al;return d=new Ae({}),G=new Ae({}),un=new Ae({}),gn=new J({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/tokenization_mpnet.py#L231",returnDescription:`
...
Set to True if the token list is already formatted with special tokens for the model`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/tokenization_mpnet.py#L256",returnDescription:`
...
Optional second list of IDs for sequence pairs`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/tokenization_mpnet_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
configuration. Check out the <a href="/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L483"}}),On=new J({props:{name:"forward",anchor:"transformers.MPNetModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16834/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16834/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L512",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16834/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetConfig"
...
`}}),mo=new Fe({props:{$$slots:{default:[n_]},$$scope:{ctx:y}}}),ho=new be({props:{anchor:"transformers.MPNetModel.forward.example",$$slots:{default:[s_]},$$scope:{ctx:y}}}),In=new Ae({}),Sn=new J({props:{name:"class transformers.MPNetForMaskedLM",anchor:"transformers.MPNetForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L576"}}),Dn=new J({props:{name:"forward",anchor:"transformers.MPNetForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16834/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16834/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L595",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L685"}}),Vn=new J({props:{name:"forward",anchor:"transformers.MPNetForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16834/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16834/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L698",returnDescription:`
<p>A <a
...
`}}),bo=new Fe({props:{$$slots:{default:[l_]},$$scope:{ctx:y}}}),vo=new be({props:{anchor:"transformers.MPNetForSequenceClassification.forward.example",$$slots:{default:[d_]},$$scope:{ctx:y}}}),To=new be({props:{anchor:"transformers.MPNetForSequenceClassification.forward.example-2",$$slots:{default:[c_]},$$scope:{ctx:y}}}),Mo=new be({props:{anchor:"transformers.MPNetForSequenceClassification.forward.example-3",$$slots:{default:[p_]},$$scope:{ctx:y}}}),$o=new be({props:{anchor:"transformers.MPNetForSequenceClassification.forward.example-4",$$slots:{default:[m_]},$$scope:{ctx:y}}}),Bn=new Ae({}),Kn=new J({props:{name:"class transformers.MPNetForMultipleChoice",anchor:"transformers.MPNetForMultipleChoice",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L780"}}),Yn=new J({props:{name:"forward",anchor:"transformers.MPNetForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16834/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16834/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L793",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L886",returnDescription:`
<p>A <a
...
`}}),Fo=new Fe({props:{$$slots:{default:[u_]},$$scope:{ctx:y}}}),Eo=new be({props:{anchor:"transformers.MPNetForTokenClassification.forward.example",$$slots:{default:[g_]},$$scope:{ctx:y}}}),zo=new be({props:{anchor:"transformers.MPNetForTokenClassification.forward.example-2",$$slots:{default:[__]},$$scope:{ctx:y}}}),rs=new Ae({}),as=new J({props:{name:"class transformers.MPNetForQuestionAnswering",anchor:"transformers.MPNetForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L971"}}),cs=new J({props:{name:"forward",anchor:"transformers.MPNetForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16834/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16834/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_mpnet.py#L985",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_tf_mpnet.py#L669",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_tf_mpnet.py#L784",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16834/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_tf_mpnet.py#L878"}}),Uo=new Fe({props:{$$slots:{default:[F_]},$$scope:{ctx:y}}}),Es=new J({props:{name:"call",anchor:"transformers.TFMPNetForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFMPNetForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16834/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16834/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_tf_mpnet.py#L889",returnDescription:`
<p>A <a
...
`}}),Vo=new Fe({props:{$$slots:{default:[E_]},$$scope:{ctx:y}}}),Bo=new be({props:{anchor:"transformers.TFMPNetForSequenceClassification.call.example",$$slots:{default:[z_]},$$scope:{ctx:y}}}),Ko=new be({props:{anchor:"transformers.TFMPNetForSequenceClassification.call.example-2",$$slots:{default:[q_]},$$scope:{ctx:y}}}),zs=new Ae({}),qs=new J({props:{name:"class transformers.TFMPNetForMultipleChoice",anchor:"transformers.TFMPNetForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMPNetForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_tf_mpnet.py#L979",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1090",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16834/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1172",returnDescription:`
<p>A <a
...
documentation from `),sr=n("a"),pd=a("PretrainedConfig"),md=a(" for more information."),hd=m(),T(so.$$.fragment),xi=m(),yt=n("h2"),ro=n("a"),Jr=n("span"),T(kn.$$.fragment),fd=m(),Gr=n("span"),ud=a("MPNetTokenizer"),Ci=m(),Ee=n("div"),T(bn.$$.fragment),gd=m(),vn=n("p"),_d=a("This tokenizer inherits from "),rr=n("a"),kd=a("BertTokenizer"),bd=a(` which contains most of the methods. Users should refer to the
...
make use of token type ids, therefore a list of zeros is returned.`),Od=m(),lr=n("div"),T(Nn.$$.fragment),ji=m(),Ft=n("h2"),lo=n("a"),na=n("span"),T(yn.$$.fragment),Id=m(),sa=n("span"),Sd=a("MPNetTokenizerFast"),Li=m(),Ye=n("div"),T(Fn.$$.fragment),Dd=m(),En=n("p"),Wd=a("Construct a \u201Cfast\u201D MPNet tokenizer (backed by HuggingFace\u2019s "),ra=n("em"),Qd=a("tokenizers"),Hd=a(" library). Based on WordPiece."),Rd=m(),zn=n("p"),Ud=a("This tokenizer inherits from "),dr=n("a"),Vd=a("PreTrainedTokenizerFast"),Bd=a(` which contains most of the main methods. Users should
...
make use of token type ids, therefore a list of zeros is returned`),Ai=m(),Et=n("h2"),po=n("a"),ia=n("span"),T(xn.$$.fragment),Gd=m(),la=n("span"),Yd=a("MPNetModel"),Oi=m(),Oe=n("div"),T(Cn.$$.fragment),Zd=m(),da=n("p"),ec=a("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),tc=m(),jn=n("p"),oc=a("This model inherits from "),cr=n("a"),nc=a("PreTrainedModel"),sc=a(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc=m(),ye=n("div"),T(Vn.$$.fragment),Hc=m(),Lt=n("p"),Rc=a("The "),fr=n("a"),Uc=a("MPNetForSequenceClassification"),Vc=a(" forward method, overrides the "),_a=n("code"),Bc=a("__call__"),Kc=a(" special method."),Xc=m(),T(bo.$$.fragment),Jc=m(),T(vo.$$.fragment),Gc=m(),T(To.$$.fragment),Yc=m(),T(Mo.$$.fragment),Zc=m(),T($o.$$.fragment),Qi=m(),At=n("h2"),wo=n("a"),ka=n("span"),T(Bn.$$.fragment),ep=m(),ba=n("span"),tp=a("MPNetForMultipleChoice"),Hi=m(),Se=n("div"),T(Kn.$$.fragment),op=m(),va=n("p"),np=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cp=m(),Re=n("div"),T(ss.$$.fragment),jp=m(),St=n("p"),Lp=a("The "),kr=n("a"),Ap=a("MPNetForTokenClassification"),Op=a(" forward method, overrides the "),Pa=n("code"),Ip=a("__call__"),Sp=a(" special method."),Dp=m(),T(Fo.$$.fragment),Wp=m(),T(Eo.$$.fragment),Qp=m(),T(zo.$$.fragment),Vi=m(),Dt=n("h2"),qo=n("a"),Na=n("span"),T(rs.$$.fragment),Hp=m(),ya=n("span"),Rp=a("MPNetForQuestionAnswering"),Bi=m(),We=n("div"),T(as.$$.fragment),Up=m(),Wt=n("p"),Vp=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Fa=n("code"),Bp=a("span start logits"),Kp=a(" and "),Ea=n("code"),Xp=a("span end logits"),Jp=a(")."),Gp=m(),is=n("p"),Yp=a("This model inherits from "),br=n("a"),Zp=a("PreTrainedModel"),em=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
behavior.`),ym=m(),T(Ao.$$.fragment),Fm=m(),tt=n("div"),T(gs.$$.fragment),Em=m(),Rt=n("p"),zm=a("The "),Mr=n("a"),qm=a("TFMPNetModel"),xm=a(" forward method, overrides the "),ja=n("code"),Cm=a("__call__"),jm=a(" special method."),Lm=m(),T(Oo.$$.fragment),Am=m(),T(Io.$$.fragment),Ji=m(),Ut=n("h2"),So=n("a"),La=n("span"),T(_s.$$.fragment),Om=m(),Aa=n("span"),Im=a("TFMPNetForMaskedLM"),Gi=m(),qe=n("div"),T(ks.$$.fragment),Sm=m(),bs=n("p"),Dm=a("MPNet Model with a "),Oa=n("code"),Wm=a("language modeling"),Qm=a(" head on top."),Hm=m(),vs=n("p"),Rm=a("This model inherits from "),$r=n("a"),Um=a("TFPreTrainedModel"),Vm=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bm=m(),Ts=n("p"),Km=a("This model is also a "),Ms=n("a"),Xm=a("tf.keras.Model"),Jm=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gm=m(),T(Do.$$.fragment),Ym=m(),Ve=n("div"),T($s.$$.fragment),Zm=m(),Vt=n("p"),eh=a("The "),wr=n("a"),th=a("TFMPNetForMaskedLM"),oh=a(" forward method, overrides the "),Ia=n("code"),nh=a("__call__"),sh=a(" special method."),rh=m(),T(Wo.$$.fragment),ah=m(),T(Qo.$$.fragment),ih=m(),T(Ho.$$.fragment),Yi=m(),Bt=n("h2"),Ro=n("a"),Sa=n("span"),T(ws.$$.fragment),lh=m(),Da=n("span"),dh=a("TFMPNetForSequenceClassification"),Zi=m(),xe=n("div"),T(Ps.$$.fragment),ch=m(),Wa=n("p"),ph=a(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vh=m(),T(Uo.$$.fragment),Th=m(),Be=n("div"),T(Es.$$.fragment),Mh=m(),Kt=n("p"),$h=a("The "),Nr=n("a"),wh=a("TFMPNetForSequenceClassification"),Ph=a(" forward method, overrides the "),Qa=n("code"),Nh=a("__call__"),yh=a(" special method."),Fh=m(),T(Vo.$$.fragment),Eh=m(),T(Bo.$$.fragment),zh=m(),T(Ko.$$.fragment),el=m(),Xt=n("h2"),Xo=n("a"),Ha=n("span"),T(zs.$$.fragment),qh=m(),Ra=n("span"),xh=a("TFMPNetForMultipleChoice"),tl=m(),Ce=n("div"),T(qs.$$.fragment),Ch=m(),Ua=n("p"),jh=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hh=m(),T(Jo.$$.fragment),Rh=m(),ot=n("div"),T(Ls.$$.fragment),Uh=m(),Jt=n("p"),Vh=a("The "),Fr=n("a"),Bh=a("TFMPNetForMultipleChoice"),Kh=a(" forward method, overrides the "),Va=n("code"),Xh=a("__call__"),Jh=a(" special method."),Gh=m(),T(Go.$$.fragment),Yh=m(),T(Yo.$$.fragment),ol=m(),Gt=n("h2"),Zo=n("a"),Ba=n("span"),T(As.$$.fragment),Zh=m(),Ka=n("span"),ef=a("TFMPNetForTokenClassification"),nl=m(),je=n("div"),T(Os.$$.fragment),tf=m(),Xa=n("p"),of=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mf=m(),T(en.$$.fragment),hf=m(),Ke=n("div"),T(Ws.$$.fragment),ff=m(),Yt=n("p"),uf=a("The "),zr=n("a"),gf=a("TFMPNetForTokenClassification"),_f=a(" forward method, overrides the "),Ja=n("code"),kf=a("__call__"),bf=a(" special method."),vf=m(),T(tn.$$.fragment),Tf=m(),T(on.$$.fragment),Mf=m(),T(nn.$$.fragment),sl=m(),Zt=n("h2"),sn=n("a"),Ga=n("span"),T(Qs.$$.fragment),$f=m(),Ya=n("span"),wf=a("TFMPNetForQuestionAnswering"),rl=m(),Le=n("div"),T(Hs.$$.fragment),Pf=m(),eo=n("p"),Nf=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lf=m(),Us=n("p"),Af=a("This model is also a "),Vs=n("a"),Of=a("tf.keras.Model"),If=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sf=m(),T(rn.$$.fragment),Df=m(),Xe=n("div"),T(Bs.$$.fragment),Wf=m(),to=n("p"),Qf=a("The "),xr=n("a"),Hf=a("TFMPNetForQuestionAnswering"),Rf=a(" forward method, overrides the "),ti=n("code"),Uf=a("__call__"),Vf=a(" special method."),Bf=m(),T(an.$$.fragment),Kf=m(),T(ln.$$.fragment),Xf=m(),T(dn.$$.fragment),this.h()},l(o){const k=e_('[data-svelte="svelte-1phssyn"]',document.head);l=s(k,"META",{name:!0,content:!0}),k.forEach(t),g=h(o),c=s(o,"H1",{class:!0});var Ks=r(c);p=s(Ks,"A",{id:!0,class:!0,href:!0});var oi=r(p);b=s(oi,"SPAN",{});var ni=r(b);M(d.$$.fragment,ni),ni.forEach(t),oi.forEach(t),f=h(Ks),E=s(Ks,"SPAN",{});var si=r(E);le=i(si,"MPNet"),si.forEach(t),Ks.forEach(t),V=h(o),z=s(o,"H2",{class:!0});var Xs=r(z);X=s(Xs,"A",{id:!0,class:!0,href:!0});var ri=r(X);D=s(ri,"SPAN",{});var ai=r(D);M(G.$$.fragment,ai),ai.forEach(t),ri.forEach(t),de=h(Xs),W=s(Xs,"SPAN",{});var ii=r(W);ce=i(ii,"Overview"),ii.forEach(t),Xs.forEach(t),se=h(o),U=s(o,"P",{});var Js=r(U);O=i(Js,"The MPNet model was proposed in "),Y=s(Js,"A",{href:!0,rel:!0});var li=r(Y);B=i(li,"MPNet: Masked and Permuted Pre-training for Language Understanding"),li.forEach(t),q=i(Js," by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),Js.forEach(t),x=h(o),Z=s(o,"P",{});var di=r(Z);H=i(di,`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
...
adding special tokens. A MPNet sequence has the following format:`),Yf.forEach(t),$d=h(Cr),Mn=s(Cr,"UL",{});var il=r(Mn);ar=s(il,"LI",{});var Jf=r(ar);wd=i(Jf,"single sequence: "),Zr=s(Jf,"CODE",{});var Zf=r(Zr);Pd=i(Zf,"<s> X </s>"),Zf.forEach(t),Jf.forEach(t),Nd=h(il),ir=s(il,"LI",{});var Gf=r(ir);yd=i(Gf,"pair of sequences: "),ea=s(Gf,"CODE",{});var eu=r(ea);Fd=i(eu,"<s> A </s></s> B </s>"),eu.forEach(t),Gf.forEach(t),il.forEach(t),Cr.forEach(t),Ed=h(Qe),ao=s(Qe,"DIV",{class:!0});var ll=r(ao);M($n.$$.fragment,ll),zd=h(ll),wn=s(ll,"P",{});var dl=r(wn);qd=i(dl,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned`),du.forEach(t),fl.forEach(t),cn.forEach(t),Ai=h(o),Et=s(o,"H2",{class:!0});var ul=r(Et);po=s(ul,"A",{id:!0,class:!0,href:!0});var cu=r(po);ia=s(cu,"SPAN",{});var pu=r(ia);M(xn.$$.fragment,pu),pu.forEach(t),cu.forEach(t),Gd=h(ul),la=s(ul,"SPAN",{});var mu=r(la);Yd=i(mu,"MPNetModel"),mu.forEach(t),ul.forEach(t),Oi=h(o),Oe=s(o,"DIV",{class:!0});var ft=r(Oe);M(Cn.$$.fragment,ft),Zd=h(ft),da=s(ft,"P",{});var hu=r(da);ec=i(hu,"The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),hu.forEach(t),tc=h(ft),jn=s(ft,"P",{});var gl=r(jn);oc=i(gl,"This model inherits from "),cr=s(gl,"A",{href:!0});var fu=r(cr);nc=i(fu,"PreTrainedModel"),fu.forEach(t),sc=i(gl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ml.forEach(t),Qc=h(gt),ye=s(gt,"DIV",{class:!0});var Je=r(ye);M(Vn.$$.fragment,Je),Hc=h(Je),Lt=s(Je,"P",{});var Ar=r(Lt);Rc=i(Ar,"The "),fr=s(Ar,"A",{href:!0});var Eu=r(fr);Uc=i(Eu,"MPNetForSequenceClassification"),Eu.forEach(t),Vc=i(Ar," forward method, overrides the "),_a=s(Ar,"CODE",{});var zu=r(_a);Bc=i(zu,"__call__"),zu.forEach(t),Kc=i(Ar," special method."),Ar.forEach(t),Xc=h(Je),M(bo.$$.fragment,Je),Jc=h(Je),M(vo.$$.fragment,Je),Gc=h(Je),M(To.$$.fragment,Je),Yc=h(Je),M(Mo.$$.fragment,Je),Zc=h(Je),M($o.$$.fragment,Je),Je.forEach(t),gt.forEach(t),Qi=h(o),At=s(o,"H2",{class:!0});var $l=r(At);wo=s($l,"A",{id:!0,class:!0,href:!0});var qu=r(wo);ka=s(qu,"SPAN",{});var xu=r(ka);M(Bn.$$.fragment,xu),xu.forEach(t),qu.forEach(t),ep=h($l),ba=s($l,"SPAN",{});var Cu=r(ba);tp=i(Cu,"MPNetForMultipleChoice"),Cu.forEach(t),$l.forEach(t),Hi=h(o),Se=s(o,"DIV",{class:!0});var _t=r(Se);M(Kn.$$.fragment,_t),op=h(_t),va=s(_t,"P",{});var ju=r(va);np=i(ju,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fl.forEach(t),Cp=h(kt),Re=s(kt,"DIV",{class:!0});var bt=r(Re);M(ss.$$.fragment,bt),jp=h(bt),St=s(bt,"P",{});var Ir=r(St);Lp=i(Ir,"The "),kr=s(Ir,"A",{href:!0});var Uu=r(kr);Ap=i(Uu,"MPNetForTokenClassification"),Uu.forEach(t),Op=i(Ir," forward method, overrides the "),Pa=s(Ir,"CODE",{});var Vu=r(Pa);Ip=i(Vu,"__call__"),Vu.forEach(t),Sp=i(Ir," special method."),Ir.forEach(t),Dp=h(bt),M(Fo.$$.fragment,bt),Wp=h(bt),M(Eo.$$.fragment,bt),Qp=h(bt),M(zo.$$.fragment,bt),bt.forEach(t),kt.forEach(t),Vi=h(o),Dt=s(o,"H2",{class:!0});var El=r(Dt);qo=s(El,"A",{id:!0,class:!0,href:!0});var Bu=r(qo);Na=s(Bu,"SPAN",{});var Ku=r(Na);M(rs.$$.fragment,Ku),Ku.forEach(t),Bu.forEach(t),Hp=h(El),ya=s(El,"SPAN",{});var Xu=r(ya);Rp=i(Xu,"MPNetForQuestionAnswering"),Xu.forEach(t),El.forEach(t),Bi=h(o),We=s(o,"DIV",{class:!0});var vt=r(We);M(as.$$.fragment,vt),Up=h(vt),Wt=s(vt,"P",{});var Sr=r(Wt);Vp=i(Sr,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Fa=s(Sr,"CODE",{});var Ju=r(Fa);Bp=i(Ju,"span start logits"),Ju.forEach(t),Kp=i(Sr," and "),Ea=s(Sr,"CODE",{});var Gu=r(Ea);Xp=i(Gu,"span end logits"),Gu.forEach(t),Jp=i(Sr,")."),Sr.forEach(t),Gp=h(vt),is=s(vt,"P",{});var zl=r(is);Yp=i(zl,"This model inherits from "),br=s(zl,"A",{href:!0});var Yu=r(br);Zp=i(Yu,"PreTrainedModel"),Yu.forEach(t),em=i(zl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jl.forEach(t),ym=h(nt),M(Ao.$$.fragment,nt),Fm=h(nt),tt=s(nt,"DIV",{class:!0});var hn=r(tt);M(gs.$$.fragment,hn),Em=h(hn),Rt=s(hn,"P",{});var Wr=r(Rt);zm=i(Wr,"The "),Mr=s(Wr,"A",{href:!0});var lg=r(Mr);qm=i(lg,"TFMPNetModel"),lg.forEach(t),xm=i(Wr," forward method, overrides the "),ja=s(Wr,"CODE",{});var dg=r(ja);Cm=i(dg,"__call__"),dg.forEach(t),jm=i(Wr," special method."),Wr.forEach(t),Lm=h(hn),M(Oo.$$.fragment,hn),Am=h(hn),M(Io.$$.fragment,hn),hn.forEach(t),nt.forEach(t),Ji=h(o),Ut=s(o,"H2",{class:!0});var Ll=r(Ut);So=s(Ll,"A",{id:!0,class:!0,href:!0});var cg=r(So);La=s(cg,"SPAN",{});var pg=r(La);M(_s.$$.fragment,pg),pg.forEach(t),cg.forEach(t),Om=h(Ll),Aa=s(Ll,"SPAN",{});var mg=r(Aa);Im=i(mg,"TFMPNetForMaskedLM"),mg.forEach(t),Ll.forEach(t),Gi=h(o),qe=s(o,"DIV",{class:!0});var st=r(qe);M(ks.$$.fragment,st),Sm=h(st),bs=s(st,"P",{});var Al=r(bs);Dm=i(Al,"MPNet Model with a "),Oa=s(Al,"CODE",{});var hg=r(Oa);Wm=i(hg,"language modeling"),hg.forEach(t),Qm=i(Al," head on top."),Al.forEach(t),Hm=h(st),vs=s(st,"P",{});var Ol=r(vs);Rm=i(Ol,"This model inherits from "),$r=s(Ol,"A",{href:!0});var fg=r($r);Um=i(fg,"TFPreTrainedModel"),fg.forEach(t),Vm=i(Ol,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ol.forEach(t),Bm=h(st),Ts=s(st,"P",{});var Il=r(Ts);Km=i(Il,"This model is also a "),Ms=s(Il,"A",{href:!0,rel:!0});var ug=r(Ms);Xm=i(ug,"tf.keras.Model"),ug.forEach(t),Jm=i(Il,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Il.forEach(t),Gm=h(st),M(Do.$$.fragment,st),Ym=h(st),Ve=s(st,"DIV",{class:!0});var Mt=r(Ve);M($s.$$.fragment,Mt),Zm=h(Mt),Vt=s(Mt,"P",{});var Qr=r(Vt);eh=i(Qr,"The "),wr=s(Qr,"A",{href:!0});var gg=r(wr);th=i(gg,"TFMPNetForMaskedLM"),gg.forEach(t),oh=i(Qr," forward method, overrides the "),Ia=s(Qr,"CODE",{});var _g=r(Ia);nh=i(_g,"__call__"),_g.forEach(t),sh=i(Qr," special method."),Qr.forEach(t),rh=h(Mt),M(Wo.$$.fragment,Mt),ah=h(Mt),M(Qo.$$.fragment,Mt),ih=h(Mt),M(Ho.$$.fragment,Mt),Mt.forEach(t),st.forEach(t),Yi=h(o),Bt=s(o,"H2",{class:!0});var Sl=r(Bt);Ro=s(Sl,"A",{id:!0,class:!0,href:!0});var kg=r(Ro);Sa=s(kg,"SPAN",{});var bg=r(Sa);M(ws.$$.fragment,bg),bg.forEach(t),kg.forEach(t),lh=h(Sl),Da=s(Sl,"SPAN",{});var vg=r(Da);dh=i(vg,"TFMPNetForSequenceClassification"),vg.forEach(t),Sl.forEach(t),Zi=h(o),xe=s(o,"DIV",{class:!0});var rt=r(xe);M(Ps.$$.fragment,rt),ch=h(rt),Wa=s(rt,"P",{});var Tg=r(Wa);ph=i(Tg,`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wl.forEach(t),vh=h(rt),M(Uo.$$.fragment,rt),Th=h(rt),Be=s(rt,"DIV",{class:!0});var $t=r(Be);M(Es.$$.fragment,$t),Mh=h($t),Kt=s($t,"P",{});var Hr=r(Kt);$h=i(Hr,"The "),Nr=s(Hr,"A",{href:!0});var wg=r(Nr);wh=i(wg,"TFMPNetForSequenceClassification"),wg.forEach(t),Ph=i(Hr," forward method, overrides the "),Qa=s(Hr,"CODE",{});var Pg=r(Qa);Nh=i(Pg,"__call__"),Pg.forEach(t),yh=i(Hr," special method."),Hr.forEach(t),Fh=h($t),M(Vo.$$.fragment,$t),Eh=h($t),M(Bo.$$.fragment,$t),zh=h($t),M(Ko.$$.fragment,$t),$t.forEach(t),rt.forEach(t),el=h(o),Xt=s(o,"H2",{class:!0});var Ql=r(Xt);Xo=s(Ql,"A",{id:!0,class:!0,href:!0});var Ng=r(Xo);Ha=s(Ng,"SPAN",{});var yg=r(Ha);M(zs.$$.fragment,yg),yg.forEach(t),Ng.forEach(t),qh=h(Ql),Ra=s(Ql,"SPAN",{});var Fg=r(Ra);xh=i(Fg,"TFMPNetForMultipleChoice"),Fg.forEach(t),Ql.forEach(t),tl=h(o),Ce=s(o,"DIV",{class:!0});var at=r(Ce);M(qs.$$.fragment,at),Ch=h(at),Ua=s(at,"P",{});var Eg=r(Ua);jh=i(Eg,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rl.forEach(t),Hh=h(at),M(Jo.$$.fragment,at),Rh=h(at),ot=s(at,"DIV",{class:!0});var fn=r(ot);M(Ls.$$.fragment,fn),Uh=h(fn),Jt=s(fn,"P",{});var Rr=r(Jt);Vh=i(Rr,"The "),Fr=s(Rr,"A",{href:!0});var xg=r(Fr);Bh=i(xg,"TFMPNetForMultipleChoice"),xg.forEach(t),Kh=i(Rr," forward method, overrides the "),Va=s(Rr,"CODE",{});var Cg=r(Va);Xh=i(Cg,"__call__"),Cg.forEach(t),Jh=i(Rr," special method."),Rr.forEach(t),Gh=h(fn),M(Go.$$.fragment,fn),Yh=h(fn),M(Yo.$$.fragment,fn),fn.forEach(t),at.forEach(t),ol=h(o),Gt=s(o,"H2",{class:!0});var Ul=r(Gt);Zo=s(Ul,"A",{id:!0,class:!0,href:!0});var jg=r(Zo);Ba=s(jg,"SPAN",{});var Lg=r(Ba);M(As.$$.fragment,Lg),Lg.forEach(t),jg.forEach(t),Zh=h(Ul),Ka=s(Ul,"SPAN",{});var Ag=r(Ka);ef=i(Ag,"TFMPNetForTokenClassification"),Ag.forEach(t),Ul.forEach(t),nl=h(o),je=s(o,"DIV",{class:!0});var it=r(je);M(Os.$$.fragment,it),tf=h(it),Xa=s(it,"P",{});var Og=r(Xa);of=i(Og,`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Og.forEach(t),nf=h(it),Is=s(it,"P",{});var Vl=r(Is);sf=i(Vl,"This model inherits from "),Er=s(Vl,"A",{href:!0});var Ig=r(Er);rf=i(Ig,"TFPreTrainedModel"),Ig.forEach(t),af=i(Vl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vl.forEach(t),lf=h(it),Ss=s(it,"P",{});var Bl=r(Ss);df=i(Bl,"This model is also a "),Ds=s(Bl,"A",{href:!0,rel:!0});var Sg=r(Ds);cf=i(Sg,"tf.keras.Model"),Sg.forEach(t),pf=i(Bl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bl.forEach(t),mf=h(it),M(en.$$.fragment,it),hf=h(it),Ke=s(it,"DIV",{class:!0});var wt=r(Ke);M(Ws.$$.fragment,wt),ff=h(wt),Yt=s(wt,"P",{});var Ur=r(Yt);uf=i(Ur,"The "),zr=s(Ur,"A",{href:!0});var Dg=r(zr);gf=i(Dg,"TFMPNetForTokenClassification"),Dg.forEach(t),_f=i(Ur," forward method, overrides the "),Ja=s(Ur,"CODE",{});var Wg=r(Ja);kf=i(Wg,"__call__"),Wg.forEach(t),bf=i(Ur," special method."),Ur.forEach(t),vf=h(wt),M(tn.$$.fragment,wt),Tf=h(wt),M(on.$$.fragment,wt),Mf=h(wt),M(nn.$$.fragment,wt),wt.forEach(t),it.forEach(t),sl=h(o),Zt=s(o,"H2",{class:!0});var Kl=r(Zt);sn=s(Kl,"A",{id:!0,class:!0,href:!0});var Qg=r(sn);Ga=s(Qg,"SPAN",{});var Hg=r(Ga);M(Qs.$$.fragment,Hg),Hg.forEach(t),Qg.forEach(t),$f=h(Kl),Ya=s(Kl,"SPAN",{});var Rg=r(Ya);wf=i(Rg,"TFMPNetForQuestionAnswering"),Rg.forEach(t),Kl.forEach(t),rl=h(o),Le=s(o,"DIV",{class:!0});var lt=r(Le);M(Hs.$$.fragment,lt),Pf=h(lt),eo=s(lt,"P",{});var Vr=r(eo);Nf=i(Vr,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Za=s(Vr,"CODE",{});var Ug=r(Za);yf=i(Ug,"span start logits"),Ug.forEach(t),Ff=i(Vr," and "),ei=s(Vr,"CODE",{});var Vg=r(ei);Ef=i(Vg,"span end logits"),Vg.forEach(t),zf=i(Vr,")."),Vr.forEach(t),qf=h(lt),Rs=s(lt,"P",{});var Xl=r(Rs);xf=i(Xl,"This model inherits from "),qr=s(Xl,"A",{href:!0});var Bg=r(qr);Cf=i(Bg,"TFPreTrainedModel"),Bg.forEach(t),jf=i(Xl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xl.forEach(t),Lf=h(lt),Us=s(lt,"P",{});var Jl=r(Us);Af=i(Jl,"This model is also a "),Vs=s(Jl,"A",{href:!0,rel:!0});var Kg=r(Vs);Of=i(Kg,"tf.keras.Model"),Kg.forEach(t),If=i(Jl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jl.forEach(t),Sf=h(lt),M(rn.$$.fragment,lt),Df=h(lt),Xe=s(lt,"DIV",{class:!0});var Pt=r(Xe);M(Bs.$$.fragment,Pt),Wf=h(Pt),to=s(Pt,"P",{});var Br=r(to);Qf=i(Br,"The "),xr=s(Br,"A",{href:!0});var Xg=r(xr);Hf=i(Xg,"TFMPNetForQuestionAnswering"),Xg.forEach(t),Rf=i(Br," forward method, overrides the "),ti=s(Br,"CODE",{});var Jg=r(ti);Uf=i(Jg,"__call__"),Jg.forEach(t),Vf=i(Br," special method."),Br.forEach(t),Bf=h(Pt),M(an.$$.fragment,Pt),Kf=h(Pt),M(ln.$$.fragment,Pt),Xf=h(Pt),M(dn.$$.fragment,Pt),Pt.forEach(t),lt.forEach(t),this.h()},h(){v(l,"name","hf:doc:metadata"),v(l,"content",JSON.stringify(R_)),v(p,"id","mpnet"),v(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(p,"href","#mpnet"),v(c,"class","relative group"),v(X,"id","overview"),v(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(X,"href","#overview"),v(z,"class","relative group"),v(Y,"href","https://arxiv.org/abs/2004.09297"),v(Y,"rel","nofollow"),v(ge,"href","https://github.com/microsoft/MPNet"),v(ge,"rel","nofollow"),v(no,"id","transformers.MPNetConfig"),v(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(no,"href","#transformers.MPNetConfig"),v(ue,"class","relative group"),v(tr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetModel"),v(or,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.TFMPNetModel"),v(_n,"href","https://huggingface.co/microsoft/mpnet-base"),v(_n,"rel","nofollow"),v(nr,"href","/docs/transformers/pr_16834/en/main_classes/configuration#transformers.PretrainedConfig"),v(sr,"href","/docs/transformers/pr_16834/en/main_classes/configuration#transformers.PretrainedConfig"),v(Ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ro,"id","transformers.MPNetTokenizer"),v(ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(ro,"href","#transformers.MPNetTokenizer"),v(yt,"class","relative group"),v(rr,"href","/docs/transformers/pr_16834/en/model_doc/bert#transformers.BertTokenizer"),v(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ao,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(io,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(lr,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(lo,"id","transformers.MPNetTokenizerFast"),v(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(lo,"href","#transformers.MPNetTokenizerFast"),v(Ft,"class","relative group"),v(dr,"href","/docs/transformers/pr_16834/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),v(co,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(po,"id","transformers.MPNetModel"),v(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(po,"href","#transformers.MPNetModel"),v(Et,"class","relative group"),v(cr,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel"),v(An,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(An,"rel","nofollow"),v(pr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetModel"),v(Ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(fo,"id","transformers.MPNetForMaskedLM"),v(fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(fo,"href","#transformers.MPNetForMaskedLM"),v(qt,"class","relative group"),v(mr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetForMaskedLM"),v(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(xt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ko,"id","transformers.MPNetForSequenceClassification"),v(ko,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(ko,"href","#transformers.MPNetForSequenceClassification"),v(jt,"class","relative group"),v(hr,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel"),v(Un,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(Un,"rel","nofollow"),v(fr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetForSequenceClassification"),v(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(wo,"id","transformers.MPNetForMultipleChoice"),v(wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(wo,"href","#transformers.MPNetForMultipleChoice"),v(At,"class","relative group"),v(ur,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel"),v(Gn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(Gn,"rel","nofollow"),v(gr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetForMultipleChoice"),v(et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(yo,"id","transformers.MPNetForTokenClassification"),v(yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(yo,"href","#transformers.MPNetForTokenClassification"),v(It,"class","relative group"),v(_r,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel"),v(ns,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(ns,"rel","nofollow"),v(kr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetForTokenClassification"),v(Re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(qo,"id","transformers.MPNetForQuestionAnswering"),v(qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(qo,"href","#transformers.MPNetForQuestionAnswering"),v(Dt,"class","relative group"),v(br,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.PreTrainedModel"),v(ds,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),v(ds,"rel","nofollow"),v(vr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.MPNetForQuestionAnswering"),v(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Lo,"id","transformers.TFMPNetModel"),v(Lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(Lo,"href","#transformers.TFMPNetModel"),v(Ht,"class","relative group"),v(Tr,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.TFPreTrainedModel"),v(us,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(us,"rel","nofollow"),v(Mr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.TFMPNetModel"),v(tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(So,"id","transformers.TFMPNetForMaskedLM"),v(So,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(So,"href","#transformers.TFMPNetForMaskedLM"),v(Ut,"class","relative group"),v($r,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.TFPreTrainedModel"),v(Ms,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(Ms,"rel","nofollow"),v(wr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.TFMPNetForMaskedLM"),v(Ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ro,"id","transformers.TFMPNetForSequenceClassification"),v(Ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(Ro,"href","#transformers.TFMPNetForSequenceClassification"),v(Bt,"class","relative group"),v(Pr,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.TFPreTrainedModel"),v(Fs,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(Fs,"rel","nofollow"),v(Nr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.TFMPNetForSequenceClassification"),v(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Xo,"id","transformers.TFMPNetForMultipleChoice"),v(Xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(Xo,"href","#transformers.TFMPNetForMultipleChoice"),v(Xt,"class","relative group"),v(yr,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.TFPreTrainedModel"),v(js,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(js,"rel","nofollow"),v(Fr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.TFMPNetForMultipleChoice"),v(ot,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Zo,"id","transformers.TFMPNetForTokenClassification"),v(Zo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(Zo,"href","#transformers.TFMPNetForTokenClassification"),v(Gt,"class","relative group"),v(Er,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.TFPreTrainedModel"),v(Ds,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(Ds,"rel","nofollow"),v(zr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.TFMPNetForTokenClassification"),v(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(sn,"id","transformers.TFMPNetForQuestionAnswering"),v(sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),v(sn,"href","#transformers.TFMPNetForQuestionAnswering"),v(Zt,"class","relative group"),v(qr,"href","/docs/transformers/pr_16834/en/main_classes/model#transformers.TFPreTrainedModel"),v(Vs,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),v(Vs,"rel","nofollow"),v(xr,"href","/docs/transformers/pr_16834/en/model_doc/mpnet#transformers.TFMPNetForQuestionAnswering"),v(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,k){e(document.head,l),_(o,g,k),_(o,c,k),e(c,p),e(p,b),$(d,b,null),e(c,f),e(c,E),e(E,le),_(o,V,k),_(o,z,k),e(z,X),e(X,D),$(G,D,null),e(z,de),e(z,W),e(W,ce),_(o,se,k),_(o,U,k),e(U,O),e(U,Y),e(Y,B),e(U,q),_(o,x,k),_(o,Z,k),e(Z,H),_(o,re,k),_(o,ee,k),e(ee,R),_(o,ae,k),_(o,te,k),e(te,C),e(C,pe),_(o,Q,k),_(o,oe,k),e(oe,me),_(o,L,k),_(o,ne,k),e(ne,j),e(j,he),e(j,u),e(u,F),e(j,K),e(j,_e),e(_e,Me),e(j,I),e(j,ke),e(ke,$e),e(j,we),_(o,A,k),_(o,S,k),e(S,Pe),e(S,ge),e(ge,fe),e(S,Ne),_(o,ie,k),_(o,ue,k),e(ue,no),e(no,Kr),$(un,Kr,null),e(ue,Gl),e(ue,Xr),e(Xr,Yl),_(o,qi,k),_(o,Ge,k),$(gn,Ge,null),e(Ge,Zl),e(Ge,dt),e(dt,ed),e(dt,tr),e(tr,td),e(dt,od),e(dt,or),e(or,nd),e(dt,sd),e(dt,_n),e(_n,rd),e(dt,ad),e(Ge,id),e(Ge,Nt),e(Nt,ld),e(Nt,nr),e(nr,dd),e(Nt,cd),e(Nt,sr),e(sr,pd),e(Nt,md),e(Ge,hd),$(so,Ge,null),_(o,xi,k),_(o,yt,k),e(yt,ro),e(ro,Jr),$(kn,Jr,null),e(yt,fd),e(yt,Gr),e(Gr,ud),_(o,Ci,k),_(o,Ee,k),$(bn,Ee,null),e(Ee,gd),e(Ee,vn),e(vn,_d),e(vn,rr),e(rr,kd),e(vn,bd),e(Ee,vd),e(Ee,ht),$(Tn,ht,null),e(ht,Td),e(ht,Yr),e(Yr,Md),e(ht,$d),e(ht,Mn),e(Mn,ar),e(ar,wd),e(ar,Zr),e(Zr,Pd),e(Mn,Nd),e(Mn,ir),e(ir,yd),e(ir,ea),e(ea,Fd),e(Ee,Ed),e(Ee,ao),$($n,ao,null),e(ao,zd),e(ao,wn),e(wn,qd),e(wn,ta),e(ta,xd),e(wn,Cd),e(Ee,jd),e(Ee,io),$(Pn,io,null),e(io,Ld),e(io,oa),e(oa,Ad),e(Ee,Od),e(Ee,lr),$(Nn,lr,null),_(o,ji,k),_(o,Ft,k),e(Ft,lo),e(lo,na),$(yn,na,null),e(Ft,Id),e(Ft,sa),e(sa,Sd),_(o,Li,k),_(o,Ye,k),$(Fn,Ye,null),e(Ye,Dd),e(Ye,En),e(En,Wd),e(En,ra),e(ra,Qd),e(En,Hd),e(Ye,Rd),e(Ye,zn),e(zn,Ud),e(zn,dr),e(dr,Vd),e(zn,Bd),e(Ye,Kd),e(Ye,co),$(qn,co,null),e(co,Xd),e(co,aa),e(aa,Jd),_(o,Ai,k),_(o,Et,k),e(Et,po),e(po,ia),$(xn,ia,null),e(Et,Gd),e(Et,la),e(la,Yd),_(o,Oi,k),_(o,Oe,k),$(Cn,Oe,null),e(Oe,Zd),e(Oe,da),e(da,ec),e(Oe,tc),e(Oe,jn),e(jn,oc),e(jn,cr),e(cr,nc),e(jn,sc),e(Oe,rc),e(Oe,Ln),e(Ln,ac),e(Ln,An),e(An,ic),e(Ln,lc),e(Oe,dc),e(Oe,Ze),$(On,Ze,null),e(Ze,cc),e(Ze,zt),e(zt,pc),e(zt,pr),e(pr,mc),e(zt,hc),e(zt,ca),e(ca,fc),e(zt,uc),e(Ze,gc),$(mo,Ze,null),e(Ze,_c),$(ho,Ze,null),_(o,Ii,k),_(o,qt,k),e(qt,fo),e(fo,pa),$(In,pa,null),e(qt,kc),e(qt,ma),e(ma,bc),_(o,Si,k),_(o,xt,k),$(Sn,xt,null),e(xt,vc),e(xt,He),$(Dn,He,null),e(He,Tc),e(He,Ct),e(Ct,Mc),e(Ct,mr),e(mr,$c),e(Ct,wc),e(Ct,ha),e(ha,Pc),e(Ct,Nc),e(He,yc),$(uo,He,null),e(He,Fc),$(go,He,null),e(He,Ec),$(_o,He,null),_(o,Di,k),_(o,jt,k),e(jt,ko),e(ko,fa),$(Wn,fa,null),e(jt,zc),e(jt,ua),e(ua,qc),_(o,Wi,k),_(o,Ie,k),$(Qn,Ie,null),e(Ie,xc),e(Ie,ga),e(ga,Cc),e(Ie,jc),e(Ie,Hn),e(Hn,Lc),e(Hn,hr),e(hr,Ac),e(Hn,Oc),e(Ie,Ic),e(Ie,Rn),e(Rn,Sc),e(Rn,Un),e(Un,Dc),e(Rn,Wc),e(Ie,Qc),e(Ie,ye),$(Vn,ye,null),e(ye,Hc),e(ye,Lt),e(Lt,Rc),e(Lt,fr),e(fr,Uc),e(Lt,Vc),e(Lt,_a),e(_a,Bc),e(Lt,Kc),e(ye,Xc),$(bo,ye,null),e(ye,Jc),$(vo,ye,null),e(ye,Gc),$(To,ye,null),e(ye,Yc),$(Mo,ye,null),e(ye,Zc),$($o,ye,null),_(o,Qi,k),_(o,At,k),e(At,wo),e(wo,ka),$(Bn,ka,null),e(At,ep),e(At,ba),e(ba,tp),_(o,Hi,k),_(o,Se,k),$(Kn,Se,null),e(Se,op),e(Se,va),e(va,np),e(Se,sp),e(Se,Xn),e(Xn,rp),e(Xn,ur),e(ur,ap),e(Xn,ip),e(Se,lp),e(Se,Jn),e(Jn,dp),e(Jn,Gn),e(Gn,cp),e(Jn,pp),e(Se,mp),e(Se,et),$(Yn,et,null),e(et,hp),e(et,Ot),e(Ot,fp),e(Ot,gr),e(gr,up),e(Ot,gp),e(Ot,Ta),e(Ta,_p),e(Ot,kp),e(et,bp),$(Po,et,null),e(et,vp),$(No,et,null),_(o,Ri,k),_(o,It,k),e(It,yo),e(yo,Ma),$(Zn,Ma,null),e(It,Tp),e(It,$a),e($a,Mp),_(o,Ui,k),_(o,De,k),$(es,De,null),e(De,$p),e(De,wa),e(wa,wp),e(De,Pp),e(De,ts),e(ts,Np),e(ts,_r),e(_r,yp),e(ts,Fp),e(De,Ep),e(De,os),e(os,zp),e(os,ns),e(ns,qp),e(os,xp),e(De,Cp),e(De,Re),$(ss,Re,null),e(Re,jp),e(Re,St),e(St,Lp),e(St,kr),e(kr,Ap),e(St,Op),e(St,Pa),e(Pa,Ip),e(St,Sp),e(Re,Dp),$(Fo,Re,null),e(Re,Wp),$(Eo,Re,null),e(Re,Qp),$(zo,Re,null),_(o,Vi,k),_(o,Dt,k),e(Dt,qo),e(qo,Na),$(rs,Na,null),e(Dt,Hp),e(Dt,ya),e(ya,Rp),_(o,Bi,k),_(o,We,k),$(as,We,null),e(We,Up),e(We,Wt),e(Wt,Vp),e(Wt,Fa),e(Fa,Bp),e(Wt,Kp),e(Wt,Ea),e(Ea,Xp),e(Wt,Jp),e(We,Gp),e(We,is),e(is,Yp),e(is,br),e(br,Zp),e(is,em),e(We,tm),e(We,ls),e(ls,om),e(ls,ds),e(ds,nm),e(ls,sm),e(We,rm),e(We,Ue),$(cs,Ue,null),e(Ue,am),e(Ue,Qt),e(Qt,im),e(Qt,vr),e(vr,lm),e(Qt,dm),e(Qt,za),e(za,cm),e(Qt,pm),e(Ue,mm),$(xo,Ue,null),e(Ue,hm),$(Co,Ue,null),e(Ue,fm),$(jo,Ue,null),_(o,Ki,k),_(o,Ht,k),e(Ht,Lo),e(Lo,qa),$(ps,qa,null),e(Ht,um),e(Ht,xa),e(xa,gm),_(o,Xi,k),_(o,ze,k),$(ms,ze,null),e(ze,_m),e(ze,Ca),e(Ca,km),e(ze,bm),e(ze,hs),e(hs,vm),e(hs,Tr),e(Tr,Tm),e(hs,Mm),e(ze,$m),e(ze,fs),e(fs,wm),e(fs,us),e(us,Pm),e(fs,Nm),e(ze,ym),$(Ao,ze,null),e(ze,Fm),e(ze,tt),$(gs,tt,null),e(tt,Em),e(tt,Rt),e(Rt,zm),e(Rt,Mr),e(Mr,qm),e(Rt,xm),e(Rt,ja),e(ja,Cm),e(Rt,jm),e(tt,Lm),$(Oo,tt,null),e(tt,Am),$(Io,tt,null),_(o,Ji,k),_(o,Ut,k),e(Ut,So),e(So,La),$(_s,La,null),e(Ut,Om),e(Ut,Aa),e(Aa,Im),_(o,Gi,k),_(o,qe,k),$(ks,qe,null),e(qe,Sm),e(qe,bs),e(bs,Dm),e(bs,Oa),e(Oa,Wm),e(bs,Qm),e(qe,Hm),e(qe,vs),e(vs,Rm),e(vs,$r),e($r,Um),e(vs,Vm),e(qe,Bm),e(qe,Ts),e(Ts,Km),e(Ts,Ms),e(Ms,Xm),e(Ts,Jm),e(qe,Gm),$(Do,qe,null),e(qe,Ym),e(qe,Ve),$($s,Ve,null),e(Ve,Zm),e(Ve,Vt),e(Vt,eh),e(Vt,wr),e(wr,th),e(Vt,oh),e(Vt,Ia),e(Ia,nh),e(Vt,sh),e(Ve,rh),$(Wo,Ve,null),e(Ve,ah),$(Qo,Ve,null),e(Ve,ih),$(Ho,Ve,null),_(o,Yi,k),_(o,Bt,k),e(Bt,Ro),e(Ro,Sa),$(ws,Sa,null),e(Bt,lh),e(Bt,Da),e(Da,dh),_(o,Zi,k),_(o,xe,k),$(Ps,xe,null),e(xe,ch),e(xe,Wa),e(Wa,ph),e(xe,mh),e(xe,Ns),e(Ns,hh),e(Ns,Pr),e(Pr,fh),e(Ns,uh),e(xe,gh),e(xe,ys),e(ys,_h),e(ys,Fs),e(Fs,kh),e(ys,bh),e(xe,vh),$(Uo,xe,null),e(xe,Th),e(xe,Be),$(Es,Be,null),e(Be,Mh),e(Be,Kt),e(Kt,$h),e(Kt,Nr),e(Nr,wh),e(Kt,Ph),e(Kt,Qa),e(Qa,Nh),e(Kt,yh),e(Be,Fh),$(Vo,Be,null),e(Be,Eh),$(Bo,Be,null),e(Be,zh),$(Ko,Be,null),_(o,el,k),_(o,Xt,k),e(Xt,Xo),e(Xo,Ha),$(zs,Ha,null),e(Xt,qh),e(Xt,Ra),e(Ra,xh),_(o,tl,k),_(o,Ce,k),$(qs,Ce,null),e(Ce,Ch),e(Ce,Ua),e(Ua,jh),e(Ce,Lh),e(Ce,xs),e(xs,Ah),e(xs,yr),e(yr,Oh),e(xs,Ih),e(Ce,Sh),e(Ce,Cs),e(Cs,Dh),e(Cs,js),e(js,Wh),e(Cs,Qh),e(Ce,Hh),$(Jo,Ce,null),e(Ce,Rh),e(Ce,ot),$(Ls,ot,null),e(ot,Uh),e(ot,Jt),e(Jt,Vh),e(Jt,Fr),e(Fr,Bh),e(Jt,Kh),e(Jt,Va),e(Va,Xh),e(Jt,Jh),e(ot,Gh),$(Go,ot,null),e(ot,Yh),$(Yo,ot,null),_(o,ol,k),_(o,Gt,k),e(Gt,Zo),e(Zo,Ba),$(As,Ba,null),e(Gt,Zh),e(Gt,Ka),e(Ka,ef),_(o,nl,k),_(o,je,k),$(Os,je,null),e(je,tf),e(je,Xa),e(Xa,of),e(je,nf),e(je,Is),e(Is,sf),e(Is,Er),e(Er,rf),e(Is,af),e(je,lf),e(je,Ss),e(Ss,df),e(Ss,Ds),e(Ds,cf),e(Ss,pf),e(je,mf),$(en,je,null),e(je,hf),e(je,Ke),$(Ws,Ke,null),e(Ke,ff),e(Ke,Yt),e(Yt,uf),e(Yt,zr),e(zr,gf),e(Yt,_f),e(Yt,Ja),e(Ja,kf),e(Yt,bf),e(Ke,vf),$(tn,Ke,null),e(Ke,Tf),$(on,Ke,null),e(Ke,Mf),$(nn,Ke,null),_(o,sl,k),_(o,Zt,k),e(Zt,sn),e(sn,Ga),$(Qs,Ga,null),e(Zt,$f),e(Zt,Ya),e(Ya,wf),_(o,rl,k),_(o,Le,k),$(Hs,Le,null),e(Le,Pf),e(Le,eo),e(eo,Nf),e(eo,Za),e(Za,yf),e(eo,Ff),e(eo,ei),e(ei,Ef),e(eo,zf),e(Le,qf),e(Le,Rs),e(Rs,xf),e(Rs,qr),e(qr,Cf),e(Rs,jf),e(Le,Lf),e(Le,Us),e(Us,Af),e(Us,Vs),e(Vs,Of),e(Us,If),e(Le,Sf),$(rn,Le,null),e(Le,Df),e(Le,Xe),$(Bs,Xe,null),e(Xe,Wf),e(Xe,to),e(to,Qf),e(to,xr),e(xr,Hf),e(to,Rf),e(to,ti),e(ti,Uf),e(to,Vf),e(Xe,Bf),$(an,Xe,null),e(Xe,Kf),$(ln,Xe,null),e(Xe,Xf),$(dn,Xe,null),al=!0},p(o,[k]){const Ks={};k&2&&(Ks.$$scope={dirty:k,ctx:o}),so.$set(Ks);const oi={};k&2&&(oi.$$scope={dirty:k,ctx:o}),mo.$set(oi);const ni={};k&2&&(ni.$$scope={dirty:k,ctx:o}),ho.$set(ni);const si={};k&2&&(si.$$scope={dirty:k,ctx:o}),uo.$set(si);const Xs={};k&2&&(Xs.$$scope={dirty:k,ctx:o}),go.$set(Xs);const ri={};k&2&&(ri.$$scope={dirty:k,ctx:o}),_o.$set(ri);const ai={};k&2&&(ai.$$scope={dirty:k,ctx:o}),bo.$set(ai);const ii={};k&2&&(ii.$$scope={dirty:k,ctx:o}),vo.$set(ii);const Js={};k&2&&(Js.$$scope={dirty:k,ctx:o}),To.$set(Js);const li={};k&2&&(li.$$scope={dirty:k,ctx:o}),Mo.$set(li);const di={};k&2&&(di.$$scope={dirty:k,ctx:o}),$o.$set(di);const ci={};k&2&&(ci.$$scope={dirty:k,ctx:o}),Po.$set(ci);const pi={};k&2&&(pi.$$scope={dirty:k,ctx:o}),No.$set(pi);const mi={};k&2&&(mi.$$scope={dirty:k,ctx:o}),Fo.$set(mi);const hi={};k&2&&(hi.$$scope={dirty:k,ctx:o}),Eo.$set(hi);const fi={};k&2&&(fi.$$scope={dirty:k,ctx:o}),zo.$set(fi);const ct={};k&2&&(ct.$$scope={dirty:k,ctx:o}),xo.$set(ct);const ui={};k&2&&(ui.$$scope={dirty:k,ctx:o}),Co.$set(ui);const gi={};k&2&&(gi.$$scope={dirty:k,ctx:o}),jo.$set(gi);const _i={};k&2&&(_i.$$scope={dirty:k,ctx:o}),Ao.$set(_i);const Gs={};k&2&&(Gs.$$scope={dirty:k,ctx:o}),Oo.$set(Gs);const ki={};k&2&&(ki.$$scope={dirty:k,ctx:o}),Io.$set(ki);const Ys={};k&2&&(Ys.$$scope={dirty:k,ctx:o}),Do.$set(Ys);const bi={};k&2&&(bi.$$scope={dirty:k,ctx:o}),Wo.$set(bi);const vi={};k&2&&(vi.$$scope={dirty:k,ctx:o}),Qo.$set(vi);const Ti={};k&2&&(Ti.$$scope={dirty:k,ctx:o}),Ho.$set(Ti);const pt={};k&2&&(pt.$$scope={dirty:k,ctx:o}),Uo.$set(pt);const mt={};k&2&&(mt.$$scope={dirty:k,ctx:o}),Vo.$set(mt);const Mi={};k&2&&(Mi.$$scope={dirty:k,ctx:o}),Bo.$set(Mi);const $i={};k&2&&($i.$$scope={dirty:k,ctx:o}),Ko.$set($i);const wi={};k&2&&(wi.$$scope={dirty:k,ctx:o}),Jo.$set(wi);const oo={};k&2&&(oo.$$scope={dirty:k,ctx:o}),Go.$set(oo);const Pi={};k&2&&(Pi.$$scope={dirty:k,ctx:o}),Yo.$set(Pi);const Ni={};k&2&&(Ni.$$scope={dirty:k,ctx:o}),en.$set(Ni);const Zs={};k&2&&(Zs.$$scope={dirty:k,ctx:o}),tn.$set(Zs);const yi={};k&2&&(yi.$$scope={dirty:k,ctx:o}),on.$set(yi);const Fi={};k&2&&(Fi.$$scope={dirty:k,ctx:o}),nn.$set(Fi);const Ei={};k&2&&(Ei.$$scope={dirty:k,ctx:o}),rn.$set(Ei);const Qe={};k&2&&(Qe.$$scope={dirty:k,ctx:o}),an.$set(Qe);const er={};k&2&&(er.$$scope={dirty:k,ctx:o}),ln.$set(er);const zi={};k&2&&(zi.$$scope={dirty:k,ctx:o}),dn.$set(zi)},i(o){al||(w(d.$$.fragment,o),w(G.$$.fragment,o),w(un.$$.fragment,o),w(gn.$$.fragment,o),w(so.$$.fragment,o),w(kn.$$.fragment,o),w(bn.$$.fragment,o),w(Tn.$$.fragment,o),w($n.$$.fragment,o),w(Pn.$$.fragment,o),w(Nn.$$.fragment,o),w(yn.$$.fragment,o),w(Fn.$$.fragment,o),w(qn.$$.fragment,o),w(xn.$$.fragment,o),w(Cn.$$.fragment,o),w(On.$$.fragment,o),w(mo.$$.fragment,o),w(ho.$$.fragment,o),w(In.$$.fragment,o),w(Sn.$$.fragment,o),w(Dn.$$.fragment,o),w(uo.$$.fragment,o),w(go.$$.fragment,o),w(_o.$$.fragment,o),w(Wn.$$.fragment,o),w(Qn.$$.fragment,o),w(Vn.$$.fragment,o),w(bo.$$.fragment,o),w(vo.$$.fragment,o),w(To.$$.fragment,o),w(Mo.$$.fragment,o),w($o.$$.fragment,o),w(Bn.$$.fragment,o),w(Kn.$$.fragment,o),w(Yn.$$.fragment,o),w(Po.$$.fragment,o),w(No.$$.fragment,o),w(Zn.$$.fragment,o),w(es.$$.fragment,o),w(ss.$$.fragment,o),w(Fo.$$.fragment,o),w(Eo.$$.fragment,o),w(zo.$$.fragment,o),w(rs.$$.fragment,o),w(as.$$.fragment,o),w(cs.$$.fragment,o),w(xo.$$.fragment,o),w(Co.$$.fragment,o),w(jo.$$.fragment,o),w(ps.$$.fragment,o),w(ms.$$.fragment,o),w(Ao.$$.fragment,o),w(gs.$$.fragment,o),w(Oo.$$.fragment,o),w(Io.$$.fragment,o),w(_s.$$.fragment,o),w(ks.$$.fragment,o),w(Do.$$.fragment,o),w($s.$$.fragment,o),w(Wo.$$.fragment,o),w(Qo.$$.fragment,o),w(Ho.$$.fragment,o),w(ws.$$.fragment,o),w(Ps.$$.fragment,o),w(Uo.$$.fragment,o),w(Es.$$.fragment,o),w(Vo.$$.fragment,o),w(Bo.$$.fragment,o),w(Ko.$$.fragment,o),w(zs.$$.fragment,o),w(qs.$$.fragment,o),w(Jo.$$.fragment,o),w(Ls.$$.fragment,o),w(Go.$$.fragment,o),w(Yo.$$.fragment,o),w(As.$$.fragment,o),w(Os.$$.fragment,o),w(en.$$.fragment,o),w(Ws.$$.fragment,o),w(tn.$$.fragment,o),w(on.$$.fragment,o),w(nn.$$.fragment,o),w(Qs.$$.fragment,o),w(Hs.$$.fragment,o),w(rn.$$.fragment,o),w(Bs.$$.fragment,o),w(an.$$.fragment,o),w(ln.$$.fragment,o),w(dn.$$.fragment,o),al=!0)},o(o){P(d.$$.fragment,o),P(G.$$.fragment,o),P(un.$$.fragment,o),P(gn.$$.fragment,o),P(so.$$.fragment,o),P(kn.$$.fragment,o),P(bn.$$.fragment,o),P(Tn.$$.fragment,o),P($n.$$.fragment,o),P(Pn.$$.fragment,o),P(Nn.$$.fragment,o),P(yn.$$.fragment,o),P(Fn.$$.fragment,o),P(qn.$$.fragment,o),P(xn.$$.fragment,o),P(Cn.$$.fragment,o),P(On.$$.fragment,o),P(mo.$$.fragment,o),P(ho.$$.fragment,o),P(In.$$.fragment,o),P(Sn.$$.fragment,o),P(Dn.$$.fragment,o),P(uo.$$.fragment,o),P(go.$$.fragment,o),P(_o.$$.fragment,o),P(Wn.$$.fragment,o),P(Qn.$$.fragment,o),P(Vn.$$.fragment,o),P(bo.$$.fragment,o),P(vo.$$.fragment,o),P(To.$$.fragment,o),P(Mo.$$.fragment,o),P($o.$$.fragment,o),P(Bn.$$.fragment,o),P(Kn.$$.fragment,o),P(Yn.$$.fragment,o),P(Po.$$.fragment,o),P(No.$$.fragment,o),P(Zn.$$.fragment,o),P(es.$$.fragment,o),P(ss.$$.fragment,o),P(Fo.$$.fragment,o),P(Eo.$$.fragment,o),P(zo.$$.fragment,o),P(rs.$$.fragment,o),P(as.$$.fragment,o),P(cs.$$.fragment,o),P(xo.$$.fragment,o),P(Co.$$.fragment,o),P(jo.$$.fragment,o),P(ps.$$.fragment,o),P(ms.$$.fragment,o),P(Ao.$$.fragment,o),P(gs.$$.fragment,o),P(Oo.$$.fragment,o),P(Io.$$.fragment,o),P(_s.$$.fragment,o),P(ks.$$.fragment,o),P(Do.$$.fragment,o),P($s.$$.fragment,o),P(Wo.$$.fragment,o),P(Qo.$$.fragment,o),P(Ho.$$.fragment,o),P(ws.$$.fragment,o),P(Ps.$$.fragment,o),P(Uo.$$.fragment,o),P(Es.$$.fragment,o),P(Vo.$$.fragment,o),P(Bo.$$.fragment,o),P(Ko.$$.fragment,o),P(zs.$$.fragment,o),P(qs.$$.fragment,o),P(Jo.$$.fragment,o),P(Ls.$$.fragment,o),P(Go.$$.fragment,o),P(Yo.$$.fragment,o),P(As.$$.fragment,o),P(Os.$$.fragment,o),P(en.$$.fragment,o),P(Ws.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(Qs.$$.fragment,o),P(Hs.$$.fragment,o),P(rn.$$.fragment,o),P(Bs.$$.fragment,o),P(an.$$.fragment,o),P(ln.$$.fragment,o),P(dn.$$.fragment,o),al=!1},d(o){t(l),o&&t(g),o&&t(c),N(d),o&&t(V),o&&t(z),N(G),o&&t(se),o&&t(U),o&&t(x),o&&t(Z),o&&t(re),o&&t(ee),o&&t(ae),o&&t(te),o&&t(Q),o&&t(oe),o&&t(L),o&&t(ne),o&&t(A),o&&t(S),o&&t(ie),o&&t(ue),N(un),o&&t(qi),o&&t(Ge),N(gn),N(so),o&&t(xi),o&&t(yt),N(kn),o&&t(Ci),o&&t(Ee),N(bn),N(Tn),N($n),N(Pn),N(Nn),o&&t(ji),o&&t(Ft),N(yn),o&&t(Li),o&&t(Ye),N(Fn),N(qn),o&&t(Ai),o&&t(Et),N(xn),o&&t(Oi),o&&t(Oe),N(Cn),N(On),N(mo),N(ho),o&&t(Ii),o&&t(qt),N(In),o&&t(Si),o&&t(xt),N(Sn),N(Dn),N(uo),N(go),N(_o),o&&t(Di),o&&t(jt),N(Wn),o&&t(Wi),o&&t(Ie),N(Qn),N(Vn),N(bo),N(vo),N(To),N(Mo),N($o),o&&t(Qi),o&&t(At),N(Bn),o&&t(Hi),o&&t(Se),N(Kn),N(Yn),N(Po),N(No),o&&t(Ri),o&&t(It),N(Zn),o&&t(Ui),o&&t(De),N(es),N(ss),N(Fo),N(Eo),N(zo),o&&t(Vi),o&&t(Dt),N(rs),o&&t(Bi),o&&t(We),N(as),N(cs),N(xo),N(Co),N(jo),o&&t(Ki),o&&t(Ht),N(ps),o&&t(Xi),o&&t(ze),N(ms),N(Ao),N(gs),N(Oo),N(Io),o&&t(Ji),o&&t(Ut),N(_s),o&&t(Gi),o&&t(qe),N(ks),N(Do),N($s),N(Wo),N(Qo),N(Ho),o&&t(Yi),o&&t(Bt),N(ws),o&&t(Zi),o&&t(xe),N(Ps),N(Uo),N(Es),N(Vo),N(Bo),N(Ko),o&&t(el),o&&t(Xt),N(zs),o&&t(tl),o&&t(Ce),N(qs),N(Jo),N(Ls),N(Go),N(Yo),o&&t(ol),o&&t(Gt),N(As),o&&t(nl),o&&t(je),N(Os),N(en),N(Ws),N(tn),N(on),N(nn),o&&t(sl),o&&t(Zt),N(Qs),o&&t(rl),o&&t(Le),N(Hs),N(rn),N(Bs),N(an),N(ln),N(dn)}}}const R_={local:"mpnet",sections:[{local:"overview",title:"Overview"},{local:"transformers.MPNetConfig",title:"MPNetConfig"},{local:"transformers.MPNetTokenizer",title:"MPNetTokenizer"},{local:"transformers.MPNetTokenizerFast",title:"MPNetTokenizerFast"},{local:"transformers.MPNetModel",title:"MPNetModel"},{local:"transformers.MPNetForMaskedLM",title:"MPNetForMaskedLM"},{local:"transformers.MPNetForSequenceClassification",title:"MPNetForSequenceClassification"},{local:"transformers.MPNetForMultipleChoice",title:"MPNetForMultipleChoice"},{local:"transformers.MPNetForTokenClassification",title:"MPNetForTokenClassification"},{local:"transformers.MPNetForQuestionAnswering",title:"MPNetForQuestionAnswering"},{local:"transformers.TFMPNetModel",title:"TFMPNetModel"},{local:"transformers.TFMPNetForMaskedLM",title:"TFMPNetForMaskedLM"},{local:"transformers.TFMPNetForSequenceClassification",title:"TFMPNetForSequenceClassification"},{local:"transformers.TFMPNetForMultipleChoice",title:"TFMPNetForMultipleChoice"},{local:"transformers.TFMPNetForTokenClassification",title:"TFMPNetForTokenClassification"},{local:"transformers.TFMPNetForQuestionAnswering",title:"TFMPNetForQuestionAnswering"}],title:"MPNet"};function U_(y){return t_(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Y_ extends Gg{constructor(l){super();Yg(this,l,U_,H_,Zg,{})}}export{Y_ as default,R_ as metadata};
