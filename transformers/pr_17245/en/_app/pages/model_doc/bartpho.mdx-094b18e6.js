import{S as jo,i as Do,s as So,e as n,k as d,w as _,t as r,M as Mo,c as s,d as o,m as c,a,x as k,h as i,b as p,F as t,g as h,y as b,L as Io,q as v,o as T,B as w,v as No}from"../../chunks/vendor-6b77c823.js";import{D as Ae}from"../../chunks/Docstring-1088f2fb.js";import{C as Lo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as eo}from"../../chunks/IconCopyLink-7a11ce68.js";function Co(to){let y,$e,q,$,me,D,et,ue,tt,Ee,B,E,fe,S,ot,ge,nt,xe,x,st,M,at,rt,Re,Z,it,Pe,ee,_e,lt,Le,te,pt,je,I,De,oe,dt,Se,ne,N,ct,se,ht,mt,Me,C,Ie,ae,ke,ut,Ne,f,ft,O,gt,_t,F,kt,bt,Ce,z,R,be,V,vt,ve,Tt,Oe,m,X,wt,A,yt,re,qt,Bt,W,zt,At,$t,U,Et,ie,xt,Rt,Pt,g,G,Lt,Te,jt,Dt,H,le,St,we,Mt,It,pe,Nt,ye,Ct,Ot,P,K,Ft,qe,Vt,Xt,L,Q,Wt,Be,Ut,Gt,j,J,Ht,Y,Kt,ze,Qt,Jt,Fe;return D=new eo({}),S=new eo({}),I=new Lo({props:{code:`import torch
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17245/src/transformers/models/bartpho/tokenization_bartpho.py#L193",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),K=new Ae({props:{name:"convert_tokens_to_string",anchor:"transformers.BartphoTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17245/src/transformers/models/bartpho/tokenization_bartpho.py#L295"}}),Q=new Ae({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17245/src/transformers/models/bartpho/tokenization_bartpho.py#L247",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17245/src/transformers/models/bartpho/tokenization_bartpho.py#L219",returnDescription:`
...
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),Ne=d(),f=n("p"),ft=r("This model was contributed by "),O=n("a"),gt=r("dqnguyen"),_t=r(". The original code can be found "),F=n("a"),kt=r("here"),bt=r("."),Ce=d(),z=n("h2"),R=n("a"),be=n("span"),_(V.$$.fragment),vt=d(),ve=n("span"),Tt=r("BartphoTokenizer"),Oe=d(),m=n("div"),_(X.$$.fragment),wt=d(),A=n("p"),yt=r("Adapted from "),re=n("a"),qt=r("XLMRobertaTokenizer"),Bt=r(". Based on "),W=n("a"),zt=r("SentencePiece"),At=r("."),$t=d(),U=n("p"),Et=r("This tokenizer inherits from "),ie=n("a"),xt=r("PreTrainedTokenizer"),Rt=r(` which contains most of the main methods. Users should refer to
...
adding special tokens. An BARTPho sequence has the following format:`),Dt=d(),H=n("ul"),le=n("li"),St=r("single sequence: "),we=n("code"),Mt=r("<s> X </s>"),It=d(),pe=n("li"),Nt=r("pair of sequences: "),ye=n("code"),Ct=r("<s> A </s></s> B </s>"),Ot=d(),P=n("div"),_(K.$$.fragment),Ft=d(),qe=n("p"),Vt=r("Converts a sequence of tokens (strings for sub-words) in a single string."),Xt=d(),L=n("div"),_(Q.$$.fragment),Wt=d(),Be=n("p"),Ut=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
