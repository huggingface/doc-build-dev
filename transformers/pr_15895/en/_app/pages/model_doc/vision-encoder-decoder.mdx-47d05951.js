...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15895/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_15895/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
`}}),ve=new Vd({props:{$$slots:{default:[ic]},$$scope:{ctx:Q}}}),Re=new yo({props:{codee:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests
...
<a href="/docs/transformers/pr_15895/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),Ge=new yo({props:{codee:`from transformers import VisionEncoderDecoderModel
...
`}}),Te=new Vd({props:{$$slots:{default:[cc]},$$scope:{ctx:Q}}}),oo=new yo({props:{codee:`from transformers import AutoFeatureExtractor, AutoTokenizer, TFVisionEncoderDecoderModel
from PIL import Image
import requests
...
example is <code>google/vit-base-patch16-224-in21k</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15895/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),no=new yo({props:{codee:`from transformers import TFVisionEncoderDecoderModel
...
`}}),ye=new Vd({props:{$$slots:{default:[lc]},$$scope:{ctx:Q}}}),uo=new yo({props:{codee:`from transformers import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
from PIL import Image
import requests
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),_o=new yo({props:{codee:`from transformers import FlaxVisionEncoderDecoderModel
