...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16047/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16047/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16047/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16047/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16047/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
the visible scope of available GPUs. Instead, you have to use the following syntax:`),K5=u(),f(xo.$$.fragment),J5=u(),Kf=o("p"),X5=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),lw=u(),vi=o("a"),rw=u(),As=o("h3"),Nt=o("a"),Jf=o("span"),f(Ro.$$.fragment),Q5=u(),Xf=o("span"),e7=a("Deployment in Notebooks"),pw=u(),Ht=o("p"),s7=a("The problem with running notebook cells as a script is that there is no normal "),Qf=o("code"),t7=a("deepspeed"),a7=a(` launcher to rely on, so
under certain setups we have to emulate it.`),iw=u(),ji=o("p"),n7=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),uw=u(),f(Io.$$.fragment),cw=u(),Bt=o("p"),o7=a("Note: "),ed=o("code"),l7=a("..."),r7=a(" stands for the normal arguments that you\u2019d pass to the functions."),hw=u(),gi=o("p"),p7=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),fw=u(),wi=o("p"),i7=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),dw=u(),f(Uo.$$.fragment),mw=u(),Le=o("p"),u7=a("If the training script is in a normal file and not in the notebook cells, you can launch "),sd=o("code"),c7=a("deepspeed"),h7=a(` normally via
shell from a cell. For example, to use `),td=o("code"),f7=a("run_translation.py"),d7=a(" you would launch it with:"),_w=u(),f(Go.$$.fragment),vw=u(),Wt=o("p"),m7=a("or with "),ad=o("code"),_7=a("%%bash"),v7=a(" magic, where you can write a multi-line code for the shell program to run:"),jw=u(),f(Lo.$$.fragment),gw=u(),yi=o("p"),j7=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),ww=u(),Ft=o("p"),g7=a("Note: While "),nd=o("code"),w7=a("%%bash"),y7=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),yw=u(),bi=o("a"),bw=u(),Ss=o("h3"),Vt=o("a"),od=o("span"),f(Mo.$$.fragment),b7=u(),ld=o("span"),E7=a("Configuration"),Ew=u(),Yt=o("p"),q7=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Zo=o("a"),$7=a("following documentation"),k7=a("."),qw=u(),Kt=o("p"),P7=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),No=o("a"),D7=a(`the DeepSpeedExamples
repo`),z7=a(":"),$w=u(),f(Ho.$$.fragment),kw=u(),Jt=o("p"),O7=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),rd=o("code"),T7=a(".json"),A7=a(" files with:"),Pw=u(),f(Bo.$$.fragment),Dw=u(),Xt=o("p"),S7=a("Some more examples are to be found in the "),Wo=o("a"),C7=a("main repo"),x7=a(" as well."),zw=u(),Ei=o("p"),R7=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Ow=u(),oe=o("p"),I7=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),pd=o("code"),U7=a("AdamW"),G7=a(" optimizer and "),id=o("code"),L7=a("WarmupLR"),M7=a(` scheduler and will enable mixed
precision training if `),ud=o("code"),Z7=a("--fp16"),N7=a(" is passed:"),Tw=u(),f(Fo.$$.fragment),Aw=u(),Qt=o("p"),H7=a("When you execute the program, DeepSpeed will log the configuration it received from the "),qi=o("a"),B7=a("Trainer"),W7=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),Sw=u(),$i=o("a"),Cw=u(),Cs=o("h3"),ea=o("a"),cd=o("span"),f(Vo.$$.fragment),F7=u(),hd=o("span"),V7=a("Passing Configuration"),xw=u(),G=o("p"),Y7=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),ki=o("a"),K7=a("Trainer"),J7=a(" via "),Pi=o("a"),X7=a("TrainingArguments"),Q7=a(" then for the "),fd=o("code"),e8=a("deepspeed"),s8=a(` argument you can
...
and its typically accessed much faster than normal CPU memory.`),vy=u(),Yi=o("p"),Wd=o("strong"),Bk=a("Performance tuning:"),jy=u(),ua=o("ul"),pl=o("li"),Fd=o("code"),Wk=a("stage3_max_live_parameters"),Fk=a(": "),Vd=o("code"),Vk=a("1e9"),Yk=u(),il=o("li"),Yd=o("code"),Kk=a("stage3_max_reuse_distance"),Jk=a(": "),Kd=o("code"),Xk=a("1e9"),gy=u(),M=o("p"),Qk=a("If hitting OOM reduce "),Jd=o("code"),e9=a("stage3_max_live_parameters"),s9=a(" and "),Xd=o("code"),t9=a("stage3_max_reuse_distance"),a9=a(`. They should have minimal impact
...
the visible scope of available GPUs. Instead, you have to use the following syntax:`),EE.forEach(t),K5=c(dh),d(xo.$$.fragment,dh),J5=c(dh),Kf=l(dh,"P",{});var pM=r(Kf);X5=n(pM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pM.forEach(t),dh.forEach(t),lM.forEach(t),lw=c(e),vi=l(e,"A",{id:!0}),r(vi).forEach(t),rw=c(e),As=l(e,"H3",{class:!0});var qE=r(As);Nt=l(qE,"A",{id:!0,class:!0,href:!0});var iM=r(Nt);Jf=l(iM,"SPAN",{});var uM=r(Jf);d(Ro.$$.fragment,uM),uM.forEach(t),iM.forEach(t),Q5=c(qE),Xf=l(qE,"SPAN",{});var cM=r(Xf);e7=n(cM,"Deployment in Notebooks"),cM.forEach(t),qE.forEach(t),pw=c(e),Ht=l(e,"P",{});var $E=r(Ht);s7=n($E,"The problem with running notebook cells as a script is that there is no normal "),Qf=l($E,"CODE",{});var hM=r(Qf);t7=n(hM,"deepspeed"),hM.forEach(t),a7=n($E,` launcher to rely on, so
under certain setups we have to emulate it.`),$E.forEach(t),iw=c(e),ji=l(e,"P",{});var fM=r(ji);n7=n(fM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),fM.forEach(t),uw=c(e),d(Io.$$.fragment,e),cw=c(e),Bt=l(e,"P",{});var kE=r(Bt);o7=n(kE,"Note: "),ed=l(kE,"CODE",{});var dM=r(ed);l7=n(dM,"..."),dM.forEach(t),r7=n(kE," stands for the normal arguments that you\u2019d pass to the functions."),kE.forEach(t),hw=c(e),gi=l(e,"P",{});var mM=r(gi);p7=n(mM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),mM.forEach(t),fw=c(e),wi=l(e,"P",{});var _M=r(wi);i7=n(_M,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),_M.forEach(t),dw=c(e),d(Uo.$$.fragment,e),mw=c(e),Le=l(e,"P",{});var mh=r(Le);u7=n(mh,"If the training script is in a normal file and not in the notebook cells, you can launch "),sd=l(mh,"CODE",{});var vM=r(sd);c7=n(vM,"deepspeed"),vM.forEach(t),h7=n(mh,` normally via
shell from a cell. For example, to use `),td=l(mh,"CODE",{});var jM=r(td);f7=n(jM,"run_translation.py"),jM.forEach(t),d7=n(mh," you would launch it with:"),mh.forEach(t),_w=c(e),d(Go.$$.fragment,e),vw=c(e),Wt=l(e,"P",{});var PE=r(Wt);m7=n(PE,"or with "),ad=l(PE,"CODE",{});var gM=r(ad);_7=n(gM,"%%bash"),gM.forEach(t),v7=n(PE," magic, where you can write a multi-line code for the shell program to run:"),PE.forEach(t),jw=c(e),d(Lo.$$.fragment,e),gw=c(e),yi=l(e,"P",{});var wM=r(yi);j7=n(wM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),wM.forEach(t),ww=c(e),Ft=l(e,"P",{});var DE=r(Ft);g7=n(DE,"Note: While "),nd=l(DE,"CODE",{});var yM=r(nd);w7=n(yM,"%%bash"),yM.forEach(t),y7=n(DE,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),DE.forEach(t),yw=c(e),bi=l(e,"A",{id:!0}),r(bi).forEach(t),bw=c(e),Ss=l(e,"H3",{class:!0});var zE=r(Ss);Vt=l(zE,"A",{id:!0,class:!0,href:!0});var bM=r(Vt);od=l(bM,"SPAN",{});var EM=r(od);d(Mo.$$.fragment,EM),EM.forEach(t),bM.forEach(t),b7=c(zE),ld=l(zE,"SPAN",{});var qM=r(ld);E7=n(qM,"Configuration"),qM.forEach(t),zE.forEach(t),Ew=c(e),Yt=l(e,"P",{});var OE=r(Yt);q7=n(OE,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Zo=l(OE,"A",{href:!0,rel:!0});var $M=r(Zo);$7=n($M,"following documentation"),$M.forEach(t),k7=n(OE,"."),OE.forEach(t),qw=c(e),Kt=l(e,"P",{});var TE=r(Kt);P7=n(TE,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),No=l(TE,"A",{href:!0,rel:!0});var kM=r(No);D7=n(kM,`the DeepSpeedExamples
repo`),kM.forEach(t),z7=n(TE,":"),TE.forEach(t),$w=c(e),d(Ho.$$.fragment,e),kw=c(e),Jt=l(e,"P",{});var AE=r(Jt);O7=n(AE,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),rd=l(AE,"CODE",{});var PM=r(rd);T7=n(PM,".json"),PM.forEach(t),A7=n(AE," files with:"),AE.forEach(t),Pw=c(e),d(Bo.$$.fragment,e),Dw=c(e),Xt=l(e,"P",{});var SE=r(Xt);S7=n(SE,"Some more examples are to be found in the "),Wo=l(SE,"A",{href:!0,rel:!0});var DM=r(Wo);C7=n(DM,"main repo"),DM.forEach(t),x7=n(SE," as well."),SE.forEach(t),zw=c(e),Ei=l(e,"P",{});var zM=r(Ei);R7=n(zM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),zM.forEach(t),Ow=c(e),oe=l(e,"P",{});var Zn=r(oe);I7=n(Zn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),pd=l(Zn,"CODE",{});var OM=r(pd);U7=n(OM,"AdamW"),OM.forEach(t),G7=n(Zn," optimizer and "),id=l(Zn,"CODE",{});var TM=r(id);L7=n(TM,"WarmupLR"),TM.forEach(t),M7=n(Zn,` scheduler and will enable mixed
precision training if `),ud=l(Zn,"CODE",{});var AM=r(ud);Z7=n(AM,"--fp16"),AM.forEach(t),N7=n(Zn," is passed:"),Zn.forEach(t),Tw=c(e),d(Fo.$$.fragment,e),Aw=c(e),Qt=l(e,"P",{});var CE=r(Qt);H7=n(CE,"When you execute the program, DeepSpeed will log the configuration it received from the "),qi=l(CE,"A",{href:!0});var SM=r(qi);B7=n(SM,"Trainer"),SM.forEach(t),W7=n(CE,`
to the console, so you can see exactly what was the final configuration passed to it.`),CE.forEach(t),Sw=c(e),$i=l(e,"A",{id:!0}),r($i).forEach(t),Cw=c(e),Cs=l(e,"H3",{class:!0});var xE=r(Cs);ea=l(xE,"A",{id:!0,class:!0,href:!0});var CM=r(ea);cd=l(CM,"SPAN",{});var xM=r(cd);d(Vo.$$.fragment,xM),xM.forEach(t),CM.forEach(t),F7=c(xE),hd=l(xE,"SPAN",{});var RM=r(hd);V7=n(RM,"Passing Configuration"),RM.forEach(t),xE.forEach(t),xw=c(e),G=l(e,"P",{});var ye=r(G);Y7=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),ki=l(ye,"A",{href:!0});var IM=r(ki);K7=n(IM,"Trainer"),IM.forEach(t),J7=n(ye," via "),Pi=l(ye,"A",{href:!0});var UM=r(Pi);X7=n(UM,"TrainingArguments"),UM.forEach(t),Q7=n(ye," then for the "),fd=l(ye,"CODE",{});var GM=r(fd);e8=n(GM,"deepspeed"),GM.forEach(t),s8=n(ye,` argument you can
