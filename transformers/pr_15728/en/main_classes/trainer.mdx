...
The [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) class provides an API for feature-complete training in PyTorch for most standard use cases. It's used in most of the [example scripts](../examples).

Before instantiating your [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer), create a [TrainingArguments](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.TrainingArguments) to access all the points of customization during training.
...
The [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) contains the basic training loop which supports the above features. To inject custom behavior you can subclass them and override the following methods:
...
The [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) class is optimized for 🤗 Transformers models and can have surprising behaviors
when you use it on other models. When using it on your own model, make sure:

- your model always return tuples or subclasses of [ModelOutput](/docs/transformers/pr_15728/en/main_classes/output#transformers.file_utils.ModelOutput).
...
Here is an example of how to customize [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) to use a weighted loss (useful when you have an unbalanced training set):
...
<docstring><name>class transformers.Trainer</name><anchor>transformers.Trainer</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L199</source><parameters>[{"name": "model", "val": ": typing.Union[transformers.modeling_utils.PreTrainedModel, torch.nn.modules.module.Module] = None"}, {"name": "args", "val": ": TrainingArguments = None"}, {"name": "data_collator", "val": ": typing.Optional[DataCollator] = None"}, {"name": "train_dataset", "val": ": typing.Optional[torch.utils.data.dataset.Dataset] = None"}, {"name": "eval_dataset", "val": ": typing.Optional[torch.utils.data.dataset.Dataset] = None"}, {"name": "tokenizer", "val": ": typing.Optional[transformers.tokenization_utils_base.PreTrainedTokenizerBase] = None"}, {"name": "model_init", "val": ": typing.Callable[[], transformers.modeling_utils.PreTrainedModel] = None"}, {"name": "compute_metrics", "val": ": typing.Union[typing.Callable[[transformers.trainer_utils.EvalPrediction], typing.Dict], NoneType] = None"}, {"name": "callbacks", "val": ": typing.Optional[typing.List[transformers.trainer_callback.TrainerCallback]] = None"}, {"name": "optimizers", "val": ": typing.Tuple[torch.optim.optimizer.Optimizer, torch.optim.lr_scheduler.LambdaLR] = (None, None)"}, {"name": "preprocess_logits_for_metrics", "val": ": typing.Callable[[torch.Tensor, torch.Tensor], torch.Tensor] = None"}]</parameters><paramsdesc>- **model** ([PreTrainedModel](/docs/transformers/pr_15728/en/main_classes/model#transformers.PreTrainedModel) or `torch.nn.Module`, *optional*) --
  ...
  [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) is optimized to work with the [PreTrainedModel](/docs/transformers/pr_15728/en/main_classes/model#transformers.PreTrainedModel) provided by the library. You can still use
  your own models defined as `torch.nn.Module` as long as they work the same way as the 🤗 Transformers
  models.

  </Tip>

- **args** ([TrainingArguments](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.TrainingArguments), *optional*) --
  The arguments to tweak for training. Will default to a basic instance of [TrainingArguments](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.TrainingArguments) with the
  `output_dir` set to a directory named *tmp_trainer* in the current directory if not provided.
- **data_collator** (`DataCollator`, *optional*) --
  The function to use to form a batch from a list of elements of `train_dataset` or `eval_dataset`. Will
  default to [default_data_collator()](/docs/transformers/pr_15728/en/main_classes/data_collator#transformers.default_data_collator) if no `tokenizer` is provided, an instance of
  [DataCollatorWithPadding](/docs/transformers/pr_15728/en/main_classes/data_collator#transformers.DataCollatorWithPadding) otherwise.
...
- **eval_dataset** (`torch.utils.data.Dataset`, *optional*) --
  ...
  `model.forward()` method are automatically removed.
- **tokenizer** ([PreTrainedTokenizerBase](/docs/transformers/pr_15728/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase), *optional*) --
  The tokenizer used to preprocess the data. If provided, will be used to automatically pad the inputs the
  maximum length when batching inputs, and it will be saved along the model to make it easier to rerun an
  interrupted training or reuse the fine-tuned model.
- **model_init** (`Callable[[], PreTrainedModel]`, *optional*) --
  A function that instantiates the model to be used. If provided, each call to [train()](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer.train) will start
...
- **compute_metrics** (`Callable[[EvalPrediction], Dict]`, *optional*) --
  The function that will be used to compute metrics at evaluation. Must take a [EvalPrediction](/docs/transformers/pr_15728/en/internal/trainer_utils#transformers.EvalPrediction) and return
  a dictionary string to metric values.
- **callbacks** (List of [TrainerCallback](/docs/transformers/pr_15728/en/main_classes/callback#transformers.TrainerCallback), *optional*) --
  A list of callbacks to customize the training loop. Will add those to the list of default callbacks
  detailed in [here](callback).

  If you want to remove one of the default callbacks used, use the [Trainer.remove_callback()](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer.remove_callback) method.
- **optimizers** (`Tuple[torch.optim.Optimizer, torch.optim.lr_scheduler.LambdaLR]`, *optional*) -- A tuple
  containing the optimizer and the scheduler to use. Will default to an instance of [AdamW](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.AdamW) on your model
  and a scheduler given by [get_linear_schedule_with_warmup()](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.get_linear_schedule_with_warmup) controlled by `args`.
...
- **model** -- Always points to the core model. If using a transformers model, it will be a [PreTrainedModel](/docs/transformers/pr_15728/en/main_classes/model#transformers.PreTrainedModel)
  subclass.
...
<div class="docstring">
<docstring><name>add\_callback</name><anchor>transformers.Trainer.add_callback</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L513</source><parameters>[{"name": "callback", "val": ""}]</parameters><paramsdesc>- **callback** (`type` or `TrainerCallback`) --
...
<div class="docstring">
<docstring><name>autocast\_smart\_context\_manager</name><anchor>transformers.Trainer.autocast_smart_context_manager</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L1940</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>compute\_loss</name><anchor>transformers.Trainer.compute_loss</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L2004</source><parameters>[{"name": "model", "val": ""}, {"name": "inputs", "val": ""}, {"name": "return_outputs", "val": " = False"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>create\_optimizer</name><anchor>transformers.Trainer.create_optimizer</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L827</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>create\_optimizer\_and\_scheduler</name><anchor>transformers.Trainer.create_optimizer_and_scheduler</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L816</source><parameters>[{"name": "num_training_steps", "val": ": int"}]</parameters></docstring>
...
For models that inherit from [PreTrainedModel](/docs/transformers/pr_15728/en/main_classes/model#transformers.PreTrainedModel), uses that method to compute the number of floating point
...
<div class="docstring">
<docstring><name>get\_train\_dataloader</name><anchor>transformers.Trainer.get_train_dataloader</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L651</source><parameters>[]</parameters></docstring>
...
To use this method, you need to have provided a `model_init` when initializing your [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer): we need to
reinitialize the model at each new run. This is incompatible with the `optimizers` argument, so you need to
subclass [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) and override the method [create_optimizer_and_scheduler()](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer.create_optimizer_and_scheduler) for custom
optimizer/scheduler.
...
<div class="docstring">
<docstring><name>init\_git\_repo</name><anchor>transformers.Trainer.init_git_repo</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L2685</source><parameters>[{"name": "at_init", "val": ": bool = False"}]</parameters><paramsdesc>- **at_init** (`bool`, *optional*, defaults to `False`) --
...
<div class="docstring">
<docstring><name>is\_local\_process\_zero</name><anchor>transformers.Trainer.is_local_process_zero</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L2028</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>is\_world\_process\_zero</name><anchor>transformers.Trainer.is_world_process_zero</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L2035</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>log</name><anchor>transformers.Trainer.log</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L1894</source><parameters>[{"name": "logs", "val": ": typing.Dict[str, float]"}]</parameters><paramsdesc>- **logs** (`Dict[str, float]`) --
...
<div class="docstring">
<docstring><name>log\_metrics</name><anchor>transformers.trainer_pt_utils.log_metrics</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer_pt_utils.py#L855</source><parameters>[{"name": "split", "val": ""}, {"name": "metrics", "val": ""}]</parameters><paramsdesc>- **split** (`str`) --
...
Note that this tracker doesn't account for memory allocations outside of [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer)'s `__init__`, `train`,
...
This also means that if any other tool that is used along the [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) calls
`torch.cuda.reset_peak_memory_stats`, the gpu peak memory stats could be invalid. And the [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) will disrupt
...
<div class="docstring">
<docstring><name>num\_examples</name><anchor>transformers.Trainer.num_examples</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L929</source><parameters>[{"name": "dataloader", "val": ": DataLoader"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>pop\_callback</name><anchor>transformers.Trainer.pop_callback</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L524</source><parameters>[{"name": "callback", "val": ""}]</parameters><paramsdesc>- **callback** (`type` or `TrainerCallback`) --
  A `TrainerCallback` class or an instance of a `TrainerCallback`. In the
...
<div class="docstring">
<docstring><name>remove\_callback</name><anchor>transformers.Trainer.remove_callback</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L540</source><parameters>[{"name": "callback", "val": ""}]</parameters><paramsdesc>- **callback** (`type` or `TrainerCallback`) --
  A `TrainerCallback` class or an instance of a `TrainerCallback`. In the
...
<div class="docstring">
<docstring><name>save\_metrics</name><anchor>transformers.trainer_pt_utils.save_metrics</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer_pt_utils.py#L945</source><parameters>[{"name": "split", "val": ""}, {"name": "metrics", "val": ""}, {"name": "combined", "val": " = True"}]</parameters><paramsdesc>- **split** (`str`) --
...
<div class="docstring">
<docstring><name>save\_model</name><anchor>transformers.Trainer.save_model</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L2047</source><parameters>[{"name": "output_dir", "val": ": typing.Optional[str] = None"}, {"name": "_internal_call", "val": ": bool = False"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>save\_state</name><anchor>transformers.trainer_pt_utils.save_state</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer_pt_utils.py#L983</source><parameters>[]</parameters></docstring>
...
<docstring><name>train</name><anchor>transformers.Trainer.train</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/trainer.py#L1093</source><parameters>[{"name": "resume_from_checkpoint", "val": ": typing.Union[str, bool, NoneType] = None"}, {"name": "trial", "val": ": typing.Union[ForwardRef('optuna.Trial'), typing.Dict[str, typing.Any]] = None"}, {"name": "ignore_keys_for_eval", "val": ": typing.Optional[typing.List[str]] = None"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **resume_from_checkpoint** (`str` or `bool`, *optional*) --
  If a `str`, local path to a saved checkpoint as saved by a previous instance of [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer). If a
  `bool` and equals `True`, load the last checkpoint in *args.output_dir* as saved by a previous instance
  of [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer). If present, training will resume from the model/optimizer/scheduler states loaded here.
...
- **do_train** (`bool`, *optional*, defaults to `False`) --
  Whether to run training or not. This argument is not directly used by [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer), it's intended to be used
...
- **do_eval** (`bool`, *optional*) --
  ...
  different from `"no"`. This argument is not directly used by [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer), it's intended to be used by your
  training/evaluation scripts instead. See the [example
  scripts](https://github.com/huggingface/transformers/tree/master/examples) for more details.
- **do_predict** (`bool`, *optional*, defaults to `False`) --
  Whether to run predictions on the test set or not. This argument is not directly used by [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer), it's
  intended to be used by your training/evaluation scripts instead. See the [example
  scripts](https://github.com/huggingface/transformers/tree/master/examples) for more details.
- **evaluation_strategy** (`str` or [IntervalStrategy](/docs/transformers/pr_15728/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"no"`) --
...
- **learning_rate** (`float`, *optional*, defaults to 5e-5) --
  The initial learning rate for [AdamW](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
- **weight_decay** (`float`, *optional*, defaults to 0) --
  The weight decay to apply (if not zero) to all layers except all bias and LayerNorm weights in [AdamW](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.AdamW)
  optimizer.
- **adam_beta1** (`float`, *optional*, defaults to 0.9) --
  The beta1 hyperparameter for the [AdamW](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
- **adam_beta2** (`float`, *optional*, defaults to 0.999) --
  The beta2 hyperparameter for the [AdamW](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
- **adam_epsilon** (`float`, *optional*, defaults to 1e-8) --
  The epsilon hyperparameter for the [AdamW](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.AdamW) optimizer.
...
- **lr_scheduler_type** (`str` or [SchedulerType](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.SchedulerType), *optional*, defaults to `"linear"`) --
  The scheduler type to use. See the documentation of [SchedulerType](/docs/transformers/pr_15728/en/main_classes/optimizer_schedules#transformers.SchedulerType) for all possible values.
...
- **logging_strategy** (`str` or [IntervalStrategy](/docs/transformers/pr_15728/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"steps"`) --
...
- **save_strategy** (`str` or [IntervalStrategy](/docs/transformers/pr_15728/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"steps"`) --
...
- **push_to_hub** (`bool`, *optional*, defaults to `False`) --
  ...
  [save_model()](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer.save_model) will also trigger a push.

  <Tip warning=&amp;lcub;true}>

  If `output_dir` exists, it needs to be a local clone of the repository to which the [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) will be
  pushed.
...
- **resume_from_checkpoint** (`str`, *optional*) --
  ...
  [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer), it's intended to be used by your training/evaluation scripts instead. See the [example
  scripts](https://github.com/huggingface/transformers/tree/master/examples) for more details.
...
- **hub_strategy** (`str` or `HubStrategy` *optional*, defaults to `"every_save"`) --
  ...
  - `"end"`: push the model, its configuration, the tokenizer (if passed along to the [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer)) and a
    draft of a model card when the [save_model()](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer.save_model) method is called.
  - `"every_save"`: push the model, its configuration, the tokenizer (if passed along to the [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer)) and
...
Using [HfArgumentParser](/docs/transformers/pr_15728/en/internal/trainer_utils#transformers.HfArgumentParser) we can turn this class into
...
<div class="docstring">
<docstring><name>get\_process\_log\_level</name><anchor>transformers.TrainingArguments.get_process_log_level</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/training_args.py#L1194</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>get\_warmup\_steps</name><anchor>transformers.TrainingArguments.get_warmup_steps</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/training_args.py#L1278</source><parameters>[{"name": "num_training_steps", "val": ": int"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>to\_dict</name><anchor>transformers.TrainingArguments.to_dict</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/training_args.py#L1287</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>to\_json\_string</name><anchor>transformers.TrainingArguments.to_json_string</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/training_args.py#L1302</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>to\_sanitized\_dict</name><anchor>transformers.TrainingArguments.to_sanitized_dict</anchor><source>https://github.com/huggingface/transformers/blob/pr_15728/src/transformers/training_args.py#L1308</source><parameters>[]</parameters></docstring>
...
By default, [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) will save all checkpoints in the `output_dir` you set in the
[TrainingArguments](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.TrainingArguments) you are using. Those will go in subfolder named `checkpoint-xxx` with xxx
being the step at which the training was at.

Resuming training from a checkpoint can be done when calling [Trainer.train()](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer.train) with either:
...
the `hub-strategy` value of your [TrainingArguments](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.TrainingArguments) to either:
...
By default [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) will use `logging.INFO` for the main process and `logging.WARNING` for the replicas if any.

These defaults can be overridden to use any of the 5 `logging` levels with [TrainingArguments](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.TrainingArguments)'s
arguments:

- `log_level` - for the main process
- `log_level_replica` - for the replicas

Further, if [TrainingArguments](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.TrainingArguments)'s `log_on_each_node` is set to `False` only the main node will
use the log level settings for its main process, all other nodes will use the log level settings for replicas.

Note that [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) is going to set `transformers`'s log level separately for each node in its
`Trainer.__init__()` So you may want to set this sooner (see the next example) if you tap into other
`transformers` functionality before creating the [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) object.
...
When resuming from a checkpoint generated by [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) all efforts are made to restore the
...
The [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer) has been extended to support libraries that may dramatically improve your training
...
By integrating [FairScale](https://github.com/facebookresearch/fairscale/) the [Trainer](/docs/transformers/pr_15728/en/main_classes/trainer#transformers.Trainer)
