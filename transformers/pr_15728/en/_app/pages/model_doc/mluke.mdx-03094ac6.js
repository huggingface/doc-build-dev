import{S as Zt,i as en,s as tn,e as o,k as p,w as O,t as r,L as nn,c as s,d as n,m as u,a as i,x as B,h as a,b as l,J as t,g as d,y as j,K as on,q as X,o as C,B as Y}from"../../chunks/vendor-9e2b328e.js";import{D as Gt}from"../../chunks/Docstring-50fd6873.js";import{C as Qt}from"../../chunks/CodeBlock-88e23343.js";import{I as qt}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function sn(We){let g,H,h,f,re,M,Se,ae,Ke,fe,w,T,le,$,De,ce,Re,_e,k,Fe,A,Oe,Be,P,je,Xe,ge,V,Ce,ke,J,Ye,ye,G,de,He,ve,Q,Ve,we,I,be,L,Je,Z,Ge,Qe,Te,N,Le,q,Ze,ee,et,tt,qe,y,nt,U,ot,st,W,it,rt,xe,b,x,pe,S,at,ue,lt,ze,m,K,ct,_,dt,te,pt,ut,ne,mt,ht,D,ft,_t,gt,R,kt,oe,yt,vt,wt,z,F,bt,me,Tt,Lt,he,Ee;return M=new qt({}),$=new qt({}),I=new Qt({props:{code:`from transformers import LukeModel
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_15728/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_15728/en/main_classes/tokenizer#transformers.BatchEncoding"
...
knowledge more likely than using only word representations.`),ve=p(),Q=o("p"),Ve=r("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),we=p(),O(I.$$.fragment),be=p(),L=o("p"),Je=r("Note that mLUKE has its own tokenizer, "),Z=o("a"),Ge=r("MLukeTokenizer"),Qe=r(". You can initialize it as follows:"),Te=p(),O(N.$$.fragment),Le=p(),q=o("p"),Ze=r("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=o("a"),et=r("LUKE\u2019s documentation page"),tt=r(` for all
tips, code examples and notebooks.`),qe=p(),y=o("p"),nt=r("This model was contributed by "),U=o("a"),ot=r("ryo0634"),st=r(". The original code can be found "),W=o("a"),it=r("here"),rt=r("."),xe=p(),b=o("h2"),x=o("a"),pe=o("span"),O(S.$$.fragment),at=p(),ue=o("span"),lt=r("MLukeTokenizer"),ze=p(),m=o("div"),O(K.$$.fragment),ct=p(),_=o("p"),dt=r("Adapted from "),te=o("a"),pt=r("XLMRobertaTokenizer"),ut=r(" and "),ne=o("a"),mt=r("LukeTokenizer"),ht=r(`. Based on
`),D=o("a"),ft=r("SentencePiece"),_t=r("."),gt=p(),R=o("p"),kt=r("This tokenizer inherits from "),oe=o("a"),yt=r("PreTrainedTokenizer"),vt=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),wt=p(),z=o("div"),O(F.$$.fragment),bt=p(),me=o("p"),Tt=r(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Lt=p(),he=o("div"),this.h()},l(e){const c=nn('[data-svelte="svelte-1phssyn"]',document.head);g=s(c,"META",{name:!0,content:!0}),c.forEach(n),H=u(e),h=s(e,"H1",{class:!0});var Me=i(h);f=s(Me,"A",{id:!0,class:!0,href:!0});var xt=i(f);re=s(xt,"SPAN",{});var zt=i(re);B(M.$$.fragment,zt),zt.forEach(n),xt.forEach(n),Se=u(Me),ae=s(Me,"SPAN",{});var Et=i(ae);Ke=a(Et,"mLUKE"),Et.forEach(n),Me.forEach(n),fe=u(e),w=s(e,"H2",{class:!0});var $e=i(w);T=s($e,"A",{id:!0,class:!0,href:!0});var Mt=i(T);le=s(Mt,"SPAN",{});var $t=i(le);B($.$$.fragment,$t),$t.forEach(n),Mt.forEach(n),De=u($e),ce=s($e,"SPAN",{});var At=i(ce);Re=a(At,"Overview"),At.forEach(n),$e.forEach(n),_e=u(e),k=s(e,"P",{});var se=i(k);Fe=a(se,"The mLUKE model was proposed in "),A=s(se,"A",{href:!0,rel:!0});var Pt=i(A);Oe=a(Pt,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Pt.forEach(n),Be=a(se,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
representations into the input allows us to extract more language-agnostic features. We also evaluate the model with a
multilingual cloze prompt task with the mLAMA dataset. We show that entity-based prompt elicits correct factual
knowledge more likely than using only word representations.`),St.forEach(n),Wt.forEach(n),ve=u(e),Q=s(e,"P",{});var Kt=i(Q);Ve=a(Kt,"One can directly plug in the weights of mLUKE into a LUKE model, like so:"),Kt.forEach(n),we=u(e),B(I.$$.fragment,e),be=u(e),L=s(e,"P",{});var Ae=i(L);Je=a(Ae,"Note that mLUKE has its own tokenizer, "),Z=s(Ae,"A",{href:!0});var Dt=i(Z);Ge=a(Dt,"MLukeTokenizer"),Dt.forEach(n),Qe=a(Ae,". You can initialize it as follows:"),Ae.forEach(n),Te=u(e),B(N.$$.fragment,e),Le=u(e),q=s(e,"P",{});var Pe=i(q);Ze=a(Pe,"As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=s(Pe,"A",{href:!0});var Rt=i(ee);et=a(Rt,"LUKE\u2019s documentation page"),Rt.forEach(n),tt=a(Pe,` for all
tips, code examples and notebooks.`),Pe.forEach(n),qe=u(e),y=s(e,"P",{});var ie=i(y);nt=a(ie,"This model was contributed by "),U=s(ie,"A",{href:!0,rel:!0});var Ft=i(U);ot=a(Ft,"ryo0634"),Ft.forEach(n),st=a(ie,". The original code can be found "),W=s(ie,"A",{href:!0,rel:!0});var Ot=i(W);it=a(Ot,"here"),Ot.forEach(n),rt=a(ie,"."),ie.forEach(n),xe=u(e),b=s(e,"H2",{class:!0});var Ie=i(b);x=s(Ie,"A",{id:!0,class:!0,href:!0});var Bt=i(x);pe=s(Bt,"SPAN",{});var jt=i(pe);B(S.$$.fragment,jt),jt.forEach(n),Bt.forEach(n),at=u(Ie),ue=s(Ie,"SPAN",{});var Xt=i(ue);lt=a(Xt,"MLukeTokenizer"),Xt.forEach(n),Ie.forEach(n),ze=u(e),m=s(e,"DIV",{class:!0});var v=i(m);B(K.$$.fragment,v),ct=u(v),_=s(v,"P",{});var E=i(_);dt=a(E,"Adapted from "),te=s(E,"A",{href:!0});var Ct=i(te);pt=a(Ct,"XLMRobertaTokenizer"),Ct.forEach(n),ut=a(E," and "),ne=s(E,"A",{href:!0});var Yt=i(ne);mt=a(Yt,"LukeTokenizer"),Yt.forEach(n),ht=a(E,`. Based on
`),D=s(E,"A",{href:!0,rel:!0});var Ht=i(D);ft=a(Ht,"SentencePiece"),Ht.forEach(n),_t=a(E,"."),E.forEach(n),gt=u(v),R=s(v,"P",{});var Ne=i(R);kt=a(Ne,"This tokenizer inherits from "),oe=s(Ne,"A",{href:!0});var Vt=i(oe);yt=a(Vt,"PreTrainedTokenizer"),Vt.forEach(n),vt=a(Ne,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ne.forEach(n),wt=u(v),z=s(v,"DIV",{class:!0});var Ue=i(z);B(F.$$.fragment,Ue),bt=u(Ue),me=s(Ue,"P",{});var Jt=i(me);Tt=a(Jt,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Jt.forEach(n),Ue.forEach(n),Lt=u(v),he=s(v,"DIV",{class:!0}),i(he).forEach(n),v.forEach(n),this.h()},h(){l(g,"name","hf:doc:metadata"),l(g,"content",JSON.stringify(rn)),l(f,"id","mluke"),l(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(f,"href","#mluke"),l(h,"class","relative group"),l(T,"id","overview"),l(T,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(T,"href","#overview"),l(w,"class","relative group"),l(A,"href","https://arxiv.org/abs/2110.08151"),l(A,"rel","nofollow"),l(P,"href","https://arxiv.org/abs/2010.01057"),l(P,"rel","nofollow"),l(Z,"href","/docs/transformers/pr_15728/en/model_doc/mluke#transformers.MLukeTokenizer"),l(ee,"href","luke"),l(U,"href","https://huggingface.co/ryo0634"),l(U,"rel","nofollow"),l(W,"href","https://github.com/studio-ousia/luke"),l(W,"rel","nofollow"),l(x,"id","transformers.MLukeTokenizer"),l(x,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(x,"href","#transformers.MLukeTokenizer"),l(b,"class","relative group"),l(te,"href","/docs/transformers/pr_15728/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer"),l(ne,"href","/docs/transformers/pr_15728/en/model_doc/luke#transformers.LukeTokenizer"),l(D,"href","https://github.com/google/sentencepiece"),l(D,"rel","nofollow"),l(oe,"href","/docs/transformers/pr_15728/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(z,"class","docstring"),l(he,"class","docstring"),l(m,"class","docstring")},m(e,c){t(document.head,g),d(e,H,c),d(e,h,c),t(h,f),t(f,re),j(M,re,null),t(h,Se),t(h,ae),t(ae,Ke),d(e,fe,c),d(e,w,c),t(w,T),t(T,le),j($,le,null),t(w,De),t(w,ce),t(ce,Re),d(e,_e,c),d(e,k,c),t(k,Fe),t(k,A),t(A,Oe),t(k,Be),t(k,P),t(P,je),t(k,Xe),d(e,ge,c),d(e,V,c),t(V,Ce),d(e,ke,c),d(e,J,c),t(J,Ye),d(e,ye,c),d(e,G,c),t(G,de),t(de,He),d(e,ve,c),d(e,Q,c),t(Q,Ve),d(e,we,c),j(I,e,c),d(e,be,c),d(e,L,c),t(L,Je),t(L,Z),t(Z,Ge),t(L,Qe),d(e,Te,c),j(N,e,c),d(e,Le,c),d(e,q,c),t(q,Ze),t(q,ee),t(ee,et),t(q,tt),d(e,qe,c),d(e,y,c),t(y,nt),t(y,U),t(U,ot),t(y,st),t(y,W),t(W,it),t(y,rt),d(e,xe,c),d(e,b,c),t(b,x),t(x,pe),j(S,pe,null),t(b,at),t(b,ue),t(ue,lt),d(e,ze,c),d(e,m,c),j(K,m,null),t(m,ct),t(m,_),t(_,dt),t(_,te),t(te,pt),t(_,ut),t(_,ne),t(ne,mt),t(_,ht),t(_,D),t(D,ft),t(_,_t),t(m,gt),t(m,R),t(R,kt),t(R,oe),t(oe,yt),t(R,vt),t(m,wt),t(m,z),j(F,z,null),t(z,bt),t(z,me),t(me,Tt),t(m,Lt),t(m,he),Ee=!0},p:on,i(e){Ee||(X(M.$$.fragment,e),X($.$$.fragment,e),X(I.$$.fragment,e),X(N.$$.fragment,e),X(S.$$.fragment,e),X(K.$$.fragment,e),X(F.$$.fragment,e),Ee=!0)},o(e){C(M.$$.fragment,e),C($.$$.fragment,e),C(I.$$.fragment,e),C(N.$$.fragment,e),C(S.$$.fragment,e),C(K.$$.fragment,e),C(F.$$.fragment,e),Ee=!1},d(e){n(g),e&&n(H),e&&n(h),Y(M),e&&n(fe),e&&n(w),Y($),e&&n(_e),e&&n(k),e&&n(ge),e&&n(V),e&&n(ke),e&&n(J),e&&n(ye),e&&n(G),e&&n(ve),e&&n(Q),e&&n(we),Y(I,e),e&&n(be),e&&n(L),e&&n(Te),Y(N,e),e&&n(Le),e&&n(q),e&&n(qe),e&&n(y),e&&n(xe),e&&n(b),Y(S),e&&n(ze),e&&n(m),Y(K),Y(F)}}}const rn={local:"mluke",sections:[{local:"overview",title:"Overview"},{local:"transformers.MLukeTokenizer",title:"MLukeTokenizer"}],title:"mLUKE"};function an(We,g,H){let{fw:h}=g;return We.$$set=f=>{"fw"in f&&H(0,h=f.fw)},[h]}class mn extends Zt{constructor(g){super();en(this,g,an,sn,tn,{fw:0})}}export{mn as default,rn as metadata};
