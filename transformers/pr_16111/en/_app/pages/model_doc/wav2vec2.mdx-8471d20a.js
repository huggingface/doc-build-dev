...
instance of <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16111/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_16111/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Whether or not <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16111/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<a href="/docs/transformers/pr_16111/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_16111/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_16111/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
Tuple of <code>jnp.ndarray</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}]}}),Es=new V({props:{name:"replace",anchor:"None",parameters:[{name:"**updates",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/flax/struct.py#L120"}}),Ps=new ee({}),Cs=new V({props:{name:"class transformers.Wav2Vec2Model",anchor:"transformers.Wav2Vec2Model",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1237",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ds=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2Model.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">292</span>, <span class="hljs-number">768</span>]`}}),Ss=new ee({}),Ns=new V({props:{name:"class transformers.Wav2Vec2ForCTC",anchor:"transformers.Wav2Vec2ForCTC",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1647",parametersDescription:[{anchor:"transformers.Wav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Rs=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1688",parametersDescription:[{anchor:"transformers.Wav2Vec2ForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16111/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
<span class="hljs-number">53.48</span>`}}),Js=new ee({}),Zs=new V({props:{name:"class transformers.Wav2Vec2ForSequenceClassification",anchor:"transformers.Wav2Vec2ForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),on=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),nn=new ee({}),rn=new V({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1900",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
[<span class="hljs-number">0</span>, <span class="hljs-number">0</span>]`}}),un=new ee({}),gn=new V({props:{name:"class transformers.Wav2Vec2ForXVector",anchor:"transformers.Wav2Vec2ForXVector",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2055",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2117",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-number">0.98</span>`}}),xn=new ee({}),Wn=new V({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1386",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),En=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"sampled_negative_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(input_values, mask_time_indices=mask_time_indices).loss`}}),Cn=new ee({}),qn=new V({props:{name:"class transformers.TFWav2Vec2Model",anchor:"transformers.TFWav2Vec2Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1428",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[ET]},$$scope:{ctx:E}}}),Ln=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16111/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[CT]},$$scope:{ctx:E}}}),Hn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16111/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16111/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16111/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16111/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
`}}),_a=new fe({props:{$$slots:{default:[zT]},$$scope:{ctx:E}}}),_r=new ue({props:{code:`import jax.numpy as jnp
...
Whether or not to return a <a href="/docs/transformers/pr_16111/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
etc.)`),qv=l(),zn=a("p"),Mv=r("This model is also a "),An=a("a"),zv=r("tf.keras.Model"),Av=r(` subclass. Use it
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),c2=l(),u(ma.$$.fragment),d2=l(),Se=a("div"),u(Hn.$$.fragment),p2=l(),bo=a("p"),m2=r("The "),bi=a("a"),h2=r("TFWav2Vec2ForCTC"),f2=r(" forward method, overrides the "),hc=a("code"),u2=r("__call__"),g2=r(" special method."),_2=l(),u(ha.$$.fragment),v2=l(),fc=a("p"),w2=r("Example:"),b2=l(),u(Rn.$$.fragment),Md=l(),yo=a("h2"),fa=a("a"),uc=a("span"),u(Xn.$$.fragment),y2=l(),gc=a("span"),k2=r("FlaxWav2Vec2Model"),zd=l(),K=a("div"),u(Gn.$$.fragment),T2=l(),Jn=a("p"),x2=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
`),Yn=a("a"),q2=r("flax.nn.Module"),M2=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),z2=l(),_c=a("p"),A2=r("Finally, this model supports inherent JAX features such as:"),L2=l(),bt=a("ul"),vc=a("li"),er=a("a"),D2=r("Just-In-Time (JIT) compilation"),O2=l(),wc=a("li"),tr=a("a"),S2=r("Automatic Differentiation"),N2=l(),bc=a("li"),or=a("a"),I2=r("Vectorization"),B2=l(),yc=a("li"),ar=a("a"),U2=r("Parallelization"),H2=l(),Ne=a("div"),u(sr.$$.fragment),R2=l(),ko=a("p"),X2=r("The "),kc=a("code"),G2=r("FlaxWav2Vec2PreTrainedModel"),J2=r("forward method, overrides the "),Tc=a("code"),Z2=r("__call__"),K2=r(" special method."),Q2=l(),u(ua.$$.fragment),Y2=l(),xc=a("p"),e1=r("Example:"),t1=l(),u(nr.$$.fragment),Ad=l(),To=a("h2"),ga=a("a"),Wc=a("span"),u(rr.$$.fragment),o1=l(),$c=a("span"),a1=r("FlaxWav2Vec2ForCTC"),Ld=l(),Q=a("div"),u(ir.$$.fragment),s1=l(),xo=a("p"),n1=r("Wav2Vec2 Model with a "),jc=a("code"),r1=r("language modeling"),i1=r(` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),lr=a("a"),l1=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),c1=r(` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),d1=l(),cr=a("p"),p1=r("This model inherits from "),ki=a("a"),m1=r("FlaxPreTrainedModel"),h1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),f1=l(),dr=a("p"),u1=r(`This model is also a Flax Linen
`),pr=a("a"),g1=r("flax.nn.Module"),_1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),v1=l(),Vc=a("p"),w1=r("Finally, this model supports inherent JAX features such as:"),b1=l(),yt=a("ul"),Fc=a("li"),mr=a("a"),y1=r("Just-In-Time (JIT) compilation"),k1=l(),Ec=a("li"),hr=a("a"),T1=r("Automatic Differentiation"),x1=l(),Pc=a("li"),fr=a("a"),W1=r("Vectorization"),$1=l(),Cc=a("li"),ur=a("a"),j1=r("Parallelization"),V1=l(),Ie=a("div"),u(gr.$$.fragment),F1=l(),Wo=a("p"),E1=r("The "),qc=a("code"),P1=r("FlaxWav2Vec2PreTrainedModel"),C1=r("forward method, overrides the "),Mc=a("code"),q1=r("__call__"),M1=r(" special method."),z1=l(),u(_a.$$.fragment),A1=l(),zc=a("p"),L1=r("Example:"),D1=l(),u(_r.$$.fragment),Dd=l(),$o=a("h2"),va=a("a"),Ac=a("span"),u(vr.$$.fragment),O1=l(),Lc=a("span"),S1=r("FlaxWav2Vec2ForPreTraining"),Od=l(),Y=a("div"),u(wr.$$.fragment),N1=l(),jo=a("p"),I1=r("Wav2Vec2 Model with a quantizer and "),Dc=a("code"),B1=r("VQ"),U1=r(` head on top.
Wav2Vec2 was proposed in `),br=a("a"),H1=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),R1=r(` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),X1=l(),yr=a("p"),G1=r("This model inherits from "),Ti=a("a"),J1=r("FlaxPreTrainedModel"),Z1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),K1=l(),kr=a("p"),Q1=r(`This model is also a Flax Linen
`),Tr=a("a"),Y1=r("flax.nn.Module"),ew=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),tw=l(),Oc=a("p"),ow=r("Finally, this model supports inherent JAX features such as:"),aw=l(),kt=a("ul"),Sc=a("li"),xr=a("a"),sw=r("Just-In-Time (JIT) compilation"),nw=l(),Nc=a("li"),Wr=a("a"),rw=r("Automatic Differentiation"),iw=l(),Ic=a("li"),$r=a("a"),lw=r("Vectorization"),cw=l(),Bc=a("li"),jr=a("a"),dw=r("Parallelization"),pw=l(),Be=a("div"),u(Vr.$$.fragment),mw=l(),Vo=a("p"),hw=r("The "),xi=a("a"),fw=r("FlaxWav2Vec2ForPreTraining"),uw=r(" forward method, overrides the "),Uc=a("code"),gw=r("__call__"),_w=r(" special method."),vw=l(),u(wa.$$.fragment),ww=l(),Hc=a("p"),bw=r("Example:"),yw=l(),u(Fr.$$.fragment),this.h()},l(o){const m=bT('[data-svelte="svelte-1phssyn"]',document.head);p=s(m,"META",{name:!0,content:!0}),m.forEach(t),x=c(o),f=s(o,"H1",{class:!0});var Er=n(f);T=s(Er,"A",{id:!0,class:!0,href:!0});var Rc=n(T);W=s(Rc,"SPAN",{});var Xc=n(W);g(k.$$.fragment,Xc),Xc.forEach(t),Rc.forEach(t),y=c(Er),j=s(Er,"SPAN",{});var Gc=n(j);O=i(Gc,"Wav2Vec2"),Gc.forEach(t),Er.forEach(t),q=c(o),F=s(o,"H2",{class:!0});var Pr=n(F);A=s(Pr,"A",{id:!0,class:!0,href:!0});var Jc=n(A);L=s(Jc,"SPAN",{});var Zc=n(L);g(X.$$.fragment,Zc),Zc.forEach(t),Jc.forEach(t),S=c(Pr),C=s(Pr,"SPAN",{});var Kc=n(C);Ve=i(Kc,"Overview"),Kc.forEach(t),Pr.forEach(t),ge=c(o),B=s(o,"P",{});var Cr=n(B);H=i(Cr,"The Wav2Vec2 model was proposed in "),_e=s(Cr,"A",{href:!0,rel:!0});var Qc=n(_e);Ge=i(Qc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Qc.forEach(t),M=i(Cr," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Cr.forEach(t),I=c(o),Fe=s(o,"P",{});var Yc=n(Fe);ve=i(Yc,"The abstract from the paper is the following:"),Yc.forEach(t),Ye=c(o),Ee=s(o,"P",{});var ed=n(Ee);oe=s(ed,"EM",{});var td=n(oe);ct=i(td,`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
transcribed speech can outperform the best semi-supervised methods while being conceptually simpler. wav2vec 2.0 masks
the speech input in the latent space and solves a contrastive task defined over a quantization of the latent
representations which are jointly learned. Experiments using all labeled data of Librispeech achieve 1.8/3.3 WER on the
clean/other test sets. When lowering the amount of labeled data to one hour, wav2vec 2.0 outperforms the previous state
...
using `),Pe=s(Nd,"A",{href:!0});var jw=n(Pe);ye=i(jw,"Wav2Vec2CTCTokenizer"),jw.forEach(t),mt=i(Nd,"."),Nd.forEach(t),qr.forEach(t),$=c(o),P=s(o,"P",{});var Id=n(P);Ze=i(Id,"This model was contributed by "),Ke=s(Id,"A",{href:!0,rel:!0});var Vw=n(Ke);Bt=i(Vw,"patrickvonplaten"),Vw.forEach(t),se=i(Id,"."),Id.forEach(t),xt=c(o),ke=s(o,"H2",{class:!0});var Bd=n(ke);Ce=s(Bd,"A",{id:!0,class:!0,href:!0});var Fw=n(Ce);G=s(Fw,"SPAN",{});var Ew=n(G);g(J.$$.fragment,Ew),Ew.forEach(t),Fw.forEach(t),Ut=c(Bd),ht=s(Bd,"SPAN",{});var Pw=n(ht);Te=i(Pw,"Wav2Vec2Config"),Pw.forEach(t),Bd.forEach(t),Wt=c(o),U=s(o,"DIV",{class:!0});var Ft=n(U);g(xe.$$.fragment,Ft),Ht=c(Ft),Rt=s(Ft,"P",{});var Wi=n(Rt);lm=i(Wi,"This is the configuration class to store the configuration of a "),Mr=s(Wi,"A",{href:!0});var Cw=n(Mr);cm=i(Cw,"Wav2Vec2Model"),Cw.forEach(t),dm=i(Wi,`. It is used to instantiate an
Wav2Vec2 model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Wav2Vec2
`),Fa=s(Wi,"A",{href:!0,rel:!0});var qw=n(Fa);pm=i(qw,"facebook/wav2vec2-base-960h"),qw.forEach(t),mm=i(Wi," architecture."),Wi.forEach(t),hm=c(Ft),Xt=s(Ft,"P",{});var $i=n(Xt);fm=i($i,"Configuration objects inherit from "),zr=s($i,"A",{href:!0});var Mw=n(zr);um=i(Mw,"PretrainedConfig"),Mw.forEach(t),gm=i($i,` and can be used to control the model outputs. Read the
documentation from `),Ar=s($i,"A",{href:!0});var zw=n(Ar);_m=i(zw,"PretrainedConfig"),zw.forEach(t),vm=i($i," for more information."),$i.forEach(t),wm=c(Ft),Xi=s(Ft,"P",{});var Aw=n(Xi);bm=i(Aw,"Example:"),Aw.forEach(t),ym=c(Ft),g(Ea.$$.fragment,Ft),Ft.forEach(t),sd=c(o),Gt=s(o,"H2",{class:!0});var Ud=n(Gt);Fo=s(Ud,"A",{id:!0,class:!0,href:!0});var Lw=n(Fo);Gi=s(Lw,"SPAN",{});var Dw=n(Gi);g(Pa.$$.fragment,Dw),Dw.forEach(t),Lw.forEach(t),km=c(Ud),Ji=s(Ud,"SPAN",{});var Ow=n(Ji);Tm=i(Ow,"Wav2Vec2CTCTokenizer"),Ow.forEach(t),Ud.forEach(t),nd=c(o),Z=s(o,"DIV",{class:!0});var Ue=n(Z);g(Ca.$$.fragment,Ue),xm=c(Ue),Zi=s(Ue,"P",{});var Sw=n(Zi);Wm=i(Sw,"Constructs a Wav2Vec2CTC tokenizer."),Sw.forEach(t),$m=c(Ue),qa=s(Ue,"P",{});var Hd=n(qa);jm=i(Hd,"This tokenizer inherits from "),Lr=s(Hd,"A",{href:!0});var Nw=n(Lr);Vm=i(Nw,"PreTrainedTokenizer"),Nw.forEach(t),Fm=i(Hd,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),Hd.forEach(t),Em=c(Ue),Eo=s(Ue,"DIV",{class:!0});var Rd=n(Eo);g(Ma.$$.fragment,Rd),Pm=c(Rd),Ki=s(Rd,"P",{});var Iw=n(Ki);Cm=i(Iw,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),Iw.forEach(t),Rd.forEach(t),qm=c(Ue),Dr=s(Ue,"DIV",{class:!0});var Bw=n(Dr);g(za.$$.fragment,Bw),Bw.forEach(t),Mm=c(Ue),qe=s(Ue,"DIV",{class:!0});var Et=n(qe);g(Aa.$$.fragment,Et),zm=c(Et),Qi=s(Et,"P",{});var Uw=n(Qi);Am=i(Uw,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Uw.forEach(t),Lm=c(Et),La=s(Et,"P",{});var Xd=n(La);Dm=i(Xd,"Similar to doing "),Yi=s(Xd,"CODE",{});var Hw=n(Yi);Om=i(Hw,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Hw.forEach(t),Sm=i(Xd,"."),Xd.forEach(t),Nm=c(Et),el=s(Et,"P",{});var Rw=n(el);Im=i(Rw,"Example:"),Rw.forEach(t),Bm=c(Et),g(Da.$$.fragment,Et),Et.forEach(t),Um=c(Ue),Po=s(Ue,"DIV",{class:!0});var Gd=n(Po);g(Oa.$$.fragment,Gd),Hm=c(Gd),tl=s(Gd,"P",{});var Xw=n(tl);Rm=i(Xw,"Convert a list of lists of token ids into a list of strings by calling decode."),Xw.forEach(t),Gd.forEach(t),Ue.forEach(t),rd=c(o),Jt=s(o,"H2",{class:!0});var Jd=n(Jt);Co=s(Jd,"A",{id:!0,class:!0,href:!0});var Gw=n(Co);ol=s(Gw,"SPAN",{});var Jw=n(ol);g(Sa.$$.fragment,Jw),Jw.forEach(t),Gw.forEach(t),Xm=c(Jd),al=s(Jd,"SPAN",{});var Zw=n(al);Gm=i(Zw,"Wav2Vec2FeatureExtractor"),Zw.forEach(t),Jd.forEach(t),id=c(o),Qe=s(o,"DIV",{class:!0});var ba=n(Qe);g(Na.$$.fragment,ba),Jm=c(ba),sl=s(ba,"P",{});var Kw=n(sl);Zm=i(Kw,"Constructs a Wav2Vec2 feature extractor."),Kw.forEach(t),Km=c(ba),Ia=s(ba,"P",{});var Zd=n(Ia);Qm=i(Zd,"This feature extractor inherits from "),Or=s(Zd,"A",{href:!0});var Qw=n(Or);Ym=i(Qw,"SequenceFeatureExtractor"),Qw.forEach(t),eh=i(Zd,` which contains
most of the main methods. Users should refer to this superclass for more information regarding those methods.`),Zd.forEach(t),th=c(ba),qo=s(ba,"DIV",{class:!0});var Kd=n(qo);g(Ba.$$.fragment,Kd),oh=c(Kd),nl=s(Kd,"P",{});var Yw=n(nl);ah=i(Yw,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),Yw.forEach(t),Kd.forEach(t),ba.forEach(t),ld=c(o),Zt=s(o,"H2",{class:!0});var Qd=n(Zt);Mo=s(Qd,"A",{id:!0,class:!0,href:!0});var eb=n(Mo);rl=s(eb,"SPAN",{});var tb=n(rl);g(Ua.$$.fragment,tb),tb.forEach(t),eb.forEach(t),sh=c(Qd),il=s(Qd,"SPAN",{});var ob=n(il);nh=i(ob,"Wav2Vec2Processor"),ob.forEach(t),Qd.forEach(t),cd=c(o),z=s(o,"DIV",{class:!0});var R=n(z);g(Ha.$$.fragment,R),rh=c(R),ll=s(R,"P",{});var ab=n(ll);ih=i(ab,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
processor.`),ab.forEach(t),lh=c(R),Me=s(R,"P",{});var Tt=n(Me);Sr=s(Tt,"A",{href:!0});var sb=n(Sr);ch=i(sb,"Wav2Vec2Processor"),sb.forEach(t),dh=i(Tt," offers all the functionalities of "),Nr=s(Tt,"A",{href:!0});var nb=n(Nr);ph=i(nb,"Wav2Vec2FeatureExtractor"),nb.forEach(t),mh=i(Tt," and "),Ir=s(Tt,"A",{href:!0});var rb=n(Ir);hh=i(rb,"PreTrainedTokenizer"),rb.forEach(t),fh=i(Tt,`.
See the docstring of `),Ra=s(Tt,"A",{href:!0});var kw=n(Ra);cl=s(kw,"STRONG",{});var ib=n(cl);uh=i(ib,"call"),ib.forEach(t),gh=i(kw,"()"),kw.forEach(t),_h=i(Tt," and "),Br=s(Tt,"A",{href:!0});var lb=n(Br);vh=i(lb,"decode()"),lb.forEach(t),wh=i(Tt," for more information."),Tt.forEach(t),bh=c(R),zo=s(R,"DIV",{class:!0});var Yd=n(zo);g(Xa.$$.fragment,Yd),yh=c(Yd),ft=s(Yd,"P",{});var ya=n(ft);kh=i(ya,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),Ga=s(ya,"A",{href:!0});var Tw=n(Ga);dl=s(Tw,"STRONG",{});var cb=n(dl);Th=i(cb,"call"),cb.forEach(t),xh=i(Tw,"()"),Tw.forEach(t),Wh=i(ya,` and returns its output. If used in the context
`),Ur=s(ya,"A",{href:!0});var db=n(Ur);$h=i(db,"as_target_processor()"),db.forEach(t),jh=i(ya,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Ja=s(ya,"A",{href:!0});var xw=n(Ja);pl=s(xw,"STRONG",{});var pb=n(pl);Vh=i(pb,"call"),pb.forEach(t),Fh=i(xw,"()"),xw.forEach(t),Eh=i(ya,". Please refer to the docstring of the above two methods for more information."),ya.forEach(t),Yd.forEach(t),Ph=c(R),Ao=s(R,"DIV",{class:!0});var ep=n(Ao);g(Za.$$.fragment,ep),Ch=c(ep),ut=s(ep,"P",{});var ka=n(ut);qh=i(ka,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),Hr=s(ka,"A",{href:!0});var mb=n(Hr);Mh=i(mb,"pad()"),mb.forEach(t),zh=i(ka,` and returns its output. If used in the context
`),Rr=s(ka,"A",{href:!0});var hb=n(Rr);Ah=i(hb,"as_target_processor()"),hb.forEach(t),Lh=i(ka,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Xr=s(ka,"A",{href:!0});var fb=n(Xr);Dh=i(fb,"pad()"),fb.forEach(t),Oh=i(ka,". Please refer to the docstring of the above two methods for more information."),ka.forEach(t),ep.forEach(t),Sh=c(R),Gr=s(R,"DIV",{class:!0});var ub=n(Gr);g(Ka.$$.fragment,ub),ub.forEach(t),Nh=c(R),$t=s(R,"DIV",{class:!0});var ji=n($t);g(Qa.$$.fragment,ji),Ih=c(ji),Ya=s(ji,"P",{});var tp=n(Ya);Bh=i(tp,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Jr=s(tp,"A",{href:!0});var gb=n(Jr);Uh=i(gb,"from_pretrained()"),gb.forEach(t),Hh=i(tp," method."),tp.forEach(t),Rh=c(ji),g(Lo.$$.fragment,ji),ji.forEach(t),Xh=c(R),Do=s(R,"DIV",{class:!0});var op=n(Do);g(es.$$.fragment,op),Gh=c(op),ts=s(op,"P",{});var ap=n(ts);Jh=i(ap,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Zr=s(ap,"A",{href:!0});var _b=n(Zr);Zh=i(_b,"batch_decode()"),_b.forEach(t),Kh=i(ap,`. Please
refer to the docstring of this method for more information.`),ap.forEach(t),op.forEach(t),Qh=c(R),Oo=s(R,"DIV",{class:!0});var sp=n(Oo);g(os.$$.fragment,sp),Yh=c(sp),as=s(sp,"P",{});var np=n(as);ef=i(np,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Kr=s(np,"A",{href:!0});var vb=n(Kr);tf=i(vb,"decode()"),vb.forEach(t),of=i(np,`. Please refer
to the docstring of this method for more information.`),np.forEach(t),sp.forEach(t),af=c(R),So=s(R,"DIV",{class:!0});var rp=n(So);g(ss.$$.fragment,rp),sf=c(rp),ml=s(rp,"P",{});var wb=n(ml);nf=i(wb,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),wb.forEach(t),rp.forEach(t),R.forEach(t),dd=c(o),Kt=s(o,"H2",{class:!0});var ip=n(Kt);No=s(ip,"A",{id:!0,class:!0,href:!0});var bb=n(No);hl=s(bb,"SPAN",{});var yb=n(hl);g(ns.$$.fragment,yb),yb.forEach(t),bb.forEach(t),rf=c(ip),fl=s(ip,"SPAN",{});var kb=n(fl);lf=i(kb,"Wav2Vec2ProcessorWithLM"),kb.forEach(t),ip.forEach(t),pd=c(o),N=s(o,"DIV",{class:!0});var te=n(N);g(rs.$$.fragment,te),cf=c(te),ul=s(te,"P",{});var Tb=n(ul);df=i(Tb,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor, a Wav2Vec2 CTC tokenizer and a decoder
with language model support into a single processor for language model boosted speech recognition decoding.`),Tb.forEach(t),pf=c(te),Io=s(te,"DIV",{class:!0});var lp=n(Io);g(is.$$.fragment,lp),mf=c(lp),gt=s(lp,"P",{});var Ta=n(gt);hf=i(Ta,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),ls=s(Ta,"A",{href:!0});var Ww=n(ls);gl=s(Ww,"STRONG",{});var xb=n(gl);ff=i(xb,"call"),xb.forEach(t),uf=i(Ww,"()"),Ww.forEach(t),gf=i(Ta,` and returns its output. If used in the context
`),Qr=s(Ta,"A",{href:!0});var Wb=n(Qr);_f=i(Wb,"as_target_processor()"),Wb.forEach(t),vf=i(Ta,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),cs=s(Ta,"A",{href:!0});var $w=n(cs);_l=s($w,"STRONG",{});var $b=n(_l);wf=i($b,"call"),$b.forEach(t),bf=i($w,"()"),$w.forEach(t),yf=i(Ta,`. Please refer to the docstring of the above two
...
`),Yr=s(xa,"A",{href:!0});var jb=n(Yr);Wf=i(jb,"pad()"),jb.forEach(t),$f=i(xa,` and returns its output. If used in the context
`),ei=s(xa,"A",{href:!0});var Vb=n(ei);jf=i(Vb,"as_target_processor()"),Vb.forEach(t),Vf=i(xa,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),ti=s(xa,"A",{href:!0});var Fb=n(ti);Ff=i(Fb,"pad()"),Fb.forEach(t),Ef=i(xa,`. Please refer to the docstring of the above two methods
for more information.`),xa.forEach(t),cp.forEach(t),Pf=c(te),jt=s(te,"DIV",{class:!0});var Vi=n(jt);g(ps.$$.fragment,Vi),Cf=c(Vi),ms=s(Vi,"P",{});var dp=n(ms);qf=i(dp,"Instantiate a "),oi=s(dp,"A",{href:!0});var Eb=n(oi);Mf=i(Eb,"Wav2Vec2ProcessorWithLM"),Eb.forEach(t),zf=i(dp," from a pretrained Wav2Vec2 processor."),dp.forEach(t),Af=c(Vi),g(Uo.$$.fragment,Vi),Vi.forEach(t),Lf=c(te),ai=s(te,"DIV",{class:!0});var Pb=n(ai);g(hs.$$.fragment,Pb),Pb.forEach(t),Df=c(te),Vt=s(te,"DIV",{class:!0});var Fi=n(Vt);g(fs.$$.fragment,Fi),Of=c(Fi),vl=s(Fi,"P",{});var Cb=n(vl);Sf=i(Cb,"Batch decode output logits to audio transcription with language model support."),Cb.forEach(t),Nf=c(Fi),g(Ho.$$.fragment,Fi),Fi.forEach(t),If=c(te),tt=s(te,"DIV",{class:!0});var Wa=n(tt);g(us.$$.fragment,Wa),Bf=c(Wa),wl=s(Wa,"P",{});var qb=n(wl);Uf=i(qb,"Decode output logits to audio transcription with language model support."),qb.forEach(t),Hf=c(Wa),bl=s(Wa,"P",{});var Mb=n(bl);Rf=i(Mb,"Example:"),Mb.forEach(t),Xf=c(Wa),g(gs.$$.fragment,Wa),Wa.forEach(t),Gf=c(te),Ro=s(te,"DIV",{class:!0});var pp=n(Ro);g(_s.$$.fragment,pp),Jf=c(pp),yl=s(pp,"P",{});var zb=n(yl);Zf=i(zb,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),zb.forEach(t),pp.forEach(t),te.forEach(t),md=c(o),Qt=s(o,"H2",{class:!0});var mp=n(Qt);Xo=s(mp,"A",{id:!0,class:!0,href:!0});var Ab=n(Xo);kl=s(Ab,"SPAN",{});var Lb=n(kl);g(vs.$$.fragment,Lb),Lb.forEach(t),Ab.forEach(t),Kf=c(mp),Tl=s(mp,"SPAN",{});var Db=n(Tl);Qf=i(Db,"Wav2Vec2 specific outputs"),Db.forEach(t),mp.forEach(t),hd=c(o),Yt=s(o,"DIV",{class:!0});var hp=n(Yt);g(ws.$$.fragment,hp),Yf=c(hp),bs=s(hp,"P",{});var fp=n(bs);eu=i(fp,"Output type of "),xl=s(fp,"CODE",{});var Ob=n(xl);tu=i(Ob,"Wav2Vec2DecoderWithLM"),Ob.forEach(t),ou=i(fp,", with transcription."),fp.forEach(t),hp.forEach(t),fd=c(o),eo=s(o,"DIV",{class:!0});var up=n(eo);g(ys.$$.fragment,up),au=c(up),ks=s(up,"P",{});var gp=n(ks);su=i(gp,"Output type of "),Wl=s(gp,"CODE",{});var Sb=n(Wl);nu=i(Sb,"Wav2Vec2BaseModelOutput"),Sb.forEach(t),ru=i(gp,", with potential hidden states and attentions."),gp.forEach(t),up.forEach(t),ud=c(o),to=s(o,"DIV",{class:!0});var _p=n(to);g(Ts.$$.fragment,_p),iu=c(_p),xs=s(_p,"P",{});var vp=n(xs);lu=i(vp,"Output type of "),si=s(vp,"A",{href:!0});var Nb=n(si);cu=i(Nb,"Wav2Vec2ForPreTraining"),Nb.forEach(t),du=i(vp,", with potential hidden states and attentions."),vp.forEach(t),_p.forEach(t),gd=c(o),vt=s(o,"DIV",{class:!0});var Ei=n(vt);g(Ws.$$.fragment,Ei),pu=c(Ei),$s=s(Ei,"P",{});var wp=n($s);mu=i(wp,"Output type of "),$l=s(wp,"CODE",{});var Ib=n($l);hu=i(Ib,"FlaxWav2Vec2BaseModelOutput"),Ib.forEach(t),fu=i(wp,", with potential hidden states and attentions."),wp.forEach(t),uu=c(Ei),Go=s(Ei,"DIV",{class:!0});var bp=n(Go);g(js.$$.fragment,bp),gu=c(bp),jl=s(bp,"P",{});var Bb=n(jl);_u=i(Bb,"\u201CReturns a new object replacing the specified fields with new values."),Bb.forEach(t),bp.forEach(t),Ei.forEach(t),_d=c(o),wt=s(o,"DIV",{class:!0});var Pi=n(wt);g(Vs.$$.fragment,Pi),vu=c(Pi),Fs=s(Pi,"P",{});var yp=n(Fs);wu=i(yp,"Output type of "),Vl=s(yp,"CODE",{});var Ub=n(Vl);bu=i(Ub,"FlaxWav2Vec2ForPreTrainingOutput"),Ub.forEach(t),yu=i(yp,", with potential hidden states and attentions."),yp.forEach(t),ku=c(Pi),Jo=s(Pi,"DIV",{class:!0});var kp=n(Jo);g(Es.$$.fragment,kp),Tu=c(kp),Fl=s(kp,"P",{});var Hb=n(Fl);xu=i(Hb,"\u201CReturns a new object replacing the specified fields with new values."),Hb.forEach(t),kp.forEach(t),Pi.forEach(t),vd=c(o),oo=s(o,"H2",{class:!0});var Tp=n(oo);Zo=s(Tp,"A",{id:!0,class:!0,href:!0});var Rb=n(Zo);El=s(Rb,"SPAN",{});var Xb=n(El);g(Ps.$$.fragment,Xb),Xb.forEach(t),Rb.forEach(t),Wu=c(Tp),Pl=s(Tp,"SPAN",{});var Gb=n(Pl);$u=i(Gb,"Wav2Vec2Model"),Gb.forEach(t),Tp.forEach(t),wd=c(o),We=s(o,"DIV",{class:!0});var Pt=n(We);g(Cs.$$.fragment,Pt),ju=c(Pt),qs=s(Pt,"P",{});var xp=n(qs);Vu=i(xp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),Ms=s(xp,"A",{href:!0,rel:!0});var Jb=n(Ms);Fu=i(Jb,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Jb.forEach(t),Eu=i(xp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),xp.forEach(t),Pu=c(Pt),zs=s(Pt,"P",{});var Wp=n(zs);Cu=i(Wp,"This model inherits from "),ni=s(Wp,"A",{href:!0});var Zb=n(ni);qu=i(Zb,"PreTrainedModel"),Zb.forEach(t),Mu=i(Wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Wp.forEach(t),zu=c(Pt),As=s(Pt,"P",{});var $p=n(As);Au=i($p,"This model is a PyTorch "),Ls=s($p,"A",{href:!0,rel:!0});var Kb=n(Ls);Lu=i(Kb,"torch.nn.Module"),Kb.forEach(t),Du=i($p,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Ou=c(Pt),ze=s(Pt,"DIV",{class:!0});var Ct=n(ze);g(Ds.$$.fragment,Ct),Su=c(Ct),ao=s(Ct,"P",{});var Ci=n(ao);Nu=i(Ci,"The "),ri=s(Ci,"A",{href:!0});var Qb=n(ri);Iu=i(Qb,"Wav2Vec2Model"),Qb.forEach(t),Bu=i(Ci," forward method, overrides the "),Cl=s(Ci,"CODE",{});var Yb=n(Cl);Uu=i(Yb,"__call__"),Yb.forEach(t),Hu=i(Ci," special method."),Ci.forEach(t),Ru=c(Ct),g(Ko.$$.fragment,Ct),Xu=c(Ct),ql=s(Ct,"P",{});var ey=n(ql);Gu=i(ey,"Example:"),ey.forEach(t),Ju=c(Ct),g(Os.$$.fragment,Ct),Ct.forEach(t),Pt.forEach(t),bd=c(o),so=s(o,"H2",{class:!0});var jp=n(so);Qo=s(jp,"A",{id:!0,class:!0,href:!0});var ty=n(Qo);Ml=s(ty,"SPAN",{});var oy=n(Ml);g(Ss.$$.fragment,oy),oy.forEach(t),ty.forEach(t),Zu=c(jp),zl=s(jp,"SPAN",{});var ay=n(zl);Ku=i(ay,"Wav2Vec2ForCTC"),ay.forEach(t),jp.forEach(t),yd=c(o),$e=s(o,"DIV",{class:!0});var qt=n($e);g(Ns.$$.fragment,qt),Qu=c(qt),no=s(qt,"P",{});var qi=n(no);Yu=i(qi,"Wav2Vec2 Model with a "),Al=s(qi,"CODE",{});var sy=n(Al);eg=i(sy,"language modeling"),sy.forEach(t),tg=i(qi,` head on top for Connectionist Temporal Classification (CTC).
...
Auli.`),Pp.forEach(t),Cg=c(at),Ys=s(at,"P",{});var Cp=n(Ys);qg=i(Cp,"This model inherits from "),ci=s(Cp,"A",{href:!0});var gy=n(ci);Mg=i(gy,"PreTrainedModel"),gy.forEach(t),zg=i(Cp,`. Check the superclass documentation for the generic methods the
...
Representations`),Wy.forEach(t),n_=i(zp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),zp.forEach(t),r_=c(nt),dn=s(nt,"P",{});var Ap=n(dn);i_=i(Ap,"This model inherits from "),pi=s(Ap,"A",{href:!0});var $y=n(pi);l_=i($y,"PreTrainedModel"),$y.forEach(t),c_=i(Ap,`. Check the superclass documentation for the generic methods the
...
Representations`),zy.forEach(t),C_=i(Op,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Op.forEach(t),q_=c(rt),wn=s(rt,"P",{});var Sp=n(wn);M_=i(Sp,"This model inherits from "),hi=s(Sp,"A",{href:!0});var Ay=n(hi);z_=i(Ay,"PreTrainedModel"),Ay.forEach(t),A_=i(Sp,`. Check the superclass documentation for the generic methods the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp.forEach(t),qv=c(it),zn=s(it,"P",{});var Xp=n(zn);Mv=i(Xp,"This model is also a "),An=s(Xp,"A",{href:!0,rel:!0});var ok=n(An);zv=i(ok,"tf.keras.Model"),ok.forEach(t),Av=i(Xp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
