...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16111/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ia=new H({}),da=new q({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/bart/modeling_bart.py#L1265",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ha=new q({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/bart/modeling_bart.py#L1304",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/bart/modeling_flax_bart.py#L1320",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Lg=d(),Jd=n("p"),Gg=r("Finally, this model supports inherent JAX features such as:"),Wg=d(),ht=n("ul"),Xd=n("li"),fs=n("a"),Rg=r("Just-In-Time (JIT) compilation"),Ug=d(),Kd=n("li"),_s=n("a"),Hg=r("Automatic Differentiation"),Qg=d(),Zd=n("li"),gs=n("a"),Vg=r("Vectorization"),Jg=d(),Yd=n("li"),ks=n("a"),Xg=r("Parallelization"),Kg=d(),te=n("div"),m(bs.$$.fragment),Zg=d(),vo=n("p"),Yg=r("The "),el=n("code"),e1=r("FlaxBartPreTrainedModel"),t1=r("forward method, overrides the "),tl=n("code"),o1=r("__call__"),n1=r(" special method."),a1=d(),m(rn.$$.fragment),s1=d(),ol=n("p"),r1=r("Summarization example:"),i1=d(),m(ys.$$.fragment),d1=d(),nl=n("p"),l1=r("Mask filling example:"),c1=d(),m(vs.$$.fragment),p1=d(),Tt=n("div"),m(Ts.$$.fragment),h1=d(),al=n("p"),u1=r("Example:"),m1=d(),m(ws.$$.fragment),f1=d(),wt=n("div"),m(xs.$$.fragment),_1=d(),sl=n("p"),g1=r("Example:"),k1=d(),m(zs.$$.fragment),Mc=d(),To=n("h2"),dn=n("a"),rl=n("span"),m(Fs.$$.fragment),b1=d(),il=n("span"),y1=r("FlaxBartForSequenceClassification"),Pc=d(),I=n("div"),m(Bs.$$.fragment),v1=d(),dl=n("p"),T1=r(`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),w1=d(),qs=n("p"),x1=r("This model inherits from "),Wr=n("a"),z1=r("FlaxPreTrainedModel"),F1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),B1=d(),$s=n("p"),q1=r(`This model is also a Flax Linen
`),js=n("a"),$1=r("flax.nn.Module"),j1=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),M1=d(),ll=n("p"),P1=r("Finally, this model supports inherent JAX features such as:"),E1=d(),ut=n("ul"),cl=n("li"),Ms=n("a"),C1=r("Just-In-Time (JIT) compilation"),A1=d(),pl=n("li"),Ps=n("a"),S1=r("Automatic Differentiation"),I1=d(),hl=n("li"),Es=n("a"),O1=r("Vectorization"),N1=d(),ul=n("li"),Cs=n("a"),D1=r("Parallelization"),L1=d(),Se=n("div"),m(As.$$.fragment),G1=d(),wo=n("p"),W1=r("The "),ml=n("code"),R1=r("FlaxBartPreTrainedModel"),U1=r("forward method, overrides the "),fl=n("code"),H1=r("__call__"),Q1=r(" special method."),V1=d(),m(ln.$$.fragment),J1=d(),_l=n("p"),X1=r("Example:"),K1=d(),m(Ss.$$.fragment),Z1=d(),xt=n("div"),m(Is.$$.fragment),Y1=d(),gl=n("p"),ek=r("Example:"),tk=d(),m(Os.$$.fragment),ok=d(),zt=n("div"),m(Ns.$$.fragment),nk=d(),kl=n("p"),ak=r("Example:"),sk=d(),m(Ds.$$.fragment),Ec=d(),xo=n("h2"),cn=n("a"),bl=n("span"),m(Ls.$$.fragment),rk=d(),yl=n("span"),ik=r("FlaxBartForQuestionAnswering"),Cc=d(),O=n("div"),m(Gs.$$.fragment),dk=d(),zo=n("p"),lk=r(`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),vl=n("code"),ck=r("span start logits"),pk=r(" and "),Tl=n("code"),hk=r("span end logits"),uk=r(")."),mk=d(),Ws=n("p"),fk=r("This model inherits from "),Rr=n("a"),_k=r("FlaxPreTrainedModel"),gk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kk=d(),Rs=n("p"),bk=r(`This model is also a Flax Linen
`),Us=n("a"),yk=r("flax.nn.Module"),vk=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tk=d(),wl=n("p"),wk=r("Finally, this model supports inherent JAX features such as:"),xk=d(),mt=n("ul"),xl=n("li"),Hs=n("a"),zk=r("Just-In-Time (JIT) compilation"),Fk=d(),zl=n("li"),Qs=n("a"),Bk=r("Automatic Differentiation"),qk=d(),Fl=n("li"),Vs=n("a"),$k=r("Vectorization"),jk=d(),Bl=n("li"),Js=n("a"),Mk=r("Parallelization"),Pk=d(),Ie=n("div"),m(Xs.$$.fragment),Ek=d(),Fo=n("p"),Ck=r("The "),ql=n("code"),Ak=r("FlaxBartPreTrainedModel"),Sk=r("forward method, overrides the "),$l=n("code"),Ik=r("__call__"),Ok=r(" special method."),Nk=d(),m(pn.$$.fragment),Dk=d(),jl=n("p"),Lk=r("Example:"),Gk=d(),m(Ks.$$.fragment),Wk=d(),Ft=n("div"),m(Zs.$$.fragment),Rk=d(),Ml=n("p"),Uk=r("Example:"),Hk=d(),m(Ys.$$.fragment),Qk=d(),Bt=n("div"),m(er.$$.fragment),Vk=d(),Pl=n("p"),Jk=r("Example:"),Xk=d(),m(tr.$$.fragment),Ac=d(),Bo=n("h2"),hn=n("a"),El=n("span"),m(or.$$.fragment),Kk=d(),Cl=n("span"),Zk=r("FlaxBartForCausalLM"),Sc=d(),X=n("div"),m(nr.$$.fragment),Yk=d(),Al=n("p"),eb=r(`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
e.g for autoregressive tasks.`),tb=d(),ar=n("p"),ob=r("This model inherits from "),Ur=n("a"),nb=r("FlaxPreTrainedModel"),ab=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sb=d(),sr=n("p"),rb=r(`This model is also a Flax Linen
`),rr=n("a"),ib=r("flax.nn.Module"),db=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),lb=d(),Sl=n("p"),cb=r("Finally, this model supports inherent JAX features such as:"),pb=d(),ft=n("ul"),Il=n("li"),ir=n("a"),hb=r("Just-In-Time (JIT) compilation"),ub=d(),Ol=n("li"),dr=n("a"),mb=r("Automatic Differentiation"),fb=d(),Nl=n("li"),lr=n("a"),_b=r("Vectorization"),gb=d(),Dl=n("li"),cr=n("a"),kb=r("Parallelization"),bb=d(),Oe=n("div"),m(pr.$$.fragment),yb=d(),qo=n("p"),vb=r("The "),Ll=n("code"),Tb=r("FlaxBartDecoderPreTrainedModel"),wb=r("forward method, overrides the "),Gl=n("code"),xb=r("__call__"),zb=r(" special method."),Fb=d(),m(un.$$.fragment),Bb=d(),Wl=n("p"),qb=r("Example:"),$b=d(),m(hr.$$.fragment),this.h()},l(o){const h=Iw('[data-svelte="svelte-1phssyn"]',document.head);p=a(h,"META",{name:!0,content:!0}),h.forEach(t),z=l(o),y=a(o,"H1",{class:!0});var ur=s(y);w=a(ur,"A",{id:!0,class:!0,href:!0});var Rl=s(w);x=a(Rl,"SPAN",{});var Ul=s(x);f(T.$$.fragment,Ul),Ul.forEach(t),Rl.forEach(t),v=l(ur),B=a(ur,"SPAN",{});var Hl=s(B);ae=i(Hl,"BART"),Hl.forEach(t),ur.forEach(t),A=l(o),$=a(o,"P",{});var mn=s($);ce=a(mn,"STRONG",{});var Ql=s(ce);ge=i(Ql,"DISCLAIMER:"),Ql.forEach(t),et=i(mn," If you see something strange, file a "),ke=a(mn,"A",{href:!0,rel:!0});var Vl=s(ke);be=i(Vl,"Github Issue"),Vl.forEach(t),tt=i(mn,` and assign
...
Ghazvininejad, Abdelrahman Mohamed, Omer Levy, Ves Stoyanov and Luke Zettlemoyer on 29 Oct, 2019.`),fr.forEach(t),D=l(o),$e=a(o,"P",{});var Yl=s($e);ye=i(Yl,"According to the abstract,"),Yl.forEach(t),Ye=l(o),K=a(o,"UL",{});var $o=s(K);re=a($o,"LI",{});var Eb=s(re);rt=i(Eb,`Bart uses a standard seq2seq/machine translation architecture with a bidirectional encoder (like BERT) and a
left-to-right decoder (like GPT).`),Eb.forEach(t),it=l($o),J=a($o,"LI",{});var Cb=s(J);dt=i(Cb,`The pretraining task involves randomly shuffling the order of the original sentences and a novel in-filling scheme,
where spans of text are replaced with a single mask token.`),Cb.forEach(t),ve=l($o),Ue=a($o,"LI",{});var Ab=s(Ue);F=i(Ab,`BART is particularly effective when fine tuned for text generation but also works well for comprehension tasks. It
matches the performance of RoBERTa with comparable training resources on GLUE and SQuAD, achieves new
state-of-the-art results on a range of abstractive dialogue, question answering, and summarization tasks, with gains
of up to 6 ROUGE.`),Ab.forEach(t),$o.forEach(t),M=l(o),U=a(o,"P",{});var Hr=s(U);Lt=i(Hr,"This model was contributed by "),He=a(Hr,"A",{href:!0,rel:!0});var Sb=s(He);ie=i(Sb,"sshleifer"),Sb.forEach(t),Gt=i(Hr,". The Authors\u2019 code can be found "),Qe=a(Hr,"A",{href:!0,rel:!0});var Ib=s(Qe);Wt=i(Ib,"here"),Ib.forEach(t),de=i(Hr,"."),Hr.forEach(t),ue=l(o),Te=a(o,"H3",{class:!0});var Oc=s(Te);je=a(Oc,"A",{id:!0,class:!0,href:!0});var Ob=s(je);le=a(Ob,"SPAN",{});var Nb=s(le);f(Ve.$$.fragment,Nb),Nb.forEach(t),Ob.forEach(t),Rt=l(Oc),Je=a(Oc,"SPAN",{});var Db=s(Je);Ut=i(Db,"Examples"),Db.forEach(t),Oc.forEach(t),tc=l(o),_t=a(o,"UL",{});var Qr=s(_t);xn=a(Qr,"LI",{});var Nc=s(xn);Ip=i(Nc,`Examples and scripts for fine-tuning BART and other models for sequence to sequence tasks can be found in
`),zn=a(Nc,"A",{href:!0,rel:!0});var Lb=s(zn);Op=i(Lb,"examples/pytorch/summarization/"),Lb.forEach(t),Np=i(Nc,"."),Nc.forEach(t),Dp=l(Qr),lt=a(Qr,"LI",{});var fn=s(lt);Lp=i(fn,"An example of how to train "),_r=a(fn,"A",{href:!0});var Gb=s(_r);Gp=i(Gb,"BartForConditionalGeneration"),Gb.forEach(t),Wp=i(fn," with a Hugging Face "),wi=a(fn,"CODE",{});var Wb=s(wi);Rp=i(Wb,"datasets"),Wb.forEach(t),Up=i(fn,`
object can be found in this `),Fn=a(fn,"A",{href:!0,rel:!0});var Rb=s(Fn);Hp=i(Rb,"forum discussion"),Rb.forEach(t),Qp=i(fn,"."),fn.forEach(t),Vp=l(Qr),jo=a(Qr,"LI",{});var ec=s(jo);Bn=a(ec,"A",{href:!0,rel:!0});var Ub=s(Bn);Jp=i(Ub,"Distilled checkpoints"),Ub.forEach(t),Xp=i(ec," are described in this "),qn=a(ec,"A",{href:!0,rel:!0});var Hb=s(qn);Kp=i(Hb,"paper"),Hb.forEach(t),Zp=i(ec,"."),ec.forEach(t),Qr.forEach(t),oc=l(o),Ht=a(o,"H2",{class:!0});var Dc=s(Ht);Mo=a(Dc,"A",{id:!0,class:!0,href:!0});var Qb=s(Mo);xi=a(Qb,"SPAN",{});var Vb=s(xi);f($n.$$.fragment,Vb),Vb.forEach(t),Qb.forEach(t),Yp=l(Dc),zi=a(Dc,"SPAN",{});var Jb=s(zi);eh=i(Jb,"Implementation Notes"),Jb.forEach(t),Dc.forEach(t),nc=l(o),Me=a(o,"UL",{});var qt=s(Me);ct=a(qt,"LI",{});var _n=s(ct);th=i(_n,"Bart doesn\u2019t use "),Fi=a(_n,"CODE",{});var Xb=s(Fi);oh=i(Xb,"token_type_ids"),Xb.forEach(t),nh=i(_n," for sequence classification. Use "),gr=a(_n,"A",{href:!0});var Kb=s(gr);ah=i(Kb,"BartTokenizer"),Kb.forEach(t),sh=i(_n,` or
`),kr=a(_n,"A",{href:!0});var Zb=s(kr);rh=i(Zb,"encode()"),Zb.forEach(t),ih=i(_n," to get the proper splitting."),_n.forEach(t),dh=l(qt),Qt=a(qt,"LI",{});var Vr=s(Qt);lh=i(Vr,"The forward pass of "),br=a(Vr,"A",{href:!0});var Yb=s(br);ch=i(Yb,"BartModel"),Yb.forEach(t),ph=i(Vr," will create the "),Bi=a(Vr,"CODE",{});var ey=s(Bi);hh=i(ey,"decoder_input_ids"),ey.forEach(t),uh=i(Vr,` if they are not passed.
...
`),$i=a(Jr,"CODE",{});var oy=s($i);kh=i(oy,"fairseq.encode"),oy.forEach(t),bh=i(Jr," starts with a space."),Jr.forEach(t),yh=l(qt),yr=a(qt,"LI",{});var jb=s(yr);vr=a(jb,"A",{href:!0});var ny=s(vr);vh=i(ny,"generate()"),ny.forEach(t),Th=i(jb,` should be used for conditional generation tasks like
summarization, see the example in that docstrings.`),jb.forEach(t),wh=l(qt),Jt=a(qt,"LI",{});var Xr=s(Jt);xh=i(Xr,"Models that load the "),ji=a(Xr,"EM",{});var ay=s(ji);zh=i(ay,"facebook/bart-large-cnn"),ay.forEach(t),Fh=i(Xr," weights will not have a "),Mi=a(Xr,"CODE",{});var sy=s(Mi);Bh=i(sy,"mask_token_id"),sy.forEach(t),qh=i(Xr,`, or be able to perform
...
adding special tokens. A BART sequence has the following format:`),Fy.forEach(t),ku=l(ei),Gn=a(ei,"UL",{});var Hc=s(Gn);Fr=a(Hc,"LI",{});var Mb=s(Fr);bu=i(Mb,"single sequence: "),Ui=a(Mb,"CODE",{});var By=s(Ui);yu=i(By,"<s> X </s>"),By.forEach(t),Mb.forEach(t),vu=l(Hc),Br=a(Hc,"LI",{});var Pb=s(Br);Tu=i(Pb,"pair of sequences: "),Hi=a(Pb,"CODE",{});var qy=s(Hi);wu=i(qy,"<s> A </s></s> B </s>"),qy.forEach(t),Pb.forEach(t),Hc.forEach(t),ei.forEach(t),xu=l(L),So=a(L,"DIV",{class:!0});var Qc=s(So);f(Wn.$$.fragment,Qc),zu=l(Qc),Qi=a(Qc,"P",{});var $y=s(Qi);Fu=i($y,"Converts a sequence of tokens (string) in a single string."),$y.forEach(t),Qc.forEach(t),Bu=l(L),Io=a(L,"DIV",{class:!0});var Vc=s(Io);f(Rn.$$.fragment,Vc),qu=l(Vc),Vi=a(Vc,"P",{});var jy=s(Vi);$u=i(jy,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
