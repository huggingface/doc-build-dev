...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16111/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[W2]},$$scope:{ctx:E}}}),Ns=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),_r=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/mbart/modeling_flax_mbart.py#L1343",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16111/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16111/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16111/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16111/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),e1=d(),cs=n("p"),t1=r("This model is also a PyTorch "),ps=n("a"),o1=r("torch.nn.Module"),n1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),a1=d(),Ae=n("div"),m(hs.$$.fragment),s1=d(),go=n("p"),r1=r("The "),yi=n("a"),i1=r("MBartForQuestionAnswering"),d1=r(" forward method, overrides the "),Wl=n("code"),l1=r("__call__"),c1=r(" special method."),p1=d(),m(an.$$.fragment),h1=d(),Rl=n("p"),u1=r("Example:"),m1=d(),m(us.$$.fragment),Vp=d(),ko=n("h2"),sn=n("a"),Ul=n("span"),m(ms.$$.fragment),f1=d(),Xl=n("span"),_1=r("MBartForSequenceClassification"),Qp=d(),Be=n("div"),m(fs.$$.fragment),g1=d(),Hl=n("p"),k1=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),b1=d(),_s=n("p"),v1=r("This model inherits from "),Ti=n("a"),y1=r("PreTrainedModel"),T1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),M1=d(),gs=n("p"),w1=r("This model is also a PyTorch "),ks=n("a"),x1=r("torch.nn.Module"),z1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),q1=d(),Y=n("div"),m(bs.$$.fragment),B1=d(),bo=n("p"),$1=r("The "),Mi=n("a"),F1=r("MBartForSequenceClassification"),j1=r(" forward method, overrides the "),Vl=n("code"),E1=r("__call__"),P1=r(" special method."),C1=d(),m(rn.$$.fragment),S1=d(),Ql=n("p"),A1=r("Example of single-label classification:"),I1=d(),m(vs.$$.fragment),N1=d(),Jl=n("p"),O1=r("Example of multi-label classification:"),D1=d(),m(ys.$$.fragment),Jp=d(),vo=n("h2"),dn=n("a"),Kl=n("span"),m(Ts.$$.fragment),L1=d(),Zl=n("span"),G1=r("MBartForCausalLM"),Kp=d(),yo=n("div"),m(Ms.$$.fragment),W1=d(),Tt=n("div"),m(ws.$$.fragment),R1=d(),Yl=n("p"),U1=r("Example:"),X1=d(),m(xs.$$.fragment),Zp=d(),To=n("h2"),ln=n("a"),ec=n("span"),m(zs.$$.fragment),H1=d(),tc=n("span"),V1=r("TFMBartModel"),Yp=d(),$e=n("div"),m(qs.$$.fragment),Q1=d(),Bs=n("p"),J1=r(`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),wi=n("a"),K1=r("TFPreTrainedModel"),Z1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Y1=d(),$s=n("p"),eb=r("This model is also a "),Fs=n("a"),tb=r("tf.keras.Model"),ob=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),nb=d(),m(cn.$$.fragment),ab=d(),Ie=n("div"),m(js.$$.fragment),sb=d(),Mo=n("p"),rb=r("The "),xi=n("a"),ib=r("TFMBartModel"),db=r(" forward method, overrides the "),oc=n("code"),lb=r("__call__"),cb=r(" special method."),pb=d(),m(pn.$$.fragment),hb=d(),nc=n("p"),ub=r("Example:"),mb=d(),m(Es.$$.fragment),eh=d(),wo=n("h2"),hn=n("a"),ac=n("span"),m(Ps.$$.fragment),fb=d(),sc=n("span"),_b=r("TFMBartForConditionalGeneration"),th=d(),Fe=n("div"),m(Cs.$$.fragment),gb=d(),Ss=n("p"),kb=r(`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=n("a"),bb=r("TFPreTrainedModel"),vb=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yb=d(),As=n("p"),Tb=r("This model is also a "),Is=n("a"),Mb=r("tf.keras.Model"),wb=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xb=d(),m(un.$$.fragment),zb=d(),ee=n("div"),m(Ns.$$.fragment),qb=d(),xo=n("p"),Bb=r("The "),qi=n("a"),$b=r("TFMBartForConditionalGeneration"),Fb=r(" forward method, overrides the "),rc=n("code"),jb=r("__call__"),Eb=r(" special method."),Pb=d(),m(mn.$$.fragment),Cb=d(),ic=n("p"),Sb=r("Summarization example:"),Ab=d(),m(Os.$$.fragment),Ib=d(),dc=n("p"),Nb=r("Mask filling example:"),Ob=d(),m(Ds.$$.fragment),oh=d(),zo=n("h2"),fn=n("a"),lc=n("span"),m(Ls.$$.fragment),Db=d(),cc=n("span"),Lb=r("FlaxMBartModel"),nh=d(),W=n("div"),m(Gs.$$.fragment),Gb=d(),Ws=n("p"),Wb=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=n("a"),Rb=r("FlaxPreTrainedModel"),Ub=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xb=d(),Rs=n("p"),Hb=r(`This model is also a Flax Linen
`),Us=n("a"),Vb=r("flax.nn.Module"),Qb=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jb=d(),pc=n("p"),Kb=r("Finally, this model supports inherent JAX features such as:"),Zb=d(),mt=n("ul"),hc=n("li"),Xs=n("a"),Yb=r("Just-In-Time (JIT) compilation"),ev=d(),uc=n("li"),Hs=n("a"),tv=r("Automatic Differentiation"),ov=d(),mc=n("li"),Vs=n("a"),nv=r("Vectorization"),av=d(),fc=n("li"),Qs=n("a"),sv=r("Parallelization"),rv=d(),Ne=n("div"),m(Js.$$.fragment),iv=d(),qo=n("p"),dv=r("The "),_c=n("code"),lv=r("FlaxMBartPreTrainedModel"),cv=r("forward method, overrides the "),gc=n("code"),pv=r("__call__"),hv=r(" special method."),uv=d(),m(_n.$$.fragment),mv=d(),kc=n("p"),fv=r("Example:"),_v=d(),m(Ks.$$.fragment),gv=d(),Mt=n("div"),m(Zs.$$.fragment),kv=d(),bc=n("p"),bv=r("Example:"),vv=d(),m(Ys.$$.fragment),yv=d(),wt=n("div"),m(er.$$.fragment),Tv=d(),vc=n("p"),Mv=r("Example:"),wv=d(),m(tr.$$.fragment),ah=d(),Bo=n("h2"),gn=n("a"),yc=n("span"),m(or.$$.fragment),xv=d(),Tc=n("span"),zv=r("FlaxMBartForConditionalGeneration"),sh=d(),R=n("div"),m(nr.$$.fragment),qv=d(),ar=n("p"),Bv=r(`The MMBart Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),e1=l(At),cs=a(At,"P",{});var du=s(cs);t1=i(du,"This model is also a PyTorch "),ps=a(du,"A",{href:!0,rel:!0});var zx=s(ps);o1=i(zx,"torch.nn.Module"),zx.forEach(t),n1=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),a1=l(At),Ae=a(At,"DIV",{class:!0});var It=s(Ae);f(hs.$$.fragment,It),s1=l(It),go=a(It,"P",{});var Gi=s(go);r1=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var qx=s(yi);i1=i(qx,"MBartForQuestionAnswering"),qx.forEach(t),d1=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var Bx=s(Wl);l1=i(Bx,"__call__"),Bx.forEach(t),c1=i(Gi," special method."),Gi.forEach(t),p1=l(It),f(an.$$.fragment,It),h1=l(It),Rl=a(It,"P",{});var $x=s(Rl);u1=i($x,"Example:"),$x.forEach(t),m1=l(It),f(us.$$.fragment,It),It.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var Fx=s(sn);Ul=a(Fx,"SPAN",{});var jx=s(Ul);f(ms.$$.fragment,jx),jx.forEach(t),Fx.forEach(t),f1=l(lu),Xl=a(lu,"SPAN",{});var Ex=s(Xl);_1=i(Ex,"MBartForSequenceClassification"),Ex.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var Nt=s(Be);f(fs.$$.fragment,Nt),g1=l(Nt),Hl=a(Nt,"P",{});var Px=s(Hl);k1=i(Px,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Px.forEach(t),b1=l(Nt),_s=a(Nt,"P",{});var cu=s(_s);v1=i(cu,"This model inherits from "),Ti=a(cu,"A",{href:!0});var Cx=s(Ti);y1=i(Cx,"PreTrainedModel"),Cx.forEach(t),T1=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),M1=l(Nt),gs=a(Nt,"P",{});var pu=s(gs);w1=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var Sx=s(ks);x1=i(Sx,"torch.nn.Module"),Sx.forEach(t),z1=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),q1=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),B1=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);$1=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var Ax=s(Mi);F1=i(Ax,"MBartForSequenceClassification"),Ax.forEach(t),j1=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var Ix=s(Vl);E1=i(Ix,"__call__"),Ix.forEach(t),P1=i(Wi," special method."),Wi.forEach(t),C1=l(Ge),f(rn.$$.fragment,Ge),S1=l(Ge),Ql=a(Ge,"P",{});var Nx=s(Ql);A1=i(Nx,"Example of single-label classification:"),Nx.forEach(t),I1=l(Ge),f(vs.$$.fragment,Ge),N1=l(Ge),Jl=a(Ge,"P",{});var Ox=s(Jl);O1=i(Ox,"Example of multi-label classification:"),Ox.forEach(t),D1=l(Ge),f(ys.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Jp=l(o),vo=a(o,"H2",{class:!0});var hu=s(vo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var Dx=s(dn);Kl=a(Dx,"SPAN",{});var Lx=s(Kl);f(Ts.$$.fragment,Lx),Lx.forEach(t),Dx.forEach(t),L1=l(hu),Zl=a(hu,"SPAN",{});var Gx=s(Zl);G1=i(Gx,"MBartForCausalLM"),Gx.forEach(t),hu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var uu=s(yo);f(Ms.$$.fragment,uu),W1=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),R1=l(Ri),Yl=a(Ri,"P",{});var Wx=s(Yl);U1=i(Wx,"Example:"),Wx.forEach(t),X1=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var Rx=s(ln);ec=a(Rx,"SPAN",{});var Ux=s(ec);f(zs.$$.fragment,Ux),Ux.forEach(t),Rx.forEach(t),H1=l(mu),tc=a(mu,"SPAN",{});var Xx=s(tc);V1=i(Xx,"TFMBartModel"),Xx.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);f(qs.$$.fragment,Ot),Q1=l(Ot),Bs=a(Ot,"P",{});var fu=s(Bs);J1=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),wi=a(fu,"A",{href:!0});var Hx=s(wi);K1=i(Hx,"TFPreTrainedModel"),Hx.forEach(t),Z1=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Y1=l(Ot),$s=a(Ot,"P",{});var _u=s($s);eb=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var Vx=s(Fs);tb=i(Vx,"tf.keras.Model"),Vx.forEach(t),ob=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nb=l(Ot),f(cn.$$.fragment,Ot),ab=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),sb=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);rb=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Qx=s(xi);ib=i(Qx,"TFMBartModel"),Qx.forEach(t),db=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var Jx=s(oc);lb=i(Jx,"__call__"),Jx.forEach(t),cb=i(Ui," special method."),Ui.forEach(t),pb=l(Dt),f(pn.$$.fragment,Dt),hb=l(Dt),nc=a(Dt,"P",{});var Kx=s(nc);ub=i(Kx,"Example:"),Kx.forEach(t),mb=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Zx=s(hn);ac=a(Zx,"SPAN",{});var Yx=s(ac);f(Ps.$$.fragment,Yx),Yx.forEach(t),Zx.forEach(t),fb=l(gu),sc=a(gu,"SPAN",{});var ez=s(sc);_b=i(ez,"TFMBartForConditionalGeneration"),ez.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gb=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);kb=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var tz=s(zi);bb=i(tz,"TFPreTrainedModel"),tz.forEach(t),vb=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),yb=l(Lt),As=a(Lt,"P",{});var bu=s(As);Tb=i(bu,"This model is also a "),Is=a(bu,"A",{href:!0,rel:!0});var oz=s(Is);Mb=i(oz,"tf.keras.Model"),oz.forEach(t),wb=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),xb=l(Lt),f(un.$$.fragment,Lt),zb=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Ns.$$.fragment,We),qb=l(We),xo=a(We,"P",{});var Xi=s(xo);Bb=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var nz=s(qi);$b=i(nz,"TFMBartForConditionalGeneration"),nz.forEach(t),Fb=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var az=s(rc);jb=i(az,"__call__"),az.forEach(t),Eb=i(Xi," special method."),Xi.forEach(t),Pb=l(We),f(mn.$$.fragment,We),Cb=l(We),ic=a(We,"P",{});var sz=s(ic);Sb=i(sz,"Summarization example:"),sz.forEach(t),Ab=l(We),f(Os.$$.fragment,We),Ib=l(We),dc=a(We,"P",{});var rz=s(dc);Nb=i(rz,"Mask filling example:"),rz.forEach(t),Ob=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),oh=l(o),zo=a(o,"H2",{class:!0});var vu=s(zo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var iz=s(fn);lc=a(iz,"SPAN",{});var dz=s(lc);f(Ls.$$.fragment,dz),dz.forEach(t),iz.forEach(t),Db=l(vu),cc=a(vu,"SPAN",{});var lz=s(cc);Lb=i(lz,"FlaxMBartModel"),lz.forEach(t),vu.forEach(t),nh=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),Gb=l(me),Ws=a(me,"P",{});var yu=s(Ws);Wb=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=a(yu,"A",{href:!0});var cz=s(Bi);Rb=i(cz,"FlaxPreTrainedModel"),cz.forEach(t),Ub=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yu.forEach(t),Xb=l(me),Rs=a(me,"P",{});var Tu=s(Rs);Hb=i(Tu,`This model is also a Flax Linen
`),Us=a(Tu,"A",{href:!0,rel:!0});var pz=s(Us);Vb=i(pz,"flax.nn.Module"),pz.forEach(t),Qb=i(Tu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tu.forEach(t),Jb=l(me),pc=a(me,"P",{});var hz=s(pc);Kb=i(hz,"Finally, this model supports inherent JAX features such as:"),hz.forEach(t),Zb=l(me),mt=a(me,"UL",{});var Fn=s(mt);hc=a(Fn,"LI",{});var uz=s(hc);Xs=a(uz,"A",{href:!0,rel:!0});var mz=s(Xs);Yb=i(mz,"Just-In-Time (JIT) compilation"),mz.forEach(t),uz.forEach(t),ev=l(Fn),uc=a(Fn,"LI",{});var fz=s(uc);Hs=a(fz,"A",{href:!0,rel:!0});var _z=s(Hs);tv=i(_z,"Automatic Differentiation"),_z.forEach(t),fz.forEach(t),ov=l(Fn),mc=a(Fn,"LI",{});var gz=s(mc);Vs=a(gz,"A",{href:!0,rel:!0});var kz=s(Vs);nv=i(kz,"Vectorization"),kz.forEach(t),gz.forEach(t),av=l(Fn),fc=a(Fn,"LI",{});var bz=s(fc);Qs=a(bz,"A",{href:!0,rel:!0});var vz=s(Qs);sv=i(vz,"Parallelization"),vz.forEach(t),bz.forEach(t),Fn.forEach(t),rv=l(me),Ne=a(me,"DIV",{class:!0});var Gt=s(Ne);f(Js.$$.fragment,Gt),iv=l(Gt),qo=a(Gt,"P",{});var Hi=s(qo);dv=i(Hi,"The "),_c=a(Hi,"CODE",{});var yz=s(_c);lv=i(yz,"FlaxMBartPreTrainedModel"),yz.forEach(t),cv=i(Hi,"forward method, overrides the "),gc=a(Hi,"CODE",{});var Tz=s(gc);pv=i(Tz,"__call__"),Tz.forEach(t),hv=i(Hi," special method."),Hi.forEach(t),uv=l(Gt),f(_n.$$.fragment,Gt),mv=l(Gt),kc=a(Gt,"P",{});var Mz=s(kc);fv=i(Mz,"Example:"),Mz.forEach(t),_v=l(Gt),f(Ks.$$.fragment,Gt),Gt.forEach(t),gv=l(me),Mt=a(me,"DIV",{class:!0});var Vi=s(Mt);f(Zs.$$.fragment,Vi),kv=l(Vi),bc=a(Vi,"P",{});var wz=s(bc);bv=i(wz,"Example:"),wz.forEach(t),vv=l(Vi),f(Ys.$$.fragment,Vi),Vi.forEach(t),yv=l(me),wt=a(me,"DIV",{class:!0});var Qi=s(wt);f(er.$$.fragment,Qi),Tv=l(Qi),vc=a(Qi,"P",{});var xz=s(vc);Mv=i(xz,"Example:"),xz.forEach(t),wv=l(Qi),f(tr.$$.fragment,Qi),Qi.forEach(t),me.forEach(t),ah=l(o),Bo=a(o,"H2",{class:!0});var Mu=s(Bo);gn=a(Mu,"A",{id:!0,class:!0,href:!0});var zz=s(gn);yc=a(zz,"SPAN",{});var qz=s(yc);f(or.$$.fragment,qz),qz.forEach(t),zz.forEach(t),xv=l(Mu),Tc=a(Mu,"SPAN",{});var Bz=s(Tc);zv=i(Bz,"FlaxMBartForConditionalGeneration"),Bz.forEach(t),Mu.forEach(t),sh=l(o),R=a(o,"DIV",{class:!0});var fe=s(R);f(nr.$$.fragment,fe),qv=l(fe),ar=a(fe,"P",{});var wu=s(ar);Bv=i(wu,`The MMBart Model with a language modeling head. Can be used for summarization.
