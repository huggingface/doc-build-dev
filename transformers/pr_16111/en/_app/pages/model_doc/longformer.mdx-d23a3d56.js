...
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),as=new S({props:{name:"forward",anchor:"transformers.LongformerModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/longformer/modeling_longformer.py#L1608",parametersDescription:[{anchor:"transformers.LongformerModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.LongformerConfig"
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bs=new S({props:{name:"forward",anchor:"transformers.LongformerForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/longformer/modeling_longformer.py#L1852",parametersDescription:[{anchor:"transformers.LongformerForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Es=new S({props:{name:"forward",anchor:"transformers.LongformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/longformer/modeling_longformer.py#L2199",parametersDescription:[{anchor:"transformers.LongformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),As=new S({props:{name:"forward",anchor:"transformers.LongformerForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/longformer/modeling_longformer.py#L2118",parametersDescription:[{anchor:"transformers.LongformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new S({props:{name:"forward",anchor:"transformers.LongformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/longformer/modeling_longformer.py#L1978",parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16111/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
trained and should be used as follows:`),td.forEach(t),Cd=d(o),v(Mn.$$.fragment,o),Pd=d(o),It=a(o,"H2",{class:!0});var zc=i(It);Do=a(zc,"A",{id:!0,class:!0,href:!0});var Yk=i(Do);ai=a(Yk,"SPAN",{});var Zk=i(ai);v(En.$$.fragment,Zk),Zk.forEach(t),Yk.forEach(t),wm=d(zc),ii=a(zc,"SPAN",{});var e1=i(ii);km=s(e1,"LongformerConfig"),e1.forEach(t),zc.forEach(t),jd=d(o),Oe=a(o,"DIV",{class:!0});var it=i(Oe);v(zn.$$.fragment,it),vm=d(it),Nt=a(it,"P",{});var $a=i(Nt);bm=s($a,"This is the configuration class to store the configuration of a "),Br=a($a,"A",{href:!0});var t1=i(Br);Tm=s(t1,"LongformerModel"),t1.forEach(t),ym=s($a," or a "),Wr=a($a,"A",{href:!0});var o1=i(Wr);Lm=s(o1,"TFLongformerModel"),o1.forEach(t),$m=s($a,`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),$a.forEach(t),Fm=d(it),St=a(it,"P",{});var Fa=i(St);xm=s(Fa,"This is the configuration class to store the configuration of a "),Qr=a(Fa,"A",{href:!0});var n1=i(Qr);Mm=s(n1,"LongformerModel"),n1.forEach(t),Em=s(Fa,`. It is used to instantiate an
Longformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the RoBERTa
`),qn=a(Fa,"A",{href:!0,rel:!0});var s1=i(qn);zm=s(s1,"roberta-base"),s1.forEach(t),qm=s(Fa," architecture with a sequence length 4,096."),Fa.forEach(t),Cm=d(it),Dt=a(it,"P",{});var xa=i(Dt);Pm=s(xa,"The "),Hr=a(xa,"A",{href:!0});var r1=i(Hr);jm=s(r1,"LongformerConfig"),r1.forEach(t),Om=s(xa," class directly inherits "),Rr=a(xa,"A",{href:!0});var a1=i(Rr);Am=s(a1,"RobertaConfig"),a1.forEach(t),Im=s(xa,`. It reuses the same defaults. Please check the
parent class for more information.`),xa.forEach(t),Nm=d(it),li=a(it,"P",{});var i1=i(li);Sm=s(i1,"Example:"),i1.forEach(t),Dm=d(it),v(Cn.$$.fragment,it),it.forEach(t),Od=d(o),Bt=a(o,"H2",{class:!0});var qc=i(Bt);Bo=a(qc,"A",{id:!0,class:!0,href:!0});var l1=i(Bo);di=a(l1,"SPAN",{});var d1=i(di);v(Pn.$$.fragment,d1),d1.forEach(t),l1.forEach(t),Bm=d(qc),ci=a(qc,"SPAN",{});var c1=i(ci);Wm=s(c1,"LongformerTokenizer"),c1.forEach(t),qc.forEach(t),Ad=d(o),ft=a(o,"DIV",{class:!0});var Ma=i(ft);v(jn.$$.fragment,Ma),Qm=d(Ma),hi=a(Ma,"P",{});var h1=i(hi);Hm=s(h1,"Construct a Longformer tokenizer."),h1.forEach(t),Rm=d(Ma),Wo=a(Ma,"P",{});var od=i(Wo);Ur=a(od,"A",{href:!0});var m1=i(Ur);Um=s(m1,"LongformerTokenizer"),m1.forEach(t),Vm=s(od," is identical to "),Vr=a(od,"A",{href:!0});var f1=i(Vr);Gm=s(f1,"RobertaTokenizer"),f1.forEach(t),Km=s(od,`. Refer to the superclass for usage examples and
documentation concerning parameters.`),od.forEach(t),Ma.forEach(t),Id=d(o),Wt=a(o,"H2",{class:!0});var Cc=i(Wt);Qo=a(Cc,"A",{id:!0,class:!0,href:!0});var p1=i(Qo);mi=a(p1,"SPAN",{});var g1=i(mi);v(On.$$.fragment,g1),g1.forEach(t),p1.forEach(t),Jm=d(Cc),fi=a(Cc,"SPAN",{});var u1=i(fi);Xm=s(u1,"LongformerTokenizerFast"),u1.forEach(t),Cc.forEach(t),Nd=d(o),pt=a(o,"DIV",{class:!0});var Ea=i(pt);v(An.$$.fragment,Ea),Ym=d(Ea),In=a(Ea,"P",{});var Pc=i(In);Zm=s(Pc,"Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),pi=a(Pc,"EM",{});var _1=i(pi);ef=s(_1,"tokenizers"),_1.forEach(t),tf=s(Pc," library)."),Pc.forEach(t),of=d(Ea),Ho=a(Ea,"P",{});var nd=i(Ho);Gr=a(nd,"A",{href:!0});var w1=i(Gr);nf=s(w1,"LongformerTokenizerFast"),w1.forEach(t),sf=s(nd," is identical to "),Kr=a(nd,"A",{href:!0});var k1=i(Kr);rf=s(k1,"RobertaTokenizerFast"),k1.forEach(t),af=s(nd,`. Refer to the superclass for usage examples
and documentation concerning parameters.`),nd.forEach(t),Ea.forEach(t),Sd=d(o),Qt=a(o,"H2",{class:!0});var jc=i(Qt);Ro=a(jc,"A",{id:!0,class:!0,href:!0});var v1=i(Ro);gi=a(v1,"SPAN",{});var b1=i(gi);v(Nn.$$.fragment,b1),b1.forEach(t),v1.forEach(t),lf=d(jc),ui=a(jc,"SPAN",{});var T1=i(ui);df=s(T1,"Longformer specific outputs"),T1.forEach(t),jc.forEach(t),Dd=d(o),Ht=a(o,"DIV",{class:!0});var Oc=i(Ht);v(Sn.$$.fragment,Oc),cf=d(Oc),_i=a(Oc,"P",{});var y1=i(_i);hf=s(y1,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),y1.forEach(t),Oc.forEach(t),Bd=d(o),Rt=a(o,"DIV",{class:!0});var Ac=i(Rt);v(Dn.$$.fragment,Ac),mf=d(Ac),wi=a(Ac,"P",{});var L1=i(wi);ff=s(L1,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),L1.forEach(t),Ac.forEach(t),Wd=d(o),Ut=a(o,"DIV",{class:!0});var Ic=i(Ut);v(Bn.$$.fragment,Ic),pf=d(Ic),ki=a(Ic,"P",{});var $1=i(ki);gf=s($1,"Base class for masked language models outputs."),$1.forEach(t),Ic.forEach(t),Qd=d(o),Vt=a(o,"DIV",{class:!0});var Nc=i(Vt);v(Wn.$$.fragment,Nc),uf=d(Nc),vi=a(Nc,"P",{});var F1=i(vi);_f=s(F1,"Base class for outputs of question answering Longformer models."),F1.forEach(t),Nc.forEach(t),Hd=d(o),Gt=a(o,"DIV",{class:!0});var Sc=i(Gt);v(Qn.$$.fragment,Sc),wf=d(Sc),bi=a(Sc,"P",{});var x1=i(bi);kf=s(x1,"Base class for outputs of sentence classification models."),x1.forEach(t),Sc.forEach(t),Rd=d(o),Kt=a(o,"DIV",{class:!0});var Dc=i(Kt);v(Hn.$$.fragment,Dc),vf=d(Dc),Ti=a(Dc,"P",{});var M1=i(Ti);bf=s(M1,"Base class for outputs of multiple choice Longformer models."),M1.forEach(t),Dc.forEach(t),Ud=d(o),Jt=a(o,"DIV",{class:!0});var Bc=i(Jt);v(Rn.$$.fragment,Bc),Tf=d(Bc),yi=a(Bc,"P",{});var E1=i(yi);yf=s(E1,"Base class for outputs of token classification models."),E1.forEach(t),Bc.forEach(t),Vd=d(o),Xt=a(o,"DIV",{class:!0});var Wc=i(Xt);v(Un.$$.fragment,Wc),Lf=d(Wc),Li=a(Wc,"P",{});var z1=i(Li);$f=s(z1,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),z1.forEach(t),Wc.forEach(t),Gd=d(o),Yt=a(o,"DIV",{class:!0});var Qc=i(Yt);v(Vn.$$.fragment,Qc),Ff=d(Qc),$i=a(Qc,"P",{});var q1=i($i);xf=s(q1,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),q1.forEach(t),Qc.forEach(t),Kd=d(o),Zt=a(o,"DIV",{class:!0});var Hc=i(Zt);v(Gn.$$.fragment,Hc),Mf=d(Hc),Fi=a(Hc,"P",{});var C1=i(Fi);Ef=s(C1,"Base class for masked language models outputs."),C1.forEach(t),Hc.forEach(t),Jd=d(o),eo=a(o,"DIV",{class:!0});var Rc=i(eo);v(Kn.$$.fragment,Rc),zf=d(Rc),xi=a(Rc,"P",{});var P1=i(xi);qf=s(P1,"Base class for outputs of question answering Longformer models."),P1.forEach(t),Rc.forEach(t),Xd=d(o),to=a(o,"DIV",{class:!0});var Uc=i(to);v(Jn.$$.fragment,Uc),Cf=d(Uc),Mi=a(Uc,"P",{});var j1=i(Mi);Pf=s(j1,"Base class for outputs of sentence classification models."),j1.forEach(t),Uc.forEach(t),Yd=d(o),oo=a(o,"DIV",{class:!0});var Vc=i(oo);v(Xn.$$.fragment,Vc),jf=d(Vc),Ei=a(Vc,"P",{});var O1=i(Ei);Of=s(O1,"Base class for outputs of multiple choice models."),O1.forEach(t),Vc.forEach(t),Zd=d(o),no=a(o,"DIV",{class:!0});var Gc=i(no);v(Yn.$$.fragment,Gc),Af=d(Gc),zi=a(Gc,"P",{});var A1=i(zi);If=s(A1,"Base class for outputs of token classification models."),A1.forEach(t),Gc.forEach(t),ec=d(o),so=a(o,"H2",{class:!0});var Kc=i(so);Uo=a(Kc,"A",{id:!0,class:!0,href:!0});var I1=i(Uo);qi=a(I1,"SPAN",{});var N1=i(qi);v(Zn.$$.fragment,N1),N1.forEach(t),I1.forEach(t),Nf=d(Kc),Ci=a(Kc,"SPAN",{});var S1=i(Ci);Sf=s(S1,"LongformerModel"),S1.forEach(t),Kc.forEach(t),tc=d(o),qe=a(o,"DIV",{class:!0});var st=i(qe);v(es.$$.fragment,st),Df=d(st),Pi=a(st,"P",{});var D1=i(Pi);Bf=s(D1,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),D1.forEach(t),Wf=d(st),ts=a(st,"P",{});var Jc=i(ts);Qf=s(Jc,"This model inherits from "),Jr=a(Jc,"A",{href:!0});var B1=i(Jr);Hf=s(B1,"PreTrainedModel"),B1.forEach(t),Rf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),Uf=d(st),os=a(st,"P",{});var Xc=i(os);Vf=s(Xc,"This model is also a PyTorch "),ns=a(Xc,"A",{href:!0,rel:!0});var W1=i(ns);Gf=s(W1,"torch.nn.Module"),W1.forEach(t),Kf=s(Xc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xc.forEach(t),Jf=d(st),ro=a(st,"P",{});var za=i(ro);Xf=s(za,"This class copied code from "),Xr=a(za,"A",{href:!0});var Q1=i(Xr);Yf=s(Q1,"RobertaModel"),Q1.forEach(t),Zf=s(za,` and overwrote standard self-attention with longformer self-attention
to provide the ability to process long sequences following the self-attention approach described in `),ss=a(za,"A",{href:!0,rel:!0});var H1=i(ss);ep=s(H1,`Longformer:
the Long-Document Transformer`),H1.forEach(t),tp=s(za,` by Iz Beltagy, Matthew E. Peters, and Arman Cohan.
Longformer self-attention combines a local (sliding window) and global attention to extend to long documents
without the O(n^2) increase in memory and compute.`),za.forEach(t),op=d(st),rs=a(st,"P",{});var Yc=i(rs);np=s(Yc,"The self-attention module "),ji=a(Yc,"CODE",{});var R1=i(ji);sp=s(R1,"LongformerSelfAttention"),R1.forEach(t),rp=s(Yc,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Yc.forEach(t),ap=d(st),Ge=a(st,"DIV",{class:!0});var kt=i(Ge);v(as.$$.fragment,kt),ip=d(kt),ao=a(kt,"P",{});var qa=i(ao);lp=s(qa,"The "),Yr=a(qa,"A",{href:!0});var U1=i(Yr);dp=s(U1,"LongformerModel"),U1.forEach(t),cp=s(qa," forward method, overrides the "),Oi=a(qa,"CODE",{});var V1=i(Oi);hp=s(V1,"__call__"),V1.forEach(t),mp=s(qa," special method."),qa.forEach(t),fp=d(kt),v(Vo.$$.fragment,kt),pp=d(kt),Ai=a(kt,"P",{});var G1=i(Ai);gp=s(G1,"Examples:"),G1.forEach(t),up=d(kt),v(is.$$.fragment,kt),kt.forEach(t),st.forEach(t),oc=d(o),io=a(o,"H2",{class:!0});var Zc=i(io);Go=a(Zc,"A",{id:!0,class:!0,href:!0});var K1=i(Go);Ii=a(K1,"SPAN",{});var J1=i(Ii);v(ls.$$.fragment,J1),J1.forEach(t),K1.forEach(t),_p=d(Zc),Ni=a(Zc,"SPAN",{});var X1=i(Ni);wp=s(X1,"LongformerForMaskedLM"),X1.forEach(t),Zc.forEach(t),nc=d(o),We=a(o,"DIV",{class:!0});var vt=i(We);v(ds.$$.fragment,vt),kp=d(vt),cs=a(vt,"P",{});var eh=i(cs);vp=s(eh,"Longformer Model with a "),Si=a(eh,"CODE",{});var Y1=i(Si);bp=s(Y1,"language modeling"),Y1.forEach(t),Tp=s(eh," head on top."),eh.forEach(t),yp=d(vt),hs=a(vt,"P",{});var th=i(hs);Lp=s(th,"This model inherits from "),Zr=a(th,"A",{href:!0});var Z1=i(Zr);$p=s(Z1,"PreTrainedModel"),Z1.forEach(t),Fp=s(th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),th.forEach(t),xp=d(vt),ms=a(vt,"P",{});var oh=i(ms);Mp=s(oh,"This model is also a PyTorch "),fs=a(oh,"A",{href:!0,rel:!0});var ev=i(fs);Ep=s(ev,"torch.nn.Module"),ev.forEach(t),zp=s(oh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oh.forEach(t),qp=d(vt),Ke=a(vt,"DIV",{class:!0});var bt=i(Ke);v(ps.$$.fragment,bt),Cp=d(bt),lo=a(bt,"P",{});var Ca=i(lo);Pp=s(Ca,"The "),ea=a(Ca,"A",{href:!0});var tv=i(ea);jp=s(tv,"LongformerForMaskedLM"),tv.forEach(t),Op=s(Ca," forward method, overrides the "),Di=a(Ca,"CODE",{});var ov=i(Di);Ap=s(ov,"__call__"),ov.forEach(t),Ip=s(Ca," special method."),Ca.forEach(t),Np=d(bt),v(Ko.$$.fragment,bt),Sp=d(bt),Bi=a(bt,"P",{});var nv=i(Bi);Dp=s(nv,"Examples:"),nv.forEach(t),Bp=d(bt),v(gs.$$.fragment,bt),bt.forEach(t),vt.forEach(t),sc=d(o),co=a(o,"H2",{class:!0});var nh=i(co);Jo=a(nh,"A",{id:!0,class:!0,href:!0});var sv=i(Jo);Wi=a(sv,"SPAN",{});var rv=i(Wi);v(us.$$.fragment,rv),rv.forEach(t),sv.forEach(t),Wp=d(nh),Qi=a(nh,"SPAN",{});var av=i(Qi);Qp=s(av,"LongformerForSequenceClassification"),av.forEach(t),nh.forEach(t),rc=d(o),Qe=a(o,"DIV",{class:!0});var Tt=i(Qe);v(_s.$$.fragment,Tt),Hp=d(Tt),Hi=a(Tt,"P",{});var iv=i(Hi);Rp=s(iv,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),iv.forEach(t),Up=d(Tt),ws=a(Tt,"P",{});var sh=i(ws);Vp=s(sh,"This model inherits from "),ta=a(sh,"A",{href:!0});var lv=i(ta);Gp=s(lv,"PreTrainedModel"),lv.forEach(t),Kp=s(sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sh.forEach(t),Jp=d(Tt),ks=a(Tt,"P",{});var rh=i(ks);Xp=s(rh,"This model is also a PyTorch "),vs=a(rh,"A",{href:!0,rel:!0});var dv=i(vs);Yp=s(dv,"torch.nn.Module"),dv.forEach(t),Zp=s(rh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rh.forEach(t),eg=d(Tt),Ce=a(Tt,"DIV",{class:!0});var rt=i(Ce);v(bs.$$.fragment,rt),tg=d(rt),ho=a(rt,"P",{});var Pa=i(ho);og=s(Pa,"The "),oa=a(Pa,"A",{href:!0});var cv=i(oa);ng=s(cv,"LongformerForSequenceClassification"),cv.forEach(t),sg=s(Pa," forward method, overrides the "),Ri=a(Pa,"CODE",{});var hv=i(Ri);rg=s(hv,"__call__"),hv.forEach(t),ag=s(Pa," special method."),Pa.forEach(t),ig=d(rt),v(Xo.$$.fragment,rt),lg=d(rt),Ui=a(rt,"P",{});var mv=i(Ui);dg=s(mv,"Example of single-label classification:"),mv.forEach(t),cg=d(rt),v(Ts.$$.fragment,rt),hg=d(rt),Vi=a(rt,"P",{});var fv=i(Vi);mg=s(fv,"Example of multi-label classification:"),fv.forEach(t),fg=d(rt),v(ys.$$.fragment,rt),rt.forEach(t),Tt.forEach(t),ac=d(o),mo=a(o,"H2",{class:!0});var ah=i(mo);Yo=a(ah,"A",{id:!0,class:!0,href:!0});var pv=i(Yo);Gi=a(pv,"SPAN",{});var gv=i(Gi);v(Ls.$$.fragment,gv),gv.forEach(t),pv.forEach(t),pg=d(ah),Ki=a(ah,"SPAN",{});var uv=i(Ki);gg=s(uv,"LongformerForMultipleChoice"),uv.forEach(t),ah.forEach(t),ic=d(o),He=a(o,"DIV",{class:!0});var yt=i(He);v($s.$$.fragment,yt),ug=d(yt),Ji=a(yt,"P",{});var _v=i(Ji);_g=s(_v,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),_v.forEach(t),wg=d(yt),Fs=a(yt,"P",{});var ih=i(Fs);kg=s(ih,"This model inherits from "),na=a(ih,"A",{href:!0});var wv=i(na);vg=s(wv,"PreTrainedModel"),wv.forEach(t),bg=s(ih,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ih.forEach(t),Tg=d(yt),xs=a(yt,"P",{});var lh=i(xs);yg=s(lh,"This model is also a PyTorch "),Ms=a(lh,"A",{href:!0,rel:!0});var kv=i(Ms);Lg=s(kv,"torch.nn.Module"),kv.forEach(t),$g=s(lh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lh.forEach(t),Fg=d(yt),Je=a(yt,"DIV",{class:!0});var Lt=i(Je);v(Es.$$.fragment,Lt),xg=d(Lt),fo=a(Lt,"P",{});var ja=i(fo);Mg=s(ja,"The "),sa=a(ja,"A",{href:!0});var vv=i(sa);Eg=s(vv,"LongformerForMultipleChoice"),vv.forEach(t),zg=s(ja," forward method, overrides the "),Xi=a(ja,"CODE",{});var bv=i(Xi);qg=s(bv,"__call__"),bv.forEach(t),Cg=s(ja," special method."),ja.forEach(t),Pg=d(Lt),v(Zo.$$.fragment,Lt),jg=d(Lt),Yi=a(Lt,"P",{});var Tv=i(Yi);Og=s(Tv,"Example:"),Tv.forEach(t),Ag=d(Lt),v(zs.$$.fragment,Lt),Lt.forEach(t),yt.forEach(t),lc=d(o),po=a(o,"H2",{class:!0});var dh=i(po);en=a(dh,"A",{id:!0,class:!0,href:!0});var yv=i(en);Zi=a(yv,"SPAN",{});var Lv=i(Zi);v(qs.$$.fragment,Lv),Lv.forEach(t),yv.forEach(t),Ig=d(dh),el=a(dh,"SPAN",{});var $v=i(el);Ng=s($v,"LongformerForTokenClassification"),$v.forEach(t),dh.forEach(t),dc=d(o),Re=a(o,"DIV",{class:!0});var $t=i(Re);v(Cs.$$.fragment,$t),Sg=d($t),tl=a($t,"P",{});var Fv=i(tl);Dg=s(Fv,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Fv.forEach(t),Bg=d($t),Ps=a($t,"P",{});var ch=i(Ps);Wg=s(ch,"This model inherits from "),ra=a(ch,"A",{href:!0});var xv=i(ra);Qg=s(xv,"PreTrainedModel"),xv.forEach(t),Hg=s(ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ch.forEach(t),Rg=d($t),js=a($t,"P",{});var hh=i(js);Ug=s(hh,"This model is also a PyTorch "),Os=a(hh,"A",{href:!0,rel:!0});var Mv=i(Os);Vg=s(Mv,"torch.nn.Module"),Mv.forEach(t),Gg=s(hh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hh.forEach(t),Kg=d($t),Xe=a($t,"DIV",{class:!0});var Ft=i(Xe);v(As.$$.fragment,Ft),Jg=d(Ft),go=a(Ft,"P",{});var Oa=i(go);Xg=s(Oa,"The "),aa=a(Oa,"A",{href:!0});var Ev=i(aa);Yg=s(Ev,"LongformerForTokenClassification"),Ev.forEach(t),Zg=s(Oa," forward method, overrides the "),ol=a(Oa,"CODE",{});var zv=i(ol);eu=s(zv,"__call__"),zv.forEach(t),tu=s(Oa," special method."),Oa.forEach(t),ou=d(Ft),v(tn.$$.fragment,Ft),nu=d(Ft),nl=a(Ft,"P",{});var qv=i(nl);su=s(qv,"Example:"),qv.forEach(t),ru=d(Ft),v(Is.$$.fragment,Ft),Ft.forEach(t),$t.forEach(t),cc=d(o),uo=a(o,"H2",{class:!0});var mh=i(uo);on=a(mh,"A",{id:!0,class:!0,href:!0});var Cv=i(on);sl=a(Cv,"SPAN",{});var Pv=i(sl);v(Ns.$$.fragment,Pv),Pv.forEach(t),Cv.forEach(t),au=d(mh),rl=a(mh,"SPAN",{});var jv=i(rl);iu=s(jv,"LongformerForQuestionAnswering"),jv.forEach(t),mh.forEach(t),hc=d(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);v(Ss.$$.fragment,xt),lu=d(xt),_o=a(xt,"P",{});var Aa=i(_o);du=s(Aa,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layers on top of the hidden-states output to compute `),al=a(Aa,"CODE",{});var Ov=i(al);cu=s(Ov,"span start logits"),Ov.forEach(t),hu=s(Aa," and "),il=a(Aa,"CODE",{});var Av=i(il);mu=s(Av,"span end logits"),Av.forEach(t),fu=s(Aa,")."),Aa.forEach(t),pu=d(xt),Ds=a(xt,"P",{});var fh=i(Ds);gu=s(fh,"This model inherits from "),ia=a(fh,"A",{href:!0});var Iv=i(ia);uu=s(Iv,"PreTrainedModel"),Iv.forEach(t),_u=s(fh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fh.forEach(t),wu=d(xt),Bs=a(xt,"P",{});var ph=i(Bs);ku=s(ph,"This model is also a PyTorch "),Ws=a(ph,"A",{href:!0,rel:!0});var Nv=i(Ws);vu=s(Nv,"torch.nn.Module"),Nv.forEach(t),bu=s(ph,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ph.forEach(t),Tu=d(xt),Ye=a(xt,"DIV",{class:!0});var Mt=i(Ye);v(Qs.$$.fragment,Mt),yu=d(Mt),wo=a(Mt,"P",{});var Ia=i(wo);Lu=s(Ia,"The "),la=a(Ia,"A",{href:!0});var Sv=i(la);$u=s(Sv,"LongformerForQuestionAnswering"),Sv.forEach(t),Fu=s(Ia," forward method, overrides the "),ll=a(Ia,"CODE",{});var Dv=i(ll);xu=s(Dv,"__call__"),Dv.forEach(t),Mu=s(Ia," special method."),Ia.forEach(t),Eu=d(Mt),v(nn.$$.fragment,Mt),zu=d(Mt),dl=a(Mt,"P",{});var Bv=i(dl);qu=s(Bv,"Examples:"),Bv.forEach(t),Cu=d(Mt),v(Hs.$$.fragment,Mt),Mt.forEach(t),xt.forEach(t),mc=d(o),ko=a(o,"H2",{class:!0});var gh=i(ko);sn=a(gh,"A",{id:!0,class:!0,href:!0});var Wv=i(sn);cl=a(Wv,"SPAN",{});var Qv=i(cl);v(Rs.$$.fragment,Qv),Qv.forEach(t),Wv.forEach(t),Pu=d(gh),hl=a(gh,"SPAN",{});var Hv=i(hl);ju=s(Hv,"TFLongformerModel"),Hv.forEach(t),gh.forEach(t),fc=d(o),Ee=a(o,"DIV",{class:!0});var Be=i(Ee);v(Us.$$.fragment,Be),Ou=d(Be),ml=a(Be,"P",{});var Rv=i(ml);Au=s(Rv,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Rv.forEach(t),Iu=d(Be),Vs=a(Be,"P",{});var uh=i(Vs);Nu=s(uh,"This model inherits from "),da=a(uh,"A",{href:!0});var Uv=i(da);Su=s(Uv,"TFPreTrainedModel"),Uv.forEach(t),Du=s(uh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uh.forEach(t),Bu=d(Be),Gs=a(Be,"P",{});var _h=i(Gs);Wu=s(_h,"This model is also a "),Ks=a(_h,"A",{href:!0,rel:!0});var Vv=i(Ks);Qu=s(Vv,"tf.keras.Model"),Vv.forEach(t),Hu=s(_h,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_h.forEach(t),Ru=d(Be),v(rn.$$.fragment,Be),Uu=d(Be),vo=a(Be,"P",{});var Na=i(vo);Vu=s(Na,"This class copies code from "),ca=a(Na,"A",{href:!0});var Gv=i(ca);Gu=s(Gv,"TFRobertaModel"),Gv.forEach(t),Ku=s(Na,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
`),Js=a(Na,"A",{href:!0,rel:!0});var Kv=i(Js);Ju=s(Kv,"Longformer: the Long-Document Transformer"),Kv.forEach(t),Xu=s(Na,` by Iz Beltagy, Matthew E. Peters, and
Arman Cohan. Longformer self-attention combines a local (sliding window) and global attention to extend to long
documents without the O(n^2) increase in memory and compute.`),Na.forEach(t),Yu=d(Be),Xs=a(Be,"P",{});var wh=i(Xs);Zu=s(wh,"The self-attention module "),fl=a(wh,"CODE",{});var Jv=i(fl);e_=s(Jv,"TFLongformerSelfAttention"),Jv.forEach(t),t_=s(wh,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),wh.forEach(t),o_=d(Be),_t=a(Be,"DIV",{class:!0});var Sa=i(_t);v(Ys.$$.fragment,Sa),n_=d(Sa),bo=a(Sa,"P",{});var Da=i(bo);s_=s(Da,"The "),ha=a(Da,"A",{href:!0});var Xv=i(ha);r_=s(Xv,"TFLongformerModel"),Xv.forEach(t),a_=s(Da," forward method, overrides the "),pl=a(Da,"CODE",{});var Yv=i(pl);i_=s(Yv,"__call__"),Yv.forEach(t),l_=s(Da," special method."),Da.forEach(t),d_=d(Sa),v(an.$$.fragment,Sa),Sa.forEach(t),Be.forEach(t),pc=d(o),To=a(o,"H2",{class:!0});var kh=i(To);ln=a(kh,"A",{id:!0,class:!0,href:!0});var Zv=i(ln);gl=a(Zv,"SPAN",{});var eb=i(gl);v(Zs.$$.fragment,eb),eb.forEach(t),Zv.forEach(t),c_=d(kh),ul=a(kh,"SPAN",{});var tb=i(ul);h_=s(tb,"TFLongformerForMaskedLM"),tb.forEach(t),kh.forEach(t),gc=d(o),Ae=a(o,"DIV",{class:!0});var lt=i(Ae);v(er.$$.fragment,lt),m_=d(lt),tr=a(lt,"P",{});var vh=i(tr);f_=s(vh,"Longformer Model with a "),_l=a(vh,"CODE",{});var ob=i(_l);p_=s(ob,"language modeling"),ob.forEach(t),g_=s(vh," head on top."),vh.forEach(t),u_=d(lt),or=a(lt,"P",{});var bh=i(or);__=s(bh,"This model inherits from "),ma=a(bh,"A",{href:!0});var nb=i(ma);w_=s(nb,"TFPreTrainedModel"),nb.forEach(t),k_=s(bh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
