...
`}}),As=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.RobertaTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/roberta/tokenization_roberta.py#L365",parametersDescription:[{anchor:"transformers.RobertaTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),or=new ye({}),nr=new j({props:{name:"class transformers.RobertaForCausalLM",anchor:"transformers.RobertaForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/roberta/modeling_roberta.py#L882",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lr=new j({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/roberta/modeling_roberta.py#L908",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),br=new ye({}),kr=new j({props:{name:"class transformers.RobertaForSequenceClassification",anchor:"transformers.RobertaForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/roberta/modeling_roberta.py#L1163",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wr=new j({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/roberta/modeling_roberta.py#L1177",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),Rr=new ye({}),Mr=new j({props:{name:"class transformers.RobertaForMultipleChoice",anchor:"transformers.RobertaForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/roberta/modeling_roberta.py#L1261",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16111/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16111/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qr=new j({props:{name:"forward",anchor:"transformers.RobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16111/src/transformers/models/roberta/modeling_roberta.py#L1274",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16111/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16111/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nb=l(),Se=n("div"),T(wr.$$.fragment),Ib=l(),Po=n("p"),Db=a("The "),vl=n("a"),Sb=a("RobertaForSequenceClassification"),Wb=a(" forward method, overrides the "),hc=n("code"),Bb=a("__call__"),Ub=a(" special method."),Hb=l(),T(Pn.$$.fragment),Qb=l(),uc=n("p"),Vb=a("Example of single-label classification:"),Jb=l(),T($r.$$.fragment),Kb=l(),fc=n("p"),Gb=a("Example of multi-label classification:"),Xb=l(),T(Fr.$$.fragment),iu=l(),jo=n("h2"),jn=n("a"),mc=n("span"),T(Rr.$$.fragment),Yb=l(),gc=n("span"),Zb=a("RobertaForMultipleChoice"),lu=l(),tt=n("div"),T(Mr.$$.fragment),e1=l(),_c=n("p"),t1=a(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),o1=l(),Er=n("p"),n1=a("This model inherits from "),wl=n("a"),s1=a("PreTrainedModel"),r1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),a1=l(),zr=n("p"),i1=a("This model is also a PyTorch "),xr=n("a"),l1=a("torch.nn.Module"),d1=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),c1=l(),it=n("div"),T(qr.$$.fragment),p1=l(),Lo=n("p"),h1=a("The "),$l=n("a"),u1=a("RobertaForMultipleChoice"),f1=a(" forward method, overrides the "),bc=n("code"),m1=a("__call__"),g1=a(" special method."),_1=l(),T(Ln.$$.fragment),b1=l(),kc=n("p"),k1=a("Example:"),T1=l(),T(Cr.$$.fragment),du=l(),Ao=n("h2"),An=n("a"),Tc=n("span"),T(Pr.$$.fragment),y1=l(),yc=n("span"),v1=a("RobertaForTokenClassification"),cu=l(),ot=n("div"),T(jr.$$.fragment),w1=l(),vc=n("p"),$1=a(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),F1=l(),Lr=n("p"),R1=a("This model inherits from "),Fl=n("a"),M1=a("PreTrainedModel"),E1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),z1=l(),Ar=n("p"),x1=a("This model is also a PyTorch "),Or=n("a"),q1=a("torch.nn.Module"),C1=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),P1=l(),lt=n("div"),T(Nr.$$.fragment),j1=l(),Oo=n("p"),L1=a("The "),Rl=n("a"),A1=a("RobertaForTokenClassification"),O1=a(" forward method, overrides the "),wc=n("code"),N1=a("__call__"),I1=a(" special method."),D1=l(),T(On.$$.fragment),S1=l(),$c=n("p"),W1=a("Example:"),B1=l(),T(Ir.$$.fragment),pu=l(),No=n("h2"),Nn=n("a"),Fc=n("span"),T(Dr.$$.fragment),U1=l(),Rc=n("span"),H1=a("RobertaForQuestionAnswering"),hu=l(),nt=n("div"),T(Sr.$$.fragment),Q1=l(),Io=n("p"),V1=a(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mc=n("code"),J1=a("span start logits"),K1=a(" and "),Ec=n("code"),G1=a("span end logits"),X1=a(")."),Y1=l(),Wr=n("p"),Z1=a("This model inherits from "),Ml=n("a"),ek=a("PreTrainedModel"),tk=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ok=l(),Br=n("p"),nk=a("This model is also a PyTorch "),Ur=n("a"),sk=a("torch.nn.Module"),rk=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ak=l(),dt=n("div"),T(Hr.$$.fragment),ik=l(),Do=n("p"),lk=a("The "),El=n("a"),dk=a("RobertaForQuestionAnswering"),ck=a(" forward method, overrides the "),zc=n("code"),pk=a("__call__"),hk=a(" special method."),uk=l(),T(In.$$.fragment),fk=l(),xc=n("p"),mk=a("Example:"),gk=l(),T(Qr.$$.fragment),uu=l(),So=n("h2"),Dn=n("a"),qc=n("span"),T(Vr.$$.fragment),_k=l(),Cc=n("span"),bk=a("TFRobertaModel"),fu=l(),Ue=n("div"),T(Jr.$$.fragment),kk=l(),Pc=n("p"),Tk=a("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),yk=l(),Kr=n("p"),vk=a("This model inherits from "),zl=n("a"),wk=a("TFPreTrainedModel"),$k=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fk=l(),Gr=n("p"),Rk=a("This model is also a "),Xr=n("a"),Mk=a("tf.keras.Model"),Ek=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zk=l(),T(Sn.$$.fragment),xk=l(),ct=n("div"),T(Yr.$$.fragment),qk=l(),Wo=n("p"),Ck=a("The "),xl=n("a"),Pk=a("TFRobertaModel"),jk=a(" forward method, overrides the "),jc=n("code"),Lk=a("__call__"),Ak=a(" special method."),Ok=l(),T(Wn.$$.fragment),Nk=l(),Lc=n("p"),Ik=a("Example:"),Dk=l(),T(Zr.$$.fragment),mu=l(),Bo=n("h2"),Bn=n("a"),Ac=n("span"),T(ea.$$.fragment),Sk=l(),Oc=n("span"),Wk=a("TFRobertaForCausalLM"),gu=l(),Uo=n("div"),T(ta.$$.fragment),Bk=l(),pt=n("div"),T(oa.$$.fragment),Uk=l(),Ho=n("p"),Hk=a("The "),ql=n("a"),Qk=a("TFRobertaForCausalLM"),Vk=a(" forward method, overrides the "),Nc=n("code"),Jk=a("__call__"),Kk=a(" special method."),Gk=l(),T(Un.$$.fragment),Xk=l(),Ic=n("p"),Yk=a("Example:"),Zk=l(),T(na.$$.fragment),_u=l(),Qo=n("h2"),Hn=n("a"),Dc=n("span"),T(sa.$$.fragment),eT=l(),Sc=n("span"),tT=a("TFRobertaForMaskedLM"),bu=l(),He=n("div"),T(ra.$$.fragment),oT=l(),aa=n("p"),nT=a("RoBERTa Model with a "),Wc=n("code"),sT=a("language modeling"),rT=a(" head on top."),aT=l(),ia=n("p"),iT=a("This model inherits from "),Cl=n("a"),lT=a("TFPreTrainedModel"),dT=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uf.forEach(t),Nb=d(Zt),Se=s(Zt,"DIV",{class:!0});var $t=r(Se);y(wr.$$.fragment,$t),Ib=d($t),Po=s($t,"P",{});var od=r(Po);Db=i(od,"The "),vl=s(od,"A",{href:!0});var M0=r(vl);Sb=i(M0,"RobertaForSequenceClassification"),M0.forEach(t),Wb=i(od," forward method, overrides the "),hc=s(od,"CODE",{});var E0=r(hc);Bb=i(E0,"__call__"),E0.forEach(t),Ub=i(od," special method."),od.forEach(t),Hb=d($t),y(Pn.$$.fragment,$t),Qb=d($t),uc=s($t,"P",{});var z0=r(uc);Vb=i(z0,"Example of single-label classification:"),z0.forEach(t),Jb=d($t),y($r.$$.fragment,$t),Kb=d($t),fc=s($t,"P",{});var x0=r(fc);Gb=i(x0,"Example of multi-label classification:"),x0.forEach(t),Xb=d($t),y(Fr.$$.fragment,$t),$t.forEach(t),Zt.forEach(t),iu=d(o),jo=s(o,"H2",{class:!0});var ff=r(jo);jn=s(ff,"A",{id:!0,class:!0,href:!0});var q0=r(jn);mc=s(q0,"SPAN",{});var C0=r(mc);y(Rr.$$.fragment,C0),C0.forEach(t),q0.forEach(t),Yb=d(ff),gc=s(ff,"SPAN",{});var P0=r(gc);Zb=i(P0,"RobertaForMultipleChoice"),P0.forEach(t),ff.forEach(t),lu=d(o),tt=s(o,"DIV",{class:!0});var eo=r(tt);y(Mr.$$.fragment,eo),e1=d(eo),_c=s(eo,"P",{});var j0=r(_c);t1=i(j0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),j0.forEach(t),o1=d(eo),Er=s(eo,"P",{});var mf=r(Er);n1=i(mf,"This model inherits from "),wl=s(mf,"A",{href:!0});var L0=r(wl);s1=i(L0,"PreTrainedModel"),L0.forEach(t),r1=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mf.forEach(t),a1=d(eo),zr=s(eo,"P",{});var gf=r(zr);i1=i(gf,"This model is also a PyTorch "),xr=s(gf,"A",{href:!0,rel:!0});var A0=r(xr);l1=i(A0,"torch.nn.Module"),A0.forEach(t),d1=i(gf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gf.forEach(t),c1=d(eo),it=s(eo,"DIV",{class:!0});var to=r(it);y(qr.$$.fragment,to),p1=d(to),Lo=s(to,"P",{});var nd=r(Lo);h1=i(nd,"The "),$l=s(nd,"A",{href:!0});var O0=r($l);u1=i(O0,"RobertaForMultipleChoice"),O0.forEach(t),f1=i(nd," forward method, overrides the "),bc=s(nd,"CODE",{});var N0=r(bc);m1=i(N0,"__call__"),N0.forEach(t),g1=i(nd," special method."),nd.forEach(t),_1=d(to),y(Ln.$$.fragment,to),b1=d(to),kc=s(to,"P",{});var I0=r(kc);k1=i(I0,"Example:"),I0.forEach(t),T1=d(to),y(Cr.$$.fragment,to),to.forEach(t),eo.forEach(t),du=d(o),Ao=s(o,"H2",{class:!0});var _f=r(Ao);An=s(_f,"A",{id:!0,class:!0,href:!0});var D0=r(An);Tc=s(D0,"SPAN",{});var S0=r(Tc);y(Pr.$$.fragment,S0),S0.forEach(t),D0.forEach(t),y1=d(_f),yc=s(_f,"SPAN",{});var W0=r(yc);v1=i(W0,"RobertaForTokenClassification"),W0.forEach(t),_f.forEach(t),cu=d(o),ot=s(o,"DIV",{class:!0});var oo=r(ot);y(jr.$$.fragment,oo),w1=d(oo),vc=s(oo,"P",{});var B0=r(vc);$1=i(B0,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),B0.forEach(t),F1=d(oo),Lr=s(oo,"P",{});var bf=r(Lr);R1=i(bf,"This model inherits from "),Fl=s(bf,"A",{href:!0});var U0=r(Fl);M1=i(U0,"PreTrainedModel"),U0.forEach(t),E1=i(bf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bf.forEach(t),z1=d(oo),Ar=s(oo,"P",{});var kf=r(Ar);x1=i(kf,"This model is also a PyTorch "),Or=s(kf,"A",{href:!0,rel:!0});var H0=r(Or);q1=i(H0,"torch.nn.Module"),H0.forEach(t),C1=i(kf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kf.forEach(t),P1=d(oo),lt=s(oo,"DIV",{class:!0});var no=r(lt);y(Nr.$$.fragment,no),j1=d(no),Oo=s(no,"P",{});var sd=r(Oo);L1=i(sd,"The "),Rl=s(sd,"A",{href:!0});var Q0=r(Rl);A1=i(Q0,"RobertaForTokenClassification"),Q0.forEach(t),O1=i(sd," forward method, overrides the "),wc=s(sd,"CODE",{});var V0=r(wc);N1=i(V0,"__call__"),V0.forEach(t),I1=i(sd," special method."),sd.forEach(t),D1=d(no),y(On.$$.fragment,no),S1=d(no),$c=s(no,"P",{});var J0=r($c);W1=i(J0,"Example:"),J0.forEach(t),B1=d(no),y(Ir.$$.fragment,no),no.forEach(t),oo.forEach(t),pu=d(o),No=s(o,"H2",{class:!0});var Tf=r(No);Nn=s(Tf,"A",{id:!0,class:!0,href:!0});var K0=r(Nn);Fc=s(K0,"SPAN",{});var G0=r(Fc);y(Dr.$$.fragment,G0),G0.forEach(t),K0.forEach(t),U1=d(Tf),Rc=s(Tf,"SPAN",{});var X0=r(Rc);H1=i(X0,"RobertaForQuestionAnswering"),X0.forEach(t),Tf.forEach(t),hu=d(o),nt=s(o,"DIV",{class:!0});var so=r(nt);y(Sr.$$.fragment,so),Q1=d(so),Io=s(so,"P",{});var rd=r(Io);V1=i(rd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mc=s(rd,"CODE",{});var Y0=r(Mc);J1=i(Y0,"span start logits"),Y0.forEach(t),K1=i(rd," and "),Ec=s(rd,"CODE",{});var Z0=r(Ec);G1=i(Z0,"span end logits"),Z0.forEach(t),X1=i(rd,")."),rd.forEach(t),Y1=d(so),Wr=s(so,"P",{});var yf=r(Wr);Z1=i(yf,"This model inherits from "),Ml=s(yf,"A",{href:!0});var eR=r(Ml);ek=i(eR,"PreTrainedModel"),eR.forEach(t),tk=i(yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yf.forEach(t),ok=d(so),Br=s(so,"P",{});var vf=r(Br);nk=i(vf,"This model is also a PyTorch "),Ur=s(vf,"A",{href:!0,rel:!0});var tR=r(Ur);sk=i(tR,"torch.nn.Module"),tR.forEach(t),rk=i(vf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vf.forEach(t),ak=d(so),dt=s(so,"DIV",{class:!0});var ro=r(dt);y(Hr.$$.fragment,ro),ik=d(ro),Do=s(ro,"P",{});var ad=r(Do);lk=i(ad,"The "),El=s(ad,"A",{href:!0});var oR=r(El);dk=i(oR,"RobertaForQuestionAnswering"),oR.forEach(t),ck=i(ad," forward method, overrides the "),zc=s(ad,"CODE",{});var nR=r(zc);pk=i(nR,"__call__"),nR.forEach(t),hk=i(ad," special method."),ad.forEach(t),uk=d(ro),y(In.$$.fragment,ro),fk=d(ro),xc=s(ro,"P",{});var sR=r(xc);mk=i(sR,"Example:"),sR.forEach(t),gk=d(ro),y(Qr.$$.fragment,ro),ro.forEach(t),so.forEach(t),uu=d(o),So=s(o,"H2",{class:!0});var wf=r(So);Dn=s(wf,"A",{id:!0,class:!0,href:!0});var rR=r(Dn);qc=s(rR,"SPAN",{});var aR=r(qc);y(Vr.$$.fragment,aR),aR.forEach(t),rR.forEach(t),_k=d(wf),Cc=s(wf,"SPAN",{});var iR=r(Cc);bk=i(iR,"TFRobertaModel"),iR.forEach(t),wf.forEach(t),fu=d(o),Ue=s(o,"DIV",{class:!0});var Ct=r(Ue);y(Jr.$$.fragment,Ct),kk=d(Ct),Pc=s(Ct,"P",{});var lR=r(Pc);Tk=i(lR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),lR.forEach(t),yk=d(Ct),Kr=s(Ct,"P",{});var $f=r(Kr);vk=i($f,"This model inherits from "),zl=s($f,"A",{href:!0});var dR=r(zl);wk=i(dR,"TFPreTrainedModel"),dR.forEach(t),$k=i($f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f.forEach(t),Fk=d(Ct),Gr=s(Ct,"P",{});var Ff=r(Gr);Rk=i(Ff,"This model is also a "),Xr=s(Ff,"A",{href:!0,rel:!0});var cR=r(Xr);Mk=i(cR,"tf.keras.Model"),cR.forEach(t),Ek=i(Ff,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ff.forEach(t),zk=d(Ct),y(Sn.$$.fragment,Ct),xk=d(Ct),ct=s(Ct,"DIV",{class:!0});var ao=r(ct);y(Yr.$$.fragment,ao),qk=d(ao),Wo=s(ao,"P",{});var id=r(Wo);Ck=i(id,"The "),xl=s(id,"A",{href:!0});var pR=r(xl);Pk=i(pR,"TFRobertaModel"),pR.forEach(t),jk=i(id," forward method, overrides the "),jc=s(id,"CODE",{});var hR=r(jc);Lk=i(hR,"__call__"),hR.forEach(t),Ak=i(id," special method."),id.forEach(t),Ok=d(ao),y(Wn.$$.fragment,ao),Nk=d(ao),Lc=s(ao,"P",{});var uR=r(Lc);Ik=i(uR,"Example:"),uR.forEach(t),Dk=d(ao),y(Zr.$$.fragment,ao),ao.forEach(t),Ct.forEach(t),mu=d(o),Bo=s(o,"H2",{class:!0});var Rf=r(Bo);Bn=s(Rf,"A",{id:!0,class:!0,href:!0});var fR=r(Bn);Ac=s(fR,"SPAN",{});var mR=r(Ac);y(ea.$$.fragment,mR),mR.forEach(t),fR.forEach(t),Sk=d(Rf),Oc=s(Rf,"SPAN",{});var gR=r(Oc);Wk=i(gR,"TFRobertaForCausalLM"),gR.forEach(t),Rf.forEach(t),gu=d(o),Uo=s(o,"DIV",{class:!0});var Mf=r(Uo);y(ta.$$.fragment,Mf),Bk=d(Mf),pt=s(Mf,"DIV",{class:!0});var io=r(pt);y(oa.$$.fragment,io),Uk=d(io),Ho=s(io,"P",{});var ld=r(Ho);Hk=i(ld,"The "),ql=s(ld,"A",{href:!0});var _R=r(ql);Qk=i(_R,"TFRobertaForCausalLM"),_R.forEach(t),Vk=i(ld," forward method, overrides the "),Nc=s(ld,"CODE",{});var bR=r(Nc);Jk=i(bR,"__call__"),bR.forEach(t),Kk=i(ld," special method."),ld.forEach(t),Gk=d(io),y(Un.$$.fragment,io),Xk=d(io),Ic=s(io,"P",{});var kR=r(Ic);Yk=i(kR,"Example:"),kR.forEach(t),Zk=d(io),y(na.$$.fragment,io),io.forEach(t),Mf.forEach(t),_u=d(o),Qo=s(o,"H2",{class:!0});var Ef=r(Qo);Hn=s(Ef,"A",{id:!0,class:!0,href:!0});var TR=r(Hn);Dc=s(TR,"SPAN",{});var yR=r(Dc);y(sa.$$.fragment,yR),yR.forEach(t),TR.forEach(t),eT=d(Ef),Sc=s(Ef,"SPAN",{});var vR=r(Sc);tT=i(vR,"TFRobertaForMaskedLM"),vR.forEach(t),Ef.forEach(t),bu=d(o),He=s(o,"DIV",{class:!0});var Pt=r(He);y(ra.$$.fragment,Pt),oT=d(Pt),aa=s(Pt,"P",{});var zf=r(aa);nT=i(zf,"RoBERTa Model with a "),Wc=s(zf,"CODE",{});var wR=r(Wc);sT=i(wR,"language modeling"),wR.forEach(t),rT=i(zf," head on top."),zf.forEach(t),aT=d(Pt),ia=s(Pt,"P",{});var xf=r(ia);iT=i(xf,"This model inherits from "),Cl=s(xf,"A",{href:!0});var $R=r(Cl);lT=i($R,"TFPreTrainedModel"),$R.forEach(t),dT=i(xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
