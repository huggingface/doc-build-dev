...
Whether or not to return a <a href="/docs/transformers/pr_16844/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_distilbert.py#L525",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16844/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16844/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16844/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16844/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16844/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16844/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jh.forEach(t),Vb=d(Mt),k(yo.$$.fragment,Mt),Kb=d(Mt),nt=n(Mt,"DIV",{class:!0});var Zt=r(nt);k(Or.$$.fragment,Zt),Jb=d(Zt),xs=n(Zt,"P",{});var fl=r(xs);Gb=i(fl,"The "),Vi=n(fl,"A",{href:!0});var e4=r(Vi);Xb=i(e4,"TFDistilBertForMultipleChoice"),e4.forEach(t),Yb=i(fl," forward method, overrides the "),zd=n(fl,"CODE",{});var t4=r(zd);Zb=i(t4,"__call__"),t4.forEach(t),ev=i(fl," special method."),fl.forEach(t),tv=d(Zt),k($o.$$.fragment,Zt),sv=d(Zt),jd=n(Zt,"P",{});var s4=r(jd);ov=i(s4,"Example:"),s4.forEach(t),nv=d(Zt),k(Nr.$$.fragment,Zt),Zt.forEach(t),Mt.forEach(t),Jp=d(s),zs=n(s,"H2",{class:!0});var Gh=r(zs);Fo=n(Gh,"A",{id:!0,class:!0,href:!0});var o4=r(Fo);Cd=n(o4,"SPAN",{});var n4=r(Cd);k(Lr.$$.fragment,n4),n4.forEach(t),o4.forEach(t),rv=d(Gh),qd=n(Gh,"SPAN",{});var r4=r(qd);av=i(r4,"TFDistilBertForTokenClassification"),r4.forEach(t),Gh.forEach(t),Gp=d(s),Le=n(s,"DIV",{class:!0});var Et=r(Le);k(Sr.$$.fragment,Et),iv=d(Et),Pd=n(Et,"P",{});var a4=r(Pd);lv=i(a4,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),a4.forEach(t),dv=d(Et),Ir=n(Et,"P",{});var Xh=r(Ir);cv=i(Xh,"This model inherits from "),Ki=n(Xh,"A",{href:!0});var i4=r(Ki);pv=i(i4,"TFPreTrainedModel"),i4.forEach(t),hv=i(Xh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xh.forEach(t),uv=d(Et),Wr=n(Et,"P",{});var Yh=r(Wr);mv=i(Yh,"This model is also a "),Rr=n(Yh,"A",{href:!0,rel:!0});var l4=r(Rr);fv=i(l4,"tf.keras.Model"),l4.forEach(t),gv=i(Yh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yh.forEach(t),_v=d(Et),k(Do.$$.fragment,Et),bv=d(Et),He=n(Et,"DIV",{class:!0});var xt=r(He);k(Ur.$$.fragment,xt),vv=d(xt),js=n(xt,"P",{});var gl=r(js);kv=i(gl,"The "),Ji=n(gl,"A",{href:!0});var d4=r(Ji);Tv=i(d4,"TFDistilBertForTokenClassification"),d4.forEach(t),wv=i(gl," forward method, overrides the "),Ad=n(gl,"CODE",{});var c4=r(Ad);yv=i(c4,"__call__"),c4.forEach(t),$v=i(gl," special method."),gl.forEach(t),Fv=d(xt),k(Bo.$$.fragment,xt),Dv=d(xt),Od=n(xt,"P",{});var p4=r(Od);Bv=i(p4,"Example:"),p4.forEach(t),Mv=d(xt),k(Qr.$$.fragment,xt),Ev=d(xt),k(Hr.$$.fragment,xt),xt.forEach(t),Et.forEach(t),Xp=d(s),Cs=n(s,"H2",{class:!0});var Zh=r(Cs);Mo=n(Zh,"A",{id:!0,class:!0,href:!0});var h4=r(Mo);Nd=n(h4,"SPAN",{});var u4=r(Nd);k(Vr.$$.fragment,u4),u4.forEach(t),h4.forEach(t),xv=d(Zh),Ld=n(Zh,"SPAN",{});var m4=r(Ld);zv=i(m4,"TFDistilBertForQuestionAnswering"),m4.forEach(t),Zh.forEach(t),Yp=d(s),Se=n(s,"DIV",{class:!0});var zt=r(Se);k(Kr.$$.fragment,zt),jv=d(zt),qs=n(zt,"P",{});var _l=r(qs);Cv=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Sd=n(_l,"CODE",{});var f4=r(Sd);qv=i(f4,"span start logits"),f4.forEach(t),Pv=i(_l," and "),Id=n(_l,"CODE",{});var g4=r(Id);Av=i(g4,"span end logits"),g4.forEach(t),Ov=i(_l,")."),_l.forEach(t),Nv=d(zt),Jr=n(zt,"P",{});var eu=r(Jr);Lv=i(eu,"This model inherits from "),Gi=n(eu,"A",{href:!0});var _4=r(Gi);Sv=i(_4,"TFPreTrainedModel"),_4.forEach(t),Iv=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),Wv=d(zt),Gr=n(zt,"P",{});var tu=r(Gr);Rv=i(tu,"This model is also a "),Xr=n(tu,"A",{href:!0,rel:!0});var b4=r(Xr);Uv=i(b4,"tf.keras.Model"),b4.forEach(t),Qv=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Hv=d(zt),k(Eo.$$.fragment,zt),Vv=d(zt),Ve=n(zt,"DIV",{class:!0});var jt=r(Ve);k(Yr.$$.fragment,jt),Kv=d(jt),Ps=n(jt,"P",{});var bl=r(Ps);Jv=i(bl,"The "),Xi=n(bl,"A",{href:!0});var v4=r(Xi);Gv=i(v4,"TFDistilBertForQuestionAnswering"),v4.forEach(t),Xv=i(bl," forward method, overrides the "),Wd=n(bl,"CODE",{});var k4=r(Wd);Yv=i(k4,"__call__"),k4.forEach(t),Zv=i(bl," special method."),bl.forEach(t),ek=d(jt),k(xo.$$.fragment,jt),tk=d(jt),Rd=n(jt,"P",{});var T4=r(Rd);sk=i(T4,"Example:"),T4.forEach(t),ok=d(jt),k(Zr.$$.fragment,jt),nk=d(jt),k(ea.$$.fragment,jt),jt.forEach(t),zt.forEach(t),Zp=d(s),As=n(s,"H2",{class:!0});var su=r(As);zo=n(su,"A",{id:!0,class:!0,href:!0});var w4=r(zo);Ud=n(w4,"SPAN",{});var y4=r(Ud);k(ta.$$.fragment,y4),y4.forEach(t),w4.forEach(t),rk=d(su),Qd=n(su,"SPAN",{});var $4=r(Qd);ak=i($4,"FlaxDistilBertModel"),$4.forEach(t),su.forEach(t),eh=d(s),Me=n(s,"DIV",{class:!0});var pt=r(Me);k(sa.$$.fragment,pt),ik=d(pt),Hd=n(pt,"P",{});var F4=r(Hd);lk=i(F4,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),F4.forEach(t),dk=d(pt),oa=n(pt,"P",{});var ou=r(oa);ck=i(ou,"This model inherits from "),Yi=n(ou,"A",{href:!0});var D4=r(Yi);pk=i(D4,"FlaxPreTrainedModel"),D4.forEach(t),hk=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ou.forEach(t),uk=d(pt),na=n(pt,"P",{});var nu=r(na);mk=i(nu,"This model is also a Flax Linen "),ra=n(nu,"A",{href:!0,rel:!0});var B4=r(ra);fk=i(B4,"flax.linen.Module"),B4.forEach(t),gk=i(nu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),nu.forEach(t),_k=d(pt),Vd=n(pt,"P",{});var M4=r(Vd);bk=i(M4,"Finally, this model supports inherent JAX features such as:"),M4.forEach(t),vk=d(pt),qt=n(pt,"UL",{});var Ho=r(qt);Kd=n(Ho,"LI",{});var E4=r(Kd);aa=n(E4,"A",{href:!0,rel:!0});var x4=r(aa);kk=i(x4,"Just-In-Time (JIT) compilation"),x4.forEach(t),E4.forEach(t),Tk=d(Ho),Jd=n(Ho,"LI",{});var z4=r(Jd);ia=n(z4,"A",{href:!0,rel:!0});var j4=r(ia);wk=i(j4,"Automatic Differentiation"),j4.forEach(t),z4.forEach(t),yk=d(Ho),Gd=n(Ho,"LI",{});var C4=r(Gd);la=n(C4,"A",{href:!0,rel:!0});var q4=r(la);$k=i(q4,"Vectorization"),q4.forEach(t),C4.forEach(t),Fk=d(Ho),Xd=n(Ho,"LI",{});var P4=r(Xd);da=n(P4,"A",{href:!0,rel:!0});var A4=r(da);Dk=i(A4,"Parallelization"),A4.forEach(t),P4.forEach(t),Ho.forEach(t),Bk=d(pt),rt=n(pt,"DIV",{class:!0});var es=r(rt);k(ca.$$.fragment,es),Mk=d(es),Os=n(es,"P",{});var vl=r(Os);Ek=i(vl,"The "),Yd=n(vl,"CODE",{});var O4=r(Yd);xk=i(O4,"FlaxDistilBertPreTrainedModel"),O4.forEach(t),zk=i(vl," forward method, overrides the "),Zd=n(vl,"CODE",{});var N4=r(Zd);jk=i(N4,"__call__"),N4.forEach(t),Ck=i(vl," special method."),vl.forEach(t),qk=d(es),k(jo.$$.fragment,es),Pk=d(es),ec=n(es,"P",{});var L4=r(ec);Ak=i(L4,"Example:"),L4.forEach(t),Ok=d(es),k(pa.$$.fragment,es),es.forEach(t),pt.forEach(t),th=d(s),Ns=n(s,"H2",{class:!0});var ru=r(Ns);Co=n(ru,"A",{id:!0,class:!0,href:!0});var S4=r(Co);tc=n(S4,"SPAN",{});var I4=r(tc);k(ha.$$.fragment,I4),I4.forEach(t),S4.forEach(t),Nk=d(ru),sc=n(ru,"SPAN",{});var W4=r(sc);Lk=i(W4,"FlaxDistilBertForMaskedLM"),W4.forEach(t),ru.forEach(t),sh=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);k(ua.$$.fragment,ht),Sk=d(ht),ma=n(ht,"P",{});var au=r(ma);Ik=i(au,"DistilBert Model with a "),oc=n(au,"CODE",{});var R4=r(oc);Wk=i(R4,"language modeling"),R4.forEach(t),Rk=i(au," head on top."),au.forEach(t),Uk=d(ht),fa=n(ht,"P",{});var iu=r(fa);Qk=i(iu,"This model inherits from "),Zi=n(iu,"A",{href:!0});var U4=r(Zi);Hk=i(U4,"FlaxPreTrainedModel"),U4.forEach(t),Vk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Kk=d(ht),ga=n(ht,"P",{});var lu=r(ga);Jk=i(lu,"This model is also a Flax Linen "),_a=n(lu,"A",{href:!0,rel:!0});var Q4=r(_a);Gk=i(Q4,"flax.linen.Module"),Q4.forEach(t),Xk=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Yk=d(ht),nc=n(ht,"P",{});var H4=r(nc);Zk=i(H4,"Finally, this model supports inherent JAX features such as:"),H4.forEach(t),eT=d(ht),Pt=n(ht,"UL",{});var Vo=r(Pt);rc=n(Vo,"LI",{});var V4=r(rc);ba=n(V4,"A",{href:!0,rel:!0});var K4=r(ba);tT=i(K4,"Just-In-Time (JIT) compilation"),K4.forEach(t),V4.forEach(t),sT=d(Vo),ac=n(Vo,"LI",{});var J4=r(ac);va=n(J4,"A",{href:!0,rel:!0});var G4=r(va);oT=i(G4,"Automatic Differentiation"),G4.forEach(t),J4.forEach(t),nT=d(Vo),ic=n(Vo,"LI",{});var X4=r(ic);ka=n(X4,"A",{href:!0,rel:!0});var Y4=r(ka);rT=i(Y4,"Vectorization"),Y4.forEach(t),X4.forEach(t),aT=d(Vo),lc=n(Vo,"LI",{});var Z4=r(lc);Ta=n(Z4,"A",{href:!0,rel:!0});var e$=r(Ta);iT=i(e$,"Parallelization"),e$.forEach(t),Z4.forEach(t),Vo.forEach(t),lT=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);k(wa.$$.fragment,ts),dT=d(ts),Ls=n(ts,"P",{});var kl=r(Ls);cT=i(kl,"The "),dc=n(kl,"CODE",{});var t$=r(dc);pT=i(t$,"FlaxDistilBertPreTrainedModel"),t$.forEach(t),hT=i(kl," forward method, overrides the "),cc=n(kl,"CODE",{});var s$=r(cc);uT=i(s$,"__call__"),s$.forEach(t),mT=i(kl," special method."),kl.forEach(t),fT=d(ts),k(qo.$$.fragment,ts),gT=d(ts),pc=n(ts,"P",{});var o$=r(pc);_T=i(o$,"Example:"),o$.forEach(t),bT=d(ts),k(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ss=n(s,"H2",{class:!0});var du=r(Ss);Po=n(du,"A",{id:!0,class:!0,href:!0});var n$=r(Po);hc=n(n$,"SPAN",{});var r$=r(hc);k($a.$$.fragment,r$),r$.forEach(t),n$.forEach(t),vT=d(du),uc=n(du,"SPAN",{});var a$=r(uc);kT=i(a$,"FlaxDistilBertForSequenceClassification"),a$.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);k(Fa.$$.fragment,ut),TT=d(ut),mc=n(ut,"P",{});var i$=r(mc);wT=i(i$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
