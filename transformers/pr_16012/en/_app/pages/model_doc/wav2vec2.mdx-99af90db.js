import{S as _k,i as vk,s as wk,e as a,k as l,w as u,t as r,M as bk,c as s,d as t,m as c,a as n,x as g,h as i,b as d,F as e,g as h,y as _,q as v,o as w,B as b}from"../../chunks/vendor-4833417e.js";import{T as fe}from"../../chunks/Tip-fffd6df1.js";import{D as V}from"../../chunks/Docstring-7b52c3d4.js";import{C as ue}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ee}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function yk(E){let p,x,f,T,W,k,y,j;return{c(){p=a("p"),x=r("This class method is simply calling "),f=a("a"),T=r("save_pretrained()"),W=r(` and
...
instance of <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16012/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16012/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_16012/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Whether or not <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16012/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<a href="/docs/transformers/pr_16012/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_16012/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_16012/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
Tuple of <code>jnp.ndarray</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}]}}),Es=new V({props:{name:"replace",anchor:"None",parameters:[{name:"**updates",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/flax/struct.py#L120"}}),Ps=new ee({}),Cs=new V({props:{name:"class transformers.Wav2Vec2Model",anchor:"transformers.Wav2Vec2Model",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1237",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16012/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ds=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2Model.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">292</span>, <span class="hljs-number">768</span>]`}}),Ss=new ee({}),Ns=new V({props:{name:"class transformers.Wav2Vec2ForCTC",anchor:"transformers.Wav2Vec2ForCTC",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1682",parametersDescription:[{anchor:"transformers.Wav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16012/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Rs=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1723",parametersDescription:[{anchor:"transformers.Wav2Vec2ForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16012/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
<span class="hljs-number">53.48</span>`}}),Js=new ee({}),Zs=new V({props:{name:"class transformers.Wav2Vec2ForSequenceClassification",anchor:"transformers.Wav2Vec2ForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1812",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16012/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),on=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1857",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),nn=new ee({}),rn=new V({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1935",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16012/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1978",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
[<span class="hljs-number">0</span>, <span class="hljs-number">0</span>]`}}),un=new ee({}),gn=new V({props:{name:"class transformers.Wav2Vec2ForXVector",anchor:"transformers.Wav2Vec2ForXVector",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2090",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16012/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2152",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-number">0.98</span>`}}),xn=new ee({}),Wn=new V({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1386",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16012/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),En=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"sampled_negative_indices",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(input_values, mask_time_indices=mask_time_indices).loss`}}),Cn=new ee({}),qn=new V({props:{name:"class transformers.TFWav2Vec2Model",anchor:"transformers.TFWav2Vec2Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1428",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16012/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[Ek]},$$scope:{ctx:E}}}),Ln=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16012/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16012/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16012/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[Ck]},$$scope:{ctx:E}}}),Hn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16012/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16012/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16012/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16012/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16012/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16012/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16012/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16012/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),f2=l(),De=a("div"),u(En.$$.fragment),u2=l(),go=a("p"),g2=r("The "),gi=a("a"),_2=r("Wav2Vec2ForPreTraining"),v2=r(" forward method, overrides the "),ac=a("code"),w2=r("__call__"),b2=r(" special method."),y2=l(),u(ia.$$.fragment),k2=l(),sc=a("p"),T2=r("Example:"),x2=l(),u(Pn.$$.fragment),Ed=l(),_o=a("h2"),la=a("a"),nc=a("span"),u(Cn.$$.fragment),W2=l(),rc=a("span"),$2=r("TFWav2Vec2Model"),Pd=l(),le=a("div"),u(qn.$$.fragment),j2=l(),ic=a("p"),V2=r("The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),F2=l(),zn=a("p"),E2=r("This model inherits from "),_i=a("a"),P2=r("TFPreTrainedModel"),C2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),q2=l(),Mn=a("p"),z2=r("This model is also a "),An=a("a"),M2=r("tf.keras.Model"),A2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),L2=l(),u(ca.$$.fragment),D2=l(),Oe=a("div"),u(Ln.$$.fragment),O2=l(),vo=a("p"),S2=r("The "),vi=a("a"),N2=r("TFWav2Vec2Model"),I2=r(" forward method, overrides the "),lc=a("code"),B2=r("__call__"),U2=r(" special method."),H2=l(),u(da.$$.fragment),R2=l(),cc=a("p"),X2=r("Example:"),G2=l(),u(Dn.$$.fragment),Cd=l(),wo=a("h2"),pa=a("a"),dc=a("span"),u(On.$$.fragment),J2=l(),pc=a("span"),Z2=r("TFWav2Vec2ForCTC"),qd=l(),ce=a("div"),u(Sn.$$.fragment),K2=l(),Nn=a("p"),Q2=r("TFWav2Vec2 Model with a "),mc=a("code"),Y2=r("language modeling"),ev=r(" head on top for Connectionist Temporal Classification (CTC)."),tv=l(),In=a("p"),ov=r("This model inherits from "),wi=a("a"),av=r("TFPreTrainedModel"),sv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Auli.`),jv=l(),Kn=a("p"),Vv=r("This model inherits from "),yi=a("a"),Fv=r("FlaxPreTrainedModel"),Ev=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pv=l(),Qn=a("p"),Cv=r(`This model is also a Flax Linen
`),Yn=a("a"),qv=r("flax.nn.Module"),zv=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mv=l(),_c=a("p"),Av=r("Finally, this model supports inherent JAX features such as:"),Lv=l(),bt=a("ul"),vc=a("li"),er=a("a"),Dv=r("Just-In-Time (JIT) compilation"),Ov=l(),wc=a("li"),tr=a("a"),Sv=r("Automatic Differentiation"),Nv=l(),bc=a("li"),or=a("a"),Iv=r("Vectorization"),Bv=l(),yc=a("li"),ar=a("a"),Uv=r("Parallelization"),Hv=l(),Ne=a("div"),u(sr.$$.fragment),Rv=l(),ko=a("p"),Xv=r("The "),kc=a("code"),Gv=r("FlaxWav2Vec2PreTrainedModel"),Jv=r("forward method, overrides the "),Tc=a("code"),Zv=r("__call__"),Kv=r(" special method."),Qv=l(),u(ua.$$.fragment),Yv=l(),xc=a("p"),ew=r("Example:"),tw=l(),u(nr.$$.fragment),Ad=l(),To=a("h2"),ga=a("a"),Wc=a("span"),u(rr.$$.fragment),ow=l(),$c=a("span"),aw=r("FlaxWav2Vec2ForCTC"),Ld=l(),Q=a("div"),u(ir.$$.fragment),sw=l(),xo=a("p"),nw=r("Wav2Vec2 Model with a "),jc=a("code"),rw=r("language modeling"),iw=r(` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Np.forEach(t),N_=c(rt),Le=s(rt,"DIV",{class:!0});var Mt=n(Le);g(kn.$$.fragment,Mt),I_=c(Mt),ho=s(Mt,"P",{});var Li=n(ho);B_=i(Li,"The "),fi=s(Li,"A",{href:!0});var D0=n(fi);U_=i(D0,"Wav2Vec2ForXVector"),D0.forEach(t),H_=i(Li," forward method, overrides the "),Ql=s(Li,"CODE",{});var O0=n(Ql);R_=i(O0,"__call__"),O0.forEach(t),X_=i(Li," special method."),Li.forEach(t),G_=c(Mt),g(na.$$.fragment,Mt),J_=c(Mt),Yl=s(Mt,"P",{});var S0=n(Yl);Z_=i(S0,"Example:"),S0.forEach(t),K_=c(Mt),g(Tn.$$.fragment,Mt),Mt.forEach(t),rt.forEach(t),Vd=c(o),fo=s(o,"H2",{class:!0});var Ip=n(fo);ra=s(Ip,"A",{id:!0,class:!0,href:!0});var N0=n(ra);ec=s(N0,"SPAN",{});var I0=n(ec);g(xn.$$.fragment,I0),I0.forEach(t),N0.forEach(t),Q_=c(Ip),tc=s(Ip,"SPAN",{});var B0=n(tc);Y_=i(B0,"Wav2Vec2ForPreTraining"),B0.forEach(t),Ip.forEach(t),Fd=c(o),je=s(o,"DIV",{class:!0});var At=n(je);g(Wn.$$.fragment,At),e2=c(At),uo=s(At,"P",{});var Di=n(uo);t2=i(Di,"Wav2Vec2 Model with a quantizer and "),oc=s(Di,"CODE",{});var U0=n(oc);o2=i(U0,"VQ"),U0.forEach(t),a2=i(Di,` head on top.
Wav2Vec2 was proposed in `),$n=s(Di,"A",{href:!0,rel:!0});var H0=n($n);s2=i(H0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),H0.forEach(t),n2=i(Di,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Di.forEach(t),r2=c(At),jn=s(At,"P",{});var Bp=n(jn);i2=i(Bp,"This model inherits from "),ui=s(Bp,"A",{href:!0});var R0=n(ui);l2=i(R0,"PreTrainedModel"),R0.forEach(t),c2=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Bp.forEach(t),d2=c(At),Vn=s(At,"P",{});var Up=n(Vn);p2=i(Up,"This model is a PyTorch "),Fn=s(Up,"A",{href:!0,rel:!0});var X0=n(Fn);m2=i(X0,"torch.nn.Module"),X0.forEach(t),h2=i(Up,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Up.forEach(t),f2=c(At),De=s(At,"DIV",{class:!0});var Lt=n(De);g(En.$$.fragment,Lt),u2=c(Lt),go=s(Lt,"P",{});var Oi=n(go);g2=i(Oi,"The "),gi=s(Oi,"A",{href:!0});var G0=n(gi);_2=i(G0,"Wav2Vec2ForPreTraining"),G0.forEach(t),v2=i(Oi," forward method, overrides the "),ac=s(Oi,"CODE",{});var J0=n(ac);w2=i(J0,"__call__"),J0.forEach(t),b2=i(Oi," special method."),Oi.forEach(t),y2=c(Lt),g(ia.$$.fragment,Lt),k2=c(Lt),sc=s(Lt,"P",{});var Z0=n(sc);T2=i(Z0,"Example:"),Z0.forEach(t),x2=c(Lt),g(Pn.$$.fragment,Lt),Lt.forEach(t),At.forEach(t),Ed=c(o),_o=s(o,"H2",{class:!0});var Hp=n(_o);la=s(Hp,"A",{id:!0,class:!0,href:!0});var K0=n(la);nc=s(K0,"SPAN",{});var Q0=n(nc);g(Cn.$$.fragment,Q0),Q0.forEach(t),K0.forEach(t),W2=c(Hp),rc=s(Hp,"SPAN",{});var Y0=n(rc);$2=i(Y0,"TFWav2Vec2Model"),Y0.forEach(t),Hp.forEach(t),Pd=c(o),le=s(o,"DIV",{class:!0});var it=n(le);g(qn.$$.fragment,it),j2=c(it),ic=s(it,"P",{});var ey=n(ic);V2=i(ey,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),ey.forEach(t),F2=c(it),zn=s(it,"P",{});var Rp=n(zn);E2=i(Rp,"This model inherits from "),_i=s(Rp,"A",{href:!0});var ty=n(_i);P2=i(ty,"TFPreTrainedModel"),ty.forEach(t),C2=i(Rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp.forEach(t),q2=c(it),Mn=s(it,"P",{});var Xp=n(Mn);z2=i(Xp,"This model is also a "),An=s(Xp,"A",{href:!0,rel:!0});var oy=n(An);M2=i(oy,"tf.keras.Model"),oy.forEach(t),A2=i(Xp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xp.forEach(t),L2=c(it),g(ca.$$.fragment,it),D2=c(it),Oe=s(it,"DIV",{class:!0});var Dt=n(Oe);g(Ln.$$.fragment,Dt),O2=c(Dt),vo=s(Dt,"P",{});var Si=n(vo);S2=i(Si,"The "),vi=s(Si,"A",{href:!0});var ay=n(vi);N2=i(ay,"TFWav2Vec2Model"),ay.forEach(t),I2=i(Si," forward method, overrides the "),lc=s(Si,"CODE",{});var sy=n(lc);B2=i(sy,"__call__"),sy.forEach(t),U2=i(Si," special method."),Si.forEach(t),H2=c(Dt),g(da.$$.fragment,Dt),R2=c(Dt),cc=s(Dt,"P",{});var ny=n(cc);X2=i(ny,"Example:"),ny.forEach(t),G2=c(Dt),g(Dn.$$.fragment,Dt),Dt.forEach(t),it.forEach(t),Cd=c(o),wo=s(o,"H2",{class:!0});var Gp=n(wo);pa=s(Gp,"A",{id:!0,class:!0,href:!0});var ry=n(pa);dc=s(ry,"SPAN",{});var iy=n(dc);g(On.$$.fragment,iy),iy.forEach(t),ry.forEach(t),J2=c(Gp),pc=s(Gp,"SPAN",{});var ly=n(pc);Z2=i(ly,"TFWav2Vec2ForCTC"),ly.forEach(t),Gp.forEach(t),qd=c(o),ce=s(o,"DIV",{class:!0});var lt=n(ce);g(Sn.$$.fragment,lt),K2=c(lt),Nn=s(lt,"P",{});var Jp=n(Nn);Q2=i(Jp,"TFWav2Vec2 Model with a "),mc=s(Jp,"CODE",{});var cy=n(mc);Y2=i(cy,"language modeling"),cy.forEach(t),ev=i(Jp," head on top for Connectionist Temporal Classification (CTC)."),Jp.forEach(t),tv=c(lt),In=s(lt,"P",{});var Zp=n(In);ov=i(Zp,"This model inherits from "),wi=s(Zp,"A",{href:!0});var dy=n(wi);av=i(dy,"TFPreTrainedModel"),dy.forEach(t),sv=i(Zp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zp.forEach(t),nv=c(lt),Bn=s(lt,"P",{});var Kp=n(Bn);rv=i(Kp,"This model is also a "),Un=s(Kp,"A",{href:!0,rel:!0});var py=n(Un);iv=i(py,"tf.keras.Model"),py.forEach(t),lv=i(Kp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kp.forEach(t),cv=c(lt),g(ma.$$.fragment,lt),dv=c(lt),Se=s(lt,"DIV",{class:!0});var Ot=n(Se);g(Hn.$$.fragment,Ot),pv=c(Ot),bo=s(Ot,"P",{});var Ni=n(bo);mv=i(Ni,"The "),bi=s(Ni,"A",{href:!0});var my=n(bi);hv=i(my,"TFWav2Vec2ForCTC"),my.forEach(t),fv=i(Ni," forward method, overrides the "),hc=s(Ni,"CODE",{});var hy=n(hc);uv=i(hy,"__call__"),hy.forEach(t),gv=i(Ni," special method."),Ni.forEach(t),_v=c(Ot),g(ha.$$.fragment,Ot),vv=c(Ot),fc=s(Ot,"P",{});var fy=n(fc);wv=i(fy,"Example:"),fy.forEach(t),bv=c(Ot),g(Rn.$$.fragment,Ot),Ot.forEach(t),lt.forEach(t),zd=c(o),yo=s(o,"H2",{class:!0});var Qp=n(yo);fa=s(Qp,"A",{id:!0,class:!0,href:!0});var uy=n(fa);uc=s(uy,"SPAN",{});var gy=n(uc);g(Xn.$$.fragment,gy),gy.forEach(t),uy.forEach(t),yv=c(Qp),gc=s(Qp,"SPAN",{});var _y=n(gc);kv=i(_y,"FlaxWav2Vec2Model"),_y.forEach(t),Qp.forEach(t),Md=c(o),K=s(o,"DIV",{class:!0});var He=n(K);g(Gn.$$.fragment,He),Tv=c(He),Jn=s(He,"P",{});var Yp=n(Jn);xv=i(Yp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),Zn=s(Yp,"A",{href:!0,rel:!0});var vy=n(Zn);Wv=i(vy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),vy.forEach(t),$v=i(Yp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Yp.forEach(t),jv=c(He),Kn=s(He,"P",{});var em=n(Kn);Vv=i(em,"This model inherits from "),yi=s(em,"A",{href:!0});var wy=n(yi);Fv=i(wy,"FlaxPreTrainedModel"),wy.forEach(t),Ev=i(em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),em.forEach(t),Pv=c(He),Qn=s(He,"P",{});var tm=n(Qn);Cv=i(tm,`This model is also a Flax Linen
`),Yn=s(tm,"A",{href:!0,rel:!0});var by=n(Yn);qv=i(by,"flax.nn.Module"),by.forEach(t),zv=i(tm,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),tm.forEach(t),Mv=c(He),_c=s(He,"P",{});var yy=n(_c);Av=i(yy,"Finally, this model supports inherent JAX features such as:"),yy.forEach(t),Lv=c(He),bt=s(He,"UL",{});var $a=n(bt);vc=s($a,"LI",{});var ky=n(vc);er=s(ky,"A",{href:!0,rel:!0});var Ty=n(er);Dv=i(Ty,"Just-In-Time (JIT) compilation"),Ty.forEach(t),ky.forEach(t),Ov=c($a),wc=s($a,"LI",{});var xy=n(wc);tr=s(xy,"A",{href:!0,rel:!0});var Wy=n(tr);Sv=i(Wy,"Automatic Differentiation"),Wy.forEach(t),xy.forEach(t),Nv=c($a),bc=s($a,"LI",{});var $y=n(bc);or=s($y,"A",{href:!0,rel:!0});var jy=n(or);Iv=i(jy,"Vectorization"),jy.forEach(t),$y.forEach(t),Bv=c($a),yc=s($a,"LI",{});var Vy=n(yc);ar=s(Vy,"A",{href:!0,rel:!0});var Fy=n(ar);Uv=i(Fy,"Parallelization"),Fy.forEach(t),Vy.forEach(t),$a.forEach(t),Hv=c(He),Ne=s(He,"DIV",{class:!0});var St=n(Ne);g(sr.$$.fragment,St),Rv=c(St),ko=s(St,"P",{});var Ii=n(ko);Xv=i(Ii,"The "),kc=s(Ii,"CODE",{});var Ey=n(kc);Gv=i(Ey,"FlaxWav2Vec2PreTrainedModel"),Ey.forEach(t),Jv=i(Ii,"forward method, overrides the "),Tc=s(Ii,"CODE",{});var Py=n(Tc);Zv=i(Py,"__call__"),Py.forEach(t),Kv=i(Ii," special method."),Ii.forEach(t),Qv=c(St),g(ua.$$.fragment,St),Yv=c(St),xc=s(St,"P",{});var Cy=n(xc);ew=i(Cy,"Example:"),Cy.forEach(t),tw=c(St),g(nr.$$.fragment,St),St.forEach(t),He.forEach(t),Ad=c(o),To=s(o,"H2",{class:!0});var om=n(To);ga=s(om,"A",{id:!0,class:!0,href:!0});var qy=n(ga);Wc=s(qy,"SPAN",{});var zy=n(Wc);g(rr.$$.fragment,zy),zy.forEach(t),qy.forEach(t),ow=c(om),$c=s(om,"SPAN",{});var My=n($c);aw=i(My,"FlaxWav2Vec2ForCTC"),My.forEach(t),om.forEach(t),Ld=c(o),Q=s(o,"DIV",{class:!0});var Re=n(Q);g(ir.$$.fragment,Re),sw=c(Re),xo=s(Re,"P",{});var Bi=n(xo);nw=i(Bi,"Wav2Vec2 Model with a "),jc=s(Bi,"CODE",{});var Ay=n(jc);rw=i(Ay,"language modeling"),Ay.forEach(t),iw=i(Bi,` head on top for Connectionist Temporal Classification (CTC).
