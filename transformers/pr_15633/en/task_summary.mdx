...
automatically selecting the correct model architecture. Please check the [AutoModel](/docs/transformers/pr_15633/en/model_doc/auto#transformers.AutoModel) documentation
...
In the next section, we show how [generation_utils.GenerationMixin.generate()](/docs/transformers/pr_15633/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) can be used to
...
[PreTrainedModel.generate()](/docs/transformers/pr_15633/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) to generate text. The default arguments for this method can be
