...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17981/en/model_doc/gpt_neox#transformers.GPTNeoXModel">GPTNeoXModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTNeoXConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 6144) &#x2014;
...
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/pr_17981/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17981/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L415",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17981/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17981/en/model_doc/gpt_neox#transformers.GPTNeoXConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17981/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L554",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17981/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
