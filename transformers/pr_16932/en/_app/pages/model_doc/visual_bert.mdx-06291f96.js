import{S as md,i as fd,s as gd,e as s,k as u,w as k,t as i,M as _d,c as n,d as o,m as h,a,x as T,h as l,b as c,F as e,g as _,y,q as w,o as $,B as V,v as vd,L as Jt}from"../../chunks/vendor-6b77c823.js";import{T as Eo}from"../../chunks/Tip-39098574.js";import{D as j}from"../../chunks/Docstring-1088f2fb.js";import{C as Ke}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as J}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Kt}from"../../chunks/ExampleCodeBlock-5212b321.js";function bd(B){let d,b,g,m,v;return m=new Ke({props:{code:`from transformers import VisualBertModel, VisualBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),b=i("Example:"),g=u(),k(m.$$.fragment)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Example:"),p.forEach(o),g=h(r),T(m.$$.fragment,r)},m(r,p){_(r,d,p),e(d,b),_(r,g,p),y(m,r,p),v=!0},p:Jt,i(r){v||(w(m.$$.fragment,r),v=!0)},o(r){$(m.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(g),V(m,r)}}}function kd(B){let d,b,g,m,v;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s("code"),m=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(p,"CODE",{});var q=a(g);m=l(q,"Module"),q.forEach(o),v=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(r,p){_(r,d,p),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function Td(B){let d,b,g,m,v;return m=new Ke({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image.
...
the latter silently ignores them.`)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(p,"CODE",{});var q=a(g);m=l(q,"Module"),q.forEach(o),v=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(r,p){_(r,d,p),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function wd(B){let d,b,g,m,v;return m=new Ke({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
...
the latter silently ignores them.`)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(p,"CODE",{});var q=a(g);m=l(q,"Module"),q.forEach(o),v=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(r,p){_(r,d,p),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function Vd(B){let d,b,g,m,v;return m=new Ke({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
...
the latter silently ignores them.`)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(p,"CODE",{});var q=a(g);m=l(q,"Module"),q.forEach(o),v=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(r,p){_(r,d,p),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function qd(B){let d,b,g,m,v;return m=new Ke({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
...
the latter silently ignores them.`)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(p,"CODE",{});var q=a(g);m=l(q,"Module"),q.forEach(o),v=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(r,p){_(r,d,p),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function xd(B){let d,b,g,m,v;return m=new Ke({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
...
the latter silently ignores them.`)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(p,"CODE",{});var q=a(g);m=l(q,"Module"),q.forEach(o),v=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(r,p){_(r,d,p),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function Pd(B){let d,b,g,m,v;return m=new Ke({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),{c(){d=s("p"),b=i("Example:"),g=u(),k(m.$$.fragment)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Example:"),p.forEach(o),g=h(r),T(m.$$.fragment,r)},m(r,p){_(r,d,p),e(d,b),_(r,g,p),y(m,r,p),v=!0},p:Jt,i(r){v||(w(m.$$.fragment,r),v=!0)},o(r){$(m.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(g),V(m,r)}}}function Ed(B){let d,b,g,m,v,r,p,q,qn,Vs,G,me,Mo,Je,zn,Ao,xn,Bs,fe,Fn,Ge,Pn,En,qs,Gt,Mn,zs,Yt,jo,An,xs,Xt,jn,Fs,ge,Co,Ye,Cn,Zt,Ln,On,Rn,Lo,Oo,Nn,Ps,Y,_e,Ro,Xe,In,No,Dn,Es,eo,Sn,Ms,to,Wn,As,ve,Qn,oo,Hn,Un,js,be,Io,so,Ze,Kn,Jn,Gn,Do,no,et,Yn,Xn,Cs,ke,Zn,ao,ea,ta,Ls,tt,Os,D,oa,ot,sa,na,st,aa,ra,Rs,X,Te,So,nt,ia,Wo,la,Ns,A,at,da,Z,ca,ro,pa,ua,rt,ha,ma,fa,ee,ga,io,_a,va,lo,ba,ka,Ta,ye,Is,te,we,Qo,it,ya,Ho,wa,Ds,z,lt,$a,dt,Va,co,Ba,qa,za,ct,xa,pt,Fa,Pa,Ea,ut,Ma,ht,Aa,ja,Ca,C,mt,La,oe,Oa,po,Ra,Na,Uo,Ia,Da,Sa,$e,Wa,Ve,Ss,se,Be,Ko,ft,Qa,Jo,Ha,Ws,x,gt,Ua,ne,Ka,Go,Ja,Ga,Yo,Ya,Xa,Za,_t,er,uo,tr,or,sr,vt,nr,bt,ar,rr,ir,L,kt,lr,ae,dr,ho,cr,pr,Xo,ur,hr,mr,qe,fr,ze,Qs,re,xe,Zo,Tt,gr,es,_r,Hs,F,yt,vr,ts,br,kr,wt,Tr,mo,yr,wr,$r,$t,Vr,Vt,Br,qr,zr,O,Bt,xr,ie,Fr,fo,Pr,Er,os,Mr,Ar,jr,Fe,Cr,Pe,Us,le,Ee,ss,qt,Lr,ns,Or,Ks,P,zt,Rr,as,Nr,Ir,xt,Dr,go,Sr,Wr,Qr,Ft,Hr,Pt,Ur,Kr,Jr,R,Et,Gr,de,Yr,_o,Xr,Zr,rs,ei,ti,oi,Me,si,Ae,Js,ce,je,is,Mt,ni,ls,ai,Gs,E,At,ri,ds,ii,li,jt,di,vo,ci,pi,ui,Ct,hi,Lt,mi,fi,gi,N,Ot,_i,pe,vi,bo,bi,ki,cs,Ti,yi,wi,Ce,$i,Le,Ys,ue,Oe,ps,Rt,Vi,us,Bi,Xs,M,Nt,qi,hs,zi,xi,It,Fi,ko,Pi,Ei,Mi,Dt,Ai,St,ji,Ci,Li,I,Wt,Oi,he,Ri,To,Ni,Ii,ms,Di,Si,Wi,Re,Qi,Ne,Zs;return r=new J({}),Je=new J({}),Xe=new J({}),tt=new Ke({props:{code:`import torch
from transformers import BertTokenizer, VisualBertModel
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16932/en/model_doc/visual_bert#transformers.VisualBertModel">VisualBertModel</a>. Vocabulary size of the model. Defines the
different tokens that can be represented by the <code>inputs_ids</code> passed to the forward method of
<a href="/docs/transformers/pr_16932/en/model_doc/visual_bert#transformers.VisualBertModel">VisualBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.VisualBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16932/en/model_doc/visual_bert#transformers.VisualBertConfig"
...
</ul>`,name:"sentence_image_labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/visual_bert/modeling_visual_bert.py#L888",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16932/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/visual_bert/modeling_visual_bert.py#L1174"}}),Bt=new j({props:{name:"forward",anchor:"transformers.VisualBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16932/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16932/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16932/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16932/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/visual_bert/modeling_visual_bert.py#L1021"}}),Et=new j({props:{name:"forward",anchor:"transformers.VisualBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16932/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16932/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16932/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/visual_bert/modeling_visual_bert.py#L1032",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16932/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/visual_bert/modeling_visual_bert.py#L1460"}}),Wt=new j({props:{name:"forward",anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"region_to_phrase_position",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16932/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16932/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16932/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
outputs from the attention layer.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/visual_bert/modeling_visual_bert.py#L1472",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16932/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
<p><a
  href="/docs/transformers/pr_16932/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Re=new Eo({props:{$$slots:{default:[Fd]},$$scope:{ctx:B}}}),Ne=new Kt({props:{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.example",$$slots:{default:[Pd]},$$scope:{ctx:B}}}),{c(){d=s("meta"),b=u(),g=s("h1"),m=s("a"),v=s("span"),k(r.$$.fragment),p=u(),q=s("span"),qn=i("VisualBERT"),Vs=u(),G=s("h2"),me=s("a"),Mo=s("span"),k(Je.$$.fragment),zn=u(),Ao=s("span"),xn=i("Overview"),Bs=u(),fe=s("p"),Fn=i("The VisualBERT model was proposed in "),Ge=s("a"),Pn=i("VisualBERT: A Simple and Performant Baseline for Vision and Language"),En=i(` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
VisualBERT is a neural network trained on a variety of (image, text) pairs.`),qs=u(),Gt=s("p"),Mn=i("The abstract from the paper is the following:"),zs=u(),Yt=s("p"),jo=s("em"),An=i(`We propose VisualBERT, a simple and flexible framework for modeling a broad range of vision-and-language tasks.
...
verbs and image regions corresponding to their arguments.`),xs=u(),Xt=s("p"),jn=i("Tips:"),Fs=u(),ge=s("ol"),Co=s("li"),Ye=s("p"),Cn=i("Most of the checkpoints provided work with the "),Zt=s("a"),Ln=i("VisualBertForPreTraining"),On=i(` configuration. Other
...
recommended that you use the pretrained checkpoints.`),Rn=u(),Lo=s("li"),Oo=s("p"),Nn=i(`For the VCR task, the authors use a fine-tuned detector for generating visual embeddings, for all the checkpoints.
We do not provide the detector and its weights as a part of the package, but it will be available in the research
projects, and the states can be loaded directly into the detector provided.`),Ps=u(),Y=s("h2"),_e=s("a"),Ro=s("span"),k(Xe.$$.fragment),In=u(),No=s("span"),Dn=i("Usage"),Es=u(),eo=s("p"),Sn=i(`VisualBERT is a multi-modal vision and language model. It can be used for visual question answering, multiple choice,
...
dimension.`),Ms=u(),to=s("p"),Wn=i(`To feed images to the model, each image is passed through a pre-trained object detector and the regions and the
...
to get the visual embeddings. The following example notebooks show how to use VisualBERT with Detectron-like models:`),js=u(),be=s("ul"),Io=s("li"),so=s("p"),Ze=s("a"),Kn=i("VisualBERT VQA demo notebook"),Jn=i(` : This notebook
contains an example on VisualBERT VQA.`),Gn=u(),Do=s("li"),no=s("p"),et=s("a"),Yn=i("Generate Embeddings for VisualBERT (Colab Notebook)"),Xn=i(` : This notebook contains
an example on how to generate visual embeddings.`),Cs=u(),ke=s("p"),Zn=i("The following example shows how to get the last hidden state using "),ao=s("a"),ea=i("VisualBertModel"),ta=i(":"),Ls=u(),k(tt.$$.fragment),Os=u(),D=s("p"),oa=i("This model was contributed by "),ot=s("a"),sa=i("gchhablani"),na=i(". The original code can be found "),st=s("a"),aa=i("here"),ra=i("."),Rs=u(),X=s("h2"),Te=s("a"),So=s("span"),k(nt.$$.fragment),ia=u(),Wo=s("span"),la=i("VisualBertConfig"),Ns=u(),A=s("div"),k(at.$$.fragment),da=u(),Z=s("p"),ca=i("This is the configuration class to store the configuration of a "),ro=s("a"),pa=i("VisualBertModel"),ua=i(`. It is used to instantiate an
...
`),rt=s("a"),ha=i("uclanlp/visualbert-vqa-coco-pre"),ma=i(" architecture."),fa=u(),ee=s("p"),ga=i("Configuration objects inherit from "),io=s("a"),_a=i("PretrainedConfig"),va=i(` and can be used to control the model outputs. Read the
documentation from `),lo=s("a"),ba=i("PretrainedConfig"),ka=i(" for more information."),Ta=u(),k(ye.$$.fragment),Is=u(),te=s("h2"),we=s("a"),Qo=s("span"),k(it.$$.fragment),ya=u(),Ho=s("span"),wa=i("VisualBertModel"),Ds=u(),z=s("div"),k(lt.$$.fragment),$a=u(),dt=s("p"),Va=i(`The bare VisualBert Model transformer outputting raw hidden-states without any specific head on top.
...
etc.)`),za=u(),ct=s("p"),xa=i("This model is also a PyTorch "),pt=s("a"),Fa=i("torch.nn.Module"),Pa=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ea=u(),ut=s("p"),Ma=i("The model can behave as an encoder (with only self-attention) following the architecture described in "),ht=s("a"),Aa=i(`Attention is
all you need`),ja=i(` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ca=u(),C=s("div"),k(mt.$$.fragment),La=u(),oe=s("p"),Oa=i("The "),po=s("a"),Ra=i("VisualBertModel"),Na=i(" forward method, overrides the "),Uo=s("code"),Ia=i("__call__"),Da=i(" special method."),Sa=u(),k($e.$$.fragment),Wa=u(),k(Ve.$$.fragment),Ss=u(),se=s("h2"),Be=s("a"),Ko=s("span"),k(ft.$$.fragment),Qa=u(),Jo=s("span"),Ha=i("VisualBertForPreTraining"),Ws=u(),x=s("div"),k(gt.$$.fragment),Ua=u(),ne=s("p"),Ka=i("VisualBert Model with two heads on top as done during the pretraining: a "),Go=s("code"),Ja=i("masked language modeling"),Ga=i(` head and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ir=u(),L=s("div"),k(kt.$$.fragment),lr=u(),ae=s("p"),dr=i("The "),ho=s("a"),cr=i("VisualBertForPreTraining"),pr=i(" forward method, overrides the "),Xo=s("code"),ur=i("__call__"),hr=i(" special method."),mr=u(),k(qe.$$.fragment),fr=u(),k(ze.$$.fragment),Qs=u(),re=s("h2"),xe=s("a"),Zo=s("span"),k(Tt.$$.fragment),gr=u(),es=s("span"),_r=i("VisualBertForQuestionAnswering"),Hs=u(),F=s("div"),k(yt.$$.fragment),vr=u(),ts=s("p"),br=i(`VisualBert Model with a classification/regression head on top (a dropout and a linear layer on top of the pooled
output) for VQA.`),kr=u(),wt=s("p"),Tr=i("This model inherits from "),mo=s("a"),yr=i("PreTrainedModel"),wr=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$r=u(),$t=s("p"),Vr=i("This model is also a PyTorch "),Vt=s("a"),Br=i("torch.nn.Module"),qr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=u(),O=s("div"),k(Bt.$$.fragment),xr=u(),ie=s("p"),Fr=i("The "),fo=s("a"),Pr=i("VisualBertForQuestionAnswering"),Er=i(" forward method, overrides the "),os=s("code"),Mr=i("__call__"),Ar=i(" special method."),jr=u(),k(Fe.$$.fragment),Cr=u(),k(Pe.$$.fragment),Us=u(),le=s("h2"),Ee=s("a"),ss=s("span"),k(qt.$$.fragment),Lr=u(),ns=s("span"),Or=i("VisualBertForMultipleChoice"),Ks=u(),P=s("div"),k(zt.$$.fragment),Rr=u(),as=s("p"),Nr=i(`VisualBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for VCR tasks.`),Ir=u(),xt=s("p"),Dr=i("This model inherits from "),go=s("a"),Sr=i("PreTrainedModel"),Wr=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qr=u(),Ft=s("p"),Hr=i("This model is also a PyTorch "),Pt=s("a"),Ur=i("torch.nn.Module"),Kr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jr=u(),R=s("div"),k(Et.$$.fragment),Gr=u(),de=s("p"),Yr=i("The "),_o=s("a"),Xr=i("VisualBertForMultipleChoice"),Zr=i(" forward method, overrides the "),rs=s("code"),ei=i("__call__"),ti=i(" special method."),oi=u(),k(Me.$$.fragment),si=u(),k(Ae.$$.fragment),Js=u(),ce=s("h2"),je=s("a"),is=s("span"),k(Mt.$$.fragment),ni=u(),ls=s("span"),ai=i("VisualBertForVisualReasoning"),Gs=u(),E=s("div"),k(At.$$.fragment),ri=u(),ds=s("p"),ii=i(`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
output) for Visual Reasoning e.g. for NLVR task.`),li=u(),jt=s("p"),di=i("This model inherits from "),vo=s("a"),ci=i("PreTrainedModel"),pi=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ui=u(),Ct=s("p"),hi=i("This model is also a PyTorch "),Lt=s("a"),mi=i("torch.nn.Module"),fi=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gi=u(),N=s("div"),k(Ot.$$.fragment),_i=u(),pe=s("p"),vi=i("The "),bo=s("a"),bi=i("VisualBertForVisualReasoning"),ki=i(" forward method, overrides the "),cs=s("code"),Ti=i("__call__"),yi=i(" special method."),wi=u(),k(Ce.$$.fragment),$i=u(),k(Le.$$.fragment),Ys=u(),ue=s("h2"),Oe=s("a"),ps=s("span"),k(Rt.$$.fragment),Vi=u(),us=s("span"),Bi=i("VisualBertForRegionToPhraseAlignment"),Xs=u(),M=s("div"),k(Nt.$$.fragment),qi=u(),hs=s("p"),zi=i(`VisualBert Model with a Masked Language Modeling head and an attention layer on top for Region-to-Phrase Alignment
e.g. for Flickr30 Entities task.`),xi=u(),It=s("p"),Fi=i("This model inherits from "),ko=s("a"),Pi=i("PreTrainedModel"),Ei=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mi=u(),Dt=s("p"),Ai=i("This model is also a PyTorch "),St=s("a"),ji=i("torch.nn.Module"),Ci=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Li=u(),I=s("div"),k(Wt.$$.fragment),Oi=u(),he=s("p"),Ri=i("The "),To=s("a"),Ni=i("VisualBertForRegionToPhraseAlignment"),Ii=i(" forward method, overrides the "),ms=s("code"),Di=i("__call__"),Si=i(" special method."),Wi=u(),k(Re.$$.fragment),Qi=u(),k(Ne.$$.fragment),this.h()},l(t){const f=_d('[data-svelte="svelte-1phssyn"]',document.head);d=n(f,"META",{name:!0,content:!0}),f.forEach(o),b=h(t),g=n(t,"H1",{class:!0});var Qt=a(g);m=n(Qt,"A",{id:!0,class:!0,href:!0});var fs=a(m);v=n(fs,"SPAN",{});var gs=a(v);T(r.$$.fragment,gs),gs.forEach(o),fs.forEach(o),p=h(Qt),q=n(Qt,"SPAN",{});var _s=a(q);qn=l(_s,"VisualBERT"),_s.forEach(o),Qt.forEach(o),Vs=h(t),G=n(t,"H2",{class:!0});var Ht=a(G);me=n(Ht,"A",{id:!0,class:!0,href:!0});var vs=a(me);Mo=n(vs,"SPAN",{});var bs=a(Mo);T(Je.$$.fragment,bs),bs.forEach(o),vs.forEach(o),zn=h(Ht),Ao=n(Ht,"SPAN",{});var ks=a(Ao);xn=l(ks,"Overview"),ks.forEach(o),Ht.forEach(o),Bs=h(t),fe=n(t,"P",{});var Ut=a(fe);Fn=l(Ut,"The VisualBERT model was proposed in "),Ge=n(Ut,"A",{href:!0,rel:!0});var Ts=a(Ge);Pn=l(Ts,"VisualBERT: A Simple and Performant Baseline for Vision and Language"),Ts.forEach(o),En=l(Ut,` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
VisualBERT is a neural network trained on a variety of (image, text) pairs.`),Ut.forEach(o),qs=h(t),Gt=n(t,"P",{});var ys=a(Gt);Mn=l(ys,"The abstract from the paper is the following:"),ys.forEach(o),zs=h(t),Yt=n(t,"P",{});var ws=a(Yt);jo=n(ws,"EM",{});var $s=a(jo);An=l($s,`We propose VisualBERT, a simple and flexible framework for modeling a broad range of vision-and-language tasks.
VisualBERT consists of a stack of Transformer layers that implicitly align elements of an input text and regions in an
associated input image with self-attention. We further propose two visually-grounded language model objectives for
pre-training VisualBERT on image caption data. Experiments on four vision-and-language tasks including VQA, VCR, NLVR2,
and Flickr30K show that VisualBERT outperforms or rivals with state-of-the-art models while being significantly
...
an example on how to generate visual embeddings.`),Ui.forEach(o),il.forEach(o),nn.forEach(o),Cs=h(t),ke=n(t,"P",{});var an=a(ke);Zn=l(an,"The following example shows how to get the last hidden state using "),ao=n(an,"A",{href:!0});var dl=a(ao);ea=l(dl,"VisualBertModel"),dl.forEach(o),ta=l(an,":"),an.forEach(o),Ls=h(t),T(tt.$$.fragment,t),Os=h(t),D=n(t,"P",{});var yo=a(D);oa=l(yo,"This model was contributed by "),ot=n(yo,"A",{href:!0,rel:!0});var cl=a(ot);sa=l(cl,"gchhablani"),cl.forEach(o),na=l(yo,". The original code can be found "),st=n(yo,"A",{href:!0,rel:!0});var pl=a(st);aa=l(pl,"here"),pl.forEach(o),ra=l(yo,"."),yo.forEach(o),Rs=h(t),X=n(t,"H2",{class:!0});var rn=a(X);Te=n(rn,"A",{id:!0,class:!0,href:!0});var ul=a(Te);So=n(ul,"SPAN",{});var hl=a(So);T(nt.$$.fragment,hl),hl.forEach(o),ul.forEach(o),ia=h(rn),Wo=n(rn,"SPAN",{});var ml=a(Wo);la=l(ml,"VisualBertConfig"),ml.forEach(o),rn.forEach(o),Ns=h(t),A=n(t,"DIV",{class:!0});var Ie=a(A);T(at.$$.fragment,Ie),da=h(Ie),Z=n(Ie,"P",{});var wo=a(Z);ca=l(wo,"This is the configuration class to store the configuration of a "),ro=n(wo,"A",{href:!0});var fl=a(ro);pa=l(fl,"VisualBertModel"),fl.forEach(o),ua=l(wo,`. It is used to instantiate an
VisualBERT model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the VisualBERT
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dn.forEach(o),za=h(S),ct=n(S,"P",{});var cn=a(ct);xa=l(cn,"This model is also a PyTorch "),pt=n(cn,"A",{href:!0,rel:!0});var wl=a(pt);Fa=l(wl,"torch.nn.Module"),wl.forEach(o),Pa=l(cn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cn.forEach(o),Ea=h(S),ut=n(S,"P",{});var pn=a(ut);Ma=l(pn,"The model can behave as an encoder (with only self-attention) following the architecture described in "),ht=n(pn,"A",{href:!0,rel:!0});var $l=a(ht);Aa=l($l,`Attention is
all you need`),$l.forEach(o),ja=l(pn,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),pn.forEach(o),Ca=h(S),C=n(S,"DIV",{class:!0});var De=a(C);T(mt.$$.fragment,De),La=h(De),oe=n(De,"P",{});var Vo=a(oe);Oa=l(Vo,"The "),po=n(Vo,"A",{href:!0});var Vl=a(po);Ra=l(Vl,"VisualBertModel"),Vl.forEach(o),Na=l(Vo," forward method, overrides the "),Uo=n(Vo,"CODE",{});var Bl=a(Uo);Ia=l(Bl,"__call__"),Bl.forEach(o),Da=l(Vo," special method."),Vo.forEach(o),Sa=h(De),T($e.$$.fragment,De),Wa=h(De),T(Ve.$$.fragment,De),De.forEach(o),S.forEach(o),Ss=h(t),se=n(t,"H2",{class:!0});var un=a(se);Be=n(un,"A",{id:!0,class:!0,href:!0});var ql=a(Be);Ko=n(ql,"SPAN",{});var zl=a(Ko);T(ft.$$.fragment,zl),zl.forEach(o),ql.forEach(o),Qa=h(un),Jo=n(un,"SPAN",{});var xl=a(Jo);Ha=l(xl,"VisualBertForPreTraining"),xl.forEach(o),un.forEach(o),Ws=h(t),x=n(t,"DIV",{class:!0});var W=a(x);T(gt.$$.fragment,W),Ua=h(W),ne=n(W,"P",{});var Bo=a(ne);Ka=l(Bo,"VisualBert Model with two heads on top as done during the pretraining: a "),Go=n(Bo,"CODE",{});var Fl=a(Go);Ja=l(Fl,"masked language modeling"),Fl.forEach(o),Ga=l(Bo,` head and a
`),Yo=n(Bo,"CODE",{});var Pl=a(Yo);Ya=l(Pl,"sentence-image prediction (classification)"),Pl.forEach(o),Xa=l(Bo," head."),Bo.forEach(o),Za=h(W),_t=n(W,"P",{});var hn=a(_t);er=l(hn,"This model inherits from "),uo=n(hn,"A",{href:!0});var El=a(uo);tr=l(El,"PreTrainedModel"),El.forEach(o),or=l(hn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kn.forEach(o),Jr=h(H),R=n(H,"DIV",{class:!0});var Qe=a(R);T(Et.$$.fragment,Qe),Gr=h(Qe),de=n(Qe,"P",{});var xo=a(de);Yr=l(xo,"The "),_o=n(xo,"A",{href:!0});var Gl=a(_o);Xr=l(Gl,"VisualBertForMultipleChoice"),Gl.forEach(o),Zr=l(xo," forward method, overrides the "),rs=n(xo,"CODE",{});var Yl=a(rs);ei=l(Yl,"__call__"),Yl.forEach(o),ti=l(xo," special method."),xo.forEach(o),oi=h(Qe),T(Me.$$.fragment,Qe),si=h(Qe),T(Ae.$$.fragment,Qe),Qe.forEach(o),H.forEach(o),Js=h(t),ce=n(t,"H2",{class:!0});var Tn=a(ce);je=n(Tn,"A",{id:!0,class:!0,href:!0});var Xl=a(je);is=n(Xl,"SPAN",{});var Zl=a(is);T(Mt.$$.fragment,Zl),Zl.forEach(o),Xl.forEach(o),ni=h(Tn),ls=n(Tn,"SPAN",{});var ed=a(ls);ai=l(ed,"VisualBertForVisualReasoning"),ed.forEach(o),Tn.forEach(o),Gs=h(t),E=n(t,"DIV",{class:!0});var U=a(E);T(At.$$.fragment,U),ri=h(U),ds=n(U,"P",{});var td=a(ds);ii=l(td,`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
output) for Visual Reasoning e.g. for NLVR task.`),td.forEach(o),li=h(U),jt=n(U,"P",{});var yn=a(jt);di=l(yn,"This model inherits from "),vo=n(yn,"A",{href:!0});var od=a(vo);ci=l(od,"PreTrainedModel"),od.forEach(o),pi=l(yn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yn.forEach(o),ui=h(U),Ct=n(U,"P",{});var wn=a(Ct);hi=l(wn,"This model is also a PyTorch "),Lt=n(wn,"A",{href:!0,rel:!0});var sd=a(Lt);mi=l(sd,"torch.nn.Module"),sd.forEach(o),fi=l(wn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wn.forEach(o),gi=h(U),N=n(U,"DIV",{class:!0});var He=a(N);T(Ot.$$.fragment,He),_i=h(He),pe=n(He,"P",{});var Fo=a(pe);vi=l(Fo,"The "),bo=n(Fo,"A",{href:!0});var nd=a(bo);bi=l(nd,"VisualBertForVisualReasoning"),nd.forEach(o),ki=l(Fo," forward method, overrides the "),cs=n(Fo,"CODE",{});var ad=a(cs);Ti=l(ad,"__call__"),ad.forEach(o),yi=l(Fo," special method."),Fo.forEach(o),wi=h(He),T(Ce.$$.fragment,He),$i=h(He),T(Le.$$.fragment,He),He.forEach(o),U.forEach(o),Ys=h(t),ue=n(t,"H2",{class:!0});var $n=a(ue);Oe=n($n,"A",{id:!0,class:!0,href:!0});var rd=a(Oe);ps=n(rd,"SPAN",{});var id=a(ps);T(Rt.$$.fragment,id),id.forEach(o),rd.forEach(o),Vi=h($n),us=n($n,"SPAN",{});var ld=a(us);Bi=l(ld,"VisualBertForRegionToPhraseAlignment"),ld.forEach(o),$n.forEach(o),Xs=h(t),M=n(t,"DIV",{class:!0});var K=a(M);T(Nt.$$.fragment,K),qi=h(K),hs=n(K,"P",{});var dd=a(hs);zi=l(dd,`VisualBert Model with a Masked Language Modeling head and an attention layer on top for Region-to-Phrase Alignment
