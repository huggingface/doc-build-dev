import{S as _i,i as vi,s as Ti,e as s,k as l,w as v,t as o,M as bi,c as n,d as r,m as c,a as i,x as T,h as a,b as d,N as Ci,F as e,g as p,y as b,q as C,o as w,B as k,v as wi}from"../../chunks/vendor-6b77c823.js";import{T as gi}from"../../chunks/Tip-39098574.js";import{D as J}from"../../chunks/Docstring-1088f2fb.js";import{C as Zs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as zt}from"../../chunks/IconCopyLink-7a11ce68.js";function ki(at){let m,q,u,x,L,O,A,F;return{c(){m=s("p"),q=o(`This class method is simply calling the feature extractor
...
methods above for more information.`),_.forEach(r),this.h()},h(){d(u,"href","/docs/transformers/pr_16932/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m($,_){p($,m,_),e(m,q),e(m,u),e(u,x),e(m,L),e(m,O),e(O,A),e(m,F)},d($){$&&r(m)}}}function yi(at){let m,q,u,x,L,O,A,F;return{c(){m=s("p"),q=o("This class method is simply calling "),u=s("a"),x=o("save_pretrained()"),L=o(` and
`),O=s("code"),A=o("save_pretrained"),F=o(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l($){m=n($,"P",{});var _=i(m);q=a(_,"This class method is simply calling "),u=n(_,"A",{href:!0});var P=i(u);x=a(P,"save_pretrained()"),P.forEach(r),L=a(_,` and
`),O=n(_,"CODE",{});var z=i(O);A=a(z,"save_pretrained"),z.forEach(r),F=a(_,`. Please refer to the docstrings of the methods
above for more information.`),_.forEach(r),this.h()},h(){d(u,"href","/docs/transformers/pr_16932/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m($,_){p($,m,_),e(m,q),e(m,u),e(u,x),e(m,L),e(m,O),e(O,A),e(m,F)},d($){$&&r(m)}}}function Oi(at){let m,q,u,x,L,O,A,F,$,_,P,z,Lt,Ce,ro,Ft,oo,gr,S,ao,we,so,no,ke,io,lo,_r,st,co,vr,nt,Dt,ho,Tr,oe,Js,br,ae,po,it,mo,fo,Cr,se,uo,qt,go,_o,wr,W,vo,ye,To,bo,Oe,Co,wo,kr,dt,ko,yr,H,Re,yo,Ee,Oo,Ro,Eo,I,xo,xe,$o,Po,$e,Mo,jo,Pe,zo,Lo,Fo,Me,Do,lt,qo,Ao,Or,Y,ne,At,je,Io,It,Vo,Rr,B,No,Vt,So,Wo,ct,Ho,Bo,Er,f,Uo,Nt,Xo,Go,St,Zo,Jo,Wt,Yo,Ko,Ht,Qo,ea,ht,ta,ra,Bt,oa,aa,Ut,sa,na,Xt,ia,da,Gt,la,ca,xr,pt,Zt,ha,$r,ze,Pr,ie,pa,Le,ma,fa,Mr,K,de,Jt,Fe,ua,Yt,ga,jr,M,De,_a,Q,va,mt,Ta,ba,qe,Ca,wa,ka,ee,ya,ft,Oa,Ra,ut,Ea,xa,$a,Kt,Pa,Ma,Ae,zr,te,le,Qt,Ie,ja,er,za,Lr,g,Ve,La,tr,Fa,Da,R,gt,qa,Aa,rr,Ia,Va,or,Na,Sa,ar,Wa,Ha,sr,Ba,Ua,Ne,nr,Xa,Ga,Za,_t,Ja,Ya,Ka,ce,Se,Qa,V,es,ir,ts,rs,vt,os,as,dr,ss,ns,is,U,We,ds,lr,ls,cs,he,hs,X,He,ps,Be,ms,Tt,fs,us,gs,pe,_s,me,Ue,vs,Xe,Ts,bt,bs,Cs,ws,fe,Ge,ks,Ze,ys,Ct,Os,Rs,Es,ue,Je,xs,cr,$s,Fr,re,ge,hr,Ye,Ps,pr,Ms,Dr,D,Ke,js,N,zs,wt,Ls,Fs,mr,Ds,qs,kt,As,Is,Vs,Qe,Ns,et,Ss,Ws,Hs,G,tt,Bs,fr,Us,Xs,rt,qr;return O=new zt({}),Ce=new zt({}),je=new zt({}),ze=new Zs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16932/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not to use a layernorm after the word + position embeddings.`,name:"layernorm_embedding"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/trocr/configuration_trocr.py#L29"}}),Ae=new Zs({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/trocr/processing_trocr.py#L23"}}),Se=new J({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/trocr/processing_trocr.py#L44"}}),We=new J({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_16932/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/processing_utils.py#L94"}}),pe=new gi({props:{$$slots:{default:[yi]},$$scope:{ctx:at}}}),Ue=new J({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/trocr/processing_trocr.py#L53"}}),Ge=new J({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/trocr/processing_trocr.py#L60"}}),Je=new J({props:{name:"as_target_processor",anchor:"transformers.TrOCRProcessor.as_target_processor",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/trocr/processing_trocr.py#L67"}}),Ye=new zt({}),Ke=new J({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16932/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16932/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/trocr/modeling_trocr.py#L775"}}),tt=new J({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/pr_16932/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16932/en/model_doc/trocr#transformers.TrOCRConfig"
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){m=s("meta"),q=l(),u=s("h1"),x=s("a"),L=s("span"),v(O.$$.fragment),A=l(),F=s("span"),$=o("TrOCR"),_=l(),P=s("h2"),z=s("a"),Lt=s("span"),v(Ce.$$.fragment),ro=l(),Ft=s("span"),oo=o("Overview"),gr=l(),S=s("p"),ao=o("The TrOCR model was proposed in "),we=s("a"),so=o(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
tasks.`),Tr=l(),oe=s("img"),br=l(),ae=s("small"),po=o("TrOCR architecture. Taken from the "),it=s("a"),mo=o("original paper"),fo=o("."),Cr=l(),se=s("p"),uo=o("Please refer to the "),qt=s("code"),go=o("VisionEncoderDecoder"),_o=o(" class on how to use this model."),wr=l(),W=s("p"),vo=o("This model was contributed by "),ye=s("a"),To=o("nielsr"),bo=o(`. The original code can be found
...
into a single instance to both extract the input features and decode the predicted token ids.`),xr=l(),pt=s("ul"),Zt=s("li"),ha=o("Step-by-step Optical Character Recognition (OCR)"),$r=l(),v(ze.$$.fragment),Pr=l(),ie=s("p"),pa=o("See the "),Le=s("a"),ma=o("model hub"),fa=o(" to look for TrOCR checkpoints."),Mr=l(),K=s("h2"),de=s("a"),Jt=s("span"),v(Fe.$$.fragment),ua=l(),Yt=s("span"),ga=o("TrOCRConfig"),jr=l(),M=s("div"),v(De.$$.fragment),_a=l(),Q=s("p"),va=o("This is the configuration class to store the configuration of a "),mt=s("a"),Ta=o("TrOCRForCausalLM"),ba=o(`. It is used to instantiate an
...
`),qe=s("a"),Ca=o("microsoft/trocr-base-handwritten"),wa=o(" architecture."),ka=l(),ee=s("p"),ya=o("Configuration objects inherit from "),ft=s("a"),Oa=o("PretrainedConfig"),Ra=o(` and can be used to control the model outputs. Read the
...
`),dr=s("code"),ss=o("__call__"),ns=o(". Please refer to the doctsring of the above two methods for more information."),is=l(),U=s("div"),v(We.$$.fragment),ds=l(),lr=s("p"),ls=o("Instantiate a processor associated with a pretrained model."),cs=l(),v(he.$$.fragment),hs=l(),X=s("div"),v(He.$$.fragment),ps=l(),Be=s("p"),ms=o(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
