...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,b),e(l,p),e(p,u),e(l,T)},d(i){i&&t(l)}}}function Vu($){let l,b,p,u,T;return u=new Ae({props:{code:`from transformers import LEDTokenizer, LEDModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function Ru($){let l,b,p,u,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,b),e(l,p),e(p,u),e(l,T)},d(i){i&&t(l)}}}function Uu($){let l,b,p,u,T;return u=new Ae({props:{code:`from transformers import LEDTokenizer, LEDForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Summarization example:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Summarization example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function Ju($){let l,b,p,u,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,b),e(l,p),e(p,u),e(l,T)},d(i){i&&t(l)}}}function Zu($){let l,b,p,u,T;return u=new Ae({props:{code:`import torch
...
`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,u){w(l,p,u),b=!0},p:je,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function Yu($){let l,b,p,u,T;return u=new Ae({props:{code:`import torch
from transformers import LEDTokenizer, LEDForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,u){w(l,p,u),b=!0},p:je,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function tm($){let l,b,p,u,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,b),e(l,p),e(p,u),e(l,T)},d(i){i&&t(l)}}}function om($){let l,b,p,u,T;return u=new Ae({props:{code:`from transformers import LEDTokenizer, LEDForQuestionAnswering
import torch
...
`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function nm($){let l,b;return l=new Ae({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function dm($){let l,b,p,u,T,i,f,D,Pe,pe,F,Z,W,ee,Ne,H,Ie,qe,I,V,te,Te,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,S,M,G,Qe,We,P,He,ne,ve;return{c(){l=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),T=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),W=a("code"),ee=n("tf.keras.Model.fit"),Ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),V=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=c(),C=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),R=a("code"),Ge=n("model(input_ids)"),De=c(),O=a("li"),Be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),S=n("model([input_ids, attention_mask])"),M=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),We=c(),P=a("li"),He=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),ve=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);T=r(se,"LI",{});var ot=d(T);i=s(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),f=h(se),D=r(se,"LI",{});var nt=d(D);Pe=s(nt,"having all inputs as a list, tuple or dict in the first positional arguments."),nt.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var N=d(F);Z=s(N,"This second option is useful when using "),W=r(N,"CODE",{});var st=d(W);ee=s(st,"tf.keras.Model.fit"),st.forEach(t),Ne=s(N,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),Te=h(q),C=r(q,"UL",{});var U=d(C);j=r(U,"LI",{});var ae=d(j);ue=s(ae,"a single Tensor with "),oe=r(ae,"CODE",{});var ze=d(oe);$e=s(ze,"input_ids"),ze.forEach(t),me=s(ae," only and nothing else: "),R=r(ae,"CODE",{});var rt=d(R);Ge=s(rt,"model(input_ids)"),rt.forEach(t),ae.forEach(t),De=h(U),O=r(U,"LI",{});var re=d(O);Be=s(re,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=r(re,"CODE",{});var dt=d(K);S=s(dt,"model([input_ids, attention_mask])"),dt.forEach(t),M=s(re," or "),G=r(re,"CODE",{});var de=d(G);Qe=s(de,"model([input_ids, attention_mask, token_type_ids])"),de.forEach(t),re.forEach(t),We=h(U),P=r(U,"LI",{});var Ve=d(P);He=s(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=r(Ve,"CODE",{});var Re=d(ne);ve=s(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),U.forEach(t)},m(q,z){g(q,l,z),e(l,b),g(q,p,z),g(q,u,z),e(u,T),e(T,i),e(u,f),e(u,D),e(D,Pe),g(q,pe,z),g(q,F,z),e(F,Z),e(F,W),e(W,ee),e(F,Ne),e(F,H),e(H,Ie),e(F,qe),g(q,I,z),g(q,V,z),e(V,te),g(q,Te,z),g(q,C,z),e(C,j),e(j,ue),e(j,oe),e(oe,$e),e(j,me),e(j,R),e(R,Ge),e(C,De),e(C,O),e(O,Be),e(O,K),e(K,S),e(O,M),e(O,G),e(G,Qe),e(C,We),e(C,P),e(P,He),e(P,ne),e(ne,ve)},d(q){q&&t(l),q&&t(p),q&&t(u),q&&t(pe),q&&t(F),q&&t(I),q&&t(V),q&&t(Te),q&&t(C)}}}function im($){let l,b,p,u,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,b),e(l,p),e(p,u),e(l,T)},d(i){i&&t(l)}}}function lm($){let l,b,p,u,T;return u=new Ae({props:{code:`from transformers import LEDTokenizer, TFLEDForConditionalGeneration
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Examples:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function cm($){let l,b,p,u,T,i,f,D,Pe,pe,F,Z,W,ee,Ne,H,Ie,qe,I,V,te,Te,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,S,M,G,Qe,We,P,He,ne,ve,q,z,se,ot,nt,N,st,at,Fe,U,ae,ze,rt,re,dt,de,Ve,Re,ad,rd,qs,dd,id,ld,ke,cd,$s,hd,pd,Ds,ud,md,Bn,fd,_d,Fs,gd,bd,Td,X,vd,zs,kd,wd,xs,yd,Ed,Qn,Ld,qd,Ss,$d,Dd,Ms,Fd,zd,Cs,xd,Sd,Md,it,Cd,Os,Od,jd,js,Ad,Pd,Nd,qo,Id,$o,Gd,Bd,Qd,Do,Wd,Fo,Hd,Vd,Wa,jt,Rd,zo,Ud,Xd,Ha,lt,At,As,xo,Jd,Ps,Zd,Va,we,So,Kd,ct,Yd,Wn,ei,ti,Mo,oi,ni,si,ht,ai,Hn,ri,di,Vn,ii,li,ci,Pt,Ra,pt,Nt,Ns,Co,hi,Is,pi,Ua,A,Oo,ui,Gs,mi,fi,It,Rn,_i,gi,Un,bi,Ti,vi,jo,ki,Xn,wi,yi,Ei,Ue,Ao,Li,Bs,qi,$i,Po,Jn,Di,Qs,Fi,zi,Zn,xi,Ws,Si,Mi,Gt,No,Ci,Io,Oi,Hs,ji,Ai,Pi,Bt,Go,Ni,Vs,Ii,Gi,Kn,Bo,Xa,ut,Qt,Rs,Qo,Bi,Us,Qi,Ja,ye,Wo,Wi,Ho,Hi,Xs,Vi,Ri,Ui,Wt,Yn,Xi,Ji,es,Zi,Ki,Yi,Vo,el,ts,tl,ol,Za,mt,Ht,Js,Ro,nl,Zs,sl,Ka,ft,Uo,al,Ks,rl,Ya,_t,Xo,dl,Ys,il,er,gt,Jo,ll,ea,cl,tr,bt,Zo,hl,ta,pl,or,Tt,Ko,ul,oa,ml,nr,vt,Yo,fl,na,_l,sr,kt,en,gl,sa,bl,ar,wt,tn,Tl,aa,vl,rr,yt,Vt,ra,on,kl,da,wl,dr,Ee,nn,yl,sn,El,os,Ll,ql,$l,an,Dl,rn,Fl,zl,xl,xe,dn,Sl,Et,Ml,ns,Cl,Ol,ia,jl,Al,Pl,Rt,Nl,Ut,ir,Lt,Xt,la,ln,Il,ca,Gl,lr,Le,cn,Bl,hn,Ql,ss,Wl,Hl,Vl,pn,Rl,un,Ul,Xl,Jl,fe,mn,Zl,qt,Kl,as,Yl,ec,ha,tc,oc,nc,Jt,sc,Zt,ac,Kt,cr,$t,Yt,pa,fn,rc,ua,dc,hr,ie,_n,ic,ma,lc,cc,gn,hc,rs,pc,uc,mc,bn,fc,Tn,_c,gc,bc,B,vn,Tc,Dt,vc,ds,kc,wc,fa,yc,Ec,Lc,eo,qc,to,$c,oo,Dc,no,Fc,so,pr,Ft,ao,_a,kn,zc,ga,xc,ur,le,wn,Sc,zt,Mc,ba,Cc,Oc,Ta,jc,Ac,Pc,yn,Nc,is,Ic,Gc,Bc,En,Qc,Ln,Wc,Hc,Vc,_e,qn,Rc,xt,Uc,ls,Xc,Jc,va,Zc,Kc,Yc,ro,eh,io,th,lo,mr,St,co,ka,$n,oh,wa,nh,fr,ce,Dn,sh,Fn,ah,cs,rh,dh,ih,zn,lh,xn,ch,hh,ph,ho,uh,Se,Sn,mh,Mt,fh,hs,_h,gh,ya,bh,Th,vh,po,kh,uo,_r,Ct,mo,Ea,Mn,wh,La,yh,gr,he,Cn,Eh,On,Lh,ps,qh,$h,Dh,jn,Fh,An,zh,xh,Sh,fo,Mh,Me,Pn,Ch,Ot,Oh,us,jh,Ah,qa,Ph,Nh,Ih,_o,Gh,go,br;return i=new Ce({}),ee=new Ce({}),xo=new Ce({}),So=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/led/configuration_led.py#L31"}}),Pt=new Oe({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Wu]},$$scope:{ctx:$}}}),Co=new Ce({}),Oo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/led/tokenization_led.py#L43"}}),Ao=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/led/modeling_tf_led.py#L1408"}}),tn=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/pr_16932/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16932/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16932/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/led/modeling_led.py#L2341",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/led/modeling_led.py#L2501",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16932/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/led/modeling_led.py#L2628",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16932/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/led/modeling_tf_led.py#L2244",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16932/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16932/src/transformers/models/led/modeling_tf_led.py#L2353",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16932/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
gained, when `),Bn=a("a"),fd=n("LEDTokenizer"),_d=n(" is used with the "),Fs=a("code"),gd=n("pad_to_multiple_of"),bd=n(" argument."),Td=c(),X=a("li"),vd=n("LED makes use of "),zs=a("em"),kd=n("global attention"),wd=n(" by means of the "),xs=a("code"),yd=n("global_attention_mask"),Ed=n(` (see
...
documentation from `),Vn=a("a"),ii=n("PretrainedConfig"),li=n(" for more information."),ci=c(),v(Pt.$$.fragment),Ra=c(),pt=a("h2"),Nt=a("a"),Ns=a("span"),v(Co.$$.fragment),hi=c(),Is=a("span"),pi=n("LEDTokenizer"),Ua=c(),A=a("div"),v(Oo.$$.fragment),ui=c(),Gs=a("p"),mi=n("Construct a LED tokenizer."),fi=c(),It=a("p"),Rn=a("a"),_i=n("LEDTokenizer"),gi=n(" is identical to "),Un=a("a"),bi=n("BartTokenizer"),Ti=n(` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),vi=c(),jo=a("p"),ki=n("Refer to superclass "),Xn=a("a"),wi=n("BartTokenizer"),yi=n(" for usage examples and documentation concerning parameters."),Ei=c(),Ue=a("div"),v(Ao.$$.fragment),Li=c(),Bs=a("p"),qi=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),$i=c(),Po=a("ul"),Jn=a("li"),Di=n("single sequence: "),Qs=a("code"),Fi=n("<s> X </s>"),zi=c(),Zn=a("li"),xi=n("pair of sequences: "),Ws=a("code"),Si=n("<s> A </s></s> B </s>"),Mi=c(),Gt=a("div"),v(No.$$.fragment),Ci=c(),Io=a("p"),Oi=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Hs=a("code"),ji=n("prepare_for_model"),Ai=n(" method."),Pi=c(),Bt=a("div"),v(Go.$$.fragment),Ni=c(),Vs=a("p"),Ii=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Gi=c(),Kn=a("div"),v(Bo.$$.fragment),Xa=c(),ut=a("h2"),Qt=a("a"),Rs=a("span"),v(Qo.$$.fragment),Bi=c(),Us=a("span"),Qi=n("LEDTokenizerFast"),Ja=c(),ye=a("div"),v(Wo.$$.fragment),Wi=c(),Ho=a("p"),Hi=n("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Xs=a("em"),Vi=n("tokenizers"),Ri=n(" library)."),Ui=c(),Wt=a("p"),Yn=a("a"),Xi=n("LEDTokenizerFast"),Ji=n(" is identical to "),es=a("a"),Zi=n("BartTokenizerFast"),Ki=n(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Yi=c(),Vo=a("p"),el=n("Refer to superclass "),ts=a("a"),tl=n("BartTokenizerFast"),ol=n(" for usage examples and documentation concerning parameters."),Za=c(),mt=a("h2"),Ht=a("a"),Js=a("span"),v(Ro.$$.fragment),nl=c(),Zs=a("span"),sl=n("LED specific outputs"),Ka=c(),ft=a("div"),v(Uo.$$.fragment),al=c(),Ks=a("p"),rl=n("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Ya=c(),_t=a("div"),v(Xo.$$.fragment),dl=c(),Ys=a("p"),il=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),er=c(),gt=a("div"),v(Jo.$$.fragment),ll=c(),ea=a("p"),cl=n("Base class for sequence-to-sequence language models outputs."),tr=c(),bt=a("div"),v(Zo.$$.fragment),hl=c(),ta=a("p"),pl=n("Base class for outputs of sequence-to-sequence sentence classification models."),or=c(),Tt=a("div"),v(Ko.$$.fragment),ul=c(),oa=a("p"),ml=n("Base class for outputs of sequence-to-sequence question answering models."),nr=c(),vt=a("div"),v(Yo.$$.fragment),fl=c(),na=a("p"),_l=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),sr=c(),kt=a("div"),v(en.$$.fragment),gl=c(),sa=a("p"),bl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),ar=c(),wt=a("div"),v(tn.$$.fragment),Tl=c(),aa=a("p"),vl=n("Base class for sequence-to-sequence language models outputs."),rr=c(),yt=a("h2"),Vt=a("a"),ra=a("span"),v(on.$$.fragment),kl=c(),da=a("span"),wl=n("LEDModel"),dr=c(),Ee=a("div"),v(nn.$$.fragment),yl=c(),sn=a("p"),El=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),xl=c(),xe=a("div"),v(dn.$$.fragment),Sl=c(),Et=a("p"),Ml=n("The "),ns=a("a"),Cl=n("LEDModel"),Ol=n(" forward method, overrides the "),ia=a("code"),jl=n("__call__"),Al=n(" special method."),Pl=c(),v(Rt.$$.fragment),Nl=c(),v(Ut.$$.fragment),ir=c(),Lt=a("h2"),Xt=a("a"),la=a("span"),v(ln.$$.fragment),Il=c(),ca=a("span"),Gl=n("LEDForConditionalGeneration"),lr=c(),Le=a("div"),v(cn.$$.fragment),Bl=c(),hn=a("p"),Ql=n(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Jl=c(),fe=a("div"),v(mn.$$.fragment),Zl=c(),qt=a("p"),Kl=n("The "),as=a("a"),Yl=n("LEDForConditionalGeneration"),ec=n(" forward method, overrides the "),ha=a("code"),tc=n("__call__"),oc=n(" special method."),nc=c(),v(Jt.$$.fragment),sc=c(),v(Zt.$$.fragment),ac=c(),v(Kt.$$.fragment),cr=c(),$t=a("h2"),Yt=a("a"),pa=a("span"),v(fn.$$.fragment),rc=c(),ua=a("span"),dc=n("LEDForSequenceClassification"),hr=c(),ie=a("div"),v(_n.$$.fragment),ic=c(),ma=a("p"),lc=n(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),mc=c(),bn=a("p"),fc=n("This model is also a PyTorch "),Tn=a("a"),_c=n("torch.nn.Module"),gc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),bc=c(),B=a("div"),v(vn.$$.fragment),Tc=c(),Dt=a("p"),vc=n("The "),ds=a("a"),kc=n("LEDForSequenceClassification"),wc=n(" forward method, overrides the "),fa=a("code"),yc=n("__call__"),Ec=n(" special method."),Lc=c(),v(eo.$$.fragment),qc=c(),v(to.$$.fragment),$c=c(),v(oo.$$.fragment),Dc=c(),v(no.$$.fragment),Fc=c(),v(so.$$.fragment),pr=c(),Ft=a("h2"),ao=a("a"),_a=a("span"),v(kn.$$.fragment),zc=c(),ga=a("span"),xc=n("LEDForQuestionAnswering"),ur=c(),le=a("div"),v(wn.$$.fragment),Sc=c(),zt=a("p"),Mc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),ba=a("code"),Cc=n("span start logits"),Oc=n(" and "),Ta=a("code"),jc=n("span end logits"),Ac=n(")."),Pc=c(),yn=a("p"),Nc=n("This model inherits from "),is=a("a"),Ic=n("PreTrainedModel"),Gc=n(`. See the superclass documentation for the generic methods the library
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Vc=c(),_e=a("div"),v(qn.$$.fragment),Rc=c(),xt=a("p"),Uc=n("The "),ls=a("a"),Xc=n("LEDForQuestionAnswering"),Jc=n(" forward method, overrides the "),va=a("code"),Zc=n("__call__"),Kc=n(" special method."),Yc=c(),v(ro.$$.fragment),eh=c(),v(io.$$.fragment),th=c(),v(lo.$$.fragment),mr=c(),St=a("h2"),co=a("a"),ka=a("span"),v($n.$$.fragment),oh=c(),wa=a("span"),nh=n("TFLEDModel"),fr=c(),ce=a("div"),v(Dn.$$.fragment),sh=c(),Fn=a("p"),ah=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
behavior.`),ph=c(),v(ho.$$.fragment),uh=c(),Se=a("div"),v(Sn.$$.fragment),mh=c(),Mt=a("p"),fh=n("The "),hs=a("a"),_h=n("TFLEDModel"),gh=n(" forward method, overrides the "),ya=a("code"),bh=n("__call__"),Th=n(" special method."),vh=c(),v(po.$$.fragment),kh=c(),v(uo.$$.fragment),_r=c(),Ct=a("h2"),mo=a("a"),Ea=a("span"),v(Mn.$$.fragment),wh=c(),La=a("span"),yh=n("TFLEDForConditionalGeneration"),gr=c(),he=a("div"),v(Cn.$$.fragment),Eh=c(),On=a("p"),Lh=n(`The LED Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sh=c(),v(fo.$$.fragment),Mh=c(),Me=a("div"),v(Pn.$$.fragment),Ch=c(),Ot=a("p"),Oh=n("The "),us=a("a"),jh=n("TFLEDForConditionalGeneration"),Ah=n(" forward method, overrides the "),qa=a("code"),Ph=n("__call__"),Nh=n(" special method."),Ih=c(),v(_o.$$.fragment),Gh=c(),v(go.$$.fragment),this.h()},l(o){const _=Bu('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),p=r(o,"H1",{class:!0});var Nn=d(p);u=r(Nn,"A",{id:!0,class:!0,href:!0});var $a=d(u);T=r($a,"SPAN",{});var Da=d(T);k(i.$$.fragment,Da),Da.forEach(t),$a.forEach(t),f=h(Nn),D=r(Nn,"SPAN",{});var Fa=d(D);Pe=s(Fa,"LED"),Fa.forEach(t),Nn.forEach(t),pe=h(o),F=r(o,"H2",{class:!0});var In=d(F);Z=r(In,"A",{id:!0,class:!0,href:!0});var za=d(Z);W=r(za,"SPAN",{});var xa=d(W);k(ee.$$.fragment,xa),xa.forEach(t),za.forEach(t),Ne=h(In),H=r(In,"SPAN",{});var Sa=d(H);Ie=s(Sa,"Overview"),Sa.forEach(t),In.forEach(t),qe=h(o),I=r(o,"P",{});var Gn=d(I);V=s(Gn,"The LED model was proposed in "),te=r(Gn,"A",{href:!0,rel:!0});var Ma=d(te);Te=s(Ma,"Longformer: The Long-Document Transformer"),Ma.forEach(t),C=s(Gn,` by Iz
...
`),P=r(Q,"A",{href:!0});var Na=d(P);He=s(Na,"BartForConditionalGeneration"),Na.forEach(t),ne=s(Q," exchanging the traditional "),ve=r(Q,"EM",{});var Ia=d(ve);q=s(Ia,"self-attention"),Ia.forEach(t),z=s(Q,` layer with
...
`),js=r(fs,"CODE",{});var rp=d(js);Ad=s(rp,"model.gradient_checkpointing_enable()"),rp.forEach(t),Pd=s(fs,"."),fs.forEach(t),Nd=h(J),qo=r(J,"LI",{});var Tr=d(qo);Id=s(Tr,"A notebook showing how to evaluate LED, can be accessed "),$o=r(Tr,"A",{href:!0,rel:!0});var dp=d($o);Gd=s(dp,"here"),dp.forEach(t),Bd=s(Tr,"."),Tr.forEach(t),Qd=h(J),Do=r(J,"LI",{});var vr=d(Do);Wd=s(vr,"A notebook showing how to fine-tune LED, can be accessed "),Fo=r(vr,"A",{href:!0,rel:!0});var ip=d(Fo);Hd=s(ip,"here"),ip.forEach(t),Vd=s(vr,"."),vr.forEach(t),J.forEach(t),Wa=h(o),jt=r(o,"P",{});var kr=d(jt);Rd=s(kr,"This model was contributed by "),zo=r(kr,"A",{href:!0,rel:!0});var lp=d(zo);Ud=s(lp,"patrickvonplaten"),lp.forEach(t),Xd=s(kr,"."),kr.forEach(t),Ha=h(o),lt=r(o,"H2",{class:!0});var wr=d(lt);At=r(wr,"A",{id:!0,class:!0,href:!0});var cp=d(At);As=r(cp,"SPAN",{});var hp=d(As);k(xo.$$.fragment,hp),hp.forEach(t),cp.forEach(t),Jd=h(wr),Ps=r(wr,"SPAN",{});var pp=d(Ps);Zd=s(pp,"LEDConfig"),pp.forEach(t),wr.forEach(t),Va=h(o),we=r(o,"DIV",{class:!0});var bo=d(we);k(So.$$.fragment,bo),Kd=h(bo),ct=r(bo,"P",{});var _s=d(ct);Yd=s(_s,"This is the configuration class to store the configuration of a "),Wn=r(_s,"A",{href:!0});var up=d(Wn);ei=s(up,"LEDModel"),up.forEach(t),ti=s(_s,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),Mo=r(_s,"A",{href:!0,rel:!0});var mp=d(Mo);oi=s(mp,"allenai/led-base-16384"),mp.forEach(t),ni=s(_s," architecture."),_s.forEach(t),si=h(bo),ht=r(bo,"P",{});var gs=d(ht);ai=s(gs,"Configuration objects inherit from "),Hn=r(gs,"A",{href:!0});var fp=d(Hn);ri=s(fp,"PretrainedConfig"),fp.forEach(t),di=s(gs,` and can be used to control the model outputs. Read the
documentation from `),Vn=r(gs,"A",{href:!0});var _p=d(Vn);ii=s(_p,"PretrainedConfig"),_p.forEach(t),li=s(gs," for more information."),gs.forEach(t),ci=h(bo),k(Pt.$$.fragment,bo),bo.forEach(t),Ra=h(o),pt=r(o,"H2",{class:!0});var yr=d(pt);Nt=r(yr,"A",{id:!0,class:!0,href:!0});var gp=d(Nt);Ns=r(gp,"SPAN",{});var bp=d(Ns);k(Co.$$.fragment,bp),bp.forEach(t),gp.forEach(t),hi=h(yr),Is=r(yr,"SPAN",{});var Tp=d(Is);pi=s(Tp,"LEDTokenizer"),Tp.forEach(t),yr.forEach(t),Ua=h(o),A=r(o,"DIV",{class:!0});var Y=d(A);k(Oo.$$.fragment,Y),ui=h(Y),Gs=r(Y,"P",{});var vp=d(Gs);mi=s(vp,"Construct a LED tokenizer."),vp.forEach(t),fi=h(Y),It=r(Y,"P",{});var Ba=d(It);Rn=r(Ba,"A",{href:!0});var kp=d(Rn);_i=s(kp,"LEDTokenizer"),kp.forEach(t),gi=s(Ba," is identical to "),Un=r(Ba,"A",{href:!0});var wp=d(Un);bi=s(wp,"BartTokenizer"),wp.forEach(t),Ti=s(Ba,` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),Ba.forEach(t),vi=h(Y),jo=r(Y,"P",{});var Er=d(jo);ki=s(Er,"Refer to superclass "),Xn=r(Er,"A",{href:!0});var yp=d(Xn);wi=s(yp,"BartTokenizer"),yp.forEach(t),yi=s(Er," for usage examples and documentation concerning parameters."),Er.forEach(t),Ei=h(Y),Ue=r(Y,"DIV",{class:!0});var bs=d(Ue);k(Ao.$$.fragment,bs),Li=h(bs),Bs=r(bs,"P",{});var Ep=d(Bs);qi=s(Ep,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),Ep.forEach(t),$i=h(bs),Po=r(bs,"UL",{});var Lr=d(Po);Jn=r(Lr,"LI",{});var Bh=d(Jn);Di=s(Bh,"single sequence: "),Qs=r(Bh,"CODE",{});var Lp=d(Qs);Fi=s(Lp,"<s> X </s>"),Lp.forEach(t),Bh.forEach(t),zi=h(Lr),Zn=r(Lr,"LI",{});var Qh=d(Zn);xi=s(Qh,"pair of sequences: "),Ws=r(Qh,"CODE",{});var qp=d(Ws);Si=s(qp,"<s> A </s></s> B </s>"),qp.forEach(t),Qh.forEach(t),Lr.forEach(t),bs.forEach(t),Mi=h(Y),Gt=r(Y,"DIV",{class:!0});var qr=d(Gt);k(No.$$.fragment,qr),Ci=h(qr),Io=r(qr,"P",{});var $r=d(Io);Oi=s($r,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned.`),Dp.forEach(t),Dr.forEach(t),Gi=h(Y),Kn=r(Y,"DIV",{class:!0});var Fp=d(Kn);k(Bo.$$.fragment,Fp),Fp.forEach(t),Y.forEach(t),Xa=h(o),ut=r(o,"H2",{class:!0});var Fr=d(ut);Qt=r(Fr,"A",{id:!0,class:!0,href:!0});var zp=d(Qt);Rs=r(zp,"SPAN",{});var xp=d(Rs);k(Qo.$$.fragment,xp),xp.forEach(t),zp.forEach(t),Bi=h(Fr),Us=r(Fr,"SPAN",{});var Sp=d(Us);Qi=s(Sp,"LEDTokenizerFast"),Sp.forEach(t),Fr.forEach(t),Ja=h(o),ye=r(o,"DIV",{class:!0});var To=d(ye);k(Wo.$$.fragment,To),Wi=h(To),Ho=r(To,"P",{});var zr=d(Ho);Hi=s(zr,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Xs=r(zr,"EM",{});var Mp=d(Xs);Vi=s(Mp,"tokenizers"),Mp.forEach(t),Ri=s(zr," library)."),zr.forEach(t),Ui=h(To),Wt=r(To,"P",{});var Qa=d(Wt);Yn=r(Qa,"A",{href:!0});var Cp=d(Yn);Xi=s(Cp,"LEDTokenizerFast"),Cp.forEach(t),Ji=s(Qa," is identical to "),es=r(Qa,"A",{href:!0});var Op=d(es);Zi=s(Op,"BartTokenizerFast"),Op.forEach(t),Ki=s(Qa,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Qa.forEach(t),Yi=h(To),Vo=r(To,"P",{});var xr=d(Vo);el=s(xr,"Refer to superclass "),ts=r(xr,"A",{href:!0});var jp=d(ts);tl=s(jp,"BartTokenizerFast"),jp.forEach(t),ol=s(xr," for usage examples and documentation concerning parameters."),xr.forEach(t),To.forEach(t),Za=h(o),mt=r(o,"H2",{class:!0});var Sr=d(mt);Ht=r(Sr,"A",{id:!0,class:!0,href:!0});var Ap=d(Ht);Js=r(Ap,"SPAN",{});var Pp=d(Js);k(Ro.$$.fragment,Pp),Pp.forEach(t),Ap.forEach(t),nl=h(Sr),Zs=r(Sr,"SPAN",{});var Np=d(Zs);sl=s(Np,"LED specific outputs"),Np.forEach(t),Sr.forEach(t),Ka=h(o),ft=r(o,"DIV",{class:!0});var Mr=d(ft);k(Uo.$$.fragment,Mr),al=h(Mr),Ks=r(Mr,"P",{});var Ip=d(Ks);rl=s(Ip,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Ip.forEach(t),Mr.forEach(t),Ya=h(o),_t=r(o,"DIV",{class:!0});var Cr=d(_t);k(Xo.$$.fragment,Cr),dl=h(Cr),Ys=r(Cr,"P",{});var Gp=d(Ys);il=s(Gp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Gp.forEach(t),Cr.forEach(t),er=h(o),gt=r(o,"DIV",{class:!0});var Or=d(gt);k(Jo.$$.fragment,Or),ll=h(Or),ea=r(Or,"P",{});var Bp=d(ea);cl=s(Bp,"Base class for sequence-to-sequence language models outputs."),Bp.forEach(t),Or.forEach(t),tr=h(o),bt=r(o,"DIV",{class:!0});var jr=d(bt);k(Zo.$$.fragment,jr),hl=h(jr),ta=r(jr,"P",{});var Qp=d(ta);pl=s(Qp,"Base class for outputs of sequence-to-sequence sentence classification models."),Qp.forEach(t),jr.forEach(t),or=h(o),Tt=r(o,"DIV",{class:!0});var Ar=d(Tt);k(Ko.$$.fragment,Ar),ul=h(Ar),oa=r(Ar,"P",{});var Wp=d(oa);ml=s(Wp,"Base class for outputs of sequence-to-sequence question answering models."),Wp.forEach(t),Ar.forEach(t),nr=h(o),vt=r(o,"DIV",{class:!0});var Pr=d(vt);k(Yo.$$.fragment,Pr),fl=h(Pr),na=r(Pr,"P",{});var Hp=d(na);_l=s(Hp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Hp.forEach(t),Pr.forEach(t),sr=h(o),kt=r(o,"DIV",{class:!0});var Nr=d(kt);k(en.$$.fragment,Nr),gl=h(Nr),sa=r(Nr,"P",{});var Vp=d(sa);bl=s(Vp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Vp.forEach(t),Nr.forEach(t),ar=h(o),wt=r(o,"DIV",{class:!0});var Ir=d(wt);k(tn.$$.fragment,Ir),Tl=h(Ir),aa=r(Ir,"P",{});var Rp=d(aa);vl=s(Rp,"Base class for sequence-to-sequence language models outputs."),Rp.forEach(t),Ir.forEach(t),rr=h(o),yt=r(o,"H2",{class:!0});var Gr=d(yt);Vt=r(Gr,"A",{id:!0,class:!0,href:!0});var Up=d(Vt);ra=r(Up,"SPAN",{});var Xp=d(ra);k(on.$$.fragment,Xp),Xp.forEach(t),Up.forEach(t),kl=h(Gr),da=r(Gr,"SPAN",{});var Jp=d(da);wl=s(Jp,"LEDModel"),Jp.forEach(t),Gr.forEach(t),dr=h(o),Ee=r(o,"DIV",{class:!0});var vo=d(Ee);k(nn.$$.fragment,vo),yl=h(vo),sn=r(vo,"P",{});var Br=d(sn);El=s(Br,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Br.forEach(t),$l=h(vo),an=r(vo,"P",{});var Qr=d(an);Dl=s(Qr,"This model is also a PyTorch "),rn=r(Qr,"A",{href:!0,rel:!0});var Kp=d(rn);Fl=s(Kp,"torch.nn.Module"),Kp.forEach(t),zl=s(Qr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Qr.forEach(t),xl=h(vo),xe=r(vo,"DIV",{class:!0});var ko=d(xe);k(dn.$$.fragment,ko),Sl=h(ko),Et=r(ko,"P",{});var Ts=d(Et);Ml=s(Ts,"The "),ns=r(Ts,"A",{href:!0});var Yp=d(ns);Cl=s(Yp,"LEDModel"),Yp.forEach(t),Ol=s(Ts," forward method, overrides the "),ia=r(Ts,"CODE",{});var eu=d(ia);jl=s(eu,"__call__"),eu.forEach(t),Al=s(Ts," special method."),Ts.forEach(t),Pl=h(ko),k(Rt.$$.fragment,ko),Nl=h(ko),k(Ut.$$.fragment,ko),ko.forEach(t),vo.forEach(t),ir=h(o),Lt=r(o,"H2",{class:!0});var Wr=d(Lt);Xt=r(Wr,"A",{id:!0,class:!0,href:!0});var tu=d(Xt);la=r(tu,"SPAN",{});var ou=d(la);k(ln.$$.fragment,ou),ou.forEach(t),tu.forEach(t),Il=h(Wr),ca=r(Wr,"SPAN",{});var nu=d(ca);Gl=s(nu,"LEDForConditionalGeneration"),nu.forEach(t),Wr.forEach(t),lr=h(o),Le=r(o,"DIV",{class:!0});var wo=d(Le);k(cn.$$.fragment,wo),Bl=h(wo),hn=r(wo,"P",{});var Hr=d(hn);Ql=s(Hr,`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Vr.forEach(t),Jl=h(wo),fe=r(wo,"DIV",{class:!0});var Je=d(fe);k(mn.$$.fragment,Je),Zl=h(Je),qt=r(Je,"P",{});var vs=d(qt);Kl=s(vs,"The "),as=r(vs,"A",{href:!0});var ru=d(as);Yl=s(ru,"LEDForConditionalGeneration"),ru.forEach(t),ec=s(vs," forward method, overrides the "),ha=r(vs,"CODE",{});var du=d(ha);tc=s(du,"__call__"),du.forEach(t),oc=s(vs," special method."),vs.forEach(t),nc=h(Je),k(Jt.$$.fragment,Je),sc=h(Je),k(Zt.$$.fragment,Je),ac=h(Je),k(Kt.$$.fragment,Je),Je.forEach(t),wo.forEach(t),cr=h(o),$t=r(o,"H2",{class:!0});var Rr=d($t);Yt=r(Rr,"A",{id:!0,class:!0,href:!0});var iu=d(Yt);pa=r(iu,"SPAN",{});var lu=d(pa);k(fn.$$.fragment,lu),lu.forEach(t),iu.forEach(t),rc=h(Rr),ua=r(Rr,"SPAN",{});var cu=d(ua);dc=s(cu,"LEDForSequenceClassification"),cu.forEach(t),Rr.forEach(t),hr=h(o),ie=r(o,"DIV",{class:!0});var Ze=d(ie);k(_n.$$.fragment,Ze),ic=h(Ze),ma=r(Ze,"P",{});var hu=d(ma);lc=s(hu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Ur.forEach(t),mc=h(Ze),bn=r(Ze,"P",{});var Xr=d(bn);fc=s(Xr,"This model is also a PyTorch "),Tn=r(Xr,"A",{href:!0,rel:!0});var uu=d(Tn);_c=s(uu,"torch.nn.Module"),uu.forEach(t),gc=s(Xr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Xr.forEach(t),bc=h(Ze),B=r(Ze,"DIV",{class:!0});var be=d(B);k(vn.$$.fragment,be),Tc=h(be),Dt=r(be,"P",{});var ks=d(Dt);vc=s(ks,"The "),ds=r(ks,"A",{href:!0});var mu=d(ds);kc=s(mu,"LEDForSequenceClassification"),mu.forEach(t),wc=s(ks," forward method, overrides the "),fa=r(ks,"CODE",{});var fu=d(fa);yc=s(fu,"__call__"),fu.forEach(t),Ec=s(ks," special method."),ks.forEach(t),Lc=h(be),k(eo.$$.fragment,be),qc=h(be),k(to.$$.fragment,be),$c=h(be),k(oo.$$.fragment,be),Dc=h(be),k(no.$$.fragment,be),Fc=h(be),k(so.$$.fragment,be),be.forEach(t),Ze.forEach(t),pr=h(o),Ft=r(o,"H2",{class:!0});var Jr=d(Ft);ao=r(Jr,"A",{id:!0,class:!0,href:!0});var _u=d(ao);_a=r(_u,"SPAN",{});var gu=d(_a);k(kn.$$.fragment,gu),gu.forEach(t),_u.forEach(t),zc=h(Jr),ga=r(Jr,"SPAN",{});var bu=d(ga);xc=s(bu,"LEDForQuestionAnswering"),bu.forEach(t),Jr.forEach(t),ur=h(o),le=r(o,"DIV",{class:!0});var Ke=d(le);k(wn.$$.fragment,Ke),Sc=h(Ke),zt=r(Ke,"P",{});var ws=d(zt);Mc=s(ws,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),ba=r(ws,"CODE",{});var Tu=d(ba);Cc=s(Tu,"span start logits"),Tu.forEach(t),Oc=s(ws," and "),Ta=r(ws,"CODE",{});var vu=d(Ta);jc=s(vu,"span end logits"),vu.forEach(t),Ac=s(ws,")."),ws.forEach(t),Pc=h(Ke),yn=r(Ke,"P",{});var Zr=d(yn);Nc=s(Zr,"This model inherits from "),is=r(Zr,"A",{href:!0});var ku=d(is);Ic=s(ku,"PreTrainedModel"),ku.forEach(t),Gc=s(Zr,`. See the superclass documentation for the generic methods the library
