...
Dimensionality of the projection before token mean-pooling for classification.`,name:"classifier_proj_size"}],source:"https://github.com/huggingface/transformers/blob/pr_16932/src/transformers/models/sew_d/configuration_sew_d.py#L32"}}),_e=new ft({props:{code:`from transformers import SEWDModel, SEWDConfig
