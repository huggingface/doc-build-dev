import{S as lf,i as df,s as cf,e as a,k as h,w as k,t as n,M as pf,c as r,d as t,m as u,a as i,x as b,h as s,b as f,G as e,g,y as w,q as $,o as P,B as F,v as hf,L as Ee}from"../../chunks/vendor-hf-doc-builder.js";import{T as Qe}from"../../chunks/Tip-hf-doc-builder.js";import{D as ae}from"../../chunks/Docstring-hf-doc-builder.js";import{C as pe}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as He}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Je}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function uf(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJModel, GPTJConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function mf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function ff(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPT2Tokenizer, GPTJModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function gf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function _f(j){let d,T,c,p,y;return p=new pe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Tf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function yf(j){let d,T,c,p,y;return p=new pe({props:{code:`import torch
...
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=a("p"),T=n("Example of single-label classification:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example of single-label classification:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function vf(j){let d,T;return d=new pe({props:{code:'# To train a model on `num_labels` classes, you can pass `num_labels=num_labels` to `.from_pretrained(...)`\nnum_labels = len(model.config.id2label)\nmodel = GPTJForSequenceClassification.from_pretrained("ydshieh/tiny-random-gptj-for-sequence-classification", num_labels=num_labels)\n\nlabels = torch.tensor(1)\nloss = model(**inputs, labels=labels).loss\nround(loss.item(), 2)',highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`</span>
...
<span class="hljs-number">0.76</span>`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function kf(j){let d,T,c,p,y;return p=new pe({props:{code:`import torch
from transformers import GPT2Tokenizer, GPTJForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=a("p"),T=n("Example of multi-label classification:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example of multi-label classification:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function bf(j){let d,T;return d=new pe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function wf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function $f(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPT2Tokenizer, GPTJForQuestionAnswering
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.13</span>`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Ff(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
...
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
tensors in the first argument of the model call function: `),W=r(C,"CODE",{});var Le=i(W);me=s(Le,"model(inputs)"),Le.forEach(t),re=s(C,"."),C.forEach(t),I=u(v),L=r(v,"P",{});var Me=i(L);ee=s(Me,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Me.forEach(t),te=u(v),E=r(v,"UL",{});var A=i(E);M=r(A,"LI",{});var B=i(M);fe=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var ce=i(Q);ie=s(ce,"input_ids"),ce.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Pe=i(H);oe=s(Pe,"model(inputs_ids)"),Pe.forEach(t),B.forEach(t),ge=u(A),q=r(A,"LI",{});var S=i(q);le=s(S,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(S,"CODE",{});var Ie=i(N);_e=s(Ie,"model([input_ids, attention_mask])"),Ie.forEach(t),de=s(S," or "),O=r(S,"CODE",{});var ve=i(O);U=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),S.forEach(t),Te=u(A),z=r(A,"LI",{});var ke=i(z);ye=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(v,x){g(v,d,x),e(d,T),g(v,c,x),g(v,p,x),e(p,y),e(y,l),e(p,m),e(p,G),e(G,he),g(v,K,x),g(v,J,x),e(J,X),e(J,D),e(D,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(v,I,x),g(v,L,x),e(L,ee),g(v,te,x),g(v,E,x),e(E,M),e(M,fe),e(M,Q),e(Q,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,O),e(O,U),e(E,Te),e(E,z),e(z,ye),e(z,R),e(R,ne)},d(v){v&&t(d),v&&t(c),v&&t(p),v&&t(K),v&&t(J),v&&t(I),v&&t(L),v&&t(te),v&&t(E)}}}function jf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Gf(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, TFGPTJModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function xf(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Ef(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, TFGPTJForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Mf(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
first positional argument :`),Me.forEach(t),te=u(v),E=r(v,"UL",{});var A=i(E);M=r(A,"LI",{});var B=i(M);fe=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var ce=i(Q);ie=s(ce,"input_ids"),ce.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Pe=i(H);oe=s(Pe,"model(inputs_ids)"),Pe.forEach(t),B.forEach(t),ge=u(A),q=r(A,"LI",{});var S=i(q);le=s(S,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(S,"CODE",{});var Ie=i(N);_e=s(Ie,"model([input_ids, attention_mask])"),Ie.forEach(t),de=s(S," or "),O=r(S,"CODE",{});var ve=i(O);U=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),S.forEach(t),Te=u(A),z=r(A,"LI",{});var ke=i(z);ye=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(v,x){g(v,d,x),e(d,T),g(v,c,x),g(v,p,x),e(p,y),e(y,l),e(p,m),e(p,G),e(G,he),g(v,K,x),g(v,J,x),e(J,X),e(J,D),e(D,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(v,I,x),g(v,L,x),e(L,ee),g(v,te,x),g(v,E,x),e(E,M),e(M,fe),e(M,Q),e(Q,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,O),e(O,U),e(E,Te),e(E,z),e(z,ye),e(z,R),e(R,ne)},d(v){v&&t(d),v&&t(c),v&&t(p),v&&t(K),v&&t(J),v&&t(I),v&&t(L),v&&t(te),v&&t(E)}}}function qf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function zf(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, TFGPTJForSequenceClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Cf(j){let d,T;return d=new pe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
first positional argument :`),Me.forEach(t),te=u(v),E=r(v,"UL",{});var A=i(E);M=r(A,"LI",{});var B=i(M);fe=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var ce=i(Q);ie=s(ce,"input_ids"),ce.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Pe=i(H);oe=s(Pe,"model(inputs_ids)"),Pe.forEach(t),B.forEach(t),ge=u(A),q=r(A,"LI",{});var S=i(q);le=s(S,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(S,"CODE",{});var Ie=i(N);_e=s(Ie,"model([input_ids, attention_mask])"),Ie.forEach(t),de=s(S," or "),O=r(S,"CODE",{});var ve=i(O);U=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),S.forEach(t),Te=u(A),z=r(A,"LI",{});var ke=i(z);ye=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(v,x){g(v,d,x),e(d,T),g(v,c,x),g(v,p,x),e(p,y),e(y,l),e(p,m),e(p,G),e(G,he),g(v,K,x),g(v,J,x),e(J,X),e(J,D),e(D,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(v,I,x),g(v,L,x),e(L,ee),g(v,te,x),g(v,E,x),e(E,M),e(M,fe),e(M,Q),e(Q,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,O),e(O,U),e(E,Te),e(E,z),e(z,ye),e(z,R),e(R,ne)},d(v){v&&t(d),v&&t(c),v&&t(p),v&&t(K),v&&t(J),v&&t(I),v&&t(L),v&&t(te),v&&t(E)}}}function Lf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function If(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, TFGPTJForQuestionAnswering
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predict_answer_tokens = inputs.input_ids[<span class="hljs-number">0</span>, answer_start_index : answer_end_index + <span class="hljs-number">1</span>]
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predict_answer_tokens)
`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Nf(j){let d,T;return d=new pe({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Of(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Sf(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, FlaxGPTJModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Df(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Wf(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, FlaxGPTJForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Uf(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne,v,x,V,ze,Ce,C,Ae,Le,Me,A,B,ce,Pe,S,Ie,ve,ke,Ne,ta,ct,Ni,Ro,Oi,Si,oa,Di,Wi,na,Ui,Bi,Lr,bt,Ht,sa,Vo,Qi,aa,Hi,Ir,Rt,Ri,_s,Vi,Ki,Nr,Ko,Or,Ts,Xi,Sr,Xo,Dr,wt,Vt,ra,Yo,Yi,ia,Zi,Wr,pt,Zo,el,Re,tl,ys,ol,nl,en,sl,al,vs,rl,il,ks,ll,dl,cl,Kt,Ur,$t,Xt,la,tn,pl,da,hl,Br,ht,on,ul,nn,ml,sn,fl,gl,_l,et,an,Tl,Pt,yl,bs,vl,kl,ca,bl,wl,$l,Yt,Pl,Zt,Qr,Ft,eo,pa,rn,Fl,ha,jl,Hr,Ve,ln,Gl,ua,xl,Jl,dn,El,cn,Ml,ql,zl,tt,pn,Cl,jt,Al,ws,Ll,Il,ma,Nl,Ol,Sl,to,Dl,oo,Rr,Gt,no,fa,hn,Wl,ga,Ul,Vr,Fe,un,Bl,_a,Ql,Hl,$s,Ps,Rl,Vl,Kl,Ke,Xl,Ta,Yl,Zl,ya,ed,td,va,od,nd,ka,sd,ad,rd,mn,id,fn,ld,dd,cd,$e,gn,pd,xt,hd,Fs,ud,md,ba,fd,gd,_d,so,Td,ao,yd,ro,vd,io,kd,lo,Kr,Jt,co,wa,_n,bd,$a,wd,Xr,Xe,Tn,$d,Et,Pd,Pa,Fd,jd,Fa,Gd,xd,Jd,yn,Ed,vn,Md,qd,zd,Oe,kn,Cd,Mt,Ad,js,Ld,Id,ja,Nd,Od,Sd,po,Dd,ho,Wd,uo,Yr,qt,mo,Ga,bn,Ud,xa,Bd,Zr,je,wn,Qd,Ja,Hd,Rd,$n,Vd,Gs,Kd,Xd,Yd,Pn,Zd,Fn,ec,tc,oc,fo,nc,ot,jn,sc,zt,ac,xs,rc,ic,Ea,lc,dc,cc,go,pc,_o,ei,Ct,To,Ma,Gn,hc,qa,uc,ti,Ge,xn,mc,za,fc,gc,Jn,_c,Js,Tc,yc,vc,En,kc,Mn,bc,wc,$c,yo,Pc,nt,qn,Fc,At,jc,Es,Gc,xc,Ca,Jc,Ec,Mc,vo,qc,ko,oi,Lt,bo,Aa,zn,zc,La,Cc,ni,se,Cn,Ac,Ia,Lc,Ic,Ms,qs,Nc,Oc,Sc,Ye,Dc,Na,Wc,Uc,Oa,Bc,Qc,Sa,Hc,Rc,Da,Vc,Kc,Xc,An,Yc,zs,Zc,ep,tp,Ln,op,In,np,sp,ap,wo,rp,Se,Nn,ip,It,lp,Cs,dp,cp,Wa,pp,hp,up,$o,mp,Po,fp,Fo,si,Nt,jo,Ua,On,gp,Ba,_p,ai,xe,Sn,Tp,Ot,yp,Qa,vp,kp,Ha,bp,wp,$p,Dn,Pp,As,Fp,jp,Gp,Wn,xp,Un,Jp,Ep,Mp,Go,qp,De,Bn,zp,St,Cp,Ls,Ap,Lp,Ra,Ip,Np,Op,xo,Sp,Jo,Dp,Eo,ri,Dt,Mo,Va,Qn,Wp,Ka,Up,ii,be,Hn,Bp,Xa,Qp,Hp,Rn,Rp,Is,Vp,Kp,Xp,Vn,Yp,Kn,Zp,eh,th,Ya,oh,nh,ut,Za,Xn,sh,ah,er,Yn,rh,ih,tr,Zn,lh,dh,or,es,ch,ph,st,ts,hh,Wt,uh,nr,mh,fh,sr,gh,_h,Th,qo,yh,zo,li,Ut,Co,ar,os,vh,rr,kh,di,we,ns,bh,ir,wh,$h,ss,Ph,Ns,Fh,jh,Gh,as,xh,rs,Jh,Eh,Mh,lr,qh,zh,mt,dr,is,Ch,Ah,cr,ls,Lh,Ih,pr,ds,Nh,Oh,hr,cs,Sh,Dh,at,ps,Wh,Bt,Uh,ur,Bh,Qh,mr,Hh,Rh,Vh,Ao,Kh,Lo,ci;return l=new He({}),Z=new He({}),A=new pe({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJModel">GPTJModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTJConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 2048) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17755/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_gptj.py#L537",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17755/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_gptj.py#L791",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17755/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_gptj.py#L913",returnDescription:`
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_gptj.py#L1040",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_17755/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_17755/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_tf_gptj.py#L653",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17755/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_tf_gptj.py#L760",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17755/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_tf_gptj.py#L864",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17755/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
`}}),$o=new Qe({props:{$$slots:{default:[qf]},$$scope:{ctx:j}}}),Po=new Je({props:{anchor:"transformers.TFGPTJForSequenceClassification.call.example",$$slots:{default:[zf]},$$scope:{ctx:j}}}),Fo=new Je({props:{anchor:"transformers.TFGPTJForSequenceClassification.call.example-2",$$slots:{default:[Cf]},$$scope:{ctx:j}}}),On=new He({}),Sn=new ae({props:{name:"class transformers.TFGPTJForQuestionAnswering",anchor:"transformers.TFGPTJForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFGPTJForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17755/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_tf_gptj.py#L976"}}),Go=new Qe({props:{$$slots:{default:[Af]},$$scope:{ctx:j}}}),Bn=new ae({props:{name:"call",anchor:"transformers.TFGPTJForQuestionAnswering.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"start_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"end_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFGPTJForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_17755/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_tf_gptj.py#L987",returnDescription:`
<p>A <a
...
<p>A <a
  href="/docs/transformers/pr_17755/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
<p><a
  href="/docs/transformers/pr_17755/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
>transformers.modeling_flax_outputs.FlaxMaskedLMOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Ao=new Qe({props:{$$slots:{default:[Df]},$$scope:{ctx:j}}}),Lo=new Je({props:{anchor:"transformers.FlaxGPTJForCausalLM.__call__.example",$$slots:{default:[Wf]},$$scope:{ctx:j}}}),{c(){d=a("meta"),T=h(),c=a("h1"),p=a("a"),y=a("span"),k(l.$$.fragment),m=h(),G=a("span"),he=n("GPT-J"),K=h(),J=a("h2"),X=a("a"),D=a("span"),k(Z.$$.fragment),ue=h(),W=a("span"),me=n("Overview"),re=h(),I=a("p"),L=n("The GPT-J model was released in the "),ee=a("a"),te=n("kingoflolz/mesh-transformer-jax"),E=n(` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),M=a("a"),fe=n("the Pile"),Q=n(" dataset."),ie=h(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),ge=n("Stella Biderman"),q=n("."),le=h(),N=a("p"),_e=n("Tips:"),de=h(),O=a("ul"),U=a("li"),Te=n("To load "),z=a("a"),ye=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
RAM to just load the model. To reduce the CPU RAM usage there are a few options. The `),ne=a("code"),v=n("torch_dtype"),x=n(` argument can be
used to initialize the model in half-precision. And the `),V=a("code"),ze=n("low_cpu_mem_usage"),Ce=n(` argument can be used to keep the RAM
usage to 1x. There is also a `),C=a("a"),Ae=n("fp16 branch"),Le=n(` which stores
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),Me=h(),k(A.$$.fragment),B=h(),ce=a("ul"),Pe=a("li"),S=a("p"),Ie=n(`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
optimizer for example makes four copies of the model: model, gradients, average and squared average of the gradients.
So it would need at least 4x model size GPU memory, even with mixed precision as gradient updates are in fp32. This
is not including the activations and data batches, which would again require some more GPU RAM. So one should explore
solutions such as DeepSpeed, to train/fine-tune the model. Another option is to use the original codebase to
train/fine-tune the model on TPU and then convert the model to Transformers format for inference. Instructions for
that could be found `),ve=a("a"),ke=n("here"),Ne=h(),ta=a("li"),ct=a("p"),Ni=n(`Although the embedding matrix has a size of 50400, only 50257 entries are used by the GPT-2 tokenizer. These extra
...
`),oa=a("code"),Di=n("<|extratoken_1|>... <|extratoken_143|>"),Wi=n(", so the "),na=a("code"),Ui=n("vocab_size"),Bi=n(" of tokenizer also becomes 50400."),Lr=h(),bt=a("h3"),Ht=a("a"),sa=a("span"),k(Vo.$$.fragment),Qi=h(),aa=a("span"),Hi=n("Generation"),Ir=h(),Rt=a("p"),Ri=n("The "),_s=a("a"),Vi=n("generate()"),Ki=n(` method can be used to generate text using GPT-J
model.`),Nr=h(),k(Ko.$$.fragment),Or=h(),Ts=a("p"),Xi=n("\u2026or in float16 precision:"),Sr=h(),k(Xo.$$.fragment),Dr=h(),wt=a("h2"),Vt=a("a"),ra=a("span"),k(Yo.$$.fragment),Yi=h(),ia=a("span"),Zi=n("GPTJConfig"),Wr=h(),pt=a("div"),k(Zo.$$.fragment),el=h(),Re=a("p"),tl=n("This is the configuration class to store the configuration of a "),ys=a("a"),ol=n("GPTJModel"),nl=n(`. It is used to instantiate a GPT-J
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the GPT-J
`),en=a("a"),sl=n("EleutherAI/gpt-j-6B"),al=n(` architecture. Configuration objects inherit from
`),vs=a("a"),rl=n("PretrainedConfig"),il=n(" and can be used to control the model outputs. Read the documentation from "),ks=a("a"),ll=n("PretrainedConfig"),dl=n(`
...
behavior.`),_l=h(),et=a("div"),k(an.$$.fragment),Tl=h(),Pt=a("p"),yl=n("The "),bs=a("a"),vl=n("GPTJModel"),kl=n(" forward method, overrides the "),ca=a("code"),bl=n("__call__"),wl=n(" special method."),$l=h(),k(Yt.$$.fragment),Pl=h(),k(Zt.$$.fragment),Qr=h(),Ft=a("h2"),eo=a("a"),pa=a("span"),k(rn.$$.fragment),Fl=h(),ha=a("span"),jl=n("GPTJForCausalLM"),Hr=h(),Ve=a("div"),k(ln.$$.fragment),Gl=h(),ua=a("p"),xl=n("The GPT-J Model transformer with a language modeling head on top."),Jl=h(),dn=a("p"),El=n("This model is a PyTorch "),cn=a("a"),Ml=n("torch.nn.Module"),ql=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zl=h(),tt=a("div"),k(pn.$$.fragment),Cl=h(),jt=a("p"),Al=n("The "),ws=a("a"),Ll=n("GPTJForCausalLM"),Il=n(" forward method, overrides the "),ma=a("code"),Nl=n("__call__"),Ol=n(" special method."),Sl=h(),k(to.$$.fragment),Dl=h(),k(oo.$$.fragment),Rr=h(),Gt=a("h2"),no=a("a"),fa=a("span"),k(hn.$$.fragment),Wl=h(),ga=a("span"),Ul=n("GPTJForSequenceClassification"),Vr=h(),Fe=a("div"),k(un.$$.fragment),Bl=h(),_a=a("p"),Ql=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Hl=h(),$s=a("p"),Ps=a("a"),Rl=n("GPTJForSequenceClassification"),Vl=n(` uses the last token in order to do the classification, as other causal models
...
no `),ya=a("code"),ed=n("pad_token_id"),td=n(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),va=a("code"),od=n("inputs_embeds"),nd=n(" are passed instead of "),ka=a("code"),sd=n("input_ids"),ad=n(`, it does the same (take the last value in
each row of the batch).`),rd=h(),mn=a("p"),id=n("This model is a PyTorch "),fn=a("a"),ld=n("torch.nn.Module"),dd=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),cd=h(),$e=a("div"),k(gn.$$.fragment),pd=h(),xt=a("p"),hd=n("The "),Fs=a("a"),ud=n("GPTJForSequenceClassification"),md=n(" forward method, overrides the "),ba=a("code"),fd=n("__call__"),gd=n(" special method."),_d=h(),k(so.$$.fragment),Td=h(),k(ao.$$.fragment),yd=h(),k(ro.$$.fragment),vd=h(),k(io.$$.fragment),kd=h(),k(lo.$$.fragment),Kr=h(),Jt=a("h2"),co=a("a"),wa=a("span"),k(_n.$$.fragment),bd=h(),$a=a("span"),wd=n("GPTJForQuestionAnswering"),Xr=h(),Xe=a("div"),k(Tn.$$.fragment),$d=h(),Et=a("p"),Pd=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Pa=a("code"),Fd=n("span start logits"),jd=n(" and "),Fa=a("code"),Gd=n("span end logits"),xd=n(")."),Jd=h(),yn=a("p"),Ed=n("This model is a PyTorch "),vn=a("a"),Md=n("torch.nn.Module"),qd=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zd=h(),Oe=a("div"),k(kn.$$.fragment),Cd=h(),Mt=a("p"),Ad=n("The "),js=a("a"),Ld=n("GPTJForQuestionAnswering"),Id=n(" forward method, overrides the "),ja=a("code"),Nd=n("__call__"),Od=n(" special method."),Sd=h(),k(po.$$.fragment),Dd=h(),k(ho.$$.fragment),Wd=h(),k(uo.$$.fragment),Yr=h(),qt=a("h2"),mo=a("a"),Ga=a("span"),k(bn.$$.fragment),Ud=h(),xa=a("span"),Bd=n("TFGPTJModel"),Zr=h(),je=a("div"),k(wn.$$.fragment),Qd=h(),Ja=a("p"),Hd=n("The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Rd=h(),$n=a("p"),Vd=n("This model inherits from "),Gs=a("a"),Kd=n("TFPreTrainedModel"),Xd=n(`. Check the superclass documentation for the generic methods the
...
behavior.`),oc=h(),k(fo.$$.fragment),nc=h(),ot=a("div"),k(jn.$$.fragment),sc=h(),zt=a("p"),ac=n("The "),xs=a("a"),rc=n("TFGPTJModel"),ic=n(" forward method, overrides the "),Ea=a("code"),lc=n("__call__"),dc=n(" special method."),cc=h(),k(go.$$.fragment),pc=h(),k(_o.$$.fragment),ei=h(),Ct=a("h2"),To=a("a"),Ma=a("span"),k(Gn.$$.fragment),hc=h(),qa=a("span"),uc=n("TFGPTJForCausalLM"),ti=h(),Ge=a("div"),k(xn.$$.fragment),mc=h(),za=a("p"),fc=n("The GPT-J Model transformer with a language modeling head on top."),gc=h(),Jn=a("p"),_c=n("This model inherits from "),Js=a("a"),Tc=n("TFPreTrainedModel"),yc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vc=h(),En=a("p"),kc=n("This model is also a "),Mn=a("a"),bc=n("tf.keras.Model"),wc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$c=h(),k(yo.$$.fragment),Pc=h(),nt=a("div"),k(qn.$$.fragment),Fc=h(),At=a("p"),jc=n("The "),Es=a("a"),Gc=n("TFGPTJForCausalLM"),xc=n(" forward method, overrides the "),Ca=a("code"),Jc=n("__call__"),Ec=n(" special method."),Mc=h(),k(vo.$$.fragment),qc=h(),k(ko.$$.fragment),oi=h(),Lt=a("h2"),bo=a("a"),Aa=a("span"),k(zn.$$.fragment),zc=h(),La=a("span"),Cc=n("TFGPTJForSequenceClassification"),ni=h(),se=a("div"),k(Cn.$$.fragment),Ac=h(),Ia=a("p"),Lc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Ic=h(),Ms=a("p"),qs=a("a"),Nc=n("GPTJForSequenceClassification"),Oc=n(` uses the last token in order to do the classification, as other causal models
...
no `),Oa=a("code"),Bc=n("pad_token_id"),Qc=n(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
each row of the batch).`),Xc=h(),An=a("p"),Yc=n("This model inherits from "),zs=a("a"),Zc=n("TFPreTrainedModel"),ep=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tp=h(),Ln=a("p"),op=n("This model is also a "),In=a("a"),np=n("tf.keras.Model"),sp=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),k(wo.$$.fragment),rp=h(),Se=a("div"),k(Nn.$$.fragment),ip=h(),It=a("p"),lp=n("The "),Cs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Wa=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),k($o.$$.fragment),mp=h(),k(Po.$$.fragment),fp=h(),k(Fo.$$.fragment),si=h(),Nt=a("h2"),jo=a("a"),Ua=a("span"),k(On.$$.fragment),gp=h(),Ba=a("span"),_p=n("TFGPTJForQuestionAnswering"),ai=h(),xe=a("div"),k(Sn.$$.fragment),Tp=h(),Ot=a("p"),yp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Qa=a("code"),vp=n("span start logits"),kp=n(" and "),Ha=a("code"),bp=n("span end logits"),wp=n(")."),$p=h(),Dn=a("p"),Pp=n("This model inherits from "),As=a("a"),Fp=n("TFPreTrainedModel"),jp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gp=h(),Wn=a("p"),xp=n("This model is also a "),Un=a("a"),Jp=n("tf.keras.Model"),Ep=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mp=h(),k(Go.$$.fragment),qp=h(),De=a("div"),k(Bn.$$.fragment),zp=h(),St=a("p"),Cp=n("The "),Ls=a("a"),Ap=n("TFGPTJForQuestionAnswering"),Lp=n(" forward method, overrides the "),Ra=a("code"),Ip=n("__call__"),Np=n(" special method."),Op=h(),k(xo.$$.fragment),Sp=h(),k(Jo.$$.fragment),Dp=h(),k(Eo.$$.fragment),ri=h(),Dt=a("h2"),Mo=a("a"),Va=a("span"),k(Qn.$$.fragment),Wp=h(),Ka=a("span"),Up=n("FlaxGPTJModel"),ii=h(),be=a("div"),k(Hn.$$.fragment),Bp=h(),Xa=a("p"),Qp=n("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),Hp=h(),Rn=a("p"),Rp=n("This model inherits from "),Is=a("a"),Vp=n("FlaxPreTrainedModel"),Kp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xp=h(),Vn=a("p"),Yp=n(`This model is also a Flax Linen
`),Kn=a("a"),Zp=n("flax.nn.Module"),eh=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),th=h(),Ya=a("p"),oh=n("Finally, this model supports inherent JAX features such as:"),nh=h(),ut=a("ul"),Za=a("li"),Xn=a("a"),sh=n("Just-In-Time (JIT) compilation"),ah=h(),er=a("li"),Yn=a("a"),rh=n("Automatic Differentiation"),ih=h(),tr=a("li"),Zn=a("a"),lh=n("Vectorization"),dh=h(),or=a("li"),es=a("a"),ch=n("Parallelization"),ph=h(),st=a("div"),k(ts.$$.fragment),hh=h(),Wt=a("p"),uh=n("The "),nr=a("code"),mh=n("FlaxGPTJPreTrainedModel"),fh=n(" forward method, overrides the "),sr=a("code"),gh=n("__call__"),_h=n(" special method."),Th=h(),k(qo.$$.fragment),yh=h(),k(zo.$$.fragment),li=h(),Ut=a("h2"),Co=a("a"),ar=a("span"),k(os.$$.fragment),vh=h(),rr=a("span"),kh=n("FlaxGPTJForCausalLM"),di=h(),we=a("div"),k(ns.$$.fragment),bh=h(),ir=a("p"),wh=n("The GPTJ Model transformer with a language modeling head on top."),$h=h(),ss=a("p"),Ph=n("This model inherits from "),Ns=a("a"),Fh=n("FlaxPreTrainedModel"),jh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh=h(),as=a("p"),xh=n(`This model is also a Flax Linen
`),rs=a("a"),Jh=n("flax.nn.Module"),Eh=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mh=h(),lr=a("p"),qh=n("Finally, this model supports inherent JAX features such as:"),zh=h(),mt=a("ul"),dr=a("li"),is=a("a"),Ch=n("Just-In-Time (JIT) compilation"),Ah=h(),cr=a("li"),ls=a("a"),Lh=n("Automatic Differentiation"),Ih=h(),pr=a("li"),ds=a("a"),Nh=n("Vectorization"),Oh=h(),hr=a("li"),cs=a("a"),Sh=n("Parallelization"),Dh=h(),at=a("div"),k(ps.$$.fragment),Wh=h(),Bt=a("p"),Uh=n("The "),ur=a("code"),Bh=n("FlaxGPTJPreTrainedModel"),Qh=n(" forward method, overrides the "),mr=a("code"),Hh=n("__call__"),Rh=n(" special method."),Vh=h(),k(Ao.$$.fragment),Kh=h(),k(Lo.$$.fragment),this.h()},l(o){const _=pf('[data-svelte="svelte-1phssyn"]',document.head);d=r(_,"META",{name:!0,content:!0}),_.forEach(t),T=u(o),c=r(o,"H1",{class:!0});var hs=i(c);p=r(hs,"A",{id:!0,class:!0,href:!0});var fr=i(p);y=r(fr,"SPAN",{});var gr=i(y);b(l.$$.fragment,gr),gr.forEach(t),fr.forEach(t),m=u(hs),G=r(hs,"SPAN",{});var _r=i(G);he=s(_r,"GPT-J"),_r.forEach(t),hs.forEach(t),K=u(o),J=r(o,"H2",{class:!0});var us=i(J);X=r(us,"A",{id:!0,class:!0,href:!0});var Tr=i(X);D=r(Tr,"SPAN",{});var yr=i(D);b(Z.$$.fragment,yr),yr.forEach(t),Tr.forEach(t),ue=u(us),W=r(us,"SPAN",{});var vr=i(W);me=s(vr,"Overview"),vr.forEach(t),us.forEach(t),re=u(o),I=r(o,"P",{});var Qt=i(I);L=s(Qt,"The GPT-J model was released in the "),ee=r(Qt,"A",{href:!0,rel:!0});var kr=i(ee);te=s(kr,"kingoflolz/mesh-transformer-jax"),kr.forEach(t),E=s(Qt,` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),M=r(Qt,"A",{href:!0,rel:!0});var br=i(M);fe=s(br,"the Pile"),br.forEach(t),Q=s(Qt," dataset."),Qt.forEach(t),ie=u(o),Y=r(o,"P",{});var ms=i(Y);H=s(ms,"This model was contributed by "),oe=r(ms,"A",{href:!0,rel:!0});var wr=i(oe);ge=s(wr,"Stella Biderman"),wr.forEach(t),q=s(ms,"."),ms.forEach(t),le=u(o),N=r(o,"P",{});var $r=i(N);_e=s($r,"Tips:"),$r.forEach(t),de=u(o),O=r(o,"UL",{});var Pr=i(O);U=r(Pr,"LI",{});var Ze=i(U);Te=s(Ze,"To load "),z=r(Ze,"A",{href:!0,rel:!0});var Fr=i(z);ye=s(Fr,"GPT-J"),Fr.forEach(t),R=s(Ze,` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
RAM to just load the model. To reduce the CPU RAM usage there are a few options. The `),ne=r(Ze,"CODE",{});var jr=i(ne);v=s(jr,"torch_dtype"),jr.forEach(t),x=s(Ze,` argument can be
used to initialize the model in half-precision. And the `),V=r(Ze,"CODE",{});var Gr=i(V);ze=s(Gr,"low_cpu_mem_usage"),Gr.forEach(t),Ce=s(Ze,` argument can be used to keep the RAM
usage to 1x. There is also a `),C=r(Ze,"A",{href:!0,rel:!0});var xr=i(C);Ae=s(xr,"fp16 branch"),xr.forEach(t),Le=s(Ze,` which stores
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),Ze.forEach(t),Pr.forEach(t),Me=u(o),b(A.$$.fragment,o),B=u(o),ce=r(o,"UL",{});var fs=i(ce);Pe=r(fs,"LI",{});var Jr=i(Pe);S=r(Jr,"P",{});var Os=i(S);Ie=s(Os,`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
optimizer for example makes four copies of the model: model, gradients, average and squared average of the gradients.
So it would need at least 4x model size GPU memory, even with mixed precision as gradient updates are in fp32. This
is not including the activations and data batches, which would again require some more GPU RAM. So one should explore
solutions such as DeepSpeed, to train/fine-tune the model. Another option is to use the original codebase to
train/fine-tune the model on TPU and then convert the model to Transformers format for inference. Instructions for
that could be found `),ve=r(Os,"A",{href:!0,rel:!0});var Er=i(ve);ke=s(Er,"here"),Er.forEach(t),Os.forEach(t),Jr.forEach(t),Ne=u(fs),ta=r(fs,"LI",{});var Mr=i(ta);ct=r(Mr,"P",{});var ft=i(ct);Ni=s(ft,`Although the embedding matrix has a size of 50400, only 50257 entries are used by the GPT-2 tokenizer. These extra
tokens are added for the sake of efficiency on TPUs. To avoid the mis-match between embedding matrix size and vocab
size, the tokenizer for `),Ro=r(ft,"A",{href:!0,rel:!0});var qr=i(Ro);Oi=s(qr,"GPT-J"),qr.forEach(t),Si=s(ft,` contains 143 extra tokens
`),oa=r(ft,"CODE",{});var zr=i(oa);Di=s(zr,"<|extratoken_1|>... <|extratoken_143|>"),zr.forEach(t),Wi=s(ft,", so the "),na=r(ft,"CODE",{});var Cr=i(na);Ui=s(Cr,"vocab_size"),Cr.forEach(t),Bi=s(ft," of tokenizer also becomes 50400."),ft.forEach(t),Mr.forEach(t),fs.forEach(t),Lr=u(o),bt=r(o,"H3",{class:!0});var gs=i(bt);Ht=r(gs,"A",{id:!0,class:!0,href:!0});var Ar=i(Ht);sa=r(Ar,"SPAN",{});var Zh=i(sa);b(Vo.$$.fragment,Zh),Zh.forEach(t),Ar.forEach(t),Qi=u(gs),aa=r(gs,"SPAN",{});var eu=i(aa);Hi=s(eu,"Generation"),eu.forEach(t),gs.forEach(t),Ir=u(o),Rt=r(o,"P",{});var pi=i(Rt);Ri=s(pi,"The "),_s=r(pi,"A",{href:!0});var tu=i(_s);Vi=s(tu,"generate()"),tu.forEach(t),Ki=s(pi,` method can be used to generate text using GPT-J
model.`),pi.forEach(t),Nr=u(o),b(Ko.$$.fragment,o),Or=u(o),Ts=r(o,"P",{});var ou=i(Ts);Xi=s(ou,"\u2026or in float16 precision:"),ou.forEach(t),Sr=u(o),b(Xo.$$.fragment,o),Dr=u(o),wt=r(o,"H2",{class:!0});var hi=i(wt);Vt=r(hi,"A",{id:!0,class:!0,href:!0});var nu=i(Vt);ra=r(nu,"SPAN",{});var su=i(ra);b(Yo.$$.fragment,su),su.forEach(t),nu.forEach(t),Yi=u(hi),ia=r(hi,"SPAN",{});var au=i(ia);Zi=s(au,"GPTJConfig"),au.forEach(t),hi.forEach(t),Wr=u(o),pt=r(o,"DIV",{class:!0});var Ss=i(pt);b(Zo.$$.fragment,Ss),el=u(Ss),Re=r(Ss,"P",{});var gt=i(Re);tl=s(gt,"This is the configuration class to store the configuration of a "),ys=r(gt,"A",{href:!0});var ru=i(ys);ol=s(ru,"GPTJModel"),ru.forEach(t),nl=s(gt,`. It is used to instantiate a GPT-J
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the GPT-J
...
`),vs=r(gt,"A",{href:!0});var lu=i(vs);rl=s(lu,"PretrainedConfig"),lu.forEach(t),il=s(gt," and can be used to control the model outputs. Read the documentation from "),ks=r(gt,"A",{href:!0});var du=i(ks);ll=s(du,"PretrainedConfig"),du.forEach(t),dl=s(gt,`
for more information.`),gt.forEach(t),cl=u(Ss),b(Kt.$$.fragment,Ss),Ss.forEach(t),Ur=u(o),$t=r(o,"H2",{class:!0});var ui=i($t);Xt=r(ui,"A",{id:!0,class:!0,href:!0});var cu=i(Xt);la=r(cu,"SPAN",{});var pu=i(la);b(tn.$$.fragment,pu),pu.forEach(t),cu.forEach(t),pl=u(ui),da=r(ui,"SPAN",{});var hu=i(da);hl=s(hu,"GPTJModel"),hu.forEach(t),ui.forEach(t),Br=u(o),ht=r(o,"DIV",{class:!0});var Ds=i(ht);b(on.$$.fragment,Ds),ul=u(Ds),nn=r(Ds,"P",{});var mi=i(nn);ml=s(mi,`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),sn=r(mi,"A",{href:!0,rel:!0});var uu=i(sn);fl=s(uu,"torch.nn.Module"),uu.forEach(t),gl=s(mi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),mi.forEach(t),_l=u(Ds),et=r(Ds,"DIV",{class:!0});var Io=i(et);b(an.$$.fragment,Io),Tl=u(Io),Pt=r(Io,"P",{});var Ws=i(Pt);yl=s(Ws,"The "),bs=r(Ws,"A",{href:!0});var mu=i(bs);vl=s(mu,"GPTJModel"),mu.forEach(t),kl=s(Ws," forward method, overrides the "),ca=r(Ws,"CODE",{});var fu=i(ca);bl=s(fu,"__call__"),fu.forEach(t),wl=s(Ws," special method."),Ws.forEach(t),$l=u(Io),b(Yt.$$.fragment,Io),Pl=u(Io),b(Zt.$$.fragment,Io),Io.forEach(t),Ds.forEach(t),Qr=u(o),Ft=r(o,"H2",{class:!0});var fi=i(Ft);eo=r(fi,"A",{id:!0,class:!0,href:!0});var gu=i(eo);pa=r(gu,"SPAN",{});var _u=i(pa);b(rn.$$.fragment,_u),_u.forEach(t),gu.forEach(t),Fl=u(fi),ha=r(fi,"SPAN",{});var Tu=i(ha);jl=s(Tu,"GPTJForCausalLM"),Tu.forEach(t),fi.forEach(t),Hr=u(o),Ve=r(o,"DIV",{class:!0});var No=i(Ve);b(ln.$$.fragment,No),Gl=u(No),ua=r(No,"P",{});var yu=i(ua);xl=s(yu,"The GPT-J Model transformer with a language modeling head on top."),yu.forEach(t),Jl=u(No),dn=r(No,"P",{});var gi=i(dn);El=s(gi,"This model is a PyTorch "),cn=r(gi,"A",{href:!0,rel:!0});var vu=i(cn);Ml=s(vu,"torch.nn.Module"),vu.forEach(t),ql=s(gi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),gi.forEach(t),zl=u(No),tt=r(No,"DIV",{class:!0});var Oo=i(tt);b(pn.$$.fragment,Oo),Cl=u(Oo),jt=r(Oo,"P",{});var Us=i(jt);Al=s(Us,"The "),ws=r(Us,"A",{href:!0});var ku=i(ws);Ll=s(ku,"GPTJForCausalLM"),ku.forEach(t),Il=s(Us," forward method, overrides the "),ma=r(Us,"CODE",{});var bu=i(ma);Nl=s(bu,"__call__"),bu.forEach(t),Ol=s(Us," special method."),Us.forEach(t),Sl=u(Oo),b(to.$$.fragment,Oo),Dl=u(Oo),b(oo.$$.fragment,Oo),Oo.forEach(t),No.forEach(t),Rr=u(o),Gt=r(o,"H2",{class:!0});var _i=i(Gt);no=r(_i,"A",{id:!0,class:!0,href:!0});var wu=i(no);fa=r(wu,"SPAN",{});var $u=i(fa);b(hn.$$.fragment,$u),$u.forEach(t),wu.forEach(t),Wl=u(_i),ga=r(_i,"SPAN",{});var Pu=i(ga);Ul=s(Pu,"GPTJForSequenceClassification"),Pu.forEach(t),_i.forEach(t),Vr=u(o),Fe=r(o,"DIV",{class:!0});var rt=i(Fe);b(un.$$.fragment,rt),Bl=u(rt),_a=r(rt,"P",{});var Fu=i(_a);Ql=s(Fu,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Fu.forEach(t),Hl=u(rt),$s=r(rt,"P",{});var Xh=i($s);Ps=r(Xh,"A",{href:!0});var ju=i(Ps);Rl=s(ju,"GPTJForSequenceClassification"),ju.forEach(t),Vl=s(Xh,` uses the last token in order to do the classification, as other causal models
...
no `),ya=r(_t,"CODE",{});var xu=i(ya);ed=s(xu,"pad_token_id"),xu.forEach(t),td=s(_t,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),va=r(_t,"CODE",{});var Ju=i(va);od=s(Ju,"inputs_embeds"),Ju.forEach(t),nd=s(_t," are passed instead of "),ka=r(_t,"CODE",{});var Eu=i(ka);sd=s(Eu,"input_ids"),Eu.forEach(t),ad=s(_t,`, it does the same (take the last value in
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ti.forEach(t),cd=u(rt),$e=r(rt,"DIV",{class:!0});var We=i($e);b(gn.$$.fragment,We),pd=u(We),xt=r(We,"P",{});var Bs=i(xt);hd=s(Bs,"The "),Fs=r(Bs,"A",{href:!0});var qu=i(Fs);ud=s(qu,"GPTJForSequenceClassification"),qu.forEach(t),md=s(Bs," forward method, overrides the "),ba=r(Bs,"CODE",{});var zu=i(ba);fd=s(zu,"__call__"),zu.forEach(t),gd=s(Bs," special method."),Bs.forEach(t),_d=u(We),b(so.$$.fragment,We),Td=u(We),b(ao.$$.fragment,We),yd=u(We),b(ro.$$.fragment,We),vd=u(We),b(io.$$.fragment,We),kd=u(We),b(lo.$$.fragment,We),We.forEach(t),rt.forEach(t),Kr=u(o),Jt=r(o,"H2",{class:!0});var yi=i(Jt);co=r(yi,"A",{id:!0,class:!0,href:!0});var Cu=i(co);wa=r(Cu,"SPAN",{});var Au=i(wa);b(_n.$$.fragment,Au),Au.forEach(t),Cu.forEach(t),bd=u(yi),$a=r(yi,"SPAN",{});var Lu=i($a);wd=s(Lu,"GPTJForQuestionAnswering"),Lu.forEach(t),yi.forEach(t),Xr=u(o),Xe=r(o,"DIV",{class:!0});var So=i(Xe);b(Tn.$$.fragment,So),$d=u(So),Et=r(So,"P",{});var Qs=i(Et);Pd=s(Qs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Pa=r(Qs,"CODE",{});var Iu=i(Pa);Fd=s(Iu,"span start logits"),Iu.forEach(t),jd=s(Qs," and "),Fa=r(Qs,"CODE",{});var Nu=i(Fa);Gd=s(Nu,"span end logits"),Nu.forEach(t),xd=s(Qs,")."),Qs.forEach(t),Jd=u(So),yn=r(So,"P",{});var vi=i(yn);Ed=s(vi,"This model is a PyTorch "),vn=r(vi,"A",{href:!0,rel:!0});var Ou=i(vn);Md=s(Ou,"torch.nn.Module"),Ou.forEach(t),qd=s(vi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vi.forEach(t),zd=u(So),Oe=r(So,"DIV",{class:!0});var Tt=i(Oe);b(kn.$$.fragment,Tt),Cd=u(Tt),Mt=r(Tt,"P",{});var Hs=i(Mt);Ad=s(Hs,"The "),js=r(Hs,"A",{href:!0});var Su=i(js);Ld=s(Su,"GPTJForQuestionAnswering"),Su.forEach(t),Id=s(Hs," forward method, overrides the "),ja=r(Hs,"CODE",{});var Du=i(ja);Nd=s(Du,"__call__"),Du.forEach(t),Od=s(Hs," special method."),Hs.forEach(t),Sd=u(Tt),b(po.$$.fragment,Tt),Dd=u(Tt),b(ho.$$.fragment,Tt),Wd=u(Tt),b(uo.$$.fragment,Tt),Tt.forEach(t),So.forEach(t),Yr=u(o),qt=r(o,"H2",{class:!0});var ki=i(qt);mo=r(ki,"A",{id:!0,class:!0,href:!0});var Wu=i(mo);Ga=r(Wu,"SPAN",{});var Uu=i(Ga);b(bn.$$.fragment,Uu),Uu.forEach(t),Wu.forEach(t),Ud=u(ki),xa=r(ki,"SPAN",{});var Bu=i(xa);Bd=s(Bu,"TFGPTJModel"),Bu.forEach(t),ki.forEach(t),Zr=u(o),je=r(o,"DIV",{class:!0});var it=i(je);b(wn.$$.fragment,it),Qd=u(it),Ja=r(it,"P",{});var Qu=i(Ja);Hd=s(Qu,"The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Qu.forEach(t),Rd=u(it),$n=r(it,"P",{});var bi=i($n);Vd=s(bi,"This model inherits from "),Gs=r(bi,"A",{href:!0});var Hu=i(Gs);Kd=s(Hu,"TFPreTrainedModel"),Hu.forEach(t),Xd=s(bi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wi.forEach(t),oc=u(it),b(fo.$$.fragment,it),nc=u(it),ot=r(it,"DIV",{class:!0});var Do=i(ot);b(jn.$$.fragment,Do),sc=u(Do),zt=r(Do,"P",{});var Rs=i(zt);ac=s(Rs,"The "),xs=r(Rs,"A",{href:!0});var Vu=i(xs);rc=s(Vu,"TFGPTJModel"),Vu.forEach(t),ic=s(Rs," forward method, overrides the "),Ea=r(Rs,"CODE",{});var Ku=i(Ea);lc=s(Ku,"__call__"),Ku.forEach(t),dc=s(Rs," special method."),Rs.forEach(t),cc=u(Do),b(go.$$.fragment,Do),pc=u(Do),b(_o.$$.fragment,Do),Do.forEach(t),it.forEach(t),ei=u(o),Ct=r(o,"H2",{class:!0});var $i=i(Ct);To=r($i,"A",{id:!0,class:!0,href:!0});var Xu=i(To);Ma=r(Xu,"SPAN",{});var Yu=i(Ma);b(Gn.$$.fragment,Yu),Yu.forEach(t),Xu.forEach(t),hc=u($i),qa=r($i,"SPAN",{});var Zu=i(qa);uc=s(Zu,"TFGPTJForCausalLM"),Zu.forEach(t),$i.forEach(t),ti=u(o),Ge=r(o,"DIV",{class:!0});var lt=i(Ge);b(xn.$$.fragment,lt),mc=u(lt),za=r(lt,"P",{});var em=i(za);fc=s(em,"The GPT-J Model transformer with a language modeling head on top."),em.forEach(t),gc=u(lt),Jn=r(lt,"P",{});var Pi=i(Jn);_c=s(Pi,"This model inherits from "),Js=r(Pi,"A",{href:!0});var tm=i(Js);Tc=s(tm,"TFPreTrainedModel"),tm.forEach(t),yc=s(Pi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pi.forEach(t),vc=u(lt),En=r(lt,"P",{});var Fi=i(En);kc=s(Fi,"This model is also a "),Mn=r(Fi,"A",{href:!0,rel:!0});var om=i(Mn);bc=s(om,"tf.keras.Model"),om.forEach(t),wc=s(Fi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),$c=u(lt),b(yo.$$.fragment,lt),Pc=u(lt),nt=r(lt,"DIV",{class:!0});var Wo=i(nt);b(qn.$$.fragment,Wo),Fc=u(Wo),At=r(Wo,"P",{});var Vs=i(At);jc=s(Vs,"The "),Es=r(Vs,"A",{href:!0});var nm=i(Es);Gc=s(nm,"TFGPTJForCausalLM"),nm.forEach(t),xc=s(Vs," forward method, overrides the "),Ca=r(Vs,"CODE",{});var sm=i(Ca);Jc=s(sm,"__call__"),sm.forEach(t),Ec=s(Vs," special method."),Vs.forEach(t),Mc=u(Wo),b(vo.$$.fragment,Wo),qc=u(Wo),b(ko.$$.fragment,Wo),Wo.forEach(t),lt.forEach(t),oi=u(o),Lt=r(o,"H2",{class:!0});var ji=i(Lt);bo=r(ji,"A",{id:!0,class:!0,href:!0});var am=i(bo);Aa=r(am,"SPAN",{});var rm=i(Aa);b(zn.$$.fragment,rm),rm.forEach(t),am.forEach(t),zc=u(ji),La=r(ji,"SPAN",{});var im=i(La);Cc=s(im,"TFGPTJForSequenceClassification"),im.forEach(t),ji.forEach(t),ni=u(o),se=r(o,"DIV",{class:!0});var qe=i(se);b(Cn.$$.fragment,qe),Ac=u(qe),Ia=r(qe,"P",{});var lm=i(Ia);Lc=s(lm,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),lm.forEach(t),Ic=u(qe),Ms=r(qe,"P",{});var Yh=i(Ms);qs=r(Yh,"A",{href:!0});var dm=i(qs);Nc=s(dm,"GPTJForSequenceClassification"),dm.forEach(t),Oc=s(Yh,` uses the last token in order to do the classification, as other causal models
(e.g. GPT, GPT-2, GPT-Neo) do.`),Yh.forEach(t),Sc=u(qe),Ye=r(qe,"P",{});var yt=i(Ye);Dc=s(yt,`Since it does classification on the last token, it requires to know the position of the last token. If a
`),Na=r(yt,"CODE",{});var cm=i(Na);Wc=s(cm,"pad_token_id"),cm.forEach(t),Uc=s(yt,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),Oa=r(yt,"CODE",{});var pm=i(Oa);Bc=s(pm,"pad_token_id"),pm.forEach(t),Qc=s(yt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Sa=r(yt,"CODE",{});var hm=i(Sa);Hc=s(hm,"inputs_embeds"),hm.forEach(t),Rc=s(yt," are passed instead of "),Da=r(yt,"CODE",{});var um=i(Da);Vc=s(um,"input_ids"),um.forEach(t),Kc=s(yt,`, it does the same (take the last value in
each row of the batch).`),yt.forEach(t),Xc=u(qe),An=r(qe,"P",{});var Gi=i(An);Yc=s(Gi,"This model inherits from "),zs=r(Gi,"A",{href:!0});var mm=i(zs);Zc=s(mm,"TFPreTrainedModel"),mm.forEach(t),ep=s(Gi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xi.forEach(t),ap=u(qe),b(wo.$$.fragment,qe),rp=u(qe),Se=r(qe,"DIV",{class:!0});var vt=i(Se);b(Nn.$$.fragment,vt),ip=u(vt),It=r(vt,"P",{});var Ks=i(It);lp=s(Ks,"The "),Cs=r(Ks,"A",{href:!0});var gm=i(Cs);dp=s(gm,"TFGPTJForSequenceClassification"),gm.forEach(t),cp=s(Ks," forward method, overrides the "),Wa=r(Ks,"CODE",{});var _m=i(Wa);pp=s(_m,"__call__"),_m.forEach(t),hp=s(Ks," special method."),Ks.forEach(t),up=u(vt),b($o.$$.fragment,vt),mp=u(vt),b(Po.$$.fragment,vt),fp=u(vt),b(Fo.$$.fragment,vt),vt.forEach(t),qe.forEach(t),si=u(o),Nt=r(o,"H2",{class:!0});var Ji=i(Nt);jo=r(Ji,"A",{id:!0,class:!0,href:!0});var Tm=i(jo);Ua=r(Tm,"SPAN",{});var ym=i(Ua);b(On.$$.fragment,ym),ym.forEach(t),Tm.forEach(t),gp=u(Ji),Ba=r(Ji,"SPAN",{});var vm=i(Ba);_p=s(vm,"TFGPTJForQuestionAnswering"),vm.forEach(t),Ji.forEach(t),ai=u(o),xe=r(o,"DIV",{class:!0});var dt=i(xe);b(Sn.$$.fragment,dt),Tp=u(dt),Ot=r(dt,"P",{});var Xs=i(Ot);yp=s(Xs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Qa=r(Xs,"CODE",{});var km=i(Qa);vp=s(km,"span start logits"),km.forEach(t),kp=s(Xs," and "),Ha=r(Xs,"CODE",{});var bm=i(Ha);bp=s(bm,"span end logits"),bm.forEach(t),wp=s(Xs,")."),Xs.forEach(t),$p=u(dt),Dn=r(dt,"P",{});var Ei=i(Dn);Pp=s(Ei,"This model inherits from "),As=r(Ei,"A",{href:!0});var wm=i(As);Fp=s(wm,"TFPreTrainedModel"),wm.forEach(t),jp=s(Ei,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mi.forEach(t),Mp=u(dt),b(Go.$$.fragment,dt),qp=u(dt),De=r(dt,"DIV",{class:!0});var kt=i(De);b(Bn.$$.fragment,kt),zp=u(kt),St=r(kt,"P",{});var Ys=i(St);Cp=s(Ys,"The "),Ls=r(Ys,"A",{href:!0});var Pm=i(Ls);Ap=s(Pm,"TFGPTJForQuestionAnswering"),Pm.forEach(t),Lp=s(Ys," forward method, overrides the "),Ra=r(Ys,"CODE",{});var Fm=i(Ra);Ip=s(Fm,"__call__"),Fm.forEach(t),Np=s(Ys," special method."),Ys.forEach(t),Op=u(kt),b(xo.$$.fragment,kt),Sp=u(kt),b(Jo.$$.fragment,kt),Dp=u(kt),b(Eo.$$.fragment,kt),kt.forEach(t),dt.forEach(t),ri=u(o),Dt=r(o,"H2",{class:!0});var qi=i(Dt);Mo=r(qi,"A",{id:!0,class:!0,href:!0});var jm=i(Mo);Va=r(jm,"SPAN",{});var Gm=i(Va);b(Qn.$$.fragment,Gm),Gm.forEach(t),jm.forEach(t),Wp=u(qi),Ka=r(qi,"SPAN",{});var xm=i(Ka);Up=s(xm,"FlaxGPTJModel"),xm.forEach(t),qi.forEach(t),ii=u(o),be=r(o,"DIV",{class:!0});var Ue=i(be);b(Hn.$$.fragment,Ue),Bp=u(Ue),Xa=r(Ue,"P",{});var Jm=i(Xa);Qp=s(Jm,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),Jm.forEach(t),Hp=u(Ue),Rn=r(Ue,"P",{});var zi=i(Rn);Rp=s(zi,"This model inherits from "),Is=r(zi,"A",{href:!0});var Em=i(Is);Vp=s(Em,"FlaxPreTrainedModel"),Em.forEach(t),Kp=s(zi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zi.forEach(t),Xp=u(Ue),Vn=r(Ue,"P",{});var Ci=i(Vn);Yp=s(Ci,`This model is also a Flax Linen
`),Kn=r(Ci,"A",{href:!0,rel:!0});var Mm=i(Kn);Zp=s(Mm,"flax.nn.Module"),Mm.forEach(t),eh=s(Ci,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ci.forEach(t),th=u(Ue),Ya=r(Ue,"P",{});var qm=i(Ya);oh=s(qm,"Finally, this model supports inherent JAX features such as:"),qm.forEach(t),nh=u(Ue),ut=r(Ue,"UL",{});var Uo=i(ut);Za=r(Uo,"LI",{});var zm=i(Za);Xn=r(zm,"A",{href:!0,rel:!0});var Cm=i(Xn);sh=s(Cm,"Just-In-Time (JIT) compilation"),Cm.forEach(t),zm.forEach(t),ah=u(Uo),er=r(Uo,"LI",{});var Am=i(er);Yn=r(Am,"A",{href:!0,rel:!0});var Lm=i(Yn);rh=s(Lm,"Automatic Differentiation"),Lm.forEach(t),Am.forEach(t),ih=u(Uo),tr=r(Uo,"LI",{});var Im=i(tr);Zn=r(Im,"A",{href:!0,rel:!0});var Nm=i(Zn);lh=s(Nm,"Vectorization"),Nm.forEach(t),Im.forEach(t),dh=u(Uo),or=r(Uo,"LI",{});var Om=i(or);es=r(Om,"A",{href:!0,rel:!0});var Sm=i(es);ch=s(Sm,"Parallelization"),Sm.forEach(t),Om.forEach(t),Uo.forEach(t),ph=u(Ue),st=r(Ue,"DIV",{class:!0});var Bo=i(st);b(ts.$$.fragment,Bo),hh=u(Bo),Wt=r(Bo,"P",{});var Zs=i(Wt);uh=s(Zs,"The "),nr=r(Zs,"CODE",{});var Dm=i(nr);mh=s(Dm,"FlaxGPTJPreTrainedModel"),Dm.forEach(t),fh=s(Zs," forward method, overrides the "),sr=r(Zs,"CODE",{});var Wm=i(sr);gh=s(Wm,"__call__"),Wm.forEach(t),_h=s(Zs," special method."),Zs.forEach(t),Th=u(Bo),b(qo.$$.fragment,Bo),yh=u(Bo),b(zo.$$.fragment,Bo),Bo.forEach(t),Ue.forEach(t),li=u(o),Ut=r(o,"H2",{class:!0});var Ai=i(Ut);Co=r(Ai,"A",{id:!0,class:!0,href:!0});var Um=i(Co);ar=r(Um,"SPAN",{});var Bm=i(ar);b(os.$$.fragment,Bm),Bm.forEach(t),Um.forEach(t),vh=u(Ai),rr=r(Ai,"SPAN",{});var Qm=i(rr);kh=s(Qm,"FlaxGPTJForCausalLM"),Qm.forEach(t),Ai.forEach(t),di=u(o),we=r(o,"DIV",{class:!0});var Be=i(we);b(ns.$$.fragment,Be),bh=u(Be),ir=r(Be,"P",{});var Hm=i(ir);wh=s(Hm,"The GPTJ Model transformer with a language modeling head on top."),Hm.forEach(t),$h=u(Be),ss=r(Be,"P",{});var Li=i(ss);Ph=s(Li,"This model inherits from "),Ns=r(Li,"A",{href:!0});var Rm=i(Ns);Fh=s(Rm,"FlaxPreTrainedModel"),Rm.forEach(t),jh=s(Li,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Li.forEach(t),Gh=u(Be),as=r(Be,"P",{});var Ii=i(as);xh=s(Ii,`This model is also a Flax Linen
`),rs=r(Ii,"A",{href:!0,rel:!0});var Vm=i(rs);Jh=s(Vm,"flax.nn.Module"),Vm.forEach(t),Eh=s(Ii,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ii.forEach(t),Mh=u(Be),lr=r(Be,"P",{});var Km=i(lr);qh=s(Km,"Finally, this model supports inherent JAX features such as:"),Km.forEach(t),zh=u(Be),mt=r(Be,"UL",{});var Qo=i(mt);dr=r(Qo,"LI",{});var Xm=i(dr);is=r(Xm,"A",{href:!0,rel:!0});var Ym=i(is);Ch=s(Ym,"Just-In-Time (JIT) compilation"),Ym.forEach(t),Xm.forEach(t),Ah=u(Qo),cr=r(Qo,"LI",{});var Zm=i(cr);ls=r(Zm,"A",{href:!0,rel:!0});var ef=i(ls);Lh=s(ef,"Automatic Differentiation"),ef.forEach(t),Zm.forEach(t),Ih=u(Qo),pr=r(Qo,"LI",{});var tf=i(pr);ds=r(tf,"A",{href:!0,rel:!0});var of=i(ds);Nh=s(of,"Vectorization"),of.forEach(t),tf.forEach(t),Oh=u(Qo),hr=r(Qo,"LI",{});var nf=i(hr);cs=r(nf,"A",{href:!0,rel:!0});var sf=i(cs);Sh=s(sf,"Parallelization"),sf.forEach(t),nf.forEach(t),Qo.forEach(t),Dh=u(Be),at=r(Be,"DIV",{class:!0});var Ho=i(at);b(ps.$$.fragment,Ho),Wh=u(Ho),Bt=r(Ho,"P",{});var ea=i(Bt);Uh=s(ea,"The "),ur=r(ea,"CODE",{});var af=i(ur);Bh=s(af,"FlaxGPTJPreTrainedModel"),af.forEach(t),Qh=s(ea," forward method, overrides the "),mr=r(ea,"CODE",{});var rf=i(mr);Hh=s(rf,"__call__"),rf.forEach(t),Rh=s(ea," special method."),ea.forEach(t),Vh=u(Ho),b(Ao.$$.fragment,Ho),Kh=u(Ho),b(Lo.$$.fragment,Ho),Ho.forEach(t),Be.forEach(t),this.h()},h(){f(d,"name","hf:doc:metadata"),f(d,"content",JSON.stringify(Bf)),f(p,"id","gptj"),f(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(p,"href","#gptj"),f(c,"class","relative group"),f(X,"id","overview"),f(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(X,"href","#overview"),f(J,"class","relative group"),f(ee,"href","https://github.com/kingoflolz/mesh-transformer-jax"),f(ee,"rel","nofollow"),f(M,"href","https://pile.eleuther.ai/"),f(M,"rel","nofollow"),f(oe,"href","https://huggingface.co/stellaathena"),f(oe,"rel","nofollow"),f(z,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),f(z,"rel","nofollow"),f(C,"href","https://huggingface.co/EleutherAI/gpt-j-6B/tree/float16"),f(C,"rel","nofollow"),f(ve,"href","https://github.com/kingoflolz/mesh-transformer-jax/blob/master/howto_finetune.md"),f(ve,"rel","nofollow"),f(Ro,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),f(Ro,"rel","nofollow"),f(Ht,"id","generation"),f(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Ht,"href","#generation"),f(bt,"class","relative group"),f(_s,"href","/docs/transformers/pr_17755/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),f(Vt,"id","transformers.GPTJConfig"),f(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Vt,"href","#transformers.GPTJConfig"),f(wt,"class","relative group"),f(ys,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJModel"),f(en,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),f(en,"rel","nofollow"),f(vs,"href","/docs/transformers/pr_17755/en/main_classes/configuration#transformers.PretrainedConfig"),f(ks,"href","/docs/transformers/pr_17755/en/main_classes/configuration#transformers.PretrainedConfig"),f(pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Xt,"id","transformers.GPTJModel"),f(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Xt,"href","#transformers.GPTJModel"),f($t,"class","relative group"),f(sn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(sn,"rel","nofollow"),f(bs,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJModel"),f(et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(eo,"id","transformers.GPTJForCausalLM"),f(eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(eo,"href","#transformers.GPTJForCausalLM"),f(Ft,"class","relative group"),f(cn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(cn,"rel","nofollow"),f(ws,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJForCausalLM"),f(tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(no,"id","transformers.GPTJForSequenceClassification"),f(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(no,"href","#transformers.GPTJForSequenceClassification"),f(Gt,"class","relative group"),f(Ps,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),f(fn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(fn,"rel","nofollow"),f(Fs,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),f($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(co,"id","transformers.GPTJForQuestionAnswering"),f(co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(co,"href","#transformers.GPTJForQuestionAnswering"),f(Jt,"class","relative group"),f(vn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(vn,"rel","nofollow"),f(js,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJForQuestionAnswering"),f(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(mo,"id","transformers.TFGPTJModel"),f(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(mo,"href","#transformers.TFGPTJModel"),f(qt,"class","relative group"),f(Gs,"href","/docs/transformers/pr_17755/en/main_classes/model#transformers.TFPreTrainedModel"),f(Fn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Fn,"rel","nofollow"),f(xs,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.TFGPTJModel"),f(ot,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(To,"id","transformers.TFGPTJForCausalLM"),f(To,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(To,"href","#transformers.TFGPTJForCausalLM"),f(Ct,"class","relative group"),f(Js,"href","/docs/transformers/pr_17755/en/main_classes/model#transformers.TFPreTrainedModel"),f(Mn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Mn,"rel","nofollow"),f(Es,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.TFGPTJForCausalLM"),f(nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(bo,"id","transformers.TFGPTJForSequenceClassification"),f(bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(bo,"href","#transformers.TFGPTJForSequenceClassification"),f(Lt,"class","relative group"),f(qs,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),f(zs,"href","/docs/transformers/pr_17755/en/main_classes/model#transformers.TFPreTrainedModel"),f(In,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(In,"rel","nofollow"),f(Cs,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.TFGPTJForSequenceClassification"),f(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(jo,"id","transformers.TFGPTJForQuestionAnswering"),f(jo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(jo,"href","#transformers.TFGPTJForQuestionAnswering"),f(Nt,"class","relative group"),f(As,"href","/docs/transformers/pr_17755/en/main_classes/model#transformers.TFPreTrainedModel"),f(Un,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Un,"rel","nofollow"),f(Ls,"href","/docs/transformers/pr_17755/en/model_doc/gptj#transformers.TFGPTJForQuestionAnswering"),f(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Mo,"id","transformers.FlaxGPTJModel"),f(Mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Mo,"href","#transformers.FlaxGPTJModel"),f(Dt,"class","relative group"),f(Is,"href","/docs/transformers/pr_17755/en/main_classes/model#transformers.FlaxPreTrainedModel"),f(Kn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),f(Kn,"rel","nofollow"),f(Xn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),f(Xn,"rel","nofollow"),f(Yn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),f(Yn,"rel","nofollow"),f(Zn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),f(Zn,"rel","nofollow"),f(es,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),f(es,"rel","nofollow"),f(st,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Co,"id","transformers.FlaxGPTJForCausalLM"),f(Co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Co,"href","#transformers.FlaxGPTJForCausalLM"),f(Ut,"class","relative group"),f(Ns,"href","/docs/transformers/pr_17755/en/main_classes/model#transformers.FlaxPreTrainedModel"),f(rs,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),f(rs,"rel","nofollow"),f(is,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),f(is,"rel","nofollow"),f(ls,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),f(ls,"rel","nofollow"),f(ds,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),f(ds,"rel","nofollow"),f(cs,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),f(cs,"rel","nofollow"),f(at,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(we,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,d),g(o,T,_),g(o,c,_),e(c,p),e(p,y),w(l,y,null),e(c,m),e(c,G),e(G,he),g(o,K,_),g(o,J,_),e(J,X),e(X,D),w(Z,D,null),e(J,ue),e(J,W),e(W,me),g(o,re,_),g(o,I,_),e(I,L),e(I,ee),e(ee,te),e(I,E),e(I,M),e(M,fe),e(I,Q),g(o,ie,_),g(o,Y,_),e(Y,H),e(Y,oe),e(oe,ge),e(Y,q),g(o,le,_),g(o,N,_),e(N,_e),g(o,de,_),g(o,O,_),e(O,U),e(U,Te),e(U,z),e(z,ye),e(U,R),e(U,ne),e(ne,v),e(U,x),e(U,V),e(V,ze),e(U,Ce),e(U,C),e(C,Ae),e(U,Le),g(o,Me,_),w(A,o,_),g(o,B,_),g(o,ce,_),e(ce,Pe),e(Pe,S),e(S,Ie),e(S,ve),e(ve,ke),e(ce,Ne),e(ce,ta),e(ta,ct),e(ct,Ni),e(ct,Ro),e(Ro,Oi),e(ct,Si),e(ct,oa),e(oa,Di),e(ct,Wi),e(ct,na),e(na,Ui),e(ct,Bi),g(o,Lr,_),g(o,bt,_),e(bt,Ht),e(Ht,sa),w(Vo,sa,null),e(bt,Qi),e(bt,aa),e(aa,Hi),g(o,Ir,_),g(o,Rt,_),e(Rt,Ri),e(Rt,_s),e(_s,Vi),e(Rt,Ki),g(o,Nr,_),w(Ko,o,_),g(o,Or,_),g(o,Ts,_),e(Ts,Xi),g(o,Sr,_),w(Xo,o,_),g(o,Dr,_),g(o,wt,_),e(wt,Vt),e(Vt,ra),w(Yo,ra,null),e(wt,Yi),e(wt,ia),e(ia,Zi),g(o,Wr,_),g(o,pt,_),w(Zo,pt,null),e(pt,el),e(pt,Re),e(Re,tl),e(Re,ys),e(ys,ol),e(Re,nl),e(Re,en),e(en,sl),e(Re,al),e(Re,vs),e(vs,rl),e(Re,il),e(Re,ks),e(ks,ll),e(Re,dl),e(pt,cl),w(Kt,pt,null),g(o,Ur,_),g(o,$t,_),e($t,Xt),e(Xt,la),w(tn,la,null),e($t,pl),e($t,da),e(da,hl),g(o,Br,_),g(o,ht,_),w(on,ht,null),e(ht,ul),e(ht,nn),e(nn,ml),e(nn,sn),e(sn,fl),e(nn,gl),e(ht,_l),e(ht,et),w(an,et,null),e(et,Tl),e(et,Pt),e(Pt,yl),e(Pt,bs),e(bs,vl),e(Pt,kl),e(Pt,ca),e(ca,bl),e(Pt,wl),e(et,$l),w(Yt,et,null),e(et,Pl),w(Zt,et,null),g(o,Qr,_),g(o,Ft,_),e(Ft,eo),e(eo,pa),w(rn,pa,null),e(Ft,Fl),e(Ft,ha),e(ha,jl),g(o,Hr,_),g(o,Ve,_),w(ln,Ve,null),e(Ve,Gl),e(Ve,ua),e(ua,xl),e(Ve,Jl),e(Ve,dn),e(dn,El),e(dn,cn),e(cn,Ml),e(dn,ql),e(Ve,zl),e(Ve,tt),w(pn,tt,null),e(tt,Cl),e(tt,jt),e(jt,Al),e(jt,ws),e(ws,Ll),e(jt,Il),e(jt,ma),e(ma,Nl),e(jt,Ol),e(tt,Sl),w(to,tt,null),e(tt,Dl),w(oo,tt,null),g(o,Rr,_),g(o,Gt,_),e(Gt,no),e(no,fa),w(hn,fa,null),e(Gt,Wl),e(Gt,ga),e(ga,Ul),g(o,Vr,_),g(o,Fe,_),w(un,Fe,null),e(Fe,Bl),e(Fe,_a),e(_a,Ql),e(Fe,Hl),e(Fe,$s),e($s,Ps),e(Ps,Rl),e($s,Vl),e(Fe,Kl),e(Fe,Ke),e(Ke,Xl),e(Ke,Ta),e(Ta,Yl),e(Ke,Zl),e(Ke,ya),e(ya,ed),e(Ke,td),e(Ke,va),e(va,od),e(Ke,nd),e(Ke,ka),e(ka,sd),e(Ke,ad),e(Fe,rd),e(Fe,mn),e(mn,id),e(mn,fn),e(fn,ld),e(mn,dd),e(Fe,cd),e(Fe,$e),w(gn,$e,null),e($e,pd),e($e,xt),e(xt,hd),e(xt,Fs),e(Fs,ud),e(xt,md),e(xt,ba),e(ba,fd),e(xt,gd),e($e,_d),w(so,$e,null),e($e,Td),w(ao,$e,null),e($e,yd),w(ro,$e,null),e($e,vd),w(io,$e,null),e($e,kd),w(lo,$e,null),g(o,Kr,_),g(o,Jt,_),e(Jt,co),e(co,wa),w(_n,wa,null),e(Jt,bd),e(Jt,$a),e($a,wd),g(o,Xr,_),g(o,Xe,_),w(Tn,Xe,null),e(Xe,$d),e(Xe,Et),e(Et,Pd),e(Et,Pa),e(Pa,Fd),e(Et,jd),e(Et,Fa),e(Fa,Gd),e(Et,xd),e(Xe,Jd),e(Xe,yn),e(yn,Ed),e(yn,vn),e(vn,Md),e(yn,qd),e(Xe,zd),e(Xe,Oe),w(kn,Oe,null),e(Oe,Cd),e(Oe,Mt),e(Mt,Ad),e(Mt,js),e(js,Ld),e(Mt,Id),e(Mt,ja),e(ja,Nd),e(Mt,Od),e(Oe,Sd),w(po,Oe,null),e(Oe,Dd),w(ho,Oe,null),e(Oe,Wd),w(uo,Oe,null),g(o,Yr,_),g(o,qt,_),e(qt,mo),e(mo,Ga),w(bn,Ga,null),e(qt,Ud),e(qt,xa),e(xa,Bd),g(o,Zr,_),g(o,je,_),w(wn,je,null),e(je,Qd),e(je,Ja),e(Ja,Hd),e(je,Rd),e(je,$n),e($n,Vd),e($n,Gs),e(Gs,Kd),e($n,Xd),e(je,Yd),e(je,Pn),e(Pn,Zd),e(Pn,Fn),e(Fn,ec),e(Pn,tc),e(je,oc),w(fo,je,null),e(je,nc),e(je,ot),w(jn,ot,null),e(ot,sc),e(ot,zt),e(zt,ac),e(zt,xs),e(xs,rc),e(zt,ic),e(zt,Ea),e(Ea,lc),e(zt,dc),e(ot,cc),w(go,ot,null),e(ot,pc),w(_o,ot,null),g(o,ei,_),g(o,Ct,_),e(Ct,To),e(To,Ma),w(Gn,Ma,null),e(Ct,hc),e(Ct,qa),e(qa,uc),g(o,ti,_),g(o,Ge,_),w(xn,Ge,null),e(Ge,mc),e(Ge,za),e(za,fc),e(Ge,gc),e(Ge,Jn),e(Jn,_c),e(Jn,Js),e(Js,Tc),e(Jn,yc),e(Ge,vc),e(Ge,En),e(En,kc),e(En,Mn),e(Mn,bc),e(En,wc),e(Ge,$c),w(yo,Ge,null),e(Ge,Pc),e(Ge,nt),w(qn,nt,null),e(nt,Fc),e(nt,At),e(At,jc),e(At,Es),e(Es,Gc),e(At,xc),e(At,Ca),e(Ca,Jc),e(At,Ec),e(nt,Mc),w(vo,nt,null),e(nt,qc),w(ko,nt,null),g(o,oi,_),g(o,Lt,_),e(Lt,bo),e(bo,Aa),w(zn,Aa,null),e(Lt,zc),e(Lt,La),e(La,Cc),g(o,ni,_),g(o,se,_),w(Cn,se,null),e(se,Ac),e(se,Ia),e(Ia,Lc),e(se,Ic),e(se,Ms),e(Ms,qs),e(qs,Nc),e(Ms,Oc),e(se,Sc),e(se,Ye),e(Ye,Dc),e(Ye,Na),e(Na,Wc),e(Ye,Uc),e(Ye,Oa),e(Oa,Bc),e(Ye,Qc),e(Ye,Sa),e(Sa,Hc),e(Ye,Rc),e(Ye,Da),e(Da,Vc),e(Ye,Kc),e(se,Xc),e(se,An),e(An,Yc),e(An,zs),e(zs,Zc),e(An,ep),e(se,tp),e(se,Ln),e(Ln,op),e(Ln,In),e(In,np),e(Ln,sp),e(se,ap),w(wo,se,null),e(se,rp),e(se,Se),w(Nn,Se,null),e(Se,ip),e(Se,It),e(It,lp),e(It,Cs),e(Cs,dp),e(It,cp),e(It,Wa),e(Wa,pp),e(It,hp),e(Se,up),w($o,Se,null),e(Se,mp),w(Po,Se,null),e(Se,fp),w(Fo,Se,null),g(o,si,_),g(o,Nt,_),e(Nt,jo),e(jo,Ua),w(On,Ua,null),e(Nt,gp),e(Nt,Ba),e(Ba,_p),g(o,ai,_),g(o,xe,_),w(Sn,xe,null),e(xe,Tp),e(xe,Ot),e(Ot,yp),e(Ot,Qa),e(Qa,vp),e(Ot,kp),e(Ot,Ha),e(Ha,bp),e(Ot,wp),e(xe,$p),e(xe,Dn),e(Dn,Pp),e(Dn,As),e(As,Fp),e(Dn,jp),e(xe,Gp),e(xe,Wn),e(Wn,xp),e(Wn,Un),e(Un,Jp),e(Wn,Ep),e(xe,Mp),w(Go,xe,null),e(xe,qp),e(xe,De),w(Bn,De,null),e(De,zp),e(De,St),e(St,Cp),e(St,Ls),e(Ls,Ap),e(St,Lp),e(St,Ra),e(Ra,Ip),e(St,Np),e(De,Op),w(xo,De,null),e(De,Sp),w(Jo,De,null),e(De,Dp),w(Eo,De,null),g(o,ri,_),g(o,Dt,_),e(Dt,Mo),e(Mo,Va),w(Qn,Va,null),e(Dt,Wp),e(Dt,Ka),e(Ka,Up),g(o,ii,_),g(o,be,_),w(Hn,be,null),e(be,Bp),e(be,Xa),e(Xa,Qp),e(be,Hp),e(be,Rn),e(Rn,Rp),e(Rn,Is),e(Is,Vp),e(Rn,Kp),e(be,Xp),e(be,Vn),e(Vn,Yp),e(Vn,Kn),e(Kn,Zp),e(Vn,eh),e(be,th),e(be,Ya),e(Ya,oh),e(be,nh),e(be,ut),e(ut,Za),e(Za,Xn),e(Xn,sh),e(ut,ah),e(ut,er),e(er,Yn),e(Yn,rh),e(ut,ih),e(ut,tr),e(tr,Zn),e(Zn,lh),e(ut,dh),e(ut,or),e(or,es),e(es,ch),e(be,ph),e(be,st),w(ts,st,null),e(st,hh),e(st,Wt),e(Wt,uh),e(Wt,nr),e(nr,mh),e(Wt,fh),e(Wt,sr),e(sr,gh),e(Wt,_h),e(st,Th),w(qo,st,null),e(st,yh),w(zo,st,null),g(o,li,_),g(o,Ut,_),e(Ut,Co),e(Co,ar),w(os,ar,null),e(Ut,vh),e(Ut,rr),e(rr,kh),g(o,di,_),g(o,we,_),w(ns,we,null),e(we,bh),e(we,ir),e(ir,wh),e(we,$h),e(we,ss),e(ss,Ph),e(ss,Ns),e(Ns,Fh),e(ss,jh),e(we,Gh),e(we,as),e(as,xh),e(as,rs),e(rs,Jh),e(as,Eh),e(we,Mh),e(we,lr),e(lr,qh),e(we,zh),e(we,mt),e(mt,dr),e(dr,is),e(is,Ch),e(mt,Ah),e(mt,cr),e(cr,ls),e(ls,Lh),e(mt,Ih),e(mt,pr),e(pr,ds),e(ds,Nh),e(mt,Oh),e(mt,hr),e(hr,cs),e(cs,Sh),e(we,Dh),e(we,at),w(ps,at,null),e(at,Wh),e(at,Bt),e(Bt,Uh),e(Bt,ur),e(ur,Bh),e(Bt,Qh),e(Bt,mr),e(mr,Hh),e(Bt,Rh),e(at,Vh),w(Ao,at,null),e(at,Kh),w(Lo,at,null),ci=!0},p(o,[_]){const hs={};_&2&&(hs.$$scope={dirty:_,ctx:o}),Kt.$set(hs);const fr={};_&2&&(fr.$$scope={dirty:_,ctx:o}),Yt.$set(fr);const gr={};_&2&&(gr.$$scope={dirty:_,ctx:o}),Zt.$set(gr);const _r={};_&2&&(_r.$$scope={dirty:_,ctx:o}),to.$set(_r);const us={};_&2&&(us.$$scope={dirty:_,ctx:o}),oo.$set(us);const Tr={};_&2&&(Tr.$$scope={dirty:_,ctx:o}),so.$set(Tr);const yr={};_&2&&(yr.$$scope={dirty:_,ctx:o}),ao.$set(yr);const vr={};_&2&&(vr.$$scope={dirty:_,ctx:o}),ro.$set(vr);const Qt={};_&2&&(Qt.$$scope={dirty:_,ctx:o}),io.$set(Qt);const kr={};_&2&&(kr.$$scope={dirty:_,ctx:o}),lo.$set(kr);const br={};_&2&&(br.$$scope={dirty:_,ctx:o}),po.$set(br);const ms={};_&2&&(ms.$$scope={dirty:_,ctx:o}),ho.$set(ms);const wr={};_&2&&(wr.$$scope={dirty:_,ctx:o}),uo.$set(wr);const $r={};_&2&&($r.$$scope={dirty:_,ctx:o}),fo.$set($r);const Pr={};_&2&&(Pr.$$scope={dirty:_,ctx:o}),go.$set(Pr);const Ze={};_&2&&(Ze.$$scope={dirty:_,ctx:o}),_o.$set(Ze);const Fr={};_&2&&(Fr.$$scope={dirty:_,ctx:o}),yo.$set(Fr);const jr={};_&2&&(jr.$$scope={dirty:_,ctx:o}),vo.$set(jr);const Gr={};_&2&&(Gr.$$scope={dirty:_,ctx:o}),ko.$set(Gr);const xr={};_&2&&(xr.$$scope={dirty:_,ctx:o}),wo.$set(xr);const fs={};_&2&&(fs.$$scope={dirty:_,ctx:o}),$o.$set(fs);const Jr={};_&2&&(Jr.$$scope={dirty:_,ctx:o}),Po.$set(Jr);const Os={};_&2&&(Os.$$scope={dirty:_,ctx:o}),Fo.$set(Os);const Er={};_&2&&(Er.$$scope={dirty:_,ctx:o}),Go.$set(Er);const Mr={};_&2&&(Mr.$$scope={dirty:_,ctx:o}),xo.$set(Mr);const ft={};_&2&&(ft.$$scope={dirty:_,ctx:o}),Jo.$set(ft);const qr={};_&2&&(qr.$$scope={dirty:_,ctx:o}),Eo.$set(qr);const zr={};_&2&&(zr.$$scope={dirty:_,ctx:o}),qo.$set(zr);const Cr={};_&2&&(Cr.$$scope={dirty:_,ctx:o}),zo.$set(Cr);const gs={};_&2&&(gs.$$scope={dirty:_,ctx:o}),Ao.$set(gs);const Ar={};_&2&&(Ar.$$scope={dirty:_,ctx:o}),Lo.$set(Ar)},i(o){ci||($(l.$$.fragment,o),$(Z.$$.fragment,o),$(A.$$.fragment,o),$(Vo.$$.fragment,o),$(Ko.$$.fragment,o),$(Xo.$$.fragment,o),$(Yo.$$.fragment,o),$(Zo.$$.fragment,o),$(Kt.$$.fragment,o),$(tn.$$.fragment,o),$(on.$$.fragment,o),$(an.$$.fragment,o),$(Yt.$$.fragment,o),$(Zt.$$.fragment,o),$(rn.$$.fragment,o),$(ln.$$.fragment,o),$(pn.$$.fragment,o),$(to.$$.fragment,o),$(oo.$$.fragment,o),$(hn.$$.fragment,o),$(un.$$.fragment,o),$(gn.$$.fragment,o),$(so.$$.fragment,o),$(ao.$$.fragment,o),$(ro.$$.fragment,o),$(io.$$.fragment,o),$(lo.$$.fragment,o),$(_n.$$.fragment,o),$(Tn.$$.fragment,o),$(kn.$$.fragment,o),$(po.$$.fragment,o),$(ho.$$.fragment,o),$(uo.$$.fragment,o),$(bn.$$.fragment,o),$(wn.$$.fragment,o),$(fo.$$.fragment,o),$(jn.$$.fragment,o),$(go.$$.fragment,o),$(_o.$$.fragment,o),$(Gn.$$.fragment,o),$(xn.$$.fragment,o),$(yo.$$.fragment,o),$(qn.$$.fragment,o),$(vo.$$.fragment,o),$(ko.$$.fragment,o),$(zn.$$.fragment,o),$(Cn.$$.fragment,o),$(wo.$$.fragment,o),$(Nn.$$.fragment,o),$($o.$$.fragment,o),$(Po.$$.fragment,o),$(Fo.$$.fragment,o),$(On.$$.fragment,o),$(Sn.$$.fragment,o),$(Go.$$.fragment,o),$(Bn.$$.fragment,o),$(xo.$$.fragment,o),$(Jo.$$.fragment,o),$(Eo.$$.fragment,o),$(Qn.$$.fragment,o),$(Hn.$$.fragment,o),$(ts.$$.fragment,o),$(qo.$$.fragment,o),$(zo.$$.fragment,o),$(os.$$.fragment,o),$(ns.$$.fragment,o),$(ps.$$.fragment,o),$(Ao.$$.fragment,o),$(Lo.$$.fragment,o),ci=!0)},o(o){P(l.$$.fragment,o),P(Z.$$.fragment,o),P(A.$$.fragment,o),P(Vo.$$.fragment,o),P(Ko.$$.fragment,o),P(Xo.$$.fragment,o),P(Yo.$$.fragment,o),P(Zo.$$.fragment,o),P(Kt.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(an.$$.fragment,o),P(Yt.$$.fragment,o),P(Zt.$$.fragment,o),P(rn.$$.fragment,o),P(ln.$$.fragment,o),P(pn.$$.fragment,o),P(to.$$.fragment,o),P(oo.$$.fragment,o),P(hn.$$.fragment,o),P(un.$$.fragment,o),P(gn.$$.fragment,o),P(so.$$.fragment,o),P(ao.$$.fragment,o),P(ro.$$.fragment,o),P(io.$$.fragment,o),P(lo.$$.fragment,o),P(_n.$$.fragment,o),P(Tn.$$.fragment,o),P(kn.$$.fragment,o),P(po.$$.fragment,o),P(ho.$$.fragment,o),P(uo.$$.fragment,o),P(bn.$$.fragment,o),P(wn.$$.fragment,o),P(fo.$$.fragment,o),P(jn.$$.fragment,o),P(go.$$.fragment,o),P(_o.$$.fragment,o),P(Gn.$$.fragment,o),P(xn.$$.fragment,o),P(yo.$$.fragment,o),P(qn.$$.fragment,o),P(vo.$$.fragment,o),P(ko.$$.fragment,o),P(zn.$$.fragment,o),P(Cn.$$.fragment,o),P(wo.$$.fragment,o),P(Nn.$$.fragment,o),P($o.$$.fragment,o),P(Po.$$.fragment,o),P(Fo.$$.fragment,o),P(On.$$.fragment,o),P(Sn.$$.fragment,o),P(Go.$$.fragment,o),P(Bn.$$.fragment,o),P(xo.$$.fragment,o),P(Jo.$$.fragment,o),P(Eo.$$.fragment,o),P(Qn.$$.fragment,o),P(Hn.$$.fragment,o),P(ts.$$.fragment,o),P(qo.$$.fragment,o),P(zo.$$.fragment,o),P(os.$$.fragment,o),P(ns.$$.fragment,o),P(ps.$$.fragment,o),P(Ao.$$.fragment,o),P(Lo.$$.fragment,o),ci=!1},d(o){t(d),o&&t(T),o&&t(c),F(l),o&&t(K),o&&t(J),F(Z),o&&t(re),o&&t(I),o&&t(ie),o&&t(Y),o&&t(le),o&&t(N),o&&t(de),o&&t(O),o&&t(Me),F(A,o),o&&t(B),o&&t(ce),o&&t(Lr),o&&t(bt),F(Vo),o&&t(Ir),o&&t(Rt),o&&t(Nr),F(Ko,o),o&&t(Or),o&&t(Ts),o&&t(Sr),F(Xo,o),o&&t(Dr),o&&t(wt),F(Yo),o&&t(Wr),o&&t(pt),F(Zo),F(Kt),o&&t(Ur),o&&t($t),F(tn),o&&t(Br),o&&t(ht),F(on),F(an),F(Yt),F(Zt),o&&t(Qr),o&&t(Ft),F(rn),o&&t(Hr),o&&t(Ve),F(ln),F(pn),F(to),F(oo),o&&t(Rr),o&&t(Gt),F(hn),o&&t(Vr),o&&t(Fe),F(un),F(gn),F(so),F(ao),F(ro),F(io),F(lo),o&&t(Kr),o&&t(Jt),F(_n),o&&t(Xr),o&&t(Xe),F(Tn),F(kn),F(po),F(ho),F(uo),o&&t(Yr),o&&t(qt),F(bn),o&&t(Zr),o&&t(je),F(wn),F(fo),F(jn),F(go),F(_o),o&&t(ei),o&&t(Ct),F(Gn),o&&t(ti),o&&t(Ge),F(xn),F(yo),F(qn),F(vo),F(ko),o&&t(oi),o&&t(Lt),F(zn),o&&t(ni),o&&t(se),F(Cn),F(wo),F(Nn),F($o),F(Po),F(Fo),o&&t(si),o&&t(Nt),F(On),o&&t(ai),o&&t(xe),F(Sn),F(Go),F(Bn),F(xo),F(Jo),F(Eo),o&&t(ri),o&&t(Dt),F(Qn),o&&t(ii),o&&t(be),F(Hn),F(ts),F(qo),F(zo),o&&t(li),o&&t(Ut),F(os),o&&t(di),o&&t(we),F(ns),F(ps),F(Ao),F(Lo)}}}const Bf={local:"gptj",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTJConfig",title:"GPTJConfig"},{local:"transformers.GPTJModel",title:"GPTJModel"},{local:"transformers.GPTJForCausalLM",title:"GPTJForCausalLM"},{local:"transformers.GPTJForSequenceClassification",title:"GPTJForSequenceClassification"},{local:"transformers.GPTJForQuestionAnswering",title:"GPTJForQuestionAnswering"},{local:"transformers.TFGPTJModel",title:"TFGPTJModel"},{local:"transformers.TFGPTJForCausalLM",title:"TFGPTJForCausalLM"},{local:"transformers.TFGPTJForSequenceClassification",title:"TFGPTJForSequenceClassification"},{local:"transformers.TFGPTJForQuestionAnswering",title:"TFGPTJForQuestionAnswering"},{local:"transformers.FlaxGPTJModel",title:"FlaxGPTJModel"},{local:"transformers.FlaxGPTJForCausalLM",title:"FlaxGPTJForCausalLM"}],title:"GPT-J"};function Qf(j){return hf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Zf extends lf{constructor(d){super();df(this,d,Qf,Uf,cf,{})}}export{Zf as default,Bf as metadata};
