...
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(v,x){g(v,d,x),e(d,T),g(v,c,x),g(v,p,x),e(p,y),e(y,l),e(p,m),e(p,G),e(G,he),g(v,K,x),g(v,J,x),e(J,X),e(J,D),e(D,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(v,I,x),g(v,L,x),e(L,ee),g(v,te,x),g(v,E,x),e(E,M),e(M,fe),e(M,B),e(B,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,O),e(O,U),e(E,Te),e(E,z),e(z,ye),e(z,R),e(R,ne)},d(v){v&&t(d),v&&t(c),v&&t(p),v&&t(K),v&&t(J),v&&t(I),v&&t(L),v&&t(te),v&&t(E)}}}function jf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function xf(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Mf(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Uf(j){let d,T,c,p,y,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne,v,x,V,ze,Ce,C,Ae,Le,Me,A,Q,ce,Pe,S,Ie,ve,ke,Ne,ta,ct,Ni,Ro,Oi,Si,oa,Di,Wi,na,Ui,Qi,Lr,bt,Ht,sa,Vo,Bi,aa,Hi,Ir,Rt,Ri,_s,Vi,Ki,Nr,Ko,Or,Ts,Xi,Sr,Xo,Dr,wt,Vt,ra,Yo,Yi,ia,Zi,Wr,pt,Zo,el,Re,tl,ys,ol,nl,en,sl,al,vs,rl,il,ks,ll,dl,cl,Kt,Ur,$t,Xt,la,tn,pl,da,hl,Qr,ht,on,ul,nn,ml,sn,fl,gl,_l,et,an,Tl,Pt,yl,bs,vl,kl,ca,bl,wl,$l,Yt,Pl,Zt,Br,Ft,eo,pa,rn,Fl,ha,jl,Hr,Ve,ln,Gl,ua,xl,Jl,dn,El,cn,Ml,ql,zl,tt,pn,Cl,jt,Al,ws,Ll,Il,ma,Nl,Ol,Sl,to,Dl,oo,Rr,Gt,no,fa,hn,Wl,ga,Ul,Vr,Fe,un,Ql,_a,Bl,Hl,$s,Ps,Rl,Vl,Kl,Ke,Xl,Ta,Yl,Zl,ya,ed,td,va,od,nd,ka,sd,ad,rd,mn,id,fn,ld,dd,cd,$e,gn,pd,xt,hd,Fs,ud,md,ba,fd,gd,_d,so,Td,ao,yd,ro,vd,io,kd,lo,Kr,Jt,co,wa,_n,bd,$a,wd,Xr,Xe,Tn,$d,Et,Pd,Pa,Fd,jd,Fa,Gd,xd,Jd,yn,Ed,vn,Md,qd,zd,Oe,kn,Cd,Mt,Ad,js,Ld,Id,ja,Nd,Od,Sd,po,Dd,ho,Wd,uo,Yr,qt,mo,Ga,bn,Ud,xa,Qd,Zr,je,wn,Bd,Ja,Hd,Rd,$n,Vd,Gs,Kd,Xd,Yd,Pn,Zd,Fn,ec,tc,oc,fo,nc,ot,jn,sc,zt,ac,xs,rc,ic,Ea,lc,dc,cc,go,pc,_o,ei,Ct,To,Ma,Gn,hc,qa,uc,ti,Ge,xn,mc,za,fc,gc,Jn,_c,Js,Tc,yc,vc,En,kc,Mn,bc,wc,$c,yo,Pc,nt,qn,Fc,At,jc,Es,Gc,xc,Ca,Jc,Ec,Mc,vo,qc,ko,oi,Lt,bo,Aa,zn,zc,La,Cc,ni,se,Cn,Ac,Ia,Lc,Ic,Ms,qs,Nc,Oc,Sc,Ye,Dc,Na,Wc,Uc,Oa,Qc,Bc,Sa,Hc,Rc,Da,Vc,Kc,Xc,An,Yc,zs,Zc,ep,tp,Ln,op,In,np,sp,ap,wo,rp,Se,Nn,ip,It,lp,Cs,dp,cp,Wa,pp,hp,up,$o,mp,Po,fp,Fo,si,Nt,jo,Ua,On,gp,Qa,_p,ai,xe,Sn,Tp,Ot,yp,Ba,vp,kp,Ha,bp,wp,$p,Dn,Pp,As,Fp,jp,Gp,Wn,xp,Un,Jp,Ep,Mp,Go,qp,De,Qn,zp,St,Cp,Ls,Ap,Lp,Ra,Ip,Np,Op,xo,Sp,Jo,Dp,Eo,ri,Dt,Mo,Va,Bn,Wp,Ka,Up,ii,be,Hn,Qp,Xa,Bp,Hp,Rn,Rp,Is,Vp,Kp,Xp,Vn,Yp,Kn,Zp,eh,th,Ya,oh,nh,ut,Za,Xn,sh,ah,er,Yn,rh,ih,tr,Zn,lh,dh,or,es,ch,ph,st,ts,hh,Wt,uh,nr,mh,fh,sr,gh,_h,Th,qo,yh,zo,li,Ut,Co,ar,os,vh,rr,kh,di,we,ns,bh,ir,wh,$h,ss,Ph,Ns,Fh,jh,Gh,as,xh,rs,Jh,Eh,Mh,lr,qh,zh,mt,dr,is,Ch,Ah,cr,ls,Lh,Ih,pr,ds,Nh,Oh,hr,cs,Sh,Dh,at,ps,Wh,Qt,Uh,ur,Qh,Bh,mr,Hh,Rh,Vh,Ao,Kh,Lo,ci;return l=new He({}),Z=new He({}),A=new pe({props:{code:`from transformers import GPTJForCausalLM
import torch
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_gptj.py#L786",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_gptj.py#L908",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17755/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_gptj.py#L1019"}}),kn=new ae({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_17755/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17755/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/gptj/modeling_gptj.py#L1035",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_17755/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17755/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
behavior.`),_l=h(),et=a("div"),k(an.$$.fragment),Tl=h(),Pt=a("p"),yl=n("The "),bs=a("a"),vl=n("GPTJModel"),kl=n(" forward method, overrides the "),ca=a("code"),bl=n("__call__"),wl=n(" special method."),$l=h(),k(Yt.$$.fragment),Pl=h(),k(Zt.$$.fragment),Br=h(),Ft=a("h2"),eo=a("a"),pa=a("span"),k(rn.$$.fragment),Fl=h(),ha=a("span"),jl=n("GPTJForCausalLM"),Hr=h(),Ve=a("div"),k(ln.$$.fragment),Gl=h(),ua=a("p"),xl=n("The GPT-J Model transformer with a language modeling head on top."),Jl=h(),dn=a("p"),El=n("This model is a PyTorch "),cn=a("a"),Ml=n("torch.nn.Module"),ql=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zd=h(),Oe=a("div"),k(kn.$$.fragment),Cd=h(),Mt=a("p"),Ad=n("The "),js=a("a"),Ld=n("GPTJForQuestionAnswering"),Id=n(" forward method, overrides the "),ja=a("code"),Nd=n("__call__"),Od=n(" special method."),Sd=h(),k(po.$$.fragment),Dd=h(),k(ho.$$.fragment),Wd=h(),k(uo.$$.fragment),Yr=h(),qt=a("h2"),mo=a("a"),Ga=a("span"),k(bn.$$.fragment),Ud=h(),xa=a("span"),Qd=n("TFGPTJModel"),Zr=h(),je=a("div"),k(wn.$$.fragment),Bd=h(),Ja=a("p"),Hd=n("The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Rd=h(),$n=a("p"),Vd=n("This model inherits from "),Gs=a("a"),Kd=n("TFPreTrainedModel"),Xd=n(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),k(wo.$$.fragment),rp=h(),Se=a("div"),k(Nn.$$.fragment),ip=h(),It=a("p"),lp=n("The "),Cs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Wa=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),k($o.$$.fragment),mp=h(),k(Po.$$.fragment),fp=h(),k(Fo.$$.fragment),si=h(),Nt=a("h2"),jo=a("a"),Ua=a("span"),k(On.$$.fragment),gp=h(),Qa=a("span"),_p=n("TFGPTJForQuestionAnswering"),ai=h(),xe=a("div"),k(Sn.$$.fragment),Tp=h(),Ot=a("p"),yp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mp=h(),k(Go.$$.fragment),qp=h(),De=a("div"),k(Qn.$$.fragment),zp=h(),St=a("p"),Cp=n("The "),Ls=a("a"),Ap=n("TFGPTJForQuestionAnswering"),Lp=n(" forward method, overrides the "),Ra=a("code"),Ip=n("__call__"),Np=n(" special method."),Op=h(),k(xo.$$.fragment),Sp=h(),k(Jo.$$.fragment),Dp=h(),k(Eo.$$.fragment),ri=h(),Dt=a("h2"),Mo=a("a"),Va=a("span"),k(Bn.$$.fragment),Wp=h(),Ka=a("span"),Up=n("FlaxGPTJModel"),ii=h(),be=a("div"),k(Hn.$$.fragment),Qp=h(),Xa=a("p"),Bp=n("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),Hp=h(),Rn=a("p"),Rp=n("This model inherits from "),Is=a("a"),Vp=n("FlaxPreTrainedModel"),Kp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
