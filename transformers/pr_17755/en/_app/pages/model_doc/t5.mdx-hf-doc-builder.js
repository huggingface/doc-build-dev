...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17755/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17755/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17755/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17755/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17755/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17755/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/modeling_tf_t5.py#L1137",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/modeling_tf_t5.py#L1313",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17755/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17755/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17755/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/modeling_tf_t5.py#L1619",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17755/src/transformers/models/t5/modeling_flax_t5.py#L956",returnDescription:`
<p>A <a
...
<p>A <a
  href="/docs/transformers/pr_17755/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
to the documentation of byT5 which can be found `),Qa=r(Od,"A",{href:!0});var P5=i(Qa);_h=s(P5,"here"),P5.forEach(t),gh=s(Od,"."),Od.forEach(t),M5.forEach(t),Dr.forEach(t),Sd=c(n),un=r(n,"P",{});var Hc=i(un);Th=s(Hc,"All checkpoints can be found on the "),Io=r(Hc,"A",{href:!0,rel:!0});var N5=i(Io);bh=s(N5,"hub"),N5.forEach(t),kh=s(Hc,"."),Hc.forEach(t),Gd=c(n),xt=r(n,"P",{});var Sr=i(xt);vh=s(Sr,"This model was contributed by "),Do=r(Sr,"A",{href:!0,rel:!0});var O5=i(Do);yh=s(O5,"thomwolf"),O5.forEach(t),wh=s(Sr,". The original code can be found "),So=r(Sr,"A",{href:!0,rel:!0});var L5=i(So);$h=s(L5,"here"),L5.forEach(t),xh=s(Sr,"."),Sr.forEach(t),Ud=c(n),er=r(n,"A",{id:!0}),i(er).forEach(t),Bd=c(n),Ot=r(n,"H2",{class:!0});var Vc=i(Ot);mn=r(Vc,"A",{id:!0,class:!0,href:!0});var A5=i(mn);vi=r(A5,"SPAN",{});var I5=i(vi);v(Go.$$.fragment,I5),I5.forEach(t),A5.forEach(t),zh=c(Vc),yi=r(Vc,"SPAN",{});var D5=i(yi);jh=s(D5,"Training"),D5.forEach(t),Vc.forEach(t),Wd=c(n),at=r(n,"P",{});var _o=i(at);qh=s(_o,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),_o.forEach(t),Rd=c(n),fn=r(n,"P",{});var Kc=i(fn);Oh=s(Kc,"One can use "),tr=r(Kc,"A",{href:!0});var B5=i(tr);Lh=s(B5,"T5ForConditionalGeneration"),B5.forEach(t),Ah=s(Kc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Kc.forEach(t),Hd=c(n),nr=r(n,"UL",{});var W5=i(nr);zi=r(W5,"LI",{});var R5=i(zi);Ih=s(R5,"Unsupervised denoising training"),R5.forEach(t),W5.forEach(t),Vd=c(n),me=r(n,"P",{});var Re=i(me);Dh=s(Re,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=r(Re,"EM",{});var H5=i(ji);Sh=s(H5,"a.k.a"),H5.forEach(t),Gh=s(Re,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),qi=r(Re,"EM",{});var V5=i(qi);Uh=s(V5,"real"),V5.forEach(t),Bh=s(Re,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Ei=r(Re,"CODE",{});var K5=i(Ei);Wh=s(K5,"<extra_id_0>"),K5.forEach(t),Rh=s(Re,`,
...
processed as follows:`),X5.forEach(t),Yd=c(n),v(Uo.$$.fragment,n),Zd=c(n),_n=r(n,"P",{});var Yc=i(_n);Qh=s(Yc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Bo=r(Yc,"A",{href:!0,rel:!0});var Q5=i(Bo);eu=s(Q5,"run_t5_mlm_flax.py"),Q5.forEach(t),tu=s(Yc,` script in the Examples
...
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),nk.forEach(t),Qd=c(n),v(Wo.$$.fragment,n),ec=c(n),oe=r(n,"P",{});var $e=i(oe);su=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Pi=r($e,"CODE",{});var ok=i(Pi);au=s(ok,"input_ids"),ok.forEach(t),ru=s($e,` (which are the
...
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Bi=r(He,"CODE",{});var uk=i(Bi);ju=s(uk,"ignore_index"),uk.forEach(t),qu=s(He,`
of the `),Wi=r(He,"CODE",{});var mk=i(Wi);Eu=s(mk,"CrossEntropyLoss"),mk.forEach(t),Fu=s(He,". In Flax, one can use the "),Ri=r(He,"CODE",{});var fk=i(Ri);Mu=s(fk,"decoder_attention_mask"),fk.forEach(t),Cu=s(He,` to ignore padded tokens from
...
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Zc.forEach(t),bk.forEach(t),rc=c(n),jt=r(n,"P",{});var Ur=i(jt);Gu=s(Ur,"According to "),Ko=r(Ur,"A",{href:!0,rel:!0});var vk=i(Ko);Uu=s(vk,"this forum post"),vk.forEach(t),Bu=s(Ur,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Yo=r(Ur,"A",{href:!0,rel:!0});var yk=i(Yo);Wu=s(yk,"paper"),yk.forEach(t),Ru=s(Ur,` for the task prefixes
...
use of token type ids, therefore a list of zeros is returned.`),Tv.forEach(t),dp.forEach(t),Nf=c(Ve),wr=r(Ve,"DIV",{class:!0});var bv=i(wr);v(xs.$$.fragment,bv),bv.forEach(t),Ve.forEach(t),jc=c(n),Bt=r(n,"H2",{class:!0});var cp=i(Bt);zn=r(cp,"A",{id:!0,class:!0,href:!0});var kv=i(zn);gl=r(kv,"SPAN",{});var vv=i(gl);v(zs.$$.fragment,vv),vv.forEach(t),kv.forEach(t),Of=c(cp),Tl=r(cp,"SPAN",{});var yv=i(Tl);Lf=s(yv,"T5TokenizerFast"),yv.forEach(t),cp.forEach(t),qc=c(n),Se=r(n,"DIV",{class:!0});var Nt=i(Se);v(js.$$.fragment,Nt),Af=c(Nt),Wt=r(Nt,"P",{});var Vr=i(Wt);If=s(Vr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),bl=r(Vr,"EM",{});var wv=i(bl);Df=s(wv,"tokenizers"),wv.forEach(t),Sf=s(Vr,` library). Based on
`),qs=r(Vr,"A",{href:!0,rel:!0});var $v=i(qs);Gf=s($v,"Unigram"),$v.forEach(t),Uf=s(Vr,"."),Vr.forEach(t),Bf=c(Nt),Es=r(Nt,"P",{});var pp=i(Es);Wf=s(pp,"This tokenizer inherits from "),$r=r(pp,"A",{href:!0});var xv=i($r);Rf=s(xv,"PreTrainedTokenizerFast"),xv.forEach(t),Hf=s(pp,` which contains most of the main methods. Users should
