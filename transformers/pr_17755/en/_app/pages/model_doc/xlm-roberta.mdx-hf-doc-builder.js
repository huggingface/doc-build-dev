...
<span class="hljs-number">0.1</span>`}}),{c(){T(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){w(d,h,m),g=!0},p:le,i(h){g||($(d.$$.fragment,h),g=!0)},o(h){M(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function W5(x){let d,g,h,m,_;return{c(){d=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),_=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var f=a(d);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(f,"CODE",{});var R=a(h);m=i(R,"Module"),R.forEach(t),_=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(l,f){b(l,d,f),e(d,g),e(d,h),e(h,m),e(d,_)},d(l){l&&t(d)}}}function B5(x){let d,g,h,m,_;return m=new de({props:{code:`import torch
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17755/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17755/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17755/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17755/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Y$=p(nt),sh=s(nt,"P",{});var e5=a(sh);Z$=i(e5,"Finally, this model supports inherent JAX features such as:"),e5.forEach(t),eM=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var t5=a(ah);Wi=s(t5,"A",{href:!0,rel:!0});var o5=a(Wi);tM=i(o5,"Just-In-Time (JIT) compilation"),o5.forEach(t),t5.forEach(t),oM=p(Is),rh=s(Is,"LI",{});var n5=a(rh);Bi=s(n5,"A",{href:!0,rel:!0});var s5=a(Bi);nM=i(s5,"Automatic Differentiation"),s5.forEach(t),n5.forEach(t),sM=p(Is),ih=s(Is,"LI",{});var a5=a(ih);Ui=s(a5,"A",{href:!0,rel:!0});var r5=a(Ui);aM=i(r5,"Vectorization"),r5.forEach(t),a5.forEach(t),rM=p(Is),lh=s(Is,"LI",{});var i5=a(lh);Qi=s(i5,"A",{href:!0,rel:!0});var l5=a(Qi);iM=i(l5,"Parallelization"),l5.forEach(t),i5.forEach(t),Is.forEach(t),lM=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);dM=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var d5=a(Md);cM=i(d5,"FlaxRobertaForTokenClassification"),d5.forEach(t),pM=i(ff,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),ff.forEach(t),hM=p(nt),qt=s(nt,"DIV",{class:!0});var Ds=a(qt);y(Vi.$$.fragment,Ds),mM=p(Ds),Jo=s(Ds,"P",{});var Gd=a(Jo);uM=i(Gd,"The "),dh=s(Gd,"CODE",{});var c5=a(dh);fM=i(c5,"FlaxRobertaPreTrainedModel"),c5.forEach(t),gM=i(Gd," forward method, overrides the "),ch=s(Gd,"CODE",{});var p5=a(ch);_M=i(p5,"__call__"),p5.forEach(t),bM=i(Gd," special method."),Gd.forEach(t),kM=p(Ds),y(ys.$$.fragment,Ds),vM=p(Ds),y(ws.$$.fragment,Ds),Ds.forEach(t),nt.forEach(t),Sm=p(o),Ko=s(o,"H2",{class:!0});var gf=a(Ko);$s=s(gf,"A",{id:!0,class:!0,href:!0});var h5=a($s);ph=s(h5,"SPAN",{});var m5=a(ph);y(Ji.$$.fragment,m5),m5.forEach(t),h5.forEach(t),TM=p(gf),hh=s(gf,"SPAN",{});var u5=a(hh);yM=i(u5,"FlaxXLMRobertaForQuestionAnswering"),u5.forEach(t),gf.forEach(t),Wm=p(o),Pe=s(o,"DIV",{class:!0});var st=a(Pe);y(Ki.$$.fragment,st),wM=p(st),Go=s(st,"P",{});var Yd=a(Go);$M=i(Yd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
