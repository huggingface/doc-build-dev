...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16244/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16244/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Wx]},$$scope:{ctx:E}}}),Ns=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16244/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16244/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16244/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16244/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16244/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16244/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nv=l(Ot),f(cn.$$.fragment,Ot),av=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),sv=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);rv=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Qw=s(xi);iv=i(Qw,"TFMBartModel"),Qw.forEach(t),dv=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var Jw=s(oc);lv=i(Jw,"__call__"),Jw.forEach(t),cv=i(Ui," special method."),Ui.forEach(t),pv=l(Dt),f(pn.$$.fragment,Dt),hv=l(Dt),nc=a(Dt,"P",{});var Kw=s(nc);uv=i(Kw,"Example:"),Kw.forEach(t),mv=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Zw=s(hn);ac=a(Zw,"SPAN",{});var Yw=s(ac);f(Ps.$$.fragment,Yw),Yw.forEach(t),Zw.forEach(t),fv=l(gu),sc=a(gu,"SPAN",{});var e4=s(sc);_v=i(e4,"TFMBartForConditionalGeneration"),e4.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gv=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);kv=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var t4=s(zi);bv=i(t4,"TFPreTrainedModel"),t4.forEach(t),vv=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),yv=l(Lt),As=a(Lt,"P",{});var bu=s(As);Tv=i(bu,"This model is also a "),Is=a(bu,"A",{href:!0,rel:!0});var o4=s(Is);Mv=i(o4,"tf.keras.Model"),o4.forEach(t),wv=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),xv=l(Lt),f(un.$$.fragment,Lt),zv=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Ns.$$.fragment,We),qv=l(We),xo=a(We,"P",{});var Xi=s(xo);Bv=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var n4=s(qi);$v=i(n4,"TFMBartForConditionalGeneration"),n4.forEach(t),Fv=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var a4=s(rc);jv=i(a4,"__call__"),a4.forEach(t),Ev=i(Xi," special method."),Xi.forEach(t),Pv=l(We),f(mn.$$.fragment,We),Cv=l(We),ic=a(We,"P",{});var s4=s(ic);Sv=i(s4,"Summarization example:"),s4.forEach(t),Av=l(We),f(Os.$$.fragment,We),Iv=l(We),dc=a(We,"P",{});var r4=s(dc);Nv=i(r4,"Mask filling example:"),r4.forEach(t),Ov=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),oh=l(o),zo=a(o,"H2",{class:!0});var vu=s(zo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var i4=s(fn);lc=a(i4,"SPAN",{});var d4=s(lc);f(Ls.$$.fragment,d4),d4.forEach(t),i4.forEach(t),Dv=l(vu),cc=a(vu,"SPAN",{});var l4=s(cc);Lv=i(l4,"FlaxMBartModel"),l4.forEach(t),vu.forEach(t),nh=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),Gv=l(me),Ws=a(me,"P",{});var yu=s(Ws);Wv=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=a(yu,"A",{href:!0});var c4=s(Bi);Rv=i(c4,"FlaxPreTrainedModel"),c4.forEach(t),Uv=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),rr=a(xu,"A",{href:!0,rel:!0});var F4=s(rr);Py=i(F4,"flax.nn.Module"),F4.forEach(t),Cy=i(xu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sy=l(fe),Mc=a(fe,"P",{});var j4=s(Mc);Ay=i(j4,"Finally, this model supports inherent JAX features such as:"),j4.forEach(t),Iy=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var E4=s(wc);ir=a(E4,"A",{href:!0,rel:!0});var P4=s(ir);Ny=i(P4,"Just-In-Time (JIT) compilation"),P4.forEach(t),E4.forEach(t),Oy=l(jn),xc=a(jn,"LI",{});var C4=s(xc);dr=a(C4,"A",{href:!0,rel:!0});var S4=s(dr);Dy=i(S4,"Automatic Differentiation"),S4.forEach(t),C4.forEach(t),Ly=l(jn),zc=a(jn,"LI",{});var A4=s(zc);lr=a(A4,"A",{href:!0,rel:!0});var I4=s(lr);Gy=i(I4,"Vectorization"),I4.forEach(t),A4.forEach(t),Wy=l(jn),qc=a(jn,"LI",{});var N4=s(qc);cr=a(N4,"A",{href:!0,rel:!0});var O4=s(cr);Ry=i(O4,"Parallelization"),O4.forEach(t),N4.forEach(t),jn.forEach(t),Uy=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xy=l(Re),$o=a(Re,"P",{});var Ji=s($o);Hy=i(Ji,"The "),Bc=a(Ji,"CODE",{});var D4=s(Bc);Vy=i(D4,"FlaxMBartPreTrainedModel"),D4.forEach(t),Qy=i(Ji,"forward method, overrides the "),$c=a(Ji,"CODE",{});var L4=s($c);Jy=i(L4,"__call__"),L4.forEach(t),Ky=i(Ji," special method."),Ji.forEach(t),Zy=l(Re),f(kn.$$.fragment,Re),Yy=l(Re),Fc=a(Re,"P",{});var G4=s(Fc);eT=i(G4,"Summarization example:"),G4.forEach(t),tT=l(Re),f(hr.$$.fragment,Re),oT=l(Re),jc=a(Re,"P",{});var W4=s(jc);nT=i(W4,"Mask filling example:"),W4.forEach(t),aT=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),sT=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),rT=l(Ki),Ec=a(Ki,"P",{});var R4=s(Ec);iT=i(R4,"Example:"),R4.forEach(t),dT=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),lT=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),cT=l(Zi),Pc=a(Zi,"P",{});var U4=s(Pc);pT=i(U4,"Example:"),U4.forEach(t),hT=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),Fo=a(o,"H2",{class:!0});var zu=s(Fo);bn=a(zu,"A",{id:!0,class:!0,href:!0});var X4=s(bn);Cc=a(X4,"SPAN",{});var H4=s(Cc);f(kr.$$.fragment,H4),H4.forEach(t),X4.forEach(t),uT=l(zu),Sc=a(zu,"SPAN",{});var V4=s(Sc);mT=i(V4,"FlaxMBartForSequenceClassification"),V4.forEach(t),zu.forEach(t),ih=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(br.$$.fragment,oe),fT=l(oe),Ac=a(oe,"P",{});var Q4=s(Ac);_T=i(Q4,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Q4.forEach(t),gT=l(oe),vr=a(oe,"P",{});var qu=s(vr);kT=i(qu,"This model inherits from "),Fi=a(qu,"A",{href:!0});var J4=s(Fi);bT=i(J4,"FlaxPreTrainedModel"),J4.forEach(t),vT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),yT=l(oe),yr=a(oe,"P",{});var Bu=s(yr);TT=i(Bu,`This model is also a Flax Linen
`),Tr=a(Bu,"A",{href:!0,rel:!0});var K4=s(Tr);MT=i(K4,"flax.nn.Module"),K4.forEach(t),wT=i(Bu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),xT=l(oe),Ic=a(oe,"P",{});var Z4=s(Ic);zT=i(Z4,"Finally, this model supports inherent JAX features such as:"),Z4.forEach(t),qT=l(oe),_t=a(oe,"UL",{});var En=s(_t);Nc=a(En,"LI",{});var Y4=s(Nc);Mr=a(Y4,"A",{href:!0,rel:!0});var ex=s(Mr);BT=i(ex,"Just-In-Time (JIT) compilation"),ex.forEach(t),Y4.forEach(t),$T=l(En),Oc=a(En,"LI",{});var tx=s(Oc);wr=a(tx,"A",{href:!0,rel:!0});var ox=s(wr);FT=i(ox,"Automatic Differentiation"),ox.forEach(t),tx.forEach(t),jT=l(En),Dc=a(En,"LI",{});var nx=s(Dc);xr=a(nx,"A",{href:!0,rel:!0});var ax=s(xr);ET=i(ax,"Vectorization"),ax.forEach(t),nx.forEach(t),PT=l(En),Lc=a(En,"LI",{});var sx=s(Lc);zr=a(sx,"A",{href:!0,rel:!0});var rx=s(zr);CT=i(rx,"Parallelization"),rx.forEach(t),sx.forEach(t),En.forEach(t),ST=l(oe),Oe=a(oe,"DIV",{class:!0});var Wt=s(Oe);f(qr.$$.fragment,Wt),AT=l(Wt),jo=a(Wt,"P",{});var Yi=s(jo);IT=i(Yi,"The "),Gc=a(Yi,"CODE",{});var ix=s(Gc);NT=i(ix,"FlaxMBartPreTrainedModel"),ix.forEach(t),OT=i(Yi,"forward method, overrides the "),Wc=a(Yi,"CODE",{});var dx=s(Wc);DT=i(dx,"__call__"),dx.forEach(t),LT=i(Yi," special method."),Yi.forEach(t),GT=l(Wt),f(vn.$$.fragment,Wt),WT=l(Wt),Rc=a(Wt,"P",{});var lx=s(Rc);RT=i(lx,"Example:"),lx.forEach(t),UT=l(Wt),f(Br.$$.fragment,Wt),Wt.forEach(t),XT=l(oe),qt=a(oe,"DIV",{class:!0});var ed=s(qt);f($r.$$.fragment,ed),HT=l(ed),Uc=a(ed,"P",{});var cx=s(Uc);VT=i(cx,"Example:"),cx.forEach(t),QT=l(ed),f(Fr.$$.fragment,ed),ed.forEach(t),JT=l(oe),Bt=a(oe,"DIV",{class:!0});var td=s(Bt);f(jr.$$.fragment,td),KT=l(td),Xc=a(td,"P",{});var px=s(Xc);ZT=i(px,"Example:"),px.forEach(t),YT=l(td),f(Er.$$.fragment,td),td.forEach(t),oe.forEach(t),dh=l(o),Eo=a(o,"H2",{class:!0});var $u=s(Eo);yn=a($u,"A",{id:!0,class:!0,href:!0});var hx=s(yn);Hc=a(hx,"SPAN",{});var ux=s(Hc);f(Pr.$$.fragment,ux),ux.forEach(t),hx.forEach(t),e1=l($u),Vc=a($u,"SPAN",{});var mx=s(Vc);t1=i(mx,"FlaxMBartForQuestionAnswering"),mx.forEach(t),$u.forEach(t),lh=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Cr.$$.fragment,ne),o1=l(ne),Po=a(ne,"P",{});var od=s(Po);n1=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
