import{S as e1,i as t1,s as o1,e as r,k as l,w as k,t as n,Y as Oo,M as n1,c as a,d as t,m as d,a as i,x as v,h as s,Z as Po,b as c,F as e,g as h,y as b,q as T,o as y,B as L}from"../../chunks/vendor-6b77c823.js";import{T as Pe}from"../../chunks/Tip-39098574.js";import{D as S}from"../../chunks/Docstring-abef54e3.js";import{C as at}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ze}from"../../chunks/IconCopyLink-7a11ce68.js";function s1(W){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
...
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function c1(W){let p,x,g,u,$,w,_,M,de,X,E,ne,Q,ce,Z,H,he,re,R,O,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,ae,te,N,ue,ie,P,_e,B,oe;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=r("p"),ne=n("This second option is useful when using "),Q=r("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r("code"),he=n("model(inputs)"),re=n("."),R=l(),O=r("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),U=r("code"),ae=n("model([input_ids, attention_mask])"),te=n(" or "),N=r("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),P=r("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var J=i(u);$=a(J,"LI",{});var Le=i($);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);de=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),X=d(m),E=a(m,"P",{});var j=i(E);ne=s(j,"This second option is useful when using "),Q=a(j,"CODE",{});var Fe=i(Q);ce=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),Z=s(j,` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a(j,"CODE",{});var xe=i(H);he=s(xe,"model(inputs)"),xe.forEach(t),re=s(j,"."),j.forEach(t),R=d(m),O=a(m,"P",{});var be=i(O);se=s(be,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),U=a(G,"CODE",{});var ke=i(U);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=a(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),P=a(A,"LI",{});var we=i(P);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,de),h(m,X,F),h(m,E,F),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,re),h(m,R,F),h(m,O,F),e(O,se),h(m,K,F),h(m,z,F),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,ae),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,P),e(P,_e),e(P,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(O),m&&t(K),m&&t(z)}}}function h1(W){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function m1(W){let p,x,g,u,$,w,_,M,de,X,E,ne,Q,ce,Z,H,he,re,R,O,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,ae,te,N,ue,ie,P,_e,B,oe;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=r("p"),ne=n("This second option is useful when using "),Q=r("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r("code"),he=n("model(inputs)"),re=n("."),R=l(),O=r("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=r("ul"),q=r("li"),me=n("a single Tensor with "),D=r("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=r("code"),pe=n("model(inputs_ids)"),ge=l(),C=r("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),ae=n("model([input_ids, attention_mask])"),te=n(" or "),N=r("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),P=r("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var J=i(u);$=a(J,"LI",{});var Le=i($);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);de=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),X=d(m),E=a(m,"P",{});var j=i(E);ne=s(j,"This second option is useful when using "),Q=a(j,"CODE",{});var Fe=i(Q);ce=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),Z=s(j,` method which currently requires having all the
...
first positional argument :`),be.forEach(t),K=d(m),z=a(m,"UL",{});var A=i(z);q=a(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=a(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=a(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=a(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(G,"CODE",{});var ke=i(U);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=a(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),P=a(A,"LI",{});var we=i(P);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,de),h(m,X,F),h(m,E,F),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,re),h(m,R,F),h(m,O,F),e(O,se),h(m,K,F),h(m,z,F),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,ae),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,P),e(P,_e),e(P,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(O),m&&t(K),m&&t(z)}}}function f1(W){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function p1(W){let p,x,g,u,$,w,_,M,de,X,E,ne,Q,ce,Z,H,he,re,R,O,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,ae,te,N,ue,ie,P,_e,B,oe;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=r("p"),ne=n("This second option is useful when using "),Q=r("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r("code"),he=n("model(inputs)"),re=n("."),R=l(),O=r("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=r("ul"),q=r("li"),me=n("a single Tensor with "),D=r("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=r("code"),pe=n("model(inputs_ids)"),ge=l(),C=r("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),ae=n("model([input_ids, attention_mask])"),te=n(" or "),N=r("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),P=r("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var J=i(u);$=a(J,"LI",{});var Le=i($);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);de=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),X=d(m),E=a(m,"P",{});var j=i(E);ne=s(j,"This second option is useful when using "),Q=a(j,"CODE",{});var Fe=i(Q);ce=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),Z=s(j,` method which currently requires having all the
...
first positional argument :`),be.forEach(t),K=d(m),z=a(m,"UL",{});var A=i(z);q=a(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=a(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=a(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=a(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(G,"CODE",{});var ke=i(U);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=a(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),P=a(A,"LI",{});var we=i(P);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,de),h(m,X,F),h(m,E,F),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,re),h(m,R,F),h(m,O,F),e(O,se),h(m,K,F),h(m,z,F),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,ae),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,P),e(P,_e),e(P,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(O),m&&t(K),m&&t(z)}}}function g1(W){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function u1(W){let p,x,g,u,$,w,_,M,de,X,E,ne,Q,ce,Z,H,he,re,R,O,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,ae,te,N,ue,ie,P,_e,B,oe;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=r("p"),ne=n("This second option is useful when using "),Q=r("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r("code"),he=n("model(inputs)"),re=n("."),R=l(),O=r("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=r("ul"),q=r("li"),me=n("a single Tensor with "),D=r("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=r("code"),pe=n("model(inputs_ids)"),ge=l(),C=r("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),ae=n("model([input_ids, attention_mask])"),te=n(" or "),N=r("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),P=r("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var J=i(u);$=a(J,"LI",{});var Le=i($);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);de=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),X=d(m),E=a(m,"P",{});var j=i(E);ne=s(j,"This second option is useful when using "),Q=a(j,"CODE",{});var Fe=i(Q);ce=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),Z=s(j,` method which currently requires having all the
...
first positional argument :`),be.forEach(t),K=d(m),z=a(m,"UL",{});var A=i(z);q=a(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=a(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=a(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=a(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(G,"CODE",{});var ke=i(U);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=a(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),P=a(A,"LI",{});var we=i(P);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,de),h(m,X,F),h(m,E,F),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,re),h(m,R,F),h(m,O,F),e(O,se),h(m,K,F),h(m,z,F),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,ae),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,P),e(P,_e),e(P,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(O),m&&t(K),m&&t(z)}}}function _1(W){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function w1(W){let p,x,g,u,$,w,_,M,de,X,E,ne,Q,ce,Z,H,he,re,R,O,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,ae,te,N,ue,ie,P,_e,B,oe;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=r("p"),ne=n("This second option is useful when using "),Q=r("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r("code"),he=n("model(inputs)"),re=n("."),R=l(),O=r("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=r("ul"),q=r("li"),me=n("a single Tensor with "),D=r("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=r("code"),pe=n("model(inputs_ids)"),ge=l(),C=r("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),ae=n("model([input_ids, attention_mask])"),te=n(" or "),N=r("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),P=r("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var J=i(u);$=a(J,"LI",{});var Le=i($);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);de=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),X=d(m),E=a(m,"P",{});var j=i(E);ne=s(j,"This second option is useful when using "),Q=a(j,"CODE",{});var Fe=i(Q);ce=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),Z=s(j,` method which currently requires having all the
...
first positional argument :`),be.forEach(t),K=d(m),z=a(m,"UL",{});var A=i(z);q=a(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=a(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=a(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=a(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(G,"CODE",{});var ke=i(U);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=a(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),P=a(A,"LI",{});var we=i(P);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,de),h(m,X,F),h(m,E,F),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,re),h(m,R,F),h(m,O,F),e(O,se),h(m,K,F),h(m,z,F),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,ae),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,P),e(P,_e),e(P,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(O),m&&t(K),m&&t(z)}}}function k1(W){let p,x,g,u,$;return{c(){p=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=a(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function v1(W){let p,x,g,u,$,w,_,M,de,X,E,ne,Q,ce,Z,H,he,re,R,O,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,ae,te,N,ue,ie,P,_e,B,oe;return{c(){p=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=r("p"),ne=n("This second option is useful when using "),Q=r("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r("code"),he=n("model(inputs)"),re=n("."),R=l(),O=r("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=r("ul"),q=r("li"),me=n("a single Tensor with "),D=r("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=r("code"),pe=n("model(inputs_ids)"),ge=l(),C=r("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),ae=n("model([input_ids, attention_mask])"),te=n(" or "),N=r("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),P=r("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=a(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=a(m,"UL",{});var J=i(u);$=a(J,"LI",{});var Le=i($);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=a(J,"LI",{});var $e=i(M);de=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),X=d(m),E=a(m,"P",{});var j=i(E);ne=s(j,"This second option is useful when using "),Q=a(j,"CODE",{});var Fe=i(Q);ce=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),Z=s(j,` method which currently requires having all the
...
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),as=new S({props:{name:"forward",anchor:"transformers.LongformerModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_longformer.py#L1608",parametersDescription:[{anchor:"transformers.LongformerModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerConfig"
...
`}}),Vo=new Pe({props:{$$slots:{default:[s1]},$$scope:{ctx:W}}}),is=new at({props:{code:`import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ps=new S({props:{name:"forward",anchor:"transformers.LongformerForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_longformer.py#L1751",parametersDescription:[{anchor:"transformers.LongformerForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
`}}),Ko=new Pe({props:{$$slots:{default:[r1]},$$scope:{ctx:W}}}),gs=new at({props:{code:`import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bs=new S({props:{name:"forward",anchor:"transformers.LongformerForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_longformer.py#L1852",parametersDescription:[{anchor:"transformers.LongformerForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
`}}),Xo=new Pe({props:{$$slots:{default:[a1]},$$scope:{ctx:W}}}),Ts=new at({props:{code:`import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Es=new S({props:{name:"forward",anchor:"transformers.LongformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_longformer.py#L2199",parametersDescription:[{anchor:"transformers.LongformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
`}}),Zo=new Pe({props:{$$slots:{default:[i1]},$$scope:{ctx:W}}}),zs=new at({props:{code:`from transformers import LongformerTokenizer, LongformerForMultipleChoice
import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),As=new S({props:{name:"forward",anchor:"transformers.LongformerForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_longformer.py#L2118",parametersDescription:[{anchor:"transformers.LongformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
`}}),tn=new Pe({props:{$$slots:{default:[l1]},$$scope:{ctx:W}}}),Is=new at({props:{code:`from transformers import LongformerTokenizer, LongformerForTokenClassification
import torch
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new S({props:{name:"forward",anchor:"transformers.LongformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"start_positions",val:": typing.Optional[torch.Tensor] = None"},{name:"end_positions",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_longformer.py#L1978",parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
`}}),nn=new Pe({props:{$$slots:{default:[d1]},$$scope:{ctx:W}}}),Hs=new at({props:{code:`from transformers import LongformerTokenizer, LongformerForQuestionAnswering
import torch
...
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),rn=new Pe({props:{$$slots:{default:[c1]},$$scope:{ctx:W}}}),Ys=new S({props:{name:"call",anchor:"transformers.TFLongformerModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_tf_longformer.py#L2028",parametersDescription:[{anchor:"transformers.TFLongformerModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
behaviors between training and evaluation).`,name:"training"}]}}),an=new Pe({props:{$$slots:{default:[h1]},$$scope:{ctx:W}}}),Zs=new ze({}),er=new S({props:{name:"class transformers.TFLongformerForMaskedLM",anchor:"transformers.TFLongformerForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_tf_longformer.py#L2094",parametersDescription:[{anchor:"transformers.TFLongformerForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),dn=new Pe({props:{$$slots:{default:[m1]},$$scope:{ctx:W}}}),rr=new S({props:{name:"call",anchor:"transformers.TFLongformerForMaskedLM.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_tf_longformer.py#L2111",parametersDescription:[{anchor:"transformers.TFLongformerForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
`}}),cn=new Pe({props:{$$slots:{default:[f1]},$$scope:{ctx:W}}}),ar=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMaskedLM
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),mn=new Pe({props:{$$slots:{default:[p1]},$$scope:{ctx:W}}}),mr=new S({props:{name:"call",anchor:"transformers.TFLongformerForQuestionAnswering.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_tf_longformer.py#L2220",parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
`}}),fn=new Pe({props:{$$slots:{default:[g1]},$$scope:{ctx:W}}}),fr=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForQuestionAnswering
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),gn=new Pe({props:{$$slots:{default:[u1]},$$scope:{ctx:W}}}),kr=new S({props:{name:"call",anchor:"transformers.TFLongformerForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_tf_longformer.py#L2389",parametersDescription:[{anchor:"transformers.TFLongformerForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
`}}),un=new Pe({props:{$$slots:{default:[_1]},$$scope:{ctx:W}}}),vr=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
`}}),kn=new Pe({props:{$$slots:{default:[k1]},$$scope:{ctx:W}}}),xr=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16244/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bn=new Pe({props:{$$slots:{default:[v1]},$$scope:{ctx:W}}}),Or=new S({props:{name:"call",anchor:"transformers.TFLongformerForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16244/src/transformers/models/longformer/modeling_tf_longformer.py#L2513",parametersDescription:[{anchor:"transformers.TFLongformerForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16244/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16244/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
`}}),Tn=new Pe({props:{$$slots:{default:[b1]},$$scope:{ctx:W}}}),Pr=new at({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMultipleChoice
import tensorflow as tf
...
WikiHop and TriviaQA.`),ie=l(),P=r("p"),_e=n("Tips:"),B=l(),oe=r("ul"),m=r("li"),F=n("Since the Longformer is based on RoBERTa, it doesn\u2019t have "),J=r("code"),Le=n("token_type_ids"),$e=n(`. You don\u2019t need to indicate which
token belongs to which segment. Just separate your segments with the separation token `),j=r("code"),Fe=n("tokenizer.sep_token"),xe=n(` (or
`),be=r("code"),A=n("</s>"),V=n(")."),Te=l(),le=r("p"),G=n("This model was contributed by "),ke=r("a"),Me=n("beltagy"),we=n(". The Authors\u2019 code can be found "),ve=r("a"),jh=n("here"),Ah=n("."),sd=l(),Pt=r("h2"),jo=r("a"),Va=r("span"),k($n.$$.fragment),Ih=l(),Ga=r("span"),Nh=n("Longformer Self Attention"),rd=l(),ye=r("p"),Sh=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
attend \u201Clocally\u201D to each other meaning that each token attends to its `),ad=new Oo,id=n(` previous tokens and
`),ld=new Oo,dd=n(" succeding tokens with "),cd=new Oo,hd=n(` being the window length as defined in
...
different `),md=new Oo,fd=n(` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
...
that every \u201Clocally\u201D attending token not only attends to tokens within its window `),gd=new Oo,ud=n(`, but also to all \u201Cglobally\u201D
...
represents the memory and time bottleneck, can be reduced from `),bd=new Oo,Td=n(` to
`),yd=new Oo,Ld=n(", with "),$d=new Oo,Fd=n(" being the sequence length and "),xd=new Oo,Md=n(` being the average window
size. It is assumed that the number of \u201Cglobally\u201D attending tokens is insignificant as compared to the number of
\u201Clocally\u201D attending tokens.`),Ed=l(),No=r("p"),dm=n("For more information, please refer to the official "),Fn=r("a"),cm=n("paper"),hm=n("."),zd=l(),jt=r("h2"),So=r("a"),si=r("span"),k(xn.$$.fragment),mm=l(),ri=r("span"),fm=n("Training"),qd=l(),At=r("p"),Sr=r("a"),pm=n("LongformerForMaskedLM"),gm=n(" is trained the exact same way "),Dr=r("a"),um=n("RobertaForMaskedLM"),_m=n(` is
trained and should be used as follows:`),Cd=l(),k(Mn.$$.fragment),Od=l(),It=r("h2"),Do=r("a"),ai=r("span"),k(En.$$.fragment),wm=l(),ii=r("span"),km=n("LongformerConfig"),Pd=l(),je=r("div"),k(zn.$$.fragment),vm=l(),Nt=r("p"),bm=n("This is the configuration class to store the configuration of a "),Br=r("a"),Tm=n("LongformerModel"),ym=n(" or a "),Wr=r("a"),Lm=n("TFLongformerModel"),$m=n(`. It
...
without the O(n^2) increase in memory and compute.`),op=l(),rs=r("p"),np=n("The self-attention module "),Pi=r("code"),sp=n("LongformerSelfAttention"),rp=n(` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),ap=l(),Ge=r("div"),k(as.$$.fragment),ip=l(),ao=r("p"),lp=n("The "),Yr=r("a"),dp=n("LongformerModel"),cp=n(" forward method, overrides the "),ji=r("code"),hp=n("__call__"),mp=n(" special method."),fp=l(),k(Vo.$$.fragment),pp=l(),Ai=r("p"),gp=n("Examples:"),up=l(),k(is.$$.fragment),oc=l(),io=r("h2"),Go=r("a"),Ii=r("span"),k(ls.$$.fragment),_p=l(),Ni=r("span"),wp=n("LongformerForMaskedLM"),nc=l(),We=r("div"),k(ds.$$.fragment),kp=l(),cs=r("p"),vp=n("Longformer Model with a "),Si=r("code"),bp=n("language modeling"),Tp=n(" head on top."),yp=l(),hs=r("p"),Lp=n("This model inherits from "),Zr=r("a"),$p=n("PreTrainedModel"),Fp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xp=l(),ms=r("p"),Mp=n("This model is also a PyTorch "),fs=r("a"),Ep=n("torch.nn.Module"),zp=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qp=l(),Ke=r("div"),k(ps.$$.fragment),Cp=l(),lo=r("p"),Op=n("The "),ea=r("a"),Pp=n("LongformerForMaskedLM"),jp=n(" forward method, overrides the "),Di=r("code"),Ap=n("__call__"),Ip=n(" special method."),Np=l(),k(Ko.$$.fragment),Sp=l(),Bi=r("p"),Dp=n("Examples:"),Bp=l(),k(gs.$$.fragment),sc=l(),co=r("h2"),Jo=r("a"),Wi=r("span"),k(us.$$.fragment),Wp=l(),Qi=r("span"),Qp=n("LongformerForSequenceClassification"),rc=l(),Qe=r("div"),k(_s.$$.fragment),Hp=l(),Hi=r("p"),Rp=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fg=l(),Je=r("div"),k(Es.$$.fragment),xg=l(),fo=r("p"),Mg=n("The "),sa=r("a"),Eg=n("LongformerForMultipleChoice"),zg=n(" forward method, overrides the "),Xi=r("code"),qg=n("__call__"),Cg=n(" special method."),Og=l(),k(Zo.$$.fragment),Pg=l(),Yi=r("p"),jg=n("Example:"),Ag=l(),k(zs.$$.fragment),lc=l(),po=r("h2"),en=r("a"),Zi=r("span"),k(qs.$$.fragment),Ig=l(),el=r("span"),Ng=n("LongformerForTokenClassification"),dc=l(),Re=r("div"),k(Cs.$$.fragment),Sg=l(),tl=r("p"),Dg=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Bg=l(),Os=r("p"),Wg=n("This model inherits from "),ra=r("a"),Qg=n("PreTrainedModel"),Hg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rg=l(),Ps=r("p"),Ug=n("This model is also a PyTorch "),js=r("a"),Vg=n("torch.nn.Module"),Gg=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),L_=l(),k(dn.$$.fragment),$_=l(),Ze=r("div"),k(rr.$$.fragment),F_=l(),yo=r("p"),x_=n("The "),fa=r("a"),M_=n("TFLongformerForMaskedLM"),E_=n(" forward method, overrides the "),wl=r("code"),z_=n("__call__"),q_=n(" special method."),C_=l(),k(cn.$$.fragment),O_=l(),kl=r("p"),P_=n("Example:"),j_=l(),k(ar.$$.fragment),uc=l(),Lo=r("h2"),hn=r("a"),vl=r("span"),k(ir.$$.fragment),A_=l(),bl=r("span"),I_=n("TFLongformerForQuestionAnswering"),_c=l(),Ie=r("div"),k(lr.$$.fragment),N_=l(),$o=r("p"),S_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tw=l(),k(gn.$$.fragment),yw=l(),tt=r("div"),k(kr.$$.fragment),Lw=l(),Mo=r("p"),$w=n("The "),_a=r("a"),Fw=n("TFLongformerForSequenceClassification"),xw=n(" forward method, overrides the "),El=r("code"),Mw=n("__call__"),Ew=n(" special method."),zw=l(),k(un.$$.fragment),qw=l(),zl=r("p"),Cw=n("Example:"),Ow=l(),k(vr.$$.fragment),vc=l(),Eo=r("h2"),_n=r("a"),ql=r("span"),k(br.$$.fragment),Pw=l(),Cl=r("span"),jw=n("TFLongformerForTokenClassification"),bc=l(),Se=r("div"),k(Tr.$$.fragment),Aw=l(),Ol=r("p"),Iw=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uw=l(),k(wn.$$.fragment),Vw=l(),ot=r("div"),k(Fr.$$.fragment),Gw=l(),zo=r("p"),Kw=n("The "),ka=r("a"),Jw=n("TFLongformerForTokenClassification"),Xw=n(" forward method, overrides the "),Pl=r("code"),Yw=n("__call__"),Zw=n(" special method."),ek=l(),k(kn.$$.fragment),tk=l(),jl=r("p"),ok=n("Example:"),nk=l(),k(xr.$$.fragment),Tc=l(),qo=r("h2"),vn=r("a"),Al=r("span"),k(Mr.$$.fragment),sk=l(),Il=r("span"),rk=n("TFLongformerForMultipleChoice"),yc=l(),De=r("div"),k(Er.$$.fragment),ak=l(),Nl=r("p"),ik=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),uk=l(),k(bn.$$.fragment),_k=l(),nt=r("div"),k(Or.$$.fragment),wk=l(),Co=r("p"),kk=n("The "),ba=r("a"),vk=n("TFLongformerForMultipleChoice"),bk=n(" forward method, overrides the "),Sl=r("code"),Tk=n("__call__"),yk=n(" special method."),Lk=l(),k(Tn.$$.fragment),$k=l(),Dl=r("p"),Fk=n("Example:"),xk=l(),k(Pr.$$.fragment),this.h()},l(o){const f=n1('[data-svelte="svelte-1phssyn"]',document.head);p=a(f,"META",{name:!0,content:!0}),f.forEach(t),x=d(o),g=a(o,"H1",{class:!0});var jr=i(g);u=a(jr,"A",{id:!0,class:!0,href:!0});var Bl=i(u);$=a(Bl,"SPAN",{});var Wl=i($);v(w.$$.fragment,Wl),Wl.forEach(t),Bl.forEach(t),_=d(jr),M=a(jr,"SPAN",{});var Ql=i(M);de=s(Ql,"Longformer"),Ql.forEach(t),jr.forEach(t),X=d(o),E=a(o,"P",{});var yn=i(E);ne=a(yn,"STRONG",{});var Hl=i(ne);Q=s(Hl,"DISCLAIMER:"),Hl.forEach(t),ce=s(yn," This model is still a work in progress, if you see something strange, file a "),Z=a(yn,"A",{href:!0,rel:!0});var Rl=i(Z);H=s(Rl,"Github Issue"),Rl.forEach(t),he=s(yn,"."),yn.forEach(t),re=d(o),R=a(o,"H2",{class:!0});var Ar=i(R);O=a(Ar,"A",{id:!0,class:!0,href:!0});var Ul=i(O);se=a(Ul,"SPAN",{});var Vl=i(se);v(K.$$.fragment,Vl),Vl.forEach(t),Ul.forEach(t),z=d(Ar),q=a(Ar,"SPAN",{});var Gl=i(q);me=s(Gl,"Overview"),Gl.forEach(t),Ar.forEach(t),D=d(o),Y=a(o,"P",{});var Ir=i(Y);fe=s(Ir,"The Longformer model was presented in "),I=a(Ir,"A",{href:!0,rel:!0});var Kl=i(I);pe=s(Kl,"Longformer: The Long-Document Transformer"),Kl.forEach(t),ge=s(Ir," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Ir.forEach(t),C=d(o),ee=a(o,"P",{});var Jl=i(ee);U=s(Jl,"The abstract from the paper is the following:"),Jl.forEach(t),ae=d(o),te=a(o,"P",{});var Xl=i(te);N=a(Xl,"EM",{});var Yl=i(N);ue=s(Yl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
contrast to most prior work, we also pretrain Longformer and finetune it on a variety of downstream tasks. Our
pretrained Longformer consistently outperforms RoBERTa on long document tasks and sets new state-of-the-art results on
WikiHop and TriviaQA.`),Yl.forEach(t),Xl.forEach(t),ie=d(o),P=a(o,"P",{});var Zl=i(P);_e=s(Zl,"Tips:"),Zl.forEach(t),B=d(o),oe=a(o,"UL",{});var ed=i(oe);m=a(ed,"LI",{});var Ln=i(m);F=s(Ln,"Since the Longformer is based on RoBERTa, it doesn\u2019t have "),J=a(Ln,"CODE",{});var Mk=i(J);Le=s(Mk,"token_type_ids"),Mk.forEach(t),$e=s(Ln,`. You don\u2019t need to indicate which
token belongs to which segment. Just separate your segments with the separation token `),j=a(Ln,"CODE",{});var Ek=i(j);Fe=s(Ek,"tokenizer.sep_token"),Ek.forEach(t),xe=s(Ln,` (or
`),be=a(Ln,"CODE",{});var zk=i(be);A=s(zk,"</s>"),zk.forEach(t),V=s(Ln,")."),Ln.forEach(t),ed.forEach(t),Te=d(o),le=a(o,"P",{});var Ta=i(le);G=s(Ta,"This model was contributed by "),ke=a(Ta,"A",{href:!0,rel:!0});var qk=i(ke);Me=s(qk,"beltagy"),qk.forEach(t),we=s(Ta,". The Authors\u2019 code can be found "),ve=a(Ta,"A",{href:!0,rel:!0});var Ck=i(ve);jh=s(Ck,"here"),Ck.forEach(t),Ah=s(Ta,"."),Ta.forEach(t),sd=d(o),Pt=a(o,"H2",{class:!0});var $c=i(Pt);jo=a($c,"A",{id:!0,class:!0,href:!0});var Ok=i(jo);Va=a(Ok,"SPAN",{});var Pk=i(Va);v($n.$$.fragment,Pk),Pk.forEach(t),Ok.forEach(t),Ih=d($c),Ga=a($c,"SPAN",{});var jk=i(Ga);Nh=s(jk,"Longformer Self Attention"),jk.forEach(t),$c.forEach(t),rd=d(o),ye=a(o,"P",{});var Oe=i(ye);Sh=s(Oe,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
attend \u201Clocally\u201D to each other meaning that each token attends to its `),ad=Po(Oe),id=s(Oe,` previous tokens and
`),ld=Po(Oe),dd=s(Oe," succeding tokens with "),cd=Po(Oe),hd=s(Oe,` being the window length as defined in
`),Ka=a(Oe,"CODE",{});var Ak=i(Ka);Dh=s(Ak,"config.attention_window"),Ak.forEach(t),Bh=s(Oe,". Note that "),Ja=a(Oe,"CODE",{});var Ik=i(Ja);Wh=s(Ik,"config.attention_window"),Ik.forEach(t),Qh=s(Oe," can be of type "),Xa=a(Oe,"CODE",{});var Nk=i(Xa);Hh=s(Nk,"List"),Nk.forEach(t),Rh=s(Oe,` to define a
different `),md=Po(Oe),fd=s(Oe,` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),Ya=a(Oe,"CODE",{});var Sk=i(Ya);Uh=s(Sk,"BertSelfAttention"),Sk.forEach(t),Vh=s(Oe,"."),Oe.forEach(t),pd=d(o),gt=a(o,"P",{});var ya=i(gt);Gh=s(ya,`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
that every \u201Clocally\u201D attending token not only attends to tokens within its window `),gd=Po(ya),ud=s(ya,`, but also to all \u201Cglobally\u201D
...
represents the memory and time bottleneck, can be reduced from `),bd=Po(wt),Td=s(wt,` to
`),yd=Po(wt),Ld=s(wt,", with "),$d=Po(wt),Fd=s(wt," being the sequence length and "),xd=Po(wt),Md=s(wt,` being the average window
size. It is assumed that the number of \u201Cglobally\u201D attending tokens is insignificant as compared to the number of
\u201Clocally\u201D attending tokens.`),wt.forEach(t),Ed=d(o),No=a(o,"P",{});var Mc=i(No);dm=s(Mc,"For more information, please refer to the official "),Fn=a(Mc,"A",{href:!0,rel:!0});var Uk=i(Fn);cm=s(Uk,"paper"),Uk.forEach(t),hm=s(Mc,"."),Mc.forEach(t),zd=d(o),jt=a(o,"H2",{class:!0});var Ec=i(jt);So=a(Ec,"A",{id:!0,class:!0,href:!0});var Vk=i(So);si=a(Vk,"SPAN",{});var Gk=i(si);v(xn.$$.fragment,Gk),Gk.forEach(t),Vk.forEach(t),mm=d(Ec),ri=a(Ec,"SPAN",{});var Kk=i(ri);fm=s(Kk,"Training"),Kk.forEach(t),Ec.forEach(t),qd=d(o),At=a(o,"P",{});var td=i(At);Sr=a(td,"A",{href:!0});var Jk=i(Sr);pm=s(Jk,"LongformerForMaskedLM"),Jk.forEach(t),gm=s(td," is trained the exact same way "),Dr=a(td,"A",{href:!0});var Xk=i(Dr);um=s(Xk,"RobertaForMaskedLM"),Xk.forEach(t),_m=s(td,` is
trained and should be used as follows:`),td.forEach(t),Cd=d(o),v(Mn.$$.fragment,o),Od=d(o),It=a(o,"H2",{class:!0});var zc=i(It);Do=a(zc,"A",{id:!0,class:!0,href:!0});var Yk=i(Do);ai=a(Yk,"SPAN",{});var Zk=i(ai);v(En.$$.fragment,Zk),Zk.forEach(t),Yk.forEach(t),wm=d(zc),ii=a(zc,"SPAN",{});var ev=i(ii);km=s(ev,"LongformerConfig"),ev.forEach(t),zc.forEach(t),Pd=d(o),je=a(o,"DIV",{class:!0});var it=i(je);v(zn.$$.fragment,it),vm=d(it),Nt=a(it,"P",{});var $a=i(Nt);bm=s($a,"This is the configuration class to store the configuration of a "),Br=a($a,"A",{href:!0});var tv=i(Br);Tm=s(tv,"LongformerModel"),tv.forEach(t),ym=s($a," or a "),Wr=a($a,"A",{href:!0});var ov=i(Wr);Lm=s(ov,"TFLongformerModel"),ov.forEach(t),$m=s($a,`. It
...
Longformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the RoBERTa
`),qn=a(Fa,"A",{href:!0,rel:!0});var sv=i(qn);zm=s(sv,"roberta-base"),sv.forEach(t),qm=s(Fa," architecture with a sequence length 4,096."),Fa.forEach(t),Cm=d(it),Dt=a(it,"P",{});var xa=i(Dt);Om=s(xa,"The "),Hr=a(xa,"A",{href:!0});var rv=i(Hr);Pm=s(rv,"LongformerConfig"),rv.forEach(t),jm=s(xa," class directly inherits "),Rr=a(xa,"A",{href:!0});var av=i(Rr);Am=s(av,"RobertaConfig"),av.forEach(t),Im=s(xa,`. It reuses the same defaults. Please check the
parent class for more information.`),xa.forEach(t),Nm=d(it),li=a(it,"P",{});var iv=i(li);Sm=s(iv,"Example:"),iv.forEach(t),Dm=d(it),v(Cn.$$.fragment,it),it.forEach(t),jd=d(o),Bt=a(o,"H2",{class:!0});var qc=i(Bt);Bo=a(qc,"A",{id:!0,class:!0,href:!0});var lv=i(Bo);di=a(lv,"SPAN",{});var dv=i(di);v(On.$$.fragment,dv),dv.forEach(t),lv.forEach(t),Bm=d(qc),ci=a(qc,"SPAN",{});var cv=i(ci);Wm=s(cv,"LongformerTokenizer"),cv.forEach(t),qc.forEach(t),Ad=d(o),ft=a(o,"DIV",{class:!0});var Ma=i(ft);v(Pn.$$.fragment,Ma),Qm=d(Ma),hi=a(Ma,"P",{});var hv=i(hi);Hm=s(hv,"Construct a Longformer tokenizer."),hv.forEach(t),Rm=d(Ma),Wo=a(Ma,"P",{});var od=i(Wo);Ur=a(od,"A",{href:!0});var mv=i(Ur);Um=s(mv,"LongformerTokenizer"),mv.forEach(t),Vm=s(od," is identical to "),Vr=a(od,"A",{href:!0});var fv=i(Vr);Gm=s(fv,"RobertaTokenizer"),fv.forEach(t),Km=s(od,`. Refer to the superclass for usage examples and
documentation concerning parameters.`),od.forEach(t),Ma.forEach(t),Id=d(o),Wt=a(o,"H2",{class:!0});var Cc=i(Wt);Qo=a(Cc,"A",{id:!0,class:!0,href:!0});var pv=i(Qo);mi=a(pv,"SPAN",{});var gv=i(mi);v(jn.$$.fragment,gv),gv.forEach(t),pv.forEach(t),Jm=d(Cc),fi=a(Cc,"SPAN",{});var uv=i(fi);Xm=s(uv,"LongformerTokenizerFast"),uv.forEach(t),Cc.forEach(t),Nd=d(o),pt=a(o,"DIV",{class:!0});var Ea=i(pt);v(An.$$.fragment,Ea),Ym=d(Ea),In=a(Ea,"P",{});var Oc=i(In);Zm=s(Oc,"Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),pi=a(Oc,"EM",{});var _v=i(pi);ef=s(_v,"tokenizers"),_v.forEach(t),tf=s(Oc," library)."),Oc.forEach(t),of=d(Ea),Ho=a(Ea,"P",{});var nd=i(Ho);Gr=a(nd,"A",{href:!0});var wv=i(Gr);nf=s(wv,"LongformerTokenizerFast"),wv.forEach(t),sf=s(nd," is identical to "),Kr=a(nd,"A",{href:!0});var kv=i(Kr);rf=s(kv,"RobertaTokenizerFast"),kv.forEach(t),af=s(nd,`. Refer to the superclass for usage examples
and documentation concerning parameters.`),nd.forEach(t),Ea.forEach(t),Sd=d(o),Qt=a(o,"H2",{class:!0});var Pc=i(Qt);Ro=a(Pc,"A",{id:!0,class:!0,href:!0});var vv=i(Ro);gi=a(vv,"SPAN",{});var bv=i(gi);v(Nn.$$.fragment,bv),bv.forEach(t),vv.forEach(t),lf=d(Pc),ui=a(Pc,"SPAN",{});var Tv=i(ui);df=s(Tv,"Longformer specific outputs"),Tv.forEach(t),Pc.forEach(t),Dd=d(o),Ht=a(o,"DIV",{class:!0});var jc=i(Ht);v(Sn.$$.fragment,jc),cf=d(jc),_i=a(jc,"P",{});var yv=i(_i);hf=s(yv,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),yv.forEach(t),jc.forEach(t),Bd=d(o),Rt=a(o,"DIV",{class:!0});var Ac=i(Rt);v(Dn.$$.fragment,Ac),mf=d(Ac),wi=a(Ac,"P",{});var Lv=i(wi);ff=s(Lv,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Lv.forEach(t),Ac.forEach(t),Wd=d(o),Ut=a(o,"DIV",{class:!0});var Ic=i(Ut);v(Bn.$$.fragment,Ic),pf=d(Ic),ki=a(Ic,"P",{});var $v=i(ki);gf=s($v,"Base class for masked language models outputs."),$v.forEach(t),Ic.forEach(t),Qd=d(o),Vt=a(o,"DIV",{class:!0});var Nc=i(Vt);v(Wn.$$.fragment,Nc),uf=d(Nc),vi=a(Nc,"P",{});var Fv=i(vi);_f=s(Fv,"Base class for outputs of question answering Longformer models."),Fv.forEach(t),Nc.forEach(t),Hd=d(o),Gt=a(o,"DIV",{class:!0});var Sc=i(Gt);v(Qn.$$.fragment,Sc),wf=d(Sc),bi=a(Sc,"P",{});var xv=i(bi);kf=s(xv,"Base class for outputs of sentence classification models."),xv.forEach(t),Sc.forEach(t),Rd=d(o),Kt=a(o,"DIV",{class:!0});var Dc=i(Kt);v(Hn.$$.fragment,Dc),vf=d(Dc),Ti=a(Dc,"P",{});var Mv=i(Ti);bf=s(Mv,"Base class for outputs of multiple choice Longformer models."),Mv.forEach(t),Dc.forEach(t),Ud=d(o),Jt=a(o,"DIV",{class:!0});var Bc=i(Jt);v(Rn.$$.fragment,Bc),Tf=d(Bc),yi=a(Bc,"P",{});var Ev=i(yi);yf=s(Ev,"Base class for outputs of token classification models."),Ev.forEach(t),Bc.forEach(t),Vd=d(o),Xt=a(o,"DIV",{class:!0});var Wc=i(Xt);v(Un.$$.fragment,Wc),Lf=d(Wc),Li=a(Wc,"P",{});var zv=i(Li);$f=s(zv,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),zv.forEach(t),Wc.forEach(t),Gd=d(o),Yt=a(o,"DIV",{class:!0});var Qc=i(Yt);v(Vn.$$.fragment,Qc),Ff=d(Qc),$i=a(Qc,"P",{});var qv=i($i);xf=s(qv,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),qv.forEach(t),Qc.forEach(t),Kd=d(o),Zt=a(o,"DIV",{class:!0});var Hc=i(Zt);v(Gn.$$.fragment,Hc),Mf=d(Hc),Fi=a(Hc,"P",{});var Cv=i(Fi);Ef=s(Cv,"Base class for masked language models outputs."),Cv.forEach(t),Hc.forEach(t),Jd=d(o),eo=a(o,"DIV",{class:!0});var Rc=i(eo);v(Kn.$$.fragment,Rc),zf=d(Rc),xi=a(Rc,"P",{});var Ov=i(xi);qf=s(Ov,"Base class for outputs of question answering Longformer models."),Ov.forEach(t),Rc.forEach(t),Xd=d(o),to=a(o,"DIV",{class:!0});var Uc=i(to);v(Jn.$$.fragment,Uc),Cf=d(Uc),Mi=a(Uc,"P",{});var Pv=i(Mi);Of=s(Pv,"Base class for outputs of sentence classification models."),Pv.forEach(t),Uc.forEach(t),Yd=d(o),oo=a(o,"DIV",{class:!0});var Vc=i(oo);v(Xn.$$.fragment,Vc),Pf=d(Vc),Ei=a(Vc,"P",{});var jv=i(Ei);jf=s(jv,"Base class for outputs of multiple choice models."),jv.forEach(t),Vc.forEach(t),Zd=d(o),no=a(o,"DIV",{class:!0});var Gc=i(no);v(Yn.$$.fragment,Gc),Af=d(Gc),zi=a(Gc,"P",{});var Av=i(zi);If=s(Av,"Base class for outputs of token classification models."),Av.forEach(t),Gc.forEach(t),ec=d(o),so=a(o,"H2",{class:!0});var Kc=i(so);Uo=a(Kc,"A",{id:!0,class:!0,href:!0});var Iv=i(Uo);qi=a(Iv,"SPAN",{});var Nv=i(qi);v(Zn.$$.fragment,Nv),Nv.forEach(t),Iv.forEach(t),Nf=d(Kc),Ci=a(Kc,"SPAN",{});var Sv=i(Ci);Sf=s(Sv,"LongformerModel"),Sv.forEach(t),Kc.forEach(t),tc=d(o),qe=a(o,"DIV",{class:!0});var st=i(qe);v(es.$$.fragment,st),Df=d(st),Oi=a(st,"P",{});var Dv=i(Oi);Bf=s(Dv,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Dv.forEach(t),Wf=d(st),ts=a(st,"P",{});var Jc=i(ts);Qf=s(Jc,"This model inherits from "),Jr=a(Jc,"A",{href:!0});var Bv=i(Jr);Hf=s(Bv,"PreTrainedModel"),Bv.forEach(t),Rf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lh.forEach(t),Fg=d(yt),Je=a(yt,"DIV",{class:!0});var Lt=i(Je);v(Es.$$.fragment,Lt),xg=d(Lt),fo=a(Lt,"P",{});var Pa=i(fo);Mg=s(Pa,"The "),sa=a(Pa,"A",{href:!0});var vb=i(sa);Eg=s(vb,"LongformerForMultipleChoice"),vb.forEach(t),zg=s(Pa," forward method, overrides the "),Xi=a(Pa,"CODE",{});var bb=i(Xi);qg=s(bb,"__call__"),bb.forEach(t),Cg=s(Pa," special method."),Pa.forEach(t),Og=d(Lt),v(Zo.$$.fragment,Lt),Pg=d(Lt),Yi=a(Lt,"P",{});var Tb=i(Yi);jg=s(Tb,"Example:"),Tb.forEach(t),Ag=d(Lt),v(zs.$$.fragment,Lt),Lt.forEach(t),yt.forEach(t),lc=d(o),po=a(o,"H2",{class:!0});var dh=i(po);en=a(dh,"A",{id:!0,class:!0,href:!0});var yb=i(en);Zi=a(yb,"SPAN",{});var Lb=i(Zi);v(qs.$$.fragment,Lb),Lb.forEach(t),yb.forEach(t),Ig=d(dh),el=a(dh,"SPAN",{});var $b=i(el);Ng=s($b,"LongformerForTokenClassification"),$b.forEach(t),dh.forEach(t),dc=d(o),Re=a(o,"DIV",{class:!0});var $t=i(Re);v(Cs.$$.fragment,$t),Sg=d($t),tl=a($t,"P",{});var Fb=i(tl);Dg=s(Fb,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Fb.forEach(t),Bg=d($t),Os=a($t,"P",{});var ch=i(Os);Wg=s(ch,"This model inherits from "),ra=a(ch,"A",{href:!0});var xb=i(ra);Qg=s(xb,"PreTrainedModel"),xb.forEach(t),Hg=s(ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ch.forEach(t),Rg=d($t),Ps=a($t,"P",{});var hh=i(Ps);Ug=s(hh,"This model is also a PyTorch "),js=a(hh,"A",{href:!0,rel:!0});var Mb=i(js);Vg=s(Mb,"torch.nn.Module"),Mb.forEach(t),Gg=s(hh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hh.forEach(t),Kg=d($t),Xe=a($t,"DIV",{class:!0});var Ft=i(Xe);v(As.$$.fragment,Ft),Jg=d(Ft),go=a(Ft,"P",{});var ja=i(go);Xg=s(ja,"The "),aa=a(ja,"A",{href:!0});var Eb=i(aa);Yg=s(Eb,"LongformerForTokenClassification"),Eb.forEach(t),Zg=s(ja," forward method, overrides the "),ol=a(ja,"CODE",{});var zb=i(ol);eu=s(zb,"__call__"),zb.forEach(t),tu=s(ja," special method."),ja.forEach(t),ou=d(Ft),v(tn.$$.fragment,Ft),nu=d(Ft),nl=a(Ft,"P",{});var qb=i(nl);su=s(qb,"Example:"),qb.forEach(t),ru=d(Ft),v(Is.$$.fragment,Ft),Ft.forEach(t),$t.forEach(t),cc=d(o),uo=a(o,"H2",{class:!0});var mh=i(uo);on=a(mh,"A",{id:!0,class:!0,href:!0});var Cb=i(on);sl=a(Cb,"SPAN",{});var Ob=i(sl);v(Ns.$$.fragment,Ob),Ob.forEach(t),Cb.forEach(t),au=d(mh),rl=a(mh,"SPAN",{});var Pb=i(rl);iu=s(Pb,"LongformerForQuestionAnswering"),Pb.forEach(t),mh.forEach(t),hc=d(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);v(Ss.$$.fragment,xt),lu=d(xt),_o=a(xt,"P",{});var Aa=i(_o);du=s(Aa,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layers on top of the hidden-states output to compute `),al=a(Aa,"CODE",{});var jb=i(al);cu=s(jb,"span start logits"),jb.forEach(t),hu=s(Aa," and "),il=a(Aa,"CODE",{});var Ab=i(il);mu=s(Ab,"span end logits"),Ab.forEach(t),fu=s(Aa,")."),Aa.forEach(t),pu=d(xt),Ds=a(xt,"P",{});var fh=i(Ds);gu=s(fh,"This model inherits from "),ia=a(fh,"A",{href:!0});var Ib=i(ia);uu=s(Ib,"PreTrainedModel"),Ib.forEach(t),_u=s(fh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mh.forEach(t),Tw=d(ct),v(gn.$$.fragment,ct),yw=d(ct),tt=a(ct,"DIV",{class:!0});var qt=i(tt);v(kr.$$.fragment,qt),Lw=d(qt),Mo=a(qt,"P",{});var Ha=i(Mo);$w=s(Ha,"The "),_a=a(Ha,"A",{href:!0});var LT=i(_a);Fw=s(LT,"TFLongformerForSequenceClassification"),LT.forEach(t),xw=s(Ha," forward method, overrides the "),El=a(Ha,"CODE",{});var $T=i(El);Mw=s($T,"__call__"),$T.forEach(t),Ew=s(Ha," special method."),Ha.forEach(t),zw=d(qt),v(un.$$.fragment,qt),qw=d(qt),zl=a(qt,"P",{});var FT=i(zl);Cw=s(FT,"Example:"),FT.forEach(t),Ow=d(qt),v(vr.$$.fragment,qt),qt.forEach(t),ct.forEach(t),vc=d(o),Eo=a(o,"H2",{class:!0});var Eh=i(Eo);_n=a(Eh,"A",{id:!0,class:!0,href:!0});var xT=i(_n);ql=a(xT,"SPAN",{});var MT=i(ql);v(br.$$.fragment,MT),MT.forEach(t),xT.forEach(t),Pw=d(Eh),Cl=a(Eh,"SPAN",{});var ET=i(Cl);jw=s(ET,"TFLongformerForTokenClassification"),ET.forEach(t),Eh.forEach(t),bc=d(o),Se=a(o,"DIV",{class:!0});var ht=i(Se);v(Tr.$$.fragment,ht),Aw=d(ht),Ol=a(ht,"P",{});var zT=i(Ol);Iw=s(zT,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
