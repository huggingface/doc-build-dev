...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ta=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),oa=new Me({}),na=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17228/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17228/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Ua=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17228/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17228/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17228/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17228/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17228/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17228/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),fi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17228/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17228/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17228/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17228/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17228/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17228/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Vi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17228/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17228/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17228/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17228/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17228/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),al=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17228/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17228/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17228/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17228/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17228/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
alongside usage examples.`),Gv=c(),dt=n("div"),T(vr.$$.fragment),Yv=c(),Lo=n("p"),Zv=r("The "),sd=n("a"),e2=r("TFRobertaForMaskedLM"),t2=r(" forward method, overrides the "),Gc=n("code"),o2=r("__call__"),n2=r(" special method."),s2=c(),T(Dn.$$.fragment),a2=c(),T(Sn.$$.fragment),r2=c(),T(Wn.$$.fragment),$m=c(),Eo=n("h2"),Bn=n("a"),Yc=n("span"),T(Tr.$$.fragment),i2=c(),Zc=n("span"),l2=r("TFXLMRobertaForSequenceClassification"),Mm=c(),Ie=n("div"),T(yr.$$.fragment),d2=c(),ep=n("p"),c2=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),p2=c(),wr=n("p"),h2=r("This model inherits from "),ad=n("a"),m2=r("TFPreTrainedModel"),u2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),f2=c(),$r=n("p"),g2=r("This model is also a "),Mr=n("a"),_2=r("tf.keras.Model"),b2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),k2=c(),T(Un.$$.fragment),v2=c(),Fr=n("p"),T2=r("This class overrides "),rd=n("a"),y2=r("TFRobertaForSequenceClassification"),w2=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),$2=c(),ct=n("div"),T(xr.$$.fragment),M2=c(),zo=n("p"),F2=r("The "),id=n("a"),x2=r("TFRobertaForSequenceClassification"),R2=r(" forward method, overrides the "),tp=n("code"),L2=r("__call__"),E2=r(" special method."),z2=c(),T(Qn.$$.fragment),q2=c(),T(Hn.$$.fragment),C2=c(),T(Vn.$$.fragment),Fm=c(),qo=n("h2"),Jn=n("a"),op=n("span"),T(Rr.$$.fragment),j2=c(),np=n("span"),X2=r("TFXLMRobertaForMultipleChoice"),xm=c(),De=n("div"),T(Lr.$$.fragment),P2=c(),sp=n("p"),A2=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),O2=c(),Er=n("p"),N2=r("This model inherits from "),ld=n("a"),I2=r("TFPreTrainedModel"),D2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),S2=c(),zr=n("p"),W2=r("This model is also a "),qr=n("a"),B2=r("tf.keras.Model"),U2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Q2=c(),T(Kn.$$.fragment),H2=c(),Cr=n("p"),V2=r("This class overrides "),dd=n("a"),J2=r("TFRobertaForMultipleChoice"),K2=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),G2=c(),xt=n("div"),T(jr.$$.fragment),Y2=c(),Co=n("p"),Z2=r("The "),cd=n("a"),eT=r("TFRobertaForMultipleChoice"),tT=r(" forward method, overrides the "),ap=n("code"),oT=r("__call__"),nT=r(" special method."),sT=c(),T(Gn.$$.fragment),aT=c(),T(Yn.$$.fragment),Rm=c(),jo=n("h2"),Zn=n("a"),rp=n("span"),T(Xr.$$.fragment),rT=c(),ip=n("span"),iT=r("TFXLMRobertaForTokenClassification"),Lm=c(),Se=n("div"),T(Pr.$$.fragment),lT=c(),lp=n("p"),dT=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
usage examples.`),j1=c(),Rt=n("div"),T(ai.$$.fragment),X1=c(),Io=n("p"),P1=r("The "),wp=n("code"),A1=r("FlaxRobertaPreTrainedModel"),O1=r(" forward method, overrides the "),$p=n("code"),N1=r("__call__"),I1=r(" special method."),D1=c(),T(cs.$$.fragment),S1=c(),T(ps.$$.fragment),jm=c(),Do=n("h2"),hs=n("a"),Mp=n("span"),T(ri.$$.fragment),W1=c(),Fp=n("span"),B1=r("FlaxXLMRobertaForMaskedLM"),Xm=c(),Ue=n("div"),T(ii.$$.fragment),U1=c(),So=n("p"),Q1=r("XLM-RoBERTa Model with a "),xp=n("code"),H1=r("language modeling"),V1=r(` head on top.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ty=c(),Rp=n("p"),oy=r("Finally, this model supports inherent JAX features such as:"),ny=c(),Wt=n("ul"),Lp=n("li"),ci=n("a"),sy=r("Just-In-Time (JIT) compilation"),ay=c(),Ep=n("li"),pi=n("a"),ry=r("Automatic Differentiation"),iy=c(),zp=n("li"),hi=n("a"),ly=r("Vectorization"),dy=c(),qp=n("li"),mi=n("a"),cy=r("Parallelization"),py=c(),ui=n("p"),hy=r("This class overrides "),kd=n("a"),my=r("FlaxRobertaForMaskedLM"),uy=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),fy=c(),Lt=n("div"),T(fi.$$.fragment),gy=c(),Wo=n("p"),_y=r("The "),Cp=n("code"),by=r("FlaxRobertaPreTrainedModel"),ky=r(" forward method, overrides the "),jp=n("code"),vy=r("__call__"),Ty=r(" special method."),yy=c(),T(ms.$$.fragment),wy=c(),T(us.$$.fragment),Pm=c(),Bo=n("h2"),fs=n("a"),Xp=n("span"),T(gi.$$.fragment),$y=c(),Pp=n("span"),My=r("FlaxXLMRobertaForSequenceClassification"),Am=c(),Ce=n("div"),T(_i.$$.fragment),Fy=c(),Ap=n("p"),xy=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Py=c(),Op=n("p"),Ay=r("Finally, this model supports inherent JAX features such as:"),Oy=c(),Bt=n("ul"),Np=n("li"),Ti=n("a"),Ny=r("Just-In-Time (JIT) compilation"),Iy=c(),Ip=n("li"),yi=n("a"),Dy=r("Automatic Differentiation"),Sy=c(),Dp=n("li"),wi=n("a"),Wy=r("Vectorization"),By=c(),Sp=n("li"),$i=n("a"),Uy=r("Parallelization"),Qy=c(),Mi=n("p"),Hy=r("This class overrides "),Td=n("a"),Vy=r("FlaxRobertaForSequenceClassification"),Jy=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Ky=c(),Et=n("div"),T(Fi.$$.fragment),Gy=c(),Uo=n("p"),Yy=r("The "),Wp=n("code"),Zy=r("FlaxRobertaPreTrainedModel"),ew=r(" forward method, overrides the "),Bp=n("code"),tw=r("__call__"),ow=r(" special method."),nw=c(),T(gs.$$.fragment),sw=c(),T(_s.$$.fragment),Om=c(),Qo=n("h2"),bs=n("a"),Up=n("span"),T(xi.$$.fragment),aw=c(),Qp=n("span"),rw=r("FlaxXLMRobertaForMultipleChoice"),Nm=c(),je=n("div"),T(Ri.$$.fragment),iw=c(),Hp=n("p"),lw=r(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
documentation alongside usage examples.`),zw=c(),zt=n("div"),T(Ai.$$.fragment),qw=c(),Ho=n("p"),Cw=r("The "),Zp=n("code"),jw=r("FlaxRobertaPreTrainedModel"),Xw=r(" forward method, overrides the "),eh=n("code"),Pw=r("__call__"),Aw=r(" special method."),Ow=c(),T(ks.$$.fragment),Nw=c(),T(vs.$$.fragment),Im=c(),Vo=n("h2"),Ts=n("a"),th=n("span"),T(Oi.$$.fragment),Iw=c(),oh=n("span"),Dw=r("FlaxXLMRobertaForTokenClassification"),Dm=c(),Xe=n("div"),T(Ni.$$.fragment),Sw=c(),nh=n("p"),Ww=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Bw=c(),Ii=n("p"),Uw=r("This model inherits from "),$d=n("a"),Qw=r("FlaxPreTrainedModel"),Hw=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yw=c(),sh=n("p"),Zw=r("Finally, this model supports inherent JAX features such as:"),e$=c(),Qt=n("ul"),ah=n("li"),Wi=n("a"),t$=r("Just-In-Time (JIT) compilation"),o$=c(),rh=n("li"),Bi=n("a"),n$=r("Automatic Differentiation"),s$=c(),ih=n("li"),Ui=n("a"),a$=r("Vectorization"),r$=c(),lh=n("li"),Qi=n("a"),i$=r("Parallelization"),l$=c(),Hi=n("p"),d$=r("This class overrides "),Md=n("a"),c$=r("FlaxRobertaForTokenClassification"),p$=r(`. Please check the superclass for the appropriate
...
alongside usage examples.`),Cu.forEach(t),Gv=p(ft),dt=s(ft,"DIV",{class:!0});var oo=a(dt);y(vr.$$.fragment,oo),Yv=p(oo),Lo=s(oo,"P",{});var Id=a(Lo);Zv=i(Id,"The "),sd=s(Id,"A",{href:!0});var QF=a(sd);e2=i(QF,"TFRobertaForMaskedLM"),QF.forEach(t),t2=i(Id," forward method, overrides the "),Gc=s(Id,"CODE",{});var HF=a(Gc);o2=i(HF,"__call__"),HF.forEach(t),n2=i(Id," special method."),Id.forEach(t),s2=p(oo),y(Dn.$$.fragment,oo),a2=p(oo),y(Sn.$$.fragment,oo),r2=p(oo),y(Wn.$$.fragment,oo),oo.forEach(t),ft.forEach(t),$m=p(o),Eo=s(o,"H2",{class:!0});var ju=a(Eo);Bn=s(ju,"A",{id:!0,class:!0,href:!0});var VF=a(Bn);Yc=s(VF,"SPAN",{});var JF=a(Yc);y(Tr.$$.fragment,JF),JF.forEach(t),VF.forEach(t),i2=p(ju),Zc=s(ju,"SPAN",{});var KF=a(Zc);l2=i(KF,"TFXLMRobertaForSequenceClassification"),KF.forEach(t),ju.forEach(t),Mm=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(yr.$$.fragment,gt),d2=p(gt),ep=s(gt,"P",{});var GF=a(ep);c2=i(GF,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),GF.forEach(t),p2=p(gt),wr=s(gt,"P",{});var Xu=a(wr);h2=i(Xu,"This model inherits from "),ad=s(Xu,"A",{href:!0});var YF=a(ad);m2=i(YF,"TFPreTrainedModel"),YF.forEach(t),u2=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xu.forEach(t),f2=p(gt),$r=s(gt,"P",{});var Pu=a($r);g2=i(Pu,"This model is also a "),Mr=s(Pu,"A",{href:!0,rel:!0});var ZF=a(Mr);_2=i(ZF,"tf.keras.Model"),ZF.forEach(t),b2=i(Pu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pu.forEach(t),k2=p(gt),y(Un.$$.fragment,gt),v2=p(gt),Fr=s(gt,"P",{});var Au=a(Fr);T2=i(Au,"This class overrides "),rd=s(Au,"A",{href:!0});var e0=a(rd);y2=i(e0,"TFRobertaForSequenceClassification"),e0.forEach(t),w2=i(Au,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Au.forEach(t),$2=p(gt),ct=s(gt,"DIV",{class:!0});var no=a(ct);y(xr.$$.fragment,no),M2=p(no),zo=s(no,"P",{});var Dd=a(zo);F2=i(Dd,"The "),id=s(Dd,"A",{href:!0});var t0=a(id);x2=i(t0,"TFRobertaForSequenceClassification"),t0.forEach(t),R2=i(Dd," forward method, overrides the "),tp=s(Dd,"CODE",{});var o0=a(tp);L2=i(o0,"__call__"),o0.forEach(t),E2=i(Dd," special method."),Dd.forEach(t),z2=p(no),y(Qn.$$.fragment,no),q2=p(no),y(Hn.$$.fragment,no),C2=p(no),y(Vn.$$.fragment,no),no.forEach(t),gt.forEach(t),Fm=p(o),qo=s(o,"H2",{class:!0});var Ou=a(qo);Jn=s(Ou,"A",{id:!0,class:!0,href:!0});var n0=a(Jn);op=s(n0,"SPAN",{});var s0=a(op);y(Rr.$$.fragment,s0),s0.forEach(t),n0.forEach(t),j2=p(Ou),np=s(Ou,"SPAN",{});var a0=a(np);X2=i(a0,"TFXLMRobertaForMultipleChoice"),a0.forEach(t),Ou.forEach(t),xm=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Lr.$$.fragment,_t),P2=p(_t),sp=s(_t,"P",{});var r0=a(sp);A2=i(r0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),r0.forEach(t),O2=p(_t),Er=s(_t,"P",{});var Nu=a(Er);N2=i(Nu,"This model inherits from "),ld=s(Nu,"A",{href:!0});var i0=a(ld);I2=i(i0,"TFPreTrainedModel"),i0.forEach(t),D2=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nu.forEach(t),S2=p(_t),zr=s(_t,"P",{});var Iu=a(zr);W2=i(Iu,"This model is also a "),qr=s(Iu,"A",{href:!0,rel:!0});var l0=a(qr);B2=i(l0,"tf.keras.Model"),l0.forEach(t),U2=i(Iu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Iu.forEach(t),Q2=p(_t),y(Kn.$$.fragment,_t),H2=p(_t),Cr=s(_t,"P",{});var Du=a(Cr);V2=i(Du,"This class overrides "),dd=s(Du,"A",{href:!0});var d0=a(dd);J2=i(d0,"TFRobertaForMultipleChoice"),d0.forEach(t),K2=i(Du,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Du.forEach(t),G2=p(_t),xt=s(_t,"DIV",{class:!0});var zs=a(xt);y(jr.$$.fragment,zs),Y2=p(zs),Co=s(zs,"P",{});var Sd=a(Co);Z2=i(Sd,"The "),cd=s(Sd,"A",{href:!0});var c0=a(cd);eT=i(c0,"TFRobertaForMultipleChoice"),c0.forEach(t),tT=i(Sd," forward method, overrides the "),ap=s(Sd,"CODE",{});var p0=a(ap);oT=i(p0,"__call__"),p0.forEach(t),nT=i(Sd," special method."),Sd.forEach(t),sT=p(zs),y(Gn.$$.fragment,zs),aT=p(zs),y(Yn.$$.fragment,zs),zs.forEach(t),_t.forEach(t),Rm=p(o),jo=s(o,"H2",{class:!0});var Su=a(jo);Zn=s(Su,"A",{id:!0,class:!0,href:!0});var h0=a(Zn);rp=s(h0,"SPAN",{});var m0=a(rp);y(Xr.$$.fragment,m0),m0.forEach(t),h0.forEach(t),rT=p(Su),ip=s(Su,"SPAN",{});var u0=a(ip);iT=i(u0,"TFXLMRobertaForTokenClassification"),u0.forEach(t),Su.forEach(t),Lm=p(o),Se=s(o,"DIV",{class:!0});var bt=a(Se);y(Pr.$$.fragment,bt),lT=p(bt),lp=s(bt,"P",{});var f0=a(lp);dT=i(f0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
documentation alongside usage examples.`),Ju.forEach(t),e1=p(kt),ht=s(kt,"DIV",{class:!0});var ao=a(ht);y(Vr.$$.fragment,ao),t1=p(ao),Oo=s(ao,"P",{});var Ud=a(Oo);o1=i(Ud,"The "),fd=s(Ud,"A",{href:!0});var L0=a(fd);n1=i(L0,"TFRobertaForQuestionAnswering"),L0.forEach(t),s1=i(Ud," forward method, overrides the "),fp=s(Ud,"CODE",{});var E0=a(fp);a1=i(E0,"__call__"),E0.forEach(t),r1=i(Ud," special method."),Ud.forEach(t),i1=p(ao),y(rs.$$.fragment,ao),l1=p(ao),y(is.$$.fragment,ao),d1=p(ao),y(ls.$$.fragment,ao),ao.forEach(t),kt.forEach(t),qm=p(o),No=s(o,"H2",{class:!0});var Ku=a(No);ds=s(Ku,"A",{id:!0,class:!0,href:!0});var z0=a(ds);gp=s(z0,"SPAN",{});var q0=a(gp);y(Jr.$$.fragment,q0),q0.forEach(t),z0.forEach(t),c1=p(Ku),_p=s(Ku,"SPAN",{});var C0=a(_p);p1=i(C0,"FlaxXLMRobertaModel"),C0.forEach(t),Ku.forEach(t),Cm=p(o),Be=s(o,"DIV",{class:!0});var vt=a(Be);y(Kr.$$.fragment,vt),h1=p(vt),Gr=s(vt,"P",{});var Gu=a(Gr);m1=i(Gu,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=s(Gu,"A",{href:!0});var j0=a(gd);u1=i(j0,"FlaxPreTrainedModel"),j0.forEach(t),f1=i(Gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gu.forEach(t),g1=p(vt),Yr=s(vt,"P",{});var Yu=a(Yr);_1=i(Yu,"This model is also a Flax Linen "),Zr=s(Yu,"A",{href:!0,rel:!0});var X0=a(Zr);b1=i(X0,"flax.linen.Module"),X0.forEach(t),k1=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),v1=p(vt),bp=s(vt,"P",{});var P0=a(bp);T1=i(P0,"Finally, this model supports inherent JAX features such as:"),P0.forEach(t),y1=p(vt),St=s(vt,"UL",{});var qs=a(St);kp=s(qs,"LI",{});var A0=a(kp);ei=s(A0,"A",{href:!0,rel:!0});var O0=a(ei);w1=i(O0,"Just-In-Time (JIT) compilation"),O0.forEach(t),A0.forEach(t),$1=p(qs),vp=s(qs,"LI",{});var N0=a(vp);ti=s(N0,"A",{href:!0,rel:!0});var I0=a(ti);M1=i(I0,"Automatic Differentiation"),I0.forEach(t),N0.forEach(t),F1=p(qs),Tp=s(qs,"LI",{});var D0=a(Tp);oi=s(D0,"A",{href:!0,rel:!0});var S0=a(oi);x1=i(S0,"Vectorization"),S0.forEach(t),D0.forEach(t),R1=p(qs),yp=s(qs,"LI",{});var W0=a(yp);ni=s(W0,"A",{href:!0,rel:!0});var B0=a(ni);L1=i(B0,"Parallelization"),B0.forEach(t),W0.forEach(t),qs.forEach(t),E1=p(vt),si=s(vt,"P",{});var Zu=a(si);z1=i(Zu,"This class overrides "),_d=s(Zu,"A",{href:!0});var U0=a(_d);q1=i(U0,"FlaxRobertaModel"),U0.forEach(t),C1=i(Zu,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Zu.forEach(t),j1=p(vt),Rt=s(vt,"DIV",{class:!0});var Cs=a(Rt);y(ai.$$.fragment,Cs),X1=p(Cs),Io=s(Cs,"P",{});var Qd=a(Io);P1=i(Qd,"The "),wp=s(Qd,"CODE",{});var Q0=a(wp);A1=i(Q0,"FlaxRobertaPreTrainedModel"),Q0.forEach(t),O1=i(Qd," forward method, overrides the "),$p=s(Qd,"CODE",{});var H0=a($p);N1=i(H0,"__call__"),H0.forEach(t),I1=i(Qd," special method."),Qd.forEach(t),D1=p(Cs),y(cs.$$.fragment,Cs),S1=p(Cs),y(ps.$$.fragment,Cs),Cs.forEach(t),vt.forEach(t),jm=p(o),Do=s(o,"H2",{class:!0});var ef=a(Do);hs=s(ef,"A",{id:!0,class:!0,href:!0});var V0=a(hs);Mp=s(V0,"SPAN",{});var J0=a(Mp);y(ri.$$.fragment,J0),J0.forEach(t),V0.forEach(t),W1=p(ef),Fp=s(ef,"SPAN",{});var K0=a(Fp);B1=i(K0,"FlaxXLMRobertaForMaskedLM"),K0.forEach(t),ef.forEach(t),Xm=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(ii.$$.fragment,Tt),U1=p(Tt),So=s(Tt,"P",{});var Hd=a(So);Q1=i(Hd,"XLM-RoBERTa Model with a "),xp=s(Hd,"CODE",{});var G0=a(xp);H1=i(G0,"language modeling"),G0.forEach(t),V1=i(Hd,` head on top.
This model inherits from `),bd=s(Hd,"A",{href:!0});var Y0=a(bd);J1=i(Y0,"FlaxPreTrainedModel"),Y0.forEach(t),K1=i(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hd.forEach(t),G1=p(Tt),li=s(Tt,"P",{});var tf=a(li);Y1=i(tf,"This model is also a Flax Linen "),di=s(tf,"A",{href:!0,rel:!0});var Z0=a(di);Z1=i(Z0,"flax.linen.Module"),Z0.forEach(t),ey=i(tf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tf.forEach(t),ty=p(Tt),Rp=s(Tt,"P",{});var ex=a(Rp);oy=i(ex,"Finally, this model supports inherent JAX features such as:"),ex.forEach(t),ny=p(Tt),Wt=s(Tt,"UL",{});var js=a(Wt);Lp=s(js,"LI",{});var tx=a(Lp);ci=s(tx,"A",{href:!0,rel:!0});var ox=a(ci);sy=i(ox,"Just-In-Time (JIT) compilation"),ox.forEach(t),tx.forEach(t),ay=p(js),Ep=s(js,"LI",{});var nx=a(Ep);pi=s(nx,"A",{href:!0,rel:!0});var sx=a(pi);ry=i(sx,"Automatic Differentiation"),sx.forEach(t),nx.forEach(t),iy=p(js),zp=s(js,"LI",{});var ax=a(zp);hi=s(ax,"A",{href:!0,rel:!0});var rx=a(hi);ly=i(rx,"Vectorization"),rx.forEach(t),ax.forEach(t),dy=p(js),qp=s(js,"LI",{});var ix=a(qp);mi=s(ix,"A",{href:!0,rel:!0});var lx=a(mi);cy=i(lx,"Parallelization"),lx.forEach(t),ix.forEach(t),js.forEach(t),py=p(Tt),ui=s(Tt,"P",{});var of=a(ui);hy=i(of,"This class overrides "),kd=s(of,"A",{href:!0});var dx=a(kd);my=i(dx,"FlaxRobertaForMaskedLM"),dx.forEach(t),uy=i(of,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),of.forEach(t),fy=p(Tt),Lt=s(Tt,"DIV",{class:!0});var Xs=a(Lt);y(fi.$$.fragment,Xs),gy=p(Xs),Wo=s(Xs,"P",{});var Vd=a(Wo);_y=i(Vd,"The "),Cp=s(Vd,"CODE",{});var cx=a(Cp);by=i(cx,"FlaxRobertaPreTrainedModel"),cx.forEach(t),ky=i(Vd," forward method, overrides the "),jp=s(Vd,"CODE",{});var px=a(jp);vy=i(px,"__call__"),px.forEach(t),Ty=i(Vd," special method."),Vd.forEach(t),yy=p(Xs),y(ms.$$.fragment,Xs),wy=p(Xs),y(us.$$.fragment,Xs),Xs.forEach(t),Tt.forEach(t),Pm=p(o),Bo=s(o,"H2",{class:!0});var nf=a(Bo);fs=s(nf,"A",{id:!0,class:!0,href:!0});var hx=a(fs);Xp=s(hx,"SPAN",{});var mx=a(Xp);y(gi.$$.fragment,mx),mx.forEach(t),hx.forEach(t),$y=p(nf),Pp=s(nf,"SPAN",{});var ux=a(Pp);My=i(ux,"FlaxXLMRobertaForSequenceClassification"),ux.forEach(t),nf.forEach(t),Am=p(o),Ce=s(o,"DIV",{class:!0});var tt=a(Ce);y(_i.$$.fragment,tt),Fy=p(tt),Ap=s(tt,"P",{});var fx=a(Ap);xy=i(fx,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),af.forEach(t),Py=p(tt),Op=s(tt,"P",{});var bx=a(Op);Ay=i(bx,"Finally, this model supports inherent JAX features such as:"),bx.forEach(t),Oy=p(tt),Bt=s(tt,"UL",{});var Ps=a(Bt);Np=s(Ps,"LI",{});var kx=a(Np);Ti=s(kx,"A",{href:!0,rel:!0});var vx=a(Ti);Ny=i(vx,"Just-In-Time (JIT) compilation"),vx.forEach(t),kx.forEach(t),Iy=p(Ps),Ip=s(Ps,"LI",{});var Tx=a(Ip);yi=s(Tx,"A",{href:!0,rel:!0});var yx=a(yi);Dy=i(yx,"Automatic Differentiation"),yx.forEach(t),Tx.forEach(t),Sy=p(Ps),Dp=s(Ps,"LI",{});var wx=a(Dp);wi=s(wx,"A",{href:!0,rel:!0});var $x=a(wi);Wy=i($x,"Vectorization"),$x.forEach(t),wx.forEach(t),By=p(Ps),Sp=s(Ps,"LI",{});var Mx=a(Sp);$i=s(Mx,"A",{href:!0,rel:!0});var Fx=a($i);Uy=i(Fx,"Parallelization"),Fx.forEach(t),Mx.forEach(t),Ps.forEach(t),Qy=p(tt),Mi=s(tt,"P",{});var rf=a(Mi);Hy=i(rf,"This class overrides "),Td=s(rf,"A",{href:!0});var xx=a(Td);Vy=i(xx,"FlaxRobertaForSequenceClassification"),xx.forEach(t),Jy=i(rf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),rf.forEach(t),Ky=p(tt),Et=s(tt,"DIV",{class:!0});var As=a(Et);y(Fi.$$.fragment,As),Gy=p(As),Uo=s(As,"P",{});var Jd=a(Uo);Yy=i(Jd,"The "),Wp=s(Jd,"CODE",{});var Rx=a(Wp);Zy=i(Rx,"FlaxRobertaPreTrainedModel"),Rx.forEach(t),ew=i(Jd," forward method, overrides the "),Bp=s(Jd,"CODE",{});var Lx=a(Bp);tw=i(Lx,"__call__"),Lx.forEach(t),ow=i(Jd," special method."),Jd.forEach(t),nw=p(As),y(gs.$$.fragment,As),sw=p(As),y(_s.$$.fragment,As),As.forEach(t),tt.forEach(t),Om=p(o),Qo=s(o,"H2",{class:!0});var lf=a(Qo);bs=s(lf,"A",{id:!0,class:!0,href:!0});var Ex=a(bs);Up=s(Ex,"SPAN",{});var zx=a(Up);y(xi.$$.fragment,zx),zx.forEach(t),Ex.forEach(t),aw=p(lf),Qp=s(lf,"SPAN",{});var qx=a(Qp);rw=i(qx,"FlaxXLMRobertaForMultipleChoice"),qx.forEach(t),lf.forEach(t),Nm=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Ri.$$.fragment,ot),iw=p(ot),Hp=s(ot,"P",{});var Cx=a(Hp);lw=i(Cx,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cf.forEach(t),_w=p(ot),Vp=s(ot,"P",{});var Px=a(Vp);bw=i(Px,"Finally, this model supports inherent JAX features such as:"),Px.forEach(t),kw=p(ot),Ut=s(ot,"UL",{});var Os=a(Ut);Jp=s(Os,"LI",{});var Ax=a(Jp);qi=s(Ax,"A",{href:!0,rel:!0});var Ox=a(qi);vw=i(Ox,"Just-In-Time (JIT) compilation"),Ox.forEach(t),Ax.forEach(t),Tw=p(Os),Kp=s(Os,"LI",{});var Nx=a(Kp);Ci=s(Nx,"A",{href:!0,rel:!0});var Ix=a(Ci);yw=i(Ix,"Automatic Differentiation"),Ix.forEach(t),Nx.forEach(t),ww=p(Os),Gp=s(Os,"LI",{});var Dx=a(Gp);ji=s(Dx,"A",{href:!0,rel:!0});var Sx=a(ji);$w=i(Sx,"Vectorization"),Sx.forEach(t),Dx.forEach(t),Mw=p(Os),Yp=s(Os,"LI",{});var Wx=a(Yp);Xi=s(Wx,"A",{href:!0,rel:!0});var Bx=a(Xi);Fw=i(Bx,"Parallelization"),Bx.forEach(t),Wx.forEach(t),Os.forEach(t),xw=p(ot),Pi=s(ot,"P",{});var pf=a(Pi);Rw=i(pf,"This class overrides "),wd=s(pf,"A",{href:!0});var Ux=a(wd);Lw=i(Ux,"FlaxRobertaForMultipleChoice"),Ux.forEach(t),Ew=i(pf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),pf.forEach(t),zw=p(ot),zt=s(ot,"DIV",{class:!0});var Ns=a(zt);y(Ai.$$.fragment,Ns),qw=p(Ns),Ho=s(Ns,"P",{});var Kd=a(Ho);Cw=i(Kd,"The "),Zp=s(Kd,"CODE",{});var Qx=a(Zp);jw=i(Qx,"FlaxRobertaPreTrainedModel"),Qx.forEach(t),Xw=i(Kd," forward method, overrides the "),eh=s(Kd,"CODE",{});var Hx=a(eh);Pw=i(Hx,"__call__"),Hx.forEach(t),Aw=i(Kd," special method."),Kd.forEach(t),Ow=p(Ns),y(ks.$$.fragment,Ns),Nw=p(Ns),y(vs.$$.fragment,Ns),Ns.forEach(t),ot.forEach(t),Im=p(o),Vo=s(o,"H2",{class:!0});var hf=a(Vo);Ts=s(hf,"A",{id:!0,class:!0,href:!0});var Vx=a(Ts);th=s(Vx,"SPAN",{});var Jx=a(th);y(Oi.$$.fragment,Jx),Jx.forEach(t),Vx.forEach(t),Iw=p(hf),oh=s(hf,"SPAN",{});var Kx=a(oh);Dw=i(Kx,"FlaxXLMRobertaForTokenClassification"),Kx.forEach(t),hf.forEach(t),Dm=p(o),Xe=s(o,"DIV",{class:!0});var nt=a(Xe);y(Ni.$$.fragment,nt),Sw=p(nt),nh=s(nt,"P",{});var Gx=a(nh);Ww=i(Gx,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Gx.forEach(t),Bw=p(nt),Ii=s(nt,"P",{});var mf=a(Ii);Uw=i(mf,"This model inherits from "),$d=s(mf,"A",{href:!0});var Yx=a($d);Qw=i(Yx,"FlaxPreTrainedModel"),Yx.forEach(t),Hw=i(mf,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Yw=p(nt),sh=s(nt,"P",{});var eR=a(sh);Zw=i(eR,"Finally, this model supports inherent JAX features such as:"),eR.forEach(t),e$=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var tR=a(ah);Wi=s(tR,"A",{href:!0,rel:!0});var oR=a(Wi);t$=i(oR,"Just-In-Time (JIT) compilation"),oR.forEach(t),tR.forEach(t),o$=p(Is),rh=s(Is,"LI",{});var nR=a(rh);Bi=s(nR,"A",{href:!0,rel:!0});var sR=a(Bi);n$=i(sR,"Automatic Differentiation"),sR.forEach(t),nR.forEach(t),s$=p(Is),ih=s(Is,"LI",{});var aR=a(ih);Ui=s(aR,"A",{href:!0,rel:!0});var rR=a(Ui);a$=i(rR,"Vectorization"),rR.forEach(t),aR.forEach(t),r$=p(Is),lh=s(Is,"LI",{});var iR=a(lh);Qi=s(iR,"A",{href:!0,rel:!0});var lR=a(Qi);i$=i(lR,"Parallelization"),lR.forEach(t),iR.forEach(t),Is.forEach(t),l$=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);d$=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var dR=a(Md);c$=i(dR,"FlaxRobertaForTokenClassification"),dR.forEach(t),p$=i(ff,`. Please check the superclass for the appropriate
