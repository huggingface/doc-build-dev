...
- One can use [PoolFormerFeatureExtractor](/docs/transformers/pr_15731/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor) to prepare images for the model.
...
This is the configuration class to store the configuration of [PoolFormerModel](/docs/transformers/pr_15731/en/model_doc/poolformer#transformers.PoolFormerModel). It is used to instantiate a
...
<docstring><name>forward</name><anchor>transformers.PoolFormerModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15731/src/transformers/models/poolformer/modeling_poolformer.py#L373</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [PoolFormerFeatureExtractor](/docs/transformers/pr_15731/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor). See
...
elements depending on the configuration ([PoolFormerConfig](/docs/transformers/pr_15731/en/model_doc/poolformer#transformers.PoolFormerConfig)) and inputs.
...
The [PoolFormerModel](/docs/transformers/pr_15731/en/model_doc/poolformer#transformers.PoolFormerModel) forward method, overrides the `__call__` special method.
...
<docstring><name>forward</name><anchor>transformers.PoolFormerForImageClassification.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15731/src/transformers/models/poolformer/modeling_poolformer.py#L439</source><parameters>[{"name": "pixel_values", "val": " = None"}, {"name": "labels", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  Pixel values. Pixel values can be obtained using [PoolFormerFeatureExtractor](/docs/transformers/pr_15731/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor). See
  [PoolFormerFeatureExtractor.__call__()](/docs/transformers/pr_15731/en/model_doc/poolformer#transformers.PoolFormerFeatureExtractor.__call__) for details.
...
The [PoolFormerForImageClassification](/docs/transformers/pr_15731/en/model_doc/poolformer#transformers.PoolFormerForImageClassification) forward method, overrides the `__call__` special method.
