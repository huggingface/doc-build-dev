...
Load T5 with [AutoModelForSeq2SeqLM](/docs/transformers/pr_15731/en/model_doc/auto#transformers.AutoModelForSeq2SeqLM):
...
1. Define your training hyperparameters in [Seq2SeqTrainingArguments](/docs/transformers/pr_15731/en/main_classes/trainer#transformers.Seq2SeqTrainingArguments).
2. Pass the training arguments to [Seq2SeqTrainer](/docs/transformers/pr_15731/en/main_classes/trainer#transformers.Seq2SeqTrainer) along with the model, dataset, tokenizer, and data collator.
...
Load T5 with [TFAutoModelForSeq2SeqLM](/docs/transformers/pr_15731/en/model_doc/auto#transformers.TFAutoModelForSeq2SeqLM):
