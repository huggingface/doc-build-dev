...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16090/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16090/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16090/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16090/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16090/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),yp=new w({}),{c(){y=o("meta"),z=u(),b=o("h1"),q=o("a"),ee=o("span"),f(O.$$.fragment),x=u(),se=o("span"),R=a("DeepSpeed Integration"),ae=u(),C=o("p"),E=o("a"),$=a("DeepSpeed"),qs=a(" implements everything described in the "),V=o("a"),$s=a("ZeRO paper"),R6=a(". Currently it provides full support for:"),Nj=u(),I=o("ol"),ef=o("li"),I6=a("Optimizer state partitioning (ZeRO stage 1)"),U6=u(),sf=o("li"),G6=a("Gradient partitioning (ZeRO stage 2)"),L6=u(),tf=o("li"),M6=a("Parameter partitioning (ZeRO stage 3)"),Z6=u(),af=o("li"),N6=a("Custom mixed precision training handling"),H6=u(),nf=o("li"),B6=a("A range of fast CUDA-extension-based optimizers"),W6=u(),of=o("li"),F6=a("ZeRO-Offload to CPU and NVMe"),Hj=u(),Se=o("p"),V6=a("ZeRO-Offload has its own dedicated paper: "),to=o("a"),Y6=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),K6=a(". And NVMe-support is described in the paper "),ao=o("a"),J6=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),X6=a("."),Bj=u(),Ip=o("p"),Q6=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),Wj=u(),Up=o("p"),e$=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),Fj=u(),Et=o("p"),s$=a("\u{1F917} Transformers integrates "),no=o("a"),t$=a("DeepSpeed"),a$=a(" via 2 options:"),Vj=u(),qt=o("ol"),oo=o("li"),n$=a("Integration of the core DeepSpeed features via "),Gp=o("a"),o$=a("Trainer"),l$=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),r$=u(),Y=o("li"),p$=a("If you don\u2019t use "),Lp=o("a"),i$=a("Trainer"),u$=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),lf=o("code"),c$=a("from_pretrained"),h$=a(" and "),rf=o("code"),f$=a("from_config"),d$=a(` include integration of essential
parts of DeepSpeed like `),pf=o("code"),m$=a("zero.Init"),_$=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Mp=o("a"),v$=a("deepspeed-non-trainer-integration"),j$=a("."),Yj=u(),Zp=o("p"),g$=a("What is integrated:"),Kj=u(),Np=o("p"),w$=a("Training:"),Jj=u(),Hp=o("ol"),uf=o("li"),y$=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),Xj=u(),Bp=o("p"),b$=a("Inference:"),Qj=u(),Wp=o("ol"),lo=o("li"),E$=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Fp=o("a"),q$=a("deepspeed-zero-inference"),$$=a("."),eg=u(),Vp=o("p"),k$=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),sg=u(),Yp=o("a"),tg=u(),ks=o("h2"),$t=o("a"),cf=o("span"),f(ro.$$.fragment),P$=u(),hf=o("span"),D$=a("Trainer Deepspeed Integration"),ag=u(),Kp=o("a"),ng=u(),Ps=o("h3"),kt=o("a"),ff=o("span"),f(po.$$.fragment),z$=u(),df=o("span"),O$=a("Installation"),og=u(),Jp=o("p"),T$=a("Install the library via pypi:"),lg=u(),f(io.$$.fragment),rg=u(),Ce=o("p"),A$=a("or via "),mf=o("code"),S$=a("transformers"),C$=a("\u2019 "),_f=o("code"),x$=a("extras"),R$=a(":"),pg=u(),f(uo.$$.fragment),ig=u(),xe=o("p"),I$=a("or find more details on "),co=o("a"),U$=a("the DeepSpeed\u2019s GitHub page"),G$=a(` and
`),ho=o("a"),L$=a("advanced install"),M$=a("."),ug=u(),Pt=o("p"),Z$=a("If you\u2019re still struggling with the build, first make sure to read "),Xp=o("a"),N$=a("zero-install-notes"),H$=a("."),cg=u(),Qp=o("p"),B$=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),hg=u(),ei=o("p"),W$=a("To make a local build for DeepSpeed:"),fg=u(),f(fo.$$.fragment),dg=u(),Re=o("p"),F$=a("If you intend to use NVMe offload you will also need to include "),vf=o("code"),V$=a("DS_BUILD_AIO=1"),Y$=a(` in the instructions above (and also
install `),jf=o("em"),K$=a("libaio-dev"),J$=a(" system-wide)."),mg=u(),Dt=o("p"),X$=a("Edit "),gf=o("code"),Q$=a("TORCH_CUDA_ARCH_LIST"),e4=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
the visible scope of available GPUs. Instead, you have to use the following syntax:`),K5=u(),f(xo.$$.fragment),J5=u(),Kf=o("p"),X5=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),lw=u(),vi=o("a"),rw=u(),As=o("h3"),Nt=o("a"),Jf=o("span"),f(Ro.$$.fragment),Q5=u(),Xf=o("span"),e9=a("Deployment in Notebooks"),pw=u(),Ht=o("p"),s9=a("The problem with running notebook cells as a script is that there is no normal "),Qf=o("code"),t9=a("deepspeed"),a9=a(` launcher to rely on, so
under certain setups we have to emulate it.`),iw=u(),ji=o("p"),n9=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),uw=u(),f(Io.$$.fragment),cw=u(),Bt=o("p"),o9=a("Note: "),ed=o("code"),l9=a("..."),r9=a(" stands for the normal arguments that you\u2019d pass to the functions."),hw=u(),gi=o("p"),p9=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),fw=u(),wi=o("p"),i9=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),dw=u(),f(Uo.$$.fragment),mw=u(),Le=o("p"),u9=a("If the training script is in a normal file and not in the notebook cells, you can launch "),sd=o("code"),c9=a("deepspeed"),h9=a(` normally via
shell from a cell. For example, to use `),td=o("code"),f9=a("run_translation.py"),d9=a(" you would launch it with:"),_w=u(),f(Go.$$.fragment),vw=u(),Wt=o("p"),m9=a("or with "),ad=o("code"),_9=a("%%bash"),v9=a(" magic, where you can write a multi-line code for the shell program to run:"),jw=u(),f(Lo.$$.fragment),gw=u(),yi=o("p"),j9=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),ww=u(),Ft=o("p"),g9=a("Note: While "),nd=o("code"),w9=a("%%bash"),y9=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),yw=u(),bi=o("a"),bw=u(),Ss=o("h3"),Vt=o("a"),od=o("span"),f(Mo.$$.fragment),b9=u(),ld=o("span"),E9=a("Configuration"),Ew=u(),Yt=o("p"),q9=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Zo=o("a"),$9=a("following documentation"),k9=a("."),qw=u(),Kt=o("p"),P9=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),No=o("a"),D9=a(`the DeepSpeedExamples
repo`),z9=a(":"),$w=u(),f(Ho.$$.fragment),kw=u(),Jt=o("p"),O9=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),rd=o("code"),T9=a(".json"),A9=a(" files with:"),Pw=u(),f(Bo.$$.fragment),Dw=u(),Xt=o("p"),S9=a("Some more examples are to be found in the "),Wo=o("a"),C9=a("main repo"),x9=a(" as well."),zw=u(),Ei=o("p"),R9=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Ow=u(),oe=o("p"),I9=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),pd=o("code"),U9=a("AdamW"),G9=a(" optimizer and "),id=o("code"),L9=a("WarmupLR"),M9=a(` scheduler and will enable mixed
precision training if `),ud=o("code"),Z9=a("--fp16"),N9=a(" is passed:"),Tw=u(),f(Fo.$$.fragment),Aw=u(),Qt=o("p"),H9=a("When you execute the program, DeepSpeed will log the configuration it received from the "),qi=o("a"),B9=a("Trainer"),W9=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),Sw=u(),$i=o("a"),Cw=u(),Cs=o("h3"),ea=o("a"),cd=o("span"),f(Vo.$$.fragment),F9=u(),hd=o("span"),V9=a("Passing Configuration"),xw=u(),G=o("p"),Y9=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),ki=o("a"),K9=a("Trainer"),J9=a(" via "),Pi=o("a"),X9=a("TrainingArguments"),Q9=a(" then for the "),fd=o("code"),e8=a("deepspeed"),s8=a(` argument you can
pass a nested `),dd=o("code"),t8=a("dict"),a8=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),Di=o("a"),n8=a("TrainingArguments"),o8=a("."),Rw=u(),zi=o("p"),l8=a("To summarize you can do:"),Iw=u(),f(Yo.$$.fragment),Uw=u(),Oi=o("p"),r8=a("or:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("a"),Mw=u(),xs=o("h3"),sa=o("a"),md=o("span"),f(Jo.$$.fragment),p8=u(),_d=o("span"),i8=a("Shared Configuration"),Zw=u(),f(ta.$$.fragment),Nw=u(),Me=o("p"),u8=a("Some configuration values are required by both the "),Ai=o("a"),c8=a("Trainer"),h8=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Si=o("a"),f8=a("Trainer"),d8=a(" command line arguments."),Hw=u(),aa=o("p"),m8=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),Ci=o("a"),_8=a("Trainer"),v8=a(` do the majority
of configuration for you.`),Bw=u(),Ze=o("p"),j8=a("Therefore, in the rest of this guide you will find a special configuration value: "),vd=o("code"),g8=a("auto"),w8=a(`, which when set will be
...
`),xi=o("a"),y8=a("Trainer"),b8=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),Ww=u(),Ri=o("p"),E8=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Fw=u(),na=o("p"),q8=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ii=o("a"),$8=a("TrainingArguments"),k8=a(" based on that. The steps are:"),Vw=u(),oa=o("ol"),jd=o("li"),P8=a("Create or load the DeepSpeed configuration to be used as a master configuration"),D8=u(),Xo=o("li"),z8=a("Create the "),Ui=o("a"),O8=a("TrainingArguments"),T8=a(" object based on these values"),Yw=u(),le=o("p"),A8=a("Do note that some values, such as "),gd=o("code"),S8=a("scheduler.params.total_num_steps"),C8=a(` are calculated by
`),Gi=o("a"),x8=a("Trainer"),R8=a(" during "),wd=o("code"),I8=a("train"),U8=a(", but you can of course do the math yourself."),Kw=u(),Li=o("a"),Jw=u(),Rs=o("h3"),la=o("a"),yd=o("span"),f(Qo.$$.fragment),G8=u(),bd=o("span"),L8=a("ZeRO"),Xw=u(),el=o("p"),sl=o("a"),M8=a("Zero Redundancy Optimizer (ZeRO)"),Z8=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),Qw=u(),Ne=o("p"),N8=a("The "),Ed=o("code"),H8=a("zero_optimization"),B8=a(" section of the configuration file is the most important part ("),tl=o("a"),W8=a("docs"),F8=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),ey=u(),ra=o("p"),V8=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Mi=o("a"),Y8=a("Trainer"),K8=a(` provides
no equivalent command line arguments.`),sy=u(),Zi=o("p"),J8=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),ty=u(),Ni=o("a"),ay=u(),Is=o("h4"),pa=o("a"),qd=o("span"),f(al.$$.fragment),X8=u(),$d=o("span"),Q8=a("ZeRO-2 Config"),ny=u(),Hi=o("p"),ek=a("The following is an example of configuration for ZeRO stage 2:"),oy=u(),f(nl.$$.fragment),ly=u(),Bi=o("p"),kd=o("strong"),sk=a("Performance tuning:"),ry=u(),He=o("ul"),Us=o("li"),tk=a("enabling "),Pd=o("code"),ak=a("offload_optimizer"),nk=a(" should reduce GPU RAM usage (it requires "),Dd=o("code"),ok=a('"stage": 2'),lk=a(")"),rk=u(),L=o("li"),zd=o("code"),pk=a('"overlap_comm": true'),ik=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Od=o("code"),uk=a("overlap_comm"),ck=a(` uses 4.5x
the `),Td=o("code"),hk=a("allgather_bucket_size"),fk=a(" and "),Ad=o("code"),dk=a("reduce_bucket_size"),mk=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),Sd=o("code"),_k=a("5e8 x 2Bytes x 2 x 4.5"),vk=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),Cd=o("code"),jk=a("2e8"),gk=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),wk=u(),xd=o("li"),yk=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),py=u(),Be=o("p"),bk=a("Additionally, "),Rd=o("code"),Ek=a("deepspeed==0.4.4"),qk=a(" added a new option "),Id=o("code"),$k=a("round_robin_gradients"),kk=a(" which you can enable with:"),iy=u(),f(ol.$$.fragment),uy=u(),Wi=o("p"),Pk=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),cy=u(),Fi=o("a"),hy=u(),Gs=o("h4"),ia=o("a"),Ud=o("span"),f(ll.$$.fragment),Dk=u(),Gd=o("span"),zk=a("ZeRO-3 Config"),fy=u(),Vi=o("p"),Ok=a("The following is an example of configuration for ZeRO stage 3:"),dy=u(),f(rl.$$.fragment),my=u(),K=o("p"),Tk=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Ld=o("code"),Ak=a('"device": "cpu"'),Sk=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Md=o("code"),Ck=a("none"),xk=a(" instead of "),Zd=o("code"),Rk=a("cpu"),Ik=a(" for the "),Nd=o("code"),Uk=a("device"),Gk=a(` entry. Offloading to
NVMe is discussed further down.`),_y=u(),We=o("p"),Lk=a("Pinned memory is enabled with "),Hd=o("code"),Mk=a("pin_memory"),Zk=a(" set to "),Bd=o("code"),Nk=a("true"),Hk=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),vy=u(),Yi=o("p"),Wd=o("strong"),Bk=a("Performance tuning:"),jy=u(),ua=o("ul"),pl=o("li"),Fd=o("code"),Wk=a("stage3_max_live_parameters"),Fk=a(": "),Vd=o("code"),Vk=a("1e9"),Yk=u(),il=o("li"),Yd=o("code"),Kk=a("stage3_max_reuse_distance"),Jk=a(": "),Kd=o("code"),Xk=a("1e9"),gy=u(),M=o("p"),Qk=a("If hitting OOM reduce "),Jd=o("code"),e7=a("stage3_max_live_parameters"),s7=a(" and "),Xd=o("code"),t7=a("stage3_max_reuse_distance"),a7=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Qd=o("code"),n7=a("1e9"),o7=a(` would consume ~2GB. The memory is shared by
`),em=o("code"),l7=a("stage3_max_live_parameters"),r7=a(" and "),sm=o("code"),p7=a("stage3_max_reuse_distance"),i7=a(", so it\u2019s not additive, it\u2019s just 2GB total."),wy=u(),ze=o("p"),tm=o("code"),u7=a("stage3_max_live_parameters"),c7=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),am=o("code"),h7=a("stage3_max_reuse_distance"),f7=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),nm=o("code"),d7=a("stage3_max_reuse_distance"),m7=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),yy=u(),Ki=o("p"),_7=a("The following configuration values depend on the model\u2019s hidden size:"),by=u(),Fe=o("ul"),ul=o("li"),om=o("code"),v7=a("reduce_bucket_size"),j7=a(": "),lm=o("code"),g7=a("hidden_size*hidden_size"),w7=u(),cl=o("li"),rm=o("code"),y7=a("stage3_prefetch_bucket_size"),b7=a(": "),pm=o("code"),E7=a("0.9 * hidden_size * hidden_size"),q7=u(),hl=o("li"),im=o("code"),$7=a("stage3_param_persistence_threshold"),k7=a(": "),um=o("code"),P7=a("10 * hidden_size"),Ey=u(),Ve=o("p"),D7=a("therefore set these values to "),cm=o("code"),z7=a("auto"),O7=a(" and the "),Ji=o("a"),T7=a("Trainer"),A7=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),qy=u(),fl=o("p"),hm=o("code"),S7=a("stage3_gather_16bit_weights_on_model_save"),C7=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),$y=u(),re=o("p"),x7=a("If you\u2019re migrating from ZeRO-2 configuration note that "),fm=o("code"),R7=a("allgather_partitions"),I7=a(", "),dm=o("code"),U7=a("allgather_bucket_size"),G7=a(` and
`),mm=o("code"),L7=a("reduce_scatter"),M7=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),ky=u(),Xi=o("ul"),dl=o("li"),_m=o("code"),Z7=a("sub_group_size"),N7=a(": "),vm=o("code"),H7=a("1e9"),Py=u(),Oe=o("p"),jm=o("code"),B7=a("sub_group_size"),W7=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),gm=o("code"),F7=a("sub_group_size"),V7=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),wm=o("code"),Y7=a("sub_group_size"),K7=a(` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),Dy=u(),Ye=o("p"),J7=a("You can leave "),ym=o("code"),X7=a("sub_group_size"),Q7=a(" to its default value of "),bm=o("em"),eP=a("1e9"),sP=a(` when not using NVMe offload. You may want to change its
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),zp=o("a"),uG=a("DeepSpeed GitHub"),cG=a("."),this.h()},l(e){const p=SK('[data-svelte="svelte-1phssyn"]',document.head);y=l(p,"META",{name:!0,content:!0}),p.forEach(t),z=c(e),b=l(e,"H1",{class:!0});var Op=r(b);q=l(Op,"A",{id:!0,class:!0,href:!0});var Rj=r(q);ee=l(Rj,"SPAN",{});var Ij=r(ee);d(O.$$.fragment,Ij),Ij.forEach(t),Rj.forEach(t),x=c(Op),se=l(Op,"SPAN",{});var jG=r(se);R=n(jG,"DeepSpeed Integration"),jG.forEach(t),Op.forEach(t),ae=c(e),C=l(e,"P",{});var Uj=r(C);E=l(Uj,"A",{href:!0,rel:!0});var gG=r(E);$=n(gG,"DeepSpeed"),gG.forEach(t),qs=n(Uj," implements everything described in the "),V=l(Uj,"A",{href:!0,rel:!0});var wG=r(V);$s=n(wG,"ZeRO paper"),wG.forEach(t),R6=n(Uj,". Currently it provides full support for:"),Uj.forEach(t),Nj=c(e),I=l(e,"OL",{});var je=r(I);ef=l(je,"LI",{});var yG=r(ef);I6=n(yG,"Optimizer state partitioning (ZeRO stage 1)"),yG.forEach(t),U6=c(je),sf=l(je,"LI",{});var bG=r(sf);G6=n(bG,"Gradient partitioning (ZeRO stage 2)"),bG.forEach(t),L6=c(je),tf=l(je,"LI",{});var EG=r(tf);M6=n(EG,"Parameter partitioning (ZeRO stage 3)"),EG.forEach(t),Z6=c(je),af=l(je,"LI",{});var qG=r(af);N6=n(qG,"Custom mixed precision training handling"),qG.forEach(t),H6=c(je),nf=l(je,"LI",{});var $G=r(nf);B6=n($G,"A range of fast CUDA-extension-based optimizers"),$G.forEach(t),W6=c(je),of=l(je,"LI",{});var kG=r(of);F6=n(kG,"ZeRO-Offload to CPU and NVMe"),kG.forEach(t),je.forEach(t),Hj=c(e),Se=l(e,"P",{});var lh=r(Se);V6=n(lh,"ZeRO-Offload has its own dedicated paper: "),to=l(lh,"A",{href:!0,rel:!0});var PG=r(to);Y6=n(PG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),PG.forEach(t),K6=n(lh,". And NVMe-support is described in the paper "),ao=l(lh,"A",{href:!0,rel:!0});var DG=r(ao);J6=n(DG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),DG.forEach(t),X6=n(lh,"."),lh.forEach(t),Bj=c(e),Ip=l(e,"P",{});var zG=r(Ip);Q6=n(zG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),zG.forEach(t),Wj=c(e),Up=l(e,"P",{});var OG=r(Up);e$=n(OG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),OG.forEach(t),Fj=c(e),Et=l(e,"P",{});var sE=r(Et);s$=n(sE,"\u{1F917} Transformers integrates "),no=l(sE,"A",{href:!0,rel:!0});var TG=r(no);t$=n(TG,"DeepSpeed"),TG.forEach(t),a$=n(sE," via 2 options:"),sE.forEach(t),Vj=c(e),qt=l(e,"OL",{});var tE=r(qt);oo=l(tE,"LI",{});var aE=r(oo);n$=n(aE,"Integration of the core DeepSpeed features via "),Gp=l(aE,"A",{href:!0});var AG=r(Gp);o$=n(AG,"Trainer"),AG.forEach(t),l$=n(aE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),aE.forEach(t),r$=c(tE),Y=l(tE,"LI",{});var ge=r(Y);p$=n(ge,"If you don\u2019t use "),Lp=l(ge,"A",{href:!0});var SG=r(Lp);i$=n(SG,"Trainer"),SG.forEach(t),u$=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),lf=l(ge,"CODE",{});var CG=r(lf);c$=n(CG,"from_pretrained"),CG.forEach(t),h$=n(ge," and "),rf=l(ge,"CODE",{});var xG=r(rf);f$=n(xG,"from_config"),xG.forEach(t),d$=n(ge,` include integration of essential
parts of DeepSpeed like `),pf=l(ge,"CODE",{});var RG=r(pf);m$=n(RG,"zero.Init"),RG.forEach(t),_$=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Mp=l(ge,"A",{href:!0});var IG=r(Mp);v$=n(IG,"deepspeed-non-trainer-integration"),IG.forEach(t),j$=n(ge,"."),ge.forEach(t),tE.forEach(t),Yj=c(e),Zp=l(e,"P",{});var UG=r(Zp);g$=n(UG,"What is integrated:"),UG.forEach(t),Kj=c(e),Np=l(e,"P",{});var GG=r(Np);w$=n(GG,"Training:"),GG.forEach(t),Jj=c(e),Hp=l(e,"OL",{});var LG=r(Hp);uf=l(LG,"LI",{});var MG=r(uf);y$=n(MG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),MG.forEach(t),LG.forEach(t),Xj=c(e),Bp=l(e,"P",{});var ZG=r(Bp);b$=n(ZG,"Inference:"),ZG.forEach(t),Qj=c(e),Wp=l(e,"OL",{});var NG=r(Wp);lo=l(NG,"LI",{});var nE=r(lo);E$=n(nE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Fp=l(nE,"A",{href:!0});var HG=r(Fp);q$=n(HG,"deepspeed-zero-inference"),HG.forEach(t),$$=n(nE,"."),nE.forEach(t),NG.forEach(t),eg=c(e),Vp=l(e,"P",{});var BG=r(Vp);k$=n(BG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),BG.forEach(t),sg=c(e),Yp=l(e,"A",{id:!0}),r(Yp).forEach(t),tg=c(e),ks=l(e,"H2",{class:!0});var oE=r(ks);$t=l(oE,"A",{id:!0,class:!0,href:!0});var WG=r($t);cf=l(WG,"SPAN",{});var FG=r(cf);d(ro.$$.fragment,FG),FG.forEach(t),WG.forEach(t),P$=c(oE),hf=l(oE,"SPAN",{});var VG=r(hf);D$=n(VG,"Trainer Deepspeed Integration"),VG.forEach(t),oE.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),Ps=l(e,"H3",{class:!0});var lE=r(Ps);kt=l(lE,"A",{id:!0,class:!0,href:!0});var YG=r(kt);ff=l(YG,"SPAN",{});var KG=r(ff);d(po.$$.fragment,KG),KG.forEach(t),YG.forEach(t),z$=c(lE),df=l(lE,"SPAN",{});var JG=r(df);O$=n(JG,"Installation"),JG.forEach(t),lE.forEach(t),og=c(e),Jp=l(e,"P",{});var XG=r(Jp);T$=n(XG,"Install the library via pypi:"),XG.forEach(t),lg=c(e),d(io.$$.fragment,e),rg=c(e),Ce=l(e,"P",{});var rh=r(Ce);A$=n(rh,"or via "),mf=l(rh,"CODE",{});var QG=r(mf);S$=n(QG,"transformers"),QG.forEach(t),C$=n(rh,"\u2019 "),_f=l(rh,"CODE",{});var eL=r(_f);x$=n(eL,"extras"),eL.forEach(t),R$=n(rh,":"),rh.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),xe=l(e,"P",{});var ph=r(xe);I$=n(ph,"or find more details on "),co=l(ph,"A",{href:!0,rel:!0});var sL=r(co);U$=n(sL,"the DeepSpeed\u2019s GitHub page"),sL.forEach(t),G$=n(ph,` and
`),ho=l(ph,"A",{href:!0,rel:!0});var tL=r(ho);L$=n(tL,"advanced install"),tL.forEach(t),M$=n(ph,"."),ph.forEach(t),ug=c(e),Pt=l(e,"P",{});var rE=r(Pt);Z$=n(rE,"If you\u2019re still struggling with the build, first make sure to read "),Xp=l(rE,"A",{href:!0});var aL=r(Xp);N$=n(aL,"zero-install-notes"),aL.forEach(t),H$=n(rE,"."),rE.forEach(t),cg=c(e),Qp=l(e,"P",{});var nL=r(Qp);B$=n(nL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),nL.forEach(t),hg=c(e),ei=l(e,"P",{});var oL=r(ei);W$=n(oL,"To make a local build for DeepSpeed:"),oL.forEach(t),fg=c(e),d(fo.$$.fragment,e),dg=c(e),Re=l(e,"P",{});var ih=r(Re);F$=n(ih,"If you intend to use NVMe offload you will also need to include "),vf=l(ih,"CODE",{});var lL=r(vf);V$=n(lL,"DS_BUILD_AIO=1"),lL.forEach(t),Y$=n(ih,` in the instructions above (and also
install `),jf=l(ih,"EM",{});var rL=r(jf);K$=n(rL,"libaio-dev"),rL.forEach(t),J$=n(ih," system-wide)."),ih.forEach(t),mg=c(e),Dt=l(e,"P",{});var pE=r(Dt);X$=n(pE,"Edit "),gf=l(pE,"CODE",{});var pL=r(gf);Q$=n(pL,"TORCH_CUDA_ARCH_LIST"),pL.forEach(t),e4=n(pE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
the visible scope of available GPUs. Instead, you have to use the following syntax:`),EE.forEach(t),K5=c(dh),d(xo.$$.fragment,dh),J5=c(dh),Kf=l(dh,"P",{});var pM=r(Kf);X5=n(pM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pM.forEach(t),dh.forEach(t),lM.forEach(t),lw=c(e),vi=l(e,"A",{id:!0}),r(vi).forEach(t),rw=c(e),As=l(e,"H3",{class:!0});var qE=r(As);Nt=l(qE,"A",{id:!0,class:!0,href:!0});var iM=r(Nt);Jf=l(iM,"SPAN",{});var uM=r(Jf);d(Ro.$$.fragment,uM),uM.forEach(t),iM.forEach(t),Q5=c(qE),Xf=l(qE,"SPAN",{});var cM=r(Xf);e9=n(cM,"Deployment in Notebooks"),cM.forEach(t),qE.forEach(t),pw=c(e),Ht=l(e,"P",{});var $E=r(Ht);s9=n($E,"The problem with running notebook cells as a script is that there is no normal "),Qf=l($E,"CODE",{});var hM=r(Qf);t9=n(hM,"deepspeed"),hM.forEach(t),a9=n($E,` launcher to rely on, so
under certain setups we have to emulate it.`),$E.forEach(t),iw=c(e),ji=l(e,"P",{});var fM=r(ji);n9=n(fM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),fM.forEach(t),uw=c(e),d(Io.$$.fragment,e),cw=c(e),Bt=l(e,"P",{});var kE=r(Bt);o9=n(kE,"Note: "),ed=l(kE,"CODE",{});var dM=r(ed);l9=n(dM,"..."),dM.forEach(t),r9=n(kE," stands for the normal arguments that you\u2019d pass to the functions."),kE.forEach(t),hw=c(e),gi=l(e,"P",{});var mM=r(gi);p9=n(mM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),mM.forEach(t),fw=c(e),wi=l(e,"P",{});var _M=r(wi);i9=n(_M,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),_M.forEach(t),dw=c(e),d(Uo.$$.fragment,e),mw=c(e),Le=l(e,"P",{});var mh=r(Le);u9=n(mh,"If the training script is in a normal file and not in the notebook cells, you can launch "),sd=l(mh,"CODE",{});var vM=r(sd);c9=n(vM,"deepspeed"),vM.forEach(t),h9=n(mh,` normally via
shell from a cell. For example, to use `),td=l(mh,"CODE",{});var jM=r(td);f9=n(jM,"run_translation.py"),jM.forEach(t),d9=n(mh," you would launch it with:"),mh.forEach(t),_w=c(e),d(Go.$$.fragment,e),vw=c(e),Wt=l(e,"P",{});var PE=r(Wt);m9=n(PE,"or with "),ad=l(PE,"CODE",{});var gM=r(ad);_9=n(gM,"%%bash"),gM.forEach(t),v9=n(PE," magic, where you can write a multi-line code for the shell program to run:"),PE.forEach(t),jw=c(e),d(Lo.$$.fragment,e),gw=c(e),yi=l(e,"P",{});var wM=r(yi);j9=n(wM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),wM.forEach(t),ww=c(e),Ft=l(e,"P",{});var DE=r(Ft);g9=n(DE,"Note: While "),nd=l(DE,"CODE",{});var yM=r(nd);w9=n(yM,"%%bash"),yM.forEach(t),y9=n(DE,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),DE.forEach(t),yw=c(e),bi=l(e,"A",{id:!0}),r(bi).forEach(t),bw=c(e),Ss=l(e,"H3",{class:!0});var zE=r(Ss);Vt=l(zE,"A",{id:!0,class:!0,href:!0});var bM=r(Vt);od=l(bM,"SPAN",{});var EM=r(od);d(Mo.$$.fragment,EM),EM.forEach(t),bM.forEach(t),b9=c(zE),ld=l(zE,"SPAN",{});var qM=r(ld);E9=n(qM,"Configuration"),qM.forEach(t),zE.forEach(t),Ew=c(e),Yt=l(e,"P",{});var OE=r(Yt);q9=n(OE,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Zo=l(OE,"A",{href:!0,rel:!0});var $M=r(Zo);$9=n($M,"following documentation"),$M.forEach(t),k9=n(OE,"."),OE.forEach(t),qw=c(e),Kt=l(e,"P",{});var TE=r(Kt);P9=n(TE,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),No=l(TE,"A",{href:!0,rel:!0});var kM=r(No);D9=n(kM,`the DeepSpeedExamples
repo`),kM.forEach(t),z9=n(TE,":"),TE.forEach(t),$w=c(e),d(Ho.$$.fragment,e),kw=c(e),Jt=l(e,"P",{});var AE=r(Jt);O9=n(AE,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),rd=l(AE,"CODE",{});var PM=r(rd);T9=n(PM,".json"),PM.forEach(t),A9=n(AE," files with:"),AE.forEach(t),Pw=c(e),d(Bo.$$.fragment,e),Dw=c(e),Xt=l(e,"P",{});var SE=r(Xt);S9=n(SE,"Some more examples are to be found in the "),Wo=l(SE,"A",{href:!0,rel:!0});var DM=r(Wo);C9=n(DM,"main repo"),DM.forEach(t),x9=n(SE," as well."),SE.forEach(t),zw=c(e),Ei=l(e,"P",{});var zM=r(Ei);R9=n(zM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),zM.forEach(t),Ow=c(e),oe=l(e,"P",{});var Zn=r(oe);I9=n(Zn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),pd=l(Zn,"CODE",{});var OM=r(pd);U9=n(OM,"AdamW"),OM.forEach(t),G9=n(Zn," optimizer and "),id=l(Zn,"CODE",{});var TM=r(id);L9=n(TM,"WarmupLR"),TM.forEach(t),M9=n(Zn,` scheduler and will enable mixed
precision training if `),ud=l(Zn,"CODE",{});var AM=r(ud);Z9=n(AM,"--fp16"),AM.forEach(t),N9=n(Zn," is passed:"),Zn.forEach(t),Tw=c(e),d(Fo.$$.fragment,e),Aw=c(e),Qt=l(e,"P",{});var CE=r(Qt);H9=n(CE,"When you execute the program, DeepSpeed will log the configuration it received from the "),qi=l(CE,"A",{href:!0});var SM=r(qi);B9=n(SM,"Trainer"),SM.forEach(t),W9=n(CE,`
to the console, so you can see exactly what was the final configuration passed to it.`),CE.forEach(t),Sw=c(e),$i=l(e,"A",{id:!0}),r($i).forEach(t),Cw=c(e),Cs=l(e,"H3",{class:!0});var xE=r(Cs);ea=l(xE,"A",{id:!0,class:!0,href:!0});var CM=r(ea);cd=l(CM,"SPAN",{});var xM=r(cd);d(Vo.$$.fragment,xM),xM.forEach(t),CM.forEach(t),F9=c(xE),hd=l(xE,"SPAN",{});var RM=r(hd);V9=n(RM,"Passing Configuration"),RM.forEach(t),xE.forEach(t),xw=c(e),G=l(e,"P",{});var ye=r(G);Y9=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),ki=l(ye,"A",{href:!0});var IM=r(ki);K9=n(IM,"Trainer"),IM.forEach(t),J9=n(ye," via "),Pi=l(ye,"A",{href:!0});var UM=r(Pi);X9=n(UM,"TrainingArguments"),UM.forEach(t),Q9=n(ye," then for the "),fd=l(ye,"CODE",{});var GM=r(fd);e8=n(GM,"deepspeed"),GM.forEach(t),s8=n(ye,` argument you can
pass a nested `),dd=l(ye,"CODE",{});var LM=r(dd);t8=n(LM,"dict"),LM.forEach(t),a8=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),Di=l(ye,"A",{href:!0});var MM=r(Di);n8=n(MM,"TrainingArguments"),MM.forEach(t),o8=n(ye,"."),ye.forEach(t),Rw=c(e),zi=l(e,"P",{});var ZM=r(zi);l8=n(ZM,"To summarize you can do:"),ZM.forEach(t),Iw=c(e),d(Yo.$$.fragment,e),Uw=c(e),Oi=l(e,"P",{});var NM=r(Oi);r8=n(NM,"or:"),NM.forEach(t),Gw=c(e),d(Ko.$$.fragment,e),Lw=c(e),Ti=l(e,"A",{id:!0}),r(Ti).forEach(t),Mw=c(e),xs=l(e,"H3",{class:!0});var RE=r(xs);sa=l(RE,"A",{id:!0,class:!0,href:!0});var HM=r(sa);md=l(HM,"SPAN",{});var BM=r(md);d(Jo.$$.fragment,BM),BM.forEach(t),HM.forEach(t),p8=c(RE),_d=l(RE,"SPAN",{});var WM=r(_d);i8=n(WM,"Shared Configuration"),WM.forEach(t),RE.forEach(t),Zw=c(e),d(ta.$$.fragment,e),Nw=c(e),Me=l(e,"P",{});var _h=r(Me);u8=n(_h,"Some configuration values are required by both the "),Ai=l(_h,"A",{href:!0});var FM=r(Ai);c8=n(FM,"Trainer"),FM.forEach(t),h8=n(_h,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Si=l(_h,"A",{href:!0});var VM=r(Si);f8=n(VM,"Trainer"),VM.forEach(t),d8=n(_h," command line arguments."),_h.forEach(t),Hw=c(e),aa=l(e,"P",{});var IE=r(aa);m8=n(IE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),Ci=l(IE,"A",{href:!0});var YM=r(Ci);_8=n(YM,"Trainer"),YM.forEach(t),v8=n(IE,` do the majority
of configuration for you.`),IE.forEach(t),Bw=c(e),Ze=l(e,"P",{});var vh=r(Ze);j8=n(vh,"Therefore, in the rest of this guide you will find a special configuration value: "),vd=l(vh,"CODE",{});var KM=r(vd);g8=n(KM,"auto"),KM.forEach(t),w8=n(vh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),xi=l(vh,"A",{href:!0});var JM=r(xi);y8=n(JM,"Trainer"),JM.forEach(t),b8=n(vh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),vh.forEach(t),Ww=c(e),Ri=l(e,"P",{});var XM=r(Ri);E8=n(XM,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),XM.forEach(t),Fw=c(e),na=l(e,"P",{});var UE=r(na);q8=n(UE,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ii=l(UE,"A",{href:!0});var QM=r(Ii);$8=n(QM,"TrainingArguments"),QM.forEach(t),k8=n(UE," based on that. The steps are:"),UE.forEach(t),Vw=c(e),oa=l(e,"OL",{});var GE=r(oa);jd=l(GE,"LI",{});var eZ=r(jd);P8=n(eZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),eZ.forEach(t),D8=c(GE),Xo=l(GE,"LI",{});var LE=r(Xo);z8=n(LE,"Create the "),Ui=l(LE,"A",{href:!0});var sZ=r(Ui);O8=n(sZ,"TrainingArguments"),sZ.forEach(t),T8=n(LE," object based on these values"),LE.forEach(t),GE.forEach(t),Yw=c(e),le=l(e,"P",{});var Nn=r(le);A8=n(Nn,"Do note that some values, such as "),gd=l(Nn,"CODE",{});var tZ=r(gd);S8=n(tZ,"scheduler.params.total_num_steps"),tZ.forEach(t),C8=n(Nn,` are calculated by
`),Gi=l(Nn,"A",{href:!0});var aZ=r(Gi);x8=n(aZ,"Trainer"),aZ.forEach(t),R8=n(Nn," during "),wd=l(Nn,"CODE",{});var nZ=r(wd);I8=n(nZ,"train"),nZ.forEach(t),U8=n(Nn,", but you can of course do the math yourself."),Nn.forEach(t),Kw=c(e),Li=l(e,"A",{id:!0}),r(Li).forEach(t),Jw=c(e),Rs=l(e,"H3",{class:!0});var ME=r(Rs);la=l(ME,"A",{id:!0,class:!0,href:!0});var oZ=r(la);yd=l(oZ,"SPAN",{});var lZ=r(yd);d(Qo.$$.fragment,lZ),lZ.forEach(t),oZ.forEach(t),G8=c(ME),bd=l(ME,"SPAN",{});var rZ=r(bd);L8=n(rZ,"ZeRO"),rZ.forEach(t),ME.forEach(t),Xw=c(e),el=l(e,"P",{});var hG=r(el);sl=l(hG,"A",{href:!0,rel:!0});var pZ=r(sl);M8=n(pZ,"Zero Redundancy Optimizer (ZeRO)"),pZ.forEach(t),Z8=n(hG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),hG.forEach(t),Qw=c(e),Ne=l(e,"P",{});var jh=r(Ne);N8=n(jh,"The "),Ed=l(jh,"CODE",{});var iZ=r(Ed);H8=n(iZ,"zero_optimization"),iZ.forEach(t),B8=n(jh," section of the configuration file is the most important part ("),tl=l(jh,"A",{href:!0,rel:!0});var uZ=r(tl);W8=n(uZ,"docs"),uZ.forEach(t),F8=n(jh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),jh.forEach(t),ey=c(e),ra=l(e,"P",{});var ZE=r(ra);V8=n(ZE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Mi=l(ZE,"A",{href:!0});var cZ=r(Mi);Y8=n(cZ,"Trainer"),cZ.forEach(t),K8=n(ZE,` provides
no equivalent command line arguments.`),ZE.forEach(t),sy=c(e),Zi=l(e,"P",{});var hZ=r(Zi);J8=n(hZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),hZ.forEach(t),ty=c(e),Ni=l(e,"A",{id:!0}),r(Ni).forEach(t),ay=c(e),Is=l(e,"H4",{class:!0});var NE=r(Is);pa=l(NE,"A",{id:!0,class:!0,href:!0});var fZ=r(pa);qd=l(fZ,"SPAN",{});var dZ=r(qd);d(al.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),X8=c(NE),$d=l(NE,"SPAN",{});var mZ=r($d);Q8=n(mZ,"ZeRO-2 Config"),mZ.forEach(t),NE.forEach(t),ny=c(e),Hi=l(e,"P",{});var _Z=r(Hi);ek=n(_Z,"The following is an example of configuration for ZeRO stage 2:"),_Z.forEach(t),oy=c(e),d(nl.$$.fragment,e),ly=c(e),Bi=l(e,"P",{});var vZ=r(Bi);kd=l(vZ,"STRONG",{});var jZ=r(kd);sk=n(jZ,"Performance tuning:"),jZ.forEach(t),vZ.forEach(t),ry=c(e),He=l(e,"UL",{});var gh=r(He);Us=l(gh,"LI",{});var wh=r(Us);tk=n(wh,"enabling "),Pd=l(wh,"CODE",{});var gZ=r(Pd);ak=n(gZ,"offload_optimizer"),gZ.forEach(t),nk=n(wh," should reduce GPU RAM usage (it requires "),Dd=l(wh,"CODE",{});var wZ=r(Dd);ok=n(wZ,'"stage": 2'),wZ.forEach(t),lk=n(wh,")"),wh.forEach(t),rk=c(gh),L=l(gh,"LI",{});var te=r(L);zd=l(te,"CODE",{});var yZ=r(zd);pk=n(yZ,'"overlap_comm": true'),yZ.forEach(t),ik=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Od=l(te,"CODE",{});var bZ=r(Od);uk=n(bZ,"overlap_comm"),bZ.forEach(t),ck=n(te,` uses 4.5x
the `),Td=l(te,"CODE",{});var EZ=r(Td);hk=n(EZ,"allgather_bucket_size"),EZ.forEach(t),fk=n(te," and "),Ad=l(te,"CODE",{});var qZ=r(Ad);dk=n(qZ,"reduce_bucket_size"),qZ.forEach(t),mk=n(te,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),Sd=l(te,"CODE",{});var $Z=r(Sd);_k=n($Z,"5e8 x 2Bytes x 2 x 4.5"),$Z.forEach(t),vk=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),Cd=l(te,"CODE",{});var kZ=r(Cd);jk=n(kZ,"2e8"),kZ.forEach(t),gk=n(te,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),te.forEach(t),wk=c(gh),xd=l(gh,"LI",{});var PZ=r(xd);yk=n(PZ,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),PZ.forEach(t),gh.forEach(t),py=c(e),Be=l(e,"P",{});var yh=r(Be);bk=n(yh,"Additionally, "),Rd=l(yh,"CODE",{});var DZ=r(Rd);Ek=n(DZ,"deepspeed==0.4.4"),DZ.forEach(t),qk=n(yh," added a new option "),Id=l(yh,"CODE",{});var zZ=r(Id);$k=n(zZ,"round_robin_gradients"),zZ.forEach(t),kk=n(yh," which you can enable with:"),yh.forEach(t),iy=c(e),d(ol.$$.fragment,e),uy=c(e),Wi=l(e,"P",{});var OZ=r(Wi);Pk=n(OZ,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),OZ.forEach(t),cy=c(e),Fi=l(e,"A",{id:!0}),r(Fi).forEach(t),hy=c(e),Gs=l(e,"H4",{class:!0});var HE=r(Gs);ia=l(HE,"A",{id:!0,class:!0,href:!0});var TZ=r(ia);Ud=l(TZ,"SPAN",{});var AZ=r(Ud);d(ll.$$.fragment,AZ),AZ.forEach(t),TZ.forEach(t),Dk=c(HE),Gd=l(HE,"SPAN",{});var SZ=r(Gd);zk=n(SZ,"ZeRO-3 Config"),SZ.forEach(t),HE.forEach(t),fy=c(e),Vi=l(e,"P",{});var CZ=r(Vi);Ok=n(CZ,"The following is an example of configuration for ZeRO stage 3:"),CZ.forEach(t),dy=c(e),d(rl.$$.fragment,e),my=c(e),K=l(e,"P",{});var ys=r(K);Tk=n(ys,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Ld=l(ys,"CODE",{});var xZ=r(Ld);Ak=n(xZ,'"device": "cpu"'),xZ.forEach(t),Sk=n(ys,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Md=l(ys,"CODE",{});var RZ=r(Md);Ck=n(RZ,"none"),RZ.forEach(t),xk=n(ys," instead of "),Zd=l(ys,"CODE",{});var IZ=r(Zd);Rk=n(IZ,"cpu"),IZ.forEach(t),Ik=n(ys," for the "),Nd=l(ys,"CODE",{});var UZ=r(Nd);Uk=n(UZ,"device"),UZ.forEach(t),Gk=n(ys,` entry. Offloading to
NVMe is discussed further down.`),ys.forEach(t),_y=c(e),We=l(e,"P",{});var bh=r(We);Lk=n(bh,"Pinned memory is enabled with "),Hd=l(bh,"CODE",{});var GZ=r(Hd);Mk=n(GZ,"pin_memory"),GZ.forEach(t),Zk=n(bh," set to "),Bd=l(bh,"CODE",{});var LZ=r(Bd);Nk=n(LZ,"true"),LZ.forEach(t),Hk=n(bh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),bh.forEach(t),vy=c(e),Yi=l(e,"P",{});var MZ=r(Yi);Wd=l(MZ,"STRONG",{});var ZZ=r(Wd);Bk=n(ZZ,"Performance tuning:"),ZZ.forEach(t),MZ.forEach(t),jy=c(e),ua=l(e,"UL",{});var BE=r(ua);pl=l(BE,"LI",{});var WE=r(pl);Fd=l(WE,"CODE",{});var NZ=r(Fd);Wk=n(NZ,"stage3_max_live_parameters"),NZ.forEach(t),Fk=n(WE,": "),Vd=l(WE,"CODE",{});var HZ=r(Vd);Vk=n(HZ,"1e9"),HZ.forEach(t),WE.forEach(t),Yk=c(BE),il=l(BE,"LI",{});var FE=r(il);Yd=l(FE,"CODE",{});var BZ=r(Yd);Kk=n(BZ,"stage3_max_reuse_distance"),BZ.forEach(t),Jk=n(FE,": "),Kd=l(FE,"CODE",{});var WZ=r(Kd);Xk=n(WZ,"1e9"),WZ.forEach(t),FE.forEach(t),BE.forEach(t),gy=c(e),M=l(e,"P",{});var be=r(M);Qk=n(be,"If hitting OOM reduce "),Jd=l(be,"CODE",{});var FZ=r(Jd);e7=n(FZ,"stage3_max_live_parameters"),FZ.forEach(t),s7=n(be," and "),Xd=l(be,"CODE",{});var VZ=r(Xd);t7=n(VZ,"stage3_max_reuse_distance"),VZ.forEach(t),a7=n(be,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Qd=l(be,"CODE",{});var YZ=r(Qd);n7=n(YZ,"1e9"),YZ.forEach(t),o7=n(be,` would consume ~2GB. The memory is shared by
`),em=l(be,"CODE",{});var KZ=r(em);l7=n(KZ,"stage3_max_live_parameters"),KZ.forEach(t),r7=n(be," and "),sm=l(be,"CODE",{});var JZ=r(sm);p7=n(JZ,"stage3_max_reuse_distance"),JZ.forEach(t),i7=n(be,", so it\u2019s not additive, it\u2019s just 2GB total."),be.forEach(t),wy=c(e),ze=l(e,"P",{});var Ap=r(ze);tm=l(Ap,"CODE",{});var XZ=r(tm);u7=n(XZ,"stage3_max_live_parameters"),XZ.forEach(t),c7=n(Ap,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),am=l(Ap,"CODE",{});var QZ=r(am);h7=n(QZ,"stage3_max_reuse_distance"),QZ.forEach(t),f7=n(Ap,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),nm=l(Ap,"CODE",{});var eN=r(nm);d7=n(eN,"stage3_max_reuse_distance"),eN.forEach(t),m7=n(Ap,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ap.forEach(t),yy=c(e),Ki=l(e,"P",{});var sN=r(Ki);_7=n(sN,"The following configuration values depend on the model\u2019s hidden size:"),sN.forEach(t),by=c(e),Fe=l(e,"UL",{});var Eh=r(Fe);ul=l(Eh,"LI",{});var VE=r(ul);om=l(VE,"CODE",{});var tN=r(om);v7=n(tN,"reduce_bucket_size"),tN.forEach(t),j7=n(VE,": "),lm=l(VE,"CODE",{});var aN=r(lm);g7=n(aN,"hidden_size*hidden_size"),aN.forEach(t),VE.forEach(t),w7=c(Eh),cl=l(Eh,"LI",{});var YE=r(cl);rm=l(YE,"CODE",{});var nN=r(rm);y7=n(nN,"stage3_prefetch_bucket_size"),nN.forEach(t),b7=n(YE,": "),pm=l(YE,"CODE",{});var oN=r(pm);E7=n(oN,"0.9 * hidden_size * hidden_size"),oN.forEach(t),YE.forEach(t),q7=c(Eh),hl=l(Eh,"LI",{});var KE=r(hl);im=l(KE,"CODE",{});var lN=r(im);$7=n(lN,"stage3_param_persistence_threshold"),lN.forEach(t),k7=n(KE,": "),um=l(KE,"CODE",{});var rN=r(um);P7=n(rN,"10 * hidden_size"),rN.forEach(t),KE.forEach(t),Eh.forEach(t),Ey=c(e),Ve=l(e,"P",{});var qh=r(Ve);D7=n(qh,"therefore set these values to "),cm=l(qh,"CODE",{});var pN=r(cm);z7=n(pN,"auto"),pN.forEach(t),O7=n(qh," and the "),Ji=l(qh,"A",{href:!0});var iN=r(Ji);T7=n(iN,"Trainer"),iN.forEach(t),A7=n(qh,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),qh.forEach(t),qy=c(e),fl=l(e,"P",{});var fG=r(fl);hm=l(fG,"CODE",{});var uN=r(hm);S7=n(uN,"stage3_gather_16bit_weights_on_model_save"),uN.forEach(t),C7=n(fG,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),fG.forEach(t),$y=c(e),re=l(e,"P",{});var Hn=r(re);x7=n(Hn,"If you\u2019re migrating from ZeRO-2 configuration note that "),fm=l(Hn,"CODE",{});var cN=r(fm);R7=n(cN,"allgather_partitions"),cN.forEach(t),I7=n(Hn,", "),dm=l(Hn,"CODE",{});var hN=r(dm);U7=n(hN,"allgather_bucket_size"),hN.forEach(t),G7=n(Hn,` and
`),mm=l(Hn,"CODE",{});var fN=r(mm);L7=n(fN,"reduce_scatter"),fN.forEach(t),M7=n(Hn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Hn.forEach(t),ky=c(e),Xi=l(e,"UL",{});var dN=r(Xi);dl=l(dN,"LI",{});var JE=r(dl);_m=l(JE,"CODE",{});var mN=r(_m);Z7=n(mN,"sub_group_size"),mN.forEach(t),N7=n(JE,": "),vm=l(JE,"CODE",{});var _N=r(vm);H7=n(_N,"1e9"),_N.forEach(t),JE.forEach(t),dN.forEach(t),Py=c(e),Oe=l(e,"P",{});var Sp=r(Oe);jm=l(Sp,"CODE",{});var vN=r(jm);B7=n(vN,"sub_group_size"),vN.forEach(t),W7=n(Sp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),gm=l(Sp,"CODE",{});var jN=r(gm);F7=n(jN,"sub_group_size"),jN.forEach(t),V7=n(Sp,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),wm=l(Sp,"CODE",{});var gN=r(wm);Y7=n(gN,"sub_group_size"),gN.forEach(t),K7=n(Sp,` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),Sp.forEach(t),Dy=c(e),Ye=l(e,"P",{});var $h=r(Ye);J7=n($h,"You can leave "),ym=l($h,"CODE",{});var wN=r(ym);X7=n(wN,"sub_group_size"),wN.forEach(t),Q7=n($h," to its default value of "),bm=l($h,"EM",{});var yN=r(bm);eP=n(yN,"1e9"),yN.forEach(t),sP=n($h,` when not using NVMe offload. You may want to change its
...
circumstances you may find the following information to be needed.`),DF.forEach(t),q3=c(e),nt=l(e,"H4",{class:!0});var e6=r(nt);un=l(e6,"A",{id:!0,class:!0,href:!0});var zF=r(un);ov=l(zF,"SPAN",{});var OF=r(ov);d(kr.$$.fragment,OF),OF.forEach(t),zF.forEach(t),_C=c(e6),lv=l(e6,"SPAN",{});var TF=r(lv);vC=n(TF,"Constructing Massive Models"),TF.forEach(t),e6.forEach(t),$3=c(e),cn=l(e,"P",{});var s6=r(cn);jC=n(s6,`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
but also if you want the initialization to happen much faster, initialize the model using `),rv=l(s6,"EM",{});var AF=r(rv);gC=n(AF,"deepspeed.zero.Init()"),AF.forEach(t),wC=n(s6,`
context manager (which is also a function decorator), like so:`),s6.forEach(t),k3=c(e),d(Pr.$$.fragment,e),P3=c(e),uc=l(e,"P",{});var SF=r(uc);yC=n(SF,"As you can see this gives you a randomly initialized model."),SF.forEach(t),D3=c(e),D=l(e,"P",{});var W=r(D);bC=n(W,"If you want to use a pretrained model, "),pv=l(W,"CODE",{});var CF=r(pv);EC=n(CF,"model_class.from_pretrained"),CF.forEach(t),qC=n(W,` will activate this feature as long as
...
`),hv=l(W,"CODE",{});var LF=r(hv);xC=n(LF,"from_pretrained"),LF.forEach(t),RC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),z3=c(e),d(Dr.$$.fragment,e),O3=c(e),hn=l(e,"P",{});var t6=r(hn);IC=n(t6,"If you\u2019re using the official example scripts and your command line arguments include "),fv=l(t6,"CODE",{});var MF=r(fv);UC=n(MF,"--deepspeed ds_config.json"),MF.forEach(t),GC=n(t6,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),t6.forEach(t),T3=c(e),fc=l(e,"P",{});var ZF=r(fc);LC=n(ZF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),ZF.forEach(t),A3=c(e),fn=l(e,"P",{});var a6=r(fn);MC=n(a6,"For full details on this method and other related features please refer to "),zr=l(a6,"A",{href:!0,rel:!0});var NF=r(zr);ZC=n(NF,"Constructing Massive Models"),NF.forEach(t),NC=n(a6,"."),a6.forEach(t),S3=c(e),fe=l(e,"P",{});var Kn=r(fe);HC=n(Kn,"Also when loading fp16-pretrained models, you will want to tell "),dv=l(Kn,"CODE",{});var HF=r(dv);BC=n(HF,"from_pretrained"),HF.forEach(t),WC=n(Kn,` to use
`),mv=l(Kn,"CODE",{});var BF=r(mv);FC=n(BF,"torch_dtype=torch.float16"),BF.forEach(t),VC=n(Kn,". For details, please, see "),dc=l(Kn,"A",{href:!0});var WF=r(dc);YC=n(WF,"from_pretrained-torch-dtype"),WF.forEach(t),KC=n(Kn,"."),Kn.forEach(t),C3=c(e),ot=l(e,"H4",{class:!0});var n6=r(ot);dn=l(n6,"A",{id:!0,class:!0,href:!0});var FF=r(dn);_v=l(FF,"SPAN",{});var VF=r(_v);d(Or.$$.fragment,VF),VF.forEach(t),FF.forEach(t),JC=c(n6),vv=l(n6,"SPAN",{});var YF=r(vv);XC=n(YF,"Gathering Parameters"),YF.forEach(t),n6.forEach(t),x3=c(e),Tr=l(e,"P",{});var mG=r(Tr);QC=n(mG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Ar=l(mG,"A",{href:!0,rel:!0});var KF=r(Ar);ex=n(KF,"Gathering Parameters"),KF.forEach(t),mG.forEach(t),R3=c(e),mn=l(e,"P",{});var o6=r(mn);sx=n(o6,`We do however use it internally in several places, one such example is when loading pretrained model weights in
`),jv=l(o6,"CODE",{});var JF=r(jv);tx=n(JF,"from_pretrained"),JF.forEach(t),ax=n(o6,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
limitations.`),o6.forEach(t),I3=c(e),mc=l(e,"P",{});var XF=r(mc);nx=n(XF,"Also under ZeRO-3, if you write your own code and run into a model parameter weight that looks like:"),XF.forEach(t),U3=c(e),d(Sr.$$.fragment,e),G3=c(e),ds=l(e,"P",{});var Zh=r(ds);ox=n(Zh,"stress on "),gv=l(Zh,"CODE",{});var QF=r(gv);lx=n(QF,"tensor([1.])"),QF.forEach(t),rx=n(Zh,", or if you get an error where it says the parameter is of size "),wv=l(Zh,"CODE",{});var eV=r(wv);px=n(eV,"1"),eV.forEach(t),ix=n(Zh,`, instead of some much
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),Zh.forEach(t),L3=c(e),_c=l(e,"A",{id:!0}),r(_c).forEach(t),M3=c(e),lt=l(e,"H3",{class:!0});var l6=r(lt);_n=l(l6,"A",{id:!0,class:!0,href:!0});var sV=r(_n);yv=l(sV,"SPAN",{});var tV=r(yv);d(Cr.$$.fragment,tV),tV.forEach(t),sV.forEach(t),ux=c(l6),bv=l(l6,"SPAN",{});var aV=r(bv);cx=n(aV,"ZeRO Inference"),aV.forEach(t),l6.forEach(t),Z3=c(e),vc=l(e,"P",{});var nV=r(vc);hx=n(nV,`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),nV.forEach(t),N3=c(e),vn=l(e,"P",{});var r6=r(vn);fx=n(r6,"Otherwise you just need to pass the usual "),jc=l(r6,"A",{href:!0});var oV=r(jc);dx=n(oV,"TrainingArguments"),oV.forEach(t),mx=n(r6," arguments. For example:"),r6.forEach(t),H3=c(e),d(xr.$$.fragment,e),B3=c(e),gc=l(e,"P",{});var lV=r(gc);_x=n(lV,`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),lV.forEach(t),W3=c(e),jn=l(e,"P",{});var p6=r(jn);vx=n(p6,"Here is an example of running "),Ev=l(p6,"CODE",{});var rV=r(Ev);jx=n(rV,"run_translation.py"),rV.forEach(t),gx=n(p6," under DeepSpeed deploying all available GPUs:"),p6.forEach(t),F3=c(e),d(Rr.$$.fragment,e),V3=c(e),wc=l(e,"P",{});var pV=r(wc);wx=n(pV,`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
...
dump the `),Sc=l(Jn,"A",{href:!0});var TV=r(Sc);Bx=n(TV,"TrainingArguments"),TV.forEach(t),Wx=n(Jn," as it has dozens of entries that are irrelevant."),Jn.forEach(t),DV.forEach(t),Fx=c($e),Zr=l($e,"LI",{});var h6=r(Zr);Tv=l(h6,"P",{});var AV=r(Tv);Vx=n(AV,"Output of:"),AV.forEach(t),Yx=c(h6),d(Nr.$$.fragment,h6),h6.forEach(t),Kx=c($e),Av=l($e,"LI",{});var SV=r(Av);Hr=l(SV,"P",{});var f6=r(Hr);Jx=n(f6,`If possible include a link to a Google Colab notebook that we can reproduce the problem with. You can use this
`),Br=l(f6,"A",{href:!0,rel:!0});var CV=r(Br);Xx=n(CV,"notebook"),CV.forEach(t),Qx=n(f6,` as
a starting point.`),f6.forEach(t),SV.forEach(t),eR=c($e),Sv=l($e,"LI",{});var xV=r(Sv);Cv=l(xV,"P",{});var RV=r(Cv);sR=n(RV,"Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),RV.forEach(t),xV.forEach(t),tR=c($e),xv=l($e,"LI",{});var IV=r(xv);Wr=l(IV,"P",{});var d6=r(Wr);aR=n(d6,"If possible try to use one of the existing "),Fr=l(d6,"A",{href:!0,rel:!0});var UV=r(Fr);nR=n(UV,"examples"),UV.forEach(t),oR=n(d6," to reproduce the problem with."),d6.forEach(t),IV.forEach(t),$e.forEach(t),c0=c(e),Cc=l(e,"P",{});var GV=r(Cc);lR=n(GV,"Things to consider:"),GV.forEach(t),h0=c(e),bn=l(e,"UL",{});var m6=r(bn);it=l(m6,"LI",{});var Nh=r(it);Rv=l(Nh,"P",{});var LV=r(Rv);rR=n(LV,"Deepspeed is often not the cause of the problem."),LV.forEach(t),pR=c(Nh),Iv=l(Nh,"P",{});var MV=r(Iv);iR=n(MV,`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
exception and you can see that DeepSpeed modules are involved, first re-test your setup without DeepSpeed in it.
And only if the problem persists then do mentioned Deepspeed and supply all the required details.`),ZV.forEach(t),Nh.forEach(t),hR=c(m6),Gv=l(m6,"LI",{});var NV=r(Gv);Vr=l(NV,"P",{});var _6=r(Vr);fR=n(_6,`If it\u2019s clear to you that the issue is in the DeepSpeed core and not the integration part, please file the Issue
directly with `),Yr=l(_6,"A",{href:!0,rel:!0});var HV=r(Yr);dR=n(HV,"Deepspeed"),HV.forEach(t),mR=n(_6,`. If you aren\u2019t sure, please do not worry,
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),_6.forEach(t),NV.forEach(t),m6.forEach(t),f0=c(e),ut=l(e,"H3",{class:!0});var v6=r(ut);En=l(v6,"A",{id:!0,class:!0,href:!0});var BV=r(En);Lv=l(BV,"SPAN",{});var WV=r(Lv);d(Kr.$$.fragment,WV),WV.forEach(t),BV.forEach(t),_R=c(v6),Mv=l(v6,"SPAN",{});var FV=r(Mv);vR=n(FV,"Troubleshooting"),FV.forEach(t),v6.forEach(t),d0=c(e),ct=l(e,"H4",{class:!0});var j6=r(ct);qn=l(j6,"A",{id:!0,class:!0,href:!0});var VV=r(qn);Zv=l(VV,"SPAN",{});var YV=r(Zv);d(Jr.$$.fragment,YV),YV.forEach(t),VV.forEach(t),jR=c(j6),Xr=l(j6,"SPAN",{});var g6=r(Xr);gR=n(g6,"the "),Nv=l(g6,"CODE",{});var KV=r(Nv);wR=n(KV,"deepspeed"),KV.forEach(t),yR=n(g6," process gets killed at startup without a traceback"),g6.forEach(t),j6.forEach(t),m0=c(e),B=l(e,"P",{});var ke=r(B);bR=n(ke,"If the "),Hv=l(ke,"CODE",{});var JV=r(Hv);ER=n(JV,"deepspeed"),JV.forEach(t),qR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
