...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16902/en/model_doc/gpt_neo#transformers.GPTNeoModel">GPTNeoModel</a>. Vocabulary size of the model. Defines the different
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16902/src/transformers/models/gpt_neo/configuration_gpt_neo.py#L34"}}),Ve=new oe({props:{code:`from transformers import GPTNeoModel, GPTNeoConfig
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/pr_16902/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16902/en/model_doc/gpt_neo#transformers.GPTNeoConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16902/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L709",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16902/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L824",returnDescription:`
