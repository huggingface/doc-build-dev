...
above for more information.`),_.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/pr_16398/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m($,_){p($,m,_),e(m,q),e(m,u),e(u,x),e(m,L),e(m,O),e(O,A),e(m,F)},d($){$&&r(m)}}}function Oi(at){let m,q,u,x,L,O,A,F,$,_,P,z,Lt,Ce,ro,Ft,oo,gr,S,ao,we,so,no,ke,io,lo,_r,st,co,vr,nt,Dt,ho,Tr,oe,Js,br,ae,po,it,mo,fo,Cr,se,uo,qt,go,_o,wr,W,vo,ye,To,bo,Oe,Co,wo,kr,lt,ko,yr,B,Ee,yo,Re,Oo,Eo,Ro,I,xo,xe,$o,Po,$e,Mo,jo,Pe,zo,Lo,Fo,Me,Do,dt,qo,Ao,Or,Y,ne,At,je,Io,It,Vo,Er,H,No,Vt,So,Wo,ct,Bo,Ho,Rr,f,Uo,Nt,Xo,Go,St,Zo,Jo,Wt,Yo,Ko,Bt,Qo,ea,ht,ta,ra,Ht,oa,aa,Ut,sa,na,Xt,ia,la,Gt,da,ca,xr,pt,Zt,ha,$r,ze,Pr,ie,pa,Le,ma,fa,Mr,K,le,Jt,Fe,ua,Yt,ga,jr,M,De,_a,Q,va,mt,Ta,ba,qe,Ca,wa,ka,ee,ya,ft,Oa,Ea,ut,Ra,xa,$a,Kt,Pa,Ma,Ae,zr,te,de,Qt,Ie,ja,er,za,Lr,g,Ve,La,tr,Fa,Da,E,gt,qa,Aa,rr,Ia,Va,or,Na,Sa,ar,Wa,Ba,sr,Ha,Ua,Ne,nr,Xa,Ga,Za,_t,Ja,Ya,Ka,ce,Se,Qa,V,es,ir,ts,rs,vt,os,as,lr,ss,ns,is,U,We,ls,dr,ds,cs,he,hs,X,Be,ps,He,ms,Tt,fs,us,gs,pe,_s,me,Ue,vs,Xe,Ts,bt,bs,Cs,ws,fe,Ge,ks,Ze,ys,Ct,Os,Es,Rs,ue,Je,xs,cr,$s,Fr,re,ge,hr,Ye,Ps,pr,Ms,Dr,D,Ke,js,N,zs,wt,Ls,Fs,mr,Ds,qs,kt,As,Is,Vs,Qe,Ns,et,Ss,Ws,Bs,G,tt,Hs,fr,Us,Xs,rt,qr;return O=new zt({}),Ce=new zt({}),je=new zt({}),ze=new Zs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">3</span>)
<span class="hljs-number">5.303</span>
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){m=s("meta"),q=d(),u=s("h1"),x=s("a"),L=s("span"),v(O.$$.fragment),A=d(),F=s("span"),$=o("TrOCR"),_=d(),P=s("h2"),z=s("a"),Lt=s("span"),v(Ce.$$.fragment),ro=d(),Ft=s("span"),oo=o("Overview"),gr=d(),S=s("p"),ao=o("The TrOCR model was proposed in "),we=s("a"),so=o(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
tasks.`),Tr=d(),oe=s("img"),br=d(),ae=s("small"),po=o("TrOCR architecture. Taken from the "),it=s("a"),mo=o("original paper"),fo=o("."),Cr=d(),se=s("p"),uo=o("Please refer to the "),qt=s("code"),go=o("VisionEncoderDecoder"),_o=o(" class on how to use this model."),wr=d(),W=s("p"),vo=o("This model was contributed by "),ye=s("a"),To=o("nielsr"),bo=o(`. The original code can be found
`),Oe=s("a"),Co=o("here"),wo=o("."),kr=d(),lt=s("p"),ko=o("Tips:"),yr=d(),B=s("ul"),Ee=s("li"),yo=o("The quickest way to get started with TrOCR is by checking the "),Re=s("a"),Oo=o(`tutorial
notebooks`),Eo=o(`, which show how to use the model
at inference time as well as fine-tuning on custom data.`),Ro=d(),I=s("li"),xo=o(`TrOCR is pre-trained in 2 stages before being fine-tuned on downstream datasets. It achieves state-of-the-art results
...
information, see the `),Pe=s("a"),zo=o("official models"),Lo=o("."),Fo=d(),Me=s("li"),Do=o("TrOCR is always used within the "),dt=s("a"),qo=o("VisionEncoderDecoder"),Ao=o(" framework."),Or=d(),Y=s("h2"),ne=s("a"),At=s("span"),v(je.$$.fragment),Io=d(),It=s("span"),Vo=o("Inference"),Er=d(),H=s("p"),No=o("TrOCR\u2019s "),Vt=s("code"),So=o("VisionEncoderDecoder"),Wo=o(` model accepts images as input and makes use of
`),ct=s("a"),Bo=o("generate()"),Ho=o(" to autoregressively generate text given the input image."),Rr=d(),f=s("p"),Uo=o("The ["),Nt=s("code"),Xo=o("ViTFeatureExtractor"),Go=o("/"),St=s("code"),Zo=o("DeiTFeatureExtractor"),Jo=o(`] class is responsible for preprocessing the input image and
...
into a single instance to both extract the input features and decode the predicted token ids.`),xr=d(),pt=s("ul"),Zt=s("li"),ha=o("Step-by-step Optical Character Recognition (OCR)"),$r=d(),v(ze.$$.fragment),Pr=d(),ie=s("p"),pa=o("See the "),Le=s("a"),ma=o("model hub"),fa=o(" to look for TrOCR checkpoints."),Mr=d(),K=s("h2"),le=s("a"),Jt=s("span"),v(Fe.$$.fragment),ua=d(),Yt=s("span"),ga=o("TrOCRConfig"),jr=d(),M=s("div"),v(De.$$.fragment),_a=d(),Q=s("p"),va=o("This is the configuration class to store the configuration of a "),mt=s("a"),Ta=o("TrOCRForCausalLM"),ba=o(`. It is used to instantiate an
...
`),qe=s("a"),Ca=o("microsoft/trocr-base"),wa=o(" architecture."),ka=d(),ee=s("p"),ya=o("Configuration objects inherit from "),ft=s("a"),Oa=o("PretrainedConfig"),Ea=o(` and can be used to control the model outputs. Read the
documentation from `),ut=s("a"),Ra=o("PretrainedConfig"),xa=o(" for more information."),$a=d(),Kt=s("p"),Pa=o("Example:"),Ma=d(),v(Ae.$$.fragment),zr=d(),te=s("h2"),de=s("a"),Qt=s("span"),v(Ie.$$.fragment),ja=d(),er=s("span"),za=o("TrOCRProcessor"),Lr=d(),g=s("div"),v(Ve.$$.fragment),La=d(),tr=s("p"),Fa=o("Constructs a TrOCR processor which wraps a vision feature extractor and a TrOCR tokenizer into a single processor."),Da=d(),E=s("p"),gt=s("a"),qa=o("TrOCRProcessor"),Aa=o(" offers all the functionalities of ["),rr=s("code"),Ia=o("ViTFeatureExtractor"),Va=o("/"),or=s("code"),Na=o("DeiTFeatureExtractor"),Sa=o(`] and
...
`),lr=s("code"),ss=o("__call__"),ns=o(". Please refer to the doctsring of the above two methods for more information."),is=d(),U=s("div"),v(We.$$.fragment),ls=d(),dr=s("p"),ds=o("Instantiate a processor associated with a pretrained model."),cs=d(),v(he.$$.fragment),hs=d(),X=s("div"),v(Be.$$.fragment),ps=d(),He=s("p"),ms=o(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
`),Oe=n(Ot,"A",{href:!0,rel:!0});var hn=i(Oe);Co=a(hn,"here"),hn.forEach(r),wo=a(Ot,"."),Ot.forEach(r),kr=c(t),lt=n(t,"P",{});var pn=i(lt);ko=a(pn,"Tips:"),pn.forEach(r),yr=c(t),B=n(t,"UL",{});var Et=i(B);Ee=n(Et,"LI",{});var Nr=i(Ee);yo=a(Nr,"The quickest way to get started with TrOCR is by checking the "),Re=n(Nr,"A",{href:!0,rel:!0});var mn=i(Re);Oo=a(mn,`tutorial
notebooks`),mn.forEach(r),Eo=a(Nr,`, which show how to use the model
at inference time as well as fine-tuning on custom data.`),Nr.forEach(r),Ro=c(Et),I=n(Et,"LI",{});var _e=i(I);xo=a(_e,`TrOCR is pre-trained in 2 stages before being fine-tuned on downstream datasets. It achieves state-of-the-art results
...
information, see the `),Pe=n(_e,"A",{href:!0,rel:!0});var gn=i(Pe);zo=a(gn,"official models"),gn.forEach(r),Lo=a(_e,"."),_e.forEach(r),Fo=c(Et),Me=n(Et,"LI",{});var Sr=i(Me);Do=a(Sr,"TrOCR is always used within the "),dt=n(Sr,"A",{href:!0});var _n=i(dt);qo=a(_n,"VisionEncoderDecoder"),_n.forEach(r),Ao=a(Sr," framework."),Sr.forEach(r),Et.forEach(r),Or=c(t),Y=n(t,"H2",{class:!0});var Wr=i(Y);ne=n(Wr,"A",{id:!0,class:!0,href:!0});var vn=i(ne);At=n(vn,"SPAN",{});var Tn=i(At);T(je.$$.fragment,Tn),Tn.forEach(r),vn.forEach(r),Io=c(Wr),It=n(Wr,"SPAN",{});var bn=i(It);Vo=a(bn,"Inference"),bn.forEach(r),Wr.forEach(r),Er=c(t),H=n(t,"P",{});var Rt=i(H);No=a(Rt,"TrOCR\u2019s "),Vt=n(Rt,"CODE",{});var Cn=i(Vt);So=a(Cn,"VisionEncoderDecoder"),Cn.forEach(r),Wo=a(Rt,` model accepts images as input and makes use of
`),ct=n(Rt,"A",{href:!0});var wn=i(ct);Bo=a(wn,"generate()"),wn.forEach(r),Ho=a(Rt," to autoregressively generate text given the input image."),Rt.forEach(r),Rr=c(t),f=n(t,"P",{});var y=i(f);Uo=a(y,"The ["),Nt=n(y,"CODE",{});var kn=i(Nt);Xo=a(kn,"ViTFeatureExtractor"),kn.forEach(r),Go=a(y,"/"),St=n(y,"CODE",{});var yn=i(St);Zo=a(yn,"DeiTFeatureExtractor"),yn.forEach(r),Jo=a(y,`] class is responsible for preprocessing the input image and
[`),Wt=n(y,"CODE",{});var On=i(Wt);Yo=a(On,"RobertaTokenizer"),On.forEach(r),Ko=a(y,"/"),Bt=n(y,"CODE",{});var En=i(Bt);Qo=a(En,"XLMRobertaTokenizer"),En.forEach(r),ea=a(y,`] decodes the generated target tokens to the target string. The
`),ht=n(y,"A",{href:!0});var Rn=i(ht);ta=a(Rn,"TrOCRProcessor"),Rn.forEach(r),ra=a(y," wraps ["),Ht=n(y,"CODE",{});var xn=i(Ht);oa=a(xn,"ViTFeatureExtractor"),xn.forEach(r),aa=a(y,"/"),Ut=n(y,"CODE",{});var $n=i(Ut);sa=a($n,"DeiTFeatureExtractor"),$n.forEach(r),na=a(y,"] and ["),Xt=n(y,"CODE",{});var Pn=i(Xt);ia=a(Pn,"RobertaTokenizer"),Pn.forEach(r),la=a(y,"/"),Gt=n(y,"CODE",{});var Mn=i(Gt);da=a(Mn,"XLMRobertaTokenizer"),Mn.forEach(r),ca=a(y,`]
...
`),lr=n(ve,"CODE",{});var ri=i(lr);ss=a(ri,"__call__"),ri.forEach(r),ns=a(ve,". Please refer to the doctsring of the above two methods for more information."),ve.forEach(r),Xr.forEach(r),is=c(R),U=n(R,"DIV",{class:!0});var Pt=i(U);T(We.$$.fragment,Pt),ls=c(Pt),dr=n(Pt,"P",{});var oi=i(dr);ds=a(oi,"Instantiate a processor associated with a pretrained model."),oi.forEach(r),cs=c(Pt),T(he.$$.fragment,Pt),Pt.forEach(r),hs=c(R),X=n(R,"DIV",{class:!0});var Mt=i(X);T(Be.$$.fragment,Mt),ps=c(Mt),He=n(Mt,"P",{});var Gr=i(He);ms=a(Gr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Tt=n(Gr,"A",{href:!0});var ai=i(Tt);fs=a(ai,"from_pretrained()"),ai.forEach(r),us=a(Gr," method."),Gr.forEach(r),gs=c(Mt),T(pe.$$.fragment,Mt),Mt.forEach(r),_s=c(R),me=n(R,"DIV",{class:!0});var Zr=i(me);T(Ue.$$.fragment,Zr),vs=c(Zr),Xe=n(Zr,"P",{});var Jr=i(Xe);Ts=a(Jr,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=n(Jr,"A",{href:!0});var si=i(bt);bs=a(si,"batch_decode()"),si.forEach(r),Cs=a(Jr,`. Please refer
to the docstring of this method for more information.`),Jr.forEach(r),Zr.forEach(r),ws=c(R),fe=n(R,"DIV",{class:!0});var Yr=i(fe);T(Ge.$$.fragment,Yr),ks=c(Yr),Ze=n(Yr,"P",{});var Kr=i(Ze);ys=a(Kr,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),Ct=n(Kr,"A",{href:!0});var ni=i(Ct);Os=a(ni,"decode()"),ni.forEach(r),Es=a(Kr,`. Please refer to the
docstring of this method for more information.`),Kr.forEach(r),Yr.forEach(r),Rs=c(R),ue=n(R,"DIV",{class:!0});var Qr=i(ue);T(Je.$$.fragment,Qr),xs=c(Qr),cr=n(Qr,"P",{});var ii=i(cr);$s=a(ii,"Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning TrOCR."),ii.forEach(r),Qr.forEach(r),R.forEach(r),Fr=c(t),re=n(t,"H2",{class:!0});var eo=i(re);ge=n(eo,"A",{id:!0,class:!0,href:!0});var li=i(ge);hr=n(li,"SPAN",{});var di=i(hr);T(Ye.$$.fragment,di),di.forEach(r),li.forEach(r),Ps=c(eo),pr=n(eo,"SPAN",{});var ci=i(pr);Ms=a(ci,"TrOCRForCausalLM"),ci.forEach(r),eo.forEach(r),Dr=c(t),D=n(t,"DIV",{class:!0});var Te=i(D);T(Ke.$$.fragment,Te),js=c(Te),N=n(Te,"P",{});var be=i(N);zs=a(be,"The TrOCR Decoder with a language modeling head. Can be used as the decoder part of "),wt=n(be,"A",{href:!0});var hi=i(wt);Ls=a(hi,"EncoderDecoderModel"),hi.forEach(r),Fs=a(be," and "),mr=n(be,"CODE",{});var pi=i(mr);Ds=a(pi,"VisionEncoderDecoder"),pi.forEach(r),qs=a(be,`.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),to.forEach(r),Bs=c(Te),G=n(Te,"DIV",{class:!0});var jt=i(G);T(tt.$$.fragment,jt),Hs=c(jt),fr=n(jt,"P",{});var ui=i(fr);Us=a(ui,"Example:"),ui.forEach(r),Xs=c(jt),T(rt.$$.fragment,jt),jt.forEach(r),Te.forEach(r),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(Ei)),l(x,"id","trocr"),l(x,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(x,"href","#trocr"),l(u,"class","relative group"),l(z,"id","overview"),l(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(z,"href","#overview"),l(P,"class","relative group"),l(we,"href","https://arxiv.org/abs/2109.10282"),l(we,"rel","nofollow"),l(ke,"href","https://en.wikipedia.org/wiki/Optical_character_recognition"),l(ke,"rel","nofollow"),Ci(oe.src,Js="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/trocr_architecture.jpg")||l(oe,"src",Js),l(oe,"alt","drawing"),l(oe,"width","600"),l(it,"href","https://arxiv.org/abs/2109.10282"),l(ye,"href","https://huggingface.co/nielsr"),l(ye,"rel","nofollow"),l(Oe,"href","https://github.com/microsoft/unilm/tree/6f60612e7cc86a2a1ae85c47231507a587ab4e01/trocr"),l(Oe,"rel","nofollow"),l(Re,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/TrOCR"),l(Re,"rel","nofollow"),l(xe,"href","https://paperswithcode.com/dataset/sroie"),l(xe,"rel","nofollow"),l($e,"href","https://fki.tic.heia-fr.ch/databases/iam-handwriting-database%3E"),l($e,"rel","nofollow"),l(Pe,"href","https://huggingface.co/models?other=trocr%3E"),l(Pe,"rel","nofollow"),l(dt,"href","vision-encoder-decoder"),l(ne,"id","inference"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#inference"),l(Y,"class","relative group"),l(ct,"href","/docs/transformers/pr_16398/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),l(ht,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor"),l(Le,"href","https://huggingface.co/models?filter=trocr"),l(Le,"rel","nofollow"),l(le,"id","transformers.TrOCRConfig"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.TrOCRConfig"),l(K,"class","relative group"),l(mt,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRForCausalLM"),l(qe,"href","https://huggingface.co/microsoft/trocr-base"),l(qe,"rel","nofollow"),l(ft,"href","/docs/transformers/pr_16398/en/main_classes/configuration#transformers.PretrainedConfig"),l(ut,"href","/docs/transformers/pr_16398/en/main_classes/configuration#transformers.PretrainedConfig"),l(M,"class","docstring"),l(de,"id","transformers.TrOCRProcessor"),l(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(de,"href","#transformers.TrOCRProcessor"),l(te,"class","relative group"),l(gt,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor"),l(Ne,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor.__call__"),l(_t,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor.decode"),l(vt,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor.as_target_processor"),l(ce,"class","docstring"),l(U,"class","docstring"),l(Tt,"href","/docs/transformers/pr_16398/en/main_classes/processors#transformers.ProcessorMixin.from_pretrained"),l(X,"class","docstring"),l(bt,"href","/docs/transformers/pr_16398/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode"),l(me,"class","docstring"),l(Ct,"href","/docs/transformers/pr_16398/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode"),l(fe,"class","docstring"),l(ue,"class","docstring"),l(g,"class","docstring"),l(ge,"id","transformers.TrOCRForCausalLM"),l(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ge,"href","#transformers.TrOCRForCausalLM"),l(re,"class","relative group"),l(wt,"href","/docs/transformers/pr_16398/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),l(kt,"href","/docs/transformers/pr_16398/en/main_classes/model#transformers.PreTrainedModel"),l(et,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(et,"rel","nofollow"),l(G,"class","docstring"),l(D,"class","docstring")},m(t,h){e(document.head,m),p(t,q,h),p(t,u,h),e(u,x),e(x,L),b(O,L,null),e(u,A),e(u,F),e(F,$),p(t,_,h),p(t,P,h),e(P,z),e(z,Lt),b(Ce,Lt,null),e(P,ro),e(P,Ft),e(Ft,oo),p(t,gr,h),p(t,S,h),e(S,ao),e(S,we),e(we,so),e(S,no),e(S,ke),e(ke,io),e(S,lo),p(t,_r,h),p(t,st,h),e(st,co),p(t,vr,h),p(t,nt,h),e(nt,Dt),e(Dt,ho),p(t,Tr,h),p(t,oe,h),p(t,br,h),p(t,ae,h),e(ae,po),e(ae,it),e(it,mo),e(ae,fo),p(t,Cr,h),p(t,se,h),e(se,uo),e(se,qt),e(qt,go),e(se,_o),p(t,wr,h),p(t,W,h),e(W,vo),e(W,ye),e(ye,To),e(W,bo),e(W,Oe),e(Oe,Co),e(W,wo),p(t,kr,h),p(t,lt,h),e(lt,ko),p(t,yr,h),p(t,B,h),e(B,Ee),e(Ee,yo),e(Ee,Re),e(Re,Oo),e(Ee,Eo),e(B,Ro),e(B,I),e(I,xo),e(I,xe),e(xe,$o),e(I,Po),e(I,$e),e($e,Mo),e(I,jo),e(I,Pe),e(Pe,zo),e(I,Lo),e(B,Fo),e(B,Me),e(Me,Do),e(Me,dt),e(dt,qo),e(Me,Ao),p(t,Or,h),p(t,Y,h),e(Y,ne),e(ne,At),b(je,At,null),e(Y,Io),e(Y,It),e(It,Vo),p(t,Er,h),p(t,H,h),e(H,No),e(H,Vt),e(Vt,So),e(H,Wo),e(H,ct),e(ct,Bo),e(H,Ho),p(t,Rr,h),p(t,f,h),e(f,Uo),e(f,Nt),e(Nt,Xo),e(f,Go),e(f,St),e(St,Zo),e(f,Jo),e(f,Wt),e(Wt,Yo),e(f,Ko),e(f,Bt),e(Bt,Qo),e(f,ea),e(f,ht),e(ht,ta),e(f,ra),e(f,Ht),e(Ht,oa),e(f,aa),e(f,Ut),e(Ut,sa),e(f,na),e(f,Xt),e(Xt,ia),e(f,la),e(f,Gt),e(Gt,da),e(f,ca),p(t,xr,h),p(t,pt,h),e(pt,Zt),e(Zt,ha),p(t,$r,h),b(ze,t,h),p(t,Pr,h),p(t,ie,h),e(ie,pa),e(ie,Le),e(Le,ma),e(ie,fa),p(t,Mr,h),p(t,K,h),e(K,le),e(le,Jt),b(Fe,Jt,null),e(K,ua),e(K,Yt),e(Yt,ga),p(t,jr,h),p(t,M,h),b(De,M,null),e(M,_a),e(M,Q),e(Q,va),e(Q,mt),e(mt,Ta),e(Q,ba),e(Q,qe),e(qe,Ca),e(Q,wa),e(M,ka),e(M,ee),e(ee,ya),e(ee,ft),e(ft,Oa),e(ee,Ea),e(ee,ut),e(ut,Ra),e(ee,xa),e(M,$a),e(M,Kt),e(Kt,Pa),e(M,Ma),b(Ae,M,null),p(t,zr,h),p(t,te,h),e(te,de),e(de,Qt),b(Ie,Qt,null),e(te,ja),e(te,er),e(er,za),p(t,Lr,h),p(t,g,h),b(Ve,g,null),e(g,La),e(g,tr),e(tr,Fa),e(g,Da),e(g,E),e(E,gt),e(gt,qa),e(E,Aa),e(E,rr),e(rr,Ia),e(E,Va),e(E,or),e(or,Na),e(E,Sa),e(E,ar),e(ar,Wa),e(E,Ba),e(E,sr),e(sr,Ha),e(E,Ua),e(E,Ne),e(Ne,nr),e(nr,Xa),e(Ne,Ga),e(E,Za),e(E,_t),e(_t,Ja),e(E,Ya),e(g,Ka),e(g,ce),b(Se,ce,null),e(ce,Qa),e(ce,V),e(V,es),e(V,ir),e(ir,ts),e(V,rs),e(V,vt),e(vt,os),e(V,as),e(V,lr),e(lr,ss),e(V,ns),e(g,is),e(g,U),b(We,U,null),e(U,ls),e(U,dr),e(dr,ds),e(U,cs),b(he,U,null),e(g,hs),e(g,X),b(Be,X,null),e(X,ps),e(X,He),e(He,ms),e(He,Tt),e(Tt,fs),e(He,us),e(X,gs),b(pe,X,null),e(g,_s),e(g,me),b(Ue,me,null),e(me,vs),e(me,Xe),e(Xe,Ts),e(Xe,bt),e(bt,bs),e(Xe,Cs),e(g,ws),e(g,fe),b(Ge,fe,null),e(fe,ks),e(fe,Ze),e(Ze,ys),e(Ze,Ct),e(Ct,Os),e(Ze,Es),e(g,Rs),e(g,ue),b(Je,ue,null),e(ue,xs),e(ue,cr),e(cr,$s),p(t,Fr,h),p(t,re,h),e(re,ge),e(ge,hr),b(Ye,hr,null),e(re,Ps),e(re,pr),e(pr,Ms),p(t,Dr,h),p(t,D,h),b(Ke,D,null),e(D,js),e(D,N),e(N,zs),e(N,wt),e(wt,Ls),e(N,Fs),e(N,mr),e(mr,Ds),e(N,qs),e(N,kt),e(kt,As),e(N,Is),e(D,Vs),e(D,Qe),e(Qe,Ns),e(Qe,et),e(et,Ss),e(Qe,Ws),e(D,Bs),e(D,G),b(tt,G,null),e(G,Hs),e(G,fr),e(fr,Us),e(G,Xs),b(rt,G,null),qr=!0},p(t,[h]){const ot={};h&2&&(ot.$$scope={dirty:h,ctx:t}),he.$set(ot);const ur={};h&2&&(ur.$$scope={dirty:h,ctx:t}),pe.$set(ur)},i(t){qr||(C(O.$$.fragment,t),C(Ce.$$.fragment,t),C(je.$$.fragment,t),C(ze.$$.fragment,t),C(Fe.$$.fragment,t),C(De.$$.fragment,t),C(Ae.$$.fragment,t),C(Ie.$$.fragment,t),C(Ve.$$.fragment,t),C(Se.$$.fragment,t),C(We.$$.fragment,t),C(he.$$.fragment,t),C(Be.$$.fragment,t),C(pe.$$.fragment,t),C(Ue.$$.fragment,t),C(Ge.$$.fragment,t),C(Je.$$.fragment,t),C(Ye.$$.fragment,t),C(Ke.$$.fragment,t),C(tt.$$.fragment,t),C(rt.$$.fragment,t),qr=!0)},o(t){w(O.$$.fragment,t),w(Ce.$$.fragment,t),w(je.$$.fragment,t),w(ze.$$.fragment,t),w(Fe.$$.fragment,t),w(De.$$.fragment,t),w(Ae.$$.fragment,t),w(Ie.$$.fragment,t),w(Ve.$$.fragment,t),w(Se.$$.fragment,t),w(We.$$.fragment,t),w(he.$$.fragment,t),w(Be.$$.fragment,t),w(pe.$$.fragment,t),w(Ue.$$.fragment,t),w(Ge.$$.fragment,t),w(Je.$$.fragment,t),w(Ye.$$.fragment,t),w(Ke.$$.fragment,t),w(tt.$$.fragment,t),w(rt.$$.fragment,t),qr=!1},d(t){r(m),t&&r(q),t&&r(u),k(O),t&&r(_),t&&r(P),k(Ce),t&&r(gr),t&&r(S),t&&r(_r),t&&r(st),t&&r(vr),t&&r(nt),t&&r(Tr),t&&r(oe),t&&r(br),t&&r(ae),t&&r(Cr),t&&r(se),t&&r(wr),t&&r(W),t&&r(kr),t&&r(lt),t&&r(yr),t&&r(B),t&&r(Or),t&&r(Y),k(je),t&&r(Er),t&&r(H),t&&r(Rr),t&&r(f),t&&r(xr),t&&r(pt),t&&r($r),k(ze,t),t&&r(Pr),t&&r(ie),t&&r(Mr),t&&r(K),k(Fe),t&&r(jr),t&&r(M),k(De),k(Ae),t&&r(zr),t&&r(te),k(Ie),t&&r(Lr),t&&r(g),k(Ve),k(Se),k(We),k(he),k(Be),k(pe),k(Ue),k(Ge),k(Je),t&&r(Fr),t&&r(re),k(Ye),t&&r(Dr),t&&r(D),k(Ke),k(tt),k(rt)}}}const Ei={local:"trocr",sections:[{local:"overview",title:"Overview"},{local:"inference",title:"Inference"},{local:"transformers.TrOCRConfig",title:"TrOCRConfig"},{local:"transformers.TrOCRProcessor",title:"TrOCRProcessor"},{local:"transformers.TrOCRForCausalLM",title:"TrOCRForCausalLM"}],title:"TrOCR"};function Ri(at){return wi(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class zi extends _i{constructor(m){super();vi(this,m,Ri,Oi,Ti,{})}}export{zi as default,Ei as metadata};
