import{S as _i,i as vi,s as Ti,e as s,k as l,w as v,t as o,M as bi,c as n,d as r,m as c,a as i,x as T,h as a,b as d,N as Ci,F as e,g as f,y as b,q as C,o as w,B as k,v as wi}from"../../chunks/vendor-6b77c823.js";import{T as gi}from"../../chunks/Tip-39098574.js";import{D as J}from"../../chunks/Docstring-abef54e3.js";import{C as Zs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as zt}from"../../chunks/IconCopyLink-7a11ce68.js";function ki(at){let p,q,u,$,L,E,A,F;return{c(){p=s("p"),q=o(`This class method is simply calling the feature extractor
...
methods above for more information.`),this.h()},l(x){p=n(x,"P",{});var _=i(p);q=a(_,`This class method is simply calling the feature extractor
...
methods above for more information.`),_.forEach(r),this.h()},h(){d(u,"href","/docs/transformers/pr_16398/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(x,_){f(x,p,_),e(p,q),e(p,u),e(u,$),e(p,L),e(p,E),e(E,A),e(p,F)},d(x){x&&r(p)}}}function Oi(at){let p,q,u,$,L,E,A,F;return{c(){p=s("p"),q=o("This class method is simply calling "),u=s("a"),$=o("save_pretrained()"),L=o(` and
`),E=s("code"),A=o("save_pretrained"),F=o(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(x){p=n(x,"P",{});var _=i(p);q=a(_,"This class method is simply calling "),u=n(_,"A",{href:!0});var P=i(u);$=a(P,"save_pretrained()"),P.forEach(r),L=a(_,` and
`),E=n(_,"CODE",{});var z=i(E);A=a(z,"save_pretrained"),z.forEach(r),F=a(_,`. Please refer to the docstrings of the methods
above for more information.`),_.forEach(r),this.h()},h(){d(u,"href","/docs/transformers/pr_16398/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(x,_){f(x,p,_),e(p,q),e(p,u),e(u,$),e(p,L),e(p,E),e(E,A),e(p,F)},d(x){x&&r(p)}}}function Ei(at){let p,q,u,$,L,E,A,F,x,_,P,z,Lt,Ce,ro,Ft,oo,gr,S,ao,we,so,no,ke,io,lo,_r,st,co,vr,nt,Dt,ho,Tr,oe,Js,br,ae,fo,it,po,mo,Cr,se,uo,qt,go,_o,wr,W,vo,Oe,To,bo,Ee,Co,wo,kr,dt,ko,Or,B,ye,Oo,Re,Eo,yo,Ro,I,$o,$e,xo,Po,xe,Mo,jo,Pe,zo,Lo,Fo,Me,Do,lt,qo,Ao,Er,Y,ne,At,je,Io,It,Vo,yr,H,No,Vt,So,Wo,ct,Bo,Ho,Rr,m,Uo,Nt,Xo,Go,St,Zo,Jo,Wt,Yo,Ko,Bt,Qo,ea,ht,ta,ra,Ht,oa,aa,Ut,sa,na,Xt,ia,da,Gt,la,ca,$r,ft,Zt,ha,xr,ze,Pr,ie,fa,Le,pa,ma,Mr,K,de,Jt,Fe,ua,Yt,ga,jr,M,De,_a,Q,va,pt,Ta,ba,qe,Ca,wa,ka,ee,Oa,mt,Ea,ya,ut,Ra,$a,xa,Kt,Pa,Ma,Ae,zr,te,le,Qt,Ie,ja,er,za,Lr,g,Ve,La,tr,Fa,Da,y,gt,qa,Aa,rr,Ia,Va,or,Na,Sa,ar,Wa,Ba,sr,Ha,Ua,Ne,nr,Xa,Ga,Za,_t,Ja,Ya,Ka,ce,Se,Qa,V,es,ir,ts,rs,vt,os,as,dr,ss,ns,is,U,We,ds,lr,ls,cs,he,hs,X,Be,fs,He,ps,Tt,ms,us,gs,fe,_s,pe,Ue,vs,Xe,Ts,bt,bs,Cs,ws,me,Ge,ks,Ze,Os,Ct,Es,ys,Rs,ue,Je,$s,cr,xs,Fr,re,ge,hr,Ye,Ps,fr,Ms,Dr,D,Ke,js,N,zs,wt,Ls,Fs,pr,Ds,qs,kt,As,Is,Vs,Qe,Ns,et,Ss,Ws,Bs,G,tt,Hs,mr,Us,Xs,rt,qr;return E=new zt({}),Ce=new zt({}),je=new zt({}),ze=new Zs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
...
`}}),rt=new Zs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
...
generated_text`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> TrOCRProcessor, VisionEncoderDecoderModel
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> VisionEncoderDecoderModel, TrOCRForCausalLM, ViTModel, TrOCRConfig, ViTConfig
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">import</span> requests
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> PIL <span class="hljs-keyword">import</span> Image
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("meta"),q=l(),u=s("h1"),$=s("a"),L=s("span"),v(E.$$.fragment),A=l(),F=s("span"),x=o("TrOCR"),_=l(),P=s("h2"),z=s("a"),Lt=s("span"),v(Ce.$$.fragment),ro=l(),Ft=s("span"),oo=o("Overview"),gr=l(),S=s("p"),ao=o("The TrOCR model was proposed in "),we=s("a"),so=o(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
tasks.`),Tr=l(),oe=s("img"),br=l(),ae=s("small"),fo=o("TrOCR architecture. Taken from the "),it=s("a"),po=o("original paper"),mo=o("."),Cr=l(),se=s("p"),uo=o("Please refer to the "),qt=s("code"),go=o("VisionEncoderDecoder"),_o=o(" class on how to use this model."),wr=l(),W=s("p"),vo=o("This model was contributed by "),Oe=s("a"),To=o("nielsr"),bo=o(`. The original code can be found
`),Ee=s("a"),Co=o("here"),wo=o("."),kr=l(),dt=s("p"),ko=o("Tips:"),Or=l(),B=s("ul"),ye=s("li"),Oo=o("The quickest way to get started with TrOCR is by checking the "),Re=s("a"),Eo=o(`tutorial
notebooks`),yo=o(`, which show how to use the model
at inference time as well as fine-tuning on custom data.`),Ro=l(),I=s("li"),$o=o(`TrOCR is pre-trained in 2 stages before being fine-tuned on downstream datasets. It achieves state-of-the-art results
...
information, see the `),Pe=s("a"),zo=o("official models"),Lo=o("."),Fo=l(),Me=s("li"),Do=o("TrOCR is always used within the "),lt=s("a"),qo=o("VisionEncoderDecoder"),Ao=o(" framework."),Er=l(),Y=s("h2"),ne=s("a"),At=s("span"),v(je.$$.fragment),Io=l(),It=s("span"),Vo=o("Inference"),yr=l(),H=s("p"),No=o("TrOCR\u2019s "),Vt=s("code"),So=o("VisionEncoderDecoder"),Wo=o(` model accepts images as input and makes use of
`),ct=s("a"),Bo=o("generate()"),Ho=o(" to autoregressively generate text given the input image."),Rr=l(),m=s("p"),Uo=o("The ["),Nt=s("code"),Xo=o("ViTFeatureExtractor"),Go=o("/"),St=s("code"),Zo=o("DeiTFeatureExtractor"),Jo=o(`] class is responsible for preprocessing the input image and
...
into a single instance to both extract the input features and decode the predicted token ids.`),$r=l(),ft=s("ul"),Zt=s("li"),ha=o("Step-by-step Optical Character Recognition (OCR)"),xr=l(),v(ze.$$.fragment),Pr=l(),ie=s("p"),fa=o("See the "),Le=s("a"),pa=o("model hub"),ma=o(" to look for TrOCR checkpoints."),Mr=l(),K=s("h2"),de=s("a"),Jt=s("span"),v(Fe.$$.fragment),ua=l(),Yt=s("span"),ga=o("TrOCRConfig"),jr=l(),M=s("div"),v(De.$$.fragment),_a=l(),Q=s("p"),va=o("This is the configuration class to store the configuration of a "),pt=s("a"),Ta=o("TrOCRForCausalLM"),ba=o(`. It is used to instantiate an
...
`),qe=s("a"),Ca=o("microsoft/trocr-base"),wa=o(" architecture."),ka=l(),ee=s("p"),Oa=o("Configuration objects inherit from "),mt=s("a"),Ea=o("PretrainedConfig"),ya=o(` and can be used to control the model outputs. Read the
documentation from `),ut=s("a"),Ra=o("PretrainedConfig"),$a=o(" for more information."),xa=l(),Kt=s("p"),Pa=o("Example:"),Ma=l(),v(Ae.$$.fragment),zr=l(),te=s("h2"),le=s("a"),Qt=s("span"),v(Ie.$$.fragment),ja=l(),er=s("span"),za=o("TrOCRProcessor"),Lr=l(),g=s("div"),v(Ve.$$.fragment),La=l(),tr=s("p"),Fa=o("Constructs a TrOCR processor which wraps a vision feature extractor and a TrOCR tokenizer into a single processor."),Da=l(),y=s("p"),gt=s("a"),qa=o("TrOCRProcessor"),Aa=o(" offers all the functionalities of ["),rr=s("code"),Ia=o("ViTFeatureExtractor"),Va=o("/"),or=s("code"),Na=o("DeiTFeatureExtractor"),Sa=o(`] and
...
`),dr=s("code"),ss=o("__call__"),ns=o(". Please refer to the doctsring of the above two methods for more information."),is=l(),U=s("div"),v(We.$$.fragment),ds=l(),lr=s("p"),ls=o("Instantiate a processor associated with a pretrained model."),cs=l(),v(he.$$.fragment),hs=l(),X=s("div"),v(Be.$$.fragment),fs=l(),He=s("p"),ps=o(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Tt=s("a"),ms=o("from_pretrained()"),us=o(" method."),gs=l(),v(fe.$$.fragment),_s=l(),pe=s("div"),v(Ue.$$.fragment),vs=l(),Xe=s("p"),Ts=o("This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=s("a"),bs=o("batch_decode()"),Cs=o(`. Please refer
to the docstring of this method for more information.`),ws=l(),me=s("div"),v(Ge.$$.fragment),ks=l(),Ze=s("p"),Os=o("This method forwards all its arguments to TrOCRTokenizer\u2019s "),Ct=s("a"),Es=o("decode()"),ys=o(`. Please refer to the
docstring of this method for more information.`),Rs=l(),ue=s("div"),v(Je.$$.fragment),$s=l(),cr=s("p"),xs=o("Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning TrOCR."),Fr=l(),re=s("h2"),ge=s("a"),hr=s("span"),v(Ye.$$.fragment),Ps=l(),fr=s("span"),Ms=o("TrOCRForCausalLM"),Dr=l(),D=s("div"),v(Ke.$$.fragment),js=l(),N=s("p"),zs=o("The TrOCR Decoder with a language modeling head. Can be used as the decoder part of "),wt=s("a"),Ls=o("EncoderDecoderModel"),Fs=o(" and "),pr=s("code"),Ds=o("VisionEncoderDecoder"),qs=o(`.
...
`),dr=n(ve,"CODE",{});var ri=i(dr);ss=a(ri,"__call__"),ri.forEach(r),ns=a(ve,". Please refer to the doctsring of the above two methods for more information."),ve.forEach(r),Xr.forEach(r),is=c(R),U=n(R,"DIV",{class:!0});var Pt=i(U);T(We.$$.fragment,Pt),ds=c(Pt),lr=n(Pt,"P",{});var oi=i(lr);ls=a(oi,"Instantiate a processor associated with a pretrained model."),oi.forEach(r),cs=c(Pt),T(he.$$.fragment,Pt),Pt.forEach(r),hs=c(R),X=n(R,"DIV",{class:!0});var Mt=i(X);T(Be.$$.fragment,Mt),fs=c(Mt),He=n(Mt,"P",{});var Gr=i(He);ps=a(Gr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Tt=n(Gr,"A",{href:!0});var ai=i(Tt);ms=a(ai,"from_pretrained()"),ai.forEach(r),us=a(Gr," method."),Gr.forEach(r),gs=c(Mt),T(fe.$$.fragment,Mt),Mt.forEach(r),_s=c(R),pe=n(R,"DIV",{class:!0});var Zr=i(pe);T(Ue.$$.fragment,Zr),vs=c(Zr),Xe=n(Zr,"P",{});var Jr=i(Xe);Ts=a(Jr,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=n(Jr,"A",{href:!0});var si=i(bt);bs=a(si,"batch_decode()"),si.forEach(r),Cs=a(Jr,`. Please refer
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),to.forEach(r),Bs=c(Te),G=n(Te,"DIV",{class:!0});var jt=i(G);T(tt.$$.fragment,jt),Hs=c(jt),mr=n(jt,"P",{});var ui=i(mr);Us=a(ui,"Example:"),ui.forEach(r),Xs=c(jt),T(rt.$$.fragment,jt),jt.forEach(r),Te.forEach(r),this.h()},h(){d(p,"name","hf:doc:metadata"),d(p,"content",JSON.stringify(yi)),d($,"id","trocr"),d($,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d($,"href","#trocr"),d(u,"class","relative group"),d(z,"id","overview"),d(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(z,"href","#overview"),d(P,"class","relative group"),d(we,"href","https://arxiv.org/abs/2109.10282"),d(we,"rel","nofollow"),d(ke,"href","https://en.wikipedia.org/wiki/Optical_character_recognition"),d(ke,"rel","nofollow"),Ci(oe.src,Js="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/trocr_architecture.jpg")||d(oe,"src",Js),d(oe,"alt","drawing"),d(oe,"width","600"),d(it,"href","https://arxiv.org/abs/2109.10282"),d(Oe,"href","https://huggingface.co/nielsr"),d(Oe,"rel","nofollow"),d(Ee,"href","https://github.com/microsoft/unilm/tree/6f60612e7cc86a2a1ae85c47231507a587ab4e01/trocr"),d(Ee,"rel","nofollow"),d(Re,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/TrOCR"),d(Re,"rel","nofollow"),d($e,"href","https://paperswithcode.com/dataset/sroie"),d($e,"rel","nofollow"),d(xe,"href","https://fki.tic.heia-fr.ch/databases/iam-handwriting-database%3E"),d(xe,"rel","nofollow"),d(Pe,"href","https://huggingface.co/models?other=trocr%3E"),d(Pe,"rel","nofollow"),d(lt,"href","vision-encoder-decoder"),d(ne,"id","inference"),d(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ne,"href","#inference"),d(Y,"class","relative group"),d(ct,"href","/docs/transformers/pr_16398/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),d(ht,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor"),d(Le,"href","https://huggingface.co/models?filter=trocr"),d(Le,"rel","nofollow"),d(de,"id","transformers.TrOCRConfig"),d(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(de,"href","#transformers.TrOCRConfig"),d(K,"class","relative group"),d(pt,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRForCausalLM"),d(qe,"href","https://huggingface.co/microsoft/trocr-base"),d(qe,"rel","nofollow"),d(mt,"href","/docs/transformers/pr_16398/en/main_classes/configuration#transformers.PretrainedConfig"),d(ut,"href","/docs/transformers/pr_16398/en/main_classes/configuration#transformers.PretrainedConfig"),d(M,"class","docstring"),d(le,"id","transformers.TrOCRProcessor"),d(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(le,"href","#transformers.TrOCRProcessor"),d(te,"class","relative group"),d(gt,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor"),d(Ne,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor.__call__"),d(_t,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor.decode"),d(vt,"href","/docs/transformers/pr_16398/en/model_doc/trocr#transformers.TrOCRProcessor.as_target_processor"),d(ce,"class","docstring"),d(U,"class","docstring"),d(Tt,"href","/docs/transformers/pr_16398/en/main_classes/processors#transformers.ProcessorMixin.from_pretrained"),d(X,"class","docstring"),d(bt,"href","/docs/transformers/pr_16398/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode"),d(pe,"class","docstring"),d(Ct,"href","/docs/transformers/pr_16398/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode"),d(me,"class","docstring"),d(ue,"class","docstring"),d(g,"class","docstring"),d(ge,"id","transformers.TrOCRForCausalLM"),d(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ge,"href","#transformers.TrOCRForCausalLM"),d(re,"class","relative group"),d(wt,"href","/docs/transformers/pr_16398/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(kt,"href","/docs/transformers/pr_16398/en/main_classes/model#transformers.PreTrainedModel"),d(et,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(et,"rel","nofollow"),d(G,"class","docstring"),d(D,"class","docstring")},m(t,h){e(document.head,p),f(t,q,h),f(t,u,h),e(u,$),e($,L),b(E,L,null),e(u,A),e(u,F),e(F,x),f(t,_,h),f(t,P,h),e(P,z),e(z,Lt),b(Ce,Lt,null),e(P,ro),e(P,Ft),e(Ft,oo),f(t,gr,h),f(t,S,h),e(S,ao),e(S,we),e(we,so),e(S,no),e(S,ke),e(ke,io),e(S,lo),f(t,_r,h),f(t,st,h),e(st,co),f(t,vr,h),f(t,nt,h),e(nt,Dt),e(Dt,ho),f(t,Tr,h),f(t,oe,h),f(t,br,h),f(t,ae,h),e(ae,fo),e(ae,it),e(it,po),e(ae,mo),f(t,Cr,h),f(t,se,h),e(se,uo),e(se,qt),e(qt,go),e(se,_o),f(t,wr,h),f(t,W,h),e(W,vo),e(W,Oe),e(Oe,To),e(W,bo),e(W,Ee),e(Ee,Co),e(W,wo),f(t,kr,h),f(t,dt,h),e(dt,ko),f(t,Or,h),f(t,B,h),e(B,ye),e(ye,Oo),e(ye,Re),e(Re,Eo),e(ye,yo),e(B,Ro),e(B,I),e(I,$o),e(I,$e),e($e,xo),e(I,Po),e(I,xe),e(xe,Mo),e(I,jo),e(I,Pe),e(Pe,zo),e(I,Lo),e(B,Fo),e(B,Me),e(Me,Do),e(Me,lt),e(lt,qo),e(Me,Ao),f(t,Er,h),f(t,Y,h),e(Y,ne),e(ne,At),b(je,At,null),e(Y,Io),e(Y,It),e(It,Vo),f(t,yr,h),f(t,H,h),e(H,No),e(H,Vt),e(Vt,So),e(H,Wo),e(H,ct),e(ct,Bo),e(H,Ho),f(t,Rr,h),f(t,m,h),e(m,Uo),e(m,Nt),e(Nt,Xo),e(m,Go),e(m,St),e(St,Zo),e(m,Jo),e(m,Wt),e(Wt,Yo),e(m,Ko),e(m,Bt),e(Bt,Qo),e(m,ea),e(m,ht),e(ht,ta),e(m,ra),e(m,Ht),e(Ht,oa),e(m,aa),e(m,Ut),e(Ut,sa),e(m,na),e(m,Xt),e(Xt,ia),e(m,da),e(m,Gt),e(Gt,la),e(m,ca),f(t,$r,h),f(t,ft,h),e(ft,Zt),e(Zt,ha),f(t,xr,h),b(ze,t,h),f(t,Pr,h),f(t,ie,h),e(ie,fa),e(ie,Le),e(Le,pa),e(ie,ma),f(t,Mr,h),f(t,K,h),e(K,de),e(de,Jt),b(Fe,Jt,null),e(K,ua),e(K,Yt),e(Yt,ga),f(t,jr,h),f(t,M,h),b(De,M,null),e(M,_a),e(M,Q),e(Q,va),e(Q,pt),e(pt,Ta),e(Q,ba),e(Q,qe),e(qe,Ca),e(Q,wa),e(M,ka),e(M,ee),e(ee,Oa),e(ee,mt),e(mt,Ea),e(ee,ya),e(ee,ut),e(ut,Ra),e(ee,$a),e(M,xa),e(M,Kt),e(Kt,Pa),e(M,Ma),b(Ae,M,null),f(t,zr,h),f(t,te,h),e(te,le),e(le,Qt),b(Ie,Qt,null),e(te,ja),e(te,er),e(er,za),f(t,Lr,h),f(t,g,h),b(Ve,g,null),e(g,La),e(g,tr),e(tr,Fa),e(g,Da),e(g,y),e(y,gt),e(gt,qa),e(y,Aa),e(y,rr),e(rr,Ia),e(y,Va),e(y,or),e(or,Na),e(y,Sa),e(y,ar),e(ar,Wa),e(y,Ba),e(y,sr),e(sr,Ha),e(y,Ua),e(y,Ne),e(Ne,nr),e(nr,Xa),e(Ne,Ga),e(y,Za),e(y,_t),e(_t,Ja),e(y,Ya),e(g,Ka),e(g,ce),b(Se,ce,null),e(ce,Qa),e(ce,V),e(V,es),e(V,ir),e(ir,ts),e(V,rs),e(V,vt),e(vt,os),e(V,as),e(V,dr),e(dr,ss),e(V,ns),e(g,is),e(g,U),b(We,U,null),e(U,ds),e(U,lr),e(lr,ls),e(U,cs),b(he,U,null),e(g,hs),e(g,X),b(Be,X,null),e(X,fs),e(X,He),e(He,ps),e(He,Tt),e(Tt,ms),e(He,us),e(X,gs),b(fe,X,null),e(g,_s),e(g,pe),b(Ue,pe,null),e(pe,vs),e(pe,Xe),e(Xe,Ts),e(Xe,bt),e(bt,bs),e(Xe,Cs),e(g,ws),e(g,me),b(Ge,me,null),e(me,ks),e(me,Ze),e(Ze,Os),e(Ze,Ct),e(Ct,Es),e(Ze,ys),e(g,Rs),e(g,ue),b(Je,ue,null),e(ue,$s),e(ue,cr),e(cr,xs),f(t,Fr,h),f(t,re,h),e(re,ge),e(ge,hr),b(Ye,hr,null),e(re,Ps),e(re,fr),e(fr,Ms),f(t,Dr,h),f(t,D,h),b(Ke,D,null),e(D,js),e(D,N),e(N,zs),e(N,wt),e(wt,Ls),e(N,Fs),e(N,pr),e(pr,Ds),e(N,qs),e(N,kt),e(kt,As),e(N,Is),e(D,Vs),e(D,Qe),e(Qe,Ns),e(Qe,et),e(et,Ss),e(Qe,Ws),e(D,Bs),e(D,G),b(tt,G,null),e(G,Hs),e(G,mr),e(mr,Us),e(G,Xs),b(rt,G,null),qr=!0},p(t,[h]){const ot={};h&2&&(ot.$$scope={dirty:h,ctx:t}),he.$set(ot);const ur={};h&2&&(ur.$$scope={dirty:h,ctx:t}),fe.$set(ur)},i(t){qr||(C(E.$$.fragment,t),C(Ce.$$.fragment,t),C(je.$$.fragment,t),C(ze.$$.fragment,t),C(Fe.$$.fragment,t),C(De.$$.fragment,t),C(Ae.$$.fragment,t),C(Ie.$$.fragment,t),C(Ve.$$.fragment,t),C(Se.$$.fragment,t),C(We.$$.fragment,t),C(he.$$.fragment,t),C(Be.$$.fragment,t),C(fe.$$.fragment,t),C(Ue.$$.fragment,t),C(Ge.$$.fragment,t),C(Je.$$.fragment,t),C(Ye.$$.fragment,t),C(Ke.$$.fragment,t),C(tt.$$.fragment,t),C(rt.$$.fragment,t),qr=!0)},o(t){w(E.$$.fragment,t),w(Ce.$$.fragment,t),w(je.$$.fragment,t),w(ze.$$.fragment,t),w(Fe.$$.fragment,t),w(De.$$.fragment,t),w(Ae.$$.fragment,t),w(Ie.$$.fragment,t),w(Ve.$$.fragment,t),w(Se.$$.fragment,t),w(We.$$.fragment,t),w(he.$$.fragment,t),w(Be.$$.fragment,t),w(fe.$$.fragment,t),w(Ue.$$.fragment,t),w(Ge.$$.fragment,t),w(Je.$$.fragment,t),w(Ye.$$.fragment,t),w(Ke.$$.fragment,t),w(tt.$$.fragment,t),w(rt.$$.fragment,t),qr=!1},d(t){r(p),t&&r(q),t&&r(u),k(E),t&&r(_),t&&r(P),k(Ce),t&&r(gr),t&&r(S),t&&r(_r),t&&r(st),t&&r(vr),t&&r(nt),t&&r(Tr),t&&r(oe),t&&r(br),t&&r(ae),t&&r(Cr),t&&r(se),t&&r(wr),t&&r(W),t&&r(kr),t&&r(dt),t&&r(Or),t&&r(B),t&&r(Er),t&&r(Y),k(je),t&&r(yr),t&&r(H),t&&r(Rr),t&&r(m),t&&r($r),t&&r(ft),t&&r(xr),k(ze,t),t&&r(Pr),t&&r(ie),t&&r(Mr),t&&r(K),k(Fe),t&&r(jr),t&&r(M),k(De),k(Ae),t&&r(zr),t&&r(te),k(Ie),t&&r(Lr),t&&r(g),k(Ve),k(Se),k(We),k(he),k(Be),k(fe),k(Ue),k(Ge),k(Je),t&&r(Fr),t&&r(re),k(Ye),t&&r(Dr),t&&r(D),k(Ke),k(tt),k(rt)}}}const yi={local:"trocr",sections:[{local:"overview",title:"Overview"},{local:"inference",title:"Inference"},{local:"transformers.TrOCRConfig",title:"TrOCRConfig"},{local:"transformers.TrOCRProcessor",title:"TrOCRProcessor"},{local:"transformers.TrOCRForCausalLM",title:"TrOCRForCausalLM"}],title:"TrOCR"};function Ri(at){return wi(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class zi extends _i{constructor(p){super();vi(this,p,Ri,Ei,Ti,{})}}export{zi as default,yi as metadata};
