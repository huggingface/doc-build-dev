import{S as As,i as Os,s as qs,e as r,k as d,w as g,t as o,M as Ss,c as a,d as t,m as c,a as s,x as _,h as n,b as m,F as e,g as z,y as b,q as y,o as v,B as w}from"../../chunks/vendor-4833417e.js";import{T as Ta}from"../../chunks/Tip-fffd6df1.js";import{D as E}from"../../chunks/Docstring-7b52c3d4.js";import{C as js}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as zs}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Fs(B){let h,P,u,p,j;return{c(){h=r("p"),P=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
...
that can be used as decoder models within the <a href="/docs/transformers/pr_15873/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
`,returnType:`
<p><code>str</code></p>
`}}),Ce=new js({props:{codee:`from transformers import AutoConfig
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_15873/en/main_classes/configuration#transformers.PretrainedConfig"
>PretrainedConfig</a></p>
`}}),De=new E({props:{name:"from_json_file",anchor:"transformers.PretrainedConfig.from_json_file",parameters:[{name:"json_file",val:": typing.Union[str, os.PathLike]"}],source:"https://github.com/huggingface/transformers/blob/pr_15873/src/transformers/configuration_utils.py#L690",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_json_file.json_file",description:`<strong>json_file</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_15873/en/main_classes/configuration#transformers.PretrainedConfig.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
...
<p><a
  href="/docs/transformers/pr_15873/en/main_classes/configuration#transformers.PretrainedConfig"
>PretrainedConfig</a></p>
`}}),se=new Ta({props:{$$slots:{default:[Is]},$$scope:{ctx:B}}}),Oe=new js({props:{codee:`# We can't instantiate directly the base class *PretrainedConfig* so let's show the examples on a
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_15873/en/main_classes/model#transformers.file_utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}]}}),Le=new E({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15873/src/transformers/configuration_utils.py#L750",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Ne=new E({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15873/src/transformers/configuration_utils.py#L718",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Me=new E({props:{name:"to_json_file",anchor:"transformers.PretrainedConfig.to_json_file",parameters:[{name:"json_file_path",val:": typing.Union[str, os.PathLike]"},{name:"use_diff",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/pr_15873/src/transformers/configuration_utils.py#L788",parametersDescription:[{anchor:"transformers.PretrainedConfig.to_json_file.json_file_path",description:`<strong>json_file_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`),lt=r("code"),Wo=o("vocab_size"),Ho=o("."),io=d(),R=r("h2"),X=r("a"),ft=r("span"),g(we.$$.fragment),Vo=d(),ht=r("span"),Bo=o("PretrainedConfig"),co=d(),l=r("div"),g($e.$$.fragment),Ro=d(),mt=r("p"),Uo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Jo=d(),g(K.$$.fragment),Go=d(),ut=r("p"),Xo=o("Class attributes (overridden by derived classes):"),Ko=d(),S=r("ul"),M=r("li"),pt=r("strong"),Qo=o("model_type"),Yo=o(" ("),gt=r("code"),Zo=o("str"),en=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
...
model.`),Hn=d(),oe=r("li"),jt=r("strong"),Vn=o("num_hidden_layers"),Bn=o(" ("),zt=r("code"),Rn=o("int"),Un=o(") \u2014 The number of blocks in the model."),Jn=d(),A=r("div"),g(ke.$$.fragment),Gn=d(),Pe=r("p"),Xn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
the library are already mapped with `),Mt=r("code"),Wr=o("AutoConfig"),Hr=o("."),Vr=d(),g(de.$$.fragment),Br=d(),ce=r("div"),g(Ie.$$.fragment),Rr=d(),U=r("p"),Ur=o("Save a configuration object to the directory "),Wt=r("code"),Jr=o("save_directory"),Gr=o(`, so that it can be re-loaded using the
...
serializes to a Python dictionary.`),na=d(),he=r("div"),g(Me.$$.fragment),ra=d(),Bt=r("p"),aa=o("Save this instance to a JSON file."),sa=d(),me=r("div"),g(We.$$.fragment),ia=d(),Rt=r("p"),da=o("Serializes this instance to a JSON string."),ca=d(),ue=r("div"),g(He.$$.fragment),la=d(),Ve=r("p"),fa=o("Updates attributes of this class with attributes from "),Ut=r("code"),ha=o("config_dict"),ma=o("."),ua=d(),O=r("div"),g(Be.$$.fragment),pa=d(),Re=r("p"),ga=o("Updates attributes of this class with attributes from "),Jt=r("code"),_a=o("update_str"),ba=o("."),ya=d(),J=r("p"),va=o("The expected format is ints, floats and strings as is, and for booleans use "),Gt=r("code"),wa=o("true"),$a=o(" or "),Xt=r("code"),ka=o("false"),Pa=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),Ca=d(),Kt=r("p"),Ea=o("The keys to change have to already exist in the config object."),this.h()},l(i){const $=Ss('[data-svelte="svelte-1phssyn"]',document.head);h=a($,"META",{name:!0,content:!0}),$.forEach(t),P=c(i),u=a(i,"H1",{class:!0});var Ue=s(u);p=a(Ue,"A",{id:!0,class:!0,href:!0});var Qt=s(p);j=a(Qt,"SPAN",{});var Yt=s(j);_(k.$$.fragment,Yt),Yt.forEach(t),Qt.forEach(t),C=c(Ue),q=a(Ue,"SPAN",{});var xa=s(q);jo=n(xa,"Configuration"),xa.forEach(t),Ue.forEach(t),ao=c(i),G=a(i,"P",{});var fo=s(G);zo=n(fo,"The base class "),Ge=a(fo,"A",{href:!0});var Da=s(Ge);Ao=n(Da,"PretrainedConfig"),Da.forEach(t),Oo=n(fo,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
