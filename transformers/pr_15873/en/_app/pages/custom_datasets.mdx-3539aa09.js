import{S as dm,i as cm,s as mm,e as l,k as f,w as d,t as n,M as _m,c as i,d as t,m as h,a as p,x as c,h as o,b as u,F as s,g as r,y as m,q as _,o as w,B as g}from"../chunks/vendor-4833417e.js";import{T as Su}from"../chunks/Tip-fffd6df1.js";import{I as z}from"../chunks/IconCopyLink-4b81c553.js";import{C as b}from"../chunks/CodeBlock-6a3d1b46.js";import{D as wm}from"../chunks/DocNotebookDropdown-ecff2a90.js";import"../chunks/CopyButton-dacfbfaf.js";function gm(V){let $,q,k,y,E,v,P,T;return{c(){$=l("p"),q=n(`For a more in-depth example of how to fine-tune a model for text classification, take a look at the corresponding
...
imdb = load_dataset(<span class="hljs-string">&quot;imdb&quot;</span>)`}}),it=new b({props:{codee:`imdb["train"][0]
{
    "label": 1,
...
}`}}),pt=new z({}),ht=new b({props:{codee:`from transformers import AutoTokenizer
...
tokenizer = AutoTokenizer.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>)`}}),ut=new b({props:{codee:`def preprocess_function(examples):
    ...
    <span class="hljs-keyword">return</span> tokenizer(examples[<span class="hljs-string">&quot;text&quot;</span>], truncation=<span class="hljs-literal">True</span>)`}}),dt=new b({props:{codee:"tokenized_imdb = imdb.map(preprocess_function, batched=True),",highlighted:'tokenized_imdb = imdb.<span class="hljs-built_in">map</span>(preprocess_function, batched=<span class="hljs-literal">True</span>)'}}),ct=new b({props:{codee:`from transformers import DataCollatorWithPadding
...
data_collator = DataCollatorWithPadding(tokenizer=tokenizer)`}}),mt=new z({}),_t=new b({props:{codee:`from transformers import AutoModelForSequenceClassification
...
model = AutoModelForSequenceClassification.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>, num_labels=<span class="hljs-number">2</span>)`}}),$t=new b({props:{codee:`from transformers import TrainingArguments, Trainer
...
trainer.train()`}}),kt=new z({}),vt=new b({props:{codee:`from transformers import DataCollatorWithPadding
...
data_collator = DataCollatorWithPadding(tokenizer, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)`}}),jt=new b({props:{codee:`tf_train_dataset = tokenized_imdb["train"].to_tf_dataset(
...
tf_validation_dataset = tokenized_imdb[<span class="hljs-string">&quot;train&quot;</span>].to_tf_dataset(
    ...
    batch_size=<span class="hljs-number">16</span>,
    collate_fn=data_collator,
)`}}),yt=new b({props:{codee:`from transformers import create_optimizer
...
optimizer, schedule = create_optimizer(init_lr=<span class="hljs-number">2e-5</span>, num_warmup_steps=<span class="hljs-number">0</span>, num_train_steps=total_train_steps)`}}),xt=new b({props:{codee:`from transformers import TFAutoModelForSequenceClassification
...
model = TFAutoModelForSequenceClassification.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>, num_labels=<span class="hljs-number">2</span>)`}}),qt=new b({props:{codee:`import tensorflow as tf
...
model.<span class="hljs-built_in">compile</span>(optimizer=optimizer)`}}),Et=new b({props:{codee:`model.fit(
    tf_train_set,
    ...
    validation_data=tf_validation_set,
    epochs=num_train_epochs,
)`}}),Tt=new z({}),qe=new Su({props:{$$slots:{default:[bm]},$$scope:{ctx:V}}}),zt=new z({}),Pt=new b({props:{codee:`from datasets import load_dataset
...
<span class="hljs-meta">&gt;&gt;&gt; </span>wnut = load_dataset(<span class="hljs-string">&quot;wnut_17&quot;</span>)`}}),Ft=new b({props:{codee:'wnut["train"][0],',highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>wnut[<span class="hljs-string">&quot;train&quot;</span>][<span class="hljs-number">0</span>]
...
}`}}),Ct=new b({props:{codee:`label_list = wnut["train"].features[f"ner_tags"].feature.names
...
]`}}),Dt=new z({}),St=new b({props:{codee:`from transformers import AutoTokenizer

tokenizer = AutoTokenizer.from_pretrained("distilbert-base-uncased"),`,highlighted:`<span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> AutoTokenizer

tokenizer = AutoTokenizer.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>)`}}),Nt=new b({props:{codee:`tokenized_input = tokenizer(example["tokens"], is_split_into_words=True)
...
[<span class="hljs-string">&#x27;[CLS]&#x27;</span>, <span class="hljs-string">&#x27;@&#x27;</span>, <span class="hljs-string">&#x27;paul&#x27;</span>, <span class="hljs-string">&#x27;##walk&#x27;</span>, <span class="hljs-string">&#x27;it&#x27;</span>, <span class="hljs-string">&quot;&#x27;&quot;</span>, <span class="hljs-string">&#x27;s&#x27;</span>, <span class="hljs-string">&#x27;the&#x27;</span>, <span class="hljs-string">&#x27;view&#x27;</span>, <span class="hljs-string">&#x27;from&#x27;</span>, <span class="hljs-string">&#x27;where&#x27;</span>, <span class="hljs-string">&#x27;i&#x27;</span>, <span class="hljs-string">&quot;&#x27;&quot;</span>, <span class="hljs-string">&#x27;m&#x27;</span>, <span class="hljs-string">&#x27;living&#x27;</span>, <span class="hljs-string">&#x27;for&#x27;</span>, <span class="hljs-string">&#x27;two&#x27;</span>, <span class="hljs-string">&#x27;weeks&#x27;</span>, <span class="hljs-string">&#x27;.&#x27;</span>, <span class="hljs-string">&#x27;empire&#x27;</span>, <span class="hljs-string">&#x27;state&#x27;</span>, <span class="hljs-string">&#x27;building&#x27;</span>, <span class="hljs-string">&#x27;=&#x27;</span>, <span class="hljs-string">&#x27;es&#x27;</span>, <span class="hljs-string">&#x27;##b&#x27;</span>, <span class="hljs-string">&#x27;.&#x27;</span>, <span class="hljs-string">&#x27;pretty&#x27;</span>, <span class="hljs-string">&#x27;bad&#x27;</span>, <span class="hljs-string">&#x27;storm&#x27;</span>, <span class="hljs-string">&#x27;here&#x27;</span>, <span class="hljs-string">&#x27;last&#x27;</span>, <span class="hljs-string">&#x27;evening&#x27;</span>, <span class="hljs-string">&#x27;.&#x27;</span>, <span class="hljs-string">&#x27;[SEP]&#x27;</span>]`}}),Lt=new b({props:{codee:`def tokenize_and_align_labels(examples):
    ...
    <span class="hljs-keyword">return</span> tokenized_inputs`}}),Ot=new b({props:{codee:"tokenized_wnut = wnut.map(tokenize_and_align_labels, batched=True),",highlighted:'tokenized_wnut = wnut.<span class="hljs-built_in">map</span>(tokenize_and_align_labels, batched=<span class="hljs-literal">True</span>)'}}),Bt=new b({props:{codee:`from transformers import DataCollatorForTokenClassification
...
data_collator = DataCollatorForTokenClassification(tokenizer)`}}),Wt=new z({}),Ht=new b({props:{codee:`from transformers import AutoModelForTokenClassification, TrainingArguments, Trainer
...
model = AutoModelForTokenClassification.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>, num_labels=<span class="hljs-built_in">len</span>(label_list))`}}),Qt=new b({props:{codee:`training_args = TrainingArguments(
    output_dir="./results",
    ...
    weight_decay=<span class="hljs-number">0.01</span>,
)`}}),Rt=new b({props:{codee:`trainer = Trainer(
    model=model,
    args=training_args,
    ...
    data_collator=data_collator,
    tokenizer=tokenizer,
)`}}),Ut=new b({props:{codee:"trainer.train(),",highlighted:"trainer.train()"}}),Yt=new z({}),Gt=new b({props:{codee:`from transformers import DataCollatorForTokenClassification
...
data_collator = DataCollatorForTokenClassification(tokenizer, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)`}}),Vt=new b({props:{codee:`tf_train_set = tokenized_wnut["train"].to_tf_dataset(
...
tf_validation_set = tokenized_wnut[<span class="hljs-string">&quot;validation&quot;</span>].to_tf_dataset(
    ...
    batch_size=<span class="hljs-number">16</span>,
    collate_fn=data_collator,
)`}}),Jt=new b({props:{codee:`from transformers import TFAutoModelForTokenClassification
...
model = TFAutoModelForTokenClassification.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>, num_labels=<span class="hljs-built_in">len</span>(label_list))`}}),Kt=new b({props:{codee:`from transformers import create_optimizer
...
)`}}),Xt=new b({props:{codee:`import tensorflow as tf

model.compile(optimizer=optimizer),`,highlighted:`<span class="hljs-keyword">import</span> tensorflow <span class="hljs-keyword">as</span> tf

model.<span class="hljs-built_in">compile</span>(optimizer=optimizer)`}}),Zt=new b({props:{codee:`model.fit(
    tf_train_set,
    validation_data=tf_validation_set,
    epochs=num_train_epochs,
),`,highlighted:`model.fit(
    ...
    validation_data=tf_validation_set,
    epochs=num_train_epochs,
)`}}),es=new z({}),Be=new Su({props:{$$slots:{default:[$m]},$$scope:{ctx:V}}}),ss=new z({}),as=new b({props:{codee:`from datasets import load_dataset
...
squad = load_dataset(<span class="hljs-string">&quot;squad&quot;</span>)`}}),ns=new b({props:{codee:'squad["train"][0],',highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>squad[<span class="hljs-string">&quot;train&quot;</span>][<span class="hljs-number">0</span>]
...
}`}}),os=new z({}),rs=new b({props:{codee:`from transformers import AutoTokenizer

tokenizer = AutoTokenizer.from_pretrained("distilbert-base-uncased"),`,highlighted:`<span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> AutoTokenizer

tokenizer = AutoTokenizer.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>)`}}),ps=new b({props:{codee:`def preprocess_function(examples):
    ...
    <span class="hljs-keyword">return</span> inputs`}}),fs=new b({props:{codee:'tokenized_squad = squad.map(preprocess_function, batched=True, remove_columns=squad["train"].column_names),',highlighted:'tokenized_squad = squad.<span class="hljs-built_in">map</span>(preprocess_function, batched=<span class="hljs-literal">True</span>, remove_columns=squad[<span class="hljs-string">&quot;train&quot;</span>].column_names)'}}),hs=new b({props:{codee:`from transformers import default_data_collator
...
data_collator = default_data_collator`}}),us=new z({}),ds=new b({props:{codee:`from transformers import AutoModelForQuestionAnswering, TrainingArguments, Trainer
...
model = AutoModelForQuestionAnswering.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>)`}}),cs=new b({props:{codee:`training_args = TrainingArguments(
    output_dir="./results",
    evaluation_strategy="epoch",
    learning_rate=2e-5,
    per_device_train_batch_size=16,
    ...
    num_train_epochs=<span class="hljs-number">3</span>,
    weight_decay=<span class="hljs-number">0.01</span>,
)`}}),ms=new b({props:{codee:`trainer = Trainer(
    model=model,
    args=training_args,
    ...
    data_collator=data_collator,
    tokenizer=tokenizer,
)`}}),_s=new b({props:{codee:"trainer.train(),",highlighted:"trainer.train()"}}),ws=new z({}),gs=new b({props:{codee:`from transformers.data.data_collator import tf_default_collator
...
data_collator = tf_default_collator`}}),bs=new b({props:{codee:`tf_train_set = tokenized_squad["train"].to_tf_dataset(
...
tf_validation_set = tokenized_squad[<span class="hljs-string">&quot;validation&quot;</span>].to_tf_dataset(
    ...
    batch_size=<span class="hljs-number">16</span>,
    collate_fn=data_collator,
)`}}),$s=new b({props:{codee:`from transformers import create_optimizer
...
optimizer, schedule = create_optimizer(
    ...
    num_warmup_steps=<span class="hljs-number">0</span>,
    num_train_steps=total_train_steps,
)`}}),ks=new b({props:{codee:`from transformers import TFAutoModelForQuestionAnswering
...
model = TFAutoModelForQuestionAnswering(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>)`}}),vs=new b({props:{codee:`import tensorflow as tf

model.compile(optimizer=optimizer),`,highlighted:`<span class="hljs-keyword">import</span> tensorflow <span class="hljs-keyword">as</span> tf

model.<span class="hljs-built_in">compile</span>(optimizer=optimizer)`}}),js=new b({props:{codee:`model.fit(
    tf_train_set,
    validation_data=tf_validation_set,
    epochs=num_train_epochs,
),`,highlighted:`model.fit(
