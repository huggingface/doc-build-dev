...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/tokenization_t5.py#L223",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/tokenization_t5.py#L163",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/tokenization_t5.py#L201",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/tokenization_t5_fast.py#L165",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16926/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16926/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16926/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16926/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1345",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16926/en/model_doc/t5#transformers.T5Config"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1301"}}),xs=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
...
model.parallelize(device_map)`}}),$s=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1313"}}),zs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1539",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1495"}}),Is=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Ds=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1508"}}),Ss=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Whether or not to return a <a href="/docs/transformers/pr_16926/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1810",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1773"}}),Js=new S({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Xs=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_t5.py#L1784"}}),Qs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_tf_t5.py#L1134",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_tf_t5.py#L1309",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16926/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16926/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16926/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_tf_t5.py#L1618",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/pr_16926/src/transformers/models/t5/modeling_flax_t5.py#L958",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_16926/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
use of token type ids, therefore a list of zeros is returned.`),_1.forEach(n),fp.forEach(n),Lf=l(nt),yr=r(nt,"DIV",{class:!0});var g1=i(yr);_(rs.$$.fragment,g1),g1.forEach(n),nt.forEach(n),Pc=l(t),tn=r(t,"H2",{class:!0});var _p=i(tn);Ln=r(_p,"A",{id:!0,class:!0,href:!0});var T1=i(Ln);bd=r(T1,"SPAN",{});var b1=i(bd);_(is.$$.fragment,b1),b1.forEach(n),T1.forEach(n),Af=l(_p),vd=r(_p,"SPAN",{});var v1=i(vd);If=s(v1,"T5TokenizerFast"),v1.forEach(n),_p.forEach(n),Nc=l(t),Ie=r(t,"DIV",{class:!0});var Ot=i(Ie);_(ds.$$.fragment,Ot),Df=l(Ot),nn=r(Ot,"P",{});var Kr=i(nn);Sf=s(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),kd=r(Kr,"EM",{});var k1=i(kd);Gf=s(k1,"tokenizers"),k1.forEach(n),Uf=s(Kr,` library). Based on
...
adding special tokens. A sequence has the following format:`),x1.forEach(n),Xf=l(Yr),hs=r(Yr,"UL",{});var Tp=i(hs);xr=r(Tp,"LI",{});var Vv=i(xr);Qf=s(Vv,"single sequence: "),wd=r(Vv,"CODE",{});var $1=i(wd);e_=s($1,"X </s>"),$1.forEach(n),Vv.forEach(n),t_=l(Tp),$r=r(Tp,"LI",{});var Kv=i($r);n_=s(Kv,"pair of sequences: "),xd=r(Kv,"CODE",{});var z1=i(xd);o_=s(z1,"A </s> B </s>"),z1.forEach(n),Kv.forEach(n),Tp.forEach(n),Yr.forEach(n),s_=l(Ot),An=r(Ot,"DIV",{class:!0});var bp=i(An);_(us.$$.fragment,bp),a_=l(bp),$d=r(bp,"P",{});var j1=i($d);r_=s(j1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),j1.forEach(n),bp.forEach(n),Ot.forEach(n),Oc=l(t),on=r(t,"H2",{class:!0});var vp=i(on);In=r(vp,"A",{id:!0,class:!0,href:!0});var q1=i(In);zd=r(q1,"SPAN",{});var E1=i(zd);_(ms.$$.fragment,E1),E1.forEach(n),q1.forEach(n),i_=l(vp),jd=r(vp,"SPAN",{});var F1=i(jd);d_=s(F1,"T5Model"),F1.forEach(n),vp.forEach(n),Lc=l(t),J=r(t,"DIV",{class:!0});var we=i(J);_(fs.$$.fragment,we),l_=l(we),qd=r(we,"P",{});var M1=i(qd);c_=s(M1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),M1.forEach(n),p_=l(we),_s=r(we,"P",{});var kp=i(_s);h_=s(kp,"The T5 model was proposed in "),gs=r(kp,"A",{href:!0,rel:!0});var C1=i(gs);u_=s(C1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),C1.forEach(n),m_=s(kp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),kp.forEach(n),f_=l(we),Ts=r(we,"P",{});var yp=i(Ts);__=s(yp,"This model inherits from "),zr=r(yp,"A",{href:!0});var P1=i(zr);g_=s(P1,"PreTrainedModel"),P1.forEach(n),T_=s(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(n),b_=l(we),bs=r(we,"P",{});var wp=i(bs);v_=s(wp,"This model is also a PyTorch "),vs=r(wp,"A",{href:!0,rel:!0});var N1=i(vs);k_=s(N1,"torch.nn.Module"),N1.forEach(n),y_=s(wp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wp.forEach(n),w_=l(we),We=r(we,"DIV",{class:!0});var Lt=i(We);_(ks.$$.fragment,Lt),x_=l(Lt),sn=r(Lt,"P",{});var Zr=i(sn);$_=s(Zr,"The "),jr=r(Zr,"A",{href:!0});var O1=i(jr);z_=s(O1,"T5Model"),O1.forEach(n),j_=s(Zr," forward method, overrides the "),Ed=r(Zr,"CODE",{});var L1=i(Ed);q_=s(L1,"__call__"),L1.forEach(n),E_=s(Zr," special method."),Zr.forEach(n),F_=l(Lt),_(Dn.$$.fragment,Lt),M_=l(Lt),Fd=r(Lt,"P",{});var A1=i(Fd);C_=s(A1,"Example:"),A1.forEach(n),P_=l(Lt),_(ys.$$.fragment,Lt),Lt.forEach(n),N_=l(we),Re=r(we,"DIV",{class:!0});var At=i(Re);_(ws.$$.fragment,At),O_=l(At),Md=r(At,"P",{});var I1=i(Md);L_=s(I1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),I1.forEach(n),A_=l(At),Cd=r(At,"P",{});var D1=i(Cd);I_=s(D1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),D1.forEach(n),D_=l(At),Pd=r(At,"P",{});var S1=i(Pd);S_=s(S1,"Example:"),S1.forEach(n),G_=l(At),_(xs.$$.fragment,At),At.forEach(n),U_=l(we),_t=r(we,"DIV",{class:!0});var lo=i(_t);_($s.$$.fragment,lo),W_=l(lo),Nd=r(lo,"P",{});var G1=i(Nd);R_=s(G1,"Moves the model to cpu from a model parallel state."),G1.forEach(n),B_=l(lo),Od=r(lo,"P",{});var U1=i(Od);H_=s(U1,"Example:"),U1.forEach(n),V_=l(lo),_(zs.$$.fragment,lo),lo.forEach(n),we.forEach(n),Ac=l(t),an=r(t,"H2",{class:!0});var xp=i(an);Sn=r(xp,"A",{id:!0,class:!0,href:!0});var W1=i(Sn);Ld=r(W1,"SPAN",{});var R1=i(Ld);_(js.$$.fragment,R1),R1.forEach(n),W1.forEach(n),K_=l(xp),Ad=r(xp,"SPAN",{});var B1=i(Ad);Y_=s(B1,"T5ForConditionalGeneration"),B1.forEach(n),xp.forEach(n),Ic=l(t),X=r(t,"DIV",{class:!0});var xe=i(X);_(qs.$$.fragment,xe),Z_=l(xe),Es=r(xe,"P",{});var $p=i(Es);J_=s($p,"T5 Model with a "),Id=r($p,"CODE",{});var H1=i(Id);X_=s(H1,"language modeling"),H1.forEach(n),Q_=s($p," head on top."),$p.forEach(n),eg=l(xe),Fs=r(xe,"P",{});var zp=i(Fs);tg=s(zp,"The T5 model was proposed in "),Ms=r(zp,"A",{href:!0,rel:!0});var V1=i(Ms);ng=s(V1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),V1.forEach(n),og=s(zp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),zp.forEach(n),sg=l(xe),Cs=r(xe,"P",{});var jp=i(Cs);ag=s(jp,"This model inherits from "),qr=r(jp,"A",{href:!0});var K1=i(qr);rg=s(K1,"PreTrainedModel"),K1.forEach(n),ig=s(jp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qp.forEach(n),hg=l(xe),Be=r(xe,"DIV",{class:!0});var It=i(Be);_(Os.$$.fragment,It),ug=l(It),rn=r(It,"P",{});var Jr=i(rn);mg=s(Jr,"The "),Er=r(Jr,"A",{href:!0});var Z1=i(Er);fg=s(Z1,"T5ForConditionalGeneration"),Z1.forEach(n),_g=s(Jr," forward method, overrides the "),Dd=r(Jr,"CODE",{});var J1=i(Dd);gg=s(J1,"__call__"),J1.forEach(n),Tg=s(Jr," special method."),Jr.forEach(n),bg=l(It),_(Gn.$$.fragment,It),vg=l(It),Sd=r(It,"P",{});var X1=i(Sd);kg=s(X1,"Examples:"),X1.forEach(n),yg=l(It),_(Ls.$$.fragment,It),It.forEach(n),wg=l(xe),He=r(xe,"DIV",{class:!0});var Dt=i(He);_(As.$$.fragment,Dt),xg=l(Dt),Gd=r(Dt,"P",{});var Q1=i(Gd);$g=s(Q1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Q1.forEach(n),zg=l(Dt),Ud=r(Dt,"P",{});var e5=i(Ud);jg=s(e5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
