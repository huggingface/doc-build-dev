...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/configuration_mbart.py#L34"}}),Xn=new $({props:{code:`from transformers import MBartModel, MBartConfig
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/tokenization_mbart_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),_a=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/tokenization_mbart_fast.py#L249"}}),ga=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/tokenization_mbart_fast.py#L264"}}),ba=new X({}),ka=new F({props:{name:"class transformers.MBart50Tokenizer",anchor:"transformers.MBart50Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart50/tokenization_mbart50.py#L48"}}),wa=new $({props:{code:`from transformers import MBart50Tokenizer
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart50/tokenization_mbart50.py#L257",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ca=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart50/tokenization_mbart50.py#L348"}}),Ea=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart50/tokenization_mbart50.py#L354"}}),Pa=new X({}),Sa=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
The token used for masking values. This is the token used when training this model with masked language
modeling. This is the token which the model will try to predict.`,name:"mask_token"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L56"}}),Ia=new $({props:{code:`from transformers import MBart50TokenizerFast
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_14549/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_mbart.py#L1301",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_mbart.py#L1570",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_mbart.py#L1443",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_14549/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_mbart.py#L1722",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_tf_mbart.py#L1158",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_tf_mbart.py#L1266",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_14549/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_flax_mbart.py#L1203",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_14549/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_flax_mbart.py#L1027",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_14549/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_flax_mbart.py#L1090",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_14549/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_flax_mbart.py#L1357",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_14549/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_flax_mbart.py#L1203",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_14549/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_14549/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/mbart/modeling_flax_mbart.py#L1203",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_14549/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
This model inherits from `),zi=a(ku,"A",{href:!0});var e4=s(zi);yy=i(e4,"TFPreTrainedModel"),e4.forEach(t),vy=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),Ty=l(Dt),Ns=a(Dt,"P",{});var yu=s(Ns);wy=i(yu,"This model is also a "),Ds=a(yu,"A",{href:!0,rel:!0});var t4=s(Ds);My=i(t4,"tf.keras.Model"),t4.forEach(t),xy=i(yu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yu.forEach(t),zy=l(Dt),m(hn.$$.fragment,Dt),Fy=l(Dt),ee=a(Dt,"DIV",{class:!0});var We=s(ee);m(Ls.$$.fragment,We),qy=l(We),Mo=a(We,"P",{});var Xi=s(Mo);$y=i(Xi,"The "),Fi=a(Xi,"A",{href:!0});var o4=s(Fi);By=i(o4,"TFMBartForConditionalGeneration"),o4.forEach(t),jy=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var n4=s(rc);Cy=i(n4,"__call__"),n4.forEach(t),Ey=i(Xi," special method."),Xi.forEach(t),Py=l(We),m(un.$$.fragment,We),Sy=l(We),ic=a(We,"P",{});var a4=s(ic);Ay=i(a4,"Summarization example:"),a4.forEach(t),Oy=l(We),m(Gs.$$.fragment,We),Iy=l(We),dc=a(We,"P",{});var s4=s(dc);Ny=i(s4,"Mask filling example:"),s4.forEach(t),Dy=l(We),m(Ws.$$.fragment,We),We.forEach(t),Dt.forEach(t),oh=l(o),xo=a(o,"H2",{class:!0});var vu=s(xo);mn=a(vu,"A",{id:!0,class:!0,href:!0});var r4=s(mn);lc=a(r4,"SPAN",{});var i4=s(lc);m(Us.$$.fragment,i4),i4.forEach(t),r4.forEach(t),Ly=l(vu),cc=a(vu,"SPAN",{});var d4=s(cc);Gy=i(d4,"FlaxMBartModel"),d4.forEach(t),vu.forEach(t),nh=l(o),U=a(o,"DIV",{class:!0});var _e=s(U);m(Rs.$$.fragment,_e),Wy=l(_e),Xs=a(_e,"P",{});var Tu=s(Xs);Uy=i(Tu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(Tu,"A",{href:!0});var l4=s(qi);Ry=i(l4,"FlaxPreTrainedModel"),l4.forEach(t),Xy=i(Tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tu.forEach(t),Vy=l(_e),Vs=a(_e,"P",{});var wu=s(Vs);Qy=i(wu,`This model is also a Flax Linen
`),Qs=a(wu,"A",{href:!0,rel:!0});var c4=s(Qs);Hy=i(c4,"flax.nn.Module"),c4.forEach(t),Jy=i(wu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wu.forEach(t),Ky=l(_e),pc=a(_e,"P",{});var p4=s(pc);Zy=i(p4,"Finally, this model supports inherent JAX features such as:"),p4.forEach(t),Yy=l(_e),ft=a(_e,"UL",{});var $n=s(ft);hc=a($n,"LI",{});var h4=s(hc);Hs=a(h4,"A",{href:!0,rel:!0});var u4=s(Hs);ev=i(u4,"Just-In-Time (JIT) compilation"),u4.forEach(t),h4.forEach(t),tv=l($n),uc=a($n,"LI",{});var m4=s(uc);Js=a(m4,"A",{href:!0,rel:!0});var f4=s(Js);ov=i(f4,"Automatic Differentiation"),f4.forEach(t),m4.forEach(t),nv=l($n),mc=a($n,"LI",{});var _4=s(mc);Ks=a(_4,"A",{href:!0,rel:!0});var g4=s(Ks);av=i(g4,"Vectorization"),g4.forEach(t),_4.forEach(t),sv=l($n),fc=a($n,"LI",{});var b4=s(fc);Zs=a(b4,"A",{href:!0,rel:!0});var k4=s(Zs);rv=i(k4,"Parallelization"),k4.forEach(t),b4.forEach(t),$n.forEach(t),iv=l(_e),Ne=a(_e,"DIV",{class:!0});var Lt=s(Ne);m(Ys.$$.fragment,Lt),dv=l(Lt),zo=a(Lt,"P",{});var Vi=s(zo);lv=i(Vi,"The "),_c=a(Vi,"CODE",{});var y4=s(_c);cv=i(y4,"FlaxMBartPreTrainedModel"),y4.forEach(t),pv=i(Vi," forward method, overrides the "),gc=a(Vi,"CODE",{});var v4=s(gc);hv=i(v4,"__call__"),v4.forEach(t),uv=i(Vi," special method."),Vi.forEach(t),mv=l(Lt),m(fn.$$.fragment,Lt),fv=l(Lt),bc=a(Lt,"P",{});var T4=s(bc);_v=i(T4,"Example:"),T4.forEach(t),gv=l(Lt),m(er.$$.fragment,Lt),Lt.forEach(t),bv=l(_e),wt=a(_e,"DIV",{class:!0});var Qi=s(wt);m(tr.$$.fragment,Qi),kv=l(Qi),kc=a(Qi,"P",{});var w4=s(kc);yv=i(w4,"Example:"),w4.forEach(t),vv=l(Qi),m(or.$$.fragment,Qi),Qi.forEach(t),Tv=l(_e),Mt=a(_e,"DIV",{class:!0});var Hi=s(Mt);m(nr.$$.fragment,Hi),wv=l(Hi),yc=a(Hi,"P",{});var M4=s(yc);Mv=i(M4,"Example:"),M4.forEach(t),xv=l(Hi),m(ar.$$.fragment,Hi),Hi.forEach(t),_e.forEach(t),ah=l(o),Fo=a(o,"H2",{class:!0});var Mu=s(Fo);_n=a(Mu,"A",{id:!0,class:!0,href:!0});var x4=s(_n);vc=a(x4,"SPAN",{});var z4=s(vc);m(sr.$$.fragment,z4),z4.forEach(t),x4.forEach(t),zv=l(Mu),Tc=a(Mu,"SPAN",{});var F4=s(Tc);Fv=i(F4,"FlaxMBartForConditionalGeneration"),F4.forEach(t),Mu.forEach(t),sh=l(o),R=a(o,"DIV",{class:!0});var ge=s(R);m(rr.$$.fragment,ge),qv=l(ge),ir=a(ge,"P",{});var xu=s(ir);$v=i(xu,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),$i=a(xu,"A",{href:!0});var q4=s($i);Bv=i(q4,"FlaxPreTrainedModel"),q4.forEach(t),jv=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),Cv=l(ge),dr=a(ge,"P",{});var zu=s(dr);Ev=i(zu,`This model is also a Flax Linen
`),lr=a(zu,"A",{href:!0,rel:!0});var $4=s(lr);Pv=i($4,"flax.nn.Module"),$4.forEach(t),Sv=i(zu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zu.forEach(t),Av=l(ge),wc=a(ge,"P",{});var B4=s(wc);Ov=i(B4,"Finally, this model supports inherent JAX features such as:"),B4.forEach(t),Iv=l(ge),_t=a(ge,"UL",{});var Bn=s(_t);Mc=a(Bn,"LI",{});var j4=s(Mc);cr=a(j4,"A",{href:!0,rel:!0});var C4=s(cr);Nv=i(C4,"Just-In-Time (JIT) compilation"),C4.forEach(t),j4.forEach(t),Dv=l(Bn),xc=a(Bn,"LI",{});var E4=s(xc);pr=a(E4,"A",{href:!0,rel:!0});var P4=s(pr);Lv=i(P4,"Automatic Differentiation"),P4.forEach(t),E4.forEach(t),Gv=l(Bn),zc=a(Bn,"LI",{});var S4=s(zc);hr=a(S4,"A",{href:!0,rel:!0});var A4=s(hr);Wv=i(A4,"Vectorization"),A4.forEach(t),S4.forEach(t),Uv=l(Bn),Fc=a(Bn,"LI",{});var O4=s(Fc);ur=a(O4,"A",{href:!0,rel:!0});var I4=s(ur);Rv=i(I4,"Parallelization"),I4.forEach(t),O4.forEach(t),Bn.forEach(t),Xv=l(ge),te=a(ge,"DIV",{class:!0});var Ue=s(te);m(mr.$$.fragment,Ue),Vv=l(Ue),qo=a(Ue,"P",{});var Ji=s(qo);Qv=i(Ji,"The "),qc=a(Ji,"CODE",{});var N4=s(qc);Hv=i(N4,"FlaxMBartPreTrainedModel"),N4.forEach(t),Jv=i(Ji," forward method, overrides the "),$c=a(Ji,"CODE",{});var D4=s($c);Kv=i(D4,"__call__"),D4.forEach(t),Zv=i(Ji," special method."),Ji.forEach(t),Yv=l(Ue),m(gn.$$.fragment,Ue),eT=l(Ue),Bc=a(Ue,"P",{});var L4=s(Bc);tT=i(L4,"Summarization example:"),L4.forEach(t),oT=l(Ue),m(fr.$$.fragment,Ue),nT=l(Ue),jc=a(Ue,"P",{});var G4=s(jc);aT=i(G4,"Mask filling example:"),G4.forEach(t),sT=l(Ue),m(_r.$$.fragment,Ue),Ue.forEach(t),rT=l(ge),xt=a(ge,"DIV",{class:!0});var Ki=s(xt);m(gr.$$.fragment,Ki),iT=l(Ki),Cc=a(Ki,"P",{});var W4=s(Cc);dT=i(W4,"Example:"),W4.forEach(t),lT=l(Ki),m(br.$$.fragment,Ki),Ki.forEach(t),cT=l(ge),zt=a(ge,"DIV",{class:!0});var Zi=s(zt);m(kr.$$.fragment,Zi),pT=l(Zi),Ec=a(Zi,"P",{});var U4=s(Ec);hT=i(U4,"Example:"),U4.forEach(t),uT=l(Zi),m(yr.$$.fragment,Zi),Zi.forEach(t),ge.forEach(t),rh=l(o),$o=a(o,"H2",{class:!0});var Fu=s($o);bn=a(Fu,"A",{id:!0,class:!0,href:!0});var R4=s(bn);Pc=a(R4,"SPAN",{});var X4=s(Pc);m(vr.$$.fragment,X4),X4.forEach(t),R4.forEach(t),mT=l(Fu),Sc=a(Fu,"SPAN",{});var V4=s(Sc);fT=i(V4,"FlaxMBartForSequenceClassification"),V4.forEach(t),Fu.forEach(t),ih=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);m(Tr.$$.fragment,ne),_T=l(ne),Ac=a(ne,"P",{});var Q4=s(Ac);gT=i(Q4,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Q4.forEach(t),bT=l(ne),wr=a(ne,"P",{});var qu=s(wr);kT=i(qu,"This model inherits from "),Bi=a(qu,"A",{href:!0});var H4=s(Bi);yT=i(H4,"FlaxPreTrainedModel"),H4.forEach(t),vT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),TT=l(ne),Mr=a(ne,"P",{});var $u=s(Mr);wT=i($u,`This model is also a Flax Linen
`),xr=a($u,"A",{href:!0,rel:!0});var J4=s(xr);MT=i(J4,"flax.nn.Module"),J4.forEach(t),xT=i($u,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$u.forEach(t),zT=l(ne),Oc=a(ne,"P",{});var K4=s(Oc);FT=i(K4,"Finally, this model supports inherent JAX features such as:"),K4.forEach(t),qT=l(ne),gt=a(ne,"UL",{});var jn=s(gt);Ic=a(jn,"LI",{});var Z4=s(Ic);zr=a(Z4,"A",{href:!0,rel:!0});var Y4=s(zr);$T=i(Y4,"Just-In-Time (JIT) compilation"),Y4.forEach(t),Z4.forEach(t),BT=l(jn),Nc=a(jn,"LI",{});var ex=s(Nc);Fr=a(ex,"A",{href:!0,rel:!0});var tx=s(Fr);jT=i(tx,"Automatic Differentiation"),tx.forEach(t),ex.forEach(t),CT=l(jn),Dc=a(jn,"LI",{});var ox=s(Dc);qr=a(ox,"A",{href:!0,rel:!0});var nx=s(qr);ET=i(nx,"Vectorization"),nx.forEach(t),ox.forEach(t),PT=l(jn),Lc=a(jn,"LI",{});var ax=s(Lc);$r=a(ax,"A",{href:!0,rel:!0});var sx=s($r);ST=i(sx,"Parallelization"),sx.forEach(t),ax.forEach(t),jn.forEach(t),AT=l(ne),De=a(ne,"DIV",{class:!0});var Gt=s(De);m(Br.$$.fragment,Gt),OT=l(Gt),Bo=a(Gt,"P",{});var Yi=s(Bo);IT=i(Yi,"The "),Gc=a(Yi,"CODE",{});var rx=s(Gc);NT=i(rx,"FlaxMBartPreTrainedModel"),rx.forEach(t),DT=i(Yi," forward method, overrides the "),Wc=a(Yi,"CODE",{});var ix=s(Wc);LT=i(ix,"__call__"),ix.forEach(t),GT=i(Yi," special method."),Yi.forEach(t),WT=l(Gt),m(kn.$$.fragment,Gt),UT=l(Gt),Uc=a(Gt,"P",{});var dx=s(Uc);RT=i(dx,"Example:"),dx.forEach(t),XT=l(Gt),m(jr.$$.fragment,Gt),Gt.forEach(t),VT=l(ne),Ft=a(ne,"DIV",{class:!0});var ed=s(Ft);m(Cr.$$.fragment,ed),QT=l(ed),Rc=a(ed,"P",{});var lx=s(Rc);HT=i(lx,"Example:"),lx.forEach(t),JT=l(ed),m(Er.$$.fragment,ed),ed.forEach(t),KT=l(ne),qt=a(ne,"DIV",{class:!0});var td=s(qt);m(Pr.$$.fragment,td),ZT=l(td),Xc=a(td,"P",{});var cx=s(Xc);YT=i(cx,"Example:"),cx.forEach(t),e1=l(td),m(Sr.$$.fragment,td),td.forEach(t),ne.forEach(t),dh=l(o),jo=a(o,"H2",{class:!0});var Bu=s(jo);yn=a(Bu,"A",{id:!0,class:!0,href:!0});var px=s(yn);Vc=a(px,"SPAN",{});var hx=s(Vc);m(Ar.$$.fragment,hx),hx.forEach(t),px.forEach(t),t1=l(Bu),Qc=a(Bu,"SPAN",{});var ux=s(Qc);o1=i(ux,"FlaxMBartForQuestionAnswering"),ux.forEach(t),Bu.forEach(t),lh=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);m(Or.$$.fragment,ae),n1=l(ae),Co=a(ae,"P",{});var od=s(Co);a1=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
