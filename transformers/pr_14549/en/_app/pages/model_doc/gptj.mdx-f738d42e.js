...
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),B=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
tensors in the first argument of the model call function: `),W=r(C,"CODE",{});var Ne=i(W);fe=s(Ne,"model(inputs)"),Ne.forEach(t),ie=s(C,"."),C.forEach(t),L=d(h),A=r(h,"P",{});var xe=i(A);ee=s(xe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),xe.forEach(t),te=d(h),J=r(h,"UL",{});var z=i(J);x=r(z,"LI",{});var U=i(x);ge=s(U,"a single Tensor with "),Q=r(U,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(U," only and nothing else: "),H=r(U,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),U.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);B=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ve=d(z),q=r(z,"LI",{});var we=i(q);ye=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,v),e(v,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,J,G),e(J,x),e(x,ge),e(x,Q),e(Q,le),e(x,Y),e(x,H),e(H,oe),e(J,_e),e(J,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,B),e(J,ve),e(J,q),e(q,ye),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(J)}}}function cg(I){let p,F,f,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function pg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,B,ve,q,ye,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),B=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function ug(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,B,ve,q,ye,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),B=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function fg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,B,ve,q,ye,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),B=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function vg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,B,ve,q,ye,R,se,h,G,V,Ae,Ie,C,Le,Ne,xe,z,U,pe,Fe,D,Se,ke,we,De,Ks,pt,Ai,Jo,Ii,Li,Xs,Ni,Si,Ys,Di,Oi,Mr,$t,Kt,Zs,xo,Wi,ea,Bi,qr,Xt,Ui,ms,Qi,Hi,Cr,Mo,zr,fs,Ri,Ar,qo,Ir,Ft,Yt,ta,Co,Vi,oa,Ki,Lr,Ye,zo,Xi,Ze,Yi,gs,Zi,el,Ao,tl,ol,_s,nl,sl,Ts,al,rl,il,na,ll,dl,Io,Nr,jt,Zt,sa,Lo,cl,aa,pl,Sr,ht,No,hl,So,ul,Do,ml,fl,gl,Oe,Oo,_l,Gt,Tl,vs,vl,yl,ra,kl,wl,bl,eo,Pl,ia,$l,Fl,Wo,Dr,Et,to,la,Bo,jl,da,Gl,Or,et,Uo,El,ca,Jl,xl,Qo,Ml,Ho,ql,Cl,zl,We,Ro,Al,Jt,Il,ys,Ll,Nl,pa,Sl,Dl,Ol,oo,Wl,ha,Bl,Ul,Vo,Wr,xt,no,ua,Ko,Ql,ma,Hl,Br,je,Xo,Rl,fa,Vl,Kl,ks,ws,Xl,Yl,Zl,tt,ed,ga,td,od,_a,nd,sd,Ta,ad,rd,va,id,ld,dd,Yo,cd,Zo,pd,hd,ud,ne,en,md,Mt,fd,bs,gd,_d,ya,Td,vd,yd,so,kd,ka,wd,bd,tn,Pd,on,$d,wa,Fd,jd,nn,Gd,sn,Ur,qt,ao,ba,an,Ed,Pa,Jd,Qr,ot,rn,xd,Ct,Md,$a,qd,Cd,Fa,zd,Ad,Id,ln,Ld,dn,Nd,Sd,Dd,Me,cn,Od,zt,Wd,Ps,Bd,Ud,ja,Qd,Hd,Rd,ro,Vd,Ga,Kd,Xd,pn,Yd,hn,Hr,At,io,Ea,un,Zd,Ja,ec,Rr,Ge,mn,tc,xa,oc,nc,fn,sc,$s,ac,rc,ic,gn,lc,_n,dc,cc,pc,lo,hc,Be,Tn,uc,It,mc,Fs,fc,gc,Ma,_c,Tc,vc,co,yc,qa,kc,wc,vn,Vr,Lt,po,Ca,yn,bc,za,Pc,Kr,Ee,kn,$c,Aa,Fc,jc,wn,Gc,js,Ec,Jc,xc,bn,Mc,Pn,qc,Cc,zc,ho,Ac,Ue,$n,Ic,Nt,Lc,Gs,Nc,Sc,Ia,Dc,Oc,Wc,uo,Bc,La,Uc,Qc,Fn,Xr,St,mo,Na,jn,Hc,Sa,Rc,Yr,ae,Gn,Vc,Da,Kc,Xc,Es,Js,Yc,Zc,ep,nt,tp,Oa,op,np,Wa,sp,ap,Ba,rp,ip,Ua,lp,dp,cp,En,pp,xs,hp,up,mp,Jn,fp,xn,gp,_p,Tp,fo,vp,qe,Mn,yp,Dt,kp,Ms,wp,bp,Qa,Pp,$p,Fp,go,jp,Ha,Gp,Ep,qn,Jp,Cn,Zr,Ot,_o,Ra,zn,xp,Va,Mp,ei,Je,An,qp,Wt,Cp,Ka,zp,Ap,Xa,Ip,Lp,Np,In,Sp,qs,Dp,Op,Wp,Ln,Bp,Nn,Up,Qp,Hp,To,Rp,Ce,Sn,Vp,Bt,Kp,Cs,Xp,Yp,Ya,Zp,eh,th,vo,oh,Za,nh,sh,Dn,ah,On,ti,Ut,yo,er,Wn,rh,tr,ih,oi,be,Bn,lh,or,dh,ch,Un,ph,zs,hh,uh,mh,Qn,fh,Hn,gh,_h,Th,nr,vh,yh,ut,sr,Rn,kh,wh,ar,Vn,bh,Ph,rr,Kn,$h,Fh,ir,Xn,jh,Gh,Qe,Yn,Eh,Qt,Jh,lr,xh,Mh,dr,qh,Ch,zh,ko,Ah,cr,Ih,Lh,Zn,ni,Ht,wo,pr,es,Nh,hr,Sh,si,Pe,ts,Dh,ur,Oh,Wh,os,Bh,As,Uh,Qh,Hh,ns,Rh,ss,Vh,Kh,Xh,mr,Yh,Zh,mt,fr,as,eu,tu,gr,rs,ou,nu,_r,is,su,au,Tr,ls,ru,iu,He,ds,lu,Rt,du,vr,cu,pu,yr,hu,uu,mu,bo,fu,kr,gu,_u,cs,ai;return T=new Xe({}),Z=new Xe({}),z=new he({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Lo=new Xe({}),No=new re({props:{name:"class transformers.GPTJModel",anchor:"transformers.GPTJModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/gptj/modeling_gptj.py#L460",parametersDescription:[{anchor:"transformers.GPTJModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_14549/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oo=new re({props:{name:"forward",anchor:"transformers.GPTJModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/gptj/modeling_gptj.py#L516",parametersDescription:[{anchor:"transformers.GPTJModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_14549/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_14549/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Bo=new Xe({}),Uo=new re({props:{name:"class transformers.GPTJForCausalLM",anchor:"transformers.GPTJForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/gptj/modeling_gptj.py#L700",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_14549/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new re({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/gptj/modeling_gptj.py#L769",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_14549/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_14549/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_14549/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_14549/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_14549/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_14549/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_14549/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),jn=new Xe({}),Gn=new re({props:{name:"class transformers.TFGPTJForSequenceClassification",anchor:"transformers.TFGPTJForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/gptj/modeling_tf_gptj.py#L852",parametersDescription:[{anchor:"transformers.TFGPTJForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_14549/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new Ke({props:{$$slots:{default:[ug]},$$scope:{ctx:I}}}),Mn=new re({props:{name:"call",anchor:"transformers.TFGPTJForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/gptj/modeling_tf_gptj.py#L866",parametersDescription:[{anchor:"transformers.TFGPTJForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_14549/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_14549/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
`}}),zn=new Xe({}),An=new re({props:{name:"class transformers.TFGPTJForQuestionAnswering",anchor:"transformers.TFGPTJForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/gptj/modeling_tf_gptj.py#L980",parametersDescription:[{anchor:"transformers.TFGPTJForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_14549/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),To=new Ke({props:{$$slots:{default:[fg]},$$scope:{ctx:I}}}),Sn=new re({props:{name:"call",anchor:"transformers.TFGPTJForQuestionAnswering.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"start_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"end_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_14549/src/transformers/models/gptj/modeling_tf_gptj.py#L991",parametersDescription:[{anchor:"transformers.TFGPTJForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_14549/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
causal language model trained on `),x=a("a"),ge=n("the Pile"),Q=n(" dataset."),le=l(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),_e=n("Stella Biderman"),M=n("."),de=l(),N=a("p"),Te=n("Tips:"),ce=l(),S=a("ul"),B=a("li"),ve=n("To load "),q=a("a"),ye=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
12.1GB of CPU RAM to load the model.`),xe=l(),y(z.$$.fragment),U=l(),pe=a("ul"),Fe=a("li"),D=a("p"),Se=n(`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
...
`),Xs=a("code"),Ni=n("<|extratoken_1|>... <|extratoken_143|>"),Si=n(", so the "),Ys=a("code"),Di=n("vocab_size"),Oi=n(" of tokenizer also becomes 50400."),Mr=l(),$t=a("h3"),Kt=a("a"),Zs=a("span"),y(xo.$$.fragment),Wi=l(),ea=a("span"),Bi=n("Generation"),qr=l(),Xt=a("p"),Ui=n("The "),ms=a("a"),Qi=n("generate()"),Hi=n(` method can be used to generate text using GPT-J
model.`),Cr=l(),y(Mo.$$.fragment),zr=l(),fs=a("p"),Ri=n("\u2026or in float16 precision:"),Ar=l(),y(qo.$$.fragment),Ir=l(),Ft=a("h2"),Yt=a("a"),ta=a("span"),y(Co.$$.fragment),Vi=l(),oa=a("span"),Ki=n("GPTJConfig"),Lr=l(),Ye=a("div"),y(zo.$$.fragment),Xi=l(),Ze=a("p"),Yi=n("This is the configuration class to store the configuration of a "),gs=a("a"),Zi=n("GPTJModel"),el=n(`. It is used to instantiate a GPT-J
...
behavior.`),gl=l(),Oe=a("div"),y(Oo.$$.fragment),_l=l(),Gt=a("p"),Tl=n("The "),vs=a("a"),vl=n("GPTJModel"),yl=n(" forward method, overrides the "),ra=a("code"),kl=n("__call__"),wl=n(" special method."),bl=l(),y(eo.$$.fragment),Pl=l(),ia=a("p"),$l=n("Example:"),Fl=l(),y(Wo.$$.fragment),Dr=l(),Et=a("h2"),to=a("a"),la=a("span"),y(Bo.$$.fragment),jl=l(),da=a("span"),Gl=n("GPTJForCausalLM"),Or=l(),et=a("div"),y(Uo.$$.fragment),El=l(),ca=a("p"),Jl=n("The GPT-J Model transformer with a language modeling head on top."),xl=l(),Qo=a("p"),Ml=n("This model is a PyTorch "),Ho=a("a"),ql=n("torch.nn.Module"),Cl=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zl=l(),We=a("div"),y(Ro.$$.fragment),Al=l(),Jt=a("p"),Il=n("The "),ys=a("a"),Ll=n("GPTJForCausalLM"),Nl=n(" forward method, overrides the "),pa=a("code"),Sl=n("__call__"),Dl=n(" special method."),Ol=l(),y(oo.$$.fragment),Wl=l(),ha=a("p"),Bl=n("Example:"),Ul=l(),y(Vo.$$.fragment),Wr=l(),xt=a("h2"),no=a("a"),ua=a("span"),y(Ko.$$.fragment),Ql=l(),ma=a("span"),Hl=n("GPTJForSequenceClassification"),Br=l(),je=a("div"),y(Xo.$$.fragment),Rl=l(),fa=a("p"),Vl=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Kl=l(),ks=a("p"),ws=a("a"),Xl=n("GPTJForSequenceClassification"),Yl=n(` uses the last token in order to do the classification, as other causal models
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ud=l(),ne=a("div"),y(en.$$.fragment),md=l(),Mt=a("p"),fd=n("The "),bs=a("a"),gd=n("GPTJForSequenceClassification"),_d=n(" forward method, overrides the "),ya=a("code"),Td=n("__call__"),vd=n(" special method."),yd=l(),y(so.$$.fragment),kd=l(),ka=a("p"),wd=n("Example of single-label classification:"),bd=l(),y(tn.$$.fragment),Pd=l(),y(on.$$.fragment),$d=l(),wa=a("p"),Fd=n("Example of multi-label classification:"),jd=l(),y(nn.$$.fragment),Gd=l(),y(sn.$$.fragment),Ur=l(),qt=a("h2"),ao=a("a"),ba=a("span"),y(an.$$.fragment),Ed=l(),Pa=a("span"),Jd=n("GPTJForQuestionAnswering"),Qr=l(),ot=a("div"),y(rn.$$.fragment),xd=l(),Ct=a("p"),Md=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
behavior.`),pc=l(),y(lo.$$.fragment),hc=l(),Be=a("div"),y(Tn.$$.fragment),uc=l(),It=a("p"),mc=n("The "),Fs=a("a"),fc=n("TFGPTJModel"),gc=n(" forward method, overrides the "),Ma=a("code"),_c=n("__call__"),Tc=n(" special method."),vc=l(),y(co.$$.fragment),yc=l(),qa=a("p"),kc=n("Example:"),wc=l(),y(vn.$$.fragment),Vr=l(),Lt=a("h2"),po=a("a"),Ca=a("span"),y(yn.$$.fragment),bc=l(),za=a("span"),Pc=n("TFGPTJForCausalLM"),Kr=l(),Ee=a("div"),y(kn.$$.fragment),$c=l(),Aa=a("p"),Fc=n("The GPT-J Model transformer with a language modeling head on top."),jc=l(),wn=a("p"),Gc=n("This model inherits from "),js=a("a"),Ec=n("TFPreTrainedModel"),Jc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xc=l(),bn=a("p"),Mc=n("This model is also a "),Pn=a("a"),qc=n("tf.keras.Model"),Cc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zc=l(),y(ho.$$.fragment),Ac=l(),Ue=a("div"),y($n.$$.fragment),Ic=l(),Nt=a("p"),Lc=n("The "),Gs=a("a"),Nc=n("TFGPTJForCausalLM"),Sc=n(" forward method, overrides the "),Ia=a("code"),Dc=n("__call__"),Oc=n(" special method."),Wc=l(),y(uo.$$.fragment),Bc=l(),La=a("p"),Uc=n("Example:"),Qc=l(),y(Fn.$$.fragment),Xr=l(),St=a("h2"),mo=a("a"),Na=a("span"),y(jn.$$.fragment),Hc=l(),Sa=a("span"),Rc=n("TFGPTJForSequenceClassification"),Yr=l(),ae=a("div"),y(Gn.$$.fragment),Vc=l(),Da=a("p"),Kc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Xc=l(),Es=a("p"),Js=a("a"),Yc=n("GPTJForSequenceClassification"),Zc=n(` uses the last token in order to do the classification, as other causal models
...
padding tokens when `),Ba=a("code"),rp=n("inputs_embeds"),ip=n(" are passed instead of "),Ua=a("code"),lp=n("input_ids"),dp=n(`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp=l(),y(fo.$$.fragment),vp=l(),qe=a("div"),y(Mn.$$.fragment),yp=l(),Dt=a("p"),kp=n("The "),Ms=a("a"),wp=n("TFGPTJForSequenceClassification"),bp=n(" forward method, overrides the "),Qa=a("code"),Pp=n("__call__"),$p=n(" special method."),Fp=l(),y(go.$$.fragment),jp=l(),Ha=a("p"),Gp=n("Example:"),Ep=l(),y(qn.$$.fragment),Jp=l(),y(Cn.$$.fragment),Zr=l(),Ot=a("h2"),_o=a("a"),Ra=a("span"),y(zn.$$.fragment),xp=l(),Va=a("span"),Mp=n("TFGPTJForQuestionAnswering"),ei=l(),Je=a("div"),y(An.$$.fragment),qp=l(),Wt=a("p"),Cp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wp=l(),Ln=a("p"),Bp=n("This model is also a "),Nn=a("a"),Up=n("tf.keras.Model"),Qp=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp=l(),y(To.$$.fragment),Rp=l(),Ce=a("div"),y(Sn.$$.fragment),Vp=l(),Bt=a("p"),Kp=n("The "),Cs=a("a"),Xp=n("TFGPTJForQuestionAnswering"),Yp=n(" forward method, overrides the "),Ya=a("code"),Zp=n("__call__"),eh=n(" special method."),th=l(),y(vo.$$.fragment),oh=l(),Za=a("p"),nh=n("Example:"),sh=l(),y(Dn.$$.fragment),ah=l(),y(On.$$.fragment),ti=l(),Ut=a("h2"),yo=a("a"),er=a("span"),y(Wn.$$.fragment),rh=l(),tr=a("span"),ih=n("FlaxGPTJModel"),oi=l(),be=a("div"),y(Bn.$$.fragment),lh=l(),or=a("p"),dh=n("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),ch=l(),Un=a("p"),ph=n("This model inherits from "),zs=a("a"),hh=n("FlaxPreTrainedModel"),uh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mh=l(),Qn=a("p"),fh=n(`This model is also a Flax Linen
`),Hn=a("a"),gh=n("flax.nn.Module"),_h=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Th=l(),nr=a("p"),vh=n("Finally, this model supports inherent JAX features such as:"),yh=l(),ut=a("ul"),sr=a("li"),Rn=a("a"),kh=n("Just-In-Time (JIT) compilation"),wh=l(),ar=a("li"),Vn=a("a"),bh=n("Automatic Differentiation"),Ph=l(),rr=a("li"),Kn=a("a"),$h=n("Vectorization"),Fh=l(),ir=a("li"),Xn=a("a"),jh=n("Parallelization"),Gh=l(),Qe=a("div"),y(Yn.$$.fragment),Eh=l(),Qt=a("p"),Jh=n("The "),lr=a("code"),xh=n("FlaxGPTJPreTrainedModel"),Mh=n("forward method, overrides the "),dr=a("code"),qh=n("__call__"),Ch=n(" special method."),zh=l(),y(ko.$$.fragment),Ah=l(),cr=a("p"),Ih=n("Example:"),Lh=l(),y(Zn.$$.fragment),ni=l(),Ht=a("h2"),wo=a("a"),pr=a("span"),y(es.$$.fragment),Nh=l(),hr=a("span"),Sh=n("FlaxGPTJForCausalLM"),si=l(),Pe=a("div"),y(ts.$$.fragment),Dh=l(),ur=a("p"),Oh=n("The GPTJ Model transformer with a language modeling head on top."),Wh=l(),os=a("p"),Bh=n("This model inherits from "),As=a("a"),Uh=n("FlaxPreTrainedModel"),Qh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
causal language model trained on `),x=r(Vt,"A",{href:!0,rel:!0});var Er=i(x);ge=s(Er,"the Pile"),Er.forEach(t),Q=s(Vt," dataset."),Vt.forEach(t),le=d(o),Y=r(o,"P",{});var us=i(Y);H=s(us,"This model was contributed by "),oe=r(us,"A",{href:!0,rel:!0});var Jr=i(oe);_e=s(Jr,"Stella Biderman"),Jr.forEach(t),M=s(us,"."),us.forEach(t),de=d(o),N=r(o,"P",{});var xr=i(N);Te=s(xr,"Tips:"),xr.forEach(t),ce=d(o),S=r(o,"UL",{});var ku=i(S);B=r(ku,"LI",{});var ft=i(B);ve=s(ft,"To load "),q=r(ft,"A",{href:!0,rel:!0});var wu=i(q);ye=s(wu,"GPT-J"),wu.forEach(t),R=s(ft,` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
...
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),ft.forEach(t),ku.forEach(t),xe=d(o),k(z.$$.fragment,o),U=d(o),pe=r(o,"UL",{});var ri=i(pe);Fe=r(ri,"LI",{});var Fu=i(Fe);D=r(Fu,"P",{});var Tu=i(D);Se=s(Tu,`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
optimizer for example makes four copies of the model: model, gradients, average and squared average of the gradients.
So it would need at least 4x model size GPU memory, even with mixed precision as gradient updates are in fp32. This
is not including the activations and data batches, which would again require some more GPU RAM. So one should explore
solutions such as DeepSpeed, to train/fine-tune the model. Another option is to use the original codebase to
...
`),Xs=r(Po,"CODE",{});var Ju=i(Xs);Ni=s(Ju,"<|extratoken_1|>... <|extratoken_143|>"),Ju.forEach(t),Si=s(Po,", so the "),Ys=r(Po,"CODE",{});var xu=i(Ys);Di=s(xu,"vocab_size"),xu.forEach(t),Oi=s(Po," of tokenizer also becomes 50400."),Po.forEach(t),Gu.forEach(t),ri.forEach(t),Mr=d(o),$t=r(o,"H3",{class:!0});var ii=i($t);Kt=r(ii,"A",{id:!0,class:!0,href:!0});var Mu=i(Kt);Zs=r(Mu,"SPAN",{});var qu=i(Zs);k(xo.$$.fragment,qu),qu.forEach(t),Mu.forEach(t),Wi=d(ii),ea=r(ii,"SPAN",{});var Cu=i(ea);Bi=s(Cu,"Generation"),Cu.forEach(t),ii.forEach(t),qr=d(o),Xt=r(o,"P",{});var li=i(Xt);Ui=s(li,"The "),ms=r(li,"A",{href:!0});var zu=i(ms);Qi=s(zu,"generate()"),zu.forEach(t),Hi=s(li,` method can be used to generate text using GPT-J
...
for more information.`),gt.forEach(t),il=d($o),na=r($o,"P",{});var Bu=i(na);ll=s(Bu,"Example:"),Bu.forEach(t),dl=d($o),k(Io.$$.fragment,$o),$o.forEach(t),Nr=d(o),jt=r(o,"H2",{class:!0});var ci=i(jt);Zt=r(ci,"A",{id:!0,class:!0,href:!0});var Uu=i(Zt);sa=r(Uu,"SPAN",{});var Qu=i(sa);k(Lo.$$.fragment,Qu),Qu.forEach(t),Uu.forEach(t),cl=d(ci),aa=r(ci,"SPAN",{});var Hu=i(aa);pl=s(Hu,"GPTJModel"),Hu.forEach(t),ci.forEach(t),Sr=d(o),ht=r(o,"DIV",{class:!0});var Is=i(ht);k(No.$$.fragment,Is),hl=d(Is),So=r(Is,"P",{});var pi=i(So);ul=s(pi,`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Do=r(pi,"A",{href:!0,rel:!0});var Ru=i(Do);ml=s(Ru,"torch.nn.Module"),Ru.forEach(t),fl=s(pi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),pi.forEach(t),gl=d(Is),Oe=r(Is,"DIV",{class:!0});var _t=i(Oe);k(Oo.$$.fragment,_t),_l=d(_t),Gt=r(_t,"P",{});var Ls=i(Gt);Tl=s(Ls,"The "),vs=r(Ls,"A",{href:!0});var Vu=i(vs);vl=s(Vu,"GPTJModel"),Vu.forEach(t),yl=s(Ls," forward method, overrides the "),ra=r(Ls,"CODE",{});var Ku=i(ra);kl=s(Ku,"__call__"),Ku.forEach(t),wl=s(Ls," special method."),Ls.forEach(t),bl=d(_t),k(eo.$$.fragment,_t),Pl=d(_t),ia=r(_t,"P",{});var Xu=i(ia);$l=s(Xu,"Example:"),Xu.forEach(t),Fl=d(_t),k(Wo.$$.fragment,_t),_t.forEach(t),Is.forEach(t),Dr=d(o),Et=r(o,"H2",{class:!0});var hi=i(Et);to=r(hi,"A",{id:!0,class:!0,href:!0});var Yu=i(to);la=r(Yu,"SPAN",{});var Zu=i(la);k(Bo.$$.fragment,Zu),Zu.forEach(t),Yu.forEach(t),jl=d(hi),da=r(hi,"SPAN",{});var em=i(da);Gl=s(em,"GPTJForCausalLM"),em.forEach(t),hi.forEach(t),Or=d(o),et=r(o,"DIV",{class:!0});var Fo=i(et);k(Uo.$$.fragment,Fo),El=d(Fo),ca=r(Fo,"P",{});var tm=i(ca);Jl=s(tm,"The GPT-J Model transformer with a language modeling head on top."),tm.forEach(t),xl=d(Fo),Qo=r(Fo,"P",{});var ui=i(Qo);Ml=s(ui,"This model is a PyTorch "),Ho=r(ui,"A",{href:!0,rel:!0});var om=i(Ho);ql=s(om,"torch.nn.Module"),om.forEach(t),Cl=s(ui,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ui.forEach(t),zl=d(Fo),We=r(Fo,"DIV",{class:!0});var Tt=i(We);k(Ro.$$.fragment,Tt),Al=d(Tt),Jt=r(Tt,"P",{});var Ns=i(Jt);Il=s(Ns,"The "),ys=r(Ns,"A",{href:!0});var nm=i(ys);Ll=s(nm,"GPTJForCausalLM"),nm.forEach(t),Nl=s(Ns," forward method, overrides the "),pa=r(Ns,"CODE",{});var sm=i(pa);Sl=s(sm,"__call__"),sm.forEach(t),Dl=s(Ns," special method."),Ns.forEach(t),Ol=d(Tt),k(oo.$$.fragment,Tt),Wl=d(Tt),ha=r(Tt,"P",{});var am=i(ha);Bl=s(am,"Example:"),am.forEach(t),Ul=d(Tt),k(Vo.$$.fragment,Tt),Tt.forEach(t),Fo.forEach(t),Wr=d(o),xt=r(o,"H2",{class:!0});var mi=i(xt);no=r(mi,"A",{id:!0,class:!0,href:!0});var rm=i(no);ua=r(rm,"SPAN",{});var im=i(ua);k(Ko.$$.fragment,im),im.forEach(t),rm.forEach(t),Ql=d(mi),ma=r(mi,"SPAN",{});var lm=i(ma);Hl=s(lm,"GPTJForSequenceClassification"),lm.forEach(t),mi.forEach(t),Br=d(o),je=r(o,"DIV",{class:!0});var st=i(je);k(Xo.$$.fragment,st),Rl=d(st),fa=r(st,"P",{});var dm=i(fa);Vl=s(dm,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),dm.forEach(t),Kl=d(st),ks=r(st,"P",{});var vu=i(ks);ws=r(vu,"A",{href:!0});var cm=i(ws);Xl=s(cm,"GPTJForSequenceClassification"),cm.forEach(t),Yl=s(vu,` uses the last token in order to do the classification, as other causal models
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_i.forEach(t),Dd=d(jo),Me=r(jo,"DIV",{class:!0});var at=i(Me);k(cn.$$.fragment,at),Od=d(at),zt=r(at,"P",{});var Os=i(zt);Wd=s(Os,"The "),Ps=r(Os,"A",{href:!0});var Fm=i(Ps);Bd=s(Fm,"GPTJForQuestionAnswering"),Fm.forEach(t),Ud=s(Os," forward method, overrides the "),ja=r(Os,"CODE",{});var jm=i(ja);Qd=s(jm,"__call__"),jm.forEach(t),Hd=s(Os," special method."),Os.forEach(t),Rd=d(at),k(ro.$$.fragment,at),Vd=d(at),Ga=r(at,"P",{});var Gm=i(Ga);Kd=s(Gm,"Example:"),Gm.forEach(t),Xd=d(at),k(pn.$$.fragment,at),Yd=d(at),k(hn.$$.fragment,at),at.forEach(t),jo.forEach(t),Hr=d(o),At=r(o,"H2",{class:!0});var Ti=i(At);io=r(Ti,"A",{id:!0,class:!0,href:!0});var Em=i(io);Ea=r(Em,"SPAN",{});var Jm=i(Ea);k(un.$$.fragment,Jm),Jm.forEach(t),Em.forEach(t),Zd=d(Ti),Ja=r(Ti,"SPAN",{});var xm=i(Ja);ec=s(xm,"TFGPTJModel"),xm.forEach(t),Ti.forEach(t),Rr=d(o),Ge=r(o,"DIV",{class:!0});var rt=i(Ge);k(mn.$$.fragment,rt),tc=d(rt),xa=r(rt,"P",{});var Mm=i(xa);oc=s(Mm,"The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Mm.forEach(t),nc=d(rt),fn=r(rt,"P",{});var vi=i(fn);sc=s(vi,"This model inherits from "),$s=r(vi,"A",{href:!0});var qm=i($s);ac=s(qm,"TFPreTrainedModel"),qm.forEach(t),rc=s(vi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vi.forEach(t),ic=d(rt),gn=r(rt,"P",{});var yi=i(gn);lc=s(yi,"This model is also a "),_n=r(yi,"A",{href:!0,rel:!0});var Cm=i(_n);dc=s(Cm,"tf.keras.Model"),Cm.forEach(t),cc=s(yi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yi.forEach(t),pc=d(rt),k(lo.$$.fragment,rt),hc=d(rt),Be=r(rt,"DIV",{class:!0});var yt=i(Be);k(Tn.$$.fragment,yt),uc=d(yt),It=r(yt,"P",{});var Ws=i(It);mc=s(Ws,"The "),Fs=r(Ws,"A",{href:!0});var zm=i(Fs);fc=s(zm,"TFGPTJModel"),zm.forEach(t),gc=s(Ws," forward method, overrides the "),Ma=r(Ws,"CODE",{});var Am=i(Ma);_c=s(Am,"__call__"),Am.forEach(t),Tc=s(Ws," special method."),Ws.forEach(t),vc=d(yt),k(co.$$.fragment,yt),yc=d(yt),qa=r(yt,"P",{});var Im=i(qa);kc=s(Im,"Example:"),Im.forEach(t),wc=d(yt),k(vn.$$.fragment,yt),yt.forEach(t),rt.forEach(t),Vr=d(o),Lt=r(o,"H2",{class:!0});var ki=i(Lt);po=r(ki,"A",{id:!0,class:!0,href:!0});var Lm=i(po);Ca=r(Lm,"SPAN",{});var Nm=i(Ca);k(yn.$$.fragment,Nm),Nm.forEach(t),Lm.forEach(t),bc=d(ki),za=r(ki,"SPAN",{});var Sm=i(za);Pc=s(Sm,"TFGPTJForCausalLM"),Sm.forEach(t),ki.forEach(t),Kr=d(o),Ee=r(o,"DIV",{class:!0});var it=i(Ee);k(kn.$$.fragment,it),$c=d(it),Aa=r(it,"P",{});var Dm=i(Aa);Fc=s(Dm,"The GPT-J Model transformer with a language modeling head on top."),Dm.forEach(t),jc=d(it),wn=r(it,"P",{});var wi=i(wn);Gc=s(wi,"This model inherits from "),js=r(wi,"A",{href:!0});var Om=i(js);Ec=s(Om,"TFPreTrainedModel"),Om.forEach(t),Jc=s(wi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wi.forEach(t),xc=d(it),bn=r(it,"P",{});var bi=i(bn);Mc=s(bi,"This model is also a "),Pn=r(bi,"A",{href:!0,rel:!0});var Wm=i(Pn);qc=s(Wm,"tf.keras.Model"),Wm.forEach(t),Cc=s(bi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bi.forEach(t),zc=d(it),k(ho.$$.fragment,it),Ac=d(it),Ue=r(it,"DIV",{class:!0});var kt=i(Ue);k($n.$$.fragment,kt),Ic=d(kt),Nt=r(kt,"P",{});var Bs=i(Nt);Lc=s(Bs,"The "),Gs=r(Bs,"A",{href:!0});var Bm=i(Gs);Nc=s(Bm,"TFGPTJForCausalLM"),Bm.forEach(t),Sc=s(Bs," forward method, overrides the "),Ia=r(Bs,"CODE",{});var Um=i(Ia);Dc=s(Um,"__call__"),Um.forEach(t),Oc=s(Bs," special method."),Bs.forEach(t),Wc=d(kt),k(uo.$$.fragment,kt),Bc=d(kt),La=r(kt,"P",{});var Qm=i(La);Uc=s(Qm,"Example:"),Qm.forEach(t),Qc=d(kt),k(Fn.$$.fragment,kt),kt.forEach(t),it.forEach(t),Xr=d(o),St=r(o,"H2",{class:!0});var Pi=i(St);mo=r(Pi,"A",{id:!0,class:!0,href:!0});var Hm=i(mo);Na=r(Hm,"SPAN",{});var Rm=i(Na);k(jn.$$.fragment,Rm),Rm.forEach(t),Hm.forEach(t),Hc=d(Pi),Sa=r(Pi,"SPAN",{});var Vm=i(Sa);Rc=s(Vm,"TFGPTJForSequenceClassification"),Vm.forEach(t),Pi.forEach(t),Yr=d(o),ae=r(o,"DIV",{class:!0});var ze=i(ae);k(Gn.$$.fragment,ze),Vc=d(ze),Da=r(ze,"P",{});var Km=i(Da);Kc=s(Km,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Km.forEach(t),Xc=d(ze),Es=r(ze,"P",{});var yu=i(Es);Js=r(yu,"A",{href:!0});var Xm=i(Js);Yc=s(Xm,"GPTJForSequenceClassification"),Xm.forEach(t),Zc=s(yu,` uses the last token in order to do the classification, as other causal models
(e.g. GPT, GPT-2, GPT-Neo) do.`),yu.forEach(t),ep=d(ze),nt=r(ze,"P",{});var wt=i(nt);tp=s(wt,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
padding tokens when `),Ba=r(wt,"CODE",{});var ef=i(Ba);rp=s(ef,"inputs_embeds"),ef.forEach(t),ip=s(wt," are passed instead of "),Ua=r(wt,"CODE",{});var tf=i(Ua);lp=s(tf,"input_ids"),tf.forEach(t),dp=s(wt,`, it does the same (take the last value in
each row of the batch).`),wt.forEach(t),cp=d(ze),En=r(ze,"P",{});var $i=i(En);pp=s($i,"This model inherits from "),xs=r($i,"A",{href:!0});var of=i(xs);hp=s(of,"TFPreTrainedModel"),of.forEach(t),up=s($i,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$i.forEach(t),mp=d(ze),Jn=r(ze,"P",{});var Fi=i(Jn);fp=s(Fi,"This model is also a "),xn=r(Fi,"A",{href:!0,rel:!0});var nf=i(xn);gp=s(nf,"tf.keras.Model"),nf.forEach(t),_p=s(Fi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),Tp=d(ze),k(fo.$$.fragment,ze),vp=d(ze),qe=r(ze,"DIV",{class:!0});var lt=i(qe);k(Mn.$$.fragment,lt),yp=d(lt),Dt=r(lt,"P",{});var Us=i(Dt);kp=s(Us,"The "),Ms=r(Us,"A",{href:!0});var sf=i(Ms);wp=s(sf,"TFGPTJForSequenceClassification"),sf.forEach(t),bp=s(Us," forward method, overrides the "),Qa=r(Us,"CODE",{});var af=i(Qa);Pp=s(af,"__call__"),af.forEach(t),$p=s(Us," special method."),Us.forEach(t),Fp=d(lt),k(go.$$.fragment,lt),jp=d(lt),Ha=r(lt,"P",{});var rf=i(Ha);Gp=s(rf,"Example:"),rf.forEach(t),Ep=d(lt),k(qn.$$.fragment,lt),Jp=d(lt),k(Cn.$$.fragment,lt),lt.forEach(t),ze.forEach(t),Zr=d(o),Ot=r(o,"H2",{class:!0});var ji=i(Ot);_o=r(ji,"A",{id:!0,class:!0,href:!0});var lf=i(_o);Ra=r(lf,"SPAN",{});var df=i(Ra);k(zn.$$.fragment,df),df.forEach(t),lf.forEach(t),xp=d(ji),Va=r(ji,"SPAN",{});var cf=i(Va);Mp=s(cf,"TFGPTJForQuestionAnswering"),cf.forEach(t),ji.forEach(t),ei=d(o),Je=r(o,"DIV",{class:!0});var dt=i(Je);k(An.$$.fragment,dt),qp=d(dt),Wt=r(dt,"P",{});var Qs=i(Wt);Cp=s(Qs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Ka=r(Qs,"CODE",{});var pf=i(Ka);zp=s(pf,"span start logits"),pf.forEach(t),Ap=s(Qs," and "),Xa=r(Qs,"CODE",{});var hf=i(Xa);Ip=s(hf,"span end logits"),hf.forEach(t),Lp=s(Qs,")."),Qs.forEach(t),Np=d(dt),In=r(dt,"P",{});var Gi=i(In);Sp=s(Gi,"This model inherits from "),qs=r(Gi,"A",{href:!0});var uf=i(qs);Dp=s(uf,"TFPreTrainedModel"),uf.forEach(t),Op=s(Gi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gi.forEach(t),Wp=d(dt),Ln=r(dt,"P",{});var Ei=i(Ln);Bp=s(Ei,"This model is also a "),Nn=r(Ei,"A",{href:!0,rel:!0});var mf=i(Nn);Up=s(mf,"tf.keras.Model"),mf.forEach(t),Qp=s(Ei,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Hp=d(dt),k(To.$$.fragment,dt),Rp=d(dt),Ce=r(dt,"DIV",{class:!0});var ct=i(Ce);k(Sn.$$.fragment,ct),Vp=d(ct),Bt=r(ct,"P",{});var Hs=i(Bt);Kp=s(Hs,"The "),Cs=r(Hs,"A",{href:!0});var ff=i(Cs);Xp=s(ff,"TFGPTJForQuestionAnswering"),ff.forEach(t),Yp=s(Hs," forward method, overrides the "),Ya=r(Hs,"CODE",{});var gf=i(Ya);Zp=s(gf,"__call__"),gf.forEach(t),eh=s(Hs," special method."),Hs.forEach(t),th=d(ct),k(vo.$$.fragment,ct),oh=d(ct),Za=r(ct,"P",{});var _f=i(Za);nh=s(_f,"Example:"),_f.forEach(t),sh=d(ct),k(Dn.$$.fragment,ct),ah=d(ct),k(On.$$.fragment,ct),ct.forEach(t),dt.forEach(t),ti=d(o),Ut=r(o,"H2",{class:!0});var Ji=i(Ut);yo=r(Ji,"A",{id:!0,class:!0,href:!0});var Tf=i(yo);er=r(Tf,"SPAN",{});var vf=i(er);k(Wn.$$.fragment,vf),vf.forEach(t),Tf.forEach(t),rh=d(Ji),tr=r(Ji,"SPAN",{});var yf=i(tr);ih=s(yf,"FlaxGPTJModel"),yf.forEach(t),Ji.forEach(t),oi=d(o),be=r(o,"DIV",{class:!0});var Re=i(be);k(Bn.$$.fragment,Re),lh=d(Re),or=r(Re,"P",{});var kf=i(or);dh=s(kf,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),kf.forEach(t),ch=d(Re),Un=r(Re,"P",{});var xi=i(Un);ph=s(xi,"This model inherits from "),zs=r(xi,"A",{href:!0});var wf=i(zs);hh=s(wf,"FlaxPreTrainedModel"),wf.forEach(t),uh=s(xi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zi.forEach(t),Xh=d(Ve),mr=r(Ve,"P",{});var Of=i(mr);Yh=s(Of,"Finally, this model supports inherent JAX features such as:"),Of.forEach(t),Zh=d(Ve),mt=r(Ve,"UL",{});var Eo=i(mt);fr=r(Eo,"LI",{});var Wf=i(fr);as=r(Wf,"A",{href:!0,rel:!0});var Bf=i(as);eu=s(Bf,"Just-In-Time (JIT) compilation"),Bf.forEach(t),Wf.forEach(t),tu=d(Eo),gr=r(Eo,"LI",{});var Uf=i(gr);rs=r(Uf,"A",{href:!0,rel:!0});var Qf=i(rs);ou=s(Qf,"Automatic Differentiation"),Qf.forEach(t),Uf.forEach(t),nu=d(Eo),_r=r(Eo,"LI",{});var Hf=i(_r);is=r(Hf,"A",{href:!0,rel:!0});var Rf=i(is);su=s(Rf,"Vectorization"),Rf.forEach(t),Hf.forEach(t),au=d(Eo),Tr=r(Eo,"LI",{});var Vf=i(Tr);ls=r(Vf,"A",{href:!0,rel:!0});var Kf=i(ls);ru=s(Kf,"Parallelization"),Kf.forEach(t),Vf.forEach(t),Eo.forEach(t),iu=d(Ve),He=r(Ve,"DIV",{class:!0});var Pt=i(He);k(ds.$$.fragment,Pt),lu=d(Pt),Rt=r(Pt,"P",{});var Vs=i(Rt);du=s(Vs,"The "),vr=r(Vs,"CODE",{});var Xf=i(vr);cu=s(Xf,"FlaxGPTJPreTrainedModel"),Xf.forEach(t),pu=s(Vs,"forward method, overrides the "),yr=r(Vs,"CODE",{});var Yf=i(yr);hu=s(Yf,"__call__"),Yf.forEach(t),uu=s(Vs," special method."),Vs.forEach(t),mu=d(Pt),k(bo.$$.fragment,Pt),fu=d(Pt),kr=r(Pt,"P",{});var Zf=i(kr);gu=s(Zf,"Example:"),Zf.forEach(t),_u=d(Pt),k(cs.$$.fragment,Pt),Pt.forEach(t),Ve.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(yg)),c(_,"id","gptj"),c(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_,"href","#gptj"),c(f,"class","relative group"),c(X,"id","overview"),c(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(X,"href","#overview"),c(E,"class","relative group"),c(ee,"href","https://github.com/kingoflolz/mesh-transformer-jax"),c(ee,"rel","nofollow"),c(x,"href","https://pile.eleuther.ai/"),c(x,"rel","nofollow"),c(oe,"href","https://huggingface.co/stellaathena"),c(oe,"rel","nofollow"),c(q,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(q,"rel","nofollow"),c(C,"href","https://huggingface.co/EleutherAI/gpt-j-6B/tree/float16"),c(C,"rel","nofollow"),c(ke,"href","https://github.com/kingoflolz/mesh-transformer-jax/blob/master/howto_finetune.md"),c(ke,"rel","nofollow"),c(Jo,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Jo,"rel","nofollow"),c(Kt,"id","generation"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#generation"),c($t,"class","relative group"),c(ms,"href","/docs/transformers/pr_14549/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(Yt,"id","transformers.GPTJConfig"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.GPTJConfig"),c(Ft,"class","relative group"),c(gs,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJModel"),c(Ao,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Ao,"rel","nofollow"),c(_s,"href","/docs/transformers/pr_14549/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ts,"href","/docs/transformers/pr_14549/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ye,"class","docstring"),c(Zt,"id","transformers.GPTJModel"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.GPTJModel"),c(jt,"class","relative group"),c(Do,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Do,"rel","nofollow"),c(vs,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJModel"),c(Oe,"class","docstring"),c(ht,"class","docstring"),c(to,"id","transformers.GPTJForCausalLM"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.GPTJForCausalLM"),c(Et,"class","relative group"),c(Ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ho,"rel","nofollow"),c(ys,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJForCausalLM"),c(We,"class","docstring"),c(et,"class","docstring"),c(no,"id","transformers.GPTJForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.GPTJForSequenceClassification"),c(xt,"class","relative group"),c(ws,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(Zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Zo,"rel","nofollow"),c(bs,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(ne,"class","docstring"),c(je,"class","docstring"),c(ao,"id","transformers.GPTJForQuestionAnswering"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.GPTJForQuestionAnswering"),c(qt,"class","relative group"),c(dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(dn,"rel","nofollow"),c(Ps,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJForQuestionAnswering"),c(Me,"class","docstring"),c(ot,"class","docstring"),c(io,"id","transformers.TFGPTJModel"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.TFGPTJModel"),c(At,"class","relative group"),c($s,"href","/docs/transformers/pr_14549/en/main_classes/model#transformers.TFPreTrainedModel"),c(_n,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(_n,"rel","nofollow"),c(Fs,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.TFGPTJModel"),c(Be,"class","docstring"),c(Ge,"class","docstring"),c(po,"id","transformers.TFGPTJForCausalLM"),c(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(po,"href","#transformers.TFGPTJForCausalLM"),c(Lt,"class","relative group"),c(js,"href","/docs/transformers/pr_14549/en/main_classes/model#transformers.TFPreTrainedModel"),c(Pn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Pn,"rel","nofollow"),c(Gs,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.TFGPTJForCausalLM"),c(Ue,"class","docstring"),c(Ee,"class","docstring"),c(mo,"id","transformers.TFGPTJForSequenceClassification"),c(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(mo,"href","#transformers.TFGPTJForSequenceClassification"),c(St,"class","relative group"),c(Js,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(xs,"href","/docs/transformers/pr_14549/en/main_classes/model#transformers.TFPreTrainedModel"),c(xn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(xn,"rel","nofollow"),c(Ms,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.TFGPTJForSequenceClassification"),c(qe,"class","docstring"),c(ae,"class","docstring"),c(_o,"id","transformers.TFGPTJForQuestionAnswering"),c(_o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_o,"href","#transformers.TFGPTJForQuestionAnswering"),c(Ot,"class","relative group"),c(qs,"href","/docs/transformers/pr_14549/en/main_classes/model#transformers.TFPreTrainedModel"),c(Nn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Nn,"rel","nofollow"),c(Cs,"href","/docs/transformers/pr_14549/en/model_doc/gptj#transformers.TFGPTJForQuestionAnswering"),c(Ce,"class","docstring"),c(Je,"class","docstring"),c(yo,"id","transformers.FlaxGPTJModel"),c(yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(yo,"href","#transformers.FlaxGPTJModel"),c(Ut,"class","relative group"),c(zs,"href","/docs/transformers/pr_14549/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Hn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Hn,"rel","nofollow"),c(Rn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Rn,"rel","nofollow"),c(Vn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Vn,"rel","nofollow"),c(Kn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Kn,"rel","nofollow"),c(Xn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Xn,"rel","nofollow"),c(Qe,"class","docstring"),c(be,"class","docstring"),c(wo,"id","transformers.FlaxGPTJForCausalLM"),c(wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(wo,"href","#transformers.FlaxGPTJForCausalLM"),c(Ht,"class","relative group"),c(As,"href","/docs/transformers/pr_14549/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(ss,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(ss,"rel","nofollow"),c(as,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(as,"rel","nofollow"),c(rs,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(rs,"rel","nofollow"),c(is,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(is,"rel","nofollow"),c(ls,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(ls,"rel","nofollow"),c(He,"class","docstring"),c(Pe,"class","docstring")},m(o,m){e(document.head,p),u(o,F,m),u(o,f,m),e(f,_),e(_,v),w(T,v,null),e(f,g),e(f,j),e(j,ue),u(o,K,m),u(o,E,m),e(E,X),e(X,O),w(Z,O,null),e(E,me),e(E,W),e(W,fe),u(o,ie,m),u(o,L,m),e(L,A),e(L,ee),e(ee,te),e(L,J),e(L,x),e(x,ge),e(L,Q),u(o,le,m),u(o,Y,m),e(Y,H),e(Y,oe),e(oe,_e),e(Y,M),u(o,de,m),u(o,N,m),e(N,Te),u(o,ce,m),u(o,S,m),e(S,B),e(B,ve),e(B,q),e(q,ye),e(B,R),e(B,se),e(se,h),e(B,G),e(B,V),e(V,Ae),e(B,Ie),e(B,C),e(C,Le),e(B,Ne),u(o,xe,m),w(z,o,m),u(o,U,m),u(o,pe,m),e(pe,Fe),e(Fe,D),e(D,Se),e(D,ke),e(ke,we),e(pe,De),e(pe,Ks),e(Ks,pt),e(pt,Ai),e(pt,Jo),e(Jo,Ii),e(pt,Li),e(pt,Xs),e(Xs,Ni),e(pt,Si),e(pt,Ys),e(Ys,Di),e(pt,Oi),u(o,Mr,m),u(o,$t,m),e($t,Kt),e(Kt,Zs),w(xo,Zs,null),e($t,Wi),e($t,ea),e(ea,Bi),u(o,qr,m),u(o,Xt,m),e(Xt,Ui),e(Xt,ms),e(ms,Qi),e(Xt,Hi),u(o,Cr,m),w(Mo,o,m),u(o,zr,m),u(o,fs,m),e(fs,Ri),u(o,Ar,m),w(qo,o,m),u(o,Ir,m),u(o,Ft,m),e(Ft,Yt),e(Yt,ta),w(Co,ta,null),e(Ft,Vi),e(Ft,oa),e(oa,Ki),u(o,Lr,m),u(o,Ye,m),w(zo,Ye,null),e(Ye,Xi),e(Ye,Ze),e(Ze,Yi),e(Ze,gs),e(gs,Zi),e(Ze,el),e(Ze,Ao),e(Ao,tl),e(Ze,ol),e(Ze,_s),e(_s,nl),e(Ze,sl),e(Ze,Ts),e(Ts,al),e(Ze,rl),e(Ye,il),e(Ye,na),e(na,ll),e(Ye,dl),w(Io,Ye,null),u(o,Nr,m),u(o,jt,m),e(jt,Zt),e(Zt,sa),w(Lo,sa,null),e(jt,cl),e(jt,aa),e(aa,pl),u(o,Sr,m),u(o,ht,m),w(No,ht,null),e(ht,hl),e(ht,So),e(So,ul),e(So,Do),e(Do,ml),e(So,fl),e(ht,gl),e(ht,Oe),w(Oo,Oe,null),e(Oe,_l),e(Oe,Gt),e(Gt,Tl),e(Gt,vs),e(vs,vl),e(Gt,yl),e(Gt,ra),e(ra,kl),e(Gt,wl),e(Oe,bl),w(eo,Oe,null),e(Oe,Pl),e(Oe,ia),e(ia,$l),e(Oe,Fl),w(Wo,Oe,null),u(o,Dr,m),u(o,Et,m),e(Et,to),e(to,la),w(Bo,la,null),e(Et,jl),e(Et,da),e(da,Gl),u(o,Or,m),u(o,et,m),w(Uo,et,null),e(et,El),e(et,ca),e(ca,Jl),e(et,xl),e(et,Qo),e(Qo,Ml),e(Qo,Ho),e(Ho,ql),e(Qo,Cl),e(et,zl),e(et,We),w(Ro,We,null),e(We,Al),e(We,Jt),e(Jt,Il),e(Jt,ys),e(ys,Ll),e(Jt,Nl),e(Jt,pa),e(pa,Sl),e(Jt,Dl),e(We,Ol),w(oo,We,null),e(We,Wl),e(We,ha),e(ha,Bl),e(We,Ul),w(Vo,We,null),u(o,Wr,m),u(o,xt,m),e(xt,no),e(no,ua),w(Ko,ua,null),e(xt,Ql),e(xt,ma),e(ma,Hl),u(o,Br,m),u(o,je,m),w(Xo,je,null),e(je,Rl),e(je,fa),e(fa,Vl),e(je,Kl),e(je,ks),e(ks,ws),e(ws,Xl),e(ks,Yl),e(je,Zl),e(je,tt),e(tt,ed),e(tt,ga),e(ga,td),e(tt,od),e(tt,_a),e(_a,nd),e(tt,sd),e(tt,Ta),e(Ta,ad),e(tt,rd),e(tt,va),e(va,id),e(tt,ld),e(je,dd),e(je,Yo),e(Yo,cd),e(Yo,Zo),e(Zo,pd),e(Yo,hd),e(je,ud),e(je,ne),w(en,ne,null),e(ne,md),e(ne,Mt),e(Mt,fd),e(Mt,bs),e(bs,gd),e(Mt,_d),e(Mt,ya),e(ya,Td),e(Mt,vd),e(ne,yd),w(so,ne,null),e(ne,kd),e(ne,ka),e(ka,wd),e(ne,bd),w(tn,ne,null),e(ne,Pd),w(on,ne,null),e(ne,$d),e(ne,wa),e(wa,Fd),e(ne,jd),w(nn,ne,null),e(ne,Gd),w(sn,ne,null),u(o,Ur,m),u(o,qt,m),e(qt,ao),e(ao,ba),w(an,ba,null),e(qt,Ed),e(qt,Pa),e(Pa,Jd),u(o,Qr,m),u(o,ot,m),w(rn,ot,null),e(ot,xd),e(ot,Ct),e(Ct,Md),e(Ct,$a),e($a,qd),e(Ct,Cd),e(Ct,Fa),e(Fa,zd),e(Ct,Ad),e(ot,Id),e(ot,ln),e(ln,Ld),e(ln,dn),e(dn,Nd),e(ln,Sd),e(ot,Dd),e(ot,Me),w(cn,Me,null),e(Me,Od),e(Me,zt),e(zt,Wd),e(zt,Ps),e(Ps,Bd),e(zt,Ud),e(zt,ja),e(ja,Qd),e(zt,Hd),e(Me,Rd),w(ro,Me,null),e(Me,Vd),e(Me,Ga),e(Ga,Kd),e(Me,Xd),w(pn,Me,null),e(Me,Yd),w(hn,Me,null),u(o,Hr,m),u(o,At,m),e(At,io),e(io,Ea),w(un,Ea,null),e(At,Zd),e(At,Ja),e(Ja,ec),u(o,Rr,m),u(o,Ge,m),w(mn,Ge,null),e(Ge,tc),e(Ge,xa),e(xa,oc),e(Ge,nc),e(Ge,fn),e(fn,sc),e(fn,$s),e($s,ac),e(fn,rc),e(Ge,ic),e(Ge,gn),e(gn,lc),e(gn,_n),e(_n,dc),e(gn,cc),e(Ge,pc),w(lo,Ge,null),e(Ge,hc),e(Ge,Be),w(Tn,Be,null),e(Be,uc),e(Be,It),e(It,mc),e(It,Fs),e(Fs,fc),e(It,gc),e(It,Ma),e(Ma,_c),e(It,Tc),e(Be,vc),w(co,Be,null),e(Be,yc),e(Be,qa),e(qa,kc),e(Be,wc),w(vn,Be,null),u(o,Vr,m),u(o,Lt,m),e(Lt,po),e(po,Ca),w(yn,Ca,null),e(Lt,bc),e(Lt,za),e(za,Pc),u(o,Kr,m),u(o,Ee,m),w(kn,Ee,null),e(Ee,$c),e(Ee,Aa),e(Aa,Fc),e(Ee,jc),e(Ee,wn),e(wn,Gc),e(wn,js),e(js,Ec),e(wn,Jc),e(Ee,xc),e(Ee,bn),e(bn,Mc),e(bn,Pn),e(Pn,qc),e(bn,Cc),e(Ee,zc),w(ho,Ee,null),e(Ee,Ac),e(Ee,Ue),w($n,Ue,null),e(Ue,Ic),e(Ue,Nt),e(Nt,Lc),e(Nt,Gs),e(Gs,Nc),e(Nt,Sc),e(Nt,Ia),e(Ia,Dc),e(Nt,Oc),e(Ue,Wc),w(uo,Ue,null),e(Ue,Bc),e(Ue,La),e(La,Uc),e(Ue,Qc),w(Fn,Ue,null),u(o,Xr,m),u(o,St,m),e(St,mo),e(mo,Na),w(jn,Na,null),e(St,Hc),e(St,Sa),e(Sa,Rc),u(o,Yr,m),u(o,ae,m),w(Gn,ae,null),e(ae,Vc),e(ae,Da),e(Da,Kc),e(ae,Xc),e(ae,Es),e(Es,Js),e(Js,Yc),e(Es,Zc),e(ae,ep),e(ae,nt),e(nt,tp),e(nt,Oa),e(Oa,op),e(nt,np),e(nt,Wa),e(Wa,sp),e(nt,ap),e(nt,Ba),e(Ba,rp),e(nt,ip),e(nt,Ua),e(Ua,lp),e(nt,dp),e(ae,cp),e(ae,En),e(En,pp),e(En,xs),e(xs,hp),e(En,up),e(ae,mp),e(ae,Jn),e(Jn,fp),e(Jn,xn),e(xn,gp),e(Jn,_p),e(ae,Tp),w(fo,ae,null),e(ae,vp),e(ae,qe),w(Mn,qe,null),e(qe,yp),e(qe,Dt),e(Dt,kp),e(Dt,Ms),e(Ms,wp),e(Dt,bp),e(Dt,Qa),e(Qa,Pp),e(Dt,$p),e(qe,Fp),w(go,qe,null),e(qe,jp),e(qe,Ha),e(Ha,Gp),e(qe,Ep),w(qn,qe,null),e(qe,Jp),w(Cn,qe,null),u(o,Zr,m),u(o,Ot,m),e(Ot,_o),e(_o,Ra),w(zn,Ra,null),e(Ot,xp),e(Ot,Va),e(Va,Mp),u(o,ei,m),u(o,Je,m),w(An,Je,null),e(Je,qp),e(Je,Wt),e(Wt,Cp),e(Wt,Ka),e(Ka,zp),e(Wt,Ap),e(Wt,Xa),e(Xa,Ip),e(Wt,Lp),e(Je,Np),e(Je,In),e(In,Sp),e(In,qs),e(qs,Dp),e(In,Op),e(Je,Wp),e(Je,Ln),e(Ln,Bp),e(Ln,Nn),e(Nn,Up),e(Ln,Qp),e(Je,Hp),w(To,Je,null),e(Je,Rp),e(Je,Ce),w(Sn,Ce,null),e(Ce,Vp),e(Ce,Bt),e(Bt,Kp),e(Bt,Cs),e(Cs,Xp),e(Bt,Yp),e(Bt,Ya),e(Ya,Zp),e(Bt,eh),e(Ce,th),w(vo,Ce,null),e(Ce,oh),e(Ce,Za),e(Za,nh),e(Ce,sh),w(Dn,Ce,null),e(Ce,ah),w(On,Ce,null),u(o,ti,m),u(o,Ut,m),e(Ut,yo),e(yo,er),w(Wn,er,null),e(Ut,rh),e(Ut,tr),e(tr,ih),u(o,oi,m),u(o,be,m),w(Bn,be,null),e(be,lh),e(be,or),e(or,dh),e(be,ch),e(be,Un),e(Un,ph),e(Un,zs),e(zs,hh),e(Un,uh),e(be,mh),e(be,Qn),e(Qn,fh),e(Qn,Hn),e(Hn,gh),e(Qn,_h),e(be,Th),e(be,nr),e(nr,vh),e(be,yh),e(be,ut),e(ut,sr),e(sr,Rn),e(Rn,kh),e(ut,wh),e(ut,ar),e(ar,Vn),e(Vn,bh),e(ut,Ph),e(ut,rr),e(rr,Kn),e(Kn,$h),e(ut,Fh),e(ut,ir),e(ir,Xn),e(Xn,jh),e(be,Gh),e(be,Qe),w(Yn,Qe,null),e(Qe,Eh),e(Qe,Qt),e(Qt,Jh),e(Qt,lr),e(lr,xh),e(Qt,Mh),e(Qt,dr),e(dr,qh),e(Qt,Ch),e(Qe,zh),w(ko,Qe,null),e(Qe,Ah),e(Qe,cr),e(cr,Ih),e(Qe,Lh),w(Zn,Qe,null),u(o,ni,m),u(o,Ht,m),e(Ht,wo),e(wo,pr),w(es,pr,null),e(Ht,Nh),e(Ht,hr),e(hr,Sh),u(o,si,m),u(o,Pe,m),w(ts,Pe,null),e(Pe,Dh),e(Pe,ur),e(ur,Oh),e(Pe,Wh),e(Pe,os),e(os,Bh),e(os,As),e(As,Uh),e(os,Qh),e(Pe,Hh),e(Pe,ns),e(ns,Rh),e(ns,ss),e(ss,Vh),e(ns,Kh),e(Pe,Xh),e(Pe,mr),e(mr,Yh),e(Pe,Zh),e(Pe,mt),e(mt,fr),e(fr,as),e(as,eu),e(mt,tu),e(mt,gr),e(gr,rs),e(rs,ou),e(mt,nu),e(mt,_r),e(_r,is),e(is,su),e(mt,au),e(mt,Tr),e(Tr,ls),e(ls,ru),e(Pe,iu),e(Pe,He),w(ds,He,null),e(He,lu),e(He,Rt),e(Rt,du),e(Rt,vr),e(vr,cu),e(Rt,pu),e(Rt,yr),e(yr,hu),e(Rt,uu),e(He,mu),w(bo,He,null),e(He,fu),e(He,kr),e(kr,gu),e(He,_u),w(cs,He,null),ai=!0},p(o,[m]){const ps={};m&2&&(ps.$$scope={dirty:m,ctx:o}),eo.$set(ps);const wr={};m&2&&(wr.$$scope={dirty:m,ctx:o}),oo.$set(wr);const br={};m&2&&(br.$$scope={dirty:m,ctx:o}),so.$set(br);const Pr={};m&2&&(Pr.$$scope={dirty:m,ctx:o}),ro.$set(Pr);const hs={};m&2&&(hs.$$scope={dirty:m,ctx:o}),lo.$set(hs);const $r={};m&2&&($r.$$scope={dirty:m,ctx:o}),co.$set($r);const Fr={};m&2&&(Fr.$$scope={dirty:m,ctx:o}),ho.$set(Fr);const jr={};m&2&&(jr.$$scope={dirty:m,ctx:o}),uo.$set(jr);const Vt={};m&2&&(Vt.$$scope={dirty:m,ctx:o}),fo.$set(Vt);const Gr={};m&2&&(Gr.$$scope={dirty:m,ctx:o}),go.$set(Gr);const Er={};m&2&&(Er.$$scope={dirty:m,ctx:o}),To.$set(Er);const us={};m&2&&(us.$$scope={dirty:m,ctx:o}),vo.$set(us);const Jr={};m&2&&(Jr.$$scope={dirty:m,ctx:o}),ko.$set(Jr);const xr={};m&2&&(xr.$$scope={dirty:m,ctx:o}),bo.$set(xr)},i(o){ai||(b(T.$$.fragment,o),b(Z.$$.fragment,o),b(z.$$.fragment,o),b(xo.$$.fragment,o),b(Mo.$$.fragment,o),b(qo.$$.fragment,o),b(Co.$$.fragment,o),b(zo.$$.fragment,o),b(Io.$$.fragment,o),b(Lo.$$.fragment,o),b(No.$$.fragment,o),b(Oo.$$.fragment,o),b(eo.$$.fragment,o),b(Wo.$$.fragment,o),b(Bo.$$.fragment,o),b(Uo.$$.fragment,o),b(Ro.$$.fragment,o),b(oo.$$.fragment,o),b(Vo.$$.fragment,o),b(Ko.$$.fragment,o),b(Xo.$$.fragment,o),b(en.$$.fragment,o),b(so.$$.fragment,o),b(tn.$$.fragment,o),b(on.$$.fragment,o),b(nn.$$.fragment,o),b(sn.$$.fragment,o),b(an.$$.fragment,o),b(rn.$$.fragment,o),b(cn.$$.fragment,o),b(ro.$$.fragment,o),b(pn.$$.fragment,o),b(hn.$$.fragment,o),b(un.$$.fragment,o),b(mn.$$.fragment,o),b(lo.$$.fragment,o),b(Tn.$$.fragment,o),b(co.$$.fragment,o),b(vn.$$.fragment,o),b(yn.$$.fragment,o),b(kn.$$.fragment,o),b(ho.$$.fragment,o),b($n.$$.fragment,o),b(uo.$$.fragment,o),b(Fn.$$.fragment,o),b(jn.$$.fragment,o),b(Gn.$$.fragment,o),b(fo.$$.fragment,o),b(Mn.$$.fragment,o),b(go.$$.fragment,o),b(qn.$$.fragment,o),b(Cn.$$.fragment,o),b(zn.$$.fragment,o),b(An.$$.fragment,o),b(To.$$.fragment,o),b(Sn.$$.fragment,o),b(vo.$$.fragment,o),b(Dn.$$.fragment,o),b(On.$$.fragment,o),b(Wn.$$.fragment,o),b(Bn.$$.fragment,o),b(Yn.$$.fragment,o),b(ko.$$.fragment,o),b(Zn.$$.fragment,o),b(es.$$.fragment,o),b(ts.$$.fragment,o),b(ds.$$.fragment,o),b(bo.$$.fragment,o),b(cs.$$.fragment,o),ai=!0)},o(o){P(T.$$.fragment,o),P(Z.$$.fragment,o),P(z.$$.fragment,o),P(xo.$$.fragment,o),P(Mo.$$.fragment,o),P(qo.$$.fragment,o),P(Co.$$.fragment,o),P(zo.$$.fragment,o),P(Io.$$.fragment,o),P(Lo.$$.fragment,o),P(No.$$.fragment,o),P(Oo.$$.fragment,o),P(eo.$$.fragment,o),P(Wo.$$.fragment,o),P(Bo.$$.fragment,o),P(Uo.$$.fragment,o),P(Ro.$$.fragment,o),P(oo.$$.fragment,o),P(Vo.$$.fragment,o),P(Ko.$$.fragment,o),P(Xo.$$.fragment,o),P(en.$$.fragment,o),P(so.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(sn.$$.fragment,o),P(an.$$.fragment,o),P(rn.$$.fragment,o),P(cn.$$.fragment,o),P(ro.$$.fragment,o),P(pn.$$.fragment,o),P(hn.$$.fragment,o),P(un.$$.fragment,o),P(mn.$$.fragment,o),P(lo.$$.fragment,o),P(Tn.$$.fragment,o),P(co.$$.fragment,o),P(vn.$$.fragment,o),P(yn.$$.fragment,o),P(kn.$$.fragment,o),P(ho.$$.fragment,o),P($n.$$.fragment,o),P(uo.$$.fragment,o),P(Fn.$$.fragment,o),P(jn.$$.fragment,o),P(Gn.$$.fragment,o),P(fo.$$.fragment,o),P(Mn.$$.fragment,o),P(go.$$.fragment,o),P(qn.$$.fragment,o),P(Cn.$$.fragment,o),P(zn.$$.fragment,o),P(An.$$.fragment,o),P(To.$$.fragment,o),P(Sn.$$.fragment,o),P(vo.$$.fragment,o),P(Dn.$$.fragment,o),P(On.$$.fragment,o),P(Wn.$$.fragment,o),P(Bn.$$.fragment,o),P(Yn.$$.fragment,o),P(ko.$$.fragment,o),P(Zn.$$.fragment,o),P(es.$$.fragment,o),P(ts.$$.fragment,o),P(ds.$$.fragment,o),P(bo.$$.fragment,o),P(cs.$$.fragment,o),ai=!1},d(o){t(p),o&&t(F),o&&t(f),$(T),o&&t(K),o&&t(E),$(Z),o&&t(ie),o&&t(L),o&&t(le),o&&t(Y),o&&t(de),o&&t(N),o&&t(ce),o&&t(S),o&&t(xe),$(z,o),o&&t(U),o&&t(pe),o&&t(Mr),o&&t($t),$(xo),o&&t(qr),o&&t(Xt),o&&t(Cr),$(Mo,o),o&&t(zr),o&&t(fs),o&&t(Ar),$(qo,o),o&&t(Ir),o&&t(Ft),$(Co),o&&t(Lr),o&&t(Ye),$(zo),$(Io),o&&t(Nr),o&&t(jt),$(Lo),o&&t(Sr),o&&t(ht),$(No),$(Oo),$(eo),$(Wo),o&&t(Dr),o&&t(Et),$(Bo),o&&t(Or),o&&t(et),$(Uo),$(Ro),$(oo),$(Vo),o&&t(Wr),o&&t(xt),$(Ko),o&&t(Br),o&&t(je),$(Xo),$(en),$(so),$(tn),$(on),$(nn),$(sn),o&&t(Ur),o&&t(qt),$(an),o&&t(Qr),o&&t(ot),$(rn),$(cn),$(ro),$(pn),$(hn),o&&t(Hr),o&&t(At),$(un),o&&t(Rr),o&&t(Ge),$(mn),$(lo),$(Tn),$(co),$(vn),o&&t(Vr),o&&t(Lt),$(yn),o&&t(Kr),o&&t(Ee),$(kn),$(ho),$($n),$(uo),$(Fn),o&&t(Xr),o&&t(St),$(jn),o&&t(Yr),o&&t(ae),$(Gn),$(fo),$(Mn),$(go),$(qn),$(Cn),o&&t(Zr),o&&t(Ot),$(zn),o&&t(ei),o&&t(Je),$(An),$(To),$(Sn),$(vo),$(Dn),$(On),o&&t(ti),o&&t(Ut),$(Wn),o&&t(oi),o&&t(be),$(Bn),$(Yn),$(ko),$(Zn),o&&t(ni),o&&t(Ht),$(es),o&&t(si),o&&t(Pe),$(ts),$(ds),$(bo),$(cs)}}}const yg={local:"gptj",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTJConfig",title:"GPTJConfig"},{local:"transformers.GPTJModel",title:"GPTJModel"},{local:"transformers.GPTJForCausalLM",title:"GPTJForCausalLM"},{local:"transformers.GPTJForSequenceClassification",title:"GPTJForSequenceClassification"},{local:"transformers.GPTJForQuestionAnswering",title:"GPTJForQuestionAnswering"},{local:"transformers.TFGPTJModel",title:"TFGPTJModel"},{local:"transformers.TFGPTJForCausalLM",title:"TFGPTJForCausalLM"},{local:"transformers.TFGPTJForSequenceClassification",title:"TFGPTJForSequenceClassification"},{local:"transformers.TFGPTJForQuestionAnswering",title:"TFGPTJForQuestionAnswering"},{local:"transformers.FlaxGPTJModel",title:"FlaxGPTJModel"},{local:"transformers.FlaxGPTJForCausalLM",title:"FlaxGPTJForCausalLM"}],title:"GPT-J"};function kg(I){return sg(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class jg extends eg{constructor(p){super();tg(this,p,kg,vg,og,{})}}export{jg as default,yg as metadata};
