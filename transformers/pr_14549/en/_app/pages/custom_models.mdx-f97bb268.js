...
to import from the `),u=r(I,"CODE",{});var ee=i(u);v=a(ee,"transformers"),ee.forEach(s),z=a(I," package."),I.forEach(s)},m(P,I){f(P,m,I),t(m,E),t(m,u),t(u,v),t(m,z)},d(P){P&&s(m)}}}function Gi(Z){let m,E,u,v,z,P,I,ee,sa,qs,Ge,oa,Is,Ke,aa,Ns,N,na,be,la,ra,Ve,ia,fa,xs,U,te,xt,ve,ca,Ot,da,Os,se,ha,Dt,ma,ua,Ds,Je,pa,Fs,$e,Bs,Qe,_a,Ss,x,ke,ga,Ft,ya,wa,ba,G,va,Bt,$a,ka,St,Ea,ja,Ca,K,Pa,Ht,Aa,Ta,Wt,Ma,Ra,Hs,O,qa,Lt,Ia,Na,Yt,xa,Oa,Ws,D,Da,zt,Fa,Ba,Ut,Sa,Ha,Ls,Xe,Wa,Ys,Ee,zs,A,La,Gt,Ya,za,Kt,Ua,Ga,Vt,Ka,Va,Us,je,Gs,F,Ja,Ze,Qa,Xa,et,Za,en,Ks,V,oe,Jt,Ce,tn,Qt,sn,Vs,B,on,tt,an,nn,Xt,ln,rn,Js,ae,fn,Zt,cn,dn,Qs,Pe,Xs,st,hn,Zs,Ae,eo,C,mn,es,un,pn,ts,_n,gn,ss,yn,wn,os,bn,vn,to,ne,so,S,$n,as,kn,En,ot,jn,Cn,oo,at,Pn,ao,Te,no,T,An,nt,Tn,Mn,lt,Rn,qn,rt,In,Nn,lo,it,xn,ro,Me,io,H,On,ft,Dn,Fn,ct,Bn,Sn,fo,J,le,ns,Re,Hn,ls,Wn,co,re,ho,$,Ln,rs,Yn,zn,is,Un,Gn,fs,Kn,Vn,cs,Jn,Qn,ds,Xn,Zn,hs,el,tl,ms,sl,ol,mo,qe,uo,W,al,us,nl,ll,ps,rl,il,po,ie,_o,dt,fl,go,ht,cl,yo,Ie,wo,fe,dl,_s,hl,ml,bo,Ne,vo,ce,ul,mt,pl,_l,$o,ut,gl,ko,xe,Eo,pt,yl,jo,Oe,Co,_t,wl,Po,De,Ao,gt,bl,To,Fe,Mo,M,vl,gs,$l,kl,ys,El,jl,Be,Cl,Pl,Ro,de,Al,yt,Tl,Ml,qo,Q,he,ws,Se,Rl,bs,ql,Io,R,Il,vs,Nl,xl,He,Ol,Dl,$s,Fl,Bl,No,We,xo,me,Sl,ks,Hl,Wl,Oo,Le,Do,wt,Ll,Fo,X,ue,Es,Ye,Yl,js,zl,Bo,bt,Ul,So,L,Gl,Cs,Kl,Vl,Ps,Jl,Ql,Ho,ze,Wo,q,Xl,vt,Zl,er,As,tr,sr,Ts,or,ar,Lo;return P=new Nt({}),ve=new Nt({}),$e=new k({props:{code:`from transformers import PretrainedConfig
...
after checking the validity of a few of them.`),Fs=c(),p($e.$$.fragment),Bs=c(),Qe=l("p"),_a=o("The three important things to remember when writing you own configuration are the following:"),Ss=c(),x=l("ul"),ke=l("li"),ga=o("you have to inherit from "),Ft=l("code"),ya=o("PretrainedConfig"),wa=o(","),ba=c(),G=l("li"),va=o("the "),Bt=l("code"),$a=o("__init__"),ka=o(" of your "),St=l("code"),Ea=o("PretrainedConfig"),ja=o(" must accept any kwargs,"),Ca=c(),K=l("li"),Pa=o("those "),Ht=l("code"),Aa=o("kwargs"),Ta=o(" need to be passed to the superclass "),Wt=l("code"),Ma=o("__init__"),Ra=o("."),Hs=c(),O=l("p"),qa=o(`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
superclass.`),Ws=c(),D=l("p"),Da=o("Defining a "),zt=l("code"),Fa=o("model_type"),Ba=o(" for your configuration (here "),Ut=l("code"),Sa=o('model_type="resnet"'),Ha=o(`) is not mandatory, unless you want to
...
directly upload your config to the Hub.`),Ks=c(),V=l("h2"),oe=l("a"),Jt=l("span"),p(Ce.$$.fragment),tn=c(),Qt=l("span"),sn=o("Writing a custom model"),Vs=c(),B=l("p"),on=o(`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
...
easy to transfer those weights:`),ro=c(),p(Me.$$.fragment),io=c(),H=l("p"),On=o("Now let\u2019s see how to make sure that when we do "),ft=l("a"),Dn=o("save_pretrained()"),Fn=o(" or "),ct=l("a"),Bn=o("push_to_hub()"),Sn=o(`, the
code of the model is saved.`),fo=c(),J=l("h2"),le=l("a"),ns=l("span"),p(Re.$$.fragment),Hn=c(),ls=l("span"),Wn=o("Sending the code to the Hub"),co=c(),p(re.$$.fragment),ho=c(),$=l("p"),Ln=o("First, make sure your model is fully defined in a "),rs=l("code"),Yn=o(".py"),zn=o(` file. It can rely on relative imports to some other files as
...
in this `),Be=l("a"),Cl=o("model repo"),Pl=o("."),Ro=c(),de=l("p"),Al=o("See the "),yt=l("a"),Tl=o("sharing tutorial"),Ml=o(" for more information on the push to Hub method."),qo=c(),Q=l("h2"),he=l("a"),ws=l("span"),p(Se.$$.fragment),Rl=c(),bs=l("span"),ql=o("Using a model with custom code"),Io=c(),R=l("p"),Il=o(`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
the `),vs=l("code"),Nl=o("from_pretrained"),xl=o(" method. All files and code uploaded to the Hub are scanned for malware (refer to the "),He=l("a"),Ol=o("Hub security"),Dl=o(` documentation for more information), but you should still
review the model code and author to avoid executing malicious code on your machine. Set `),$s=l("code"),Fl=o("trust_remote_code=True"),Bl=o(` to use
a model with custom code:`),No=c(),p(We.$$.fragment),xo=c(),me=l("p"),Sl=o("It is also strongly encouraged to pass a commit hash as a "),ks=l("code"),Hl=o("revision"),Wl=o(` to make sure the author of the models did not
...
hash of any commit.`),Fo=c(),X=l("h2"),ue=l("a"),Es=l("span"),p(Ye.$$.fragment),Yl=c(),js=l("span"),zl=o("Registering a model with custom code to the auto classes"),Bo=c(),bt=l("p"),Ul=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
...
configurations will then give us the different types of ResNets that are possible. We then just store those arguments,
after checking the validity of a few of them.`),pr.forEach(s),Fs=d(e),_($e.$$.fragment,e),Bs=d(e),Qe=r(e,"P",{});var _r=i(Qe);_a=a(_r,"The three important things to remember when writing you own configuration are the following:"),_r.forEach(s),Ss=d(e),x=r(e,"UL",{});var kt=i(x);ke=r(kt,"LI",{});var Uo=i(ke);ga=a(Uo,"you have to inherit from "),Ft=r(Uo,"CODE",{});var gr=i(Ft);ya=a(gr,"PretrainedConfig"),gr.forEach(s),wa=a(Uo,","),Uo.forEach(s),ba=d(kt),G=r(kt,"LI",{});var Et=i(G);va=a(Et,"the "),Bt=r(Et,"CODE",{});var yr=i(Bt);$a=a(yr,"__init__"),yr.forEach(s),ka=a(Et," of your "),St=r(Et,"CODE",{});var wr=i(St);Ea=a(wr,"PretrainedConfig"),wr.forEach(s),ja=a(Et," must accept any kwargs,"),Et.forEach(s),Ca=d(kt),K=r(kt,"LI",{});var jt=i(K);Pa=a(jt,"those "),Ht=r(jt,"CODE",{});var br=i(Ht);Aa=a(br,"kwargs"),br.forEach(s),Ta=a(jt," need to be passed to the superclass "),Wt=r(jt,"CODE",{});var vr=i(Wt);Ma=a(vr,"__init__"),vr.forEach(s),Ra=a(jt,"."),jt.forEach(s),kt.forEach(s),Hs=d(e),O=r(e,"P",{});var Ct=i(O);qa=a(Ct,`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
superclass.`),Ct.forEach(s),Ws=d(e),D=r(e,"P",{});var Pt=i(D);Da=a(Pt,"Defining a "),zt=r(Pt,"CODE",{});var Er=i(zt);Fa=a(Er,"model_type"),Er.forEach(s),Ba=a(Pt," for your configuration (here "),Ut=r(Pt,"CODE",{});var jr=i(Ut);Sa=a(jr,'model_type="resnet"'),jr.forEach(s),Ha=a(Pt,`) is not mandatory, unless you want to
...
`),Vt=r(pe,"CODE",{});var Tr=i(Vt);Ka=a(Tr,"from_pretrained"),Tr.forEach(s),Va=a(pe," method:"),pe.forEach(s),Us=d(e),_(je.$$.fragment,e),Gs=d(e),F=r(e,"P",{});var At=i(F);Ja=a(At,"You can also use any other method of the "),Ze=r(At,"A",{href:!0});var Mr=i(Ze);Qa=a(Mr,"PretrainedConfig"),Mr.forEach(s),Xa=a(At," class, like "),et=r(At,"A",{href:!0});var Rr=i(et);Za=a(Rr,"push_to_hub()"),Rr.forEach(s),en=a(At,` to
directly upload your config to the Hub.`),At.forEach(s),Ks=d(e),V=r(e,"H2",{class:!0});var Go=i(V);oe=r(Go,"A",{id:!0,class:!0,href:!0});var qr=i(oe);Jt=r(qr,"SPAN",{});var Ir=i(Jt);_(Ce.$$.fragment,Ir),Ir.forEach(s),qr.forEach(s),tn=d(Go),Qt=r(Go,"SPAN",{});var Nr=i(Qt);sn=a(Nr,"Writing a custom model"),Nr.forEach(s),Go.forEach(s),Vs=d(e),B=r(e,"P",{});var Tt=i(B);on=a(Tt,`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
...
classification (like `),Xt=r(Tt,"CODE",{});var Or=i(Xt);ln=a(Or,"BertModelForSequenceClassification"),Or.forEach(s),rn=a(Tt,")."),Tt.forEach(s),Js=d(e),ae=r(e,"P",{});var Ko=i(ae);fn=a(Ko,`As we mentioned before, we\u2019ll only write a loose wrapper of the model to keep it simple for this example. The only
thing we need to do before writing this class is a map between the block types and actual block classes. Then the
model is defined from the configuration by passing everything to the `),Zt=r(Ko,"CODE",{});var Dr=i(Zt);cn=a(Dr,"ResNet"),Dr.forEach(s),dn=a(Ko," class:"),Ko.forEach(s),Qs=d(e),_(Pe.$$.fragment,e),Xs=d(e),st=r(e,"P",{});var Fr=i(st);hn=a(Fr,"For the model that will classify images, we just change the forward method:"),Fr.forEach(s),Zs=d(e),_(Ae.$$.fragment,e),eo=d(e),C=r(e,"P",{});var Y=i(C);mn=a(Y,"In both cases, notice how we inherit from "),es=r(Y,"CODE",{});var Br=i(es);un=a(Br,"PreTrainedModel"),Br.forEach(s),pn=a(Y," and call the superclass initialization with the "),ts=r(Y,"CODE",{});var Sr=i(ts);_n=a(Sr,"config"),Sr.forEach(s),gn=a(Y,`
(a bit like when you write a regular `),ss=r(Y,"CODE",{});var Hr=i(ss);yn=a(Hr,"torch.nn.Module"),Hr.forEach(s),wn=a(Y,"). The line that sets the "),os=r(Y,"CODE",{});var Wr=i(os);bn=a(Wr,"config_class"),Wr.forEach(s),vn=a(Y,` is not mandatory, unless
you want to register your model with the auto classes (see last section).`),Y.forEach(s),to=d(e),_(ne.$$.fragment,e),so=d(e),S=r(e,"P",{});var Mt=i(S);$n=a(Mt,`You can have your model return anything you want, but returning a dictionary like we did for
...
we will use the pretrained version of the resnet50d. Since our model is just a wrapper around it, it\u2019s going to be
easy to transfer those weights:`),Vr.forEach(s),ro=d(e),_(Me.$$.fragment,e),io=d(e),H=r(e,"P",{});var Rt=i(H);On=a(Rt,"Now let\u2019s see how to make sure that when we do "),ft=r(Rt,"A",{href:!0});var Jr=i(ft);Dn=a(Jr,"save_pretrained()"),Jr.forEach(s),Fn=a(Rt," or "),ct=r(Rt,"A",{href:!0});var Qr=i(ct);Bn=a(Qr,"push_to_hub()"),Qr.forEach(s),Sn=a(Rt,`, the
code of the model is saved.`),Rt.forEach(s),fo=d(e),J=r(e,"H2",{class:!0});var Vo=i(J);le=r(Vo,"A",{id:!0,class:!0,href:!0});var Xr=i(le);ns=r(Xr,"SPAN",{});var Zr=i(ns);_(Re.$$.fragment,Zr),Zr.forEach(s),Xr.forEach(s),Hn=d(Vo),ls=r(Vo,"SPAN",{});var ei=i(ls);Wn=a(ei,"Sending the code to the Hub"),ei.forEach(s),Vo.forEach(s),co=d(e),_(re.$$.fragment,e),ho=d(e),$=r(e,"P",{});var j=i($);Ln=a(j,"First, make sure your model is fully defined in a "),rs=r(j,"CODE",{});var ti=i(rs);Yn=a(ti,".py"),ti.forEach(s),zn=a(j,` file. It can rely on relative imports to some other files as
long as all the files are in the same directory (we don\u2019t support submodules for this feature yet). For our example,
...
in this `),Be=r(ge,"A",{href:!0,rel:!0});var bi=i(Be);Cl=a(bi,"model repo"),bi.forEach(s),Pl=a(ge,"."),ge.forEach(s),Ro=d(e),de=r(e,"P",{});var Xo=i(de);Al=a(Xo,"See the "),yt=r(Xo,"A",{href:!0});var vi=i(yt);Tl=a(vi,"sharing tutorial"),vi.forEach(s),Ml=a(Xo," for more information on the push to Hub method."),Xo.forEach(s),qo=d(e),Q=r(e,"H2",{class:!0});var Zo=i(Q);he=r(Zo,"A",{id:!0,class:!0,href:!0});var $i=i(he);ws=r($i,"SPAN",{});var ki=i(ws);_(Se.$$.fragment,ki),ki.forEach(s),$i.forEach(s),Rl=d(Zo),bs=r(Zo,"SPAN",{});var Ei=i(bs);ql=a(Ei,"Using a model with custom code"),Ei.forEach(s),Zo.forEach(s),Io=d(e),R=r(e,"P",{});var ye=i(R);Il=a(ye,`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
the `),vs=r(ye,"CODE",{});var ji=i(vs);Nl=a(ji,"from_pretrained"),ji.forEach(s),xl=a(ye," method. All files and code uploaded to the Hub are scanned for malware (refer to the "),He=r(ye,"A",{href:!0,rel:!0});var Ci=i(He);Ol=a(Ci,"Hub security"),Ci.forEach(s),Dl=a(ye,` documentation for more information), but you should still
review the model code and author to avoid executing malicious code on your machine. Set `),$s=r(ye,"CODE",{});var Pi=i($s);Fl=a(Pi,"trust_remote_code=True"),Pi.forEach(s),Bl=a(ye,` to use
a model with custom code:`),ye.forEach(s),No=d(e),_(We.$$.fragment,e),xo=d(e),me=r(e,"P",{});var ea=i(me);Sl=a(ea,"It is also strongly encouraged to pass a commit hash as a "),ks=r(ea,"CODE",{});var Ai=i(ks);Hl=a(Ai,"revision"),Ai.forEach(s),Wl=a(ea,` to make sure the author of the models did not
...
hash of any commit.`),Ti.forEach(s),Fo=d(e),X=r(e,"H2",{class:!0});var ta=i(X);ue=r(ta,"A",{id:!0,class:!0,href:!0});var Mi=i(ue);Es=r(Mi,"SPAN",{});var Ri=i(Es);_(Ye.$$.fragment,Ri),Ri.forEach(s),Mi.forEach(s),Yl=d(ta),js=r(ta,"SPAN",{});var qi=i(js);zl=a(qi,"Registering a model with custom code to the auto classes"),qi.forEach(s),ta.forEach(s),Bo=d(e),bt=r(e,"P",{});var Ii=i(bt);Ul=a(Ii,`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
