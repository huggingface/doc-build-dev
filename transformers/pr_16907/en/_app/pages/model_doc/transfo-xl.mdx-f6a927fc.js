...
The epsilon to use in the layer normalization layers`,name:"layer_norm_epsilon"}],source:"https://github.com/huggingface/transformers/blob/pr_16907/src/transformers/models/transfo_xl/configuration_transfo_xl.py#L29"}}),Yt=new Qe({props:{code:`from transformers import TransfoXLConfig, TransfoXLModel
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16907/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/pr_16907/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16907/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16907/en/model_doc/transfo-xl#transformers.TransfoXLConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16907/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1065",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16907/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16907/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1209",returnDescription:`
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16907/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L882",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16907/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16907/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L961",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16907/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16907/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L1070",returnDescription:`
