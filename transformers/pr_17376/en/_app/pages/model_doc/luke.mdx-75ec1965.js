import{S as Bc,i as Kc,s as Rc,e as a,k as c,w as b,t as o,M as Hc,c as r,d as t,m as p,a as i,x as v,h as s,b as d,F as e,g as _,y as T,q as w,o as L,B as E,v as Vc,L as Qo}from"../../chunks/vendor-6b77c823.js";import{T as Vo}from"../../chunks/Tip-39098574.js";import{D as S}from"../../chunks/Docstring-1088f2fb.js";import{C as Wn}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Te}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Yo}from"../../chunks/ExampleCodeBlock-5212b321.js";function Yc(z){let h,y,g,f,k;return f=new Wn({props:{code:`from transformers import LukeConfig, LukeModel
...
Beyonc\xE9 PER
Los Angeles LOC`}}),{c(){h=a("p"),y=o("Examples:"),g=c(),b(f.$$.fragment)},l(l){h=r(l,"P",{});var u=i(h);y=s(u,"Examples:"),u.forEach(t),g=p(l),v(f.$$.fragment,l)},m(l,u){_(l,h,u),e(h,y),_(l,g,u),T(f,l,u),k=!0},p:Qo,i(l){k||(w(f.$$.fragment,l),k=!0)},o(l){L(f.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(g),E(f,l)}}}function sp(z){let h,y,g,f,k,l,u,$,Us,Jo,se,we,Un,Ge,Bs,Bn,Ks,Xo,Le,Rs,Ze,Hs,Vs,Go,Gt,Ys,Zo,Zt,Kn,Qs,es,en,Js,ts,W,Rn,et,Xs,tn,Gs,Zs,ea,Hn,q,ta,Vn,na,oa,Yn,sa,aa,Qn,ra,ia,Jn,la,da,nn,ca,pa,ha,tt,U,on,ua,ma,Xn,fa,ga,Gn,_a,ka,Zn,ya,ba,va,nt,sn,eo,Ta,wa,La,an,to,Ea,za,$a,N,no,xa,Fa,ae,Ee,rn,qa,Ca,ot,Ma,Pa,ja,ze,ln,Aa,Ia,st,Oa,Sa,Na,dn,cn,Da,Wa,Ua,O,pn,Ba,Ka,oo,Ra,Ha,so,Va,Ya,ao,Qa,Ja,ro,Xa,Ga,Za,re,er,hn,tr,nr,at,or,sr,ar,rt,rr,it,ir,lr,ns,un,dr,os,lt,ss,B,cr,dt,pr,hr,ct,ur,mr,pt,fr,gr,as,ie,$e,io,ht,_r,lo,kr,rs,D,ut,yr,le,br,mn,vr,Tr,mt,wr,Lr,Er,de,zr,fn,$r,xr,gn,Fr,qr,Cr,xe,is,ce,Fe,co,ft,Mr,po,Pr,ls,C,gt,jr,ho,Ar,Ir,x,Or,_n,Sr,Nr,kn,Dr,Wr,yn,Ur,Br,uo,Kr,Rr,mo,Hr,Vr,fo,Yr,Qr,go,Jr,Xr,Gr,qe,_t,Zr,_o,ei,ti,bn,kt,ds,pe,Ce,ko,yt,ni,yo,oi,cs,M,bt,si,bo,ai,ri,vt,ii,vn,li,di,ci,Tt,pi,wt,hi,ui,mi,K,Lt,fi,he,gi,Tn,_i,ki,vo,yi,bi,vi,Me,Ti,Pe,ps,ue,je,To,Et,wi,wo,Li,hs,P,zt,Ei,Lo,zi,$i,$t,xi,wn,Fi,qi,Ci,xt,Mi,Ft,Pi,ji,Ai,J,qt,Ii,me,Oi,Ln,Si,Ni,Eo,Di,Wi,Ui,Ae,us,fe,Ie,zo,Ct,Bi,$o,Ki,ms,j,Mt,Ri,xo,Hi,Vi,Pt,Yi,En,Qi,Ji,Xi,jt,Gi,At,Zi,el,tl,R,It,nl,ge,ol,zn,sl,al,Fo,rl,il,ll,Oe,dl,Se,fs,_e,Ne,qo,Ot,cl,Co,pl,gs,A,St,hl,Mo,ul,ml,Nt,fl,$n,gl,_l,kl,Dt,yl,Wt,bl,vl,Tl,H,Ut,wl,ke,Ll,xn,El,zl,Po,$l,xl,Fl,De,ql,We,_s,ye,Ue,jo,Bt,Cl,Ao,Ml,ks,I,Kt,Pl,Io,jl,Al,Rt,Il,Fn,Ol,Sl,Nl,Ht,Dl,Vt,Wl,Ul,Bl,V,Yt,Kl,be,Rl,qn,Hl,Vl,Oo,Yl,Ql,Jl,Be,Xl,Ke,ys;return l=new Te({}),Ge=new Te({}),lt=new Wn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17376/en/model_doc/luke#transformers.LukeModel">LukeModel</a>.`,name:"vocab_size"},{anchor:"transformers.LukeConfig.entity_vocab_size",description:`<strong>entity_vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 500000) &#x2014;
Entity vocabulary size of the LUKE model. Defines the number of different entities that can be represented
by the <code>entity_ids</code> passed when calling <a href="/docs/transformers/pr_17376/en/model_doc/luke#transformers.LukeModel">LukeModel</a>.`,name:"entity_vocab_size"},{anchor:"transformers.LukeConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LukeTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17376/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17376/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17376/src/transformers/models/luke/tokenization_luke.py#L262",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17376/en/main_classes/tokenizer#transformers.BatchEncoding"
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17376/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_17376/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17376/en/model_doc/luke#transformers.LukeConfig"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"entity_labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17376/src/transformers/models/luke/modeling_luke.py#L1170",returnDescription:`
...
and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17376/src/transformers/models/luke/modeling_luke.py#L1283",returnDescription:`
...
`}}),Oe=new Vo({props:{$$slots:{default:[Gc]},$$scope:{ctx:z}}}),Se=new Yo({props:{anchor:"transformers.LukeForEntityClassification.forward.example",$$slots:{default:[Zc]},$$scope:{ctx:z}}}),Ot=new Te({}),St=new S({props:{name:"class transformers.LukeForEntityPairClassification",anchor:"transformers.LukeForEntityPairClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17376/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17376/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17376/src/transformers/models/luke/modeling_luke.py#L1385"}}),Ut=new S({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17376/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_17376/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17376/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>[0, ..., config.num_labels - 1]</code>. If the shape is <code>(batch_size, num_labels)</code>, the binary cross entropy
loss is used for the multi-label classification. In this case, labels should only contain <code>[0, 1]</code>, where 0
and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17376/src/transformers/models/luke/modeling_luke.py#L1398",returnDescription:`
...
labels should only contain <code>[0, 1]</code>, where 0 and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17376/src/transformers/models/luke/modeling_luke.py#L1518",returnDescription:`
...
`}}),Be=new Vo({props:{$$slots:{default:[np]},$$scope:{ctx:z}}}),Ke=new Yo({props:{anchor:"transformers.LukeForEntitySpanClassification.forward.example",$$slots:{default:[op]},$$scope:{ctx:z}}}),{c(){h=a("meta"),y=c(),g=a("h1"),f=a("a"),k=a("span"),b(l.$$.fragment),u=c(),$=a("span"),Us=o("LUKE"),Jo=c(),se=a("h2"),we=a("a"),Un=a("span"),b(Ge.$$.fragment),Bs=c(),Bn=a("span"),Ks=o("Overview"),Xo=c(),Le=a("p"),Rs=o("The LUKE model was proposed in "),Ze=a("a"),Hs=o("LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),Vs=o(` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
...
`),nn=a("a"),ca=o("LukeTokenizer"),pa=o("."),ha=c(),tt=a("li"),U=a("p"),on=a("a"),ua=o("LukeTokenizer"),ma=o(" takes "),Xn=a("code"),fa=o("entities"),ga=o(" and "),Gn=a("code"),_a=o("entity_spans"),ka=o(` (character-based start and end
...
head models by specifying `),so=a("code"),Va=o('task="entity_classification"'),Ya=o(", "),ao=a("code"),Qa=o('task="entity_pair_classification"'),Ja=o(`, or
...
token) for entity classification tasks, such as Open Entity.`),Vi=c(),Pt=a("p"),Yi=o("This model inherits from "),En=a("a"),Qi=o("PreTrainedModel"),Ji=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bl=c(),V=a("div"),b(Yt.$$.fragment),Kl=c(),be=a("p"),Rl=o("The "),qn=a("a"),Hl=o("LukeForEntitySpanClassification"),Vl=o(" forward method, overrides the "),Oo=a("code"),Yl=o("__call__"),Ql=o(" special method."),Jl=c(),b(Be.$$.fragment),Xl=c(),b(Ke.$$.fragment),this.h()},l(n){const m=Hc('[data-svelte="svelte-1phssyn"]',document.head);h=r(m,"META",{name:!0,content:!0}),m.forEach(t),y=p(n),g=r(n,"H1",{class:!0});var Qt=i(g);f=r(Qt,"A",{id:!0,class:!0,href:!0});var So=i(f);k=r(So,"SPAN",{});var No=i(k);v(l.$$.fragment,No),No.forEach(t),So.forEach(t),u=p(Qt),$=r(Qt,"SPAN",{});var Do=i($);Us=s(Do,"LUKE"),Do.forEach(t),Qt.forEach(t),Jo=p(n),se=r(n,"H2",{class:!0});var Jt=i(se);we=r(Jt,"A",{id:!0,class:!0,href:!0});var Wo=i(we);Un=r(Wo,"SPAN",{});var Uo=i(Un);v(Ge.$$.fragment,Uo),Uo.forEach(t),Wo.forEach(t),Bs=p(Jt),Bn=r(Jt,"SPAN",{});var Bo=i(Bn);Ks=s(Bo,"Overview"),Bo.forEach(t),Jt.forEach(t),Xo=p(n),Le=r(n,"P",{});var Xt=i(Le);Rs=s(Xt,"The LUKE model was proposed in "),Ze=r(Xt,"A",{href:!0,rel:!0});var Ko=i(Ze);Hs=s(Ko,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),Ko.forEach(t),Vs=s(Xt,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
...
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
question answering.`),Zl.forEach(t),Ts.forEach(t),vs.forEach(t),$a=p(Re),N=r(Re,"LI",{});var X=i(N);no=r(X,"P",{});var yd=i(no);xa=s(yd,"There are three head models for the former use case:"),yd.forEach(t),Fa=p(X),ae=r(X,"UL",{});var Cn=i(ae);Ee=r(Cn,"LI",{});var Ro=i(Ee);rn=r(Ro,"A",{href:!0});var bd=i(rn);qa=s(bd,"LukeForEntityClassification"),bd.forEach(t),Ca=s(Ro,`, for tasks to classify a single entity in an input text such as
...
named entity recognition (NER). This model places a linear head on top of the output entity representations. You
can address NER using this model by inputting all possible entity spans in the text to the model.`),ed.forEach(t),Cn.forEach(t),Ua=p(X),O=r(X,"P",{});var Q=i(O);pn=r(Q,"A",{href:!0});var Ed=i(pn);Ba=s(Ed,"LukeTokenizer"),Ed.forEach(t),Ka=s(Q," has a "),oo=r(Q,"CODE",{});var zd=i(oo);Ra=s(zd,"task"),zd.forEach(t),Ha=s(Q,` argument, which enables you to easily create an input to these
head models by specifying `),so=r(Q,"CODE",{});var $d=i(so);Va=s($d,'task="entity_classification"'),$d.forEach(t),Ya=s(Q,", "),ao=r(Q,"CODE",{});var xd=i(ao);Qa=s(xd,'task="entity_pair_classification"'),xd.forEach(t),Ja=s(Q,`, or
`),ro=r(Q,"CODE",{});var Fd=i(ro);Xa=s(Fd,'task="entity_span_classification"'),Fd.forEach(t),Ga=s(Q,". Please refer to the example code of each head models."),Q.forEach(t),Za=p(X),re=r(X,"P",{});var Mn=i(re);er=s(Mn,"A demo notebook on how to fine-tune "),hn=r(Mn,"A",{href:!0});var qd=i(hn);tr=s(qd,"LukeForEntityPairClassification"),qd.forEach(t),nr=s(Mn,` for relation
classification can be found `),at=r(Mn,"A",{href:!0,rel:!0});var Cd=i(at);or=s(Cd,"here"),Cd.forEach(t),sr=s(Mn,"."),Mn.forEach(t),ar=p(X),rt=r(X,"P",{});var ws=i(rt);rr=s(ws,`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
...
documentation from `),gn=r(jn,"A",{href:!0});var Bd=i(gn);Fr=s(Bd,"PretrainedConfig"),Bd.forEach(t),qr=s(jn," for more information."),jn.forEach(t),Cr=p(Ve),v(xe.$$.fragment,Ve),Ve.forEach(t),is=p(n),ce=r(n,"H2",{class:!0});var Es=i(ce);Fe=r(Es,"A",{id:!0,class:!0,href:!0});var Kd=i(Fe);co=r(Kd,"SPAN",{});var Rd=i(co);v(ft.$$.fragment,Rd),Rd.forEach(t),Kd.forEach(t),Mr=p(Es),po=r(Es,"SPAN",{});var Hd=i(po);Pr=s(Hd,"LukeTokenizer"),Hd.forEach(t),Es.forEach(t),ls=p(n),C=r(n,"DIV",{class:!0});var G=i(C);v(gt.$$.fragment,G),jr=p(G),ho=r(G,"P",{});var Vd=i(ho);Ar=s(Vd,"Construct a LUKE tokenizer."),Vd.forEach(t),Ir=p(G),x=r(G,"P",{});var F=i(x);Or=s(F,"This tokenizer inherits from "),_n=r(F,"A",{href:!0});var Yd=i(_n);Sr=s(Yd,"RobertaTokenizer"),Yd.forEach(t),Nr=s(F,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),kn=r(F,"A",{href:!0});var Qd=i(kn);Dr=s(Qd,"RobertaTokenizer"),Qd.forEach(t),Wr=s(F,", "),yn=r(F,"A",{href:!0});var Jd=i(yn);Ur=s(Jd,"LukeTokenizer"),Jd.forEach(t),Br=s(F,`
also creates entity sequences, namely `),uo=r(F,"CODE",{});var Xd=i(uo);Kr=s(Xd,"entity_ids"),Xd.forEach(t),Rr=s(F,", "),mo=r(F,"CODE",{});var Gd=i(mo);Hr=s(Gd,"entity_attention_mask"),Gd.forEach(t),Vr=s(F,", "),fo=r(F,"CODE",{});var Zd=i(fo);Yr=s(Zd,"entity_token_type_ids"),Zd.forEach(t),Qr=s(F,`, and
`),go=r(F,"CODE",{});var ec=i(go);Jr=s(ec,"entity_position_ids"),ec.forEach(t),Xr=s(F," to be used by the LUKE model."),F.forEach(t),Gr=p(G),qe=r(G,"DIV",{class:!0});var zs=i(qe);v(_t.$$.fragment,zs),Zr=p(zs),_o=r(zs,"P",{});var tc=i(_o);ei=s(tc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),tc.forEach(t),zs.forEach(t),ti=p(G),bn=r(G,"DIV",{class:!0});var nc=i(bn);v(kt.$$.fragment,nc),nc.forEach(t),G.forEach(t),ds=p(n),pe=r(n,"H2",{class:!0});var $s=i(pe);Ce=r($s,"A",{id:!0,class:!0,href:!0});var oc=i(Ce);ko=r(oc,"SPAN",{});var sc=i(ko);v(yt.$$.fragment,sc),sc.forEach(t),oc.forEach(t),ni=p($s),yo=r($s,"SPAN",{});var ac=i(yo);oi=s(ac,"LukeModel"),ac.forEach(t),$s.forEach(t),cs=p(n),M=r(n,"DIV",{class:!0});var Z=i(M);v(bt.$$.fragment,Z),si=p(Z),bo=r(Z,"P",{});var rc=i(bo);ai=s(rc,"The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),rc.forEach(t),ri=p(Z),vt=r(Z,"P",{});var xs=i(vt);ii=s(xs,"This model inherits from "),vn=r(xs,"A",{href:!0});var ic=i(vn);li=s(ic,"PreTrainedModel"),ic.forEach(t),di=s(xs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
token) for entity classification tasks, such as Open Entity.`),Tc.forEach(t),Vi=p(te),Pt=r(te,"P",{});var js=i(Pt);Yi=s(js,"This model inherits from "),En=r(js,"A",{href:!0});var wc=i(En);Qi=s(wc,"PreTrainedModel"),wc.forEach(t),Ji=s(js,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
