...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17474/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17474/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17474/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17474/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),h4=c(),Tm=n("p"),m4=r("Finally, this model supports inherent JAX features such as:"),u4=c(),eo=n("ul"),bm=n("li"),Rl=n("a"),f4=r("Just-In-Time (JIT) compilation"),g4=c(),ym=n("li"),Hl=n("a"),_4=r("Automatic Differentiation"),k4=c(),Em=n("li"),Ql=n("a"),v4=r("Vectorization"),T4=c(),wm=n("li"),Bl=n("a"),b4=r("Parallelization"),y4=c(),It=n("div"),b(Vl.$$.fragment),E4=c(),kn=n("p"),w4=r("The "),$m=n("code"),$4=r("FlaxElectraPreTrainedModel"),F4=r(" forward method, overrides the "),Fm=n("code"),x4=r("__call__"),M4=r(" special method."),z4=c(),b(na.$$.fragment),j4=c(),b(sa.$$.fragment),$f=c(),vn=n("h2"),aa=n("a"),xm=n("span"),b(Kl.$$.fragment),C4=c(),Mm=n("span"),q4=r("FlaxElectraForQuestionAnswering"),Ff=c(),Re=n("div"),b(Jl.$$.fragment),P4=c(),Tn=n("p"),A4=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=n("code"),O4=r("span start logits"),L4=r(" and "),jm=n("code"),N4=r("span end logits"),I4=r(")."),D4=c(),Gl=n("p"),S4=r("This model inherits from "),hc=n("a"),W4=r("FlaxPreTrainedModel"),U4=r(`. Check the superclass documentation for the generic methods the
...
`),Qi=s(xg,"A",{href:!0,rel:!0});var n7=a(Qi);mw=i(n7,"flax.nn.Module"),n7.forEach(t),uw=i(xg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xg.forEach(t),fw=p(Ye),Eh=s(Ye,"P",{});var s7=a(Eh);gw=i(s7,"Finally, this model supports inherent JAX features such as:"),s7.forEach(t),_w=p(Ye),Jt=s(Ye,"UL",{});var va=a(Jt);wh=s(va,"LI",{});var a7=a(wh);Bi=s(a7,"A",{href:!0,rel:!0});var r7=a(Bi);kw=i(r7,"Just-In-Time (JIT) compilation"),r7.forEach(t),a7.forEach(t),vw=p(va),$h=s(va,"LI",{});var i7=a($h);Vi=s(i7,"A",{href:!0,rel:!0});var l7=a(Vi);Tw=i(l7,"Automatic Differentiation"),l7.forEach(t),i7.forEach(t),bw=p(va),Fh=s(va,"LI",{});var d7=a(Fh);Ki=s(d7,"A",{href:!0,rel:!0});var c7=a(Ki);yw=i(c7,"Vectorization"),c7.forEach(t),d7.forEach(t),Ew=p(va),xh=s(va,"LI",{});var p7=a(xh);Ji=s(p7,"A",{href:!0,rel:!0});var h7=a(Ji);ww=i(h7,"Parallelization"),h7.forEach(t),p7.forEach(t),va.forEach(t),$w=p(Ye),Pt=s(Ye,"DIV",{class:!0});var Ta=a(Pt);y(Gi.$$.fragment,Ta),Fw=p(Ta),ln=s(Ta,"P",{});var Cc=a(ln);xw=i(Cc,"The "),Mh=s(Cc,"CODE",{});var m7=a(Mh);Mw=i(m7,"FlaxElectraPreTrainedModel"),m7.forEach(t),zw=i(Cc," forward method, overrides the "),zh=s(Cc,"CODE",{});var u7=a(zh);jw=i(u7,"__call__"),u7.forEach(t),Cw=i(Cc," special method."),Cc.forEach(t),qw=p(Ta),y(Us.$$.fragment,Ta),Pw=p(Ta),y(Rs.$$.fragment,Ta),Ta.forEach(t),Ye.forEach(t),ff=p(o),dn=s(o,"H2",{class:!0});var Mg=a(dn);Hs=s(Mg,"A",{id:!0,class:!0,href:!0});var f7=a(Hs);jh=s(f7,"SPAN",{});var g7=a(jh);y(Xi.$$.fragment,g7),g7.forEach(t),f7.forEach(t),Aw=p(Mg),Ch=s(Mg,"SPAN",{});var _7=a(Ch);Ow=i(_7,"FlaxElectraForCausalLM"),_7.forEach(t),Mg.forEach(t),gf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),Lw=p(_t),qh=s(_t,"P",{});var k7=a(qh);Nw=i(k7,`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
`),tl=s(jg,"A",{href:!0,rel:!0});var T7=a(tl);Hw=i(T7,"flax.nn.Module"),T7.forEach(t),Qw=i(jg,` subclass. Use it as a
