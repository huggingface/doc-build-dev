import{S as ks,i as ys,s as ws,e as s,k as p,w as k,t as i,M as $s,c as r,d as t,m,a,x as y,h as l,b as u,G as e,g as b,y as w,q as $,o as T,B,v as Ts,L as Jo}from"../../chunks/vendor-hf-doc-builder.js";import{T as An}from"../../chunks/Tip-hf-doc-builder.js";import{D as Ye}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ko}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Je}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Yo}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Bs(x){let d,v,f,c,_;return c=new Ko({props:{code:`from transformers import BloomModel, BloomConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),v=i("Example:"),f=p(),k(c.$$.fragment)},l(n){d=r(n,"P",{});var h=a(d);v=l(h,"Example:"),h.forEach(t),f=m(n),y(c.$$.fragment,n)},m(n,h){b(n,d,h),e(d,v),b(n,f,h),w(c,n,h),_=!0},p:Jo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function zs(x){let d,v,f,c,_;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),c=i("Module"),_=i(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(n,h){b(n,d,h),e(d,v),e(d,f),e(f,c),e(d,_)},d(n){n&&t(d)}}}function xs(x){let d,v,f,c,_;return c=new Ko({props:{code:`from transformers import BloomTokenizer, BloomModel
import torch
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){d=s("p"),v=i("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),f=p(),k(c.$$.fragment)},l(n){d=r(n,"P",{});var h=a(d);v=l(h,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),h.forEach(t),f=m(n),y(c.$$.fragment,n)},m(n,h){b(n,d,h),e(d,v),b(n,f,h),w(c,n,h),_=!0},p:Jo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function Cs(x){let d,v,f,c,_,n,h,C;return{c(){d=s("p"),v=i("When used with "),f=s("code"),c=i("is_split_into_words=True"),_=i(", this tokenizer needs to be instantiated with "),n=s("code"),h=i("add_prefix_space=True"),C=i(".")},l(W){d=r(W,"P",{});var q=a(d);v=l(q,"When used with "),f=r(q,"CODE",{});var A=a(f);c=l(A,"is_split_into_words=True"),A.forEach(t),_=l(q,", this tokenizer needs to be instantiated with "),n=r(q,"CODE",{});var S=a(n);h=l(S,"add_prefix_space=True"),S.forEach(t),C=l(q,"."),q.forEach(t)},m(W,q){b(W,d,q),e(d,v),e(d,f),e(f,c),e(d,_),e(d,n),e(n,h),e(d,C)},d(W){W&&t(d)}}}function Fs(x){let d,v,f,c,_;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var h=a(d);v=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(h,"CODE",{});var C=a(f);c=l(C,"Module"),C.forEach(t),_=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(n,h){b(n,d,h),e(d,v),e(d,f),e(f,c),e(d,_)},d(n){n&&t(d)}}}function Es(x){let d,v,f,c,_;return c=new Ko({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=s("p"),v=i("Example:"),f=p(),k(c.$$.fragment)},l(n){d=r(n,"P",{});var h=a(d);v=l(h,"Example:"),h.forEach(t),f=m(n),y(c.$$.fragment,n)},m(n,h){b(n,d,h),e(d,v),b(n,f,h),w(c,n,h),_=!0},p:Jo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function Ps(x){let d,v,f,c,_,n,h,C,W,q,A,S,Ke,me,Qo,Qe,Xo,Bo,Q,Zo,he,et,ot,zo,M,Xe,tt,nt,Ze,st,rt,eo,at,it,oo,lt,dt,to,ct,pt,no,mt,xo,H,X,so,ue,ht,ro,ut,Mo,L,fe,ft,U,gt,je,_t,bt,ge,vt,kt,yt,V,wt,Ie,$t,Tt,Ne,Bt,zt,xt,Z,Co,G,ee,ao,_e,Mt,io,Ct,Fo,F,be,Ft,lo,Et,Pt,ve,qt,Se,Lt,At,jt,ke,It,ye,Nt,St,Dt,j,we,Ot,R,Wt,De,Ht,Ut,co,Vt,Gt,Rt,oe,Yt,te,Eo,Y,ne,po,$e,Jt,mo,Kt,Po,z,Te,Qt,Be,Xt,ho,Zt,en,on,uo,tn,nn,se,sn,ze,rn,fo,an,ln,dn,re,cn,xe,pn,Oe,mn,hn,qo,J,ae,go,Me,un,_o,fn,Lo,E,Ce,gn,bo,_n,bn,Fe,vn,We,kn,yn,wn,Ee,$n,Pe,Tn,Bn,zn,I,qe,xn,K,Mn,He,Cn,Fn,vo,En,Pn,qn,ie,Ln,le,Ao;return n=new Je({}),me=new Je({}),ue=new Je({}),fe=new Ye({props:{name:"class transformers.BloomConfig",anchor:"transformers.BloomConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 64"},{name:"n_layer",val:" = 2"},{name:"n_head",val:" = 8"},{name:"n_inner",val:" = None"},{name:"masked_softmax_fusion",val:" = True"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"use_cache",val:" = False"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"apply_residual_connection_post_layernorm",val:" = False"},{name:"bias_dropout_fusion",val:" = True"},{name:"hidden_dropout",val:" = 0.0"},{name:"attention_dropout",val:" = 0.0"},{name:"attention_softmax_in_fp32",val:" = True"},{name:"pretraining_tp",val:" = 1"},{name:"dtype",val:" = 'bfloat16'"},{name:"gradient_checkpointing",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BloomConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17474/src/transformers/models/bloom/modeling_bloom.py#L890",returnDescription:`
<p>A <a
...
`}}),ie=new An({props:{$$slots:{default:[Fs]},$$scope:{ctx:x}}}),le=new Yo({props:{anchor:"transformers.BloomForCausalLM.forward.example",$$slots:{default:[Es]},$$scope:{ctx:x}}}),{c(){d=s("meta"),v=p(),f=s("h1"),c=s("a"),_=s("span"),k(n.$$.fragment),h=p(),C=s("span"),W=i("BLOOM"),q=p(),A=s("h2"),S=s("a"),Ke=s("span"),k(me.$$.fragment),Qo=p(),Qe=s("span"),Xo=i("Overview"),Bo=p(),Q=s("p"),Zo=i("Bloom model has been proposed with its various versions through the "),he=s("a"),et=i("BigScience Workshop"),ot=i(`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
...
Several smaller versions of the models have been trained on the same dataset. Bloom is available in the following version:`),zo=p(),M=s("ul"),Xe=s("li"),tt=i("350M parameters"),nt=p(),Ze=s("li"),st=i("760M parameters"),rt=p(),eo=s("li"),at=i("1.3B parameters"),it=p(),oo=s("li"),lt=i("2.5B parameters"),dt=p(),to=s("li"),ct=i("6.3B parameters"),pt=p(),no=s("li"),mt=i("175B parameters"),xo=p(),H=s("h2"),X=s("a"),so=s("span"),k(ue.$$.fragment),ht=p(),ro=s("span"),ut=i("BloomConfig"),Mo=p(),L=s("div"),k(fe.$$.fragment),ft=p(),U=s("p"),gt=i("This is the configuration class to store the configuration of a "),je=s("a"),_t=i("BloomModel"),bt=i(`. It is used to instantiate a Bloom
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
`),ge=s("a"),vt=i("bigscience/bloom"),kt=i("."),yt=p(),V=s("p"),wt=i("Configuration objects inherit from "),Ie=s("a"),$t=i("PretrainedConfig"),Tt=i(` and can be used to control the model outputs. Read the
documentation from `),Ne=s("a"),Bt=i("PretrainedConfig"),zt=i(" for more information."),xt=p(),k(Z.$$.fragment),Co=p(),G=s("h2"),ee=s("a"),ao=s("span"),k(_e.$$.fragment),Mt=p(),io=s("span"),Ct=i("BloomModel"),Fo=p(),F=s("div"),k(be.$$.fragment),Ft=p(),lo=s("p"),Et=i("The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),Pt=p(),ve=s("p"),qt=i("This model inherits from "),Se=s("a"),Lt=i("PreTrainedModel"),At=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),jt=p(),ke=s("p"),It=i("This model is also a PyTorch "),ye=s("a"),Nt=i("torch.nn.Module"),St=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dt=p(),j=s("div"),k(we.$$.fragment),Ot=p(),R=s("p"),Wt=i("The "),De=s("a"),Ht=i("BloomModel"),Ut=i(" forward method, overrides the "),co=s("code"),Vt=i("__call__"),Gt=i(" special method."),Rt=p(),k(oe.$$.fragment),Yt=p(),k(te.$$.fragment),Eo=p(),Y=s("h2"),ne=s("a"),po=s("span"),k($e.$$.fragment),Jt=p(),mo=s("span"),Kt=i("BloomTokenizerFast"),Po=p(),z=s("div"),k(Te.$$.fragment),Qt=p(),Be=s("p"),Xt=i("Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),ho=s("em"),Zt=i("tokenizers"),en=i(` library). Based on byte-level
Byte-Pair-Encoding.`),on=p(),uo=s("p"),tn=i("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),nn=p(),k(se.$$.fragment),sn=p(),ze=s("p"),rn=i("You can get around that behavior by passing "),fo=s("code"),an=i("add_prefix_space=True"),ln=i(` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),dn=p(),k(re.$$.fragment),cn=p(),xe=s("p"),pn=i("This tokenizer inherits from "),Oe=s("a"),mn=i("PreTrainedTokenizerFast"),hn=i(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),qo=p(),J=s("h2"),ae=s("a"),go=s("span"),k(Me.$$.fragment),un=p(),_o=s("span"),fn=i("BloomForCausalLM"),Lo=p(),E=s("div"),k(Ce.$$.fragment),gn=p(),bo=s("p"),_n=i(`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),bn=p(),Fe=s("p"),vn=i("This model inherits from "),We=s("a"),kn=i("PreTrainedModel"),yn=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),wn=p(),Ee=s("p"),$n=i("This model is also a PyTorch "),Pe=s("a"),Tn=i("torch.nn.Module"),Bn=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zn=p(),I=s("div"),k(qe.$$.fragment),xn=p(),K=s("p"),Mn=i("The "),He=s("a"),Cn=i("BloomForCausalLM"),Fn=i(" forward method, overrides the "),vo=s("code"),En=i("__call__"),Pn=i(" special method."),qn=p(),k(ie.$$.fragment),Ln=p(),k(le.$$.fragment),this.h()},l(o){const g=$s('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(t),v=m(o),f=r(o,"H1",{class:!0});var Le=a(f);c=r(Le,"A",{id:!0,class:!0,href:!0});var ko=a(c);_=r(ko,"SPAN",{});var yo=a(_);y(n.$$.fragment,yo),yo.forEach(t),ko.forEach(t),h=m(Le),C=r(Le,"SPAN",{});var wo=a(C);W=l(wo,"BLOOM"),wo.forEach(t),Le.forEach(t),q=m(o),A=r(o,"H2",{class:!0});var Ae=a(A);S=r(Ae,"A",{id:!0,class:!0,href:!0});var $o=a(S);Ke=r($o,"SPAN",{});var To=a(Ke);y(me.$$.fragment,To),To.forEach(t),$o.forEach(t),Qo=m(Ae),Qe=r(Ae,"SPAN",{});var jn=a(Qe);Xo=l(jn,"Overview"),jn.forEach(t),Ae.forEach(t),Bo=m(o),Q=r(o,"P",{});var jo=a(Q);Zo=l(jo,"Bloom model has been proposed with its various versions through the "),he=r(jo,"A",{href:!0,rel:!0});var In=a(he);et=l(In,"BigScience Workshop"),In.forEach(t),ot=l(jo,`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
The architecture of Bloom is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on different 46 languages including code.
Several smaller versions of the models have been trained on the same dataset. Bloom is available in the following version:`),jo.forEach(t),zo=m(o),M=r(o,"UL",{});var N=a(M);Xe=r(N,"LI",{});var Nn=a(Xe);tt=l(Nn,"350M parameters"),Nn.forEach(t),nt=m(N),Ze=r(N,"LI",{});var Sn=a(Ze);st=l(Sn,"760M parameters"),Sn.forEach(t),rt=m(N),eo=r(N,"LI",{});var Dn=a(eo);at=l(Dn,"1.3B parameters"),Dn.forEach(t),it=m(N),oo=r(N,"LI",{});var On=a(oo);lt=l(On,"2.5B parameters"),On.forEach(t),dt=m(N),to=r(N,"LI",{});var Wn=a(to);ct=l(Wn,"6.3B parameters"),Wn.forEach(t),pt=m(N),no=r(N,"LI",{});var Hn=a(no);mt=l(Hn,"175B parameters"),Hn.forEach(t),N.forEach(t),xo=m(o),H=r(o,"H2",{class:!0});var Io=a(H);X=r(Io,"A",{id:!0,class:!0,href:!0});var Un=a(X);so=r(Un,"SPAN",{});var Vn=a(so);y(ue.$$.fragment,Vn),Vn.forEach(t),Un.forEach(t),ht=m(Io),ro=r(Io,"SPAN",{});var Gn=a(ro);ut=l(Gn,"BloomConfig"),Gn.forEach(t),Io.forEach(t),Mo=m(o),L=r(o,"DIV",{class:!0});var de=a(L);y(fe.$$.fragment,de),ft=m(de),U=r(de,"P",{});var Ue=a(U);gt=l(Ue,"This is the configuration class to store the configuration of a "),je=r(Ue,"A",{href:!0});var Rn=a(je);_t=l(Rn,"BloomModel"),Rn.forEach(t),bt=l(Ue,`. It is used to instantiate a Bloom
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
`),ge=r(Ue,"A",{href:!0,rel:!0});var Yn=a(ge);vt=l(Yn,"bigscience/bloom"),Yn.forEach(t),kt=l(Ue,"."),Ue.forEach(t),yt=m(de),V=r(de,"P",{});var Ve=a(V);wt=l(Ve,"Configuration objects inherit from "),Ie=r(Ve,"A",{href:!0});var Jn=a(Ie);$t=l(Jn,"PretrainedConfig"),Jn.forEach(t),Tt=l(Ve,` and can be used to control the model outputs. Read the
documentation from `),Ne=r(Ve,"A",{href:!0});var Kn=a(Ne);Bt=l(Kn,"PretrainedConfig"),Kn.forEach(t),zt=l(Ve," for more information."),Ve.forEach(t),xt=m(de),y(Z.$$.fragment,de),de.forEach(t),Co=m(o),G=r(o,"H2",{class:!0});var No=a(G);ee=r(No,"A",{id:!0,class:!0,href:!0});var Qn=a(ee);ao=r(Qn,"SPAN",{});var Xn=a(ao);y(_e.$$.fragment,Xn),Xn.forEach(t),Qn.forEach(t),Mt=m(No),io=r(No,"SPAN",{});var Zn=a(io);Ct=l(Zn,"BloomModel"),Zn.forEach(t),No.forEach(t),Fo=m(o),F=r(o,"DIV",{class:!0});var D=a(F);y(be.$$.fragment,D),Ft=m(D),lo=r(D,"P",{});var es=a(lo);Et=l(es,"The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),es.forEach(t),Pt=m(D),ve=r(D,"P",{});var So=a(ve);qt=l(So,"This model inherits from "),Se=r(So,"A",{href:!0});var os=a(Se);Lt=l(os,"PreTrainedModel"),os.forEach(t),At=l(So,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),So.forEach(t),jt=m(D),ke=r(D,"P",{});var Do=a(ke);It=l(Do,"This model is also a PyTorch "),ye=r(Do,"A",{href:!0,rel:!0});var ts=a(ye);Nt=l(ts,"torch.nn.Module"),ts.forEach(t),St=l(Do,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Do.forEach(t),Dt=m(D),j=r(D,"DIV",{class:!0});var ce=a(j);y(we.$$.fragment,ce),Ot=m(ce),R=r(ce,"P",{});var Ge=a(R);Wt=l(Ge,"The "),De=r(Ge,"A",{href:!0});var ns=a(De);Ht=l(ns,"BloomModel"),ns.forEach(t),Ut=l(Ge," forward method, overrides the "),co=r(Ge,"CODE",{});var ss=a(co);Vt=l(ss,"__call__"),ss.forEach(t),Gt=l(Ge," special method."),Ge.forEach(t),Rt=m(ce),y(oe.$$.fragment,ce),Yt=m(ce),y(te.$$.fragment,ce),ce.forEach(t),D.forEach(t),Eo=m(o),Y=r(o,"H2",{class:!0});var Oo=a(Y);ne=r(Oo,"A",{id:!0,class:!0,href:!0});var rs=a(ne);po=r(rs,"SPAN",{});var as=a(po);y($e.$$.fragment,as),as.forEach(t),rs.forEach(t),Jt=m(Oo),mo=r(Oo,"SPAN",{});var is=a(mo);Kt=l(is,"BloomTokenizerFast"),is.forEach(t),Oo.forEach(t),Po=m(o),z=r(o,"DIV",{class:!0});var P=a(z);y(Te.$$.fragment,P),Qt=m(P),Be=r(P,"P",{});var Wo=a(Be);Xt=l(Wo,"Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),ho=r(Wo,"EM",{});var ls=a(ho);Zt=l(ls,"tokenizers"),ls.forEach(t),en=l(Wo,` library). Based on byte-level
Byte-Pair-Encoding.`),Wo.forEach(t),on=m(P),uo=r(P,"P",{});var ds=a(uo);tn=l(ds,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),ds.forEach(t),nn=m(P),y(se.$$.fragment,P),sn=m(P),ze=r(P,"P",{});var Ho=a(ze);rn=l(Ho,"You can get around that behavior by passing "),fo=r(Ho,"CODE",{});var cs=a(fo);an=l(cs,"add_prefix_space=True"),cs.forEach(t),ln=l(Ho,` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),Ho.forEach(t),dn=m(P),y(re.$$.fragment,P),cn=m(P),xe=r(P,"P",{});var Uo=a(xe);pn=l(Uo,"This tokenizer inherits from "),Oe=r(Uo,"A",{href:!0});var ps=a(Oe);mn=l(ps,"PreTrainedTokenizerFast"),ps.forEach(t),hn=l(Uo,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Uo.forEach(t),P.forEach(t),qo=m(o),J=r(o,"H2",{class:!0});var Vo=a(J);ae=r(Vo,"A",{id:!0,class:!0,href:!0});var ms=a(ae);go=r(ms,"SPAN",{});var hs=a(go);y(Me.$$.fragment,hs),hs.forEach(t),ms.forEach(t),un=m(Vo),_o=r(Vo,"SPAN",{});var us=a(_o);fn=l(us,"BloomForCausalLM"),us.forEach(t),Vo.forEach(t),Lo=m(o),E=r(o,"DIV",{class:!0});var O=a(E);y(Ce.$$.fragment,O),gn=m(O),bo=r(O,"P",{});var fs=a(bo);_n=l(fs,`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),fs.forEach(t),bn=m(O),Fe=r(O,"P",{});var Go=a(Fe);vn=l(Go,"This model inherits from "),We=r(Go,"A",{href:!0});var gs=a(We);kn=l(gs,"PreTrainedModel"),gs.forEach(t),yn=l(Go,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),Go.forEach(t),wn=m(O),Ee=r(O,"P",{});var Ro=a(Ee);$n=l(Ro,"This model is also a PyTorch "),Pe=r(Ro,"A",{href:!0,rel:!0});var _s=a(Pe);Tn=l(_s,"torch.nn.Module"),_s.forEach(t),Bn=l(Ro,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ro.forEach(t),zn=m(O),I=r(O,"DIV",{class:!0});var pe=a(I);y(qe.$$.fragment,pe),xn=m(pe),K=r(pe,"P",{});var Re=a(K);Mn=l(Re,"The "),He=r(Re,"A",{href:!0});var bs=a(He);Cn=l(bs,"BloomForCausalLM"),bs.forEach(t),Fn=l(Re," forward method, overrides the "),vo=r(Re,"CODE",{});var vs=a(vo);En=l(vs,"__call__"),vs.forEach(t),Pn=l(Re," special method."),Re.forEach(t),qn=m(pe),y(ie.$$.fragment,pe),Ln=m(pe),y(le.$$.fragment,pe),pe.forEach(t),O.forEach(t),this.h()},h(){u(d,"name","hf:doc:metadata"),u(d,"content",JSON.stringify(qs)),u(c,"id","bloom"),u(c,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(c,"href","#bloom"),u(f,"class","relative group"),u(S,"id","overview"),u(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(S,"href","#overview"),u(A,"class","relative group"),u(he,"href","https://bigscience.huggingface.co/"),u(he,"rel","nofollow"),u(X,"id","transformers.BloomConfig"),u(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(X,"href","#transformers.BloomConfig"),u(H,"class","relative group"),u(je,"href","/docs/transformers/pr_17474/en/model_doc/bloom#transformers.BloomModel"),u(ge,"href","https://huggingface.co/bigscience/bloom"),u(ge,"rel","nofollow"),u(Ie,"href","/docs/transformers/pr_17474/en/main_classes/configuration#transformers.PretrainedConfig"),u(Ne,"href","/docs/transformers/pr_17474/en/main_classes/configuration#transformers.PretrainedConfig"),u(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ee,"id","transformers.BloomModel"),u(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ee,"href","#transformers.BloomModel"),u(G,"class","relative group"),u(Se,"href","/docs/transformers/pr_17474/en/main_classes/model#transformers.PreTrainedModel"),u(ye,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(ye,"rel","nofollow"),u(De,"href","/docs/transformers/pr_17474/en/model_doc/bloom#transformers.BloomModel"),u(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ne,"id","transformers.BloomTokenizerFast"),u(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ne,"href","#transformers.BloomTokenizerFast"),u(Y,"class","relative group"),u(Oe,"href","/docs/transformers/pr_17474/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),u(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ae,"id","transformers.BloomForCausalLM"),u(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ae,"href","#transformers.BloomForCausalLM"),u(J,"class","relative group"),u(We,"href","/docs/transformers/pr_17474/en/main_classes/model#transformers.PreTrainedModel"),u(Pe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Pe,"rel","nofollow"),u(He,"href","/docs/transformers/pr_17474/en/model_doc/bloom#transformers.BloomForCausalLM"),u(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,g){e(document.head,d),b(o,v,g),b(o,f,g),e(f,c),e(c,_),w(n,_,null),e(f,h),e(f,C),e(C,W),b(o,q,g),b(o,A,g),e(A,S),e(S,Ke),w(me,Ke,null),e(A,Qo),e(A,Qe),e(Qe,Xo),b(o,Bo,g),b(o,Q,g),e(Q,Zo),e(Q,he),e(he,et),e(Q,ot),b(o,zo,g),b(o,M,g),e(M,Xe),e(Xe,tt),e(M,nt),e(M,Ze),e(Ze,st),e(M,rt),e(M,eo),e(eo,at),e(M,it),e(M,oo),e(oo,lt),e(M,dt),e(M,to),e(to,ct),e(M,pt),e(M,no),e(no,mt),b(o,xo,g),b(o,H,g),e(H,X),e(X,so),w(ue,so,null),e(H,ht),e(H,ro),e(ro,ut),b(o,Mo,g),b(o,L,g),w(fe,L,null),e(L,ft),e(L,U),e(U,gt),e(U,je),e(je,_t),e(U,bt),e(U,ge),e(ge,vt),e(U,kt),e(L,yt),e(L,V),e(V,wt),e(V,Ie),e(Ie,$t),e(V,Tt),e(V,Ne),e(Ne,Bt),e(V,zt),e(L,xt),w(Z,L,null),b(o,Co,g),b(o,G,g),e(G,ee),e(ee,ao),w(_e,ao,null),e(G,Mt),e(G,io),e(io,Ct),b(o,Fo,g),b(o,F,g),w(be,F,null),e(F,Ft),e(F,lo),e(lo,Et),e(F,Pt),e(F,ve),e(ve,qt),e(ve,Se),e(Se,Lt),e(ve,At),e(F,jt),e(F,ke),e(ke,It),e(ke,ye),e(ye,Nt),e(ke,St),e(F,Dt),e(F,j),w(we,j,null),e(j,Ot),e(j,R),e(R,Wt),e(R,De),e(De,Ht),e(R,Ut),e(R,co),e(co,Vt),e(R,Gt),e(j,Rt),w(oe,j,null),e(j,Yt),w(te,j,null),b(o,Eo,g),b(o,Y,g),e(Y,ne),e(ne,po),w($e,po,null),e(Y,Jt),e(Y,mo),e(mo,Kt),b(o,Po,g),b(o,z,g),w(Te,z,null),e(z,Qt),e(z,Be),e(Be,Xt),e(Be,ho),e(ho,Zt),e(Be,en),e(z,on),e(z,uo),e(uo,tn),e(z,nn),w(se,z,null),e(z,sn),e(z,ze),e(ze,rn),e(ze,fo),e(fo,an),e(ze,ln),e(z,dn),w(re,z,null),e(z,cn),e(z,xe),e(xe,pn),e(xe,Oe),e(Oe,mn),e(xe,hn),b(o,qo,g),b(o,J,g),e(J,ae),e(ae,go),w(Me,go,null),e(J,un),e(J,_o),e(_o,fn),b(o,Lo,g),b(o,E,g),w(Ce,E,null),e(E,gn),e(E,bo),e(bo,_n),e(E,bn),e(E,Fe),e(Fe,vn),e(Fe,We),e(We,kn),e(Fe,yn),e(E,wn),e(E,Ee),e(Ee,$n),e(Ee,Pe),e(Pe,Tn),e(Ee,Bn),e(E,zn),e(E,I),w(qe,I,null),e(I,xn),e(I,K),e(K,Mn),e(K,He),e(He,Cn),e(K,Fn),e(K,vo),e(vo,En),e(K,Pn),e(I,qn),w(ie,I,null),e(I,Ln),w(le,I,null),Ao=!0},p(o,[g]){const Le={};g&2&&(Le.$$scope={dirty:g,ctx:o}),Z.$set(Le);const ko={};g&2&&(ko.$$scope={dirty:g,ctx:o}),oe.$set(ko);const yo={};g&2&&(yo.$$scope={dirty:g,ctx:o}),te.$set(yo);const wo={};g&2&&(wo.$$scope={dirty:g,ctx:o}),se.$set(wo);const Ae={};g&2&&(Ae.$$scope={dirty:g,ctx:o}),re.$set(Ae);const $o={};g&2&&($o.$$scope={dirty:g,ctx:o}),ie.$set($o);const To={};g&2&&(To.$$scope={dirty:g,ctx:o}),le.$set(To)},i(o){Ao||($(n.$$.fragment,o),$(me.$$.fragment,o),$(ue.$$.fragment,o),$(fe.$$.fragment,o),$(Z.$$.fragment,o),$(_e.$$.fragment,o),$(be.$$.fragment,o),$(we.$$.fragment,o),$(oe.$$.fragment,o),$(te.$$.fragment,o),$($e.$$.fragment,o),$(Te.$$.fragment,o),$(se.$$.fragment,o),$(re.$$.fragment,o),$(Me.$$.fragment,o),$(Ce.$$.fragment,o),$(qe.$$.fragment,o),$(ie.$$.fragment,o),$(le.$$.fragment,o),Ao=!0)},o(o){T(n.$$.fragment,o),T(me.$$.fragment,o),T(ue.$$.fragment,o),T(fe.$$.fragment,o),T(Z.$$.fragment,o),T(_e.$$.fragment,o),T(be.$$.fragment,o),T(we.$$.fragment,o),T(oe.$$.fragment,o),T(te.$$.fragment,o),T($e.$$.fragment,o),T(Te.$$.fragment,o),T(se.$$.fragment,o),T(re.$$.fragment,o),T(Me.$$.fragment,o),T(Ce.$$.fragment,o),T(qe.$$.fragment,o),T(ie.$$.fragment,o),T(le.$$.fragment,o),Ao=!1},d(o){t(d),o&&t(v),o&&t(f),B(n),o&&t(q),o&&t(A),B(me),o&&t(Bo),o&&t(Q),o&&t(zo),o&&t(M),o&&t(xo),o&&t(H),B(ue),o&&t(Mo),o&&t(L),B(fe),B(Z),o&&t(Co),o&&t(G),B(_e),o&&t(Fo),o&&t(F),B(be),B(we),B(oe),B(te),o&&t(Eo),o&&t(Y),B($e),o&&t(Po),o&&t(z),B(Te),B(se),B(re),o&&t(qo),o&&t(J),B(Me),o&&t(Lo),o&&t(E),B(Ce),B(qe),B(ie),B(le)}}}const qs={local:"bloom",sections:[{local:"overview",title:"Overview"},{local:"transformers.BloomConfig",title:"BloomConfig"},{local:"transformers.BloomModel",title:"BloomModel"},{local:"transformers.BloomTokenizerFast",title:"BloomTokenizerFast"},{local:"transformers.BloomForCausalLM",title:"BloomForCausalLM"}],title:"BLOOM"};function Ls(x){return Ts(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Os extends ks{constructor(d){super();ys(this,d,Ls,Ps,ws,{})}}export{Os as default,qs as metadata};
