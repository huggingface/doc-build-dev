...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18000/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_distilbert.py#L625",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_distilbert.py#L723",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_distilbert.py#L1051",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_distilbert.py#L956",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_distilbert.py#L839",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xk=p(),Pa=o("p"),Yk=a("This model is also a Flax Linen "),Aa=o("a"),Zk=a("flax.linen.Module"),e0=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t0=p(),ac=o("p"),s0=a("Finally, this model supports inherent JAX features such as:"),o0=p(),zt=o("ul"),ic=o("li"),Oa=o("a"),n0=a("Just-In-Time (JIT) compilation"),r0=p(),lc=o("li"),Na=o("a"),a0=a("Automatic Differentiation"),i0=p(),dc=o("li"),La=o("a"),l0=a("Vectorization"),d0=p(),cc=o("li"),Sa=o("a"),c0=a("Parallelization"),p0=p(),bt=o("div"),T(Ia.$$.fragment),h0=p(),Ps=o("p"),u0=a("The "),pc=o("code"),f0=a("FlaxDistilBertPreTrainedModel"),m0=a(" forward method, overrides the "),hc=o("code"),g0=a("__call__"),_0=a(" special method."),b0=p(),T(sn.$$.fragment),v0=p(),T(on.$$.fragment),ph=p(),As=o("h2"),nn=o("a"),uc=o("span"),T(Wa.$$.fragment),k0=p(),fc=o("span"),T0=a("FlaxDistilBertForMultipleChoice"),hh=p(),je=o("div"),T(Qa.$$.fragment),$0=p(),mc=o("p"),w0=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),y0=p(),Ra=o("p"),D0=a("This model inherits from "),dl=o("a"),F0=a("FlaxPreTrainedModel"),B0=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),x0=p(),Ua=o("p"),M0=a("This model is also a Flax Linen "),Ha=o("a"),E0=a("flax.linen.Module"),z0=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),j0=p(),gc=o("p"),C0=a("Finally, this model supports inherent JAX features such as:"),q0=p(),jt=o("ul"),_c=o("li"),Ka=o("a"),P0=a("Just-In-Time (JIT) compilation"),A0=p(),bc=o("li"),Va=o("a"),O0=a("Automatic Differentiation"),N0=p(),vc=o("li"),Ja=o("a"),L0=a("Vectorization"),S0=p(),kc=o("li"),Ga=o("a"),I0=a("Parallelization"),W0=p(),vt=o("div"),T(Xa.$$.fragment),Q0=p(),Os=o("p"),R0=a("The "),Tc=o("code"),U0=a("FlaxDistilBertPreTrainedModel"),H0=a(" forward method, overrides the "),$c=o("code"),K0=a("__call__"),V0=a(" special method."),J0=p(),T(rn.$$.fragment),G0=p(),T(an.$$.fragment),uh=p(),Ns=o("h2"),ln=o("a"),wc=o("span"),T(Ya.$$.fragment),X0=p(),yc=o("span"),Y0=a("FlaxDistilBertForTokenClassification"),fh=p(),Ce=o("div"),T(Za.$$.fragment),Z0=p(),Dc=o("p"),eT=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xk=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yk=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q1=r(Aa);Zk=i(Q1,"flax.linen.Module"),Q1.forEach(t),e0=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),t0=h(nt),ac=n(nt,"P",{});var R1=r(ac);s0=i(R1,"Finally, this model supports inherent JAX features such as:"),R1.forEach(t),o0=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U1=r(ic);Oa=n(U1,"A",{href:!0,rel:!0});var H1=r(Oa);n0=i(H1,"Just-In-Time (JIT) compilation"),H1.forEach(t),U1.forEach(t),r0=h(yn),lc=n(yn,"LI",{});var K1=r(lc);Na=n(K1,"A",{href:!0,rel:!0});var V1=r(Na);a0=i(V1,"Automatic Differentiation"),V1.forEach(t),K1.forEach(t),i0=h(yn),dc=n(yn,"LI",{});var J1=r(dc);La=n(J1,"A",{href:!0,rel:!0});var G1=r(La);l0=i(G1,"Vectorization"),G1.forEach(t),J1.forEach(t),d0=h(yn),cc=n(yn,"LI",{});var X1=r(cc);Sa=n(X1,"A",{href:!0,rel:!0});var Y1=r(Sa);c0=i(Y1,"Parallelization"),Y1.forEach(t),X1.forEach(t),yn.forEach(t),p0=h(nt),bt=n(nt,"DIV",{class:!0});var Dn=r(bt);$(Ia.$$.fragment,Dn),h0=h(Dn),Ps=n(Dn,"P",{});var xl=r(Ps);u0=i(xl,"The "),pc=n(xl,"CODE",{});var Z1=r(pc);f0=i(Z1,"FlaxDistilBertPreTrainedModel"),Z1.forEach(t),m0=i(xl," forward method, overrides the "),hc=n(xl,"CODE",{});var ey=r(hc);g0=i(ey,"__call__"),ey.forEach(t),_0=i(xl," special method."),xl.forEach(t),b0=h(Dn),$(sn.$$.fragment,Dn),v0=h(Dn),$(on.$$.fragment,Dn),Dn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),k0=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);T0=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$0=h(rt),mc=n(rt,"P",{});var ny=r(mc);w0=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),ny.forEach(t),y0=h(rt),Ra=n(rt,"P",{});var mu=r(Ra);D0=i(mu,"This model inherits from "),dl=n(mu,"A",{href:!0});var ry=r(dl);F0=i(ry,"FlaxPreTrainedModel"),ry.forEach(t),B0=i(mu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mu.forEach(t),x0=h(rt),Ua=n(rt,"P",{});var gu=r(Ua);M0=i(gu,"This model is also a Flax Linen "),Ha=n(gu,"A",{href:!0,rel:!0});var ay=r(Ha);E0=i(ay,"flax.linen.Module"),ay.forEach(t),z0=i(gu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),j0=h(rt),gc=n(rt,"P",{});var iy=r(gc);C0=i(iy,"Finally, this model supports inherent JAX features such as:"),iy.forEach(t),q0=h(rt),jt=n(rt,"UL",{});var Fn=r(jt);_c=n(Fn,"LI",{});var ly=r(_c);Ka=n(ly,"A",{href:!0,rel:!0});var dy=r(Ka);P0=i(dy,"Just-In-Time (JIT) compilation"),dy.forEach(t),ly.forEach(t),A0=h(Fn),bc=n(Fn,"LI",{});var cy=r(bc);Va=n(cy,"A",{href:!0,rel:!0});var py=r(Va);O0=i(py,"Automatic Differentiation"),py.forEach(t),cy.forEach(t),N0=h(Fn),vc=n(Fn,"LI",{});var hy=r(vc);Ja=n(hy,"A",{href:!0,rel:!0});var uy=r(Ja);L0=i(uy,"Vectorization"),uy.forEach(t),hy.forEach(t),S0=h(Fn),kc=n(Fn,"LI",{});var fy=r(kc);Ga=n(fy,"A",{href:!0,rel:!0});var my=r(Ga);I0=i(my,"Parallelization"),my.forEach(t),fy.forEach(t),Fn.forEach(t),W0=h(rt),vt=n(rt,"DIV",{class:!0});var Bn=r(vt);$(Xa.$$.fragment,Bn),Q0=h(Bn),Os=n(Bn,"P",{});var Ml=r(Os);R0=i(Ml,"The "),Tc=n(Ml,"CODE",{});var gy=r(Tc);U0=i(gy,"FlaxDistilBertPreTrainedModel"),gy.forEach(t),H0=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _y=r($c);K0=i(_y,"__call__"),_y.forEach(t),V0=i(Ml," special method."),Ml.forEach(t),J0=h(Bn),$(rn.$$.fragment,Bn),G0=h(Bn),$(an.$$.fragment,Bn),Bn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var by=r(ln);wc=n(by,"SPAN",{});var vy=r(wc);$(Ya.$$.fragment,vy),vy.forEach(t),by.forEach(t),X0=h(_u),yc=n(_u,"SPAN",{});var ky=r(yc);Y0=i(ky,"FlaxDistilBertForTokenClassification"),ky.forEach(t),_u.forEach(t),fh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),Z0=h(at),Dc=n(at,"P",{});var Ty=r(Dc);eT=i(Ty,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
