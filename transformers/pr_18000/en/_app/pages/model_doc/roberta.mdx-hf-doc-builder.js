...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/tokenization_roberta.py#L396",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qv=p(),dt=n("div"),T(Cr.$$.fragment),Jv=p(),Lo=n("p"),Vv=r("The "),bd=n("a"),Kv=r("RobertaForQuestionAnswering"),Gv=r(" forward method, overrides the "),pp=n("code"),Xv=r("__call__"),Yv=r(" special method."),Zv=p(),T(Zn.$$.fragment),e0=p(),T(es.$$.fragment),t0=p(),T(ts.$$.fragment),pm=p(),Ao=n("h2"),os=n("a"),hp=n("span"),T(jr.$$.fragment),o0=p(),up=n("span"),n0=r("TFRobertaModel"),hm=p(),Qe=n("div"),T(Pr.$$.fragment),s0=p(),mp=n("p"),a0=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),r0=p(),Lr=n("p"),i0=r("This model inherits from "),kd=n("a"),l0=r("TFPreTrainedModel"),d0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),c0=p(),Ar=n("p"),p0=r("This model is also a "),Or=n("a"),h0=r("tf.keras.Model"),u0=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),m0=p(),T(ns.$$.fragment),f0=p(),Rt=n("div"),T(Nr.$$.fragment),g0=p(),Oo=n("p"),_0=r("The "),vd=n("a"),b0=r("TFRobertaModel"),k0=r(" forward method, overrides the "),fp=n("code"),v0=r("__call__"),T0=r(" special method."),y0=p(),T(ss.$$.fragment),w0=p(),T(as.$$.fragment),um=p(),No=n("h2"),rs=n("a"),gp=n("span"),T(Ir.$$.fragment),$0=p(),_p=n("span"),F0=r("TFRobertaForCausalLM"),mm=p(),Io=n("div"),T(Dr.$$.fragment),x0=p(),Mt=n("div"),T(Sr.$$.fragment),R0=p(),Do=n("p"),M0=r("The "),Td=n("a"),E0=r("TFRobertaForCausalLM"),z0=r(" forward method, overrides the "),bp=n("code"),q0=r("__call__"),C0=r(" special method."),j0=p(),T(is.$$.fragment),P0=p(),T(ls.$$.fragment),fm=p(),So=n("h2"),ds=n("a"),kp=n("span"),T(Wr.$$.fragment),L0=p(),vp=n("span"),A0=r("TFRobertaForMaskedLM"),gm=p(),Je=n("div"),T(Br.$$.fragment),O0=p(),Ur=n("p"),N0=r("RoBERTa Model with a "),Tp=n("code"),I0=r("language modeling"),D0=r(" head on top."),S0=p(),Hr=n("p"),W0=r("This model inherits from "),yd=n("a"),B0=r("TFPreTrainedModel"),U0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),H0=p(),Qr=n("p"),Q0=r("This model is also a "),Jr=n("a"),J0=r("tf.keras.Model"),V0=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),K0=p(),T(cs.$$.fragment),G0=p(),ct=n("div"),T(Vr.$$.fragment),X0=p(),Wo=n("p"),Y0=r("The "),wd=n("a"),Z0=r("TFRobertaForMaskedLM"),eT=r(" forward method, overrides the "),yp=n("code"),tT=r("__call__"),oT=r(" special method."),nT=p(),T(ps.$$.fragment),sT=p(),T(hs.$$.fragment),aT=p(),T(us.$$.fragment),_m=p(),Bo=n("h2"),ms=n("a"),wp=n("span"),T(Kr.$$.fragment),rT=p(),$p=n("span"),iT=r("TFRobertaForSequenceClassification"),bm=p(),Ve=n("div"),T(Gr.$$.fragment),lT=p(),Fp=n("p"),dT=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Aw=p(),Zp=n("p"),Ow=r("Finally, this model supports inherent JAX features such as:"),Nw=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),Iw=r("Just-In-Time (JIT) compilation"),Dw=p(),th=n("li"),Li=n("a"),Sw=r("Automatic Differentiation"),Ww=p(),oh=n("li"),Ai=n("a"),Bw=r("Vectorization"),Uw=p(),nh=n("li"),Oi=n("a"),Hw=r("Parallelization"),Qw=p(),qt=n("div"),T(Ni.$$.fragment),Jw=p(),tn=n("p"),Vw=r("The "),sh=n("code"),Kw=r("FlaxRobertaPreTrainedModel"),Gw=r(" forward method, overrides the "),ah=n("code"),Xw=r("__call__"),Yw=r(" special method."),Zw=p(),T(Os.$$.fragment),e1=p(),T(Ns.$$.fragment),Em=p(),on=n("h2"),Is=n("a"),rh=n("span"),T(Ii.$$.fragment),t1=p(),ih=n("span"),o1=r("FlaxRobertaForMaskedLM"),zm=p(),Ie=n("div"),T(Di.$$.fragment),n1=p(),Si=n("p"),s1=r("RoBERTa Model with a "),lh=n("code"),a1=r("language modeling"),r1=r(" head on top."),i1=p(),Wi=n("p"),l1=r("This model inherits from "),Pd=n("a"),d1=r("FlaxPreTrainedModel"),c1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),p1=p(),Bi=n("p"),h1=r("This model is also a Flax Linen "),Ui=n("a"),u1=r("flax.linen.Module"),m1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),f1=p(),dh=n("p"),g1=r("Finally, this model supports inherent JAX features such as:"),_1=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),b1=r("Just-In-Time (JIT) compilation"),k1=p(),ph=n("li"),Qi=n("a"),v1=r("Automatic Differentiation"),T1=p(),hh=n("li"),Ji=n("a"),y1=r("Vectorization"),w1=p(),uh=n("li"),Vi=n("a"),$1=r("Parallelization"),F1=p(),Ct=n("div"),T(Ki.$$.fragment),x1=p(),nn=n("p"),R1=r("The "),mh=n("code"),M1=r("FlaxRobertaPreTrainedModel"),E1=r(" forward method, overrides the "),fh=n("code"),z1=r("__call__"),q1=r(" special method."),C1=p(),T(Ds.$$.fragment),j1=p(),T(Ss.$$.fragment),qm=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),T(Gi.$$.fragment),P1=p(),_h=n("span"),L1=r("FlaxRobertaForSequenceClassification"),Cm=p(),De=n("div"),T(Xi.$$.fragment),A1=p(),bh=n("p"),O1=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q1=p(),kh=n("p"),J1=r("Finally, this model supports inherent JAX features such as:"),V1=p(),Jt=n("ul"),vh=n("li"),tl=n("a"),K1=r("Just-In-Time (JIT) compilation"),G1=p(),Th=n("li"),ol=n("a"),X1=r("Automatic Differentiation"),Y1=p(),yh=n("li"),nl=n("a"),Z1=r("Vectorization"),e$=p(),wh=n("li"),sl=n("a"),t$=r("Parallelization"),o$=p(),jt=n("div"),T(al.$$.fragment),n$=p(),an=n("p"),s$=r("The "),$h=n("code"),a$=r("FlaxRobertaPreTrainedModel"),r$=r(" forward method, overrides the "),Fh=n("code"),i$=r("__call__"),l$=r(" special method."),d$=p(),T(Bs.$$.fragment),c$=p(),T(Us.$$.fragment),jm=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),T(rl.$$.fragment),p$=p(),Rh=n("span"),h$=r("FlaxRobertaForMultipleChoice"),Pm=p(),Se=n("div"),T(il.$$.fragment),u$=p(),Mh=n("p"),m$=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),f$=p(),ll=n("p"),g$=r("This model inherits from "),Ad=n("a"),_$=r("FlaxPreTrainedModel"),b$=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w$=p(),Eh=n("p"),$$=r("Finally, this model supports inherent JAX features such as:"),F$=p(),Vt=n("ul"),zh=n("li"),pl=n("a"),x$=r("Just-In-Time (JIT) compilation"),R$=p(),qh=n("li"),hl=n("a"),M$=r("Automatic Differentiation"),E$=p(),Ch=n("li"),ul=n("a"),z$=r("Vectorization"),q$=p(),jh=n("li"),ml=n("a"),C$=r("Parallelization"),j$=p(),Pt=n("div"),T(fl.$$.fragment),P$=p(),ln=n("p"),L$=r("The "),Ph=n("code"),A$=r("FlaxRobertaPreTrainedModel"),O$=r(" forward method, overrides the "),Lh=n("code"),N$=r("__call__"),I$=r(" special method."),D$=p(),T(Qs.$$.fragment),S$=p(),T(Js.$$.fragment),Lm=p(),dn=n("h2"),Vs=n("a"),Ah=n("span"),T(gl.$$.fragment),W$=p(),Oh=n("span"),B$=r("FlaxRobertaForTokenClassification"),Am=p(),We=n("div"),T(_l.$$.fragment),U$=p(),Nh=n("p"),H$=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ff.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var Tx=a(bd);Kv=i(Tx,"RobertaForQuestionAnswering"),Tx.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var yx=a(pp);Xv=i(yx,"__call__"),yx.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),e0=h(po),y(es.$$.fragment,po),t0=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),pm=h(o),Ao=s(o,"H2",{class:!0});var gf=a(Ao);os=s(gf,"A",{id:!0,class:!0,href:!0});var wx=a(os);hp=s(wx,"SPAN",{});var $x=a(hp);y(jr.$$.fragment,$x),$x.forEach(t),wx.forEach(t),o0=h(gf),up=s(gf,"SPAN",{});var Fx=a(up);n0=i(Fx,"TFRobertaModel"),Fx.forEach(t),gf.forEach(t),hm=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),s0=h(Ot),mp=s(Ot,"P",{});var xx=a(mp);a0=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),r0=h(Ot),Lr=s(Ot,"P",{});var _f=a(Lr);i0=i(_f,"This model inherits from "),kd=s(_f,"A",{href:!0});var Rx=a(kd);l0=i(Rx,"TFPreTrainedModel"),Rx.forEach(t),d0=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_f.forEach(t),c0=h(Ot),Ar=s(Ot,"P",{});var bf=a(Ar);p0=i(bf,"This model is also a "),Or=s(bf,"A",{href:!0,rel:!0});var Mx=a(Or);h0=i(Mx,"tf.keras.Model"),Mx.forEach(t),u0=i(bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bf.forEach(t),m0=h(Ot),y(ns.$$.fragment,Ot),f0=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),g0=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_0=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var Ex=a(vd);b0=i(Ex,"TFRobertaModel"),Ex.forEach(t),k0=i(Gd," forward method, overrides the "),fp=s(Gd,"CODE",{});var zx=a(fp);v0=i(zx,"__call__"),zx.forEach(t),T0=i(Gd," special method."),Gd.forEach(t),y0=h(na),y(ss.$$.fragment,na),w0=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),um=h(o),No=s(o,"H2",{class:!0});var kf=a(No);rs=s(kf,"A",{id:!0,class:!0,href:!0});var qx=a(rs);gp=s(qx,"SPAN",{});var Cx=a(gp);y(Ir.$$.fragment,Cx),Cx.forEach(t),qx.forEach(t),$0=h(kf),_p=s(kf,"SPAN",{});var jx=a(_p);F0=i(jx,"TFRobertaForCausalLM"),jx.forEach(t),kf.forEach(t),mm=h(o),Io=s(o,"DIV",{class:!0});var vf=a(Io);y(Dr.$$.fragment,vf),x0=h(vf),Mt=s(vf,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),R0=h(sa),Do=s(sa,"P",{});var Xd=a(Do);M0=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var Px=a(Td);E0=i(Px,"TFRobertaForCausalLM"),Px.forEach(t),z0=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var Lx=a(bp);q0=i(Lx,"__call__"),Lx.forEach(t),C0=i(Xd," special method."),Xd.forEach(t),j0=h(sa),y(is.$$.fragment,sa),P0=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vf.forEach(t),fm=h(o),So=s(o,"H2",{class:!0});var Tf=a(So);ds=s(Tf,"A",{id:!0,class:!0,href:!0});var Ax=a(ds);kp=s(Ax,"SPAN",{});var Ox=a(kp);y(Wr.$$.fragment,Ox),Ox.forEach(t),Ax.forEach(t),L0=h(Tf),vp=s(Tf,"SPAN",{});var Nx=a(vp);A0=i(Nx,"TFRobertaForMaskedLM"),Nx.forEach(t),Tf.forEach(t),gm=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),O0=h(Nt),Ur=s(Nt,"P",{});var yf=a(Ur);N0=i(yf,"RoBERTa Model with a "),Tp=s(yf,"CODE",{});var Ix=a(Tp);I0=i(Ix,"language modeling"),Ix.forEach(t),D0=i(yf," head on top."),yf.forEach(t),S0=h(Nt),Hr=s(Nt,"P",{});var wf=a(Hr);W0=i(wf,"This model inherits from "),yd=s(wf,"A",{href:!0});var Dx=a(yd);B0=i(Dx,"TFPreTrainedModel"),Dx.forEach(t),U0=i(wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wf.forEach(t),H0=h(Nt),Qr=s(Nt,"P",{});var $f=a(Qr);Q0=i($f,"This model is also a "),Jr=s($f,"A",{href:!0,rel:!0});var Sx=a(Jr);J0=i(Sx,"tf.keras.Model"),Sx.forEach(t),V0=i($f,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$f.forEach(t),K0=h(Nt),y(cs.$$.fragment,Nt),G0=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),X0=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Y0=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var Wx=a(wd);Z0=i(Wx,"TFRobertaForMaskedLM"),Wx.forEach(t),eT=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var Bx=a(yp);tT=i(Bx,"__call__"),Bx.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),y(ps.$$.fragment,ho),sT=h(ho),y(hs.$$.fragment,ho),aT=h(ho),y(us.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),_m=h(o),Bo=s(o,"H2",{class:!0});var Ff=a(Bo);ms=s(Ff,"A",{id:!0,class:!0,href:!0});var Ux=a(ms);wp=s(Ux,"SPAN",{});var Hx=a(wp);y(Kr.$$.fragment,Hx),Hx.forEach(t),Ux.forEach(t),rT=h(Ff),$p=s(Ff,"SPAN",{});var Qx=a($p);iT=i(Qx,"TFRobertaForSequenceClassification"),Qx.forEach(t),Ff.forEach(t),bm=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var Jx=a(Fp);dT=i(Jx,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wf.forEach(t),Aw=h(_t),Zp=s(_t,"P",{});var QR=a(Zp);Ow=i(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),Nw=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var JR=a(eh);Pi=s(JR,"A",{href:!0,rel:!0});var VR=a(Pi);Iw=i(VR,"Just-In-Time (JIT) compilation"),VR.forEach(t),JR.forEach(t),Dw=h(la),th=s(la,"LI",{});var KR=a(th);Li=s(KR,"A",{href:!0,rel:!0});var GR=a(Li);Sw=i(GR,"Automatic Differentiation"),GR.forEach(t),KR.forEach(t),Ww=h(la),oh=s(la,"LI",{});var XR=a(oh);Ai=s(XR,"A",{href:!0,rel:!0});var YR=a(Ai);Bw=i(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),Uw=h(la),nh=s(la,"LI",{});var ZR=a(nh);Oi=s(ZR,"A",{href:!0,rel:!0});var eM=a(Oi);Hw=i(eM,"Parallelization"),eM.forEach(t),ZR.forEach(t),la.forEach(t),Qw=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);y(Ni.$$.fragment,da),Jw=h(da),tn=s(da,"P",{});var ac=a(tn);Vw=i(ac,"The "),sh=s(ac,"CODE",{});var tM=a(sh);Kw=i(tM,"FlaxRobertaPreTrainedModel"),tM.forEach(t),Gw=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oM=a(ah);Xw=i(oM,"__call__"),oM.forEach(t),Yw=i(ac," special method."),ac.forEach(t),Zw=h(da),y(Os.$$.fragment,da),e1=h(da),y(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),Em=h(o),on=s(o,"H2",{class:!0});var Bf=a(on);Is=s(Bf,"A",{id:!0,class:!0,href:!0});var nM=a(Is);rh=s(nM,"SPAN",{});var sM=a(rh);y(Ii.$$.fragment,sM),sM.forEach(t),nM.forEach(t),t1=h(Bf),ih=s(Bf,"SPAN",{});var aM=a(ih);o1=i(aM,"FlaxRobertaForMaskedLM"),aM.forEach(t),Bf.forEach(t),zm=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);y(Di.$$.fragment,bt),n1=h(bt),Si=s(bt,"P",{});var Uf=a(Si);s1=i(Uf,"RoBERTa Model with a "),lh=s(Uf,"CODE",{});var rM=a(lh);a1=i(rM,"language modeling"),rM.forEach(t),r1=i(Uf," head on top."),Uf.forEach(t),i1=h(bt),Wi=s(bt,"P",{});var Hf=a(Wi);l1=i(Hf,"This model inherits from "),Pd=s(Hf,"A",{href:!0});var iM=a(Pd);d1=i(iM,"FlaxPreTrainedModel"),iM.forEach(t),c1=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hf.forEach(t),p1=h(bt),Bi=s(bt,"P",{});var Qf=a(Bi);h1=i(Qf,"This model is also a Flax Linen "),Ui=s(Qf,"A",{href:!0,rel:!0});var lM=a(Ui);u1=i(lM,"flax.linen.Module"),lM.forEach(t),m1=i(Qf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qf.forEach(t),f1=h(bt),dh=s(bt,"P",{});var dM=a(dh);g1=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_1=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);b1=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),k1=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var uM=a(Qi);v1=i(uM,"Automatic Differentiation"),uM.forEach(t),hM.forEach(t),T1=h(ca),hh=s(ca,"LI",{});var mM=a(hh);Ji=s(mM,"A",{href:!0,rel:!0});var fM=a(Ji);y1=i(fM,"Vectorization"),fM.forEach(t),mM.forEach(t),w1=h(ca),uh=s(ca,"LI",{});var gM=a(uh);Vi=s(gM,"A",{href:!0,rel:!0});var _M=a(Vi);$1=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),F1=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);y(Ki.$$.fragment,pa),x1=h(pa),nn=s(pa,"P",{});var rc=a(nn);R1=i(rc,"The "),mh=s(rc,"CODE",{});var bM=a(mh);M1=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),E1=i(rc," forward method, overrides the "),fh=s(rc,"CODE",{});var kM=a(fh);z1=i(kM,"__call__"),kM.forEach(t),q1=i(rc," special method."),rc.forEach(t),C1=h(pa),y(Ds.$$.fragment,pa),j1=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qm=h(o),sn=s(o,"H2",{class:!0});var Jf=a(sn);Ws=s(Jf,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var TM=a(gh);y(Gi.$$.fragment,TM),TM.forEach(t),vM.forEach(t),P1=h(Jf),_h=s(Jf,"SPAN",{});var yM=a(_h);L1=i(yM,"FlaxRobertaForSequenceClassification"),yM.forEach(t),Jf.forEach(t),Cm=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A1=h(kt),bh=s(kt,"P",{});var wM=a(bh);O1=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Kf.forEach(t),Q1=h(kt),kh=s(kt,"P",{});var xM=a(kh);J1=i(xM,"Finally, this model supports inherent JAX features such as:"),xM.forEach(t),V1=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RM=a(vh);tl=s(RM,"A",{href:!0,rel:!0});var MM=a(tl);K1=i(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),RM.forEach(t),G1=h(ha),Th=s(ha,"LI",{});var EM=a(Th);ol=s(EM,"A",{href:!0,rel:!0});var zM=a(ol);X1=i(zM,"Automatic Differentiation"),zM.forEach(t),EM.forEach(t),Y1=h(ha),yh=s(ha,"LI",{});var qM=a(yh);nl=s(qM,"A",{href:!0,rel:!0});var CM=a(nl);Z1=i(CM,"Vectorization"),CM.forEach(t),qM.forEach(t),e$=h(ha),wh=s(ha,"LI",{});var jM=a(wh);sl=s(jM,"A",{href:!0,rel:!0});var PM=a(sl);t$=i(PM,"Parallelization"),PM.forEach(t),jM.forEach(t),ha.forEach(t),o$=h(kt),jt=s(kt,"DIV",{class:!0});var ua=a(jt);y(al.$$.fragment,ua),n$=h(ua),an=s(ua,"P",{});var ic=a(an);s$=i(ic,"The "),$h=s(ic,"CODE",{});var LM=a($h);a$=i(LM,"FlaxRobertaPreTrainedModel"),LM.forEach(t),r$=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AM=a(Fh);i$=i(AM,"__call__"),AM.forEach(t),l$=i(ic," special method."),ic.forEach(t),d$=h(ua),y(Bs.$$.fragment,ua),c$=h(ua),y(Us.$$.fragment,ua),ua.forEach(t),kt.forEach(t),jm=h(o),rn=s(o,"H2",{class:!0});var Gf=a(rn);Hs=s(Gf,"A",{id:!0,class:!0,href:!0});var OM=a(Hs);xh=s(OM,"SPAN",{});var NM=a(xh);y(rl.$$.fragment,NM),NM.forEach(t),OM.forEach(t),p$=h(Gf),Rh=s(Gf,"SPAN",{});var IM=a(Rh);h$=i(IM,"FlaxRobertaForMultipleChoice"),IM.forEach(t),Gf.forEach(t),Pm=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),u$=h(vt),Mh=s(vt,"P",{});var DM=a(Mh);m$=i(DM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DM.forEach(t),f$=h(vt),ll=s(vt,"P",{});var Xf=a(ll);g$=i(Xf,"This model inherits from "),Ad=s(Xf,"A",{href:!0});var SM=a(Ad);_$=i(SM,"FlaxPreTrainedModel"),SM.forEach(t),b$=i(Xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xf.forEach(t),k$=h(vt),dl=s(vt,"P",{});var Yf=a(dl);v$=i(Yf,"This model is also a Flax Linen "),cl=s(Yf,"A",{href:!0,rel:!0});var WM=a(cl);T$=i(WM,"flax.linen.Module"),WM.forEach(t),y$=i(Yf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yf.forEach(t),w$=h(vt),Eh=s(vt,"P",{});var BM=a(Eh);$$=i(BM,"Finally, this model supports inherent JAX features such as:"),BM.forEach(t),F$=h(vt),Vt=s(vt,"UL",{});var ma=a(Vt);zh=s(ma,"LI",{});var UM=a(zh);pl=s(UM,"A",{href:!0,rel:!0});var HM=a(pl);x$=i(HM,"Just-In-Time (JIT) compilation"),HM.forEach(t),UM.forEach(t),R$=h(ma),qh=s(ma,"LI",{});var QM=a(qh);hl=s(QM,"A",{href:!0,rel:!0});var JM=a(hl);M$=i(JM,"Automatic Differentiation"),JM.forEach(t),QM.forEach(t),E$=h(ma),Ch=s(ma,"LI",{});var VM=a(Ch);ul=s(VM,"A",{href:!0,rel:!0});var KM=a(ul);z$=i(KM,"Vectorization"),KM.forEach(t),VM.forEach(t),q$=h(ma),jh=s(ma,"LI",{});var GM=a(jh);ml=s(GM,"A",{href:!0,rel:!0});var XM=a(ml);C$=i(XM,"Parallelization"),XM.forEach(t),GM.forEach(t),ma.forEach(t),j$=h(vt),Pt=s(vt,"DIV",{class:!0});var fa=a(Pt);y(fl.$$.fragment,fa),P$=h(fa),ln=s(fa,"P",{});var lc=a(ln);L$=i(lc,"The "),Ph=s(lc,"CODE",{});var YM=a(Ph);A$=i(YM,"FlaxRobertaPreTrainedModel"),YM.forEach(t),O$=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZM=a(Lh);N$=i(ZM,"__call__"),ZM.forEach(t),I$=i(lc," special method."),lc.forEach(t),D$=h(fa),y(Qs.$$.fragment,fa),S$=h(fa),y(Js.$$.fragment,fa),fa.forEach(t),vt.forEach(t),Lm=h(o),dn=s(o,"H2",{class:!0});var Zf=a(dn);Vs=s(Zf,"A",{id:!0,class:!0,href:!0});var eE=a(Vs);Ah=s(eE,"SPAN",{});var tE=a(Ah);y(gl.$$.fragment,tE),tE.forEach(t),eE.forEach(t),W$=h(Zf),Oh=s(Zf,"SPAN",{});var oE=a(Oh);B$=i(oE,"FlaxRobertaForTokenClassification"),oE.forEach(t),Zf.forEach(t),Am=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U$=h(Tt),Nh=s(Tt,"P",{});var nE=a(Nh);H$=i(nE,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
