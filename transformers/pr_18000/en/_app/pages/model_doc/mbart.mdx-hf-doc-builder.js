...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/tokenization_mbart.py#L222",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/tokenization_mbart_fast.py#L165",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/tokenization_mbart_fast.py#L194",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart50/tokenization_mbart50.py#L289",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart50/tokenization_mbart50.py#L259",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L173",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18000/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18000/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18000/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Cv=p(),hc=a("p"),Pv=i("Finally, this model supports inherent JAX features such as:"),Sv=p(),_t=a("ul"),mc=a("li"),Ir=a("a"),Av=i("Just-In-Time (JIT) compilation"),Ov=p(),fc=a("li"),Nr=a("a"),Iv=i("Automatic Differentiation"),Nv=p(),_c=a("li"),Dr=a("a"),Dv=i("Vectorization"),Lv=p(),gc=a("li"),Lr=a("a"),Gv=i("Parallelization"),Wv=p(),tt=a("div"),y(Gr.$$.fragment),Rv=p(),go=a("p"),Uv=i("The "),bc=a("code"),Xv=i("FlaxMBartPreTrainedModel"),Qv=i(" forward method, overrides the "),kc=a("code"),Hv=i("__call__"),Vv=i(" special method."),Jv=p(),y(Nn.$$.fragment),Kv=p(),y(Dn.$$.fragment),Zv=p(),Ln=a("div"),y(Wr.$$.fragment),Yv=p(),y(Gn.$$.fragment),e0=p(),Wn=a("div"),y(Rr.$$.fragment),t0=p(),y(Rn.$$.fragment),Yp=p(),bo=a("h2"),Un=a("a"),yc=a("span"),y(Ur.$$.fragment),o0=p(),vc=a("span"),n0=i("FlaxMBartForQuestionAnswering"),eu=p(),D=a("div"),y(Xr.$$.fragment),a0=p(),ko=a("p"),s0=i(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Tc=a("code"),r0=i("span start logits"),i0=i(" and "),wc=a("code"),d0=i("span end logits"),l0=i(")."),c0=p(),Qr=a("p"),p0=i("This model inherits from "),Di=a("a"),u0=i("FlaxPreTrainedModel"),h0=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),m0=p(),Hr=a("p"),f0=i(`This model is also a Flax Linen
`),Vr=a("a"),_0=i("flax.nn.Module"),g0=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),b0=p(),Mc=a("p"),k0=i("Finally, this model supports inherent JAX features such as:"),y0=p(),gt=a("ul"),$c=a("li"),Jr=a("a"),v0=i("Just-In-Time (JIT) compilation"),T0=p(),xc=a("li"),Kr=a("a"),w0=i("Automatic Differentiation"),M0=p(),zc=a("li"),Zr=a("a"),$0=i("Vectorization"),x0=p(),qc=a("li"),Yr=a("a"),z0=i("Parallelization"),q0=p(),ot=a("div"),y(ei.$$.fragment),F0=p(),yo=a("p"),B0=i("The "),Fc=a("code"),j0=i("FlaxMBartPreTrainedModel"),E0=i(" forward method, overrides the "),Bc=a("code"),C0=i("__call__"),P0=i(" special method."),S0=p(),y(Xn.$$.fragment),A0=p(),y(Qn.$$.fragment),O0=p(),Hn=a("div"),y(ti.$$.fragment),I0=p(),y(Vn.$$.fragment),N0=p(),Jn=a("div"),y(oi.$$.fragment),D0=p(),y(Kn.$$.fragment),this.h()},l(o){const _=CM('[data-svelte="svelte-1phssyn"]',document.head);l=s(_,"META",{name:!0,content:!0}),_.forEach(t),k=u(o),m=s(o,"H1",{class:!0});var ni=r(m);c=s(ni,"A",{id:!0,class:!0,href:!0});var jc=r(c);g=s(jc,"SPAN",{});var Ec=r(g);v(n.$$.fragment,Ec),Ec.forEach(t),jc.forEach(t),h=u(ni),F=s(ni,"SPAN",{});var Cc=r(F);st=d(Cc,"MBart and MBart-50"),Cc.forEach(t),ni.forEach(t),ze=u(o),E=s(o,"P",{});var Zn=r(E);Ie=s(Zn,"STRONG",{});var Pc=r(Ie);he=d(Pc,"DISCLAIMER:"),Pc.forEach(t),rt=d(Zn," If you see something strange, file a "),me=s(Zn,"A",{href:!0,rel:!0});var Sc=r(me);fe=d(Sc,"Github Issue"),Sc.forEach(t),it=d(Zn,` and assign
...
example shows how to translate English to Romanian using the `),ld=s(To,"EM",{});var np=r(ld);Uh=d(np,"facebook/mbart-large-en-ro"),np.forEach(t),Xh=d(To," model."),To.forEach(t),ii.forEach(t),ep.forEach(t),pp=u(o),v(ka.$$.fragment,o),up=u(o),Nt=s(o,"H2",{class:!0});var di=r(Nt);Mo=s(di,"A",{id:!0,class:!0,href:!0});var ap=r(Mo);cd=s(ap,"SPAN",{});var sp=r(cd);v(ya.$$.fragment,sp),sp.forEach(t),ap.forEach(t),Qh=u(di),pd=s(di,"SPAN",{});var rp=r(pd);Hh=d(rp,"Overview of MBart-50"),rp.forEach(t),di.forEach(t),hp=u(o),yt=s(o,"P",{});var wo=r(yt);Vh=d(wo,"MBart-50 was introduced in the "),va=s(wo,"A",{href:!0,rel:!0});var L0=r(va);Jh=d(L0,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),L0.forEach(t),Kh=d(wo,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
Chaudhary, Jiatao Gu, Angela Fan. MBart-50 is created using the original `),ud=s(wo,"EM",{});var G0=r(ud);Zh=d(G0,"mbart-large-cc25"),G0.forEach(t),Yh=d(wo,` checkpoint by extendeding
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),wo.forEach(t),mp=u(o),ui=s(o,"P",{});var W0=r(ui);em=d(W0,"According to the abstract"),W0.forEach(t),fp=u(o),hi=s(o,"P",{});var R0=r(hi);hd=s(R0,"EM",{});var U0=r(hd);tm=d(U0,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),U0.forEach(t),R0.forEach(t),_p=u(o),Dt=s(o,"H3",{class:!0});var ou=r(Dt);$o=s(ou,"A",{id:!0,class:!0,href:!0});var X0=r($o);md=s(X0,"SPAN",{});var Q0=r(md);v(Ta.$$.fragment,Q0),Q0.forEach(t),X0.forEach(t),om=u(ou),fd=s(ou,"SPAN",{});var H0=r(fd);nm=d(H0,"Training of MBart-50"),H0.forEach(t),ou.forEach(t),gp=u(o),Ve=s(o,"P",{});var ea=r(Ve);am=d(ea,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),_d=s(ea,"CODE",{});var V0=r(_d);sm=d(V0,"[lang_code] X [eos]"),V0.forEach(t),rm=d(ea,", where "),gd=s(ea,"CODE",{});var J0=r(gd);im=d(J0,"lang_code"),J0.forEach(t),dm=d(ea,` is source
language id for source text and target language id for target text, with `),bd=s(ea,"CODE",{});var K0=r(bd);lm=d(K0,"X"),K0.forEach(t),cm=d(ea,` being the source or target text
respectively.`),ea.forEach(t),bp=u(o),xo=s(o,"P",{});var nu=r(xo);pm=d(nu,"MBart-50 has its own tokenizer "),mi=s(nu,"A",{href:!0});var Z0=r(mi);um=d(Z0,"MBart50Tokenizer"),Z0.forEach(t),hm=d(nu,"."),nu.forEach(t),kp=u(o),fi=s(o,"UL",{});var Y0=r(fi);kd=s(Y0,"LI",{});var eT=r(kd);mm=d(eT,"Supervised training"),eT.forEach(t),Y0.forEach(t),yp=u(o),v(wa.$$.fragment,o),vp=u(o),_i=s(o,"UL",{});var tT=r(_i);Ma=s(tT,"LI",{});var au=r(Ma);yd=s(au,"P",{});var oT=r(yd);fm=d(oT,"Generation"),oT.forEach(t),_m=u(au),Te=s(au,"P",{});var nt=r(Te);gm=d(nt,"To generate using the mBART-50 multilingual translation models, "),vd=s(nt,"CODE",{});var nT=r(vd);bm=d(nT,"eos_token_id"),nT.forEach(t),km=d(nt,` is used as the
