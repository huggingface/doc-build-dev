...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a> or <a href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.TFWav2Vec2Model">TFWav2Vec2Model</a>. Vocabulary size of the
model. Defines the different tokens that can be represented by the <em>inputs_ids</em> passed to the forward
method of <a href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a>.`,name:"vocab_size"},{anchor:"transformers.Wav2Vec2Config.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
instance of <a href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L490",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L420",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_18000/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_18000/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_18000/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L229",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L346",returnDescription:`
<p><code>Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1632",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1766",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1888",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2068",returnDescription:`
<p>A <a
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1392",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1459",returnDescription:`
<p>A <a
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1583",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_18000/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
tokens and clean up tokenization spaces.`),Yb.forEach(t),Cm=p(Ca),ts=s(Ca,"P",{});var Bd=n(ts);Em=i(Bd,"Similar to doing "),al=s(Bd,"CODE",{});var e0=n(al);Pm=i(e0,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),e0.forEach(t),qm=i(Bd,"."),Bd.forEach(t),zm=p(Ca),y(Wo.$$.fragment,Ca),Ca.forEach(t),Mm=p(Ae),Vo=s(Ae,"DIV",{class:!0});var Ud=n(Vo);y(os.$$.fragment,Ud),Am=p(Ud),sl=s(Ud,"P",{});var t0=n(sl);Om=i(t0,"Convert a list of lists of token ids into a list of strings by calling decode."),t0.forEach(t),Ud.forEach(t),Ae.forEach(t),rd=p(o),Nt=s(o,"H2",{class:!0});var Rd=n(Nt);jo=s(Rd,"A",{id:!0,class:!0,href:!0});var o0=n(jo);nl=s(o0,"SPAN",{});var a0=n(nl);y(as.$$.fragment,a0),a0.forEach(t),o0.forEach(t),Lm=p(Rd),rl=s(Rd,"SPAN",{});var s0=n(rl);Dm=i(s0,"Wav2Vec2FeatureExtractor"),s0.forEach(t),Rd.forEach(t),id=p(o),Ue=s(o,"DIV",{class:!0});var Ea=n(Ue);y(ss.$$.fragment,Ea),Sm=p(Ea),il=s(Ea,"P",{});var n0=n(il);Nm=i(n0,"Constructs a Wav2Vec2 feature extractor."),n0.forEach(t),Im=p(Ea),ns=s(Ea,"P",{});var Hd=n(ns);Bm=i(Hd,"This feature extractor inherits from "),Rr=s(Hd,"A",{href:!0});var r0=n(Rr);Um=i(r0,"SequenceFeatureExtractor"),r0.forEach(t),Rm=i(Hd,` which contains
most of the main methods. Users should refer to this superclass for more information regarding those methods.`),Hd.forEach(t),Hm=p(Ea),Fo=s(Ea,"DIV",{class:!0});var Xd=n(Fo);y(rs.$$.fragment,Xd),Xm=p(Xd),ll=s(Xd,"P",{});var i0=n(ll);Gm=i(i0,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),i0.forEach(t),Xd.forEach(t),Ea.forEach(t),ld=p(o),It=s(o,"H2",{class:!0});var Gd=n(It);Co=s(Gd,"A",{id:!0,class:!0,href:!0});var l0=n(Co);cl=s(l0,"SPAN",{});var c0=n(cl);y(is.$$.fragment,c0),c0.forEach(t),l0.forEach(t),Jm=p(Gd),dl=s(Gd,"SPAN",{});var d0=n(dl);Zm=i(d0,"Wav2Vec2Processor"),d0.forEach(t),Gd.forEach(t),cd=p(o),M=s(o,"DIV",{class:!0});var R=n(M);y(ls.$$.fragment,R),Km=p(R),pl=s(R,"P",{});var p0=n(pl);Qm=i(p0,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
processor.`),p0.forEach(t),Ym=p(R),qe=s(R,"P",{});var Tt=n(qe);Hr=s(Tt,"A",{href:!0});var m0=n(Hr);eh=i(m0,"Wav2Vec2Processor"),m0.forEach(t),th=i(Tt," offers all the functionalities of "),Xr=s(Tt,"A",{href:!0});var h0=n(Xr);oh=i(h0,"Wav2Vec2FeatureExtractor"),h0.forEach(t),ah=i(Tt," and "),Gr=s(Tt,"A",{href:!0});var f0=n(Gr);sh=i(f0,"PreTrainedTokenizer"),f0.forEach(t),nh=i(Tt,`.
See the docstring of `),cs=s(Tt,"A",{href:!0});var Nb=n(cs);ml=s(Nb,"STRONG",{});var u0=n(ml);rh=i(u0,"call"),u0.forEach(t),ih=i(Nb,"()"),Nb.forEach(t),lh=i(Tt," and "),Jr=s(Tt,"A",{href:!0});var g0=n(Jr);ch=i(g0,"decode()"),g0.forEach(t),dh=i(Tt," for more information."),Tt.forEach(t),ph=p(R),Eo=s(R,"DIV",{class:!0});var Jd=n(Eo);y(ds.$$.fragment,Jd),mh=p(Jd),ht=s(Jd,"P",{});var Pa=n(ht);hh=i(Pa,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),ps=s(Pa,"A",{href:!0});var Ib=n(ps);hl=s(Ib,"STRONG",{});var _0=n(hl);fh=i(_0,"call"),_0.forEach(t),uh=i(Ib,"()"),Ib.forEach(t),gh=i(Pa,` and returns its output. If used in the context
`),Zr=s(Pa,"A",{href:!0});var v0=n(Zr);_h=i(v0,"as_target_processor()"),v0.forEach(t),vh=i(Pa,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),ms=s(Pa,"A",{href:!0});var Bb=n(ms);fl=s(Bb,"STRONG",{});var b0=n(fl);bh=i(b0,"call"),b0.forEach(t),wh=i(Bb,"()"),Bb.forEach(t),yh=i(Pa,". Please refer to the docstring of the above two methods for more information."),Pa.forEach(t),Jd.forEach(t),kh=p(R),Po=s(R,"DIV",{class:!0});var Zd=n(Po);y(hs.$$.fragment,Zd),Th=p(Zd),ft=s(Zd,"P",{});var qa=n(ft);$h=i(qa,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),Kr=s(qa,"A",{href:!0});var w0=n(Kr);xh=i(w0,"pad()"),w0.forEach(t),Wh=i(qa,` and returns its output. If used in the context
`),Qr=s(qa,"A",{href:!0});var y0=n(Qr);Vh=i(y0,"as_target_processor()"),y0.forEach(t),jh=i(qa,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Yr=s(qa,"A",{href:!0});var k0=n(Yr);Fh=i(k0,"pad()"),k0.forEach(t),Ch=i(qa,". Please refer to the docstring of the above two methods for more information."),qa.forEach(t),Zd.forEach(t),Eh=p(R),ei=s(R,"DIV",{class:!0});var T0=n(ei);y(fs.$$.fragment,T0),T0.forEach(t),Ph=p(R),Wt=s(R,"DIV",{class:!0});var Ei=n(Wt);y(us.$$.fragment,Ei),qh=p(Ei),gs=s(Ei,"P",{});var Kd=n(gs);zh=i(Kd,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),ti=s(Kd,"A",{href:!0});var $0=n(ti);Mh=i($0,"from_pretrained()"),$0.forEach(t),Ah=i(Kd," method."),Kd.forEach(t),Oh=p(Ei),y(qo.$$.fragment,Ei),Ei.forEach(t),Lh=p(R),zo=s(R,"DIV",{class:!0});var Qd=n(zo);y(_s.$$.fragment,Qd),Dh=p(Qd),vs=s(Qd,"P",{});var Yd=n(vs);Sh=i(Yd,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),oi=s(Yd,"A",{href:!0});var x0=n(oi);Nh=i(x0,"batch_decode()"),x0.forEach(t),Ih=i(Yd,`. Please
refer to the docstring of this method for more information.`),Yd.forEach(t),Qd.forEach(t),Bh=p(R),Mo=s(R,"DIV",{class:!0});var ep=n(Mo);y(bs.$$.fragment,ep),Uh=p(ep),ws=s(ep,"P",{});var tp=n(ws);Rh=i(tp,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),ai=s(tp,"A",{href:!0});var W0=n(ai);Hh=i(W0,"decode()"),W0.forEach(t),Xh=i(tp,`. Please refer
to the docstring of this method for more information.`),tp.forEach(t),ep.forEach(t),Gh=p(R),Ao=s(R,"DIV",{class:!0});var op=n(Ao);y(ys.$$.fragment,op),Jh=p(op),ul=s(op,"P",{});var V0=n(ul);Zh=i(V0,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),V0.forEach(t),op.forEach(t),R.forEach(t),dd=p(o),Bt=s(o,"H2",{class:!0});var ap=n(Bt);Oo=s(ap,"A",{id:!0,class:!0,href:!0});var j0=n(Oo);gl=s(j0,"SPAN",{});var F0=n(gl);y(ks.$$.fragment,F0),F0.forEach(t),j0.forEach(t),Kh=p(ap),_l=s(ap,"SPAN",{});var C0=n(_l);Qh=i(C0,"Wav2Vec2ProcessorWithLM"),C0.forEach(t),ap.forEach(t),pd=p(o),N=s(o,"DIV",{class:!0});var te=n(N);y(Ts.$$.fragment,te),Yh=p(te),vl=s(te,"P",{});var E0=n(vl);ef=i(E0,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor, a Wav2Vec2 CTC tokenizer and a decoder
with language model support into a single processor for language model boosted speech recognition decoding.`),E0.forEach(t),tf=p(te),Lo=s(te,"DIV",{class:!0});var sp=n(Lo);y($s.$$.fragment,sp),of=p(sp),ut=s(sp,"P",{});var za=n(ut);af=i(za,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),xs=s(za,"A",{href:!0});var Ub=n(xs);bl=s(Ub,"STRONG",{});var P0=n(bl);sf=i(P0,"call"),P0.forEach(t),nf=i(Ub,"()"),Ub.forEach(t),rf=i(za,` and returns its output. If used in the context
`),si=s(za,"A",{href:!0});var q0=n(si);lf=i(q0,"as_target_processor()"),q0.forEach(t),cf=i(za,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),Ws=s(za,"A",{href:!0});var Rb=n(Ws);wl=s(Rb,"STRONG",{});var z0=n(wl);df=i(z0,"call"),z0.forEach(t),pf=i(Rb,"()"),Rb.forEach(t),mf=i(za,`. Please refer to the docstring of the above two
...
`),ni=s(Ma,"A",{href:!0});var M0=n(ni);gf=i(M0,"pad()"),M0.forEach(t),_f=i(Ma,` and returns its output. If used in the context
`),ri=s(Ma,"A",{href:!0});var A0=n(ri);vf=i(A0,"as_target_processor()"),A0.forEach(t),bf=i(Ma,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),ii=s(Ma,"A",{href:!0});var O0=n(ii);wf=i(O0,"pad()"),O0.forEach(t),yf=i(Ma,`. Please refer to the docstring of the above two methods
for more information.`),Ma.forEach(t),np.forEach(t),kf=p(te),Vt=s(te,"DIV",{class:!0});var Pi=n(Vt);y(js.$$.fragment,Pi),Tf=p(Pi),Fs=s(Pi,"P",{});var rp=n(Fs);$f=i(rp,"Instantiate a "),li=s(rp,"A",{href:!0});var L0=n(li);xf=i(L0,"Wav2Vec2ProcessorWithLM"),L0.forEach(t),Wf=i(rp," from a pretrained Wav2Vec2 processor."),rp.forEach(t),Vf=p(Pi),y(So.$$.fragment,Pi),Pi.forEach(t),jf=p(te),ci=s(te,"DIV",{class:!0});var D0=n(ci);y(Cs.$$.fragment,D0),D0.forEach(t),Ff=p(te),jt=s(te,"DIV",{class:!0});var qi=n(jt);y(Es.$$.fragment,qi),Cf=p(qi),yl=s(qi,"P",{});var S0=n(yl);Ef=i(S0,"Batch decode output logits to audio transcription with language model support."),S0.forEach(t),Pf=p(qi),y(No.$$.fragment,qi),qi.forEach(t),qf=p(te),Ft=s(te,"DIV",{class:!0});var zi=n(Ft);y(Ps.$$.fragment,zi),zf=p(zi),kl=s(zi,"P",{});var N0=n(kl);Mf=i(N0,"Decode output logits to audio transcription with language model support."),N0.forEach(t),Af=p(zi),y(Io.$$.fragment,zi),zi.forEach(t),Of=p(te),Bo=s(te,"DIV",{class:!0});var ip=n(Bo);y(qs.$$.fragment,ip),Lf=p(ip),Tl=s(ip,"P",{});var I0=n(Tl);Df=i(I0,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),I0.forEach(t),ip.forEach(t),te.forEach(t),md=p(o),Ut=s(o,"H2",{class:!0});var lp=n(Ut);Uo=s(lp,"A",{id:!0,class:!0,href:!0});var B0=n(Uo);$l=s(B0,"SPAN",{});var U0=n($l);y(zs.$$.fragment,U0),U0.forEach(t),B0.forEach(t),Sf=p(lp),xl=s(lp,"SPAN",{});var R0=n(xl);Nf=i(R0,"Wav2Vec2 specific outputs"),R0.forEach(t),lp.forEach(t),hd=p(o),Rt=s(o,"DIV",{class:!0});var cp=n(Rt);y(Ms.$$.fragment,cp),If=p(cp),As=s(cp,"P",{});var dp=n(As);Bf=i(dp,"Output type of "),Wl=s(dp,"CODE",{});var H0=n(Wl);Uf=i(H0,"Wav2Vec2DecoderWithLM"),H0.forEach(t),Rf=i(dp,", with transcription."),dp.forEach(t),cp.forEach(t),fd=p(o),Ht=s(o,"DIV",{class:!0});var pp=n(Ht);y(Os.$$.fragment,pp),Hf=p(pp),Vl=s(pp,"P",{});var X0=n(Vl);Xf=i(X0,"Base class for models that have been trained with the Wav2Vec2 loss objective."),X0.forEach(t),pp.forEach(t),ud=p(o),Xt=s(o,"DIV",{class:!0});var mp=n(Xt);y(Ls.$$.fragment,mp),Gf=p(mp),Ds=s(mp,"P",{});var hp=n(Ds);Jf=i(hp,"Output type of "),di=s(hp,"A",{href:!0});var G0=n(di);Zf=i(G0,"Wav2Vec2ForPreTraining"),G0.forEach(t),Kf=i(hp,", with potential hidden states and attentions."),hp.forEach(t),mp.forEach(t),gd=p(o),_t=s(o,"DIV",{class:!0});var Mi=n(_t);y(Ss.$$.fragment,Mi),Qf=p(Mi),Ns=s(Mi,"P",{});var fp=n(Ns);Yf=i(fp,"Output type of "),jl=s(fp,"CODE",{});var J0=n(jl);eu=i(J0,"FlaxWav2Vec2BaseModelOutput"),J0.forEach(t),tu=i(fp,", with potential hidden states and attentions."),fp.forEach(t),ou=p(Mi),Ro=s(Mi,"DIV",{class:!0});var up=n(Ro);y(Is.$$.fragment,up),au=p(up),Fl=s(up,"P",{});var Z0=n(Fl);su=i(Z0,"\u201CReturns a new object replacing the specified fields with new values."),Z0.forEach(t),up.forEach(t),Mi.forEach(t),_d=p(o),vt=s(o,"DIV",{class:!0});var Ai=n(vt);y(Bs.$$.fragment,Ai),nu=p(Ai),Us=s(Ai,"P",{});var gp=n(Us);ru=i(gp,"Output type of "),Cl=s(gp,"CODE",{});var K0=n(Cl);iu=i(K0,"FlaxWav2Vec2ForPreTrainingOutput"),K0.forEach(t),lu=i(gp,", with potential hidden states and attentions."),gp.forEach(t),cu=p(Ai),Ho=s(Ai,"DIV",{class:!0});var _p=n(Ho);y(Rs.$$.fragment,_p),du=p(_p),El=s(_p,"P",{});var Q0=n(El);pu=i(Q0,"\u201CReturns a new object replacing the specified fields with new values."),Q0.forEach(t),_p.forEach(t),Ai.forEach(t),vd=p(o),Gt=s(o,"H2",{class:!0});var vp=n(Gt);Xo=s(vp,"A",{id:!0,class:!0,href:!0});var Y0=n(Xo);Pl=s(Y0,"SPAN",{});var ew=n(Pl);y(Hs.$$.fragment,ew),ew.forEach(t),Y0.forEach(t),mu=p(vp),ql=s(vp,"SPAN",{});var tw=n(ql);hu=i(tw,"Wav2Vec2Model"),tw.forEach(t),vp.forEach(t),bd=p(o),xe=s(o,"DIV",{class:!0});var Ct=n(xe);y(Xs.$$.fragment,Ct),fu=p(Ct),Gs=s(Ct,"P",{});var bp=n(Gs);uu=i(bp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),Js=s(bp,"A",{href:!0,rel:!0});var ow=n(Js);gu=i(ow,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),ow.forEach(t),_u=i(bp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),bp.forEach(t),vu=p(Ct),Zs=s(Ct,"P",{});var wp=n(Zs);bu=i(wp,"This model inherits from "),pi=s(wp,"A",{href:!0});var aw=n(pi);wu=i(aw,"PreTrainedModel"),aw.forEach(t),yu=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),wp.forEach(t),ku=p(Ct),Ks=s(Ct,"P",{});var yp=n(Ks);Tu=i(yp,"This model is a PyTorch "),Qs=s(yp,"A",{href:!0,rel:!0});var sw=n(Qs);$u=i(sw,"torch.nn.Module"),sw.forEach(t),xu=i(yp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),yp.forEach(t),Wu=p(Ct),Ge=s(Ct,"DIV",{class:!0});var Aa=n(Ge);y(Ys.$$.fragment,Aa),Vu=p(Aa),Jt=s(Aa,"P",{});var Oi=n(Jt);ju=i(Oi,"The "),mi=s(Oi,"A",{href:!0});var nw=n(mi);Fu=i(nw,"Wav2Vec2Model"),nw.forEach(t),Cu=i(Oi," forward method, overrides the "),zl=s(Oi,"CODE",{});var rw=n(zl);Eu=i(rw,"__call__"),rw.forEach(t),Pu=i(Oi," special method."),Oi.forEach(t),qu=p(Aa),y(Go.$$.fragment,Aa),zu=p(Aa),y(Jo.$$.fragment,Aa),Aa.forEach(t),Ct.forEach(t),wd=p(o),Zt=s(o,"H2",{class:!0});var kp=n(Zt);Zo=s(kp,"A",{id:!0,class:!0,href:!0});var iw=n(Zo);Ml=s(iw,"SPAN",{});var lw=n(Ml);y(en.$$.fragment,lw),lw.forEach(t),iw.forEach(t),Mu=p(kp),Al=s(kp,"SPAN",{});var cw=n(Al);Au=i(cw,"Wav2Vec2ForCTC"),cw.forEach(t),kp.forEach(t),yd=p(o),We=s(o,"DIV",{class:!0});var Et=n(We);y(tn.$$.fragment,Et),Ou=p(Et),Kt=s(Et,"P",{});var Li=n(Kt);Lu=i(Li,"Wav2Vec2 Model with a "),Ol=s(Li,"CODE",{});var dw=n(Ol);Du=i(dw,"language modeling"),dw.forEach(t),Su=i(Li,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),on=s(Li,"A",{href:!0,rel:!0});var pw=n(on);Nu=i(pw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),pw.forEach(t),Iu=i(Li,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Li.forEach(t),Bu=p(Et),an=s(Et,"P",{});var Tp=n(an);Uu=i(Tp,"This model inherits from "),hi=s(Tp,"A",{href:!0});var mw=n(hi);Ru=i(mw,"PreTrainedModel"),mw.forEach(t),Hu=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Tp.forEach(t),Xu=p(Et),sn=s(Et,"P",{});var $p=n(sn);Gu=i($p,"This model is a PyTorch "),nn=s($p,"A",{href:!0,rel:!0});var hw=n(nn);Ju=i(hw,"torch.nn.Module"),hw.forEach(t),Zu=i($p,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Ku=p(Et),ze=s(Et,"DIV",{class:!0});var Pt=n(ze);y(rn.$$.fragment,Pt),Qu=p(Pt),Qt=s(Pt,"P",{});var Di=n(Qt);Yu=i(Di,"The "),fi=s(Di,"A",{href:!0});var fw=n(fi);eg=i(fw,"Wav2Vec2ForCTC"),fw.forEach(t),tg=i(Di," forward method, overrides the "),Ll=s(Di,"CODE",{});var uw=n(Ll);og=i(uw,"__call__"),uw.forEach(t),ag=i(Di," special method."),Di.forEach(t),sg=p(Pt),y(Ko.$$.fragment,Pt),ng=p(Pt),y(Qo.$$.fragment,Pt),rg=p(Pt),y(Yo.$$.fragment,Pt),Pt.forEach(t),Et.forEach(t),kd=p(o),Yt=s(o,"H2",{class:!0});var xp=n(Yt);ea=s(xp,"A",{id:!0,class:!0,href:!0});var gw=n(ea);Dl=s(gw,"SPAN",{});var _w=n(Dl);y(ln.$$.fragment,_w),_w.forEach(t),gw.forEach(t),ig=p(xp),Sl=s(xp,"SPAN",{});var vw=n(Sl);lg=i(vw,"Wav2Vec2ForSequenceClassification"),vw.forEach(t),xp.forEach(t),Td=p(o),ne=s(o,"DIV",{class:!0});var at=n(ne);y(cn.$$.fragment,at),cg=p(at),Nl=s(at,"P",{});var bw=n(Nl);dg=i(bw,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),bw.forEach(t),pg=p(at),dn=s(at,"P",{});var Wp=n(dn);mg=i(Wp,"Wav2Vec2 was proposed in "),pn=s(Wp,"A",{href:!0,rel:!0});var ww=n(pn);hg=i(ww,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),ww.forEach(t),fg=i(Wp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Wp.forEach(t),ug=p(at),mn=s(at,"P",{});var Vp=n(mn);gg=i(Vp,"This model inherits from "),ui=s(Vp,"A",{href:!0});var yw=n(ui);_g=i(yw,"PreTrainedModel"),yw.forEach(t),vg=i(Vp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Vp.forEach(t),bg=p(at),hn=s(at,"P",{});var jp=n(hn);wg=i(jp,"This model is a PyTorch "),fn=s(jp,"A",{href:!0,rel:!0});var kw=n(fn);yg=i(kw,"torch.nn.Module"),kw.forEach(t),kg=i(jp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jp.forEach(t),Tg=p(at),Me=s(at,"DIV",{class:!0});var qt=n(Me);y(un.$$.fragment,qt),$g=p(qt),eo=s(qt,"P",{});var Si=n(eo);xg=i(Si,"The "),gi=s(Si,"A",{href:!0});var Tw=n(gi);Wg=i(Tw,"Wav2Vec2ForSequenceClassification"),Tw.forEach(t),Vg=i(Si," forward method, overrides the "),Il=s(Si,"CODE",{});var $w=n(Il);jg=i($w,"__call__"),$w.forEach(t),Fg=i(Si," special method."),Si.forEach(t),Cg=p(qt),y(ta.$$.fragment,qt),Eg=p(qt),y(oa.$$.fragment,qt),Pg=p(qt),y(aa.$$.fragment,qt),qt.forEach(t),at.forEach(t),$d=p(o),to=s(o,"H2",{class:!0});var Fp=n(to);sa=s(Fp,"A",{id:!0,class:!0,href:!0});var xw=n(sa);Bl=s(xw,"SPAN",{});var Ww=n(Bl);y(gn.$$.fragment,Ww),Ww.forEach(t),xw.forEach(t),qg=p(Fp),Ul=s(Fp,"SPAN",{});var Vw=n(Ul);zg=i(Vw,"Wav2Vec2ForAudioFrameClassification"),Vw.forEach(t),Fp.forEach(t),xd=p(o),re=s(o,"DIV",{class:!0});var st=n(re);y(_n.$$.fragment,st),Mg=p(st),Rl=s(st,"P",{});var jw=n(Rl);Ag=i(jw,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),jw.forEach(t),Og=p(st),vn=s(st,"P",{});var Cp=n(vn);Lg=i(Cp,"Wav2Vec2 was proposed in "),bn=s(Cp,"A",{href:!0,rel:!0});var Fw=n(bn);Dg=i(Fw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Fw.forEach(t),Sg=i(Cp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Cp.forEach(t),Ng=p(st),wn=s(st,"P",{});var Ep=n(wn);Ig=i(Ep,"This model inherits from "),_i=s(Ep,"A",{href:!0});var Cw=n(_i);Bg=i(Cw,"PreTrainedModel"),Cw.forEach(t),Ug=i(Ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Ep.forEach(t),Rg=p(st),yn=s(st,"P",{});var Pp=n(yn);Hg=i(Pp,"This model is a PyTorch "),kn=s(Pp,"A",{href:!0,rel:!0});var Ew=n(kn);Xg=i(Ew,"torch.nn.Module"),Ew.forEach(t),Gg=i(Pp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),Jg=p(st),Je=s(st,"DIV",{class:!0});var Oa=n(Je);y(Tn.$$.fragment,Oa),Zg=p(Oa),oo=s(Oa,"P",{});var Ni=n(oo);Kg=i(Ni,"The "),vi=s(Ni,"A",{href:!0});var Pw=n(vi);Qg=i(Pw,"Wav2Vec2ForAudioFrameClassification"),Pw.forEach(t),Yg=i(Ni," forward method, overrides the "),Hl=s(Ni,"CODE",{});var qw=n(Hl);e_=i(qw,"__call__"),qw.forEach(t),t_=i(Ni," special method."),Ni.forEach(t),o_=p(Oa),y(na.$$.fragment,Oa),a_=p(Oa),y(ra.$$.fragment,Oa),Oa.forEach(t),st.forEach(t),Wd=p(o),ao=s(o,"H2",{class:!0});var qp=n(ao);ia=s(qp,"A",{id:!0,class:!0,href:!0});var zw=n(ia);Xl=s(zw,"SPAN",{});var Mw=n(Xl);y($n.$$.fragment,Mw),Mw.forEach(t),zw.forEach(t),s_=p(qp),Gl=s(qp,"SPAN",{});var Aw=n(Gl);n_=i(Aw,"Wav2Vec2ForXVector"),Aw.forEach(t),qp.forEach(t),Vd=p(o),ie=s(o,"DIV",{class:!0});var nt=n(ie);y(xn.$$.fragment,nt),r_=p(nt),Jl=s(nt,"P",{});var Ow=n(Jl);i_=i(Ow,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Ow.forEach(t),l_=p(nt),Wn=s(nt,"P",{});var zp=n(Wn);c_=i(zp,"Wav2Vec2 was proposed in "),Vn=s(zp,"A",{href:!0,rel:!0});var Lw=n(Vn);d_=i(Lw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Lw.forEach(t),p_=i(zp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),zp.forEach(t),m_=p(nt),jn=s(nt,"P",{});var Mp=n(jn);h_=i(Mp,"This model inherits from "),bi=s(Mp,"A",{href:!0});var Dw=n(bi);f_=i(Dw,"PreTrainedModel"),Dw.forEach(t),u_=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Mp.forEach(t),g_=p(nt),Fn=s(nt,"P",{});var Ap=n(Fn);__=i(Ap,"This model is a PyTorch "),Cn=s(Ap,"A",{href:!0,rel:!0});var Sw=n(Cn);v_=i(Sw,"torch.nn.Module"),Sw.forEach(t),b_=i(Ap,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ap.forEach(t),w_=p(nt),Ze=s(nt,"DIV",{class:!0});var La=n(Ze);y(En.$$.fragment,La),y_=p(La),so=s(La,"P",{});var Ii=n(so);k_=i(Ii,"The "),wi=s(Ii,"A",{href:!0});var Nw=n(wi);T_=i(Nw,"Wav2Vec2ForXVector"),Nw.forEach(t),$_=i(Ii," forward method, overrides the "),Zl=s(Ii,"CODE",{});var Iw=n(Zl);x_=i(Iw,"__call__"),Iw.forEach(t),W_=i(Ii," special method."),Ii.forEach(t),V_=p(La),y(la.$$.fragment,La),j_=p(La),y(ca.$$.fragment,La),La.forEach(t),nt.forEach(t),jd=p(o),no=s(o,"H2",{class:!0});var Op=n(no);da=s(Op,"A",{id:!0,class:!0,href:!0});var Bw=n(da);Kl=s(Bw,"SPAN",{});var Uw=n(Kl);y(Pn.$$.fragment,Uw),Uw.forEach(t),Bw.forEach(t),F_=p(Op),Ql=s(Op,"SPAN",{});var Rw=n(Ql);C_=i(Rw,"Wav2Vec2ForPreTraining"),Rw.forEach(t),Op.forEach(t),Fd=p(o),Ve=s(o,"DIV",{class:!0});var zt=n(Ve);y(qn.$$.fragment,zt),E_=p(zt),ro=s(zt,"P",{});var Bi=n(ro);P_=i(Bi,"Wav2Vec2 Model with a quantizer and "),Yl=s(Bi,"CODE",{});var Hw=n(Yl);q_=i(Hw,"VQ"),Hw.forEach(t),z_=i(Bi,` head on top.
Wav2Vec2 was proposed in `),zn=s(Bi,"A",{href:!0,rel:!0});var Xw=n(zn);M_=i(Xw,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Xw.forEach(t),A_=i(Bi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Bi.forEach(t),O_=p(zt),Mn=s(zt,"P",{});var Lp=n(Mn);L_=i(Lp,"This model inherits from "),yi=s(Lp,"A",{href:!0});var Gw=n(yi);D_=i(Gw,"PreTrainedModel"),Gw.forEach(t),S_=i(Lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Lp.forEach(t),N_=p(zt),An=s(zt,"P",{});var Dp=n(An);I_=i(Dp,"This model is a PyTorch "),On=s(Dp,"A",{href:!0,rel:!0});var Jw=n(On);B_=i(Jw,"torch.nn.Module"),Jw.forEach(t),U_=i(Dp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dp.forEach(t),R_=p(zt),Ke=s(zt,"DIV",{class:!0});var Da=n(Ke);y(Ln.$$.fragment,Da),H_=p(Da),io=s(Da,"P",{});var Ui=n(io);X_=i(Ui,"The "),ki=s(Ui,"A",{href:!0});var Zw=n(ki);G_=i(Zw,"Wav2Vec2ForPreTraining"),Zw.forEach(t),J_=i(Ui," forward method, overrides the "),ec=s(Ui,"CODE",{});var Kw=n(ec);Z_=i(Kw,"__call__"),Kw.forEach(t),K_=i(Ui," special method."),Ui.forEach(t),Q_=p(Da),y(pa.$$.fragment,Da),Y_=p(Da),y(ma.$$.fragment,Da),Da.forEach(t),zt.forEach(t),Cd=p(o),lo=s(o,"H2",{class:!0});var Sp=n(lo);ha=s(Sp,"A",{id:!0,class:!0,href:!0});var Qw=n(ha);tc=s(Qw,"SPAN",{});var Yw=n(tc);y(Dn.$$.fragment,Yw),Yw.forEach(t),Qw.forEach(t),ev=p(Sp),oc=s(Sp,"SPAN",{});var e1=n(oc);tv=i(e1,"TFWav2Vec2Model"),e1.forEach(t),Sp.forEach(t),Ed=p(o),le=s(o,"DIV",{class:!0});var rt=n(le);y(Sn.$$.fragment,rt),ov=p(rt),ac=s(rt,"P",{});var t1=n(ac);av=i(t1,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),t1.forEach(t),sv=p(rt),Nn=s(rt,"P",{});var Np=n(Nn);nv=i(Np,"This model inherits from "),Ti=s(Np,"A",{href:!0});var o1=n(Ti);rv=i(o1,"TFPreTrainedModel"),o1.forEach(t),iv=i(Np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
