...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18000/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
layers on top of the hidden-states output to compute `),Mp=n("code"),GT=r("span start logits"),XT=r(" and "),zp=n("code"),YT=r("span end logits"),ZT=r(")."),e0=c(),Dr=n("p"),t0=r("This model inherits from "),Bd=n("a"),o0=r("PreTrainedModel"),n0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),s0=c(),Sr=n("p"),a0=r("This model is also a PyTorch "),Wr=n("a"),r0=r("torch.nn.Module"),i0=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),l0=c(),it=n("div"),b(Ur.$$.fragment),d0=c(),Uo=n("p"),c0=r("The "),Rd=n("a"),p0=r("ElectraForQuestionAnswering"),h0=r(" forward method, overrides the "),jp=n("code"),m0=r("__call__"),u0=r(" special method."),f0=c(),b(ns.$$.fragment),g0=c(),b(ss.$$.fragment),_0=c(),b(as.$$.fragment),Gu=c(),Bo=n("h2"),rs=n("a"),Cp=n("span"),b(Br.$$.fragment),k0=c(),qp=n("span"),v0=r("TFElectraModel"),Xu=c(),Ke=n("div"),b(Rr.$$.fragment),T0=c(),Pp=n("p"),b0=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),y0=c(),Hr=n("p"),E0=r("This model inherits from "),Hd=n("a"),w0=r("TFPreTrainedModel"),$0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),F0=c(),Qr=n("p"),x0=r("This model is also a "),Vr=n("a"),M0=r("tf.keras.Model"),z0=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j0=c(),b(is.$$.fragment),C0=c(),zt=n("div"),b(Kr.$$.fragment),q0=c(),Ro=n("p"),P0=r("The "),Qd=n("a"),A0=r("TFElectraModel"),O0=r(" forward method, overrides the "),Ap=n("code"),L0=r("__call__"),N0=r(" special method."),I0=c(),b(ls.$$.fragment),D0=c(),b(ds.$$.fragment),Yu=c(),Ho=n("h2"),cs=n("a"),Op=n("span"),b(Jr.$$.fragment),S0=c(),Lp=n("span"),W0=r("TFElectraForPreTraining"),Zu=c(),Oe=n("div"),b(Gr.$$.fragment),U0=c(),Np=n("p"),B0=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),R0=c(),Ip=n("p"),H0=r(`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
of the two to have the correct classification head to be used for this model.`),Q0=c(),Xr=n("p"),V0=r("This model inherits from "),Vd=n("a"),K0=r("TFPreTrainedModel"),J0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),G0=c(),Yr=n("p"),X0=r("This model is also a "),Zr=n("a"),Y0=r("tf.keras.Model"),Z0=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
layers on top of the hidden-states output to compute `),Mp=s(Tc,"CODE",{});var yx=a(Mp);GT=i(yx,"span start logits"),yx.forEach(t),XT=i(Tc," and "),zp=s(Tc,"CODE",{});var Ex=a(zp);YT=i(Ex,"span end logits"),Ex.forEach(t),ZT=i(Tc,")."),Tc.forEach(t),e0=p(uo),Dr=s(uo,"P",{});var Zf=a(Dr);t0=i(Zf,"This model inherits from "),Bd=s(Zf,"A",{href:!0});var wx=a(Bd);o0=i(wx,"PreTrainedModel"),wx.forEach(t),n0=i(Zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zf.forEach(t),s0=p(uo),Sr=s(uo,"P",{});var eg=a(Sr);a0=i(eg,"This model is also a PyTorch "),Wr=s(eg,"A",{href:!0,rel:!0});var $x=a(Wr);r0=i($x,"torch.nn.Module"),$x.forEach(t),i0=i(eg,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eg.forEach(t),l0=p(uo),it=s(uo,"DIV",{class:!0});var fo=a(it);y(Ur.$$.fragment,fo),d0=p(fo),Uo=s(fo,"P",{});var bc=a(Uo);c0=i(bc,"The "),Rd=s(bc,"A",{href:!0});var Fx=a(Rd);p0=i(Fx,"ElectraForQuestionAnswering"),Fx.forEach(t),h0=i(bc," forward method, overrides the "),jp=s(bc,"CODE",{});var xx=a(jp);m0=i(xx,"__call__"),xx.forEach(t),u0=i(bc," special method."),bc.forEach(t),f0=p(fo),y(ns.$$.fragment,fo),g0=p(fo),y(ss.$$.fragment,fo),_0=p(fo),y(as.$$.fragment,fo),fo.forEach(t),uo.forEach(t),Gu=p(o),Bo=s(o,"H2",{class:!0});var tg=a(Bo);rs=s(tg,"A",{id:!0,class:!0,href:!0});var Mx=a(rs);Cp=s(Mx,"SPAN",{});var zx=a(Cp);y(Br.$$.fragment,zx),zx.forEach(t),Mx.forEach(t),k0=p(tg),qp=s(tg,"SPAN",{});var jx=a(qp);v0=i(jx,"TFElectraModel"),jx.forEach(t),tg.forEach(t),Xu=p(o),Ke=s(o,"DIV",{class:!0});var Bt=a(Ke);y(Rr.$$.fragment,Bt),T0=p(Bt),Pp=s(Bt,"P",{});var Cx=a(Pp);b0=i(Cx,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),Cx.forEach(t),y0=p(Bt),Hr=s(Bt,"P",{});var og=a(Hr);E0=i(og,"This model inherits from "),Hd=s(og,"A",{href:!0});var qx=a(Hd);w0=i(qx,"TFPreTrainedModel"),qx.forEach(t),$0=i(og,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),og.forEach(t),F0=p(Bt),Qr=s(Bt,"P",{});var ng=a(Qr);x0=i(ng,"This model is also a "),Vr=s(ng,"A",{href:!0,rel:!0});var Px=a(Vr);M0=i(Px,"tf.keras.Model"),Px.forEach(t),z0=i(ng,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ng.forEach(t),j0=p(Bt),y(is.$$.fragment,Bt),C0=p(Bt),zt=s(Bt,"DIV",{class:!0});var ua=a(zt);y(Kr.$$.fragment,ua),q0=p(ua),Ro=s(ua,"P",{});var yc=a(Ro);P0=i(yc,"The "),Qd=s(yc,"A",{href:!0});var Ax=a(Qd);A0=i(Ax,"TFElectraModel"),Ax.forEach(t),O0=i(yc," forward method, overrides the "),Ap=s(yc,"CODE",{});var Ox=a(Ap);L0=i(Ox,"__call__"),Ox.forEach(t),N0=i(yc," special method."),yc.forEach(t),I0=p(ua),y(ls.$$.fragment,ua),D0=p(ua),y(ds.$$.fragment,ua),ua.forEach(t),Bt.forEach(t),Yu=p(o),Ho=s(o,"H2",{class:!0});var sg=a(Ho);cs=s(sg,"A",{id:!0,class:!0,href:!0});var Lx=a(cs);Op=s(Lx,"SPAN",{});var Nx=a(Op);y(Jr.$$.fragment,Nx),Nx.forEach(t),Lx.forEach(t),S0=p(sg),Lp=s(sg,"SPAN",{});var Ix=a(Lp);W0=i(Ix,"TFElectraForPreTraining"),Ix.forEach(t),sg.forEach(t),Zu=p(o),Oe=s(o,"DIV",{class:!0});var mt=a(Oe);y(Gr.$$.fragment,mt),U0=p(mt),Np=s(mt,"P",{});var Dx=a(Np);B0=i(Dx,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),Dx.forEach(t),R0=p(mt),Ip=s(mt,"P",{});var Sx=a(Ip);H0=i(Sx,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
of the two to have the correct classification head to be used for this model.`),Sx.forEach(t),Q0=p(mt),Xr=s(mt,"P",{});var ag=a(Xr);V0=i(ag,"This model inherits from "),Vd=s(ag,"A",{href:!0});var Wx=a(Vd);K0=i(Wx,"TFPreTrainedModel"),Wx.forEach(t),J0=i(ag,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ag.forEach(t),G0=p(mt),Yr=s(mt,"P",{});var rg=a(Yr);X0=i(rg,"This model is also a "),Zr=s(rg,"A",{href:!0,rel:!0});var Ux=a(Zr);Y0=i(Ux,"tf.keras.Model"),Ux.forEach(t),Z0=i(rg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
