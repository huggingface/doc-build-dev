...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ta=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),oa=new Me({}),na=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),da=new Me({}),ca=new X({props:{name:"class transformers.XLMRobertaModel",anchor:"transformers.XLMRobertaModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.XLMRobertaModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18000/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18000/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L65"}}),fa=new X({props:{name:"forward",anchor:"transformers.XLMRobertaModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18000/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18000/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Ua=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18000/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18000/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18000/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),fi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18000/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18000/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18000/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Vi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18000/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
`}}),ys=new $e({props:{$$slots:{default:[qL]},$$scope:{ctx:x}}}),ws=new ie({props:{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.example",$$slots:{default:[CL]},$$scope:{ctx:x}}}),Ji=new Me({}),Ki=new X({props:{name:"class transformers.FlaxXLMRobertaForQuestionAnswering",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"gradient_checkpointing",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18000/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18000/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),al=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18000/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18000/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18000/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18000/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18000/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
alongside usage examples.`),Kk=c(),lt=n("div"),T(ar.$$.fragment),Gk=c(),Mo=n("p"),Yk=r("The "),Yl=n("a"),Zk=r("RobertaForQuestionAnswering"),e0=r(" forward method, overrides the "),Bc=n("code"),t0=r("__call__"),o0=r(" special method."),n0=c(),T(qn.$$.fragment),s0=c(),T(Cn.$$.fragment),a0=c(),T(jn.$$.fragment),vm=c(),Fo=n("h2"),Xn=n("a"),Wc=n("span"),T(rr.$$.fragment),r0=c(),Uc=n("span"),i0=r("TFXLMRobertaModel"),Tm=c(),Oe=n("div"),T(ir.$$.fragment),l0=c(),Qc=n("p"),d0=r("The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),c0=c(),lr=n("p"),p0=r("This model inherits from "),Zl=n("a"),h0=r("TFPreTrainedModel"),m0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),u0=c(),dr=n("p"),f0=r("This model is also a "),cr=n("a"),g0=r("tf.keras.Model"),_0=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),b0=c(),T(Pn.$$.fragment),k0=c(),pr=n("p"),v0=r("This class overrides "),ed=n("a"),T0=r("TFRobertaModel"),y0=r(`. Please check the superclass for the appropriate documentation alongside
usage examples.`),w0=c(),Ft=n("div"),T(hr.$$.fragment),$0=c(),xo=n("p"),M0=r("The "),td=n("a"),F0=r("TFRobertaModel"),x0=r(" forward method, overrides the "),Hc=n("code"),R0=r("__call__"),L0=r(" special method."),E0=c(),T(An.$$.fragment),z0=c(),T(On.$$.fragment),ym=c(),Ro=n("h2"),Nn=n("a"),Vc=n("span"),T(mr.$$.fragment),q0=c(),Jc=n("span"),C0=r("TFXLMRobertaForMaskedLM"),wm=c(),Ne=n("div"),T(ur.$$.fragment),j0=c(),fr=n("p"),X0=r("XLM-RoBERTa Model with a "),Kc=n("code"),P0=r("language modeling"),A0=r(" head on top."),O0=c(),gr=n("p"),N0=r("This model inherits from "),od=n("a"),I0=r("TFPreTrainedModel"),D0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),S0=c(),_r=n("p"),B0=r("This model is also a "),br=n("a"),W0=r("tf.keras.Model"),U0=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Q0=c(),T(In.$$.fragment),H0=c(),kr=n("p"),V0=r("This class overrides "),nd=n("a"),J0=r("TFRobertaForMaskedLM"),K0=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),G0=c(),dt=n("div"),T(vr.$$.fragment),Y0=c(),Lo=n("p"),Z0=r("The "),sd=n("a"),ev=r("TFRobertaForMaskedLM"),tv=r(" forward method, overrides the "),Gc=n("code"),ov=r("__call__"),nv=r(" special method."),sv=c(),T(Dn.$$.fragment),av=c(),T(Sn.$$.fragment),rv=c(),T(Bn.$$.fragment),$m=c(),Eo=n("h2"),Wn=n("a"),Yc=n("span"),T(Tr.$$.fragment),iv=c(),Zc=n("span"),lv=r("TFXLMRobertaForSequenceClassification"),Mm=c(),Ie=n("div"),T(yr.$$.fragment),dv=c(),ep=n("p"),cv=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),pv=c(),wr=n("p"),hv=r("This model inherits from "),ad=n("a"),mv=r("TFPreTrainedModel"),uv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fv=c(),$r=n("p"),gv=r("This model is also a "),Mr=n("a"),_v=r("tf.keras.Model"),bv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kv=c(),T(Un.$$.fragment),vv=c(),Fr=n("p"),Tv=r("This class overrides "),rd=n("a"),yv=r("TFRobertaForSequenceClassification"),wv=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),$v=c(),ct=n("div"),T(xr.$$.fragment),Mv=c(),zo=n("p"),Fv=r("The "),id=n("a"),xv=r("TFRobertaForSequenceClassification"),Rv=r(" forward method, overrides the "),tp=n("code"),Lv=r("__call__"),Ev=r(" special method."),zv=c(),T(Qn.$$.fragment),qv=c(),T(Hn.$$.fragment),Cv=c(),T(Vn.$$.fragment),Fm=c(),qo=n("h2"),Jn=n("a"),op=n("span"),T(Rr.$$.fragment),jv=c(),np=n("span"),Xv=r("TFXLMRobertaForMultipleChoice"),xm=c(),De=n("div"),T(Lr.$$.fragment),Pv=c(),sp=n("p"),Av=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Ov=c(),Er=n("p"),Nv=r("This model inherits from "),ld=n("a"),Iv=r("TFPreTrainedModel"),Dv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sv=c(),zr=n("p"),Bv=r("This model is also a "),qr=n("a"),Wv=r("tf.keras.Model"),Uv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qv=c(),T(Kn.$$.fragment),Hv=c(),Cr=n("p"),Vv=r("This class overrides "),dd=n("a"),Jv=r("TFRobertaForMultipleChoice"),Kv=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Gv=c(),xt=n("div"),T(jr.$$.fragment),Yv=c(),Co=n("p"),Zv=r("The "),cd=n("a"),eT=r("TFRobertaForMultipleChoice"),tT=r(" forward method, overrides the "),ap=n("code"),oT=r("__call__"),nT=r(" special method."),sT=c(),T(Gn.$$.fragment),aT=c(),T(Yn.$$.fragment),Rm=c(),jo=n("h2"),Zn=n("a"),rp=n("span"),T(Xr.$$.fragment),rT=c(),ip=n("span"),iT=r("TFXLMRobertaForTokenClassification"),Lm=c(),Se=n("div"),T(Pr.$$.fragment),lT=c(),lp=n("p"),dT=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
documentation alongside usage examples.`),wT=c(),pt=n("div"),T(Dr.$$.fragment),$T=c(),Xo=n("p"),MT=r("The "),md=n("a"),FT=r("TFRobertaForTokenClassification"),xT=r(" forward method, overrides the "),dp=n("code"),RT=r("__call__"),LT=r(" special method."),ET=c(),T(ts.$$.fragment),zT=c(),T(os.$$.fragment),qT=c(),T(ns.$$.fragment),Em=c(),Po=n("h2"),ss=n("a"),cp=n("span"),T(Sr.$$.fragment),CT=c(),pp=n("span"),jT=r("TFXLMRobertaForQuestionAnswering"),zm=c(),Be=n("div"),T(Br.$$.fragment),XT=c(),Ao=n("p"),PT=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=n("code"),AT=r("span start logits"),OT=r(" and "),mp=n("code"),NT=r("span end logits"),IT=r(")."),DT=c(),Wr=n("p"),ST=r("This model inherits from "),ud=n("a"),BT=r("TFPreTrainedModel"),WT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation alongside usage examples.`),e1=c(),ht=n("div"),T(Vr.$$.fragment),t1=c(),Oo=n("p"),o1=r("The "),fd=n("a"),n1=r("TFRobertaForQuestionAnswering"),s1=r(" forward method, overrides the "),fp=n("code"),a1=r("__call__"),r1=r(" special method."),i1=c(),T(rs.$$.fragment),l1=c(),T(is.$$.fragment),d1=c(),T(ls.$$.fragment),qm=c(),No=n("h2"),ds=n("a"),gp=n("span"),T(Jr.$$.fragment),c1=c(),_p=n("span"),p1=r("FlaxXLMRobertaModel"),Cm=c(),We=n("div"),T(Kr.$$.fragment),h1=c(),Gr=n("p"),m1=r(`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=n("a"),u1=r("FlaxPreTrainedModel"),f1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),g1=c(),Yr=n("p"),_1=r("This model is also a Flax Linen "),Zr=n("a"),b1=r("flax.linen.Module"),k1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),v1=c(),bp=n("p"),T1=r("Finally, this model supports inherent JAX features such as:"),y1=c(),St=n("ul"),kp=n("li"),ei=n("a"),w1=r("Just-In-Time (JIT) compilation"),$1=c(),vp=n("li"),ti=n("a"),M1=r("Automatic Differentiation"),F1=c(),Tp=n("li"),oi=n("a"),x1=r("Vectorization"),R1=c(),yp=n("li"),ni=n("a"),L1=r("Parallelization"),E1=c(),si=n("p"),z1=r("This class overrides "),_d=n("a"),q1=r("FlaxRobertaModel"),C1=r(`. Please check the superclass for the appropriate documentation alongside
usage examples.`),j1=c(),Rt=n("div"),T(ai.$$.fragment),X1=c(),Io=n("p"),P1=r("The "),wp=n("code"),A1=r("FlaxRobertaPreTrainedModel"),O1=r(" forward method, overrides the "),$p=n("code"),N1=r("__call__"),I1=r(" special method."),D1=c(),T(cs.$$.fragment),S1=c(),T(ps.$$.fragment),jm=c(),Do=n("h2"),hs=n("a"),Mp=n("span"),T(ri.$$.fragment),B1=c(),Fp=n("span"),W1=r("FlaxXLMRobertaForMaskedLM"),Xm=c(),Ue=n("div"),T(ii.$$.fragment),U1=c(),So=n("p"),Q1=r("XLM-RoBERTa Model with a "),xp=n("code"),H1=r("language modeling"),V1=r(` head on top.
This model inherits from `),bd=n("a"),J1=r("FlaxPreTrainedModel"),K1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),G1=c(),li=n("p"),Y1=r("This model is also a Flax Linen "),di=n("a"),Z1=r("flax.linen.Module"),ey=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ty=c(),Rp=n("p"),oy=r("Finally, this model supports inherent JAX features such as:"),ny=c(),Bt=n("ul"),Lp=n("li"),ci=n("a"),sy=r("Just-In-Time (JIT) compilation"),ay=c(),Ep=n("li"),pi=n("a"),ry=r("Automatic Differentiation"),iy=c(),zp=n("li"),hi=n("a"),ly=r("Vectorization"),dy=c(),qp=n("li"),mi=n("a"),cy=r("Parallelization"),py=c(),ui=n("p"),hy=r("This class overrides "),kd=n("a"),my=r("FlaxRobertaForMaskedLM"),uy=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),fy=c(),Lt=n("div"),T(fi.$$.fragment),gy=c(),Bo=n("p"),_y=r("The "),Cp=n("code"),by=r("FlaxRobertaPreTrainedModel"),ky=r(" forward method, overrides the "),jp=n("code"),vy=r("__call__"),Ty=r(" special method."),yy=c(),T(ms.$$.fragment),wy=c(),T(us.$$.fragment),Pm=c(),Wo=n("h2"),fs=n("a"),Xp=n("span"),T(gi.$$.fragment),$y=c(),Pp=n("span"),My=r("FlaxXLMRobertaForSequenceClassification"),Am=c(),Ce=n("div"),T(_i.$$.fragment),Fy=c(),Ap=n("p"),xy=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Ry=c(),bi=n("p"),Ly=r("This model inherits from "),vd=n("a"),Ey=r("FlaxPreTrainedModel"),zy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),qy=c(),ki=n("p"),Cy=r("This model is also a Flax Linen "),vi=n("a"),jy=r("flax.linen.Module"),Xy=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Py=c(),Op=n("p"),Ay=r("Finally, this model supports inherent JAX features such as:"),Oy=c(),Wt=n("ul"),Np=n("li"),Ti=n("a"),Ny=r("Just-In-Time (JIT) compilation"),Iy=c(),Ip=n("li"),yi=n("a"),Dy=r("Automatic Differentiation"),Sy=c(),Dp=n("li"),wi=n("a"),By=r("Vectorization"),Wy=c(),Sp=n("li"),$i=n("a"),Uy=r("Parallelization"),Qy=c(),Mi=n("p"),Hy=r("This class overrides "),Td=n("a"),Vy=r("FlaxRobertaForSequenceClassification"),Jy=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Ky=c(),Et=n("div"),T(Fi.$$.fragment),Gy=c(),Uo=n("p"),Yy=r("The "),Bp=n("code"),Zy=r("FlaxRobertaPreTrainedModel"),ew=r(" forward method, overrides the "),Wp=n("code"),tw=r("__call__"),ow=r(" special method."),nw=c(),T(gs.$$.fragment),sw=c(),T(_s.$$.fragment),Om=c(),Qo=n("h2"),bs=n("a"),Up=n("span"),T(xi.$$.fragment),aw=c(),Qp=n("span"),rw=r("FlaxXLMRobertaForMultipleChoice"),Nm=c(),je=n("div"),T(Ri.$$.fragment),iw=c(),Hp=n("p"),lw=r(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),dw=c(),Li=n("p"),cw=r("This model inherits from "),yd=n("a"),pw=r("FlaxPreTrainedModel"),hw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mw=c(),Ei=n("p"),uw=r("This model is also a Flax Linen "),zi=n("a"),fw=r("flax.linen.Module"),gw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_w=c(),Vp=n("p"),bw=r("Finally, this model supports inherent JAX features such as:"),kw=c(),Ut=n("ul"),Jp=n("li"),qi=n("a"),vw=r("Just-In-Time (JIT) compilation"),Tw=c(),Kp=n("li"),Ci=n("a"),yw=r("Automatic Differentiation"),ww=c(),Gp=n("li"),ji=n("a"),$w=r("Vectorization"),Mw=c(),Yp=n("li"),Xi=n("a"),Fw=r("Parallelization"),xw=c(),Pi=n("p"),Rw=r("This class overrides "),wd=n("a"),Lw=r("FlaxRobertaForMultipleChoice"),Ew=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),zw=c(),zt=n("div"),T(Ai.$$.fragment),qw=c(),Ho=n("p"),Cw=r("The "),Zp=n("code"),jw=r("FlaxRobertaPreTrainedModel"),Xw=r(" forward method, overrides the "),eh=n("code"),Pw=r("__call__"),Aw=r(" special method."),Ow=c(),T(ks.$$.fragment),Nw=c(),T(vs.$$.fragment),Im=c(),Vo=n("h2"),Ts=n("a"),th=n("span"),T(Oi.$$.fragment),Iw=c(),oh=n("span"),Dw=r("FlaxXLMRobertaForTokenClassification"),Dm=c(),Xe=n("div"),T(Ni.$$.fragment),Sw=c(),nh=n("p"),Bw=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ww=c(),Ii=n("p"),Uw=r("This model inherits from "),$d=n("a"),Qw=r("FlaxPreTrainedModel"),Hw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vw=c(),Di=n("p"),Jw=r("This model is also a Flax Linen "),Si=n("a"),Kw=r("flax.linen.Module"),Gw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yw=c(),sh=n("p"),Zw=r("Finally, this model supports inherent JAX features such as:"),e$=c(),Qt=n("ul"),ah=n("li"),Bi=n("a"),t$=r("Just-In-Time (JIT) compilation"),o$=c(),rh=n("li"),Wi=n("a"),n$=r("Automatic Differentiation"),s$=c(),ih=n("li"),Ui=n("a"),a$=r("Vectorization"),r$=c(),lh=n("li"),Qi=n("a"),i$=r("Parallelization"),l$=c(),Hi=n("p"),d$=r("This class overrides "),Md=n("a"),c$=r("FlaxRobertaForTokenClassification"),p$=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),h$=c(),qt=n("div"),T(Vi.$$.fragment),m$=c(),Jo=n("p"),u$=r("The "),dh=n("code"),f$=r("FlaxRobertaPreTrainedModel"),g$=r(" forward method, overrides the "),ch=n("code"),_$=r("__call__"),b$=r(" special method."),k$=c(),T(ys.$$.fragment),v$=c(),T(ws.$$.fragment),Sm=c(),Ko=n("h2"),$s=n("a"),ph=n("span"),T(Ji.$$.fragment),T$=c(),hh=n("span"),y$=r("FlaxXLMRobertaForQuestionAnswering"),Bm=c(),Pe=n("div"),T(Ki.$$.fragment),w$=c(),Go=n("p"),$$=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),mh=n("code"),M$=r("span start logits"),F$=r(" and "),uh=n("code"),x$=r("span end logits"),R$=r(")."),L$=c(),Gi=n("p"),E$=r("This model inherits from "),Fd=n("a"),z$=r("FlaxPreTrainedModel"),q$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),C$=c(),Yi=n("p"),j$=r("This model is also a Flax Linen "),Zi=n("a"),X$=r("flax.linen.Module"),P$=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=c(),fh=n("p"),O$=r("Finally, this model supports inherent JAX features such as:"),N$=c(),Ht=n("ul"),gh=n("li"),el=n("a"),I$=r("Just-In-Time (JIT) compilation"),D$=c(),_h=n("li"),tl=n("a"),S$=r("Automatic Differentiation"),B$=c(),bh=n("li"),ol=n("a"),W$=r("Vectorization"),U$=c(),kh=n("li"),nl=n("a"),Q$=r("Parallelization"),H$=c(),sl=n("p"),V$=r("This class overrides "),xd=n("a"),J$=r("FlaxRobertaForQuestionAnswering"),K$=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),G$=c(),Ct=n("div"),T(al.$$.fragment),Y$=c(),Yo=n("p"),Z$=r("The "),vh=n("code"),eM=r("FlaxRobertaPreTrainedModel"),tM=r(" forward method, overrides the "),Th=n("code"),oM=r("__call__"),nM=r(" special method."),sM=c(),T(Ms.$$.fragment),aM=c(),T(Fs.$$.fragment),this.h()},l(o){const k=jR('[data-svelte="svelte-1phssyn"]',document.head);d=s(k,"META",{name:!0,content:!0}),k.forEach(t),g=p(o),h=s(o,"H1",{class:!0});var rl=a(h);m=s(rl,"A",{id:!0,class:!0,href:!0});var yh=a(m);_=s(yh,"SPAN",{});var wh=a(_);y(l.$$.fragment,wh),wh.forEach(t),yh.forEach(t),f=p(rl),R=s(rl,"SPAN",{});var $h=a(R);ue=i($h,"XLM-RoBERTa"),$h.forEach(t),rl.forEach(t),J=p(o),E=s(o,"H2",{class:!0});var il=a(E);Y=s(il,"A",{id:!0,class:!0,href:!0});var Mh=a(Y);D=s(Mh,"SPAN",{});var Fh=a(D);y(ee.$$.fragment,Fh),Fh.forEach(t),Mh.forEach(t),fe=p(il),S=s(il,"SPAN",{});var xh=a(S);ge=i(xh,"Overview"),xh.forEach(t),il.forEach(t),ce=p(o),V=s(o,"P",{});var ll=a(V);P=i(ll,"The XLM-RoBERTa model was proposed in "),te=s(ll,"A",{href:!0,rel:!0});var Rh=a(te);K=i(Rh,"Unsupervised Cross-lingual Representation Learning at Scale"),Rh.forEach(t),z=i(ll,` by Alexis Conneau, Kartikay Khandelwal, Naman Goyal, Vishrav Chaudhary, Guillaume
Wenzek, Francisco Guzm\xE1n, Edouard Grave, Myle Ott, Luke Zettlemoyer and Veselin Stoyanov. It is based on Facebook\u2019s
RoBERTa model released in 2019. It is a large multi-lingual language model, trained on 2.5TB of filtered CommonCrawl
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Km.forEach(t),Dg=p(jt),ha=s(jt,"P",{});var Gm=a(ha);Sg=i(Gm,"This model is also a PyTorch "),ma=s(Gm,"A",{href:!0,rel:!0});var MM=a(ma);Bg=i(MM,"torch.nn.Module"),MM.forEach(t),Wg=i(Gm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ru.forEach(t),D_=p(Pt),Ra=s(Pt,"P",{});var iu=a(Ra);S_=i(iu,"This model is also a PyTorch "),La=s(iu,"A",{href:!0,rel:!0});var BM=a(La);B_=i(BM,"torch.nn.Module"),BM.forEach(t),W_=i(iu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),iu.forEach(t),U_=p(Pt),Ea=s(Pt,"P",{});var lu=a(Ea);Q_=i(lu,"This class overrides "),Nl=s(lu,"A",{href:!0});var WM=a(Nl);H_=i(WM,"RobertaForMaskedLM"),WM.forEach(t),V_=i(lu,`. Please check the superclass for the appropriate documentation
