...
`}}),or=new ve({}),nr=new U({props:{name:"class transformers.TFDistilBertModel",anchor:"transformers.TFDistilBertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L536",parametersDescription:[{anchor:"transformers.TFDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16027/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new me({props:{$$slots:{default:[mF]},$$scope:{ctx:j}}}),lr=new U({props:{name:"call",anchor:"transformers.TFDistilBertModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L541",parametersDescription:[{anchor:"transformers.TFDistilBertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),vr=new ve({}),br=new U({props:{name:"class transformers.TFDistilBertForSequenceClassification",anchor:"transformers.TFDistilBertForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L740",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16027/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),To=new me({props:{$$slots:{default:[bF]},$$scope:{ctx:j}}}),$r=new U({props:{name:"call",anchor:"transformers.TFDistilBertForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L757",parametersDescription:[{anchor:"transformers.TFDistilBertForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16027/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16027/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Fr=new ve({}),yr=new U({props:{name:"class transformers.TFDistilBertForMultipleChoice",anchor:"transformers.TFDistilBertForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L931",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16027/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$o=new me({props:{$$slots:{default:[kF]},$$scope:{ctx:j}}}),zr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L957",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16027/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16027/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),jr=new ve({}),Cr=new U({props:{name:"class transformers.TFDistilBertForTokenClassification",anchor:"transformers.TFDistilBertForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L841",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16027/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yo=new me({props:{$$slots:{default:[$F]},$$scope:{ctx:j}}}),Ir=new U({props:{name:"call",anchor:"transformers.TFDistilBertForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L852",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16027/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16027/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Lr=new ve({}),Sr=new U({props:{name:"class transformers.TFDistilBertForQuestionAnswering",anchor:"transformers.TFDistilBertForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1073",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16027/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Mo=new me({props:{$$slots:{default:[FF]},$$scope:{ctx:j}}}),Hr=new U({props:{name:"call",anchor:"transformers.TFDistilBertForQuestionAnswering.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16027/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1084",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16027/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16027/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16027/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
splitting and wordpiece.`),hp.forEach(t),cf=d(Qo),hn=n(Qo,"P",{});var lh=r(hn);pf=i(lh,"Refer to superclass "),vi=n(lh,"A",{href:!0});var e2=r(vi);hf=i(e2,"BertTokenizerFast"),e2.forEach(t),uf=i(lh," for usage examples and documentation concerning parameters."),lh.forEach(t),Qo.forEach(t),Tp=d(s),cs=n(s,"H2",{class:!0});var dh=r(cs);eo=n(dh,"A",{id:!0,class:!0,href:!0});var t2=r(eo);yl=n(t2,"SPAN",{});var s2=r(yl);k(un.$$.fragment,s2),s2.forEach(t),t2.forEach(t),ff=d(dh),Bl=n(dh,"SPAN",{});var o2=r(Bl);mf=i(o2,"DistilBertModel"),o2.forEach(t),dh.forEach(t),kp=d(s),Oe=n(s,"DIV",{class:!0});var It=r(Oe);k(fn.$$.fragment,It),gf=d(It),El=n(It,"P",{});var n2=r(El);_f=i(n2,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),n2.forEach(t),vf=d(It),mn=n(It,"P",{});var ch=r(mn);bf=i(ch,"This model inherits from "),bi=n(ch,"A",{href:!0});var r2=r(bi);Tf=i(r2,"PreTrainedModel"),r2.forEach(t),kf=i(ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ph.forEach(t),yf=d(It),Ve=n(It,"DIV",{class:!0});var Nt=r(Ve);k(vn.$$.fragment,Nt),Bf=d(Nt),ps=n(Nt,"P",{});var Gi=r(ps);Ef=i(Gi,"The "),Ti=n(Gi,"A",{href:!0});var i2=r(Ti);Mf=i(i2,"DistilBertModel"),i2.forEach(t),zf=i(Gi," forward method, overrides the "),Ml=n(Gi,"CODE",{});var l2=r(Ml);xf=i(l2,"__call__"),l2.forEach(t),jf=i(Gi," special method."),Gi.forEach(t),Cf=d(Nt),k(to.$$.fragment,Nt),Pf=d(Nt),zl=n(Nt,"P",{});var d2=r(zl);qf=i(d2,"Example:"),d2.forEach(t),Af=d(Nt),k(bn.$$.fragment,Nt),Nt.forEach(t),It.forEach(t),wp=d(s),hs=n(s,"H2",{class:!0});var hh=r(hs);so=n(hh,"A",{id:!0,class:!0,href:!0});var c2=r(so);xl=n(c2,"SPAN",{});var p2=r(xl);k(Tn.$$.fragment,p2),p2.forEach(t),c2.forEach(t),If=d(hh),jl=n(hh,"SPAN",{});var h2=r(jl);Nf=i(h2,"DistilBertForMaskedLM"),h2.forEach(t),hh.forEach(t),$p=d(s),We=n(s,"DIV",{class:!0});var Lt=r(We);k(kn.$$.fragment,Lt),Lf=d(Lt),wn=n(Lt,"P",{});var uh=r(wn);Sf=i(uh,"DistilBert Model with a "),Cl=n(uh,"CODE",{});var u2=r(Cl);Of=i(u2,"masked language modeling"),u2.forEach(t),Wf=i(uh," head on top."),uh.forEach(t),Rf=d(Lt),$n=n(Lt,"P",{});var fh=r($n);Hf=i(fh,"This model inherits from "),ki=n(fh,"A",{href:!0});var f2=r(ki);Qf=i(f2,"PreTrainedModel"),f2.forEach(t),Uf=i(fh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mh.forEach(t),Xf=d(Lt),Je=n(Lt,"DIV",{class:!0});var St=r(Je);k(yn.$$.fragment,St),Yf=d(St),us=n(St,"P",{});var Xi=r(us);Zf=i(Xi,"The "),wi=n(Xi,"A",{href:!0});var g2=r(wi);em=i(g2,"DistilBertForMaskedLM"),g2.forEach(t),tm=i(Xi," forward method, overrides the "),Pl=n(Xi,"CODE",{});var _2=r(Pl);sm=i(_2,"__call__"),_2.forEach(t),om=i(Xi," special method."),Xi.forEach(t),nm=d(St),k(oo.$$.fragment,St),rm=d(St),ql=n(St,"P",{});var v2=r(ql);am=i(v2,"Example:"),v2.forEach(t),im=d(St),k(Bn.$$.fragment,St),St.forEach(t),Lt.forEach(t),Dp=d(s),fs=n(s,"H2",{class:!0});var gh=r(fs);no=n(gh,"A",{id:!0,class:!0,href:!0});var b2=r(no);Al=n(b2,"SPAN",{});var T2=r(Al);k(En.$$.fragment,T2),T2.forEach(t),b2.forEach(t),lm=d(gh),Il=n(gh,"SPAN",{});var k2=r(Il);dm=i(k2,"DistilBertForSequenceClassification"),k2.forEach(t),gh.forEach(t),Fp=d(s),Re=n(s,"DIV",{class:!0});var Ot=r(Re);k(Mn.$$.fragment,Ot),cm=d(Ot),Nl=n(Ot,"P",{});var w2=r(Nl);pm=i(w2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_h.forEach(t),gm=d(Ot),xn=n(Ot,"P",{});var vh=r(xn);_m=i(vh,"This model is also a PyTorch "),jn=n(vh,"A",{href:!0,rel:!0});var D2=r(jn);vm=i(D2,"torch.nn.Module"),D2.forEach(t),bm=i(vh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vh.forEach(t),Tm=d(Ot),Ce=n(Ot,"DIV",{class:!0});var ct=r(Ce);k(Cn.$$.fragment,ct),km=d(ct),ms=n(ct,"P",{});var Yi=r(ms);wm=i(Yi,"The "),Di=n(Yi,"A",{href:!0});var F2=r(Di);$m=i(F2,"DistilBertForSequenceClassification"),F2.forEach(t),Dm=i(Yi," forward method, overrides the "),Ll=n(Yi,"CODE",{});var y2=r(Ll);Fm=i(y2,"__call__"),y2.forEach(t),ym=i(Yi," special method."),Yi.forEach(t),Bm=d(ct),k(ro.$$.fragment,ct),Em=d(ct),Sl=n(ct,"P",{});var B2=r(Sl);Mm=i(B2,"Example of single-label classification:"),B2.forEach(t),zm=d(ct),k(Pn.$$.fragment,ct),xm=d(ct),Ol=n(ct,"P",{});var E2=r(Ol);jm=i(E2,"Example of multi-label classification:"),E2.forEach(t),Cm=d(ct),k(qn.$$.fragment,ct),ct.forEach(t),Ot.forEach(t),yp=d(s),gs=n(s,"H2",{class:!0});var bh=r(gs);ao=n(bh,"A",{id:!0,class:!0,href:!0});var M2=r(ao);Wl=n(M2,"SPAN",{});var z2=r(Wl);k(An.$$.fragment,z2),z2.forEach(t),M2.forEach(t),Pm=d(bh),Rl=n(bh,"SPAN",{});var x2=r(Rl);qm=i(x2,"DistilBertForMultipleChoice"),x2.forEach(t),bh.forEach(t),Bp=d(s),He=n(s,"DIV",{class:!0});var Wt=r(He);k(In.$$.fragment,Wt),Am=d(Wt),Hl=n(Wt,"P",{});var j2=r(Hl);Im=i(j2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),j2.forEach(t),Nm=d(Wt),Nn=n(Wt,"P",{});var Th=r(Nn);Lm=i(Th,"This model inherits from "),Fi=n(Th,"A",{href:!0});var C2=r(Fi);Sm=i(C2,"PreTrainedModel"),C2.forEach(t),Om=i(Th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dh.forEach(t),mg=d(Ht),Ge=n(Ht,"DIV",{class:!0});var Qt=r(Ge);k(Jn.$$.fragment,Qt),gg=d(Qt),bs=n(Qt,"P",{});var el=r(bs);_g=i(el,"The "),Ei=n(el,"A",{href:!0});var H2=r(Ei);vg=i(H2,"DistilBertForTokenClassification"),H2.forEach(t),bg=i(el," forward method, overrides the "),Gl=n(el,"CODE",{});var Q2=r(Gl);Tg=i(Q2,"__call__"),Q2.forEach(t),kg=i(el," special method."),el.forEach(t),wg=d(Qt),k(co.$$.fragment,Qt),$g=d(Qt),Xl=n(Qt,"P",{});var U2=r(Xl);Dg=i(U2,"Example:"),U2.forEach(t),Fg=d(Qt),k(Kn.$$.fragment,Qt),Qt.forEach(t),Ht.forEach(t),zp=d(s),Ts=n(s,"H2",{class:!0});var Fh=r(Ts);po=n(Fh,"A",{id:!0,class:!0,href:!0});var V2=r(po);Yl=n(V2,"SPAN",{});var J2=r(Yl);k(Gn.$$.fragment,J2),J2.forEach(t),V2.forEach(t),yg=d(Fh),Zl=n(Fh,"SPAN",{});var K2=r(Zl);Bg=i(K2,"DistilBertForQuestionAnswering"),K2.forEach(t),Fh.forEach(t),xp=d(s),Ue=n(s,"DIV",{class:!0});var Ut=r(Ue);k(Xn.$$.fragment,Ut),Eg=d(Ut),ks=n(Ut,"P",{});var tl=r(ks);Mg=i(tl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),ed=n(tl,"CODE",{});var G2=r(ed);zg=i(G2,"span start logits"),G2.forEach(t),xg=i(tl," and "),td=n(tl,"CODE",{});var X2=r(td);jg=i(X2,"span end logits"),X2.forEach(t),Cg=i(tl,")."),tl.forEach(t),Pg=d(Ut),Yn=n(Ut,"P",{});var yh=r(Yn);qg=i(yh,"This model inherits from "),Mi=n(yh,"A",{href:!0});var Y2=r(Mi);Ag=i(Y2,"PreTrainedModel"),Y2.forEach(t),Ig=i(yh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bh.forEach(t),Wg=d(Ut),Xe=n(Ut,"DIV",{class:!0});var Vt=r(Xe);k(tr.$$.fragment,Vt),Rg=d(Vt),ws=n(Vt,"P",{});var sl=r(ws);Hg=i(sl,"The "),zi=n(sl,"A",{href:!0});var e0=r(zi);Qg=i(e0,"DistilBertForQuestionAnswering"),e0.forEach(t),Ug=i(sl," forward method, overrides the "),sd=n(sl,"CODE",{});var t0=r(sd);Vg=i(t0,"__call__"),t0.forEach(t),Jg=i(sl," special method."),sl.forEach(t),Kg=d(Vt),k(ho.$$.fragment,Vt),Gg=d(Vt),od=n(Vt,"P",{});var s0=r(od);Xg=i(s0,"Example:"),s0.forEach(t),Yg=d(Vt),k(sr.$$.fragment,Vt),Vt.forEach(t),Ut.forEach(t),jp=d(s),$s=n(s,"H2",{class:!0});var Eh=r($s);uo=n(Eh,"A",{id:!0,class:!0,href:!0});var o0=r(uo);nd=n(o0,"SPAN",{});var n0=r(nd);k(or.$$.fragment,n0),n0.forEach(t),o0.forEach(t),Zg=d(Eh),rd=n(Eh,"SPAN",{});var r0=r(rd);e_=i(r0,"TFDistilBertModel"),r0.forEach(t),Eh.forEach(t),Cp=d(s),Pe=n(s,"DIV",{class:!0});var Tt=r(Pe);k(nr.$$.fragment,Tt),t_=d(Tt),ad=n(Tt,"P",{});var a0=r(ad);s_=i(a0,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),a0.forEach(t),o_=d(Tt),rr=n(Tt,"P",{});var Mh=r(rr);n_=i(Mh,"This model inherits from "),xi=n(Mh,"A",{href:!0});var i0=r(xi);r_=i(i0,"TFPreTrainedModel"),i0.forEach(t),a_=i(Mh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zh.forEach(t),p_=d(Tt),k(fo.$$.fragment,Tt),h_=d(Tt),Ye=n(Tt,"DIV",{class:!0});var Jt=r(Ye);k(lr.$$.fragment,Jt),u_=d(Jt),Ds=n(Jt,"P",{});var ol=r(Ds);f_=i(ol,"The "),ji=n(ol,"A",{href:!0});var d0=r(ji);m_=i(d0,"TFDistilBertModel"),d0.forEach(t),g_=i(ol," forward method, overrides the "),id=n(ol,"CODE",{});var c0=r(id);__=i(c0,"__call__"),c0.forEach(t),v_=i(ol," special method."),ol.forEach(t),b_=d(Jt),k(mo.$$.fragment,Jt),T_=d(Jt),ld=n(Jt,"P",{});var p0=r(ld);k_=i(p0,"Example:"),p0.forEach(t),w_=d(Jt),k(dr.$$.fragment,Jt),Jt.forEach(t),Tt.forEach(t),Pp=d(s),Fs=n(s,"H2",{class:!0});var xh=r(Fs);go=n(xh,"A",{id:!0,class:!0,href:!0});var h0=r(go);dd=n(h0,"SPAN",{});var u0=r(dd);k(cr.$$.fragment,u0),u0.forEach(t),h0.forEach(t),$_=d(xh),cd=n(xh,"SPAN",{});var f0=r(cd);D_=i(f0,"TFDistilBertForMaskedLM"),f0.forEach(t),xh.forEach(t),qp=d(s),qe=n(s,"DIV",{class:!0});var kt=r(qe);k(pr.$$.fragment,kt),F_=d(kt),hr=n(kt,"P",{});var jh=r(hr);y_=i(jh,"DistilBert Model with a "),pd=n(jh,"CODE",{});var m0=r(pd);B_=i(m0,"masked language modeling"),m0.forEach(t),E_=i(jh," head on top."),jh.forEach(t),M_=d(kt),ur=n(kt,"P",{});var Ch=r(ur);z_=i(Ch,"This model inherits from "),Ci=n(Ch,"A",{href:!0});var g0=r(Ci);x_=i(g0,"TFPreTrainedModel"),g0.forEach(t),j_=i(Ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ch.forEach(t),C_=d(kt),fr=n(kt,"P",{});var Ph=r(fr);P_=i(Ph,"This model is also a "),mr=n(Ph,"A",{href:!0,rel:!0});var _0=r(mr);q_=i(_0,"tf.keras.Model"),_0.forEach(t),A_=i(Ph,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ph.forEach(t),I_=d(kt),k(_o.$$.fragment,kt),N_=d(kt),Ze=n(kt,"DIV",{class:!0});var Kt=r(Ze);k(gr.$$.fragment,Kt),L_=d(Kt),ys=n(Kt,"P",{});var nl=r(ys);S_=i(nl,"The "),Pi=n(nl,"A",{href:!0});var v0=r(Pi);O_=i(v0,"TFDistilBertForMaskedLM"),v0.forEach(t),W_=i(nl," forward method, overrides the "),hd=n(nl,"CODE",{});var b0=r(hd);R_=i(b0,"__call__"),b0.forEach(t),H_=i(nl," special method."),nl.forEach(t),Q_=d(Kt),k(vo.$$.fragment,Kt),U_=d(Kt),ud=n(Kt,"P",{});var T0=r(ud);V_=i(T0,"Example:"),T0.forEach(t),J_=d(Kt),k(_r.$$.fragment,Kt),Kt.forEach(t),kt.forEach(t),Ap=d(s),Bs=n(s,"H2",{class:!0});var qh=r(Bs);bo=n(qh,"A",{id:!0,class:!0,href:!0});var k0=r(bo);fd=n(k0,"SPAN",{});var w0=r(fd);k(vr.$$.fragment,w0),w0.forEach(t),k0.forEach(t),K_=d(qh),md=n(qh,"SPAN",{});var $0=r(md);G_=i($0,"TFDistilBertForSequenceClassification"),$0.forEach(t),qh.forEach(t),Ip=d(s),Ae=n(s,"DIV",{class:!0});var wt=r(Ae);k(br.$$.fragment,wt),X_=d(wt),gd=n(wt,"P",{});var D0=r(gd);Y_=i(D0,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),D0.forEach(t),Z_=d(wt),Tr=n(wt,"P",{});var Ah=r(Tr);ev=i(Ah,"This model inherits from "),qi=n(Ah,"A",{href:!0});var F0=r(qi);tv=i(F0,"TFPreTrainedModel"),F0.forEach(t),sv=i(Ah,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),iv=d(wt),k(To.$$.fragment,wt),lv=d(wt),et=n(wt,"DIV",{class:!0});var Gt=r(et);k($r.$$.fragment,Gt),dv=d(Gt),Es=n(Gt,"P",{});var rl=r(Es);cv=i(rl,"The "),Ai=n(rl,"A",{href:!0});var B0=r(Ai);pv=i(B0,"TFDistilBertForSequenceClassification"),B0.forEach(t),hv=i(rl," forward method, overrides the "),_d=n(rl,"CODE",{});var E0=r(_d);uv=i(E0,"__call__"),E0.forEach(t),fv=i(rl," special method."),rl.forEach(t),mv=d(Gt),k(ko.$$.fragment,Gt),gv=d(Gt),vd=n(Gt,"P",{});var M0=r(vd);_v=i(M0,"Example:"),M0.forEach(t),vv=d(Gt),k(Dr.$$.fragment,Gt),Gt.forEach(t),wt.forEach(t),Np=d(s),Ms=n(s,"H2",{class:!0});var Nh=r(Ms);wo=n(Nh,"A",{id:!0,class:!0,href:!0});var z0=r(wo);bd=n(z0,"SPAN",{});var x0=r(bd);k(Fr.$$.fragment,x0),x0.forEach(t),z0.forEach(t),bv=d(Nh),Td=n(Nh,"SPAN",{});var j0=r(Td);Tv=i(j0,"TFDistilBertForMultipleChoice"),j0.forEach(t),Nh.forEach(t),Lp=d(s),Ie=n(s,"DIV",{class:!0});var $t=r(Ie);k(yr.$$.fragment,$t),kv=d($t),kd=n($t,"P",{});var C0=r(kd);wv=i(C0,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),C0.forEach(t),$v=d($t),Br=n($t,"P",{});var Lh=r(Br);Dv=i(Lh,"This model inherits from "),Ii=n(Lh,"A",{href:!0});var P0=r(Ii);Fv=i(P0,"TFPreTrainedModel"),P0.forEach(t),yv=i(Lh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lh.forEach(t),Bv=d($t),Er=n($t,"P",{});var Sh=r(Er);Ev=i(Sh,"This model is also a "),Mr=n(Sh,"A",{href:!0,rel:!0});var q0=r(Mr);Mv=i(q0,"tf.keras.Model"),q0.forEach(t),zv=i(Sh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sh.forEach(t),xv=d($t),k($o.$$.fragment,$t),jv=d($t),tt=n($t,"DIV",{class:!0});var Xt=r(tt);k(zr.$$.fragment,Xt),Cv=d(Xt),zs=n(Xt,"P",{});var al=r(zs);Pv=i(al,"The "),Ni=n(al,"A",{href:!0});var A0=r(Ni);qv=i(A0,"TFDistilBertForMultipleChoice"),A0.forEach(t),Av=i(al," forward method, overrides the "),wd=n(al,"CODE",{});var I0=r(wd);Iv=i(I0,"__call__"),I0.forEach(t),Nv=i(al," special method."),al.forEach(t),Lv=d(Xt),k(Do.$$.fragment,Xt),Sv=d(Xt),$d=n(Xt,"P",{});var N0=r($d);Ov=i(N0,"Example:"),N0.forEach(t),Wv=d(Xt),k(xr.$$.fragment,Xt),Xt.forEach(t),$t.forEach(t),Sp=d(s),xs=n(s,"H2",{class:!0});var Oh=r(xs);Fo=n(Oh,"A",{id:!0,class:!0,href:!0});var L0=r(Fo);Dd=n(L0,"SPAN",{});var S0=r(Dd);k(jr.$$.fragment,S0),S0.forEach(t),L0.forEach(t),Rv=d(Oh),Fd=n(Oh,"SPAN",{});var O0=r(Fd);Hv=i(O0,"TFDistilBertForTokenClassification"),O0.forEach(t),Oh.forEach(t),Op=d(s),Ne=n(s,"DIV",{class:!0});var Dt=r(Ne);k(Cr.$$.fragment,Dt),Qv=d(Dt),yd=n(Dt,"P",{});var W0=r(yd);Uv=i(W0,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),W0.forEach(t),Vv=d(Dt),Pr=n(Dt,"P",{});var Wh=r(Pr);Jv=i(Wh,"This model inherits from "),Li=n(Wh,"A",{href:!0});var R0=r(Li);Kv=i(R0,"TFPreTrainedModel"),R0.forEach(t),Gv=i(Wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wh.forEach(t),Xv=d(Dt),qr=n(Dt,"P",{});var Rh=r(qr);Yv=i(Rh,"This model is also a "),Ar=n(Rh,"A",{href:!0,rel:!0});var H0=r(Ar);Zv=i(H0,"tf.keras.Model"),H0.forEach(t),eb=i(Rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),tb=d(Dt),k(yo.$$.fragment,Dt),sb=d(Dt),st=n(Dt,"DIV",{class:!0});var Yt=r(st);k(Ir.$$.fragment,Yt),ob=d(Yt),js=n(Yt,"P",{});var il=r(js);nb=i(il,"The "),Si=n(il,"A",{href:!0});var Q0=r(Si);rb=i(Q0,"TFDistilBertForTokenClassification"),Q0.forEach(t),ab=i(il," forward method, overrides the "),Bd=n(il,"CODE",{});var U0=r(Bd);ib=i(U0,"__call__"),U0.forEach(t),lb=i(il," special method."),il.forEach(t),db=d(Yt),k(Bo.$$.fragment,Yt),cb=d(Yt),Ed=n(Yt,"P",{});var V0=r(Ed);pb=i(V0,"Example:"),V0.forEach(t),hb=d(Yt),k(Nr.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),Wp=d(s),Cs=n(s,"H2",{class:!0});var Hh=r(Cs);Eo=n(Hh,"A",{id:!0,class:!0,href:!0});var J0=r(Eo);Md=n(J0,"SPAN",{});var K0=r(Md);k(Lr.$$.fragment,K0),K0.forEach(t),J0.forEach(t),ub=d(Hh),zd=n(Hh,"SPAN",{});var G0=r(zd);fb=i(G0,"TFDistilBertForQuestionAnswering"),G0.forEach(t),Hh.forEach(t),Rp=d(s),Le=n(s,"DIV",{class:!0});var Ft=r(Le);k(Sr.$$.fragment,Ft),mb=d(Ft),Ps=n(Ft,"P",{});var ll=r(Ps);gb=i(ll,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),xd=n(ll,"CODE",{});var X0=r(xd);_b=i(X0,"span start logits"),X0.forEach(t),vb=i(ll," and "),jd=n(ll,"CODE",{});var Y0=r(jd);bb=i(Y0,"span end logits"),Y0.forEach(t),Tb=i(ll,")."),ll.forEach(t),kb=d(Ft),Or=n(Ft,"P",{});var Qh=r(Or);wb=i(Qh,"This model inherits from "),Oi=n(Qh,"A",{href:!0});var Z0=r(Oi);$b=i(Z0,"TFPreTrainedModel"),Z0.forEach(t),Db=i(Qh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
