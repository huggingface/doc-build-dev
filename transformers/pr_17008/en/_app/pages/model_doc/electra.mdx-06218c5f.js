...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17008/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17008/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17008/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17008/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17008/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17008/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17008/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17008/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17008/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17008/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17008/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17008/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17008/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17008/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17008/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17008/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17008/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17008/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17008/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17008/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ww=c(),kh=n("p"),Uw=r("Finally, this model supports inherent JAX features such as:"),Rw=c(),Kt=n("ul"),vh=n("li"),ol=n("a"),Hw=r("Just-In-Time (JIT) compilation"),Qw=c(),Th=n("li"),nl=n("a"),Bw=r("Automatic Differentiation"),Vw=c(),bh=n("li"),sl=n("a"),Kw=r("Vectorization"),Jw=c(),yh=n("li"),al=n("a"),Gw=r("Parallelization"),Xw=c(),Pt=n("div"),b(rl.$$.fragment),Yw=c(),ln=n("p"),Zw=r("The "),Eh=n("code"),e0=r("FlaxElectraPreTrainedModel"),t0=r(" forward method, overrides the "),wh=n("code"),o0=r("__call__"),n0=r(" special method."),s0=c(),b(Us.$$.fragment),a0=c(),b(Rs.$$.fragment),Nu=c(),dn=n("h2"),Hs=n("a"),$h=n("span"),b(il.$$.fragment),r0=c(),Fh=n("span"),i0=r("FlaxElectraForMultipleChoice"),Iu=c(),We=n("div"),b(ll.$$.fragment),l0=c(),xh=n("p"),d0=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),c0=c(),dl=n("p"),p0=r("This model inherits from "),Dd=n("a"),h0=r("FlaxPreTrainedModel"),m0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),u0=c(),cl=n("p"),f0=r(`This model is also a Flax Linen
`),pl=n("a"),g0=r("flax.nn.Module"),_0=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),k0=c(),Mh=n("p"),v0=r("Finally, this model supports inherent JAX features such as:"),T0=c(),Jt=n("ul"),zh=n("li"),hl=n("a"),b0=r("Just-In-Time (JIT) compilation"),y0=c(),Ch=n("li"),ml=n("a"),E0=r("Automatic Differentiation"),w0=c(),jh=n("li"),ul=n("a"),$0=r("Vectorization"),F0=c(),qh=n("li"),fl=n("a"),x0=r("Parallelization"),M0=c(),At=n("div"),b(gl.$$.fragment),z0=c(),cn=n("p"),C0=r("The "),Ph=n("code"),j0=r("FlaxElectraPreTrainedModel"),q0=r(" forward method, overrides the "),Ah=n("code"),P0=r("__call__"),A0=r(" special method."),O0=c(),b(Qs.$$.fragment),L0=c(),b(Bs.$$.fragment),Su=c(),pn=n("h2"),Vs=n("a"),Oh=n("span"),b(_l.$$.fragment),N0=c(),Lh=n("span"),I0=r("FlaxElectraForTokenClassification"),Du=c(),Ae=n("div"),b(kl.$$.fragment),S0=c(),Nh=n("p"),D0=r("Electra model with a token classification head on top."),W0=c(),Ih=n("p"),U0=r("Both the discriminator and generator may be loaded into this model."),R0=c(),vl=n("p"),H0=r("This model inherits from "),Wd=n("a"),Q0=r("FlaxPreTrainedModel"),B0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),V0=c(),Tl=n("p"),K0=r(`This model is also a Flax Linen
`),bl=n("a"),J0=r("flax.nn.Module"),G0=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),X0=c(),Sh=n("p"),Y0=r("Finally, this model supports inherent JAX features such as:"),Z0=c(),Gt=n("ul"),Dh=n("li"),yl=n("a"),e$=r("Just-In-Time (JIT) compilation"),t$=c(),Wh=n("li"),El=n("a"),o$=r("Automatic Differentiation"),n$=c(),Uh=n("li"),wl=n("a"),s$=r("Vectorization"),a$=c(),Rh=n("li"),$l=n("a"),r$=r("Parallelization"),i$=c(),Ot=n("div"),b(Fl.$$.fragment),l$=c(),hn=n("p"),d$=r("The "),Hh=n("code"),c$=r("FlaxElectraPreTrainedModel"),p$=r(" forward method, overrides the "),Qh=n("code"),h$=r("__call__"),m$=r(" special method."),u$=c(),b(Ks.$$.fragment),f$=c(),b(Js.$$.fragment),Wu=c(),mn=n("h2"),Gs=n("a"),Bh=n("span"),b(xl.$$.fragment),g$=c(),Vh=n("span"),_$=r("FlaxElectraForQuestionAnswering"),Uu=c(),Ue=n("div"),b(Ml.$$.fragment),k$=c(),un=n("p"),v$=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Kh=n("code"),T$=r("span start logits"),b$=r(" and "),Jh=n("code"),y$=r("span end logits"),E$=r(")."),w$=c(),zl=n("p"),$$=r("This model inherits from "),Ud=n("a"),F$=r("FlaxPreTrainedModel"),x$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),M$=c(),Cl=n("p"),z$=r(`This model is also a Flax Linen
`),jl=n("a"),C$=r("flax.nn.Module"),j$=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),q$=c(),Gh=n("p"),P$=r("Finally, this model supports inherent JAX features such as:"),A$=c(),Xt=n("ul"),Xh=n("li"),ql=n("a"),O$=r("Just-In-Time (JIT) compilation"),L$=c(),Yh=n("li"),Pl=n("a"),N$=r("Automatic Differentiation"),I$=c(),Zh=n("li"),Al=n("a"),S$=r("Vectorization"),D$=c(),em=n("li"),Ol=n("a"),W$=r("Parallelization"),U$=c(),Lt=n("div"),b(Ll.$$.fragment),R$=c(),fn=n("p"),H$=r("The "),tm=n("code"),Q$=r("FlaxElectraPreTrainedModel"),B$=r(" forward method, overrides the "),om=n("code"),V$=r("__call__"),K$=r(" special method."),J$=c(),b(Xs.$$.fragment),G$=c(),b(Ys.$$.fragment),this.h()},l(o){const v=Lz('[data-svelte="svelte-1phssyn"]',document.head);d=s(v,"META",{name:!0,content:!0}),v.forEach(t),g=p(o),h=s(o,"H1",{class:!0});var Nl=a(h);m=s(Nl,"A",{id:!0,class:!0,href:!0});var nm=a(m);_=s(nm,"SPAN",{});var sm=a(_);y(l.$$.fragment,sm),sm.forEach(t),nm.forEach(t),u=p(Nl),M=s(Nl,"SPAN",{});var am=a(M);ue=i(am,"ELECTRA"),am.forEach(t),Nl.forEach(t),J=p(o),C=s(o,"H2",{class:!0});var Il=a(C);ee=s(Il,"A",{id:!0,class:!0,href:!0});var rm=a(ee);S=s(rm,"SPAN",{});var im=a(S);y(oe.$$.fragment,im),im.forEach(t),rm.forEach(t),fe=p(Il),D=s(Il,"SPAN",{});var lm=a(D);ge=i(lm,"Overview"),lm.forEach(t),Il.forEach(t),pe=p(o),K=s(o,"P",{});var Sl=a(K);O=i(Sl,"The ELECTRA model was proposed in the paper "),ne=s(Sl,"A",{href:!0,rel:!0});var dm=a(ne);X=i(dm,`ELECTRA: Pre-training Text Encoders as Discriminators Rather Than
...
splitting and wordpiece.`),ea.forEach(t),Gg=p(oo),ja=s(oo,"P",{});var Bl=a(ja);Xg=i(Bl,"Refer to superclass "),nd=s(Bl,"A",{href:!0});var Wm=a(nd);Yg=i(Wm,"BertTokenizerFast"),Wm.forEach(t),Zg=i(Bl," for usage examples and documentation concerning parameters."),Bl.forEach(t),oo.forEach(t),Gm=p(o),vo=s(o,"H2",{class:!0});var Vl=a(vo);En=s(Vl,"A",{id:!0,class:!0,href:!0});var Um=a(En);yc=s(Um,"SPAN",{});var Rm=a(yc);y(qa.$$.fragment,Rm),Rm.forEach(t),Um.forEach(t),e_=p(Vl),Ec=s(Vl,"SPAN",{});var Hm=a(Ec);t_=i(Hm,"Electra specific outputs"),Hm.forEach(t),Vl.forEach(t),Xm=p(o),To=s(o,"DIV",{class:!0});var Hu=a(To);y(Pa.$$.fragment,Hu),o_=p(Hu),Aa=s(Hu,"P",{});var Qu=a(Aa);n_=i(Qu,"Output type of "),sd=s(Qu,"A",{href:!0});var X$=a(sd);s_=i(X$,"ElectraForPreTraining"),X$.forEach(t),a_=i(Qu,"."),Qu.forEach(t),Hu.forEach(t),Ym=p(o),bo=s(o,"DIV",{class:!0});var Bu=a(bo);y(Oa.$$.fragment,Bu),r_=p(Bu),La=s(Bu,"P",{});var Vu=a(La);i_=i(Vu,"Output type of "),ad=s(Vu,"A",{href:!0});var Y$=a(ad);l_=i(Y$,"TFElectraForPreTraining"),Y$.forEach(t),d_=i(Vu,"."),Vu.forEach(t),Bu.forEach(t),Zm=p(o),yo=s(o,"H2",{class:!0});var Ku=a(yo);wn=s(Ku,"A",{id:!0,class:!0,href:!0});var Z$=a(wn);wc=s(Z$,"SPAN",{});var e2=a(wc);y(Na.$$.fragment,e2),e2.forEach(t),Z$.forEach(t),c_=p(Ku),$c=s(Ku,"SPAN",{});var t2=a($c);p_=i(t2,"ElectraModel"),t2.forEach(t),Ku.forEach(t),eu=p(o),Ze=s(o,"DIV",{class:!0});var no=a(Ze);y(Ia.$$.fragment,no),h_=p(no),Fc=s(no,"P",{});var o2=a(Fc);m_=i(o2,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),o2.forEach(t),u_=p(no),Sa=s(no,"P",{});var Ju=a(Sa);f_=i(Ju,"This model inherits from "),rd=s(Ju,"A",{href:!0});var n2=a(rd);g_=i(n2,"PreTrainedModel"),n2.forEach(t),__=i(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju.forEach(t),k_=p(no),Da=s(no,"P",{});var Gu=a(Da);v_=i(Gu,"This model is also a PyTorch "),Wa=s(Gu,"A",{href:!0,rel:!0});var s2=a(Wa);T_=i(s2,"torch.nn.Module"),s2.forEach(t),b_=i(Gu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gu.forEach(t),y_=p(no),Et=s(no,"DIV",{class:!0});var ta=a(Et);y(Ua.$$.fragment,ta),E_=p(ta),Eo=s(ta,"P",{});var Rd=a(Eo);w_=i(Rd,"The "),id=s(Rd,"A",{href:!0});var a2=a(id);$_=i(a2,"ElectraModel"),a2.forEach(t),F_=i(Rd," forward method, overrides the "),xc=s(Rd,"CODE",{});var r2=a(xc);x_=i(r2,"__call__"),r2.forEach(t),M_=i(Rd," special method."),Rd.forEach(t),z_=p(ta),y($n.$$.fragment,ta),C_=p(ta),y(Fn.$$.fragment,ta),ta.forEach(t),no.forEach(t),tu=p(o),wo=s(o,"H2",{class:!0});var Xu=a(wo);xn=s(Xu,"A",{id:!0,class:!0,href:!0});var i2=a(xn);Mc=s(i2,"SPAN",{});var l2=a(Mc);y(Ra.$$.fragment,l2),l2.forEach(t),i2.forEach(t),j_=p(Xu),zc=s(Xu,"SPAN",{});var d2=a(zc);q_=i(d2,"ElectraForPreTraining"),d2.forEach(t),Xu.forEach(t),ou=p(o),He=s(o,"DIV",{class:!0});var Nt=a(He);y(Ha.$$.fragment,Nt),P_=p(Nt),Cc=s(Nt,"P",{});var c2=a(Cc);A_=i(c2,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),c2.forEach(t),O_=p(Nt),jc=s(Nt,"P",{});var p2=a(jc);L_=i(p2,"It is recommended to load the discriminator checkpoint into that model."),p2.forEach(t),N_=p(Nt),Qa=s(Nt,"P",{});var Yu=a(Qa);I_=i(Yu,"This model inherits from "),ld=s(Yu,"A",{href:!0});var h2=a(ld);S_=i(h2,"PreTrainedModel"),h2.forEach(t),D_=i(Yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yu.forEach(t),W_=p(Nt),Ba=s(Nt,"P",{});var Zu=a(Ba);U_=i(Zu,"This model is also a PyTorch "),Va=s(Zu,"A",{href:!0,rel:!0});var m2=a(Va);R_=i(m2,"torch.nn.Module"),m2.forEach(t),H_=i(Zu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zu.forEach(t),Q_=p(Nt),wt=s(Nt,"DIV",{class:!0});var oa=a(wt);y(Ka.$$.fragment,oa),B_=p(oa),$o=s(oa,"P",{});var Hd=a($o);V_=i(Hd,"The "),dd=s(Hd,"A",{href:!0});var u2=a(dd);K_=i(u2,"ElectraForPreTraining"),u2.forEach(t),J_=i(Hd," forward method, overrides the "),qc=s(Hd,"CODE",{});var f2=a(qc);G_=i(f2,"__call__"),f2.forEach(t),X_=i(Hd," special method."),Hd.forEach(t),Y_=p(oa),y(Mn.$$.fragment,oa),Z_=p(oa),y(zn.$$.fragment,oa),oa.forEach(t),Nt.forEach(t),nu=p(o),Fo=s(o,"H2",{class:!0});var ef=a(Fo);Cn=s(ef,"A",{id:!0,class:!0,href:!0});var g2=a(Cn);Pc=s(g2,"SPAN",{});var _2=a(Pc);y(Ja.$$.fragment,_2),_2.forEach(t),g2.forEach(t),ek=p(ef),Ac=s(ef,"SPAN",{});var k2=a(Ac);tk=i(k2,"ElectraForCausalLM"),k2.forEach(t),ef.forEach(t),su=p(o),et=s(o,"DIV",{class:!0});var so=a(et);y(Ga.$$.fragment,so),ok=p(so),Xa=s(so,"P",{});var tf=a(Xa);nk=i(tf,"ELECTRA Model with a "),Oc=s(tf,"CODE",{});var v2=a(Oc);sk=i(v2,"language modeling"),v2.forEach(t),ak=i(tf," head on top for CLM fine-tuning."),tf.forEach(t),rk=p(so),Ya=s(so,"P",{});var of=a(Ya);ik=i(of,"This model inherits from "),cd=s(of,"A",{href:!0});var T2=a(cd);lk=i(T2,"PreTrainedModel"),T2.forEach(t),dk=i(of,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),of.forEach(t),ck=p(so),Za=s(so,"P",{});var nf=a(Za);pk=i(nf,"This model is also a PyTorch "),er=s(nf,"A",{href:!0,rel:!0});var b2=a(er);hk=i(b2,"torch.nn.Module"),b2.forEach(t),mk=i(nf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nf.forEach(t),uk=p(so),$t=s(so,"DIV",{class:!0});var na=a($t);y(tr.$$.fragment,na),fk=p(na),xo=s(na,"P",{});var Qd=a(xo);gk=i(Qd,"The "),pd=s(Qd,"A",{href:!0});var y2=a(pd);_k=i(y2,"ElectraForCausalLM"),y2.forEach(t),kk=i(Qd," forward method, overrides the "),Lc=s(Qd,"CODE",{});var E2=a(Lc);vk=i(E2,"__call__"),E2.forEach(t),Tk=i(Qd," special method."),Qd.forEach(t),bk=p(na),y(jn.$$.fragment,na),yk=p(na),y(qn.$$.fragment,na),na.forEach(t),so.forEach(t),au=p(o),Mo=s(o,"H2",{class:!0});var sf=a(Mo);Pn=s(sf,"A",{id:!0,class:!0,href:!0});var w2=a(Pn);Nc=s(w2,"SPAN",{});var $2=a(Nc);y(or.$$.fragment,$2),$2.forEach(t),w2.forEach(t),Ek=p(sf),Ic=s(sf,"SPAN",{});var F2=a(Ic);wk=i(F2,"ElectraForMaskedLM"),F2.forEach(t),sf.forEach(t),ru=p(o),Qe=s(o,"DIV",{class:!0});var It=a(Qe);y(nr.$$.fragment,It),$k=p(It),Sc=s(It,"P",{});var x2=a(Sc);Fk=i(x2,"Electra model with a language modeling head on top."),x2.forEach(t),xk=p(It),Dc=s(It,"P",{});var M2=a(Dc);Mk=i(M2,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),M2.forEach(t),zk=p(It),sr=s(It,"P",{});var af=a(sr);Ck=i(af,"This model inherits from "),hd=s(af,"A",{href:!0});var z2=a(hd);jk=i(z2,"PreTrainedModel"),z2.forEach(t),qk=i(af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),af.forEach(t),Pk=p(It),ar=s(It,"P",{});var rf=a(ar);Ak=i(rf,"This model is also a PyTorch "),rr=s(rf,"A",{href:!0,rel:!0});var C2=a(rr);Ok=i(C2,"torch.nn.Module"),C2.forEach(t),Lk=i(rf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rf.forEach(t),Nk=p(It),st=s(It,"DIV",{class:!0});var ao=a(st);y(ir.$$.fragment,ao),Ik=p(ao),zo=s(ao,"P",{});var Bd=a(zo);Sk=i(Bd,"The "),md=s(Bd,"A",{href:!0});var j2=a(md);Dk=i(j2,"ElectraForMaskedLM"),j2.forEach(t),Wk=i(Bd," forward method, overrides the "),Wc=s(Bd,"CODE",{});var q2=a(Wc);Uk=i(q2,"__call__"),q2.forEach(t),Rk=i(Bd," special method."),Bd.forEach(t),Hk=p(ao),y(An.$$.fragment,ao),Qk=p(ao),y(On.$$.fragment,ao),Bk=p(ao),y(Ln.$$.fragment,ao),ao.forEach(t),It.forEach(t),iu=p(o),Co=s(o,"H2",{class:!0});var lf=a(Co);Nn=s(lf,"A",{id:!0,class:!0,href:!0});var P2=a(Nn);Uc=s(P2,"SPAN",{});var A2=a(Uc);y(lr.$$.fragment,A2),A2.forEach(t),P2.forEach(t),Vk=p(lf),Rc=s(lf,"SPAN",{});var O2=a(Rc);Kk=i(O2,"ElectraForSequenceClassification"),O2.forEach(t),lf.forEach(t),lu=p(o),tt=s(o,"DIV",{class:!0});var ro=a(tt);y(dr.$$.fragment,ro),Jk=p(ro),Hc=s(ro,"P",{});var L2=a(Hc);Gk=i(L2,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),L2.forEach(t),Xk=p(ro),cr=s(ro,"P",{});var df=a(cr);Yk=i(df,"This model inherits from "),ud=s(df,"A",{href:!0});var N2=a(ud);Zk=i(N2,"PreTrainedModel"),N2.forEach(t),ev=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),df.forEach(t),tv=p(ro),pr=s(ro,"P",{});var cf=a(pr);ov=i(cf,"This model is also a PyTorch "),hr=s(cf,"A",{href:!0,rel:!0});var I2=a(hr);nv=i(I2,"torch.nn.Module"),I2.forEach(t),sv=i(cf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cf.forEach(t),av=p(ro),Re=s(ro,"DIV",{class:!0});var pt=a(Re);y(mr.$$.fragment,pt),rv=p(pt),jo=s(pt,"P",{});var Vd=a(jo);iv=i(Vd,"The "),fd=s(Vd,"A",{href:!0});var S2=a(fd);lv=i(S2,"ElectraForSequenceClassification"),S2.forEach(t),dv=i(Vd," forward method, overrides the "),Qc=s(Vd,"CODE",{});var D2=a(Qc);cv=i(D2,"__call__"),D2.forEach(t),pv=i(Vd," special method."),Vd.forEach(t),hv=p(pt),y(In.$$.fragment,pt),mv=p(pt),y(Sn.$$.fragment,pt),uv=p(pt),y(Dn.$$.fragment,pt),fv=p(pt),y(Wn.$$.fragment,pt),gv=p(pt),y(Un.$$.fragment,pt),pt.forEach(t),ro.forEach(t),du=p(o),qo=s(o,"H2",{class:!0});var pf=a(qo);Rn=s(pf,"A",{id:!0,class:!0,href:!0});var W2=a(Rn);Bc=s(W2,"SPAN",{});var U2=a(Bc);y(ur.$$.fragment,U2),U2.forEach(t),W2.forEach(t),_v=p(pf),Vc=s(pf,"SPAN",{});var R2=a(Vc);kv=i(R2,"ElectraForMultipleChoice"),R2.forEach(t),pf.forEach(t),cu=p(o),ot=s(o,"DIV",{class:!0});var io=a(ot);y(fr.$$.fragment,io),vv=p(io),Kc=s(io,"P",{});var H2=a(Kc);Tv=i(H2,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),H2.forEach(t),bv=p(io),gr=s(io,"P",{});var hf=a(gr);yv=i(hf,"This model inherits from "),gd=s(hf,"A",{href:!0});var Q2=a(gd);Ev=i(Q2,"PreTrainedModel"),Q2.forEach(t),wv=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),$v=p(io),_r=s(io,"P",{});var mf=a(_r);Fv=i(mf,"This model is also a PyTorch "),kr=s(mf,"A",{href:!0,rel:!0});var B2=a(kr);xv=i(B2,"torch.nn.Module"),B2.forEach(t),Mv=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mf.forEach(t),zv=p(io),Ft=s(io,"DIV",{class:!0});var sa=a(Ft);y(vr.$$.fragment,sa),Cv=p(sa),Po=s(sa,"P",{});var Kd=a(Po);jv=i(Kd,"The "),_d=s(Kd,"A",{href:!0});var V2=a(_d);qv=i(V2,"ElectraForMultipleChoice"),V2.forEach(t),Pv=i(Kd," forward method, overrides the "),Jc=s(Kd,"CODE",{});var K2=a(Jc);Av=i(K2,"__call__"),K2.forEach(t),Ov=i(Kd," special method."),Kd.forEach(t),Lv=p(sa),y(Hn.$$.fragment,sa),Nv=p(sa),y(Qn.$$.fragment,sa),sa.forEach(t),io.forEach(t),pu=p(o),Ao=s(o,"H2",{class:!0});var uf=a(Ao);Bn=s(uf,"A",{id:!0,class:!0,href:!0});var J2=a(Bn);Gc=s(J2,"SPAN",{});var G2=a(Gc);y(Tr.$$.fragment,G2),G2.forEach(t),J2.forEach(t),Iv=p(uf),Xc=s(uf,"SPAN",{});var X2=a(Xc);Sv=i(X2,"ElectraForTokenClassification"),X2.forEach(t),uf.forEach(t),hu=p(o),Be=s(o,"DIV",{class:!0});var St=a(Be);y(br.$$.fragment,St),Dv=p(St),Yc=s(St,"P",{});var Y2=a(Yc);Wv=i(Y2,"Electra model with a token classification head on top."),Y2.forEach(t),Uv=p(St),Zc=s(St,"P",{});var Z2=a(Zc);Rv=i(Z2,"Both the discriminator and generator may be loaded into this model."),Z2.forEach(t),Hv=p(St),yr=s(St,"P",{});var ff=a(yr);Qv=i(ff,"This model inherits from "),kd=s(ff,"A",{href:!0});var eF=a(kd);Bv=i(eF,"PreTrainedModel"),eF.forEach(t),Vv=i(ff,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
