import{S as py,i as hy,s as my,e as r,k as h,w as v,t as n,M as uy,c as a,d as t,m,a as i,x as y,h as s,b,F as e,g,y as w,q as M,o as $,B as F,v as fy,L as xe}from"../../chunks/vendor-6b77c823.js";import{T as Pe}from"../../chunks/Tip-39098574.js";import{D as ie}from"../../chunks/Docstring-1088f2fb.js";import{C as ze}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-5212b321.js";function gy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertModel, MobileBertConfig
...
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,_),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function qy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertTokenizer, MobileBertForMultipleChoice
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Iy(E){let d,_,c,p,T,l,u,x,he,V,z,J,D,X,me,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
tensors in the first argument of the model call function: `),L=a(S,"CODE",{});var Te=i(L);ue=s(Te,"model(inputs)"),Te.forEach(t),le=s(S,"."),S.forEach(t),K=m(f),N=a(f,"P",{});var ke=i(N);ee=s(ke,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(f,B){g(f,d,B),e(d,_),g(f,c,B),g(f,p,B),e(p,T),e(T,l),e(p,u),e(p,x),e(x,he),g(f,V,B),g(f,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,ue),e(z,le),g(f,K,B),g(f,N,B),e(N,ee),g(f,G,B),g(f,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,fe),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(f){f&&t(d),f&&t(c),f&&t(p),f&&t(V),f&&t(z),f&&t(K),f&&t(N),f&&t(G),f&&t(P)}}}function Dy(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,_),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function Ly(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertTokenizer, TFMobileBertModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=r("p"),_=n("Example:"),c=h(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=m(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Wy(E){let d,_,c,p,T,l,u,x,he,V,z,J,D,X,me,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=h(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=a(Q,"CODE",{});var Me=i(R);Z=s(Me,"model([input_ids, attention_mask])"),Me.forEach(t),re=s(Q," or "),H=a(Q,"CODE",{});var te=i(H);_e=s(te,"model([input_ids, attention_mask, token_type_ids])"),te.forEach(t),Q.forEach(t),ae=m(j),O=a(j,"LI",{});var oe=i(O);pe=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(f,B){g(f,d,B),e(d,_),g(f,c,B),g(f,p,B),e(p,T),e(T,l),e(p,u),e(p,x),e(x,he),g(f,V,B),g(f,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,ue),e(z,le),g(f,K,B),g(f,N,B),e(N,ee),g(f,G,B),g(f,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,fe),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(f){f&&t(d),f&&t(c),f&&t(p),f&&t(V),f&&t(z),f&&t(K),f&&t(N),f&&t(G),f&&t(P)}}}function Ry(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=a(Q,"CODE",{});var Me=i(R);Z=s(Me,"model([input_ids, attention_mask])"),Me.forEach(t),re=s(Q," or "),H=a(Q,"CODE",{});var te=i(H);_e=s(te,"model([input_ids, attention_mask, token_type_ids])"),te.forEach(t),Q.forEach(t),ae=m(j),O=a(j,"LI",{});var oe=i(O);pe=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(f,B){g(f,d,B),e(d,_),g(f,c,B),g(f,p,B),e(p,T),e(T,l),e(p,u),e(p,x),e(x,he),g(f,V,B),g(f,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,ue),e(z,le),g(f,K,B),g(f,N,B),e(N,ee),g(f,G,B),g(f,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,fe),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(f){f&&t(d),f&&t(c),f&&t(p),f&&t(V),f&&t(z),f&&t(K),f&&t(N),f&&t(G),f&&t(P)}}}function Qy(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-number">0.57</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Gy(E){let d,_,c,p,T,l,u,x,he,V,z,J,D,X,me,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=h(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=a(Q,"CODE",{});var Me=i(R);Z=s(Me,"model([input_ids, attention_mask])"),Me.forEach(t),re=s(Q," or "),H=a(Q,"CODE",{});var te=i(H);_e=s(te,"model([input_ids, attention_mask, token_type_ids])"),te.forEach(t),Q.forEach(t),ae=m(j),O=a(j,"LI",{});var oe=i(O);pe=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(f,B){g(f,d,B),e(d,_),g(f,c,B),g(f,p,B),e(p,T),e(T,l),e(p,u),e(p,x),e(x,he),g(f,V,B),g(f,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,ue),e(z,le),g(f,K,B),g(f,N,B),e(N,ee),g(f,G,B),g(f,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,fe),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(f){f&&t(d),f&&t(c),f&&t(p),f&&t(V),f&&t(z),f&&t(K),f&&t(N),f&&t(G),f&&t(P)}}}function Yy(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=a(Q,"CODE",{});var Me=i(R);Z=s(Me,"model([input_ids, attention_mask])"),Me.forEach(t),re=s(Q," or "),H=a(Q,"CODE",{});var te=i(H);_e=s(te,"model([input_ids, attention_mask, token_type_ids])"),te.forEach(t),Q.forEach(t),ae=m(j),O=a(j,"LI",{});var oe=i(O);pe=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(f,B){g(f,d,B),e(d,_),g(f,c,B),g(f,p,B),e(p,T),e(T,l),e(p,u),e(p,x),e(x,he),g(f,V,B),g(f,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,ue),e(z,le),g(f,K,B),g(f,N,B),e(N,ee),g(f,G,B),g(f,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,fe),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(f){f&&t(d),f&&t(c),f&&t(p),f&&t(V),f&&t(z),f&&t(K),f&&t(N),f&&t(G),f&&t(P)}}}function Xy(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=a(Q,"CODE",{});var Me=i(R);Z=s(Me,"model([input_ids, attention_mask])"),Me.forEach(t),re=s(Q," or "),H=a(Q,"CODE",{});var te=i(H);_e=s(te,"model([input_ids, attention_mask, token_type_ids])"),te.forEach(t),Q.forEach(t),ae=m(j),O=a(j,"LI",{});var oe=i(O);pe=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(f,B){g(f,d,B),e(d,_),g(f,c,B),g(f,p,B),e(p,T),e(T,l),e(p,u),e(p,x),e(x,he),g(f,V,B),g(f,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,ue),e(z,le),g(f,K,B),g(f,N,B),e(N,ee),g(f,G,B),g(f,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,fe),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(f){f&&t(d),f&&t(c),f&&t(p),f&&t(V),f&&t(z),f&&t(K),f&&t(N),f&&t(G),f&&t(P)}}}function nw(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=r("p"),_=n("Example:"),c=h(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=m(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function rw(E){let d,_,c,p,T,l,u,x,he,V,z,J,D,X,me,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=h(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=a(Q,"CODE",{});var Me=i(R);Z=s(Me,"model([input_ids, attention_mask])"),Me.forEach(t),re=s(Q," or "),H=a(Q,"CODE",{});var te=i(H);_e=s(te,"model([input_ids, attention_mask, token_type_ids])"),te.forEach(t),Q.forEach(t),ae=m(j),O=a(j,"LI",{});var oe=i(O);pe=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(f,B){g(f,d,B),e(d,_),g(f,c,B),g(f,p,B),e(p,T),e(T,l),e(p,u),e(p,x),e(x,he),g(f,V,B),g(f,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,ue),e(z,le),g(f,K,B),g(f,N,B),e(N,ee),g(f,G,B),g(f,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,fe),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(f){f&&t(d),f&&t(c),f&&t(p),f&&t(V),f&&t(z),f&&t(K),f&&t(N),f&&t(G),f&&t(P)}}}function aw(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.03</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function dw(E){let d,_,c,p,T,l,u,x,he,V,z,J,D,X,me,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=h(),x=r("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=h(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=h(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=h(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=h(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=m(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=m(Y),x=a(Y,"LI",{});var $e=i(x);he=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=m(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),me=s(S,` method which currently requires having all the
...
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=a(Q,"CODE",{});var Me=i(R);Z=s(Me,"model([input_ids, attention_mask])"),Me.forEach(t),re=s(Q," or "),H=a(Q,"CODE",{});var te=i(H);_e=s(te,"model([input_ids, attention_mask, token_type_ids])"),te.forEach(t),Q.forEach(t),ae=m(j),O=a(j,"LI",{});var oe=i(O);pe=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=a(oe,"CODE",{});var Be=i(A);be=s(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(t),oe.forEach(t),j.forEach(t)},m(f,B){g(f,d,B),e(d,_),g(f,c,B),g(f,p,B),e(p,T),e(T,l),e(p,u),e(p,x),e(x,he),g(f,V,B),g(f,z,B),e(z,J),e(z,D),e(D,X),e(z,me),e(z,L),e(L,ue),e(z,le),g(f,K,B),g(f,N,B),e(N,ee),g(f,G,B),g(f,P,B),e(P,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,W),e(W,fe),e(P,ce),e(P,q),e(q,ge),e(q,R),e(R,Z),e(q,re),e(q,H),e(H,_e),e(P,ae),e(P,O),e(O,pe),e(O,A),e(A,be)},d(f){f&&t(d),f&&t(c),f&&t(p),f&&t(V),f&&t(z),f&&t(K),f&&t(N),f&&t(G),f&&t(P)}}}function cw(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function mw(E){let d,_,c,p,T,l,u,x,he,V,z,J,D,X,me,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be,f,B,Y,ve,$e,S,we,Te,ke,j,I,Fe,ye,Q,Me,te,oe,Be,Mt,Ep,ya,xp,zp,wa,Pp,qp,is,Cp,jp,Np,Wt,Op,Ma,Sp,Ap,$a,Ip,Dp,Lp,Co,Wp,qi,Rp,Ad,Rt,jo,Ci,ls,Up,ji,Hp,Id,st,ds,Qp,Ni,Kp,Vp,No,Fa,Gp,Yp,Ba,Jp,Zp,Xp,cs,eh,Ea,th,oh,Dd,Ut,Oo,Oi,ps,nh,Si,sh,Ld,rt,hs,rh,ms,ah,Ai,ih,lh,dh,So,xa,ch,ph,za,hh,mh,uh,us,fh,Pa,gh,_h,Wd,Ht,Ao,Ii,fs,bh,Di,Th,Rd,Qt,gs,kh,_s,vh,qa,yh,wh,Ud,Kt,bs,Mh,Ts,$h,Ca,Fh,Bh,Hd,Vt,Io,Li,ks,Eh,Wi,xh,Qd,je,vs,zh,Ri,Ph,qh,ys,Ch,ja,jh,Nh,Oh,ws,Sh,Ms,Ah,Ih,Dh,Ui,$s,Lh,Wh,it,Fs,Rh,Gt,Uh,Na,Hh,Qh,Hi,Kh,Vh,Gh,Do,Yh,Lo,Kd,Yt,Wo,Qi,Bs,Jh,Ki,Zh,Vd,Re,Es,Xh,Jt,em,Vi,tm,om,Gi,nm,sm,rm,xs,am,Oa,im,lm,dm,zs,cm,Ps,pm,hm,mm,lt,qs,um,Zt,fm,Sa,gm,_m,Yi,bm,Tm,km,Ro,vm,Uo,Gd,Xt,Ho,Ji,Cs,ym,Zi,wm,Yd,Ue,js,Mm,Ns,$m,Xi,Fm,Bm,Em,Os,xm,Aa,zm,Pm,qm,Ss,Cm,As,jm,Nm,Om,Ye,Is,Sm,eo,Am,Ia,Im,Dm,el,Lm,Wm,Rm,Qo,Um,Ko,Hm,Vo,Jd,to,Go,tl,Ds,Qm,ol,Km,Zd,He,Ls,Vm,Ws,Gm,nl,Ym,Jm,Zm,Rs,Xm,Da,eu,tu,ou,Us,nu,Hs,su,ru,au,dt,Qs,iu,oo,lu,La,du,cu,sl,pu,hu,mu,Yo,uu,Jo,Xd,no,Zo,rl,Ks,fu,al,gu,ec,Qe,Vs,_u,il,bu,Tu,Gs,ku,Wa,vu,yu,wu,Ys,Mu,Js,$u,Fu,Bu,Ce,Zs,Eu,so,xu,Ra,zu,Pu,ll,qu,Cu,ju,Xo,Nu,en,Ou,tn,Su,on,Au,nn,tc,ro,sn,dl,Xs,Iu,cl,Du,oc,Ke,er,Lu,pl,Wu,Ru,tr,Uu,Ua,Hu,Qu,Ku,or,Vu,nr,Gu,Yu,Ju,ct,sr,Zu,ao,Xu,Ha,ef,tf,hl,of,nf,sf,rn,rf,an,nc,io,ln,ml,rr,af,ul,lf,sc,Ve,ar,df,fl,cf,pf,ir,hf,Qa,mf,uf,ff,lr,gf,dr,_f,bf,Tf,Je,cr,kf,lo,vf,Ka,yf,wf,gl,Mf,$f,Ff,dn,Bf,cn,Ef,pn,rc,co,hn,_l,pr,xf,bl,zf,ac,Ge,hr,Pf,po,qf,Tl,Cf,jf,kl,Nf,Of,Sf,mr,Af,Va,If,Df,Lf,ur,Wf,fr,Rf,Uf,Hf,Ze,gr,Qf,ho,Kf,Ga,Vf,Gf,vl,Yf,Jf,Zf,mn,Xf,un,eg,fn,ic,mo,gn,yl,_r,tg,wl,og,lc,Ne,br,ng,Ml,sg,rg,Tr,ag,Ya,ig,lg,dg,kr,cg,vr,pg,hg,mg,_n,ug,pt,yr,fg,uo,gg,Ja,_g,bg,$l,Tg,kg,vg,bn,yg,Tn,dc,fo,kn,Fl,wr,wg,Bl,Mg,cc,Oe,Mr,$g,go,Fg,El,Bg,Eg,xl,xg,zg,Pg,$r,qg,Za,Cg,jg,Ng,Fr,Og,Br,Sg,Ag,Ig,vn,Dg,ht,Er,Lg,_o,Wg,Xa,Rg,Ug,zl,Hg,Qg,Kg,yn,Vg,wn,pc,bo,Mn,Pl,xr,Gg,ql,Yg,hc,Se,zr,Jg,Pr,Zg,Cl,Xg,e_,t_,qr,o_,ei,n_,s_,r_,Cr,a_,jr,i_,l_,d_,$n,c_,Xe,Nr,p_,To,h_,ti,m_,u_,jl,f_,g_,__,Fn,b_,Bn,T_,En,mc,ko,xn,Nl,Or,k_,Ol,v_,uc,Ae,Sr,y_,Ar,w_,Sl,M_,$_,F_,Ir,B_,oi,E_,x_,z_,Dr,P_,Lr,q_,C_,j_,zn,N_,mt,Wr,O_,vo,S_,ni,A_,I_,Al,D_,L_,W_,Pn,R_,qn,fc,yo,Cn,Il,Rr,U_,Dl,H_,gc,Ie,Ur,Q_,Ll,K_,V_,Hr,G_,si,Y_,J_,Z_,Qr,X_,Kr,eb,tb,ob,jn,nb,et,Vr,sb,wo,rb,ri,ab,ib,Wl,lb,db,cb,Nn,pb,On,hb,Sn,_c,Mo,An,Rl,Gr,mb,Ul,ub,bc,De,Yr,fb,Hl,gb,_b,Jr,bb,ai,Tb,kb,vb,Zr,yb,Xr,wb,Mb,$b,In,Fb,ut,ea,Bb,$o,Eb,ii,xb,zb,Ql,Pb,qb,Cb,Dn,jb,Ln,Tc,Fo,Wn,Kl,ta,Nb,Vl,Ob,kc,Le,oa,Sb,Gl,Ab,Ib,na,Db,li,Lb,Wb,Rb,sa,Ub,ra,Hb,Qb,Kb,Rn,Vb,tt,aa,Gb,Bo,Yb,di,Jb,Zb,Yl,Xb,eT,tT,Un,oT,Hn,nT,Qn,vc,Eo,Kn,Jl,ia,sT,Zl,rT,yc,We,la,aT,xo,iT,Xl,lT,dT,ed,cT,pT,hT,da,mT,ci,uT,fT,gT,ca,_T,pa,bT,TT,kT,Vn,vT,ot,ha,yT,zo,wT,pi,MT,$T,td,FT,BT,ET,Gn,xT,Yn,zT,Jn,wc;return l=new qe({}),X=new qe({}),I=new qe({}),oe=new ie({props:{name:"class transformers.MobileBertConfig",anchor:"transformers.MobileBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 512"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 512"},{name:"hidden_act",val:" = 'relu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"embedding_size",val:" = 128"},{name:"trigram_input",val:" = True"},{name:"use_bottleneck",val:" = True"},{name:"intra_bottleneck_size",val:" = 128"},{name:"use_bottleneck_attention",val:" = False"},{name:"key_query_shared_bottleneck",val:" = True"},{name:"num_feedforward_networks",val:" = 4"},{name:"normalization_type",val:" = 'no_norm'"},{name:"classifier_activation",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MobileBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the MobileBERT model. Defines the number of different tokens that can be represented by
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or <a href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.MobileBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L797"}}),ks=new qe({}),vs=new ie({props:{name:"class transformers.MobileBertModel",anchor:"transformers.MobileBertModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.MobileBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.MobileBertConfig">MobileBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17008/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L805"}}),Fs=new ie({props:{name:"forward",anchor:"transformers.MobileBertModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_attentions",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MobileBertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17008/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17008/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17008/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17008/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L835",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
`}}),Do=new Pe({props:{$$slots:{default:[_y]},$$scope:{ctx:E}}}),Lo=new Ee({props:{anchor:"transformers.MobileBertModel.forward.example",$$slots:{default:[by]},$$scope:{ctx:E}}}),Bs=new qe({}),Es=new ie({props:{name:"class transformers.MobileBertForPreTraining",anchor:"transformers.MobileBertForPreTraining",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MobileBertForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.MobileBertConfig">MobileBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17008/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L921"}}),qs=new ie({props:{name:"forward",anchor:"transformers.MobileBertForPreTraining.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"next_sentence_label",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MobileBertForPreTraining.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17008/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17008/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17008/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L944",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L1053",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L1139",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L1248",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L1459",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L1561",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_mobilebert.py#L1351",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
<a href="/docs/transformers/pr_17008/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17008/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
`}}),bn=new Pe({props:{$$slots:{default:[Dy]},$$scope:{ctx:E}}}),Tn=new Ee({props:{anchor:"transformers.TFMobileBertModel.call.example",$$slots:{default:[Ly]},$$scope:{ctx:E}}}),wr=new qe({}),Mr=new ie({props:{name:"class transformers.TFMobileBertForPreTraining",anchor:"transformers.TFMobileBertForPreTraining",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMobileBertForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.MobileBertConfig">MobileBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_tf_outputs.TFNextSentencePredictorOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
`}}),Dn=new Pe({props:{$$slots:{default:[nw]},$$scope:{ctx:E}}}),Ln=new Ee({props:{anchor:"transformers.TFMobileBertForMultipleChoice.call.example",$$slots:{default:[sw]},$$scope:{ctx:E}}}),ta=new qe({}),oa=new ie({props:{name:"class transformers.TFMobileBertForTokenClassification",anchor:"transformers.TFMobileBertForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMobileBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17008/en/model_doc/mobilebert#transformers.MobileBertConfig">MobileBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17008/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17008/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
`}}),Gn=new Pe({props:{$$slots:{default:[cw]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[pw]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[hw]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=h(),c=r("h1"),p=r("a"),T=r("span"),v(l.$$.fragment),u=h(),x=r("span"),he=n("MobileBERT"),V=h(),z=r("h2"),J=r("a"),D=r("span"),v(X.$$.fragment),me=h(),L=r("span"),ue=n("Overview"),le=h(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),P=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
...
documentation from `),$a=r("a"),Ip=n("PretrainedConfig"),Dp=n(" for more information."),Lp=h(),v(Co.$$.fragment),Wp=h(),qi=r("p"),Rp=n(`Attributes: pretrained_config_archive_map (Dict[str, str]): A dictionary containing all the available pre-trained
...
and wordpiece.`),Xp=h(),cs=r("p"),eh=n("Refer to superclass "),Ea=r("a"),th=n("BertTokenizer"),oh=n(" for usage examples and documentation concerning parameters."),Dd=h(),Ut=r("h2"),Oo=r("a"),Oi=r("span"),v(ps.$$.fragment),nh=h(),Si=r("span"),sh=n("MobileBertTokenizerFast"),Ld=h(),rt=r("div"),v(hs.$$.fragment),rh=h(),ms=r("p"),ah=n("Construct a \u201Cfast\u201D MobileBERT tokenizer (backed by HuggingFace\u2019s "),Ai=r("em"),ih=n("tokenizers"),lh=n(" library)."),dh=h(),So=r("p"),xa=r("a"),ch=n("MobileBertTokenizerFast"),ph=n(" is identical to "),za=r("a"),hh=n("BertTokenizerFast"),mh=n(` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),uh=h(),us=r("p"),fh=n("Refer to superclass "),Pa=r("a"),gh=n("BertTokenizerFast"),_h=n(" for usage examples and documentation concerning parameters."),Wd=h(),Ht=r("h2"),Ao=r("a"),Ii=r("span"),v(fs.$$.fragment),bh=h(),Di=r("span"),Th=n("MobileBert specific outputs"),Rd=h(),Qt=r("div"),v(gs.$$.fragment),kh=h(),_s=r("p"),vh=n("Output type of "),qa=r("a"),yh=n("MobileBertForPreTraining"),wh=n("."),Ud=h(),Kt=r("div"),v(bs.$$.fragment),Mh=h(),Ts=r("p"),$h=n("Output type of "),Ca=r("a"),Fh=n("TFMobileBertForPreTraining"),Bh=n("."),Hd=h(),Vt=r("h2"),Io=r("a"),Li=r("span"),v(ks.$$.fragment),Eh=h(),Wi=r("span"),xh=n("MobileBertModel"),Qd=h(),je=r("div"),v(vs.$$.fragment),zh=h(),Ri=r("p"),Ph=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),qh=h(),ys=r("p"),Ch=n("This model inherits from "),ja=r("a"),jh=n("PreTrainedModel"),Nh=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mm=h(),lt=r("div"),v(qs.$$.fragment),um=h(),Zt=r("p"),fm=n("The "),Sa=r("a"),gm=n("MobileBertForPreTraining"),_m=n(" forward method, overrides the "),Yi=r("code"),bm=n("__call__"),Tm=n(" special method."),km=h(),v(Ro.$$.fragment),vm=h(),v(Uo.$$.fragment),Gd=h(),Xt=r("h2"),Ho=r("a"),Ji=r("span"),v(Cs.$$.fragment),ym=h(),Zi=r("span"),wm=n("MobileBertForMaskedLM"),Yd=h(),Ue=r("div"),v(js.$$.fragment),Mm=h(),Ns=r("p"),$m=n("MobileBert Model with a "),Xi=r("code"),Fm=n("language modeling"),Bm=n(" head on top."),Em=h(),Os=r("p"),xm=n("This model inherits from "),Aa=r("a"),zm=n("PreTrainedModel"),Pm=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qm=h(),Ss=r("p"),Cm=n("This model is also a PyTorch "),As=r("a"),jm=n("torch.nn.Module"),Nm=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Om=h(),Ye=r("div"),v(Is.$$.fragment),Sm=h(),eo=r("p"),Am=n("The "),Ia=r("a"),Im=n("MobileBertForMaskedLM"),Dm=n(" forward method, overrides the "),el=r("code"),Lm=n("__call__"),Wm=n(" special method."),Rm=h(),v(Qo.$$.fragment),Um=h(),v(Ko.$$.fragment),Hm=h(),v(Vo.$$.fragment),Jd=h(),to=r("h2"),Go=r("a"),tl=r("span"),v(Ds.$$.fragment),Qm=h(),ol=r("span"),Km=n("MobileBertForNextSentencePrediction"),Zd=h(),He=r("div"),v(Ls.$$.fragment),Vm=h(),Ws=r("p"),Gm=n("MobileBert Model with a "),nl=r("code"),Ym=n("next sentence prediction (classification)"),Jm=n(" head on top."),Zm=h(),Rs=r("p"),Xm=n("This model inherits from "),Da=r("a"),eu=n("PreTrainedModel"),tu=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou=h(),Us=r("p"),nu=n("This model is also a PyTorch "),Hs=r("a"),su=n("torch.nn.Module"),ru=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),au=h(),dt=r("div"),v(Qs.$$.fragment),iu=h(),oo=r("p"),lu=n("The "),La=r("a"),du=n("MobileBertForNextSentencePrediction"),cu=n(" forward method, overrides the "),sl=r("code"),pu=n("__call__"),hu=n(" special method."),mu=h(),v(Yo.$$.fragment),uu=h(),v(Jo.$$.fragment),Xd=h(),no=r("h2"),Zo=r("a"),rl=r("span"),v(Ks.$$.fragment),fu=h(),al=r("span"),gu=n("MobileBertForSequenceClassification"),ec=h(),Qe=r("div"),v(Vs.$$.fragment),_u=h(),il=r("p"),bu=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bu=h(),Ce=r("div"),v(Zs.$$.fragment),Eu=h(),so=r("p"),xu=n("The "),Ra=r("a"),zu=n("MobileBertForSequenceClassification"),Pu=n(" forward method, overrides the "),ll=r("code"),qu=n("__call__"),Cu=n(" special method."),ju=h(),v(Xo.$$.fragment),Nu=h(),v(en.$$.fragment),Ou=h(),v(tn.$$.fragment),Su=h(),v(on.$$.fragment),Au=h(),v(nn.$$.fragment),tc=h(),ro=r("h2"),sn=r("a"),dl=r("span"),v(Xs.$$.fragment),Iu=h(),cl=r("span"),Du=n("MobileBertForMultipleChoice"),oc=h(),Ke=r("div"),v(er.$$.fragment),Lu=h(),pl=r("p"),Wu=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tf=h(),Je=r("div"),v(cr.$$.fragment),kf=h(),lo=r("p"),vf=n("The "),Ka=r("a"),yf=n("MobileBertForTokenClassification"),wf=n(" forward method, overrides the "),gl=r("code"),Mf=n("__call__"),$f=n(" special method."),Ff=h(),v(dn.$$.fragment),Bf=h(),v(cn.$$.fragment),Ef=h(),v(pn.$$.fragment),rc=h(),co=r("h2"),hn=r("a"),_l=r("span"),v(pr.$$.fragment),xf=h(),bl=r("span"),zf=n("MobileBertForQuestionAnswering"),ac=h(),Ge=r("div"),v(hr.$$.fragment),Pf=h(),po=r("p"),qf=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=r("code"),Cf=n("span start logits"),jf=n(" and "),kl=r("code"),Nf=n("span end logits"),Of=n(")."),Sf=h(),mr=r("p"),Af=n("This model inherits from "),Va=r("a"),If=n("PreTrainedModel"),Df=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lf=h(),ur=r("p"),Wf=n("This model is also a PyTorch "),fr=r("a"),Rf=n("torch.nn.Module"),Uf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ig=h(),v(vn.$$.fragment),Dg=h(),ht=r("div"),v(Er.$$.fragment),Lg=h(),_o=r("p"),Wg=n("The "),Xa=r("a"),Rg=n("TFMobileBertForPreTraining"),Ug=n(" forward method, overrides the "),zl=r("code"),Hg=n("__call__"),Qg=n(" special method."),Kg=h(),v(yn.$$.fragment),Vg=h(),v(wn.$$.fragment),pc=h(),bo=r("h2"),Mn=r("a"),Pl=r("span"),v(xr.$$.fragment),Gg=h(),ql=r("span"),Yg=n("TFMobileBertForMaskedLM"),hc=h(),Se=r("div"),v(zr.$$.fragment),Jg=h(),Pr=r("p"),Zg=n("MobileBert Model with a "),Cl=r("code"),Xg=n("language modeling"),e_=n(" head on top."),t_=h(),qr=r("p"),o_=n("This model inherits from "),ei=r("a"),n_=n("TFPreTrainedModel"),s_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),z_=h(),Dr=r("p"),P_=n("This model is also a "),Lr=r("a"),q_=n("tf.keras.Model"),C_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=h(),v(zn.$$.fragment),N_=h(),mt=r("div"),v(Wr.$$.fragment),O_=h(),vo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),D_=n("__call__"),L_=n(" special method."),W_=h(),v(Pn.$$.fragment),R_=h(),v(qn.$$.fragment),fc=h(),yo=r("h2"),Cn=r("a"),Il=r("span"),v(Rr.$$.fragment),U_=h(),Dl=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=h(),Ie=r("div"),v(Ur.$$.fragment),Q_=h(),Ll=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$b=h(),v(In.$$.fragment),Fb=h(),ut=r("div"),v(ea.$$.fragment),Bb=h(),$o=r("p"),Eb=n("The "),ii=r("a"),xb=n("TFMobileBertForMultipleChoice"),zb=n(" forward method, overrides the "),Ql=r("code"),Pb=n("__call__"),qb=n(" special method."),Cb=h(),v(Dn.$$.fragment),jb=h(),v(Ln.$$.fragment),Tc=h(),Fo=r("h2"),Wn=r("a"),Kl=r("span"),v(ta.$$.fragment),Nb=h(),Vl=r("span"),Ob=n("TFMobileBertForTokenClassification"),kc=h(),Le=r("div"),v(oa.$$.fragment),Sb=h(),Gl=r("p"),Ab=n(`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ib=h(),na=r("p"),Db=n("This model inherits from "),li=r("a"),Lb=n("TFPreTrainedModel"),Wb=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained
with a causal language modeling (CLM) objective are better in that regard.`),ud.forEach(t),ga.forEach(t),pe=m(o),A=a(o,"P",{});var Po=i(A);be=s(Po,"This model was contributed by "),f=a(Po,"A",{href:!0,rel:!0});var fd=i(f);B=s(fd,"vshampor"),fd.forEach(t),Y=s(Po,". The original code can be found "),ve=a(Po,"A",{href:!0,rel:!0});var gd=i(ve);$e=s(gd,"here"),gd.forEach(t),S=s(Po,"."),Po.forEach(t),we=m(o),Te=a(o,"H2",{class:!0});var _a=i(Te);ke=a(_a,"A",{id:!0,class:!0,href:!0});var _d=i(ke);j=a(_d,"SPAN",{});var bd=i(j);y(I.$$.fragment,bd),bd.forEach(t),_d.forEach(t),Fe=m(_a),ye=a(_a,"SPAN",{});var Td=i(ye);Q=s(Td,"MobileBertConfig"),Td.forEach(t),_a.forEach(t),Me=m(o),te=a(o,"DIV",{class:!0});var at=i(te);y(oe.$$.fragment,at),Be=m(at),Mt=a(at,"P",{});var $t=i(Mt);Ep=s($t,"This is the configuration class to store the configuration of a "),ya=a($t,"A",{href:!0});var kd=i(ya);xp=s(kd,"MobileBertModel"),kd.forEach(t),zp=s($t," or a "),wa=a($t,"A",{href:!0});var vd=i(wa);Pp=s(vd,"TFMobileBertModel"),vd.forEach(t),qp=s($t,`. It
is used to instantiate a MobileBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the MobileBERT
...
documentation from `),$a=a(qo,"A",{href:!0});var Md=i($a);Ip=s(Md,"PretrainedConfig"),Md.forEach(t),Dp=s(qo," for more information."),qo.forEach(t),Lp=m(at),y(Co.$$.fragment,at),Wp=m(at),qi=a(at,"P",{});var $d=i(qi);Rp=s($d,`Attributes: pretrained_config_archive_map (Dict[str, str]): A dictionary containing all the available pre-trained
...
and wordpiece.`),Zn.forEach(t),Xp=m(Ft),cs=a(Ft,"P",{});var Ta=i(cs);eh=s(Ta,"Refer to superclass "),Ea=a(Ta,"A",{href:!0});var qd=i(Ea);th=s(qd,"BertTokenizer"),qd.forEach(t),oh=s(Ta," for usage examples and documentation concerning parameters."),Ta.forEach(t),Ft.forEach(t),Dd=m(o),Ut=a(o,"H2",{class:!0});var ka=i(Ut);Oo=a(ka,"A",{id:!0,class:!0,href:!0});var Cd=i(Oo);Oi=a(Cd,"SPAN",{});var jd=i(Oi);y(ps.$$.fragment,jd),jd.forEach(t),Cd.forEach(t),nh=m(ka),Si=a(ka,"SPAN",{});var Nd=i(Si);sh=s(Nd,"MobileBertTokenizerFast"),Nd.forEach(t),ka.forEach(t),Ld=m(o),rt=a(o,"DIV",{class:!0});var Bt=i(rt);y(hs.$$.fragment,Bt),rh=m(Bt),ms=a(Bt,"P",{});var va=i(ms);ah=s(va,"Construct a \u201Cfast\u201D MobileBERT tokenizer (backed by HuggingFace\u2019s "),Ai=a(va,"EM",{});var Od=i(Ai);ih=s(Od,"tokenizers"),Od.forEach(t),lh=s(va," library)."),va.forEach(t),dh=m(Bt),So=a(Bt,"P",{});var Sd=i(So);xa=a(Sd,"A",{href:!0});var PT=i(xa);ch=s(PT,"MobileBertTokenizerFast"),PT.forEach(t),ph=s(Sd," is identical to "),za=a(Sd,"A",{href:!0});var qT=i(za);hh=s(qT,"BertTokenizerFast"),qT.forEach(t),mh=s(Sd,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),Sd.forEach(t),uh=m(Bt),us=a(Bt,"P",{});var Mc=i(us);fh=s(Mc,"Refer to superclass "),Pa=a(Mc,"A",{href:!0});var CT=i(Pa);gh=s(CT,"BertTokenizerFast"),CT.forEach(t),_h=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=m(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var jT=i(Ao);Ii=a(jT,"SPAN",{});var NT=i(Ii);y(fs.$$.fragment,NT),NT.forEach(t),jT.forEach(t),bh=m($c),Di=a($c,"SPAN",{});var OT=i(Di);Th=s(OT,"MobileBert specific outputs"),OT.forEach(t),$c.forEach(t),Rd=m(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);y(gs.$$.fragment,Fc),kh=m(Fc),_s=a(Fc,"P",{});var Bc=i(_s);vh=s(Bc,"Output type of "),qa=a(Bc,"A",{href:!0});var ST=i(qa);yh=s(ST,"MobileBertForPreTraining"),ST.forEach(t),wh=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=m(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);y(bs.$$.fragment,Ec),Mh=m(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$h=s(xc,"Output type of "),Ca=a(xc,"A",{href:!0});var AT=i(Ca);Fh=s(AT,"TFMobileBertForPreTraining"),AT.forEach(t),Bh=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=m(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var IT=i(Io);Li=a(IT,"SPAN",{});var DT=i(Li);y(ks.$$.fragment,DT),DT.forEach(t),IT.forEach(t),Eh=m(zc),Wi=a(zc,"SPAN",{});var LT=i(Wi);xh=s(LT,"MobileBertModel"),LT.forEach(t),zc.forEach(t),Qd=m(o),je=a(o,"DIV",{class:!0});var ft=i(je);y(vs.$$.fragment,ft),zh=m(ft),Ri=a(ft,"P",{});var WT=i(Ri);Ph=s(WT,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),WT.forEach(t),qh=m(ft),ys=a(ft,"P",{});var Pc=i(ys);Ch=s(Pc,"This model inherits from "),ja=a(Pc,"A",{href:!0});var RT=i(ja);jh=s(RT,"PreTrainedModel"),RT.forEach(t),Nh=s(Pc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc.forEach(t),Oh=m(ft),ws=a(ft,"P",{});var qc=i(ws);Sh=s(qc,"This model is also a PyTorch "),Ms=a(qc,"A",{href:!0,rel:!0});var UT=i(Ms);Ah=s(UT,"torch.nn.Module"),UT.forEach(t),Ih=s(qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qc.forEach(t),Dh=m(ft),Ui=a(ft,"P",{});var HT=i(Ui);$s=a(HT,"A",{href:!0,rel:!0});var QT=i($s);Lh=s(QT,"https://arxiv.org/pdf/2004.02984.pdf"),QT.forEach(t),HT.forEach(t),Wh=m(ft),it=a(ft,"DIV",{class:!0});var Xn=i(it);y(Fs.$$.fragment,Xn),Rh=m(Xn),Gt=a(Xn,"P",{});var hi=i(Gt);Uh=s(hi,"The "),Na=a(hi,"A",{href:!0});var KT=i(Na);Hh=s(KT,"MobileBertModel"),KT.forEach(t),Qh=s(hi," forward method, overrides the "),Hi=a(hi,"CODE",{});var VT=i(Hi);Kh=s(VT,"__call__"),VT.forEach(t),Vh=s(hi," special method."),hi.forEach(t),Gh=m(Xn),y(Do.$$.fragment,Xn),Yh=m(Xn),y(Lo.$$.fragment,Xn),Xn.forEach(t),ft.forEach(t),Kd=m(o),Yt=a(o,"H2",{class:!0});var Cc=i(Yt);Wo=a(Cc,"A",{id:!0,class:!0,href:!0});var GT=i(Wo);Qi=a(GT,"SPAN",{});var YT=i(Qi);y(Bs.$$.fragment,YT),YT.forEach(t),GT.forEach(t),Jh=m(Cc),Ki=a(Cc,"SPAN",{});var JT=i(Ki);Zh=s(JT,"MobileBertForPreTraining"),JT.forEach(t),Cc.forEach(t),Vd=m(o),Re=a(o,"DIV",{class:!0});var Et=i(Re);y(Es.$$.fragment,Et),Xh=m(Et),Jt=a(Et,"P",{});var mi=i(Jt);em=s(mi,"MobileBert Model with two heads on top as done during the pretraining: a "),Vi=a(mi,"CODE",{});var ZT=i(Vi);tm=s(ZT,"masked language modeling"),ZT.forEach(t),om=s(mi,` head and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jc.forEach(t),dm=m(Et),zs=a(Et,"P",{});var Nc=i(zs);cm=s(Nc,"This model is also a PyTorch "),Ps=a(Nc,"A",{href:!0,rel:!0});var tk=i(Ps);pm=s(tk,"torch.nn.Module"),tk.forEach(t),hm=s(Nc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nc.forEach(t),mm=m(Et),lt=a(Et,"DIV",{class:!0});var es=i(lt);y(qs.$$.fragment,es),um=m(es),Zt=a(es,"P",{});var ui=i(Zt);fm=s(ui,"The "),Sa=a(ui,"A",{href:!0});var ok=i(Sa);gm=s(ok,"MobileBertForPreTraining"),ok.forEach(t),_m=s(ui," forward method, overrides the "),Yi=a(ui,"CODE",{});var nk=i(Yi);bm=s(nk,"__call__"),nk.forEach(t),Tm=s(ui," special method."),ui.forEach(t),km=m(es),y(Ro.$$.fragment,es),vm=m(es),y(Uo.$$.fragment,es),es.forEach(t),Et.forEach(t),Gd=m(o),Xt=a(o,"H2",{class:!0});var Oc=i(Xt);Ho=a(Oc,"A",{id:!0,class:!0,href:!0});var sk=i(Ho);Ji=a(sk,"SPAN",{});var rk=i(Ji);y(Cs.$$.fragment,rk),rk.forEach(t),sk.forEach(t),ym=m(Oc),Zi=a(Oc,"SPAN",{});var ak=i(Zi);wm=s(ak,"MobileBertForMaskedLM"),ak.forEach(t),Oc.forEach(t),Yd=m(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);y(js.$$.fragment,xt),Mm=m(xt),Ns=a(xt,"P",{});var Sc=i(Ns);$m=s(Sc,"MobileBert Model with a "),Xi=a(Sc,"CODE",{});var ik=i(Xi);Fm=s(ik,"language modeling"),ik.forEach(t),Bm=s(Sc," head on top."),Sc.forEach(t),Em=m(xt),Os=a(xt,"P",{});var Ac=i(Os);xm=s(Ac,"This model inherits from "),Aa=a(Ac,"A",{href:!0});var lk=i(Aa);zm=s(lk,"PreTrainedModel"),lk.forEach(t),Pm=s(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),qm=m(xt),Ss=a(xt,"P",{});var Ic=i(Ss);Cm=s(Ic,"This model is also a PyTorch "),As=a(Ic,"A",{href:!0,rel:!0});var dk=i(As);jm=s(dk,"torch.nn.Module"),dk.forEach(t),Nm=s(Ic,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Om=m(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sm=m(zt),eo=a(zt,"P",{});var fi=i(eo);Am=s(fi,"The "),Ia=a(fi,"A",{href:!0});var ck=i(Ia);Im=s(ck,"MobileBertForMaskedLM"),ck.forEach(t),Dm=s(fi," forward method, overrides the "),el=a(fi,"CODE",{});var pk=i(el);Lm=s(pk,"__call__"),pk.forEach(t),Wm=s(fi," special method."),fi.forEach(t),Rm=m(zt),y(Qo.$$.fragment,zt),Um=m(zt),y(Ko.$$.fragment,zt),Hm=m(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=m(o),to=a(o,"H2",{class:!0});var Dc=i(to);Go=a(Dc,"A",{id:!0,class:!0,href:!0});var hk=i(Go);tl=a(hk,"SPAN",{});var mk=i(tl);y(Ds.$$.fragment,mk),mk.forEach(t),hk.forEach(t),Qm=m(Dc),ol=a(Dc,"SPAN",{});var uk=i(ol);Km=s(uk,"MobileBertForNextSentencePrediction"),uk.forEach(t),Dc.forEach(t),Zd=m(o),He=a(o,"DIV",{class:!0});var Pt=i(He);y(Ls.$$.fragment,Pt),Vm=m(Pt),Ws=a(Pt,"P",{});var Lc=i(Ws);Gm=s(Lc,"MobileBert Model with a "),nl=a(Lc,"CODE",{});var fk=i(nl);Ym=s(fk,"next sentence prediction (classification)"),fk.forEach(t),Jm=s(Lc," head on top."),Lc.forEach(t),Zm=m(Pt),Rs=a(Pt,"P",{});var Wc=i(Rs);Xm=s(Wc,"This model inherits from "),Da=a(Wc,"A",{href:!0});var gk=i(Da);eu=s(gk,"PreTrainedModel"),gk.forEach(t),tu=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wc.forEach(t),ou=m(Pt),Us=a(Pt,"P",{});var Rc=i(Us);nu=s(Rc,"This model is also a PyTorch "),Hs=a(Rc,"A",{href:!0,rel:!0});var _k=i(Hs);su=s(_k,"torch.nn.Module"),_k.forEach(t),ru=s(Rc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(t),au=m(Pt),dt=a(Pt,"DIV",{class:!0});var ts=i(dt);y(Qs.$$.fragment,ts),iu=m(ts),oo=a(ts,"P",{});var gi=i(oo);lu=s(gi,"The "),La=a(gi,"A",{href:!0});var bk=i(La);du=s(bk,"MobileBertForNextSentencePrediction"),bk.forEach(t),cu=s(gi," forward method, overrides the "),sl=a(gi,"CODE",{});var Tk=i(sl);pu=s(Tk,"__call__"),Tk.forEach(t),hu=s(gi," special method."),gi.forEach(t),mu=m(ts),y(Yo.$$.fragment,ts),uu=m(ts),y(Jo.$$.fragment,ts),ts.forEach(t),Pt.forEach(t),Xd=m(o),no=a(o,"H2",{class:!0});var Uc=i(no);Zo=a(Uc,"A",{id:!0,class:!0,href:!0});var kk=i(Zo);rl=a(kk,"SPAN",{});var vk=i(rl);y(Ks.$$.fragment,vk),vk.forEach(t),kk.forEach(t),fu=m(Uc),al=a(Uc,"SPAN",{});var yk=i(al);gu=s(yk,"MobileBertForSequenceClassification"),yk.forEach(t),Uc.forEach(t),ec=m(o),Qe=a(o,"DIV",{class:!0});var qt=i(Qe);y(Vs.$$.fragment,qt),_u=m(qt),il=a(qt,"P",{});var wk=i(il);bu=s(wk,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wk.forEach(t),Tu=m(qt),Gs=a(qt,"P",{});var Hc=i(Gs);ku=s(Hc,"This model inherits from "),Wa=a(Hc,"A",{href:!0});var Mk=i(Wa);vu=s(Mk,"PreTrainedModel"),Mk.forEach(t),yu=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hc.forEach(t),wu=m(qt),Ys=a(qt,"P",{});var Qc=i(Ys);Mu=s(Qc,"This model is also a PyTorch "),Js=a(Qc,"A",{href:!0,rel:!0});var $k=i(Js);$u=s($k,"torch.nn.Module"),$k.forEach(t),Fu=s(Qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=m(qt),Ce=a(qt,"DIV",{class:!0});var nt=i(Ce);y(Zs.$$.fragment,nt),Eu=m(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var Fk=i(Ra);zu=s(Fk,"MobileBertForSequenceClassification"),Fk.forEach(t),Pu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var Bk=i(ll);qu=s(Bk,"__call__"),Bk.forEach(t),Cu=s(_i," special method."),_i.forEach(t),ju=m(nt),y(Xo.$$.fragment,nt),Nu=m(nt),y(en.$$.fragment,nt),Ou=m(nt),y(tn.$$.fragment,nt),Su=m(nt),y(on.$$.fragment,nt),Au=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var Ek=i(sn);dl=a(Ek,"SPAN",{});var xk=i(dl);y(Xs.$$.fragment,xk),xk.forEach(t),Ek.forEach(t),Iu=m(Kc),cl=a(Kc,"SPAN",{});var zk=i(cl);Du=s(zk,"MobileBertForMultipleChoice"),zk.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var Ct=i(Ke);y(er.$$.fragment,Ct),Lu=m(Ct),pl=a(Ct,"P",{});var Pk=i(pl);Wu=s(Pk,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Pk.forEach(t),Ru=m(Ct),tr=a(Ct,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qk=i(Ua);Hu=s(qk,"PreTrainedModel"),qk.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
for Named-Entity-Recognition (NER) tasks.`),Ik.forEach(t),pf=m(jt),ir=a(jt,"P",{});var Jc=i(ir);hf=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var Dk=i(Qa);mf=s(Dk,"PreTrainedModel"),Dk.forEach(t),uf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),ff=m(jt),lr=a(jt,"P",{});var Zc=i(lr);gf=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var Lk=i(dr);_f=s(Lk,"torch.nn.Module"),Lk.forEach(t),bf=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tf=m(jt),Je=a(jt,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),kf=m(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vf=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var Wk=i(Ka);yf=s(Wk,"MobileBertForTokenClassification"),Wk.forEach(t),wf=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var Rk=i(gl);Mf=s(Rk,"__call__"),Rk.forEach(t),$f=s(Ti," special method."),Ti.forEach(t),Ff=m(Nt),y(dn.$$.fragment,Nt),Bf=m(Nt),y(cn.$$.fragment,Nt),Ef=m(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),jt.forEach(t),rc=m(o),co=a(o,"H2",{class:!0});var Xc=i(co);hn=a(Xc,"A",{id:!0,class:!0,href:!0});var Uk=i(hn);_l=a(Uk,"SPAN",{});var Hk=i(_l);y(pr.$$.fragment,Hk),Hk.forEach(t),Uk.forEach(t),xf=m(Xc),bl=a(Xc,"SPAN",{});var Qk=i(bl);zf=s(Qk,"MobileBertForQuestionAnswering"),Qk.forEach(t),Xc.forEach(t),ac=m(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(hr.$$.fragment,Ot),Pf=m(Ot),po=a(Ot,"P",{});var ki=i(po);qf=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var Kk=i(Tl);Cf=s(Kk,"span start logits"),Kk.forEach(t),jf=s(ki," and "),kl=a(ki,"CODE",{});var Vk=i(kl);Nf=s(Vk,"span end logits"),Vk.forEach(t),Of=s(ki,")."),ki.forEach(t),Sf=m(Ot),mr=a(Ot,"P",{});var ep=i(mr);Af=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var Gk=i(Va);If=s(Gk,"PreTrainedModel"),Gk.forEach(t),Df=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep.forEach(t),Lf=m(Ot),ur=a(Ot,"P",{});var tp=i(ur);Wf=s(tp,"This model is also a PyTorch "),fr=a(tp,"A",{href:!0,rel:!0});var Yk=i(fr);Rf=s(Yk,"torch.nn.Module"),Yk.forEach(t),Uf=s(tp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
`),xl=a(wi,"CODE",{});var pv=i(xl);xg=s(pv,"next sentence prediction (classification)"),pv.forEach(t),zg=s(wi," head."),wi.forEach(t),Pg=m(_t),$r=a(_t,"P",{});var ap=i($r);qg=s(ap,"This model inherits from "),Za=a(ap,"A",{href:!0});var hv=i(Za);Cg=s(hv,"TFPreTrainedModel"),hv.forEach(t),jg=s(ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip.forEach(t),Ig=m(_t),y(vn.$$.fragment,_t),Dg=m(_t),ht=a(_t,"DIV",{class:!0});var ss=i(ht);y(Er.$$.fragment,ss),Lg=m(ss),_o=a(ss,"P",{});var Mi=i(_o);Wg=s(Mi,"The "),Xa=a(Mi,"A",{href:!0});var uv=i(Xa);Rg=s(uv,"TFMobileBertForPreTraining"),uv.forEach(t),Ug=s(Mi," forward method, overrides the "),zl=a(Mi,"CODE",{});var fv=i(zl);Hg=s(fv,"__call__"),fv.forEach(t),Qg=s(Mi," special method."),Mi.forEach(t),Kg=m(ss),y(yn.$$.fragment,ss),Vg=m(ss),y(wn.$$.fragment,ss),ss.forEach(t),_t.forEach(t),pc=m(o),bo=a(o,"H2",{class:!0});var lp=i(bo);Mn=a(lp,"A",{id:!0,class:!0,href:!0});var gv=i(Mn);Pl=a(gv,"SPAN",{});var _v=i(Pl);y(xr.$$.fragment,_v),_v.forEach(t),gv.forEach(t),Gg=m(lp),ql=a(lp,"SPAN",{});var bv=i(ql);Yg=s(bv,"TFMobileBertForMaskedLM"),bv.forEach(t),lp.forEach(t),hc=m(o),Se=a(o,"DIV",{class:!0});var bt=i(Se);y(zr.$$.fragment,bt),Jg=m(bt),Pr=a(bt,"P",{});var dp=i(Pr);Zg=s(dp,"MobileBert Model with a "),Cl=a(dp,"CODE",{});var Tv=i(Cl);Xg=s(Tv,"language modeling"),Tv.forEach(t),e_=s(dp," head on top."),dp.forEach(t),t_=m(bt),qr=a(bt,"P",{});var cp=i(qr);o_=s(cp,"This model inherits from "),ei=a(cp,"A",{href:!0});var kv=i(ei);n_=s(kv,"TFPreTrainedModel"),kv.forEach(t),s_=s(cp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=m(Tt),Dr=a(Tt,"P",{});var fp=i(Dr);P_=s(fp,"This model is also a "),Lr=a(fp,"A",{href:!0,rel:!0});var xv=i(Lr);q_=s(xv,"tf.keras.Model"),xv.forEach(t),C_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),j_=m(Tt),y(zn.$$.fragment,Tt),N_=m(Tt),mt=a(Tt,"DIV",{class:!0});var rs=i(mt);y(Wr.$$.fragment,rs),O_=m(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zv=i(ni);A_=s(zv,"TFMobileBertForNextSentencePrediction"),zv.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Pv=i(Al);D_=s(Pv,"__call__"),Pv.forEach(t),L_=s(Fi," special method."),Fi.forEach(t),W_=m(rs),y(Pn.$$.fragment,rs),R_=m(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=m(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var qv=i(Cn);Il=a(qv,"SPAN",{});var Cv=i(Il);y(Rr.$$.fragment,Cv),Cv.forEach(t),qv.forEach(t),U_=m(gp),Dl=a(gp,"SPAN",{});var jv=i(Dl);H_=s(jv,"TFMobileBertForSequenceClassification"),jv.forEach(t),gp.forEach(t),gc=m(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=m(kt),Ll=a(kt,"P",{});var Nv=i(Ll);K_=s(Nv,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),$b=m(vt),y(In.$$.fragment,vt),Fb=m(vt),ut=a(vt,"DIV",{class:!0});var as=i(ut);y(ea.$$.fragment,as),Bb=m(as),$o=a(as,"P",{});var Ei=i($o);Eb=s(Ei,"The "),ii=a(Ei,"A",{href:!0});var Qv=i(ii);xb=s(Qv,"TFMobileBertForMultipleChoice"),Qv.forEach(t),zb=s(Ei," forward method, overrides the "),Ql=a(Ei,"CODE",{});var Kv=i(Ql);Pb=s(Kv,"__call__"),Kv.forEach(t),qb=s(Ei," special method."),Ei.forEach(t),Cb=m(as),y(Dn.$$.fragment,as),jb=m(as),y(Ln.$$.fragment,as),as.forEach(t),vt.forEach(t),Tc=m(o),Fo=a(o,"H2",{class:!0});var yp=i(Fo);Wn=a(yp,"A",{id:!0,class:!0,href:!0});var Vv=i(Wn);Kl=a(Vv,"SPAN",{});var Gv=i(Kl);y(ta.$$.fragment,Gv),Gv.forEach(t),Vv.forEach(t),Nb=m(yp),Vl=a(yp,"SPAN",{});var Yv=i(Vl);Ob=s(Yv,"TFMobileBertForTokenClassification"),Yv.forEach(t),yp.forEach(t),kc=m(o),Le=a(o,"DIV",{class:!0});var yt=i(Le);y(oa.$$.fragment,yt),Sb=m(yt),Gl=a(yt,"P",{});var Jv=i(Gl);Ab=s(Jv,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Jv.forEach(t),Ib=m(yt),na=a(yt,"P",{});var wp=i(na);Db=s(wp,"This model inherits from "),li=a(wp,"A",{href:!0});var Zv=i(li);Lb=s(Zv,"TFPreTrainedModel"),Zv.forEach(t),Wb=s(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mp.forEach(t),Kb=m(yt),y(Rn.$$.fragment,yt),Vb=m(yt),tt=a(yt,"DIV",{class:!0});var Dt=i(tt);y(aa.$$.fragment,Dt),Gb=m(Dt),Bo=a(Dt,"P",{});var xi=i(Bo);Yb=s(xi,"The "),di=a(xi,"A",{href:!0});var ey=i(di);Jb=s(ey,"TFMobileBertForTokenClassification"),ey.forEach(t),Zb=s(xi," forward method, overrides the "),Yl=a(xi,"CODE",{});var ty=i(Yl);Xb=s(ty,"__call__"),ty.forEach(t),eT=s(xi," special method."),xi.forEach(t),tT=m(Dt),y(Un.$$.fragment,Dt),oT=m(Dt),y(Hn.$$.fragment,Dt),nT=m(Dt),y(Qn.$$.fragment,Dt),Dt.forEach(t),yt.forEach(t),vc=m(o),Eo=a(o,"H2",{class:!0});var $p=i(Eo);Kn=a($p,"A",{id:!0,class:!0,href:!0});var oy=i(Kn);Jl=a(oy,"SPAN",{});var ny=i(Jl);y(ia.$$.fragment,ny),ny.forEach(t),oy.forEach(t),sT=m($p),Zl=a($p,"SPAN",{});var sy=i(Zl);rT=s(sy,"TFMobileBertForQuestionAnswering"),sy.forEach(t),$p.forEach(t),yc=m(o),We=a(o,"DIV",{class:!0});var wt=i(We);y(la.$$.fragment,wt),aT=m(wt),xo=a(wt,"P",{});var zi=i(xo);iT=s(zi,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
