...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(h,"CODE",{});var x=a(u);f=o(x,"Module"),x.forEach(n),R=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,u),e(u,f),e(p,R)},d(g){g&&n(p)}}}function vT($){let p,y,u,f,R,g,h,x,ti,Ia,$e,ot,Fr,St,oi,zr,ni,Oa,an,ri,Wa,nt,si,Dt,ai,di,Ha,dn,ii,Ba,cn,$r,ci,Qa,rt,li,Lt,pi,hi,Va,Ee,st,Er,It,ui,jr,mi,Ua,de,Ot,gi,me,ln,_i,fi,Mr,vi,bi,pn,Ti,wi,hn,ki,qi,yi,at,Wt,Ri,Ht,xi,un,Fi,zi,$i,dt,Bt,Ei,Qt,ji,mn,Mi,Gi,Ka,je,it,Gr,Vt,Ai,Ar,Pi,Ya,Me,Ut,Ni,ct,Kt,Ci,Pr,Si,Ja,Ge,lt,Nr,Yt,Di,Cr,Li,Xa,Ae,Jt,Ii,Sr,Oi,Za,Xt,Zt,ed,Pe,pt,Dr,eo,Wi,Lr,Hi,td,X,to,Bi,Ir,Qi,Vi,Or,Ui,Ki,oo,Yi,ht,no,Ji,Wr,Xi,Zi,ut,ro,ec,Ne,tc,Hr,oc,nc,Br,rc,sc,ac,mt,so,dc,ao,ic,Qr,cc,lc,od,Ce,gt,Vr,io,pc,Ur,hc,nd,D,co,uc,Se,mc,gn,gc,_c,Kr,fc,vc,bc,_t,Tc,Yr,wc,kc,ie,qc,Jr,yc,Rc,_n,xc,Fc,Xr,zc,$c,fn,Ec,jc,Mc,G,Gc,vn,Ac,Pc,Zr,Nc,Cc,es,Sc,Dc,ts,Lc,Ic,os,Oc,Wc,bn,Hc,Bc,ns,Qc,Vc,Tn,Uc,Kc,wn,Yc,Jc,rs,Xc,Zc,el,lo,tl,kn,ol,nl,rl,po,sl,ho,al,dl,il,ee,uo,cl,De,ll,qn,pl,hl,ss,ul,ml,gl,ft,_l,as,fl,vl,mo,rd,Le,vt,ds,go,bl,is,Tl,sd,E,_o,wl,Ie,kl,yn,ql,yl,cs,Rl,xl,Fl,bt,zl,ls,$l,El,ps,jl,Ml,ce,Gl,hs,Al,Pl,Rn,Nl,Cl,us,Sl,Dl,xn,Ll,Il,Ol,A,Wl,Fn,Hl,Bl,ms,Ql,Vl,gs,Ul,Kl,_s,Yl,Jl,fs,Xl,Zl,zn,ep,tp,vs,op,np,$n,rp,sp,En,ap,dp,bs,ip,cp,lp,fo,pp,jn,hp,up,mp,vo,gp,bo,_p,fp,vp,te,To,bp,Oe,Tp,Mn,wp,kp,Ts,qp,yp,Rp,Tt,xp,ws,Fp,zp,wo,$p,wt,ko,Ep,qo,jp,Gn,Mp,Gp,ad,We,kt,ks,yo,Ap,qs,Pp,dd,j,Ro,Np,He,Cp,An,Sp,Dp,ys,Lp,Ip,Op,qt,Wp,Rs,Hp,Bp,xs,Qp,Vp,le,Up,Fs,Kp,Yp,Pn,Jp,Xp,zs,Zp,eh,Nn,th,oh,nh,P,rh,Cn,sh,ah,$s,dh,ih,Es,ch,lh,js,ph,hh,Ms,uh,mh,Sn,gh,_h,Gs,fh,vh,Dn,bh,Th,Ln,wh,kh,As,qh,yh,Rh,xo,xh,In,Fh,zh,$h,Fo,Eh,zo,jh,Mh,Gh,oe,$o,Ah,Be,Ph,On,Nh,Ch,Ps,Sh,Dh,Lh,yt,Ih,Ns,Oh,Wh,Eo,Hh,Rt,jo,Bh,Cs,Qh,id,Qe,xt,Ss,Mo,Vh,Ds,Uh,cd,N,Go,Kh,Ve,Yh,Wn,Jh,Xh,Ls,Zh,eu,tu,Ft,ou,Is,nu,ru,pe,su,Os,au,du,Hn,iu,cu,Ws,lu,pu,Bn,hu,uu,mu,L,gu,Qn,_u,fu,Hs,vu,bu,Bs,Tu,wu,Qs,ku,qu,Vs,yu,Ru,Vn,xu,Fu,Us,zu,$u,Un,Eu,ju,Ks,Mu,Gu,Au,Ao,Pu,Kn,Nu,Cu,Su,Po,Du,No,Lu,Iu,Ou,Ys,Wu,Hu,ne,Co,Bu,Ue,Qu,Yn,Vu,Uu,Js,Ku,Yu,Ju,zt,Xu,Xs,Zu,em,So,ld,Ke,$t,Zs,Do,tm,ea,om,pd,F,Lo,nm,Ye,rm,Jn,sm,am,ta,dm,im,cm,Et,lm,oa,pm,hm,na,um,mm,he,gm,ra,_m,fm,Xn,vm,bm,sa,Tm,wm,Zn,km,qm,ym,I,Rm,er,xm,Fm,aa,zm,$m,da,Em,jm,ia,Mm,Gm,ca,Am,Pm,tr,Nm,Cm,la,Sm,Dm,or,Lm,Im,pa,Om,Wm,Hm,Io,Bm,nr,Qm,Vm,Um,Oo,Km,Wo,Ym,Jm,Xm,ha,Zm,eg,re,Ho,tg,Je,og,rr,ng,rg,ua,sg,ag,dg,jt,ig,ma,cg,lg,Bo,pg,Mt,Qo,hg,Vo,ug,sr,mg,gg,hd,Xe,Gt,ga,Uo,_g,_a,fg,ud,z,Ko,vg,Ze,bg,ar,Tg,wg,fa,kg,qg,yg,At,Rg,va,xg,Fg,ba,zg,$g,ue,Eg,Ta,jg,Mg,dr,Gg,Ag,wa,Pg,Ng,ir,Cg,Sg,Dg,O,Lg,cr,Ig,Og,ka,Wg,Hg,qa,Bg,Qg,ya,Vg,Ug,Ra,Kg,Yg,lr,Jg,Xg,xa,Zg,e_,pr,t_,o_,Fa,n_,r_,s_,Yo,a_,hr,d_,i_,c_,Jo,l_,Xo,p_,h_,u_,za,m_,g_,se,Zo,__,et,f_,ur,v_,b_,$a,T_,w_,k_,Pt,q_,Ea,y_,R_,en,x_,Nt,tn,F_,ja,z_,md;return g=new _e({}),St=new _e({}),It=new _e({}),Ot=new M({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"doc_sep"},{anchor:"transformers.RagConfig.n_docs",description:`<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to 5) &#x2014;
...
<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"retrieval_batch_size"},{anchor:"transformers.RagConfig.dataset",description:`<strong>dataset</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;wiki_dpr&quot;</code>) &#x2014;
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_16030/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),Bt=new M({props:{name:"to_dict",anchor:"transformers.RagConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/models/rag/configuration_rag.py#L183",returnDescription:`
...
one (default) from the datasets library with <code>config.index_name=&quot;wiki_dpr&quot;</code> for example.`,name:"config"},{anchor:"transformers.RagRetriever.question_encoder_tokenizer",description:`<strong>question_encoder_tokenizer</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
The tokenizer that was used to tokenize the question. It is used to decode the question and then use the
generator_tokenizer.`,name:"question_encoder_tokenizer"},{anchor:"transformers.RagRetriever.generator_tokenizer",description:`<strong>generator_tokenizer</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
...
<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.RagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
...
<p>A <a
  href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagConfig"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagSequenceForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_16030/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate)</code>
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],returnDescription:`
<p>The generated
...
`}}),yo=new _e({}),Ro=new M({props:{name:"class transformers.RagTokenForGeneration",anchor:"transformers.RagTokenForGeneration",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"question_encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"generator",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"retriever",val:": typing.Optional = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/models/rag/modeling_rag.py#L1135",parametersDescription:[{anchor:"transformers.RagTokenForGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_16030/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.TFRagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagSequenceForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_16030/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_16030/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
...
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),Ml=c(),ce=r("p"),Gl=t("The question encoder can be any "),hs=r("em"),Al=t("autoencoding"),Pl=t(" model, preferably "),Rn=r("a"),Nl=t("DPRQuestionEncoder"),Cl=t(`, and the generator can be
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gh=c(),oe=r("div"),v($o.$$.fragment),Ah=c(),Be=r("p"),Ph=t("The "),On=r("a"),Nh=t("RagTokenForGeneration"),Ch=t(" forward method, overrides the "),Ps=r("code"),Sh=t("__call__"),Dh=t(" special method."),Lh=c(),v(yt.$$.fragment),Ih=c(),Ns=r("p"),Oh=t("Example:"),Wh=c(),v(Eo.$$.fragment),Hh=c(),Rt=r("div"),v(jo.$$.fragment),Bh=c(),Cs=r("p"),Qh=t("Implements RAG token decoding."),id=c(),Qe=r("h2"),xt=r("a"),Ss=r("span"),v(Mo.$$.fragment),Vh=c(),Ds=r("span"),Uh=t("TFRagModel"),cd=c(),N=r("div"),v(Go.$$.fragment),Kh=c(),Ve=r("p"),Yh=t("The "),Wn=r("a"),Jh=t("TFRagModel"),Xh=t(" forward method, overrides the "),Ls=r("code"),Zh=t("__call__"),eu=t(" special method."),tu=c(),v(Ft.$$.fragment),ou=c(),Is=r("p"),nu=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
sequence-to-sequence models that need a slightly different processing for the labels.`),H_.forEach(n),qd.forEach(n),kd.forEach(n),Ja=l(d),Ge=s(d,"H2",{class:!0});var yd=a(Ge);lt=s(yd,"A",{id:!0,class:!0,href:!0});var B_=a(lt);Nr=s(B_,"SPAN",{});var Q_=a(Nr);b(Yt.$$.fragment,Q_),Q_.forEach(n),B_.forEach(n),Di=l(yd),Cr=s(yd,"SPAN",{});var V_=a(Cr);Li=o(V_,"Rag specific outputs"),V_.forEach(n),yd.forEach(n),Xa=l(d),Ae=s(d,"DIV",{class:!0});var Rd=a(Ae);b(Jt.$$.fragment,Rd),Ii=l(Rd),Sr=s(Rd,"P",{});var U_=a(Sr);Oi=o(U_,"Base class for retriever augmented marginalized models outputs."),U_.forEach(n),Rd.forEach(n),Za=l(d),Xt=s(d,"DIV",{class:!0});var K_=a(Xt);b(Zt.$$.fragment,K_),K_.forEach(n),ed=l(d),Pe=s(d,"H2",{class:!0});var xd=a(Pe);pt=s(xd,"A",{id:!0,class:!0,href:!0});var Y_=a(pt);Dr=s(Y_,"SPAN",{});var J_=a(Dr);b(eo.$$.fragment,J_),J_.forEach(n),Y_.forEach(n),Wi=l(xd),Lr=s(xd,"SPAN",{});var X_=a(Lr);Hi=o(X_,"RagRetriever"),X_.forEach(n),xd.forEach(n),td=l(d),X=s(d,"DIV",{class:!0});var ae=a(X);b(to.$$.fragment,ae),Bi=l(ae),Ir=s(ae,"P",{});var Z_=a(Ir);Qi=o(Z_,`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ld.forEach(n),$h=l(Q),Fo=s(Q,"P",{});var Id=a(Fo);Eh=o(Id,"This model is also a PyTorch "),zo=s(Id,"A",{href:!0,rel:!0});var xv=a(zo);jh=o(xv,"torch.nn.Module"),xv.forEach(n),Mh=o(Id,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Id.forEach(n),Gh=l(Q),oe=s(Q,"DIV",{class:!0});var ke=a(oe);b($o.$$.fragment,ke),Ah=l(ke),Be=s(ke,"P",{});var Tr=a(Be);Ph=o(Tr,"The "),On=s(Tr,"A",{href:!0});var Fv=a(On);Nh=o(Fv,"RagTokenForGeneration"),Fv.forEach(n),Ch=o(Tr," forward method, overrides the "),Ps=s(Tr,"CODE",{});var zv=a(Ps);Sh=o(zv,"__call__"),zv.forEach(n),Dh=o(Tr," special method."),Tr.forEach(n),Lh=l(ke),b(yt.$$.fragment,ke),Ih=l(ke),Ns=s(ke,"P",{});var $v=a(Ns);Oh=o($v,"Example:"),$v.forEach(n),Wh=l(ke),b(Eo.$$.fragment,ke),ke.forEach(n),Hh=l(Q),Rt=s(Q,"DIV",{class:!0});var Od=a(Rt);b(jo.$$.fragment,Od),Bh=l(Od),Cs=s(Od,"P",{});var Ev=a(Cs);Qh=o(Ev,"Implements RAG token decoding."),Ev.forEach(n),Od.forEach(n),Q.forEach(n),id=l(d),Qe=s(d,"H2",{class:!0});var Wd=a(Qe);xt=s(Wd,"A",{id:!0,class:!0,href:!0});var jv=a(xt);Ss=s(jv,"SPAN",{});var Mv=a(Ss);b(Mo.$$.fragment,Mv),Mv.forEach(n),jv.forEach(n),Vh=l(Wd),Ds=s(Wd,"SPAN",{});var Gv=a(Ds);Uh=o(Gv,"TFRagModel"),Gv.forEach(n),Wd.forEach(n),cd=l(d),N=s(d,"DIV",{class:!0});var U=a(N);b(Go.$$.fragment,U),Kh=l(U),Ve=s(U,"P",{});var wr=a(Ve);Yh=o(wr,"The "),Wn=s(wr,"A",{href:!0});var Av=a(Wn);Jh=o(Av,"TFRagModel"),Av.forEach(n),Xh=o(wr," forward method, overrides the "),Ls=s(wr,"CODE",{});var Pv=a(Ls);Zh=o(Pv,"__call__"),Pv.forEach(n),eu=o(wr," special method."),wr.forEach(n),tu=l(U),b(Ft.$$.fragment,U),ou=l(U),Is=s(U,"P",{});var Nv=a(Is);nu=o(Nv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
