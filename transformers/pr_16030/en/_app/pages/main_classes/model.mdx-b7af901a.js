import{S as i$,i as l$,s as d$,e as o,k as l,w as c,t as r,M as p$,c as s,d as t,m as d,a,x as m,h as i,b as p,F as e,g as v,y as u,q as g,o as h,B as _}from"../../chunks/vendor-6b77c823.js";import{T as Fp}from"../../chunks/Tip-39098574.js";import{D as f}from"../../chunks/Docstring-abef54e3.js";import{C as O}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as xt}from"../../chunks/IconCopyLink-7a11ce68.js";function c$(ee){let x,L;return{c(){x=o("p"),L=r("Passing `use_auth_token=True\u201C is required when you want to use a private model.")},l(T){x=s(T,"P",{});var $=a(x);L=i($,"Passing `use_auth_token=True\u201C is required when you want to use a private model."),$.forEach(t)},m(T,$){v(T,x,$),e(x,L)},d(T){T&&t(x)}}}function m$(ee){let x,L,T,$,te;return{c(){x=o("p"),L=r("Activate the special "),T=o("a"),$=r("\u201Coffline-mode\u201D"),te=r(` to
use this method in a firewalled environment.`),this.h()},l(A){x=s(A,"P",{});var I=a(x);L=i(I,"Activate the special "),T=s(I,"A",{href:!0,rel:!0});var Me=a(T);$=i(Me,"\u201Coffline-mode\u201D"),Me.forEach(t),te=i(I,` to
use this method in a firewalled environment.`),I.forEach(t),this.h()},h(){p(T,"href","https://huggingface.co/transformers/installation.html#offline-mode"),p(T,"rel","nofollow")},m(A,I){v(A,x,I),e(x,L),e(x,T),e(T,$),e(x,te)},d(A){A&&t(x)}}}function u$(ee){let x,L;return{c(){x=o("p"),L=r("This API is experimental and may have some slight breaking changes in the next releases.")},l(T){x=s(T,"P",{});var $=a(x);L=i($,"This API is experimental and may have some slight breaking changes in the next releases."),$.forEach(t)},m(T,$){v(T,x,$),e(x,L)},d(T){T&&t(x)}}}function g$(ee){let x,L,T,$,te;return{c(){x=o("p"),L=r("Passing "),T=o("code"),$=r("use_auth_token=True"),te=r(" is required when you want to use a private model.")},l(A){x=s(A,"P",{});var I=a(x);L=i(I,"Passing "),T=s(I,"CODE",{});var Me=a(T);$=i(Me,"use_auth_token=True"),Me.forEach(t),te=i(I," is required when you want to use a private model."),I.forEach(t)},m(A,I){v(A,x,I),e(x,L),e(x,T),e(T,$),e(x,te)},d(A){A&&t(x)}}}function h$(ee){let x,L;return{c(){x=o("p"),L=r("This API is experimental and may have some slight breaking changes in the next releases.")},l(T){x=s(T,"P",{});var $=a(x);L=i($,"This API is experimental and may have some slight breaking changes in the next releases."),$.forEach(t)},m(T,$){v(T,x,$),e(x,L)},d(T){T&&t(x)}}}function _$(ee){let x,L,T,$,te,A,I,Me,Am,Op,ie,Gm,Aa,Sm,Nm,Ga,Cm,Im,Sa,Bm,Wm,Dp,nt,Na,Um,Hm,Ca,Vm,Xm,zp,wt,Ir,Rm,Ym,Br,Km,Ap,B,Zm,Ia,Jm,Qm,Wr,eu,tu,Ba,nu,ou,Wa,su,au,Ua,ru,iu,Gp,ot,Tt,Ur,Hn,lu,Hr,du,Sp,w,Vn,pu,Vr,cu,mu,Ha,Va,uu,gu,hu,Xn,Xr,_u,fu,Rr,bu,vu,Yr,yu,ku,ne,Kr,Ae,Zr,xu,wu,Xa,Tu,ju,Ra,$u,Mu,Pu,Rn,Ge,Jr,Lu,Eu,Qr,qu,Fu,ei,Ou,Du,zu,st,jt,ti,Au,Gu,Ya,Su,Nu,Cu,$t,ni,Iu,Bu,oi,Wu,Uu,Hu,Mt,si,Vu,Xu,ai,Ru,Yu,Ku,ri,Pt,ii,Zu,Ju,li,Qu,eg,tg,di,Lt,pi,ng,og,ci,sg,ag,rg,mi,V,ui,ig,lg,gi,dg,pg,hi,cg,mg,_i,ug,gg,fi,hg,_g,fg,le,Yn,bg,Kn,vg,bi,yg,kg,xg,vi,wg,Tg,Zn,jg,D,Jn,$g,yi,Mg,Pg,at,Lg,ki,Eg,qg,xi,Fg,Og,Dg,Qn,zg,wi,Ag,Gg,Sg,eo,Ng,Ti,Cg,Ig,Bg,Et,Wg,qt,Ug,ji,Hg,Vg,to,Xg,Ft,no,Rg,$i,Yg,Kg,Ot,oo,Zg,Mi,Jg,Qg,Se,so,eh,Pi,th,nh,Li,oh,sh,Ne,ao,ah,Ei,rh,ih,qi,lh,dh,Dt,ro,ph,Fi,ch,mh,zt,io,uh,Oi,gh,hh,At,lo,_h,Di,fh,bh,Ce,po,vh,zi,yh,kh,Gt,xh,Ie,co,wh,mo,Th,Ai,jh,$h,Mh,uo,Ph,Gi,Lh,Eh,qh,St,go,Fh,ho,Oh,Si,Dh,zh,Ah,Nt,_o,Gh,Ni,Sh,Nh,Be,fo,Ch,Ci,Ih,Bh,bo,Wh,Ii,Uh,Hh,Np,Ka,Cp,rt,Ct,Bi,vo,Vh,Wi,Xh,Ip,de,Rh,Ui,Yh,Kh,Hi,Zh,Jh,Vi,Qh,e_,Bp,yo,Wp,We,t_,Xi,n_,o_,Ri,s_,a_,Up,ko,Hp,It,r_,Yi,i_,l_,Vp,xo,Xp,Za,d_,Rp,it,Bt,Ki,wo,p_,Zi,c_,Yp,E,To,m_,jo,u_,Ji,g_,h_,__,Ue,$o,f_,Qi,b_,v_,lt,y_,el,k_,x_,tl,w_,T_,j_,Wt,Mo,$_,nl,M_,P_,Ut,Po,L_,dt,E_,ol,q_,F_,Lo,O_,D_,z_,Ht,Eo,A_,sl,G_,S_,Vt,qo,N_,al,C_,I_,Xt,Fo,B_,rl,W_,U_,Rt,Oo,H_,il,V_,X_,Yt,Do,R_,pt,Y_,ll,K_,Z_,Ja,J_,Q_,Kp,ct,Kt,dl,zo,ef,pl,tf,Zp,y,Ao,nf,cl,of,sf,Qa,er,af,rf,lf,Go,ml,df,pf,ul,cf,mf,gl,uf,gf,mt,He,hl,hf,_f,tr,ff,bf,nr,vf,yf,kf,Zt,_l,xf,wf,fl,Tf,jf,$f,X,bl,Mf,Pf,vl,Lf,Ef,yl,qf,Ff,kl,Of,Df,xl,zf,Af,Gf,pe,So,Sf,No,Nf,wl,Cf,If,Bf,Tl,Wf,Uf,Co,Hf,Jt,Io,Vf,jl,Xf,Rf,S,Bo,Yf,$l,Kf,Zf,Wo,Jf,Ml,Qf,eb,tb,Uo,nb,Pl,ob,sb,ab,Qt,rb,Ll,ib,lb,Ho,db,en,Vo,pb,El,cb,mb,tn,Xo,ub,ql,gb,hb,nn,Ro,_b,Fl,fb,bb,on,Yo,vb,Ol,yb,kb,sn,Ko,xb,Dl,wb,Tb,an,Zo,jb,zl,$b,Mb,rn,Jo,Pb,Al,Lb,Eb,ln,Qo,qb,Gl,Fb,Ob,Ve,es,Db,ts,zb,Sl,Ab,Gb,Sb,ns,Nb,Nl,Cb,Ib,Bb,dn,os,Wb,ss,Ub,or,Hb,Vb,Xb,pn,as,Rb,Cl,Yb,Kb,cn,rs,Zb,Il,Jb,Qb,mn,is,ev,Bl,tv,nv,un,ls,ov,Wl,sv,av,gn,ds,rv,Ul,iv,lv,hn,ps,dv,Hl,pv,cv,ce,cs,mv,oe,uv,Vl,gv,hv,Xl,_v,fv,Rl,bv,vv,Yl,yv,kv,xv,ut,wv,Kl,Tv,jv,Zl,$v,Mv,Pv,gt,Lv,Jl,Ev,qv,Ql,Fv,Ov,Jp,ht,_n,ed,ms,Dv,td,zv,Qp,Pe,us,Av,gs,Gv,nd,Sv,Nv,Cv,fn,hs,Iv,od,Bv,ec,_t,bn,sd,_s,Wv,ad,Uv,tc,M,fs,Hv,rd,Vv,Xv,sr,ar,Rv,Yv,Kv,id,Zv,Jv,ft,Xe,ld,Qv,ey,rr,ty,ny,ir,oy,sy,ay,vn,dd,ry,iy,pd,ly,dy,py,R,cd,cy,my,md,uy,gy,ud,hy,_y,gd,fy,by,hd,vy,yy,ky,me,bs,xy,vs,wy,_d,Ty,jy,$y,fd,My,Py,ys,Ly,W,ks,Ey,bd,qy,Fy,xs,Oy,vd,Dy,zy,Ay,ws,Gy,yd,Sy,Ny,Cy,kd,Iy,By,Ts,Wy,Re,js,Uy,xd,Hy,Vy,yn,Xy,kn,$s,Ry,Ms,Yy,wd,Ky,Zy,Jy,Y,Ps,Qy,se,e1,Td,t1,n1,jd,o1,s1,$d,a1,r1,Md,i1,l1,d1,Pd,p1,c1,Ld,m1,u1,Ls,g1,K,Es,h1,ae,_1,Ed,f1,b1,qd,v1,y1,Fd,k1,x1,Od,w1,T1,j1,Dd,$1,M1,zd,P1,L1,qs,E1,ue,Fs,q1,re,F1,Ad,O1,D1,Gd,z1,A1,Sd,G1,S1,Nd,N1,C1,I1,Cd,B1,W1,Os,nc,bt,xn,Id,Ds,U1,Bd,H1,oc,P,zs,V1,As,X1,lr,R1,Y1,K1,wn,Gs,Z1,Ss,J1,dr,Q1,ek,tk,ge,Ns,nk,Wd,ok,sk,Ud,ak,rk,Cs,ik,he,Is,lk,Hd,dk,pk,Vd,ck,mk,Bs,uk,Tn,Ws,gk,Xd,hk,_k,_e,Us,fk,Rd,bk,vk,Yd,yk,kk,Hs,xk,U,Vs,wk,Kd,Tk,jk,vt,$k,Zd,Mk,Pk,pr,Lk,Ek,qk,Xs,Fk,Rs,Ok,Dk,zk,Jd,Ak,Gk,Ys,Sk,fe,Ks,Nk,Qd,Ck,Ik,ep,Bk,Wk,Zs,Uk,be,Js,Hk,tp,Vk,Xk,np,Rk,Yk,Qs,Kk,jn,ea,Zk,ta,Jk,cr,Qk,e0,t0,ve,na,n0,op,o0,s0,sp,a0,r0,oa,sc,G,sa,i0,aa,l0,mr,d0,p0,c0,$n,ra,m0,ia,u0,ur,g0,h0,_0,N,la,f0,ap,b0,v0,da,y0,pa,k0,x0,w0,Le,T0,rp,j0,$0,ip,M0,P0,gr,L0,E0,q0,ca,F0,ma,O0,D0,z0,lp,A0,G0,ua,S0,ye,ga,N0,dp,C0,I0,pp,B0,W0,ha,U0,Mn,_a,H0,fa,V0,hr,X0,R0,Y0,ke,ba,K0,cp,Z0,J0,mp,Q0,ex,va,ac,Ee,ya,tx,ka,nx,_r,ox,sx,ax,H,xa,rx,up,ix,lx,yt,dx,gp,px,cx,fr,mx,ux,gx,wa,hx,Ta,_x,fx,bx,hp,vx,yx,ja,rc,kt,Pn,_p,$a,kx,fp,xx,ic,qe,Ma,wx,bp,Tx,jx,xe,Pa,$x,La,Mx,vp,Px,Lx,Ex,yp,qx,Fx,Ea,lc;return A=new xt({}),Hn=new xt({}),Vn=new f({props:{name:"class transformers.PreTrainedModel",anchor:"transformers.PreTrainedModel",parameters:[{name:"config",val:": PretrainedConfig"},{name:"*inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/modeling_utils.py#L423"}}),Yn=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/file_utils.py#L2842",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
</ul>`,name:"config"}]}}),Et=new Fp({props:{$$slots:{default:[c$]},$$scope:{ctx:ee}}}),qt=new Fp({props:{$$slots:{default:[m$]},$$scope:{ctx:ee}}}),to=new O({props:{code:`from transformers import BertConfig, BertModel
...
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/modeling_utils.py#L601",returnDescription:`
...
`,returnType:`
<p><code>int</code></p>
`}}),Eo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7f76b59341d0>"}],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16030/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
<a href="/docs/transformers/pr_16030/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
you want to cast, and should be <code>False</code> for those you want to skip.`,name:"mask"}]}}),Ls=new O({props:{code:`from transformers import FlaxBertModel
...
A derived instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_16030/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
`}}),ua=new O({props:{code:`tokenizer = AutoTokenizer.from_pretrained("distilgpt2")  # Initialize tokenizer
...
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16030/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
<p><code>TFSampleDecoderOnlyOutput</code> <code>TFSampleEncoderDecoderOutput</code>or <code>tf.Tensor</code>: A <code>tf.Tensor</code> containing the generated tokens (default behaviour) or a
...
`,returnType:`
<p><code>str</code></p>
`}}),Ea=new O({props:{code:`from transformers import {object_class}
...
<span class="hljs-comment"># Make a change to an existing repo that has been cloned locally in *my-finetuned-bert*.</span>
{<span class="hljs-built_in">object</span>}.push_to_hub(<span class="hljs-string">&quot;my-finetuned-bert&quot;</span>, repo_url=<span class="hljs-string">&quot;https://huggingface.co/sgugger/my-finetuned-bert&quot;</span>)`}}),{c(){x=o("meta"),L=l(),T=o("h1"),$=o("a"),te=o("span"),c(A.$$.fragment),I=l(),Me=o("span"),Am=r("Models"),Op=l(),ie=o("p"),Gm=r("The base classes "),Aa=o("a"),Sm=r("PreTrainedModel"),Nm=r(", "),Ga=o("a"),Cm=r("TFPreTrainedModel"),Im=r(`, and
...
for this model architecture.`),Pu=l(),Rn=o("li"),Ge=o("p"),Jr=o("strong"),Lu=r("load_tf_weights"),Eu=r(" ("),Qr=o("code"),qu=r("Callable"),Fu=r(") \u2014 A python "),ei=o("em"),Ou=r("method"),Du=r(` for loading a TensorFlow checkpoint in a PyTorch model,
taking as arguments:`),zu=l(),st=o("ul"),jt=o("li"),ti=o("strong"),Au=r("model"),Gu=r(" ("),Ya=o("a"),Su=r("PreTrainedModel"),Nu=r(") \u2014 An instance of the model on which to load the TensorFlow checkpoint."),Cu=l(),$t=o("li"),ni=o("strong"),Iu=r("config"),Bu=r(" ("),oi=o("code"),Wu=r("PreTrainedConfig"),Uu=r(") \u2014 An instance of the configuration associated to the model."),Hu=l(),Mt=o("li"),si=o("strong"),Vu=r("path"),Xu=r(" ("),ai=o("code"),Ru=r("str"),Yu=r(") \u2014 A path to the TensorFlow checkpoint."),Ku=l(),ri=o("li"),Pt=o("p"),ii=o("strong"),Zu=r("base_model_prefix"),Ju=r(" ("),li=o("code"),Qu=r("str"),eg=r(`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),tg=l(),di=o("li"),Lt=o("p"),pi=o("strong"),ng=r("is_parallelizable"),og=r(" ("),ci=o("code"),sg=r("bool"),ag=r(") \u2014 A flag indicating whether this model supports model parallelization."),rg=l(),mi=o("li"),V=o("p"),ui=o("strong"),ig=r("main_input_name"),lg=r(" ("),gi=o("code"),dg=r("str"),pg=r(") \u2014 The name of the principal input to the model (often "),hi=o("code"),cg=r("input_ids"),mg=r(` for NLP
...
`),bi=o("code"),yg=r("repo_path_or_name"),kg=r("."),xg=l(),vi=o("p"),wg=r("Examples:"),Tg=l(),c(Zn.$$.fragment),jg=l(),D=o("div"),c(Jn.$$.fragment),$g=l(),yi=o("p"),Mg=r("Instantiate a pretrained pytorch model from a pre-trained model configuration."),Pg=l(),at=o("p"),Lg=r("The model is set in evaluation mode by default using "),ki=o("code"),Eg=r("model.eval()"),qg=r(` (Dropout modules are deactivated). To train
...
weights are discarded.`),Bg=l(),c(Et.$$.fragment),Wg=l(),c(qt.$$.fragment),Ug=l(),ji=o("p"),Hg=r("Examples:"),Vg=l(),c(to.$$.fragment),Xg=l(),Ft=o("div"),c(no.$$.fragment),Rg=l(),$i=o("p"),Yg=r("Returns the model\u2019s input embeddings."),Kg=l(),Ot=o("div"),c(oo.$$.fragment),Zg=l(),Mi=o("p"),Jg=r("Returns the model\u2019s output embeddings."),Qg=l(),Se=o("div"),c(so.$$.fragment),eh=l(),Pi=o("p"),th=r("Deactivates gradient checkpointing for the current model."),nh=l(),Li=o("p"),oh=r(`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),sh=l(),Ne=o("div"),c(ao.$$.fragment),ah=l(),Ei=o("p"),rh=r("Activates gradient checkpointing for the current model."),ih=l(),qi=o("p"),lh=r(`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
...
library are already mapped with an auto class.`),kh=l(),c(Gt.$$.fragment),xh=l(),Ie=o("div"),c(co.$$.fragment),wh=l(),mo=o("p"),Th=r("Resizes input token embeddings matrix of the model if "),Ai=o("code"),jh=r("new_num_tokens != config.vocab_size"),$h=r("."),Mh=l(),uo=o("p"),Ph=r("Takes care of tying weights embeddings afterwards if the model class has a "),Gi=o("code"),Lh=r("tie_weights()"),Eh=r(" method."),qh=l(),St=o("div"),c(go.$$.fragment),Fh=l(),ho=o("p"),Oh=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=o("code"),Dh=r("[from_pretrained()](/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),zh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
classes of the same architecture adding modules on top of the base model.`),$f=l(),X=o("li"),bl=o("strong"),Mf=r("main_input_name"),Pf=r(" ("),vl=o("code"),Lf=r("str"),Ef=r(") \u2014 The name of the principal input to the model (often "),yl=o("code"),qf=r("input_ids"),Ff=r(` for NLP
...
weights are discarded.`),ab=l(),c(Qt.$$.fragment),rb=l(),Ll=o("p"),ib=r("Examples:"),lb=l(),c(Ho.$$.fragment),db=l(),en=o("div"),c(Vo.$$.fragment),pb=l(),El=o("p"),cb=r("Dict of bias attached to an LM head. The key represents the name of the bias attribute."),mb=l(),tn=o("div"),c(Xo.$$.fragment),ub=l(),ql=o("p"),gb=r("Returns the model\u2019s input embeddings layer."),hb=l(),nn=o("div"),c(Ro.$$.fragment),_b=l(),Fl=o("p"),fb=r("The LM Head layer. This method must be overwritten by all the models that have a lm head."),bb=l(),on=o("div"),c(Yo.$$.fragment),vb=l(),Ol=o("p"),yb=r("Returns the model\u2019s output embeddings"),kb=l(),sn=o("div"),c(Ko.$$.fragment),xb=l(),Dl=o("p"),wb=r(`Get the layer that handles a bias attribute in case the model has an LM head with weights tied to the
embeddings`),Tb=l(),an=o("div"),c(Zo.$$.fragment),jb=l(),zl=o("p"),$b=r("Get the concatenated _prefix name of the bias from the model name to the parent layer"),Mb=l(),rn=o("div"),c(Jo.$$.fragment),Pb=l(),Al=o("p"),Lb=r(`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),Eb=l(),ln=o("div"),c(Qo.$$.fragment),qb=l(),Gl=o("p"),Fb=r("Prunes heads of the base model."),Ob=l(),Ve=o("div"),c(es.$$.fragment),Db=l(),ts=o("p"),zb=r("Resizes input token embeddings matrix of the model if "),Sl=o("code"),Ab=r("new_num_tokens != config.vocab_size"),Gb=r("."),Sb=l(),ns=o("p"),Nb=r("Takes care of tying weights embeddings afterwards if the model class has a "),Nl=o("code"),Cb=r("tie_weights()"),Ib=r(" method."),Bb=l(),dn=o("div"),c(os.$$.fragment),Wb=l(),ss=o("p"),Ub=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
...
backwards pass. In this case, `),Kl=o("code"),Tv=r("data"),jv=r(" is a singleton tuple containing "),Zl=o("code"),$v=r("(inputs,)"),Mv=r("."),Pv=l(),gt=o("p"),Lv=r(`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=o("code"),Ev=r("loss"),qv=r(" output, and the model will output a "),Ql=o("code"),Fv=r("loss"),Ov=r(` component (notice the
...
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),c1=l(),Ld=o("p"),m1=r("Examples:"),u1=l(),c(Ls.$$.fragment),g1=l(),K=o("div"),c(Es.$$.fragment),h1=l(),ae=o("p"),_1=r("Cast the floating-point "),Ed=o("code"),f1=r("parmas"),b1=r(" to "),qd=o("code"),v1=r("jax.numpy.float16"),y1=r(". This returns a new "),Fd=o("code"),k1=r("params"),x1=r(` tree and does not cast the
`),Od=o("code"),w1=r("params"),T1=r(" in place."),j1=l(),Dd=o("p"),$1=r(`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),M1=l(),zd=o("p"),P1=r("Examples:"),L1=l(),c(qs.$$.fragment),E1=l(),ue=o("div"),c(Fs.$$.fragment),q1=l(),re=o("p"),F1=r("Cast the floating-point "),Ad=o("code"),O1=r("parmas"),D1=r(" to "),Gd=o("code"),z1=r("jax.numpy.float32"),A1=r(`. This method can be used to explicitly convert the
...
the `),pr=o("a"),Lk=r("PretrainedConfig"),Ek=r(" of the model. The default values indicated are the default values of those config."),qk=l(),Xs=o("p"),Fk=r("Most of these parameters are explained in more detail in "),Rs=o("a"),Ok=r(`this blog
...
code`),x0=r("."),w0=l(),Le=o("p"),T0=r("Apart from "),rp=o("code"),j0=r("input_ids"),$0=r(" and "),ip=o("code"),M0=r("attention_mask"),P0=r(`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=o("a"),L0=r("PretrainedConfig"),E0=r(` of the model. The default values indicated are the default
values of those config.`),q0=l(),ca=o("p"),F0=r("Most of these parameters are explained in more detail in "),ma=o("a"),O0=r(`this blog
post`),D0=r("."),z0=l(),lp=o("p"),A0=r("Examples:"),G0=l(),c(ua.$$.fragment),S0=l(),ye=o("div"),c(ga.$$.fragment),N0=l(),dp=o("p"),C0=r("Generates sequences for models with a language modeling head using greedy decoding."),I0=l(),pp=o("p"),B0=r("Examples:"),W0=l(),c(ha.$$.fragment),U0=l(),Mn=o("div"),c(_a.$$.fragment),H0=l(),fa=o("p"),V0=r("Implement in subclasses of "),hr=o("a"),X0=r("TFPreTrainedModel"),R0=r(" for custom behavior to prepare inputs in the generate method."),Y0=l(),ke=o("div"),c(ba.$$.fragment),K0=l(),cp=o("p"),Z0=r("Generates sequences for models with a language modeling head using multinomial sampling."),J0=l(),mp=o("p"),Q0=r("Examples:"),ex=l(),c(va.$$.fragment),ac=l(),Ee=o("div"),c(ya.$$.fragment),tx=l(),ka=o("p"),nx=r("A class containing all of the functions supporting generation, to be used as a mixin in "),_r=o("a"),ox=r("FlaxPreTrainedModel"),sx=r("."),ax=l(),H=o("div"),c(xa.$$.fragment),rx=l(),up=o("p"),ix=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
weights are discarded.`),hc.forEach(t),Bg=d(C),m(Et.$$.fragment,C),Wg=d(C),m(qt.$$.fragment,C),Ug=d(C),ji=s(C,"P",{});var Dw=a(ji);Hg=i(Dw,"Examples:"),Dw.forEach(t),Vg=d(C),m(to.$$.fragment,C),C.forEach(t),Xg=d(j),Ft=s(j,"DIV",{class:!0});var _c=a(Ft);m(no.$$.fragment,_c),Rg=d(_c),$i=s(_c,"P",{});var zw=a($i);Yg=i(zw,"Returns the model\u2019s input embeddings."),zw.forEach(t),_c.forEach(t),Kg=d(j),Ot=s(j,"DIV",{class:!0});var fc=a(Ot);m(oo.$$.fragment,fc),Zg=d(fc),Mi=s(fc,"P",{});var Aw=a(Mi);Jg=i(Aw,"Returns the model\u2019s output embeddings."),Aw.forEach(t),fc.forEach(t),Qg=d(j),Se=s(j,"DIV",{class:!0});var yr=a(Se);m(so.$$.fragment,yr),eh=d(yr),Pi=s(yr,"P",{});var Gw=a(Pi);th=i(Gw,"Deactivates gradient checkpointing for the current model."),Gw.forEach(t),nh=d(yr),Li=s(yr,"P",{});var Sw=a(Li);oh=i(Sw,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),Sw.forEach(t),yr.forEach(t),sh=d(j),Ne=s(j,"DIV",{class:!0});var kr=a(Ne);m(ao.$$.fragment,kr),ah=d(kr),Ei=s(kr,"P",{});var Nw=a(Ei);rh=i(Nw,"Activates gradient checkpointing for the current model."),Nw.forEach(t),ih=d(kr),qi=s(kr,"P",{});var Cw=a(qi);lh=i(Cw,`Note that in other frameworks this feature can be referred to as \u201Cactivation checkpointing\u201D or \u201Ccheckpoint
activations\u201D.`),Cw.forEach(t),kr.forEach(t),dh=d(j),Dt=s(j,"DIV",{class:!0});var bc=a(Dt);m(ro.$$.fragment,bc),ph=d(bc),Fi=s(bc,"P",{});var Iw=a(Fi);ch=i(Iw,"If needed prunes and maybe initializes weights."),Iw.forEach(t),bc.forEach(t),mh=d(j),zt=s(j,"DIV",{class:!0});var vc=a(zt);m(io.$$.fragment,vc),uh=d(vc),Oi=s(vc,"P",{});var Bw=a(Oi);gh=i(Bw,`A method executed at the end of each Transformer model initialization, to execute code that needs the model\u2019s
modules properly initialized (such as weight initialization).`),Bw.forEach(t),vc.forEach(t),hh=d(j),At=s(j,"DIV",{class:!0});var yc=a(At);m(lo.$$.fragment,yc),_h=d(yc),Di=s(yc,"P",{});var Ww=a(Di);fh=i(Ww,"Prunes heads of the base model."),Ww.forEach(t),yc.forEach(t),bh=d(j),Ce=s(j,"DIV",{class:!0});var xr=a(Ce);m(po.$$.fragment,xr),vh=d(xr),zi=s(xr,"P",{});var Uw=a(zi);yh=i(Uw,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),Uw.forEach(t),kh=d(xr),m(Gt.$$.fragment,xr),xr.forEach(t),xh=d(j),Ie=s(j,"DIV",{class:!0});var wr=a(Ie);m(co.$$.fragment,wr),wh=d(wr),mo=s(wr,"P",{});var kc=a(mo);Th=i(kc,"Resizes input token embeddings matrix of the model if "),Ai=s(kc,"CODE",{});var Hw=a(Ai);jh=i(Hw,"new_num_tokens != config.vocab_size"),Hw.forEach(t),$h=i(kc,"."),kc.forEach(t),Mh=d(wr),uo=s(wr,"P",{});var xc=a(uo);Ph=i(xc,"Takes care of tying weights embeddings afterwards if the model class has a "),Gi=s(xc,"CODE",{});var Vw=a(Gi);Lh=i(Vw,"tie_weights()"),Vw.forEach(t),Eh=i(xc," method."),xc.forEach(t),wr.forEach(t),qh=d(j),St=s(j,"DIV",{class:!0});var wc=a(St);m(go.$$.fragment,wc),Fh=d(wc),ho=s(wc,"P",{});var Tc=a(ho);Oh=i(Tc,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),Si=s(Tc,"CODE",{});var Xw=a(Si);Dh=i(Xw,"[from_pretrained()](/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Xw.forEach(t),zh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d(j),Nt=s(j,"DIV",{class:!0});var jc=a(Nt);m(_o.$$.fragment,jc),Gh=d(jc),Ni=s(jc,"P",{});var Rw=a(Ni);Sh=i(Rw,"Set model\u2019s input embeddings."),Rw.forEach(t),jc.forEach(t),Nh=d(j),Be=s(j,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var Yw=a(Ci);Ih=i(Yw,"Tie the weights between the input embeddings and the output embeddings."),Yw.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var $c=a(bo);Wh=i($c,"If the "),Ii=s($c,"CODE",{});var Kw=a(Ii);Uh=i(Kw,"torchscript"),Kw.forEach(t),Hh=i($c,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
weights instead.`),$c.forEach(t),Tr.forEach(t),j.forEach(t),Np=d(n),Ka=s(n,"A",{id:!0}),a(Ka).forEach(t),Cp=d(n),rt=s(n,"H3",{class:!0});var Mc=a(rt);Ct=s(Mc,"A",{id:!0,class:!0,href:!0});var Zw=a(Ct);Bi=s(Zw,"SPAN",{});var Jw=a(Bi);m(vo.$$.fragment,Jw),Jw.forEach(t),Zw.forEach(t),Vh=d(Mc),Wi=s(Mc,"SPAN",{});var Qw=a(Wi);Xh=i(Qw,"Model Instantiation dtype"),Qw.forEach(t),Mc.forEach(t),Ip=d(n),de=s(n,"P",{});var En=a(de);Rh=i(En,"Under Pytorch a model normally gets instantiated with "),Ui=s(En,"CODE",{});var eT=a(Ui);Yh=i(eT,"torch.float32"),eT.forEach(t),Kh=i(En,` format. This can be an issue if one tries to
load a model whose weights are in fp16, since it\u2019d require twice as much memory. To overcome this limitation, you can
either explicitly pass the desired `),Hi=s(En,"CODE",{});var tT=a(Hi);Zh=i(tT,"dtype"),tT.forEach(t),Jh=i(En," using "),Vi=s(En,"CODE",{});var nT=a(Vi);Qh=i(nT,"torch_dtype"),nT.forEach(t),e_=i(En," argument:"),En.forEach(t),Bp=d(n),m(yo.$$.fragment,n),Wp=d(n),We=s(n,"P",{});var jr=a(We);t_=i(jr,"or, if you want the model to always load in the most optimal memory pattern, you can use the special value "),Xi=s(jr,"CODE",{});var oT=a(Xi);n_=i(oT,'"auto"'),oT.forEach(t),o_=i(jr,`,
and then `),Ri=s(jr,"CODE",{});var sT=a(Ri);s_=i(sT,"dtype"),sT.forEach(t),a_=i(jr," will be automatically derived from the model\u2019s weights:"),jr.forEach(t),Up=d(n),m(ko.$$.fragment,n),Hp=d(n),It=s(n,"P",{});var Pc=a(It);r_=i(Pc,"Models instantiated from scratch can also be told which "),Yi=s(Pc,"CODE",{});var aT=a(Yi);i_=i(aT,"dtype"),aT.forEach(t),l_=i(Pc," to use with:"),Pc.forEach(t),Vp=d(n),m(xo.$$.fragment,n),Xp=d(n),Za=s(n,"P",{});var rT=a(Za);d_=i(rT,"Due to Pytorch design, this functionality is only available for floating dtypes."),rT.forEach(t),Rp=d(n),it=s(n,"H2",{class:!0});var Lc=a(it);Bt=s(Lc,"A",{id:!0,class:!0,href:!0});var iT=a(Bt);Ki=s(iT,"SPAN",{});var lT=a(Ki);m(wo.$$.fragment,lT),lT.forEach(t),iT.forEach(t),p_=d(Lc),Zi=s(Lc,"SPAN",{});var dT=a(Zi);c_=i(dT,"ModuleUtilsMixin"),dT.forEach(t),Lc.forEach(t),Yp=d(n),E=s(n,"DIV",{class:!0});var z=a(E);m(To.$$.fragment,z),m_=d(z),jo=s(z,"P",{});var Ec=a(jo);u_=i(Ec,"A few utilities for "),Ji=s(Ec,"CODE",{});var pT=a(Ji);g_=i(pT,"torch.nn.Modules"),pT.forEach(t),h_=i(Ec,", to be used as a mixin."),Ec.forEach(t),__=d(z),Ue=s(z,"DIV",{class:!0});var $r=a(Ue);m($o.$$.fragment,$r),f_=d($r),Qi=s($r,"P",{});var cT=a(Qi);b_=i(cT,"Add a memory hook before and after each sub-module forward pass to record increase in memory consumption."),cT.forEach(t),v_=d($r),lt=s($r,"P",{});var Mr=a(lt);y_=i(Mr,"Increase in memory consumption is stored in a "),el=s(Mr,"CODE",{});var mT=a(el);k_=i(mT,"mem_rss_diff"),mT.forEach(t),x_=i(Mr,` attribute for each module and can be reset to zero
with `),tl=s(Mr,"CODE",{});var uT=a(tl);w_=i(uT,"model.reset_memory_hooks_state()"),uT.forEach(t),T_=i(Mr,"."),Mr.forEach(t),$r.forEach(t),j_=d(z),Wt=s(z,"DIV",{class:!0});var qc=a(Wt);m(Mo.$$.fragment,qc),$_=d(qc),nl=s(qc,"P",{});var gT=a(nl);M_=i(gT,"Helper function to estimate the total number of tokens from the model inputs."),gT.forEach(t),qc.forEach(t),P_=d(z),Ut=s(z,"DIV",{class:!0});var Fc=a(Ut);m(Po.$$.fragment,Fc),L_=d(Fc),dt=s(Fc,"P",{});var Pr=a(dt);E_=i(Pr,`Get number of (optionally, non-embeddings) floating-point operations for the forward and backward passes of a
batch with this transformer model. Default approximation neglects the quadratic dependency on the number of
tokens (valid if `),ol=s(Pr,"CODE",{});var hT=a(ol);q_=i(hT,"12 * d_model << sequence_length"),hT.forEach(t),F_=i(Pr,") as laid out in "),Lo=s(Pr,"A",{href:!0,rel:!0});var _T=a(Lo);O_=i(_T,`this
paper`),_T.forEach(t),D_=i(Pr,` section 2.1. Should be overridden for transformers with parameter
re-use e.g. Albert or Universal Transformers, or if doing long-range modeling with very high sequence lengths.`),Pr.forEach(t),Fc.forEach(t),z_=d(z),Ht=s(z,"DIV",{class:!0});var Oc=a(Ht);m(Eo.$$.fragment,Oc),A_=d(Oc),sl=s(Oc,"P",{});var fT=a(sl);G_=i(fT,"Makes broadcastable attention and causal masks so that future and masked tokens are ignored."),fT.forEach(t),Oc.forEach(t),S_=d(z),Vt=s(z,"DIV",{class:!0});var Dc=a(Vt);m(qo.$$.fragment,Dc),N_=d(Dc),al=s(Dc,"P",{});var bT=a(al);C_=i(bT,"Prepare the head mask if needed."),bT.forEach(t),Dc.forEach(t),I_=d(z),Xt=s(z,"DIV",{class:!0});var zc=a(Xt);m(Fo.$$.fragment,zc),B_=d(zc),rl=s(zc,"P",{});var vT=a(rl);W_=i(vT,"Invert an attention mask (e.g., switches 0. and 1.)."),vT.forEach(t),zc.forEach(t),U_=d(z),Rt=s(z,"DIV",{class:!0});var Ac=a(Rt);m(Oo.$$.fragment,Ac),H_=d(Ac),il=s(Ac,"P",{});var yT=a(il);V_=i(yT,"Get number of (optionally, trainable or non-embeddings) parameters in the module."),yT.forEach(t),Ac.forEach(t),X_=d(z),Yt=s(z,"DIV",{class:!0});var Gc=a(Yt);m(Do.$$.fragment,Gc),R_=d(Gc),pt=s(Gc,"P",{});var Lr=a(pt);Y_=i(Lr,"Reset the "),ll=s(Lr,"CODE",{});var kT=a(ll);K_=i(kT,"mem_rss_diff"),kT.forEach(t),Z_=i(Lr," attribute of each module (see "),Ja=s(Lr,"A",{href:!0});var xT=a(Ja);J_=i(xT,"add_memory_hooks()"),xT.forEach(t),Q_=i(Lr,")."),Lr.forEach(t),Gc.forEach(t),z.forEach(t),Kp=d(n),ct=s(n,"H2",{class:!0});var Sc=a(ct);Kt=s(Sc,"A",{id:!0,class:!0,href:!0});var wT=a(Kt);dl=s(wT,"SPAN",{});var TT=a(dl);m(zo.$$.fragment,TT),TT.forEach(t),wT.forEach(t),ef=d(Sc),pl=s(Sc,"SPAN",{});var jT=a(pl);tf=i(jT,"TFPreTrainedModel"),jT.forEach(t),Sc.forEach(t),Zp=d(n),y=s(n,"DIV",{class:!0});var k=a(y);m(Ao.$$.fragment,k),nf=d(k),cl=s(k,"P",{});var $T=a(cl);of=i($T,"Base class for all TF models."),$T.forEach(t),sf=d(k),Qa=s(k,"P",{});var Dx=a(Qa);er=s(Dx,"A",{href:!0});var MT=a(er);af=i(MT,"TFPreTrainedModel"),MT.forEach(t),rf=i(Dx,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),Dx.forEach(t),lf=d(k),Go=s(k,"UL",{});var Nc=a(Go);ml=s(Nc,"LI",{});var PT=a(ml);df=i(PT,"resize the input embeddings,"),PT.forEach(t),pf=d(Nc),ul=s(Nc,"LI",{});var LT=a(ul);cf=i(LT,"prune heads in the self-attention heads."),LT.forEach(t),Nc.forEach(t),mf=d(k),gl=s(k,"P",{});var ET=a(gl);uf=i(ET,"Class attributes (overridden by derived classes):"),ET.forEach(t),gf=d(k),mt=s(k,"UL",{});var Er=a(mt);He=s(Er,"LI",{});var Da=a(He);hl=s(Da,"STRONG",{});var qT=a(hl);hf=i(qT,"config_class"),qT.forEach(t),_f=i(Da," ("),tr=s(Da,"A",{href:!0});var FT=a(tr);ff=i(FT,"PretrainedConfig"),FT.forEach(t),bf=i(Da,") \u2014 A subclass of "),nr=s(Da,"A",{href:!0});var OT=a(nr);vf=i(OT,"PretrainedConfig"),OT.forEach(t),yf=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),kf=d(Er),Zt=s(Er,"LI",{});var Ep=a(Zt);_l=s(Ep,"STRONG",{});var DT=a(_l);xf=i(DT,"base_model_prefix"),DT.forEach(t),wf=i(Ep," ("),fl=s(Ep,"CODE",{});var zT=a(fl);Tf=i(zT,"str"),zT.forEach(t),jf=i(Ep,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Ep.forEach(t),$f=d(Er),X=s(Er,"LI",{});var De=a(X);bl=s(De,"STRONG",{});var AT=a(bl);Mf=i(AT,"main_input_name"),AT.forEach(t),Pf=i(De," ("),vl=s(De,"CODE",{});var GT=a(vl);Lf=i(GT,"str"),GT.forEach(t),Ef=i(De,") \u2014 The name of the principal input to the model (often "),yl=s(De,"CODE",{});var ST=a(yl);qf=i(ST,"input_ids"),ST.forEach(t),Ff=i(De,` for NLP
models, `),kl=s(De,"CODE",{});var NT=a(kl);Of=i(NT,"pixel_values"),NT.forEach(t),Df=i(De," for vision models and "),xl=s(De,"CODE",{});var CT=a(xl);zf=i(CT,"input_values"),CT.forEach(t),Af=i(De," for speech models)."),De.forEach(t),Er.forEach(t),Gf=d(k),pe=s(k,"DIV",{class:!0});var qn=a(pe);m(So.$$.fragment,qn),Sf=d(qn),No=s(qn,"P",{});var Cc=a(No);Nf=i(Cc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
weights are discarded.`),Wc.forEach(t),ab=d(Z),m(Qt.$$.fragment,Z),rb=d(Z),Ll=s(Z,"P",{});var XT=a(Ll);ib=i(XT,"Examples:"),XT.forEach(t),lb=d(Z),m(Ho.$$.fragment,Z),Z.forEach(t),db=d(k),en=s(k,"DIV",{class:!0});var Uc=a(en);m(Vo.$$.fragment,Uc),pb=d(Uc),El=s(Uc,"P",{});var RT=a(El);cb=i(RT,"Dict of bias attached to an LM head. The key represents the name of the bias attribute."),RT.forEach(t),Uc.forEach(t),mb=d(k),tn=s(k,"DIV",{class:!0});var Hc=a(tn);m(Xo.$$.fragment,Hc),ub=d(Hc),ql=s(Hc,"P",{});var YT=a(ql);gb=i(YT,"Returns the model\u2019s input embeddings layer."),YT.forEach(t),Hc.forEach(t),hb=d(k),nn=s(k,"DIV",{class:!0});var Vc=a(nn);m(Ro.$$.fragment,Vc),_b=d(Vc),Fl=s(Vc,"P",{});var KT=a(Fl);fb=i(KT,"The LM Head layer. This method must be overwritten by all the models that have a lm head."),KT.forEach(t),Vc.forEach(t),bb=d(k),on=s(k,"DIV",{class:!0});var Xc=a(on);m(Yo.$$.fragment,Xc),vb=d(Xc),Ol=s(Xc,"P",{});var ZT=a(Ol);yb=i(ZT,"Returns the model\u2019s output embeddings"),ZT.forEach(t),Xc.forEach(t),kb=d(k),sn=s(k,"DIV",{class:!0});var Rc=a(sn);m(Ko.$$.fragment,Rc),xb=d(Rc),Dl=s(Rc,"P",{});var JT=a(Dl);wb=i(JT,`Get the layer that handles a bias attribute in case the model has an LM head with weights tied to the
embeddings`),JT.forEach(t),Rc.forEach(t),Tb=d(k),an=s(k,"DIV",{class:!0});var Yc=a(an);m(Zo.$$.fragment,Yc),jb=d(Yc),zl=s(Yc,"P",{});var QT=a(zl);$b=i(QT,"Get the concatenated _prefix name of the bias from the model name to the parent layer"),QT.forEach(t),Yc.forEach(t),Mb=d(k),rn=s(k,"DIV",{class:!0});var Kc=a(rn);m(Jo.$$.fragment,Kc),Pb=d(Kc),Al=s(Kc,"P",{});var e2=a(Al);Lb=i(e2,`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
the checkpoint was made.`),e2.forEach(t),Kc.forEach(t),Eb=d(k),ln=s(k,"DIV",{class:!0});var Zc=a(ln);m(Qo.$$.fragment,Zc),qb=d(Zc),Gl=s(Zc,"P",{});var t2=a(Gl);Fb=i(t2,"Prunes heads of the base model."),t2.forEach(t),Zc.forEach(t),Ob=d(k),Ve=s(k,"DIV",{class:!0});var qr=a(Ve);m(es.$$.fragment,qr),Db=d(qr),ts=s(qr,"P",{});var Jc=a(ts);zb=i(Jc,"Resizes input token embeddings matrix of the model if "),Sl=s(Jc,"CODE",{});var n2=a(Sl);Ab=i(n2,"new_num_tokens != config.vocab_size"),n2.forEach(t),Gb=i(Jc,"."),Jc.forEach(t),Sb=d(qr),ns=s(qr,"P",{});var Qc=a(ns);Nb=i(Qc,"Takes care of tying weights embeddings afterwards if the model class has a "),Nl=s(Qc,"CODE",{});var o2=a(Nl);Cb=i(o2,"tie_weights()"),o2.forEach(t),Ib=i(Qc," method."),Qc.forEach(t),qr.forEach(t),Bb=d(k),dn=s(k,"DIV",{class:!0});var em=a(dn);m(os.$$.fragment,em),Wb=d(em),ss=s(em,"P",{});var tm=a(ss);Ub=i(tm,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
...
part of the input dictionary, the loss is computed internally (inside the model class) and is used in the
backwards pass. In this case, `),Kl=s(Fr,"CODE",{});var h2=a(Kl);Tv=i(h2,"data"),h2.forEach(t),jv=i(Fr," is a singleton tuple containing "),Zl=s(Fr,"CODE",{});var _2=a(Zl);$v=i(_2,"(inputs,)"),_2.forEach(t),Mv=i(Fr,"."),Fr.forEach(t),Pv=d(Fn),gt=s(Fn,"P",{});var Or=a(gt);Lv=i(Or,`This is possible under the aforementioned circumstances because our overriden compile function can set an
additional loss function that reduces a `),Jl=s(Or,"CODE",{});var f2=a(Jl);Ev=i(f2,"loss"),f2.forEach(t),qv=i(Or," output, and the model will output a "),Ql=s(Or,"CODE",{});var b2=a(Ql);Fv=i(b2,"loss"),b2.forEach(t),Ov=i(Or,` component (notice the
name matching) containing the loss that was used to train the pre-trained model.`),Or.forEach(t),Fn.forEach(t),k.forEach(t),Jp=d(n),ht=s(n,"H2",{class:!0});var lm=a(ht);_n=s(lm,"A",{id:!0,class:!0,href:!0});var v2=a(_n);ed=s(v2,"SPAN",{});var y2=a(ed);m(ms.$$.fragment,y2),y2.forEach(t),v2.forEach(t),Dv=d(lm),td=s(lm,"SPAN",{});var k2=a(td);zv=i(k2,"TFModelUtilsMixin"),k2.forEach(t),lm.forEach(t),Qp=d(n),Pe=s(n,"DIV",{class:!0});var Dr=a(Pe);m(us.$$.fragment,Dr),Av=d(Dr),gs=s(Dr,"P",{});var dm=a(gs);Gv=i(dm,"A few utilities for "),nd=s(dm,"CODE",{});var x2=a(nd);Sv=i(x2,"tf.keras.Model"),x2.forEach(t),Nv=i(dm,", to be used as a mixin."),dm.forEach(t),Cv=d(Dr),fn=s(Dr,"DIV",{class:!0});var pm=a(fn);m(hs.$$.fragment,pm),Iv=d(pm),od=s(pm,"P",{});var w2=a(od);Bv=i(w2,"Get the number of (optionally, trainable) parameters in the model."),w2.forEach(t),pm.forEach(t),Dr.forEach(t),ec=d(n),_t=s(n,"H2",{class:!0});var cm=a(_t);bn=s(cm,"A",{id:!0,class:!0,href:!0});var T2=a(bn);sd=s(T2,"SPAN",{});var j2=a(sd);m(_s.$$.fragment,j2),j2.forEach(t),T2.forEach(t),Wv=d(cm),ad=s(cm,"SPAN",{});var $2=a(ad);Uv=i($2,"FlaxPreTrainedModel"),$2.forEach(t),cm.forEach(t),tc=d(n),M=s(n,"DIV",{class:!0});var q=a(M);m(fs.$$.fragment,q),Hv=d(q),rd=s(q,"P",{});var M2=a(rd);Vv=i(M2,"Base class for all models."),M2.forEach(t),Xv=d(q),sr=s(q,"P",{});var zx=a(sr);ar=s(zx,"A",{href:!0});var P2=a(ar);Rv=i(P2,"FlaxPreTrainedModel"),P2.forEach(t),Yv=i(zx,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models.`),zx.forEach(t),Kv=d(q),id=s(q,"P",{});var L2=a(id);Zv=i(L2,"Class attributes (overridden by derived classes):"),L2.forEach(t),Jv=d(q),ft=s(q,"UL",{});var zr=a(ft);Xe=s(zr,"LI",{});var za=a(Xe);ld=s(za,"STRONG",{});var E2=a(ld);Qv=i(E2,"config_class"),E2.forEach(t),ey=i(za," ("),rr=s(za,"A",{href:!0});var q2=a(rr);ty=i(q2,"PretrainedConfig"),q2.forEach(t),ny=i(za,") \u2014 A subclass of "),ir=s(za,"A",{href:!0});var F2=a(ir);oy=i(F2,"PretrainedConfig"),F2.forEach(t),sy=i(za,` to use as configuration class
...
`),_d=s(mm,"CODE",{});var C2=a(_d);Ty=i(C2,"repo_path_or_name"),C2.forEach(t),jy=i(mm,"."),mm.forEach(t),$y=d(On),fd=s(On,"P",{});var I2=a(fd);My=i(I2,"Examples:"),I2.forEach(t),Py=d(On),m(ys.$$.fragment,On),On.forEach(t),Ly=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),Ey=d(Te),bd=s(Te,"P",{});var B2=a(bd);qy=i(B2,"Instantiate a pretrained flax model from a pre-trained model configuration."),B2.forEach(t),Fy=d(Te),xs=s(Te,"P",{});var um=a(xs);Oy=i(um,"The warning "),vd=s(um,"EM",{});var W2=a(vd);Dy=i(W2,"Weights from XXX not initialized from pretrained model"),W2.forEach(t),zy=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
...
half-precision training or to save weights in bfloat16 for inference in order to save memory and improve speed.`),J2.forEach(t),c1=d(Ze),Ld=s(Ze,"P",{});var Q2=a(Ld);m1=i(Q2,"Examples:"),Q2.forEach(t),u1=d(Ze),m(Ls.$$.fragment,Ze),Ze.forEach(t),g1=d(q),K=s(q,"DIV",{class:!0});var Qe=a(K);m(Es.$$.fragment,Qe),h1=d(Qe),ae=s(Qe,"P",{});var et=a(ae);_1=i(et,"Cast the floating-point "),Ed=s(et,"CODE",{});var ej=a(Ed);f1=i(ej,"parmas"),ej.forEach(t),b1=i(et," to "),qd=s(et,"CODE",{});var tj=a(qd);v1=i(tj,"jax.numpy.float16"),tj.forEach(t),y1=i(et,". This returns a new "),Fd=s(et,"CODE",{});var nj=a(Fd);k1=i(nj,"params"),nj.forEach(t),x1=i(et,` tree and does not cast the
`),Od=s(et,"CODE",{});var oj=a(Od);w1=i(oj,"params"),oj.forEach(t),T1=i(et," in place."),et.forEach(t),j1=d(Qe),Dd=s(Qe,"P",{});var sj=a(Dd);$1=i(sj,`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),sj.forEach(t),M1=d(Qe),zd=s(Qe,"P",{});var aj=a(zd);P1=i(aj,"Examples:"),aj.forEach(t),L1=d(Qe),m(qs.$$.fragment,Qe),Qe.forEach(t),E1=d(q),ue=s(q,"DIV",{class:!0});var Dn=a(ue);m(Fs.$$.fragment,Dn),q1=d(Dn),re=s(Dn,"P",{});var tt=a(re);F1=i(tt,"Cast the floating-point "),Ad=s(tt,"CODE",{});var rj=a(Ad);O1=i(rj,"parmas"),rj.forEach(t),D1=i(tt," to "),Gd=s(tt,"CODE",{});var ij=a(Gd);z1=i(ij,"jax.numpy.float32"),ij.forEach(t),A1=i(tt,`. This method can be used to explicitly convert the
...
the `),pr=s(Gr,"A",{href:!0});var jj=a(pr);Lk=i(jj,"PretrainedConfig"),jj.forEach(t),Ek=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),qk=d(je),Xs=s(je,"P",{});var xm=a(Xs);Fk=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var $j=a(Rs);Ok=i($j,`this blog
post`),$j.forEach(t),Dk=i(xm,"."),xm.forEach(t),zk=d(je),Jd=s(je,"P",{});var Mj=a(Jd);Ak=i(Mj,"Examples:"),Mj.forEach(t),Gk=d(je),m(Ys.$$.fragment,je),je.forEach(t),Sk=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),Nk=d(Sn),Qd=s(Sn,"P",{});var Pj=a(Qd);Ck=i(Pj,"Generates sequences for models with a language modeling head using greedy decoding."),Pj.forEach(t),Ik=d(Sn),ep=s(Sn,"P",{});var Lj=a(ep);Bk=i(Lj,"Examples:"),Lj.forEach(t),Wk=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),Uk=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),Hk=d(Nn),tp=s(Nn,"P",{});var Ej=a(tp);Vk=i(Ej,"Generates sequences for models with a language modeling head using beam search decoding."),Ej.forEach(t),Xk=d(Nn),np=s(Nn,"P",{});var qj=a(np);Rk=i(qj,"Examples:"),qj.forEach(t),Yk=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),Kk=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Zk=d(wm),ta=s(wm,"P",{});var Tm=a(ta);Jk=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var Fj=a(cr);Qk=i(Fj,"PreTrainedModel"),Fj.forEach(t),e0=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),t0=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),n0=d(Cn),op=s(Cn,"P",{});var Oj=a(op);o0=i(Oj,"Generates sequences for models with a language modeling head using multinomial sampling."),Oj.forEach(t),s0=d(Cn),sp=s(Cn,"P",{});var Dj=a(sp);a0=i(Dj,"Examples:"),Dj.forEach(t),r0=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),i0=d(J),aa=s(J,"P",{});var jm=a(aa);l0=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var zj=a(mr);d0=i(zj,"TFPreTrainedModel"),zj.forEach(t),p0=i(jm,"."),jm.forEach(t),c0=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),m0=d($m),ia=s($m,"P",{});var Mm=a(ia);u0=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var Aj=a(ur);g0=i(Aj,"PreTrainedModel"),Aj.forEach(t),h0=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),_0=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),f0=d(Q),ap=s(Q,"P",{});var Gj=a(ap);b0=i(Gj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),Sj.forEach(t),x0=i(Pm,"."),Pm.forEach(t),w0=d(Q),Le=s(Q,"P",{});var In=a(Le);T0=i(In,"Apart from "),rp=s(In,"CODE",{});var Nj=a(rp);j0=i(Nj,"input_ids"),Nj.forEach(t),$0=i(In," and "),ip=s(In,"CODE",{});var Cj=a(ip);M0=i(Cj,"attention_mask"),Cj.forEach(t),P0=i(In,`, all the arguments below will default to the value of the attribute
of the same name inside the `),gr=s(In,"A",{href:!0});var Ij=a(gr);L0=i(Ij,"PretrainedConfig"),Ij.forEach(t),E0=i(In,` of the model. The default values indicated are the default
values of those config.`),In.forEach(t),q0=d(Q),ca=s(Q,"P",{});var Lm=a(ca);F0=i(Lm,"Most of these parameters are explained in more detail in "),ma=s(Lm,"A",{href:!0,rel:!0});var Bj=a(ma);O0=i(Bj,`this blog
post`),Bj.forEach(t),D0=i(Lm,"."),Lm.forEach(t),z0=d(Q),lp=s(Q,"P",{});var Wj=a(lp);A0=i(Wj,"Examples:"),Wj.forEach(t),G0=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),S0=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),N0=d(Bn),dp=s(Bn,"P",{});var Uj=a(dp);C0=i(Uj,"Generates sequences for models with a language modeling head using greedy decoding."),Uj.forEach(t),I0=d(Bn),pp=s(Bn,"P",{});var Hj=a(pp);B0=i(Hj,"Examples:"),Hj.forEach(t),W0=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),U0=d(J),Mn=s(J,"DIV",{class:!0});var Em=a(Mn);m(_a.$$.fragment,Em),H0=d(Em),fa=s(Em,"P",{});var qm=a(fa);V0=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var Vj=a(hr);X0=i(Vj,"TFPreTrainedModel"),Vj.forEach(t),R0=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Em.forEach(t),Y0=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),K0=d(Wn),cp=s(Wn,"P",{});var Xj=a(cp);Z0=i(Xj,"Generates sequences for models with a language modeling head using multinomial sampling."),Xj.forEach(t),J0=d(Wn),mp=s(Wn,"P",{});var Rj=a(mp);Q0=i(Rj,"Examples:"),Rj.forEach(t),ex=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ac=d(n),Ee=s(n,"DIV",{class:!0});var Sr=a(Ee);m(ya.$$.fragment,Sr),tx=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);nx=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),_r=s(Fm,"A",{href:!0});var Yj=a(_r);ox=i(Yj,"FlaxPreTrainedModel"),Yj.forEach(t),sx=i(Fm,"."),Fm.forEach(t),ax=d(Sr),H=s(Sr,"DIV",{class:!0});var $e=a(H);m(xa.$$.fragment,$e),rx=d($e),up=s($e,"P",{});var Kj=a(up);ix=i(Kj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
post`),Qj.forEach(t),fx=i(Om,"."),Om.forEach(t),bx=d($e),hp=s($e,"P",{});var e$=a(hp);vx=i(e$,"Examples:"),e$.forEach(t),yx=d($e),m(ja.$$.fragment,$e),$e.forEach(t),Sr.forEach(t),rc=d(n),kt=s(n,"H2",{class:!0});var Dm=a(kt);Pn=s(Dm,"A",{id:!0,class:!0,href:!0});var t$=a(Pn);_p=s(t$,"SPAN",{});var n$=a(_p);m($a.$$.fragment,n$),n$.forEach(t),t$.forEach(t),kx=d(Dm),fp=s(Dm,"SPAN",{});var o$=a(fp);xx=i(o$,"Pushing to the Hub"),o$.forEach(t),Dm.forEach(t),ic=d(n),qe=s(n,"DIV",{class:!0});var Cr=a(qe);m(Ma.$$.fragment,Cr),wx=d(Cr),bp=s(Cr,"P",{});var s$=a(bp);Tx=i(s$,"A Mixin containing the functionality to push a model or tokenizer to the hub."),s$.forEach(t),jx=d(Cr),xe=s(Cr,"DIV",{class:!0});var Un=a(xe);m(Pa.$$.fragment,Un),$x=d(Un),La=s(Un,"P",{});var zm=a(La);Mx=i(zm,`Upload the {object_files} to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),vp=s(zm,"CODE",{});var a$=a(vp);Px=i(a$,"repo_path_or_name"),a$.forEach(t),Lx=i(zm,"."),zm.forEach(t),Ex=d(Un),yp=s(Un,"P",{});var r$=a(yp);qx=i(r$,"Examples:"),r$.forEach(t),Fx=d(Un),m(Ea.$$.fragment,Un),Un.forEach(t),Cr.forEach(t),this.h()},h(){p(x,"name","hf:doc:metadata"),p(x,"content",JSON.stringify(f$)),p($,"id","models"),p($,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p($,"href","#models"),p(T,"class","relative group"),p(Aa,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel"),p(Ga,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel"),p(Sa,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Na,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel"),p(Ca,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel"),p(Ia,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin"),p(Ba,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.generation_utils.GenerationMixin"),p(Wa,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.generation_tf_utils.TFGenerationMixin"),p(Ua,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.generation_flax_utils.FlaxGenerationMixin"),p(Tt,"id","transformers.PreTrainedModel"),p(Tt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Tt,"href","#transformers.PreTrainedModel"),p(ot,"class","relative group"),p(Va,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel"),p(Xa,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ra,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ya,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel"),p(le,"class","docstring"),p(D,"class","docstring"),p(Ft,"class","docstring"),p(Ot,"class","docstring"),p(Se,"class","docstring"),p(Ne,"class","docstring"),p(Dt,"class","docstring"),p(zt,"class","docstring"),p(At,"class","docstring"),p(Ce,"class","docstring"),p(Ie,"class","docstring"),p(St,"class","docstring"),p(Nt,"class","docstring"),p(Be,"class","docstring"),p(w,"class","docstring"),p(Ka,"id","from_pretrained-torch-dtype"),p(Ct,"id","model-instantiation-dtype"),p(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ct,"href","#model-instantiation-dtype"),p(rt,"class","relative group"),p(Bt,"id","transformers.modeling_utils.ModuleUtilsMixin"),p(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Bt,"href","#transformers.modeling_utils.ModuleUtilsMixin"),p(it,"class","relative group"),p(Ue,"class","docstring"),p(Wt,"class","docstring"),p(Lo,"href","https://arxiv.org/pdf/2001.08361.pdf"),p(Lo,"rel","nofollow"),p(Ut,"class","docstring"),p(Ht,"class","docstring"),p(Vt,"class","docstring"),p(Xt,"class","docstring"),p(Rt,"class","docstring"),p(Ja,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.modeling_utils.ModuleUtilsMixin.add_memory_hooks"),p(Yt,"class","docstring"),p(E,"class","docstring"),p(Kt,"id","transformers.TFPreTrainedModel"),p(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Kt,"href","#transformers.TFPreTrainedModel"),p(ct,"class","relative group"),p(er,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel"),p(tr,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(nr,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(pe,"class","docstring"),p(Jt,"class","docstring"),p(S,"class","docstring"),p(en,"class","docstring"),p(tn,"class","docstring"),p(nn,"class","docstring"),p(on,"class","docstring"),p(sn,"class","docstring"),p(an,"class","docstring"),p(rn,"class","docstring"),p(ln,"class","docstring"),p(Ve,"class","docstring"),p(or,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained"),p(dn,"class","docstring"),p(pn,"class","docstring"),p(cn,"class","docstring"),p(mn,"class","docstring"),p(un,"class","docstring"),p(gn,"class","docstring"),p(hn,"class","docstring"),p(ce,"class","docstring"),p(y,"class","docstring"),p(_n,"id","transformers.modeling_tf_utils.TFModelUtilsMixin"),p(_n,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(_n,"href","#transformers.modeling_tf_utils.TFModelUtilsMixin"),p(ht,"class","relative group"),p(fn,"class","docstring"),p(Pe,"class","docstring"),p(bn,"id","transformers.FlaxPreTrainedModel"),p(bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(bn,"href","#transformers.FlaxPreTrainedModel"),p(_t,"class","relative group"),p(ar,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(rr,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(ir,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(me,"class","docstring"),p(W,"class","docstring"),p(Re,"class","docstring"),p(kn,"class","docstring"),p(Y,"class","docstring"),p(K,"class","docstring"),p(ue,"class","docstring"),p(M,"class","docstring"),p(xn,"id","transformers.generation_utils.GenerationMixin"),p(xn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(xn,"href","#transformers.generation_utils.GenerationMixin"),p(bt,"class","relative group"),p(lr,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel"),p(dr,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel"),p(wn,"class","docstring"),p(ge,"class","docstring"),p(he,"class","docstring"),p(Tn,"class","docstring"),p(_e,"class","docstring"),p(pr,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(Rs,"href","https://huggingface.co/blog/how-to-generate"),p(Rs,"rel","nofollow"),p(U,"class","docstring"),p(fe,"class","docstring"),p(be,"class","docstring"),p(cr,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel"),p(jn,"class","docstring"),p(ve,"class","docstring"),p(P,"class","docstring"),p(mr,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel"),p(ur,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.PreTrainedModel"),p($n,"class","docstring"),p(pa,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),p(pa,"rel","nofollow"),p(gr,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(ma,"href","https://huggingface.co/blog/how-to-generate"),p(ma,"rel","nofollow"),p(N,"class","docstring"),p(ye,"class","docstring"),p(hr,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.TFPreTrainedModel"),p(Mn,"class","docstring"),p(ke,"class","docstring"),p(G,"class","docstring"),p(_r,"href","/docs/transformers/pr_16030/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(fr,"href","/docs/transformers/pr_16030/en/main_classes/configuration#transformers.PretrainedConfig"),p(Ta,"href","https://huggingface.co/blog/how-to-generate"),p(Ta,"rel","nofollow"),p(H,"class","docstring"),p(Ee,"class","docstring"),p(Pn,"id","transformers.file_utils.PushToHubMixin"),p(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Pn,"href","#transformers.file_utils.PushToHubMixin"),p(kt,"class","relative group"),p(xe,"class","docstring"),p(qe,"class","docstring")},m(n,b){e(document.head,x),v(n,L,b),v(n,T,b),e(T,$),e($,te),u(A,te,null),e(T,I),e(T,Me),e(Me,Am),v(n,Op,b),v(n,ie,b),e(ie,Gm),e(ie,Aa),e(Aa,Sm),e(ie,Nm),e(ie,Ga),e(Ga,Cm),e(ie,Im),e(ie,Sa),e(Sa,Bm),e(ie,Wm),v(n,Dp,b),v(n,nt,b),e(nt,Na),e(Na,Um),e(nt,Hm),e(nt,Ca),e(Ca,Vm),e(nt,Xm),v(n,zp,b),v(n,wt,b),e(wt,Ir),e(Ir,Rm),e(wt,Ym),e(wt,Br),e(Br,Km),v(n,Ap,b),v(n,B,b),e(B,Zm),e(B,Ia),e(Ia,Jm),e(B,Qm),e(B,Wr),e(Wr,eu),e(B,tu),e(B,Ba),e(Ba,nu),e(B,ou),e(B,Wa),e(Wa,su),e(B,au),e(B,Ua),e(Ua,ru),e(B,iu),v(n,Gp,b),v(n,ot,b),e(ot,Tt),e(Tt,Ur),u(Hn,Ur,null),e(ot,lu),e(ot,Hr),e(Hr,du),v(n,Sp,b),v(n,w,b),u(Vn,w,null),e(w,pu),e(w,Vr),e(Vr,cu),e(w,mu),e(w,Ha),e(Ha,Va),e(Va,uu),e(Ha,gu),e(w,hu),e(w,Xn),e(Xn,Xr),e(Xr,_u),e(Xn,fu),e(Xn,Rr),e(Rr,bu),e(w,vu),e(w,Yr),e(Yr,yu),e(w,ku),e(w,ne),e(ne,Kr),e(Kr,Ae),e(Ae,Zr),e(Zr,xu),e(Ae,wu),e(Ae,Xa),e(Xa,Tu),e(Ae,ju),e(Ae,Ra),e(Ra,$u),e(Ae,Mu),e(ne,Pu),e(ne,Rn),e(Rn,Ge),e(Ge,Jr),e(Jr,Lu),e(Ge,Eu),e(Ge,Qr),e(Qr,qu),e(Ge,Fu),e(Ge,ei),e(ei,Ou),e(Ge,Du),e(Rn,zu),e(Rn,st),e(st,jt),e(jt,ti),e(ti,Au),e(jt,Gu),e(jt,Ya),e(Ya,Su),e(jt,Nu),e(st,Cu),e(st,$t),e($t,ni),e(ni,Iu),e($t,Bu),e($t,oi),e(oi,Wu),e($t,Uu),e(st,Hu),e(st,Mt),e(Mt,si),e(si,Vu),e(Mt,Xu),e(Mt,ai),e(ai,Ru),e(Mt,Yu),e(ne,Ku),e(ne,ri),e(ri,Pt),e(Pt,ii),e(ii,Zu),e(Pt,Ju),e(Pt,li),e(li,Qu),e(Pt,eg),e(ne,tg),e(ne,di),e(di,Lt),e(Lt,pi),e(pi,ng),e(Lt,og),e(Lt,ci),e(ci,sg),e(Lt,ag),e(ne,rg),e(ne,mi),e(mi,V),e(V,ui),e(ui,ig),e(V,lg),e(V,gi),e(gi,dg),e(V,pg),e(V,hi),e(hi,cg),e(V,mg),e(V,_i),e(_i,ug),e(V,gg),e(V,fi),e(fi,hg),e(V,_g),e(w,fg),e(w,le),u(Yn,le,null),e(le,bg),e(le,Kn),e(Kn,vg),e(Kn,bi),e(bi,yg),e(Kn,kg),e(le,xg),e(le,vi),e(vi,wg),e(le,Tg),u(Zn,le,null),e(w,jg),e(w,D),u(Jn,D,null),e(D,$g),e(D,yi),e(yi,Mg),e(D,Pg),e(D,at),e(at,Lg),e(at,ki),e(ki,Eg),e(at,qg),e(at,xi),e(xi,Fg),e(at,Og),e(D,Dg),e(D,Qn),e(Qn,zg),e(Qn,wi),e(wi,Ag),e(Qn,Gg),e(D,Sg),e(D,eo),e(eo,Ng),e(eo,Ti),e(Ti,Cg),e(eo,Ig),e(D,Bg),u(Et,D,null),e(D,Wg),u(qt,D,null),e(D,Ug),e(D,ji),e(ji,Hg),e(D,Vg),u(to,D,null),e(w,Xg),e(w,Ft),u(no,Ft,null),e(Ft,Rg),e(Ft,$i),e($i,Yg),e(w,Kg),e(w,Ot),u(oo,Ot,null),e(Ot,Zg),e(Ot,Mi),e(Mi,Jg),e(w,Qg),e(w,Se),u(so,Se,null),e(Se,eh),e(Se,Pi),e(Pi,th),e(Se,nh),e(Se,Li),e(Li,oh),e(w,sh),e(w,Ne),u(ao,Ne,null),e(Ne,ah),e(Ne,Ei),e(Ei,rh),e(Ne,ih),e(Ne,qi),e(qi,lh),e(w,dh),e(w,Dt),u(ro,Dt,null),e(Dt,ph),e(Dt,Fi),e(Fi,ch),e(w,mh),e(w,zt),u(io,zt,null),e(zt,uh),e(zt,Oi),e(Oi,gh),e(w,hh),e(w,At),u(lo,At,null),e(At,_h),e(At,Di),e(Di,fh),e(w,bh),e(w,Ce),u(po,Ce,null),e(Ce,vh),e(Ce,zi),e(zi,yh),e(Ce,kh),u(Gt,Ce,null),e(w,xh),e(w,Ie),u(co,Ie,null),e(Ie,wh),e(Ie,mo),e(mo,Th),e(mo,Ai),e(Ai,jh),e(mo,$h),e(Ie,Mh),e(Ie,uo),e(uo,Ph),e(uo,Gi),e(Gi,Lh),e(uo,Eh),e(w,qh),e(w,St),u(go,St,null),e(St,Fh),e(St,ho),e(ho,Oh),e(ho,Si),e(Si,Dh),e(ho,zh),e(w,Ah),e(w,Nt),u(_o,Nt,null),e(Nt,Gh),e(Nt,Ni),e(Ni,Sh),e(w,Nh),e(w,Be),u(fo,Be,null),e(Be,Ch),e(Be,Ci),e(Ci,Ih),e(Be,Bh),e(Be,bo),e(bo,Wh),e(bo,Ii),e(Ii,Uh),e(bo,Hh),v(n,Np,b),v(n,Ka,b),v(n,Cp,b),v(n,rt,b),e(rt,Ct),e(Ct,Bi),u(vo,Bi,null),e(rt,Vh),e(rt,Wi),e(Wi,Xh),v(n,Ip,b),v(n,de,b),e(de,Rh),e(de,Ui),e(Ui,Yh),e(de,Kh),e(de,Hi),e(Hi,Zh),e(de,Jh),e(de,Vi),e(Vi,Qh),e(de,e_),v(n,Bp,b),u(yo,n,b),v(n,Wp,b),v(n,We,b),e(We,t_),e(We,Xi),e(Xi,n_),e(We,o_),e(We,Ri),e(Ri,s_),e(We,a_),v(n,Up,b),u(ko,n,b),v(n,Hp,b),v(n,It,b),e(It,r_),e(It,Yi),e(Yi,i_),e(It,l_),v(n,Vp,b),u(xo,n,b),v(n,Xp,b),v(n,Za,b),e(Za,d_),v(n,Rp,b),v(n,it,b),e(it,Bt),e(Bt,Ki),u(wo,Ki,null),e(it,p_),e(it,Zi),e(Zi,c_),v(n,Yp,b),v(n,E,b),u(To,E,null),e(E,m_),e(E,jo),e(jo,u_),e(jo,Ji),e(Ji,g_),e(jo,h_),e(E,__),e(E,Ue),u($o,Ue,null),e(Ue,f_),e(Ue,Qi),e(Qi,b_),e(Ue,v_),e(Ue,lt),e(lt,y_),e(lt,el),e(el,k_),e(lt,x_),e(lt,tl),e(tl,w_),e(lt,T_),e(E,j_),e(E,Wt),u(Mo,Wt,null),e(Wt,$_),e(Wt,nl),e(nl,M_),e(E,P_),e(E,Ut),u(Po,Ut,null),e(Ut,L_),e(Ut,dt),e(dt,E_),e(dt,ol),e(ol,q_),e(dt,F_),e(dt,Lo),e(Lo,O_),e(dt,D_),e(E,z_),e(E,Ht),u(Eo,Ht,null),e(Ht,A_),e(Ht,sl),e(sl,G_),e(E,S_),e(E,Vt),u(qo,Vt,null),e(Vt,N_),e(Vt,al),e(al,C_),e(E,I_),e(E,Xt),u(Fo,Xt,null),e(Xt,B_),e(Xt,rl),e(rl,W_),e(E,U_),e(E,Rt),u(Oo,Rt,null),e(Rt,H_),e(Rt,il),e(il,V_),e(E,X_),e(E,Yt),u(Do,Yt,null),e(Yt,R_),e(Yt,pt),e(pt,Y_),e(pt,ll),e(ll,K_),e(pt,Z_),e(pt,Ja),e(Ja,J_),e(pt,Q_),v(n,Kp,b),v(n,ct,b),e(ct,Kt),e(Kt,dl),u(zo,dl,null),e(ct,ef),e(ct,pl),e(pl,tf),v(n,Zp,b),v(n,y,b),u(Ao,y,null),e(y,nf),e(y,cl),e(cl,of),e(y,sf),e(y,Qa),e(Qa,er),e(er,af),e(Qa,rf),e(y,lf),e(y,Go),e(Go,ml),e(ml,df),e(Go,pf),e(Go,ul),e(ul,cf),e(y,mf),e(y,gl),e(gl,uf),e(y,gf),e(y,mt),e(mt,He),e(He,hl),e(hl,hf),e(He,_f),e(He,tr),e(tr,ff),e(He,bf),e(He,nr),e(nr,vf),e(He,yf),e(mt,kf),e(mt,Zt),e(Zt,_l),e(_l,xf),e(Zt,wf),e(Zt,fl),e(fl,Tf),e(Zt,jf),e(mt,$f),e(mt,X),e(X,bl),e(bl,Mf),e(X,Pf),e(X,vl),e(vl,Lf),e(X,Ef),e(X,yl),e(yl,qf),e(X,Ff),e(X,kl),e(kl,Of),e(X,Df),e(X,xl),e(xl,zf),e(X,Af),e(y,Gf),e(y,pe),u(So,pe,null),e(pe,Sf),e(pe,No),e(No,Nf),e(No,wl),e(wl,Cf),e(No,If),e(pe,Bf),e(pe,Tl),e(Tl,Wf),e(pe,Uf),u(Co,pe,null),e(y,Hf),e(y,Jt),u(Io,Jt,null),e(Jt,Vf),e(Jt,jl),e(jl,Xf),e(y,Rf),e(y,S),u(Bo,S,null),e(S,Yf),e(S,$l),e($l,Kf),e(S,Zf),e(S,Wo),e(Wo,Jf),e(Wo,Ml),e(Ml,Qf),e(Wo,eb),e(S,tb),e(S,Uo),e(Uo,nb),e(Uo,Pl),e(Pl,ob),e(Uo,sb),e(S,ab),u(Qt,S,null),e(S,rb),e(S,Ll),e(Ll,ib),e(S,lb),u(Ho,S,null),e(y,db),e(y,en),u(Vo,en,null),e(en,pb),e(en,El),e(El,cb),e(y,mb),e(y,tn),u(Xo,tn,null),e(tn,ub),e(tn,ql),e(ql,gb),e(y,hb),e(y,nn),u(Ro,nn,null),e(nn,_b),e(nn,Fl),e(Fl,fb),e(y,bb),e(y,on),u(Yo,on,null),e(on,vb),e(on,Ol),e(Ol,yb),e(y,kb),e(y,sn),u(Ko,sn,null),e(sn,xb),e(sn,Dl),e(Dl,wb),e(y,Tb),e(y,an),u(Zo,an,null),e(an,jb),e(an,zl),e(zl,$b),e(y,Mb),e(y,rn),u(Jo,rn,null),e(rn,Pb),e(rn,Al),e(Al,Lb),e(y,Eb),e(y,ln),u(Qo,ln,null),e(ln,qb),e(ln,Gl),e(Gl,Fb),e(y,Ob),e(y,Ve),u(es,Ve,null),e(Ve,Db),e(Ve,ts),e(ts,zb),e(ts,Sl),e(Sl,Ab),e(ts,Gb),e(Ve,Sb),e(Ve,ns),e(ns,Nb),e(ns,Nl),e(Nl,Cb),e(ns,Ib),e(y,Bb),e(y,dn),u(os,dn,null),e(dn,Wb),e(dn,ss),e(ss,Ub),e(ss,or),e(or,Hb),e(ss,Vb),e(y,Xb),e(y,pn),u(as,pn,null),e(pn,Rb),e(pn,Cl),e(Cl,Yb),e(y,Kb),e(y,cn),u(rs,cn,null),e(cn,Zb),e(cn,Il),e(Il,Jb),e(y,Qb),e(y,mn),u(is,mn,null),e(mn,ev),e(mn,Bl),e(Bl,tv),e(y,nv),e(y,un),u(ls,un,null),e(un,ov),e(un,Wl),e(Wl,sv),e(y,av),e(y,gn),u(ds,gn,null),e(gn,rv),e(gn,Ul),e(Ul,iv),e(y,lv),e(y,hn),u(ps,hn,null),e(hn,dv),e(hn,Hl),e(Hl,pv),e(y,cv),e(y,ce),u(cs,ce,null),e(ce,mv),e(ce,oe),e(oe,uv),e(oe,Vl),e(Vl,gv),e(oe,hv),e(oe,Xl),e(Xl,_v),e(oe,fv),e(oe,Rl),e(Rl,bv),e(oe,vv),e(oe,Yl),e(Yl,yv),e(oe,kv),e(ce,xv),e(ce,ut),e(ut,wv),e(ut,Kl),e(Kl,Tv),e(ut,jv),e(ut,Zl),e(Zl,$v),e(ut,Mv),e(ce,Pv),e(ce,gt),e(gt,Lv),e(gt,Jl),e(Jl,Ev),e(gt,qv),e(gt,Ql),e(Ql,Fv),e(gt,Ov),v(n,Jp,b),v(n,ht,b),e(ht,_n),e(_n,ed),u(ms,ed,null),e(ht,Dv),e(ht,td),e(td,zv),v(n,Qp,b),v(n,Pe,b),u(us,Pe,null),e(Pe,Av),e(Pe,gs),e(gs,Gv),e(gs,nd),e(nd,Sv),e(gs,Nv),e(Pe,Cv),e(Pe,fn),u(hs,fn,null),e(fn,Iv),e(fn,od),e(od,Bv),v(n,ec,b),v(n,_t,b),e(_t,bn),e(bn,sd),u(_s,sd,null),e(_t,Wv),e(_t,ad),e(ad,Uv),v(n,tc,b),v(n,M,b),u(fs,M,null),e(M,Hv),e(M,rd),e(rd,Vv),e(M,Xv),e(M,sr),e(sr,ar),e(ar,Rv),e(sr,Yv),e(M,Kv),e(M,id),e(id,Zv),e(M,Jv),e(M,ft),e(ft,Xe),e(Xe,ld),e(ld,Qv),e(Xe,ey),e(Xe,rr),e(rr,ty),e(Xe,ny),e(Xe,ir),e(ir,oy),e(Xe,sy),e(ft,ay),e(ft,vn),e(vn,dd),e(dd,ry),e(vn,iy),e(vn,pd),e(pd,ly),e(vn,dy),e(ft,py),e(ft,R),e(R,cd),e(cd,cy),e(R,my),e(R,md),e(md,uy),e(R,gy),e(R,ud),e(ud,hy),e(R,_y),e(R,gd),e(gd,fy),e(R,by),e(R,hd),e(hd,vy),e(R,yy),e(M,ky),e(M,me),u(bs,me,null),e(me,xy),e(me,vs),e(vs,wy),e(vs,_d),e(_d,Ty),e(vs,jy),e(me,$y),e(me,fd),e(fd,My),e(me,Py),u(ys,me,null),e(M,Ly),e(M,W),u(ks,W,null),e(W,Ey),e(W,bd),e(bd,qy),e(W,Fy),e(W,xs),e(xs,Oy),e(xs,vd),e(vd,Dy),e(xs,zy),e(W,Ay),e(W,ws),e(ws,Gy),e(ws,yd),e(yd,Sy),e(ws,Ny),e(W,Cy),e(W,kd),e(kd,Iy),e(W,By),u(Ts,W,null),e(M,Wy),e(M,Re),u(js,Re,null),e(Re,Uy),e(Re,xd),e(xd,Hy),e(Re,Vy),u(yn,Re,null),e(M,Xy),e(M,kn),u($s,kn,null),e(kn,Ry),e(kn,Ms),e(Ms,Yy),e(Ms,wd),e(wd,Ky),e(Ms,Zy),e(M,Jy),e(M,Y),u(Ps,Y,null),e(Y,Qy),e(Y,se),e(se,e1),e(se,Td),e(Td,t1),e(se,n1),e(se,jd),e(jd,o1),e(se,s1),e(se,$d),e($d,a1),e(se,r1),e(se,Md),e(Md,i1),e(se,l1),e(Y,d1),e(Y,Pd),e(Pd,p1),e(Y,c1),e(Y,Ld),e(Ld,m1),e(Y,u1),u(Ls,Y,null),e(M,g1),e(M,K),u(Es,K,null),e(K,h1),e(K,ae),e(ae,_1),e(ae,Ed),e(Ed,f1),e(ae,b1),e(ae,qd),e(qd,v1),e(ae,y1),e(ae,Fd),e(Fd,k1),e(ae,x1),e(ae,Od),e(Od,w1),e(ae,T1),e(K,j1),e(K,Dd),e(Dd,$1),e(K,M1),e(K,zd),e(zd,P1),e(K,L1),u(qs,K,null),e(M,E1),e(M,ue),u(Fs,ue,null),e(ue,q1),e(ue,re),e(re,F1),e(re,Ad),e(Ad,O1),e(re,D1),e(re,Gd),e(Gd,z1),e(re,A1),e(re,Sd),e(Sd,G1),e(re,S1),e(re,Nd),e(Nd,N1),e(re,C1),e(ue,I1),e(ue,Cd),e(Cd,B1),e(ue,W1),u(Os,ue,null),v(n,nc,b),v(n,bt,b),e(bt,xn),e(xn,Id),u(Ds,Id,null),e(bt,U1),e(bt,Bd),e(Bd,H1),v(n,oc,b),v(n,P,b),u(zs,P,null),e(P,V1),e(P,As),e(As,X1),e(As,lr),e(lr,R1),e(As,Y1),e(P,K1),e(P,wn),u(Gs,wn,null),e(wn,Z1),e(wn,Ss),e(Ss,J1),e(Ss,dr),e(dr,Q1),e(Ss,ek),e(P,tk),e(P,ge),u(Ns,ge,null),e(ge,nk),e(ge,Wd),e(Wd,ok),e(ge,sk),e(ge,Ud),e(Ud,ak),e(ge,rk),u(Cs,ge,null),e(P,ik),e(P,he),u(Is,he,null),e(he,lk),e(he,Hd),e(Hd,dk),e(he,pk),e(he,Vd),e(Vd,ck),e(he,mk),u(Bs,he,null),e(P,uk),e(P,Tn),u(Ws,Tn,null),e(Tn,gk),e(Tn,Xd),e(Xd,hk),e(P,_k),e(P,_e),u(Us,_e,null),e(_e,fk),e(_e,Rd),e(Rd,bk),e(_e,vk),e(_e,Yd),e(Yd,yk),e(_e,kk),u(Hs,_e,null),e(P,xk),e(P,U),u(Vs,U,null),e(U,wk),e(U,Kd),e(Kd,Tk),e(U,jk),e(U,vt),e(vt,$k),e(vt,Zd),e(Zd,Mk),e(vt,Pk),e(vt,pr),e(pr,Lk),e(vt,Ek),e(U,qk),e(U,Xs),e(Xs,Fk),e(Xs,Rs),e(Rs,Ok),e(Xs,Dk),e(U,zk),e(U,Jd),e(Jd,Ak),e(U,Gk),u(Ys,U,null),e(P,Sk),e(P,fe),u(Ks,fe,null),e(fe,Nk),e(fe,Qd),e(Qd,Ck),e(fe,Ik),e(fe,ep),e(ep,Bk),e(fe,Wk),u(Zs,fe,null),e(P,Uk),e(P,be),u(Js,be,null),e(be,Hk),e(be,tp),e(tp,Vk),e(be,Xk),e(be,np),e(np,Rk),e(be,Yk),u(Qs,be,null),e(P,Kk),e(P,jn),u(ea,jn,null),e(jn,Zk),e(jn,ta),e(ta,Jk),e(ta,cr),e(cr,Qk),e(ta,e0),e(P,t0),e(P,ve),u(na,ve,null),e(ve,n0),e(ve,op),e(op,o0),e(ve,s0),e(ve,sp),e(sp,a0),e(ve,r0),u(oa,ve,null),v(n,sc,b),v(n,G,b),u(sa,G,null),e(G,i0),e(G,aa),e(aa,l0),e(aa,mr),e(mr,d0),e(aa,p0),e(G,c0),e(G,$n),u(ra,$n,null),e($n,m0),e($n,ia),e(ia,u0),e(ia,ur),e(ur,g0),e(ia,h0),e(G,_0),e(G,N),u(la,N,null),e(N,f0),e(N,ap),e(ap,b0),e(N,v0),e(N,da),e(da,y0),e(da,pa),e(pa,k0),e(da,x0),e(N,w0),e(N,Le),e(Le,T0),e(Le,rp),e(rp,j0),e(Le,$0),e(Le,ip),e(ip,M0),e(Le,P0),e(Le,gr),e(gr,L0),e(Le,E0),e(N,q0),e(N,ca),e(ca,F0),e(ca,ma),e(ma,O0),e(ca,D0),e(N,z0),e(N,lp),e(lp,A0),e(N,G0),u(ua,N,null),e(G,S0),e(G,ye),u(ga,ye,null),e(ye,N0),e(ye,dp),e(dp,C0),e(ye,I0),e(ye,pp),e(pp,B0),e(ye,W0),u(ha,ye,null),e(G,U0),e(G,Mn),u(_a,Mn,null),e(Mn,H0),e(Mn,fa),e(fa,V0),e(fa,hr),e(hr,X0),e(fa,R0),e(G,Y0),e(G,ke),u(ba,ke,null),e(ke,K0),e(ke,cp),e(cp,Z0),e(ke,J0),e(ke,mp),e(mp,Q0),e(ke,ex),u(va,ke,null),v(n,ac,b),v(n,Ee,b),u(ya,Ee,null),e(Ee,tx),e(Ee,ka),e(ka,nx),e(ka,_r),e(_r,ox),e(ka,sx),e(Ee,ax),e(Ee,H),u(xa,H,null),e(H,rx),e(H,up),e(up,ix),e(H,lx),e(H,yt),e(yt,dx),e(yt,gp),e(gp,px),e(yt,cx),e(yt,fr),e(fr,mx),e(yt,ux),e(H,gx),e(H,wa),e(wa,hx),e(wa,Ta),e(Ta,_x),e(wa,fx),e(H,bx),e(H,hp),e(hp,vx),e(H,yx),u(ja,H,null),v(n,rc,b),v(n,kt,b),e(kt,Pn),e(Pn,_p),u($a,_p,null),e(kt,kx),e(kt,fp),e(fp,xx),v(n,ic,b),v(n,qe,b),u(Ma,qe,null),e(qe,wx),e(qe,bp),e(bp,Tx),e(qe,jx),e(qe,xe),u(Pa,xe,null),e(xe,$x),e(xe,La),e(La,Mx),e(La,vp),e(vp,Px),e(La,Lx),e(xe,Ex),e(xe,yp),e(yp,qx),e(xe,Fx),u(Ea,xe,null),lc=!0},p(n,[b]){const qa={};b&2&&(qa.$$scope={dirty:b,ctx:n}),Et.$set(qa);const kp={};b&2&&(kp.$$scope={dirty:b,ctx:n}),qt.$set(kp);const xp={};b&2&&(xp.$$scope={dirty:b,ctx:n}),Gt.$set(xp);const wp={};b&2&&(wp.$$scope={dirty:b,ctx:n}),Qt.$set(wp);const Fe={};b&2&&(Fe.$$scope={dirty:b,ctx:n}),yn.$set(Fe)},i(n){lc||(g(A.$$.fragment,n),g(Hn.$$.fragment,n),g(Vn.$$.fragment,n),g(Yn.$$.fragment,n),g(Zn.$$.fragment,n),g(Jn.$$.fragment,n),g(Et.$$.fragment,n),g(qt.$$.fragment,n),g(to.$$.fragment,n),g(no.$$.fragment,n),g(oo.$$.fragment,n),g(so.$$.fragment,n),g(ao.$$.fragment,n),g(ro.$$.fragment,n),g(io.$$.fragment,n),g(lo.$$.fragment,n),g(po.$$.fragment,n),g(Gt.$$.fragment,n),g(co.$$.fragment,n),g(go.$$.fragment,n),g(_o.$$.fragment,n),g(fo.$$.fragment,n),g(vo.$$.fragment,n),g(yo.$$.fragment,n),g(ko.$$.fragment,n),g(xo.$$.fragment,n),g(wo.$$.fragment,n),g(To.$$.fragment,n),g($o.$$.fragment,n),g(Mo.$$.fragment,n),g(Po.$$.fragment,n),g(Eo.$$.fragment,n),g(qo.$$.fragment,n),g(Fo.$$.fragment,n),g(Oo.$$.fragment,n),g(Do.$$.fragment,n),g(zo.$$.fragment,n),g(Ao.$$.fragment,n),g(So.$$.fragment,n),g(Co.$$.fragment,n),g(Io.$$.fragment,n),g(Bo.$$.fragment,n),g(Qt.$$.fragment,n),g(Ho.$$.fragment,n),g(Vo.$$.fragment,n),g(Xo.$$.fragment,n),g(Ro.$$.fragment,n),g(Yo.$$.fragment,n),g(Ko.$$.fragment,n),g(Zo.$$.fragment,n),g(Jo.$$.fragment,n),g(Qo.$$.fragment,n),g(es.$$.fragment,n),g(os.$$.fragment,n),g(as.$$.fragment,n),g(rs.$$.fragment,n),g(is.$$.fragment,n),g(ls.$$.fragment,n),g(ds.$$.fragment,n),g(ps.$$.fragment,n),g(cs.$$.fragment,n),g(ms.$$.fragment,n),g(us.$$.fragment,n),g(hs.$$.fragment,n),g(_s.$$.fragment,n),g(fs.$$.fragment,n),g(bs.$$.fragment,n),g(ys.$$.fragment,n),g(ks.$$.fragment,n),g(Ts.$$.fragment,n),g(js.$$.fragment,n),g(yn.$$.fragment,n),g($s.$$.fragment,n),g(Ps.$$.fragment,n),g(Ls.$$.fragment,n),g(Es.$$.fragment,n),g(qs.$$.fragment,n),g(Fs.$$.fragment,n),g(Os.$$.fragment,n),g(Ds.$$.fragment,n),g(zs.$$.fragment,n),g(Gs.$$.fragment,n),g(Ns.$$.fragment,n),g(Cs.$$.fragment,n),g(Is.$$.fragment,n),g(Bs.$$.fragment,n),g(Ws.$$.fragment,n),g(Us.$$.fragment,n),g(Hs.$$.fragment,n),g(Vs.$$.fragment,n),g(Ys.$$.fragment,n),g(Ks.$$.fragment,n),g(Zs.$$.fragment,n),g(Js.$$.fragment,n),g(Qs.$$.fragment,n),g(ea.$$.fragment,n),g(na.$$.fragment,n),g(oa.$$.fragment,n),g(sa.$$.fragment,n),g(ra.$$.fragment,n),g(la.$$.fragment,n),g(ua.$$.fragment,n),g(ga.$$.fragment,n),g(ha.$$.fragment,n),g(_a.$$.fragment,n),g(ba.$$.fragment,n),g(va.$$.fragment,n),g(ya.$$.fragment,n),g(xa.$$.fragment,n),g(ja.$$.fragment,n),g($a.$$.fragment,n),g(Ma.$$.fragment,n),g(Pa.$$.fragment,n),g(Ea.$$.fragment,n),lc=!0)},o(n){h(A.$$.fragment,n),h(Hn.$$.fragment,n),h(Vn.$$.fragment,n),h(Yn.$$.fragment,n),h(Zn.$$.fragment,n),h(Jn.$$.fragment,n),h(Et.$$.fragment,n),h(qt.$$.fragment,n),h(to.$$.fragment,n),h(no.$$.fragment,n),h(oo.$$.fragment,n),h(so.$$.fragment,n),h(ao.$$.fragment,n),h(ro.$$.fragment,n),h(io.$$.fragment,n),h(lo.$$.fragment,n),h(po.$$.fragment,n),h(Gt.$$.fragment,n),h(co.$$.fragment,n),h(go.$$.fragment,n),h(_o.$$.fragment,n),h(fo.$$.fragment,n),h(vo.$$.fragment,n),h(yo.$$.fragment,n),h(ko.$$.fragment,n),h(xo.$$.fragment,n),h(wo.$$.fragment,n),h(To.$$.fragment,n),h($o.$$.fragment,n),h(Mo.$$.fragment,n),h(Po.$$.fragment,n),h(Eo.$$.fragment,n),h(qo.$$.fragment,n),h(Fo.$$.fragment,n),h(Oo.$$.fragment,n),h(Do.$$.fragment,n),h(zo.$$.fragment,n),h(Ao.$$.fragment,n),h(So.$$.fragment,n),h(Co.$$.fragment,n),h(Io.$$.fragment,n),h(Bo.$$.fragment,n),h(Qt.$$.fragment,n),h(Ho.$$.fragment,n),h(Vo.$$.fragment,n),h(Xo.$$.fragment,n),h(Ro.$$.fragment,n),h(Yo.$$.fragment,n),h(Ko.$$.fragment,n),h(Zo.$$.fragment,n),h(Jo.$$.fragment,n),h(Qo.$$.fragment,n),h(es.$$.fragment,n),h(os.$$.fragment,n),h(as.$$.fragment,n),h(rs.$$.fragment,n),h(is.$$.fragment,n),h(ls.$$.fragment,n),h(ds.$$.fragment,n),h(ps.$$.fragment,n),h(cs.$$.fragment,n),h(ms.$$.fragment,n),h(us.$$.fragment,n),h(hs.$$.fragment,n),h(_s.$$.fragment,n),h(fs.$$.fragment,n),h(bs.$$.fragment,n),h(ys.$$.fragment,n),h(ks.$$.fragment,n),h(Ts.$$.fragment,n),h(js.$$.fragment,n),h(yn.$$.fragment,n),h($s.$$.fragment,n),h(Ps.$$.fragment,n),h(Ls.$$.fragment,n),h(Es.$$.fragment,n),h(qs.$$.fragment,n),h(Fs.$$.fragment,n),h(Os.$$.fragment,n),h(Ds.$$.fragment,n),h(zs.$$.fragment,n),h(Gs.$$.fragment,n),h(Ns.$$.fragment,n),h(Cs.$$.fragment,n),h(Is.$$.fragment,n),h(Bs.$$.fragment,n),h(Ws.$$.fragment,n),h(Us.$$.fragment,n),h(Hs.$$.fragment,n),h(Vs.$$.fragment,n),h(Ys.$$.fragment,n),h(Ks.$$.fragment,n),h(Zs.$$.fragment,n),h(Js.$$.fragment,n),h(Qs.$$.fragment,n),h(ea.$$.fragment,n),h(na.$$.fragment,n),h(oa.$$.fragment,n),h(sa.$$.fragment,n),h(ra.$$.fragment,n),h(la.$$.fragment,n),h(ua.$$.fragment,n),h(ga.$$.fragment,n),h(ha.$$.fragment,n),h(_a.$$.fragment,n),h(ba.$$.fragment,n),h(va.$$.fragment,n),h(ya.$$.fragment,n),h(xa.$$.fragment,n),h(ja.$$.fragment,n),h($a.$$.fragment,n),h(Ma.$$.fragment,n),h(Pa.$$.fragment,n),h(Ea.$$.fragment,n),lc=!1},d(n){t(x),n&&t(L),n&&t(T),_(A),n&&t(Op),n&&t(ie),n&&t(Dp),n&&t(nt),n&&t(zp),n&&t(wt),n&&t(Ap),n&&t(B),n&&t(Gp),n&&t(ot),_(Hn),n&&t(Sp),n&&t(w),_(Vn),_(Yn),_(Zn),_(Jn),_(Et),_(qt),_(to),_(no),_(oo),_(so),_(ao),_(ro),_(io),_(lo),_(po),_(Gt),_(co),_(go),_(_o),_(fo),n&&t(Np),n&&t(Ka),n&&t(Cp),n&&t(rt),_(vo),n&&t(Ip),n&&t(de),n&&t(Bp),_(yo,n),n&&t(Wp),n&&t(We),n&&t(Up),_(ko,n),n&&t(Hp),n&&t(It),n&&t(Vp),_(xo,n),n&&t(Xp),n&&t(Za),n&&t(Rp),n&&t(it),_(wo),n&&t(Yp),n&&t(E),_(To),_($o),_(Mo),_(Po),_(Eo),_(qo),_(Fo),_(Oo),_(Do),n&&t(Kp),n&&t(ct),_(zo),n&&t(Zp),n&&t(y),_(Ao),_(So),_(Co),_(Io),_(Bo),_(Qt),_(Ho),_(Vo),_(Xo),_(Ro),_(Yo),_(Ko),_(Zo),_(Jo),_(Qo),_(es),_(os),_(as),_(rs),_(is),_(ls),_(ds),_(ps),_(cs),n&&t(Jp),n&&t(ht),_(ms),n&&t(Qp),n&&t(Pe),_(us),_(hs),n&&t(ec),n&&t(_t),_(_s),n&&t(tc),n&&t(M),_(fs),_(bs),_(ys),_(ks),_(Ts),_(js),_(yn),_($s),_(Ps),_(Ls),_(Es),_(qs),_(Fs),_(Os),n&&t(nc),n&&t(bt),_(Ds),n&&t(oc),n&&t(P),_(zs),_(Gs),_(Ns),_(Cs),_(Is),_(Bs),_(Ws),_(Us),_(Hs),_(Vs),_(Ys),_(Ks),_(Zs),_(Js),_(Qs),_(ea),_(na),_(oa),n&&t(sc),n&&t(G),_(sa),_(ra),_(la),_(ua),_(ga),_(ha),_(_a),_(ba),_(va),n&&t(ac),n&&t(Ee),_(ya),_(xa),_(ja),n&&t(rc),n&&t(kt),_($a),n&&t(ic),n&&t(qe),_(Ma),_(Pa),_(Ea)}}}const f$={local:"models",sections:[{local:"transformers.PreTrainedModel",sections:[{local:"model-instantiation-dtype",title:"Model Instantiation dtype"}],title:"PreTrainedModel"},{local:"transformers.modeling_utils.ModuleUtilsMixin",title:"ModuleUtilsMixin"},{local:"transformers.TFPreTrainedModel",title:"TFPreTrainedModel"},{local:"transformers.modeling_tf_utils.TFModelUtilsMixin",title:"TFModelUtilsMixin"},{local:"transformers.FlaxPreTrainedModel",title:"FlaxPreTrainedModel"},{local:"transformers.generation_utils.GenerationMixin",title:"Generation"},{local:"transformers.file_utils.PushToHubMixin",title:"Pushing to the Hub"}],title:"Models"};function b$(ee,x,L){let{fw:T}=x;return ee.$$set=$=>{"fw"in $&&L(0,T=$.fw)},[T]}class T$ extends i${constructor(x){super();l$(this,x,b$,_$,d$,{fw:0})}}export{T$ as default,f$ as metadata};
