...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var f=a(p);N=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(f,"CODE",{});var G=a(m);k=i(G,"Module"),G.forEach(o),w=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,p,f),e(p,N),e(p,m),e(m,k),e(p,w)},d(g){g&&o(p)}}}function pd(W){let p,N,m,k,w,g,f,G,Xn,cn,ne,ve,lo,Ae,Kn,co,Qn,pn,J,Yn,Ie,Zn,es,Le,ts,os,hn,Ot,ns,un,ye,ss,Se,as,rs,mn,se,be,po,Oe,is,ho,ls,fn,Pe,ds,uo,cs,ps,gn,De,_n,ae,ke,mo,Be,hs,fo,us,Tn,z,We,ms,re,fs,Dt,gs,_s,He,Ts,vs,ys,ie,bs,Bt,Ps,ks,Wt,ws,Ns,$s,go,Gs,xs,Ue,vn,le,we,_o,Ve,Ms,To,Fs,yn,q,Je,Es,vo,zs,qs,Re,js,Ht,Cs,As,Is,Xe,Ls,Ke,Ss,Os,Ds,C,Qe,Bs,de,Ws,Ut,Hs,Us,yo,Vs,Js,Rs,Ne,Xs,bo,Ks,Qs,Ye,bn,ce,$e,Po,Ze,Ys,ko,Zs,Pn,j,et,ea,wo,ta,oa,tt,na,Vt,sa,aa,ra,ot,ia,nt,la,da,ca,A,st,pa,pe,ha,Jt,ua,ma,No,fa,ga,_a,Ge,Ta,$o,va,ya,at,kn,he,xe,Go,rt,ba,xo,Pa,wn,x,it,ka,Mo,wa,Na,Rt,Xt,$a,Ga,xa,B,Ma,Fo,Fa,Ea,Eo,za,qa,zo,ja,Ca,qo,Aa,Ia,La,lt,Sa,Kt,Oa,Da,Ba,dt,Wa,ct,Ha,Ua,Va,$,pt,Ja,ue,Ra,Qt,Xa,Ka,jo,Qa,Ya,Za,Me,er,Co,tr,or,ht,nr,ut,sr,Ao,ar,rr,mt,ir,ft,Nn,me,Fe,Io,gt,lr,Lo,dr,$n,M,_t,cr,So,pr,hr,Tt,ur,Yt,mr,fr,gr,vt,_r,yt,Tr,vr,yr,Oo,br,Pr,H,Do,bt,kr,wr,Bo,Pt,Nr,$r,Wo,kt,Gr,xr,Ho,wt,Mr,Fr,I,Nt,Er,fe,zr,Uo,qr,jr,Vo,Cr,Ar,Ir,Ee,Lr,Jo,Sr,Or,$t,Gn,ge,ze,Ro,Gt,Dr,Xo,Br,xn,F,xt,Wr,Ko,Hr,Ur,Mt,Vr,Zt,Jr,Rr,Xr,Ft,Kr,Et,Qr,Yr,Zr,Qo,ei,ti,U,Yo,zt,oi,ni,Zo,qt,si,ai,en,jt,ri,ii,tn,Ct,li,di,L,At,ci,_e,pi,on,hi,ui,nn,mi,fi,gi,qe,_i,sn,Ti,vi,It,Mn;return g=new Te({}),Ae=new Te({}),Oe=new Te({}),De=new oe({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16354/en/model_doc/gpt_neo#transformers.GPTNeoModel">GPTNeoModel</a>. Vocabulary size of the model. Defines the different
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16354/en/model_doc/gpt_neo#transformers.GPTNeoConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16354/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),st=new V({props:{name:"forward",anchor:"transformers.GPTNeoForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16354/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L712",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
model = GPTNeoForSequenceClassification.from_pretrained(
    "EleutherAI/gpt-neo-1.3B", problem_type="multi_label_classification", num_labels=num_labels
)
...
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;EleutherAI/gpt-neo-1.3B&quot;</span>, problem_type=<span class="hljs-string">&quot;multi_label_classification&quot;</span>, num_labels=num_labels
<span class="hljs-meta">... </span>)
...
and behavior.`),Ds=d(),C=n("div"),_(Qe.$$.fragment),Bs=d(),de=n("p"),Ws=r("The "),Ut=n("a"),Hs=r("GPTNeoModel"),Us=r(" forward method, overrides the "),yo=n("code"),Vs=r("__call__"),Js=r(" special method."),Rs=d(),_(Ne.$$.fragment),Xs=d(),bo=n("p"),Ks=r("Example:"),Qs=d(),_(Ye.$$.fragment),bn=d(),ce=n("h2"),$e=n("a"),Po=n("span"),_(Ze.$$.fragment),Ys=d(),ko=n("span"),Zs=r("GPTNeoForCausalLM"),Pn=d(),j=n("div"),_(et.$$.fragment),ea=d(),wo=n("p"),ta=r(`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
padding tokens when `),zo=n("code"),ja=r("inputs_embeds"),Ca=r(" are passed instead of "),qo=n("code"),Aa=r("input_ids"),Ia=r(`, it does the same (take the last value in
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Va=d(),$=n("div"),_(pt.$$.fragment),Ja=d(),ue=n("p"),Ra=r("The "),Qt=n("a"),Xa=r("GPTNeoForSequenceClassification"),Ka=r(" forward method, overrides the "),jo=n("code"),Qa=r("__call__"),Ya=r(" special method."),Za=d(),_(Me.$$.fragment),er=d(),Co=n("p"),tr=r("Example of single-label classification:"),or=d(),_(ht.$$.fragment),nr=d(),_(ut.$$.fragment),sr=d(),Ao=n("p"),ar=r("Example of multi-label classification:"),rr=d(),_(mt.$$.fragment),ir=d(),_(ft.$$.fragment),Nn=d(),me=n("h2"),Fe=n("a"),Io=n("span"),_(gt.$$.fragment),lr=d(),Lo=n("span"),dr=r("FlaxGPTNeoModel"),$n=d(),M=n("div"),_(_t.$$.fragment),cr=d(),So=n("p"),pr=r("The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),hr=d(),Tt=n("p"),ur=r("This model inherits from "),Yt=n("a"),mr=r("FlaxPreTrainedModel"),fr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gr=d(),vt=n("p"),_r=r(`This model is also a Flax Linen
`),yt=n("a"),Tr=r("flax.nn.Module"),vr=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),yr=d(),Oo=n("p"),br=r("Finally, this model supports inherent JAX features such as:"),Pr=d(),H=n("ul"),Do=n("li"),bt=n("a"),kr=r("Just-In-Time (JIT) compilation"),wr=d(),Bo=n("li"),Pt=n("a"),Nr=r("Automatic Differentiation"),$r=d(),Wo=n("li"),kt=n("a"),Gr=r("Vectorization"),xr=d(),Ho=n("li"),wt=n("a"),Mr=r("Parallelization"),Fr=d(),I=n("div"),_(Nt.$$.fragment),Er=d(),fe=n("p"),zr=r("The "),Uo=n("code"),qr=r("FlaxGPTNeoPreTrainedModel"),jr=r("forward method, overrides the "),Vo=n("code"),Cr=r("__call__"),Ar=r(" special method."),Ir=d(),_(Ee.$$.fragment),Lr=d(),Jo=n("p"),Sr=r("Example:"),Or=d(),_($t.$$.fragment),Gn=d(),ge=n("h2"),ze=n("a"),Ro=n("span"),_(Gt.$$.fragment),Dr=d(),Xo=n("span"),Br=r("FlaxGPTNeoForCausalLM"),xn=d(),F=n("div"),_(xt.$$.fragment),Wr=d(),Ko=n("p"),Hr=r(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
documentation from `),Wt=s(oo,"A",{href:!0});var Li=a(Wt);ws=i(Li,"PretrainedConfig"),Li.forEach(o),Ns=i(oo," for more information."),oo.forEach(o),$s=c(R),go=s(R,"P",{});var Si=a(go);Gs=i(Si,"Example:"),Si.forEach(o),xs=c(R),T(Ue.$$.fragment,R),R.forEach(o),vn=c(t),le=s(t,"H2",{class:!0});var jn=a(le);we=s(jn,"A",{id:!0,class:!0,href:!0});var Oi=a(we);_o=s(Oi,"SPAN",{});var Di=a(_o);T(Ve.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),Ms=c(jn),To=s(jn,"SPAN",{});var Bi=a(To);Fs=i(Bi,"GPTNeoModel"),Bi.forEach(o),jn.forEach(o),yn=c(t),q=s(t,"DIV",{class:!0});var X=a(q);T(Je.$$.fragment,X),Es=c(X),vo=s(X,"P",{});var Wi=a(vo);zs=i(Wi,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),Wi.forEach(o),qs=c(X),Re=s(X,"P",{});var Cn=a(Re);js=i(Cn,"This model inherits from "),Ht=s(Cn,"A",{href:!0});var Hi=a(Ht);Cs=i(Hi,"PreTrainedModel"),Hi.forEach(o),As=i(Cn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cn.forEach(o),Is=c(X),Xe=s(X,"P",{});var An=a(Xe);Ls=i(An,"This model is also a PyTorch "),Ke=s(An,"A",{href:!0,rel:!0});var Ui=a(Ke);Ss=i(Ui,"torch.nn.Module"),Ui.forEach(o),Os=i(An,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),An.forEach(o),Ds=c(X),C=s(X,"DIV",{class:!0});var K=a(C);T(Qe.$$.fragment,K),Bs=c(K),de=s(K,"P",{});var no=a(de);Ws=i(no,"The "),Ut=s(no,"A",{href:!0});var Vi=a(Ut);Hs=i(Vi,"GPTNeoModel"),Vi.forEach(o),Us=i(no," forward method, overrides the "),yo=s(no,"CODE",{});var Ji=a(yo);Vs=i(Ji,"__call__"),Ji.forEach(o),Js=i(no," special method."),no.forEach(o),Rs=c(K),T(Ne.$$.fragment,K),Xs=c(K),bo=s(K,"P",{});var Ri=a(bo);Ks=i(Ri,"Example:"),Ri.forEach(o),Qs=c(K),T(Ye.$$.fragment,K),K.forEach(o),X.forEach(o),bn=c(t),ce=s(t,"H2",{class:!0});var In=a(ce);$e=s(In,"A",{id:!0,class:!0,href:!0});var Xi=a($e);Po=s(Xi,"SPAN",{});var Ki=a(Po);T(Ze.$$.fragment,Ki),Ki.forEach(o),Xi.forEach(o),Ys=c(In),ko=s(In,"SPAN",{});var Qi=a(ko);Zs=i(Qi,"GPTNeoForCausalLM"),Qi.forEach(o),In.forEach(o),Pn=c(t),j=s(t,"DIV",{class:!0});var Q=a(j);T(et.$$.fragment,Q),ea=c(Q),wo=s(Q,"P",{});var Yi=a(wo);ta=i(Yi,`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
padding tokens when `),zo=s(Z,"CODE",{});var pl=a(zo);ja=i(pl,"inputs_embeds"),pl.forEach(o),Ca=i(Z," are passed instead of "),qo=s(Z,"CODE",{});var hl=a(qo);Aa=i(hl,"input_ids"),hl.forEach(o),Ia=i(Z,`, it does the same (take the last value in
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Un.forEach(o),yr=c(O),Oo=s(O,"P",{});var Nl=a(Oo);br=i(Nl,"Finally, this model supports inherent JAX features such as:"),Nl.forEach(o),Pr=c(O),H=s(O,"UL",{});var je=a(H);Do=s(je,"LI",{});var $l=a(Do);bt=s($l,"A",{href:!0,rel:!0});var Gl=a(bt);kr=i(Gl,"Just-In-Time (JIT) compilation"),Gl.forEach(o),$l.forEach(o),wr=c(je),Bo=s(je,"LI",{});var xl=a(Bo);Pt=s(xl,"A",{href:!0,rel:!0});var Ml=a(Pt);Nr=i(Ml,"Automatic Differentiation"),Ml.forEach(o),xl.forEach(o),$r=c(je),Wo=s(je,"LI",{});var Fl=a(Wo);kt=s(Fl,"A",{href:!0,rel:!0});var El=a(kt);Gr=i(El,"Vectorization"),El.forEach(o),Fl.forEach(o),xr=c(je),Ho=s(je,"LI",{});var zl=a(Ho);wt=s(zl,"A",{href:!0,rel:!0});var ql=a(wt);Mr=i(ql,"Parallelization"),ql.forEach(o),zl.forEach(o),je.forEach(o),Fr=c(O),I=s(O,"DIV",{class:!0});var ee=a(I);T(Nt.$$.fragment,ee),Er=c(ee),fe=s(ee,"P",{});var ro=a(fe);zr=i(ro,"The "),Uo=s(ro,"CODE",{});var jl=a(Uo);qr=i(jl,"FlaxGPTNeoPreTrainedModel"),jl.forEach(o),jr=i(ro,"forward method, overrides the "),Vo=s(ro,"CODE",{});var Cl=a(Vo);Cr=i(Cl,"__call__"),Cl.forEach(o),Ar=i(ro," special method."),ro.forEach(o),Ir=c(ee),T(Ee.$$.fragment,ee),Lr=c(ee),Jo=s(ee,"P",{});var Al=a(Jo);Sr=i(Al,"Example:"),Al.forEach(o),Or=c(ee),T($t.$$.fragment,ee),ee.forEach(o),O.forEach(o),Gn=c(t),ge=s(t,"H2",{class:!0});var Vn=a(ge);ze=s(Vn,"A",{id:!0,class:!0,href:!0});var Il=a(ze);Ro=s(Il,"SPAN",{});var Ll=a(Ro);T(Gt.$$.fragment,Ll),Ll.forEach(o),Il.forEach(o),Dr=c(Vn),Xo=s(Vn,"SPAN",{});var Sl=a(Xo);Br=i(Sl,"FlaxGPTNeoForCausalLM"),Sl.forEach(o),Vn.forEach(o),xn=c(t),F=s(t,"DIV",{class:!0});var D=a(F);T(xt.$$.fragment,D),Wr=c(D),Ko=s(D,"P",{});var Ol=a(Ko);Hr=i(Ol,`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
