import{S as eg,i as tg,s as og,e as a,k as l,w as k,t as n,M as ng,c as r,d as t,m as d,a as i,x as b,h as s,b as c,F as e,g as u,y as w,q as y,o as P,B as $,v as sg}from"../../chunks/vendor-6b77c823.js";import{T as Ke}from"../../chunks/Tip-39098574.js";import{D as re}from"../../chunks/Docstring-abef54e3.js";import{C as he}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Xe}from"../../chunks/IconCopyLink-7a11ce68.js";function ag(I){let p,F,f,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),v=n(`
...
`),S=r(D,"CODE",{});var Ne=i(S);Te=s(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ce=s(D," or "),N=r(D,"CODE",{});var be=i(N);W=s(be,"model([input_ids, attention_mask, token_type_ids])"),be.forEach(t),D.forEach(t),ve=d(C),q=r(C,"LI",{});var we=i(q);ke=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function vg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,B,fe,ie,L,A,ee,te,J,x,ge,U,le,Y,H,oe,_e,M,de,S,Te,ce,N,W,ve,q,ke,R,se,h,G,V,Ae,Ie,z,Le,Se,xe,C,Q,pe,Fe,D,Ne,be,we,De,Ks,pt,Ai,Jo,Ii,Li,Xs,Si,Ni,Ys,Di,Oi,Mr,$t,Kt,Zs,xo,Bi,ea,Wi,qr,Xt,Qi,ms,Ui,Hi,zr,Mo,Cr,fs,Ri,Ar,qo,Ir,Ft,Yt,ta,zo,Vi,oa,Ki,Lr,Ye,Co,Xi,Ze,Yi,gs,Zi,el,Ao,tl,ol,_s,nl,sl,Ts,al,rl,il,na,ll,dl,Io,Sr,jt,Zt,sa,Lo,cl,aa,pl,Nr,ht,So,hl,No,ul,Do,ml,fl,gl,Oe,Oo,_l,Gt,Tl,vs,vl,kl,ra,bl,wl,yl,eo,Pl,ia,$l,Fl,Bo,Dr,Et,to,la,Wo,jl,da,Gl,Or,et,Qo,El,ca,Jl,xl,Uo,Ml,Ho,ql,zl,Cl,Be,Ro,Al,Jt,Il,ks,Ll,Sl,pa,Nl,Dl,Ol,oo,Bl,ha,Wl,Ql,Vo,Br,xt,no,ua,Ko,Ul,ma,Hl,Wr,je,Xo,Rl,fa,Vl,Kl,bs,ws,Xl,Yl,Zl,tt,ed,ga,td,od,_a,nd,sd,Ta,ad,rd,va,id,ld,dd,Yo,cd,Zo,pd,hd,ud,ne,en,md,Mt,fd,ys,gd,_d,ka,Td,vd,kd,so,bd,ba,wd,yd,tn,Pd,on,$d,wa,Fd,jd,nn,Gd,sn,Qr,qt,ao,ya,an,Ed,Pa,Jd,Ur,ot,rn,xd,zt,Md,$a,qd,zd,Fa,Cd,Ad,Id,ln,Ld,dn,Sd,Nd,Dd,Me,cn,Od,Ct,Bd,Ps,Wd,Qd,ja,Ud,Hd,Rd,ro,Vd,Ga,Kd,Xd,pn,Yd,hn,Hr,At,io,Ea,un,Zd,Ja,ec,Rr,Ge,mn,tc,xa,oc,nc,fn,sc,$s,ac,rc,ic,gn,lc,_n,dc,cc,pc,lo,hc,We,Tn,uc,It,mc,Fs,fc,gc,Ma,_c,Tc,vc,co,kc,qa,bc,wc,vn,Vr,Lt,po,za,kn,yc,Ca,Pc,Kr,Ee,bn,$c,Aa,Fc,jc,wn,Gc,js,Ec,Jc,xc,yn,Mc,Pn,qc,zc,Cc,ho,Ac,Qe,$n,Ic,St,Lc,Gs,Sc,Nc,Ia,Dc,Oc,Bc,uo,Wc,La,Qc,Uc,Fn,Xr,Nt,mo,Sa,jn,Hc,Na,Rc,Yr,ae,Gn,Vc,Da,Kc,Xc,Es,Js,Yc,Zc,ep,nt,tp,Oa,op,np,Ba,sp,ap,Wa,rp,ip,Qa,lp,dp,cp,En,pp,xs,hp,up,mp,Jn,fp,xn,gp,_p,Tp,fo,vp,qe,Mn,kp,Dt,bp,Ms,wp,yp,Ua,Pp,$p,Fp,go,jp,Ha,Gp,Ep,qn,Jp,zn,Zr,Ot,_o,Ra,Cn,xp,Va,Mp,ei,Je,An,qp,Bt,zp,Ka,Cp,Ap,Xa,Ip,Lp,Sp,In,Np,qs,Dp,Op,Bp,Ln,Wp,Sn,Qp,Up,Hp,To,Rp,ze,Nn,Vp,Wt,Kp,zs,Xp,Yp,Ya,Zp,eh,th,vo,oh,Za,nh,sh,Dn,ah,On,ti,Qt,ko,er,Bn,rh,tr,ih,oi,ye,Wn,lh,or,dh,ch,Qn,ph,Cs,hh,uh,mh,Un,fh,Hn,gh,_h,Th,nr,vh,kh,ut,sr,Rn,bh,wh,ar,Vn,yh,Ph,rr,Kn,$h,Fh,ir,Xn,jh,Gh,Ue,Yn,Eh,Ut,Jh,lr,xh,Mh,dr,qh,zh,Ch,bo,Ah,cr,Ih,Lh,Zn,ni,Ht,wo,pr,es,Sh,hr,Nh,si,Pe,ts,Dh,ur,Oh,Bh,os,Wh,As,Qh,Uh,Hh,ns,Rh,ss,Vh,Kh,Xh,mr,Yh,Zh,mt,fr,as,eu,tu,gr,rs,ou,nu,_r,is,su,au,Tr,ls,ru,iu,He,ds,lu,Rt,du,vr,cu,pu,kr,hu,uu,mu,yo,fu,br,gu,_u,cs,ai;return T=new Xe({}),Z=new Xe({}),C=new he({props:{code:`from transformers import GPTJForCausalLM
import torch
...
configuration. Check out the <a href="/docs/transformers/pr_16354/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oo=new re({props:{name:"forward",anchor:"transformers.GPTJModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16354/src/transformers/models/gptj/modeling_gptj.py#L505",parametersDescription:[{anchor:"transformers.GPTJModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16354/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new re({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16354/src/transformers/models/gptj/modeling_gptj.py#L758",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model = GPTJForSequenceClassification.from_pretrained(
    "EleutherAI/gpt-j-6B", problem_type="multi_label_classification", num_labels=num_labels
)
...
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;EleutherAI/gpt-j-6B&quot;</span>, problem_type=<span class="hljs-string">&quot;multi_label_classification&quot;</span>, num_labels=num_labels
<span class="hljs-meta">... </span>)
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),bo=new Ke({props:{$$slots:{default:[_g]},$$scope:{ctx:I}}}),Zn=new he({props:{code:`from transformers import GPTJTokenizer, FlaxGPTJModel
...
that could be found `),be=a("a"),we=n("here"),De=l(),Ks=a("li"),pt=a("p"),Ai=n(`Although the embedding matrix has a size of 50400, only 50257 entries are used by the GPT-2 tokenizer. These extra
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ud=l(),ne=a("div"),k(en.$$.fragment),md=l(),Mt=a("p"),fd=n("The "),ys=a("a"),gd=n("GPTJForSequenceClassification"),_d=n(" forward method, overrides the "),ka=a("code"),Td=n("__call__"),vd=n(" special method."),kd=l(),k(so.$$.fragment),bd=l(),ba=a("p"),wd=n("Example of single-label classification:"),yd=l(),k(tn.$$.fragment),Pd=l(),k(on.$$.fragment),$d=l(),wa=a("p"),Fd=n("Example of multi-label classification:"),jd=l(),k(nn.$$.fragment),Gd=l(),k(sn.$$.fragment),Qr=l(),qt=a("h2"),ao=a("a"),ya=a("span"),k(an.$$.fragment),Ed=l(),Pa=a("span"),Jd=n("GPTJForQuestionAnswering"),Ur=l(),ot=a("div"),k(rn.$$.fragment),xd=l(),zt=a("p"),Md=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp=l(),k(fo.$$.fragment),vp=l(),qe=a("div"),k(Mn.$$.fragment),kp=l(),Dt=a("p"),bp=n("The "),Ms=a("a"),wp=n("TFGPTJForSequenceClassification"),yp=n(" forward method, overrides the "),Ua=a("code"),Pp=n("__call__"),$p=n(" special method."),Fp=l(),k(go.$$.fragment),jp=l(),Ha=a("p"),Gp=n("Example:"),Ep=l(),k(qn.$$.fragment),Jp=l(),k(zn.$$.fragment),Zr=l(),Ot=a("h2"),_o=a("a"),Ra=a("span"),k(Cn.$$.fragment),xp=l(),Va=a("span"),Mp=n("TFGPTJForQuestionAnswering"),ei=l(),Je=a("div"),k(An.$$.fragment),qp=l(),Bt=a("p"),zp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Th=l(),nr=a("p"),vh=n("Finally, this model supports inherent JAX features such as:"),kh=l(),ut=a("ul"),sr=a("li"),Rn=a("a"),bh=n("Just-In-Time (JIT) compilation"),wh=l(),ar=a("li"),Vn=a("a"),yh=n("Automatic Differentiation"),Ph=l(),rr=a("li"),Kn=a("a"),$h=n("Vectorization"),Fh=l(),ir=a("li"),Xn=a("a"),jh=n("Parallelization"),Gh=l(),Ue=a("div"),k(Yn.$$.fragment),Eh=l(),Ut=a("p"),Jh=n("The "),lr=a("code"),xh=n("FlaxGPTJPreTrainedModel"),Mh=n("forward method, overrides the "),dr=a("code"),qh=n("__call__"),zh=n(" special method."),Ch=l(),k(bo.$$.fragment),Ah=l(),cr=a("p"),Ih=n("Example:"),Lh=l(),k(Zn.$$.fragment),ni=l(),Ht=a("h2"),wo=a("a"),pr=a("span"),k(es.$$.fragment),Sh=l(),hr=a("span"),Nh=n("FlaxGPTJForCausalLM"),si=l(),Pe=a("div"),k(ts.$$.fragment),Dh=l(),ur=a("p"),Oh=n("The GPTJ Model transformer with a language modeling head on top."),Bh=l(),os=a("p"),Wh=n("This model inherits from "),As=a("a"),Qh=n("FlaxPreTrainedModel"),Uh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh=l(),ns=a("p"),Rh=n(`This model is also a Flax Linen
`),ss=a("a"),Vh=n("flax.nn.Module"),Kh=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Xh=l(),mr=a("p"),Yh=n("Finally, this model supports inherent JAX features such as:"),Zh=l(),mt=a("ul"),fr=a("li"),as=a("a"),eu=n("Just-In-Time (JIT) compilation"),tu=l(),gr=a("li"),rs=a("a"),ou=n("Automatic Differentiation"),nu=l(),_r=a("li"),is=a("a"),su=n("Vectorization"),au=l(),Tr=a("li"),ls=a("a"),ru=n("Parallelization"),iu=l(),He=a("div"),k(ds.$$.fragment),lu=l(),Rt=a("p"),du=n("The "),vr=a("code"),cu=n("FlaxGPTJPreTrainedModel"),pu=n("forward method, overrides the "),kr=a("code"),hu=n("__call__"),uu=n(" special method."),mu=l(),k(yo.$$.fragment),fu=l(),br=a("p"),gu=n("Example:"),_u=l(),k(cs.$$.fragment),this.h()},l(o){const m=ng('[data-svelte="svelte-1phssyn"]',document.head);p=r(m,"META",{name:!0,content:!0}),m.forEach(t),F=d(o),f=r(o,"H1",{class:!0});var ps=i(f);_=r(ps,"A",{id:!0,class:!0,href:!0});var wr=i(_);v=r(wr,"SPAN",{});var yr=i(v);b(T.$$.fragment,yr),yr.forEach(t),wr.forEach(t),g=d(ps),j=r(ps,"SPAN",{});var Pr=i(j);ue=s(Pr,"GPT-J"),Pr.forEach(t),ps.forEach(t),K=d(o),E=r(o,"H2",{class:!0});var hs=i(E);X=r(hs,"A",{id:!0,class:!0,href:!0});var $r=i(X);O=r($r,"SPAN",{});var Fr=i(O);b(Z.$$.fragment,Fr),Fr.forEach(t),$r.forEach(t),me=d(hs),B=r(hs,"SPAN",{});var jr=i(B);fe=s(jr,"Overview"),jr.forEach(t),hs.forEach(t),ie=d(o),L=r(o,"P",{});var Vt=i(L);A=s(Vt,"The GPT-J model was released in the "),ee=r(Vt,"A",{href:!0,rel:!0});var Gr=i(ee);te=s(Gr,"kingoflolz/mesh-transformer-jax"),Gr.forEach(t),J=s(Vt,` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),x=r(Vt,"A",{href:!0,rel:!0});var Er=i(x);ge=s(Er,"the Pile"),Er.forEach(t),U=s(Vt," dataset."),Vt.forEach(t),le=d(o),Y=r(o,"P",{});var us=i(Y);H=s(us,"This model was contributed by "),oe=r(us,"A",{href:!0,rel:!0});var Jr=i(oe);_e=s(Jr,"Stella Biderman"),Jr.forEach(t),M=s(us,"."),us.forEach(t),de=d(o),S=r(o,"P",{});var xr=i(S);Te=s(xr,"Tips:"),xr.forEach(t),ce=d(o),N=r(o,"UL",{});var bu=i(N);W=r(bu,"LI",{});var ft=i(W);ve=s(ft,"To load "),q=r(ft,"A",{href:!0,rel:!0});var wu=i(q);ke=s(wu,"GPT-J"),wu.forEach(t),R=s(ft,` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
...
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),ft.forEach(t),bu.forEach(t),xe=d(o),b(C.$$.fragment,o),Q=d(o),pe=r(o,"UL",{});var ri=i(pe);Fe=r(ri,"LI",{});var Fu=i(Fe);D=r(Fu,"P",{});var Tu=i(D);Ne=s(Tu,`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
optimizer for example makes four copies of the model: model, gradients, average and squared average of the gradients.
So it would need at least 4x model size GPU memory, even with mixed precision as gradient updates are in fp32. This
is not including the activations and data batches, which would again require some more GPU RAM. So one should explore
solutions such as DeepSpeed, to train/fine-tune the model. Another option is to use the original codebase to
train/fine-tune the model on TPU and then convert the model to Transformers format for inference. Instructions for
that could be found `),be=r(Tu,"A",{href:!0,rel:!0});var ju=i(be);we=s(ju,"here"),ju.forEach(t),Tu.forEach(t),Fu.forEach(t),De=d(ri),Ks=r(ri,"LI",{});var Gu=i(Ks);pt=r(Gu,"P",{});var Po=i(pt);Ai=s(Po,`Although the embedding matrix has a size of 50400, only 50257 entries are used by the GPT-2 tokenizer. These extra
tokens are added for the sake of efficiency on TPUs. To avoid the mis-match between embedding matrix size and vocab
size, the tokenizer for `),Jo=r(Po,"A",{href:!0,rel:!0});var Eu=i(Jo);Ii=s(Eu,"GPT-J"),Eu.forEach(t),Li=s(Po,` contains 143 extra tokens
`),Xs=r(Po,"CODE",{});var Ju=i(Xs);Si=s(Ju,"<|extratoken_1|>... <|extratoken_143|>"),Ju.forEach(t),Ni=s(Po,", so the "),Ys=r(Po,"CODE",{});var xu=i(Ys);Di=s(xu,"vocab_size"),xu.forEach(t),Oi=s(Po," of tokenizer also becomes 50400."),Po.forEach(t),Gu.forEach(t),ri.forEach(t),Mr=d(o),$t=r(o,"H3",{class:!0});var ii=i($t);Kt=r(ii,"A",{id:!0,class:!0,href:!0});var Mu=i(Kt);Zs=r(Mu,"SPAN",{});var qu=i(Zs);b(xo.$$.fragment,qu),qu.forEach(t),Mu.forEach(t),Bi=d(ii),ea=r(ii,"SPAN",{});var zu=i(ea);Wi=s(zu,"Generation"),zu.forEach(t),ii.forEach(t),qr=d(o),Xt=r(o,"P",{});var li=i(Xt);Qi=s(li,"The "),ms=r(li,"A",{href:!0});var Cu=i(ms);Ui=s(Cu,"generate()"),Cu.forEach(t),Hi=s(li,` method can be used to generate text using GPT-J
model.`),li.forEach(t),zr=d(o),b(Mo.$$.fragment,o),Cr=d(o),fs=r(o,"P",{});var Au=i(fs);Ri=s(Au,"\u2026or in float16 precision:"),Au.forEach(t),Ar=d(o),b(qo.$$.fragment,o),Ir=d(o),Ft=r(o,"H2",{class:!0});var di=i(Ft);Yt=r(di,"A",{id:!0,class:!0,href:!0});var Iu=i(Yt);ta=r(Iu,"SPAN",{});var Lu=i(ta);b(zo.$$.fragment,Lu),Lu.forEach(t),Iu.forEach(t),Vi=d(di),oa=r(di,"SPAN",{});var Su=i(oa);Ki=s(Su,"GPTJConfig"),Su.forEach(t),di.forEach(t),Lr=d(o),Ye=r(o,"DIV",{class:!0});var $o=i(Ye);b(Co.$$.fragment,$o),Xi=d($o),Ze=r($o,"P",{});var gt=i(Ze);Yi=s(gt,"This is the configuration class to store the configuration of a "),gs=r(gt,"A",{href:!0});var Nu=i(gs);Zi=s(Nu,"GPTJModel"),Nu.forEach(t),el=s(gt,`. It is used to instantiate a GPT-J
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the GPT-J
...
for more information.`),gt.forEach(t),il=d($o),na=r($o,"P",{});var Wu=i(na);ll=s(Wu,"Example:"),Wu.forEach(t),dl=d($o),b(Io.$$.fragment,$o),$o.forEach(t),Sr=d(o),jt=r(o,"H2",{class:!0});var ci=i(jt);Zt=r(ci,"A",{id:!0,class:!0,href:!0});var Qu=i(Zt);sa=r(Qu,"SPAN",{});var Uu=i(sa);b(Lo.$$.fragment,Uu),Uu.forEach(t),Qu.forEach(t),cl=d(ci),aa=r(ci,"SPAN",{});var Hu=i(aa);pl=s(Hu,"GPTJModel"),Hu.forEach(t),ci.forEach(t),Nr=d(o),ht=r(o,"DIV",{class:!0});var Is=i(ht);b(So.$$.fragment,Is),hl=d(Is),No=r(Is,"P",{});var pi=i(No);ul=s(pi,`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Do=r(pi,"A",{href:!0,rel:!0});var Ru=i(Do);ml=s(Ru,"torch.nn.Module"),Ru.forEach(t),fl=s(pi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),pi.forEach(t),gl=d(Is),Oe=r(Is,"DIV",{class:!0});var _t=i(Oe);b(Oo.$$.fragment,_t),_l=d(_t),Gt=r(_t,"P",{});var Ls=i(Gt);Tl=s(Ls,"The "),vs=r(Ls,"A",{href:!0});var Vu=i(vs);vl=s(Vu,"GPTJModel"),Vu.forEach(t),kl=s(Ls," forward method, overrides the "),ra=r(Ls,"CODE",{});var Ku=i(ra);bl=s(Ku,"__call__"),Ku.forEach(t),wl=s(Ls," special method."),Ls.forEach(t),yl=d(_t),b(eo.$$.fragment,_t),Pl=d(_t),ia=r(_t,"P",{});var Xu=i(ia);$l=s(Xu,"Example:"),Xu.forEach(t),Fl=d(_t),b(Bo.$$.fragment,_t),_t.forEach(t),Is.forEach(t),Dr=d(o),Et=r(o,"H2",{class:!0});var hi=i(Et);to=r(hi,"A",{id:!0,class:!0,href:!0});var Yu=i(to);la=r(Yu,"SPAN",{});var Zu=i(la);b(Wo.$$.fragment,Zu),Zu.forEach(t),Yu.forEach(t),jl=d(hi),da=r(hi,"SPAN",{});var em=i(da);Gl=s(em,"GPTJForCausalLM"),em.forEach(t),hi.forEach(t),Or=d(o),et=r(o,"DIV",{class:!0});var Fo=i(et);b(Qo.$$.fragment,Fo),El=d(Fo),ca=r(Fo,"P",{});var tm=i(ca);Jl=s(tm,"The GPT-J Model transformer with a language modeling head on top."),tm.forEach(t),xl=d(Fo),Uo=r(Fo,"P",{});var ui=i(Uo);Ml=s(ui,"This model is a PyTorch "),Ho=r(ui,"A",{href:!0,rel:!0});var om=i(Ho);ql=s(om,"torch.nn.Module"),om.forEach(t),zl=s(ui,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ui.forEach(t),Cl=d(Fo),Be=r(Fo,"DIV",{class:!0});var Tt=i(Be);b(Ro.$$.fragment,Tt),Al=d(Tt),Jt=r(Tt,"P",{});var Ss=i(Jt);Il=s(Ss,"The "),ks=r(Ss,"A",{href:!0});var nm=i(ks);Ll=s(nm,"GPTJForCausalLM"),nm.forEach(t),Sl=s(Ss," forward method, overrides the "),pa=r(Ss,"CODE",{});var sm=i(pa);Nl=s(sm,"__call__"),sm.forEach(t),Dl=s(Ss," special method."),Ss.forEach(t),Ol=d(Tt),b(oo.$$.fragment,Tt),Bl=d(Tt),ha=r(Tt,"P",{});var am=i(ha);Wl=s(am,"Example:"),am.forEach(t),Ql=d(Tt),b(Vo.$$.fragment,Tt),Tt.forEach(t),Fo.forEach(t),Br=d(o),xt=r(o,"H2",{class:!0});var mi=i(xt);no=r(mi,"A",{id:!0,class:!0,href:!0});var rm=i(no);ua=r(rm,"SPAN",{});var im=i(ua);b(Ko.$$.fragment,im),im.forEach(t),rm.forEach(t),Ul=d(mi),ma=r(mi,"SPAN",{});var lm=i(ma);Hl=s(lm,"GPTJForSequenceClassification"),lm.forEach(t),mi.forEach(t),Wr=d(o),je=r(o,"DIV",{class:!0});var st=i(je);b(Xo.$$.fragment,st),Rl=d(st),fa=r(st,"P",{});var dm=i(fa);Vl=s(dm,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),dm.forEach(t),Kl=d(st),bs=r(st,"P",{});var vu=i(bs);ws=r(vu,"A",{href:!0});var cm=i(ws);Xl=s(cm,"GPTJForSequenceClassification"),cm.forEach(t),Yl=s(vu,` uses the last token in order to do the classification, as other causal models
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fi.forEach(t),ud=d(st),ne=r(st,"DIV",{class:!0});var $e=i(ne);b(en.$$.fragment,$e),md=d($e),Mt=r($e,"P",{});var Ns=i(Mt);fd=s(Ns,"The "),ys=r(Ns,"A",{href:!0});var gm=i(ys);gd=s(gm,"GPTJForSequenceClassification"),gm.forEach(t),_d=s(Ns," forward method, overrides the "),ka=r(Ns,"CODE",{});var _m=i(ka);Td=s(_m,"__call__"),_m.forEach(t),vd=s(Ns," special method."),Ns.forEach(t),kd=d($e),b(so.$$.fragment,$e),bd=d($e),ba=r($e,"P",{});var Tm=i(ba);wd=s(Tm,"Example of single-label classification:"),Tm.forEach(t),yd=d($e),b(tn.$$.fragment,$e),Pd=d($e),b(on.$$.fragment,$e),$d=d($e),wa=r($e,"P",{});var vm=i(wa);Fd=s(vm,"Example of multi-label classification:"),vm.forEach(t),jd=d($e),b(nn.$$.fragment,$e),Gd=d($e),b(sn.$$.fragment,$e),$e.forEach(t),st.forEach(t),Qr=d(o),qt=r(o,"H2",{class:!0});var gi=i(qt);ao=r(gi,"A",{id:!0,class:!0,href:!0});var km=i(ao);ya=r(km,"SPAN",{});var bm=i(ya);b(an.$$.fragment,bm),bm.forEach(t),km.forEach(t),Ed=d(gi),Pa=r(gi,"SPAN",{});var wm=i(Pa);Jd=s(wm,"GPTJForQuestionAnswering"),wm.forEach(t),gi.forEach(t),Ur=d(o),ot=r(o,"DIV",{class:!0});var jo=i(ot);b(rn.$$.fragment,jo),xd=d(jo),zt=r(jo,"P",{});var Ds=i(zt);Md=s(Ds,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_i.forEach(t),Dd=d(jo),Me=r(jo,"DIV",{class:!0});var at=i(Me);b(cn.$$.fragment,at),Od=d(at),Ct=r(at,"P",{});var Os=i(Ct);Bd=s(Os,"The "),Ps=r(Os,"A",{href:!0});var Fm=i(Ps);Wd=s(Fm,"GPTJForQuestionAnswering"),Fm.forEach(t),Qd=s(Os," forward method, overrides the "),ja=r(Os,"CODE",{});var jm=i(ja);Ud=s(jm,"__call__"),jm.forEach(t),Hd=s(Os," special method."),Os.forEach(t),Rd=d(at),b(ro.$$.fragment,at),Vd=d(at),Ga=r(at,"P",{});var Gm=i(Ga);Kd=s(Gm,"Example:"),Gm.forEach(t),Xd=d(at),b(pn.$$.fragment,at),Yd=d(at),b(hn.$$.fragment,at),at.forEach(t),jo.forEach(t),Hr=d(o),At=r(o,"H2",{class:!0});var Ti=i(At);io=r(Ti,"A",{id:!0,class:!0,href:!0});var Em=i(io);Ea=r(Em,"SPAN",{});var Jm=i(Ea);b(un.$$.fragment,Jm),Jm.forEach(t),Em.forEach(t),Zd=d(Ti),Ja=r(Ti,"SPAN",{});var xm=i(Ja);ec=s(xm,"TFGPTJModel"),xm.forEach(t),Ti.forEach(t),Rr=d(o),Ge=r(o,"DIV",{class:!0});var rt=i(Ge);b(mn.$$.fragment,rt),tc=d(rt),xa=r(rt,"P",{});var Mm=i(xa);oc=s(Mm,"The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Mm.forEach(t),nc=d(rt),fn=r(rt,"P",{});var vi=i(fn);sc=s(vi,"This model inherits from "),$s=r(vi,"A",{href:!0});var qm=i($s);ac=s(qm,"TFPreTrainedModel"),qm.forEach(t),rc=s(vi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ki.forEach(t),pc=d(rt),b(lo.$$.fragment,rt),hc=d(rt),We=r(rt,"DIV",{class:!0});var kt=i(We);b(Tn.$$.fragment,kt),uc=d(kt),It=r(kt,"P",{});var Bs=i(It);mc=s(Bs,"The "),Fs=r(Bs,"A",{href:!0});var Cm=i(Fs);fc=s(Cm,"TFGPTJModel"),Cm.forEach(t),gc=s(Bs," forward method, overrides the "),Ma=r(Bs,"CODE",{});var Am=i(Ma);_c=s(Am,"__call__"),Am.forEach(t),Tc=s(Bs," special method."),Bs.forEach(t),vc=d(kt),b(co.$$.fragment,kt),kc=d(kt),qa=r(kt,"P",{});var Im=i(qa);bc=s(Im,"Example:"),Im.forEach(t),wc=d(kt),b(vn.$$.fragment,kt),kt.forEach(t),rt.forEach(t),Vr=d(o),Lt=r(o,"H2",{class:!0});var bi=i(Lt);po=r(bi,"A",{id:!0,class:!0,href:!0});var Lm=i(po);za=r(Lm,"SPAN",{});var Sm=i(za);b(kn.$$.fragment,Sm),Sm.forEach(t),Lm.forEach(t),yc=d(bi),Ca=r(bi,"SPAN",{});var Nm=i(Ca);Pc=s(Nm,"TFGPTJForCausalLM"),Nm.forEach(t),bi.forEach(t),Kr=d(o),Ee=r(o,"DIV",{class:!0});var it=i(Ee);b(bn.$$.fragment,it),$c=d(it),Aa=r(it,"P",{});var Dm=i(Aa);Fc=s(Dm,"The GPT-J Model transformer with a language modeling head on top."),Dm.forEach(t),jc=d(it),wn=r(it,"P",{});var wi=i(wn);Gc=s(wi,"This model inherits from "),js=r(wi,"A",{href:!0});var Om=i(js);Ec=s(Om,"TFPreTrainedModel"),Om.forEach(t),Jc=s(wi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wi.forEach(t),xc=d(it),yn=r(it,"P",{});var yi=i(yn);Mc=s(yi,"This model is also a "),Pn=r(yi,"A",{href:!0,rel:!0});var Bm=i(Pn);qc=s(Bm,"tf.keras.Model"),Bm.forEach(t),zc=s(yi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yi.forEach(t),Cc=d(it),b(ho.$$.fragment,it),Ac=d(it),Qe=r(it,"DIV",{class:!0});var bt=i(Qe);b($n.$$.fragment,bt),Ic=d(bt),St=r(bt,"P",{});var Ws=i(St);Lc=s(Ws,"The "),Gs=r(Ws,"A",{href:!0});var Wm=i(Gs);Sc=s(Wm,"TFGPTJForCausalLM"),Wm.forEach(t),Nc=s(Ws," forward method, overrides the "),Ia=r(Ws,"CODE",{});var Qm=i(Ia);Dc=s(Qm,"__call__"),Qm.forEach(t),Oc=s(Ws," special method."),Ws.forEach(t),Bc=d(bt),b(uo.$$.fragment,bt),Wc=d(bt),La=r(bt,"P",{});var Um=i(La);Qc=s(Um,"Example:"),Um.forEach(t),Uc=d(bt),b(Fn.$$.fragment,bt),bt.forEach(t),it.forEach(t),Xr=d(o),Nt=r(o,"H2",{class:!0});var Pi=i(Nt);mo=r(Pi,"A",{id:!0,class:!0,href:!0});var Hm=i(mo);Sa=r(Hm,"SPAN",{});var Rm=i(Sa);b(jn.$$.fragment,Rm),Rm.forEach(t),Hm.forEach(t),Hc=d(Pi),Na=r(Pi,"SPAN",{});var Vm=i(Na);Rc=s(Vm,"TFGPTJForSequenceClassification"),Vm.forEach(t),Pi.forEach(t),Yr=d(o),ae=r(o,"DIV",{class:!0});var Ce=i(ae);b(Gn.$$.fragment,Ce),Vc=d(Ce),Da=r(Ce,"P",{});var Km=i(Da);Kc=s(Km,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Km.forEach(t),Xc=d(Ce),Es=r(Ce,"P",{});var ku=i(Es);Js=r(ku,"A",{href:!0});var Xm=i(Js);Yc=s(Xm,"GPTJForSequenceClassification"),Xm.forEach(t),Zc=s(ku,` uses the last token in order to do the classification, as other causal models
(e.g. GPT, GPT-2, GPT-Neo) do.`),ku.forEach(t),ep=d(Ce),nt=r(Ce,"P",{});var wt=i(nt);tp=s(wt,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
no `),Ba=r(wt,"CODE",{});var Zm=i(Ba);sp=s(Zm,"pad_token_id"),Zm.forEach(t),ap=s(wt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Wa=r(wt,"CODE",{});var ef=i(Wa);rp=s(ef,"inputs_embeds"),ef.forEach(t),ip=s(wt," are passed instead of "),Qa=r(wt,"CODE",{});var tf=i(Qa);lp=s(tf,"input_ids"),tf.forEach(t),dp=s(wt,`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),Tp=d(Ce),b(fo.$$.fragment,Ce),vp=d(Ce),qe=r(Ce,"DIV",{class:!0});var lt=i(qe);b(Mn.$$.fragment,lt),kp=d(lt),Dt=r(lt,"P",{});var Qs=i(Dt);bp=s(Qs,"The "),Ms=r(Qs,"A",{href:!0});var sf=i(Ms);wp=s(sf,"TFGPTJForSequenceClassification"),sf.forEach(t),yp=s(Qs," forward method, overrides the "),Ua=r(Qs,"CODE",{});var af=i(Ua);Pp=s(af,"__call__"),af.forEach(t),$p=s(Qs," special method."),Qs.forEach(t),Fp=d(lt),b(go.$$.fragment,lt),jp=d(lt),Ha=r(lt,"P",{});var rf=i(Ha);Gp=s(rf,"Example:"),rf.forEach(t),Ep=d(lt),b(qn.$$.fragment,lt),Jp=d(lt),b(zn.$$.fragment,lt),lt.forEach(t),Ce.forEach(t),Zr=d(o),Ot=r(o,"H2",{class:!0});var ji=i(Ot);_o=r(ji,"A",{id:!0,class:!0,href:!0});var lf=i(_o);Ra=r(lf,"SPAN",{});var df=i(Ra);b(Cn.$$.fragment,df),df.forEach(t),lf.forEach(t),xp=d(ji),Va=r(ji,"SPAN",{});var cf=i(Va);Mp=s(cf,"TFGPTJForQuestionAnswering"),cf.forEach(t),ji.forEach(t),ei=d(o),Je=r(o,"DIV",{class:!0});var dt=i(Je);b(An.$$.fragment,dt),qp=d(dt),Bt=r(dt,"P",{});var Us=i(Bt);zp=s(Us,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Hp=d(dt),b(To.$$.fragment,dt),Rp=d(dt),ze=r(dt,"DIV",{class:!0});var ct=i(ze);b(Nn.$$.fragment,ct),Vp=d(ct),Wt=r(ct,"P",{});var Hs=i(Wt);Kp=s(Hs,"The "),zs=r(Hs,"A",{href:!0});var ff=i(zs);Xp=s(ff,"TFGPTJForQuestionAnswering"),ff.forEach(t),Yp=s(Hs," forward method, overrides the "),Ya=r(Hs,"CODE",{});var gf=i(Ya);Zp=s(gf,"__call__"),gf.forEach(t),eh=s(Hs," special method."),Hs.forEach(t),th=d(ct),b(vo.$$.fragment,ct),oh=d(ct),Za=r(ct,"P",{});var _f=i(Za);nh=s(_f,"Example:"),_f.forEach(t),sh=d(ct),b(Dn.$$.fragment,ct),ah=d(ct),b(On.$$.fragment,ct),ct.forEach(t),dt.forEach(t),ti=d(o),Qt=r(o,"H2",{class:!0});var Ji=i(Qt);ko=r(Ji,"A",{id:!0,class:!0,href:!0});var Tf=i(ko);er=r(Tf,"SPAN",{});var vf=i(er);b(Bn.$$.fragment,vf),vf.forEach(t),Tf.forEach(t),rh=d(Ji),tr=r(Ji,"SPAN",{});var kf=i(tr);ih=s(kf,"FlaxGPTJModel"),kf.forEach(t),Ji.forEach(t),oi=d(o),ye=r(o,"DIV",{class:!0});var Re=i(ye);b(Wn.$$.fragment,Re),lh=d(Re),or=r(Re,"P",{});var bf=i(or);dh=s(bf,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),bf.forEach(t),ch=d(Re),Qn=r(Re,"P",{});var xi=i(Qn);ph=s(xi,"This model inherits from "),Cs=r(xi,"A",{href:!0});var wf=i(Cs);hh=s(wf,"FlaxPreTrainedModel"),wf.forEach(t),uh=s(xi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mi.forEach(t),Th=d(Re),nr=r(Re,"P",{});var Pf=i(nr);vh=s(Pf,"Finally, this model supports inherent JAX features such as:"),Pf.forEach(t),kh=d(Re),ut=r(Re,"UL",{});var Go=i(ut);sr=r(Go,"LI",{});var $f=i(sr);Rn=r($f,"A",{href:!0,rel:!0});var Ff=i(Rn);bh=s(Ff,"Just-In-Time (JIT) compilation"),Ff.forEach(t),$f.forEach(t),wh=d(Go),ar=r(Go,"LI",{});var jf=i(ar);Vn=r(jf,"A",{href:!0,rel:!0});var Gf=i(Vn);yh=s(Gf,"Automatic Differentiation"),Gf.forEach(t),jf.forEach(t),Ph=d(Go),rr=r(Go,"LI",{});var Ef=i(rr);Kn=r(Ef,"A",{href:!0,rel:!0});var Jf=i(Kn);$h=s(Jf,"Vectorization"),Jf.forEach(t),Ef.forEach(t),Fh=d(Go),ir=r(Go,"LI",{});var xf=i(ir);Xn=r(xf,"A",{href:!0,rel:!0});var Mf=i(Xn);jh=s(Mf,"Parallelization"),Mf.forEach(t),xf.forEach(t),Go.forEach(t),Gh=d(Re),Ue=r(Re,"DIV",{class:!0});var yt=i(Ue);b(Yn.$$.fragment,yt),Eh=d(yt),Ut=r(yt,"P",{});var Rs=i(Ut);Jh=s(Rs,"The "),lr=r(Rs,"CODE",{});var qf=i(lr);xh=s(qf,"FlaxGPTJPreTrainedModel"),qf.forEach(t),Mh=s(Rs,"forward method, overrides the "),dr=r(Rs,"CODE",{});var zf=i(dr);qh=s(zf,"__call__"),zf.forEach(t),zh=s(Rs," special method."),Rs.forEach(t),Ch=d(yt),b(bo.$$.fragment,yt),Ah=d(yt),cr=r(yt,"P",{});var Cf=i(cr);Ih=s(Cf,"Example:"),Cf.forEach(t),Lh=d(yt),b(Zn.$$.fragment,yt),yt.forEach(t),Re.forEach(t),ni=d(o),Ht=r(o,"H2",{class:!0});var qi=i(Ht);wo=r(qi,"A",{id:!0,class:!0,href:!0});var Af=i(wo);pr=r(Af,"SPAN",{});var If=i(pr);b(es.$$.fragment,If),If.forEach(t),Af.forEach(t),Sh=d(qi),hr=r(qi,"SPAN",{});var Lf=i(hr);Nh=s(Lf,"FlaxGPTJForCausalLM"),Lf.forEach(t),qi.forEach(t),si=d(o),Pe=r(o,"DIV",{class:!0});var Ve=i(Pe);b(ts.$$.fragment,Ve),Dh=d(Ve),ur=r(Ve,"P",{});var Sf=i(ur);Oh=s(Sf,"The GPTJ Model transformer with a language modeling head on top."),Sf.forEach(t),Bh=d(Ve),os=r(Ve,"P",{});var zi=i(os);Wh=s(zi,"This model inherits from "),As=r(zi,"A",{href:!0});var Nf=i(As);Qh=s(Nf,"FlaxPreTrainedModel"),Nf.forEach(t),Uh=s(zi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ci.forEach(t),Xh=d(Ve),mr=r(Ve,"P",{});var Of=i(mr);Yh=s(Of,"Finally, this model supports inherent JAX features such as:"),Of.forEach(t),Zh=d(Ve),mt=r(Ve,"UL",{});var Eo=i(mt);fr=r(Eo,"LI",{});var Bf=i(fr);as=r(Bf,"A",{href:!0,rel:!0});var Wf=i(as);eu=s(Wf,"Just-In-Time (JIT) compilation"),Wf.forEach(t),Bf.forEach(t),tu=d(Eo),gr=r(Eo,"LI",{});var Qf=i(gr);rs=r(Qf,"A",{href:!0,rel:!0});var Uf=i(rs);ou=s(Uf,"Automatic Differentiation"),Uf.forEach(t),Qf.forEach(t),nu=d(Eo),_r=r(Eo,"LI",{});var Hf=i(_r);is=r(Hf,"A",{href:!0,rel:!0});var Rf=i(is);su=s(Rf,"Vectorization"),Rf.forEach(t),Hf.forEach(t),au=d(Eo),Tr=r(Eo,"LI",{});var Vf=i(Tr);ls=r(Vf,"A",{href:!0,rel:!0});var Kf=i(ls);ru=s(Kf,"Parallelization"),Kf.forEach(t),Vf.forEach(t),Eo.forEach(t),iu=d(Ve),He=r(Ve,"DIV",{class:!0});var Pt=i(He);b(ds.$$.fragment,Pt),lu=d(Pt),Rt=r(Pt,"P",{});var Vs=i(Rt);du=s(Vs,"The "),vr=r(Vs,"CODE",{});var Xf=i(vr);cu=s(Xf,"FlaxGPTJPreTrainedModel"),Xf.forEach(t),pu=s(Vs,"forward method, overrides the "),kr=r(Vs,"CODE",{});var Yf=i(kr);hu=s(Yf,"__call__"),Yf.forEach(t),uu=s(Vs," special method."),Vs.forEach(t),mu=d(Pt),b(yo.$$.fragment,Pt),fu=d(Pt),br=r(Pt,"P",{});var Zf=i(br);gu=s(Zf,"Example:"),Zf.forEach(t),_u=d(Pt),b(cs.$$.fragment,Pt),Pt.forEach(t),Ve.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(kg)),c(_,"id","gptj"),c(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_,"href","#gptj"),c(f,"class","relative group"),c(X,"id","overview"),c(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(X,"href","#overview"),c(E,"class","relative group"),c(ee,"href","https://github.com/kingoflolz/mesh-transformer-jax"),c(ee,"rel","nofollow"),c(x,"href","https://pile.eleuther.ai/"),c(x,"rel","nofollow"),c(oe,"href","https://huggingface.co/stellaathena"),c(oe,"rel","nofollow"),c(q,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(q,"rel","nofollow"),c(z,"href","https://huggingface.co/EleutherAI/gpt-j-6B/tree/float16"),c(z,"rel","nofollow"),c(be,"href","https://github.com/kingoflolz/mesh-transformer-jax/blob/master/howto_finetune.md"),c(be,"rel","nofollow"),c(Jo,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Jo,"rel","nofollow"),c(Kt,"id","generation"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#generation"),c($t,"class","relative group"),c(ms,"href","/docs/transformers/pr_16354/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(Yt,"id","transformers.GPTJConfig"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.GPTJConfig"),c(Ft,"class","relative group"),c(gs,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.GPTJModel"),c(Ao,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Ao,"rel","nofollow"),c(_s,"href","/docs/transformers/pr_16354/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ts,"href","/docs/transformers/pr_16354/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ye,"class","docstring"),c(Zt,"id","transformers.GPTJModel"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.GPTJModel"),c(jt,"class","relative group"),c(Do,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Do,"rel","nofollow"),c(vs,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.GPTJModel"),c(Oe,"class","docstring"),c(ht,"class","docstring"),c(to,"id","transformers.GPTJForCausalLM"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.GPTJForCausalLM"),c(Et,"class","relative group"),c(Ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ho,"rel","nofollow"),c(ks,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.GPTJForCausalLM"),c(Be,"class","docstring"),c(et,"class","docstring"),c(no,"id","transformers.GPTJForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.GPTJForSequenceClassification"),c(xt,"class","relative group"),c(ws,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(Zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Zo,"rel","nofollow"),c(ys,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(ne,"class","docstring"),c(je,"class","docstring"),c(ao,"id","transformers.GPTJForQuestionAnswering"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.GPTJForQuestionAnswering"),c(qt,"class","relative group"),c(dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(dn,"rel","nofollow"),c(Ps,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.GPTJForQuestionAnswering"),c(Me,"class","docstring"),c(ot,"class","docstring"),c(io,"id","transformers.TFGPTJModel"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.TFGPTJModel"),c(At,"class","relative group"),c($s,"href","/docs/transformers/pr_16354/en/main_classes/model#transformers.TFPreTrainedModel"),c(_n,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(_n,"rel","nofollow"),c(Fs,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.TFGPTJModel"),c(We,"class","docstring"),c(Ge,"class","docstring"),c(po,"id","transformers.TFGPTJForCausalLM"),c(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(po,"href","#transformers.TFGPTJForCausalLM"),c(Lt,"class","relative group"),c(js,"href","/docs/transformers/pr_16354/en/main_classes/model#transformers.TFPreTrainedModel"),c(Pn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Pn,"rel","nofollow"),c(Gs,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.TFGPTJForCausalLM"),c(Qe,"class","docstring"),c(Ee,"class","docstring"),c(mo,"id","transformers.TFGPTJForSequenceClassification"),c(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(mo,"href","#transformers.TFGPTJForSequenceClassification"),c(Nt,"class","relative group"),c(Js,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(xs,"href","/docs/transformers/pr_16354/en/main_classes/model#transformers.TFPreTrainedModel"),c(xn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(xn,"rel","nofollow"),c(Ms,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.TFGPTJForSequenceClassification"),c(qe,"class","docstring"),c(ae,"class","docstring"),c(_o,"id","transformers.TFGPTJForQuestionAnswering"),c(_o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_o,"href","#transformers.TFGPTJForQuestionAnswering"),c(Ot,"class","relative group"),c(qs,"href","/docs/transformers/pr_16354/en/main_classes/model#transformers.TFPreTrainedModel"),c(Sn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Sn,"rel","nofollow"),c(zs,"href","/docs/transformers/pr_16354/en/model_doc/gptj#transformers.TFGPTJForQuestionAnswering"),c(ze,"class","docstring"),c(Je,"class","docstring"),c(ko,"id","transformers.FlaxGPTJModel"),c(ko,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ko,"href","#transformers.FlaxGPTJModel"),c(Qt,"class","relative group"),c(Cs,"href","/docs/transformers/pr_16354/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Hn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Hn,"rel","nofollow"),c(Rn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Rn,"rel","nofollow"),c(Vn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Vn,"rel","nofollow"),c(Kn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Kn,"rel","nofollow"),c(Xn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Xn,"rel","nofollow"),c(Ue,"class","docstring"),c(ye,"class","docstring"),c(wo,"id","transformers.FlaxGPTJForCausalLM"),c(wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(wo,"href","#transformers.FlaxGPTJForCausalLM"),c(Ht,"class","relative group"),c(As,"href","/docs/transformers/pr_16354/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(ss,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(ss,"rel","nofollow"),c(as,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(as,"rel","nofollow"),c(rs,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(rs,"rel","nofollow"),c(is,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(is,"rel","nofollow"),c(ls,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(ls,"rel","nofollow"),c(He,"class","docstring"),c(Pe,"class","docstring")},m(o,m){e(document.head,p),u(o,F,m),u(o,f,m),e(f,_),e(_,v),w(T,v,null),e(f,g),e(f,j),e(j,ue),u(o,K,m),u(o,E,m),e(E,X),e(X,O),w(Z,O,null),e(E,me),e(E,B),e(B,fe),u(o,ie,m),u(o,L,m),e(L,A),e(L,ee),e(ee,te),e(L,J),e(L,x),e(x,ge),e(L,U),u(o,le,m),u(o,Y,m),e(Y,H),e(Y,oe),e(oe,_e),e(Y,M),u(o,de,m),u(o,S,m),e(S,Te),u(o,ce,m),u(o,N,m),e(N,W),e(W,ve),e(W,q),e(q,ke),e(W,R),e(W,se),e(se,h),e(W,G),e(W,V),e(V,Ae),e(W,Ie),e(W,z),e(z,Le),e(W,Se),u(o,xe,m),w(C,o,m),u(o,Q,m),u(o,pe,m),e(pe,Fe),e(Fe,D),e(D,Ne),e(D,be),e(be,we),e(pe,De),e(pe,Ks),e(Ks,pt),e(pt,Ai),e(pt,Jo),e(Jo,Ii),e(pt,Li),e(pt,Xs),e(Xs,Si),e(pt,Ni),e(pt,Ys),e(Ys,Di),e(pt,Oi),u(o,Mr,m),u(o,$t,m),e($t,Kt),e(Kt,Zs),w(xo,Zs,null),e($t,Bi),e($t,ea),e(ea,Wi),u(o,qr,m),u(o,Xt,m),e(Xt,Qi),e(Xt,ms),e(ms,Ui),e(Xt,Hi),u(o,zr,m),w(Mo,o,m),u(o,Cr,m),u(o,fs,m),e(fs,Ri),u(o,Ar,m),w(qo,o,m),u(o,Ir,m),u(o,Ft,m),e(Ft,Yt),e(Yt,ta),w(zo,ta,null),e(Ft,Vi),e(Ft,oa),e(oa,Ki),u(o,Lr,m),u(o,Ye,m),w(Co,Ye,null),e(Ye,Xi),e(Ye,Ze),e(Ze,Yi),e(Ze,gs),e(gs,Zi),e(Ze,el),e(Ze,Ao),e(Ao,tl),e(Ze,ol),e(Ze,_s),e(_s,nl),e(Ze,sl),e(Ze,Ts),e(Ts,al),e(Ze,rl),e(Ye,il),e(Ye,na),e(na,ll),e(Ye,dl),w(Io,Ye,null),u(o,Sr,m),u(o,jt,m),e(jt,Zt),e(Zt,sa),w(Lo,sa,null),e(jt,cl),e(jt,aa),e(aa,pl),u(o,Nr,m),u(o,ht,m),w(So,ht,null),e(ht,hl),e(ht,No),e(No,ul),e(No,Do),e(Do,ml),e(No,fl),e(ht,gl),e(ht,Oe),w(Oo,Oe,null),e(Oe,_l),e(Oe,Gt),e(Gt,Tl),e(Gt,vs),e(vs,vl),e(Gt,kl),e(Gt,ra),e(ra,bl),e(Gt,wl),e(Oe,yl),w(eo,Oe,null),e(Oe,Pl),e(Oe,ia),e(ia,$l),e(Oe,Fl),w(Bo,Oe,null),u(o,Dr,m),u(o,Et,m),e(Et,to),e(to,la),w(Wo,la,null),e(Et,jl),e(Et,da),e(da,Gl),u(o,Or,m),u(o,et,m),w(Qo,et,null),e(et,El),e(et,ca),e(ca,Jl),e(et,xl),e(et,Uo),e(Uo,Ml),e(Uo,Ho),e(Ho,ql),e(Uo,zl),e(et,Cl),e(et,Be),w(Ro,Be,null),e(Be,Al),e(Be,Jt),e(Jt,Il),e(Jt,ks),e(ks,Ll),e(Jt,Sl),e(Jt,pa),e(pa,Nl),e(Jt,Dl),e(Be,Ol),w(oo,Be,null),e(Be,Bl),e(Be,ha),e(ha,Wl),e(Be,Ql),w(Vo,Be,null),u(o,Br,m),u(o,xt,m),e(xt,no),e(no,ua),w(Ko,ua,null),e(xt,Ul),e(xt,ma),e(ma,Hl),u(o,Wr,m),u(o,je,m),w(Xo,je,null),e(je,Rl),e(je,fa),e(fa,Vl),e(je,Kl),e(je,bs),e(bs,ws),e(ws,Xl),e(bs,Yl),e(je,Zl),e(je,tt),e(tt,ed),e(tt,ga),e(ga,td),e(tt,od),e(tt,_a),e(_a,nd),e(tt,sd),e(tt,Ta),e(Ta,ad),e(tt,rd),e(tt,va),e(va,id),e(tt,ld),e(je,dd),e(je,Yo),e(Yo,cd),e(Yo,Zo),e(Zo,pd),e(Yo,hd),e(je,ud),e(je,ne),w(en,ne,null),e(ne,md),e(ne,Mt),e(Mt,fd),e(Mt,ys),e(ys,gd),e(Mt,_d),e(Mt,ka),e(ka,Td),e(Mt,vd),e(ne,kd),w(so,ne,null),e(ne,bd),e(ne,ba),e(ba,wd),e(ne,yd),w(tn,ne,null),e(ne,Pd),w(on,ne,null),e(ne,$d),e(ne,wa),e(wa,Fd),e(ne,jd),w(nn,ne,null),e(ne,Gd),w(sn,ne,null),u(o,Qr,m),u(o,qt,m),e(qt,ao),e(ao,ya),w(an,ya,null),e(qt,Ed),e(qt,Pa),e(Pa,Jd),u(o,Ur,m),u(o,ot,m),w(rn,ot,null),e(ot,xd),e(ot,zt),e(zt,Md),e(zt,$a),e($a,qd),e(zt,zd),e(zt,Fa),e(Fa,Cd),e(zt,Ad),e(ot,Id),e(ot,ln),e(ln,Ld),e(ln,dn),e(dn,Sd),e(ln,Nd),e(ot,Dd),e(ot,Me),w(cn,Me,null),e(Me,Od),e(Me,Ct),e(Ct,Bd),e(Ct,Ps),e(Ps,Wd),e(Ct,Qd),e(Ct,ja),e(ja,Ud),e(Ct,Hd),e(Me,Rd),w(ro,Me,null),e(Me,Vd),e(Me,Ga),e(Ga,Kd),e(Me,Xd),w(pn,Me,null),e(Me,Yd),w(hn,Me,null),u(o,Hr,m),u(o,At,m),e(At,io),e(io,Ea),w(un,Ea,null),e(At,Zd),e(At,Ja),e(Ja,ec),u(o,Rr,m),u(o,Ge,m),w(mn,Ge,null),e(Ge,tc),e(Ge,xa),e(xa,oc),e(Ge,nc),e(Ge,fn),e(fn,sc),e(fn,$s),e($s,ac),e(fn,rc),e(Ge,ic),e(Ge,gn),e(gn,lc),e(gn,_n),e(_n,dc),e(gn,cc),e(Ge,pc),w(lo,Ge,null),e(Ge,hc),e(Ge,We),w(Tn,We,null),e(We,uc),e(We,It),e(It,mc),e(It,Fs),e(Fs,fc),e(It,gc),e(It,Ma),e(Ma,_c),e(It,Tc),e(We,vc),w(co,We,null),e(We,kc),e(We,qa),e(qa,bc),e(We,wc),w(vn,We,null),u(o,Vr,m),u(o,Lt,m),e(Lt,po),e(po,za),w(kn,za,null),e(Lt,yc),e(Lt,Ca),e(Ca,Pc),u(o,Kr,m),u(o,Ee,m),w(bn,Ee,null),e(Ee,$c),e(Ee,Aa),e(Aa,Fc),e(Ee,jc),e(Ee,wn),e(wn,Gc),e(wn,js),e(js,Ec),e(wn,Jc),e(Ee,xc),e(Ee,yn),e(yn,Mc),e(yn,Pn),e(Pn,qc),e(yn,zc),e(Ee,Cc),w(ho,Ee,null),e(Ee,Ac),e(Ee,Qe),w($n,Qe,null),e(Qe,Ic),e(Qe,St),e(St,Lc),e(St,Gs),e(Gs,Sc),e(St,Nc),e(St,Ia),e(Ia,Dc),e(St,Oc),e(Qe,Bc),w(uo,Qe,null),e(Qe,Wc),e(Qe,La),e(La,Qc),e(Qe,Uc),w(Fn,Qe,null),u(o,Xr,m),u(o,Nt,m),e(Nt,mo),e(mo,Sa),w(jn,Sa,null),e(Nt,Hc),e(Nt,Na),e(Na,Rc),u(o,Yr,m),u(o,ae,m),w(Gn,ae,null),e(ae,Vc),e(ae,Da),e(Da,Kc),e(ae,Xc),e(ae,Es),e(Es,Js),e(Js,Yc),e(Es,Zc),e(ae,ep),e(ae,nt),e(nt,tp),e(nt,Oa),e(Oa,op),e(nt,np),e(nt,Ba),e(Ba,sp),e(nt,ap),e(nt,Wa),e(Wa,rp),e(nt,ip),e(nt,Qa),e(Qa,lp),e(nt,dp),e(ae,cp),e(ae,En),e(En,pp),e(En,xs),e(xs,hp),e(En,up),e(ae,mp),e(ae,Jn),e(Jn,fp),e(Jn,xn),e(xn,gp),e(Jn,_p),e(ae,Tp),w(fo,ae,null),e(ae,vp),e(ae,qe),w(Mn,qe,null),e(qe,kp),e(qe,Dt),e(Dt,bp),e(Dt,Ms),e(Ms,wp),e(Dt,yp),e(Dt,Ua),e(Ua,Pp),e(Dt,$p),e(qe,Fp),w(go,qe,null),e(qe,jp),e(qe,Ha),e(Ha,Gp),e(qe,Ep),w(qn,qe,null),e(qe,Jp),w(zn,qe,null),u(o,Zr,m),u(o,Ot,m),e(Ot,_o),e(_o,Ra),w(Cn,Ra,null),e(Ot,xp),e(Ot,Va),e(Va,Mp),u(o,ei,m),u(o,Je,m),w(An,Je,null),e(Je,qp),e(Je,Bt),e(Bt,zp),e(Bt,Ka),e(Ka,Cp),e(Bt,Ap),e(Bt,Xa),e(Xa,Ip),e(Bt,Lp),e(Je,Sp),e(Je,In),e(In,Np),e(In,qs),e(qs,Dp),e(In,Op),e(Je,Bp),e(Je,Ln),e(Ln,Wp),e(Ln,Sn),e(Sn,Qp),e(Ln,Up),e(Je,Hp),w(To,Je,null),e(Je,Rp),e(Je,ze),w(Nn,ze,null),e(ze,Vp),e(ze,Wt),e(Wt,Kp),e(Wt,zs),e(zs,Xp),e(Wt,Yp),e(Wt,Ya),e(Ya,Zp),e(Wt,eh),e(ze,th),w(vo,ze,null),e(ze,oh),e(ze,Za),e(Za,nh),e(ze,sh),w(Dn,ze,null),e(ze,ah),w(On,ze,null),u(o,ti,m),u(o,Qt,m),e(Qt,ko),e(ko,er),w(Bn,er,null),e(Qt,rh),e(Qt,tr),e(tr,ih),u(o,oi,m),u(o,ye,m),w(Wn,ye,null),e(ye,lh),e(ye,or),e(or,dh),e(ye,ch),e(ye,Qn),e(Qn,ph),e(Qn,Cs),e(Cs,hh),e(Qn,uh),e(ye,mh),e(ye,Un),e(Un,fh),e(Un,Hn),e(Hn,gh),e(Un,_h),e(ye,Th),e(ye,nr),e(nr,vh),e(ye,kh),e(ye,ut),e(ut,sr),e(sr,Rn),e(Rn,bh),e(ut,wh),e(ut,ar),e(ar,Vn),e(Vn,yh),e(ut,Ph),e(ut,rr),e(rr,Kn),e(Kn,$h),e(ut,Fh),e(ut,ir),e(ir,Xn),e(Xn,jh),e(ye,Gh),e(ye,Ue),w(Yn,Ue,null),e(Ue,Eh),e(Ue,Ut),e(Ut,Jh),e(Ut,lr),e(lr,xh),e(Ut,Mh),e(Ut,dr),e(dr,qh),e(Ut,zh),e(Ue,Ch),w(bo,Ue,null),e(Ue,Ah),e(Ue,cr),e(cr,Ih),e(Ue,Lh),w(Zn,Ue,null),u(o,ni,m),u(o,Ht,m),e(Ht,wo),e(wo,pr),w(es,pr,null),e(Ht,Sh),e(Ht,hr),e(hr,Nh),u(o,si,m),u(o,Pe,m),w(ts,Pe,null),e(Pe,Dh),e(Pe,ur),e(ur,Oh),e(Pe,Bh),e(Pe,os),e(os,Wh),e(os,As),e(As,Qh),e(os,Uh),e(Pe,Hh),e(Pe,ns),e(ns,Rh),e(ns,ss),e(ss,Vh),e(ns,Kh),e(Pe,Xh),e(Pe,mr),e(mr,Yh),e(Pe,Zh),e(Pe,mt),e(mt,fr),e(fr,as),e(as,eu),e(mt,tu),e(mt,gr),e(gr,rs),e(rs,ou),e(mt,nu),e(mt,_r),e(_r,is),e(is,su),e(mt,au),e(mt,Tr),e(Tr,ls),e(ls,ru),e(Pe,iu),e(Pe,He),w(ds,He,null),e(He,lu),e(He,Rt),e(Rt,du),e(Rt,vr),e(vr,cu),e(Rt,pu),e(Rt,kr),e(kr,hu),e(Rt,uu),e(He,mu),w(yo,He,null),e(He,fu),e(He,br),e(br,gu),e(He,_u),w(cs,He,null),ai=!0},p(o,[m]){const ps={};m&2&&(ps.$$scope={dirty:m,ctx:o}),eo.$set(ps);const wr={};m&2&&(wr.$$scope={dirty:m,ctx:o}),oo.$set(wr);const yr={};m&2&&(yr.$$scope={dirty:m,ctx:o}),so.$set(yr);const Pr={};m&2&&(Pr.$$scope={dirty:m,ctx:o}),ro.$set(Pr);const hs={};m&2&&(hs.$$scope={dirty:m,ctx:o}),lo.$set(hs);const $r={};m&2&&($r.$$scope={dirty:m,ctx:o}),co.$set($r);const Fr={};m&2&&(Fr.$$scope={dirty:m,ctx:o}),ho.$set(Fr);const jr={};m&2&&(jr.$$scope={dirty:m,ctx:o}),uo.$set(jr);const Vt={};m&2&&(Vt.$$scope={dirty:m,ctx:o}),fo.$set(Vt);const Gr={};m&2&&(Gr.$$scope={dirty:m,ctx:o}),go.$set(Gr);const Er={};m&2&&(Er.$$scope={dirty:m,ctx:o}),To.$set(Er);const us={};m&2&&(us.$$scope={dirty:m,ctx:o}),vo.$set(us);const Jr={};m&2&&(Jr.$$scope={dirty:m,ctx:o}),bo.$set(Jr);const xr={};m&2&&(xr.$$scope={dirty:m,ctx:o}),yo.$set(xr)},i(o){ai||(y(T.$$.fragment,o),y(Z.$$.fragment,o),y(C.$$.fragment,o),y(xo.$$.fragment,o),y(Mo.$$.fragment,o),y(qo.$$.fragment,o),y(zo.$$.fragment,o),y(Co.$$.fragment,o),y(Io.$$.fragment,o),y(Lo.$$.fragment,o),y(So.$$.fragment,o),y(Oo.$$.fragment,o),y(eo.$$.fragment,o),y(Bo.$$.fragment,o),y(Wo.$$.fragment,o),y(Qo.$$.fragment,o),y(Ro.$$.fragment,o),y(oo.$$.fragment,o),y(Vo.$$.fragment,o),y(Ko.$$.fragment,o),y(Xo.$$.fragment,o),y(en.$$.fragment,o),y(so.$$.fragment,o),y(tn.$$.fragment,o),y(on.$$.fragment,o),y(nn.$$.fragment,o),y(sn.$$.fragment,o),y(an.$$.fragment,o),y(rn.$$.fragment,o),y(cn.$$.fragment,o),y(ro.$$.fragment,o),y(pn.$$.fragment,o),y(hn.$$.fragment,o),y(un.$$.fragment,o),y(mn.$$.fragment,o),y(lo.$$.fragment,o),y(Tn.$$.fragment,o),y(co.$$.fragment,o),y(vn.$$.fragment,o),y(kn.$$.fragment,o),y(bn.$$.fragment,o),y(ho.$$.fragment,o),y($n.$$.fragment,o),y(uo.$$.fragment,o),y(Fn.$$.fragment,o),y(jn.$$.fragment,o),y(Gn.$$.fragment,o),y(fo.$$.fragment,o),y(Mn.$$.fragment,o),y(go.$$.fragment,o),y(qn.$$.fragment,o),y(zn.$$.fragment,o),y(Cn.$$.fragment,o),y(An.$$.fragment,o),y(To.$$.fragment,o),y(Nn.$$.fragment,o),y(vo.$$.fragment,o),y(Dn.$$.fragment,o),y(On.$$.fragment,o),y(Bn.$$.fragment,o),y(Wn.$$.fragment,o),y(Yn.$$.fragment,o),y(bo.$$.fragment,o),y(Zn.$$.fragment,o),y(es.$$.fragment,o),y(ts.$$.fragment,o),y(ds.$$.fragment,o),y(yo.$$.fragment,o),y(cs.$$.fragment,o),ai=!0)},o(o){P(T.$$.fragment,o),P(Z.$$.fragment,o),P(C.$$.fragment,o),P(xo.$$.fragment,o),P(Mo.$$.fragment,o),P(qo.$$.fragment,o),P(zo.$$.fragment,o),P(Co.$$.fragment,o),P(Io.$$.fragment,o),P(Lo.$$.fragment,o),P(So.$$.fragment,o),P(Oo.$$.fragment,o),P(eo.$$.fragment,o),P(Bo.$$.fragment,o),P(Wo.$$.fragment,o),P(Qo.$$.fragment,o),P(Ro.$$.fragment,o),P(oo.$$.fragment,o),P(Vo.$$.fragment,o),P(Ko.$$.fragment,o),P(Xo.$$.fragment,o),P(en.$$.fragment,o),P(so.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(sn.$$.fragment,o),P(an.$$.fragment,o),P(rn.$$.fragment,o),P(cn.$$.fragment,o),P(ro.$$.fragment,o),P(pn.$$.fragment,o),P(hn.$$.fragment,o),P(un.$$.fragment,o),P(mn.$$.fragment,o),P(lo.$$.fragment,o),P(Tn.$$.fragment,o),P(co.$$.fragment,o),P(vn.$$.fragment,o),P(kn.$$.fragment,o),P(bn.$$.fragment,o),P(ho.$$.fragment,o),P($n.$$.fragment,o),P(uo.$$.fragment,o),P(Fn.$$.fragment,o),P(jn.$$.fragment,o),P(Gn.$$.fragment,o),P(fo.$$.fragment,o),P(Mn.$$.fragment,o),P(go.$$.fragment,o),P(qn.$$.fragment,o),P(zn.$$.fragment,o),P(Cn.$$.fragment,o),P(An.$$.fragment,o),P(To.$$.fragment,o),P(Nn.$$.fragment,o),P(vo.$$.fragment,o),P(Dn.$$.fragment,o),P(On.$$.fragment,o),P(Bn.$$.fragment,o),P(Wn.$$.fragment,o),P(Yn.$$.fragment,o),P(bo.$$.fragment,o),P(Zn.$$.fragment,o),P(es.$$.fragment,o),P(ts.$$.fragment,o),P(ds.$$.fragment,o),P(yo.$$.fragment,o),P(cs.$$.fragment,o),ai=!1},d(o){t(p),o&&t(F),o&&t(f),$(T),o&&t(K),o&&t(E),$(Z),o&&t(ie),o&&t(L),o&&t(le),o&&t(Y),o&&t(de),o&&t(S),o&&t(ce),o&&t(N),o&&t(xe),$(C,o),o&&t(Q),o&&t(pe),o&&t(Mr),o&&t($t),$(xo),o&&t(qr),o&&t(Xt),o&&t(zr),$(Mo,o),o&&t(Cr),o&&t(fs),o&&t(Ar),$(qo,o),o&&t(Ir),o&&t(Ft),$(zo),o&&t(Lr),o&&t(Ye),$(Co),$(Io),o&&t(Sr),o&&t(jt),$(Lo),o&&t(Nr),o&&t(ht),$(So),$(Oo),$(eo),$(Bo),o&&t(Dr),o&&t(Et),$(Wo),o&&t(Or),o&&t(et),$(Qo),$(Ro),$(oo),$(Vo),o&&t(Br),o&&t(xt),$(Ko),o&&t(Wr),o&&t(je),$(Xo),$(en),$(so),$(tn),$(on),$(nn),$(sn),o&&t(Qr),o&&t(qt),$(an),o&&t(Ur),o&&t(ot),$(rn),$(cn),$(ro),$(pn),$(hn),o&&t(Hr),o&&t(At),$(un),o&&t(Rr),o&&t(Ge),$(mn),$(lo),$(Tn),$(co),$(vn),o&&t(Vr),o&&t(Lt),$(kn),o&&t(Kr),o&&t(Ee),$(bn),$(ho),$($n),$(uo),$(Fn),o&&t(Xr),o&&t(Nt),$(jn),o&&t(Yr),o&&t(ae),$(Gn),$(fo),$(Mn),$(go),$(qn),$(zn),o&&t(Zr),o&&t(Ot),$(Cn),o&&t(ei),o&&t(Je),$(An),$(To),$(Nn),$(vo),$(Dn),$(On),o&&t(ti),o&&t(Qt),$(Bn),o&&t(oi),o&&t(ye),$(Wn),$(Yn),$(bo),$(Zn),o&&t(ni),o&&t(Ht),$(es),o&&t(si),o&&t(Pe),$(ts),$(ds),$(yo),$(cs)}}}const kg={local:"gptj",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTJConfig",title:"GPTJConfig"},{local:"transformers.GPTJModel",title:"GPTJModel"},{local:"transformers.GPTJForCausalLM",title:"GPTJForCausalLM"},{local:"transformers.GPTJForSequenceClassification",title:"GPTJForSequenceClassification"},{local:"transformers.GPTJForQuestionAnswering",title:"GPTJForQuestionAnswering"},{local:"transformers.TFGPTJModel",title:"TFGPTJModel"},{local:"transformers.TFGPTJForCausalLM",title:"TFGPTJForCausalLM"},{local:"transformers.TFGPTJForSequenceClassification",title:"TFGPTJForSequenceClassification"},{local:"transformers.TFGPTJForQuestionAnswering",title:"TFGPTJForQuestionAnswering"},{local:"transformers.FlaxGPTJModel",title:"FlaxGPTJModel"},{local:"transformers.FlaxGPTJForCausalLM",title:"FlaxGPTJForCausalLM"}],title:"GPT-J"};function bg(I){return sg(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class jg extends eg{constructor(p){super();tg(this,p,bg,vg,og,{})}}export{jg as default,kg as metadata};
