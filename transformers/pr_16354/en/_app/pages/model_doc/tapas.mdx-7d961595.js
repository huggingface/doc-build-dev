...
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function gy(U){let l,_,c,f,v,w,T,y,k,D,j,H,G,V,B,K,re,I,O,b,M,R,C,N,ee,te,ce,oe,se,P,L,W,X,Q,Y,ge,ue,_e,me,ne,je,ie,we;return{c(){l=o("p"),_=s("TF 2.0 models accepts two formats as inputs:"),c=p(),f=o("ul"),v=o("li"),w=s("having all inputs as keyword arguments (like PyTorch models), or"),T=p(),y=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),D=p(),j=o("p"),H=s("This second option is useful when using "),G=o("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),I=s("."),O=p(),b=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),Q=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=p(),ne=o("li"),je=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),we=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){l=n(g,"P",{});var S=r(l);_=a(S,"TF 2.0 models accepts two formats as inputs:"),S.forEach(t),c=d(g),f=n(g,"UL",{});var ve=r(f);v=n(ve,"LI",{});var ze=r(v);w=a(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),T=d(ve),y=n(ve,"LI",{});var be=r(y);k=a(be,"having all inputs as a list, tuple or dict in the first positional arguments."),be.forEach(t),ve.forEach(t),D=d(g),j=n(g,"P",{});var le=r(j);H=a(le,"This second option is useful when using "),G=n(le,"CODE",{});var xe=r(G);V=a(xe,"tf.keras.Model.fit"),xe.forEach(t),B=a(le,` method which currently requires having all the
tensors in the first argument of the model call function: `),K=n(le,"CODE",{});var Me=r(K);re=a(Me,"model(inputs)"),Me.forEach(t),I=a(le,"."),le.forEach(t),O=d(g),b=n(g,"P",{});var Z=r(b);M=a(Z,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z.forEach(t),R=d(g),C=n(g,"UL",{});var pe=r(C);N=n(pe,"LI",{});var de=r(N);ee=a(de,"a single Tensor with "),te=n(de,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(de," only and nothing else: "),se=n(de,"CODE",{});var qe=r(se);P=a(qe,"model(inputs_ids)"),qe.forEach(t),de.forEach(t),L=d(pe),W=n(pe,"LI",{});var Te=r(W);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n(Te,"CODE",{});var Ne=r(Q);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=d(pe),ne=n(pe,"LI",{});var Ae=r(ne);je=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);we=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),pe.forEach(t)},m(g,S){u(g,l,S),e(l,_),u(g,c,S),u(g,f,S),e(f,v),e(v,w),e(f,T),e(f,y),e(y,k),u(g,D,S),u(g,j,S),e(j,H),e(j,G),e(G,V),e(j,B),e(j,K),e(K,re),e(j,I),u(g,O,S),u(g,b,S),e(b,M),u(g,R,S),u(g,C,S),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,oe),e(N,se),e(se,P),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,je),e(ne,ie),e(ie,we)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(j),g&&t(O),g&&t(b),g&&t(R),g&&t(C)}}}function _y(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Z.forEach(t),R=d(g),C=n(g,"UL",{});var pe=r(C);N=n(pe,"LI",{});var de=r(N);ee=a(de,"a single Tensor with "),te=n(de,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(de," only and nothing else: "),se=n(de,"CODE",{});var qe=r(se);P=a(qe,"model(inputs_ids)"),qe.forEach(t),de.forEach(t),L=d(pe),W=n(pe,"LI",{});var Te=r(W);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n(Te,"CODE",{});var Ne=r(Q);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=d(pe),ne=n(pe,"LI",{});var Ae=r(ne);je=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);we=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),pe.forEach(t)},m(g,S){u(g,l,S),e(l,_),u(g,c,S),u(g,f,S),e(f,v),e(v,w),e(f,T),e(f,y),e(y,k),u(g,D,S),u(g,j,S),e(j,H),e(j,G),e(G,V),e(j,B),e(j,K),e(K,re),e(j,I),u(g,O,S),u(g,b,S),e(b,M),u(g,R,S),u(g,C,S),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,oe),e(N,se),e(se,P),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,je),e(ne,ie),e(ie,we)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(j),g&&t(O),g&&t(b),g&&t(R),g&&t(C)}}}function vy(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Z.forEach(t),R=d(g),C=n(g,"UL",{});var pe=r(C);N=n(pe,"LI",{});var de=r(N);ee=a(de,"a single Tensor with "),te=n(de,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(de," only and nothing else: "),se=n(de,"CODE",{});var qe=r(se);P=a(qe,"model(inputs_ids)"),qe.forEach(t),de.forEach(t),L=d(pe),W=n(pe,"LI",{});var Te=r(W);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n(Te,"CODE",{});var Ne=r(Q);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=d(pe),ne=n(pe,"LI",{});var Ae=r(ne);je=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);we=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),pe.forEach(t)},m(g,S){u(g,l,S),e(l,_),u(g,c,S),u(g,f,S),e(f,v),e(v,w),e(f,T),e(f,y),e(y,k),u(g,D,S),u(g,j,S),e(j,H),e(j,G),e(G,V),e(j,B),e(j,K),e(K,re),e(j,I),u(g,O,S),u(g,b,S),e(b,M),u(g,R,S),u(g,C,S),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,oe),e(N,se),e(se,P),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,je),e(ne,ie),e(ie,we)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(j),g&&t(O),g&&t(b),g&&t(R),g&&t(C)}}}function by(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Z.forEach(t),R=d(g),C=n(g,"UL",{});var pe=r(C);N=n(pe,"LI",{});var de=r(N);ee=a(de,"a single Tensor with "),te=n(de,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(de," only and nothing else: "),se=n(de,"CODE",{});var qe=r(se);P=a(qe,"model(inputs_ids)"),qe.forEach(t),de.forEach(t),L=d(pe),W=n(pe,"LI",{});var Te=r(W);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n(Te,"CODE",{});var Ne=r(Q);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=d(pe),ne=n(pe,"LI",{});var Ae=r(ne);je=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);we=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),pe.forEach(t)},m(g,S){u(g,l,S),e(l,_),u(g,c,S),u(g,f,S),e(f,v),e(v,w),e(f,T),e(f,y),e(y,k),u(g,D,S),u(g,j,S),e(j,H),e(j,G),e(G,V),e(j,B),e(j,K),e(K,re),e(j,I),u(g,O,S),u(g,b,S),e(b,M),u(g,R,S),u(g,C,S),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,oe),e(N,se),e(se,P),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,je),e(ne,ie),e(ie,we)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(j),g&&t(O),g&&t(b),g&&t(R),g&&t(C)}}}function yy(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function jy(U){let l,_,c,f,v,w,T,y,k,D,j,H,G,V,B,K,re,I,O,b,M,R,C,N,ee,te,ce,oe,se,P,L,W,X,Q,Y,ge,ue,_e,me,ne,je,ie,we,g,S,ve,ze,be,le,xe,Me,Z,pe,de,De,qe,Te,Ne,ke,Ae,Oe,Ze,Ps,Ss,ut,mt,da,ft,gt,Ds,tt,Ns,Os,Ke,Pe,Ls,bt,ye,kt,yt,Qs,jt,qt,Is,$t,vs,Rt,Et,ws,Ye,$e,Ws,Ft,ae,ot,Gt,Hs,At,os,Us,zt,xt,Bs,Ct,ns,Rs,Mt,rs,Gs,Pt,Vs,Le,St,is,Ks,Dt,ls,Ys,ps,Ue,ds,Ee,cs,nt,Js,Nt,Ot,Xs,Zs,Be,ea,hs,us,et,Lt,q,J,xa,ta,Ca,ca,Qt,st,sa,rt,Ma,aa,Pa,ha,Ie,ms,bs,Re,Sa,ua,ks,oa,fs,ma,fe,Da,ys,Na,Oa,fa,_t,na,gs,La,Fe,Qa,ra,Ia,Wa,Ha,he,Ua,ia,Ba,Ra,ga,js,Ga,_a,Ce,la,It,pa,Ki,Mc,Pc,Yi,Ji,Sc,Dc,Xi,Zi,Nc,Oc,Va,Ka,el,Lc,Qc,tl,Ic,Wc,sl,Hc,Uc,Ya,al,Bc,Rc,ol,Gc,Vc,nl,Kc,Yc,Ja,rl,Jc,Xc,il,Zc,eh,ll,th,sd,jo,ad,qo,sh,pn,ah,oh,od,$o,nh,dn,rh,ih,nd,Hr,pl,lh,rd,Eo,ph,cn,dh,ch,id,We,Ur,dl,hh,uh,mh,Br,cl,fh,gh,_h,Rr,hl,Th,vh,wh,Gr,ul,bh,kh,yh,Vr,ml,jh,qh,$h,Kr,fl,Eh,Fh,Ah,Yr,gl,zh,xh,Ch,Jr,_l,Mh,Ph,Sh,Xr,Tl,Dh,Nh,ld,Tt,Oh,hn,Lh,Qh,un,Ih,Wh,vl,Hh,Uh,wl,Bh,Rh,bl,Gh,Vh,pd,Zr,kl,Kh,dd,Fo,cd,Se,Yh,yl,Jh,Xh,jl,Zh,eu,ql,tu,su,$l,au,ou,El,nu,ru,Fl,iu,lu,ei,pu,du,mn,cu,hu,fn,uu,mu,hd,ti,fu,ud,Ao,md,Xa,zo,Al,gn,gu,zl,_u,fd,xo,gd,vt,Tu,xl,vu,wu,Cl,bu,ku,Ml,yu,ju,_n,qu,$u,Tn,Eu,Fu,_d,Za,Co,Pl,vn,Au,Sl,zu,Td,eo,wn,xu,bn,Cu,si,Mu,Pu,vd,to,Mo,Dl,kn,Su,Nl,Du,wd,Wt,yn,Nu,_s,Ou,ai,Lu,Qu,Ol,Iu,Wu,Ll,Hu,Uu,oi,Bu,Ru,Gu,jn,Vu,qn,Ku,Yu,Ju,Ql,Xu,Zu,$n,bd,so,Po,Il,En,em,Wl,tm,kd,Ge,Fn,sm,Hl,am,om,Qe,nm,ni,rm,im,ri,lm,pm,Ul,dm,cm,Bl,hm,um,Rl,mm,fm,Gl,gm,_m,Vl,Tm,vm,Kl,wm,bm,Yl,km,ym,jm,it,Jl,qm,$m,Xl,Em,Fm,Zl,Am,zm,ep,xm,Cm,tp,Mm,Pm,sp,Sm,Dm,ap,Nm,Om,ii,li,Lm,Qm,Im,So,An,Wm,op,Hm,Um,Ta,zn,Bm,xn,Rm,pi,Gm,Vm,Km,Cn,Ym,Mn,Jm,Xm,Zm,di,Pn,yd,ao,Do,np,Sn,ef,rp,tf,jd,lt,Dn,sf,Nn,af,ci,of,nf,rf,On,lf,Ln,pf,df,cf,Qn,hf,hi,uf,mf,ff,In,gf,Wn,_f,Tf,vf,Vt,Hn,wf,oo,bf,ui,kf,yf,ip,jf,qf,$f,No,Ef,lp,Ff,Af,Un,qd,no,Oo,pp,Bn,zf,dp,xf,$d,Ts,Rn,Cf,ro,Mf,cp,Pf,Sf,mi,Df,Nf,Of,Gn,Lf,Vn,Qf,If,Wf,Kt,Kn,Hf,io,Uf,fi,Bf,Rf,hp,Gf,Vf,Kf,Lo,Yf,up,Jf,Xf,Yn,Ed,lo,Qo,mp,Jn,Zf,fp,eg,Fd,Ht,Xn,tg,gp,sg,ag,Zn,og,gi,ng,rg,ig,er,lg,tr,pg,dg,cg,Yt,sr,hg,po,ug,_i,mg,fg,_p,gg,_g,Tg,Io,vg,Tp,wg,bg,ar,Ad,co,Wo,vp,or,kg,wp,yg,zd,Ut,nr,jg,ho,qg,bp,$g,Eg,kp,Fg,Ag,zg,rr,xg,Ti,Cg,Mg,Pg,ir,Sg,lr,Dg,Ng,Og,Jt,pr,Lg,uo,Qg,vi,Ig,Wg,yp,Hg,Ug,Bg,Ho,Rg,jp,Gg,Vg,dr,xd,mo,Uo,qp,cr,Kg,$p,Yg,Cd,pt,hr,Jg,Ep,Xg,Zg,ur,e_,wi,t_,s_,a_,mr,o_,fr,n_,r_,i_,Bo,l_,Xt,gr,p_,fo,d_,bi,c_,h_,Fp,u_,m_,f_,Ro,g_,Ap,__,T_,_r,Md,go,Go,zp,Tr,v_,xp,w_,Pd,dt,vr,b_,wr,k_,Cp,y_,j_,q_,br,$_,ki,E_,F_,A_,kr,z_,yr,x_,C_,M_,Vo,P_,Zt,jr,S_,_o,D_,yi,N_,O_,Mp,L_,Q_,I_,Ko,W_,Pp,H_,U_,qr,Sd,To,Yo,Sp,$r,B_,Dp,R_,Dd,ct,Er,G_,Np,V_,K_,Fr,Y_,ji,J_,X_,Z_,Ar,eT,zr,tT,sT,aT,Jo,oT,es,xr,nT,vo,rT,qi,iT,lT,Op,pT,dT,cT,Xo,hT,Lp,uT,mT,Cr,Nd,wo,Zo,Qp,Mr,fT,Ip,gT,Od,ht,Pr,_T,bo,TT,Wp,vT,wT,Hp,bT,kT,yT,Sr,jT,$i,qT,$T,ET,Dr,FT,Nr,AT,zT,xT,en,CT,ts,Or,MT,ko,PT,Ei,ST,DT,Up,NT,OT,LT,tn,QT,Bp,IT,WT,Lr,Ld;return w=new Bt({}),V=new Bt({}),rt=new Bt({}),jo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Zk],pytorch:[Jk]},$$scope:{ctx:U}}}),Fo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ay],pytorch:[ty]},$$scope:{ctx:U}}}),Ao=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[iy],pytorch:[ny]},$$scope:{ctx:U}}}),gn=new Bt({}),xo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[cy],pytorch:[py]},$$scope:{ctx:U}}}),vn=new Bt({}),wn=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16354/src/transformers/models/tapas/modeling_tapas.py#L106",parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
print(f"{tokenizer.decode([predicted_id])}")`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> TapasTokenizer, TapasForMaskedLM
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">import</span> pandas <span class="hljs-keyword">as</span> pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_id = probs.argmax().item()

<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">f&quot;<span class="hljs-subst">{tokenizer.decode([predicted_id])}</span>&quot;</span>)
di`}}),Jn=new Bt({}),Xn=new He({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16354/src/transformers/models/tapas/modeling_tapas.py#L1477",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16354/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16354/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),sr=new He({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16354/src/transformers/models/tapas/modeling_tapas.py#L1489",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16354/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16354/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vo=new Ms({props:{$$slots:{default:[Ty]},$$scope:{ctx:U}}}),jr=new He({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16354/src/transformers/models/tapas/modeling_tf_tapas.py#L1054",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16354/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Ko=new Ms({props:{$$slots:{default:[vy]},$$scope:{ctx:U}}}),qr=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForMaskedLM
import pandas as pd
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16354/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jo=new Ms({props:{$$slots:{default:[wy]},$$scope:{ctx:U}}}),xr=new He({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16354/src/transformers/models/tapas/modeling_tf_tapas.py#L1589",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16354/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16354/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("meta"),_=p(),c=o("h1"),f=o("a"),v=o("span"),$(w.$$.fragment),T=p(),y=o("span"),k=s("TAPAS"),D=p(),j=o("h2"),H=o("a"),G=o("span"),$(V.$$.fragment),B=p(),K=o("span"),re=s("Overview"),I=p(),O=o("p"),b=s("The TAPAS model was proposed in "),M=o("a"),R=s("TAPAS: Weakly Supervised Table Parsing via Pre-training"),C=s(`
...
documentation from `),oi=o("a"),Bu=s("PretrainedConfig"),Ru=s(" for more information."),Gu=p(),jn=o("p"),Vu=s(`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),qn=o("a"),Ku=s("https://github.com/google-research/tapas/tree/master"),Yu=s("."),Ju=p(),Ql=o("p"),Xu=s("Example:"),Zu=p(),$($n.$$.fragment),bd=p(),so=o("h2"),Po=o("a"),Il=o("span"),$(En.$$.fragment),em=p(),Wl=o("span"),tm=s("TapasTokenizer"),kd=p(),Ge=o("div"),$(Fn.$$.fragment),sm=p(),Hl=o("p"),am=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
`),Bl=o("code"),hm=s("column_ids"),um=s(", "),Rl=o("code"),mm=s("row_ids"),fm=s(", "),Gl=o("code"),gm=s("prev_labels"),_m=s(", "),Vl=o("code"),Tm=s("column_ranks"),vm=s(", "),Kl=o("code"),wm=s("inv_column_ranks"),bm=s(" and "),Yl=o("code"),km=s("numeric_relations"),ym=s(":"),jm=p(),it=o("ul"),Jl=o("li"),qm=s(`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
...
`),Mn=o("a"),Jm=s("here"),Xm=s("."),Zm=p(),di=o("div"),$(Pn.$$.fragment),yd=p(),ao=o("h2"),Do=o("a"),np=o("span"),$(Sn.$$.fragment),ef=p(),rp=o("span"),tf=s("TapasModel"),jd=p(),lt=o("div"),$(Dn.$$.fragment),sf=p(),Nn=o("p"),af=s(`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),vf=p(),Vt=o("div"),$(Hn.$$.fragment),wf=p(),oo=o("p"),bf=s("The "),ui=o("a"),kf=s("TapasModel"),yf=s(" forward method, overrides the "),ip=o("code"),jf=s("__call__"),qf=s(" special method."),$f=p(),$(No.$$.fragment),Ef=p(),lp=o("p"),Ff=s("Examples:"),Af=p(),$(Un.$$.fragment),qd=p(),no=o("h2"),Oo=o("a"),pp=o("span"),$(Bn.$$.fragment),zf=p(),dp=o("span"),xf=s("TapasForMaskedLM"),$d=p(),Ts=o("div"),$(Rn.$$.fragment),Cf=p(),ro=o("p"),Mf=s("Tapas Model with a "),cp=o("code"),Pf=s("language modeling"),Sf=s(` head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cg=p(),Yt=o("div"),$(sr.$$.fragment),hg=p(),po=o("p"),ug=s("The "),_i=o("a"),mg=s("TapasForSequenceClassification"),fg=s(" forward method, overrides the "),_p=o("code"),gg=s("__call__"),_g=s(" special method."),Tg=p(),$(Io.$$.fragment),vg=p(),Tp=o("p"),wg=s("Examples:"),bg=p(),$(ar.$$.fragment),Ad=p(),co=o("h2"),Wo=o("a"),vp=o("span"),$(or.$$.fragment),kg=p(),wp=o("span"),yg=s("TapasForQuestionAnswering"),zd=p(),Ut=o("div"),$(nr.$$.fragment),jg=p(),ho=o("p"),qg=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),bp=o("code"),$g=s("logits"),Eg=s(" and optional "),kp=o("code"),Fg=s("logits_aggregation"),Ag=s(`), e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Og=p(),Jt=o("div"),$(pr.$$.fragment),Lg=p(),uo=o("p"),Qg=s("The "),vi=o("a"),Ig=s("TapasForQuestionAnswering"),Wg=s(" forward method, overrides the "),yp=o("code"),Hg=s("__call__"),Ug=s(" special method."),Bg=p(),$(Ho.$$.fragment),Rg=p(),jp=o("p"),Gg=s("Examples:"),Vg=p(),$(dr.$$.fragment),xd=p(),mo=o("h2"),Uo=o("a"),qp=o("span"),$(cr.$$.fragment),Kg=p(),$p=o("span"),Yg=s("TFTapasModel"),Cd=p(),pt=o("div"),$(hr.$$.fragment),Jg=p(),Ep=o("p"),Xg=s("The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Zg=p(),ur=o("p"),e_=s("This model inherits from "),wi=o("a"),t_=s("TFPreTrainedModel"),s_=s(`. Check the superclass documentation for the generic methods the
...
behavior.`),i_=p(),$(Bo.$$.fragment),l_=p(),Xt=o("div"),$(gr.$$.fragment),p_=p(),fo=o("p"),d_=s("The "),bi=o("a"),c_=s("TFTapasModel"),h_=s(" forward method, overrides the "),Fp=o("code"),u_=s("__call__"),m_=s(" special method."),f_=p(),$(Ro.$$.fragment),g_=p(),Ap=o("p"),__=s("Examples:"),T_=p(),$(_r.$$.fragment),Md=p(),go=o("h2"),Go=o("a"),zp=o("span"),$(Tr.$$.fragment),v_=p(),xp=o("span"),w_=s("TFTapasForMaskedLM"),Pd=p(),dt=o("div"),$(vr.$$.fragment),b_=p(),wr=o("p"),k_=s("Tapas Model with a "),Cp=o("code"),y_=s("language modeling"),j_=s(" head on top."),q_=p(),br=o("p"),$_=s("This model inherits from "),ki=o("a"),E_=s("TFPreTrainedModel"),F_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),A_=p(),kr=o("p"),z_=s("This model is also a "),yr=o("a"),x_=s("tf.keras.Model"),C_=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),M_=p(),$(Vo.$$.fragment),P_=p(),Zt=o("div"),$(jr.$$.fragment),S_=p(),_o=o("p"),D_=s("The "),yi=o("a"),N_=s("TFTapasForMaskedLM"),O_=s(" forward method, overrides the "),Mp=o("code"),L_=s("__call__"),Q_=s(" special method."),I_=p(),$(Ko.$$.fragment),W_=p(),Pp=o("p"),H_=s("Examples:"),U_=p(),$(qr.$$.fragment),Sd=p(),To=o("h2"),Yo=o("a"),Sp=o("span"),$($r.$$.fragment),B_=p(),Dp=o("span"),R_=s("TFTapasForSequenceClassification"),Dd=p(),ct=o("div"),$(Er.$$.fragment),G_=p(),Np=o("p"),V_=s(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),K_=p(),Fr=o("p"),Y_=s("This model inherits from "),ji=o("a"),J_=s("TFPreTrainedModel"),X_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Z_=p(),Ar=o("p"),eT=s("This model is also a "),zr=o("a"),tT=s("tf.keras.Model"),sT=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),aT=p(),$(Jo.$$.fragment),oT=p(),es=o("div"),$(xr.$$.fragment),nT=p(),vo=o("p"),rT=s("The "),qi=o("a"),iT=s("TFTapasForSequenceClassification"),lT=s(" forward method, overrides the "),Op=o("code"),pT=s("__call__"),dT=s(" special method."),cT=p(),$(Xo.$$.fragment),hT=p(),Lp=o("p"),uT=s("Examples:"),mT=p(),$(Cr.$$.fragment),Nd=p(),wo=o("h2"),Zo=o("a"),Qp=o("span"),$(Mr.$$.fragment),fT=p(),Ip=o("span"),gT=s("TFTapasForQuestionAnswering"),Od=p(),ht=o("div"),$(Pr.$$.fragment),_T=p(),bo=o("p"),TT=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Wp=o("code"),vT=s("logits"),wT=s(" and optional "),Hp=o("code"),bT=s("logits_aggregation"),kT=s(`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),yT=p(),Sr=o("p"),jT=s("This model inherits from "),$i=o("a"),qT=s("TFPreTrainedModel"),$T=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ET=p(),Dr=o("p"),FT=s("This model is also a "),Nr=o("a"),AT=s("tf.keras.Model"),zT=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xT=p(),$(en.$$.fragment),CT=p(),ts=o("div"),$(Or.$$.fragment),MT=p(),ko=o("p"),PT=s("The "),Ei=o("a"),ST=s("TFTapasForQuestionAnswering"),DT=s(" forward method, overrides the "),Up=o("code"),NT=s("__call__"),OT=s(" special method."),LT=p(),$(tn.$$.fragment),QT=p(),Bp=o("p"),IT=s("Examples:"),WT=p(),$(Lr.$$.fragment),this.h()},l(i){const m=Gk('[data-svelte="svelte-1phssyn"]',document.head);l=n(m,"META",{name:!0,content:!0}),m.forEach(t),_=d(i),c=n(i,"H1",{class:!0});var Qr=r(c);f=n(Qr,"A",{id:!0,class:!0,href:!0});var Rp=r(f);v=n(Rp,"SPAN",{});var Gp=r(v);E(w.$$.fragment,Gp),Gp.forEach(t),Rp.forEach(t),T=d(Qr),y=n(Qr,"SPAN",{});var Vp=r(y);k=a(Vp,"TAPAS"),Vp.forEach(t),Qr.forEach(t),D=d(i),j=n(i,"H2",{class:!0});var Ir=r(j);H=n(Ir,"A",{id:!0,class:!0,href:!0});var Kp=r(H);G=n(Kp,"SPAN",{});var Yp=r(G);E(V.$$.fragment,Yp),Yp.forEach(t),Kp.forEach(t),B=d(Ir),K=n(Ir,"SPAN",{});var Jp=r(K);re=a(Jp,"Overview"),Jp.forEach(t),Ir.forEach(t),I=d(i),O=n(i,"P",{});var Wr=r(O);b=a(Wr,"The TAPAS model was proposed in "),M=n(Wr,"A",{href:!0,rel:!0});var Xp=r(M);R=a(Xp,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),Xp.forEach(t),C=a(Wr,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),Wr.forEach(t),N=d(i),ee=n(i,"P",{});var Zp=r(ee);te=a(Zp,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),Zp.forEach(t),ce=d(i),oe=n(i,"UL",{});var yo=r(oe);se=n(yo,"LI",{});var Fi=r(se);P=n(Fi,"A",{href:!0,rel:!0});var ed=r(P);L=a(ed,"SQA"),ed.forEach(t),W=a(Fi," (Sequential Question Answering by Microsoft)"),Fi.forEach(t),X=d(yo),Q=n(yo,"LI",{});var Ai=r(Q);Y=n(Ai,"A",{href:!0,rel:!0});var td=r(Y);ge=a(td,"WTQ"),td.forEach(t),ue=a(Ai," (Wiki Table Questions by Stanford University)"),Ai.forEach(t),_e=d(yo),me=n(yo,"LI",{});var HT=r(me);ne=n(HT,"A",{href:!0,rel:!0});var ev=r(ne);je=a(ev,"WikiSQL"),ev.forEach(t),ie=a(HT," (by Salesforce)."),HT.forEach(t),yo.forEach(t),we=d(i),g=n(i,"P",{});var tv=r(g);S=a(tv,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),tv.forEach(t),ve=d(i),ze=n(i,"P",{});var sv=r(ze);be=a(sv,"The abstract from the paper is the following:"),sv.forEach(t),le=d(i),xe=n(i,"P",{});var av=r(xe);Me=n(av,"EM",{});var ov=r(Me);Z=a(ov,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),ov.forEach(t),av.forEach(t),pe=d(i),de=n(i,"P",{});var sn=r(de);De=a(sn,"In addition, the authors have further pre-trained TAPAS to recognize "),qe=n(sn,"STRONG",{});var nv=r(qe);Te=a(nv,"table entailment"),nv.forEach(t),Ne=a(sn,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),ke=n(sn,"A",{href:!0,rel:!0});var rv=r(ke);Ae=a(rv,"TabFact"),rv.forEach(t),Oe=a(sn,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),Ze=n(sn,"A",{href:!0,rel:!0});var iv=r(Ze);Ps=a(iv,"Understanding tables with intermediate pre-training"),iv.forEach(t),Ss=a(sn," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),sn.forEach(t),ut=d(i),mt=n(i,"IMG",{src:!0,alt:!0,width:!0}),ft=d(i),gt=n(i,"SMALL",{});var Qd=r(gt);Ds=a(Qd,"TAPAS architecture. Taken from the "),tt=n(Qd,"A",{href:!0});var lv=r(tt);Ns=a(lv,"original blog post"),lv.forEach(t),Os=a(Qd,"."),Qd.forEach(t),Ke=d(i),Pe=n(i,"P",{});var an=r(Pe);Ls=a(an,"This model was contributed by "),bt=n(an,"A",{href:!0,rel:!0});var pv=r(bt);ye=a(pv,"nielsr"),pv.forEach(t),kt=a(an,". The Tensorflow version of this model was contributed by "),yt=n(an,"A",{href:!0,rel:!0});var dv=r(yt);Qs=a(dv,"kamalkraj"),dv.forEach(t),jt=a(an,". The original code can be found "),qt=n(an,"A",{href:!0,rel:!0});var cv=r(qt);Is=a(cv,"here"),cv.forEach(t),$t=a(an,"."),an.forEach(t),vs=d(i),Rt=n(i,"P",{});var hv=r(Rt);Et=a(hv,"Tips:"),hv.forEach(t),ws=d(i),Ye=n(i,"UL",{});var on=r(Ye);$e=n(on,"LI",{});var ss=r($e);Ws=a(ss,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),Ft=n(ss,"CODE",{});var uv=r(Ft);ae=a(uv,"reset_position_index_per_cell"),uv.forEach(t),ot=a(ss," parameter of "),Gt=n(ss,"A",{href:!0});var mv=r(Gt);Hs=a(mv,"TapasConfig"),mv.forEach(t),At=a(ss,", which is set to "),os=n(ss,"CODE",{});var fv=r(os);Us=a(fv,"True"),fv.forEach(t),zt=a(ss," by default. The default versions of the models available on the "),xt=n(ss,"A",{href:!0,rel:!0});var gv=r(xt);Bs=a(gv,"hub"),gv.forEach(t),Ct=a(ss," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),ns=n(ss,"CODE",{});var _v=r(ns);Rs=a(_v,'revision="no_reset"'),_v.forEach(t),Mt=a(ss," when calling the "),rs=n(ss,"CODE",{});var Tv=r(rs);Gs=a(Tv,"from_pretrained()"),Tv.forEach(t),Pt=a(ss," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),ss.forEach(t),Vs=d(on),Le=n(on,"LI",{});var qs=r(Le);St=a(qs,"TAPAS is based on BERT, so "),is=n(qs,"CODE",{});var vv=r(is);Ks=a(vv,"TAPAS-base"),vv.forEach(t),Dt=a(qs," for example corresponds to a "),ls=n(qs,"CODE",{});var wv=r(ls);Ys=a(wv,"BERT-base"),wv.forEach(t),ps=a(qs," architecture. Of course, "),Ue=n(qs,"CODE",{});var bv=r(Ue);ds=a(bv,"TAPAS-large"),bv.forEach(t),Ee=a(qs," will result in the best performance (the results reported in the paper are from "),cs=n(qs,"CODE",{});var kv=r(cs);nt=a(kv,"TAPAS-large"),kv.forEach(t),Js=a(qs,"). Results of the various sized models are shown on the "),Nt=n(qs,"A",{href:!0,rel:!0});var yv=r(Nt);Ot=a(yv,"original Github repository"),yv.forEach(t),Xs=a(qs,"."),qs.forEach(t),Zs=d(on),Be=n(on,"LI",{});var zi=r(Be);ea=a(zi,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),hs=n(zi,"CODE",{});var jv=r(hs);us=a(jv,"prev_labels"),jv.forEach(t),et=a(zi," token type ids can be overwritten by the predicted "),Lt=n(zi,"CODE",{});var qv=r(Lt);q=a(qv,"labels"),qv.forEach(t),J=a(zi," of the model to the previous question. See \u201CUsage\u201D section for more info."),zi.forEach(t),xa=d(on),ta=n(on,"LI",{});var $v=r(ta);Ca=a($v,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),$v.forEach(t),on.forEach(t),ca=d(i),Qt=n(i,"H2",{class:!0});var Id=r(Qt);st=n(Id,"A",{id:!0,class:!0,href:!0});var Ev=r(st);sa=n(Ev,"SPAN",{});var Fv=r(sa);E(rt.$$.fragment,Fv),Fv.forEach(t),Ev.forEach(t),Ma=d(Id),aa=n(Id,"SPAN",{});var Av=r(aa);Pa=a(Av,"Usage: fine-tuning"),Av.forEach(t),Id.forEach(t),ha=d(i),Ie=n(i,"P",{});var Wd=r(Ie);ms=a(Wd,"Here we explain how you can fine-tune "),bs=n(Wd,"A",{href:!0});var zv=r(bs);Re=a(zv,"TapasForQuestionAnswering"),zv.forEach(t),Sa=a(Wd," on your own dataset."),Wd.forEach(t),ua=d(i),ks=n(i,"P",{});var xv=r(ks);oa=n(xv,"STRONG",{});var Cv=r(oa);fs=a(Cv,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),Cv.forEach(t),xv.forEach(t),ma=d(i),fe=n(i,"P",{});var Hd=r(fe);Da=a(Hd,"Basically, there are 3 different ways in which one can fine-tune "),ys=n(Hd,"A",{href:!0});var Mv=r(ys);Na=a(Mv,"TapasForQuestionAnswering"),Mv.forEach(t),Oa=a(Hd,", corresponding to the different datasets on which Tapas was fine-tuned:"),Hd.forEach(t),fa=d(i),_t=n(i,"OL",{});var xi=r(_t);na=n(xi,"LI",{});var Pv=r(na);gs=a(Pv,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),Pv.forEach(t),La=d(xi),Fe=n(xi,"LI",{});var Ud=r(Fe);Qa=a(Ud,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ra=n(Ud,"STRONG",{});var Sv=r(ra);Ia=a(Sv,"weak supervision"),Sv.forEach(t),Wa=a(Ud,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Ud.forEach(t),Ha=d(xi),he=n(xi,"LI",{});var Bd=r(he);Ua=a(Bd,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ia=n(Bd,"STRONG",{});var Dv=r(ia);Ba=a(Dv,"strong supervision"),Dv.forEach(t),Ra=a(Bd,". Here, learning the appropriate aggregation operator is much easier."),Bd.forEach(t),xi.forEach(t),ga=d(i),js=n(i,"P",{});var Nv=r(js);Ga=a(Nv,"To summarize:"),Nv.forEach(t),_a=d(i),Ce=n(i,"TABLE",{});var Rd=r(Ce);la=n(Rd,"THEAD",{});var Ov=r(la);It=n(Ov,"TR",{});var Ci=r(It);pa=n(Ci,"TH",{});var Lv=r(pa);Ki=n(Lv,"STRONG",{});var Qv=r(Ki);Mc=a(Qv,"Task"),Qv.forEach(t),Lv.forEach(t),Pc=d(Ci),Yi=n(Ci,"TH",{});var Iv=r(Yi);Ji=n(Iv,"STRONG",{});var Wv=r(Ji);Sc=a(Wv,"Example dataset"),Wv.forEach(t),Iv.forEach(t),Dc=d(Ci),Xi=n(Ci,"TH",{});var Hv=r(Xi);Zi=n(Hv,"STRONG",{});var Uv=r(Zi);Nc=a(Uv,"Description"),Uv.forEach(t),Hv.forEach(t),Ci.forEach(t),Ov.forEach(t),Oc=d(Rd),Va=n(Rd,"TBODY",{});var Mi=r(Va);Ka=n(Mi,"TR",{});var Pi=r(Ka);el=n(Pi,"TD",{});var Bv=r(el);Lc=a(Bv,"Conversational"),Bv.forEach(t),Qc=d(Pi),tl=n(Pi,"TD",{});var Rv=r(tl);Ic=a(Rv,"SQA"),Rv.forEach(t),Wc=d(Pi),sl=n(Pi,"TD",{});var Gv=r(sl);Hc=a(Gv,"Conversational, only cell selection questions"),Gv.forEach(t),Pi.forEach(t),Uc=d(Mi),Ya=n(Mi,"TR",{});var Si=r(Ya);al=n(Si,"TD",{});var Vv=r(al);Bc=a(Vv,"Weak supervision for aggregation"),Vv.forEach(t),Rc=d(Si),ol=n(Si,"TD",{});var Kv=r(ol);Gc=a(Kv,"WTQ"),Kv.forEach(t),Vc=d(Si),nl=n(Si,"TD",{});var Yv=r(nl);Kc=a(Yv,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Yv.forEach(t),Si.forEach(t),Yc=d(Mi),Ja=n(Mi,"TR",{});var Di=r(Ja);rl=n(Di,"TD",{});var Jv=r(rl);Jc=a(Jv,"Strong supervision for aggregation"),Jv.forEach(t),Xc=d(Di),il=n(Di,"TD",{});var Xv=r(il);Zc=a(Xv,"WikiSQL-supervised"),Xv.forEach(t),eh=d(Di),ll=n(Di,"TD",{});var Zv=r(ll);th=a(Zv,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),Zv.forEach(t),Di.forEach(t),Mi.forEach(t),Rd.forEach(t),sd=d(i),E(jo.$$.fragment,i),ad=d(i),qo=n(i,"P",{});var Gd=r(qo);sh=a(Gd,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),pn=n(Gd,"A",{href:!0,rel:!0});var ew=r(pn);ah=a(ew,"here"),ew.forEach(t),oh=a(Gd," for more info."),Gd.forEach(t),od=d(i),$o=n(i,"P",{});var Vd=r($o);nh=a(Vd,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),dn=n(Vd,"A",{href:!0,rel:!0});var tw=r(dn);rh=a(tw,"here"),tw.forEach(t),ih=a(Vd,"."),Vd.forEach(t),nd=d(i),Hr=n(i,"P",{});var sw=r(Hr);pl=n(sw,"STRONG",{});var aw=r(pl);lh=a(aw,"STEP 2: Prepare your data in the SQA format"),aw.forEach(t),sw.forEach(t),rd=d(i),Eo=n(i,"P",{});var Kd=r(Eo);ph=a(Kd,"Second, no matter what you picked above, you should prepare your dataset in the "),cn=n(Kd,"A",{href:!0,rel:!0});var ow=r(cn);dh=a(ow,"SQA"),ow.forEach(t),ch=a(Kd," format. This format is a TSV/CSV file with the following columns:"),Kd.forEach(t),id=d(i),We=n(i,"UL",{});var at=r(We);Ur=n(at,"LI",{});var UT=r(Ur);dl=n(UT,"CODE",{});var nw=r(dl);hh=a(nw,"id"),nw.forEach(t),uh=a(UT,": optional, id of the table-question pair, for bookkeeping purposes."),UT.forEach(t),mh=d(at),Br=n(at,"LI",{});var BT=r(Br);cl=n(BT,"CODE",{});var rw=r(cl);fh=a(rw,"annotator"),rw.forEach(t),gh=a(BT,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),BT.forEach(t),_h=d(at),Rr=n(at,"LI",{});var RT=r(Rr);hl=n(RT,"CODE",{});var iw=r(hl);Th=a(iw,"position"),iw.forEach(t),vh=a(RT,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),RT.forEach(t),wh=d(at),Gr=n(at,"LI",{});var GT=r(Gr);ul=n(GT,"CODE",{});var lw=r(ul);bh=a(lw,"question"),lw.forEach(t),kh=a(GT,": string"),GT.forEach(t),yh=d(at),Vr=n(at,"LI",{});var VT=r(Vr);ml=n(VT,"CODE",{});var pw=r(ml);jh=a(pw,"table_file"),pw.forEach(t),qh=a(VT,": string, name of a csv file containing the tabular data"),VT.forEach(t),$h=d(at),Kr=n(at,"LI",{});var KT=r(Kr);fl=n(KT,"CODE",{});var dw=r(fl);Eh=a(dw,"answer_coordinates"),dw.forEach(t),Fh=a(KT,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),KT.forEach(t),Ah=d(at),Yr=n(at,"LI",{});var YT=r(Yr);gl=n(YT,"CODE",{});var cw=r(gl);zh=a(cw,"answer_text"),cw.forEach(t),xh=a(YT,": list of one or more strings (each string being a cell value that is part of the answer)"),YT.forEach(t),Ch=d(at),Jr=n(at,"LI",{});var JT=r(Jr);_l=n(JT,"CODE",{});var hw=r(_l);Mh=a(hw,"aggregation_label"),hw.forEach(t),Ph=a(JT,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),JT.forEach(t),Sh=d(at),Xr=n(at,"LI",{});var XT=r(Xr);Tl=n(XT,"CODE",{});var uw=r(Tl);Dh=a(uw,"float_answer"),uw.forEach(t),Nh=a(XT,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),XT.forEach(t),at.forEach(t),ld=d(i),Tt=n(i,"P",{});var $s=r(Tt);Oh=a($s,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),hn=n($s,"A",{href:!0,rel:!0});var mw=r(hn);Lh=a(mw,"here"),mw.forEach(t),Qh=a($s,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),un=n($s,"A",{href:!0,rel:!0});var fw=r(un);Ih=a(fw,"here"),fw.forEach(t),Wh=a($s,". Interestingly, these conversion scripts are not perfect (the "),vl=n($s,"CODE",{});var gw=r(vl);Hh=a(gw,"answer_coordinates"),gw.forEach(t),Uh=a($s," and "),wl=n($s,"CODE",{});var _w=r(wl);Bh=a(_w,"float_answer"),_w.forEach(t),Rh=a($s," fields are populated based on the "),bl=n($s,"CODE",{});var Tw=r(bl);Gh=a(Tw,"answer_text"),Tw.forEach(t),Vh=a($s,"), meaning that WTQ and WikiSQL results could actually be improved."),$s.forEach(t),pd=d(i),Zr=n(i,"P",{});var vw=r(Zr);kl=n(vw,"STRONG",{});var ww=r(kl);Kh=a(ww,"STEP 3: Convert your data into tensors using TapasTokenizer"),ww.forEach(t),vw.forEach(t),dd=d(i),E(Fo.$$.fragment,i),cd=d(i),Se=n(i,"P",{});var Je=r(Se);Yh=a(Je,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),yl=n(Je,"STRONG",{});var bw=r(yl);Jh=a(bw,"not conversational"),bw.forEach(t),Xh=a(Je,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),jl=n(Je,"CODE",{});var kw=r(jl);Zh=a(kw,"queries"),kw.forEach(t),eu=a(Je,", "),ql=n(Je,"CODE",{});var yw=r(ql);tu=a(yw,"answer_coordinates"),yw.forEach(t),su=a(Je," and "),$l=n(Je,"CODE",{});var jw=r($l);au=a(jw,"answer_text"),jw.forEach(t),ou=a(Je," per table (in the order of their "),El=n(Je,"CODE",{});var qw=r(El);nu=a(qw,"position"),qw.forEach(t),ru=a(Je,`
index) and batch encode each table with its questions. This will make sure that the `),Fl=n(Je,"CODE",{});var $w=r(Fl);iu=a($w,"prev_labels"),$w.forEach(t),lu=a(Je," token types (see docs of "),ei=n(Je,"A",{href:!0});var Ew=r(ei);pu=a(Ew,"TapasTokenizer"),Ew.forEach(t),du=a(Je,") are set correctly. See "),mn=n(Je,"A",{href:!0,rel:!0});var Fw=r(mn);cu=a(Fw,"this notebook"),Fw.forEach(t),hu=a(Je," for more info. See "),fn=n(Je,"A",{href:!0,rel:!0});var Aw=r(fn);uu=a(Aw,"this notebook"),Aw.forEach(t),mu=a(Je," for more info regarding using the TensorFlow model."),Je.forEach(t),hd=d(i),ti=n(i,"P",{});var zw=r(ti);fu=a(zw,"**STEP 4: Train (fine-tune) the model"),zw.forEach(t),ud=d(i),E(Ao.$$.fragment,i),md=d(i),Xa=n(i,"H2",{class:!0});var Yd=r(Xa);zo=n(Yd,"A",{id:!0,class:!0,href:!0});var xw=r(zo);Al=n(xw,"SPAN",{});var Cw=r(Al);E(gn.$$.fragment,Cw),Cw.forEach(t),xw.forEach(t),gu=d(Yd),zl=n(Yd,"SPAN",{});var Mw=r(zl);_u=a(Mw,"Usage: inference"),Mw.forEach(t),Yd.forEach(t),fd=d(i),E(xo.$$.fragment,i),gd=d(i),vt=n(i,"P",{});var Es=r(vt);Tu=a(Es,"In case of a conversational set-up, then each table-question pair must be provided "),xl=n(Es,"STRONG",{});var Pw=r(xl);vu=a(Pw,"sequentially"),Pw.forEach(t),wu=a(Es," to the model, such that the "),Cl=n(Es,"CODE",{});var Sw=r(Cl);bu=a(Sw,"prev_labels"),Sw.forEach(t),ku=a(Es," token types can be overwritten by the predicted "),Ml=n(Es,"CODE",{});var Dw=r(Ml);yu=a(Dw,"labels"),Dw.forEach(t),ju=a(Es," of the previous table-question pair. Again, more info can be found in "),_n=n(Es,"A",{href:!0,rel:!0});var Nw=r(_n);qu=a(Nw,"this notebook"),Nw.forEach(t),$u=a(Es," (for PyTorch) and "),Tn=n(Es,"A",{href:!0,rel:!0});var Ow=r(Tn);Eu=a(Ow,"this notebook"),Ow.forEach(t),Fu=a(Es," (for TensorFlow)."),Es.forEach(t),_d=d(i),Za=n(i,"H2",{class:!0});var Jd=r(Za);Co=n(Jd,"A",{id:!0,class:!0,href:!0});var Lw=r(Co);Pl=n(Lw,"SPAN",{});var Qw=r(Pl);E(vn.$$.fragment,Qw),Qw.forEach(t),Lw.forEach(t),Au=d(Jd),Sl=n(Jd,"SPAN",{});var Iw=r(Sl);zu=a(Iw,"TAPAS specific outputs"),Iw.forEach(t),Jd.forEach(t),Td=d(i),eo=n(i,"DIV",{class:!0});var Xd=r(eo);E(wn.$$.fragment,Xd),xu=d(Xd),bn=n(Xd,"P",{});var Zd=r(bn);Cu=a(Zd,"Output type of "),si=n(Zd,"A",{href:!0});var Ww=r(si);Mu=a(Ww,"TapasForQuestionAnswering"),Ww.forEach(t),Pu=a(Zd,"."),Zd.forEach(t),Xd.forEach(t),vd=d(i),to=n(i,"H2",{class:!0});var ec=r(to);Mo=n(ec,"A",{id:!0,class:!0,href:!0});var Hw=r(Mo);Dl=n(Hw,"SPAN",{});var Uw=r(Dl);E(kn.$$.fragment,Uw),Uw.forEach(t),Hw.forEach(t),Su=d(ec),Nl=n(ec,"SPAN",{});var Bw=r(Nl);Du=a(Bw,"TapasConfig"),Bw.forEach(t),ec.forEach(t),wd=d(i),Wt=n(i,"DIV",{class:!0});var va=r(Wt);E(yn.$$.fragment,va),Nu=d(va),_s=n(va,"P",{});var wa=r(_s);Ou=a(wa,"This is the configuration class to store the configuration of a "),ai=n(wa,"A",{href:!0});var Rw=r(ai);Lu=a(Rw,"TapasModel"),Rw.forEach(t),Qu=a(wa,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
...
documentation from `),oi=n(wa,"A",{href:!0});var Kw=r(oi);Bu=a(Kw,"PretrainedConfig"),Kw.forEach(t),Ru=a(wa," for more information."),wa.forEach(t),Gu=d(va),jn=n(va,"P",{});var tc=r(jn);Vu=a(tc,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),qn=n(tc,"A",{href:!0,rel:!0});var Yw=r(qn);Ku=a(Yw,"https://github.com/google-research/tapas/tree/master"),Yw.forEach(t),Yu=a(tc,"."),tc.forEach(t),Ju=d(va),Ql=n(va,"P",{});var Jw=r(Ql);Xu=a(Jw,"Example:"),Jw.forEach(t),Zu=d(va),E($n.$$.fragment,va),va.forEach(t),bd=d(i),so=n(i,"H2",{class:!0});var sc=r(so);Po=n(sc,"A",{id:!0,class:!0,href:!0});var Xw=r(Po);Il=n(Xw,"SPAN",{});var Zw=r(Il);E(En.$$.fragment,Zw),Zw.forEach(t),Xw.forEach(t),em=d(sc),Wl=n(sc,"SPAN",{});var eb=r(Wl);tm=a(eb,"TapasTokenizer"),eb.forEach(t),sc.forEach(t),kd=d(i),Ge=n(i,"DIV",{class:!0});var wt=r(Ge);E(Fn.$$.fragment,wt),sm=d(wt),Hl=n(wt,"P",{});var tb=r(Hl);am=a(tb,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),tb.forEach(t),om=d(wt),Qe=n(wt,"P",{});var Xe=r(Qe);nm=a(Xe,"This tokenizer inherits from "),ni=n(Xe,"A",{href:!0});var sb=r(ni);rm=a(sb,"PreTrainedTokenizer"),sb.forEach(t),im=a(Xe,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),ri=n(Xe,"A",{href:!0});var ab=r(ri);lm=a(ab,"TapasTokenizer"),ab.forEach(t),pm=a(Xe,` creates several token type ids to
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Ul=n(Xe,"CODE",{});var ob=r(Ul);dm=a(ob,"segment_ids"),ob.forEach(t),cm=a(Xe,`,
`),Bl=n(Xe,"CODE",{});var nb=r(Bl);hm=a(nb,"column_ids"),nb.forEach(t),um=a(Xe,", "),Rl=n(Xe,"CODE",{});var rb=r(Rl);mm=a(rb,"row_ids"),rb.forEach(t),fm=a(Xe,", "),Gl=n(Xe,"CODE",{});var ib=r(Gl);gm=a(ib,"prev_labels"),ib.forEach(t),_m=a(Xe,", "),Vl=n(Xe,"CODE",{});var lb=r(Vl);Tm=a(lb,"column_ranks"),lb.forEach(t),vm=a(Xe,", "),Kl=n(Xe,"CODE",{});var pb=r(Kl);wm=a(pb,"inv_column_ranks"),pb.forEach(t),bm=a(Xe," and "),Yl=n(Xe,"CODE",{});var db=r(Yl);km=a(db,"numeric_relations"),db.forEach(t),ym=a(Xe,":"),Xe.forEach(t),jm=d(wt),it=n(wt,"UL",{});var as=r(it);Jl=n(as,"LI",{});var cb=r(Jl);qm=a(cb,`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),cb.forEach(t),$m=d(as),Xl=n(as,"LI",{});var hb=r(Xl);Em=a(hb,`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),hb.forEach(t),Fm=d(as),Zl=n(as,"LI",{});var ub=r(Zl);Am=a(ub,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),ub.forEach(t),zm=d(as),ep=n(as,"LI",{});var mb=r(ep);xm=a(mb,`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),mb.forEach(t),Cm=d(as),tp=n(as,"LI",{});var fb=r(tp);Mm=a(fb,`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),fb.forEach(t),Pm=d(as),sp=n(as,"LI",{});var gb=r(sp);Sm=a(gb,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),gb.forEach(t),Dm=d(as),ap=n(as,"LI",{});var _b=r(ap);Nm=a(_b,`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),_b.forEach(t),as.forEach(t),Om=d(wt),ii=n(wt,"P",{});var ZT=r(ii);li=n(ZT,"A",{href:!0});var Tb=r(li);Lm=a(Tb,"TapasTokenizer"),Tb.forEach(t),Qm=a(ZT,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),ZT.forEach(t),Im=d(wt),So=n(wt,"DIV",{class:!0});var ac=r(So);E(An.$$.fragment,ac),Wm=d(ac),op=n(ac,"P",{});var vb=r(op);Hm=a(vb,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),vb.forEach(t),ac.forEach(t),Um=d(wt),Ta=n(wt,"DIV",{class:!0});var Ni=r(Ta);E(zn.$$.fragment,Ni),Bm=d(Ni),xn=n(Ni,"P",{});var oc=r(xn);Rm=a(oc,"Converts logits of "),pi=n(oc,"A",{href:!0});var wb=r(pi);Gm=a(wb,"TapasForQuestionAnswering"),wb.forEach(t),Vm=a(oc,` to actual predicted answer coordinates and optional
...
`),Mn=n(nc,"A",{href:!0,rel:!0});var bb=r(Mn);Jm=a(bb,"here"),bb.forEach(t),Xm=a(nc,"."),nc.forEach(t),Ni.forEach(t),Zm=d(wt),di=n(wt,"DIV",{class:!0});var kb=r(di);E(Pn.$$.fragment,kb),kb.forEach(t),wt.forEach(t),yd=d(i),ao=n(i,"H2",{class:!0});var rc=r(ao);Do=n(rc,"A",{id:!0,class:!0,href:!0});var yb=r(Do);np=n(yb,"SPAN",{});var jb=r(np);E(Sn.$$.fragment,jb),jb.forEach(t),yb.forEach(t),ef=d(rc),rp=n(rc,"SPAN",{});var qb=r(rp);tf=a(qb,"TapasModel"),qb.forEach(t),rc.forEach(t),jd=d(i),lt=n(i,"DIV",{class:!0});var Fs=r(lt);E(Dn.$$.fragment,Fs),sf=d(Fs),Nn=n(Fs,"P",{});var ic=r(Nn);af=a(ic,`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ic.forEach(t),rf=d(Fs),On=n(Fs,"P",{});var lc=r(On);lf=a(lc,"This model is also a PyTorch "),Ln=n(lc,"A",{href:!0,rel:!0});var Eb=r(Ln);pf=a(Eb,"torch.nn.Module"),Eb.forEach(t),df=a(lc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc.forEach(t),cf=d(Fs),Qn=n(Fs,"P",{});var pc=r(Qn);hf=a(pc,"This class is a small change compared to "),hi=n(pc,"A",{href:!0});var Fb=r(hi);uf=a(Fb,"BertModel"),Fb.forEach(t),mf=a(pc,", taking into account the additional token type ids."),pc.forEach(t),ff=d(Fs),In=n(Fs,"P",{});var dc=r(In);gf=a(dc,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
cross-attention is added between the self-attention layers, following the architecture described in `),Wn=n(dc,"A",{href:!0,rel:!0});var Ab=r(Wn);_f=a(Ab,`Attention is
all you need`),Ab.forEach(t),Tf=a(dc,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),dc.forEach(t),vf=d(Fs),Vt=n(Fs,"DIV",{class:!0});var ba=r(Vt);E(Hn.$$.fragment,ba),wf=d(ba),oo=n(ba,"P",{});var Oi=r(oo);bf=a(Oi,"The "),ui=n(Oi,"A",{href:!0});var zb=r(ui);kf=a(zb,"TapasModel"),zb.forEach(t),yf=a(Oi," forward method, overrides the "),ip=n(Oi,"CODE",{});var xb=r(ip);jf=a(xb,"__call__"),xb.forEach(t),qf=a(Oi," special method."),Oi.forEach(t),$f=d(ba),E(No.$$.fragment,ba),Ef=d(ba),lp=n(ba,"P",{});var Cb=r(lp);Ff=a(Cb,"Examples:"),Cb.forEach(t),Af=d(ba),E(Un.$$.fragment,ba),ba.forEach(t),Fs.forEach(t),qd=d(i),no=n(i,"H2",{class:!0});var cc=r(no);Oo=n(cc,"A",{id:!0,class:!0,href:!0});var Mb=r(Oo);pp=n(Mb,"SPAN",{});var Pb=r(pp);E(Bn.$$.fragment,Pb),Pb.forEach(t),Mb.forEach(t),zf=d(cc),dp=n(cc,"SPAN",{});var Sb=r(dp);xf=a(Sb,"TapasForMaskedLM"),Sb.forEach(t),cc.forEach(t),$d=d(i),Ts=n(i,"DIV",{class:!0});var nn=r(Ts);E(Rn.$$.fragment,nn),Cf=d(nn),ro=n(nn,"P",{});var Li=r(ro);Mf=a(Li,"Tapas Model with a "),cp=n(Li,"CODE",{});var Db=r(cp);Pf=a(Db,"language modeling"),Db.forEach(t),Sf=a(Li,` head on top.
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Li.forEach(t),Of=d(nn),Gn=n(nn,"P",{});var hc=r(Gn);Lf=a(hc,"This model is also a PyTorch "),Vn=n(hc,"A",{href:!0,rel:!0});var Ob=r(Vn);Qf=a(Ob,"torch.nn.Module"),Ob.forEach(t),If=a(hc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hc.forEach(t),Wf=d(nn),Kt=n(nn,"DIV",{class:!0});var ka=r(Kt);E(Kn.$$.fragment,ka),Hf=d(ka),io=n(ka,"P",{});var Qi=r(io);Uf=a(Qi,"The "),fi=n(Qi,"A",{href:!0});var Lb=r(fi);Bf=a(Lb,"TapasForMaskedLM"),Lb.forEach(t),Rf=a(Qi," forward method, overrides the "),hp=n(Qi,"CODE",{});var Qb=r(hp);Gf=a(Qb,"__call__"),Qb.forEach(t),Vf=a(Qi," special method."),Qi.forEach(t),Kf=d(ka),E(Lo.$$.fragment,ka),Yf=d(ka),up=n(ka,"P",{});var Ib=r(up);Jf=a(Ib,"Examples:"),Ib.forEach(t),Xf=d(ka),E(Yn.$$.fragment,ka),ka.forEach(t),nn.forEach(t),Ed=d(i),lo=n(i,"H2",{class:!0});var uc=r(lo);Qo=n(uc,"A",{id:!0,class:!0,href:!0});var Wb=r(Qo);mp=n(Wb,"SPAN",{});var Hb=r(mp);E(Jn.$$.fragment,Hb),Hb.forEach(t),Wb.forEach(t),Zf=d(uc),fp=n(uc,"SPAN",{});var Ub=r(fp);eg=a(Ub,"TapasForSequenceClassification"),Ub.forEach(t),uc.forEach(t),Fd=d(i),Ht=n(i,"DIV",{class:!0});var ya=r(Ht);E(Xn.$$.fragment,ya),tg=d(ya),gp=n(ya,"P",{});var Bb=r(gp);sg=a(Bb,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Bb.forEach(t),ag=d(ya),Zn=n(ya,"P",{});var mc=r(Zn);og=a(mc,"This model inherits from "),gi=n(mc,"A",{href:!0});var Rb=r(gi);ng=a(Rb,"PreTrainedModel"),Rb.forEach(t),rg=a(mc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mc.forEach(t),ig=d(ya),er=n(ya,"P",{});var fc=r(er);lg=a(fc,"This model is also a PyTorch "),tr=n(fc,"A",{href:!0,rel:!0});var Gb=r(tr);pg=a(Gb,"torch.nn.Module"),Gb.forEach(t),dg=a(fc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fc.forEach(t),cg=d(ya),Yt=n(ya,"DIV",{class:!0});var ja=r(Yt);E(sr.$$.fragment,ja),hg=d(ja),po=n(ja,"P",{});var Ii=r(po);ug=a(Ii,"The "),_i=n(Ii,"A",{href:!0});var Vb=r(_i);mg=a(Vb,"TapasForSequenceClassification"),Vb.forEach(t),fg=a(Ii," forward method, overrides the "),_p=n(Ii,"CODE",{});var Kb=r(_p);gg=a(Kb,"__call__"),Kb.forEach(t),_g=a(Ii," special method."),Ii.forEach(t),Tg=d(ja),E(Io.$$.fragment,ja),vg=d(ja),Tp=n(ja,"P",{});var Yb=r(Tp);wg=a(Yb,"Examples:"),Yb.forEach(t),bg=d(ja),E(ar.$$.fragment,ja),ja.forEach(t),ya.forEach(t),Ad=d(i),co=n(i,"H2",{class:!0});var gc=r(co);Wo=n(gc,"A",{id:!0,class:!0,href:!0});var Jb=r(Wo);vp=n(Jb,"SPAN",{});var Xb=r(vp);E(or.$$.fragment,Xb),Xb.forEach(t),Jb.forEach(t),kg=d(gc),wp=n(gc,"SPAN",{});var Zb=r(wp);yg=a(Zb,"TapasForQuestionAnswering"),Zb.forEach(t),gc.forEach(t),zd=d(i),Ut=n(i,"DIV",{class:!0});var qa=r(Ut);E(nr.$$.fragment,qa),jg=d(qa),ho=n(qa,"P",{});var Wi=r(ho);qg=a(Wi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),bp=n(Wi,"CODE",{});var ek=r(bp);$g=a(ek,"logits"),ek.forEach(t),Eg=a(Wi," and optional "),kp=n(Wi,"CODE",{});var tk=r(kp);Fg=a(tk,"logits_aggregation"),tk.forEach(t),Ag=a(Wi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Wi.forEach(t),zg=d(qa),rr=n(qa,"P",{});var _c=r(rr);xg=a(_c,"This model inherits from "),Ti=n(_c,"A",{href:!0});var sk=r(Ti);Cg=a(sk,"PreTrainedModel"),sk.forEach(t),Mg=a(_c,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_c.forEach(t),Pg=d(qa),ir=n(qa,"P",{});var Tc=r(ir);Sg=a(Tc,"This model is also a PyTorch "),lr=n(Tc,"A",{href:!0,rel:!0});var ak=r(lr);Dg=a(ak,"torch.nn.Module"),ak.forEach(t),Ng=a(Tc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc.forEach(t),Og=d(qa),Jt=n(qa,"DIV",{class:!0});var $a=r(Jt);E(pr.$$.fragment,$a),Lg=d($a),uo=n($a,"P",{});var Hi=r(uo);Qg=a(Hi,"The "),vi=n(Hi,"A",{href:!0});var ok=r(vi);Ig=a(ok,"TapasForQuestionAnswering"),ok.forEach(t),Wg=a(Hi," forward method, overrides the "),yp=n(Hi,"CODE",{});var nk=r(yp);Hg=a(nk,"__call__"),nk.forEach(t),Ug=a(Hi," special method."),Hi.forEach(t),Bg=d($a),E(Ho.$$.fragment,$a),Rg=d($a),jp=n($a,"P",{});var rk=r(jp);Gg=a(rk,"Examples:"),rk.forEach(t),Vg=d($a),E(dr.$$.fragment,$a),$a.forEach(t),qa.forEach(t),xd=d(i),mo=n(i,"H2",{class:!0});var vc=r(mo);Uo=n(vc,"A",{id:!0,class:!0,href:!0});var ik=r(Uo);qp=n(ik,"SPAN",{});var lk=r(qp);E(cr.$$.fragment,lk),lk.forEach(t),ik.forEach(t),Kg=d(vc),$p=n(vc,"SPAN",{});var pk=r($p);Yg=a(pk,"TFTapasModel"),pk.forEach(t),vc.forEach(t),Cd=d(i),pt=n(i,"DIV",{class:!0});var As=r(pt);E(hr.$$.fragment,As),Jg=d(As),Ep=n(As,"P",{});var dk=r(Ep);Xg=a(dk,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),dk.forEach(t),Zg=d(As),ur=n(As,"P",{});var wc=r(ur);e_=a(wc,"This model inherits from "),wi=n(wc,"A",{href:!0});var ck=r(wi);t_=a(ck,"TFPreTrainedModel"),ck.forEach(t),s_=a(wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wc.forEach(t),a_=d(As),mr=n(As,"P",{});var bc=r(mr);o_=a(bc,"This model is also a "),fr=n(bc,"A",{href:!0,rel:!0});var hk=r(fr);n_=a(hk,"tf.keras.Model"),hk.forEach(t),r_=a(bc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bc.forEach(t),i_=d(As),E(Bo.$$.fragment,As),l_=d(As),Xt=n(As,"DIV",{class:!0});var Ea=r(Xt);E(gr.$$.fragment,Ea),p_=d(Ea),fo=n(Ea,"P",{});var Ui=r(fo);d_=a(Ui,"The "),bi=n(Ui,"A",{href:!0});var uk=r(bi);c_=a(uk,"TFTapasModel"),uk.forEach(t),h_=a(Ui," forward method, overrides the "),Fp=n(Ui,"CODE",{});var mk=r(Fp);u_=a(mk,"__call__"),mk.forEach(t),m_=a(Ui," special method."),Ui.forEach(t),f_=d(Ea),E(Ro.$$.fragment,Ea),g_=d(Ea),Ap=n(Ea,"P",{});var fk=r(Ap);__=a(fk,"Examples:"),fk.forEach(t),T_=d(Ea),E(_r.$$.fragment,Ea),Ea.forEach(t),As.forEach(t),Md=d(i),go=n(i,"H2",{class:!0});var kc=r(go);Go=n(kc,"A",{id:!0,class:!0,href:!0});var gk=r(Go);zp=n(gk,"SPAN",{});var _k=r(zp);E(Tr.$$.fragment,_k),_k.forEach(t),gk.forEach(t),v_=d(kc),xp=n(kc,"SPAN",{});var Tk=r(xp);w_=a(Tk,"TFTapasForMaskedLM"),Tk.forEach(t),kc.forEach(t),Pd=d(i),dt=n(i,"DIV",{class:!0});var zs=r(dt);E(vr.$$.fragment,zs),b_=d(zs),wr=n(zs,"P",{});var yc=r(wr);k_=a(yc,"Tapas Model with a "),Cp=n(yc,"CODE",{});var vk=r(Cp);y_=a(vk,"language modeling"),vk.forEach(t),j_=a(yc," head on top."),yc.forEach(t),q_=d(zs),br=n(zs,"P",{});var jc=r(br);$_=a(jc,"This model inherits from "),ki=n(jc,"A",{href:!0});var wk=r(ki);E_=a(wk,"TFPreTrainedModel"),wk.forEach(t),F_=a(jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jc.forEach(t),A_=d(zs),kr=n(zs,"P",{});var qc=r(kr);z_=a(qc,"This model is also a "),yr=n(qc,"A",{href:!0,rel:!0});var bk=r(yr);x_=a(bk,"tf.keras.Model"),bk.forEach(t),C_=a(qc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qc.forEach(t),M_=d(zs),E(Vo.$$.fragment,zs),P_=d(zs),Zt=n(zs,"DIV",{class:!0});var Fa=r(Zt);E(jr.$$.fragment,Fa),S_=d(Fa),_o=n(Fa,"P",{});var Bi=r(_o);D_=a(Bi,"The "),yi=n(Bi,"A",{href:!0});var kk=r(yi);N_=a(kk,"TFTapasForMaskedLM"),kk.forEach(t),O_=a(Bi," forward method, overrides the "),Mp=n(Bi,"CODE",{});var yk=r(Mp);L_=a(yk,"__call__"),yk.forEach(t),Q_=a(Bi," special method."),Bi.forEach(t),I_=d(Fa),E(Ko.$$.fragment,Fa),W_=d(Fa),Pp=n(Fa,"P",{});var jk=r(Pp);H_=a(jk,"Examples:"),jk.forEach(t),U_=d(Fa),E(qr.$$.fragment,Fa),Fa.forEach(t),zs.forEach(t),Sd=d(i),To=n(i,"H2",{class:!0});var $c=r(To);Yo=n($c,"A",{id:!0,class:!0,href:!0});var qk=r(Yo);Sp=n(qk,"SPAN",{});var $k=r(Sp);E($r.$$.fragment,$k),$k.forEach(t),qk.forEach(t),B_=d($c),Dp=n($c,"SPAN",{});var Ek=r(Dp);R_=a(Ek,"TFTapasForSequenceClassification"),Ek.forEach(t),$c.forEach(t),Dd=d(i),ct=n(i,"DIV",{class:!0});var xs=r(ct);E(Er.$$.fragment,xs),G_=d(xs),Np=n(xs,"P",{});var Fk=r(Np);V_=a(Fk,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Fk.forEach(t),K_=d(xs),Fr=n(xs,"P",{});var Ec=r(Fr);Y_=a(Ec,"This model inherits from "),ji=n(Ec,"A",{href:!0});var Ak=r(ji);J_=a(Ak,"TFPreTrainedModel"),Ak.forEach(t),X_=a(Ec,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fc.forEach(t),aT=d(xs),E(Jo.$$.fragment,xs),oT=d(xs),es=n(xs,"DIV",{class:!0});var Aa=r(es);E(xr.$$.fragment,Aa),nT=d(Aa),vo=n(Aa,"P",{});var Ri=r(vo);rT=a(Ri,"The "),qi=n(Ri,"A",{href:!0});var xk=r(qi);iT=a(xk,"TFTapasForSequenceClassification"),xk.forEach(t),lT=a(Ri," forward method, overrides the "),Op=n(Ri,"CODE",{});var Ck=r(Op);pT=a(Ck,"__call__"),Ck.forEach(t),dT=a(Ri," special method."),Ri.forEach(t),cT=d(Aa),E(Xo.$$.fragment,Aa),hT=d(Aa),Lp=n(Aa,"P",{});var Mk=r(Lp);uT=a(Mk,"Examples:"),Mk.forEach(t),mT=d(Aa),E(Cr.$$.fragment,Aa),Aa.forEach(t),xs.forEach(t),Nd=d(i),wo=n(i,"H2",{class:!0});var Ac=r(wo);Zo=n(Ac,"A",{id:!0,class:!0,href:!0});var Pk=r(Zo);Qp=n(Pk,"SPAN",{});var Sk=r(Qp);E(Mr.$$.fragment,Sk),Sk.forEach(t),Pk.forEach(t),fT=d(Ac),Ip=n(Ac,"SPAN",{});var Dk=r(Ip);gT=a(Dk,"TFTapasForQuestionAnswering"),Dk.forEach(t),Ac.forEach(t),Od=d(i),ht=n(i,"DIV",{class:!0});var Cs=r(ht);E(Pr.$$.fragment,Cs),_T=d(Cs),bo=n(Cs,"P",{});var Gi=r(bo);TT=a(Gi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Wp=n(Gi,"CODE",{});var Nk=r(Wp);vT=a(Nk,"logits"),Nk.forEach(t),wT=a(Gi," and optional "),Hp=n(Gi,"CODE",{});var Ok=r(Hp);bT=a(Ok,"logits_aggregation"),Ok.forEach(t),kT=a(Gi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Gi.forEach(t),yT=d(Cs),Sr=n(Cs,"P",{});var zc=r(Sr);jT=a(zc,"This model inherits from "),$i=n(zc,"A",{href:!0});var Lk=r($i);qT=a(Lk,"TFPreTrainedModel"),Lk.forEach(t),$T=a(zc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
