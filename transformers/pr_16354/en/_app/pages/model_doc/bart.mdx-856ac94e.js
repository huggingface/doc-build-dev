...
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function rx(j){let p,z,T,w,x,v,y,B,se,A,$,pe,ke,tt,ye,Te,ot,Ze,V,N,Ue,re,C,O,nt,he,ue,at,J,st,rt,L,Me,ve,Ye,Z,ie,it,dt,X,lt,we,Re,F,P,H,Dt,He,de,Gt,Qe,Wt,le,me,xe,Pe,ce,Ve,Ut,Je,Rt,ac,gt,xn,Lp,zn,Dp,Gp,Wp,ct,Up,kr,Rp,Hp,Fi,Qp,Vp,Fn,Jp,Xp,Kp,jo,Bn,Zp,Yp,qn,eh,th,sc,Ht,Mo,Bi,$n,oh,qi,nh,rc,Ee,pt,ah,$i,sh,rh,yr,ih,dh,Tr,lh,ch,ph,Qt,hh,vr,uh,mh,ji,fh,_h,gh,Vt,bh,Mi,kh,yh,Pi,Th,vh,wh,wr,xr,xh,zh,Fh,Jt,Bh,Ei,qh,$h,Ci,jh,Mh,ic,Xt,Po,Ai,jn,Ph,Oi,Eh,dc,bt,Ch,Si,Ah,Oh,Ii,Sh,Ih,lc,Mn,cc,Kt,Eo,Ni,Pn,Nh,Li,Lh,pc,ze,En,Dh,Zt,Gh,zr,Wh,Uh,Cn,Rh,Hh,Qh,Yt,Vh,Fr,Jh,Xh,Br,Kh,Zh,Yh,Di,eu,tu,An,hc,eo,Co,Gi,On,ou,Wi,nu,uc,E,Sn,au,Ui,su,ru,Ri,iu,du,In,lu,Nn,cu,Hi,pu,hu,uu,Ao,mu,Ln,fu,qr,_u,gu,bu,kt,Dn,ku,Qi,yu,Tu,Gn,$r,vu,Vi,wu,xu,jr,zu,Ji,Fu,Bu,Oo,Wn,qu,Xi,$u,ju,So,Un,Mu,Ki,Pu,Eu,Io,Rn,Cu,Hn,Au,Zi,Ou,Su,mc,to,No,Yi,Qn,Iu,ed,Nu,fc,W,Vn,Lu,Jn,Du,td,Gu,Wu,Uu,od,Ru,Hu,Xn,Qu,Kn,Vu,nd,Ju,Xu,Ku,Lo,Zu,Zn,Yu,Mr,em,tm,om,Do,Yn,nm,ad,am,_c,oo,Go,sd,ea,sm,rd,rm,gc,Xe,ta,im,oa,dm,Pr,lm,cm,pm,na,hm,aa,um,mm,fm,Ce,sa,_m,no,gm,Er,bm,km,id,ym,Tm,vm,Wo,wm,dd,xm,zm,ra,bc,ao,Uo,ld,ia,Fm,cd,Bm,kc,Ke,da,qm,la,$m,Cr,jm,Mm,Pm,ca,Em,pa,Cm,Am,Om,Y,ha,Sm,so,Im,Ar,Nm,Lm,pd,Dm,Gm,Wm,Ro,Um,hd,Rm,Hm,ua,Qm,ud,Vm,Jm,ma,yc,ro,Ho,md,fa,Xm,fd,Km,Tc,Fe,_a,Zm,_d,Ym,ef,ga,tf,Or,of,nf,af,ba,sf,ka,rf,df,lf,D,ya,cf,io,pf,Sr,hf,uf,gd,mf,ff,_f,Qo,gf,bd,bf,kf,Ta,yf,va,Tf,kd,vf,wf,wa,xf,xa,vc,lo,Vo,yd,za,zf,Td,Ff,wc,Be,Fa,Bf,co,qf,vd,$f,jf,wd,Mf,Pf,Ef,Ba,Cf,Ir,Af,Of,Sf,qa,If,$a,Nf,Lf,Df,fe,ja,Gf,po,Wf,Nr,Uf,Rf,xd,Hf,Qf,Vf,Jo,Jf,zd,Xf,Kf,Ma,Zf,Pa,xc,ho,Xo,Fd,Ea,Yf,Bd,e_,zc,uo,Ca,t_,yt,Aa,o_,qd,n_,a_,Oa,Fc,mo,Ko,$d,Sa,s_,jd,r_,Bc,qe,Ia,i_,Na,d_,Lr,l_,c_,p_,La,h_,Da,u_,m_,f_,Zo,__,Ae,Ga,g_,fo,b_,Dr,k_,y_,Md,T_,v_,w_,Yo,x_,Pd,z_,F_,Wa,qc,_o,en,Ed,Ua,B_,Cd,q_,$c,$e,Ra,$_,Ha,j_,Gr,M_,P_,E_,Qa,C_,Va,A_,O_,S_,tn,I_,ee,Ja,N_,go,L_,Wr,D_,G_,Ad,W_,U_,R_,on,H_,Od,Q_,V_,Xa,J_,Sd,X_,K_,Ka,jc,bo,nn,Id,Za,Z_,Nd,Y_,Mc,U,Ya,eg,es,tg,Ur,og,ng,ag,ts,sg,os,rg,ig,dg,Ld,lg,cg,ht,Dd,ns,pg,hg,Gd,as,ug,mg,Wd,ss,fg,_g,Ud,rs,gg,bg,Oe,is,kg,ko,yg,Rd,Tg,vg,Hd,wg,xg,zg,an,Fg,Qd,Bg,qg,ds,$g,Tt,ls,jg,Vd,Mg,Pg,cs,Eg,vt,ps,Cg,Jd,Ag,Og,hs,Pc,yo,sn,Xd,us,Sg,Kd,Ig,Ec,R,ms,Ng,fs,Lg,Rr,Dg,Gg,Wg,_s,Ug,gs,Rg,Hg,Qg,Zd,Vg,Jg,ut,Yd,bs,Xg,Kg,el,ks,Zg,Yg,tl,ys,eb,tb,ol,Ts,ob,nb,te,vs,ab,To,sb,nl,rb,ib,al,db,lb,cb,rn,pb,sl,hb,ub,ws,mb,rl,fb,_b,xs,gb,wt,zs,bb,il,kb,yb,Fs,Tb,xt,Bs,vb,dl,wb,xb,qs,Cc,vo,dn,ll,$s,zb,cl,Fb,Ac,S,js,Bb,pl,qb,$b,Ms,jb,Hr,Mb,Pb,Eb,Ps,Cb,Es,Ab,Ob,Sb,hl,Ib,Nb,mt,ul,Cs,Lb,Db,ml,As,Gb,Wb,fl,Os,Ub,Rb,_l,Ss,Hb,Qb,Se,Is,Vb,wo,Jb,gl,Xb,Kb,bl,Zb,Yb,ek,ln,tk,kl,ok,nk,Ns,ak,zt,Ls,sk,yl,rk,ik,Ds,dk,Ft,Gs,lk,Tl,ck,pk,Ws,Oc,xo,cn,vl,Us,hk,wl,uk,Sc,I,Rs,mk,zo,fk,xl,_k,gk,zl,bk,kk,yk,Hs,Tk,Qr,vk,wk,xk,Qs,zk,Vs,Fk,Bk,qk,Fl,$k,jk,ft,Bl,Js,Mk,Pk,ql,Xs,Ek,Ck,$l,Ks,Ak,Ok,jl,Zs,Sk,Ik,Ie,Ys,Nk,Fo,Lk,Ml,Dk,Gk,Pl,Wk,Uk,Rk,pn,Hk,El,Qk,Vk,er,Jk,Bt,tr,Xk,Cl,Kk,Zk,or,Yk,qt,nr,ey,Al,ty,oy,ar,Ic,Bo,hn,Ol,sr,ny,Sl,ay,Nc,K,rr,sy,Il,ry,iy,ir,dy,Vr,ly,cy,py,dr,hy,lr,uy,my,fy,Nl,_y,gy,_t,Ll,cr,by,ky,Dl,pr,yy,Ty,Gl,hr,vy,wy,Wl,ur,xy,zy,Ne,mr,Fy,qo,By,Ul,qy,$y,Rl,jy,My,Py,un,Ey,Hl,Cy,Ay,fr,Lc;return v=new Q({}),re=new Q({}),Ve=new Q({}),$n=new Q({}),jn=new Q({}),Mn=new M({props:{code:`from transformers import BartForConditionalGeneration, BartTokenizer
...
model = BartForSequenceClassification.from_pretrained(
    "facebook/bart-base", problem_type="multi_label_classification", num_labels=num_labels
)
...
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;facebook/bart-base&quot;</span>, problem_type=<span class="hljs-string">&quot;multi_label_classification&quot;</span>, num_labels=num_labels
<span class="hljs-meta">... </span>)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=n("meta"),z=d(),T=n("h1"),w=n("a"),x=n("span"),m(v.$$.fragment),y=d(),B=n("span"),se=r("BART"),A=d(),$=n("p"),pe=n("strong"),ke=r("DISCLAIMER:"),tt=r(" If you see something strange, file a "),ye=n("a"),Te=r("Github Issue"),ot=r(` and assign
...
`),zn=n("a"),Dp=r("examples/pytorch/summarization/"),Gp=r("."),Wp=d(),ct=n("li"),Up=r("An example of how to train "),kr=n("a"),Rp=r("BartForConditionalGeneration"),Hp=r(" with a Hugging Face "),Fi=n("code"),Qp=r("datasets"),Vp=r(`
...
`),Mi=n("code"),kh=r("forced_bos_token_id=0"),yh=r(`. This only works, however, if the string you pass to
...
mask-filling tasks.`),ic=d(),Xt=n("h2"),Po=n("a"),Ai=n("span"),m(jn.$$.fragment),Ph=d(),Oi=n("span"),Eh=r("Mask Filling"),dc=d(),bt=n("p"),Ch=r("The "),Si=n("code"),Ah=r("facebook/bart-base"),Oh=r(" and "),Ii=n("code"),Sh=r("facebook/bart-large"),Ih=r(" checkpoints can be used to fill multi-token masks."),lc=d(),m(Mn.$$.fragment),cc=d(),Kt=n("h2"),Eo=n("a"),Ni=n("span"),m(Pn.$$.fragment),Nh=d(),Li=n("span"),Lh=r("BartConfig"),pc=d(),ze=n("div"),m(En.$$.fragment),Dh=d(),Zt=n("p"),Gh=r("This is the configuration class to store the configuration of a "),zr=n("a"),Wh=r("BartModel"),Uh=r(`. It is used to instantiate a BART
...
and behavior.`),fm=d(),Ce=n("div"),m(sa.$$.fragment),_m=d(),no=n("p"),gm=r("The "),Er=n("a"),bm=r("BartModel"),km=r(" forward method, overrides the "),id=n("code"),ym=r("__call__"),Tm=r(" special method."),vm=d(),m(Wo.$$.fragment),wm=d(),dd=n("p"),xm=r("Example:"),zm=d(),m(ra.$$.fragment),bc=d(),ao=n("h2"),Uo=n("a"),ld=n("span"),m(ia.$$.fragment),Fm=d(),cd=n("span"),Bm=r("BartForConditionalGeneration"),kc=d(),Ke=n("div"),m(da.$$.fragment),qm=d(),la=n("p"),$m=r(`The BART Model with a language modeling head. Can be used for summarization.
...
behavior.`),f_=d(),m(Zo.$$.fragment),__=d(),Ae=n("div"),m(Ga.$$.fragment),g_=d(),fo=n("p"),b_=r("The "),Dr=n("a"),k_=r("TFBartModel"),y_=r(" forward method, overrides the "),Md=n("code"),T_=r("__call__"),v_=r(" special method."),w_=d(),m(Yo.$$.fragment),x_=d(),Pd=n("p"),z_=r("Example:"),F_=d(),m(Wa.$$.fragment),qc=d(),_o=n("h2"),en=n("a"),Ed=n("span"),m(Ua.$$.fragment),B_=d(),Cd=n("span"),q_=r("TFBartForConditionalGeneration"),$c=d(),$e=n("div"),m(Ra.$$.fragment),$_=d(),Ha=n("p"),j_=r(`The BART Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Qg=d(),Zd=n("p"),Vg=r("Finally, this model supports inherent JAX features such as:"),Jg=d(),ut=n("ul"),Yd=n("li"),bs=n("a"),Xg=r("Just-In-Time (JIT) compilation"),Kg=d(),el=n("li"),ks=n("a"),Zg=r("Automatic Differentiation"),Yg=d(),tl=n("li"),ys=n("a"),eb=r("Vectorization"),tb=d(),ol=n("li"),Ts=n("a"),ob=r("Parallelization"),nb=d(),te=n("div"),m(vs.$$.fragment),ab=d(),To=n("p"),sb=r("The "),nl=n("code"),rb=r("FlaxBartPreTrainedModel"),ib=r("forward method, overrides the "),al=n("code"),db=r("__call__"),lb=r(" special method."),cb=d(),m(rn.$$.fragment),pb=d(),sl=n("p"),hb=r("Summarization example:"),ub=d(),m(ws.$$.fragment),mb=d(),rl=n("p"),fb=r("Mask filling example:"),_b=d(),m(xs.$$.fragment),gb=d(),wt=n("div"),m(zs.$$.fragment),bb=d(),il=n("p"),kb=r("Example:"),yb=d(),m(Fs.$$.fragment),Tb=d(),xt=n("div"),m(Bs.$$.fragment),vb=d(),dl=n("p"),wb=r("Example:"),xb=d(),m(qs.$$.fragment),Cc=d(),vo=n("h2"),dn=n("a"),ll=n("span"),m($s.$$.fragment),zb=d(),cl=n("span"),Fb=r("FlaxBartForSequenceClassification"),Ac=d(),S=n("div"),m(js.$$.fragment),Bb=d(),pl=n("p"),qb=r(`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),$b=d(),Ms=n("p"),jb=r("This model inherits from "),Hr=n("a"),Mb=r("FlaxPreTrainedModel"),Pb=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eb=d(),Ps=n("p"),Cb=r(`This model is also a Flax Linen
`),Es=n("a"),Ab=r("flax.nn.Module"),Ob=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sb=d(),hl=n("p"),Ib=r("Finally, this model supports inherent JAX features such as:"),Nb=d(),mt=n("ul"),ul=n("li"),Cs=n("a"),Lb=r("Just-In-Time (JIT) compilation"),Db=d(),ml=n("li"),As=n("a"),Gb=r("Automatic Differentiation"),Wb=d(),fl=n("li"),Os=n("a"),Ub=r("Vectorization"),Rb=d(),_l=n("li"),Ss=n("a"),Hb=r("Parallelization"),Qb=d(),Se=n("div"),m(Is.$$.fragment),Vb=d(),wo=n("p"),Jb=r("The "),gl=n("code"),Xb=r("FlaxBartPreTrainedModel"),Kb=r("forward method, overrides the "),bl=n("code"),Zb=r("__call__"),Yb=r(" special method."),ek=d(),m(ln.$$.fragment),tk=d(),kl=n("p"),ok=r("Example:"),nk=d(),m(Ns.$$.fragment),ak=d(),zt=n("div"),m(Ls.$$.fragment),sk=d(),yl=n("p"),rk=r("Example:"),ik=d(),m(Ds.$$.fragment),dk=d(),Ft=n("div"),m(Gs.$$.fragment),lk=d(),Tl=n("p"),ck=r("Example:"),pk=d(),m(Ws.$$.fragment),Oc=d(),xo=n("h2"),cn=n("a"),vl=n("span"),m(Us.$$.fragment),hk=d(),wl=n("span"),uk=r("FlaxBartForQuestionAnswering"),Sc=d(),I=n("div"),m(Rs.$$.fragment),mk=d(),zo=n("p"),fk=r(`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),xl=n("code"),_k=r("span start logits"),gk=r(" and "),zl=n("code"),bk=r("span end logits"),kk=r(")."),yk=d(),Hs=n("p"),Tk=r("This model inherits from "),Qr=n("a"),vk=r("FlaxPreTrainedModel"),wk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xk=d(),Qs=n("p"),zk=r(`This model is also a Flax Linen
`),Vs=n("a"),Fk=r("flax.nn.Module"),Bk=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),qk=d(),Fl=n("p"),$k=r("Finally, this model supports inherent JAX features such as:"),jk=d(),ft=n("ul"),Bl=n("li"),Js=n("a"),Mk=r("Just-In-Time (JIT) compilation"),Pk=d(),ql=n("li"),Xs=n("a"),Ek=r("Automatic Differentiation"),Ck=d(),$l=n("li"),Ks=n("a"),Ak=r("Vectorization"),Ok=d(),jl=n("li"),Zs=n("a"),Sk=r("Parallelization"),Ik=d(),Ie=n("div"),m(Ys.$$.fragment),Nk=d(),Fo=n("p"),Lk=r("The "),Ml=n("code"),Dk=r("FlaxBartPreTrainedModel"),Gk=r("forward method, overrides the "),Pl=n("code"),Wk=r("__call__"),Uk=r(" special method."),Rk=d(),m(pn.$$.fragment),Hk=d(),El=n("p"),Qk=r("Example:"),Vk=d(),m(er.$$.fragment),Jk=d(),Bt=n("div"),m(tr.$$.fragment),Xk=d(),Cl=n("p"),Kk=r("Example:"),Zk=d(),m(or.$$.fragment),Yk=d(),qt=n("div"),m(nr.$$.fragment),ey=d(),Al=n("p"),ty=r("Example:"),oy=d(),m(ar.$$.fragment),Ic=d(),Bo=n("h2"),hn=n("a"),Ol=n("span"),m(sr.$$.fragment),ny=d(),Sl=n("span"),ay=r("FlaxBartForCausalLM"),Nc=d(),K=n("div"),m(rr.$$.fragment),sy=d(),Il=n("p"),ry=r(`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
...
This is different than some other modeling APIs. A typical use case of this feature is mask filling.`),Kr.forEach(t),gh=l($t),Vt=a($t,"LI",{});var Zr=s(Vt);bh=i(Zr,`Model predictions are intended to be identical to the original implementation when
`),Mi=a(Zr,"CODE",{});var iT=s(Mi);kh=i(iT,"forced_bos_token_id=0"),iT.forEach(t),yh=i(Zr,`. This only works, however, if the string you pass to
...
mask-filling tasks.`),Yr.forEach(t),$t.forEach(t),ic=l(o),Xt=a(o,"H2",{class:!0});var Uc=s(Xt);Po=a(Uc,"A",{id:!0,class:!0,href:!0});var hT=s(Po);Ai=a(hT,"SPAN",{});var uT=s(Ai);f(jn.$$.fragment,uT),uT.forEach(t),hT.forEach(t),Ph=l(Uc),Oi=a(Uc,"SPAN",{});var mT=s(Oi);Eh=i(mT,"Mask Filling"),mT.forEach(t),Uc.forEach(t),dc=l(o),bt=a(o,"P",{});var ei=s(bt);Ch=i(ei,"The "),Si=a(ei,"CODE",{});var fT=s(Si);Ah=i(fT,"facebook/bart-base"),fT.forEach(t),Oh=i(ei," and "),Ii=a(ei,"CODE",{});var _T=s(Ii);Sh=i(_T,"facebook/bart-large"),_T.forEach(t),Ih=i(ei," checkpoints can be used to fill multi-token masks."),ei.forEach(t),lc=l(o),f(Mn.$$.fragment,o),cc=l(o),Kt=a(o,"H2",{class:!0});var Rc=s(Kt);Eo=a(Rc,"A",{id:!0,class:!0,href:!0});var gT=s(Eo);Ni=a(gT,"SPAN",{});var bT=s(Ni);f(Pn.$$.fragment,bT),bT.forEach(t),gT.forEach(t),Nh=l(Rc),Li=a(Rc,"SPAN",{});var kT=s(Li);Lh=i(kT,"BartConfig"),kT.forEach(t),Rc.forEach(t),pc=l(o),ze=a(o,"DIV",{class:!0});var jt=s(ze);f(En.$$.fragment,jt),Dh=l(jt),Zt=a(jt,"P",{});var ti=s(Zt);Gh=i(ti,"This is the configuration class to store the configuration of a "),zr=a(ti,"A",{href:!0});var yT=s(zr);Wh=i(yT,"BartModel"),yT.forEach(t),Uh=i(ti,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
...
this superclass for more information regarding those methods.`),Vc.forEach(t),bu=l(G),kt=a(G,"DIV",{class:!0});var ni=s(kt);f(Dn.$$.fragment,ni),ku=l(ni),Qi=a(ni,"P",{});var PT=s(Qi);yu=i(PT,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),fm=l(gn),Ce=a(gn,"DIV",{class:!0});var Mt=s(Ce);f(sa.$$.fragment,Mt),_m=l(Mt),no=a(Mt,"P",{});var ai=s(no);gm=i(ai,"The "),Er=a(ai,"A",{href:!0});var KT=s(Er);bm=i(KT,"BartModel"),KT.forEach(t),km=i(ai," forward method, overrides the "),id=a(ai,"CODE",{});var ZT=s(id);ym=i(ZT,"__call__"),ZT.forEach(t),Tm=i(ai," special method."),ai.forEach(t),vm=l(Mt),f(Wo.$$.fragment,Mt),wm=l(Mt),dd=a(Mt,"P",{});var YT=s(dd);xm=i(YT,"Example:"),YT.forEach(t),zm=l(Mt),f(ra.$$.fragment,Mt),Mt.forEach(t),gn.forEach(t),bc=l(o),ao=a(o,"H2",{class:!0});var dp=s(ao);Uo=a(dp,"A",{id:!0,class:!0,href:!0});var ev=s(Uo);ld=a(ev,"SPAN",{});var tv=s(ld);f(ia.$$.fragment,tv),tv.forEach(t),ev.forEach(t),Fm=l(dp),cd=a(dp,"SPAN",{});var ov=s(cd);Bm=i(ov,"BartForConditionalGeneration"),ov.forEach(t),dp.forEach(t),kc=l(o),Ke=a(o,"DIV",{class:!0});var bn=s(Ke);f(da.$$.fragment,bn),qm=l(bn),la=a(bn,"P",{});var lp=s(la);$m=i(lp,`The BART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp.forEach(t),Pm=l(bn),ca=a(bn,"P",{});var cp=s(ca);Em=i(cp,"This model is also a PyTorch "),pa=a(cp,"A",{href:!0,rel:!0});var av=s(pa);Cm=i(av,"torch.nn.Module"),av.forEach(t),Am=i(cp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),Om=l(bn),Y=a(bn,"DIV",{class:!0});var Le=s(Y);f(ha.$$.fragment,Le),Sm=l(Le),so=a(Le,"P",{});var si=s(so);Im=i(si,"The "),Ar=a(si,"A",{href:!0});var sv=s(Ar);Nm=i(sv,"BartForConditionalGeneration"),sv.forEach(t),Lm=i(si," forward method, overrides the "),pd=a(si,"CODE",{});var rv=s(pd);Dm=i(rv,"__call__"),rv.forEach(t),Gm=i(si," special method."),si.forEach(t),Wm=l(Le),f(Ro.$$.fragment,Le),Um=l(Le),hd=a(Le,"P",{});var iv=s(hd);Rm=i(iv,"Summarization example:"),iv.forEach(t),Hm=l(Le),f(ua.$$.fragment,Le),Qm=l(Le),ud=a(Le,"P",{});var dv=s(ud);Vm=i(dv,"Mask filling example:"),dv.forEach(t),Jm=l(Le),f(ma.$$.fragment,Le),Le.forEach(t),bn.forEach(t),yc=l(o),ro=a(o,"H2",{class:!0});var pp=s(ro);Ho=a(pp,"A",{id:!0,class:!0,href:!0});var lv=s(Ho);md=a(lv,"SPAN",{});var cv=s(md);f(fa.$$.fragment,cv),cv.forEach(t),lv.forEach(t),Xm=l(pp),fd=a(pp,"SPAN",{});var pv=s(fd);Km=i(pv,"BartForSequenceClassification"),pv.forEach(t),pp.forEach(t),Tc=l(o),Fe=a(o,"DIV",{class:!0});var Pt=s(Fe);f(_a.$$.fragment,Pt),Zm=l(Pt),_d=a(Pt,"P",{});var hv=s(_d);Ym=i(hv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),af=l(Pt),ba=a(Pt,"P",{});var up=s(ba);sf=i(up,"This model is also a PyTorch "),ka=a(up,"A",{href:!0,rel:!0});var mv=s(ka);rf=i(mv,"torch.nn.Module"),mv.forEach(t),df=i(up,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),lf=l(Pt),D=a(Pt,"DIV",{class:!0});var oe=s(D);f(ya.$$.fragment,oe),cf=l(oe),io=a(oe,"P",{});var ri=s(io);pf=i(ri,"The "),Sr=a(ri,"A",{href:!0});var fv=s(Sr);hf=i(fv,"BartForSequenceClassification"),fv.forEach(t),uf=i(ri," forward method, overrides the "),gd=a(ri,"CODE",{});var _v=s(gd);mf=i(_v,"__call__"),_v.forEach(t),ff=i(ri," special method."),ri.forEach(t),_f=l(oe),f(Qo.$$.fragment,oe),gf=l(oe),bd=a(oe,"P",{});var gv=s(bd);bf=i(gv,"Example of single-label classification:"),gv.forEach(t),kf=l(oe),f(Ta.$$.fragment,oe),yf=l(oe),f(va.$$.fragment,oe),Tf=l(oe),kd=a(oe,"P",{});var bv=s(kd);vf=i(bv,"Example of multi-label classification:"),bv.forEach(t),wf=l(oe),f(wa.$$.fragment,oe),xf=l(oe),f(xa.$$.fragment,oe),oe.forEach(t),Pt.forEach(t),vc=l(o),lo=a(o,"H2",{class:!0});var mp=s(lo);Vo=a(mp,"A",{id:!0,class:!0,href:!0});var kv=s(Vo);yd=a(kv,"SPAN",{});var yv=s(yd);f(za.$$.fragment,yv),yv.forEach(t),kv.forEach(t),zf=l(mp),Td=a(mp,"SPAN",{});var Tv=s(Td);Ff=i(Tv,"BartForQuestionAnswering"),Tv.forEach(t),mp.forEach(t),wc=l(o),Be=a(o,"DIV",{class:!0});var Et=s(Be);f(Fa.$$.fragment,Et),Bf=l(Et),co=a(Et,"P",{});var ii=s(co);qf=i(ii,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p.forEach(t),Df=l(Et),fe=a(Et,"DIV",{class:!0});var et=s(fe);f(ja.$$.fragment,et),Gf=l(et),po=a(et,"P",{});var di=s(po);Wf=i(di,"The "),Nr=a(di,"A",{href:!0});var Fv=s(Nr);Uf=i(Fv,"BartForQuestionAnswering"),Fv.forEach(t),Rf=i(di," forward method, overrides the "),xd=a(di,"CODE",{});var Bv=s(xd);Hf=i(Bv,"__call__"),Bv.forEach(t),Qf=i(di," special method."),di.forEach(t),Vf=l(et),f(Jo.$$.fragment,et),Jf=l(et),zd=a(et,"P",{});var qv=s(zd);Xf=i(qv,"Example:"),qv.forEach(t),Kf=l(et),f(Ma.$$.fragment,et),Zf=l(et),f(Pa.$$.fragment,et),et.forEach(t),Et.forEach(t),xc=l(o),ho=a(o,"H2",{class:!0});var gp=s(ho);Xo=a(gp,"A",{id:!0,class:!0,href:!0});var $v=s(Xo);Fd=a($v,"SPAN",{});var jv=s(Fd);f(Ea.$$.fragment,jv),jv.forEach(t),$v.forEach(t),Yf=l(gp),Bd=a(gp,"SPAN",{});var Mv=s(Bd);e_=i(Mv,"BartForCausalLM"),Mv.forEach(t),gp.forEach(t),zc=l(o),uo=a(o,"DIV",{class:!0});var bp=s(uo);f(Ca.$$.fragment,bp),t_=l(bp),yt=a(bp,"DIV",{class:!0});var li=s(yt);f(Aa.$$.fragment,li),o_=l(li),qd=a(li,"P",{});var Pv=s(qd);n_=i(Pv,"Example:"),Pv.forEach(t),a_=l(li),f(Oa.$$.fragment,li),li.forEach(t),bp.forEach(t),Fc=l(o),mo=a(o,"H2",{class:!0});var kp=s(mo);Ko=a(kp,"A",{id:!0,class:!0,href:!0});var Ev=s(Ko);$d=a(Ev,"SPAN",{});var Cv=s($d);f(Sa.$$.fragment,Cv),Cv.forEach(t),Ev.forEach(t),s_=l(kp),jd=a(kp,"SPAN",{});var Av=s(jd);r_=i(Av,"TFBartModel"),Av.forEach(t),kp.forEach(t),Bc=l(o),qe=a(o,"DIV",{class:!0});var Ct=s(qe);f(Ia.$$.fragment,Ct),i_=l(Ct),Na=a(Ct,"P",{});var yp=s(Na);d_=i(yp,`The bare BART Model outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bp.forEach(t),dg=l(ge),Ld=a(ge,"P",{});var t1=s(Ld);lg=i(t1,"Finally, this model supports inherent JAX features such as:"),t1.forEach(t),cg=l(ge),ht=a(ge,"UL",{});var kn=s(ht);Dd=a(kn,"LI",{});var o1=s(Dd);ns=a(o1,"A",{href:!0,rel:!0});var n1=s(ns);pg=i(n1,"Just-In-Time (JIT) compilation"),n1.forEach(t),o1.forEach(t),hg=l(kn),Gd=a(kn,"LI",{});var a1=s(Gd);as=a(a1,"A",{href:!0,rel:!0});var s1=s(as);ug=i(s1,"Automatic Differentiation"),s1.forEach(t),a1.forEach(t),mg=l(kn),Wd=a(kn,"LI",{});var r1=s(Wd);ss=a(r1,"A",{href:!0,rel:!0});var i1=s(ss);fg=i(i1,"Vectorization"),i1.forEach(t),r1.forEach(t),_g=l(kn),Ud=a(kn,"LI",{});var d1=s(Ud);rs=a(d1,"A",{href:!0,rel:!0});var l1=s(rs);gg=i(l1,"Parallelization"),l1.forEach(t),d1.forEach(t),kn.forEach(t),bg=l(ge),Oe=a(ge,"DIV",{class:!0});var St=s(Oe);f(is.$$.fragment,St),kg=l(St),ko=a(St,"P",{});var hi=s(ko);yg=i(hi,"The "),Rd=a(hi,"CODE",{});var c1=s(Rd);Tg=i(c1,"FlaxBartPreTrainedModel"),c1.forEach(t),vg=i(hi,"forward method, overrides the "),Hd=a(hi,"CODE",{});var p1=s(Hd);wg=i(p1,"__call__"),p1.forEach(t),xg=i(hi," special method."),hi.forEach(t),zg=l(St),f(an.$$.fragment,St),Fg=l(St),Qd=a(St,"P",{});var h1=s(Qd);Bg=i(h1,"Example:"),h1.forEach(t),qg=l(St),f(ds.$$.fragment,St),St.forEach(t),$g=l(ge),Tt=a(ge,"DIV",{class:!0});var ui=s(Tt);f(ls.$$.fragment,ui),jg=l(ui),Vd=a(ui,"P",{});var u1=s(Vd);Mg=i(u1,"Example:"),u1.forEach(t),Pg=l(ui),f(cs.$$.fragment,ui),ui.forEach(t),Eg=l(ge),vt=a(ge,"DIV",{class:!0});var mi=s(vt);f(ps.$$.fragment,mi),Cg=l(mi),Jd=a(mi,"P",{});var m1=s(Jd);Ag=i(m1,"Example:"),m1.forEach(t),Og=l(mi),f(hs.$$.fragment,mi),mi.forEach(t),ge.forEach(t),Pc=l(o),yo=a(o,"H2",{class:!0});var qp=s(yo);sn=a(qp,"A",{id:!0,class:!0,href:!0});var f1=s(sn);Xd=a(f1,"SPAN",{});var _1=s(Xd);f(us.$$.fragment,_1),_1.forEach(t),f1.forEach(t),Sg=l(qp),Kd=a(qp,"SPAN",{});var g1=s(Kd);Ig=i(g1,"FlaxBartForConditionalGeneration"),g1.forEach(t),qp.forEach(t),Ec=l(o),R=a(o,"DIV",{class:!0});var be=s(R);f(ms.$$.fragment,be),Ng=l(be),fs=a(be,"P",{});var $p=s(fs);Lg=i($p,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rr=a($p,"A",{href:!0});var b1=s(Rr);Dg=i(b1,"FlaxPreTrainedModel"),b1.forEach(t),Gg=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),Wg=l(be),_s=a(be,"P",{});var jp=s(_s);Ug=i(jp,`This model is also a Flax Linen
`),gs=a(jp,"A",{href:!0,rel:!0});var k1=s(gs);Rg=i(k1,"flax.nn.Module"),k1.forEach(t),Hg=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Qg=l(be),Zd=a(be,"P",{});var y1=s(Zd);Vg=i(y1,"Finally, this model supports inherent JAX features such as:"),y1.forEach(t),Jg=l(be),ut=a(be,"UL",{});var yn=s(ut);Yd=a(yn,"LI",{});var T1=s(Yd);bs=a(T1,"A",{href:!0,rel:!0});var v1=s(bs);Xg=i(v1,"Just-In-Time (JIT) compilation"),v1.forEach(t),T1.forEach(t),Kg=l(yn),el=a(yn,"LI",{});var w1=s(el);ks=a(w1,"A",{href:!0,rel:!0});var x1=s(ks);Zg=i(x1,"Automatic Differentiation"),x1.forEach(t),w1.forEach(t),Yg=l(yn),tl=a(yn,"LI",{});var z1=s(tl);ys=a(z1,"A",{href:!0,rel:!0});var F1=s(ys);eb=i(F1,"Vectorization"),F1.forEach(t),z1.forEach(t),tb=l(yn),ol=a(yn,"LI",{});var B1=s(ol);Ts=a(B1,"A",{href:!0,rel:!0});var q1=s(Ts);ob=i(q1,"Parallelization"),q1.forEach(t),B1.forEach(t),yn.forEach(t),nb=l(be),te=a(be,"DIV",{class:!0});var Ge=s(te);f(vs.$$.fragment,Ge),ab=l(Ge),To=a(Ge,"P",{});var fi=s(To);sb=i(fi,"The "),nl=a(fi,"CODE",{});var $1=s(nl);rb=i($1,"FlaxBartPreTrainedModel"),$1.forEach(t),ib=i(fi,"forward method, overrides the "),al=a(fi,"CODE",{});var j1=s(al);db=i(j1,"__call__"),j1.forEach(t),lb=i(fi," special method."),fi.forEach(t),cb=l(Ge),f(rn.$$.fragment,Ge),pb=l(Ge),sl=a(Ge,"P",{});var M1=s(sl);hb=i(M1,"Summarization example:"),M1.forEach(t),ub=l(Ge),f(ws.$$.fragment,Ge),mb=l(Ge),rl=a(Ge,"P",{});var P1=s(rl);fb=i(P1,"Mask filling example:"),P1.forEach(t),_b=l(Ge),f(xs.$$.fragment,Ge),Ge.forEach(t),gb=l(be),wt=a(be,"DIV",{class:!0});var _i=s(wt);f(zs.$$.fragment,_i),bb=l(_i),il=a(_i,"P",{});var E1=s(il);kb=i(E1,"Example:"),E1.forEach(t),yb=l(_i),f(Fs.$$.fragment,_i),_i.forEach(t),Tb=l(be),xt=a(be,"DIV",{class:!0});var gi=s(xt);f(Bs.$$.fragment,gi),vb=l(gi),dl=a(gi,"P",{});var C1=s(dl);wb=i(C1,"Example:"),C1.forEach(t),xb=l(gi),f(qs.$$.fragment,gi),gi.forEach(t),be.forEach(t),Cc=l(o),vo=a(o,"H2",{class:!0});var Mp=s(vo);dn=a(Mp,"A",{id:!0,class:!0,href:!0});var A1=s(dn);ll=a(A1,"SPAN",{});var O1=s(ll);f($s.$$.fragment,O1),O1.forEach(t),A1.forEach(t),zb=l(Mp),cl=a(Mp,"SPAN",{});var S1=s(cl);Fb=i(S1,"FlaxBartForSequenceClassification"),S1.forEach(t),Mp.forEach(t),Ac=l(o),S=a(o,"DIV",{class:!0});var ne=s(S);f(js.$$.fragment,ne),Bb=l(ne),pl=a(ne,"P",{});var I1=s(pl);qb=i(I1,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),I1.forEach(t),$b=l(ne),Ms=a(ne,"P",{});var Pp=s(Ms);jb=i(Pp,"This model inherits from "),Hr=a(Pp,"A",{href:!0});var N1=s(Hr);Mb=i(N1,"FlaxPreTrainedModel"),N1.forEach(t),Pb=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pp.forEach(t),Eb=l(ne),Ps=a(ne,"P",{});var Ep=s(Ps);Cb=i(Ep,`This model is also a Flax Linen
`),Es=a(Ep,"A",{href:!0,rel:!0});var L1=s(Es);Ab=i(L1,"flax.nn.Module"),L1.forEach(t),Ob=i(Ep,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ep.forEach(t),Sb=l(ne),hl=a(ne,"P",{});var D1=s(hl);Ib=i(D1,"Finally, this model supports inherent JAX features such as:"),D1.forEach(t),Nb=l(ne),mt=a(ne,"UL",{});var Tn=s(mt);ul=a(Tn,"LI",{});var G1=s(ul);Cs=a(G1,"A",{href:!0,rel:!0});var W1=s(Cs);Lb=i(W1,"Just-In-Time (JIT) compilation"),W1.forEach(t),G1.forEach(t),Db=l(Tn),ml=a(Tn,"LI",{});var U1=s(ml);As=a(U1,"A",{href:!0,rel:!0});var R1=s(As);Gb=i(R1,"Automatic Differentiation"),R1.forEach(t),U1.forEach(t),Wb=l(Tn),fl=a(Tn,"LI",{});var H1=s(fl);Os=a(H1,"A",{href:!0,rel:!0});var Q1=s(Os);Ub=i(Q1,"Vectorization"),Q1.forEach(t),H1.forEach(t),Rb=l(Tn),_l=a(Tn,"LI",{});var V1=s(_l);Ss=a(V1,"A",{href:!0,rel:!0});var J1=s(Ss);Hb=i(J1,"Parallelization"),J1.forEach(t),V1.forEach(t),Tn.forEach(t),Qb=l(ne),Se=a(ne,"DIV",{class:!0});var It=s(Se);f(Is.$$.fragment,It),Vb=l(It),wo=a(It,"P",{});var bi=s(wo);Jb=i(bi,"The "),gl=a(bi,"CODE",{});var X1=s(gl);Xb=i(X1,"FlaxBartPreTrainedModel"),X1.forEach(t),Kb=i(bi,"forward method, overrides the "),bl=a(bi,"CODE",{});var K1=s(bl);Zb=i(K1,"__call__"),K1.forEach(t),Yb=i(bi," special method."),bi.forEach(t),ek=l(It),f(ln.$$.fragment,It),tk=l(It),kl=a(It,"P",{});var Z1=s(kl);ok=i(Z1,"Example:"),Z1.forEach(t),nk=l(It),f(Ns.$$.fragment,It),It.forEach(t),ak=l(ne),zt=a(ne,"DIV",{class:!0});var ki=s(zt);f(Ls.$$.fragment,ki),sk=l(ki),yl=a(ki,"P",{});var Y1=s(yl);rk=i(Y1,"Example:"),Y1.forEach(t),ik=l(ki),f(Ds.$$.fragment,ki),ki.forEach(t),dk=l(ne),Ft=a(ne,"DIV",{class:!0});var yi=s(Ft);f(Gs.$$.fragment,yi),lk=l(yi),Tl=a(yi,"P",{});var ew=s(Tl);ck=i(ew,"Example:"),ew.forEach(t),pk=l(yi),f(Ws.$$.fragment,yi),yi.forEach(t),ne.forEach(t),Oc=l(o),xo=a(o,"H2",{class:!0});var Cp=s(xo);cn=a(Cp,"A",{id:!0,class:!0,href:!0});var tw=s(cn);vl=a(tw,"SPAN",{});var ow=s(vl);f(Us.$$.fragment,ow),ow.forEach(t),tw.forEach(t),hk=l(Cp),wl=a(Cp,"SPAN",{});var nw=s(wl);uk=i(nw,"FlaxBartForQuestionAnswering"),nw.forEach(t),Cp.forEach(t),Sc=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);f(Rs.$$.fragment,ae),mk=l(ae),zo=a(ae,"P",{});var Ti=s(zo);fk=i(Ti,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),xl=a(Ti,"CODE",{});var aw=s(xl);_k=i(aw,"span start logits"),aw.forEach(t),gk=i(Ti," and "),zl=a(Ti,"CODE",{});var sw=s(zl);bk=i(sw,"span end logits"),sw.forEach(t),kk=i(Ti,")."),Ti.forEach(t),yk=l(ae),Hs=a(ae,"P",{});var Ap=s(Hs);Tk=i(Ap,"This model inherits from "),Qr=a(Ap,"A",{href:!0});var rw=s(Qr);vk=i(rw,"FlaxPreTrainedModel"),rw.forEach(t),wk=i(Ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ap.forEach(t),xk=l(ae),Qs=a(ae,"P",{});var Op=s(Qs);zk=i(Op,`This model is also a Flax Linen
`),Vs=a(Op,"A",{href:!0,rel:!0});var iw=s(Vs);Fk=i(iw,"flax.nn.Module"),iw.forEach(t),Bk=i(Op,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Op.forEach(t),qk=l(ae),Fl=a(ae,"P",{});var dw=s(Fl);$k=i(dw,"Finally, this model supports inherent JAX features such as:"),dw.forEach(t),jk=l(ae),ft=a(ae,"UL",{});var vn=s(ft);Bl=a(vn,"LI",{});var lw=s(Bl);Js=a(lw,"A",{href:!0,rel:!0});var cw=s(Js);Mk=i(cw,"Just-In-Time (JIT) compilation"),cw.forEach(t),lw.forEach(t),Pk=l(vn),ql=a(vn,"LI",{});var pw=s(ql);Xs=a(pw,"A",{href:!0,rel:!0});var hw=s(Xs);Ek=i(hw,"Automatic Differentiation"),hw.forEach(t),pw.forEach(t),Ck=l(vn),$l=a(vn,"LI",{});var uw=s($l);Ks=a(uw,"A",{href:!0,rel:!0});var mw=s(Ks);Ak=i(mw,"Vectorization"),mw.forEach(t),uw.forEach(t),Ok=l(vn),jl=a(vn,"LI",{});var fw=s(jl);Zs=a(fw,"A",{href:!0,rel:!0});var _w=s(Zs);Sk=i(_w,"Parallelization"),_w.forEach(t),fw.forEach(t),vn.forEach(t),Ik=l(ae),Ie=a(ae,"DIV",{class:!0});var Nt=s(Ie);f(Ys.$$.fragment,Nt),Nk=l(Nt),Fo=a(Nt,"P",{});var vi=s(Fo);Lk=i(vi,"The "),Ml=a(vi,"CODE",{});var gw=s(Ml);Dk=i(gw,"FlaxBartPreTrainedModel"),gw.forEach(t),Gk=i(vi,"forward method, overrides the "),Pl=a(vi,"CODE",{});var bw=s(Pl);Wk=i(bw,"__call__"),bw.forEach(t),Uk=i(vi," special method."),vi.forEach(t),Rk=l(Nt),f(pn.$$.fragment,Nt),Hk=l(Nt),El=a(Nt,"P",{});var kw=s(El);Qk=i(kw,"Example:"),kw.forEach(t),Vk=l(Nt),f(er.$$.fragment,Nt),Nt.forEach(t),Jk=l(ae),Bt=a(ae,"DIV",{class:!0});var wi=s(Bt);f(tr.$$.fragment,wi),Xk=l(wi),Cl=a(wi,"P",{});var yw=s(Cl);Kk=i(yw,"Example:"),yw.forEach(t),Zk=l(wi),f(or.$$.fragment,wi),wi.forEach(t),Yk=l(ae),qt=a(ae,"DIV",{class:!0});var xi=s(qt);f(nr.$$.fragment,xi),ey=l(xi),Al=a(xi,"P",{});var Tw=s(Al);ty=i(Tw,"Example:"),Tw.forEach(t),oy=l(xi),f(ar.$$.fragment,xi),xi.forEach(t),ae.forEach(t),Ic=l(o),Bo=a(o,"H2",{class:!0});var Sp=s(Bo);hn=a(Sp,"A",{id:!0,class:!0,href:!0});var vw=s(hn);Ol=a(vw,"SPAN",{});var ww=s(Ol);f(sr.$$.fragment,ww),ww.forEach(t),vw.forEach(t),ny=l(Sp),Sl=a(Sp,"SPAN",{});var xw=s(Sl);ay=i(xw,"FlaxBartForCausalLM"),xw.forEach(t),Sp.forEach(t),Nc=l(o),K=a(o,"DIV",{class:!0});var We=s(K);f(rr.$$.fragment,We),sy=l(We),Il=a(We,"P",{});var zw=s(Il);ry=i(zw,`Bart Decoder Model with a language modeling head on top (linear layer with weights tied to the input embeddings)
