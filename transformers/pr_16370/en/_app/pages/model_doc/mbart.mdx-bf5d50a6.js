...
separator.`),e0.forEach(t),Ct.forEach(t),Ug=l(ue),Ko=a(ue,"DIV",{class:!0});var Zh=s(Ko);m(Ra.$$.fragment,Zh),Xg=l(Zh),Bl=a(Zh,"P",{});var t0=s(Bl);Hg=i(t0,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),t0.forEach(t),Zh.forEach(t),Vg=l(ue),Zo=a(ue,"DIV",{class:!0});var Yh=s(Zo);m(Ua.$$.fragment,Yh),Qg=l(Yh),$l=a(Yh,"P",{});var o0=s($l);Jg=i(o0,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),o0.forEach(t),Yh.forEach(t),ue.forEach(t),Gp=l(o),po=a(o,"H2",{class:!0});var eu=s(po);Yo=a(eu,"A",{id:!0,class:!0,href:!0});var n0=s(Yo);Fl=a(n0,"SPAN",{});var a0=s(Fl);m(Xa.$$.fragment,a0),a0.forEach(t),n0.forEach(t),Kg=l(eu),jl=a(eu,"SPAN",{});var s0=s(jl);Zg=i(s0,"MBartModel"),s0.forEach(t),eu.forEach(t),Wp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);m(Ha.$$.fragment,Bn),Yg=l(Bn),Va=a(Bn,"P",{});var tu=s(Va);ek=i(tu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);m(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Ni=s(ho);lk=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var d0=s(gi);ck=i(d0,"MBartModel"),d0.forEach(t),pk=i(Ni," forward method, overrides the "),El=a(Ni,"CODE",{});var l0=s(El);hk=i(l0,"__call__"),l0.forEach(t),uk=i(Ni," special method."),Ni.forEach(t),mk=l(St),m(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var c0=s(Pl);_k=i(c0,"Example:"),c0.forEach(t),gk=l(St),m(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p0=s(tn);Cl=a(p0,"SPAN",{});var h0=s(Cl);m(Ya.$$.fragment,h0),h0.forEach(t),p0.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var u0=s(Sl);bk=i(u0,"MBartForConditionalGeneration"),u0.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);m(es.$$.fragment,$n),yk=l($n),ts=a($n,"P",{});var au=s(ts);vk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l($n),Z=a($n,"DIV",{class:!0});var Le=s(Z);m(as.$$.fragment,Le),$k=l(Le),mo=a(Le,"P",{});var Di=s(mo);Fk=i(Di,"The "),bi=a(Di,"A",{href:!0});var _0=s(bi);jk=i(_0,"MBartForConditionalGeneration"),_0.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var g0=s(Al);Pk=i(g0,"__call__"),g0.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),m(on.$$.fragment,Le),Ak=l(Le),Ol=a(Le,"P",{});var k0=s(Ol);Ok=i(k0,"Translation example:"),k0.forEach(t),Ik=l(Le),m(ss.$$.fragment,Le),Nk=l(Le),Il=a(Le,"P",{});var b0=s(Il);Dk=i(b0,"Mask filling example:"),b0.forEach(t),Lk=l(Le),m(rs.$$.fragment,Le),Le.forEach(t),$n.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var y0=s(nn);Nl=a(y0,"SPAN",{});var v0=s(Nl);m(is.$$.fragment,v0),v0.forEach(t),y0.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T0=s(Dl);Wk=i(T0,"MBartForQuestionAnswering"),T0.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);m(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var Ot=s(Ae);m(hs.$$.fragment,Ot),sb=l(Ot),go=a(Ot,"P",{});var Gi=s(go);rb=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var q0=s(vi);ib=i(q0,"MBartForQuestionAnswering"),q0.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var B0=s(Wl);lb=i(B0,"__call__"),B0.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(Ot),m(an.$$.fragment,Ot),hb=l(Ot),Rl=a(Ot,"P",{});var $0=s(Rl);ub=i($0,"Example:"),$0.forEach(t),mb=l(Ot),m(us.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var F0=s(sn);Ul=a(F0,"SPAN",{});var j0=s(Ul);m(ms.$$.fragment,j0),j0.forEach(t),F0.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E0=s(Xl);_b=i(E0,"MBartForSequenceClassification"),E0.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var It=s(Be);m(fs.$$.fragment,It),gb=l(It),Hl=a(It,"P",{});var P0=s(Hl);kb=i(P0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(It),Y=a(It,"DIV",{class:!0});var Ge=s(Y);m(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);$b=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var A0=s(Mi);Fb=i(A0,"MBartForSequenceClassification"),A0.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var O0=s(Vl);Eb=i(O0,"__call__"),O0.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),m(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var I0=s(Ql);Ab=i(I0,"Example of single-label classification:"),I0.forEach(t),Ob=l(Ge),m(ys.$$.fragment,Ge),Ib=l(Ge),Jl=a(Ge,"P",{});var N0=s(Jl);Nb=i(N0,"Example of multi-label classification:"),N0.forEach(t),Db=l(Ge),m(vs.$$.fragment,Ge),Ge.forEach(t),It.forEach(t),Jp=l(o),yo=a(o,"H2",{class:!0});var hu=s(yo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D0=s(dn);Kl=a(D0,"SPAN",{});var L0=s(Kl);m(Ts.$$.fragment,L0),L0.forEach(t),D0.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G0=s(Zl);Gb=i(G0,"MBartForCausalLM"),G0.forEach(t),hu.forEach(t),Kp=l(o),vo=a(o,"DIV",{class:!0});var uu=s(vo);m(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);m(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var W0=s(Yl);Ub=i(W0,"Example:"),W0.forEach(t),Xb=l(Ri),m(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var R0=s(ln);ec=a(R0,"SPAN",{});var U0=s(ec);m(zs.$$.fragment,U0),U0.forEach(t),R0.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X0=s(tc);Vb=i(X0,"TFMBartModel"),X0.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Nt=s($e);m(qs.$$.fragment,Nt),Qb=l(Nt),Bs=a(Nt,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Nt),$s=a(Nt,"P",{});var _u=s($s);ey=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var V0=s(Fs);ty=i(V0,"tf.keras.Model"),V0.forEach(t),oy=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),ny=l(Nt),m(cn.$$.fragment,Nt),ay=l(Nt),Oe=a(Nt,"DIV",{class:!0});var Dt=s(Oe);m(js.$$.fragment,Dt),sy=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);ry=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q0=s(xi);iy=i(Q0,"TFMBartModel"),Q0.forEach(t),dy=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J0=s(oc);ly=i(J0,"__call__"),J0.forEach(t),cy=i(Ui," special method."),Ui.forEach(t),py=l(Dt),m(pn.$$.fragment,Dt),hy=l(Dt),nc=a(Dt,"P",{});var K0=s(nc);uy=i(K0,"Example:"),K0.forEach(t),my=l(Dt),m(Es.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z0=s(hn);ac=a(Z0,"SPAN",{});var Y0=s(ac);m(Ps.$$.fragment,Y0),Y0.forEach(t),Z0.forEach(t),fy=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_y=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);m(Cs.$$.fragment,Lt),gy=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);ky=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
