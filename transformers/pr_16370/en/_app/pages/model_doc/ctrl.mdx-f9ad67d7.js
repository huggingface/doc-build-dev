...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function Zc(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function ep(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function tp(J){let h,E,m,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
...
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,m,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function op(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function np(J){let h,E,m,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),Ce=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ye=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),m=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var fe=i(M);_e=s(fe,"having all inputs as a list, tuple or dict in the first positional arguments."),fe.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var qe=i(A);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);ke=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),P.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),Ce=s(K," or "),W=r(K,"CODE",{});var Pe=i(W);S=s(Pe,"model([input_ids, attention_mask, token_type_ids])"),Pe.forEach(t),K.forEach(t),te=d(D),I=r(D,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,m,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function sp(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function ap(J){let h,E,m,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),pe=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),Ce=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ye=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),m=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var fe=i(M);_e=s(fe,"having all inputs as a list, tuple or dict in the first positional arguments."),fe.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var qe=i(A);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);ke=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),P.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),Ce=s(K," or "),W=r(K,"CODE",{});var Pe=i(W);S=s(Pe,"model([input_ids, attention_mask, token_type_ids])"),Pe.forEach(t),K.forEach(t),te=d(D),I=r(D,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,m,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(p){p&&t(h),p&&t(m),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(F)}}}function rp(J){let h,E,m,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(_,"CODE",{});var M=i(m);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,m),e(m,g),e(h,v)},d(T){T&&t(h)}}}function ip(J){let h,E,m,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,pe,x,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye,p,$,ie,Ae,fe,N,qe,Oe,He,D,P,We,ze,K,Be,Pe,we,Ue,En,fa,ma,Yo,Fn,ga,_a,Rs,Ye,Ta,Gt,va,ka,Kt,ba,Ca,Ms,ct,Rt,qn,Xt,ya,zn,wa,Es,Le,Jt,La,Je,$a,Zo,Ra,Ma,en,Ea,Fa,Qt,qa,za,Pa,pt,xa,tn,ja,Sa,on,Ia,Na,Da,Pn,Aa,Oa,Yt,Fs,ht,Mt,xn,Zt,Ha,jn,Wa,qs,Ne,eo,Ba,Sn,Ua,Va,to,Ga,nn,Ka,Xa,Ja,sn,oo,zs,ut,Et,In,no,Qa,Nn,Ya,Ps,$e,so,Za,Dn,er,tr,ao,or,an,nr,sr,ar,ro,rr,io,ir,lr,dr,xe,lo,cr,ft,pr,rn,hr,ur,An,fr,mr,gr,Ft,_r,On,Tr,vr,co,xs,mt,qt,Hn,po,kr,Wn,br,js,Re,ho,Cr,Bn,yr,wr,uo,Lr,ln,$r,Rr,Mr,fo,Er,mo,Fr,qr,zr,je,go,Pr,gt,xr,dn,jr,Sr,Un,Ir,Nr,Dr,zt,Ar,Vn,Or,Hr,_o,Ss,_t,Pt,Gn,To,Wr,Kn,Br,Is,Me,vo,Ur,Ee,Vr,cn,Gr,Kr,Xn,Xr,Jr,Jn,Qr,Yr,Qn,Zr,ei,Yn,ti,oi,ni,ko,si,pn,ai,ri,ii,bo,li,Co,di,ci,pi,B,yo,hi,Tt,ui,hn,fi,mi,Zn,gi,_i,Ti,xt,vi,es,ki,bi,wo,Ci,Lo,yi,ts,wi,Li,$o,$i,Ro,Ns,vt,jt,os,Mo,Ri,ns,Mi,Ds,de,Eo,Ei,ss,Fi,qi,Fo,zi,un,Pi,xi,ji,qo,Si,zo,Ii,Ni,Di,St,Ai,Se,Po,Oi,kt,Hi,fn,Wi,Bi,as,Ui,Vi,Gi,It,Ki,rs,Xi,Ji,xo,As,bt,Nt,is,jo,Qi,ls,Yi,Os,ce,So,Zi,ds,el,tl,Io,ol,mn,nl,sl,al,No,rl,Do,il,ll,dl,Dt,cl,Ie,Ao,pl,Ct,hl,gn,ul,fl,cs,ml,gl,_l,At,Tl,ps,vl,kl,Oo,Hs,yt,Ot,hs,Ho,bl,us,Cl,Ws,X,Wo,yl,fs,wl,Ll,_n,Tn,$l,Rl,Ml,De,El,ms,Fl,ql,gs,zl,Pl,_s,xl,jl,Ts,Sl,Il,Nl,Bo,Dl,vn,Al,Ol,Hl,Uo,Wl,Vo,Bl,Ul,Vl,Ht,Gl,me,Go,Kl,wt,Xl,kn,Jl,Ql,vs,Yl,Zl,ed,Wt,td,ks,od,nd,Ko,sd,Xo,Bs;return T=new dt({}),Z=new dt({}),Xt=new dt({}),Jt=new Fe({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16370/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),Xo=new Qe({props:{code:`labels = tf.constant(1)
loss = model(**inputs, labels=labels).loss
round(float(loss), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = tf.constant(<span class="hljs-number">1</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){h=a("meta"),E=l(),m=a("h1"),g=a("a"),v=a("span"),k(T.$$.fragment),_=l(),M=a("span"),_e=n("CTRL"),Y=l(),R=a("h2"),Q=a("a"),A=a("span"),k(Z.$$.fragment),Te=l(),O=a("span"),ve=n("Overview"),pe=l(),x=a("p"),j=n("CTRL model was proposed in "),ee=a("a"),ne=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),ke=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
TensorFlow models accepts `),Pe=a("code"),we=n("past"),Ue=n(" as input. Using the "),En=a("code"),fa=n("past_key_values"),ma=n(` value prevents the model from re-computing
...
and behavior.`),dr=l(),xe=a("div"),k(lo.$$.fragment),cr=l(),ft=a("p"),pr=n("The "),rn=a("a"),hr=n("CTRLModel"),ur=n(" forward method, overrides the "),An=a("code"),fr=n("__call__"),mr=n(" special method."),gr=l(),k(Ft.$$.fragment),_r=l(),On=a("p"),Tr=n("Example:"),vr=l(),k(co.$$.fragment),xs=l(),mt=a("h2"),qt=a("a"),Hn=a("span"),k(po.$$.fragment),kr=l(),Wn=a("span"),br=n("CTRLLMHeadModel"),js=l(),Re=a("div"),k(ho.$$.fragment),Cr=l(),Bn=a("p"),yr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mr=l(),fo=a("p"),Er=n("This model is also a PyTorch "),mo=a("a"),Fr=n("torch.nn.Module"),qr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=l(),B=a("div"),k(yo.$$.fragment),hi=l(),Tt=a("p"),ui=n("The "),hn=a("a"),fi=n("CTRLForSequenceClassification"),mi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),k(xt.$$.fragment),vi=l(),es=a("p"),ki=n("Example of single-label classification:"),bi=l(),k(wo.$$.fragment),Ci=l(),k(Lo.$$.fragment),yi=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),k($o.$$.fragment),$i=l(),k(Ro.$$.fragment),Ns=l(),vt=a("h2"),jt=a("a"),os=a("span"),k(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Ds=l(),de=a("div"),k(Eo.$$.fragment),Ei=l(),ss=a("p"),Fi=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Fo=a("p"),zi=n("This model inherits from "),un=a("a"),Pi=n("TFPreTrainedModel"),xi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ji=l(),qo=a("p"),Si=n("This model is also a "),zo=a("a"),Ii=n("tf.keras.Model"),Ni=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Di=l(),k(St.$$.fragment),Ai=l(),Se=a("div"),k(Po.$$.fragment),Oi=l(),kt=a("p"),Hi=n("The "),fn=a("a"),Wi=n("TFCTRLModel"),Bi=n(" forward method, overrides the "),as=a("code"),Ui=n("__call__"),Vi=n(" special method."),Gi=l(),k(It.$$.fragment),Ki=l(),rs=a("p"),Xi=n("Example:"),Ji=l(),k(xo.$$.fragment),As=l(),bt=a("h2"),Nt=a("a"),is=a("span"),k(jo.$$.fragment),Qi=l(),ls=a("span"),Yi=n("TFCTRLLMHeadModel"),Os=l(),ce=a("div"),k(So.$$.fragment),Zi=l(),ds=a("p"),el=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),tl=l(),Io=a("p"),ol=n("This model inherits from "),mn=a("a"),nl=n("TFPreTrainedModel"),sl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),al=l(),No=a("p"),rl=n("This model is also a "),Do=a("a"),il=n("tf.keras.Model"),ll=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dl=l(),k(Dt.$$.fragment),cl=l(),Ie=a("div"),k(Ao.$$.fragment),pl=l(),Ct=a("p"),hl=n("The "),gn=a("a"),ul=n("TFCTRLLMHeadModel"),fl=n(" forward method, overrides the "),cs=a("code"),ml=n("__call__"),gl=n(" special method."),_l=l(),k(At.$$.fragment),Tl=l(),ps=a("p"),vl=n("Example:"),kl=l(),k(Oo.$$.fragment),Hs=l(),yt=a("h2"),Ot=a("a"),hs=a("span"),k(Ho.$$.fragment),bl=l(),us=a("span"),Cl=n("TFCTRLForSequenceClassification"),Ws=l(),X=a("div"),k(Wo.$$.fragment),yl=l(),fs=a("p"),wl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),Ll=l(),_n=a("p"),Tn=a("a"),$l=n("TFCTRLForSequenceClassification"),Rl=n(` uses the last token in order to do the classification, as other causal models
...
`),ms=a("code"),Fl=n("pad_token_id"),ql=n(` is defined in the configuration, it finds the last token that is not a padding token in each row. If
...
the left.`),ud.forEach(t),Ae=d(Bt),fe=r(Bt,"LI",{});var Vs=i(fe);N=s(Vs,`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows CTRL to generate syntactically coherent text as it can be
observed in the `),qe=r(Vs,"EM",{});var fd=i(qe);Oe=s(fd,"run_generation.py"),fd.forEach(t),He=s(Vs," example script."),Vs.forEach(t),D=d(Bt),P=r(Bt,"LI",{});var Ze=i(P);We=s(Ze,"The PyTorch models can take the "),ze=r(Ze,"CODE",{});var md=i(ze);K=s(md,"past_key_values"),md.forEach(t),Be=s(Ze,` as input, which is the previously computed key/value attention pairs.
TensorFlow models accepts `),Pe=r(Ze,"CODE",{});var gd=i(Pe);we=s(gd,"past"),gd.forEach(t),Ue=s(Ze," as input. Using the "),En=r(Ze,"CODE",{});var _d=i(En);fa=s(_d,"past_key_values"),_d.forEach(t),ma=s(Ze,` value prevents the model from re-computing
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),dr=d(tt),xe=r(tt,"DIV",{class:!0});var ot=i(xe);b(lo.$$.fragment,ot),cr=d(ot),ft=r(ot,"P",{});var yn=i(ft);pr=s(yn,"The "),rn=r(yn,"A",{href:!0});var Wd=i(rn);hr=s(Wd,"CTRLModel"),Wd.forEach(t),ur=s(yn," forward method, overrides the "),An=r(yn,"CODE",{});var Bd=i(An);fr=s(Bd,"__call__"),Bd.forEach(t),mr=s(yn," special method."),yn.forEach(t),gr=d(ot),b(Ft.$$.fragment,ot),_r=d(ot),On=r(ot,"P",{});var Ud=i(On);Tr=s(Ud,"Example:"),Ud.forEach(t),vr=d(ot),b(co.$$.fragment,ot),ot.forEach(t),tt.forEach(t),xs=d(o),mt=r(o,"H2",{class:!0});var Zs=i(mt);qt=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=i(qt);Hn=r(Vd,"SPAN",{});var Gd=i(Hn);b(po.$$.fragment,Gd),Gd.forEach(t),Vd.forEach(t),kr=d(Zs),Wn=r(Zs,"SPAN",{});var Kd=i(Wn);br=s(Kd,"CTRLLMHeadModel"),Kd.forEach(t),Zs.forEach(t),js=d(o),Re=r(o,"DIV",{class:!0});var nt=i(Re);b(ho.$$.fragment,nt),Cr=d(nt),Bn=r(nt,"P",{});var Xd=i(Bn);yr=s(Xd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ea.forEach(t),Mr=d(nt),fo=r(nt,"P",{});var ta=i(fo);Er=s(ta,"This model is also a PyTorch "),mo=r(ta,"A",{href:!0,rel:!0});var Qd=i(mo);Fr=s(Qd,"torch.nn.Module"),Qd.forEach(t),qr=s(ta,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa.forEach(t),pi=d(at),B=r(at,"DIV",{class:!0});var le=i(B);b(yo.$$.fragment,le),hi=d(le),Tt=r(le,"P",{});var Ln=i(Tt);ui=s(Ln,"The "),hn=r(Ln,"A",{href:!0});var pc=i(hn);fi=s(pc,"CTRLForSequenceClassification"),pc.forEach(t),mi=s(Ln," forward method, overrides the "),Zn=r(Ln,"CODE",{});var hc=i(Zn);gi=s(hc,"__call__"),hc.forEach(t),_i=s(Ln," special method."),Ln.forEach(t),Ti=d(le),b(xt.$$.fragment,le),vi=d(le),es=r(le,"P",{});var uc=i(es);ki=s(uc,"Example of single-label classification:"),uc.forEach(t),bi=d(le),b(wo.$$.fragment,le),Ci=d(le),b(Lo.$$.fragment,le),yi=d(le),ts=r(le,"P",{});var fc=i(ts);wi=s(fc,"Example of multi-label classification:"),fc.forEach(t),Li=d(le),b($o.$$.fragment,le),$i=d(le),b(Ro.$$.fragment,le),le.forEach(t),at.forEach(t),Ns=d(o),vt=r(o,"H2",{class:!0});var aa=i(vt);jt=r(aa,"A",{id:!0,class:!0,href:!0});var mc=i(jt);os=r(mc,"SPAN",{});var gc=i(os);b(Mo.$$.fragment,gc),gc.forEach(t),mc.forEach(t),Ri=d(aa),ns=r(aa,"SPAN",{});var _c=i(ns);Mi=s(_c,"TFCTRLModel"),_c.forEach(t),aa.forEach(t),Ds=d(o),de=r(o,"DIV",{class:!0});var Ge=i(de);b(Eo.$$.fragment,Ge),Ei=d(Ge),ss=r(Ge,"P",{});var Tc=i(ss);Fi=s(Tc,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Tc.forEach(t),qi=d(Ge),Fo=r(Ge,"P",{});var ra=i(Fo);zi=s(ra,"This model inherits from "),un=r(ra,"A",{href:!0});var vc=i(un);Pi=s(vc,"TFPreTrainedModel"),vc.forEach(t),xi=s(ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ca.forEach(t),dl=d(Ke),b(Dt.$$.fragment,Ke),cl=d(Ke),Ie=r(Ke,"DIV",{class:!0});var it=i(Ie);b(Ao.$$.fragment,it),pl=d(it),Ct=r(it,"P",{});var Rn=i(Ct);hl=s(Rn,"The "),gn=r(Rn,"A",{href:!0});var Fc=i(gn);ul=s(Fc,"TFCTRLLMHeadModel"),Fc.forEach(t),fl=s(Rn," forward method, overrides the "),cs=r(Rn,"CODE",{});var qc=i(cs);ml=s(qc,"__call__"),qc.forEach(t),gl=s(Rn," special method."),Rn.forEach(t),_l=d(it),b(At.$$.fragment,it),Tl=d(it),ps=r(it,"P",{});var zc=i(ps);vl=s(zc,"Example:"),zc.forEach(t),kl=d(it),b(Oo.$$.fragment,it),it.forEach(t),Ke.forEach(t),Hs=d(o),yt=r(o,"H2",{class:!0});var pa=i(yt);Ot=r(pa,"A",{id:!0,class:!0,href:!0});var Pc=i(Ot);hs=r(Pc,"SPAN",{});var xc=i(hs);b(Ho.$$.fragment,xc),xc.forEach(t),Pc.forEach(t),bl=d(pa),us=r(pa,"SPAN",{});var jc=i(us);Cl=s(jc,"TFCTRLForSequenceClassification"),jc.forEach(t),pa.forEach(t),Ws=d(o),X=r(o,"DIV",{class:!0});var ge=i(X);b(Wo.$$.fragment,ge),yl=d(ge),fs=r(ge,"P",{});var Sc=i(fs);wl=s(Sc,"The CTRL Model transformer with a sequence classification head on top (linear layer)."),Sc.forEach(t),Ll=d(ge),_n=r(ge,"P",{});var ad=i(_n);Tn=r(ad,"A",{href:!0});var Ic=i(Tn);$l=s(Ic,"TFCTRLForSequenceClassification"),Ic.forEach(t),Rl=s(ad,` uses the last token in order to do the classification, as other causal models
...
`),ms=r(lt,"CODE",{});var Nc=i(ms);Fl=s(Nc,"pad_token_id"),Nc.forEach(t),ql=s(lt,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
