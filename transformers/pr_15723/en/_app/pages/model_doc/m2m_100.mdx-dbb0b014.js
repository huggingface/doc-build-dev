import{S as ii,i as di,s as li,e as n,k as d,w as u,t as r,M as ci,c as s,d as o,m as l,a,x as f,h as i,b as c,F as e,g as h,y as _,q as g,o as k,B as M,v as pi}from"../../chunks/vendor-6b77c823.js";import{T as ri}from"../../chunks/Tip-39098574.js";import{D as H}from"../../chunks/Docstring-17b815d9.js";import{C as st}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as at}from"../../chunks/IconCopyLink-7a11ce68.js";function hi(rt){let m,S,v,q,F;return{c(){m=n("p"),S=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),q=r("Module"),F=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){m=s(y,"P",{});var z=a(m);S=i(z,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(z,"CODE",{});var I=a(v);q=i(I,"Module"),I.forEach(o),F=i(z,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),z.forEach(o)},m(y,z){h(y,m,z),e(m,S),e(m,v),e(v,q),e(m,F)},d(y){y&&o(m)}}}function mi(rt){let m,S,v,q,F;return{c(){m=n("p"),S=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),q=r("Module"),F=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){m=s(y,"P",{});var z=a(m);S=i(z,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(z,"CODE",{});var I=a(v);q=i(I,"Module"),I.forEach(o),F=i(z,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),z.forEach(o)},m(y,z){h(y,m,z),e(m,S),e(m,v),e(v,q),e(m,F)},d(y){y&&o(m)}}}function ui(rt){let m,S,v,q,F,y,z,I,an,go,U,te,xt,_e,rn,Et,dn,ko,oe,ln,ge,cn,pn,Mo,it,hn,bo,dt,Ct,mn,vo,ne,un,ke,fn,_n,yo,V,se,jt,Me,gn,Ft,kn,To,L,Mn,Pt,bn,vn,Ot,yn,Tn,St,wn,zn,wo,E,qn,lt,$n,xn,Lt,En,Cn,At,jn,Fn,Dt,Pn,On,zo,ct,It,Sn,qo,be,$o,pt,ve,Nt,Ln,An,$,Dn,Gt,In,Nn,Wt,Gn,Wn,Bt,Bn,Hn,Ht,Un,Vn,Ut,Xn,Rn,xo,ye,Eo,X,ae,Vt,Te,Jn,Xt,Kn,Co,x,we,Zn,R,Qn,ht,Yn,es,ze,ts,os,ns,J,ss,mt,as,rs,ut,is,ds,ls,Rt,cs,ps,qe,jo,K,re,Jt,$e,hs,Kt,ms,Fo,b,xe,us,Ee,fs,Ce,_s,gs,ks,je,Ms,ft,bs,vs,ys,Zt,Ts,ws,Fe,zs,A,Pe,qs,Oe,$s,Qt,xs,Es,Cs,Se,Le,Yt,js,Fs,eo,Ps,Os,Ae,to,Ss,Ls,oo,As,Ds,no,Is,Ns,ie,De,Gs,Ie,Ws,so,Bs,Hs,Us,N,Ne,Vs,_t,Xs,gt,Rs,Js,ao,Ks,Zs,kt,Ge,Po,Z,de,ro,We,Qs,io,Ys,Oo,P,Be,ea,He,ta,Mt,oa,na,sa,Ue,aa,Ve,ra,ia,da,C,Xe,la,Q,ca,bt,pa,ha,lo,ma,ua,fa,le,_a,co,ga,ka,Re,So,Y,ce,po,Je,Ma,ho,ba,Lo,O,Ke,va,Ze,ya,vt,Ta,wa,za,Qe,qa,Ye,$a,xa,Ea,T,et,Ca,ee,ja,yt,Fa,Pa,mo,Oa,Sa,La,pe,Aa,uo,Da,Ia,tt,Na,fo,Ga,Wa,ot,Ao;return y=new at({}),_e=new at({}),Me=new at({}),be=new st({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_15723/en/model_doc/m2m_100#transformers.M2M100Model">M2M100Model</a> or`,name:"vocab_size"},{anchor:"transformers.M2M100Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_15723/src/transformers/models/m2m_100/configuration_m2m_100.py#L34"}}),qe=new st({props:{code:`from transformers import M2M100Model, M2M100Config
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_15723/src/transformers/models/m2m_100/tokenization_m2m_100.py#L65"}}),Fe=new st({props:{code:`from transformers import M2M100Tokenizer
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_15723/src/transformers/models/m2m_100/tokenization_m2m_100.py#L258",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_15723/src/transformers/models/m2m_100/tokenization_m2m_100.py#L228",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15723/en/model_doc/m2m_100#transformers.M2M100Config"
...
`}}),le=new ri({props:{$$slots:{default:[hi]},$$scope:{ctx:rt}}}),Re=new st({props:{code:`from transformers import M2M100Tokenizer, M2M100Model
import torch
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_15723/src/transformers/models/m2m_100/modeling_m2m_100.py#L1273",returnDescription:`
<p>A <a
...
`}}),pe=new ri({props:{$$slots:{default:[mi]},$$scope:{ctx:rt}}}),tt=new st({props:{code:`from transformers import M2M100Tokenizer, M2M100ForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># translate to French</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>gen_tokens = model.generate(**model_inputs, forced_bos_token_id=tokenizer.get_lang_id(<span class="hljs-string">&quot;fr&quot;</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){m=n("meta"),S=d(),v=n("h1"),q=n("a"),F=n("span"),u(y.$$.fragment),z=d(),I=n("span"),an=r("M2M100"),go=d(),U=n("h2"),te=n("a"),xt=n("span"),u(_e.$$.fragment),rn=d(),Et=n("span"),dn=r("Overview"),ko=d(),oe=n("p"),ln=r("The M2M100 model was proposed in "),ge=n("a"),cn=r("Beyond English-Centric Multilingual Machine Translation"),pn=r(` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
Siddharth Goyal, Mandeep Baines, Onur Celebi, Guillaume Wenzek, Vishrav Chaudhary, Naman Goyal, Tom Birch, Vitaliy
Liptchinsky, Sergey Edunov, Edouard Grave, Michael Auli, Armand Joulin.`),Mo=d(),it=n("p"),hn=r("The abstract from the paper is the following:"),bo=d(),dt=n("p"),Ct=n("em"),mn=r(`Existing work in translation demonstrated the potential of massively multilingual machine translation by training a
...
source and target text. The source text format is `),Pt=n("code"),bn=r("[lang_code] X [eos]"),vn=r(", where "),Ot=n("code"),yn=r("lang_code"),Tn=r(` is source language
...
examples. To install `),At=n("code"),jn=r("sentencepiece"),Fn=r(" run "),Dt=n("code"),Pn=r("pip install sentencepiece"),On=r("."),zo=d(),ct=n("ul"),It=n("li"),Sn=r("Supervised Training"),qo=d(),u(be.$$.fragment),$o=d(),pt=n("ul"),ve=n("li"),Nt=n("p"),Ln=r("Generation"),An=d(),$=n("p"),Dn=r("M2M100 uses the "),Gt=n("code"),In=r("eos_token_id"),Nn=r(" as the "),Wt=n("code"),Gn=r("decoder_start_token_id"),Wn=r(` for generation with the target language id
...
documentation from `),ut=n("a"),is=r("PretrainedConfig"),ds=r(" for more information."),ls=d(),Rt=n("p"),cs=r("Example:"),ps=d(),u(qe.$$.fragment),jo=d(),K=n("h2"),re=n("a"),Jt=n("span"),u($e.$$.fragment),hs=d(),Kt=n("span"),ms=r("M2M100Tokenizer"),Fo=d(),b=n("div"),u(xe.$$.fragment),us=d(),Ee=n("p"),fs=r("Construct an M2M100 tokenizer. Based on "),Ce=n("a"),_s=r("SentencePiece"),gs=r("."),ks=d(),je=n("p"),Ms=r("This tokenizer inherits from "),ft=n("a"),bs=r("PreTrainedTokenizer"),vs=r(` which contains most of the main methods. Users should refer to
...
and behavior.`),da=d(),C=n("div"),u(Xe.$$.fragment),la=d(),Q=n("p"),ca=r("The "),bt=n("a"),pa=r("M2M100Model"),ha=r(" forward method, overrides the "),lo=n("code"),ma=r("__call__"),ua=r(" special method."),fa=d(),u(le.$$.fragment),_a=d(),co=n("p"),ga=r("Example:"),ka=d(),u(Re.$$.fragment),So=d(),Y=n("h2"),ce=n("a"),po=n("span"),u(Je.$$.fragment),Ma=d(),ho=n("span"),ba=r("M2M100ForConditionalGeneration"),Lo=d(),O=n("div"),u(Ke.$$.fragment),va=d(),Ze=n("p"),ya=r(`The M2M100 Model with a language modeling head. Can be used for summarization.
This model inherits from `),vt=n("a"),Ta=r("PreTrainedModel"),wa=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),za=d(),Qe=n("p"),qa=r("This model is also a PyTorch "),Ye=n("a"),$a=r("torch.nn.Module"),xa=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ea=d(),T=n("div"),u(et.$$.fragment),Ca=d(),ee=n("p"),ja=r("The "),yt=n("a"),Fa=r("M2M100ForConditionalGeneration"),Pa=r(" forward method, overrides the "),mo=n("code"),Oa=r("__call__"),Sa=r(" special method."),La=d(),u(pe.$$.fragment),Aa=d(),uo=n("p"),Da=r("Example:"),Ia=d(),u(tt.$$.fragment),Na=d(),fo=n("p"),Ga=r("Translation example::"),Wa=d(),u(ot.$$.fragment),this.h()},l(t){const p=ci('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),S=l(t),v=s(t,"H1",{class:!0});var nt=a(v);q=s(nt,"A",{id:!0,class:!0,href:!0});var _o=a(q);F=s(_o,"SPAN",{});var Ha=a(F);f(y.$$.fragment,Ha),Ha.forEach(o),_o.forEach(o),z=l(nt),I=s(nt,"SPAN",{});var Ua=a(I);an=i(Ua,"M2M100"),Ua.forEach(o),nt.forEach(o),go=l(t),U=s(t,"H2",{class:!0});var Do=a(U);te=s(Do,"A",{id:!0,class:!0,href:!0});var Va=a(te);xt=s(Va,"SPAN",{});var Xa=a(xt);f(_e.$$.fragment,Xa),Xa.forEach(o),Va.forEach(o),rn=l(Do),Et=s(Do,"SPAN",{});var Ra=a(Et);dn=i(Ra,"Overview"),Ra.forEach(o),Do.forEach(o),ko=l(t),oe=s(t,"P",{});var Io=a(oe);ln=i(Io,"The M2M100 model was proposed in "),ge=s(Io,"A",{href:!0,rel:!0});var Ja=a(ge);cn=i(Ja,"Beyond English-Centric Multilingual Machine Translation"),Ja.forEach(o),pn=i(Io,` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
Siddharth Goyal, Mandeep Baines, Onur Celebi, Guillaume Wenzek, Vishrav Chaudhary, Naman Goyal, Tom Birch, Vitaliy
Liptchinsky, Sergey Edunov, Edouard Grave, Michael Auli, Armand Joulin.`),Io.forEach(o),Mo=l(t),it=s(t,"P",{});var Ka=a(it);hn=i(Ka,"The abstract from the paper is the following:"),Ka.forEach(o),bo=l(t),dt=s(t,"P",{});var Za=a(dt);Ct=s(Za,"EM",{});var Qa=a(Ct);mn=i(Qa,`Existing work in translation demonstrated the potential of massively multilingual machine translation by training a
single model able to translate between any pair of languages. However, much of this work is English-Centric by training
only on data which was translated from or to English. While this is supported by large sources of training data, it
does not reflect translation needs worldwide. In this work, we create a true Many-to-Many multilingual translation
model that can translate directly between any pair of 100 languages. We build and open source a training dataset that
...
to create high quality models. Our focus on non-English-Centric models brings gains of more than 10 BLEU when directly
translating between non-English directions while performing competitively to the best single systems of WMT. We
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),Qa.forEach(o),Za.forEach(o),vo=l(t),ne=s(t,"P",{});var No=a(ne);un=i(No,"This model was contributed by "),ke=s(No,"A",{href:!0,rel:!0});var Ya=a(ke);fn=i(Ya,"valhalla"),Ya.forEach(o),_n=i(No,"."),No.forEach(o),yo=l(t),V=s(t,"H3",{class:!0});var Go=a(V);se=s(Go,"A",{id:!0,class:!0,href:!0});var er=a(se);jt=s(er,"SPAN",{});var tr=a(jt);f(Me.$$.fragment,tr),tr.forEach(o),er.forEach(o),gn=l(Go),Ft=s(Go,"SPAN",{});var or=a(Ft);kn=i(or,"Training and Generation"),or.forEach(o),Go.forEach(o),To=l(t),L=s(t,"P",{});var he=a(L);Mn=i(he,`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),Pt=s(he,"CODE",{});var nr=a(Pt);bn=i(nr,"[lang_code] X [eos]"),nr.forEach(o),vn=i(he,", where "),Ot=s(he,"CODE",{});var sr=a(Ot);yn=i(sr,"lang_code"),sr.forEach(o),Tn=i(he,` is source language
id for source text and target language id for target text, with `),St=s(he,"CODE",{});var ar=a(St);wn=i(ar,"X"),ar.forEach(o),zn=i(he," being the source or target text."),he.forEach(o),wo=l(t),E=s(t,"P",{});var G=a(E);qn=i(G,"The "),lt=s(G,"A",{href:!0});var rr=a(lt);$n=i(rr,"M2M100Tokenizer"),rr.forEach(o),xn=i(G," depends on "),Lt=s(G,"CODE",{});var ir=a(Lt);En=i(ir,"sentencepiece"),ir.forEach(o),Cn=i(G,` so be sure to install it before running the
examples. To install `),At=s(G,"CODE",{});var dr=a(At);jn=i(dr,"sentencepiece"),dr.forEach(o),Fn=i(G," run "),Dt=s(G,"CODE",{});var lr=a(Dt);Pn=i(lr,"pip install sentencepiece"),lr.forEach(o),On=i(G,"."),G.forEach(o),zo=l(t),ct=s(t,"UL",{});var cr=a(ct);It=s(cr,"LI",{});var pr=a(It);Sn=i(pr,"Supervised Training"),pr.forEach(o),cr.forEach(o),qo=l(t),f(be.$$.fragment,t),$o=l(t),pt=s(t,"UL",{});var hr=a(pt);ve=s(hr,"LI",{});var Wo=a(ve);Nt=s(Wo,"P",{});var mr=a(Nt);Ln=i(mr,"Generation"),mr.forEach(o),An=l(Wo),$=s(Wo,"P",{});var D=a($);Dn=i(D,"M2M100 uses the "),Gt=s(D,"CODE",{});var ur=a(Gt);In=i(ur,"eos_token_id"),ur.forEach(o),Nn=i(D," as the "),Wt=s(D,"CODE",{});var fr=a(Wt);Gn=i(fr,"decoder_start_token_id"),fr.forEach(o),Wn=i(D,` for generation with the target language id
being forced as the first generated token. To force the target language id as the first generated token, pass the
...
Hindi to French and Chinese to English using the `),Ut=s(D,"EM",{});var kr=a(Ut);Xn=i(kr,"facebook/m2m100_418M"),kr.forEach(o),Rn=i(D," checkpoint."),D.forEach(o),Wo.forEach(o),hr.forEach(o),xo=l(t),f(ye.$$.fragment,t),Eo=l(t),X=s(t,"H2",{class:!0});var Bo=a(X);ae=s(Bo,"A",{id:!0,class:!0,href:!0});var Mr=a(ae);Vt=s(Mr,"SPAN",{});var br=a(Vt);f(Te.$$.fragment,br),br.forEach(o),Mr.forEach(o),Jn=l(Bo),Xt=s(Bo,"SPAN",{});var vr=a(Xt);Kn=i(vr,"M2M100Config"),vr.forEach(o),Bo.forEach(o),Co=l(t),x=s(t,"DIV",{class:!0});var W=a(x);f(we.$$.fragment,W),Zn=l(W),R=s(W,"P",{});var Tt=a(R);Qn=i(Tt,"This is the configuration class to store the configuration of a "),ht=s(Tt,"A",{href:!0});var yr=a(ht);Yn=i(yr,"M2M100Model"),yr.forEach(o),es=i(Tt,`. It is used to instantiate an
M2M100 model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the M2M100
...
documentation from `),ut=s(wt,"A",{href:!0});var zr=a(ut);is=i(zr,"PretrainedConfig"),zr.forEach(o),ds=i(wt," for more information."),wt.forEach(o),ls=l(W),Rt=s(W,"P",{});var qr=a(Rt);cs=i(qr,"Example:"),qr.forEach(o),ps=l(W),f(qe.$$.fragment,W),W.forEach(o),jo=l(t),K=s(t,"H2",{class:!0});var Ho=a(K);re=s(Ho,"A",{id:!0,class:!0,href:!0});var $r=a(re);Jt=s($r,"SPAN",{});var xr=a(Jt);f($e.$$.fragment,xr),xr.forEach(o),$r.forEach(o),hs=l(Ho),Kt=s(Ho,"SPAN",{});var Er=a(Kt);ms=i(Er,"M2M100Tokenizer"),Er.forEach(o),Ho.forEach(o),Fo=l(t),b=s(t,"DIV",{class:!0});var w=a(b);f(xe.$$.fragment,w),us=l(w),Ee=s(w,"P",{});var Uo=a(Ee);fs=i(Uo,"Construct an M2M100 tokenizer. Based on "),Ce=s(Uo,"A",{href:!0,rel:!0});var Cr=a(Ce);_s=i(Cr,"SentencePiece"),Cr.forEach(o),gs=i(Uo,"."),Uo.forEach(o),ks=l(w),je=s(w,"P",{});var Vo=a(je);Ms=i(Vo,"This tokenizer inherits from "),ft=s(Vo,"A",{href:!0});var jr=a(ft);bs=i(jr,"PreTrainedTokenizer"),jr.forEach(o),vs=i(Vo,` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tn.forEach(o),da=l(ue),C=s(ue,"DIV",{class:!0});var B=a(C);f(Xe.$$.fragment,B),la=l(B),Q=s(B,"P",{});var qt=a(Q);ca=i(qt,"The "),bt=s(qt,"A",{href:!0});var Rr=a(bt);pa=i(Rr,"M2M100Model"),Rr.forEach(o),ha=i(qt," forward method, overrides the "),lo=s(qt,"CODE",{});var Jr=a(lo);ma=i(Jr,"__call__"),Jr.forEach(o),ua=i(qt," special method."),qt.forEach(o),fa=l(B),f(le.$$.fragment,B),_a=l(B),co=s(B,"P",{});var Kr=a(co);ga=i(Kr,"Example:"),Kr.forEach(o),ka=l(B),f(Re.$$.fragment,B),B.forEach(o),ue.forEach(o),So=l(t),Y=s(t,"H2",{class:!0});var on=a(Y);ce=s(on,"A",{id:!0,class:!0,href:!0});var Zr=a(ce);po=s(Zr,"SPAN",{});var Qr=a(po);f(Je.$$.fragment,Qr),Qr.forEach(o),Zr.forEach(o),Ma=l(on),ho=s(on,"SPAN",{});var Yr=a(ho);ba=i(Yr,"M2M100ForConditionalGeneration"),Yr.forEach(o),on.forEach(o),Lo=l(t),O=s(t,"DIV",{class:!0});var fe=a(O);f(Ke.$$.fragment,fe),va=l(fe),Ze=s(fe,"P",{});var nn=a(Ze);ya=i(nn,`The M2M100 Model with a language modeling head. Can be used for summarization.
This model inherits from `),vt=s(nn,"A",{href:!0});var ei=a(vt);Ta=i(ei,"PreTrainedModel"),ei.forEach(o),wa=i(nn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sn.forEach(o),Ea=l(fe),T=s(fe,"DIV",{class:!0});var j=a(T);f(et.$$.fragment,j),Ca=l(j),ee=s(j,"P",{});var $t=a(ee);ja=i($t,"The "),yt=s($t,"A",{href:!0});var oi=a(yt);Fa=i(oi,"M2M100ForConditionalGeneration"),oi.forEach(o),Pa=i($t," forward method, overrides the "),mo=s($t,"CODE",{});var ni=a(mo);Oa=i(ni,"__call__"),ni.forEach(o),Sa=i($t," special method."),$t.forEach(o),La=l(j),f(pe.$$.fragment,j),Aa=l(j),uo=s(j,"P",{});var si=a(uo);Da=i(si,"Example:"),si.forEach(o),Ia=l(j),f(tt.$$.fragment,j),Na=l(j),fo=s(j,"P",{});var ai=a(fo);Ga=i(ai,"Translation example::"),ai.forEach(o),Wa=l(j),f(ot.$$.fragment,j),j.forEach(o),fe.forEach(o),this.h()},h(){c(m,"name","hf:doc:metadata"),c(m,"content",JSON.stringify(fi)),c(q,"id","m2m100"),c(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(q,"href","#m2m100"),c(v,"class","relative group"),c(te,"id","overview"),c(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(te,"href","#overview"),c(U,"class","relative group"),c(ge,"href","https://arxiv.org/abs/2010.11125"),c(ge,"rel","nofollow"),c(ke,"href","https://huggingface.co/valhalla"),c(ke,"rel","nofollow"),c(se,"id","training-and-generation"),c(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(se,"href","#training-and-generation"),c(V,"class","relative group"),c(lt,"href","/docs/transformers/pr_15723/en/model_doc/m2m_100#transformers.M2M100Tokenizer"),c(ae,"id","transformers.M2M100Config"),c(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ae,"href","#transformers.M2M100Config"),c(X,"class","relative group"),c(ht,"href","/docs/transformers/pr_15723/en/model_doc/m2m_100#transformers.M2M100Model"),c(ze,"href","https://huggingface.co/facebook/m2m100_418M"),c(ze,"rel","nofollow"),c(mt,"href","/docs/transformers/pr_15723/en/main_classes/configuration#transformers.PretrainedConfig"),c(ut,"href","/docs/transformers/pr_15723/en/main_classes/configuration#transformers.PretrainedConfig"),c(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(re,"id","transformers.M2M100Tokenizer"),c(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(re,"href","#transformers.M2M100Tokenizer"),c(K,"class","relative group"),c(Ce,"href","https://github.com/google/sentencepiece"),c(Ce,"rel","nofollow"),c(ft,"href","/docs/transformers/pr_15723/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(gt,"href","../glossary#token-type-ids"),c(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(b,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(de,"id","transformers.M2M100Model"),c(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(de,"href","#transformers.M2M100Model"),c(Z,"class","relative group"),c(Mt,"href","/docs/transformers/pr_15723/en/main_classes/model#transformers.PreTrainedModel"),c(Ve,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ve,"rel","nofollow"),c(bt,"href","/docs/transformers/pr_15723/en/model_doc/m2m_100#transformers.M2M100Model"),c(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ce,"id","transformers.M2M100ForConditionalGeneration"),c(ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ce,"href","#transformers.M2M100ForConditionalGeneration"),c(Y,"class","relative group"),c(vt,"href","/docs/transformers/pr_15723/en/main_classes/model#transformers.PreTrainedModel"),c(Ye,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ye,"rel","nofollow"),c(yt,"href","/docs/transformers/pr_15723/en/model_doc/m2m_100#transformers.M2M100ForConditionalGeneration"),c(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,p){e(document.head,m),h(t,S,p),h(t,v,p),e(v,q),e(q,F),_(y,F,null),e(v,z),e(v,I),e(I,an),h(t,go,p),h(t,U,p),e(U,te),e(te,xt),_(_e,xt,null),e(U,rn),e(U,Et),e(Et,dn),h(t,ko,p),h(t,oe,p),e(oe,ln),e(oe,ge),e(ge,cn),e(oe,pn),h(t,Mo,p),h(t,it,p),e(it,hn),h(t,bo,p),h(t,dt,p),e(dt,Ct),e(Ct,mn),h(t,vo,p),h(t,ne,p),e(ne,un),e(ne,ke),e(ke,fn),e(ne,_n),h(t,yo,p),h(t,V,p),e(V,se),e(se,jt),_(Me,jt,null),e(V,gn),e(V,Ft),e(Ft,kn),h(t,To,p),h(t,L,p),e(L,Mn),e(L,Pt),e(Pt,bn),e(L,vn),e(L,Ot),e(Ot,yn),e(L,Tn),e(L,St),e(St,wn),e(L,zn),h(t,wo,p),h(t,E,p),e(E,qn),e(E,lt),e(lt,$n),e(E,xn),e(E,Lt),e(Lt,En),e(E,Cn),e(E,At),e(At,jn),e(E,Fn),e(E,Dt),e(Dt,Pn),e(E,On),h(t,zo,p),h(t,ct,p),e(ct,It),e(It,Sn),h(t,qo,p),_(be,t,p),h(t,$o,p),h(t,pt,p),e(pt,ve),e(ve,Nt),e(Nt,Ln),e(ve,An),e(ve,$),e($,Dn),e($,Gt),e(Gt,In),e($,Nn),e($,Wt),e(Wt,Gn),e($,Wn),e($,Bt),e(Bt,Bn),e($,Hn),e($,Ht),e(Ht,Un),e($,Vn),e($,Ut),e(Ut,Xn),e($,Rn),h(t,xo,p),_(ye,t,p),h(t,Eo,p),h(t,X,p),e(X,ae),e(ae,Vt),_(Te,Vt,null),e(X,Jn),e(X,Xt),e(Xt,Kn),h(t,Co,p),h(t,x,p),_(we,x,null),e(x,Zn),e(x,R),e(R,Qn),e(R,ht),e(ht,Yn),e(R,es),e(R,ze),e(ze,ts),e(R,os),e(x,ns),e(x,J),e(J,ss),e(J,mt),e(mt,as),e(J,rs),e(J,ut),e(ut,is),e(J,ds),e(x,ls),e(x,Rt),e(Rt,cs),e(x,ps),_(qe,x,null),h(t,jo,p),h(t,K,p),e(K,re),e(re,Jt),_($e,Jt,null),e(K,hs),e(K,Kt),e(Kt,ms),h(t,Fo,p),h(t,b,p),_(xe,b,null),e(b,us),e(b,Ee),e(Ee,fs),e(Ee,Ce),e(Ce,_s),e(Ee,gs),e(b,ks),e(b,je),e(je,Ms),e(je,ft),e(ft,bs),e(je,vs),e(b,ys),e(b,Zt),e(Zt,Ts),e(b,ws),_(Fe,b,null),e(b,zs),e(b,A),_(Pe,A,null),e(A,qs),e(A,Oe),e(Oe,$s),e(Oe,Qt),e(Qt,xs),e(Oe,Es),e(A,Cs),e(A,Se),e(Se,Le),e(Le,Yt),e(Yt,js),e(Le,Fs),e(Le,eo),e(eo,Ps),e(Se,Os),e(Se,Ae),e(Ae,to),e(to,Ss),e(Ae,Ls),e(Ae,oo),e(oo,As),e(A,Ds),e(A,no),e(no,Is),e(b,Ns),e(b,ie),_(De,ie,null),e(ie,Gs),e(ie,Ie),e(Ie,Ws),e(Ie,so),e(so,Bs),e(Ie,Hs),e(b,Us),e(b,N),_(Ne,N,null),e(N,Vs),e(N,_t),e(_t,Xs),e(_t,gt),e(gt,Rs),e(N,Js),e(N,ao),e(ao,Ks),e(b,Zs),e(b,kt),_(Ge,kt,null),h(t,Po,p),h(t,Z,p),e(Z,de),e(de,ro),_(We,ro,null),e(Z,Qs),e(Z,io),e(io,Ys),h(t,Oo,p),h(t,P,p),_(Be,P,null),e(P,ea),e(P,He),e(He,ta),e(He,Mt),e(Mt,oa),e(He,na),e(P,sa),e(P,Ue),e(Ue,aa),e(Ue,Ve),e(Ve,ra),e(Ue,ia),e(P,da),e(P,C),_(Xe,C,null),e(C,la),e(C,Q),e(Q,ca),e(Q,bt),e(bt,pa),e(Q,ha),e(Q,lo),e(lo,ma),e(Q,ua),e(C,fa),_(le,C,null),e(C,_a),e(C,co),e(co,ga),e(C,ka),_(Re,C,null),h(t,So,p),h(t,Y,p),e(Y,ce),e(ce,po),_(Je,po,null),e(Y,Ma),e(Y,ho),e(ho,ba),h(t,Lo,p),h(t,O,p),_(Ke,O,null),e(O,va),e(O,Ze),e(Ze,ya),e(Ze,vt),e(vt,Ta),e(Ze,wa),e(O,za),e(O,Qe),e(Qe,qa),e(Qe,Ye),e(Ye,$a),e(Qe,xa),e(O,Ea),e(O,T),_(et,T,null),e(T,Ca),e(T,ee),e(ee,ja),e(ee,yt),e(yt,Fa),e(ee,Pa),e(ee,mo),e(mo,Oa),e(ee,Sa),e(T,La),_(pe,T,null),e(T,Aa),e(T,uo),e(uo,Da),e(T,Ia),_(tt,T,null),e(T,Na),e(T,fo),e(fo,Ga),e(T,Wa),_(ot,T,null),Ao=!0},p(t,[p]){const nt={};p&2&&(nt.$$scope={dirty:p,ctx:t}),le.$set(nt);const _o={};p&2&&(_o.$$scope={dirty:p,ctx:t}),pe.$set(_o)},i(t){Ao||(g(y.$$.fragment,t),g(_e.$$.fragment,t),g(Me.$$.fragment,t),g(be.$$.fragment,t),g(ye.$$.fragment,t),g(Te.$$.fragment,t),g(we.$$.fragment,t),g(qe.$$.fragment,t),g($e.$$.fragment,t),g(xe.$$.fragment,t),g(Fe.$$.fragment,t),g(Pe.$$.fragment,t),g(De.$$.fragment,t),g(Ne.$$.fragment,t),g(Ge.$$.fragment,t),g(We.$$.fragment,t),g(Be.$$.fragment,t),g(Xe.$$.fragment,t),g(le.$$.fragment,t),g(Re.$$.fragment,t),g(Je.$$.fragment,t),g(Ke.$$.fragment,t),g(et.$$.fragment,t),g(pe.$$.fragment,t),g(tt.$$.fragment,t),g(ot.$$.fragment,t),Ao=!0)},o(t){k(y.$$.fragment,t),k(_e.$$.fragment,t),k(Me.$$.fragment,t),k(be.$$.fragment,t),k(ye.$$.fragment,t),k(Te.$$.fragment,t),k(we.$$.fragment,t),k(qe.$$.fragment,t),k($e.$$.fragment,t),k(xe.$$.fragment,t),k(Fe.$$.fragment,t),k(Pe.$$.fragment,t),k(De.$$.fragment,t),k(Ne.$$.fragment,t),k(Ge.$$.fragment,t),k(We.$$.fragment,t),k(Be.$$.fragment,t),k(Xe.$$.fragment,t),k(le.$$.fragment,t),k(Re.$$.fragment,t),k(Je.$$.fragment,t),k(Ke.$$.fragment,t),k(et.$$.fragment,t),k(pe.$$.fragment,t),k(tt.$$.fragment,t),k(ot.$$.fragment,t),Ao=!1},d(t){o(m),t&&o(S),t&&o(v),M(y),t&&o(go),t&&o(U),M(_e),t&&o(ko),t&&o(oe),t&&o(Mo),t&&o(it),t&&o(bo),t&&o(dt),t&&o(vo),t&&o(ne),t&&o(yo),t&&o(V),M(Me),t&&o(To),t&&o(L),t&&o(wo),t&&o(E),t&&o(zo),t&&o(ct),t&&o(qo),M(be,t),t&&o($o),t&&o(pt),t&&o(xo),M(ye,t),t&&o(Eo),t&&o(X),M(Te),t&&o(Co),t&&o(x),M(we),M(qe),t&&o(jo),t&&o(K),M($e),t&&o(Fo),t&&o(b),M(xe),M(Fe),M(Pe),M(De),M(Ne),M(Ge),t&&o(Po),t&&o(Z),M(We),t&&o(Oo),t&&o(P),M(Be),M(Xe),M(le),M(Re),t&&o(So),t&&o(Y),M(Je),t&&o(Lo),t&&o(O),M(Ke),M(et),M(pe),M(tt),M(ot)}}}const fi={local:"m2m100",sections:[{local:"overview",sections:[{local:"training-and-generation",title:"Training and Generation"}],title:"Overview"},{local:"transformers.M2M100Config",title:"M2M100Config"},{local:"transformers.M2M100Tokenizer",title:"M2M100Tokenizer"},{local:"transformers.M2M100Model",title:"M2M100Model"},{local:"transformers.M2M100ForConditionalGeneration",title:"M2M100ForConditionalGeneration"}],title:"M2M100"};function _i(rt){return pi(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class yi extends ii{constructor(m){super();di(this,m,_i,ui,li,{})}}export{yi as default,fi as metadata};
