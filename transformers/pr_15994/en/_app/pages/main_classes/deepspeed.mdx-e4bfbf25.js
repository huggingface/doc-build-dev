...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),yp=new w({}),{c(){y=o("meta"),z=u(),b=o("h1"),q=o("a"),ee=o("span"),f(O.$$.fragment),x=u(),se=o("span"),R=a("DeepSpeed Integration"),ae=u(),C=o("p"),E=o("a"),$=a("DeepSpeed"),qs=a(" implements everything described in the "),V=o("a"),$s=a("ZeRO paper"),R4=a(". Currently it provides full support for:"),Nj=u(),I=o("ol"),ef=o("li"),I4=a("Optimizer state partitioning (ZeRO stage 1)"),U4=u(),sf=o("li"),G4=a("Gradient partitioning (ZeRO stage 2)"),L4=u(),tf=o("li"),M4=a("Parameter partitioning (ZeRO stage 3)"),Z4=u(),af=o("li"),N4=a("Custom mixed precision training handling"),H4=u(),nf=o("li"),B4=a("A range of fast CUDA-extension-based optimizers"),W4=u(),of=o("li"),F4=a("ZeRO-Offload to CPU and NVMe"),Hj=u(),Se=o("p"),V4=a("ZeRO-Offload has its own dedicated paper: "),to=o("a"),Y4=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),K4=a(". And NVMe-support is described in the paper "),ao=o("a"),J4=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),X4=a("."),Bj=u(),Ip=o("p"),Q4=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),Wj=u(),Up=o("p"),e$=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
...
documented `),Eo=o("a"),Y5=a("here"),K5=a(". The file naming is up to you."),Rg=u(),ri=o("p"),J5=a("Therefore, if your original command line looked as follows:"),Ig=u(),f(qo.$$.fragment),Ug=u(),pi=o("p"),X5=a("Now it should be:"),Gg=u(),f($o.$$.fragment),Lg=u(),U=o("p"),Q5=a("Unlike, "),xf=o("code"),e6=a("torch.distributed.launch"),s6=a(" where you have to specify how many GPUs to use with "),Rf=o("code"),t6=a("--nproc_per_node"),a6=a(`, with the
`),If=o("code"),n6=a("deepspeed"),o6=a(" launcher you don\u2019t have to use the corresponding "),Uf=o("code"),l6=a("--num_gpus"),r6=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),ko=o("a"),p6=a("here"),i6=a("."),Mg=u(),ne=o("p"),u6=a("In fact, you can continue using "),Gf=o("code"),c6=a("-m torch.distributed.launch"),h6=a(` with DeepSpeed as long as you don\u2019t need to use
`),Lf=o("code"),f6=a("deepspeed"),d6=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Mf=o("code"),m6=a("deepspeed"),_6=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Zg=u(),Rt=o("p"),v6=a("Here is an example of running "),Zf=o("code"),j6=a("run_translation.py"),g6=a(" under DeepSpeed deploying all available GPUs:"),Ng=u(),f(Po.$$.fragment),Hg=u(),It=o("p"),w6=a("Note that in the DeepSpeed documentation you are likely to see "),Nf=o("code"),y6=a("--deepspeed --deepspeed_config ds_config.json"),b6=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Bg=u(),Ut=o("p"),E6=a("For some practical usage examples, please, see this "),Do=o("a"),q6=a("post"),$6=a("."),Wg=u(),ii=o("a"),Fg=u(),Os=o("h3"),Gt=o("a"),Hf=o("span"),f(zo.$$.fragment),k6=u(),Bf=o("span"),P6=a("Deployment with one GPU"),Vg=u(),Lt=o("p"),D6=a("To deploy DeepSpeed with one GPU adjust the "),ui=o("a"),z6=a("Trainer"),O6=a(" command line arguments as follows:"),Yg=u(),f(Oo.$$.fragment),Kg=u(),Ge=o("p"),T6=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Wf=o("code"),A6=a("--num_gpus=1"),S6=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),To=o("a"),C6=a("documentation"),x6=a(" discusses the launcher options."),Jg=u(),ci=o("p"),R6=a("Why would you want to use DeepSpeed with just one GPU?"),Xg=u(),Mt=o("ol"),Ff=o("li"),I6=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),U6=u(),Vf=o("li"),G6=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),Qg=u(),hi=o("p"),L6=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),ew=u(),f(Ao.$$.fragment),sw=u(),fi=o("p"),M6=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),tw=u(),Zt=o("p"),Z6=a("For a practical usage example of this type of deployment, please, see this "),So=o("a"),N6=a("post"),H6=a("."),aw=u(),di=o("p"),B6=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),nw=u(),mi=o("p"),W6=a("Notes:"),ow=u(),_i=o("ul"),Ts=o("li"),Co=o("p"),F6=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Yf=o("code"),V6=a("CUDA_VISIBLE_DEVICES"),Y6=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),K6=u(),f(xo.$$.fragment),J6=u(),Kf=o("p"),X6=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),lw=u(),vi=o("a"),rw=u(),As=o("h3"),Nt=o("a"),Jf=o("span"),f(Ro.$$.fragment),Q6=u(),Xf=o("span"),e9=a("Deployment in Notebooks"),pw=u(),Ht=o("p"),s9=a("The problem with running notebook cells as a script is that there is no normal "),Qf=o("code"),t9=a("deepspeed"),a9=a(` launcher to rely on, so
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),zp=o("a"),uG=a("DeepSpeed GitHub"),cG=a("."),this.h()},l(e){const p=SK('[data-svelte="svelte-1phssyn"]',document.head);y=l(p,"META",{name:!0,content:!0}),p.forEach(t),z=c(e),b=l(e,"H1",{class:!0});var Op=r(b);q=l(Op,"A",{id:!0,class:!0,href:!0});var Rj=r(q);ee=l(Rj,"SPAN",{});var Ij=r(ee);d(O.$$.fragment,Ij),Ij.forEach(t),Rj.forEach(t),x=c(Op),se=l(Op,"SPAN",{});var jG=r(se);R=n(jG,"DeepSpeed Integration"),jG.forEach(t),Op.forEach(t),ae=c(e),C=l(e,"P",{});var Uj=r(C);E=l(Uj,"A",{href:!0,rel:!0});var gG=r(E);$=n(gG,"DeepSpeed"),gG.forEach(t),qs=n(Uj," implements everything described in the "),V=l(Uj,"A",{href:!0,rel:!0});var wG=r(V);$s=n(wG,"ZeRO paper"),wG.forEach(t),R4=n(Uj,". Currently it provides full support for:"),Uj.forEach(t),Nj=c(e),I=l(e,"OL",{});var je=r(I);ef=l(je,"LI",{});var yG=r(ef);I4=n(yG,"Optimizer state partitioning (ZeRO stage 1)"),yG.forEach(t),U4=c(je),sf=l(je,"LI",{});var bG=r(sf);G4=n(bG,"Gradient partitioning (ZeRO stage 2)"),bG.forEach(t),L4=c(je),tf=l(je,"LI",{});var EG=r(tf);M4=n(EG,"Parameter partitioning (ZeRO stage 3)"),EG.forEach(t),Z4=c(je),af=l(je,"LI",{});var qG=r(af);N4=n(qG,"Custom mixed precision training handling"),qG.forEach(t),H4=c(je),nf=l(je,"LI",{});var $G=r(nf);B4=n($G,"A range of fast CUDA-extension-based optimizers"),$G.forEach(t),W4=c(je),of=l(je,"LI",{});var kG=r(of);F4=n(kG,"ZeRO-Offload to CPU and NVMe"),kG.forEach(t),je.forEach(t),Hj=c(e),Se=l(e,"P",{});var lh=r(Se);V4=n(lh,"ZeRO-Offload has its own dedicated paper: "),to=l(lh,"A",{href:!0,rel:!0});var PG=r(to);Y4=n(PG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),PG.forEach(t),K4=n(lh,". And NVMe-support is described in the paper "),ao=l(lh,"A",{href:!0,rel:!0});var DG=r(ao);J4=n(DG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),DG.forEach(t),X4=n(lh,"."),lh.forEach(t),Bj=c(e),Ip=l(e,"P",{});var zG=r(Ip);Q4=n(zG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),zG.forEach(t),Wj=c(e),Up=l(e,"P",{});var OG=r(Up);e$=n(OG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
...
documented `),Eo=l(Ln,"A",{href:!0,rel:!0});var AL=r(Eo);Y5=n(AL,"here"),AL.forEach(t),K5=n(Ln,". The file naming is up to you."),Ln.forEach(t),mE.forEach(t),Rg=c(e),ri=l(e,"P",{});var SL=r(ri);J5=n(SL,"Therefore, if your original command line looked as follows:"),SL.forEach(t),Ig=c(e),d(qo.$$.fragment,e),Ug=c(e),pi=l(e,"P",{});var CL=r(pi);X5=n(CL,"Now it should be:"),CL.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),U=l(e,"P",{});var we=r(U);Q5=n(we,"Unlike, "),xf=l(we,"CODE",{});var xL=r(xf);e6=n(xL,"torch.distributed.launch"),xL.forEach(t),s6=n(we," where you have to specify how many GPUs to use with "),Rf=l(we,"CODE",{});var RL=r(Rf);t6=n(RL,"--nproc_per_node"),RL.forEach(t),a6=n(we,`, with the
`),If=l(we,"CODE",{});var IL=r(If);n6=n(IL,"deepspeed"),IL.forEach(t),o6=n(we," launcher you don\u2019t have to use the corresponding "),Uf=l(we,"CODE",{});var UL=r(Uf);l6=n(UL,"--num_gpus"),UL.forEach(t),r6=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),ko=l(we,"A",{href:!0,rel:!0});var GL=r(ko);p6=n(GL,"here"),GL.forEach(t),i6=n(we,"."),we.forEach(t),Mg=c(e),ne=l(e,"P",{});var Mn=r(ne);u6=n(Mn,"In fact, you can continue using "),Gf=l(Mn,"CODE",{});var LL=r(Gf);c6=n(LL,"-m torch.distributed.launch"),LL.forEach(t),h6=n(Mn,` with DeepSpeed as long as you don\u2019t need to use
`),Lf=l(Mn,"CODE",{});var ML=r(Lf);f6=n(ML,"deepspeed"),ML.forEach(t),d6=n(Mn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Mf=l(Mn,"CODE",{});var ZL=r(Mf);m6=n(ZL,"deepspeed"),ZL.forEach(t),_6=n(Mn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Mn.forEach(t),Zg=c(e),Rt=l(e,"P",{});var _E=r(Rt);v6=n(_E,"Here is an example of running "),Zf=l(_E,"CODE",{});var NL=r(Zf);j6=n(NL,"run_translation.py"),NL.forEach(t),g6=n(_E," under DeepSpeed deploying all available GPUs:"),_E.forEach(t),Ng=c(e),d(Po.$$.fragment,e),Hg=c(e),It=l(e,"P",{});var vE=r(It);w6=n(vE,"Note that in the DeepSpeed documentation you are likely to see "),Nf=l(vE,"CODE",{});var HL=r(Nf);y6=n(HL,"--deepspeed --deepspeed_config ds_config.json"),HL.forEach(t),b6=n(vE,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),vE.forEach(t),Bg=c(e),Ut=l(e,"P",{});var jE=r(Ut);E6=n(jE,"For some practical usage examples, please, see this "),Do=l(jE,"A",{href:!0,rel:!0});var BL=r(Do);q6=n(BL,"post"),BL.forEach(t),$6=n(jE,"."),jE.forEach(t),Wg=c(e),ii=l(e,"A",{id:!0}),r(ii).forEach(t),Fg=c(e),Os=l(e,"H3",{class:!0});var gE=r(Os);Gt=l(gE,"A",{id:!0,class:!0,href:!0});var WL=r(Gt);Hf=l(WL,"SPAN",{});var FL=r(Hf);d(zo.$$.fragment,FL),FL.forEach(t),WL.forEach(t),k6=c(gE),Bf=l(gE,"SPAN",{});var VL=r(Bf);P6=n(VL,"Deployment with one GPU"),VL.forEach(t),gE.forEach(t),Vg=c(e),Lt=l(e,"P",{});var wE=r(Lt);D6=n(wE,"To deploy DeepSpeed with one GPU adjust the "),ui=l(wE,"A",{href:!0});var YL=r(ui);z6=n(YL,"Trainer"),YL.forEach(t),O6=n(wE," command line arguments as follows:"),wE.forEach(t),Yg=c(e),d(Oo.$$.fragment,e),Kg=c(e),Ge=l(e,"P",{});var fh=r(Ge);T6=n(fh,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Wf=l(fh,"CODE",{});var KL=r(Wf);A6=n(KL,"--num_gpus=1"),KL.forEach(t),S6=n(fh,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),To=l(fh,"A",{href:!0,rel:!0});var JL=r(To);C6=n(JL,"documentation"),JL.forEach(t),x6=n(fh," discusses the launcher options."),fh.forEach(t),Jg=c(e),ci=l(e,"P",{});var XL=r(ci);R6=n(XL,"Why would you want to use DeepSpeed with just one GPU?"),XL.forEach(t),Xg=c(e),Mt=l(e,"OL",{});var yE=r(Mt);Ff=l(yE,"LI",{});var QL=r(Ff);I6=n(QL,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),QL.forEach(t),U6=c(yE),Vf=l(yE,"LI",{});var eM=r(Vf);G6=n(eM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),eM.forEach(t),yE.forEach(t),Qg=c(e),hi=l(e,"P",{});var sM=r(hi);L6=n(sM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),sM.forEach(t),ew=c(e),d(Ao.$$.fragment,e),sw=c(e),fi=l(e,"P",{});var tM=r(fi);M6=n(tM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),tM.forEach(t),tw=c(e),Zt=l(e,"P",{});var bE=r(Zt);Z6=n(bE,"For a practical usage example of this type of deployment, please, see this "),So=l(bE,"A",{href:!0,rel:!0});var aM=r(So);N6=n(aM,"post"),aM.forEach(t),H6=n(bE,"."),bE.forEach(t),aw=c(e),di=l(e,"P",{});var nM=r(di);B6=n(nM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),nM.forEach(t),nw=c(e),mi=l(e,"P",{});var oM=r(mi);W6=n(oM,"Notes:"),oM.forEach(t),ow=c(e),_i=l(e,"UL",{});var lM=r(_i);Ts=l(lM,"LI",{});var dh=r(Ts);Co=l(dh,"P",{});var EE=r(Co);F6=n(EE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Yf=l(EE,"CODE",{});var rM=r(Yf);V6=n(rM,"CUDA_VISIBLE_DEVICES"),rM.forEach(t),Y6=n(EE,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),EE.forEach(t),K6=c(dh),d(xo.$$.fragment,dh),J6=c(dh),Kf=l(dh,"P",{});var pM=r(Kf);X6=n(pM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pM.forEach(t),dh.forEach(t),lM.forEach(t),lw=c(e),vi=l(e,"A",{id:!0}),r(vi).forEach(t),rw=c(e),As=l(e,"H3",{class:!0});var qE=r(As);Nt=l(qE,"A",{id:!0,class:!0,href:!0});var iM=r(Nt);Jf=l(iM,"SPAN",{});var uM=r(Jf);d(Ro.$$.fragment,uM),uM.forEach(t),iM.forEach(t),Q6=c(qE),Xf=l(qE,"SPAN",{});var cM=r(Xf);e9=n(cM,"Deployment in Notebooks"),cM.forEach(t),qE.forEach(t),pw=c(e),Ht=l(e,"P",{});var $E=r(Ht);s9=n($E,"The problem with running notebook cells as a script is that there is no normal "),Qf=l($E,"CODE",{});var hM=r(Qf);t9=n(hM,"deepspeed"),hM.forEach(t),a9=n($E,` launcher to rely on, so
...
circumstances you may find the following information to be needed.`),DF.forEach(t),q3=c(e),nt=l(e,"H4",{class:!0});var e4=r(nt);un=l(e4,"A",{id:!0,class:!0,href:!0});var zF=r(un);ov=l(zF,"SPAN",{});var OF=r(ov);d(kr.$$.fragment,OF),OF.forEach(t),zF.forEach(t),_C=c(e4),lv=l(e4,"SPAN",{});var TF=r(lv);vC=n(TF,"Constructing Massive Models"),TF.forEach(t),e4.forEach(t),$3=c(e),cn=l(e,"P",{});var s4=r(cn);jC=n(s4,`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
but also if you want the initialization to happen much faster, initialize the model using `),rv=l(s4,"EM",{});var AF=r(rv);gC=n(AF,"deepspeed.zero.Init()"),AF.forEach(t),wC=n(s4,`
context manager (which is also a function decorator), like so:`),s4.forEach(t),k3=c(e),d(Pr.$$.fragment,e),P3=c(e),uc=l(e,"P",{});var SF=r(uc);yC=n(SF,"As you can see this gives you a randomly initialized model."),SF.forEach(t),D3=c(e),D=l(e,"P",{});var W=r(D);bC=n(W,"If you want to use a pretrained model, "),pv=l(W,"CODE",{});var CF=r(pv);EC=n(CF,"model_class.from_pretrained"),CF.forEach(t),qC=n(W,` will activate this feature as long as
...
`),hv=l(W,"CODE",{});var LF=r(hv);xC=n(LF,"from_pretrained"),LF.forEach(t),RC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),z3=c(e),d(Dr.$$.fragment,e),O3=c(e),hn=l(e,"P",{});var t4=r(hn);IC=n(t4,"If you\u2019re using the official example scripts and your command line arguments include "),fv=l(t4,"CODE",{});var MF=r(fv);UC=n(MF,"--deepspeed ds_config.json"),MF.forEach(t),GC=n(t4,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),t4.forEach(t),T3=c(e),fc=l(e,"P",{});var ZF=r(fc);LC=n(ZF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),ZF.forEach(t),A3=c(e),fn=l(e,"P",{});var a4=r(fn);MC=n(a4,"For full details on this method and other related features please refer to "),zr=l(a4,"A",{href:!0,rel:!0});var NF=r(zr);ZC=n(NF,"Constructing Massive Models"),NF.forEach(t),NC=n(a4,"."),a4.forEach(t),S3=c(e),fe=l(e,"P",{});var Kn=r(fe);HC=n(Kn,"Also when loading fp16-pretrained models, you will want to tell "),dv=l(Kn,"CODE",{});var HF=r(dv);BC=n(HF,"from_pretrained"),HF.forEach(t),WC=n(Kn,` to use
`),mv=l(Kn,"CODE",{});var BF=r(mv);FC=n(BF,"torch_dtype=torch.float16"),BF.forEach(t),VC=n(Kn,". For details, please, see "),dc=l(Kn,"A",{href:!0});var WF=r(dc);YC=n(WF,"from_pretrained-torch-dtype"),WF.forEach(t),KC=n(Kn,"."),Kn.forEach(t),C3=c(e),ot=l(e,"H4",{class:!0});var n4=r(ot);dn=l(n4,"A",{id:!0,class:!0,href:!0});var FF=r(dn);_v=l(FF,"SPAN",{});var VF=r(_v);d(Or.$$.fragment,VF),VF.forEach(t),FF.forEach(t),JC=c(n4),vv=l(n4,"SPAN",{});var YF=r(vv);XC=n(YF,"Gathering Parameters"),YF.forEach(t),n4.forEach(t),x3=c(e),Tr=l(e,"P",{});var mG=r(Tr);QC=n(mG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Ar=l(mG,"A",{href:!0,rel:!0});var KF=r(Ar);ex=n(KF,"Gathering Parameters"),KF.forEach(t),mG.forEach(t),R3=c(e),mn=l(e,"P",{});var o4=r(mn);sx=n(o4,`We do however use it internally in several places, one such example is when loading pretrained model weights in
`),jv=l(o4,"CODE",{});var JF=r(jv);tx=n(JF,"from_pretrained"),JF.forEach(t),ax=n(o4,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
limitations.`),o4.forEach(t),I3=c(e),mc=l(e,"P",{});var XF=r(mc);nx=n(XF,"Also under ZeRO-3, if you write your own code and run into a model parameter weight that looks like:"),XF.forEach(t),U3=c(e),d(Sr.$$.fragment,e),G3=c(e),ds=l(e,"P",{});var Zh=r(ds);ox=n(Zh,"stress on "),gv=l(Zh,"CODE",{});var QF=r(gv);lx=n(QF,"tensor([1.])"),QF.forEach(t),rx=n(Zh,", or if you get an error where it says the parameter is of size "),wv=l(Zh,"CODE",{});var eV=r(wv);px=n(eV,"1"),eV.forEach(t),ix=n(Zh,`, instead of some much
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),Zh.forEach(t),L3=c(e),_c=l(e,"A",{id:!0}),r(_c).forEach(t),M3=c(e),lt=l(e,"H3",{class:!0});var l4=r(lt);_n=l(l4,"A",{id:!0,class:!0,href:!0});var sV=r(_n);yv=l(sV,"SPAN",{});var tV=r(yv);d(Cr.$$.fragment,tV),tV.forEach(t),sV.forEach(t),ux=c(l4),bv=l(l4,"SPAN",{});var aV=r(bv);cx=n(aV,"ZeRO Inference"),aV.forEach(t),l4.forEach(t),Z3=c(e),vc=l(e,"P",{});var nV=r(vc);hx=n(nV,`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),nV.forEach(t),N3=c(e),vn=l(e,"P",{});var r4=r(vn);fx=n(r4,"Otherwise you just need to pass the usual "),jc=l(r4,"A",{href:!0});var oV=r(jc);dx=n(oV,"TrainingArguments"),oV.forEach(t),mx=n(r4," arguments. For example:"),r4.forEach(t),H3=c(e),d(xr.$$.fragment,e),B3=c(e),gc=l(e,"P",{});var lV=r(gc);_x=n(lV,`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),lV.forEach(t),W3=c(e),jn=l(e,"P",{});var p4=r(jn);vx=n(p4,"Here is an example of running "),Ev=l(p4,"CODE",{});var rV=r(Ev);jx=n(rV,"run_translation.py"),rV.forEach(t),gx=n(p4," under DeepSpeed deploying all available GPUs:"),p4.forEach(t),F3=c(e),d(Rr.$$.fragment,e),V3=c(e),wc=l(e,"P",{});var pV=r(wc);wx=n(pV,`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
...
dump the `),Sc=l(Jn,"A",{href:!0});var TV=r(Sc);Bx=n(TV,"TrainingArguments"),TV.forEach(t),Wx=n(Jn," as it has dozens of entries that are irrelevant."),Jn.forEach(t),DV.forEach(t),Fx=c($e),Zr=l($e,"LI",{});var h4=r(Zr);Tv=l(h4,"P",{});var AV=r(Tv);Vx=n(AV,"Output of:"),AV.forEach(t),Yx=c(h4),d(Nr.$$.fragment,h4),h4.forEach(t),Kx=c($e),Av=l($e,"LI",{});var SV=r(Av);Hr=l(SV,"P",{});var f4=r(Hr);Jx=n(f4,`If possible include a link to a Google Colab notebook that we can reproduce the problem with. You can use this
`),Br=l(f4,"A",{href:!0,rel:!0});var CV=r(Br);Xx=n(CV,"notebook"),CV.forEach(t),Qx=n(f4,` as
a starting point.`),f4.forEach(t),SV.forEach(t),eR=c($e),Sv=l($e,"LI",{});var xV=r(Sv);Cv=l(xV,"P",{});var RV=r(Cv);sR=n(RV,"Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),RV.forEach(t),xV.forEach(t),tR=c($e),xv=l($e,"LI",{});var IV=r(xv);Wr=l(IV,"P",{});var d4=r(Wr);aR=n(d4,"If possible try to use one of the existing "),Fr=l(d4,"A",{href:!0,rel:!0});var UV=r(Fr);nR=n(UV,"examples"),UV.forEach(t),oR=n(d4," to reproduce the problem with."),d4.forEach(t),IV.forEach(t),$e.forEach(t),c0=c(e),Cc=l(e,"P",{});var GV=r(Cc);lR=n(GV,"Things to consider:"),GV.forEach(t),h0=c(e),bn=l(e,"UL",{});var m4=r(bn);it=l(m4,"LI",{});var Nh=r(it);Rv=l(Nh,"P",{});var LV=r(Rv);rR=n(LV,"Deepspeed is often not the cause of the problem."),LV.forEach(t),pR=c(Nh),Iv=l(Nh,"P",{});var MV=r(Iv);iR=n(MV,`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
exception and you can see that DeepSpeed modules are involved, first re-test your setup without DeepSpeed in it.
And only if the problem persists then do mentioned Deepspeed and supply all the required details.`),ZV.forEach(t),Nh.forEach(t),hR=c(m4),Gv=l(m4,"LI",{});var NV=r(Gv);Vr=l(NV,"P",{});var _4=r(Vr);fR=n(_4,`If it\u2019s clear to you that the issue is in the DeepSpeed core and not the integration part, please file the Issue
directly with `),Yr=l(_4,"A",{href:!0,rel:!0});var HV=r(Yr);dR=n(HV,"Deepspeed"),HV.forEach(t),mR=n(_4,`. If you aren\u2019t sure, please do not worry,
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),_4.forEach(t),NV.forEach(t),m4.forEach(t),f0=c(e),ut=l(e,"H3",{class:!0});var v4=r(ut);En=l(v4,"A",{id:!0,class:!0,href:!0});var BV=r(En);Lv=l(BV,"SPAN",{});var WV=r(Lv);d(Kr.$$.fragment,WV),WV.forEach(t),BV.forEach(t),_R=c(v4),Mv=l(v4,"SPAN",{});var FV=r(Mv);vR=n(FV,"Troubleshooting"),FV.forEach(t),v4.forEach(t),d0=c(e),ct=l(e,"H4",{class:!0});var j4=r(ct);qn=l(j4,"A",{id:!0,class:!0,href:!0});var VV=r(qn);Zv=l(VV,"SPAN",{});var YV=r(Zv);d(Jr.$$.fragment,YV),YV.forEach(t),VV.forEach(t),jR=c(j4),Xr=l(j4,"SPAN",{});var g4=r(Xr);gR=n(g4,"the "),Nv=l(g4,"CODE",{});var KV=r(Nv);wR=n(KV,"deepspeed"),KV.forEach(t),yR=n(g4," process gets killed at startup without a traceback"),g4.forEach(t),j4.forEach(t),m0=c(e),B=l(e,"P",{});var ke=r(B);bR=n(ke,"If the "),Hv=l(ke,"CODE",{});var JV=r(Hv);ER=n(JV,"deepspeed"),JV.forEach(t),qR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
