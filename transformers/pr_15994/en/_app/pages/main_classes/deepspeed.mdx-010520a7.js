...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
to no avail, the next thing to try is to pre-build the modules before installing them.`),Tj=u(),Gp=o("p"),X5=a("To make a local build for DeepSpeed:"),Aj=u(),f(so.$$.fragment),Sj=u(),De=o("p"),Q5=a("If you intend to use NVMe offload you will also need to include "),Kh=o("code"),e4=a("DS_BUILD_AIO=1"),s4=a(` in the instructions above (and also
...
find more details in the discussion below.`),wg=u(),At=o("p"),V$=a("For a practical usage example of this type of deployment, please, see this "),wo=o("a"),Y$=a("post"),K$=a("."),bg=u(),Qp=o("p"),J$=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),qg=u(),ei=o("p"),X$=a("Notes:"),Eg=u(),si=o("ul"),qs=o("li"),bo=o("p"),Q$=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=o("code"),e6=a("CUDA_VISIBLE_DEVICES"),s6=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),t6=u(),f(qo.$$.fragment),a6=u(),Of=o("p"),n6=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),$g=u(),ti=o("a"),kg=u(),Es=o("h3"),St=o("a"),Tf=o("span"),f(Eo.$$.fragment),o6=u(),Af=o("span"),l6=a("Deployment in Notebooks"),Pg=u(),Ct=o("p"),r6=a("The problem with running notebook cells as a script is that there is no normal "),Sf=o("code"),p6=a("deepspeed"),i6=a(` launcher to rely on, so
under certain setups we have to emulate it.`),zg=u(),ai=o("p"),u6=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),Dg=u(),f($o.$$.fragment),Og=u(),xt=o("p"),c6=a("Note: "),Cf=o("code"),h6=a("..."),f6=a(" stands for the normal arguments that you\u2019d pass to the functions."),Tg=u(),ni=o("p"),d6=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),Ag=u(),oi=o("p"),m6=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),Sg=u(),f(ko.$$.fragment),Cg=u(),Se=o("p"),_6=a("If the training script is in a normal file and not in the notebook cells, you can launch "),xf=o("code"),v6=a("deepspeed"),j6=a(` normally via
shell from a cell. For example, to use `),Rf=o("code"),g6=a("run_translation.py"),y6=a(" you would launch it with:"),xg=u(),f(Po.$$.fragment),Rg=u(),Rt=o("p"),w6=a("or with "),If=o("code"),b6=a("%%bash"),q6=a(" magic, where you can write a multi-line code for the shell program to run:"),Ig=u(),f(zo.$$.fragment),Ug=u(),li=o("p"),E6=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),Gg=u(),It=o("p"),$6=a("Note: While "),Uf=o("code"),k6=a("%%bash"),P6=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Lg=u(),ri=o("a"),Mg=u(),$s=o("h3"),Ut=o("a"),Gf=o("span"),f(Do.$$.fragment),z6=u(),Lf=o("span"),D6=a("Configuration"),Zg=u(),Gt=o("p"),O6=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Oo=o("a"),T6=a("following documentation"),A6=a("."),Ng=u(),Lt=o("p"),S6=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),To=o("a"),C6=a(`the DeepSpeedExamples
repo`),x6=a(":"),Hg=u(),f(Ao.$$.fragment),Bg=u(),Mt=o("p"),R6=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Mf=o("code"),I6=a(".json"),U6=a(" files with:"),Wg=u(),f(So.$$.fragment),Fg=u(),Zt=o("p"),G6=a("Some more examples are to be found in the "),Co=o("a"),L6=a("main repo"),M6=a(" as well."),Vg=u(),pi=o("p"),Z6=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Yg=u(),X=o("p"),N6=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Zf=o("code"),H6=a("AdamW"),B6=a(" optimizer and "),Nf=o("code"),W6=a("WarmupLR"),F6=a(` scheduler and will enable mixed
precision training if `),Hf=o("code"),V6=a("--fp16"),Y6=a(" is passed:"),Kg=u(),f(xo.$$.fragment),Jg=u(),Nt=o("p"),K6=a("When you execute the program, DeepSpeed will log the configuration it received from the "),ii=o("a"),J6=a("Trainer"),X6=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),Xg=u(),ui=o("a"),Qg=u(),ks=o("h3"),Ht=o("a"),Bf=o("span"),f(Ro.$$.fragment),Q6=u(),Wf=o("span"),e9=a("Passing Configuration"),ey=u(),T=o("p"),s9=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
find more details in the discussion below.`),xG.forEach(t),wg=c(e),At=l(e,"P",{});var O0=r(At);V$=n(O0,"For a practical usage example of this type of deployment, please, see this "),wo=l(O0,"A",{href:!0,rel:!0});var RG=r(wo);Y$=n(RG,"post"),RG.forEach(t),K$=n(O0,"."),O0.forEach(t),bg=c(e),Qp=l(e,"P",{});var IG=r(Qp);J$=n(IG,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),IG.forEach(t),qg=c(e),ei=l(e,"P",{});var UG=r(ei);X$=n(UG,"Notes:"),UG.forEach(t),Eg=c(e),si=l(e,"UL",{});var GG=r(si);qs=l(GG,"LI",{});var Kc=r(qs);bo=l(Kc,"P",{});var T0=r(bo);Q$=n(T0,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=l(T0,"CODE",{});var LG=r(Df);e6=n(LG,"CUDA_VISIBLE_DEVICES"),LG.forEach(t),s6=n(T0,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),T0.forEach(t),t6=c(Kc),d(qo.$$.fragment,Kc),a6=c(Kc),Of=l(Kc,"P",{});var MG=r(Of);n6=n(MG,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),MG.forEach(t),Kc.forEach(t),GG.forEach(t),$g=c(e),ti=l(e,"A",{id:!0}),r(ti).forEach(t),kg=c(e),Es=l(e,"H3",{class:!0});var A0=r(Es);St=l(A0,"A",{id:!0,class:!0,href:!0});var ZG=r(St);Tf=l(ZG,"SPAN",{});var NG=r(Tf);d(Eo.$$.fragment,NG),NG.forEach(t),ZG.forEach(t),o6=c(A0),Af=l(A0,"SPAN",{});var HG=r(Af);l6=n(HG,"Deployment in Notebooks"),HG.forEach(t),A0.forEach(t),Pg=c(e),Ct=l(e,"P",{});var S0=r(Ct);r6=n(S0,"The problem with running notebook cells as a script is that there is no normal "),Sf=l(S0,"CODE",{});var BG=r(Sf);p6=n(BG,"deepspeed"),BG.forEach(t),i6=n(S0,` launcher to rely on, so
under certain setups we have to emulate it.`),S0.forEach(t),zg=c(e),ai=l(e,"P",{});var WG=r(ai);u6=n(WG,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),WG.forEach(t),Dg=c(e),d($o.$$.fragment,e),Og=c(e),xt=l(e,"P",{});var C0=r(xt);c6=n(C0,"Note: "),Cf=l(C0,"CODE",{});var FG=r(Cf);h6=n(FG,"..."),FG.forEach(t),f6=n(C0," stands for the normal arguments that you\u2019d pass to the functions."),C0.forEach(t),Tg=c(e),ni=l(e,"P",{});var VG=r(ni);d6=n(VG,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),VG.forEach(t),Ag=c(e),oi=l(e,"P",{});var YG=r(oi);m6=n(YG,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),YG.forEach(t),Sg=c(e),d(ko.$$.fragment,e),Cg=c(e),Se=l(e,"P",{});var Jc=r(Se);_6=n(Jc,"If the training script is in a normal file and not in the notebook cells, you can launch "),xf=l(Jc,"CODE",{});var KG=r(xf);v6=n(KG,"deepspeed"),KG.forEach(t),j6=n(Jc,` normally via
shell from a cell. For example, to use `),Rf=l(Jc,"CODE",{});var JG=r(Rf);g6=n(JG,"run_translation.py"),JG.forEach(t),y6=n(Jc," you would launch it with:"),Jc.forEach(t),xg=c(e),d(Po.$$.fragment,e),Rg=c(e),Rt=l(e,"P",{});var x0=r(Rt);w6=n(x0,"or with "),If=l(x0,"CODE",{});var XG=r(If);b6=n(XG,"%%bash"),XG.forEach(t),q6=n(x0," magic, where you can write a multi-line code for the shell program to run:"),x0.forEach(t),Ig=c(e),d(zo.$$.fragment,e),Ug=c(e),li=l(e,"P",{});var QG=r(li);E6=n(QG,"In such case you don\u2019t need any of the code presented at the beginning of this section."),QG.forEach(t),Gg=c(e),It=l(e,"P",{});var R0=r(It);$6=n(R0,"Note: While "),Uf=l(R0,"CODE",{});var eL=r(Uf);k6=n(eL,"%%bash"),eL.forEach(t),P6=n(R0,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),R0.forEach(t),Lg=c(e),ri=l(e,"A",{id:!0}),r(ri).forEach(t),Mg=c(e),$s=l(e,"H3",{class:!0});var I0=r($s);Ut=l(I0,"A",{id:!0,class:!0,href:!0});var sL=r(Ut);Gf=l(sL,"SPAN",{});var tL=r(Gf);d(Do.$$.fragment,tL),tL.forEach(t),sL.forEach(t),z6=c(I0),Lf=l(I0,"SPAN",{});var aL=r(Lf);D6=n(aL,"Configuration"),aL.forEach(t),I0.forEach(t),Zg=c(e),Gt=l(e,"P",{});var U0=r(Gt);O6=n(U0,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Oo=l(U0,"A",{href:!0,rel:!0});var nL=r(Oo);T6=n(nL,"following documentation"),nL.forEach(t),A6=n(U0,"."),U0.forEach(t),Ng=c(e),Lt=l(e,"P",{});var G0=r(Lt);S6=n(G0,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),To=l(G0,"A",{href:!0,rel:!0});var oL=r(To);C6=n(oL,`the DeepSpeedExamples
repo`),oL.forEach(t),x6=n(G0,":"),G0.forEach(t),Hg=c(e),d(Ao.$$.fragment,e),Bg=c(e),Mt=l(e,"P",{});var L0=r(Mt);R6=n(L0,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Mf=l(L0,"CODE",{});var lL=r(Mf);I6=n(lL,".json"),lL.forEach(t),U6=n(L0," files with:"),L0.forEach(t),Wg=c(e),d(So.$$.fragment,e),Fg=c(e),Zt=l(e,"P",{});var M0=r(Zt);G6=n(M0,"Some more examples are to be found in the "),Co=l(M0,"A",{href:!0,rel:!0});var rL=r(Co);L6=n(rL,"main repo"),rL.forEach(t),M6=n(M0," as well."),M0.forEach(t),Vg=c(e),pi=l(e,"P",{});var pL=r(pi);Z6=n(pL,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),pL.forEach(t),Yg=c(e),X=l(e,"P",{});var Dn=r(X);N6=n(Dn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Zf=l(Dn,"CODE",{});var iL=r(Zf);H6=n(iL,"AdamW"),iL.forEach(t),B6=n(Dn," optimizer and "),Nf=l(Dn,"CODE",{});var uL=r(Nf);W6=n(uL,"WarmupLR"),uL.forEach(t),F6=n(Dn,` scheduler and will enable mixed
precision training if `),Hf=l(Dn,"CODE",{});var cL=r(Hf);V6=n(cL,"--fp16"),cL.forEach(t),Y6=n(Dn," is passed:"),Dn.forEach(t),Kg=c(e),d(xo.$$.fragment,e),Jg=c(e),Nt=l(e,"P",{});var Z0=r(Nt);K6=n(Z0,"When you execute the program, DeepSpeed will log the configuration it received from the "),ii=l(Z0,"A",{href:!0});var hL=r(ii);J6=n(hL,"Trainer"),hL.forEach(t),X6=n(Z0,`
to the console, so you can see exactly what was the final configuration passed to it.`),Z0.forEach(t),Xg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Qg=c(e),ks=l(e,"H3",{class:!0});var N0=r(ks);Ht=l(N0,"A",{id:!0,class:!0,href:!0});var fL=r(Ht);Bf=l(fL,"SPAN",{});var dL=r(Bf);d(Ro.$$.fragment,dL),dL.forEach(t),fL.forEach(t),Q6=c(N0),Wf=l(N0,"SPAN",{});var mL=r(Wf);e9=n(mL,"Passing Configuration"),mL.forEach(t),N0.forEach(t),ey=c(e),T=l(e,"P",{});var fe=r(T);s9=n(fe,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
