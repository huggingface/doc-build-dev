import{S as Km,i as Zm,s as Xm,e as o,k as d,w as g,t as r,M as Qm,c as s,d as t,m as l,a,x as v,h as i,b as c,F as e,g as h,y as k,q as T,o as M,B as y,v as ef}from"../../chunks/vendor-6b77c823.js";import{T as pn}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-abef54e3.js";import{C as $e}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as he}from"../../chunks/IconCopyLink-7a11ce68.js";function tf(I){let u,z,f,x,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),x=r("Module"),w=r(`
...
`),S=s(de,"CODE",{});var xe=a(S);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),L.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,x,j),e(x,w),e(w,b),e(x,_),e(x,$),e($,Ae),h(m,ue,j),h(m,q,j),e(q,ve),e(q,X),e(X,Oe),e(q,Q),e(q,ee),e(ee,Se),e(q,je),h(m,G,j),h(m,A,j),e(A,qe),h(m,C,j),h(m,E,j),e(E,P),e(P,te),e(P,ne),e(ne,ke),e(P,He),e(P,J),e(J,F),e(E,Te),e(E,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(E,We),e(E,O),e(O,Ue),e(O,S),e(S,H)},d(m){m&&t(u),m&&t(f),m&&t(x),m&&t(ue),m&&t(q),m&&t(G),m&&t(A),m&&t(C),m&&t(E)}}}function sf(I){let u,z,f,x,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),x=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){u=s(b,"P",{});var _=a(u);z=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var $=a(f);x=i($,"Module"),$.forEach(t),w=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(b){u=s(b,"P",{});var _=a(u);z=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var $=a(f);x=i($,"Module"),$.forEach(t),w=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){h(b,u,_),e(u,z),e(u,f),e(f,x),e(u,w)},d(b){b&&t(u)}}}function cf(I){let u,z,f,x,w,b,_,$,Ae,ue,q,ve,X,Oe,Q,ee,Se,je,G,A,qe,C,E,P,te,ne,ke,He,J,F,Te,N,De,oe,Me,se,ae,re,We,O,Ue,S,H,m,j,ye,nt,be,D,ot,st,Re,L,ie,at,Ve,W,rt,it,de,xe,bi,Zo,xi,wi,zi,dt,hn,$i,qs,ji,qi,Ei,un,Fi,Es,Pi,Ni,Ci,lt,Li,Fs,Ii,Ai,Ps,Oi,Si,Hi,Ns,mn,Di,Cs,Wi,Ui,Ri,Ls,fn,Vi,_n,Bi,Gi,Za,ct,Nt,Is,gn,Ji,As,Yi,Xa,Ee,Xo,Ki,Os,Zi,Xi,vn,Qi,kn,ed,td,nd,pt,od,Ss,sd,ad,Hs,rd,id,dd,Ds,ld,Qa,ht,Ct,Ws,Tn,cd,Us,pd,er,Lt,Rs,hd,ud,Vs,Mn,md,tr,ut,It,Bs,yn,fd,Gs,_d,nr,Fe,bn,gd,Js,vd,kd,Td,xn,Md,Ys,yd,bd,xd,wn,wd,zn,zd,$d,jd,$n,qd,Ks,Ed,Fd,or,At,Pd,jn,Nd,Cd,sr,qn,ar,Qo,Ld,rr,En,ir,mt,Ot,Zs,Fn,Id,Xs,Ad,dr,es,Od,lr,Pn,cr,ts,Sd,pr,Nn,hr,ft,St,Qs,Cn,Hd,ea,Dd,ur,le,Ln,Wd,_t,Ud,ns,Rd,Vd,In,Bd,Gd,Jd,gt,Yd,os,Kd,Zd,ss,Xd,Qd,el,ta,tl,nl,An,mr,vt,Ht,na,On,ol,oa,sl,fr,U,Sn,al,Hn,rl,Dn,il,dl,ll,Wn,cl,as,pl,hl,ul,sa,ml,fl,Un,_l,Dt,Rn,gl,aa,vl,_r,kt,Wt,ra,Vn,kl,ia,Tl,gr,we,Bn,Ml,Gn,yl,rs,bl,xl,wl,Jn,zl,Yn,$l,jl,ql,me,Kn,El,Tt,Fl,is,Pl,Nl,da,Cl,Ll,Il,Ut,Al,la,Ol,Sl,Zn,vr,Mt,Rt,ca,Xn,Hl,pa,Dl,kr,ze,Qn,Wl,eo,Ul,ds,Rl,Vl,Bl,to,Gl,no,Jl,Yl,Kl,Y,oo,Zl,yt,Xl,ls,Ql,ec,ha,tc,nc,oc,Vt,sc,so,ac,ao,rc,ic,dc,ua,lc,cc,ro,Tr,bt,Bt,ma,io,pc,fa,hc,Mr,xt,lo,uc,Je,co,mc,_a,fc,_c,po,yr,wt,Gt,ga,ho,gc,va,vc,br,ce,uo,kc,mo,Tc,cs,Mc,yc,bc,fo,xc,_o,wc,zc,$c,Jt,jc,fe,go,qc,zt,Ec,ps,Fc,Pc,ka,Nc,Cc,Lc,Yt,Ic,Ta,Ac,Oc,vo,xr,$t,Kt,Ma,ko,Sc,ya,Hc,wr,pe,To,Dc,Mo,Wc,hs,Uc,Rc,Vc,yo,Bc,bo,Gc,Jc,Yc,Zt,Kc,K,xo,Zc,jt,Xc,us,Qc,ep,ba,tp,np,op,Xt,sp,wo,ap,zo,rp,ip,dp,xa,lp,cp,$o,zr,qt,Qt,wa,jo,pp,za,hp,$r,R,qo,up,Eo,mp,ms,fp,_p,gp,Fo,vp,Po,kp,Tp,Mp,$a,yp,bp,Be,ja,No,xp,wp,qa,Co,zp,$p,Ea,Lo,jp,qp,Fa,Io,Ep,Fp,_e,Ao,Pp,Et,Np,Pa,Cp,Lp,Na,Ip,Ap,Op,en,Sp,Ca,Hp,Dp,Oo,jr,Ft,tn,La,So,Wp,Ia,Up,qr,V,Ho,Rp,Do,Vp,fs,Bp,Gp,Jp,Wo,Yp,Uo,Kp,Zp,Xp,Aa,Qp,eh,Ge,Oa,Ro,th,nh,Sa,Vo,oh,sh,Ha,Bo,ah,rh,Da,Go,ih,dh,ge,Jo,lh,Pt,ch,Wa,ph,hh,Ua,uh,mh,fh,nn,_h,Ra,gh,vh,Yo,Er;return b=new he({}),te=new he({}),gn=new he({}),Tn=new he({}),yn=new he({}),qn=new $e({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
</ul>`,name:"sp_model_kwargs"}]}}),Un=new $e({props:{code:`from transformers import MarianTokenizer
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15994/en/model_doc/marian#transformers.MarianConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">26</span>, <span class="hljs-number">512</span>]`}}),Xn=new he({}),Qn=new B({props:{name:"class transformers.MarianMTModel",anchor:"transformers.MarianMTModel",parameters:[{name:"config",val:": MarianConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/models/marian/modeling_marian.py#L1267",parametersDescription:[{anchor:"transformers.MarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15994/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15994/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oo=new B({props:{name:"forward",anchor:"transformers.MarianMTModel.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple[torch.Tensor], transformers.modeling_outputs.BaseModelOutput, NoneType] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/models/marian/modeling_marian.py#L1390",parametersDescription:[{anchor:"transformers.MarianMTModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15994/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_15994/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15994/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-literal">True</span>`}}),ho=new he({}),uo=new B({props:{name:"class transformers.TFMarianModel",anchor:"transformers.TFMarianModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/models/marian/modeling_tf_marian.py#L1157",parametersDescription:[{anchor:"transformers.TFMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15994/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15994/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jt=new pn({props:{$$slots:{default:[of]},$$scope:{ctx:I}}}),go=new B({props:{name:"call",anchor:"transformers.TFMarianModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/models/marian/modeling_tf_marian.py#L1169",parametersDescription:[{anchor:"transformers.TFMarianModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ko=new he({}),To=new B({props:{name:"class transformers.TFMarianMTModel",anchor:"transformers.TFMarianMTModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/models/marian/modeling_tf_marian.py#L1243",parametersDescription:[{anchor:"transformers.TFMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15994/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15994/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new pn({props:{$$slots:{default:[af]},$$scope:{ctx:I}}}),xo=new B({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/models/marian/modeling_tf_marian.py#L1276",parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15994/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_15994/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15994/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_15994/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_15994/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Jo=new B({props:{name:"__call__",anchor:"transformers.FlaxMarianMTModel.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15994/src/transformers/models/marian/modeling_flax_marian.py#L1130",parametersDescription:[{anchor:"transformers.FlaxMarianMTModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15994/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_15994/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15994/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
and assign @patrickvonplaten.`),je=d(),G=o("p"),A=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),qe=d(),C=o("h2"),E=o("a"),P=o("span"),g(te.$$.fragment),ne=d(),ke=o("span"),He=r("Implementation Notes"),J=d(),F=o("ul"),Te=o("li"),N=o("p"),De=r("Each model is about 298 MB on disk, there are more than 1,000 models."),oe=d(),Me=o("li"),se=o("p"),ae=r("The list of supported language pairs can be found "),re=o("a"),We=r("here"),O=r("."),Ue=d(),S=o("li"),H=o("p"),m=r("Models were originally trained by "),j=o("a"),ye=r("J\xF6rg Tiedemann"),nt=r(" using the "),be=o("a"),D=r("Marian"),ot=r(" C++ library, which supports fast training and translation."),st=d(),Re=o("li"),L=o("p"),ie=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),at=d(),Ve=o("li"),W=o("p"),rt=r("The 80 opus models that require BPE preprocessing are not supported."),it=d(),de=o("li"),xe=o("p"),bi=r("The modeling code is the same as "),Zo=o("a"),xi=r("BartForConditionalGeneration"),wi=r(" with a few minor modifications:"),zi=d(),dt=o("ul"),hn=o("li"),$i=r("static (sinusoid) positional embeddings ("),qs=o("code"),ji=r("MarianConfig.static_position_embeddings=True"),qi=r(")"),Ei=d(),un=o("li"),Fi=r("no layernorm_embedding ("),Es=o("code"),Pi=r("MarianConfig.normalize_embedding=False"),Ni=r(")"),Ci=d(),lt=o("li"),Li=r("the model starts generating with "),Fs=o("code"),Ii=r("pad_token_id"),Ai=r(` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Ps=o("code"),Oi=r("<s/>"),Si=r("),"),Hi=d(),Ns=o("li"),mn=o("p"),Di=r("Code to bulk convert models can be found in "),Cs=o("code"),Wi=r("convert_marian_to_pytorch.py"),Ui=r("."),Ri=d(),Ls=o("li"),fn=o("p"),Vi=r("This model was contributed by "),_n=o("a"),Bi=r("sshleifer"),Gi=r("."),Za=d(),ct=o("h2"),Nt=o("a"),Is=o("span"),g(gn.$$.fragment),Ji=d(),As=o("span"),Yi=r("Naming"),Xa=d(),Ee=o("ul"),Xo=o("li"),Ki=r("All model names use the following format: "),Os=o("code"),Zi=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),Xi=d(),vn=o("li"),Qi=r("The language codes used to name models are inconsistent. Two digit codes can usually be found "),kn=o("a"),ed=r("here"),td=r(`, three digit codes require googling \u201Clanguage
...
group use a combination of ISO-639-5 codes and ISO-639-2 codes.`),Qa=d(),ht=o("h2"),Ct=o("a"),Ws=o("span"),g(Tn.$$.fragment),cd=d(),Us=o("span"),pd=r("Examples"),er=d(),Lt=o("ul"),Rs=o("li"),hd=r(`Since Marian models are smaller than many other translation models available in the library, they can be useful for
fine-tuning experiments and integration tests.`),ud=d(),Vs=o("li"),Mn=o("a"),md=r("Fine-tune on GPU"),tr=d(),ut=o("h2"),It=o("a"),Bs=o("span"),g(yn.$$.fragment),fd=d(),Gs=o("span"),_d=r("Multilingual Models"),nr=d(),Fe=o("ul"),bn=o("li"),gd=r("All model names use the following format: "),Js=o("code"),vd=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),kd=r(":"),Td=d(),xn=o("li"),Md=r(`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
require 3 character language codes:`),sr=d(),g(qn.$$.fragment),ar=d(),Qo=o("p"),Ld=r("Here is the code to see all available pretrained models on the hub:"),rr=d(),g(En.$$.fragment),ir=d(),mt=o("h2"),Ot=o("a"),Zs=o("span"),g(Fn.$$.fragment),Id=d(),Xs=o("span"),Ad=r("Old Style Multi-Lingual Models"),dr=d(),es=o("p"),Od=r(`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),lr=d(),g(Pn.$$.fragment),cr=d(),ts=o("p"),Sd=r("Example of translating english to many romance languages, using old-style 2 character language codes"),pr=d(),g(Nn.$$.fragment),hr=d(),ft=o("h2"),St=o("a"),Qs=o("span"),g(Cn.$$.fragment),Hd=d(),ea=o("span"),Dd=r("MarianConfig"),ur=d(),le=o("div"),g(Ln.$$.fragment),Wd=d(),_t=o("p"),Ud=r("This is the configuration class to store the configuration of a "),ns=o("a"),Rd=r("MarianModel"),Vd=r(`. It is used to instantiate an
...
`),In=o("a"),Bd=r("Helsinki-NLP/opus-mt-en-de"),Gd=r(" architecture."),Jd=d(),gt=o("p"),Yd=r("Configuration objects inherit from "),os=o("a"),Kd=r("PretrainedConfig"),Zd=r(` and can be used to control the model outputs. Read the
documentation from `),ss=o("a"),Xd=r("PretrainedConfig"),Qd=r(" for more information."),el=d(),ta=o("p"),tl=r("Examples:"),nl=d(),g(An.$$.fragment),mr=d(),vt=o("h2"),Ht=o("a"),na=o("span"),g(On.$$.fragment),ol=d(),oa=o("span"),sl=r("MarianTokenizer"),fr=d(),U=o("div"),g(Sn.$$.fragment),al=d(),Hn=o("p"),rl=r("Construct a Marian tokenizer. Based on "),Dn=o("a"),il=r("SentencePiece"),dl=r("."),ll=d(),Wn=o("p"),cl=r("This tokenizer inherits from "),as=o("a"),pl=r("PreTrainedTokenizer"),hl=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ul=d(),sa=o("p"),ml=r("Examples:"),fl=d(),g(Un.$$.fragment),_l=d(),Dt=o("div"),g(Rn.$$.fragment),gl=d(),aa=o("p"),vl=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),_r=d(),kt=o("h2"),Wt=o("a"),ra=o("span"),g(Vn.$$.fragment),kl=d(),ia=o("span"),Tl=r("MarianModel"),gr=d(),we=o("div"),g(Bn.$$.fragment),Ml=d(),Gn=o("p"),yl=r(`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ql=d(),me=o("div"),g(Kn.$$.fragment),El=d(),Tt=o("p"),Fl=r("The "),is=o("a"),Pl=r("MarianModel"),Nl=r(" forward method, overrides the "),da=o("code"),Cl=r("__call__"),Ll=r(" special method."),Il=d(),g(Ut.$$.fragment),Al=d(),la=o("p"),Ol=r("Example:"),Sl=d(),g(Zn.$$.fragment),vr=d(),Mt=o("h2"),Rt=o("a"),ca=o("span"),g(Xn.$$.fragment),Hl=d(),pa=o("span"),Dl=r("MarianMTModel"),kr=d(),ze=o("div"),g(Qn.$$.fragment),Wl=d(),eo=o("p"),Ul=r(`The Marian Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kl=d(),Y=o("div"),g(oo.$$.fragment),Zl=d(),yt=o("p"),Xl=r("The "),ls=o("a"),Ql=r("MarianMTModel"),ec=r(" forward method, overrides the "),ha=o("code"),tc=r("__call__"),nc=r(" special method."),oc=d(),g(Vt.$$.fragment),sc=d(),so=o("p"),ac=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),ao=o("a"),rc=r("here"),ic=r("."),dc=d(),ua=o("p"),lc=r("Examples:"),cc=d(),g(ro.$$.fragment),Tr=d(),bt=o("h2"),Bt=o("a"),ma=o("span"),g(io.$$.fragment),pc=d(),fa=o("span"),hc=r("MarianForCausalLM"),Mr=d(),xt=o("div"),g(lo.$$.fragment),uc=d(),Je=o("div"),g(co.$$.fragment),mc=d(),_a=o("p"),fc=r("Example:"),_c=d(),g(po.$$.fragment),yr=d(),wt=o("h2"),Gt=o("a"),ga=o("span"),g(ho.$$.fragment),gc=d(),va=o("span"),vc=r("TFMarianModel"),br=d(),ce=o("div"),g(uo.$$.fragment),kc=d(),mo=o("p"),Tc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
behavior.`),$c=d(),g(Jt.$$.fragment),jc=d(),fe=o("div"),g(go.$$.fragment),qc=d(),zt=o("p"),Ec=r("The "),ps=o("a"),Fc=r("TFMarianModel"),Pc=r(" forward method, overrides the "),ka=o("code"),Nc=r("__call__"),Cc=r(" special method."),Lc=d(),g(Yt.$$.fragment),Ic=d(),Ta=o("p"),Ac=r("Example:"),Oc=d(),g(vo.$$.fragment),xr=d(),$t=o("h2"),Kt=o("a"),Ma=o("span"),g(ko.$$.fragment),Sc=d(),ya=o("span"),Hc=r("TFMarianMTModel"),wr=d(),pe=o("div"),g(To.$$.fragment),Dc=d(),Mo=o("p"),Wc=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gp=d(),Fo=o("p"),vp=r(`This model is also a Flax Linen
`),Po=o("a"),kp=r("flax.nn.Module"),Tp=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mp=d(),$a=o("p"),yp=r("Finally, this model supports inherent JAX features such as:"),bp=d(),Be=o("ul"),ja=o("li"),No=o("a"),xp=r("Just-In-Time (JIT) compilation"),wp=d(),qa=o("li"),Co=o("a"),zp=r("Automatic Differentiation"),$p=d(),Ea=o("li"),Lo=o("a"),jp=r("Vectorization"),qp=d(),Fa=o("li"),Io=o("a"),Ep=r("Parallelization"),Fp=d(),_e=o("div"),g(Ao.$$.fragment),Pp=d(),Et=o("p"),Np=r("The "),Pa=o("code"),Cp=r("FlaxMarianPreTrainedModel"),Lp=r("forward method, overrides the "),Na=o("code"),Ip=r("__call__"),Ap=r(" special method."),Op=d(),g(en.$$.fragment),Sp=d(),Ca=o("p"),Hp=r("Example:"),Dp=d(),g(Oo.$$.fragment),jr=d(),Ft=o("h2"),tn=o("a"),La=o("span"),g(So.$$.fragment),Wp=d(),Ia=o("span"),Up=r("FlaxMarianMTModel"),qr=d(),V=o("div"),g(Ho.$$.fragment),Rp=d(),Do=o("p"),Vp=r(`The MARIAN Model with a language modeling head. Can be used for translation.
...
group use a combination of ISO-639-5 codes and ISO-639-2 codes.`),Kh.forEach(t),sn.forEach(t),Qa=l(n),ht=s(n,"H2",{class:!0});var Dr=a(ht);Ct=s(Dr,"A",{id:!0,class:!0,href:!0});var Zh=a(Ct);Ws=s(Zh,"SPAN",{});var Xh=a(Ws);v(Tn.$$.fragment,Xh),Xh.forEach(t),Zh.forEach(t),cd=l(Dr),Us=s(Dr,"SPAN",{});var Qh=a(Us);pd=i(Qh,"Examples"),Qh.forEach(t),Dr.forEach(t),er=l(n),Lt=s(n,"UL",{});var Wr=a(Lt);Rs=s(Wr,"LI",{});var eu=a(Rs);hd=i(eu,`Since Marian models are smaller than many other translation models available in the library, they can be useful for
fine-tuning experiments and integration tests.`),eu.forEach(t),ud=l(Wr),Vs=s(Wr,"LI",{});var tu=a(Vs);Mn=s(tu,"A",{href:!0,rel:!0});var nu=a(Mn);md=i(nu,"Fine-tune on GPU"),nu.forEach(t),tu.forEach(t),Wr.forEach(t),tr=l(n),ut=s(n,"H2",{class:!0});var Ur=a(ut);It=s(Ur,"A",{id:!0,class:!0,href:!0});var ou=a(It);Bs=s(ou,"SPAN",{});var su=a(Bs);v(yn.$$.fragment,su),su.forEach(t),ou.forEach(t),fd=l(Ur),Gs=s(Ur,"SPAN",{});var au=a(Gs);_d=i(au,"Multilingual Models"),au.forEach(t),Ur.forEach(t),nr=l(n),Fe=s(n,"UL",{});var an=a(Fe);bn=s(an,"LI",{});var Rr=a(bn);gd=i(Rr,"All model names use the following format: "),Js=s(Rr,"CODE",{});var ru=a(Js);vd=i(ru,"Helsinki-NLP/opus-mt-{src}-{tgt}"),ru.forEach(t),kd=i(Rr,":"),Rr.forEach(t),Td=l(an),xn=s(an,"LI",{});var Vr=a(xn);Md=i(Vr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
group:`),fu.forEach(t),lr=l(n),v(Pn.$$.fragment,n),cr=l(n),ts=s(n,"P",{});var _u=a(ts);Sd=i(_u,"Example of translating english to many romance languages, using old-style 2 character language codes"),_u.forEach(t),pr=l(n),v(Nn.$$.fragment,n),hr=l(n),ft=s(n,"H2",{class:!0});var Kr=a(ft);St=s(Kr,"A",{id:!0,class:!0,href:!0});var gu=a(St);Qs=s(gu,"SPAN",{});var vu=a(Qs);v(Cn.$$.fragment,vu),vu.forEach(t),gu.forEach(t),Hd=l(Kr),ea=s(Kr,"SPAN",{});var ku=a(ea);Dd=i(ku,"MarianConfig"),ku.forEach(t),Kr.forEach(t),ur=l(n),le=s(n,"DIV",{class:!0});var Ye=a(le);v(Ln.$$.fragment,Ye),Wd=l(Ye),_t=s(Ye,"P",{});var Ts=a(_t);Ud=i(Ts,"This is the configuration class to store the configuration of a "),ns=s(Ts,"A",{href:!0});var Tu=a(ns);Rd=i(Tu,"MarianModel"),Tu.forEach(t),Vd=i(Ts,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
`),In=s(Ts,"A",{href:!0,rel:!0});var Mu=a(In);Bd=i(Mu,"Helsinki-NLP/opus-mt-en-de"),Mu.forEach(t),Gd=i(Ts," architecture."),Ts.forEach(t),Jd=l(Ye),gt=s(Ye,"P",{});var Ms=a(gt);Yd=i(Ms,"Configuration objects inherit from "),os=s(Ms,"A",{href:!0});var yu=a(os);Kd=i(yu,"PretrainedConfig"),yu.forEach(t),Zd=i(Ms,` and can be used to control the model outputs. Read the
...
this superclass for more information regarding those methods.`),Qr.forEach(t),ul=l(Pe),sa=s(Pe,"P",{});var Eu=a(sa);ml=i(Eu,"Examples:"),Eu.forEach(t),fl=l(Pe),v(Un.$$.fragment,Pe),_l=l(Pe),Dt=s(Pe,"DIV",{class:!0});var ei=a(Dt);v(Rn.$$.fragment,ei),gl=l(ei),aa=s(ei,"P",{});var Fu=a(aa);vl=i(Fu,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Fu.forEach(t),ei.forEach(t),Pe.forEach(t),_r=l(n),kt=s(n,"H2",{class:!0});var ti=a(kt);Wt=s(ti,"A",{id:!0,class:!0,href:!0});var Pu=a(Wt);ra=s(Pu,"SPAN",{});var Nu=a(ra);v(Vn.$$.fragment,Nu),Nu.forEach(t),Pu.forEach(t),kl=l(ti),ia=s(ti,"SPAN",{});var Cu=a(ia);Tl=i(Cu,"MarianModel"),Cu.forEach(t),ti.forEach(t),gr=l(n),we=s(n,"DIV",{class:!0});var rn=a(we);v(Bn.$$.fragment,rn),Ml=l(rn),Gn=s(rn,"P",{});var ni=a(Gn);yl=i(ni,`The bare Marian Model outputting raw hidden-states without any specific head on top.
