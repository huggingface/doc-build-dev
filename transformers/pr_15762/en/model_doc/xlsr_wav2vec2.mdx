...
<h1 id="xlsrwav2vec2">XLSR-Wav2Vec2</h1>
...
- XLSR-Wav2Vec2 model was trained using connectionist temporal classification (CTC) so the model output has to be
  decoded using [Wav2Vec2CTCTokenizer](/docs/transformers/pr_15762/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer).
