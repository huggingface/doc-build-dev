...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16441/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16441/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16441/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16441/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16441/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16441/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16441/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16441/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16441/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16441/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16441/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16441/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16441/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16441/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16441/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16441/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16441/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16441/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
splitting and wordpiece.`),ea.forEach(t),Gg=p(oo),ja=s(oo,"P",{});var Bl=a(ja);Xg=i(Bl,"Refer to superclass "),nd=s(Bl,"A",{href:!0});var Wm=a(nd);Yg=i(Wm,"BertTokenizerFast"),Wm.forEach(t),Zg=i(Bl," for usage examples and documentation concerning parameters."),Bl.forEach(t),oo.forEach(t),Gm=p(o),vo=s(o,"H2",{class:!0});var Vl=a(vo);En=s(Vl,"A",{id:!0,class:!0,href:!0});var Um=a(En);yc=s(Um,"SPAN",{});var Rm=a(yc);y(qa.$$.fragment,Rm),Rm.forEach(t),Um.forEach(t),e_=p(Vl),Ec=s(Vl,"SPAN",{});var Hm=a(Ec);t_=i(Hm,"Electra specific outputs"),Hm.forEach(t),Vl.forEach(t),Xm=p(o),To=s(o,"DIV",{class:!0});var Hu=a(To);y(Pa.$$.fragment,Hu),o_=p(Hu),Aa=s(Hu,"P",{});var Qu=a(Aa);n_=i(Qu,"Output type of "),sd=s(Qu,"A",{href:!0});var X2=a(sd);s_=i(X2,"ElectraForPreTraining"),X2.forEach(t),a_=i(Qu,"."),Qu.forEach(t),Hu.forEach(t),Ym=p(o),bo=s(o,"DIV",{class:!0});var Bu=a(bo);y(Oa.$$.fragment,Bu),r_=p(Bu),La=s(Bu,"P",{});var Vu=a(La);i_=i(Vu,"Output type of "),ad=s(Vu,"A",{href:!0});var Y2=a(ad);l_=i(Y2,"TFElectraForPreTraining"),Y2.forEach(t),d_=i(Vu,"."),Vu.forEach(t),Bu.forEach(t),Zm=p(o),yo=s(o,"H2",{class:!0});var Ku=a(yo);wn=s(Ku,"A",{id:!0,class:!0,href:!0});var Z2=a(wn);wc=s(Z2,"SPAN",{});var e4=a(wc);y(Na.$$.fragment,e4),e4.forEach(t),Z2.forEach(t),c_=p(Ku),$c=s(Ku,"SPAN",{});var t4=a($c);p_=i(t4,"ElectraModel"),t4.forEach(t),Ku.forEach(t),eu=p(o),Ze=s(o,"DIV",{class:!0});var no=a(Ze);y(Ia.$$.fragment,no),h_=p(no),Fc=s(no,"P",{});var o4=a(Fc);m_=i(o4,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),o4.forEach(t),u_=p(no),Sa=s(no,"P",{});var Ju=a(Sa);f_=i(Ju,"This model inherits from "),rd=s(Ju,"A",{href:!0});var n4=a(rd);g_=i(n4,"PreTrainedModel"),n4.forEach(t),__=i(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju.forEach(t),k_=p(no),Da=s(no,"P",{});var Gu=a(Da);v_=i(Gu,"This model is also a PyTorch "),Wa=s(Gu,"A",{href:!0,rel:!0});var s4=a(Wa);T_=i(s4,"torch.nn.Module"),s4.forEach(t),b_=i(Gu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gu.forEach(t),y_=p(no),Et=s(no,"DIV",{class:!0});var ta=a(Et);y(Ua.$$.fragment,ta),E_=p(ta),Eo=s(ta,"P",{});var Rd=a(Eo);w_=i(Rd,"The "),id=s(Rd,"A",{href:!0});var a4=a(id);$_=i(a4,"ElectraModel"),a4.forEach(t),F_=i(Rd," forward method, overrides the "),xc=s(Rd,"CODE",{});var r4=a(xc);x_=i(r4,"__call__"),r4.forEach(t),M_=i(Rd," special method."),Rd.forEach(t),z_=p(ta),y($n.$$.fragment,ta),C_=p(ta),y(Fn.$$.fragment,ta),ta.forEach(t),no.forEach(t),tu=p(o),wo=s(o,"H2",{class:!0});var Xu=a(wo);xn=s(Xu,"A",{id:!0,class:!0,href:!0});var i4=a(xn);Mc=s(i4,"SPAN",{});var l4=a(Mc);y(Ra.$$.fragment,l4),l4.forEach(t),i4.forEach(t),j_=p(Xu),zc=s(Xu,"SPAN",{});var d4=a(zc);q_=i(d4,"ElectraForPreTraining"),d4.forEach(t),Xu.forEach(t),ou=p(o),He=s(o,"DIV",{class:!0});var Nt=a(He);y(Ha.$$.fragment,Nt),P_=p(Nt),Cc=s(Nt,"P",{});var c4=a(Cc);A_=i(c4,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),c4.forEach(t),O_=p(Nt),jc=s(Nt,"P",{});var p4=a(jc);L_=i(p4,"It is recommended to load the discriminator checkpoint into that model."),p4.forEach(t),N_=p(Nt),Qa=s(Nt,"P",{});var Yu=a(Qa);I_=i(Yu,"This model inherits from "),ld=s(Yu,"A",{href:!0});var h4=a(ld);S_=i(h4,"PreTrainedModel"),h4.forEach(t),D_=i(Yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yu.forEach(t),W_=p(Nt),Ba=s(Nt,"P",{});var Zu=a(Ba);U_=i(Zu,"This model is also a PyTorch "),Va=s(Zu,"A",{href:!0,rel:!0});var m4=a(Va);R_=i(m4,"torch.nn.Module"),m4.forEach(t),H_=i(Zu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zu.forEach(t),Q_=p(Nt),wt=s(Nt,"DIV",{class:!0});var oa=a(wt);y(Ka.$$.fragment,oa),B_=p(oa),$o=s(oa,"P",{});var Hd=a($o);V_=i(Hd,"The "),dd=s(Hd,"A",{href:!0});var u4=a(dd);K_=i(u4,"ElectraForPreTraining"),u4.forEach(t),J_=i(Hd," forward method, overrides the "),qc=s(Hd,"CODE",{});var f4=a(qc);G_=i(f4,"__call__"),f4.forEach(t),X_=i(Hd," special method."),Hd.forEach(t),Y_=p(oa),y(Mn.$$.fragment,oa),Z_=p(oa),y(zn.$$.fragment,oa),oa.forEach(t),Nt.forEach(t),nu=p(o),Fo=s(o,"H2",{class:!0});var ef=a(Fo);Cn=s(ef,"A",{id:!0,class:!0,href:!0});var g4=a(Cn);Pc=s(g4,"SPAN",{});var _4=a(Pc);y(Ja.$$.fragment,_4),_4.forEach(t),g4.forEach(t),ek=p(ef),Ac=s(ef,"SPAN",{});var k4=a(Ac);tk=i(k4,"ElectraForCausalLM"),k4.forEach(t),ef.forEach(t),su=p(o),et=s(o,"DIV",{class:!0});var so=a(et);y(Ga.$$.fragment,so),ok=p(so),Xa=s(so,"P",{});var tf=a(Xa);nk=i(tf,"ELECTRA Model with a "),Oc=s(tf,"CODE",{});var v4=a(Oc);sk=i(v4,"language modeling"),v4.forEach(t),ak=i(tf," head on top for CLM fine-tuning."),tf.forEach(t),rk=p(so),Ya=s(so,"P",{});var of=a(Ya);ik=i(of,"This model inherits from "),cd=s(of,"A",{href:!0});var T4=a(cd);lk=i(T4,"PreTrainedModel"),T4.forEach(t),dk=i(of,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),of.forEach(t),ck=p(so),Za=s(so,"P",{});var nf=a(Za);pk=i(nf,"This model is also a PyTorch "),er=s(nf,"A",{href:!0,rel:!0});var b4=a(er);hk=i(b4,"torch.nn.Module"),b4.forEach(t),mk=i(nf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nf.forEach(t),uk=p(so),$t=s(so,"DIV",{class:!0});var na=a($t);y(tr.$$.fragment,na),fk=p(na),xo=s(na,"P",{});var Qd=a(xo);gk=i(Qd,"The "),pd=s(Qd,"A",{href:!0});var y4=a(pd);_k=i(y4,"ElectraForCausalLM"),y4.forEach(t),kk=i(Qd," forward method, overrides the "),Lc=s(Qd,"CODE",{});var E4=a(Lc);vk=i(E4,"__call__"),E4.forEach(t),Tk=i(Qd," special method."),Qd.forEach(t),bk=p(na),y(jn.$$.fragment,na),yk=p(na),y(qn.$$.fragment,na),na.forEach(t),so.forEach(t),au=p(o),Mo=s(o,"H2",{class:!0});var sf=a(Mo);Pn=s(sf,"A",{id:!0,class:!0,href:!0});var w4=a(Pn);Nc=s(w4,"SPAN",{});var $4=a(Nc);y(or.$$.fragment,$4),$4.forEach(t),w4.forEach(t),Ek=p(sf),Ic=s(sf,"SPAN",{});var F4=a(Ic);wk=i(F4,"ElectraForMaskedLM"),F4.forEach(t),sf.forEach(t),ru=p(o),Qe=s(o,"DIV",{class:!0});var It=a(Qe);y(nr.$$.fragment,It),$k=p(It),Sc=s(It,"P",{});var x4=a(Sc);Fk=i(x4,"Electra model with a language modeling head on top."),x4.forEach(t),xk=p(It),Dc=s(It,"P",{});var M4=a(Dc);Mk=i(M4,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),M4.forEach(t),zk=p(It),sr=s(It,"P",{});var af=a(sr);Ck=i(af,"This model inherits from "),hd=s(af,"A",{href:!0});var z4=a(hd);jk=i(z4,"PreTrainedModel"),z4.forEach(t),qk=i(af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),af.forEach(t),Pk=p(It),ar=s(It,"P",{});var rf=a(ar);Ak=i(rf,"This model is also a PyTorch "),rr=s(rf,"A",{href:!0,rel:!0});var C4=a(rr);Ok=i(C4,"torch.nn.Module"),C4.forEach(t),Lk=i(rf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rf.forEach(t),Nk=p(It),st=s(It,"DIV",{class:!0});var ao=a(st);y(ir.$$.fragment,ao),Ik=p(ao),zo=s(ao,"P",{});var Bd=a(zo);Sk=i(Bd,"The "),md=s(Bd,"A",{href:!0});var j4=a(md);Dk=i(j4,"ElectraForMaskedLM"),j4.forEach(t),Wk=i(Bd," forward method, overrides the "),Wc=s(Bd,"CODE",{});var q4=a(Wc);Uk=i(q4,"__call__"),q4.forEach(t),Rk=i(Bd," special method."),Bd.forEach(t),Hk=p(ao),y(An.$$.fragment,ao),Qk=p(ao),y(On.$$.fragment,ao),Bk=p(ao),y(Ln.$$.fragment,ao),ao.forEach(t),It.forEach(t),iu=p(o),Co=s(o,"H2",{class:!0});var lf=a(Co);Nn=s(lf,"A",{id:!0,class:!0,href:!0});var P4=a(Nn);Uc=s(P4,"SPAN",{});var A4=a(Uc);y(lr.$$.fragment,A4),A4.forEach(t),P4.forEach(t),Vk=p(lf),Rc=s(lf,"SPAN",{});var O4=a(Rc);Kk=i(O4,"ElectraForSequenceClassification"),O4.forEach(t),lf.forEach(t),lu=p(o),tt=s(o,"DIV",{class:!0});var ro=a(tt);y(dr.$$.fragment,ro),Jk=p(ro),Hc=s(ro,"P",{});var L4=a(Hc);Gk=i(L4,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),L4.forEach(t),Xk=p(ro),cr=s(ro,"P",{});var df=a(cr);Yk=i(df,"This model inherits from "),ud=s(df,"A",{href:!0});var N4=a(ud);Zk=i(N4,"PreTrainedModel"),N4.forEach(t),e1=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),df.forEach(t),t1=p(ro),pr=s(ro,"P",{});var cf=a(pr);o1=i(cf,"This model is also a PyTorch "),hr=s(cf,"A",{href:!0,rel:!0});var I4=a(hr);n1=i(I4,"torch.nn.Module"),I4.forEach(t),s1=i(cf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cf.forEach(t),a1=p(ro),Re=s(ro,"DIV",{class:!0});var pt=a(Re);y(mr.$$.fragment,pt),r1=p(pt),jo=s(pt,"P",{});var Vd=a(jo);i1=i(Vd,"The "),fd=s(Vd,"A",{href:!0});var S4=a(fd);l1=i(S4,"ElectraForSequenceClassification"),S4.forEach(t),d1=i(Vd," forward method, overrides the "),Qc=s(Vd,"CODE",{});var D4=a(Qc);c1=i(D4,"__call__"),D4.forEach(t),p1=i(Vd," special method."),Vd.forEach(t),h1=p(pt),y(In.$$.fragment,pt),m1=p(pt),y(Sn.$$.fragment,pt),u1=p(pt),y(Dn.$$.fragment,pt),f1=p(pt),y(Wn.$$.fragment,pt),g1=p(pt),y(Un.$$.fragment,pt),pt.forEach(t),ro.forEach(t),du=p(o),qo=s(o,"H2",{class:!0});var pf=a(qo);Rn=s(pf,"A",{id:!0,class:!0,href:!0});var W4=a(Rn);Bc=s(W4,"SPAN",{});var U4=a(Bc);y(ur.$$.fragment,U4),U4.forEach(t),W4.forEach(t),_1=p(pf),Vc=s(pf,"SPAN",{});var R4=a(Vc);k1=i(R4,"ElectraForMultipleChoice"),R4.forEach(t),pf.forEach(t),cu=p(o),ot=s(o,"DIV",{class:!0});var io=a(ot);y(fr.$$.fragment,io),v1=p(io),Kc=s(io,"P",{});var H4=a(Kc);T1=i(H4,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),H4.forEach(t),b1=p(io),gr=s(io,"P",{});var hf=a(gr);y1=i(hf,"This model inherits from "),gd=s(hf,"A",{href:!0});var Q4=a(gd);E1=i(Q4,"PreTrainedModel"),Q4.forEach(t),w1=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),$1=p(io),_r=s(io,"P",{});var mf=a(_r);F1=i(mf,"This model is also a PyTorch "),kr=s(mf,"A",{href:!0,rel:!0});var B4=a(kr);x1=i(B4,"torch.nn.Module"),B4.forEach(t),M1=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mf.forEach(t),z1=p(io),Ft=s(io,"DIV",{class:!0});var sa=a(Ft);y(vr.$$.fragment,sa),C1=p(sa),Po=s(sa,"P",{});var Kd=a(Po);j1=i(Kd,"The "),_d=s(Kd,"A",{href:!0});var V4=a(_d);q1=i(V4,"ElectraForMultipleChoice"),V4.forEach(t),P1=i(Kd," forward method, overrides the "),Jc=s(Kd,"CODE",{});var K4=a(Jc);A1=i(K4,"__call__"),K4.forEach(t),O1=i(Kd," special method."),Kd.forEach(t),L1=p(sa),y(Hn.$$.fragment,sa),N1=p(sa),y(Qn.$$.fragment,sa),sa.forEach(t),io.forEach(t),pu=p(o),Ao=s(o,"H2",{class:!0});var uf=a(Ao);Bn=s(uf,"A",{id:!0,class:!0,href:!0});var J4=a(Bn);Gc=s(J4,"SPAN",{});var G4=a(Gc);y(Tr.$$.fragment,G4),G4.forEach(t),J4.forEach(t),I1=p(uf),Xc=s(uf,"SPAN",{});var X4=a(Xc);S1=i(X4,"ElectraForTokenClassification"),X4.forEach(t),uf.forEach(t),hu=p(o),Be=s(o,"DIV",{class:!0});var St=a(Be);y(br.$$.fragment,St),D1=p(St),Yc=s(St,"P",{});var Y4=a(Yc);W1=i(Y4,"Electra model with a token classification head on top."),Y4.forEach(t),U1=p(St),Zc=s(St,"P",{});var Z4=a(Zc);R1=i(Z4,"Both the discriminator and generator may be loaded into this model."),Z4.forEach(t),H1=p(St),yr=s(St,"P",{});var ff=a(yr);Q1=i(ff,"This model inherits from "),kd=s(ff,"A",{href:!0});var eF=a(kd);B1=i(eF,"PreTrainedModel"),eF.forEach(t),V1=i(ff,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Af.forEach(t),qb=p(Ut),y(vs.$$.fragment,Ut),Pb=p(Ut),zt=s(Ut,"DIV",{class:!0});var ia=a(zt);y(ii.$$.fragment,ia),Ab=p(ia),Ko=s(ia,"P",{});var oc=a(Ko);Ob=i(oc,"The "),jd=s(oc,"A",{href:!0});var ZF=a(jd);Lb=i(ZF,"TFElectraForMultipleChoice"),ZF.forEach(t),Nb=i(oc," forward method, overrides the "),xp=s(oc,"CODE",{});var e0=a(xp);Ib=i(e0,"__call__"),e0.forEach(t),Sb=i(oc," special method."),oc.forEach(t),Db=p(ia),y(Ts.$$.fragment,ia),Wb=p(ia),y(bs.$$.fragment,ia),ia.forEach(t),Ut.forEach(t),$u=p(o),Jo=s(o,"H2",{class:!0});var Of=a(Jo);ys=s(Of,"A",{id:!0,class:!0,href:!0});var t0=a(ys);Mp=s(t0,"SPAN",{});var o0=a(Mp);y(li.$$.fragment,o0),o0.forEach(t),t0.forEach(t),Ub=p(Of),zp=s(Of,"SPAN",{});var n0=a(zp);Rb=i(n0,"TFElectraForTokenClassification"),n0.forEach(t),Of.forEach(t),Fu=p(o),Ne=s(o,"DIV",{class:!0});var ut=a(Ne);y(di.$$.fragment,ut),Hb=p(ut),Cp=s(ut,"P",{});var s0=a(Cp);Qb=i(s0,"Electra model with a token classification head on top."),s0.forEach(t),Bb=p(ut),jp=s(ut,"P",{});var a0=a(jp);Vb=i(a0,"Both the discriminator and generator may be loaded into this model."),a0.forEach(t),Kb=p(ut),ci=s(ut,"P",{});var Lf=a(ci);Jb=i(Lf,"This model inherits from "),qd=s(Lf,"A",{href:!0});var r0=a(qd);Gb=i(r0,"TFPreTrainedModel"),r0.forEach(t),Xb=i(Lf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lf.forEach(t),Yb=p(ut),pi=s(ut,"P",{});var Nf=a(pi);Zb=i(Nf,"This model is also a "),hi=s(Nf,"A",{href:!0,rel:!0});var i0=a(hi);ey=i(i0,"tf.keras.Model"),i0.forEach(t),ty=i(Nf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nf.forEach(t),oy=p(ut),y(Es.$$.fragment,ut),ny=p(ut),dt=s(ut,"DIV",{class:!0});var uo=a(dt);y(mi.$$.fragment,uo),sy=p(uo),Go=s(uo,"P",{});var nc=a(Go);ay=i(nc,"The "),Pd=s(nc,"A",{href:!0});var l0=a(Pd);ry=i(l0,"TFElectraForTokenClassification"),l0.forEach(t),iy=i(nc," forward method, overrides the "),qp=s(nc,"CODE",{});var d0=a(qp);ly=i(d0,"__call__"),d0.forEach(t),dy=i(nc," special method."),nc.forEach(t),cy=p(uo),y(ws.$$.fragment,uo),py=p(uo),y($s.$$.fragment,uo),hy=p(uo),y(Fs.$$.fragment,uo),uo.forEach(t),ut.forEach(t),xu=p(o),Xo=s(o,"H2",{class:!0});var If=a(Xo);xs=s(If,"A",{id:!0,class:!0,href:!0});var c0=a(xs);Pp=s(c0,"SPAN",{});var p0=a(Pp);y(ui.$$.fragment,p0),p0.forEach(t),c0.forEach(t),my=p(If),Ap=s(If,"SPAN",{});var h0=a(Ap);uy=i(h0,"TFElectraForQuestionAnswering"),h0.forEach(t),If.forEach(t),Mu=p(o),Ge=s(o,"DIV",{class:!0});var Rt=a(Ge);y(fi.$$.fragment,Rt),fy=p(Rt),Yo=s(Rt,"P",{});var sc=a(Yo);gy=i(sc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(sc,"CODE",{});var m0=a(Op);_y=i(m0,"span start logits"),m0.forEach(t),ky=i(sc," and "),Lp=s(sc,"CODE",{});var u0=a(Lp);vy=i(u0,"span end logits"),u0.forEach(t),Ty=i(sc,")."),sc.forEach(t),by=p(Rt),gi=s(Rt,"P",{});var Sf=a(gi);yy=i(Sf,"This model inherits from "),Ad=s(Sf,"A",{href:!0});var f0=a(Ad);Ey=i(f0,"TFPreTrainedModel"),f0.forEach(t),wy=i(Sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sf.forEach(t),$y=p(Rt),_i=s(Rt,"P",{});var Df=a(_i);Fy=i(Df,"This model is also a "),ki=s(Df,"A",{href:!0,rel:!0});var g0=a(ki);xy=i(g0,"tf.keras.Model"),g0.forEach(t),My=i(Df,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df.forEach(t),zy=p(Rt),y(Ms.$$.fragment,Rt),Cy=p(Rt),ct=s(Rt,"DIV",{class:!0});var fo=a(ct);y(vi.$$.fragment,fo),jy=p(fo),Zo=s(fo,"P",{});var ac=a(Zo);qy=i(ac,"The "),Od=s(ac,"A",{href:!0});var _0=a(Od);Py=i(_0,"TFElectraForQuestionAnswering"),_0.forEach(t),Ay=i(ac," forward method, overrides the "),Np=s(ac,"CODE",{});var k0=a(Np);Oy=i(k0,"__call__"),k0.forEach(t),Ly=i(ac," special method."),ac.forEach(t),Ny=p(fo),y(zs.$$.fragment,fo),Iy=p(fo),y(Cs.$$.fragment,fo),Sy=p(fo),y(js.$$.fragment,fo),fo.forEach(t),Rt.forEach(t),zu=p(o),en=s(o,"H2",{class:!0});var Wf=a(en);qs=s(Wf,"A",{id:!0,class:!0,href:!0});var v0=a(qs);Ip=s(v0,"SPAN",{});var T0=a(Ip);y(Ti.$$.fragment,T0),T0.forEach(t),v0.forEach(t),Dy=p(Wf),Sp=s(Wf,"SPAN",{});var b0=a(Sp);Wy=i(b0,"FlaxElectraModel"),b0.forEach(t),Wf.forEach(t),Cu=p(o),Ie=s(o,"DIV",{class:!0});var ft=a(Ie);y(bi.$$.fragment,ft),Uy=p(ft),Dp=s(ft,"P",{});var y0=a(Dp);Ry=i(y0,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),y0.forEach(t),Hy=p(ft),yi=s(ft,"P",{});var Uf=a(yi);Qy=i(Uf,"This model inherits from "),Ld=s(Uf,"A",{href:!0});var E0=a(Ld);By=i(E0,"FlaxPreTrainedModel"),E0.forEach(t),Vy=i(Uf,`. Check the superclass documentation for the generic methods the
...
`),wi=s(Rf,"A",{href:!0,rel:!0});var w0=a(wi);Gy=i(w0,"flax.nn.Module"),w0.forEach(t),Xy=i(Rf,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rf.forEach(t),Yy=p(ft),Wp=s(ft,"P",{});var $0=a(Wp);Zy=i($0,"Finally, this model supports inherent JAX features such as:"),$0.forEach(t),eE=p(ft),Qt=s(ft,"UL",{});var la=a(Qt);Up=s(la,"LI",{});var F0=a(Up);$i=s(F0,"A",{href:!0,rel:!0});var x0=a($i);tE=i(x0,"Just-In-Time (JIT) compilation"),x0.forEach(t),F0.forEach(t),oE=p(la),Rp=s(la,"LI",{});var M0=a(Rp);Fi=s(M0,"A",{href:!0,rel:!0});var z0=a(Fi);nE=i(z0,"Automatic Differentiation"),z0.forEach(t),M0.forEach(t),sE=p(la),Hp=s(la,"LI",{});var C0=a(Hp);xi=s(C0,"A",{href:!0,rel:!0});var j0=a(xi);aE=i(j0,"Vectorization"),j0.forEach(t),C0.forEach(t),rE=p(la),Qp=s(la,"LI",{});var q0=a(Qp);Mi=s(q0,"A",{href:!0,rel:!0});var P0=a(Mi);iE=i(P0,"Parallelization"),P0.forEach(t),q0.forEach(t),la.forEach(t),lE=p(ft),Ct=s(ft,"DIV",{class:!0});var da=a(Ct);y(zi.$$.fragment,da),dE=p(da),tn=s(da,"P",{});var rc=a(tn);cE=i(rc,"The "),Bp=s(rc,"CODE",{});var A0=a(Bp);pE=i(A0,"FlaxElectraPreTrainedModel"),A0.forEach(t),hE=i(rc," forward method, overrides the "),Vp=s(rc,"CODE",{});var O0=a(Vp);mE=i(O0,"__call__"),O0.forEach(t),uE=i(rc," special method."),rc.forEach(t),fE=p(da),y(Ps.$$.fragment,da),gE=p(da),y(As.$$.fragment,da),da.forEach(t),ft.forEach(t),ju=p(o),on=s(o,"H2",{class:!0});var Hf=a(on);Os=s(Hf,"A",{id:!0,class:!0,href:!0});var L0=a(Os);Kp=s(L0,"SPAN",{});var N0=a(Kp);y(Ci.$$.fragment,N0),N0.forEach(t),L0.forEach(t),_E=p(Hf),Jp=s(Hf,"SPAN",{});var I0=a(Jp);kE=i(I0,"FlaxElectraForPreTraining"),I0.forEach(t),Hf.forEach(t),qu=p(o),Pe=s(o,"DIV",{class:!0});var Xe=a(Pe);y(ji.$$.fragment,Xe),vE=p(Xe),Gp=s(Xe,"P",{});var S0=a(Gp);TE=i(S0,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),S0.forEach(t),bE=p(Xe),Xp=s(Xe,"P",{});var D0=a(Xp);yE=i(D0,"It is recommended to load the discriminator checkpoint into that model."),D0.forEach(t),EE=p(Xe),qi=s(Xe,"P",{});var Qf=a(qi);wE=i(Qf,"This model inherits from "),Nd=s(Qf,"A",{href:!0});var W0=a(Nd);$E=i(W0,"FlaxPreTrainedModel"),W0.forEach(t),FE=i(Qf,`. Check the superclass documentation for the generic methods the
...
`),Ai=s(Bf,"A",{href:!0,rel:!0});var U0=a(Ai);zE=i(U0,"flax.nn.Module"),U0.forEach(t),CE=i(Bf,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bf.forEach(t),jE=p(Xe),Yp=s(Xe,"P",{});var R0=a(Yp);qE=i(R0,"Finally, this model supports inherent JAX features such as:"),R0.forEach(t),PE=p(Xe),Bt=s(Xe,"UL",{});var ca=a(Bt);Zp=s(ca,"LI",{});var H0=a(Zp);Oi=s(H0,"A",{href:!0,rel:!0});var Q0=a(Oi);AE=i(Q0,"Just-In-Time (JIT) compilation"),Q0.forEach(t),H0.forEach(t),OE=p(ca),eh=s(ca,"LI",{});var B0=a(eh);Li=s(B0,"A",{href:!0,rel:!0});var V0=a(Li);LE=i(V0,"Automatic Differentiation"),V0.forEach(t),B0.forEach(t),NE=p(ca),th=s(ca,"LI",{});var K0=a(th);Ni=s(K0,"A",{href:!0,rel:!0});var J0=a(Ni);IE=i(J0,"Vectorization"),J0.forEach(t),K0.forEach(t),SE=p(ca),oh=s(ca,"LI",{});var G0=a(oh);Ii=s(G0,"A",{href:!0,rel:!0});var X0=a(Ii);DE=i(X0,"Parallelization"),X0.forEach(t),G0.forEach(t),ca.forEach(t),WE=p(Xe),jt=s(Xe,"DIV",{class:!0});var pa=a(jt);y(Si.$$.fragment,pa),UE=p(pa),nn=s(pa,"P",{});var ic=a(nn);RE=i(ic,"The "),nh=s(ic,"CODE",{});var Y0=a(nh);HE=i(Y0,"FlaxElectraPreTrainedModel"),Y0.forEach(t),QE=i(ic," forward method, overrides the "),sh=s(ic,"CODE",{});var Z0=a(sh);BE=i(Z0,"__call__"),Z0.forEach(t),VE=i(ic," special method."),ic.forEach(t),KE=p(pa),y(Ls.$$.fragment,pa),JE=p(pa),y(Ns.$$.fragment,pa),pa.forEach(t),Xe.forEach(t),Pu=p(o),sn=s(o,"H2",{class:!0});var Vf=a(sn);Is=s(Vf,"A",{id:!0,class:!0,href:!0});var ex=a(Is);ah=s(ex,"SPAN",{});var tx=a(ah);y(Di.$$.fragment,tx),tx.forEach(t),ex.forEach(t),GE=p(Vf),rh=s(Vf,"SPAN",{});var ox=a(rh);XE=i(ox,"FlaxElectraForMaskedLM"),ox.forEach(t),Vf.forEach(t),Au=p(o),Se=s(o,"DIV",{class:!0});var gt=a(Se);y(Wi.$$.fragment,gt),YE=p(gt),Ui=s(gt,"P",{});var Kf=a(Ui);ZE=i(Kf,"Electra Model with a "),ih=s(Kf,"CODE",{});var nx=a(ih);ew=i(nx,"language modeling"),nx.forEach(t),tw=i(Kf," head on top."),Kf.forEach(t),ow=p(gt),Ri=s(gt,"P",{});var Jf=a(Ri);nw=i(Jf,"This model inherits from "),Id=s(Jf,"A",{href:!0});var sx=a(Id);sw=i(sx,"FlaxPreTrainedModel"),sx.forEach(t),aw=i(Jf,`. Check the superclass documentation for the generic methods the
