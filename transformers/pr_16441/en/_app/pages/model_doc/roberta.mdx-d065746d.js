...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yf.forEach(t),FT=h(Nt),y(bs.$$.fragment,Nt),xT=h(Nt),pt=s(Nt,"DIV",{class:!0});var co=a(pt);y(ti.$$.fragment,co),RT=h(co),Uo=s(co,"P",{});var qd=a(Uo);MT=i(qd,"The "),rd=s(qd,"A",{href:!0});var XF=a(rd);ET=i(XF,"TFRobertaForTokenClassification"),XF.forEach(t),zT=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var YF=a(dp);qT=i(YF,"__call__"),YF.forEach(t),CT=i(qd," special method."),qd.forEach(t),jT=h(co),y(ks.$$.fragment,co),PT=h(co),y(vs.$$.fragment,co),LT=h(co),y(Ts.$$.fragment,co),co.forEach(t),Nt.forEach(t),Wm=h(o),Ho=s(o,"H2",{class:!0});var Zf=a(Ho);ys=s(Zf,"A",{id:!0,class:!0,href:!0});var ZF=a(ys);cp=s(ZF,"SPAN",{});var e0=a(cp);y(oi.$$.fragment,e0),e0.forEach(t),ZF.forEach(t),AT=h(Zf),pp=s(Zf,"SPAN",{});var t0=a(pp);OT=i(t0,"TFRobertaForQuestionAnswering"),t0.forEach(t),Zf.forEach(t),Bm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);y(ni.$$.fragment,It),NT=h(It),Qo=s(It,"P",{});var Cd=a(Qo);IT=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Cd,"CODE",{});var o0=a(hp);DT=i(o0,"span start logits"),o0.forEach(t),ST=i(Cd," and "),mp=s(Cd,"CODE",{});var n0=a(mp);WT=i(n0,"span end logits"),n0.forEach(t),BT=i(Cd,")."),Cd.forEach(t),UT=h(It),si=s(It,"P",{});var eu=a(si);HT=i(eu,"This model inherits from "),id=s(eu,"A",{href:!0});var s0=a(id);QT=i(s0,"TFPreTrainedModel"),s0.forEach(t),VT=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),JT=h(It),ai=s(It,"P",{});var tu=a(ai);KT=i(tu,"This model is also a "),ri=s(tu,"A",{href:!0,rel:!0});var a0=a(ri);GT=i(a0,"tf.keras.Model"),a0.forEach(t),XT=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),YT=h(It),y(ws.$$.fragment,It),ZT=h(It),ht=s(It,"DIV",{class:!0});var po=a(ht);y(ii.$$.fragment,po),ey=h(po),Vo=s(po,"P",{});var jd=a(Vo);ty=i(jd,"The "),ld=s(jd,"A",{href:!0});var r0=a(ld);oy=i(r0,"TFRobertaForQuestionAnswering"),r0.forEach(t),ny=i(jd," forward method, overrides the "),fp=s(jd,"CODE",{});var i0=a(fp);sy=i(i0,"__call__"),i0.forEach(t),ay=i(jd," special method."),jd.forEach(t),ry=h(po),y($s.$$.fragment,po),iy=h(po),y(Fs.$$.fragment,po),ly=h(po),y(xs.$$.fragment,po),po.forEach(t),It.forEach(t),Um=h(o),Jo=s(o,"H2",{class:!0});var ou=a(Jo);Rs=s(ou,"A",{id:!0,class:!0,href:!0});var l0=a(Rs);up=s(l0,"SPAN",{});var d0=a(up);y(li.$$.fragment,d0),d0.forEach(t),l0.forEach(t),dy=h(ou),gp=s(ou,"SPAN",{});var c0=a(gp);cy=i(c0,"FlaxRobertaModel"),c0.forEach(t),ou.forEach(t),Hm=h(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(di.$$.fragment,ut),py=h(ut),_p=s(ut,"P",{});var p0=a(_p);hy=i(p0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),p0.forEach(t),my=h(ut),ci=s(ut,"P",{});var nu=a(ci);fy=i(nu,"This model inherits from "),dd=s(nu,"A",{href:!0});var h0=a(dd);uy=i(h0,"FlaxPreTrainedModel"),h0.forEach(t),gy=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),nu.forEach(t),_y=h(ut),pi=s(ut,"P",{});var su=a(pi);by=i(su,"This model is also a Flax Linen "),hi=s(su,"A",{href:!0,rel:!0});var m0=a(hi);ky=i(m0,"flax.linen.Module"),m0.forEach(t),vy=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),Ty=h(ut),bp=s(ut,"P",{});var f0=a(bp);yy=i(f0,"Finally, this model supports inherent JAX features such as:"),f0.forEach(t),wy=h(ut),St=s(ut,"UL",{});var Xs=a(St);kp=s(Xs,"LI",{});var u0=a(kp);mi=s(u0,"A",{href:!0,rel:!0});var g0=a(mi);$y=i(g0,"Just-In-Time (JIT) compilation"),g0.forEach(t),u0.forEach(t),Fy=h(Xs),vp=s(Xs,"LI",{});var _0=a(vp);fi=s(_0,"A",{href:!0,rel:!0});var b0=a(fi);xy=i(b0,"Automatic Differentiation"),b0.forEach(t),_0.forEach(t),Ry=h(Xs),Tp=s(Xs,"LI",{});var k0=a(Tp);ui=s(k0,"A",{href:!0,rel:!0});var v0=a(ui);My=i(v0,"Vectorization"),v0.forEach(t),k0.forEach(t),Ey=h(Xs),yp=s(Xs,"LI",{});var T0=a(yp);gi=s(T0,"A",{href:!0,rel:!0});var y0=a(gi);zy=i(y0,"Parallelization"),y0.forEach(t),T0.forEach(t),Xs.forEach(t),qy=h(ut),Mt=s(ut,"DIV",{class:!0});var Ys=a(Mt);y(_i.$$.fragment,Ys),Cy=h(Ys),Ko=s(Ys,"P",{});var Pd=a(Ko);jy=i(Pd,"The "),wp=s(Pd,"CODE",{});var w0=a(wp);Py=i(w0,"FlaxRobertaPreTrainedModel"),w0.forEach(t),Ly=i(Pd," forward method, overrides the "),$p=s(Pd,"CODE",{});var $0=a($p);Ay=i($0,"__call__"),$0.forEach(t),Oy=i(Pd," special method."),Pd.forEach(t),Ny=h(Ys),y(Ms.$$.fragment,Ys),Iy=h(Ys),y(Es.$$.fragment,Ys),Ys.forEach(t),ut.forEach(t),Qm=h(o),Go=s(o,"H2",{class:!0});var au=a(Go);zs=s(au,"A",{id:!0,class:!0,href:!0});var F0=a(zs);Fp=s(F0,"SPAN",{});var x0=a(Fp);y(bi.$$.fragment,x0),x0.forEach(t),F0.forEach(t),Dy=h(au),xp=s(au,"SPAN",{});var R0=a(xp);Sy=i(R0,"FlaxRobertaForMaskedLM"),R0.forEach(t),au.forEach(t),Vm=h(o),Ne=s(o,"DIV",{class:!0});var gt=a(Ne);y(ki.$$.fragment,gt),Wy=h(gt),vi=s(gt,"P",{});var ru=a(vi);By=i(ru,"RoBERTa Model with a "),Rp=s(ru,"CODE",{});var M0=a(Rp);Uy=i(M0,"language modeling"),M0.forEach(t),Hy=i(ru," head on top."),ru.forEach(t),Qy=h(gt),Ti=s(gt,"P",{});var iu=a(Ti);Vy=i(iu,"This model inherits from "),cd=s(iu,"A",{href:!0});var E0=a(cd);Jy=i(E0,"FlaxPreTrainedModel"),E0.forEach(t),Ky=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Gy=h(gt),yi=s(gt,"P",{});var lu=a(yi);Xy=i(lu,"This model is also a Flax Linen "),wi=s(lu,"A",{href:!0,rel:!0});var z0=a(wi);Yy=i(z0,"flax.linen.Module"),z0.forEach(t),Zy=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),ew=h(gt),Mp=s(gt,"P",{});var q0=a(Mp);tw=i(q0,"Finally, this model supports inherent JAX features such as:"),q0.forEach(t),ow=h(gt),Wt=s(gt,"UL",{});var Zs=a(Wt);Ep=s(Zs,"LI",{});var C0=a(Ep);$i=s(C0,"A",{href:!0,rel:!0});var j0=a($i);nw=i(j0,"Just-In-Time (JIT) compilation"),j0.forEach(t),C0.forEach(t),sw=h(Zs),zp=s(Zs,"LI",{});var P0=a(zp);Fi=s(P0,"A",{href:!0,rel:!0});var L0=a(Fi);aw=i(L0,"Automatic Differentiation"),L0.forEach(t),P0.forEach(t),rw=h(Zs),qp=s(Zs,"LI",{});var A0=a(qp);xi=s(A0,"A",{href:!0,rel:!0});var O0=a(xi);iw=i(O0,"Vectorization"),O0.forEach(t),A0.forEach(t),lw=h(Zs),Cp=s(Zs,"LI",{});var N0=a(Cp);Ri=s(N0,"A",{href:!0,rel:!0});var I0=a(Ri);dw=i(I0,"Parallelization"),I0.forEach(t),N0.forEach(t),Zs.forEach(t),cw=h(gt),Et=s(gt,"DIV",{class:!0});var ea=a(Et);y(Mi.$$.fragment,ea),pw=h(ea),Xo=s(ea,"P",{});var Ld=a(Xo);hw=i(Ld,"The "),jp=s(Ld,"CODE",{});var D0=a(jp);mw=i(D0,"FlaxRobertaPreTrainedModel"),D0.forEach(t),fw=i(Ld," forward method, overrides the "),Pp=s(Ld,"CODE",{});var S0=a(Pp);uw=i(S0,"__call__"),S0.forEach(t),gw=i(Ld," special method."),Ld.forEach(t),_w=h(ea),y(qs.$$.fragment,ea),bw=h(ea),y(Cs.$$.fragment,ea),ea.forEach(t),gt.forEach(t),Jm=h(o),Yo=s(o,"H2",{class:!0});var du=a(Yo);js=s(du,"A",{id:!0,class:!0,href:!0});var W0=a(js);Lp=s(W0,"SPAN",{});var B0=a(Lp);y(Ei.$$.fragment,B0),B0.forEach(t),W0.forEach(t),kw=h(du),Ap=s(du,"SPAN",{});var U0=a(Ap);vw=i(U0,"FlaxRobertaForSequenceClassification"),U0.forEach(t),du.forEach(t),Km=h(o),Ie=s(o,"DIV",{class:!0});var _t=a(Ie);y(zi.$$.fragment,_t),Tw=h(_t),Op=s(_t,"P",{});var H0=a(Op);yw=i(H0,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),H0.forEach(t),ww=h(_t),qi=s(_t,"P",{});var cu=a(qi);$w=i(cu,"This model inherits from "),pd=s(cu,"A",{href:!0});var Q0=a(pd);Fw=i(Q0,"FlaxPreTrainedModel"),Q0.forEach(t),xw=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),cu.forEach(t),Rw=h(_t),Ci=s(_t,"P",{});var pu=a(Ci);Mw=i(pu,"This model is also a Flax Linen "),ji=s(pu,"A",{href:!0,rel:!0});var V0=a(ji);Ew=i(V0,"flax.linen.Module"),V0.forEach(t),zw=i(pu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),qw=h(_t),Np=s(_t,"P",{});var J0=a(Np);Cw=i(J0,"Finally, this model supports inherent JAX features such as:"),J0.forEach(t),jw=h(_t),Bt=s(_t,"UL",{});var ta=a(Bt);Ip=s(ta,"LI",{});var K0=a(Ip);Pi=s(K0,"A",{href:!0,rel:!0});var G0=a(Pi);Pw=i(G0,"Just-In-Time (JIT) compilation"),G0.forEach(t),K0.forEach(t),Lw=h(ta),Dp=s(ta,"LI",{});var X0=a(Dp);Li=s(X0,"A",{href:!0,rel:!0});var Y0=a(Li);Aw=i(Y0,"Automatic Differentiation"),Y0.forEach(t),X0.forEach(t),Ow=h(ta),Sp=s(ta,"LI",{});var Z0=a(Sp);Ai=s(Z0,"A",{href:!0,rel:!0});var ex=a(Ai);Nw=i(ex,"Vectorization"),ex.forEach(t),Z0.forEach(t),Iw=h(ta),Wp=s(ta,"LI",{});var tx=a(Wp);Oi=s(tx,"A",{href:!0,rel:!0});var ox=a(Oi);Dw=i(ox,"Parallelization"),ox.forEach(t),tx.forEach(t),ta.forEach(t),Sw=h(_t),zt=s(_t,"DIV",{class:!0});var oa=a(zt);y(Ni.$$.fragment,oa),Ww=h(oa),Zo=s(oa,"P",{});var Ad=a(Zo);Bw=i(Ad,"The "),Bp=s(Ad,"CODE",{});var nx=a(Bp);Uw=i(nx,"FlaxRobertaPreTrainedModel"),nx.forEach(t),Hw=i(Ad," forward method, overrides the "),Up=s(Ad,"CODE",{});var sx=a(Up);Qw=i(sx,"__call__"),sx.forEach(t),Vw=i(Ad," special method."),Ad.forEach(t),Jw=h(oa),y(Ps.$$.fragment,oa),Kw=h(oa),y(Ls.$$.fragment,oa),oa.forEach(t),_t.forEach(t),Gm=h(o),en=s(o,"H2",{class:!0});var hu=a(en);As=s(hu,"A",{id:!0,class:!0,href:!0});var ax=a(As);Hp=s(ax,"SPAN",{});var rx=a(Hp);y(Ii.$$.fragment,rx),rx.forEach(t),ax.forEach(t),Gw=h(hu),Qp=s(hu,"SPAN",{});var ix=a(Qp);Xw=i(ix,"FlaxRobertaForMultipleChoice"),ix.forEach(t),hu.forEach(t),Xm=h(o),De=s(o,"DIV",{class:!0});var bt=a(De);y(Di.$$.fragment,bt),Yw=h(bt),Vp=s(bt,"P",{});var lx=a(Vp);Zw=i(lx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
