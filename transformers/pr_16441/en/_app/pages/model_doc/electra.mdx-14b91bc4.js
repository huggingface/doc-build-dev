...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bf.forEach(t),R1=p(po),He=s(po,"DIV",{class:!0});var ht=a(He);y(wr.$$.fragment,ht),H1=p(ht),Oo=s(ht,"P",{});var _c=a(Oo);B1=i(_c,"The "),Id=s(_c,"A",{href:!0});var e0=a(Id);Q1=i(e0,"ElectraForSequenceClassification"),e0.forEach(t),V1=i(_c," forward method, overrides the "),gp=s(_c,"CODE",{});var t0=a(gp);K1=i(t0,"__call__"),t0.forEach(t),J1=i(_c," special method."),_c.forEach(t),G1=p(ht),y(Hn.$$.fragment,ht),X1=p(ht),y(Bn.$$.fragment,ht),Y1=p(ht),y(Qn.$$.fragment,ht),Z1=p(ht),y(Vn.$$.fragment,ht),ev=p(ht),y(Kn.$$.fragment,ht),ht.forEach(t),po.forEach(t),Hu=p(o),Lo=s(o,"H2",{class:!0});var Qf=a(Lo);Jn=s(Qf,"A",{id:!0,class:!0,href:!0});var o0=a(Jn);_p=s(o0,"SPAN",{});var n0=a(_p);y($r.$$.fragment,n0),n0.forEach(t),o0.forEach(t),tv=p(Qf),kp=s(Qf,"SPAN",{});var s0=a(kp);ov=i(s0,"ElectraForMultipleChoice"),s0.forEach(t),Qf.forEach(t),Bu=p(o),nt=s(o,"DIV",{class:!0});var ho=a(nt);y(Fr.$$.fragment,ho),nv=p(ho),vp=s(ho,"P",{});var a0=a(vp);sv=i(a0,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kf.forEach(t),mv=p(ho),Mt=s(ho,"DIV",{class:!0});var ma=a(Mt);y(Cr.$$.fragment,ma),uv=p(ma),No=s(ma,"P",{});var kc=a(No);fv=i(kc,"The "),Sd=s(kc,"A",{href:!0});var l0=a(Sd);gv=i(l0,"ElectraForMultipleChoice"),l0.forEach(t),_v=i(kc," forward method, overrides the "),Tp=s(kc,"CODE",{});var d0=a(Tp);kv=i(d0,"__call__"),d0.forEach(t),vv=i(kc," special method."),kc.forEach(t),Tv=p(ma),y(Gn.$$.fragment,ma),bv=p(ma),y(Xn.$$.fragment,ma),ma.forEach(t),ho.forEach(t),Qu=p(o),Io=s(o,"H2",{class:!0});var Jf=a(Io);Yn=s(Jf,"A",{id:!0,class:!0,href:!0});var c0=a(Yn);bp=s(c0,"SPAN",{});var p0=a(bp);y(jr.$$.fragment,p0),p0.forEach(t),c0.forEach(t),yv=p(Jf),yp=s(Jf,"SPAN",{});var h0=a(yp);Ev=i(h0,"ElectraForTokenClassification"),h0.forEach(t),Jf.forEach(t),Vu=p(o),Ve=s(o,"DIV",{class:!0});var Ut=a(Ve);y(qr.$$.fragment,Ut),wv=p(Ut),Ep=s(Ut,"P",{});var m0=a(Ep);$v=i(m0,"Electra model with a token classification head on top."),m0.forEach(t),Fv=p(Ut),wp=s(Ut,"P",{});var u0=a(wp);xv=i(u0,"Both the discriminator and generator may be loaded into this model."),u0.forEach(t),Mv=p(Ut),Pr=s(Ut,"P",{});var Gf=a(Pr);zv=i(Gf,"This model inherits from "),Wd=s(Gf,"A",{href:!0});var f0=a(Wd);Cv=i(f0,"PreTrainedModel"),f0.forEach(t),jv=i(Gf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
