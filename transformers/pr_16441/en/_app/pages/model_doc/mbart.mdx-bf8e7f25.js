...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16441/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16441/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16441/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16441/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16441/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16441/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16441/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16441/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16441/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
refer to this superclass for more information regarding those methods.`),Jh.forEach(t),Bg=l(fe),Ml=a(fe,"P",{});var Yw=s(Ml);$g=i(Yw,"Examples:"),Yw.forEach(t),Fg=l(fe),m(Ia.$$.fragment,fe),jg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);m(Na.$$.fragment,St),Eg=l(St),wl=a(St,"P",{});var e4=s(wl);Pg=i(e4,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),e4.forEach(t),Cg=l(St),Da=a(St,"P",{});var Kh=s(Da);Sg=i(Kh,"An MBART-50 sequence has the following format, where "),xl=a(Kh,"CODE",{});var t4=s(xl);Ag=i(t4,"X"),t4.forEach(t),Og=i(Kh," represents the sequence:"),Kh.forEach(t),Ig=l(St),La=a(St,"UL",{});var Zh=s(La);Ga=a(Zh,"LI",{});var Yh=s(Ga);zl=a(Yh,"CODE",{});var o4=s(zl);Ng=i(o4,"input_ids"),o4.forEach(t),Dg=i(Yh," (for encoder) "),ql=a(Yh,"CODE",{});var n4=s(ql);Lg=i(n4,"[src_lang_code] X [eos]"),n4.forEach(t),Yh.forEach(t),Gg=l(Zh),Wa=a(Zh,"LI",{});var eu=s(Wa);Bl=a(eu,"CODE",{});var a4=s(Bl);Wg=i(a4,"labels"),a4.forEach(t),Rg=i(eu,": (for decoder) "),$l=a(eu,"CODE",{});var s4=s($l);Ug=i(s4,"[tgt_lang_code] X [eos]"),s4.forEach(t),eu.forEach(t),Zh.forEach(t),Xg=l(St),Fl=a(St,"P",{});var r4=s(Fl);Hg=i(r4,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),r4.forEach(t),St.forEach(t),Vg=l(fe),Ko=a(fe,"DIV",{class:!0});var tu=s(Ko);m(Ra.$$.fragment,tu),Qg=l(tu),jl=a(tu,"P",{});var i4=s(jl);Jg=i(i4,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),i4.forEach(t),tu.forEach(t),Kg=l(fe),Zo=a(fe,"DIV",{class:!0});var ou=s(Zo);m(Ua.$$.fragment,ou),Zg=l(ou),El=a(ou,"P",{});var d4=s(El);Yg=i(d4,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),d4.forEach(t),ou.forEach(t),fe.forEach(t),Up=l(o),po=a(o,"H2",{class:!0});var nu=s(po);Yo=a(nu,"A",{id:!0,class:!0,href:!0});var l4=s(Yo);Pl=a(l4,"SPAN",{});var c4=s(Pl);m(Xa.$$.fragment,c4),c4.forEach(t),l4.forEach(t),ek=l(nu),Cl=a(nu,"SPAN",{});var p4=s(Cl);tk=i(p4,"MBartModel"),p4.forEach(t),nu.forEach(t),Xp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);m(Ha.$$.fragment,Bn),ok=l(Bn),Va=a(Bn,"P",{});var au=s(Va);nk=i(au,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),bi=a(au,"A",{href:!0});var h4=s(bi);ak=i(h4,"PreTrainedModel"),h4.forEach(t),sk=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),rk=l(Bn),Qa=a(Bn,"P",{});var su=s(Qa);ik=i(su,"This model is also a PyTorch "),Ja=a(su,"A",{href:!0,rel:!0});var u4=s(Ja);dk=i(u4,"torch.nn.Module"),u4.forEach(t),lk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),ck=l(Bn),Oe=a(Bn,"DIV",{class:!0});var At=s(Oe);m(Ka.$$.fragment,At),pk=l(At),ho=a(At,"P",{});var Gi=s(ho);hk=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var m4=s(yi);uk=i(m4,"MBartModel"),m4.forEach(t),mk=i(Gi," forward method, overrides the "),Sl=a(Gi,"CODE",{});var f4=s(Sl);fk=i(f4,"__call__"),f4.forEach(t),_k=i(Gi," special method."),Gi.forEach(t),gk=l(At),m(en.$$.fragment,At),kk=l(At),Al=a(At,"P",{});var _4=s(Al);bk=i(_4,"Example:"),_4.forEach(t),yk=l(At),m(Za.$$.fragment,At),At.forEach(t),Bn.forEach(t),Hp=l(o),uo=a(o,"H2",{class:!0});var ru=s(uo);tn=a(ru,"A",{id:!0,class:!0,href:!0});var g4=s(tn);Ol=a(g4,"SPAN",{});var k4=s(Ol);m(Ya.$$.fragment,k4),k4.forEach(t),g4.forEach(t),vk=l(ru),Il=a(ru,"SPAN",{});var b4=s(Il);Tk=i(b4,"MBartForConditionalGeneration"),b4.forEach(t),ru.forEach(t),Vp=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);m(es.$$.fragment,$n),Mk=l($n),ts=a($n,"P",{});var iu=s(ts);wk=i(iu,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),vi=a(iu,"A",{href:!0});var y4=s(vi);xk=i(y4,"PreTrainedModel"),y4.forEach(t),zk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),qk=l($n),os=a($n,"P",{});var du=s(os);Bk=i(du,"This model is also a PyTorch "),ns=a(du,"A",{href:!0,rel:!0});var v4=s(ns);$k=i(v4,"torch.nn.Module"),v4.forEach(t),Fk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),jk=l($n),Y=a($n,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Ek=l(Ge),mo=a(Ge,"P",{});var Wi=s(mo);Pk=i(Wi,"The "),Ti=a(Wi,"A",{href:!0});var T4=s(Ti);Ck=i(T4,"MBartForConditionalGeneration"),T4.forEach(t),Sk=i(Wi," forward method, overrides the "),Nl=a(Wi,"CODE",{});var M4=s(Nl);Ak=i(M4,"__call__"),M4.forEach(t),Ok=i(Wi," special method."),Wi.forEach(t),Ik=l(Ge),m(on.$$.fragment,Ge),Nk=l(Ge),Dl=a(Ge,"P",{});var w4=s(Dl);Dk=i(w4,"Translation example:"),w4.forEach(t),Lk=l(Ge),m(ss.$$.fragment,Ge),Gk=l(Ge),Ll=a(Ge,"P",{});var x4=s(Ll);Wk=i(x4,"Mask filling example:"),x4.forEach(t),Rk=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),$n.forEach(t),Qp=l(o),fo=a(o,"H2",{class:!0});var lu=s(fo);nn=a(lu,"A",{id:!0,class:!0,href:!0});var z4=s(nn);Gl=a(z4,"SPAN",{});var q4=s(Gl);m(is.$$.fragment,q4),q4.forEach(t),z4.forEach(t),Uk=l(lu),Wl=a(lu,"SPAN",{});var B4=s(Wl);Xk=i(B4,"MBartForQuestionAnswering"),B4.forEach(t),lu.forEach(t),Jp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);m(ds.$$.fragment,Ot),Hk=l(Ot),_o=a(Ot,"P",{});var Ri=s(_o);Vk=i(Ri,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Rl=a(Ri,"CODE",{});var $4=s(Rl);Qk=i($4,"span start logits"),$4.forEach(t),Jk=i(Ri," and "),Ul=a(Ri,"CODE",{});var F4=s(Ul);Kk=i(F4,"span end logits"),F4.forEach(t),Zk=i(Ri,")."),Ri.forEach(t),Yk=l(Ot),ls=a(Ot,"P",{});var cu=s(ls);eb=i(cu,"This model inherits from "),Mi=a(cu,"A",{href:!0});var j4=s(Mi);tb=i(j4,"PreTrainedModel"),j4.forEach(t),ob=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),nb=l(Ot),cs=a(Ot,"P",{});var pu=s(cs);ab=i(pu,"This model is also a PyTorch "),ps=a(pu,"A",{href:!0,rel:!0});var E4=s(ps);sb=i(E4,"torch.nn.Module"),E4.forEach(t),rb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),ib=l(Ot),ue=a(Ot,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),db=l(at),go=a(at,"P",{});var Ui=s(go);lb=i(Ui,"The "),wi=a(Ui,"A",{href:!0});var P4=s(wi);cb=i(P4,"MBartForQuestionAnswering"),P4.forEach(t),pb=i(Ui," forward method, overrides the "),Xl=a(Ui,"CODE",{});var C4=s(Xl);hb=i(C4,"__call__"),C4.forEach(t),ub=i(Ui," special method."),Ui.forEach(t),mb=l(at),m(an.$$.fragment,at),fb=l(at),Hl=a(at,"P",{});var S4=s(Hl);_b=i(S4,"Example:"),S4.forEach(t),gb=l(at),m(us.$$.fragment,at),kb=l(at),m(ms.$$.fragment,at),at.forEach(t),Ot.forEach(t),Kp=l(o),ko=a(o,"H2",{class:!0});var hu=s(ko);sn=a(hu,"A",{id:!0,class:!0,href:!0});var A4=s(sn);Vl=a(A4,"SPAN",{});var O4=s(Vl);m(fs.$$.fragment,O4),O4.forEach(t),A4.forEach(t),bb=l(hu),Ql=a(hu,"SPAN",{});var I4=s(Ql);yb=i(I4,"MBartForSequenceClassification"),I4.forEach(t),hu.forEach(t),Zp=l(o),Fe=a(o,"DIV",{class:!0});var It=s(Fe);m(_s.$$.fragment,It),vb=l(It),Jl=a(It,"P",{});var N4=s(Jl);Tb=i(N4,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),N4.forEach(t),Mb=l(It),gs=a(It,"P",{});var uu=s(gs);wb=i(uu,"This model inherits from "),xi=a(uu,"A",{href:!0});var D4=s(xi);xb=i(D4,"PreTrainedModel"),D4.forEach(t),zb=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),qb=l(It),ks=a(It,"P",{});var mu=s(ks);Bb=i(mu,"This model is also a PyTorch "),bs=a(mu,"A",{href:!0,rel:!0});var L4=s(bs);$b=i(L4,"torch.nn.Module"),L4.forEach(t),Fb=i(mu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mu.forEach(t),jb=l(It),L=a(It,"DIV",{class:!0});var oe=s(L);m(ys.$$.fragment,oe),Eb=l(oe),bo=a(oe,"P",{});var Xi=s(bo);Pb=i(Xi,"The "),zi=a(Xi,"A",{href:!0});var G4=s(zi);Cb=i(G4,"MBartForSequenceClassification"),G4.forEach(t),Sb=i(Xi," forward method, overrides the "),Kl=a(Xi,"CODE",{});var W4=s(Kl);Ab=i(W4,"__call__"),W4.forEach(t),Ob=i(Xi," special method."),Xi.forEach(t),Ib=l(oe),m(rn.$$.fragment,oe),Nb=l(oe),Zl=a(oe,"P",{});var R4=s(Zl);Db=i(R4,"Example of single-label classification:"),R4.forEach(t),Lb=l(oe),m(vs.$$.fragment,oe),Gb=l(oe),m(Ts.$$.fragment,oe),Wb=l(oe),Yl=a(oe,"P",{});var U4=s(Yl);Rb=i(U4,"Example of multi-label classification:"),U4.forEach(t),Ub=l(oe),m(Ms.$$.fragment,oe),Xb=l(oe),m(ws.$$.fragment,oe),oe.forEach(t),It.forEach(t),Yp=l(o),yo=a(o,"H2",{class:!0});var fu=s(yo);dn=a(fu,"A",{id:!0,class:!0,href:!0});var X4=s(dn);ec=a(X4,"SPAN",{});var H4=s(ec);m(xs.$$.fragment,H4),H4.forEach(t),X4.forEach(t),Hb=l(fu),tc=a(fu,"SPAN",{});var V4=s(tc);Vb=i(V4,"MBartForCausalLM"),V4.forEach(t),fu.forEach(t),eh=l(o),vo=a(o,"DIV",{class:!0});var _u=s(vo);m(zs.$$.fragment,_u),Qb=l(_u),Mt=a(_u,"DIV",{class:!0});var Hi=s(Mt);m(qs.$$.fragment,Hi),Jb=l(Hi),oc=a(Hi,"P",{});var Q4=s(oc);Kb=i(Q4,"Example:"),Q4.forEach(t),Zb=l(Hi),m(Bs.$$.fragment,Hi),Hi.forEach(t),_u.forEach(t),th=l(o),To=a(o,"H2",{class:!0});var gu=s(To);ln=a(gu,"A",{id:!0,class:!0,href:!0});var J4=s(ln);nc=a(J4,"SPAN",{});var K4=s(nc);m($s.$$.fragment,K4),K4.forEach(t),J4.forEach(t),Yb=l(gu),ac=a(gu,"SPAN",{});var Z4=s(ac);ey=i(Z4,"TFMBartModel"),Z4.forEach(t),gu.forEach(t),oh=l(o),je=a(o,"DIV",{class:!0});var Nt=s(je);m(Fs.$$.fragment,Nt),ty=l(Nt),js=a(Nt,"P",{});var ku=s(js);oy=i(ku,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(ku,"A",{href:!0});var Y4=s(qi);ny=i(Y4,"TFPreTrainedModel"),Y4.forEach(t),ay=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
