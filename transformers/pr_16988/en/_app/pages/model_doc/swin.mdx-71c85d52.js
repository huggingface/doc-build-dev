...
<span class="hljs-meta">&gt;&gt;&gt; </span>feature_extractor = AutoFeatureExtractor.from_pretrained(<span class="hljs-string">&quot;microsoft/swin-tiny-patch4-window7-224&quot;</span>)
<span class="hljs-comment">#FIXME - remove once model added to hub</span>

<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFSwinForMaskedImageModeling.from_pretrained(
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;microsoft/swin-tiny-patch4-window7-224&quot;</span>, from_pt=<span class="hljs-literal">True</span>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(model.config.id2label[predicted_label])
tabby, tabby cat`}}),{c(){d=n("p"),b=r("Example:"),h=u(),v(m.$$.fragment)},l(s){d=a(s,"P",{});var c=l(d);b=i(c,"Example:"),c.forEach(o),h=g(s),$(m.$$.fragment,s)},m(s,c){_(s,d,c),e(d,b),_(s,h,c),T(m,s,c),w=!0},p:At,i(s){w||(y(m.$$.fragment,s),w=!0)},o(s){S(m.$$.fragment,s),w=!1},d(s){s&&o(d),s&&o(h),k(m,s)}}}function ll(F){let d,b,h,m,w,s,c,x,Hs,ss,K,pe,ho,Be,Ws,mo,Us,ns,he,Vs,Ke,Bs,Ks,as,Pt,Rs,rs,zt,fo,Ys,is,Ot,Zs,ls,B,Re,Gs,Nt,Js,Xs,Qs,Ye,en,uo,tn,on,sn,M,nn,go,an,rn,_o,ln,dn,wo,cn,pn,bo,hn,mn,vo,fn,un,$o,gn,_n,To,wn,bn,ds,me,Pr,cs,fe,vn,Dt,$n,Tn,ps,q,yn,Ze,Sn,kn,Ge,Fn,xn,Je,Mn,En,hs,R,ue,yo,Xe,jn,So,In,ms,j,Qe,Cn,Y,An,Lt,qn,Pn,et,zn,On,Nn,Z,Dn,Ht,Ln,Hn,Wt,Wn,Un,Vn,ge,fs,G,_e,ko,tt,Bn,Fo,Kn,us,H,ot,Rn,st,Yn,nt,Zn,Gn,Jn,P,at,Xn,J,Qn,Ut,ea,ta,xo,oa,sa,na,we,aa,be,gs,X,ve,Mo,rt,ra,Eo,ia,_s,W,it,la,Q,da,jo,ca,pa,lt,ha,ma,fa,z,dt,ua,ee,ga,Vt,_a,wa,Io,ba,va,$a,$e,Ta,Te,ws,te,ye,Co,ct,ya,Ao,Sa,bs,I,pt,ka,qo,Fa,xa,ht,Ma,mt,Ea,ja,Ia,O,ft,Ca,oe,Aa,Bt,qa,Pa,Po,za,Oa,Na,Se,Da,ke,vs,se,Fe,zo,ut,La,Oo,Ha,$s,U,gt,Wa,_t,Ua,wt,Va,Ba,Ka,N,bt,Ra,ne,Ya,Kt,Za,Ga,No,Ja,Xa,Qa,xe,er,Me,Ts,ae,Ee,Do,vt,tr,Lo,or,ys,V,$t,sr,re,nr,Ho,ar,rr,Tt,ir,lr,dr,D,yt,cr,ie,pr,Rt,hr,mr,Wo,fr,ur,gr,je,_r,Ie,Ss,le,Ce,Uo,St,wr,Vo,br,ks,C,kt,vr,Bo,$r,Tr,Ft,yr,xt,Sr,kr,Fr,L,Mt,xr,de,Mr,Yt,Er,jr,Ko,Ir,Cr,Ar,Ae,qr,qe,Fs;return s=new ce({}),Be=new ce({}),Xe=new ce({}),Qe=new A({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
<p>Example &#x2014;`,name:"encoder_stride"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/configuration_swin.py#L29"}}),ge=new Ct({props:{anchor:"transformers.SwinConfig.example",$$slots:{default:[Zi]},$$scope:{ctx:F}}}),tt=new ce({}),ot=new A({props:{name:"class transformers.SwinModel",anchor:"transformers.SwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],parametersDescription:[{anchor:"transformers.SwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16988/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16988/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_swin.py#L905"}}),at=new A({props:{name:"forward",anchor:"transformers.SwinModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16988/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16988/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_swin.py#L1003"}}),dt=new A({props:{name:"forward",anchor:"transformers.SwinForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16988/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_swin.py#L1018",returnDescription:`
...
`}}),$e=new po({props:{$$slots:{default:[Xi]},$$scope:{ctx:F}}}),Te=new Ct({props:{anchor:"transformers.SwinForMaskedImageModeling.forward.example",$$slots:{default:[Qi]},$$scope:{ctx:F}}}),ct=new ce({}),pt=new A({props:{name:"class transformers.SwinForImageClassification",anchor:"transformers.SwinForImageClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.SwinForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16988/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16988/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_swin.py#L1113"}}),ft=new A({props:{name:"forward",anchor:"transformers.SwinForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16988/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_swin.py#L1128",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16988/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_tf_swin.py#L1075"}}),bt=new A({props:{name:"call",anchor:"transformers.TFSwinModel.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFSwinModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16988/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16988/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_tf_swin.py#L1220"}}),yt=new A({props:{name:"call",anchor:"transformers.TFSwinForMaskedImageModeling.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFSwinForMaskedImageModeling.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16988/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_tf_swin.py#L1229",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16988/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_tf_swin.py#L1340"}}),Mt=new A({props:{name:"call",anchor:"transformers.TFSwinForImageClassification.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFSwinForImageClassification.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16988/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16988/src/transformers/models/swin/modeling_tf_swin.py#L1354",returnDescription:`
...
behavior.`),Jn=u(),P=n("div"),v(at.$$.fragment),Xn=u(),J=n("p"),Qn=r("The "),Ut=n("a"),ea=r("SwinModel"),ta=r(" forward method, overrides the "),xo=n("code"),oa=r("__call__"),sa=r(" special method."),na=u(),v(we.$$.fragment),aa=u(),v(be.$$.fragment),gs=u(),X=n("h2"),ve=n("a"),Mo=n("span"),v(rt.$$.fragment),ra=u(),Eo=n("span"),ia=r("SwinForMaskedImageModeling"),_s=u(),W=n("div"),v(it.$$.fragment),la=u(),Q=n("p"),da=r("Swin Model with a decoder on top for masked image modeling, as proposed in "),jo=n("code"),ca=r("SimMIM <https://arxiv.org/abs/2111.09886>"),pa=r(`__.
...
regular Tensorflow Module and refer to the Tensorflow documentation for all matter related to general usage and
behavior.`),Fr=u(),L=n("div"),v(Mt.$$.fragment),xr=u(),de=n("p"),Mr=r("The "),Yt=n("a"),Er=r("TFSwinForImageClassification"),jr=r(" forward method, overrides the "),Ko=n("code"),Ir=r("__call__"),Cr=r(" special method."),Ar=u(),v(Ae.$$.fragment),qr=u(),v(qe.$$.fragment),this.h()},l(t){const f=Ki('[data-svelte="svelte-1phssyn"]',document.head);d=a(f,"META",{name:!0,content:!0}),f.forEach(o),b=g(t),h=a(t,"H1",{class:!0});var Et=l(h);m=a(Et,"A",{id:!0,class:!0,href:!0});var Ro=l(m);w=a(Ro,"SPAN",{});var Yo=l(w);$(s.$$.fragment,Yo),Yo.forEach(o),Ro.forEach(o),c=g(Et),x=a(Et,"SPAN",{});var Zo=l(x);Hs=i(Zo,"Swin Transformer"),Zo.forEach(o),Et.forEach(o),ss=g(t),K=a(t,"H2",{class:!0});var jt=l(K);pe=a(jt,"A",{id:!0,class:!0,href:!0});var Go=l(pe);ho=a(Go,"SPAN",{});var Jo=l(ho);$(Be.$$.fragment,Jo),Jo.forEach(o),Go.forEach(o),Ws=g(jt),mo=a(jt,"SPAN",{});var Xo=l(mo);Us=i(Xo,"Overview"),Xo.forEach(o),jt.forEach(o),ns=g(t),he=a(t,"P",{});var It=l(he);Vs=i(It,"The Swin Transformer was proposed in "),Ke=a(It,"A",{href:!0,rel:!0});var Qo=l(Ke);Bs=i(Qo,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),Qo.forEach(o),Ks=i(It,`
...
documentation from `),Wt=a(Jt,"A",{href:!0});var oi=l(Wt);Wn=i(oi,"PretrainedConfig"),oi.forEach(o),Un=i(Jt," for more information."),Jt.forEach(o),Vn=g(ze),$(ge.$$.fragment,ze),ze.forEach(o),fs=g(t),G=a(t,"H2",{class:!0});var Is=l(G);_e=a(Is,"A",{id:!0,class:!0,href:!0});var si=l(_e);ko=a(si,"SPAN",{});var ni=l(ko);$(tt.$$.fragment,ni),ni.forEach(o),si.forEach(o),Bn=g(Is),Fo=a(Is,"SPAN",{});var ai=l(Fo);Kn=i(ai,"SwinModel"),ai.forEach(o),Is.forEach(o),us=g(t),H=a(t,"DIV",{class:!0});var Xt=l(H);$(ot.$$.fragment,Xt),Rn=g(Xt),st=a(Xt,"P",{});var Cs=l(st);Yn=i(Cs,`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),nt=a(Cs,"A",{href:!0,rel:!0});var ri=l(nt);Zn=i(ri,"torch.nn.Module"),ri.forEach(o),Gn=i(Cs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cs.forEach(o),Jn=g(Xt),P=a(Xt,"DIV",{class:!0});var Oe=l(P);$(at.$$.fragment,Oe),Xn=g(Oe),J=a(Oe,"P",{});var Qt=l(J);Qn=i(Qt,"The "),Ut=a(Qt,"A",{href:!0});var ii=l(Ut);ea=i(ii,"SwinModel"),ii.forEach(o),ta=i(Qt," forward method, overrides the "),xo=a(Qt,"CODE",{});var li=l(xo);oa=i(li,"__call__"),li.forEach(o),sa=i(Qt," special method."),Qt.forEach(o),na=g(Oe),$(we.$$.fragment,Oe),aa=g(Oe),$(be.$$.fragment,Oe),Oe.forEach(o),Xt.forEach(o),gs=g(t),X=a(t,"H2",{class:!0});var As=l(X);ve=a(As,"A",{id:!0,class:!0,href:!0});var di=l(ve);Mo=a(di,"SPAN",{});var ci=l(Mo);$(rt.$$.fragment,ci),ci.forEach(o),di.forEach(o),ra=g(As),Eo=a(As,"SPAN",{});var pi=l(Eo);ia=i(pi,"SwinForMaskedImageModeling"),pi.forEach(o),As.forEach(o),_s=g(t),W=a(t,"DIV",{class:!0});var eo=l(W);$(it.$$.fragment,eo),la=g(eo),Q=a(eo,"P",{});var to=l(Q);da=i(to,"Swin Model with a decoder on top for masked image modeling, as proposed in "),jo=a(to,"CODE",{});var hi=l(jo);ca=i(hi,"SimMIM <https://arxiv.org/abs/2111.09886>"),hi.forEach(o),pa=i(to,`__.
