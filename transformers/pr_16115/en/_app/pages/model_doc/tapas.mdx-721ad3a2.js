...
`}}),pn=new le({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/tokenization_tapas.py#L397"}}),dn=new ss({}),cn=new le({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tapas.py#L856",parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16115/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Tn=new le({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tapas.py#L894",parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),vn=new ss({}),wn=new le({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tapas.py#L1009",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16115/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),jn=new le({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tapas.py#L1028",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),En=new ss({}),Fn=new le({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tapas.py#L1468",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16115/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xn=new le({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tapas.py#L1480",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),On=new ss({}),In=new le({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tf_tapas.py#L976",parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16115/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new As({props:{$$slots:{default:[Y2]},$$scope:{ctx:U}}}),Bn=new le({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tf_tapas.py#L982",parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16115/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Rn=new ss({}),Vn=new le({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tf_tapas.py#L1066",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16115/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ta=new As({props:{$$slots:{default:[X2]},$$scope:{ctx:U}}}),Zn=new le({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tf_tapas.py#L1082",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16115/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),so=new ss({}),to=new le({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tf_tapas.py#L1649",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16115/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oa=new As({props:{$$slots:{default:[e0]},$$scope:{ctx:U}}}),ro=new le({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16115/src/transformers/models/tapas/modeling_tf_tapas.py#L1660",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16115/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16115/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16115/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rw=l(),b(oa.$$.fragment),Vw=l(),ls=o("div"),b(ro.$$.fragment),Kw=l(),yt=o("p"),Yw=a("The "),vr=o("a"),Jw=a("TFTapasForSequenceClassification"),Xw=a(" forward method, overrides the "),Up=o("code"),Zw=a("__call__"),e1=a(" special method."),s1=l(),b(ra.$$.fragment),t1=l(),Hp=o("p"),a1=a("Examples:"),n1=l(),b(io.$$.fragment),pc=l(),kt=o("h2"),ia=o("a"),Bp=o("span"),b(lo.$$.fragment),o1=l(),Gp=o("span"),r1=a("TFTapasForQuestionAnswering"),dc=l(),Oe=o("div"),b(po.$$.fragment),i1=l(),jt=o("p"),l1=a(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Rp=o("code"),p1=a("logits"),d1=a(" and optional "),Vp=o("code"),c1=a("logits_aggregation"),h1=a(`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),u1=l(),co=o("p"),m1=a("This model inherits from "),wr=o("a"),g1=a("TFPreTrainedModel"),f1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_1=l(),ho=o("p"),T1=a("This model is also a "),uo=o("a"),b1=a("tf.keras.Model"),v1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),w1=l(),b(la.$$.fragment),y1=l(),ps=o("div"),b(mo.$$.fragment),k1=l(),qt=o("p"),j1=a("The "),yr=o("a"),q1=a("TFTapasForQuestionAnswering"),E1=a(" forward method, overrides the "),Kp=o("code"),F1=a("__call__"),A1=a(" special method."),$1=l(),b(pa.$$.fragment),z1=l(),Yp=o("p"),x1=a("Examples:"),C1=l(),b(go.$$.fragment),this.h()},l(t){const h=H2('[data-svelte="svelte-1phssyn"]',document.head);m=r(h,"META",{name:!0,content:!0}),h.forEach(s),F=p(t),g=r(t,"H1",{class:!0});var fo=i(g);f=r(fo,"A",{id:!0,class:!0,href:!0});var Jp=i(f);q=r(Jp,"SPAN",{});var Xp=i(q);v(T.$$.fragment,Xp),Xp.forEach(s),Jp.forEach(s),_=p(fo),A=r(fo,"SPAN",{});var Zp=i(A);_e=n(Zp,"TAPAS"),Zp.forEach(s),fo.forEach(s),K=p(t),$=r(t,"H2",{class:!0});var _o=i($);Y=r(_o,"A",{id:!0,class:!0,href:!0});var ed=i(Y);O=r(ed,"SPAN",{});var sd=i(O);v(Z.$$.fragment,sd),sd.forEach(s),ed.forEach(s),Te=p(_o),I=r(_o,"SPAN",{});var td=i(I);be=n(td,"Overview"),td.forEach(s),_o.forEach(s),ce=p(t),W=r(t,"P",{});var To=i(W);N=n(To,"The TAPAS model was proposed in "),ee=r(To,"A",{href:!0,rel:!0});var ad=i(ee);se=n(ad,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),ad.forEach(s),z=n(To,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),To.forEach(s),x=p(t),oe=r(t,"P",{});var nd=i(oe);H=n(nd,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),nd.forEach(s),he=p(t),V=r(t,"UL",{});var Et=i(V);L=r(Et,"LI",{});var M1=i(L);te=r(M1,"A",{href:!0,rel:!0});var R1=i(te);ve=n(R1,"SQA"),R1.forEach(s),C=n(M1," (Sequential Question Answering by Microsoft)"),M1.forEach(s),we=p(Et),Q=r(Et,"LI",{});var P1=i(Q);ae=r(P1,"A",{href:!0,rel:!0});var V1=i(ae);ye=n(V1,"WTQ"),V1.forEach(s),B=n(P1," (Wiki Table Questions by Stanford University)"),P1.forEach(s),ke=p(Et),re=r(Et,"LI",{});var S1=i(re);P=r(S1,"A",{href:!0,rel:!0});var K1=i(P);je=n(K1,"WikiSQL"),K1.forEach(s),G=n(S1," (by Salesforce)."),S1.forEach(s),Et.forEach(s),ue=p(t),u=r(t,"P",{});var Y1=i(u);E=n(Y1,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),Y1.forEach(s),J=p(t),Fe=r(t,"P",{});var J1=i(Fe);Ge=n(J1,"The abstract from the paper is the following:"),J1.forEach(s),S=p(t),Ae=r(t,"P",{});var X1=i(Ae);xe=r(X1,"EM",{});var Z1=i(xe);Re=n(Z1,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),Z1.forEach(s),X1.forEach(s),D=p(t),M=r(t,"P",{});var da=i(M);Ve=n(da,"In addition, the authors have further pre-trained TAPAS to recognize "),Ce=r(da,"STRONG",{});var ey=i(Ce);R=n(ey,"table entailment"),ey.forEach(s),Ke=n(da,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),qe=r(da,"A",{href:!0,rel:!0});var sy=i(qe);Ee=n(sy,"TabFact"),sy.forEach(s),Ye=n(da,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),fa=r(da,"A",{href:!0,rel:!0});var ty=i(fa);dh=n(ty,"Understanding tables with intermediate pre-training"),ty.forEach(s),ch=n(da," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),da.forEach(s),od=p(t),At=r(t,"IMG",{src:!0,alt:!0,width:!0}),rd=p(t),$t=r(t,"SMALL",{});var hc=i($t);hh=n(hc,"TAPAS architecture. Taken from the "),bo=r(hc,"A",{href:!0});var ay=i(bo);uh=n(ay,"original blog post"),ay.forEach(s),mh=n(hc,"."),hc.forEach(s),id=p(t),_s=r(t,"P",{});var ca=i(_s);gh=n(ca,"This model was contributed by "),_a=r(ca,"A",{href:!0,rel:!0});var ny=i(_a);fh=n(ny,"nielsr"),ny.forEach(s),_h=n(ca,". The Tensorflow version of this model was contributed by "),Ta=r(ca,"A",{href:!0,rel:!0});var oy=i(Ta);Th=n(oy,"kamalkraj"),oy.forEach(s),bh=n(ca,". The original code can be found "),ba=r(ca,"A",{href:!0,rel:!0});var ry=i(ba);vh=n(ry,"here"),ry.forEach(s),wh=n(ca,"."),ca.forEach(s),ld=p(t),vo=r(t,"P",{});var iy=i(vo);yh=n(iy,"Tips:"),iy.forEach(s),pd=p(t),Ts=r(t,"UL",{});var ha=i(Ts);Me=r(ha,"LI",{});var ds=i(Me);kh=n(ds,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),Rr=r(ds,"CODE",{});var ly=i(Rr);jh=n(ly,"reset_position_index_per_cell"),ly.forEach(s),qh=n(ds," parameter of "),wo=r(ds,"A",{href:!0});var py=i(wo);Eh=n(py,"TapasConfig"),py.forEach(s),Fh=n(ds,", which is set to "),Vr=r(ds,"CODE",{});var dy=i(Vr);Ah=n(dy,"True"),dy.forEach(s),$h=n(ds," by default. The default versions of the models available on the "),va=r(ds,"A",{href:!0,rel:!0});var cy=i(va);zh=n(cy,"hub"),cy.forEach(s),xh=n(ds," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),Kr=r(ds,"CODE",{});var hy=i(Kr);Ch=n(hy,'revision="no_reset"'),hy.forEach(s),Mh=n(ds," when calling the "),Yr=r(ds,"CODE",{});var uy=i(Yr);Ph=n(uy,"from_pretrained()"),uy.forEach(s),Sh=n(ds," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),ds.forEach(s),Dh=p(ha),Je=r(ha,"LI",{});var vs=i(Je);Nh=n(vs,"TAPAS is based on BERT, so "),Jr=r(vs,"CODE",{});var my=i(Jr);Lh=n(my,"TAPAS-base"),my.forEach(s),Qh=n(vs," for example corresponds to a "),Xr=r(vs,"CODE",{});var gy=i(Xr);Oh=n(gy,"BERT-base"),gy.forEach(s),Ih=n(vs," architecture. Of course, "),Zr=r(vs,"CODE",{});var fy=i(Zr);Wh=n(fy,"TAPAS-large"),fy.forEach(s),Uh=n(vs," will result in the best performance (the results reported in the paper are from "),ei=r(vs,"CODE",{});var _y=i(ei);Hh=n(_y,"TAPAS-large"),_y.forEach(s),Bh=n(vs,"). Results of the various sized models are shown on the "),wa=r(vs,"A",{href:!0,rel:!0});var Ty=i(wa);Gh=n(Ty,"original Github repository"),Ty.forEach(s),Rh=n(vs,"."),vs.forEach(s),Vh=p(ha),Vs=r(ha,"LI",{});var kr=i(Vs);Kh=n(kr,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),si=r(kr,"CODE",{});var by=i(si);Yh=n(by,"prev_labels"),by.forEach(s),Jh=n(kr," token type ids can be overwritten by the predicted "),ti=r(kr,"CODE",{});var vy=i(ti);Xh=n(vy,"labels"),vy.forEach(s),Zh=n(kr," of the model to the previous question. See \u201CUsage\u201D section for more info."),kr.forEach(s),eu=p(ha),ai=r(ha,"LI",{});var wy=i(ai);su=n(wy,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),wy.forEach(s),ha.forEach(s),dd=p(t),Ks=r(t,"H2",{class:!0});var uc=i(Ks);zt=r(uc,"A",{id:!0,class:!0,href:!0});var yy=i(zt);ni=r(yy,"SPAN",{});var ky=i(ni);v(ya.$$.fragment,ky),ky.forEach(s),yy.forEach(s),tu=p(uc),oi=r(uc,"SPAN",{});var jy=i(oi);au=n(jy,"Usage: fine-tuning"),jy.forEach(s),uc.forEach(s),cd=p(t),xt=r(t,"P",{});var mc=i(xt);nu=n(mc,"Here we explain how you can fine-tune "),yo=r(mc,"A",{href:!0});var qy=i(yo);ou=n(qy,"TapasForQuestionAnswering"),qy.forEach(s),ru=n(mc," on your own dataset."),mc.forEach(s),hd=p(t),ko=r(t,"P",{});var Ey=i(ko);ri=r(Ey,"STRONG",{});var Fy=i(ri);iu=n(Fy,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),Fy.forEach(s),Ey.forEach(s),ud=p(t),Ct=r(t,"P",{});var gc=i(Ct);lu=n(gc,"Basically, there are 3 different ways in which one can fine-tune "),jo=r(gc,"A",{href:!0});var Ay=i(jo);pu=n(Ay,"TapasForQuestionAnswering"),Ay.forEach(s),du=n(gc,", corresponding to the different datasets on which Tapas was fine-tuned:"),gc.forEach(s),md=p(t),zs=r(t,"OL",{});var jr=i(zs);ii=r(jr,"LI",{});var $y=i(ii);cu=n($y,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),$y.forEach(s),hu=p(jr),ka=r(jr,"LI",{});var fc=i(ka);uu=n(fc,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),li=r(fc,"STRONG",{});var zy=i(li);mu=n(zy,"weak supervision"),zy.forEach(s),gu=n(fc,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),fc.forEach(s),fu=p(jr),ja=r(jr,"LI",{});var _c=i(ja);_u=n(_c,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),pi=r(_c,"STRONG",{});var xy=i(pi);Tu=n(xy,"strong supervision"),xy.forEach(s),bu=n(_c,". Here, learning the appropriate aggregation operator is much easier."),_c.forEach(s),jr.forEach(s),gd=p(t),qo=r(t,"P",{});var Cy=i(qo);vu=n(Cy,"To summarize:"),Cy.forEach(s),fd=p(t),Mt=r(t,"TABLE",{});var Tc=i(Mt);di=r(Tc,"THEAD",{});var My=i(di);Ys=r(My,"TR",{});var qr=i(Ys);ci=r(qr,"TH",{});var Py=i(ci);hi=r(Py,"STRONG",{});var Sy=i(hi);wu=n(Sy,"Task"),Sy.forEach(s),Py.forEach(s),yu=p(qr),ui=r(qr,"TH",{});var Dy=i(ui);mi=r(Dy,"STRONG",{});var Ny=i(mi);ku=n(Ny,"Example dataset"),Ny.forEach(s),Dy.forEach(s),ju=p(qr),gi=r(qr,"TH",{});var Ly=i(gi);fi=r(Ly,"STRONG",{});var Qy=i(fi);qu=n(Qy,"Description"),Qy.forEach(s),Ly.forEach(s),qr.forEach(s),My.forEach(s),Eu=p(Tc),Js=r(Tc,"TBODY",{});var Er=i(Js);Xs=r(Er,"TR",{});var Fr=i(Xs);_i=r(Fr,"TD",{});var Oy=i(_i);Fu=n(Oy,"Conversational"),Oy.forEach(s),Au=p(Fr),Ti=r(Fr,"TD",{});var Iy=i(Ti);$u=n(Iy,"SQA"),Iy.forEach(s),zu=p(Fr),bi=r(Fr,"TD",{});var Wy=i(bi);xu=n(Wy,"Conversational, only cell selection questions"),Wy.forEach(s),Fr.forEach(s),Cu=p(Er),Zs=r(Er,"TR",{});var Ar=i(Zs);vi=r(Ar,"TD",{});var Uy=i(vi);Mu=n(Uy,"Weak supervision for aggregation"),Uy.forEach(s),Pu=p(Ar),wi=r(Ar,"TD",{});var Hy=i(wi);Su=n(Hy,"WTQ"),Hy.forEach(s),Du=p(Ar),yi=r(Ar,"TD",{});var By=i(yi);Nu=n(By,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),By.forEach(s),Ar.forEach(s),Lu=p(Er),et=r(Er,"TR",{});var $r=i(et);ki=r($r,"TD",{});var Gy=i(ki);Qu=n(Gy,"Strong supervision for aggregation"),Gy.forEach(s),Ou=p($r),ji=r($r,"TD",{});var Ry=i(ji);Iu=n(Ry,"WikiSQL-supervised"),Ry.forEach(s),Wu=p($r),qi=r($r,"TD",{});var Vy=i(qi);Uu=n(Vy,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),Vy.forEach(s),$r.forEach(s),Er.forEach(s),Tc.forEach(s),_d=p(t),xs=r(t,"P",{});var zr=i(xs);Hu=n(zr,`Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the
`),qa=r(zr,"A",{href:!0,rel:!0});var Ky=i(qa);Bu=n(Ky,"torch-scatter"),Ky.forEach(s),Gu=n(zr," dependency for your environment in case you\u2019re using PyTorch, or the "),Ea=r(zr,"A",{href:!0,rel:!0});var Yy=i(Ea);Ru=n(Yy,"tensorflow_probability"),Yy.forEach(s),Vu=n(zr,`
dependency in case you\u2019re using Tensorflow:`),zr.forEach(s),Td=p(t),v(Fa.$$.fragment,t),bd=p(t),Cs=r(t,"P",{});var xr=i(Cs);Ku=n(xr,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),Eo=r(xr,"A",{href:!0});var Jy=i(Eo);Yu=n(Jy,"TapasConfig"),Jy.forEach(s),Ju=n(xr,", and then create a "),Fo=r(xr,"A",{href:!0});var Xy=i(Fo);Xu=n(Xy,"TapasForQuestionAnswering"),Xy.forEach(s),Zu=n(xr," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),xr.forEach(s),vd=p(t),v(Aa.$$.fragment,t),wd=p(t),Pt=r(t,"P",{});var bc=i(Pt);em=n(bc,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),$a=r(bc,"A",{href:!0,rel:!0});var Zy=i($a);sm=n(Zy,"here"),Zy.forEach(s),tm=n(bc," for more info."),bc.forEach(s),yd=p(t),St=r(t,"P",{});var vc=i(St);am=n(vc,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),za=r(vc,"A",{href:!0,rel:!0});var ek=i(za);nm=n(ek,"here"),ek.forEach(s),om=n(vc,"."),vc.forEach(s),kd=p(t),Ao=r(t,"P",{});var sk=i(Ao);Ei=r(sk,"STRONG",{});var tk=i(Ei);rm=n(tk,"STEP 2: Prepare your data in the SQA format"),tk.forEach(s),sk.forEach(s),jd=p(t),Dt=r(t,"P",{});var wc=i(Dt);im=n(wc,"Second, no matter what you picked above, you should prepare your dataset in the "),xa=r(wc,"A",{href:!0,rel:!0});var ak=i(xa);lm=n(ak,"SQA"),ak.forEach(s),pm=n(wc," format. This format is a TSV/CSV file with the following columns:"),wc.forEach(s),qd=p(t),ie=r(t,"UL",{});var ze=i(ie);$o=r(ze,"LI",{});var D1=i($o);Fi=r(D1,"CODE",{});var nk=i(Fi);dm=n(nk,"id"),nk.forEach(s),cm=n(D1,": optional, id of the table-question pair, for bookkeeping purposes."),D1.forEach(s),hm=p(ze),zo=r(ze,"LI",{});var N1=i(zo);Ai=r(N1,"CODE",{});var ok=i(Ai);um=n(ok,"annotator"),ok.forEach(s),mm=n(N1,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),N1.forEach(s),gm=p(ze),xo=r(ze,"LI",{});var L1=i(xo);$i=r(L1,"CODE",{});var rk=i($i);fm=n(rk,"position"),rk.forEach(s),_m=n(L1,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),L1.forEach(s),Tm=p(ze),Co=r(ze,"LI",{});var Q1=i(Co);zi=r(Q1,"CODE",{});var ik=i(zi);bm=n(ik,"question"),ik.forEach(s),vm=n(Q1,": string"),Q1.forEach(s),wm=p(ze),Mo=r(ze,"LI",{});var O1=i(Mo);xi=r(O1,"CODE",{});var lk=i(xi);ym=n(lk,"table_file"),lk.forEach(s),km=n(O1,": string, name of a csv file containing the tabular data"),O1.forEach(s),jm=p(ze),Po=r(ze,"LI",{});var I1=i(Po);Ci=r(I1,"CODE",{});var pk=i(Ci);qm=n(pk,"answer_coordinates"),pk.forEach(s),Em=n(I1,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),I1.forEach(s),Fm=p(ze),So=r(ze,"LI",{});var W1=i(So);Mi=r(W1,"CODE",{});var dk=i(Mi);Am=n(dk,"answer_text"),dk.forEach(s),$m=n(W1,": list of one or more strings (each string being a cell value that is part of the answer)"),W1.forEach(s),zm=p(ze),Do=r(ze,"LI",{});var U1=i(Do);Pi=r(U1,"CODE",{});var ck=i(Pi);xm=n(ck,"aggregation_label"),ck.forEach(s),Cm=n(U1,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),U1.forEach(s),Mm=p(ze),No=r(ze,"LI",{});var H1=i(No);Si=r(H1,"CODE",{});var hk=i(Si);Pm=n(hk,"float_answer"),hk.forEach(s),Sm=n(H1,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),H1.forEach(s),ze.forEach(s),Ed=p(t),We=r(t,"P",{});var ws=i(We);Dm=n(ws,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),Ca=r(ws,"A",{href:!0,rel:!0});var uk=i(Ca);Nm=n(uk,"here"),uk.forEach(s),Lm=n(ws,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),Ma=r(ws,"A",{href:!0,rel:!0});var mk=i(Ma);Qm=n(mk,"here"),mk.forEach(s),Om=n(ws,". Interestingly, these conversion scripts are not perfect (the "),Di=r(ws,"CODE",{});var gk=i(Di);Im=n(gk,"answer_coordinates"),gk.forEach(s),Wm=n(ws," and "),Ni=r(ws,"CODE",{});var fk=i(Ni);Um=n(fk,"float_answer"),fk.forEach(s),Hm=n(ws," fields are populated based on the "),Li=r(ws,"CODE",{});var _k=i(Li);Bm=n(_k,"answer_text"),_k.forEach(s),Gm=n(ws,"), meaning that WTQ and WikiSQL results could actually be improved."),ws.forEach(s),Fd=p(t),Lo=r(t,"P",{});var Tk=i(Lo);Qi=r(Tk,"STRONG",{});var bk=i(Qi);Rm=n(bk,"STEP 3: Convert your data into PyTorch/TensorFlow tensors using TapasTokenizer"),bk.forEach(s),Tk.forEach(s),Ad=p(t),$e=r(t,"P",{});var cs=i($e);Vm=n(cs,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),Qo=r(cs,"A",{href:!0});var vk=i(Qo);Km=n(vk,"TapasTokenizer"),vk.forEach(s),Ym=n(cs," to convert table-question pairs into "),Oi=r(cs,"CODE",{});var wk=i(Oi);Jm=n(wk,"input_ids"),wk.forEach(s),Xm=n(cs,", "),Ii=r(cs,"CODE",{});var yk=i(Ii);Zm=n(yk,"attention_mask"),yk.forEach(s),eg=n(cs,", "),Wi=r(cs,"CODE",{});var kk=i(Wi);sg=n(kk,"token_type_ids"),kk.forEach(s),tg=n(cs," and so on. Again, based on which of the three cases you picked above, "),Oo=r(cs,"A",{href:!0});var jk=i(Oo);ag=n(jk,"TapasForQuestionAnswering"),jk.forEach(s),ng=n(cs,"/"),Io=r(cs,"A",{href:!0});var qk=i(Io);og=n(qk,"TFTapasForQuestionAnswering"),qk.forEach(s),rg=n(cs,` requires different
inputs to be fine-tuned:`),cs.forEach(s),$d=p(t),Nt=r(t,"TABLE",{});var yc=i(Nt);Ui=r(yc,"THEAD",{});var Ek=i(Ui);Pa=r(Ek,"TR",{});var kc=i(Pa);Hi=r(kc,"TH",{});var Fk=i(Hi);Bi=r(Fk,"STRONG",{});var Ak=i(Bi);ig=n(Ak,"Task"),Ak.forEach(s),Fk.forEach(s),lg=p(kc),Gi=r(kc,"TH",{});var $k=i(Gi);Ri=r($k,"STRONG",{});var zk=i(Ri);pg=n(zk,"Required inputs"),zk.forEach(s),$k.forEach(s),kc.forEach(s),Ek.forEach(s),dg=p(yc),st=r(yc,"TBODY",{});var Cr=i(st);Sa=r(Cr,"TR",{});var jc=i(Sa);Vi=r(jc,"TD",{});var xk=i(Vi);cg=n(xk,"Conversational"),xk.forEach(s),hg=p(jc),$s=r(jc,"TD",{});var ua=i($s);Ki=r(ua,"CODE",{});var Ck=i(Ki);ug=n(Ck,"input_ids"),Ck.forEach(s),mg=n(ua,", "),Yi=r(ua,"CODE",{});var Mk=i(Yi);gg=n(Mk,"attention_mask"),Mk.forEach(s),fg=n(ua,", "),Ji=r(ua,"CODE",{});var Pk=i(Ji);_g=n(Pk,"token_type_ids"),Pk.forEach(s),Tg=n(ua,", "),Xi=r(ua,"CODE",{});var Sk=i(Xi);bg=n(Sk,"labels"),Sk.forEach(s),ua.forEach(s),jc.forEach(s),vg=p(Cr),Da=r(Cr,"TR",{});var qc=i(Da);Zi=r(qc,"TD",{});var Dk=i(Zi);wg=n(Dk,"Weak supervision for aggregation"),Dk.forEach(s),yg=p(qc),Pe=r(qc,"TD",{});var hs=i(Pe);el=r(hs,"CODE",{});var Nk=i(el);kg=n(Nk,"input_ids"),Nk.forEach(s),jg=n(hs,", "),sl=r(hs,"CODE",{});var Lk=i(sl);qg=n(Lk,"attention_mask"),Lk.forEach(s),Eg=n(hs,", "),tl=r(hs,"CODE",{});var Qk=i(tl);Fg=n(Qk,"token_type_ids"),Qk.forEach(s),Ag=n(hs,", "),al=r(hs,"CODE",{});var Ok=i(al);$g=n(Ok,"labels"),Ok.forEach(s),zg=n(hs,", "),nl=r(hs,"CODE",{});var Ik=i(nl);xg=n(Ik,"numeric_values"),Ik.forEach(s),Cg=n(hs,", "),ol=r(hs,"CODE",{});var Wk=i(ol);Mg=n(Wk,"numeric_values_scale"),Wk.forEach(s),Pg=n(hs,", "),rl=r(hs,"CODE",{});var Uk=i(rl);Sg=n(Uk,"float_answer"),Uk.forEach(s),hs.forEach(s),qc.forEach(s),Dg=p(Cr),Na=r(Cr,"TR",{});var Ec=i(Na);il=r(Ec,"TD",{});var Hk=i(il);Ng=n(Hk,"Strong supervision for aggregation"),Hk.forEach(s),Lg=p(Ec),ms=r(Ec,"TD",{});var Ss=i(ms);ll=r(Ss,"CODE",{});var Bk=i(ll);Qg=n(Bk,"input ids"),Bk.forEach(s),Og=n(Ss,", "),pl=r(Ss,"CODE",{});var Gk=i(pl);Ig=n(Gk,"attention mask"),Gk.forEach(s),Wg=n(Ss,", "),dl=r(Ss,"CODE",{});var Rk=i(dl);Ug=n(Rk,"token type ids"),Rk.forEach(s),Hg=n(Ss,", "),cl=r(Ss,"CODE",{});var Vk=i(cl);Bg=n(Vk,"labels"),Vk.forEach(s),Gg=n(Ss,", "),hl=r(Ss,"CODE",{});var Kk=i(hl);Rg=n(Kk,"aggregation_labels"),Kk.forEach(s),Ss.forEach(s),Ec.forEach(s),Cr.forEach(s),yc.forEach(s),zd=p(t),pe=r(t,"P",{});var Ie=i(pe);Wo=r(Ie,"A",{href:!0});var Yk=i(Wo);Vg=n(Yk,"TapasTokenizer"),Yk.forEach(s),Kg=n(Ie," creates the "),ul=r(Ie,"CODE",{});var Jk=i(ul);Yg=n(Jk,"labels"),Jk.forEach(s),Jg=n(Ie,", "),ml=r(Ie,"CODE",{});var Xk=i(ml);Xg=n(Xk,"numeric_values"),Xk.forEach(s),Zg=n(Ie," and "),gl=r(Ie,"CODE",{});var Zk=i(gl);ef=n(Zk,"numeric_values_scale"),Zk.forEach(s),sf=n(Ie," based on the "),fl=r(Ie,"CODE",{});var ej=i(fl);tf=n(ej,"answer_coordinates"),ej.forEach(s),af=n(Ie," and "),_l=r(Ie,"CODE",{});var sj=i(_l);nf=n(sj,"answer_text"),sj.forEach(s),of=n(Ie," columns of the TSV file. The "),Tl=r(Ie,"CODE",{});var tj=i(Tl);rf=n(tj,"float_answer"),tj.forEach(s),lf=n(Ie," and "),bl=r(Ie,"CODE",{});var aj=i(bl);pf=n(aj,"aggregation_labels"),aj.forEach(s),df=n(Ie," are already in the TSV file of step 2. Here\u2019s an example:"),Ie.forEach(s),xd=p(t),v(La.$$.fragment,t),Cd=p(t),bs=r(t,"P",{});var ma=i(bs);cf=n(ma,"Note that "),Uo=r(ma,"A",{href:!0});var nj=i(Uo);hf=n(nj,"TapasTokenizer"),nj.forEach(s),uf=n(ma," expects the data of the table to be "),vl=r(ma,"STRONG",{});var oj=i(vl);mf=n(oj,"text-only"),oj.forEach(s),gf=n(ma,". You can use "),wl=r(ma,"CODE",{});var rj=i(wl);ff=n(rj,".astype(str)"),rj.forEach(s),_f=n(ma,` on a dataframe to turn it into text-only data.
...
question tokens, special tokens and padding.`),mq.forEach(s),us.forEach(s),$T=p(Be),tr=r(Be,"P",{});var B1=i(tr);ar=r(B1,"A",{href:!0});var gq=i(ar);zT=n(gq,"TapasTokenizer"),gq.forEach(s),xT=n(B1,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),B1.forEach(s),CT=p(Be),Ut=r(Be,"DIV",{class:!0});var Sc=i(Ut);v(an.$$.fragment,Sc),MT=p(Sc),pp=r(Sc,"P",{});var fq=i(pp);PT=n(fq,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),fq.forEach(s),Sc.forEach(s),ST=p(Be),Ps=r(Be,"DIV",{class:!0});var Pr=i(Ps);v(nn.$$.fragment,Pr),DT=p(Pr),on=r(Pr,"P",{});var Dc=i(on);NT=n(Dc,"Converts logits of "),nr=r(Dc,"A",{href:!0});var _q=i(nr);LT=n(_q,"TapasForQuestionAnswering"),_q.forEach(s),QT=n(Dc,` to actual predicted answer coordinates and optional
