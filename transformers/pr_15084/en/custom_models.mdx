...
`AwesomeModel` should subclass [PreTrainedModel](/docs/transformers/pr_15084/en/main_classes/model#transformers.PreTrainedModel) and `AwesomeConfig` should subclass [PretrainedConfig](/docs/transformers/pr_15084/en/main_classes/configuration#transformers.PretrainedConfig). The
...
[AutoConfig](/docs/transformers/pr_15084/en/model_doc/auto#transformers.AutoConfig)) but it's different for models. Your custom model could be suitable for sequence classification (in
