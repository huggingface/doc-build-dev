...
<span class="hljs-meta">&gt;&gt;&gt; </span>squad = load_dataset(<span class="hljs-string">&quot;squad&quot;</span>)`}}),_s=new C({props:{codee:'squad["train"][0],',highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>squad[<span class="hljs-string">&quot;train&quot;</span>][<span class="hljs-number">0</span>]
...
}`}}),gs=new Nt({}),ws=new Bo({props:{id:"qgaM0weJHpA"}}),js=new C({props:{codee:`from transformers import AutoTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer = AutoTokenizer.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>)`}}),vs=new C({props:{codee:`def preprocess_function(examples):
...
<span class="hljs-meta">&gt;&gt;&gt; </span>data_collator = DefaultDataCollator(return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)`}}}),ks=new Nt({}),ys=new C({props:{codee:`from transformers import AutoModelForQuestionAnswering, TrainingArguments, Trainer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = AutoModelForQuestionAnswering.from_pretrained(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>)`}}),ts=new He({props:{$$slots:{default:[Jo]},$$scope:{ctx:F}}}),Ds=new C({props:{codee:`training_args = TrainingArguments(
    output_dir="./results",
...
<span class="hljs-meta">&gt;&gt;&gt; </span>trainer.train()`}}),zs=new Nt({}),as=new He({props:{$$slots:{default:[Go]},$$scope:{ctx:F}}}),Fs=new C({props:{codee:`tf_train_set = tokenized_squad["train"].to_tf_dataset(
...
<span class="hljs-meta">... </span>    batch_size=<span class="hljs-number">16</span>,
<span class="hljs-meta">... </span>    collate_fn=data_collator,
<span class="hljs-meta">... </span>)`}}),Ps=new C({props:{codee:`from transformers import create_optimizer
...
<span class="hljs-meta">... </span>)`}}),Ss=new C({props:{codee:`from transformers import TFAutoModelForQuestionAnswering
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFAutoModelForQuestionAnswering(<span class="hljs-string">&quot;distilbert-base-uncased&quot;</span>)`}}),Qs=new C({props:{codee:`import tensorflow as tf
