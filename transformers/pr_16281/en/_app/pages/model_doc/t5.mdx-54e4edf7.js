...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16281/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Us=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16281/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16281/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16281/src/transformers/models/t5/modeling_t5.py#L1808",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16281/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16281/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16281/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16281/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
for summarization: `),U=s(Nr,"EM",{});var o1=a(U);Oe=i(o1,"summarize: \u2026"),o1.forEach(t),m=i(Nr,"."),Nr.forEach(t),t1.forEach(t),j=l(Ir),te=s(Ir,"LI",{});var s1=a(te);Se=s(s1,"P",{});var a1=a(Se);pt=i(a1,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),a1.forEach(t),s1.forEach(t),D=l(Ir),Ge=s(Ir,"LI",{});var r1=a(Ge);ne=s(r1,"P",{});var io=a(ne);ht=i(io,"See the "),A=s(io,"A",{href:!0});var i1=a(A);Y=i(i1,"training"),i1.forEach(t),ut=i(io,", "),Ae=s(io,"A",{href:!0});var d1=a(Ae);Z=i(d1,"inference"),d1.forEach(t),mt=i(io," and "),Le=s(io,"A",{href:!0});var l1=a(Le);Ie=i(l1,"scripts"),l1.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),r1.forEach(t),Ir.forEach(t),Vl=l(n),Xa=s(n,"P",{});var c1=a(Xa);Dp=i(c1,"T5 comes in different sizes:"),c1.forEach(t),Kl=l(n),Be=s(n,"UL",{});var At=a(Be);di=s(At,"LI",{});var p1=a(di);li=s(p1,"P",{});var h1=a(li);To=s(h1,"A",{href:!0,rel:!0});var u1=a(To);Sp=i(u1,"t5-small"),u1.forEach(t),h1.forEach(t),p1.forEach(t),Gp=l(At),ci=s(At,"LI",{});var m1=a(ci);pi=s(m1,"P",{});var f1=a(pi);vo=s(f1,"A",{href:!0,rel:!0});var _1=a(vo);Bp=i(_1,"t5-base"),_1.forEach(t),f1.forEach(t),m1.forEach(t),Wp=l(At),hi=s(At,"LI",{});var g1=a(hi);ui=s(g1,"P",{});var T1=a(ui);ko=s(T1,"A",{href:!0,rel:!0});var v1=a(ko);Up=i(v1,"t5-large"),v1.forEach(t),T1.forEach(t),g1.forEach(t),Rp=l(At),mi=s(At,"LI",{});var k1=a(mi);fi=s(k1,"P",{});var b1=a(fi);bo=s(b1,"A",{href:!0,rel:!0});var y1=a(bo);Hp=i(y1,"t5-3b"),y1.forEach(t),b1.forEach(t),k1.forEach(t),Vp=l(At),_i=s(At,"LI",{});var w1=a(_i);Qa=s(w1,"P",{});var Vk=a(Qa);yo=s(Vk,"A",{href:!0,rel:!0});var x1=a(yo);Kp=i(x1,"t5-11b"),x1.forEach(t),Yp=i(Vk,"."),Vk.forEach(t),w1.forEach(t),At.forEach(t),Yl=l(n),er=s(n,"P",{});var z1=a(er);Zp=i(z1,"Based on the original T5 model, Google has released some follow-up works:"),z1.forEach(t),Zl=l(n),$t=s(n,"UL",{});var Dr=a($t);gi=s(Dr,"LI",{});var $1=a(gi);zn=s($1,"P",{});var Ul=a(zn);Ti=s(Ul,"STRONG",{});var q1=a(Ti);Jp=i(q1,"T5v1.1"),q1.forEach(t),Xp=i(Ul,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var O1=a(or);lh=i(O1,"here"),O1.forEach(t),ch=i(Hl,"."),Hl.forEach(t),P1.forEach(t),Dr.forEach(t),Jl=l(n),En=s(n,"P",{});var Bc=a(En);ph=i(Bc,"All checkpoints can be found on the "),wo=s(Bc,"A",{href:!0,rel:!0});var A1=a(wo);hh=i(A1,"hub"),A1.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var L1=a(xo);fh=i(L1,"thomwolf"),L1.forEach(t),_h=i(Sr,". The original code can be found "),zo=s(Sr,"A",{href:!0,rel:!0});var I1=a(zo);gh=i(I1,"here"),I1.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Wc=a(Zt);jn=s(Wc,"A",{id:!0,class:!0,href:!0});var N1=a(jn);wi=s(N1,"SPAN",{});var D1=a(wi);_($o.$$.fragment,D1),D1.forEach(t),N1.forEach(t),vh=l(Wc),xi=s(Wc,"SPAN",{});var S1=a(xi);kh=i(S1,"Training"),S1.forEach(t),Wc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),Uc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var Lt=a(dt);Ei=s(Lt,"P",{});var R1=a(Ei);Mh=i(R1,"Unsupervised denoising training"),R1.forEach(t),Ph=l(Lt),_e=s(Lt,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var H1=a(ji);Oh=i(H1,"a.k.a"),H1.forEach(t),Ah=i(tt,` unique mask tokens) and
...
`),rr=s(tt,"A",{href:!0});var J1=a(rr);Uh=i(J1,"T5Tokenizer"),J1.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(Lt),Oi=s(Lt,"P",{});var X1=a(Oi);Vh=i(X1,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
