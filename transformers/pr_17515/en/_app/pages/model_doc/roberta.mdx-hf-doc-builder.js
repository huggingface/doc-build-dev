...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17515/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17515/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17515/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_17515/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17515/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17515/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17515/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17515/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17515/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17515/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),by=h(It),T(us.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vy=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yy=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);Ty=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$y=i(Xx,"__call__"),Xx.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(mo),T(gs.$$.fragment,mo),Ry=h(mo),T(_s.$$.fragment,mo),My=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);T(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),Ey=h(Mu),Mp=s(Mu,"SPAN",{});var e5=a(Mp);zy=i(e5,"TFRobertaForMultipleChoice"),e5.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var t5=a(Ep);Cy=i(t5,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t5.forEach(t),jy=h(Dt),ni=s(Dt,"P",{});var Eu=a(ni);Py=i(Eu,"This model inherits from "),xd=s(Eu,"A",{href:!0});var o5=a(xd);Ly=i(o5,"TFPreTrainedModel"),o5.forEach(t),Ay=i(Eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eu.forEach(t),Oy=h(Dt),si=s(Dt,"P",{});var zu=a(si);Ny=i(zu,"This model is also a "),ai=s(zu,"A",{href:!0,rel:!0});var n5=a(ai);Iy=i(n5,"tf.keras.Model"),n5.forEach(t),Dy=i(zu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),Sy=h(Dt),T(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s5=a(Rd);Hy=i(s5,"TFRobertaForMultipleChoice"),s5.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a5=a(zp);Jy=i(a5,"__call__"),a5.forEach(t),Vy=i(ec," special method."),ec.forEach(t),Ky=h(aa),T(ys.$$.fragment,aa),Gy=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var r5=a(ws);qp=s(r5,"SPAN",{});var i5=a(qp);T(ii.$$.fragment,i5),i5.forEach(t),r5.forEach(t),Xy=h(qu),Cp=s(qu,"SPAN",{});var l5=a(Cp);Yy=i(l5,"TFRobertaForTokenClassification"),l5.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var d5=a(jp);eT=i(d5,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d5.forEach(t),tT=h(St),di=s(St,"P",{});var Cu=a(di);oT=i(Cu,"This model inherits from "),Md=s(Cu,"A",{href:!0});var c5=a(Md);nT=i(c5,"TFPreTrainedModel"),c5.forEach(t),sT=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),aT=h(St),ci=s(St,"P",{});var ju=a(ci);rT=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var p5=a(pi);iT=i(p5,"tf.keras.Model"),p5.forEach(t),lT=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dT=h(St),T($s.$$.fragment,St),cT=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);T(hi.$$.fragment,fo),pT=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hT=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h5=a(Ed);mT=i(h5,"TFRobertaForTokenClassification"),h5.forEach(t),fT=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var m5=a(Pp);uT=i(m5,"__call__"),m5.forEach(t),gT=i(tc," special method."),tc.forEach(t),_T=h(fo),T(Fs.$$.fragment,fo),bT=h(fo),T(xs.$$.fragment,fo),kT=h(fo),T(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var f5=a(Ms);Lp=s(f5,"SPAN",{});var u5=a(Lp);T(mi.$$.fragment,u5),u5.forEach(t),f5.forEach(t),vT=h(Pu),Ap=s(Pu,"SPAN",{});var g5=a(Ap);yT=i(g5,"TFRobertaForQuestionAnswering"),g5.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);T(fi.$$.fragment,Wt),TT=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wT=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _5=a(Op);$T=i(_5,"span start logits"),_5.forEach(t),FT=i(oc," and "),Np=s(oc,"CODE",{});var b5=a(Np);xT=i(b5,"span end logits"),b5.forEach(t),RT=i(oc,")."),oc.forEach(t),MT=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);ET=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var k5=a(zd);zT=i(k5,"TFPreTrainedModel"),k5.forEach(t),qT=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),CT=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jT=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var v5=a(_i);PT=i(v5,"tf.keras.Model"),v5.forEach(t),LT=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),AT=h(Wt),T(Es.$$.fragment,Wt),OT=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),NT=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);IT=i(nc,"The "),qd=s(nc,"A",{href:!0});var y5=a(qd);DT=i(y5,"TFRobertaForQuestionAnswering"),y5.forEach(t),ST=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var T5=a(Ip);WT=i(T5,"__call__"),T5.forEach(t),BT=i(nc," special method."),nc.forEach(t),UT=h(uo),T(zs.$$.fragment,uo),HT=h(uo),T(qs.$$.fragment,uo),QT=h(uo),T(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var w5=a(js);Dp=s(w5,"SPAN",{});var $5=a(Dp);T(ki.$$.fragment,$5),$5.forEach(t),w5.forEach(t),JT=h(Ou),Sp=s(Ou,"SPAN",{});var F5=a(Sp);VT=i(F5,"FlaxRobertaModel"),F5.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),KT=h(gt),Wp=s(gt,"P",{});var x5=a(Wp);GT=i(x5,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x5.forEach(t),XT=h(gt),yi=s(gt,"P",{});var Nu=a(yi);YT=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var R5=a(Cd);ZT=i(R5,"FlaxPreTrainedModel"),R5.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),tw=h(gt),Ti=s(gt,"P",{});var Iu=a(Ti);ow=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var M5=a(wi);nw=i(M5,"flax.linen.Module"),M5.forEach(t),sw=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),aw=h(gt),Bp=s(gt,"P",{});var E5=a(Bp);rw=i(E5,"Finally, this model supports inherent JAX features such as:"),E5.forEach(t),iw=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var z5=a(Up);$i=s(z5,"A",{href:!0,rel:!0});var q5=a($i);lw=i(q5,"Just-In-Time (JIT) compilation"),q5.forEach(t),z5.forEach(t),dw=h(ra),Hp=s(ra,"LI",{});var C5=a(Hp);Fi=s(C5,"A",{href:!0,rel:!0});var j5=a(Fi);cw=i(j5,"Automatic Differentiation"),j5.forEach(t),C5.forEach(t),pw=h(ra),Qp=s(ra,"LI",{});var P5=a(Qp);xi=s(P5,"A",{href:!0,rel:!0});var L5=a(xi);hw=i(L5,"Vectorization"),L5.forEach(t),P5.forEach(t),mw=h(ra),Jp=s(ra,"LI",{});var A5=a(Jp);Ri=s(A5,"A",{href:!0,rel:!0});var O5=a(Ri);fw=i(O5,"Parallelization"),O5.forEach(t),A5.forEach(t),ra.forEach(t),uw=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);T(Mi.$$.fragment,ia),gw=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_w=i(sc,"The "),Vp=s(sc,"CODE",{});var N5=a(Vp);bw=i(N5,"FlaxRobertaPreTrainedModel"),N5.forEach(t),kw=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var I5=a(Kp);vw=i(I5,"__call__"),I5.forEach(t),yw=i(sc," special method."),sc.forEach(t),Tw=h(ia),T(Ps.$$.fragment,ia),ww=h(ia),T(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var D5=a(As);Gp=s(D5,"SPAN",{});var S5=a(Gp);T(Ei.$$.fragment,S5),S5.forEach(t),D5.forEach(t),$w=h(Du),Xp=s(Du,"SPAN",{});var W5=a(Xp);Fw=i(W5,"FlaxRobertaForCausalLM"),W5.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);T(zi.$$.fragment,_t),xw=h(_t),Yp=s(_t,"P",{});var B5=a(Yp);Rw=i(B5,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),B5.forEach(t),Mw=h(_t),qi=s(_t,"P",{});var Su=a(qi);Ew=i(Su,"This model inherits from "),jd=s(Su,"A",{href:!0});var U5=a(jd);zw=i(U5,"FlaxPreTrainedModel"),U5.forEach(t),qw=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Su.forEach(t),Cw=h(_t),Ci=s(_t,"P",{});var Wu=a(Ci);jw=i(Wu,"This model is also a Flax Linen "),ji=s(Wu,"A",{href:!0,rel:!0});var H5=a(ji);Pw=i(H5,"flax.linen.Module"),H5.forEach(t),Lw=i(Wu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),Aw=h(_t),Zp=s(_t,"P",{});var Q5=a(Zp);Ow=i(Q5,"Finally, this model supports inherent JAX features such as:"),Q5.forEach(t),Nw=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var J5=a(eh);Pi=s(J5,"A",{href:!0,rel:!0});var V5=a(Pi);Iw=i(V5,"Just-In-Time (JIT) compilation"),V5.forEach(t),J5.forEach(t),Dw=h(la),th=s(la,"LI",{});var K5=a(th);Li=s(K5,"A",{href:!0,rel:!0});var G5=a(Li);Sw=i(G5,"Automatic Differentiation"),G5.forEach(t),K5.forEach(t),Ww=h(la),oh=s(la,"LI",{});var X5=a(oh);Ai=s(X5,"A",{href:!0,rel:!0});var Y5=a(Ai);Bw=i(Y5,"Vectorization"),Y5.forEach(t),X5.forEach(t),Uw=h(la),nh=s(la,"LI",{});var Z5=a(nh);Oi=s(Z5,"A",{href:!0,rel:!0});var eR=a(Oi);Hw=i(eR,"Parallelization"),eR.forEach(t),Z5.forEach(t),la.forEach(t),Qw=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);T(Ni.$$.fragment,da),Jw=h(da),tn=s(da,"P",{});var ac=a(tn);Vw=i(ac,"The "),sh=s(ac,"CODE",{});var tR=a(sh);Kw=i(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),Gw=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oR=a(ah);Xw=i(oR,"__call__"),oR.forEach(t),Yw=i(ac," special method."),ac.forEach(t),Zw=h(da),T(Os.$$.fragment,da),e$=h(da),T(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nR=a(Is);rh=s(nR,"SPAN",{});var sR=a(rh);T(Ii.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t$=h(Bu),ih=s(Bu,"SPAN",{});var aR=a(ih);o$=i(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Bu.forEach(t),qf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);T(Di.$$.fragment,bt),n$=h(bt),Si=s(bt,"P",{});var Uu=a(Si);s$=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rR=a(lh);a$=i(rR,"language modeling"),rR.forEach(t),r$=i(Uu," head on top."),Uu.forEach(t),i$=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);l$=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iR=a(Pd);d$=i(iR,"FlaxPreTrainedModel"),iR.forEach(t),c$=i(Hu,`. Check the superclass documentation for the generic methods the
