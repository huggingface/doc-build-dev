import{S as hh,i as uh,s as fh,e as a,k as c,w as T,t as n,M as mh,c as r,d as t,m as l,a as i,x as v,h as s,b as d,F as e,g as h,y as x,q as k,o as b,B as y,v as _h}from"../../chunks/vendor-6b77c823.js";import{T as Yt}from"../../chunks/Tip-39098574.js";import{D}from"../../chunks/Docstring-af1d0ae0.js";import{C as ln}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as We}from"../../chunks/IconCopyLink-7a11ce68.js";function gh(U){let p,q,m,g,S,_,w,$;return{c(){p=a("p"),q=n(`This class method is simply calling the feature extractor
...
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(f,F){h(f,p,F),e(p,q),h(f,m,F),h(f,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),h(f,z,F),h(f,E,F),e(E,N),e(E,H),e(H,ee),e(E,Fe),e(E,B),e(B,Ce),e(E,$e),h(f,M,F),h(f,J,F),e(J,te),h(f,ye,F),h(f,P,F),e(P,j),e(j,Pe),e(j,oe),e(oe,ne),e(j,je),e(j,se),e(se,ae),e(P,Me),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(p),f&&t(m),f&&t(g),f&&t(z),f&&t(E),f&&t(M),f&&t(J),f&&t(ye),f&&t(P)}}}function bh(U){let p,q,m,g,S;return{c(){p=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=r(_,"P",{});var w=i(p);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(w,"CODE",{});var $=i(m);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),at.forEach(t),ye=l(f),P=r(f,"UL",{});var G=i(P);j=r(G,"LI",{});var ce=i(j);Pe=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var rt=i(oe);ne=s(rt,"input_ids"),rt.forEach(t),je=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Ue=i(se);ae=s(Ue,"model(input_ids)"),Ue.forEach(t),ce.forEach(t),Me=l(G),O=r(G,"LI",{});var C=i(O);Ee=s(C,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(C,"CODE",{});var it=i(L);Ae=s(it,"model([input_ids, attention_mask])"),it.forEach(t),re=s(C," or "),ie=r(C,"CODE",{});var qe=i(ie);Ie=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),C.forEach(t),de=l(G),K=r(G,"LI",{});var Le=i(K);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(f,F){h(f,p,F),e(p,q),h(f,m,F),h(f,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),h(f,z,F),h(f,E,F),e(E,N),e(E,H),e(H,ee),e(E,Fe),e(E,B),e(B,Ce),e(E,$e),h(f,M,F),h(f,J,F),e(J,te),h(f,ye,F),h(f,P,F),e(P,j),e(j,Pe),e(j,oe),e(oe,ne),e(j,je),e(j,se),e(se,ae),e(P,Me),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(p),f&&t(m),f&&t(g),f&&t(z),f&&t(E),f&&t(M),f&&t(J),f&&t(ye),f&&t(P)}}}function wh(U){let p,q,m,g,S;return{c(){p=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=r(_,"P",{});var w=i(p);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(w,"CODE",{});var $=i(m);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){h(_,p,w),e(p,q),e(p,m),e(m,g),e(p,S)},d(_){_&&t(p)}}}function Sh(U){let p,q,m,g,S,_,w,$,A,z,E,N,H,ee,Fe,B,Ce,$e,M,J,te,ye,P,j,Pe,oe,ne,je,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,f,F,X,st,Ne,Q,Ve,_e,at,G,ce,rt,Ue,C,it,qe,Le,dt,pn,tr,or,hn,nr,sr,un,ar,rr,Zs,W,ir,Yn,dr,cr,Xn,lr,pr,Qn,hr,ur,Zn,fr,mr,es,_r,gr,Xt,Tr,vr,ts,xr,ea,fn,os,kr,ta,Qt,oa,mn,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,qr,rs,zr,Fr,is,Cr,Pr,ds,jr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,pe,no,Or,lt,Gr,_n,Wr,Vr,so,Ur,Rr,Hr,pt,Br,gn,Jr,Kr,Tn,Yr,Xr,Qr,ps,Zr,ei,ao,ia,ht,St,hs,ro,ti,us,oi,da,V,io,ni,fs,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,ms,pi,hi,Et,po,ui,ho,fi,_s,mi,_i,gi,Re,uo,Ti,xn,vi,kn,xi,ki,gs,bi,yi,bn,fo,ca,ut,qt,Ts,mo,wi,vs,Si,la,he,_o,$i,xs,Ei,qi,go,zi,yn,Fi,Ci,Pi,ks,ji,Mi,zt,To,Ai,bs,Ii,pa,ft,Ft,ys,vo,Di,ws,Ni,ha,I,xo,Li,Ss,Oi,Gi,ge,wn,Wi,Vi,Sn,Ui,Ri,$n,Hi,Bi,ko,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,Ct,bo,ed,Oe,td,yo,Es,od,nd,sd,qn,ad,rd,wo,qs,id,dd,cd,ld,He,So,pd,zs,hd,ud,Pt,fd,Be,$o,md,Eo,_d,zn,gd,Td,vd,jt,xd,Mt,qo,kd,zo,bd,Fn,yd,wd,Sd,At,Fo,$d,Co,Ed,Cn,qd,zd,Fd,It,Po,Cd,Fs,Pd,ua,mt,Dt,Cs,jo,jd,Ps,Md,fa,we,Mo,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Vd,Te,No,Ud,_t,Rd,jn,Hd,Bd,js,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,ma,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Vo,ic,Uo,dc,cc,lc,ve,Ro,pc,Tt,hc,An,uc,fc,Ds,mc,_c,gc,Ot,Tc,Ns,vc,xc,Ho,ga,vt,Gt,Ls,Bo,kc,Os,bc,Ta,ue,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,qc,Xo,zc,Fc,Cc,Wt,Pc,xe,Qo,jc,xt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Vt,Oc,Ws,Gc,Wc,Zo,va,kt,Ut,Vs,en,Vc,Us,Uc,xa,fe,tn,Rc,on,Hc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Rt,el,ke,an,tl,bt,ol,Ln,nl,sl,Rs,al,rl,il,Ht,dl,Hs,cl,ll,rn,ka;return _=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
avoid subtle bugs.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Speech2TextFeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16656/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
...
<a href="/docs/transformers/pr_16656/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both
<a href="/docs/transformers/pr_16656/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
<p>Indices can be obtained using <code>SpeechToTextTokenizer</code>. See <a href="/docs/transformers/pr_16656/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16656/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
>transformers.modeling_outputs.Seq2SeqLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16656/en/model_doc/speech_to_text#transformers.Speech2TextConfig"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16656/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new D({props:{name:"forward",anchor:"transformers.Speech2TextForConditionalGeneration.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16656/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1284",parametersDescription:[{anchor:"transformers.Speech2TextForConditionalGeneration.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a <code>numpy.ndarray</code>, <em>e.g.</em>
via the soundfile library (<code>pip install soundfile</code>). To prepare the array into <code>input_features</code>, the
<a href="/docs/transformers/pr_16656/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16656/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a>. See <a href="/docs/transformers/pr_16656/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16656/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
<p>A <a
  href="/docs/transformers/pr_16656/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16656/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
documentation from `),Tn=a("a"),Yr=n("PretrainedConfig"),Xr=n(" for more information."),Qr=c(),ps=a("p"),Zr=n("Example:"),ei=c(),T(ao.$$.fragment),ia=c(),ht=a("h2"),St=a("a"),hs=a("span"),T(ro.$$.fragment),ti=c(),us=a("span"),oi=n("Speech2TextTokenizer"),da=c(),V=a("div"),T(io.$$.fragment),ni=c(),fs=a("p"),si=n("Construct an Speech2Text tokenizer."),ai=c(),co=a("p"),ri=n("This tokenizer inherits from "),vn=a("a"),ii=n("PreTrainedTokenizer"),di=n(` which contains some of the main methods. Users should refer to
...
special tokens using the tokenizer `),_s=a("code"),mi=n("prepare_for_model"),_i=n(" method."),gi=c(),Re=a("div"),T(uo.$$.fragment),Ti=c(),xn=a("p"),vi=n("Create the token type IDs corresponding to the sequences passed. "),kn=a("a"),xi=n(`What are token type
...
information.`),Zi=c(),Ct=a("div"),T(bo.$$.fragment),ed=c(),Oe=a("p"),td=n(`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),ld=c(),He=a("div"),T(So.$$.fragment),pd=c(),zs=a("p"),hd=n("Instantiate a processor associated with a pretrained model."),ud=c(),T(Pt.$$.fragment),fd=c(),Be=a("div"),T($o.$$.fragment),md=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=a("a"),gd=n("from_pretrained()"),Td=n(" method."),vd=c(),T(jt.$$.fragment),xd=c(),Mt=a("div"),T(qo.$$.fragment),kd=c(),zo=a("p"),bd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=a("a"),yd=n("batch_decode()"),wd=n(`. Please
...
Speech2Text.`),ua=c(),mt=a("h2"),Dt=a("a"),Cs=a("span"),T(jo.$$.fragment),jd=c(),Ps=a("span"),Md=n("Speech2TextModel"),fa=c(),we=a("div"),T(Mo.$$.fragment),Ad=c(),Ao=a("p"),Id=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Vd=c(),Te=a("div"),T(No.$$.fragment),Ud=c(),_t=a("p"),Rd=n("The "),jn=a("a"),Hd=n("Speech2TextModel"),Bd=n(" forward method, overrides the "),js=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),T(Nt.$$.fragment),Xd=c(),Ms=a("p"),Qd=n("Example:"),Zd=c(),T(Lo.$$.fragment),ma=c(),gt=a("h2"),Lt=a("a"),As=a("span"),T(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),T(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),ve=a("div"),T(Ro.$$.fragment),pc=c(),Tt=a("p"),hc=n("The "),An=a("a"),uc=n("Speech2TextForConditionalGeneration"),fc=n(" forward method, overrides the "),Ds=a("code"),mc=n("__call__"),_c=n(" special method."),gc=c(),T(Ot.$$.fragment),Tc=c(),Ns=a("p"),vc=n("Example:"),xc=c(),T(Ho.$$.fragment),ga=c(),vt=a("h2"),Gt=a("a"),Ls=a("span"),T(Bo.$$.fragment),kc=c(),Os=a("span"),bc=n("TFSpeech2TextModel"),Ta=c(),ue=a("div"),T(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
behavior.`),Cc=c(),T(Wt.$$.fragment),Pc=c(),xe=a("div"),T(Qo.$$.fragment),jc=c(),xt=a("p"),Mc=n("The "),Dn=a("a"),Ac=n("TFSpeech2TextModel"),Ic=n(" forward method, overrides the "),Gs=a("code"),Dc=n("__call__"),Nc=n(" special method."),Lc=c(),T(Vt.$$.fragment),Oc=c(),Ws=a("p"),Gc=n("Example:"),Wc=c(),T(Zo.$$.fragment),va=c(),kt=a("h2"),Ut=a("a"),Vs=a("span"),T(en.$$.fragment),Vc=c(),Us=a("span"),Uc=n("TFSpeech2TextForConditionalGeneration"),xa=c(),fe=a("div"),T(tn.$$.fragment),Rc=c(),on=a("p"),Hc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
install those packages before running the examples. You could either install those as extra speech dependencies with
`),Qn=r(me,"CODE",{});var Cl=i(Qn);hr=s(Cl,'pip install transformers"[speech, sentencepiece]"'),Cl.forEach(t),ur=s(me," or install the packages seperately with "),Zn=r(me,"CODE",{});var Pl=i(Zn);fr=s(Pl,"pip install torchaudio sentencepiece"),Pl.forEach(t),mr=s(me,". Also "),es=r(me,"CODE",{});var jl=i(es);_r=s(jl,"torchaudio"),jl.forEach(t),gr=s(me," requires the development version of the "),Xt=r(me,"A",{href:!0,rel:!0});var Ml=i(Xt);Tr=s(Ml,"libsndfile"),Ml.forEach(t),vr=s(me,` package which can be installed via a system package manager. On Ubuntu it can
...
information.`),Ge.forEach(t),Zi=l(R),Ct=r(R,"DIV",{class:!0});var Ia=i(Ct);v(bo.$$.fragment,Ia),ed=l(Ia),Oe=r(Ia,"P",{});var Bt=i(Oe);td=s(Bt,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),Bt.forEach(t),Ia.forEach(t),ld=l(R),He=r(R,"DIV",{class:!0});var Un=i(He);v(So.$$.fragment,Un),pd=l(Un),zs=r(Un,"P",{});var zp=i(zs);hd=s(zp,"Instantiate a processor associated with a pretrained model."),zp.forEach(t),ud=l(Un),v(Pt.$$.fragment,Un),Un.forEach(t),fd=l(R),Be=r(R,"DIV",{class:!0});var Rn=i(Be);v($o.$$.fragment,Rn),md=l(Rn),Eo=r(Rn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=r(Da,"A",{href:!0});var Fp=i(zn);gd=s(Fp,"from_pretrained()"),Fp.forEach(t),Td=s(Da," method."),Da.forEach(t),vd=l(Rn),v(jt.$$.fragment,Rn),Rn.forEach(t),xd=l(R),Mt=r(R,"DIV",{class:!0});var Na=i(Mt);v(qo.$$.fragment,Na),kd=l(Na),zo=r(Na,"P",{});var La=i(zo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var Cp=i(Fn);yd=s(Cp,"batch_decode()"),Cp.forEach(t),wd=s(La,`. Please
refer to the docstring of this method for more information.`),La.forEach(t),Na.forEach(t),Sd=l(R),At=r(R,"DIV",{class:!0});var Oa=i(At);v(Fo.$$.fragment,Oa),$d=l(Oa),Co=r(Oa,"P",{});var Ga=i(Co);Ed=s(Ga,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Cn=r(Ga,"A",{href:!0});var Pp=i(Cn);qd=s(Pp,"decode()"),Pp.forEach(t),zd=s(Ga,`. Please refer
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(R),It=r(R,"DIV",{class:!0});var Wa=i(It);v(Po.$$.fragment,Wa),Cd=l(Wa),Fs=r(Wa,"P",{});var jp=i(Fs);Pd=s(jp,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),jp.forEach(t),Wa.forEach(t),R.forEach(t),ua=l(o),mt=r(o,"H2",{class:!0});var Va=i(mt);Dt=r(Va,"A",{id:!0,class:!0,href:!0});var Mp=i(Dt);Cs=r(Mp,"SPAN",{});var Ap=i(Cs);v(jo.$$.fragment,Ap),Ap.forEach(t),Mp.forEach(t),jd=l(Va),Ps=r(Va,"SPAN",{});var Ip=i(Ps);Md=s(Ip,"Speech2TextModel"),Ip.forEach(t),Va.forEach(t),fa=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);v(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ua=i(Ao);Id=s(Ua,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Pn=r(Ua,"A",{href:!0});var Dp=i(Pn);Dd=s(Dp,"PreTrainedModel"),Dp.forEach(t),Nd=s(Ua,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ra.forEach(t),Vd=l(Jt),Te=r(Jt,"DIV",{class:!0});var Qe=i(Te);v(No.$$.fragment,Qe),Ud=l(Qe),_t=r(Qe,"P",{});var Hn=i(_t);Rd=s(Hn,"The "),jn=r(Hn,"A",{href:!0});var Lp=i(jn);Hd=s(Lp,"Speech2TextModel"),Lp.forEach(t),Bd=s(Hn," forward method, overrides the "),js=r(Hn,"CODE",{});var Op=i(js);Jd=s(Op,"__call__"),Op.forEach(t),Kd=s(Hn," special method."),Hn.forEach(t),Yd=l(Qe),v(Nt.$$.fragment,Qe),Xd=l(Qe),Ms=r(Qe,"P",{});var Gp=i(Ms);Qd=s(Gp,"Example:"),Gp.forEach(t),Zd=l(Qe),v(Lo.$$.fragment,Qe),Qe.forEach(t),Jt.forEach(t),ma=l(o),gt=r(o,"H2",{class:!0});var Ha=i(gt);Lt=r(Ha,"A",{id:!0,class:!0,href:!0});var Wp=i(Lt);As=r(Wp,"SPAN",{});var Vp=i(As);v(Oo.$$.fragment,Vp),Vp.forEach(t),Wp.forEach(t),ec=l(Ha),Is=r(Ha,"SPAN",{});var Up=i(Is);tc=s(Up,"Speech2TextForConditionalGeneration"),Up.forEach(t),Ha.forEach(t),_a=l(o),Se=r(o,"DIV",{class:!0});var Kt=i(Se);v(Go.$$.fragment,Kt),oc=l(Kt),Wo=r(Kt,"P",{});var Ba=i(Wo);nc=s(Ba,`The Speech2Text Model with a language modeling head. Can be used for summarization.
