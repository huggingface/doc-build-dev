...
All models have outputs that are instances of subclasses of [ModelOutput](/docs/transformers/pr_15268/en/main_classes/output#transformers.file_utils.ModelOutput). Those are
...
The `outputs` object is a [SequenceClassifierOutput](/docs/transformers/pr_15268/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput), as we can see in the
...
<docstring><name>class transformers.file\_utils.ModelOutput</name><anchor>transformers.file_utils.ModelOutput</anchor><source>https://github.com/huggingface/transformers/blob/pr_15268/src/transformers/file_utils.py#L2285</source><parameters>""</parameters></docstring>
...
You can't unpack a `ModelOutput` directly. Use the [to_tuple()](/docs/transformers/pr_15268/en/main_classes/output#transformers.file_utils.ModelOutput.to_tuple) method to convert it to a
tuple before.
...
<div class="docstring">
<docstring><name>to\_tuple</name><anchor>transformers.file_utils.ModelOutput.to_tuple</anchor><source>https://github.com/huggingface/transformers/blob/pr_15268/src/transformers/file_utils.py#L2374</source><parameters>[]</parameters></docstring>
...
<div class="docstring">
<docstring><name>replace</name><anchor>None</anchor><source>https://github.com/huggingface/transformers/blob/pr_15268/src/flax/struct.py#L120</source><parameters>[{"name": "**updates", "val": ""}]</parameters></docstring>
