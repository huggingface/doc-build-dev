...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_3/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_3/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_3/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
documentation alongside usage examples.`),wy=c(),pt=n("div"),T(Dr.$$.fragment),$y=c(),Xo=n("p"),My=r("The "),md=n("a"),Fy=r("TFRobertaForTokenClassification"),xy=r(" forward method, overrides the "),dp=n("code"),Ry=r("__call__"),Ly=r(" special method."),Ey=c(),T(ts.$$.fragment),zy=c(),T(os.$$.fragment),qy=c(),T(ns.$$.fragment),Em=c(),Po=n("h2"),ss=n("a"),cp=n("span"),T(Sr.$$.fragment),Cy=c(),pp=n("span"),jy=r("TFXLMRobertaForQuestionAnswering"),zm=c(),Be=n("div"),T(Br.$$.fragment),Xy=c(),Ao=n("p"),Py=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=n("code"),Ay=r("span start logits"),Oy=r(" and "),mp=n("code"),Ny=r("span end logits"),Iy=r(")."),Dy=c(),Wr=n("p"),Sy=r("This model inherits from "),ud=n("a"),By=r("TFPreTrainedModel"),Wy=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
usage examples.`),jw=c(),Rt=n("div"),T(ai.$$.fragment),Xw=c(),Io=n("p"),Pw=r("The "),wp=n("code"),Aw=r("FlaxRobertaPreTrainedModel"),Ow=r(" forward method, overrides the "),$p=n("code"),Nw=r("__call__"),Iw=r(" special method."),Dw=c(),T(cs.$$.fragment),Sw=c(),T(ps.$$.fragment),jm=c(),Do=n("h2"),hs=n("a"),Mp=n("span"),T(ri.$$.fragment),Bw=c(),Fp=n("span"),Ww=r("FlaxXLMRobertaForMaskedLM"),Xm=c(),Ue=n("div"),T(ii.$$.fragment),Uw=c(),So=n("p"),Qw=r("XLM-RoBERTa Model with a "),xp=n("code"),Hw=r("language modeling"),Vw=r(` head on top.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t$=c(),Rp=n("p"),o$=r("Finally, this model supports inherent JAX features such as:"),n$=c(),Bt=n("ul"),Lp=n("li"),ci=n("a"),s$=r("Just-In-Time (JIT) compilation"),a$=c(),Ep=n("li"),pi=n("a"),r$=r("Automatic Differentiation"),i$=c(),zp=n("li"),hi=n("a"),l$=r("Vectorization"),d$=c(),qp=n("li"),mi=n("a"),c$=r("Parallelization"),p$=c(),ui=n("p"),h$=r("This class overrides "),kd=n("a"),m$=r("FlaxRobertaForMaskedLM"),u$=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),f$=c(),Lt=n("div"),T(fi.$$.fragment),g$=c(),Bo=n("p"),_$=r("The "),Cp=n("code"),b$=r("FlaxRobertaPreTrainedModel"),k$=r(" forward method, overrides the "),jp=n("code"),v$=r("__call__"),T$=r(" special method."),y$=c(),T(ms.$$.fragment),w$=c(),T(us.$$.fragment),Pm=c(),Wo=n("h2"),fs=n("a"),Xp=n("span"),T(gi.$$.fragment),$$=c(),Pp=n("span"),M$=r("FlaxXLMRobertaForSequenceClassification"),Am=c(),Ce=n("div"),T(_i.$$.fragment),F$=c(),Ap=n("p"),x$=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P$=c(),Op=n("p"),A$=r("Finally, this model supports inherent JAX features such as:"),O$=c(),Wt=n("ul"),Np=n("li"),Ti=n("a"),N$=r("Just-In-Time (JIT) compilation"),I$=c(),Ip=n("li"),yi=n("a"),D$=r("Automatic Differentiation"),S$=c(),Dp=n("li"),wi=n("a"),B$=r("Vectorization"),W$=c(),Sp=n("li"),$i=n("a"),U$=r("Parallelization"),Q$=c(),Mi=n("p"),H$=r("This class overrides "),Td=n("a"),V$=r("FlaxRobertaForSequenceClassification"),J$=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),K$=c(),Et=n("div"),T(Fi.$$.fragment),G$=c(),Uo=n("p"),Y$=r("The "),Bp=n("code"),Z$=r("FlaxRobertaPreTrainedModel"),e1=r(" forward method, overrides the "),Wp=n("code"),t1=r("__call__"),o1=r(" special method."),n1=c(),T(gs.$$.fragment),s1=c(),T(_s.$$.fragment),Om=c(),Qo=n("h2"),bs=n("a"),Up=n("span"),T(xi.$$.fragment),a1=c(),Qp=n("span"),r1=r("FlaxXLMRobertaForMultipleChoice"),Nm=c(),je=n("div"),T(Ri.$$.fragment),i1=c(),Hp=n("p"),l1=r(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
documentation alongside usage examples.`),z1=c(),zt=n("div"),T(Ai.$$.fragment),q1=c(),Ho=n("p"),C1=r("The "),Zp=n("code"),j1=r("FlaxRobertaPreTrainedModel"),X1=r(" forward method, overrides the "),eh=n("code"),P1=r("__call__"),A1=r(" special method."),O1=c(),T(ks.$$.fragment),N1=c(),T(vs.$$.fragment),Im=c(),Vo=n("h2"),Ts=n("a"),th=n("span"),T(Oi.$$.fragment),I1=c(),oh=n("span"),D1=r("FlaxXLMRobertaForTokenClassification"),Dm=c(),Xe=n("div"),T(Ni.$$.fragment),S1=c(),nh=n("p"),B1=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),W1=c(),Ii=n("p"),U1=r("This model inherits from "),$d=n("a"),Q1=r("FlaxPreTrainedModel"),H1=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Y1=c(),sh=n("p"),Z1=r("Finally, this model supports inherent JAX features such as:"),eM=c(),Qt=n("ul"),ah=n("li"),Bi=n("a"),tM=r("Just-In-Time (JIT) compilation"),oM=c(),rh=n("li"),Wi=n("a"),nM=r("Automatic Differentiation"),sM=c(),ih=n("li"),Ui=n("a"),aM=r("Vectorization"),rM=c(),lh=n("li"),Qi=n("a"),iM=r("Parallelization"),lM=c(),Hi=n("p"),dM=r("This class overrides "),Md=n("a"),cM=r("FlaxRobertaForTokenClassification"),pM=r(`. Please check the superclass for the appropriate
...
for Named-Entity-Recognition (NER) tasks.`),f0.forEach(t),cy=p(bt),Ar=s(bt,"P",{});var Bu=a(Ar);py=i(Bu,"This model inherits from "),pd=s(Bu,"A",{href:!0});var g0=a(pd);hy=i(g0,"TFPreTrainedModel"),g0.forEach(t),my=i(Bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bu.forEach(t),uy=p(bt),Or=s(bt,"P",{});var Wu=a(Or);fy=i(Wu,"This model is also a "),Nr=s(Wu,"A",{href:!0,rel:!0});var _0=a(Nr);gy=i(_0,"tf.keras.Model"),_0.forEach(t),_y=i(Wu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wu.forEach(t),by=p(bt),y(es.$$.fragment,bt),ky=p(bt),Ir=s(bt,"P",{});var Uu=a(Ir);vy=i(Uu,"This class overrides "),hd=s(Uu,"A",{href:!0});var b0=a(hd);Ty=i(b0,"TFRobertaForTokenClassification"),b0.forEach(t),yy=i(Uu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Uu.forEach(t),wy=p(bt),pt=s(bt,"DIV",{class:!0});var so=a(pt);y(Dr.$$.fragment,so),$y=p(so),Xo=s(so,"P",{});var Bd=a(Xo);My=i(Bd,"The "),md=s(Bd,"A",{href:!0});var k0=a(md);Fy=i(k0,"TFRobertaForTokenClassification"),k0.forEach(t),xy=i(Bd," forward method, overrides the "),dp=s(Bd,"CODE",{});var v0=a(dp);Ry=i(v0,"__call__"),v0.forEach(t),Ly=i(Bd," special method."),Bd.forEach(t),Ey=p(so),y(ts.$$.fragment,so),zy=p(so),y(os.$$.fragment,so),qy=p(so),y(ns.$$.fragment,so),so.forEach(t),bt.forEach(t),Em=p(o),Po=s(o,"H2",{class:!0});var Qu=a(Po);ss=s(Qu,"A",{id:!0,class:!0,href:!0});var T0=a(ss);cp=s(T0,"SPAN",{});var y0=a(cp);y(Sr.$$.fragment,y0),y0.forEach(t),T0.forEach(t),Cy=p(Qu),pp=s(Qu,"SPAN",{});var w0=a(pp);jy=i(w0,"TFXLMRobertaForQuestionAnswering"),w0.forEach(t),Qu.forEach(t),zm=p(o),Be=s(o,"DIV",{class:!0});var kt=a(Be);y(Br.$$.fragment,kt),Xy=p(kt),Ao=s(kt,"P",{});var Wd=a(Ao);Py=i(Wd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Wd,"CODE",{});var $0=a(hp);Ay=i($0,"span start logits"),$0.forEach(t),Oy=i(Wd," and "),mp=s(Wd,"CODE",{});var M0=a(mp);Ny=i(M0,"span end logits"),M0.forEach(t),Iy=i(Wd,")."),Wd.forEach(t),Dy=p(kt),Wr=s(kt,"P",{});var Hu=a(Wr);Sy=i(Hu,"This model inherits from "),ud=s(Hu,"A",{href:!0});var F0=a(ud);By=i(F0,"TFPreTrainedModel"),F0.forEach(t),Wy=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),af.forEach(t),P$=p(tt),Op=s(tt,"P",{});var bx=a(Op);A$=i(bx,"Finally, this model supports inherent JAX features such as:"),bx.forEach(t),O$=p(tt),Wt=s(tt,"UL",{});var Ps=a(Wt);Np=s(Ps,"LI",{});var kx=a(Np);Ti=s(kx,"A",{href:!0,rel:!0});var vx=a(Ti);N$=i(vx,"Just-In-Time (JIT) compilation"),vx.forEach(t),kx.forEach(t),I$=p(Ps),Ip=s(Ps,"LI",{});var Tx=a(Ip);yi=s(Tx,"A",{href:!0,rel:!0});var yx=a(yi);D$=i(yx,"Automatic Differentiation"),yx.forEach(t),Tx.forEach(t),S$=p(Ps),Dp=s(Ps,"LI",{});var wx=a(Dp);wi=s(wx,"A",{href:!0,rel:!0});var $x=a(wi);B$=i($x,"Vectorization"),$x.forEach(t),wx.forEach(t),W$=p(Ps),Sp=s(Ps,"LI",{});var Mx=a(Sp);$i=s(Mx,"A",{href:!0,rel:!0});var Fx=a($i);U$=i(Fx,"Parallelization"),Fx.forEach(t),Mx.forEach(t),Ps.forEach(t),Q$=p(tt),Mi=s(tt,"P",{});var rf=a(Mi);H$=i(rf,"This class overrides "),Td=s(rf,"A",{href:!0});var xx=a(Td);V$=i(xx,"FlaxRobertaForSequenceClassification"),xx.forEach(t),J$=i(rf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),rf.forEach(t),K$=p(tt),Et=s(tt,"DIV",{class:!0});var As=a(Et);y(Fi.$$.fragment,As),G$=p(As),Uo=s(As,"P",{});var Jd=a(Uo);Y$=i(Jd,"The "),Bp=s(Jd,"CODE",{});var Rx=a(Bp);Z$=i(Rx,"FlaxRobertaPreTrainedModel"),Rx.forEach(t),e1=i(Jd," forward method, overrides the "),Wp=s(Jd,"CODE",{});var Lx=a(Wp);t1=i(Lx,"__call__"),Lx.forEach(t),o1=i(Jd," special method."),Jd.forEach(t),n1=p(As),y(gs.$$.fragment,As),s1=p(As),y(_s.$$.fragment,As),As.forEach(t),tt.forEach(t),Om=p(o),Qo=s(o,"H2",{class:!0});var lf=a(Qo);bs=s(lf,"A",{id:!0,class:!0,href:!0});var Ex=a(bs);Up=s(Ex,"SPAN",{});var zx=a(Up);y(xi.$$.fragment,zx),zx.forEach(t),Ex.forEach(t),a1=p(lf),Qp=s(lf,"SPAN",{});var qx=a(Qp);r1=i(qx,"FlaxXLMRobertaForMultipleChoice"),qx.forEach(t),lf.forEach(t),Nm=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Ri.$$.fragment,ot),i1=p(ot),Hp=s(ot,"P",{});var Cx=a(Hp);l1=i(Cx,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cf.forEach(t),_1=p(ot),Vp=s(ot,"P",{});var Px=a(Vp);b1=i(Px,"Finally, this model supports inherent JAX features such as:"),Px.forEach(t),k1=p(ot),Ut=s(ot,"UL",{});var Os=a(Ut);Jp=s(Os,"LI",{});var Ax=a(Jp);qi=s(Ax,"A",{href:!0,rel:!0});var Ox=a(qi);v1=i(Ox,"Just-In-Time (JIT) compilation"),Ox.forEach(t),Ax.forEach(t),T1=p(Os),Kp=s(Os,"LI",{});var Nx=a(Kp);Ci=s(Nx,"A",{href:!0,rel:!0});var Ix=a(Ci);y1=i(Ix,"Automatic Differentiation"),Ix.forEach(t),Nx.forEach(t),w1=p(Os),Gp=s(Os,"LI",{});var Dx=a(Gp);ji=s(Dx,"A",{href:!0,rel:!0});var Sx=a(ji);$1=i(Sx,"Vectorization"),Sx.forEach(t),Dx.forEach(t),M1=p(Os),Yp=s(Os,"LI",{});var Bx=a(Yp);Xi=s(Bx,"A",{href:!0,rel:!0});var Wx=a(Xi);F1=i(Wx,"Parallelization"),Wx.forEach(t),Bx.forEach(t),Os.forEach(t),x1=p(ot),Pi=s(ot,"P",{});var pf=a(Pi);R1=i(pf,"This class overrides "),wd=s(pf,"A",{href:!0});var Ux=a(wd);L1=i(Ux,"FlaxRobertaForMultipleChoice"),Ux.forEach(t),E1=i(pf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),pf.forEach(t),z1=p(ot),zt=s(ot,"DIV",{class:!0});var Ns=a(zt);y(Ai.$$.fragment,Ns),q1=p(Ns),Ho=s(Ns,"P",{});var Kd=a(Ho);C1=i(Kd,"The "),Zp=s(Kd,"CODE",{});var Qx=a(Zp);j1=i(Qx,"FlaxRobertaPreTrainedModel"),Qx.forEach(t),X1=i(Kd," forward method, overrides the "),eh=s(Kd,"CODE",{});var Hx=a(eh);P1=i(Hx,"__call__"),Hx.forEach(t),A1=i(Kd," special method."),Kd.forEach(t),O1=p(Ns),y(ks.$$.fragment,Ns),N1=p(Ns),y(vs.$$.fragment,Ns),Ns.forEach(t),ot.forEach(t),Im=p(o),Vo=s(o,"H2",{class:!0});var hf=a(Vo);Ts=s(hf,"A",{id:!0,class:!0,href:!0});var Vx=a(Ts);th=s(Vx,"SPAN",{});var Jx=a(th);y(Oi.$$.fragment,Jx),Jx.forEach(t),Vx.forEach(t),I1=p(hf),oh=s(hf,"SPAN",{});var Kx=a(oh);D1=i(Kx,"FlaxXLMRobertaForTokenClassification"),Kx.forEach(t),hf.forEach(t),Dm=p(o),Xe=s(o,"DIV",{class:!0});var nt=a(Xe);y(Ni.$$.fragment,nt),S1=p(nt),nh=s(nt,"P",{});var Gx=a(nh);B1=i(Gx,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Gx.forEach(t),W1=p(nt),Ii=s(nt,"P",{});var mf=a(Ii);U1=i(mf,"This model inherits from "),$d=s(mf,"A",{href:!0});var Yx=a($d);Q1=i(Yx,"FlaxPreTrainedModel"),Yx.forEach(t),H1=i(mf,`. Check the superclass documentation for the generic methods the
