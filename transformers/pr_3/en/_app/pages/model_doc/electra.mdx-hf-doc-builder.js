...
Whether or not to return a <a href="/docs/transformers/pr_3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/electra/modeling_electra.py#L837",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$1=p(kt),Bh=s(kt,"P",{});var I3=a(Bh);F1=i(I3,"Finally, this model supports inherent JAX features such as:"),I3.forEach(t),x1=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Rh=s(Ea,"LI",{});var D3=a(Rh);ml=s(D3,"A",{href:!0,rel:!0});var S3=a(ml);M1=i(S3,"Just-In-Time (JIT) compilation"),S3.forEach(t),D3.forEach(t),z1=p(Ea),Hh=s(Ea,"LI",{});var W3=a(Hh);ul=s(W3,"A",{href:!0,rel:!0});var U3=a(ul);j1=i(U3,"Automatic Differentiation"),U3.forEach(t),W3.forEach(t),C1=p(Ea),Qh=s(Ea,"LI",{});var B3=a(Qh);fl=s(B3,"A",{href:!0,rel:!0});var R3=a(fl);q1=i(R3,"Vectorization"),R3.forEach(t),B3.forEach(t),P1=p(Ea),Vh=s(Ea,"LI",{});var H3=a(Vh);gl=s(H3,"A",{href:!0,rel:!0});var Q3=a(gl);A1=i(Q3,"Parallelization"),Q3.forEach(t),H3.forEach(t),Ea.forEach(t),O1=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L1=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N1=i(Pc,"The "),Kh=s(Pc,"CODE",{});var V3=a(Kh);I1=i(V3,"FlaxElectraPreTrainedModel"),V3.forEach(t),D1=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var K3=a(Jh);S1=i(K3,"__call__"),K3.forEach(t),W1=i(Pc," special method."),Pc.forEach(t),U1=p(wa),y(Ks.$$.fragment,wa),B1=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var J3=a(Gs);Gh=s(J3,"SPAN",{});var G3=a(Gh);y(kl.$$.fragment,G3),G3.forEach(t),J3.forEach(t),R1=p(Og),Xh=s(Og,"SPAN",{});var X3=a(Xh);H1=i(X3,"FlaxElectraForSequenceClassification"),X3.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Q1=p(vt),Yh=s(vt,"P",{});var Y3=a(Yh);V1=i(Y3,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
