import{S as Fi,i as qi,s as zi,e as r,k as g,w,t as d,M as ji,c as i,d as t,m as _,a as l,x as $,h as c,b as f,N as Ci,G as e,g as b,y,q as v,o as T,B as Y,v as Oi,L as S}from"../../chunks/vendor-hf-doc-builder.js";import{T as ft}from"../../chunks/Tip-hf-doc-builder.js";import{D as A}from"../../chunks/Docstring-hf-doc-builder.js";import{C as P}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as we}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ai(M){let n,u,a,p,k;return p=new P({props:{code:`from transformers import YosoModel, YosoConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){w(n.$$.fragment)},l(a){$(n.$$.fragment,a)},m(a,p){y(n,a,p),u=!0},p:S,i(a){u||(v(n.$$.fragment,a),u=!0)},o(a){T(n.$$.fragment,a),u=!1},d(a){Y(n,a)}}}function Xi(M){let n,u,a,p,k,s,h,x,Hs,is,Z,$e,gt,oo,Qs,_t,Us,ls,X,Bs,to,Rs,Vs,Gs,ds,No,Ks,cs,Io,bt,Js,ps,Do,Zs,hs,R,kt,Xs,en,ee,on,wt,tn,sn,$t,nn,an,rn,oe,ln,yt,dn,cn,vt,pn,hn,ms,ye,zr,us,ve,mn,Wo,un,fn,fs,V,gn,so,_n,bn,no,kn,wn,gs,te,Te,Tt,ao,$n,Yt,yn,_s,O,ro,vn,se,Tn,Ho,Yn,Mn,io,xn,Fn,qn,ne,zn,Qo,jn,Cn,Uo,On,An,En,Ye,bs,ae,Me,Mt,lo,Sn,xt,Pn,ks,I,co,Ln,po,Nn,ho,In,Dn,Wn,L,mo,Hn,re,Qn,Bo,Un,Bn,Ft,Rn,Vn,Gn,xe,Kn,Fe,ws,ie,qe,qt,uo,Jn,zt,Zn,$s,D,fo,Xn,le,ea,jt,oa,ta,go,sa,na,aa,q,_o,ra,de,ia,Ro,la,da,Ct,ca,pa,ha,ze,ma,je,ua,Ce,ys,ce,Oe,Ot,bo,fa,At,ga,vs,W,ko,_a,wo,ba,$o,ka,wa,$a,F,yo,ya,pe,va,Vo,Ta,Ya,Et,Ma,xa,Fa,Ae,qa,Ee,za,Se,ja,Pe,Ca,Le,Ts,he,Ne,St,vo,Oa,Pt,Aa,Ys,H,To,Ea,Yo,Sa,Mo,Pa,La,Na,N,xo,Ia,me,Da,Go,Wa,Ha,Lt,Qa,Ua,Ba,Ie,Ra,De,Ms,ue,We,Nt,Fo,Va,It,Ga,xs,Q,qo,Ka,zo,Ja,jo,Za,Xa,er,z,Co,or,fe,tr,Ko,sr,nr,Dt,ar,rr,ir,He,lr,Qe,dr,Ue,Fs,ge,Be,Wt,Oo,cr,Ht,pr,qs,U,Ao,hr,B,mr,Qt,ur,fr,Ut,gr,_r,Eo,br,kr,wr,j,So,$r,_e,yr,Jo,vr,Tr,Bt,Yr,Mr,xr,Re,Fr,Ve,qr,Ge,zs;return s=new we({}),oo=new we({}),ao=new we({}),ro=new A({props:{name:"class transformers.YosoConfig",anchor:"transformers.YosoConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 4096"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_expectation",val:" = True"},{name:"hash_code_len",val:" = 9"},{name:"num_hash",val:" = 64"},{name:"conv_window",val:" = None"},{name:"use_fast_hash",val:" = True"},{name:"lsh_backward",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.YosoConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$a=g(),F=r("div"),w(yo.$$.fragment),ya=g(),pe=r("p"),va=d("The "),Vo=r("a"),Ta=d("YosoForSequenceClassification"),Ya=d(" forward method, overrides the "),Et=r("code"),Ma=d("__call__"),xa=d(" special method."),Fa=g(),w(Ae.$$.fragment),qa=g(),w(Ee.$$.fragment),za=g(),w(Se.$$.fragment),ja=g(),w(Pe.$$.fragment),Ca=g(),w(Le.$$.fragment),Ts=g(),he=r("h2"),Ne=r("a"),St=r("span"),w(vo.$$.fragment),Oa=g(),Pt=r("span"),Aa=d("YosoForMultipleChoice"),Ys=g(),H=r("div"),w(To.$$.fragment),Ea=g(),Yo=r("p"),Sa=d(`YOSO Model with a multiple choice classification head on top (a linear layer on top of
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ps.forEach(t),$a=_(it),F=i(it,"DIV",{class:!0});var C=l(F);$(yo.$$.fragment,C),ya=_(C),pe=i(C,"P",{});var lt=l(pe);va=c(lt,"The "),Vo=i(lt,"A",{href:!0});var ri=l(Vo);Ta=c(ri,"YosoForSequenceClassification"),ri.forEach(t),Ya=c(lt," forward method, overrides the "),Et=i(lt,"CODE",{});var ii=l(Et);Ma=c(ii,"__call__"),ii.forEach(t),xa=c(lt," special method."),lt.forEach(t),Fa=_(C),$(Ae.$$.fragment,C),qa=_(C),$(Ee.$$.fragment,C),za=_(C),$(Se.$$.fragment,C),ja=_(C),$(Pe.$$.fragment,C),Ca=_(C),$(Le.$$.fragment,C),C.forEach(t),it.forEach(t),Ts=_(o),he=i(o,"H2",{class:!0});var Ls=l(he);Ne=i(Ls,"A",{id:!0,class:!0,href:!0});var li=l(Ne);St=i(li,"SPAN",{});var di=l(St);$(vo.$$.fragment,di),di.forEach(t),li.forEach(t),Oa=_(Ls),Pt=i(Ls,"SPAN",{});var ci=l(Pt);Aa=c(ci,"YosoForMultipleChoice"),ci.forEach(t),Ls.forEach(t),Ys=_(o),H=i(o,"DIV",{class:!0});var dt=l(H);$(To.$$.fragment,dt),Ea=_(dt),Yo=i(dt,"P",{});var Ns=l(Yo);Sa=c(Ns,`YOSO Model with a multiple choice classification head on top (a linear layer on top of
the pooled output and a softmax) e.g. for RocStories/SWAG tasks.
