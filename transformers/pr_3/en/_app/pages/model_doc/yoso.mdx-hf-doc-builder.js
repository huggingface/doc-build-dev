import{S as Fi,i as qi,s as zi,e as r,k as g,w,t as d,M as ji,c as i,d as t,m as _,a as l,x as $,h as c,b as f,N as Ci,G as e,g as b,y as v,q as y,o as T,B as Y,v as Ai,L as S}from"../../chunks/vendor-hf-doc-builder.js";import{T as ft}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as P}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as we}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Oi(M){let n,u,a,p,k;return p=new P({props:{code:`from transformers import YosoModel, YosoConfig
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){w(n.$$.fragment)},l(a){$(n.$$.fragment,a)},m(a,p){v(n,a,p),u=!0},p:S,i(a){u||(y(n.$$.fragment,a),u=!0)},o(a){T(n.$$.fragment,a),u=!1},d(a){Y(n,a)}}}function Ui(M){let n,u,a,p,k;return{c(){n=r("p"),u=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),a=r("code"),p=d("Module"),k=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=i(s,"P",{});var h=l(n);u=c(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),a=i(h,"CODE",{});var x=l(a);p=c(x,"Module"),x.forEach(t),k=c(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){w(n.$$.fragment)},l(a){$(n.$$.fragment,a)},m(a,p){v(n,a,p),u=!0},p:S,i(a){u||(y(n.$$.fragment,a),u=!0)},o(a){T(n.$$.fragment,a),u=!1},d(a){Y(n,a)}}}function Xi(M){let n,u,a,p,k,s,h,x,Hs,is,Z,$e,gt,oo,Qs,_t,Us,ls,X,Bs,to,Rs,Vs,Gs,ds,No,Ks,cs,Io,bt,Js,ps,Do,Zs,hs,R,kt,Xs,en,ee,on,wt,tn,sn,$t,nn,an,rn,oe,ln,vt,dn,cn,yt,pn,hn,ms,ve,zr,us,ye,mn,Wo,un,fn,fs,V,gn,so,_n,bn,no,kn,wn,gs,te,Te,Tt,ao,$n,Yt,vn,_s,A,ro,yn,se,Tn,Ho,Yn,Mn,io,xn,Fn,qn,ne,zn,Qo,jn,Cn,Uo,An,On,En,Ye,bs,ae,Me,Mt,lo,Sn,xt,Pn,ks,I,co,Ln,po,Nn,ho,In,Dn,Wn,L,mo,Hn,re,Qn,Bo,Un,Bn,Ft,Rn,Vn,Gn,xe,Kn,Fe,ws,ie,qe,qt,uo,Jn,zt,Zn,$s,D,fo,Xn,le,ea,jt,oa,ta,go,sa,na,aa,q,_o,ra,de,ia,Ro,la,da,Ct,ca,pa,ha,ze,ma,je,ua,Ce,vs,ce,Ae,At,bo,fa,Ot,ga,ys,W,ko,_a,wo,ba,$o,ka,wa,$a,F,vo,va,pe,ya,Vo,Ta,Ya,Et,Ma,xa,Fa,Oe,qa,Ee,za,Se,ja,Pe,Ca,Le,Ts,he,Ne,St,yo,Aa,Pt,Oa,Ys,H,To,Ea,Yo,Sa,Mo,Pa,La,Na,N,xo,Ia,me,Da,Go,Wa,Ha,Lt,Qa,Ua,Ba,Ie,Ra,De,Ms,ue,We,Nt,Fo,Va,It,Ga,xs,Q,qo,Ka,zo,Ja,jo,Za,Xa,er,z,Co,or,fe,tr,Ko,sr,nr,Dt,ar,rr,ir,He,lr,Qe,dr,Ue,Fs,ge,Be,Wt,Ao,cr,Ht,pr,qs,U,Oo,hr,B,mr,Qt,ur,fr,Ut,gr,_r,Eo,br,kr,wr,j,So,$r,_e,vr,Jo,yr,Tr,Bt,Yr,Mr,xr,Re,Fr,Ve,qr,Ge,zs;return s=new we({}),oo=new we({}),ao=new we({}),ro=new O({props:{name:"class transformers.YosoConfig",anchor:"transformers.YosoConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 4096"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_expectation",val:" = True"},{name:"hash_code_len",val:" = 9"},{name:"num_hash",val:" = 64"},{name:"conv_window",val:" = None"},{name:"use_fast_hash",val:" = True"},{name:"lsh_backward",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.YosoConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_3/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_3/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_3/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),xe=new ft({props:{$$slots:{default:[Ei]},$$scope:{ctx:M}}}),Fe=new E({props:{anchor:"transformers.YosoModel.forward.example",$$slots:{default:[Si]},$$scope:{ctx:M}}}),uo=new we({}),fo=new O({props:{name:"class transformers.YosoForMaskedLM",anchor:"transformers.YosoForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.YosoForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_3/en/model_doc/yoso#transformers.YosoConfig">YosoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Ie=new ft({props:{$$slots:{default:[Ui]},$$scope:{ctx:M}}}),De=new E({props:{anchor:"transformers.YosoForMultipleChoice.forward.example",$$slots:{default:[Bi]},$$scope:{ctx:M}}}),Fo=new we({}),qo=new O({props:{name:"class transformers.YosoForTokenClassification",anchor:"transformers.YosoForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.YosoForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_3/en/model_doc/yoso#transformers.YosoConfig">YosoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),He=new ft({props:{$$slots:{default:[Ri]},$$scope:{ctx:M}}}),Qe=new E({props:{anchor:"transformers.YosoForTokenClassification.forward.example",$$slots:{default:[Vi]},$$scope:{ctx:M}}}),Ue=new E({props:{anchor:"transformers.YosoForTokenClassification.forward.example-2",$$slots:{default:[Gi]},$$scope:{ctx:M}}}),Ao=new we({}),Oo=new O({props:{name:"class transformers.YosoForQuestionAnswering",anchor:"transformers.YosoForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.YosoForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_3/en/model_doc/yoso#transformers.YosoConfig">YosoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Re=new ft({props:{$$slots:{default:[Ki]},$$scope:{ctx:M}}}),Ve=new E({props:{anchor:"transformers.YosoForQuestionAnswering.forward.example",$$slots:{default:[Ji]},$$scope:{ctx:M}}}),Ge=new E({props:{anchor:"transformers.YosoForQuestionAnswering.forward.example-2",$$slots:{default:[Zi]},$$scope:{ctx:M}}}),{c(){n=r("meta"),u=g(),a=r("h1"),p=r("a"),k=r("span"),w(s.$$.fragment),h=g(),x=r("span"),Hs=d("YOSO"),is=g(),Z=r("h2"),$e=r("a"),gt=r("span"),w(oo.$$.fragment),Qs=g(),_t=r("span"),Us=d("Overview"),ls=g(),X=r("p"),Bs=d("The YOSO model was proposed in "),to=r("a"),Rs=d("You Only Sample (Almost) Once: Linear Cost Self-Attention Via Bernoulli Sampling"),Vs=r("br"),Gs=d(`
...
documentation from `),Uo=r("a"),An=d("PretrainedConfig"),On=d(" for more information."),En=g(),w(Ye.$$.fragment),bs=g(),ae=r("h2"),Me=r("a"),Mt=r("span"),w(lo.$$.fragment),Sn=g(),xt=r("span"),Pn=d("YosoModel"),ks=g(),I=r("div"),w(co.$$.fragment),Ln=g(),po=r("p"),Nn=d(`The bare YOSO Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ho=r("a"),In=d("torch.nn.Module"),Dn=d(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wn=g(),L=r("div"),w(mo.$$.fragment),Hn=g(),re=r("p"),Qn=d("The "),Bo=r("a"),Un=d("YosoModel"),Bn=d(" forward method, overrides the "),Ft=r("code"),Rn=d("__call__"),Vn=d(" special method."),Gn=g(),w(xe.$$.fragment),Kn=g(),w(Fe.$$.fragment),ws=g(),ie=r("h2"),qe=r("a"),qt=r("span"),w(uo.$$.fragment),Jn=g(),zt=r("span"),Zn=d("YosoForMaskedLM"),$s=g(),D=r("div"),w(fo.$$.fragment),Xn=g(),le=r("p"),ea=d("YOSO Model with a "),jt=r("code"),oa=d("language modeling"),ta=d(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$a=g(),F=r("div"),w(vo.$$.fragment),va=g(),pe=r("p"),ya=d("The "),Vo=r("a"),Ta=d("YosoForSequenceClassification"),Ya=d(" forward method, overrides the "),Et=r("code"),Ma=d("__call__"),xa=d(" special method."),Fa=g(),w(Oe.$$.fragment),qa=g(),w(Ee.$$.fragment),za=g(),w(Se.$$.fragment),ja=g(),w(Pe.$$.fragment),Ca=g(),w(Le.$$.fragment),Ts=g(),he=r("h2"),Ne=r("a"),St=r("span"),w(yo.$$.fragment),Aa=g(),Pt=r("span"),Oa=d("YosoForMultipleChoice"),Ys=g(),H=r("div"),w(To.$$.fragment),Ea=g(),Yo=r("p"),Sa=d(`YOSO Model with a multiple choice classification head on top (a linear layer on top of
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),er=g(),z=r("div"),w(Co.$$.fragment),or=g(),fe=r("p"),tr=d("The "),Ko=r("a"),sr=d("YosoForTokenClassification"),nr=d(" forward method, overrides the "),Dt=r("code"),ar=d("__call__"),rr=d(" special method."),ir=g(),w(He.$$.fragment),lr=g(),w(Qe.$$.fragment),dr=g(),w(Ue.$$.fragment),Fs=g(),ge=r("h2"),Be=r("a"),Wt=r("span"),w(Ao.$$.fragment),cr=g(),Ht=r("span"),pr=d("YosoForQuestionAnswering"),qs=g(),U=r("div"),w(Oo.$$.fragment),hr=g(),B=r("p"),mr=d(`YOSO Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
