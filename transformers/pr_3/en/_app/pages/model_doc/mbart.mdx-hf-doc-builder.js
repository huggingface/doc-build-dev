...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),k=i("Example:"),m=p(),y(c.$$.fragment)},l(n){l=s(n,"P",{});var h=r(l);k=d(h,"Example:"),h.forEach(t),m=u(n),v(c.$$.fragment,n)},m(n,h){b(n,l,h),e(l,k),b(n,m,h),T(c,n,h),g=!0},p:P,i(n){g||(w(c.$$.fragment,n),g=!0)},o(n){M(c.$$.fragment,n),g=!1},d(n){n&&t(l),n&&t(m),$(c,n)}}}function n1(x){let l,k,m,c,g,n,h,F,st,ze,E,Ie,he,rt,me,fe,it,Xe,Q,L,Ne,ne,S,A,dt,le,ce,lt,H,ct,pt,G,qe,_e,Qe,ae,ge,be,ut,se,ke,ye,He;return{c(){l=a("p"),k=i("TF 2.0 models accepts two formats as inputs:"),m=p(),c=a("ul"),g=a("li"),n=i("having all inputs as keyword arguments (like PyTorch models), or"),h=p(),F=a("li"),st=i("having all inputs as a list, tuple or dict in the first positional arguments."),ze=p(),E=a("p"),Ie=i("This second option is useful when using "),he=a("code"),rt=i("tf.keras.Model.fit"),me=i(` method which currently requires having all the
tensors in the first argument of the model call function: `),fe=a("code"),it=i("model(inputs)"),Xe=i("."),Q=p(),L=a("p"),Ne=i(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=p(),S=a("ul"),A=a("li"),dt=i("a single Tensor with "),le=a("code"),ce=i("input_ids"),lt=i(" only and nothing else: "),H=a("code"),ct=i("model(input_ids)"),pt=p(),G=a("li"),qe=i(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),_e=a("code"),Qe=i("model([input_ids, attention_mask])"),ae=i(" or "),ge=a("code"),be=i("model([input_ids, attention_mask, token_type_ids])"),ut=p(),se=a("li"),ke=i(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a("code"),He=i('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){l=s(z,"P",{});var j=r(l);k=d(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),m=u(z),c=s(z,"UL",{});var ve=r(c);g=s(ve,"LI",{});var De=r(g);n=d(De,"having all inputs as keyword arguments (like PyTorch models), or"),De.forEach(t),h=u(ve),F=s(ve,"LI",{});var jt=r(F);st=d(jt,"having all inputs as a list, tuple or dict in the first positional arguments."),jt.forEach(t),ve.forEach(t),ze=u(z),E=s(z,"P",{});var V=r(E);Ie=d(V,"This second option is useful when using "),he=s(V,"CODE",{});var Et=r(he);rt=d(Et,"tf.keras.Model.fit"),Et.forEach(t),me=d(V,` method which currently requires having all the
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/tokenization_mbart_fast.py#L165",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_mbart.py#L1172",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_3/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_mbart.py#L1727",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
<p><a
  href="/docs/transformers/pr_3/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Kn=new C({props:{anchor:"transformers.FlaxMBartForQuestionAnswering.decode.example",$$slots:{default:[w1]},$$scope:{ctx:x}}}),{c(){l=a("meta"),k=p(),m=a("h1"),c=a("a"),g=a("span"),y(n.$$.fragment),h=p(),F=a("span"),st=i("MBart and MBart-50"),ze=p(),E=a("p"),Ie=a("strong"),he=i("DISCLAIMER:"),rt=i(" If you see something strange, file a "),me=a("a"),fe=i("Github Issue"),it=i(` and assign
...
documentation from `),ki=s(Wi,"A",{href:!0});var mw=r(ki);Dm=d(mw,"PretrainedConfig"),mw.forEach(t),Lm=d(Wi," for more information."),Wi.forEach(t),Gm=u(ta),v(qo.$$.fragment,ta),ta.forEach(t),$p=u(o),Rt=s(o,"H2",{class:!0});var ru=r(Rt);Fo=s(ru,"A",{id:!0,class:!0,href:!0});var fw=r(Fo);qd=s(fw,"SPAN",{});var _w=r(qd);v(Fa.$$.fragment,_w),_w.forEach(t),fw.forEach(t),Wm=u(ru),Fd=s(ru,"SPAN",{});var gw=r(Fd);Rm=d(gw,"MBartTokenizer"),gw.forEach(t),ru.forEach(t),xp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);v(Ba.$$.fragment,Se),Um=u(Se),Bd=s(Se,"P",{});var bw=r(Bd);Xm=d(bw,"Construct an MBART tokenizer."),bw.forEach(t),Qm=u(Se),ht=s(Se,"P",{});var oa=r(ht);Hm=d(oa,"Adapted from "),yi=s(oa,"A",{href:!0});var kw=r(yi);Vm=d(kw,"RobertaTokenizer"),kw.forEach(t),Jm=d(oa," and "),vi=s(oa,"A",{href:!0});var yw=r(vi);Km=d(yw,"XLNetTokenizer"),yw.forEach(t),Zm=d(oa,`. Based on
...
adding special tokens. An MBART-50 sequence has the following format, where `),tl=s(xu,"CODE",{});var Zw=r(tl);q_=d(Zw,"X"),Zw.forEach(t),F_=d(xu," represents the sequence:"),xu.forEach(t),B_=u(aa),ss=s(aa,"UL",{});var zu=r(ss);rs=s(zu,"LI",{});var qu=r(rs);ol=s(qu,"CODE",{});var Yw=r(ol);j_=d(Yw,"input_ids"),Yw.forEach(t),E_=d(qu," (for encoder) "),nl=s(qu,"CODE",{});var eM=r(nl);C_=d(eM,"[src_lang_code] X [eos]"),eM.forEach(t),qu.forEach(t),P_=u(zu),is=s(zu,"LI",{});var Fu=r(is);al=s(Fu,"CODE",{});var tM=r(al);S_=d(tM,"labels"),tM.forEach(t),A_=d(Fu,": (for decoder) "),sl=s(Fu,"CODE",{});var oM=r(sl);O_=d(oM,"[tgt_lang_code] X [eos]"),oM.forEach(t),Fu.forEach(t),zu.forEach(t),I_=u(aa),rl=s(aa,"P",{});var nM=r(rl);N_=d(nM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
special tokens using the tokenizer `),dl=s(Eu,"CODE",{});var sM=r(dl);X_=d(sM,"prepare_for_model"),sM.forEach(t),Q_=d(Eu," method."),Eu.forEach(t),ju.forEach(t),H_=u(ee),Lo=s(ee,"DIV",{class:!0});var Cu=r(Lo);v(ps.$$.fragment,Cu),V_=u(Cu),ll=s(Cu,"P",{});var rM=r(ll);J_=d(rM,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),rM.forEach(t),Cu.forEach(t),K_=u(ee),Go=s(ee,"DIV",{class:!0});var Pu=r(Go);v(us.$$.fragment,Pu),Z_=u(Pu),cl=s(Pu,"P",{});var iM=r(cl);Y_=d(iM,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),iM.forEach(t),Pu.forEach(t),ee.forEach(t),jp=u(o),Ht=s(o,"H2",{class:!0});var Su=r(Ht);Wo=s(Su,"A",{id:!0,class:!0,href:!0});var dM=r(Wo);pl=s(dM,"SPAN",{});var lM=r(pl);v(hs.$$.fragment,lM),lM.forEach(t),dM.forEach(t),eg=u(Su),ul=s(Su,"SPAN",{});var cM=r(ul);tg=d(cM,"MBart50TokenizerFast"),cM.forEach(t),Su.forEach(t),Ep=u(o),K=s(o,"DIV",{class:!0});var Ae=r(K);v(ms.$$.fragment,Ae),og=u(Ae),Vt=s(Ae,"P",{});var Ui=r(Vt);ng=d(Ui,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),hl=s(Ui,"EM",{});var pM=r(hl);ag=d(pM,"tokenizers"),pM.forEach(t),sg=d(Ui,` library). Based on
`),fs=s(Ui,"A",{href:!0,rel:!0});var uM=r(fs);rg=d(uM,"BPE"),uM.forEach(t),ig=d(Ui,"."),Ui.forEach(t),dg=u(Ae),_s=s(Ae,"P",{});var Au=r(_s);lg=d(Au,"This tokenizer inherits from "),Mi=s(Au,"A",{href:!0});var hM=r(Mi);cg=d(hM,"PreTrainedTokenizerFast"),hM.forEach(t),pg=d(Au,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Au.forEach(t),ug=u(Ae),v(Ro.$$.fragment,Ae),hg=u(Ae),Be=s(Ae,"DIV",{class:!0});var Tt=r(Be);v(gs.$$.fragment,Tt),mg=u(Tt),ml=s(Tt,"P",{});var mM=r(ml);fg=d(mM,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),mM.forEach(t),_g=u(Tt),bs=s(Tt,"P",{});var Ou=r(bs);gg=d(Ou,"An MBART-50 sequence has the following format, where "),fl=s(Ou,"CODE",{});var fM=r(fl);bg=d(fM,"X"),fM.forEach(t),kg=d(Ou," represents the sequence:"),Ou.forEach(t),yg=u(Tt),ks=s(Tt,"UL",{});var Iu=r(ks);ys=s(Iu,"LI",{});var Nu=r(ys);_l=s(Nu,"CODE",{});var _M=r(_l);vg=d(_M,"input_ids"),_M.forEach(t),Tg=d(Nu," (for encoder) "),gl=s(Nu,"CODE",{});var gM=r(gl);wg=d(gM,"[src_lang_code] X [eos]"),gM.forEach(t),Nu.forEach(t),Mg=u(Iu),vs=s(Iu,"LI",{});var Du=r(vs);bl=s(Du,"CODE",{});var bM=r(bl);$g=d(bM,"labels"),bM.forEach(t),xg=d(Du,": (for decoder) "),kl=s(Du,"CODE",{});var kM=r(kl);zg=d(kM,"[tgt_lang_code] X [eos]"),kM.forEach(t),Du.forEach(t),Iu.forEach(t),qg=u(Tt),yl=s(Tt,"P",{});var yM=r(yl);Fg=d(yM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),yM.forEach(t),Tt.forEach(t),Bg=u(Ae),Uo=s(Ae,"DIV",{class:!0});var Lu=r(Uo);v(Ts.$$.fragment,Lu),jg=u(Lu),vl=s(Lu,"P",{});var vM=r(vl);Eg=d(vM,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),vM.forEach(t),Lu.forEach(t),Cg=u(Ae),Xo=s(Ae,"DIV",{class:!0});var Gu=r(Xo);v(ws.$$.fragment,Gu),Pg=u(Gu),Tl=s(Gu,"P",{});var TM=r(Tl);Sg=d(TM,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),TM.forEach(t),Gu.forEach(t),Ae.forEach(t),Cp=u(o),Jt=s(o,"H2",{class:!0});var Wu=r(Jt);Qo=s(Wu,"A",{id:!0,class:!0,href:!0});var wM=r(Qo);wl=s(wM,"SPAN",{});var MM=r(wl);v(Ms.$$.fragment,MM),MM.forEach(t),wM.forEach(t),Ag=u(Wu),Ml=s(Wu,"SPAN",{});var $M=r(Ml);Og=d($M,"MBartModel"),$M.forEach(t),Wu.forEach(t),Pp=u(o),We=s(o,"DIV",{class:!0});var sa=r(We);v($s.$$.fragment,sa),Ig=u(sa),xs=s(sa,"P",{});var Ru=r(xs);Ng=d(Ru,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),$i=s(Ru,"A",{href:!0});var xM=r($i);Dg=d(xM,"PreTrainedModel"),xM.forEach(t),Lg=d(Ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ru.forEach(t),Gg=u(sa),zs=s(sa,"P",{});var Uu=r(zs);Wg=d(Uu,"This model is also a PyTorch "),qs=s(Uu,"A",{href:!0,rel:!0});var zM=r(qs);Rg=d(zM,"torch.nn.Module"),zM.forEach(t),Ug=d(Uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uu.forEach(t),Xg=u(sa),Ze=s(sa,"DIV",{class:!0});var ra=r(Ze);v(Fs.$$.fragment,ra),Qg=u(ra),Kt=s(ra,"P",{});var Xi=r(Kt);Hg=d(Xi,"The "),xi=s(Xi,"A",{href:!0});var qM=r(xi);Vg=d(qM,"MBartModel"),qM.forEach(t),Jg=d(Xi," forward method, overrides the "),$l=s(Xi,"CODE",{});var FM=r($l);Kg=d(FM,"__call__"),FM.forEach(t),Zg=d(Xi," special method."),Xi.forEach(t),Yg=u(ra),v(Ho.$$.fragment,ra),eb=u(ra),v(Vo.$$.fragment,ra),ra.forEach(t),sa.forEach(t),Sp=u(o),Zt=s(o,"H2",{class:!0});var Xu=r(Zt);Jo=s(Xu,"A",{id:!0,class:!0,href:!0});var BM=r(Jo);xl=s(BM,"SPAN",{});var jM=r(xl);v(Bs.$$.fragment,jM),jM.forEach(t),BM.forEach(t),tb=u(Xu),zl=s(Xu,"SPAN",{});var EM=r(zl);ob=d(EM,"MBartForConditionalGeneration"),EM.forEach(t),Xu.forEach(t),Ap=u(o),Re=s(o,"DIV",{class:!0});var ia=r(Re);v(js.$$.fragment,ia),nb=u(ia),Es=s(ia,"P",{});var Qu=r(Es);ab=d(Qu,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ku.forEach(t),Ob=u(Mt),Ee=s(Mt,"DIV",{class:!0});var $t=r(Ee);v(Ls.$$.fragment,$t),Ib=u($t),oo=s($t,"P",{});var Vi=r(oo);Nb=d(Vi,"The "),Bi=s(Vi,"A",{href:!0});var RM=r(Bi);Db=d(RM,"MBartForQuestionAnswering"),RM.forEach(t),Lb=d(Vi," forward method, overrides the "),Cl=s(Vi,"CODE",{});var UM=r(Cl);Gb=d(UM,"__call__"),UM.forEach(t),Wb=d(Vi," special method."),Vi.forEach(t),Rb=u($t),v(tn.$$.fragment,$t),Ub=u($t),v(on.$$.fragment,$t),Xb=u($t),v(nn.$$.fragment,$t),$t.forEach(t),Mt.forEach(t),Np=u(o),no=s(o,"H2",{class:!0});var Zu=r(no);an=s(Zu,"A",{id:!0,class:!0,href:!0});var XM=r(an);Pl=s(XM,"SPAN",{});var QM=r(Pl);v(Gs.$$.fragment,QM),QM.forEach(t),XM.forEach(t),Qb=u(Zu),Sl=s(Zu,"SPAN",{});var HM=r(Sl);Hb=d(HM,"MBartForSequenceClassification"),HM.forEach(t),Zu.forEach(t),Dp=u(o),Me=s(o,"DIV",{class:!0});var xt=r(Me);v(Ws.$$.fragment,xt),Vb=u(xt),Al=s(xt,"P",{});var VM=r(Al);Jb=d(VM,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rh.forEach(t),jk=u(zt),v(fn.$$.fragment,zt),Ek=u(zt),Ye=s(zt,"DIV",{class:!0});var da=r(Ye);v(or.$$.fragment,da),Ck=u(da),lo=s(da,"P",{});var Ki=r(lo);Pk=d(Ki,"The "),Pi=s(Ki,"A",{href:!0});var d$=r(Pi);Sk=d(d$,"TFMBartModel"),d$.forEach(t),Ak=d(Ki," forward method, overrides the "),Gl=s(Ki,"CODE",{});var l$=r(Gl);Ok=d(l$,"__call__"),l$.forEach(t),Ik=d(Ki," special method."),Ki.forEach(t),Nk=u(da),v(_n.$$.fragment,da),Dk=u(da),v(gn.$$.fragment,da),da.forEach(t),zt.forEach(t),Up=u(o),co=s(o,"H2",{class:!0});var ih=r(co);bn=s(ih,"A",{id:!0,class:!0,href:!0});var c$=r(bn);Wl=s(c$,"SPAN",{});var p$=r(Wl);v(nr.$$.fragment,p$),p$.forEach(t),c$.forEach(t),Lk=u(ih),Rl=s(ih,"SPAN",{});var u$=r(Rl);Gk=d(u$,"TFMBartForConditionalGeneration"),u$.forEach(t),ih.forEach(t),Xp=u(o),xe=s(o,"DIV",{class:!0});var qt=r(xe);v(ar.$$.fragment,qt),Wk=u(qt),sr=s(qt,"P",{});var dh=r(sr);Rk=d(dh,`The MBART Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),lh.forEach(t),Kk=u(qt),v(kn.$$.fragment,qt),Zk=u(qt),Ce=s(qt,"DIV",{class:!0});var Ft=r(Ce);v(dr.$$.fragment,Ft),Yk=u(Ft),po=s(Ft,"P",{});var Zi=r(po);ey=d(Zi,"The "),Ai=s(Zi,"A",{href:!0});var f$=r(Ai);ty=d(f$,"TFMBartForConditionalGeneration"),f$.forEach(t),oy=d(Zi," forward method, overrides the "),Ul=s(Zi,"CODE",{});var _$=r(Ul);ny=d(_$,"__call__"),_$.forEach(t),ay=d(Zi," special method."),Zi.forEach(t),sy=u(Ft),v(yn.$$.fragment,Ft),ry=u(Ft),v(vn.$$.fragment,Ft),iy=u(Ft),v(Tn.$$.fragment,Ft),Ft.forEach(t),qt.forEach(t),Qp=u(o),uo=s(o,"H2",{class:!0});var ch=r(uo);wn=s(ch,"A",{id:!0,class:!0,href:!0});var g$=r(wn);Xl=s(g$,"SPAN",{});var b$=r(Xl);v(lr.$$.fragment,b$),b$.forEach(t),g$.forEach(t),dy=u(ch),Ql=s(ch,"SPAN",{});var k$=r(Ql);ly=d(k$,"FlaxMBartModel"),k$.forEach(t),ch.forEach(t),Hp=u(o),W=s(o,"DIV",{class:!0});var pe=r(W);v(cr.$$.fragment,pe),cy=u(pe),pr=s(pe,"P",{});var ph=r(pr);py=d(ph,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
