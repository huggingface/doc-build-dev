import{S as _m,i as gm,s as vm,e as o,k as d,w as M,t as r,M as km,c as s,d as t,m as c,a,x as b,h as i,b as p,G as e,g as _,y,q as x,o as w,B as $,v as Tm,L as jt}from"../../chunks/vendor-hf-doc-builder.js";import{T as bn}from"../../chunks/Tip-hf-doc-builder.js";import{D as V}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as de}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as zt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Mm(z){let h,k,g,u,v;return u=new ye({props:{code:`from transformers import MarianModel, MarianConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){h=o("p"),k=r("Example:"),g=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);k=i(m,"Example:"),m.forEach(t),g=c(l),b(u.$$.fragment,l)},m(l,m){_(l,h,m),e(h,k),_(l,g,m),y(u,l,m),v=!0},p:jt,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){w(u.$$.fragment,l),v=!1},d(l){l&&t(h),l&&t(g),$(u,l)}}}function Om(z){let h,k,g,u,v,l,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,_e,te,ne,oe,Se,S,He,H,D,T,q,ge,Ke,ve,U,Ze,Xe,De,I,se,Qe,Ue,W,et,tt,ae,ke,bi,ts,yi,xi,wi,nt,yn,$i,Ps,zi,ji,qi,xn,Ei,Ns,Fi,Pi,Ni,ot,Ci,Cs,Li,Ii,Ls,Ai,Oi,Si,Is,wn,Hi,As,Di,Ui,Wi,Os,$n,Ri,zn,Bi,Vi,Za,st,qt,Ss,jn,Gi,Hs,Ji,Xa,$e,ns,Yi,Ds,Ki,Zi,qn,Xi,En,Qi,el,tl,at,nl,Us,ol,sl,Ws,al,rl,il,Rs,ll,Qa,rt,Et,Bs,Fn,dl,Vs,cl,er,Ft,Gs,pl,hl,Js,Pn,ul,tr,it,Pt,Ys,Nn,ml,Ks,fl,nr,ze,Cn,_l,Zs,gl,vl,kl,Ln,Tl,Xs,Ml,bl,yl,In,xl,An,wl,$l,zl,On,jl,Qs,ql,El,or,Nt,Fl,Sn,Pl,Nl,sr,Hn,ar,os,Cl,rr,Dn,ir,lt,Ct,ea,Un,Ll,ta,Il,lr,ss,Al,dr,Wn,cr,as,Ol,pr,Rn,hr,dt,Lt,na,Bn,Sl,oa,Hl,ur,Te,Vn,Dl,ct,Ul,rs,Wl,Rl,Gn,Bl,Vl,Gl,pt,Jl,is,Yl,Kl,ls,Zl,Xl,Ql,It,mr,ht,At,sa,Jn,ed,aa,td,fr,re,Yn,nd,Kn,od,Zn,sd,ad,rd,Xn,id,ds,ld,dd,cd,Ot,pd,St,Qn,hd,ra,ud,_r,ut,Ht,ia,eo,md,la,fd,gr,Me,to,_d,no,gd,cs,vd,kd,Td,oo,Md,so,bd,yd,xd,je,ao,wd,mt,$d,ps,zd,jd,da,qd,Ed,Fd,Dt,Pd,Ut,vr,ft,Wt,ca,ro,Nd,pa,Cd,kr,be,io,Ld,lo,Id,hs,Ad,Od,Sd,co,Hd,po,Dd,Ud,Wd,pe,ho,Rd,_t,Bd,us,Vd,Gd,ha,Jd,Yd,Kd,Rt,Zd,uo,Xd,mo,Qd,ec,tc,Bt,Tr,gt,Vt,ua,fo,nc,ma,oc,Mr,vt,_o,sc,Gt,go,ac,Jt,br,kt,Yt,fa,vo,rc,_a,ic,yr,ie,ko,lc,To,dc,ms,cc,pc,hc,Mo,uc,bo,mc,fc,_c,Kt,gc,qe,yo,vc,Tt,kc,fs,Tc,Mc,ga,bc,yc,xc,Zt,wc,Xt,xr,Mt,Qt,va,xo,$c,ka,zc,wr,le,wo,jc,$o,qc,_s,Ec,Fc,Pc,zo,Nc,jo,Cc,Lc,Ic,en,Ac,he,qo,Oc,bt,Sc,gs,Hc,Dc,Ta,Uc,Wc,Rc,tn,Bc,Eo,Vc,Fo,Gc,Jc,Yc,nn,$r,yt,on,Ma,Po,Kc,ba,Zc,zr,R,No,Xc,Co,Qc,vs,ep,tp,np,Lo,op,Io,sp,ap,rp,ya,ip,lp,We,xa,Ao,dp,cp,wa,Oo,pp,hp,$a,So,up,mp,za,Ho,fp,_p,Ee,Do,gp,xt,vp,ja,kp,Tp,qa,Mp,bp,yp,sn,xp,an,jr,wt,rn,Ea,Uo,wp,Fa,$p,qr,B,Wo,zp,Ro,jp,ks,qp,Ep,Fp,Bo,Pp,Vo,Np,Cp,Lp,Pa,Ip,Ap,Re,Na,Go,Op,Sp,Ca,Jo,Hp,Dp,La,Yo,Up,Wp,Ia,Ko,Rp,Bp,Fe,Zo,Vp,$t,Gp,Aa,Jp,Yp,Oa,Kp,Zp,Xp,ln,Qp,dn,Er;return l=new de({}),X=new de({}),jn=new de({}),Fn=new de({}),Nn=new de({}),Hn=new ye({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/configuration_marian.py#L34"}}),It=new zt({props:{anchor:"transformers.MarianConfig.example",$$slots:{default:[Mm]},$$scope:{ctx:z}}}),Jn=new de({}),Yn=new V({props:{name:"class transformers.MarianTokenizer",anchor:"transformers.MarianTokenizer",parameters:[{name:"source_spm",val:""},{name:"target_spm",val:""},{name:"vocab",val:""},{name:"target_vocab_file",val:" = None"},{name:"source_lang",val:" = None"},{name:"target_lang",val:" = None"},{name:"unk_token",val:" = '<unk>'"},{name:"eos_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"model_max_length",val:" = 512"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"separate_vocabs",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MarianTokenizer.source_spm",description:`<strong>source_spm</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17958/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_marian.py#L1169",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17958/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17958/en/model_doc/marian#transformers.MarianConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_marian.py#L1396",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17958/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17958/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_marian.py#L1571",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17958/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
`}}),Jt=new zt({props:{anchor:"transformers.MarianForCausalLM.forward.example",$$slots:{default:[zm]},$$scope:{ctx:z}}}),vo=new de({}),ko=new V({props:{name:"class transformers.TFMarianModel",anchor:"transformers.TFMarianModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17958/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17958/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_tf_marian.py#L1188"}}),Kt=new bn({props:{$$slots:{default:[jm]},$$scope:{ctx:z}}}),yo=new V({props:{name:"call",anchor:"transformers.TFMarianModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_tf_marian.py#L1200",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17958/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
`}}),Zt=new bn({props:{$$slots:{default:[qm]},$$scope:{ctx:z}}}),Xt=new zt({props:{anchor:"transformers.TFMarianModel.call.example",$$slots:{default:[Em]},$$scope:{ctx:z}}}),xo=new de({}),wo=new V({props:{name:"class transformers.TFMarianMTModel",anchor:"transformers.TFMarianMTModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17958/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17958/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_tf_marian.py#L1276"}}),en=new bn({props:{$$slots:{default:[Fm]},$$scope:{ctx:z}}}),qo=new V({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17958/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/pr_17958/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17958/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_tf_marian.py#L1309",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17958/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),tn=new bn({props:{$$slots:{default:[Pm]},$$scope:{ctx:z}}}),nn=new zt({props:{anchor:"transformers.TFMarianMTModel.call.example",$$slots:{default:[Nm]},$$scope:{ctx:z}}}),Po=new de({}),No=new V({props:{name:"class transformers.FlaxMarianModel",anchor:"transformers.FlaxMarianModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17958/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17958/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_flax_marian.py#L1142",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17958/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
`}}),sn=new bn({props:{$$slots:{default:[Cm]},$$scope:{ctx:z}}}),an=new zt({props:{anchor:"transformers.FlaxMarianModel.__call__.example",$$slots:{default:[Lm]},$$scope:{ctx:z}}}),Uo=new de({}),Wo=new V({props:{name:"class transformers.FlaxMarianMTModel",anchor:"transformers.FlaxMarianMTModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17958/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17958/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17958/src/transformers/models/marian/modeling_flax_marian.py#L1142",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17958/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
and assign @patrickvonplaten.`),xe=d(),G=o("p"),O=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),we=d(),L=o("h2"),F=o("a"),N=o("span"),M(X.$$.fragment),Q=d(),me=o("span"),Ae=r("Implementation Notes"),J=d(),P=o("ul"),fe=o("li"),C=o("p"),Oe=r("Each model is about 298 MB on disk, there are more than 1,000 models."),ee=d(),_e=o("li"),te=o("p"),ne=r("The list of supported language pairs can be found "),oe=o("a"),Se=r("here"),S=r("."),He=d(),H=o("li"),D=o("p"),T=r("Models were originally trained by "),q=o("a"),ge=r("J\xF6rg Tiedemann"),Ke=r(" using the "),ve=o("a"),U=r("Marian"),Ze=r(" C++ library, which supports fast training and translation."),Xe=d(),De=o("li"),I=o("p"),se=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
...
group use a combination of ISO-639-5 codes and ISO-639-2 codes.`),Qa=d(),rt=o("h2"),Et=o("a"),Bs=o("span"),M(Fn.$$.fragment),dl=d(),Vs=o("span"),cl=r("Examples"),er=d(),Ft=o("ul"),Gs=o("li"),pl=r(`Since Marian models are smaller than many other translation models available in the library, they can be useful for
...
group:`),dr=d(),M(Wn.$$.fragment),cr=d(),as=o("p"),Ol=r("Example of translating english to many romance languages, using old-style 2 character language codes"),pr=d(),M(Rn.$$.fragment),hr=d(),dt=o("h2"),Lt=o("a"),na=o("span"),M(Bn.$$.fragment),Sl=d(),oa=o("span"),Hl=r("MarianConfig"),ur=d(),Te=o("div"),M(Vn.$$.fragment),Dl=d(),ct=o("p"),Ul=r("This is the configuration class to store the configuration of a "),rs=o("a"),Wl=r("MarianModel"),Rl=r(`. It is used to instantiate an
...
`),Gn=o("a"),Bl=r("Helsinki-NLP/opus-mt-en-de"),Vl=r(" architecture."),Gl=d(),pt=o("p"),Jl=r("Configuration objects inherit from "),is=o("a"),Yl=r("PretrainedConfig"),Kl=r(` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wd=d(),pe=o("div"),M(ho.$$.fragment),Rd=d(),_t=o("p"),Bd=r("The "),us=o("a"),Vd=r("MarianMTModel"),Gd=r(" forward method, overrides the "),ha=o("code"),Jd=r("__call__"),Yd=r(" special method."),Kd=d(),M(Rt.$$.fragment),Zd=d(),uo=o("p"),Xd=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),mo=o("a"),Qd=r("here"),ec=r("."),tc=d(),M(Bt.$$.fragment),Tr=d(),gt=o("h2"),Vt=o("a"),ua=o("span"),M(fo.$$.fragment),nc=d(),ma=o("span"),oc=r("MarianForCausalLM"),Mr=d(),vt=o("div"),M(_o.$$.fragment),sc=d(),Gt=o("div"),M(go.$$.fragment),ac=d(),M(Jt.$$.fragment),br=d(),kt=o("h2"),Yt=o("a"),fa=o("span"),M(vo.$$.fragment),rc=d(),_a=o("span"),ic=r("TFMarianModel"),yr=d(),ie=o("div"),M(ko.$$.fragment),lc=d(),To=o("p"),dc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ic=d(),M(en.$$.fragment),Ac=d(),he=o("div"),M(qo.$$.fragment),Oc=d(),bt=o("p"),Sc=r("The "),gs=o("a"),Hc=r("TFMarianMTModel"),Dc=r(" forward method, overrides the "),Ta=o("code"),Uc=r("__call__"),Wc=r(" special method."),Rc=d(),M(tn.$$.fragment),Bc=d(),Eo=o("p"),Vc=r(`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rp=d(),ya=o("p"),ip=r("Finally, this model supports inherent JAX features such as:"),lp=d(),We=o("ul"),xa=o("li"),Ao=o("a"),dp=r("Just-In-Time (JIT) compilation"),cp=d(),wa=o("li"),Oo=o("a"),pp=r("Automatic Differentiation"),hp=d(),$a=o("li"),So=o("a"),up=r("Vectorization"),mp=d(),za=o("li"),Ho=o("a"),fp=r("Parallelization"),_p=d(),Ee=o("div"),M(Do.$$.fragment),gp=d(),xt=o("p"),vp=r("The "),ja=o("code"),kp=r("FlaxMarianPreTrainedModel"),Tp=r(" forward method, overrides the "),qa=o("code"),Mp=r("__call__"),bp=r(" special method."),yp=d(),M(sn.$$.fragment),xp=d(),M(an.$$.fragment),jr=d(),wt=o("h2"),rn=o("a"),Ea=o("span"),M(Uo.$$.fragment),wp=d(),Fa=o("span"),$p=r("FlaxMarianMTModel"),qr=d(),B=o("div"),M(Wo.$$.fragment),zp=d(),Ro=o("p"),jp=r(`The MARIAN Model with a language modeling head. Can be used for translation.
...
group use a combination of ISO-639-5 codes and ISO-639-2 codes.`),wh.forEach(t),pn.forEach(t),Qa=c(n),rt=s(n,"H2",{class:!0});var Sr=a(rt);Et=s(Sr,"A",{id:!0,class:!0,href:!0});var $h=a(Et);Bs=s($h,"SPAN",{});var zh=a(Bs);b(Fn.$$.fragment,zh),zh.forEach(t),$h.forEach(t),dl=c(Sr),Vs=s(Sr,"SPAN",{});var jh=a(Vs);cl=i(jh,"Examples"),jh.forEach(t),Sr.forEach(t),er=c(n),Ft=s(n,"UL",{});var Hr=a(Ft);Gs=s(Hr,"LI",{});var qh=a(Gs);pl=i(qh,`Since Marian models are smaller than many other translation models available in the library, they can be useful for
fine-tuning experiments and integration tests.`),qh.forEach(t),hl=c(Hr),Js=s(Hr,"LI",{});var Eh=a(Js);Pn=s(Eh,"A",{href:!0,rel:!0});var Fh=a(Pn);ul=i(Fh,"Fine-tune on GPU"),Fh.forEach(t),Eh.forEach(t),Hr.forEach(t),tr=c(n),it=s(n,"H2",{class:!0});var Dr=a(it);Pt=s(Dr,"A",{id:!0,class:!0,href:!0});var Ph=a(Pt);Ys=s(Ph,"SPAN",{});var Nh=a(Ys);b(Nn.$$.fragment,Nh),Nh.forEach(t),Ph.forEach(t),ml=c(Dr),Ks=s(Dr,"SPAN",{});var Ch=a(Ks);fl=i(Ch,"Multilingual Models"),Ch.forEach(t),Dr.forEach(t),nr=c(n),ze=s(n,"UL",{});var hn=a(ze);Cn=s(hn,"LI",{});var Ur=a(Cn);_l=i(Ur,"All model names use the following format: "),Zs=s(Ur,"CODE",{});var Lh=a(Zs);gl=i(Lh,"Helsinki-NLP/opus-mt-{src}-{tgt}"),Lh.forEach(t),vl=i(Ur,":"),Ur.forEach(t),kl=c(hn),Ln=s(hn,"LI",{});var Wr=a(Ln);Tl=i(Wr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
language to the `),Xs=s(Wr,"CODE",{});var Ih=a(Xs);Ml=i(Ih,"src_text"),Ih.forEach(t),bl=i(Wr,"."),Wr.forEach(t),yl=c(hn),In=s(hn,"LI",{});var Rr=a(In);xl=i(Rr,"You can see a models\u2019s supported language codes in its model card, under target constituents, like in "),An=s(Rr,"A",{href:!0,rel:!0});var Ah=a(An);wl=i(Ah,"opus-mt-en-roa"),Ah.forEach(t),$l=i(Rr,"."),Rr.forEach(t),zl=c(hn),On=s(hn,"LI",{});var Br=a(On);jl=i(Br,"Note that if a model is only multilingual on the source side, like "),Qs=s(Br,"CODE",{});var Oh=a(Qs);ql=i(Oh,"Helsinki-NLP/opus-mt-roa-en"),Oh.forEach(t),El=i(Br,`, no language
codes are required.`),Br.forEach(t),hn.forEach(t),or=c(n),Nt=s(n,"P",{});var Vr=a(Nt);Fl=i(Vr,"New multi-lingual models from the "),Sn=s(Vr,"A",{href:!0,rel:!0});var Sh=a(Sn);Pl=i(Sh,"Tatoeba-Challenge repo"),Sh.forEach(t),Nl=i(Vr,`
require 3 character language codes:`),Vr.forEach(t),sr=c(n),b(Hn.$$.fragment,n),ar=c(n),os=s(n,"P",{});var Hh=a(os);Cl=i(Hh,"Here is the code to see all available pretrained models on the hub:"),Hh.forEach(t),rr=c(n),b(Dn.$$.fragment,n),ir=c(n),lt=s(n,"H2",{class:!0});var Gr=a(lt);Ct=s(Gr,"A",{id:!0,class:!0,href:!0});var Dh=a(Ct);ea=s(Dh,"SPAN",{});var Uh=a(ea);b(Un.$$.fragment,Uh),Uh.forEach(t),Dh.forEach(t),Ll=c(Gr),ta=s(Gr,"SPAN",{});var Wh=a(ta);Il=i(Wh,"Old Style Multi-Lingual Models"),Wh.forEach(t),Gr.forEach(t),lr=c(n),ss=s(n,"P",{});var Rh=a(ss);Al=i(Rh,`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),Rh.forEach(t),dr=c(n),b(Wn.$$.fragment,n),cr=c(n),as=s(n,"P",{});var Bh=a(as);Ol=i(Bh,"Example of translating english to many romance languages, using old-style 2 character language codes"),Bh.forEach(t),pr=c(n),b(Rn.$$.fragment,n),hr=c(n),dt=s(n,"H2",{class:!0});var Jr=a(dt);Lt=s(Jr,"A",{id:!0,class:!0,href:!0});var Vh=a(Lt);na=s(Vh,"SPAN",{});var Gh=a(na);b(Bn.$$.fragment,Gh),Gh.forEach(t),Vh.forEach(t),Sl=c(Jr),oa=s(Jr,"SPAN",{});var Jh=a(oa);Hl=i(Jh,"MarianConfig"),Jh.forEach(t),Jr.forEach(t),ur=c(n),Te=s(n,"DIV",{class:!0});var un=a(Te);b(Vn.$$.fragment,un),Dl=c(un),ct=s(un,"P",{});var xs=a(ct);Ul=i(xs,"This is the configuration class to store the configuration of a "),rs=s(xs,"A",{href:!0});var Yh=a(rs);Wl=i(Yh,"MarianModel"),Yh.forEach(t),Rl=i(xs,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
`),Gn=s(xs,"A",{href:!0,rel:!0});var Kh=a(Gn);Bl=i(Kh,"Helsinki-NLP/opus-mt-en-de"),Kh.forEach(t),Vl=i(xs," architecture."),xs.forEach(t),Gl=c(un),pt=s(un,"P",{});var ws=a(pt);Jl=i(ws,"Configuration objects inherit from "),is=s(ws,"A",{href:!0});var Zh=a(is);Yl=i(Zh,"PretrainedConfig"),Zh.forEach(t),Kl=i(ws,` and can be used to control the model outputs. Read the
documentation from `),ls=s(ws,"A",{href:!0});var Xh=a(ls);Zl=i(Xh,"PretrainedConfig"),Xh.forEach(t),Xl=i(ws," for more information."),ws.forEach(t),Ql=c(un),b(It.$$.fragment,un),un.forEach(t),mr=c(n),ht=s(n,"H2",{class:!0});var Yr=a(ht);At=s(Yr,"A",{id:!0,class:!0,href:!0});var Qh=a(At);sa=s(Qh,"SPAN",{});var eu=a(sa);b(Jn.$$.fragment,eu),eu.forEach(t),Qh.forEach(t),ed=c(Yr),aa=s(Yr,"SPAN",{});var tu=a(aa);td=i(tu,"MarianTokenizer"),tu.forEach(t),Yr.forEach(t),fr=c(n),re=s(n,"DIV",{class:!0});var Be=a(re);b(Yn.$$.fragment,Be),nd=c(Be),Kn=s(Be,"P",{});var Kr=a(Kn);od=i(Kr,"Construct a Marian tokenizer. Based on "),Zn=s(Kr,"A",{href:!0,rel:!0});var nu=a(Zn);sd=i(nu,"SentencePiece"),nu.forEach(t),ad=i(Kr,"."),Kr.forEach(t),rd=c(Be),Xn=s(Be,"P",{});var Zr=a(Xn);id=i(Zr,"This tokenizer inherits from "),ds=s(Zr,"A",{href:!0});var ou=a(ds);ld=i(ou,"PreTrainedTokenizer"),ou.forEach(t),dd=i(Zr,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Zr.forEach(t),cd=c(Be),b(Ot.$$.fragment,Be),pd=c(Be),St=s(Be,"DIV",{class:!0});var Xr=a(St);b(Qn.$$.fragment,Xr),hd=c(Xr),ra=s(Xr,"P",{});var su=a(ra);ud=i(su,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),su.forEach(t),Xr.forEach(t),Be.forEach(t),_r=c(n),ut=s(n,"H2",{class:!0});var Qr=a(ut);Ht=s(Qr,"A",{id:!0,class:!0,href:!0});var au=a(Ht);ia=s(au,"SPAN",{});var ru=a(ia);b(eo.$$.fragment,ru),ru.forEach(t),au.forEach(t),md=c(Qr),la=s(Qr,"SPAN",{});var iu=a(la);fd=i(iu,"MarianModel"),iu.forEach(t),Qr.forEach(t),gr=c(n),Me=s(n,"DIV",{class:!0});var mn=a(Me);b(to.$$.fragment,mn),_d=c(mn),no=s(mn,"P",{});var ei=a(no);gd=i(ei,`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),oi.forEach(t),Sd=c(_n),co=s(_n,"P",{});var si=a(co);Hd=i(si,"This model is also a PyTorch "),po=s(si,"A",{href:!0,rel:!0});var _u=a(po);Dd=i(_u,"torch.nn.Module"),_u.forEach(t),Ud=i(si,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),si.forEach(t),Wd=c(_n),pe=s(_n,"DIV",{class:!0});var Ve=a(pe);b(ho.$$.fragment,Ve),Rd=c(Ve),_t=s(Ve,"P",{});var zs=a(_t);Bd=i(zs,"The "),us=s(zs,"A",{href:!0});var gu=a(us);Vd=i(gu,"MarianMTModel"),gu.forEach(t),Gd=i(zs," forward method, overrides the "),ha=s(zs,"CODE",{});var vu=a(ha);Jd=i(vu,"__call__"),vu.forEach(t),Yd=i(zs," special method."),zs.forEach(t),Kd=c(Ve),b(Rt.$$.fragment,Ve),Zd=c(Ve),uo=s(Ve,"P",{});var ai=a(uo);Xd=i(ai,`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),mo=s(ai,"A",{href:!0,rel:!0});var ku=a(mo);Qd=i(ku,"here"),ku.forEach(t),ec=i(ai,"."),ai.forEach(t),tc=c(Ve),b(Bt.$$.fragment,Ve),Ve.forEach(t),_n.forEach(t),Tr=c(n),gt=s(n,"H2",{class:!0});var ri=a(gt);Vt=s(ri,"A",{id:!0,class:!0,href:!0});var Tu=a(Vt);ua=s(Tu,"SPAN",{});var Mu=a(ua);b(fo.$$.fragment,Mu),Mu.forEach(t),Tu.forEach(t),nc=c(ri),ma=s(ri,"SPAN",{});var bu=a(ma);oc=i(bu,"MarianForCausalLM"),bu.forEach(t),ri.forEach(t),Mr=c(n),vt=s(n,"DIV",{class:!0});var ii=a(vt);b(_o.$$.fragment,ii),sc=c(ii),Gt=s(ii,"DIV",{class:!0});var li=a(Gt);b(go.$$.fragment,li),ac=c(li),b(Jt.$$.fragment,li),li.forEach(t),ii.forEach(t),br=c(n),kt=s(n,"H2",{class:!0});var di=a(kt);Yt=s(di,"A",{id:!0,class:!0,href:!0});var yu=a(Yt);fa=s(yu,"SPAN",{});var xu=a(fa);b(vo.$$.fragment,xu),xu.forEach(t),yu.forEach(t),rc=c(di),_a=s(di,"SPAN",{});var wu=a(_a);ic=i(wu,"TFMarianModel"),wu.forEach(t),di.forEach(t),yr=c(n),ie=s(n,"DIV",{class:!0});var Ge=a(ie);b(ko.$$.fragment,Ge),lc=c(Ge),To=s(Ge,"P",{});var ci=a(To);dc=i(ci,`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),vi.forEach(t),rp=c(Pe),ya=s(Pe,"P",{});var Wu=a(ya);ip=i(Wu,"Finally, this model supports inherent JAX features such as:"),Wu.forEach(t),lp=c(Pe),We=s(Pe,"UL",{});var vn=a(We);xa=s(vn,"LI",{});var Ru=a(xa);Ao=s(Ru,"A",{href:!0,rel:!0});var Bu=a(Ao);dp=i(Bu,"Just-In-Time (JIT) compilation"),Bu.forEach(t),Ru.forEach(t),cp=c(vn),wa=s(vn,"LI",{});var Vu=a(wa);Oo=s(Vu,"A",{href:!0,rel:!0});var Gu=a(Oo);pp=i(Gu,"Automatic Differentiation"),Gu.forEach(t),Vu.forEach(t),hp=c(vn),$a=s(vn,"LI",{});var Ju=a($a);So=s(Ju,"A",{href:!0,rel:!0});var Yu=a(So);up=i(Yu,"Vectorization"),Yu.forEach(t),Ju.forEach(t),mp=c(vn),za=s(vn,"LI",{});var Ku=a(za);Ho=s(Ku,"A",{href:!0,rel:!0});var Zu=a(Ho);fp=i(Zu,"Parallelization"),Zu.forEach(t),Ku.forEach(t),vn.forEach(t),_p=c(Pe),Ee=s(Pe,"DIV",{class:!0});var kn=a(Ee);b(Do.$$.fragment,kn),gp=c(kn),xt=s(kn,"P",{});var Es=a(xt);vp=i(Es,"The "),ja=s(Es,"CODE",{});var Xu=a(ja);kp=i(Xu,"FlaxMarianPreTrainedModel"),Xu.forEach(t),Tp=i(Es," forward method, overrides the "),qa=s(Es,"CODE",{});var Qu=a(qa);Mp=i(Qu,"__call__"),Qu.forEach(t),bp=i(Es," special method."),Es.forEach(t),yp=c(kn),b(sn.$$.fragment,kn),xp=c(kn),b(an.$$.fragment,kn),kn.forEach(t),Pe.forEach(t),jr=c(n),wt=s(n,"H2",{class:!0});var ki=a(wt);rn=s(ki,"A",{id:!0,class:!0,href:!0});var em=a(rn);Ea=s(em,"SPAN",{});var tm=a(Ea);b(Uo.$$.fragment,tm),tm.forEach(t),em.forEach(t),wp=c(ki),Fa=s(ki,"SPAN",{});var nm=a(Fa);$p=i(nm,"FlaxMarianMTModel"),nm.forEach(t),ki.forEach(t),qr=c(n),B=s(n,"DIV",{class:!0});var Ne=a(B);b(Wo.$$.fragment,Ne),zp=c(Ne),Ro=s(Ne,"P",{});var Ti=a(Ro);jp=i(Ti,`The MARIAN Model with a language modeling head. Can be used for translation.
