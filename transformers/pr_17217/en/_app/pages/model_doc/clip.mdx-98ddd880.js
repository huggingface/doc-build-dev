import{S as dv,i as cv,s as pv,e as s,k as m,w as P,t as i,M as mv,c as r,d as o,m as f,a,x as $,h as l,b as h,F as e,g as v,y as I,q as T,o as C,B as y,v as fv,L as W}from"../../chunks/vendor-6b77c823.js";import{T as Z}from"../../chunks/Tip-39098574.js";import{D as k}from"../../chunks/Docstring-1088f2fb.js";import{C as A}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as D}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as S}from"../../chunks/ExampleCodeBlock-5212b321.js";function hv(x){let d,b,u,p,_;return p=new A({props:{code:`from transformers import CLIPTextModel, CLIPTextConfig
...
first positional argument :`),At=m(),K=s("ul"),Y=s("li"),De=i("a single Tensor with "),He=s("code"),Vt=i("input_ids"),Oe=i(" only and nothing else: "),we=s("code"),vn=i("model(input_ids)"),Nt=m(),O=s("li"),re=i(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),lr.forEach(o),At=f(w),K=r(w,"UL",{});var Ve=a(K);Y=r(Ve,"LI",{});var ie=a(Y);De=l(ie,"a single Tensor with "),He=r(ie,"CODE",{});var dr=a(He);Vt=l(dr,"input_ids"),dr.forEach(o),Oe=l(ie," only and nothing else: "),we=r(ie,"CODE",{});var cr=a(we);vn=l(cr,"model(input_ids)"),cr.forEach(o),ie.forEach(o),Nt=f(Ve),O=r(Ve,"LI",{});var le=a(O);re=l(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Ee=r(le,"CODE",{});var pr=a(Ee);Me=l(pr,"model([input_ids, attention_mask])"),pr.forEach(o),bn=l(le," or "),ze=r(le,"CODE",{});var mr=a(ze);Pn=l(mr,"model([input_ids, attention_mask, token_type_ids])"),mr.forEach(o),le.forEach(o),St=f(Ve),ee=r(Ve,"LI",{});var Ne=a(ee);$n=l(Ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Ae=r(Ne,"CODE",{});var fr=a(Ae);ae=l(fr,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),fr.forEach(o),Ne.forEach(o),Ve.forEach(o)},m(w,j){v(w,d,j),e(d,b),v(w,u,j),v(w,p,j),e(p,_),e(_,n),e(p,c),e(p,L),e(L,un),v(w,Re,j),v(w,z,j),e(z,se),e(z,ye),e(ye,xe),e(z,gn),e(z,Le),e(Le,_n),e(z,Ot),v(w,Q,j),v(w,qe,j),e(qe,ke),v(w,At,j),v(w,K,j),e(K,Y),e(Y,De),e(Y,He),e(He,Vt),e(Y,Oe),e(Y,we),e(we,vn),e(K,Nt),e(K,O),e(O,re),e(O,Ee),e(Ee,Me),e(O,bn),e(O,ze),e(ze,Pn),e(K,St),e(K,ee),e(ee,$n),e(ee,Ae),e(Ae,ae)},d(w){w&&o(d),w&&o(u),w&&o(p),w&&o(Re),w&&o(z),w&&o(Q),w&&o(qe),w&&o(At),w&&o(K)}}}function Lv(x){let d,b,u,p,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),p=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var c=a(d);b=l(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(c,"CODE",{});var L=a(u);p=l(L,"Module"),L.forEach(o),_=l(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text_features = model.get_text_features(**inputs)`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(p.$$.fragment)},l(n){d=r(n,"P",{});var c=a(d);b=l(c,"Examples:"),c.forEach(o),u=f(n),$(p.$$.fragment,n)},m(n,c){v(n,d,c),e(d,b),v(n,u,c),I(p,n,c),_=!0},p:W,i(n){_||(T(p.$$.fragment,n),_=!0)},o(n){C(p.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(p,n)}}}function Nv(x){let d,b,u,p,_;return p=new A({props:{code:`from PIL import Image
import requests
from transformers import CLIPProcessor, FlaxCLIPModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooler_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){d=s("p"),b=i("Example:"),u=m(),P(p.$$.fragment)},l(n){d=r(n,"P",{});var c=a(d);b=l(c,"Example:"),c.forEach(o),u=f(n),$(p.$$.fragment,n)},m(n,c){v(n,d,c),e(d,b),v(n,u,c),I(p,n,c),_=!0},p:W,i(n){_||(T(p.$$.fragment,n),_=!0)},o(n){C(p.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),y(p,n)}}}function Rv(x){let d,b,u,p,_,n,c,L,un,Re,z,se,ye,xe,gn,Le,_n,Ot,Q,qe,ke,At,K,Y,De,He,Vt,Oe,we,vn,Nt,O,re,Ee,Me,bn,ze,Pn,St,ee,$n,Ae,ae,w,j,Wt,ar,In,E,ir,Ke,lr,Ve,ie,dr,cr,le,pr,mr,Ne,fr,Fd,hr,qd,Dd,ur,Od,Ad,il,Tn,ll,Se,Vd,Cn,Nd,Sd,yn,Wd,Bd,dl,Ge,Bt,_a,xn,Ud,va,Rd,cl,te,Ln,Hd,Ut,gr,Kd,Gd,_r,Jd,Xd,Zd,Je,Qd,vr,Yd,ec,br,tc,oc,nc,Rt,kn,sc,wn,rc,Pr,ac,ic,pl,Xe,Ht,ba,En,lc,Pa,dc,ml,oe,Mn,cc,Ze,pc,$r,mc,fc,zn,hc,uc,gc,Qe,_c,Ir,vc,bc,Tr,Pc,$c,Ic,Kt,fl,Ye,Gt,$a,jn,Tc,Ia,Cc,hl,ne,Fn,yc,et,xc,Cr,Lc,kc,qn,wc,Ec,Mc,tt,zc,yr,jc,Fc,xr,qc,Dc,Oc,Jt,ul,ot,Xt,Ta,Dn,Ac,Ca,Vc,gl,F,On,Nc,ya,Sc,Wc,An,Bc,Lr,Uc,Rc,Hc,de,Vn,Kc,xa,Gc,Jc,La,kr,Xc,ka,Zc,Qc,wa,Yc,ep,Zt,Nn,tp,Sn,op,Ea,np,sp,rp,Qt,Wn,ap,Ma,ip,lp,wr,Bn,_l,nt,Yt,za,Un,dp,ja,cp,vl,U,Rn,pp,Hn,mp,Fa,fp,hp,up,Kn,gp,Er,_p,vp,bp,ce,Gn,Pp,qa,$p,Ip,Da,Mr,Tp,Oa,Cp,yp,Aa,xp,Lp,eo,Jn,kp,Va,wp,bl,st,to,Na,Xn,Ep,Sa,Mp,Pl,V,Zn,zp,Wa,jp,Fp,Qn,qp,zr,Dp,Op,Ap,oo,Yn,Vp,es,Np,Ba,Sp,Wp,Bp,no,ts,Up,rt,Rp,Ua,Hp,Kp,Ra,Gp,Jp,Xp,so,os,Zp,at,Qp,Ha,Yp,em,Ka,tm,om,$l,it,ro,Ga,ns,nm,Ja,sm,Il,R,ss,rm,Xa,am,im,G,jr,lm,dm,Fr,cm,pm,qr,mm,fm,Za,hm,um,Dr,gm,_m,vm,ao,rs,bm,as,Pm,Or,$m,Im,Tm,io,is,Cm,ls,ym,Ar,xm,Lm,Tl,lt,lo,Qa,ds,km,Ya,wm,Cl,H,cs,Em,ps,Mm,ms,zm,jm,Fm,pe,fs,qm,dt,Dm,Vr,Om,Am,ei,Vm,Nm,Sm,co,Wm,po,Bm,me,hs,Um,ct,Rm,Nr,Hm,Km,ti,Gm,Jm,Xm,mo,Zm,fo,Qm,fe,us,Ym,pt,ef,Sr,tf,of,oi,nf,sf,rf,ho,af,uo,yl,mt,go,ni,gs,lf,si,df,xl,ft,_s,cf,he,vs,pf,ht,mf,Wr,ff,hf,ri,uf,gf,_f,_o,vf,vo,Ll,ut,bo,ai,bs,bf,ii,Pf,kl,gt,Ps,$f,ue,$s,If,_t,Tf,Br,Cf,yf,li,xf,Lf,kf,Po,wf,$o,wl,vt,Io,di,Is,Ef,ci,Mf,El,q,Ts,zf,Cs,jf,Ur,Ff,qf,Df,ys,Of,xs,Af,Vf,Nf,To,Sf,ge,Ls,Wf,bt,Bf,Rr,Uf,Rf,pi,Hf,Kf,Gf,Co,Jf,yo,Xf,_e,ks,Zf,Pt,Qf,Hr,Yf,eh,mi,th,oh,nh,xo,sh,Lo,rh,ve,ws,ah,$t,ih,Kr,lh,dh,fi,ch,ph,mh,ko,fh,wo,Ml,It,Eo,hi,Es,hh,ui,uh,zl,Tt,Ms,gh,be,zs,_h,Ct,vh,Gr,bh,Ph,gi,$h,Ih,Th,Mo,Ch,zo,jl,yt,jo,_i,js,yh,vi,xh,Fl,xt,Fs,Lh,Pe,qs,kh,Lt,wh,Jr,Eh,Mh,bi,zh,jh,Fh,Fo,qh,qo,ql,kt,Do,Pi,Ds,Dh,$i,Oh,Dl,M,Os,Ah,As,Vh,Xr,Nh,Sh,Wh,Vs,Bh,Ns,Uh,Rh,Hh,Ii,Kh,Gh,je,Ti,Ss,Jh,Xh,Ci,Ws,Zh,Qh,yi,Bs,Yh,eu,xi,Us,tu,ou,$e,Rs,nu,wt,su,Li,ru,au,ki,iu,lu,du,Oo,cu,Ao,pu,Vo,Hs,mu,No,fu,So,Ks,hu,Wo,Ol,Et,Bo,wi,Gs,uu,Ei,gu,Al,Mt,Js,_u,Ie,Xs,vu,zt,bu,Mi,Pu,$u,zi,Iu,Tu,Cu,Uo,yu,Ro,Vl,jt,Ho,ji,Zs,xu,Fi,Lu,Nl,Ft,Qs,ku,Te,Ys,wu,qt,Eu,qi,Mu,zu,Di,ju,Fu,qu,Ko,Du,Go,Sl;return n=new D({}),xe=new D({}),Me=new D({}),Tn=new A({props:{code:`from PIL import Image
import requests
...
Dictionary of configuration options used to initialize <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPTextConfig">CLIPTextConfig</a>.`,name:"text_config_dict"},{anchor:"transformers.CLIPConfig.vision_config_dict",description:`<strong>vision_config_dict</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
Dictionary of configuration options used to initialize <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPVisionConfig">CLIPVisionConfig</a>.`,name:"vision_config_dict"},{anchor:"transformers.CLIPConfig.projection_dim",description:`<strong>projection_dim</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
Dictionary of keyword arguments.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/configuration_clip.py#L245"}}),kn=new k({props:{name:"from_text_vision_configs",anchor:"transformers.CLIPConfig.from_text_vision_configs",parameters:[{name:"text_config",val:": CLIPTextConfig"},{name:"vision_config",val:": CLIPVisionConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/configuration_clip.py#L294",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPConfig"
>CLIPConfig</a></p>
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPModel">CLIPModel</a>.`,name:"vocab_size"},{anchor:"transformers.CLIPTextConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/tokenization_clip.py#L186",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/tokenization_clip.py#L213",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/tokenization_clip.py#L241",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
The end of sequence token.`,name:"eos_token"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/tokenization_clip_fast.py#L50"}}),Gn=new k({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.CLIPTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.CLIPTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/tokenization_clip_fast.py#L123",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/tokenization_clip_fast.py#L150",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
The filter to user for resampling.`,name:"resample"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/feature_extraction_clip.py#L204"}}),ns=new D({}),ss=new k({props:{name:"class transformers.CLIPProcessor",anchor:"transformers.CLIPProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.CLIPProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>) &#x2014;
The feature extractor is a required input.`,name:"feature_extractor"},{anchor:"transformers.CLIPProcessor.tokenizer",description:`<strong>tokenizer</strong> (<a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPTokenizerFast">CLIPTokenizerFast</a>) &#x2014;
The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/processing_clip.py#L22"}}),rs=new k({props:{name:"batch_decode",anchor:"transformers.CLIPProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/processing_clip.py#L95"}}),is=new k({props:{name:"decode",anchor:"transformers.CLIPProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/processing_clip.py#L102"}}),ds=new D({}),cs=new k({props:{name:"class transformers.CLIPModel",anchor:"transformers.CLIPModel",parameters:[{name:"config",val:": CLIPConfig"}],parametersDescription:[{anchor:"transformers.CLIPModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPConfig">CLIPConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17217/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_clip.py#L847"}}),fs=new k({props:{name:"forward",anchor:"transformers.CLIPModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"return_loss",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CLIPModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17217/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17217/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See <code>CLIPFeatureExtractor.__call__()</code> for details.`,name:"pixel_values"},{anchor:"transformers.CLIPModel.forward.return_loss",description:`<strong>return_loss</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_clip.py#L978",returnDescription:`
...
<li><strong>text_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPTextModel"
>CLIPTextModel</a>.</li>
<li><strong>image_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The image embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPVisionModel"
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_clip.py#L882",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_clip.py#L929",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_clip.py#L698",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17217/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
...
`}}),_o=new Z({props:{$$slots:{default:[Iv]},$$scope:{ctx:x}}}),vo=new S({props:{anchor:"transformers.CLIPTextModel.forward.example",$$slots:{default:[Tv]},$$scope:{ctx:x}}}),bs=new D({}),Ps=new k({props:{name:"class transformers.CLIPVisionModel",anchor:"transformers.CLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_clip.py#L794"}}),$s=new k({props:{name:"forward",anchor:"transformers.CLIPVisionModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CLIPVisionModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_clip.py#L807",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17217/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_tf_clip.py#L1341",returnDescription:`
...
<li><strong>text_embeds(<code>tf.Tensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.TFCLIPTextModel"
...
<a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.TFCLIPVisionModel"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_tf_clip.py#L1259",returnDescription:`
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_tf_clip.py#L1299",returnDescription:`
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_tf_clip.py#L1048",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17217/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_tf_clip.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17217/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
>transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling</a> or a tuple of <code>tf.Tensor</code> (if
<code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various elements depending on the
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17217/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17217/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_flax_clip.py#L1148"}}),Rs=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPModel.__call__",parameters:[{name:"input_ids",val:""},{name:"pixel_values",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17217/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17217/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_flax_clip.py#L777",returnDescription:`
...
<a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
<a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.FlaxCLIPVisionModel"
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17217/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17217/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_flax_clip.py#L822",returnDescription:`
<p>The text embeddings obtained by applying
the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
`}}),No=new S({props:{anchor:"transformers.FlaxCLIPModel.get_text_features.example",$$slots:{default:[Vv]},$$scope:{ctx:x}}}),Ks=new k({props:{name:"get_image_features",anchor:"transformers.FlaxCLIPModel.get_image_features",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:" = False"}],parametersDescription:[{anchor:"transformers.FlaxCLIPModel.get_image_features.pixel_values",description:`<strong>pixel_values</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained
using <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See <code>CLIPFeatureExtractor.__call__()</code> for details.`,name:"pixel_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_flax_clip.py#L889",returnDescription:`
<p>The image embeddings obtained by
applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.FlaxCLIPVisionModel"
...
`}}),Wo=new S({props:{anchor:"transformers.FlaxCLIPModel.get_image_features.example",$$slots:{default:[Nv]},$$scope:{ctx:x}}}),Gs=new D({}),Js=new k({props:{name:"class transformers.FlaxCLIPTextModel",anchor:"transformers.FlaxCLIPTextModel",parameters:[{name:"config",val:": CLIPTextConfig"},{name:"input_shape",val:" = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_flax_clip.py#L969"}}),Xs=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPTextModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPTextModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17217/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_17217/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17217/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_flax_clip.py#L622",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17217/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
`}}),Uo=new Z({props:{$$slots:{default:[Sv]},$$scope:{ctx:x}}}),Ro=new S({props:{anchor:"transformers.FlaxCLIPTextModel.__call__.example",$$slots:{default:[Wv]},$$scope:{ctx:x}}}),Zs=new D({}),Qs=new k({props:{name:"class transformers.FlaxCLIPVisionModel",anchor:"transformers.FlaxCLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_flax_clip.py#L1022"}}),Ys=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPVisionModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPVisionModel.__call__.pixel_values",description:`<strong>pixel_values</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
Whether or not to return a <a href="/docs/transformers/pr_17217/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17217/src/transformers/models/clip/modeling_flax_clip.py#L702",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17217/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
for the task, similarly to the zero-shot capabilities of GPT-2 and 3.`),Y=m(),De=s("p"),He=i("The abstract from the paper is the following:"),Vt=m(),Oe=s("p"),we=s("em"),vn=i(`State-of-the-art computer vision systems are trained to predict a fixed set of predetermined object categories. This
...
model weights at this https URL.`),Nt=m(),O=s("h2"),re=s("a"),Ee=s("span"),P(Me.$$.fragment),bn=m(),ze=s("span"),Pn=i("Usage"),St=m(),ee=s("p"),$n=i(`CLIP is a multi-modal vision and language model. It can be used for image-text similarity and for zero-shot image
...
The `),j=s("a"),Wt=i("CLIPFeatureExtractor"),ar=i(" can be used to resize (or rescale) and normalize images for the model."),In=m(),E=s("p"),ir=i("The "),Ke=s("a"),lr=i("CLIPTokenizer"),Ve=i(" is used to encode the text. The "),ie=s("a"),dr=i("CLIPProcessor"),cr=i(` wraps
`),le=s("a"),pr=i("CLIPFeatureExtractor"),mr=i(" and "),Ne=s("a"),fr=i("CLIPTokenizer"),Fd=i(` into a single instance to both
encode the text and prepare the images. The following example shows how to get the image-text similarity scores using
`),hr=s("a"),qd=i("CLIPProcessor"),Dd=i(" and "),ur=s("a"),Od=i("CLIPModel"),Ad=i("."),il=m(),P(Tn.$$.fragment),ll=m(),Se=s("p"),Vd=i("This model was contributed by "),Cn=s("a"),Nd=i("valhalla"),Sd=i(". The original code can be found "),yn=s("a"),Wd=i("here"),Bd=i("."),dl=m(),Ge=s("h2"),Bt=s("a"),_a=s("span"),P(xn.$$.fragment),Ud=m(),va=s("span"),Rd=i("CLIPConfig"),cl=m(),te=s("div"),P(Ln.$$.fragment),Hd=m(),Ut=s("p"),gr=s("a"),Kd=i("CLIPConfig"),Gd=i(" is the configuration class to store the configuration of a "),_r=s("a"),Jd=i("CLIPModel"),Xd=i(`. It is used to instantiate
...
documentation from `),xr=s("a"),qc=i("PretrainedConfig"),Dc=i(" for more information."),Oc=m(),P(Jt.$$.fragment),ul=m(),ot=s("h2"),Xt=s("a"),Ta=s("span"),P(Dn.$$.fragment),Ac=m(),Ca=s("span"),Vc=i("CLIPTokenizer"),gl=m(),F=s("div"),P(On.$$.fragment),Nc=m(),ya=s("p"),Sc=i("Construct a CLIP tokenizer. Based on byte-level Byte-Pair-Encoding."),Wc=m(),An=s("p"),Bc=i("This tokenizer inherits from "),Lr=s("a"),Uc=i("PreTrainedTokenizer"),Rc=i(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Hc=m(),de=s("div"),P(Vn.$$.fragment),Kc=m(),xa=s("p"),Gc=i(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),Jc=m(),La=s("ul"),kr=s("li"),Xc=i("single sequence: "),ka=s("code"),Zc=i("<|startoftext|> X <|endoftext|>"),Qc=m(),wa=s("p"),Yc=i("Pairs of sequences are not the expected use case, but they will be handled without a separator."),ep=m(),Zt=s("div"),P(Nn.$$.fragment),tp=m(),Sn=s("p"),op=i(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
adding special tokens. A CLIP sequence has the following format:`),Ip=m(),Da=s("ul"),Mr=s("li"),Tp=i("single sequence: "),Oa=s("code"),Cp=i("<|startoftext|> X <|endoftext|>"),yp=m(),Aa=s("p"),xp=i("Pairs of sequences are not the expected use case, but they will be handled without a separator."),Lp=m(),eo=s("div"),P(Jn.$$.fragment),kp=m(),Va=s("p"),wp=i(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),bl=m(),st=s("h2"),to=s("a"),Na=s("span"),P(Xn.$$.fragment),Ep=m(),Sa=s("span"),Mp=i("CLIPFeatureExtractor"),Pl=m(),V=s("div"),P(Zn.$$.fragment),zp=m(),Wa=s("p"),jp=i("Constructs a CLIP feature extractor."),Fp=m(),Qn=s("p"),qp=i("This feature extractor inherits from "),zr=s("a"),Dp=i("FeatureExtractionMixin"),Op=i(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Ap=m(),oo=s("div"),P(Yn.$$.fragment),Vp=m(),es=s("p"),Np=i("Crops "),Ba=s("code"),Sp=i("image"),Wp=i(` to the given size using a center crop. Note that if the image is too small to be cropped to the
...
for any dataset specific training. For instance, we match the accuracy of the original ResNet-50 on ImageNet zero-shot
without needing to use any of the 1.28 million training examples it was trained on. We release our code and pre-trained
model weights at this https URL.`),Hi.forEach(o),Ri.forEach(o),Nt=f(t),O=r(t,"H2",{class:!0});var nr=a(O);re=r(nr,"A",{id:!0,class:!0,href:!0});var Ki=a(re);Ee=r(Ki,"SPAN",{});var Gi=a(Ee);$(Me.$$.fragment,Gi),Gi.forEach(o),Ki.forEach(o),bn=f(nr),ze=r(nr,"SPAN",{});var Ji=a(ze);Pn=l(Ji,"Usage"),Ji.forEach(o),nr.forEach(o),St=f(t),ee=r(t,"P",{});var Xi=a(ee);$n=l(Xi,`CLIP is a multi-modal vision and language model. It can be used for image-text similarity and for zero-shot image
classification. CLIP uses a ViT like transformer to get visual features and a causal language model to get the text
features. Both the text and visual features are then projected to a latent space with identical dimension. The dot
...
which are then linearly embedded. A [CLS] token is added to serve as representation of an entire image. The authors
also add absolute position embeddings, and feed the resulting sequence of vectors to a standard Transformer encoder.
The `),j=r(sr,"A",{href:!0});var Zi=a(j);Wt=l(Zi,"CLIPFeatureExtractor"),Zi.forEach(o),ar=l(sr," can be used to resize (or rescale) and normalize images for the model."),sr.forEach(o),In=f(t),E=r(t,"P",{});var N=a(E);ir=l(N,"The "),Ke=r(N,"A",{href:!0});var Qi=a(Ke);lr=l(Qi,"CLIPTokenizer"),Qi.forEach(o),Ve=l(N," is used to encode the text. The "),ie=r(N,"A",{href:!0});var Yi=a(ie);dr=l(Yi,"CLIPProcessor"),Yi.forEach(o),cr=l(N,` wraps
`),le=r(N,"A",{href:!0});var el=a(le);pr=l(el,"CLIPFeatureExtractor"),el.forEach(o),mr=l(N," and "),Ne=r(N,"A",{href:!0});var tl=a(Ne);fr=l(tl,"CLIPTokenizer"),tl.forEach(o),Fd=l(N,` into a single instance to both
encode the text and prepare the images. The following example shows how to get the image-text similarity scores using
`),hr=r(N,"A",{href:!0});var ol=a(hr);qd=l(ol,"CLIPProcessor"),ol.forEach(o),Dd=l(N," and "),ur=r(N,"A",{href:!0});var nl=a(ur);Od=l(nl,"CLIPModel"),nl.forEach(o),Ad=l(N,"."),N.forEach(o),il=f(t),$(Tn.$$.fragment,t),ll=f(t),Se=r(t,"P",{});var Dt=a(Se);Vd=l(Dt,"This model was contributed by "),Cn=r(Dt,"A",{href:!0,rel:!0});var sl=a(Cn);Nd=l(sl,"valhalla"),sl.forEach(o),Sd=l(Dt,". The original code can be found "),yn=r(Dt,"A",{href:!0,rel:!0});var rl=a(yn);Wd=l(rl,"here"),rl.forEach(o),Bd=l(Dt,"."),Dt.forEach(o),dl=f(t),Ge=r(t,"H2",{class:!0});var rr=a(Ge);Bt=r(rr,"A",{id:!0,class:!0,href:!0});var Vu=a(Bt);_a=r(Vu,"SPAN",{});var Nu=a(_a);$(xn.$$.fragment,Nu),Nu.forEach(o),Vu.forEach(o),Ud=f(rr),va=r(rr,"SPAN",{});var Su=a(va);Rd=l(Su,"CLIPConfig"),Su.forEach(o),rr.forEach(o),cl=f(t),te=r(t,"DIV",{class:!0});var Jo=a(te);$(Ln.$$.fragment,Jo),Hd=f(Jo),Ut=r(Jo,"P",{});var al=a(Ut);gr=r(al,"A",{href:!0});var Wu=a(gr);Kd=l(Wu,"CLIPConfig"),Wu.forEach(o),Gd=l(al," is the configuration class to store the configuration of a "),_r=r(al,"A",{href:!0});var Bu=a(_r);Jd=l(Bu,"CLIPModel"),Bu.forEach(o),Xd=l(al,`. It is used to instantiate
...
documentation from `),xr=r(ta,"A",{href:!0});var ag=a(xr);qc=l(ag,"PretrainedConfig"),ag.forEach(o),Dc=l(ta," for more information."),ta.forEach(o),Oc=f(Zo),$(Jt.$$.fragment,Zo),Zo.forEach(o),ul=f(t),ot=r(t,"H2",{class:!0});var Hl=a(ot);Xt=r(Hl,"A",{id:!0,class:!0,href:!0});var ig=a(Xt);Ta=r(ig,"SPAN",{});var lg=a(Ta);$(Dn.$$.fragment,lg),lg.forEach(o),ig.forEach(o),Ac=f(Hl),Ca=r(Hl,"SPAN",{});var dg=a(Ca);Vc=l(dg,"CLIPTokenizer"),dg.forEach(o),Hl.forEach(o),gl=f(t),F=r(t,"DIV",{class:!0});var J=a(F);$(On.$$.fragment,J),Nc=f(J),ya=r(J,"P",{});var cg=a(ya);Sc=l(cg,"Construct a CLIP tokenizer. Based on byte-level Byte-Pair-Encoding."),cg.forEach(o),Wc=f(J),An=r(J,"P",{});var Kl=a(An);Bc=l(Kl,"This tokenizer inherits from "),Lr=r(Kl,"A",{href:!0});var pg=a(Lr);Uc=l(pg,"PreTrainedTokenizer"),pg.forEach(o),Rc=l(Kl,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Kl.forEach(o),Hc=f(J),de=r(J,"DIV",{class:!0});var Qo=a(de);$(Vn.$$.fragment,Qo),Kc=f(Qo),xa=r(Qo,"P",{});var mg=a(xa);Gc=l(mg,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),mg.forEach(o),Jc=f(Qo),La=r(Qo,"UL",{});var fg=a(La);kr=r(fg,"LI",{});var Ou=a(kr);Xc=l(Ou,"single sequence: "),ka=r(Ou,"CODE",{});var hg=a(ka);Zc=l(hg,"<|startoftext|> X <|endoftext|>"),hg.forEach(o),Ou.forEach(o),fg.forEach(o),Qc=f(Qo),wa=r(Qo,"P",{});var ug=a(wa);Yc=l(ug,"Pairs of sequences are not the expected use case, but they will be handled without a separator."),ug.forEach(o),Qo.forEach(o),ep=f(J),Zt=r(J,"DIV",{class:!0});var Gl=a(Zt);$(Nn.$$.fragment,Gl),tp=f(Gl),Sn=r(Gl,"P",{});var Jl=a(Sn);op=l(Jl,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
