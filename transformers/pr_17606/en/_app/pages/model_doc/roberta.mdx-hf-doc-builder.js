...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17606/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17606/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17606/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q$=h(kt),kh=s(kt,"P",{});var x6=a(kh);V$=i(x6,"Finally, this model supports inherent JAX features such as:"),x6.forEach(t),J$=h(kt),Vt=s(kt,"UL",{});var ha=a(Vt);vh=s(ha,"LI",{});var R6=a(vh);tl=s(R6,"A",{href:!0,rel:!0});var M6=a(tl);K$=i(M6,"Just-In-Time (JIT) compilation"),M6.forEach(t),R6.forEach(t),G$=h(ha),yh=s(ha,"LI",{});var E6=a(yh);ol=s(E6,"A",{href:!0,rel:!0});var z6=a(ol);X$=i(z6,"Automatic Differentiation"),z6.forEach(t),E6.forEach(t),Y$=h(ha),Th=s(ha,"LI",{});var C6=a(Th);nl=s(C6,"A",{href:!0,rel:!0});var q6=a(nl);Z$=i(q6,"Vectorization"),q6.forEach(t),C6.forEach(t),e0=h(ha),wh=s(ha,"LI",{});var j6=a(wh);sl=s(j6,"A",{href:!0,rel:!0});var P6=a(sl);t0=i(P6,"Parallelization"),P6.forEach(t),j6.forEach(t),ha.forEach(t),o0=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n0=h(ma),an=s(ma,"P",{});var ic=a(an);s0=i(ic,"The "),$h=s(ic,"CODE",{});var L6=a($h);a0=i(L6,"FlaxRobertaPreTrainedModel"),L6.forEach(t),r0=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var A6=a(Fh);i0=i(A6,"__call__"),A6.forEach(t),l0=i(ic," special method."),ic.forEach(t),d0=h(ma),T(Bs.$$.fragment,ma),c0=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var O6=a(Hs);xh=s(O6,"SPAN",{});var N6=a(xh);T(rl.$$.fragment,N6),N6.forEach(t),O6.forEach(t),p0=h(Gu),Rh=s(Gu,"SPAN",{});var I6=a(Rh);h0=i(I6,"FlaxRobertaForMultipleChoice"),I6.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m0=h(vt),Mh=s(vt,"P",{});var D6=a(Mh);f0=i(D6,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D6.forEach(t),u0=h(vt),ll=s(vt,"P",{});var Xu=a(ll);g0=i(Xu,"This model inherits from "),Ad=s(Xu,"A",{href:!0});var S6=a(Ad);_0=i(S6,"FlaxPreTrainedModel"),S6.forEach(t),b0=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k0=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v0=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var W6=a(cl);y0=i(W6,"flax.linen.Module"),W6.forEach(t),T0=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w0=h(vt),Eh=s(vt,"P",{});var B6=a(Eh);$0=i(B6,"Finally, this model supports inherent JAX features such as:"),B6.forEach(t),F0=h(vt),Jt=s(vt,"UL",{});var fa=a(Jt);zh=s(fa,"LI",{});var U6=a(zh);pl=s(U6,"A",{href:!0,rel:!0});var H6=a(pl);x0=i(H6,"Just-In-Time (JIT) compilation"),H6.forEach(t),U6.forEach(t),R0=h(fa),Ch=s(fa,"LI",{});var Q6=a(Ch);hl=s(Q6,"A",{href:!0,rel:!0});var V6=a(hl);M0=i(V6,"Automatic Differentiation"),V6.forEach(t),Q6.forEach(t),E0=h(fa),qh=s(fa,"LI",{});var J6=a(qh);ml=s(J6,"A",{href:!0,rel:!0});var K6=a(ml);z0=i(K6,"Vectorization"),K6.forEach(t),J6.forEach(t),C0=h(fa),jh=s(fa,"LI",{});var G6=a(jh);fl=s(G6,"A",{href:!0,rel:!0});var X6=a(fl);q0=i(X6,"Parallelization"),X6.forEach(t),G6.forEach(t),fa.forEach(t),j0=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);T(ul.$$.fragment,ua),P0=h(ua),ln=s(ua,"P",{});var lc=a(ln);L0=i(lc,"The "),Ph=s(lc,"CODE",{});var Y6=a(Ph);A0=i(Y6,"FlaxRobertaPreTrainedModel"),Y6.forEach(t),O0=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var Z6=a(Lh);N0=i(Z6,"__call__"),Z6.forEach(t),I0=i(lc," special method."),lc.forEach(t),D0=h(ua),T(Qs.$$.fragment,ua),S0=h(ua),T(Vs.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Js=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Js);Ah=s(eM,"SPAN",{});var tM=a(Ah);T(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W0=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B0=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var yt=a(We);T(_l.$$.fragment,yt),U0=h(yt),Nh=s(yt,"P",{});var nM=a(Nh);H0=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
