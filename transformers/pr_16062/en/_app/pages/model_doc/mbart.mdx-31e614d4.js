...
`,returnType:`
<p><code>List[int]</code></p>
`}}),_a=new B({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart/tokenization_mbart_fast.py#L251"}}),ga=new B({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart/tokenization_mbart_fast.py#L266"}}),ka=new U({}),ba=new B({props:{name:"class transformers.MBart50Tokenizer",anchor:"transformers.MBart50Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart50/tokenization_mbart50.py#L48",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ea=new B({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart50/tokenization_mbart50.py#L348"}}),Pa=new B({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart50/tokenization_mbart50.py#L354"}}),Ca=new U({}),Aa=new B({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L57",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16062/en/model_doc/mbart#transformers.MBartConfig"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16062/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hs=new B({props:{name:"forward",anchor:"transformers.MBartForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart/modeling_mbart.py#L1563",parametersDescription:[{anchor:"transformers.MBartForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16062/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16062/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16062/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16062/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16062/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bs=new B({props:{name:"forward",anchor:"transformers.MBartForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart/modeling_mbart.py#L1437",parametersDescription:[{anchor:"transformers.MBartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16062/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16062/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16062/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16062/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16062/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Rz]},$$scope:{ctx:E}}}),Ns=new B({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16062/src/transformers/models/mbart/modeling_tf_mbart.py#L1335",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16062/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16062/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16062/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16062/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16062/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16062/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16062/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
This model inherits from `),xi=a(ku,"A",{href:!0});var t0=s(xi);bv=i(t0,"TFPreTrainedModel"),t0.forEach(t),vv=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),yv=l(Lt),Ss=a(Lt,"P",{});var bu=s(Ss);Tv=i(bu,"This model is also a "),Is=a(bu,"A",{href:!0,rel:!0});var o0=s(Is);Mv=i(o0,"tf.keras.Model"),o0.forEach(t),wv=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),zv=l(Lt),f(un.$$.fragment,Lt),xv=l(Lt),ee=a(Lt,"DIV",{class:!0});var Re=s(ee);f(Ns.$$.fragment,Re),Bv=l(Re),zo=a(Re,"P",{});var Xi=s(zo);qv=i(Xi,"The "),Bi=a(Xi,"A",{href:!0});var n0=s(Bi);$v=i(n0,"TFMBartForConditionalGeneration"),n0.forEach(t),Fv=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var a0=s(rc);jv=i(a0,"__call__"),a0.forEach(t),Ev=i(Xi," special method."),Xi.forEach(t),Pv=l(Re),f(mn.$$.fragment,Re),Cv=l(Re),ic=a(Re,"P",{});var s0=s(ic);Av=i(s0,"Summarization example:"),s0.forEach(t),Sv=l(Re),f(Ds.$$.fragment,Re),Iv=l(Re),dc=a(Re,"P",{});var r0=s(dc);Nv=i(r0,"Mask filling example:"),r0.forEach(t),Dv=l(Re),f(Os.$$.fragment,Re),Re.forEach(t),Lt.forEach(t),oh=l(o),xo=a(o,"H2",{class:!0});var vu=s(xo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var i0=s(fn);lc=a(i0,"SPAN",{});var d0=s(lc);f(Ls.$$.fragment,d0),d0.forEach(t),i0.forEach(t),Ov=l(vu),cc=a(vu,"SPAN",{});var l0=s(cc);Lv=i(l0,"FlaxMBartModel"),l0.forEach(t),vu.forEach(t),nh=l(o),R=a(o,"DIV",{class:!0});var me=s(R);f(Gs.$$.fragment,me),Gv=l(me),Rs=a(me,"P",{});var yu=s(Rs);Rv=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(yu,"A",{href:!0});var c0=s(qi);Wv=i(c0,"FlaxPreTrainedModel"),c0.forEach(t),Uv=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),rr=a(zu,"A",{href:!0,rel:!0});var F0=s(rr);Py=i(F0,"flax.nn.Module"),F0.forEach(t),Cy=i(zu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zu.forEach(t),Ay=l(fe),Mc=a(fe,"P",{});var j0=s(Mc);Sy=i(j0,"Finally, this model supports inherent JAX features such as:"),j0.forEach(t),Iy=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var E0=s(wc);ir=a(E0,"A",{href:!0,rel:!0});var P0=s(ir);Ny=i(P0,"Just-In-Time (JIT) compilation"),P0.forEach(t),E0.forEach(t),Dy=l(jn),zc=a(jn,"LI",{});var C0=s(zc);dr=a(C0,"A",{href:!0,rel:!0});var A0=s(dr);Oy=i(A0,"Automatic Differentiation"),A0.forEach(t),C0.forEach(t),Ly=l(jn),xc=a(jn,"LI",{});var S0=s(xc);lr=a(S0,"A",{href:!0,rel:!0});var I0=s(lr);Gy=i(I0,"Vectorization"),I0.forEach(t),S0.forEach(t),Ry=l(jn),Bc=a(jn,"LI",{});var N0=s(Bc);cr=a(N0,"A",{href:!0,rel:!0});var D0=s(cr);Wy=i(D0,"Parallelization"),D0.forEach(t),N0.forEach(t),jn.forEach(t),Uy=l(fe),te=a(fe,"DIV",{class:!0});var We=s(te);f(pr.$$.fragment,We),Xy=l(We),$o=a(We,"P",{});var Ji=s($o);Hy=i(Ji,"The "),qc=a(Ji,"CODE",{});var O0=s(qc);Vy=i(O0,"FlaxMBartPreTrainedModel"),O0.forEach(t),Qy=i(Ji,"forward method, overrides the "),$c=a(Ji,"CODE",{});var L0=s($c);Jy=i(L0,"__call__"),L0.forEach(t),Ky=i(Ji," special method."),Ji.forEach(t),Zy=l(We),f(kn.$$.fragment,We),Yy=l(We),Fc=a(We,"P",{});var G0=s(Fc);eT=i(G0,"Summarization example:"),G0.forEach(t),tT=l(We),f(hr.$$.fragment,We),oT=l(We),jc=a(We,"P",{});var R0=s(jc);nT=i(R0,"Mask filling example:"),R0.forEach(t),aT=l(We),f(ur.$$.fragment,We),We.forEach(t),sT=l(fe),zt=a(fe,"DIV",{class:!0});var Ki=s(zt);f(mr.$$.fragment,Ki),rT=l(Ki),Ec=a(Ki,"P",{});var W0=s(Ec);iT=i(W0,"Example:"),W0.forEach(t),dT=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),lT=l(fe),xt=a(fe,"DIV",{class:!0});var Zi=s(xt);f(_r.$$.fragment,Zi),cT=l(Zi),Pc=a(Zi,"P",{});var U0=s(Pc);pT=i(U0,"Example:"),U0.forEach(t),hT=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),Fo=a(o,"H2",{class:!0});var xu=s(Fo);bn=a(xu,"A",{id:!0,class:!0,href:!0});var X0=s(bn);Cc=a(X0,"SPAN",{});var H0=s(Cc);f(kr.$$.fragment,H0),H0.forEach(t),X0.forEach(t),uT=l(xu),Ac=a(xu,"SPAN",{});var V0=s(Ac);mT=i(V0,"FlaxMBartForSequenceClassification"),V0.forEach(t),xu.forEach(t),ih=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(br.$$.fragment,oe),fT=l(oe),Sc=a(oe,"P",{});var Q0=s(Sc);_T=i(Q0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Q0.forEach(t),gT=l(oe),vr=a(oe,"P",{});var Bu=s(vr);kT=i(Bu,"This model inherits from "),Fi=a(Bu,"A",{href:!0});var J0=s(Fi);bT=i(J0,"FlaxPreTrainedModel"),J0.forEach(t),vT=i(Bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bu.forEach(t),yT=l(oe),yr=a(oe,"P",{});var qu=s(yr);TT=i(qu,`This model is also a Flax Linen
`),Tr=a(qu,"A",{href:!0,rel:!0});var K0=s(Tr);MT=i(K0,"flax.nn.Module"),K0.forEach(t),wT=i(qu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),qu.forEach(t),zT=l(oe),Ic=a(oe,"P",{});var Z0=s(Ic);xT=i(Z0,"Finally, this model supports inherent JAX features such as:"),Z0.forEach(t),BT=l(oe),_t=a(oe,"UL",{});var En=s(_t);Nc=a(En,"LI",{});var Y0=s(Nc);Mr=a(Y0,"A",{href:!0,rel:!0});var ez=s(Mr);qT=i(ez,"Just-In-Time (JIT) compilation"),ez.forEach(t),Y0.forEach(t),$T=l(En),Dc=a(En,"LI",{});var tz=s(Dc);wr=a(tz,"A",{href:!0,rel:!0});var oz=s(wr);FT=i(oz,"Automatic Differentiation"),oz.forEach(t),tz.forEach(t),jT=l(En),Oc=a(En,"LI",{});var nz=s(Oc);zr=a(nz,"A",{href:!0,rel:!0});var az=s(zr);ET=i(az,"Vectorization"),az.forEach(t),nz.forEach(t),PT=l(En),Lc=a(En,"LI",{});var sz=s(Lc);xr=a(sz,"A",{href:!0,rel:!0});var rz=s(xr);CT=i(rz,"Parallelization"),rz.forEach(t),sz.forEach(t),En.forEach(t),AT=l(oe),De=a(oe,"DIV",{class:!0});var Rt=s(De);f(Br.$$.fragment,Rt),ST=l(Rt),jo=a(Rt,"P",{});var Yi=s(jo);IT=i(Yi,"The "),Gc=a(Yi,"CODE",{});var iz=s(Gc);NT=i(iz,"FlaxMBartPreTrainedModel"),iz.forEach(t),DT=i(Yi,"forward method, overrides the "),Rc=a(Yi,"CODE",{});var dz=s(Rc);OT=i(dz,"__call__"),dz.forEach(t),LT=i(Yi," special method."),Yi.forEach(t),GT=l(Rt),f(vn.$$.fragment,Rt),RT=l(Rt),Wc=a(Rt,"P",{});var lz=s(Wc);WT=i(lz,"Example:"),lz.forEach(t),UT=l(Rt),f(qr.$$.fragment,Rt),Rt.forEach(t),XT=l(oe),Bt=a(oe,"DIV",{class:!0});var ed=s(Bt);f($r.$$.fragment,ed),HT=l(ed),Uc=a(ed,"P",{});var cz=s(Uc);VT=i(cz,"Example:"),cz.forEach(t),QT=l(ed),f(Fr.$$.fragment,ed),ed.forEach(t),JT=l(oe),qt=a(oe,"DIV",{class:!0});var td=s(qt);f(jr.$$.fragment,td),KT=l(td),Xc=a(td,"P",{});var pz=s(Xc);ZT=i(pz,"Example:"),pz.forEach(t),YT=l(td),f(Er.$$.fragment,td),td.forEach(t),oe.forEach(t),dh=l(o),Eo=a(o,"H2",{class:!0});var $u=s(Eo);yn=a($u,"A",{id:!0,class:!0,href:!0});var hz=s(yn);Hc=a(hz,"SPAN",{});var uz=s(Hc);f(Pr.$$.fragment,uz),uz.forEach(t),hz.forEach(t),e1=l($u),Vc=a($u,"SPAN",{});var mz=s(Vc);t1=i(mz,"FlaxMBartForQuestionAnswering"),mz.forEach(t),$u.forEach(t),lh=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Cr.$$.fragment,ne),o1=l(ne),Po=a(ne,"P",{});var od=s(Po);n1=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
