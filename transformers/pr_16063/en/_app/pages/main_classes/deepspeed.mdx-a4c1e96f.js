...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16063/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16063/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16063/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16063/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16063/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),np=new y({}),{c(){w=o("meta"),M=u(),b=o("h1"),$=o("a"),ms=o("span"),f(F.$$.fragment),Nn=u(),_s=o("span"),vs=a("DeepSpeed Integration"),ht=u(),V=o("p"),Y=o("a"),Z=a("DeepSpeed"),yp=a(" implements everything described in the "),$e=o("a"),wp=a("ZeRO paper"),ZE=a(". Currently it provides full support for:"),pj=u(),D=o("ol"),Ch=o("li"),NE=a("Optimizer state partitioning (ZeRO stage 1)"),HE=u(),xh=o("li"),BE=a("Gradient partitioning (ZeRO stage 2)"),WE=u(),Rh=o("li"),FE=a("Parameter partitioning (ZeRO stage 3)"),VE=u(),Ih=o("li"),YE=a("Custom mixed precision training handling"),KE=u(),Uh=o("li"),JE=a("A range of fast CUDA-extension-based optimizers"),XE=u(),Gh=o("li"),QE=a("ZeRO-Offload to CPU and NVMe"),ij=u(),ke=o("p"),e6=a("ZeRO-Offload has its own dedicated paper: "),Hn=o("a"),s6=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),t6=a(". And NVMe-support is described in the paper "),Bn=o("a"),a6=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),n6=a("."),uj=u(),bp=o("p"),o6=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),cj=u(),qp=o("p"),l6=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),hj=u(),ft=o("p"),r6=a("\u{1F917} Transformers integrates "),Wn=o("a"),p6=a("DeepSpeed"),i6=a(" via 2 options:"),fj=u(),dt=o("ol"),Fn=o("li"),u6=a("Integration of the core DeepSpeed features via "),Ep=o("a"),c6=a("Trainer"),h6=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),f6=u(),L=o("li"),d6=a("If you don\u2019t use "),$p=o("a"),m6=a("Trainer"),_6=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Lh=o("code"),v6=a("from_pretrained"),j6=a(" and "),Mh=o("code"),g6=a("from_config"),y6=a(` include integration of essential
parts of DeepSpeed like `),Zh=o("code"),w6=a("zero.Init"),b6=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),kp=o("a"),q6=a("deepspeed-non-trainer-integration"),E6=a("."),dj=u(),Pp=o("p"),$6=a("What is integrated:"),mj=u(),zp=o("p"),k6=a("Training:"),_j=u(),Dp=o("ol"),Nh=o("li"),P6=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),vj=u(),Op=o("p"),z6=a("Inference:"),jj=u(),Tp=o("ol"),Vn=o("li"),D6=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Ap=o("a"),O6=a("deepspeed-zero-inference"),T6=a("."),gj=u(),Sp=o("p"),A6=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),yj=u(),Cp=o("a"),wj=u(),js=o("h2"),mt=o("a"),Hh=o("span"),f(Yn.$$.fragment),S6=u(),Bh=o("span"),C6=a("Trainer Deepspeed Integration"),bj=u(),xp=o("a"),qj=u(),gs=o("h3"),_t=o("a"),Wh=o("span"),f(Kn.$$.fragment),x6=u(),Fh=o("span"),R6=a("Installation"),Ej=u(),Rp=o("p"),I6=a("Install the library via pypi:"),$j=u(),f(Jn.$$.fragment),kj=u(),Pe=o("p"),U6=a("or via "),Vh=o("code"),G6=a("transformers"),L6=a("\u2019 "),Yh=o("code"),M6=a("extras"),Z6=a(":"),Pj=u(),f(Xn.$$.fragment),zj=u(),ze=o("p"),N6=a("or find more details on "),Qn=o("a"),H6=a("the DeepSpeed\u2019s GitHub page"),B6=a(` and
`),eo=o("a"),W6=a("advanced install"),F6=a("."),Dj=u(),vt=o("p"),V6=a("If you\u2019re still struggling with the build, first make sure to read "),Ip=o("a"),Y6=a("zero-install-notes"),K6=a("."),Oj=u(),Up=o("p"),J6=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),Tj=u(),Gp=o("p"),X6=a("To make a local build for DeepSpeed:"),Aj=u(),f(so.$$.fragment),Sj=u(),De=o("p"),Q6=a("If you intend to use NVMe offload you will also need to include "),Kh=o("code"),e$=a("DS_BUILD_AIO=1"),s$=a(` in the instructions above (and also
...
following:`),eg=u(),$t=o("ol"),ws=o("li"),H$=a("replace "),cf=o("code"),B$=a("python -m torch.distributed.launch"),W$=a(" with "),hf=o("code"),F$=a("deepspeed"),V$=a("."),Y$=u(),ye=o("li"),K$=a("add a new argument "),ff=o("code"),J$=a("--deepspeed ds_config.json"),X$=a(", where "),df=o("code"),Q$=a("ds_config.json"),e5=a(` is the DeepSpeed configuration file as
documented `),uo=o("a"),s5=a("here"),t5=a(". The file naming is up to you."),sg=u(),Wp=o("p"),a5=a("Therefore, if your original command line looked as follows:"),tg=u(),f(co.$$.fragment),ag=u(),Fp=o("p"),n5=a("Now it should be:"),ng=u(),f(ho.$$.fragment),og=u(),O=o("p"),o5=a("Unlike, "),mf=o("code"),l5=a("torch.distributed.launch"),r5=a(" where you have to specify how many GPUs to use with "),_f=o("code"),p5=a("--nproc_per_node"),i5=a(`, with the
`),vf=o("code"),u5=a("deepspeed"),c5=a(" launcher you don\u2019t have to use the corresponding "),jf=o("code"),h5=a("--num_gpus"),f5=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),fo=o("a"),d5=a("here"),m5=a("."),lg=u(),J=o("p"),_5=a("In fact, you can continue using "),gf=o("code"),v5=a("-m torch.distributed.launch"),j5=a(` with DeepSpeed as long as you don\u2019t need to use
`),yf=o("code"),g5=a("deepspeed"),y5=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),wf=o("code"),w5=a("deepspeed"),b5=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),rg=u(),kt=o("p"),q5=a("Here is an example of running "),bf=o("code"),E5=a("run_translation.py"),$5=a(" under DeepSpeed deploying all available GPUs:"),pg=u(),f(mo.$$.fragment),ig=u(),Pt=o("p"),k5=a("Note that in the DeepSpeed documentation you are likely to see "),qf=o("code"),P5=a("--deepspeed --deepspeed_config ds_config.json"),z5=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),ug=u(),zt=o("p"),D5=a("For some practical usage examples, please, see this "),_o=o("a"),O5=a("post"),T5=a("."),cg=u(),Vp=o("a"),hg=u(),bs=o("h3"),Dt=o("a"),Ef=o("span"),f(vo.$$.fragment),A5=u(),$f=o("span"),S5=a("Deployment with one GPU"),fg=u(),Ot=o("p"),C5=a("To deploy DeepSpeed with one GPU adjust the "),Yp=o("a"),x5=a("Trainer"),R5=a(" command line arguments as follows:"),dg=u(),f(jo.$$.fragment),mg=u(),Ae=o("p"),I5=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),kf=o("code"),U5=a("--num_gpus=1"),G5=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),go=o("a"),L5=a("documentation"),M5=a(" discusses the launcher options."),_g=u(),Kp=o("p"),Z5=a("Why would you want to use DeepSpeed with just one GPU?"),vg=u(),Tt=o("ol"),Pf=o("li"),N5=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),H5=u(),zf=o("li"),B5=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),jg=u(),Jp=o("p"),W5=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),gg=u(),f(yo.$$.fragment),yg=u(),Xp=o("p"),F5=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),wg=u(),At=o("p"),V5=a("For a practical usage example of this type of deployment, please, see this "),wo=o("a"),Y5=a("post"),K5=a("."),bg=u(),Qp=o("p"),J5=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),qg=u(),ei=o("p"),X5=a("Notes:"),Eg=u(),si=o("ul"),qs=o("li"),bo=o("p"),Q5=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=o("code"),e4=a("CUDA_VISIBLE_DEVICES"),s4=a(` to limit
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),hp=o("a"),NI=a("DeepSpeed GitHub"),HI=a("."),this.h()},l(e){const p=FV('[data-svelte="svelte-1phssyn"]',document.head);w=l(p,"META",{name:!0,content:!0}),p.forEach(t),M=c(e),b=l(e,"H1",{class:!0});var fp=r(b);$=l(fp,"A",{id:!0,class:!0,href:!0});var tj=r($);ms=l(tj,"SPAN",{});var KI=r(ms);d(F.$$.fragment,KI),KI.forEach(t),tj.forEach(t),Nn=c(fp),_s=l(fp,"SPAN",{});var JI=r(_s);vs=n(JI,"DeepSpeed Integration"),JI.forEach(t),fp.forEach(t),ht=c(e),V=l(e,"P",{});var aj=r(V);Y=l(aj,"A",{href:!0,rel:!0});var XI=r(Y);Z=n(XI,"DeepSpeed"),XI.forEach(t),yp=n(aj," implements everything described in the "),$e=l(aj,"A",{href:!0,rel:!0});var QI=r($e);wp=n(QI,"ZeRO paper"),QI.forEach(t),ZE=n(aj,". Currently it provides full support for:"),aj.forEach(t),pj=c(e),D=l(e,"OL",{});var ue=r(D);Ch=l(ue,"LI",{});var eU=r(Ch);NE=n(eU,"Optimizer state partitioning (ZeRO stage 1)"),eU.forEach(t),HE=c(ue),xh=l(ue,"LI",{});var sU=r(xh);BE=n(sU,"Gradient partitioning (ZeRO stage 2)"),sU.forEach(t),WE=c(ue),Rh=l(ue,"LI",{});var tU=r(Rh);FE=n(tU,"Parameter partitioning (ZeRO stage 3)"),tU.forEach(t),VE=c(ue),Ih=l(ue,"LI",{});var aU=r(Ih);YE=n(aU,"Custom mixed precision training handling"),aU.forEach(t),KE=c(ue),Uh=l(ue,"LI",{});var nU=r(Uh);JE=n(nU,"A range of fast CUDA-extension-based optimizers"),nU.forEach(t),XE=c(ue),Gh=l(ue,"LI",{});var oU=r(Gh);QE=n(oU,"ZeRO-Offload to CPU and NVMe"),oU.forEach(t),ue.forEach(t),ij=c(e),ke=l(e,"P",{});var Zc=r(ke);e6=n(Zc,"ZeRO-Offload has its own dedicated paper: "),Hn=l(Zc,"A",{href:!0,rel:!0});var lU=r(Hn);s6=n(lU,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),lU.forEach(t),t6=n(Zc,". And NVMe-support is described in the paper "),Bn=l(Zc,"A",{href:!0,rel:!0});var rU=r(Bn);a6=n(rU,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),rU.forEach(t),n6=n(Zc,"."),Zc.forEach(t),uj=c(e),bp=l(e,"P",{});var pU=r(bp);o6=n(pU,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),pU.forEach(t),cj=c(e),qp=l(e,"P",{});var iU=r(qp);l6=n(iU,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),iU.forEach(t),hj=c(e),ft=l(e,"P",{});var i0=r(ft);r6=n(i0,"\u{1F917} Transformers integrates "),Wn=l(i0,"A",{href:!0,rel:!0});var uU=r(Wn);p6=n(uU,"DeepSpeed"),uU.forEach(t),i6=n(i0," via 2 options:"),i0.forEach(t),fj=c(e),dt=l(e,"OL",{});var u0=r(dt);Fn=l(u0,"LI",{});var c0=r(Fn);u6=n(c0,"Integration of the core DeepSpeed features via "),Ep=l(c0,"A",{href:!0});var cU=r(Ep);c6=n(cU,"Trainer"),cU.forEach(t),h6=n(c0,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),c0.forEach(t),f6=c(u0),L=l(u0,"LI",{});var ce=r(L);d6=n(ce,"If you don\u2019t use "),$p=l(ce,"A",{href:!0});var hU=r($p);m6=n(hU,"Trainer"),hU.forEach(t),_6=n(ce,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Lh=l(ce,"CODE",{});var fU=r(Lh);v6=n(fU,"from_pretrained"),fU.forEach(t),j6=n(ce," and "),Mh=l(ce,"CODE",{});var dU=r(Mh);g6=n(dU,"from_config"),dU.forEach(t),y6=n(ce,` include integration of essential
parts of DeepSpeed like `),Zh=l(ce,"CODE",{});var mU=r(Zh);w6=n(mU,"zero.Init"),mU.forEach(t),b6=n(ce,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),kp=l(ce,"A",{href:!0});var _U=r(kp);q6=n(_U,"deepspeed-non-trainer-integration"),_U.forEach(t),E6=n(ce,"."),ce.forEach(t),u0.forEach(t),dj=c(e),Pp=l(e,"P",{});var vU=r(Pp);$6=n(vU,"What is integrated:"),vU.forEach(t),mj=c(e),zp=l(e,"P",{});var jU=r(zp);k6=n(jU,"Training:"),jU.forEach(t),_j=c(e),Dp=l(e,"OL",{});var gU=r(Dp);Nh=l(gU,"LI",{});var yU=r(Nh);P6=n(yU,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),yU.forEach(t),gU.forEach(t),vj=c(e),Op=l(e,"P",{});var wU=r(Op);z6=n(wU,"Inference:"),wU.forEach(t),jj=c(e),Tp=l(e,"OL",{});var bU=r(Tp);Vn=l(bU,"LI",{});var h0=r(Vn);D6=n(h0,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Ap=l(h0,"A",{href:!0});var qU=r(Ap);O6=n(qU,"deepspeed-zero-inference"),qU.forEach(t),T6=n(h0,"."),h0.forEach(t),bU.forEach(t),gj=c(e),Sp=l(e,"P",{});var EU=r(Sp);A6=n(EU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),EU.forEach(t),yj=c(e),Cp=l(e,"A",{id:!0}),r(Cp).forEach(t),wj=c(e),js=l(e,"H2",{class:!0});var f0=r(js);mt=l(f0,"A",{id:!0,class:!0,href:!0});var $U=r(mt);Hh=l($U,"SPAN",{});var kU=r(Hh);d(Yn.$$.fragment,kU),kU.forEach(t),$U.forEach(t),S6=c(f0),Bh=l(f0,"SPAN",{});var PU=r(Bh);C6=n(PU,"Trainer Deepspeed Integration"),PU.forEach(t),f0.forEach(t),bj=c(e),xp=l(e,"A",{id:!0}),r(xp).forEach(t),qj=c(e),gs=l(e,"H3",{class:!0});var d0=r(gs);_t=l(d0,"A",{id:!0,class:!0,href:!0});var zU=r(_t);Wh=l(zU,"SPAN",{});var DU=r(Wh);d(Kn.$$.fragment,DU),DU.forEach(t),zU.forEach(t),x6=c(d0),Fh=l(d0,"SPAN",{});var OU=r(Fh);R6=n(OU,"Installation"),OU.forEach(t),d0.forEach(t),Ej=c(e),Rp=l(e,"P",{});var TU=r(Rp);I6=n(TU,"Install the library via pypi:"),TU.forEach(t),$j=c(e),d(Jn.$$.fragment,e),kj=c(e),Pe=l(e,"P",{});var Nc=r(Pe);U6=n(Nc,"or via "),Vh=l(Nc,"CODE",{});var AU=r(Vh);G6=n(AU,"transformers"),AU.forEach(t),L6=n(Nc,"\u2019 "),Yh=l(Nc,"CODE",{});var SU=r(Yh);M6=n(SU,"extras"),SU.forEach(t),Z6=n(Nc,":"),Nc.forEach(t),Pj=c(e),d(Xn.$$.fragment,e),zj=c(e),ze=l(e,"P",{});var Hc=r(ze);N6=n(Hc,"or find more details on "),Qn=l(Hc,"A",{href:!0,rel:!0});var CU=r(Qn);H6=n(CU,"the DeepSpeed\u2019s GitHub page"),CU.forEach(t),B6=n(Hc,` and
`),eo=l(Hc,"A",{href:!0,rel:!0});var xU=r(eo);W6=n(xU,"advanced install"),xU.forEach(t),F6=n(Hc,"."),Hc.forEach(t),Dj=c(e),vt=l(e,"P",{});var m0=r(vt);V6=n(m0,"If you\u2019re still struggling with the build, first make sure to read "),Ip=l(m0,"A",{href:!0});var RU=r(Ip);Y6=n(RU,"zero-install-notes"),RU.forEach(t),K6=n(m0,"."),m0.forEach(t),Oj=c(e),Up=l(e,"P",{});var IU=r(Up);J6=n(IU,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),IU.forEach(t),Tj=c(e),Gp=l(e,"P",{});var UU=r(Gp);X6=n(UU,"To make a local build for DeepSpeed:"),UU.forEach(t),Aj=c(e),d(so.$$.fragment,e),Sj=c(e),De=l(e,"P",{});var Bc=r(De);Q6=n(Bc,"If you intend to use NVMe offload you will also need to include "),Kh=l(Bc,"CODE",{});var GU=r(Kh);e$=n(GU,"DS_BUILD_AIO=1"),GU.forEach(t),s$=n(Bc,` in the instructions above (and also
...
following:`),b0.forEach(t),eg=c(e),$t=l(e,"OL",{});var q0=r($t);ws=l(q0,"LI",{});var Vc=r(ws);H$=n(Vc,"replace "),cf=l(Vc,"CODE",{});var rG=r(cf);B$=n(rG,"python -m torch.distributed.launch"),rG.forEach(t),W$=n(Vc," with "),hf=l(Vc,"CODE",{});var pG=r(hf);F$=n(pG,"deepspeed"),pG.forEach(t),V$=n(Vc,"."),Vc.forEach(t),Y$=c(q0),ye=l(q0,"LI",{});var Pn=r(ye);K$=n(Pn,"add a new argument "),ff=l(Pn,"CODE",{});var iG=r(ff);J$=n(iG,"--deepspeed ds_config.json"),iG.forEach(t),X$=n(Pn,", where "),df=l(Pn,"CODE",{});var uG=r(df);Q$=n(uG,"ds_config.json"),uG.forEach(t),e5=n(Pn,` is the DeepSpeed configuration file as
documented `),uo=l(Pn,"A",{href:!0,rel:!0});var cG=r(uo);s5=n(cG,"here"),cG.forEach(t),t5=n(Pn,". The file naming is up to you."),Pn.forEach(t),q0.forEach(t),sg=c(e),Wp=l(e,"P",{});var hG=r(Wp);a5=n(hG,"Therefore, if your original command line looked as follows:"),hG.forEach(t),tg=c(e),d(co.$$.fragment,e),ag=c(e),Fp=l(e,"P",{});var fG=r(Fp);n5=n(fG,"Now it should be:"),fG.forEach(t),ng=c(e),d(ho.$$.fragment,e),og=c(e),O=l(e,"P",{});var he=r(O);o5=n(he,"Unlike, "),mf=l(he,"CODE",{});var dG=r(mf);l5=n(dG,"torch.distributed.launch"),dG.forEach(t),r5=n(he," where you have to specify how many GPUs to use with "),_f=l(he,"CODE",{});var mG=r(_f);p5=n(mG,"--nproc_per_node"),mG.forEach(t),i5=n(he,`, with the
`),vf=l(he,"CODE",{});var _G=r(vf);u5=n(_G,"deepspeed"),_G.forEach(t),c5=n(he," launcher you don\u2019t have to use the corresponding "),jf=l(he,"CODE",{});var vG=r(jf);h5=n(vG,"--num_gpus"),vG.forEach(t),f5=n(he,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),fo=l(he,"A",{href:!0,rel:!0});var jG=r(fo);d5=n(jG,"here"),jG.forEach(t),m5=n(he,"."),he.forEach(t),lg=c(e),J=l(e,"P",{});var zn=r(J);_5=n(zn,"In fact, you can continue using "),gf=l(zn,"CODE",{});var gG=r(gf);v5=n(gG,"-m torch.distributed.launch"),gG.forEach(t),j5=n(zn,` with DeepSpeed as long as you don\u2019t need to use
`),yf=l(zn,"CODE",{});var yG=r(yf);g5=n(yG,"deepspeed"),yG.forEach(t),y5=n(zn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),wf=l(zn,"CODE",{});var wG=r(wf);w5=n(wG,"deepspeed"),wG.forEach(t),b5=n(zn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),zn.forEach(t),rg=c(e),kt=l(e,"P",{});var E0=r(kt);q5=n(E0,"Here is an example of running "),bf=l(E0,"CODE",{});var bG=r(bf);E5=n(bG,"run_translation.py"),bG.forEach(t),$5=n(E0," under DeepSpeed deploying all available GPUs:"),E0.forEach(t),pg=c(e),d(mo.$$.fragment,e),ig=c(e),Pt=l(e,"P",{});var $0=r(Pt);k5=n($0,"Note that in the DeepSpeed documentation you are likely to see "),qf=l($0,"CODE",{});var qG=r(qf);P5=n(qG,"--deepspeed --deepspeed_config ds_config.json"),qG.forEach(t),z5=n($0,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),$0.forEach(t),ug=c(e),zt=l(e,"P",{});var k0=r(zt);D5=n(k0,"For some practical usage examples, please, see this "),_o=l(k0,"A",{href:!0,rel:!0});var EG=r(_o);O5=n(EG,"post"),EG.forEach(t),T5=n(k0,"."),k0.forEach(t),cg=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),hg=c(e),bs=l(e,"H3",{class:!0});var P0=r(bs);Dt=l(P0,"A",{id:!0,class:!0,href:!0});var $G=r(Dt);Ef=l($G,"SPAN",{});var kG=r(Ef);d(vo.$$.fragment,kG),kG.forEach(t),$G.forEach(t),A5=c(P0),$f=l(P0,"SPAN",{});var PG=r($f);S5=n(PG,"Deployment with one GPU"),PG.forEach(t),P0.forEach(t),fg=c(e),Ot=l(e,"P",{});var z0=r(Ot);C5=n(z0,"To deploy DeepSpeed with one GPU adjust the "),Yp=l(z0,"A",{href:!0});var zG=r(Yp);x5=n(zG,"Trainer"),zG.forEach(t),R5=n(z0," command line arguments as follows:"),z0.forEach(t),dg=c(e),d(jo.$$.fragment,e),mg=c(e),Ae=l(e,"P",{});var Yc=r(Ae);I5=n(Yc,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),kf=l(Yc,"CODE",{});var DG=r(kf);U5=n(DG,"--num_gpus=1"),DG.forEach(t),G5=n(Yc,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),go=l(Yc,"A",{href:!0,rel:!0});var OG=r(go);L5=n(OG,"documentation"),OG.forEach(t),M5=n(Yc," discusses the launcher options."),Yc.forEach(t),_g=c(e),Kp=l(e,"P",{});var TG=r(Kp);Z5=n(TG,"Why would you want to use DeepSpeed with just one GPU?"),TG.forEach(t),vg=c(e),Tt=l(e,"OL",{});var D0=r(Tt);Pf=l(D0,"LI",{});var AG=r(Pf);N5=n(AG,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),AG.forEach(t),H5=c(D0),zf=l(D0,"LI",{});var SG=r(zf);B5=n(SG,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),SG.forEach(t),D0.forEach(t),jg=c(e),Jp=l(e,"P",{});var CG=r(Jp);W5=n(CG,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),CG.forEach(t),gg=c(e),d(yo.$$.fragment,e),yg=c(e),Xp=l(e,"P",{});var xG=r(Xp);F5=n(xG,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),xG.forEach(t),wg=c(e),At=l(e,"P",{});var O0=r(At);V5=n(O0,"For a practical usage example of this type of deployment, please, see this "),wo=l(O0,"A",{href:!0,rel:!0});var RG=r(wo);Y5=n(RG,"post"),RG.forEach(t),K5=n(O0,"."),O0.forEach(t),bg=c(e),Qp=l(e,"P",{});var IG=r(Qp);J5=n(IG,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),IG.forEach(t),qg=c(e),ei=l(e,"P",{});var UG=r(ei);X5=n(UG,"Notes:"),UG.forEach(t),Eg=c(e),si=l(e,"UL",{});var GG=r(si);qs=l(GG,"LI",{});var Kc=r(qs);bo=l(Kc,"P",{});var T0=r(bo);Q5=n(T0,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=l(T0,"CODE",{});var LG=r(Df);e4=n(LG,"CUDA_VISIBLE_DEVICES"),LG.forEach(t),s4=n(T0,` to limit
