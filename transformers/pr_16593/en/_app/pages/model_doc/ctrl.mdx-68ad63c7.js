...
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);F=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var De=i(v);T=s(De,"having all inputs as keyword arguments (like PyTorch models), or"),De.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),D=r(N,"CODE",{});var qe=i(D);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
tensors in the first argument of the model call function: `),A=r(N,"CODE",{});var Ae=i(A);ve=s(Ae,"model(inputs)"),Ae.forEach(t),pe=s(N,"."),N.forEach(t),x=d(p),j=r(p,"P",{});var He=i(j);ee=s(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),He.forEach(t),ne=d(p),E=r(p,"UL",{});var O=i(E);q=r(O,"LI",{});var P=i(q);ke=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(P," only and nothing else: "),V=r(P,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),P.forEach(t),ae=d(O),z=r(O,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ye=s(K," or "),W=r(K,"CODE",{});var Pe=i(W);S=s(Pe,"model([input_ids, attention_mask, token_type_ids])"),Pe.forEach(t),K.forEach(t),te=d(O),I=r(O,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),O.forEach(t)},m(p,$){u(p,h,$),e(h,F),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,D),e(D,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,x,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,E,$),e(E,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(E,ae),e(E,z),e(z,be),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(E,te),e(E,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(x),p&&t(j),p&&t(ne),p&&t(E)}}}function op(J){let h,F,f,g,v;return{c(){h=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);F=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
configuration. Check out the <a href="/docs/transformers/pr_16593/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new Ee({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16593/src/transformers/models/ctrl/modeling_ctrl.py#L354",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/pr_16593/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16593/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.CTRLConfig"
...
<p>A <a
  href="/docs/transformers/pr_16593/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16593/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Co=new Ee({props:{name:"forward",anchor:"transformers.CTRLForSequenceClassification.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16593/src/transformers/models/ctrl/modeling_ctrl.py#L620",parametersDescription:[{anchor:"transformers.CTRLForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16593/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new $t({props:{$$slots:{default:[tp]},$$scope:{ctx:J}}}),Po=new Ee({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16593/src/transformers/models/ctrl/modeling_tf_ctrl.py#L521",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16593/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16593/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ot=new $t({props:{$$slots:{default:[np]},$$scope:{ctx:J}}}),Do=new Ee({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16593/src/transformers/models/ctrl/modeling_tf_ctrl.py#L631",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<p>A <a
  href="/docs/transformers/pr_16593/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16593/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new $t({props:{$$slots:{default:[ap]},$$scope:{ctx:J}}}),Go=new Ee({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16593/src/transformers/models/ctrl/modeling_tf_ctrl.py#L742",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
the left.`),De=l(),me=a("li"),N=n(`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows CTRL to generate syntactically coherent text as it can be
observed in the `),qe=a("em"),Ae=n("run_generation.py"),He=n(" example script."),O=l(),P=a("li"),We=n("The PyTorch models can take the "),ze=a("code"),K=n("past_key_values"),Be=n(` as input, which is the previously computed key/value attention pairs.
...
documentation from `),on=a("a"),Ia=n("PretrainedConfig"),Na=n(" for more information."),Oa=l(),Pn=a("p"),Da=n("Examples:"),Aa=l(),k(Yt.$$.fragment),Es=l(),ht=a("h2"),Mt=a("a"),xn=a("span"),k(Zt.$$.fragment),Ha=l(),jn=a("span"),Wa=n("CTRLTokenizer"),qs=l(),Ne=a("div"),k(eo.$$.fragment),Ba=l(),Sn=a("p"),Ua=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Va=l(),to=a("p"),Ga=n("This tokenizer inherits from "),nn=a("a"),Ka=n("PreTrainedTokenizer"),Xa=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ja=l(),sn=a("div"),k(oo.$$.fragment),zs=l(),ut=a("h2"),Ft=a("a"),In=a("span"),k(no.$$.fragment),Qa=l(),Nn=a("span"),Ya=n("CTRLModel"),Ps=l(),$e=a("div"),k(so.$$.fragment),Za=l(),On=a("p"),er=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),tr=l(),ao=a("p"),or=n("This model inherits from "),an=a("a"),nr=n("PreTrainedModel"),sr=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=l(),B=a("div"),k(Co.$$.fragment),hi=l(),Tt=a("p"),ui=n("The "),hn=a("a"),mi=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),k(xt.$$.fragment),vi=l(),es=a("p"),ki=n("Example of single-label classification:"),bi=l(),k(wo.$$.fragment),yi=l(),k(Lo.$$.fragment),Ci=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),k($o.$$.fragment),$i=l(),k(Ro.$$.fragment),Ns=l(),vt=a("h2"),jt=a("a"),os=a("span"),k(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Os=l(),de=a("div"),k(Fo.$$.fragment),Fi=l(),ss=a("p"),Ei=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Eo=a("p"),zi=n("This model inherits from "),un=a("a"),Pi=n("TFPreTrainedModel"),xi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ji=l(),qo=a("p"),Si=n("This model is also a "),zo=a("a"),Ii=n("tf.keras.Model"),Ni=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oi=l(),k(St.$$.fragment),Di=l(),Se=a("div"),k(Po.$$.fragment),Ai=l(),kt=a("p"),Hi=n("The "),mn=a("a"),Wi=n("TFCTRLModel"),Bi=n(" forward method, overrides the "),as=a("code"),Ui=n("__call__"),Vi=n(" special method."),Gi=l(),k(It.$$.fragment),Ki=l(),rs=a("p"),Xi=n("Example:"),Ji=l(),k(xo.$$.fragment),Ds=l(),bt=a("h2"),Nt=a("a"),is=a("span"),k(jo.$$.fragment),Qi=l(),ls=a("span"),Yi=n("TFCTRLLMHeadModel"),As=l(),ce=a("div"),k(So.$$.fragment),Zi=l(),ds=a("p"),el=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),al=l(),No=a("p"),rl=n("This model is also a "),Oo=a("a"),il=n("tf.keras.Model"),ll=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dl=l(),k(Ot.$$.fragment),cl=l(),Ie=a("div"),k(Do.$$.fragment),pl=l(),yt=a("p"),hl=n("The "),gn=a("a"),ul=n("TFCTRLLMHeadModel"),ml=n(" forward method, overrides the "),cs=a("code"),fl=n("__call__"),gl=n(" special method."),_l=l(),k(Dt.$$.fragment),Tl=l(),ps=a("p"),vl=n("Example:"),kl=l(),k(Ao.$$.fragment),Hs=l(),Ct=a("h2"),At=a("a"),hs=a("span"),k(Ho.$$.fragment),bl=l(),us=a("span"),yl=n("TFCTRLForSequenceClassification"),Ws=l(),X=a("div"),k(Wo.$$.fragment),Cl=l(),ms=a("p"),wl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),Ll=l(),_n=a("p"),Tn=a("a"),$l=n("TFCTRLForSequenceClassification"),Rl=n(` uses the last token in order to do the classification, as other causal models
(e.g. GPT-1, GPT-2) do.`),Ml=l(),Oe=a("p"),Fl=n(`Since it does classification on the last token, it requires to know the position of the last token. If a
...
each row of the batch).`),Nl=l(),Bo=a("p"),Ol=n("This model inherits from "),vn=a("a"),Dl=n("TFPreTrainedModel"),Al=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
the left.`),ud.forEach(t),De=d(Bt),me=r(Bt,"LI",{});var Vs=i(me);N=s(Vs,`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows CTRL to generate syntactically coherent text as it can be
observed in the `),qe=r(Vs,"EM",{});var md=i(qe);Ae=s(md,"run_generation.py"),md.forEach(t),He=s(Vs," example script."),Vs.forEach(t),O=d(Bt),P=r(Bt,"LI",{});var Ze=i(P);We=s(Ze,"The PyTorch models can take the "),ze=r(Ze,"CODE",{});var fd=i(ze);K=s(fd,"past_key_values"),fd.forEach(t),Be=s(Ze,` as input, which is the previously computed key/value attention pairs.
...
documentation from `),on=r(yn,"A",{href:!0});var Fd=i(on);Ia=s(Fd,"PretrainedConfig"),Fd.forEach(t),Na=s(yn," for more information."),yn.forEach(t),Oa=d(et),Pn=r(et,"P",{});var Ed=i(Pn);Da=s(Ed,"Examples:"),Ed.forEach(t),Aa=d(et),b(Yt.$$.fragment,et),et.forEach(t),Es=d(o),ht=r(o,"H2",{class:!0});var Ks=i(ht);Mt=r(Ks,"A",{id:!0,class:!0,href:!0});var qd=i(Mt);xn=r(qd,"SPAN",{});var zd=i(xn);b(Zt.$$.fragment,zd),zd.forEach(t),qd.forEach(t),Ha=d(Ks),jn=r(Ks,"SPAN",{});var Pd=i(jn);Wa=s(Pd,"CTRLTokenizer"),Pd.forEach(t),Ks.forEach(t),qs=d(o),Ne=r(o,"DIV",{class:!0});var Vt=i(Ne);b(eo.$$.fragment,Vt),Ba=d(Vt),Sn=r(Vt,"P",{});var xd=i(Sn);Ua=s(xd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),xd.forEach(t),Va=d(Vt),to=r(Vt,"P",{});var Xs=i(to);Ga=s(Xs,"This tokenizer inherits from "),nn=r(Xs,"A",{href:!0});var jd=i(nn);Ka=s(jd,"PreTrainedTokenizer"),jd.forEach(t),Xa=s(Xs,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Xs.forEach(t),Ja=d(Vt),sn=r(Vt,"DIV",{class:!0});var Sd=i(sn);b(oo.$$.fragment,Sd),Sd.forEach(t),Vt.forEach(t),zs=d(o),ut=r(o,"H2",{class:!0});var Js=i(ut);Ft=r(Js,"A",{id:!0,class:!0,href:!0});var Id=i(Ft);In=r(Id,"SPAN",{});var Nd=i(In);b(no.$$.fragment,Nd),Nd.forEach(t),Id.forEach(t),Qa=d(Js),Nn=r(Js,"SPAN",{});var Od=i(Nn);Ya=s(Od,"CTRLModel"),Od.forEach(t),Js.forEach(t),Ps=d(o),$e=r(o,"DIV",{class:!0});var tt=i($e);b(so.$$.fragment,tt),Za=d(tt),On=r(tt,"P",{});var Dd=i(On);er=s(Dd,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Dd.forEach(t),tr=d(tt),ao=r(tt,"P",{});var Qs=i(ao);or=s(Qs,"This model inherits from "),an=r(Qs,"A",{href:!0});var Ad=i(an);nr=s(Ad,"PreTrainedModel"),Ad.forEach(t),sr=s(Qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta.forEach(t),zr=d(nt),je=r(nt,"DIV",{class:!0});var st=i(je);b(go.$$.fragment,st),Pr=d(st),gt=r(st,"P",{});var wn=i(gt);xr=s(wn,"The "),dn=r(wn,"A",{href:!0});var Yd=i(dn);jr=s(Yd,"CTRLLMHeadModel"),Yd.forEach(t),Sr=s(wn," forward method, overrides the "),Un=r(wn,"CODE",{});var Zd=i(Un);Ir=s(Zd,"__call__"),Zd.forEach(t),Nr=s(wn," special method."),wn.forEach(t),Or=d(st),b(zt.$$.fragment,st),Dr=d(st),Vn=r(st,"P",{});var ec=i(Vn);Ar=s(ec,"Example:"),ec.forEach(t),Hr=d(st),b(_o.$$.fragment,st),st.forEach(t),nt.forEach(t),Ss=d(o),_t=r(o,"H2",{class:!0});var oa=i(_t);Pt=r(oa,"A",{id:!0,class:!0,href:!0});var tc=i(Pt);Gn=r(tc,"SPAN",{});var oc=i(Gn);b(To.$$.fragment,oc),oc.forEach(t),tc.forEach(t),Wr=d(oa),Kn=r(oa,"SPAN",{});var nc=i(Kn);Br=s(nc,"CTRLForSequenceClassification"),nc.forEach(t),oa.forEach(t),Is=d(o),Me=r(o,"DIV",{class:!0});var at=i(Me);b(vo.$$.fragment,at),Ur=d(at),Fe=r(at,"P",{});var Ve=i(Fe);Vr=s(Ve,`The CTRL Model transformer with a sequence classification head on top (linear layer).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa.forEach(t),pi=d(at),B=r(at,"DIV",{class:!0});var le=i(B);b(Co.$$.fragment,le),hi=d(le),Tt=r(le,"P",{});var Ln=i(Tt);ui=s(Ln,"The "),hn=r(Ln,"A",{href:!0});var pc=i(hn);mi=s(pc,"CTRLForSequenceClassification"),pc.forEach(t),fi=s(Ln," forward method, overrides the "),Zn=r(Ln,"CODE",{});var hc=i(Zn);gi=s(hc,"__call__"),hc.forEach(t),_i=s(Ln," special method."),Ln.forEach(t),Ti=d(le),b(xt.$$.fragment,le),vi=d(le),es=r(le,"P",{});var uc=i(es);ki=s(uc,"Example of single-label classification:"),uc.forEach(t),bi=d(le),b(wo.$$.fragment,le),yi=d(le),b(Lo.$$.fragment,le),Ci=d(le),ts=r(le,"P",{});var mc=i(ts);wi=s(mc,"Example of multi-label classification:"),mc.forEach(t),Li=d(le),b($o.$$.fragment,le),$i=d(le),b(Ro.$$.fragment,le),le.forEach(t),at.forEach(t),Ns=d(o),vt=r(o,"H2",{class:!0});var aa=i(vt);jt=r(aa,"A",{id:!0,class:!0,href:!0});var fc=i(jt);os=r(fc,"SPAN",{});var gc=i(os);b(Mo.$$.fragment,gc),gc.forEach(t),fc.forEach(t),Ri=d(aa),ns=r(aa,"SPAN",{});var _c=i(ns);Mi=s(_c,"TFCTRLModel"),_c.forEach(t),aa.forEach(t),Os=d(o),de=r(o,"DIV",{class:!0});var Ge=i(de);b(Fo.$$.fragment,Ge),Fi=d(Ge),ss=r(Ge,"P",{});var Tc=i(ss);Ei=s(Tc,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Tc.forEach(t),qi=d(Ge),Eo=r(Ge,"P",{});var ra=i(Eo);zi=s(ra,"This model inherits from "),un=r(ra,"A",{href:!0});var vc=i(un);Pi=s(vc,"TFPreTrainedModel"),vc.forEach(t),xi=s(ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ia.forEach(t),Oi=d(Ge),b(St.$$.fragment,Ge),Di=d(Ge),Se=r(Ge,"DIV",{class:!0});var rt=i(Se);b(Po.$$.fragment,rt),Ai=d(rt),kt=r(rt,"P",{});var $n=i(kt);Hi=s($n,"The "),mn=r($n,"A",{href:!0});var bc=i(mn);Wi=s(bc,"TFCTRLModel"),bc.forEach(t),Bi=s($n," forward method, overrides the "),as=r($n,"CODE",{});var yc=i(as);Ui=s(yc,"__call__"),yc.forEach(t),Vi=s($n," special method."),$n.forEach(t),Gi=d(rt),b(It.$$.fragment,rt),Ki=d(rt),rs=r(rt,"P",{});var Cc=i(rs);Xi=s(Cc,"Example:"),Cc.forEach(t),Ji=d(rt),b(xo.$$.fragment,rt),rt.forEach(t),Ge.forEach(t),Ds=d(o),bt=r(o,"H2",{class:!0});var la=i(bt);Nt=r(la,"A",{id:!0,class:!0,href:!0});var wc=i(Nt);is=r(wc,"SPAN",{});var Lc=i(is);b(jo.$$.fragment,Lc),Lc.forEach(t),wc.forEach(t),Qi=d(la),ls=r(la,"SPAN",{});var $c=i(ls);Yi=s($c,"TFCTRLLMHeadModel"),$c.forEach(t),la.forEach(t),As=d(o),ce=r(o,"DIV",{class:!0});var Ke=i(ce);b(So.$$.fragment,Ke),Zi=d(Ke),ds=r(Ke,"P",{});var Rc=i(ds);el=s(Rc,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
each row of the batch).`),lt.forEach(t),Nl=d(ge),Bo=r(ge,"P",{});var ha=i(Bo);Ol=s(ha,"This model inherits from "),vn=r(ha,"A",{href:!0});var Hc=i(vn);Dl=s(Hc,"TFPreTrainedModel"),Hc.forEach(t),Al=s(ha,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ua.forEach(t),Vl=d(ge),b(Ht.$$.fragment,ge),Gl=d(ge),fe=r(ge,"DIV",{class:!0});var Xe=i(fe);b(Go.$$.fragment,Xe),Kl=d(Xe),wt=r(Xe,"P",{});var Mn=i(wt);Xl=s(Mn,"The "),kn=r(Mn,"A",{href:!0});var Bc=i(kn);Jl=s(Bc,"TFCTRLForSequenceClassification"),Bc.forEach(t),Ql=s(Mn," forward method, overrides the "),vs=r(Mn,"CODE",{});var Uc=i(vs);Yl=s(Uc,"__call__"),Uc.forEach(t),Zl=s(Mn," special method."),Mn.forEach(t),ed=d(Xe),b(Wt.$$.fragment,Xe),td=d(Xe),ks=r(Xe,"P",{});var Vc=i(ks);od=s(Vc,"Example:"),Vc.forEach(t),nd=d(Xe),b(Ko.$$.fragment,Xe),sd=d(Xe),b(Xo.$$.fragment,Xe),Xe.forEach(t),ge.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(lp)),c(g,"id","ctrl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#ctrl"),c(f,"class","relative group"),c(Q,"id","overview"),c(Q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Q,"href","#overview"),c(R,"class","relative group"),c(ee,"href","https://arxiv.org/abs/1909.05858"),c(ee,"rel","nofollow"),c(oe,"href","https://github.com/salesforce/ctrl"),c(oe,"rel","nofollow"),c(Yo,"href","model_doc/ctrl#transformers.CTRLModel.forward"),c(Gt,"href","https://huggingface.co/keskarnitishr"),c(Gt,"rel","nofollow"),c(Kt,"href","https://github.com/salesforce/ctrl"),c(Kt,"rel","nofollow"),c(Rt,"id","transformers.CTRLConfig"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.CTRLConfig"),c(ct,"class","relative group"),c(Zo,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.CTRLModel"),c(en,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Qt,"href","https://huggingface.co/ctrl"),c(Qt,"rel","nofollow"),c(tn,"href","/docs/transformers/pr_16593/en/main_classes/configuration#transformers.PretrainedConfig"),c(on,"href","/docs/transformers/pr_16593/en/main_classes/configuration#transformers.PretrainedConfig"),c(Le,"class","docstring"),c(Mt,"id","transformers.CTRLTokenizer"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.CTRLTokenizer"),c(ht,"class","relative group"),c(nn,"href","/docs/transformers/pr_16593/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(sn,"class","docstring"),c(Ne,"class","docstring"),c(Ft,"id","transformers.CTRLModel"),c(Ft,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ft,"href","#transformers.CTRLModel"),c(ut,"class","relative group"),c(an,"href","/docs/transformers/pr_16593/en/main_classes/model#transformers.PreTrainedModel"),c(io,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(io,"rel","nofollow"),c(rn,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.CTRLModel"),c(xe,"class","docstring"),c($e,"class","docstring"),c(qt,"id","transformers.CTRLLMHeadModel"),c(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qt,"href","#transformers.CTRLLMHeadModel"),c(ft,"class","relative group"),c(ln,"href","/docs/transformers/pr_16593/en/main_classes/model#transformers.PreTrainedModel"),c(fo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(fo,"rel","nofollow"),c(dn,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.CTRLLMHeadModel"),c(je,"class","docstring"),c(Re,"class","docstring"),c(Pt,"id","transformers.CTRLForSequenceClassification"),c(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pt,"href","#transformers.CTRLForSequenceClassification"),c(_t,"class","relative group"),c(cn,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(pn,"href","/docs/transformers/pr_16593/en/main_classes/model#transformers.PreTrainedModel"),c(yo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(yo,"rel","nofollow"),c(hn,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(B,"class","docstring"),c(Me,"class","docstring"),c(jt,"id","transformers.TFCTRLModel"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.TFCTRLModel"),c(vt,"class","relative group"),c(un,"href","/docs/transformers/pr_16593/en/main_classes/model#transformers.TFPreTrainedModel"),c(zo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(zo,"rel","nofollow"),c(mn,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Se,"class","docstring"),c(de,"class","docstring"),c(Nt,"id","transformers.TFCTRLLMHeadModel"),c(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nt,"href","#transformers.TFCTRLLMHeadModel"),c(bt,"class","relative group"),c(fn,"href","/docs/transformers/pr_16593/en/main_classes/model#transformers.TFPreTrainedModel"),c(Oo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Oo,"rel","nofollow"),c(gn,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.TFCTRLLMHeadModel"),c(Ie,"class","docstring"),c(ce,"class","docstring"),c(At,"id","transformers.TFCTRLForSequenceClassification"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.TFCTRLForSequenceClassification"),c(Ct,"class","relative group"),c(Tn,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(vn,"href","/docs/transformers/pr_16593/en/main_classes/model#transformers.TFPreTrainedModel"),c(Vo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Vo,"rel","nofollow"),c(kn,"href","/docs/transformers/pr_16593/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(fe,"class","docstring"),c(X,"class","docstring")},m(o,m){e(document.head,h),u(o,F,m),u(o,f,m),e(f,g),e(g,v),y(T,v,null),e(f,_),e(f,M),e(M,_e),u(o,Y,m),u(o,R,m),e(R,Q),e(Q,D),y(Z,D,null),e(R,Te),e(R,A),e(A,ve),u(o,pe,m),u(o,x,m),e(x,j),e(x,ee),e(ee,ne),e(x,E),e(x,q),e(q,ke),e(x,U),u(o,he,m),u(o,se,m),e(se,V),u(o,ue,m),u(o,ae,m),e(ae,z),e(z,be),u(o,H,m),u(o,re,m),e(re,ye),u(o,W,m),u(o,S,m),e(S,te),e(te,I),e(te,oe),e(oe,G),e(te,Ce),e(S,p),e(S,$),e($,ie),e(S,De),e(S,me),e(me,N),e(me,qe),e(qe,Ae),e(me,He),e(S,O),e(S,P),e(P,We),e(P,ze),e(ze,K),e(P,Be),e(P,Pe),e(Pe,we),e(P,Ue),e(P,Fn),e(Fn,ma),e(P,fa),e(P,Yo),e(Yo,En),e(En,ga),e(P,_a),u(o,Rs,m),u(o,Ye,m),e(Ye,Ta),e(Ye,Gt),e(Gt,va),e(Ye,ka),e(Ye,Kt),e(Kt,ba),e(Ye,ya),u(o,Ms,m),u(o,ct,m),e(ct,Rt),e(Rt,qn),y(Xt,qn,null),e(ct,Ca),e(ct,zn),e(zn,wa),u(o,Fs,m),u(o,Le,m),y(Jt,Le,null),e(Le,La),e(Le,Je),e(Je,$a),e(Je,Zo),e(Zo,Ra),e(Je,Ma),e(Je,en),e(en,Fa),e(Je,Ea),e(Je,Qt),e(Qt,qa),e(Je,za),e(Le,Pa),e(Le,pt),e(pt,xa),e(pt,tn),e(tn,ja),e(pt,Sa),e(pt,on),e(on,Ia),e(pt,Na),e(Le,Oa),e(Le,Pn),e(Pn,Da),e(Le,Aa),y(Yt,Le,null),u(o,Es,m),u(o,ht,m),e(ht,Mt),e(Mt,xn),y(Zt,xn,null),e(ht,Ha),e(ht,jn),e(jn,Wa),u(o,qs,m),u(o,Ne,m),y(eo,Ne,null),e(Ne,Ba),e(Ne,Sn),e(Sn,Ua),e(Ne,Va),e(Ne,to),e(to,Ga),e(to,nn),e(nn,Ka),e(to,Xa),e(Ne,Ja),e(Ne,sn),y(oo,sn,null),u(o,zs,m),u(o,ut,m),e(ut,Ft),e(Ft,In),y(no,In,null),e(ut,Qa),e(ut,Nn),e(Nn,Ya),u(o,Ps,m),u(o,$e,m),y(so,$e,null),e($e,Za),e($e,On),e(On,er),e($e,tr),e($e,ao),e(ao,or),e(ao,an),e(an,nr),e(ao,sr),e($e,ar),e($e,ro),e(ro,rr),e(ro,io),e(io,ir),e(ro,lr),e($e,dr),e($e,xe),y(lo,xe,null),e(xe,cr),e(xe,mt),e(mt,pr),e(mt,rn),e(rn,hr),e(mt,ur),e(mt,Dn),e(Dn,mr),e(mt,fr),e(xe,gr),y(Et,xe,null),e(xe,_r),e(xe,An),e(An,Tr),e(xe,vr),y(co,xe,null),u(o,xs,m),u(o,ft,m),e(ft,qt),e(qt,Hn),y(po,Hn,null),e(ft,kr),e(ft,Wn),e(Wn,br),u(o,js,m),u(o,Re,m),y(ho,Re,null),e(Re,yr),e(Re,Bn),e(Bn,Cr),e(Re,wr),e(Re,uo),e(uo,Lr),e(uo,ln),e(ln,$r),e(uo,Rr),e(Re,Mr),e(Re,mo),e(mo,Fr),e(mo,fo),e(fo,Er),e(mo,qr),e(Re,zr),e(Re,je),y(go,je,null),e(je,Pr),e(je,gt),e(gt,xr),e(gt,dn),e(dn,jr),e(gt,Sr),e(gt,Un),e(Un,Ir),e(gt,Nr),e(je,Or),y(zt,je,null),e(je,Dr),e(je,Vn),e(Vn,Ar),e(je,Hr),y(_o,je,null),u(o,Ss,m),u(o,_t,m),e(_t,Pt),e(Pt,Gn),y(To,Gn,null),e(_t,Wr),e(_t,Kn),e(Kn,Br),u(o,Is,m),u(o,Me,m),y(vo,Me,null),e(Me,Ur),e(Me,Fe),e(Fe,Vr),e(Fe,cn),e(cn,Gr),e(Fe,Kr),e(Fe,Xn),e(Xn,Xr),e(Fe,Jr),e(Fe,Jn),e(Jn,Qr),e(Fe,Yr),e(Fe,Qn),e(Qn,Zr),e(Fe,ei),e(Fe,Yn),e(Yn,ti),e(Fe,oi),e(Me,ni),e(Me,ko),e(ko,si),e(ko,pn),e(pn,ai),e(ko,ri),e(Me,ii),e(Me,bo),e(bo,li),e(bo,yo),e(yo,di),e(bo,ci),e(Me,pi),e(Me,B),y(Co,B,null),e(B,hi),e(B,Tt),e(Tt,ui),e(Tt,hn),e(hn,mi),e(Tt,fi),e(Tt,Zn),e(Zn,gi),e(Tt,_i),e(B,Ti),y(xt,B,null),e(B,vi),e(B,es),e(es,ki),e(B,bi),y(wo,B,null),e(B,yi),y(Lo,B,null),e(B,Ci),e(B,ts),e(ts,wi),e(B,Li),y($o,B,null),e(B,$i),y(Ro,B,null),u(o,Ns,m),u(o,vt,m),e(vt,jt),e(jt,os),y(Mo,os,null),e(vt,Ri),e(vt,ns),e(ns,Mi),u(o,Os,m),u(o,de,m),y(Fo,de,null),e(de,Fi),e(de,ss),e(ss,Ei),e(de,qi),e(de,Eo),e(Eo,zi),e(Eo,un),e(un,Pi),e(Eo,xi),e(de,ji),e(de,qo),e(qo,Si),e(qo,zo),e(zo,Ii),e(qo,Ni),e(de,Oi),y(St,de,null),e(de,Di),e(de,Se),y(Po,Se,null),e(Se,Ai),e(Se,kt),e(kt,Hi),e(kt,mn),e(mn,Wi),e(kt,Bi),e(kt,as),e(as,Ui),e(kt,Vi),e(Se,Gi),y(It,Se,null),e(Se,Ki),e(Se,rs),e(rs,Xi),e(Se,Ji),y(xo,Se,null),u(o,Ds,m),u(o,bt,m),e(bt,Nt),e(Nt,is),y(jo,is,null),e(bt,Qi),e(bt,ls),e(ls,Yi),u(o,As,m),u(o,ce,m),y(So,ce,null),e(ce,Zi),e(ce,ds),e(ds,el),e(ce,tl),e(ce,Io),e(Io,ol),e(Io,fn),e(fn,nl),e(Io,sl),e(ce,al),e(ce,No),e(No,rl),e(No,Oo),e(Oo,il),e(No,ll),e(ce,dl),y(Ot,ce,null),e(ce,cl),e(ce,Ie),y(Do,Ie,null),e(Ie,pl),e(Ie,yt),e(yt,hl),e(yt,gn),e(gn,ul),e(yt,ml),e(yt,cs),e(cs,fl),e(yt,gl),e(Ie,_l),y(Dt,Ie,null),e(Ie,Tl),e(Ie,ps),e(ps,vl),e(Ie,kl),y(Ao,Ie,null),u(o,Hs,m),u(o,Ct,m),e(Ct,At),e(At,hs),y(Ho,hs,null),e(Ct,bl),e(Ct,us),e(us,yl),u(o,Ws,m),u(o,X,m),y(Wo,X,null),e(X,Cl),e(X,ms),e(ms,wl),e(X,Ll),e(X,_n),e(_n,Tn),e(Tn,$l),e(_n,Rl),e(X,Ml),e(X,Oe),e(Oe,Fl),e(Oe,fs),e(fs,El),e(Oe,ql),e(Oe,gs),e(gs,zl),e(Oe,Pl),e(Oe,_s),e(_s,xl),e(Oe,jl),e(Oe,Ts),e(Ts,Sl),e(Oe,Il),e(X,Nl),e(X,Bo),e(Bo,Ol),e(Bo,vn),e(vn,Dl),e(Bo,Al),e(X,Hl),e(X,Uo),e(Uo,Wl),e(Uo,Vo),e(Vo,Bl),e(Uo,Ul),e(X,Vl),y(Ht,X,null),e(X,Gl),e(X,fe),y(Go,fe,null),e(fe,Kl),e(fe,wt),e(wt,Xl),e(wt,kn),e(kn,Jl),e(wt,Ql),e(wt,vs),e(vs,Yl),e(wt,Zl),e(fe,ed),y(Wt,fe,null),e(fe,td),e(fe,ks),e(ks,od),e(fe,nd),y(Ko,fe,null),e(fe,sd),y(Xo,fe,null),Bs=!0},p(o,[m]){const Jo={};m&2&&(Jo.$$scope={dirty:m,ctx:o}),Et.$set(Jo);const bs={};m&2&&(bs.$$scope={dirty:m,ctx:o}),zt.$set(bs);const ys={};m&2&&(ys.$$scope={dirty:m,ctx:o}),xt.$set(ys);const Cs={};m&2&&(Cs.$$scope={dirty:m,ctx:o}),St.$set(Cs);const Qo={};m&2&&(Qo.$$scope={dirty:m,ctx:o}),It.$set(Qo);const ws={};m&2&&(ws.$$scope={dirty:m,ctx:o}),Ot.$set(ws);const Ls={};m&2&&(Ls.$$scope={dirty:m,ctx:o}),Dt.$set(Ls);const $s={};m&2&&($s.$$scope={dirty:m,ctx:o}),Ht.$set($s);const Lt={};m&2&&(Lt.$$scope={dirty:m,ctx:o}),Wt.$set(Lt)},i(o){Bs||(C(T.$$.fragment,o),C(Z.$$.fragment,o),C(Xt.$$.fragment,o),C(Jt.$$.fragment,o),C(Yt.$$.fragment,o),C(Zt.$$.fragment,o),C(eo.$$.fragment,o),C(oo.$$.fragment,o),C(no.$$.fragment,o),C(so.$$.fragment,o),C(lo.$$.fragment,o),C(Et.$$.fragment,o),C(co.$$.fragment,o),C(po.$$.fragment,o),C(ho.$$.fragment,o),C(go.$$.fragment,o),C(zt.$$.fragment,o),C(_o.$$.fragment,o),C(To.$$.fragment,o),C(vo.$$.fragment,o),C(Co.$$.fragment,o),C(xt.$$.fragment,o),C(wo.$$.fragment,o),C(Lo.$$.fragment,o),C($o.$$.fragment,o),C(Ro.$$.fragment,o),C(Mo.$$.fragment,o),C(Fo.$$.fragment,o),C(St.$$.fragment,o),C(Po.$$.fragment,o),C(It.$$.fragment,o),C(xo.$$.fragment,o),C(jo.$$.fragment,o),C(So.$$.fragment,o),C(Ot.$$.fragment,o),C(Do.$$.fragment,o),C(Dt.$$.fragment,o),C(Ao.$$.fragment,o),C(Ho.$$.fragment,o),C(Wo.$$.fragment,o),C(Ht.$$.fragment,o),C(Go.$$.fragment,o),C(Wt.$$.fragment,o),C(Ko.$$.fragment,o),C(Xo.$$.fragment,o),Bs=!0)},o(o){w(T.$$.fragment,o),w(Z.$$.fragment,o),w(Xt.$$.fragment,o),w(Jt.$$.fragment,o),w(Yt.$$.fragment,o),w(Zt.$$.fragment,o),w(eo.$$.fragment,o),w(oo.$$.fragment,o),w(no.$$.fragment,o),w(so.$$.fragment,o),w(lo.$$.fragment,o),w(Et.$$.fragment,o),w(co.$$.fragment,o),w(po.$$.fragment,o),w(ho.$$.fragment,o),w(go.$$.fragment,o),w(zt.$$.fragment,o),w(_o.$$.fragment,o),w(To.$$.fragment,o),w(vo.$$.fragment,o),w(Co.$$.fragment,o),w(xt.$$.fragment,o),w(wo.$$.fragment,o),w(Lo.$$.fragment,o),w($o.$$.fragment,o),w(Ro.$$.fragment,o),w(Mo.$$.fragment,o),w(Fo.$$.fragment,o),w(St.$$.fragment,o),w(Po.$$.fragment,o),w(It.$$.fragment,o),w(xo.$$.fragment,o),w(jo.$$.fragment,o),w(So.$$.fragment,o),w(Ot.$$.fragment,o),w(Do.$$.fragment,o),w(Dt.$$.fragment,o),w(Ao.$$.fragment,o),w(Ho.$$.fragment,o),w(Wo.$$.fragment,o),w(Ht.$$.fragment,o),w(Go.$$.fragment,o),w(Wt.$$.fragment,o),w(Ko.$$.fragment,o),w(Xo.$$.fragment,o),Bs=!1},d(o){t(h),o&&t(F),o&&t(f),L(T),o&&t(Y),o&&t(R),L(Z),o&&t(pe),o&&t(x),o&&t(he),o&&t(se),o&&t(ue),o&&t(ae),o&&t(H),o&&t(re),o&&t(W),o&&t(S),o&&t(Rs),o&&t(Ye),o&&t(Ms),o&&t(ct),L(Xt),o&&t(Fs),o&&t(Le),L(Jt),L(Yt),o&&t(Es),o&&t(ht),L(Zt),o&&t(qs),o&&t(Ne),L(eo),L(oo),o&&t(zs),o&&t(ut),L(no),o&&t(Ps),o&&t($e),L(so),L(lo),L(Et),L(co),o&&t(xs),o&&t(ft),L(po),o&&t(js),o&&t(Re),L(ho),L(go),L(zt),L(_o),o&&t(Ss),o&&t(_t),L(To),o&&t(Is),o&&t(Me),L(vo),L(Co),L(xt),L(wo),L(Lo),L($o),L(Ro),o&&t(Ns),o&&t(vt),L(Mo),o&&t(Os),o&&t(de),L(Fo),L(St),L(Po),L(It),L(xo),o&&t(Ds),o&&t(bt),L(jo),o&&t(As),o&&t(ce),L(So),L(Ot),L(Do),L(Dt),L(Ao),o&&t(Hs),o&&t(Ct),L(Ho),o&&t(Ws),o&&t(X),L(Wo),L(Ht),L(Go),L(Wt),L(Ko),L(Xo)}}}const lp={local:"ctrl",sections:[{local:"overview",title:"Overview"},{local:"transformers.CTRLConfig",title:"CTRLConfig"},{local:"transformers.CTRLTokenizer",title:"CTRLTokenizer"},{local:"transformers.CTRLModel",title:"CTRLModel"},{local:"transformers.CTRLLMHeadModel",title:"CTRLLMHeadModel"},{local:"transformers.CTRLForSequenceClassification",title:"CTRLForSequenceClassification"},{local:"transformers.TFCTRLModel",title:"TFCTRLModel"},{local:"transformers.TFCTRLLMHeadModel",title:"TFCTRLLMHeadModel"},{local:"transformers.TFCTRLForSequenceClassification",title:"TFCTRLForSequenceClassification"}],title:"CTRL"};function dp(J){return Qc(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class fp extends Gc{constructor(h){super();Kc(this,h,dp,ip,Xc,{})}}export{fp as default,lp as metadata};
