...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17074/src/transformers/models/vit/feature_extraction_vit.py#L82",returnDescription:`
<p>A <a
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_17074/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_17074/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17074/src/transformers/models/vit/modeling_vit.py#L538",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17074/en/model_doc/vit#transformers.ViTConfig"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_17074/src/transformers/models/vit/modeling_vit.py#L634",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17074/src/transformers/models/vit/modeling_vit.py#L743",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17074/en/main_classes/output#transformers.modeling_outputs.ImageClassifierOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17074/src/transformers/models/vit/modeling_tf_vit.py#L656",returnDescription:`
<p>A <a
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17074/src/transformers/models/vit/modeling_tf_vit.py#L742",returnDescription:`
<p>A <a
