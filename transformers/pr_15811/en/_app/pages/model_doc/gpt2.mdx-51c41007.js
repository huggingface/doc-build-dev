import{S as bv,i as kv,s as yv,e as n,k as l,w as v,t as a,L as wv,c as s,d as t,m as d,a as i,x as b,h as r,b as c,J as e,g as h,y as k,q as y,o as w,B as P}from"../../chunks/vendor-9e2b328e.js";import{T as Le}from"../../chunks/Tip-76f97a76.js";import{D as H}from"../../chunks/Docstring-50fd6873.js";import{C as Me}from"../../chunks/CodeBlock-88e23343.js";import{I as Fe}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Pv(q){let p,M,f,T,$;return{c(){p=n("p"),M=a("When used with "),f=n("code"),T=a("is_split_into_words=True"),$=a(", this tokenizer will add a space before each word (even the first one).")},l(_){p=s(_,"P",{});var g=i(p);M=r(g,"When used with "),f=s(g,"CODE",{});var z=i(f);T=r(z,"is_split_into_words=True"),z.forEach(t),$=r(g,", this tokenizer will add a space before each word (even the first one)."),g.forEach(t)},m(_,g){h(_,p,g),e(p,M),e(p,f),e(f,T),e(p,$)},d(_){_&&t(p)}}}function $v(q){let p,M,f,T,$,_,g,z;return{c(){p=n("p"),M=a("When used with "),f=n("code"),T=a("is_split_into_words=True"),$=a(", this tokenizer needs to be instantiated with "),_=n("code"),g=a("add_prefix_space=True"),z=a(".")},l(Q){p=s(Q,"P",{});var C=i(p);M=r(C,"When used with "),f=s(C,"CODE",{});var F=i(f);T=r(F,"is_split_into_words=True"),F.forEach(t),$=r(C,", this tokenizer needs to be instantiated with "),_=s(C,"CODE",{});var R=i(_);g=r(R,"add_prefix_space=True"),R.forEach(t),z=r(C,"."),C.forEach(t)},m(Q,C){h(Q,p,C),e(p,M),e(p,f),e(f,T),e(p,$),e(p,_),e(_,g),e(p,z)},d(Q){Q&&t(p)}}}function Mv(q){let p,M,f,T,$;return{c(){p=n("p"),M=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=a("Module"),$=a(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(_,g){h(_,p,g),e(p,M),e(p,f),e(f,T),e(p,$)},d(_){_&&t(p)}}}function Gv(q){let p,M,f,T,$;return{c(){p=n("p"),M=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=i(p);M=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var z=i(f);T=r(z,"Module"),z.forEach(t),$=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(_,g){h(_,p,g),e(p,M),e(p,f),e(f,T),e(p,$)},d(_){_&&t(p)}}}function zv(q){let p,M,f,T,$;return{c(){p=n("p"),M=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=i(p);M=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var z=i(f);T=r(z,"Module"),z.forEach(t),$=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Oe.forEach(t),te=d(u),x=s(u,"UL",{});var D=i(x);E=s(D,"LI",{});var X=i(E);se=r(X,"a single Tensor with "),V=s(X,"CODE",{});var We=i(V);pe=r(We,"input_ids"),We.forEach(t),ae=r(X," only and nothing else: "),O=s(X,"CODE",{});var Ee=i(O);fe=r(Ee,"model(inputs_ids)"),Ee.forEach(t),X.forEach(t),he=d(D),j=s(D,"LI",{});var Y=i(j);ge=r(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=s(Y,"CODE",{});var Be=i(B);U=r(Be,"model([input_ids, attention_mask])"),Be.forEach(t),re=r(Y," or "),J=s(Y,"CODE",{});var qe=i(J);_e=r(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),Y.forEach(t),oe=d(D),N=s(D,"LI",{});var ve=i(N);ie=r(ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),K=s(ve,"CODE",{});var Ue=i(K);Te=r(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ve.forEach(t),D.forEach(t)},m(u,G){h(u,p,G),e(p,M),h(u,f,G),h(u,T,G),e(T,$),e($,_),e(T,g),e(T,z),e(z,Q),h(u,C,G),h(u,F,G),e(F,R),e(F,S),e(S,Z),e(F,ue),e(F,A),e(A,me),e(F,ce),h(u,W,G),h(u,L,G),e(L,ee),h(u,te,G),h(u,x,G),e(x,E),e(E,se),e(E,V),e(V,pe),e(E,ae),e(E,O),e(O,fe),e(x,he),e(x,j),e(j,ge),e(j,B),e(B,U),e(j,re),e(j,J),e(J,_e),e(x,oe),e(x,N),e(N,ie),e(N,K),e(K,Te)},d(u){u&&t(p),u&&t(f),u&&t(T),u&&t(C),u&&t(F),u&&t(W),u&&t(L),u&&t(te),u&&t(x)}}}function Cv(q){let p,M,f,T,$;return{c(){p=n("p"),M=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=i(p);M=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var z=i(f);T=r(z,"Module"),z.forEach(t),$=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Oe.forEach(t),te=d(u),x=s(u,"UL",{});var D=i(x);E=s(D,"LI",{});var X=i(E);se=r(X,"a single Tensor with "),V=s(X,"CODE",{});var We=i(V);pe=r(We,"input_ids"),We.forEach(t),ae=r(X," only and nothing else: "),O=s(X,"CODE",{});var Ee=i(O);fe=r(Ee,"model(inputs_ids)"),Ee.forEach(t),X.forEach(t),he=d(D),j=s(D,"LI",{});var Y=i(j);ge=r(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=s(Y,"CODE",{});var Be=i(B);U=r(Be,"model([input_ids, attention_mask])"),Be.forEach(t),re=r(Y," or "),J=s(Y,"CODE",{});var qe=i(J);_e=r(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),Y.forEach(t),oe=d(D),N=s(D,"LI",{});var ve=i(N);ie=r(ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),K=s(ve,"CODE",{});var Ue=i(K);Te=r(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ve.forEach(t),D.forEach(t)},m(u,G){h(u,p,G),e(p,M),h(u,f,G),h(u,T,G),e(T,$),e($,_),e(T,g),e(T,z),e(z,Q),h(u,C,G),h(u,F,G),e(F,R),e(F,S),e(S,Z),e(F,ue),e(F,A),e(A,me),e(F,ce),h(u,W,G),h(u,L,G),e(L,ee),h(u,te,G),h(u,x,G),e(x,E),e(E,se),e(E,V),e(V,pe),e(E,ae),e(E,O),e(O,fe),e(x,he),e(x,j),e(j,ge),e(j,B),e(B,U),e(j,re),e(j,J),e(J,_e),e(x,oe),e(x,N),e(N,ie),e(N,K),e(K,Te)},d(u){u&&t(p),u&&t(f),u&&t(T),u&&t(C),u&&t(F),u&&t(W),u&&t(L),u&&t(te),u&&t(x)}}}function Hv(q){let p,M,f,T,$;return{c(){p=n("p"),M=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=a("Module"),$=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=i(p);M=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var z=i(f);T=r(z,"Module"),z.forEach(t),$=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(_,g){h(_,p,g),e(p,M),e(p,f),e(f,T),e(p,$)},d(_){_&&t(p)}}}function Lv(q){let p,M,f,T,$,_,g,z,Q,C,F,R,S,Z,ue,A,me,ce,W,L,ee,te,x,E,se,V,pe,ae,O,fe,he,j,ge,B,U,re,J,_e,oe,N,ie,K,Te;return{c(){p=n("p"),M=a("TF 2.0 models accepts two formats as inputs:"),f=l(),T=n("ul"),$=n("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),z=n("li"),Q=a("having all inputs as a list, tuple or dict in the first positional arguments."),C=l(),F=n("p"),R=a("This second option is useful when using "),S=n("code"),Z=a("tf.keras.Model.fit"),ue=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=n("code"),me=a("model(inputs)"),ce=a("."),W=l(),L=n("p"),ee=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),x=n("ul"),E=n("li"),se=a("a single Tensor with "),V=n("code"),pe=a("input_ids"),ae=a(" only and nothing else: "),O=n("code"),fe=a("model(inputs_ids)"),he=l(),j=n("li"),ge=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),B=n("code"),U=a("model([input_ids, attention_mask])"),re=a(" or "),J=n("code"),_e=a("model([input_ids, attention_mask, token_type_ids])"),oe=l(),N=n("li"),ie=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),K=n("code"),Te=a('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){p=s(u,"P",{});var G=i(p);M=r(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(u),T=s(u,"UL",{});var ne=i(T);$=s(ne,"LI",{});var xe=i($);_=r(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=d(ne),z=s(ne,"LI",{});var Se=i(z);Q=r(Se,"having all inputs as a list, tuple or dict in the first positional arguments."),Se.forEach(t),ne.forEach(t),C=d(u),F=s(u,"P",{});var I=i(F);R=r(I,"This second option is useful when using "),S=s(I,"CODE",{});var je=i(S);Z=r(je,"tf.keras.Model.fit"),je.forEach(t),ue=r(I,` method which currently requires having all the
...
Argument used when doing sequence summary, used in the models <a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel">GPT2DoubleHeadsModel</a> and
<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.TFGPT2DoubleHeadsModel">TFGPT2DoubleHeadsModel</a>.</p>
...
<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel">GPT2DoubleHeadsModel</a>.</p>
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),$o=new Le({props:{$$slots:{default:[Pv]},$$scope:{ctx:q}}}),yn=new Fe({}),wn=new H({props:{name:"class transformers.GPT2TokenizerFast",anchor:"transformers.GPT2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"unk_token",val:" = '<|endoftext|>'"},{name:"bos_token",val:" = '<|endoftext|>'"},{name:"eos_token",val:" = '<|endoftext|>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/tokenization_gpt2_fast.py#L70",parametersDescription:[{anchor:"transformers.GPT2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
heads.`,name:"attentions"}]}}),jn=new Fe({}),En=new H({props:{name:"class transformers.GPT2Model",anchor:"transformers.GPT2Model",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L668",parametersDescription:[{anchor:"transformers.GPT2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Hn=new H({props:{name:"forward",anchor:"transformers.GPT2Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L737",parametersDescription:[{anchor:"transformers.GPT2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config"
...
`}}),xo=new Le({props:{$$slots:{default:[Mv]},$$scope:{ctx:q}}}),Ln=new Me({props:{code:`from transformers import GPT2Tokenizer, GPT2Model
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Nn=new H({props:{name:"parallelize",anchor:"transformers.GPT2Model.parallelize",parameters:[{name:"device_map",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L691",parametersDescription:[{anchor:"transformers.GPT2Model.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
...
model.parallelize(device_map)`}}),Sn=new H({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L711"}}),An=new Me({props:{code:`# On a 4 GPU machine with gpt2-large:
...
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),On=new Fe({}),Wn=new H({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L946",parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vn=new H({props:{name:"forward",anchor:"transformers.GPT2LMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L1015",parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
`}}),Eo=new Le({props:{$$slots:{default:[Gv]},$$scope:{ctx:q}}}),Jn=new Me({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Kn=new H({props:{name:"parallelize",anchor:"transformers.GPT2LMHeadModel.parallelize",parameters:[{name:"device_map",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L961",parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the gpt2 models have the
following number of attention modules:</p>
...
model.parallelize(device_map)`}}),Yn=new H({props:{name:"deparallelize",anchor:"transformers.GPT2LMHeadModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L973"}}),Qn=new Me({props:{code:`# On a 4 GPU machine with gpt2-large:
model = GPT2LMHeadModel.from_pretrained("gpt2-large")
device_map = {
    0: [0, 1, 2, 3, 4, 5, 6, 7],
    1: [8, 9, 10, 11, 12, 13, 14, 15],
...
model.parallelize(device_map)  <span class="hljs-comment"># Splits the model across several devices</span>
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),Zn=new Fe({}),es=new H({props:{name:"class transformers.GPT2DoubleHeadsModel",anchor:"transformers.GPT2DoubleHeadsModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L1115",parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ss=new H({props:{name:"forward",anchor:"transformers.GPT2DoubleHeadsModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"mc_token_ids",val:" = None"},{name:"labels",val:" = None"},{name:"mc_labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L1189",parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<p>A <a
  href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput"
...
`}}),Co=new Le({props:{$$slots:{default:[zv]},$$scope:{ctx:q}}}),as=new Me({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>mc_logits = outputs.mc_logits`}}),rs=new Fe({}),is=new H({props:{name:"class transformers.GPT2ForSequenceClassification",anchor:"transformers.GPT2ForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L1331",parametersDescription:[{anchor:"transformers.GPT2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ps=new H({props:{name:"forward",anchor:"transformers.GPT2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L1347",parametersDescription:[{anchor:"transformers.GPT2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
`}}),Ho=new Le({props:{$$slots:{default:[Fv]},$$scope:{ctx:q}}}),hs=new Me({props:{code:`from transformers import GPT2Tokenizer, GPT2ForSequenceClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ms=new Fe({}),fs=new H({props:{name:"class transformers.GPT2ForTokenClassification",anchor:"transformers.GPT2ForTokenClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L1457",parametersDescription:[{anchor:"transformers.GPT2ForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vs=new H({props:{name:"forward",anchor:"transformers.GPT2ForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_gpt2.py#L1479",parametersDescription:[{anchor:"transformers.GPT2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
`}}),No=new Le({props:{$$slots:{default:[xv]},$$scope:{ctx:q}}}),bs=new Me({props:{code:`from transformers import GPT2Tokenizer, GPT2ForTokenClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ks=new Fe({}),ys=new H({props:{name:"class transformers.TFGPT2Model",anchor:"transformers.TFGPT2Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_tf_gpt2.py#L727",parametersDescription:[{anchor:"transformers.TFGPT2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),So=new Le({props:{$$slots:{default:[jv]},$$scope:{ctx:q}}}),Ms=new H({props:{name:"call",anchor:"transformers.TFGPT2Model.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_tf_gpt2.py#L732",parametersDescription:[{anchor:"transformers.TFGPT2Model.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),Ao=new Le({props:{$$slots:{default:[Ev]},$$scope:{ctx:q}}}),Gs=new Me({props:{code:`from transformers import GPT2Tokenizer, TFGPT2Model
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),zs=new Fe({}),Fs=new H({props:{name:"class transformers.TFGPT2LMHeadModel",anchor:"transformers.TFGPT2LMHeadModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_tf_gpt2.py#L843",parametersDescription:[{anchor:"transformers.TFGPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Wo=new Le({props:{$$slots:{default:[qv]},$$scope:{ctx:q}}}),qs=new H({props:{name:"call",anchor:"transformers.TFGPT2LMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_tf_gpt2.py#L861",parametersDescription:[{anchor:"transformers.TFGPT2LMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),Bo=new Le({props:{$$slots:{default:[Cv]},$$scope:{ctx:q}}}),Cs=new Me({props:{code:`from transformers import GPT2Tokenizer, TFGPT2LMHeadModel
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ds=new Fe({}),Hs=new H({props:{name:"class transformers.TFGPT2DoubleHeadsModel",anchor:"transformers.TFGPT2DoubleHeadsModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_tf_gpt2.py#L995",parametersDescription:[{anchor:"transformers.TFGPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new Le({props:{$$slots:{default:[Dv]},$$scope:{ctx:q}}}),Ss=new H({props:{name:"call",anchor:"transformers.TFGPT2DoubleHeadsModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"mc_token_ids",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1004",parametersDescription:[{anchor:"transformers.TFGPT2DoubleHeadsModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.models.gpt2.modeling_tf_gpt2.TFGPT2DoubleHeadsModelOutput"
...
`}}),Vo=new Le({props:{$$slots:{default:[Hv]},$$scope:{ctx:q}}}),As=new Me({props:{code:`import tensorflow as tf
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15811/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
`}}),Xo=new Le({props:{$$slots:{default:[Nv]},$$scope:{ctx:q}}}),Js=new Me({props:{code:`from transformers import GPT2Tokenizer, TFGPT2ForSequenceClassification
import tensorflow as tf
...
`}}),Zo=new Le({props:{$$slots:{default:[Iv]},$$scope:{ctx:q}}}),ia=new Me({props:{code:`from transformers import GPT2Tokenizer, FlaxGPT2Model
...
`}}),tn=new Le({props:{$$slots:{default:[Sv]},$$scope:{ctx:q}}}),Ta=new Me({props:{code:`from transformers import GPT2Tokenizer, FlaxGPT2LMHeadModel
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sd.forEach(t),Om=d(Tt),b(So.$$.fragment,Tt),Wm=d(Tt),tt=s(Tt,"DIV",{class:!0});var Lt=i(tt);b(Ms.$$.fragment,Lt),Bm=d(Lt),co=s(Lt,"P",{});var lr=i(co);Um=r(lr,"The "),Ba=s(lr,"A",{href:!0});var Z2=i(Ba);Rm=r(Z2,"TFGPT2Model"),Z2.forEach(t),Vm=r(lr," forward method, overrides the "),$i=s(lr,"CODE",{});var e1=i($i);Jm=r(e1,"__call__"),e1.forEach(t),Km=r(lr," special method."),lr.forEach(t),Xm=d(Lt),b(Ao.$$.fragment,Lt),Ym=d(Lt),Mi=s(Lt,"P",{});var t1=i(Mi);Qm=r(t1,"Example:"),t1.forEach(t),Zm=d(Lt),b(Gs.$$.fragment,Lt),Lt.forEach(t),Tt.forEach(t),Zl=d(o),po=s(o,"H2",{class:!0});var Ad=i(po);Oo=s(Ad,"A",{id:!0,class:!0,href:!0});var o1=i(Oo);Gi=s(o1,"SPAN",{});var n1=i(Gi);b(zs.$$.fragment,n1),n1.forEach(t),o1.forEach(t),ef=d(Ad),zi=s(Ad,"SPAN",{});var s1=i(zi);tf=r(s1,"TFGPT2LMHeadModel"),s1.forEach(t),Ad.forEach(t),ed=d(o),De=s(o,"DIV",{class:!0});var vt=i(De);b(Fs.$$.fragment,vt),of=d(vt),Fi=s(vt,"P",{});var a1=i(Fi);nf=r(a1,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),a1.forEach(t),sf=d(vt),xs=s(vt,"P",{});var Od=i(xs);af=r(Od,"This model inherits from "),Ua=s(Od,"A",{href:!0});var r1=i(Ua);rf=r(r1,"TFPreTrainedModel"),r1.forEach(t),lf=r(Od,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Od.forEach(t),df=d(vt),js=s(vt,"P",{});var Wd=i(js);cf=r(Wd,"This model is also a "),Es=s(Wd,"A",{href:!0,rel:!0});var i1=i(Es);pf=r(i1,"tf.keras.Model"),i1.forEach(t),hf=r(Wd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wd.forEach(t),uf=d(vt),b(Wo.$$.fragment,vt),mf=d(vt),ot=s(vt,"DIV",{class:!0});var Nt=i(ot);b(qs.$$.fragment,Nt),ff=d(Nt),ho=s(Nt,"P",{});var dr=i(ho);gf=r(dr,"The "),Ra=s(dr,"A",{href:!0});var l1=i(Ra);_f=r(l1,"TFGPT2LMHeadModel"),l1.forEach(t),Tf=r(dr," forward method, overrides the "),xi=s(dr,"CODE",{});var d1=i(xi);vf=r(d1,"__call__"),d1.forEach(t),bf=r(dr," special method."),dr.forEach(t),kf=d(Nt),b(Bo.$$.fragment,Nt),yf=d(Nt),ji=s(Nt,"P",{});var c1=i(ji);wf=r(c1,"Example:"),c1.forEach(t),Pf=d(Nt),b(Cs.$$.fragment,Nt),Nt.forEach(t),vt.forEach(t),td=d(o),uo=s(o,"H2",{class:!0});var Bd=i(uo);Uo=s(Bd,"A",{id:!0,class:!0,href:!0});var p1=i(Uo);Ei=s(p1,"SPAN",{});var h1=i(Ei);b(Ds.$$.fragment,h1),h1.forEach(t),p1.forEach(t),$f=d(Bd),qi=s(Bd,"SPAN",{});var u1=i(qi);Mf=r(u1,"TFGPT2DoubleHeadsModel"),u1.forEach(t),Bd.forEach(t),od=d(o),He=s(o,"DIV",{class:!0});var bt=i(He);b(Hs.$$.fragment,bt),Gf=d(bt),Ci=s(bt,"P",{});var m1=i(Ci);zf=r(m1,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),m1.forEach(t),Ff=d(bt),Ls=s(bt,"P",{});var Ud=i(Ls);xf=r(Ud,"This model inherits from "),Va=s(Ud,"A",{href:!0});var f1=i(Va);jf=r(f1,"TFPreTrainedModel"),f1.forEach(t),Ef=r(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(t),qf=d(bt),Ns=s(bt,"P",{});var Rd=i(Ns);Cf=r(Rd,"This model is also a "),Is=s(Rd,"A",{href:!0,rel:!0});var g1=i(Is);Df=r(g1,"tf.keras.Model"),g1.forEach(t),Hf=r(Rd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rd.forEach(t),Lf=d(bt),b(Ro.$$.fragment,bt),Nf=d(bt),nt=s(bt,"DIV",{class:!0});var It=i(nt);b(Ss.$$.fragment,It),If=d(It),mo=s(It,"P",{});var cr=i(mo);Sf=r(cr,"The "),Ja=s(cr,"A",{href:!0});var _1=i(Ja);Af=r(_1,"TFGPT2DoubleHeadsModel"),_1.forEach(t),Of=r(cr," forward method, overrides the "),Di=s(cr,"CODE",{});var T1=i(Di);Wf=r(T1,"__call__"),T1.forEach(t),Bf=r(cr," special method."),cr.forEach(t),Uf=d(It),b(Vo.$$.fragment,It),Rf=d(It),Hi=s(It,"P",{});var v1=i(Hi);Vf=r(v1,"Examples:"),v1.forEach(t),Jf=d(It),b(As.$$.fragment,It),It.forEach(t),bt.forEach(t),nd=d(o),fo=s(o,"H2",{class:!0});var Vd=i(fo);Jo=s(Vd,"A",{id:!0,class:!0,href:!0});var b1=i(Jo);Li=s(b1,"SPAN",{});var k1=i(Li);b(Os.$$.fragment,k1),k1.forEach(t),b1.forEach(t),Kf=d(Vd),Ni=s(Vd,"SPAN",{});var y1=i(Ni);Xf=r(y1,"TFGPT2ForSequenceClassification"),y1.forEach(t),Vd.forEach(t),sd=d(o),de=s(o,"DIV",{class:!0});var Ie=i(de);b(Ws.$$.fragment,Ie),Yf=d(Ie),Ii=s(Ie,"P",{});var w1=i(Ii);Qf=r(w1,"The GPT2 Model transformer with a sequence classification head on top (linear layer)."),w1.forEach(t),Zf=d(Ie),Ka=s(Ie,"P",{});var K_=i(Ka);Xa=s(K_,"A",{href:!0});var P1=i(Xa);eg=r(P1,"TFGPT2ForSequenceClassification"),P1.forEach(t),tg=r(K_,` uses the last token in order to do the classification, as other causal models
