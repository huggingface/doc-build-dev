...
`}}),pn=new ss({}),dn=new de({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tapas.py#L856",parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),_n=new de({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tapas.py#L894",parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),bn=new ss({}),vn=new de({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tapas.py#L1009",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new de({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tapas.py#L1028",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),qn=new ss({}),En=new de({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tapas.py#L1468",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$n=new de({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tapas.py#L1480",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),Qn=new ss({}),On=new de({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tf_tapas.py#L976",parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new As({props:{$$slots:{default:[V2]},$$scope:{ctx:U}}}),Hn=new de({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tf_tapas.py#L982",parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Gn=new ss({}),Rn=new de({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tf_tapas.py#L1066",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ta=new As({props:{$$slots:{default:[Y2]},$$scope:{ctx:U}}}),Xn=new de({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tf_tapas.py#L1082",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),eo=new ss({}),so=new de({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tf_tapas.py#L1649",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15811/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oa=new As({props:{$$slots:{default:[X2]},$$scope:{ctx:U}}}),oo=new de({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15811/src/transformers/models/tapas/modeling_tf_tapas.py#L1660",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15811/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15811/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gw=l(),b(oa.$$.fragment),Rw=l(),ls=o("div"),b(oo.$$.fragment),Vw=l(),yt=o("p"),Kw=a("The "),Tr=o("a"),Yw=a("TFTapasForSequenceClassification"),Jw=a(" forward method, overrides the "),Wp=o("code"),Xw=a("__call__"),Zw=a(" special method."),e1=l(),b(ra.$$.fragment),s1=l(),Up=o("p"),t1=a("Examples:"),a1=l(),b(ro.$$.fragment),lc=l(),kt=o("h2"),ia=o("a"),Hp=o("span"),b(io.$$.fragment),n1=l(),Bp=o("span"),o1=a("TFTapasForQuestionAnswering"),pc=l(),Oe=o("div"),b(lo.$$.fragment),r1=l(),jt=o("p"),i1=a(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Gp=o("code"),l1=a("logits"),p1=a(" and optional "),Rp=o("code"),d1=a("logits_aggregation"),c1=a(`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),h1=l(),po=o("p"),u1=a("This model inherits from "),br=o("a"),m1=a("TFPreTrainedModel"),f1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),g1=l(),co=o("p"),_1=a("This model is also a "),ho=o("a"),T1=a("tf.keras.Model"),b1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),v1=l(),b(la.$$.fragment),w1=l(),ps=o("div"),b(uo.$$.fragment),y1=l(),qt=o("p"),k1=a("The "),vr=o("a"),j1=a("TFTapasForQuestionAnswering"),q1=a(" forward method, overrides the "),Vp=o("code"),E1=a("__call__"),F1=a(" special method."),A1=l(),b(pa.$$.fragment),z1=l(),Kp=o("p"),$1=a("Examples:"),x1=l(),b(mo.$$.fragment),this.h()},l(t){const h=W2('[data-svelte="svelte-1phssyn"]',document.head);m=r(h,"META",{name:!0,content:!0}),h.forEach(s),F=p(t),f=r(t,"H1",{class:!0});var fo=i(f);g=r(fo,"A",{id:!0,class:!0,href:!0});var Yp=i(g);q=r(Yp,"SPAN",{});var Jp=i(q);v(T.$$.fragment,Jp),Jp.forEach(s),Yp.forEach(s),_=p(fo),A=r(fo,"SPAN",{});var Xp=i(A);_e=n(Xp,"TAPAS"),Xp.forEach(s),fo.forEach(s),K=p(t),z=r(t,"H2",{class:!0});var go=i(z);Y=r(go,"A",{id:!0,class:!0,href:!0});var Zp=i(Y);O=r(Zp,"SPAN",{});var ed=i(O);v(Z.$$.fragment,ed),ed.forEach(s),Zp.forEach(s),Te=p(go),I=r(go,"SPAN",{});var sd=i(I);be=n(sd,"Overview"),sd.forEach(s),go.forEach(s),ce=p(t),W=r(t,"P",{});var _o=i(W);N=n(_o,"The TAPAS model was proposed in "),ee=r(_o,"A",{href:!0,rel:!0});var td=i(ee);se=n(td,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),td.forEach(s),$=n(_o,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),_o.forEach(s),x=p(t),oe=r(t,"P",{});var ad=i(oe);H=n(ad,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),ad.forEach(s),he=p(t),V=r(t,"UL",{});var Et=i(V);L=r(Et,"LI",{});var C1=i(L);te=r(C1,"A",{href:!0,rel:!0});var G1=i(te);ve=n(G1,"SQA"),G1.forEach(s),C=n(C1," (Sequential Question Answering by Microsoft)"),C1.forEach(s),we=p(Et),Q=r(Et,"LI",{});var M1=i(Q);ae=r(M1,"A",{href:!0,rel:!0});var R1=i(ae);ye=n(R1,"WTQ"),R1.forEach(s),B=n(M1," (Wiki Table Questions by Stanford University)"),M1.forEach(s),ke=p(Et),re=r(Et,"LI",{});var P1=i(re);P=r(P1,"A",{href:!0,rel:!0});var V1=i(P);je=n(V1,"WikiSQL"),V1.forEach(s),G=n(P1," (by Salesforce)."),P1.forEach(s),Et.forEach(s),ue=p(t),u=r(t,"P",{});var K1=i(u);E=n(K1,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),K1.forEach(s),J=p(t),Fe=r(t,"P",{});var Y1=i(Fe);Ge=n(Y1,"The abstract from the paper is the following:"),Y1.forEach(s),S=p(t),Ae=r(t,"P",{});var J1=i(Ae);xe=r(J1,"EM",{});var X1=i(xe);Re=n(X1,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),X1.forEach(s),J1.forEach(s),D=p(t),M=r(t,"P",{});var da=i(M);Ve=n(da,"In addition, the authors have further pre-trained TAPAS to recognize "),Ce=r(da,"STRONG",{});var Z1=i(Ce);R=n(Z1,"table entailment"),Z1.forEach(s),Ke=n(da,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),qe=r(da,"A",{href:!0,rel:!0});var ey=i(qe);Ee=n(ey,"TabFact"),ey.forEach(s),Ye=n(da,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),ga=r(da,"A",{href:!0,rel:!0});var sy=i(ga);ph=n(sy,"Understanding tables with intermediate pre-training"),sy.forEach(s),dh=n(da," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),da.forEach(s),nd=p(t),At=r(t,"IMG",{src:!0,alt:!0,width:!0}),od=p(t),zt=r(t,"SMALL",{});var cc=i(zt);ch=n(cc,"TAPAS architecture. Taken from the "),To=r(cc,"A",{href:!0});var ty=i(To);hh=n(ty,"original blog post"),ty.forEach(s),uh=n(cc,"."),cc.forEach(s),rd=p(t),_s=r(t,"P",{});var ca=i(_s);mh=n(ca,"This model was contributed by "),_a=r(ca,"A",{href:!0,rel:!0});var ay=i(_a);fh=n(ay,"nielsr"),ay.forEach(s),gh=n(ca,". The Tensorflow version of this model was contributed by "),Ta=r(ca,"A",{href:!0,rel:!0});var ny=i(Ta);_h=n(ny,"kamalkraj"),ny.forEach(s),Th=n(ca,". The original code can be found "),ba=r(ca,"A",{href:!0,rel:!0});var oy=i(ba);bh=n(oy,"here"),oy.forEach(s),vh=n(ca,"."),ca.forEach(s),id=p(t),bo=r(t,"P",{});var ry=i(bo);wh=n(ry,"Tips:"),ry.forEach(s),ld=p(t),Ts=r(t,"UL",{});var ha=i(Ts);Me=r(ha,"LI",{});var ds=i(Me);yh=n(ds,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),Br=r(ds,"CODE",{});var iy=i(Br);kh=n(iy,"reset_position_index_per_cell"),iy.forEach(s),jh=n(ds," parameter of "),vo=r(ds,"A",{href:!0});var ly=i(vo);qh=n(ly,"TapasConfig"),ly.forEach(s),Eh=n(ds,", which is set to "),Gr=r(ds,"CODE",{});var py=i(Gr);Fh=n(py,"True"),py.forEach(s),Ah=n(ds," by default. The default versions of the models available on the "),va=r(ds,"A",{href:!0,rel:!0});var dy=i(va);zh=n(dy,"hub"),dy.forEach(s),$h=n(ds," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),Rr=r(ds,"CODE",{});var cy=i(Rr);xh=n(cy,'revision="no_reset"'),cy.forEach(s),Ch=n(ds," when calling the "),Vr=r(ds,"CODE",{});var hy=i(Vr);Mh=n(hy,"from_pretrained()"),hy.forEach(s),Ph=n(ds," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),ds.forEach(s),Sh=p(ha),Je=r(ha,"LI",{});var vs=i(Je);Dh=n(vs,"TAPAS is based on BERT, so "),Kr=r(vs,"CODE",{});var uy=i(Kr);Nh=n(uy,"TAPAS-base"),uy.forEach(s),Lh=n(vs," for example corresponds to a "),Yr=r(vs,"CODE",{});var my=i(Yr);Qh=n(my,"BERT-base"),my.forEach(s),Oh=n(vs," architecture. Of course, "),Jr=r(vs,"CODE",{});var fy=i(Jr);Ih=n(fy,"TAPAS-large"),fy.forEach(s),Wh=n(vs," will result in the best performance (the results reported in the paper are from "),Xr=r(vs,"CODE",{});var gy=i(Xr);Uh=n(gy,"TAPAS-large"),gy.forEach(s),Hh=n(vs,"). Results of the various sized models are shown on the "),wa=r(vs,"A",{href:!0,rel:!0});var _y=i(wa);Bh=n(_y,"original Github repository"),_y.forEach(s),Gh=n(vs,"."),vs.forEach(s),Rh=p(ha),Vs=r(ha,"LI",{});var wr=i(Vs);Vh=n(wr,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),Zr=r(wr,"CODE",{});var Ty=i(Zr);Kh=n(Ty,"prev_labels"),Ty.forEach(s),Yh=n(wr," token type ids can be overwritten by the predicted "),ei=r(wr,"CODE",{});var by=i(ei);Jh=n(by,"labels"),by.forEach(s),Xh=n(wr," of the model to the previous question. See \u201CUsage\u201D section for more info."),wr.forEach(s),Zh=p(ha),si=r(ha,"LI",{});var vy=i(si);eu=n(vy,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),vy.forEach(s),ha.forEach(s),pd=p(t),Ks=r(t,"H2",{class:!0});var hc=i(Ks);$t=r(hc,"A",{id:!0,class:!0,href:!0});var wy=i($t);ti=r(wy,"SPAN",{});var yy=i(ti);v(ya.$$.fragment,yy),yy.forEach(s),wy.forEach(s),su=p(hc),ai=r(hc,"SPAN",{});var ky=i(ai);tu=n(ky,"Usage: fine-tuning"),ky.forEach(s),hc.forEach(s),dd=p(t),xt=r(t,"P",{});var uc=i(xt);au=n(uc,"Here we explain how you can fine-tune "),wo=r(uc,"A",{href:!0});var jy=i(wo);nu=n(jy,"TapasForQuestionAnswering"),jy.forEach(s),ou=n(uc," on your own dataset."),uc.forEach(s),cd=p(t),yo=r(t,"P",{});var qy=i(yo);ni=r(qy,"STRONG",{});var Ey=i(ni);ru=n(Ey,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),Ey.forEach(s),qy.forEach(s),hd=p(t),Ct=r(t,"P",{});var mc=i(Ct);iu=n(mc,"Basically, there are 3 different ways in which one can fine-tune "),ko=r(mc,"A",{href:!0});var Fy=i(ko);lu=n(Fy,"TapasForQuestionAnswering"),Fy.forEach(s),pu=n(mc,", corresponding to the different datasets on which Tapas was fine-tuned:"),mc.forEach(s),ud=p(t),$s=r(t,"OL",{});var yr=i($s);oi=r(yr,"LI",{});var Ay=i(oi);du=n(Ay,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),Ay.forEach(s),cu=p(yr),ka=r(yr,"LI",{});var fc=i(ka);hu=n(fc,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ri=r(fc,"STRONG",{});var zy=i(ri);uu=n(zy,"weak supervision"),zy.forEach(s),mu=n(fc,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),fc.forEach(s),fu=p(yr),ja=r(yr,"LI",{});var gc=i(ja);gu=n(gc,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ii=r(gc,"STRONG",{});var $y=i(ii);_u=n($y,"strong supervision"),$y.forEach(s),Tu=n(gc,". Here, learning the appropriate aggregation operator is much easier."),gc.forEach(s),yr.forEach(s),md=p(t),jo=r(t,"P",{});var xy=i(jo);bu=n(xy,"To summarize:"),xy.forEach(s),fd=p(t),Mt=r(t,"TABLE",{});var _c=i(Mt);li=r(_c,"THEAD",{});var Cy=i(li);Ys=r(Cy,"TR",{});var kr=i(Ys);pi=r(kr,"TH",{});var My=i(pi);di=r(My,"STRONG",{});var Py=i(di);vu=n(Py,"Task"),Py.forEach(s),My.forEach(s),wu=p(kr),ci=r(kr,"TH",{});var Sy=i(ci);hi=r(Sy,"STRONG",{});var Dy=i(hi);yu=n(Dy,"Example dataset"),Dy.forEach(s),Sy.forEach(s),ku=p(kr),ui=r(kr,"TH",{});var Ny=i(ui);mi=r(Ny,"STRONG",{});var Ly=i(mi);ju=n(Ly,"Description"),Ly.forEach(s),Ny.forEach(s),kr.forEach(s),Cy.forEach(s),qu=p(_c),Js=r(_c,"TBODY",{});var jr=i(Js);Xs=r(jr,"TR",{});var qr=i(Xs);fi=r(qr,"TD",{});var Qy=i(fi);Eu=n(Qy,"Conversational"),Qy.forEach(s),Fu=p(qr),gi=r(qr,"TD",{});var Oy=i(gi);Au=n(Oy,"SQA"),Oy.forEach(s),zu=p(qr),_i=r(qr,"TD",{});var Iy=i(_i);$u=n(Iy,"Conversational, only cell selection questions"),Iy.forEach(s),qr.forEach(s),xu=p(jr),Zs=r(jr,"TR",{});var Er=i(Zs);Ti=r(Er,"TD",{});var Wy=i(Ti);Cu=n(Wy,"Weak supervision for aggregation"),Wy.forEach(s),Mu=p(Er),bi=r(Er,"TD",{});var Uy=i(bi);Pu=n(Uy,"WTQ"),Uy.forEach(s),Su=p(Er),vi=r(Er,"TD",{});var Hy=i(vi);Du=n(Hy,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Hy.forEach(s),Er.forEach(s),Nu=p(jr),et=r(jr,"TR",{});var Fr=i(et);wi=r(Fr,"TD",{});var By=i(wi);Lu=n(By,"Strong supervision for aggregation"),By.forEach(s),Qu=p(Fr),yi=r(Fr,"TD",{});var Gy=i(yi);Ou=n(Gy,"WikiSQL-supervised"),Gy.forEach(s),Iu=p(Fr),ki=r(Fr,"TD",{});var Ry=i(ki);Wu=n(Ry,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),Ry.forEach(s),Fr.forEach(s),jr.forEach(s),_c.forEach(s),gd=p(t),xs=r(t,"P",{});var Ar=i(xs);Uu=n(Ar,`Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the
`),qa=r(Ar,"A",{href:!0,rel:!0});var Vy=i(qa);Hu=n(Vy,"torch-scatter"),Vy.forEach(s),Bu=n(Ar," dependency for your environment in case you\u2019re using PyTorch, or the "),Ea=r(Ar,"A",{href:!0,rel:!0});var Ky=i(Ea);Gu=n(Ky,"tensorflow_probability"),Ky.forEach(s),Ru=n(Ar,`
dependency in case you\u2019re using Tensorflow:`),Ar.forEach(s),_d=p(t),v(Fa.$$.fragment,t),Td=p(t),Cs=r(t,"P",{});var zr=i(Cs);Vu=n(zr,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),qo=r(zr,"A",{href:!0});var Yy=i(qo);Ku=n(Yy,"TapasConfig"),Yy.forEach(s),Yu=n(zr,", and then create a "),Eo=r(zr,"A",{href:!0});var Jy=i(Eo);Ju=n(Jy,"TapasForQuestionAnswering"),Jy.forEach(s),Xu=n(zr," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),zr.forEach(s),bd=p(t),v(Aa.$$.fragment,t),vd=p(t),Pt=r(t,"P",{});var Tc=i(Pt);Zu=n(Tc,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),za=r(Tc,"A",{href:!0,rel:!0});var Xy=i(za);em=n(Xy,"here"),Xy.forEach(s),sm=n(Tc," for more info."),Tc.forEach(s),wd=p(t),St=r(t,"P",{});var bc=i(St);tm=n(bc,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),$a=r(bc,"A",{href:!0,rel:!0});var Zy=i($a);am=n(Zy,"here"),Zy.forEach(s),nm=n(bc,"."),bc.forEach(s),yd=p(t),Fo=r(t,"P",{});var ek=i(Fo);ji=r(ek,"STRONG",{});var sk=i(ji);om=n(sk,"STEP 2: Prepare your data in the SQA format"),sk.forEach(s),ek.forEach(s),kd=p(t),Dt=r(t,"P",{});var vc=i(Dt);rm=n(vc,"Second, no matter what you picked above, you should prepare your dataset in the "),xa=r(vc,"A",{href:!0,rel:!0});var tk=i(xa);im=n(tk,"SQA"),tk.forEach(s),lm=n(vc," format. This format is a TSV/CSV file with the following columns:"),vc.forEach(s),jd=p(t),ie=r(t,"UL",{});var $e=i(ie);Ao=r($e,"LI",{});var S1=i(Ao);qi=r(S1,"CODE",{});var ak=i(qi);pm=n(ak,"id"),ak.forEach(s),dm=n(S1,": optional, id of the table-question pair, for bookkeeping purposes."),S1.forEach(s),cm=p($e),zo=r($e,"LI",{});var D1=i(zo);Ei=r(D1,"CODE",{});var nk=i(Ei);hm=n(nk,"annotator"),nk.forEach(s),um=n(D1,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),D1.forEach(s),mm=p($e),$o=r($e,"LI",{});var N1=i($o);Fi=r(N1,"CODE",{});var ok=i(Fi);fm=n(ok,"position"),ok.forEach(s),gm=n(N1,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),N1.forEach(s),_m=p($e),xo=r($e,"LI",{});var L1=i(xo);Ai=r(L1,"CODE",{});var rk=i(Ai);Tm=n(rk,"question"),rk.forEach(s),bm=n(L1,": string"),L1.forEach(s),vm=p($e),Co=r($e,"LI",{});var Q1=i(Co);zi=r(Q1,"CODE",{});var ik=i(zi);wm=n(ik,"table_file"),ik.forEach(s),ym=n(Q1,": string, name of a csv file containing the tabular data"),Q1.forEach(s),km=p($e),Mo=r($e,"LI",{});var O1=i(Mo);$i=r(O1,"CODE",{});var lk=i($i);jm=n(lk,"answer_coordinates"),lk.forEach(s),qm=n(O1,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),O1.forEach(s),Em=p($e),Po=r($e,"LI",{});var I1=i(Po);xi=r(I1,"CODE",{});var pk=i(xi);Fm=n(pk,"answer_text"),pk.forEach(s),Am=n(I1,": list of one or more strings (each string being a cell value that is part of the answer)"),I1.forEach(s),zm=p($e),So=r($e,"LI",{});var W1=i(So);Ci=r(W1,"CODE",{});var dk=i(Ci);$m=n(dk,"aggregation_label"),dk.forEach(s),xm=n(W1,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),W1.forEach(s),Cm=p($e),Do=r($e,"LI",{});var U1=i(Do);Mi=r(U1,"CODE",{});var ck=i(Mi);Mm=n(ck,"float_answer"),ck.forEach(s),Pm=n(U1,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),U1.forEach(s),$e.forEach(s),qd=p(t),We=r(t,"P",{});var ws=i(We);Sm=n(ws,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),Ca=r(ws,"A",{href:!0,rel:!0});var hk=i(Ca);Dm=n(hk,"here"),hk.forEach(s),Nm=n(ws,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),Ma=r(ws,"A",{href:!0,rel:!0});var uk=i(Ma);Lm=n(uk,"here"),uk.forEach(s),Qm=n(ws,". Interestingly, these conversion scripts are not perfect (the "),Pi=r(ws,"CODE",{});var mk=i(Pi);Om=n(mk,"answer_coordinates"),mk.forEach(s),Im=n(ws," and "),Si=r(ws,"CODE",{});var fk=i(Si);Wm=n(fk,"float_answer"),fk.forEach(s),Um=n(ws," fields are populated based on the "),Di=r(ws,"CODE",{});var gk=i(Di);Hm=n(gk,"answer_text"),gk.forEach(s),Bm=n(ws,"), meaning that WTQ and WikiSQL results could actually be improved."),ws.forEach(s),Ed=p(t),No=r(t,"P",{});var _k=i(No);Ni=r(_k,"STRONG",{});var Tk=i(Ni);Gm=n(Tk,"STEP 3: Convert your data into PyTorch/TensorFlow tensors using TapasTokenizer"),Tk.forEach(s),_k.forEach(s),Fd=p(t),ze=r(t,"P",{});var cs=i(ze);Rm=n(cs,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),Lo=r(cs,"A",{href:!0});var bk=i(Lo);Vm=n(bk,"TapasTokenizer"),bk.forEach(s),Km=n(cs," to convert table-question pairs into "),Li=r(cs,"CODE",{});var vk=i(Li);Ym=n(vk,"input_ids"),vk.forEach(s),Jm=n(cs,", "),Qi=r(cs,"CODE",{});var wk=i(Qi);Xm=n(wk,"attention_mask"),wk.forEach(s),Zm=n(cs,", "),Oi=r(cs,"CODE",{});var yk=i(Oi);ef=n(yk,"token_type_ids"),yk.forEach(s),sf=n(cs," and so on. Again, based on which of the three cases you picked above, "),Qo=r(cs,"A",{href:!0});var kk=i(Qo);tf=n(kk,"TapasForQuestionAnswering"),kk.forEach(s),af=n(cs,"/"),Oo=r(cs,"A",{href:!0});var jk=i(Oo);nf=n(jk,"TFTapasForQuestionAnswering"),jk.forEach(s),of=n(cs,` requires different
inputs to be fine-tuned:`),cs.forEach(s),Ad=p(t),Nt=r(t,"TABLE",{});var wc=i(Nt);Ii=r(wc,"THEAD",{});var qk=i(Ii);Pa=r(qk,"TR",{});var yc=i(Pa);Wi=r(yc,"TH",{});var Ek=i(Wi);Ui=r(Ek,"STRONG",{});var Fk=i(Ui);rf=n(Fk,"Task"),Fk.forEach(s),Ek.forEach(s),lf=p(yc),Hi=r(yc,"TH",{});var Ak=i(Hi);Bi=r(Ak,"STRONG",{});var zk=i(Bi);pf=n(zk,"Required inputs"),zk.forEach(s),Ak.forEach(s),yc.forEach(s),qk.forEach(s),df=p(wc),st=r(wc,"TBODY",{});var $r=i(st);Sa=r($r,"TR",{});var kc=i(Sa);Gi=r(kc,"TD",{});var $k=i(Gi);cf=n($k,"Conversational"),$k.forEach(s),hf=p(kc),zs=r(kc,"TD",{});var ua=i(zs);Ri=r(ua,"CODE",{});var xk=i(Ri);uf=n(xk,"input_ids"),xk.forEach(s),mf=n(ua,", "),Vi=r(ua,"CODE",{});var Ck=i(Vi);ff=n(Ck,"attention_mask"),Ck.forEach(s),gf=n(ua,", "),Ki=r(ua,"CODE",{});var Mk=i(Ki);_f=n(Mk,"token_type_ids"),Mk.forEach(s),Tf=n(ua,", "),Yi=r(ua,"CODE",{});var Pk=i(Yi);bf=n(Pk,"labels"),Pk.forEach(s),ua.forEach(s),kc.forEach(s),vf=p($r),Da=r($r,"TR",{});var jc=i(Da);Ji=r(jc,"TD",{});var Sk=i(Ji);wf=n(Sk,"Weak supervision for aggregation"),Sk.forEach(s),yf=p(jc),Pe=r(jc,"TD",{});var hs=i(Pe);Xi=r(hs,"CODE",{});var Dk=i(Xi);kf=n(Dk,"input_ids"),Dk.forEach(s),jf=n(hs,", "),Zi=r(hs,"CODE",{});var Nk=i(Zi);qf=n(Nk,"attention_mask"),Nk.forEach(s),Ef=n(hs,", "),el=r(hs,"CODE",{});var Lk=i(el);Ff=n(Lk,"token_type_ids"),Lk.forEach(s),Af=n(hs,", "),sl=r(hs,"CODE",{});var Qk=i(sl);zf=n(Qk,"labels"),Qk.forEach(s),$f=n(hs,", "),tl=r(hs,"CODE",{});var Ok=i(tl);xf=n(Ok,"numeric_values"),Ok.forEach(s),Cf=n(hs,", "),al=r(hs,"CODE",{});var Ik=i(al);Mf=n(Ik,"numeric_values_scale"),Ik.forEach(s),Pf=n(hs,", "),nl=r(hs,"CODE",{});var Wk=i(nl);Sf=n(Wk,"float_answer"),Wk.forEach(s),hs.forEach(s),jc.forEach(s),Df=p($r),Na=r($r,"TR",{});var qc=i(Na);ol=r(qc,"TD",{});var Uk=i(ol);Nf=n(Uk,"Strong supervision for aggregation"),Uk.forEach(s),Lf=p(qc),ms=r(qc,"TD",{});var Ss=i(ms);rl=r(Ss,"CODE",{});var Hk=i(rl);Qf=n(Hk,"input ids"),Hk.forEach(s),Of=n(Ss,", "),il=r(Ss,"CODE",{});var Bk=i(il);If=n(Bk,"attention mask"),Bk.forEach(s),Wf=n(Ss,", "),ll=r(Ss,"CODE",{});var Gk=i(ll);Uf=n(Gk,"token type ids"),Gk.forEach(s),Hf=n(Ss,", "),pl=r(Ss,"CODE",{});var Rk=i(pl);Bf=n(Rk,"labels"),Rk.forEach(s),Gf=n(Ss,", "),dl=r(Ss,"CODE",{});var Vk=i(dl);Rf=n(Vk,"aggregation_labels"),Vk.forEach(s),Ss.forEach(s),qc.forEach(s),$r.forEach(s),wc.forEach(s),zd=p(t),le=r(t,"P",{});var Ie=i(le);Io=r(Ie,"A",{href:!0});var Kk=i(Io);Vf=n(Kk,"TapasTokenizer"),Kk.forEach(s),Kf=n(Ie," creates the "),cl=r(Ie,"CODE",{});var Yk=i(cl);Yf=n(Yk,"labels"),Yk.forEach(s),Jf=n(Ie,", "),hl=r(Ie,"CODE",{});var Jk=i(hl);Xf=n(Jk,"numeric_values"),Jk.forEach(s),Zf=n(Ie," and "),ul=r(Ie,"CODE",{});var Xk=i(ul);eg=n(Xk,"numeric_values_scale"),Xk.forEach(s),sg=n(Ie," based on the "),ml=r(Ie,"CODE",{});var Zk=i(ml);tg=n(Zk,"answer_coordinates"),Zk.forEach(s),ag=n(Ie," and "),fl=r(Ie,"CODE",{});var ej=i(fl);ng=n(ej,"answer_text"),ej.forEach(s),og=n(Ie," columns of the TSV file. The "),gl=r(Ie,"CODE",{});var sj=i(gl);rg=n(sj,"float_answer"),sj.forEach(s),ig=n(Ie," and "),_l=r(Ie,"CODE",{});var tj=i(_l);lg=n(tj,"aggregation_labels"),tj.forEach(s),pg=n(Ie," are already in the TSV file of step 2. Here\u2019s an example:"),Ie.forEach(s),$d=p(t),v(La.$$.fragment,t),xd=p(t),bs=r(t,"P",{});var ma=i(bs);dg=n(ma,"Note that "),Wo=r(ma,"A",{href:!0});var aj=i(Wo);cg=n(aj,"TapasTokenizer"),aj.forEach(s),hg=n(ma," expects the data of the table to be "),Tl=r(ma,"STRONG",{});var nj=i(Tl);ug=n(nj,"text-only"),nj.forEach(s),mg=n(ma,". You can use "),bl=r(ma,"CODE",{});var oj=i(bl);fg=n(oj,".astype(str)"),oj.forEach(s),gg=n(ma,` on a dataframe to turn it into text-only data.
...
question tokens, special tokens and padding.`),uq.forEach(s),us.forEach(s),AT=p(Be),sr=r(Be,"P",{});var H1=i(sr);tr=r(H1,"A",{href:!0});var mq=i(tr);zT=n(mq,"TapasTokenizer"),mq.forEach(s),$T=n(H1,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),H1.forEach(s),xT=p(Be),Ut=r(Be,"DIV",{class:!0});var Pc=i(Ut);v(an.$$.fragment,Pc),CT=p(Pc),ip=r(Pc,"P",{});var fq=i(ip);MT=n(fq,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),fq.forEach(s),Pc.forEach(s),PT=p(Be),Ps=r(Be,"DIV",{class:!0});var Cr=i(Ps);v(nn.$$.fragment,Cr),ST=p(Cr),on=r(Cr,"P",{});var Sc=i(on);DT=n(Sc,"Converts logits of "),ar=r(Sc,"A",{href:!0});var gq=i(ar);NT=n(gq,"TapasForQuestionAnswering"),gq.forEach(s),LT=n(Sc,` to actual predicted answer coordinates and optional
