...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17014/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17014/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17014/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yf.forEach(t),FT=h(Nt),y(bs.$$.fragment,Nt),xT=h(Nt),pt=s(Nt,"DIV",{class:!0});var co=a(pt);y(ti.$$.fragment,co),RT=h(co),Uo=s(co,"P",{});var qd=a(Uo);MT=i(qd,"The "),rd=s(qd,"A",{href:!0});var XF=a(rd);ET=i(XF,"TFRobertaForTokenClassification"),XF.forEach(t),zT=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var YF=a(dp);qT=i(YF,"__call__"),YF.forEach(t),CT=i(qd," special method."),qd.forEach(t),jT=h(co),y(ks.$$.fragment,co),PT=h(co),y(vs.$$.fragment,co),LT=h(co),y(Ts.$$.fragment,co),co.forEach(t),Nt.forEach(t),Wm=h(o),Ho=s(o,"H2",{class:!0});var Zf=a(Ho);ys=s(Zf,"A",{id:!0,class:!0,href:!0});var ZF=a(ys);cp=s(ZF,"SPAN",{});var e4=a(cp);y(oi.$$.fragment,e4),e4.forEach(t),ZF.forEach(t),AT=h(Zf),pp=s(Zf,"SPAN",{});var t4=a(pp);OT=i(t4,"TFRobertaForQuestionAnswering"),t4.forEach(t),Zf.forEach(t),Bm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);y(ni.$$.fragment,It),NT=h(It),Qo=s(It,"P",{});var Cd=a(Qo);IT=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Cd,"CODE",{});var o4=a(hp);DT=i(o4,"span start logits"),o4.forEach(t),ST=i(Cd," and "),mp=s(Cd,"CODE",{});var n4=a(mp);WT=i(n4,"span end logits"),n4.forEach(t),BT=i(Cd,")."),Cd.forEach(t),UT=h(It),si=s(It,"P",{});var eu=a(si);HT=i(eu,"This model inherits from "),id=s(eu,"A",{href:!0});var s4=a(id);QT=i(s4,"TFPreTrainedModel"),s4.forEach(t),VT=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),JT=h(It),ai=s(It,"P",{});var tu=a(ai);KT=i(tu,"This model is also a "),ri=s(tu,"A",{href:!0,rel:!0});var a4=a(ri);GT=i(a4,"tf.keras.Model"),a4.forEach(t),XT=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),YT=h(It),y(ws.$$.fragment,It),ZT=h(It),ht=s(It,"DIV",{class:!0});var po=a(ht);y(ii.$$.fragment,po),ey=h(po),Vo=s(po,"P",{});var jd=a(Vo);ty=i(jd,"The "),ld=s(jd,"A",{href:!0});var r4=a(ld);oy=i(r4,"TFRobertaForQuestionAnswering"),r4.forEach(t),ny=i(jd," forward method, overrides the "),fp=s(jd,"CODE",{});var i4=a(fp);sy=i(i4,"__call__"),i4.forEach(t),ay=i(jd," special method."),jd.forEach(t),ry=h(po),y($s.$$.fragment,po),iy=h(po),y(Fs.$$.fragment,po),ly=h(po),y(xs.$$.fragment,po),po.forEach(t),It.forEach(t),Um=h(o),Jo=s(o,"H2",{class:!0});var ou=a(Jo);Rs=s(ou,"A",{id:!0,class:!0,href:!0});var l4=a(Rs);up=s(l4,"SPAN",{});var d4=a(up);y(li.$$.fragment,d4),d4.forEach(t),l4.forEach(t),dy=h(ou),gp=s(ou,"SPAN",{});var c4=a(gp);cy=i(c4,"FlaxRobertaModel"),c4.forEach(t),ou.forEach(t),Hm=h(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(di.$$.fragment,ut),py=h(ut),_p=s(ut,"P",{});var p4=a(_p);hy=i(p4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),p4.forEach(t),my=h(ut),ci=s(ut,"P",{});var nu=a(ci);fy=i(nu,"This model inherits from "),dd=s(nu,"A",{href:!0});var h4=a(dd);uy=i(h4,"FlaxPreTrainedModel"),h4.forEach(t),gy=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),nu.forEach(t),_y=h(ut),pi=s(ut,"P",{});var su=a(pi);by=i(su,"This model is also a Flax Linen "),hi=s(su,"A",{href:!0,rel:!0});var m4=a(hi);ky=i(m4,"flax.linen.Module"),m4.forEach(t),vy=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),Ty=h(ut),bp=s(ut,"P",{});var f4=a(bp);yy=i(f4,"Finally, this model supports inherent JAX features such as:"),f4.forEach(t),wy=h(ut),St=s(ut,"UL",{});var Xs=a(St);kp=s(Xs,"LI",{});var u4=a(kp);mi=s(u4,"A",{href:!0,rel:!0});var g4=a(mi);$y=i(g4,"Just-In-Time (JIT) compilation"),g4.forEach(t),u4.forEach(t),Fy=h(Xs),vp=s(Xs,"LI",{});var _4=a(vp);fi=s(_4,"A",{href:!0,rel:!0});var b4=a(fi);xy=i(b4,"Automatic Differentiation"),b4.forEach(t),_4.forEach(t),Ry=h(Xs),Tp=s(Xs,"LI",{});var k4=a(Tp);ui=s(k4,"A",{href:!0,rel:!0});var v4=a(ui);My=i(v4,"Vectorization"),v4.forEach(t),k4.forEach(t),Ey=h(Xs),yp=s(Xs,"LI",{});var T4=a(yp);gi=s(T4,"A",{href:!0,rel:!0});var y4=a(gi);zy=i(y4,"Parallelization"),y4.forEach(t),T4.forEach(t),Xs.forEach(t),qy=h(ut),Mt=s(ut,"DIV",{class:!0});var Ys=a(Mt);y(_i.$$.fragment,Ys),Cy=h(Ys),Ko=s(Ys,"P",{});var Pd=a(Ko);jy=i(Pd,"The "),wp=s(Pd,"CODE",{});var w4=a(wp);Py=i(w4,"FlaxRobertaPreTrainedModel"),w4.forEach(t),Ly=i(Pd," forward method, overrides the "),$p=s(Pd,"CODE",{});var $4=a($p);Ay=i($4,"__call__"),$4.forEach(t),Oy=i(Pd," special method."),Pd.forEach(t),Ny=h(Ys),y(Ms.$$.fragment,Ys),Iy=h(Ys),y(Es.$$.fragment,Ys),Ys.forEach(t),ut.forEach(t),Qm=h(o),Go=s(o,"H2",{class:!0});var au=a(Go);zs=s(au,"A",{id:!0,class:!0,href:!0});var F4=a(zs);Fp=s(F4,"SPAN",{});var x4=a(Fp);y(bi.$$.fragment,x4),x4.forEach(t),F4.forEach(t),Dy=h(au),xp=s(au,"SPAN",{});var R4=a(xp);Sy=i(R4,"FlaxRobertaForMaskedLM"),R4.forEach(t),au.forEach(t),Vm=h(o),Ne=s(o,"DIV",{class:!0});var gt=a(Ne);y(ki.$$.fragment,gt),Wy=h(gt),vi=s(gt,"P",{});var ru=a(vi);By=i(ru,"RoBERTa Model with a "),Rp=s(ru,"CODE",{});var M4=a(Rp);Uy=i(M4,"language modeling"),M4.forEach(t),Hy=i(ru," head on top."),ru.forEach(t),Qy=h(gt),Ti=s(gt,"P",{});var iu=a(Ti);Vy=i(iu,"This model inherits from "),cd=s(iu,"A",{href:!0});var E4=a(cd);Jy=i(E4,"FlaxPreTrainedModel"),E4.forEach(t),Ky=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Gy=h(gt),yi=s(gt,"P",{});var lu=a(yi);Xy=i(lu,"This model is also a Flax Linen "),wi=s(lu,"A",{href:!0,rel:!0});var z4=a(wi);Yy=i(z4,"flax.linen.Module"),z4.forEach(t),Zy=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),ew=h(gt),Mp=s(gt,"P",{});var q4=a(Mp);tw=i(q4,"Finally, this model supports inherent JAX features such as:"),q4.forEach(t),ow=h(gt),Wt=s(gt,"UL",{});var Zs=a(Wt);Ep=s(Zs,"LI",{});var C4=a(Ep);$i=s(C4,"A",{href:!0,rel:!0});var j4=a($i);nw=i(j4,"Just-In-Time (JIT) compilation"),j4.forEach(t),C4.forEach(t),sw=h(Zs),zp=s(Zs,"LI",{});var P4=a(zp);Fi=s(P4,"A",{href:!0,rel:!0});var L4=a(Fi);aw=i(L4,"Automatic Differentiation"),L4.forEach(t),P4.forEach(t),rw=h(Zs),qp=s(Zs,"LI",{});var A4=a(qp);xi=s(A4,"A",{href:!0,rel:!0});var O4=a(xi);iw=i(O4,"Vectorization"),O4.forEach(t),A4.forEach(t),lw=h(Zs),Cp=s(Zs,"LI",{});var N4=a(Cp);Ri=s(N4,"A",{href:!0,rel:!0});var I4=a(Ri);dw=i(I4,"Parallelization"),I4.forEach(t),N4.forEach(t),Zs.forEach(t),cw=h(gt),Et=s(gt,"DIV",{class:!0});var ea=a(Et);y(Mi.$$.fragment,ea),pw=h(ea),Xo=s(ea,"P",{});var Ld=a(Xo);hw=i(Ld,"The "),jp=s(Ld,"CODE",{});var D4=a(jp);mw=i(D4,"FlaxRobertaPreTrainedModel"),D4.forEach(t),fw=i(Ld," forward method, overrides the "),Pp=s(Ld,"CODE",{});var S4=a(Pp);uw=i(S4,"__call__"),S4.forEach(t),gw=i(Ld," special method."),Ld.forEach(t),_w=h(ea),y(qs.$$.fragment,ea),bw=h(ea),y(Cs.$$.fragment,ea),ea.forEach(t),gt.forEach(t),Jm=h(o),Yo=s(o,"H2",{class:!0});var du=a(Yo);js=s(du,"A",{id:!0,class:!0,href:!0});var W4=a(js);Lp=s(W4,"SPAN",{});var B4=a(Lp);y(Ei.$$.fragment,B4),B4.forEach(t),W4.forEach(t),kw=h(du),Ap=s(du,"SPAN",{});var U4=a(Ap);vw=i(U4,"FlaxRobertaForSequenceClassification"),U4.forEach(t),du.forEach(t),Km=h(o),Ie=s(o,"DIV",{class:!0});var _t=a(Ie);y(zi.$$.fragment,_t),Tw=h(_t),Op=s(_t,"P",{});var H4=a(Op);yw=i(H4,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),H4.forEach(t),ww=h(_t),qi=s(_t,"P",{});var cu=a(qi);$w=i(cu,"This model inherits from "),pd=s(cu,"A",{href:!0});var Q4=a(pd);Fw=i(Q4,"FlaxPreTrainedModel"),Q4.forEach(t),xw=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),cu.forEach(t),Rw=h(_t),Ci=s(_t,"P",{});var pu=a(Ci);Mw=i(pu,"This model is also a Flax Linen "),ji=s(pu,"A",{href:!0,rel:!0});var V4=a(ji);Ew=i(V4,"flax.linen.Module"),V4.forEach(t),zw=i(pu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),qw=h(_t),Np=s(_t,"P",{});var J4=a(Np);Cw=i(J4,"Finally, this model supports inherent JAX features such as:"),J4.forEach(t),jw=h(_t),Bt=s(_t,"UL",{});var ta=a(Bt);Ip=s(ta,"LI",{});var K4=a(Ip);Pi=s(K4,"A",{href:!0,rel:!0});var G4=a(Pi);Pw=i(G4,"Just-In-Time (JIT) compilation"),G4.forEach(t),K4.forEach(t),Lw=h(ta),Dp=s(ta,"LI",{});var X4=a(Dp);Li=s(X4,"A",{href:!0,rel:!0});var Y4=a(Li);Aw=i(Y4,"Automatic Differentiation"),Y4.forEach(t),X4.forEach(t),Ow=h(ta),Sp=s(ta,"LI",{});var Z4=a(Sp);Ai=s(Z4,"A",{href:!0,rel:!0});var ex=a(Ai);Nw=i(ex,"Vectorization"),ex.forEach(t),Z4.forEach(t),Iw=h(ta),Wp=s(ta,"LI",{});var tx=a(Wp);Oi=s(tx,"A",{href:!0,rel:!0});var ox=a(Oi);Dw=i(ox,"Parallelization"),ox.forEach(t),tx.forEach(t),ta.forEach(t),Sw=h(_t),zt=s(_t,"DIV",{class:!0});var oa=a(zt);y(Ni.$$.fragment,oa),Ww=h(oa),Zo=s(oa,"P",{});var Ad=a(Zo);Bw=i(Ad,"The "),Bp=s(Ad,"CODE",{});var nx=a(Bp);Uw=i(nx,"FlaxRobertaPreTrainedModel"),nx.forEach(t),Hw=i(Ad," forward method, overrides the "),Up=s(Ad,"CODE",{});var sx=a(Up);Qw=i(sx,"__call__"),sx.forEach(t),Vw=i(Ad," special method."),Ad.forEach(t),Jw=h(oa),y(Ps.$$.fragment,oa),Kw=h(oa),y(Ls.$$.fragment,oa),oa.forEach(t),_t.forEach(t),Gm=h(o),en=s(o,"H2",{class:!0});var hu=a(en);As=s(hu,"A",{id:!0,class:!0,href:!0});var ax=a(As);Hp=s(ax,"SPAN",{});var rx=a(Hp);y(Ii.$$.fragment,rx),rx.forEach(t),ax.forEach(t),Gw=h(hu),Qp=s(hu,"SPAN",{});var ix=a(Qp);Xw=i(ix,"FlaxRobertaForMultipleChoice"),ix.forEach(t),hu.forEach(t),Xm=h(o),De=s(o,"DIV",{class:!0});var bt=a(De);y(Di.$$.fragment,bt),Yw=h(bt),Vp=s(bt,"P",{});var lx=a(Vp);Zw=i(lx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
