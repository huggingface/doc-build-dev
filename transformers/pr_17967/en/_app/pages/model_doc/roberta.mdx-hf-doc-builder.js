...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17967/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17967/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17967/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17967/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_17967/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17967/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17967/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17967/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17967/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17967/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17967/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17967/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17967/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wf.forEach(t),A1=h(_t),Zp=s(_t,"P",{});var QR=a(Zp);O1=i(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),N1=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var JR=a(eh);Pi=s(JR,"A",{href:!0,rel:!0});var VR=a(Pi);I1=i(VR,"Just-In-Time (JIT) compilation"),VR.forEach(t),JR.forEach(t),D1=h(la),th=s(la,"LI",{});var KR=a(th);Li=s(KR,"A",{href:!0,rel:!0});var GR=a(Li);S1=i(GR,"Automatic Differentiation"),GR.forEach(t),KR.forEach(t),W1=h(la),oh=s(la,"LI",{});var XR=a(oh);Ai=s(XR,"A",{href:!0,rel:!0});var YR=a(Ai);B1=i(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),U1=h(la),nh=s(la,"LI",{});var ZR=a(nh);Oi=s(ZR,"A",{href:!0,rel:!0});var e7=a(Oi);H1=i(e7,"Parallelization"),e7.forEach(t),ZR.forEach(t),la.forEach(t),Q1=h(_t),qt=s(_t,"DIV",{class:!0});var da=a(qt);y(Ni.$$.fragment,da),J1=h(da),tn=s(da,"P",{});var ac=a(tn);V1=i(ac,"The "),sh=s(ac,"CODE",{});var t7=a(sh);K1=i(t7,"FlaxRobertaPreTrainedModel"),t7.forEach(t),G1=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var o7=a(ah);X1=i(o7,"__call__"),o7.forEach(t),Y1=i(ac," special method."),ac.forEach(t),Z1=h(da),y(Os.$$.fragment,da),e$=h(da),y(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),Em=h(o),on=s(o,"H2",{class:!0});var Bf=a(on);Is=s(Bf,"A",{id:!0,class:!0,href:!0});var n7=a(Is);rh=s(n7,"SPAN",{});var s7=a(rh);y(Ii.$$.fragment,s7),s7.forEach(t),n7.forEach(t),t$=h(Bf),ih=s(Bf,"SPAN",{});var a7=a(ih);o$=i(a7,"FlaxRobertaForMaskedLM"),a7.forEach(t),Bf.forEach(t),zm=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);y(Di.$$.fragment,bt),n$=h(bt),Si=s(bt,"P",{});var Uf=a(Si);s$=i(Uf,"RoBERTa Model with a "),lh=s(Uf,"CODE",{});var r7=a(lh);a$=i(r7,"language modeling"),r7.forEach(t),r$=i(Uf," head on top."),Uf.forEach(t),i$=h(bt),Wi=s(bt,"P",{});var Hf=a(Wi);l$=i(Hf,"This model inherits from "),Pd=s(Hf,"A",{href:!0});var i7=a(Pd);d$=i(i7,"FlaxPreTrainedModel"),i7.forEach(t),c$=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hf.forEach(t),p$=h(bt),Bi=s(bt,"P",{});var Qf=a(Bi);h$=i(Qf,"This model is also a Flax Linen "),Ui=s(Qf,"A",{href:!0,rel:!0});var l7=a(Ui);u$=i(l7,"flax.linen.Module"),l7.forEach(t),m$=i(Qf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qf.forEach(t),f$=h(bt),dh=s(bt,"P",{});var d7=a(dh);g$=i(d7,"Finally, this model supports inherent JAX features such as:"),d7.forEach(t),_$=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var c7=a(ch);Hi=s(c7,"A",{href:!0,rel:!0});var p7=a(Hi);b$=i(p7,"Just-In-Time (JIT) compilation"),p7.forEach(t),c7.forEach(t),k$=h(ca),ph=s(ca,"LI",{});var h7=a(ph);Qi=s(h7,"A",{href:!0,rel:!0});var u7=a(Qi);v$=i(u7,"Automatic Differentiation"),u7.forEach(t),h7.forEach(t),T$=h(ca),hh=s(ca,"LI",{});var m7=a(hh);Ji=s(m7,"A",{href:!0,rel:!0});var f7=a(Ji);y$=i(f7,"Vectorization"),f7.forEach(t),m7.forEach(t),w$=h(ca),uh=s(ca,"LI",{});var g7=a(uh);Vi=s(g7,"A",{href:!0,rel:!0});var _7=a(Vi);$$=i(_7,"Parallelization"),_7.forEach(t),g7.forEach(t),ca.forEach(t),F$=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);y(Ki.$$.fragment,pa),x$=h(pa),nn=s(pa,"P",{});var rc=a(nn);R$=i(rc,"The "),mh=s(rc,"CODE",{});var b7=a(mh);M$=i(b7,"FlaxRobertaPreTrainedModel"),b7.forEach(t),E$=i(rc," forward method, overrides the "),fh=s(rc,"CODE",{});var k7=a(fh);z$=i(k7,"__call__"),k7.forEach(t),q$=i(rc," special method."),rc.forEach(t),C$=h(pa),y(Ds.$$.fragment,pa),j$=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qm=h(o),sn=s(o,"H2",{class:!0});var Jf=a(sn);Ws=s(Jf,"A",{id:!0,class:!0,href:!0});var v7=a(Ws);gh=s(v7,"SPAN",{});var T7=a(gh);y(Gi.$$.fragment,T7),T7.forEach(t),v7.forEach(t),P$=h(Jf),_h=s(Jf,"SPAN",{});var y7=a(_h);L$=i(y7,"FlaxRobertaForSequenceClassification"),y7.forEach(t),Jf.forEach(t),Cm=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A$=h(kt),bh=s(kt,"P",{});var w7=a(bh);O$=i(w7,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),w7.forEach(t),N$=h(kt),Yi=s(kt,"P",{});var Vf=a(Yi);I$=i(Vf,"This model inherits from "),Ld=s(Vf,"A",{href:!0});var $7=a(Ld);D$=i($7,"FlaxPreTrainedModel"),$7.forEach(t),S$=i(Vf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vf.forEach(t),W$=h(kt),Zi=s(kt,"P",{});var Kf=a(Zi);B$=i(Kf,"This model is also a Flax Linen "),el=s(Kf,"A",{href:!0,rel:!0});var F7=a(el);U$=i(F7,"flax.linen.Module"),F7.forEach(t),H$=i(Kf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Kf.forEach(t),Q$=h(kt),kh=s(kt,"P",{});var x7=a(kh);J$=i(x7,"Finally, this model supports inherent JAX features such as:"),x7.forEach(t),V$=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var R7=a(vh);tl=s(R7,"A",{href:!0,rel:!0});var M7=a(tl);K$=i(M7,"Just-In-Time (JIT) compilation"),M7.forEach(t),R7.forEach(t),G$=h(ha),Th=s(ha,"LI",{});var E7=a(Th);ol=s(E7,"A",{href:!0,rel:!0});var z7=a(ol);X$=i(z7,"Automatic Differentiation"),z7.forEach(t),E7.forEach(t),Y$=h(ha),yh=s(ha,"LI",{});var q7=a(yh);nl=s(q7,"A",{href:!0,rel:!0});var C7=a(nl);Z$=i(C7,"Vectorization"),C7.forEach(t),q7.forEach(t),e2=h(ha),wh=s(ha,"LI",{});var j7=a(wh);sl=s(j7,"A",{href:!0,rel:!0});var P7=a(sl);t2=i(P7,"Parallelization"),P7.forEach(t),j7.forEach(t),ha.forEach(t),o2=h(kt),jt=s(kt,"DIV",{class:!0});var ua=a(jt);y(al.$$.fragment,ua),n2=h(ua),an=s(ua,"P",{});var ic=a(an);s2=i(ic,"The "),$h=s(ic,"CODE",{});var L7=a($h);a2=i(L7,"FlaxRobertaPreTrainedModel"),L7.forEach(t),r2=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var A7=a(Fh);i2=i(A7,"__call__"),A7.forEach(t),l2=i(ic," special method."),ic.forEach(t),d2=h(ua),y(Bs.$$.fragment,ua),c2=h(ua),y(Us.$$.fragment,ua),ua.forEach(t),kt.forEach(t),jm=h(o),rn=s(o,"H2",{class:!0});var Gf=a(rn);Hs=s(Gf,"A",{id:!0,class:!0,href:!0});var O7=a(Hs);xh=s(O7,"SPAN",{});var N7=a(xh);y(rl.$$.fragment,N7),N7.forEach(t),O7.forEach(t),p2=h(Gf),Rh=s(Gf,"SPAN",{});var I7=a(Rh);h2=i(I7,"FlaxRobertaForMultipleChoice"),I7.forEach(t),Gf.forEach(t),Pm=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),u2=h(vt),Mh=s(vt,"P",{});var D7=a(Mh);m2=i(D7,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D7.forEach(t),f2=h(vt),ll=s(vt,"P",{});var Xf=a(ll);g2=i(Xf,"This model inherits from "),Ad=s(Xf,"A",{href:!0});var S7=a(Ad);_2=i(S7,"FlaxPreTrainedModel"),S7.forEach(t),b2=i(Xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xf.forEach(t),k2=h(vt),dl=s(vt,"P",{});var Yf=a(dl);v2=i(Yf,"This model is also a Flax Linen "),cl=s(Yf,"A",{href:!0,rel:!0});var W7=a(cl);T2=i(W7,"flax.linen.Module"),W7.forEach(t),y2=i(Yf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yf.forEach(t),w2=h(vt),Eh=s(vt,"P",{});var B7=a(Eh);$2=i(B7,"Finally, this model supports inherent JAX features such as:"),B7.forEach(t),F2=h(vt),Vt=s(vt,"UL",{});var ma=a(Vt);zh=s(ma,"LI",{});var U7=a(zh);pl=s(U7,"A",{href:!0,rel:!0});var H7=a(pl);x2=i(H7,"Just-In-Time (JIT) compilation"),H7.forEach(t),U7.forEach(t),R2=h(ma),qh=s(ma,"LI",{});var Q7=a(qh);hl=s(Q7,"A",{href:!0,rel:!0});var J7=a(hl);M2=i(J7,"Automatic Differentiation"),J7.forEach(t),Q7.forEach(t),E2=h(ma),Ch=s(ma,"LI",{});var V7=a(Ch);ul=s(V7,"A",{href:!0,rel:!0});var K7=a(ul);z2=i(K7,"Vectorization"),K7.forEach(t),V7.forEach(t),q2=h(ma),jh=s(ma,"LI",{});var G7=a(jh);ml=s(G7,"A",{href:!0,rel:!0});var X7=a(ml);C2=i(X7,"Parallelization"),X7.forEach(t),G7.forEach(t),ma.forEach(t),j2=h(vt),Pt=s(vt,"DIV",{class:!0});var fa=a(Pt);y(fl.$$.fragment,fa),P2=h(fa),ln=s(fa,"P",{});var lc=a(ln);L2=i(lc,"The "),Ph=s(lc,"CODE",{});var Y7=a(Ph);A2=i(Y7,"FlaxRobertaPreTrainedModel"),Y7.forEach(t),O2=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var Z7=a(Lh);N2=i(Z7,"__call__"),Z7.forEach(t),I2=i(lc," special method."),lc.forEach(t),D2=h(fa),y(Qs.$$.fragment,fa),S2=h(fa),y(Js.$$.fragment,fa),fa.forEach(t),vt.forEach(t),Lm=h(o),dn=s(o,"H2",{class:!0});var Zf=a(dn);Vs=s(Zf,"A",{id:!0,class:!0,href:!0});var eM=a(Vs);Ah=s(eM,"SPAN",{});var tM=a(Ah);y(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W2=h(Zf),Oh=s(Zf,"SPAN",{});var oM=a(Oh);B2=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zf.forEach(t),Am=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U2=h(Tt),Nh=s(Tt,"P",{});var nM=a(Nh);H2=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
