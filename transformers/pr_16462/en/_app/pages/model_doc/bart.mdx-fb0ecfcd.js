...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16462/en/model_doc/bart#transformers.BartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16462/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16462/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),on=new je({props:{$$slots:{default:[e2]},$$scope:{ctx:j}}}),Xa=new C({props:{code:`from transformers import BartTokenizer, TFBartForConditionalGeneration
...
Whether or not to return a <a href="/docs/transformers/pr_16462/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16462/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
`}}),an=new je({props:{$$slots:{default:[t2]},$$scope:{ctx:j}}}),ds=new C({props:{code:`from transformers import BartTokenizer, FlaxBartModel
...
Whether or not to return a <a href="/docs/transformers/pr_16462/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16462/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16462/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16462/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Ts=new $({props:{name:"__call__",anchor:"transformers.FlaxBartForConditionalGeneration.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16462/src/transformers/models/bart/modeling_flax_bart.py#L1164",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16462/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16462/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16462/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16462/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16462/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
`}}),rn=new je({props:{$$slots:{default:[o2]},$$scope:{ctx:j}}}),ws=new C({props:{code:`from transformers import BartTokenizer, FlaxBartForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),qs=new $({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16462/src/transformers/models/bart/modeling_flax_bart.py#L1319",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16462/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16462/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16462/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16462/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16462/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
`}}),ln=new je({props:{$$slots:{default:[n2]},$$scope:{ctx:j}}}),Ns=new C({props:{code:`from transformers import BartTokenizer, FlaxBartForSequenceClassification
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16462/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16462/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Ys=new $({props:{name:"__call__",anchor:"transformers.FlaxBartForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16462/src/transformers/models/bart/modeling_flax_bart.py#L1164",parametersDescription:[{anchor:"transformers.FlaxBartForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16462/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16462/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16462/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16462/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16462/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
`}}),pn=new je({props:{$$slots:{default:[a2]},$$scope:{ctx:j}}}),er=new C({props:{code:`from transformers import BartTokenizer, FlaxBartForQuestionAnswering
...
<p><a
  href="/docs/transformers/pr_16462/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),un=new je({props:{$$slots:{default:[s2]},$$scope:{ctx:j}}}),fr=new C({props:{code:`from transformers import BartTokenizer, FlaxBartForCausalLM
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),qp.forEach(t),dg=l(ge),Ld=a(ge,"P",{});var tw=s(Ld);lg=i(tw,"Finally, this model supports inherent JAX features such as:"),tw.forEach(t),cg=l(ge),ht=a(ge,"UL",{});var kn=s(ht);Dd=a(kn,"LI",{});var ow=s(Dd);ns=a(ow,"A",{href:!0,rel:!0});var nw=s(ns);pg=i(nw,"Just-In-Time (JIT) compilation"),nw.forEach(t),ow.forEach(t),hg=l(kn),Gd=a(kn,"LI",{});var aw=s(Gd);as=a(aw,"A",{href:!0,rel:!0});var sw=s(as);ug=i(sw,"Automatic Differentiation"),sw.forEach(t),aw.forEach(t),mg=l(kn),Wd=a(kn,"LI",{});var rw=s(Wd);ss=a(rw,"A",{href:!0,rel:!0});var iw=s(ss);fg=i(iw,"Vectorization"),iw.forEach(t),rw.forEach(t),_g=l(kn),Ud=a(kn,"LI",{});var dw=s(Ud);rs=a(dw,"A",{href:!0,rel:!0});var lw=s(rs);gg=i(lw,"Parallelization"),lw.forEach(t),dw.forEach(t),kn.forEach(t),bg=l(ge),Se=a(ge,"DIV",{class:!0});var Ot=s(Se);f(is.$$.fragment,Ot),kg=l(Ot),ko=a(Ot,"P",{});var hi=s(ko);yg=i(hi,"The "),Rd=a(hi,"CODE",{});var cw=s(Rd);vg=i(cw,"FlaxBartPreTrainedModel"),cw.forEach(t),Tg=i(hi,"forward method, overrides the "),Hd=a(hi,"CODE",{});var pw=s(Hd);wg=i(pw,"__call__"),pw.forEach(t),xg=i(hi," special method."),hi.forEach(t),Fg=l(Ot),f(an.$$.fragment,Ot),zg=l(Ot),Qd=a(Ot,"P",{});var hw=s(Qd);qg=i(hw,"Example:"),hw.forEach(t),$g=l(Ot),f(ds.$$.fragment,Ot),Ot.forEach(t),Bg=l(ge),vt=a(ge,"DIV",{class:!0});var ui=s(vt);f(ls.$$.fragment,ui),jg=l(ui),Vd=a(ui,"P",{});var uw=s(Vd);Cg=i(uw,"Example:"),uw.forEach(t),Mg=l(ui),f(cs.$$.fragment,ui),ui.forEach(t),Eg=l(ge),Tt=a(ge,"DIV",{class:!0});var mi=s(Tt);f(ps.$$.fragment,mi),Pg=l(mi),Jd=a(mi,"P",{});var mw=s(Jd);Ag=i(mw,"Example:"),mw.forEach(t),Sg=l(mi),f(hs.$$.fragment,mi),mi.forEach(t),ge.forEach(t),Mc=l(o),yo=a(o,"H2",{class:!0});var $p=s(yo);sn=a($p,"A",{id:!0,class:!0,href:!0});var fw=s(sn);Xd=a(fw,"SPAN",{});var _w=s(Xd);f(us.$$.fragment,_w),_w.forEach(t),fw.forEach(t),Og=l($p),Kd=a($p,"SPAN",{});var gw=s(Kd);Ig=i(gw,"FlaxBartForConditionalGeneration"),gw.forEach(t),$p.forEach(t),Ec=l(o),R=a(o,"DIV",{class:!0});var be=s(R);f(ms.$$.fragment,be),Ng=l(be),fs=a(be,"P",{});var Bp=s(fs);Lg=i(Bp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rr=a(Bp,"A",{href:!0});var bw=s(Rr);Dg=i(bw,"FlaxPreTrainedModel"),bw.forEach(t),Gg=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bp.forEach(t),Wg=l(be),_s=a(be,"P",{});var jp=s(_s);Ug=i(jp,`This model is also a Flax Linen
`),gs=a(jp,"A",{href:!0,rel:!0});var kw=s(gs);Rg=i(kw,"flax.nn.Module"),kw.forEach(t),Hg=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Qg=l(be),Zd=a(be,"P",{});var yw=s(Zd);Vg=i(yw,"Finally, this model supports inherent JAX features such as:"),yw.forEach(t),Jg=l(be),ut=a(be,"UL",{});var yn=s(ut);Yd=a(yn,"LI",{});var vw=s(Yd);bs=a(vw,"A",{href:!0,rel:!0});var Tw=s(bs);Xg=i(Tw,"Just-In-Time (JIT) compilation"),Tw.forEach(t),vw.forEach(t),Kg=l(yn),el=a(yn,"LI",{});var ww=s(el);ks=a(ww,"A",{href:!0,rel:!0});var xw=s(ks);Zg=i(xw,"Automatic Differentiation"),xw.forEach(t),ww.forEach(t),Yg=l(yn),tl=a(yn,"LI",{});var Fw=s(tl);ys=a(Fw,"A",{href:!0,rel:!0});var zw=s(ys);eb=i(zw,"Vectorization"),zw.forEach(t),Fw.forEach(t),tb=l(yn),ol=a(yn,"LI",{});var qw=s(ol);vs=a(qw,"A",{href:!0,rel:!0});var $w=s(vs);ob=i($w,"Parallelization"),$w.forEach(t),qw.forEach(t),yn.forEach(t),nb=l(be),te=a(be,"DIV",{class:!0});var Ge=s(te);f(Ts.$$.fragment,Ge),ab=l(Ge),vo=a(Ge,"P",{});var fi=s(vo);sb=i(fi,"The "),nl=a(fi,"CODE",{});var Bw=s(nl);rb=i(Bw,"FlaxBartPreTrainedModel"),Bw.forEach(t),ib=i(fi,"forward method, overrides the "),al=a(fi,"CODE",{});var jw=s(al);db=i(jw,"__call__"),jw.forEach(t),lb=i(fi," special method."),fi.forEach(t),cb=l(Ge),f(rn.$$.fragment,Ge),pb=l(Ge),sl=a(Ge,"P",{});var Cw=s(sl);hb=i(Cw,"Summarization example:"),Cw.forEach(t),ub=l(Ge),f(ws.$$.fragment,Ge),mb=l(Ge),rl=a(Ge,"P",{});var Mw=s(rl);fb=i(Mw,"Mask filling example:"),Mw.forEach(t),_b=l(Ge),f(xs.$$.fragment,Ge),Ge.forEach(t),gb=l(be),wt=a(be,"DIV",{class:!0});var _i=s(wt);f(Fs.$$.fragment,_i),bb=l(_i),il=a(_i,"P",{});var Ew=s(il);kb=i(Ew,"Example:"),Ew.forEach(t),yb=l(_i),f(zs.$$.fragment,_i),_i.forEach(t),vb=l(be),xt=a(be,"DIV",{class:!0});var gi=s(xt);f(qs.$$.fragment,gi),Tb=l(gi),dl=a(gi,"P",{});var Pw=s(dl);wb=i(Pw,"Example:"),Pw.forEach(t),xb=l(gi),f($s.$$.fragment,gi),gi.forEach(t),be.forEach(t),Pc=l(o),To=a(o,"H2",{class:!0});var Cp=s(To);dn=a(Cp,"A",{id:!0,class:!0,href:!0});var Aw=s(dn);ll=a(Aw,"SPAN",{});var Sw=s(ll);f(Bs.$$.fragment,Sw),Sw.forEach(t),Aw.forEach(t),Fb=l(Cp),cl=a(Cp,"SPAN",{});var Ow=s(cl);zb=i(Ow,"FlaxBartForSequenceClassification"),Ow.forEach(t),Cp.forEach(t),Ac=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);f(js.$$.fragment,ne),qb=l(ne),pl=a(ne,"P",{});var Iw=s(pl);$b=i(Iw,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Iw.forEach(t),Bb=l(ne),Cs=a(ne,"P",{});var Mp=s(Cs);jb=i(Mp,"This model inherits from "),Hr=a(Mp,"A",{href:!0});var Nw=s(Hr);Cb=i(Nw,"FlaxPreTrainedModel"),Nw.forEach(t),Mb=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp.forEach(t),Eb=l(ne),Ms=a(ne,"P",{});var Ep=s(Ms);Pb=i(Ep,`This model is also a Flax Linen
`),Es=a(Ep,"A",{href:!0,rel:!0});var Lw=s(Es);Ab=i(Lw,"flax.nn.Module"),Lw.forEach(t),Sb=i(Ep,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ep.forEach(t),Ob=l(ne),hl=a(ne,"P",{});var Dw=s(hl);Ib=i(Dw,"Finally, this model supports inherent JAX features such as:"),Dw.forEach(t),Nb=l(ne),mt=a(ne,"UL",{});var vn=s(mt);ul=a(vn,"LI",{});var Gw=s(ul);Ps=a(Gw,"A",{href:!0,rel:!0});var Ww=s(Ps);Lb=i(Ww,"Just-In-Time (JIT) compilation"),Ww.forEach(t),Gw.forEach(t),Db=l(vn),ml=a(vn,"LI",{});var Uw=s(ml);As=a(Uw,"A",{href:!0,rel:!0});var Rw=s(As);Gb=i(Rw,"Automatic Differentiation"),Rw.forEach(t),Uw.forEach(t),Wb=l(vn),fl=a(vn,"LI",{});var Hw=s(fl);Ss=a(Hw,"A",{href:!0,rel:!0});var Qw=s(Ss);Ub=i(Qw,"Vectorization"),Qw.forEach(t),Hw.forEach(t),Rb=l(vn),_l=a(vn,"LI",{});var Vw=s(_l);Os=a(Vw,"A",{href:!0,rel:!0});var Jw=s(Os);Hb=i(Jw,"Parallelization"),Jw.forEach(t),Vw.forEach(t),vn.forEach(t),Qb=l(ne),Oe=a(ne,"DIV",{class:!0});var It=s(Oe);f(Is.$$.fragment,It),Vb=l(It),wo=a(It,"P",{});var bi=s(wo);Jb=i(bi,"The "),gl=a(bi,"CODE",{});var Xw=s(gl);Xb=i(Xw,"FlaxBartPreTrainedModel"),Xw.forEach(t),Kb=i(bi,"forward method, overrides the "),bl=a(bi,"CODE",{});var Kw=s(bl);Zb=i(Kw,"__call__"),Kw.forEach(t),Yb=i(bi," special method."),bi.forEach(t),ek=l(It),f(ln.$$.fragment,It),tk=l(It),kl=a(It,"P",{});var Zw=s(kl);ok=i(Zw,"Example:"),Zw.forEach(t),nk=l(It),f(Ns.$$.fragment,It),It.forEach(t),ak=l(ne),Ft=a(ne,"DIV",{class:!0});var ki=s(Ft);f(Ls.$$.fragment,ki),sk=l(ki),yl=a(ki,"P",{});var Yw=s(yl);rk=i(Yw,"Example:"),Yw.forEach(t),ik=l(ki),f(Ds.$$.fragment,ki),ki.forEach(t),dk=l(ne),zt=a(ne,"DIV",{class:!0});var yi=s(zt);f(Gs.$$.fragment,yi),lk=l(yi),vl=a(yi,"P",{});var e1=s(vl);ck=i(e1,"Example:"),e1.forEach(t),pk=l(yi),f(Ws.$$.fragment,yi),yi.forEach(t),ne.forEach(t),Sc=l(o),xo=a(o,"H2",{class:!0});var Pp=s(xo);cn=a(Pp,"A",{id:!0,class:!0,href:!0});var t1=s(cn);Tl=a(t1,"SPAN",{});var o1=s(Tl);f(Us.$$.fragment,o1),o1.forEach(t),t1.forEach(t),hk=l(Pp),wl=a(Pp,"SPAN",{});var n1=s(wl);uk=i(n1,"FlaxBartForQuestionAnswering"),n1.forEach(t),Pp.forEach(t),Oc=l(o),I=a(o,"DIV",{class:!0});var ae=s(I);f(Rs.$$.fragment,ae),mk=l(ae),Fo=a(ae,"P",{});var vi=s(Fo);fk=i(vi,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
