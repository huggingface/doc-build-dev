import{S as uk,i as mk,s as fk,e as o,k as c,w as y,t as s,M as gk,c as n,d as t,m as h,a as r,x as q,h as a,b as f,N as _k,G as e,g as m,y as j,q as $,o as E,B as F,v as Tk,L as ut}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ms}from"../../chunks/Tip-hf-doc-builder.js";import{D as He}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ve}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Rt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{F as Sc,M as Tn}from"../../chunks/Markdown-hf-doc-builder.js";import{E as To}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function bk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L;return g=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
`),d=n(M,"A",{href:!0,rel:!0});var R=r(d);u=a(R,"torch-scatter"),R.forEach(t),T=a(M," dependency:"),M.forEach(t),p=h(w),q(g.$$.fragment,w),A=h(w),k=n(w,"P",{});var C=r(k);N=a(C,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),x=n(C,"A",{href:!0});var O=r(x);U=a(O,"TapasConfig"),O.forEach(t),G=a(C,", and then create a "),V=n(C,"A",{href:!0});var ee=r(V);B=a(ee,"TapasForQuestionAnswering"),ee.forEach(t),K=a(C," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),C.forEach(t),re=h(w),q(W.$$.fragment,w),this.h()},h(){f(d,"href","https://github.com/rusty1s/pytorch_scatter"),f(d,"rel","nofollow"),f(x,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig"),f(V,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering")},m(w,M){m(w,l,M),e(l,b),e(l,d),e(d,u),e(l,T),m(w,p,M),j(g,w,M),m(w,A,M),m(w,k,M),e(k,N),e(k,x),e(x,U),e(k,G),e(k,V),e(V,B),e(k,K),m(w,re,M),j(W,w,M),L=!0},p:ut,i(w){L||($(g.$$.fragment,w),$(W.$$.fragment,w),L=!0)},o(w){E(g.$$.fragment,w),E(W.$$.fragment,w),L=!1},d(w){w&&t(l),w&&t(p),F(g,w),w&&t(A),w&&t(k),w&&t(re),F(W,w)}}}function vk(S){let l,b;return l=new Tn({props:{$$slots:{default:[bk]},$$scope:{ctx:S}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function wk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L;return g=new Ve({props:{code:`from transformers import TapasConfig, TFTapasForQuestionAnswering
...
<span class="hljs-meta">&gt;&gt;&gt; </span>config = TapasConfig(num_aggregation_labels=<span class="hljs-number">3</span>, average_logits_per_cell=<span class="hljs-literal">True</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># initializing the pre-trained base sized model with our custom classification heads</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFTapasForQuestionAnswering.from_pretrained(<span class="hljs-string">&quot;google/tapas-base&quot;</span>, config=config)`}}),{c(){l=o("p"),b=s("Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the "),d=o("a"),u=s("tensorflow_probability"),T=s(" dependency:"),p=c(),y(g.$$.fragment),A=c(),k=o("p"),N=s("Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),x=o("a"),U=s("TapasConfig"),G=s(", and then create a "),V=o("a"),B=s("TFTapasForQuestionAnswering"),K=s(" based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),re=c(),y(W.$$.fragment),this.h()},l(w){l=n(w,"P",{});var M=r(l);b=a(M,"Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the "),d=n(M,"A",{href:!0,rel:!0});var R=r(d);u=a(R,"tensorflow_probability"),R.forEach(t),T=a(M," dependency:"),M.forEach(t),p=h(w),q(g.$$.fragment,w),A=h(w),k=n(w,"P",{});var C=r(k);N=a(C,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),x=n(C,"A",{href:!0});var O=r(x);U=a(O,"TapasConfig"),O.forEach(t),G=a(C,", and then create a "),V=n(C,"A",{href:!0});var ee=r(V);B=a(ee,"TFTapasForQuestionAnswering"),ee.forEach(t),K=a(C," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),C.forEach(t),re=h(w),q(W.$$.fragment,w),this.h()},h(){f(d,"href","https://github.com/tensorflow/probability"),f(d,"rel","nofollow"),f(x,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig"),f(V,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering")},m(w,M){m(w,l,M),e(l,b),e(l,d),e(d,u),e(l,T),m(w,p,M),j(g,w,M),m(w,A,M),m(w,k,M),e(k,N),e(k,x),e(x,U),e(k,G),e(k,V),e(V,B),e(k,K),m(w,re,M),j(W,w,M),L=!0},p:ut,i(w){L||($(g.$$.fragment,w),$(W.$$.fragment,w),L=!0)},o(w){E(g.$$.fragment,w),E(W.$$.fragment,w),L=!1},d(w){w&&t(l),w&&t(p),F(g,w),w&&t(A),w&&t(k),w&&t(re),F(W,w)}}}function kk(S){let l,b;return l=new Tn({props:{$$slots:{default:[wk]},$$scope:{ctx:S}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function yk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se,P,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve,v,D,be,xe,we,le,ze,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ss,Ps,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Se,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Gt,Ft,hs,Ye,$e,Ws,At,ae,ot,Vt,Hs,xt,Jt,Us,zt,Ct,Bs,Mt,Xt,Rs,St,Zt,Gs,Pt,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,os,nt,Js,Ot,Lt,Xs,Zs,Be,ea,ns,rs,et,Qt;return Ue=new Ve({props:{code:`from transformers import TapasTokenizer
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),b=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=o("a"),u=s("TapasTokenizer"),T=s(" to convert table-question pairs into "),p=o("code"),g=s("input_ids"),A=s(", "),k=o("code"),N=s("attention_mask"),x=s(", "),U=o("code"),G=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),B=o("a"),K=s("TapasForQuestionAnswering"),re=s(` requires different
inputs to be fine-tuned:`),W=c(),L=o("table"),w=o("thead"),M=o("tr"),R=o("th"),C=o("strong"),O=s("Task"),ee=c(),te=o("th"),ce=o("strong"),oe=s("Required inputs"),se=c(),P=o("tbody"),Q=o("tr"),H=o("td"),X=s("Conversational"),I=c(),Y=o("td"),ge=o("code"),ue=s("input_ids"),_e=s(", "),me=o("code"),ne=s("attention_mask"),qe=s(", "),ie=o("code"),ve=s("token_type_ids"),v=s(", "),D=o("code"),be=s("labels"),xe=c(),we=o("tr"),le=o("td"),ze=s("Weak supervision for aggregation"),Me=c(),Z=o("td"),de=o("code"),pe=s("input_ids"),De=s(", "),je=o("code"),Te=s("attention_mask"),Ne=s(", "),ke=o("code"),Ae=s("token_type_ids"),Oe=s(", "),Ze=o("code"),Ss=s("labels"),Ps=s(", "),mt=o("code"),ft=s("numeric_values"),ca=s(", "),gt=o("code"),_t=s("numeric_values_scale"),Ds=s(", "),tt=o("code"),Ns=s("float_answer"),Os=c(),Ke=o("tr"),Se=o("td"),Ls=s("Strong supervision for aggregation"),kt=c(),ye=o("td"),yt=o("code"),qt=s("input ids"),Qs=s(", "),jt=o("code"),$t=s("attention mask"),Is=s(", "),Et=o("code"),cs=s("token type ids"),Gt=s(", "),Ft=o("code"),hs=s("labels"),Ye=s(", "),$e=o("code"),Ws=s("aggregation_labels"),At=c(),ae=o("p"),ot=o("a"),Vt=s("TapasTokenizer"),Hs=s(" creates the "),xt=o("code"),Jt=s("labels"),Us=s(", "),zt=o("code"),Ct=s("numeric_values"),Bs=s(" and "),Mt=o("code"),Xt=s("numeric_values_scale"),Rs=s(" based on the "),St=o("code"),Zt=s("answer_coordinates"),Gs=s(" and "),Pt=o("code"),Vs=s("answer_text"),Le=s(" columns of the TSV file. The "),Dt=o("code"),es=s("float_answer"),Ks=s(" and "),Nt=o("code"),ts=s("aggregation_labels"),Ys=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ss=c(),y(Ue.$$.fragment),as=c(),Ee=o("p"),os=s("Note that "),nt=o("a"),Js=s("TapasTokenizer"),Ot=s(" expects the data of the table to be "),Lt=o("strong"),Xs=s("text-only"),Zs=s(". You can use "),Be=o("code"),ea=s(".astype(str)"),ns=s(` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),rs=c(),y(et.$$.fragment),this.h()},l(z){l=n(z,"P",{});var J=r(l);b=a(J,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=n(J,"A",{href:!0});var ya=r(d);u=a(ya,"TapasTokenizer"),ya.forEach(t),T=a(J," to convert table-question pairs into "),p=n(J,"CODE",{});var ta=r(p);g=a(ta,"input_ids"),ta.forEach(t),A=a(J,", "),k=n(J,"CODE",{});var qa=r(k);N=a(qa,"attention_mask"),qa.forEach(t),x=a(J,", "),U=n(J,"CODE",{});var ha=r(U);G=a(ha,"token_type_ids"),ha.forEach(t),V=a(J," and so on. Again, based on which of the three cases you picked above, "),B=n(J,"A",{href:!0});var It=r(B);K=a(It,"TapasForQuestionAnswering"),It.forEach(t),re=a(J,` requires different
inputs to be fine-tuned:`),J.forEach(t),W=h(z),L=n(z,"TABLE",{});var st=r(L);w=n(st,"THEAD",{});var sa=r(w);M=n(sa,"TR",{});var rt=r(M);R=n(rt,"TH",{});var ja=r(R);C=n(ja,"STRONG",{});var aa=r(C);O=a(aa,"Task"),aa.forEach(t),ja.forEach(t),ee=h(rt),te=n(rt,"TH",{});var $a=r(te);ce=n($a,"STRONG",{});var ua=r(ce);oe=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),rt.forEach(t),sa.forEach(t),se=h(st),P=n(st,"TBODY",{});var Ie=r(P);Q=n(Ie,"TR",{});var is=r(Q);H=n(is,"TD",{});var us=r(H);X=a(us,"Conversational"),us.forEach(t),I=h(is),Y=n(is,"TD",{});var Re=r(Y);ge=n(Re,"CODE",{});var Ea=r(ge);ue=a(Ea,"input_ids"),Ea.forEach(t),_e=a(Re,", "),me=n(Re,"CODE",{});var ma=r(me);ne=a(ma,"attention_mask"),ma.forEach(t),qe=a(Re,", "),ie=n(Re,"CODE",{});var ms=r(ie);ve=a(ms,"token_type_ids"),ms.forEach(t),v=a(Re,", "),D=n(Re,"CODE",{});var oa=r(D);be=a(oa,"labels"),oa.forEach(t),Re.forEach(t),is.forEach(t),xe=h(Ie),we=n(Ie,"TR",{});var ls=r(we);le=n(ls,"TD",{});var fa=r(le);ze=a(fa,"Weak supervision for aggregation"),fa.forEach(t),Me=h(ls),Z=n(ls,"TD",{});var fe=r(Z);de=n(fe,"CODE",{});var Fa=r(de);pe=a(Fa,"input_ids"),Fa.forEach(t),De=a(fe,", "),je=n(fe,"CODE",{});var fs=r(je);Te=a(fs,"attention_mask"),fs.forEach(t),Ne=a(fe,", "),ke=n(fe,"CODE",{});var Aa=r(ke);Ae=a(Aa,"token_type_ids"),Aa.forEach(t),Oe=a(fe,", "),Ze=n(fe,"CODE",{});var xa=r(Ze);Ss=a(xa,"labels"),xa.forEach(t),Ps=a(fe,", "),mt=n(fe,"CODE",{});var ga=r(mt);ft=a(ga,"numeric_values"),ga.forEach(t),ca=a(fe,", "),gt=n(fe,"CODE",{});var Tt=r(gt);_t=a(Tt,"numeric_values_scale"),Tt.forEach(t),Ds=a(fe,", "),tt=n(fe,"CODE",{});var na=r(tt);Ns=a(na,"float_answer"),na.forEach(t),fe.forEach(t),ls.forEach(t),Os=h(Ie),Ke=n(Ie,"TR",{});var ds=r(Ke);Se=n(ds,"TD",{});var za=r(Se);Ls=a(za,"Strong supervision for aggregation"),za.forEach(t),kt=h(ds),ye=n(ds,"TD",{});var Fe=r(ye);yt=n(Fe,"CODE",{});var Ca=r(yt);qt=a(Ca,"input ids"),Ca.forEach(t),Qs=a(Fe,", "),jt=n(Fe,"CODE",{});var ra=r(jt);$t=a(ra,"attention mask"),ra.forEach(t),Is=a(Fe,", "),Et=n(Fe,"CODE",{});var Ma=r(Et);cs=a(Ma,"token type ids"),Ma.forEach(t),Gt=a(Fe,", "),Ft=n(Fe,"CODE",{});var Sa=r(Ft);hs=a(Sa,"labels"),Sa.forEach(t),Ye=a(Fe,", "),$e=n(Fe,"CODE",{});var Pa=r($e);Ws=a(Pa,"aggregation_labels"),Pa.forEach(t),Fe.forEach(t),ds.forEach(t),Ie.forEach(t),st.forEach(t),At=h(z),ae=n(z,"P",{});var he=r(ae);ot=n(he,"A",{href:!0});var Da=r(ot);Vt=a(Da,"TapasTokenizer"),Da.forEach(t),Hs=a(he," creates the "),xt=n(he,"CODE",{});var ia=r(xt);Jt=a(ia,"labels"),ia.forEach(t),Us=a(he,", "),zt=n(he,"CODE",{});var Na=r(zt);Ct=a(Na,"numeric_values"),Na.forEach(t),Bs=a(he," and "),Mt=n(he,"CODE",{});var Oa=r(Mt);Xt=a(Oa,"numeric_values_scale"),Oa.forEach(t),Rs=a(he," based on the "),St=n(he,"CODE",{});var _a=r(St);Zt=a(_a,"answer_coordinates"),_a.forEach(t),Gs=a(he," and "),Pt=n(he,"CODE",{});var gs=r(Pt);Vs=a(gs,"answer_text"),gs.forEach(t),Le=a(he," columns of the TSV file. The "),Dt=n(he,"CODE",{});var La=r(Dt);es=a(La,"float_answer"),La.forEach(t),Ks=a(he," and "),Nt=n(he,"CODE",{});var Ta=r(Nt);ts=a(Ta,"aggregation_labels"),Ta.forEach(t),Ys=a(he," are already in the TSV file of step 2. Here\u2019s an example:"),he.forEach(t),ss=h(z),q(Ue.$$.fragment,z),as=h(z),Ee=n(z,"P",{});var Ce=r(Ee);os=a(Ce,"Note that "),nt=n(Ce,"A",{href:!0});var la=r(nt);Js=a(la,"TapasTokenizer"),la.forEach(t),Ot=a(Ce," expects the data of the table to be "),Lt=n(Ce,"STRONG",{});var Wt=r(Lt);Xs=a(Wt,"text-only"),Wt.forEach(t),Zs=a(Ce,". You can use "),Be=n(Ce,"CODE",{});var da=r(Be);ea=a(da,".astype(str)"),da.forEach(t),ns=a(Ce,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ce.forEach(t),rs=h(z),q(et.$$.fragment,z),this.h()},h(){f(d,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer"),f(B,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(ot,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer"),f(nt,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer")},m(z,J){m(z,l,J),e(l,b),e(l,d),e(d,u),e(l,T),e(l,p),e(p,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,G),e(l,V),e(l,B),e(B,K),e(l,re),m(z,W,J),m(z,L,J),e(L,w),e(w,M),e(M,R),e(R,C),e(C,O),e(M,ee),e(M,te),e(te,ce),e(ce,oe),e(L,se),e(L,P),e(P,Q),e(Q,H),e(H,X),e(Q,I),e(Q,Y),e(Y,ge),e(ge,ue),e(Y,_e),e(Y,me),e(me,ne),e(Y,qe),e(Y,ie),e(ie,ve),e(Y,v),e(Y,D),e(D,be),e(P,xe),e(P,we),e(we,le),e(le,ze),e(we,Me),e(we,Z),e(Z,de),e(de,pe),e(Z,De),e(Z,je),e(je,Te),e(Z,Ne),e(Z,ke),e(ke,Ae),e(Z,Oe),e(Z,Ze),e(Ze,Ss),e(Z,Ps),e(Z,mt),e(mt,ft),e(Z,ca),e(Z,gt),e(gt,_t),e(Z,Ds),e(Z,tt),e(tt,Ns),e(P,Os),e(P,Ke),e(Ke,Se),e(Se,Ls),e(Ke,kt),e(Ke,ye),e(ye,yt),e(yt,qt),e(ye,Qs),e(ye,jt),e(jt,$t),e(ye,Is),e(ye,Et),e(Et,cs),e(ye,Gt),e(ye,Ft),e(Ft,hs),e(ye,Ye),e(ye,$e),e($e,Ws),m(z,At,J),m(z,ae,J),e(ae,ot),e(ot,Vt),e(ae,Hs),e(ae,xt),e(xt,Jt),e(ae,Us),e(ae,zt),e(zt,Ct),e(ae,Bs),e(ae,Mt),e(Mt,Xt),e(ae,Rs),e(ae,St),e(St,Zt),e(ae,Gs),e(ae,Pt),e(Pt,Vs),e(ae,Le),e(ae,Dt),e(Dt,es),e(ae,Ks),e(ae,Nt),e(Nt,ts),e(ae,Ys),m(z,ss,J),j(Ue,z,J),m(z,as,J),m(z,Ee,J),e(Ee,os),e(Ee,nt),e(nt,Js),e(Ee,Ot),e(Ee,Lt),e(Lt,Xs),e(Ee,Zs),e(Ee,Be),e(Be,ea),e(Ee,ns),m(z,rs,J),j(et,z,J),Qt=!0},p:ut,i(z){Qt||($(Ue.$$.fragment,z),$(et.$$.fragment,z),Qt=!0)},o(z){E(Ue.$$.fragment,z),E(et.$$.fragment,z),Qt=!1},d(z){z&&t(l),z&&t(W),z&&t(L),z&&t(At),z&&t(ae),z&&t(ss),F(Ue,z),z&&t(as),z&&t(Ee),z&&t(rs),F(et,z)}}}function qk(S){let l,b;return l=new Tn({props:{$$slots:{default:[yk]},$$scope:{ctx:S}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function jk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se,P,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve,v,D,be,xe,we,le,ze,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ss,Ps,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Se,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Gt,Ft,hs,Ye,$e,Ws,At,ae,ot,Vt,Hs,xt,Jt,Us,zt,Ct,Bs,Mt,Xt,Rs,St,Zt,Gs,Pt,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,os,nt,Js,Ot,Lt,Xs,Zs,Be,ea,ns,rs,et,Qt;return Ue=new Ve({props:{code:`from transformers import TapasTokenizer
import pandas as pd
...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),b=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=o("a"),u=s("TapasTokenizer"),T=s(" to convert table-question pairs into "),p=o("code"),g=s("input_ids"),A=s(", "),k=o("code"),N=s("attention_mask"),x=s(", "),U=o("code"),G=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),B=o("a"),K=s("TFTapasForQuestionAnswering"),re=s(` requires different
inputs to be fine-tuned:`),W=c(),L=o("table"),w=o("thead"),M=o("tr"),R=o("th"),C=o("strong"),O=s("Task"),ee=c(),te=o("th"),ce=o("strong"),oe=s("Required inputs"),se=c(),P=o("tbody"),Q=o("tr"),H=o("td"),X=s("Conversational"),I=c(),Y=o("td"),ge=o("code"),ue=s("input_ids"),_e=s(", "),me=o("code"),ne=s("attention_mask"),qe=s(", "),ie=o("code"),ve=s("token_type_ids"),v=s(", "),D=o("code"),be=s("labels"),xe=c(),we=o("tr"),le=o("td"),ze=s("Weak supervision for aggregation"),Me=c(),Z=o("td"),de=o("code"),pe=s("input_ids"),De=s(", "),je=o("code"),Te=s("attention_mask"),Ne=s(", "),ke=o("code"),Ae=s("token_type_ids"),Oe=s(", "),Ze=o("code"),Ss=s("labels"),Ps=s(", "),mt=o("code"),ft=s("numeric_values"),ca=s(", "),gt=o("code"),_t=s("numeric_values_scale"),Ds=s(", "),tt=o("code"),Ns=s("float_answer"),Os=c(),Ke=o("tr"),Se=o("td"),Ls=s("Strong supervision for aggregation"),kt=c(),ye=o("td"),yt=o("code"),qt=s("input ids"),Qs=s(", "),jt=o("code"),$t=s("attention mask"),Is=s(", "),Et=o("code"),cs=s("token type ids"),Gt=s(", "),Ft=o("code"),hs=s("labels"),Ye=s(", "),$e=o("code"),Ws=s("aggregation_labels"),At=c(),ae=o("p"),ot=o("a"),Vt=s("TapasTokenizer"),Hs=s(" creates the "),xt=o("code"),Jt=s("labels"),Us=s(", "),zt=o("code"),Ct=s("numeric_values"),Bs=s(" and "),Mt=o("code"),Xt=s("numeric_values_scale"),Rs=s(" based on the "),St=o("code"),Zt=s("answer_coordinates"),Gs=s(" and "),Pt=o("code"),Vs=s("answer_text"),Le=s(" columns of the TSV file. The "),Dt=o("code"),es=s("float_answer"),Ks=s(" and "),Nt=o("code"),ts=s("aggregation_labels"),Ys=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ss=c(),y(Ue.$$.fragment),as=c(),Ee=o("p"),os=s("Note that "),nt=o("a"),Js=s("TapasTokenizer"),Ot=s(" expects the data of the table to be "),Lt=o("strong"),Xs=s("text-only"),Zs=s(". You can use "),Be=o("code"),ea=s(".astype(str)"),ns=s(` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),rs=c(),y(et.$$.fragment),this.h()},l(z){l=n(z,"P",{});var J=r(l);b=a(J,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=n(J,"A",{href:!0});var ya=r(d);u=a(ya,"TapasTokenizer"),ya.forEach(t),T=a(J," to convert table-question pairs into "),p=n(J,"CODE",{});var ta=r(p);g=a(ta,"input_ids"),ta.forEach(t),A=a(J,", "),k=n(J,"CODE",{});var qa=r(k);N=a(qa,"attention_mask"),qa.forEach(t),x=a(J,", "),U=n(J,"CODE",{});var ha=r(U);G=a(ha,"token_type_ids"),ha.forEach(t),V=a(J," and so on. Again, based on which of the three cases you picked above, "),B=n(J,"A",{href:!0});var It=r(B);K=a(It,"TFTapasForQuestionAnswering"),It.forEach(t),re=a(J,` requires different
inputs to be fine-tuned:`),J.forEach(t),W=h(z),L=n(z,"TABLE",{});var st=r(L);w=n(st,"THEAD",{});var sa=r(w);M=n(sa,"TR",{});var rt=r(M);R=n(rt,"TH",{});var ja=r(R);C=n(ja,"STRONG",{});var aa=r(C);O=a(aa,"Task"),aa.forEach(t),ja.forEach(t),ee=h(rt),te=n(rt,"TH",{});var $a=r(te);ce=n($a,"STRONG",{});var ua=r(ce);oe=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),rt.forEach(t),sa.forEach(t),se=h(st),P=n(st,"TBODY",{});var Ie=r(P);Q=n(Ie,"TR",{});var is=r(Q);H=n(is,"TD",{});var us=r(H);X=a(us,"Conversational"),us.forEach(t),I=h(is),Y=n(is,"TD",{});var Re=r(Y);ge=n(Re,"CODE",{});var Ea=r(ge);ue=a(Ea,"input_ids"),Ea.forEach(t),_e=a(Re,", "),me=n(Re,"CODE",{});var ma=r(me);ne=a(ma,"attention_mask"),ma.forEach(t),qe=a(Re,", "),ie=n(Re,"CODE",{});var ms=r(ie);ve=a(ms,"token_type_ids"),ms.forEach(t),v=a(Re,", "),D=n(Re,"CODE",{});var oa=r(D);be=a(oa,"labels"),oa.forEach(t),Re.forEach(t),is.forEach(t),xe=h(Ie),we=n(Ie,"TR",{});var ls=r(we);le=n(ls,"TD",{});var fa=r(le);ze=a(fa,"Weak supervision for aggregation"),fa.forEach(t),Me=h(ls),Z=n(ls,"TD",{});var fe=r(Z);de=n(fe,"CODE",{});var Fa=r(de);pe=a(Fa,"input_ids"),Fa.forEach(t),De=a(fe,", "),je=n(fe,"CODE",{});var fs=r(je);Te=a(fs,"attention_mask"),fs.forEach(t),Ne=a(fe,", "),ke=n(fe,"CODE",{});var Aa=r(ke);Ae=a(Aa,"token_type_ids"),Aa.forEach(t),Oe=a(fe,", "),Ze=n(fe,"CODE",{});var xa=r(Ze);Ss=a(xa,"labels"),xa.forEach(t),Ps=a(fe,", "),mt=n(fe,"CODE",{});var ga=r(mt);ft=a(ga,"numeric_values"),ga.forEach(t),ca=a(fe,", "),gt=n(fe,"CODE",{});var Tt=r(gt);_t=a(Tt,"numeric_values_scale"),Tt.forEach(t),Ds=a(fe,", "),tt=n(fe,"CODE",{});var na=r(tt);Ns=a(na,"float_answer"),na.forEach(t),fe.forEach(t),ls.forEach(t),Os=h(Ie),Ke=n(Ie,"TR",{});var ds=r(Ke);Se=n(ds,"TD",{});var za=r(Se);Ls=a(za,"Strong supervision for aggregation"),za.forEach(t),kt=h(ds),ye=n(ds,"TD",{});var Fe=r(ye);yt=n(Fe,"CODE",{});var Ca=r(yt);qt=a(Ca,"input ids"),Ca.forEach(t),Qs=a(Fe,", "),jt=n(Fe,"CODE",{});var ra=r(jt);$t=a(ra,"attention mask"),ra.forEach(t),Is=a(Fe,", "),Et=n(Fe,"CODE",{});var Ma=r(Et);cs=a(Ma,"token type ids"),Ma.forEach(t),Gt=a(Fe,", "),Ft=n(Fe,"CODE",{});var Sa=r(Ft);hs=a(Sa,"labels"),Sa.forEach(t),Ye=a(Fe,", "),$e=n(Fe,"CODE",{});var Pa=r($e);Ws=a(Pa,"aggregation_labels"),Pa.forEach(t),Fe.forEach(t),ds.forEach(t),Ie.forEach(t),st.forEach(t),At=h(z),ae=n(z,"P",{});var he=r(ae);ot=n(he,"A",{href:!0});var Da=r(ot);Vt=a(Da,"TapasTokenizer"),Da.forEach(t),Hs=a(he," creates the "),xt=n(he,"CODE",{});var ia=r(xt);Jt=a(ia,"labels"),ia.forEach(t),Us=a(he,", "),zt=n(he,"CODE",{});var Na=r(zt);Ct=a(Na,"numeric_values"),Na.forEach(t),Bs=a(he," and "),Mt=n(he,"CODE",{});var Oa=r(Mt);Xt=a(Oa,"numeric_values_scale"),Oa.forEach(t),Rs=a(he," based on the "),St=n(he,"CODE",{});var _a=r(St);Zt=a(_a,"answer_coordinates"),_a.forEach(t),Gs=a(he," and "),Pt=n(he,"CODE",{});var gs=r(Pt);Vs=a(gs,"answer_text"),gs.forEach(t),Le=a(he," columns of the TSV file. The "),Dt=n(he,"CODE",{});var La=r(Dt);es=a(La,"float_answer"),La.forEach(t),Ks=a(he," and "),Nt=n(he,"CODE",{});var Ta=r(Nt);ts=a(Ta,"aggregation_labels"),Ta.forEach(t),Ys=a(he," are already in the TSV file of step 2. Here\u2019s an example:"),he.forEach(t),ss=h(z),q(Ue.$$.fragment,z),as=h(z),Ee=n(z,"P",{});var Ce=r(Ee);os=a(Ce,"Note that "),nt=n(Ce,"A",{href:!0});var la=r(nt);Js=a(la,"TapasTokenizer"),la.forEach(t),Ot=a(Ce," expects the data of the table to be "),Lt=n(Ce,"STRONG",{});var Wt=r(Lt);Xs=a(Wt,"text-only"),Wt.forEach(t),Zs=a(Ce,". You can use "),Be=n(Ce,"CODE",{});var da=r(Be);ea=a(da,".astype(str)"),da.forEach(t),ns=a(Ce,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ce.forEach(t),rs=h(z),q(et.$$.fragment,z),this.h()},h(){f(d,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer"),f(B,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(ot,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer"),f(nt,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer")},m(z,J){m(z,l,J),e(l,b),e(l,d),e(d,u),e(l,T),e(l,p),e(p,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,G),e(l,V),e(l,B),e(B,K),e(l,re),m(z,W,J),m(z,L,J),e(L,w),e(w,M),e(M,R),e(R,C),e(C,O),e(M,ee),e(M,te),e(te,ce),e(ce,oe),e(L,se),e(L,P),e(P,Q),e(Q,H),e(H,X),e(Q,I),e(Q,Y),e(Y,ge),e(ge,ue),e(Y,_e),e(Y,me),e(me,ne),e(Y,qe),e(Y,ie),e(ie,ve),e(Y,v),e(Y,D),e(D,be),e(P,xe),e(P,we),e(we,le),e(le,ze),e(we,Me),e(we,Z),e(Z,de),e(de,pe),e(Z,De),e(Z,je),e(je,Te),e(Z,Ne),e(Z,ke),e(ke,Ae),e(Z,Oe),e(Z,Ze),e(Ze,Ss),e(Z,Ps),e(Z,mt),e(mt,ft),e(Z,ca),e(Z,gt),e(gt,_t),e(Z,Ds),e(Z,tt),e(tt,Ns),e(P,Os),e(P,Ke),e(Ke,Se),e(Se,Ls),e(Ke,kt),e(Ke,ye),e(ye,yt),e(yt,qt),e(ye,Qs),e(ye,jt),e(jt,$t),e(ye,Is),e(ye,Et),e(Et,cs),e(ye,Gt),e(ye,Ft),e(Ft,hs),e(ye,Ye),e(ye,$e),e($e,Ws),m(z,At,J),m(z,ae,J),e(ae,ot),e(ot,Vt),e(ae,Hs),e(ae,xt),e(xt,Jt),e(ae,Us),e(ae,zt),e(zt,Ct),e(ae,Bs),e(ae,Mt),e(Mt,Xt),e(ae,Rs),e(ae,St),e(St,Zt),e(ae,Gs),e(ae,Pt),e(Pt,Vs),e(ae,Le),e(ae,Dt),e(Dt,es),e(ae,Ks),e(ae,Nt),e(Nt,ts),e(ae,Ys),m(z,ss,J),j(Ue,z,J),m(z,as,J),m(z,Ee,J),e(Ee,os),e(Ee,nt),e(nt,Js),e(Ee,Ot),e(Ee,Lt),e(Lt,Xs),e(Ee,Zs),e(Ee,Be),e(Be,ea),e(Ee,ns),m(z,rs,J),j(et,z,J),Qt=!0},p:ut,i(z){Qt||($(Ue.$$.fragment,z),$(et.$$.fragment,z),Qt=!0)},o(z){E(Ue.$$.fragment,z),E(et.$$.fragment,z),Qt=!1},d(z){z&&t(l),z&&t(W),z&&t(L),z&&t(At),z&&t(ae),z&&t(ss),F(Ue,z),z&&t(as),z&&t(Ee),z&&t(rs),F(et,z)}}}function $k(S){let l,b;return l=new Tn({props:{$$slots:{default:[jk]},$$scope:{ctx:S}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function Ek(S){let l,b,d,u,T,p,g,A;return g=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering, AdamW
...
<span class="hljs-meta">... </span>        optimizer.step()`}}),{c(){l=o("p"),b=s("You can then fine-tune "),d=o("a"),u=s("TapasForQuestionAnswering"),T=s(" as follows (shown here for the weak supervision for aggregation case):"),p=c(),y(g.$$.fragment),this.h()},l(k){l=n(k,"P",{});var N=r(l);b=a(N,"You can then fine-tune "),d=n(N,"A",{href:!0});var x=r(d);u=a(x,"TapasForQuestionAnswering"),x.forEach(t),T=a(N," as follows (shown here for the weak supervision for aggregation case):"),N.forEach(t),p=h(k),q(g.$$.fragment,k),this.h()},h(){f(d,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering")},m(k,N){m(k,l,N),e(l,b),e(l,d),e(d,u),e(l,T),m(k,p,N),j(g,k,N),A=!0},p:ut,i(k){A||($(g.$$.fragment,k),A=!0)},o(k){E(g.$$.fragment,k),A=!1},d(k){k&&t(l),k&&t(p),F(g,k)}}}function Fk(S){let l,b;return l=new Tn({props:{$$slots:{default:[Ek]},$$scope:{ctx:S}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function Ak(S){let l,b,d,u,T,p,g,A;return g=new Ve({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">... </span>        optimizer.apply_gradients(<span class="hljs-built_in">zip</span>(grads, model.trainable_weights))`}}),{c(){l=o("p"),b=s("You can then fine-tune "),d=o("a"),u=s("TFTapasForQuestionAnswering"),T=s(" as follows (shown here for the weak supervision for aggregation case):"),p=c(),y(g.$$.fragment),this.h()},l(k){l=n(k,"P",{});var N=r(l);b=a(N,"You can then fine-tune "),d=n(N,"A",{href:!0});var x=r(d);u=a(x,"TFTapasForQuestionAnswering"),x.forEach(t),T=a(N," as follows (shown here for the weak supervision for aggregation case):"),N.forEach(t),p=h(k),q(g.$$.fragment,k),this.h()},h(){f(d,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering")},m(k,N){m(k,l,N),e(l,b),e(l,d),e(d,u),e(l,T),m(k,p,N),j(g,k,N),A=!0},p:ut,i(k){A||($(g.$$.fragment,k),A=!0)},o(k){E(g.$$.fragment,k),A=!1},d(k){k&&t(l),k&&t(p),F(g,k)}}}function xk(S){let l,b;return l=new Tn({props:{$$slots:{default:[Ak]},$$scope:{ctx:S}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function zk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se,P,Q,H;return Q=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
Predicted answer: SUM &gt; <span class="hljs-number">87</span>, <span class="hljs-number">53</span>, <span class="hljs-number">69</span>`}}),{c(){l=o("p"),b=s("Here we explain how you can use "),d=o("a"),u=s("TapasForQuestionAnswering"),T=s(" or "),p=o("a"),g=s("TFTapasForQuestionAnswering"),A=s(" for inference (i.e. making predictions on new data). For inference, only "),k=o("code"),N=s("input_ids"),x=s(", "),U=o("code"),G=s("attention_mask"),V=s(" and "),B=o("code"),K=s("token_type_ids"),re=s(" (which you can obtain using "),W=o("a"),L=s("TapasTokenizer"),w=s(") have to be provided to the model to obtain the logits. Next, you can use the handy "),M=o("code"),R=s("convert_logits_to_predictions"),C=s(" method to convert these into predicted coordinates and optional aggregation indices."),O=c(),ee=o("p"),te=s("However, note that inference is "),ce=o("strong"),oe=s("different"),se=s(" depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),P=c(),y(Q.$$.fragment),this.h()},l(X){l=n(X,"P",{});var I=r(l);b=a(I,"Here we explain how you can use "),d=n(I,"A",{href:!0});var Y=r(d);u=a(Y,"TapasForQuestionAnswering"),Y.forEach(t),T=a(I," or "),p=n(I,"A",{href:!0});var ge=r(p);g=a(ge,"TFTapasForQuestionAnswering"),ge.forEach(t),A=a(I," for inference (i.e. making predictions on new data). For inference, only "),k=n(I,"CODE",{});var ue=r(k);N=a(ue,"input_ids"),ue.forEach(t),x=a(I,", "),U=n(I,"CODE",{});var _e=r(U);G=a(_e,"attention_mask"),_e.forEach(t),V=a(I," and "),B=n(I,"CODE",{});var me=r(B);K=a(me,"token_type_ids"),me.forEach(t),re=a(I," (which you can obtain using "),W=n(I,"A",{href:!0});var ne=r(W);L=a(ne,"TapasTokenizer"),ne.forEach(t),w=a(I,") have to be provided to the model to obtain the logits. Next, you can use the handy "),M=n(I,"CODE",{});var qe=r(M);R=a(qe,"convert_logits_to_predictions"),qe.forEach(t),C=a(I," method to convert these into predicted coordinates and optional aggregation indices."),I.forEach(t),O=h(X),ee=n(X,"P",{});var ie=r(ee);te=a(ie,"However, note that inference is "),ce=n(ie,"STRONG",{});var ve=r(ce);oe=a(ve,"different"),ve.forEach(t),se=a(ie," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),ie.forEach(t),P=h(X),q(Q.$$.fragment,X),this.h()},h(){f(d,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(p,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(W,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer")},m(X,I){m(X,l,I),e(l,b),e(l,d),e(d,u),e(l,T),e(l,p),e(p,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,G),e(l,V),e(l,B),e(B,K),e(l,re),e(l,W),e(W,L),e(l,w),e(l,M),e(M,R),e(l,C),m(X,O,I),m(X,ee,I),e(ee,te),e(ee,ce),e(ce,oe),e(ee,se),m(X,P,I),j(Q,X,I),H=!0},p:ut,i(X){H||($(Q.$$.fragment,X),H=!0)},o(X){E(Q.$$.fragment,X),H=!1},d(X){X&&t(l),X&&t(O),X&&t(ee),X&&t(P),F(Q,X)}}}function Ck(S){let l,b;return l=new Tn({props:{$$slots:{default:[zk]},$$scope:{ctx:S}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function Mk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se;return oe=new Ve({props:{code:`from transformers import TapasTokenizer, TFTapasForQuestionAnswering
import pandas as pd
...
Predicted answer: COUNT &gt; <span class="hljs-number">69</span>
What <span class="hljs-keyword">is</span> the total number of movies?
Predicted answer: SUM &gt; <span class="hljs-number">87</span>, <span class="hljs-number">53</span>, <span class="hljs-number">69</span>`}}),{c(){l=o("p"),b=s("Here we explain how you can use "),d=o("a"),u=s("TFTapasForQuestionAnswering"),T=s(" for inference (i.e. making predictions on new data). For inference, only "),p=o("code"),g=s("input_ids"),A=s(", "),k=o("code"),N=s("attention_mask"),x=s(" and "),U=o("code"),G=s("token_type_ids"),V=s(" (which you can obtain using "),B=o("a"),K=s("TapasTokenizer"),re=s(") have to be provided to the model to obtain the logits. Next, you can use the handy "),W=o("code"),L=s("convert_logits_to_predictions"),w=s(" method to convert these into predicted coordinates and optional aggregation indices."),M=c(),R=o("p"),C=s("However, note that inference is "),O=o("strong"),ee=s("different"),te=s(" depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),ce=c(),y(oe.$$.fragment),this.h()},l(P){l=n(P,"P",{});var Q=r(l);b=a(Q,"Here we explain how you can use "),d=n(Q,"A",{href:!0});var H=r(d);u=a(H,"TFTapasForQuestionAnswering"),H.forEach(t),T=a(Q," for inference (i.e. making predictions on new data). For inference, only "),p=n(Q,"CODE",{});var X=r(p);g=a(X,"input_ids"),X.forEach(t),A=a(Q,", "),k=n(Q,"CODE",{});var I=r(k);N=a(I,"attention_mask"),I.forEach(t),x=a(Q," and "),U=n(Q,"CODE",{});var Y=r(U);G=a(Y,"token_type_ids"),Y.forEach(t),V=a(Q," (which you can obtain using "),B=n(Q,"A",{href:!0});var ge=r(B);K=a(ge,"TapasTokenizer"),ge.forEach(t),re=a(Q,") have to be provided to the model to obtain the logits. Next, you can use the handy "),W=n(Q,"CODE",{});var ue=r(W);L=a(ue,"convert_logits_to_predictions"),ue.forEach(t),w=a(Q," method to convert these into predicted coordinates and optional aggregation indices."),Q.forEach(t),M=h(P),R=n(P,"P",{});var _e=r(R);C=a(_e,"However, note that inference is "),O=n(_e,"STRONG",{});var me=r(O);ee=a(me,"different"),me.forEach(t),te=a(_e," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),_e.forEach(t),ce=h(P),q(oe.$$.fragment,P),this.h()},h(){f(d,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(B,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer")},m(P,Q){m(P,l,Q),e(l,b),e(l,d),e(d,u),e(l,T),e(l,p),e(p,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,G),e(l,V),e(l,B),e(B,K),e(l,re),e(l,W),e(W,L),e(l,w),m(P,M,Q),m(P,R,Q),e(R,C),e(R,O),e(O,ee),e(R,te),m(P,ce,Q),j(oe,P,Q),se=!0},p:ut,i(P){se||($(oe.$$.fragment,P),se=!0)},o(P){E(oe.$$.fragment,P),se=!1},d(P){P&&t(l),P&&t(M),P&&t(R),P&&t(ce),F(oe,P)}}}function Sk(S){let l,b;return l=new Tn({props:{$$slots:{default:[Mk]},$$scope:{ctx:S}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function Pk(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasModel, TapasConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=o("p"),b=s("Example:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Example:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Dk(S){let l,b,d,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(p,g){m(p,l,g),e(l,b),e(l,d),e(d,u),e(l,T)},d(p){p&&t(l)}}}function Nk(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasModel
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=o("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Ok(S){let l,b,d,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(p,g){m(p,l,g),e(l,b),e(l,d),e(d,u),e(l,T)},d(p){p&&t(l)}}}function Lk(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForMaskedLM
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Qk(S){let l,b,d,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(p,g){m(p,l,g),e(l,b),e(l,d),e(d,u),e(l,T)},d(p){p&&t(l)}}}function Ik(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForSequenceClassification
import torch
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Wk(S){let l,b,d,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(p,g){m(p,l,g),e(l,b),e(l,d),e(d,u),e(l,T)},d(p){p&&t(l)}}}function Hk(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Uk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se,P,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve;return{c(){l=o("p"),b=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=o("ul"),T=o("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),G=o("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
...
first positional argument :`),R=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),P=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),ie=o("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=n(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(v),u=n(v,"UL",{});var be=r(u);T=n(be,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=n(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=n(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),G=n(le,"CODE",{});var ze=r(G);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),B=a(le,` method which currently requires having all the
...
`),ie=n(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,d,D),m(v,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,G),e(G,V),e(x,B),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,R,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,P),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,ve)},d(v){v&&t(l),v&&t(d),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(R),v&&t(C)}}}function Bk(S){let l,b,d,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(p,g){m(p,l,g),e(l,b),e(l,d),e(d,u),e(l,T)},d(p){p&&t(l)}}}function Rk(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasModel
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=o("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Gk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se,P,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve;return{c(){l=o("p"),b=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=o("ul"),T=o("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),G=o("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),P=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=n(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(v),u=n(v,"UL",{});var be=r(u);T=n(be,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=n(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=n(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),G=n(le,"CODE",{});var ze=r(G);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),B=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),R=h(v),C=n(v,"UL",{});var de=r(C);O=n(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);P=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=n(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,d,D),m(v,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,G),e(G,V),e(x,B),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,R,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,P),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,ve)},d(v){v&&t(l),v&&t(d),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(R),v&&t(C)}}}function Vk(S){let l,b,d,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(p,g){m(p,l,g),e(l,b),e(l,d),e(d,u),e(l,T)},d(p){p&&t(l)}}}function Kk(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForMaskedLM
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Yk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se,P,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve;return{c(){l=o("p"),b=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=o("ul"),T=o("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),G=o("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),P=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=n(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(v),u=n(v,"UL",{});var be=r(u);T=n(be,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=n(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=n(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),G=n(le,"CODE",{});var ze=r(G);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),B=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),R=h(v),C=n(v,"UL",{});var de=r(C);O=n(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);P=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=n(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,d,D),m(v,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,G),e(G,V),e(x,B),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,R,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,P),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,ve)},d(v){v&&t(l),v&&t(d),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(R),v&&t(C)}}}function Jk(S){let l,b,d,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(p,g){m(p,l,g),e(l,b),e(l,d),e(d,u),e(l,T)},d(p){p&&t(l)}}}function Xk(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Zk(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se,P,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve;return{c(){l=o("p"),b=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=o("ul"),T=o("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),G=o("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),P=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=n(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(v),u=n(v,"UL",{});var be=r(u);T=n(be,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=n(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=n(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),G=n(le,"CODE",{});var ze=r(G);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),B=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),R=h(v),C=n(v,"UL",{});var de=r(C);O=n(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);P=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=n(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,d,D),m(v,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,G),e(G,V),e(x,B),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,R,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,P),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,ve)},d(v){v&&t(l),v&&t(d),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(R),v&&t(C)}}}function ey(S){let l,b,d,u,T;return{c(){l=o("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(p,g){m(p,l,g),e(l,b),e(l,d),e(d,u),e(l,T)},d(p){p&&t(l)}}}function ty(S){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function sy(S){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,oe,se,P,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,ve,v,D,be,xe,we,le,ze,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ss,Ps,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Se,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Gt,Ft,hs,Ye,$e,Ws,At,ae,ot,Vt,Hs,xt,Jt,Us,zt,Ct,Bs,Mt,Xt,Rs,St,Zt,Gs,Pt,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,os,nt,Js,Ot,Lt,Xs,Zs,Be,ea,ns,rs,et,Qt,z,J,ya,ta,qa,ha,It,st,sa,rt,ja,aa,$a,ua,Ie,is,us,Re,Ea,ma,ms,oa,ls,fa,fe,Fa,fs,Aa,xa,ga,Tt,na,ds,za,Fe,Ca,ra,Ma,Sa,Pa,he,Da,ia,Na,Oa,_a,gs,La,Ta,Ce,la,Wt,da,el,Pc,Dc,tl,sl,Nc,Oc,al,ol,Lc,Qc,Qa,Ia,nl,Ic,Wc,rl,Hc,Uc,il,Bc,Rc,Wa,ll,Gc,Vc,dl,Kc,Yc,pl,Jc,Xc,Ha,cl,Zc,eh,hl,th,sh,ul,ah,op,bo,np,vo,oh,bn,nh,rh,rp,wo,ih,vn,lh,dh,ip,Br,ml,ph,lp,ko,ch,wn,hh,uh,dp,We,Rr,fl,mh,fh,gh,Gr,gl,_h,Th,bh,Vr,_l,vh,wh,kh,Kr,Tl,yh,qh,jh,Yr,bl,$h,Eh,Fh,Jr,vl,Ah,xh,zh,Xr,wl,Ch,Mh,Sh,Zr,kl,Ph,Dh,Nh,ei,yl,Oh,Lh,pp,bt,Qh,kn,Ih,Wh,yn,Hh,Uh,ql,Bh,Rh,jl,Gh,Vh,$l,Kh,Yh,cp,ti,El,Jh,hp,yo,up,Pe,Xh,Fl,Zh,eu,Al,tu,su,xl,au,ou,zl,nu,ru,Cl,iu,lu,Ml,du,pu,si,cu,hu,qn,uu,mu,jn,fu,gu,mp,ai,_u,fp,qo,gp,Ua,jo,Sl,$n,Tu,Pl,bu,_p,$o,Tp,vt,vu,Dl,wu,ku,Nl,yu,qu,Ol,ju,$u,En,Eu,Fu,Fn,Au,xu,bp,Ba,Eo,Ll,An,zu,Ql,Cu,vp,Ra,xn,Mu,zn,Su,oi,Pu,Du,wp,Ga,Fo,Il,Cn,Nu,Wl,Ou,kp,Ht,Mn,Lu,Va,Qu,ni,Iu,Wu,Sn,Hu,Uu,Bu,Ka,Ru,Hl,Gu,Vu,ri,Ku,Yu,Ju,Pn,Xu,Dn,Zu,em,tm,Ao,yp,Ya,xo,Ul,Nn,sm,Bl,am,qp,Ge,On,om,Rl,nm,rm,Qe,im,ii,lm,dm,li,pm,cm,Gl,hm,um,Vl,mm,fm,Kl,gm,_m,Yl,Tm,bm,Jl,vm,wm,Xl,km,ym,Zl,qm,jm,$m,it,ed,Em,Fm,td,Am,xm,sd,zm,Cm,ad,Mm,Sm,od,Pm,Dm,nd,Nm,Om,rd,Lm,Qm,di,pi,Im,Wm,Hm,zo,Ln,Um,id,Bm,Rm,ba,Qn,Gm,In,Vm,ci,Km,Ym,Jm,Wn,Xm,Hn,Zm,ef,tf,hi,Un,jp,Ja,Co,ld,Bn,sf,dd,af,$p,lt,Rn,of,Gn,nf,ui,rf,lf,df,Vn,pf,Kn,cf,hf,uf,Yn,mf,mi,ff,gf,_f,Jn,Tf,Xn,bf,vf,wf,_s,Zn,kf,Xa,yf,fi,qf,jf,pd,$f,Ef,Ff,Mo,Af,So,Ep,Za,Po,cd,er,xf,hd,zf,Fp,ps,tr,Cf,eo,Mf,ud,Sf,Pf,gi,Df,Nf,Of,sr,Lf,ar,Qf,If,Wf,Ts,or,Hf,to,Uf,_i,Bf,Rf,md,Gf,Vf,Kf,Do,Yf,No,Ap,so,Oo,fd,nr,Jf,gd,Xf,xp,Ut,rr,Zf,_d,eg,tg,ir,sg,Ti,ag,og,ng,lr,rg,dr,ig,lg,dg,bs,pr,pg,ao,cg,bi,hg,ug,Td,mg,fg,gg,Lo,_g,Qo,zp,oo,Io,bd,cr,Tg,vd,bg,Cp,Bt,hr,vg,no,wg,wd,kg,yg,kd,qg,jg,$g,ur,Eg,vi,Fg,Ag,xg,mr,zg,fr,Cg,Mg,Sg,vs,gr,Pg,ro,Dg,wi,Ng,Og,yd,Lg,Qg,Ig,Wo,Wg,Ho,Mp,io,Uo,qd,_r,Hg,jd,Ug,Sp,dt,Tr,Bg,$d,Rg,Gg,br,Vg,ki,Kg,Yg,Jg,vr,Xg,wr,Zg,e_,t_,Bo,s_,ws,kr,a_,lo,o_,yi,n_,r_,Ed,i_,l_,d_,Ro,p_,Go,Pp,po,Vo,Fd,yr,c_,Ad,h_,Dp,pt,qr,u_,jr,m_,xd,f_,g_,__,$r,T_,qi,b_,v_,w_,Er,k_,Fr,y_,q_,j_,Ko,$_,ks,Ar,E_,co,F_,ji,A_,x_,zd,z_,C_,M_,Yo,S_,Jo,Np,ho,Xo,Cd,xr,P_,Md,D_,Op,ct,zr,N_,Sd,O_,L_,Cr,Q_,$i,I_,W_,H_,Mr,U_,Sr,B_,R_,G_,Zo,V_,ys,Pr,K_,uo,Y_,Ei,J_,X_,Pd,Z_,eT,tT,en,sT,tn,Lp,mo,sn,Dd,Dr,aT,Nd,oT,Qp,ht,Nr,nT,fo,rT,Od,iT,lT,Ld,dT,pT,cT,Or,hT,Fi,uT,mT,fT,Lr,gT,Qr,_T,TT,bT,an,vT,qs,Ir,wT,go,kT,Ai,yT,qT,Qd,jT,$T,ET,on,FT,nn,Ip;return p=new Rt({}),V=new Rt({}),rt=new Rt({}),bo=new Sc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[kk],pytorch:[vk]},$$scope:{ctx:S}}}),yo=new Sc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[$k],pytorch:[qk]},$$scope:{ctx:S}}}),qo=new Sc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[xk],pytorch:[Fk]},$$scope:{ctx:S}}}),$n=new Rt({}),$o=new Sc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Sk],pytorch:[Ck]},$$scope:{ctx:S}}}),An=new Rt({}),xn=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
this threshold will be selected.`,name:"cell_classification_threshold"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/tokenization_tapas.py#L1939",returnDescription:`
<ul>
...
`}}),Un=new He({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/tokenization_tapas.py#L444"}}),Bn=new Rt({}),Rn=new He({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17686/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tapas.py#L853"}}),Zn=new He({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_17686/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17686/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
Whether or not to return a <a href="/docs/transformers/pr_17686/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tapas.py#L891",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17686/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig"
...
`}}),Mo=new Ms({props:{$$slots:{default:[Dk]},$$scope:{ctx:S}}}),So=new To({props:{anchor:"transformers.TapasModel.forward.example",$$slots:{default:[Nk]},$$scope:{ctx:S}}}),er=new Rt({}),tr=new He({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17686/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tapas.py#L1006"}}),or=new He({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/pr_17686/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17686/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tapas.py#L1025",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17686/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tapas.py#L1478",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17686/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tapas.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
`}}),Wo=new Ms({props:{$$slots:{default:[Wk]},$$scope:{ctx:S}}}),Ho=new To({props:{anchor:"transformers.TapasForQuestionAnswering.forward.example",$$slots:{default:[Hk]},$$scope:{ctx:S}}}),_r=new Rt({}),Tr=new He({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17686/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tf_tapas.py#L961"}}),Bo=new Ms({props:{$$slots:{default:[Uk]},$$scope:{ctx:S}}}),kr=new He({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_17686/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17686/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17686/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tf_tapas.py#L967",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17686/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
`}}),Ro=new Ms({props:{$$slots:{default:[Bk]},$$scope:{ctx:S}}}),Go=new To({props:{anchor:"transformers.TFTapasModel.call.example",$$slots:{default:[Rk]},$$scope:{ctx:S}}}),yr=new Rt({}),qr=new He({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17686/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tf_tapas.py#L1036"}}),Ko=new Ms({props:{$$slots:{default:[Gk]},$$scope:{ctx:S}}}),Ar=new He({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_17686/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17686/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tf_tapas.py#L1052",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17686/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy). Note: this is called
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tf_tapas.py#L1586",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17686/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/vr_17686/src/transformers/models/tapas/modeling_tf_tapas.py#L1264",returnDescription:`
...
`}}),on=new Ms({props:{$$slots:{default:[ey]},$$scope:{ctx:S}}}),nn=new To({props:{anchor:"transformers.TFTapasForQuestionAnswering.call.example",$$slots:{default:[ty]},$$scope:{ctx:S}}}),{c(){l=o("meta"),b=c(),d=o("h1"),u=o("a"),T=o("span"),y(p.$$.fragment),g=c(),A=o("span"),k=s("TAPAS"),N=c(),x=o("h2"),U=o("a"),G=o("span"),y(V.$$.fragment),B=c(),K=o("span"),re=s("Overview"),W=c(),L=o("p"),w=s("The TAPAS model was proposed in "),M=o("a"),R=s("TAPAS: Weakly Supervised Table Parsing via Pre-training"),C=s(`
...
millions of tables from English Wikipedia and corresponding texts.`),O=c(),ee=o("p"),te=s("For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),ce=c(),oe=o("ul"),se=o("li"),P=o("a"),Q=s("SQA"),H=s(" (Sequential Question Answering by Microsoft)"),X=c(),I=o("li"),Y=o("a"),ge=s("WTQ"),ue=s(" (Wiki Table Questions by Stanford University)"),_e=c(),me=o("li"),ne=o("a"),qe=s("WikiSQL"),ie=s(" (by Salesforce)."),ve=c(),v=o("p"),D=s("It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),be=c(),xe=o("p"),we=s("The abstract from the paper is the following:"),le=c(),ze=o("p"),Me=o("em"),Z=s("Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),de=c(),pe=o("p"),De=s("In addition, the authors have further pre-trained TAPAS to recognize "),je=o("strong"),Te=s("table entailment"),Ne=s(", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),ke=o("a"),Ae=s("TabFact"),Oe=s(", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),Ze=o("a"),Ss=s("Understanding tables with intermediate pre-training"),Ps=s(" by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),mt=c(),ft=o("img"),gt=c(),_t=o("small"),Ds=s("TAPAS architecture. Taken from the "),tt=o("a"),Ns=s("original blog post"),Os=s("."),Ke=c(),Se=o("p"),Ls=s("This model was contributed by "),kt=o("a"),ye=s("nielsr"),yt=s(". The Tensorflow version of this model was contributed by "),qt=o("a"),Qs=s("kamalkraj"),jt=s(". The original code can be found "),$t=o("a"),Is=s("here"),Et=s("."),cs=c(),Gt=o("p"),Ft=s("Tips:"),hs=c(),Ye=o("ul"),$e=o("li"),Ws=s("TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),At=o("code"),ae=s("reset_position_index_per_cell"),ot=s(" parameter of "),Vt=o("a"),Hs=s("TapasConfig"),xt=s(", which is set to "),Jt=o("code"),Us=s("True"),zt=s(" by default. The default versions of the models available on the "),Ct=o("a"),Bs=s("hub"),Mt=s(" all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),Xt=o("code"),Rs=s('revision="no_reset"'),St=s(" when calling the "),Zt=o("code"),Gs=s("from_pretrained()"),Pt=s(" method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),Vs=c(),Le=o("li"),Dt=s("TAPAS is based on BERT, so "),es=o("code"),Ks=s("TAPAS-base"),Nt=s(" for example corresponds to a "),ts=o("code"),Ys=s("BERT-base"),ss=s(" architecture. Of course, "),Ue=o("code"),as=s("TAPAS-large"),Ee=s(" will result in the best performance (the results reported in the paper are from "),os=o("code"),nt=s("TAPAS-large"),Js=s("). Results of the various sized models are shown on the "),Ot=o("a"),Lt=s("original Github repository"),Xs=s("."),Zs=c(),Be=o("li"),ea=s("TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),ns=o("code"),rs=s("prev_labels"),et=s(" token type ids can be overwritten by the predicted "),Qt=o("code"),z=s("labels"),J=s(" of the model to the previous question. See \u201CUsage\u201D section for more info."),ya=c(),ta=o("li"),qa=s("TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),ha=c(),It=o("h2"),st=o("a"),sa=o("span"),y(rt.$$.fragment),ja=c(),aa=o("span"),$a=s("Usage: fine-tuning"),ua=c(),Ie=o("p"),is=s("Here we explain how you can fine-tune "),us=o("a"),Re=s("TapasForQuestionAnswering"),Ea=s(" on your own dataset."),ma=c(),ms=o("p"),oa=o("strong"),ls=s("STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),fa=c(),fe=o("p"),Fa=s("Basically, there are 3 different ways in which one can fine-tune "),fs=o("a"),Aa=s("TapasForQuestionAnswering"),xa=s(", corresponding to the different datasets on which Tapas was fine-tuned:"),ga=c(),Tt=o("ol"),na=o("li"),ds=s("SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),za=c(),Fe=o("li"),Ca=s("WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ra=o("strong"),Ma=s("weak supervision"),Sa=s(", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Pa=c(),he=o("li"),Da=s("WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ia=o("strong"),Na=s("strong supervision"),Oa=s(". Here, learning the appropriate aggregation operator is much easier."),_a=c(),gs=o("p"),La=s("To summarize:"),Ta=c(),Ce=o("table"),la=o("thead"),Wt=o("tr"),da=o("th"),el=o("strong"),Pc=s("Task"),Dc=c(),tl=o("th"),sl=o("strong"),Nc=s("Example dataset"),Oc=c(),al=o("th"),ol=o("strong"),Lc=s("Description"),Qc=c(),Qa=o("tbody"),Ia=o("tr"),nl=o("td"),Ic=s("Conversational"),Wc=c(),rl=o("td"),Hc=s("SQA"),Uc=c(),il=o("td"),Bc=s("Conversational, only cell selection questions"),Rc=c(),Wa=o("tr"),ll=o("td"),Gc=s("Weak supervision for aggregation"),Vc=c(),dl=o("td"),Kc=s("WTQ"),Yc=c(),pl=o("td"),Jc=s("Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Xc=c(),Ha=o("tr"),cl=o("td"),Zc=s("Strong supervision for aggregation"),eh=c(),hl=o("td"),th=s("WikiSQL-supervised"),sh=c(),ul=o("td"),ah=s("Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),op=c(),y(bo.$$.fragment),np=c(),vo=o("p"),oh=s("What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),bn=o("a"),nh=s("here"),rh=s(" for more info."),rp=c(),wo=o("p"),ih=s("For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),vn=o("a"),lh=s("here"),dh=s("."),ip=c(),Br=o("p"),ml=o("strong"),ph=s("STEP 2: Prepare your data in the SQA format"),lp=c(),ko=o("p"),ch=s("Second, no matter what you picked above, you should prepare your dataset in the "),wn=o("a"),hh=s("SQA"),uh=s(" format. This format is a TSV/CSV file with the following columns:"),dp=c(),We=o("ul"),Rr=o("li"),fl=o("code"),mh=s("id"),fh=s(": optional, id of the table-question pair, for bookkeeping purposes."),gh=c(),Gr=o("li"),gl=o("code"),_h=s("annotator"),Th=s(": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),bh=c(),Vr=o("li"),_l=o("code"),vh=s("position"),wh=s(": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),kh=c(),Kr=o("li"),Tl=o("code"),yh=s("question"),qh=s(": string"),jh=c(),Yr=o("li"),bl=o("code"),$h=s("table_file"),Eh=s(": string, name of a csv file containing the tabular data"),Fh=c(),Jr=o("li"),vl=o("code"),Ah=s("answer_coordinates"),xh=s(": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),zh=c(),Xr=o("li"),wl=o("code"),Ch=s("answer_text"),Mh=s(": list of one or more strings (each string being a cell value that is part of the answer)"),Sh=c(),Zr=o("li"),kl=o("code"),Ph=s("aggregation_label"),Dh=s(": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),Nh=c(),ei=o("li"),yl=o("code"),Oh=s("float_answer"),Lh=s(": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),pp=c(),bt=o("p"),Qh=s("The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),kn=o("a"),Ih=s("here"),Wh=s(". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),yn=o("a"),Hh=s("here"),Uh=s(". Interestingly, these conversion scripts are not perfect (the "),ql=o("code"),Bh=s("answer_coordinates"),Rh=s(" and "),jl=o("code"),Gh=s("float_answer"),Vh=s(" fields are populated based on the "),$l=o("code"),Kh=s("answer_text"),Yh=s("), meaning that WTQ and WikiSQL results could actually be improved."),cp=c(),ti=o("p"),El=o("strong"),Jh=s("STEP 3: Convert your data into tensors using TapasTokenizer"),hp=c(),y(yo.$$.fragment),up=c(),Pe=o("p"),Xh=s("Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),Fl=o("strong"),Zh=s("not conversational"),eu=s(". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),Al=o("code"),tu=s("queries"),su=s(", "),xl=o("code"),au=s("answer_coordinates"),ou=s(" and "),zl=o("code"),nu=s("answer_text"),ru=s(" per table (in the order of their "),Cl=o("code"),iu=s("position"),lu=s(`
index) and batch encode each table with its questions. This will make sure that the `),Ml=o("code"),du=s("prev_labels"),pu=s(" token types (see docs of "),si=o("a"),cu=s("TapasTokenizer"),hu=s(") are set correctly. See "),qn=o("a"),uu=s("this notebook"),mu=s(" for more info. See "),jn=o("a"),fu=s("this notebook"),gu=s(" for more info regarding using the TensorFlow model."),mp=c(),ai=o("p"),_u=s("**STEP 4: Train (fine-tune) the model"),fp=c(),y(qo.$$.fragment),gp=c(),Ua=o("h2"),jo=o("a"),Sl=o("span"),y($n.$$.fragment),Tu=c(),Pl=o("span"),bu=s("Usage: inference"),_p=c(),y($o.$$.fragment),Tp=c(),vt=o("p"),vu=s("In case of a conversational set-up, then each table-question pair must be provided "),Dl=o("strong"),wu=s("sequentially"),ku=s(" to the model, such that the "),Nl=o("code"),yu=s("prev_labels"),qu=s(" token types can be overwritten by the predicted "),Ol=o("code"),ju=s("labels"),$u=s(" of the previous table-question pair. Again, more info can be found in "),En=o("a"),Eu=s("this notebook"),Fu=s(" (for PyTorch) and "),Fn=o("a"),Au=s("this notebook"),xu=s(" (for TensorFlow)."),bp=c(),Ba=o("h2"),Eo=o("a"),Ll=o("span"),y(An.$$.fragment),zu=c(),Ql=o("span"),Cu=s("TAPAS specific outputs"),vp=c(),Ra=o("div"),y(xn.$$.fragment),Mu=c(),zn=o("p"),Su=s("Output type of "),oi=o("a"),Pu=s("TapasForQuestionAnswering"),Du=s("."),wp=c(),Ga=o("h2"),Fo=o("a"),Il=o("span"),y(Cn.$$.fragment),Nu=c(),Wl=o("span"),Ou=s("TapasConfig"),kp=c(),Ht=o("div"),y(Mn.$$.fragment),Lu=c(),Va=o("p"),Qu=s("This is the configuration class to store the configuration of a "),ni=o("a"),Iu=s("TapasModel"),Wu=s(`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS
`),Sn=o("a"),Hu=s("google/tapas-base-finetuned-sqa"),Uu=s(" architecture."),Bu=c(),Ka=o("p"),Ru=s("Configuration objects inherit from "),Hl=o("code"),Gu=s("PreTrainedConfig"),Vu=s(` and can be used to control the model outputs. Read the
documentation from `),ri=o("a"),Ku=s("PretrainedConfig"),Yu=s(" for more information."),Ju=c(),Pn=o("p"),Xu=s(`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Dn=o("a"),Zu=s("https://github.com/google-research/tapas/tree/master"),em=s("."),tm=c(),y(Ao.$$.fragment),yp=c(),Ya=o("h2"),xo=o("a"),Ul=o("span"),y(Nn.$$.fragment),sm=c(),Bl=o("span"),am=s("TapasTokenizer"),qp=c(),Ge=o("div"),y(On.$$.fragment),om=c(),Rl=o("p"),nm=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),rm=c(),Qe=o("p"),im=s("This tokenizer inherits from "),ii=o("a"),lm=s("PreTrainedTokenizer"),dm=s(` which contains most of the main methods. Users should refer to
...
`),Vl=o("code"),mm=s("column_ids"),fm=s(", "),Kl=o("code"),gm=s("row_ids"),_m=s(", "),Yl=o("code"),Tm=s("prev_labels"),bm=s(", "),Jl=o("code"),vm=s("column_ranks"),wm=s(", "),Xl=o("code"),km=s("inv_column_ranks"),ym=s(" and "),Zl=o("code"),qm=s("numeric_relations"),jm=s(":"),$m=c(),it=o("ul"),ed=o("li"),Em=s(`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
...
tokens, special tokens and padding.`),xm=c(),sd=o("li"),zm=s(`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),Cm=c(),ad=o("li"),Mm=s(`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),Sm=c(),od=o("li"),Pm=s(`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),Dm=c(),nd=o("li"),Nm=s(`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),Om=c(),rd=o("li"),Lm=s(`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
...
wordpiece.`),Hm=c(),zo=o("div"),y(Ln.$$.fragment),Um=c(),id=o("p"),Bm=s("Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Rm=c(),ba=o("div"),y(Qn.$$.fragment),Gm=c(),In=o("p"),Vm=s("Converts logits of "),ci=o("a"),Km=s("TapasForQuestionAnswering"),Ym=s(` to actual predicted answer coordinates and optional
aggregation indices.`),Jm=c(),Wn=o("p"),Xm=s(`The original implementation, on which this function is based, can be found
`),Hn=o("a"),Zm=s("here"),ef=s("."),tf=c(),hi=o("div"),y(Un.$$.fragment),jp=c(),Ja=o("h2"),Co=o("a"),ld=o("span"),y(Bn.$$.fragment),sf=c(),dd=o("span"),af=s("TapasModel"),$p=c(),lt=o("div"),y(Rn.$$.fragment),of=c(),Gn=o("p"),nf=s(`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),wf=c(),_s=o("div"),y(Zn.$$.fragment),kf=c(),Xa=o("p"),yf=s("The "),fi=o("a"),qf=s("TapasModel"),jf=s(" forward method, overrides the "),pd=o("code"),$f=s("__call__"),Ef=s(" special method."),Ff=c(),y(Mo.$$.fragment),Af=c(),y(So.$$.fragment),Ep=c(),Za=o("h2"),Po=o("a"),cd=o("span"),y(er.$$.fragment),xf=c(),hd=o("span"),zf=s("TapasForMaskedLM"),Fp=c(),ps=o("div"),y(tr.$$.fragment),Cf=c(),eo=o("p"),Mf=s("Tapas Model with a "),ud=o("code"),Sf=s("language modeling"),Pf=s(` head on top.
...
SQA, WTQ or WikiSQL-supervised tasks.`),$g=c(),ur=o("p"),Eg=s("This model inherits from "),vi=o("a"),Fg=s("PreTrainedModel"),Ag=s(`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xg=c(),mr=o("p"),zg=s("This model is also a PyTorch "),fr=o("a"),Cg=s("torch.nn.Module"),Mg=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sg=c(),vs=o("div"),y(gr.$$.fragment),Pg=c(),ro=o("p"),Dg=s("The "),wi=o("a"),Ng=s("TapasForQuestionAnswering"),Og=s(" forward method, overrides the "),yd=o("code"),Lg=s("__call__"),Qg=s(" special method."),Ig=c(),y(Wo.$$.fragment),Wg=c(),y(Ho.$$.fragment),Mp=c(),io=o("h2"),Uo=o("a"),qd=o("span"),y(_r.$$.fragment),Hg=c(),jd=o("span"),Ug=s("TFTapasModel"),Sp=c(),dt=o("div"),y(Tr.$$.fragment),Bg=c(),$d=o("p"),Rg=s("The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Gg=c(),br=o("p"),Vg=s("This model inherits from "),ki=o("a"),Kg=s("TFPreTrainedModel"),Yg=s(`. Check the superclass documentation for the generic methods the
...
behavior.`),t_=c(),y(Bo.$$.fragment),s_=c(),ws=o("div"),y(kr.$$.fragment),a_=c(),lo=o("p"),o_=s("The "),yi=o("a"),n_=s("TFTapasModel"),r_=s(" forward method, overrides the "),Ed=o("code"),i_=s("__call__"),l_=s(" special method."),d_=c(),y(Ro.$$.fragment),p_=c(),y(Go.$$.fragment),Pp=c(),po=o("h2"),Vo=o("a"),Fd=o("span"),y(yr.$$.fragment),c_=c(),Ad=o("span"),h_=s("TFTapasForMaskedLM"),Dp=c(),pt=o("div"),y(qr.$$.fragment),u_=c(),jr=o("p"),m_=s("Tapas Model with a "),xd=o("code"),f_=s("language modeling"),g_=s(" head on top."),__=c(),$r=o("p"),T_=s("This model inherits from "),qi=o("a"),b_=s("TFPreTrainedModel"),v_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),w_=c(),Er=o("p"),k_=s("This model is also a "),Fr=o("a"),y_=s("tf.keras.Model"),q_=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=c(),y(Ko.$$.fragment),$_=c(),ks=o("div"),y(Ar.$$.fragment),E_=c(),co=o("p"),F_=s("The "),ji=o("a"),A_=s("TFTapasForMaskedLM"),x_=s(" forward method, overrides the "),zd=o("code"),z_=s("__call__"),C_=s(" special method."),M_=c(),y(Yo.$$.fragment),S_=c(),y(Jo.$$.fragment),Np=c(),ho=o("h2"),Xo=o("a"),Cd=o("span"),y(xr.$$.fragment),P_=c(),Md=o("span"),D_=s("TFTapasForSequenceClassification"),Op=c(),ct=o("div"),y(zr.$$.fragment),N_=c(),Sd=o("p"),O_=s(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),H_=c(),Mr=o("p"),U_=s("This model is also a "),Sr=o("a"),B_=s("tf.keras.Model"),R_=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),G_=c(),y(Zo.$$.fragment),V_=c(),ys=o("div"),y(Pr.$$.fragment),K_=c(),uo=o("p"),Y_=s("The "),Ei=o("a"),J_=s("TFTapasForSequenceClassification"),X_=s(" forward method, overrides the "),Pd=o("code"),Z_=s("__call__"),eT=s(" special method."),tT=c(),y(en.$$.fragment),sT=c(),y(tn.$$.fragment),Lp=c(),mo=o("h2"),sn=o("a"),Dd=o("span"),y(Dr.$$.fragment),aT=c(),Nd=o("span"),oT=s("TFTapasForQuestionAnswering"),Qp=c(),ht=o("div"),y(Nr.$$.fragment),nT=c(),fo=o("p"),rT=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
SQA, WTQ or WikiSQL-supervised tasks.`),cT=c(),Or=o("p"),hT=s("This model inherits from "),Fi=o("a"),uT=s("TFPreTrainedModel"),mT=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fT=c(),Lr=o("p"),gT=s("This model is also a "),Qr=o("a"),_T=s("tf.keras.Model"),TT=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bT=c(),y(an.$$.fragment),vT=c(),qs=o("div"),y(Ir.$$.fragment),wT=c(),go=o("p"),kT=s("The "),Ai=o("a"),yT=s("TFTapasForQuestionAnswering"),qT=s(" forward method, overrides the "),Qd=o("code"),jT=s("__call__"),$T=s(" special method."),ET=c(),y(on.$$.fragment),FT=c(),y(nn.$$.fragment),this.h()},l(i){const _=gk('[data-svelte="svelte-1phssyn"]',document.head);l=n(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(i),d=n(i,"H1",{class:!0});var Wr=r(d);u=n(Wr,"A",{id:!0,class:!0,href:!0});var Id=r(u);T=n(Id,"SPAN",{});var Wd=r(T);q(p.$$.fragment,Wd),Wd.forEach(t),Id.forEach(t),g=h(Wr),A=n(Wr,"SPAN",{});var Hd=r(A);k=a(Hd,"TAPAS"),Hd.forEach(t),Wr.forEach(t),N=h(i),x=n(i,"H2",{class:!0});var Hr=r(x);U=n(Hr,"A",{id:!0,class:!0,href:!0});var Ud=r(U);G=n(Ud,"SPAN",{});var Bd=r(G);q(V.$$.fragment,Bd),Bd.forEach(t),Ud.forEach(t),B=h(Hr),K=n(Hr,"SPAN",{});var Rd=r(K);re=a(Rd,"Overview"),Rd.forEach(t),Hr.forEach(t),W=h(i),L=n(i,"P",{});var Ur=r(L);w=a(Ur,"The TAPAS model was proposed in "),M=n(Ur,"A",{href:!0,rel:!0});var Gd=r(M);R=a(Gd,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),Gd.forEach(t),C=a(Ur,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),Ur.forEach(t),O=h(i),ee=n(i,"P",{});var Vd=r(ee);te=a(Vd,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),Vd.forEach(t),ce=h(i),oe=n(i,"UL",{});var _o=r(oe);se=n(_o,"LI",{});var xi=r(se);P=n(xi,"A",{href:!0,rel:!0});var Kd=r(P);Q=a(Kd,"SQA"),Kd.forEach(t),H=a(xi," (Sequential Question Answering by Microsoft)"),xi.forEach(t),X=h(_o),I=n(_o,"LI",{});var zi=r(I);Y=n(zi,"A",{href:!0,rel:!0});var Yd=r(Y);ge=a(Yd,"WTQ"),Yd.forEach(t),ue=a(zi," (Wiki Table Questions by Stanford University)"),zi.forEach(t),_e=h(_o),me=n(_o,"LI",{});var Ci=r(me);ne=n(Ci,"A",{href:!0,rel:!0});var Jd=r(ne);qe=a(Jd,"WikiSQL"),Jd.forEach(t),ie=a(Ci," (by Salesforce)."),Ci.forEach(t),_o.forEach(t),ve=h(i),v=n(i,"P",{});var Xd=r(v);D=a(Xd,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),Xd.forEach(t),be=h(i),xe=n(i,"P",{});var Zd=r(xe);we=a(Zd,"The abstract from the paper is the following:"),Zd.forEach(t),le=h(i),ze=n(i,"P",{});var ep=r(ze);Me=n(ep,"EM",{});var tp=r(Me);Z=a(tp,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),tp.forEach(t),ep.forEach(t),de=h(i),pe=n(i,"P",{});var pa=r(pe);De=a(pa,"In addition, the authors have further pre-trained TAPAS to recognize "),je=n(pa,"STRONG",{});var sp=r(je);Te=a(sp,"table entailment"),sp.forEach(t),Ne=a(pa,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),ke=n(pa,"A",{href:!0,rel:!0});var ap=r(ke);Ae=a(ap,"TabFact"),ap.forEach(t),Oe=a(pa,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),Ze=n(pa,"A",{href:!0,rel:!0});var LT=r(Ze);Ss=a(LT,"Understanding tables with intermediate pre-training"),LT.forEach(t),Ps=a(pa," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),pa.forEach(t),mt=h(i),ft=n(i,"IMG",{src:!0,alt:!0,width:!0}),gt=h(i),_t=n(i,"SMALL",{});var Wp=r(_t);Ds=a(Wp,"TAPAS architecture. Taken from the "),tt=n(Wp,"A",{href:!0});var QT=r(tt);Ns=a(QT,"original blog post"),QT.forEach(t),Os=a(Wp,"."),Wp.forEach(t),Ke=h(i),Se=n(i,"P",{});var rn=r(Se);Ls=a(rn,"This model was contributed by "),kt=n(rn,"A",{href:!0,rel:!0});var IT=r(kt);ye=a(IT,"nielsr"),IT.forEach(t),yt=a(rn,". The Tensorflow version of this model was contributed by "),qt=n(rn,"A",{href:!0,rel:!0});var WT=r(qt);Qs=a(WT,"kamalkraj"),WT.forEach(t),jt=a(rn,". The original code can be found "),$t=n(rn,"A",{href:!0,rel:!0});var HT=r($t);Is=a(HT,"here"),HT.forEach(t),Et=a(rn,"."),rn.forEach(t),cs=h(i),Gt=n(i,"P",{});var UT=r(Gt);Ft=a(UT,"Tips:"),UT.forEach(t),hs=h(i),Ye=n(i,"UL",{});var ln=r(Ye);$e=n(ln,"LI",{});var Kt=r($e);Ws=a(Kt,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),At=n(Kt,"CODE",{});var BT=r(At);ae=a(BT,"reset_position_index_per_cell"),BT.forEach(t),ot=a(Kt," parameter of "),Vt=n(Kt,"A",{href:!0});var RT=r(Vt);Hs=a(RT,"TapasConfig"),RT.forEach(t),xt=a(Kt,", which is set to "),Jt=n(Kt,"CODE",{});var GT=r(Jt);Us=a(GT,"True"),GT.forEach(t),zt=a(Kt," by default. The default versions of the models available on the "),Ct=n(Kt,"A",{href:!0,rel:!0});var VT=r(Ct);Bs=a(VT,"hub"),VT.forEach(t),Mt=a(Kt," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),Xt=n(Kt,"CODE",{});var KT=r(Xt);Rs=a(KT,'revision="no_reset"'),KT.forEach(t),St=a(Kt," when calling the "),Zt=n(Kt,"CODE",{});var YT=r(Zt);Gs=a(YT,"from_pretrained()"),YT.forEach(t),Pt=a(Kt," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),Kt.forEach(t),Vs=h(ln),Le=n(ln,"LI",{});var js=r(Le);Dt=a(js,"TAPAS is based on BERT, so "),es=n(js,"CODE",{});var JT=r(es);Ks=a(JT,"TAPAS-base"),JT.forEach(t),Nt=a(js," for example corresponds to a "),ts=n(js,"CODE",{});var XT=r(ts);Ys=a(XT,"BERT-base"),XT.forEach(t),ss=a(js," architecture. Of course, "),Ue=n(js,"CODE",{});var ZT=r(Ue);as=a(ZT,"TAPAS-large"),ZT.forEach(t),Ee=a(js," will result in the best performance (the results reported in the paper are from "),os=n(js,"CODE",{});var eb=r(os);nt=a(eb,"TAPAS-large"),eb.forEach(t),Js=a(js,"). Results of the various sized models are shown on the "),Ot=n(js,"A",{href:!0,rel:!0});var tb=r(Ot);Lt=a(tb,"original Github repository"),tb.forEach(t),Xs=a(js,"."),js.forEach(t),Zs=h(ln),Be=n(ln,"LI",{});var Mi=r(Be);ea=a(Mi,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),ns=n(Mi,"CODE",{});var sb=r(ns);rs=a(sb,"prev_labels"),sb.forEach(t),et=a(Mi," token type ids can be overwritten by the predicted "),Qt=n(Mi,"CODE",{});var ab=r(Qt);z=a(ab,"labels"),ab.forEach(t),J=a(Mi," of the model to the previous question. See \u201CUsage\u201D section for more info."),Mi.forEach(t),ya=h(ln),ta=n(ln,"LI",{});var ob=r(ta);qa=a(ob,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),ob.forEach(t),ln.forEach(t),ha=h(i),It=n(i,"H2",{class:!0});var Hp=r(It);st=n(Hp,"A",{id:!0,class:!0,href:!0});var nb=r(st);sa=n(nb,"SPAN",{});var rb=r(sa);q(rt.$$.fragment,rb),rb.forEach(t),nb.forEach(t),ja=h(Hp),aa=n(Hp,"SPAN",{});var ib=r(aa);$a=a(ib,"Usage: fine-tuning"),ib.forEach(t),Hp.forEach(t),ua=h(i),Ie=n(i,"P",{});var Up=r(Ie);is=a(Up,"Here we explain how you can fine-tune "),us=n(Up,"A",{href:!0});var lb=r(us);Re=a(lb,"TapasForQuestionAnswering"),lb.forEach(t),Ea=a(Up," on your own dataset."),Up.forEach(t),ma=h(i),ms=n(i,"P",{});var db=r(ms);oa=n(db,"STRONG",{});var pb=r(oa);ls=a(pb,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),pb.forEach(t),db.forEach(t),fa=h(i),fe=n(i,"P",{});var Bp=r(fe);Fa=a(Bp,"Basically, there are 3 different ways in which one can fine-tune "),fs=n(Bp,"A",{href:!0});var cb=r(fs);Aa=a(cb,"TapasForQuestionAnswering"),cb.forEach(t),xa=a(Bp,", corresponding to the different datasets on which Tapas was fine-tuned:"),Bp.forEach(t),ga=h(i),Tt=n(i,"OL",{});var Si=r(Tt);na=n(Si,"LI",{});var hb=r(na);ds=a(hb,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),hb.forEach(t),za=h(Si),Fe=n(Si,"LI",{});var Rp=r(Fe);Ca=a(Rp,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ra=n(Rp,"STRONG",{});var ub=r(ra);Ma=a(ub,"weak supervision"),ub.forEach(t),Sa=a(Rp,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Rp.forEach(t),Pa=h(Si),he=n(Si,"LI",{});var Gp=r(he);Da=a(Gp,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ia=n(Gp,"STRONG",{});var mb=r(ia);Na=a(mb,"strong supervision"),mb.forEach(t),Oa=a(Gp,". Here, learning the appropriate aggregation operator is much easier."),Gp.forEach(t),Si.forEach(t),_a=h(i),gs=n(i,"P",{});var fb=r(gs);La=a(fb,"To summarize:"),fb.forEach(t),Ta=h(i),Ce=n(i,"TABLE",{});var Vp=r(Ce);la=n(Vp,"THEAD",{});var gb=r(la);Wt=n(gb,"TR",{});var Pi=r(Wt);da=n(Pi,"TH",{});var _b=r(da);el=n(_b,"STRONG",{});var Tb=r(el);Pc=a(Tb,"Task"),Tb.forEach(t),_b.forEach(t),Dc=h(Pi),tl=n(Pi,"TH",{});var bb=r(tl);sl=n(bb,"STRONG",{});var vb=r(sl);Nc=a(vb,"Example dataset"),vb.forEach(t),bb.forEach(t),Oc=h(Pi),al=n(Pi,"TH",{});var wb=r(al);ol=n(wb,"STRONG",{});var kb=r(ol);Lc=a(kb,"Description"),kb.forEach(t),wb.forEach(t),Pi.forEach(t),gb.forEach(t),Qc=h(Vp),Qa=n(Vp,"TBODY",{});var Di=r(Qa);Ia=n(Di,"TR",{});var Ni=r(Ia);nl=n(Ni,"TD",{});var yb=r(nl);Ic=a(yb,"Conversational"),yb.forEach(t),Wc=h(Ni),rl=n(Ni,"TD",{});var qb=r(rl);Hc=a(qb,"SQA"),qb.forEach(t),Uc=h(Ni),il=n(Ni,"TD",{});var jb=r(il);Bc=a(jb,"Conversational, only cell selection questions"),jb.forEach(t),Ni.forEach(t),Rc=h(Di),Wa=n(Di,"TR",{});var Oi=r(Wa);ll=n(Oi,"TD",{});var $b=r(ll);Gc=a($b,"Weak supervision for aggregation"),$b.forEach(t),Vc=h(Oi),dl=n(Oi,"TD",{});var Eb=r(dl);Kc=a(Eb,"WTQ"),Eb.forEach(t),Yc=h(Oi),pl=n(Oi,"TD",{});var Fb=r(pl);Jc=a(Fb,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Fb.forEach(t),Oi.forEach(t),Xc=h(Di),Ha=n(Di,"TR",{});var Li=r(Ha);cl=n(Li,"TD",{});var Ab=r(cl);Zc=a(Ab,"Strong supervision for aggregation"),Ab.forEach(t),eh=h(Li),hl=n(Li,"TD",{});var xb=r(hl);th=a(xb,"WikiSQL-supervised"),xb.forEach(t),sh=h(Li),ul=n(Li,"TD",{});var zb=r(ul);ah=a(zb,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),zb.forEach(t),Li.forEach(t),Di.forEach(t),Vp.forEach(t),op=h(i),q(bo.$$.fragment,i),np=h(i),vo=n(i,"P",{});var Kp=r(vo);oh=a(Kp,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),bn=n(Kp,"A",{href:!0,rel:!0});var Cb=r(bn);nh=a(Cb,"here"),Cb.forEach(t),rh=a(Kp," for more info."),Kp.forEach(t),rp=h(i),wo=n(i,"P",{});var Yp=r(wo);ih=a(Yp,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),vn=n(Yp,"A",{href:!0,rel:!0});var Mb=r(vn);lh=a(Mb,"here"),Mb.forEach(t),dh=a(Yp,"."),Yp.forEach(t),ip=h(i),Br=n(i,"P",{});var Sb=r(Br);ml=n(Sb,"STRONG",{});var Pb=r(ml);ph=a(Pb,"STEP 2: Prepare your data in the SQA format"),Pb.forEach(t),Sb.forEach(t),lp=h(i),ko=n(i,"P",{});var Jp=r(ko);ch=a(Jp,"Second, no matter what you picked above, you should prepare your dataset in the "),wn=n(Jp,"A",{href:!0,rel:!0});var Db=r(wn);hh=a(Db,"SQA"),Db.forEach(t),uh=a(Jp," format. This format is a TSV/CSV file with the following columns:"),Jp.forEach(t),dp=h(i),We=n(i,"UL",{});var at=r(We);Rr=n(at,"LI",{});var AT=r(Rr);fl=n(AT,"CODE",{});var Nb=r(fl);mh=a(Nb,"id"),Nb.forEach(t),fh=a(AT,": optional, id of the table-question pair, for bookkeeping purposes."),AT.forEach(t),gh=h(at),Gr=n(at,"LI",{});var xT=r(Gr);gl=n(xT,"CODE",{});var Ob=r(gl);_h=a(Ob,"annotator"),Ob.forEach(t),Th=a(xT,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),xT.forEach(t),bh=h(at),Vr=n(at,"LI",{});var zT=r(Vr);_l=n(zT,"CODE",{});var Lb=r(_l);vh=a(Lb,"position"),Lb.forEach(t),wh=a(zT,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),zT.forEach(t),kh=h(at),Kr=n(at,"LI",{});var CT=r(Kr);Tl=n(CT,"CODE",{});var Qb=r(Tl);yh=a(Qb,"question"),Qb.forEach(t),qh=a(CT,": string"),CT.forEach(t),jh=h(at),Yr=n(at,"LI",{});var MT=r(Yr);bl=n(MT,"CODE",{});var Ib=r(bl);$h=a(Ib,"table_file"),Ib.forEach(t),Eh=a(MT,": string, name of a csv file containing the tabular data"),MT.forEach(t),Fh=h(at),Jr=n(at,"LI",{});var ST=r(Jr);vl=n(ST,"CODE",{});var Wb=r(vl);Ah=a(Wb,"answer_coordinates"),Wb.forEach(t),xh=a(ST,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),ST.forEach(t),zh=h(at),Xr=n(at,"LI",{});var PT=r(Xr);wl=n(PT,"CODE",{});var Hb=r(wl);Ch=a(Hb,"answer_text"),Hb.forEach(t),Mh=a(PT,": list of one or more strings (each string being a cell value that is part of the answer)"),PT.forEach(t),Sh=h(at),Zr=n(at,"LI",{});var DT=r(Zr);kl=n(DT,"CODE",{});var Ub=r(kl);Ph=a(Ub,"aggregation_label"),Ub.forEach(t),Dh=a(DT,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),DT.forEach(t),Nh=h(at),ei=n(at,"LI",{});var NT=r(ei);yl=n(NT,"CODE",{});var Bb=r(yl);Oh=a(Bb,"float_answer"),Bb.forEach(t),Lh=a(NT,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),NT.forEach(t),at.forEach(t),pp=h(i),bt=n(i,"P",{});var $s=r(bt);Qh=a($s,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),kn=n($s,"A",{href:!0,rel:!0});var Rb=r(kn);Ih=a(Rb,"here"),Rb.forEach(t),Wh=a($s,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),yn=n($s,"A",{href:!0,rel:!0});var Gb=r(yn);Hh=a(Gb,"here"),Gb.forEach(t),Uh=a($s,". Interestingly, these conversion scripts are not perfect (the "),ql=n($s,"CODE",{});var Vb=r(ql);Bh=a(Vb,"answer_coordinates"),Vb.forEach(t),Rh=a($s," and "),jl=n($s,"CODE",{});var Kb=r(jl);Gh=a(Kb,"float_answer"),Kb.forEach(t),Vh=a($s," fields are populated based on the "),$l=n($s,"CODE",{});var Yb=r($l);Kh=a(Yb,"answer_text"),Yb.forEach(t),Yh=a($s,"), meaning that WTQ and WikiSQL results could actually be improved."),$s.forEach(t),cp=h(i),ti=n(i,"P",{});var Jb=r(ti);El=n(Jb,"STRONG",{});var Xb=r(El);Jh=a(Xb,"STEP 3: Convert your data into tensors using TapasTokenizer"),Xb.forEach(t),Jb.forEach(t),hp=h(i),q(yo.$$.fragment,i),up=h(i),Pe=n(i,"P",{});var Je=r(Pe);Xh=a(Je,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),Fl=n(Je,"STRONG",{});var Zb=r(Fl);Zh=a(Zb,"not conversational"),Zb.forEach(t),eu=a(Je,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),Al=n(Je,"CODE",{});var ev=r(Al);tu=a(ev,"queries"),ev.forEach(t),su=a(Je,", "),xl=n(Je,"CODE",{});var tv=r(xl);au=a(tv,"answer_coordinates"),tv.forEach(t),ou=a(Je," and "),zl=n(Je,"CODE",{});var sv=r(zl);nu=a(sv,"answer_text"),sv.forEach(t),ru=a(Je," per table (in the order of their "),Cl=n(Je,"CODE",{});var av=r(Cl);iu=a(av,"position"),av.forEach(t),lu=a(Je,`
index) and batch encode each table with its questions. This will make sure that the `),Ml=n(Je,"CODE",{});var ov=r(Ml);du=a(ov,"prev_labels"),ov.forEach(t),pu=a(Je," token types (see docs of "),si=n(Je,"A",{href:!0});var nv=r(si);cu=a(nv,"TapasTokenizer"),nv.forEach(t),hu=a(Je,") are set correctly. See "),qn=n(Je,"A",{href:!0,rel:!0});var rv=r(qn);uu=a(rv,"this notebook"),rv.forEach(t),mu=a(Je," for more info. See "),jn=n(Je,"A",{href:!0,rel:!0});var iv=r(jn);fu=a(iv,"this notebook"),iv.forEach(t),gu=a(Je," for more info regarding using the TensorFlow model."),Je.forEach(t),mp=h(i),ai=n(i,"P",{});var lv=r(ai);_u=a(lv,"**STEP 4: Train (fine-tune) the model"),lv.forEach(t),fp=h(i),q(qo.$$.fragment,i),gp=h(i),Ua=n(i,"H2",{class:!0});var Xp=r(Ua);jo=n(Xp,"A",{id:!0,class:!0,href:!0});var dv=r(jo);Sl=n(dv,"SPAN",{});var pv=r(Sl);q($n.$$.fragment,pv),pv.forEach(t),dv.forEach(t),Tu=h(Xp),Pl=n(Xp,"SPAN",{});var cv=r(Pl);bu=a(cv,"Usage: inference"),cv.forEach(t),Xp.forEach(t),_p=h(i),q($o.$$.fragment,i),Tp=h(i),vt=n(i,"P",{});var Es=r(vt);vu=a(Es,"In case of a conversational set-up, then each table-question pair must be provided "),Dl=n(Es,"STRONG",{});var hv=r(Dl);wu=a(hv,"sequentially"),hv.forEach(t),ku=a(Es," to the model, such that the "),Nl=n(Es,"CODE",{});var uv=r(Nl);yu=a(uv,"prev_labels"),uv.forEach(t),qu=a(Es," token types can be overwritten by the predicted "),Ol=n(Es,"CODE",{});var mv=r(Ol);ju=a(mv,"labels"),mv.forEach(t),$u=a(Es," of the previous table-question pair. Again, more info can be found in "),En=n(Es,"A",{href:!0,rel:!0});var fv=r(En);Eu=a(fv,"this notebook"),fv.forEach(t),Fu=a(Es," (for PyTorch) and "),Fn=n(Es,"A",{href:!0,rel:!0});var gv=r(Fn);Au=a(gv,"this notebook"),gv.forEach(t),xu=a(Es," (for TensorFlow)."),Es.forEach(t),bp=h(i),Ba=n(i,"H2",{class:!0});var Zp=r(Ba);Eo=n(Zp,"A",{id:!0,class:!0,href:!0});var _v=r(Eo);Ll=n(_v,"SPAN",{});var Tv=r(Ll);q(An.$$.fragment,Tv),Tv.forEach(t),_v.forEach(t),zu=h(Zp),Ql=n(Zp,"SPAN",{});var bv=r(Ql);Cu=a(bv,"TAPAS specific outputs"),bv.forEach(t),Zp.forEach(t),vp=h(i),Ra=n(i,"DIV",{class:!0});var ec=r(Ra);q(xn.$$.fragment,ec),Mu=h(ec),zn=n(ec,"P",{});var tc=r(zn);Su=a(tc,"Output type of "),oi=n(tc,"A",{href:!0});var vv=r(oi);Pu=a(vv,"TapasForQuestionAnswering"),vv.forEach(t),Du=a(tc,"."),tc.forEach(t),ec.forEach(t),wp=h(i),Ga=n(i,"H2",{class:!0});var sc=r(Ga);Fo=n(sc,"A",{id:!0,class:!0,href:!0});var wv=r(Fo);Il=n(wv,"SPAN",{});var kv=r(Il);q(Cn.$$.fragment,kv),kv.forEach(t),wv.forEach(t),Nu=h(sc),Wl=n(sc,"SPAN",{});var yv=r(Wl);Ou=a(yv,"TapasConfig"),yv.forEach(t),sc.forEach(t),kp=h(i),Ht=n(i,"DIV",{class:!0});var va=r(Ht);q(Mn.$$.fragment,va),Lu=h(va),Va=n(va,"P",{});var Qi=r(Va);Qu=a(Qi,"This is the configuration class to store the configuration of a "),ni=n(Qi,"A",{href:!0});var qv=r(ni);Iu=a(qv,"TapasModel"),qv.forEach(t),Wu=a(Qi,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS
`),Sn=n(Qi,"A",{href:!0,rel:!0});var jv=r(Sn);Hu=a(jv,"google/tapas-base-finetuned-sqa"),jv.forEach(t),Uu=a(Qi," architecture."),Qi.forEach(t),Bu=h(va),Ka=n(va,"P",{});var Ii=r(Ka);Ru=a(Ii,"Configuration objects inherit from "),Hl=n(Ii,"CODE",{});var $v=r(Hl);Gu=a($v,"PreTrainedConfig"),$v.forEach(t),Vu=a(Ii,` and can be used to control the model outputs. Read the
documentation from `),ri=n(Ii,"A",{href:!0});var Ev=r(ri);Ku=a(Ev,"PretrainedConfig"),Ev.forEach(t),Yu=a(Ii," for more information."),Ii.forEach(t),Ju=h(va),Pn=n(va,"P",{});var ac=r(Pn);Xu=a(ac,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Dn=n(ac,"A",{href:!0,rel:!0});var Fv=r(Dn);Zu=a(Fv,"https://github.com/google-research/tapas/tree/master"),Fv.forEach(t),em=a(ac,"."),ac.forEach(t),tm=h(va),q(Ao.$$.fragment,va),va.forEach(t),yp=h(i),Ya=n(i,"H2",{class:!0});var oc=r(Ya);xo=n(oc,"A",{id:!0,class:!0,href:!0});var Av=r(xo);Ul=n(Av,"SPAN",{});var xv=r(Ul);q(Nn.$$.fragment,xv),xv.forEach(t),Av.forEach(t),sm=h(oc),Bl=n(oc,"SPAN",{});var zv=r(Bl);am=a(zv,"TapasTokenizer"),zv.forEach(t),oc.forEach(t),qp=h(i),Ge=n(i,"DIV",{class:!0});var wt=r(Ge);q(On.$$.fragment,wt),om=h(wt),Rl=n(wt,"P",{});var Cv=r(Rl);nm=a(Cv,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),Cv.forEach(t),rm=h(wt),Qe=n(wt,"P",{});var Xe=r(Qe);im=a(Xe,"This tokenizer inherits from "),ii=n(Xe,"A",{href:!0});var Mv=r(ii);lm=a(Mv,"PreTrainedTokenizer"),Mv.forEach(t),dm=a(Xe,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),li=n(Xe,"A",{href:!0});var Sv=r(li);pm=a(Sv,"TapasTokenizer"),Sv.forEach(t),cm=a(Xe,` creates several token type ids to
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Gl=n(Xe,"CODE",{});var Pv=r(Gl);hm=a(Pv,"segment_ids"),Pv.forEach(t),um=a(Xe,`,
`),Vl=n(Xe,"CODE",{});var Dv=r(Vl);mm=a(Dv,"column_ids"),Dv.forEach(t),fm=a(Xe,", "),Kl=n(Xe,"CODE",{});var Nv=r(Kl);gm=a(Nv,"row_ids"),Nv.forEach(t),_m=a(Xe,", "),Yl=n(Xe,"CODE",{});var Ov=r(Yl);Tm=a(Ov,"prev_labels"),Ov.forEach(t),bm=a(Xe,", "),Jl=n(Xe,"CODE",{});var Lv=r(Jl);vm=a(Lv,"column_ranks"),Lv.forEach(t),wm=a(Xe,", "),Xl=n(Xe,"CODE",{});var Qv=r(Xl);km=a(Qv,"inv_column_ranks"),Qv.forEach(t),ym=a(Xe," and "),Zl=n(Xe,"CODE",{});var Iv=r(Zl);qm=a(Iv,"numeric_relations"),Iv.forEach(t),jm=a(Xe,":"),Xe.forEach(t),$m=h(wt),it=n(wt,"UL",{});var Yt=r(it);ed=n(Yt,"LI",{});var Wv=r(ed);Em=a(Wv,`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),Wv.forEach(t),Fm=h(Yt),td=n(Yt,"LI",{});var Hv=r(td);Am=a(Hv,`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),Hv.forEach(t),xm=h(Yt),sd=n(Yt,"LI",{});var Uv=r(sd);zm=a(Uv,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),Uv.forEach(t),Cm=h(Yt),ad=n(Yt,"LI",{});var Bv=r(ad);Mm=a(Bv,`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),Bv.forEach(t),Sm=h(Yt),od=n(Yt,"LI",{});var Rv=r(od);Pm=a(Rv,`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),Rv.forEach(t),Dm=h(Yt),nd=n(Yt,"LI",{});var Gv=r(nd);Nm=a(Gv,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),Gv.forEach(t),Om=h(Yt),rd=n(Yt,"LI",{});var Vv=r(rd);Lm=a(Vv,`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),Vv.forEach(t),Yt.forEach(t),Qm=h(wt),di=n(wt,"P",{});var OT=r(di);pi=n(OT,"A",{href:!0});var Kv=r(pi);Im=a(Kv,"TapasTokenizer"),Kv.forEach(t),Wm=a(OT,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),OT.forEach(t),Hm=h(wt),zo=n(wt,"DIV",{class:!0});var nc=r(zo);q(Ln.$$.fragment,nc),Um=h(nc),id=n(nc,"P",{});var Yv=r(id);Bm=a(Yv,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Yv.forEach(t),nc.forEach(t),Rm=h(wt),ba=n(wt,"DIV",{class:!0});var Wi=r(ba);q(Qn.$$.fragment,Wi),Gm=h(Wi),In=n(Wi,"P",{});var rc=r(In);Vm=a(rc,"Converts logits of "),ci=n(rc,"A",{href:!0});var Jv=r(ci);Km=a(Jv,"TapasForQuestionAnswering"),Jv.forEach(t),Ym=a(rc,` to actual predicted answer coordinates and optional
...
`),Hn=n(ic,"A",{href:!0,rel:!0});var Xv=r(Hn);Zm=a(Xv,"here"),Xv.forEach(t),ef=a(ic,"."),ic.forEach(t),Wi.forEach(t),tf=h(wt),hi=n(wt,"DIV",{class:!0});var Zv=r(hi);q(Un.$$.fragment,Zv),Zv.forEach(t),wt.forEach(t),jp=h(i),Ja=n(i,"H2",{class:!0});var lc=r(Ja);Co=n(lc,"A",{id:!0,class:!0,href:!0});var ew=r(Co);ld=n(ew,"SPAN",{});var tw=r(ld);q(Bn.$$.fragment,tw),tw.forEach(t),ew.forEach(t),sf=h(lc),dd=n(lc,"SPAN",{});var sw=r(dd);af=a(sw,"TapasModel"),sw.forEach(t),lc.forEach(t),$p=h(i),lt=n(i,"DIV",{class:!0});var Fs=r(lt);q(Rn.$$.fragment,Fs),of=h(Fs),Gn=n(Fs,"P",{});var dc=r(Gn);nf=a(dc,`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ui=n(dc,"A",{href:!0});var aw=r(ui);rf=a(aw,"PreTrainedModel"),aw.forEach(t),lf=a(dc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pc.forEach(t),uf=h(Fs),Yn=n(Fs,"P",{});var cc=r(Yn);mf=a(cc,"This class is a small change compared to "),mi=n(cc,"A",{href:!0});var nw=r(mi);ff=a(nw,"BertModel"),nw.forEach(t),gf=a(cc,", taking into account the additional token type ids."),cc.forEach(t),_f=h(Fs),Jn=n(Fs,"P",{});var hc=r(Jn);Tf=a(hc,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),hc.forEach(t),wf=h(Fs),_s=n(Fs,"DIV",{class:!0});var dn=r(_s);q(Zn.$$.fragment,dn),kf=h(dn),Xa=n(dn,"P",{});var Hi=r(Xa);yf=a(Hi,"The "),fi=n(Hi,"A",{href:!0});var iw=r(fi);qf=a(iw,"TapasModel"),iw.forEach(t),jf=a(Hi," forward method, overrides the "),pd=n(Hi,"CODE",{});var lw=r(pd);$f=a(lw,"__call__"),lw.forEach(t),Ef=a(Hi," special method."),Hi.forEach(t),Ff=h(dn),q(Mo.$$.fragment,dn),Af=h(dn),q(So.$$.fragment,dn),dn.forEach(t),Fs.forEach(t),Ep=h(i),Za=n(i,"H2",{class:!0});var uc=r(Za);Po=n(uc,"A",{id:!0,class:!0,href:!0});var dw=r(Po);cd=n(dw,"SPAN",{});var pw=r(cd);q(er.$$.fragment,pw),pw.forEach(t),dw.forEach(t),xf=h(uc),hd=n(uc,"SPAN",{});var cw=r(hd);zf=a(cw,"TapasForMaskedLM"),cw.forEach(t),uc.forEach(t),Fp=h(i),ps=n(i,"DIV",{class:!0});var pn=r(ps);q(tr.$$.fragment,pn),Cf=h(pn),eo=n(pn,"P",{});var Ui=r(eo);Mf=a(Ui,"Tapas Model with a "),ud=n(Ui,"CODE",{});var hw=r(ud);Sf=a(hw,"language modeling"),hw.forEach(t),Pf=a(Ui,` head on top.
This model inherits from `),gi=n(Ui,"A",{href:!0});var uw=r(gi);Df=a(uw,"PreTrainedModel"),uw.forEach(t),Nf=a(Ui,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ui.forEach(t),Of=h(pn),sr=n(pn,"P",{});var mc=r(sr);Lf=a(mc,"This model is also a PyTorch "),ar=n(mc,"A",{href:!0,rel:!0});var mw=r(ar);Qf=a(mw,"torch.nn.Module"),mw.forEach(t),If=a(mc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mc.forEach(t),Wf=h(pn),Ts=n(pn,"DIV",{class:!0});var cn=r(Ts);q(or.$$.fragment,cn),Hf=h(cn),to=n(cn,"P",{});var Bi=r(to);Uf=a(Bi,"The "),_i=n(Bi,"A",{href:!0});var fw=r(_i);Bf=a(fw,"TapasForMaskedLM"),fw.forEach(t),Rf=a(Bi," forward method, overrides the "),md=n(Bi,"CODE",{});var gw=r(md);Gf=a(gw,"__call__"),gw.forEach(t),Vf=a(Bi," special method."),Bi.forEach(t),Kf=h(cn),q(Do.$$.fragment,cn),Yf=h(cn),q(No.$$.fragment,cn),cn.forEach(t),pn.forEach(t),Ap=h(i),so=n(i,"H2",{class:!0});var fc=r(so);Oo=n(fc,"A",{id:!0,class:!0,href:!0});var _w=r(Oo);fd=n(_w,"SPAN",{});var Tw=r(fd);q(nr.$$.fragment,Tw),Tw.forEach(t),_w.forEach(t),Jf=h(fc),gd=n(fc,"SPAN",{});var bw=r(gd);Xf=a(bw,"TapasForSequenceClassification"),bw.forEach(t),fc.forEach(t),xp=h(i),Ut=n(i,"DIV",{class:!0});var wa=r(Ut);q(rr.$$.fragment,wa),Zf=h(wa),_d=n(wa,"P",{});var vw=r(_d);eg=a(vw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_c.forEach(t),dg=h(wa),bs=n(wa,"DIV",{class:!0});var hn=r(bs);q(pr.$$.fragment,hn),pg=h(hn),ao=n(hn,"P",{});var Ri=r(ao);cg=a(Ri,"The "),bi=n(Ri,"A",{href:!0});var yw=r(bi);hg=a(yw,"TapasForSequenceClassification"),yw.forEach(t),ug=a(Ri," forward method, overrides the "),Td=n(Ri,"CODE",{});var qw=r(Td);mg=a(qw,"__call__"),qw.forEach(t),fg=a(Ri," special method."),Ri.forEach(t),gg=h(hn),q(Lo.$$.fragment,hn),_g=h(hn),q(Qo.$$.fragment,hn),hn.forEach(t),wa.forEach(t),zp=h(i),oo=n(i,"H2",{class:!0});var Tc=r(oo);Io=n(Tc,"A",{id:!0,class:!0,href:!0});var jw=r(Io);bd=n(jw,"SPAN",{});var $w=r(bd);q(cr.$$.fragment,$w),$w.forEach(t),jw.forEach(t),Tg=h(Tc),vd=n(Tc,"SPAN",{});var Ew=r(vd);bg=a(Ew,"TapasForQuestionAnswering"),Ew.forEach(t),Tc.forEach(t),Cp=h(i),Bt=n(i,"DIV",{class:!0});var ka=r(Bt);q(hr.$$.fragment,ka),vg=h(ka),no=n(ka,"P",{});var Gi=r(no);wg=a(Gi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),wd=n(Gi,"CODE",{});var Fw=r(wd);kg=a(Fw,"logits"),Fw.forEach(t),yg=a(Gi," and optional "),kd=n(Gi,"CODE",{});var Aw=r(kd);qg=a(Aw,"logits_aggregation"),Aw.forEach(t),jg=a(Gi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Gi.forEach(t),$g=h(ka),ur=n(ka,"P",{});var bc=r(ur);Eg=a(bc,"This model inherits from "),vi=n(bc,"A",{href:!0});var xw=r(vi);Fg=a(xw,"PreTrainedModel"),xw.forEach(t),Ag=a(bc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bc.forEach(t),xg=h(ka),mr=n(ka,"P",{});var vc=r(mr);zg=a(vc,"This model is also a PyTorch "),fr=n(vc,"A",{href:!0,rel:!0});var zw=r(fr);Cg=a(zw,"torch.nn.Module"),zw.forEach(t),Mg=a(vc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vc.forEach(t),Sg=h(ka),vs=n(ka,"DIV",{class:!0});var un=r(vs);q(gr.$$.fragment,un),Pg=h(un),ro=n(un,"P",{});var Vi=r(ro);Dg=a(Vi,"The "),wi=n(Vi,"A",{href:!0});var Cw=r(wi);Ng=a(Cw,"TapasForQuestionAnswering"),Cw.forEach(t),Og=a(Vi," forward method, overrides the "),yd=n(Vi,"CODE",{});var Mw=r(yd);Lg=a(Mw,"__call__"),Mw.forEach(t),Qg=a(Vi," special method."),Vi.forEach(t),Ig=h(un),q(Wo.$$.fragment,un),Wg=h(un),q(Ho.$$.fragment,un),un.forEach(t),ka.forEach(t),Mp=h(i),io=n(i,"H2",{class:!0});var wc=r(io);Uo=n(wc,"A",{id:!0,class:!0,href:!0});var Sw=r(Uo);qd=n(Sw,"SPAN",{});var Pw=r(qd);q(_r.$$.fragment,Pw),Pw.forEach(t),Sw.forEach(t),Hg=h(wc),jd=n(wc,"SPAN",{});var Dw=r(jd);Ug=a(Dw,"TFTapasModel"),Dw.forEach(t),wc.forEach(t),Sp=h(i),dt=n(i,"DIV",{class:!0});var As=r(dt);q(Tr.$$.fragment,As),Bg=h(As),$d=n(As,"P",{});var Nw=r($d);Rg=a(Nw,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Nw.forEach(t),Gg=h(As),br=n(As,"P",{});var kc=r(br);Vg=a(kc,"This model inherits from "),ki=n(kc,"A",{href:!0});var Ow=r(ki);Kg=a(Ow,"TFPreTrainedModel"),Ow.forEach(t),Yg=a(kc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc.forEach(t),t_=h(As),q(Bo.$$.fragment,As),s_=h(As),ws=n(As,"DIV",{class:!0});var mn=r(ws);q(kr.$$.fragment,mn),a_=h(mn),lo=n(mn,"P",{});var Ki=r(lo);o_=a(Ki,"The "),yi=n(Ki,"A",{href:!0});var Qw=r(yi);n_=a(Qw,"TFTapasModel"),Qw.forEach(t),r_=a(Ki," forward method, overrides the "),Ed=n(Ki,"CODE",{});var Iw=r(Ed);i_=a(Iw,"__call__"),Iw.forEach(t),l_=a(Ki," special method."),Ki.forEach(t),d_=h(mn),q(Ro.$$.fragment,mn),p_=h(mn),q(Go.$$.fragment,mn),mn.forEach(t),As.forEach(t),Pp=h(i),po=n(i,"H2",{class:!0});var qc=r(po);Vo=n(qc,"A",{id:!0,class:!0,href:!0});var Ww=r(Vo);Fd=n(Ww,"SPAN",{});var Hw=r(Fd);q(yr.$$.fragment,Hw),Hw.forEach(t),Ww.forEach(t),c_=h(qc),Ad=n(qc,"SPAN",{});var Uw=r(Ad);h_=a(Uw,"TFTapasForMaskedLM"),Uw.forEach(t),qc.forEach(t),Dp=h(i),pt=n(i,"DIV",{class:!0});var xs=r(pt);q(qr.$$.fragment,xs),u_=h(xs),jr=n(xs,"P",{});var jc=r(jr);m_=a(jc,"Tapas Model with a "),xd=n(jc,"CODE",{});var Bw=r(xd);f_=a(Bw,"language modeling"),Bw.forEach(t),g_=a(jc," head on top."),jc.forEach(t),__=h(xs),$r=n(xs,"P",{});var $c=r($r);T_=a($c,"This model inherits from "),qi=n($c,"A",{href:!0});var Rw=r(qi);b_=a(Rw,"TFPreTrainedModel"),Rw.forEach(t),v_=a($c,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$c.forEach(t),w_=h(xs),Er=n(xs,"P",{});var Ec=r(Er);k_=a(Ec,"This model is also a "),Fr=n(Ec,"A",{href:!0,rel:!0});var Gw=r(Fr);y_=a(Gw,"tf.keras.Model"),Gw.forEach(t),q_=a(Ec,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ec.forEach(t),j_=h(xs),q(Ko.$$.fragment,xs),$_=h(xs),ks=n(xs,"DIV",{class:!0});var fn=r(ks);q(Ar.$$.fragment,fn),E_=h(fn),co=n(fn,"P",{});var Yi=r(co);F_=a(Yi,"The "),ji=n(Yi,"A",{href:!0});var Vw=r(ji);A_=a(Vw,"TFTapasForMaskedLM"),Vw.forEach(t),x_=a(Yi," forward method, overrides the "),zd=n(Yi,"CODE",{});var Kw=r(zd);z_=a(Kw,"__call__"),Kw.forEach(t),C_=a(Yi," special method."),Yi.forEach(t),M_=h(fn),q(Yo.$$.fragment,fn),S_=h(fn),q(Jo.$$.fragment,fn),fn.forEach(t),xs.forEach(t),Np=h(i),ho=n(i,"H2",{class:!0});var Fc=r(ho);Xo=n(Fc,"A",{id:!0,class:!0,href:!0});var Yw=r(Xo);Cd=n(Yw,"SPAN",{});var Jw=r(Cd);q(xr.$$.fragment,Jw),Jw.forEach(t),Yw.forEach(t),P_=h(Fc),Md=n(Fc,"SPAN",{});var Xw=r(Md);D_=a(Xw,"TFTapasForSequenceClassification"),Xw.forEach(t),Fc.forEach(t),Op=h(i),ct=n(i,"DIV",{class:!0});var zs=r(ct);q(zr.$$.fragment,zs),N_=h(zs),Sd=n(zs,"P",{});var Zw=r(Sd);O_=a(Zw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),H_=h(zs),Mr=n(zs,"P",{});var xc=r(Mr);U_=a(xc,"This model is also a "),Sr=n(xc,"A",{href:!0,rel:!0});var tk=r(Sr);B_=a(tk,"tf.keras.Model"),tk.forEach(t),R_=a(xc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xc.forEach(t),G_=h(zs),q(Zo.$$.fragment,zs),V_=h(zs),ys=n(zs,"DIV",{class:!0});var gn=r(ys);q(Pr.$$.fragment,gn),K_=h(gn),uo=n(gn,"P",{});var Ji=r(uo);Y_=a(Ji,"The "),Ei=n(Ji,"A",{href:!0});var sk=r(Ei);J_=a(sk,"TFTapasForSequenceClassification"),sk.forEach(t),X_=a(Ji," forward method, overrides the "),Pd=n(Ji,"CODE",{});var ak=r(Pd);Z_=a(ak,"__call__"),ak.forEach(t),eT=a(Ji," special method."),Ji.forEach(t),tT=h(gn),q(en.$$.fragment,gn),sT=h(gn),q(tn.$$.fragment,gn),gn.forEach(t),zs.forEach(t),Lp=h(i),mo=n(i,"H2",{class:!0});var zc=r(mo);sn=n(zc,"A",{id:!0,class:!0,href:!0});var ok=r(sn);Dd=n(ok,"SPAN",{});var nk=r(Dd);q(Dr.$$.fragment,nk),nk.forEach(t),ok.forEach(t),aT=h(zc),Nd=n(zc,"SPAN",{});var rk=r(Nd);oT=a(rk,"TFTapasForQuestionAnswering"),rk.forEach(t),zc.forEach(t),Qp=h(i),ht=n(i,"DIV",{class:!0});var Cs=r(ht);q(Nr.$$.fragment,Cs),nT=h(Cs),fo=n(Cs,"P",{});var Xi=r(fo);rT=a(Xi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
SQA, WTQ or WikiSQL-supervised tasks.`),Xi.forEach(t),cT=h(Cs),Or=n(Cs,"P",{});var Cc=r(Or);hT=a(Cc,"This model inherits from "),Fi=n(Cc,"A",{href:!0});var dk=r(Fi);uT=a(dk,"TFPreTrainedModel"),dk.forEach(t),mT=a(Cc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mc.forEach(t),bT=h(Cs),q(an.$$.fragment,Cs),vT=h(Cs),qs=n(Cs,"DIV",{class:!0});var _n=r(qs);q(Ir.$$.fragment,_n),wT=h(_n),go=n(_n,"P",{});var Zi=r(go);kT=a(Zi,"The "),Ai=n(Zi,"A",{href:!0});var ck=r(Ai);yT=a(ck,"TFTapasForQuestionAnswering"),ck.forEach(t),qT=a(Zi," forward method, overrides the "),Qd=n(Zi,"CODE",{});var hk=r(Qd);jT=a(hk,"__call__"),hk.forEach(t),$T=a(Zi," special method."),Zi.forEach(t),ET=h(_n),q(on.$$.fragment,_n),FT=h(_n),q(nn.$$.fragment,_n),_n.forEach(t),Cs.forEach(t),this.h()},h(){f(l,"name","hf:doc:metadata"),f(l,"content",JSON.stringify(ay)),f(u,"id","tapas"),f(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(u,"href","#tapas"),f(d,"class","relative group"),f(U,"id","overview"),f(U,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(U,"href","#overview"),f(x,"class","relative group"),f(M,"href","https://www.aclweb.org/anthology/2020.acl-main.398"),f(M,"rel","nofollow"),f(P,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),f(P,"rel","nofollow"),f(Y,"href","https://github.com/ppasupat/WikiTableQuestions"),f(Y,"rel","nofollow"),f(ne,"href","https://github.com/salesforce/WikiSQL"),f(ne,"rel","nofollow"),f(ke,"href","https://github.com/wenhuchen/Table-Fact-Checking"),f(ke,"rel","nofollow"),f(Ze,"href","https://www.aclweb.org/anthology/2020.findings-emnlp.27/"),f(Ze,"rel","nofollow"),_k(ft.src,ca="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/tapas_architecture.png")||f(ft,"src",ca),f(ft,"alt","drawing"),f(ft,"width","600"),f(tt,"href","https://ai.googleblog.com/2020/04/using-neural-networks-to-find-answers.html"),f(kt,"href","https://huggingface.co/nielsr"),f(kt,"rel","nofollow"),f(qt,"href","https://huggingface.co/kamalkraj"),f(qt,"rel","nofollow"),f($t,"href","https://github.com/google-research/tapas"),f($t,"rel","nofollow"),f(Vt,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasConfig"),f(Ct,"href","https://huggingface.co/models?search=tapas"),f(Ct,"rel","nofollow"),f(Ot,"href","https://github.com/google-research/tapas%3E"),f(Ot,"rel","nofollow"),f(st,"id","usage-finetuning"),f(st,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(st,"href","#usage-finetuning"),f(It,"class","relative group"),f(us,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(fs,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(bn,"href","https://github.com/google-research/tapas/issues/91#issuecomment-735719340"),f(bn,"rel","nofollow"),f(vn,"href","https://huggingface.co/models?search=tapas"),f(vn,"rel","nofollow"),f(wn,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),f(wn,"rel","nofollow"),f(kn,"href","https://github.com/google-research/tapas/issues/50#issuecomment-705465960"),f(kn,"rel","nofollow"),f(yn,"href","https://github.com/NielsRogge/tapas_utils"),f(yn,"rel","nofollow"),f(si,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer"),f(qn,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),f(qn,"rel","nofollow"),f(jn,"href","https://github.com/kamalkraj/Tapas-Tutorial/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),f(jn,"rel","nofollow"),f(jo,"id","usage-inference"),f(jo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(jo,"href","#usage-inference"),f(Ua,"class","relative group"),f(En,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),f(En,"rel","nofollow"),f(Fn,"href","https://github.com/kamalkraj/Tapas-Tutorial/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),f(Fn,"rel","nofollow"),f(Eo,"id","transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"),f(Eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Eo,"href","#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"),f(Ba,"class","relative group"),f(oi,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(Ra,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Fo,"id","transformers.TapasConfig"),f(Fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Fo,"href","#transformers.TapasConfig"),f(Ga,"class","relative group"),f(ni,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasModel"),f(Sn,"href","https://huggingface.co/google/tapas-base-finetuned-sqa"),f(Sn,"rel","nofollow"),f(ri,"href","/docs/transformers/pr_17686/en/main_classes/configuration#transformers.PretrainedConfig"),f(Dn,"href","https://github.com/google-research/tapas/tree/master"),f(Dn,"rel","nofollow"),f(Ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(xo,"id","transformers.TapasTokenizer"),f(xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(xo,"href","#transformers.TapasTokenizer"),f(Ya,"class","relative group"),f(ii,"href","/docs/transformers/pr_17686/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),f(li,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer"),f(pi,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasTokenizer"),f(zo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ci,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(Hn,"href","https://github.com/google-research/tapas/blob/4908213eb4df7aa988573350278b44c4dbe3f71b/tapas/experiments/prediction_utils.py#L288"),f(Hn,"rel","nofollow"),f(ba,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(hi,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Co,"id","transformers.TapasModel"),f(Co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Co,"href","#transformers.TapasModel"),f(Ja,"class","relative group"),f(ui,"href","/docs/transformers/pr_17686/en/main_classes/model#transformers.PreTrainedModel"),f(Kn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Kn,"rel","nofollow"),f(mi,"href","/docs/transformers/pr_17686/en/model_doc/bert#transformers.BertModel"),f(Xn,"href","https://arxiv.org/abs/1706.03762"),f(Xn,"rel","nofollow"),f(fi,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasModel"),f(_s,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Po,"id","transformers.TapasForMaskedLM"),f(Po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Po,"href","#transformers.TapasForMaskedLM"),f(Za,"class","relative group"),f(gi,"href","/docs/transformers/pr_17686/en/main_classes/model#transformers.PreTrainedModel"),f(ar,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(ar,"rel","nofollow"),f(_i,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForMaskedLM"),f(Ts,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ps,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Oo,"id","transformers.TapasForSequenceClassification"),f(Oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Oo,"href","#transformers.TapasForSequenceClassification"),f(so,"class","relative group"),f(Ti,"href","/docs/transformers/pr_17686/en/main_classes/model#transformers.PreTrainedModel"),f(dr,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(dr,"rel","nofollow"),f(bi,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForSequenceClassification"),f(bs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ut,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Io,"id","transformers.TapasForQuestionAnswering"),f(Io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Io,"href","#transformers.TapasForQuestionAnswering"),f(oo,"class","relative group"),f(vi,"href","/docs/transformers/pr_17686/en/main_classes/model#transformers.PreTrainedModel"),f(fr,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(fr,"rel","nofollow"),f(wi,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(vs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Uo,"id","transformers.TFTapasModel"),f(Uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Uo,"href","#transformers.TFTapasModel"),f(io,"class","relative group"),f(ki,"href","/docs/transformers/pr_17686/en/main_classes/model#transformers.TFPreTrainedModel"),f(wr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(wr,"rel","nofollow"),f(yi,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasModel"),f(ws,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(dt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Vo,"id","transformers.TFTapasForMaskedLM"),f(Vo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Vo,"href","#transformers.TFTapasForMaskedLM"),f(po,"class","relative group"),f(qi,"href","/docs/transformers/pr_17686/en/main_classes/model#transformers.TFPreTrainedModel"),f(Fr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Fr,"rel","nofollow"),f(ji,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasForMaskedLM"),f(ks,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Xo,"id","transformers.TFTapasForSequenceClassification"),f(Xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Xo,"href","#transformers.TFTapasForSequenceClassification"),f(ho,"class","relative group"),f($i,"href","/docs/transformers/pr_17686/en/main_classes/model#transformers.TFPreTrainedModel"),f(Sr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Sr,"rel","nofollow"),f(Ei,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasForSequenceClassification"),f(ys,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(sn,"id","transformers.TFTapasForQuestionAnswering"),f(sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(sn,"href","#transformers.TFTapasForQuestionAnswering"),f(mo,"class","relative group"),f(Fi,"href","/docs/transformers/pr_17686/en/main_classes/model#transformers.TFPreTrainedModel"),f(Qr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Qr,"rel","nofollow"),f(Ai,"href","/docs/transformers/pr_17686/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(qs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,_){e(document.head,l),m(i,b,_),m(i,d,_),e(d,u),e(u,T),j(p,T,null),e(d,g),e(d,A),e(A,k),m(i,N,_),m(i,x,_),e(x,U),e(U,G),j(V,G,null),e(x,B),e(x,K),e(K,re),m(i,W,_),m(i,L,_),e(L,w),e(L,M),e(M,R),e(L,C),m(i,O,_),m(i,ee,_),e(ee,te),m(i,ce,_),m(i,oe,_),e(oe,se),e(se,P),e(P,Q),e(se,H),e(oe,X),e(oe,I),e(I,Y),e(Y,ge),e(I,ue),e(oe,_e),e(oe,me),e(me,ne),e(ne,qe),e(me,ie),m(i,ve,_),m(i,v,_),e(v,D),m(i,be,_),m(i,xe,_),e(xe,we),m(i,le,_),m(i,ze,_),e(ze,Me),e(Me,Z),m(i,de,_),m(i,pe,_),e(pe,De),e(pe,je),e(je,Te),e(pe,Ne),e(pe,ke),e(ke,Ae),e(pe,Oe),e(pe,Ze),e(Ze,Ss),e(pe,Ps),m(i,mt,_),m(i,ft,_),m(i,gt,_),m(i,_t,_),e(_t,Ds),e(_t,tt),e(tt,Ns),e(_t,Os),m(i,Ke,_),m(i,Se,_),e(Se,Ls),e(Se,kt),e(kt,ye),e(Se,yt),e(Se,qt),e(qt,Qs),e(Se,jt),e(Se,$t),e($t,Is),e(Se,Et),m(i,cs,_),m(i,Gt,_),e(Gt,Ft),m(i,hs,_),m(i,Ye,_),e(Ye,$e),e($e,Ws),e($e,At),e(At,ae),e($e,ot),e($e,Vt),e(Vt,Hs),e($e,xt),e($e,Jt),e(Jt,Us),e($e,zt),e($e,Ct),e(Ct,Bs),e($e,Mt),e($e,Xt),e(Xt,Rs),e($e,St),e($e,Zt),e(Zt,Gs),e($e,Pt),e(Ye,Vs),e(Ye,Le),e(Le,Dt),e(Le,es),e(es,Ks),e(Le,Nt),e(Le,ts),e(ts,Ys),e(Le,ss),e(Le,Ue),e(Ue,as),e(Le,Ee),e(Le,os),e(os,nt),e(Le,Js),e(Le,Ot),e(Ot,Lt),e(Le,Xs),e(Ye,Zs),e(Ye,Be),e(Be,ea),e(Be,ns),e(ns,rs),e(Be,et),e(Be,Qt),e(Qt,z),e(Be,J),e(Ye,ya),e(Ye,ta),e(ta,qa),m(i,ha,_),m(i,It,_),e(It,st),e(st,sa),j(rt,sa,null),e(It,ja),e(It,aa),e(aa,$a),m(i,ua,_),m(i,Ie,_),e(Ie,is),e(Ie,us),e(us,Re),e(Ie,Ea),m(i,ma,_),m(i,ms,_),e(ms,oa),e(oa,ls),m(i,fa,_),m(i,fe,_),e(fe,Fa),e(fe,fs),e(fs,Aa),e(fe,xa),m(i,ga,_),m(i,Tt,_),e(Tt,na),e(na,ds),e(Tt,za),e(Tt,Fe),e(Fe,Ca),e(Fe,ra),e(ra,Ma),e(Fe,Sa),e(Tt,Pa),e(Tt,he),e(he,Da),e(he,ia),e(ia,Na),e(he,Oa),m(i,_a,_),m(i,gs,_),e(gs,La),m(i,Ta,_),m(i,Ce,_),e(Ce,la),e(la,Wt),e(Wt,da),e(da,el),e(el,Pc),e(Wt,Dc),e(Wt,tl),e(tl,sl),e(sl,Nc),e(Wt,Oc),e(Wt,al),e(al,ol),e(ol,Lc),e(Ce,Qc),e(Ce,Qa),e(Qa,Ia),e(Ia,nl),e(nl,Ic),e(Ia,Wc),e(Ia,rl),e(rl,Hc),e(Ia,Uc),e(Ia,il),e(il,Bc),e(Qa,Rc),e(Qa,Wa),e(Wa,ll),e(ll,Gc),e(Wa,Vc),e(Wa,dl),e(dl,Kc),e(Wa,Yc),e(Wa,pl),e(pl,Jc),e(Qa,Xc),e(Qa,Ha),e(Ha,cl),e(cl,Zc),e(Ha,eh),e(Ha,hl),e(hl,th),e(Ha,sh),e(Ha,ul),e(ul,ah),m(i,op,_),j(bo,i,_),m(i,np,_),m(i,vo,_),e(vo,oh),e(vo,bn),e(bn,nh),e(vo,rh),m(i,rp,_),m(i,wo,_),e(wo,ih),e(wo,vn),e(vn,lh),e(wo,dh),m(i,ip,_),m(i,Br,_),e(Br,ml),e(ml,ph),m(i,lp,_),m(i,ko,_),e(ko,ch),e(ko,wn),e(wn,hh),e(ko,uh),m(i,dp,_),m(i,We,_),e(We,Rr),e(Rr,fl),e(fl,mh),e(Rr,fh),e(We,gh),e(We,Gr),e(Gr,gl),e(gl,_h),e(Gr,Th),e(We,bh),e(We,Vr),e(Vr,_l),e(_l,vh),e(Vr,wh),e(We,kh),e(We,Kr),e(Kr,Tl),e(Tl,yh),e(Kr,qh),e(We,jh),e(We,Yr),e(Yr,bl),e(bl,$h),e(Yr,Eh),e(We,Fh),e(We,Jr),e(Jr,vl),e(vl,Ah),e(Jr,xh),e(We,zh),e(We,Xr),e(Xr,wl),e(wl,Ch),e(Xr,Mh),e(We,Sh),e(We,Zr),e(Zr,kl),e(kl,Ph),e(Zr,Dh),e(We,Nh),e(We,ei),e(ei,yl),e(yl,Oh),e(ei,Lh),m(i,pp,_),m(i,bt,_),e(bt,Qh),e(bt,kn),e(kn,Ih),e(bt,Wh),e(bt,yn),e(yn,Hh),e(bt,Uh),e(bt,ql),e(ql,Bh),e(bt,Rh),e(bt,jl),e(jl,Gh),e(bt,Vh),e(bt,$l),e($l,Kh),e(bt,Yh),m(i,cp,_),m(i,ti,_),e(ti,El),e(El,Jh),m(i,hp,_),j(yo,i,_),m(i,up,_),m(i,Pe,_),e(Pe,Xh),e(Pe,Fl),e(Fl,Zh),e(Pe,eu),e(Pe,Al),e(Al,tu),e(Pe,su),e(Pe,xl),e(xl,au),e(Pe,ou),e(Pe,zl),e(zl,nu),e(Pe,ru),e(Pe,Cl),e(Cl,iu),e(Pe,lu),e(Pe,Ml),e(Ml,du),e(Pe,pu),e(Pe,si),e(si,cu),e(Pe,hu),e(Pe,qn),e(qn,uu),e(Pe,mu),e(Pe,jn),e(jn,fu),e(Pe,gu),m(i,mp,_),m(i,ai,_),e(ai,_u),m(i,fp,_),j(qo,i,_),m(i,gp,_),m(i,Ua,_),e(Ua,jo),e(jo,Sl),j($n,Sl,null),e(Ua,Tu),e(Ua,Pl),e(Pl,bu),m(i,_p,_),j($o,i,_),m(i,Tp,_),m(i,vt,_),e(vt,vu),e(vt,Dl),e(Dl,wu),e(vt,ku),e(vt,Nl),e(Nl,yu),e(vt,qu),e(vt,Ol),e(Ol,ju),e(vt,$u),e(vt,En),e(En,Eu),e(vt,Fu),e(vt,Fn),e(Fn,Au),e(vt,xu),m(i,bp,_),m(i,Ba,_),e(Ba,Eo),e(Eo,Ll),j(An,Ll,null),e(Ba,zu),e(Ba,Ql),e(Ql,Cu),m(i,vp,_),m(i,Ra,_),j(xn,Ra,null),e(Ra,Mu),e(Ra,zn),e(zn,Su),e(zn,oi),e(oi,Pu),e(zn,Du),m(i,wp,_),m(i,Ga,_),e(Ga,Fo),e(Fo,Il),j(Cn,Il,null),e(Ga,Nu),e(Ga,Wl),e(Wl,Ou),m(i,kp,_),m(i,Ht,_),j(Mn,Ht,null),e(Ht,Lu),e(Ht,Va),e(Va,Qu),e(Va,ni),e(ni,Iu),e(Va,Wu),e(Va,Sn),e(Sn,Hu),e(Va,Uu),e(Ht,Bu),e(Ht,Ka),e(Ka,Ru),e(Ka,Hl),e(Hl,Gu),e(Ka,Vu),e(Ka,ri),e(ri,Ku),e(Ka,Yu),e(Ht,Ju),e(Ht,Pn),e(Pn,Xu),e(Pn,Dn),e(Dn,Zu),e(Pn,em),e(Ht,tm),j(Ao,Ht,null),m(i,yp,_),m(i,Ya,_),e(Ya,xo),e(xo,Ul),j(Nn,Ul,null),e(Ya,sm),e(Ya,Bl),e(Bl,am),m(i,qp,_),m(i,Ge,_),j(On,Ge,null),e(Ge,om),e(Ge,Rl),e(Rl,nm),e(Ge,rm),e(Ge,Qe),e(Qe,im),e(Qe,ii),e(ii,lm),e(Qe,dm),e(Qe,li),e(li,pm),e(Qe,cm),e(Qe,Gl),e(Gl,hm),e(Qe,um),e(Qe,Vl),e(Vl,mm),e(Qe,fm),e(Qe,Kl),e(Kl,gm),e(Qe,_m),e(Qe,Yl),e(Yl,Tm),e(Qe,bm),e(Qe,Jl),e(Jl,vm),e(Qe,wm),e(Qe,Xl),e(Xl,km),e(Qe,ym),e(Qe,Zl),e(Zl,qm),e(Qe,jm),e(Ge,$m),e(Ge,it),e(it,ed),e(ed,Em),e(it,Fm),e(it,td),e(td,Am),e(it,xm),e(it,sd),e(sd,zm),e(it,Cm),e(it,ad),e(ad,Mm),e(it,Sm),e(it,od),e(od,Pm),e(it,Dm),e(it,nd),e(nd,Nm),e(it,Om),e(it,rd),e(rd,Lm),e(Ge,Qm),e(Ge,di),e(di,pi),e(pi,Im),e(di,Wm),e(Ge,Hm),e(Ge,zo),j(Ln,zo,null),e(zo,Um),e(zo,id),e(id,Bm),e(Ge,Rm),e(Ge,ba),j(Qn,ba,null),e(ba,Gm),e(ba,In),e(In,Vm),e(In,ci),e(ci,Km),e(In,Ym),e(ba,Jm),e(ba,Wn),e(Wn,Xm),e(Wn,Hn),e(Hn,Zm),e(Wn,ef),e(Ge,tf),e(Ge,hi),j(Un,hi,null),m(i,jp,_),m(i,Ja,_),e(Ja,Co),e(Co,ld),j(Bn,ld,null),e(Ja,sf),e(Ja,dd),e(dd,af),m(i,$p,_),m(i,lt,_),j(Rn,lt,null),e(lt,of),e(lt,Gn),e(Gn,nf),e(Gn,ui),e(ui,rf),e(Gn,lf),e(lt,df),e(lt,Vn),e(Vn,pf),e(Vn,Kn),e(Kn,cf),e(Vn,hf),e(lt,uf),e(lt,Yn),e(Yn,mf),e(Yn,mi),e(mi,ff),e(Yn,gf),e(lt,_f),e(lt,Jn),e(Jn,Tf),e(Jn,Xn),e(Xn,bf),e(Jn,vf),e(lt,wf),e(lt,_s),j(Zn,_s,null),e(_s,kf),e(_s,Xa),e(Xa,yf),e(Xa,fi),e(fi,qf),e(Xa,jf),e(Xa,pd),e(pd,$f),e(Xa,Ef),e(_s,Ff),j(Mo,_s,null),e(_s,Af),j(So,_s,null),m(i,Ep,_),m(i,Za,_),e(Za,Po),e(Po,cd),j(er,cd,null),e(Za,xf),e(Za,hd),e(hd,zf),m(i,Fp,_),m(i,ps,_),j(tr,ps,null),e(ps,Cf),e(ps,eo),e(eo,Mf),e(eo,ud),e(ud,Sf),e(eo,Pf),e(eo,gi),e(gi,Df),e(eo,Nf),e(ps,Of),e(ps,sr),e(sr,Lf),e(sr,ar),e(ar,Qf),e(sr,If),e(ps,Wf),e(ps,Ts),j(or,Ts,null),e(Ts,Hf),e(Ts,to),e(to,Uf),e(to,_i),e(_i,Bf),e(to,Rf),e(to,md),e(md,Gf),e(to,Vf),e(Ts,Kf),j(Do,Ts,null),e(Ts,Yf),j(No,Ts,null),m(i,Ap,_),m(i,so,_),e(so,Oo),e(Oo,fd),j(nr,fd,null),e(so,Jf),e(so,gd),e(gd,Xf),m(i,xp,_),m(i,Ut,_),j(rr,Ut,null),e(Ut,Zf),e(Ut,_d),e(_d,eg),e(Ut,tg),e(Ut,ir),e(ir,sg),e(ir,Ti),e(Ti,ag),e(ir,og),e(Ut,ng),e(Ut,lr),e(lr,rg),e(lr,dr),e(dr,ig),e(lr,lg),e(Ut,dg),e(Ut,bs),j(pr,bs,null),e(bs,pg),e(bs,ao),e(ao,cg),e(ao,bi),e(bi,hg),e(ao,ug),e(ao,Td),e(Td,mg),e(ao,fg),e(bs,gg),j(Lo,bs,null),e(bs,_g),j(Qo,bs,null),m(i,zp,_),m(i,oo,_),e(oo,Io),e(Io,bd),j(cr,bd,null),e(oo,Tg),e(oo,vd),e(vd,bg),m(i,Cp,_),m(i,Bt,_),j(hr,Bt,null),e(Bt,vg),e(Bt,no),e(no,wg),e(no,wd),e(wd,kg),e(no,yg),e(no,kd),e(kd,qg),e(no,jg),e(Bt,$g),e(Bt,ur),e(ur,Eg),e(ur,vi),e(vi,Fg),e(ur,Ag),e(Bt,xg),e(Bt,mr),e(mr,zg),e(mr,fr),e(fr,Cg),e(mr,Mg),e(Bt,Sg),e(Bt,vs),j(gr,vs,null),e(vs,Pg),e(vs,ro),e(ro,Dg),e(ro,wi),e(wi,Ng),e(ro,Og),e(ro,yd),e(yd,Lg),e(ro,Qg),e(vs,Ig),j(Wo,vs,null),e(vs,Wg),j(Ho,vs,null),m(i,Mp,_),m(i,io,_),e(io,Uo),e(Uo,qd),j(_r,qd,null),e(io,Hg),e(io,jd),e(jd,Ug),m(i,Sp,_),m(i,dt,_),j(Tr,dt,null),e(dt,Bg),e(dt,$d),e($d,Rg),e(dt,Gg),e(dt,br),e(br,Vg),e(br,ki),e(ki,Kg),e(br,Yg),e(dt,Jg),e(dt,vr),e(vr,Xg),e(vr,wr),e(wr,Zg),e(vr,e_),e(dt,t_),j(Bo,dt,null),e(dt,s_),e(dt,ws),j(kr,ws,null),e(ws,a_),e(ws,lo),e(lo,o_),e(lo,yi),e(yi,n_),e(lo,r_),e(lo,Ed),e(Ed,i_),e(lo,l_),e(ws,d_),j(Ro,ws,null),e(ws,p_),j(Go,ws,null),m(i,Pp,_),m(i,po,_),e(po,Vo),e(Vo,Fd),j(yr,Fd,null),e(po,c_),e(po,Ad),e(Ad,h_),m(i,Dp,_),m(i,pt,_),j(qr,pt,null),e(pt,u_),e(pt,jr),e(jr,m_),e(jr,xd),e(xd,f_),e(jr,g_),e(pt,__),e(pt,$r),e($r,T_),e($r,qi),e(qi,b_),e($r,v_),e(pt,w_),e(pt,Er),e(Er,k_),e(Er,Fr),e(Fr,y_),e(Er,q_),e(pt,j_),j(Ko,pt,null),e(pt,$_),e(pt,ks),j(Ar,ks,null),e(ks,E_),e(ks,co),e(co,F_),e(co,ji),e(ji,A_),e(co,x_),e(co,zd),e(zd,z_),e(co,C_),e(ks,M_),j(Yo,ks,null),e(ks,S_),j(Jo,ks,null),m(i,Np,_),m(i,ho,_),e(ho,Xo),e(Xo,Cd),j(xr,Cd,null),e(ho,P_),e(ho,Md),e(Md,D_),m(i,Op,_),m(i,ct,_),j(zr,ct,null),e(ct,N_),e(ct,Sd),e(Sd,O_),e(ct,L_),e(ct,Cr),e(Cr,Q_),e(Cr,$i),e($i,I_),e(Cr,W_),e(ct,H_),e(ct,Mr),e(Mr,U_),e(Mr,Sr),e(Sr,B_),e(Mr,R_),e(ct,G_),j(Zo,ct,null),e(ct,V_),e(ct,ys),j(Pr,ys,null),e(ys,K_),e(ys,uo),e(uo,Y_),e(uo,Ei),e(Ei,J_),e(uo,X_),e(uo,Pd),e(Pd,Z_),e(uo,eT),e(ys,tT),j(en,ys,null),e(ys,sT),j(tn,ys,null),m(i,Lp,_),m(i,mo,_),e(mo,sn),e(sn,Dd),j(Dr,Dd,null),e(mo,aT),e(mo,Nd),e(Nd,oT),m(i,Qp,_),m(i,ht,_),j(Nr,ht,null),e(ht,nT),e(ht,fo),e(fo,rT),e(fo,Od),e(Od,iT),e(fo,lT),e(fo,Ld),e(Ld,dT),e(fo,pT),e(ht,cT),e(ht,Or),e(Or,hT),e(Or,Fi),e(Fi,uT),e(Or,mT),e(ht,fT),e(ht,Lr),e(Lr,gT),e(Lr,Qr),e(Qr,_T),e(Lr,TT),e(ht,bT),j(an,ht,null),e(ht,vT),e(ht,qs),j(Ir,qs,null),e(qs,wT),e(qs,go),e(go,kT),e(go,Ai),e(Ai,yT),e(go,qT),e(go,Qd),e(Qd,jT),e(go,$T),e(qs,ET),j(on,qs,null),e(qs,FT),j(nn,qs,null),Ip=!0},p(i,[_]){const Wr={};_&2&&(Wr.$$scope={dirty:_,ctx:i}),bo.$set(Wr);const Id={};_&2&&(Id.$$scope={dirty:_,ctx:i}),yo.$set(Id);const Wd={};_&2&&(Wd.$$scope={dirty:_,ctx:i}),qo.$set(Wd);const Hd={};_&2&&(Hd.$$scope={dirty:_,ctx:i}),$o.$set(Hd);const Hr={};_&2&&(Hr.$$scope={dirty:_,ctx:i}),Ao.$set(Hr);const Ud={};_&2&&(Ud.$$scope={dirty:_,ctx:i}),Mo.$set(Ud);const Bd={};_&2&&(Bd.$$scope={dirty:_,ctx:i}),So.$set(Bd);const Rd={};_&2&&(Rd.$$scope={dirty:_,ctx:i}),Do.$set(Rd);const Ur={};_&2&&(Ur.$$scope={dirty:_,ctx:i}),No.$set(Ur);const Gd={};_&2&&(Gd.$$scope={dirty:_,ctx:i}),Lo.$set(Gd);const Vd={};_&2&&(Vd.$$scope={dirty:_,ctx:i}),Qo.$set(Vd);const _o={};_&2&&(_o.$$scope={dirty:_,ctx:i}),Wo.$set(_o);const xi={};_&2&&(xi.$$scope={dirty:_,ctx:i}),Ho.$set(xi);const Kd={};_&2&&(Kd.$$scope={dirty:_,ctx:i}),Bo.$set(Kd);const zi={};_&2&&(zi.$$scope={dirty:_,ctx:i}),Ro.$set(zi);const Yd={};_&2&&(Yd.$$scope={dirty:_,ctx:i}),Go.$set(Yd);const Ci={};_&2&&(Ci.$$scope={dirty:_,ctx:i}),Ko.$set(Ci);const Jd={};_&2&&(Jd.$$scope={dirty:_,ctx:i}),Yo.$set(Jd);const Xd={};_&2&&(Xd.$$scope={dirty:_,ctx:i}),Jo.$set(Xd);const Zd={};_&2&&(Zd.$$scope={dirty:_,ctx:i}),Zo.$set(Zd);const ep={};_&2&&(ep.$$scope={dirty:_,ctx:i}),en.$set(ep);const tp={};_&2&&(tp.$$scope={dirty:_,ctx:i}),tn.$set(tp);const pa={};_&2&&(pa.$$scope={dirty:_,ctx:i}),an.$set(pa);const sp={};_&2&&(sp.$$scope={dirty:_,ctx:i}),on.$set(sp);const ap={};_&2&&(ap.$$scope={dirty:_,ctx:i}),nn.$set(ap)},i(i){Ip||($(p.$$.fragment,i),$(V.$$.fragment,i),$(rt.$$.fragment,i),$(bo.$$.fragment,i),$(yo.$$.fragment,i),$(qo.$$.fragment,i),$($n.$$.fragment,i),$($o.$$.fragment,i),$(An.$$.fragment,i),$(xn.$$.fragment,i),$(Cn.$$.fragment,i),$(Mn.$$.fragment,i),$(Ao.$$.fragment,i),$(Nn.$$.fragment,i),$(On.$$.fragment,i),$(Ln.$$.fragment,i),$(Qn.$$.fragment,i),$(Un.$$.fragment,i),$(Bn.$$.fragment,i),$(Rn.$$.fragment,i),$(Zn.$$.fragment,i),$(Mo.$$.fragment,i),$(So.$$.fragment,i),$(er.$$.fragment,i),$(tr.$$.fragment,i),$(or.$$.fragment,i),$(Do.$$.fragment,i),$(No.$$.fragment,i),$(nr.$$.fragment,i),$(rr.$$.fragment,i),$(pr.$$.fragment,i),$(Lo.$$.fragment,i),$(Qo.$$.fragment,i),$(cr.$$.fragment,i),$(hr.$$.fragment,i),$(gr.$$.fragment,i),$(Wo.$$.fragment,i),$(Ho.$$.fragment,i),$(_r.$$.fragment,i),$(Tr.$$.fragment,i),$(Bo.$$.fragment,i),$(kr.$$.fragment,i),$(Ro.$$.fragment,i),$(Go.$$.fragment,i),$(yr.$$.fragment,i),$(qr.$$.fragment,i),$(Ko.$$.fragment,i),$(Ar.$$.fragment,i),$(Yo.$$.fragment,i),$(Jo.$$.fragment,i),$(xr.$$.fragment,i),$(zr.$$.fragment,i),$(Zo.$$.fragment,i),$(Pr.$$.fragment,i),$(en.$$.fragment,i),$(tn.$$.fragment,i),$(Dr.$$.fragment,i),$(Nr.$$.fragment,i),$(an.$$.fragment,i),$(Ir.$$.fragment,i),$(on.$$.fragment,i),$(nn.$$.fragment,i),Ip=!0)},o(i){E(p.$$.fragment,i),E(V.$$.fragment,i),E(rt.$$.fragment,i),E(bo.$$.fragment,i),E(yo.$$.fragment,i),E(qo.$$.fragment,i),E($n.$$.fragment,i),E($o.$$.fragment,i),E(An.$$.fragment,i),E(xn.$$.fragment,i),E(Cn.$$.fragment,i),E(Mn.$$.fragment,i),E(Ao.$$.fragment,i),E(Nn.$$.fragment,i),E(On.$$.fragment,i),E(Ln.$$.fragment,i),E(Qn.$$.fragment,i),E(Un.$$.fragment,i),E(Bn.$$.fragment,i),E(Rn.$$.fragment,i),E(Zn.$$.fragment,i),E(Mo.$$.fragment,i),E(So.$$.fragment,i),E(er.$$.fragment,i),E(tr.$$.fragment,i),E(or.$$.fragment,i),E(Do.$$.fragment,i),E(No.$$.fragment,i),E(nr.$$.fragment,i),E(rr.$$.fragment,i),E(pr.$$.fragment,i),E(Lo.$$.fragment,i),E(Qo.$$.fragment,i),E(cr.$$.fragment,i),E(hr.$$.fragment,i),E(gr.$$.fragment,i),E(Wo.$$.fragment,i),E(Ho.$$.fragment,i),E(_r.$$.fragment,i),E(Tr.$$.fragment,i),E(Bo.$$.fragment,i),E(kr.$$.fragment,i),E(Ro.$$.fragment,i),E(Go.$$.fragment,i),E(yr.$$.fragment,i),E(qr.$$.fragment,i),E(Ko.$$.fragment,i),E(Ar.$$.fragment,i),E(Yo.$$.fragment,i),E(Jo.$$.fragment,i),E(xr.$$.fragment,i),E(zr.$$.fragment,i),E(Zo.$$.fragment,i),E(Pr.$$.fragment,i),E(en.$$.fragment,i),E(tn.$$.fragment,i),E(Dr.$$.fragment,i),E(Nr.$$.fragment,i),E(an.$$.fragment,i),E(Ir.$$.fragment,i),E(on.$$.fragment,i),E(nn.$$.fragment,i),Ip=!1},d(i){t(l),i&&t(b),i&&t(d),F(p),i&&t(N),i&&t(x),F(V),i&&t(W),i&&t(L),i&&t(O),i&&t(ee),i&&t(ce),i&&t(oe),i&&t(ve),i&&t(v),i&&t(be),i&&t(xe),i&&t(le),i&&t(ze),i&&t(de),i&&t(pe),i&&t(mt),i&&t(ft),i&&t(gt),i&&t(_t),i&&t(Ke),i&&t(Se),i&&t(cs),i&&t(Gt),i&&t(hs),i&&t(Ye),i&&t(ha),i&&t(It),F(rt),i&&t(ua),i&&t(Ie),i&&t(ma),i&&t(ms),i&&t(fa),i&&t(fe),i&&t(ga),i&&t(Tt),i&&t(_a),i&&t(gs),i&&t(Ta),i&&t(Ce),i&&t(op),F(bo,i),i&&t(np),i&&t(vo),i&&t(rp),i&&t(wo),i&&t(ip),i&&t(Br),i&&t(lp),i&&t(ko),i&&t(dp),i&&t(We),i&&t(pp),i&&t(bt),i&&t(cp),i&&t(ti),i&&t(hp),F(yo,i),i&&t(up),i&&t(Pe),i&&t(mp),i&&t(ai),i&&t(fp),F(qo,i),i&&t(gp),i&&t(Ua),F($n),i&&t(_p),F($o,i),i&&t(Tp),i&&t(vt),i&&t(bp),i&&t(Ba),F(An),i&&t(vp),i&&t(Ra),F(xn),i&&t(wp),i&&t(Ga),F(Cn),i&&t(kp),i&&t(Ht),F(Mn),F(Ao),i&&t(yp),i&&t(Ya),F(Nn),i&&t(qp),i&&t(Ge),F(On),F(Ln),F(Qn),F(Un),i&&t(jp),i&&t(Ja),F(Bn),i&&t($p),i&&t(lt),F(Rn),F(Zn),F(Mo),F(So),i&&t(Ep),i&&t(Za),F(er),i&&t(Fp),i&&t(ps),F(tr),F(or),F(Do),F(No),i&&t(Ap),i&&t(so),F(nr),i&&t(xp),i&&t(Ut),F(rr),F(pr),F(Lo),F(Qo),i&&t(zp),i&&t(oo),F(cr),i&&t(Cp),i&&t(Bt),F(hr),F(gr),F(Wo),F(Ho),i&&t(Mp),i&&t(io),F(_r),i&&t(Sp),i&&t(dt),F(Tr),F(Bo),F(kr),F(Ro),F(Go),i&&t(Pp),i&&t(po),F(yr),i&&t(Dp),i&&t(pt),F(qr),F(Ko),F(Ar),F(Yo),F(Jo),i&&t(Np),i&&t(ho),F(xr),i&&t(Op),i&&t(ct),F(zr),F(Zo),F(Pr),F(en),F(tn),i&&t(Lp),i&&t(mo),F(Dr),i&&t(Qp),i&&t(ht),F(Nr),F(an),F(Ir),F(on),F(nn)}}}const ay={local:"tapas",sections:[{local:"overview",title:"Overview"},{local:"usage-finetuning",title:"Usage: fine-tuning"},{local:"usage-inference",title:"Usage: inference"},{local:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",title:"TAPAS specific outputs"},{local:"transformers.TapasConfig",title:"TapasConfig"},{local:"transformers.TapasTokenizer",title:"TapasTokenizer"},{local:"transformers.TapasModel",title:"TapasModel"},{local:"transformers.TapasForMaskedLM",title:"TapasForMaskedLM"},{local:"transformers.TapasForSequenceClassification",title:"TapasForSequenceClassification"},{local:"transformers.TapasForQuestionAnswering",title:"TapasForQuestionAnswering"},{local:"transformers.TFTapasModel",title:"TFTapasModel"},{local:"transformers.TFTapasForMaskedLM",title:"TFTapasForMaskedLM"},{local:"transformers.TFTapasForSequenceClassification",title:"TFTapasForSequenceClassification"},{local:"transformers.TFTapasForQuestionAnswering",title:"TFTapasForQuestionAnswering"}],title:"TAPAS"};function oy(S){return Tk(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class hy extends uk{constructor(l){super();mk(this,l,oy,sy,fk,{})}}export{hy as default,ay as metadata};
