...
[AutoTokenizer](/docs/transformers/pr_15758/en/model_doc/auto#transformers.AutoTokenizer) because we will eventually train a classifier using a pretrained [DistilBERT](https://huggingface.co/distilbert-base-uncased) model:
...
Now load your model with the [AutoModelForSequenceClassification](/docs/transformers/pr_15758/en/model_doc/auto#transformers.AutoModelForSequenceClassification) class along with the number of expected labels:
...
1. Define your training hyperparameters in [TrainingArguments](/docs/transformers/pr_15758/en/main_classes/trainer#transformers.TrainingArguments).
2. Pass the training arguments to a [Trainer](/docs/transformers/pr_15758/en/main_classes/trainer#transformers.Trainer) along with the model, dataset, tokenizer, and data collator.
...
Start by batching the processed examples together with dynamic padding using the [DataCollatorWithPadding](/docs/transformers/pr_15758/en/main_classes/data_collator#transformers.DataCollatorWithPadding) function.
...
Load your model with the [TFAutoModelForSequenceClassification](/docs/transformers/pr_15758/en/model_doc/auto#transformers.TFAutoModelForSequenceClassification) class along with the number of expected labels:
...
Now you need to tokenize the text. Load the DistilBERT tokenizer with an [AutoTokenizer](/docs/transformers/pr_15758/en/model_doc/auto#transformers.AutoTokenizer):
...
Load your model with the [AutoModelForTokenClassification](/docs/transformers/pr_15758/en/model_doc/auto#transformers.AutoModelForTokenClassification) class along with the number of expected labels:
...
Gather your training arguments in [TrainingArguments](/docs/transformers/pr_15758/en/main_classes/trainer#transformers.TrainingArguments):
...
Collect your model, training arguments, dataset, data collator, and tokenizer in [Trainer](/docs/transformers/pr_15758/en/main_classes/trainer#transformers.Trainer):
...
Load the model with the [TFAutoModelForTokenClassification](/docs/transformers/pr_15758/en/model_doc/auto#transformers.TFAutoModelForTokenClassification) class along with the number of expected labels:
...
Load the DistilBERT tokenizer with an [AutoTokenizer](/docs/transformers/pr_15758/en/model_doc/auto#transformers.AutoTokenizer):
...
Load your model with the [AutoModelForQuestionAnswering](/docs/transformers/pr_15758/en/model_doc/auto#transformers.AutoModelForQuestionAnswering) class:
...
Load your model with the [TFAutoModelForQuestionAnswering](/docs/transformers/pr_15758/en/model_doc/auto#transformers.TFAutoModelForQuestionAnswering) class:
