...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16444/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16444/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16444/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16444/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16444/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16444/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16444/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
documentation from `),pi=a(Ni,"A",{href:!0});var H1=s(pi);Um=i(H1,"PretrainedConfig"),H1.forEach(t),Xm=i(Ni," for more information."),Ni.forEach(t),Hm=l(Pt),Pd=a(Pt,"P",{});var V1=s(Pd);Vm=i(V1,"Example:"),V1.forEach(t),Qm=l(Pt),m(Hn.$$.fragment,Pt),Pt.forEach(t),Op=l(o),ao=a(o,"H2",{class:!0});var vh=s(ao);No=a(vh,"A",{id:!0,class:!0,href:!0});var Q1=s(No);Cd=a(Q1,"SPAN",{});var J1=s(Cd);m(Vn.$$.fragment,J1),J1.forEach(t),Q1.forEach(t),Jm=l(vh),Sd=a(vh,"SPAN",{});var K1=s(Sd);Km=i(K1,"MBartTokenizer"),K1.forEach(t),vh.forEach(t),Ip=l(o),G=a(o,"DIV",{class:!0});var me=s(G);m(Qn.$$.fragment,me),Zm=l(me),Ad=a(me,"P",{});var Z1=s(Ad);Ym=i(Z1,"Construct an MBART tokenizer."),Z1.forEach(t),ef=l(me),mt=a(me,"P",{});var xn=s(mt);tf=i(xn,"Adapted from "),hi=a(xn,"A",{href:!0});var Y1=s(hi);of=i(Y1,"RobertaTokenizer"),Y1.forEach(t),nf=i(xn," and "),ui=a(xn,"A",{href:!0});var e4=s(ui);af=i(e4,"XLNetTokenizer"),e4.forEach(t),sf=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var t4=s(Jn);rf=i(t4,"SentencePiece"),t4.forEach(t),df=i(xn,"."),xn.forEach(t),lf=l(me),Kn=a(me,"P",{});var Th=s(Kn);cf=i(Th,"The tokenization method is "),Od=a(Th,"CODE",{});var o4=s(Od);pf=i(o4,"<tokens> <eos> <language code>"),o4.forEach(t),hf=i(Th," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Th.forEach(t),uf=l(me),Id=a(me,"P",{});var n4=s(Id);mf=i(n4,"Examples:"),n4.forEach(t),ff=l(me),m(Zn.$$.fragment,me),_f=l(me),Do=a(me,"DIV",{class:!0});var Mh=s(Do);m(Yn.$$.fragment,Mh),gf=l(Mh),Nd=a(Mh,"P",{});var a4=s(Nd);kf=i(a4,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),a4.forEach(t),Mh.forEach(t),bf=l(me),tt=a(me,"DIV",{class:!0});var zn=s(tt);m(ea.$$.fragment,zn),yf=l(zn),ta=a(zn,"P",{});var wh=s(ta);vf=i(wh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Dd=a(wh,"CODE",{});var s4=s(Dd);Tf=i(s4,"X"),s4.forEach(t),Mf=i(wh," represents the sequence:"),wh.forEach(t),wf=l(zn),oa=a(zn,"UL",{});var xh=s(oa);na=a(xh,"LI",{});var zh=s(na);Ld=a(zh,"CODE",{});var r4=s(Ld);xf=i(r4,"input_ids"),r4.forEach(t),zf=i(zh," (for encoder) "),Gd=a(zh,"CODE",{});var i4=s(Gd);qf=i(i4,"X [eos, src_lang_code]"),i4.forEach(t),zh.forEach(t),Bf=l(xh),aa=a(xh,"LI",{});var qh=s(aa);Wd=a(qh,"CODE",{});var d4=s(Wd);$f=i(d4,"decoder_input_ids"),d4.forEach(t),Ff=i(qh,": (for decoder) "),Rd=a(qh,"CODE",{});var l4=s(Rd);jf=i(l4,"X [eos, tgt_lang_code]"),l4.forEach(t),qh.forEach(t),xh.forEach(t),Ef=l(zn),Ud=a(zn,"P",{});var c4=s(Ud);Pf=i(c4,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),c4.forEach(t),zn.forEach(t),me.forEach(t),Np=l(o),so=a(o,"H2",{class:!0});var Bh=s(so);Lo=a(Bh,"A",{id:!0,class:!0,href:!0});var p4=s(Lo);Xd=a(p4,"SPAN",{});var h4=s(Xd);m(sa.$$.fragment,h4),h4.forEach(t),p4.forEach(t),Cf=l(Bh),Hd=a(Bh,"SPAN",{});var u4=s(Hd);Sf=i(u4,"MBartTokenizerFast"),u4.forEach(t),Bh.forEach(t),Dp=l(o),C=a(o,"DIV",{class:!0});var V=s(C);m(ra.$$.fragment,V),Af=l(V),ro=a(V,"P",{});var Di=s(ro);Of=i(Di,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Vd=a(Di,"EM",{});var m4=s(Vd);If=i(m4,"tokenizers"),m4.forEach(t),Nf=i(Di,` library). Based on
`),ia=a(Di,"A",{href:!0,rel:!0});var f4=s(ia);Df=i(f4,"BPE"),f4.forEach(t),Lf=i(Di,"."),Di.forEach(t),Gf=l(V),Tt=a(V,"P",{});var ei=s(Tt);mi=a(ei,"A",{href:!0});var _4=s(mi);Wf=i(_4,"MBartTokenizerFast"),_4.forEach(t),Rf=i(ei," is a subclass of "),fi=a(ei,"A",{href:!0});var g4=s(fi);Uf=i(g4,"XLMRobertaTokenizerFast"),g4.forEach(t),Xf=i(ei,`. Refer to superclass
`),_i=a(ei,"A",{href:!0});var k4=s(_i);Hf=i(k4,"XLMRobertaTokenizerFast"),k4.forEach(t),Vf=i(ei,` for usage examples and documentation concerning the initialization parameters and other
methods.`),ei.forEach(t),Qf=l(V),da=a(V,"P",{});var $h=s(da);Jf=i($h,"The tokenization method is "),Qd=a($h,"CODE",{});var b4=s(Qd);Kf=i(b4,"<tokens> <eos> <language code>"),b4.forEach(t),Zf=i($h," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$h.forEach(t),Yf=l(V),Jd=a(V,"P",{});var y4=s(Jd);e_=i(y4,"Examples:"),y4.forEach(t),t_=l(V),m(la.$$.fragment,V),o_=l(V),Se=a(V,"DIV",{class:!0});var Ct=s(Se);m(ca.$$.fragment,Ct),n_=l(Ct),Kd=a(Ct,"P",{});var v4=s(Kd);a_=i(v4,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),v4.forEach(t),s_=l(Ct),pa=a(Ct,"P",{});var Fh=s(pa);r_=i(Fh,"An MBART sequence has the following format, where "),Zd=a(Fh,"CODE",{});var T4=s(Zd);i_=i(T4,"X"),T4.forEach(t),d_=i(Fh," represents the sequence:"),Fh.forEach(t),l_=l(Ct),ha=a(Ct,"UL",{});var jh=s(ha);ua=a(jh,"LI",{});var Eh=s(ua);Yd=a(Eh,"CODE",{});var M4=s(Yd);c_=i(M4,"input_ids"),M4.forEach(t),p_=i(Eh," (for encoder) "),el=a(Eh,"CODE",{});var w4=s(el);h_=i(w4,"X [eos, src_lang_code]"),w4.forEach(t),Eh.forEach(t),u_=l(jh),ma=a(jh,"LI",{});var Ph=s(ma);tl=a(Ph,"CODE",{});var x4=s(tl);m_=i(x4,"decoder_input_ids"),x4.forEach(t),f_=i(Ph,": (for decoder) "),ol=a(Ph,"CODE",{});var z4=s(ol);__=i(z4,"X [eos, tgt_lang_code]"),z4.forEach(t),Ph.forEach(t),jh.forEach(t),g_=l(Ct),nl=a(Ct,"P",{});var q4=s(nl);k_=i(q4,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),q4.forEach(t),Ct.forEach(t),b_=l(V),Go=a(V,"DIV",{class:!0});var Ch=s(Go);m(fa.$$.fragment,Ch),y_=l(Ch),al=a(Ch,"P",{});var B4=s(al);v_=i(B4,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),B4.forEach(t),Ch.forEach(t),T_=l(V),Wo=a(V,"DIV",{class:!0});var Sh=s(Wo);m(_a.$$.fragment,Sh),M_=l(Sh),sl=a(Sh,"P",{});var $4=s(sl);w_=i($4,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),$4.forEach(t),Sh.forEach(t),x_=l(V),Ro=a(V,"DIV",{class:!0});var Ah=s(Ro);m(ga.$$.fragment,Ah),z_=l(Ah),rl=a(Ah,"P",{});var F4=s(rl);q_=i(F4,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),F4.forEach(t),Ah.forEach(t),V.forEach(t),Lp=l(o),io=a(o,"H2",{class:!0});var Oh=s(io);Uo=a(Oh,"A",{id:!0,class:!0,href:!0});var j4=s(Uo);il=a(j4,"SPAN",{});var E4=s(il);m(ka.$$.fragment,E4),E4.forEach(t),j4.forEach(t),B_=l(Oh),dl=a(Oh,"SPAN",{});var P4=s(dl);$_=i(P4,"MBart50Tokenizer"),P4.forEach(t),Oh.forEach(t),Gp=l(o),S=a(o,"DIV",{class:!0});var Q=s(S);m(ba.$$.fragment,Q),F_=l(Q),ya=a(Q,"P",{});var Ih=s(ya);j_=i(Ih,"Construct a MBart50 tokenizer. Based on "),va=a(Ih,"A",{href:!0,rel:!0});var C4=s(va);E_=i(C4,"SentencePiece"),C4.forEach(t),P_=i(Ih,"."),Ih.forEach(t),C_=l(Q),Ta=a(Q,"P",{});var Nh=s(Ta);S_=i(Nh,"This tokenizer inherits from "),gi=a(Nh,"A",{href:!0});var S4=s(gi);A_=i(S4,"PreTrainedTokenizer"),S4.forEach(t),O_=i(Nh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Nh.forEach(t),I_=l(Q),ll=a(Q,"P",{});var A4=s(ll);N_=i(A4,"Examples:"),A4.forEach(t),D_=l(Q),m(Ma.$$.fragment,Q),L_=l(Q),ot=a(Q,"DIV",{class:!0});var qn=s(ot);m(wa.$$.fragment,qn),G_=l(qn),xa=a(qn,"P",{});var Dh=s(xa);W_=i(Dh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),cl=a(Dh,"CODE",{});var O4=s(cl);R_=i(O4,"X"),O4.forEach(t),U_=i(Dh," represents the sequence:"),Dh.forEach(t),X_=l(qn),za=a(qn,"UL",{});var Lh=s(za);qa=a(Lh,"LI",{});var Gh=s(qa);pl=a(Gh,"CODE",{});var I4=s(pl);H_=i(I4,"input_ids"),I4.forEach(t),V_=i(Gh," (for encoder) "),hl=a(Gh,"CODE",{});var N4=s(hl);Q_=i(N4,"[src_lang_code] X [eos]"),N4.forEach(t),Gh.forEach(t),J_=l(Lh),Ba=a(Lh,"LI",{});var Wh=s(Ba);ul=a(Wh,"CODE",{});var D4=s(ul);K_=i(D4,"labels"),D4.forEach(t),Z_=i(Wh,": (for decoder) "),ml=a(Wh,"CODE",{});var L4=s(ml);Y_=i(L4,"[tgt_lang_code] X [eos]"),L4.forEach(t),Wh.forEach(t),Lh.forEach(t),eg=l(qn),fl=a(qn,"P",{});var G4=s(fl);tg=i(G4,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),G4.forEach(t),qn.forEach(t),og=l(Q),Xo=a(Q,"DIV",{class:!0});var Rh=s(Xo);m($a.$$.fragment,Rh),ng=l(Rh),_l=a(Rh,"P",{});var W4=s(_l);ag=i(W4,"Converts a sequence of tokens (strings for sub-words) in a single string."),W4.forEach(t),Rh.forEach(t),sg=l(Q),Ho=a(Q,"DIV",{class:!0});var Uh=s(Ho);m(Fa.$$.fragment,Uh),rg=l(Uh),ja=a(Uh,"P",{});var Xh=s(ja);ig=i(Xh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),gl=a(Xh,"CODE",{});var R4=s(gl);dg=i(R4,"prepare_for_model"),R4.forEach(t),lg=i(Xh," method."),Xh.forEach(t),Uh.forEach(t),cg=l(Q),Vo=a(Q,"DIV",{class:!0});var Hh=s(Vo);m(Ea.$$.fragment,Hh),pg=l(Hh),kl=a(Hh,"P",{});var U4=s(kl);hg=i(U4,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),U4.forEach(t),Hh.forEach(t),ug=l(Q),Qo=a(Q,"DIV",{class:!0});var Vh=s(Qo);m(Pa.$$.fragment,Vh),mg=l(Vh),bl=a(Vh,"P",{});var X4=s(bl);fg=i(X4,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),X4.forEach(t),Vh.forEach(t),Q.forEach(t),Wp=l(o),lo=a(o,"H2",{class:!0});var Qh=s(lo);Jo=a(Qh,"A",{id:!0,class:!0,href:!0});var H4=s(Jo);yl=a(H4,"SPAN",{});var V4=s(yl);m(Ca.$$.fragment,V4),V4.forEach(t),H4.forEach(t),_g=l(Qh),vl=a(Qh,"SPAN",{});var Q4=s(vl);gg=i(Q4,"MBart50TokenizerFast"),Q4.forEach(t),Qh.forEach(t),Rp=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);m(Sa.$$.fragment,fe),kg=l(fe),co=a(fe,"P",{});var Li=s(co);bg=i(Li,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),Tl=a(Li,"EM",{});var J4=s(Tl);yg=i(J4,"tokenizers"),J4.forEach(t),vg=i(Li,` library). Based on
`),Aa=a(Li,"A",{href:!0,rel:!0});var K4=s(Aa);Tg=i(K4,"BPE"),K4.forEach(t),Mg=i(Li,"."),Li.forEach(t),wg=l(fe),Oa=a(fe,"P",{});var Jh=s(Oa);xg=i(Jh,"This tokenizer inherits from "),ki=a(Jh,"A",{href:!0});var Z4=s(ki);zg=i(Z4,"PreTrainedTokenizerFast"),Z4.forEach(t),qg=i(Jh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Jh.forEach(t),Bg=l(fe),Ml=a(fe,"P",{});var Y4=s(Ml);$g=i(Y4,"Examples:"),Y4.forEach(t),Fg=l(fe),m(Ia.$$.fragment,fe),jg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);m(Na.$$.fragment,St),Eg=l(St),wl=a(St,"P",{});var ew=s(wl);Pg=i(ew,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),ew.forEach(t),Cg=l(St),Da=a(St,"P",{});var Kh=s(Da);Sg=i(Kh,"An MBART-50 sequence has the following format, where "),xl=a(Kh,"CODE",{});var tw=s(xl);Ag=i(tw,"X"),tw.forEach(t),Og=i(Kh," represents the sequence:"),Kh.forEach(t),Ig=l(St),La=a(St,"UL",{});var Zh=s(La);Ga=a(Zh,"LI",{});var Yh=s(Ga);zl=a(Yh,"CODE",{});var ow=s(zl);Ng=i(ow,"input_ids"),ow.forEach(t),Dg=i(Yh," (for encoder) "),ql=a(Yh,"CODE",{});var nw=s(ql);Lg=i(nw,"[src_lang_code] X [eos]"),nw.forEach(t),Yh.forEach(t),Gg=l(Zh),Wa=a(Zh,"LI",{});var eu=s(Wa);Bl=a(eu,"CODE",{});var aw=s(Bl);Wg=i(aw,"labels"),aw.forEach(t),Rg=i(eu,": (for decoder) "),$l=a(eu,"CODE",{});var sw=s($l);Ug=i(sw,"[tgt_lang_code] X [eos]"),sw.forEach(t),eu.forEach(t),Zh.forEach(t),Xg=l(St),Fl=a(St,"P",{});var rw=s(Fl);Hg=i(rw,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),rw.forEach(t),St.forEach(t),Vg=l(fe),Ko=a(fe,"DIV",{class:!0});var tu=s(Ko);m(Ra.$$.fragment,tu),Qg=l(tu),jl=a(tu,"P",{});var iw=s(jl);Jg=i(iw,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),iw.forEach(t),tu.forEach(t),Kg=l(fe),Zo=a(fe,"DIV",{class:!0});var ou=s(Zo);m(Ua.$$.fragment,ou),Zg=l(ou),El=a(ou,"P",{});var dw=s(El);Yg=i(dw,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),dw.forEach(t),ou.forEach(t),fe.forEach(t),Up=l(o),po=a(o,"H2",{class:!0});var nu=s(po);Yo=a(nu,"A",{id:!0,class:!0,href:!0});var lw=s(Yo);Pl=a(lw,"SPAN",{});var cw=s(Pl);m(Xa.$$.fragment,cw),cw.forEach(t),lw.forEach(t),ek=l(nu),Cl=a(nu,"SPAN",{});var pw=s(Cl);tk=i(pw,"MBartModel"),pw.forEach(t),nu.forEach(t),Xp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);m(Ha.$$.fragment,Bn),ok=l(Bn),Va=a(Bn,"P",{});var au=s(Va);nk=i(au,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),bi=a(au,"A",{href:!0});var hw=s(bi);ak=i(hw,"PreTrainedModel"),hw.forEach(t),sk=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),rk=l(Bn),Qa=a(Bn,"P",{});var su=s(Qa);ik=i(su,"This model is also a PyTorch "),Ja=a(su,"A",{href:!0,rel:!0});var uw=s(Ja);dk=i(uw,"torch.nn.Module"),uw.forEach(t),lk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),ck=l(Bn),Oe=a(Bn,"DIV",{class:!0});var At=s(Oe);m(Ka.$$.fragment,At),pk=l(At),ho=a(At,"P",{});var Gi=s(ho);hk=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var mw=s(yi);uk=i(mw,"MBartModel"),mw.forEach(t),mk=i(Gi," forward method, overrides the "),Sl=a(Gi,"CODE",{});var fw=s(Sl);fk=i(fw,"__call__"),fw.forEach(t),_k=i(Gi," special method."),Gi.forEach(t),gk=l(At),m(en.$$.fragment,At),kk=l(At),Al=a(At,"P",{});var _w=s(Al);bk=i(_w,"Example:"),_w.forEach(t),yk=l(At),m(Za.$$.fragment,At),At.forEach(t),Bn.forEach(t),Hp=l(o),uo=a(o,"H2",{class:!0});var ru=s(uo);tn=a(ru,"A",{id:!0,class:!0,href:!0});var gw=s(tn);Ol=a(gw,"SPAN",{});var kw=s(Ol);m(Ya.$$.fragment,kw),kw.forEach(t),gw.forEach(t),vk=l(ru),Il=a(ru,"SPAN",{});var bw=s(Il);Tk=i(bw,"MBartForConditionalGeneration"),bw.forEach(t),ru.forEach(t),Vp=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);m(es.$$.fragment,$n),Mk=l($n),ts=a($n,"P",{});var iu=s(ts);wk=i(iu,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),vi=a(iu,"A",{href:!0});var yw=s(vi);xk=i(yw,"PreTrainedModel"),yw.forEach(t),zk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),qk=l($n),os=a($n,"P",{});var du=s(os);Bk=i(du,"This model is also a PyTorch "),ns=a(du,"A",{href:!0,rel:!0});var vw=s(ns);$k=i(vw,"torch.nn.Module"),vw.forEach(t),Fk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),jk=l($n),Y=a($n,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Ek=l(Ge),mo=a(Ge,"P",{});var Wi=s(mo);Pk=i(Wi,"The "),Ti=a(Wi,"A",{href:!0});var Tw=s(Ti);Ck=i(Tw,"MBartForConditionalGeneration"),Tw.forEach(t),Sk=i(Wi," forward method, overrides the "),Nl=a(Wi,"CODE",{});var Mw=s(Nl);Ak=i(Mw,"__call__"),Mw.forEach(t),Ok=i(Wi," special method."),Wi.forEach(t),Ik=l(Ge),m(on.$$.fragment,Ge),Nk=l(Ge),Dl=a(Ge,"P",{});var ww=s(Dl);Dk=i(ww,"Translation example:"),ww.forEach(t),Lk=l(Ge),m(ss.$$.fragment,Ge),Gk=l(Ge),Ll=a(Ge,"P",{});var xw=s(Ll);Wk=i(xw,"Mask filling example:"),xw.forEach(t),Rk=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),$n.forEach(t),Qp=l(o),fo=a(o,"H2",{class:!0});var lu=s(fo);nn=a(lu,"A",{id:!0,class:!0,href:!0});var zw=s(nn);Gl=a(zw,"SPAN",{});var qw=s(Gl);m(is.$$.fragment,qw),qw.forEach(t),zw.forEach(t),Uk=l(lu),Wl=a(lu,"SPAN",{});var Bw=s(Wl);Xk=i(Bw,"MBartForQuestionAnswering"),Bw.forEach(t),lu.forEach(t),Jp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);m(ds.$$.fragment,Ot),Hk=l(Ot),_o=a(Ot,"P",{});var Ri=s(_o);Vk=i(Ri,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Rl=a(Ri,"CODE",{});var $w=s(Rl);Qk=i($w,"span start logits"),$w.forEach(t),Jk=i(Ri," and "),Ul=a(Ri,"CODE",{});var Fw=s(Ul);Kk=i(Fw,"span end logits"),Fw.forEach(t),Zk=i(Ri,")."),Ri.forEach(t),Yk=l(Ot),ls=a(Ot,"P",{});var cu=s(ls);eb=i(cu,"This model inherits from "),Mi=a(cu,"A",{href:!0});var jw=s(Mi);tb=i(jw,"PreTrainedModel"),jw.forEach(t),ob=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),nb=l(Ot),cs=a(Ot,"P",{});var pu=s(cs);ab=i(pu,"This model is also a PyTorch "),ps=a(pu,"A",{href:!0,rel:!0});var Ew=s(ps);sb=i(Ew,"torch.nn.Module"),Ew.forEach(t),rb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),ib=l(Ot),ue=a(Ot,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),db=l(at),go=a(at,"P",{});var Ui=s(go);lb=i(Ui,"The "),wi=a(Ui,"A",{href:!0});var Pw=s(wi);cb=i(Pw,"MBartForQuestionAnswering"),Pw.forEach(t),pb=i(Ui," forward method, overrides the "),Xl=a(Ui,"CODE",{});var Cw=s(Xl);hb=i(Cw,"__call__"),Cw.forEach(t),ub=i(Ui," special method."),Ui.forEach(t),mb=l(at),m(an.$$.fragment,at),fb=l(at),Hl=a(at,"P",{});var Sw=s(Hl);_b=i(Sw,"Example:"),Sw.forEach(t),gb=l(at),m(us.$$.fragment,at),kb=l(at),m(ms.$$.fragment,at),at.forEach(t),Ot.forEach(t),Kp=l(o),ko=a(o,"H2",{class:!0});var hu=s(ko);sn=a(hu,"A",{id:!0,class:!0,href:!0});var Aw=s(sn);Vl=a(Aw,"SPAN",{});var Ow=s(Vl);m(fs.$$.fragment,Ow),Ow.forEach(t),Aw.forEach(t),bb=l(hu),Ql=a(hu,"SPAN",{});var Iw=s(Ql);yb=i(Iw,"MBartForSequenceClassification"),Iw.forEach(t),hu.forEach(t),Zp=l(o),Fe=a(o,"DIV",{class:!0});var It=s(Fe);m(_s.$$.fragment,It),vb=l(It),Jl=a(It,"P",{});var Nw=s(Jl);Tb=i(Nw,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Nw.forEach(t),Mb=l(It),gs=a(It,"P",{});var uu=s(gs);wb=i(uu,"This model inherits from "),xi=a(uu,"A",{href:!0});var Dw=s(xi);xb=i(Dw,"PreTrainedModel"),Dw.forEach(t),zb=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),qb=l(It),ks=a(It,"P",{});var mu=s(ks);Bb=i(mu,"This model is also a PyTorch "),bs=a(mu,"A",{href:!0,rel:!0});var Lw=s(bs);$b=i(Lw,"torch.nn.Module"),Lw.forEach(t),Fb=i(mu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mu.forEach(t),jb=l(It),L=a(It,"DIV",{class:!0});var oe=s(L);m(ys.$$.fragment,oe),Eb=l(oe),bo=a(oe,"P",{});var Xi=s(bo);Pb=i(Xi,"The "),zi=a(Xi,"A",{href:!0});var Gw=s(zi);Cb=i(Gw,"MBartForSequenceClassification"),Gw.forEach(t),Sb=i(Xi," forward method, overrides the "),Kl=a(Xi,"CODE",{});var Ww=s(Kl);Ab=i(Ww,"__call__"),Ww.forEach(t),Ob=i(Xi," special method."),Xi.forEach(t),Ib=l(oe),m(rn.$$.fragment,oe),Nb=l(oe),Zl=a(oe,"P",{});var Rw=s(Zl);Db=i(Rw,"Example of single-label classification:"),Rw.forEach(t),Lb=l(oe),m(vs.$$.fragment,oe),Gb=l(oe),m(Ts.$$.fragment,oe),Wb=l(oe),Yl=a(oe,"P",{});var Uw=s(Yl);Rb=i(Uw,"Example of multi-label classification:"),Uw.forEach(t),Ub=l(oe),m(Ms.$$.fragment,oe),Xb=l(oe),m(ws.$$.fragment,oe),oe.forEach(t),It.forEach(t),Yp=l(o),yo=a(o,"H2",{class:!0});var fu=s(yo);dn=a(fu,"A",{id:!0,class:!0,href:!0});var Xw=s(dn);ec=a(Xw,"SPAN",{});var Hw=s(ec);m(xs.$$.fragment,Hw),Hw.forEach(t),Xw.forEach(t),Hb=l(fu),tc=a(fu,"SPAN",{});var Vw=s(tc);Vb=i(Vw,"MBartForCausalLM"),Vw.forEach(t),fu.forEach(t),eh=l(o),vo=a(o,"DIV",{class:!0});var _u=s(vo);m(zs.$$.fragment,_u),Qb=l(_u),Mt=a(_u,"DIV",{class:!0});var Hi=s(Mt);m(qs.$$.fragment,Hi),Jb=l(Hi),oc=a(Hi,"P",{});var Qw=s(oc);Kb=i(Qw,"Example:"),Qw.forEach(t),Zb=l(Hi),m(Bs.$$.fragment,Hi),Hi.forEach(t),_u.forEach(t),th=l(o),To=a(o,"H2",{class:!0});var gu=s(To);ln=a(gu,"A",{id:!0,class:!0,href:!0});var Jw=s(ln);nc=a(Jw,"SPAN",{});var Kw=s(nc);m($s.$$.fragment,Kw),Kw.forEach(t),Jw.forEach(t),Yb=l(gu),ac=a(gu,"SPAN",{});var Zw=s(ac);ey=i(Zw,"TFMBartModel"),Zw.forEach(t),gu.forEach(t),oh=l(o),je=a(o,"DIV",{class:!0});var Nt=s(je);m(Fs.$$.fragment,Nt),ty=l(Nt),js=a(Nt,"P",{});var ku=s(js);oy=i(ku,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(ku,"A",{href:!0});var Yw=s(qi);ny=i(Yw,"TFPreTrainedModel"),Yw.forEach(t),ay=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
