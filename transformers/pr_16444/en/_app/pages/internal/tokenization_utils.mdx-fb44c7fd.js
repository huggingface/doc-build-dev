...
PyTorch tensors, you will lose the specific device of your tensors however.`),W.forEach(t)},m(ge,W){$(ge,h,W),e(h,P),e(h,v),e(v,z),e(h,E),e(h,y),e(y,x),e(h,B)},d(ge){ge&&t(h)}}}function ah(U){let h,P;return{c(){h=r("p"),P=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(v){h=s(v,"P",{});var z=a(h);P=n(z,"This API is experimental and may have some slight breaking changes in the next releases."),z.forEach(t)},m(v,z){$(v,h,z),e(h,P)},d(v){v&&t(h)}}}function ih(U){let h,P,v,z,E,y,x,B,ge,W,D,ro,so,ks,bs,ao,vs,Ts,io,ys,ws,co,zs,xs,qr,lo,$s,Er,ke,De,So,ot,Ps,Co,qs,Br,p,nt,Es,be,Bs,po,Ls,Ds,mo,Is,Ns,As,Oo,Fs,Ss,Wo,Cs,Os,I,te,jo,Ws,js,Mo,Ms,Rs,Ro,Us,Vs,Hs,F,Uo,Gs,Xs,Vo,Ys,Js,Ho,Ks,Qs,Go,Zs,ea,Xo,ta,oa,na,V,Yo,ra,sa,Jo,aa,ia,Ko,da,ca,Qo,la,pa,ma,S,Zo,ha,ua,en,fa,_a,tn,ga,ka,on,ba,va,ho,Ta,ya,wa,Ie,nn,za,xa,rn,$a,Pa,qa,H,sn,Ea,Ba,an,La,Da,dn,Ia,Na,cn,Aa,Fa,Sa,G,ln,Ca,Oa,pn,Wa,ja,mn,Ma,Ra,hn,Ua,Va,Ha,Ne,rt,Ga,un,Xa,Ya,Ae,st,Ja,fn,Ka,Qa,Fe,at,Za,_n,ei,ti,oe,it,oi,gn,ni,ri,Se,si,ne,dt,ai,kn,ii,di,bn,ci,li,Ce,ct,pi,vn,mi,hi,Oe,lt,ui,pt,fi,Tn,_i,gi,ki,re,mt,bi,uo,vi,fo,Ti,yi,yn,wi,zi,se,ht,xi,wn,$i,Pi,ut,qi,zn,Ei,Bi,Li,ae,ft,Di,xn,Ii,Ni,_t,Ai,$n,Fi,Si,Ci,ie,gt,Oi,Pn,Wi,ji,We,Mi,C,kt,Ri,bt,Ui,_o,Vi,Hi,Gi,je,Xi,qn,Yi,Ji,vt,Ki,Me,Tt,Qi,ve,Zi,En,ed,td,Bn,od,nd,rd,de,yt,sd,Ln,ad,id,ce,Dn,dd,cd,In,ld,pd,Nn,md,hd,ud,X,wt,fd,An,_d,gd,Q,kd,Fn,bd,vd,Sn,Td,yd,Cn,wd,zd,xd,Re,$d,Ue,zt,Pd,j,qd,On,Ed,Bd,Wn,Ld,Dd,jn,Id,Nd,Mn,Ad,Fd,Sd,Ve,xt,Cd,Rn,Od,Wd,Y,$t,jd,Pt,Md,Un,Rd,Ud,Vd,Vn,Hd,Gd,qt,Xd,le,Et,Yd,Bt,Jd,Hn,Kd,Qd,Zd,He,ec,J,Lt,tc,Gn,oc,nc,Dt,rc,Xn,sc,ac,ic,It,dc,Yn,cc,lc,pc,pe,Nt,mc,Jn,hc,uc,At,fc,Kn,_c,gc,kc,Ge,Ft,bc,St,vc,Qn,Tc,yc,wc,Xe,Ct,zc,Zn,xc,Lr,Te,Ye,er,Ot,$c,tr,Pc,Dr,A,Wt,qc,ye,Ec,go,Bc,Lc,ko,Dc,Ic,Nc,q,jt,Ac,or,Fc,Sc,nr,Cc,Oc,Mt,Wc,bo,jc,Mc,Rc,Rt,Uc,rr,Vc,Hc,Gc,Ut,sr,Xc,Yc,Vt,Jc,ar,Kc,Qc,Zc,M,el,vo,tl,ol,ir,nl,rl,dr,sl,al,cr,il,dl,cl,lr,ll,pl,Ht,ml,N,Gt,hl,pr,ul,fl,mr,_l,gl,Xt,kl,To,bl,vl,Tl,hr,yl,wl,Yt,zl,me,Jt,xl,we,$l,ur,Pl,ql,fr,El,Bl,Ll,_r,Dl,Ir,ze,Je,gr,Kt,Il,kr,Nl,Nr,xe,Qt,Al,$e,Fl,br,Sl,Cl,Ke,Ol,vr,Wl,jl,Ml,Ar,Pe,Zt,Rl,Tr,Ul,Fr,qe,eo,Vl,yr,Hl,Sr;return y=new gs({}),ot=new gs({}),nt=new w({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/tokenization_utils_base.py#L1428",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
The maximum length (in number of tokens) for the inputs to the transformer model. When the tokenizer is
loaded with <a href="/docs/transformers/pr_16444/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained">from_pretrained()</a>, this will be set to the
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16444/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16444/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_16444/en/main_classes/tokenizer#transformers.BatchEncoding"
...
<p><a
  href="/docs/transformers/pr_16444/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),We=new Pr({props:{warning:!0,$$slots:{default:[nh]},$$scope:{ctx:U}}}),kt=new w({props:{name:"from_pretrained",anchor:"transformers.PreTrainedTokenizerBase.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:": typing.Union[str, os.PathLike]"},{name:"*init_inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/tokenization_utils_base.py#L1546",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
Can be either:</p>
<ul>
...
using the <a href="/docs/transformers/pr_16444/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained">save_pretrained()</a> method, e.g.,
...
<code>additional_special_tokens</code>. See parameters in the <code>__init__</code> for more details.`,name:"kwargs"}]}}),je=new Pr({props:{$$slots:{default:[rh]},$$scope:{ctx:U}}}),vt=new _s({props:{code:`# We can't instantiate directly the base class *PreTrainedTokenizerBase* so let's show our examples on a derived class: BertTokenizer
...
`}}),yt=new w({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/tokenization_utils_base.py#L1534",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
`}}),wt=new w({props:{name:"pad",anchor:"transformers.PreTrainedTokenizerBase.pad",parameters:[{name:"encoded_inputs",val:": typing.Union[transformers.tokenization_utils_base.BatchEncoding, typing.List[transformers.tokenization_utils_base.BatchEncoding], typing.Dict[str, typing.List[int]], typing.Dict[str, typing.List[typing.List[int]]], typing.List[typing.Dict[str, typing.List[int]]]]"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = True"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"verbose",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/tokenization_utils_base.py#L2695",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.pad.encoded_inputs",description:`<strong>encoded_inputs</strong> (<a href="/docs/transformers/pr_16444/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, list of <a href="/docs/transformers/pr_16444/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <code>Dict[str, List[int]]</code>, <code>Dict[str, List[List[int]]</code> or <code>List[Dict[str, List[int]]]</code>) &#x2014;
Tokenized inputs. Can represent one input (<a href="/docs/transformers/pr_16444/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> or <code>Dict[str, List[int]]</code>) or a batch of
tokenized inputs (list of <a href="/docs/transformers/pr_16444/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <em>Dict[str, List[List[int]]]</em> or <em>List[Dict[str,
...
the note above for the return type.`,name:"encoded_inputs"},{anchor:"transformers.PreTrainedTokenizerBase.pad.padding",description:`<strong>padding</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16444/en/internal/file_utils#transformers.utils.PaddingStrategy">PaddingStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16444/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16444/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Activates and controls truncation. Accepts the following values:</p>
<ul>
<li><code>True</code> or <code>&apos;longest_first&apos;</code>: Truncate to a maximum length specified with the argument <code>max_length</code> or
to the maximum acceptable input length for the model if that argument is not provided. This will
...
Message to commit while pushing. Will default to <code>&quot;add tokenizer&quot;</code>.`,name:"commit_message"},{anchor:"transformers.utils.PushToHubMixin.push_to_hub.organization",description:`<strong>organization</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Organization in which you want to push your tokenizer (you must be a member of this organization).`,name:"organization"},{anchor:"transformers.utils.PushToHubMixin.push_to_hub.private",description:`<strong>private</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
<span class="hljs-keyword">assert</span> tokenizer.cls_token == <span class="hljs-string">&quot;&lt;CLS&gt;&quot;</span>`}}),Gt=new w({props:{name:"add_tokens",anchor:"transformers.SpecialTokensMixin.add_tokens",parameters:[{name:"new_tokens",val:": typing.Union[str, tokenizers.AddedToken, typing.List[typing.Union[str, tokenizers.AddedToken]]]"},{name:"special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16444/src/transformers/tokenization_utils_base.py#L900",parametersDescription:[{anchor:"transformers.SpecialTokensMixin.add_tokens.new_tokens",description:`<strong>new_tokens</strong> (<code>str</code>, <code>tokenizers.AddedToken</code> or a list of <em>str</em> or <code>tokenizers.AddedToken</code>) &#x2014;
...
Should be `),dn=r("code"),Ia=o("'right'"),Na=o(" or "),cn=r("code"),Aa=o("'left'"),Fa=o("."),Sa=d(),G=r("li"),ln=r("strong"),Ca=o("truncation_side"),Oa=o(" ("),pn=r("code"),Wa=o("str"),ja=o(`) \u2014 The default value for the side on which the model should have truncation
...
`),Sn=r("code"),Td=o("self.pad_token_id"),yd=o(" and "),Cn=r("code"),wd=o("self.pad_token_type_id"),zd=o(")"),xd=d(),u(Re.$$.fragment),$d=d(),Ue=r("div"),u(zt.$$.fragment),Pd=d(),j=r("p"),qd=o(`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
...
`),Un=r("code"),Rd=o("repo_path_or_name"),Ud=o("."),Vd=d(),Vn=r("p"),Hd=o("Examples:"),Gd=d(),u(qt.$$.fragment),Xd=d(),le=r("div"),u(Et.$$.fragment),Yd=d(),Bt=r("p"),Jd=o(`Register this class with a given auto class. This should only be used for custom tokenizers as the ones in the
library are already mapped with `),Hn=r("code"),Kd=o("AutoTokenizer"),Qd=o("."),Zd=d(),u(He.$$.fragment),ec=d(),J=r("div"),u(Lt.$$.fragment),tc=d(),Gn=r("p"),oc=o("Save the full tokenizer state."),nc=d(),Dt=r("p"),rc=o(`This method make sure the full tokenizer can then be re-loaded using the
...
makes it easy to develop model-agnostic training and fine-tuning scripts.`),Zc=d(),M=r("p"),el=o(`When possible, special tokens are already registered for provided pretrained models (for instance
...
`),cr=r("code"),il=o("'</s>'"),dl=o(")."),cl=d(),lr=r("p"),ll=o("Examples:"),pl=d(),u(Ht.$$.fragment),ml=d(),N=r("div"),u(Gt.$$.fragment),hl=d(),pr=r("p"),ul=o(`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
...
applied. Should be `),mn=s(Le,"CODE",{});var Lp=a(mn);Ma=n(Lp,"'right'"),Lp.forEach(t),Ra=n(Le," or "),hn=s(Le,"CODE",{});var Dp=a(hn);Ua=n(Dp,"'left'"),Dp.forEach(t),Va=n(Le,"."),Le.forEach(t),O.forEach(t),Ha=c(m),Ne=s(m,"DIV",{class:!0});var Or=a(Ne);f(rt.$$.fragment,Or),Ga=c(Or),un=s(Or,"P",{});var Ip=a(un);Xa=n(Ip,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
adding special tokens.`),Sp.forEach(t),di=c(zo),bn=s(zo,"P",{});var Cp=a(bn);ci=n(Cp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Cp.forEach(t),zo.forEach(t),li=c(m),Ce=s(m,"DIV",{class:!0});var Mr=a(Ce);f(ct.$$.fragment,Mr),pi=c(Mr),vn=s(Mr,"P",{});var Op=a(vn);mi=n(Op,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Op.forEach(t),Mr.forEach(t),hi=c(m),Oe=s(m,"DIV",{class:!0});var Rr=a(Oe);f(lt.$$.fragment,Rr),ui=c(Rr),pt=s(Rr,"P",{});var Ur=a(pt);fi=n(Ur,"Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=s(Ur,"CODE",{});var Wp=a(Tn);_i=n(Wp,'" ".join(tokens)'),Wp.forEach(t),gi=n(Ur,` but we
often want to remove sub-word tokenization artifacts at the same time.`),Ur.forEach(t),Rr.forEach(t),ki=c(m),re=s(m,"DIV",{class:!0});var xo=a(re);f(mt.$$.fragment,xo),bi=c(xo),uo=s(xo,"P",{});var Gl=a(uo);vi=n(Gl,"Create the token type IDs corresponding to the sequences passed. "),fo=s(Gl,"A",{href:!0});var jp=a(fo);Ti=n(jp,`What are token type
IDs?`),jp.forEach(t),Gl.forEach(t),yi=c(xo),yn=s(xo,"P",{});var Mp=a(yn);wi=n(Mp,"Should be overridden in a subclass if the model has a special way of building those."),Mp.forEach(t),xo.forEach(t),zi=c(m),se=s(m,"DIV",{class:!0});var $o=a(se);f(ht.$$.fragment,$o),xi=c($o),wn=s($o,"P",{});var Rp=a(wn);$i=n(Rp,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Rp.forEach(t),Pi=c($o),ut=s($o,"P",{});var Vr=a(ut);qi=n(Vr,"Similar to doing "),zn=s(Vr,"CODE",{});var Up=a(zn);Ei=n(Up,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Up.forEach(t),Bi=n(Vr,"."),Vr.forEach(t),$o.forEach(t),Li=c(m),ae=s(m,"DIV",{class:!0});var Po=a(ae);f(ft.$$.fragment,Po),Di=c(Po),xn=s(Po,"P",{});var Vp=a(xn);Ii=n(Vp,"Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Vp.forEach(t),Ni=c(Po),_t=s(Po,"P",{});var Hr=a(_t);Ai=n(Hr,"Same as doing "),$n=s(Hr,"CODE",{});var Hp=a($n);Fi=n(Hp,"self.convert_tokens_to_ids(self.tokenize(text))"),Hp.forEach(t),Si=n(Hr,"."),Hr.forEach(t),Po.forEach(t),Ci=c(m),ie=s(m,"DIV",{class:!0});var qo=a(ie);f(gt.$$.fragment,qo),Oi=c(qo),Pn=s(qo,"P",{});var Gp=a(Pn);Wi=n(Gp,"Tokenize and prepare for the model a sequence or a pair of sequences."),Gp.forEach(t),ji=c(qo),f(We.$$.fragment,qo),qo.forEach(t),Mi=c(m),C=s(m,"DIV",{class:!0});var he=a(C);f(kt.$$.fragment,he),Ri=c(he),bt=s(he,"P",{});var Gr=a(bt);Ui=n(Gr,"Instantiate a "),_o=s(Gr,"A",{href:!0});var Xp=a(_o);Vi=n(Xp,"PreTrainedTokenizerBase"),Xp.forEach(t),Hi=n(Gr,` (or a derived class) from a predefined
tokenizer.`),Gr.forEach(t),Gi=c(he),f(je.$$.fragment,he),Xi=c(he),qn=s(he,"P",{});var Yp=a(qn);Yi=n(Yp,"Examples:"),Yp.forEach(t),Ji=c(he),f(vt.$$.fragment,he),he.forEach(t),Ki=c(m),Me=s(m,"DIV",{class:!0});var Xr=a(Me);f(Tt.$$.fragment,Xr),Qi=c(Xr),ve=s(Xr,"P",{});var Eo=a(ve);Zi=n(Eo,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
different than `),Wn=s(ue,"CODE",{});var im=a(Wn);Ld=n(im,"None"),im.forEach(t),Dd=n(ue," and "),jn=s(ue,"EM",{});var dm=a(jn);Id=n(dm,"truncation_strategy = longest_first"),dm.forEach(t),Nd=n(ue," or "),Mn=s(ue,"CODE",{});var cm=a(Mn);Ad=n(cm,"True"),cm.forEach(t),Fd=n(ue,`, it is not possible to return
...
makes it easy to develop model-agnostic training and fine-tuning scripts.`),cs.forEach(t),ds.forEach(t),Zc=c(L),M=s(L,"P",{});var _e=a(M);el=n(_e,`When possible, special tokens are already registered for provided pretrained models (for instance
...
`),cr=s(_e,"CODE",{});var Am=a(cr);il=n(Am,"'</s>'"),Am.forEach(t),dl=n(_e,")."),_e.forEach(t),cl=c(L),lr=s(L,"P",{});var Fm=a(lr);ll=n(Fm,"Examples:"),Fm.forEach(t),pl=c(L),f(Ht.$$.fragment,L),L.forEach(t),ml=c(fe),N=s(fe,"DIV",{class:!0});var K=a(N);f(Gt.$$.fragment,K),hl=c(K),pr=s(K,"P",{});var Sm=a(pr);ul=n(Sm,`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
