...
- local: transformers.MaskFormerPretrainedModel
  title: MaskFormerPretrainedModel
...
- **num_labels** (`int`, *optional*, defaults to `150`) --
  The number of labels.</paramsdesc><paramgroups>0</paramgroups><raises>- `ValueError` -- Raised if the backbone model type selected is not in `MaskFormerConfig.backbones_supported`</raises><raisederrors>`ValueError`</raisederrors></docstring>
...
<div class="docstring">
<docstring><name>from\_backbone\_and\_detr\_configs</name><anchor>transformers.MaskFormerConfig.from_backbone_and_detr_configs</anchor><source>https://github.com/huggingface/transformers/blob/pr_15682/src/transformers/models/maskformer/configuration_maskformer.py#L151</source><parameters>[{"name": "backbone_config", "val": ": PretrainedConfig"}, {"name": "detr_config", "val": ": DetrConfig"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **backbone_config** ([PretrainedConfig](/docs/transformers/pr_15682/en/main_classes/configuration#transformers.PretrainedConfig)) --
...
- **annotations** (`Dict`, `List[Dict]`, *optional*) --
  The corresponding annotations as numpy arrays in the following format: &amp;lcub; "masks" : the target mask,
...
<div class="docstring">
<docstring><name>post\_process\_segmentation</name><anchor>transformers.MaskFormerFeatureExtractor.post_process_segmentation</anchor><source>https://github.com/huggingface/transformers/blob/pr_15682/src/transformers/models/maskformer/feature_extraction_maskformer.py#L376</source><parameters>[{"name": "outputs", "val": ": MaskFormerForInstanceSegmentationOutput"}, {"name": "target_size", "val": ": typing.Tuple[int, int] = None"}]</parameters><paramsdesc>- **outputs** (`MaskFormerForInstanceSegmentationOutput`) --
...
<div class="docstring">
<docstring><name>post\_process\_semantic\_segmentation</name><anchor>transformers.MaskFormerFeatureExtractor.post_process_semantic_segmentation</anchor><source>https://github.com/huggingface/transformers/blob/pr_15682/src/transformers/models/maskformer/feature_extraction_maskformer.py#L444</source><parameters>[{"name": "outputs", "val": ": MaskFormerForInstanceSegmentationOutput"}, {"name": "target_size", "val": ": typing.Tuple[int, int] = None"}]</parameters><paramsdesc>- **outputs** (`MaskFormerForInstanceSegmentationOutput`) --
...
<div class="docstring">
<docstring><name>post\_process\_panoptic\_segmentation</name><anchor>transformers.MaskFormerFeatureExtractor.post_process_panoptic_segmentation</anchor><source>https://github.com/huggingface/transformers/blob/pr_15682/src/transformers/models/maskformer/feature_extraction_maskformer.py#L462</source><parameters>[{"name": "outputs", "val": ": MaskFormerForInstanceSegmentationOutput"}, {"name": "object_mask_threshold", "val": ": float = 0.8"}, {"name": "overlap_mask_area_threshold", "val": ": float = 0.8"}, {"name": "is_thing_map", "val": ": typing.Union[typing.Dict[int, bool], NoneType] = None"}]</parameters><paramsdesc>- **outputs** (`MaskFormerForInstanceSegmentationOutput`) --
...
- **is_thing_map** (`Dict[int, bool]`, *optional*, defaults to `None`) --
  ...
  If not set, defaults to the `is_thing_map` of ADE20K-150 panoptic.</paramsdesc><paramgroups>0</paramgroups><rettype>`List[Dict]`</rettype><retdesc>A list of dictionaries, one per image, each dictionary containing two keys:
...
<h2 id="transformers.MaskFormerPretrainedModel">MaskFormerPretrainedModel</h2>
