...
<div class="docstring">
<docstring><name>post\_process\_panoptic\_segmentation</name><anchor>transformers.MaskFormerFeatureExtractor.post_process_panoptic_segmentation</anchor><source>https://github.com/huggingface/transformers/blob/pr_15682/src/transformers/models/maskformer/feature_extraction_maskformer.py#L464</source><parameters>[{"name": "outputs", "val": ": MaskFormerForInstanceSegmentationOutput"}, {"name": "object_mask_threshold", "val": ": float = 0.8"}, {"name": "overlap_mask_area_threshold", "val": ": float = 0.8"}, {"name": "is_thing_map", "val": ": typing.Union[typing.Dict[int, bool], NoneType] = None"}]</parameters><paramsdesc>- **outputs** (`MaskFormerForInstanceSegmentationOutput`) --
...
<docstring><name>class transformers.MaskFormerModel</name><anchor>transformers.MaskFormerModel</anchor><source>https://github.com/huggingface/transformers/blob/pr_15682/src/transformers/models/maskformer/modeling_maskformer.py#L2275</source><parameters>[{"name": "config", "val": ": MaskFormerConfig"}]</parameters><paramsdesc>- **config** ([MaskFormerConfig](/docs/transformers/pr_15682/en/model_doc/maskformer#transformers.MaskFormerConfig)) -- Model configuration class with all the parameters of the model.
