...
`}}),As=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.RobertaTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/roberta/tokenization_roberta.py#L365",parametersDescription:[{anchor:"transformers.RobertaTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),or=new ye({}),nr=new j({props:{name:"class transformers.RobertaForCausalLM",anchor:"transformers.RobertaForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/roberta/modeling_roberta.py#L882",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15845/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15845/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lr=new j({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/roberta/modeling_roberta.py#L908",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15845/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),br=new ye({}),kr=new j({props:{name:"class transformers.RobertaForSequenceClassification",anchor:"transformers.RobertaForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/roberta/modeling_roberta.py#L1163",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15845/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15845/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wr=new j({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/roberta/modeling_roberta.py#L1177",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15845/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),Rr=new ye({}),Mr=new j({props:{name:"class transformers.RobertaForMultipleChoice",anchor:"transformers.RobertaForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/roberta/modeling_roberta.py#L1261",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15845/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15845/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qr=new j({props:{name:"forward",anchor:"transformers.RobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/roberta/modeling_roberta.py#L1274",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15845/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df.forEach(t),Cv=d(At),y(ts.$$.fragment,At),Pv=d(At),mt=s(At,"DIV",{class:!0});var ho=r(mt);y(qa.$$.fragment,ho),jv=d(ho),Zo=s(ho,"P",{});var hd=r(Zo);Lv=i(hd,"The "),Il=s(hd,"A",{href:!0});var Z4=r(Il);Av=i(Z4,"TFRobertaForTokenClassification"),Z4.forEach(t),Ov=i(hd," forward method, overrides the "),sp=s(hd,"CODE",{});var e5=r(sp);Nv=i(e5,"__call__"),e5.forEach(t),Iv=i(hd," special method."),hd.forEach(t),Dv=d(ho),y(os.$$.fragment,ho),Sv=d(ho),rp=s(ho,"P",{});var t5=r(rp);Wv=i(t5,"Example:"),t5.forEach(t),Bv=d(ho),y(Ca.$$.fragment,ho),ho.forEach(t),At.forEach(t),Fu=d(o),en=s(o,"H2",{class:!0});var Sf=r(en);ns=s(Sf,"A",{id:!0,class:!0,href:!0});var o5=r(ns);ap=s(o5,"SPAN",{});var n5=r(ap);y(Pa.$$.fragment,n5),n5.forEach(t),o5.forEach(t),Uv=d(Sf),ip=s(Sf,"SPAN",{});var s5=r(ip);Hv=i(s5,"TFRobertaForQuestionAnswering"),s5.forEach(t),Sf.forEach(t),Ru=d(o),Ke=s(o,"DIV",{class:!0});var Ot=r(Ke);y(ja.$$.fragment,Ot),Qv=d(Ot),tn=s(Ot,"P",{});var ud=r(tn);Vv=i(ud,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),lp=s(ud,"CODE",{});var r5=r(lp);Jv=i(r5,"span start logits"),r5.forEach(t),Kv=i(ud," and "),dp=s(ud,"CODE",{});var a5=r(dp);Gv=i(a5,"span end logits"),a5.forEach(t),Xv=i(ud,")."),ud.forEach(t),Yv=d(Ot),La=s(Ot,"P",{});var Wf=r(La);Zv=i(Wf,"This model inherits from "),Dl=s(Wf,"A",{href:!0});var i5=r(Dl);e1=i(i5,"TFPreTrainedModel"),i5.forEach(t),t1=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),o1=d(Ot),Aa=s(Ot,"P",{});var Bf=r(Aa);n1=i(Bf,"This model is also a "),Oa=s(Bf,"A",{href:!0,rel:!0});var l5=r(Oa);s1=i(l5,"tf.keras.Model"),l5.forEach(t),r1=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),a1=d(Ot),y(ss.$$.fragment,Ot),i1=d(Ot),gt=s(Ot,"DIV",{class:!0});var uo=r(gt);y(Na.$$.fragment,uo),l1=d(uo),on=s(uo,"P",{});var fd=r(on);d1=i(fd,"The "),Sl=s(fd,"A",{href:!0});var d5=r(Sl);c1=i(d5,"TFRobertaForQuestionAnswering"),d5.forEach(t),p1=i(fd," forward method, overrides the "),cp=s(fd,"CODE",{});var c5=r(cp);h1=i(c5,"__call__"),c5.forEach(t),u1=i(fd," special method."),fd.forEach(t),f1=d(uo),y(rs.$$.fragment,uo),m1=d(uo),pp=s(uo,"P",{});var p5=r(pp);g1=i(p5,"Example:"),p5.forEach(t),_1=d(uo),y(Ia.$$.fragment,uo),uo.forEach(t),Ot.forEach(t),Mu=d(o),nn=s(o,"H2",{class:!0});var Uf=r(nn);as=s(Uf,"A",{id:!0,class:!0,href:!0});var h5=r(as);hp=s(h5,"SPAN",{});var u5=r(hp);y(Da.$$.fragment,u5),u5.forEach(t),h5.forEach(t),b1=d(Uf),up=s(Uf,"SPAN",{});var f5=r(up);k1=i(f5,"FlaxRobertaModel"),f5.forEach(t),Uf.forEach(t),Eu=d(o),Le=s(o,"DIV",{class:!0});var Ft=r(Le);y(Sa.$$.fragment,Ft),T1=d(Ft),fp=s(Ft,"P",{});var m5=r(fp);y1=i(m5,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),m5.forEach(t),v1=d(Ft),Wa=s(Ft,"P",{});var Hf=r(Wa);w1=i(Hf,"This model inherits from "),Wl=s(Hf,"A",{href:!0});var g5=r(Wl);$1=i(g5,"FlaxPreTrainedModel"),g5.forEach(t),F1=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hf.forEach(t),R1=d(Ft),Ba=s(Ft,"P",{});var Qf=r(Ba);M1=i(Qf,"This model is also a Flax Linen "),Ua=s(Qf,"A",{href:!0,rel:!0});var _5=r(Ua);E1=i(_5,"flax.linen.Module"),_5.forEach(t),z1=i(Qf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qf.forEach(t),x1=d(Ft),mp=s(Ft,"P",{});var b5=r(mp);q1=i(b5,"Finally, this model supports inherent JAX features such as:"),b5.forEach(t),C1=d(Ft),Nt=s(Ft,"UL",{});var bs=r(Nt);gp=s(bs,"LI",{});var k5=r(gp);Ha=s(k5,"A",{href:!0,rel:!0});var T5=r(Ha);P1=i(T5,"Just-In-Time (JIT) compilation"),T5.forEach(t),k5.forEach(t),j1=d(bs),_p=s(bs,"LI",{});var y5=r(_p);Qa=s(y5,"A",{href:!0,rel:!0});var v5=r(Qa);L1=i(v5,"Automatic Differentiation"),v5.forEach(t),y5.forEach(t),A1=d(bs),bp=s(bs,"LI",{});var w5=r(bp);Va=s(w5,"A",{href:!0,rel:!0});var $5=r(Va);O1=i($5,"Vectorization"),$5.forEach(t),w5.forEach(t),N1=d(bs),kp=s(bs,"LI",{});var F5=r(kp);Ja=s(F5,"A",{href:!0,rel:!0});var R5=r(Ja);I1=i(R5,"Parallelization"),R5.forEach(t),F5.forEach(t),bs.forEach(t),D1=d(Ft),_t=s(Ft,"DIV",{class:!0});var fo=r(_t);y(Ka.$$.fragment,fo),S1=d(fo),sn=s(fo,"P",{});var md=r(sn);W1=i(md,"The "),Tp=s(md,"CODE",{});var M5=r(Tp);B1=i(M5,"FlaxRobertaPreTrainedModel"),M5.forEach(t),U1=i(md,"forward method, overrides the "),yp=s(md,"CODE",{});var E5=r(yp);H1=i(E5,"__call__"),E5.forEach(t),Q1=i(md," special method."),md.forEach(t),V1=d(fo),y(is.$$.fragment,fo),J1=d(fo),vp=s(fo,"P",{});var z5=r(vp);K1=i(z5,"Example:"),z5.forEach(t),G1=d(fo),y(Ga.$$.fragment,fo),fo.forEach(t),Ft.forEach(t),zu=d(o),rn=s(o,"H2",{class:!0});var Vf=r(rn);ls=s(Vf,"A",{id:!0,class:!0,href:!0});var x5=r(ls);wp=s(x5,"SPAN",{});var q5=r(wp);y(Xa.$$.fragment,q5),q5.forEach(t),x5.forEach(t),X1=d(Vf),$p=s(Vf,"SPAN",{});var C5=r($p);Y1=i(C5,"FlaxRobertaForMaskedLM"),C5.forEach(t),Vf.forEach(t),xu=d(o),Ae=s(o,"DIV",{class:!0});var Rt=r(Ae);y(Ya.$$.fragment,Rt),Z1=d(Rt),Za=s(Rt,"P",{});var Jf=r(Za);ew=i(Jf,"RoBERTa Model with a "),Fp=s(Jf,"CODE",{});var P5=r(Fp);tw=i(P5,"language modeling"),P5.forEach(t),ow=i(Jf," head on top."),Jf.forEach(t),nw=d(Rt),ei=s(Rt,"P",{});var Kf=r(ei);sw=i(Kf,"This model inherits from "),Bl=s(Kf,"A",{href:!0});var j5=r(Bl);rw=i(j5,"FlaxPreTrainedModel"),j5.forEach(t),aw=i(Kf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Kf.forEach(t),iw=d(Rt),ti=s(Rt,"P",{});var Gf=r(ti);lw=i(Gf,"This model is also a Flax Linen "),oi=s(Gf,"A",{href:!0,rel:!0});var L5=r(oi);dw=i(L5,"flax.linen.Module"),L5.forEach(t),cw=i(Gf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Gf.forEach(t),pw=d(Rt),Rp=s(Rt,"P",{});var A5=r(Rp);hw=i(A5,"Finally, this model supports inherent JAX features such as:"),A5.forEach(t),uw=d(Rt),It=s(Rt,"UL",{});var ks=r(It);Mp=s(ks,"LI",{});var O5=r(Mp);ni=s(O5,"A",{href:!0,rel:!0});var N5=r(ni);fw=i(N5,"Just-In-Time (JIT) compilation"),N5.forEach(t),O5.forEach(t),mw=d(ks),Ep=s(ks,"LI",{});var I5=r(Ep);si=s(I5,"A",{href:!0,rel:!0});var D5=r(si);gw=i(D5,"Automatic Differentiation"),D5.forEach(t),I5.forEach(t),_w=d(ks),zp=s(ks,"LI",{});var S5=r(zp);ri=s(S5,"A",{href:!0,rel:!0});var W5=r(ri);bw=i(W5,"Vectorization"),W5.forEach(t),S5.forEach(t),kw=d(ks),xp=s(ks,"LI",{});var B5=r(xp);ai=s(B5,"A",{href:!0,rel:!0});var U5=r(ai);Tw=i(U5,"Parallelization"),U5.forEach(t),B5.forEach(t),ks.forEach(t),yw=d(Rt),bt=s(Rt,"DIV",{class:!0});var mo=r(bt);y(ii.$$.fragment,mo),vw=d(mo),an=s(mo,"P",{});var gd=r(an);ww=i(gd,"The "),qp=s(gd,"CODE",{});var H5=r(qp);$w=i(H5,"FlaxRobertaPreTrainedModel"),H5.forEach(t),Fw=i(gd,"forward method, overrides the "),Cp=s(gd,"CODE",{});var Q5=r(Cp);Rw=i(Q5,"__call__"),Q5.forEach(t),Mw=i(gd," special method."),gd.forEach(t),Ew=d(mo),y(ds.$$.fragment,mo),zw=d(mo),Pp=s(mo,"P",{});var V5=r(Pp);xw=i(V5,"Example:"),V5.forEach(t),qw=d(mo),y(li.$$.fragment,mo),mo.forEach(t),Rt.forEach(t),qu=d(o),ln=s(o,"H2",{class:!0});var Xf=r(ln);cs=s(Xf,"A",{id:!0,class:!0,href:!0});var J5=r(cs);jp=s(J5,"SPAN",{});var K5=r(jp);y(di.$$.fragment,K5),K5.forEach(t),J5.forEach(t),Cw=d(Xf),Lp=s(Xf,"SPAN",{});var G5=r(Lp);Pw=i(G5,"FlaxRobertaForSequenceClassification"),G5.forEach(t),Xf.forEach(t),Cu=d(o),Oe=s(o,"DIV",{class:!0});var Mt=r(Oe);y(ci.$$.fragment,Mt),jw=d(Mt),Ap=s(Mt,"P",{});var X5=r(Ap);Lw=i(X5,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X5.forEach(t),Aw=d(Mt),pi=s(Mt,"P",{});var Yf=r(pi);Ow=i(Yf,"This model inherits from "),Ul=s(Yf,"A",{href:!0});var Y5=r(Ul);Nw=i(Y5,"FlaxPreTrainedModel"),Y5.forEach(t),Iw=i(Yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Yf.forEach(t),Dw=d(Mt),hi=s(Mt,"P",{});var Zf=r(hi);Sw=i(Zf,"This model is also a Flax Linen "),ui=s(Zf,"A",{href:!0,rel:!0});var Z5=r(ui);Ww=i(Z5,"flax.linen.Module"),Z5.forEach(t),Bw=i(Zf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
