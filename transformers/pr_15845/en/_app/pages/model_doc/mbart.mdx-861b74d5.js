...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15845/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15845/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15845/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Wz]},$$scope:{ctx:E}}}),Is=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15845/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Ni=s(ho);lk=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var d5=s(gi);ck=i(d5,"MBartModel"),d5.forEach(t),pk=i(Ni," forward method, overrides the "),El=a(Ni,"CODE",{});var l5=s(El);hk=i(l5,"__call__"),l5.forEach(t),uk=i(Ni," special method."),Ni.forEach(t),mk=l(St),f(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var c5=s(Pl);_k=i(c5,"Example:"),c5.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p5=s(tn);Cl=a(p5,"SPAN",{});var h5=s(Cl);f(Ya.$$.fragment,h5),h5.forEach(t),p5.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var u5=s(Sl);bk=i(u5,"MBartForConditionalGeneration"),u5.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var Fn=s(Je);f(es.$$.fragment,Fn),yk=l(Fn),ts=a(Fn,"P",{});var au=s(ts);vk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l(Fn),os=a(Fn,"P",{});var su=s(os);xk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var f5=s(ns);zk=i(f5,"torch.nn.Module"),f5.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l(Fn),Z=a(Fn,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),Fk=l(Le),mo=a(Le,"P",{});var Di=s(mo);$k=i(Di,"The "),bi=a(Di,"A",{href:!0});var _5=s(bi);jk=i(_5,"MBartForConditionalGeneration"),_5.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var g5=s(Al);Pk=i(g5,"__call__"),g5.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(on.$$.fragment,Le),Ak=l(Le),Ol=a(Le,"P",{});var k5=s(Ol);Ok=i(k5,"Translation example:"),k5.forEach(t),Ik=l(Le),f(ss.$$.fragment,Le),Nk=l(Le),Il=a(Le,"P",{});var b5=s(Il);Dk=i(b5,"Mask filling example:"),b5.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),Fn.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var y5=s(nn);Nl=a(y5,"SPAN",{});var v5=s(Nl);f(is.$$.fragment,v5),v5.forEach(t),y5.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T5=s(Dl);Wk=i(T5,"MBartForQuestionAnswering"),T5.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var M5=s(Ll);Xk=i(M5,"span start logits"),M5.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var w5=s(Gl);Vk=i(w5,"span end logits"),w5.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(At),ls=a(At,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),yi=a(iu,"A",{href:!0});var x5=s(yi);Zk=i(x5,"PreTrainedModel"),x5.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var Ot=s(Ae);f(hs.$$.fragment,Ot),sb=l(Ot),go=a(Ot,"P",{});var Gi=s(go);rb=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var q5=s(vi);ib=i(q5,"MBartForQuestionAnswering"),q5.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var B5=s(Wl);lb=i(B5,"__call__"),B5.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(Ot),f(an.$$.fragment,Ot),hb=l(Ot),Rl=a(Ot,"P",{});var F5=s(Rl);ub=i(F5,"Example:"),F5.forEach(t),mb=l(Ot),f(us.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var $5=s(sn);Ul=a($5,"SPAN",{});var j5=s(Ul);f(ms.$$.fragment,j5),j5.forEach(t),$5.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E5=s(Xl);_b=i(E5,"MBartForSequenceClassification"),E5.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var It=s(Be);f(fs.$$.fragment,It),gb=l(It),Hl=a(It,"P",{});var P5=s(Hl);kb=i(P5,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),P5.forEach(t),bb=l(It),_s=a(It,"P",{});var cu=s(_s);yb=i(cu,"This model inherits from "),Ti=a(cu,"A",{href:!0});var C5=s(Ti);vb=i(C5,"PreTrainedModel"),C5.forEach(t),Tb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(It),gs=a(It,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var S5=s(ks);xb=i(S5,"torch.nn.Module"),S5.forEach(t),zb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(It),Y=a(It,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);Fb=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var A5=s(Mi);$b=i(A5,"MBartForSequenceClassification"),A5.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var O5=s(Vl);Eb=i(O5,"__call__"),O5.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var I5=s(Ql);Ab=i(I5,"Example of single-label classification:"),I5.forEach(t),Ob=l(Ge),f(ys.$$.fragment,Ge),Ib=l(Ge),Jl=a(Ge,"P",{});var N5=s(Jl);Nb=i(N5,"Example of multi-label classification:"),N5.forEach(t),Db=l(Ge),f(vs.$$.fragment,Ge),Ge.forEach(t),It.forEach(t),Jp=l(o),yo=a(o,"H2",{class:!0});var hu=s(yo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D5=s(dn);Kl=a(D5,"SPAN",{});var L5=s(Kl);f(Ts.$$.fragment,L5),L5.forEach(t),D5.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G5=s(Zl);Gb=i(G5,"MBartForCausalLM"),G5.forEach(t),hu.forEach(t),Kp=l(o),vo=a(o,"DIV",{class:!0});var uu=s(vo);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var W5=s(Yl);Ub=i(W5,"Example:"),W5.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var R5=s(ln);ec=a(R5,"SPAN",{});var U5=s(ec);f(zs.$$.fragment,U5),U5.forEach(t),R5.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X5=s(tc);Vb=i(X5,"TFMBartModel"),X5.forEach(t),mu.forEach(t),Yp=l(o),Fe=a(o,"DIV",{class:!0});var Nt=s(Fe);f(qs.$$.fragment,Nt),Qb=l(Nt),Bs=a(Nt,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Nt),Fs=a(Nt,"P",{});var _u=s(Fs);ey=i(_u,"This model is also a "),$s=a(_u,"A",{href:!0,rel:!0});var V5=s($s);ty=i(V5,"tf.keras.Model"),V5.forEach(t),oy=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),ny=l(Nt),f(cn.$$.fragment,Nt),ay=l(Nt),Oe=a(Nt,"DIV",{class:!0});var Dt=s(Oe);f(js.$$.fragment,Dt),sy=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);ry=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q5=s(xi);iy=i(Q5,"TFMBartModel"),Q5.forEach(t),dy=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J5=s(oc);ly=i(J5,"__call__"),J5.forEach(t),cy=i(Ui," special method."),Ui.forEach(t),py=l(Dt),f(pn.$$.fragment,Dt),hy=l(Dt),nc=a(Dt,"P",{});var K5=s(nc);uy=i(K5,"Example:"),K5.forEach(t),my=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z5=s(hn);ac=a(Z5,"SPAN",{});var Y5=s(ac);f(Ps.$$.fragment,Y5),Y5.forEach(t),Z5.forEach(t),fy=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_y=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),$e=a(o,"DIV",{class:!0});var Lt=s($e);f(Cs.$$.fragment,Lt),gy=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);ky=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
