...
<p>A <a
  href="/docs/transformers/pr_15845/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15845/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_15845/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Us=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15845/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/t5/modeling_t5.py#L1808",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15845/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_15845/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15845/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[yw]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/t5/modeling_tf_t5.py#L1357",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15845/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15845/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15845/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[xw]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15845/src/transformers/models/t5/modeling_tf_t5.py#L1688",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15845/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15845/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15845/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15845/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15845/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15845/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15845/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15845/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15845/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
behavior.`),WT=d(),f(Yn.$$.fragment),UT=d(),Ze=o("div"),f(ha.$$.fragment),RT=d(),_n=o("p"),HT=r("The "),Pr=o("a"),VT=r("TFT5Model"),KT=r(" forward method, overrides the "),cl=o("code"),YT=r("__call__"),ZT=r(" special method."),JT=d(),f(Zn.$$.fragment),XT=d(),pl=o("p"),QT=r("Examples:"),e5=d(),f(ua.$$.fragment),Cc=d(),gn=o("h2"),Jn=o("a"),hl=o("span"),f(ma.$$.fragment),t5=d(),ul=o("span"),n5=r("TFT5ForConditionalGeneration"),Oc=d(),le=o("div"),f(fa.$$.fragment),o5=d(),_a=o("p"),s5=r("T5 Model with a "),ml=o("code"),a5=r("language modeling"),r5=r(" head on top."),i5=d(),ga=o("p"),d5=r("The T5 model was proposed in "),Ta=o("a"),l5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),c5=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),p5=d(),va=o("p"),h5=r("This model inherits from "),Cr=o("a"),u5=r("TFPreTrainedModel"),m5=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),f5=d(),ka=o("p"),_5=r("This model is also a "),ba=o("a"),g5=r("tf.keras.Model"),T5=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),v5=d(),f(Xn.$$.fragment),k5=d(),Je=o("div"),f(ya.$$.fragment),b5=d(),Tn=o("p"),y5=r("The "),Or=o("a"),w5=r("TFT5ForConditionalGeneration"),x5=r(" forward method, overrides the "),fl=o("code"),z5=r("__call__"),$5=r(" special method."),q5=d(),f(Qn.$$.fragment),E5=d(),_l=o("p"),j5=r("Examples:"),F5=d(),f(wa.$$.fragment),Ac=d(),vn=o("h2"),eo=o("a"),gl=o("span"),f(xa.$$.fragment),M5=d(),Tl=o("span"),P5=r("TFT5EncoderModel"),Lc=d(),ce=o("div"),f(za.$$.fragment),C5=d(),vl=o("p"),O5=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),A5=d(),$a=o("p"),L5=r("The T5 model was proposed in "),qa=o("a"),I5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),N5=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),D5=d(),Ea=o("p"),S5=r("This model inherits from "),Ar=o("a"),G5=r("TFPreTrainedModel"),B5=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),W5=d(),ja=o("p"),U5=r("This model is also a "),Fa=o("a"),R5=r("tf.keras.Model"),H5=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),V5=d(),f(to.$$.fragment),K5=d(),Xe=o("div"),f(Ma.$$.fragment),Y5=d(),kn=o("p"),Z5=r("The "),Lr=o("a"),J5=r("TFT5EncoderModel"),X5=r(" forward method, overrides the "),kl=o("code"),Q5=r("__call__"),ev=r(" special method."),tv=d(),f(no.$$.fragment),nv=d(),bl=o("p"),ov=r("Examples:"),sv=d(),f(Pa.$$.fragment),Ic=d(),bn=o("h2"),oo=o("a"),yl=o("span"),f(Ca.$$.fragment),av=d(),wl=o("span"),rv=r("FlaxT5Model"),Nc=d(),lt=o("div"),f(Oa.$$.fragment),iv=d(),Qe=o("div"),f(Aa.$$.fragment),dv=d(),yn=o("p"),lv=r("The "),xl=o("code"),cv=r("FlaxT5PreTrainedModel"),pv=r("forward method, overrides the "),zl=o("code"),hv=r("__call__"),uv=r(" special method."),mv=d(),f(so.$$.fragment),fv=d(),$l=o("p"),_v=r("Example:"),gv=d(),f(La.$$.fragment),Tv=d(),Mt=o("div"),f(Ia.$$.fragment),vv=d(),ql=o("p"),kv=r("Example:"),bv=d(),f(Na.$$.fragment),yv=d(),Pt=o("div"),f(Da.$$.fragment),wv=d(),El=o("p"),xv=r("Example:"),zv=d(),f(Sa.$$.fragment),Dc=d(),wn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),$v=d(),Fl=o("span"),qv=r("FlaxT5ForConditionalGeneration"),Sc=d(),ct=o("div"),f(Ba.$$.fragment),Ev=d(),et=o("div"),f(Wa.$$.fragment),jv=d(),xn=o("p"),Fv=r("The "),Ml=o("code"),Mv=r("FlaxT5PreTrainedModel"),Pv=r("forward method, overrides the "),Pl=o("code"),Cv=r("__call__"),Ov=r(" special method."),Av=d(),f(ro.$$.fragment),Lv=d(),Cl=o("p"),Iv=r("Example:"),Nv=d(),f(Ua.$$.fragment),Dv=d(),Ct=o("div"),f(Ra.$$.fragment),Sv=d(),Ol=o("p"),Gv=r("Example:"),Bv=d(),f(Ha.$$.fragment),Wv=d(),Ot=o("div"),f(Va.$$.fragment),Uv=d(),Al=o("p"),Rv=r("Example:"),Hv=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_w('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),$=l(n),b=s(n,"H1",{class:!0});var Ya=a(b);w=s(Ya,"A",{id:!0,class:!0,href:!0});var Ll=a(w);z=s(Ll,"SPAN",{});var Il=a(z);_(x.$$.fragment,Il),Il.forEach(t),Ll.forEach(t),y=l(Ya),q=s(Ya,"SPAN",{});var Nl=a(q);qe=i(Nl,"T5"),Nl.forEach(t),Ya.forEach(t),oe=l(n),E=s(n,"H2",{class:!0});var Za=a(E);ee=s(Za,"A",{id:!0,class:!0,href:!0});var Dl=a(ee);S=s(Dl,"SPAN",{});var Sl=a(S);_(se.$$.fragment,Sl),Sl.forEach(t),Dl.forEach(t),Ee=l(Za),G=s(Za,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Za.forEach(t),ke=l(n),B=s(n,"P",{});var Ja=a(B);I=i(Ja,"The T5 model was presented in "),ae=s(Ja,"A",{href:!0,rel:!0});var Bl=a(ae);pe=i(Bl,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Bl.forEach(t),F=i(Ja,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
with scale and our new \u201CColossal Clean Crawled Corpus\u201D, we achieve state-of-the-art results on many benchmarks covering
summarization, question answering, text classification, and more. To facilitate future work on transfer learning for
NLP, we release our dataset, pre-trained models, and code.`),Qv.forEach(t),Xv.forEach(t),ye=l(n),P=s(n,"P",{});var ek=a(P);Me=i(ek,"Tips:"),ek.forEach(t),H=l(n),V=s(n,"UL",{});var Ir=a(V);me=s(Ir,"LI",{});var tk=a(me);O=s(tk,"P",{});var Nr=a(O);Pe=i(Nr,`T5 is an encoder-decoder model pre-trained on a multi-task mixture of unsupervised and supervised tasks and for which
each task is converted into a text-to-text format. T5 works well on a variety of tasks out-of-the-box by prepending a
different prefix to the input corresponding to each task, e.g., for translation: `),fe=s(Nr,"EM",{});var nk=a(fe);N=i(nk,"translate English to German: \u2026"),nk.forEach(t),Ce=i(Nr,`,
for summarization: `),U=s(Nr,"EM",{});var ok=a(U);Oe=i(ok,"summarize: \u2026"),ok.forEach(t),m=i(Nr,"."),Nr.forEach(t),tk.forEach(t),j=l(Ir),te=s(Ir,"LI",{});var sk=a(te);Se=s(sk,"P",{});var ak=a(Se);pt=i(ak,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),ak.forEach(t),sk.forEach(t),D=l(Ir),Ge=s(Ir,"LI",{});var rk=a(Ge);ne=s(rk,"P",{});var io=a(ne);ht=i(io,"See the "),A=s(io,"A",{href:!0});var ik=a(A);Y=i(ik,"training"),ik.forEach(t),ut=i(io,", "),Ae=s(io,"A",{href:!0});var dk=a(Ae);Z=i(dk,"inference"),dk.forEach(t),mt=i(io," and "),Le=s(io,"A",{href:!0});var lk=a(Le);Ie=i(lk,"scripts"),lk.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rk.forEach(t),Ir.forEach(t),Vl=l(n),Xa=s(n,"P",{});var ck=a(Xa);Dp=i(ck,"T5 comes in different sizes:"),ck.forEach(t),Kl=l(n),Be=s(n,"UL",{});var At=a(Be);di=s(At,"LI",{});var pk=a(di);li=s(pk,"P",{});var hk=a(li);To=s(hk,"A",{href:!0,rel:!0});var uk=a(To);Sp=i(uk,"t5-small"),uk.forEach(t),hk.forEach(t),pk.forEach(t),Gp=l(At),ci=s(At,"LI",{});var mk=a(ci);pi=s(mk,"P",{});var fk=a(pi);vo=s(fk,"A",{href:!0,rel:!0});var _k=a(vo);Bp=i(_k,"t5-base"),_k.forEach(t),fk.forEach(t),mk.forEach(t),Wp=l(At),hi=s(At,"LI",{});var gk=a(hi);ui=s(gk,"P",{});var Tk=a(ui);ko=s(Tk,"A",{href:!0,rel:!0});var vk=a(ko);Up=i(vk,"t5-large"),vk.forEach(t),Tk.forEach(t),gk.forEach(t),Rp=l(At),mi=s(At,"LI",{});var kk=a(mi);fi=s(kk,"P",{});var bk=a(fi);bo=s(bk,"A",{href:!0,rel:!0});var yk=a(bo);Hp=i(yk,"t5-3b"),yk.forEach(t),bk.forEach(t),kk.forEach(t),Vp=l(At),_i=s(At,"LI",{});var wk=a(_i);Qa=s(wk,"P",{});var Vv=a(Qa);yo=s(Vv,"A",{href:!0,rel:!0});var xk=a(yo);Kp=i(xk,"t5-11b"),xk.forEach(t),Yp=i(Vv,"."),Vv.forEach(t),wk.forEach(t),At.forEach(t),Yl=l(n),er=s(n,"P",{});var zk=a(er);Zp=i(zk,"Based on the original T5 model, Google has released some follow-up works:"),zk.forEach(t),Zl=l(n),$t=s(n,"UL",{});var Dr=a($t);gi=s(Dr,"LI",{});var $k=a(gi);zn=s($k,"P",{});var Ul=a(zn);Ti=s(Ul,"STRONG",{});var qk=a(Ti);Jp=i(qk,"T5v1.1"),qk.forEach(t),Xp=i(Ul,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=s(Ul,"A",{href:!0});var Ek=a(tr);Qp=i(Ek,"here"),Ek.forEach(t),eh=i(Ul,"."),Ul.forEach(t),$k.forEach(t),th=l(Dr),vi=s(Dr,"LI",{});var jk=a(vi);$n=s(jk,"P",{});var Rl=a($n);ki=s(Rl,"STRONG",{});var Fk=a(ki);nh=i(Fk,"mT5"),Fk.forEach(t),oh=i(Rl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=s(Rl,"A",{href:!0});var Mk=a(nr);sh=i(Mk,"here"),Mk.forEach(t),ah=i(Rl,"."),Rl.forEach(t),jk.forEach(t),rh=l(Dr),bi=s(Dr,"LI",{});var Pk=a(bi);qn=s(Pk,"P",{});var Hl=a(qn);yi=s(Hl,"STRONG",{});var Ck=a(yi);ih=i(Ck,"byT5"),Ck.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Ok=a(or);lh=i(Ok,"here"),Ok.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Pk.forEach(t),Dr.forEach(t),Jl=l(n),En=s(n,"P",{});var Bc=a(En);ph=i(Bc,"All checkpoints can be found on the "),wo=s(Bc,"A",{href:!0,rel:!0});var Ak=a(wo);hh=i(Ak,"hub"),Ak.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var Lk=a(xo);fh=i(Lk,"thomwolf"),Lk.forEach(t),_h=i(Sr,". The original code can be found "),zo=s(Sr,"A",{href:!0,rel:!0});var Ik=a(zo);gh=i(Ik,"here"),Ik.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Wc=a(Zt);jn=s(Wc,"A",{id:!0,class:!0,href:!0});var Nk=a(jn);wi=s(Nk,"SPAN",{});var Dk=a(wi);_($o.$$.fragment,Dk),Dk.forEach(t),Nk.forEach(t),vh=l(Wc),xi=s(Wc,"SPAN",{});var Sk=a(xi);kh=i(Sk,"Training"),Sk.forEach(t),Wc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),Uc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var Lt=a(dt);Ei=s(Lt,"P",{});var Rk=a(Ei);Mh=i(Rk,"Unsupervised denoising training"),Rk.forEach(t),Ph=l(Lt),_e=s(Lt,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var Hk=a(ji);Oh=i(Hk,"a.k.a"),Hk.forEach(t),Ah=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=s(tt,"EM",{});var Vk=a(Fi);Lh=i(Vk,"real"),Vk.forEach(t),Ih=i(tt,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Mi=s(tt,"CODE",{});var Kk=a(Mi);Nh=i(Kk,"<extra_id_0>"),Kk.forEach(t),Dh=i(tt,`,
`),Pi=s(tt,"CODE",{});var Yk=a(Pi);Sh=i(Yk,"<extra_id_1>"),Yk.forEach(t),Gh=i(tt,", \u2026 up to "),Ci=s(tt,"CODE",{});var Zk=a(Ci);Bh=i(Zk,"<extra_id_99>"),Zk.forEach(t),Wh=i(tt,`. As a default, 100 sentinel tokens are available in
`),rr=s(tt,"A",{href:!0});var Jk=a(rr);Uh=i(Jk,"T5Tokenizer"),Jk.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(Lt),Oi=s(Lt,"P",{});var Xk=a(Oi);Vh=i(Xk,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
directory.`),Hc.forEach(t),Lt.forEach(t),Qh=l(Rc),ge=s(Rc,"LI",{});var nt=a(ge);Ai=s(nt,"P",{});var eb=a(Ai);eu=i(eb,"Supervised training"),eb.forEach(t),tu=l(nt),Li=s(nt,"P",{});var tb=a(Li);nu=i(tb,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
...
of the `),Ki=s(ot,"CODE",{});var ub=a(Ki);Pu=i(ub,"CrossEntropyLoss"),ub.forEach(t),Cu=i(ot,". In Flax, one can use the "),Yi=s(ot,"CODE",{});var mb=a(Yi);Ou=i(mb,"decoder_attention_mask"),mb.forEach(t),Au=i(ot,` to ignore padded tokens from
...
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Ao=s(Wr,"A",{href:!0,rel:!0});var yb=a(Ao);Yu=i(yb,"paper"),yb.forEach(t),Zu=i(Wr,` for the task prefixes
...
`),cr=s(It,"A",{href:!0});var Cb=a(cr);fm=i(Cb,"generate()"),Cb.forEach(t),_m=i(It,", make sure you start it with the "),rd=s(It,"CODE",{});var Ob=a(rd);gm=i(Ob,"pad_token_id"),Ob.forEach(t),Tm=i(It,"."),It.forEach(t),pc=l(n),pr=s(n,"P",{});var Ab=a(pr);vm=i(Ab,"The example above only shows a single example. You can also do batched inference, like so:"),Ab.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Zc=a(en);Cn=s(Zc,"A",{id:!0,class:!0,href:!0});var Lb=a(Cn);id=s(Lb,"SPAN",{});var Ib=a(id);_(Bo.$$.fragment,Ib),Ib.forEach(t),Lb.forEach(t),km=l(Zc),dd=s(Zc,"SPAN",{});var Nb=a(dd);bm=i(Nb,"Performance"),Nb.forEach(t),Zc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);ym=i(po,"If you\u2019d like a faster training and inference performance, install "),Wo=s(po,"A",{href:!0,rel:!0});var Db=a(Wo);wm=i(Db,"apex"),Db.forEach(t),xm=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var Sb=a(ld);zm=i(Sb,"apex.normalization.FusedRMSNorm"),Sb.forEach(t),$m=i(po," instead of "),cd=s(po,"CODE",{});var Gb=a(cd);qm=i(Gb,"T5LayerNorm"),Gb.forEach(t),Em=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Jc=a(tn);On=s(Jc,"A",{id:!0,class:!0,href:!0});var Bb=a(On);pd=s(Bb,"SPAN",{});var Wb=a(pd);_(Uo.$$.fragment,Wb),Wb.forEach(t),Bb.forEach(t),jm=l(Jc),hd=s(Jc,"SPAN",{});var Ub=a(hd);Fm=i(Ub,"Example scripts"),Ub.forEach(t),Jc.forEach(t),gc=l(n),ur=s(n,"P",{});var Rb=a(ur);Mm=i(Rb,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rb.forEach(t),Tc=l(n),An=s(n,"UL",{});var Xc=a(An);ud=s(Xc,"LI",{});var Hb=a(ud);nn=s(Hb,"P",{});var Ur=a(nn);Pm=i(Ur,"pre-training: the "),Ro=s(Ur,"A",{href:!0,rel:!0});var Vb=a(Ro);Cm=i(Vb,"run_t5_mlm_flax.py"),Vb.forEach(t),Om=i(Ur,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Ur,"A",{href:!0,rel:!0});var Kb=a(Ho);Am=i(Kb,"t5_tokenizer_model.py"),Kb.forEach(t),Lm=i(Ur,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
...
(`),Zo=s(yt,"A",{href:!0,rel:!0});var Qb=a(Zo);Rm=i(Qb,"PyTorch"),Qb.forEach(t),Hm=i(yt," and "),Jo=s(yt,"A",{href:!0,rel:!0});var e1=a(Jo);Vm=i(e1,"Tensorflow"),e1.forEach(t),Km=i(yt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),yt.forEach(t),Yb.forEach(t),Xc.forEach(t),vc=l(n),on=s(n,"H2",{class:!0});var Qc=a(on);Ln=s(Qc,"A",{id:!0,class:!0,href:!0});var t1=a(Ln);fd=s(t1,"SPAN",{});var n1=a(fd);_(Xo.$$.fragment,n1),n1.forEach(t),t1.forEach(t),Ym=l(Qc),_d=s(Qc,"SPAN",{});var o1=a(_d);Zm=i(o1,"T5Config"),o1.forEach(t),Qc.forEach(t),kc=l(n),wt=s(n,"DIV",{class:!0});var Rr=a(wt);_(Qo.$$.fragment,Rr),Jm=l(Rr),xt=s(Rr,"P",{});var ho=a(xt);Xm=i(ho,"This is the configuration class to store the configuration of a "),mr=s(ho,"A",{href:!0});var s1=a(mr);Qm=i(s1,"T5Model"),s1.forEach(t),ef=i(ho," or a "),fr=s(ho,"A",{href:!0});var a1=a(fr);tf=i(a1,"TFT5Model"),a1.forEach(t),nf=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
adding special tokens. A sequence has the following format:`),m1.forEach(t),zf=l(Vr),is=s(Vr,"UL",{});var op=a(is);vr=s(op,"LI",{});var Kv=a(vr);$f=i(Kv,"single sequence: "),kd=s(Kv,"CODE",{});var f1=a(kd);qf=i(f1,"X </s>"),f1.forEach(t),Kv.forEach(t),Ef=l(op),kr=s(op,"LI",{});var Yv=a(kr);jf=i(Yv,"pair of sequences: "),bd=s(Yv,"CODE",{});var _1=a(bd);Ff=i(_1,"A </s> B </s>"),_1.forEach(t),Yv.forEach(t),op.forEach(t),Vr.forEach(t),Mf=l(st),Nn=s(st,"DIV",{class:!0});var sp=a(Nn);_(ds.$$.fragment,sp),Pf=l(sp),ls=s(sp,"P",{});var ap=a(ls);Cf=i(ap,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),yd=s(ap,"CODE",{});var g1=a(yd);Of=i(g1,"prepare_for_model"),g1.forEach(t),Af=i(ap," method."),ap.forEach(t),sp.forEach(t),Lf=l(st),Dn=s(st,"DIV",{class:!0});var rp=a(Dn);_(cs.$$.fragment,rp),If=l(rp),wd=s(rp,"P",{});var T1=a(wd);Nf=i(T1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),T1.forEach(t),rp.forEach(t),Df=l(st),br=s(st,"DIV",{class:!0});var v1=a(br);_(ps.$$.fragment,v1),v1.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);Sn=s(ip,"A",{id:!0,class:!0,href:!0});var k1=a(Sn);xd=s(k1,"SPAN",{});var b1=a(xd);_(hs.$$.fragment,b1),b1.forEach(t),k1.forEach(t),Sf=l(ip),zd=s(ip,"SPAN",{});var y1=a(zd);Gf=i(y1,"T5TokenizerFast"),y1.forEach(t),ip.forEach(t),xc=l(n),De=s(n,"DIV",{class:!0});var Nt=a(De);_(us.$$.fragment,Nt),Bf=l(Nt),dn=s(Nt,"P",{});var Kr=a(dn);Wf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),$d=s(Kr,"EM",{});var w1=a($d);Uf=i(w1,"tokenizers"),w1.forEach(t),Rf=i(Kr,` library). Based on
`),ms=s(Kr,"A",{href:!0,rel:!0});var x1=a(ms);Hf=i(x1,"Unigram"),x1.forEach(t),Vf=i(Kr,"."),Kr.forEach(t),Kf=l(Nt),fs=s(Nt,"P",{});var dp=a(fs);Yf=i(dp,"This tokenizer inherits from "),yr=s(dp,"A",{href:!0});var z1=a(yr);Zf=i(z1,"PreTrainedTokenizerFast"),z1.forEach(t),Jf=i(dp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),dp.forEach(t),Xf=l(Nt),Ft=s(Nt,"DIV",{class:!0});var Yr=a(Ft);_(_s.$$.fragment,Yr),Qf=l(Yr),qd=s(Yr,"P",{});var $1=a(qd);e_=i($1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),$1.forEach(t),t_=l(Yr),gs=s(Yr,"UL",{});var lp=a(gs);wr=s(lp,"LI",{});var Zv=a(wr);n_=i(Zv,"single sequence: "),Ed=s(Zv,"CODE",{});var q1=a(Ed);o_=i(q1,"X </s>"),q1.forEach(t),Zv.forEach(t),s_=l(lp),xr=s(lp,"LI",{});var Jv=a(xr);a_=i(Jv,"pair of sequences: "),jd=s(Jv,"CODE",{});var E1=a(jd);r_=i(E1,"A </s> B </s>"),E1.forEach(t),Jv.forEach(t),lp.forEach(t),Yr.forEach(t),i_=l(Nt),Gn=s(Nt,"DIV",{class:!0});var cp=a(Gn);_(Ts.$$.fragment,cp),d_=l(cp),Fd=s(cp,"P",{});var j1=a(Fd);l_=i(j1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),j1.forEach(t),cp.forEach(t),Nt.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Bn=s(pp,"A",{id:!0,class:!0,href:!0});var F1=a(Bn);Md=s(F1,"SPAN",{});var M1=a(Md);_(vs.$$.fragment,M1),M1.forEach(t),F1.forEach(t),c_=l(pp),Pd=s(pp,"SPAN",{});var P1=a(Pd);p_=i(P1,"T5Model"),P1.forEach(t),pp.forEach(t),$c=l(n),J=s(n,"DIV",{class:!0});var xe=a(J);_(ks.$$.fragment,xe),h_=l(xe),Cd=s(xe,"P",{});var C1=a(Cd);u_=i(C1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),C1.forEach(t),m_=l(xe),bs=s(xe,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var O1=a(ys);__=i(O1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),O1.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l(xe),ws=s(xe,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var A1=a(zr);k_=i(A1,"PreTrainedModel"),A1.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),$_=l(xe),Ue=s(xe,"DIV",{class:!0});var Dt=a(Ue);_($s.$$.fragment,Dt),q_=l(Dt),cn=s(Dt,"P",{});var Zr=a(cn);E_=i(Zr,"The "),$r=s(Zr,"A",{href:!0});var I1=a($r);j_=i(I1,"T5Model"),I1.forEach(t),F_=i(Zr," forward method, overrides the "),Od=s(Zr,"CODE",{});var N1=a(Od);M_=i(N1,"__call__"),N1.forEach(t),P_=i(Zr," special method."),Zr.forEach(t),C_=l(Dt),_(Wn.$$.fragment,Dt),O_=l(Dt),Ad=s(Dt,"P",{});var D1=a(Ad);A_=i(D1,"Example:"),D1.forEach(t),L_=l(Dt),_(qs.$$.fragment,Dt),Dt.forEach(t),I_=l(xe),Re=s(xe,"DIV",{class:!0});var St=a(Re);_(Es.$$.fragment,St),N_=l(St),Ld=s(St,"P",{});var S1=a(Ld);D_=i(S1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),S1.forEach(t),S_=l(St),Id=s(St,"P",{});var G1=a(Id);G_=i(G1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),G1.forEach(t),B_=l(St),Nd=s(St,"P",{});var B1=a(Nd);W_=i(B1,"Example:"),B1.forEach(t),U_=l(St),_(js.$$.fragment,St),St.forEach(t),R_=l(xe),vt=s(xe,"DIV",{class:!0});var uo=a(vt);_(Fs.$$.fragment,uo),H_=l(uo),Dd=s(uo,"P",{});var W1=a(Dd);V_=i(W1,"Moves the model to cpu from a model parallel state."),W1.forEach(t),K_=l(uo),Sd=s(uo,"P",{});var U1=a(Sd);Y_=i(U1,"Example:"),U1.forEach(t),Z_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),xe.forEach(t),qc=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Un=s(fp,"A",{id:!0,class:!0,href:!0});var R1=a(Un);Gd=s(R1,"SPAN",{});var H1=a(Gd);_(Ps.$$.fragment,H1),H1.forEach(t),R1.forEach(t),J_=l(fp),Bd=s(fp,"SPAN",{});var V1=a(Bd);X_=i(V1,"T5ForConditionalGeneration"),V1.forEach(t),fp.forEach(t),Ec=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),Os=s(ze,"P",{});var _p=a(Os);eg=i(_p,"T5 Model with a "),Wd=s(_p,"CODE",{});var K1=a(Wd);tg=i(K1,"language modeling"),K1.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),As=s(ze,"P",{});var gp=a(As);sg=i(gp,"The T5 model was proposed in "),Ls=s(gp,"A",{href:!0,rel:!0});var Y1=a(Ls);ag=i(Y1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Y1.forEach(t),rg=i(gp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),gp.forEach(t),ig=l(ze),Is=s(ze,"P",{});var Tp=a(Is);dg=i(Tp,"This model inherits from "),qr=s(Tp,"A",{href:!0});var Z1=a(qr);lg=i(Z1,"PreTrainedModel"),Z1.forEach(t),cg=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l(ze),Ns=s(ze,"P",{});var vp=a(Ns);hg=i(vp,"This model is also a PyTorch "),Ds=s(vp,"A",{href:!0,rel:!0});var J1=a(Ds);ug=i(J1,"torch.nn.Module"),J1.forEach(t),mg=i(vp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
