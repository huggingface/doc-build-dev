...
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
on the encoder, decoder, or reconstructing parts of the text.`),H0.forEach(t),Ze=l(o),se=a(o,"P",{});var fp=s(se);ye=i(fp,"This model was contributed by "),ve=a(fp,"A",{href:!0,rel:!0});var V0=s(ve);ht=i(V0,"valhalla"),V0.forEach(t),re=i(fp,". The Authors\u2019 code can be found "),Te=a(fp,"A",{href:!0,rel:!0});var Q0=s(Te);Me=i(Q0,"here"),Q0.forEach(t),fp.forEach(t),Ye=l(o),w=a(o,"H3",{class:!0});var ph=s(w);F=a(ph,"A",{id:!0,class:!0,href:!0});var J0=s(F);we=a(J0,"SPAN",{});var K0=s(we);f(He.$$.fragment,K0),K0.forEach(t),J0.forEach(t),Ut=l(ph),K=a(ph,"SPAN",{});var Z0=s(K);Xt=i(Z0,"Training of MBart"),Z0.forEach(t),ph.forEach(t),kt=l(o),X=a(o,"P",{});var jt=s(X);ie=i(jt,`MBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for translation task. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
...
target text format is `),Ve=a(jt,"CODE",{});var t1=s(Ve);Kt=i(t1,"[tgt_lang_code] X [eos]"),t1.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var o1=s(rd);Pu=i(o1,"bos"),o1.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Su=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var U0=s(Cn);id=a(U0,"STRONG",{});var n1=s(id);Au=i(n1,"call"),n1.forEach(t),Ou=i(U0,"()"),U0.forEach(t),Iu=i(Ei,` will encode source text format, and it should be wrapped
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),ny=l(Nt),f(cn.$$.fragment,Nt),ay=l(Nt),Oe=a(Nt,"DIV",{class:!0});var Dt=s(Oe);f(js.$$.fragment,Dt),sy=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);ry=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q2=s(xi);iy=i(Q2,"TFMBartModel"),Q2.forEach(t),dy=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J2=s(oc);ly=i(J2,"__call__"),J2.forEach(t),cy=i(Ui," special method."),Ui.forEach(t),py=l(Dt),f(pn.$$.fragment,Dt),hy=l(Dt),nc=a(Dt,"P",{});var K2=s(nc);uy=i(K2,"Example:"),K2.forEach(t),my=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z2=s(hn);ac=a(Z2,"SPAN",{});var Y2=s(ac);f(Ps.$$.fragment,Y2),Y2.forEach(t),Z2.forEach(t),fy=l(gu),sc=a(gu,"SPAN",{});var ew=s(sc);_y=i(ew,"TFMBartForConditionalGeneration"),ew.forEach(t),gu.forEach(t),th=l(o),$e=a(o,"DIV",{class:!0});var Lt=s($e);f(Cs.$$.fragment,Lt),gy=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);ky=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var tw=s(zi);by=i(tw,"TFPreTrainedModel"),tw.forEach(t),yy=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),vy=l(Lt),As=a(Lt,"P",{});var bu=s(As);Ty=i(bu,"This model is also a "),Os=a(bu,"A",{href:!0,rel:!0});var ow=s(Os);My=i(ow,"tf.keras.Model"),ow.forEach(t),wy=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),xy=l(Lt),f(un.$$.fragment,Lt),zy=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Is.$$.fragment,We),qy=l(We),xo=a(We,"P",{});var Xi=s(xo);By=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var nw=s(qi);Fy=i(nw,"TFMBartForConditionalGeneration"),nw.forEach(t),$y=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var aw=s(rc);jy=i(aw,"__call__"),aw.forEach(t),Ey=i(Xi," special method."),Xi.forEach(t),Py=l(We),f(mn.$$.fragment,We),Cy=l(We),ic=a(We,"P",{});var sw=s(ic);Sy=i(sw,"Summarization example:"),sw.forEach(t),Ay=l(We),f(Ns.$$.fragment,We),Oy=l(We),dc=a(We,"P",{});var rw=s(dc);Iy=i(rw,"Mask filling example:"),rw.forEach(t),Ny=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),oh=l(o),zo=a(o,"H2",{class:!0});var yu=s(zo);fn=a(yu,"A",{id:!0,class:!0,href:!0});var iw=s(fn);lc=a(iw,"SPAN",{});var dw=s(lc);f(Ls.$$.fragment,dw),dw.forEach(t),iw.forEach(t),Dy=l(yu),cc=a(yu,"SPAN",{});var lw=s(cc);Ly=i(lw,"FlaxMBartModel"),lw.forEach(t),yu.forEach(t),nh=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),Gy=l(me),Ws=a(me,"P",{});var vu=s(Ws);Wy=i(vu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=a(vu,"A",{href:!0});var cw=s(Bi);Ry=i(cw,"FlaxPreTrainedModel"),cw.forEach(t),Uy=i(vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vu.forEach(t),Xy=l(me),Rs=a(me,"P",{});var Tu=s(Rs);Hy=i(Tu,`This model is also a Flax Linen
`),Us=a(Tu,"A",{href:!0,rel:!0});var pw=s(Us);Vy=i(pw,"flax.nn.Module"),pw.forEach(t),Qy=i(Tu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tu.forEach(t),Jy=l(me),pc=a(me,"P",{});var hw=s(pc);Ky=i(hw,"Finally, this model supports inherent JAX features such as:"),hw.forEach(t),Zy=l(me),mt=a(me,"UL",{});var $n=s(mt);hc=a($n,"LI",{});var uw=s(hc);Xs=a(uw,"A",{href:!0,rel:!0});var mw=s(Xs);Yy=i(mw,"Just-In-Time (JIT) compilation"),mw.forEach(t),uw.forEach(t),ev=l($n),uc=a($n,"LI",{});var fw=s(uc);Hs=a(fw,"A",{href:!0,rel:!0});var _w=s(Hs);tv=i(_w,"Automatic Differentiation"),_w.forEach(t),fw.forEach(t),ov=l($n),mc=a($n,"LI",{});var gw=s(mc);Vs=a(gw,"A",{href:!0,rel:!0});var kw=s(Vs);nv=i(kw,"Vectorization"),kw.forEach(t),gw.forEach(t),av=l($n),fc=a($n,"LI",{});var bw=s(fc);Qs=a(bw,"A",{href:!0,rel:!0});var yw=s(Qs);sv=i(yw,"Parallelization"),yw.forEach(t),bw.forEach(t),$n.forEach(t),rv=l(me),Ie=a(me,"DIV",{class:!0});var Gt=s(Ie);f(Js.$$.fragment,Gt),iv=l(Gt),qo=a(Gt,"P",{});var Hi=s(qo);dv=i(Hi,"The "),_c=a(Hi,"CODE",{});var vw=s(_c);lv=i(vw,"FlaxMBartPreTrainedModel"),vw.forEach(t),cv=i(Hi,"forward method, overrides the "),gc=a(Hi,"CODE",{});var Tw=s(gc);pv=i(Tw,"__call__"),Tw.forEach(t),hv=i(Hi," special method."),Hi.forEach(t),uv=l(Gt),f(_n.$$.fragment,Gt),mv=l(Gt),kc=a(Gt,"P",{});var Mw=s(kc);fv=i(Mw,"Example:"),Mw.forEach(t),_v=l(Gt),f(Ks.$$.fragment,Gt),Gt.forEach(t),gv=l(me),Mt=a(me,"DIV",{class:!0});var Vi=s(Mt);f(Zs.$$.fragment,Vi),kv=l(Vi),bc=a(Vi,"P",{});var ww=s(bc);bv=i(ww,"Example:"),ww.forEach(t),yv=l(Vi),f(Ys.$$.fragment,Vi),Vi.forEach(t),vv=l(me),wt=a(me,"DIV",{class:!0});var Qi=s(wt);f(er.$$.fragment,Qi),Tv=l(Qi),yc=a(Qi,"P",{});var xw=s(yc);Mv=i(xw,"Example:"),xw.forEach(t),wv=l(Qi),f(tr.$$.fragment,Qi),Qi.forEach(t),me.forEach(t),ah=l(o),Bo=a(o,"H2",{class:!0});var Mu=s(Bo);gn=a(Mu,"A",{id:!0,class:!0,href:!0});var zw=s(gn);vc=a(zw,"SPAN",{});var qw=s(vc);f(or.$$.fragment,qw),qw.forEach(t),zw.forEach(t),xv=l(Mu),Tc=a(Mu,"SPAN",{});var Bw=s(Tc);zv=i(Bw,"FlaxMBartForConditionalGeneration"),Bw.forEach(t),Mu.forEach(t),sh=l(o),R=a(o,"DIV",{class:!0});var fe=s(R);f(nr.$$.fragment,fe),qv=l(fe),ar=a(fe,"P",{});var wu=s(ar);Bv=i(wu,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Fi=a(wu,"A",{href:!0});var Fw=s(Fi);Fv=i(Fw,"FlaxPreTrainedModel"),Fw.forEach(t),$v=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),jv=l(fe),sr=a(fe,"P",{});var xu=s(sr);Ev=i(xu,`This model is also a Flax Linen
`),rr=a(xu,"A",{href:!0,rel:!0});var $w=s(rr);Pv=i($w,"flax.nn.Module"),$w.forEach(t),Cv=i(xu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sv=l(fe),Mc=a(fe,"P",{});var jw=s(Mc);Av=i(jw,"Finally, this model supports inherent JAX features such as:"),jw.forEach(t),Ov=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var Ew=s(wc);ir=a(Ew,"A",{href:!0,rel:!0});var Pw=s(ir);Iv=i(Pw,"Just-In-Time (JIT) compilation"),Pw.forEach(t),Ew.forEach(t),Nv=l(jn),xc=a(jn,"LI",{});var Cw=s(xc);dr=a(Cw,"A",{href:!0,rel:!0});var Sw=s(dr);Dv=i(Sw,"Automatic Differentiation"),Sw.forEach(t),Cw.forEach(t),Lv=l(jn),zc=a(jn,"LI",{});var Aw=s(zc);lr=a(Aw,"A",{href:!0,rel:!0});var Ow=s(lr);Gv=i(Ow,"Vectorization"),Ow.forEach(t),Aw.forEach(t),Wv=l(jn),qc=a(jn,"LI",{});var Iw=s(qc);cr=a(Iw,"A",{href:!0,rel:!0});var Nw=s(cr);Rv=i(Nw,"Parallelization"),Nw.forEach(t),Iw.forEach(t),jn.forEach(t),Uv=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xv=l(Re),Fo=a(Re,"P",{});var Ji=s(Fo);Hv=i(Ji,"The "),Bc=a(Ji,"CODE",{});var Dw=s(Bc);Vv=i(Dw,"FlaxMBartPreTrainedModel"),Dw.forEach(t),Qv=i(Ji,"forward method, overrides the "),Fc=a(Ji,"CODE",{});var Lw=s(Fc);Jv=i(Lw,"__call__"),Lw.forEach(t),Kv=i(Ji," special method."),Ji.forEach(t),Zv=l(Re),f(kn.$$.fragment,Re),Yv=l(Re),$c=a(Re,"P",{});var Gw=s($c);eT=i(Gw,"Summarization example:"),Gw.forEach(t),tT=l(Re),f(hr.$$.fragment,Re),oT=l(Re),jc=a(Re,"P",{});var Ww=s(jc);nT=i(Ww,"Mask filling example:"),Ww.forEach(t),aT=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),sT=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),rT=l(Ki),Ec=a(Ki,"P",{});var Rw=s(Ec);iT=i(Rw,"Example:"),Rw.forEach(t),dT=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),lT=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),cT=l(Zi),Pc=a(Zi,"P",{});var Uw=s(Pc);pT=i(Uw,"Example:"),Uw.forEach(t),hT=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),$o=a(o,"H2",{class:!0});var zu=s($o);bn=a(zu,"A",{id:!0,class:!0,href:!0});var Xw=s(bn);Cc=a(Xw,"SPAN",{});var Hw=s(Cc);f(kr.$$.fragment,Hw),Hw.forEach(t),Xw.forEach(t),uT=l(zu),Sc=a(zu,"SPAN",{});var Vw=s(Sc);mT=i(Vw,"FlaxMBartForSequenceClassification"),Vw.forEach(t),zu.forEach(t),ih=l(o),O=a(o,"DIV",{class:!0});var oe=s(O);f(br.$$.fragment,oe),fT=l(oe),Ac=a(oe,"P",{});var Qw=s(Ac);_T=i(Qw,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Qw.forEach(t),gT=l(oe),yr=a(oe,"P",{});var qu=s(yr);kT=i(qu,"This model inherits from "),$i=a(qu,"A",{href:!0});var Jw=s($i);bT=i(Jw,"FlaxPreTrainedModel"),Jw.forEach(t),yT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
