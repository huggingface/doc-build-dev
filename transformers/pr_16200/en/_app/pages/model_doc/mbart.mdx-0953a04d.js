...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16200/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16200/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16200/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16200/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16200/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16200/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Wx]},$$scope:{ctx:E}}}),Ns=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16200/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16200/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16200/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16200/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tu.forEach(t),nk=l(Bn),Qa=a(Bn,"P",{});var ou=s(Qa);ak=i(ou,"This model is also a PyTorch "),Ja=a(ou,"A",{href:!0,rel:!0});var i2=s(Ja);sk=i(i2,"torch.nn.Module"),i2.forEach(t),rk=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Oi=s(ho);lk=i(Oi,"The "),gi=a(Oi,"A",{href:!0});var d2=s(gi);ck=i(d2,"MBartModel"),d2.forEach(t),pk=i(Oi," forward method, overrides the "),El=a(Oi,"CODE",{});var l2=s(El);hk=i(l2,"__call__"),l2.forEach(t),uk=i(Oi," special method."),Oi.forEach(t),mk=l(St),f(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var c2=s(Pl);_k=i(c2,"Example:"),c2.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p2=s(tn);Cl=a(p2,"SPAN",{});var h2=s(Cl);f(Ya.$$.fragment,h2),h2.forEach(t),p2.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var u2=s(Sl);bk=i(u2,"MBartForConditionalGeneration"),u2.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);f(es.$$.fragment,$n),vk=l($n),ts=a($n,"P",{});var au=s(ts);yk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l($n),os=a($n,"P",{});var su=s(os);xk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var f2=s(ns);zk=i(f2,"torch.nn.Module"),f2.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l($n),Z=a($n,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),$k=l(Le),mo=a(Le,"P",{});var Di=s(mo);Fk=i(Di,"The "),bi=a(Di,"A",{href:!0});var _2=s(bi);jk=i(_2,"MBartForConditionalGeneration"),_2.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var g2=s(Al);Pk=i(g2,"__call__"),g2.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(on.$$.fragment,Le),Ak=l(Le),Il=a(Le,"P",{});var k2=s(Il);Ik=i(k2,"Translation example:"),k2.forEach(t),Nk=l(Le),f(ss.$$.fragment,Le),Ok=l(Le),Nl=a(Le,"P",{});var b2=s(Nl);Dk=i(b2,"Mask filling example:"),b2.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),$n.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var v2=s(nn);Ol=a(v2,"SPAN",{});var y2=s(Ol);f(is.$$.fragment,y2),y2.forEach(t),v2.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T2=s(Dl);Wk=i(T2,"MBartForQuestionAnswering"),T2.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var M2=s(Ll);Xk=i(M2,"span start logits"),M2.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var w2=s(Gl);Vk=i(w2,"span end logits"),w2.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(At),ls=a(At,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),vi=a(iu,"A",{href:!0});var x2=s(vi);Zk=i(x2,"PreTrainedModel"),x2.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),eb=l(At),cs=a(At,"P",{});var du=s(cs);tb=i(du,"This model is also a PyTorch "),ps=a(du,"A",{href:!0,rel:!0});var z2=s(ps);ob=i(z2,"torch.nn.Module"),z2.forEach(t),nb=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var It=s(Ae);f(hs.$$.fragment,It),sb=l(It),go=a(It,"P",{});var Gi=s(go);rb=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var q2=s(yi);ib=i(q2,"MBartForQuestionAnswering"),q2.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var B2=s(Wl);lb=i(B2,"__call__"),B2.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(It),f(an.$$.fragment,It),hb=l(It),Rl=a(It,"P",{});var $2=s(Rl);ub=i($2,"Example:"),$2.forEach(t),mb=l(It),f(us.$$.fragment,It),It.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var F2=s(sn);Ul=a(F2,"SPAN",{});var j2=s(Ul);f(ms.$$.fragment,j2),j2.forEach(t),F2.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E2=s(Xl);_b=i(E2,"MBartForSequenceClassification"),E2.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var Nt=s(Be);f(fs.$$.fragment,Nt),gb=l(Nt),Hl=a(Nt,"P",{});var P2=s(Hl);kb=i(P2,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(Nt),gs=a(Nt,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var S2=s(ks);xb=i(S2,"torch.nn.Module"),S2.forEach(t),zb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);$b=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var A2=s(Mi);Fb=i(A2,"MBartForSequenceClassification"),A2.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var I2=s(Vl);Eb=i(I2,"__call__"),I2.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var N2=s(Ql);Ab=i(N2,"Example of single-label classification:"),N2.forEach(t),Ib=l(Ge),f(vs.$$.fragment,Ge),Nb=l(Ge),Jl=a(Ge,"P",{});var O2=s(Jl);Ob=i(O2,"Example of multi-label classification:"),O2.forEach(t),Db=l(Ge),f(ys.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Jp=l(o),vo=a(o,"H2",{class:!0});var hu=s(vo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D2=s(dn);Kl=a(D2,"SPAN",{});var L2=s(Kl);f(Ts.$$.fragment,L2),L2.forEach(t),D2.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G2=s(Zl);Gb=i(G2,"MBartForCausalLM"),G2.forEach(t),hu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var uu=s(yo);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var W2=s(Yl);Ub=i(W2,"Example:"),W2.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var R2=s(ln);ec=a(R2,"SPAN",{});var U2=s(ec);f(zs.$$.fragment,U2),U2.forEach(t),R2.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X2=s(tc);Vb=i(X2,"TFMBartModel"),X2.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);f(qs.$$.fragment,Ot),Qb=l(Ot),Bs=a(Ot,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nv=l(Ot),f(cn.$$.fragment,Ot),av=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),sv=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);rv=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q2=s(xi);iv=i(Q2,"TFMBartModel"),Q2.forEach(t),dv=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J2=s(oc);lv=i(J2,"__call__"),J2.forEach(t),cv=i(Ui," special method."),Ui.forEach(t),pv=l(Dt),f(pn.$$.fragment,Dt),hv=l(Dt),nc=a(Dt,"P",{});var K2=s(nc);uv=i(K2,"Example:"),K2.forEach(t),mv=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z2=s(hn);ac=a(Z2,"SPAN",{});var Y2=s(ac);f(Ps.$$.fragment,Y2),Y2.forEach(t),Z2.forEach(t),fv=l(gu),sc=a(gu,"SPAN",{});var ew=s(sc);_v=i(ew,"TFMBartForConditionalGeneration"),ew.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gv=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);kv=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var tw=s(zi);bv=i(tw,"TFPreTrainedModel"),tw.forEach(t),vv=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),yv=l(Lt),As=a(Lt,"P",{});var bu=s(As);Tv=i(bu,"This model is also a "),Is=a(bu,"A",{href:!0,rel:!0});var ow=s(Is);Mv=i(ow,"tf.keras.Model"),ow.forEach(t),wv=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),xv=l(Lt),f(un.$$.fragment,Lt),zv=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Ns.$$.fragment,We),qv=l(We),xo=a(We,"P",{});var Xi=s(xo);Bv=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var nw=s(qi);$v=i(nw,"TFMBartForConditionalGeneration"),nw.forEach(t),Fv=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var aw=s(rc);jv=i(aw,"__call__"),aw.forEach(t),Ev=i(Xi," special method."),Xi.forEach(t),Pv=l(We),f(mn.$$.fragment,We),Cv=l(We),ic=a(We,"P",{});var sw=s(ic);Sv=i(sw,"Summarization example:"),sw.forEach(t),Av=l(We),f(Os.$$.fragment,We),Iv=l(We),dc=a(We,"P",{});var rw=s(dc);Nv=i(rw,"Mask filling example:"),rw.forEach(t),Ov=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),oh=l(o),zo=a(o,"H2",{class:!0});var vu=s(zo);fn=a(vu,"A",{id:!0,class:!0,href:!0});var iw=s(fn);lc=a(iw,"SPAN",{});var dw=s(lc);f(Ls.$$.fragment,dw),dw.forEach(t),iw.forEach(t),Dv=l(vu),cc=a(vu,"SPAN",{});var lw=s(cc);Lv=i(lw,"FlaxMBartModel"),lw.forEach(t),vu.forEach(t),nh=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),Gv=l(me),Ws=a(me,"P",{});var yu=s(Ws);Wv=i(yu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=a(yu,"A",{href:!0});var cw=s(Bi);Rv=i(cw,"FlaxPreTrainedModel"),cw.forEach(t),Uv=i(yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),rr=a(xu,"A",{href:!0,rel:!0});var Fw=s(rr);Py=i(Fw,"flax.nn.Module"),Fw.forEach(t),Cy=i(xu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sy=l(fe),Mc=a(fe,"P",{});var jw=s(Mc);Ay=i(jw,"Finally, this model supports inherent JAX features such as:"),jw.forEach(t),Iy=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var Ew=s(wc);ir=a(Ew,"A",{href:!0,rel:!0});var Pw=s(ir);Ny=i(Pw,"Just-In-Time (JIT) compilation"),Pw.forEach(t),Ew.forEach(t),Oy=l(jn),xc=a(jn,"LI",{});var Cw=s(xc);dr=a(Cw,"A",{href:!0,rel:!0});var Sw=s(dr);Dy=i(Sw,"Automatic Differentiation"),Sw.forEach(t),Cw.forEach(t),Ly=l(jn),zc=a(jn,"LI",{});var Aw=s(zc);lr=a(Aw,"A",{href:!0,rel:!0});var Iw=s(lr);Gy=i(Iw,"Vectorization"),Iw.forEach(t),Aw.forEach(t),Wy=l(jn),qc=a(jn,"LI",{});var Nw=s(qc);cr=a(Nw,"A",{href:!0,rel:!0});var Ow=s(cr);Ry=i(Ow,"Parallelization"),Ow.forEach(t),Nw.forEach(t),jn.forEach(t),Uy=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xy=l(Re),$o=a(Re,"P",{});var Ji=s($o);Hy=i(Ji,"The "),Bc=a(Ji,"CODE",{});var Dw=s(Bc);Vy=i(Dw,"FlaxMBartPreTrainedModel"),Dw.forEach(t),Qy=i(Ji,"forward method, overrides the "),$c=a(Ji,"CODE",{});var Lw=s($c);Jy=i(Lw,"__call__"),Lw.forEach(t),Ky=i(Ji," special method."),Ji.forEach(t),Zy=l(Re),f(kn.$$.fragment,Re),Yy=l(Re),Fc=a(Re,"P",{});var Gw=s(Fc);eT=i(Gw,"Summarization example:"),Gw.forEach(t),tT=l(Re),f(hr.$$.fragment,Re),oT=l(Re),jc=a(Re,"P",{});var Ww=s(jc);nT=i(Ww,"Mask filling example:"),Ww.forEach(t),aT=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),sT=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),rT=l(Ki),Ec=a(Ki,"P",{});var Rw=s(Ec);iT=i(Rw,"Example:"),Rw.forEach(t),dT=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),lT=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),cT=l(Zi),Pc=a(Zi,"P",{});var Uw=s(Pc);pT=i(Uw,"Example:"),Uw.forEach(t),hT=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),Fo=a(o,"H2",{class:!0});var zu=s(Fo);bn=a(zu,"A",{id:!0,class:!0,href:!0});var Xw=s(bn);Cc=a(Xw,"SPAN",{});var Hw=s(Cc);f(kr.$$.fragment,Hw),Hw.forEach(t),Xw.forEach(t),uT=l(zu),Sc=a(zu,"SPAN",{});var Vw=s(Sc);mT=i(Vw,"FlaxMBartForSequenceClassification"),Vw.forEach(t),zu.forEach(t),ih=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(br.$$.fragment,oe),fT=l(oe),Ac=a(oe,"P",{});var Qw=s(Ac);_T=i(Qw,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Qw.forEach(t),gT=l(oe),vr=a(oe,"P",{});var qu=s(vr);kT=i(qu,"This model inherits from "),Fi=a(qu,"A",{href:!0});var Jw=s(Fi);bT=i(Jw,"FlaxPreTrainedModel"),Jw.forEach(t),vT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),yT=l(oe),yr=a(oe,"P",{});var Bu=s(yr);TT=i(Bu,`This model is also a Flax Linen
`),Tr=a(Bu,"A",{href:!0,rel:!0});var Kw=s(Tr);MT=i(Kw,"flax.nn.Module"),Kw.forEach(t),wT=i(Bu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),xT=l(oe),Ic=a(oe,"P",{});var Zw=s(Ic);zT=i(Zw,"Finally, this model supports inherent JAX features such as:"),Zw.forEach(t),qT=l(oe),_t=a(oe,"UL",{});var En=s(_t);Nc=a(En,"LI",{});var Yw=s(Nc);Mr=a(Yw,"A",{href:!0,rel:!0});var ex=s(Mr);BT=i(ex,"Just-In-Time (JIT) compilation"),ex.forEach(t),Yw.forEach(t),$T=l(En),Oc=a(En,"LI",{});var tx=s(Oc);wr=a(tx,"A",{href:!0,rel:!0});var ox=s(wr);FT=i(ox,"Automatic Differentiation"),ox.forEach(t),tx.forEach(t),jT=l(En),Dc=a(En,"LI",{});var nx=s(Dc);xr=a(nx,"A",{href:!0,rel:!0});var ax=s(xr);ET=i(ax,"Vectorization"),ax.forEach(t),nx.forEach(t),PT=l(En),Lc=a(En,"LI",{});var sx=s(Lc);zr=a(sx,"A",{href:!0,rel:!0});var rx=s(zr);CT=i(rx,"Parallelization"),rx.forEach(t),sx.forEach(t),En.forEach(t),ST=l(oe),Oe=a(oe,"DIV",{class:!0});var Wt=s(Oe);f(qr.$$.fragment,Wt),AT=l(Wt),jo=a(Wt,"P",{});var Yi=s(jo);IT=i(Yi,"The "),Gc=a(Yi,"CODE",{});var ix=s(Gc);NT=i(ix,"FlaxMBartPreTrainedModel"),ix.forEach(t),OT=i(Yi,"forward method, overrides the "),Wc=a(Yi,"CODE",{});var dx=s(Wc);DT=i(dx,"__call__"),dx.forEach(t),LT=i(Yi," special method."),Yi.forEach(t),GT=l(Wt),f(vn.$$.fragment,Wt),WT=l(Wt),Rc=a(Wt,"P",{});var lx=s(Rc);RT=i(lx,"Example:"),lx.forEach(t),UT=l(Wt),f(Br.$$.fragment,Wt),Wt.forEach(t),XT=l(oe),qt=a(oe,"DIV",{class:!0});var ed=s(qt);f($r.$$.fragment,ed),HT=l(ed),Uc=a(ed,"P",{});var cx=s(Uc);VT=i(cx,"Example:"),cx.forEach(t),QT=l(ed),f(Fr.$$.fragment,ed),ed.forEach(t),JT=l(oe),Bt=a(oe,"DIV",{class:!0});var td=s(Bt);f(jr.$$.fragment,td),KT=l(td),Xc=a(td,"P",{});var px=s(Xc);ZT=i(px,"Example:"),px.forEach(t),YT=l(td),f(Er.$$.fragment,td),td.forEach(t),oe.forEach(t),dh=l(o),Eo=a(o,"H2",{class:!0});var $u=s(Eo);yn=a($u,"A",{id:!0,class:!0,href:!0});var hx=s(yn);Hc=a(hx,"SPAN",{});var ux=s(Hc);f(Pr.$$.fragment,ux),ux.forEach(t),hx.forEach(t),e0=l($u),Vc=a($u,"SPAN",{});var mx=s(Vc);t0=i(mx,"FlaxMBartForQuestionAnswering"),mx.forEach(t),$u.forEach(t),lh=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Cr.$$.fragment,ne),o0=l(ne),Po=a(ne,"P",{});var od=s(Po);n0=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Qc=a(od,"CODE",{});var fx=s(Qc);a0=i(fx,"span start logits"),fx.forEach(t),s0=i(od," and "),Jc=a(od,"CODE",{});var _x=s(Jc);r0=i(_x,"span end logits"),_x.forEach(t),i0=i(od,")."),od.forEach(t),d0=l(ne),Sr=a(ne,"P",{});var Fu=s(Sr);l0=i(Fu,"This model inherits from "),ji=a(Fu,"A",{href:!0});var gx=s(ji);c0=i(gx,"FlaxPreTrainedModel"),gx.forEach(t),p0=i(Fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
