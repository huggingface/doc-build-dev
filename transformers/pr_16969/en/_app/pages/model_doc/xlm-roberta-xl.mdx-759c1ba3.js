import{S as Rd,i as Fd,s as Cd,e as i,k as g,w as k,t as r,M as zd,c as l,d as o,m as _,a as d,x as M,h as a,b as m,F as e,g as L,y as v,q as w,o as X,B as $,v as qd,L as A}from"../../chunks/vendor-6b77c823.js";import{T as io}from"../../chunks/Tip-39098574.js";import{D as F}from"../../chunks/Docstring-1088f2fb.js";import{C as S}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as re}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as P}from"../../chunks/ExampleCodeBlock-5212b321.js";function Ed(T){let s,f,c,p,b;return p=new S({props:{code:`from transformers import XLMRobertaXLModel, XLMRobertaXLConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){s=i("p"),f=r("Examples:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Examples:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function jd(T){let s,f,c,p,b;return{c(){s=i("p"),f=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=r("Module"),b=r(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){s=i("p"),f=r("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Example:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Ad(T){let s,f,c,p,b;return{c(){s=i("p"),f=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=a(y,"Module"),y.forEach(o),b=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){s=i("p"),f=r("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Example:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Nd(T){let s,f,c,p,b;return{c(){s=i("p"),f=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=a(y,"Module"),y.forEach(o),b=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=r("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Example:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Od(T){let s,f;return s=new S({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){v(s,c,p),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Dd(T){let s,f,c,p,b;return{c(){s=i("p"),f=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=a(y,"Module"),y.forEach(o),b=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=r("Example of single-label classification:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Example of single-label classification:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Bd(T){let s,f;return s=new S({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){v(s,c,p),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Qd(T){let s,f,c,p,b;return p=new S({props:{code:`import torch
from transformers import RobertaTokenizer, XLMRobertaXLForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){s=i("p"),f=r("Example of multi-label classification:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Example of multi-label classification:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Hd(T){let s,f;return s=new S({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){v(s,c,p),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Ud(T){let s,f,c,p,b;return{c(){s=i("p"),f=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=a(y,"Module"),y.forEach(o),b=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){s=i("p"),f=r("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Example:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Gd(T){let s,f,c,p,b;return{c(){s=i("p"),f=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=a(y,"Module"),y.forEach(o),b=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=r("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Example:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function Kd(T){let s,f;return s=new S({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){v(s,c,p),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Yd(T){let s,f,c,p,b;return{c(){s=i("p"),f=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=a(y,"Module"),y.forEach(o),b=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=r("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=a(h,"Example:"),h.forEach(o),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),v(p,n,h),b=!0},p:A,i(n){b||(w(p.$$.fragment,n),b=!0)},o(n){X(p.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(p,n)}}}function ec(T){let s,f;return s=new S({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){v(s,c,p),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function tc(T){let s,f,c,p,b,n,h,y,Fs,Yn,ae,Re,Ho,bt,Cs,Uo,zs,Zn,Fe,qs,Lt,Es,js,es,lo,Ps,ts,co,Vo,As,os,po,Ss,ns,ho,kt,Ns,Go,Is,Os,ss,Q,Ds,Mt,Ws,Bs,vt,Qs,Hs,wt,Us,Vs,rs,ie,Ce,Jo,Xt,Gs,Ko,Js,as,N,$t,Ks,G,Ys,mo,Zs,er,Yo,tr,or,Tt,nr,sr,rr,le,ar,uo,ir,lr,fo,dr,cr,pr,ze,is,de,qe,Zo,yt,hr,en,mr,ls,I,xt,ur,ce,fr,go,gr,_r,Rt,br,Lr,kr,te,Mr,tn,vr,R,wr,on,Xr,$r,nn,Tr,yr,sn,xr,Rr,rn,Fr,Cr,an,zr,qr,ln,Er,jr,dn,Pr,Ar,Ft,Sr,Nr,H,Ct,Ir,pe,Or,_o,Dr,Wr,cn,Br,Qr,Hr,Ee,Ur,je,ds,he,Pe,pn,zt,Vr,hn,Gr,cs,J,qt,Jr,K,Kr,mn,Yr,Zr,bo,ea,ta,Et,oa,na,sa,U,jt,ra,me,aa,Lo,ia,la,un,da,ca,pa,Ae,ha,Se,ps,ue,Ne,fn,Pt,ma,gn,ua,hs,Y,At,fa,Z,ga,_n,_a,ba,ko,La,ka,St,Ma,va,wa,C,Nt,Xa,fe,$a,Mo,Ta,ya,bn,xa,Ra,Fa,Ie,Ca,Oe,za,De,ms,ge,We,Ln,It,qa,kn,Ea,us,O,Ot,ja,Mn,Pa,Aa,_e,Sa,vo,Na,Ia,Dt,Oa,Da,Wa,x,Wt,Ba,be,Qa,wo,Ha,Ua,vn,Va,Ga,Ja,Be,Ka,Qe,Ya,He,Za,Ue,ei,Ve,fs,Le,Ge,wn,Bt,ti,Xn,oi,gs,D,Qt,ni,$n,si,ri,ke,ai,Xo,ii,li,Ht,di,ci,pi,V,Ut,hi,Me,mi,$o,ui,fi,Tn,gi,_i,bi,Je,Li,Ke,_s,ve,Ye,yn,Vt,ki,xn,Mi,bs,W,Gt,vi,Rn,wi,Xi,we,$i,To,Ti,yi,Jt,xi,Ri,Fi,z,Kt,Ci,Xe,zi,yo,qi,Ei,Fn,ji,Pi,Ai,Ze,Si,et,Ni,tt,Ls,$e,ot,Cn,Yt,Ii,zn,Oi,ks,B,Zt,Di,Te,Wi,qn,Bi,Qi,En,Hi,Ui,Vi,ye,Gi,xo,Ji,Ki,eo,Yi,Zi,el,q,to,tl,xe,ol,Ro,nl,sl,jn,rl,al,il,nt,ll,st,dl,rt,Ms;return n=new re({}),bt=new re({}),Xt=new re({}),$t=new F({props:{name:"class transformers.XLMRobertaXLConfig",anchor:"transformers.XLMRobertaXLConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 2560"},{name:"num_hidden_layers",val:" = 36"},{name:"num_attention_heads",val:" = 32"},{name:"intermediate_size",val:" = 10240"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 514"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 250880) &#x2014;
Vocabulary size of the XLM_ROBERTA_XL model. Defines the number of different tokens that can be represented
by the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16969/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel">XLMRobertaXLModel</a>.`,name:"vocab_size"},{anchor:"transformers.XLMRobertaXLConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 2560) &#x2014;
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_16969/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel">XLMRobertaXLModel</a> or
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L708",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16969/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16969/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig"
...
`}}),Ee=new io({props:{$$slots:{default:[jd]},$$scope:{ctx:T}}}),je=new P({props:{anchor:"transformers.XLMRobertaXLModel.forward.example",$$slots:{default:[Pd]},$$scope:{ctx:T}}}),zt=new re({}),qt=new F({props:{name:"class transformers.XLMRobertaXLForCausalLM",anchor:"transformers.XLMRobertaXLForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16969/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig">XLMRobertaXLConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16969/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L850"}}),jt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16969/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/pr_16969/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16969/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L875",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16969/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16969/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1000"}}),Nt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16969/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/pr_16969/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16969/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1028",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16969/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16969/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1128"}}),Wt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16969/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/pr_16969/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16969/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1141",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16969/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1237",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16969/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1336",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16969/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16969/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1434"}}),to=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_16969/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/pr_16969/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16969/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16969/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1447",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16969/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
language from the input ids.`),ss=g(),Q=i("p"),Ds=r("This model was contributed by "),Mt=i("a"),Ws=r("Soonhwan-Kwon"),Bs=r(" and "),vt=i("a"),Qs=r("stefan-it"),Hs=r(". The original code can be found "),wt=i("a"),Us=r("here"),Vs=r("."),rs=g(),ie=i("h2"),Ce=i("a"),Jo=i("span"),k(Xt.$$.fragment),Gs=g(),Ko=i("span"),Js=r("XLMRobertaXLConfig"),as=g(),N=i("div"),k($t.$$.fragment),Ks=g(),G=i("p"),Ys=r("This is the configuration class to store the configuration of a "),mo=i("a"),Zs=r("XLMRobertaXLModel"),er=r(" or a "),Yo=i("code"),tr=r("TFXLMRobertaXLModel"),or=r(`.
...
cross-attention is added between the self-attention layers, following the architecture described in `),tn=i("em"),vr=r(`Attention is
all you need`),R=i("em"),wr=r(`by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
...
both `),sn=i("code"),xr=r("is_decoder"),Rr=r(" argument and "),rn=i("code"),Fr=r("add_cross_attention"),Cr=r(" set to "),an=i("code"),zr=r("True"),qr=r("; an "),ln=i("code"),Er=r("encoder_hidden_states"),jr=r(` is then expected as
an input to the forward pass. .. `),dn=i("em"),Pr=r("Attention is all you need"),Ar=r(": "),Ft=i("a"),Sr=r("https://arxiv.org/abs/1706.03762"),Nr=g(),H=i("div"),k(Ct.$$.fragment),Ir=g(),pe=i("p"),Or=r("The "),_o=i("a"),Dr=r("XLMRobertaXLModel"),Wr=r(" forward method, overrides the "),cn=i("code"),Br=r("__call__"),Qr=r(" special method."),Hr=g(),k(Ee.$$.fragment),Ur=g(),k(je.$$.fragment),ds=g(),he=i("h2"),Pe=i("a"),pn=i("span"),k(zt.$$.fragment),Vr=g(),hn=i("span"),Gr=r("XLMRobertaXLForCausalLM"),cs=g(),J=i("div"),k(qt.$$.fragment),Jr=g(),K=i("p"),Kr=r("XLM-RoBERTa-xlarge Model with a "),mn=i("code"),Yr=r("language modeling"),Zr=r(` head on top for CLM fine-tuning.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),St=i("a"),Ma=r("torch.nn.Module"),va=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),wa=g(),C=i("div"),k(Nt.$$.fragment),Xa=g(),fe=i("p"),$a=r("The "),Mo=i("a"),Ta=r("XLMRobertaXLForMaskedLM"),ya=r(" forward method, overrides the "),bn=i("code"),xa=r("__call__"),Ra=r(" special method."),Fa=g(),k(Ie.$$.fragment),Ca=g(),k(Oe.$$.fragment),za=g(),k(De.$$.fragment),ms=g(),ge=i("h2"),We=i("a"),Ln=i("span"),k(It.$$.fragment),qa=g(),kn=i("span"),Ea=r("XLMRobertaXLForSequenceClassification"),us=g(),O=i("div"),k(Ot.$$.fragment),ja=g(),Mn=i("p"),Pa=r(`XLM-RoBERTa-xlarge Model transformer with a sequence classification/regression head on top (a linear layer on top
of the pooled output) e.g. for GLUE tasks.`),Aa=g(),_e=i("p"),Sa=r("This model inherits from "),vo=i("a"),Na=r("PreTrainedModel"),Ia=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Dt=i("a"),Oa=r("torch.nn.Module"),Da=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Wa=g(),x=i("div"),k(Wt.$$.fragment),Ba=g(),be=i("p"),Qa=r("The "),wo=i("a"),Ha=r("XLMRobertaXLForSequenceClassification"),Ua=r(" forward method, overrides the "),vn=i("code"),Va=r("__call__"),Ga=r(" special method."),Ja=g(),k(Be.$$.fragment),Ka=g(),k(Qe.$$.fragment),Ya=g(),k(He.$$.fragment),Za=g(),k(Ue.$$.fragment),ei=g(),k(Ve.$$.fragment),fs=g(),Le=i("h2"),Ge=i("a"),wn=i("span"),k(Bt.$$.fragment),ti=g(),Xn=i("span"),oi=r("XLMRobertaXLForMultipleChoice"),gs=g(),D=i("div"),k(Qt.$$.fragment),ni=g(),$n=i("p"),si=r(`XLM-Roberta-xlarge Model with a multiple choice classification head on top (a linear layer on top of the pooled
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),pi=g(),V=i("div"),k(Ut.$$.fragment),hi=g(),Me=i("p"),mi=r("The "),$o=i("a"),ui=r("XLMRobertaXLForMultipleChoice"),fi=r(" forward method, overrides the "),Tn=i("code"),gi=r("__call__"),_i=r(" special method."),bi=g(),k(Je.$$.fragment),Li=g(),k(Ke.$$.fragment),_s=g(),ve=i("h2"),Ye=i("a"),yn=i("span"),k(Vt.$$.fragment),ki=g(),xn=i("span"),Mi=r("XLMRobertaXLForTokenClassification"),bs=g(),W=i("div"),k(Gt.$$.fragment),vi=g(),Rn=i("p"),wi=r(`XLM-Roberta-xlarge Model with a token classification head on top (a linear layer on top of the hidden-states
output) e.g. for Named-Entity-Recognition (NER) tasks.`),Xi=g(),we=i("p"),$i=r("This model inherits from "),To=i("a"),Ti=r("PreTrainedModel"),yi=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Jt=i("a"),xi=r("torch.nn.Module"),Ri=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Fi=g(),z=i("div"),k(Kt.$$.fragment),Ci=g(),Xe=i("p"),zi=r("The "),yo=i("a"),qi=r("XLMRobertaXLForTokenClassification"),Ei=r(" forward method, overrides the "),Fn=i("code"),ji=r("__call__"),Pi=r(" special method."),Ai=g(),k(Ze.$$.fragment),Si=g(),k(et.$$.fragment),Ni=g(),k(tt.$$.fragment),Ls=g(),$e=i("h2"),ot=i("a"),Cn=i("span"),k(Yt.$$.fragment),Ii=g(),zn=i("span"),Oi=r("XLMRobertaXLForQuestionAnswering"),ks=g(),B=i("div"),k(Zt.$$.fragment),Di=g(),Te=i("p"),Wi=r(`XLM-Roberta-xlarge Model with a span classification head on top for extractive question-answering tasks like SQuAD
...
language from the input ids.`),ro.forEach(o),Un.forEach(o),ss=_(t),Q=l(t,"P",{});var ee=d(Q);Ds=a(ee,"This model was contributed by "),Mt=l(ee,"A",{href:!0,rel:!0});var Gn=d(Mt);Ws=a(Gn,"Soonhwan-Kwon"),Gn.forEach(o),Bs=a(ee," and "),vt=l(ee,"A",{href:!0,rel:!0});var Jn=d(vt);Qs=a(Jn,"stefan-it"),Jn.forEach(o),Hs=a(ee,". The original code can be found "),wt=l(ee,"A",{href:!0,rel:!0});var Kn=d(wt);Us=a(Kn,"here"),Kn.forEach(o),Vs=a(ee,"."),ee.forEach(o),rs=_(t),ie=l(t,"H2",{class:!0});var vs=d(ie);Ce=l(vs,"A",{id:!0,class:!0,href:!0});var cl=d(Ce);Jo=l(cl,"SPAN",{});var pl=d(Jo);M(Xt.$$.fragment,pl),pl.forEach(o),cl.forEach(o),Gs=_(vs),Ko=l(vs,"SPAN",{});var hl=d(Ko);Js=a(hl,"XLMRobertaXLConfig"),hl.forEach(o),vs.forEach(o),as=_(t),N=l(t,"DIV",{class:!0});var at=d(N);M($t.$$.fragment,at),Ks=_(at),G=l(at,"P",{});var it=d(G);Ys=a(it,"This is the configuration class to store the configuration of a "),mo=l(it,"A",{href:!0});var ml=d(mo);Zs=a(ml,"XLMRobertaXLModel"),ml.forEach(o),er=a(it," or a "),Yo=l(it,"CODE",{});var ul=d(Yo);tr=a(ul,"TFXLMRobertaXLModel"),ul.forEach(o),or=a(it,`.
It is used to instantiate a XLM_ROBERTA_XL model according to the specified arguments, defining the model
architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of the
...
documentation from `),fo=l(Fo,"A",{href:!0});var _l=d(fo);dr=a(_l,"PretrainedConfig"),_l.forEach(o),cr=a(Fo," for more information."),Fo.forEach(o),pr=_(at),M(ze.$$.fragment,at),at.forEach(o),is=_(t),de=l(t,"H2",{class:!0});var ws=d(de);qe=l(ws,"A",{id:!0,class:!0,href:!0});var bl=d(qe);Zo=l(bl,"SPAN",{});var Ll=d(Zo);M(yt.$$.fragment,Ll),Ll.forEach(o),bl.forEach(o),hr=_(ws),en=l(ws,"SPAN",{});var kl=d(en);mr=a(kl,"XLMRobertaXLModel"),kl.forEach(o),ws.forEach(o),ls=_(t),I=l(t,"DIV",{class:!0});var lt=d(I);M(xt.$$.fragment,lt),ur=_(lt),ce=l(lt,"P",{});var Co=d(ce);fr=a(Co,`The bare XLM-RoBERTa-xlarge Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),go=l(Co,"A",{href:!0});var Ml=d(go);gr=a(Ml,"PreTrainedModel"),Ml.forEach(o),_r=a(Co,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Rt=l(Co,"A",{href:!0,rel:!0});var vl=d(Rt);br=a(vl,"torch.nn.Module"),vl.forEach(o),Lr=a(Co,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Co.forEach(o),kr=_(lt),te=l(lt,"P",{});var ao=d(te);Mr=a(ao,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
cross-attention is added between the self-attention layers, following the architecture described in `),tn=l(ao,"EM",{});var wl=d(tn);vr=a(wl,`Attention is
all you need`),wl.forEach(o),R=l(ao,"EM",{});var E=d(R);wr=a(E,`by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
...
both `),sn=l(E,"CODE",{});var Tl=d(sn);xr=a(Tl,"is_decoder"),Tl.forEach(o),Rr=a(E," argument and "),rn=l(E,"CODE",{});var yl=d(rn);Fr=a(yl,"add_cross_attention"),yl.forEach(o),Cr=a(E," set to "),an=l(E,"CODE",{});var xl=d(an);zr=a(xl,"True"),xl.forEach(o),qr=a(E,"; an "),ln=l(E,"CODE",{});var Rl=d(ln);Er=a(Rl,"encoder_hidden_states"),Rl.forEach(o),jr=a(E,` is then expected as
an input to the forward pass. .. `),E.forEach(o),dn=l(ao,"EM",{});var Fl=d(dn);Pr=a(Fl,"Attention is all you need"),Fl.forEach(o),Ar=a(ao,": "),Ft=l(ao,"A",{href:!0,rel:!0});var Cl=d(Ft);Sr=a(Cl,"https://arxiv.org/abs/1706.03762"),Cl.forEach(o),ao.forEach(o),Nr=_(lt),H=l(lt,"DIV",{class:!0});var dt=d(H);M(Ct.$$.fragment,dt),Ir=_(dt),pe=l(dt,"P",{});var zo=d(pe);Or=a(zo,"The "),_o=l(zo,"A",{href:!0});var zl=d(_o);Dr=a(zl,"XLMRobertaXLModel"),zl.forEach(o),Wr=a(zo," forward method, overrides the "),cn=l(zo,"CODE",{});var ql=d(cn);Br=a(ql,"__call__"),ql.forEach(o),Qr=a(zo," special method."),zo.forEach(o),Hr=_(dt),M(Ee.$$.fragment,dt),Ur=_(dt),M(je.$$.fragment,dt),dt.forEach(o),lt.forEach(o),ds=_(t),he=l(t,"H2",{class:!0});var Xs=d(he);Pe=l(Xs,"A",{id:!0,class:!0,href:!0});var El=d(Pe);pn=l(El,"SPAN",{});var jl=d(pn);M(zt.$$.fragment,jl),jl.forEach(o),El.forEach(o),Vr=_(Xs),hn=l(Xs,"SPAN",{});var Pl=d(hn);Gr=a(Pl,"XLMRobertaXLForCausalLM"),Pl.forEach(o),Xs.forEach(o),cs=_(t),J=l(t,"DIV",{class:!0});var qo=d(J);M(qt.$$.fragment,qo),Jr=_(qo),K=l(qo,"P",{});var ct=d(K);Kr=a(ct,"XLM-RoBERTa-xlarge Model with a "),mn=l(ct,"CODE",{});var Al=d(mn);Yr=a(Al,"language modeling"),Al.forEach(o),Zr=a(ct,` head on top for CLM fine-tuning.
