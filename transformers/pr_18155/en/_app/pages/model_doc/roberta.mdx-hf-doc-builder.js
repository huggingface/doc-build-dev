...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18155/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18155/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18155/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),y(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);yT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),y(gs.$$.fragment,mo),RT=h(mo),y(_s.$$.fragment,mo),MT=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);y(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var e5=a(Mp);zT=i(e5,"TFRobertaForMultipleChoice"),e5.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var t5=a(Ep);CT=i(t5,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s5=a(Rd);HT=i(s5,"TFRobertaForMultipleChoice"),s5.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a5=a(zp);JT=i(a5,"__call__"),a5.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var r5=a(ws);qp=s(r5,"SPAN",{});var i5=a(qp);y(ii.$$.fragment,i5),i5.forEach(t),r5.forEach(t),XT=h(qu),Cp=s(qu,"SPAN",{});var l5=a(Cp);YT=i(l5,"TFRobertaForTokenClassification"),l5.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var d5=a(jp);ey=i(d5,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d5.forEach(t),ty=h(St),di=s(St,"P",{});var Cu=a(di);oy=i(Cu,"This model inherits from "),Md=s(Cu,"A",{href:!0});var c5=a(Md);ny=i(c5,"TFPreTrainedModel"),c5.forEach(t),sy=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),ay=h(St),ci=s(St,"P",{});var ju=a(ci);ry=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var p5=a(pi);iy=i(p5,"tf.keras.Model"),p5.forEach(t),ly=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),py=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h5=a(Ed);my=i(h5,"TFRobertaForTokenClassification"),h5.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var m5=a(Pp);uy=i(m5,"__call__"),m5.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),y(Fs.$$.fragment,fo),by=h(fo),y(xs.$$.fragment,fo),ky=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var f5=a(Ms);Lp=s(f5,"SPAN",{});var u5=a(Lp);y(mi.$$.fragment,u5),u5.forEach(t),f5.forEach(t),vy=h(Pu),Ap=s(Pu,"SPAN",{});var g5=a(Ap);Ty=i(g5,"TFRobertaForQuestionAnswering"),g5.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _5=a(Op);$y=i(_5,"span start logits"),_5.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var b5=a(Np);xy=i(b5,"span end logits"),b5.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ey=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var k5=a(zd);zy=i(k5,"TFPreTrainedModel"),k5.forEach(t),qy=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),Cy=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jy=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var v5=a(_i);Py=i(v5,"tf.keras.Model"),v5.forEach(t),Ly=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),qd=s(nc,"A",{href:!0});var T5=a(qd);Dy=i(T5,"TFRobertaForQuestionAnswering"),T5.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var y5=a(Ip);Wy=i(y5,"__call__"),y5.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),y(zs.$$.fragment,uo),Hy=h(uo),y(qs.$$.fragment,uo),Qy=h(uo),y(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var w5=a(js);Dp=s(w5,"SPAN",{});var $5=a(Dp);y(ki.$$.fragment,$5),$5.forEach(t),w5.forEach(t),Jy=h(Ou),Sp=s(Ou,"SPAN",{});var F5=a(Sp);Vy=i(F5,"FlaxRobertaModel"),F5.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var x5=a(Wp);Gy=i(x5,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x5.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yy=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var R5=a(Cd);Zy=i(R5,"FlaxPreTrainedModel"),R5.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),tw=h(gt),yi=s(gt,"P",{});var Iu=a(yi);ow=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var M5=a(wi);nw=i(M5,"flax.linen.Module"),M5.forEach(t),sw=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),aw=h(gt),Bp=s(gt,"P",{});var E5=a(Bp);rw=i(E5,"Finally, this model supports inherent JAX features such as:"),E5.forEach(t),iw=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var z5=a(Up);$i=s(z5,"A",{href:!0,rel:!0});var q5=a($i);lw=i(q5,"Just-In-Time (JIT) compilation"),q5.forEach(t),z5.forEach(t),dw=h(ra),Hp=s(ra,"LI",{});var C5=a(Hp);Fi=s(C5,"A",{href:!0,rel:!0});var j5=a(Fi);cw=i(j5,"Automatic Differentiation"),j5.forEach(t),C5.forEach(t),pw=h(ra),Qp=s(ra,"LI",{});var P5=a(Qp);xi=s(P5,"A",{href:!0,rel:!0});var L5=a(xi);hw=i(L5,"Vectorization"),L5.forEach(t),P5.forEach(t),mw=h(ra),Jp=s(ra,"LI",{});var A5=a(Jp);Ri=s(A5,"A",{href:!0,rel:!0});var O5=a(Ri);fw=i(O5,"Parallelization"),O5.forEach(t),A5.forEach(t),ra.forEach(t),uw=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),gw=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_w=i(sc,"The "),Vp=s(sc,"CODE",{});var N5=a(Vp);bw=i(N5,"FlaxRobertaPreTrainedModel"),N5.forEach(t),kw=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var I5=a(Kp);vw=i(I5,"__call__"),I5.forEach(t),Tw=i(sc," special method."),sc.forEach(t),yw=h(ia),y(Ps.$$.fragment,ia),ww=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var D5=a(As);Gp=s(D5,"SPAN",{});var S5=a(Gp);y(Ei.$$.fragment,S5),S5.forEach(t),D5.forEach(t),$w=h(Du),Xp=s(Du,"SPAN",{});var W5=a(Xp);Fw=i(W5,"FlaxRobertaForCausalLM"),W5.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),xw=h(_t),Yp=s(_t,"P",{});var B5=a(Yp);Rw=i(B5,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
