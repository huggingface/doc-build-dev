...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_17744/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel">XLMRobertaXLModel</a> or
...
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17744/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17744/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L709",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17744/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17744/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L876",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17744/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1029",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17744/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1142",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17744/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1238",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17744/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1337",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17744/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1448",returnDescription:`
<p>A <a
