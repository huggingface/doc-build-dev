...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),bp=new w({}),{c(){y=o("meta"),C=u(),b=o("h1"),k=o("a"),ee=o("span"),f(z.$$.fragment),x=u(),se=o("span"),R=a("DeepSpeed Integration"),ae=u(),S=o("p"),E=o("a"),q=a("DeepSpeed"),Es=a(" implements everything described in the "),V=o("a"),qs=a("ZeRO paper"),L5=a(". Currently it provides full support for:"),Bj=u(),I=o("ol"),sf=o("li"),M5=a("Optimizer state partitioning (ZeRO stage 1)"),Z5=u(),tf=o("li"),N5=a("Gradient partitioning (ZeRO stage 2)"),H5=u(),af=o("li"),B5=a("Parameter partitioning (ZeRO stage 3)"),W5=u(),nf=o("li"),F5=a("Custom mixed precision training handling"),V5=u(),of=o("li"),Y5=a("A range of fast CUDA-extension-based optimizers"),K5=u(),lf=o("li"),J5=a("ZeRO-Offload to CPU and NVMe"),Wj=u(),Se=o("p"),X5=a("ZeRO-Offload has its own dedicated paper: "),ao=o("a"),Q5=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),e6=a(". And NVMe-support is described in the paper "),no=o("a"),s6=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),t6=a("."),Fj=u(),Up=o("p"),a6=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),Vj=u(),Gp=o("p"),n6=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),Yj=u(),Et=o("p"),o6=a("\u{1F917} Transformers integrates "),oo=o("a"),l6=a("DeepSpeed"),r6=a(" via 2 options:"),Kj=u(),qt=o("ol"),lo=o("li"),p6=a("Integration of the core DeepSpeed features via "),Lp=o("a"),i6=a("Trainer"),u6=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),c6=u(),Y=o("li"),h6=a("If you don\u2019t use "),Mp=o("a"),f6=a("Trainer"),d6=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),rf=o("code"),m6=a("from_pretrained"),_6=a(" and "),pf=o("code"),v6=a("from_config"),j6=a(` include integration of essential
parts of DeepSpeed like `),uf=o("code"),g6=a("zero.Init"),w6=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=o("a"),y6=a("deepspeed-non-trainer-integration"),b6=a("."),Jj=u(),Np=o("p"),E6=a("What is integrated:"),Xj=u(),Hp=o("p"),q6=a("Training:"),Qj=u(),Bp=o("ol"),cf=o("li"),$6=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),eg=u(),Wp=o("p"),k6=a("Inference:"),sg=u(),Fp=o("ol"),ro=o("li"),P6=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Vp=o("a"),D6=a("deepspeed-zero-inference"),z6=a("."),tg=u(),Yp=o("p"),O6=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),$s=o("h2"),$t=o("a"),hf=o("span"),f(po.$$.fragment),T6=u(),ff=o("span"),A6=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),ks=o("h3"),kt=o("a"),df=o("span"),f(io.$$.fragment),S6=u(),mf=o("span"),C6=a("Installation"),rg=u(),Xp=o("p"),x6=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R6=a("or via "),_f=o("code"),I6=a("transformers"),U6=a("\u2019 "),vf=o("code"),G6=a("extras"),L6=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M6=a("or find more details on "),ho=o("a"),Z6=a("the DeepSpeed\u2019s GitHub page"),N6=a(` and
`),fo=o("a"),H6=a("advanced install"),B6=a("."),hg=u(),Pt=o("p"),W6=a("If you\u2019re still struggling with the build, first make sure to read "),Qp=o("a"),F6=a("zero-install-notes"),V6=a("."),fg=u(),ei=o("p"),Y6=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),dg=u(),si=o("p"),K6=a("To make a local build for DeepSpeed:"),mg=u(),f(mo.$$.fragment),_g=u(),Re=o("p"),J6=a("If you intend to use NVMe offload you will also need to include "),jf=o("code"),X6=a("DS_BUILD_AIO=1"),Q6=a(` in the instructions above (and also
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Op=o("a"),vG=a("DeepSpeed GitHub"),jG=a("."),this.h()},l(e){const p=MK('[data-svelte="svelte-1phssyn"]',document.head);y=l(p,"META",{name:!0,content:!0}),p.forEach(t),C=c(e),b=l(e,"H1",{class:!0});var Tp=r(b);k=l(Tp,"A",{id:!0,class:!0,href:!0});var Uj=r(k);ee=l(Uj,"SPAN",{});var Gj=r(ee);d(z.$$.fragment,Gj),Gj.forEach(t),Uj.forEach(t),x=c(Tp),se=l(Tp,"SPAN",{});var $G=r(se);R=n($G,"DeepSpeed Integration"),$G.forEach(t),Tp.forEach(t),ae=c(e),S=l(e,"P",{});var Lj=r(S);E=l(Lj,"A",{href:!0,rel:!0});var kG=r(E);q=n(kG,"DeepSpeed"),kG.forEach(t),Es=n(Lj," implements everything described in the "),V=l(Lj,"A",{href:!0,rel:!0});var PG=r(V);qs=n(PG,"ZeRO paper"),PG.forEach(t),L5=n(Lj,". Currently it provides full support for:"),Lj.forEach(t),Bj=c(e),I=l(e,"OL",{});var je=r(I);sf=l(je,"LI",{});var DG=r(sf);M5=n(DG,"Optimizer state partitioning (ZeRO stage 1)"),DG.forEach(t),Z5=c(je),tf=l(je,"LI",{});var zG=r(tf);N5=n(zG,"Gradient partitioning (ZeRO stage 2)"),zG.forEach(t),H5=c(je),af=l(je,"LI",{});var OG=r(af);B5=n(OG,"Parameter partitioning (ZeRO stage 3)"),OG.forEach(t),W5=c(je),nf=l(je,"LI",{});var TG=r(nf);F5=n(TG,"Custom mixed precision training handling"),TG.forEach(t),V5=c(je),of=l(je,"LI",{});var AG=r(of);Y5=n(AG,"A range of fast CUDA-extension-based optimizers"),AG.forEach(t),K5=c(je),lf=l(je,"LI",{});var SG=r(lf);J5=n(SG,"ZeRO-Offload to CPU and NVMe"),SG.forEach(t),je.forEach(t),Wj=c(e),Se=l(e,"P",{});var rh=r(Se);X5=n(rh,"ZeRO-Offload has its own dedicated paper: "),ao=l(rh,"A",{href:!0,rel:!0});var CG=r(ao);Q5=n(CG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),CG.forEach(t),e6=n(rh,". And NVMe-support is described in the paper "),no=l(rh,"A",{href:!0,rel:!0});var xG=r(no);s6=n(xG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),xG.forEach(t),t6=n(rh,"."),rh.forEach(t),Fj=c(e),Up=l(e,"P",{});var RG=r(Up);a6=n(RG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),RG.forEach(t),Vj=c(e),Gp=l(e,"P",{});var IG=r(Gp);n6=n(IG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),IG.forEach(t),Yj=c(e),Et=l(e,"P",{});var nE=r(Et);o6=n(nE,"\u{1F917} Transformers integrates "),oo=l(nE,"A",{href:!0,rel:!0});var UG=r(oo);l6=n(UG,"DeepSpeed"),UG.forEach(t),r6=n(nE," via 2 options:"),nE.forEach(t),Kj=c(e),qt=l(e,"OL",{});var oE=r(qt);lo=l(oE,"LI",{});var lE=r(lo);p6=n(lE,"Integration of the core DeepSpeed features via "),Lp=l(lE,"A",{href:!0});var GG=r(Lp);i6=n(GG,"Trainer"),GG.forEach(t),u6=n(lE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),lE.forEach(t),c6=c(oE),Y=l(oE,"LI",{});var ge=r(Y);h6=n(ge,"If you don\u2019t use "),Mp=l(ge,"A",{href:!0});var LG=r(Mp);f6=n(LG,"Trainer"),LG.forEach(t),d6=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),rf=l(ge,"CODE",{});var MG=r(rf);m6=n(MG,"from_pretrained"),MG.forEach(t),_6=n(ge," and "),pf=l(ge,"CODE",{});var ZG=r(pf);v6=n(ZG,"from_config"),ZG.forEach(t),j6=n(ge,` include integration of essential
parts of DeepSpeed like `),uf=l(ge,"CODE",{});var NG=r(uf);g6=n(NG,"zero.Init"),NG.forEach(t),w6=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=l(ge,"A",{href:!0});var HG=r(Zp);y6=n(HG,"deepspeed-non-trainer-integration"),HG.forEach(t),b6=n(ge,"."),ge.forEach(t),oE.forEach(t),Jj=c(e),Np=l(e,"P",{});var BG=r(Np);E6=n(BG,"What is integrated:"),BG.forEach(t),Xj=c(e),Hp=l(e,"P",{});var WG=r(Hp);q6=n(WG,"Training:"),WG.forEach(t),Qj=c(e),Bp=l(e,"OL",{});var FG=r(Bp);cf=l(FG,"LI",{});var VG=r(cf);$6=n(VG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),VG.forEach(t),FG.forEach(t),eg=c(e),Wp=l(e,"P",{});var YG=r(Wp);k6=n(YG,"Inference:"),YG.forEach(t),sg=c(e),Fp=l(e,"OL",{});var KG=r(Fp);ro=l(KG,"LI",{});var rE=r(ro);P6=n(rE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Vp=l(rE,"A",{href:!0});var JG=r(Vp);D6=n(JG,"deepspeed-zero-inference"),JG.forEach(t),z6=n(rE,"."),rE.forEach(t),KG.forEach(t),tg=c(e),Yp=l(e,"P",{});var XG=r(Yp);O6=n(XG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),XG.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),$s=l(e,"H2",{class:!0});var pE=r($s);$t=l(pE,"A",{id:!0,class:!0,href:!0});var QG=r($t);hf=l(QG,"SPAN",{});var eL=r(hf);d(po.$$.fragment,eL),eL.forEach(t),QG.forEach(t),T6=c(pE),ff=l(pE,"SPAN",{});var sL=r(ff);A6=n(sL,"Trainer Deepspeed Integration"),sL.forEach(t),pE.forEach(t),og=c(e),Jp=l(e,"A",{id:!0}),r(Jp).forEach(t),lg=c(e),ks=l(e,"H3",{class:!0});var iE=r(ks);kt=l(iE,"A",{id:!0,class:!0,href:!0});var tL=r(kt);df=l(tL,"SPAN",{});var aL=r(df);d(io.$$.fragment,aL),aL.forEach(t),tL.forEach(t),S6=c(iE),mf=l(iE,"SPAN",{});var nL=r(mf);C6=n(nL,"Installation"),nL.forEach(t),iE.forEach(t),rg=c(e),Xp=l(e,"P",{});var oL=r(Xp);x6=n(oL,"Install the library via pypi:"),oL.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),Ce=l(e,"P",{});var ph=r(Ce);R6=n(ph,"or via "),_f=l(ph,"CODE",{});var lL=r(_f);I6=n(lL,"transformers"),lL.forEach(t),U6=n(ph,"\u2019 "),vf=l(ph,"CODE",{});var rL=r(vf);G6=n(rL,"extras"),rL.forEach(t),L6=n(ph,":"),ph.forEach(t),ug=c(e),d(co.$$.fragment,e),cg=c(e),xe=l(e,"P",{});var ih=r(xe);M6=n(ih,"or find more details on "),ho=l(ih,"A",{href:!0,rel:!0});var pL=r(ho);Z6=n(pL,"the DeepSpeed\u2019s GitHub page"),pL.forEach(t),N6=n(ih,` and
`),fo=l(ih,"A",{href:!0,rel:!0});var iL=r(fo);H6=n(iL,"advanced install"),iL.forEach(t),B6=n(ih,"."),ih.forEach(t),hg=c(e),Pt=l(e,"P",{});var uE=r(Pt);W6=n(uE,"If you\u2019re still struggling with the build, first make sure to read "),Qp=l(uE,"A",{href:!0});var uL=r(Qp);F6=n(uL,"zero-install-notes"),uL.forEach(t),V6=n(uE,"."),uE.forEach(t),fg=c(e),ei=l(e,"P",{});var cL=r(ei);Y6=n(cL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),cL.forEach(t),dg=c(e),si=l(e,"P",{});var hL=r(si);K6=n(hL,"To make a local build for DeepSpeed:"),hL.forEach(t),mg=c(e),d(mo.$$.fragment,e),_g=c(e),Re=l(e,"P",{});var uh=r(Re);J6=n(uh,"If you intend to use NVMe offload you will also need to include "),jf=l(uh,"CODE",{});var fL=r(jf);X6=n(fL,"DS_BUILD_AIO=1"),fL.forEach(t),Q6=n(uh,` in the instructions above (and also
...
`),fv=l(W,"CODE",{});var FF=r(fv);GC=n(FF,"from_pretrained"),FF.forEach(t),LC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),T3=c(e),d(zr.$$.fragment,e),A3=c(e),hn=l(e,"P",{});var o5=r(hn);MC=n(o5,"If you\u2019re using the official example scripts and your command line arguments include "),dv=l(o5,"CODE",{});var VF=r(dv);ZC=n(VF,"--deepspeed ds_config.json"),VF.forEach(t),NC=n(o5,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),o5.forEach(t),S3=c(e),dc=l(e,"P",{});var YF=r(dc);HC=n(YF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),YF.forEach(t),C3=c(e),fn=l(e,"P",{});var l5=r(fn);BC=n(l5,"For full details on this method and other related features please refer to "),Or=l(l5,"A",{href:!0,rel:!0});var KF=r(Or);WC=n(KF,"Constructing Massive Models"),KF.forEach(t),FC=n(l5,"."),l5.forEach(t),x3=c(e),fe=l(e,"P",{});var Jn=r(fe);VC=n(Jn,"Also when loading fp16-pretrained models, you will want to tell "),mv=l(Jn,"CODE",{});var JF=r(mv);YC=n(JF,"from_pretrained"),JF.forEach(t),KC=n(Jn,` to use
`),_v=l(Jn,"CODE",{});var XF=r(_v);JC=n(XF,"torch_dtype=torch.float16"),XF.forEach(t),XC=n(Jn,". For details, please, see "),mc=l(Jn,"A",{href:!0});var QF=r(mc);QC=n(QF,"from_pretrained-torch-dtype"),QF.forEach(t),ex=n(Jn,"."),Jn.forEach(t),R3=c(e),nt=l(e,"H4",{class:!0});var r5=r(nt);dn=l(r5,"A",{id:!0,class:!0,href:!0});var eV=r(dn);vv=l(eV,"SPAN",{});var sV=r(vv);d(Tr.$$.fragment,sV),sV.forEach(t),eV.forEach(t),sx=c(r5),jv=l(r5,"SPAN",{});var tV=r(jv);tx=n(tV,"Gathering Parameters"),tV.forEach(t),r5.forEach(t),I3=c(e),Ar=l(e,"P",{});var bG=r(Ar);ax=n(bG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=l(bG,"A",{href:!0,rel:!0});var aV=r(Sr);nx=n(aV,"Gathering Parameters"),aV.forEach(t),bG.forEach(t),U3=c(e),mn=l(e,"P",{});var p5=r(mn);ox=n(p5,`We do however use it internally in several places, one such example is when loading pretrained model weights in
`),gv=l(p5,"CODE",{});var nV=r(gv);lx=n(nV,"from_pretrained"),nV.forEach(t),rx=n(p5,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
...
dump the `),Cc=l(Xn,"A",{href:!0});var UV=r(Cc);Yx=n(UV,"TrainingArguments"),UV.forEach(t),Kx=n(Xn," as it has dozens of entries that are irrelevant."),Xn.forEach(t),xV.forEach(t),Jx=c($e),Nr=l($e,"LI",{});var m5=r(Nr);Av=l(m5,"P",{});var GV=r(Av);Xx=n(GV,"Output of:"),GV.forEach(t),Qx=c(m5),d(Hr.$$.fragment,m5),m5.forEach(t),eR=c($e),Sv=l($e,"LI",{});var LV=r(Sv);Br=l(LV,"P",{});var _5=r(Br);sR=n(_5,`If possible include a link to a Google Colab notebook that we can reproduce the problem with. You can use this
`),Wr=l(_5,"A",{href:!0,rel:!0});var MV=r(Wr);tR=n(MV,"notebook"),MV.forEach(t),aR=n(_5,` as
a starting point.`),_5.forEach(t),LV.forEach(t),nR=c($e),Cv=l($e,"LI",{});var ZV=r(Cv);xv=l(ZV,"P",{});var NV=r(xv);oR=n(NV,"Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),NV.forEach(t),ZV.forEach(t),lR=c($e),Rv=l($e,"LI",{});var HV=r(Rv);Fr=l(HV,"P",{});var v5=r(Fr);rR=n(v5,"If possible try to use one of the existing "),Vr=l(v5,"A",{href:!0,rel:!0});var BV=r(Vr);pR=n(BV,"examples"),BV.forEach(t),iR=n(v5," to reproduce the problem with."),v5.forEach(t),HV.forEach(t),$e.forEach(t),f0=c(e),xc=l(e,"P",{});var WV=r(xc);uR=n(WV,"Things to consider:"),WV.forEach(t),d0=c(e),bn=l(e,"UL",{});var j5=r(bn);pt=l(j5,"LI",{});var Hh=r(pt);Iv=l(Hh,"P",{});var FV=r(Iv);cR=n(FV,"Deepspeed is often not the cause of the problem."),FV.forEach(t),hR=c(Hh),Uv=l(Hh,"P",{});var VV=r(Uv);fR=n(VV,`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
exception and you can see that DeepSpeed modules are involved, first re-test your setup without DeepSpeed in it.
And only if the problem persists then do mentioned Deepspeed and supply all the required details.`),YV.forEach(t),Hh.forEach(t),_R=c(j5),Lv=l(j5,"LI",{});var KV=r(Lv);Yr=l(KV,"P",{});var g5=r(Yr);vR=n(g5,`If it\u2019s clear to you that the issue is in the DeepSpeed core and not the integration part, please file the Issue
directly with `),Kr=l(g5,"A",{href:!0,rel:!0});var JV=r(Kr);jR=n(JV,"Deepspeed"),JV.forEach(t),gR=n(g5,`. If you aren\u2019t sure, please do not worry,
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),g5.forEach(t),KV.forEach(t),j5.forEach(t),m0=c(e),it=l(e,"H3",{class:!0});var w5=r(it);En=l(w5,"A",{id:!0,class:!0,href:!0});var XV=r(En);Mv=l(XV,"SPAN",{});var QV=r(Mv);d(Jr.$$.fragment,QV),QV.forEach(t),XV.forEach(t),wR=c(w5),Zv=l(w5,"SPAN",{});var eY=r(Zv);yR=n(eY,"Troubleshooting"),eY.forEach(t),w5.forEach(t),_0=c(e),ut=l(e,"H4",{class:!0});var y5=r(ut);qn=l(y5,"A",{id:!0,class:!0,href:!0});var sY=r(qn);Nv=l(sY,"SPAN",{});var tY=r(Nv);d(Xr.$$.fragment,tY),tY.forEach(t),sY.forEach(t),bR=c(y5),Qr=l(y5,"SPAN",{});var b5=r(Qr);ER=n(b5,"the "),Hv=l(b5,"CODE",{});var aY=r(Hv);qR=n(aY,"deepspeed"),aY.forEach(t),$R=n(b5," process gets killed at startup without a traceback"),b5.forEach(t),y5.forEach(t),v0=c(e),B=l(e,"P",{});var ke=r(B);kR=n(ke,"If the "),Bv=l(ke,"CODE",{});var nY=r(Bv);PR=n(nY,"deepspeed"),nY.forEach(t),DR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
