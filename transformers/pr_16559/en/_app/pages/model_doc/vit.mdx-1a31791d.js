import{S as mm,i as fm,s as um,e as a,k as d,w,t as r,M as gm,c as s,d as t,m as c,a as n,x as b,h as i,b as l,F as e,g as m,y,q as $,o as x,B as F,v as _m}from"../../chunks/vendor-6b77c823.js";import{T as _e}from"../../chunks/Tip-39098574.js";import{D as W}from"../../chunks/Docstring-abef54e3.js";import{C as Ft}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";function vm(I){let p,T,f,g,v;return{c(){p=a("p"),T=r(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
PIL images.`),g.forEach(t)},m(f,g){m(f,p,g),e(p,T)},d(f){f&&t(p)}}}function wm(I){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function bm(I){let p,T,f,g,v;return{c(){p=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var u=n(p);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,p,u),e(p,T),e(p,f),e(f,g),e(p,v)},d(_){_&&t(p)}}}function Im(I){let p,T,f,g,v,_,u,V,pe,R,k,ie,j,B,oe,C,he,ae,E,M,z,Me,se,L,je,Te,Xo,tr,sn,Zo,Da,or,nn,Qo,ar,rn,N,Vt,sr,Et,nr,rr,ir,Oa,lr,dr,kt,cr,Yo,pr,hr,mr,Pe,fr,Sa,ur,gr,It,_r,vr,Tr,Ce,wr,Mt,br,yr,jt,$r,xr,Fr,Ae,Vr,Pt,Er,kr,Ct,Ir,Mr,jr,Wa,Pr,ln,ea,Cr,dn,le,Ba,P,ta,Ar,qr,oa,zr,Nr,aa,Lr,Dr,Ua,Or,Sr,Ra,Wr,Br,Ha,Ur,Rr,Ja,Hr,Jr,sa,Kr,Gr,Xr,Ka,na,ra,Zr,Qr,Yr,Ga,At,ei,qt,ti,oi,ai,Xa,ia,la,si,ni,cn,we,ri,zt,ii,li,Nt,di,ci,pn,et,pi,Lt,hi,mi,hn,qe,tt,Za,Dt,fi,Qa,ui,mn,U,Ot,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Fi,pa,Vi,Ei,ki,Ya,Ii,Mi,Wt,fn,Le,ot,es,Bt,ji,ts,Pi,un,ne,Ut,Ci,os,Ai,qi,Rt,zi,ha,Ni,Li,Di,be,Ht,Oi,as,Si,Wi,at,gn,De,st,ss,Jt,Bi,ns,Ui,_n,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,rs,el,tl,ol,nt,al,is,sl,nl,Qt,vn,Se,rt,ls,Yt,rl,ds,il,Tn,fe,eo,ll,We,dl,cs,cl,pl,to,hl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,ps,Tl,wl,bl,it,yl,hs,$l,xl,ao,wn,Ue,lt,ms,so,Fl,fs,Vl,bn,re,no,El,us,kl,Il,ro,Ml,io,jl,Pl,Cl,K,lo,Al,Re,ql,ua,zl,Nl,gs,Ll,Dl,Ol,dt,Sl,_s,Wl,Bl,co,yn,He,ct,vs,po,Ul,Ts,Rl,$n,D,ho,Hl,ws,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,pt,ad,G,go,sd,Je,nd,_a,rd,id,bs,ld,dd,cd,ht,pd,ys,hd,md,_o,xn,Ke,mt,$s,vo,fd,xs,ud,Fn,O,To,gd,Fs,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,Vs,Pd,Cd,Ad,ut,qd,Es,zd,Nd,xo,Vn,Xe,gt,ks,Fo,Ld,Is,Dd,En,A,Vo,Od,Ms,Sd,Wd,Eo,Bd,wa,Ud,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,js,Zd,Qd,ue,Ps,Mo,Yd,ec,Cs,jo,tc,oc,As,Po,ac,sc,qs,Co,nc,rc,Z,Ao,ic,Ze,lc,zs,dc,cc,Ns,pc,hc,mc,_t,fc,Ls,uc,gc,qo,kn,Qe,vt,Ds,zo,_c,Os,vc,In,q,No,Tc,Ss,wc,bc,Lo,yc,ba,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Ic,Ws,Mc,jc,ge,Bs,So,Pc,Cc,Us,Wo,Ac,qc,Rs,Bo,zc,Nc,Hs,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Js,Wc,Bc,Ks,Uc,Rc,Hc,Tt,Jc,Gs,Kc,Gc,Ho,Mn;return _=new ve({}),k=new _e({props:{$$slots:{default:[vm]},$$scope:{ctx:I}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16559/en/main_classes/feature_extractor#transformers.BatchFeature"
...
<p>A <a
  href="/docs/transformers/pr_16559/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16559/en/model_doc/vit#transformers.ViTConfig"
...
`}}),nt=new _e({props:{$$slots:{default:[wm]},$$scope:{ctx:I}}}),Qt=new Ft({props:{code:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">197</span>, <span class="hljs-number">768</span>]`}}),Yt=new ve({}),eo=new W({props:{name:"class transformers.ViTForMaskedImageModeling",anchor:"transformers.ViTForMaskedImageModeling",parameters:[{name:"config",val:": ViTConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/models/vit/modeling_vit.py#L616",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16559/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16559/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oo=new W({props:{name:"forward",anchor:"transformers.ViTForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"interpolate_pos_encoding",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/models/vit/modeling_vit.py#L630",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16559/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),so=new ve({}),no=new W({props:{name:"class transformers.ViTForImageClassification",anchor:"transformers.ViTForImageClassification",parameters:[{name:"config",val:": ViTConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/models/vit/modeling_vit.py#L726",parametersDescription:[{anchor:"transformers.ViTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16559/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16559/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new W({props:{name:"forward",anchor:"transformers.ViTForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"interpolate_pos_encoding",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16559/src/transformers/models/vit/modeling_vit.py#L739",parametersDescription:[{anchor:"transformers.ViTForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16559/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
<p>A <a
  href="/docs/transformers/pr_16559/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
<p>A <a
  href="/docs/transformers/pr_16559/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){p=a("meta"),T=d(),f=a("h1"),g=a("a"),v=a("span"),w(_.$$.fragment),u=d(),V=a("span"),pe=r("Vision Transformer (ViT)"),R=d(),w(k.$$.fragment),ie=d(),j=a("h2"),B=a("a"),oe=a("span"),w(C.$$.fragment),he=d(),ae=a("span"),E=r("Overview"),M=d(),z=a("p"),Me=r("The Vision Transformer (ViT) model was proposed in "),se=a("a"),L=r(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
go to him!`),hn=d(),qe=a("h2"),tt=a("a"),Za=a("span"),w(Dt.$$.fragment),fi=d(),Qa=a("span"),ui=r("ViTConfig"),mn=d(),U=a("div"),w(Ot.$$.fragment),gi=d(),ze=a("p"),_i=r("This is the configuration class to store the configuration of a "),da=a("a"),vi=r("ViTModel"),Ti=r(`. It is used to instantiate an ViT
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),w(ft.$$.fragment),Ed=d(),X=a("div"),w($o.$$.fragment),kd=d(),Ge=a("p"),Id=r("The "),Ta=a("a"),Md=r("TFViTForImageClassification"),jd=r(" forward method, overrides the "),Vs=a("code"),Pd=r("__call__"),Cd=r(" special method."),Ad=d(),w(ut.$$.fragment),qd=d(),Es=a("p"),zd=r("Examples:"),Nd=d(),w(xo.$$.fragment),Vn=d(),Xe=a("h2"),gt=a("a"),ks=a("span"),w(Fo.$$.fragment),Ld=d(),Is=a("span"),Dd=r("FlaxVitModel"),En=d(),A=a("div"),w(Vo.$$.fragment),Od=d(),Ms=a("p"),Sd=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Bd=r("This model inherits from "),wa=a("a"),Ud=r("FlaxPreTrainedModel"),Rd=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),js=a("p"),Zd=r("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Ps=a("li"),Mo=a("a"),Yd=r("Just-In-Time (JIT) compilation"),ec=d(),Cs=a("li"),jo=a("a"),tc=r("Automatic Differentiation"),oc=d(),As=a("li"),Po=a("a"),ac=r("Vectorization"),sc=d(),qs=a("li"),Co=a("a"),nc=r("Parallelization"),rc=d(),Z=a("div"),w(Ao.$$.fragment),ic=d(),Ze=a("p"),lc=r("The "),zs=a("code"),dc=r("FlaxViTPreTrainedModel"),cc=r("forward method, overrides the "),Ns=a("code"),pc=r("__call__"),hc=r(" special method."),mc=d(),w(_t.$$.fragment),fc=d(),Ls=a("p"),uc=r("Examples:"),gc=d(),w(qo.$$.fragment),kn=d(),Qe=a("h2"),vt=a("a"),Ds=a("span"),w(zo.$$.fragment),_c=d(),Os=a("span"),vc=r("FlaxViTForImageClassification"),In=d(),q=a("div"),w(No.$$.fragment),Tc=d(),Ss=a("p"),wc=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rn.forEach(t),od=c(de),b(pt.$$.fragment,de),ad=c(de),G=s(de,"DIV",{class:!0});var Ve=n(G);b(go.$$.fragment,Ve),sd=c(Ve),Je=s(Ve,"P",{});var qa=n(Je);nd=i(qa,"The "),_a=s(qa,"A",{href:!0});var Th=n(_a);rd=i(Th,"TFViTModel"),Th.forEach(t),id=i(qa," forward method, overrides the "),bs=s(qa,"CODE",{});var wh=n(bs);ld=i(wh,"__call__"),wh.forEach(t),dd=i(qa," special method."),qa.forEach(t),cd=c(Ve),b(ht.$$.fragment,Ve),pd=c(Ve),ys=s(Ve,"P",{});var bh=n(ys);hd=i(bh,"Examples:"),bh.forEach(t),md=c(Ve),b(_o.$$.fragment,Ve),Ve.forEach(t),de.forEach(t),xn=c(o),Ke=s(o,"H2",{class:!0});var Hn=n(Ke);mt=s(Hn,"A",{id:!0,class:!0,href:!0});var yh=n(mt);$s=s(yh,"SPAN",{});var $h=n($s);b(vo.$$.fragment,$h),$h.forEach(t),yh.forEach(t),fd=c(Hn),xs=s(Hn,"SPAN",{});var xh=n(xs);ud=i(xh,"TFViTForImageClassification"),xh.forEach(t),Hn.forEach(t),Fn=c(o),O=s(o,"DIV",{class:!0});var ce=n(O);b(To.$$.fragment,ce),gd=c(ce),Fs=s(ce,"P",{});var Fh=n(Fs);_d=i(Fh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kn.forEach(t),Vd=c(ce),b(ft.$$.fragment,ce),Ed=c(ce),X=s(ce,"DIV",{class:!0});var Ee=n(X);b($o.$$.fragment,Ee),kd=c(Ee),Ge=s(Ee,"P",{});var za=n(Ge);Id=i(za,"The "),Ta=s(za,"A",{href:!0});var kh=n(Ta);Md=i(kh,"TFViTForImageClassification"),kh.forEach(t),jd=i(za," forward method, overrides the "),Vs=s(za,"CODE",{});var Ih=n(Vs);Pd=i(Ih,"__call__"),Ih.forEach(t),Cd=i(za," special method."),za.forEach(t),Ad=c(Ee),b(ut.$$.fragment,Ee),qd=c(Ee),Es=s(Ee,"P",{});var Mh=n(Es);zd=i(Mh,"Examples:"),Mh.forEach(t),Nd=c(Ee),b(xo.$$.fragment,Ee),Ee.forEach(t),ce.forEach(t),Vn=c(o),Xe=s(o,"H2",{class:!0});var Gn=n(Xe);gt=s(Gn,"A",{id:!0,class:!0,href:!0});var jh=n(gt);ks=s(jh,"SPAN",{});var Ph=n(ks);b(Fo.$$.fragment,Ph),Ph.forEach(t),jh.forEach(t),Ld=c(Gn),Is=s(Gn,"SPAN",{});var Ch=n(Is);Dd=i(Ch,"FlaxVitModel"),Ch.forEach(t),Gn.forEach(t),En=c(o),A=s(o,"DIV",{class:!0});var ee=n(A);b(Vo.$$.fragment,ee),Od=c(ee),Ms=s(ee,"P",{});var Ah=n(Ms);Sd=i(Ah,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Ah.forEach(t),Wd=c(ee),Eo=s(ee,"P",{});var Xn=n(Eo);Bd=i(Xn,"This model inherits from "),wa=s(Xn,"A",{href:!0});var qh=n(wa);Ud=i(qh,"FlaxPreTrainedModel"),qh.forEach(t),Rd=i(Xn,`. Check the superclass documentation for the generic methods the
