import{S as gs,i as _s,s as bs,e as s,k as p,w as k,t as i,M as vs,c as a,d as t,m as h,a as r,x as y,h as l,b as u,F as e,g as b,y as w,q as $,o as T,B,v as ks,L as Yo}from"../../chunks/vendor-6b77c823.js";import{T as Pn}from"../../chunks/Tip-39098574.js";import{D as Ye}from"../../chunks/Docstring-1088f2fb.js";import{C as Jo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Je}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Ro}from"../../chunks/ExampleCodeBlock-5212b321.js";function ys(M){let d,v,f,c,_;return c=new Jo({props:{code:`from transformers import BloomModel, BloomConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),v=i("Example:"),f=p(),k(c.$$.fragment)},l(n){d=a(n,"P",{});var m=r(d);v=l(m,"Example:"),m.forEach(t),f=h(n),y(c.$$.fragment,n)},m(n,m){b(n,d,m),e(d,v),b(n,f,m),w(c,n,m),_=!0},p:Yo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function ws(M){let d,v,f,c,_;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=r(d);v=l(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(m,"CODE",{});var x=r(f);c=l(x,"Module"),x.forEach(t),_=l(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(n,m){b(n,d,m),e(d,v),e(d,f),e(f,c),e(d,_)},d(n){n&&t(d)}}}function $s(M){let d,v,f,c,_;return c=new Jo({props:{code:`from transformers import BloomTokenizer, BloomModel
import torch
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){d=s("p"),v=i("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),f=p(),k(c.$$.fragment)},l(n){d=a(n,"P",{});var m=r(d);v=l(m,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),m.forEach(t),f=h(n),y(c.$$.fragment,n)},m(n,m){b(n,d,m),e(d,v),b(n,f,m),w(c,n,m),_=!0},p:Yo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function Bs(M){let d,v,f,c,_,n,m,x;return{c(){d=s("p"),v=i("When used with "),f=s("code"),c=i("is_split_into_words=True"),_=i(", this tokenizer needs to be instantiated with "),n=s("code"),m=i("add_prefix_space=True"),x=i(".")},l(W){d=a(W,"P",{});var q=r(d);v=l(q,"When used with "),f=a(q,"CODE",{});var A=r(f);c=l(A,"is_split_into_words=True"),A.forEach(t),_=l(q,", this tokenizer needs to be instantiated with "),n=a(q,"CODE",{});var N=r(n);m=l(N,"add_prefix_space=True"),N.forEach(t),x=l(q,"."),q.forEach(t)},m(W,q){b(W,d,q),e(d,v),e(d,f),e(f,c),e(d,_),e(d,n),e(n,m),e(d,x)},d(W){W&&t(d)}}}function zs(M){let d,v,f,c,_;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=r(d);v=l(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(m,"CODE",{});var x=r(f);c=l(x,"Module"),x.forEach(t),_=l(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(n,m){b(n,d,m),e(d,v),e(d,f),e(f,c),e(d,_)},d(n){n&&t(d)}}}function Ms(M){let d,v,f,c,_;return c=new Jo({props:{code:`import torch
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17202/src/transformers/models/bloom/modeling_bloom.py#L943",returnDescription:`
<p>A <a
...
`),ge=s("a"),gt=i("bigscience/bloom"),_t=i("."),bt=p(),V=s("p"),vt=i("Configuration objects inherit from "),Ie=s("a"),kt=i("PretrainedConfig"),yt=i(` and can be used to control the model outputs. Read the
documentation from `),Ne=s("a"),wt=i("PretrainedConfig"),$t=i(" for more information."),Tt=p(),k(Z.$$.fragment),xo=p(),G=s("h2"),ee=s("a"),ao=s("span"),k(_e.$$.fragment),Bt=p(),ro=s("span"),zt=i("BloomModel"),Co=p(),C=s("div"),k(be.$$.fragment),Mt=p(),io=s("p"),xt=i("The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),Ct=p(),ve=s("p"),Ft=i("This model inherits from "),Se=s("a"),Et=i("PreTrainedModel"),Pt=i(`. Check the superclass documentation for the generic methods the
...
embeddings).`),fn=p(),Fe=s("p"),gn=i("This model inherits from "),We=s("a"),_n=i("PreTrainedModel"),bn=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),vn=p(),Ee=s("p"),kn=i("This model is also a PyTorch "),Pe=s("a"),yn=i("torch.nn.Module"),wn=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$n=p(),I=s("div"),k(qe.$$.fragment),Tn=p(),K=s("p"),Bn=i("The "),He=s("a"),zn=i("BloomForCausalLM"),Mn=i(" forward method, overrides the "),bo=s("code"),xn=i("__call__"),Cn=i(" special method."),Fn=p(),k(ie.$$.fragment),En=p(),k(le.$$.fragment),this.h()},l(o){const g=vs('[data-svelte="svelte-1phssyn"]',document.head);d=a(g,"META",{name:!0,content:!0}),g.forEach(t),v=h(o),f=a(o,"H1",{class:!0});var Le=r(f);c=a(Le,"A",{id:!0,class:!0,href:!0});var vo=r(c);_=a(vo,"SPAN",{});var ko=r(_);y(n.$$.fragment,ko),ko.forEach(t),vo.forEach(t),m=h(Le),x=a(Le,"SPAN",{});var yo=r(x);W=l(yo,"BLOOM"),yo.forEach(t),Le.forEach(t),q=h(o),A=a(o,"H2",{class:!0});var Ae=r(A);N=a(Ae,"A",{id:!0,class:!0,href:!0});var wo=r(N);Ke=a(wo,"SPAN",{});var $o=r(Ke);y(pe.$$.fragment,$o),$o.forEach(t),wo.forEach(t),Ko=h(Ae),Qe=a(Ae,"SPAN",{});var qn=r(Qe);Qo=l(qn,"Overview"),qn.forEach(t),Ae.forEach(t),To=h(o),Q=a(o,"P",{});var Ao=r(Q);Xo=l(Ao,"Bloom model has been proposed with its various versions through the "),he=a(Ao,"A",{href:!0,rel:!0});var Ln=r(he);Zo=l(Ln,"BigScience Workshop"),Ln.forEach(t),et=l(Ao,`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
The architecture of Bloom is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on different 46 languages including code.
...
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
`),ge=a(Ue,"A",{href:!0,rel:!0});var Un=r(ge);gt=l(Un,"bigscience/bloom"),Un.forEach(t),_t=l(Ue,"."),Ue.forEach(t),bt=h(de),V=a(de,"P",{});var Ve=r(V);vt=l(Ve,"Configuration objects inherit from "),Ie=a(Ve,"A",{href:!0});var Vn=r(Ie);kt=l(Vn,"PretrainedConfig"),Vn.forEach(t),yt=l(Ve,` and can be used to control the model outputs. Read the
documentation from `),Ne=a(Ve,"A",{href:!0});var Gn=r(Ne);wt=l(Gn,"PretrainedConfig"),Gn.forEach(t),$t=l(Ve," for more information."),Ve.forEach(t),Tt=h(de),y(Z.$$.fragment,de),de.forEach(t),xo=h(o),G=a(o,"H2",{class:!0});var Io=r(G);ee=a(Io,"A",{id:!0,class:!0,href:!0});var Rn=r(ee);ao=a(Rn,"SPAN",{});var Yn=r(ao);y(_e.$$.fragment,Yn),Yn.forEach(t),Rn.forEach(t),Bt=h(Io),ro=a(Io,"SPAN",{});var Jn=r(ro);zt=l(Jn,"BloomModel"),Jn.forEach(t),Io.forEach(t),Co=h(o),C=a(o,"DIV",{class:!0});var D=r(C);y(be.$$.fragment,D),Mt=h(D),io=a(D,"P",{});var Kn=r(io);xt=l(Kn,"The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),Kn.forEach(t),Ct=h(D),ve=a(D,"P",{});var No=r(ve);Ft=l(No,"This model inherits from "),Se=a(No,"A",{href:!0});var Qn=r(Se);Et=l(Qn,"PreTrainedModel"),Qn.forEach(t),Pt=l(No,`. Check the superclass documentation for the generic methods the
