...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),b=i("Example:"),f=p(),k(c.$$.fragment)},l(n){d=a(n,"P",{});var m=r(d);b=l(m,"Example:"),m.forEach(t),f=h(n),y(c.$$.fragment,n)},m(n,m){v(n,d,m),e(d,b),v(n,f,m),w(c,n,m),_=!0},p:Yo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function ws(M){let d,b,f,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=r(d);b=l(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(m,"CODE",{});var x=r(f);c=l(x,"Module"),x.forEach(t),_=l(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(n,m){v(n,d,m),e(d,b),e(d,f),e(f,c),e(d,_)},d(n){n&&t(d)}}}function $s(M){let d,b,f,c,_;return c=new Jo({props:{code:`from transformers import BloomTokenizer, BloomModel
import torch
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){d=s("p"),b=i("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),f=p(),k(c.$$.fragment)},l(n){d=a(n,"P",{});var m=r(d);b=l(m,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),m.forEach(t),f=h(n),y(c.$$.fragment,n)},m(n,m){v(n,d,m),e(d,b),v(n,f,m),w(c,n,m),_=!0},p:Yo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function Bs(M){let d,b,f,c,_,n,m,x;return{c(){d=s("p"),b=i("When used with "),f=s("code"),c=i("is_split_into_words=True"),_=i(", this tokenizer needs to be instantiated with "),n=s("code"),m=i("add_prefix_space=True"),x=i(".")},l(W){d=a(W,"P",{});var q=r(d);b=l(q,"When used with "),f=a(q,"CODE",{});var A=r(f);c=l(A,"is_split_into_words=True"),A.forEach(t),_=l(q,", this tokenizer needs to be instantiated with "),n=a(q,"CODE",{});var N=r(n);m=l(N,"add_prefix_space=True"),N.forEach(t),x=l(q,"."),q.forEach(t)},m(W,q){v(W,d,q),e(d,b),e(d,f),e(f,c),e(d,_),e(d,n),e(n,m),e(d,x)},d(W){W&&t(d)}}}function zs(M){let d,b,f,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=r(d);b=l(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(m,"CODE",{});var x=r(f);c=l(x,"Module"),x.forEach(t),_=l(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(n,m){v(n,d,m),e(d,b),e(d,f),e(f,c),e(d,_)},d(n){n&&t(d)}}}function Ms(M){let d,b,f,c,_;return c=new Jo({props:{code:`import torch
...
`}}),ie=new Pn({props:{$$slots:{default:[zs]},$$scope:{ctx:M}}}),le=new Ro({props:{anchor:"transformers.BloomForCausalLM.forward.example",$$slots:{default:[Ms]},$$scope:{ctx:M}}}),{c(){d=s("meta"),b=p(),f=s("h1"),c=s("a"),_=s("span"),k(n.$$.fragment),m=p(),x=s("span"),W=i("BLOOM"),q=p(),A=s("h2"),N=s("a"),Ke=s("span"),k(pe.$$.fragment),Ko=p(),Qe=s("span"),Qo=i("Overview"),To=p(),Q=s("p"),Xo=i("Bloom model has been proposed with its various versions through the "),he=s("a"),Zo=i("BigScience Workshop"),et=i(`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
...
Several smaller versions of the models have been trained on the same dataset. Bloom is available in the following version:`),Bo=p(),E=s("ul"),Xe=s("li"),ot=i("350M parameters"),tt=p(),Ze=s("li"),nt=i("760M parameters"),st=p(),eo=s("li"),at=i("1B300M parameters"),rt=p(),oo=s("li"),it=i("2B500M parameters"),lt=p(),to=s("li"),dt=i("175B parameters"),zo=p(),H=s("h2"),X=s("a"),no=s("span"),k(ue.$$.fragment),ct=p(),so=s("span"),mt=i("BloomConfig"),Mo=p(),L=s("div"),k(fe.$$.fragment),pt=p(),U=s("p"),ht=i("This is the configuration class to store the configuration of a "),je=s("a"),ut=i("BloomModel"),ft=i(`. It is used to instantiate a GPT-2
...
documentation from `),Ne=s("a"),wt=i("PretrainedConfig"),$t=i(" for more information."),Tt=p(),k(Z.$$.fragment),xo=p(),G=s("h2"),ee=s("a"),ao=s("span"),k(_e.$$.fragment),Bt=p(),ro=s("span"),zt=i("BloomModel"),Co=p(),C=s("div"),k(ve.$$.fragment),Mt=p(),io=s("p"),xt=i("The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),Ct=p(),be=s("p"),Ft=i("This model inherits from "),Se=s("a"),Et=i("PreTrainedModel"),Pt=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),qt=p(),ke=s("p"),Lt=i("This model is also a PyTorch "),ye=s("a"),At=i("torch.nn.Module"),jt=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),It=p(),j=s("div"),k(we.$$.fragment),Nt=p(),R=s("p"),St=i("The "),De=s("a"),Dt=i("BloomModel"),Ot=i(" forward method, overrides the "),lo=s("code"),Wt=i("__call__"),Ht=i(" special method."),Ut=p(),k(oe.$$.fragment),Vt=p(),k(te.$$.fragment),Fo=p(),Y=s("h2"),ne=s("a"),co=s("span"),k($e.$$.fragment),Gt=p(),mo=s("span"),Rt=i("BloomTokenizerFast"),Eo=p(),z=s("div"),k(Te.$$.fragment),Yt=p(),Be=s("p"),Jt=i("Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),po=s("em"),Kt=i("tokenizers"),Qt=i(` library). Based on byte-level
...
the model was not pretrained this way, it might yield a decrease in performance.`),an=p(),k(ae.$$.fragment),rn=p(),Me=s("p"),ln=i("This tokenizer inherits from "),Oe=s("a"),dn=i("PreTrainedTokenizerFast"),cn=i(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Po=p(),J=s("h2"),re=s("a"),fo=s("span"),k(xe.$$.fragment),mn=p(),go=s("span"),pn=i("BloomForCausalLM"),qo=p(),F=s("div"),k(Ce.$$.fragment),hn=p(),_o=s("p"),un=i(`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),fn=p(),Fe=s("p"),gn=i("This model inherits from "),We=s("a"),_n=i("PreTrainedModel"),vn=i(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$n=p(),I=s("div"),k(qe.$$.fragment),Tn=p(),K=s("p"),Bn=i("The "),He=s("a"),zn=i("BloomForCausalLM"),Mn=i(" forward method, overrides the "),vo=s("code"),xn=i("__call__"),Cn=i(" special method."),Fn=p(),k(ie.$$.fragment),En=p(),k(le.$$.fragment),this.h()},l(o){const g=bs('[data-svelte="svelte-1phssyn"]',document.head);d=a(g,"META",{name:!0,content:!0}),g.forEach(t),b=h(o),f=a(o,"H1",{class:!0});var Le=r(f);c=a(Le,"A",{id:!0,class:!0,href:!0});var bo=r(c);_=a(bo,"SPAN",{});var ko=r(_);y(n.$$.fragment,ko),ko.forEach(t),bo.forEach(t),m=h(Le),x=a(Le,"SPAN",{});var yo=r(x);W=l(yo,"BLOOM"),yo.forEach(t),Le.forEach(t),q=h(o),A=a(o,"H2",{class:!0});var Ae=r(A);N=a(Ae,"A",{id:!0,class:!0,href:!0});var wo=r(N);Ke=a(wo,"SPAN",{});var $o=r(Ke);y(pe.$$.fragment,$o),$o.forEach(t),wo.forEach(t),Ko=h(Ae),Qe=a(Ae,"SPAN",{});var qn=r(Qe);Qo=l(qn,"Overview"),qn.forEach(t),Ae.forEach(t),To=h(o),Q=a(o,"P",{});var Ao=r(Q);Xo=l(Ao,"Bloom model has been proposed with its various versions through the "),he=a(Ao,"A",{href:!0,rel:!0});var Ln=r(he);Zo=l(Ln,"BigScience Workshop"),Ln.forEach(t),et=l(Ao,`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
The architecture of Bloom is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on different 46 languages including code.
Several smaller versions of the models have been trained on the same dataset. Bloom is available in the following version:`),Ao.forEach(t),Bo=h(o),E=a(o,"UL",{});var S=r(E);Xe=a(S,"LI",{});var An=r(Xe);ot=l(An,"350M parameters"),An.forEach(t),tt=h(S),Ze=a(S,"LI",{});var jn=r(Ze);nt=l(jn,"760M parameters"),jn.forEach(t),st=h(S),eo=a(S,"LI",{});var In=r(eo);at=l(In,"1B300M parameters"),In.forEach(t),rt=h(S),oo=a(S,"LI",{});var Nn=r(oo);it=l(Nn,"2B500M parameters"),Nn.forEach(t),lt=h(S),to=a(S,"LI",{});var Sn=r(to);dt=l(Sn,"175B parameters"),Sn.forEach(t),S.forEach(t),zo=h(o),H=a(o,"H2",{class:!0});var jo=r(H);X=a(jo,"A",{id:!0,class:!0,href:!0});var Dn=r(X);no=a(Dn,"SPAN",{});var On=r(no);y(ue.$$.fragment,On),On.forEach(t),Dn.forEach(t),ct=h(jo),so=a(jo,"SPAN",{});var Wn=r(so);mt=l(Wn,"BloomConfig"),Wn.forEach(t),jo.forEach(t),Mo=h(o),L=a(o,"DIV",{class:!0});var de=r(L);y(fe.$$.fragment,de),pt=h(de),U=a(de,"P",{});var Ue=r(U);ht=l(Ue,"This is the configuration class to store the configuration of a "),je=a(Ue,"A",{href:!0});var Hn=r(je);ut=l(Hn,"BloomModel"),Hn.forEach(t),ft=l(Ue,`. It is used to instantiate a GPT-2
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
...
documentation from `),Ne=a(Ve,"A",{href:!0});var Gn=r(Ne);wt=l(Gn,"PretrainedConfig"),Gn.forEach(t),$t=l(Ve," for more information."),Ve.forEach(t),Tt=h(de),y(Z.$$.fragment,de),de.forEach(t),xo=h(o),G=a(o,"H2",{class:!0});var Io=r(G);ee=a(Io,"A",{id:!0,class:!0,href:!0});var Rn=r(ee);ao=a(Rn,"SPAN",{});var Yn=r(ao);y(_e.$$.fragment,Yn),Yn.forEach(t),Rn.forEach(t),Bt=h(Io),ro=a(Io,"SPAN",{});var Jn=r(ro);zt=l(Jn,"BloomModel"),Jn.forEach(t),Io.forEach(t),Co=h(o),C=a(o,"DIV",{class:!0});var D=r(C);y(ve.$$.fragment,D),Mt=h(D),io=a(D,"P",{});var Kn=r(io);xt=l(Kn,"The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),Kn.forEach(t),Ct=h(D),be=a(D,"P",{});var No=r(be);Ft=l(No,"This model inherits from "),Se=a(No,"A",{href:!0});var Qn=r(Se);Et=l(Qn,"PreTrainedModel"),Qn.forEach(t),Pt=l(No,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),No.forEach(t),qt=h(D),ke=a(D,"P",{});var So=r(ke);Lt=l(So,"This model is also a PyTorch "),ye=a(So,"A",{href:!0,rel:!0});var Xn=r(ye);At=l(Xn,"torch.nn.Module"),Xn.forEach(t),jt=l(So,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),So.forEach(t),It=h(D),j=a(D,"DIV",{class:!0});var ce=r(j);y(we.$$.fragment,ce),Nt=h(ce),R=a(ce,"P",{});var Ge=r(R);St=l(Ge,"The "),De=a(Ge,"A",{href:!0});var Zn=r(De);Dt=l(Zn,"BloomModel"),Zn.forEach(t),Ot=l(Ge," forward method, overrides the "),lo=a(Ge,"CODE",{});var es=r(lo);Wt=l(es,"__call__"),es.forEach(t),Ht=l(Ge," special method."),Ge.forEach(t),Ut=h(ce),y(oe.$$.fragment,ce),Vt=h(ce),y(te.$$.fragment,ce),ce.forEach(t),D.forEach(t),Fo=h(o),Y=a(o,"H2",{class:!0});var Do=r(Y);ne=a(Do,"A",{id:!0,class:!0,href:!0});var os=r(ne);co=a(os,"SPAN",{});var ts=r(co);y($e.$$.fragment,ts),ts.forEach(t),os.forEach(t),Gt=h(Do),mo=a(Do,"SPAN",{});var ns=r(mo);Rt=l(ns,"BloomTokenizerFast"),ns.forEach(t),Do.forEach(t),Eo=h(o),z=a(o,"DIV",{class:!0});var P=r(z);y(Te.$$.fragment,P),Yt=h(P),Be=a(P,"P",{});var Oo=r(Be);Jt=l(Oo,"Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),po=a(Oo,"EM",{});var ss=r(po);Kt=l(ss,"tokenizers"),ss.forEach(t),Qt=l(Oo,` library). Based on byte-level
Byte-Pair-Encoding.`),Oo.forEach(t),Xt=h(P),ho=a(P,"P",{});var as=r(ho);Zt=l(as,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),as.forEach(t),en=h(P),y(se.$$.fragment,P),on=h(P),ze=a(P,"P",{});var Wo=r(ze);tn=l(Wo,"You can get around that behavior by passing "),uo=a(Wo,"CODE",{});var rs=r(uo);nn=l(rs,"add_prefix_space=True"),rs.forEach(t),sn=l(Wo,` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),Wo.forEach(t),an=h(P),y(ae.$$.fragment,P),rn=h(P),Me=a(P,"P",{});var Ho=r(Me);ln=l(Ho,"This tokenizer inherits from "),Oe=a(Ho,"A",{href:!0});var is=r(Oe);dn=l(is,"PreTrainedTokenizerFast"),is.forEach(t),cn=l(Ho,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Ho.forEach(t),P.forEach(t),Po=h(o),J=a(o,"H2",{class:!0});var Uo=r(J);re=a(Uo,"A",{id:!0,class:!0,href:!0});var ls=r(re);fo=a(ls,"SPAN",{});var ds=r(fo);y(xe.$$.fragment,ds),ds.forEach(t),ls.forEach(t),mn=h(Uo),go=a(Uo,"SPAN",{});var cs=r(go);pn=l(cs,"BloomForCausalLM"),cs.forEach(t),Uo.forEach(t),qo=h(o),F=a(o,"DIV",{class:!0});var O=r(F);y(Ce.$$.fragment,O),hn=h(O),_o=a(O,"P",{});var ms=r(_o);un=l(ms,`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),ms.forEach(t),fn=h(O),Fe=a(O,"P",{});var Vo=r(Fe);gn=l(Vo,"This model inherits from "),We=a(Vo,"A",{href:!0});var ps=r(We);_n=l(ps,"PreTrainedModel"),ps.forEach(t),vn=l(Vo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),Vo.forEach(t),bn=h(O),Ee=a(O,"P",{});var Go=r(Ee);kn=l(Go,"This model is also a PyTorch "),Pe=a(Go,"A",{href:!0,rel:!0});var hs=r(Pe);yn=l(hs,"torch.nn.Module"),hs.forEach(t),wn=l(Go,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Go.forEach(t),$n=h(O),I=a(O,"DIV",{class:!0});var me=r(I);y(qe.$$.fragment,me),Tn=h(me),K=a(me,"P",{});var Re=r(K);Bn=l(Re,"The "),He=a(Re,"A",{href:!0});var us=r(He);zn=l(us,"BloomForCausalLM"),us.forEach(t),Mn=l(Re," forward method, overrides the "),vo=a(Re,"CODE",{});var fs=r(vo);xn=l(fs,"__call__"),fs.forEach(t),Cn=l(Re," special method."),Re.forEach(t),Fn=h(me),y(ie.$$.fragment,me),En=h(me),y(le.$$.fragment,me),me.forEach(t),O.forEach(t),this.h()},h(){u(d,"name","hf:doc:metadata"),u(d,"content",JSON.stringify(Cs)),u(c,"id","bloom"),u(c,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(c,"href","#bloom"),u(f,"class","relative group"),u(N,"id","overview"),u(N,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(N,"href","#overview"),u(A,"class","relative group"),u(he,"href","https://bigscience.huggingface.co/"),u(he,"rel","nofollow"),u(X,"id","transformers.BloomConfig"),u(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(X,"href","#transformers.BloomConfig"),u(H,"class","relative group"),u(je,"href","/docs/transformers/pr_17202/en/model_doc/bloom#transformers.BloomModel"),u(ge,"href","https://huggingface.co/bigscience/bloom"),u(ge,"rel","nofollow"),u(Ie,"href","/docs/transformers/pr_17202/en/main_classes/configuration#transformers.PretrainedConfig"),u(Ne,"href","/docs/transformers/pr_17202/en/main_classes/configuration#transformers.PretrainedConfig"),u(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ee,"id","transformers.BloomModel"),u(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ee,"href","#transformers.BloomModel"),u(G,"class","relative group"),u(Se,"href","/docs/transformers/pr_17202/en/main_classes/model#transformers.PreTrainedModel"),u(ye,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(ye,"rel","nofollow"),u(De,"href","/docs/transformers/pr_17202/en/model_doc/bloom#transformers.BloomModel"),u(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ne,"id","transformers.BloomTokenizerFast"),u(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ne,"href","#transformers.BloomTokenizerFast"),u(Y,"class","relative group"),u(Oe,"href","/docs/transformers/pr_17202/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),u(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(re,"id","transformers.BloomForCausalLM"),u(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(re,"href","#transformers.BloomForCausalLM"),u(J,"class","relative group"),u(We,"href","/docs/transformers/pr_17202/en/main_classes/model#transformers.PreTrainedModel"),u(Pe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Pe,"rel","nofollow"),u(He,"href","/docs/transformers/pr_17202/en/model_doc/bloom#transformers.BloomForCausalLM"),u(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,g){e(document.head,d),v(o,b,g),v(o,f,g),e(f,c),e(c,_),w(n,_,null),e(f,m),e(f,x),e(x,W),v(o,q,g),v(o,A,g),e(A,N),e(N,Ke),w(pe,Ke,null),e(A,Ko),e(A,Qe),e(Qe,Qo),v(o,To,g),v(o,Q,g),e(Q,Xo),e(Q,he),e(he,Zo),e(Q,et),v(o,Bo,g),v(o,E,g),e(E,Xe),e(Xe,ot),e(E,tt),e(E,Ze),e(Ze,nt),e(E,st),e(E,eo),e(eo,at),e(E,rt),e(E,oo),e(oo,it),e(E,lt),e(E,to),e(to,dt),v(o,zo,g),v(o,H,g),e(H,X),e(X,no),w(ue,no,null),e(H,ct),e(H,so),e(so,mt),v(o,Mo,g),v(o,L,g),w(fe,L,null),e(L,pt),e(L,U),e(U,ht),e(U,je),e(je,ut),e(U,ft),e(U,ge),e(ge,gt),e(U,_t),e(L,vt),e(L,V),e(V,bt),e(V,Ie),e(Ie,kt),e(V,yt),e(V,Ne),e(Ne,wt),e(V,$t),e(L,Tt),w(Z,L,null),v(o,xo,g),v(o,G,g),e(G,ee),e(ee,ao),w(_e,ao,null),e(G,Bt),e(G,ro),e(ro,zt),v(o,Co,g),v(o,C,g),w(ve,C,null),e(C,Mt),e(C,io),e(io,xt),e(C,Ct),e(C,be),e(be,Ft),e(be,Se),e(Se,Et),e(be,Pt),e(C,qt),e(C,ke),e(ke,Lt),e(ke,ye),e(ye,At),e(ke,jt),e(C,It),e(C,j),w(we,j,null),e(j,Nt),e(j,R),e(R,St),e(R,De),e(De,Dt),e(R,Ot),e(R,lo),e(lo,Wt),e(R,Ht),e(j,Ut),w(oe,j,null),e(j,Vt),w(te,j,null),v(o,Fo,g),v(o,Y,g),e(Y,ne),e(ne,co),w($e,co,null),e(Y,Gt),e(Y,mo),e(mo,Rt),v(o,Eo,g),v(o,z,g),w(Te,z,null),e(z,Yt),e(z,Be),e(Be,Jt),e(Be,po),e(po,Kt),e(Be,Qt),e(z,Xt),e(z,ho),e(ho,Zt),e(z,en),w(se,z,null),e(z,on),e(z,ze),e(ze,tn),e(ze,uo),e(uo,nn),e(ze,sn),e(z,an),w(ae,z,null),e(z,rn),e(z,Me),e(Me,ln),e(Me,Oe),e(Oe,dn),e(Me,cn),v(o,Po,g),v(o,J,g),e(J,re),e(re,fo),w(xe,fo,null),e(J,mn),e(J,go),e(go,pn),v(o,qo,g),v(o,F,g),w(Ce,F,null),e(F,hn),e(F,_o),e(_o,un),e(F,fn),e(F,Fe),e(Fe,gn),e(Fe,We),e(We,_n),e(Fe,vn),e(F,bn),e(F,Ee),e(Ee,kn),e(Ee,Pe),e(Pe,yn),e(Ee,wn),e(F,$n),e(F,I),w(qe,I,null),e(I,Tn),e(I,K),e(K,Bn),e(K,He),e(He,zn),e(K,Mn),e(K,vo),e(vo,xn),e(K,Cn),e(I,Fn),w(ie,I,null),e(I,En),w(le,I,null),Lo=!0},p(o,[g]){const Le={};g&2&&(Le.$$scope={dirty:g,ctx:o}),Z.$set(Le);const bo={};g&2&&(bo.$$scope={dirty:g,ctx:o}),oe.$set(bo);const ko={};g&2&&(ko.$$scope={dirty:g,ctx:o}),te.$set(ko);const yo={};g&2&&(yo.$$scope={dirty:g,ctx:o}),se.$set(yo);const Ae={};g&2&&(Ae.$$scope={dirty:g,ctx:o}),ae.$set(Ae);const wo={};g&2&&(wo.$$scope={dirty:g,ctx:o}),ie.$set(wo);const $o={};g&2&&($o.$$scope={dirty:g,ctx:o}),le.$set($o)},i(o){Lo||($(n.$$.fragment,o),$(pe.$$.fragment,o),$(ue.$$.fragment,o),$(fe.$$.fragment,o),$(Z.$$.fragment,o),$(_e.$$.fragment,o),$(ve.$$.fragment,o),$(we.$$.fragment,o),$(oe.$$.fragment,o),$(te.$$.fragment,o),$($e.$$.fragment,o),$(Te.$$.fragment,o),$(se.$$.fragment,o),$(ae.$$.fragment,o),$(xe.$$.fragment,o),$(Ce.$$.fragment,o),$(qe.$$.fragment,o),$(ie.$$.fragment,o),$(le.$$.fragment,o),Lo=!0)},o(o){T(n.$$.fragment,o),T(pe.$$.fragment,o),T(ue.$$.fragment,o),T(fe.$$.fragment,o),T(Z.$$.fragment,o),T(_e.$$.fragment,o),T(ve.$$.fragment,o),T(we.$$.fragment,o),T(oe.$$.fragment,o),T(te.$$.fragment,o),T($e.$$.fragment,o),T(Te.$$.fragment,o),T(se.$$.fragment,o),T(ae.$$.fragment,o),T(xe.$$.fragment,o),T(Ce.$$.fragment,o),T(qe.$$.fragment,o),T(ie.$$.fragment,o),T(le.$$.fragment,o),Lo=!1},d(o){t(d),o&&t(b),o&&t(f),B(n),o&&t(q),o&&t(A),B(pe),o&&t(To),o&&t(Q),o&&t(Bo),o&&t(E),o&&t(zo),o&&t(H),B(ue),o&&t(Mo),o&&t(L),B(fe),B(Z),o&&t(xo),o&&t(G),B(_e),o&&t(Co),o&&t(C),B(ve),B(we),B(oe),B(te),o&&t(Fo),o&&t(Y),B($e),o&&t(Eo),o&&t(z),B(Te),B(se),B(ae),o&&t(Po),o&&t(J),B(xe),o&&t(qo),o&&t(F),B(Ce),B(qe),B(ie),B(le)}}}const Cs={local:"bloom",sections:[{local:"overview",title:"Overview"},{local:"transformers.BloomConfig",title:"BloomConfig"},{local:"transformers.BloomModel",title:"BloomModel"},{local:"transformers.BloomTokenizerFast",title:"BloomTokenizerFast"},{local:"transformers.BloomForCausalLM",title:"BloomForCausalLM"}],title:"BLOOM"};function Fs(M){return ks(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Is extends gs{constructor(d){super();_s(this,d,Fs,xs,vs,{})}}export{Is as default,Cs as metadata};
