...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17202/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17202/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u1=h(bt),dh=s(bt,"P",{});var dM=a(dh);g1=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_1=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);b1=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),k1=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var mM=a(Qi);v1=i(mM,"Automatic Differentiation"),mM.forEach(t),hM.forEach(t),y1=h(ca),hh=s(ca,"LI",{});var fM=a(hh);Ji=s(fM,"A",{href:!0,rel:!0});var uM=a(Ji);T1=i(uM,"Vectorization"),uM.forEach(t),fM.forEach(t),w1=h(ca),mh=s(ca,"LI",{});var gM=a(mh);Vi=s(gM,"A",{href:!0,rel:!0});var _M=a(Vi);$1=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),F1=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);T(Ki.$$.fragment,pa),x1=h(pa),nn=s(pa,"P",{});var rc=a(nn);R1=i(rc,"The "),fh=s(rc,"CODE",{});var bM=a(fh);M1=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),E1=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kM=a(uh);z1=i(kM,"__call__"),kM.forEach(t),q1=i(rc," special method."),rc.forEach(t),C1=h(pa),T(Ds.$$.fragment,pa),j1=h(pa),T(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),Cf=h(o),sn=s(o,"H2",{class:!0});var Ju=a(sn);Ws=s(Ju,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var yM=a(gh);T(Gi.$$.fragment,yM),yM.forEach(t),vM.forEach(t),P1=h(Ju),_h=s(Ju,"SPAN",{});var TM=a(_h);L1=i(TM,"FlaxRobertaForSequenceClassification"),TM.forEach(t),Ju.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);T(Xi.$$.fragment,kt),A1=h(kt),bh=s(kt,"P",{});var wM=a(bh);O1=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wM.forEach(t),N1=h(kt),Yi=s(kt,"P",{});var Vu=a(Yi);I1=i(Vu,"This model inherits from "),Ld=s(Vu,"A",{href:!0});var $M=a(Ld);D1=i($M,"FlaxPreTrainedModel"),$M.forEach(t),S1=i(Vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vu.forEach(t),W1=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);B1=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var FM=a(el);U1=i(FM,"flax.linen.Module"),FM.forEach(t),H1=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q1=h(kt),kh=s(kt,"P",{});var xM=a(kh);J1=i(xM,"Finally, this model supports inherent JAX features such as:"),xM.forEach(t),V1=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RM=a(vh);tl=s(RM,"A",{href:!0,rel:!0});var MM=a(tl);K1=i(MM,"Just-In-Time (JIT) compilation"),MM.forEach(t),RM.forEach(t),G1=h(ha),yh=s(ha,"LI",{});var EM=a(yh);ol=s(EM,"A",{href:!0,rel:!0});var zM=a(ol);X1=i(zM,"Automatic Differentiation"),zM.forEach(t),EM.forEach(t),Y1=h(ha),Th=s(ha,"LI",{});var qM=a(Th);nl=s(qM,"A",{href:!0,rel:!0});var CM=a(nl);Z1=i(CM,"Vectorization"),CM.forEach(t),qM.forEach(t),e$=h(ha),wh=s(ha,"LI",{});var jM=a(wh);sl=s(jM,"A",{href:!0,rel:!0});var PM=a(sl);t$=i(PM,"Parallelization"),PM.forEach(t),jM.forEach(t),ha.forEach(t),o$=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n$=h(ma),an=s(ma,"P",{});var ic=a(an);s$=i(ic,"The "),$h=s(ic,"CODE",{});var LM=a($h);a$=i(LM,"FlaxRobertaPreTrainedModel"),LM.forEach(t),r$=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AM=a(Fh);i$=i(AM,"__call__"),AM.forEach(t),l$=i(ic," special method."),ic.forEach(t),d$=h(ma),T(Bs.$$.fragment,ma),c$=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OM=a(Hs);xh=s(OM,"SPAN",{});var NM=a(xh);T(rl.$$.fragment,NM),NM.forEach(t),OM.forEach(t),p$=h(Gu),Rh=s(Gu,"SPAN",{});var IM=a(Rh);h$=i(IM,"FlaxRobertaForMultipleChoice"),IM.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m$=h(vt),Mh=s(vt,"P",{});var DM=a(Mh);f$=i(DM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
