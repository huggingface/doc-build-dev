import{S as gs,i as _s,s as vs,e as s,k as m,w as k,t as i,M as bs,c as r,d as t,m as h,a,x as y,h as l,b as u,G as e,g as v,y as w,q as $,o as T,B,v as ks,L as Yo}from"../../chunks/vendor-hf-doc-builder.js";import{T as Pn}from"../../chunks/Tip-hf-doc-builder.js";import{D as Ye}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Jo}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Je}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ro}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function ys(M){let d,b,f,c,_;return c=new Jo({props:{code:`from transformers import BloomModel, BloomConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),b=i("Example:"),f=m(),k(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Example:"),p.forEach(t),f=h(n),y(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,f,p),w(c,n,p),_=!0},p:Yo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function ws(M){let d,b,f,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(p,"CODE",{});var x=a(f);c=l(x,"Module"),x.forEach(t),_=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){v(n,d,p),e(d,b),e(d,f),e(f,c),e(d,_)},d(n){n&&t(d)}}}function $s(M){let d,b,f,c,_;return c=new Jo({props:{code:`from transformers import BloomTokenizer, BloomModel
import torch
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){d=s("p"),b=i("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),f=m(),k(c.$$.fragment)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),p.forEach(t),f=h(n),y(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,b),v(n,f,p),w(c,n,p),_=!0},p:Yo,i(n){_||($(c.$$.fragment,n),_=!0)},o(n){T(c.$$.fragment,n),_=!1},d(n){n&&t(d),n&&t(f),B(c,n)}}}function Bs(M){let d,b,f,c,_,n,p,x;return{c(){d=s("p"),b=i("When used with "),f=s("code"),c=i("is_split_into_words=True"),_=i(", this tokenizer needs to be instantiated with "),n=s("code"),p=i("add_prefix_space=True"),x=i(".")},l(W){d=r(W,"P",{});var q=a(d);b=l(q,"When used with "),f=r(q,"CODE",{});var A=a(f);c=l(A,"is_split_into_words=True"),A.forEach(t),_=l(q,", this tokenizer needs to be instantiated with "),n=r(q,"CODE",{});var N=a(n);p=l(N,"add_prefix_space=True"),N.forEach(t),x=l(q,"."),q.forEach(t)},m(W,q){v(W,d,q),e(d,b),e(d,f),e(f,c),e(d,_),e(d,n),e(n,p),e(d,x)},d(W){W&&t(d)}}}function zs(M){let d,b,f,c,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),c=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var p=a(d);b=l(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(p,"CODE",{});var x=a(f);c=l(x,"Module"),x.forEach(t),_=l(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){v(n,d,p),e(d,b),e(d,f),e(f,c),e(d,_)},d(n){n&&t(d)}}}function Ms(M){let d,b,f,c,_;return c=new Jo({props:{code:`import torch
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17202/src/transformers/models/bloom/modeling_bloom.py#L875",returnDescription:`
<p>A <a
...
`),ge=s("a"),gt=i("bigscience/bloom"),_t=i("."),vt=m(),V=s("p"),bt=i("Configuration objects inherit from "),Ie=s("a"),kt=i("PretrainedConfig"),yt=i(` and can be used to control the model outputs. Read the
documentation from `),Ne=s("a"),wt=i("PretrainedConfig"),$t=i(" for more information."),Tt=m(),k(Z.$$.fragment),xo=m(),G=s("h2"),ee=s("a"),ro=s("span"),k(_e.$$.fragment),Bt=m(),ao=s("span"),zt=i("BloomModel"),Co=m(),C=s("div"),k(ve.$$.fragment),Mt=m(),io=s("p"),xt=i("The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),Ct=m(),be=s("p"),Ft=i("This model inherits from "),Se=s("a"),Et=i("PreTrainedModel"),Pt=i(`. Check the superclass documentation for the generic methods the
...
embeddings).`),fn=m(),Fe=s("p"),gn=i("This model inherits from "),We=s("a"),_n=i("PreTrainedModel"),vn=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),bn=m(),Ee=s("p"),kn=i("This model is also a PyTorch "),Pe=s("a"),yn=i("torch.nn.Module"),wn=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$n=m(),I=s("div"),k(qe.$$.fragment),Tn=m(),K=s("p"),Bn=i("The "),He=s("a"),zn=i("BloomForCausalLM"),Mn=i(" forward method, overrides the "),vo=s("code"),xn=i("__call__"),Cn=i(" special method."),Fn=m(),k(ie.$$.fragment),En=m(),k(le.$$.fragment),this.h()},l(o){const g=bs('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(t),b=h(o),f=r(o,"H1",{class:!0});var Le=a(f);c=r(Le,"A",{id:!0,class:!0,href:!0});var bo=a(c);_=r(bo,"SPAN",{});var ko=a(_);y(n.$$.fragment,ko),ko.forEach(t),bo.forEach(t),p=h(Le),x=r(Le,"SPAN",{});var yo=a(x);W=l(yo,"BLOOM"),yo.forEach(t),Le.forEach(t),q=h(o),A=r(o,"H2",{class:!0});var Ae=a(A);N=r(Ae,"A",{id:!0,class:!0,href:!0});var wo=a(N);Ke=r(wo,"SPAN",{});var $o=a(Ke);y(me.$$.fragment,$o),$o.forEach(t),wo.forEach(t),Ko=h(Ae),Qe=r(Ae,"SPAN",{});var qn=a(Qe);Qo=l(qn,"Overview"),qn.forEach(t),Ae.forEach(t),To=h(o),Q=r(o,"P",{});var Ao=a(Q);Xo=l(Ao,"Bloom model has been proposed with its various versions through the "),he=r(Ao,"A",{href:!0,rel:!0});var Ln=a(he);Zo=l(Ln,"BigScience Workshop"),Ln.forEach(t),et=l(Ao,`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
The architecture of Bloom is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on different 46 languages including code.
Several smaller versions of the models have been trained on the same dataset. Bloom is available in the following version:`),Ao.forEach(t),Bo=h(o),E=r(o,"UL",{});var S=a(E);Xe=r(S,"LI",{});var An=a(Xe);ot=l(An,"350M parameters"),An.forEach(t),tt=h(S),Ze=r(S,"LI",{});var jn=a(Ze);nt=l(jn,"760M parameters"),jn.forEach(t),st=h(S),eo=r(S,"LI",{});var In=a(eo);rt=l(In,"1B300M parameters"),In.forEach(t),at=h(S),oo=r(S,"LI",{});var Nn=a(oo);it=l(Nn,"2B500M parameters"),Nn.forEach(t),lt=h(S),to=r(S,"LI",{});var Sn=a(to);dt=l(Sn,"175B parameters"),Sn.forEach(t),S.forEach(t),zo=h(o),H=r(o,"H2",{class:!0});var jo=a(H);X=r(jo,"A",{id:!0,class:!0,href:!0});var Dn=a(X);no=r(Dn,"SPAN",{});var On=a(no);y(ue.$$.fragment,On),On.forEach(t),Dn.forEach(t),ct=h(jo),so=r(jo,"SPAN",{});var Wn=a(so);pt=l(Wn,"BloomConfig"),Wn.forEach(t),jo.forEach(t),Mo=h(o),L=r(o,"DIV",{class:!0});var de=a(L);y(fe.$$.fragment,de),mt=h(de),U=r(de,"P",{});var Ue=a(U);ht=l(Ue,"This is the configuration class to store the configuration of a "),je=r(Ue,"A",{href:!0});var Hn=a(je);ut=l(Hn,"BloomModel"),Hn.forEach(t),ft=l(Ue,`. It is used to instantiate a GPT-2
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
`),ge=r(Ue,"A",{href:!0,rel:!0});var Un=a(ge);gt=l(Un,"bigscience/bloom"),Un.forEach(t),_t=l(Ue,"."),Ue.forEach(t),vt=h(de),V=r(de,"P",{});var Ve=a(V);bt=l(Ve,"Configuration objects inherit from "),Ie=r(Ve,"A",{href:!0});var Vn=a(Ie);kt=l(Vn,"PretrainedConfig"),Vn.forEach(t),yt=l(Ve,` and can be used to control the model outputs. Read the
documentation from `),Ne=r(Ve,"A",{href:!0});var Gn=a(Ne);wt=l(Gn,"PretrainedConfig"),Gn.forEach(t),$t=l(Ve," for more information."),Ve.forEach(t),Tt=h(de),y(Z.$$.fragment,de),de.forEach(t),xo=h(o),G=r(o,"H2",{class:!0});var Io=a(G);ee=r(Io,"A",{id:!0,class:!0,href:!0});var Rn=a(ee);ro=r(Rn,"SPAN",{});var Yn=a(ro);y(_e.$$.fragment,Yn),Yn.forEach(t),Rn.forEach(t),Bt=h(Io),ao=r(Io,"SPAN",{});var Jn=a(ao);zt=l(Jn,"BloomModel"),Jn.forEach(t),Io.forEach(t),Co=h(o),C=r(o,"DIV",{class:!0});var D=a(C);y(ve.$$.fragment,D),Mt=h(D),io=r(D,"P",{});var Kn=a(io);xt=l(Kn,"The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),Kn.forEach(t),Ct=h(D),be=r(D,"P",{});var No=a(be);Ft=l(No,"This model inherits from "),Se=r(No,"A",{href:!0});var Qn=a(Se);Et=l(Qn,"PreTrainedModel"),Qn.forEach(t),Pt=l(No,`. Check the superclass documentation for the generic methods the
