import{S as As,i as Os,s as qs,e as r,k as d,w as p,t as o,M as Ss,c as a,d as t,m as c,a as s,x as g,h as n,b as h,F as e,g as z,y as _,q as b,o as y,B as v,v as Fs}from"../../chunks/vendor-6b77c823.js";import{T as Ta}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-abef54e3.js";import{C as js}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as zs}from"../../chunks/IconCopyLink-7a11ce68.js";function Is(J){let m,C,u,w,j;return{c(){m=r("p"),C=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
initialize a model does `),u=r("strong"),w=o("not"),j=o(" load the model weights. It only affects the model\u2019s configuration.")},l(k){m=a(k,"P",{});var P=s(m);C=n(P,`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
initialize a model does `),u=a(P,"STRONG",{});var q=s(u);w=n(q,"not"),q.forEach(t),j=n(P," load the model weights. It only affects the model\u2019s configuration."),P.forEach(t)},m(k,P){z(k,m,P),e(m,C),e(m,u),e(u,w),e(m,j)},d(k){k&&t(m)}}}function Ls(J){let m,C,u,w,j;return{c(){m=r("p"),C=o("Passing "),u=r("code"),w=o("use_auth_token=True"),j=o(" is required when you want to use a private model.")},l(k){m=a(k,"P",{});var P=s(m);C=n(P,"Passing "),u=a(P,"CODE",{});var q=s(u);w=n(q,"use_auth_token=True"),q.forEach(t),j=n(P," is required when you want to use a private model."),P.forEach(t)},m(k,P){z(k,m,P),e(m,C),e(m,u),e(u,w),e(m,j)},d(k){k&&t(m)}}}function Ns(J){let m,C;return{c(){m=r("p"),C=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(u){m=a(u,"P",{});var w=s(m);C=n(w,"This API is experimental and may have some slight breaking changes in the next releases."),w.forEach(t)},m(u,w){z(u,m,w),e(m,C)},d(u){u&&t(m)}}}function Ms(J){let m,C,u,w,j,k,P,q,jo,ao,G,zo,Ge,Ao,Oo,so,T,qo,it,So,Fo,dt,Io,Lo,ct,No,Mo,lt,Wo,Ho,io,B,X,ft,we,Vo,ht,Bo,co,l,$e,Ro,mt,Uo,Jo,K,Go,ut,Xo,Ko,S,M,pt,Qo,Yo,gt,Zo,en,Xe,tn,on,nn,x,_t,rn,an,bt,sn,dn,Ke,cn,ln,Qe,fn,hn,Ye,mn,un,pn,Q,yt,gn,_n,vt,bn,yn,vn,Y,wt,wn,$n,$t,kn,Pn,Cn,kt,En,Tn,F,Z,Pt,xn,Dn,Ct,jn,zn,An,ee,Et,On,qn,Tt,Sn,Fn,In,te,xt,Ln,Nn,Dt,Mn,Wn,Hn,oe,jt,Vn,Bn,zt,Rn,Un,Jn,A,ke,Gn,Pe,Xn,At,Kn,Qn,Yn,Ot,Zn,er,Ce,tr,ne,Ee,or,I,nr,qt,rr,ar,St,sr,ir,Ft,dr,cr,lr,re,Te,fr,xe,hr,Ze,mr,ur,pr,ae,De,gr,je,_r,et,br,yr,vr,D,ze,wr,Ae,$r,tt,kr,Pr,Cr,se,Er,It,Tr,xr,Oe,Dr,ie,qe,jr,L,zr,Lt,Ar,Or,ot,qr,Sr,Nt,Fr,Ir,Lr,W,Se,Nr,Fe,Mr,Mt,Wr,Hr,Vr,de,Br,ce,Ie,Rr,R,Ur,Wt,Jr,Gr,nt,Xr,Kr,Qr,le,Le,Yr,Ht,Zr,ea,fe,Ne,ta,Vt,oa,na,he,Me,ra,Bt,aa,sa,me,We,ia,Rt,da,ca,ue,He,la,Ve,fa,Ut,ha,ma,ua,O,Be,pa,Re,ga,Jt,_a,ba,ya,U,va,Gt,wa,$a,Xt,ka,Pa,Ca,Kt,Ea,lo;return k=new zs({}),we=new zs({}),$e=new E({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16448/src/transformers/configuration_utils.py#L53",parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
Store the string that was passed to <a href="/docs/transformers/pr_16448/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">PreTrainedModel.from_pretrained()</a> or
<a href="/docs/transformers/pr_16448/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">TFPreTrainedModel.from_pretrained()</a> as <code>pretrained_model_name_or_path</code> if the configuration was created
...
that can be used as decoder models within the <a href="/docs/transformers/pr_16448/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
Whether the model should return a <a
  href="/docs/transformers/pr_16448/en/main_classes/output#transformers.utils.ModelOutput"
...
Message to commit while pushing. Will default to <code>&quot;add config&quot;</code>.`,name:"commit_message"},{anchor:"transformers.utils.PushToHubMixin.push_to_hub.organization",description:`<strong>organization</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Organization in which you want to push your config (you must be a member of this organization).`,name:"organization"},{anchor:"transformers.utils.PushToHubMixin.push_to_hub.private",description:`<strong>private</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig"
>PretrainedConfig</a></p>
`}}),De=new E({props:{name:"from_json_file",anchor:"transformers.PretrainedConfig.from_json_file",parameters:[{name:"json_file",val:": typing.Union[str, os.PathLike]"}],source:"https://github.com/huggingface/transformers/blob/pr_16448/src/transformers/configuration_utils.py#L695",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_json_file.json_file",description:`<strong>json_file</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
...
<p><a
  href="/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig"
>PretrainedConfig</a></p>
`}}),se=new Ta({props:{$$slots:{default:[Ls]},$$scope:{ctx:J}}}),Oe=new js({props:{code:`# We can't instantiate directly the base class *PretrainedConfig* so let's show the examples on a
...
`}}),Se=new E({props:{name:"register_for_auto_class",anchor:"transformers.PretrainedConfig.register_for_auto_class",parameters:[{name:"auto_class",val:" = 'AutoConfig'"}],source:"https://github.com/huggingface/transformers/blob/pr_16448/src/transformers/configuration_utils.py#L867",parametersDescription:[{anchor:"transformers.PretrainedConfig.register_for_auto_class.auto_class",description:`<strong>auto_class</strong> (<code>str</code> or <code>type</code>, <em>optional</em>, defaults to <code>&quot;AutoConfig&quot;</code>) &#x2014;
The auto class to register this new configuration with.`,name:"auto_class"}]}}),de=new Ta({props:{warning:!0,$$slots:{default:[Ns]},$$scope:{ctx:J}}}),Ie=new E({props:{name:"save_pretrained",anchor:"transformers.PretrainedConfig.save_pretrained",parameters:[{name:"save_directory",val:": typing.Union[str, os.PathLike]"},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16448/src/transformers/configuration_utils.py#L400",parametersDescription:[{anchor:"transformers.PretrainedConfig.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_16448/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}]}}),Le=new E({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16448/src/transformers/configuration_utils.py#L755",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Ne=new E({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16448/src/transformers/configuration_utils.py#L723",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Me=new E({props:{name:"to_json_file",anchor:"transformers.PretrainedConfig.to_json_file",parameters:[{name:"json_file_path",val:": typing.Union[str, os.PathLike]"},{name:"use_diff",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/pr_16448/src/transformers/configuration_utils.py#L793",parametersDescription:[{anchor:"transformers.PretrainedConfig.to_json_file.json_file_path",description:`<strong>json_file_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`),lt=r("code"),Wo=o("vocab_size"),Ho=o("."),io=d(),B=r("h2"),X=r("a"),ft=r("span"),p(we.$$.fragment),Vo=d(),ht=r("span"),Bo=o("PretrainedConfig"),co=d(),l=r("div"),p($e.$$.fragment),Ro=d(),mt=r("p"),Uo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Jo=d(),p(K.$$.fragment),Go=d(),ut=r("p"),Xo=o("Class attributes (overridden by derived classes):"),Ko=d(),S=r("ul"),M=r("li"),pt=r("strong"),Qo=o("model_type"),Yo=o(" ("),gt=r("code"),Zo=o("str"),en=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
...
`),Qe=r("a"),fn=o("EncoderDecoderConfig"),hn=o(" or "),Ye=r("a"),mn=o("~RagConfig"),un=o("."),pn=d(),Q=r("li"),yt=r("strong"),gn=o("keys_to_ignore_at_inference"),_n=o(" ("),vt=r("code"),bn=o("List[str]"),yn=o(`) \u2014 A list of keys to ignore by default when looking at dictionary
...
the library are already mapped with `),Mt=r("code"),Wr=o("AutoConfig"),Hr=o("."),Vr=d(),p(de.$$.fragment),Br=d(),ce=r("div"),p(Ie.$$.fragment),Rr=d(),R=r("p"),Ur=o("Save a configuration object to the directory "),Wt=r("code"),Jr=o("save_directory"),Gr=o(`, so that it can be re-loaded using the
...
serializes to a Python dictionary.`),na=d(),he=r("div"),p(Me.$$.fragment),ra=d(),Bt=r("p"),aa=o("Save this instance to a JSON file."),sa=d(),me=r("div"),p(We.$$.fragment),ia=d(),Rt=r("p"),da=o("Serializes this instance to a JSON string."),ca=d(),ue=r("div"),p(He.$$.fragment),la=d(),Ve=r("p"),fa=o("Updates attributes of this class with attributes from "),Ut=r("code"),ha=o("config_dict"),ma=o("."),ua=d(),O=r("div"),p(Be.$$.fragment),pa=d(),Re=r("p"),ga=o("Updates attributes of this class with attributes from "),Jt=r("code"),_a=o("update_str"),ba=o("."),ya=d(),U=r("p"),va=o("The expected format is ints, floats and strings as is, and for booleans use "),Gt=r("code"),wa=o("true"),$a=o(" or "),Xt=r("code"),ka=o("false"),Pa=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),Ca=d(),Kt=r("p"),Ea=o("The keys to change have to already exist in the config object."),this.h()},l(i){const $=Ss('[data-svelte="svelte-1phssyn"]',document.head);m=a($,"META",{name:!0,content:!0}),$.forEach(t),C=c(i),u=a(i,"H1",{class:!0});var Ue=s(u);w=a(Ue,"A",{id:!0,class:!0,href:!0});var Qt=s(w);j=a(Qt,"SPAN",{});var Yt=s(j);g(k.$$.fragment,Yt),Yt.forEach(t),Qt.forEach(t),P=c(Ue),q=a(Ue,"SPAN",{});var xa=s(q);jo=n(xa,"Configuration"),xa.forEach(t),Ue.forEach(t),ao=c(i),G=a(i,"P",{});var fo=s(G);zo=n(fo,"The base class "),Ge=a(fo,"A",{href:!0});var Da=s(Ge);Ao=n(Da,"PretrainedConfig"),Da.forEach(t),Oo=n(fo,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),lt=a(H,"CODE",{});var Oa=s(lt);Wo=n(Oa,"vocab_size"),Oa.forEach(t),Ho=n(H,"."),H.forEach(t),io=c(i),B=a(i,"H2",{class:!0});var ho=s(B);X=a(ho,"A",{id:!0,class:!0,href:!0});var qa=s(X);ft=a(qa,"SPAN",{});var Sa=s(ft);g(we.$$.fragment,Sa),Sa.forEach(t),qa.forEach(t),Vo=c(ho),ht=a(ho,"SPAN",{});var Fa=s(ht);Bo=n(Fa,"PretrainedConfig"),Fa.forEach(t),ho.forEach(t),co=c(i),l=a(i,"DIV",{class:!0});var f=s(l);g($e.$$.fragment,f),Ro=c(f),mt=a(f,"P",{});var Ia=s(mt);Uo=n(Ia,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Ia.forEach(t),Jo=c(f),g(K.$$.fragment,f),Go=c(f),ut=a(f,"P",{});var La=s(ut);Xo=n(La,"Class attributes (overridden by derived classes):"),La.forEach(t),Ko=c(f),S=a(f,"UL",{});var pe=s(S);M=a(pe,"LI",{});var Je=s(M);pt=a(Je,"STRONG",{});var Na=s(pt);Qo=n(Na,"model_type"),Na.forEach(t),Yo=n(Je," ("),gt=a(Je,"CODE",{});var Ma=s(gt);Zo=n(Ma,"str"),Ma.forEach(t),en=n(Je,`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
...
`),Qe=a(N,"A",{href:!0});var Ra=s(Qe);fn=n(Ra,"EncoderDecoderConfig"),Ra.forEach(t),hn=n(N," or "),Ye=a(N,"A",{href:!0});var Ua=s(Ye);mn=n(Ua,"~RagConfig"),Ua.forEach(t),un=n(N,"."),N.forEach(t),pn=c(pe),Q=a(pe,"LI",{});var Zt=s(Q);yt=a(Zt,"STRONG",{});var Ja=s(yt);gn=n(Ja,"keys_to_ignore_at_inference"),Ja.forEach(t),_n=n(Zt," ("),vt=a(Zt,"CODE",{});var Ga=s(vt);bn=n(Ga,"List[str]"),Ga.forEach(t),yn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
...
naming of attributes.`),eo.forEach(t),pe.forEach(t),Cn=c(f),kt=a(f,"P",{});var Qa=s(kt);En=n(Qa,"Common attributes (present in all subclasses):"),Qa.forEach(t),Tn=c(f),F=a(f,"UL",{});var ge=s(F);Z=a(ge,"LI",{});var to=s(Z);Pt=a(to,"STRONG",{});var Ya=s(Pt);xn=n(Ya,"vocab_size"),Ya.forEach(t),Dn=n(to," ("),Ct=a(to,"CODE",{});var Za=s(Ct);jn=n(Za,"int"),Za.forEach(t),zn=n(to,`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
embeddings matrix (this attribute may be missing for models that don\u2019t have a text modality like ViT).`),to.forEach(t),An=c(ge),ee=a(ge,"LI",{});var oo=s(ee);Et=a(oo,"STRONG",{});var es=s(Et);On=n(es,"hidden_size"),es.forEach(t),qn=n(oo," ("),Tt=a(oo,"CODE",{});var ts=s(Tt);Sn=n(ts,"int"),ts.forEach(t),Fn=n(oo,") \u2014 The hidden size of the model."),oo.forEach(t),In=c(ge),te=a(ge,"LI",{});var no=s(te);xt=a(no,"STRONG",{});var os=s(xt);Ln=n(os,"num_attention_heads"),os.forEach(t),Nn=n(no," ("),Dt=a(no,"CODE",{});var ns=s(Dt);Mn=n(ns,"int"),ns.forEach(t),Wn=n(no,`) \u2014 The number of attention heads used in the multi-head attention layers of the
model.`),no.forEach(t),Hn=c(ge),oe=a(ge,"LI",{});var ro=s(oe);jt=a(ro,"STRONG",{});var rs=s(jt);Vn=n(rs,"num_hidden_layers"),rs.forEach(t),Bn=n(ro," ("),zt=a(ro,"CODE",{});var as=s(zt);Rn=n(as,"int"),as.forEach(t),Un=n(ro,") \u2014 The number of blocks in the model."),ro.forEach(t),ge.forEach(t),Jn=c(f),A=a(f,"DIV",{class:!0});var _e=s(A);g(ke.$$.fragment,_e),Gn=c(_e),Pe=a(_e,"P",{});var mo=s(Pe);Xn=n(mo,`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),At=a(mo,"CODE",{});var ss=s(At);Kn=n(ss,"repo_path_or_name"),ss.forEach(t),Qn=n(mo,"."),mo.forEach(t),Yn=c(_e),Ot=a(_e,"P",{});var is=s(Ot);Zn=n(is,"Examples:"),is.forEach(t),er=c(_e),g(Ce.$$.fragment,_e),_e.forEach(t),tr=c(f),ne=a(f,"DIV",{class:!0});var uo=s(ne);g(Ee.$$.fragment,uo),or=c(uo),I=a(uo,"P",{});var be=s(I);nr=n(be,"Checks whether the passed dictionary and its nested dicts have a "),qt=a(be,"EM",{});var ds=s(qt);rr=n(ds,"torch_dtype"),ds.forEach(t),ar=n(be,` key and if it\u2019s not None,
...
string, which can then be stored in the json format.`),be.forEach(t),uo.forEach(t),lr=c(f),re=a(f,"DIV",{class:!0});var po=s(re);g(Te.$$.fragment,po),fr=c(po),xe=a(po,"P",{});var go=s(xe);hr=n(go,"Instantiates a "),Ze=a(go,"A",{href:!0});var fs=s(Ze);mr=n(fs,"PretrainedConfig"),fs.forEach(t),ur=n(go," from a Python dictionary of parameters."),go.forEach(t),po.forEach(t),pr=c(f),ae=a(f,"DIV",{class:!0});var _o=s(ae);g(De.$$.fragment,_o),gr=c(_o),je=a(_o,"P",{});var bo=s(je);_r=n(bo,"Instantiates a "),et=a(bo,"A",{href:!0});var hs=s(et);br=n(hs,"PretrainedConfig"),hs.forEach(t),yr=n(bo," from the path to a JSON file of parameters."),bo.forEach(t),_o.forEach(t),vr=c(f),D=a(f,"DIV",{class:!0});var V=s(D);g(ze.$$.fragment,V),wr=c(V),Ae=a(V,"P",{});var yo=s(Ae);$r=n(yo,"Instantiate a "),tt=a(yo,"A",{href:!0});var ms=s(tt);kr=n(ms,"PretrainedConfig"),ms.forEach(t),Pr=n(yo," (or a derived class) from a pretrained model configuration."),yo.forEach(t),Cr=c(V),g(se.$$.fragment,V),Er=c(V),It=a(V,"P",{});var us=s(It);Tr=n(us,"Examples:"),us.forEach(t),xr=c(V),g(Oe.$$.fragment,V),V.forEach(t),Dr=c(f),ie=a(f,"DIV",{class:!0});var vo=s(ie);g(qe.$$.fragment,vo),jr=c(vo),L=a(vo,"P",{});var ye=s(L);zr=n(ye,"From a "),Lt=a(ye,"CODE",{});var ps=s(Lt);Ar=n(ps,"pretrained_model_name_or_path"),ps.forEach(t),Or=n(ye,`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=a(ye,"A",{href:!0});var gs=s(ot);qr=n(gs,"PretrainedConfig"),gs.forEach(t),Sr=n(ye," using "),Nt=a(ye,"CODE",{});var _s=s(Nt);Fr=n(_s,"from_dict"),_s.forEach(t),Ir=n(ye,"."),ye.forEach(t),vo.forEach(t),Lr=c(f),W=a(f,"DIV",{class:!0});var rt=s(W);g(Se.$$.fragment,rt),Nr=c(rt),Fe=a(rt,"P",{});var wo=s(Fe);Mr=n(wo,`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Mt=a(wo,"CODE",{});var bs=s(Mt);Wr=n(bs,"AutoConfig"),bs.forEach(t),Hr=n(wo,"."),wo.forEach(t),Vr=c(rt),g(de.$$.fragment,rt),rt.forEach(t),Br=c(f),ce=a(f,"DIV",{class:!0});var $o=s(ce);g(Ie.$$.fragment,$o),Rr=c($o),R=a($o,"P",{});var at=s(R);Ur=n(at,"Save a configuration object to the directory "),Wt=a(at,"CODE",{});var ys=s(Wt);Jr=n(ys,"save_directory"),ys.forEach(t),Gr=n(at,`, so that it can be re-loaded using the
`),nt=a(at,"A",{href:!0});var vs=s(nt);Xr=n(vs,"from_pretrained()"),vs.forEach(t),Kr=n(at," class method."),at.forEach(t),$o.forEach(t),Qr=c(f),le=a(f,"DIV",{class:!0});var ko=s(le);g(Le.$$.fragment,ko),Yr=c(ko),Ht=a(ko,"P",{});var ws=s(Ht);Zr=n(ws,"Serializes this instance to a Python dictionary."),ws.forEach(t),ko.forEach(t),ea=c(f),fe=a(f,"DIV",{class:!0});var Po=s(fe);g(Ne.$$.fragment,Po),ta=c(Po),Vt=a(Po,"P",{});var $s=s(Vt);oa=n($s,`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),$s.forEach(t),Po.forEach(t),na=c(f),he=a(f,"DIV",{class:!0});var Co=s(he);g(Me.$$.fragment,Co),ra=c(Co),Bt=a(Co,"P",{});var ks=s(Bt);aa=n(ks,"Save this instance to a JSON file."),ks.forEach(t),Co.forEach(t),sa=c(f),me=a(f,"DIV",{class:!0});var Eo=s(me);g(We.$$.fragment,Eo),ia=c(Eo),Rt=a(Eo,"P",{});var Ps=s(Rt);da=n(Ps,"Serializes this instance to a JSON string."),Ps.forEach(t),Eo.forEach(t),ca=c(f),ue=a(f,"DIV",{class:!0});var To=s(ue);g(He.$$.fragment,To),la=c(To),Ve=a(To,"P",{});var xo=s(Ve);fa=n(xo,"Updates attributes of this class with attributes from "),Ut=a(xo,"CODE",{});var Cs=s(Ut);ha=n(Cs,"config_dict"),Cs.forEach(t),ma=n(xo,"."),xo.forEach(t),To.forEach(t),ua=c(f),O=a(f,"DIV",{class:!0});var ve=s(O);g(Be.$$.fragment,ve),pa=c(ve),Re=a(ve,"P",{});var Do=s(Re);ga=n(Do,"Updates attributes of this class with attributes from "),Jt=a(Do,"CODE",{});var Es=s(Jt);_a=n(Es,"update_str"),Es.forEach(t),ba=n(Do,"."),Do.forEach(t),ya=c(ve),U=a(ve,"P",{});var st=s(U);va=n(st,"The expected format is ints, floats and strings as is, and for booleans use "),Gt=a(st,"CODE",{});var Ts=s(Gt);wa=n(Ts,"true"),Ts.forEach(t),$a=n(st," or "),Xt=a(st,"CODE",{});var xs=s(Xt);ka=n(xs,"false"),xs.forEach(t),Pa=n(st,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),st.forEach(t),Ca=c(ve),Kt=a(ve,"P",{});var Ds=s(Kt);Ea=n(Ds,"The keys to change have to already exist in the config object."),Ds.forEach(t),ve.forEach(t),f.forEach(t),this.h()},h(){h(m,"name","hf:doc:metadata"),h(m,"content",JSON.stringify(Ws)),h(w,"id","configuration"),h(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(w,"href","#configuration"),h(u,"class","relative group"),h(Ge,"href","/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig"),h(X,"id","transformers.PretrainedConfig"),h(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(X,"href","#transformers.PretrainedConfig"),h(B,"class","relative group"),h(Xe,"href","/docs/transformers/pr_16448/en/model_doc/auto#transformers.AutoConfig"),h(Ke,"href","/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig"),h(Qe,"href","/docs/transformers/pr_16448/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),h(Ye,"href","/docs/transformers/pr_16448/en/model_doc/rag#transformers.RagConfig"),h(A,"class","docstring"),h(ne,"class","docstring"),h(Ze,"href","/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig"),h(re,"class","docstring"),h(et,"href","/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig"),h(ae,"class","docstring"),h(tt,"href","/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig"),h(D,"class","docstring"),h(ot,"href","/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig"),h(ie,"class","docstring"),h(W,"class","docstring"),h(nt,"href","/docs/transformers/pr_16448/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),h(ce,"class","docstring"),h(le,"class","docstring"),h(fe,"class","docstring"),h(he,"class","docstring"),h(me,"class","docstring"),h(ue,"class","docstring"),h(O,"class","docstring"),h(l,"class","docstring")},m(i,$){e(document.head,m),z(i,C,$),z(i,u,$),e(u,w),e(w,j),_(k,j,null),e(u,P),e(u,q),e(q,jo),z(i,ao,$),z(i,G,$),e(G,zo),e(G,Ge),e(Ge,Ao),e(G,Oo),z(i,so,$),z(i,T,$),e(T,qo),e(T,it),e(it,So),e(T,Fo),e(T,dt),e(dt,Io),e(T,Lo),e(T,ct),e(ct,No),e(T,Mo),e(T,lt),e(lt,Wo),e(T,Ho),z(i,io,$),z(i,B,$),e(B,X),e(X,ft),_(we,ft,null),e(B,Vo),e(B,ht),e(ht,Bo),z(i,co,$),z(i,l,$),_($e,l,null),e(l,Ro),e(l,mt),e(mt,Uo),e(l,Jo),_(K,l,null),e(l,Go),e(l,ut),e(ut,Xo),e(l,Ko),e(l,S),e(S,M),e(M,pt),e(pt,Qo),e(M,Yo),e(M,gt),e(gt,Zo),e(M,en),e(M,Xe),e(Xe,tn),e(M,on),e(S,nn),e(S,x),e(x,_t),e(_t,rn),e(x,an),e(x,bt),e(bt,sn),e(x,dn),e(x,Ke),e(Ke,cn),e(x,ln),e(x,Qe),e(Qe,fn),e(x,hn),e(x,Ye),e(Ye,mn),e(x,un),e(S,pn),e(S,Q),e(Q,yt),e(yt,gn),e(Q,_n),e(Q,vt),e(vt,bn),e(Q,yn),e(S,vn),e(S,Y),e(Y,wt),e(wt,wn),e(Y,$n),e(Y,$t),e($t,kn),e(Y,Pn),e(l,Cn),e(l,kt),e(kt,En),e(l,Tn),e(l,F),e(F,Z),e(Z,Pt),e(Pt,xn),e(Z,Dn),e(Z,Ct),e(Ct,jn),e(Z,zn),e(F,An),e(F,ee),e(ee,Et),e(Et,On),e(ee,qn),e(ee,Tt),e(Tt,Sn),e(ee,Fn),e(F,In),e(F,te),e(te,xt),e(xt,Ln),e(te,Nn),e(te,Dt),e(Dt,Mn),e(te,Wn),e(F,Hn),e(F,oe),e(oe,jt),e(jt,Vn),e(oe,Bn),e(oe,zt),e(zt,Rn),e(oe,Un),e(l,Jn),e(l,A),_(ke,A,null),e(A,Gn),e(A,Pe),e(Pe,Xn),e(Pe,At),e(At,Kn),e(Pe,Qn),e(A,Yn),e(A,Ot),e(Ot,Zn),e(A,er),_(Ce,A,null),e(l,tr),e(l,ne),_(Ee,ne,null),e(ne,or),e(ne,I),e(I,nr),e(I,qt),e(qt,rr),e(I,ar),e(I,St),e(St,sr),e(I,ir),e(I,Ft),e(Ft,dr),e(I,cr),e(l,lr),e(l,re),_(Te,re,null),e(re,fr),e(re,xe),e(xe,hr),e(xe,Ze),e(Ze,mr),e(xe,ur),e(l,pr),e(l,ae),_(De,ae,null),e(ae,gr),e(ae,je),e(je,_r),e(je,et),e(et,br),e(je,yr),e(l,vr),e(l,D),_(ze,D,null),e(D,wr),e(D,Ae),e(Ae,$r),e(Ae,tt),e(tt,kr),e(Ae,Pr),e(D,Cr),_(se,D,null),e(D,Er),e(D,It),e(It,Tr),e(D,xr),_(Oe,D,null),e(l,Dr),e(l,ie),_(qe,ie,null),e(ie,jr),e(ie,L),e(L,zr),e(L,Lt),e(Lt,Ar),e(L,Or),e(L,ot),e(ot,qr),e(L,Sr),e(L,Nt),e(Nt,Fr),e(L,Ir),e(l,Lr),e(l,W),_(Se,W,null),e(W,Nr),e(W,Fe),e(Fe,Mr),e(Fe,Mt),e(Mt,Wr),e(Fe,Hr),e(W,Vr),_(de,W,null),e(l,Br),e(l,ce),_(Ie,ce,null),e(ce,Rr),e(ce,R),e(R,Ur),e(R,Wt),e(Wt,Jr),e(R,Gr),e(R,nt),e(nt,Xr),e(R,Kr),e(l,Qr),e(l,le),_(Le,le,null),e(le,Yr),e(le,Ht),e(Ht,Zr),e(l,ea),e(l,fe),_(Ne,fe,null),e(fe,ta),e(fe,Vt),e(Vt,oa),e(l,na),e(l,he),_(Me,he,null),e(he,ra),e(he,Bt),e(Bt,aa),e(l,sa),e(l,me),_(We,me,null),e(me,ia),e(me,Rt),e(Rt,da),e(l,ca),e(l,ue),_(He,ue,null),e(ue,la),e(ue,Ve),e(Ve,fa),e(Ve,Ut),e(Ut,ha),e(Ve,ma),e(l,ua),e(l,O),_(Be,O,null),e(O,pa),e(O,Re),e(Re,ga),e(Re,Jt),e(Jt,_a),e(Re,ba),e(O,ya),e(O,U),e(U,va),e(U,Gt),e(Gt,wa),e(U,$a),e(U,Xt),e(Xt,ka),e(U,Pa),e(O,Ca),e(O,Kt),e(Kt,Ea),lo=!0},p(i,[$]){const Ue={};$&2&&(Ue.$$scope={dirty:$,ctx:i}),K.$set(Ue);const Qt={};$&2&&(Qt.$$scope={dirty:$,ctx:i}),se.$set(Qt);const Yt={};$&2&&(Yt.$$scope={dirty:$,ctx:i}),de.$set(Yt)},i(i){lo||(b(k.$$.fragment,i),b(we.$$.fragment,i),b($e.$$.fragment,i),b(K.$$.fragment,i),b(ke.$$.fragment,i),b(Ce.$$.fragment,i),b(Ee.$$.fragment,i),b(Te.$$.fragment,i),b(De.$$.fragment,i),b(ze.$$.fragment,i),b(se.$$.fragment,i),b(Oe.$$.fragment,i),b(qe.$$.fragment,i),b(Se.$$.fragment,i),b(de.$$.fragment,i),b(Ie.$$.fragment,i),b(Le.$$.fragment,i),b(Ne.$$.fragment,i),b(Me.$$.fragment,i),b(We.$$.fragment,i),b(He.$$.fragment,i),b(Be.$$.fragment,i),lo=!0)},o(i){y(k.$$.fragment,i),y(we.$$.fragment,i),y($e.$$.fragment,i),y(K.$$.fragment,i),y(ke.$$.fragment,i),y(Ce.$$.fragment,i),y(Ee.$$.fragment,i),y(Te.$$.fragment,i),y(De.$$.fragment,i),y(ze.$$.fragment,i),y(se.$$.fragment,i),y(Oe.$$.fragment,i),y(qe.$$.fragment,i),y(Se.$$.fragment,i),y(de.$$.fragment,i),y(Ie.$$.fragment,i),y(Le.$$.fragment,i),y(Ne.$$.fragment,i),y(Me.$$.fragment,i),y(We.$$.fragment,i),y(He.$$.fragment,i),y(Be.$$.fragment,i),lo=!1},d(i){t(m),i&&t(C),i&&t(u),v(k),i&&t(ao),i&&t(G),i&&t(so),i&&t(T),i&&t(io),i&&t(B),v(we),i&&t(co),i&&t(l),v($e),v(K),v(ke),v(Ce),v(Ee),v(Te),v(De),v(ze),v(se),v(Oe),v(qe),v(Se),v(de),v(Ie),v(Le),v(Ne),v(Me),v(We),v(He),v(Be)}}}const Ws={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Hs(J){return Fs(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gs extends As{constructor(m){super();Os(this,m,Hs,Ms,qs,{})}}export{Gs as default,Ws as metadata};
