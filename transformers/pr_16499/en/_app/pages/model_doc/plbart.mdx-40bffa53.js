...
the latter silently ignores them.`)},l(T){u=s(T,"P",{});var y=a(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(y,"CODE",{});var C=a(v);L=i(C,"Module"),C.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){u=s(T,"P",{});var y=a(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(y,"CODE",{});var C=a(v);L=i(C,"Module"),C.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,B),e(u,v),e(v,L),e(u,z)},d(T){T&&o(u)}}}function sl(me){let u,B,v,L,z,T,y,C,ts,sn,I,io,os,ns,Ce,ss,as,je,rs,is,an,Y,fe,lo,Ee,ds,co,ls,rn,G,cs,Me,ps,hs,po,us,ms,dn,Mt,fs,ln,St,ho,gs,cn,R,_s,Se,bs,ks,Ae,vs,Ts,pn,Z,ge,uo,Ne,ys,mo,ws,hn,j,Ps,fo,Ls,qs,go,zs,Bs,_o,$s,xs,bo,Fs,Cs,un,_e,js,Oe,Es,Ms,mn,W,Ss,Ie,ko,As,Ns,Os,At,Is,Ds,fn,Nt,vo,Xs,gn,De,_n,Ot,Xe,To,Gs,Rs,ee,Ws,yo,Hs,Us,wo,Vs,Js,bn,Ge,kn,te,be,Po,Re,Ks,Lo,Qs,vn,x,We,Ys,oe,Zs,It,ea,ta,He,oa,na,sa,ne,aa,Dt,ra,ia,Xt,da,la,ca,qo,pa,ha,Ue,Tn,se,ke,zo,Ve,ua,Bo,ma,yn,P,Je,fa,$o,ga,_a,D,ba,Gt,ka,va,Rt,Ta,ya,Ke,wa,Pa,La,Qe,qa,xo,za,Ba,$a,Fo,xa,Fa,Ye,Ca,ve,Ze,ja,Co,Ea,Ma,N,et,Sa,tt,Aa,jo,Na,Oa,Ia,ot,nt,Eo,Da,Xa,Mo,Ga,Ra,st,So,Wa,Ha,Ao,Ua,Va,No,Ja,wn,ae,Te,Oo,at,Ka,Io,Qa,Pn,S,rt,Ya,it,Za,Wt,er,tr,or,dt,nr,lt,sr,ar,rr,E,ct,ir,re,dr,Ht,lr,cr,Do,pr,hr,ur,ye,mr,Xo,fr,gr,pt,Ln,ie,we,Go,ht,_r,Ro,br,qn,A,ut,kr,mt,vr,Ut,Tr,yr,wr,ft,Pr,gt,Lr,qr,zr,M,_t,Br,de,$r,Vt,xr,Fr,Wo,Cr,jr,Er,Pe,Mr,Ho,Sr,Ar,bt,zn,le,Le,Uo,kt,Nr,Vo,Or,Bn,F,vt,Ir,Jo,Dr,Xr,Tt,Gr,Jt,Rr,Wr,Hr,yt,Ur,wt,Vr,Jr,Kr,w,Pt,Qr,ce,Yr,Kt,Zr,ei,Ko,ti,oi,ni,qe,si,Qo,ai,ri,Lt,ii,qt,di,Yo,li,ci,zt,pi,Bt,$n,pe,ze,Zo,$t,hi,en,ui,xn,he,xt,mi,H,Ft,fi,tn,gi,_i,Ct,Fn;return T=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new X({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16499/en/model_doc/plbart#transformers.PLBartConfig"
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),B=l(),v=n("h1"),L=n("a"),z=n("span"),m(T.$$.fragment),y=l(),C=n("span"),ts=r("PLBart"),sn=l(),I=n("p"),io=n("strong"),os=r("DISCLAIMER:"),ns=r(" If you see something strange, file a "),Ce=n("a"),ss=r("Github Issue"),as=r(` and assign
...
inside the context manager `),At=n("a"),Is=r("as_target_tokenizer()"),Ds=r(" to encode target text format."),fn=l(),Nt=n("ul"),vo=n("li"),Xs=r("Supervised training"),gn=l(),m(De.$$.fragment),_n=l(),Ot=n("ul"),Xe=n("li"),To=n("p"),Gs=r("Generation"),Rs=l(),ee=n("p"),Ws=r("While generating the target text set the "),yo=n("code"),Hs=r("decoder_start_token_id"),Us=r(` to the target language id. The following
...
documentation from `),Xt=n("a"),da=r("PretrainedConfig"),la=r(" for more information."),ca=l(),qo=n("p"),pa=r("Example:"),ha=l(),m(Ue.$$.fragment),Tn=l(),se=n("h2"),ke=n("a"),zo=n("span"),m(Ve.$$.fragment),ua=l(),Bo=n("span"),ma=r("PLBartTokenizer"),yn=l(),P=n("div"),m(Je.$$.fragment),fa=l(),$o=n("p"),ga=r("Construct an PLBART tokenizer."),_a=l(),D=n("p"),ba=r("Adapted from "),Gt=n("a"),ka=r("RobertaTokenizer"),va=r(" and "),Rt=n("a"),Ta=r("XLNetTokenizer"),ya=r(`. Based on
...
separator.`),wn=l(),ae=n("h2"),Te=n("a"),Oo=n("span"),m(at.$$.fragment),Ka=l(),Io=n("span"),Qa=r("PLBartModel"),Pn=l(),S=n("div"),m(rt.$$.fragment),Ya=l(),it=n("p"),Za=r(`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
separator.`),kd.forEach(o),$e.forEach(o),$.forEach(o),wn=c(t),ae=s(t,"H2",{class:!0});var Rn=a(ae);Te=s(Rn,"A",{id:!0,class:!0,href:!0});var vd=a(Te);Oo=s(vd,"SPAN",{});var Td=a(Oo);f(at.$$.fragment,Td),Td.forEach(o),vd.forEach(o),Ka=c(Rn),Io=s(Rn,"SPAN",{});var yd=a(Io);Qa=i(yd,"PLBartModel"),yd.forEach(o),Rn.forEach(o),Pn=c(t),S=s(t,"DIV",{class:!0});var xe=a(S);f(rt.$$.fragment,xe),Ya=c(xe),it=s(xe,"P",{});var Wn=a(it);Za=i(Wn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
This model inherits from `),Ut=s(Vn,"A",{href:!0});var Fd=a(Ut);Tr=i(Fd,"PreTrainedModel"),Fd.forEach(o),yr=i(Vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
classification.`),Od.forEach(o),Xr=c(Q),Tt=s(Q,"P",{});var Qn=a(Tt);Gr=i(Qn,"This model inherits from "),Jt=s(Qn,"A",{href:!0});var Id=a(Jt);Rr=i(Id,"PreTrainedModel"),Id.forEach(o),Wr=i(Qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
