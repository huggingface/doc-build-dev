import{S as Uy,i as By,s as Ry,e as o,k as d,w as $,t as s,M as Gy,c as n,d as t,m as p,a as r,x as E,h as a,b as h,N as Vy,F as e,g as u,y as F,q as A,o as z,B as x,v as Ky,L as rn}from"../../chunks/vendor-6b77c823.js";import{T as Ms}from"../../chunks/Tip-39098574.js";import{D as He}from"../../chunks/Docstring-abef54e3.js";import{C as Ve}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Bt}from"../../chunks/IconCopyLink-7a11ce68.js";import{F as Cc,M as ln}from"../../chunks/Markdown-4489c441.js";function Yy(U){let l,_,c,f,v,b,T,k,y,D,q,H,G,V,B,K,re,I,O;return T=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
`),ie=o("code"),be=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){l=n(g,"P",{});var P=r(l);_=a(P,"TF 2.0 models accepts two formats as inputs:"),P.forEach(t),c=p(g),f=n(g,"UL",{});var ve=r(f);v=n(ve,"LI",{});var ze=r(v);b=a(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),T=p(ve),k=n(ve,"LI",{});var we=r(k);y=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),ve.forEach(t),D=p(g),q=n(g,"P",{});var le=r(q);H=a(le,"This second option is useful when using "),G=n(le,"CODE",{});var xe=r(G);V=a(xe,"tf.keras.Model.fit"),xe.forEach(t),B=a(le,` method which currently requires having all the
...
`),ie=n(Ae,"CODE",{});var Oe=r(ie);be=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(g,P){u(g,l,P),e(l,_),u(g,c,P),u(g,f,P),e(f,v),e(v,b),e(f,T),e(f,k),e(k,y),u(g,D,P),u(g,q,P),e(q,H),e(q,G),e(G,V),e(q,B),e(q,K),e(K,re),e(q,I),u(g,O,P),u(g,w,P),e(w,M),u(g,R,P),u(g,C,P),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,oe),e(N,se),e(se,S),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,be)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(q),g&&t(O),g&&t(w),g&&t(R),g&&t(C)}}}function _k(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){l=n(b,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var k=r(c);f=a(k,"Module"),k.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Z.forEach(t),R=p(g),C=n(g,"UL",{});var de=r(C);N=n(de,"LI",{});var pe=r(N);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),L=p(de),W=n(de,"LI",{});var Te=r(W);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n(Te,"CODE",{});var Ne=r(Q);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ye=r(ue);_e=a(ye,"model([input_ids, attention_mask, token_type_ids])"),ye.forEach(t),Te.forEach(t),me=p(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);be=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(g,P){u(g,l,P),e(l,_),u(g,c,P),u(g,f,P),e(f,v),e(v,b),e(f,T),e(f,k),e(k,y),u(g,D,P),u(g,q,P),e(q,H),e(q,G),e(G,V),e(q,B),e(q,K),e(K,re),e(q,I),u(g,O,P),u(g,w,P),e(w,M),u(g,R,P),u(g,C,P),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,oe),e(N,se),e(se,S),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,be)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(q),g&&t(O),g&&t(w),g&&t(R),g&&t(C)}}}function vk(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){l=n(b,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var k=r(c);f=a(k,"Module"),k.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Z.forEach(t),R=p(g),C=n(g,"UL",{});var de=r(C);N=n(de,"LI",{});var pe=r(N);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),L=p(de),W=n(de,"LI",{});var Te=r(W);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n(Te,"CODE",{});var Ne=r(Q);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ye=r(ue);_e=a(ye,"model([input_ids, attention_mask, token_type_ids])"),ye.forEach(t),Te.forEach(t),me=p(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);be=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(g,P){u(g,l,P),e(l,_),u(g,c,P),u(g,f,P),e(f,v),e(v,b),e(f,T),e(f,k),e(k,y),u(g,D,P),u(g,q,P),e(q,H),e(q,G),e(G,V),e(q,B),e(q,K),e(K,re),e(q,I),u(g,O,P),u(g,w,P),e(w,M),u(g,R,P),u(g,C,P),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,oe),e(N,se),e(se,S),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,be)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(q),g&&t(O),g&&t(w),g&&t(R),g&&t(C)}}}function wk(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){l=n(b,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var k=r(c);f=a(k,"Module"),k.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(b){l=n(b,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var k=r(c);f=a(k,"Module"),k.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(b,T){u(b,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(b){b&&t(l)}}}function qk(U){let l,_,c,f,v,b,T,k,y,D,q,H,G,V,B,K,re,I,O,w,M,R,C,N,ee,te,ce,oe,se,S,L,W,X,Q,Y,ge,ue,_e,me,ne,qe,ie,be,g,P,ve,ze,we,le,xe,Me,Z,de,pe,De,je,Te,Ne,ye,Ae,Oe,Ze,Ss,Ps,ut,mt,pa,ft,gt,Ds,tt,Ns,Os,Ke,Se,Ls,wt,ke,yt,kt,Qs,qt,jt,Is,$t,vs,Rt,Et,bs,Ye,$e,Ws,Ft,ae,ot,Gt,Hs,At,os,Us,zt,xt,Bs,Ct,ns,Rs,Mt,rs,Gs,St,Vs,Le,Pt,is,Ks,Dt,ls,Ys,ds,Ue,ps,Ee,cs,nt,Js,Nt,Ot,Xs,Zs,Be,ea,hs,us,et,Lt,j,J,xa,ta,Ca,ca,Qt,st,sa,rt,Ma,aa,Sa,ha,Ie,ms,ws,Re,Pa,ua,ys,oa,fs,ma,fe,Da,ks,Na,Oa,fa,_t,na,gs,La,Fe,Qa,ra,Ia,Wa,Ha,he,Ua,ia,Ba,Ra,ga,qs,Ga,_a,Ce,la,It,da,Ki,Mc,Sc,Yi,Ji,Pc,Dc,Xi,Zi,Nc,Oc,Va,Ka,el,Lc,Qc,tl,Ic,Wc,sl,Hc,Uc,Ya,al,Bc,Rc,ol,Gc,Vc,nl,Kc,Yc,Ja,rl,Jc,Xc,il,Zc,eh,ll,th,sp,qo,ap,jo,sh,dn,ah,oh,op,$o,nh,pn,rh,ih,np,Hr,dl,lh,rp,Eo,dh,cn,ph,ch,ip,We,Ur,pl,hh,uh,mh,Br,cl,fh,gh,_h,Rr,hl,Th,vh,bh,Gr,ul,wh,yh,kh,Vr,ml,qh,jh,$h,Kr,fl,Eh,Fh,Ah,Yr,gl,zh,xh,Ch,Jr,_l,Mh,Sh,Ph,Xr,Tl,Dh,Nh,lp,Tt,Oh,hn,Lh,Qh,un,Ih,Wh,vl,Hh,Uh,bl,Bh,Rh,wl,Gh,Vh,dp,Zr,yl,Kh,pp,Fo,cp,Pe,Yh,kl,Jh,Xh,ql,Zh,eu,jl,tu,su,$l,au,ou,El,nu,ru,Fl,iu,lu,ei,du,pu,mn,cu,hu,fn,uu,mu,hp,ti,fu,up,Ao,mp,Xa,zo,Al,gn,gu,zl,_u,fp,xo,gp,vt,Tu,xl,vu,bu,Cl,wu,yu,Ml,ku,qu,_n,ju,$u,Tn,Eu,Fu,_p,Za,Co,Sl,vn,Au,Pl,zu,Tp,eo,bn,xu,wn,Cu,si,Mu,Su,vp,to,Mo,Dl,yn,Pu,Nl,Du,bp,Wt,kn,Nu,_s,Ou,ai,Lu,Qu,Ol,Iu,Wu,Ll,Hu,Uu,oi,Bu,Ru,Gu,qn,Vu,jn,Ku,Yu,Ju,Ql,Xu,Zu,$n,wp,so,So,Il,En,em,Wl,tm,yp,Ge,Fn,sm,Hl,am,om,Qe,nm,ni,rm,im,ri,lm,dm,Ul,pm,cm,Bl,hm,um,Rl,mm,fm,Gl,gm,_m,Vl,Tm,vm,Kl,bm,wm,Yl,ym,km,qm,it,Jl,jm,$m,Xl,Em,Fm,Zl,Am,zm,ed,xm,Cm,td,Mm,Sm,sd,Pm,Dm,ad,Nm,Om,ii,li,Lm,Qm,Im,Po,An,Wm,od,Hm,Um,Ta,zn,Bm,xn,Rm,di,Gm,Vm,Km,Cn,Ym,Mn,Jm,Xm,Zm,pi,Sn,kp,ao,Do,nd,Pn,ef,rd,tf,qp,lt,Dn,sf,Nn,af,ci,of,nf,rf,On,lf,Ln,df,pf,cf,Qn,hf,hi,uf,mf,ff,In,gf,Wn,_f,Tf,vf,Vt,Hn,bf,oo,wf,ui,yf,kf,id,qf,jf,$f,No,Ef,ld,Ff,Af,Un,jp,no,Oo,dd,Bn,zf,pd,xf,$p,Ts,Rn,Cf,ro,Mf,cd,Sf,Pf,mi,Df,Nf,Of,Gn,Lf,Vn,Qf,If,Wf,Kt,Kn,Hf,io,Uf,fi,Bf,Rf,hd,Gf,Vf,Kf,Lo,Yf,ud,Jf,Xf,Yn,Ep,lo,Qo,md,Jn,Zf,fd,eg,Fp,Ht,Xn,tg,gd,sg,ag,Zn,og,gi,ng,rg,ig,er,lg,tr,dg,pg,cg,Yt,sr,hg,po,ug,_i,mg,fg,_d,gg,_g,Tg,Io,vg,Td,bg,wg,ar,Ap,co,Wo,vd,or,yg,bd,kg,zp,Ut,nr,qg,ho,jg,wd,$g,Eg,yd,Fg,Ag,zg,rr,xg,Ti,Cg,Mg,Sg,ir,Pg,lr,Dg,Ng,Og,Jt,dr,Lg,uo,Qg,vi,Ig,Wg,kd,Hg,Ug,Bg,Ho,Rg,qd,Gg,Vg,pr,xp,mo,Uo,jd,cr,Kg,$d,Yg,Cp,dt,hr,Jg,Ed,Xg,Zg,ur,e_,bi,t_,s_,a_,mr,o_,fr,n_,r_,i_,Bo,l_,Xt,gr,d_,fo,p_,wi,c_,h_,Fd,u_,m_,f_,Ro,g_,Ad,__,T_,_r,Mp,go,Go,zd,Tr,v_,xd,b_,Sp,pt,vr,w_,br,y_,Cd,k_,q_,j_,wr,$_,yi,E_,F_,A_,yr,z_,kr,x_,C_,M_,Vo,S_,Zt,qr,P_,_o,D_,ki,N_,O_,Md,L_,Q_,I_,Ko,W_,Sd,H_,U_,jr,Pp,To,Yo,Pd,$r,B_,Dd,R_,Dp,ct,Er,G_,Nd,V_,K_,Fr,Y_,qi,J_,X_,Z_,Ar,eT,zr,tT,sT,aT,Jo,oT,es,xr,nT,vo,rT,ji,iT,lT,Od,dT,pT,cT,Xo,hT,Ld,uT,mT,Cr,Np,bo,Zo,Qd,Mr,fT,Id,gT,Op,ht,Sr,_T,wo,TT,Wd,vT,bT,Hd,wT,yT,kT,Pr,qT,$i,jT,$T,ET,Dr,FT,Nr,AT,zT,xT,en,CT,ts,Or,MT,yo,ST,Ei,PT,DT,Ud,NT,OT,LT,tn,QT,Bd,IT,WT,Lr,Lp;return b=new Bt({}),V=new Bt({}),rt=new Bt({}),qo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Zy],pytorch:[Jy]},$$scope:{ctx:U}}}),Fo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ak],pytorch:[tk]},$$scope:{ctx:U}}}),Ao=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ik],pytorch:[nk]},$$scope:{ctx:U}}}),gn=new Bt({}),xo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ck],pytorch:[dk]},$$scope:{ctx:U}}}),vn=new Bt({}),bn=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16499/src/transformers/models/tapas/modeling_tapas.py#L106",parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
<a href="/docs/transformers/pr_16499/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16499/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16499/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jo=new Ms({props:{$$slots:{default:[bk]},$$scope:{ctx:U}}}),xr=new He({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16499/src/transformers/models/tapas/modeling_tf_tapas.py#L1585",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16499/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16499/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16499/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
implementation. Original implementation available at `),jn=o("a"),Ku=s("https://github.com/google-research/tapas/tree/master"),Yu=s("."),Ju=d(),Ql=o("p"),Xu=s("Example:"),Zu=d(),$($n.$$.fragment),wp=d(),so=o("h2"),So=o("a"),Il=o("span"),$(En.$$.fragment),em=d(),Wl=o("span"),tm=s("TapasTokenizer"),yp=d(),Ge=o("div"),$(Fn.$$.fragment),sm=d(),Hl=o("p"),am=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
`),Mn=o("a"),Jm=s("here"),Xm=s("."),Zm=d(),pi=o("div"),$(Sn.$$.fragment),kp=d(),ao=o("h2"),Do=o("a"),nd=o("span"),$(Pn.$$.fragment),ef=d(),rd=o("span"),tf=s("TapasModel"),qp=d(),lt=o("div"),$(Dn.$$.fragment),sf=d(),Nn=o("p"),af=s(`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
implementation. Original implementation available at `),jn=n(tc,"A",{href:!0,rel:!0});var Yb=r(jn);Ku=a(Yb,"https://github.com/google-research/tapas/tree/master"),Yb.forEach(t),Yu=a(tc,"."),tc.forEach(t),Ju=p(va),Ql=n(va,"P",{});var Jb=r(Ql);Xu=a(Jb,"Example:"),Jb.forEach(t),Zu=p(va),E($n.$$.fragment,va),va.forEach(t),wp=p(i),so=n(i,"H2",{class:!0});var sc=r(so);So=n(sc,"A",{id:!0,class:!0,href:!0});var Xb=r(So);Il=n(Xb,"SPAN",{});var Zb=r(Il);E(En.$$.fragment,Zb),Zb.forEach(t),Xb.forEach(t),em=p(sc),Wl=n(sc,"SPAN",{});var ew=r(Wl);tm=a(ew,"TapasTokenizer"),ew.forEach(t),sc.forEach(t),yp=p(i),Ge=n(i,"DIV",{class:!0});var bt=r(Ge);E(Fn.$$.fragment,bt),sm=p(bt),Hl=n(bt,"P",{});var tw=r(Hl);am=a(tw,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),fw.forEach(t),Sm=p(as),sd=n(as,"LI",{});var gw=r(sd);Pm=a(gw,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hc.forEach(t),Wf=p(nn),Kt=n(nn,"DIV",{class:!0});var ya=r(Kt);E(Kn.$$.fragment,ya),Hf=p(ya),io=n(ya,"P",{});var Qi=r(io);Uf=a(Qi,"The "),fi=n(Qi,"A",{href:!0});var Lw=r(fi);Bf=a(Lw,"TapasForMaskedLM"),Lw.forEach(t),Rf=a(Qi," forward method, overrides the "),hd=n(Qi,"CODE",{});var Qw=r(hd);Gf=a(Qw,"__call__"),Qw.forEach(t),Vf=a(Qi," special method."),Qi.forEach(t),Kf=p(ya),E(Lo.$$.fragment,ya),Yf=p(ya),ud=n(ya,"P",{});var Iw=r(ud);Jf=a(Iw,"Examples:"),Iw.forEach(t),Xf=p(ya),E(Yn.$$.fragment,ya),ya.forEach(t),nn.forEach(t),Ep=p(i),lo=n(i,"H2",{class:!0});var uc=r(lo);Qo=n(uc,"A",{id:!0,class:!0,href:!0});var Ww=r(Qo);md=n(Ww,"SPAN",{});var Hw=r(md);E(Jn.$$.fragment,Hw),Hw.forEach(t),Ww.forEach(t),Zf=p(uc),fd=n(uc,"SPAN",{});var Uw=r(fd);eg=a(Uw,"TapasForSequenceClassification"),Uw.forEach(t),uc.forEach(t),Fp=p(i),Ht=n(i,"DIV",{class:!0});var ka=r(Ht);E(Xn.$$.fragment,ka),tg=p(ka),gd=n(ka,"P",{});var Bw=r(gd);sg=a(Bw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Bw.forEach(t),ag=p(ka),Zn=n(ka,"P",{});var mc=r(Zn);og=a(mc,"This model inherits from "),gi=n(mc,"A",{href:!0});var Rw=r(gi);ng=a(Rw,"PreTrainedModel"),Rw.forEach(t),rg=a(mc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mc.forEach(t),ig=p(ka),er=n(ka,"P",{});var fc=r(er);lg=a(fc,"This model is also a PyTorch "),tr=n(fc,"A",{href:!0,rel:!0});var Gw=r(tr);dg=a(Gw,"torch.nn.Module"),Gw.forEach(t),pg=a(fc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jc.forEach(t),M_=p(zs),E(Vo.$$.fragment,zs),S_=p(zs),Zt=n(zs,"DIV",{class:!0});var Fa=r(Zt);E(qr.$$.fragment,Fa),P_=p(Fa),_o=n(Fa,"P",{});var Bi=r(_o);D_=a(Bi,"The "),ki=n(Bi,"A",{href:!0});var yy=r(ki);N_=a(yy,"TFTapasForMaskedLM"),yy.forEach(t),O_=a(Bi," forward method, overrides the "),Md=n(Bi,"CODE",{});var ky=r(Md);L_=a(ky,"__call__"),ky.forEach(t),Q_=a(Bi," special method."),Bi.forEach(t),I_=p(Fa),E(Ko.$$.fragment,Fa),W_=p(Fa),Sd=n(Fa,"P",{});var qy=r(Sd);H_=a(qy,"Examples:"),qy.forEach(t),U_=p(Fa),E(jr.$$.fragment,Fa),Fa.forEach(t),zs.forEach(t),Pp=p(i),To=n(i,"H2",{class:!0});var $c=r(To);Yo=n($c,"A",{id:!0,class:!0,href:!0});var jy=r(Yo);Pd=n(jy,"SPAN",{});var $y=r(Pd);E($r.$$.fragment,$y),$y.forEach(t),jy.forEach(t),B_=p($c),Dd=n($c,"SPAN",{});var Ey=r(Dd);R_=a(Ey,"TFTapasForSequenceClassification"),Ey.forEach(t),$c.forEach(t),Dp=p(i),ct=n(i,"DIV",{class:!0});var xs=r(ct);E(Er.$$.fragment,xs),G_=p(xs),Nd=n(xs,"P",{});var Fy=r(Nd);V_=a(Fy,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fc.forEach(t),aT=p(xs),E(Jo.$$.fragment,xs),oT=p(xs),es=n(xs,"DIV",{class:!0});var Aa=r(es);E(xr.$$.fragment,Aa),nT=p(Aa),vo=n(Aa,"P",{});var Ri=r(vo);rT=a(Ri,"The "),ji=n(Ri,"A",{href:!0});var xy=r(ji);iT=a(xy,"TFTapasForSequenceClassification"),xy.forEach(t),lT=a(Ri," forward method, overrides the "),Od=n(Ri,"CODE",{});var Cy=r(Od);dT=a(Cy,"__call__"),Cy.forEach(t),pT=a(Ri," special method."),Ri.forEach(t),cT=p(Aa),E(Xo.$$.fragment,Aa),hT=p(Aa),Ld=n(Aa,"P",{});var My=r(Ld);uT=a(My,"Examples:"),My.forEach(t),mT=p(Aa),E(Cr.$$.fragment,Aa),Aa.forEach(t),xs.forEach(t),Np=p(i),bo=n(i,"H2",{class:!0});var Ac=r(bo);Zo=n(Ac,"A",{id:!0,class:!0,href:!0});var Sy=r(Zo);Qd=n(Sy,"SPAN",{});var Py=r(Qd);E(Mr.$$.fragment,Py),Py.forEach(t),Sy.forEach(t),fT=p(Ac),Id=n(Ac,"SPAN",{});var Dy=r(Id);gT=a(Dy,"TFTapasForQuestionAnswering"),Dy.forEach(t),Ac.forEach(t),Op=p(i),ht=n(i,"DIV",{class:!0});var Cs=r(ht);E(Sr.$$.fragment,Cs),_T=p(Cs),wo=n(Cs,"P",{});var Gi=r(wo);TT=a(Gi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Wd=n(Gi,"CODE",{});var Ny=r(Wd);vT=a(Ny,"logits"),Ny.forEach(t),bT=a(Gi," and optional "),Hd=n(Gi,"CODE",{});var Oy=r(Hd);wT=a(Oy,"logits_aggregation"),Oy.forEach(t),yT=a(Gi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Gi.forEach(t),kT=p(Cs),Pr=n(Cs,"P",{});var zc=r(Pr);qT=a(zc,"This model inherits from "),$i=n(zc,"A",{href:!0});var Ly=r($i);jT=a(Ly,"TFPreTrainedModel"),Ly.forEach(t),$T=a(zc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
