...
`),qe=n("code"),_e=a('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(k){p=s(k,"P",{});var j=r(p);L=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(o),I=d(k),C=s(k,"UL",{});var to=r(C);b=s(to,"LI",{});var Qs=r(b);y=i(Qs,"having all inputs as keyword arguments (like PyTorch models), or"),Qs.forEach(o),f=d(to),w=s(to,"LI",{});var Yo=r(w);Ho=i(Yo,"having all inputs as a list, tuple or dict in the first positional arguments."),Yo.forEach(o),to.forEach(o),at=d(k),z=s(k,"P",{});var E=r(z);ue=i(E,"This second option is useful when using "),ye=s(E,"CODE",{});var Ys=r(ye);Ce=i(Ys,"tf.keras.Model.fit"),Ys.forEach(o),Ko=i(E,` method which currently requires having all the
...
`),qe=s(Oe,"CODE",{});var rr=r(qe);_e=i(rr,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),rr.forEach(o),Oe.forEach(o),De.forEach(o)},m(k,j){m(k,p,j),e(p,L),m(k,I,j),m(k,C,j),e(C,b),e(b,y),e(C,f),e(C,w),e(w,Ho),m(k,at,j),m(k,z,j),e(z,ue),e(z,ye),e(ye,Ce),e(z,Ko),e(z,be),e(be,Go),e(z,Xt),m(k,pe,j),m(k,ze,j),e(ze,Le),m(k,Zt,j),m(k,H,j),e(H,he),e(he,je),e(he,it),e(it,Qt),e(he,Fe),e(he,we),e(we,Jo),e(H,Yt),e(H,O),e(O,ge),e(O,$e),e($e,ke),e(O,Xo),e(O,xe),e(xe,Zo),e(H,eo),e(H,me),e(me,Qo),e(me,qe),e(qe,_e)},d(k){k&&o(p),k&&o(I),k&&o(C),k&&o(at),k&&o(z),k&&o(pe),k&&o(ze),k&&o(Zt),k&&o(H)}}}function gP(x){let p,L,I,C,b;return{c(){p=n("p"),L=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=r(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=r(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=r(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=r(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){m(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function bP(x){let p,L,I,C,b,y,f,w,Ho,at,z,ue,ye,Ce,Ko,be,Go,Xt,pe,ze,Le,Zt,H,he,je,it,Qt,Fe,we,Jo,Yt,O,ge,$e,ke,Xo,xe,Zo,eo,me,Qo,qe,_e,k,j,to,Qs,Yo,E,Ys,lt,er,De,ve,tr,or,Pe,nr,sr,Oe,rr,xd,ar,Ed,Md,ir,zd,jd,nl,en,sl,Ae,Fd,tn,qd,Dd,on,Od,Ad,rl,dt,oo,pa,nn,Nd,ha,Vd,al,fe,sn,Sd,no,lr,Wd,Bd,dr,Ud,Rd,Hd,ct,Kd,cr,Gd,Jd,pr,Xd,Zd,Qd,so,rn,Yd,an,ec,hr,tc,oc,il,pt,ro,ma,ln,nc,fa,sc,ll,V,dn,rc,ht,ac,mr,ic,lc,cn,dc,cc,pc,mt,hc,fr,mc,fc,ur,uc,gc,_c,ua,vc,Pc,pn,dl,ft,ao,ga,hn,Tc,_a,Ic,cl,S,mn,yc,ut,Cc,gr,bc,Lc,fn,wc,$c,kc,gt,xc,_r,Ec,Mc,vr,zc,jc,Fc,va,qc,Dc,un,pl,_t,io,Pa,gn,Oc,Ta,Ac,hl,F,_n,Nc,Ia,Vc,Sc,vn,Wc,Pr,Bc,Uc,Rc,Te,Pn,Hc,ya,Kc,Gc,Ca,Tr,Jc,ba,Xc,Zc,La,Qc,Yc,lo,Tn,ep,In,tp,wa,op,np,sp,co,yn,rp,$a,ap,ip,Ir,Cn,ml,vt,po,ka,bn,lp,xa,dp,fl,W,Ln,cp,wn,pp,Ea,hp,mp,fp,$n,up,yr,gp,_p,vp,Ie,kn,Pp,Ma,Tp,Ip,za,Cr,yp,ja,Cp,bp,Fa,Lp,wp,ho,xn,$p,qa,kp,ul,Pt,mo,Da,En,xp,Oa,Ep,gl,B,Mn,Mp,Aa,zp,jp,zn,Fp,br,qp,Dp,Op,fo,jn,Ap,Fn,Np,Na,Vp,Sp,Wp,uo,qn,Bp,Tt,Up,Va,Rp,Hp,Sa,Kp,Gp,_l,It,go,Wa,Dn,Jp,Ba,Xp,vl,U,On,Zp,Ua,Qp,Yp,K,Lr,eh,th,wr,oh,nh,$r,sh,rh,Ra,ah,ih,kr,lh,dh,ch,_o,An,ph,Nn,hh,xr,mh,fh,uh,vo,Vn,gh,Sn,_h,Er,vh,Ph,Pl,yt,Po,Ha,Wn,Th,Ka,Ih,Tl,R,Bn,yh,Un,Ch,Rn,bh,Lh,wh,G,Hn,$h,Ct,kh,Mr,xh,Eh,Ga,Mh,zh,jh,To,Fh,Ja,qh,Dh,Kn,Oh,J,Gn,Ah,bt,Nh,zr,Vh,Sh,Xa,Wh,Bh,Uh,Io,Rh,Za,Hh,Kh,Jn,Gh,X,Xn,Jh,Lt,Xh,jr,Zh,Qh,Qa,Yh,em,tm,yo,om,Ya,nm,sm,Zn,Il,wt,Co,ei,Qn,rm,ti,am,yl,$t,Yn,im,Z,es,lm,kt,dm,Fr,cm,pm,oi,hm,mm,fm,bo,um,ni,gm,_m,ts,Cl,xt,Lo,si,os,vm,ri,Pm,bl,Et,ns,Tm,Q,ss,Im,Mt,ym,qr,Cm,bm,ai,Lm,wm,$m,wo,km,ii,xm,Em,rs,Ll,zt,$o,li,as,Mm,di,zm,wl,q,is,jm,ls,Fm,Dr,qm,Dm,Om,ds,Am,cs,Nm,Vm,Sm,ko,Wm,Y,ps,Bm,jt,Um,Or,Rm,Hm,ci,Km,Gm,Jm,xo,Xm,pi,Zm,Qm,hs,Ym,ee,ms,ef,Ft,tf,Ar,of,nf,hi,sf,rf,af,Eo,lf,mi,df,cf,fs,pf,te,us,hf,qt,mf,Nr,ff,uf,fi,gf,_f,vf,Mo,Pf,ui,Tf,If,gs,$l,Dt,zo,gi,_s,yf,_i,Cf,kl,Ot,vs,bf,oe,Ps,Lf,At,wf,Vr,$f,kf,vi,xf,Ef,Mf,jo,zf,Pi,jf,Ff,Ts,xl,Nt,Fo,Ti,Is,qf,Ii,Df,El,Vt,ys,Of,ne,Cs,Af,St,Nf,Sr,Vf,Sf,yi,Wf,Bf,Uf,qo,Rf,Ci,Hf,Kf,bs,Ml,Wt,Do,bi,Ls,Gf,Li,Jf,zl,M,ws,Xf,$s,Zf,Wr,Qf,Yf,eu,ks,tu,xs,ou,nu,su,wi,ru,au,Ee,$i,Es,iu,lu,ki,Ms,du,cu,xi,zs,pu,hu,Ei,js,mu,fu,se,Fs,uu,Bt,gu,Mi,_u,vu,zi,Pu,Tu,Iu,Oo,yu,ji,Cu,bu,qs,Lu,Ne,Ds,wu,Fi,$u,ku,Os,xu,Ve,As,Eu,qi,Mu,zu,Ns,jl,Ut,Ao,Di,Vs,ju,Oi,Fu,Fl,Rt,Ss,qu,re,Ws,Du,Ht,Ou,Ai,Au,Nu,Ni,Vu,Su,Wu,No,Bu,Vi,Uu,Ru,Bs,ql,Kt,Vo,Si,Us,Hu,Wi,Ku,Dl,Gt,Rs,Gu,ae,Hs,Ju,Jt,Xu,Bi,Zu,Qu,Ui,Yu,eg,tg,So,og,Ri,ng,sg,Ks,Ol;return y=new D({}),Ce=new D({}),ke=new D({}),en=new A({props:{code:`from PIL import Image
import requests
...
special tokens using the tokenizer `),wa=n("code"),op=a("prepare_for_model"),np=a(" method."),sp=l(),co=n("div"),u(yn.$$.fragment),rp=l(),$a=n("p"),ap=a(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),ip=l(),Ir=n("div"),u(Cn.$$.fragment),ml=l(),vt=n("h2"),po=n("a"),ka=n("span"),u(bn.$$.fragment),lp=l(),xa=n("span"),dp=a("CLIPTokenizerFast"),fl=l(),W=n("div"),u(Ln.$$.fragment),cp=l(),wn=n("p"),pp=a("Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Ea=n("em"),hp=a("tokenizers"),mp=a(` library). Based on byte-level
...
behavior.`),wh=l(),G=n("div"),u(Hn.$$.fragment),$h=l(),Ct=n("p"),kh=a("The "),Mr=n("a"),xh=a("CLIPModel"),Eh=a(" forward method, overrides the "),Ga=n("code"),Mh=a("__call__"),zh=a(" special method."),jh=l(),u(To.$$.fragment),Fh=l(),Ja=n("p"),qh=a("Examples:"),Dh=l(),u(Kn.$$.fragment),Oh=l(),J=n("div"),u(Gn.$$.fragment),Ah=l(),bt=n("p"),Nh=a("The "),zr=n("a"),Vh=a("CLIPModel"),Sh=a(" forward method, overrides the "),Xa=n("code"),Wh=a("__call__"),Bh=a(" special method."),Uh=l(),u(Io.$$.fragment),Rh=l(),Za=n("p"),Hh=a("Examples:"),Kh=l(),u(Jn.$$.fragment),Gh=l(),X=n("div"),u(Xn.$$.fragment),Jh=l(),Lt=n("p"),Xh=a("The "),jr=n("a"),Zh=a("CLIPModel"),Qh=a(" forward method, overrides the "),Qa=n("code"),Yh=a("__call__"),em=a(" special method."),tm=l(),u(yo.$$.fragment),om=l(),Ya=n("p"),nm=a("Examples:"),sm=l(),u(Zn.$$.fragment),Il=l(),wt=n("h2"),Co=n("a"),ei=n("span"),u(Qn.$$.fragment),rm=l(),ti=n("span"),am=a("CLIPTextModel"),yl=l(),$t=n("div"),u(Yn.$$.fragment),im=l(),Z=n("div"),u(es.$$.fragment),lm=l(),kt=n("p"),dm=a("The "),Fr=n("a"),cm=a("CLIPTextModel"),pm=a(" forward method, overrides the "),oi=n("code"),hm=a("__call__"),mm=a(" special method."),fm=l(),u(bo.$$.fragment),um=l(),ni=n("p"),gm=a("Examples:"),_m=l(),u(ts.$$.fragment),Cl=l(),xt=n("h2"),Lo=n("a"),si=n("span"),u(os.$$.fragment),vm=l(),ri=n("span"),Pm=a("CLIPVisionModel"),bl=l(),Et=n("div"),u(ns.$$.fragment),Tm=l(),Q=n("div"),u(ss.$$.fragment),Im=l(),Mt=n("p"),ym=a("The "),qr=n("a"),Cm=a("CLIPVisionModel"),bm=a(" forward method, overrides the "),ai=n("code"),Lm=a("__call__"),wm=a(" special method."),$m=l(),u(wo.$$.fragment),km=l(),ii=n("p"),xm=a("Examples:"),Em=l(),u(rs.$$.fragment),Ll=l(),zt=n("h2"),$o=n("a"),li=n("span"),u(as.$$.fragment),Mm=l(),di=n("span"),zm=a("TFCLIPModel"),wl=l(),q=n("div"),u(is.$$.fragment),jm=l(),ls=n("p"),Fm=a("This model inherits from "),Dr=n("a"),qm=a("TFPreTrainedModel"),Dm=a(`. Check the superclass documentation for the generic methods the
