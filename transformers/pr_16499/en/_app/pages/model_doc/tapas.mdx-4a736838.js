...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),_=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),c=o("a"),f=s("TapasTokenizer"),v=s(" to convert table-question pairs into "),w=o("code"),T=s("input_ids"),k=s(", "),y=o("code"),D=s("attention_mask"),q=s(", "),H=o("code"),G=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),B=o("a"),K=s("TFTapasForQuestionAnswering"),re=s(` requires different
inputs to be fine-tuned:`),I=d(),O=o("table"),b=o("thead"),M=o("tr"),R=o("th"),C=o("strong"),N=s("Task"),ee=d(),te=o("th"),ce=o("strong"),oe=s("Required inputs"),se=d(),S=o("tbody"),L=o("tr"),W=o("td"),X=s("Conversational"),Q=d(),Y=o("td"),ge=o("code"),ue=s("input_ids"),_e=s(", "),me=o("code"),ne=s("attention_mask"),qe=s(", "),ie=o("code"),we=s("token_type_ids"),g=s(", "),P=o("code"),ve=s("labels"),ze=d(),be=o("tr"),le=o("td"),xe=s("Weak supervision for aggregation"),Me=d(),Z=o("td"),de=o("code"),pe=s("input_ids"),De=s(", "),je=o("code"),Te=s("attention_mask"),Ne=s(", "),ye=o("code"),Ae=s("token_type_ids"),Oe=s(", "),Ze=o("code"),Ss=s("labels"),Ps=s(", "),ut=o("code"),mt=s("numeric_values"),pa=s(", "),ft=o("code"),gt=s("numeric_values_scale"),Ds=s(", "),tt=o("code"),Ns=s("float_answer"),Os=d(),Ke=o("tr"),Se=o("td"),Ls=s("Strong supervision for aggregation"),bt=d(),ke=o("td"),yt=o("code"),kt=s("input ids"),Qs=s(", "),qt=o("code"),jt=s("attention mask"),Is=s(", "),$t=o("code"),vs=s("token type ids"),Rt=s(", "),Et=o("code"),ws=s("labels"),Ye=s(", "),$e=o("code"),Ws=s("aggregation_labels"),Ft=d(),ae=o("p"),ot=o("a"),Gt=s("TapasTokenizer"),Hs=s(" creates the "),At=o("code"),os=s("labels"),Us=s(", "),zt=o("code"),xt=s("numeric_values"),Bs=s(" and "),Ct=o("code"),ns=s("numeric_values_scale"),Rs=s(" based on the "),Mt=o("code"),rs=s("answer_coordinates"),Gs=s(" and "),St=o("code"),Vs=s("answer_text"),Le=s(" columns of the TSV file. The "),Pt=o("code"),is=s("float_answer"),Ks=s(" and "),Dt=o("code"),ls=s("aggregation_labels"),Ys=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ds=d(),$(Ue.$$.fragment),ps=d(),Ee=o("p"),cs=s("Note that "),nt=o("a"),Js=s("TapasTokenizer"),Nt=s(" expects the data of the table to be "),Ot=o("strong"),Xs=s("text-only"),Zs=s(". You can use "),Be=o("code"),ea=s(".astype(str)"),hs=s(` on a dataframe to turn it into text-only data.
...
<span class="hljs-meta">... </span>        optimizer.step()`}}),{c(){l=o("p"),_=s("You can then fine-tune "),c=o("a"),f=s("TapasForQuestionAnswering"),v=s(" as follows (shown here for the weak supervision for aggregation case):"),w=d(),$(T.$$.fragment),this.h()},l(y){l=n(y,"P",{});var D=r(l);_=a(D,"You can then fine-tune "),c=n(D,"A",{href:!0});var q=r(c);f=a(q,"TapasForQuestionAnswering"),q.forEach(t),v=a(D," as follows (shown here for the weak supervision for aggregation case):"),D.forEach(t),w=p(y),E(T.$$.fragment,y),this.h()},h(){h(c,"href","/docs/transformers/pr_16499/en/model_doc/tapas#transformers.TapasForQuestionAnswering")},m(y,D){u(y,l,D),e(l,_),e(l,c),e(c,f),e(l,v),u(y,w,D),F(T,y,D),k=!0},p:rn,i(y){k||(A(T.$$.fragment,y),k=!0)},o(y){z(T.$$.fragment,y),k=!1},d(y){y&&t(l),y&&t(w),x(T,y)}}}function nk(U){let l,_;return l=new ln({props:{$$slots:{default:[ok]},$$scope:{ctx:U}}}),{c(){$(l.$$.fragment)},l(c){E(l.$$.fragment,c)},m(c,f){F(l,c,f),_=!0},p(c,f){const v={};f&2&&(v.$$scope={dirty:f,ctx:c}),l.$set(v)},i(c){_||(A(l.$$.fragment,c),_=!0)},o(c){z(l.$$.fragment,c),_=!1},d(c){x(l,c)}}}function rk(U){let l,_,c,f,v,w,T,k;return T=new Ve({props:{code:`import tensorflow as tf
...
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var k=r(c);f=a(k,"Module"),k.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function yk(U){let l,_,c,f,v,w,T,k,y,D,q,H,G,V,B,K,re,I,O,b,M,R,C,N,ee,te,ce,oe,se,S,L,W,X,Q,Y,ge,ue,_e,me,ne,qe,ie,we;return{c(){l=o("p"),_=s("TF 2.0 models accepts two formats as inputs:"),c=d(),f=o("ul"),v=o("li"),w=s("having all inputs as keyword arguments (like PyTorch models), or"),T=d(),k=o("li"),y=s("having all inputs as a list, tuple or dict in the first positional arguments."),D=d(),q=o("p"),H=s("This second option is useful when using "),G=o("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),I=s("."),O=d(),b=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=d(),C=o("ul"),N=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),S=s("model(inputs_ids)"),L=d(),W=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=d(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),we=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){l=n(g,"P",{});var P=r(l);_=a(P,"TF 2.0 models accepts two formats as inputs:"),P.forEach(t),c=p(g),f=n(g,"UL",{});var ve=r(f);v=n(ve,"LI",{});var ze=r(v);w=a(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),T=p(ve),k=n(ve,"LI",{});var be=r(k);y=a(be,"having all inputs as a list, tuple or dict in the first positional arguments."),be.forEach(t),ve.forEach(t),D=p(g),q=n(g,"P",{});var le=r(q);H=a(le,"This second option is useful when using "),G=n(le,"CODE",{});var xe=r(G);V=a(xe,"tf.keras.Model.fit"),xe.forEach(t),B=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),R=p(g),C=n(g,"UL",{});var de=r(C);N=n(de,"LI",{});var pe=r(N);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),L=p(de),W=n(de,"LI",{});var Te=r(W);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n(Te,"CODE",{});var Ne=r(Q);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ye=r(ue);_e=a(ye,"model([input_ids, attention_mask, token_type_ids])"),ye.forEach(t),Te.forEach(t),me=p(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);we=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(g,P){u(g,l,P),e(l,_),u(g,c,P),u(g,f,P),e(f,v),e(v,w),e(f,T),e(f,k),e(k,y),u(g,D,P),u(g,q,P),e(q,H),e(q,G),e(G,V),e(q,B),e(q,K),e(K,re),e(q,I),u(g,O,P),u(g,b,P),e(b,M),u(g,R,P),u(g,C,P),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,oe),e(N,se),e(se,S),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,we)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(q),g&&t(O),g&&t(b),g&&t(R),g&&t(C)}}}function kk(U){let l,_,c,f,v;return{c(){l=o("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){l=n(w,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n(T,"CODE",{});var k=r(c);f=a(k,"Module"),k.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(w){w&&t(l)}}}function qk(U){let l,_,c,f,v,w,T,k,y,D,q,H,G,V,B,K,re,I,O,b,M,R,C,N,ee,te,ce,oe,se,S,L,W,X,Q,Y,ge,ue,_e,me,ne,qe,ie,we,g,P,ve,ze,be,le,xe,Me,Z,de,pe,De,je,Te,Ne,ye,Ae,Oe,Ze,Ss,Ps,ut,mt,pa,ft,gt,Ds,tt,Ns,Os,Ke,Se,Ls,bt,ke,yt,kt,Qs,qt,jt,Is,$t,vs,Rt,Et,ws,Ye,$e,Ws,Ft,ae,ot,Gt,Hs,At,os,Us,zt,xt,Bs,Ct,ns,Rs,Mt,rs,Gs,St,Vs,Le,Pt,is,Ks,Dt,ls,Ys,ds,Ue,ps,Ee,cs,nt,Js,Nt,Ot,Xs,Zs,Be,ea,hs,us,et,Lt,j,J,xa,ta,Ca,ca,Qt,st,sa,rt,Ma,aa,Sa,ha,Ie,ms,bs,Re,Pa,ua,ys,oa,fs,ma,fe,Da,ks,Na,Oa,fa,_t,na,gs,La,Fe,Qa,ra,Ia,Wa,Ha,he,Ua,ia,Ba,Ra,ga,qs,Ga,_a,Ce,la,It,da,Ki,Mc,Sc,Yi,Ji,Pc,Dc,Xi,Zi,Nc,Oc,Va,Ka,el,Lc,Qc,tl,Ic,Wc,sl,Hc,Uc,Ya,al,Bc,Rc,ol,Gc,Vc,nl,Kc,Yc,Ja,rl,Jc,Xc,il,Zc,eh,ll,th,sp,qo,ap,jo,sh,dn,ah,oh,op,$o,nh,pn,rh,ih,np,Hr,dl,lh,rp,Eo,dh,cn,ph,ch,ip,We,Ur,pl,hh,uh,mh,Br,cl,fh,gh,_h,Rr,hl,Th,vh,wh,Gr,ul,bh,yh,kh,Vr,ml,qh,jh,$h,Kr,fl,Eh,Fh,Ah,Yr,gl,zh,xh,Ch,Jr,_l,Mh,Sh,Ph,Xr,Tl,Dh,Nh,lp,Tt,Oh,hn,Lh,Qh,un,Ih,Wh,vl,Hh,Uh,wl,Bh,Rh,bl,Gh,Vh,dp,Zr,yl,Kh,pp,Fo,cp,Pe,Yh,kl,Jh,Xh,ql,Zh,eu,jl,tu,su,$l,au,ou,El,nu,ru,Fl,iu,lu,ei,du,pu,mn,cu,hu,fn,uu,mu,hp,ti,fu,up,Ao,mp,Xa,zo,Al,gn,gu,zl,_u,fp,xo,gp,vt,Tu,xl,vu,wu,Cl,bu,yu,Ml,ku,qu,_n,ju,$u,Tn,Eu,Fu,_p,Za,Co,Sl,vn,Au,Pl,zu,Tp,eo,wn,xu,bn,Cu,si,Mu,Su,vp,to,Mo,Dl,yn,Pu,Nl,Du,wp,Wt,kn,Nu,_s,Ou,ai,Lu,Qu,Ol,Iu,Wu,Ll,Hu,Uu,oi,Bu,Ru,Gu,qn,Vu,jn,Ku,Yu,Ju,Ql,Xu,Zu,$n,bp,so,So,Il,En,em,Wl,tm,yp,Ge,Fn,sm,Hl,am,om,Qe,nm,ni,rm,im,ri,lm,dm,Ul,pm,cm,Bl,hm,um,Rl,mm,fm,Gl,gm,_m,Vl,Tm,vm,Kl,wm,bm,Yl,ym,km,qm,it,Jl,jm,$m,Xl,Em,Fm,Zl,Am,zm,ed,xm,Cm,td,Mm,Sm,sd,Pm,Dm,ad,Nm,Om,ii,li,Lm,Qm,Im,Po,An,Wm,od,Hm,Um,Ta,zn,Bm,xn,Rm,di,Gm,Vm,Km,Cn,Ym,Mn,Jm,Xm,Zm,pi,Sn,kp,ao,Do,nd,Pn,ef,rd,tf,qp,lt,Dn,sf,Nn,af,ci,of,nf,rf,On,lf,Ln,df,pf,cf,Qn,hf,hi,uf,mf,ff,In,gf,Wn,_f,Tf,vf,Vt,Hn,wf,oo,bf,ui,yf,kf,id,qf,jf,$f,No,Ef,ld,Ff,Af,Un,jp,no,Oo,dd,Bn,zf,pd,xf,$p,Ts,Rn,Cf,ro,Mf,cd,Sf,Pf,mi,Df,Nf,Of,Gn,Lf,Vn,Qf,If,Wf,Kt,Kn,Hf,io,Uf,fi,Bf,Rf,hd,Gf,Vf,Kf,Lo,Yf,ud,Jf,Xf,Yn,Ep,lo,Qo,md,Jn,Zf,fd,eg,Fp,Ht,Xn,tg,gd,sg,ag,Zn,og,gi,ng,rg,ig,er,lg,tr,dg,pg,cg,Yt,sr,hg,po,ug,_i,mg,fg,_d,gg,_g,Tg,Io,vg,Td,wg,bg,ar,Ap,co,Wo,vd,or,yg,wd,kg,zp,Ut,nr,qg,ho,jg,bd,$g,Eg,yd,Fg,Ag,zg,rr,xg,Ti,Cg,Mg,Sg,ir,Pg,lr,Dg,Ng,Og,Jt,dr,Lg,uo,Qg,vi,Ig,Wg,kd,Hg,Ug,Bg,Ho,Rg,qd,Gg,Vg,pr,xp,mo,Uo,jd,cr,Kg,$d,Yg,Cp,dt,hr,Jg,Ed,Xg,Zg,ur,e_,wi,t_,s_,a_,mr,o_,fr,n_,r_,i_,Bo,l_,Xt,gr,d_,fo,p_,bi,c_,h_,Fd,u_,m_,f_,Ro,g_,Ad,__,T_,_r,Mp,go,Go,zd,Tr,v_,xd,w_,Sp,pt,vr,b_,wr,y_,Cd,k_,q_,j_,br,$_,yi,E_,F_,A_,yr,z_,kr,x_,C_,M_,Vo,S_,Zt,qr,P_,_o,D_,ki,N_,O_,Md,L_,Q_,I_,Ko,W_,Sd,H_,U_,jr,Pp,To,Yo,Pd,$r,B_,Dd,R_,Dp,ct,Er,G_,Nd,V_,K_,Fr,Y_,qi,J_,X_,Z_,Ar,eT,zr,tT,sT,aT,Jo,oT,es,xr,nT,vo,rT,ji,iT,lT,Od,dT,pT,cT,Xo,hT,Ld,uT,mT,Cr,Np,wo,Zo,Qd,Mr,fT,Id,gT,Op,ht,Sr,_T,bo,TT,Wd,vT,wT,Hd,bT,yT,kT,Pr,qT,$i,jT,$T,ET,Dr,FT,Nr,AT,zT,xT,en,CT,ts,Or,MT,yo,ST,Ei,PT,DT,Ud,NT,OT,LT,tn,QT,Bd,IT,WT,Lr,Lp;return w=new Bt({}),V=new Bt({}),rt=new Bt({}),qo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Zy],pytorch:[Jy]},$$scope:{ctx:U}}}),Fo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ak],pytorch:[tk]},$$scope:{ctx:U}}}),Ao=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ik],pytorch:[nk]},$$scope:{ctx:U}}}),gn=new Bt({}),xo=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ck],pytorch:[dk]},$$scope:{ctx:U}}}),vn=new Bt({}),wn=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16499/src/transformers/models/tapas/modeling_tapas.py#L106",parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16499/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jo=new Ms({props:{$$slots:{default:[wk]},$$scope:{ctx:U}}}),xr=new He({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16499/src/transformers/models/tapas/modeling_tf_tapas.py#L1585",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16499/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/pr_16499/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16499/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
implementation. Original implementation available at `),jn=o("a"),Ku=s("https://github.com/google-research/tapas/tree/master"),Yu=s("."),Ju=d(),Ql=o("p"),Xu=s("Example:"),Zu=d(),$($n.$$.fragment),bp=d(),so=o("h2"),So=o("a"),Il=o("span"),$(En.$$.fragment),em=d(),Wl=o("span"),tm=s("TapasTokenizer"),yp=d(),Ge=o("div"),$(Fn.$$.fragment),sm=d(),Hl=o("p"),am=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cg=d(),Yt=o("div"),$(sr.$$.fragment),hg=d(),po=o("p"),ug=s("The "),_i=o("a"),mg=s("TapasForSequenceClassification"),fg=s(" forward method, overrides the "),_d=o("code"),gg=s("__call__"),_g=s(" special method."),Tg=d(),$(Io.$$.fragment),vg=d(),Td=o("p"),wg=s("Examples:"),bg=d(),$(ar.$$.fragment),Ap=d(),co=o("h2"),Wo=o("a"),vd=o("span"),$(or.$$.fragment),yg=d(),wd=o("span"),kg=s("TapasForQuestionAnswering"),zp=d(),Ut=o("div"),$(nr.$$.fragment),qg=d(),ho=o("p"),jg=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),bd=o("code"),$g=s("logits"),Eg=s(" and optional "),yd=o("code"),Fg=s("logits_aggregation"),Ag=s(`), e.g. for
...
(linear layers on top of the hidden-states output to compute `),Wd=o("code"),vT=s("logits"),wT=s(" and optional "),Hd=o("code"),bT=s("logits_aggregation"),yT=s(`), e.g. for
...
`),Mn=n(nc,"A",{href:!0,rel:!0});var bb=r(Mn);Jm=a(bb,"here"),bb.forEach(t),Xm=a(nc,"."),nc.forEach(t),Ni.forEach(t),Zm=p(wt),pi=n(wt,"DIV",{class:!0});var yb=r(pi);E(Sn.$$.fragment,yb),yb.forEach(t),wt.forEach(t),kp=p(i),ao=n(i,"H2",{class:!0});var rc=r(ao);Do=n(rc,"A",{id:!0,class:!0,href:!0});var kb=r(Do);nd=n(kb,"SPAN",{});var qb=r(nd);E(Pn.$$.fragment,qb),qb.forEach(t),kb.forEach(t),ef=p(rc),rd=n(rc,"SPAN",{});var jb=r(rd);tf=a(jb,"TapasModel"),jb.forEach(t),rc.forEach(t),qp=p(i),lt=n(i,"DIV",{class:!0});var Fs=r(lt);E(Dn.$$.fragment,Fs),sf=p(Fs),Nn=n(Fs,"P",{});var ic=r(Nn);af=a(ic,`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hc.forEach(t),Wf=p(nn),Kt=n(nn,"DIV",{class:!0});var ya=r(Kt);E(Kn.$$.fragment,ya),Hf=p(ya),io=n(ya,"P",{});var Qi=r(io);Uf=a(Qi,"The "),fi=n(Qi,"A",{href:!0});var Lb=r(fi);Bf=a(Lb,"TapasForMaskedLM"),Lb.forEach(t),Rf=a(Qi," forward method, overrides the "),hd=n(Qi,"CODE",{});var Qb=r(hd);Gf=a(Qb,"__call__"),Qb.forEach(t),Vf=a(Qi," special method."),Qi.forEach(t),Kf=p(ya),E(Lo.$$.fragment,ya),Yf=p(ya),ud=n(ya,"P",{});var Ib=r(ud);Jf=a(Ib,"Examples:"),Ib.forEach(t),Xf=p(ya),E(Yn.$$.fragment,ya),ya.forEach(t),nn.forEach(t),Ep=p(i),lo=n(i,"H2",{class:!0});var uc=r(lo);Qo=n(uc,"A",{id:!0,class:!0,href:!0});var Wb=r(Qo);md=n(Wb,"SPAN",{});var Hb=r(md);E(Jn.$$.fragment,Hb),Hb.forEach(t),Wb.forEach(t),Zf=p(uc),fd=n(uc,"SPAN",{});var Ub=r(fd);eg=a(Ub,"TapasForSequenceClassification"),Ub.forEach(t),uc.forEach(t),Fp=p(i),Ht=n(i,"DIV",{class:!0});var ka=r(Ht);E(Xn.$$.fragment,ka),tg=p(ka),gd=n(ka,"P",{});var Bb=r(gd);sg=a(Bb,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Bb.forEach(t),ag=p(ka),Zn=n(ka,"P",{});var mc=r(Zn);og=a(mc,"This model inherits from "),gi=n(mc,"A",{href:!0});var Rb=r(gi);ng=a(Rb,"PreTrainedModel"),Rb.forEach(t),rg=a(mc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mc.forEach(t),ig=p(ka),er=n(ka,"P",{});var fc=r(er);lg=a(fc,"This model is also a PyTorch "),tr=n(fc,"A",{href:!0,rel:!0});var Gb=r(tr);dg=a(Gb,"torch.nn.Module"),Gb.forEach(t),pg=a(fc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fc.forEach(t),cg=p(ka),Yt=n(ka,"DIV",{class:!0});var qa=r(Yt);E(sr.$$.fragment,qa),hg=p(qa),po=n(qa,"P",{});var Ii=r(po);ug=a(Ii,"The "),_i=n(Ii,"A",{href:!0});var Vb=r(_i);mg=a(Vb,"TapasForSequenceClassification"),Vb.forEach(t),fg=a(Ii," forward method, overrides the "),_d=n(Ii,"CODE",{});var Kb=r(_d);gg=a(Kb,"__call__"),Kb.forEach(t),_g=a(Ii," special method."),Ii.forEach(t),Tg=p(qa),E(Io.$$.fragment,qa),vg=p(qa),Td=n(qa,"P",{});var Yb=r(Td);wg=a(Yb,"Examples:"),Yb.forEach(t),bg=p(qa),E(ar.$$.fragment,qa),qa.forEach(t),ka.forEach(t),Ap=p(i),co=n(i,"H2",{class:!0});var gc=r(co);Wo=n(gc,"A",{id:!0,class:!0,href:!0});var Jb=r(Wo);vd=n(Jb,"SPAN",{});var Xb=r(vd);E(or.$$.fragment,Xb),Xb.forEach(t),Jb.forEach(t),yg=p(gc),wd=n(gc,"SPAN",{});var Zb=r(wd);kg=a(Zb,"TapasForQuestionAnswering"),Zb.forEach(t),gc.forEach(t),zp=p(i),Ut=n(i,"DIV",{class:!0});var ja=r(Ut);E(nr.$$.fragment,ja),qg=p(ja),ho=n(ja,"P",{});var Wi=r(ho);jg=a(Wi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),bd=n(Wi,"CODE",{});var ey=r(bd);$g=a(ey,"logits"),ey.forEach(t),Eg=a(Wi," and optional "),yd=n(Wi,"CODE",{});var ty=r(yd);Fg=a(ty,"logits_aggregation"),ty.forEach(t),Ag=a(Wi,`), e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc.forEach(t),Og=p(ja),Jt=n(ja,"DIV",{class:!0});var $a=r(Jt);E(dr.$$.fragment,$a),Lg=p($a),uo=n($a,"P",{});var Hi=r(uo);Qg=a(Hi,"The "),vi=n(Hi,"A",{href:!0});var oy=r(vi);Ig=a(oy,"TapasForQuestionAnswering"),oy.forEach(t),Wg=a(Hi," forward method, overrides the "),kd=n(Hi,"CODE",{});var ny=r(kd);Hg=a(ny,"__call__"),ny.forEach(t),Ug=a(Hi," special method."),Hi.forEach(t),Bg=p($a),E(Ho.$$.fragment,$a),Rg=p($a),qd=n($a,"P",{});var ry=r(qd);Gg=a(ry,"Examples:"),ry.forEach(t),Vg=p($a),E(pr.$$.fragment,$a),$a.forEach(t),ja.forEach(t),xp=p(i),mo=n(i,"H2",{class:!0});var vc=r(mo);Uo=n(vc,"A",{id:!0,class:!0,href:!0});var iy=r(Uo);jd=n(iy,"SPAN",{});var ly=r(jd);E(cr.$$.fragment,ly),ly.forEach(t),iy.forEach(t),Kg=p(vc),$d=n(vc,"SPAN",{});var dy=r($d);Yg=a(dy,"TFTapasModel"),dy.forEach(t),vc.forEach(t),Cp=p(i),dt=n(i,"DIV",{class:!0});var As=r(dt);E(hr.$$.fragment,As),Jg=p(As),Ed=n(As,"P",{});var py=r(Ed);Xg=a(py,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),py.forEach(t),Zg=p(As),ur=n(As,"P",{});var wc=r(ur);e_=a(wc,"This model inherits from "),wi=n(wc,"A",{href:!0});var cy=r(wi);t_=a(cy,"TFPreTrainedModel"),cy.forEach(t),s_=a(wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wc.forEach(t),a_=p(As),mr=n(As,"P",{});var bc=r(mr);o_=a(bc,"This model is also a "),fr=n(bc,"A",{href:!0,rel:!0});var hy=r(fr);n_=a(hy,"tf.keras.Model"),hy.forEach(t),r_=a(bc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bc.forEach(t),i_=p(As),E(Bo.$$.fragment,As),l_=p(As),Xt=n(As,"DIV",{class:!0});var Ea=r(Xt);E(gr.$$.fragment,Ea),d_=p(Ea),fo=n(Ea,"P",{});var Ui=r(fo);p_=a(Ui,"The "),bi=n(Ui,"A",{href:!0});var uy=r(bi);c_=a(uy,"TFTapasModel"),uy.forEach(t),h_=a(Ui," forward method, overrides the "),Fd=n(Ui,"CODE",{});var my=r(Fd);u_=a(my,"__call__"),my.forEach(t),m_=a(Ui," special method."),Ui.forEach(t),f_=p(Ea),E(Ro.$$.fragment,Ea),g_=p(Ea),Ad=n(Ea,"P",{});var fy=r(Ad);__=a(fy,"Examples:"),fy.forEach(t),T_=p(Ea),E(_r.$$.fragment,Ea),Ea.forEach(t),As.forEach(t),Mp=p(i),go=n(i,"H2",{class:!0});var yc=r(go);Go=n(yc,"A",{id:!0,class:!0,href:!0});var gy=r(Go);zd=n(gy,"SPAN",{});var _y=r(zd);E(Tr.$$.fragment,_y),_y.forEach(t),gy.forEach(t),v_=p(yc),xd=n(yc,"SPAN",{});var Ty=r(xd);w_=a(Ty,"TFTapasForMaskedLM"),Ty.forEach(t),yc.forEach(t),Sp=p(i),pt=n(i,"DIV",{class:!0});var zs=r(pt);E(vr.$$.fragment,zs),b_=p(zs),wr=n(zs,"P",{});var kc=r(wr);y_=a(kc,"Tapas Model with a "),Cd=n(kc,"CODE",{});var vy=r(Cd);k_=a(vy,"language modeling"),vy.forEach(t),q_=a(kc," head on top."),kc.forEach(t),j_=p(zs),br=n(zs,"P",{});var qc=r(br);$_=a(qc,"This model inherits from "),yi=n(qc,"A",{href:!0});var wy=r(yi);E_=a(wy,"TFPreTrainedModel"),wy.forEach(t),F_=a(qc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qc.forEach(t),A_=p(zs),yr=n(zs,"P",{});var jc=r(yr);z_=a(jc,"This model is also a "),kr=n(jc,"A",{href:!0,rel:!0});var by=r(kr);x_=a(by,"tf.keras.Model"),by.forEach(t),C_=a(jc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fc.forEach(t),aT=p(xs),E(Jo.$$.fragment,xs),oT=p(xs),es=n(xs,"DIV",{class:!0});var Aa=r(es);E(xr.$$.fragment,Aa),nT=p(Aa),vo=n(Aa,"P",{});var Ri=r(vo);rT=a(Ri,"The "),ji=n(Ri,"A",{href:!0});var xy=r(ji);iT=a(xy,"TFTapasForSequenceClassification"),xy.forEach(t),lT=a(Ri," forward method, overrides the "),Od=n(Ri,"CODE",{});var Cy=r(Od);dT=a(Cy,"__call__"),Cy.forEach(t),pT=a(Ri," special method."),Ri.forEach(t),cT=p(Aa),E(Xo.$$.fragment,Aa),hT=p(Aa),Ld=n(Aa,"P",{});var My=r(Ld);uT=a(My,"Examples:"),My.forEach(t),mT=p(Aa),E(Cr.$$.fragment,Aa),Aa.forEach(t),xs.forEach(t),Np=p(i),wo=n(i,"H2",{class:!0});var Ac=r(wo);Zo=n(Ac,"A",{id:!0,class:!0,href:!0});var Sy=r(Zo);Qd=n(Sy,"SPAN",{});var Py=r(Qd);E(Mr.$$.fragment,Py),Py.forEach(t),Sy.forEach(t),fT=p(Ac),Id=n(Ac,"SPAN",{});var Dy=r(Id);gT=a(Dy,"TFTapasForQuestionAnswering"),Dy.forEach(t),Ac.forEach(t),Op=p(i),ht=n(i,"DIV",{class:!0});var Cs=r(ht);E(Sr.$$.fragment,Cs),_T=p(Cs),bo=n(Cs,"P",{});var Gi=r(bo);TT=a(Gi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Wd=n(Gi,"CODE",{});var Ny=r(Wd);vT=a(Ny,"logits"),Ny.forEach(t),wT=a(Gi," and optional "),Hd=n(Gi,"CODE",{});var Oy=r(Hd);bT=a(Oy,"logits_aggregation"),Oy.forEach(t),yT=a(Gi,`), e.g. for
