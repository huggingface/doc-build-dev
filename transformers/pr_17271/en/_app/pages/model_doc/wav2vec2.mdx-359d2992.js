...
above for more information.`),P.forEach(t),this.h()},h(){m(f,"href","/docs/transformers/pr_17271/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(D,P){_(D,c,P),e(c,b),e(c,f),e(f,h),e(c,v),e(c,l),e(l,u),e(c,j)},d(D){D&&t(c)}}}function xk(W){let c,b,f,h,v,l,u,j,D,P,C,A,O,H;return{c(){c=a("p"),b=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){_(l,c,u),e(c,b),e(c,f),e(f,h),e(c,v)},d(l){l&&t(c)}}}function zk(W){let c,b,f,h,v;return h=new ue({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForSequenceClassification
from datasets import load_dataset
import torch
...
first positional argument :`),qe.forEach(t),Se=p(V),z=s(V,"UL",{});var X=n(z);I=s(X,"LI",{});var G=n(I);Fe=i(G,"a single Tensor with "),ve=s(G,"CODE",{});var At=n(ve);Re=i(At,"input_values"),At.forEach(t),Ce=i(G," only and nothing else: "),oe=s(G,"CODE",{});var mt=n(oe);lt=i(mt,"model(inputs_ids)"),mt.forEach(t),G.forEach(t),He=p(X),L=s(X,"LI",{});var Te=n(L);ct=i(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(Te,"CODE",{});var xt=n(de);pe=i(xt,"model([input_values, attention_mask])"),xt.forEach(t),Ne=i(Te," or "),be=s(Te,"CODE",{});var J=n(be);dt=i(J,"model([input_values, attention_mask, token_type_ids])"),J.forEach(t),Te.forEach(t),we=p(X),ae=s(X,"LI",{});var $e=n(ae);Ee=i($e,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=s($e,"CODE",{});var Ot=n(ye);pt=i(Ot,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ot.forEach(t),$e.forEach(t),X.forEach(t)},m(V,E){_(V,c,E),e(c,b),_(V,f,E),_(V,h,E),e(h,v),e(v,l),e(h,u),e(h,j),e(j,D),_(V,P,E),_(V,C,E),e(C,A),e(C,O),e(O,H),e(C,S),e(C,q),e(q,je),e(C,ge),_(V,B,E),_(V,U,E),e(U,_e),_(V,Se,E),_(V,z,E),e(z,I),e(I,Fe),e(I,ve),e(ve,Re),e(I,Ce),e(I,oe),e(oe,lt),e(z,He),e(z,L),e(L,ct),e(L,de),e(de,pe),e(L,Ne),e(L,be),e(be,dt),e(z,we),e(z,ae),e(ae,Ee),e(ae,ye),e(ye,pt)},d(V){V&&t(c),V&&t(f),V&&t(h),V&&t(P),V&&t(C),V&&t(B),V&&t(U),V&&t(Se),V&&t(z)}}}function Hk(W){let c,b,f,h,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
instance of <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.Wav2Vec2CTCTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17271/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17271/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/tokenization_utils_base.py#L2393",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L490",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L420",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_17271/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),is=new ee({}),ls=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_17271/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),ds=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/processing_wav2vec2.py#L66"}}),hs=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/processing_wav2vec2.py#L75"}}),fs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/processing_wav2vec2.py#L47"}}),us=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_17271/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_17271/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_17271/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L229",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L346",returnDescription:`
<p><code>Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17271/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1326",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1691",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1780"}}),gn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1825",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
`}}),ta=new me({props:{$$slots:{default:[Pk]},$$scope:{ctx:W}}}),oa=new he({props:{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.example",$$slots:{default:[zk]},$$scope:{ctx:W}}}),aa=new he({props:{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.example-2",$$slots:{default:[Mk]},$$scope:{ctx:W}}}),_n=new ee({}),vn=new F({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1903"}}),$n=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1946",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2058"}}),qn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2120",returnDescription:`
...
`}}),la=new me({props:{$$slots:{default:[Lk]},$$scope:{ctx:W}}}),ca=new he({props:{anchor:"transformers.Wav2Vec2ForXVector.forward.example",$$slots:{default:[Dk]},$$scope:{ctx:W}}}),Pn=new ee({}),zn=new F({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1389"}}),Dn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"mask_time_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"sampled_negative_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1450",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1452"}}),fa=new me({props:{$$slots:{default:[Ik]},$$scope:{ctx:W}}}),Rn=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17271/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17271/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17271/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
`}}),ua=new me({props:{$$slots:{default:[Bk]},$$scope:{ctx:W}}}),ga=new he({props:{anchor:"transformers.TFWav2Vec2Model.call.example",$$slots:{default:[Uk]},$$scope:{ctx:W}}}),Hn=new ee({}),Xn=new F({props:{name:"class transformers.TFWav2Vec2ForCTC",anchor:"transformers.TFWav2Vec2ForCTC",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1555"}}),va=new me({props:{$$slots:{default:[Rk]},$$scope:{ctx:W}}}),Qn=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17271/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17271/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1582",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
`}}),ba=new me({props:{$$slots:{default:[Hk]},$$scope:{ctx:W}}}),wa=new he({props:{anchor:"transformers.TFWav2Vec2ForCTC.call.example",$$slots:{default:[Xk]},$$scope:{ctx:W}}}),Yn=new ee({}),er=new F({props:{name:"class transformers.FlaxWav2Vec2Model",anchor:"transformers.FlaxWav2Vec2Model",parameters:[{name:"config",val:": Wav2Vec2Config"},{name:"input_shape",val:": typing.Tuple = (1, 1024)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxWav2Vec2Model.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1058"}}),dr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17271/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17271/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17271/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322"}}),qr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17271/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17271/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1325",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17271/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
`}}),ja=new me({props:{$$slots:{default:[Qk]},$$scope:{ctx:W}}}),Fa=new he({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[Yk]},$$scope:{ctx:W}}}),{c(){c=a("meta"),b=d(),f=a("h1"),h=a("a"),v=a("span"),w(l.$$.fragment),u=d(),j=a("span"),D=r("Wav2Vec2"),P=d(),C=a("h2"),A=a("a"),O=a("span"),w(H.$$.fragment),S=d(),q=a("span"),je=r("Overview"),ge=d(),B=a("p"),U=r("The Wav2Vec2 model was proposed in "),_e=a("a"),Se=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),z=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),I=d(),Fe=a("p"),ve=r("The abstract from the paper is the following:"),Re=d(),Ce=a("p"),oe=a("em"),lt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),J_=d(),Ke=a("div"),w(Dn.$$.fragment),Z_=d(),io=a("p"),K_=r("The "),Ti=a("a"),Q_=r("Wav2Vec2ForPreTraining"),Y_=r(" forward method, overrides the "),tc=a("code"),e2=r("__call__"),t2=r(" special method."),o2=d(),w(pa.$$.fragment),a2=d(),w(ma.$$.fragment),Ed=d(),lo=a("h2"),ha=a("a"),oc=a("span"),w(Sn.$$.fragment),s2=d(),ac=a("span"),n2=r("TFWav2Vec2Model"),qd=d(),le=a("div"),w(Nn.$$.fragment),r2=d(),sc=a("p"),i2=r("The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),l2=d(),In=a("p"),c2=r("This model inherits from "),$i=a("a"),d2=r("TFPreTrainedModel"),p2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),m2=d(),Bn=a("p"),h2=r("This model is also a "),Un=a("a"),f2=r("tf.keras.Model"),u2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),g2=d(),w(fa.$$.fragment),_2=d(),Qe=a("div"),w(Rn.$$.fragment),v2=d(),co=a("p"),b2=r("The "),xi=a("a"),w2=r("TFWav2Vec2Model"),y2=r(" forward method, overrides the "),nc=a("code"),k2=r("__call__"),T2=r(" special method."),$2=d(),w(ua.$$.fragment),x2=d(),w(ga.$$.fragment),Pd=d(),po=a("h2"),_a=a("a"),rc=a("span"),w(Hn.$$.fragment),W2=d(),ic=a("span"),V2=r("TFWav2Vec2ForCTC"),zd=d(),ce=a("div"),w(Xn.$$.fragment),j2=d(),Gn=a("p"),F2=r("TFWav2Vec2 Model with a "),lc=a("code"),C2=r("language modeling"),E2=r(" head on top for Connectionist Temporal Classification (CTC)."),q2=d(),Jn=a("p"),P2=r("This model inherits from "),Wi=a("a"),z2=r("TFPreTrainedModel"),M2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),A2=d(),Zn=a("p"),O2=r("This model is also a "),Kn=a("a"),L2=r("tf.keras.Model"),D2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),S2=d(),w(va.$$.fragment),N2=d(),Ye=a("div"),w(Qn.$$.fragment),I2=d(),mo=a("p"),B2=r("The "),Vi=a("a"),U2=r("TFWav2Vec2ForCTC"),R2=r(" forward method, overrides the "),cc=a("code"),H2=r("__call__"),X2=r(" special method."),G2=d(),w(ba.$$.fragment),J2=d(),w(wa.$$.fragment),Md=d(),ho=a("h2"),ya=a("a"),dc=a("span"),w(Yn.$$.fragment),Z2=d(),pc=a("span"),K2=r("FlaxWav2Vec2Model"),Ad=d(),K=a("div"),w(er.$$.fragment),Q2=d(),tr=a("p"),Y2=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),or=a("a"),ev=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),tv=r(` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),ov=d(),ar=a("p"),av=r("This model inherits from "),ji=a("a"),sv=r("FlaxPreTrainedModel"),nv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rv=d(),sr=a("p"),iv=r(`This model is also a Flax Linen
`),nr=a("a"),lv=r("flax.nn.Module"),cv=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),dv=d(),mc=a("p"),pv=r("Finally, this model supports inherent JAX features such as:"),mv=d(),bt=a("ul"),hc=a("li"),rr=a("a"),hv=r("Just-In-Time (JIT) compilation"),fv=d(),fc=a("li"),ir=a("a"),uv=r("Automatic Differentiation"),gv=d(),uc=a("li"),lr=a("a"),_v=r("Vectorization"),vv=d(),gc=a("li"),cr=a("a"),bv=r("Parallelization"),wv=d(),et=a("div"),w(dr.$$.fragment),yv=d(),fo=a("p"),kv=r("The "),_c=a("code"),Tv=r("FlaxWav2Vec2PreTrainedModel"),$v=r(" forward method, overrides the "),vc=a("code"),xv=r("__call__"),Wv=r(" special method."),Vv=d(),w(ka.$$.fragment),jv=d(),w(Ta.$$.fragment),Od=d(),uo=a("h2"),$a=a("a"),bc=a("span"),w(pr.$$.fragment),Fv=d(),wc=a("span"),Cv=r("FlaxWav2Vec2ForCTC"),Ld=d(),Q=a("div"),w(mr.$$.fragment),Ev=d(),go=a("p"),qv=r("Wav2Vec2 Model with a "),yc=a("code"),Pv=r("language modeling"),zv=r(` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),hr=a("a"),Mv=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Av=r(` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ov=d(),fr=a("p"),Lv=r("This model inherits from "),Fi=a("a"),Dv=r("FlaxPreTrainedModel"),Sv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nv=d(),ur=a("p"),Iv=r(`This model is also a Flax Linen
`),gr=a("a"),Bv=r("flax.nn.Module"),Uv=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rv=d(),kc=a("p"),Hv=r("Finally, this model supports inherent JAX features such as:"),Xv=d(),wt=a("ul"),Tc=a("li"),_r=a("a"),Gv=r("Just-In-Time (JIT) compilation"),Jv=d(),$c=a("li"),vr=a("a"),Zv=r("Automatic Differentiation"),Kv=d(),xc=a("li"),br=a("a"),Qv=r("Vectorization"),Yv=d(),Wc=a("li"),wr=a("a"),eb=r("Parallelization"),tb=d(),tt=a("div"),w(yr.$$.fragment),ob=d(),_o=a("p"),ab=r("The "),Vc=a("code"),sb=r("FlaxWav2Vec2PreTrainedModel"),nb=r(" forward method, overrides the "),jc=a("code"),rb=r("__call__"),ib=r(" special method."),lb=d(),w(xa.$$.fragment),cb=d(),w(Wa.$$.fragment),Dd=d(),vo=a("h2"),Va=a("a"),Fc=a("span"),w(kr.$$.fragment),db=d(),Cc=a("span"),pb=r("FlaxWav2Vec2ForPreTraining"),Sd=d(),Y=a("div"),w(Tr.$$.fragment),mb=d(),bo=a("p"),hb=r("Wav2Vec2 Model with a quantizer and "),Ec=a("code"),fb=r("VQ"),ub=r(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Tp.forEach(t),Cu=p(Ct),Ge=s(Ct,"DIV",{class:!0});var Aa=n(Ge);y(en.$$.fragment,Aa),Eu=p(Aa),Jt=s(Aa,"P",{});var Li=n(Jt);qu=i(Li,"The "),hi=s(Li,"A",{href:!0});var c1=n(hi);Pu=i(c1,"Wav2Vec2Model"),c1.forEach(t),zu=i(Li," forward method, overrides the "),Ml=s(Li,"CODE",{});var d1=n(Ml);Mu=i(d1,"__call__"),d1.forEach(t),Au=i(Li," special method."),Li.forEach(t),Ou=p(Aa),y(Go.$$.fragment,Aa),Lu=p(Aa),y(Jo.$$.fragment,Aa),Aa.forEach(t),Ct.forEach(t),yd=p(o),Zt=s(o,"H2",{class:!0});var $p=n(Zt);Zo=s($p,"A",{id:!0,class:!0,href:!0});var p1=n(Zo);Al=s(p1,"SPAN",{});var m1=n(Al);y(tn.$$.fragment,m1),m1.forEach(t),p1.forEach(t),Du=p($p),Ol=s($p,"SPAN",{});var h1=n(Ol);Su=i(h1,"Wav2Vec2ForCTC"),h1.forEach(t),$p.forEach(t),kd=p(o),We=s(o,"DIV",{class:!0});var Et=n(We);y(on.$$.fragment,Et),Nu=p(Et),Kt=s(Et,"P",{});var Di=n(Kt);Iu=i(Di,"Wav2Vec2 Model with a "),Ll=s(Di,"CODE",{});var f1=n(Ll);Bu=i(f1,"language modeling"),f1.forEach(t),Uu=i(Di,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),an=s(Di,"A",{href:!0,rel:!0});var u1=n(an);Ru=i(u1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),u1.forEach(t),Hu=i(Di,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cp.forEach(t),Vg=p(at),Me=s(at,"DIV",{class:!0});var Pt=n(Me);y(gn.$$.fragment,Pt),jg=p(Pt),eo=s(Pt,"P",{});var Ni=n(eo);Fg=i(Ni,"The "),_i=s(Ni,"A",{href:!0});var V1=n(_i);Cg=i(V1,"Wav2Vec2ForSequenceClassification"),V1.forEach(t),Eg=i(Ni," forward method, overrides the "),Bl=s(Ni,"CODE",{});var j1=n(Bl);qg=i(j1,"__call__"),j1.forEach(t),Pg=i(Ni," special method."),Ni.forEach(t),zg=p(Pt),y(ta.$$.fragment,Pt),Mg=p(Pt),y(oa.$$.fragment,Pt),Ag=p(Pt),y(aa.$$.fragment,Pt),Pt.forEach(t),at.forEach(t),xd=p(o),to=s(o,"H2",{class:!0});var Ep=n(to);sa=s(Ep,"A",{id:!0,class:!0,href:!0});var F1=n(sa);Ul=s(F1,"SPAN",{});var C1=n(Ul);y(_n.$$.fragment,C1),C1.forEach(t),F1.forEach(t),Og=p(Ep),Rl=s(Ep,"SPAN",{});var E1=n(Rl);Lg=i(E1,"Wav2Vec2ForAudioFrameClassification"),E1.forEach(t),Ep.forEach(t),Wd=p(o),re=s(o,"DIV",{class:!0});var st=n(re);y(vn.$$.fragment,st),Dg=p(st),Hl=s(st,"P",{});var q1=n(Hl);Sg=i(q1,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),q1.forEach(t),Ng=p(st),bn=s(st,"P",{});var qp=n(bn);Ig=i(qp,"Wav2Vec2 was proposed in "),wn=s(qp,"A",{href:!0,rel:!0});var P1=n(wn);Bg=i(P1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),P1.forEach(t),Ug=i(qp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),qp.forEach(t),Rg=p(st),yn=s(st,"P",{});var Pp=n(yn);Hg=i(Pp,"This model inherits from "),vi=s(Pp,"A",{href:!0});var z1=n(vi);Xg=i(z1,"PreTrainedModel"),z1.forEach(t),Gg=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Pp.forEach(t),Jg=p(st),kn=s(st,"P",{});var zp=n(kn);Zg=i(zp,"This model is a PyTorch "),Tn=s(zp,"A",{href:!0,rel:!0});var M1=n(Tn);Kg=i(M1,"torch.nn.Module"),M1.forEach(t),Qg=i(zp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zp.forEach(t),Yg=p(st),Je=s(st,"DIV",{class:!0});var Oa=n(Je);y($n.$$.fragment,Oa),e_=p(Oa),oo=s(Oa,"P",{});var Ii=n(oo);t_=i(Ii,"The "),bi=s(Ii,"A",{href:!0});var A1=n(bi);o_=i(A1,"Wav2Vec2ForAudioFrameClassification"),A1.forEach(t),a_=i(Ii," forward method, overrides the "),Xl=s(Ii,"CODE",{});var O1=n(Xl);s_=i(O1,"__call__"),O1.forEach(t),n_=i(Ii," special method."),Ii.forEach(t),r_=p(Oa),y(na.$$.fragment,Oa),i_=p(Oa),y(ra.$$.fragment,Oa),Oa.forEach(t),st.forEach(t),Vd=p(o),ao=s(o,"H2",{class:!0});var Mp=n(ao);ia=s(Mp,"A",{id:!0,class:!0,href:!0});var L1=n(ia);Gl=s(L1,"SPAN",{});var D1=n(Gl);y(xn.$$.fragment,D1),D1.forEach(t),L1.forEach(t),l_=p(Mp),Jl=s(Mp,"SPAN",{});var S1=n(Jl);c_=i(S1,"Wav2Vec2ForXVector"),S1.forEach(t),Mp.forEach(t),jd=p(o),ie=s(o,"DIV",{class:!0});var nt=n(ie);y(Wn.$$.fragment,nt),d_=p(nt),Zl=s(nt,"P",{});var N1=n(Zl);p_=i(N1,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),N1.forEach(t),m_=p(nt),Vn=s(nt,"P",{});var Ap=n(Vn);h_=i(Ap,"Wav2Vec2 was proposed in "),jn=s(Ap,"A",{href:!0,rel:!0});var I1=n(jn);f_=i(I1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lp.forEach(t),$_=p(nt),Ze=s(nt,"DIV",{class:!0});var La=n(Ze);y(qn.$$.fragment,La),x_=p(La),so=s(La,"P",{});var Bi=n(so);W_=i(Bi,"The "),yi=s(Bi,"A",{href:!0});var R1=n(yi);V_=i(R1,"Wav2Vec2ForXVector"),R1.forEach(t),j_=i(Bi," forward method, overrides the "),Kl=s(Bi,"CODE",{});var H1=n(Kl);F_=i(H1,"__call__"),H1.forEach(t),C_=i(Bi," special method."),Bi.forEach(t),E_=p(La),y(la.$$.fragment,La),q_=p(La),y(ca.$$.fragment,La),La.forEach(t),nt.forEach(t),Fd=p(o),no=s(o,"H2",{class:!0});var Dp=n(no);da=s(Dp,"A",{id:!0,class:!0,href:!0});var X1=n(da);Ql=s(X1,"SPAN",{});var G1=n(Ql);y(Pn.$$.fragment,G1),G1.forEach(t),X1.forEach(t),P_=p(Dp),Yl=s(Dp,"SPAN",{});var J1=n(Yl);z_=i(J1,"Wav2Vec2ForPreTraining"),J1.forEach(t),Dp.forEach(t),Cd=p(o),Ve=s(o,"DIV",{class:!0});var zt=n(Ve);y(zn.$$.fragment,zt),M_=p(zt),ro=s(zt,"P",{});var Ui=n(ro);A_=i(Ui,"Wav2Vec2 Model with a quantizer and "),ec=s(Ui,"CODE",{});var Z1=n(ec);O_=i(Z1,"VQ"),Z1.forEach(t),L_=i(Ui,` head on top.
Wav2Vec2 was proposed in `),Mn=s(Ui,"A",{href:!0,rel:!0});var K1=n(Mn);D_=i(K1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),K1.forEach(t),S_=i(Ui,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ui.forEach(t),N_=p(zt),An=s(zt,"P",{});var Sp=n(An);I_=i(Sp,"This model inherits from "),ki=s(Sp,"A",{href:!0});var Q1=n(ki);B_=i(Q1,"PreTrainedModel"),Q1.forEach(t),U_=i(Sp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Sp.forEach(t),R_=p(zt),On=s(zt,"P",{});var Np=n(On);H_=i(Np,"This model is a PyTorch "),Ln=s(Np,"A",{href:!0,rel:!0});var Y1=n(Ln);X_=i(Y1,"torch.nn.Module"),Y1.forEach(t),G_=i(Np,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Np.forEach(t),J_=p(zt),Ke=s(zt,"DIV",{class:!0});var Da=n(Ke);y(Dn.$$.fragment,Da),Z_=p(Da),io=s(Da,"P",{});var Ri=n(io);K_=i(Ri,"The "),Ti=s(Ri,"A",{href:!0});var ey=n(Ti);Q_=i(ey,"Wav2Vec2ForPreTraining"),ey.forEach(t),Y_=i(Ri," forward method, overrides the "),tc=s(Ri,"CODE",{});var ty=n(tc);e2=i(ty,"__call__"),ty.forEach(t),t2=i(Ri," special method."),Ri.forEach(t),o2=p(Da),y(pa.$$.fragment,Da),a2=p(Da),y(ma.$$.fragment,Da),Da.forEach(t),zt.forEach(t),Ed=p(o),lo=s(o,"H2",{class:!0});var Ip=n(lo);ha=s(Ip,"A",{id:!0,class:!0,href:!0});var oy=n(ha);oc=s(oy,"SPAN",{});var ay=n(oc);y(Sn.$$.fragment,ay),ay.forEach(t),oy.forEach(t),s2=p(Ip),ac=s(Ip,"SPAN",{});var sy=n(ac);n2=i(sy,"TFWav2Vec2Model"),sy.forEach(t),Ip.forEach(t),qd=p(o),le=s(o,"DIV",{class:!0});var rt=n(le);y(Nn.$$.fragment,rt),r2=p(rt),sc=s(rt,"P",{});var ny=n(sc);i2=i(ny,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),ny.forEach(t),l2=p(rt),In=s(rt,"P",{});var Bp=n(In);c2=i(Bp,"This model inherits from "),$i=s(Bp,"A",{href:!0});var ry=n($i);d2=i(ry,"TFPreTrainedModel"),ry.forEach(t),p2=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bp.forEach(t),m2=p(rt),Bn=s(rt,"P",{});var Up=n(Bn);h2=i(Up,"This model is also a "),Un=s(Up,"A",{href:!0,rel:!0});var iy=n(Un);f2=i(iy,"tf.keras.Model"),iy.forEach(t),u2=i(Up,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Up.forEach(t),g2=p(rt),y(fa.$$.fragment,rt),_2=p(rt),Qe=s(rt,"DIV",{class:!0});var Sa=n(Qe);y(Rn.$$.fragment,Sa),v2=p(Sa),co=s(Sa,"P",{});var Hi=n(co);b2=i(Hi,"The "),xi=s(Hi,"A",{href:!0});var ly=n(xi);w2=i(ly,"TFWav2Vec2Model"),ly.forEach(t),y2=i(Hi," forward method, overrides the "),nc=s(Hi,"CODE",{});var cy=n(nc);k2=i(cy,"__call__"),cy.forEach(t),T2=i(Hi," special method."),Hi.forEach(t),$2=p(Sa),y(ua.$$.fragment,Sa),x2=p(Sa),y(ga.$$.fragment,Sa),Sa.forEach(t),rt.forEach(t),Pd=p(o),po=s(o,"H2",{class:!0});var Rp=n(po);_a=s(Rp,"A",{id:!0,class:!0,href:!0});var dy=n(_a);rc=s(dy,"SPAN",{});var py=n(rc);y(Hn.$$.fragment,py),py.forEach(t),dy.forEach(t),W2=p(Rp),ic=s(Rp,"SPAN",{});var my=n(ic);V2=i(my,"TFWav2Vec2ForCTC"),my.forEach(t),Rp.forEach(t),zd=p(o),ce=s(o,"DIV",{class:!0});var it=n(ce);y(Xn.$$.fragment,it),j2=p(it),Gn=s(it,"P",{});var Hp=n(Gn);F2=i(Hp,"TFWav2Vec2 Model with a "),lc=s(Hp,"CODE",{});var hy=n(lc);C2=i(hy,"language modeling"),hy.forEach(t),E2=i(Hp," head on top for Connectionist Temporal Classification (CTC)."),Hp.forEach(t),q2=p(it),Jn=s(it,"P",{});var Xp=n(Jn);P2=i(Xp,"This model inherits from "),Wi=s(Xp,"A",{href:!0});var fy=n(Wi);z2=i(fy,"TFPreTrainedModel"),fy.forEach(t),M2=i(Xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xp.forEach(t),A2=p(it),Zn=s(it,"P",{});var Gp=n(Zn);O2=i(Gp,"This model is also a "),Kn=s(Gp,"A",{href:!0,rel:!0});var uy=n(Kn);L2=i(uy,"tf.keras.Model"),uy.forEach(t),D2=i(Gp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gp.forEach(t),S2=p(it),y(va.$$.fragment,it),N2=p(it),Ye=s(it,"DIV",{class:!0});var Na=n(Ye);y(Qn.$$.fragment,Na),I2=p(Na),mo=s(Na,"P",{});var Xi=n(mo);B2=i(Xi,"The "),Vi=s(Xi,"A",{href:!0});var gy=n(Vi);U2=i(gy,"TFWav2Vec2ForCTC"),gy.forEach(t),R2=i(Xi," forward method, overrides the "),cc=s(Xi,"CODE",{});var _y=n(cc);H2=i(_y,"__call__"),_y.forEach(t),X2=i(Xi," special method."),Xi.forEach(t),G2=p(Na),y(ba.$$.fragment,Na),J2=p(Na),y(wa.$$.fragment,Na),Na.forEach(t),it.forEach(t),Md=p(o),ho=s(o,"H2",{class:!0});var Jp=n(ho);ya=s(Jp,"A",{id:!0,class:!0,href:!0});var vy=n(ya);dc=s(vy,"SPAN",{});var by=n(dc);y(Yn.$$.fragment,by),by.forEach(t),vy.forEach(t),Z2=p(Jp),pc=s(Jp,"SPAN",{});var wy=n(pc);K2=i(wy,"FlaxWav2Vec2Model"),wy.forEach(t),Jp.forEach(t),Ad=p(o),K=s(o,"DIV",{class:!0});var Oe=n(K);y(er.$$.fragment,Oe),Q2=p(Oe),tr=s(Oe,"P",{});var Zp=n(tr);Y2=i(Zp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),or=s(Zp,"A",{href:!0,rel:!0});var yy=n(or);ev=i(yy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),yy.forEach(t),tv=i(Zp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Zp.forEach(t),ov=p(Oe),ar=s(Oe,"P",{});var Kp=n(ar);av=i(Kp,"This model inherits from "),ji=s(Kp,"A",{href:!0});var ky=n(ji);sv=i(ky,"FlaxPreTrainedModel"),ky.forEach(t),nv=i(Kp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kp.forEach(t),rv=p(Oe),sr=s(Oe,"P",{});var Qp=n(sr);iv=i(Qp,`This model is also a Flax Linen
`),nr=s(Qp,"A",{href:!0,rel:!0});var Ty=n(nr);lv=i(Ty,"flax.nn.Module"),Ty.forEach(t),cv=i(Qp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Qp.forEach(t),dv=p(Oe),mc=s(Oe,"P",{});var $y=n(mc);pv=i($y,"Finally, this model supports inherent JAX features such as:"),$y.forEach(t),mv=p(Oe),bt=s(Oe,"UL",{});var Ia=n(bt);hc=s(Ia,"LI",{});var xy=n(hc);rr=s(xy,"A",{href:!0,rel:!0});var Wy=n(rr);hv=i(Wy,"Just-In-Time (JIT) compilation"),Wy.forEach(t),xy.forEach(t),fv=p(Ia),fc=s(Ia,"LI",{});var Vy=n(fc);ir=s(Vy,"A",{href:!0,rel:!0});var jy=n(ir);uv=i(jy,"Automatic Differentiation"),jy.forEach(t),Vy.forEach(t),gv=p(Ia),uc=s(Ia,"LI",{});var Fy=n(uc);lr=s(Fy,"A",{href:!0,rel:!0});var Cy=n(lr);_v=i(Cy,"Vectorization"),Cy.forEach(t),Fy.forEach(t),vv=p(Ia),gc=s(Ia,"LI",{});var Ey=n(gc);cr=s(Ey,"A",{href:!0,rel:!0});var qy=n(cr);bv=i(qy,"Parallelization"),qy.forEach(t),Ey.forEach(t),Ia.forEach(t),wv=p(Oe),et=s(Oe,"DIV",{class:!0});var Ba=n(et);y(dr.$$.fragment,Ba),yv=p(Ba),fo=s(Ba,"P",{});var Gi=n(fo);kv=i(Gi,"The "),_c=s(Gi,"CODE",{});var Py=n(_c);Tv=i(Py,"FlaxWav2Vec2PreTrainedModel"),Py.forEach(t),$v=i(Gi," forward method, overrides the "),vc=s(Gi,"CODE",{});var zy=n(vc);xv=i(zy,"__call__"),zy.forEach(t),Wv=i(Gi," special method."),Gi.forEach(t),Vv=p(Ba),y(ka.$$.fragment,Ba),jv=p(Ba),y(Ta.$$.fragment,Ba),Ba.forEach(t),Oe.forEach(t),Od=p(o),uo=s(o,"H2",{class:!0});var Yp=n(uo);$a=s(Yp,"A",{id:!0,class:!0,href:!0});var My=n($a);bc=s(My,"SPAN",{});var Ay=n(bc);y(pr.$$.fragment,Ay),Ay.forEach(t),My.forEach(t),Fv=p(Yp),wc=s(Yp,"SPAN",{});var Oy=n(wc);Cv=i(Oy,"FlaxWav2Vec2ForCTC"),Oy.forEach(t),Yp.forEach(t),Ld=p(o),Q=s(o,"DIV",{class:!0});var Le=n(Q);y(mr.$$.fragment,Le),Ev=p(Le),go=s(Le,"P",{});var Ji=n(go);qv=i(Ji,"Wav2Vec2 Model with a "),yc=s(Ji,"CODE",{});var Ly=n(yc);Pv=i(Ly,"language modeling"),Ly.forEach(t),zv=i(Ji,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),hr=s(Ji,"A",{href:!0,rel:!0});var Dy=n(hr);Mv=i(Dy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Dy.forEach(t),Av=i(Ji,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ji.forEach(t),Ov=p(Le),fr=s(Le,"P",{});var em=n(fr);Lv=i(em,"This model inherits from "),Fi=s(em,"A",{href:!0});var Sy=n(Fi);Dv=i(Sy,"FlaxPreTrainedModel"),Sy.forEach(t),Sv=i(em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),em.forEach(t),Nv=p(Le),ur=s(Le,"P",{});var tm=n(ur);Iv=i(tm,`This model is also a Flax Linen
`),gr=s(tm,"A",{href:!0,rel:!0});var Ny=n(gr);Bv=i(Ny,"flax.nn.Module"),Ny.forEach(t),Uv=i(tm,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),tm.forEach(t),Rv=p(Le),kc=s(Le,"P",{});var Iy=n(kc);Hv=i(Iy,"Finally, this model supports inherent JAX features such as:"),Iy.forEach(t),Xv=p(Le),wt=s(Le,"UL",{});var Ua=n(wt);Tc=s(Ua,"LI",{});var By=n(Tc);_r=s(By,"A",{href:!0,rel:!0});var Uy=n(_r);Gv=i(Uy,"Just-In-Time (JIT) compilation"),Uy.forEach(t),By.forEach(t),Jv=p(Ua),$c=s(Ua,"LI",{});var Ry=n($c);vr=s(Ry,"A",{href:!0,rel:!0});var Hy=n(vr);Zv=i(Hy,"Automatic Differentiation"),Hy.forEach(t),Ry.forEach(t),Kv=p(Ua),xc=s(Ua,"LI",{});var Xy=n(xc);br=s(Xy,"A",{href:!0,rel:!0});var Gy=n(br);Qv=i(Gy,"Vectorization"),Gy.forEach(t),Xy.forEach(t),Yv=p(Ua),Wc=s(Ua,"LI",{});var Jy=n(Wc);wr=s(Jy,"A",{href:!0,rel:!0});var Zy=n(wr);eb=i(Zy,"Parallelization"),Zy.forEach(t),Jy.forEach(t),Ua.forEach(t),tb=p(Le),tt=s(Le,"DIV",{class:!0});var Ra=n(tt);y(yr.$$.fragment,Ra),ob=p(Ra),_o=s(Ra,"P",{});var Zi=n(_o);ab=i(Zi,"The "),Vc=s(Zi,"CODE",{});var Ky=n(Vc);sb=i(Ky,"FlaxWav2Vec2PreTrainedModel"),Ky.forEach(t),nb=i(Zi," forward method, overrides the "),jc=s(Zi,"CODE",{});var Qy=n(jc);rb=i(Qy,"__call__"),Qy.forEach(t),ib=i(Zi," special method."),Zi.forEach(t),lb=p(Ra),y(xa.$$.fragment,Ra),cb=p(Ra),y(Wa.$$.fragment,Ra),Ra.forEach(t),Le.forEach(t),Dd=p(o),vo=s(o,"H2",{class:!0});var om=n(vo);Va=s(om,"A",{id:!0,class:!0,href:!0});var Yy=n(Va);Fc=s(Yy,"SPAN",{});var ek=n(Fc);y(kr.$$.fragment,ek),ek.forEach(t),Yy.forEach(t),db=p(om),Cc=s(om,"SPAN",{});var tk=n(Cc);pb=i(tk,"FlaxWav2Vec2ForPreTraining"),tk.forEach(t),om.forEach(t),Sd=p(o),Y=s(o,"DIV",{class:!0});var De=n(Y);y(Tr.$$.fragment,De),mb=p(De),bo=s(De,"P",{});var Ki=n(bo);hb=i(Ki,"Wav2Vec2 Model with a quantizer and "),Ec=s(Ki,"CODE",{});var ok=n(Ec);fb=i(ok,"VQ"),ok.forEach(t),ub=i(Ki,` head on top.
