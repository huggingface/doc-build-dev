...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17221/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_17221/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17221/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17221/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),X1=p(),Pa=s("p"),Y1=a("This model is also a Flax Linen "),Aa=s("a"),Z1=a("flax.linen.Module"),e2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t2=p(),ac=s("p"),o2=a("Finally, this model supports inherent JAX features such as:"),s2=p(),zt=s("ul"),ic=s("li"),Oa=s("a"),n2=a("Just-In-Time (JIT) compilation"),r2=p(),lc=s("li"),Na=s("a"),a2=a("Automatic Differentiation"),i2=p(),dc=s("li"),La=s("a"),l2=a("Vectorization"),d2=p(),cc=s("li"),Sa=s("a"),c2=a("Parallelization"),p2=p(),bt=s("div"),T(Ia.$$.fragment),h2=p(),Ao=s("p"),u2=a("The "),pc=s("code"),f2=a("FlaxDistilBertPreTrainedModel"),m2=a(" forward method, overrides the "),hc=s("code"),g2=a("__call__"),_2=a(" special method."),b2=p(),T(on.$$.fragment),v2=p(),T(sn.$$.fragment),ph=p(),Oo=s("h2"),nn=s("a"),uc=s("span"),T(Wa.$$.fragment),k2=p(),fc=s("span"),T2=a("FlaxDistilBertForMultipleChoice"),hh=p(),je=s("div"),T(Qa.$$.fragment),$2=p(),mc=s("p"),w2=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),y2=p(),Ra=s("p"),D2=a("This model inherits from "),dl=s("a"),F2=a("FlaxPreTrainedModel"),B2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),x2=p(),Ua=s("p"),M2=a("This model is also a Flax Linen "),Ha=s("a"),E2=a("flax.linen.Module"),z2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),j2=p(),gc=s("p"),C2=a("Finally, this model supports inherent JAX features such as:"),q2=p(),jt=s("ul"),_c=s("li"),Va=s("a"),P2=a("Just-In-Time (JIT) compilation"),A2=p(),bc=s("li"),Ka=s("a"),O2=a("Automatic Differentiation"),N2=p(),vc=s("li"),Ja=s("a"),L2=a("Vectorization"),S2=p(),kc=s("li"),Ga=s("a"),I2=a("Parallelization"),W2=p(),vt=s("div"),T(Xa.$$.fragment),Q2=p(),No=s("p"),R2=a("The "),Tc=s("code"),U2=a("FlaxDistilBertPreTrainedModel"),H2=a(" forward method, overrides the "),$c=s("code"),V2=a("__call__"),K2=a(" special method."),J2=p(),T(rn.$$.fragment),G2=p(),T(an.$$.fragment),uh=p(),Lo=s("h2"),ln=s("a"),wc=s("span"),T(Ya.$$.fragment),X2=p(),yc=s("span"),Y2=a("FlaxDistilBertForTokenClassification"),fh=p(),Ce=s("div"),T(Za.$$.fragment),Z2=p(),Dc=s("p"),ek=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),tk=p(),ei=s("p"),ok=a("This model inherits from "),cl=s("a"),sk=a("FlaxPreTrainedModel"),nk=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),rk=p(),ti=s("p"),ak=a("This model is also a Flax Linen "),oi=s("a"),ik=a("flax.linen.Module"),lk=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),dk=p(),Fc=s("p"),ck=a("Finally, this model supports inherent JAX features such as:"),pk=p(),Ct=s("ul"),Bc=s("li"),si=s("a"),hk=a("Just-In-Time (JIT) compilation"),uk=p(),xc=s("li"),ni=s("a"),fk=a("Automatic Differentiation"),mk=p(),Mc=s("li"),ri=s("a"),gk=a("Vectorization"),_k=p(),Ec=s("li"),ai=s("a"),bk=a("Parallelization"),vk=p(),kt=s("div"),T(ii.$$.fragment),kk=p(),So=s("p"),Tk=a("The "),zc=s("code"),$k=a("FlaxDistilBertPreTrainedModel"),wk=a(" forward method, overrides the "),jc=s("code"),yk=a("__call__"),Dk=a(" special method."),Fk=p(),T(dn.$$.fragment),Bk=p(),T(cn.$$.fragment),mh=p(),Io=s("h2"),pn=s("a"),Cc=s("span"),T(li.$$.fragment),xk=p(),qc=s("span"),Mk=a("FlaxDistilBertForQuestionAnswering"),gh=p(),qe=s("div"),T(di.$$.fragment),Ek=p(),Wo=s("p"),zk=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Pc=s("code"),jk=a("span start logits"),Ck=a(" and "),Ac=s("code"),qk=a("span end logits"),Pk=a(")."),Ak=p(),ci=s("p"),Ok=a("This model inherits from "),pl=s("a"),Nk=a("FlaxPreTrainedModel"),Lk=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Sk=p(),pi=s("p"),Ik=a("This model is also a Flax Linen "),hi=s("a"),Wk=a("flax.linen.Module"),Qk=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Rk=p(),Oc=s("p"),Uk=a("Finally, this model supports inherent JAX features such as:"),Hk=p(),qt=s("ul"),Nc=s("li"),ui=s("a"),Vk=a("Just-In-Time (JIT) compilation"),Kk=p(),Lc=s("li"),fi=s("a"),Jk=a("Automatic Differentiation"),Gk=p(),Sc=s("li"),mi=s("a"),Xk=a("Vectorization"),Yk=p(),Ic=s("li"),gi=s("a"),Zk=a("Parallelization"),eT=p(),Tt=s("div"),T(_i.$$.fragment),tT=p(),Qo=s("p"),oT=a("The "),Wc=s("code"),sT=a("FlaxDistilBertPreTrainedModel"),nT=a(" forward method, overrides the "),Qc=s("code"),rT=a("__call__"),aT=a(" special method."),iT=p(),T(hn.$$.fragment),lT=p(),T(un.$$.fragment),this.h()},l(o){const v=oD('[data-svelte="svelte-1phssyn"]',document.head);d=n(v,"META",{name:!0,content:!0}),v.forEach(t),g=h(o),c=n(o,"H1",{class:!0});var bi=r(c);u=n(bi,"A",{id:!0,class:!0,href:!0});var Rc=r(u);_=n(Rc,"SPAN",{});var Uc=r(_);$(l.$$.fragment,Uc),Uc.forEach(t),Rc.forEach(t),f=h(bi),x=n(bi,"SPAN",{});var Hc=r(x);he=i(Hc,"DistilBERT"),Hc.forEach(t),bi.forEach(t),V=h(o),E=n(o,"H2",{class:!0});var vi=r(E);G=n(vi,"A",{id:!0,class:!0,href:!0});var Vc=r(G);S=n(Vc,"SPAN",{});var Kc=r(S);$(X.$$.fragment,Kc),Kc.forEach(t),Vc.forEach(t),ue=h(vi),I=n(vi,"SPAN",{});var Jc=r(I);fe=i(Jc,"Overview"),Jc.forEach(t),vi.forEach(t),le=h(o),N=n(o,"P",{});var Pt=r(N);P=i(Pt,"The DistilBERT model was proposed in the blog post "),Y=n(Pt,"A",{href:!0,rel:!0});var Gc=r(Y);K=i(Gc,`Smaller, faster, cheaper, lighter: Introducing DistilBERT, a
...
and wordpiece.`),fn.forEach(t),sf=h(St),Sn=n(St,"P",{});var yi=r(Sn);nf=i(yi,"Refer to superclass "),ji=n(yi,"A",{href:!0});var yp=r(ji);rf=i(yp,"BertTokenizer"),yp.forEach(t),af=i(yi," for usage examples and documentation concerning parameters."),yi.forEach(t),St.forEach(t),Cp=h(o),so=n(o,"H2",{class:!0});var Di=r(so);Jo=n(Di,"A",{id:!0,class:!0,href:!0});var Dp=r(Jo);Nl=n(Dp,"SPAN",{});var Fp=r(Nl);$(In.$$.fragment,Fp),Fp.forEach(t),Dp.forEach(t),lf=h(Di),Ll=n(Di,"SPAN",{});var dT=r(Ll);df=i(dT,"DistilBertTokenizerFast"),dT.forEach(t),Di.forEach(t),qp=h(o),ct=n(o,"DIV",{class:!0});var mn=r(ct);$(Wn.$$.fragment,mn),cf=h(mn),Qn=n(mn,"P",{});var bh=r(Qn);pf=i(bh,"Construct a \u201Cfast\u201D DistilBERT tokenizer (backed by HuggingFace\u2019s "),Sl=n(bh,"EM",{});var cT=r(Sl);hf=i(cT,"tokenizers"),cT.forEach(t),uf=i(bh," library)."),bh.forEach(t),ff=h(mn),Go=n(mn,"P",{});var Bp=r(Go);Ci=n(Bp,"A",{href:!0});var pT=r(Ci);mf=i(pT,"DistilBertTokenizerFast"),pT.forEach(t),gf=i(Bp," is identical to "),qi=n(Bp,"A",{href:!0});var hT=r(qi);_f=i(hT,"BertTokenizerFast"),hT.forEach(t),bf=i(Bp,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),Bp.forEach(t),vf=h(mn),Rn=n(mn,"P",{});var vh=r(Rn);kf=i(vh,"Refer to superclass "),Pi=n(vh,"A",{href:!0});var uT=r(Pi);Tf=i(uT,"BertTokenizerFast"),uT.forEach(t),$f=i(vh," for usage examples and documentation concerning parameters."),vh.forEach(t),mn.forEach(t),Pp=h(o),no=n(o,"H2",{class:!0});var kh=r(no);Xo=n(kh,"A",{id:!0,class:!0,href:!0});var fT=r(Xo);Il=n(fT,"SPAN",{});var mT=r(Il);$(Un.$$.fragment,mT),mT.forEach(t),fT.forEach(t),wf=h(kh),Wl=n(kh,"SPAN",{});var gT=r(Wl);yf=i(gT,"DistilBertModel"),gT.forEach(t),kh.forEach(t),Ap=h(o),We=n(o,"DIV",{class:!0});var It=r(We);$(Hn.$$.fragment,It),Df=h(It),Ql=n(It,"P",{});var _T=r(Ql);Ff=i(_T,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),_T.forEach(t),Bf=h(It),Vn=n(It,"P",{});var Th=r(Vn);xf=i(Th,"This model inherits from "),Ai=n(Th,"A",{href:!0});var bT=r(Ai);Mf=i(bT,"PreTrainedModel"),bT.forEach(t),Ef=i(Th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Th.forEach(t),zf=h(It),Kn=n(It,"P",{});var $h=r(Kn);jf=i($h,"This model is also a PyTorch "),Jn=n($h,"A",{href:!0,rel:!0});var vT=r(Jn);Cf=i(vT,"torch.nn.Module"),vT.forEach(t),qf=i($h,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),Pf=h(It),ht=n(It,"DIV",{class:!0});var gn=r(ht);$(Gn.$$.fragment,gn),Af=h(gn),ro=n(gn,"P",{});var hl=r(ro);Of=i(hl,"The "),Oi=n(hl,"A",{href:!0});var kT=r(Oi);Nf=i(kT,"DistilBertModel"),kT.forEach(t),Lf=i(hl," forward method, overrides the "),Rl=n(hl,"CODE",{});var TT=r(Rl);Sf=i(TT,"__call__"),TT.forEach(t),If=i(hl," special method."),hl.forEach(t),Wf=h(gn),$(Yo.$$.fragment,gn),Qf=h(gn),$(Zo.$$.fragment,gn),gn.forEach(t),It.forEach(t),Op=h(o),ao=n(o,"H2",{class:!0});var wh=r(ao);es=n(wh,"A",{id:!0,class:!0,href:!0});var $T=r(es);Ul=n($T,"SPAN",{});var wT=r(Ul);$(Xn.$$.fragment,wT),wT.forEach(t),$T.forEach(t),Rf=h(wh),Hl=n(wh,"SPAN",{});var yT=r(Hl);Uf=i(yT,"DistilBertForMaskedLM"),yT.forEach(t),wh.forEach(t),Np=h(o),Qe=n(o,"DIV",{class:!0});var Wt=r(Qe);$(Yn.$$.fragment,Wt),Hf=h(Wt),Zn=n(Wt,"P",{});var yh=r(Zn);Vf=i(yh,"DistilBert Model with a "),Vl=n(yh,"CODE",{});var DT=r(Vl);Kf=i(DT,"masked language modeling"),DT.forEach(t),Jf=i(yh," head on top."),yh.forEach(t),Gf=h(Wt),er=n(Wt,"P",{});var Dh=r(er);Xf=i(Dh,"This model inherits from "),Ni=n(Dh,"A",{href:!0});var FT=r(Ni);Yf=i(FT,"PreTrainedModel"),FT.forEach(t),Zf=i(Dh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dh.forEach(t),em=h(Wt),tr=n(Wt,"P",{});var Fh=r(tr);tm=i(Fh,"This model is also a PyTorch "),or=n(Fh,"A",{href:!0,rel:!0});var BT=r(or);om=i(BT,"torch.nn.Module"),BT.forEach(t),sm=i(Fh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fh.forEach(t),nm=h(Wt),Ke=n(Wt,"DIV",{class:!0});var Qt=r(Ke);$(sr.$$.fragment,Qt),rm=h(Qt),io=n(Qt,"P",{});var ul=r(io);am=i(ul,"The "),Li=n(ul,"A",{href:!0});var xT=r(Li);im=i(xT,"DistilBertForMaskedLM"),xT.forEach(t),lm=i(ul," forward method, overrides the "),Kl=n(ul,"CODE",{});var MT=r(Kl);dm=i(MT,"__call__"),MT.forEach(t),cm=i(ul," special method."),ul.forEach(t),pm=h(Qt),$(ts.$$.fragment,Qt),hm=h(Qt),$(os.$$.fragment,Qt),um=h(Qt),$(ss.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),Lp=h(o),lo=n(o,"H2",{class:!0});var Bh=r(lo);ns=n(Bh,"A",{id:!0,class:!0,href:!0});var ET=r(ns);Jl=n(ET,"SPAN",{});var zT=r(Jl);$(nr.$$.fragment,zT),zT.forEach(t),ET.forEach(t),fm=h(Bh),Gl=n(Bh,"SPAN",{});var jT=r(Gl);mm=i(jT,"DistilBertForSequenceClassification"),jT.forEach(t),Bh.forEach(t),Sp=h(o),Re=n(o,"DIV",{class:!0});var Rt=r(Re);$(rr.$$.fragment,Rt),gm=h(Rt),Xl=n(Rt,"P",{});var CT=r(Xl);_m=i(CT,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),CT.forEach(t),bm=h(Rt),ar=n(Rt,"P",{});var xh=r(ar);vm=i(xh,"This model inherits from "),Si=n(xh,"A",{href:!0});var qT=r(Si);km=i(qT,"PreTrainedModel"),qT.forEach(t),Tm=i(xh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xh.forEach(t),$m=h(Rt),ir=n(Rt,"P",{});var Mh=r(ir);wm=i(Mh,"This model is also a PyTorch "),lr=n(Mh,"A",{href:!0,rel:!0});var PT=r(lr);ym=i(PT,"torch.nn.Module"),PT.forEach(t),Dm=i(Mh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mh.forEach(t),Fm=h(Rt),Pe=n(Rt,"DIV",{class:!0});var tt=r(Pe);$(dr.$$.fragment,tt),Bm=h(tt),co=n(tt,"P",{});var fl=r(co);xm=i(fl,"The "),Ii=n(fl,"A",{href:!0});var AT=r(Ii);Mm=i(AT,"DistilBertForSequenceClassification"),AT.forEach(t),Em=i(fl," forward method, overrides the "),Yl=n(fl,"CODE",{});var OT=r(Yl);zm=i(OT,"__call__"),OT.forEach(t),jm=i(fl," special method."),fl.forEach(t),Cm=h(tt),$(rs.$$.fragment,tt),qm=h(tt),$(as.$$.fragment,tt),Pm=h(tt),$(is.$$.fragment,tt),Am=h(tt),$(ls.$$.fragment,tt),Om=h(tt),$(ds.$$.fragment,tt),tt.forEach(t),Rt.forEach(t),Ip=h(o),po=n(o,"H2",{class:!0});var Eh=r(po);cs=n(Eh,"A",{id:!0,class:!0,href:!0});var NT=r(cs);Zl=n(NT,"SPAN",{});var LT=r(Zl);$(cr.$$.fragment,LT),LT.forEach(t),NT.forEach(t),Nm=h(Eh),ed=n(Eh,"SPAN",{});var ST=r(ed);Lm=i(ST,"DistilBertForMultipleChoice"),ST.forEach(t),Eh.forEach(t),Wp=h(o),Ue=n(o,"DIV",{class:!0});var Ut=r(Ue);$(pr.$$.fragment,Ut),Sm=h(Ut),td=n(Ut,"P",{});var IT=r(td);Im=i(IT,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),IT.forEach(t),Wm=h(Ut),hr=n(Ut,"P",{});var zh=r(hr);Qm=i(zh,"This model inherits from "),Wi=n(zh,"A",{href:!0});var WT=r(Wi);Rm=i(WT,"PreTrainedModel"),WT.forEach(t),Um=i(zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zh.forEach(t),Hm=h(Ut),ur=n(Ut,"P",{});var jh=r(ur);Vm=i(jh,"This model is also a PyTorch "),fr=n(jh,"A",{href:!0,rel:!0});var QT=r(fr);Km=i(QT,"torch.nn.Module"),QT.forEach(t),Jm=i(jh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jh.forEach(t),Gm=h(Ut),ut=n(Ut,"DIV",{class:!0});var _n=r(ut);$(mr.$$.fragment,_n),Xm=h(_n),ho=n(_n,"P",{});var ml=r(ho);Ym=i(ml,"The "),Qi=n(ml,"A",{href:!0});var RT=r(Qi);Zm=i(RT,"DistilBertForMultipleChoice"),RT.forEach(t),eg=i(ml," forward method, overrides the "),od=n(ml,"CODE",{});var UT=r(od);tg=i(UT,"__call__"),UT.forEach(t),og=i(ml," special method."),ml.forEach(t),sg=h(_n),$(ps.$$.fragment,_n),ng=h(_n),$(hs.$$.fragment,_n),_n.forEach(t),Ut.forEach(t),Qp=h(o),uo=n(o,"H2",{class:!0});var Ch=r(uo);us=n(Ch,"A",{id:!0,class:!0,href:!0});var HT=r(us);sd=n(HT,"SPAN",{});var VT=r(sd);$(gr.$$.fragment,VT),VT.forEach(t),HT.forEach(t),rg=h(Ch),nd=n(Ch,"SPAN",{});var KT=r(nd);ag=i(KT,"DistilBertForTokenClassification"),KT.forEach(t),Ch.forEach(t),Rp=h(o),He=n(o,"DIV",{class:!0});var Ht=r(He);$(_r.$$.fragment,Ht),ig=h(Ht),rd=n(Ht,"P",{});var JT=r(rd);lg=i(JT,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),JT.forEach(t),dg=h(Ht),br=n(Ht,"P",{});var qh=r(br);cg=i(qh,"This model inherits from "),Ri=n(qh,"A",{href:!0});var GT=r(Ri);pg=i(GT,"PreTrainedModel"),GT.forEach(t),hg=i(qh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qh.forEach(t),ug=h(Ht),vr=n(Ht,"P",{});var Ph=r(vr);fg=i(Ph,"This model is also a PyTorch "),kr=n(Ph,"A",{href:!0,rel:!0});var XT=r(kr);mg=i(XT,"torch.nn.Module"),XT.forEach(t),gg=i(Ph,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ph.forEach(t),_g=h(Ht),Je=n(Ht,"DIV",{class:!0});var Vt=r(Je);$(Tr.$$.fragment,Vt),bg=h(Vt),fo=n(Vt,"P",{});var gl=r(fo);vg=i(gl,"The "),Ui=n(gl,"A",{href:!0});var YT=r(Ui);kg=i(YT,"DistilBertForTokenClassification"),YT.forEach(t),Tg=i(gl," forward method, overrides the "),ad=n(gl,"CODE",{});var ZT=r(ad);$g=i(ZT,"__call__"),ZT.forEach(t),wg=i(gl," special method."),gl.forEach(t),yg=h(Vt),$(fs.$$.fragment,Vt),Dg=h(Vt),$(ms.$$.fragment,Vt),Fg=h(Vt),$(gs.$$.fragment,Vt),Vt.forEach(t),Ht.forEach(t),Up=h(o),mo=n(o,"H2",{class:!0});var Ah=r(mo);_s=n(Ah,"A",{id:!0,class:!0,href:!0});var e$=r(_s);id=n(e$,"SPAN",{});var t$=r(id);$($r.$$.fragment,t$),t$.forEach(t),e$.forEach(t),Bg=h(Ah),ld=n(Ah,"SPAN",{});var o$=r(ld);xg=i(o$,"DistilBertForQuestionAnswering"),o$.forEach(t),Ah.forEach(t),Hp=h(o),Ve=n(o,"DIV",{class:!0});var Kt=r(Ve);$(wr.$$.fragment,Kt),Mg=h(Kt),go=n(Kt,"P",{});var _l=r(go);Eg=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),dd=n(_l,"CODE",{});var s$=r(dd);zg=i(s$,"span start logits"),s$.forEach(t),jg=i(_l," and "),cd=n(_l,"CODE",{});var n$=r(cd);Cg=i(n$,"span end logits"),n$.forEach(t),qg=i(_l,")."),_l.forEach(t),Pg=h(Kt),yr=n(Kt,"P",{});var Oh=r(yr);Ag=i(Oh,"This model inherits from "),Hi=n(Oh,"A",{href:!0});var r$=r(Hi);Og=i(r$,"PreTrainedModel"),r$.forEach(t),Ng=i(Oh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Oh.forEach(t),Lg=h(Kt),Dr=n(Kt,"P",{});var Nh=r(Dr);Sg=i(Nh,"This model is also a PyTorch "),Fr=n(Nh,"A",{href:!0,rel:!0});var a$=r(Fr);Ig=i(a$,"torch.nn.Module"),a$.forEach(t),Wg=i(Nh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nh.forEach(t),Qg=h(Kt),Ge=n(Kt,"DIV",{class:!0});var Jt=r(Ge);$(Br.$$.fragment,Jt),Rg=h(Jt),_o=n(Jt,"P",{});var bl=r(_o);Ug=i(bl,"The "),Vi=n(bl,"A",{href:!0});var i$=r(Vi);Hg=i(i$,"DistilBertForQuestionAnswering"),i$.forEach(t),Vg=i(bl," forward method, overrides the "),pd=n(bl,"CODE",{});var l$=r(pd);Kg=i(l$,"__call__"),l$.forEach(t),Jg=i(bl," special method."),bl.forEach(t),Gg=h(Jt),$(bs.$$.fragment,Jt),Xg=h(Jt),$(vs.$$.fragment,Jt),Yg=h(Jt),$(ks.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Vp=h(o),bo=n(o,"H2",{class:!0});var Lh=r(bo);Ts=n(Lh,"A",{id:!0,class:!0,href:!0});var d$=r(Ts);hd=n(d$,"SPAN",{});var c$=r(hd);$(xr.$$.fragment,c$),c$.forEach(t),d$.forEach(t),Zg=h(Lh),ud=n(Lh,"SPAN",{});var p$=r(ud);e_=i(p$,"TFDistilBertModel"),p$.forEach(t),Lh.forEach(t),Kp=h(o),Ae=n(o,"DIV",{class:!0});var $t=r(Ae);$(Mr.$$.fragment,$t),t_=h($t),fd=n($t,"P",{});var h$=r(fd);o_=i(h$,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),h$.forEach(t),s_=h($t),Er=n($t,"P",{});var Sh=r(Er);n_=i(Sh,"This model inherits from "),Ki=n(Sh,"A",{href:!0});var u$=r(Ki);r_=i(u$,"TFPreTrainedModel"),u$.forEach(t),a_=i(Sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sh.forEach(t),i_=h($t),zr=n($t,"P",{});var Ih=r(zr);l_=i(Ih,"This model is also a "),jr=n(Ih,"A",{href:!0,rel:!0});var f$=r(jr);d_=i(f$,"tf.keras.Model"),f$.forEach(t),c_=i(Ih,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),p_=h($t),$($s.$$.fragment,$t),h_=h($t),ft=n($t,"DIV",{class:!0});var bn=r(ft);$(Cr.$$.fragment,bn),u_=h(bn),vo=n(bn,"P",{});var vl=r(vo);f_=i(vl,"The "),Ji=n(vl,"A",{href:!0});var m$=r(Ji);m_=i(m$,"TFDistilBertModel"),m$.forEach(t),g_=i(vl," forward method, overrides the "),md=n(vl,"CODE",{});var g$=r(md);__=i(g$,"__call__"),g$.forEach(t),b_=i(vl," special method."),vl.forEach(t),v_=h(bn),$(ws.$$.fragment,bn),k_=h(bn),$(ys.$$.fragment,bn),bn.forEach(t),$t.forEach(t),Jp=h(o),ko=n(o,"H2",{class:!0});var Wh=r(ko);Ds=n(Wh,"A",{id:!0,class:!0,href:!0});var _$=r(Ds);gd=n(_$,"SPAN",{});var b$=r(gd);$(qr.$$.fragment,b$),b$.forEach(t),_$.forEach(t),T_=h(Wh),_d=n(Wh,"SPAN",{});var v$=r(_d);$_=i(v$,"TFDistilBertForMaskedLM"),v$.forEach(t),Wh.forEach(t),Gp=h(o),Oe=n(o,"DIV",{class:!0});var wt=r(Oe);$(Pr.$$.fragment,wt),w_=h(wt),Ar=n(wt,"P",{});var Qh=r(Ar);y_=i(Qh,"DistilBert Model with a "),bd=n(Qh,"CODE",{});var k$=r(bd);D_=i(k$,"masked language modeling"),k$.forEach(t),F_=i(Qh," head on top."),Qh.forEach(t),B_=h(wt),Or=n(wt,"P",{});var Rh=r(Or);x_=i(Rh,"This model inherits from "),Gi=n(Rh,"A",{href:!0});var T$=r(Gi);M_=i(T$,"TFPreTrainedModel"),T$.forEach(t),E_=i(Rh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rh.forEach(t),z_=h(wt),Nr=n(wt,"P",{});var Uh=r(Nr);j_=i(Uh,"This model is also a "),Lr=n(Uh,"A",{href:!0,rel:!0});var $$=r(Lr);C_=i($$,"tf.keras.Model"),$$.forEach(t),q_=i(Uh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uh.forEach(t),P_=h(wt),$(Fs.$$.fragment,wt),A_=h(wt),Xe=n(wt,"DIV",{class:!0});var Gt=r(Xe);$(Sr.$$.fragment,Gt),O_=h(Gt),To=n(Gt,"P",{});var kl=r(To);N_=i(kl,"The "),Xi=n(kl,"A",{href:!0});var w$=r(Xi);L_=i(w$,"TFDistilBertForMaskedLM"),w$.forEach(t),S_=i(kl," forward method, overrides the "),vd=n(kl,"CODE",{});var y$=r(vd);I_=i(y$,"__call__"),y$.forEach(t),W_=i(kl," special method."),kl.forEach(t),Q_=h(Gt),$(Bs.$$.fragment,Gt),R_=h(Gt),$(xs.$$.fragment,Gt),U_=h(Gt),$(Ms.$$.fragment,Gt),Gt.forEach(t),wt.forEach(t),Xp=h(o),$o=n(o,"H2",{class:!0});var Hh=r($o);Es=n(Hh,"A",{id:!0,class:!0,href:!0});var D$=r(Es);kd=n(D$,"SPAN",{});var F$=r(kd);$(Ir.$$.fragment,F$),F$.forEach(t),D$.forEach(t),H_=h(Hh),Td=n(Hh,"SPAN",{});var B$=r(Td);V_=i(B$,"TFDistilBertForSequenceClassification"),B$.forEach(t),Hh.forEach(t),Yp=h(o),Ne=n(o,"DIV",{class:!0});var yt=r(Ne);$(Wr.$$.fragment,yt),K_=h(yt),$d=n(yt,"P",{});var x$=r($d);J_=i(x$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),x$.forEach(t),G_=h(yt),Qr=n(yt,"P",{});var Vh=r(Qr);X_=i(Vh,"This model inherits from "),Yi=n(Vh,"A",{href:!0});var M$=r(Yi);Y_=i(M$,"TFPreTrainedModel"),M$.forEach(t),Z_=i(Vh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vh.forEach(t),eb=h(yt),Rr=n(yt,"P",{});var Kh=r(Rr);tb=i(Kh,"This model is also a "),Ur=n(Kh,"A",{href:!0,rel:!0});var E$=r(Ur);ob=i(E$,"tf.keras.Model"),E$.forEach(t),sb=i(Kh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kh.forEach(t),nb=h(yt),$(zs.$$.fragment,yt),rb=h(yt),Ye=n(yt,"DIV",{class:!0});var Xt=r(Ye);$(Hr.$$.fragment,Xt),ab=h(Xt),wo=n(Xt,"P",{});var Tl=r(wo);ib=i(Tl,"The "),Zi=n(Tl,"A",{href:!0});var z$=r(Zi);lb=i(z$,"TFDistilBertForSequenceClassification"),z$.forEach(t),db=i(Tl," forward method, overrides the "),wd=n(Tl,"CODE",{});var j$=r(wd);cb=i(j$,"__call__"),j$.forEach(t),pb=i(Tl," special method."),Tl.forEach(t),hb=h(Xt),$(js.$$.fragment,Xt),ub=h(Xt),$(Cs.$$.fragment,Xt),fb=h(Xt),$(qs.$$.fragment,Xt),Xt.forEach(t),yt.forEach(t),Zp=h(o),yo=n(o,"H2",{class:!0});var Jh=r(yo);Ps=n(Jh,"A",{id:!0,class:!0,href:!0});var C$=r(Ps);yd=n(C$,"SPAN",{});var q$=r(yd);$(Vr.$$.fragment,q$),q$.forEach(t),C$.forEach(t),mb=h(Jh),Dd=n(Jh,"SPAN",{});var P$=r(Dd);gb=i(P$,"TFDistilBertForMultipleChoice"),P$.forEach(t),Jh.forEach(t),eh=h(o),Le=n(o,"DIV",{class:!0});var Dt=r(Le);$(Kr.$$.fragment,Dt),_b=h(Dt),Fd=n(Dt,"P",{});var A$=r(Fd);bb=i(A$,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),A$.forEach(t),vb=h(Dt),Jr=n(Dt,"P",{});var Gh=r(Jr);kb=i(Gh,"This model inherits from "),el=n(Gh,"A",{href:!0});var O$=r(el);Tb=i(O$,"TFPreTrainedModel"),O$.forEach(t),$b=i(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh.forEach(t),wb=h(Dt),Gr=n(Dt,"P",{});var Xh=r(Gr);yb=i(Xh,"This model is also a "),Xr=n(Xh,"A",{href:!0,rel:!0});var N$=r(Xr);Db=i(N$,"tf.keras.Model"),N$.forEach(t),Fb=i(Xh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),Bb=h(Dt),$(As.$$.fragment,Dt),xb=h(Dt),mt=n(Dt,"DIV",{class:!0});var vn=r(mt);$(Yr.$$.fragment,vn),Mb=h(vn),Do=n(vn,"P",{});var $l=r(Do);Eb=i($l,"The "),tl=n($l,"A",{href:!0});var L$=r(tl);zb=i(L$,"TFDistilBertForMultipleChoice"),L$.forEach(t),jb=i($l," forward method, overrides the "),Bd=n($l,"CODE",{});var S$=r(Bd);Cb=i(S$,"__call__"),S$.forEach(t),qb=i($l," special method."),$l.forEach(t),Pb=h(vn),$(Os.$$.fragment,vn),Ab=h(vn),$(Ns.$$.fragment,vn),vn.forEach(t),Dt.forEach(t),th=h(o),Fo=n(o,"H2",{class:!0});var Yh=r(Fo);Ls=n(Yh,"A",{id:!0,class:!0,href:!0});var I$=r(Ls);xd=n(I$,"SPAN",{});var W$=r(xd);$(Zr.$$.fragment,W$),W$.forEach(t),I$.forEach(t),Ob=h(Yh),Md=n(Yh,"SPAN",{});var Q$=r(Md);Nb=i(Q$,"TFDistilBertForTokenClassification"),Q$.forEach(t),Yh.forEach(t),oh=h(o),Se=n(o,"DIV",{class:!0});var Ft=r(Se);$(ea.$$.fragment,Ft),Lb=h(Ft),Ed=n(Ft,"P",{});var R$=r(Ed);Sb=i(R$,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R$.forEach(t),Ib=h(Ft),ta=n(Ft,"P",{});var Zh=r(ta);Wb=i(Zh,"This model inherits from "),ol=n(Zh,"A",{href:!0});var U$=r(ol);Qb=i(U$,"TFPreTrainedModel"),U$.forEach(t),Rb=i(Zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),Ub=h(Ft),oa=n(Ft,"P",{});var eu=r(oa);Hb=i(eu,"This model is also a "),sa=n(eu,"A",{href:!0,rel:!0});var H$=r(sa);Vb=i(H$,"tf.keras.Model"),H$.forEach(t),Kb=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jb=h(Ft),$(Ss.$$.fragment,Ft),Gb=h(Ft),Ze=n(Ft,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xb=h(Yt),Bo=n(Yt,"P",{});var wl=r(Bo);Yb=i(wl,"The "),sl=n(wl,"A",{href:!0});var V$=r(sl);Zb=i(V$,"TFDistilBertForTokenClassification"),V$.forEach(t),ev=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var K$=r(zd);tv=i(K$,"__call__"),K$.forEach(t),ov=i(wl," special method."),wl.forEach(t),sv=h(Yt),$(Is.$$.fragment,Yt),nv=h(Yt),$(Ws.$$.fragment,Yt),rv=h(Yt),$(Qs.$$.fragment,Yt),Yt.forEach(t),Ft.forEach(t),sh=h(o),xo=n(o,"H2",{class:!0});var tu=r(xo);Rs=n(tu,"A",{id:!0,class:!0,href:!0});var J$=r(Rs);jd=n(J$,"SPAN",{});var G$=r(jd);$(ra.$$.fragment,G$),G$.forEach(t),J$.forEach(t),av=h(tu),Cd=n(tu,"SPAN",{});var X$=r(Cd);iv=i(X$,"TFDistilBertForQuestionAnswering"),X$.forEach(t),tu.forEach(t),nh=h(o),Ie=n(o,"DIV",{class:!0});var Bt=r(Ie);$(aa.$$.fragment,Bt),lv=h(Bt),Mo=n(Bt,"P",{});var yl=r(Mo);dv=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y$=r(qd);cv=i(Y$,"span start logits"),Y$.forEach(t),pv=i(yl," and "),Pd=n(yl,"CODE",{});var Z$=r(Pd);hv=i(Z$,"span end logits"),Z$.forEach(t),uv=i(yl,")."),yl.forEach(t),fv=h(Bt),ia=n(Bt,"P",{});var ou=r(ia);mv=i(ou,"This model inherits from "),nl=n(ou,"A",{href:!0});var ew=r(nl);gv=i(ew,"TFPreTrainedModel"),ew.forEach(t),_v=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),bv=h(Bt),la=n(Bt,"P",{});var su=r(la);vv=i(su,"This model is also a "),da=n(su,"A",{href:!0,rel:!0});var tw=r(da);kv=i(tw,"tf.keras.Model"),tw.forEach(t),Tv=i(su,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),su.forEach(t),$v=h(Bt),$(Us.$$.fragment,Bt),wv=h(Bt),et=n(Bt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yv=h(Zt),Eo=n(Zt,"P",{});var Dl=r(Eo);Dv=i(Dl,"The "),rl=n(Dl,"A",{href:!0});var ow=r(rl);Fv=i(ow,"TFDistilBertForQuestionAnswering"),ow.forEach(t),Bv=i(Dl," forward method, overrides the "),Ad=n(Dl,"CODE",{});var sw=r(Ad);xv=i(sw,"__call__"),sw.forEach(t),Mv=i(Dl," special method."),Dl.forEach(t),Ev=h(Zt),$(Hs.$$.fragment,Zt),zv=h(Zt),$(Vs.$$.fragment,Zt),jv=h(Zt),$(Ks.$$.fragment,Zt),Zt.forEach(t),Bt.forEach(t),rh=h(o),zo=n(o,"H2",{class:!0});var nu=r(zo);Js=n(nu,"A",{id:!0,class:!0,href:!0});var nw=r(Js);Od=n(nw,"SPAN",{});var rw=r(Od);$(pa.$$.fragment,rw),rw.forEach(t),nw.forEach(t),Cv=h(nu),Nd=n(nu,"SPAN",{});var aw=r(Nd);qv=i(aw,"FlaxDistilBertModel"),aw.forEach(t),nu.forEach(t),ah=h(o),Me=n(o,"DIV",{class:!0});var ot=r(Me);$(ha.$$.fragment,ot),Pv=h(ot),Ld=n(ot,"P",{});var iw=r(Ld);Av=i(iw,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),iw.forEach(t),Ov=h(ot),ua=n(ot,"P",{});var ru=r(ua);Nv=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var lw=r(al);Lv=i(lw,"FlaxPreTrainedModel"),lw.forEach(t),Sv=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Iv=h(ot),fa=n(ot,"P",{});var au=r(fa);Wv=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var dw=r(ma);Qv=i(dw,"flax.linen.Module"),dw.forEach(t),Rv=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(ot),Sd=n(ot,"P",{});var cw=r(Sd);Hv=i(cw,"Finally, this model supports inherent JAX features such as:"),cw.forEach(t),Vv=h(ot),Mt=n(ot,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var pw=r(Id);ga=n(pw,"A",{href:!0,rel:!0});var hw=r(ga);Kv=i(hw,"Just-In-Time (JIT) compilation"),hw.forEach(t),pw.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var uw=r(Wd);_a=n(uw,"A",{href:!0,rel:!0});var fw=r(_a);Gv=i(fw,"Automatic Differentiation"),fw.forEach(t),uw.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var mw=r(Qd);ba=n(mw,"A",{href:!0,rel:!0});var gw=r(ba);Yv=i(gw,"Vectorization"),gw.forEach(t),mw.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _w=r(Rd);va=n(_w,"A",{href:!0,rel:!0});var bw=r(va);e1=i(bw,"Parallelization"),bw.forEach(t),_w.forEach(t),kn.forEach(t),t1=h(ot),gt=n(ot,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),o1=h(Tn),jo=n(Tn,"P",{});var Fl=r(jo);s1=i(Fl,"The "),Ud=n(Fl,"CODE",{});var vw=r(Ud);n1=i(vw,"FlaxDistilBertPreTrainedModel"),vw.forEach(t),r1=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var kw=r(Hd);a1=i(kw,"__call__"),kw.forEach(t),i1=i(Fl," special method."),Fl.forEach(t),l1=h(Tn),$(Gs.$$.fragment,Tn),d1=h(Tn),$(Xs.$$.fragment,Tn),Tn.forEach(t),ot.forEach(t),ih=h(o),Co=n(o,"H2",{class:!0});var iu=r(Co);Ys=n(iu,"A",{id:!0,class:!0,href:!0});var Tw=r(Ys);Vd=n(Tw,"SPAN",{});var $w=r(Vd);$(Ta.$$.fragment,$w),$w.forEach(t),Tw.forEach(t),c1=h(iu),Kd=n(iu,"SPAN",{});var ww=r(Kd);p1=i(ww,"FlaxDistilBertForMaskedLM"),ww.forEach(t),iu.forEach(t),lh=h(o),Ee=n(o,"DIV",{class:!0});var st=r(Ee);$($a.$$.fragment,st),h1=h(st),wa=n(st,"P",{});var lu=r(wa);u1=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var yw=r(Jd);f1=i(yw,"language modeling"),yw.forEach(t),m1=i(lu," head on top."),lu.forEach(t),g1=h(st),ya=n(st,"P",{});var du=r(ya);_1=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var Dw=r(il);b1=i(Dw,"FlaxPreTrainedModel"),Dw.forEach(t),v1=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),k1=h(st),Da=n(st,"P",{});var cu=r(Da);T1=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var Fw=r(Fa);$1=i(Fw,"flax.linen.Module"),Fw.forEach(t),w1=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),y1=h(st),Gd=n(st,"P",{});var Bw=r(Gd);D1=i(Bw,"Finally, this model supports inherent JAX features such as:"),Bw.forEach(t),F1=h(st),Et=n(st,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var xw=r(Xd);Ba=n(xw,"A",{href:!0,rel:!0});var Mw=r(Ba);B1=i(Mw,"Just-In-Time (JIT) compilation"),Mw.forEach(t),xw.forEach(t),x1=h($n),Yd=n($n,"LI",{});var Ew=r(Yd);xa=n(Ew,"A",{href:!0,rel:!0});var zw=r(xa);M1=i(zw,"Automatic Differentiation"),zw.forEach(t),Ew.forEach(t),E1=h($n),Zd=n($n,"LI",{});var jw=r(Zd);Ma=n(jw,"A",{href:!0,rel:!0});var Cw=r(Ma);z1=i(Cw,"Vectorization"),Cw.forEach(t),jw.forEach(t),j1=h($n),ec=n($n,"LI",{});var qw=r(ec);Ea=n(qw,"A",{href:!0,rel:!0});var Pw=r(Ea);C1=i(Pw,"Parallelization"),Pw.forEach(t),qw.forEach(t),$n.forEach(t),q1=h(st),_t=n(st,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),P1=h(wn),qo=n(wn,"P",{});var Bl=r(qo);A1=i(Bl,"The "),tc=n(Bl,"CODE",{});var Aw=r(tc);O1=i(Aw,"FlaxDistilBertPreTrainedModel"),Aw.forEach(t),N1=i(Bl," forward method, overrides the "),oc=n(Bl,"CODE",{});var Ow=r(oc);L1=i(Ow,"__call__"),Ow.forEach(t),S1=i(Bl," special method."),Bl.forEach(t),I1=h(wn),$(Zs.$$.fragment,wn),W1=h(wn),$(en.$$.fragment,wn),wn.forEach(t),st.forEach(t),dh=h(o),Po=n(o,"H2",{class:!0});var pu=r(Po);tn=n(pu,"A",{id:!0,class:!0,href:!0});var Nw=r(tn);sc=n(Nw,"SPAN",{});var Lw=r(sc);$(ja.$$.fragment,Lw),Lw.forEach(t),Nw.forEach(t),Q1=h(pu),nc=n(pu,"SPAN",{});var Sw=r(nc);R1=i(Sw,"FlaxDistilBertForSequenceClassification"),Sw.forEach(t),pu.forEach(t),ch=h(o),ze=n(o,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),U1=h(nt),rc=n(nt,"P",{});var Iw=r(rc);H1=i(Iw,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Iw.forEach(t),V1=h(nt),qa=n(nt,"P",{});var hu=r(qa);K1=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var Ww=r(ll);J1=i(Ww,"FlaxPreTrainedModel"),Ww.forEach(t),G1=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),X1=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Y1=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Qw=r(Aa);Z1=i(Qw,"flax.linen.Module"),Qw.forEach(t),e2=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),t2=h(nt),ac=n(nt,"P",{});var Rw=r(ac);o2=i(Rw,"Finally, this model supports inherent JAX features such as:"),Rw.forEach(t),s2=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var Uw=r(ic);Oa=n(Uw,"A",{href:!0,rel:!0});var Hw=r(Oa);n2=i(Hw,"Just-In-Time (JIT) compilation"),Hw.forEach(t),Uw.forEach(t),r2=h(yn),lc=n(yn,"LI",{});var Vw=r(lc);Na=n(Vw,"A",{href:!0,rel:!0});var Kw=r(Na);a2=i(Kw,"Automatic Differentiation"),Kw.forEach(t),Vw.forEach(t),i2=h(yn),dc=n(yn,"LI",{});var Jw=r(dc);La=n(Jw,"A",{href:!0,rel:!0});var Gw=r(La);l2=i(Gw,"Vectorization"),Gw.forEach(t),Jw.forEach(t),d2=h(yn),cc=n(yn,"LI",{});var Xw=r(cc);Sa=n(Xw,"A",{href:!0,rel:!0});var Yw=r(Sa);c2=i(Yw,"Parallelization"),Yw.forEach(t),Xw.forEach(t),yn.forEach(t),p2=h(nt),bt=n(nt,"DIV",{class:!0});var Dn=r(bt);$(Ia.$$.fragment,Dn),h2=h(Dn),Ao=n(Dn,"P",{});var xl=r(Ao);u2=i(xl,"The "),pc=n(xl,"CODE",{});var Zw=r(pc);f2=i(Zw,"FlaxDistilBertPreTrainedModel"),Zw.forEach(t),m2=i(xl," forward method, overrides the "),hc=n(xl,"CODE",{});var ey=r(hc);g2=i(ey,"__call__"),ey.forEach(t),_2=i(xl," special method."),xl.forEach(t),b2=h(Dn),$(on.$$.fragment,Dn),v2=h(Dn),$(sn.$$.fragment,Dn),Dn.forEach(t),nt.forEach(t),ph=h(o),Oo=n(o,"H2",{class:!0});var fu=r(Oo);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var oy=r(uc);$(Wa.$$.fragment,oy),oy.forEach(t),ty.forEach(t),k2=h(fu),fc=n(fu,"SPAN",{});var sy=r(fc);T2=i(sy,"FlaxDistilBertForMultipleChoice"),sy.forEach(t),fu.forEach(t),hh=h(o),je=n(o,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$2=h(rt),mc=n(rt,"P",{});var ny=r(mc);w2=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
