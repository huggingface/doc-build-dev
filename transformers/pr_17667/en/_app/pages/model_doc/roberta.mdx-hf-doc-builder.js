...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17667/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17667/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17667/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17667/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u$=h(bt),dh=s(bt,"P",{});var d6=a(dh);g$=i(d6,"Finally, this model supports inherent JAX features such as:"),d6.forEach(t),_$=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var c6=a(ch);Hi=s(c6,"A",{href:!0,rel:!0});var p6=a(Hi);b$=i(p6,"Just-In-Time (JIT) compilation"),p6.forEach(t),c6.forEach(t),k$=h(ca),ph=s(ca,"LI",{});var h6=a(ph);Qi=s(h6,"A",{href:!0,rel:!0});var m6=a(Qi);v$=i(m6,"Automatic Differentiation"),m6.forEach(t),h6.forEach(t),T$=h(ca),hh=s(ca,"LI",{});var f6=a(hh);Ji=s(f6,"A",{href:!0,rel:!0});var u6=a(Ji);y$=i(u6,"Vectorization"),u6.forEach(t),f6.forEach(t),w$=h(ca),mh=s(ca,"LI",{});var g6=a(mh);Vi=s(g6,"A",{href:!0,rel:!0});var _6=a(Vi);$$=i(_6,"Parallelization"),_6.forEach(t),g6.forEach(t),ca.forEach(t),F$=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);y(Ki.$$.fragment,pa),x$=h(pa),nn=s(pa,"P",{});var rc=a(nn);R$=i(rc,"The "),fh=s(rc,"CODE",{});var b6=a(fh);M$=i(b6,"FlaxRobertaPreTrainedModel"),b6.forEach(t),E$=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var k6=a(uh);z$=i(k6,"__call__"),k6.forEach(t),q$=i(rc," special method."),rc.forEach(t),C$=h(pa),y(Ds.$$.fragment,pa),j$=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),Cf=h(o),sn=s(o,"H2",{class:!0});var Ju=a(sn);Ws=s(Ju,"A",{id:!0,class:!0,href:!0});var v6=a(Ws);gh=s(v6,"SPAN",{});var T6=a(gh);y(Gi.$$.fragment,T6),T6.forEach(t),v6.forEach(t),P$=h(Ju),_h=s(Ju,"SPAN",{});var y6=a(_h);L$=i(y6,"FlaxRobertaForSequenceClassification"),y6.forEach(t),Ju.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A$=h(kt),bh=s(kt,"P",{});var w6=a(bh);O$=i(w6,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),w6.forEach(t),N$=h(kt),Yi=s(kt,"P",{});var Vu=a(Yi);I$=i(Vu,"This model inherits from "),Ld=s(Vu,"A",{href:!0});var $6=a(Ld);D$=i($6,"FlaxPreTrainedModel"),$6.forEach(t),S$=i(Vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vu.forEach(t),W$=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);B$=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var F6=a(el);U$=i(F6,"flax.linen.Module"),F6.forEach(t),H$=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q$=h(kt),kh=s(kt,"P",{});var x6=a(kh);J$=i(x6,"Finally, this model supports inherent JAX features such as:"),x6.forEach(t),V$=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var R6=a(vh);tl=s(R6,"A",{href:!0,rel:!0});var M6=a(tl);K$=i(M6,"Just-In-Time (JIT) compilation"),M6.forEach(t),R6.forEach(t),G$=h(ha),Th=s(ha,"LI",{});var E6=a(Th);ol=s(E6,"A",{href:!0,rel:!0});var z6=a(ol);X$=i(z6,"Automatic Differentiation"),z6.forEach(t),E6.forEach(t),Y$=h(ha),yh=s(ha,"LI",{});var q6=a(yh);nl=s(q6,"A",{href:!0,rel:!0});var C6=a(nl);Z$=i(C6,"Vectorization"),C6.forEach(t),q6.forEach(t),e2=h(ha),wh=s(ha,"LI",{});var j6=a(wh);sl=s(j6,"A",{href:!0,rel:!0});var P6=a(sl);t2=i(P6,"Parallelization"),P6.forEach(t),j6.forEach(t),ha.forEach(t),o2=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);y(al.$$.fragment,ma),n2=h(ma),an=s(ma,"P",{});var ic=a(an);s2=i(ic,"The "),$h=s(ic,"CODE",{});var L6=a($h);a2=i(L6,"FlaxRobertaPreTrainedModel"),L6.forEach(t),r2=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var A6=a(Fh);i2=i(A6,"__call__"),A6.forEach(t),l2=i(ic," special method."),ic.forEach(t),d2=h(ma),y(Bs.$$.fragment,ma),c2=h(ma),y(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var O6=a(Hs);xh=s(O6,"SPAN",{});var N6=a(xh);y(rl.$$.fragment,N6),N6.forEach(t),O6.forEach(t),p2=h(Gu),Rh=s(Gu,"SPAN",{});var I6=a(Rh);h2=i(I6,"FlaxRobertaForMultipleChoice"),I6.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),m2=h(vt),Mh=s(vt,"P",{});var D6=a(Mh);f2=i(D6,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
