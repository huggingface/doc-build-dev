import{S as uy,i as my,s as fy,e as o,k as d,w as f,t as r,M as _y,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as p,y as g,q as T,o as k,B as v}from"../../chunks/vendor-4833417e.js";import{T as zt}from"../../chunks/Tip-fffd6df1.js";import{D as M}from"../../chunks/Docstring-4f315ed9.js";import{C as R}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ke}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function gy(I){let u,x,b,y,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),y=r("Module"),z=r(`
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16017/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16017/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16017/src/transformers/models/t5/modeling_t5.py#L1308"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Ws=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16017/src/transformers/models/t5/modeling_t5.py#L1503"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Whether or not to return a <a href="/docs/transformers/pr_16017/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16017/src/transformers/models/t5/modeling_t5.py#L1779"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16017/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16017/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16017/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16017/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16017/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16017/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16017/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
`),rr=s(tt,"A",{href:!0});var J1=a(rr);Wh=i(J1,"T5Tokenizer"),J1.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(It),Ai=s(It,"P",{});var X1=a(Ai);Vh=i(X1,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),X1.forEach(t),Kh=l(It),_(Eo.$$.fragment,It),Yh=l(It),qo=s(It,"P",{});var Hc=a(qo);Zh=i(Hc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=s(Hc,"A",{href:!0,rel:!0});var Q1=a(jo);Jh=i(Q1,"run_t5_mlm_flax.py"),Q1.forEach(t),Xh=i(Hc,` script in the Examples
...
(`),Zo=s(wt,"A",{href:!0,rel:!0});var Qb=a(Zo);Rm=i(Qb,"PyTorch"),Qb.forEach(t),Hm=i(wt," and "),Jo=s(wt,"A",{href:!0,rel:!0});var e5=a(Jo);Vm=i(e5,"Tensorflow"),e5.forEach(t),Km=i(wt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),wt.forEach(t),Yb.forEach(t),Xc.forEach(t),kc=l(n),on=s(n,"H2",{class:!0});var Qc=a(on);In=s(Qc,"A",{id:!0,class:!0,href:!0});var t5=a(In);fd=s(t5,"SPAN",{});var n5=a(fd);_(Xo.$$.fragment,n5),n5.forEach(t),t5.forEach(t),Ym=l(Qc),_d=s(Qc,"SPAN",{});var o5=a(_d);Zm=i(o5,"T5Config"),o5.forEach(t),Qc.forEach(t),vc=l(n),yt=s(n,"DIV",{class:!0});var Rr=a(yt);_(Qo.$$.fragment,Rr),Jm=l(Rr),$t=s(Rr,"P",{});var ho=a($t);Xm=i(ho,"This is the configuration class to store the configuration of a "),mr=s(ho,"A",{href:!0});var s5=a(mr);Qm=i(s5,"T5Model"),s5.forEach(t),ef=i(ho," or a "),fr=s(ho,"A",{href:!0});var a5=a(fr);tf=i(a5,"TFT5Model"),a5.forEach(t),nf=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
documentation from `),gr=s(Hr,"A",{href:!0});var d5=a(gr);cf=i(d5,"PretrainedConfig"),d5.forEach(t),pf=i(Hr," for more information."),Hr.forEach(t),Rr.forEach(t),bc=l(n),an=s(n,"H2",{class:!0});var ep=a(an);Ln=s(ep,"A",{id:!0,class:!0,href:!0});var l5=a(Ln);gd=s(l5,"SPAN",{});var c5=a(gd);_(ts.$$.fragment,c5),c5.forEach(t),l5.forEach(t),hf=l(ep),Td=s(ep,"SPAN",{});var p5=a(Td);uf=i(p5,"T5Tokenizer"),p5.forEach(t),ep.forEach(t),wc=l(n),ie=s(n,"DIV",{class:!0});var st=a(ie);_(ns.$$.fragment,st),mf=l(st),os=s(st,"P",{});var tp=a(os);ff=i(tp,"Construct a T5 tokenizer. Based on "),ss=s(tp,"A",{href:!0,rel:!0});var h5=a(ss);_f=i(h5,"SentencePiece"),h5.forEach(t),gf=i(tp,"."),tp.forEach(t),Tf=l(st),as=s(st,"P",{});var np=a(as);kf=i(np,"This tokenizer inherits from "),Tr=s(np,"A",{href:!0});var u5=a(Tr);vf=i(u5,"PreTrainedTokenizer"),u5.forEach(t),bf=i(np,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),np.forEach(t),wf=l(st),jt=s(st,"DIV",{class:!0});var Vr=a(jt);_(rs.$$.fragment,Vr),yf=l(Vr),kd=s(Vr,"P",{});var m5=a(kd);$f=i(m5,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
special tokens using the tokenizer `),wd=s(ap,"CODE",{});var g5=a(wd);Af=i(g5,"prepare_for_model"),g5.forEach(t),Nf=i(ap," method."),ap.forEach(t),sp.forEach(t),If=l(st),Sn=s(st,"DIV",{class:!0});var rp=a(Sn);_(cs.$$.fragment,rp),Lf=l(rp),yd=s(rp,"P",{});var T5=a(yd);Df=i(T5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),T5.forEach(t),rp.forEach(t),Sf=l(st),br=s(st,"DIV",{class:!0});var k5=a(br);_(ps.$$.fragment,k5),k5.forEach(t),st.forEach(t),yc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);On=s(ip,"A",{id:!0,class:!0,href:!0});var v5=a(On);$d=s(v5,"SPAN",{});var b5=a($d);_(hs.$$.fragment,b5),b5.forEach(t),v5.forEach(t),Of=l(ip),zd=s(ip,"SPAN",{});var w5=a(zd);Gf=i(w5,"T5TokenizerFast"),w5.forEach(t),ip.forEach(t),$c=l(n),Se=s(n,"DIV",{class:!0});var Dt=a(Se);_(us.$$.fragment,Dt),Bf=l(Dt),dn=s(Dt,"P",{});var Kr=a(dn);Uf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),xd=s(Kr,"EM",{});var y5=a(xd);Wf=i(y5,"tokenizers"),y5.forEach(t),Rf=i(Kr,` library). Based on
`),ms=s(Kr,"A",{href:!0,rel:!0});var $5=a(ms);Hf=i($5,"Unigram"),$5.forEach(t),Vf=i(Kr,"."),Kr.forEach(t),Kf=l(Dt),fs=s(Dt,"P",{});var dp=a(fs);Yf=i(dp,"This tokenizer inherits from "),wr=s(dp,"A",{href:!0});var z5=a(wr);Zf=i(z5,"PreTrainedTokenizerFast"),z5.forEach(t),Jf=i(dp,` which contains most of the main methods. Users should
...
adding special tokens. A sequence has the following format:`),x5.forEach(t),t_=l(Yr),gs=s(Yr,"UL",{});var lp=a(gs);yr=s(lp,"LI",{});var Zv=a(yr);n_=i(Zv,"single sequence: "),qd=s(Zv,"CODE",{});var E5=a(qd);o_=i(E5,"X </s>"),E5.forEach(t),Zv.forEach(t),s_=l(lp),$r=s(lp,"LI",{});var Jv=a($r);a_=i(Jv,"pair of sequences: "),jd=s(Jv,"CODE",{});var q5=a(jd);r_=i(q5,"A </s> B </s>"),q5.forEach(t),Jv.forEach(t),lp.forEach(t),Yr.forEach(t),i_=l(Dt),Gn=s(Dt,"DIV",{class:!0});var cp=a(Gn);_(Ts.$$.fragment,cp),d_=l(cp),Fd=s(cp,"P",{});var j5=a(Fd);l_=i(j5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),j5.forEach(t),cp.forEach(t),Dt.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Bn=s(pp,"A",{id:!0,class:!0,href:!0});var F5=a(Bn);Md=s(F5,"SPAN",{});var M5=a(Md);_(ks.$$.fragment,M5),M5.forEach(t),F5.forEach(t),c_=l(pp),Pd=s(pp,"SPAN",{});var P5=a(Pd);p_=i(P5,"T5Model"),P5.forEach(t),pp.forEach(t),xc=l(n),J=s(n,"DIV",{class:!0});var $e=a(J);_(vs.$$.fragment,$e),h_=l($e),Cd=s($e,"P",{});var C5=a(Cd);u_=i(C5,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),C5.forEach(t),m_=l($e),bs=s($e,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ws=s(hp,"A",{href:!0,rel:!0});var A5=a(ws);__=i(A5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),A5.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l($e),ys=s($e,"P",{});var up=a(ys);k_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var N5=a(zr);v_=i(N5,"PreTrainedModel"),N5.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),w_=l($e),$s=s($e,"P",{});var mp=a($s);y_=i(mp,"This model is also a PyTorch "),zs=s(mp,"A",{href:!0,rel:!0});var I5=a(zs);$_=i(I5,"torch.nn.Module"),I5.forEach(t),z_=i(mp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),x_=l($e),We=s($e,"DIV",{class:!0});var St=a(We);_(xs.$$.fragment,St),E_=l(St),cn=s(St,"P",{});var Zr=a(cn);q_=i(Zr,"The "),xr=s(Zr,"A",{href:!0});var L5=a(xr);j_=i(L5,"T5Model"),L5.forEach(t),F_=i(Zr," forward method, overrides the "),Ad=s(Zr,"CODE",{});var D5=a(Ad);M_=i(D5,"__call__"),D5.forEach(t),P_=i(Zr," special method."),Zr.forEach(t),C_=l(St),_(Un.$$.fragment,St),A_=l(St),Nd=s(St,"P",{});var S5=a(Nd);N_=i(S5,"Example:"),S5.forEach(t),I_=l(St),_(Es.$$.fragment,St),St.forEach(t),L_=l($e),Re=s($e,"DIV",{class:!0});var Ot=a(Re);_(qs.$$.fragment,Ot),D_=l(Ot),Id=s(Ot,"P",{});var O5=a(Id);S_=i(O5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),O5.forEach(t),O_=l(Ot),Ld=s(Ot,"P",{});var G5=a(Ld);G_=i(G5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),G5.forEach(t),B_=l(Ot),Dd=s(Ot,"P",{});var B5=a(Dd);U_=i(B5,"Example:"),B5.forEach(t),W_=l(Ot),_(js.$$.fragment,Ot),Ot.forEach(t),R_=l($e),kt=s($e,"DIV",{class:!0});var uo=a(kt);_(Fs.$$.fragment,uo),H_=l(uo),Sd=s(uo,"P",{});var U5=a(Sd);V_=i(U5,"Moves the model to cpu from a model parallel state."),U5.forEach(t),K_=l(uo),Od=s(uo,"P",{});var W5=a(Od);Y_=i(W5,"Example:"),W5.forEach(t),Z_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),$e.forEach(t),Ec=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Wn=s(fp,"A",{id:!0,class:!0,href:!0});var R5=a(Wn);Gd=s(R5,"SPAN",{});var H5=a(Gd);_(Ps.$$.fragment,H5),H5.forEach(t),R5.forEach(t),J_=l(fp),Bd=s(fp,"SPAN",{});var V5=a(Bd);X_=i(V5,"T5ForConditionalGeneration"),V5.forEach(t),fp.forEach(t),qc=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),As=s(ze,"P",{});var _p=a(As);eg=i(_p,"T5 Model with a "),Ud=s(_p,"CODE",{});var K5=a(Ud);tg=i(K5,"language modeling"),K5.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),Ns=s(ze,"P",{});var gp=a(Ns);sg=i(gp,"The T5 model was proposed in "),Is=s(gp,"A",{href:!0,rel:!0});var Y5=a(Is);ag=i(Y5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Y5.forEach(t),rg=i(gp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),gp.forEach(t),ig=l(ze),Ls=s(ze,"P",{});var Tp=a(Ls);dg=i(Tp,"This model inherits from "),Er=s(Tp,"A",{href:!0});var Z5=a(Er);lg=i(Z5,"PreTrainedModel"),Z5.forEach(t),cg=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
