...
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/pr_18034/en/model_doc/nezha#transformers.NezhaModel">NezhaModel</a>.`,name:"vocab_size"},{anchor:"transformers.NezhaConfig.embedding_size",description:`<strong>embedding_size</strong> (<code>int</code>, optional, defaults to 128) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18034/src/transformers/models/nezha/modeling_nezha.py#L903",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18034/en/model_doc/nezha#transformers.NezhaConfig"
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18034/src/transformers/models/nezha/modeling_nezha.py#L1060",returnDescription:`
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18034/src/transformers/models/nezha/modeling_nezha.py#L1170",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18034/src/transformers/models/nezha/modeling_nezha.py#L1263",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18034/src/transformers/models/nezha/modeling_nezha.py#L1372",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18034/src/transformers/models/nezha/modeling_nezha.py#L1470",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18034/src/transformers/models/nezha/modeling_nezha.py#L1567",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18034/src/transformers/models/nezha/modeling_nezha.py#L1646",returnDescription:`
<p>A <a
