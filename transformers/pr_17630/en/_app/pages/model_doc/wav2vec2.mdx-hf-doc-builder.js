...
above for more information.`),P.forEach(t),this.h()},h(){m(f,"href","/docs/transformers/pr_17630/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(D,P){_(D,c,P),e(c,b),e(c,f),e(f,h),e(c,v),e(c,l),e(l,u),e(c,j)},d(D){D&&t(c)}}}function yy(W){let c,b,f,h,v,l,u,j,D,P,C,A,O,H;return{c(){c=a("p"),b=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),{c(){w(c.$$.fragment)},l(f){y(c.$$.fragment,f)},m(f,h){k(c,f,h),b=!0},p:fe,i(f){b||(T(c.$$.fragment,f),b=!0)},o(f){$(c.$$.fragment,f),b=!1},d(f){x(c,f)}}}function qy(W){let c,b,f,h,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){_(l,c,u),e(c,b),e(c,f),e(f,h),e(c,v)},d(l){l&&t(c)}}}function Py(W){let c,b,f,h,v;return h=new ue({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForAudioFrameClassification
from datasets import load_dataset
import torch
...
first positional argument :`),qe.forEach(t),Se=p(V),z=s(V,"UL",{});var X=n(z);I=s(X,"LI",{});var G=n(I);Fe=i(G,"a single Tensor with "),ve=s(G,"CODE",{});var At=n(ve);Re=i(At,"input_values"),At.forEach(t),Ce=i(G," only and nothing else: "),oe=s(G,"CODE",{});var mt=n(oe);lt=i(mt,"model(inputs_ids)"),mt.forEach(t),G.forEach(t),He=p(X),L=s(X,"LI",{});var Te=n(L);ct=i(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(Te,"CODE",{});var xt=n(de);pe=i(xt,"model([input_values, attention_mask])"),xt.forEach(t),Ne=i(Te," or "),be=s(Te,"CODE",{});var J=n(be);dt=i(J,"model([input_values, attention_mask, token_type_ids])"),J.forEach(t),Te.forEach(t),we=p(X),ae=s(X,"LI",{});var $e=n(ae);Ee=i($e,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=s($e,"CODE",{});var Ot=n(ye);pt=i(Ot,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ot.forEach(t),$e.forEach(t),X.forEach(t)},m(V,E){_(V,c,E),e(c,b),_(V,f,E),_(V,h,E),e(h,v),e(v,l),e(h,u),e(h,j),e(j,D),_(V,P,E),_(V,C,E),e(C,A),e(C,O),e(O,H),e(C,S),e(C,q),e(q,je),e(C,ge),_(V,B,E),_(V,U,E),e(U,_e),_(V,Se,E),_(V,z,E),e(z,I),e(I,Fe),e(I,ve),e(ve,Re),e(I,Ce),e(I,oe),e(oe,lt),e(z,He),e(z,L),e(L,ct),e(L,de),e(de,pe),e(L,Ne),e(L,be),e(be,dt),e(z,we),e(z,ae),e(ae,Ee),e(ae,ye),e(ye,pt)},d(V){V&&t(c),V&&t(f),V&&t(h),V&&t(P),V&&t(C),V&&t(B),V&&t(U),V&&t(Se),V&&t(z)}}}function Iy(W){let c,b,f,h,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){_(l,c,u),e(c,b),e(c,f),e(f,h),e(c,v)},d(l){l&&t(c)}}}function Ry(W){let c,b,f,h,v;return h=new ue({props:{code:`from transformers import Wav2Vec2Processor, FlaxWav2Vec2Model
from datasets import load_dataset
import soundfile as sf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>hidden_states = model(input_values).last_hidden_state`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(h.$$.fragment)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Example:"),u.forEach(t),f=p(l),y(h.$$.fragment,l)},m(l,u){_(l,c,u),e(c,b),_(l,f,u),k(h,l,u),v=!0},p:fe,i(l){v||(T(h.$$.fragment,l),v=!0)},o(l){$(h.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(h,l)}}}function Hy(W){let c,b,f,h,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># show that cosine similarity is much higher than random</span>
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> np.asarray(cosine_sim)[mask_time_indices].mean() &gt; <span class="hljs-number">0.5</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(h.$$.fragment)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Example:"),u.forEach(t),f=p(l),y(h.$$.fragment,l)},m(l,u){_(l,c,u),e(c,b),_(l,f,u),k(h,l,u),v=!0},p:fe,i(l){v||(T(h.$$.fragment,l),v=!0)},o(l){$(h.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(h,l)}}}function Zy(W){let c,b,f,h,v,l,u,j,D,P,C,A,O,H,S,q,je,ge,B,U,_e,Se,z,I,Fe,ve,Re,Ce,oe,lt,He,L,ct,de,pe,Ne,be,dt,we,ae,Ee,ye,pt,V,E,Ie,Be,Mt,se,$t,ke,qe,X,G,At,mt,Te,xt,J,$e,Ot,Lt,am,Sr,sm,nm,Ga,rm,im,lm,Dt,cm,Nr,dm,pm,Ir,mm,hm,fm,To,sd,St,$o,Qi,Ja,um,Yi,gm,nd,Z,Za,_m,el,vm,bm,Ka,wm,Br,ym,km,Tm,xo,Qa,$m,tl,xm,Wm,Ur,Ya,Vm,Xe,es,jm,ol,Fm,Cm,ts,Em,al,qm,Pm,zm,Wo,Mm,Vo,os,Am,sl,Om,rd,Nt,jo,nl,as,Lm,rl,Dm,id,Ue,ss,Sm,il,Nm,Im,ns,Bm,Rr,Um,Rm,Hm,Fo,rs,Xm,ll,Gm,ld,It,Co,cl,is,Jm,dl,Zm,cd,M,ls,Km,pl,Qm,Ym,Pe,Hr,eh,th,Xr,oh,ah,Gr,sh,nh,cs,ml,rh,ih,lh,Jr,ch,dh,ph,Eo,ds,mh,ht,hh,ps,hl,fh,uh,gh,Zr,_h,vh,ms,fl,bh,wh,yh,kh,qo,hs,Th,ft,$h,Kr,xh,Wh,Qr,Vh,jh,Yr,Fh,Ch,Eh,ei,fs,qh,Wt,us,Ph,gs,zh,ti,Mh,Ah,Oh,Po,Lh,zo,_s,Dh,vs,Sh,oi,Nh,Ih,Bh,Mo,bs,Uh,ws,Rh,ai,Hh,Xh,Gh,Ao,ys,Jh,ul,Zh,dd,Bt,Oo,gl,ks,Kh,_l,Qh,pd,N,Ts,Yh,vl,ef,tf,Lo,$s,of,ut,af,xs,bl,sf,nf,rf,si,lf,cf,Ws,wl,df,pf,mf,hf,Do,Vs,ff,gt,uf,ni,gf,_f,ri,vf,bf,ii,wf,yf,kf,Vt,js,Tf,Fs,$f,li,xf,Wf,Vf,So,jf,ci,Cs,Ff,jt,Es,Cf,yl,Ef,qf,No,Pf,Ft,qs,zf,kl,Mf,Af,Io,Of,Bo,Ps,Lf,Tl,Df,md,Ut,Uo,$l,zs,Sf,xl,Nf,hd,Rt,Ms,If,As,Bf,Wl,Uf,Rf,fd,Ht,Os,Hf,Vl,Xf,ud,Xt,Ls,Gf,Ds,Jf,di,Zf,Kf,gd,_t,Ss,Qf,Ns,Yf,jl,eu,tu,ou,Ro,Is,au,Fl,su,_d,vt,Bs,nu,Us,ru,Cl,iu,lu,cu,Ho,Rs,du,El,pu,vd,Gt,Xo,ql,Hs,mu,Pl,hu,bd,xe,Xs,fu,Gs,uu,Js,gu,_u,vu,Zs,bu,pi,wu,yu,ku,Ks,Tu,Qs,$u,xu,Wu,Ge,Ys,Vu,Jt,ju,mi,Fu,Cu,zl,Eu,qu,Pu,Go,zu,Jo,wd,Zt,Zo,Ml,en,Mu,Al,Au,yd,We,tn,Ou,Kt,Lu,Ol,Du,Su,on,Nu,Iu,Bu,an,Uu,hi,Ru,Hu,Xu,sn,Gu,nn,Ju,Zu,Ku,ze,rn,Qu,Qt,Yu,fi,eg,tg,Ll,og,ag,sg,Ko,ng,Qo,rg,Yo,kd,Yt,ea,Dl,ln,ig,Sl,lg,Td,ne,cn,cg,Nl,dg,pg,dn,mg,pn,hg,fg,ug,mn,gg,ui,_g,vg,bg,hn,wg,fn,yg,kg,Tg,Me,un,$g,eo,xg,gi,Wg,Vg,Il,jg,Fg,Cg,ta,Eg,oa,qg,aa,$d,to,sa,Bl,gn,Pg,Ul,zg,xd,re,_n,Mg,Rl,Ag,Og,vn,Lg,bn,Dg,Sg,Ng,wn,Ig,_i,Bg,Ug,Rg,yn,Hg,kn,Xg,Gg,Jg,Je,Tn,Zg,oo,Kg,vi,Qg,Yg,Hl,e_,t_,o_,na,a_,ra,Wd,ao,ia,Xl,$n,s_,Gl,n_,Vd,ie,xn,r_,Jl,i_,l_,Wn,c_,Vn,d_,p_,m_,jn,h_,bi,f_,u_,g_,Fn,__,Cn,v_,b_,w_,Ze,En,y_,so,k_,wi,T_,$_,Zl,x_,W_,V_,la,j_,ca,jd,no,da,Kl,qn,F_,Ql,C_,Fd,Ve,Pn,E_,ro,q_,Yl,P_,z_,zn,M_,A_,O_,Mn,L_,yi,D_,S_,N_,An,I_,On,B_,U_,R_,Ke,Ln,H_,io,X_,ki,G_,J_,ec,Z_,K_,Q_,pa,Y_,ma,Cd,lo,ha,tc,Dn,ev,oc,tv,Ed,le,Sn,ov,ac,av,sv,Nn,nv,Ti,rv,iv,lv,In,cv,Bn,dv,pv,mv,fa,hv,Qe,Un,fv,co,uv,$i,gv,_v,sc,vv,bv,wv,ua,yv,ga,qd,po,_a,nc,Rn,kv,rc,Tv,Pd,ce,Hn,$v,Xn,xv,ic,Wv,Vv,jv,Gn,Fv,xi,Cv,Ev,qv,Jn,Pv,Zn,zv,Mv,Av,va,Ov,Ye,Kn,Lv,mo,Dv,Wi,Sv,Nv,lc,Iv,Bv,Uv,ba,Rv,wa,zd,ho,ya,cc,Qn,Hv,dc,Xv,Md,K,Yn,Gv,er,Jv,tr,Zv,Kv,Qv,or,Yv,Vi,e2,t2,o2,ar,a2,sr,s2,n2,r2,pc,i2,l2,bt,mc,nr,c2,d2,hc,rr,p2,m2,fc,ir,h2,f2,uc,lr,u2,g2,et,cr,_2,fo,v2,gc,b2,w2,_c,y2,k2,T2,ka,$2,Ta,Ad,uo,$a,vc,dr,x2,bc,W2,Od,Q,pr,V2,go,j2,wc,F2,C2,mr,E2,q2,P2,hr,z2,ji,M2,A2,O2,fr,L2,ur,D2,S2,N2,yc,I2,B2,wt,kc,gr,U2,R2,Tc,_r,H2,X2,$c,vr,G2,J2,xc,br,Z2,K2,tt,wr,Q2,_o,Y2,Wc,eb,tb,Vc,ob,ab,sb,xa,nb,Wa,Ld,vo,Va,jc,yr,rb,Fc,ib,Dd,Y,kr,lb,bo,cb,Cc,db,pb,Tr,mb,hb,fb,$r,ub,Fi,gb,_b,vb,xr,bb,Wr,wb,yb,kb,Ec,Tb,$b,yt,qc,Vr,xb,Wb,Pc,jr,Vb,jb,zc,Fr,Fb,Cb,Mc,Cr,Eb,qb,ot,Er,Pb,wo,zb,Ci,Mb,Ab,Ac,Ob,Lb,Db,ja,Sb,Fa,Sd;return l=new ee({}),H=new ee({}),G=new ee({}),$e=new F({props:{name:"class transformers.Wav2Vec2Config",anchor:"transformers.Wav2Vec2Config",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"feat_quantizer_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"num_codevectors_per_group",val:" = 320"},{name:"num_codevector_groups",val:" = 2"},{name:"contrastive_logits_temperature",val:" = 0.1"},{name:"num_negatives",val:" = 100"},{name:"codevector_dim",val:" = 256"},{name:"proj_codevector_dim",val:" = 256"},{name:"diversity_loss_weight",val:" = 0.1"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"tdnn_dim",val:" = (512, 512, 512, 512, 1500)"},{name:"tdnn_kernel",val:" = (5, 3, 3, 1, 1)"},{name:"tdnn_dilation",val:" = (1, 2, 3, 1, 1)"},{name:"xvector_output_dim",val:" = 512"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"add_adapter",val:" = False"},{name:"adapter_kernel_size",val:" = 3"},{name:"adapter_stride",val:" = 2"},{name:"num_adapter_layers",val:" = 3"},{name:"output_hidden_size",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
Vocabulary size of the Wav2Vec2 model. Defines the number of different tokens that can be represented by
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a> or <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.TFWav2Vec2Model">TFWav2Vec2Model</a>. Vocabulary size of the
model. Defines the different tokens that can be represented by the <em>inputs_ids</em> passed to the forward
method of <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Model">Wav2Vec2Model</a>.`,name:"vocab_size"},{anchor:"transformers.Wav2Vec2Config.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
instance of <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.Wav2Vec2CTCTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17630/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17630/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/tokenization_utils_base.py#L2409",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L490",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L420",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_17630/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),is=new ee({}),ls=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_17630/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),ds=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/processing_wav2vec2.py#L66"}}),hs=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/processing_wav2vec2.py#L75"}}),fs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/processing_wav2vec2.py#L47"}}),us=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_17630/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_17630/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_17630/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
Whether or not to return a <a href="/docs/transformers/pr_17630/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1266",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.modeling_outputs.Wav2Vec2BaseModelOutput"
>transformers.modeling_outputs.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1630",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1719"}}),un=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1764",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1886",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
`}}),na=new me({props:{$$slots:{default:[qy]},$$scope:{ctx:W}}}),ra=new he({props:{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.example",$$slots:{default:[Py]},$$scope:{ctx:W}}}),$n=new ee({}),xn=new F({props:{name:"class transformers.Wav2Vec2ForXVector",anchor:"transformers.Wav2Vec2ForXVector",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2004"}}),En=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2066",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/main_classes/output#transformers.modeling_outputs.XVectorOutput"
...
`}}),la=new me({props:{$$slots:{default:[zy]},$$scope:{ctx:W}}}),ca=new he({props:{anchor:"transformers.Wav2Vec2ForXVector.forward.example",$$slots:{default:[My]},$$scope:{ctx:W}}}),qn=new ee({}),Pn=new F({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1329"}}),Ln=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"mask_time_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"sampled_negative_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1390",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1452"}}),fa=new me({props:{$$slots:{default:[Ly]},$$scope:{ctx:W}}}),Un=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17630/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17630/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17630/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
`}}),ua=new me({props:{$$slots:{default:[Dy]},$$scope:{ctx:W}}}),ga=new he({props:{anchor:"transformers.TFWav2Vec2Model.call.example",$$slots:{default:[Sy]},$$scope:{ctx:W}}}),Rn=new ee({}),Hn=new F({props:{name:"class transformers.TFWav2Vec2ForCTC",anchor:"transformers.TFWav2Vec2ForCTC",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1555"}}),va=new me({props:{$$slots:{default:[Ny]},$$scope:{ctx:W}}}),Kn=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17630/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17630/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1582",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
`}}),ba=new me({props:{$$slots:{default:[Iy]},$$scope:{ctx:W}}}),wa=new he({props:{anchor:"transformers.TFWav2Vec2ForCTC.call.example",$$slots:{default:[By]},$$scope:{ctx:W}}}),Qn=new ee({}),Yn=new F({props:{name:"class transformers.FlaxWav2Vec2Model",anchor:"transformers.FlaxWav2Vec2Model",parameters:[{name:"config",val:": Wav2Vec2Config"},{name:"input_shape",val:": typing.Tuple = (1, 1024)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxWav2Vec2Model.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1058"}}),cr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17630/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17630/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
`}}),xa=new me({props:{$$slots:{default:[Hy]},$$scope:{ctx:W}}}),Wa=new he({props:{anchor:"transformers.FlaxWav2Vec2ForCTC.__call__.example",$$slots:{default:[Xy]},$$scope:{ctx:W}}}),yr=new ee({}),kr=new F({props:{name:"class transformers.FlaxWav2Vec2ForPreTraining",anchor:"transformers.FlaxWav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"},{name:"input_shape",val:": typing.Tuple = (1, 1024)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_17630/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322"}}),Er=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/pr_17630/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17630/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1325",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17630/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
`}}),ja=new me({props:{$$slots:{default:[Gy]},$$scope:{ctx:W}}}),Fa=new he({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[Jy]},$$scope:{ctx:W}}}),{c(){c=a("meta"),b=d(),f=a("h1"),h=a("a"),v=a("span"),w(l.$$.fragment),u=d(),j=a("span"),D=r("Wav2Vec2"),P=d(),C=a("h2"),A=a("a"),O=a("span"),w(H.$$.fragment),S=d(),q=a("span"),je=r("Overview"),ge=d(),B=a("p"),U=r("The Wav2Vec2 model was proposed in "),_e=a("a"),Se=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),z=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),I=d(),Fe=a("p"),ve=r("The abstract from the paper is the following:"),Re=d(),Ce=a("p"),oe=a("em"),lt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
processor.`),Ym=d(),Pe=a("p"),Hr=a("a"),eh=r("Wav2Vec2Processor"),th=r(" offers all the functionalities of "),Xr=a("a"),oh=r("Wav2Vec2FeatureExtractor"),ah=r(" and "),Gr=a("a"),sh=r("PreTrainedTokenizer"),nh=r(`.
...
`),ms=a("a"),fl=a("strong"),bh=r("call"),wh=r("()"),yh=r(". Please refer to the docstring of the above two methods for more information."),kh=d(),qo=a("div"),w(hs.$$.fragment),Th=d(),ft=a("p"),$h=r(`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
...
`),Yr=a("a"),Fh=r("pad()"),Ch=r(". Please refer to the docstring of the above two methods for more information."),Eh=d(),ei=a("div"),w(fs.$$.fragment),qh=d(),Wt=a("div"),w(us.$$.fragment),Ph=d(),gs=a("p"),zh=r(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),ti=a("a"),Mh=r("from_pretrained()"),Ah=r(" method."),Oh=d(),w(Po.$$.fragment),Lh=d(),zo=a("div"),w(_s.$$.fragment),Dh=d(),vs=a("p"),Sh=r("This method forwards all its arguments to PreTrainedTokenizer\u2019s "),oi=a("a"),Nh=r("batch_decode()"),Ih=r(`. Please
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Tg=d(),Me=a("div"),w(un.$$.fragment),$g=d(),eo=a("p"),xg=r("The "),gi=a("a"),Wg=r("Wav2Vec2ForSequenceClassification"),Vg=r(" forward method, overrides the "),Il=a("code"),jg=r("__call__"),Fg=r(" special method."),Cg=d(),w(ta.$$.fragment),Eg=d(),w(oa.$$.fragment),qg=d(),w(aa.$$.fragment),$d=d(),to=a("h2"),sa=a("a"),Bl=a("span"),w(gn.$$.fragment),Pg=d(),Ul=a("span"),zg=r("Wav2Vec2ForAudioFrameClassification"),xd=d(),re=a("div"),w(_n.$$.fragment),Mg=d(),Rl=a("p"),Ag=r("Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),Og=d(),vn=a("p"),Lg=r("Wav2Vec2 was proposed in "),bn=a("a"),Dg=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),w_=d(),Ze=a("div"),w(En.$$.fragment),y_=d(),so=a("p"),k_=r("The "),wi=a("a"),T_=r("Wav2Vec2ForXVector"),$_=r(" forward method, overrides the "),Zl=a("code"),x_=r("__call__"),W_=r(" special method."),V_=d(),w(la.$$.fragment),j_=d(),w(ca.$$.fragment),jd=d(),no=a("h2"),da=a("a"),Kl=a("span"),w(qn.$$.fragment),F_=d(),Ql=a("span"),C_=r("Wav2Vec2ForPreTraining"),Fd=d(),Ve=a("div"),w(Pn.$$.fragment),E_=d(),ro=a("p"),q_=r("Wav2Vec2 Model with a quantizer and "),Yl=a("code"),P_=r("VQ"),z_=r(` head on top.
...
Representations`),q2=r(` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),P2=d(),hr=a("p"),z2=r("This model inherits from "),ji=a("a"),M2=r("FlaxPreTrainedModel"),A2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),kb=d(),Ec=a("p"),Tb=r("Finally, this model supports inherent JAX features such as:"),$b=d(),yt=a("ul"),qc=a("li"),Vr=a("a"),xb=r("Just-In-Time (JIT) compilation"),Wb=d(),Pc=a("li"),jr=a("a"),Vb=r("Automatic Differentiation"),jb=d(),zc=a("li"),Fr=a("a"),Fb=r("Vectorization"),Cb=d(),Mc=a("li"),Cr=a("a"),Eb=r("Parallelization"),qb=d(),ot=a("div"),w(Er.$$.fragment),Pb=d(),wo=a("p"),zb=r("The "),Ci=a("a"),Mb=r("FlaxWav2Vec2ForPreTraining"),Ab=r(" forward method, overrides the "),Ac=a("code"),Ob=r("__call__"),Lb=r(" special method."),Db=d(),w(ja.$$.fragment),Sb=d(),w(Fa.$$.fragment),this.h()},l(o){const g=gy('[data-svelte="svelte-1phssyn"]',document.head);c=s(g,"META",{name:!0,content:!0}),g.forEach(t),b=p(o),f=s(o,"H1",{class:!0});var qr=n(f);h=s(qr,"A",{id:!0,class:!0,href:!0});var Oc=n(h);v=s(Oc,"SPAN",{});var Lc=n(v);y(l.$$.fragment,Lc),Lc.forEach(t),Oc.forEach(t),u=p(qr),j=s(qr,"SPAN",{});var Dc=n(j);D=i(Dc,"Wav2Vec2"),Dc.forEach(t),qr.forEach(t),P=p(o),C=s(o,"H2",{class:!0});var Pr=n(C);A=s(Pr,"A",{id:!0,class:!0,href:!0});var Sc=n(A);O=s(Sc,"SPAN",{});var Nc=n(O);y(H.$$.fragment,Nc),Nc.forEach(t),Sc.forEach(t),S=p(Pr),q=s(Pr,"SPAN",{});var Ic=n(q);je=i(Ic,"Overview"),Ic.forEach(t),Pr.forEach(t),ge=p(o),B=s(o,"P",{});var zr=n(B);U=i(zr,"The Wav2Vec2 model was proposed in "),_e=s(zr,"A",{href:!0,rel:!0});var Bc=n(_e);Se=i(Bc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Bc.forEach(t),z=i(zr," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),zr.forEach(t),I=p(o),Fe=s(o,"P",{});var Uc=n(Fe);ve=i(Uc,"The abstract from the paper is the following:"),Uc.forEach(t),Re=p(o),Ce=s(o,"P",{});var Rc=n(Ce);oe=s(Rc,"EM",{});var Hc=n(oe);lt=i(Hc,`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
transcribed speech can outperform the best semi-supervised methods while being conceptually simpler. wav2vec 2.0 masks
the speech input in the latent space and solves a contrastive task defined over a quantization of the latent
representations which are jointly learned. Experiments using all labeled data of Librispeech achieve 1.8/3.3 WER on the
clean/other test sets. When lowering the amount of labeled data to one hour, wav2vec 2.0 outperforms the previous state
...
processor.`),pw.forEach(t),Ym=p(R),Pe=s(R,"P",{});var Tt=n(Pe);Hr=s(Tt,"A",{href:!0});var mw=n(Hr);eh=i(mw,"Wav2Vec2Processor"),mw.forEach(t),th=i(Tt," offers all the functionalities of "),Xr=s(Tt,"A",{href:!0});var hw=n(Xr);oh=i(hw,"Wav2Vec2FeatureExtractor"),hw.forEach(t),ah=i(Tt," and "),Gr=s(Tt,"A",{href:!0});var fw=n(Gr);sh=i(fw,"PreTrainedTokenizer"),fw.forEach(t),nh=i(Tt,`.
See the docstring of `),cs=s(Tt,"A",{href:!0});var Nb=n(cs);ml=s(Nb,"STRONG",{});var uw=n(ml);rh=i(uw,"call"),uw.forEach(t),ih=i(Nb,"()"),Nb.forEach(t),lh=i(Tt," and "),Jr=s(Tt,"A",{href:!0});var gw=n(Jr);ch=i(gw,"decode()"),gw.forEach(t),dh=i(Tt," for more information."),Tt.forEach(t),ph=p(R),Eo=s(R,"DIV",{class:!0});var Jd=n(Eo);y(ds.$$.fragment,Jd),mh=p(Jd),ht=s(Jd,"P",{});var qa=n(ht);hh=i(qa,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),ps=s(qa,"A",{href:!0});var Ib=n(ps);hl=s(Ib,"STRONG",{});var _w=n(hl);fh=i(_w,"call"),_w.forEach(t),uh=i(Ib,"()"),Ib.forEach(t),gh=i(qa,` and returns its output. If used in the context
`),Zr=s(qa,"A",{href:!0});var vw=n(Zr);_h=i(vw,"as_target_processor()"),vw.forEach(t),vh=i(qa,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),ms=s(qa,"A",{href:!0});var Bb=n(ms);fl=s(Bb,"STRONG",{});var bw=n(fl);bh=i(bw,"call"),bw.forEach(t),wh=i(Bb,"()"),Bb.forEach(t),yh=i(qa,". Please refer to the docstring of the above two methods for more information."),qa.forEach(t),Jd.forEach(t),kh=p(R),qo=s(R,"DIV",{class:!0});var Zd=n(qo);y(hs.$$.fragment,Zd),Th=p(Zd),ft=s(Zd,"P",{});var Pa=n(ft);$h=i(Pa,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),Kr=s(Pa,"A",{href:!0});var ww=n(Kr);xh=i(ww,"pad()"),ww.forEach(t),Wh=i(Pa,` and returns its output. If used in the context
`),Qr=s(Pa,"A",{href:!0});var yw=n(Qr);Vh=i(yw,"as_target_processor()"),yw.forEach(t),jh=i(Pa,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Yr=s(Pa,"A",{href:!0});var kw=n(Yr);Fh=i(kw,"pad()"),kw.forEach(t),Ch=i(Pa,". Please refer to the docstring of the above two methods for more information."),Pa.forEach(t),Zd.forEach(t),Eh=p(R),ei=s(R,"DIV",{class:!0});var Tw=n(ei);y(fs.$$.fragment,Tw),Tw.forEach(t),qh=p(R),Wt=s(R,"DIV",{class:!0});var Ei=n(Wt);y(us.$$.fragment,Ei),Ph=p(Ei),gs=s(Ei,"P",{});var Kd=n(gs);zh=i(Kd,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),ti=s(Kd,"A",{href:!0});var $w=n(ti);Mh=i($w,"from_pretrained()"),$w.forEach(t),Ah=i(Kd," method."),Kd.forEach(t),Oh=p(Ei),y(Po.$$.fragment,Ei),Ei.forEach(t),Lh=p(R),zo=s(R,"DIV",{class:!0});var Qd=n(zo);y(_s.$$.fragment,Qd),Dh=p(Qd),vs=s(Qd,"P",{});var Yd=n(vs);Sh=i(Yd,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),oi=s(Yd,"A",{href:!0});var xw=n(oi);Nh=i(xw,"batch_decode()"),xw.forEach(t),Ih=i(Yd,`. Please
...
`),xs=s(za,"A",{href:!0});var Ub=n(xs);bl=s(Ub,"STRONG",{});var qw=n(bl);sf=i(qw,"call"),qw.forEach(t),nf=i(Ub,"()"),Ub.forEach(t),rf=i(za,` and returns its output. If used in the context
`),si=s(za,"A",{href:!0});var Pw=n(si);lf=i(Pw,"as_target_processor()"),Pw.forEach(t),cf=i(za,` this method forwards all its arguments to
...
Auli.`),Li.forEach(t),Bu=p(Et),an=s(Et,"P",{});var Tp=n(an);Uu=i(Tp,"This model inherits from "),hi=s(Tp,"A",{href:!0});var m0=n(hi);Ru=i(m0,"PreTrainedModel"),m0.forEach(t),Hu=i(Tp,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Ku=p(Et),ze=s(Et,"DIV",{class:!0});var qt=n(ze);y(rn.$$.fragment,qt),Qu=p(qt),Qt=s(qt,"P",{});var Di=n(Qt);Yu=i(Di,"The "),fi=s(Di,"A",{href:!0});var f0=n(fi);eg=i(f0,"Wav2Vec2ForCTC"),f0.forEach(t),tg=i(Di," forward method, overrides the "),Ll=s(Di,"CODE",{});var u0=n(Ll);og=i(u0,"__call__"),u0.forEach(t),ag=i(Di," special method."),Di.forEach(t),sg=p(qt),y(Ko.$$.fragment,qt),ng=p(qt),y(Qo.$$.fragment,qt),rg=p(qt),y(Yo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),kd=p(o),Yt=s(o,"H2",{class:!0});var xp=n(Yt);ea=s(xp,"A",{id:!0,class:!0,href:!0});var g0=n(ea);Dl=s(g0,"SPAN",{});var _0=n(Dl);y(ln.$$.fragment,_0),_0.forEach(t),g0.forEach(t),ig=p(xp),Sl=s(xp,"SPAN",{});var v0=n(Sl);lg=i(v0,"Wav2Vec2ForSequenceClassification"),v0.forEach(t),xp.forEach(t),Td=p(o),ne=s(o,"DIV",{class:!0});var at=n(ne);y(cn.$$.fragment,at),cg=p(at),Nl=s(at,"P",{});var b0=n(Nl);dg=i(b0,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jp.forEach(t),Tg=p(at),Me=s(at,"DIV",{class:!0});var Pt=n(Me);y(un.$$.fragment,Pt),$g=p(Pt),eo=s(Pt,"P",{});var Si=n(eo);xg=i(Si,"The "),gi=s(Si,"A",{href:!0});var T0=n(gi);Wg=i(T0,"Wav2Vec2ForSequenceClassification"),T0.forEach(t),Vg=i(Si," forward method, overrides the "),Il=s(Si,"CODE",{});var $0=n(Il);jg=i($0,"__call__"),$0.forEach(t),Fg=i(Si," special method."),Si.forEach(t),Cg=p(Pt),y(ta.$$.fragment,Pt),Eg=p(Pt),y(oa.$$.fragment,Pt),qg=p(Pt),y(aa.$$.fragment,Pt),Pt.forEach(t),at.forEach(t),$d=p(o),to=s(o,"H2",{class:!0});var Fp=n(to);sa=s(Fp,"A",{id:!0,class:!0,href:!0});var x0=n(sa);Bl=s(x0,"SPAN",{});var W0=n(Bl);y(gn.$$.fragment,W0),W0.forEach(t),x0.forEach(t),Pg=p(Fp),Ul=s(Fp,"SPAN",{});var V0=n(Ul);zg=i(V0,"Wav2Vec2ForAudioFrameClassification"),V0.forEach(t),Fp.forEach(t),xd=p(o),re=s(o,"DIV",{class:!0});var st=n(re);y(_n.$$.fragment,st),Mg=p(st),Rl=s(st,"P",{});var j0=n(Rl);Ag=i(j0,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),j0.forEach(t),Og=p(st),vn=s(st,"P",{});var Cp=n(vn);Lg=i(Cp,"Wav2Vec2 was proposed in "),bn=s(Cp,"A",{href:!0,rel:!0});var F0=n(bn);Dg=i(F0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
library implements for all its model (such as downloading or saving etc.).`),Ep.forEach(t),Rg=p(st),yn=s(st,"P",{});var qp=n(yn);Hg=i(qp,"This model is a PyTorch "),kn=s(qp,"A",{href:!0,rel:!0});var E0=n(kn);Xg=i(E0,"torch.nn.Module"),E0.forEach(t),Gg=i(qp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qp.forEach(t),Jg=p(st),Je=s(st,"DIV",{class:!0});var Oa=n(Je);y(Tn.$$.fragment,Oa),Zg=p(Oa),oo=s(Oa,"P",{});var Ni=n(oo);Kg=i(Ni,"The "),vi=s(Ni,"A",{href:!0});var q0=n(vi);Qg=i(q0,"Wav2Vec2ForAudioFrameClassification"),q0.forEach(t),Yg=i(Ni," forward method, overrides the "),Hl=s(Ni,"CODE",{});var P0=n(Hl);e_=i(P0,"__call__"),P0.forEach(t),t_=i(Ni," special method."),Ni.forEach(t),o_=p(Oa),y(na.$$.fragment,Oa),a_=p(Oa),y(ra.$$.fragment,Oa),Oa.forEach(t),st.forEach(t),Wd=p(o),ao=s(o,"H2",{class:!0});var Pp=n(ao);ia=s(Pp,"A",{id:!0,class:!0,href:!0});var z0=n(ia);Xl=s(z0,"SPAN",{});var M0=n(Xl);y($n.$$.fragment,M0),M0.forEach(t),z0.forEach(t),s_=p(Pp),Gl=s(Pp,"SPAN",{});var A0=n(Gl);n_=i(A0,"Wav2Vec2ForXVector"),A0.forEach(t),Pp.forEach(t),Vd=p(o),ie=s(o,"DIV",{class:!0});var nt=n(ie);y(xn.$$.fragment,nt),r_=p(nt),Jl=s(nt,"P",{});var O0=n(Jl);i_=i(O0,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),O0.forEach(t),l_=p(nt),Wn=s(nt,"P",{});var zp=n(Wn);c_=i(zp,"Wav2Vec2 was proposed in "),Vn=s(zp,"A",{href:!0,rel:!0});var L0=n(Vn);d_=i(L0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ap.forEach(t),w_=p(nt),Ze=s(nt,"DIV",{class:!0});var La=n(Ze);y(En.$$.fragment,La),y_=p(La),so=s(La,"P",{});var Ii=n(so);k_=i(Ii,"The "),wi=s(Ii,"A",{href:!0});var N0=n(wi);T_=i(N0,"Wav2Vec2ForXVector"),N0.forEach(t),$_=i(Ii," forward method, overrides the "),Zl=s(Ii,"CODE",{});var I0=n(Zl);x_=i(I0,"__call__"),I0.forEach(t),W_=i(Ii," special method."),Ii.forEach(t),V_=p(La),y(la.$$.fragment,La),j_=p(La),y(ca.$$.fragment,La),La.forEach(t),nt.forEach(t),jd=p(o),no=s(o,"H2",{class:!0});var Op=n(no);da=s(Op,"A",{id:!0,class:!0,href:!0});var B0=n(da);Kl=s(B0,"SPAN",{});var U0=n(Kl);y(qn.$$.fragment,U0),U0.forEach(t),B0.forEach(t),F_=p(Op),Ql=s(Op,"SPAN",{});var R0=n(Ql);C_=i(R0,"Wav2Vec2ForPreTraining"),R0.forEach(t),Op.forEach(t),Fd=p(o),Ve=s(o,"DIV",{class:!0});var zt=n(Ve);y(Pn.$$.fragment,zt),E_=p(zt),ro=s(zt,"P",{});var Bi=n(ro);q_=i(Bi,"Wav2Vec2 Model with a quantizer and "),Yl=s(Bi,"CODE",{});var H0=n(Yl);P_=i(H0,"VQ"),H0.forEach(t),z_=i(Bi,` head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ip.forEach(t),mv=p(rt),y(fa.$$.fragment,rt),hv=p(rt),Qe=s(rt,"DIV",{class:!0});var Sa=n(Qe);y(Un.$$.fragment,Sa),fv=p(Sa),co=s(Sa,"P",{});var Ri=n(co);uv=i(Ri,"The "),$i=s(Ri,"A",{href:!0});var s1=n($i);gv=i(s1,"TFWav2Vec2Model"),s1.forEach(t),_v=i(Ri," forward method, overrides the "),sc=s(Ri,"CODE",{});var n1=n(sc);vv=i(n1,"__call__"),n1.forEach(t),bv=i(Ri," special method."),Ri.forEach(t),wv=p(Sa),y(ua.$$.fragment,Sa),yv=p(Sa),y(ga.$$.fragment,Sa),Sa.forEach(t),rt.forEach(t),qd=p(o),po=s(o,"H2",{class:!0});var Bp=n(po);_a=s(Bp,"A",{id:!0,class:!0,href:!0});var r1=n(_a);nc=s(r1,"SPAN",{});var i1=n(nc);y(Rn.$$.fragment,i1),i1.forEach(t),r1.forEach(t),kv=p(Bp),rc=s(Bp,"SPAN",{});var l1=n(rc);Tv=i(l1,"TFWav2Vec2ForCTC"),l1.forEach(t),Bp.forEach(t),Pd=p(o),ce=s(o,"DIV",{class:!0});var it=n(ce);y(Hn.$$.fragment,it),$v=p(it),Xn=s(it,"P",{});var Up=n(Xn);xv=i(Up,"TFWav2Vec2 Model with a "),ic=s(Up,"CODE",{});var c1=n(ic);Wv=i(c1,"language modeling"),c1.forEach(t),Vv=i(Up," head on top for Connectionist Temporal Classification (CTC)."),Up.forEach(t),jv=p(it),Gn=s(it,"P",{});var Rp=n(Gn);Fv=i(Rp,"This model inherits from "),xi=s(Rp,"A",{href:!0});var d1=n(xi);Cv=i(d1,"TFPreTrainedModel"),d1.forEach(t),Ev=i(Rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp.forEach(t),qv=p(it),Jn=s(it,"P",{});var Hp=n(Jn);Pv=i(Hp,"This model is also a "),Zn=s(Hp,"A",{href:!0,rel:!0});var p1=n(Zn);zv=i(p1,"tf.keras.Model"),p1.forEach(t),Mv=i(Hp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp.forEach(t),Av=p(it),y(va.$$.fragment,it),Ov=p(it),Ye=s(it,"DIV",{class:!0});var Na=n(Ye);y(Kn.$$.fragment,Na),Lv=p(Na),mo=s(Na,"P",{});var Hi=n(mo);Dv=i(Hi,"The "),Wi=s(Hi,"A",{href:!0});var m1=n(Wi);Sv=i(m1,"TFWav2Vec2ForCTC"),m1.forEach(t),Nv=i(Hi," forward method, overrides the "),lc=s(Hi,"CODE",{});var h1=n(lc);Iv=i(h1,"__call__"),h1.forEach(t),Bv=i(Hi," special method."),Hi.forEach(t),Uv=p(Na),y(ba.$$.fragment,Na),Rv=p(Na),y(wa.$$.fragment,Na),Na.forEach(t),it.forEach(t),zd=p(o),ho=s(o,"H2",{class:!0});var Xp=n(ho);ya=s(Xp,"A",{id:!0,class:!0,href:!0});var f1=n(ya);cc=s(f1,"SPAN",{});var u1=n(cc);y(Qn.$$.fragment,u1),u1.forEach(t),f1.forEach(t),Hv=p(Xp),dc=s(Xp,"SPAN",{});var g1=n(dc);Xv=i(g1,"FlaxWav2Vec2Model"),g1.forEach(t),Xp.forEach(t),Md=p(o),K=s(o,"DIV",{class:!0});var Oe=n(K);y(Yn.$$.fragment,Oe),Gv=p(Oe),er=s(Oe,"P",{});var Gp=n(er);Jv=i(Gp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Representations`),M1.forEach(t),q2=i(Gi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Gi.forEach(t),P2=p(Le),hr=s(Le,"P",{});var Qp=n(hr);z2=i(Qp,"This model inherits from "),ji=s(Qp,"A",{href:!0});var A1=n(ji);M2=i(A1,"FlaxPreTrainedModel"),A1.forEach(t),A2=i(Qp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
