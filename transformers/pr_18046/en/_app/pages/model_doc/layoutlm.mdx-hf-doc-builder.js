import{S as lh,i as dh,s as ch,e as a,k as c,w as L,t as n,M as ph,c as r,d as t,m as p,a as i,x as w,h as s,b as u,G as e,g as f,y as T,q as v,o as M,B as $,v as uh,L as Et}from"../../chunks/vendor-hf-doc-builder.js";import{T as Qe}from"../../chunks/Tip-hf-doc-builder.js";import{D as _e}from"../../chunks/Docstring-hf-doc-builder.js";import{C as tt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as De}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as zt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function hh(E){let d,k,_,h,b;return h=new tt({props:{code:`from transformers import LayoutLMModel, LayoutLMConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:Et,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function mh(E){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
...
first positional argument :`),$e.forEach(t),Q=p(g),F=r(g,"UL",{});var O=i(F);q=r(O,"LI",{});var K=i(q);le=s(K,"a single Tensor with "),W=r(K,"CODE",{});var xe=i(W);V=s(xe,"input_ids"),xe.forEach(t),ee=s(K," only and nothing else: "),H=r(K,"CODE",{});var ye=i(H);te=s(ye,"model(inputs_ids)"),ye.forEach(t),K.forEach(t),de=p(O),C=r(O,"LI",{});var P=i(C);ce=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(P,"CODE",{});var ze=i(U);pe=s(ze,"model([input_ids, attention_mask])"),ze.forEach(t),oe=s(P," or "),R=r(P,"CODE",{});var ke=i(R);ue=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),P.forEach(t),he=p(O),N=r(O,"LI",{});var ge=i(N);me=s(ge,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(ge,"CODE",{});var Ee=i(B);fe=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),ge.forEach(t),O.forEach(t)},m(g,x){f(g,d,x),e(d,k),f(g,_,x),f(g,h,x),e(h,b),e(b,l),e(h,m),e(h,j),e(j,re),f(g,Y,x),f(g,z,x),e(z,ae),e(z,I),e(I,Z),e(z,ne),e(z,A),e(A,ie),e(z,se),f(g,J,x),f(g,D,x),e(D,G),f(g,Q,x),f(g,F,x),e(F,q),e(q,le),e(q,W),e(W,V),e(q,ee),e(q,H),e(H,te),e(F,de),e(F,C),e(C,ce),e(C,U),e(U,pe),e(C,oe),e(C,R),e(R,ue),e(F,he),e(F,N),e(N,me),e(N,B),e(B,fe)},d(g){g&&t(d),g&&t(_),g&&t(h),g&&t(Y),g&&t(z),g&&t(J),g&&t(D),g&&t(Q),g&&t(F)}}}function Th(E){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(m,"CODE",{});var j=i(_);h=s(j,"Module"),j.forEach(t),b=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){f(l,d,m),e(d,k),e(d,_),e(_,h),e(d,b)},d(l){l&&t(d)}}}function vh(E){let d,k,_,h,b;return h=new tt({props:{code:`from transformers import LayoutLMTokenizer, TFLayoutLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:Et,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function Mh(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,W,V,ee,H,te,de,C,ce,U,pe,oe,R,ue,he,N,me,B,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),W=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),H=a("code"),te=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),oe=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),N=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),_=p(g),h=r(g,"UL",{});var X=i(h);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(t),m=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),X.forEach(t),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(t),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:Et,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function jh(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,W,V,ee,H,te,de,C,ce,U,pe,oe,R,ue,he,N,me,B,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),W=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),H=a("code"),te=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),oe=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),N=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),_=p(g),h=r(g,"UL",{});var X=i(h);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(t),m=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),X.forEach(t),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(t),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:Et,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function Eh(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,W,V,ee,H,te,de,C,ce,U,pe,oe,R,ue,he,N,me,B,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),W=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),H=a("code"),te=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),oe=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),N=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),_=p(g),h=r(g,"UL",{});var X=i(h);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(t),m=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),X.forEach(t),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(t),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),w(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),T(h,l,m),b=!0},p:Et,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function Ph(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,W,V,ee,H,te,de,C,ce,U,pe,oe,R,ue,he,N,me,B,fe,g,x,X,je,Me,S,be,Fe,$e,O,K,xe,ye,P,ze,ke,ge,Ee,Qn,Wr,Hr,Os,Rr,Kr,xo,Vr,Xr,jo,Yr,Zr,Da,Fo,Aa,ot,Gr,Is,Jr,Qr,Ds,ei,ti,Ua,zo,Ba,es,et,oi,ts,ni,si,Eo,ai,ri,qo,ii,li,Wa,nt,di,Co,ci,pi,Po,ui,hi,Ha,rt,qt,As,No,mi,Us,fi,Ra,Pe,So,gi,it,_i,os,yi,bi,Oo,ki,Li,wi,lt,Ti,ns,vi,Mi,ss,$i,xi,ji,Ct,Ka,dt,Pt,Bs,Io,Fi,Ws,zi,Va,Ne,Do,Ei,Hs,qi,Ci,Nt,as,Pi,Ni,rs,Si,Oi,Ii,Ao,Di,is,Ai,Ui,Xa,ct,St,Rs,Uo,Bi,Ks,Wi,Ya,Se,Bo,Hi,Vs,Ri,Ki,Ot,ls,Vi,Xi,ds,Yi,Zi,Gi,Wo,Ji,cs,Qi,el,Za,pt,It,Xs,Ho,tl,Ys,ol,Ga,Oe,Ro,nl,Ko,sl,Vo,al,rl,il,Xo,ll,Yo,dl,cl,pl,Ae,Zo,ul,ut,hl,ps,ml,fl,Zs,gl,_l,yl,Dt,bl,At,Ja,ht,Ut,Gs,Go,kl,Js,Ll,Qa,Ie,Jo,wl,mt,Tl,Qs,vl,Ml,Qo,$l,xl,jl,en,Fl,tn,zl,El,ql,Ue,on,Cl,ft,Pl,us,Nl,Sl,ea,Ol,Il,Dl,Bt,Al,Wt,er,gt,Ht,ta,nn,Ul,oa,Bl,tr,qe,sn,Wl,an,Hl,rn,Rl,Kl,Vl,ln,Xl,dn,Yl,Zl,Gl,cn,Jl,pn,Ql,ed,td,Be,un,od,_t,nd,hs,sd,ad,na,rd,id,ld,Rt,dd,Kt,or,yt,Vt,sa,hn,cd,aa,pd,nr,Ce,mn,ud,bt,hd,fn,md,fd,gn,gd,_d,yd,_n,bd,yn,kd,Ld,wd,bn,Td,kn,vd,Md,$d,We,Ln,xd,kt,jd,ms,Fd,zd,ra,Ed,qd,Cd,Xt,Pd,Yt,sr,Lt,Zt,ia,wn,Nd,la,Sd,ar,Le,Tn,Od,da,Id,Dd,vn,Ad,fs,Ud,Bd,Wd,Mn,Hd,$n,Rd,Kd,Vd,Gt,Xd,He,xn,Yd,wt,Zd,gs,Gd,Jd,ca,Qd,ec,tc,Jt,oc,Qt,rr,Tt,eo,pa,jn,nc,ua,sc,ir,we,Fn,ac,zn,rc,ha,ic,lc,dc,En,cc,_s,pc,uc,hc,qn,mc,Cn,fc,gc,_c,to,yc,Re,Pn,bc,vt,kc,ys,Lc,wc,ma,Tc,vc,Mc,oo,$c,no,lr,Mt,so,fa,Nn,xc,ga,jc,dr,Te,Sn,Fc,_a,zc,Ec,On,qc,bs,Cc,Pc,Nc,In,Sc,Dn,Oc,Ic,Dc,ao,Ac,Ke,An,Uc,$t,Bc,ks,Wc,Hc,ya,Rc,Kc,Vc,ro,Xc,io,cr,xt,lo,ba,Un,Yc,ka,Zc,pr,ve,Bn,Gc,La,Jc,Qc,Wn,ep,Ls,tp,op,np,Hn,sp,Rn,ap,rp,ip,co,lp,Ve,Kn,dp,jt,cp,ws,pp,up,wa,hp,mp,fp,po,gp,uo,ur;return l=new De({}),A=new De({}),Fo=new tt({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/pr_18046/en/model_doc/layoutlm#transformers.LayoutLMModel">LayoutLMModel</a>.`,name:"vocab_size"},{anchor:"transformers.LayoutLMConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
If set to <code>True</code>, the model will return a <a href="/docs/transformers/pr_18046/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_layoutlm.py#L729",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18046/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18046/en/model_doc/layoutlm#transformers.LayoutLMConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_layoutlm.py#L870",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18046/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_layoutlm.py#L994",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18046/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18046/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_layoutlm.py#L1117"}}),Ln=new _e({props:{name:"forward",anchor:"transformers.LayoutLMForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18046/en/model_doc/layoutlm#transformers.LayoutLMTokenizer">LayoutLMTokenizer</a>. See <a href="/docs/transformers/pr_18046/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18046/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_layoutlm.py#L1131",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18046/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L910",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18046/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1032",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18046/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1155",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18046/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18046/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1285",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18046/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
(from 93.07 to 94.42).`),$e=c(),O=a("p"),K=n("Tips:"),xe=c(),ye=a("ul"),P=a("li"),ze=n("In addition to "),ke=a("em"),ge=n("input_ids"),Ee=n(", "),Qn=a("a"),Wr=n("forward()"),Hr=n(" also expects the input "),Os=a("code"),Rr=n("bbox"),Kr=n(`, which are
...
scale. To normalize, you can use the following function:`),Da=c(),L(Fo.$$.fragment),Aa=c(),ot=a("p"),Gr=n("Here, "),Is=a("code"),Jr=n("width"),Qr=n(" and "),Ds=a("code"),ei=n("height"),ti=n(` correspond to the width and height of the original document in which the token
...
`),Oo=a("a"),ki=n("microsoft/layoutlm-base-uncased"),Li=n(" architecture."),wi=c(),lt=a("p"),Ti=n("Configuration objects inherit from "),ns=a("a"),vi=n("BertConfig"),Mi=n(` and can be used to control the model outputs. Read the
documentation from `),ss=a("a"),$i=n("BertConfig"),xi=n(" for more information."),ji=c(),L(Ct.$$.fragment),Ka=c(),dt=a("h2"),Pt=a("a"),Bs=a("span"),L(Io.$$.fragment),Fi=c(),Ws=a("span"),zi=n("LayoutLMTokenizer"),Va=c(),Ne=a("div"),L(Do.$$.fragment),Ei=c(),Hs=a("p"),qi=n("Constructs a LayoutLM tokenizer."),Ci=c(),Nt=a("p"),as=a("a"),Pi=n("LayoutLMTokenizer"),Ni=n(" is identical to "),rs=a("a"),Si=n("BertTokenizer"),Oi=n(` and runs end-to-end tokenization: punctuation splitting +
wordpiece.`),Ii=c(),Ao=a("p"),Di=n("Refer to superclass "),is=a("a"),Ai=n("BertTokenizer"),Ui=n(" for usage examples and documentation concerning parameters."),Xa=c(),ct=a("h2"),St=a("a"),Rs=a("span"),L(Uo.$$.fragment),Bi=c(),Ks=a("span"),Wi=n("LayoutLMTokenizerFast"),Ya=c(),Se=a("div"),L(Bo.$$.fragment),Hi=c(),Vs=a("p"),Ri=n("Constructs a \u201CFast\u201D LayoutLMTokenizer."),Ki=c(),Ot=a("p"),ls=a("a"),Vi=n("LayoutLMTokenizerFast"),Xi=n(" is identical to "),ds=a("a"),Yi=n("BertTokenizerFast"),Zi=n(` and runs end-to-end tokenization: punctuation
splitting + wordpiece.`),Gi=c(),Wo=a("p"),Ji=n("Refer to superclass "),cs=a("a"),Qi=n("BertTokenizerFast"),el=n(" for usage examples and documentation concerning parameters."),Za=c(),pt=a("h2"),It=a("a"),Xs=a("span"),L(Ho.$$.fragment),tl=c(),Ys=a("span"),ol=n("LayoutLMModel"),Ga=c(),Oe=a("div"),L(Ro.$$.fragment),nl=c(),Ko=a("p"),sl=n(`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),pl=c(),Ae=a("div"),L(Zo.$$.fragment),ul=c(),ut=a("p"),hl=n("The "),ps=a("a"),ml=n("LayoutLMModel"),fl=n(" forward method, overrides the "),Zs=a("code"),gl=n("__call__"),_l=n(" special method."),yl=c(),L(Dt.$$.fragment),bl=c(),L(At.$$.fragment),Ja=c(),ht=a("h2"),Ut=a("a"),Gs=a("span"),L(Go.$$.fragment),kl=c(),Js=a("span"),Ll=n("LayoutLMForMaskedLM"),Qa=c(),Ie=a("div"),L(Jo.$$.fragment),wl=c(),mt=a("p"),Tl=n("LayoutLM Model with a "),Qs=a("code"),vl=n("language modeling"),Ml=n(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$d=c(),We=a("div"),L(Ln.$$.fragment),xd=c(),kt=a("p"),jd=n("The "),ms=a("a"),Fd=n("LayoutLMForTokenClassification"),zd=n(" forward method, overrides the "),ra=a("code"),Ed=n("__call__"),qd=n(" special method."),Cd=c(),L(Xt.$$.fragment),Pd=c(),L(Yt.$$.fragment),sr=c(),Lt=a("h2"),Zt=a("a"),ia=a("span"),L(wn.$$.fragment),Nd=c(),la=a("span"),Sd=n("TFLayoutLMModel"),ar=c(),Le=a("div"),L(Tn.$$.fragment),Od=c(),da=a("p"),Id=n("The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Dd=c(),vn=a("p"),Ad=n("This model inherits from "),fs=a("a"),Ud=n("TFPreTrainedModel"),Bd=n(`. Check the superclass documentation for the generic methods the
...
behavior.`),Vd=c(),L(Gt.$$.fragment),Xd=c(),He=a("div"),L(xn.$$.fragment),Yd=c(),wt=a("p"),Zd=n("The "),gs=a("a"),Gd=n("TFLayoutLMModel"),Jd=n(" forward method, overrides the "),ca=a("code"),Qd=n("__call__"),ec=n(" special method."),tc=c(),L(Jt.$$.fragment),oc=c(),L(Qt.$$.fragment),rr=c(),Tt=a("h2"),eo=a("a"),pa=a("span"),L(jn.$$.fragment),nc=c(),ua=a("span"),sc=n("TFLayoutLMForMaskedLM"),ir=c(),we=a("div"),L(Fn.$$.fragment),ac=c(),zn=a("p"),rc=n("LayoutLM Model with a "),ha=a("code"),ic=n("language modeling"),lc=n(" head on top."),dc=c(),En=a("p"),cc=n("This model inherits from "),_s=a("a"),pc=n("TFPreTrainedModel"),uc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
pooled output) e.g. for GLUE tasks.`),Ec=c(),On=a("p"),qc=n("This model inherits from "),bs=a("a"),Cc=n("TFPreTrainedModel"),Pc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nc=c(),In=a("p"),Sc=n("This model is also a "),Dn=a("a"),Oc=n("tf.keras.Model"),Ic=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dc=c(),L(ao.$$.fragment),Ac=c(),Ke=a("div"),L(An.$$.fragment),Uc=c(),$t=a("p"),Bc=n("The "),ks=a("a"),Wc=n("TFLayoutLMForSequenceClassification"),Hc=n(" forward method, overrides the "),ya=a("code"),Rc=n("__call__"),Kc=n(" special method."),Vc=c(),L(ro.$$.fragment),Xc=c(),L(io.$$.fragment),cr=c(),xt=a("h2"),lo=a("a"),ba=a("span"),L(Un.$$.fragment),Yc=c(),ka=a("span"),Zc=n("TFLayoutLMForTokenClassification"),pr=c(),ve=a("div"),L(Bn.$$.fragment),Gc=c(),La=a("p"),Jc=n(`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip=c(),L(co.$$.fragment),lp=c(),Ve=a("div"),L(Kn.$$.fragment),dp=c(),jt=a("p"),cp=n("The "),ws=a("a"),pp=n("TFLayoutLMForTokenClassification"),up=n(" forward method, overrides the "),wa=a("code"),hp=n("__call__"),mp=n(" special method."),fp=c(),L(po.$$.fragment),gp=c(),L(uo.$$.fragment),this.h()},l(o){const y=ph('[data-svelte="svelte-1phssyn"]',document.head);d=r(y,"META",{name:!0,content:!0}),y.forEach(t),k=p(o),_=r(o,"H1",{class:!0});var Vn=i(_);h=r(Vn,"A",{id:!0,class:!0,href:!0});var Ta=i(h);b=r(Ta,"SPAN",{});var va=i(b);w(l.$$.fragment,va),va.forEach(t),Ta.forEach(t),m=p(Vn),j=r(Vn,"SPAN",{});var Ma=i(j);re=s(Ma,"LayoutLM"),Ma.forEach(t),Vn.forEach(t),Y=p(o),z=r(o,"A",{id:!0}),i(z).forEach(t),ae=p(o),I=r(o,"H2",{class:!0});var Xn=i(I);Z=r(Xn,"A",{id:!0,class:!0,href:!0});var $a=i(Z);ne=r($a,"SPAN",{});var xa=i(ne);w(A.$$.fragment,xa),xa.forEach(t),$a.forEach(t),ie=p(Xn),se=r(Xn,"SPAN",{});var ja=i(se);J=s(ja,"Overview"),ja.forEach(t),Xn.forEach(t),D=p(o),G=r(o,"P",{});var Yn=i(G);Q=s(Yn,"The LayoutLM model was proposed in the paper "),F=r(Yn,"A",{href:!0,rel:!0});var Fa=i(F);q=s(Fa,`LayoutLM: Pre-training of Text and Layout for Document Image
...
document-level pretraining. It achieves new state-of-the-art results in several downstream tasks, including form
understanding (from 70.72 to 79.27), receipt understanding (from 94.02 to 95.24) and document image classification
(from 93.07 to 94.42).`),Na.forEach(t),Pa.forEach(t),$e=p(o),O=r(o,"P",{});var Sa=i(O);K=s(Sa,"Tips:"),Sa.forEach(t),xe=p(o),ye=r(o,"UL",{});var _p=i(ye);P=r(_p,"LI",{});var Xe=i(P);ze=s(Xe,"In addition to "),ke=r(Xe,"EM",{});var yp=i(ke);ge=s(yp,"input_ids"),yp.forEach(t),Ee=s(Xe,", "),Qn=r(Xe,"A",{href:!0});var bp=i(Qn);Wr=s(bp,"forward()"),bp.forEach(t),Hr=s(Xe," also expects the input "),Os=r(Xe,"CODE",{});var kp=i(Os);Rr=s(kp,"bbox"),kp.forEach(t),Kr=s(Xe,`, which are
the bounding boxes (i.e. 2D-positions) of the input tokens. These can be obtained using an external OCR engine such
...
(x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1) represents the
position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on a 0-1000
scale. To normalize, you can use the following function:`),Xe.forEach(t),_p.forEach(t),Da=p(o),w(Fo.$$.fragment,o),Aa=p(o),ot=r(o,"P",{});var Ts=i(ot);Gr=s(Ts,"Here, "),Is=r(Ts,"CODE",{});var Tp=i(Is);Jr=s(Tp,"width"),Tp.forEach(t),Qr=s(Ts," and "),Ds=r(Ts,"CODE",{});var vp=i(Ds);ei=s(vp,"height"),vp.forEach(t),ti=s(Ts,` correspond to the width and height of the original document in which the token
occurs. Those can be obtained using the Python Image Library (PIL) library for example, as follows:`),Ts.forEach(t),Ua=p(o),w(zo.$$.fragment,o),Ba=p(o),es=r(o,"UL",{});var Mp=i(es);et=r(Mp,"LI",{});var ho=i(et);oi=s(ho,"For a demo which shows how to fine-tune "),ts=r(ho,"A",{href:!0});var $p=i(ts);ni=s($p,"LayoutLMForTokenClassification"),$p.forEach(t),si=s(ho," on the "),Eo=r(ho,"A",{href:!0,rel:!0});var xp=i(Eo);ai=s(xp,"FUNSD dataset"),xp.forEach(t),ri=s(ho," (a collection of annotated forms), see "),qo=r(ho,"A",{href:!0,rel:!0});var jp=i(qo);ii=s(jp,"this notebook"),jp.forEach(t),li=s(ho,`.
It includes an inference part, which shows how to use Google\u2019s Tesseract on a new document.`),ho.forEach(t),Mp.forEach(t),Wa=p(o),nt=r(o,"P",{});var vs=i(nt);di=s(vs,"This model was contributed by "),Co=r(vs,"A",{href:!0,rel:!0});var Fp=i(Co);ci=s(Fp,"liminghao1630"),Fp.forEach(t),pi=s(vs,`. The original code can be found
`),Po=r(vs,"A",{href:!0,rel:!0});var zp=i(Po);ui=s(zp,"here"),zp.forEach(t),hi=s(vs,"."),vs.forEach(t),Ha=p(o),rt=r(o,"H2",{class:!0});var hr=i(rt);qt=r(hr,"A",{id:!0,class:!0,href:!0});var Ep=i(qt);As=r(Ep,"SPAN",{});var qp=i(As);w(No.$$.fragment,qp),qp.forEach(t),Ep.forEach(t),mi=p(hr),Us=r(hr,"SPAN",{});var Cp=i(Us);fi=s(Cp,"LayoutLMConfig"),Cp.forEach(t),hr.forEach(t),Ra=p(o),Pe=r(o,"DIV",{class:!0});var mo=i(Pe);w(So.$$.fragment,mo),gi=p(mo),it=r(mo,"P",{});var Ms=i(it);_i=s(Ms,"This is the configuration class to store the configuration of a "),os=r(Ms,"A",{href:!0});var Pp=i(os);yi=s(Pp,"LayoutLMModel"),Pp.forEach(t),bi=s(Ms,`. It is used to instantiate a
LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the LayoutLM
`),Oo=r(Ms,"A",{href:!0,rel:!0});var Np=i(Oo);ki=s(Np,"microsoft/layoutlm-base-uncased"),Np.forEach(t),Li=s(Ms," architecture."),Ms.forEach(t),wi=p(mo),lt=r(mo,"P",{});var $s=i(lt);Ti=s($s,"Configuration objects inherit from "),ns=r($s,"A",{href:!0});var Sp=i(ns);vi=s(Sp,"BertConfig"),Sp.forEach(t),Mi=s($s,` and can be used to control the model outputs. Read the
documentation from `),ss=r($s,"A",{href:!0});var Op=i(ss);$i=s(Op,"BertConfig"),Op.forEach(t),xi=s($s," for more information."),$s.forEach(t),ji=p(mo),w(Ct.$$.fragment,mo),mo.forEach(t),Ka=p(o),dt=r(o,"H2",{class:!0});var mr=i(dt);Pt=r(mr,"A",{id:!0,class:!0,href:!0});var Ip=i(Pt);Bs=r(Ip,"SPAN",{});var Dp=i(Bs);w(Io.$$.fragment,Dp),Dp.forEach(t),Ip.forEach(t),Fi=p(mr),Ws=r(mr,"SPAN",{});var Ap=i(Ws);zi=s(Ap,"LayoutLMTokenizer"),Ap.forEach(t),mr.forEach(t),Va=p(o),Ne=r(o,"DIV",{class:!0});var fo=i(Ne);w(Do.$$.fragment,fo),Ei=p(fo),Hs=r(fo,"P",{});var Up=i(Hs);qi=s(Up,"Constructs a LayoutLM tokenizer."),Up.forEach(t),Ci=p(fo),Nt=r(fo,"P",{});var Oa=i(Nt);as=r(Oa,"A",{href:!0});var Bp=i(as);Pi=s(Bp,"LayoutLMTokenizer"),Bp.forEach(t),Ni=s(Oa," is identical to "),rs=r(Oa,"A",{href:!0});var Wp=i(rs);Si=s(Wp,"BertTokenizer"),Wp.forEach(t),Oi=s(Oa,` and runs end-to-end tokenization: punctuation splitting +
wordpiece.`),Oa.forEach(t),Ii=p(fo),Ao=r(fo,"P",{});var fr=i(Ao);Di=s(fr,"Refer to superclass "),is=r(fr,"A",{href:!0});var Hp=i(is);Ai=s(Hp,"BertTokenizer"),Hp.forEach(t),Ui=s(fr," for usage examples and documentation concerning parameters."),fr.forEach(t),fo.forEach(t),Xa=p(o),ct=r(o,"H2",{class:!0});var gr=i(ct);St=r(gr,"A",{id:!0,class:!0,href:!0});var Rp=i(St);Rs=r(Rp,"SPAN",{});var Kp=i(Rs);w(Uo.$$.fragment,Kp),Kp.forEach(t),Rp.forEach(t),Bi=p(gr),Ks=r(gr,"SPAN",{});var Vp=i(Ks);Wi=s(Vp,"LayoutLMTokenizerFast"),Vp.forEach(t),gr.forEach(t),Ya=p(o),Se=r(o,"DIV",{class:!0});var go=i(Se);w(Bo.$$.fragment,go),Hi=p(go),Vs=r(go,"P",{});var Xp=i(Vs);Ri=s(Xp,"Constructs a \u201CFast\u201D LayoutLMTokenizer."),Xp.forEach(t),Ki=p(go),Ot=r(go,"P",{});var Ia=i(Ot);ls=r(Ia,"A",{href:!0});var Yp=i(ls);Vi=s(Yp,"LayoutLMTokenizerFast"),Yp.forEach(t),Xi=s(Ia," is identical to "),ds=r(Ia,"A",{href:!0});var Zp=i(ds);Yi=s(Zp,"BertTokenizerFast"),Zp.forEach(t),Zi=s(Ia,` and runs end-to-end tokenization: punctuation
splitting + wordpiece.`),Ia.forEach(t),Gi=p(go),Wo=r(go,"P",{});var _r=i(Wo);Ji=s(_r,"Refer to superclass "),cs=r(_r,"A",{href:!0});var Gp=i(cs);Qi=s(Gp,"BertTokenizerFast"),Gp.forEach(t),el=s(_r," for usage examples and documentation concerning parameters."),_r.forEach(t),go.forEach(t),Za=p(o),pt=r(o,"H2",{class:!0});var yr=i(pt);It=r(yr,"A",{id:!0,class:!0,href:!0});var Jp=i(It);Xs=r(Jp,"SPAN",{});var Qp=i(Xs);w(Ho.$$.fragment,Qp),Qp.forEach(t),Jp.forEach(t),tl=p(yr),Ys=r(yr,"SPAN",{});var eu=i(Ys);ol=s(eu,"LayoutLMModel"),eu.forEach(t),yr.forEach(t),Ga=p(o),Oe=r(o,"DIV",{class:!0});var _o=i(Oe);w(Ro.$$.fragment,_o),nl=p(_o),Ko=r(_o,"P",{});var br=i(Ko);sl=s(br,`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kr.forEach(t),pl=p(_o),Ae=r(_o,"DIV",{class:!0});var yo=i(Ae);w(Zo.$$.fragment,yo),ul=p(yo),ut=r(yo,"P",{});var xs=i(ut);hl=s(xs,"The "),ps=r(xs,"A",{href:!0});var nu=i(ps);ml=s(nu,"LayoutLMModel"),nu.forEach(t),fl=s(xs," forward method, overrides the "),Zs=r(xs,"CODE",{});var su=i(Zs);gl=s(su,"__call__"),su.forEach(t),_l=s(xs," special method."),xs.forEach(t),yl=p(yo),w(Dt.$$.fragment,yo),bl=p(yo),w(At.$$.fragment,yo),yo.forEach(t),_o.forEach(t),Ja=p(o),ht=r(o,"H2",{class:!0});var Lr=i(ht);Ut=r(Lr,"A",{id:!0,class:!0,href:!0});var au=i(Ut);Gs=r(au,"SPAN",{});var ru=i(Gs);w(Go.$$.fragment,ru),ru.forEach(t),au.forEach(t),kl=p(Lr),Js=r(Lr,"SPAN",{});var iu=i(Js);Ll=s(iu,"LayoutLMForMaskedLM"),iu.forEach(t),Lr.forEach(t),Qa=p(o),Ie=r(o,"DIV",{class:!0});var bo=i(Ie);w(Jo.$$.fragment,bo),wl=p(bo),mt=r(bo,"P",{});var js=i(mt);Tl=s(js,"LayoutLM Model with a "),Qs=r(js,"CODE",{});var lu=i(Qs);vl=s(lu,"language modeling"),lu.forEach(t),Ml=s(js,` head on top.
...
Ming Zhou.`),js.forEach(t),jl=p(bo),en=r(bo,"P",{});var wr=i(en);Fl=s(wr,"This model is a PyTorch "),tn=r(wr,"A",{href:!0,rel:!0});var cu=i(tn);zl=s(cu,"torch.nn.Module"),cu.forEach(t),El=s(wr,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wr.forEach(t),ql=p(bo),Ue=r(bo,"DIV",{class:!0});var ko=i(Ue);w(on.$$.fragment,ko),Cl=p(ko),ft=r(ko,"P",{});var Fs=i(ft);Pl=s(Fs,"The "),us=r(Fs,"A",{href:!0});var pu=i(us);Nl=s(pu,"LayoutLMForMaskedLM"),pu.forEach(t),Sl=s(Fs," forward method, overrides the "),ea=r(Fs,"CODE",{});var uu=i(ea);Ol=s(uu,"__call__"),uu.forEach(t),Il=s(Fs," special method."),Fs.forEach(t),Dl=p(ko),w(Bt.$$.fragment,ko),Al=p(ko),w(Wt.$$.fragment,ko),ko.forEach(t),bo.forEach(t),er=p(o),gt=r(o,"H2",{class:!0});var Tr=i(gt);Ht=r(Tr,"A",{id:!0,class:!0,href:!0});var hu=i(Ht);ta=r(hu,"SPAN",{});var mu=i(ta);w(nn.$$.fragment,mu),mu.forEach(t),hu.forEach(t),Ul=p(Tr),oa=r(Tr,"SPAN",{});var fu=i(oa);Bl=s(fu,"LayoutLMForSequenceClassification"),fu.forEach(t),Tr.forEach(t),tr=p(o),qe=r(o,"DIV",{class:!0});var st=i(qe);w(sn.$$.fragment,st),Wl=p(st),an=r(st,"P",{});var vr=i(an);Hl=s(vr,`LayoutLM Model with a sequence classification head on top (a linear layer on top of the pooled output) e.g. for
document image classification tasks such as the `),rn=r(vr,"A",{href:!0,rel:!0});var gu=i(rn);Rl=s(gu,"RVL-CDIP"),gu.forEach(t),Kl=s(vr," dataset."),vr.forEach(t),Vl=p(st),ln=r(st,"P",{});var Mr=i(ln);Xl=s(Mr,"The LayoutLM model was proposed in "),dn=r(Mr,"A",{href:!0,rel:!0});var _u=i(dn);Yl=s(_u,`LayoutLM: Pre-training of Text and Layout for Document Image
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$r.forEach(t),td=p(st),Be=r(st,"DIV",{class:!0});var Lo=i(Be);w(un.$$.fragment,Lo),od=p(Lo),_t=r(Lo,"P",{});var zs=i(_t);nd=s(zs,"The "),hs=r(zs,"A",{href:!0});var bu=i(hs);sd=s(bu,"LayoutLMForSequenceClassification"),bu.forEach(t),ad=s(zs," forward method, overrides the "),na=r(zs,"CODE",{});var ku=i(na);rd=s(ku,"__call__"),ku.forEach(t),id=s(zs," special method."),zs.forEach(t),ld=p(Lo),w(Rt.$$.fragment,Lo),dd=p(Lo),w(Kt.$$.fragment,Lo),Lo.forEach(t),st.forEach(t),or=p(o),yt=r(o,"H2",{class:!0});var xr=i(yt);Vt=r(xr,"A",{id:!0,class:!0,href:!0});var Lu=i(Vt);sa=r(Lu,"SPAN",{});var wu=i(sa);w(hn.$$.fragment,wu),wu.forEach(t),Lu.forEach(t),cd=p(xr),aa=r(xr,"SPAN",{});var Tu=i(aa);pd=s(Tu,"LayoutLMForTokenClassification"),Tu.forEach(t),xr.forEach(t),nr=p(o),Ce=r(o,"DIV",{class:!0});var at=i(Ce);w(mn.$$.fragment,at),ud=p(at),bt=r(at,"P",{});var Es=i(bt);hd=s(Es,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
sequence labeling (information extraction) tasks such as the `),fn=r(Es,"A",{href:!0,rel:!0});var vu=i(fn);md=s(vu,"FUNSD"),vu.forEach(t),fd=s(Es,`
...
Ming Zhou.`),jr.forEach(t),wd=p(at),bn=r(at,"P",{});var Fr=i(bn);Td=s(Fr,"This model is a PyTorch "),kn=r(Fr,"A",{href:!0,rel:!0});var xu=i(kn);vd=s(xu,"torch.nn.Module"),xu.forEach(t),Md=s(Fr,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fr.forEach(t),$d=p(at),We=r(at,"DIV",{class:!0});var wo=i(We);w(Ln.$$.fragment,wo),xd=p(wo),kt=r(wo,"P",{});var qs=i(kt);jd=s(qs,"The "),ms=r(qs,"A",{href:!0});var ju=i(ms);Fd=s(ju,"LayoutLMForTokenClassification"),ju.forEach(t),zd=s(qs," forward method, overrides the "),ra=r(qs,"CODE",{});var Fu=i(ra);Ed=s(Fu,"__call__"),Fu.forEach(t),qd=s(qs," special method."),qs.forEach(t),Cd=p(wo),w(Xt.$$.fragment,wo),Pd=p(wo),w(Yt.$$.fragment,wo),wo.forEach(t),at.forEach(t),sr=p(o),Lt=r(o,"H2",{class:!0});var zr=i(Lt);Zt=r(zr,"A",{id:!0,class:!0,href:!0});var zu=i(Zt);ia=r(zu,"SPAN",{});var Eu=i(ia);w(wn.$$.fragment,Eu),Eu.forEach(t),zu.forEach(t),Nd=p(zr),la=r(zr,"SPAN",{});var qu=i(la);Sd=s(qu,"TFLayoutLMModel"),qu.forEach(t),zr.forEach(t),ar=p(o),Le=r(o,"DIV",{class:!0});var Ye=i(Le);w(Tn.$$.fragment,Ye),Od=p(Ye),da=r(Ye,"P",{});var Cu=i(da);Id=s(Cu,"The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Cu.forEach(t),Dd=p(Ye),vn=r(Ye,"P",{});var Er=i(vn);Ad=s(Er,"This model inherits from "),fs=r(Er,"A",{href:!0});var Pu=i(fs);Ud=s(Pu,"TFPreTrainedModel"),Pu.forEach(t),Bd=s(Er,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qr.forEach(t),Vd=p(Ye),w(Gt.$$.fragment,Ye),Xd=p(Ye),He=r(Ye,"DIV",{class:!0});var To=i(He);w(xn.$$.fragment,To),Yd=p(To),wt=r(To,"P",{});var Cs=i(wt);Zd=s(Cs,"The "),gs=r(Cs,"A",{href:!0});var Su=i(gs);Gd=s(Su,"TFLayoutLMModel"),Su.forEach(t),Jd=s(Cs," forward method, overrides the "),ca=r(Cs,"CODE",{});var Ou=i(ca);Qd=s(Ou,"__call__"),Ou.forEach(t),ec=s(Cs," special method."),Cs.forEach(t),tc=p(To),w(Jt.$$.fragment,To),oc=p(To),w(Qt.$$.fragment,To),To.forEach(t),Ye.forEach(t),rr=p(o),Tt=r(o,"H2",{class:!0});var Cr=i(Tt);eo=r(Cr,"A",{id:!0,class:!0,href:!0});var Iu=i(eo);pa=r(Iu,"SPAN",{});var Du=i(pa);w(jn.$$.fragment,Du),Du.forEach(t),Iu.forEach(t),nc=p(Cr),ua=r(Cr,"SPAN",{});var Au=i(ua);sc=s(Au,"TFLayoutLMForMaskedLM"),Au.forEach(t),Cr.forEach(t),ir=p(o),we=r(o,"DIV",{class:!0});var Ze=i(we);w(Fn.$$.fragment,Ze),ac=p(Ze),zn=r(Ze,"P",{});var Pr=i(zn);rc=s(Pr,"LayoutLM Model with a "),ha=r(Pr,"CODE",{});var Uu=i(ha);ic=s(Uu,"language modeling"),Uu.forEach(t),lc=s(Pr," head on top."),Pr.forEach(t),dc=p(Ze),En=r(Ze,"P",{});var Nr=i(En);cc=s(Nr,"This model inherits from "),_s=r(Nr,"A",{href:!0});var Bu=i(_s);pc=s(Bu,"TFPreTrainedModel"),Bu.forEach(t),uc=s(Nr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sr.forEach(t),_c=p(Ze),w(to.$$.fragment,Ze),yc=p(Ze),Re=r(Ze,"DIV",{class:!0});var vo=i(Re);w(Pn.$$.fragment,vo),bc=p(vo),vt=r(vo,"P",{});var Ps=i(vt);kc=s(Ps,"The "),ys=r(Ps,"A",{href:!0});var Hu=i(ys);Lc=s(Hu,"TFLayoutLMForMaskedLM"),Hu.forEach(t),wc=s(Ps," forward method, overrides the "),ma=r(Ps,"CODE",{});var Ru=i(ma);Tc=s(Ru,"__call__"),Ru.forEach(t),vc=s(Ps," special method."),Ps.forEach(t),Mc=p(vo),w(oo.$$.fragment,vo),$c=p(vo),w(no.$$.fragment,vo),vo.forEach(t),Ze.forEach(t),lr=p(o),Mt=r(o,"H2",{class:!0});var Or=i(Mt);so=r(Or,"A",{id:!0,class:!0,href:!0});var Ku=i(so);fa=r(Ku,"SPAN",{});var Vu=i(fa);w(Nn.$$.fragment,Vu),Vu.forEach(t),Ku.forEach(t),xc=p(Or),ga=r(Or,"SPAN",{});var Xu=i(ga);jc=s(Xu,"TFLayoutLMForSequenceClassification"),Xu.forEach(t),Or.forEach(t),dr=p(o),Te=r(o,"DIV",{class:!0});var Ge=i(Te);w(Sn.$$.fragment,Ge),Fc=p(Ge),_a=r(Ge,"P",{});var Yu=i(_a);zc=s(Yu,`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Yu.forEach(t),Ec=p(Ge),On=r(Ge,"P",{});var Ir=i(On);qc=s(Ir,"This model inherits from "),bs=r(Ir,"A",{href:!0});var Zu=i(bs);Cc=s(Zu,"TFPreTrainedModel"),Zu.forEach(t),Pc=s(Ir,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ir.forEach(t),Nc=p(Ge),In=r(Ge,"P",{});var Dr=i(In);Sc=s(Dr,"This model is also a "),Dn=r(Dr,"A",{href:!0,rel:!0});var Gu=i(Dn);Oc=s(Gu,"tf.keras.Model"),Gu.forEach(t),Ic=s(Dr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dr.forEach(t),Dc=p(Ge),w(ao.$$.fragment,Ge),Ac=p(Ge),Ke=r(Ge,"DIV",{class:!0});var Mo=i(Ke);w(An.$$.fragment,Mo),Uc=p(Mo),$t=r(Mo,"P",{});var Ns=i($t);Bc=s(Ns,"The "),ks=r(Ns,"A",{href:!0});var Ju=i(ks);Wc=s(Ju,"TFLayoutLMForSequenceClassification"),Ju.forEach(t),Hc=s(Ns," forward method, overrides the "),ya=r(Ns,"CODE",{});var Qu=i(ya);Rc=s(Qu,"__call__"),Qu.forEach(t),Kc=s(Ns," special method."),Ns.forEach(t),Vc=p(Mo),w(ro.$$.fragment,Mo),Xc=p(Mo),w(io.$$.fragment,Mo),Mo.forEach(t),Ge.forEach(t),cr=p(o),xt=r(o,"H2",{class:!0});var Ar=i(xt);lo=r(Ar,"A",{id:!0,class:!0,href:!0});var eh=i(lo);ba=r(eh,"SPAN",{});var th=i(ba);w(Un.$$.fragment,th),th.forEach(t),eh.forEach(t),Yc=p(Ar),ka=r(Ar,"SPAN",{});var oh=i(ka);Zc=s(oh,"TFLayoutLMForTokenClassification"),oh.forEach(t),Ar.forEach(t),pr=p(o),ve=r(o,"DIV",{class:!0});var Je=i(ve);w(Bn.$$.fragment,Je),Gc=p(Je),La=r(Je,"P",{});var nh=i(La);Jc=s(nh,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
