...
between <span class="hljs-number">1999</span> <span class="hljs-keyword">and</span> <span class="hljs-number">2002.</span>`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:C,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function yj($){let n,u;return n=new S({props:{$$slots:{default:[bj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function $j($){let n,u;return n=new q({props:{code:`from transformers import TFAutoModelForSeq2SeqLM, AutoTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
Hugging Face ist ein Technologieunternehmen mit Sitz <span class="hljs-keyword">in</span> New York und Paris.`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:C,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Aj($){let n,u;return n=new S({props:{$$slots:{default:[Tj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Ij($){let n,u;return n=new q({props:{code:`from transformers import AutoFeatureExtractor, AutoModelForAudioClassification
...
<span class="hljs-string">&#x27;_unknown_&#x27;</span>`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:C,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function zj($){let n,u;return n=new S({props:{$$slots:{default:[Ij]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Lj($){let n,u;return n=new q({props:{code:`from transformers import AutoProcessor, AutoModelForCTC
from datasets import load_dataset
import torch
...
<span class="hljs-string">&#x27;MISTER QUILTER IS THE APOSTLE OF THE MIDDLE CLASSES AND WE ARE GLAD TO WELCOME HIS GOSPEL&#x27;</span>`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:C,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Mj($){let n,u;return n=new S({props:{$$slots:{default:[Lj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Pj($){let n,u;return n=new q({props:{code:`from transformers import AutoFeatureExtractor, AutoModelForImageClassification
import torch
from datasets import load_dataset
...
Egyptian cat`}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p:C,i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Fj($){let n,u;return n=new S({props:{$$slots:{default:[Pj]},$$scope:{ctx:$}}}),{c(){j(n.$$.fragment)},l(a){k(n.$$.fragment,a)},m(a,f){w(n,a,f),u=!0},p(a,f){const _={};f&2&&(_.$$scope={dirty:f,ctx:a}),n.$set(_)},i(a){u||(x(n.$$.fragment,a),u=!0)},o(a){b(n.$$.fragment,a),u=!1},d(a){y(n,a)}}}function Nj($){let n,u,a,f,_,E,A,z,v,I,F,Vs,gs,As,Js,K,Is,fs,We,Ks,G,ds,zs,Zs,Z,U,Ye,Ls,se,us,ss,T,L,na,_s,oa,js,ra,ks,Qe,Ms,zi,ar,ee,Xa,Li,Mi,Va,Pi,nr,la,Fi,or,te,rr,Ps,ae,Ja,Xe,Ni,Ka,Ci,lr,W,Si,Ve,Oi,Di,Je,Ri,Bi,Ke,Hi,Gi,Ze,Ui,Wi,ir,ia,Yi,pr,pa,Qi,cr,st,hr,ca,Xi,ur,Y,Za,Vi,Ji,sn,Ki,Zi,en,sp,ep,tn,tp,ap,an,np,mr,ne,gr,Fs,oe,nn,et,op,on,rp,fr,ws,lp,tt,ip,pp,at,cp,hp,dr,ha,up,_r,nt,jr,ua,mp,kr,ot,wr,ma,gp,xr,O,rn,fp,dp,ln,_p,jp,pn,kp,wp,cn,xp,bp,hn,yp,$p,un,vp,qp,mn,Ep,br,re,yr,Ns,le,gn,rt,Tp,fn,Ap,$r,ga,Ip,vr,ie,zp,lt,Lp,Mp,qr,Cs,pe,dn,it,Pp,_n,Fp,Er,xs,Np,pt,Cp,Sp,ct,Op,Dp,Tr,fa,Rp,Ar,ht,Ir,da,Bp,zr,ut,Lr,_a,Hp,Mr,R,jn,Gp,Up,mt,Wp,kn,Yp,Qp,Xp,wn,Vp,Jp,xn,Kp,Zp,Ss,sc,bn,ec,tc,yn,ac,nc,oc,$n,rc,Pr,ce,Fr,ja,lc,Nr,Os,he,vn,gt,ic,qn,pc,Cr,ue,cc,ft,hc,uc,Sr,ka,mc,Or,me,Dr,bs,gc,En,fc,dc,Tn,_c,jc,Rr,ge,kc,wa,wc,xc,Br,Ds,fe,An,dt,bc,In,yc,Hr,B,$c,zn,vc,qc,Ln,Ec,Tc,Mn,Ac,Ic,Pn,zc,Lc,_t,Mc,Pc,Gr,de,Ur,M,Fc,Fn,Nc,Cc,Nn,Sc,Oc,Cn,Dc,Rc,Sn,Bc,Hc,On,Gc,Uc,Dn,Wc,Yc,Rn,Qc,Xc,Bn,Vc,Jc,Hn,Kc,Zc,Wr,_e,sh,jt,eh,th,Yr,Rs,je,Gn,kt,ah,Un,nh,Qr,ke,oh,wt,rh,lh,Xr,xa,ih,Vr,P,Wn,ph,ch,Yn,hh,uh,Qn,mh,gh,Xn,fh,dh,Vn,_h,jh,Jn,kh,wh,Kn,xh,bh,Zn,yh,$h,so,vh,Jr,ys,qh,xt,Eh,Th,bt,Ah,Ih,Kr,yt,Zr,ba,zh,sl,$t,el,ya,Lh,tl,$a,Mh,al,H,eo,Ph,Fh,to,Nh,Ch,ao,Sh,Oh,no,Dh,Rh,oo,Bh,Hh,ro,Gh,nl,we,ol,va,Uh,rl,$s,Wh,lo,Yh,Qh,io,Xh,Vh,ll,vt,il,Bs,xe,po,qt,Jh,co,Kh,pl,be,Zh,Et,su,eu,cl,ye,tu,Tt,au,nu,hl,qa,ou,ul,At,ml,Q,ru,ho,lu,iu,uo,pu,cu,mo,hu,uu,go,mu,gu,gl,It,fl,Ea,fu,dl,es,Hs,du,fo,_u,ju,_o,ku,wu,xu,jo,bu,yu,ko,$u,vu,zt,qu,wo,Eu,Tu,_l,Ta,Au,jl,$e,kl,Gs,ve,xo,Lt,Iu,bo,zu,wl,qe,Lu,Mt,Mu,Pu,xl,Ee,Fu,Pt,Nu,Cu,bl,Aa,Su,yl,Ft,$l,ts,Ou,yo,Du,Ru,$o,Bu,Hu,vo,Gu,Uu,vl,Ia,Wu,ql,as,Us,Yu,qo,Qu,Xu,Eo,Vu,Ju,Ku,To,Zu,sm,Ao,em,tm,Nt,am,Io,nm,om,El,Te,Tl,za,rm,Al,Ws,Ae,zo,Ct,lm,Lo,im,Il,ns,pm,St,cm,hm,Ot,um,mm,La,gm,fm,zl,Ie,dm,Ma,_m,jm,Ll,Dt,Ml,Pa,km,Pl,os,Mo,wm,xm,Po,bm,ym,Rt,$m,Fo,vm,qm,Em,Bt,Tm,No,Am,Im,Fl,ze,Nl,Ys,Le,Co,Ht,zm,So,Lm,Cl,X,Mm,Gt,Pm,Fm,Ut,Nm,Cm,Wt,Sm,Om,Fa,Dm,Rm,Sl,Me,Bm,Na,Hm,Gm,Ol,Yt,Dl,Ca,Um,Rl,rs,Oo,Wm,Ym,Do,Qm,Xm,Qt,Vm,Ro,Jm,Km,Zm,Bo,sg,Bl,Pe,Hl,Qs,Fe,Ho,Xt,eg,Go,tg,Gl,ls,ag,Vt,ng,og,Jt,rg,lg,Sa,ig,pg,Ul,Ne,cg,Oa,hg,ug,Wl,Kt,Yl,Da,mg,Ql,is,Uo,gg,fg,Wo,dg,_g,Zt,jg,Yo,kg,wg,xg,sa,bg,Qo,yg,$g,Xl,Ce,Vl;return E=new J({}),F=new V_({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Mixed",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/en/task_summary.ipynb"},{label:"PyTorch",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/en/pytorch/task_summary.ipynb"},{label:"TensorFlow",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/main/transformers_doc/en/tensorflow/task_summary.ipynb"},{label:"Mixed",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/en/task_summary.ipynb"},{label:"PyTorch",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/en/pytorch/task_summary.ipynb"},{label:"TensorFlow",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/main/transformers_doc/en/tensorflow/task_summary.ipynb"}]}}),te=new X_({props:{$$slots:{default:[J_]},$$scope:{ctx:$}}}),Xe=new J({}),st=new q({props:{code:`from transformers import pipeline
...
[{<span class="hljs-string">&#x27;translation_text&#x27;</span>: <span class="hljs-string">&#x27;Hugging Face ist ein Technologieunternehmen mit Sitz in New York und Paris.&#x27;</span>}]`}}),Te=new ms({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Aj],pytorch:[Ej]},$$scope:{ctx:$}}}),Ct=new J({}),Dt=new q({props:{code:`from transformers import pipeline
...
input sequence.`),Or=m(),j(me.$$.fragment),Dr=m(),bs=l("p"),gc=o("This outputs a (hopefully) coherent next token following the original sequence, which in our case is the word "),En=l("em"),fc=o("is"),dc=o(` or
...
(see `),_t=l("a"),Mc=o("gpt-2 config"),Pc=o(" for example)."),Gr=m(),j(de.$$.fragment),Ur=m(),M=l("p"),Fc=o("Text generation is currently possible with "),Fn=l("em"),Nc=o("GPT-2"),Cc=o(", "),Nn=l("em"),Sc=o("OpenAi-GPT"),Oc=o(", "),Cn=l("em"),Dc=o("CTRL"),Rc=o(", "),Sn=l("em"),Bc=o("XLNet"),Hc=o(", "),On=l("em"),Gc=o("Transfo-XL"),Uc=o(" and "),Dn=l("em"),Wc=o("Reformer"),Yc=o(` in
...
encoding and decoding the sequence, so that we\u2019re left with a string that contains the special tokens.`),Oh=m(),no=l("li"),Dh=o("Encode that sequence into IDs (special tokens are added automatically)."),Rh=m(),oo=l("li"),Bh=o(`Retrieve the predictions by passing the input to the model and getting the first output. This results in a
...
multi-task mixture dataset (including WMT), yet, yielding impressive translation results.`),yl=m(),j(Ft.$$.fragment),$l=m(),ts=l("p"),Ou=o("Because the translation pipeline depends on the "),yo=l("code"),Du=o("PreTrainedModel.generate()"),Ru=o(` method, we can override the default
...
sequence classification is the GLUE dataset, which is entirely based on that task. If you would like to fine-tune a
model on a GLUE sequence classification task, you may leverage the `),Ve=i(vs,"A",{href:!0,rel:!0});var Mg=p(Ve);Oi=r(Mg,"run_glue.py"),Mg.forEach(t),Di=r(vs,", "),Je=i(vs,"A",{href:!0,rel:!0});var Pg=p(Je);Ri=r(Pg,"run_tf_glue.py"),Pg.forEach(t),Bi=r(vs,", "),Ke=i(vs,"A",{href:!0,rel:!0});var Fg=p(Ke);Hi=r(Fg,"run_tf_text_classification.py"),Fg.forEach(t),Gi=r(vs," or "),Ze=i(vs,"A",{href:!0,rel:!0});var Ng=p(Ze);Ui=r(Ng,"run_xnli.py"),Ng.forEach(t),Wi=r(vs," scripts."),vs.forEach(t),ir=g(s),ia=i(s,"P",{});var Cg=p(ia);Yi=r(Cg,`Here is an example of using pipelines to do sentiment analysis: identifying if a sequence is positive or negative. It
leverages a fine-tuned model on sst2, which is a GLUE task.`),Cg.forEach(t),pr=g(s),pa=i(s,"P",{});var Sg=p(pa);Qi=r(Sg,"This returns a label (\u201CPOSITIVE\u201D or \u201CNEGATIVE\u201D) alongside a score, as follows:"),Sg.forEach(t),cr=g(s),k(st.$$.fragment,s),hr=g(s),ca=i(s,"P",{});var Og=p(ca);Xi=r(Og,`Here is an example of doing a sequence classification using a model to determine if two sequences are paraphrases of
each other. The process is the following:`),Og.forEach(t),ur=g(s),Y=i(s,"OL",{});var qs=p(Y);Za=i(qs,"LI",{});var Dg=p(Za);Vi=r(Dg,`Instantiate a tokenizer and a model from the checkpoint name. The model is identified as a BERT model and loads it
with the weights stored in the checkpoint.`),Dg.forEach(t),Ji=g(qs),sn=i(qs,"LI",{});var Rg=p(sn);Ki=r(Rg,`Build a sequence from the two sentences, with the correct model-specific separators, token type ids and attention
...
positions of the extracted answer in the text.`),Jg.forEach(t),kr=g(s),k(ot.$$.fragment,s),wr=g(s),ma=i(s,"P",{});var Kg=p(ma);gp=r(Kg,"Here is an example of question answering using a model and a tokenizer. The process is the following:"),Kg.forEach(t),xr=g(s),O=i(s,"OL",{});var V=p(O);rn=i(V,"LI",{});var Zg=p(rn);fp=r(Zg,`Instantiate a tokenizer and a model from the checkpoint name. The model is identified as a BERT model and loads it
...
input sequence.`),Lf.forEach(t),Or=g(s),k(me.$$.fragment,s),Dr=g(s),bs=i(s,"P",{});var Ga=p(bs);gc=r(Ga,"This outputs a (hopefully) coherent next token following the original sequence, which in our case is the word "),En=i(Ga,"EM",{});var Mf=p(En);fc=r(Mf,"is"),Mf.forEach(t),dc=r(Ga,` or
...
generate multiple tokens up to a specified length instead of one token at a time.`),li.forEach(t),Br=g(s),Ds=i(s,"H3",{class:!0});var ii=p(Ds);fe=i(ii,"A",{id:!0,class:!0,href:!0});var Nf=p(fe);An=i(Nf,"SPAN",{});var Cf=p(An);k(dt.$$.fragment,Cf),Cf.forEach(t),Nf.forEach(t),bc=g(ii),In=i(ii,"SPAN",{});var Sf=p(In);yc=r(Sf,"Text Generation"),Sf.forEach(t),ii.forEach(t),Hr=g(s),B=i(s,"P",{});var cs=p(B);$c=r(cs,"In text generation ("),zn=i(cs,"EM",{});var Of=p(zn);vc=r(Of,"a.k.a"),Of.forEach(t),qc=g(cs),Ln=i(cs,"EM",{});var Df=p(Ln);Ec=r(Df,"open-ended text generation"),Df.forEach(t),Tc=r(cs,`) the goal is to create a coherent portion of text that is a
...
(see `),_t=i(cs,"A",{href:!0,rel:!0});var Hf=p(_t);Mc=r(Hf,"gpt-2 config"),Hf.forEach(t),Pc=r(cs," for example)."),cs.forEach(t),Gr=g(s),k(de.$$.fragment,s),Ur=g(s),M=i(s,"P",{});var N=p(M);Fc=r(N,"Text generation is currently possible with "),Fn=i(N,"EM",{});var Gf=p(Fn);Nc=r(Gf,"GPT-2"),Gf.forEach(t),Cc=r(N,", "),Nn=i(N,"EM",{});var Uf=p(Nn);Sc=r(Uf,"OpenAi-GPT"),Uf.forEach(t),Oc=r(N,", "),Cn=i(N,"EM",{});var Wf=p(Cn);Dc=r(Wf,"CTRL"),Wf.forEach(t),Rc=r(N,", "),Sn=i(N,"EM",{});var Yf=p(Sn);Bc=r(Yf,"XLNet"),Yf.forEach(t),Hc=r(N,", "),On=i(N,"EM",{});var Qf=p(On);Gc=r(Qf,"Transfo-XL"),Qf.forEach(t),Uc=r(N," and "),Dn=i(N,"EM",{});var Xf=p(Dn);Wc=r(Xf,"Reformer"),Xf.forEach(t),Yc=r(N,` in
...
belonging to one of 9 classes:`),nd.forEach(t),Vr=g(s),P=i(s,"UL",{});var D=p(P);Wn=i(D,"LI",{});var od=p(Wn);ph=r(od,"O, Outside of a named entity"),od.forEach(t),ch=g(D),Yn=i(D,"LI",{});var rd=p(Yn);hh=r(rd,"B-MIS, Beginning of a miscellaneous entity right after another miscellaneous entity"),rd.forEach(t),uh=g(D),Qn=i(D,"LI",{});var ld=p(Qn);mh=r(ld,"I-MIS, Miscellaneous entity"),ld.forEach(t),gh=g(D),Xn=i(D,"LI",{});var id=p(Xn);fh=r(id,"B-PER, Beginning of a person\u2019s name right after another person\u2019s name"),id.forEach(t),dh=g(D),Vn=i(D,"LI",{});var pd=p(Vn);_h=r(pd,"I-PER, Person\u2019s name"),pd.forEach(t),jh=g(D),Jn=i(D,"LI",{});var cd=p(Jn);kh=r(cd,"B-ORG, Beginning of an organisation right after another organisation"),cd.forEach(t),wh=g(D),Kn=i(D,"LI",{});var hd=p(Kn);xh=r(hd,"I-ORG, Organisation"),hd.forEach(t),bh=g(D),Zn=i(D,"LI",{});var ud=p(Zn);yh=r(ud,"B-LOC, Beginning of a location right after another location"),ud.forEach(t),$h=g(D),so=i(D,"LI",{});var md=p(so);vh=r(md,"I-LOC, Location"),md.forEach(t),D.forEach(t),Jr=g(s),ys=i(s,"P",{});var Ua=p(ys);qh=r(Ua,"It leverages a fine-tuned model on CoNLL-2003, fine-tuned by "),xt=i(Ua,"A",{href:!0,rel:!0});var gd=p(xt);Eh=r(gd,"@stefan-it"),gd.forEach(t),Th=r(Ua," from "),bt=i(Ua,"A",{href:!0,rel:!0});var fd=p(bt);Ah=r(fd,"dbmdz"),fd.forEach(t),Ih=r(Ua,"."),Ua.forEach(t),Kr=g(s),k(yt.$$.fragment,s),Zr=g(s),ba=i(s,"P",{});var dd=p(ba);zh=r(dd,`This outputs a list of all words that have been identified as one of the entities from the 9 classes defined above.
...
encoding and decoding the sequence, so that we\u2019re left with a string that contains the special tokens.`),xd.forEach(t),Oh=g(hs),no=i(hs,"LI",{});var bd=p(no);Dh=r(bd,"Encode that sequence into IDs (special tokens are added automatically)."),bd.forEach(t),Rh=g(hs),oo=i(hs,"LI",{});var yd=p(oo);Bh=r(yd,`Retrieve the predictions by passing the input to the model and getting the first output. This results in a
distribution over the 9 possible classes for each token. We take the argmax to retrieve the most likely class for
