...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);E=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var z=i(m);L=s(z,"Module"),z.forEach(t),w=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,E),e(h,m),e(m,L),e(h,w)},d(g){g&&t(h)}}}function up(K){let h,E,m,L,w,g,f,z,Ds,Ho,le,xe,Nn,He,Bs,Dn,Ws,Vo,$e,Us,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Bn,Vs,Jo,Gt,Ys,Xo,R,Wn,Ye,Qs,Zt,Js,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ra,ia,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,Ta,on,Gn,La,wa,Ea,U,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Fa,Ma,Ca,Fe,an,Pa,ja,Ge,Aa,Ia,Oa,rn,dn,Sa,Na,Da,O,ln,Ba,Wa,eo,Ua,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,er,Ze,tr,nr,or,et,sr,tt,ar,rr,Go,pn,ir,Zo,nt,es,V,dr,ot,lr,cr,st,pr,hr,at,ur,mr,ts,he,Me,so,rt,fr,ao,gr,ns,F,it,_r,dt,kr,hn,yr,br,vr,ue,Tr,un,Lr,wr,mn,Er,zr,xr,ro,$r,qr,lt,os,me,Ce,io,ct,Fr,lo,Mr,ss,M,pt,Cr,co,Pr,jr,x,Ar,fn,Ir,Or,gn,Sr,Nr,_n,Dr,Br,po,Wr,Ur,ho,Kr,Rr,uo,Hr,Vr,mo,Yr,Qr,Jr,Pe,ht,Xr,fo,Gr,Zr,kn,ut,as,fe,je,go,mt,ei,_o,ti,rs,C,ft,ni,ko,oi,si,gt,ai,yn,ri,ii,di,_t,li,kt,ci,pi,hi,S,yt,ui,ge,mi,bn,fi,gi,yo,_i,ki,yi,Ae,bi,bo,vi,Ti,bt,is,_e,Ie,vo,vt,Li,To,wi,ds,P,Tt,Ei,Lo,zi,xi,Lt,$i,vn,qi,Fi,Mi,wt,Ci,Et,Pi,ji,Ai,J,zt,Ii,ke,Oi,Tn,Si,Ni,wo,Di,Bi,Wi,Oe,ls,ye,Se,Eo,xt,Ui,zo,Ki,cs,j,$t,Ri,xo,Hi,Vi,qt,Yi,Ln,Qi,Ji,Xi,Ft,Gi,Mt,Zi,ed,td,N,Ct,nd,be,od,wn,sd,ad,$o,rd,id,dd,Ne,ld,qo,cd,pd,Pt,ps,ve,De,Fo,jt,hd,Mo,ud,hs,A,At,md,Co,fd,gd,It,_d,En,kd,yd,bd,Ot,vd,St,Td,Ld,wd,D,Nt,Ed,Te,zd,zn,xd,$d,Po,qd,Fd,Md,Be,Cd,jo,Pd,jd,Dt,us,Le,We,Ao,Bt,Ad,Io,Id,ms,I,Wt,Od,Oo,Sd,Nd,Ut,Dd,xn,Bd,Wd,Ud,Kt,Kd,Rt,Rd,Hd,Vd,B,Ht,Yd,we,Qd,$n,Jd,Xd,So,Gd,Zd,el,Ue,tl,No,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LukeTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16384/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_16384/en/main_classes/tokenizer#transformers.BatchEncoding"
...
<p><a
  href="/docs/transformers/pr_16384/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ut=new W({props:{name:"save_vocabulary",anchor:"transformers.LukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/tokenization_luke.py#L1378"}}),mt=new ze({}),ft=new W({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:": LukeConfig"},{name:"add_pooling_layer",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/modeling_luke.py#L879",parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16384/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yt=new W({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>word_last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>entity_last_hidden_state = outputs.entity_last_hidden_state`}}),vt=new ze({}),Tt=new W({props:{name:"class transformers.LukeForMaskedLM",anchor:"transformers.LukeForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/modeling_luke.py#L1132",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16384/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zt=new W({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Predicted <span class="hljs-keyword">class</span>: person`}}),jt=new ze({}),At=new W({props:{name:"class transformers.LukeForEntityPairClassification",anchor:"transformers.LukeForEntityPairClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/modeling_luke.py#L1383",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16384/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new W({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Be=new Ro({props:{$$slots:{default:[pp]},$$scope:{ctx:K}}}),Dt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeForEntityPairClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_idx = logits.argmax(-<span class="hljs-number">1</span>).item()
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])
Predicted <span class="hljs-keyword">class</span>: per:cities_of_residence`}}),Bt=new ze({}),Wt=new W({props:{name:"class transformers.LukeForEntitySpanClassification",anchor:"transformers.LukeForEntitySpanClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/modeling_luke.py#L1503",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16384/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new W({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16384/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16384/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16384/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Ue=new Ro({props:{$$slots:{default:[hp]},$$scope:{ctx:K}}}),Vt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeForEntitySpanClassification
...
Beyonc\xE9 PER
Los Angeles LOC`}}),{c(){h=a("meta"),E=l(),m=a("h1"),L=a("a"),w=a("span"),_(g.$$.fragment),f=l(),z=a("span"),Ds=o("LUKE"),Ho=l(),le=a("h2"),xe=a("a"),Nn=a("span"),_(He.$$.fragment),Bs=l(),Dn=a("span"),Ws=o("Overview"),Vo=l(),$e=a("p"),Us=o("The LUKE model was proposed in "),Ve=a("a"),Ks=o("LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),Rs=o(` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
extractive and cloze-style question answering, entity typing, and relation classification.`),Yo=l(),Jt=a("p"),Hs=o("The abstract from the paper is the following:"),Qo=l(),Xt=a("p"),Bn=a("em"),Vs=o(`Entity representations are useful in natural language tasks involving entities. In this paper, we propose new
...
answering).`),Jo=l(),Gt=a("p"),Ys=o("Tips:"),Xo=l(),R=a("ul"),Wn=a("li"),Ye=a("p"),Qs=o("This implementation is the same as "),Zt=a("a"),Js=o("RobertaModel"),Xs=o(` with the addition of entity embeddings as well
...
entity typing, e.g. the `),Xe=a("a"),Fa=o("Open Entity dataset"),Ma=o(`.
This model places a linear head on top of the output entity representation.`),Ca=l(),Fe=a("li"),an=a("a"),Pa=o("LukeForEntityPairClassification"),ja=o(`, for tasks to classify the relationship between two entities
...
can address NER using this model by inputting all possible entity spans in the text to the model.`),Da=l(),O=a("p"),ln=a("a"),Ba=o("LukeTokenizer"),Wa=o(" has a "),eo=a("code"),Ua=o("task"),Ka=o(` argument, which enables you to easily create an input to these
...
documentation from `),mn=a("a"),Er=o("PretrainedConfig"),zr=o(" for more information."),xr=l(),ro=a("p"),$r=o("Examples:"),qr=l(),_(lt.$$.fragment),os=l(),me=a("h2"),Ce=a("a"),io=a("span"),_(ct.$$.fragment),Fr=l(),lo=a("span"),Mr=o("LukeTokenizer"),ss=l(),M=a("div"),_(pt.$$.fragment),Cr=l(),co=a("p"),Pr=o("Construct a LUKE tokenizer."),jr=l(),x=a("p"),Ar=o("This tokenizer inherits from "),fn=a("a"),Ir=o("RobertaTokenizer"),Or=o(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),gn=a("a"),Sr=o("RobertaTokenizer"),Nr=o(", "),_n=a("a"),Dr=o("LukeTokenizer"),Br=o(`
also creates entity sequences, namely `),po=a("code"),Wr=o("entity_ids"),Ur=o(", "),ho=a("code"),Kr=o("entity_attention_mask"),Rr=o(", "),uo=a("code"),Hr=o("entity_token_type_ids"),Vr=o(`, and
...
masked entity prediction.`),xi=l(),Lt=a("p"),$i=o("This model inherits from "),vn=a("a"),qi=o("PreTrainedModel"),Fi=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mi=l(),wt=a("p"),Ci=o("This model is also a PyTorch "),Et=a("a"),Pi=o("torch.nn.Module"),ji=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ai=l(),J=a("div"),_(zt.$$.fragment),Ii=l(),ke=a("p"),Oi=o("The "),Tn=a("a"),Si=o("LukeForMaskedLM"),Ni=o(" forward method, overrides the "),wo=a("code"),Di=o("__call__"),Bi=o(" special method."),Wi=l(),_(Oe.$$.fragment),ls=l(),ye=a("h2"),Se=a("a"),Eo=a("span"),_(xt.$$.fragment),Ui=l(),zo=a("span"),Ki=o("LukeForEntityClassification"),cs=l(),j=a("div"),_($t.$$.fragment),Ri=l(),xo=a("p"),Hi=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Vi=l(),qt=a("p"),Yi=o("This model inherits from "),Ln=a("a"),Qi=o("PreTrainedModel"),Ji=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xi=l(),Ft=a("p"),Gi=o("This model is also a PyTorch "),Mt=a("a"),Zi=o("torch.nn.Module"),ed=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),N=a("div"),_(Ct.$$.fragment),nd=l(),be=a("p"),od=o("The "),wn=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),rd=o("__call__"),id=o(" special method."),dd=l(),_(Ne.$$.fragment),ld=l(),qo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),De=a("a"),Fo=a("span"),_(jt.$$.fragment),hd=l(),Mo=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Co=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wd=l(),D=a("div"),_(Nt.$$.fragment),Ed=l(),Te=a("p"),zd=o("The "),zn=a("a"),xd=o("LukeForEntityPairClassification"),$d=o(" forward method, overrides the "),Po=a("code"),qd=o("__call__"),Fd=o(" special method."),Md=l(),_(Be.$$.fragment),Cd=l(),jo=a("p"),Pd=o("Examples:"),jd=l(),_(Dt.$$.fragment),us=l(),Le=a("h2"),We=a("a"),Ao=a("span"),_(Bt.$$.fragment),Ad=l(),Io=a("span"),Id=o("LukeForEntitySpanClassification"),ms=l(),I=a("div"),_(Wt.$$.fragment),Od=l(),Oo=a("p"),Sd=o(`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
such as named entity recognition.`),Nd=l(),Ut=a("p"),Dd=o("This model inherits from "),xn=a("a"),Bd=o("PreTrainedModel"),Wd=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud=l(),Kt=a("p"),Kd=o("This model is also a PyTorch "),Rt=a("a"),Rd=o("torch.nn.Module"),Hd=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vd=l(),B=a("div"),_(Ht.$$.fragment),Yd=l(),we=a("p"),Qd=o("The "),$n=a("a"),Jd=o("LukeForEntitySpanClassification"),Xd=o(" forward method, overrides the "),So=a("code"),Gd=o("__call__"),Zd=o(" special method."),el=l(),_(Ue.$$.fragment),tl=l(),No=a("p"),nl=o("Examples:"),ol=l(),_(Vt.$$.fragment),this.h()},l(n){const p=rp('[data-svelte="svelte-1phssyn"]',document.head);h=r(p,"META",{name:!0,content:!0}),p.forEach(t),E=c(n),m=r(n,"H1",{class:!0});var Yt=i(m);L=r(Yt,"A",{id:!0,class:!0,href:!0});var Do=i(L);w=r(Do,"SPAN",{});var Bo=i(w);k(g.$$.fragment,Bo),Bo.forEach(t),Do.forEach(t),f=c(Yt),z=r(Yt,"SPAN",{});var Wo=i(z);Ds=s(Wo,"LUKE"),Wo.forEach(t),Yt.forEach(t),Ho=c(n),le=r(n,"H2",{class:!0});var Qt=i(le);xe=r(Qt,"A",{id:!0,class:!0,href:!0});var il=i(xe);Nn=r(il,"SPAN",{});var dl=i(Nn);k(He.$$.fragment,dl),dl.forEach(t),il.forEach(t),Bs=c(Qt),Dn=r(Qt,"SPAN",{});var ll=i(Dn);Ws=s(ll,"Overview"),ll.forEach(t),Qt.forEach(t),Vo=c(n),$e=r(n,"P",{});var gs=i($e);Us=s(gs,"The LUKE model was proposed in "),Ve=r(gs,"A",{href:!0,rel:!0});var cl=i(Ve);Ks=s(cl,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),cl.forEach(t),Rs=s(gs,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),ul.forEach(t),hl.forEach(t),Jo=c(n),Gt=r(n,"P",{});var ml=i(Gt);Ys=s(ml,"Tips:"),ml.forEach(t),Xo=c(n),R=r(n,"UL",{});var Ke=i(R);Wn=r(Ke,"LI",{});var fl=i(Wn);Ye=r(fl,"P",{});var _s=i(Ye);Qs=s(_s,"This implementation is the same as "),Zt=r(_s,"A",{href:!0});var gl=i(Zt);Js=s(gl,"RobertaModel"),gl.forEach(t),Xs=s(_s,` with the addition of entity embeddings as well
...
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
question answering.`),al.forEach(t),ys.forEach(t),ks.forEach(t),Ea=c(Ke),U=r(Ke,"LI",{});var X=i(U);Zn=r(X,"P",{});var ql=i(Zn);za=s(ql,"There are three head models for the former use case:"),ql.forEach(t),xa=c(X),ce=r(X,"UL",{});var qn=i(ce);qe=r(qn,"LI",{});var Uo=i(qe);sn=r(Uo,"A",{href:!0});var Fl=i(sn);$a=s(Fl,"LukeForEntityClassification"),Fl.forEach(t),qa=s(Uo,`, for tasks to classify a single entity in an input text such as
entity typing, e.g. the `),Xe=r(Uo,"A",{href:!0,rel:!0});var Ml=i(Xe);Fa=s(Ml,"Open Entity dataset"),Ml.forEach(t),Ma=s(Uo,`.
This model places a linear head on top of the output entity representation.`),Uo.forEach(t),Ca=c(qn),Fe=r(qn,"LI",{});var Ko=i(Fe);an=r(Ko,"A",{href:!0});var Cl=i(an);Pa=s(Cl,"LukeForEntityPairClassification"),Cl.forEach(t),ja=s(Ko,`, for tasks to classify the relationship between two entities
...
model places a linear head on top of the concatenated output representation of the pair of given entities.`),Ko.forEach(t),Oa=c(qn),rn=r(qn,"LI",{});var rl=i(rn);dn=r(rl,"A",{href:!0});var jl=i(dn);Sa=s(jl,"LukeForEntitySpanClassification"),jl.forEach(t),Na=s(rl,`, for tasks to classify the sequence of entity spans, such as
named entity recognition (NER). This model places a linear head on top of the output entity representations. You
...
documentation from `),mn=r(Mn,"A",{href:!0});var Gl=i(mn);Er=s(Gl,"PretrainedConfig"),Gl.forEach(t),zr=s(Mn," for more information."),Mn.forEach(t),xr=c(G),ro=r(G,"P",{});var Zl=i(ro);$r=s(Zl,"Examples:"),Zl.forEach(t),qr=c(G),k(lt.$$.fragment,G),G.forEach(t),os=c(n),me=r(n,"H2",{class:!0});var Ls=i(me);Ce=r(Ls,"A",{id:!0,class:!0,href:!0});var ec=i(Ce);io=r(ec,"SPAN",{});var tc=i(io);k(ct.$$.fragment,tc),tc.forEach(t),ec.forEach(t),Fr=c(Ls),lo=r(Ls,"SPAN",{});var nc=i(lo);Mr=s(nc,"LukeTokenizer"),nc.forEach(t),Ls.forEach(t),ss=c(n),M=r(n,"DIV",{class:!0});var Z=i(M);k(pt.$$.fragment,Z),Cr=c(Z),co=r(Z,"P",{});var oc=i(co);Pr=s(oc,"Construct a LUKE tokenizer."),oc.forEach(t),jr=c(Z),x=r(Z,"P",{});var $=i(x);Ar=s($,"This tokenizer inherits from "),fn=r($,"A",{href:!0});var sc=i(fn);Ir=s(sc,"RobertaTokenizer"),sc.forEach(t),Or=s($,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),gn=r($,"A",{href:!0});var ac=i(gn);Sr=s(ac,"RobertaTokenizer"),ac.forEach(t),Nr=s($,", "),_n=r($,"A",{href:!0});var rc=i(_n);Dr=s(rc,"LukeTokenizer"),rc.forEach(t),Br=s($,`
also creates entity sequences, namely `),po=r($,"CODE",{});var ic=i(po);Wr=s(ic,"entity_ids"),ic.forEach(t),Ur=s($,", "),ho=r($,"CODE",{});var dc=i(ho);Kr=s(dc,"entity_attention_mask"),dc.forEach(t),Rr=s($,", "),uo=r($,"CODE",{});var lc=i(uo);Hr=s(lc,"entity_token_type_ids"),lc.forEach(t),Vr=s($,`, and
...
masked entity prediction.`),Ec.forEach(t),xi=c(ne),Lt=r(ne,"P",{});var qs=i(Lt);$i=s(qs,"This model inherits from "),vn=r(qs,"A",{href:!0});var zc=i(vn);qi=s(zc,"PreTrainedModel"),zc.forEach(t),Fi=s(qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qs.forEach(t),Mi=c(ne),wt=r(ne,"P",{});var Fs=i(wt);Ci=s(Fs,"This model is also a PyTorch "),Et=r(Fs,"A",{href:!0,rel:!0});var xc=i(Et);Pi=s(xc,"torch.nn.Module"),xc.forEach(t),ji=s(Fs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fs.forEach(t),Ai=c(ne),J=r(ne,"DIV",{class:!0});var Pn=i(J);k(zt.$$.fragment,Pn),Ii=c(Pn),ke=r(Pn,"P",{});var jn=i(ke);Oi=s(jn,"The "),Tn=r(jn,"A",{href:!0});var $c=i(Tn);Si=s($c,"LukeForMaskedLM"),$c.forEach(t),Ni=s(jn," forward method, overrides the "),wo=r(jn,"CODE",{});var qc=i(wo);Di=s(qc,"__call__"),qc.forEach(t),Bi=s(jn," special method."),jn.forEach(t),Wi=c(Pn),k(Oe.$$.fragment,Pn),Pn.forEach(t),ne.forEach(t),ls=c(n),ye=r(n,"H2",{class:!0});var Ms=i(ye);Se=r(Ms,"A",{id:!0,class:!0,href:!0});var Fc=i(Se);Eo=r(Fc,"SPAN",{});var Mc=i(Eo);k(xt.$$.fragment,Mc),Mc.forEach(t),Fc.forEach(t),Ui=c(Ms),zo=r(Ms,"SPAN",{});var Cc=i(zo);Ki=s(Cc,"LukeForEntityClassification"),Cc.forEach(t),Ms.forEach(t),cs=c(n),j=r(n,"DIV",{class:!0});var oe=i(j);k($t.$$.fragment,oe),Ri=c(oe),xo=r(oe,"P",{});var Pc=i(xo);Hi=s(Pc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Pc.forEach(t),Vi=c(oe),qt=r(oe,"P",{});var Cs=i(qt);Yi=s(Cs,"This model inherits from "),Ln=r(Cs,"A",{href:!0});var jc=i(Ln);Qi=s(jc,"PreTrainedModel"),jc.forEach(t),Ji=s(Cs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cs.forEach(t),Xi=c(oe),Ft=r(oe,"P",{});var Ps=i(Ft);Gi=s(Ps,"This model is also a PyTorch "),Mt=r(Ps,"A",{href:!0,rel:!0});var Ac=i(Mt);Zi=s(Ac,"torch.nn.Module"),Ac.forEach(t),ed=s(Ps,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ps.forEach(t),td=c(oe),N=r(oe,"DIV",{class:!0});var se=i(N);k(Ct.$$.fragment,se),nd=c(se),be=r(se,"P",{});var An=i(be);od=s(An,"The "),wn=r(An,"A",{href:!0});var Ic=i(wn);sd=s(Ic,"LukeForEntityClassification"),Ic.forEach(t),ad=s(An," forward method, overrides the "),$o=r(An,"CODE",{});var Oc=i($o);rd=s(Oc,"__call__"),Oc.forEach(t),id=s(An," special method."),An.forEach(t),dd=c(se),k(Ne.$$.fragment,se),ld=c(se),qo=r(se,"P",{});var Sc=i(qo);cd=s(Sc,"Examples:"),Sc.forEach(t),pd=c(se),k(Pt.$$.fragment,se),se.forEach(t),oe.forEach(t),ps=c(n),ve=r(n,"H2",{class:!0});var js=i(ve);De=r(js,"A",{id:!0,class:!0,href:!0});var Nc=i(De);Fo=r(Nc,"SPAN",{});var Dc=i(Fo);k(jt.$$.fragment,Dc),Dc.forEach(t),Nc.forEach(t),hd=c(js),Mo=r(js,"SPAN",{});var Bc=i(Mo);ud=s(Bc,"LukeForEntityPairClassification"),Bc.forEach(t),js.forEach(t),hs=c(n),A=r(n,"DIV",{class:!0});var ae=i(A);k(At.$$.fragment,ae),md=c(ae),Co=r(ae,"P",{});var Wc=i(Co);fd=s(Wc,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
tokens) for entity pair classification tasks, such as TACRED.`),Wc.forEach(t),gd=c(ae),It=r(ae,"P",{});var As=i(It);_d=s(As,"This model inherits from "),En=r(As,"A",{href:!0});var Uc=i(En);kd=s(Uc,"PreTrainedModel"),Uc.forEach(t),yd=s(As,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
