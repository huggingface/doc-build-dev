...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(expected_translation_romanian, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs[<span class="hljs-string">&quot;labels&quot;</span>] = labels[<span class="hljs-string">&quot;input_ids&quot;</span>]`}}),la=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBartTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart/tokenization_mbart_fast.py#L163",parametersDescription:[{anchor:"transformers.MBartTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Ma=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ra=new q({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50TokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L221"}}),Wa=new q({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50TokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L236"}}),Ua=new U({}),Xa=new q({props:{name:"class transformers.MBartModel",anchor:"transformers.MBartModel",parameters:[{name:"config",val:": MBartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart/modeling_mbart.py#L1123",parametersDescription:[{anchor:"transformers.MBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15658/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15658/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ja=new q({props:{name:"forward",anchor:"transformers.MBartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart/modeling_mbart.py#L1150",parametersDescription:[{anchor:"transformers.MBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15658/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15658/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15658/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Es=new U({}),Ps=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart/modeling_tf_mbart.py#L1311",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15658/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15658/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Lz]},$$scope:{ctx:E}}}),Is=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/mbart/modeling_tf_mbart.py#L1344",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15658/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15658/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15658/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_15658/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15658/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15658/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15658/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_h.forEach(t),kv=l(Lt),Ss=a(Lt,"P",{});var gh=s(Ss);bv=i(gh,"This model is also a "),As=a(gh,"A",{href:!0,rel:!0});var e5=s(As);vv=i(e5,"tf.keras.Model"),e5.forEach(t),yv=i(gh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gh.forEach(t),Tv=l(Lt),f(un.$$.fragment,Lt),Mv=l(Lt),ee=a(Lt,"DIV",{class:!0});var Re=s(ee);f(Is.$$.fragment,Re),wv=l(Re),wo=a(Re,"P",{});var Ui=s(wo);xv=i(Ui,"The "),zi=a(Ui,"A",{href:!0});var t5=s(zi);zv=i(t5,"TFMBartForConditionalGeneration"),t5.forEach(t),qv=i(Ui," forward method, overrides the "),sc=a(Ui,"CODE",{});var o5=s(sc);Bv=i(o5,"__call__"),o5.forEach(t),$v=i(Ui," special method."),Ui.forEach(t),Fv=l(Re),f(hn.$$.fragment,Re),jv=l(Re),rc=a(Re,"P",{});var n5=s(rc);Ev=i(n5,"Summarization example:"),n5.forEach(t),Pv=l(Re),f(Ns.$$.fragment,Re),Cv=l(Re),ic=a(Re,"P",{});var a5=s(ic);Sv=i(a5,"Mask filling example:"),a5.forEach(t),Av=l(Re),f(Os.$$.fragment,Re),Re.forEach(t),Lt.forEach(t),tu=l(o),xo=a(o,"H2",{class:!0});var kh=s(xo);mn=a(kh,"A",{id:!0,class:!0,href:!0});var s5=s(mn);dc=a(s5,"SPAN",{});var r5=s(dc);f(Ds.$$.fragment,r5),r5.forEach(t),s5.forEach(t),Iv=l(kh),lc=a(kh,"SPAN",{});var i5=s(lc);Nv=i(i5,"FlaxMBartModel"),i5.forEach(t),kh.forEach(t),ou=l(o),R=a(o,"DIV",{class:!0});var me=s(R);f(Ls.$$.fragment,me),Ov=l(me),Gs=a(me,"P",{});var bh=s(Gs);Dv=i(bh,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(bh,"A",{href:!0});var d5=s(qi);Lv=i(d5,"FlaxPreTrainedModel"),d5.forEach(t),Gv=i(bh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bh.forEach(t),Rv=l(me),Rs=a(me,"P",{});var vh=s(Rs);Wv=i(vh,`This model is also a Flax Linen
`),Ws=a(vh,"A",{href:!0,rel:!0});var l5=s(Ws);Uv=i(l5,"flax.nn.Module"),l5.forEach(t),Xv=i(vh,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),vh.forEach(t),Hv=l(me),cc=a(me,"P",{});var c5=s(cc);Vv=i(c5,"Finally, this model supports inherent JAX features such as:"),c5.forEach(t),Qv=l(me),mt=a(me,"UL",{});var $n=s(mt);pc=a($n,"LI",{});var p5=s(pc);Us=a(p5,"A",{href:!0,rel:!0});var u5=s(Us);Jv=i(u5,"Just-In-Time (JIT) compilation"),u5.forEach(t),p5.forEach(t),Kv=l($n),uc=a($n,"LI",{});var h5=s(uc);Xs=a(h5,"A",{href:!0,rel:!0});var m5=s(Xs);Zv=i(m5,"Automatic Differentiation"),m5.forEach(t),h5.forEach(t),Yv=l($n),hc=a($n,"LI",{});var f5=s(hc);Hs=a(f5,"A",{href:!0,rel:!0});var _5=s(Hs);ey=i(_5,"Vectorization"),_5.forEach(t),f5.forEach(t),ty=l($n),mc=a($n,"LI",{});var g5=s(mc);Vs=a(g5,"A",{href:!0,rel:!0});var k5=s(Vs);oy=i(k5,"Parallelization"),k5.forEach(t),g5.forEach(t),$n.forEach(t),ny=l(me),Ne=a(me,"DIV",{class:!0});var Gt=s(Ne);f(Qs.$$.fragment,Gt),ay=l(Gt),zo=a(Gt,"P",{});var Xi=s(zo);sy=i(Xi,"The "),fc=a(Xi,"CODE",{});var b5=s(fc);ry=i(b5,"FlaxMBartPreTrainedModel"),b5.forEach(t),iy=i(Xi,"forward method, overrides the "),_c=a(Xi,"CODE",{});var v5=s(_c);dy=i(v5,"__call__"),v5.forEach(t),ly=i(Xi," special method."),Xi.forEach(t),cy=l(Gt),f(fn.$$.fragment,Gt),py=l(Gt),gc=a(Gt,"P",{});var y5=s(gc);uy=i(y5,"Example:"),y5.forEach(t),hy=l(Gt),f(Js.$$.fragment,Gt),Gt.forEach(t),my=l(me),Mt=a(me,"DIV",{class:!0});var Hi=s(Mt);f(Ks.$$.fragment,Hi),fy=l(Hi),kc=a(Hi,"P",{});var T5=s(kc);_y=i(T5,"Example:"),T5.forEach(t),gy=l(Hi),f(Zs.$$.fragment,Hi),Hi.forEach(t),ky=l(me),wt=a(me,"DIV",{class:!0});var Vi=s(wt);f(Ys.$$.fragment,Vi),by=l(Vi),bc=a(Vi,"P",{});var M5=s(bc);vy=i(M5,"Example:"),M5.forEach(t),yy=l(Vi),f(er.$$.fragment,Vi),Vi.forEach(t),me.forEach(t),nu=l(o),qo=a(o,"H2",{class:!0});var yh=s(qo);_n=a(yh,"A",{id:!0,class:!0,href:!0});var w5=s(_n);vc=a(w5,"SPAN",{});var x5=s(vc);f(tr.$$.fragment,x5),x5.forEach(t),w5.forEach(t),Ty=l(yh),yc=a(yh,"SPAN",{});var z5=s(yc);My=i(z5,"FlaxMBartForConditionalGeneration"),z5.forEach(t),yh.forEach(t),au=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);f(or.$$.fragment,fe),wy=l(fe),nr=a(fe,"P",{});var Th=s(nr);xy=i(Th,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Bi=a(Th,"A",{href:!0});var q5=s(Bi);zy=i(q5,"FlaxPreTrainedModel"),q5.forEach(t),qy=i(Th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Th.forEach(t),By=l(fe),ar=a(fe,"P",{});var Mh=s(ar);$y=i(Mh,`This model is also a Flax Linen
`),sr=a(Mh,"A",{href:!0,rel:!0});var B5=s(sr);Fy=i(B5,"flax.nn.Module"),B5.forEach(t),jy=i(Mh,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mh.forEach(t),Ey=l(fe),Tc=a(fe,"P",{});var $5=s(Tc);Py=i($5,"Finally, this model supports inherent JAX features such as:"),$5.forEach(t),Cy=l(fe),ft=a(fe,"UL",{});var Fn=s(ft);Mc=a(Fn,"LI",{});var F5=s(Mc);rr=a(F5,"A",{href:!0,rel:!0});var j5=s(rr);Sy=i(j5,"Just-In-Time (JIT) compilation"),j5.forEach(t),F5.forEach(t),Ay=l(Fn),wc=a(Fn,"LI",{});var E5=s(wc);ir=a(E5,"A",{href:!0,rel:!0});var P5=s(ir);Iy=i(P5,"Automatic Differentiation"),P5.forEach(t),E5.forEach(t),Ny=l(Fn),xc=a(Fn,"LI",{});var C5=s(xc);dr=a(C5,"A",{href:!0,rel:!0});var S5=s(dr);Oy=i(S5,"Vectorization"),S5.forEach(t),C5.forEach(t),Dy=l(Fn),zc=a(Fn,"LI",{});var A5=s(zc);lr=a(A5,"A",{href:!0,rel:!0});var I5=s(lr);Ly=i(I5,"Parallelization"),I5.forEach(t),A5.forEach(t),Fn.forEach(t),Gy=l(fe),te=a(fe,"DIV",{class:!0});var We=s(te);f(cr.$$.fragment,We),Ry=l(We),Bo=a(We,"P",{});var Qi=s(Bo);Wy=i(Qi,"The "),qc=a(Qi,"CODE",{});var N5=s(qc);Uy=i(N5,"FlaxMBartPreTrainedModel"),N5.forEach(t),Xy=i(Qi,"forward method, overrides the "),Bc=a(Qi,"CODE",{});var O5=s(Bc);Hy=i(O5,"__call__"),O5.forEach(t),Vy=i(Qi," special method."),Qi.forEach(t),Qy=l(We),f(gn.$$.fragment,We),Jy=l(We),$c=a(We,"P",{});var D5=s($c);Ky=i(D5,"Summarization example:"),D5.forEach(t),Zy=l(We),f(pr.$$.fragment,We),Yy=l(We),Fc=a(We,"P",{});var L5=s(Fc);eT=i(L5,"Mask filling example:"),L5.forEach(t),tT=l(We),f(ur.$$.fragment,We),We.forEach(t),oT=l(fe),xt=a(fe,"DIV",{class:!0});var Ji=s(xt);f(hr.$$.fragment,Ji),nT=l(Ji),jc=a(Ji,"P",{});var G5=s(jc);aT=i(G5,"Example:"),G5.forEach(t),sT=l(Ji),f(mr.$$.fragment,Ji),Ji.forEach(t),rT=l(fe),zt=a(fe,"DIV",{class:!0});var Ki=s(zt);f(fr.$$.fragment,Ki),iT=l(Ki),Ec=a(Ki,"P",{});var R5=s(Ec);dT=i(R5,"Example:"),R5.forEach(t),lT=l(Ki),f(_r.$$.fragment,Ki),Ki.forEach(t),fe.forEach(t),su=l(o),$o=a(o,"H2",{class:!0});var wh=s($o);kn=a(wh,"A",{id:!0,class:!0,href:!0});var W5=s(kn);Pc=a(W5,"SPAN",{});var U5=s(Pc);f(gr.$$.fragment,U5),U5.forEach(t),W5.forEach(t),cT=l(wh),Cc=a(wh,"SPAN",{});var X5=s(Cc);pT=i(X5,"FlaxMBartForSequenceClassification"),X5.forEach(t),wh.forEach(t),ru=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(kr.$$.fragment,oe),uT=l(oe),Sc=a(oe,"P",{});var H5=s(Sc);hT=i(H5,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),H5.forEach(t),mT=l(oe),br=a(oe,"P",{});var xh=s(br);fT=i(xh,"This model inherits from "),$i=a(xh,"A",{href:!0});var V5=s($i);_T=i(V5,"FlaxPreTrainedModel"),V5.forEach(t),gT=i(xh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xh.forEach(t),kT=l(oe),vr=a(oe,"P",{});var zh=s(vr);bT=i(zh,`This model is also a Flax Linen
`),yr=a(zh,"A",{href:!0,rel:!0});var Q5=s(yr);vT=i(Q5,"flax.nn.Module"),Q5.forEach(t),yT=i(zh,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zh.forEach(t),TT=l(oe),Ac=a(oe,"P",{});var J5=s(Ac);MT=i(J5,"Finally, this model supports inherent JAX features such as:"),J5.forEach(t),wT=l(oe),_t=a(oe,"UL",{});var jn=s(_t);Ic=a(jn,"LI",{});var K5=s(Ic);Tr=a(K5,"A",{href:!0,rel:!0});var Z5=s(Tr);xT=i(Z5,"Just-In-Time (JIT) compilation"),Z5.forEach(t),K5.forEach(t),zT=l(jn),Nc=a(jn,"LI",{});var Y5=s(Nc);Mr=a(Y5,"A",{href:!0,rel:!0});var ez=s(Mr);qT=i(ez,"Automatic Differentiation"),ez.forEach(t),Y5.forEach(t),BT=l(jn),Oc=a(jn,"LI",{});var tz=s(Oc);wr=a(tz,"A",{href:!0,rel:!0});var oz=s(wr);$T=i(oz,"Vectorization"),oz.forEach(t),tz.forEach(t),FT=l(jn),Dc=a(jn,"LI",{});var nz=s(Dc);xr=a(nz,"A",{href:!0,rel:!0});var az=s(xr);jT=i(az,"Parallelization"),az.forEach(t),nz.forEach(t),jn.forEach(t),ET=l(oe),Oe=a(oe,"DIV",{class:!0});var Rt=s(Oe);f(zr.$$.fragment,Rt),PT=l(Rt),Fo=a(Rt,"P",{});var Zi=s(Fo);CT=i(Zi,"The "),Lc=a(Zi,"CODE",{});var sz=s(Lc);ST=i(sz,"FlaxMBartPreTrainedModel"),sz.forEach(t),AT=i(Zi,"forward method, overrides the "),Gc=a(Zi,"CODE",{});var rz=s(Gc);IT=i(rz,"__call__"),rz.forEach(t),NT=i(Zi," special method."),Zi.forEach(t),OT=l(Rt),f(bn.$$.fragment,Rt),DT=l(Rt),Rc=a(Rt,"P",{});var iz=s(Rc);LT=i(iz,"Example:"),iz.forEach(t),GT=l(Rt),f(qr.$$.fragment,Rt),Rt.forEach(t),RT=l(oe),qt=a(oe,"DIV",{class:!0});var Yi=s(qt);f(Br.$$.fragment,Yi),WT=l(Yi),Wc=a(Yi,"P",{});var dz=s(Wc);UT=i(dz,"Example:"),dz.forEach(t),XT=l(Yi),f($r.$$.fragment,Yi),Yi.forEach(t),HT=l(oe),Bt=a(oe,"DIV",{class:!0});var ed=s(Bt);f(Fr.$$.fragment,ed),VT=l(ed),Uc=a(ed,"P",{});var lz=s(Uc);QT=i(lz,"Example:"),lz.forEach(t),JT=l(ed),f(jr.$$.fragment,ed),ed.forEach(t),oe.forEach(t),iu=l(o),jo=a(o,"H2",{class:!0});var qh=s(jo);vn=a(qh,"A",{id:!0,class:!0,href:!0});var cz=s(vn);Xc=a(cz,"SPAN",{});var pz=s(Xc);f(Er.$$.fragment,pz),pz.forEach(t),cz.forEach(t),KT=l(qh),Hc=a(qh,"SPAN",{});var uz=s(Hc);ZT=i(uz,"FlaxMBartForQuestionAnswering"),uz.forEach(t),qh.forEach(t),du=l(o),N=a(o,"DIV",{class:!0});var ne=s(N);f(Pr.$$.fragment,ne),YT=l(ne),Eo=a(ne,"P",{});var td=s(Eo);eM=i(td,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
