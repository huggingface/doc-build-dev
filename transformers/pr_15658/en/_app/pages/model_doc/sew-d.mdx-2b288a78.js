import{S as Es,i as Ss,s as Ws,e as n,k as d,w as v,t as r,L as Ds,c as a,d as o,m as c,a as s,x as w,h as i,b as l,J as e,g as f,y as b,q as y,o as E,B as S}from"../../chunks/vendor-9e2b328e.js";import{T as ka}from"../../chunks/Tip-76f97a76.js";import{D as Je}from"../../chunks/Docstring-50fd6873.js";import{C as ft}from"../../chunks/CodeBlock-88e23343.js";import{I as ht}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function ks(N){let m,W,h,_,D;return{c(){m=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),D=r(`
...
instance of <a href="/docs/transformers/pr_15658/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.SEWDConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_15658/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.SEWDConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_15658/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15658/en/model_doc/sew-d#transformers.SEWDConfig"
...
<span class="hljs-number">0.21</span>`}}),ze=new ht({}),Ae=new Je({props:{name:"class transformers.SEWDForSequenceClassification",anchor:"transformers.SEWDForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/sew_d/modeling_sew_d.py#L1633",parametersDescription:[{anchor:"transformers.SEWDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15658/en/model_doc/sew-d#transformers.SEWDConfig">SEWDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15658/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oe=new Je({props:{name:"forward",anchor:"transformers.SEWDForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15658/src/transformers/models/sew_d/modeling_sew_d.py#L1678",parametersDescription:[{anchor:"transformers.SEWDForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_15658/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){m=n("meta"),W=d(),h=n("h1"),_=n("a"),D=n("span"),v(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Vt=d(),K=n("h2"),Z=n("a"),ut=n("span"),v(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),Lt=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),pe=n("a"),Eo=r(`Performance-Efficiency Trade-offs
in Unsupervised Pre-training for Speech Recognition`),So=r(` by Felix Wu, Kwangyoun Kim,
Jing Pan, Kyu Han, Kilian Q. Weinberger, Yoav Artzi.`),It=d(),Qe=n("p"),Wo=r("The abstract from the paper is the following:"),Nt=d(),Ye=n("p"),_t=n("em"),Do=r(`This paper is a study of performance-efficiency trade-offs in pre-trained models for automatic speech recognition
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),In=d(),C=n("div"),v(Pe.$$.fragment),Nn=d(),B=n("p"),Kn=r("The "),at=n("a"),On=r("SEWDForCTC"),Hn=r(" forward method, overrides the "),$t=n("code"),Rn=r("__call__"),Un=r(" special method."),Jn=d(),v(ie.$$.fragment),Qn=d(),qt=n("p"),Yn=r("Example:"),Bn=d(),v(Fe.$$.fragment),Gn=d(),v(Me.$$.fragment),Gt=d(),G=n("h2"),le=n("a"),xt=n("span"),v(ze.$$.fragment),Xn=d(),jt=n("span"),Zn=r("SEWDForSequenceClassification"),Xt=d(),k=n("div"),v(Ae.$$.fragment),ea=d(),Pt=n("p"),ta=r(`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),oa=d(),Ve=n("p"),na=r("SEW-D was proposed in "),Le=n("a"),aa=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),sa=r(` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),ra=d(),Ie=n("p"),ia=r("This model inherits from "),st=n("a"),la=r("PreTrainedModel"),da=r(`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(V),P=a(V,"DIV",{class:!0});var L=s(P);w(De.$$.fragment,L),hn=c(L),J=a(L,"P",{});var dt=s(J);un=i(dt,"The "),ot=a(dt,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWDModel"),Za.forEach(o),_n=i(dt," forward method, overrides the "),Wt=a(dt,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(L),w(se.$$.fragment,L),yn=c(L),Dt=a(L,"P",{});var ts=s(Dt);En=i(ts,"Example:"),ts.forEach(o),Sn=c(L),w(ke.$$.fragment,L),L.forEach(o),V.forEach(o),Yt=c(t),Q=a(t,"H2",{class:!0});var po=s(Q);re=a(po,"A",{id:!0,class:!0,href:!0});var os=s(re);kt=a(os,"SPAN",{});var ns=s(kt);w(Ce.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=c(po),Ct=a(po,"SPAN",{});var as=s(Ct);Dn=i(as,"SEWDForCTC"),as.forEach(o),po.forEach(o),Bt=c(t),x=a(t,"DIV",{class:!0});var I=s(x);w(Te.$$.fragment,I),kn=c(I),Y=a(I,"P",{});var ct=s(Y);Cn=i(ct,"SEW-D Model with a "),Tt=a(ct,"CODE",{});var ss=s(Tt);Tn=i(ss,"language modeling"),ss.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),ct.forEach(o),jn=c(I),qe=a(I,"P",{});var mo=s(qe);Pn=i(mo,"This model inherits from "),nt=a(mo,"A",{href:!0});var is=s(nt);Fn=i(is,"PreTrainedModel"),is.forEach(o),Mn=i(mo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),mo.forEach(o),zn=c(I),xe=a(I,"P",{});var fo=s(xe);An=i(fo,"This model is a PyTorch "),je=a(fo,"A",{href:!0,rel:!0});var ls=s(je);Vn=i(ls,"torch.nn.Module"),ls.forEach(o),Ln=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),In=c(I),C=a(I,"DIV",{class:!0});var F=s(C);w(Pe.$$.fragment,F),Nn=c(F),B=a(F,"P",{});var pt=s(B);Kn=i(pt,"The "),at=a(pt,"A",{href:!0});var ds=s(at);On=i(ds,"SEWDForCTC"),ds.forEach(o),Hn=i(pt," forward method, overrides the "),$t=a(pt,"CODE",{});var cs=s($t);Rn=i(cs,"__call__"),cs.forEach(o),Un=i(pt," special method."),pt.forEach(o),Jn=c(F),w(ie.$$.fragment,F),Qn=c(F),qt=a(F,"P",{});var ps=s(qt);Yn=i(ps,"Example:"),ps.forEach(o),Bn=c(F),w(Fe.$$.fragment,F),Gn=c(F),w(Me.$$.fragment,F),F.forEach(o),I.forEach(o),Gt=c(t),G=a(t,"H2",{class:!0});var ho=s(G);le=a(ho,"A",{id:!0,class:!0,href:!0});var ms=s(le);xt=a(ms,"SPAN",{});var fs=s(xt);w(ze.$$.fragment,fs),fs.forEach(o),ms.forEach(o),Xn=c(ho),jt=a(ho,"SPAN",{});var hs=s(jt);Zn=i(hs,"SEWDForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=c(t),k=a(t,"DIV",{class:!0});var M=s(k);w(Ae.$$.fragment,M),ea=c(M),Pt=a(M,"P",{});var us=s(Pt);ta=i(us,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),us.forEach(o),oa=c(M),Ve=a(M,"P",{});var uo=s(Ve);na=i(uo,"SEW-D was proposed in "),Le=a(uo,"A",{href:!0,rel:!0});var gs=s(Le);aa=i(gs,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),gs.forEach(o),sa=i(uo,` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),uo.forEach(o),ra=c(M),Ie=a(M,"P",{});var go=s(Ie);ia=i(go,"This model inherits from "),st=a(go,"A",{href:!0});var _s=s(st);la=i(_s,"PreTrainedModel"),_s.forEach(o),da=i(go,`. Check the superclass documentation for the generic methods the
