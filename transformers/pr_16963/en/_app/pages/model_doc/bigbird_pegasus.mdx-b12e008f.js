...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16963/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/pr_16963/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16963/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16963/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2510",returnDescription:`
<p>A <a
...
<p>A <a
  href="/docs/transformers/pr_16963/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16963/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2781",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16963/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
documentation from `),Uo=n("a"),ra=i("PretrainedConfig"),ia=i(" for more information."),da=h(),y(fe.$$.fragment),la=h(),yt=n("blockquote"),wt=n("blockquote"),kt=n("blockquote"),Bt=n("p"),ca=i("from transformers import BigBirdPegasusModel, BigBirdPegasusConfig"),ua=h(),Tt=n("blockquote"),$t=n("blockquote"),so=n("blockquote"),_e=n("h1"),be=n("a"),Pt=n("span"),y(ao.$$.fragment),pa=h(),qt=n("span"),ha=i("Initializing a BigBirdPegasus bigbird-pegasus-base style configuration >>> configuration ="),ga=h(),zt=n("p"),ma=i("BigBirdPegasusConfig()"),fa=h(),Ft=n("blockquote"),xt=n("blockquote"),ro=n("blockquote"),ve=n("h1"),ye=n("a"),Ct=n("span"),y(io.$$.fragment),_a=h(),Et=n("span"),ba=i("Initializing a model from the bigbird-pegasus-base style configuration >>> model ="),va=h(),Mt=n("p"),ya=i("BigBirdPegasusModel(configuration)"),wa=h(),jt=n("blockquote"),St=n("blockquote"),At=n("blockquote"),we=n("h1"),ke=n("a"),Ot=n("span"),y(lo.$$.fragment),ka=h(),Lt=n("span"),Ba=i("Accessing the model configuration >>> configuration = model.config"),Bn=h(),oe=n("h2"),Be=n("a"),Nt=n("span"),y(co.$$.fragment),Ta=h(),It=n("span"),$a=i("BigBirdPegasusModel"),Tn=h(),L=n("div"),y(uo.$$.fragment),Pa=h(),po=n("p"),qa=i(`The bare BigBirdPegasus Model outputting raw hidden-states without any specific head on top.
...
linear layer on top of the hidden-states output to compute `),Zt=n("code"),Ar=i("span start logits"),Or=i(" and "),Yt=n("code"),Lr=i("span end logits"),Nr=i(")."),Ir=h(),xo=n("p"),Dr=i("This model inherits from "),Yo=n("a"),Qr=i("PreTrainedModel"),Wr=i(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xn.forEach(t),yr=g(U),F=s(U,"DIV",{class:!0});var A=a(F);w(qo.$$.fragment,A),wr=g(A),re=s(A,"P",{});var st=a(re);kr=d(st,"The "),Zo=s(st,"A",{href:!0});var gd=a(Zo);Br=d(gd,"BigBirdPegasusForSequenceClassification"),gd.forEach(t),Tr=d(st," forward method, overrides the "),Vt=s(st,"CODE",{});var md=a(Vt);$r=d(md,"__call__"),md.forEach(t),Pr=d(st," special method."),st.forEach(t),qr=g(A),w(xe.$$.fragment,A),zr=g(A),w(Ce.$$.fragment,A),Fr=g(A),w(Ee.$$.fragment,A),xr=g(A),w(Me.$$.fragment,A),Cr=g(A),w(je.$$.fragment,A),A.forEach(t),U.forEach(t),Fn=g(o),ie=s(o,"H2",{class:!0});var es=a(ie);Se=s(es,"A",{id:!0,class:!0,href:!0});var fd=a(Se);Kt=s(fd,"SPAN",{});var _d=a(Kt);w(zo.$$.fragment,_d),_d.forEach(t),fd.forEach(t),Er=g(es),Jt=s(es,"SPAN",{});var bd=a(Jt);Mr=d(bd,"BigBirdPegasusForQuestionAnswering"),bd.forEach(t),es.forEach(t),xn=g(o),M=s(o,"DIV",{class:!0});var H=a(M);w(Fo.$$.fragment,H),jr=g(H),de=s(H,"P",{});var at=a(de);Sr=d(at,`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
