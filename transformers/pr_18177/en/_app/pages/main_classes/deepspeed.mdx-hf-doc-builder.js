...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),up=new y({}),{c(){g=o("meta"),S=u(),b=o("h1"),k=o("a"),X=o("span"),f(z.$$.fragment),C=u(),Q=o("span"),x=a("DeepSpeed Integration"),te=u(),T=o("p"),q=o("a"),E=a("DeepSpeed"),gs=a(" implements everything described in the "),W=o("a"),bs=a("ZeRO paper"),c6=a(". Currently it provides full support for:"),yj=u(),R=o("ol"),Mh=o("li"),h6=a("Optimizer state partitioning (ZeRO stage 1)"),f6=u(),Lh=o("li"),d6=a("Gradient partitioning (ZeRO stage 2)"),m6=u(),Zh=o("li"),_6=a("Parameter partitioning (ZeRO stage 3)"),v6=u(),Nh=o("li"),j6=a("Custom mixed precision training handling"),w6=u(),Hh=o("li"),y6=a("A range of fast CUDA-extension-based optimizers"),g6=u(),Bh=o("li"),b6=a("ZeRO-Offload to CPU and NVMe"),gj=u(),Te=o("p"),q6=a("ZeRO-Offload has its own dedicated paper: "),Kn=o("a"),E6=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),$6=a(". And NVMe-support is described in the paper "),Jn=o("a"),k6=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),P6=a("."),bj=u(),kp=o("p"),z6=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),qj=u(),Pp=o("p"),D6=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),Ej=u(),wt=o("p"),O6=a("\u{1F917} Transformers integrates "),Xn=o("a"),A6=a("DeepSpeed"),T6=a(" via 2 options:"),$j=u(),yt=o("ol"),Qn=o("li"),S6=a("Integration of the core DeepSpeed features via "),zp=o("a"),C6=a("Trainer"),x6=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),R6=u(),F=o("li"),I6=a("If you don\u2019t use "),Dp=o("a"),U6=a("Trainer"),G6=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Wh=o("code"),M6=a("from_pretrained"),L6=a(" and "),Fh=o("code"),Z6=a("from_config"),N6=a(` include integration of essential
parts of DeepSpeed like `),Vh=o("code"),H6=a("zero.Init"),B6=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Op=o("a"),W6=a("deepspeed-non-trainer-integration"),F6=a("."),kj=u(),Ap=o("p"),V6=a("What is integrated:"),Pj=u(),Tp=o("p"),Y6=a("Training:"),zj=u(),Sp=o("ol"),Yh=o("li"),K6=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),Dj=u(),Cp=o("p"),J6=a("Inference:"),Oj=u(),xp=o("ol"),eo=o("li"),X6=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=o("a"),Q6=a("deepspeed-zero-inference"),e$=a("."),Aj=u(),Ip=o("p"),s$=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),Tj=u(),Up=o("a"),Sj=u(),qs=o("h2"),gt=o("a"),Kh=o("span"),f(so.$$.fragment),t$=u(),Jh=o("span"),a$=a("Trainer Deepspeed Integration"),Cj=u(),Gp=o("a"),xj=u(),Es=o("h3"),bt=o("a"),Xh=o("span"),f(to.$$.fragment),n$=u(),Qh=o("span"),o$=a("Installation"),Rj=u(),Mp=o("p"),l$=a("Install the library via pypi:"),Ij=u(),f(ao.$$.fragment),Uj=u(),Se=o("p"),r$=a("or via "),ef=o("code"),p$=a("transformers"),i$=a("\u2019 "),sf=o("code"),u$=a("extras"),c$=a(":"),Gj=u(),f(no.$$.fragment),Mj=u(),Ce=o("p"),h$=a("or find more details on "),oo=o("a"),f$=a("the DeepSpeed\u2019s GitHub page"),d$=a(` and
`),lo=o("a"),m$=a("advanced install"),_$=a("."),Lj=u(),qt=o("p"),v$=a("If you\u2019re still struggling with the build, first make sure to read "),Lp=o("a"),j$=a("zero-install-notes"),w$=a("."),Zj=u(),Zp=o("p"),y$=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),Nj=u(),Np=o("p"),g$=a("To make a local build for DeepSpeed:"),Hj=u(),f(ro.$$.fragment),Bj=u(),xe=o("p"),b$=a("If you intend to use NVMe offload you will also need to include "),tf=o("code"),q$=a("DS_BUILD_AIO=1"),E$=a(` in the instructions above (and also
install `),af=o("em"),$$=a("libaio-dev"),k$=a(" system-wide)."),Wj=u(),Et=o("p"),P$=a("Edit "),nf=o("code"),z$=a("TORCH_CUDA_ARCH_LIST"),D$=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),Fj=u(),f(po.$$.fragment),Vj=u(),ke=o("p"),O$=a("So if you get "),of=o("code"),A$=a("8, 6"),T$=a(", then use "),lf=o("code"),S$=a('TORCH_CUDA_ARCH_LIST="8.6"'),C$=a(`. If you have multiple different cards, you can list all
of them like so `),rf=o("code"),x$=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),Yj=u(),Hp=o("p"),R$=a("If you need to use the same setup on multiple machines, make a binary wheel:"),Kj=u(),f(io.$$.fragment),Jj=u(),Re=o("p"),I$=a("it will generate something like "),pf=o("code"),U$=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),G$=a(` which now you can install
as `),uf=o("code"),M$=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),L$=a(" locally or on any other machine."),Xj=u(),$t=o("p"),Z$=a("Again, remember to ensure to adjust "),cf=o("code"),N$=a("TORCH_CUDA_ARCH_LIST"),H$=a(" to the target architectures."),Qj=u(),Ie=o("p"),B$=a("You can find the complete list of NVIDIA GPUs and their corresponding "),hf=o("strong"),W$=a("Compute Capabilities"),F$=a(` (same as arch in this
context) `),uo=o("a"),V$=a("here"),Y$=a("."),ew=u(),Bp=o("p"),K$=a("You can check the archs pytorch was built with using:"),sw=u(),f(co.$$.fragment),tw=u(),Wp=o("p"),J$=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),aw=u(),f(ho.$$.fragment),nw=u(),Fp=o("p"),X$=a("If the output is:"),ow=u(),f(fo.$$.fragment),lw=u(),kt=o("p"),Q$=a("then you know that this card\u2019s arch is "),ff=o("code"),e5=a("8.6"),s5=a("."),rw=u(),Pt=o("p"),t5=a("You can also leave "),df=o("code"),a5=a("TORCH_CUDA_ARCH_LIST"),n5=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),pw=u(),zt=o("p"),o5=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=o("a"),l5=a("Deepspeed"),r5=a(","),iw=u(),Vp=o("a"),uw=u(),$s=o("h3"),Dt=o("a"),mf=o("span"),f(_o.$$.fragment),p5=u(),_f=o("span"),i5=a("Deployment with multiple GPUs"),cw=u(),Ot=o("p"),u5=a("To deploy this feature with multiple GPUs adjust the "),Yp=o("a"),c5=a("Trainer"),h5=a(` command line arguments as
following:`),hw=u(),At=o("ol"),ks=o("li"),f5=a("replace "),vf=o("code"),d5=a("python -m torch.distributed.launch"),m5=a(" with "),jf=o("code"),_5=a("deepspeed"),v5=a("."),j5=u(),Pe=o("li"),w5=a("add a new argument "),wf=o("code"),y5=a("--deepspeed ds_config.json"),g5=a(", where "),yf=o("code"),b5=a("ds_config.json"),q5=a(` is the DeepSpeed configuration file as
documented `),vo=o("a"),E5=a("here"),$5=a(". The file naming is up to you."),fw=u(),Kp=o("p"),k5=a("Therefore, if your original command line looked as follows:"),dw=u(),f(jo.$$.fragment),mw=u(),Jp=o("p"),P5=a("Now it should be:"),_w=u(),f(wo.$$.fragment),vw=u(),I=o("p"),z5=a("Unlike, "),gf=o("code"),D5=a("torch.distributed.launch"),O5=a(" where you have to specify how many GPUs to use with "),bf=o("code"),A5=a("--nproc_per_node"),T5=a(`, with the
`),qf=o("code"),S5=a("deepspeed"),C5=a(" launcher you don\u2019t have to use the corresponding "),Ef=o("code"),x5=a("--num_gpus"),R5=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=o("a"),I5=a("here"),U5=a("."),jw=u(),ae=o("p"),G5=a("In fact, you can continue using "),$f=o("code"),M5=a("-m torch.distributed.launch"),L5=a(` with DeepSpeed as long as you don\u2019t need to use
`),kf=o("code"),Z5=a("deepspeed"),N5=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Pf=o("code"),H5=a("deepspeed"),B5=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),ww=u(),Tt=o("p"),W5=a("Here is an example of running "),zf=o("code"),F5=a("run_translation.py"),V5=a(" under DeepSpeed deploying all available GPUs:"),yw=u(),f(go.$$.fragment),gw=u(),St=o("p"),Y5=a("Note that in the DeepSpeed documentation you are likely to see "),Df=o("code"),K5=a("--deepspeed --deepspeed_config ds_config.json"),J5=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),bw=u(),Ct=o("p"),X5=a("For some practical usage examples, please, see this "),bo=o("a"),Q5=a("post"),e4=a("."),qw=u(),Xp=o("a"),Ew=u(),Ps=o("h3"),xt=o("a"),Of=o("span"),f(qo.$$.fragment),s4=u(),Af=o("span"),t4=a("Deployment with one GPU"),$w=u(),Rt=o("p"),a4=a("To deploy DeepSpeed with one GPU adjust the "),Qp=o("a"),n4=a("Trainer"),o4=a(" command line arguments as follows:"),kw=u(),f(Eo.$$.fragment),Pw=u(),Ue=o("p"),l4=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Tf=o("code"),r4=a("--num_gpus=1"),p4=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),$o=o("a"),i4=a("documentation"),u4=a(" discusses the launcher options."),zw=u(),ei=o("p"),c4=a("Why would you want to use DeepSpeed with just one GPU?"),Dw=u(),It=o("ol"),Sf=o("li"),h4=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),f4=u(),Cf=o("li"),d4=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),Ow=u(),si=o("p"),m4=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),Aw=u(),f(ko.$$.fragment),Tw=u(),ti=o("p"),_4=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),Sw=u(),Ut=o("p"),v4=a("For a practical usage example of this type of deployment, please, see this "),Po=o("a"),j4=a("post"),w4=a("."),Cw=u(),ai=o("p"),y4=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),xw=u(),ni=o("p"),g4=a("Notes:"),Rw=u(),oi=o("ul"),zs=o("li"),zo=o("p"),b4=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),xf=o("code"),q4=a("CUDA_VISIBLE_DEVICES"),E4=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),$4=u(),f(Do.$$.fragment),k4=u(),Rf=o("p"),P4=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),Iw=u(),li=o("a"),Uw=u(),Ds=o("h3"),Gt=o("a"),If=o("span"),f(Oo.$$.fragment),z4=u(),Uf=o("span"),D4=a("Deployment in Notebooks"),Gw=u(),Mt=o("p"),O4=a("The problem with running notebook cells as a script is that there is no normal "),Gf=o("code"),A4=a("deepspeed"),T4=a(` launcher to rely on, so
under certain setups we have to emulate it.`),Mw=u(),ri=o("p"),S4=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),Lw=u(),f(Ao.$$.fragment),Zw=u(),Lt=o("p"),C4=a("Note: "),Mf=o("code"),x4=a("..."),R4=a(" stands for the normal arguments that you\u2019d pass to the functions."),Nw=u(),pi=o("p"),I4=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),Hw=u(),ii=o("p"),U4=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),Bw=u(),f(To.$$.fragment),Ww=u(),Ge=o("p"),G4=a("If the training script is in a normal file and not in the notebook cells, you can launch "),Lf=o("code"),M4=a("deepspeed"),L4=a(` normally via
shell from a cell. For example, to use `),Zf=o("code"),Z4=a("run_translation.py"),N4=a(" you would launch it with:"),Fw=u(),f(So.$$.fragment),Vw=u(),Zt=o("p"),H4=a("or with "),Nf=o("code"),B4=a("%%bash"),W4=a(" magic, where you can write a multi-line code for the shell program to run:"),Yw=u(),f(Co.$$.fragment),Kw=u(),ui=o("p"),F4=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),Jw=u(),Nt=o("p"),V4=a("Note: While "),Hf=o("code"),Y4=a("%%bash"),K4=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Xw=u(),ci=o("a"),Qw=u(),Os=o("h3"),Ht=o("a"),Bf=o("span"),f(xo.$$.fragment),J4=u(),Wf=o("span"),X4=a("Configuration"),ey=u(),Bt=o("p"),Q4=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Ro=o("a"),e7=a("following documentation"),s7=a("."),sy=u(),Wt=o("p"),t7=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Io=o("a"),a7=a(`the DeepSpeedExamples
repo`),n7=a(":"),ty=u(),f(Uo.$$.fragment),ay=u(),Ft=o("p"),o7=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Ff=o("code"),l7=a(".json"),r7=a(" files with:"),ny=u(),f(Go.$$.fragment),oy=u(),Vt=o("p"),p7=a("Some more examples are to be found in the "),Mo=o("a"),i7=a("main repo"),u7=a(" as well."),ly=u(),hi=o("p"),c7=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),ry=u(),ne=o("p"),h7=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Vf=o("code"),f7=a("AdamW"),d7=a(" optimizer and "),Yf=o("code"),m7=a("WarmupLR"),_7=a(` scheduler and will enable mixed
precision training if `),Kf=o("code"),v7=a("--fp16"),j7=a(" is passed:"),py=u(),f(Lo.$$.fragment),iy=u(),Yt=o("p"),w7=a("When you execute the program, DeepSpeed will log the configuration it received from the "),fi=o("a"),y7=a("Trainer"),g7=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),uy=u(),di=o("a"),cy=u(),As=o("h3"),Kt=o("a"),Jf=o("span"),f(Zo.$$.fragment),b7=u(),Xf=o("span"),q7=a("Passing Configuration"),hy=u(),U=o("p"),E7=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),mi=o("a"),$7=a("Trainer"),k7=a(" via "),_i=o("a"),P7=a("TrainingArguments"),z7=a(" then for the "),Qf=o("code"),D7=a("deepspeed"),O7=a(` argument you can
pass a nested `),ed=o("code"),A7=a("dict"),T7=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),vi=o("a"),S7=a("TrainingArguments"),C7=a("."),fy=u(),ji=o("p"),x7=a("To summarize you can do:"),dy=u(),f(No.$$.fragment),my=u(),wi=o("p"),R7=a("or:"),_y=u(),f(Ho.$$.fragment),vy=u(),yi=o("a"),jy=u(),Ts=o("h3"),Jt=o("a"),sd=o("span"),f(Bo.$$.fragment),I7=u(),td=o("span"),U7=a("Shared Configuration"),wy=u(),f(Xt.$$.fragment),yy=u(),Me=o("p"),G7=a("Some configuration values are required by both the "),gi=o("a"),M7=a("Trainer"),L7=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),bi=o("a"),Z7=a("Trainer"),N7=a(" command line arguments."),gy=u(),Qt=o("p"),H7=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),qi=o("a"),B7=a("Trainer"),W7=a(` do the majority
of configuration for you.`),by=u(),Le=o("p"),F7=a("Therefore, in the rest of this guide you will find a special configuration value: "),ad=o("code"),V7=a("auto"),Y7=a(`, which when set will be
...
`),Ei=o("a"),K7=a("Trainer"),J7=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),qy=u(),$i=o("p"),X7=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Ey=u(),ea=o("p"),Q7=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),ki=o("a"),e8=a("TrainingArguments"),s8=a(" based on that. The steps are:"),$y=u(),sa=o("ol"),nd=o("li"),t8=a("Create or load the DeepSpeed configuration to be used as a master configuration"),a8=u(),Wo=o("li"),n8=a("Create the "),Pi=o("a"),o8=a("TrainingArguments"),l8=a(" object based on these values"),ky=u(),oe=o("p"),r8=a("Do note that some values, such as "),od=o("code"),p8=a("scheduler.params.total_num_steps"),i8=a(` are calculated by
`),zi=o("a"),u8=a("Trainer"),c8=a(" during "),ld=o("code"),h8=a("train"),f8=a(", but you can of course do the math yourself."),Py=u(),Di=o("a"),zy=u(),Ss=o("h3"),ta=o("a"),rd=o("span"),f(Fo.$$.fragment),d8=u(),pd=o("span"),m8=a("ZeRO"),Dy=u(),Vo=o("p"),Yo=o("a"),_8=a("Zero Redundancy Optimizer (ZeRO)"),v8=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),Oy=u(),Ze=o("p"),j8=a("The "),id=o("code"),w8=a("zero_optimization"),y8=a(" section of the configuration file is the most important part ("),Ko=o("a"),g8=a("docs"),b8=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),Ay=u(),aa=o("p"),q8=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Oi=o("a"),E8=a("Trainer"),$8=a(` provides
no equivalent command line arguments.`),Ty=u(),Ai=o("p"),k8=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),Sy=u(),Ti=o("a"),Cy=u(),Cs=o("h4"),na=o("a"),ud=o("span"),f(Jo.$$.fragment),P8=u(),cd=o("span"),z8=a("ZeRO-2 Config"),xy=u(),Si=o("p"),D8=a("The following is an example of configuration for ZeRO stage 2:"),Ry=u(),f(Xo.$$.fragment),Iy=u(),Ci=o("p"),hd=o("strong"),O8=a("Performance tuning:"),Uy=u(),Ne=o("ul"),xs=o("li"),A8=a("enabling "),fd=o("code"),T8=a("offload_optimizer"),S8=a(" should reduce GPU RAM usage (it requires "),dd=o("code"),C8=a('"stage": 2'),x8=a(")"),R8=u(),G=o("li"),md=o("code"),I8=a('"overlap_comm": true'),U8=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),_d=o("code"),G8=a("overlap_comm"),M8=a(` uses 4.5x
the `),vd=o("code"),L8=a("allgather_bucket_size"),Z8=a(" and "),jd=o("code"),N8=a("reduce_bucket_size"),H8=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),wd=o("code"),B8=a("5e8 x 2Bytes x 2 x 4.5"),W8=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),yd=o("code"),F8=a("2e8"),V8=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),Y8=u(),gd=o("li"),K8=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),Gy=u(),He=o("p"),J8=a("Additionally, "),bd=o("code"),X8=a("deepspeed==0.4.4"),Q8=a(" added a new option "),qd=o("code"),ek=a("round_robin_gradients"),sk=a(" which you can enable with:"),My=u(),f(Qo.$$.fragment),Ly=u(),xi=o("p"),tk=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),Zy=u(),Ri=o("a"),Ny=u(),Rs=o("h4"),oa=o("a"),Ed=o("span"),f(el.$$.fragment),ak=u(),$d=o("span"),nk=a("ZeRO-3 Config"),Hy=u(),Ii=o("p"),ok=a("The following is an example of configuration for ZeRO stage 3:"),By=u(),f(sl.$$.fragment),Wy=u(),V=o("p"),lk=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),kd=o("code"),rk=a('"device": "cpu"'),pk=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Pd=o("code"),ik=a("none"),uk=a(" instead of "),zd=o("code"),ck=a("cpu"),hk=a(" for the "),Dd=o("code"),fk=a("device"),dk=a(` entry. Offloading to
NVMe is discussed further down.`),Fy=u(),Be=o("p"),mk=a("Pinned memory is enabled with "),Od=o("code"),_k=a("pin_memory"),vk=a(" set to "),Ad=o("code"),jk=a("true"),wk=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Vy=u(),Ui=o("p"),Td=o("strong"),yk=a("Performance tuning:"),Yy=u(),la=o("ul"),tl=o("li"),Sd=o("code"),gk=a("stage3_max_live_parameters"),bk=a(": "),Cd=o("code"),qk=a("1e9"),Ek=u(),al=o("li"),xd=o("code"),$k=a("stage3_max_reuse_distance"),kk=a(": "),Rd=o("code"),Pk=a("1e9"),Ky=u(),M=o("p"),zk=a("If hitting OOM reduce "),Id=o("code"),Dk=a("stage3_max_live_parameters"),Ok=a(" and "),Ud=o("code"),Ak=a("stage3_max_reuse_distance"),Tk=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Gd=o("code"),Sk=a("1e9"),Ck=a(` would consume ~2GB. The memory is shared by
`),Md=o("code"),xk=a("stage3_max_live_parameters"),Rk=a(" and "),Ld=o("code"),Ik=a("stage3_max_reuse_distance"),Uk=a(", so it\u2019s not additive, it\u2019s just 2GB total."),Jy=u(),ze=o("p"),Zd=o("code"),Gk=a("stage3_max_live_parameters"),Mk=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Nd=o("code"),Lk=a("stage3_max_reuse_distance"),Zk=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Hd=o("code"),Nk=a("stage3_max_reuse_distance"),Hk=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Xy=u(),Gi=o("p"),Bk=a("The following configuration values depend on the model\u2019s hidden size:"),Qy=u(),We=o("ul"),nl=o("li"),Bd=o("code"),Wk=a("reduce_bucket_size"),Fk=a(": "),Wd=o("code"),Vk=a("hidden_size*hidden_size"),Yk=u(),ol=o("li"),Fd=o("code"),Kk=a("stage3_prefetch_bucket_size"),Jk=a(": "),Vd=o("code"),Xk=a("0.9 * hidden_size * hidden_size"),Qk=u(),ll=o("li"),Yd=o("code"),e9=a("stage3_param_persistence_threshold"),s9=a(": "),Kd=o("code"),t9=a("10 * hidden_size"),eg=u(),Fe=o("p"),a9=a("therefore set these values to "),Jd=o("code"),n9=a("auto"),o9=a(" and the "),Mi=o("a"),l9=a("Trainer"),r9=a(` will automatically assign the recommended
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),jp=o("a"),mU=a("DeepSpeed GitHub"),_U=a("."),this.h()},l(e){const p=AY('[data-svelte="svelte-1phssyn"]',document.head);g=l(p,"META",{name:!0,content:!0}),p.forEach(t),S=c(e),b=l(e,"H1",{class:!0});var wp=r(b);k=l(wp,"A",{id:!0,class:!0,href:!0});var mj=r(k);X=l(mj,"SPAN",{});var _j=r(X);d(z.$$.fragment,_j),_j.forEach(t),mj.forEach(t),C=c(wp),Q=l(wp,"SPAN",{});var qU=r(Q);x=n(qU,"DeepSpeed Integration"),qU.forEach(t),wp.forEach(t),te=c(e),T=l(e,"P",{});var vj=r(T);q=l(vj,"A",{href:!0,rel:!0});var EU=r(q);E=n(EU,"DeepSpeed"),EU.forEach(t),gs=n(vj," implements everything described in the "),W=l(vj,"A",{href:!0,rel:!0});var $U=r(W);bs=n($U,"ZeRO paper"),$U.forEach(t),c6=n(vj,". Currently it provides full support for:"),vj.forEach(t),yj=c(e),R=l(e,"OL",{});var ve=r(R);Mh=l(ve,"LI",{});var kU=r(Mh);h6=n(kU,"Optimizer state partitioning (ZeRO stage 1)"),kU.forEach(t),f6=c(ve),Lh=l(ve,"LI",{});var PU=r(Lh);d6=n(PU,"Gradient partitioning (ZeRO stage 2)"),PU.forEach(t),m6=c(ve),Zh=l(ve,"LI",{});var zU=r(Zh);_6=n(zU,"Parameter partitioning (ZeRO stage 3)"),zU.forEach(t),v6=c(ve),Nh=l(ve,"LI",{});var DU=r(Nh);j6=n(DU,"Custom mixed precision training handling"),DU.forEach(t),w6=c(ve),Hh=l(ve,"LI",{});var OU=r(Hh);y6=n(OU,"A range of fast CUDA-extension-based optimizers"),OU.forEach(t),g6=c(ve),Bh=l(ve,"LI",{});var AU=r(Bh);b6=n(AU,"ZeRO-Offload to CPU and NVMe"),AU.forEach(t),ve.forEach(t),gj=c(e),Te=l(e,"P",{});var Yc=r(Te);q6=n(Yc,"ZeRO-Offload has its own dedicated paper: "),Kn=l(Yc,"A",{href:!0,rel:!0});var TU=r(Kn);E6=n(TU,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),TU.forEach(t),$6=n(Yc,". And NVMe-support is described in the paper "),Jn=l(Yc,"A",{href:!0,rel:!0});var SU=r(Jn);k6=n(SU,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),SU.forEach(t),P6=n(Yc,"."),Yc.forEach(t),bj=c(e),kp=l(e,"P",{});var CU=r(kp);z6=n(CU,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),CU.forEach(t),qj=c(e),Pp=l(e,"P",{});var xU=r(Pp);D6=n(xU,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),xU.forEach(t),Ej=c(e),wt=l(e,"P",{});var S0=r(wt);O6=n(S0,"\u{1F917} Transformers integrates "),Xn=l(S0,"A",{href:!0,rel:!0});var RU=r(Xn);A6=n(RU,"DeepSpeed"),RU.forEach(t),T6=n(S0," via 2 options:"),S0.forEach(t),$j=c(e),yt=l(e,"OL",{});var C0=r(yt);Qn=l(C0,"LI",{});var x0=r(Qn);S6=n(x0,"Integration of the core DeepSpeed features via "),zp=l(x0,"A",{href:!0});var IU=r(zp);C6=n(IU,"Trainer"),IU.forEach(t),x6=n(x0,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),x0.forEach(t),R6=c(C0),F=l(C0,"LI",{});var je=r(F);I6=n(je,"If you don\u2019t use "),Dp=l(je,"A",{href:!0});var UU=r(Dp);U6=n(UU,"Trainer"),UU.forEach(t),G6=n(je,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Wh=l(je,"CODE",{});var GU=r(Wh);M6=n(GU,"from_pretrained"),GU.forEach(t),L6=n(je," and "),Fh=l(je,"CODE",{});var MU=r(Fh);Z6=n(MU,"from_config"),MU.forEach(t),N6=n(je,` include integration of essential
parts of DeepSpeed like `),Vh=l(je,"CODE",{});var LU=r(Vh);H6=n(LU,"zero.Init"),LU.forEach(t),B6=n(je,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Op=l(je,"A",{href:!0});var ZU=r(Op);W6=n(ZU,"deepspeed-non-trainer-integration"),ZU.forEach(t),F6=n(je,"."),je.forEach(t),C0.forEach(t),kj=c(e),Ap=l(e,"P",{});var NU=r(Ap);V6=n(NU,"What is integrated:"),NU.forEach(t),Pj=c(e),Tp=l(e,"P",{});var HU=r(Tp);Y6=n(HU,"Training:"),HU.forEach(t),zj=c(e),Sp=l(e,"OL",{});var BU=r(Sp);Yh=l(BU,"LI",{});var WU=r(Yh);K6=n(WU,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),WU.forEach(t),BU.forEach(t),Dj=c(e),Cp=l(e,"P",{});var FU=r(Cp);J6=n(FU,"Inference:"),FU.forEach(t),Oj=c(e),xp=l(e,"OL",{});var VU=r(xp);eo=l(VU,"LI",{});var R0=r(eo);X6=n(R0,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(R0,"A",{href:!0});var YU=r(Rp);Q6=n(YU,"deepspeed-zero-inference"),YU.forEach(t),e$=n(R0,"."),R0.forEach(t),VU.forEach(t),Aj=c(e),Ip=l(e,"P",{});var KU=r(Ip);s$=n(KU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),KU.forEach(t),Tj=c(e),Up=l(e,"A",{id:!0}),r(Up).forEach(t),Sj=c(e),qs=l(e,"H2",{class:!0});var I0=r(qs);gt=l(I0,"A",{id:!0,class:!0,href:!0});var JU=r(gt);Kh=l(JU,"SPAN",{});var XU=r(Kh);d(so.$$.fragment,XU),XU.forEach(t),JU.forEach(t),t$=c(I0),Jh=l(I0,"SPAN",{});var QU=r(Jh);a$=n(QU,"Trainer Deepspeed Integration"),QU.forEach(t),I0.forEach(t),Cj=c(e),Gp=l(e,"A",{id:!0}),r(Gp).forEach(t),xj=c(e),Es=l(e,"H3",{class:!0});var U0=r(Es);bt=l(U0,"A",{id:!0,class:!0,href:!0});var eG=r(bt);Xh=l(eG,"SPAN",{});var sG=r(Xh);d(to.$$.fragment,sG),sG.forEach(t),eG.forEach(t),n$=c(U0),Qh=l(U0,"SPAN",{});var tG=r(Qh);o$=n(tG,"Installation"),tG.forEach(t),U0.forEach(t),Rj=c(e),Mp=l(e,"P",{});var aG=r(Mp);l$=n(aG,"Install the library via pypi:"),aG.forEach(t),Ij=c(e),d(ao.$$.fragment,e),Uj=c(e),Se=l(e,"P",{});var Kc=r(Se);r$=n(Kc,"or via "),ef=l(Kc,"CODE",{});var nG=r(ef);p$=n(nG,"transformers"),nG.forEach(t),i$=n(Kc,"\u2019 "),sf=l(Kc,"CODE",{});var oG=r(sf);u$=n(oG,"extras"),oG.forEach(t),c$=n(Kc,":"),Kc.forEach(t),Gj=c(e),d(no.$$.fragment,e),Mj=c(e),Ce=l(e,"P",{});var Jc=r(Ce);h$=n(Jc,"or find more details on "),oo=l(Jc,"A",{href:!0,rel:!0});var lG=r(oo);f$=n(lG,"the DeepSpeed\u2019s GitHub page"),lG.forEach(t),d$=n(Jc,` and
`),lo=l(Jc,"A",{href:!0,rel:!0});var rG=r(lo);m$=n(rG,"advanced install"),rG.forEach(t),_$=n(Jc,"."),Jc.forEach(t),Lj=c(e),qt=l(e,"P",{});var G0=r(qt);v$=n(G0,"If you\u2019re still struggling with the build, first make sure to read "),Lp=l(G0,"A",{href:!0});var pG=r(Lp);j$=n(pG,"zero-install-notes"),pG.forEach(t),w$=n(G0,"."),G0.forEach(t),Zj=c(e),Zp=l(e,"P",{});var iG=r(Zp);y$=n(iG,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),iG.forEach(t),Nj=c(e),Np=l(e,"P",{});var uG=r(Np);g$=n(uG,"To make a local build for DeepSpeed:"),uG.forEach(t),Hj=c(e),d(ro.$$.fragment,e),Bj=c(e),xe=l(e,"P",{});var Xc=r(xe);b$=n(Xc,"If you intend to use NVMe offload you will also need to include "),tf=l(Xc,"CODE",{});var cG=r(tf);q$=n(cG,"DS_BUILD_AIO=1"),cG.forEach(t),E$=n(Xc,` in the instructions above (and also
install `),af=l(Xc,"EM",{});var hG=r(af);$$=n(hG,"libaio-dev"),hG.forEach(t),k$=n(Xc," system-wide)."),Xc.forEach(t),Wj=c(e),Et=l(e,"P",{});var M0=r(Et);P$=n(M0,"Edit "),nf=l(M0,"CODE",{});var fG=r(nf);z$=n(fG,"TORCH_CUDA_ARCH_LIST"),fG.forEach(t),D$=n(M0,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),M0.forEach(t),Fj=c(e),d(po.$$.fragment,e),Vj=c(e),ke=l(e,"P",{});var yp=r(ke);O$=n(yp,"So if you get "),of=l(yp,"CODE",{});var dG=r(of);A$=n(dG,"8, 6"),dG.forEach(t),T$=n(yp,", then use "),lf=l(yp,"CODE",{});var mG=r(lf);S$=n(mG,'TORCH_CUDA_ARCH_LIST="8.6"'),mG.forEach(t),C$=n(yp,`. If you have multiple different cards, you can list all
of them like so `),rf=l(yp,"CODE",{});var _G=r(rf);x$=n(_G,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),_G.forEach(t),yp.forEach(t),Yj=c(e),Hp=l(e,"P",{});var vG=r(Hp);R$=n(vG,"If you need to use the same setup on multiple machines, make a binary wheel:"),vG.forEach(t),Kj=c(e),d(io.$$.fragment,e),Jj=c(e),Re=l(e,"P",{});var Qc=r(Re);I$=n(Qc,"it will generate something like "),pf=l(Qc,"CODE",{});var jG=r(pf);U$=n(jG,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),jG.forEach(t),G$=n(Qc,` which now you can install
as `),uf=l(Qc,"CODE",{});var wG=r(uf);M$=n(wG,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wG.forEach(t),L$=n(Qc," locally or on any other machine."),Qc.forEach(t),Xj=c(e),$t=l(e,"P",{});var L0=r($t);Z$=n(L0,"Again, remember to ensure to adjust "),cf=l(L0,"CODE",{});var yG=r(cf);N$=n(yG,"TORCH_CUDA_ARCH_LIST"),yG.forEach(t),H$=n(L0," to the target architectures."),L0.forEach(t),Qj=c(e),Ie=l(e,"P",{});var eh=r(Ie);B$=n(eh,"You can find the complete list of NVIDIA GPUs and their corresponding "),hf=l(eh,"STRONG",{});var gG=r(hf);W$=n(gG,"Compute Capabilities"),gG.forEach(t),F$=n(eh,` (same as arch in this
context) `),uo=l(eh,"A",{href:!0,rel:!0});var bG=r(uo);V$=n(bG,"here"),bG.forEach(t),Y$=n(eh,"."),eh.forEach(t),ew=c(e),Bp=l(e,"P",{});var qG=r(Bp);K$=n(qG,"You can check the archs pytorch was built with using:"),qG.forEach(t),sw=c(e),d(co.$$.fragment,e),tw=c(e),Wp=l(e,"P",{});var EG=r(Wp);J$=n(EG,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),EG.forEach(t),aw=c(e),d(ho.$$.fragment,e),nw=c(e),Fp=l(e,"P",{});var $G=r(Fp);X$=n($G,"If the output is:"),$G.forEach(t),ow=c(e),d(fo.$$.fragment,e),lw=c(e),kt=l(e,"P",{});var Z0=r(kt);Q$=n(Z0,"then you know that this card\u2019s arch is "),ff=l(Z0,"CODE",{});var kG=r(ff);e5=n(kG,"8.6"),kG.forEach(t),s5=n(Z0,"."),Z0.forEach(t),rw=c(e),Pt=l(e,"P",{});var N0=r(Pt);t5=n(N0,"You can also leave "),df=l(N0,"CODE",{});var PG=r(df);a5=n(PG,"TORCH_CUDA_ARCH_LIST"),PG.forEach(t),n5=n(N0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),N0.forEach(t),pw=c(e),zt=l(e,"P",{});var H0=r(zt);o5=n(H0,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=l(H0,"A",{href:!0,rel:!0});var zG=r(mo);l5=n(zG,"Deepspeed"),zG.forEach(t),r5=n(H0,","),H0.forEach(t),iw=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),uw=c(e),$s=l(e,"H3",{class:!0});var B0=r($s);Dt=l(B0,"A",{id:!0,class:!0,href:!0});var DG=r(Dt);mf=l(DG,"SPAN",{});var OG=r(mf);d(_o.$$.fragment,OG),OG.forEach(t),DG.forEach(t),p5=c(B0),_f=l(B0,"SPAN",{});var AG=r(_f);i5=n(AG,"Deployment with multiple GPUs"),AG.forEach(t),B0.forEach(t),cw=c(e),Ot=l(e,"P",{});var W0=r(Ot);u5=n(W0,"To deploy this feature with multiple GPUs adjust the "),Yp=l(W0,"A",{href:!0});var TG=r(Yp);c5=n(TG,"Trainer"),TG.forEach(t),h5=n(W0,` command line arguments as
following:`),W0.forEach(t),hw=c(e),At=l(e,"OL",{});var F0=r(At);ks=l(F0,"LI",{});var sh=r(ks);f5=n(sh,"replace "),vf=l(sh,"CODE",{});var SG=r(vf);d5=n(SG,"python -m torch.distributed.launch"),SG.forEach(t),m5=n(sh," with "),jf=l(sh,"CODE",{});var CG=r(jf);_5=n(CG,"deepspeed"),CG.forEach(t),v5=n(sh,"."),sh.forEach(t),j5=c(F0),Pe=l(F0,"LI",{});var Sn=r(Pe);w5=n(Sn,"add a new argument "),wf=l(Sn,"CODE",{});var xG=r(wf);y5=n(xG,"--deepspeed ds_config.json"),xG.forEach(t),g5=n(Sn,", where "),yf=l(Sn,"CODE",{});var RG=r(yf);b5=n(RG,"ds_config.json"),RG.forEach(t),q5=n(Sn,` is the DeepSpeed configuration file as
documented `),vo=l(Sn,"A",{href:!0,rel:!0});var IG=r(vo);E5=n(IG,"here"),IG.forEach(t),$5=n(Sn,". The file naming is up to you."),Sn.forEach(t),F0.forEach(t),fw=c(e),Kp=l(e,"P",{});var UG=r(Kp);k5=n(UG,"Therefore, if your original command line looked as follows:"),UG.forEach(t),dw=c(e),d(jo.$$.fragment,e),mw=c(e),Jp=l(e,"P",{});var GG=r(Jp);P5=n(GG,"Now it should be:"),GG.forEach(t),_w=c(e),d(wo.$$.fragment,e),vw=c(e),I=l(e,"P",{});var we=r(I);z5=n(we,"Unlike, "),gf=l(we,"CODE",{});var MG=r(gf);D5=n(MG,"torch.distributed.launch"),MG.forEach(t),O5=n(we," where you have to specify how many GPUs to use with "),bf=l(we,"CODE",{});var LG=r(bf);A5=n(LG,"--nproc_per_node"),LG.forEach(t),T5=n(we,`, with the
`),qf=l(we,"CODE",{});var ZG=r(qf);S5=n(ZG,"deepspeed"),ZG.forEach(t),C5=n(we," launcher you don\u2019t have to use the corresponding "),Ef=l(we,"CODE",{});var NG=r(Ef);x5=n(NG,"--num_gpus"),NG.forEach(t),R5=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=l(we,"A",{href:!0,rel:!0});var HG=r(yo);I5=n(HG,"here"),HG.forEach(t),U5=n(we,"."),we.forEach(t),jw=c(e),ae=l(e,"P",{});var Cn=r(ae);G5=n(Cn,"In fact, you can continue using "),$f=l(Cn,"CODE",{});var BG=r($f);M5=n(BG,"-m torch.distributed.launch"),BG.forEach(t),L5=n(Cn,` with DeepSpeed as long as you don\u2019t need to use
`),kf=l(Cn,"CODE",{});var WG=r(kf);Z5=n(WG,"deepspeed"),WG.forEach(t),N5=n(Cn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Pf=l(Cn,"CODE",{});var FG=r(Pf);H5=n(FG,"deepspeed"),FG.forEach(t),B5=n(Cn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Cn.forEach(t),ww=c(e),Tt=l(e,"P",{});var V0=r(Tt);W5=n(V0,"Here is an example of running "),zf=l(V0,"CODE",{});var VG=r(zf);F5=n(VG,"run_translation.py"),VG.forEach(t),V5=n(V0," under DeepSpeed deploying all available GPUs:"),V0.forEach(t),yw=c(e),d(go.$$.fragment,e),gw=c(e),St=l(e,"P",{});var Y0=r(St);Y5=n(Y0,"Note that in the DeepSpeed documentation you are likely to see "),Df=l(Y0,"CODE",{});var YG=r(Df);K5=n(YG,"--deepspeed --deepspeed_config ds_config.json"),YG.forEach(t),J5=n(Y0,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Y0.forEach(t),bw=c(e),Ct=l(e,"P",{});var K0=r(Ct);X5=n(K0,"For some practical usage examples, please, see this "),bo=l(K0,"A",{href:!0,rel:!0});var KG=r(bo);Q5=n(KG,"post"),KG.forEach(t),e4=n(K0,"."),K0.forEach(t),qw=c(e),Xp=l(e,"A",{id:!0}),r(Xp).forEach(t),Ew=c(e),Ps=l(e,"H3",{class:!0});var J0=r(Ps);xt=l(J0,"A",{id:!0,class:!0,href:!0});var JG=r(xt);Of=l(JG,"SPAN",{});var XG=r(Of);d(qo.$$.fragment,XG),XG.forEach(t),JG.forEach(t),s4=c(J0),Af=l(J0,"SPAN",{});var QG=r(Af);t4=n(QG,"Deployment with one GPU"),QG.forEach(t),J0.forEach(t),$w=c(e),Rt=l(e,"P",{});var X0=r(Rt);a4=n(X0,"To deploy DeepSpeed with one GPU adjust the "),Qp=l(X0,"A",{href:!0});var eM=r(Qp);n4=n(eM,"Trainer"),eM.forEach(t),o4=n(X0," command line arguments as follows:"),X0.forEach(t),kw=c(e),d(Eo.$$.fragment,e),Pw=c(e),Ue=l(e,"P",{});var th=r(Ue);l4=n(th,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Tf=l(th,"CODE",{});var sM=r(Tf);r4=n(sM,"--num_gpus=1"),sM.forEach(t),p4=n(th,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),$o=l(th,"A",{href:!0,rel:!0});var tM=r($o);i4=n(tM,"documentation"),tM.forEach(t),u4=n(th," discusses the launcher options."),th.forEach(t),zw=c(e),ei=l(e,"P",{});var aM=r(ei);c4=n(aM,"Why would you want to use DeepSpeed with just one GPU?"),aM.forEach(t),Dw=c(e),It=l(e,"OL",{});var Q0=r(It);Sf=l(Q0,"LI",{});var nM=r(Sf);h4=n(nM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),nM.forEach(t),f4=c(Q0),Cf=l(Q0,"LI",{});var oM=r(Cf);d4=n(oM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),oM.forEach(t),Q0.forEach(t),Ow=c(e),si=l(e,"P",{});var lM=r(si);m4=n(lM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),lM.forEach(t),Aw=c(e),d(ko.$$.fragment,e),Tw=c(e),ti=l(e,"P",{});var rM=r(ti);_4=n(rM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),rM.forEach(t),Sw=c(e),Ut=l(e,"P",{});var eq=r(Ut);v4=n(eq,"For a practical usage example of this type of deployment, please, see this "),Po=l(eq,"A",{href:!0,rel:!0});var pM=r(Po);j4=n(pM,"post"),pM.forEach(t),w4=n(eq,"."),eq.forEach(t),Cw=c(e),ai=l(e,"P",{});var iM=r(ai);y4=n(iM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),iM.forEach(t),xw=c(e),ni=l(e,"P",{});var uM=r(ni);g4=n(uM,"Notes:"),uM.forEach(t),Rw=c(e),oi=l(e,"UL",{});var cM=r(oi);zs=l(cM,"LI",{});var ah=r(zs);zo=l(ah,"P",{});var sq=r(zo);b4=n(sq,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),xf=l(sq,"CODE",{});var hM=r(xf);q4=n(hM,"CUDA_VISIBLE_DEVICES"),hM.forEach(t),E4=n(sq,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),sq.forEach(t),$4=c(ah),d(Do.$$.fragment,ah),k4=c(ah),Rf=l(ah,"P",{});var fM=r(Rf);P4=n(fM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),fM.forEach(t),ah.forEach(t),cM.forEach(t),Iw=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),Uw=c(e),Ds=l(e,"H3",{class:!0});var tq=r(Ds);Gt=l(tq,"A",{id:!0,class:!0,href:!0});var dM=r(Gt);If=l(dM,"SPAN",{});var mM=r(If);d(Oo.$$.fragment,mM),mM.forEach(t),dM.forEach(t),z4=c(tq),Uf=l(tq,"SPAN",{});var _M=r(Uf);D4=n(_M,"Deployment in Notebooks"),_M.forEach(t),tq.forEach(t),Gw=c(e),Mt=l(e,"P",{});var aq=r(Mt);O4=n(aq,"The problem with running notebook cells as a script is that there is no normal "),Gf=l(aq,"CODE",{});var vM=r(Gf);A4=n(vM,"deepspeed"),vM.forEach(t),T4=n(aq,` launcher to rely on, so
under certain setups we have to emulate it.`),aq.forEach(t),Mw=c(e),ri=l(e,"P",{});var jM=r(ri);S4=n(jM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),jM.forEach(t),Lw=c(e),d(Ao.$$.fragment,e),Zw=c(e),Lt=l(e,"P",{});var nq=r(Lt);C4=n(nq,"Note: "),Mf=l(nq,"CODE",{});var wM=r(Mf);x4=n(wM,"..."),wM.forEach(t),R4=n(nq," stands for the normal arguments that you\u2019d pass to the functions."),nq.forEach(t),Nw=c(e),pi=l(e,"P",{});var yM=r(pi);I4=n(yM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),yM.forEach(t),Hw=c(e),ii=l(e,"P",{});var gM=r(ii);U4=n(gM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),gM.forEach(t),Bw=c(e),d(To.$$.fragment,e),Ww=c(e),Ge=l(e,"P",{});var nh=r(Ge);G4=n(nh,"If the training script is in a normal file and not in the notebook cells, you can launch "),Lf=l(nh,"CODE",{});var bM=r(Lf);M4=n(bM,"deepspeed"),bM.forEach(t),L4=n(nh,` normally via
shell from a cell. For example, to use `),Zf=l(nh,"CODE",{});var qM=r(Zf);Z4=n(qM,"run_translation.py"),qM.forEach(t),N4=n(nh," you would launch it with:"),nh.forEach(t),Fw=c(e),d(So.$$.fragment,e),Vw=c(e),Zt=l(e,"P",{});var oq=r(Zt);H4=n(oq,"or with "),Nf=l(oq,"CODE",{});var EM=r(Nf);B4=n(EM,"%%bash"),EM.forEach(t),W4=n(oq," magic, where you can write a multi-line code for the shell program to run:"),oq.forEach(t),Yw=c(e),d(Co.$$.fragment,e),Kw=c(e),ui=l(e,"P",{});var $M=r(ui);F4=n($M,"In such case you don\u2019t need any of the code presented at the beginning of this section."),$M.forEach(t),Jw=c(e),Nt=l(e,"P",{});var lq=r(Nt);V4=n(lq,"Note: While "),Hf=l(lq,"CODE",{});var kM=r(Hf);Y4=n(kM,"%%bash"),kM.forEach(t),K4=n(lq,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),lq.forEach(t),Xw=c(e),ci=l(e,"A",{id:!0}),r(ci).forEach(t),Qw=c(e),Os=l(e,"H3",{class:!0});var rq=r(Os);Ht=l(rq,"A",{id:!0,class:!0,href:!0});var PM=r(Ht);Bf=l(PM,"SPAN",{});var zM=r(Bf);d(xo.$$.fragment,zM),zM.forEach(t),PM.forEach(t),J4=c(rq),Wf=l(rq,"SPAN",{});var DM=r(Wf);X4=n(DM,"Configuration"),DM.forEach(t),rq.forEach(t),ey=c(e),Bt=l(e,"P",{});var pq=r(Bt);Q4=n(pq,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Ro=l(pq,"A",{href:!0,rel:!0});var OM=r(Ro);e7=n(OM,"following documentation"),OM.forEach(t),s7=n(pq,"."),pq.forEach(t),sy=c(e),Wt=l(e,"P",{});var iq=r(Wt);t7=n(iq,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Io=l(iq,"A",{href:!0,rel:!0});var AM=r(Io);a7=n(AM,`the DeepSpeedExamples
repo`),AM.forEach(t),n7=n(iq,":"),iq.forEach(t),ty=c(e),d(Uo.$$.fragment,e),ay=c(e),Ft=l(e,"P",{});var uq=r(Ft);o7=n(uq,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Ff=l(uq,"CODE",{});var TM=r(Ff);l7=n(TM,".json"),TM.forEach(t),r7=n(uq," files with:"),uq.forEach(t),ny=c(e),d(Go.$$.fragment,e),oy=c(e),Vt=l(e,"P",{});var cq=r(Vt);p7=n(cq,"Some more examples are to be found in the "),Mo=l(cq,"A",{href:!0,rel:!0});var SM=r(Mo);i7=n(SM,"main repo"),SM.forEach(t),u7=n(cq," as well."),cq.forEach(t),ly=c(e),hi=l(e,"P",{});var CM=r(hi);c7=n(CM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),CM.forEach(t),ry=c(e),ne=l(e,"P",{});var xn=r(ne);h7=n(xn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Vf=l(xn,"CODE",{});var xM=r(Vf);f7=n(xM,"AdamW"),xM.forEach(t),d7=n(xn," optimizer and "),Yf=l(xn,"CODE",{});var RM=r(Yf);m7=n(RM,"WarmupLR"),RM.forEach(t),_7=n(xn,` scheduler and will enable mixed
precision training if `),Kf=l(xn,"CODE",{});var IM=r(Kf);v7=n(IM,"--fp16"),IM.forEach(t),j7=n(xn," is passed:"),xn.forEach(t),py=c(e),d(Lo.$$.fragment,e),iy=c(e),Yt=l(e,"P",{});var hq=r(Yt);w7=n(hq,"When you execute the program, DeepSpeed will log the configuration it received from the "),fi=l(hq,"A",{href:!0});var UM=r(fi);y7=n(UM,"Trainer"),UM.forEach(t),g7=n(hq,`
to the console, so you can see exactly what was the final configuration passed to it.`),hq.forEach(t),uy=c(e),di=l(e,"A",{id:!0}),r(di).forEach(t),cy=c(e),As=l(e,"H3",{class:!0});var fq=r(As);Kt=l(fq,"A",{id:!0,class:!0,href:!0});var GM=r(Kt);Jf=l(GM,"SPAN",{});var MM=r(Jf);d(Zo.$$.fragment,MM),MM.forEach(t),GM.forEach(t),b7=c(fq),Xf=l(fq,"SPAN",{});var LM=r(Xf);q7=n(LM,"Passing Configuration"),LM.forEach(t),fq.forEach(t),hy=c(e),U=l(e,"P",{});var ye=r(U);E7=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),mi=l(ye,"A",{href:!0});var ZM=r(mi);$7=n(ZM,"Trainer"),ZM.forEach(t),k7=n(ye," via "),_i=l(ye,"A",{href:!0});var NM=r(_i);P7=n(NM,"TrainingArguments"),NM.forEach(t),z7=n(ye," then for the "),Qf=l(ye,"CODE",{});var HM=r(Qf);D7=n(HM,"deepspeed"),HM.forEach(t),O7=n(ye,` argument you can
pass a nested `),ed=l(ye,"CODE",{});var BM=r(ed);A7=n(BM,"dict"),BM.forEach(t),T7=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),vi=l(ye,"A",{href:!0});var WM=r(vi);S7=n(WM,"TrainingArguments"),WM.forEach(t),C7=n(ye,"."),ye.forEach(t),fy=c(e),ji=l(e,"P",{});var FM=r(ji);x7=n(FM,"To summarize you can do:"),FM.forEach(t),dy=c(e),d(No.$$.fragment,e),my=c(e),wi=l(e,"P",{});var VM=r(wi);R7=n(VM,"or:"),VM.forEach(t),_y=c(e),d(Ho.$$.fragment,e),vy=c(e),yi=l(e,"A",{id:!0}),r(yi).forEach(t),jy=c(e),Ts=l(e,"H3",{class:!0});var dq=r(Ts);Jt=l(dq,"A",{id:!0,class:!0,href:!0});var YM=r(Jt);sd=l(YM,"SPAN",{});var KM=r(sd);d(Bo.$$.fragment,KM),KM.forEach(t),YM.forEach(t),I7=c(dq),td=l(dq,"SPAN",{});var JM=r(td);U7=n(JM,"Shared Configuration"),JM.forEach(t),dq.forEach(t),wy=c(e),d(Xt.$$.fragment,e),yy=c(e),Me=l(e,"P",{});var oh=r(Me);G7=n(oh,"Some configuration values are required by both the "),gi=l(oh,"A",{href:!0});var XM=r(gi);M7=n(XM,"Trainer"),XM.forEach(t),L7=n(oh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),bi=l(oh,"A",{href:!0});var QM=r(bi);Z7=n(QM,"Trainer"),QM.forEach(t),N7=n(oh," command line arguments."),oh.forEach(t),gy=c(e),Qt=l(e,"P",{});var mq=r(Qt);H7=n(mq,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),qi=l(mq,"A",{href:!0});var eL=r(qi);B7=n(eL,"Trainer"),eL.forEach(t),W7=n(mq,` do the majority
of configuration for you.`),mq.forEach(t),by=c(e),Le=l(e,"P",{});var lh=r(Le);F7=n(lh,"Therefore, in the rest of this guide you will find a special configuration value: "),ad=l(lh,"CODE",{});var sL=r(ad);V7=n(sL,"auto"),sL.forEach(t),Y7=n(lh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),Ei=l(lh,"A",{href:!0});var tL=r(Ei);K7=n(tL,"Trainer"),tL.forEach(t),J7=n(lh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),lh.forEach(t),qy=c(e),$i=l(e,"P",{});var aL=r($i);X7=n(aL,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),aL.forEach(t),Ey=c(e),ea=l(e,"P",{});var _q=r(ea);Q7=n(_q,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),ki=l(_q,"A",{href:!0});var nL=r(ki);e8=n(nL,"TrainingArguments"),nL.forEach(t),s8=n(_q," based on that. The steps are:"),_q.forEach(t),$y=c(e),sa=l(e,"OL",{});var vq=r(sa);nd=l(vq,"LI",{});var oL=r(nd);t8=n(oL,"Create or load the DeepSpeed configuration to be used as a master configuration"),oL.forEach(t),a8=c(vq),Wo=l(vq,"LI",{});var jq=r(Wo);n8=n(jq,"Create the "),Pi=l(jq,"A",{href:!0});var lL=r(Pi);o8=n(lL,"TrainingArguments"),lL.forEach(t),l8=n(jq," object based on these values"),jq.forEach(t),vq.forEach(t),ky=c(e),oe=l(e,"P",{});var Rn=r(oe);r8=n(Rn,"Do note that some values, such as "),od=l(Rn,"CODE",{});var rL=r(od);p8=n(rL,"scheduler.params.total_num_steps"),rL.forEach(t),i8=n(Rn,` are calculated by
`),zi=l(Rn,"A",{href:!0});var pL=r(zi);u8=n(pL,"Trainer"),pL.forEach(t),c8=n(Rn," during "),ld=l(Rn,"CODE",{});var iL=r(ld);h8=n(iL,"train"),iL.forEach(t),f8=n(Rn,", but you can of course do the math yourself."),Rn.forEach(t),Py=c(e),Di=l(e,"A",{id:!0}),r(Di).forEach(t),zy=c(e),Ss=l(e,"H3",{class:!0});var wq=r(Ss);ta=l(wq,"A",{id:!0,class:!0,href:!0});var uL=r(ta);rd=l(uL,"SPAN",{});var cL=r(rd);d(Fo.$$.fragment,cL),cL.forEach(t),uL.forEach(t),d8=c(wq),pd=l(wq,"SPAN",{});var hL=r(pd);m8=n(hL,"ZeRO"),hL.forEach(t),wq.forEach(t),Dy=c(e),Vo=l(e,"P",{});var vU=r(Vo);Yo=l(vU,"A",{href:!0,rel:!0});var fL=r(Yo);_8=n(fL,"Zero Redundancy Optimizer (ZeRO)"),fL.forEach(t),v8=n(vU,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),vU.forEach(t),Oy=c(e),Ze=l(e,"P",{});var rh=r(Ze);j8=n(rh,"The "),id=l(rh,"CODE",{});var dL=r(id);w8=n(dL,"zero_optimization"),dL.forEach(t),y8=n(rh," section of the configuration file is the most important part ("),Ko=l(rh,"A",{href:!0,rel:!0});var mL=r(Ko);g8=n(mL,"docs"),mL.forEach(t),b8=n(rh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),rh.forEach(t),Ay=c(e),aa=l(e,"P",{});var yq=r(aa);q8=n(yq,"This section has to be configured exclusively via DeepSpeed configuration - the "),Oi=l(yq,"A",{href:!0});var _L=r(Oi);E8=n(_L,"Trainer"),_L.forEach(t),$8=n(yq,` provides
no equivalent command line arguments.`),yq.forEach(t),Ty=c(e),Ai=l(e,"P",{});var vL=r(Ai);k8=n(vL,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),vL.forEach(t),Sy=c(e),Ti=l(e,"A",{id:!0}),r(Ti).forEach(t),Cy=c(e),Cs=l(e,"H4",{class:!0});var gq=r(Cs);na=l(gq,"A",{id:!0,class:!0,href:!0});var jL=r(na);ud=l(jL,"SPAN",{});var wL=r(ud);d(Jo.$$.fragment,wL),wL.forEach(t),jL.forEach(t),P8=c(gq),cd=l(gq,"SPAN",{});var yL=r(cd);z8=n(yL,"ZeRO-2 Config"),yL.forEach(t),gq.forEach(t),xy=c(e),Si=l(e,"P",{});var gL=r(Si);D8=n(gL,"The following is an example of configuration for ZeRO stage 2:"),gL.forEach(t),Ry=c(e),d(Xo.$$.fragment,e),Iy=c(e),Ci=l(e,"P",{});var bL=r(Ci);hd=l(bL,"STRONG",{});var qL=r(hd);O8=n(qL,"Performance tuning:"),qL.forEach(t),bL.forEach(t),Uy=c(e),Ne=l(e,"UL",{});var ph=r(Ne);xs=l(ph,"LI",{});var ih=r(xs);A8=n(ih,"enabling "),fd=l(ih,"CODE",{});var EL=r(fd);T8=n(EL,"offload_optimizer"),EL.forEach(t),S8=n(ih," should reduce GPU RAM usage (it requires "),dd=l(ih,"CODE",{});var $L=r(dd);C8=n($L,'"stage": 2'),$L.forEach(t),x8=n(ih,")"),ih.forEach(t),R8=c(ph),G=l(ph,"LI",{});var se=r(G);md=l(se,"CODE",{});var kL=r(md);I8=n(kL,'"overlap_comm": true'),kL.forEach(t),U8=n(se," trades off increased GPU RAM usage to lower all-reduce latency. "),_d=l(se,"CODE",{});var PL=r(_d);G8=n(PL,"overlap_comm"),PL.forEach(t),M8=n(se,` uses 4.5x
the `),vd=l(se,"CODE",{});var zL=r(vd);L8=n(zL,"allgather_bucket_size"),zL.forEach(t),Z8=n(se," and "),jd=l(se,"CODE",{});var DL=r(jd);N8=n(DL,"reduce_bucket_size"),DL.forEach(t),H8=n(se,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),wd=l(se,"CODE",{});var OL=r(wd);B8=n(OL,"5e8 x 2Bytes x 2 x 4.5"),OL.forEach(t),W8=n(se,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),yd=l(se,"CODE",{});var AL=r(yd);F8=n(AL,"2e8"),AL.forEach(t),V8=n(se,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),se.forEach(t),Y8=c(ph),gd=l(ph,"LI",{});var TL=r(gd);K8=n(TL,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),TL.forEach(t),ph.forEach(t),Gy=c(e),He=l(e,"P",{});var uh=r(He);J8=n(uh,"Additionally, "),bd=l(uh,"CODE",{});var SL=r(bd);X8=n(SL,"deepspeed==0.4.4"),SL.forEach(t),Q8=n(uh," added a new option "),qd=l(uh,"CODE",{});var CL=r(qd);ek=n(CL,"round_robin_gradients"),CL.forEach(t),sk=n(uh," which you can enable with:"),uh.forEach(t),My=c(e),d(Qo.$$.fragment,e),Ly=c(e),xi=l(e,"P",{});var xL=r(xi);tk=n(xL,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),xL.forEach(t),Zy=c(e),Ri=l(e,"A",{id:!0}),r(Ri).forEach(t),Ny=c(e),Rs=l(e,"H4",{class:!0});var bq=r(Rs);oa=l(bq,"A",{id:!0,class:!0,href:!0});var RL=r(oa);Ed=l(RL,"SPAN",{});var IL=r(Ed);d(el.$$.fragment,IL),IL.forEach(t),RL.forEach(t),ak=c(bq),$d=l(bq,"SPAN",{});var UL=r($d);nk=n(UL,"ZeRO-3 Config"),UL.forEach(t),bq.forEach(t),Hy=c(e),Ii=l(e,"P",{});var GL=r(Ii);ok=n(GL,"The following is an example of configuration for ZeRO stage 3:"),GL.forEach(t),By=c(e),d(sl.$$.fragment,e),Wy=c(e),V=l(e,"P",{});var ws=r(V);lk=n(ws,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),kd=l(ws,"CODE",{});var ML=r(kd);rk=n(ML,'"device": "cpu"'),ML.forEach(t),pk=n(ws,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Pd=l(ws,"CODE",{});var LL=r(Pd);ik=n(LL,"none"),LL.forEach(t),uk=n(ws," instead of "),zd=l(ws,"CODE",{});var ZL=r(zd);ck=n(ZL,"cpu"),ZL.forEach(t),hk=n(ws," for the "),Dd=l(ws,"CODE",{});var NL=r(Dd);fk=n(NL,"device"),NL.forEach(t),dk=n(ws,` entry. Offloading to
NVMe is discussed further down.`),ws.forEach(t),Fy=c(e),Be=l(e,"P",{});var ch=r(Be);mk=n(ch,"Pinned memory is enabled with "),Od=l(ch,"CODE",{});var HL=r(Od);_k=n(HL,"pin_memory"),HL.forEach(t),vk=n(ch," set to "),Ad=l(ch,"CODE",{});var BL=r(Ad);jk=n(BL,"true"),BL.forEach(t),wk=n(ch,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),ch.forEach(t),Vy=c(e),Ui=l(e,"P",{});var WL=r(Ui);Td=l(WL,"STRONG",{});var FL=r(Td);yk=n(FL,"Performance tuning:"),FL.forEach(t),WL.forEach(t),Yy=c(e),la=l(e,"UL",{});var qq=r(la);tl=l(qq,"LI",{});var Eq=r(tl);Sd=l(Eq,"CODE",{});var VL=r(Sd);gk=n(VL,"stage3_max_live_parameters"),VL.forEach(t),bk=n(Eq,": "),Cd=l(Eq,"CODE",{});var YL=r(Cd);qk=n(YL,"1e9"),YL.forEach(t),Eq.forEach(t),Ek=c(qq),al=l(qq,"LI",{});var $q=r(al);xd=l($q,"CODE",{});var KL=r(xd);$k=n(KL,"stage3_max_reuse_distance"),KL.forEach(t),kk=n($q,": "),Rd=l($q,"CODE",{});var JL=r(Rd);Pk=n(JL,"1e9"),JL.forEach(t),$q.forEach(t),qq.forEach(t),Ky=c(e),M=l(e,"P",{});var ge=r(M);zk=n(ge,"If hitting OOM reduce "),Id=l(ge,"CODE",{});var XL=r(Id);Dk=n(XL,"stage3_max_live_parameters"),XL.forEach(t),Ok=n(ge," and "),Ud=l(ge,"CODE",{});var QL=r(Ud);Ak=n(QL,"stage3_max_reuse_distance"),QL.forEach(t),Tk=n(ge,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Gd=l(ge,"CODE",{});var eZ=r(Gd);Sk=n(eZ,"1e9"),eZ.forEach(t),Ck=n(ge,` would consume ~2GB. The memory is shared by
`),Md=l(ge,"CODE",{});var sZ=r(Md);xk=n(sZ,"stage3_max_live_parameters"),sZ.forEach(t),Rk=n(ge," and "),Ld=l(ge,"CODE",{});var tZ=r(Ld);Ik=n(tZ,"stage3_max_reuse_distance"),tZ.forEach(t),Uk=n(ge,", so it\u2019s not additive, it\u2019s just 2GB total."),ge.forEach(t),Jy=c(e),ze=l(e,"P",{});var gp=r(ze);Zd=l(gp,"CODE",{});var aZ=r(Zd);Gk=n(aZ,"stage3_max_live_parameters"),aZ.forEach(t),Mk=n(gp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Nd=l(gp,"CODE",{});var nZ=r(Nd);Lk=n(nZ,"stage3_max_reuse_distance"),nZ.forEach(t),Zk=n(gp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Hd=l(gp,"CODE",{});var oZ=r(Hd);Nk=n(oZ,"stage3_max_reuse_distance"),oZ.forEach(t),Hk=n(gp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),gp.forEach(t),Xy=c(e),Gi=l(e,"P",{});var lZ=r(Gi);Bk=n(lZ,"The following configuration values depend on the model\u2019s hidden size:"),lZ.forEach(t),Qy=c(e),We=l(e,"UL",{});var hh=r(We);nl=l(hh,"LI",{});var kq=r(nl);Bd=l(kq,"CODE",{});var rZ=r(Bd);Wk=n(rZ,"reduce_bucket_size"),rZ.forEach(t),Fk=n(kq,": "),Wd=l(kq,"CODE",{});var pZ=r(Wd);Vk=n(pZ,"hidden_size*hidden_size"),pZ.forEach(t),kq.forEach(t),Yk=c(hh),ol=l(hh,"LI",{});var Pq=r(ol);Fd=l(Pq,"CODE",{});var iZ=r(Fd);Kk=n(iZ,"stage3_prefetch_bucket_size"),iZ.forEach(t),Jk=n(Pq,": "),Vd=l(Pq,"CODE",{});var uZ=r(Vd);Xk=n(uZ,"0.9 * hidden_size * hidden_size"),uZ.forEach(t),Pq.forEach(t),Qk=c(hh),ll=l(hh,"LI",{});var zq=r(ll);Yd=l(zq,"CODE",{});var cZ=r(Yd);e9=n(cZ,"stage3_param_persistence_threshold"),cZ.forEach(t),s9=n(zq,": "),Kd=l(zq,"CODE",{});var hZ=r(Kd);t9=n(hZ,"10 * hidden_size"),hZ.forEach(t),zq.forEach(t),hh.forEach(t),eg=c(e),Fe=l(e,"P",{});var fh=r(Fe);a9=n(fh,"therefore set these values to "),Jd=l(fh,"CODE",{});var fZ=r(Jd);n9=n(fZ,"auto"),fZ.forEach(t),o9=n(fh," and the "),Mi=l(fh,"A",{href:!0});var dZ=r(Mi);l9=n(dZ,"Trainer"),dZ.forEach(t),r9=n(fh,` will automatically assign the recommended
