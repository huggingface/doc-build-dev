...
the latter silently ignores them.`)},l(T){u=s(T,"P",{});var y=a(u);L=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(y,"CODE",{});var C=a(v);w=i(C,"Module"),C.forEach(o),q=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,L),e(u,v),e(v,w),e(u,q)},d(T){T&&o(u)}}}function Zd(Q){let u,L,v,w,q,T,y,C,Zn,on,D,ao,es,ts,je,os,ns,Ee,ss,as,nn,Y,fe,ro,Fe,rs,io,is,sn,X,ds,Me,ls,cs,lo,ps,hs,an,Et,us,rn,Ft,co,ms,dn,G,fs,Se,gs,_s,Ae,bs,ks,ln,Z,ge,po,Ne,vs,ho,Ts,cn,j,ys,uo,ws,Ps,mo,Ls,zs,fo,qs,Bs,go,$s,xs,pn,_e,Cs,Ie,js,Es,hn,R,Fs,De,_o,Ms,Ss,As,Mt,Ns,Is,un,St,bo,Ds,mn,Oe,fn,At,Xe,ko,Os,Xs,ee,Gs,vo,Rs,Ws,To,Hs,Us,gn,Ge,_n,te,be,yo,Re,Vs,wo,Js,bn,$,We,Ks,oe,Qs,Nt,Ys,Zs,He,ea,ta,oa,ne,na,It,sa,aa,Dt,ra,ia,da,Po,la,ca,Ue,kn,se,ke,Lo,Ve,pa,zo,ha,vn,P,Je,ua,qo,ma,fa,O,ga,Ot,_a,ba,Xt,ka,va,Ke,Ta,ya,wa,Qe,Pa,Bo,La,za,qa,$o,Ba,$a,Ye,xa,ve,Ze,Ca,xo,ja,Ea,N,et,Fa,tt,Ma,Co,Sa,Aa,Na,ot,nt,jo,Ia,Da,Eo,Oa,Xa,st,Fo,Ga,Ra,Mo,Wa,Ha,So,Ua,Tn,ae,Te,Ao,at,Va,No,Ja,yn,S,rt,Ka,it,Qa,Gt,Ya,Za,er,dt,tr,lt,or,nr,sr,E,ct,ar,re,rr,Rt,ir,dr,Io,lr,cr,pr,ye,hr,Do,ur,mr,pt,wn,ie,we,Oo,ht,fr,Xo,gr,Pn,A,ut,_r,mt,br,Wt,kr,vr,Tr,ft,yr,gt,wr,Pr,Lr,F,_t,zr,de,qr,Ht,Br,$r,Go,xr,Cr,jr,Pe,Er,Ro,Fr,Mr,bt,Ln,le,Le,Wo,kt,Sr,Ho,Ar,zn,x,vt,Nr,Uo,Ir,Dr,Tt,Or,Ut,Xr,Gr,Rr,yt,Wr,wt,Hr,Ur,Vr,z,Pt,Jr,ce,Kr,Vt,Qr,Yr,Vo,Zr,ei,ti,ze,oi,Jo,ni,si,Lt,ai,Ko,ri,ii,zt,qn,pe,qe,Qo,qt,di,Yo,li,Bn,he,Bt,ci,W,$t,pi,Zo,hi,ui,xt,$n;return T=new me({}),Fe=new me({}),Ne=new me({}),Oe=new ue({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
`),Ee=n("a"),ss=r("@gchhablani"),as=r("."),nn=l(),Y=n("h2"),fe=n("a"),ro=n("span"),m(Fe.$$.fragment),rs=l(),io=n("span"),is=r("Overview of PLBart"),sn=l(),X=n("p"),ds=r("The PLBART model was proposed in "),Me=n("a"),ls=r("Unified Pre-training for Program Understanding and Generation"),cs=r(` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
inside the context manager `),Mt=n("a"),Ns=r("as_target_tokenizer()"),Is=r(" to encode target text format."),un=l(),St=n("ul"),bo=n("li"),Ds=r("Supervised training"),mn=l(),m(Oe.$$.fragment),fn=l(),At=n("ul"),Xe=n("li"),ko=n("p"),Os=r("Generation"),Xs=l(),ee=n("p"),Gs=r("While generating the target text set the "),vo=n("code"),Rs=r("decoder_start_token_id"),Ws=r(` to the target language id. The following
...
documentation from `),Dt=n("a"),ra=r("PretrainedConfig"),ia=r(" for more information."),da=l(),Po=n("p"),la=r("Example:"),ca=l(),m(Ue.$$.fragment),kn=l(),se=n("h2"),ke=n("a"),Lo=n("span"),m(Ve.$$.fragment),pa=l(),zo=n("span"),ha=r("PLBartTokenizer"),vn=l(),P=n("div"),m(Je.$$.fragment),ua=l(),qo=n("p"),ma=r("Construct an PLBART tokenizer."),fa=l(),O=n("p"),ga=r("Adapted from "),Ot=n("a"),_a=r("RobertaTokenizer"),ba=r(" and "),Xt=n("a"),ka=r("XLNetTokenizer"),va=r(`. Based on
...
adding special tokens. An PLBART sequence has the following format, where `),Co=n("code"),Sa=r("X"),Aa=r(" represents the sequence:"),Na=l(),ot=n("ul"),nt=n("li"),jo=n("code"),Ia=r("input_ids"),Da=r(" (for encoder) "),Eo=n("code"),Oa=r("X [eos, src_lang_code]"),Xa=l(),st=n("li"),Fo=n("code"),Ga=r("decoder_input_ids"),Ra=r(": (for decoder) "),Mo=n("code"),Wa=r("X [eos, tgt_lang_code]"),Ha=l(),So=n("p"),Ua=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
classification.`),Dr=l(),Tt=n("p"),Or=r("This model inherits from "),Ut=n("a"),Xr=r("PreTrainedModel"),Gr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
inside the context manager `),Mt=s(Qt,"A",{href:!0});var Ii=a(Mt);Ns=i(Ii,"as_target_tokenizer()"),Ii.forEach(o),Is=i(Qt," to encode target text format."),Qt.forEach(o),un=c(t),St=s(t,"UL",{});var Di=a(St);bo=s(Di,"LI",{});var Oi=a(bo);Ds=i(Oi,"Supervised training"),Oi.forEach(o),Di.forEach(o),mn=c(t),f(Oe.$$.fragment,t),fn=c(t),At=s(t,"UL",{});var Xi=a(At);Xe=s(Xi,"LI",{});var En=a(Xe);ko=s(En,"P",{});var Gi=a(ko);Os=i(Gi,"Generation"),Gi.forEach(o),Xs=c(En),ee=s(En,"P",{});var Yt=a(ee);Gs=i(Yt,"While generating the target text set the "),vo=s(Yt,"CODE",{});var Ri=a(vo);Rs=i(Ri,"decoder_start_token_id"),Ri.forEach(o),Ws=i(Yt,` to the target language id. The following
example shows how to translate Python to English using the `),To=s(Yt,"CODE",{});var Wi=a(To);Hs=i(Wi,"uclanlp/plbart-python-en_XX"),Wi.forEach(o),Us=i(Yt," model."),Yt.forEach(o),En.forEach(o),Xi.forEach(o),gn=c(t),f(Ge.$$.fragment,t),_n=c(t),te=s(t,"H2",{class:!0});var Fn=a(te);be=s(Fn,"A",{id:!0,class:!0,href:!0});var Hi=a(be);yo=s(Hi,"SPAN",{});var Ui=a(yo);f(Re.$$.fragment,Ui),Ui.forEach(o),Hi.forEach(o),Vs=c(Fn),wo=s(Fn,"SPAN",{});var Vi=a(wo);Js=i(Vi,"PLBartConfig"),Vi.forEach(o),Fn.forEach(o),bn=c(t),$=s(t,"DIV",{class:!0});var U=a($);f(We.$$.fragment,U),Ks=c(U),oe=s(U,"P",{});var Zt=a(oe);Qs=i(Zt,"This is the configuration class to store the configuration of a "),Nt=s(Zt,"A",{href:!0});var Ji=a(Nt);Ys=i(Ji,"PLBartModel"),Ji.forEach(o),Zs=i(Zt,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
...
classification.`),Md.forEach(o),Dr=c(K),Tt=s(K,"P",{});var Jn=a(Tt);Or=i(Jn,"This model inherits from "),Ut=s(Jn,"A",{href:!0});var Sd=a(Ut);Xr=i(Sd,"PreTrainedModel"),Sd.forEach(o),Gr=i(Jn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
