import{S as Ts,i as xs,s as Ms,e as a,k as i,w as b,t as n,M as Ds,c as s,d as o,m as l,a as d,x as y,h as t,b as c,F as e,g as u,y as w,q as E,o as k,B as S,v as $s}from"../../chunks/vendor-6b77c823.js";import{T as Ss}from"../../chunks/Tip-39098574.js";import{D as ne}from"../../chunks/Docstring-abef54e3.js";import{C as en}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as xn}from"../../chunks/IconCopyLink-7a11ce68.js";function js(Je){let h,A,g,D,F;return{c(){h=a("p"),A=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),D=n("Module"),F=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=s(T,"P",{});var M=d(h);A=t(M,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(M,"CODE",{});var L=d(g);D=t(L,"Module"),L.forEach(o),F=t(M,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(T,M){u(T,h,M),e(h,A),e(h,g),e(g,D),e(h,F)},d(T){T&&o(h)}}}function qs(Je){let h,A,g,D,F;return{c(){h=a("p"),A=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),D=n("Module"),F=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=s(T,"P",{});var M=d(h);A=t(M,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(M,"CODE",{});var L=d(g);D=t(L,"Module"),L.forEach(o),F=t(M,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(T,M){u(T,h,M),e(h,A),e(h,g),e(g,D),e(h,F)},d(T){T&&o(h)}}}function Ps(Je){let h,A,g,D,F,T,M,L,Mn,on,$,Dn,Ye,$n,jn,To,qn,Pn,Ze,zn,Fn,Ke,An,Cn,nn,N,Ln,xo,Nn,In,he,Vn,Wn,tn,I,On,Qe,Bn,Rn,Xe,Un,Hn,rn,H,te,Mo,me,Gn,Do,Jn,an,x,fe,Yn,re,eo,Zn,Kn,oo,Qn,Xn,et,G,ot,no,nt,tt,to,rt,at,st,$o,dt,ct,ue,it,ae,ge,lt,_e,pt,ro,ht,mt,ft,se,ve,ut,J,gt,jo,_t,vt,qo,bt,yt,sn,Y,de,Po,be,wt,zo,Et,dn,m,ye,kt,Z,St,ao,Tt,xt,so,Mt,Dt,$t,we,jt,Ee,qt,Pt,zt,ke,Ft,Se,At,Ct,Lt,Fo,Nt,It,Te,Vt,co,Wt,Ot,Bt,xe,Rt,Me,Ut,Ht,Gt,V,io,Jt,Yt,Ao,Zt,Kt,Co,Qt,Xt,er,j,De,or,K,nr,lo,tr,rr,Lo,ar,sr,dr,ce,cr,No,ir,lr,$e,pr,q,je,hr,Io,mr,fr,Q,ur,Vo,gr,_r,Wo,vr,br,yr,Oo,wr,Er,qe,cn,X,ie,Bo,Pe,kr,Ro,Sr,ln,f,ze,Tr,ee,xr,po,Mr,Dr,ho,$r,jr,qr,Fe,Pr,Ae,zr,Fr,Ar,Ce,Cr,Le,Lr,Nr,Ir,Uo,Vr,Wr,Ne,Or,mo,Br,Rr,Ur,Ie,Hr,Ve,Gr,Jr,Yr,W,fo,Zr,Kr,Ho,Qr,Xr,Go,ea,oa,na,P,We,ta,oe,ra,uo,aa,sa,Jo,da,ca,ia,le,la,Yo,pa,ha,Oe,ma,C,Be,fa,Zo,ua,ga,Ko,_a,va,Re,pn;return T=new xn({}),me=new xn({}),fe=new ne({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16597/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_16597/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_16597/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/pr_16597/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/pr_16597/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16597/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16597/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16597/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16597/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<a href="/docs/transformers/pr_16597/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
tensor of type <code>torch.FloatTensor</code>. See <a href="/docs/transformers/pr_16597/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__"><strong>call</strong>()</a>`,name:"input_features"},{anchor:"transformers.SpeechEncoderDecoderModel.forward.return_dict",description:`<strong>return_dict</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_16597/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<a href="/docs/transformers/pr_16597/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16597/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16597/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16597/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
Zhou, Wei Li, Peter J. Liu.`),zt=i(),ke=a("p"),Ft=n("Additionally, in "),Se=a("a"),At=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
:meth`),Ao=a("em"),Zt=n("~transformers.AutoModel.from_pretrained"),Kt=n(` class method for the encoder and
...
Zhou, Wei Li, Peter J. Liu.`),Ar=i(),Ce=a("p"),Cr=n("Additionally, in "),Le=a("a"),Lr=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
documentation from `),to=s(vo,"A",{href:!0});var Aa=d(to);rt=t(Aa,"PretrainedConfig"),Aa.forEach(o),at=t(vo," for more information."),vo.forEach(o),st=l(z),$o=s(z,"P",{});var Ca=d($o);dt=t(Ca,"Examples:"),Ca.forEach(o),ct=l(z),y(ue.$$.fragment,z),it=l(z),ae=s(z,"DIV",{class:!0});var mn=d(ae);y(ge.$$.fragment,mn),lt=l(mn),_e=s(mn,"P",{});var fn=d(_e);pt=t(fn,"Instantiate a "),ro=s(fn,"A",{href:!0});var La=d(ro);ht=t(La,"SpeechEncoderDecoderConfig"),La.forEach(o),mt=t(fn,` (or a derived class) from a pre-trained encoder model
...
Zhou, Wei Li, Peter J. Liu.`),_n.forEach(o),zt=l(_),ke=s(_,"P",{});var vn=d(ke);Ft=t(vn,"Additionally, in "),Se=s(vn,"A",{href:!0,rel:!0});var Ha=d(Se);At=t(Ha,`Large-Scale Self- and Semi-Supervised Learning for Speech
Translation`),Ha.forEach(o),Ct=t(vn,` it is shown how leveraging large pretrained speech models for speech
...
Zhou, Wei Li, Peter J. Liu.`),En.forEach(o),Ar=l(v),Ce=s(v,"P",{});var kn=d(Ce);Cr=t(kn,"Additionally, in "),Le=s(kn,"A",{href:!0,rel:!0});var hs=d(Le);Lr=t(hs,`Large-Scale Self- and Semi-Supervised Learning for Speech
