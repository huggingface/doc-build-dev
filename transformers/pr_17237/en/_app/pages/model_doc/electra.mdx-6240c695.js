...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17237/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17237/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17237/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17237/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17237/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17237/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17237/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17237/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17237/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17237/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17237/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17237/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17237/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17237/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17237/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17237/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17237/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17237/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17237/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
`),yl=s(Ng,"A",{href:!0,rel:!0});var e3=a(yl);e$=i(e3,"flax.nn.Module"),e3.forEach(t),t$=i(Ng,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ng.forEach(t),o$=p(vt),Zh=s(vt,"P",{});var t3=a(Zh);n$=i(t3,"Finally, this model supports inherent JAX features such as:"),t3.forEach(t),s$=p(vt),Yt=s(vt,"UL",{});var $a=a(Yt);em=s($a,"LI",{});var o3=a(em);El=s(o3,"A",{href:!0,rel:!0});var n3=a(El);a$=i(n3,"Just-In-Time (JIT) compilation"),n3.forEach(t),o3.forEach(t),r$=p($a),tm=s($a,"LI",{});var s3=a(tm);wl=s(s3,"A",{href:!0,rel:!0});var a3=a(wl);i$=i(a3,"Automatic Differentiation"),a3.forEach(t),s3.forEach(t),l$=p($a),om=s($a,"LI",{});var r3=a(om);$l=s(r3,"A",{href:!0,rel:!0});var i3=a($l);d$=i(i3,"Vectorization"),i3.forEach(t),r3.forEach(t),c$=p($a),nm=s($a,"LI",{});var l3=a(nm);Fl=s(l3,"A",{href:!0,rel:!0});var d3=a(Fl);p$=i(d3,"Parallelization"),d3.forEach(t),l3.forEach(t),$a.forEach(t),h$=p(vt),Lt=s(vt,"DIV",{class:!0});var Fa=a(Lt);y(xl.$$.fragment,Fa),m$=p(Fa),un=s(Fa,"P",{});var Ac=a(un);u$=i(Ac,"The "),sm=s(Ac,"CODE",{});var c3=a(sm);f$=i(c3,"FlaxElectraPreTrainedModel"),c3.forEach(t),g$=i(Ac," forward method, overrides the "),am=s(Ac,"CODE",{});var p3=a(am);_$=i(p3,"__call__"),p3.forEach(t),k$=i(Ac," special method."),Ac.forEach(t),v$=p(Fa),y(Xs.$$.fragment,Fa),T$=p(Fa),y(Ys.$$.fragment,Fa),Fa.forEach(t),vt.forEach(t),bf=p(o),fn=s(o,"H2",{class:!0});var Ig=a(fn);Zs=s(Ig,"A",{id:!0,class:!0,href:!0});var h3=a(Zs);rm=s(h3,"SPAN",{});var m3=a(rm);y(Ml.$$.fragment,m3),m3.forEach(t),h3.forEach(t),b$=p(Ig),im=s(Ig,"SPAN",{});var u3=a(im);y$=i(u3,"FlaxElectraForMultipleChoice"),u3.forEach(t),Ig.forEach(t),yf=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(zl.$$.fragment,Tt),E$=p(Tt),lm=s(Tt,"P",{});var f3=a(lm);w$=i(f3,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),f3.forEach(t),$$=p(Tt),Cl=s(Tt,"P",{});var Dg=a(Cl);F$=i(Dg,"This model inherits from "),cc=s(Dg,"A",{href:!0});var g3=a(cc);x$=i(g3,"FlaxPreTrainedModel"),g3.forEach(t),M$=i(Dg,`. Check the superclass documentation for the generic methods the
...
`),ql=s(Sg,"A",{href:!0,rel:!0});var _3=a(ql);j$=i(_3,"flax.nn.Module"),_3.forEach(t),q$=i(Sg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sg.forEach(t),P$=p(Tt),dm=s(Tt,"P",{});var k3=a(dm);A$=i(k3,"Finally, this model supports inherent JAX features such as:"),k3.forEach(t),O$=p(Tt),Zt=s(Tt,"UL",{});var xa=a(Zt);cm=s(xa,"LI",{});var v3=a(cm);Pl=s(v3,"A",{href:!0,rel:!0});var T3=a(Pl);L$=i(T3,"Just-In-Time (JIT) compilation"),T3.forEach(t),v3.forEach(t),N$=p(xa),pm=s(xa,"LI",{});var b3=a(pm);Al=s(b3,"A",{href:!0,rel:!0});var y3=a(Al);I$=i(y3,"Automatic Differentiation"),y3.forEach(t),b3.forEach(t),D$=p(xa),hm=s(xa,"LI",{});var E3=a(hm);Ol=s(E3,"A",{href:!0,rel:!0});var w3=a(Ol);S$=i(w3,"Vectorization"),w3.forEach(t),E3.forEach(t),W$=p(xa),mm=s(xa,"LI",{});var $3=a(mm);Ll=s($3,"A",{href:!0,rel:!0});var F3=a(Ll);U$=i(F3,"Parallelization"),F3.forEach(t),$3.forEach(t),xa.forEach(t),R$=p(Tt),Nt=s(Tt,"DIV",{class:!0});var Ma=a(Nt);y(Nl.$$.fragment,Ma),H$=p(Ma),gn=s(Ma,"P",{});var Oc=a(gn);B$=i(Oc,"The "),um=s(Oc,"CODE",{});var x3=a(um);Q$=i(x3,"FlaxElectraPreTrainedModel"),x3.forEach(t),V$=i(Oc," forward method, overrides the "),fm=s(Oc,"CODE",{});var M3=a(fm);K$=i(M3,"__call__"),M3.forEach(t),J$=i(Oc," special method."),Oc.forEach(t),G$=p(Ma),y(ea.$$.fragment,Ma),X$=p(Ma),y(ta.$$.fragment,Ma),Ma.forEach(t),Tt.forEach(t),Ef=p(o),_n=s(o,"H2",{class:!0});var Wg=a(_n);oa=s(Wg,"A",{id:!0,class:!0,href:!0});var z3=a(oa);gm=s(z3,"SPAN",{});var C3=a(gm);y(Il.$$.fragment,C3),C3.forEach(t),z3.forEach(t),Y$=p(Wg),_m=s(Wg,"SPAN",{});var j3=a(_m);Z$=i(j3,"FlaxElectraForTokenClassification"),j3.forEach(t),Wg.forEach(t),wf=p(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);y(Dl.$$.fragment,Ze),eF=p(Ze),km=s(Ze,"P",{});var q3=a(km);tF=i(q3,"Electra model with a token classification head on top."),q3.forEach(t),oF=p(Ze),vm=s(Ze,"P",{});var P3=a(vm);nF=i(P3,"Both the discriminator and generator may be loaded into this model."),P3.forEach(t),sF=p(Ze),Sl=s(Ze,"P",{});var Ug=a(Sl);aF=i(Ug,"This model inherits from "),pc=s(Ug,"A",{href:!0});var A3=a(pc);rF=i(A3,"FlaxPreTrainedModel"),A3.forEach(t),iF=i(Ug,`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rg.forEach(t),hF=p(Ze),Tm=s(Ze,"P",{});var L3=a(Tm);mF=i(L3,"Finally, this model supports inherent JAX features such as:"),L3.forEach(t),uF=p(Ze),eo=s(Ze,"UL",{});var za=a(eo);bm=s(za,"LI",{});var N3=a(bm);Rl=s(N3,"A",{href:!0,rel:!0});var I3=a(Rl);fF=i(I3,"Just-In-Time (JIT) compilation"),I3.forEach(t),N3.forEach(t),gF=p(za),ym=s(za,"LI",{});var D3=a(ym);Hl=s(D3,"A",{href:!0,rel:!0});var S3=a(Hl);_F=i(S3,"Automatic Differentiation"),S3.forEach(t),D3.forEach(t),kF=p(za),Em=s(za,"LI",{});var W3=a(Em);Bl=s(W3,"A",{href:!0,rel:!0});var U3=a(Bl);vF=i(U3,"Vectorization"),U3.forEach(t),W3.forEach(t),TF=p(za),wm=s(za,"LI",{});var R3=a(wm);Ql=s(R3,"A",{href:!0,rel:!0});var H3=a(Ql);bF=i(H3,"Parallelization"),H3.forEach(t),R3.forEach(t),za.forEach(t),yF=p(Ze),It=s(Ze,"DIV",{class:!0});var Ca=a(It);y(Vl.$$.fragment,Ca),EF=p(Ca),kn=s(Ca,"P",{});var Lc=a(kn);wF=i(Lc,"The "),$m=s(Lc,"CODE",{});var B3=a($m);$F=i(B3,"FlaxElectraPreTrainedModel"),B3.forEach(t),FF=i(Lc," forward method, overrides the "),Fm=s(Lc,"CODE",{});var Q3=a(Fm);xF=i(Q3,"__call__"),Q3.forEach(t),MF=i(Lc," special method."),Lc.forEach(t),zF=p(Ca),y(na.$$.fragment,Ca),CF=p(Ca),y(sa.$$.fragment,Ca),Ca.forEach(t),Ze.forEach(t),$f=p(o),vn=s(o,"H2",{class:!0});var Hg=a(vn);aa=s(Hg,"A",{id:!0,class:!0,href:!0});var V3=a(aa);xm=s(V3,"SPAN",{});var K3=a(xm);y(Kl.$$.fragment,K3),K3.forEach(t),V3.forEach(t),jF=p(Hg),Mm=s(Hg,"SPAN",{});var J3=a(Mm);qF=i(J3,"FlaxElectraForQuestionAnswering"),J3.forEach(t),Hg.forEach(t),Ff=p(o),Re=s(o,"DIV",{class:!0});var bt=a(Re);y(Jl.$$.fragment,bt),PF=p(bt),Tn=s(bt,"P",{});var Nc=a(Tn);AF=i(Nc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=s(Nc,"CODE",{});var G3=a(zm);OF=i(G3,"span start logits"),G3.forEach(t),LF=i(Nc," and "),Cm=s(Nc,"CODE",{});var X3=a(Cm);NF=i(X3,"span end logits"),X3.forEach(t),IF=i(Nc,")."),Nc.forEach(t),DF=p(bt),Gl=s(bt,"P",{});var Bg=a(Gl);SF=i(Bg,"This model inherits from "),hc=s(Bg,"A",{href:!0});var Y3=a(hc);WF=i(Y3,"FlaxPreTrainedModel"),Y3.forEach(t),UF=i(Bg,`. Check the superclass documentation for the generic methods the
