...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16659/en/model_doc/qdqbert#transformers.QDQBertConfig"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mr.forEach(o),hc=d(pe),X=r(pe,"DIV",{class:!0});var he=i(X);_(To.$$.fragment,he),uc=d(he),Ee=r(he,"P",{});var Bn=i(Ee);mc=s(Bn,"The "),fn=r(Bn,"A",{href:!0});var zu=i(fn);fc=s(zu,"QDQBertForNextSentencePrediction"),zu.forEach(o),gc=s(Bn," forward method, overrides the "),Es=r(Bn,"CODE",{});var Bu=i(Es);_c=s(Bu,"__call__"),Bu.forEach(o),bc=s(Bn," special method."),Bn.forEach(o),kc=d(he),_(at.$$.fragment,he),vc=d(he),Fs=r(he,"P",{});var Mu=i(Fs);Qc=s(Mu,"Example:"),Mu.forEach(o),wc=d(he),_(yo.$$.fragment,he),he.forEach(o),pe.forEach(o),Fa=d(t),Fe=r(t,"H2",{class:!0});var fr=i(Fe);rt=r(fr,"A",{id:!0,class:!0,href:!0});var xu=i(rt);Ps=r(xu,"SPAN",{});var ju=i(Ps);_(qo.$$.fragment,ju),ju.forEach(o),xu.forEach(o),Tc=d(fr),Cs=r(fr,"SPAN",{});var Eu=i(Cs);yc=s(Eu,"QDQBertForMultipleChoice"),Eu.forEach(o),fr.forEach(o),Pa=d(t),W=r(t,"DIV",{class:!0});var ue=i(W);_($o.$$.fragment,ue),qc=d(ue),As=r(ue,"P",{});var Fu=i(As);$c=s(Fu,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
