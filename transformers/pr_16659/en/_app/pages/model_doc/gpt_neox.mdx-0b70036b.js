...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),b(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),v=!0},p:oo,i(r){v||(P(u.$$.fragment,r),v=!0)},o(r){$(u.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(p),y(u,r)}}}function Ns(G){let d,T,p,u,v,r,_,X,A,z,C,q,ot,me,no,nt,so,Nt,R,ao,fe,ro,io,Gt,Y,lo,ue,co,po,Xt,Ie,ho,xt,ge,zt,Se,mo,Mt,I,K,st,_e,fo,at,uo,Ct,Q,go,rt,_o,To,Et,Te,Ft,S,Z,it,ve,vo,lt,bo,qt,M,be,ko,D,wo,De,Po,$o,ke,yo,No,Go,B,Xo,Be,xo,zo,We,Mo,Co,Eo,ee,jt,W,te,dt,we,Fo,ct,qo,Lt,N,Pe,jo,$e,Lo,pt,Ao,Io,So,ht,Do,Bo,oe,Wo,ye,Oo,mt,Ho,Vo,Uo,ne,Jo,Ne,Ro,Oe,Yo,Ko,At,O,se,ft,Ge,Qo,ut,Zo,It,j,Xe,en,xe,tn,ze,on,nn,sn,E,Me,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,St,V,ie,_t,Ce,fn,Tt,un,Dt,L,Ee,gn,U,_n,vt,Tn,vn,Fe,bn,kn,wn,F,qe,Pn,J,$n,Ve,yn,Nn,bt,Gn,Xn,xn,le,zn,de,Bt;return r=new Ae({}),me=new Ae({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Ae({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/vr_16659/src/transformers/models/gpt_neox/tokenization_gpt_neox_fast.py#L44"}}),oe=new to({props:{anchor:"transformers.GPTNeoXTokenizerFast.example",$$slots:{default:[bs]},$$scope:{ctx:G}}}),ne=new Mn({props:{$$slots:{default:[ks]},$$scope:{ctx:G}}}),Ge=new Ae({}),Xe=new et({props:{name:"class transformers.GPTNeoXModel",anchor:"transformers.GPTNeoXModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16659/en/model_doc/gpt_neox#transformers.GPTNeoXConfig">~GPTNeoXConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
`}}),le=new Mn({props:{$$slots:{default:[$s]},$$scope:{ctx:G}}}),de=new to({props:{anchor:"transformers.GPTNeoXForCausalLM.forward.example",$$slots:{default:[ys]},$$scope:{ctx:G}}}),{c(){d=n("meta"),T=m(),p=n("h1"),u=n("a"),v=n("span"),b(r.$$.fragment),_=m(),X=n("span"),A=i("GPT-NeoX"),z=m(),C=n("h2"),q=n("a"),ot=n("span"),b(me.$$.fragment),no=m(),nt=n("span"),so=i("Overview"),Nt=m(),R=n("p"),ao=i(`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
...
documentation from `),We=n("a"),Mo=i("PretrainedConfig"),Co=i(" for more information."),Eo=m(),b(ee.$$.fragment),jt=m(),W=n("h2"),te=n("a"),dt=n("span"),b(we.$$.fragment),Fo=m(),ct=n("span"),qo=i("GPTNeoXTokenizerFast"),Lt=m(),N=n("div"),b(Pe.$$.fragment),jo=m(),$e=n("p"),Lo=i("Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=n("em"),Ao=i("tokenizers"),Io=i(` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),At=m(),O=n("h2"),se=n("a"),ft=n("span"),b(Ge.$$.fragment),Qo=m(),ut=n("span"),Zo=i("GPTNeoXModel"),It=m(),j=n("div"),b(Xe.$$.fragment),en=m(),xe=n("p"),tn=i(`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=n("a"),on=i("torch.nn.Module"),nn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn=m(),E=n("div"),b(Me.$$.fragment),an=m(),H=n("p"),rn=i("The "),He=n("a"),ln=i("GPTNeoXModel"),dn=i(" forward method, overrides the "),gt=n("code"),cn=i("__call__"),pn=i(" special method."),hn=m(),b(ae.$$.fragment),mn=m(),b(re.$$.fragment),St=m(),V=n("h2"),ie=n("a"),_t=n("span"),b(Ce.$$.fragment),fn=m(),Tt=n("span"),un=i("GPTNeoXForCausalLM"),Dt=m(),L=n("div"),b(Ee.$$.fragment),gn=m(),U=n("p"),_n=i("GPTNeoX Model with a "),vt=n("code"),Tn=i("language modeling"),vn=i(` head on top for CLM fine-tuning.
