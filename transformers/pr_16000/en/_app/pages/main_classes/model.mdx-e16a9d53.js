...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16000/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_16000/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = BertModel.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, from_flax=<span class="hljs-literal">True</span>)`}}),no=new f({props:{name:"get_input_embeddings",anchor:"transformers.PreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L575",returnDescription:`
<p>A torch module mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Lo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7f3711746270>"}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),zo=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_utils.py#L194"}}),Do=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/file_utils.py#L2825",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16000/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_16000/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
<a href="/docs/transformers/pr_16000/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<ul>
<li><a
  href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/generation_utils.py#L1669",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/generation_tf_utils.py#L1979",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16000/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/pr_16000/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
downloading and saving models.`),Kv=l(),id=o("p"),Zv=r("Class attributes (overridden by derived classes):"),Jv=l(),ft=o("ul"),Xe=o("li"),ld=o("strong"),Qv=r("config_class"),e0=r(" ("),rr=o("a"),t0=r("PretrainedConfig"),n0=r(") \u2014 A subclass of "),ir=o("a"),o0=r("PretrainedConfig"),s0=r(` to use as configuration class
for this model architecture.`),a0=l(),vn=o("li"),dd=o("strong"),r0=r("base_model_prefix"),i0=r(" ("),pd=o("code"),l0=r("str"),d0=r(`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),p0=l(),R=o("li"),cd=o("strong"),c0=r("main_input_name"),m0=r(" ("),md=o("code"),u0=r("str"),g0=r(") \u2014 The name of the principal input to the model (often "),ud=o("code"),h0=r("input_ids"),_0=r(` for NLP
models, `),gd=o("code"),f0=r("pixel_values"),b0=r(" for vision models and "),hd=o("code"),v0=r("input_values"),y0=r(" for speech models)."),k0=l(),me=o("div"),c(bs.$$.fragment),x0=l(),vs=o("p"),w0=r(`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=o("code"),T0=r("repo_path_or_name"),j0=r("."),$0=l(),fd=o("p"),M0=r("Examples:"),P0=l(),c(ys.$$.fragment),E0=l(),W=o("div"),c(ks.$$.fragment),L0=l(),bd=o("p"),q0=r("Instantiate a pretrained flax model from a pre-trained model configuration."),F0=l(),xs=o("p"),O0=r("The warning "),vd=o("em"),z0=r("Weights from XXX not initialized from pretrained model"),D0=r(` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),A0=l(),ws=o("p"),G0=r("The warning "),yd=o("em"),S0=r("Weights from XXX not used in YYY"),N0=r(` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),C0=l(),kd=o("p"),I0=r("Examples:"),B0=l(),c(Ts.$$.fragment),W0=l(),Re=o("div"),c(js.$$.fragment),U0=l(),xd=o("p"),H0=r(`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V0=l(),c(yn.$$.fragment),X0=l(),kn=o("div"),c($s.$$.fragment),R0=l(),Ms=o("p"),Y0=r(`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=o("code"),K0=r("[from_pretrained()](/docs/transformers/pr_16000/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),Z0=r(" class method"),J0=l(),Y=o("div"),c(Ps.$$.fragment),Q0=l(),se=o("p"),ey=r("Cast the floating-point "),Td=o("code"),ty=r("params"),ny=r(" to "),jd=o("code"),oy=r("jax.numpy.bfloat16"),sy=r(". This returns a new "),$d=o("code"),ay=r("params"),ry=r(` tree and does not cast
...
model parameters to fp32 precision. This returns a new `),Sd=o("code"),Gy=r("params"),Sy=r(" tree and does not cast the "),Nd=o("code"),Ny=r("params"),Cy=r(" in place."),Iy=l(),Cd=o("p"),By=r("Examples:"),Wy=l(),c(Os.$$.fragment),nc=l(),bt=o("h2"),xn=o("a"),Id=o("span"),c(zs.$$.fragment),Uy=l(),Bd=o("span"),Hy=r("Generation"),oc=l(),P=o("div"),c(Ds.$$.fragment),Vy=l(),As=o("p"),Xy=r("A class containing all of the functions supporting generation, to be used as a mixin in "),lr=o("a"),Ry=r("PreTrainedModel"),Yy=r("."),Ky=l(),wn=o("div"),c(Gs.$$.fragment),Zy=l(),Ss=o("p"),Jy=r("Implement in subclasses of "),dr=o("a"),Qy=r("PreTrainedModel"),e1=r(" for custom behavior to adjust the logits in the generate method."),t1=l(),ge=o("div"),c(Ns.$$.fragment),n1=l(),Wd=o("p"),o1=r("Generates sequences for models with a language modeling head using beam search with multinomial sampling."),s1=l(),Ud=o("p"),a1=r("Examples:"),r1=l(),c(Cs.$$.fragment),i1=l(),he=o("div"),c(Is.$$.fragment),l1=l(),Hd=o("p"),d1=r("Generates sequences for models with a language modeling head using beam search decoding."),p1=l(),Vd=o("p"),c1=r("Examples:"),m1=l(),c(Bs.$$.fragment),u1=l(),Tn=o("div"),c(Ws.$$.fragment),g1=l(),Xd=o("p"),h1=r(`compute the transition probabilities of sequences given generation
scores and beam indices`),_1=l(),_e=o("div"),c(Us.$$.fragment),f1=l(),Rd=o("p"),b1=r("Generates sequences for models with a language modeling head using beam search decoding."),v1=l(),Yd=o("p"),y1=r("Examples:"),k1=l(),c(Hs.$$.fragment),x1=l(),U=o("div"),c(Vs.$$.fragment),w1=l(),Kd=o("p"),T1=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),j1=l(),vt=o("p"),$1=r("Apart from "),Zd=o("code"),M1=r("inputs"),P1=r(`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=o("a"),E1=r("PretrainedConfig"),L1=r(" of the model. The default values indicated are the default values of those config."),q1=l(),Xs=o("p"),F1=r("Most of these parameters are explained in more detail in "),Rs=o("a"),O1=r(`this blog
post`),z1=r("."),D1=l(),Jd=o("p"),A1=r("Examples:"),G1=l(),c(Ys.$$.fragment),S1=l(),fe=o("div"),c(Ks.$$.fragment),N1=l(),Qd=o("p"),C1=r("Generates sequences for models with a language modeling head using greedy decoding."),I1=l(),ep=o("p"),B1=r("Examples:"),W1=l(),c(Zs.$$.fragment),U1=l(),be=o("div"),c(Js.$$.fragment),H1=l(),tp=o("p"),V1=r("Generates sequences for models with a language modeling head using beam search decoding."),X1=l(),np=o("p"),R1=r("Examples:"),Y1=l(),c(Qs.$$.fragment),K1=l(),jn=o("div"),c(ea.$$.fragment),Z1=l(),ta=o("p"),J1=r("Implement in subclasses of "),cr=o("a"),Q1=r("PreTrainedModel"),ek=r(" for custom behavior to prepare inputs in the generate method."),tk=l(),ve=o("div"),c(na.$$.fragment),nk=l(),op=o("p"),ok=r("Generates sequences for models with a language modeling head using multinomial sampling."),sk=l(),sp=o("p"),ak=r("Examples:"),rk=l(),c(oa.$$.fragment),sc=l(),G=o("div"),c(sa.$$.fragment),ik=l(),aa=o("p"),lk=r("A class containing all of the functions supporting generation, to be used as a mixin in "),mr=o("a"),dk=r("TFPreTrainedModel"),pk=r("."),ck=l(),$n=o("div"),c(ra.$$.fragment),mk=l(),ia=o("p"),uk=r("Implement in subclasses of "),ur=o("a"),gk=r("PreTrainedModel"),hk=r(" for custom behavior to adjust the logits in the generate method."),_k=l(),N=o("div"),c(la.$$.fragment),fk=l(),ap=o("p"),bk=r(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
downloading and saving models.`),Dx.forEach(t),Kv=d(q),id=s(q,"P",{});var E2=a(id);Zv=i(E2,"Class attributes (overridden by derived classes):"),E2.forEach(t),Jv=d(q),ft=s(q,"UL",{});var Dr=a(ft);Xe=s(Dr,"LI",{});var Da=a(Xe);ld=s(Da,"STRONG",{});var L2=a(ld);Qv=i(L2,"config_class"),L2.forEach(t),e0=i(Da," ("),rr=s(Da,"A",{href:!0});var q2=a(rr);t0=i(q2,"PretrainedConfig"),q2.forEach(t),n0=i(Da,") \u2014 A subclass of "),ir=s(Da,"A",{href:!0});var F2=a(ir);o0=i(F2,"PretrainedConfig"),F2.forEach(t),s0=i(Da,` to use as configuration class
for this model architecture.`),Da.forEach(t),a0=d(Dr),vn=s(Dr,"LI",{});var qp=a(vn);dd=s(qp,"STRONG",{});var O2=a(dd);r0=i(O2,"base_model_prefix"),O2.forEach(t),i0=i(qp," ("),pd=s(qp,"CODE",{});var z2=a(pd);l0=i(z2,"str"),z2.forEach(t),d0=i(qp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),qp.forEach(t),p0=d(Dr),R=s(Dr,"LI",{});var De=a(R);cd=s(De,"STRONG",{});var D2=a(cd);c0=i(D2,"main_input_name"),D2.forEach(t),m0=i(De," ("),md=s(De,"CODE",{});var A2=a(md);u0=i(A2,"str"),A2.forEach(t),g0=i(De,") \u2014 The name of the principal input to the model (often "),ud=s(De,"CODE",{});var G2=a(ud);h0=i(G2,"input_ids"),G2.forEach(t),_0=i(De,` for NLP
models, `),gd=s(De,"CODE",{});var S2=a(gd);f0=i(S2,"pixel_values"),S2.forEach(t),b0=i(De," for vision models and "),hd=s(De,"CODE",{});var N2=a(hd);v0=i(N2,"input_values"),N2.forEach(t),y0=i(De," for speech models)."),De.forEach(t),Dr.forEach(t),k0=d(q),me=s(q,"DIV",{class:!0});var On=a(me);m(bs.$$.fragment,On),x0=d(On),vs=s(On,"P",{});var mm=a(vs);w0=i(mm,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),_d=s(mm,"CODE",{});var C2=a(_d);T0=i(C2,"repo_path_or_name"),C2.forEach(t),j0=i(mm,"."),mm.forEach(t),$0=d(On),fd=s(On,"P",{});var I2=a(fd);M0=i(I2,"Examples:"),I2.forEach(t),P0=d(On),m(ys.$$.fragment,On),On.forEach(t),E0=d(q),W=s(q,"DIV",{class:!0});var Te=a(W);m(ks.$$.fragment,Te),L0=d(Te),bd=s(Te,"P",{});var B2=a(bd);q0=i(B2,"Instantiate a pretrained flax model from a pre-trained model configuration."),B2.forEach(t),F0=d(Te),xs=s(Te,"P",{});var um=a(xs);O0=i(um,"The warning "),vd=s(um,"EM",{});var W2=a(vd);z0=i(W2,"Weights from XXX not initialized from pretrained model"),W2.forEach(t),D0=i(um,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),um.forEach(t),A0=d(Te),ws=s(Te,"P",{});var gm=a(ws);G0=i(gm,"The warning "),yd=s(gm,"EM",{});var U2=a(yd);S0=i(U2,"Weights from XXX not used in YYY"),U2.forEach(t),N0=i(gm,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),gm.forEach(t),C0=d(Te),kd=s(Te,"P",{});var H2=a(kd);I0=i(H2,"Examples:"),H2.forEach(t),B0=d(Te),m(Ts.$$.fragment,Te),Te.forEach(t),W0=d(q),Re=s(q,"DIV",{class:!0});var Ar=a(Re);m(js.$$.fragment,Ar),U0=d(Ar),xd=s(Ar,"P",{});var V2=a(xd);H0=i(V2,`Register this class with a given auto class. This should only be used for custom models as the ones in the
library are already mapped with an auto class.`),V2.forEach(t),V0=d(Ar),m(yn.$$.fragment,Ar),Ar.forEach(t),X0=d(q),kn=s(q,"DIV",{class:!0});var hm=a(kn);m($s.$$.fragment,hm),R0=d(hm),Ms=s(hm,"P",{});var _m=a(Ms);Y0=i(_m,`Save a model and its configuration file to a directory, so that it can be re-loaded using the
`),wd=s(_m,"CODE",{});var X2=a(wd);K0=i(X2,"[from_pretrained()](/docs/transformers/pr_16000/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained)"),X2.forEach(t),Z0=i(_m," class method"),_m.forEach(t),hm.forEach(t),J0=d(q),Y=s(q,"DIV",{class:!0});var Ze=a(Y);m(Ps.$$.fragment,Ze),Q0=d(Ze),se=s(Ze,"P",{});var Je=a(se);ey=i(Je,"Cast the floating-point "),Td=s(Je,"CODE",{});var R2=a(Td);ty=i(R2,"params"),R2.forEach(t),ny=i(Je," to "),jd=s(Je,"CODE",{});var Y2=a(jd);oy=i(Y2,"jax.numpy.bfloat16"),Y2.forEach(t),sy=i(Je,". This returns a new "),$d=s(Je,"CODE",{});var K2=a($d);ay=i(K2,"params"),K2.forEach(t),ry=i(Je,` tree and does not cast
...
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var lj=a(Sd);Gy=i(lj,"params"),lj.forEach(t),Sy=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var dj=a(Nd);Ny=i(dj,"params"),dj.forEach(t),Cy=i(tt," in place."),tt.forEach(t),Iy=d(zn),Cd=s(zn,"P",{});var pj=a(Cd);By=i(pj,"Examples:"),pj.forEach(t),Wy=d(zn),m(Os.$$.fragment,zn),zn.forEach(t),q.forEach(t),nc=d(n),bt=s(n,"H2",{class:!0});var fm=a(bt);xn=s(fm,"A",{id:!0,class:!0,href:!0});var cj=a(xn);Id=s(cj,"SPAN",{});var mj=a(Id);m(zs.$$.fragment,mj),mj.forEach(t),cj.forEach(t),Uy=d(fm),Bd=s(fm,"SPAN",{});var uj=a(Bd);Hy=i(uj,"Generation"),uj.forEach(t),fm.forEach(t),oc=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(Ds.$$.fragment,F),Vy=d(F),As=s(F,"P",{});var bm=a(As);Xy=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var gj=a(lr);Ry=i(gj,"PreTrainedModel"),gj.forEach(t),Yy=i(bm,"."),bm.forEach(t),Ky=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Zy=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);Jy=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var hj=a(dr);Qy=i(hj,"PreTrainedModel"),hj.forEach(t),e1=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),t1=d(F),ge=s(F,"DIV",{class:!0});var Dn=a(ge);m(Ns.$$.fragment,Dn),n1=d(Dn),Wd=s(Dn,"P",{});var _j=a(Wd);o1=i(_j,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),_j.forEach(t),s1=d(Dn),Ud=s(Dn,"P",{});var fj=a(Ud);a1=i(fj,"Examples:"),fj.forEach(t),r1=d(Dn),m(Cs.$$.fragment,Dn),Dn.forEach(t),i1=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),l1=d(An),Hd=s(An,"P",{});var bj=a(Hd);d1=i(bj,"Generates sequences for models with a language modeling head using beam search decoding."),bj.forEach(t),p1=d(An),Vd=s(An,"P",{});var vj=a(Vd);c1=i(vj,"Examples:"),vj.forEach(t),m1=d(An),m(Bs.$$.fragment,An),An.forEach(t),u1=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),g1=d(km),Xd=s(km,"P",{});var yj=a(Xd);h1=i(yj,`compute the transition probabilities of sequences given generation
scores and beam indices`),yj.forEach(t),km.forEach(t),_1=d(F),_e=s(F,"DIV",{class:!0});var Gn=a(_e);m(Us.$$.fragment,Gn),f1=d(Gn),Rd=s(Gn,"P",{});var kj=a(Rd);b1=i(kj,"Generates sequences for models with a language modeling head using beam search decoding."),kj.forEach(t),v1=d(Gn),Yd=s(Gn,"P",{});var xj=a(Yd);y1=i(xj,"Examples:"),xj.forEach(t),k1=d(Gn),m(Hs.$$.fragment,Gn),Gn.forEach(t),x1=d(F),U=s(F,"DIV",{class:!0});var je=a(U);m(Vs.$$.fragment,je),w1=d(je),Kd=s(je,"P",{});var wj=a(Kd);T1=i(wj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),wj.forEach(t),j1=d(je),vt=s(je,"P",{});var Gr=a(vt);$1=i(Gr,"Apart from "),Zd=s(Gr,"CODE",{});var Tj=a(Zd);M1=i(Tj,"inputs"),Tj.forEach(t),P1=i(Gr,`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=s(Gr,"A",{href:!0});var jj=a(pr);E1=i(jj,"PretrainedConfig"),jj.forEach(t),L1=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),q1=d(je),Xs=s(je,"P",{});var xm=a(Xs);F1=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var $j=a(Rs);O1=i($j,`this blog
post`),$j.forEach(t),z1=i(xm,"."),xm.forEach(t),D1=d(je),Jd=s(je,"P",{});var Mj=a(Jd);A1=i(Mj,"Examples:"),Mj.forEach(t),G1=d(je),m(Ys.$$.fragment,je),je.forEach(t),S1=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),N1=d(Sn),Qd=s(Sn,"P",{});var Pj=a(Qd);C1=i(Pj,"Generates sequences for models with a language modeling head using greedy decoding."),Pj.forEach(t),I1=d(Sn),ep=s(Sn,"P",{});var Ej=a(ep);B1=i(Ej,"Examples:"),Ej.forEach(t),W1=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),U1=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),H1=d(Nn),tp=s(Nn,"P",{});var Lj=a(tp);V1=i(Lj,"Generates sequences for models with a language modeling head using beam search decoding."),Lj.forEach(t),X1=d(Nn),np=s(Nn,"P",{});var qj=a(np);R1=i(qj,"Examples:"),qj.forEach(t),Y1=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),K1=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Z1=d(wm),ta=s(wm,"P",{});var Tm=a(ta);J1=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var Fj=a(cr);Q1=i(Fj,"PreTrainedModel"),Fj.forEach(t),ek=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),tk=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),nk=d(Cn),op=s(Cn,"P",{});var Oj=a(op);ok=i(Oj,"Generates sequences for models with a language modeling head using multinomial sampling."),Oj.forEach(t),sk=d(Cn),sp=s(Cn,"P",{});var zj=a(sp);ak=i(zj,"Examples:"),zj.forEach(t),rk=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),ik=d(J),aa=s(J,"P",{});var jm=a(aa);lk=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var Dj=a(mr);dk=i(Dj,"TFPreTrainedModel"),Dj.forEach(t),pk=i(jm,"."),jm.forEach(t),ck=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),mk=d($m),ia=s($m,"P",{});var Mm=a(ia);uk=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var Aj=a(ur);gk=i(Aj,"PreTrainedModel"),Aj.forEach(t),hk=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),_k=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),fk=d(Q),ap=s(Q,"P",{});var Gj=a(ap);bk=i(Gj,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
