...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16000/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),e0=u(),nn=o("p"),KS=a("Here is an example of running "),N1=o("code"),JS=a("run_translation.py"),XS=a(" under DeepSpeed deploying all available GPUs:"),s0=u(),f(gr.$$.fragment),t0=u(),tc=o("p"),QS=a(`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
should be able to fit much larger batches and/or sequence length onto the same hardware.`),a0=u(),ac=o("p"),eC=a(`Additionally DeepSpeed is currently developing a related product called Deepspeed-Inference which has no relationship
to the ZeRO technology, but instead uses tensor parallelism to scale models that can\u2019t fit onto a single GPU. This is a
work in progress and we will provide the integration once that product is complete.`),n0=u(),Ks=o("h3"),on=o("a"),H1=o("span"),f(yr.$$.fragment),sC=u(),B1=o("span"),tC=a("Memory Requirements"),o0=u(),nc=o("p"),aC=a("Since Deepspeed ZeRO can offload memory to CPU (and NVMe) the framework provides utils that allow one to tell how much CPU and GPU memory will be needed depending on the number of GPUs being used."),l0=u(),oc=o("p"),nC=a("Let\u2019s estimate how much memory is needed to finetune \u201Cbigscience/T0_3B\u201D on a single GPU:"),r0=u(),f(wr.$$.fragment),p0=u(),lc=o("p"),oC=a("So you can fit it on a single 80GB GPU and no CPU offload, or a tiny 8GB GPU but then need ~60GB of CPU memory. (Remember this is just the memory for params, optimizer states and gradients - you will need a bit more memory for cuda kernels, activations and temps.)"),i0=u(),rc=o("p"),lC=a("Then it\u2019s a tradeoff of cost vs speed. It\u2019ll be cheaper to buy/rent a smaller GPU (or less GPUs since you can use multiple GPUs with Deepspeed ZeRO. But then it\u2019ll be slower, so even if you don\u2019t care about how fast something will be done, the slowdown has a direct impact on the duration of using the GPU and thus bigger cost. So experiment and compare which works the best."),u0=u(),pc=o("p"),rC=a("If you have enough GPU memory make sure to disable the CPU/NVMe offload as it\u2019ll make everything faster."),c0=u(),ic=o("p"),pC=a("For example, let\u2019s repeat the same for 2 GPUs:"),h0=u(),f(br.$$.fragment),f0=u(),uc=o("p"),iC=a("So here you\u2019d want 2x 32GB GPUs or higher without offloading to CPU."),d0=u(),ln=o("p"),uC=a("For full information please see "),qr=o("a"),cC=a("memory estimators"),hC=a("."),m0=u(),Js=o("h3"),rn=o("a"),W1=o("span"),f(Er.$$.fragment),fC=u(),F1=o("span"),dC=a("Filing Issues"),_0=u(),cc=o("p"),mC=a("Here is how to file an issue so that we could quickly get to the bottom of the issue and help you to unblock your work."),v0=u(),hc=o("p"),_C=a("In your report please always include:"),j0=u(),R=o("ol"),V1=o("li"),Y1=o("p"),vC=a("the full Deepspeed config file in the report"),jC=u(),K1=o("li"),qe=o("p"),gC=a("either the command line arguments if you were using the "),fc=o("a"),yC=a("Trainer"),wC=a(` or
...
a starting point.`),SC=u(),Q1=o("li"),ev=o("p"),CC=a("Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),xC=u(),sv=o("li"),Dr=o("p"),RC=a("If possible try to use one of the existing "),Or=o("a"),IC=a("examples"),UC=a(" to reproduce the problem with."),g0=u(),_c=o("p"),GC=a("Things to consider:"),y0=u(),pn=o("ul"),Xs=o("li"),tv=o("p"),LC=a("Deepspeed is often not the cause of the problem."),MC=u(),av=o("p"),ZC=a(`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
need be.`),w0=u(),Qs=o("h3"),un=o("a"),lv=o("span"),f(Sr.$$.fragment),YC=u(),rv=o("span"),KC=a("Troubleshooting"),b0=u(),et=o("h4"),cn=o("a"),pv=o("span"),f(Cr.$$.fragment),JC=u(),xr=o("span"),XC=a("the "),iv=o("code"),QC=a("deepspeed"),ex=a(" process gets killed at startup without a traceback"),q0=u(),I=o("p"),sx=a("If the "),uv=o("code"),tx=a("deepspeed"),ax=a(` process gets killed at launch time without a traceback, that usually means that the program tried
...
ZeRO-3. Here is how you can `),Rr=o("a"),ux=a("estimate how much memory is needed for a specific model"),cx=a("."),E0=u(),st=o("h4"),hn=o("a"),dv=o("span"),f(Ir.$$.fragment),hx=u(),vc=o("span"),fx=a("training and/or eval/predict loss is "),mv=o("code"),dx=a("NaN"),$0=u(),jc=o("p"),mx=a("This often happens when one takes a model pre-trained in bf16 mixed precision mode and tries to use it under fp16 (with or without mixed precision). Most models trained on TPU and often the ones released by Google are in this category (e.g. almost all t5-based models). Here the solution is to either use fp32 or bf16 if your hardware supports it (TPU, Ampere GPUs or newer)."),k0=u(),gc=o("p"),_x=a("The other problem may have to do with using fp16. When you configure this section:"),P0=u(),f(Ur.$$.fragment),z0=u(),fn=o("p"),vx=a("and you see in your log that Deepspeed reports "),_v=o("code"),jx=a("OVERFLOW!"),gx=a(" as follows:"),D0=u(),f(Gr.$$.fragment),O0=u(),yc=o("p"),yx=a("that means that the Deepspeed loss scaler can\u2019t figure out a scaling co-efficient that overcomes loss overflow."),T0=u(),wc=o("p"),wx=a("(the log was massaged to be more readable here.)"),A0=u(),ls=o("p"),bx=a("In this case you usually need to raise the value of "),vv=o("code"),qx=a("initial_scale_power"),Ex=a(". Setting it to "),jv=o("code"),$x=a('"initial_scale_power": 32'),kx=a(" will typically resolve the problem."),S0=u(),tt=o("h3"),dn=o("a"),gv=o("span"),f(Lr.$$.fragment),Px=u(),yv=o("span"),zx=a("Notes"),C0=u(),rs=o("ul"),mn=o("li"),Dx=a("DeepSpeed works with the PyTorch "),bc=o("a"),Ox=a("Trainer"),Tx=a(" but not TF "),wv=o("code"),Ax=a("TFTrainer"),Sx=u(),Mr=o("li"),Cx=a("While DeepSpeed has a pip installable PyPI package, it is highly recommended that it gets installed from "),Zr=o("a"),xx=a("source"),Rx=a(` to best match your hardware and also if you need to enable
...
with your own trainer, and you will have to adapt the latter according to `),Nr=o("a"),Mx=a("the DeepSpeed integration instructions"),Zx=a("."),x0=u(),Ec=o("a"),R0=u(),nt=o("h2"),_n=o("a"),bv=o("span"),f(Hr.$$.fragment),Nx=u(),qv=o("span"),Hx=a("Non-Trainer Deepspeed Integration"),I0=u(),le=o("p"),Bx=a("The "),$c=o("a"),Wx=a("HfDeepSpeedConfig"),Fx=a(` is used to integrate Deepspeed into the \u{1F917} Transformers core
functionality, when `),kc=o("a"),Vx=a("Trainer"),Yx=a(" is not used. The only thing that it does is handling Deepspeed ZeRO 3 param gathering and automatically splitting the model onto multiple gpus during "),Ev=o("code"),Kx=a("from_pretrained"),Jx=a(" call. Everything else you have to do by yourself."),U0=u(),vn=o("p"),Xx=a("When using "),Pc=o("a"),Qx=a("Trainer"),eR=a(" everything is automatically taken care of."),G0=u(),ps=o("p"),sR=a("When not using "),zc=o("a"),tR=a("Trainer"),aR=a(`, to efficiently deploy DeepSpeed stage 3, you must instantiate the
`),Dc=o("a"),nR=a("HfDeepSpeedConfig"),oR=a(" object before instantiating the model."),L0=u(),Oc=o("p"),lR=a("For example for a pretrained model:"),M0=u(),f(Br.$$.fragment),Z0=u(),Tc=o("p"),rR=a("or for non-pretrained model:"),N0=u(),f(Wr.$$.fragment),H0=u(),re=o("p"),pR=a("Please note that if you\u2019re not using the "),Ac=o("a"),iR=a("Trainer"),uR=a(" integration, you\u2019re completely on your own. Basically follow the documentation on the "),Fr=o("a"),cR=a("Deepspeed"),hR=a(" website. Also you have to configure explicitly the config file - you can\u2019t use "),$v=o("code"),fR=a('"auto"'),dR=a(" values and you will have to put real values instead."),B0=u(),ot=o("h2"),jn=o("a"),kv=o("span"),f(Vr.$$.fragment),mR=u(),Pv=o("span"),_R=a("HfDeepSpeedConfig"),W0=u(),E=o("div"),f(Yr.$$.fragment),vR=u(),zv=o("p"),jR=a("This object contains a DeepSpeed configuration dictionary and can be quickly queried for things like zero stage."),gR=u(),Ee=o("p"),yR=a("A "),Dv=o("code"),wR=a("weakref"),bR=a(` of this object is stored in the module\u2019s globals to be able to access the config from areas where
...
the DeepSpeed configuration is not modified in any way.`),RR=u(),is=o("div"),f(Kr.$$.fragment),IR=u(),Cv=o("p"),UR=a("Deletes a sub-section of the config file if it\u2019s found."),GR=u(),lt=o("p"),LR=a("Unless "),xv=o("code"),MR=a("must_exist"),ZR=a(" is "),Rv=o("code"),NR=a("True"),HR=a(" the section doesn\u2019t have to exist."),BR=u(),gn=o("div"),f(Jr.$$.fragment),WR=u(),Xr=o("p"),FR=a("Returns the set value or "),Iv=o("code"),VR=a("default"),YR=a(" if no value is set"),KR=u(),yn=o("div"),f(Qr.$$.fragment),JR=u(),rt=o("p"),XR=a("Returns "),Uv=o("code"),QR=a("True"),eI=a("/"),Gv=o("code"),sI=a("False` only if the value is set, always `False` otherwise. So use this method to ask the very specific question of whether the value is set to `False` (and it's not set to `True"),tI=a(" or isn\u2019t set)."),aI=u(),wn=o("div"),f(ep.$$.fragment),nI=u(),pt=o("p"),oI=a("Returns "),Lv=o("code"),lI=a("True"),rI=a("/"),Mv=o("code"),pI=a("False` only if the value is set, always `False` otherwise. So use this method to ask the very specific question of whether the value is set to `True` (and it's not set to `False"),iI=a(" or isn\u2019t set)."),F0=u(),it=o("h3"),bn=o("a"),Zv=o("span"),f(sp.$$.fragment),uI=u(),Nv=o("span"),cI=a("Custom DeepSpeed ZeRO Inference"),V0=u(),qn=o("p"),hI=a("Here is an example of how one could do DeepSpeed ZeRO Inference without using "),xc=o("a"),fI=a("Trainer"),dI=a(" when one can\u2019t fit a model onto a single GPU. The solution includes using additional GPUs or/and offloading GPU memory to CPU memory."),Y0=u(),Rc=o("p"),mI=a("The important nuance to understand here is that the way ZeRO is designed you can process different inputs on different GPUs in parallel."),K0=u(),Ic=o("p"),_I=a("The example has copious notes and is self-documenting."),J0=u(),Uc=o("p"),vI=a("Make sure to:"),X0=u(),En=o("ol"),Hv=o("li"),jI=a("disable CPU offload if you have enough GPU memory (since it slows things down)"),gI=u(),Bv=o("li"),yI=a("enable bf16 if you own an Ampere or a newer GPU to make things faster. If you don\u2019t have that hardware you may enable fp16 as long as you don\u2019t use any model that was pre-trained in bf16 mixed precision (such as most t5 models). These usually overflow in fp16 and you will see garbage as output."),Q0=u(),f(tp.$$.fragment),e3=u(),$n=o("p"),wI=a("Let\u2019s save it as "),Wv=o("code"),bI=a("t0.py"),qI=a(" and run it:"),s3=u(),f(ap.$$.fragment),t3=u(),Gc=o("p"),EI=a("This was a very basic example and you will want to adapt it to your needs."),a3=u(),ut=o("h2"),kn=o("a"),Fv=o("span"),f(np.$$.fragment),$I=u(),Vv=o("span"),kI=a("Main DeepSpeed Resources"),n3=u(),ie=o("ul"),Yv=o("li"),op=o("a"),PI=a("Project\u2019s github"),zI=u(),Kv=o("li"),lp=o("a"),DI=a("Usage docs"),OI=u(),Jv=o("li"),rp=o("a"),TI=a("API docs"),AI=u(),Xv=o("li"),pp=o("a"),SI=a("Blog posts"),o3=u(),Lc=o("p"),CI=a("Papers:"),l3=u(),us=o("ul"),Qv=o("li"),ip=o("a"),xI=a("ZeRO: Memory Optimizations Toward Training Trillion Parameter Models"),RI=u(),ej=o("li"),up=o("a"),II=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),UI=u(),sj=o("li"),cp=o("a"),GI=a("ZeRO-Infinity: Breaking the GPU Memory Wall for Extreme Scale Deep Learning"),r3=u(),cs=o("p"),LI=a("Finally, please, remember that, HuggingFace "),Mc=o("a"),MI=a("Trainer"),ZI=a(` only integrates DeepSpeed, therefore if you
...
won\u2019t be possible on a single GPU.`),iU.forEach(t),hj=c(e),ft=l(e,"P",{});var i3=r(ft);r6=n(i3,"\u{1F917} Transformers integrates "),Wn=l(i3,"A",{href:!0,rel:!0});var uU=r(Wn);p6=n(uU,"DeepSpeed"),uU.forEach(t),i6=n(i3," via 2 options:"),i3.forEach(t),fj=c(e),dt=l(e,"OL",{});var u3=r(dt);Fn=l(u3,"LI",{});var c3=r(Fn);u6=n(c3,"Integration of the core DeepSpeed features via "),Ep=l(c3,"A",{href:!0});var cU=r(Ep);c6=n(cU,"Trainer"),cU.forEach(t),h6=n(c3,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),c3.forEach(t),f6=c(u3),L=l(u3,"LI",{});var ce=r(L);d6=n(ce,"If you don\u2019t use "),$p=l(ce,"A",{href:!0});var hU=r($p);m6=n(hU,"Trainer"),hU.forEach(t),_6=n(ce,` and want to use your own Trainer where you integrated DeepSpeed
...
install `),Jh=l(Bc,"EM",{});var LU=r(Jh);t$=n(LU,"libaio-dev"),LU.forEach(t),a$=n(Bc," system-wide)."),Bc.forEach(t),Cj=c(e),jt=l(e,"P",{});var _3=r(jt);n$=n(_3,"Edit "),Xh=l(_3,"CODE",{});var MU=r(Xh);o$=n(MU,"TORCH_CUDA_ARCH_LIST"),MU.forEach(t),l$=n(_3,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),_3.forEach(t),xj=c(e),d(to.$$.fragment,e),Rj=c(e),ge=l(e,"P",{});var dp=r(ge);r$=n(dp,"So if you get "),Qh=l(dp,"CODE",{});var ZU=r(Qh);p$=n(ZU,"8, 6"),ZU.forEach(t),i$=n(dp,", then use "),ef=l(dp,"CODE",{});var NU=r(ef);u$=n(NU,'TORCH_CUDA_ARCH_LIST="8.6"'),NU.forEach(t),c$=n(dp,`. If you have multiple different cards, you can list all
...
use it here as well.`),zn.forEach(t),rg=c(e),kt=l(e,"P",{});var E3=r(kt);q5=n(E3,"Here is an example of running "),bf=l(E3,"CODE",{});var bG=r(bf);E5=n(bG,"run_translation.py"),bG.forEach(t),$5=n(E3," under DeepSpeed deploying all available GPUs:"),E3.forEach(t),pg=c(e),d(mo.$$.fragment,e),ig=c(e),Pt=l(e,"P",{});var $3=r(Pt);k5=n($3,"Note that in the DeepSpeed documentation you are likely to see "),qf=l($3,"CODE",{});var qG=r(qf);P5=n(qG,"--deepspeed --deepspeed_config ds_config.json"),qG.forEach(t),z5=n($3,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),$3.forEach(t),ug=c(e),zt=l(e,"P",{});var k3=r(zt);D5=n(k3,"For some practical usage examples, please, see this "),_o=l(k3,"A",{href:!0,rel:!0});var EG=r(_o);O5=n(EG,"post"),EG.forEach(t),T5=n(k3,"."),k3.forEach(t),cg=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),hg=c(e),bs=l(e,"H3",{class:!0});var P3=r(bs);Dt=l(P3,"A",{id:!0,class:!0,href:!0});var $G=r(Dt);Ef=l($G,"SPAN",{});var kG=r(Ef);d(vo.$$.fragment,kG),kG.forEach(t),$G.forEach(t),A5=c(P3),$f=l(P3,"SPAN",{});var PG=r($f);S5=n(PG,"Deployment with one GPU"),PG.forEach(t),P3.forEach(t),fg=c(e),Ot=l(e,"P",{});var z3=r(Ot);C5=n(z3,"To deploy DeepSpeed with one GPU adjust the "),Yp=l(z3,"A",{href:!0});var zG=r(Yp);x5=n(zG,"Trainer"),zG.forEach(t),R5=n(z3," command line arguments as follows:"),z3.forEach(t),dg=c(e),d(jo.$$.fragment,e),mg=c(e),Ae=l(e,"P",{});var Yc=r(Ae);I5=n(Yc,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
...
with, then you don\u2019t need this argument. The following `),go=l(Yc,"A",{href:!0,rel:!0});var OG=r(go);L5=n(OG,"documentation"),OG.forEach(t),M5=n(Yc," discusses the launcher options."),Yc.forEach(t),_g=c(e),Kp=l(e,"P",{});var TG=r(Kp);Z5=n(TG,"Why would you want to use DeepSpeed with just one GPU?"),TG.forEach(t),vg=c(e),Tt=l(e,"OL",{});var D3=r(Tt);Pf=l(D3,"LI",{});var AG=r(Pf);N5=n(AG,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),AG.forEach(t),H5=c(D3),zf=l(D3,"LI",{});var SG=r(zf);B5=n(SG,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),SG.forEach(t),D3.forEach(t),jg=c(e),Jp=l(e,"P",{});var CG=r(Jp);W5=n(CG,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
...
find more details in the discussion below.`),xG.forEach(t),wg=c(e),At=l(e,"P",{});var O3=r(At);V5=n(O3,"For a practical usage example of this type of deployment, please, see this "),wo=l(O3,"A",{href:!0,rel:!0});var RG=r(wo);Y5=n(RG,"post"),RG.forEach(t),K5=n(O3,"."),O3.forEach(t),bg=c(e),Qp=l(e,"P",{});var IG=r(Qp);J5=n(IG,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),IG.forEach(t),qg=c(e),ei=l(e,"P",{});var UG=r(ei);X5=n(UG,"Notes:"),UG.forEach(t),Eg=c(e),si=l(e,"UL",{});var GG=r(si);qs=l(GG,"LI",{});var Kc=r(qs);bo=l(Kc,"P",{});var T3=r(bo);Q5=n(T3,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Df=l(T3,"CODE",{});var LG=r(Df);e4=n(LG,"CUDA_VISIBLE_DEVICES"),LG.forEach(t),s4=n(T3,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),T3.forEach(t),t4=c(Kc),d(qo.$$.fragment,Kc),a4=c(Kc),Of=l(Kc,"P",{});var MG=r(Of);n4=n(MG,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),MG.forEach(t),Kc.forEach(t),GG.forEach(t),$g=c(e),ti=l(e,"A",{id:!0}),r(ti).forEach(t),kg=c(e),Es=l(e,"H3",{class:!0});var A3=r(Es);St=l(A3,"A",{id:!0,class:!0,href:!0});var ZG=r(St);Tf=l(ZG,"SPAN",{});var NG=r(Tf);d(Eo.$$.fragment,NG),NG.forEach(t),ZG.forEach(t),o4=c(A3),Af=l(A3,"SPAN",{});var HG=r(Af);l4=n(HG,"Deployment in Notebooks"),HG.forEach(t),A3.forEach(t),Pg=c(e),Ct=l(e,"P",{});var S3=r(Ct);r4=n(S3,"The problem with running notebook cells as a script is that there is no normal "),Sf=l(S3,"CODE",{});var BG=r(Sf);p4=n(BG,"deepspeed"),BG.forEach(t),i4=n(S3,` launcher to rely on, so
under certain setups we have to emulate it.`),S3.forEach(t),zg=c(e),ai=l(e,"P",{});var WG=r(ai);u4=n(WG,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),WG.forEach(t),Dg=c(e),d($o.$$.fragment,e),Og=c(e),xt=l(e,"P",{});var C3=r(xt);c4=n(C3,"Note: "),Cf=l(C3,"CODE",{});var FG=r(Cf);h4=n(FG,"..."),FG.forEach(t),f4=n(C3," stands for the normal arguments that you\u2019d pass to the functions."),C3.forEach(t),Tg=c(e),ni=l(e,"P",{});var VG=r(ni);d4=n(VG,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
...
shell from a cell. For example, to use `),Rf=l(Jc,"CODE",{});var JG=r(Rf);g4=n(JG,"run_translation.py"),JG.forEach(t),y4=n(Jc," you would launch it with:"),Jc.forEach(t),xg=c(e),d(Po.$$.fragment,e),Rg=c(e),Rt=l(e,"P",{});var x3=r(Rt);w4=n(x3,"or with "),If=l(x3,"CODE",{});var XG=r(If);b4=n(XG,"%%bash"),XG.forEach(t),q4=n(x3," magic, where you can write a multi-line code for the shell program to run:"),x3.forEach(t),Ig=c(e),d(zo.$$.fragment,e),Ug=c(e),li=l(e,"P",{});var QG=r(li);E4=n(QG,"In such case you don\u2019t need any of the code presented at the beginning of this section."),QG.forEach(t),Gg=c(e),It=l(e,"P",{});var R3=r(It);$4=n(R3,"Note: While "),Uf=l(R3,"CODE",{});var eL=r(Uf);k4=n(eL,"%%bash"),eL.forEach(t),P4=n(R3,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),R3.forEach(t),Lg=c(e),ri=l(e,"A",{id:!0}),r(ri).forEach(t),Mg=c(e),$s=l(e,"H3",{class:!0});var I3=r($s);Ut=l(I3,"A",{id:!0,class:!0,href:!0});var sL=r(Ut);Gf=l(sL,"SPAN",{});var tL=r(Gf);d(Do.$$.fragment,tL),tL.forEach(t),sL.forEach(t),z4=c(I3),Lf=l(I3,"SPAN",{});var aL=r(Lf);D4=n(aL,"Configuration"),aL.forEach(t),I3.forEach(t),Zg=c(e),Gt=l(e,"P",{});var U3=r(Gt);O4=n(U3,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Oo=l(U3,"A",{href:!0,rel:!0});var nL=r(Oo);T4=n(nL,"following documentation"),nL.forEach(t),A4=n(U3,"."),U3.forEach(t),Ng=c(e),Lt=l(e,"P",{});var G3=r(Lt);S4=n(G3,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),To=l(G3,"A",{href:!0,rel:!0});var oL=r(To);C4=n(oL,`the DeepSpeedExamples
repo`),oL.forEach(t),x4=n(G3,":"),G3.forEach(t),Hg=c(e),d(Ao.$$.fragment,e),Bg=c(e),Mt=l(e,"P",{});var L3=r(Mt);R4=n(L3,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Mf=l(L3,"CODE",{});var lL=r(Mf);I4=n(lL,".json"),lL.forEach(t),U4=n(L3," files with:"),L3.forEach(t),Wg=c(e),d(So.$$.fragment,e),Fg=c(e),Zt=l(e,"P",{});var M3=r(Zt);G4=n(M3,"Some more examples are to be found in the "),Co=l(M3,"A",{href:!0,rel:!0});var rL=r(Co);L4=n(rL,"main repo"),rL.forEach(t),M4=n(M3," as well."),M3.forEach(t),Vg=c(e),pi=l(e,"P",{});var pL=r(pi);Z4=n(pL,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
...
precision training if `),Hf=l(Dn,"CODE",{});var cL=r(Hf);V4=n(cL,"--fp16"),cL.forEach(t),Y4=n(Dn," is passed:"),Dn.forEach(t),Kg=c(e),d(xo.$$.fragment,e),Jg=c(e),Nt=l(e,"P",{});var Z3=r(Nt);K4=n(Z3,"When you execute the program, DeepSpeed will log the configuration it received from the "),ii=l(Z3,"A",{href:!0});var hL=r(ii);J4=n(hL,"Trainer"),hL.forEach(t),X4=n(Z3,`
to the console, so you can see exactly what was the final configuration passed to it.`),Z3.forEach(t),Xg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Qg=c(e),ks=l(e,"H3",{class:!0});var N3=r(ks);Ht=l(N3,"A",{id:!0,class:!0,href:!0});var fL=r(Ht);Bf=l(fL,"SPAN",{});var dL=r(Bf);d(Ro.$$.fragment,dL),dL.forEach(t),fL.forEach(t),Q4=c(N3),Wf=l(N3,"SPAN",{});var mL=r(Wf);e8=n(mL,"Passing Configuration"),mL.forEach(t),N3.forEach(t),ey=c(e),T=l(e,"P",{});var fe=r(T);s8=n(fe,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
...
the file system before passing it to `),fi=l(fe,"A",{href:!0});var yL=r(fi);u8=n(yL,"TrainingArguments"),yL.forEach(t),c8=n(fe,"."),fe.forEach(t),sy=c(e),di=l(e,"P",{});var wL=r(di);h8=n(wL,"To summarize you can do:"),wL.forEach(t),ty=c(e),d(Io.$$.fragment,e),ay=c(e),mi=l(e,"P",{});var bL=r(mi);f8=n(bL,"or:"),bL.forEach(t),ny=c(e),d(Uo.$$.fragment,e),oy=c(e),_i=l(e,"A",{id:!0}),r(_i).forEach(t),ly=c(e),Ps=l(e,"H3",{class:!0});var H3=r(Ps);Bt=l(H3,"A",{id:!0,class:!0,href:!0});var qL=r(Bt);Yf=l(qL,"SPAN",{});var EL=r(Yf);d(Go.$$.fragment,EL),EL.forEach(t),qL.forEach(t),d8=c(H3),Kf=l(H3,"SPAN",{});var $L=r(Kf);m8=n($L,"Shared Configuration"),$L.forEach(t),H3.forEach(t),ry=c(e),d(Wt.$$.fragment,e),py=c(e),Ce=l(e,"P",{});var Xc=r(Ce);_8=n(Xc,"Some configuration values are required by both the "),vi=l(Xc,"A",{href:!0});var kL=r(vi);v8=n(kL,"Trainer"),kL.forEach(t),j8=n(Xc,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),ji=l(Xc,"A",{href:!0});var PL=r(ji);g8=n(PL,"Trainer"),PL.forEach(t),y8=n(Xc," command line arguments."),Xc.forEach(t),iy=c(e),Ft=l(e,"P",{});var B3=r(Ft);w8=n(B3,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),gi=l(B3,"A",{href:!0});var zL=r(gi);b8=n(zL,"Trainer"),zL.forEach(t),q8=n(B3,` do the majority
of configuration for you.`),B3.forEach(t),uy=c(e),xe=l(e,"P",{});var Qc=r(xe);E8=n(Qc,"Therefore, in the rest of this guide you will find a special configuration value: "),Jf=l(Qc,"CODE",{});var DL=r(Jf);$8=n(DL,"auto"),DL.forEach(t),k8=n(Qc,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
...
your needs.`),TL.forEach(t),hy=c(e),Vt=l(e,"P",{});var W3=r(Vt);O8=n(W3,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),bi=l(W3,"A",{href:!0});var AL=r(bi);T8=n(AL,"TrainingArguments"),AL.forEach(t),A8=n(W3," based on that. The steps are:"),W3.forEach(t),fy=c(e),Yt=l(e,"OL",{});var F3=r(Yt);Xf=l(F3,"LI",{});var SL=r(Xf);S8=n(SL,"Create or load the DeepSpeed configuration to be used as a master configuration"),SL.forEach(t),C8=c(F3),Lo=l(F3,"LI",{});var V3=r(Lo);x8=n(V3,"Create the "),qi=l(V3,"A",{href:!0});var CL=r(qi);R8=n(CL,"TrainingArguments"),CL.forEach(t),I8=n(V3," object based on these values"),V3.forEach(t),F3.forEach(t),dy=c(e),Q=l(e,"P",{});var On=r(Q);U8=n(On,"Do note that some values, such as "),Qf=l(On,"CODE",{});var xL=r(Qf);G8=n(xL,"scheduler.params.total_num_steps"),xL.forEach(t),L8=n(On,` are calculated by
`),Ei=l(On,"A",{href:!0});var RL=r(Ei);M8=n(RL,"Trainer"),RL.forEach(t),Z8=n(On," during "),ed=l(On,"CODE",{});var IL=r(ed);N8=n(IL,"train"),IL.forEach(t),H8=n(On,", but you can of course do the math yourself."),On.forEach(t),my=c(e),$i=l(e,"A",{id:!0}),r($i).forEach(t),_y=c(e),zs=l(e,"H3",{class:!0});var Y3=r(zs);Kt=l(Y3,"A",{id:!0,class:!0,href:!0});var UL=r(Kt);sd=l(UL,"SPAN",{});var GL=r(sd);d(Mo.$$.fragment,GL),GL.forEach(t),UL.forEach(t),B8=c(Y3),td=l(Y3,"SPAN",{});var LL=r(td);W8=n(LL,"ZeRO"),LL.forEach(t),Y3.forEach(t),vy=c(e),Zo=l(e,"P",{});var BI=r(Zo);No=l(BI,"A",{href:!0,rel:!0});var ML=r(No);F8=n(ML,"Zero Redundancy Optimizer (ZeRO)"),ML.forEach(t),V8=n(BI,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
...
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),gW.forEach(t),e0=c(e),nn=l(e,"P",{});var dE=r(nn);KS=n(dE,"Here is an example of running "),N1=l(dE,"CODE",{});var yW=r(N1);JS=n(yW,"run_translation.py"),yW.forEach(t),XS=n(dE," under DeepSpeed deploying all available GPUs:"),dE.forEach(t),s0=c(e),d(gr.$$.fragment,e),t0=c(e),tc=l(e,"P",{});var wW=r(tc);QS=n(wW,`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
should be able to fit much larger batches and/or sequence length onto the same hardware.`),wW.forEach(t),a0=c(e),ac=l(e,"P",{});var bW=r(ac);eC=n(bW,`Additionally DeepSpeed is currently developing a related product called Deepspeed-Inference which has no relationship
to the ZeRO technology, but instead uses tensor parallelism to scale models that can\u2019t fit onto a single GPU. This is a
work in progress and we will provide the integration once that product is complete.`),bW.forEach(t),n0=c(e),Ks=l(e,"H3",{class:!0});var mE=r(Ks);on=l(mE,"A",{id:!0,class:!0,href:!0});var qW=r(on);H1=l(qW,"SPAN",{});var EW=r(H1);d(yr.$$.fragment,EW),EW.forEach(t),qW.forEach(t),sC=c(mE),B1=l(mE,"SPAN",{});var $W=r(B1);tC=n($W,"Memory Requirements"),$W.forEach(t),mE.forEach(t),o0=c(e),nc=l(e,"P",{});var kW=r(nc);aC=n(kW,"Since Deepspeed ZeRO can offload memory to CPU (and NVMe) the framework provides utils that allow one to tell how much CPU and GPU memory will be needed depending on the number of GPUs being used."),kW.forEach(t),l0=c(e),oc=l(e,"P",{});var PW=r(oc);nC=n(PW,"Let\u2019s estimate how much memory is needed to finetune \u201Cbigscience/T0_3B\u201D on a single GPU:"),PW.forEach(t),r0=c(e),d(wr.$$.fragment,e),p0=c(e),lc=l(e,"P",{});var zW=r(lc);oC=n(zW,"So you can fit it on a single 80GB GPU and no CPU offload, or a tiny 8GB GPU but then need ~60GB of CPU memory. (Remember this is just the memory for params, optimizer states and gradients - you will need a bit more memory for cuda kernels, activations and temps.)"),zW.forEach(t),i0=c(e),rc=l(e,"P",{});var DW=r(rc);lC=n(DW,"Then it\u2019s a tradeoff of cost vs speed. It\u2019ll be cheaper to buy/rent a smaller GPU (or less GPUs since you can use multiple GPUs with Deepspeed ZeRO. But then it\u2019ll be slower, so even if you don\u2019t care about how fast something will be done, the slowdown has a direct impact on the duration of using the GPU and thus bigger cost. So experiment and compare which works the best."),DW.forEach(t),u0=c(e),pc=l(e,"P",{});var OW=r(pc);rC=n(OW,"If you have enough GPU memory make sure to disable the CPU/NVMe offload as it\u2019ll make everything faster."),OW.forEach(t),c0=c(e),ic=l(e,"P",{});var TW=r(ic);pC=n(TW,"For example, let\u2019s repeat the same for 2 GPUs:"),TW.forEach(t),h0=c(e),d(br.$$.fragment,e),f0=c(e),uc=l(e,"P",{});var AW=r(uc);iC=n(AW,"So here you\u2019d want 2x 32GB GPUs or higher without offloading to CPU."),AW.forEach(t),d0=c(e),ln=l(e,"P",{});var _E=r(ln);uC=n(_E,"For full information please see "),qr=l(_E,"A",{href:!0,rel:!0});var SW=r(qr);cC=n(SW,"memory estimators"),SW.forEach(t),hC=n(_E,"."),_E.forEach(t),m0=c(e),Js=l(e,"H3",{class:!0});var vE=r(Js);rn=l(vE,"A",{id:!0,class:!0,href:!0});var CW=r(rn);W1=l(CW,"SPAN",{});var xW=r(W1);d(Er.$$.fragment,xW),xW.forEach(t),CW.forEach(t),fC=c(vE),F1=l(vE,"SPAN",{});var RW=r(F1);dC=n(RW,"Filing Issues"),RW.forEach(t),vE.forEach(t),_0=c(e),cc=l(e,"P",{});var IW=r(cc);mC=n(IW,"Here is how to file an issue so that we could quickly get to the bottom of the issue and help you to unblock your work."),IW.forEach(t),v0=c(e),hc=l(e,"P",{});var UW=r(hc);_C=n(UW,"In your report please always include:"),UW.forEach(t),j0=c(e),R=l(e,"OL",{});var ve=r(R);V1=l(ve,"LI",{});var GW=r(V1);Y1=l(GW,"P",{});var LW=r(Y1);vC=n(LW,"the full Deepspeed config file in the report"),LW.forEach(t),GW.forEach(t),jC=c(ve),K1=l(ve,"LI",{});var MW=r(K1);qe=l(MW,"P",{});var In=r(qe);gC=n(In,"either the command line arguments if you were using the "),fc=l(In,"A",{href:!0});var ZW=r(fc);yC=n(ZW,"Trainer"),ZW.forEach(t),wC=n(In,` or
