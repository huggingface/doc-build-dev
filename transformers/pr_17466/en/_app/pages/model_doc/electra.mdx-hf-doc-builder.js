...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17466/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17466/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17466/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17466/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`),Bi=s(xg,"A",{href:!0,rel:!0});var n6=a(Bi);mw=i(n6,"flax.nn.Module"),n6.forEach(t),uw=i(xg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xg.forEach(t),fw=p(Ye),Eh=s(Ye,"P",{});var s6=a(Eh);gw=i(s6,"Finally, this model supports inherent JAX features such as:"),s6.forEach(t),_w=p(Ye),Jt=s(Ye,"UL",{});var va=a(Jt);wh=s(va,"LI",{});var a6=a(wh);Qi=s(a6,"A",{href:!0,rel:!0});var r6=a(Qi);kw=i(r6,"Just-In-Time (JIT) compilation"),r6.forEach(t),a6.forEach(t),vw=p(va),$h=s(va,"LI",{});var i6=a($h);Vi=s(i6,"A",{href:!0,rel:!0});var l6=a(Vi);Tw=i(l6,"Automatic Differentiation"),l6.forEach(t),i6.forEach(t),bw=p(va),Fh=s(va,"LI",{});var d6=a(Fh);Ki=s(d6,"A",{href:!0,rel:!0});var c6=a(Ki);yw=i(c6,"Vectorization"),c6.forEach(t),d6.forEach(t),Ew=p(va),xh=s(va,"LI",{});var p6=a(xh);Ji=s(p6,"A",{href:!0,rel:!0});var h6=a(Ji);ww=i(h6,"Parallelization"),h6.forEach(t),p6.forEach(t),va.forEach(t),$w=p(Ye),Pt=s(Ye,"DIV",{class:!0});var Ta=a(Pt);y(Gi.$$.fragment,Ta),Fw=p(Ta),ln=s(Ta,"P",{});var jc=a(ln);xw=i(jc,"The "),Mh=s(jc,"CODE",{});var m6=a(Mh);Mw=i(m6,"FlaxElectraPreTrainedModel"),m6.forEach(t),zw=i(jc," forward method, overrides the "),zh=s(jc,"CODE",{});var u6=a(zh);Cw=i(u6,"__call__"),u6.forEach(t),jw=i(jc," special method."),jc.forEach(t),qw=p(Ta),y(Us.$$.fragment,Ta),Pw=p(Ta),y(Rs.$$.fragment,Ta),Ta.forEach(t),Ye.forEach(t),ff=p(o),dn=s(o,"H2",{class:!0});var Mg=a(dn);Hs=s(Mg,"A",{id:!0,class:!0,href:!0});var f6=a(Hs);Ch=s(f6,"SPAN",{});var g6=a(Ch);y(Xi.$$.fragment,g6),g6.forEach(t),f6.forEach(t),Aw=p(Mg),jh=s(Mg,"SPAN",{});var _6=a(jh);Ow=i(_6,"FlaxElectraForCausalLM"),_6.forEach(t),Mg.forEach(t),gf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),Lw=p(_t),qh=s(_t,"P",{});var k6=a(qh);Nw=i(k6,`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$$=p(kt),Rh=s(kt,"P",{});var I6=a(Rh);F$=i(I6,"Finally, this model supports inherent JAX features such as:"),I6.forEach(t),x$=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var D6=a(Hh);ml=s(D6,"A",{href:!0,rel:!0});var S6=a(ml);M$=i(S6,"Just-In-Time (JIT) compilation"),S6.forEach(t),D6.forEach(t),z$=p(Ea),Bh=s(Ea,"LI",{});var W6=a(Bh);ul=s(W6,"A",{href:!0,rel:!0});var U6=a(ul);C$=i(U6,"Automatic Differentiation"),U6.forEach(t),W6.forEach(t),j$=p(Ea),Qh=s(Ea,"LI",{});var R6=a(Qh);fl=s(R6,"A",{href:!0,rel:!0});var H6=a(fl);q$=i(H6,"Vectorization"),H6.forEach(t),R6.forEach(t),P$=p(Ea),Vh=s(Ea,"LI",{});var B6=a(Vh);gl=s(B6,"A",{href:!0,rel:!0});var Q6=a(gl);A$=i(Q6,"Parallelization"),Q6.forEach(t),B6.forEach(t),Ea.forEach(t),O$=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L$=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N$=i(Pc,"The "),Kh=s(Pc,"CODE",{});var V6=a(Kh);I$=i(V6,"FlaxElectraPreTrainedModel"),V6.forEach(t),D$=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var K6=a(Jh);S$=i(K6,"__call__"),K6.forEach(t),W$=i(Pc," special method."),Pc.forEach(t),U$=p(wa),y(Ks.$$.fragment,wa),R$=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var J6=a(Gs);Gh=s(J6,"SPAN",{});var G6=a(Gh);y(kl.$$.fragment,G6),G6.forEach(t),J6.forEach(t),H$=p(Og),Xh=s(Og,"SPAN",{});var X6=a(Xh);B$=i(X6,"FlaxElectraForSequenceClassification"),X6.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Q$=p(vt),Yh=s(vt,"P",{});var Y6=a(Yh);V$=i(Y6,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
