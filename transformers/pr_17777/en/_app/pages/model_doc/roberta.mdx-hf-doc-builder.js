...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/roberta/tokenization_roberta.py#L396",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q$=p(),kh=n("p"),J$=r("Finally, this model supports inherent JAX features such as:"),V$=p(),Jt=n("ul"),vh=n("li"),tl=n("a"),K$=r("Just-In-Time (JIT) compilation"),G$=p(),Th=n("li"),ol=n("a"),X$=r("Automatic Differentiation"),Y$=p(),yh=n("li"),nl=n("a"),Z$=r("Vectorization"),e7=p(),wh=n("li"),sl=n("a"),t7=r("Parallelization"),o7=p(),jt=n("div"),T(al.$$.fragment),n7=p(),an=n("p"),s7=r("The "),$h=n("code"),a7=r("FlaxRobertaPreTrainedModel"),r7=r(" forward method, overrides the "),Fh=n("code"),i7=r("__call__"),l7=r(" special method."),d7=p(),T(Bs.$$.fragment),c7=p(),T(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),T(rl.$$.fragment),p7=p(),Rh=n("span"),h7=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),T(il.$$.fragment),m7=p(),Mh=n("p"),f7=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),u7=p(),ll=n("p"),g7=r("This model inherits from "),Ad=n("a"),_7=r("FlaxPreTrainedModel"),b7=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k7=p(),dl=n("p"),v7=r("This model is also a Flax Linen "),cl=n("a"),T7=r("flax.linen.Module"),y7=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w7=p(),Eh=n("p"),$7=r("Finally, this model supports inherent JAX features such as:"),F7=p(),Vt=n("ul"),zh=n("li"),pl=n("a"),x7=r("Just-In-Time (JIT) compilation"),R7=p(),qh=n("li"),hl=n("a"),M7=r("Automatic Differentiation"),E7=p(),Ch=n("li"),ml=n("a"),z7=r("Vectorization"),q7=p(),jh=n("li"),fl=n("a"),C7=r("Parallelization"),j7=p(),Pt=n("div"),T(ul.$$.fragment),P7=p(),ln=n("p"),L7=r("The "),Ph=n("code"),A7=r("FlaxRobertaPreTrainedModel"),O7=r(" forward method, overrides the "),Lh=n("code"),N7=r("__call__"),I7=r(" special method."),D7=p(),T(Qs.$$.fragment),S7=p(),T(Js.$$.fragment),Af=p(),dn=n("h2"),Vs=n("a"),Ah=n("span"),T(gl.$$.fragment),W7=p(),Oh=n("span"),B7=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),T(_l.$$.fragment),U7=p(),Nh=n("p"),H7=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Q7=p(),bl=n("p"),J7=r("This model inherits from "),Od=n("a"),V7=r("FlaxPreTrainedModel"),K7=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),G7=p(),kl=n("p"),X7=r("This model is also a Flax Linen "),vl=n("a"),Y7=r("flax.linen.Module"),Z7=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q$=h(kt),kh=s(kt,"P",{});var xR=a(kh);J$=i(xR,"Finally, this model supports inherent JAX features such as:"),xR.forEach(t),V$=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RR=a(vh);tl=s(RR,"A",{href:!0,rel:!0});var MR=a(tl);K$=i(MR,"Just-In-Time (JIT) compilation"),MR.forEach(t),RR.forEach(t),G$=h(ha),Th=s(ha,"LI",{});var ER=a(Th);ol=s(ER,"A",{href:!0,rel:!0});var zR=a(ol);X$=i(zR,"Automatic Differentiation"),zR.forEach(t),ER.forEach(t),Y$=h(ha),yh=s(ha,"LI",{});var qR=a(yh);nl=s(qR,"A",{href:!0,rel:!0});var CR=a(nl);Z$=i(CR,"Vectorization"),CR.forEach(t),qR.forEach(t),e7=h(ha),wh=s(ha,"LI",{});var jR=a(wh);sl=s(jR,"A",{href:!0,rel:!0});var PR=a(sl);t7=i(PR,"Parallelization"),PR.forEach(t),jR.forEach(t),ha.forEach(t),o7=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);y(al.$$.fragment,ma),n7=h(ma),an=s(ma,"P",{});var ic=a(an);s7=i(ic,"The "),$h=s(ic,"CODE",{});var LR=a($h);a7=i(LR,"FlaxRobertaPreTrainedModel"),LR.forEach(t),r7=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AR=a(Fh);i7=i(AR,"__call__"),AR.forEach(t),l7=i(ic," special method."),ic.forEach(t),d7=h(ma),y(Bs.$$.fragment,ma),c7=h(ma),y(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OR=a(Hs);xh=s(OR,"SPAN",{});var NR=a(xh);y(rl.$$.fragment,NR),NR.forEach(t),OR.forEach(t),p7=h(Gu),Rh=s(Gu,"SPAN",{});var IR=a(Rh);h7=i(IR,"FlaxRobertaForMultipleChoice"),IR.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),m7=h(vt),Mh=s(vt,"P",{});var DR=a(Mh);f7=i(DR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DR.forEach(t),u7=h(vt),ll=s(vt,"P",{});var Xu=a(ll);g7=i(Xu,"This model inherits from "),Ad=s(Xu,"A",{href:!0});var SR=a(Ad);_7=i(SR,"FlaxPreTrainedModel"),SR.forEach(t),b7=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k7=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v7=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var WR=a(cl);T7=i(WR,"flax.linen.Module"),WR.forEach(t),y7=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w7=h(vt),Eh=s(vt,"P",{});var BR=a(Eh);$7=i(BR,"Finally, this model supports inherent JAX features such as:"),BR.forEach(t),F7=h(vt),Vt=s(vt,"UL",{});var fa=a(Vt);zh=s(fa,"LI",{});var UR=a(zh);pl=s(UR,"A",{href:!0,rel:!0});var HR=a(pl);x7=i(HR,"Just-In-Time (JIT) compilation"),HR.forEach(t),UR.forEach(t),R7=h(fa),qh=s(fa,"LI",{});var QR=a(qh);hl=s(QR,"A",{href:!0,rel:!0});var JR=a(hl);M7=i(JR,"Automatic Differentiation"),JR.forEach(t),QR.forEach(t),E7=h(fa),Ch=s(fa,"LI",{});var VR=a(Ch);ml=s(VR,"A",{href:!0,rel:!0});var KR=a(ml);z7=i(KR,"Vectorization"),KR.forEach(t),VR.forEach(t),q7=h(fa),jh=s(fa,"LI",{});var GR=a(jh);fl=s(GR,"A",{href:!0,rel:!0});var XR=a(fl);C7=i(XR,"Parallelization"),XR.forEach(t),GR.forEach(t),fa.forEach(t),j7=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);y(ul.$$.fragment,ua),P7=h(ua),ln=s(ua,"P",{});var lc=a(ln);L7=i(lc,"The "),Ph=s(lc,"CODE",{});var YR=a(Ph);A7=i(YR,"FlaxRobertaPreTrainedModel"),YR.forEach(t),O7=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZR=a(Lh);N7=i(ZR,"__call__"),ZR.forEach(t),I7=i(lc," special method."),lc.forEach(t),D7=h(ua),y(Qs.$$.fragment,ua),S7=h(ua),y(Js.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Vs=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Vs);Ah=s(eM,"SPAN",{});var tM=a(Ah);y(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W7=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B7=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U7=h(Tt),Nh=s(Tt,"P",{});var nM=a(Nh);H7=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nM.forEach(t),Q7=h(Tt),bl=s(Tt,"P",{});var eg=a(bl);J7=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sM=a(Od);V7=i(sM,"FlaxPreTrainedModel"),sM.forEach(t),K7=i(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),G7=h(Tt),kl=s(Tt,"P",{});var tg=a(kl);X7=i(tg,"This model is also a Flax Linen "),vl=s(tg,"A",{href:!0,rel:!0});var aM=a(vl);Y7=i(aM,"flax.linen.Module"),aM.forEach(t),Z7=i(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
