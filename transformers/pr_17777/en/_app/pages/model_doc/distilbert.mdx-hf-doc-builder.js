...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17777/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_17777/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17777/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17777/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y1=r(qd);cv=i(Y1,"span start logits"),Y1.forEach(t),pv=i(yl," and "),Pd=n(yl,"CODE",{});var Z1=r(Pd);hv=i(Z1,"span end logits"),Z1.forEach(t),uv=i(yl,")."),yl.forEach(t),fv=h(xt),ia=n(xt,"P",{});var su=r(ia);mv=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var e7=r(nl);gv=i(e7,"TFPreTrainedModel"),e7.forEach(t),_v=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),bv=h(xt),la=n(xt,"P",{});var ou=r(la);vv=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var t7=r(da);kv=i(t7,"tf.keras.Model"),t7.forEach(t),Tv=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$v=h(xt),$(Uo.$$.fragment,xt),wv=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yv=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);Fv=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var s7=r(rl);Dv=i(s7,"TFDistilBertForQuestionAnswering"),s7.forEach(t),xv=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var o7=r(Ad);Bv=i(o7,"__call__"),o7.forEach(t),Mv=i(Fl," special method."),Fl.forEach(t),Ev=h(Zt),$(Ho.$$.fragment,Zt),zv=h(Zt),$(Ko.$$.fragment,Zt),jv=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var n7=r(Jo);Od=n(n7,"SPAN",{});var r7=r(Od);$(pa.$$.fragment,r7),r7.forEach(t),n7.forEach(t),Cv=h(nu),Nd=n(nu,"SPAN",{});var a7=r(Nd);qv=i(a7,"FlaxDistilBertModel"),a7.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),Pv=h(st),Ld=n(st,"P",{});var i7=r(Ld);Av=i(i7,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i7.forEach(t),Ov=h(st),ua=n(st,"P",{});var ru=r(ua);Nv=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l7=r(al);Lv=i(l7,"FlaxPreTrainedModel"),l7.forEach(t),Sv=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Iv=h(st),fa=n(st,"P",{});var au=r(fa);Wv=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d7=r(ma);Qv=i(d7,"flax.linen.Module"),d7.forEach(t),Rv=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(st),Sd=n(st,"P",{});var c7=r(Sd);Hv=i(c7,"Finally, this model supports inherent JAX features such as:"),c7.forEach(t),Kv=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p7=r(Id);ga=n(p7,"A",{href:!0,rel:!0});var h7=r(ga);Vv=i(h7,"Just-In-Time (JIT) compilation"),h7.forEach(t),p7.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var u7=r(Wd);_a=n(u7,"A",{href:!0,rel:!0});var f7=r(_a);Gv=i(f7,"Automatic Differentiation"),f7.forEach(t),u7.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var m7=r(Qd);ba=n(m7,"A",{href:!0,rel:!0});var g7=r(ba);Yv=i(g7,"Vectorization"),g7.forEach(t),m7.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _7=r(Rd);va=n(_7,"A",{href:!0,rel:!0});var b7=r(va);ek=i(b7,"Parallelization"),b7.forEach(t),_7.forEach(t),kn.forEach(t),tk=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sk=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ok=i(Dl,"The "),Ud=n(Dl,"CODE",{});var v7=r(Ud);nk=i(v7,"FlaxDistilBertPreTrainedModel"),v7.forEach(t),rk=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var k7=r(Hd);ak=i(k7,"__call__"),k7.forEach(t),ik=i(Dl," special method."),Dl.forEach(t),lk=h(Tn),$(Go.$$.fragment,Tn),dk=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T7=r(Yo);Kd=n(T7,"SPAN",{});var $7=r(Kd);$(Ta.$$.fragment,$7),$7.forEach(t),T7.forEach(t),ck=h(iu),Vd=n(iu,"SPAN",{});var w7=r(Vd);pk=i(w7,"FlaxDistilBertForMaskedLM"),w7.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hk=h(ot),wa=n(ot,"P",{});var lu=r(wa);uk=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y7=r(Jd);fk=i(y7,"language modeling"),y7.forEach(t),mk=i(lu," head on top."),lu.forEach(t),gk=h(ot),ya=n(ot,"P",{});var du=r(ya);_k=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var F7=r(il);bk=i(F7,"FlaxPreTrainedModel"),F7.forEach(t),vk=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kk=h(ot),Fa=n(ot,"P",{});var cu=r(Fa);Tk=i(cu,"This model is also a Flax Linen "),Da=n(cu,"A",{href:!0,rel:!0});var D7=r(Da);$k=i(D7,"flax.linen.Module"),D7.forEach(t),wk=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yk=h(ot),Gd=n(ot,"P",{});var x7=r(Gd);Fk=i(x7,"Finally, this model supports inherent JAX features such as:"),x7.forEach(t),Dk=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var B7=r(Xd);xa=n(B7,"A",{href:!0,rel:!0});var M7=r(xa);xk=i(M7,"Just-In-Time (JIT) compilation"),M7.forEach(t),B7.forEach(t),Bk=h($n),Yd=n($n,"LI",{});var E7=r(Yd);Ba=n(E7,"A",{href:!0,rel:!0});var z7=r(Ba);Mk=i(z7,"Automatic Differentiation"),z7.forEach(t),E7.forEach(t),Ek=h($n),Zd=n($n,"LI",{});var j7=r(Zd);Ma=n(j7,"A",{href:!0,rel:!0});var C7=r(Ma);zk=i(C7,"Vectorization"),C7.forEach(t),j7.forEach(t),jk=h($n),ec=n($n,"LI",{});var q7=r(ec);Ea=n(q7,"A",{href:!0,rel:!0});var P7=r(Ea);Ck=i(P7,"Parallelization"),P7.forEach(t),q7.forEach(t),$n.forEach(t),qk=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pk=h(wn),Cs=n(wn,"P",{});var xl=r(Cs);Ak=i(xl,"The "),tc=n(xl,"CODE",{});var A7=r(tc);Ok=i(A7,"FlaxDistilBertPreTrainedModel"),A7.forEach(t),Nk=i(xl," forward method, overrides the "),sc=n(xl,"CODE",{});var O7=r(sc);Lk=i(O7,"__call__"),O7.forEach(t),Sk=i(xl," special method."),xl.forEach(t),Ik=h(wn),$(Zo.$$.fragment,wn),Wk=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N7=r(tn);oc=n(N7,"SPAN",{});var L7=r(oc);$(ja.$$.fragment,L7),L7.forEach(t),N7.forEach(t),Qk=h(pu),nc=n(pu,"SPAN",{});var S7=r(nc);Rk=i(S7,"FlaxDistilBertForSequenceClassification"),S7.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uk=h(nt),rc=n(nt,"P",{});var I7=r(rc);Hk=i(I7,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I7.forEach(t),Kk=h(nt),qa=n(nt,"P",{});var hu=r(qa);Vk=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W7=r(ll);Jk=i(W7,"FlaxPreTrainedModel"),W7.forEach(t),Gk=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xk=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yk=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q7=r(Aa);Zk=i(Q7,"flax.linen.Module"),Q7.forEach(t),eT=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tT=h(nt),ac=n(nt,"P",{});var R7=r(ac);sT=i(R7,"Finally, this model supports inherent JAX features such as:"),R7.forEach(t),oT=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U7=r(ic);Oa=n(U7,"A",{href:!0,rel:!0});var H7=r(Oa);nT=i(H7,"Just-In-Time (JIT) compilation"),H7.forEach(t),U7.forEach(t),rT=h(yn),lc=n(yn,"LI",{});var K7=r(lc);Na=n(K7,"A",{href:!0,rel:!0});var V7=r(Na);aT=i(V7,"Automatic Differentiation"),V7.forEach(t),K7.forEach(t),iT=h(yn),dc=n(yn,"LI",{});var J7=r(dc);La=n(J7,"A",{href:!0,rel:!0});var G7=r(La);lT=i(G7,"Vectorization"),G7.forEach(t),J7.forEach(t),dT=h(yn),cc=n(yn,"LI",{});var X7=r(cc);Sa=n(X7,"A",{href:!0,rel:!0});var Y7=r(Sa);cT=i(Y7,"Parallelization"),Y7.forEach(t),X7.forEach(t),yn.forEach(t),pT=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),hT=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);uT=i(Bl,"The "),pc=n(Bl,"CODE",{});var Z7=r(pc);fT=i(Z7,"FlaxDistilBertPreTrainedModel"),Z7.forEach(t),mT=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var ey=r(hc);gT=i(ey,"__call__"),ey.forEach(t),_T=i(Bl," special method."),Bl.forEach(t),bT=h(Fn),$(sn.$$.fragment,Fn),vT=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),kT=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);TT=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$T=h(rt),mc=n(rt,"P",{});var ny=r(mc);wT=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
