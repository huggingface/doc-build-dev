...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),up=new y({}),{c(){g=o("meta"),S=u(),b=o("h1"),k=o("a"),X=o("span"),f(z.$$.fragment),C=u(),Q=o("span"),x=a("DeepSpeed Integration"),te=u(),T=o("p"),q=o("a"),E=a("DeepSpeed"),gs=a(" implements everything described in the "),W=o("a"),bs=a("ZeRO paper"),c7=a(". Currently it provides full support for:"),yj=u(),R=o("ol"),Mh=o("li"),h7=a("Optimizer state partitioning (ZeRO stage 1)"),f7=u(),Lh=o("li"),d7=a("Gradient partitioning (ZeRO stage 2)"),m7=u(),Zh=o("li"),_7=a("Parameter partitioning (ZeRO stage 3)"),v7=u(),Nh=o("li"),j7=a("Custom mixed precision training handling"),w7=u(),Hh=o("li"),y7=a("A range of fast CUDA-extension-based optimizers"),g7=u(),Bh=o("li"),b7=a("ZeRO-Offload to CPU and NVMe"),gj=u(),Te=o("p"),q7=a("ZeRO-Offload has its own dedicated paper: "),Kn=o("a"),E7=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),$7=a(". And NVMe-support is described in the paper "),Jn=o("a"),k7=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),P7=a("."),bj=u(),kp=o("p"),z7=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),qj=u(),Pp=o("p"),D7=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),Ej=u(),wt=o("p"),O7=a("\u{1F917} Transformers integrates "),Xn=o("a"),A7=a("DeepSpeed"),T7=a(" via 2 options:"),$j=u(),yt=o("ol"),Qn=o("li"),S7=a("Integration of the core DeepSpeed features via "),zp=o("a"),C7=a("Trainer"),x7=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),R7=u(),F=o("li"),I7=a("If you don\u2019t use "),Dp=o("a"),U7=a("Trainer"),G7=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Wh=o("code"),M7=a("from_pretrained"),L7=a(" and "),Fh=o("code"),Z7=a("from_config"),N7=a(` include integration of essential
parts of DeepSpeed like `),Vh=o("code"),H7=a("zero.Init"),B7=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Op=o("a"),W7=a("deepspeed-non-trainer-integration"),F7=a("."),kj=u(),Ap=o("p"),V7=a("What is integrated:"),Pj=u(),Tp=o("p"),Y7=a("Training:"),zj=u(),Sp=o("ol"),Yh=o("li"),K7=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),Dj=u(),Cp=o("p"),J7=a("Inference:"),Oj=u(),xp=o("ol"),eo=o("li"),X7=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=o("a"),Q7=a("deepspeed-zero-inference"),e6=a("."),Aj=u(),Ip=o("p"),s6=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),jp=o("a"),mU=a("DeepSpeed GitHub"),_U=a("."),this.h()},l(e){const p=AY('[data-svelte="svelte-1phssyn"]',document.head);g=l(p,"META",{name:!0,content:!0}),p.forEach(t),S=c(e),b=l(e,"H1",{class:!0});var wp=r(b);k=l(wp,"A",{id:!0,class:!0,href:!0});var mj=r(k);X=l(mj,"SPAN",{});var _j=r(X);d(z.$$.fragment,_j),_j.forEach(t),mj.forEach(t),C=c(wp),Q=l(wp,"SPAN",{});var qU=r(Q);x=n(qU,"DeepSpeed Integration"),qU.forEach(t),wp.forEach(t),te=c(e),T=l(e,"P",{});var vj=r(T);q=l(vj,"A",{href:!0,rel:!0});var EU=r(q);E=n(EU,"DeepSpeed"),EU.forEach(t),gs=n(vj," implements everything described in the "),W=l(vj,"A",{href:!0,rel:!0});var $U=r(W);bs=n($U,"ZeRO paper"),$U.forEach(t),c7=n(vj,". Currently it provides full support for:"),vj.forEach(t),yj=c(e),R=l(e,"OL",{});var ve=r(R);Mh=l(ve,"LI",{});var kU=r(Mh);h7=n(kU,"Optimizer state partitioning (ZeRO stage 1)"),kU.forEach(t),f7=c(ve),Lh=l(ve,"LI",{});var PU=r(Lh);d7=n(PU,"Gradient partitioning (ZeRO stage 2)"),PU.forEach(t),m7=c(ve),Zh=l(ve,"LI",{});var zU=r(Zh);_7=n(zU,"Parameter partitioning (ZeRO stage 3)"),zU.forEach(t),v7=c(ve),Nh=l(ve,"LI",{});var DU=r(Nh);j7=n(DU,"Custom mixed precision training handling"),DU.forEach(t),w7=c(ve),Hh=l(ve,"LI",{});var OU=r(Hh);y7=n(OU,"A range of fast CUDA-extension-based optimizers"),OU.forEach(t),g7=c(ve),Bh=l(ve,"LI",{});var AU=r(Bh);b7=n(AU,"ZeRO-Offload to CPU and NVMe"),AU.forEach(t),ve.forEach(t),gj=c(e),Te=l(e,"P",{});var Yc=r(Te);q7=n(Yc,"ZeRO-Offload has its own dedicated paper: "),Kn=l(Yc,"A",{href:!0,rel:!0});var TU=r(Kn);E7=n(TU,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),TU.forEach(t),$7=n(Yc,". And NVMe-support is described in the paper "),Jn=l(Yc,"A",{href:!0,rel:!0});var SU=r(Jn);k7=n(SU,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),SU.forEach(t),P7=n(Yc,"."),Yc.forEach(t),bj=c(e),kp=l(e,"P",{});var CU=r(kp);z7=n(CU,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),CU.forEach(t),qj=c(e),Pp=l(e,"P",{});var xU=r(Pp);D7=n(xU,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),xU.forEach(t),Ej=c(e),wt=l(e,"P",{});var S0=r(wt);O7=n(S0,"\u{1F917} Transformers integrates "),Xn=l(S0,"A",{href:!0,rel:!0});var RU=r(Xn);A7=n(RU,"DeepSpeed"),RU.forEach(t),T7=n(S0," via 2 options:"),S0.forEach(t),$j=c(e),yt=l(e,"OL",{});var C0=r(yt);Qn=l(C0,"LI",{});var x0=r(Qn);S7=n(x0,"Integration of the core DeepSpeed features via "),zp=l(x0,"A",{href:!0});var IU=r(zp);C7=n(IU,"Trainer"),IU.forEach(t),x7=n(x0,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),x0.forEach(t),R7=c(C0),F=l(C0,"LI",{});var je=r(F);I7=n(je,"If you don\u2019t use "),Dp=l(je,"A",{href:!0});var UU=r(Dp);U7=n(UU,"Trainer"),UU.forEach(t),G7=n(je,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Wh=l(je,"CODE",{});var GU=r(Wh);M7=n(GU,"from_pretrained"),GU.forEach(t),L7=n(je," and "),Fh=l(je,"CODE",{});var MU=r(Fh);Z7=n(MU,"from_config"),MU.forEach(t),N7=n(je,` include integration of essential
parts of DeepSpeed like `),Vh=l(je,"CODE",{});var LU=r(Vh);H7=n(LU,"zero.Init"),LU.forEach(t),B7=n(je,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Op=l(je,"A",{href:!0});var ZU=r(Op);W7=n(ZU,"deepspeed-non-trainer-integration"),ZU.forEach(t),F7=n(je,"."),je.forEach(t),C0.forEach(t),kj=c(e),Ap=l(e,"P",{});var NU=r(Ap);V7=n(NU,"What is integrated:"),NU.forEach(t),Pj=c(e),Tp=l(e,"P",{});var HU=r(Tp);Y7=n(HU,"Training:"),HU.forEach(t),zj=c(e),Sp=l(e,"OL",{});var BU=r(Sp);Yh=l(BU,"LI",{});var WU=r(Yh);K7=n(WU,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),WU.forEach(t),BU.forEach(t),Dj=c(e),Cp=l(e,"P",{});var FU=r(Cp);J7=n(FU,"Inference:"),FU.forEach(t),Oj=c(e),xp=l(e,"OL",{});var VU=r(xp);eo=l(VU,"LI",{});var R0=r(eo);X7=n(R0,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(R0,"A",{href:!0});var YU=r(Rp);Q7=n(YU,"deepspeed-zero-inference"),YU.forEach(t),e6=n(R0,"."),R0.forEach(t),VU.forEach(t),Aj=c(e),Ip=l(e,"P",{});var KU=r(Ip);s6=n(KU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
