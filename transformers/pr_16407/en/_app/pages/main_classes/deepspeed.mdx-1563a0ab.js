...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16407/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16407/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16407/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16407/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16407/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
the visible scope of available GPUs. Instead, you have to use the following syntax:`),e7=u(),f(Ro.$$.fragment),s7=u(),Jf=o("p"),t7=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pw=u(),ji=o("a"),iw=u(),Ts=o("h3"),Nt=o("a"),Xf=o("span"),f(Io.$$.fragment),a7=u(),Qf=o("span"),n7=a("Deployment in Notebooks"),uw=u(),Ht=o("p"),o7=a("The problem with running notebook cells as a script is that there is no normal "),ed=o("code"),l7=a("deepspeed"),r7=a(` launcher to rely on, so
under certain setups we have to emulate it.`),cw=u(),gi=o("p"),p7=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),hw=u(),f(Uo.$$.fragment),fw=u(),Bt=o("p"),i7=a("Note: "),sd=o("code"),u7=a("..."),c7=a(" stands for the normal arguments that you\u2019d pass to the functions."),dw=u(),wi=o("p"),h7=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
...
cell with:`),_w=u(),f(Go.$$.fragment),vw=u(),Le=o("p"),d7=a("If the training script is in a normal file and not in the notebook cells, you can launch "),td=o("code"),m7=a("deepspeed"),_7=a(` normally via
shell from a cell. For example, to use `),ad=o("code"),v7=a("run_translation.py"),j7=a(" you would launch it with:"),jw=u(),f(Lo.$$.fragment),gw=u(),Wt=o("p"),g7=a("or with "),nd=o("code"),w7=a("%%bash"),y7=a(" magic, where you can write a multi-line code for the shell program to run:"),ww=u(),f(Mo.$$.fragment),yw=u(),bi=o("p"),b7=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),bw=u(),Ft=o("p"),E7=a("Note: While "),od=o("code"),q7=a("%%bash"),$7=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Ew=u(),Ei=o("a"),qw=u(),As=o("h3"),Vt=o("a"),ld=o("span"),f(Zo.$$.fragment),k7=u(),rd=o("span"),P7=a("Configuration"),$w=u(),Yt=o("p"),D7=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=o("a"),z7=a("following documentation"),O7=a("."),kw=u(),Kt=o("p"),T7=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=o("a"),A7=a(`the DeepSpeedExamples
repo`),S7=a(":"),Pw=u(),f(Bo.$$.fragment),Dw=u(),Jt=o("p"),C7=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),pd=o("code"),x7=a(".json"),R7=a(" files with:"),zw=u(),f(Wo.$$.fragment),Ow=u(),Xt=o("p"),I7=a("Some more examples are to be found in the "),Fo=o("a"),U7=a("main repo"),G7=a(" as well."),Tw=u(),qi=o("p"),L7=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
...
including optimizer states cpu offload, uses `),id=o("code"),Z7=a("AdamW"),N7=a(" optimizer and "),ud=o("code"),H7=a("WarmupLR"),B7=a(` scheduler and will enable mixed
precision training if `),cd=o("code"),W7=a("--fp16"),F7=a(" is passed:"),Sw=u(),f(Vo.$$.fragment),Cw=u(),Qt=o("p"),V7=a("When you execute the program, DeepSpeed will log the configuration it received from the "),$i=o("a"),Y7=a("Trainer"),K7=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),xw=u(),ki=o("a"),Rw=u(),Ss=o("h3"),ea=o("a"),hd=o("span"),f(Yo.$$.fragment),J7=u(),fd=o("span"),X7=a("Passing Configuration"),Iw=u(),G=o("p"),Q7=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
the visible scope of available GPUs. Instead, you have to use the following syntax:`),kE.forEach(t),e7=c(mh),d(Ro.$$.fragment,mh),s7=c(mh),Jf=l(mh,"P",{});var mM=r(Jf);t7=n(mM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),mM.forEach(t),mh.forEach(t),fM.forEach(t),pw=c(e),ji=l(e,"A",{id:!0}),r(ji).forEach(t),iw=c(e),Ts=l(e,"H3",{class:!0});var PE=r(Ts);Nt=l(PE,"A",{id:!0,class:!0,href:!0});var _M=r(Nt);Xf=l(_M,"SPAN",{});var vM=r(Xf);d(Io.$$.fragment,vM),vM.forEach(t),_M.forEach(t),a7=c(PE),Qf=l(PE,"SPAN",{});var jM=r(Qf);n7=n(jM,"Deployment in Notebooks"),jM.forEach(t),PE.forEach(t),uw=c(e),Ht=l(e,"P",{});var DE=r(Ht);o7=n(DE,"The problem with running notebook cells as a script is that there is no normal "),ed=l(DE,"CODE",{});var gM=r(ed);l7=n(gM,"deepspeed"),gM.forEach(t),r7=n(DE,` launcher to rely on, so
under certain setups we have to emulate it.`),DE.forEach(t),cw=c(e),gi=l(e,"P",{});var wM=r(gi);p7=n(wM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),wM.forEach(t),hw=c(e),d(Uo.$$.fragment,e),fw=c(e),Bt=l(e,"P",{});var zE=r(Bt);i7=n(zE,"Note: "),sd=l(zE,"CODE",{});var yM=r(sd);u7=n(yM,"..."),yM.forEach(t),c7=n(zE," stands for the normal arguments that you\u2019d pass to the functions."),zE.forEach(t),dw=c(e),wi=l(e,"P",{});var bM=r(wi);h7=n(bM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),bM.forEach(t),mw=c(e),yi=l(e,"P",{});var EM=r(yi);f7=n(EM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),EM.forEach(t),_w=c(e),d(Go.$$.fragment,e),vw=c(e),Le=l(e,"P",{});var _h=r(Le);d7=n(_h,"If the training script is in a normal file and not in the notebook cells, you can launch "),td=l(_h,"CODE",{});var qM=r(td);m7=n(qM,"deepspeed"),qM.forEach(t),_7=n(_h,` normally via
shell from a cell. For example, to use `),ad=l(_h,"CODE",{});var $M=r(ad);v7=n($M,"run_translation.py"),$M.forEach(t),j7=n(_h," you would launch it with:"),_h.forEach(t),jw=c(e),d(Lo.$$.fragment,e),gw=c(e),Wt=l(e,"P",{});var OE=r(Wt);g7=n(OE,"or with "),nd=l(OE,"CODE",{});var kM=r(nd);w7=n(kM,"%%bash"),kM.forEach(t),y7=n(OE," magic, where you can write a multi-line code for the shell program to run:"),OE.forEach(t),ww=c(e),d(Mo.$$.fragment,e),yw=c(e),bi=l(e,"P",{});var PM=r(bi);b7=n(PM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),PM.forEach(t),bw=c(e),Ft=l(e,"P",{});var TE=r(Ft);E7=n(TE,"Note: While "),od=l(TE,"CODE",{});var DM=r(od);q7=n(DM,"%%bash"),DM.forEach(t),$7=n(TE,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),TE.forEach(t),Ew=c(e),Ei=l(e,"A",{id:!0}),r(Ei).forEach(t),qw=c(e),As=l(e,"H3",{class:!0});var AE=r(As);Vt=l(AE,"A",{id:!0,class:!0,href:!0});var zM=r(Vt);ld=l(zM,"SPAN",{});var OM=r(ld);d(Zo.$$.fragment,OM),OM.forEach(t),zM.forEach(t),k7=c(AE),rd=l(AE,"SPAN",{});var TM=r(rd);P7=n(TM,"Configuration"),TM.forEach(t),AE.forEach(t),$w=c(e),Yt=l(e,"P",{});var SE=r(Yt);D7=n(SE,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=l(SE,"A",{href:!0,rel:!0});var AM=r(No);z7=n(AM,"following documentation"),AM.forEach(t),O7=n(SE,"."),SE.forEach(t),kw=c(e),Kt=l(e,"P",{});var CE=r(Kt);T7=n(CE,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=l(CE,"A",{href:!0,rel:!0});var SM=r(Ho);A7=n(SM,`the DeepSpeedExamples
repo`),SM.forEach(t),S7=n(CE,":"),CE.forEach(t),Pw=c(e),d(Bo.$$.fragment,e),Dw=c(e),Jt=l(e,"P",{});var xE=r(Jt);C7=n(xE,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),pd=l(xE,"CODE",{});var CM=r(pd);x7=n(CM,".json"),CM.forEach(t),R7=n(xE," files with:"),xE.forEach(t),zw=c(e),d(Wo.$$.fragment,e),Ow=c(e),Xt=l(e,"P",{});var RE=r(Xt);I7=n(RE,"Some more examples are to be found in the "),Fo=l(RE,"A",{href:!0,rel:!0});var xM=r(Fo);U7=n(xM,"main repo"),xM.forEach(t),G7=n(RE," as well."),RE.forEach(t),Tw=c(e),qi=l(e,"P",{});var RM=r(qi);L7=n(RM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),RM.forEach(t),Aw=c(e),oe=l(e,"P",{});var Nn=r(oe);M7=n(Nn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),id=l(Nn,"CODE",{});var IM=r(id);Z7=n(IM,"AdamW"),IM.forEach(t),N7=n(Nn," optimizer and "),ud=l(Nn,"CODE",{});var UM=r(ud);H7=n(UM,"WarmupLR"),UM.forEach(t),B7=n(Nn,` scheduler and will enable mixed
precision training if `),cd=l(Nn,"CODE",{});var GM=r(cd);W7=n(GM,"--fp16"),GM.forEach(t),F7=n(Nn," is passed:"),Nn.forEach(t),Sw=c(e),d(Vo.$$.fragment,e),Cw=c(e),Qt=l(e,"P",{});var IE=r(Qt);V7=n(IE,"When you execute the program, DeepSpeed will log the configuration it received from the "),$i=l(IE,"A",{href:!0});var LM=r($i);Y7=n(LM,"Trainer"),LM.forEach(t),K7=n(IE,`
to the console, so you can see exactly what was the final configuration passed to it.`),IE.forEach(t),xw=c(e),ki=l(e,"A",{id:!0}),r(ki).forEach(t),Rw=c(e),Ss=l(e,"H3",{class:!0});var UE=r(Ss);ea=l(UE,"A",{id:!0,class:!0,href:!0});var MM=r(ea);hd=l(MM,"SPAN",{});var ZM=r(hd);d(Yo.$$.fragment,ZM),ZM.forEach(t),MM.forEach(t),J7=c(UE),fd=l(UE,"SPAN",{});var NM=r(fd);X7=n(NM,"Passing Configuration"),NM.forEach(t),UE.forEach(t),Iw=c(e),G=l(e,"P",{});var ye=r(G);Q7=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
