...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17141/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17141/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17141/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zk=p(),xt=n("div"),y(vr.$$.fragment),e1=p(),zo=n("p"),t1=r("The "),fd=n("a"),o1=r("RobertaForMultipleChoice"),n1=r(" forward method, overrides the "),op=n("code"),s1=r("__call__"),a1=r(" special method."),r1=p(),y(Qn.$$.fragment),i1=p(),y(Vn.$$.fragment),lf=p(),Co=n("h2"),Jn=n("a"),np=n("span"),y(yr.$$.fragment),l1=p(),sp=n("span"),d1=r("RobertaForTokenClassification"),df=p(),at=n("div"),y(Tr.$$.fragment),c1=p(),ap=n("p"),p1=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),v1=p(),lt=n("div"),y(xr.$$.fragment),y1=p(),qo=n("p"),T1=r("The "),gd=n("a"),w1=r("RobertaForTokenClassification"),$1=r(" forward method, overrides the "),rp=n("code"),F1=r("__call__"),x1=r(" special method."),R1=p(),y(Kn.$$.fragment),M1=p(),y(Gn.$$.fragment),E1=p(),y(Xn.$$.fragment),cf=p(),jo=n("h2"),Yn=n("a"),ip=n("span"),y(Rr.$$.fragment),z1=p(),lp=n("span"),C1=r("RobertaForQuestionAnswering"),pf=p(),rt=n("div"),y(Mr.$$.fragment),q1=p(),Po=n("p"),j1=r(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),v1=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);T(xr.$$.fragment,lo),y1=h(lo),qo=s(lo,"P",{});var Vd=a(qo);T1=i(Vd,"The "),gd=s(Vd,"A",{href:!0});var hx=a(gd);w1=i(hx,"RobertaForTokenClassification"),hx.forEach(t),$1=i(Vd," forward method, overrides the "),rp=s(Vd,"CODE",{});var mx=a(rp);F1=i(mx,"__call__"),mx.forEach(t),x1=i(Vd," special method."),Vd.forEach(t),R1=h(lo),T(Kn.$$.fragment,lo),M1=h(lo),T(Gn.$$.fragment,lo),E1=h(lo),T(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var fx=a(Yn);ip=s(fx,"SPAN",{});var ux=a(ip);T(Rr.$$.fragment,ux),ux.forEach(t),fx.forEach(t),z1=h(mu),lp=s(mu,"SPAN",{});var gx=a(lp);C1=i(gx,"RobertaForQuestionAnswering"),gx.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);T(Mr.$$.fragment,co),q1=h(co),Po=s(co,"P",{});var Jd=a(Po);j1=i(Jd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Jd,"CODE",{});var _x=a(dp);P1=i(_x,"span start logits"),_x.forEach(t),L1=i(Jd," and "),cp=s(Jd,"CODE",{});var bx=a(cp);A1=i(bx,"span end logits"),bx.forEach(t),O1=i(Jd,")."),Jd.forEach(t),N1=h(co),Er=s(co,"P",{});var fu=a(Er);I1=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var kx=a(_d);D1=i(kx,"PreTrainedModel"),kx.forEach(t),S1=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),W1=h(co),zr=s(co,"P",{});var uu=a(zr);B1=i(uu,"This model is also a PyTorch "),Cr=s(uu,"A",{href:!0,rel:!0});var vx=a(Cr);U1=i(vx,"torch.nn.Module"),vx.forEach(t),H1=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Q1=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);T(qr.$$.fragment,po),V1=h(po),Lo=s(po,"P",{});var Kd=a(Lo);J1=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var yx=a(bd);K1=i(yx,"RobertaForQuestionAnswering"),yx.forEach(t),G1=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var Tx=a(pp);X1=i(Tx,"__call__"),Tx.forEach(t),Y1=i(Kd," special method."),Kd.forEach(t),Z1=h(po),T(Zn.$$.fragment,po),ev=h(po),T(es.$$.fragment,po),tv=h(po),T(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var wx=a(os);hp=s(wx,"SPAN",{});var $x=a(hp);T(jr.$$.fragment,$x),$x.forEach(t),wx.forEach(t),ov=h(gu),mp=s(gu,"SPAN",{});var Fx=a(mp);nv=i(Fx,"TFRobertaModel"),Fx.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);T(Pr.$$.fragment,Ot),sv=h(Ot),fp=s(Ot,"P",{});var xx=a(fp);av=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),rv=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iv=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var Rx=a(kd);lv=i(Rx,"TFPreTrainedModel"),Rx.forEach(t),dv=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),by=h(It),T(us.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vy=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yy=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);Ty=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$y=i(Xx,"__call__"),Xx.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(mo),T(gs.$$.fragment,mo),Ry=h(mo),T(_s.$$.fragment,mo),My=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);T(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),Ey=h(Mu),Mp=s(Mu,"SPAN",{});var e4=a(Mp);zy=i(e4,"TFRobertaForMultipleChoice"),e4.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),Cy=h(Dt),Ep=s(Dt,"P",{});var t4=a(Ep);qy=i(t4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),Sy=h(Dt),T(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s4=a(Rd);Hy=i(s4,"TFRobertaForMultipleChoice"),s4.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a4=a(zp);Vy=i(a4,"__call__"),a4.forEach(t),Jy=i(ec," special method."),ec.forEach(t),Ky=h(aa),T(ys.$$.fragment,aa),Gy=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var r4=a(ws);Cp=s(r4,"SPAN",{});var i4=a(Cp);T(ii.$$.fragment,i4),i4.forEach(t),r4.forEach(t),Xy=h(Cu),qp=s(Cu,"SPAN",{});var l4=a(qp);Yy=i(l4,"TFRobertaForTokenClassification"),l4.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var d4=a(jp);eT=i(d4,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d4.forEach(t),tT=h(St),di=s(St,"P",{});var qu=a(di);oT=i(qu,"This model inherits from "),Md=s(qu,"A",{href:!0});var c4=a(Md);nT=i(c4,"TFPreTrainedModel"),c4.forEach(t),sT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),aT=h(St),ci=s(St,"P",{});var ju=a(ci);rT=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var p4=a(pi);iT=i(p4,"tf.keras.Model"),p4.forEach(t),lT=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dT=h(St),T($s.$$.fragment,St),cT=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);T(hi.$$.fragment,fo),pT=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hT=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h4=a(Ed);mT=i(h4,"TFRobertaForTokenClassification"),h4.forEach(t),fT=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var m4=a(Pp);uT=i(m4,"__call__"),m4.forEach(t),gT=i(tc," special method."),tc.forEach(t),_T=h(fo),T(Fs.$$.fragment,fo),bT=h(fo),T(xs.$$.fragment,fo),kT=h(fo),T(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var f4=a(Ms);Lp=s(f4,"SPAN",{});var u4=a(Lp);T(mi.$$.fragment,u4),u4.forEach(t),f4.forEach(t),vT=h(Pu),Ap=s(Pu,"SPAN",{});var g4=a(Ap);yT=i(g4,"TFRobertaForQuestionAnswering"),g4.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);T(fi.$$.fragment,Wt),TT=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wT=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _4=a(Op);$T=i(_4,"span start logits"),_4.forEach(t),FT=i(oc," and "),Np=s(oc,"CODE",{});var b4=a(Np);xT=i(b4,"span end logits"),b4.forEach(t),RT=i(oc,")."),oc.forEach(t),MT=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);ET=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var k4=a(zd);zT=i(k4,"TFPreTrainedModel"),k4.forEach(t),CT=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),qT=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jT=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var v4=a(_i);PT=i(v4,"tf.keras.Model"),v4.forEach(t),LT=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),AT=h(Wt),T(Es.$$.fragment,Wt),OT=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),NT=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);IT=i(nc,"The "),Cd=s(nc,"A",{href:!0});var y4=a(Cd);DT=i(y4,"TFRobertaForQuestionAnswering"),y4.forEach(t),ST=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var T4=a(Ip);WT=i(T4,"__call__"),T4.forEach(t),BT=i(nc," special method."),nc.forEach(t),UT=h(uo),T(zs.$$.fragment,uo),HT=h(uo),T(Cs.$$.fragment,uo),QT=h(uo),T(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var w4=a(js);Dp=s(w4,"SPAN",{});var $4=a(Dp);T(ki.$$.fragment,$4),$4.forEach(t),w4.forEach(t),VT=h(Ou),Sp=s(Ou,"SPAN",{});var F4=a(Sp);JT=i(F4,"FlaxRobertaModel"),F4.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),KT=h(gt),Wp=s(gt,"P",{});var x4=a(Wp);GT=i(x4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x4.forEach(t),XT=h(gt),yi=s(gt,"P",{});var Nu=a(yi);YT=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var R4=a(qd);ZT=i(R4,"FlaxPreTrainedModel"),R4.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),tw=h(gt),Ti=s(gt,"P",{});var Iu=a(Ti);ow=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var M4=a(wi);nw=i(M4,"flax.linen.Module"),M4.forEach(t),sw=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),aw=h(gt),Bp=s(gt,"P",{});var E4=a(Bp);rw=i(E4,"Finally, this model supports inherent JAX features such as:"),E4.forEach(t),iw=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var z4=a(Up);$i=s(z4,"A",{href:!0,rel:!0});var C4=a($i);lw=i(C4,"Just-In-Time (JIT) compilation"),C4.forEach(t),z4.forEach(t),dw=h(ra),Hp=s(ra,"LI",{});var q4=a(Hp);Fi=s(q4,"A",{href:!0,rel:!0});var j4=a(Fi);cw=i(j4,"Automatic Differentiation"),j4.forEach(t),q4.forEach(t),pw=h(ra),Qp=s(ra,"LI",{});var P4=a(Qp);xi=s(P4,"A",{href:!0,rel:!0});var L4=a(xi);hw=i(L4,"Vectorization"),L4.forEach(t),P4.forEach(t),mw=h(ra),Vp=s(ra,"LI",{});var A4=a(Vp);Ri=s(A4,"A",{href:!0,rel:!0});var O4=a(Ri);fw=i(O4,"Parallelization"),O4.forEach(t),A4.forEach(t),ra.forEach(t),uw=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);T(Mi.$$.fragment,ia),gw=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_w=i(sc,"The "),Jp=s(sc,"CODE",{});var N4=a(Jp);bw=i(N4,"FlaxRobertaPreTrainedModel"),N4.forEach(t),kw=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var I4=a(Kp);vw=i(I4,"__call__"),I4.forEach(t),yw=i(sc," special method."),sc.forEach(t),Tw=h(ia),T(Ps.$$.fragment,ia),ww=h(ia),T(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var D4=a(As);Gp=s(D4,"SPAN",{});var S4=a(Gp);T(Ei.$$.fragment,S4),S4.forEach(t),D4.forEach(t),$w=h(Du),Xp=s(Du,"SPAN",{});var W4=a(Xp);Fw=i(W4,"FlaxRobertaForCausalLM"),W4.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);T(zi.$$.fragment,_t),xw=h(_t),Yp=s(_t,"P",{});var B4=a(Yp);Rw=i(B4,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),B4.forEach(t),Mw=h(_t),Ci=s(_t,"P",{});var Su=a(Ci);Ew=i(Su,"This model inherits from "),jd=s(Su,"A",{href:!0});var U4=a(jd);zw=i(U4,"FlaxPreTrainedModel"),U4.forEach(t),Cw=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Su.forEach(t),qw=h(_t),qi=s(_t,"P",{});var Wu=a(qi);jw=i(Wu,"This model is also a Flax Linen "),ji=s(Wu,"A",{href:!0,rel:!0});var H4=a(ji);Pw=i(H4,"flax.linen.Module"),H4.forEach(t),Lw=i(Wu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),Aw=h(_t),Zp=s(_t,"P",{});var Q4=a(Zp);Ow=i(Q4,"Finally, this model supports inherent JAX features such as:"),Q4.forEach(t),Nw=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var V4=a(eh);Pi=s(V4,"A",{href:!0,rel:!0});var J4=a(Pi);Iw=i(J4,"Just-In-Time (JIT) compilation"),J4.forEach(t),V4.forEach(t),Dw=h(la),th=s(la,"LI",{});var K4=a(th);Li=s(K4,"A",{href:!0,rel:!0});var G4=a(Li);Sw=i(G4,"Automatic Differentiation"),G4.forEach(t),K4.forEach(t),Ww=h(la),oh=s(la,"LI",{});var X4=a(oh);Ai=s(X4,"A",{href:!0,rel:!0});var Y4=a(Ai);Bw=i(Y4,"Vectorization"),Y4.forEach(t),X4.forEach(t),Uw=h(la),nh=s(la,"LI",{});var Z4=a(nh);Oi=s(Z4,"A",{href:!0,rel:!0});var eR=a(Oi);Hw=i(eR,"Parallelization"),eR.forEach(t),Z4.forEach(t),la.forEach(t),Qw=h(_t),Ct=s(_t,"DIV",{class:!0});var da=a(Ct);T(Ni.$$.fragment,da),Vw=h(da),tn=s(da,"P",{});var ac=a(tn);Jw=i(ac,"The "),sh=s(ac,"CODE",{});var tR=a(sh);Kw=i(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),Gw=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oR=a(ah);Xw=i(oR,"__call__"),oR.forEach(t),Yw=i(ac," special method."),ac.forEach(t),Zw=h(da),T(Os.$$.fragment,da),e$=h(da),T(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nR=a(Is);rh=s(nR,"SPAN",{});var sR=a(rh);T(Ii.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t$=h(Bu),ih=s(Bu,"SPAN",{});var aR=a(ih);o$=i(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Bu.forEach(t),Cf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);T(Di.$$.fragment,bt),n$=h(bt),Si=s(bt,"P",{});var Uu=a(Si);s$=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rR=a(lh);a$=i(rR,"language modeling"),rR.forEach(t),r$=i(Uu," head on top."),Uu.forEach(t),i$=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);l$=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iR=a(Pd);d$=i(iR,"FlaxPreTrainedModel"),iR.forEach(t),c$=i(Hu,`. Check the superclass documentation for the generic methods the
