...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15879/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15879/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15879/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15879/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15879/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
and its typically accessed much faster than normal CPU memory.`),Ry=u(),Ci=o("p"),kd=o("strong"),J7=a("Performance tuning:"),Iy=u(),ea=o("ul"),Ko=o("li"),Pd=o("code"),X7=a("stage3_max_live_parameters"),Q7=a(": "),zd=o("code"),e9=a("1e9"),s9=u(),Jo=o("li"),Dd=o("code"),t9=a("stage3_max_reuse_distance"),a9=a(": "),Od=o("code"),n9=a("1e9"),Uy=u(),S=o("p"),o9=a("If hitting OOM reduce "),Td=o("code"),l9=a("stage3_max_live_parameters"),r9=a(" and "),Ad=o("code"),p9=a("stage3_max_reuse_distance"),i9=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Sd=o("code"),u9=a("1e9"),c9=a(` would consume ~2GB. The memory is shared by
`),Cd=o("code"),h9=a("stage3_max_live_parameters"),f9=a(" and "),xd=o("code"),d9=a("stage3_max_reuse_distance"),m9=a(", so it\u2019s not additive, it\u2019s just 2GB total."),Gy=u(),we=o("p"),Rd=o("code"),_9=a("stage3_max_live_parameters"),v9=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Id=o("code"),j9=a("stage3_max_reuse_distance"),g9=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Ud=o("code"),y9=a("stage3_max_reuse_distance"),w9=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ly=u(),xi=o("p"),b9=a("The following configuration values depend on the model\u2019s hidden size:"),My=u(),Le=o("ul"),Xo=o("li"),Gd=o("code"),q9=a("reduce_bucket_size"),E9=a(": "),Ld=o("code"),$9=a("hidden_size*hidden_size"),k9=u(),Qo=o("li"),Md=o("code"),P9=a("stage3_prefetch_bucket_size"),z9=a(": "),Zd=o("code"),D9=a("0.9 * hidden_size * hidden_size"),O9=u(),el=o("li"),Nd=o("code"),T9=a("stage3_param_persistence_threshold"),A9=a(": "),Hd=o("code"),S9=a("10 * hidden_size"),Zy=u(),Me=o("p"),C9=a("therefore set these values to "),Bd=o("code"),x9=a("auto"),R9=a(" and the "),Ri=o("a"),I9=a("Trainer"),U9=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),Ny=u(),sl=o("p"),Wd=o("code"),G9=a("stage3_gather_fp16_weights_on_model_save"),L9=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Hy=u(),ee=o("p"),M9=a("If you\u2019re migrating from ZeRO-2 configuration note that "),Fd=o("code"),Z9=a("allgather_partitions"),N9=a(", "),Vd=o("code"),H9=a("allgather_bucket_size"),B9=a(` and
`),Yd=o("code"),W9=a("reduce_scatter"),F9=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),By=u(),Ii=o("ul"),tl=o("li"),Kd=o("code"),V9=a("sub_group_size"),Y9=a(": "),Jd=o("code"),K9=a("1e9"),Wy=u(),be=o("p"),Xd=o("code"),J9=a("sub_group_size"),X9=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),Qd=o("code"),Q9=a("sub_group_size"),ek=a(` and each buckets is updated one at a time. When used with NVMe offload in
...
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),nh.forEach(t),Ry=c(e),Ci=l(e,"P",{});var yM=r(Ci);kd=l(yM,"STRONG",{});var wM=r(kd);J7=n(wM,"Performance tuning:"),wM.forEach(t),yM.forEach(t),Iy=c(e),ea=l(e,"UL",{});var Q0=r(ea);Ko=l(Q0,"LI",{});var eq=r(Ko);Pd=l(eq,"CODE",{});var bM=r(Pd);X7=n(bM,"stage3_max_live_parameters"),bM.forEach(t),Q7=n(eq,": "),zd=l(eq,"CODE",{});var qM=r(zd);e9=n(qM,"1e9"),qM.forEach(t),eq.forEach(t),s9=c(Q0),Jo=l(Q0,"LI",{});var sq=r(Jo);Dd=l(sq,"CODE",{});var EM=r(Dd);t9=n(EM,"stage3_max_reuse_distance"),EM.forEach(t),a9=n(sq,": "),Od=l(sq,"CODE",{});var $M=r(Od);n9=n($M,"1e9"),$M.forEach(t),sq.forEach(t),Q0.forEach(t),Uy=c(e),S=l(e,"P",{});var de=r(S);o9=n(de,"If hitting OOM reduce "),Td=l(de,"CODE",{});var kM=r(Td);l9=n(kM,"stage3_max_live_parameters"),kM.forEach(t),r9=n(de," and "),Ad=l(de,"CODE",{});var PM=r(Ad);p9=n(PM,"stage3_max_reuse_distance"),PM.forEach(t),i9=n(de,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Sd=l(de,"CODE",{});var zM=r(Sd);u9=n(zM,"1e9"),zM.forEach(t),c9=n(de,` would consume ~2GB. The memory is shared by
`),Cd=l(de,"CODE",{});var DM=r(Cd);h9=n(DM,"stage3_max_live_parameters"),DM.forEach(t),f9=n(de," and "),xd=l(de,"CODE",{});var OM=r(xd);d9=n(OM,"stage3_max_reuse_distance"),OM.forEach(t),m9=n(de,", so it\u2019s not additive, it\u2019s just 2GB total."),de.forEach(t),Gy=c(e),we=l(e,"P",{});var mp=r(we);Rd=l(mp,"CODE",{});var TM=r(Rd);_9=n(TM,"stage3_max_live_parameters"),TM.forEach(t),v9=n(mp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Id=l(mp,"CODE",{});var AM=r(Id);j9=n(AM,"stage3_max_reuse_distance"),AM.forEach(t),g9=n(mp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Ud=l(mp,"CODE",{});var SM=r(Ud);y9=n(SM,"stage3_max_reuse_distance"),SM.forEach(t),w9=n(mp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),mp.forEach(t),Ly=c(e),xi=l(e,"P",{});var CM=r(xi);b9=n(CM,"The following configuration values depend on the model\u2019s hidden size:"),CM.forEach(t),My=c(e),Le=l(e,"UL",{});var oh=r(Le);Xo=l(oh,"LI",{});var tq=r(Xo);Gd=l(tq,"CODE",{});var xM=r(Gd);q9=n(xM,"reduce_bucket_size"),xM.forEach(t),E9=n(tq,": "),Ld=l(tq,"CODE",{});var RM=r(Ld);$9=n(RM,"hidden_size*hidden_size"),RM.forEach(t),tq.forEach(t),k9=c(oh),Qo=l(oh,"LI",{});var aq=r(Qo);Md=l(aq,"CODE",{});var IM=r(Md);P9=n(IM,"stage3_prefetch_bucket_size"),IM.forEach(t),z9=n(aq,": "),Zd=l(aq,"CODE",{});var UM=r(Zd);D9=n(UM,"0.9 * hidden_size * hidden_size"),UM.forEach(t),aq.forEach(t),O9=c(oh),el=l(oh,"LI",{});var nq=r(el);Nd=l(nq,"CODE",{});var GM=r(Nd);T9=n(GM,"stage3_param_persistence_threshold"),GM.forEach(t),A9=n(nq,": "),Hd=l(nq,"CODE",{});var LM=r(Hd);S9=n(LM,"10 * hidden_size"),LM.forEach(t),nq.forEach(t),oh.forEach(t),Zy=c(e),Me=l(e,"P",{});var lh=r(Me);C9=n(lh,"therefore set these values to "),Bd=l(lh,"CODE",{});var MM=r(Bd);x9=n(MM,"auto"),MM.forEach(t),R9=n(lh," and the "),Ri=l(lh,"A",{href:!0});var ZM=r(Ri);I9=n(ZM,"Trainer"),ZM.forEach(t),U9=n(lh,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),lh.forEach(t),Ny=c(e),sl=l(e,"P",{});var WI=r(sl);Wd=l(WI,"CODE",{});var NM=r(Wd);G9=n(NM,"stage3_gather_fp16_weights_on_model_save"),NM.forEach(t),L9=n(WI,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),WI.forEach(t),Hy=c(e),ee=l(e,"P",{});var Tn=r(ee);M9=n(Tn,"If you\u2019re migrating from ZeRO-2 configuration note that "),Fd=l(Tn,"CODE",{});var HM=r(Fd);Z9=n(HM,"allgather_partitions"),HM.forEach(t),N9=n(Tn,", "),Vd=l(Tn,"CODE",{});var BM=r(Vd);H9=n(BM,"allgather_bucket_size"),BM.forEach(t),B9=n(Tn,` and
`),Yd=l(Tn,"CODE",{});var WM=r(Yd);W9=n(WM,"reduce_scatter"),WM.forEach(t),F9=n(Tn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Tn.forEach(t),By=c(e),Ii=l(e,"UL",{});var FM=r(Ii);tl=l(FM,"LI",{});var oq=r(tl);Kd=l(oq,"CODE",{});var VM=r(Kd);V9=n(VM,"sub_group_size"),VM.forEach(t),Y9=n(oq,": "),Jd=l(oq,"CODE",{});var YM=r(Jd);K9=n(YM,"1e9"),YM.forEach(t),oq.forEach(t),FM.forEach(t),Wy=c(e),be=l(e,"P",{});var _p=r(be);Xd=l(_p,"CODE",{});var KM=r(Xd);J9=n(KM,"sub_group_size"),KM.forEach(t),X9=n(_p,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),Qd=l(_p,"CODE",{});var JM=r(Qd);Q9=n(JM,"sub_group_size"),JM.forEach(t),ek=n(_p,` and each buckets is updated one at a time. When used with NVMe offload in
