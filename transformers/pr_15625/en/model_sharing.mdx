...
Pass your training arguments as usual to [Trainer](/docs/transformers/pr_15625/en/main_classes/trainer#transformers.Trainer):
...
TensorFlow users can enable the same functionality with [PushToHubCallback](/docs/transformers/pr_15625/en/main_classes/keras_callbacks#transformers.PushToHubCallback). In the [PushToHubCallback](/docs/transformers/pr_15625/en/main_classes/keras_callbacks#transformers.PushToHubCallback) function, add:
