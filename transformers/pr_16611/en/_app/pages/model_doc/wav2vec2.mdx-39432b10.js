...
instance of <a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Whether or not <a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16611/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_16611/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
<p>A <a
  href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
<span class="hljs-number">53.48</span>`}}),Js=new ee({}),Zs=new V({props:{name:"class transformers.Wav2Vec2ForSequenceClassification",anchor:"transformers.Wav2Vec2ForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),on=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),nn=new ee({}),rn=new V({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1900",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-number">0.98</span>`}}),xn=new ee({}),Wn=new V({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1386",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),En=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"mask_time_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"sampled_negative_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(input_values, mask_time_indices=mask_time_indices).loss`}}),qn=new ee({}),Pn=new V({props:{name:"class transformers.TFWav2Vec2Model",anchor:"transformers.TFWav2Vec2Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1428",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[CT]},$$scope:{ctx:E}}}),On=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[PT]},$$scope:{ctx:E}}}),Hn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16611/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16611/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16611/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
using `),Ce=s(Nd,"A",{href:!0});var j1=n(Ce);ye=i(j1,"Wav2Vec2CTCTokenizer"),j1.forEach(t),mt=i(Nd,"."),Nd.forEach(t),Pr.forEach(t),$=c(o),C=s(o,"P",{});var Id=n(C);Ze=i(Id,"This model was contributed by "),Ke=s(Id,"A",{href:!0,rel:!0});var V1=n(Ke);Bt=i(V1,"patrickvonplaten"),V1.forEach(t),se=i(Id,"."),Id.forEach(t),xt=c(o),ke=s(o,"H2",{class:!0});var Bd=n(ke);qe=s(Bd,"A",{id:!0,class:!0,href:!0});var F1=n(qe);G=s(F1,"SPAN",{});var E1=n(G);g(J.$$.fragment,E1),E1.forEach(t),F1.forEach(t),Ut=c(Bd),ht=s(Bd,"SPAN",{});var C1=n(ht);Te=i(C1,"Wav2Vec2Config"),C1.forEach(t),Bd.forEach(t),Wt=c(o),U=s(o,"DIV",{class:!0});var Ft=n(U);g(xe.$$.fragment,Ft),Ht=c(Ft),Rt=s(Ft,"P",{});var Wi=n(Rt);lm=i(Wi,"This is the configuration class to store the configuration of a "),zr=s(Wi,"A",{href:!0});var q1=n(zr);cm=i(q1,"Wav2Vec2Model"),q1.forEach(t),dm=i(Wi,`. It is used to instantiate an
Wav2Vec2 model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Wav2Vec2
...
documentation from `),Ar=s($i,"A",{href:!0});var M1=n(Ar);_m=i(M1,"PretrainedConfig"),M1.forEach(t),vm=i($i," for more information."),$i.forEach(t),wm=c(Ft),Xi=s(Ft,"P",{});var A1=n(Xi);bm=i(A1,"Example:"),A1.forEach(t),ym=c(Ft),g(Ea.$$.fragment,Ft),Ft.forEach(t),sd=c(o),Gt=s(o,"H2",{class:!0});var Ud=n(Gt);Fo=s(Ud,"A",{id:!0,class:!0,href:!0});var O1=n(Fo);Gi=s(O1,"SPAN",{});var L1=n(Gi);g(Ca.$$.fragment,L1),L1.forEach(t),O1.forEach(t),km=c(Ud),Ji=s(Ud,"SPAN",{});var D1=n(Ji);Tm=i(D1,"Wav2Vec2CTCTokenizer"),D1.forEach(t),Ud.forEach(t),nd=c(o),Z=s(o,"DIV",{class:!0});var Ue=n(Z);g(qa.$$.fragment,Ue),xm=c(Ue),Zi=s(Ue,"P",{});var S1=n(Zi);Wm=i(S1,"Constructs a Wav2Vec2CTC tokenizer."),S1.forEach(t),$m=c(Ue),Pa=s(Ue,"P",{});var Hd=n(Pa);jm=i(Hd,"This tokenizer inherits from "),Or=s(Hd,"A",{href:!0});var N1=n(Or);Vm=i(N1,"PreTrainedTokenizer"),N1.forEach(t),Fm=i(Hd,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),Hd.forEach(t),Em=c(Ue),Eo=s(Ue,"DIV",{class:!0});var Rd=n(Eo);g(za.$$.fragment,Rd),Cm=c(Rd),Ki=s(Rd,"P",{});var I1=n(Ki);qm=i(I1,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),I1.forEach(t),Rd.forEach(t),Pm=c(Ue),Lr=s(Ue,"DIV",{class:!0});var B1=n(Lr);g(Ma.$$.fragment,B1),B1.forEach(t),zm=c(Ue),Pe=s(Ue,"DIV",{class:!0});var Et=n(Pe);g(Aa.$$.fragment,Et),Mm=c(Et),Qi=s(Et,"P",{});var U1=n(Qi);Am=i(U1,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),U1.forEach(t),Om=c(Et),Oa=s(Et,"P",{});var Xd=n(Oa);Lm=i(Xd,"Similar to doing "),Yi=s(Xd,"CODE",{});var H1=n(Yi);Dm=i(H1,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),H1.forEach(t),Sm=i(Xd,"."),Xd.forEach(t),Nm=c(Et),el=s(Et,"P",{});var R1=n(el);Im=i(R1,"Example:"),R1.forEach(t),Bm=c(Et),g(La.$$.fragment,Et),Et.forEach(t),Um=c(Ue),Co=s(Ue,"DIV",{class:!0});var Gd=n(Co);g(Da.$$.fragment,Gd),Hm=c(Gd),tl=s(Gd,"P",{});var X1=n(tl);Rm=i(X1,"Convert a list of lists of token ids into a list of strings by calling decode."),X1.forEach(t),Gd.forEach(t),Ue.forEach(t),rd=c(o),Jt=s(o,"H2",{class:!0});var Jd=n(Jt);qo=s(Jd,"A",{id:!0,class:!0,href:!0});var G1=n(qo);ol=s(G1,"SPAN",{});var J1=n(ol);g(Sa.$$.fragment,J1),J1.forEach(t),G1.forEach(t),Xm=c(Jd),al=s(Jd,"SPAN",{});var Z1=n(al);Gm=i(Z1,"Wav2Vec2FeatureExtractor"),Z1.forEach(t),Jd.forEach(t),id=c(o),Qe=s(o,"DIV",{class:!0});var ba=n(Qe);g(Na.$$.fragment,ba),Jm=c(ba),sl=s(ba,"P",{});var K1=n(sl);Zm=i(K1,"Constructs a Wav2Vec2 feature extractor."),K1.forEach(t),Km=c(ba),Ia=s(ba,"P",{});var Zd=n(Ia);Qm=i(Zd,"This feature extractor inherits from "),Dr=s(Zd,"A",{href:!0});var Q1=n(Dr);Ym=i(Q1,"SequenceFeatureExtractor"),Q1.forEach(t),eh=i(Zd,` which contains
...
`),Ja=s(ya,"A",{href:!0});var x1=n(Ja);pl=s(x1,"STRONG",{});var pb=n(pl);Vh=i(pb,"call"),pb.forEach(t),Fh=i(x1,"()"),x1.forEach(t),Eh=i(ya,". Please refer to the docstring of the above two methods for more information."),ya.forEach(t),Yd.forEach(t),Ch=c(R),Ao=s(R,"DIV",{class:!0});var ep=n(Ao);g(Za.$$.fragment,ep),qh=c(ep),ut=s(ep,"P",{});var ka=n(ut);Ph=i(ka,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
`),Hr=s(ka,"A",{href:!0});var mb=n(Hr);zh=i(mb,"pad()"),mb.forEach(t),Mh=i(ka,` and returns its output. If used in the context
`),Rr=s(ka,"A",{href:!0});var hb=n(Rr);Ah=i(hb,"as_target_processor()"),hb.forEach(t),Oh=i(ka,` this method forwards all its arguments to PreTrainedTokenizer\u2019s
`),Xr=s(ka,"A",{href:!0});var fb=n(Xr);Lh=i(fb,"pad()"),fb.forEach(t),Dh=i(ka,". Please refer to the docstring of the above two methods for more information."),ka.forEach(t),ep.forEach(t),Sh=c(R),Gr=s(R,"DIV",{class:!0});var ub=n(Gr);g(Ka.$$.fragment,ub),ub.forEach(t),Nh=c(R),$t=s(R,"DIV",{class:!0});var ji=n($t);g(Qa.$$.fragment,ji),Ih=c(ji),Ya=s(ji,"P",{});var tp=n(Ya);Bh=i(tp,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Jr=s(tp,"A",{href:!0});var gb=n(Jr);Uh=i(gb,"from_pretrained()"),gb.forEach(t),Hh=i(tp," method."),tp.forEach(t),Rh=c(ji),g(Oo.$$.fragment,ji),ji.forEach(t),Xh=c(R),Lo=s(R,"DIV",{class:!0});var op=n(Lo);g(es.$$.fragment,op),Gh=c(op),ts=s(op,"P",{});var ap=n(ts);Jh=i(ap,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Zr=s(ap,"A",{href:!0});var _b=n(Zr);Zh=i(_b,"batch_decode()"),_b.forEach(t),Kh=i(ap,`. Please
refer to the docstring of this method for more information.`),ap.forEach(t),op.forEach(t),Qh=c(R),Do=s(R,"DIV",{class:!0});var sp=n(Do);g(os.$$.fragment,sp),Yh=c(sp),as=s(sp,"P",{});var np=n(as);ef=i(np,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Kr=s(np,"A",{href:!0});var vb=n(Kr);tf=i(vb,"decode()"),vb.forEach(t),of=i(np,`. Please refer
...
for more information.`),xa.forEach(t),cp.forEach(t),Cf=c(te),jt=s(te,"DIV",{class:!0});var Vi=n(jt);g(ps.$$.fragment,Vi),qf=c(Vi),ms=s(Vi,"P",{});var dp=n(ms);Pf=i(dp,"Instantiate a "),oi=s(dp,"A",{href:!0});var Eb=n(oi);zf=i(Eb,"Wav2Vec2ProcessorWithLM"),Eb.forEach(t),Mf=i(dp," from a pretrained Wav2Vec2 processor."),dp.forEach(t),Af=c(Vi),g(Uo.$$.fragment,Vi),Vi.forEach(t),Of=c(te),ai=s(te,"DIV",{class:!0});var Cb=n(ai);g(hs.$$.fragment,Cb),Cb.forEach(t),Lf=c(te),Vt=s(te,"DIV",{class:!0});var Fi=n(Vt);g(fs.$$.fragment,Fi),Df=c(Fi),vl=s(Fi,"P",{});var qb=n(vl);Sf=i(qb,"Batch decode output logits to audio transcription with language model support."),qb.forEach(t),Nf=c(Fi),g(Ho.$$.fragment,Fi),Fi.forEach(t),If=c(te),tt=s(te,"DIV",{class:!0});var Wa=n(tt);g(us.$$.fragment,Wa),Bf=c(Wa),wl=s(Wa,"P",{});var Pb=n(wl);Uf=i(Pb,"Decode output logits to audio transcription with language model support."),Pb.forEach(t),Hf=c(Wa),bl=s(Wa,"P",{});var zb=n(bl);Rf=i(zb,"Example:"),zb.forEach(t),Xf=c(Wa),g(gs.$$.fragment,Wa),Wa.forEach(t),Gf=c(te),Ro=s(te,"DIV",{class:!0});var pp=n(Ro);g(_s.$$.fragment,pp),Jf=c(pp),yl=s(pp,"P",{});var Mb=n(yl);Zf=i(Mb,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),Mb.forEach(t),pp.forEach(t),te.forEach(t),md=c(o),Qt=s(o,"H2",{class:!0});var mp=n(Qt);Xo=s(mp,"A",{id:!0,class:!0,href:!0});var Ab=n(Xo);kl=s(Ab,"SPAN",{});var Ob=n(kl);g(vs.$$.fragment,Ob),Ob.forEach(t),Ab.forEach(t),Kf=c(mp),Tl=s(mp,"SPAN",{});var Lb=n(Tl);Qf=i(Lb,"Wav2Vec2 specific outputs"),Lb.forEach(t),mp.forEach(t),hd=c(o),Yt=s(o,"DIV",{class:!0});var hp=n(Yt);g(ws.$$.fragment,hp),Yf=c(hp),bs=s(hp,"P",{});var fp=n(bs);eu=i(fp,"Output type of "),xl=s(fp,"CODE",{});var Db=n(xl);tu=i(Db,"Wav2Vec2DecoderWithLM"),Db.forEach(t),ou=i(fp,", with transcription."),fp.forEach(t),hp.forEach(t),fd=c(o),eo=s(o,"DIV",{class:!0});var up=n(eo);g(ys.$$.fragment,up),au=c(up),ks=s(up,"P",{});var gp=n(ks);su=i(gp,"Output type of "),Wl=s(gp,"CODE",{});var Sb=n(Wl);nu=i(Sb,"Wav2Vec2BaseModelOutput"),Sb.forEach(t),ru=i(gp,", with potential hidden states and attentions."),gp.forEach(t),up.forEach(t),ud=c(o),to=s(o,"DIV",{class:!0});var _p=n(to);g(Ts.$$.fragment,_p),iu=c(_p),xs=s(_p,"P",{});var vp=n(xs);lu=i(vp,"Output type of "),si=s(vp,"A",{href:!0});var Nb=n(si);cu=i(Nb,"Wav2Vec2ForPreTraining"),Nb.forEach(t),du=i(vp,", with potential hidden states and attentions."),vp.forEach(t),_p.forEach(t),gd=c(o),vt=s(o,"DIV",{class:!0});var Ei=n(vt);g(Ws.$$.fragment,Ei),pu=c(Ei),$s=s(Ei,"P",{});var wp=n($s);mu=i(wp,"Output type of "),$l=s(wp,"CODE",{});var Ib=n($l);hu=i(Ib,"FlaxWav2Vec2BaseModelOutput"),Ib.forEach(t),fu=i(wp,", with potential hidden states and attentions."),wp.forEach(t),uu=c(Ei),Go=s(Ei,"DIV",{class:!0});var bp=n(Go);g(js.$$.fragment,bp),gu=c(bp),jl=s(bp,"P",{});var Bb=n(jl);_u=i(Bb,"\u201CReturns a new object replacing the specified fields with new values."),Bb.forEach(t),bp.forEach(t),Ei.forEach(t),_d=c(o),wt=s(o,"DIV",{class:!0});var Ci=n(wt);g(Vs.$$.fragment,Ci),vu=c(Ci),Fs=s(Ci,"P",{});var yp=n(Fs);wu=i(yp,"Output type of "),Vl=s(yp,"CODE",{});var Ub=n(Vl);bu=i(Ub,"FlaxWav2Vec2ForPreTrainingOutput"),Ub.forEach(t),yu=i(yp,", with potential hidden states and attentions."),yp.forEach(t),ku=c(Ci),Jo=s(Ci,"DIV",{class:!0});var kp=n(Jo);g(Es.$$.fragment,kp),Tu=c(kp),Fl=s(kp,"P",{});var Hb=n(Fl);xu=i(Hb,"\u201CReturns a new object replacing the specified fields with new values."),Hb.forEach(t),kp.forEach(t),Ci.forEach(t),vd=c(o),oo=s(o,"H2",{class:!0});var Tp=n(oo);Zo=s(Tp,"A",{id:!0,class:!0,href:!0});var Rb=n(Zo);El=s(Rb,"SPAN",{});var Xb=n(El);g(Cs.$$.fragment,Xb),Xb.forEach(t),Rb.forEach(t),Wu=c(Tp),Cl=s(Tp,"SPAN",{});var Gb=n(Cl);$u=i(Gb,"Wav2Vec2Model"),Gb.forEach(t),Tp.forEach(t),wd=c(o),We=s(o,"DIV",{class:!0});var Ct=n(We);g(qs.$$.fragment,Ct),ju=c(Ct),Ps=s(Ct,"P",{});var xp=n(Ps);Vu=i(xp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Auli.`),xp.forEach(t),Cu=c(Ct),Ms=s(Ct,"P",{});var Wp=n(Ms);qu=i(Wp,"This model inherits from "),ni=s(Wp,"A",{href:!0});var Zb=n(ni);Pu=i(Zb,"PreTrainedModel"),Zb.forEach(t),zu=i(Wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Wp.forEach(t),Mu=c(Ct),As=s(Ct,"P",{});var $p=n(As);Au=i($p,"This model is a PyTorch "),Os=s($p,"A",{href:!0,rel:!0});var Kb=n(Os);Ou=i(Kb,"torch.nn.Module"),Kb.forEach(t),Lu=i($p,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Du=c(Ct),Me=s(Ct,"DIV",{class:!0});var qt=n(Me);g(Ls.$$.fragment,qt),Su=c(qt),ao=s(qt,"P",{});var qi=n(ao);Nu=i(qi,"The "),ri=s(qi,"A",{href:!0});var Qb=n(ri);Iu=i(Qb,"Wav2Vec2Model"),Qb.forEach(t),Bu=i(qi," forward method, overrides the "),ql=s(qi,"CODE",{});var Yb=n(ql);Uu=i(Yb,"__call__"),Yb.forEach(t),Hu=i(qi," special method."),qi.forEach(t),Ru=c(qt),g(Ko.$$.fragment,qt),Xu=c(qt),Pl=s(qt,"P",{});var ey=n(Pl);Gu=i(ey,"Example:"),ey.forEach(t),Ju=c(qt),g(Ds.$$.fragment,qt),qt.forEach(t),Ct.forEach(t),bd=c(o),so=s(o,"H2",{class:!0});var jp=n(so);Qo=s(jp,"A",{id:!0,class:!0,href:!0});var ty=n(Qo);zl=s(ty,"SPAN",{});var oy=n(zl);g(Ss.$$.fragment,oy),oy.forEach(t),ty.forEach(t),Zu=c(jp),Ml=s(jp,"SPAN",{});var ay=n(Ml);Ku=i(ay,"Wav2Vec2ForCTC"),ay.forEach(t),jp.forEach(t),yd=c(o),$e=s(o,"DIV",{class:!0});var Pt=n($e);g(Ns.$$.fragment,Pt),Qu=c(Pt),no=s(Pt,"P",{});var Pi=n(no);Yu=i(Pi,"Wav2Vec2 Model with a "),Al=s(Pi,"CODE",{});var sy=n(Al);eg=i(sy,"language modeling"),sy.forEach(t),tg=i(Pi,` head on top for Connectionist Temporal Classification (CTC).
