...
behavior.`),a1=d(),u(ln.$$.fragment),s1=d(),Ie=n("div"),u(Ps.$$.fragment),r1=d(),To=n("p"),i1=r("The "),xi=n("a"),d1=r("TFMBartModel"),l1=r(" forward method, overrides the "),oc=n("code"),c1=r("__call__"),p1=r(" special method."),h1=d(),u(cn.$$.fragment),u1=d(),nc=n("p"),m1=r("Example:"),f1=d(),u(Ss.$$.fragment),eh=d(),wo=n("h2"),pn=n("a"),ac=n("span"),u(Os.$$.fragment),_1=d(),sc=n("span"),g1=r("TFMBartForConditionalGeneration"),th=d(),Ee=n("div"),u(As.$$.fragment),k1=d(),Is=n("p"),b1=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),z1=d(),u(hn.$$.fragment),F1=d(),ee=n("div"),u(Ls.$$.fragment),q1=d(),Mo=n("p"),$1=r("The "),Fi=n("a"),B1=r("TFMBartForConditionalGeneration"),j1=r(" forward method, overrides the "),rc=n("code"),E1=r("__call__"),C1=r(" special method."),P1=d(),u(un.$$.fragment),S1=d(),ic=n("p"),O1=r("Summarization example:"),A1=d(),u(Gs.$$.fragment),I1=d(),dc=n("p"),N1=r("Mask filling example:"),D1=d(),u(Ws.$$.fragment),oh=d(),xo=n("h2"),mn=n("a"),lc=n("span"),u(Us.$$.fragment),L1=d(),cc=n("span"),G1=r("FlaxMBartModel"),nh=d(),U=n("div"),u(Rs.$$.fragment),W1=d(),Xs=n("p"),U1=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Oy=d(),wc=n("p"),Ay=r("Finally, this model supports inherent JAX features such as:"),Iy=d(),_t=n("ul"),Mc=n("li"),cr=n("a"),Ny=r("Just-In-Time (JIT) compilation"),Dy=d(),xc=n("li"),pr=n("a"),Ly=r("Automatic Differentiation"),Gy=d(),zc=n("li"),hr=n("a"),Wy=r("Vectorization"),Uy=d(),Fc=n("li"),ur=n("a"),Ry=r("Parallelization"),Xy=d(),te=n("div"),u(mr.$$.fragment),Qy=d(),qo=n("p"),Hy=r("The "),qc=n("code"),Vy=r("FlaxMBartPreTrainedModel"),Jy=r("forward method, overrides the "),$c=n("code"),Ky=r("__call__"),Zy=r(" special method."),Yy=d(),u(gn.$$.fragment),ev=d(),Bc=n("p"),tv=r("Summarization example:"),ov=d(),u(fr.$$.fragment),nv=d(),jc=n("p"),av=r("Mask filling example:"),sv=d(),u(_r.$$.fragment),rv=d(),xt=n("div"),u(gr.$$.fragment),iv=d(),Ec=n("p"),dv=r("Example:"),lv=d(),u(kr.$$.fragment),cv=d(),zt=n("div"),u(br.$$.fragment),pv=d(),Cc=n("p"),hv=r("Example:"),uv=d(),u(yr.$$.fragment),rh=d(),$o=n("h2"),kn=n("a"),Pc=n("span"),u(vr.$$.fragment),mv=d(),Sc=n("span"),fv=r("FlaxMBartForSequenceClassification"),ih=d(),A=n("div"),u(Tr.$$.fragment),_v=d(),Oc=n("p"),gv=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gu.forEach(t),a1=l(It),m(ln.$$.fragment,It),s1=l(It),Ie=a(It,"DIV",{class:!0});var Nt=s(Ie);m(Ps.$$.fragment,Nt),r1=l(Nt),To=a(Nt,"P",{});var Ri=s(To);i1=i(Ri,"The "),xi=a(Ri,"A",{href:!0});var Hx=s(xi);d1=i(Hx,"TFMBartModel"),Hx.forEach(t),l1=i(Ri," forward method, overrides the "),oc=a(Ri,"CODE",{});var Vx=s(oc);c1=i(Vx,"__call__"),Vx.forEach(t),p1=i(Ri," special method."),Ri.forEach(t),h1=l(Nt),m(cn.$$.fragment,Nt),u1=l(Nt),nc=a(Nt,"P",{});var Jx=s(nc);m1=i(Jx,"Example:"),Jx.forEach(t),f1=l(Nt),m(Ss.$$.fragment,Nt),Nt.forEach(t),It.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var ku=s(wo);pn=a(ku,"A",{id:!0,class:!0,href:!0});var Kx=s(pn);ac=a(Kx,"SPAN",{});var Zx=s(ac);m(Os.$$.fragment,Zx),Zx.forEach(t),Kx.forEach(t),_1=l(ku),sc=a(ku,"SPAN",{});var Yx=s(sc);g1=i(Yx,"TFMBartForConditionalGeneration"),Yx.forEach(t),ku.forEach(t),th=l(o),Ee=a(o,"DIV",{class:!0});var Dt=s(Ee);m(As.$$.fragment,Dt),k1=l(Dt),Is=a(Dt,"P",{});var bu=s(Is);b1=i(bu,`The MBART Model with a language modeling head. Can be used for summarization.
