...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ia=new Q({}),da=new $({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_bart.py#L1268",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ha=new $({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_bart.py#L1307",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
[<span class="hljs-string">&#x27;not&#x27;</span>, <span class="hljs-string">&#x27;good&#x27;</span>, <span class="hljs-string">&#x27;healthy&#x27;</span>, <span class="hljs-string">&#x27;great&#x27;</span>, <span class="hljs-string">&#x27;very&#x27;</span>]`}}),fa=new Q({}),_a=new $({props:{name:"class transformers.BartForSequenceClassification",anchor:"transformers.BartForSequenceClassification",parameters:[{name:"config",val:": BartConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_bart.py#L1437",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ya=new $({props:{name:"forward",anchor:"transformers.BartForSequenceClassification.forward",parameters:[{name:"input_ids",val:": LongTensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_bart.py#L1450",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),Fa=new Q({}),za=new $({props:{name:"class transformers.BartForQuestionAnswering",anchor:"transformers.BartForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_bart.py#L1564",parametersDescription:[{anchor:"transformers.BartForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ja=new $({props:{name:"forward",anchor:"transformers.BartForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": Tensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_bart.py#L1576",parametersDescription:[{anchor:"transformers.BartForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Ts=new $({props:{name:"__call__",anchor:"transformers.FlaxBartForConditionalGeneration.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_flax_bart.py#L1164",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),qs=new $({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_flax_bart.py#L1319",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Is=new $({props:{name:"__call__",anchor:"transformers.FlaxBartForSequenceClassification.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_flax_bart.py#L1164",parametersDescription:[{anchor:"transformers.FlaxBartForSequenceClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Ys=new $({props:{name:"__call__",anchor:"transformers.FlaxBartForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_flax_bart.py#L1164",parametersDescription:[{anchor:"transformers.FlaxBartForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),nr=new $({props:{name:"decode",anchor:"transformers.FlaxBartForQuestionAnswering.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/bart/modeling_flax_bart.py#L1050",parametersDescription:[{anchor:"transformers.FlaxBartForQuestionAnswering.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
object can be found in this `),zn=a(fn,"A",{href:!0,rel:!0});var Xy=s(zn);Jp=i(Xy,"forum discussion"),Xy.forEach(t),Xp=i(fn,"."),fn.forEach(t),Kp=l(Xr),jo=a(Xr,"LI",{});var nc=s(jo);qn=a(nc,"A",{href:!0,rel:!0});var Ky=s(qn);Zp=i(Ky,"Distilled checkpoints"),Ky.forEach(t),Yp=i(nc," are described in this "),$n=a(nc,"A",{href:!0,rel:!0});var Zy=s($n);eh=i(Zy,"paper"),Zy.forEach(t),th=i(nc,"."),nc.forEach(t),Xr.forEach(t),sc=l(o),Ht=a(o,"H2",{class:!0});var Wc=s(Ht);Co=a(Wc,"A",{id:!0,class:!0,href:!0});var Yy=s(Co);qi=a(Yy,"SPAN",{});var e1=s(qi);f(Bn.$$.fragment,e1),e1.forEach(t),Yy.forEach(t),oh=l(Wc),$i=a(Wc,"SPAN",{});var t1=s($i);nh=i(t1,"Implementation Notes"),t1.forEach(t),Wc.forEach(t),rc=l(o),Ee=a(o,"UL",{});var Bt=s(Ee);pt=a(Bt,"LI",{});var _n=s(pt);ah=i(_n,"Bart doesn\u2019t use "),Bi=a(_n,"CODE",{});var o1=s(Bi);sh=i(o1,"token_type_ids"),o1.forEach(t),rh=i(_n," for sequence classification. Use "),yr=a(_n,"A",{href:!0});var n1=s(yr);ih=i(n1,"BartTokenizer"),n1.forEach(t),dh=i(_n,` or
`),vr=a(_n,"A",{href:!0});var a1=s(vr);lh=i(a1,"encode()"),a1.forEach(t),ch=i(_n," to get the proper splitting."),_n.forEach(t),ph=l(Bt),Qt=a(Bt,"LI",{});var Kr=s(Qt);hh=i(Kr,"The forward pass of "),Tr=a(Kr,"A",{href:!0});var s1=s(Tr);uh=i(s1,"BartModel"),s1.forEach(t),mh=i(Kr," will create the "),ji=a(Kr,"CODE",{});var r1=s(ji);fh=i(r1,"decoder_input_ids"),r1.forEach(t),_h=i(Kr,` if they are not passed.
...
`),Ci=a(Zr,"CODE",{});var i1=s(Ci);bh=i(i1,"forced_bos_token_id=0"),i1.forEach(t),yh=i(Zr,`. This only works, however, if the string you pass to
`),Mi=a(Zr,"CODE",{});var d1=s(Mi);vh=i(d1,"fairseq.encode"),d1.forEach(t),Th=i(Zr," starts with a space."),Zr.forEach(t),wh=l(Bt),wr=a(Bt,"LI",{});var Sy=s(wr);xr=a(Sy,"A",{href:!0});var l1=s(xr);xh=i(l1,"generate()"),l1.forEach(t),Fh=i(Sy,` should be used for conditional generation tasks like
summarization, see the example in that docstrings.`),Sy.forEach(t),zh=l(Bt),Jt=a(Bt,"LI",{});var Yr=s(Jt);qh=i(Yr,"Models that load the "),Ei=a(Yr,"EM",{});var c1=s(Ei);$h=i(c1,"facebook/bart-large-cnn"),c1.forEach(t),Bh=i(Yr," weights will not have a "),Pi=a(Yr,"CODE",{});var p1=s(Pi);jh=i(p1,"mask_token_id"),p1.forEach(t),Ch=i(Yr,`, or be able to perform
mask-filling tasks.`),Yr.forEach(t),Bt.forEach(t),ic=l(o),Xt=a(o,"H2",{class:!0});var Uc=s(Xt);Mo=a(Uc,"A",{id:!0,class:!0,href:!0});var h1=s(Mo);Ai=a(h1,"SPAN",{});var u1=s(Ai);f(jn.$$.fragment,u1),u1.forEach(t),h1.forEach(t),Mh=l(Uc),Si=a(Uc,"SPAN",{});var m1=s(Si);Eh=i(m1,"Mask Filling"),m1.forEach(t),Uc.forEach(t),dc=l(o),kt=a(o,"P",{});var ei=s(kt);Ph=i(ei,"The "),Oi=a(ei,"CODE",{});var f1=s(Oi);Ah=i(f1,"facebook/bart-base"),f1.forEach(t),Sh=i(ei," and "),Ii=a(ei,"CODE",{});var _1=s(Ii);Oh=i(_1,"facebook/bart-large"),_1.forEach(t),Ih=i(ei," checkpoints can be used to fill multi-token masks."),ei.forEach(t),lc=l(o),f(Cn.$$.fragment,o),cc=l(o),Kt=a(o,"H2",{class:!0});var Rc=s(Kt);Eo=a(Rc,"A",{id:!0,class:!0,href:!0});var g1=s(Eo);Ni=a(g1,"SPAN",{});var k1=s(Ni);f(Mn.$$.fragment,k1),k1.forEach(t),g1.forEach(t),Nh=l(Rc),Li=a(Rc,"SPAN",{});var b1=s(Li);Lh=i(b1,"BartConfig"),b1.forEach(t),Rc.forEach(t),pc=l(o),Fe=a(o,"DIV",{class:!0});var jt=s(Fe);f(En.$$.fragment,jt),Dh=l(jt),Zt=a(jt,"P",{});var ti=s(Zt);Gh=i(ti,"This is the configuration class to store the configuration of a "),Fr=a(ti,"A",{href:!0});var y1=s(Fr);Wh=i(y1,"BartModel"),y1.forEach(t),Uh=i(ti,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),Pn=a(ti,"A",{href:!0,rel:!0});var v1=s(Pn);Rh=i(v1,"facebook/bart-large"),v1.forEach(t),Hh=i(ti," architecture."),ti.forEach(t),Qh=l(jt),Yt=a(jt,"P",{});var oi=s(Yt);Vh=i(oi,"Configuration objects inherit from "),zr=a(oi,"A",{href:!0});var T1=s(zr);Jh=i(T1,"PretrainedConfig"),T1.forEach(t),Xh=i(oi,` and can be used to control the model outputs. Read the
documentation from `),qr=a(oi,"A",{href:!0});var w1=s(qr);Kh=i(w1,"PretrainedConfig"),w1.forEach(t),Zh=i(oi," for more information."),oi.forEach(t),Yh=l(jt),Di=a(jt,"P",{});var x1=s(Di);eu=i(x1,"Example:"),x1.forEach(t),tu=l(jt),f(An.$$.fragment,jt),jt.forEach(t),hc=l(o),eo=a(o,"H2",{class:!0});var Hc=s(eo);Po=a(Hc,"A",{id:!0,class:!0,href:!0});var F1=s(Po);Gi=a(F1,"SPAN",{});var z1=s(Gi);f(Sn.$$.fragment,z1),z1.forEach(t),F1.forEach(t),ou=l(Hc),Wi=a(Hc,"SPAN",{});var q1=s(Wi);nu=i(q1,"BartTokenizer"),q1.forEach(t),Hc.forEach(t),uc=l(o),E=a(o,"DIV",{class:!0});var G=s(E);f(On.$$.fragment,G),au=l(G),Ui=a(G,"P",{});var $1=s(Ui);su=i($1,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),$1.forEach(t),ru=l(G),Ri=a(G,"P",{});var B1=s(Ri);iu=i(B1,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),B1.forEach(t),du=l(G),f(In.$$.fragment,G),lu=l(G),Nn=a(G,"P",{});var Qc=s(Nn);cu=i(Qc,"You can get around that behavior by passing "),Hi=a(Qc,"CODE",{});var j1=s(Hi);pu=i(j1,"add_prefix_space=True"),j1.forEach(t),hu=i(Qc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Qc.forEach(t),uu=l(G),f(Ao.$$.fragment,G),mu=l(G),Ln=a(G,"P",{});var Vc=s(Ln);fu=i(Vc,"This tokenizer inherits from "),$r=a(Vc,"A",{href:!0});var C1=s($r);_u=i(C1,"PreTrainedTokenizer"),C1.forEach(t),gu=i(Vc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Vc.forEach(t),ku=l(G),bt=a(G,"DIV",{class:!0});var ni=s(bt);f(Dn.$$.fragment,ni),bu=l(ni),Qi=a(ni,"P",{});var M1=s(Qi);yu=i(M1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),M1.forEach(t),vu=l(ni),Gn=a(ni,"UL",{});var Jc=s(Gn);Br=a(Jc,"LI",{});var Oy=s(Br);Tu=i(Oy,"single sequence: "),Vi=a(Oy,"CODE",{});var E1=s(Vi);wu=i(E1,"<s> X </s>"),E1.forEach(t),Oy.forEach(t),xu=l(Jc),jr=a(Jc,"LI",{});var Iy=s(jr);Fu=i(Iy,"pair of sequences: "),Ji=a(Iy,"CODE",{});var P1=s(Ji);zu=i(P1,"<s> A </s></s> B </s>"),P1.forEach(t),Iy.forEach(t),Jc.forEach(t),ni.forEach(t),qu=l(G),So=a(G,"DIV",{class:!0});var Xc=s(So);f(Wn.$$.fragment,Xc),$u=l(Xc),Xi=a(Xc,"P",{});var A1=s(Xi);Bu=i(A1,"Converts a sequence of tokens (string) in a single string."),A1.forEach(t),Xc.forEach(t),ju=l(G),Oo=a(G,"DIV",{class:!0});var Kc=s(Oo);f(Un.$$.fragment,Kc),Cu=l(Kc),Ki=a(Kc,"P",{});var S1=s(Ki);Mu=i(S1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),S1.forEach(t),Kc.forEach(t),Eu=l(G),Io=a(G,"DIV",{class:!0});var Zc=s(Io);f(Rn.$$.fragment,Zc),Pu=l(Zc),Hn=a(Zc,"P",{});var Yc=s(Hn);Au=i(Yc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Zi=a(Yc,"CODE",{});var O1=s(Zi);Su=i(O1,"prepare_for_model"),O1.forEach(t),Ou=i(Yc," method."),Yc.forEach(t),Zc.forEach(t),G.forEach(t),mc=l(o),to=a(o,"H2",{class:!0});var ep=s(to);No=a(ep,"A",{id:!0,class:!0,href:!0});var I1=s(No);Yi=a(I1,"SPAN",{});var N1=s(Yi);f(Qn.$$.fragment,N1),N1.forEach(t),I1.forEach(t),Iu=l(ep),ed=a(ep,"SPAN",{});var L1=s(ed);Nu=i(L1,"BartTokenizerFast"),L1.forEach(t),ep.forEach(t),fc=l(o),W=a(o,"DIV",{class:!0});var _e=s(W);f(Vn.$$.fragment,_e),Lu=l(_e),Jn=a(_e,"P",{});var tp=s(Jn);Du=i(tp,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),td=a(tp,"EM",{});var D1=s(td);Gu=i(D1,"tokenizers"),D1.forEach(t),Wu=i(tp,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),tp.forEach(t),Uu=l(_e),od=a(_e,"P",{});var G1=s(od);Ru=i(G1,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),G1.forEach(t),Hu=l(_e),f(Xn.$$.fragment,_e),Qu=l(_e),Kn=a(_e,"P",{});var op=s(Kn);Vu=i(op,"You can get around that behavior by passing "),nd=a(op,"CODE",{});var W1=s(nd);Ju=i(W1,"add_prefix_space=True"),W1.forEach(t),Xu=i(op,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),op.forEach(t),Ku=l(_e),f(Lo.$$.fragment,_e),Zu=l(_e),Zn=a(_e,"P",{});var np=s(Zn);Yu=i(np,"This tokenizer inherits from "),Cr=a(np,"A",{href:!0});var U1=s(Cr);em=i(U1,"PreTrainedTokenizerFast"),U1.forEach(t),tm=i(np,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),np.forEach(t),om=l(_e),Do=a(_e,"DIV",{class:!0});var ap=s(Do);f(Yn.$$.fragment,ap),nm=l(ap),ad=a(ap,"P",{});var R1=s(ad);am=i(R1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),R1.forEach(t),ap.forEach(t),_e.forEach(t),_c=l(o),oo=a(o,"H2",{class:!0});var sp=s(oo);Go=a(sp,"A",{id:!0,class:!0,href:!0});var H1=s(Go);sd=a(H1,"SPAN",{});var Q1=s(sd);f(ea.$$.fragment,Q1),Q1.forEach(t),H1.forEach(t),sm=l(sp),rd=a(sp,"SPAN",{});var V1=s(rd);rm=i(V1,"BartModel"),V1.forEach(t),sp.forEach(t),gc=l(o),Xe=a(o,"DIV",{class:!0});var gn=s(Xe);f(ta.$$.fragment,gn),im=l(gn),oa=a(gn,"P",{});var rp=s(oa);dm=i(rp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Mr=a(rp,"A",{href:!0});var J1=s(Mr);lm=i(J1,"PreTrainedModel"),J1.forEach(t),cm=i(rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rp.forEach(t),pm=l(gn),na=a(gn,"P",{});var ip=s(na);hm=i(ip,"This model is also a PyTorch "),aa=a(ip,"A",{href:!0,rel:!0});var X1=s(aa);um=i(X1,"torch.nn.Module"),X1.forEach(t),mm=i(ip,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),fm=l(gn),Pe=a(gn,"DIV",{class:!0});var Ct=s(Pe);f(sa.$$.fragment,Ct),_m=l(Ct),no=a(Ct,"P",{});var ai=s(no);gm=i(ai,"The "),Er=a(ai,"A",{href:!0});var K1=s(Er);km=i(K1,"BartModel"),K1.forEach(t),bm=i(ai," forward method, overrides the "),id=a(ai,"CODE",{});var Z1=s(id);ym=i(Z1,"__call__"),Z1.forEach(t),vm=i(ai," special method."),ai.forEach(t),Tm=l(Ct),f(Wo.$$.fragment,Ct),wm=l(Ct),dd=a(Ct,"P",{});var Y1=s(dd);xm=i(Y1,"Example:"),Y1.forEach(t),Fm=l(Ct),f(ra.$$.fragment,Ct),Ct.forEach(t),gn.forEach(t),kc=l(o),ao=a(o,"H2",{class:!0});var dp=s(ao);Uo=a(dp,"A",{id:!0,class:!0,href:!0});var ev=s(Uo);ld=a(ev,"SPAN",{});var tv=s(ld);f(ia.$$.fragment,tv),tv.forEach(t),ev.forEach(t),zm=l(dp),cd=a(dp,"SPAN",{});var ov=s(cd);qm=i(ov,"BartForConditionalGeneration"),ov.forEach(t),dp.forEach(t),bc=l(o),Ke=a(o,"DIV",{class:!0});var kn=s(Ke);f(da.$$.fragment,kn),$m=l(kn),la=a(kn,"P",{});var lp=s(la);Bm=i(lp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Pr=a(lp,"A",{href:!0});var nv=s(Pr);jm=i(nv,"PreTrainedModel"),nv.forEach(t),Cm=i(lp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lp.forEach(t),Mm=l(kn),ca=a(kn,"P",{});var cp=s(ca);Em=i(cp,"This model is also a PyTorch "),pa=a(cp,"A",{href:!0,rel:!0});var av=s(pa);Pm=i(av,"torch.nn.Module"),av.forEach(t),Am=i(cp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),Sm=l(kn),Y=a(kn,"DIV",{class:!0});var Le=s(Y);f(ha.$$.fragment,Le),Om=l(Le),so=a(Le,"P",{});var si=s(so);Im=i(si,"The "),Ar=a(si,"A",{href:!0});var sv=s(Ar);Nm=i(sv,"BartForConditionalGeneration"),sv.forEach(t),Lm=i(si," forward method, overrides the "),pd=a(si,"CODE",{});var rv=s(pd);Dm=i(rv,"__call__"),rv.forEach(t),Gm=i(si," special method."),si.forEach(t),Wm=l(Le),f(Ro.$$.fragment,Le),Um=l(Le),hd=a(Le,"P",{});var iv=s(hd);Rm=i(iv,"Summarization example:"),iv.forEach(t),Hm=l(Le),f(ua.$$.fragment,Le),Qm=l(Le),ud=a(Le,"P",{});var dv=s(ud);Vm=i(dv,"Mask filling example:"),dv.forEach(t),Jm=l(Le),f(ma.$$.fragment,Le),Le.forEach(t),kn.forEach(t),yc=l(o),ro=a(o,"H2",{class:!0});var pp=s(ro);Ho=a(pp,"A",{id:!0,class:!0,href:!0});var lv=s(Ho);md=a(lv,"SPAN",{});var cv=s(md);f(fa.$$.fragment,cv),cv.forEach(t),lv.forEach(t),Xm=l(pp),fd=a(pp,"SPAN",{});var pv=s(fd);Km=i(pv,"BartForSequenceClassification"),pv.forEach(t),pp.forEach(t),vc=l(o),ze=a(o,"DIV",{class:!0});var Mt=s(ze);f(_a.$$.fragment,Mt),Zm=l(Mt),_d=a(Mt,"P",{});var hv=s(_d);Ym=i(hv,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),hv.forEach(t),ef=l(Mt),ga=a(Mt,"P",{});var hp=s(ga);tf=i(hp,"This model inherits from "),Sr=a(hp,"A",{href:!0});var uv=s(Sr);of=i(uv,"PreTrainedModel"),uv.forEach(t),nf=i(hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp.forEach(t),af=l(Mt),ka=a(Mt,"P",{});var up=s(ka);sf=i(up,"This model is also a PyTorch "),ba=a(up,"A",{href:!0,rel:!0});var mv=s(ba);rf=i(mv,"torch.nn.Module"),mv.forEach(t),df=i(up,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),lf=l(Mt),D=a(Mt,"DIV",{class:!0});var oe=s(D);f(ya.$$.fragment,oe),cf=l(oe),io=a(oe,"P",{});var ri=s(io);pf=i(ri,"The "),Or=a(ri,"A",{href:!0});var fv=s(Or);hf=i(fv,"BartForSequenceClassification"),fv.forEach(t),uf=i(ri," forward method, overrides the "),gd=a(ri,"CODE",{});var _v=s(gd);mf=i(_v,"__call__"),_v.forEach(t),ff=i(ri," special method."),ri.forEach(t),_f=l(oe),f(Qo.$$.fragment,oe),gf=l(oe),kd=a(oe,"P",{});var gv=s(kd);kf=i(gv,"Example of single-label classification:"),gv.forEach(t),bf=l(oe),f(va.$$.fragment,oe),yf=l(oe),f(Ta.$$.fragment,oe),vf=l(oe),bd=a(oe,"P",{});var kv=s(bd);Tf=i(kv,"Example of multi-label classification:"),kv.forEach(t),wf=l(oe),f(wa.$$.fragment,oe),xf=l(oe),f(xa.$$.fragment,oe),oe.forEach(t),Mt.forEach(t),Tc=l(o),lo=a(o,"H2",{class:!0});var mp=s(lo);Vo=a(mp,"A",{id:!0,class:!0,href:!0});var bv=s(Vo);yd=a(bv,"SPAN",{});var yv=s(yd);f(Fa.$$.fragment,yv),yv.forEach(t),bv.forEach(t),Ff=l(mp),vd=a(mp,"SPAN",{});var vv=s(vd);zf=i(vv,"BartForQuestionAnswering"),vv.forEach(t),mp.forEach(t),wc=l(o),qe=a(o,"DIV",{class:!0});var Et=s(qe);f(za.$$.fragment,Et),qf=l(Et),co=a(Et,"P",{});var ii=s(co);$f=i(ii,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Td=a(ii,"CODE",{});var Tv=s(Td);Bf=i(Tv,"span start logits"),Tv.forEach(t),jf=i(ii," and "),wd=a(ii,"CODE",{});var wv=s(wd);Cf=i(wv,"span end logits"),wv.forEach(t),Mf=i(ii,")."),ii.forEach(t),Ef=l(Et),qa=a(Et,"P",{});var fp=s(qa);Pf=i(fp,"This model inherits from "),Ir=a(fp,"A",{href:!0});var xv=s(Ir);Af=i(xv,"PreTrainedModel"),xv.forEach(t),Sf=i(fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),Of=l(Et),$a=a(Et,"P",{});var _p=s($a);If=i(_p,"This model is also a PyTorch "),Ba=a(_p,"A",{href:!0,rel:!0});var Fv=s(Ba);Nf=i(Fv,"torch.nn.Module"),Fv.forEach(t),Lf=i(_p,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p.forEach(t),Df=l(Et),fe=a(Et,"DIV",{class:!0});var et=s(fe);f(ja.$$.fragment,et),Gf=l(et),po=a(et,"P",{});var di=s(po);Wf=i(di,"The "),Nr=a(di,"A",{href:!0});var zv=s(Nr);Uf=i(zv,"BartForQuestionAnswering"),zv.forEach(t),Rf=i(di," forward method, overrides the "),xd=a(di,"CODE",{});var qv=s(xd);Hf=i(qv,"__call__"),qv.forEach(t),Qf=i(di," special method."),di.forEach(t),Vf=l(et),f(Jo.$$.fragment,et),Jf=l(et),Fd=a(et,"P",{});var $v=s(Fd);Xf=i($v,"Example:"),$v.forEach(t),Kf=l(et),f(Ca.$$.fragment,et),Zf=l(et),f(Ma.$$.fragment,et),et.forEach(t),Et.forEach(t),xc=l(o),ho=a(o,"H2",{class:!0});var gp=s(ho);Xo=a(gp,"A",{id:!0,class:!0,href:!0});var Bv=s(Xo);zd=a(Bv,"SPAN",{});var jv=s(zd);f(Ea.$$.fragment,jv),jv.forEach(t),Bv.forEach(t),Yf=l(gp),qd=a(gp,"SPAN",{});var Cv=s(qd);e_=i(Cv,"BartForCausalLM"),Cv.forEach(t),gp.forEach(t),Fc=l(o),uo=a(o,"DIV",{class:!0});var kp=s(uo);f(Pa.$$.fragment,kp),t_=l(kp),yt=a(kp,"DIV",{class:!0});var li=s(yt);f(Aa.$$.fragment,li),o_=l(li),$d=a(li,"P",{});var Mv=s($d);n_=i(Mv,"Example:"),Mv.forEach(t),a_=l(li),f(Sa.$$.fragment,li),li.forEach(t),kp.forEach(t),zc=l(o),mo=a(o,"H2",{class:!0});var bp=s(mo);Ko=a(bp,"A",{id:!0,class:!0,href:!0});var Ev=s(Ko);Bd=a(Ev,"SPAN",{});var Pv=s(Bd);f(Oa.$$.fragment,Pv),Pv.forEach(t),Ev.forEach(t),s_=l(bp),jd=a(bp,"SPAN",{});var Av=s(jd);r_=i(Av,"TFBartModel"),Av.forEach(t),bp.forEach(t),qc=l(o),$e=a(o,"DIV",{class:!0});var Pt=s($e);f(Ia.$$.fragment,Pt),i_=l(Pt),Na=a(Pt,"P",{});var yp=s(Na);d_=i(yp,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Lr=a(yp,"A",{href:!0});var Sv=s(Lr);l_=i(Sv,"TFPreTrainedModel"),Sv.forEach(t),c_=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),p_=l(Pt),La=a(Pt,"P",{});var vp=s(La);h_=i(vp,"This model is also a "),Da=a(vp,"A",{href:!0,rel:!0});var Ov=s(Da);u_=i(Ov,"tf.keras.Model"),Ov.forEach(t),m_=i(vp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),f_=l(Pt),f(Zo.$$.fragment,Pt),__=l(Pt),Ae=a(Pt,"DIV",{class:!0});var At=s(Ae);f(Ga.$$.fragment,At),g_=l(At),fo=a(At,"P",{});var ci=s(fo);k_=i(ci,"The "),Dr=a(ci,"A",{href:!0});var Iv=s(Dr);b_=i(Iv,"TFBartModel"),Iv.forEach(t),y_=i(ci," forward method, overrides the "),Cd=a(ci,"CODE",{});var Nv=s(Cd);v_=i(Nv,"__call__"),Nv.forEach(t),T_=i(ci," special method."),ci.forEach(t),w_=l(At),f(Yo.$$.fragment,At),x_=l(At),Md=a(At,"P",{});var Lv=s(Md);F_=i(Lv,"Example:"),Lv.forEach(t),z_=l(At),f(Wa.$$.fragment,At),At.forEach(t),Pt.forEach(t),$c=l(o),_o=a(o,"H2",{class:!0});var Tp=s(_o);en=a(Tp,"A",{id:!0,class:!0,href:!0});var Dv=s(en);Ed=a(Dv,"SPAN",{});var Gv=s(Ed);f(Ua.$$.fragment,Gv),Gv.forEach(t),Dv.forEach(t),q_=l(Tp),Pd=a(Tp,"SPAN",{});var Wv=s(Pd);$_=i(Wv,"TFBartForConditionalGeneration"),Wv.forEach(t),Tp.forEach(t),Bc=l(o),Be=a(o,"DIV",{class:!0});var St=s(Be);f(Ra.$$.fragment,St),B_=l(St),Ha=a(St,"P",{});var wp=s(Ha);j_=i(wp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(wp,"A",{href:!0});var Uv=s(Gr);C_=i(Uv,"TFPreTrainedModel"),Uv.forEach(t),M_=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp.forEach(t),E_=l(St),Qa=a(St,"P",{});var xp=s(Qa);P_=i(xp,"This model is also a "),Va=a(xp,"A",{href:!0,rel:!0});var Rv=s(Va);A_=i(Rv,"tf.keras.Model"),Rv.forEach(t),S_=i(xp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xp.forEach(t),O_=l(St),f(tn.$$.fragment,St),I_=l(St),ee=a(St,"DIV",{class:!0});var De=s(ee);f(Ja.$$.fragment,De),N_=l(De),go=a(De,"P",{});var pi=s(go);L_=i(pi,"The "),Wr=a(pi,"A",{href:!0});var Hv=s(Wr);D_=i(Hv,"TFBartForConditionalGeneration"),Hv.forEach(t),G_=i(pi," forward method, overrides the "),Ad=a(pi,"CODE",{});var Qv=s(Ad);W_=i(Qv,"__call__"),Qv.forEach(t),U_=i(pi," special method."),pi.forEach(t),R_=l(De),f(on.$$.fragment,De),H_=l(De),Sd=a(De,"P",{});var Vv=s(Sd);Q_=i(Vv,"Summarization example:"),Vv.forEach(t),V_=l(De),f(Xa.$$.fragment,De),J_=l(De),Od=a(De,"P",{});var Jv=s(Od);X_=i(Jv,"Mask filling example:"),Jv.forEach(t),K_=l(De),f(Ka.$$.fragment,De),De.forEach(t),St.forEach(t),jc=l(o),ko=a(o,"H2",{class:!0});var Fp=s(ko);nn=a(Fp,"A",{id:!0,class:!0,href:!0});var Xv=s(nn);Id=a(Xv,"SPAN",{});var Kv=s(Id);f(Za.$$.fragment,Kv),Kv.forEach(t),Xv.forEach(t),Z_=l(Fp),Nd=a(Fp,"SPAN",{});var Zv=s(Nd);Y_=i(Zv,"FlaxBartModel"),Zv.forEach(t),Fp.forEach(t),Cc=l(o),U=a(o,"DIV",{class:!0});var ge=s(U);f(Ya.$$.fragment,ge),eg=l(ge),es=a(ge,"P",{});var zp=s(es);tg=i(zp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Ur=a(zp,"A",{href:!0});var Yv=s(Ur);og=i(Yv,"FlaxPreTrainedModel"),Yv.forEach(t),ng=i(zp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
