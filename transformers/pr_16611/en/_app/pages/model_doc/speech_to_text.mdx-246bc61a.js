...
first positional argument :`),ye=c(),C=a("ul"),j=a("li"),Ce=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),je=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Me=c(),O=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),at.forEach(t),ye=l(f),C=r(f,"UL",{});var G=i(C);j=r(G,"LI",{});var ce=i(j);Ce=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var rt=i(oe);ne=s(rt,"input_ids"),rt.forEach(t),je=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Re=i(se);ae=s(Re,"model(input_ids)"),Re.forEach(t),ce.forEach(t),Me=l(G),O=r(G,"LI",{});var P=i(O);Ee=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(P,"CODE",{});var it=i(L);Ae=s(it,"model([input_ids, attention_mask])"),it.forEach(t),re=s(P," or "),ie=r(P,"CODE",{});var ze=i(ie);Ie=s(ze,"model([input_ids, attention_mask, token_type_ids])"),ze.forEach(t),P.forEach(t),de=l(G),K=r(G,"LI",{});var Le=i(K);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(f,F){h(f,p,F),e(p,z),h(f,m,F),h(f,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),h(f,q,F),h(f,E,F),e(E,N),e(E,V),e(V,ee),e(E,Fe),e(E,B),e(B,Pe),e(E,$e),h(f,M,F),h(f,J,F),e(J,te),h(f,ye,F),h(f,C,F),e(C,j),e(j,Ce),e(j,oe),e(oe,ne),e(j,je),e(j,se),e(se,ae),e(C,Me),e(C,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(C,de),e(C,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(p),f&&t(m),f&&t(g),f&&t(q),f&&t(E),f&&t(M),f&&t(J),f&&t(ye),f&&t(C)}}}function bh(R){let p,z,m,g,S;return{c(){p=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=r(_,"P",{});var w=i(p);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(w,"CODE",{});var $=i(m);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){h(_,p,w),e(p,z),e(p,m),e(m,g),e(p,S)},d(_){_&&t(p)}}}function yh(R){let p,z,m,g,S,_,w,$,A,q,E,N,V,ee,Fe,B,Pe,$e,M,J,te,ye,C,j,Ce,oe,ne,je,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){p=a("p"),z=n("TF 2.0 models accepts two formats as inputs:"),m=c(),g=a("ul"),S=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),q=c(),E=a("p"),N=n("This second option is useful when using "),V=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),Pe=n("model(inputs)"),$e=n("."),M=c(),J=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ye=c(),C=a("ul"),j=a("li"),Ce=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),je=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Me=c(),O=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),Ie=n("model([input_ids, attention_mask, token_type_ids])"),de=c(),K=a("li"),De=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){p=r(f,"P",{});var F=i(p);z=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),m=l(f),g=r(f,"UL",{});var X=i(g);S=r(X,"LI",{});var st=i(S);_=s(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(X),$=r(X,"LI",{});var Ne=i($);A=s(Ne,"having all inputs as a list, tuple or dict in the first positional arguments."),Ne.forEach(t),X.forEach(t),q=l(f),E=r(f,"P",{});var Q=i(E);N=s(Q,"This second option is useful when using "),V=r(Q,"CODE",{});var Ue=i(V);ee=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Fe=s(Q,` method which currently requires having all the
...
first positional argument :`),at.forEach(t),ye=l(f),C=r(f,"UL",{});var G=i(C);j=r(G,"LI",{});var ce=i(j);Ce=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var rt=i(oe);ne=s(rt,"input_ids"),rt.forEach(t),je=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Re=i(se);ae=s(Re,"model(input_ids)"),Re.forEach(t),ce.forEach(t),Me=l(G),O=r(G,"LI",{});var P=i(O);Ee=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(P,"CODE",{});var it=i(L);Ae=s(it,"model([input_ids, attention_mask])"),it.forEach(t),re=s(P," or "),ie=r(P,"CODE",{});var ze=i(ie);Ie=s(ze,"model([input_ids, attention_mask, token_type_ids])"),ze.forEach(t),P.forEach(t),de=l(G),K=r(G,"LI",{});var Le=i(K);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(f,F){h(f,p,F),e(p,z),h(f,m,F),h(f,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),h(f,q,F),h(f,E,F),e(E,N),e(E,V),e(V,ee),e(E,Fe),e(E,B),e(B,Pe),e(E,$e),h(f,M,F),h(f,J,F),e(J,te),h(f,ye,F),h(f,C,F),e(C,j),e(j,Ce),e(j,oe),e(oe,ne),e(j,je),e(j,se),e(se,ae),e(C,Me),e(C,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(C,de),e(C,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(p),f&&t(m),f&&t(g),f&&t(q),f&&t(E),f&&t(M),f&&t(J),f&&t(ye),f&&t(C)}}}function wh(R){let p,z,m,g,S;return{c(){p=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=r(_,"P",{});var w=i(p);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(w,"CODE",{});var $=i(m);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){h(_,p,w),e(p,z),e(p,m),e(m,g),e(p,S)},d(_){_&&t(p)}}}function Sh(R){let p,z,m,g,S,_,w,$,A,q,E,N,V,ee,Fe,B,Pe,$e,M,J,te,ye,C,j,Ce,oe,ne,je,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,f,F,X,st,Ne,Q,Ue,_e,at,G,ce,rt,Re,P,it,ze,Le,dt,pn,tr,or,hn,nr,sr,un,ar,rr,Zs,W,ir,Yn,dr,cr,Xn,lr,pr,Qn,hr,ur,Zn,fr,mr,es,_r,gr,Xt,Tr,vr,ts,xr,ea,fn,os,kr,ta,Qt,oa,mn,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,zr,rs,qr,Fr,is,Pr,Cr,ds,jr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,pe,no,Or,lt,Gr,_n,Wr,Ur,so,Rr,Hr,Vr,pt,Br,gn,Jr,Kr,Tn,Yr,Xr,Qr,ps,Zr,ei,ao,ia,ht,St,hs,ro,ti,us,oi,da,U,io,ni,fs,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,ms,pi,hi,Et,po,ui,ho,fi,_s,mi,_i,gi,He,uo,Ti,xn,vi,kn,xi,ki,gs,bi,yi,bn,fo,ca,ut,zt,Ts,mo,wi,vs,Si,la,he,_o,$i,xs,Ei,zi,go,qi,yn,Fi,Pi,Ci,ks,ji,Mi,qt,To,Ai,bs,Ii,pa,ft,Ft,ys,vo,Di,ws,Ni,ha,I,xo,Li,Ss,Oi,Gi,ge,wn,Wi,Ui,Sn,Ri,Hi,$n,Vi,Bi,ko,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,Pt,bo,ed,Oe,td,yo,Es,od,nd,sd,zn,ad,rd,wo,zs,id,dd,cd,ld,Ve,So,pd,qs,hd,ud,Ct,fd,Be,$o,md,Eo,_d,qn,gd,Td,vd,jt,xd,Mt,zo,kd,qo,bd,Fn,yd,wd,Sd,At,Fo,$d,Po,Ed,Pn,zd,qd,Fd,It,Co,Pd,Fs,Cd,ua,mt,Dt,Ps,jo,jd,Cs,Md,fa,we,Mo,Ad,Ao,Id,Cn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Ud,Te,No,Rd,_t,Hd,jn,Vd,Bd,js,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,ma,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Uo,ic,Ro,dc,cc,lc,ve,Ho,pc,Tt,hc,An,uc,fc,Ds,mc,_c,gc,Ot,Tc,Ns,vc,xc,Vo,ga,vt,Gt,Ls,Bo,kc,Os,bc,Ta,ue,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,zc,Xo,qc,Fc,Pc,Wt,Cc,xe,Qo,jc,xt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Ut,Oc,Ws,Gc,Wc,Zo,va,kt,Rt,Us,en,Uc,Rs,Rc,xa,fe,tn,Hc,on,Vc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Ht,el,ke,an,tl,bt,ol,Ln,nl,sl,Hs,al,rl,il,Vt,dl,Vs,cl,ll,rn,ka;return _=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
avoid subtle bugs.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Speech2TextFeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16611/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
...
<a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),No=new D({props:{name:"forward",anchor:"transformers.Speech2TextModel.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1138",parametersDescription:[{anchor:"transformers.Speech2TextModel.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
...
<p>Indices can be obtained using <code>SpeechToTextTokenizer</code>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16611/en/model_doc/speech_to_text#transformers.Speech2TextConfig"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16611/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ho=new D({props:{name:"forward",anchor:"transformers.Speech2TextForConditionalGeneration.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16611/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1284",parametersDescription:[{anchor:"transformers.Speech2TextForConditionalGeneration.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a <code>numpy.ndarray</code>, <em>e.g.</em>
via the soundfile library (<code>pip install soundfile</code>). To prepare the array into <code>input_features</code>, the
<a href="/docs/transformers/pr_16611/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16611/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a>. See <a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16611/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
generated token, pass the `),rs=a("code"),qr=n("forced_bos_token_id"),Fr=n(" parameter to the "),is=a("code"),Pr=n("generate()"),Cr=n(` method. The following
...
should refer to this superclass for more information regarding those methods.`),Ci=c(),ks=a("p"),ji=n(`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
...
information.`),ld=c(),Ve=a("div"),T(So.$$.fragment),pd=c(),qs=a("p"),hd=n("Instantiate a processor associated with a pretrained model."),ud=c(),T(Ct.$$.fragment),fd=c(),Be=a("div"),T($o.$$.fragment),md=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),qn=a("a"),gd=n("from_pretrained()"),Td=n(" method."),vd=c(),T(jt.$$.fragment),xd=c(),Mt=a("div"),T(zo.$$.fragment),kd=c(),qo=a("p"),bd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=a("a"),yd=n("batch_decode()"),wd=n(`. Please
...
to the docstring of this method for more information.`),Fd=c(),It=a("div"),T(Co.$$.fragment),Pd=c(),Fs=a("p"),Cd=n(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),ua=c(),mt=a("h2"),Dt=a("a"),Ps=a("span"),T(jo.$$.fragment),jd=c(),Cs=a("span"),Md=n("Speech2TextModel"),fa=c(),we=a("div"),T(Mo.$$.fragment),Ad=c(),Ao=a("p"),Id=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Ud=c(),Te=a("div"),T(No.$$.fragment),Rd=c(),_t=a("p"),Hd=n("The "),jn=a("a"),Vd=n("Speech2TextModel"),Bd=n(" forward method, overrides the "),js=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),T(Nt.$$.fragment),Xd=c(),Ms=a("p"),Qd=n("Example:"),Zd=c(),T(Lo.$$.fragment),ma=c(),gt=a("h2"),Lt=a("a"),As=a("span"),T(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),T(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
the target language id is forced as the first generated token. To force the target language id as the first
generated token, pass the `),rs=r(qe,"CODE",{});var Wl=i(rs);qr=s(Wl,"forced_bos_token_id"),Wl.forEach(t),Fr=s(qe," parameter to the "),is=r(qe,"CODE",{});var Ul=i(is);Pr=s(Ul,"generate()"),Ul.forEach(t),Cr=s(qe,` method. The following
example shows how to transate English speech to French text using the `),ds=r(qe,"EM",{});var Rl=i(ds);jr=s(Rl,"facebook/s2t-medium-mustc-multilingual-st"),Rl.forEach(t),Mr=s(qe,`
...
special tokens using the tokenizer `),_s=r(Pa,"CODE",{});var rp=i(_s);mi=s(rp,"prepare_for_model"),rp.forEach(t),_i=s(Pa," method."),Pa.forEach(t),Fa.forEach(t),gi=l(be),He=r(be,"DIV",{class:!0});var Un=i(He);v(uo.$$.fragment,Un),Ti=l(Un),xn=r(Un,"P",{});var pl=i(xn);vi=s(pl,"Create the token type IDs corresponding to the sequences passed. "),kn=r(pl,"A",{href:!0});var ip=i(kn);xi=s(ip,`What are token type
IDs?`),ip.forEach(t),pl.forEach(t),ki=l(Un),gs=r(Un,"P",{});var dp=i(gs);bi=s(dp,"Should be overridden in a subclass if the model has a special way of building those."),dp.forEach(t),Un.forEach(t),yi=l(be),bn=r(be,"DIV",{class:!0});var cp=i(bn);v(fo.$$.fragment,cp),cp.forEach(t),be.forEach(t),ca=l(o),ut=r(o,"H2",{class:!0});var Ca=i(ut);zt=r(Ca,"A",{id:!0,class:!0,href:!0});var lp=i(zt);Ts=r(lp,"SPAN",{});var pp=i(Ts);v(mo.$$.fragment,pp),pp.forEach(t),lp.forEach(t),wi=l(Ca),vs=r(Ca,"SPAN",{});var hp=i(vs);Si=s(hp,"Speech2TextFeatureExtractor"),hp.forEach(t),Ca.forEach(t),la=l(o),he=r(o,"DIV",{class:!0});var Xe=i(he);v(_o.$$.fragment,Xe),$i=l(Xe),xs=r(Xe,"P",{});var up=i(xs);Ei=s(up,"Constructs a Speech2Text feature extractor."),up.forEach(t),zi=l(Xe),go=r(Xe,"P",{});var ja=i(go);qi=s(ja,"This feature extractor inherits from "),yn=r(ja,"A",{href:!0});var fp=i(yn);Fi=s(fp,"Speech2TextFeatureExtractor"),fp.forEach(t),Pi=s(ja,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ja.forEach(t),Ci=l(Xe),ks=r(Xe,"P",{});var mp=i(ks);ji=s(mp,`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
...
information.`),Ge.forEach(t),Zi=l(H),Pt=r(H,"DIV",{class:!0});var Ia=i(Pt);v(bo.$$.fragment,Ia),ed=l(Ia),Oe=r(Ia,"P",{});var Bt=i(Oe);td=s(Bt,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),Bt.forEach(t),Ia.forEach(t),ld=l(H),Ve=r(H,"DIV",{class:!0});var Rn=i(Ve);v(So.$$.fragment,Rn),pd=l(Rn),qs=r(Rn,"P",{});var qp=i(qs);hd=s(qp,"Instantiate a processor associated with a pretrained model."),qp.forEach(t),ud=l(Rn),v(Ct.$$.fragment,Rn),Rn.forEach(t),fd=l(H),Be=r(H,"DIV",{class:!0});var Hn=i(Be);v($o.$$.fragment,Hn),md=l(Hn),Eo=r(Hn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),qn=r(Da,"A",{href:!0});var Fp=i(qn);gd=s(Fp,"from_pretrained()"),Fp.forEach(t),Td=s(Da," method."),Da.forEach(t),vd=l(Hn),v(jt.$$.fragment,Hn),Hn.forEach(t),xd=l(H),Mt=r(H,"DIV",{class:!0});var Na=i(Mt);v(zo.$$.fragment,Na),kd=l(Na),qo=r(Na,"P",{});var La=i(qo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var Pp=i(Fn);yd=s(Pp,"batch_decode()"),Pp.forEach(t),wd=s(La,`. Please
refer to the docstring of this method for more information.`),La.forEach(t),Na.forEach(t),Sd=l(H),At=r(H,"DIV",{class:!0});var Oa=i(At);v(Fo.$$.fragment,Oa),$d=l(Oa),Po=r(Oa,"P",{});var Ga=i(Po);Ed=s(Ga,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Pn=r(Ga,"A",{href:!0});var Cp=i(Pn);zd=s(Cp,"decode()"),Cp.forEach(t),qd=s(Ga,`. Please refer
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(H),It=r(H,"DIV",{class:!0});var Wa=i(It);v(Co.$$.fragment,Wa),Pd=l(Wa),Fs=r(Wa,"P",{});var jp=i(Fs);Cd=s(jp,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),jp.forEach(t),Wa.forEach(t),H.forEach(t),ua=l(o),mt=r(o,"H2",{class:!0});var Ua=i(mt);Dt=r(Ua,"A",{id:!0,class:!0,href:!0});var Mp=i(Dt);Ps=r(Mp,"SPAN",{});var Ap=i(Ps);v(jo.$$.fragment,Ap),Ap.forEach(t),Mp.forEach(t),jd=l(Ua),Cs=r(Ua,"SPAN",{});var Ip=i(Cs);Md=s(Ip,"Speech2TextModel"),Ip.forEach(t),Ua.forEach(t),fa=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);v(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ra=i(Ao);Id=s(Ra,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Cn=r(Ra,"A",{href:!0});var Dp=i(Cn);Dd=s(Dp,"PreTrainedModel"),Dp.forEach(t),Nd=s(Ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ha.forEach(t),Ud=l(Jt),Te=r(Jt,"DIV",{class:!0});var Qe=i(Te);v(No.$$.fragment,Qe),Rd=l(Qe),_t=r(Qe,"P",{});var Vn=i(_t);Hd=s(Vn,"The "),jn=r(Vn,"A",{href:!0});var Lp=i(jn);Vd=s(Lp,"Speech2TextModel"),Lp.forEach(t),Bd=s(Vn," forward method, overrides the "),js=r(Vn,"CODE",{});var Op=i(js);Jd=s(Op,"__call__"),Op.forEach(t),Kd=s(Vn," special method."),Vn.forEach(t),Yd=l(Qe),v(Nt.$$.fragment,Qe),Xd=l(Qe),Ms=r(Qe,"P",{});var Gp=i(Ms);Qd=s(Gp,"Example:"),Gp.forEach(t),Zd=l(Qe),v(Lo.$$.fragment,Qe),Qe.forEach(t),Jt.forEach(t),ma=l(o),gt=r(o,"H2",{class:!0});var Va=i(gt);Lt=r(Va,"A",{id:!0,class:!0,href:!0});var Wp=i(Lt);As=r(Wp,"SPAN",{});var Up=i(As);v(Oo.$$.fragment,Up),Up.forEach(t),Wp.forEach(t),ec=l(Va),Is=r(Va,"SPAN",{});var Rp=i(Is);tc=s(Rp,"Speech2TextForConditionalGeneration"),Rp.forEach(t),Va.forEach(t),_a=l(o),Se=r(o,"DIV",{class:!0});var Kt=i(Se);v(Go.$$.fragment,Kt),oc=l(Kt),Wo=r(Kt,"P",{});var Ba=i(Wo);nc=s(Ba,`The Speech2Text Model with a language modeling head. Can be used for summarization.
