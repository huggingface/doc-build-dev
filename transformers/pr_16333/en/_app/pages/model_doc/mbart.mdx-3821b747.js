...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16333/en/model_doc/mbart#transformers.MBartConfig"
...
adding special tokens. The special tokens depend on calling set_lang.`),Vw.forEach(t),jg=l(Ct),Da=a(Ct,"P",{});var Vh=s(Da);Eg=i(Vh,"An MBART-50 sequence has the following format, where "),Tl=a(Vh,"CODE",{});var Qw=s(Tl);Pg=i(Qw,"X"),Qw.forEach(t),Cg=i(Vh," represents the sequence:"),Vh.forEach(t),Sg=l(Ct),La=a(Ct,"UL",{});var Qh=s(La);Ga=a(Qh,"LI",{});var Jh=s(Ga);Ml=a(Jh,"CODE",{});var Jw=s(Ml);Ag=i(Jw,"input_ids"),Jw.forEach(t),Og=i(Jh," (for encoder) "),wl=a(Jh,"CODE",{});var Kw=s(wl);Ig=i(Kw,"[src_lang_code] X [eos]"),Kw.forEach(t),Jh.forEach(t),Ng=l(Qh),Wa=a(Qh,"LI",{});var Kh=s(Wa);xl=a(Kh,"CODE",{});var Zw=s(xl);Dg=i(Zw,"labels"),Zw.forEach(t),Lg=i(Kh,": (for decoder) "),zl=a(Kh,"CODE",{});var Yw=s(zl);Gg=i(Yw,"[tgt_lang_code] X [eos]"),Yw.forEach(t),Kh.forEach(t),Qh.forEach(t),Wg=l(Ct),ql=a(Ct,"P",{});var e3=s(ql);Rg=i(e3,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),e3.forEach(t),Ct.forEach(t),Ug=l(ue),Ko=a(ue,"DIV",{class:!0});var Zh=s(Ko);f(Ra.$$.fragment,Zh),Xg=l(Zh),Bl=a(Zh,"P",{});var t3=s(Bl);Hg=i(t3,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),t3.forEach(t),Zh.forEach(t),Vg=l(ue),Zo=a(ue,"DIV",{class:!0});var Yh=s(Zo);f(Ua.$$.fragment,Yh),Qg=l(Yh),Fl=a(Yh,"P",{});var o3=s(Fl);Jg=i(o3,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),o3.forEach(t),Yh.forEach(t),ue.forEach(t),Gp=l(o),po=a(o,"H2",{class:!0});var eu=s(po);Yo=a(eu,"A",{id:!0,class:!0,href:!0});var n3=s(Yo);$l=a(n3,"SPAN",{});var a3=s($l);f(Xa.$$.fragment,a3),a3.forEach(t),n3.forEach(t),Kg=l(eu),jl=a(eu,"SPAN",{});var s3=s(jl);Zg=i(s3,"MBartModel"),s3.forEach(t),eu.forEach(t),Wp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);f(Ha.$$.fragment,Bn),Yg=l(Bn),Va=a(Bn,"P",{});var tu=s(Va);ek=i(tu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),_i=a(tu,"A",{href:!0});var r3=s(_i);tk=i(r3,"PreTrainedModel"),r3.forEach(t),ok=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tu.forEach(t),nk=l(Bn),Qa=a(Bn,"P",{});var ou=s(Qa);ak=i(ou,"This model is also a PyTorch "),Ja=a(ou,"A",{href:!0,rel:!0});var i3=s(Ja);sk=i(i3,"torch.nn.Module"),i3.forEach(t),rk=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Ni=s(ho);lk=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var d3=s(gi);ck=i(d3,"MBartModel"),d3.forEach(t),pk=i(Ni," forward method, overrides the "),El=a(Ni,"CODE",{});var l3=s(El);hk=i(l3,"__call__"),l3.forEach(t),uk=i(Ni," special method."),Ni.forEach(t),mk=l(St),f(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var c3=s(Pl);_k=i(c3,"Example:"),c3.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p3=s(tn);Cl=a(p3,"SPAN",{});var h3=s(Cl);f(Ya.$$.fragment,h3),h3.forEach(t),p3.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var u3=s(Sl);bk=i(u3,"MBartForConditionalGeneration"),u3.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var Fn=s(Je);f(es.$$.fragment,Fn),yk=l(Fn),ts=a(Fn,"P",{});var au=s(ts);vk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),ki=a(au,"A",{href:!0});var m3=s(ki);Tk=i(m3,"PreTrainedModel"),m3.forEach(t),Mk=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l(Fn),os=a(Fn,"P",{});var su=s(os);xk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var f3=s(ns);zk=i(f3,"torch.nn.Module"),f3.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l(Fn),Z=a(Fn,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),Fk=l(Le),mo=a(Le,"P",{});var Di=s(mo);$k=i(Di,"The "),bi=a(Di,"A",{href:!0});var _3=s(bi);jk=i(_3,"MBartForConditionalGeneration"),_3.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var g3=s(Al);Pk=i(g3,"__call__"),g3.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(on.$$.fragment,Le),Ak=l(Le),Ol=a(Le,"P",{});var k3=s(Ol);Ok=i(k3,"Translation example:"),k3.forEach(t),Ik=l(Le),f(ss.$$.fragment,Le),Nk=l(Le),Il=a(Le,"P",{});var b3=s(Il);Dk=i(b3,"Mask filling example:"),b3.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),Fn.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var y3=s(nn);Nl=a(y3,"SPAN",{});var v3=s(Nl);f(is.$$.fragment,v3),v3.forEach(t),y3.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T3=s(Dl);Wk=i(T3,"MBartForQuestionAnswering"),T3.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var M3=s(Ll);Xk=i(M3,"span start logits"),M3.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var w3=s(Gl);Vk=i(w3,"span end logits"),w3.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(At),ls=a(At,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),yi=a(iu,"A",{href:!0});var x3=s(yi);Zk=i(x3,"PreTrainedModel"),x3.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),eb=l(At),cs=a(At,"P",{});var du=s(cs);tb=i(du,"This model is also a PyTorch "),ps=a(du,"A",{href:!0,rel:!0});var z3=s(ps);ob=i(z3,"torch.nn.Module"),z3.forEach(t),nb=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var Ot=s(Ae);f(hs.$$.fragment,Ot),sb=l(Ot),go=a(Ot,"P",{});var Gi=s(go);rb=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var q3=s(vi);ib=i(q3,"MBartForQuestionAnswering"),q3.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var B3=s(Wl);lb=i(B3,"__call__"),B3.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(Ot),f(an.$$.fragment,Ot),hb=l(Ot),Rl=a(Ot,"P",{});var F3=s(Rl);ub=i(F3,"Example:"),F3.forEach(t),mb=l(Ot),f(us.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var $3=s(sn);Ul=a($3,"SPAN",{});var j3=s(Ul);f(ms.$$.fragment,j3),j3.forEach(t),$3.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E3=s(Xl);_b=i(E3,"MBartForSequenceClassification"),E3.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var It=s(Be);f(fs.$$.fragment,It),gb=l(It),Hl=a(It,"P",{});var P3=s(Hl);kb=i(P3,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),P3.forEach(t),bb=l(It),_s=a(It,"P",{});var cu=s(_s);yb=i(cu,"This model inherits from "),Ti=a(cu,"A",{href:!0});var C3=s(Ti);vb=i(C3,"PreTrainedModel"),C3.forEach(t),Tb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(It),gs=a(It,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var S3=s(ks);xb=i(S3,"torch.nn.Module"),S3.forEach(t),zb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(It),Y=a(It,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);Fb=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var A3=s(Mi);$b=i(A3,"MBartForSequenceClassification"),A3.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var O3=s(Vl);Eb=i(O3,"__call__"),O3.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var I3=s(Ql);Ab=i(I3,"Example of single-label classification:"),I3.forEach(t),Ob=l(Ge),f(ys.$$.fragment,Ge),Ib=l(Ge),Jl=a(Ge,"P",{});var N3=s(Jl);Nb=i(N3,"Example of multi-label classification:"),N3.forEach(t),Db=l(Ge),f(vs.$$.fragment,Ge),Ge.forEach(t),It.forEach(t),Jp=l(o),yo=a(o,"H2",{class:!0});var hu=s(yo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D3=s(dn);Kl=a(D3,"SPAN",{});var L3=s(Kl);f(Ts.$$.fragment,L3),L3.forEach(t),D3.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G3=s(Zl);Gb=i(G3,"MBartForCausalLM"),G3.forEach(t),hu.forEach(t),Kp=l(o),vo=a(o,"DIV",{class:!0});var uu=s(vo);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var W3=s(Yl);Ub=i(W3,"Example:"),W3.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var R3=s(ln);ec=a(R3,"SPAN",{});var U3=s(ec);f(zs.$$.fragment,U3),U3.forEach(t),R3.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X3=s(tc);Vb=i(X3,"TFMBartModel"),X3.forEach(t),mu.forEach(t),Yp=l(o),Fe=a(o,"DIV",{class:!0});var Nt=s(Fe);f(qs.$$.fragment,Nt),Qb=l(Nt),Bs=a(Nt,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),wi=a(fu,"A",{href:!0});var H3=s(wi);Kb=i(H3,"TFPreTrainedModel"),H3.forEach(t),Zb=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Nt),Fs=a(Nt,"P",{});var _u=s(Fs);ey=i(_u,"This model is also a "),$s=a(_u,"A",{href:!0,rel:!0});var V3=s($s);ty=i(V3,"tf.keras.Model"),V3.forEach(t),oy=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),ny=l(Nt),f(cn.$$.fragment,Nt),ay=l(Nt),Oe=a(Nt,"DIV",{class:!0});var Dt=s(Oe);f(js.$$.fragment,Dt),sy=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);ry=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q3=s(xi);iy=i(Q3,"TFMBartModel"),Q3.forEach(t),dy=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J3=s(oc);ly=i(J3,"__call__"),J3.forEach(t),cy=i(Ui," special method."),Ui.forEach(t),py=l(Dt),f(pn.$$.fragment,Dt),hy=l(Dt),nc=a(Dt,"P",{});var K3=s(nc);uy=i(K3,"Example:"),K3.forEach(t),my=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z3=s(hn);ac=a(Z3,"SPAN",{});var Y3=s(ac);f(Ps.$$.fragment,Y3),Y3.forEach(t),Z3.forEach(t),fy=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_y=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),$e=a(o,"DIV",{class:!0});var Lt=s($e);f(Cs.$$.fragment,Lt),gy=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);ky=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
