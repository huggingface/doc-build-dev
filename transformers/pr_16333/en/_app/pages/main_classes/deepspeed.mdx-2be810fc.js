...
values look like, but we highly recommend using the one with multiple `),Mm=o("code"),aD=a("auto"),nD=a(" settings in it."),Xy=u(),f(Pl.$$.fragment),Qy=u(),ru=o("a"),e3=u(),Ns=o("h4"),wa=o("a"),Zm=o("span"),f(Dl.$$.fragment),oD=u(),Nm=o("span"),lD=a("ZeRO-3 Example"),s3=u(),ya=o("p"),rD=a("Here is a full ZeRO-3 auto-configuration file "),Hm=o("code"),pD=a("ds_config_zero3.json"),iD=a(":"),t3=u(),f(zl.$$.fragment),a3=u(),ba=o("p"),uD=a(`Here is a full ZeRO-3 all-enabled manually set configuration file. It is here mainly for you to see what the typical
values look like, but we highly recommend using the one with multiple `),Bm=o("code"),cD=a("auto"),hD=a(" settings in it."),n3=u(),f(Ol.$$.fragment),o3=u(),Hs=o("h3"),Ea=o("a"),Wm=o("span"),f(Tl.$$.fragment),fD=u(),Fm=o("span"),dD=a("Optimizer and Scheduler"),l3=u(),qa=o("p"),mD=a("As long as you don\u2019t enable "),Vm=o("code"),_D=a("offload_optimizer"),vD=a(` you can mix and match DeepSpeed and HuggingFace schedulers and
...
GPU implementation (except LAMB).`),i3=u(),iu=o("a"),u3=u(),Bs=o("h4"),ka=o("a"),Km=o("span"),f(Al.$$.fragment),bD=u(),Jm=o("span"),ED=a("Optimizer"),c3=u(),Qe=o("p"),qD=a(`DeepSpeed\u2019s main optimizers are Adam, AdamW, OneBitAdam, and Lamb. These have been thoroughly tested with ZeRO and are
thus recommended to be used. It, however, can import other optimizers from `),Xm=o("code"),$D=a("torch"),kD=a(". The full documentation is "),Sl=o("a"),PD=a("here"),DD=a("."),h3=u(),$=o("p"),zD=a("If you don\u2019t configure the "),Qm=o("code"),OD=a("optimizer"),TD=a(" entry in the configuration file, the "),uu=o("a"),AD=a("Trainer"),SD=a(` will
...
therefore, if you don\u2019t configure the scheduler this is scheduler that will get configured by default.`),z3=u(),O=o("p"),Kz=a("If you don\u2019t configure the "),O_=o("code"),Jz=a("scheduler"),Xz=a(" entry in the configuration file, the "),ju=o("a"),Qz=a("Trainer"),eO=a(` will use
...
instructions on how to disable this automatic conversion if for some reason you prefer not to use it.`),W3=u(),ce=o("p"),fT=a("With the \u{1F917} Trainer you can use "),t1=o("code"),dT=a("--tf32"),mT=a(" to enable it, or disable it with "),a1=o("code"),_T=a("--tf32 0"),vT=a(" or "),n1=o("code"),jT=a("--no_tf32"),gT=a(". By default the PyTorch default is used."),F3=u(),qu=o("a"),V3=u(),Vs=o("h3"),Ia=o("a"),o1=o("span"),f(Kl.$$.fragment),wT=u(),l1=o("span"),yT=a("Automatic Mixed Precision"),Y3=u(),$u=o("p"),bT=a("You can use automatic mixed precision with either a pytorch-like AMP way or the apex-like way:"),K3=u(),Ys=o("h3"),Ua=o("a"),r1=o("span"),f(Jl.$$.fragment),ET=u(),p1=o("span"),qT=a("fp16"),J3=u(),ku=o("p"),$T=a("To configure pytorch AMP-like mode with fp16 (float16) set:"),X3=u(),f(Xl.$$.fragment),Q3=u(),ls=o("p"),kT=a("and the "),Pu=o("a"),PT=a("Trainer"),DT=a(` will automatically enable or disable it based on the value of
...
configuration.`),n2=u(),La=o("p"),LT=a("Here is the "),er=o("a"),MT=a("documentation"),ZT=a("."),o2=u(),Ks=o("h3"),Ma=o("a"),h1=o("span"),f(sr.$$.fragment),NT=u(),f1=o("span"),HT=a("bf16"),l2=u(),Ou=o("p"),BT=a("If bf16 (bfloat16) is desired instead of fp16 then the following configuration section is to be used:"),r2=u(),f(tr.$$.fragment),p2=u(),Tu=o("p"),WT=a("bf16 has the same dynamic range as fp32 and thus doesn\u2019t require loss scaling."),i2=u(),ps=o("p"),FT=a("This mode gets enabled when "),d1=o("code"),VT=a("--bf16"),YT=a(" or "),m1=o("code"),KT=a("--bf16_full_eval"),JT=a(" command line args are passed."),u2=u(),Au=o("p"),XT=a("You can also enable/disable this mode explicitly:"),c2=u(),f(ar.$$.fragment),h2=u(),f(Za.$$.fragment),f2=u(),Js=o("h3"),Na=o("a"),_1=o("span"),f(nr.$$.fragment),QT=u(),v1=o("span"),eA=a("apex"),d2=u(),Su=o("p"),sA=a("To configure apex AMP-like mode set:"),m2=u(),f(or.$$.fragment),_2=u(),he=o("p"),tA=a("and the "),Cu=o("a"),aA=a("Trainer"),nA=a(" will automatically configure it based on the values of "),j1=o("code"),oA=a("args.fp16_backend"),lA=a(` and
...
configuration.`),O2=u(),Zu=o("a"),T2=u(),Qs=o("h3"),Ya=o("a"),P1=o("span"),f(cr.$$.fragment),IA=u(),D1=o("span"),UA=a("Gradient Accumulation"),A2=u(),Nu=o("p"),GA=a("To configure gradient accumulation set:"),S2=u(),f(hr.$$.fragment),C2=u(),is=o("p"),LA=a("and the "),Hu=o("a"),MA=a("Trainer"),ZA=a(" will automatically set it to the value of "),z1=o("code"),NA=a("args.gradient_accumulation_steps"),HA=a("."),x2=u(),Bu=o("p"),BA=a("You can also set the value explicitly:"),R2=u(),f(fr.$$.fragment),I2=u(),Ka=o("p"),WA=a("But then you\u2019re on your own synchronizing the "),Wu=o("a"),FA=a("Trainer"),VA=a(` command line arguments and the DeepSpeed
configuration.`),U2=u(),Fu=o("a"),G2=u(),et=o("h3"),Ja=o("a"),O1=o("span"),f(dr.$$.fragment),YA=u(),T1=o("span"),KA=a("Gradient Clipping"),L2=u(),Vu=o("p"),JA=a("To configure gradient gradient clipping set:"),M2=u(),f(mr.$$.fragment),Z2=u(),us=o("p"),XA=a("and the "),Yu=o("a"),QA=a("Trainer"),eS=a(" will automatically set it to the value of "),A1=o("code"),sS=a("args.max_grad_norm"),tS=a("."),N2=u(),Ku=o("p"),aS=a("You can also set the value explicitly:"),H2=u(),f(_r.$$.fragment),B2=u(),Xa=o("p"),nS=a("But then you\u2019re on your own synchronizing the "),Ju=o("a"),oS=a("Trainer"),lS=a(` command line arguments and the DeepSpeed
configuration.`),W2=u(),Xu=o("a"),F2=u(),st=o("h3"),Qa=o("a"),S1=o("span"),f(vr.$$.fragment),rS=u(),C1=o("span"),pS=a("Getting The Model Weights Out"),V2=u(),en=o("p"),iS=a(`As long as you continue training and resuming using DeepSpeed you don\u2019t need to worry about anything. DeepSpeed stores
...
they are only the fp16 version of the weights.`),J2=u(),T=o("p"),_S=a(`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
example will contain `),av=o("code"),hC=a("global_step1"),fC=a("."),yb=u(),rc=o("p"),dC=a("Note: currently the script requires 2x general RAM of the final fp32 model weights."),bb=u(),tt=o("h3"),pn=o("a"),nv=o("span"),f(kr.$$.fragment),mC=u(),ov=o("span"),_C=a("ZeRO-3 and Infinity Nuances"),Eb=u(),pc=o("p"),vC=a("ZeRO-3 is quite different from ZeRO-2 because of its param sharding feature."),qb=u(),ic=o("p"),jC=a("ZeRO-Infinity further extends ZeRO-3 to support NVMe memory and multiple other speed and scalability improvements."),$b=u(),uc=o("p"),gC=a(`While all the efforts were made for things to just work without needing any special changes to your models, in certain
circumstances you may find the following information to be needed.`),kb=u(),at=o("h4"),un=o("a"),lv=o("span"),f(Pr.$$.fragment),wC=u(),rv=o("span"),yC=a("Constructing Massive Models"),Pb=u(),cn=o("p"),bC=a(`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
...
they are only the fp16 version of the weights.`),Kq.forEach(t),J2=c(e),T=l(e,"P",{});var Q=r(T);_S=n(Q,`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
circumstances you may find the following information to be needed.`),xF.forEach(t),kb=c(e),at=l(e,"H4",{class:!0});var a6=r(at);un=l(a6,"A",{id:!0,class:!0,href:!0});var RF=r(un);lv=l(RF,"SPAN",{});var IF=r(lv);d(Pr.$$.fragment,IF),IF.forEach(t),RF.forEach(t),wC=c(a6),rv=l(a6,"SPAN",{});var UF=r(rv);yC=n(UF,"Constructing Massive Models"),UF.forEach(t),a6.forEach(t),Pb=c(e),cn=l(e,"P",{});var n6=r(cn);bC=n(n6,`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
