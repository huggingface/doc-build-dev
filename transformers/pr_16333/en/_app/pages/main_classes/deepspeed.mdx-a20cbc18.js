...
values look like, but we highly recommend using the one with multiple `),Mm=o("code"),aD=a("auto"),nD=a(" settings in it."),Xy=u(),f(Pl.$$.fragment),Qy=u(),ru=o("a"),e3=u(),Hs=o("h4"),wa=o("a"),Zm=o("span"),f(Dl.$$.fragment),oD=u(),Nm=o("span"),lD=a("ZeRO-3 Example"),s3=u(),ya=o("p"),rD=a("Here is a full ZeRO-3 auto-configuration file "),Hm=o("code"),pD=a("ds_config_zero3.json"),iD=a(":"),t3=u(),f(zl.$$.fragment),a3=u(),ba=o("p"),uD=a(`Here is a full ZeRO-3 all-enabled manually set configuration file. It is here mainly for you to see what the typical
values look like, but we highly recommend using the one with multiple `),Bm=o("code"),cD=a("auto"),hD=a(" settings in it."),n3=u(),f(Ol.$$.fragment),o3=u(),Bs=o("h3"),Ea=o("a"),Wm=o("span"),f(Tl.$$.fragment),fD=u(),Fm=o("span"),dD=a("Optimizer and Scheduler"),l3=u(),qa=o("p"),mD=a("As long as you don\u2019t enable "),Vm=o("code"),_D=a("offload_optimizer"),vD=a(` you can mix and match DeepSpeed and HuggingFace schedulers and
optimizers, with the exception of using the combination of HuggingFace scheduler and DeepSpeed optimizer:`),r3=u(),pu=o("p"),jD=a(`| Combos       | HF Scheduler | DS Scheduler |
| HF Optimizer | Yes          | Yes          |
| DS Optimizer | No           | Yes          |`),p3=u(),$a=o("p"),gD=a("It is possible to use a non-DeepSpeed optimizer when "),Ym=o("code"),wD=a("offload_optimizer"),yD=a(` is enabled, as long as it has both CPU and
GPU implementation (except LAMB).`),i3=u(),iu=o("a"),u3=u(),Ws=o("h4"),ka=o("a"),Km=o("span"),f(Al.$$.fragment),bD=u(),Jm=o("span"),ED=a("Optimizer"),c3=u(),Qe=o("p"),qD=a(`DeepSpeed\u2019s main optimizers are Adam, AdamW, OneBitAdam, and Lamb. These have been thoroughly tested with ZeRO and are
thus recommended to be used. It, however, can import other optimizers from `),Xm=o("code"),$D=a("torch"),kD=a(". The full documentation is "),Sl=o("a"),PD=a("here"),DD=a("."),h3=u(),k=o("p"),zD=a("If you don\u2019t configure the "),Qm=o("code"),OD=a("optimizer"),TD=a(" entry in the configuration file, the "),uu=o("a"),AD=a("Trainer"),SD=a(` will
...
arguments: `),s_=o("code"),RD=a("--learning_rate"),ID=a(", "),t_=o("code"),UD=a("--adam_beta1"),GD=a(", "),a_=o("code"),LD=a("--adam_beta2"),MD=a(", "),n_=o("code"),ZD=a("--adam_epsilon"),ND=a(" and "),o_=o("code"),HD=a("--weight_decay"),BD=a("."),f3=u(),es=o("p"),WD=a("Here is an example of the auto-configured "),l_=o("code"),FD=a("optimizer"),VD=a(" entry for "),r_=o("code"),YD=a("AdamW"),KD=a(":"),d3=u(),f(Cl.$$.fragment),m3=u(),cu=o("p"),JD=a(`Note that the command line arguments will set the values in the configuration file. This is so that there is one
definitive source of the values and to avoid hard to find errors when for example, the learning rate is set to
different values in different places. Command line rules. The values that get overridden are:`),_3=u(),pe=o("ul"),xl=o("li"),p_=o("code"),XD=a("lr"),QD=a(" with the value of "),i_=o("code"),ez=a("--learning_rate"),sz=u(),Rl=o("li"),u_=o("code"),tz=a("betas"),az=a(" with the value of "),c_=o("code"),nz=a("--adam_beta1 --adam_beta2"),oz=u(),Il=o("li"),h_=o("code"),lz=a("eps"),rz=a(" with the value of "),f_=o("code"),pz=a("--adam_epsilon"),iz=u(),Ul=o("li"),d_=o("code"),uz=a("weight_decay"),cz=a(" with the value of "),m_=o("code"),hz=a("--weight_decay"),v3=u(),hu=o("p"),fz=a("Therefore please remember to tune the shared hyperparameters on the command line."),j3=u(),fu=o("p"),dz=a("You can also set the values explicitly:"),g3=u(),f(Gl.$$.fragment),w3=u(),Pa=o("p"),mz=a("But then you\u2019re on your own synchronizing the "),du=o("a"),_z=a("Trainer"),vz=a(` command line arguments and the DeepSpeed
configuration.`),y3=u(),mu=o("p"),jz=a("If you want to use another optimizer which is not listed above, you will have to add to the top level configuration."),b3=u(),f(Ll.$$.fragment),E3=u(),ie=o("p"),gz=a("Similarly to "),__=o("code"),wz=a("AdamW"),yz=a(`, you can configure other officially supported optimizers. Just remember that may have different
config values. e.g. for Adam you will want `),v_=o("code"),bz=a("weight_decay"),Ez=a(" around "),j_=o("code"),qz=a("0.01"),$z=a("."),q3=u(),_u=o("a"),$3=u(),Fs=o("h4"),Da=o("a"),g_=o("span"),f(Ml.$$.fragment),kz=u(),w_=o("span"),Pz=a("Scheduler"),k3=u(),Z=o("p"),Dz=a("DeepSpeed supports "),y_=o("code"),zz=a("LRRangeTest"),Oz=a(", "),b_=o("code"),Tz=a("OneCycle"),Az=a(", "),E_=o("code"),Sz=a("WarmupLR"),Cz=a(" and "),q_=o("code"),xz=a("WarmupDecayLR"),Rz=a(` learning rate schedulers. The full
documentation is `),Zl=o("a"),Iz=a("here"),Uz=a("."),P3=u(),vu=o("p"),Gz=a("Here is where the schedulers overlap between \u{1F917} Transformers and DeepSpeed:"),D3=u(),za=o("ul"),Nl=o("li"),$_=o("code"),Lz=a("WarmupLR"),Mz=a(" via "),k_=o("code"),Zz=a("--lr_scheduler_type constant_with_warmup"),Nz=u(),ss=o("li"),P_=o("code"),Hz=a("WarmupDecayLR"),Bz=a(" via "),D_=o("code"),Wz=a("--lr_scheduler_type linear"),Fz=a(". This is also the default value for "),z_=o("code"),Vz=a("--lr_scheduler_type"),Yz=a(`,
therefore, if you don\u2019t configure the scheduler this is scheduler that will get configured by default.`),z3=u(),T=o("p"),Kz=a("If you don\u2019t configure the "),O_=o("code"),Jz=a("scheduler"),Xz=a(" entry in the configuration file, the "),ju=o("a"),Qz=a("Trainer"),eO=a(` will use
...
\u{1F917} Transformers version of it.`),O3=u(),ts=o("p"),iO=a("Here is an example of the auto-configured "),x_=o("code"),uO=a("scheduler"),cO=a(" entry for "),R_=o("code"),hO=a("WarmupLR"),fO=a(":"),T3=u(),f(Hl.$$.fragment),A3=u(),as=o("p"),dO=a("Since "),I_=o("em"),mO=a("\u201Cauto\u201D"),_O=a(" is used the "),gu=o("a"),vO=a("Trainer"),jO=a(` arguments will set the correct values in the configuration
file. This is so that there is one definitive source of the values and to avoid hard to find errors when, for example,
the learning rate is set to different values in different places. Command line rules. The values that get set are:`),S3=u(),ue=o("ul"),Oa=o("li"),U_=o("code"),gO=a("warmup_min_lr"),wO=a(" with the value of "),G_=o("code"),yO=a("0"),bO=a("."),EO=u(),Ta=o("li"),L_=o("code"),qO=a("warmup_max_lr"),$O=a(" with the value of "),M_=o("code"),kO=a("--learning_rate"),PO=a("."),DO=u(),ns=o("li"),Z_=o("code"),zO=a("warmup_num_steps"),OO=a(" with the value of "),N_=o("code"),TO=a("--warmup_steps"),AO=a(" if provided. Otherwise will use "),H_=o("code"),SO=a("--warmup_ratio"),CO=a(`
...
`),F_=o("code"),LO=a("WarmupDecayLR"),MO=a(")."),C3=u(),wu=o("p"),ZO=a("You can, of course, take over any or all of the configuration values and set those yourself:"),x3=u(),f(Bl.$$.fragment),R3=u(),Aa=o("p"),NO=a("But then you\u2019re on your own synchronizing the "),yu=o("a"),HO=a("Trainer"),BO=a(` command line arguments and the DeepSpeed
configuration.`),I3=u(),Sa=o("p"),WO=a("For example, for "),V_=o("code"),FO=a("WarmupDecayLR"),VO=a(", you can use the following entry:"),U3=u(),f(Wl.$$.fragment),G3=u(),J=o("p"),YO=a("and "),Y_=o("code"),KO=a("total_num_steps"),JO=a(", "),K_=o("code"),XO=a("warmup_max_lr"),QO=a(", "),J_=o("code"),eT=a("warmup_num_steps"),sT=a(" and "),X_=o("code"),tT=a("total_num_steps"),aT=a(" will be set at loading time."),L3=u(),bu=o("a"),M3=u(),Vs=o("h3"),Ca=o("a"),Q_=o("span"),f(Fl.$$.fragment),nT=u(),e1=o("span"),oT=a("fp32 Precision"),Z3=u(),Eu=o("p"),lT=a("Deepspeed supports the full fp32 and the fp16 mixed precision."),N3=u(),xa=o("p"),rT=a(`Because of the much reduced memory needs and faster speed one gets with the fp16 mixed precision, the only time you
...
the full fp32 mode, by explicitly disabling the otherwise default fp16 mixed precision mode with:`),H3=u(),f(Vl.$$.fragment),B3=u(),Ra=o("p"),uT=a(`If you\u2019re using the Ampere-architecture based GPU, pytorch version 1.7 and higher will automatically switch to using
...
instructions on how to disable this automatic conversion if for some reason you prefer not to use it.`),W3=u(),ce=o("p"),fT=a("With the \u{1F917} Trainer you can use "),t1=o("code"),dT=a("--tf32"),mT=a(" to enable it, or disable it with "),a1=o("code"),_T=a("--tf32 0"),vT=a(" or "),n1=o("code"),jT=a("--no_tf32"),gT=a(". By default the PyTorch default is used."),F3=u(),qu=o("a"),V3=u(),Ys=o("h3"),Ia=o("a"),o1=o("span"),f(Kl.$$.fragment),wT=u(),l1=o("span"),yT=a("Automatic Mixed Precision"),Y3=u(),$u=o("p"),bT=a("You can use automatic mixed precision with either a pytorch-like AMP way or the apex-like way:"),K3=u(),Ks=o("h3"),Ua=o("a"),r1=o("span"),f(Jl.$$.fragment),ET=u(),p1=o("span"),qT=a("fp16"),J3=u(),ku=o("p"),$T=a("To configure pytorch AMP-like mode with fp16 (float16) set:"),X3=u(),f(Xl.$$.fragment),Q3=u(),ls=o("p"),kT=a("and the "),Pu=o("a"),PT=a("Trainer"),DT=a(` will automatically enable or disable it based on the value of
`),i1=o("code"),zT=a("args.fp16_backend"),OT=a(". The rest of config values are up to you."),e2=u(),rs=o("p"),TT=a("This mode gets enabled when "),u1=o("code"),AT=a("--fp16 --fp16_backend amp"),ST=a(" or "),c1=o("code"),CT=a("--fp16_full_eval"),xT=a(" command line args are passed."),s2=u(),Du=o("p"),RT=a("You can also enable/disable this mode explicitly:"),t2=u(),f(Ql.$$.fragment),a2=u(),Ga=o("p"),IT=a("But then you\u2019re on your own synchronizing the "),zu=o("a"),UT=a("Trainer"),GT=a(` command line arguments and the DeepSpeed
configuration.`),n2=u(),La=o("p"),LT=a("Here is the "),er=o("a"),MT=a("documentation"),ZT=a("."),o2=u(),Js=o("h3"),Ma=o("a"),h1=o("span"),f(sr.$$.fragment),NT=u(),f1=o("span"),HT=a("bf16"),l2=u(),Ou=o("p"),BT=a("If bf16 (bfloat16) is desired instead of fp16 then the following configuration section is to be used:"),r2=u(),f(tr.$$.fragment),p2=u(),Tu=o("p"),WT=a("bf16 has the same dynamic range as fp32 and thus doesn\u2019t require loss scaling."),i2=u(),ps=o("p"),FT=a("This mode gets enabled when "),d1=o("code"),VT=a("--bf16"),YT=a(" or "),m1=o("code"),KT=a("--bf16_full_eval"),JT=a(" command line args are passed."),u2=u(),Au=o("p"),XT=a("You can also enable/disable this mode explicitly:"),c2=u(),f(ar.$$.fragment),h2=u(),f(Za.$$.fragment),f2=u(),Xs=o("h3"),Na=o("a"),_1=o("span"),f(nr.$$.fragment),QT=u(),v1=o("span"),eA=a("apex"),d2=u(),Su=o("p"),sA=a("To configure apex AMP-like mode set:"),m2=u(),f(or.$$.fragment),_2=u(),he=o("p"),tA=a("and the "),Cu=o("a"),aA=a("Trainer"),nA=a(" will automatically configure it based on the values of "),j1=o("code"),oA=a("args.fp16_backend"),lA=a(` and
`),g1=o("code"),rA=a("args.fp16_opt_level"),pA=a("."),v2=u(),Ha=o("p"),iA=a("This mode gets enabled when "),w1=o("code"),uA=a("--fp16 --fp16_backend apex --fp16_opt_level 01"),cA=a(" command line args are passed."),j2=u(),xu=o("p"),hA=a("You can also configure this mode explicitly:"),g2=u(),f(lr.$$.fragment),w2=u(),Ba=o("p"),fA=a("But then you\u2019re on your own synchronizing the "),Ru=o("a"),dA=a("Trainer"),mA=a(` command line arguments and the DeepSpeed
configuration.`),y2=u(),Wa=o("p"),_A=a("Here is the "),rr=o("a"),vA=a("documentation"),jA=a("."),b2=u(),Iu=o("a"),E2=u(),Qs=o("h3"),Fa=o("a"),y1=o("span"),f(pr.$$.fragment),gA=u(),b1=o("span"),wA=a("Batch Size"),q2=u(),Uu=o("p"),yA=a("To configure batch size, use:"),$2=u(),f(ir.$$.fragment),k2=u(),N=o("p"),bA=a("and the "),Gu=o("a"),EA=a("Trainer"),qA=a(" will automatically set "),E1=o("code"),$A=a("train_micro_batch_size_per_gpu"),kA=a(` to the value of
`),q1=o("code"),PA=a("args.per_device_train_batch_size"),DA=a(" and "),$1=o("code"),zA=a("train_batch_size"),OA=a(" to "),k1=o("code"),TA=a("args.world_size * args.per_device_train_batch_size * args.gradient_accumulation_steps"),AA=a("."),P2=u(),Lu=o("p"),SA=a("You can also set the values explicitly:"),D2=u(),f(ur.$$.fragment),z2=u(),Va=o("p"),CA=a("But then you\u2019re on your own synchronizing the "),Mu=o("a"),xA=a("Trainer"),RA=a(` command line arguments and the DeepSpeed
configuration.`),O2=u(),Zu=o("a"),T2=u(),et=o("h3"),Ya=o("a"),P1=o("span"),f(cr.$$.fragment),IA=u(),D1=o("span"),UA=a("Gradient Accumulation"),A2=u(),Nu=o("p"),GA=a("To configure gradient accumulation set:"),S2=u(),f(hr.$$.fragment),C2=u(),is=o("p"),LA=a("and the "),Hu=o("a"),MA=a("Trainer"),ZA=a(" will automatically set it to the value of "),z1=o("code"),NA=a("args.gradient_accumulation_steps"),HA=a("."),x2=u(),Bu=o("p"),BA=a("You can also set the value explicitly:"),R2=u(),f(fr.$$.fragment),I2=u(),Ka=o("p"),WA=a("But then you\u2019re on your own synchronizing the "),Wu=o("a"),FA=a("Trainer"),VA=a(` command line arguments and the DeepSpeed
configuration.`),U2=u(),Fu=o("a"),G2=u(),st=o("h3"),Ja=o("a"),O1=o("span"),f(dr.$$.fragment),YA=u(),T1=o("span"),KA=a("Gradient Clipping"),L2=u(),Vu=o("p"),JA=a("To configure gradient gradient clipping set:"),M2=u(),f(mr.$$.fragment),Z2=u(),us=o("p"),XA=a("and the "),Yu=o("a"),QA=a("Trainer"),eS=a(" will automatically set it to the value of "),A1=o("code"),sS=a("args.max_grad_norm"),tS=a("."),N2=u(),Ku=o("p"),aS=a("You can also set the value explicitly:"),H2=u(),f(_r.$$.fragment),B2=u(),Xa=o("p"),nS=a("But then you\u2019re on your own synchronizing the "),Ju=o("a"),oS=a("Trainer"),lS=a(` command line arguments and the DeepSpeed
configuration.`),W2=u(),Xu=o("a"),F2=u(),tt=o("h3"),Qa=o("a"),S1=o("span"),f(vr.$$.fragment),rS=u(),C1=o("span"),pS=a("Getting The Model Weights Out"),V2=u(),en=o("p"),iS=a(`As long as you continue training and resuming using DeepSpeed you don\u2019t need to worry about anything. DeepSpeed stores
...
pattern), and are saved under the normal checkpoint.`),Y2=u(),Qu=o("p"),R1=o("strong"),hS=a("FP16 Weights:"),K2=u(),sn=o("p"),fS=a("When a model is saved under ZeRO-2, you end up having the normal "),I1=o("code"),dS=a("pytorch_model.bin"),mS=a(` file with the model weights, but
they are only the fp16 version of the weights.`),J2=u(),A=o("p"),_S=a(`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
memory it can be done in the same training script. The following sections will discuss both approaches.`),sb=u(),sc=o("p"),B1=o("strong"),SS=a("Live FP32 Weights Recovery:"),tb=u(),tc=o("p"),CS=a("This approach may not work if you model is large and you have little free CPU memory left, at the end of the training."),ab=u(),ac=o("p"),xS=a("If you have saved at least one checkpoint, and you want to use the latest one, you can do the following:"),nb=u(),f(wr.$$.fragment),ob=u(),cs=o("p"),RS=a("If you\u2019re using the "),W1=o("code"),IS=a("--load_best_model_at_end"),US=a(" class:"),F1=o("em"),GS=a("~transformers.TrainingArguments"),LS=a(` argument (to track the best
checkpoint), then you can finish the training by first saving the final model explicitly and then do the same as above:`),lb=u(),f(yr.$$.fragment),rb=u(),f(an.$$.fragment),pb=u(),nn=o("p"),MS=a("Of course, you don\u2019t have to use class:"),V1=o("em"),ZS=a("~transformers.Trainer"),NS=a(` and you can adjust the examples above to your own
trainer.`),ib=u(),on=o("p"),HS=a("If for some reason you want more refinement, you can also extract the fp32 "),Y1=o("code"),BS=a("state_dict"),WS=a(` of the weights and apply
these yourself as is shown in the following example:`),ub=u(),f(br.$$.fragment),cb=u(),nc=o("p"),K1=o("strong"),FS=a("Offline FP32 Weights Recovery:"),hb=u(),hs=o("p"),VS=a("DeepSpeed creates a special conversion script "),J1=o("code"),YS=a("zero_to_fp32.py"),KS=a(` which it places in the top-level of the checkpoint
folder. Using this script you can extract the weights at any point. The script is standalone and you no longer need to
have the configuration file or a `),X1=o("code"),JS=a("Trainer"),XS=a(" to do the extraction."),fb=u(),oc=o("p"),QS=a("Let\u2019s say your checkpoint folder looks like this:"),db=u(),f(Er.$$.fragment),mb=u(),ln=o("p"),eC=a("In this example there is just one DeepSpeed checkpoint sub-folder "),Q1=o("em"),sC=a("global_step1"),tC=a(`. Therefore to reconstruct the fp32
weights just run:`),_b=u(),f(qr.$$.fragment),vb=u(),rn=o("p"),aC=a("This is it. "),ev=o("code"),nC=a("pytorch_model.bin"),oC=a(" will now contain the full fp32 model weights consolidated from multiple GPUs."),jb=u(),lc=o("p"),lC=a("The script will automatically be able to handle either a ZeRO-2 or ZeRO-3 checkpoint."),gb=u(),$r=o("p"),sv=o("code"),rC=a("python zero_to_fp32.py -h"),pC=a(" will give you usage details."),wb=u(),fs=o("p"),iC=a("The script will auto-discover the deepspeed sub-folder using the contents of the file "),tv=o("code"),uC=a("latest"),cC=a(`, which in the current
example will contain `),av=o("code"),hC=a("global_step1"),fC=a("."),yb=u(),rc=o("p"),dC=a("Note: currently the script requires 2x general RAM of the final fp32 model weights."),bb=u(),at=o("h3"),pn=o("a"),nv=o("span"),f(kr.$$.fragment),mC=u(),ov=o("span"),_C=a("ZeRO-3 and Infinity Nuances"),Eb=u(),pc=o("p"),vC=a("ZeRO-3 is quite different from ZeRO-2 because of its param sharding feature."),qb=u(),ic=o("p"),jC=a("ZeRO-Infinity further extends ZeRO-3 to support NVMe memory and multiple other speed and scalability improvements."),$b=u(),uc=o("p"),gC=a(`While all the efforts were made for things to just work without needing any special changes to your models, in certain
circumstances you may find the following information to be needed.`),kb=u(),nt=o("h4"),un=o("a"),lv=o("span"),f(Pr.$$.fragment),wC=u(),rv=o("span"),yC=a("Constructing Massive Models"),Pb=u(),cn=o("p"),bC=a(`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
...
context manager (which is also a function decorator), like so:`),Db=u(),f(Dr.$$.fragment),zb=u(),cc=o("p"),$C=a("As you can see this gives you a randomly initialized model."),Ob=u(),D=o("p"),kC=a("If you want to use a pretrained model, "),iv=o("code"),PC=a("model_class.from_pretrained"),DC=a(` will activate this feature as long as
...
`),fv=o("code"),GC=a("from_pretrained"),LC=a(". Here is an example of a possible sequence:"),Tb=u(),f(zr.$$.fragment),Ab=u(),hn=o("p"),MC=a("If you\u2019re using the official example scripts and your command line arguments include "),dv=o("code"),ZC=a("--deepspeed ds_config.json"),NC=a(`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),Sb=u(),dc=o("p"),HC=a("Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),Cb=u(),fn=o("p"),BC=a("For full details on this method and other related features please refer to "),Or=o("a"),WC=a("Constructing Massive Models"),FC=a("."),xb=u(),fe=o("p"),VC=a("Also when loading fp16-pretrained models, you will want to tell "),mv=o("code"),YC=a("from_pretrained"),KC=a(` to use
`),_v=o("code"),JC=a("torch_dtype=torch.float16"),XC=a(". For details, please, see "),mc=o("a"),QC=a("from_pretrained-torch-dtype"),ex=a("."),Rb=u(),ot=o("h4"),dn=o("a"),vv=o("span"),f(Tr.$$.fragment),sx=u(),jv=o("span"),tx=a("Gathering Parameters"),Ib=u(),Ar=o("p"),ax=a(`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=o("a"),nx=a("Gathering Parameters"),Ub=u(),mn=o("p"),ox=a(`We do however use it internally in several places, one such example is when loading pretrained model weights in
...
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),Zb=u(),vc=o("a"),Nb=u(),lt=o("h3"),_n=o("a"),bv=o("span"),f(xr.$$.fragment),dx=u(),Ev=o("span"),mx=a("ZeRO Inference"),Hb=u(),jc=o("p"),_x=a(`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),Bb=u(),vn=o("p"),vx=a("Otherwise you just need to pass the usual "),gc=o("a"),jx=a("TrainingArguments"),gx=a(" arguments. For example:"),Wb=u(),f(Rr.$$.fragment),Fb=u(),wc=o("p"),wx=a(`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
for the inference as only ZeRO-3 performs sharding of parameters, whereas ZeRO-1 shards gradients and optimizer states.`),Vb=u(),jn=o("p"),yx=a("Here is an example of running "),qv=o("code"),bx=a("run_translation.py"),Ex=a(" under DeepSpeed deploying all available GPUs:"),Yb=u(),f(Ir.$$.fragment),Kb=u(),yc=o("p"),qx=a(`Since for inference there is no need for additional large memory used by the optimizer states and the gradients you
...
the full fp32 mode, by explicitly disabling the otherwise default fp16 mixed precision mode with:`),Tq.forEach(t),H3=c(e),d(Vl.$$.fragment,e),B3=c(e),Ra=l(e,"P",{});var Aq=r(Ra);uT=n(Aq,`If you\u2019re using the Ampere-architecture based GPU, pytorch version 1.7 and higher will automatically switch to using
the much more efficient tf32 format for some operations, but the results will still be in fp32. For details and
...
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),o6.forEach(t),Sb=c(e),dc=l(e,"P",{});var YF=r(dc);HC=n(YF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),YF.forEach(t),Cb=c(e),fn=l(e,"P",{});var l6=r(fn);BC=n(l6,"For full details on this method and other related features please refer to "),Or=l(l6,"A",{href:!0,rel:!0});var KF=r(Or);WC=n(KF,"Constructing Massive Models"),KF.forEach(t),FC=n(l6,"."),l6.forEach(t),xb=c(e),fe=l(e,"P",{});var Jn=r(fe);VC=n(Jn,"Also when loading fp16-pretrained models, you will want to tell "),mv=l(Jn,"CODE",{});var JF=r(mv);YC=n(JF,"from_pretrained"),JF.forEach(t),KC=n(Jn,` to use
`),_v=l(Jn,"CODE",{});var XF=r(_v);JC=n(XF,"torch_dtype=torch.float16"),XF.forEach(t),XC=n(Jn,". For details, please, see "),mc=l(Jn,"A",{href:!0});var QF=r(mc);QC=n(QF,"from_pretrained-torch-dtype"),QF.forEach(t),ex=n(Jn,"."),Jn.forEach(t),Rb=c(e),ot=l(e,"H4",{class:!0});var r6=r(ot);dn=l(r6,"A",{id:!0,class:!0,href:!0});var eV=r(dn);vv=l(eV,"SPAN",{});var sV=r(vv);d(Tr.$$.fragment,sV),sV.forEach(t),eV.forEach(t),sx=c(r6),jv=l(r6,"SPAN",{});var tV=r(jv);tx=n(tV,"Gathering Parameters"),tV.forEach(t),r6.forEach(t),Ib=c(e),Ar=l(e,"P",{});var bG=r(Ar);ax=n(bG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=l(bG,"A",{href:!0,rel:!0});var aV=r(Sr);nx=n(aV,"Gathering Parameters"),aV.forEach(t),bG.forEach(t),Ub=c(e),mn=l(e,"P",{});var p6=r(mn);ox=n(p6,`We do however use it internally in several places, one such example is when loading pretrained model weights in
