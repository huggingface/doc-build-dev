import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as n,M as ma,c as a,d as o,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as y,v as fa}from"../../chunks/vendor-6b77c823.js";import{T as ca}from"../../chunks/Tip-39098574.js";import{D as Ue}from"../../chunks/Docstring-17b815d9.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as vt}from"../../chunks/IconCopyLink-7a11ce68.js";function ga(He){let u,D,m,B,j;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(w,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),j=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(T,w){p(T,u,w),e(u,D),e(u,m),e(m,B),e(u,j)},d(T){T&&o(u)}}}function _a(He){let u,D,m,B,j;return{c(){u=s("p"),D=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(w,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(o),j=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(T,w){p(T,u,w),e(u,D),e(u,m),e(m,B),e(u,j)},d(T){T&&o(u)}}}function ba(He){let u,D,m,B,j,T,w,S,Do,Kt,R,Y,kt,ie,So,yt,Mo,Qt,M,Ao,Ve,No,Lo,de,Fo,Oo,Xt,Je,Io,Yt,Ke,Tt,Ro,Zt,Qe,Wo,eo,Xe,le,Uo,Ye,Ho,Vo,to,ce,oo,Ze,he,Jo,et,Ko,Qo,no,pe,ro,tt,Xo,so,Z,A,ot,Yo,Zo,nt,en,tn,wt,on,nn,rn,Et,sn,ao,N,an,ue,dn,ln,me,cn,hn,io,W,ee,Bt,fe,pn,zt,un,lo,$,ge,mn,_e,fn,$t,gn,_n,bn,U,vn,rt,kn,yn,st,Tn,wn,En,Gt,Bn,zn,be,co,H,te,qt,ve,$n,Pt,Gn,ho,C,ke,qn,ye,Pn,Te,xn,jn,Cn,we,Dn,at,Sn,Mn,An,it,Ee,po,V,oe,xt,Be,Nn,jt,Ln,uo,f,ze,Fn,Ct,On,In,$e,Rn,dt,Wn,Un,Hn,Ge,Vn,qe,Jn,Kn,Qn,Pe,Xn,xe,Yn,Zn,er,J,tr,lt,or,nr,je,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,mr,fr,Nt,gr,_r,Lt,br,vr,kr,q,Ce,yr,K,Tr,ct,wr,Er,Ft,Br,zr,$r,ne,Gr,Ot,qr,Pr,De,mo,Q,re,It,Se,xr,Rt,jr,fo,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Ne,Nr,ht,Lr,Fr,Or,Le,Ir,Fe,Rr,Wr,Ur,P,Oe,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,go;return T=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16817/src/transformers/models/bert_generation/configuration_bert_generation.py#L20"}}),be=new Jt({props:{code:`from transformers import BertGenerationConfig, BertGenerationEncoder
...
<a href="/docs/transformers/pr_16817/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16817/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16817/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16817/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16817/src/transformers/models/bert_generation/modeling_bert_generation.py#L461",returnDescription:`
<p>A <a
...
this superclass for more information regarding those methods.`),An=l(),it=s("div"),g(Ee.$$.fragment),po=l(),V=s("h2"),oe=s("a"),xt=s("span"),g(Be.$$.fragment),Nn=l(),jt=s("span"),Ln=n("BertGenerationEncoder"),uo=l(),f=s("div"),g(ze.$$.fragment),Fn=l(),Ct=s("p"),On=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=l(),$e=s("p"),Rn=n("This model inherits from "),dt=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
Therefore, no EOS token should be added to the end of the input.`),ys.forEach(o),ko.forEach(o),ao=c(t),N=a(t,"P",{});var mt=i(N);an=r(mt,"This model was contributed by "),ue=a(mt,"A",{href:!0,rel:!0});var Ts=i(ue);dn=r(Ts,"patrickvonplaten"),Ts.forEach(o),ln=r(mt,`. The original code can be
found `),me=a(mt,"A",{href:!0,rel:!0});var ws=i(me);cn=r(ws,"here"),ws.forEach(o),hn=r(mt,"."),mt.forEach(o),io=c(t),W=a(t,"H2",{class:!0});var yo=i(W);ee=a(yo,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(fe.$$.fragment,Bs),Bs.forEach(o),Es.forEach(o),pn=c(yo),zt=a(yo,"SPAN",{});var zs=i(zt);un=r(zs,"BertGenerationConfig"),zs.forEach(o),yo.forEach(o),lo=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(ge.$$.fragment,L),mn=c(L),_e=a(L,"P",{});var To=i(_e);fn=r(To,"This is the configuration class to store the configuration of a "),$t=a(To,"CODE",{});var $s=i($t);gn=r($s,"BertGenerationPreTrainedModel"),$s.forEach(o),_n=r(To,`. It is used to
