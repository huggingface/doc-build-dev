...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
find more details in the discussion below.`),nw=u(),Zt=o("p"),W6=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F6=a("post"),V6=a("."),ow=u(),mi=o("p"),Y6=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),lw=u(),_i=o("p"),K6=a("Notes:"),rw=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J6=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=o("code"),X6=a("CUDA_VISIBLE_DEVICES"),Q6=a(` to limit
...
`),Pi=o("a"),e7=a("Trainer"),s7=a(" via "),Di=o("a"),t7=a("TrainingArguments"),a7=a(" then for the "),dd=o("code"),n7=a("deepspeed"),o7=a(` argument you can
pass a nested `),md=o("code"),l7=a("dict"),r7=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=o("a"),p7=a("TrainingArguments"),i7=a("."),Uw=u(),Oi=o("p"),u7=a("To summarize you can do:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("p"),c7=a("or:"),Mw=u(),f(Jo.$$.fragment),Zw=u(),Ai=o("a"),Nw=u(),Cs=o("h3"),sa=o("a"),_d=o("span"),f(Xo.$$.fragment),h7=u(),vd=o("span"),f7=a("Shared Configuration"),Hw=u(),f(ta.$$.fragment),Bw=u(),Me=o("p"),d7=a("Some configuration values are required by both the "),Si=o("a"),m7=a("Trainer"),_7=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),v7=a("Trainer"),j7=a(" command line arguments."),Ww=u(),aa=o("p"),g7=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),w7=a("Trainer"),y7=a(` do the majority
of configuration for you.`),Fw=u(),Ze=o("p"),b7=a("Therefore, in the rest of this guide you will find a special configuration value: "),jd=o("code"),E7=a("auto"),q7=a(`, which when set will be
...
difficult to detect ways. You have been warned.`),Vw=u(),Ii=o("p"),P7=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Yw=u(),na=o("p"),D7=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),z7=a("TrainingArguments"),O7=a(" based on that. The steps are:"),Kw=u(),oa=o("ol"),gd=o("li"),T7=a("Create or load the DeepSpeed configuration to be used as a master configuration"),A7=u(),Qo=o("li"),S7=a("Create the "),Gi=o("a"),C7=a("TrainingArguments"),x7=a(" object based on these values"),Jw=u(),le=o("p"),R7=a("Do note that some values, such as "),wd=o("code"),I7=a("scheduler.params.total_num_steps"),U7=a(` are calculated by
`),Li=o("a"),G7=a("Trainer"),L7=a(" during "),yd=o("code"),M7=a("train"),Z7=a(", but you can of course do the math yourself."),Xw=u(),Mi=o("a"),Qw=u(),xs=o("h3"),la=o("a"),bd=o("span"),f(el.$$.fragment),N7=u(),Ed=o("span"),H7=a("ZeRO"),ey=u(),sl=o("p"),tl=o("a"),B7=a("Zero Redundancy Optimizer (ZeRO)"),W7=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sy=u(),Ne=o("p"),F7=a("The "),qd=o("code"),V7=a("zero_optimization"),Y7=a(" section of the configuration file is the most important part ("),al=o("a"),K7=a("docs"),J7=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),ty=u(),ra=o("p"),X7=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q7=a("Trainer"),ek=a(` provides
...
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(ye,"A",{href:!0});var HM=r(Pi);e7=n(HM,"Trainer"),HM.forEach(t),s7=n(ye," via "),Di=l(ye,"A",{href:!0});var BM=r(Di);t7=n(BM,"TrainingArguments"),BM.forEach(t),a7=n(ye," then for the "),dd=l(ye,"CODE",{});var WM=r(dd);n7=n(WM,"deepspeed"),WM.forEach(t),o7=n(ye,` argument you can
pass a nested `),md=l(ye,"CODE",{});var FM=r(md);l7=n(FM,"dict"),FM.forEach(t),r7=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(ye,"A",{href:!0});var VM=r(zi);p7=n(VM,"TrainingArguments"),VM.forEach(t),i7=n(ye,"."),ye.forEach(t),Uw=c(e),Oi=l(e,"P",{});var YM=r(Oi);u7=n(YM,"To summarize you can do:"),YM.forEach(t),Gw=c(e),d(Ko.$$.fragment,e),Lw=c(e),Ti=l(e,"P",{});var KM=r(Ti);c7=n(KM,"or:"),KM.forEach(t),Mw=c(e),d(Jo.$$.fragment,e),Zw=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Nw=c(e),Cs=l(e,"H3",{class:!0});var GE=r(Cs);sa=l(GE,"A",{id:!0,class:!0,href:!0});var JM=r(sa);_d=l(JM,"SPAN",{});var XM=r(_d);d(Xo.$$.fragment,XM),XM.forEach(t),JM.forEach(t),h7=c(GE),vd=l(GE,"SPAN",{});var QM=r(vd);f7=n(QM,"Shared Configuration"),QM.forEach(t),GE.forEach(t),Hw=c(e),d(ta.$$.fragment,e),Bw=c(e),Me=l(e,"P",{});var vh=r(Me);d7=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var eZ=r(Si);m7=n(eZ,"Trainer"),eZ.forEach(t),_7=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var sZ=r(Ci);v7=n(sZ,"Trainer"),sZ.forEach(t),j7=n(vh," command line arguments."),vh.forEach(t),Ww=c(e),aa=l(e,"P",{});var LE=r(aa);g7=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var tZ=r(xi);w7=n(tZ,"Trainer"),tZ.forEach(t),y7=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fw=c(e),Ze=l(e,"P",{});var jh=r(Ze);b7=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),jd=l(jh,"CODE",{});var aZ=r(jd);E7=n(aZ,"auto"),aZ.forEach(t),q7=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),Ri=l(jh,"A",{href:!0});var nZ=r(Ri);$7=n(nZ,"Trainer"),nZ.forEach(t),k7=n(jh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vw=c(e),Ii=l(e,"P",{});var oZ=r(Ii);P7=n(oZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),oZ.forEach(t),Yw=c(e),na=l(e,"P",{});var ME=r(na);D7=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var lZ=r(Ui);z7=n(lZ,"TrainingArguments"),lZ.forEach(t),O7=n(ME," based on that. The steps are:"),ME.forEach(t),Kw=c(e),oa=l(e,"OL",{});var ZE=r(oa);gd=l(ZE,"LI",{});var rZ=r(gd);T7=n(rZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),rZ.forEach(t),A7=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);S7=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var pZ=r(Gi);C7=n(pZ,"TrainingArguments"),pZ.forEach(t),x7=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jw=c(e),le=l(e,"P",{});var Hn=r(le);R7=n(Hn,"Do note that some values, such as "),wd=l(Hn,"CODE",{});var iZ=r(wd);I7=n(iZ,"scheduler.params.total_num_steps"),iZ.forEach(t),U7=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var uZ=r(Li);G7=n(uZ,"Trainer"),uZ.forEach(t),L7=n(Hn," during "),yd=l(Hn,"CODE",{});var cZ=r(yd);M7=n(cZ,"train"),cZ.forEach(t),Z7=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xw=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qw=c(e),xs=l(e,"H3",{class:!0});var HE=r(xs);la=l(HE,"A",{id:!0,class:!0,href:!0});var hZ=r(la);bd=l(hZ,"SPAN",{});var fZ=r(bd);d(el.$$.fragment,fZ),fZ.forEach(t),hZ.forEach(t),N7=c(HE),Ed=l(HE,"SPAN",{});var dZ=r(Ed);H7=n(dZ,"ZeRO"),dZ.forEach(t),HE.forEach(t),ey=c(e),sl=l(e,"P",{});var gG=r(sl);tl=l(gG,"A",{href:!0,rel:!0});var mZ=r(tl);B7=n(mZ,"Zero Redundancy Optimizer (ZeRO)"),mZ.forEach(t),W7=n(gG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),gG.forEach(t),sy=c(e),Ne=l(e,"P",{});var gh=r(Ne);F7=n(gh,"The "),qd=l(gh,"CODE",{});var _Z=r(qd);V7=n(_Z,"zero_optimization"),_Z.forEach(t),Y7=n(gh," section of the configuration file is the most important part ("),al=l(gh,"A",{href:!0,rel:!0});var vZ=r(al);K7=n(vZ,"docs"),vZ.forEach(t),J7=n(gh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),ty=c(e),ra=l(e,"P",{});var BE=r(ra);X7=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var jZ=r(Zi);Q7=n(jZ,"Trainer"),jZ.forEach(t),ek=n(BE,` provides
