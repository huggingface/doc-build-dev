...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15875/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15875/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15875/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15875/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15875/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),sy=l(Nt),Es=a(Nt,"P",{});var bu=s(Es);ry=i(bu,"This model is also a "),Ps=a(bu,"A",{href:!0,rel:!0});var e5=s(Ps);iy=i(e5,"tf.keras.Model"),e5.forEach(t),dy=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),ly=l(Nt),m(cn.$$.fragment,Nt),cy=l(Nt),Ie=a(Nt,"DIV",{class:!0});var Dt=s(Ie);m(Cs.$$.fragment,Dt),py=l(Dt),Mo=a(Dt,"P",{});var Vi=s(Mo);hy=i(Vi,"The "),Bi=a(Vi,"A",{href:!0});var t5=s(Bi);uy=i(t5,"TFMBartModel"),t5.forEach(t),my=i(Vi," forward method, overrides the "),sc=a(Vi,"CODE",{});var o5=s(sc);fy=i(o5,"__call__"),o5.forEach(t),_y=i(Vi," special method."),Vi.forEach(t),gy=l(Dt),m(pn.$$.fragment,Dt),ky=l(Dt),rc=a(Dt,"P",{});var n5=s(rc);by=i(n5,"Example:"),n5.forEach(t),yy=l(Dt),m(Ss.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),nh=l(o),wo=a(o,"H2",{class:!0});var yu=s(wo);hn=a(yu,"A",{id:!0,class:!0,href:!0});var a5=s(hn);ic=a(a5,"SPAN",{});var s5=s(ic);m(As.$$.fragment,s5),s5.forEach(t),a5.forEach(t),vy=l(yu),dc=a(yu,"SPAN",{});var r5=s(dc);Ty=i(r5,"TFMBartForConditionalGeneration"),r5.forEach(t),yu.forEach(t),ah=l(o),Ee=a(o,"DIV",{class:!0});var Lt=s(Ee);m(Os.$$.fragment,Lt),My=l(Lt),Is=a(Lt,"P",{});var vu=s(Is);wy=i(vu,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),$i=a(vu,"A",{href:!0});var i5=s($i);xy=i(i5,"TFPreTrainedModel"),i5.forEach(t),zy=i(vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vu.forEach(t),qy=l(Lt),Ns=a(Lt,"P",{});var Tu=s(Ns);By=i(Tu,"This model is also a "),Ds=a(Tu,"A",{href:!0,rel:!0});var d5=s(Ds);$y=i(d5,"tf.keras.Model"),d5.forEach(t),Fy=i(Tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tu.forEach(t),jy=l(Lt),m(un.$$.fragment,Lt),Ey=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);m(Ls.$$.fragment,We),Py=l(We),xo=a(We,"P",{});var Qi=s(xo);Cy=i(Qi,"The "),Fi=a(Qi,"A",{href:!0});var l5=s(Fi);Sy=i(l5,"TFMBartForConditionalGeneration"),l5.forEach(t),Ay=i(Qi," forward method, overrides the "),lc=a(Qi,"CODE",{});var c5=s(lc);Oy=i(c5,"__call__"),c5.forEach(t),Iy=i(Qi," special method."),Qi.forEach(t),Ny=l(We),m(mn.$$.fragment,We),Dy=l(We),cc=a(We,"P",{});var p5=s(cc);Ly=i(p5,"Summarization example:"),p5.forEach(t),Gy=l(We),m(Gs.$$.fragment,We),Wy=l(We),pc=a(We,"P",{});var h5=s(pc);Ry=i(h5,"Mask filling example:"),h5.forEach(t),Uy=l(We),m(Ws.$$.fragment,We),We.forEach(t),Lt.forEach(t),sh=l(o),zo=a(o,"H2",{class:!0});var Mu=s(zo);fn=a(Mu,"A",{id:!0,class:!0,href:!0});var u5=s(fn);hc=a(u5,"SPAN",{});var m5=s(hc);m(Rs.$$.fragment,m5),m5.forEach(t),u5.forEach(t),Xy=l(Mu),uc=a(Mu,"SPAN",{});var f5=s(uc);Hy=i(f5,"FlaxMBartModel"),f5.forEach(t),Mu.forEach(t),rh=l(o),R=a(o,"DIV",{class:!0});var _e=s(R);m(Us.$$.fragment,_e),Vy=l(_e),Xs=a(_e,"P",{});var wu=s(Xs);Qy=i(wu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ji=a(wu,"A",{href:!0});var _5=s(ji);Jy=i(_5,"FlaxPreTrainedModel"),_5.forEach(t),Ky=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),Zy=l(_e),Hs=a(_e,"P",{});var xu=s(Hs);Yy=i(xu,`This model is also a Flax Linen
`),Vs=a(xu,"A",{href:!0,rel:!0});var g5=s(Vs);ev=i(g5,"flax.nn.Module"),g5.forEach(t),tv=i(xu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),ov=l(_e),mc=a(_e,"P",{});var k5=s(mc);nv=i(k5,"Finally, this model supports inherent JAX features such as:"),k5.forEach(t),av=l(_e),ft=a(_e,"UL",{});var Fn=s(ft);fc=a(Fn,"LI",{});var b5=s(fc);Qs=a(b5,"A",{href:!0,rel:!0});var y5=s(Qs);sv=i(y5,"Just-In-Time (JIT) compilation"),y5.forEach(t),b5.forEach(t),rv=l(Fn),_c=a(Fn,"LI",{});var v5=s(_c);Js=a(v5,"A",{href:!0,rel:!0});var T5=s(Js);iv=i(T5,"Automatic Differentiation"),T5.forEach(t),v5.forEach(t),dv=l(Fn),gc=a(Fn,"LI",{});var M5=s(gc);Ks=a(M5,"A",{href:!0,rel:!0});var w5=s(Ks);lv=i(w5,"Vectorization"),w5.forEach(t),M5.forEach(t),cv=l(Fn),kc=a(Fn,"LI",{});var x5=s(kc);Zs=a(x5,"A",{href:!0,rel:!0});var z5=s(Zs);pv=i(z5,"Parallelization"),z5.forEach(t),x5.forEach(t),Fn.forEach(t),hv=l(_e),Ne=a(_e,"DIV",{class:!0});var Gt=s(Ne);m(Ys.$$.fragment,Gt),uv=l(Gt),qo=a(Gt,"P",{});var Ji=s(qo);mv=i(Ji,"The "),bc=a(Ji,"CODE",{});var q5=s(bc);fv=i(q5,"FlaxMBartPreTrainedModel"),q5.forEach(t),_v=i(Ji,"forward method, overrides the "),yc=a(Ji,"CODE",{});var B5=s(yc);gv=i(B5,"__call__"),B5.forEach(t),kv=i(Ji," special method."),Ji.forEach(t),bv=l(Gt),m(_n.$$.fragment,Gt),yv=l(Gt),vc=a(Gt,"P",{});var $5=s(vc);vv=i($5,"Example:"),$5.forEach(t),Tv=l(Gt),m(er.$$.fragment,Gt),Gt.forEach(t),Mv=l(_e),wt=a(_e,"DIV",{class:!0});var Ki=s(wt);m(tr.$$.fragment,Ki),wv=l(Ki),Tc=a(Ki,"P",{});var F5=s(Tc);xv=i(F5,"Example:"),F5.forEach(t),zv=l(Ki),m(or.$$.fragment,Ki),Ki.forEach(t),qv=l(_e),xt=a(_e,"DIV",{class:!0});var Zi=s(xt);m(nr.$$.fragment,Zi),Bv=l(Zi),Mc=a(Zi,"P",{});var j5=s(Mc);$v=i(j5,"Example:"),j5.forEach(t),Fv=l(Zi),m(ar.$$.fragment,Zi),Zi.forEach(t),_e.forEach(t),ih=l(o),Bo=a(o,"H2",{class:!0});var zu=s(Bo);gn=a(zu,"A",{id:!0,class:!0,href:!0});var E5=s(gn);wc=a(E5,"SPAN",{});var P5=s(wc);m(sr.$$.fragment,P5),P5.forEach(t),E5.forEach(t),jv=l(zu),xc=a(zu,"SPAN",{});var C5=s(xc);Ev=i(C5,"FlaxMBartForConditionalGeneration"),C5.forEach(t),zu.forEach(t),dh=l(o),U=a(o,"DIV",{class:!0});var ge=s(U);m(rr.$$.fragment,ge),Pv=l(ge),ir=a(ge,"P",{});var qu=s(ir);Cv=i(qu,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Ei=a(qu,"A",{href:!0});var S5=s(Ei);Sv=i(S5,"FlaxPreTrainedModel"),S5.forEach(t),Av=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),Ov=l(ge),dr=a(ge,"P",{});var Bu=s(dr);Iv=i(Bu,`This model is also a Flax Linen
`),lr=a(Bu,"A",{href:!0,rel:!0});var A5=s(lr);Nv=i(A5,"flax.nn.Module"),A5.forEach(t),Dv=i(Bu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),Lv=l(ge),zc=a(ge,"P",{});var O5=s(zc);Gv=i(O5,"Finally, this model supports inherent JAX features such as:"),O5.forEach(t),Wv=l(ge),_t=a(ge,"UL",{});var jn=s(_t);qc=a(jn,"LI",{});var I5=s(qc);cr=a(I5,"A",{href:!0,rel:!0});var N5=s(cr);Rv=i(N5,"Just-In-Time (JIT) compilation"),N5.forEach(t),I5.forEach(t),Uv=l(jn),Bc=a(jn,"LI",{});var D5=s(Bc);pr=a(D5,"A",{href:!0,rel:!0});var L5=s(pr);Xv=i(L5,"Automatic Differentiation"),L5.forEach(t),D5.forEach(t),Hv=l(jn),$c=a(jn,"LI",{});var G5=s($c);hr=a(G5,"A",{href:!0,rel:!0});var W5=s(hr);Vv=i(W5,"Vectorization"),W5.forEach(t),G5.forEach(t),Qv=l(jn),Fc=a(jn,"LI",{});var R5=s(Fc);ur=a(R5,"A",{href:!0,rel:!0});var U5=s(ur);Jv=i(U5,"Parallelization"),U5.forEach(t),R5.forEach(t),jn.forEach(t),Kv=l(ge),te=a(ge,"DIV",{class:!0});var Re=s(te);m(mr.$$.fragment,Re),Zv=l(Re),$o=a(Re,"P",{});var Yi=s($o);Yv=i(Yi,"The "),jc=a(Yi,"CODE",{});var X5=s(jc);eT=i(X5,"FlaxMBartPreTrainedModel"),X5.forEach(t),tT=i(Yi,"forward method, overrides the "),Ec=a(Yi,"CODE",{});var H5=s(Ec);oT=i(H5,"__call__"),H5.forEach(t),nT=i(Yi," special method."),Yi.forEach(t),aT=l(Re),m(kn.$$.fragment,Re),sT=l(Re),Pc=a(Re,"P",{});var V5=s(Pc);rT=i(V5,"Summarization example:"),V5.forEach(t),iT=l(Re),m(fr.$$.fragment,Re),dT=l(Re),Cc=a(Re,"P",{});var Q5=s(Cc);lT=i(Q5,"Mask filling example:"),Q5.forEach(t),cT=l(Re),m(_r.$$.fragment,Re),Re.forEach(t),pT=l(ge),zt=a(ge,"DIV",{class:!0});var ed=s(zt);m(gr.$$.fragment,ed),hT=l(ed),Sc=a(ed,"P",{});var J5=s(Sc);uT=i(J5,"Example:"),J5.forEach(t),mT=l(ed),m(kr.$$.fragment,ed),ed.forEach(t),fT=l(ge),qt=a(ge,"DIV",{class:!0});var td=s(qt);m(br.$$.fragment,td),_T=l(td),Ac=a(td,"P",{});var K5=s(Ac);gT=i(K5,"Example:"),K5.forEach(t),kT=l(td),m(yr.$$.fragment,td),td.forEach(t),ge.forEach(t),lh=l(o),Fo=a(o,"H2",{class:!0});var $u=s(Fo);bn=a($u,"A",{id:!0,class:!0,href:!0});var Z5=s(bn);Oc=a(Z5,"SPAN",{});var Y5=s(Oc);m(vr.$$.fragment,Y5),Y5.forEach(t),Z5.forEach(t),bT=l($u),Ic=a($u,"SPAN",{});var ez=s(Ic);yT=i(ez,"FlaxMBartForSequenceClassification"),ez.forEach(t),$u.forEach(t),ch=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);m(Tr.$$.fragment,ne),vT=l(ne),Nc=a(ne,"P",{});var tz=s(Nc);TT=i(tz,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
