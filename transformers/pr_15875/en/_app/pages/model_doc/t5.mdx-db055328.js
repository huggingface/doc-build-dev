...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Ws=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15875/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
behavior.`),BT=d(),f(Yn.$$.fragment),WT=d(),Ze=o("div"),f(ha.$$.fragment),RT=d(),_n=o("p"),HT=r("The "),Pr=o("a"),VT=r("TFT5Model"),KT=r(" forward method, overrides the "),cl=o("code"),YT=r("__call__"),ZT=r(" special method."),JT=d(),f(Zn.$$.fragment),XT=d(),pl=o("p"),QT=r("Examples:"),e5=d(),f(ua.$$.fragment),Cc=d(),gn=o("h2"),Jn=o("a"),hl=o("span"),f(ma.$$.fragment),t5=d(),ul=o("span"),n5=r("TFT5ForConditionalGeneration"),Nc=d(),le=o("div"),f(fa.$$.fragment),o5=d(),_a=o("p"),s5=r("T5 Model with a "),ml=o("code"),a5=r("language modeling"),r5=r(" head on top."),i5=d(),ga=o("p"),d5=r("The T5 model was proposed in "),Ta=o("a"),l5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),k5=d(),f(Xn.$$.fragment),v5=d(),Je=o("div"),f(ya.$$.fragment),b5=d(),Tn=o("p"),y5=r("The "),Nr=o("a"),w5=r("TFT5ForConditionalGeneration"),x5=r(" forward method, overrides the "),fl=o("code"),z5=r("__call__"),$5=r(" special method."),q5=d(),f(Qn.$$.fragment),E5=d(),_l=o("p"),j5=r("Examples:"),F5=d(),f(wa.$$.fragment),Oc=d(),kn=o("h2"),eo=o("a"),gl=o("span"),f(xa.$$.fragment),M5=d(),Tl=o("span"),P5=r("TFT5EncoderModel"),Lc=d(),ce=o("div"),f(za.$$.fragment),C5=d(),kl=o("p"),N5=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),O5=d(),$a=o("p"),L5=r("The T5 model was proposed in "),qa=o("a"),A5=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qp.forEach(t),BT=l(at),_(Yn.$$.fragment,at),WT=l(at),Ze=s(at,"DIV",{class:!0});var Rt=a(Ze);_(ha.$$.fragment,Rt),RT=l(Rt),_n=s(Rt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Pr=s(Qr,"A",{href:!0});var E1=a(Pr);VT=i(E1,"TFT5Model"),E1.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var j1=a(cl);YT=i(j1,"__call__"),j1.forEach(t),ZT=i(Qr," special method."),Qr.forEach(t),JT=l(Rt),_(Zn.$$.fragment,Rt),XT=l(Rt),pl=s(Rt,"P",{});var F1=a(pl);QT=i(F1,"Examples:"),F1.forEach(t),e5=l(Rt),_(ua.$$.fragment,Rt),Rt.forEach(t),at.forEach(t),Cc=l(n),gn=s(n,"H2",{class:!0});var Ep=a(gn);Jn=s(Ep,"A",{id:!0,class:!0,href:!0});var M1=a(Jn);hl=s(M1,"SPAN",{});var P1=a(hl);_(ma.$$.fragment,P1),P1.forEach(t),M1.forEach(t),t5=l(Ep),ul=s(Ep,"SPAN",{});var C1=a(ul);n5=i(C1,"TFT5ForConditionalGeneration"),C1.forEach(t),Ep.forEach(t),Nc=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),o5=l(rt),_a=s(rt,"P",{});var jp=a(_a);s5=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var N1=a(ml);a5=i(N1,"language modeling"),N1.forEach(t),r5=i(jp," head on top."),jp.forEach(t),i5=l(rt),ga=s(rt,"P",{});var Fp=a(ga);d5=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var O1=a(Ta);l5=i(O1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),O1.forEach(t),c5=i(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Fp.forEach(t),p5=l(rt),ka=s(rt,"P",{});var Mp=a(ka);h5=i(Mp,"This model inherits from "),Cr=s(Mp,"A",{href:!0});var L1=a(Cr);u5=i(L1,"TFPreTrainedModel"),L1.forEach(t),m5=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mp.forEach(t),f5=l(rt),va=s(rt,"P",{});var Pp=a(va);_5=i(Pp,"This model is also a "),ba=s(Pp,"A",{href:!0,rel:!0});var A1=a(ba);g5=i(A1,"tf.keras.Model"),A1.forEach(t),T5=i(Pp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),k5=l(rt),_(Xn.$$.fragment,rt),v5=l(rt),Je=s(rt,"DIV",{class:!0});var Ht=a(Je);_(ya.$$.fragment,Ht),b5=l(Ht),Tn=s(Ht,"P",{});var ei=a(Tn);y5=i(ei,"The "),Nr=s(ei,"A",{href:!0});var I1=a(Nr);w5=i(I1,"TFT5ForConditionalGeneration"),I1.forEach(t),x5=i(ei," forward method, overrides the "),fl=s(ei,"CODE",{});var D1=a(fl);z5=i(D1,"__call__"),D1.forEach(t),$5=i(ei," special method."),ei.forEach(t),q5=l(Ht),_(Qn.$$.fragment,Ht),E5=l(Ht),_l=s(Ht,"P",{});var S1=a(_l);j5=i(S1,"Examples:"),S1.forEach(t),F5=l(Ht),_(wa.$$.fragment,Ht),Ht.forEach(t),rt.forEach(t),Oc=l(n),kn=s(n,"H2",{class:!0});var Cp=a(kn);eo=s(Cp,"A",{id:!0,class:!0,href:!0});var G1=a(eo);gl=s(G1,"SPAN",{});var U1=a(gl);_(xa.$$.fragment,U1),U1.forEach(t),G1.forEach(t),M5=l(Cp),Tl=s(Cp,"SPAN",{});var B1=a(Tl);P5=i(B1,"TFT5EncoderModel"),B1.forEach(t),Cp.forEach(t),Lc=l(n),ce=s(n,"DIV",{class:!0});var it=a(ce);_(za.$$.fragment,it),C5=l(it),kl=s(it,"P",{});var W1=a(kl);N5=i(W1,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),W1.forEach(t),O5=l(it),$a=s(it,"P",{});var Np=a($a);L5=i(Np,"The T5 model was proposed in "),qa=s(Np,"A",{href:!0,rel:!0});var R1=a(qa);A5=i(R1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
