...
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(C),q=r(C,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),C.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,J,G),e(J,x),e(x,ge),e(x,Q),e(Q,le),e(x,Y),e(x,H),e(H,oe),e(J,_e),e(J,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(J,ye),e(J,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(J)}}}function cg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function pg(I){let p,F,f,_,y,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var z=i(E);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(z,` method which currently requires having all the
...
first positional argument :`),xe.forEach(t),te=d(h),J=r(h,"UL",{});var C=i(J);x=r(C,"LI",{});var B=i(x);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(C),M=r(C,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(C),q=r(C,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),C.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,J,G),e(J,x),e(x,ge),e(x,Q),e(Q,le),e(x,Y),e(x,H),e(H,oe),e(J,_e),e(J,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(J,ye),e(J,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(J)}}}function hg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function ug(I){let p,F,f,_,y,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var z=i(E);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(z,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function fg(I){let p,F,f,_,y,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),J=a("ul"),x=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var z=i(E);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(z,` method which currently requires having all the
...
first positional argument :`),xe.forEach(t),te=d(h),J=r(h,"UL",{});var C=i(J);x=r(C,"LI",{});var B=i(x);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(C),M=r(C,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(C),q=r(C,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),C.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,J,G),e(J,x),e(x,ge),e(x,Q),e(Q,le),e(x,Y),e(x,H),e(H,oe),e(J,_e),e(J,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(J,ye),e(J,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(J)}}}function gg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function yg(I){let p,F,f,_,y,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,J,x,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ye,q,ve,R,se,h,G,V,Ae,Ie,z,Le,Ne,xe,C,B,pe,Fe,D,Se,ke,we,De,Ks,pt,Ai,Jo,Ii,Li,Xs,Ni,Si,Ys,Di,Oi,Mr,$t,Kt,Zs,xo,Wi,ea,Ui,qr,Xt,Bi,ms,Qi,Hi,zr,Mo,Cr,fs,Ri,Ar,qo,Ir,Ft,Yt,ta,zo,Vi,oa,Ki,Lr,Ye,Co,Xi,Ze,Yi,gs,Zi,el,Ao,tl,ol,_s,nl,sl,Ts,al,rl,il,na,ll,dl,Io,Nr,jt,Zt,sa,Lo,cl,aa,pl,Sr,ht,No,hl,So,ul,Do,ml,fl,gl,Oe,Oo,_l,Gt,Tl,ys,yl,vl,ra,kl,wl,bl,eo,Pl,ia,$l,Fl,Wo,Dr,Et,to,la,Uo,jl,da,Gl,Or,et,Bo,El,ca,Jl,xl,Qo,Ml,Ho,ql,zl,Cl,We,Ro,Al,Jt,Il,vs,Ll,Nl,pa,Sl,Dl,Ol,oo,Wl,ha,Ul,Bl,Vo,Wr,xt,no,ua,Ko,Ql,ma,Hl,Ur,je,Xo,Rl,fa,Vl,Kl,ks,ws,Xl,Yl,Zl,tt,ed,ga,td,od,_a,nd,sd,Ta,ad,rd,ya,id,ld,dd,Yo,cd,Zo,pd,hd,ud,ne,en,md,Mt,fd,bs,gd,_d,va,Td,yd,vd,so,kd,ka,wd,bd,tn,Pd,on,$d,wa,Fd,jd,nn,Gd,sn,Br,qt,ao,ba,an,Ed,Pa,Jd,Qr,ot,rn,xd,zt,Md,$a,qd,zd,Fa,Cd,Ad,Id,ln,Ld,dn,Nd,Sd,Dd,Me,cn,Od,Ct,Wd,Ps,Ud,Bd,ja,Qd,Hd,Rd,ro,Vd,Ga,Kd,Xd,pn,Yd,hn,Hr,At,io,Ea,un,Zd,Ja,ec,Rr,Ge,mn,tc,xa,oc,nc,fn,sc,$s,ac,rc,ic,gn,lc,_n,dc,cc,pc,lo,hc,Ue,Tn,uc,It,mc,Fs,fc,gc,Ma,_c,Tc,yc,co,vc,qa,kc,wc,yn,Vr,Lt,po,za,vn,bc,Ca,Pc,Kr,Ee,kn,$c,Aa,Fc,jc,wn,Gc,js,Ec,Jc,xc,bn,Mc,Pn,qc,zc,Cc,ho,Ac,Be,$n,Ic,Nt,Lc,Gs,Nc,Sc,Ia,Dc,Oc,Wc,uo,Uc,La,Bc,Qc,Fn,Xr,St,mo,Na,jn,Hc,Sa,Rc,Yr,ae,Gn,Vc,Da,Kc,Xc,Es,Js,Yc,Zc,ep,nt,tp,Oa,op,np,Wa,sp,ap,Ua,rp,ip,Ba,lp,dp,cp,En,pp,xs,hp,up,mp,Jn,fp,xn,gp,_p,Tp,fo,yp,qe,Mn,vp,Dt,kp,Ms,wp,bp,Qa,Pp,$p,Fp,go,jp,Ha,Gp,Ep,qn,Jp,zn,Zr,Ot,_o,Ra,Cn,xp,Va,Mp,ei,Je,An,qp,Wt,zp,Ka,Cp,Ap,Xa,Ip,Lp,Np,In,Sp,qs,Dp,Op,Wp,Ln,Up,Nn,Bp,Qp,Hp,To,Rp,ze,Sn,Vp,Ut,Kp,zs,Xp,Yp,Ya,Zp,eh,th,yo,oh,Za,nh,sh,Dn,ah,On,ti,Bt,vo,er,Wn,rh,tr,ih,oi,be,Un,lh,or,dh,ch,Bn,ph,Cs,hh,uh,mh,Qn,fh,Hn,gh,_h,Th,nr,yh,vh,ut,sr,Rn,kh,wh,ar,Vn,bh,Ph,rr,Kn,$h,Fh,ir,Xn,jh,Gh,Qe,Yn,Eh,Qt,Jh,lr,xh,Mh,dr,qh,zh,Ch,ko,Ah,cr,Ih,Lh,Zn,ni,Ht,wo,pr,es,Nh,hr,Sh,si,Pe,ts,Dh,ur,Oh,Wh,os,Uh,As,Bh,Qh,Hh,ns,Rh,ss,Vh,Kh,Xh,mr,Yh,Zh,mt,fr,as,eu,tu,gr,rs,ou,nu,_r,is,su,au,Tr,ls,ru,iu,He,ds,lu,Rt,du,yr,cu,pu,vr,hu,uu,mu,bo,fu,kr,gu,_u,cs,ai;return T=new Xe({}),Z=new Xe({}),C=new he({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Lo=new Xe({}),No=new re({props:{name:"class transformers.GPTJModel",anchor:"transformers.GPTJModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/gptj/modeling_gptj.py#L460",parametersDescription:[{anchor:"transformers.GPTJModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16573/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16573/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oo=new re({props:{name:"forward",anchor:"transformers.GPTJModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/gptj/modeling_gptj.py#L516",parametersDescription:[{anchor:"transformers.GPTJModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16573/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16573/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16573/en/model_doc/gptj#transformers.GPTJConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Uo=new Xe({}),Bo=new re({props:{name:"class transformers.GPTJForCausalLM",anchor:"transformers.GPTJForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/gptj/modeling_gptj.py#L700",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16573/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16573/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new re({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/gptj/modeling_gptj.py#L769",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16573/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16573/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16573/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16573/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16573/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16573/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16573/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16573/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),jn=new Xe({}),Gn=new re({props:{name:"class transformers.TFGPTJForSequenceClassification",anchor:"transformers.TFGPTJForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/gptj/modeling_tf_gptj.py#L849",parametersDescription:[{anchor:"transformers.TFGPTJForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16573/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16573/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new Ke({props:{$$slots:{default:[ug]},$$scope:{ctx:I}}}),Mn=new re({props:{name:"call",anchor:"transformers.TFGPTJForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/gptj/modeling_tf_gptj.py#L863",parametersDescription:[{anchor:"transformers.TFGPTJForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16573/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16573/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16573/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16573/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16573/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=a("meta"),F=l(),f=a("h1"),_=a("a"),y=a("span"),v(T.$$.fragment),g=l(),j=a("span"),ue=n("GPT-J"),K=l(),E=a("h2"),X=a("a"),O=a("span"),v(Z.$$.fragment),me=l(),W=a("span"),fe=n("Overview"),ie=l(),L=a("p"),A=n("The GPT-J model was released in the "),ee=a("a"),te=n("kingoflolz/mesh-transformer-jax"),J=n(` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),x=a("a"),ge=n("the Pile"),Q=n(" dataset."),le=l(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),_e=n("Stella Biderman"),M=n("."),de=l(),N=a("p"),Te=n("Tips:"),ce=l(),S=a("ul"),U=a("li"),ye=n("To load "),q=a("a"),ve=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
12.1GB of CPU RAM to load the model.`),xe=l(),v(C.$$.fragment),B=l(),pe=a("ul"),Fe=a("li"),D=a("p"),Se=n(`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
...
`),Xs=a("code"),Ni=n("<|extratoken_1|>... <|extratoken_143|>"),Si=n(", so the "),Ys=a("code"),Di=n("vocab_size"),Oi=n(" of tokenizer also becomes 50400."),Mr=l(),$t=a("h3"),Kt=a("a"),Zs=a("span"),v(xo.$$.fragment),Wi=l(),ea=a("span"),Ui=n("Generation"),qr=l(),Xt=a("p"),Bi=n("The "),ms=a("a"),Qi=n("generate()"),Hi=n(` method can be used to generate text using GPT-J
model.`),zr=l(),v(Mo.$$.fragment),Cr=l(),fs=a("p"),Ri=n("\u2026or in float16 precision:"),Ar=l(),v(qo.$$.fragment),Ir=l(),Ft=a("h2"),Yt=a("a"),ta=a("span"),v(zo.$$.fragment),Vi=l(),oa=a("span"),Ki=n("GPTJConfig"),Lr=l(),Ye=a("div"),v(Co.$$.fragment),Xi=l(),Ze=a("p"),Yi=n("This is the configuration class to store the configuration of a "),gs=a("a"),Zi=n("GPTJModel"),el=n(`. It is used to instantiate a GPT-J
...
behavior.`),gl=l(),Oe=a("div"),v(Oo.$$.fragment),_l=l(),Gt=a("p"),Tl=n("The "),ys=a("a"),yl=n("GPTJModel"),vl=n(" forward method, overrides the "),ra=a("code"),kl=n("__call__"),wl=n(" special method."),bl=l(),v(eo.$$.fragment),Pl=l(),ia=a("p"),$l=n("Example:"),Fl=l(),v(Wo.$$.fragment),Dr=l(),Et=a("h2"),to=a("a"),la=a("span"),v(Uo.$$.fragment),jl=l(),da=a("span"),Gl=n("GPTJForCausalLM"),Or=l(),et=a("div"),v(Bo.$$.fragment),El=l(),ca=a("p"),Jl=n("The GPT-J Model transformer with a language modeling head on top."),xl=l(),Qo=a("p"),Ml=n("This model is a PyTorch "),Ho=a("a"),ql=n("torch.nn.Module"),zl=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cl=l(),We=a("div"),v(Ro.$$.fragment),Al=l(),Jt=a("p"),Il=n("The "),vs=a("a"),Ll=n("GPTJForCausalLM"),Nl=n(" forward method, overrides the "),pa=a("code"),Sl=n("__call__"),Dl=n(" special method."),Ol=l(),v(oo.$$.fragment),Wl=l(),ha=a("p"),Ul=n("Example:"),Bl=l(),v(Vo.$$.fragment),Wr=l(),xt=a("h2"),no=a("a"),ua=a("span"),v(Ko.$$.fragment),Ql=l(),ma=a("span"),Hl=n("GPTJForSequenceClassification"),Ur=l(),je=a("div"),v(Xo.$$.fragment),Rl=l(),fa=a("p"),Vl=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Kl=l(),ks=a("p"),ws=a("a"),Xl=n("GPTJForSequenceClassification"),Yl=n(` uses the last token in order to do the classification, as other causal models
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ud=l(),ne=a("div"),v(en.$$.fragment),md=l(),Mt=a("p"),fd=n("The "),bs=a("a"),gd=n("GPTJForSequenceClassification"),_d=n(" forward method, overrides the "),va=a("code"),Td=n("__call__"),yd=n(" special method."),vd=l(),v(so.$$.fragment),kd=l(),ka=a("p"),wd=n("Example of single-label classification:"),bd=l(),v(tn.$$.fragment),Pd=l(),v(on.$$.fragment),$d=l(),wa=a("p"),Fd=n("Example of multi-label classification:"),jd=l(),v(nn.$$.fragment),Gd=l(),v(sn.$$.fragment),Br=l(),qt=a("h2"),ao=a("a"),ba=a("span"),v(an.$$.fragment),Ed=l(),Pa=a("span"),Jd=n("GPTJForQuestionAnswering"),Qr=l(),ot=a("div"),v(rn.$$.fragment),xd=l(),zt=a("p"),Md=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dd=l(),Me=a("div"),v(cn.$$.fragment),Od=l(),Ct=a("p"),Wd=n("The "),Ps=a("a"),Ud=n("GPTJForQuestionAnswering"),Bd=n(" forward method, overrides the "),ja=a("code"),Qd=n("__call__"),Hd=n(" special method."),Rd=l(),v(ro.$$.fragment),Vd=l(),Ga=a("p"),Kd=n("Example:"),Xd=l(),v(pn.$$.fragment),Yd=l(),v(hn.$$.fragment),Hr=l(),At=a("h2"),io=a("a"),Ea=a("span"),v(un.$$.fragment),Zd=l(),Ja=a("span"),ec=n("TFGPTJModel"),Rr=l(),Ge=a("div"),v(mn.$$.fragment),tc=l(),xa=a("p"),oc=n("The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),nc=l(),fn=a("p"),sc=n("This model inherits from "),$s=a("a"),ac=n("TFPreTrainedModel"),rc=n(`. Check the superclass documentation for the generic methods the
...
behavior.`),pc=l(),v(lo.$$.fragment),hc=l(),Ue=a("div"),v(Tn.$$.fragment),uc=l(),It=a("p"),mc=n("The "),Fs=a("a"),fc=n("TFGPTJModel"),gc=n(" forward method, overrides the "),Ma=a("code"),_c=n("__call__"),Tc=n(" special method."),yc=l(),v(co.$$.fragment),vc=l(),qa=a("p"),kc=n("Example:"),wc=l(),v(yn.$$.fragment),Vr=l(),Lt=a("h2"),po=a("a"),za=a("span"),v(vn.$$.fragment),bc=l(),Ca=a("span"),Pc=n("TFGPTJForCausalLM"),Kr=l(),Ee=a("div"),v(kn.$$.fragment),$c=l(),Aa=a("p"),Fc=n("The GPT-J Model transformer with a language modeling head on top."),jc=l(),wn=a("p"),Gc=n("This model inherits from "),js=a("a"),Ec=n("TFPreTrainedModel"),Jc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xc=l(),bn=a("p"),Mc=n("This model is also a "),Pn=a("a"),qc=n("tf.keras.Model"),zc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cc=l(),v(ho.$$.fragment),Ac=l(),Be=a("div"),v($n.$$.fragment),Ic=l(),Nt=a("p"),Lc=n("The "),Gs=a("a"),Nc=n("TFGPTJForCausalLM"),Sc=n(" forward method, overrides the "),Ia=a("code"),Dc=n("__call__"),Oc=n(" special method."),Wc=l(),v(uo.$$.fragment),Uc=l(),La=a("p"),Bc=n("Example:"),Qc=l(),v(Fn.$$.fragment),Xr=l(),St=a("h2"),mo=a("a"),Na=a("span"),v(jn.$$.fragment),Hc=l(),Sa=a("span"),Rc=n("TFGPTJForSequenceClassification"),Yr=l(),ae=a("div"),v(Gn.$$.fragment),Vc=l(),Da=a("p"),Kc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Xc=l(),Es=a("p"),Js=a("a"),Yc=n("GPTJForSequenceClassification"),Zc=n(` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp=l(),v(fo.$$.fragment),yp=l(),qe=a("div"),v(Mn.$$.fragment),vp=l(),Dt=a("p"),kp=n("The "),Ms=a("a"),wp=n("TFGPTJForSequenceClassification"),bp=n(" forward method, overrides the "),Qa=a("code"),Pp=n("__call__"),$p=n(" special method."),Fp=l(),v(go.$$.fragment),jp=l(),Ha=a("p"),Gp=n("Example:"),Ep=l(),v(qn.$$.fragment),Jp=l(),v(zn.$$.fragment),Zr=l(),Ot=a("h2"),_o=a("a"),Ra=a("span"),v(Cn.$$.fragment),xp=l(),Va=a("span"),Mp=n("TFGPTJForQuestionAnswering"),ei=l(),Je=a("div"),v(An.$$.fragment),qp=l(),Wt=a("p"),zp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp=l(),v(To.$$.fragment),Rp=l(),ze=a("div"),v(Sn.$$.fragment),Vp=l(),Ut=a("p"),Kp=n("The "),zs=a("a"),Xp=n("TFGPTJForQuestionAnswering"),Yp=n(" forward method, overrides the "),Ya=a("code"),Zp=n("__call__"),eh=n(" special method."),th=l(),v(yo.$$.fragment),oh=l(),Za=a("p"),nh=n("Example:"),sh=l(),v(Dn.$$.fragment),ah=l(),v(On.$$.fragment),ti=l(),Bt=a("h2"),vo=a("a"),er=a("span"),v(Wn.$$.fragment),rh=l(),tr=a("span"),ih=n("FlaxGPTJModel"),oi=l(),be=a("div"),v(Un.$$.fragment),lh=l(),or=a("p"),dh=n("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),ch=l(),Bn=a("p"),ph=n("This model inherits from "),Cs=a("a"),hh=n("FlaxPreTrainedModel"),uh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mh=l(),Qn=a("p"),fh=n(`This model is also a Flax Linen
`),Hn=a("a"),gh=n("flax.nn.Module"),_h=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Th=l(),nr=a("p"),yh=n("Finally, this model supports inherent JAX features such as:"),vh=l(),ut=a("ul"),sr=a("li"),Rn=a("a"),kh=n("Just-In-Time (JIT) compilation"),wh=l(),ar=a("li"),Vn=a("a"),bh=n("Automatic Differentiation"),Ph=l(),rr=a("li"),Kn=a("a"),$h=n("Vectorization"),Fh=l(),ir=a("li"),Xn=a("a"),jh=n("Parallelization"),Gh=l(),Qe=a("div"),v(Yn.$$.fragment),Eh=l(),Qt=a("p"),Jh=n("The "),lr=a("code"),xh=n("FlaxGPTJPreTrainedModel"),Mh=n("forward method, overrides the "),dr=a("code"),qh=n("__call__"),zh=n(" special method."),Ch=l(),v(ko.$$.fragment),Ah=l(),cr=a("p"),Ih=n("Example:"),Lh=l(),v(Zn.$$.fragment),ni=l(),Ht=a("h2"),wo=a("a"),pr=a("span"),v(es.$$.fragment),Nh=l(),hr=a("span"),Sh=n("FlaxGPTJForCausalLM"),si=l(),Pe=a("div"),v(ts.$$.fragment),Dh=l(),ur=a("p"),Oh=n("The GPTJ Model transformer with a language modeling head on top."),Wh=l(),os=a("p"),Uh=n("This model inherits from "),As=a("a"),Bh=n("FlaxPreTrainedModel"),Qh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Hp=d(dt),k(To.$$.fragment,dt),Rp=d(dt),ze=r(dt,"DIV",{class:!0});var ct=i(ze);k(Sn.$$.fragment,ct),Vp=d(ct),Ut=r(ct,"P",{});var Hs=i(Ut);Kp=s(Hs,"The "),zs=r(Hs,"A",{href:!0});var ff=i(zs);Xp=s(ff,"TFGPTJForQuestionAnswering"),ff.forEach(t),Yp=s(Hs," forward method, overrides the "),Ya=r(Hs,"CODE",{});var gf=i(Ya);Zp=s(gf,"__call__"),gf.forEach(t),eh=s(Hs," special method."),Hs.forEach(t),th=d(ct),k(yo.$$.fragment,ct),oh=d(ct),Za=r(ct,"P",{});var _f=i(Za);nh=s(_f,"Example:"),_f.forEach(t),sh=d(ct),k(Dn.$$.fragment,ct),ah=d(ct),k(On.$$.fragment,ct),ct.forEach(t),dt.forEach(t),ti=d(o),Bt=r(o,"H2",{class:!0});var Ji=i(Bt);vo=r(Ji,"A",{id:!0,class:!0,href:!0});var Tf=i(vo);er=r(Tf,"SPAN",{});var yf=i(er);k(Wn.$$.fragment,yf),yf.forEach(t),Tf.forEach(t),rh=d(Ji),tr=r(Ji,"SPAN",{});var vf=i(tr);ih=s(vf,"FlaxGPTJModel"),vf.forEach(t),Ji.forEach(t),oi=d(o),be=r(o,"DIV",{class:!0});var Re=i(be);k(Un.$$.fragment,Re),lh=d(Re),or=r(Re,"P",{});var kf=i(or);dh=s(kf,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),kf.forEach(t),ch=d(Re),Bn=r(Re,"P",{});var xi=i(Bn);ph=s(xi,"This model inherits from "),Cs=r(xi,"A",{href:!0});var wf=i(Cs);hh=s(wf,"FlaxPreTrainedModel"),wf.forEach(t),uh=s(xi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
