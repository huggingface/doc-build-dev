...
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Oe=i(v);T=s(Oe,"having all inputs as keyword arguments (like PyTorch models), or"),Oe.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),O=r(N,"CODE",{});var qe=i(O);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
tensors in the first argument of the model call function: `),A=r(N,"CODE",{});var Ae=i(A);ve=s(Ae,"model(inputs)"),Ae.forEach(t),pe=s(N,"."),N.forEach(t),P=d(p),j=r(p,"P",{});var He=i(j);ee=s(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,O),e(O,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,P,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,ke),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(P),p&&t(j),p&&t(ne),p&&t(F)}}}function op(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function np(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,O,Z,Te,A,ve,pe,P,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ve=n("model(inputs)"),pe=n("."),P=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),ye=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Oe=i(v);T=s(Oe,"having all inputs as keyword arguments (like PyTorch models), or"),Oe.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),O=r(N,"CODE",{});var qe=i(O);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function ip(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,O,Z,Te,A,ve,pe,P,j,ee,ne,F,q,ke,U,he,se,V,ue,ae,z,be,H,re,ye,W,S,te,I,oe,G,Ce,p,$,ie,Oe,me,N,qe,Ae,He,D,x,We,ze,K,Be,xe,we,Ue,En,ma,fa,Yo,Fn,ga,_a,Rs,Ye,Ta,Gt,va,ka,Kt,ba,ya,Ms,ct,Rt,qn,Xt,Ca,zn,wa,Es,Le,Jt,La,Je,$a,Zo,Ra,Ma,en,Ea,Fa,Qt,qa,za,xa,pt,Pa,tn,ja,Sa,on,Ia,Na,Da,xn,Oa,Aa,Yt,Fs,ht,Mt,Pn,Zt,Ha,jn,Wa,qs,Ne,eo,Ba,Sn,Ua,Va,to,Ga,nn,Ka,Xa,Ja,sn,oo,zs,ut,Et,In,no,Qa,Nn,Ya,xs,$e,so,Za,Dn,er,tr,ao,or,an,nr,sr,ar,ro,rr,io,ir,lr,dr,Pe,lo,cr,mt,pr,rn,hr,ur,On,mr,fr,gr,Ft,_r,An,Tr,vr,co,Ps,ft,qt,Hn,po,kr,Wn,br,js,Re,ho,yr,Bn,Cr,wr,uo,Lr,ln,$r,Rr,Mr,mo,Er,fo,Fr,qr,zr,je,go,xr,gt,Pr,dn,jr,Sr,Un,Ir,Nr,Dr,zt,Or,Vn,Ar,Hr,_o,Ss,_t,xt,Gn,To,Wr,Kn,Br,Is,Me,vo,Ur,Ee,Vr,cn,Gr,Kr,Xn,Xr,Jr,Jn,Qr,Yr,Qn,Zr,ei,Yn,ti,oi,ni,ko,si,pn,ai,ri,ii,bo,li,yo,di,ci,pi,B,Co,hi,Tt,ui,hn,mi,fi,Zn,gi,_i,Ti,Pt,vi,es,ki,bi,wo,yi,Lo,Ci,ts,wi,Li,$o,$i,Ro,Ns,vt,jt,os,Mo,Ri,ns,Mi,Ds,de,Eo,Ei,ss,Fi,qi,Fo,zi,un,xi,Pi,ji,qo,Si,zo,Ii,Ni,Di,St,Oi,Se,xo,Ai,kt,Hi,mn,Wi,Bi,as,Ui,Vi,Gi,It,Ki,rs,Xi,Ji,Po,Os,bt,Nt,is,jo,Qi,ls,Yi,As,ce,So,Zi,ds,el,tl,Io,ol,fn,nl,sl,al,No,rl,Do,il,ll,dl,Dt,cl,Ie,Oo,pl,yt,hl,gn,ul,ml,cs,fl,gl,_l,Ot,Tl,ps,vl,kl,Ao,Hs,Ct,At,hs,Ho,bl,us,yl,Ws,X,Wo,Cl,ms,wl,Ll,_n,Tn,$l,Rl,Ml,De,El,fs,Fl,ql,gs,zl,xl,_s,Pl,jl,Ts,Sl,Il,Nl,Bo,Dl,vn,Ol,Al,Hl,Uo,Wl,Vo,Bl,Ul,Vl,Ht,Gl,fe,Go,Kl,wt,Xl,kn,Jl,Ql,vs,Yl,Zl,ed,Wt,td,ks,od,nd,Ko,sd,Xo,Bs;return T=new dt({}),Z=new dt({}),Xt=new dt({}),Jt=new Fe({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/pr_16573/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new Fe({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/ctrl/modeling_ctrl.py#L351",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16573/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/pr_16573/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer = CTRLTokenizer.from_pretrained(<span class="hljs-string">&quot;sshleifer/tiny-ctrl&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>model = CTRLModel.from_pretrained(<span class="hljs-string">&quot;sshleifer/tiny-ctrl&quot;</span>)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),po=new dt({}),ho=new Fe({props:{name:"class transformers.CTRLLMHeadModel",anchor:"transformers.CTRLLMHeadModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/ctrl/modeling_ctrl.py#L503",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16573/en/model_doc/ctrl#transformers.CTRLConfig">CTRLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16573/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),go=new Fe({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/ctrl/modeling_ctrl.py#L525",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer = CTRLTokenizer.from_pretrained(<span class="hljs-string">&quot;sshleifer/tiny-ctrl&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>model = CTRLForSequenceClassification.from_pretrained(<span class="hljs-string">&quot;sshleifer/tiny-ctrl&quot;</span>)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = CTRLForSequenceClassification.from_pretrained(<span class="hljs-string">&quot;sshleifer/tiny-ctrl&quot;</span>, num_labels=num_labels)

<span class="hljs-meta">&gt;&gt;&gt; </span>labels = torch.tensor(<span class="hljs-number">1</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">1.21</span>`}}),$o=new Qe({props:{code:`import torch
from transformers import CTRLTokenizer, CTRLForSequenceClassification
...
<span class="hljs-meta">... </span>    <span class="hljs-string">&quot;sshleifer/tiny-ctrl&quot;</span>, problem_type=<span class="hljs-string">&quot;multi_label_classification&quot;</span>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16573/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new $t({props:{$$slots:{default:[tp]},$$scope:{ctx:J}}}),xo=new Fe({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/ctrl/modeling_tf_ctrl.py#L522",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16573/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Dt=new $t({props:{$$slots:{default:[np]},$$scope:{ctx:J}}}),Oo=new Fe({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/ctrl/modeling_tf_ctrl.py#L633",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
`}}),Ot=new $t({props:{$$slots:{default:[sp]},$$scope:{ctx:J}}}),Ao=new Qe({props:{code:`from transformers import CTRLTokenizer, TFCTRLLMHeadModel
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16573/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new $t({props:{$$slots:{default:[ap]},$$scope:{ctx:J}}}),Go=new Fe({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/models/ctrl/modeling_tf_ctrl.py#L745",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
`}}),{c(){h=a("meta"),E=l(),f=a("h1"),g=a("a"),v=a("span"),k(T.$$.fragment),_=l(),M=a("span"),_e=n("CTRL"),Y=l(),R=a("h2"),Q=a("a"),O=a("span"),k(Z.$$.fragment),Te=l(),A=a("span"),ve=n("Overview"),pe=l(),P=a("p"),j=n("CTRL model was proposed in "),ee=a("a"),ne=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),ke=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
the left.`),Oe=l(),me=a("li"),N=n(`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows CTRL to generate syntactically coherent text as it can be
observed in the `),qe=a("em"),Ae=n("run_generation.py"),He=n(" example script."),D=l(),x=a("li"),We=n("The PyTorch models can take the "),ze=a("code"),K=n("past_key_values"),Be=n(` as input, which is the previously computed key/value attention pairs.
...
documentation from `),on=a("a"),Ia=n("PretrainedConfig"),Na=n(" for more information."),Da=l(),xn=a("p"),Oa=n("Examples:"),Aa=l(),k(Yt.$$.fragment),Fs=l(),ht=a("h2"),Mt=a("a"),Pn=a("span"),k(Zt.$$.fragment),Ha=l(),jn=a("span"),Wa=n("CTRLTokenizer"),qs=l(),Ne=a("div"),k(eo.$$.fragment),Ba=l(),Sn=a("p"),Ua=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Va=l(),to=a("p"),Ga=n("This tokenizer inherits from "),nn=a("a"),Ka=n("PreTrainedTokenizer"),Xa=n(` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=l(),B=a("div"),k(Co.$$.fragment),hi=l(),Tt=a("p"),ui=n("The "),hn=a("a"),mi=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),k(Pt.$$.fragment),vi=l(),es=a("p"),ki=n("Example of single-label classification:"),bi=l(),k(wo.$$.fragment),yi=l(),k(Lo.$$.fragment),Ci=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),k($o.$$.fragment),$i=l(),k(Ro.$$.fragment),Ns=l(),vt=a("h2"),jt=a("a"),os=a("span"),k(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Ds=l(),de=a("div"),k(Eo.$$.fragment),Ei=l(),ss=a("p"),Fi=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Fo=a("p"),zi=n("This model inherits from "),un=a("a"),xi=n("TFPreTrainedModel"),Pi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ji=l(),qo=a("p"),Si=n("This model is also a "),zo=a("a"),Ii=n("tf.keras.Model"),Ni=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Di=l(),k(St.$$.fragment),Oi=l(),Se=a("div"),k(xo.$$.fragment),Ai=l(),kt=a("p"),Hi=n("The "),mn=a("a"),Wi=n("TFCTRLModel"),Bi=n(" forward method, overrides the "),as=a("code"),Ui=n("__call__"),Vi=n(" special method."),Gi=l(),k(It.$$.fragment),Ki=l(),rs=a("p"),Xi=n("Example:"),Ji=l(),k(Po.$$.fragment),Os=l(),bt=a("h2"),Nt=a("a"),is=a("span"),k(jo.$$.fragment),Qi=l(),ls=a("span"),Yi=n("TFCTRLLMHeadModel"),As=l(),ce=a("div"),k(So.$$.fragment),Zi=l(),ds=a("p"),el=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dl=l(),k(Dt.$$.fragment),cl=l(),Ie=a("div"),k(Oo.$$.fragment),pl=l(),yt=a("p"),hl=n("The "),gn=a("a"),ul=n("TFCTRLLMHeadModel"),ml=n(" forward method, overrides the "),cs=a("code"),fl=n("__call__"),gl=n(" special method."),_l=l(),k(Ot.$$.fragment),Tl=l(),ps=a("p"),vl=n("Example:"),kl=l(),k(Ao.$$.fragment),Hs=l(),Ct=a("h2"),At=a("a"),hs=a("span"),k(Ho.$$.fragment),bl=l(),us=a("span"),yl=n("TFCTRLForSequenceClassification"),Ws=l(),X=a("div"),k(Wo.$$.fragment),Cl=l(),ms=a("p"),wl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),Ll=l(),_n=a("p"),Tn=a("a"),$l=n("TFCTRLForSequenceClassification"),Rl=n(` uses the last token in order to do the classification, as other causal models
...
the left.`),ud.forEach(t),Oe=d(Bt),me=r(Bt,"LI",{});var Vs=i(me);N=s(Vs,`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows CTRL to generate syntactically coherent text as it can be
observed in the `),qe=r(Vs,"EM",{});var md=i(qe);Ae=s(md,"run_generation.py"),md.forEach(t),He=s(Vs," example script."),Vs.forEach(t),D=d(Bt),x=r(Bt,"LI",{});var Ze=i(x);We=s(Ze,"The PyTorch models can take the "),ze=r(Ze,"CODE",{});var fd=i(ze);K=s(fd,"past_key_values"),fd.forEach(t),Be=s(Ze,` as input, which is the previously computed key/value attention pairs.
...
documentation from `),on=r(yn,"A",{href:!0});var Ed=i(on);Ia=s(Ed,"PretrainedConfig"),Ed.forEach(t),Na=s(yn," for more information."),yn.forEach(t),Da=d(et),xn=r(et,"P",{});var Fd=i(xn);Oa=s(Fd,"Examples:"),Fd.forEach(t),Aa=d(et),b(Yt.$$.fragment,et),et.forEach(t),Fs=d(o),ht=r(o,"H2",{class:!0});var Ks=i(ht);Mt=r(Ks,"A",{id:!0,class:!0,href:!0});var qd=i(Mt);Pn=r(qd,"SPAN",{});var zd=i(Pn);b(Zt.$$.fragment,zd),zd.forEach(t),qd.forEach(t),Ha=d(Ks),jn=r(Ks,"SPAN",{});var xd=i(jn);Wa=s(xd,"CTRLTokenizer"),xd.forEach(t),Ks.forEach(t),qs=d(o),Ne=r(o,"DIV",{class:!0});var Vt=i(Ne);b(eo.$$.fragment,Vt),Ba=d(Vt),Sn=r(Vt,"P",{});var Pd=i(Sn);Ua=s(Pd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Pd.forEach(t),Va=d(Vt),to=r(Vt,"P",{});var Xs=i(to);Ga=s(Xs,"This tokenizer inherits from "),nn=r(Xs,"A",{href:!0});var jd=i(nn);Ka=s(jd,"PreTrainedTokenizer"),jd.forEach(t),Xa=s(Xs,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Xs.forEach(t),Ja=d(Vt),sn=r(Vt,"DIV",{class:!0});var Sd=i(sn);b(oo.$$.fragment,Sd),Sd.forEach(t),Vt.forEach(t),zs=d(o),ut=r(o,"H2",{class:!0});var Js=i(ut);Et=r(Js,"A",{id:!0,class:!0,href:!0});var Id=i(Et);In=r(Id,"SPAN",{});var Nd=i(In);b(no.$$.fragment,Nd),Nd.forEach(t),Id.forEach(t),Qa=d(Js),Nn=r(Js,"SPAN",{});var Dd=i(Nn);Ya=s(Dd,"CTRLModel"),Dd.forEach(t),Js.forEach(t),xs=d(o),$e=r(o,"DIV",{class:!0});var tt=i($e);b(so.$$.fragment,tt),Za=d(tt),Dn=r(tt,"P",{});var Od=i(Dn);er=s(Od,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Od.forEach(t),tr=d(tt),ao=r(tt,"P",{});var Qs=i(ao);or=s(Qs,"This model inherits from "),an=r(Qs,"A",{href:!0});var Ad=i(an);nr=s(Ad,"PreTrainedModel"),Ad.forEach(t),sr=s(Qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),dr=d(tt),Pe=r(tt,"DIV",{class:!0});var ot=i(Pe);b(lo.$$.fragment,ot),cr=d(ot),mt=r(ot,"P",{});var Cn=i(mt);pr=s(Cn,"The "),rn=r(Cn,"A",{href:!0});var Wd=i(rn);hr=s(Wd,"CTRLModel"),Wd.forEach(t),ur=s(Cn," forward method, overrides the "),On=r(Cn,"CODE",{});var Bd=i(On);mr=s(Bd,"__call__"),Bd.forEach(t),fr=s(Cn," special method."),Cn.forEach(t),gr=d(ot),b(Ft.$$.fragment,ot),_r=d(ot),An=r(ot,"P",{});var Ud=i(An);Tr=s(Ud,"Example:"),Ud.forEach(t),vr=d(ot),b(co.$$.fragment,ot),ot.forEach(t),tt.forEach(t),Ps=d(o),ft=r(o,"H2",{class:!0});var Zs=i(ft);qt=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=i(qt);Hn=r(Vd,"SPAN",{});var Gd=i(Hn);b(po.$$.fragment,Gd),Gd.forEach(t),Vd.forEach(t),kr=d(Zs),Wn=r(Zs,"SPAN",{});var Kd=i(Wn);br=s(Kd,"CTRLLMHeadModel"),Kd.forEach(t),Zs.forEach(t),js=d(o),Re=r(o,"DIV",{class:!0});var nt=i(Re);b(ho.$$.fragment,nt),yr=d(nt),Bn=r(nt,"P",{});var Xd=i(Bn);Cr=s(Xd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ia.forEach(t),Di=d(Ge),b(St.$$.fragment,Ge),Oi=d(Ge),Se=r(Ge,"DIV",{class:!0});var rt=i(Se);b(xo.$$.fragment,rt),Ai=d(rt),kt=r(rt,"P",{});var $n=i(kt);Hi=s($n,"The "),mn=r($n,"A",{href:!0});var bc=i(mn);Wi=s(bc,"TFCTRLModel"),bc.forEach(t),Bi=s($n," forward method, overrides the "),as=r($n,"CODE",{});var yc=i(as);Ui=s(yc,"__call__"),yc.forEach(t),Vi=s($n," special method."),$n.forEach(t),Gi=d(rt),b(It.$$.fragment,rt),Ki=d(rt),rs=r(rt,"P",{});var Cc=i(rs);Xi=s(Cc,"Example:"),Cc.forEach(t),Ji=d(rt),b(Po.$$.fragment,rt),rt.forEach(t),Ge.forEach(t),Os=d(o),bt=r(o,"H2",{class:!0});var la=i(bt);Nt=r(la,"A",{id:!0,class:!0,href:!0});var wc=i(Nt);is=r(wc,"SPAN",{});var Lc=i(is);b(jo.$$.fragment,Lc),Lc.forEach(t),wc.forEach(t),Qi=d(la),ls=r(la,"SPAN",{});var $c=i(ls);Yi=s($c,"TFCTRLLMHeadModel"),$c.forEach(t),la.forEach(t),As=d(o),ce=r(o,"DIV",{class:!0});var Ke=i(ce);b(So.$$.fragment,Ke),Zi=d(Ke),ds=r(Ke,"P",{});var Rc=i(ds);el=s(Rc,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
padding tokens when `),_s=r(lt,"CODE",{});var Oc=i(_s);Pl=s(Oc,"inputs_embeds"),Oc.forEach(t),jl=s(lt," are passed instead of "),Ts=r(lt,"CODE",{});var Ac=i(Ts);Sl=s(Ac,"input_ids"),Ac.forEach(t),Il=s(lt,`, it does the same (take the last value in
each row of the batch).`),lt.forEach(t),Nl=d(ge),Bo=r(ge,"P",{});var ha=i(Bo);Dl=s(ha,"This model inherits from "),vn=r(ha,"A",{href:!0});var Hc=i(vn);Ol=s(Hc,"TFPreTrainedModel"),Hc.forEach(t),Al=s(ha,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
