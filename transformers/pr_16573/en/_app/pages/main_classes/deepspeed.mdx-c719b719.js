...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16573/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
the visible scope of available GPUs. Instead, you have to use the following syntax:`),e7=u(),f(Ro.$$.fragment),s7=u(),Xf=o("p"),t7=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pw=u(),ji=o("a"),iw=u(),Ts=o("h3"),Ht=o("a"),Qf=o("span"),f(Io.$$.fragment),a7=u(),ed=o("span"),n7=a("Deployment in Notebooks"),uw=u(),Bt=o("p"),o7=a("The problem with running notebook cells as a script is that there is no normal "),sd=o("code"),l7=a("deepspeed"),r7=a(` launcher to rely on, so
under certain setups we have to emulate it.`),cw=u(),gi=o("p"),p7=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),hw=u(),f(Uo.$$.fragment),fw=u(),Wt=o("p"),i7=a("Note: "),td=o("code"),u7=a("..."),c7=a(" stands for the normal arguments that you\u2019d pass to the functions."),dw=u(),wi=o("p"),h7=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),mw=u(),yi=o("p"),f7=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),_w=u(),f(Go.$$.fragment),vw=u(),Le=o("p"),d7=a("If the training script is in a normal file and not in the notebook cells, you can launch "),ad=o("code"),m7=a("deepspeed"),_7=a(` normally via
shell from a cell. For example, to use `),nd=o("code"),v7=a("run_translation.py"),j7=a(" you would launch it with:"),jw=u(),f(Lo.$$.fragment),gw=u(),Ft=o("p"),g7=a("or with "),od=o("code"),w7=a("%%bash"),y7=a(" magic, where you can write a multi-line code for the shell program to run:"),ww=u(),f(Mo.$$.fragment),yw=u(),bi=o("p"),b7=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),bw=u(),Vt=o("p"),E7=a("Note: While "),ld=o("code"),q7=a("%%bash"),$7=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Ew=u(),Ei=o("a"),qw=u(),As=o("h3"),Yt=o("a"),rd=o("span"),f(Zo.$$.fragment),k7=u(),pd=o("span"),P7=a("Configuration"),$w=u(),Kt=o("p"),D7=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=o("a"),z7=a("following documentation"),O7=a("."),kw=u(),Jt=o("p"),T7=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=o("a"),A7=a(`the DeepSpeedExamples
repo`),S7=a(":"),Pw=u(),f(Bo.$$.fragment),Dw=u(),Xt=o("p"),C7=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),id=o("code"),x7=a(".json"),R7=a(" files with:"),zw=u(),f(Wo.$$.fragment),Ow=u(),Qt=o("p"),I7=a("Some more examples are to be found in the "),Fo=o("a"),U7=a("main repo"),G7=a(" as well."),Tw=u(),qi=o("p"),L7=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Aw=u(),oe=o("p"),M7=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
...
precision training if `),hd=o("code"),W7=a("--fp16"),F7=a(" is passed:"),Sw=u(),f(Vo.$$.fragment),Cw=u(),ea=o("p"),V7=a("When you execute the program, DeepSpeed will log the configuration it received from the "),$i=o("a"),Y7=a("Trainer"),K7=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),xw=u(),ki=o("a"),Rw=u(),Ss=o("h3"),sa=o("a"),fd=o("span"),f(Yo.$$.fragment),J7=u(),dd=o("span"),X7=a("Passing Configuration"),Iw=u(),G=o("p"),Q7=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
and its typically accessed much faster than normal CPU memory.`),gy=u(),Ki=o("p"),Vd=o("strong"),Yk=a("Performance tuning:"),wy=u(),ca=o("ul"),il=o("li"),Yd=o("code"),Kk=a("stage3_max_live_parameters"),Jk=a(": "),Kd=o("code"),Xk=a("1e9"),Qk=u(),ul=o("li"),Jd=o("code"),e9=a("stage3_max_reuse_distance"),s9=a(": "),Xd=o("code"),t9=a("1e9"),yy=u(),M=o("p"),a9=a("If hitting OOM reduce "),Qd=o("code"),n9=a("stage3_max_live_parameters"),o9=a(" and "),em=o("code"),l9=a("stage3_max_reuse_distance"),r9=a(`. They should have minimal impact
...
the visible scope of available GPUs. Instead, you have to use the following syntax:`),kE.forEach(t),e7=c(mh),d(Ro.$$.fragment,mh),s7=c(mh),Xf=l(mh,"P",{});var _M=r(Xf);t7=n(_M,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),_M.forEach(t),mh.forEach(t),dM.forEach(t),pw=c(e),ji=l(e,"A",{id:!0}),r(ji).forEach(t),iw=c(e),Ts=l(e,"H3",{class:!0});var PE=r(Ts);Ht=l(PE,"A",{id:!0,class:!0,href:!0});var vM=r(Ht);Qf=l(vM,"SPAN",{});var jM=r(Qf);d(Io.$$.fragment,jM),jM.forEach(t),vM.forEach(t),a7=c(PE),ed=l(PE,"SPAN",{});var gM=r(ed);n7=n(gM,"Deployment in Notebooks"),gM.forEach(t),PE.forEach(t),uw=c(e),Bt=l(e,"P",{});var DE=r(Bt);o7=n(DE,"The problem with running notebook cells as a script is that there is no normal "),sd=l(DE,"CODE",{});var wM=r(sd);l7=n(wM,"deepspeed"),wM.forEach(t),r7=n(DE,` launcher to rely on, so
under certain setups we have to emulate it.`),DE.forEach(t),cw=c(e),gi=l(e,"P",{});var yM=r(gi);p7=n(yM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),yM.forEach(t),hw=c(e),d(Uo.$$.fragment,e),fw=c(e),Wt=l(e,"P",{});var zE=r(Wt);i7=n(zE,"Note: "),td=l(zE,"CODE",{});var bM=r(td);u7=n(bM,"..."),bM.forEach(t),c7=n(zE," stands for the normal arguments that you\u2019d pass to the functions."),zE.forEach(t),dw=c(e),wi=l(e,"P",{});var EM=r(wi);h7=n(EM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),EM.forEach(t),mw=c(e),yi=l(e,"P",{});var qM=r(yi);f7=n(qM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),qM.forEach(t),_w=c(e),d(Go.$$.fragment,e),vw=c(e),Le=l(e,"P",{});var _h=r(Le);d7=n(_h,"If the training script is in a normal file and not in the notebook cells, you can launch "),ad=l(_h,"CODE",{});var $M=r(ad);m7=n($M,"deepspeed"),$M.forEach(t),_7=n(_h,` normally via
shell from a cell. For example, to use `),nd=l(_h,"CODE",{});var kM=r(nd);v7=n(kM,"run_translation.py"),kM.forEach(t),j7=n(_h," you would launch it with:"),_h.forEach(t),jw=c(e),d(Lo.$$.fragment,e),gw=c(e),Ft=l(e,"P",{});var OE=r(Ft);g7=n(OE,"or with "),od=l(OE,"CODE",{});var PM=r(od);w7=n(PM,"%%bash"),PM.forEach(t),y7=n(OE," magic, where you can write a multi-line code for the shell program to run:"),OE.forEach(t),ww=c(e),d(Mo.$$.fragment,e),yw=c(e),bi=l(e,"P",{});var DM=r(bi);b7=n(DM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),DM.forEach(t),bw=c(e),Vt=l(e,"P",{});var TE=r(Vt);E7=n(TE,"Note: While "),ld=l(TE,"CODE",{});var zM=r(ld);q7=n(zM,"%%bash"),zM.forEach(t),$7=n(TE,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),TE.forEach(t),Ew=c(e),Ei=l(e,"A",{id:!0}),r(Ei).forEach(t),qw=c(e),As=l(e,"H3",{class:!0});var AE=r(As);Yt=l(AE,"A",{id:!0,class:!0,href:!0});var OM=r(Yt);rd=l(OM,"SPAN",{});var TM=r(rd);d(Zo.$$.fragment,TM),TM.forEach(t),OM.forEach(t),k7=c(AE),pd=l(AE,"SPAN",{});var AM=r(pd);P7=n(AM,"Configuration"),AM.forEach(t),AE.forEach(t),$w=c(e),Kt=l(e,"P",{});var SE=r(Kt);D7=n(SE,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=l(SE,"A",{href:!0,rel:!0});var SM=r(No);z7=n(SM,"following documentation"),SM.forEach(t),O7=n(SE,"."),SE.forEach(t),kw=c(e),Jt=l(e,"P",{});var CE=r(Jt);T7=n(CE,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=l(CE,"A",{href:!0,rel:!0});var CM=r(Ho);A7=n(CM,`the DeepSpeedExamples
repo`),CM.forEach(t),S7=n(CE,":"),CE.forEach(t),Pw=c(e),d(Bo.$$.fragment,e),Dw=c(e),Xt=l(e,"P",{});var xE=r(Xt);C7=n(xE,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),id=l(xE,"CODE",{});var xM=r(id);x7=n(xM,".json"),xM.forEach(t),R7=n(xE," files with:"),xE.forEach(t),zw=c(e),d(Wo.$$.fragment,e),Ow=c(e),Qt=l(e,"P",{});var RE=r(Qt);I7=n(RE,"Some more examples are to be found in the "),Fo=l(RE,"A",{href:!0,rel:!0});var RM=r(Fo);U7=n(RM,"main repo"),RM.forEach(t),G7=n(RE," as well."),RE.forEach(t),Tw=c(e),qi=l(e,"P",{});var IM=r(qi);L7=n(IM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),IM.forEach(t),Aw=c(e),oe=l(e,"P",{});var Nn=r(oe);M7=n(Nn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
