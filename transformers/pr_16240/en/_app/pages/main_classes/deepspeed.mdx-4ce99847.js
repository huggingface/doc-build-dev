...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),cp=new w({}),hp=new Zj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16240/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),fp=new Zj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16240/src/transformers/deepspeed.py#L114"}}),dp=new Zj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16240/src/transformers/deepspeed.py#L105"}}),_p=new Zj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16240/src/transformers/deepspeed.py#L146"}}),vp=new Zj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16240/src/transformers/deepspeed.py#L137"}}),jp=new w({}),gp=new g({props:{code:`#!/usr/bin/env python
...
Memory Wall for Extreme Scale Deep Learning`),X6=a("."),Bj=u(),Ip=o("p"),Q6=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),Wj=u(),Up=o("p"),e4=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),Fj=u(),Et=o("p"),s4=a("\u{1F917} Transformers integrates "),no=o("a"),t4=a("DeepSpeed"),a4=a(" via 2 options:"),Vj=u(),qt=o("ol"),oo=o("li"),n4=a("Integration of the core DeepSpeed features via "),Gp=o("a"),o4=a("Trainer"),l4=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),r4=u(),Y=o("li"),p4=a("If you don\u2019t use "),Lp=o("a"),i4=a("Trainer"),u4=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),lf=o("code"),c4=a("from_pretrained"),h4=a(" and "),rf=o("code"),f4=a("from_config"),d4=a(` include integration of essential
parts of DeepSpeed like `),pf=o("code"),m4=a("zero.Init"),_4=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Mp=o("a"),v4=a("deepspeed-non-trainer-integration"),j4=a("."),Yj=u(),Zp=o("p"),g4=a("What is integrated:"),Kj=u(),Np=o("p"),w4=a("Training:"),Jj=u(),Hp=o("ol"),uf=o("li"),y4=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),Xj=u(),Bp=o("p"),b4=a("Inference:"),Qj=u(),Wp=o("ol"),lo=o("li"),E4=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Fp=o("a"),q4=a("deepspeed-zero-inference"),$4=a("."),eg=u(),Vp=o("p"),k4=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),sg=u(),Yp=o("a"),tg=u(),ks=o("h2"),$t=o("a"),cf=o("span"),f(ro.$$.fragment),P4=u(),hf=o("span"),D4=a("Trainer Deepspeed Integration"),ag=u(),Kp=o("a"),ng=u(),Ps=o("h3"),kt=o("a"),ff=o("span"),f(po.$$.fragment),z4=u(),df=o("span"),O4=a("Installation"),og=u(),Jp=o("p"),T4=a("Install the library via pypi:"),lg=u(),f(io.$$.fragment),rg=u(),Ce=o("p"),A4=a("or via "),mf=o("code"),S4=a("transformers"),C4=a("\u2019 "),_f=o("code"),x4=a("extras"),R4=a(":"),pg=u(),f(uo.$$.fragment),ig=u(),xe=o("p"),I4=a("or find more details on "),co=o("a"),U4=a("the DeepSpeed\u2019s GitHub page"),G4=a(` and
`),ho=o("a"),L4=a("advanced install"),M4=a("."),ug=u(),Pt=o("p"),Z4=a("If you\u2019re still struggling with the build, first make sure to read "),Xp=o("a"),N4=a("zero-install-notes"),H4=a("."),cg=u(),Qp=o("p"),B4=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),hg=u(),ei=o("p"),W4=a("To make a local build for DeepSpeed:"),fg=u(),f(fo.$$.fragment),dg=u(),Re=o("p"),F4=a("If you intend to use NVMe offload you will also need to include "),vf=o("code"),V4=a("DS_BUILD_AIO=1"),Y4=a(` in the instructions above (and also
install `),jf=o("em"),K4=a("libaio-dev"),J4=a(" system-wide)."),mg=u(),Dt=o("p"),X4=a("Edit "),gf=o("code"),Q4=a("TORCH_CUDA_ARCH_LIST"),e$=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),_g=u(),f(mo.$$.fragment),vg=u(),Pe=o("p"),s$=a("So if you get "),wf=o("code"),t$=a("8, 6"),a$=a(", then use "),yf=o("code"),n$=a('TORCH_CUDA_ARCH_LIST="8.6"'),o$=a(`. If you have multiple different cards, you can list all
of them like so `),bf=o("code"),l$=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),jg=u(),si=o("p"),r$=a("If you need to use the same setup on multiple machines, make a binary wheel:"),gg=u(),f(_o.$$.fragment),wg=u(),Ie=o("p"),p$=a("it will generate something like "),Ef=o("code"),i$=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),u$=a(` which now you can install
as `),qf=o("code"),c$=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),h$=a(" locally or on any other machine."),yg=u(),zt=o("p"),f$=a("Again, remember to ensure to adjust "),$f=o("code"),d$=a("TORCH_CUDA_ARCH_LIST"),m$=a(" to the target architectures."),bg=u(),Ue=o("p"),_$=a("You can find the complete list of NVIDIA GPUs and their corresponding "),kf=o("strong"),v$=a("Compute Capabilities"),j$=a(` (same as arch in this
context) `),vo=o("a"),g$=a("here"),w$=a("."),Eg=u(),ti=o("p"),y$=a("You can check the archs pytorch was built with using:"),qg=u(),f(jo.$$.fragment),$g=u(),ai=o("p"),b$=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),E$=a("If the output is:"),Dg=u(),f(wo.$$.fragment),zg=u(),Ot=o("p"),q$=a("then you know that this card\u2019s arch is "),Pf=o("code"),$$=a("8.6"),k$=a("."),Og=u(),Tt=o("p"),P$=a("You can also leave "),Df=o("code"),D$=a("TORCH_CUDA_ARCH_LIST"),z$=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Tg=u(),At=o("p"),O$=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),yo=o("a"),T$=a("Deepspeed"),A$=a(","),Ag=u(),oi=o("a"),Sg=u(),Ds=o("h3"),St=o("a"),zf=o("span"),f(bo.$$.fragment),S$=u(),Of=o("span"),C$=a("Deployment with multiple GPUs"),Cg=u(),Ct=o("p"),x$=a("To deploy this feature with multiple GPUs adjust the "),li=o("a"),R$=a("Trainer"),I$=a(` command line arguments as
following:`),xg=u(),xt=o("ol"),zs=o("li"),U$=a("replace "),Tf=o("code"),G$=a("python -m torch.distributed.launch"),L$=a(" with "),Af=o("code"),M$=a("deepspeed"),Z$=a("."),N$=u(),De=o("li"),H$=a("add a new argument "),Sf=o("code"),B$=a("--deepspeed ds_config.json"),W$=a(", where "),Cf=o("code"),F$=a("ds_config.json"),V$=a(` is the DeepSpeed configuration file as
documented `),Eo=o("a"),Y$=a("here"),K$=a(". The file naming is up to you."),Rg=u(),ri=o("p"),J$=a("Therefore, if your original command line looked as follows:"),Ig=u(),f(qo.$$.fragment),Ug=u(),pi=o("p"),X$=a("Now it should be:"),Gg=u(),f($o.$$.fragment),Lg=u(),U=o("p"),Q$=a("Unlike, "),xf=o("code"),e5=a("torch.distributed.launch"),s5=a(" where you have to specify how many GPUs to use with "),Rf=o("code"),t5=a("--nproc_per_node"),a5=a(`, with the
...
Memory Wall for Extreme Scale Deep Learning`),DG.forEach(t),X6=n(lh,"."),lh.forEach(t),Bj=c(e),Ip=l(e,"P",{});var zG=r(Ip);Q6=n(zG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),zG.forEach(t),Wj=c(e),Up=l(e,"P",{});var OG=r(Up);e4=n(OG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),OG.forEach(t),Fj=c(e),Et=l(e,"P",{});var sE=r(Et);s4=n(sE,"\u{1F917} Transformers integrates "),no=l(sE,"A",{href:!0,rel:!0});var TG=r(no);t4=n(TG,"DeepSpeed"),TG.forEach(t),a4=n(sE," via 2 options:"),sE.forEach(t),Vj=c(e),qt=l(e,"OL",{});var tE=r(qt);oo=l(tE,"LI",{});var aE=r(oo);n4=n(aE,"Integration of the core DeepSpeed features via "),Gp=l(aE,"A",{href:!0});var AG=r(Gp);o4=n(AG,"Trainer"),AG.forEach(t),l4=n(aE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),aE.forEach(t),r4=c(tE),Y=l(tE,"LI",{});var ge=r(Y);p4=n(ge,"If you don\u2019t use "),Lp=l(ge,"A",{href:!0});var SG=r(Lp);i4=n(SG,"Trainer"),SG.forEach(t),u4=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),lf=l(ge,"CODE",{});var CG=r(lf);c4=n(CG,"from_pretrained"),CG.forEach(t),h4=n(ge," and "),rf=l(ge,"CODE",{});var xG=r(rf);f4=n(xG,"from_config"),xG.forEach(t),d4=n(ge,` include integration of essential
parts of DeepSpeed like `),pf=l(ge,"CODE",{});var RG=r(pf);m4=n(RG,"zero.Init"),RG.forEach(t),_4=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Mp=l(ge,"A",{href:!0});var IG=r(Mp);v4=n(IG,"deepspeed-non-trainer-integration"),IG.forEach(t),j4=n(ge,"."),ge.forEach(t),tE.forEach(t),Yj=c(e),Zp=l(e,"P",{});var UG=r(Zp);g4=n(UG,"What is integrated:"),UG.forEach(t),Kj=c(e),Np=l(e,"P",{});var GG=r(Np);w4=n(GG,"Training:"),GG.forEach(t),Jj=c(e),Hp=l(e,"OL",{});var LG=r(Hp);uf=l(LG,"LI",{});var MG=r(uf);y4=n(MG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),MG.forEach(t),LG.forEach(t),Xj=c(e),Bp=l(e,"P",{});var ZG=r(Bp);b4=n(ZG,"Inference:"),ZG.forEach(t),Qj=c(e),Wp=l(e,"OL",{});var NG=r(Wp);lo=l(NG,"LI",{});var nE=r(lo);E4=n(nE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Fp=l(nE,"A",{href:!0});var HG=r(Fp);q4=n(HG,"deepspeed-zero-inference"),HG.forEach(t),$4=n(nE,"."),nE.forEach(t),NG.forEach(t),eg=c(e),Vp=l(e,"P",{});var BG=r(Vp);k4=n(BG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),BG.forEach(t),sg=c(e),Yp=l(e,"A",{id:!0}),r(Yp).forEach(t),tg=c(e),ks=l(e,"H2",{class:!0});var oE=r(ks);$t=l(oE,"A",{id:!0,class:!0,href:!0});var WG=r($t);cf=l(WG,"SPAN",{});var FG=r(cf);d(ro.$$.fragment,FG),FG.forEach(t),WG.forEach(t),P4=c(oE),hf=l(oE,"SPAN",{});var VG=r(hf);D4=n(VG,"Trainer Deepspeed Integration"),VG.forEach(t),oE.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),Ps=l(e,"H3",{class:!0});var lE=r(Ps);kt=l(lE,"A",{id:!0,class:!0,href:!0});var YG=r(kt);ff=l(YG,"SPAN",{});var KG=r(ff);d(po.$$.fragment,KG),KG.forEach(t),YG.forEach(t),z4=c(lE),df=l(lE,"SPAN",{});var JG=r(df);O4=n(JG,"Installation"),JG.forEach(t),lE.forEach(t),og=c(e),Jp=l(e,"P",{});var XG=r(Jp);T4=n(XG,"Install the library via pypi:"),XG.forEach(t),lg=c(e),d(io.$$.fragment,e),rg=c(e),Ce=l(e,"P",{});var rh=r(Ce);A4=n(rh,"or via "),mf=l(rh,"CODE",{});var QG=r(mf);S4=n(QG,"transformers"),QG.forEach(t),C4=n(rh,"\u2019 "),_f=l(rh,"CODE",{});var eL=r(_f);x4=n(eL,"extras"),eL.forEach(t),R4=n(rh,":"),rh.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),xe=l(e,"P",{});var ph=r(xe);I4=n(ph,"or find more details on "),co=l(ph,"A",{href:!0,rel:!0});var sL=r(co);U4=n(sL,"the DeepSpeed\u2019s GitHub page"),sL.forEach(t),G4=n(ph,` and
`),ho=l(ph,"A",{href:!0,rel:!0});var tL=r(ho);L4=n(tL,"advanced install"),tL.forEach(t),M4=n(ph,"."),ph.forEach(t),ug=c(e),Pt=l(e,"P",{});var rE=r(Pt);Z4=n(rE,"If you\u2019re still struggling with the build, first make sure to read "),Xp=l(rE,"A",{href:!0});var aL=r(Xp);N4=n(aL,"zero-install-notes"),aL.forEach(t),H4=n(rE,"."),rE.forEach(t),cg=c(e),Qp=l(e,"P",{});var nL=r(Qp);B4=n(nL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),nL.forEach(t),hg=c(e),ei=l(e,"P",{});var oL=r(ei);W4=n(oL,"To make a local build for DeepSpeed:"),oL.forEach(t),fg=c(e),d(fo.$$.fragment,e),dg=c(e),Re=l(e,"P",{});var ih=r(Re);F4=n(ih,"If you intend to use NVMe offload you will also need to include "),vf=l(ih,"CODE",{});var lL=r(vf);V4=n(lL,"DS_BUILD_AIO=1"),lL.forEach(t),Y4=n(ih,` in the instructions above (and also
install `),jf=l(ih,"EM",{});var rL=r(jf);K4=n(rL,"libaio-dev"),rL.forEach(t),J4=n(ih," system-wide)."),ih.forEach(t),mg=c(e),Dt=l(e,"P",{});var pE=r(Dt);X4=n(pE,"Edit "),gf=l(pE,"CODE",{});var pL=r(gf);Q4=n(pL,"TORCH_CUDA_ARCH_LIST"),pL.forEach(t),e$=n(pE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),pE.forEach(t),_g=c(e),d(mo.$$.fragment,e),vg=c(e),Pe=l(e,"P",{});var Tp=r(Pe);s$=n(Tp,"So if you get "),wf=l(Tp,"CODE",{});var iL=r(wf);t$=n(iL,"8, 6"),iL.forEach(t),a$=n(Tp,", then use "),yf=l(Tp,"CODE",{});var uL=r(yf);n$=n(uL,'TORCH_CUDA_ARCH_LIST="8.6"'),uL.forEach(t),o$=n(Tp,`. If you have multiple different cards, you can list all
of them like so `),bf=l(Tp,"CODE",{});var cL=r(bf);l$=n(cL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),cL.forEach(t),Tp.forEach(t),jg=c(e),si=l(e,"P",{});var hL=r(si);r$=n(hL,"If you need to use the same setup on multiple machines, make a binary wheel:"),hL.forEach(t),gg=c(e),d(_o.$$.fragment,e),wg=c(e),Ie=l(e,"P",{});var uh=r(Ie);p$=n(uh,"it will generate something like "),Ef=l(uh,"CODE",{});var fL=r(Ef);i$=n(fL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),fL.forEach(t),u$=n(uh,` which now you can install
as `),qf=l(uh,"CODE",{});var dL=r(qf);c$=n(dL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),dL.forEach(t),h$=n(uh," locally or on any other machine."),uh.forEach(t),yg=c(e),zt=l(e,"P",{});var iE=r(zt);f$=n(iE,"Again, remember to ensure to adjust "),$f=l(iE,"CODE",{});var mL=r($f);d$=n(mL,"TORCH_CUDA_ARCH_LIST"),mL.forEach(t),m$=n(iE," to the target architectures."),iE.forEach(t),bg=c(e),Ue=l(e,"P",{});var ch=r(Ue);_$=n(ch,"You can find the complete list of NVIDIA GPUs and their corresponding "),kf=l(ch,"STRONG",{});var _L=r(kf);v$=n(_L,"Compute Capabilities"),_L.forEach(t),j$=n(ch,` (same as arch in this
context) `),vo=l(ch,"A",{href:!0,rel:!0});var vL=r(vo);g$=n(vL,"here"),vL.forEach(t),w$=n(ch,"."),ch.forEach(t),Eg=c(e),ti=l(e,"P",{});var jL=r(ti);y$=n(jL,"You can check the archs pytorch was built with using:"),jL.forEach(t),qg=c(e),d(jo.$$.fragment,e),$g=c(e),ai=l(e,"P",{});var gL=r(ai);b$=n(gL,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),gL.forEach(t),kg=c(e),d(go.$$.fragment,e),Pg=c(e),ni=l(e,"P",{});var wL=r(ni);E$=n(wL,"If the output is:"),wL.forEach(t),Dg=c(e),d(wo.$$.fragment,e),zg=c(e),Ot=l(e,"P",{});var uE=r(Ot);q$=n(uE,"then you know that this card\u2019s arch is "),Pf=l(uE,"CODE",{});var yL=r(Pf);$$=n(yL,"8.6"),yL.forEach(t),k$=n(uE,"."),uE.forEach(t),Og=c(e),Tt=l(e,"P",{});var cE=r(Tt);P$=n(cE,"You can also leave "),Df=l(cE,"CODE",{});var bL=r(Df);D$=n(bL,"TORCH_CUDA_ARCH_LIST"),bL.forEach(t),z$=n(cE,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),cE.forEach(t),Tg=c(e),At=l(e,"P",{});var hE=r(At);O$=n(hE,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),yo=l(hE,"A",{href:!0,rel:!0});var EL=r(yo);T$=n(EL,"Deepspeed"),EL.forEach(t),A$=n(hE,","),hE.forEach(t),Ag=c(e),oi=l(e,"A",{id:!0}),r(oi).forEach(t),Sg=c(e),Ds=l(e,"H3",{class:!0});var fE=r(Ds);St=l(fE,"A",{id:!0,class:!0,href:!0});var qL=r(St);zf=l(qL,"SPAN",{});var $L=r(zf);d(bo.$$.fragment,$L),$L.forEach(t),qL.forEach(t),S$=c(fE),Of=l(fE,"SPAN",{});var kL=r(Of);C$=n(kL,"Deployment with multiple GPUs"),kL.forEach(t),fE.forEach(t),Cg=c(e),Ct=l(e,"P",{});var dE=r(Ct);x$=n(dE,"To deploy this feature with multiple GPUs adjust the "),li=l(dE,"A",{href:!0});var PL=r(li);R$=n(PL,"Trainer"),PL.forEach(t),I$=n(dE,` command line arguments as
following:`),dE.forEach(t),xg=c(e),xt=l(e,"OL",{});var mE=r(xt);zs=l(mE,"LI",{});var hh=r(zs);U$=n(hh,"replace "),Tf=l(hh,"CODE",{});var DL=r(Tf);G$=n(DL,"python -m torch.distributed.launch"),DL.forEach(t),L$=n(hh," with "),Af=l(hh,"CODE",{});var zL=r(Af);M$=n(zL,"deepspeed"),zL.forEach(t),Z$=n(hh,"."),hh.forEach(t),N$=c(mE),De=l(mE,"LI",{});var Ln=r(De);H$=n(Ln,"add a new argument "),Sf=l(Ln,"CODE",{});var OL=r(Sf);B$=n(OL,"--deepspeed ds_config.json"),OL.forEach(t),W$=n(Ln,", where "),Cf=l(Ln,"CODE",{});var TL=r(Cf);F$=n(TL,"ds_config.json"),TL.forEach(t),V$=n(Ln,` is the DeepSpeed configuration file as
documented `),Eo=l(Ln,"A",{href:!0,rel:!0});var AL=r(Eo);Y$=n(AL,"here"),AL.forEach(t),K$=n(Ln,". The file naming is up to you."),Ln.forEach(t),mE.forEach(t),Rg=c(e),ri=l(e,"P",{});var SL=r(ri);J$=n(SL,"Therefore, if your original command line looked as follows:"),SL.forEach(t),Ig=c(e),d(qo.$$.fragment,e),Ug=c(e),pi=l(e,"P",{});var CL=r(pi);X$=n(CL,"Now it should be:"),CL.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),U=l(e,"P",{});var we=r(U);Q$=n(we,"Unlike, "),xf=l(we,"CODE",{});var xL=r(xf);e5=n(xL,"torch.distributed.launch"),xL.forEach(t),s5=n(we," where you have to specify how many GPUs to use with "),Rf=l(we,"CODE",{});var RL=r(Rf);t5=n(RL,"--nproc_per_node"),RL.forEach(t),a5=n(we,`, with the
