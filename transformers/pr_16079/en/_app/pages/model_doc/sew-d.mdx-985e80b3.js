import{S as Ea,i as Sa,s as Wa,e as n,k as d,w as v,t as r,M as Da,c as s,d as o,m as c,a,x as w,h as i,b as l,F as e,g as f,y as b,q as y,o as E,B as S}from"../../chunks/vendor-4833417e.js";import{T as ks}from"../../chunks/Tip-fffd6df1.js";import{D as Je}from"../../chunks/Docstring-4f315ed9.js";import{C as ft}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ht}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function ka(I){let m,W,h,_,D;return{c(){m=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),D=r(`
...
instance of <a href="/docs/transformers/pr_16079/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.SEWDConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16079/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.SEWDConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16079/en/model_doc/sew-d#transformers.SEWDConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">292</span>, <span class="hljs-number">384</span>]`}}),Ce=new ht({}),Te=new Je({props:{name:"class transformers.SEWDForCTC",anchor:"transformers.SEWDForCTC",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16079/src/transformers/models/sew_d/modeling_sew_d.py#L1501",parametersDescription:[{anchor:"transformers.SEWDForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16079/en/model_doc/sew-d#transformers.SEWDConfig">SEWDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16079/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Pe=new Je({props:{name:"forward",anchor:"transformers.SEWDForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16079/src/transformers/models/sew_d/modeling_sew_d.py#L1542",parametersDescription:[{anchor:"transformers.SEWDForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16079/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){m=n("meta"),W=d(),h=n("h1"),_=n("a"),D=n("span"),v(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Vt=d(),N=n("h2"),Z=n("a"),ut=n("span"),v(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),Ot=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),pe=n("a"),Eo=r(`Performance-Efficiency Trade-offs
...
library implements for all its model (such as downloading or saving etc.).`),zn=d(),xe=n("p"),An=r("This model is a PyTorch "),je=n("a"),Vn=r("torch.nn.Module"),On=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ln=d(),C=n("div"),v(Pe.$$.fragment),In=d(),Y=n("p"),Nn=r("The "),st=n("a"),Kn=r("SEWDForCTC"),Hn=r(" forward method, overrides the "),$t=n("code"),Rn=r("__call__"),Un=r(" special method."),Jn=d(),v(ie.$$.fragment),Qn=d(),qt=n("p"),Bn=r("Example:"),Yn=d(),v(Fe.$$.fragment),Gn=d(),v(Me.$$.fragment),Gt=d(),G=n("h2"),le=n("a"),xt=n("span"),v(ze.$$.fragment),Xn=d(),jt=n("span"),Zn=r("SEWDForSequenceClassification"),Xt=d(),k=n("div"),v(Ae.$$.fragment),es=d(),Pt=n("p"),ts=r(`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),os=d(),Ve=n("p"),ns=r("SEW-D was proposed in "),Oe=n("a"),ss=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),as=r(` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),rs=d(),Le=n("p"),is=r("This model inherits from "),at=n("a"),ls=r("PreTrainedModel"),ds=r(`. Check the superclass documentation for the generic methods the
...
using `),Ge=s(no,"A",{href:!0});var As=a(Ge);qo=i(As,"Wav2Vec2CTCTokenizer"),As.forEach(o),xo=i(no,"."),no.forEach(o),oo.forEach(o),Ht=c(t),oe=s(t,"P",{});var so=a(oe);jo=i(so,"This model was contributed by "),fe=s(so,"A",{href:!0,rel:!0});var Vs=a(fe);Po=i(Vs,"anton-l"),Vs.forEach(o),Fo=i(so,"."),so.forEach(o),Rt=c(t),K=s(t,"H2",{class:!0});var ao=a(K);ne=s(ao,"A",{id:!0,class:!0,href:!0});var Os=a(ne);wt=s(Os,"SPAN",{});var Ls=a(wt);w(he.$$.fragment,Ls),Ls.forEach(o),Os.forEach(o),Mo=c(ao),bt=s(ao,"SPAN",{});var Is=a(bt);zo=i(Is,"SEWDConfig"),Is.forEach(o),ao.forEach(o),Ut=c(t),$=s(t,"DIV",{class:!0});var A=a($);w(ue.$$.fragment,A),Ao=c(A),H=s(A,"P",{});var it=a(H);Vo=i(it,"This is the configuration class to store the configuration of a "),Xe=s(it,"A",{href:!0});var Ns=a(Xe);Oo=i(Ns,"SEWDModel"),Ns.forEach(o),Lo=i(it,`. It is used to instantiate a SEW-D
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the SEW-D
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(V),P=s(V,"DIV",{class:!0});var O=a(P);w(De.$$.fragment,O),hn=c(O),J=s(O,"P",{});var dt=a(J);un=i(dt,"The "),ot=s(dt,"A",{href:!0});var Zs=a(ot);gn=i(Zs,"SEWDModel"),Zs.forEach(o),_n=i(dt," forward method, overrides the "),Wt=s(dt,"CODE",{});var ea=a(Wt);vn=i(ea,"__call__"),ea.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(O),w(ae.$$.fragment,O),yn=c(O),Dt=s(O,"P",{});var ta=a(Dt);En=i(ta,"Example:"),ta.forEach(o),Sn=c(O),w(ke.$$.fragment,O),O.forEach(o),V.forEach(o),Bt=c(t),Q=s(t,"H2",{class:!0});var po=a(Q);re=s(po,"A",{id:!0,class:!0,href:!0});var oa=a(re);kt=s(oa,"SPAN",{});var na=a(kt);w(Ce.$$.fragment,na),na.forEach(o),oa.forEach(o),Wn=c(po),Ct=s(po,"SPAN",{});var sa=a(Ct);Dn=i(sa,"SEWDForCTC"),sa.forEach(o),po.forEach(o),Yt=c(t),x=s(t,"DIV",{class:!0});var L=a(x);w(Te.$$.fragment,L),kn=c(L),B=s(L,"P",{});var ct=a(B);Cn=i(ct,"SEW-D Model with a "),Tt=s(ct,"CODE",{});var aa=a(Tt);Tn=i(aa,"language modeling"),aa.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),ct.forEach(o),jn=c(L),qe=s(L,"P",{});var mo=a(qe);Pn=i(mo,"This model inherits from "),nt=s(mo,"A",{href:!0});var ia=a(nt);Fn=i(ia,"PreTrainedModel"),ia.forEach(o),Mn=i(mo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),mo.forEach(o),zn=c(L),xe=s(L,"P",{});var fo=a(xe);An=i(fo,"This model is a PyTorch "),je=s(fo,"A",{href:!0,rel:!0});var la=a(je);Vn=i(la,"torch.nn.Module"),la.forEach(o),On=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),Ln=c(L),C=s(L,"DIV",{class:!0});var F=a(C);w(Pe.$$.fragment,F),In=c(F),Y=s(F,"P",{});var pt=a(Y);Nn=i(pt,"The "),st=s(pt,"A",{href:!0});var da=a(st);Kn=i(da,"SEWDForCTC"),da.forEach(o),Hn=i(pt," forward method, overrides the "),$t=s(pt,"CODE",{});var ca=a($t);Rn=i(ca,"__call__"),ca.forEach(o),Un=i(pt," special method."),pt.forEach(o),Jn=c(F),w(ie.$$.fragment,F),Qn=c(F),qt=s(F,"P",{});var pa=a(qt);Bn=i(pa,"Example:"),pa.forEach(o),Yn=c(F),w(Fe.$$.fragment,F),Gn=c(F),w(Me.$$.fragment,F),F.forEach(o),L.forEach(o),Gt=c(t),G=s(t,"H2",{class:!0});var ho=a(G);le=s(ho,"A",{id:!0,class:!0,href:!0});var ma=a(le);xt=s(ma,"SPAN",{});var fa=a(xt);w(ze.$$.fragment,fa),fa.forEach(o),ma.forEach(o),Xn=c(ho),jt=s(ho,"SPAN",{});var ha=a(jt);Zn=i(ha,"SEWDForSequenceClassification"),ha.forEach(o),ho.forEach(o),Xt=c(t),k=s(t,"DIV",{class:!0});var M=a(k);w(Ae.$$.fragment,M),es=c(M),Pt=s(M,"P",{});var ua=a(Pt);ts=i(ua,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),ua.forEach(o),os=c(M),Ve=s(M,"P",{});var uo=a(Ve);ns=i(uo,"SEW-D was proposed in "),Oe=s(uo,"A",{href:!0,rel:!0});var ga=a(Oe);ss=i(ga,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
Recognition`),ga.forEach(o),as=i(uo,` by Felix Wu, Kwangyoun Kim, Jing Pan, Kyu Han, Kilian Q. Weinberger,
Yoav Artzi.`),uo.forEach(o),rs=c(M),Le=s(M,"P",{});var go=a(Le);is=i(go,"This model inherits from "),at=s(go,"A",{href:!0});var _a=a(at);ls=i(_a,"PreTrainedModel"),_a.forEach(o),ds=i(go,`. Check the superclass documentation for the generic methods the
