...
context) `),uo=o("a"),V5=a("here"),Y5=a("."),ew=u(),Bp=o("p"),K5=a("You can check the archs pytorch was built with using:"),sw=u(),f(co.$$.fragment),tw=u(),Wp=o("p"),J5=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),aw=u(),f(ho.$$.fragment),nw=u(),Fp=o("p"),X5=a("If the output is:"),ow=u(),f(fo.$$.fragment),lw=u(),kt=o("p"),Q5=a("then you know that this card\u2019s arch is "),ff=o("code"),e4=a("8.6"),s4=a("."),rw=u(),Pt=o("p"),t4=a("You can also leave "),df=o("code"),a4=a("TORCH_CUDA_ARCH_LIST"),n4=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),pw=u(),zt=o("p"),o4=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=o("a"),l4=a("Deepspeed"),r4=a(","),iw=u(),Vp=o("a"),uw=u(),$s=o("h3"),Dt=o("a"),mf=o("span"),f(_o.$$.fragment),p4=u(),_f=o("span"),i4=a("Deployment with multiple GPUs"),cw=u(),Ot=o("p"),u4=a("To deploy this feature with multiple GPUs adjust the "),Yp=o("a"),c4=a("Trainer"),h4=a(` command line arguments as
following:`),hw=u(),At=o("ol"),ks=o("li"),f4=a("replace "),vf=o("code"),d4=a("python -m torch.distributed.launch"),m4=a(" with "),jf=o("code"),_4=a("deepspeed"),v4=a("."),j4=u(),Pe=o("li"),w4=a("add a new argument "),wf=o("code"),y4=a("--deepspeed ds_config.json"),g4=a(", where "),yf=o("code"),b4=a("ds_config.json"),q4=a(` is the DeepSpeed configuration file as
documented `),vo=o("a"),E4=a("here"),$4=a(". The file naming is up to you."),fw=u(),Kp=o("p"),k4=a("Therefore, if your original command line looked as follows:"),dw=u(),f(jo.$$.fragment),mw=u(),Jp=o("p"),P4=a("Now it should be:"),_w=u(),f(wo.$$.fragment),vw=u(),I=o("p"),z4=a("Unlike, "),gf=o("code"),D4=a("torch.distributed.launch"),O4=a(" where you have to specify how many GPUs to use with "),bf=o("code"),A4=a("--nproc_per_node"),T4=a(`, with the
`),qf=o("code"),S4=a("deepspeed"),C4=a(" launcher you don\u2019t have to use the corresponding "),Ef=o("code"),x4=a("--num_gpus"),R4=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=o("a"),I4=a("here"),U4=a("."),jw=u(),ae=o("p"),G4=a("In fact, you can continue using "),$f=o("code"),M4=a("-m torch.distributed.launch"),L4=a(` with DeepSpeed as long as you don\u2019t need to use
`),kf=o("code"),Z4=a("deepspeed"),N4=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Pf=o("code"),H4=a("deepspeed"),B4=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),ww=u(),Tt=o("p"),W4=a("Here is an example of running "),zf=o("code"),F4=a("run_translation.py"),V4=a(" under DeepSpeed deploying all available GPUs:"),yw=u(),f(go.$$.fragment),gw=u(),St=o("p"),Y4=a("Note that in the DeepSpeed documentation you are likely to see "),Df=o("code"),K4=a("--deepspeed --deepspeed_config ds_config.json"),J4=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),bw=u(),Ct=o("p"),X4=a("For some practical usage examples, please, see this "),bo=o("a"),Q4=a("post"),e$=a("."),qw=u(),Xp=o("a"),Ew=u(),Ps=o("h3"),xt=o("a"),Of=o("span"),f(qo.$$.fragment),s$=u(),Af=o("span"),t$=a("Deployment with one GPU"),$w=u(),Rt=o("p"),a$=a("To deploy DeepSpeed with one GPU adjust the "),Qp=o("a"),n$=a("Trainer"),o$=a(" command line arguments as follows:"),kw=u(),f(Eo.$$.fragment),Pw=u(),Ue=o("p"),l$=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
...
context) `),uo=l(eh,"A",{href:!0,rel:!0});var bG=r(uo);V5=n(bG,"here"),bG.forEach(t),Y5=n(eh,"."),eh.forEach(t),ew=c(e),Bp=l(e,"P",{});var qG=r(Bp);K5=n(qG,"You can check the archs pytorch was built with using:"),qG.forEach(t),sw=c(e),d(co.$$.fragment,e),tw=c(e),Wp=l(e,"P",{});var EG=r(Wp);J5=n(EG,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),EG.forEach(t),aw=c(e),d(ho.$$.fragment,e),nw=c(e),Fp=l(e,"P",{});var $G=r(Fp);X5=n($G,"If the output is:"),$G.forEach(t),ow=c(e),d(fo.$$.fragment,e),lw=c(e),kt=l(e,"P",{});var Z0=r(kt);Q5=n(Z0,"then you know that this card\u2019s arch is "),ff=l(Z0,"CODE",{});var kG=r(ff);e4=n(kG,"8.6"),kG.forEach(t),s4=n(Z0,"."),Z0.forEach(t),rw=c(e),Pt=l(e,"P",{});var N0=r(Pt);t4=n(N0,"You can also leave "),df=l(N0,"CODE",{});var PG=r(df);a4=n(PG,"TORCH_CUDA_ARCH_LIST"),PG.forEach(t),n4=n(N0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),N0.forEach(t),pw=c(e),zt=l(e,"P",{});var H0=r(zt);o4=n(H0,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=l(H0,"A",{href:!0,rel:!0});var zG=r(mo);l4=n(zG,"Deepspeed"),zG.forEach(t),r4=n(H0,","),H0.forEach(t),iw=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),uw=c(e),$s=l(e,"H3",{class:!0});var B0=r($s);Dt=l(B0,"A",{id:!0,class:!0,href:!0});var DG=r(Dt);mf=l(DG,"SPAN",{});var OG=r(mf);d(_o.$$.fragment,OG),OG.forEach(t),DG.forEach(t),p4=c(B0),_f=l(B0,"SPAN",{});var AG=r(_f);i4=n(AG,"Deployment with multiple GPUs"),AG.forEach(t),B0.forEach(t),cw=c(e),Ot=l(e,"P",{});var W0=r(Ot);u4=n(W0,"To deploy this feature with multiple GPUs adjust the "),Yp=l(W0,"A",{href:!0});var TG=r(Yp);c4=n(TG,"Trainer"),TG.forEach(t),h4=n(W0,` command line arguments as
following:`),W0.forEach(t),hw=c(e),At=l(e,"OL",{});var F0=r(At);ks=l(F0,"LI",{});var sh=r(ks);f4=n(sh,"replace "),vf=l(sh,"CODE",{});var SG=r(vf);d4=n(SG,"python -m torch.distributed.launch"),SG.forEach(t),m4=n(sh," with "),jf=l(sh,"CODE",{});var CG=r(jf);_4=n(CG,"deepspeed"),CG.forEach(t),v4=n(sh,"."),sh.forEach(t),j4=c(F0),Pe=l(F0,"LI",{});var Sn=r(Pe);w4=n(Sn,"add a new argument "),wf=l(Sn,"CODE",{});var xG=r(wf);y4=n(xG,"--deepspeed ds_config.json"),xG.forEach(t),g4=n(Sn,", where "),yf=l(Sn,"CODE",{});var RG=r(yf);b4=n(RG,"ds_config.json"),RG.forEach(t),q4=n(Sn,` is the DeepSpeed configuration file as
documented `),vo=l(Sn,"A",{href:!0,rel:!0});var IG=r(vo);E4=n(IG,"here"),IG.forEach(t),$4=n(Sn,". The file naming is up to you."),Sn.forEach(t),F0.forEach(t),fw=c(e),Kp=l(e,"P",{});var UG=r(Kp);k4=n(UG,"Therefore, if your original command line looked as follows:"),UG.forEach(t),dw=c(e),d(jo.$$.fragment,e),mw=c(e),Jp=l(e,"P",{});var GG=r(Jp);P4=n(GG,"Now it should be:"),GG.forEach(t),_w=c(e),d(wo.$$.fragment,e),vw=c(e),I=l(e,"P",{});var we=r(I);z4=n(we,"Unlike, "),gf=l(we,"CODE",{});var MG=r(gf);D4=n(MG,"torch.distributed.launch"),MG.forEach(t),O4=n(we," where you have to specify how many GPUs to use with "),bf=l(we,"CODE",{});var LG=r(bf);A4=n(LG,"--nproc_per_node"),LG.forEach(t),T4=n(we,`, with the
`),qf=l(we,"CODE",{});var ZG=r(qf);S4=n(ZG,"deepspeed"),ZG.forEach(t),C4=n(we," launcher you don\u2019t have to use the corresponding "),Ef=l(we,"CODE",{});var NG=r(Ef);x4=n(NG,"--num_gpus"),NG.forEach(t),R4=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=l(we,"A",{href:!0,rel:!0});var HG=r(yo);I4=n(HG,"here"),HG.forEach(t),U4=n(we,"."),we.forEach(t),jw=c(e),ae=l(e,"P",{});var Cn=r(ae);G4=n(Cn,"In fact, you can continue using "),$f=l(Cn,"CODE",{});var BG=r($f);M4=n(BG,"-m torch.distributed.launch"),BG.forEach(t),L4=n(Cn,` with DeepSpeed as long as you don\u2019t need to use
`),kf=l(Cn,"CODE",{});var WG=r(kf);Z4=n(WG,"deepspeed"),WG.forEach(t),N4=n(Cn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Pf=l(Cn,"CODE",{});var FG=r(Pf);H4=n(FG,"deepspeed"),FG.forEach(t),B4=n(Cn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Cn.forEach(t),ww=c(e),Tt=l(e,"P",{});var V0=r(Tt);W4=n(V0,"Here is an example of running "),zf=l(V0,"CODE",{});var VG=r(zf);F4=n(VG,"run_translation.py"),VG.forEach(t),V4=n(V0," under DeepSpeed deploying all available GPUs:"),V0.forEach(t),yw=c(e),d(go.$$.fragment,e),gw=c(e),St=l(e,"P",{});var Y0=r(St);Y4=n(Y0,"Note that in the DeepSpeed documentation you are likely to see "),Df=l(Y0,"CODE",{});var YG=r(Df);K4=n(YG,"--deepspeed --deepspeed_config ds_config.json"),YG.forEach(t),J4=n(Y0,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Y0.forEach(t),bw=c(e),Ct=l(e,"P",{});var K0=r(Ct);X4=n(K0,"For some practical usage examples, please, see this "),bo=l(K0,"A",{href:!0,rel:!0});var KG=r(bo);Q4=n(KG,"post"),KG.forEach(t),e$=n(K0,"."),K0.forEach(t),qw=c(e),Xp=l(e,"A",{id:!0}),r(Xp).forEach(t),Ew=c(e),Ps=l(e,"H3",{class:!0});var J0=r(Ps);xt=l(J0,"A",{id:!0,class:!0,href:!0});var JG=r(xt);Of=l(JG,"SPAN",{});var XG=r(Of);d(qo.$$.fragment,XG),XG.forEach(t),JG.forEach(t),s$=c(J0),Af=l(J0,"SPAN",{});var QG=r(Af);t$=n(QG,"Deployment with one GPU"),QG.forEach(t),J0.forEach(t),$w=c(e),Rt=l(e,"P",{});var X0=r(Rt);a$=n(X0,"To deploy DeepSpeed with one GPU adjust the "),Qp=l(X0,"A",{href:!0});var eM=r(Qp);n$=n(eM,"Trainer"),eM.forEach(t),o$=n(X0," command line arguments as follows:"),X0.forEach(t),kw=c(e),d(Eo.$$.fragment,e),Pw=c(e),Ue=l(e,"P",{});var th=r(Ue);l$=n(th,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
