import{S as wh,i as Lh,s as xh,e as n,k as d,w as v,t as r,M as $h,c as s,d as t,m as l,a,x as y,h as i,b as c,F as e,g as h,y as T,q as b,o as M,B as w,v as zh}from"../../chunks/vendor-6b77c823.js";import{T as Jt}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-af1d0ae0.js";import{C as mn}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ue}from"../../chunks/IconCopyLink-7a11ce68.js";function Xh(I){let p,x,f,k,L;return{c(){p=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),k=r("Module"),L=r(`
...
first positional argument :`),Te=d(),E=n("ul"),q=n("li"),pe=r("a single Tensor with "),ne=n("code"),xe=r("input_ids"),he=r(" only and nothing else: "),H=n("code"),Ce=r("model(input_ids)"),$e=d(),G=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),P=s(Ne,"CODE",{});var re=a(P);be=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(m,X){h(m,p,X),e(p,x),h(m,f,X),h(m,k,X),e(k,L),e(L,_),e(k,g),e(k,$),e($,Ge),h(m,ce,X),h(m,z,X),e(z,ee),e(z,B),e(B,te),e(z,Ee),e(z,R),e(R,qe),e(z,Le),h(m,S,X),h(m,V,X),e(V,oe),h(m,Te,X),h(m,E,X),e(E,q),e(q,pe),e(q,ne),e(ne,xe),e(q,he),e(q,H),e(H,Ce),e(E,$e),e(E,G),e(G,Pe),e(G,A),e(A,Ae),e(G,je),e(G,j),e(j,Oe),e(E,De),e(E,W),e(W,J),e(W,P),e(P,be)},d(m){m&&t(p),m&&t(f),m&&t(k),m&&t(ce),m&&t(z),m&&t(S),m&&t(V),m&&t(Te),m&&t(E)}}}function Eh(I){let p,x,f,k,L;return{c(){p=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),k=r("Module"),L=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=a(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);k=i($,"Module"),$.forEach(t),L=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(_,g){h(_,p,g),e(p,x),e(p,f),e(f,k),e(p,L)},d(_){_&&t(p)}}}function qh(I){let p,x,f,k,L,_,g,$,Ge,ce,z,ee,B,te,Ee,R,qe,Le,S,V,oe,Te,E,q,pe,ne,xe,he,H,Ce,$e,G,Pe,A,Ae,je,j,Oe,De,W,J,P,be;return{c(){p=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),f=d(),k=n("ul"),L=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),$=n("li"),Ge=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),z=n("p"),ee=r("This second option is useful when using "),B=n("code"),te=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),qe=r("model(inputs)"),Le=r("."),S=d(),V=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=d(),E=n("ul"),q=n("li"),pe=r("a single Tensor with "),ne=n("code"),xe=r("input_ids"),he=r(" only and nothing else: "),H=n("code"),Ce=r("model(input_ids)"),$e=d(),G=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),A=n("code"),Ae=r("model([input_ids, attention_mask])"),je=r(" or "),j=n("code"),Oe=r("model([input_ids, attention_mask, token_type_ids])"),De=d(),W=n("li"),J=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),P=n("code"),be=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=s(m,"P",{});var X=a(p);x=i(X,"TF 2.0 models accepts two formats as inputs:"),X.forEach(t),f=l(m),k=s(m,"UL",{});var se=a(k);L=s(se,"LI",{});var at=a(L);_=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),g=l(se),$=s(se,"LI",{});var Be=a($);Ge=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),se.forEach(t),ce=l(m),z=s(m,"P",{});var F=a(z);ee=i(F,"This second option is useful when using "),B=s(F,"CODE",{});var Me=a(B);te=i(Me,"tf.keras.Model.fit"),Me.forEach(t),Ee=i(F,` method which currently requires having all the
...
not make use of token type ids, therefore a list of zeros is returned.`),Bc.forEach(t),Ga.forEach(t),Dr=l(ve),bn=s(ve,"DIV",{class:!0});var Rc=a(bn);y(ro.$$.fragment,Rc),Rc.forEach(t),ve.forEach(t),la=l(o),ht=s(o,"H2",{class:!0});var Ea=a(ht);zt=s(Ea,"A",{id:!0,class:!0,href:!0});var Vc=a(zt);ns=s(Vc,"SPAN",{});var Hc=a(ns);y(io.$$.fragment,Hc),Hc.forEach(t),Vc.forEach(t),Nr=l(Ea),ss=s(Ea,"SPAN",{});var Jc=a(ss);Ir=i(Jc,"XGLMTokenizerFast"),Jc.forEach(t),Ea.forEach(t),ca=l(o),ie=s(o,"DIV",{class:!0});var Je=a(ie);y(lo.$$.fragment,Je),Sr=l(Je),we=s(Je,"P",{});var Ke=a(we);Wr=i(Ke,"Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),as=s(Ke,"EM",{});var Kc=a(as);Ur=i(Kc,"tokenizers"),Kc.forEach(t),Br=i(Ke," library). Adapted from "),Mn=s(Ke,"A",{href:!0});var Zc=a(Mn);Rr=i(Zc,"RobertaTokenizer"),Zc.forEach(t),Vr=i(Ke,`
