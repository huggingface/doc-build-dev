import{S as wh,i as Lh,s as xh,e as n,k as d,w as v,t as r,M as $h,c as s,d as t,m as l,a,x as y,h as i,b as c,F as e,g as h,y as T,q as b,o as M,B as w,v as zh}from"../../chunks/vendor-6b77c823.js";import{T as Jt}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-abef54e3.js";import{C as mn}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ue}from"../../chunks/IconCopyLink-7a11ce68.js";function Xh(I){let p,x,f,k,L;return{c(){p=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),k=r("Module"),L=r(`
...
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=a(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);k=i($,"Module"),$.forEach(t),L=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(_,g){h(_,p,g),e(p,x),e(p,f),e(f,k),e(p,L)},d(_){_&&t(p)}}}function Gh(I){let p,x,f,k,L,_,g,$,Ge,ce,z,ee,B,te,Ee,R,qe,Le,S,H,oe,Te,E,q,pe,ne,xe,he,V,Ce,$e,G,Pe,A,Ae,je,j,Oe,De,W,J,P,be;return{c(){p=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),f=d(),k=n("ul"),L=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),$=n("li"),Ge=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),z=n("p"),ee=r("This second option is useful when using "),B=n("code"),te=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),qe=r("model(inputs)"),Le=r("."),S=d(),H=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=d(),E=n("ul"),q=n("li"),pe=r("a single Tensor with "),ne=n("code"),xe=r("input_ids"),he=r(" only and nothing else: "),V=n("code"),Ce=r("model(input_ids)"),$e=d(),G=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
tensors in the first argument of the model call function: `),R=s(F,"CODE",{});var rt=a(R);qe=i(rt,"model(inputs)"),rt.forEach(t),Le=i(F,"."),F.forEach(t),S=l(m),H=s(m,"P",{});var ae=a(H);oe=i(ae,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ae.forEach(t),Te=l(m),E=s(m,"UL",{});var K=a(E);q=s(K,"LI",{});var U=a(q);pe=i(U,"a single Tensor with "),ne=s(U,"CODE",{});var it=a(ne);xe=i(it,"input_ids"),it.forEach(t),he=i(U," only and nothing else: "),V=s(U,"CODE",{});var dt=a(V);Ce=i(dt,"model(input_ids)"),dt.forEach(t),U.forEach(t),$e=l(K),G=s(K,"LI",{});var O=a(G);Pe=i(O,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),P=s(Ne,"CODE",{});var re=a(P);be=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(m,X){h(m,p,X),e(p,x),h(m,f,X),h(m,k,X),e(k,L),e(L,_),e(k,g),e(k,$),e($,Ge),h(m,ce,X),h(m,z,X),e(z,ee),e(z,B),e(B,te),e(z,Ee),e(z,R),e(R,qe),e(z,Le),h(m,S,X),h(m,H,X),e(H,oe),h(m,Te,X),h(m,E,X),e(E,q),e(q,pe),e(q,ne),e(ne,xe),e(q,he),e(q,V),e(V,Ce),e(E,$e),e(E,G),e(G,Pe),e(G,A),e(A,Ae),e(G,je),e(G,j),e(j,Oe),e(E,De),e(E,W),e(W,J),e(W,P),e(P,be)},d(m){m&&t(p),m&&t(f),m&&t(k),m&&t(ce),m&&t(z),m&&t(S),m&&t(H),m&&t(Te),m&&t(E)}}}function Eh(I){let p,x,f,k,L;return{c(){p=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),k=r("Module"),L=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=a(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);k=i($,"Module"),$.forEach(t),L=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(_,g){h(_,p,g),e(p,x),e(p,f),e(f,k),e(p,L)},d(_){_&&t(p)}}}function qh(I){let p,x,f,k,L,_,g,$,Ge,ce,z,ee,B,te,Ee,R,qe,Le,S,H,oe,Te,E,q,pe,ne,xe,he,V,Ce,$e,G,Pe,A,Ae,je,j,Oe,De,W,J,P,be;return{c(){p=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),f=d(),k=n("ul"),L=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),g=d(),$=n("li"),Ge=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),z=n("p"),ee=r("This second option is useful when using "),B=n("code"),te=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),qe=r("model(inputs)"),Le=r("."),S=d(),H=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=d(),E=n("ul"),q=n("li"),pe=r("a single Tensor with "),ne=n("code"),xe=r("input_ids"),he=r(" only and nothing else: "),V=n("code"),Ce=r("model(input_ids)"),$e=d(),G=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),A=n("code"),Ae=r("model([input_ids, attention_mask])"),je=r(" or "),j=n("code"),Oe=r("model([input_ids, attention_mask, token_type_ids])"),De=d(),W=n("li"),J=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),P=n("code"),be=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=s(m,"P",{});var X=a(p);x=i(X,"TF 2.0 models accepts two formats as inputs:"),X.forEach(t),f=l(m),k=s(m,"UL",{});var se=a(k);L=s(se,"LI",{});var at=a(L);_=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),g=l(se),$=s(se,"LI",{});var Be=a($);Ge=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),se.forEach(t),ce=l(m),z=s(m,"P",{});var F=a(z);ee=i(F,"This second option is useful when using "),B=s(F,"CODE",{});var Me=a(B);te=i(Me,"tf.keras.Model.fit"),Me.forEach(t),Ee=i(F,` method which currently requires having all the
...
first positional argument :`),ae.forEach(t),Te=l(m),E=s(m,"UL",{});var K=a(E);q=s(K,"LI",{});var U=a(q);pe=i(U,"a single Tensor with "),ne=s(U,"CODE",{});var it=a(ne);xe=i(it,"input_ids"),it.forEach(t),he=i(U," only and nothing else: "),V=s(U,"CODE",{});var dt=a(V);Ce=i(dt,"model(input_ids)"),dt.forEach(t),U.forEach(t),$e=l(K),G=s(K,"LI",{});var O=a(G);Pe=i(O,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),A=s(O,"CODE",{});var lt=a(A);Ae=i(lt,"model([input_ids, attention_mask])"),lt.forEach(t),je=i(O," or "),j=s(O,"CODE",{});var ct=a(j);Oe=i(ct,"model([input_ids, attention_mask, token_type_ids])"),ct.forEach(t),O.forEach(t),De=l(K),W=s(K,"LI",{});var Ne=a(W);J=i(Ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),P=s(Ne,"CODE",{});var re=a(P);be=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(m,X){h(m,p,X),e(p,x),h(m,f,X),h(m,k,X),e(k,L),e(L,_),e(k,g),e(k,$),e($,Ge),h(m,ce,X),h(m,z,X),e(z,ee),e(z,B),e(B,te),e(z,Ee),e(z,R),e(R,qe),e(z,Le),h(m,S,X),h(m,H,X),e(H,oe),h(m,Te,X),h(m,E,X),e(E,q),e(q,pe),e(q,ne),e(ne,xe),e(q,he),e(q,V),e(V,Ce),e(E,$e),e(E,G),e(G,Pe),e(G,A),e(A,Ae),e(G,je),e(G,j),e(j,Oe),e(E,De),e(E,W),e(W,J),e(W,P),e(P,be)},d(m){m&&t(p),m&&t(f),m&&t(k),m&&t(ce),m&&t(z),m&&t(S),m&&t(H),m&&t(Te),m&&t(E)}}}function Ch(I){let p,x,f,k,L;return{c(){p=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),k=r("Module"),L=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=a(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);k=i($,"Module"),$.forEach(t),L=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var g=a(p);x=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var $=a(f);k=i($,"Module"),$.forEach(t),L=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(_,g){h(_,p,g),e(p,x),e(p,f),e(f,k),e(p,L)},d(_){_&&t(p)}}}function jh(I){let p,x,f,k,L,_,g,$,Ge,ce,z,ee,B,te,Ee,R,qe,Le,S,H,oe,Te,E,q,pe,ne,xe,he,V,Ce,$e,G,Pe,A,Ae,je,j,Oe,De,W,J,P,be,m,X,se,at,Be,F,Me,rt,ae,K,U,it,dt,O,lt,ct,Ne,re,er,fn,tr,or,gn,nr,sr,ar,Jn,rr,ir,Kt,ia,pt,Lt,Kn,Zt,dr,Zn,lr,da,D,Qt,cr,Ie,pr,_n,hr,ur,kn,mr,fr,Yt,gr,_r,kr,eo,vr,vn,yr,Tr,br,Re,to,Mr,Qn,wr,Lr,oo,yn,xr,Yn,$r,zr,Tn,Xr,es,Fr,Gr,xt,no,Er,so,qr,ts,Cr,Pr,Ar,$t,ao,jr,os,Or,Dr,bn,ro,la,ht,zt,ns,io,Nr,ss,Ir,ca,ie,lo,Sr,we,Wr,as,Ur,Br,Mn,Rr,Hr,wn,Vr,Jr,co,Kr,Zr,Qr,po,Yr,Ln,ei,ti,oi,He,ho,ni,rs,si,ai,uo,xn,ri,is,ii,di,$n,li,ds,ci,pi,Xt,mo,hi,ls,ui,pa,ut,Ft,cs,fo,mi,ps,fi,ha,de,go,gi,_o,_i,zn,ki,vi,yi,ko,Ti,vo,bi,Mi,wi,Gt,Li,hs,xi,$i,us,zi,Xi,ue,yo,Fi,mt,Gi,Xn,Ei,qi,ms,Ci,Pi,Ai,Et,ji,fs,Oi,Di,To,ua,ft,qt,gs,bo,Ni,_s,Ii,ma,le,Mo,Si,ks,Wi,Ui,wo,Bi,Fn,Ri,Hi,Vi,Lo,Ji,xo,Ki,Zi,Qi,me,$o,Yi,gt,ed,Gn,td,od,vs,nd,sd,ad,Ct,rd,ys,id,dd,zo,fa,_t,Pt,Ts,Xo,ld,bs,cd,ga,Z,Fo,pd,Go,hd,En,ud,md,fd,Eo,gd,qo,_d,kd,vd,At,yd,jt,Td,Ms,bd,Md,ws,wd,Ld,fe,Co,xd,kt,$d,qn,zd,Xd,Ls,Fd,Gd,Ed,Ot,qd,xs,Cd,Pd,Po,_a,vt,Dt,$s,Ao,Ad,zs,jd,ka,Q,jo,Od,Xs,Dd,Nd,Oo,Id,Cn,Sd,Wd,Ud,Do,Bd,No,Rd,Hd,Vd,Nt,Jd,ge,Io,Kd,yt,Zd,Pn,Qd,Yd,Fs,el,tl,ol,It,nl,Gs,sl,al,So,va,Tt,St,Es,Wo,rl,qs,il,ya,Y,Uo,dl,Bo,ll,An,cl,pl,hl,Ro,ul,Ho,ml,fl,gl,Cs,_l,kl,Se,Ps,Vo,vl,yl,As,Jo,Tl,bl,js,Ko,Ml,wl,Os,Zo,Ll,xl,_e,Qo,$l,bt,zl,Ds,Xl,Fl,Ns,Gl,El,ql,Wt,Cl,Is,Pl,Al,Yo,Ta,Mt,Ut,Ss,en,jl,Ws,Ol,ba,N,tn,Dl,Us,Nl,Il,on,Sl,jn,Wl,Ul,Bl,nn,Rl,sn,Hl,Vl,Jl,Bs,Kl,Zl,We,Rs,an,Ql,Yl,Hs,rn,ec,tc,Vs,dn,oc,nc,Js,ln,sc,ac,ke,cn,rc,wt,ic,Ks,dc,lc,Zs,cc,pc,hc,Bt,uc,Qs,mc,fc,pn,Ma;return _=new Ue({}),te=new Ue({}),m=new Ue({}),Me=new C({props:{name:"class transformers.XGLMConfig",anchor:"transformers.XGLMConfig",parameters:[{name:"vocab_size",val:" = 256008"},{name:"max_position_embeddings",val:" = 2048"},{name:"d_model",val:" = 1024"},{name:"ffn_dim",val:" = 4096"},{name:"num_layers",val:" = 24"},{name:"attention_heads",val:" = 16"},{name:"activation_function",val:" = 'gelu'"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.0"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"scale_embedding",val:" = True"},{name:"use_cache",val:" = True"},{name:"decoder_start_token_id",val:" = 2"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16543/src/transformers/models/xglm/configuration_xglm.py#L29",parametersDescription:[{anchor:"transformers.XGLMConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 256008) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Xo=new Ue({}),Fo=new C({props:{name:"class transformers.TFXGLMModel",anchor:"transformers.TFXGLMModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16543/src/transformers/models/xglm/modeling_tf_xglm.py#L746",parametersDescription:[{anchor:"transformers.TFXGLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16543/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
Jeff Wang, Luke Zettlemoyer, Zornitsa Kozareva, Mona Diab, Veselin Stoyanov, Xian Li.`),q=d(),pe=n("p"),ne=r("The abstract from the paper is the following:"),xe=d(),he=n("p"),V=n("em"),Ce=r(`Large-scale autoregressive language models such as GPT-3 are few-shot learners that can perform a wide range of language
...
`),Yt=n("a"),gr=r("SentencePiece"),_r=r("."),kr=d(),eo=n("p"),vr=r("This tokenizer inherits from "),vn=n("a"),yr=r("PreTrainedTokenizer"),Tr=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),br=d(),Re=n("div"),v(to.$$.fragment),Mr=d(),Qn=n("p"),wr=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Lr=d(),oo=n("ul"),yn=n("li"),xr=r("single sequence: "),Yn=n("code"),$r=r("<s> X </s>"),zr=d(),Tn=n("li"),Xr=r("pair of sequences: "),es=n("code"),Fr=r("<s> A </s></s> B </s>"),Gr=d(),xt=n("div"),v(no.$$.fragment),Er=d(),so=n("p"),qr=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
not make use of token type ids, therefore a list of zeros is returned.`),Dr=d(),bn=n("div"),v(ro.$$.fragment),la=d(),ht=n("h2"),zt=n("a"),ns=n("span"),v(io.$$.fragment),Nr=d(),ss=n("span"),Ir=r("XGLMTokenizerFast"),ca=d(),ie=n("div"),v(lo.$$.fragment),Sr=d(),we=n("p"),Wr=r("Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),as=n("em"),Ur=r("tokenizers"),Br=r(" library). Adapted from "),Mn=n("a"),Rr=r("RobertaTokenizer"),Hr=r(`
and `),wn=n("a"),Vr=r("XLNetTokenizer"),Jr=r(`. Based on
...
refer to this superclass for more information regarding those methods.`),oi=d(),He=n("div"),v(ho.$$.fragment),ni=d(),rs=n("p"),si=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
etc.)`),yi=d(),ko=n("p"),Ti=r("This model is also a PyTorch "),vo=n("a"),bi=r("torch.nn.Module"),Mi=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wi=d(),Gt=n("p"),Li=r("Transformer decoder consisting of "),hs=n("em"),xi=r("config.num_layers"),$i=r(" layers. Each layer is a "),us=n("code"),zi=r("XGLMDecoderLayer"),Xi=d(),ue=n("div"),v(yo.$$.fragment),Fi=d(),mt=n("p"),Gi=r("The "),Xn=n("a"),Ei=r("XGLMModel"),qi=r(" forward method, overrides the "),ms=n("code"),Ci=r("__call__"),Pi=r(" special method."),Ai=d(),v(Et.$$.fragment),ji=d(),fs=n("p"),Oi=r("Example:"),Di=d(),v(To.$$.fragment),ua=d(),ft=n("h2"),qt=n("a"),gs=n("span"),v(bo.$$.fragment),Ni=d(),_s=n("span"),Ii=r("XGLMForCausalLM"),ma=d(),le=n("div"),v(Mo.$$.fragment),Si=d(),ks=n("p"),Wi=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Ui=d(),wo=n("p"),Bi=r("This model inherits from "),Fn=n("a"),Ri=r("PreTrainedModel"),Hi=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vi=d(),Lo=n("p"),Ji=r("This model is also a PyTorch "),xo=n("a"),Ki=r("torch.nn.Module"),Zi=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qi=d(),me=n("div"),v($o.$$.fragment),Yi=d(),gt=n("p"),ed=r("The "),Gn=n("a"),td=r("XGLMForCausalLM"),od=r(" forward method, overrides the "),vs=n("code"),nd=r("__call__"),sd=r(" special method."),ad=d(),v(Ct.$$.fragment),rd=d(),ys=n("p"),id=r("Example:"),dd=d(),v(zo.$$.fragment),fa=d(),_t=n("h2"),Pt=n("a"),Ts=n("span"),v(Xo.$$.fragment),ld=d(),bs=n("span"),cd=r("TFXGLMModel"),ga=d(),Z=n("div"),v(Fo.$$.fragment),pd=d(),Go=n("p"),hd=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),vd=d(),v(At.$$.fragment),yd=d(),jt=n("p"),Td=r("Transformer decoder consisting of "),Ms=n("em"),bd=r("config.num_layers"),Md=r(" layers. Each layer is a "),ws=n("code"),wd=r("TFXGLMDecoderLayer"),Ld=d(),fe=n("div"),v(Co.$$.fragment),xd=d(),kt=n("p"),$d=r("The "),qn=n("a"),zd=r("TFXGLMModel"),Xd=r(" forward method, overrides the "),Ls=n("code"),Fd=r("__call__"),Gd=r(" special method."),Ed=d(),v(Ot.$$.fragment),qd=d(),xs=n("p"),Cd=r("Example:"),Pd=d(),v(Po.$$.fragment),_a=d(),vt=n("h2"),Dt=n("a"),$s=n("span"),v(Ao.$$.fragment),Ad=d(),zs=n("span"),jd=r("TFXGLMForCausalLM"),ka=d(),Q=n("div"),v(jo.$$.fragment),Od=d(),Xs=n("p"),Dd=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud=d(),Do=n("p"),Bd=r("This model is also a "),No=n("a"),Rd=r("tf.keras.Model"),Hd=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),v(Nt.$$.fragment),Jd=d(),ge=n("div"),v(Io.$$.fragment),Kd=d(),yt=n("p"),Zd=r("The "),Pn=n("a"),Qd=r("TFXGLMForCausalLM"),Yd=r(" forward method, overrides the "),Fs=n("code"),el=r("__call__"),tl=r(" special method."),ol=d(),v(It.$$.fragment),nl=d(),Gs=n("p"),sl=r("Example:"),al=d(),v(So.$$.fragment),va=d(),Tt=n("h2"),St=n("a"),Es=n("span"),v(Wo.$$.fragment),rl=d(),qs=n("span"),il=r("FlaxXGLMModel"),ya=d(),Y=n("div"),v(Uo.$$.fragment),dl=d(),Bo=n("p"),ll=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
`),Ho=n("a"),ml=r("flax.nn.Module"),fl=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),gl=d(),Cs=n("p"),_l=r("Finally, this model supports inherent JAX features such as:"),kl=d(),Se=n("ul"),Ps=n("li"),Vo=n("a"),vl=r("Just-In-Time (JIT) compilation"),yl=d(),As=n("li"),Jo=n("a"),Tl=r("Automatic Differentiation"),bl=d(),js=n("li"),Ko=n("a"),Ml=r("Vectorization"),wl=d(),Os=n("li"),Zo=n("a"),Ll=r("Parallelization"),xl=d(),_e=n("div"),v(Qo.$$.fragment),$l=d(),bt=n("p"),zl=r("The "),Ds=n("code"),Xl=r("FlaxXGLMPreTrainedModel"),Fl=r("forward method, overrides the "),Ns=n("code"),Gl=r("__call__"),El=r(" special method."),ql=d(),v(Wt.$$.fragment),Cl=d(),Is=n("p"),Pl=r("Example:"),Al=d(),v(Yo.$$.fragment),Ta=d(),Mt=n("h2"),Ut=n("a"),Ss=n("span"),v(en.$$.fragment),jl=d(),Ws=n("span"),Ol=r("FlaxXGLMForCausalLM"),ba=d(),N=n("div"),v(tn.$$.fragment),Dl=d(),Us=n("p"),Nl=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
`),sn=n("a"),Hl=r("flax.nn.Module"),Vl=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jl=d(),Bs=n("p"),Kl=r("Finally, this model supports inherent JAX features such as:"),Zl=d(),We=n("ul"),Rs=n("li"),an=n("a"),Ql=r("Just-In-Time (JIT) compilation"),Yl=d(),Hs=n("li"),rn=n("a"),ec=r("Automatic Differentiation"),tc=d(),Vs=n("li"),dn=n("a"),oc=r("Vectorization"),nc=d(),Js=n("li"),ln=n("a"),sc=r("Parallelization"),ac=d(),ke=n("div"),v(cn.$$.fragment),rc=d(),wt=n("p"),ic=r("The "),Ks=n("code"),dc=r("FlaxXGLMPreTrainedModel"),lc=r("forward method, overrides the "),Zs=n("code"),cc=r("__call__"),pc=r(" special method."),hc=d(),v(Bt.$$.fragment),uc=d(),Qs=n("p"),mc=r("Example:"),fc=d(),v(pn.$$.fragment),this.h()},l(o){const u=$h('[data-svelte="svelte-1phssyn"]',document.head);p=s(u,"META",{name:!0,content:!0}),u.forEach(t),x=l(o),f=s(o,"H1",{class:!0});var hn=a(f);k=s(hn,"A",{id:!0,class:!0,href:!0});var Ys=a(k);L=s(Ys,"SPAN",{});var ea=a(L);y(_.$$.fragment,ea),ea.forEach(t),Ys.forEach(t),g=l(hn),$=s(hn,"SPAN",{});var ta=a($);Ge=i(ta,"XGLM"),ta.forEach(t),hn.forEach(t),ce=l(o),z=s(o,"H2",{class:!0});var un=a(z);ee=s(un,"A",{id:!0,class:!0,href:!0});var oa=a(ee);B=s(oa,"SPAN",{});var na=a(B);y(te.$$.fragment,na),na.forEach(t),oa.forEach(t),Ee=l(un),R=s(un,"SPAN",{});var sa=a(R);qe=i(sa,"Overview"),sa.forEach(t),un.forEach(t),Le=l(o),S=s(o,"P",{});var wa=a(S);H=i(wa,"The XGLM model was proposed in "),oe=s(wa,"A",{href:!0,rel:!0});var yc=a(oe);Te=i(yc,"Few-shot Learning with Multilingual Language Models"),yc.forEach(t),E=i(wa,`
by Xi Victoria Lin, Todor Mihaylov, Mikel Artetxe, Tianlu Wang, Shuohui Chen, Daniel Simig, Myle Ott, Naman Goyal,
Shruti Bhosale, Jingfei Du, Ramakanth Pasunuru, Sam Shleifer, Punit Singh Koura, Vishrav Chaudhary, Brian O\u2019Horo,
Jeff Wang, Luke Zettlemoyer, Zornitsa Kozareva, Mona Diab, Veselin Stoyanov, Xian Li.`),wa.forEach(t),q=l(o),pe=s(o,"P",{});var Tc=a(pe);ne=i(Tc,"The abstract from the paper is the following:"),Tc.forEach(t),xe=l(o),he=s(o,"P",{});var bc=a(he);V=s(bc,"EM",{});var Mc=a(V);Ce=i(Mc,`Large-scale autoregressive language models such as GPT-3 are few-shot learners that can perform a wide range of language
tasks without fine-tuning. While these models are known to be able to jointly represent many different languages,
their training data is dominated by English, potentially limiting their cross-lingual generalization.
In this work, we train multilingual autoregressive language models on a balanced corpus covering a diverse set of languages,
and study their few- and zero-shot learning capabilities in a wide range of tasks. Our largest model with 7.5 billion parameters
...
showing in particular that it enables cross-lingual in-context learning on some tasks, while there is still room for improvement
on surface form robustness and adaptation to tasks that do not have a natural cloze form. Finally, we evaluate our models
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),Mc.forEach(t),bc.forEach(t),$e=l(o),G=s(o,"P",{});var On=a(G);Pe=i(On,"This model was contributed by "),A=s(On,"A",{href:!0,rel:!0});var wc=a(A);Ae=i(wc,"Suraj"),wc.forEach(t),je=i(On,". The original code can be found "),j=s(On,"A",{href:!0,rel:!0});var Lc=a(j);Oe=i(Lc,"here"),Lc.forEach(t),De=i(On,"."),On.forEach(t),W=l(o),J=s(o,"H2",{class:!0});var La=a(J);P=s(La,"A",{id:!0,class:!0,href:!0});var xc=a(P);be=s(xc,"SPAN",{});var $c=a(be);y(m.$$.fragment,$c),$c.forEach(t),xc.forEach(t),X=l(La),se=s(La,"SPAN",{});var zc=a(se);at=i(zc,"XGLMConfig"),zc.forEach(t),La.forEach(t),Be=l(o),F=s(o,"DIV",{class:!0});var Ve=a(F);y(Me.$$.fragment,Ve),rt=l(Ve),ae=s(Ve,"P",{});var Dn=a(ae);K=i(Dn,"This is the configuration class to store the configuration of a "),U=s(Dn,"A",{href:!0});var Xc=a(U);it=i(Xc,"XGLMModel"),Xc.forEach(t),dt=i(Dn,`. It is used to instantiate an XGLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
`),O=s(Dn,"A",{href:!0,rel:!0});var Fc=a(O);lt=i(Fc,"facebook/xglm-564M"),Fc.forEach(t),ct=i(Dn," architecture."),Dn.forEach(t),Ne=l(Ve),re=s(Ve,"P",{});var Nn=a(re);er=i(Nn,"Configuration objects inherit from "),fn=s(Nn,"A",{href:!0});var Gc=a(fn);tr=i(Gc,"PretrainedConfig"),Gc.forEach(t),or=i(Nn,` and can be used to control the model outputs. Read the
documentation from `),gn=s(Nn,"A",{href:!0});var Ec=a(gn);nr=i(Ec,"PretrainedConfig"),Ec.forEach(t),sr=i(Nn," for more information."),Nn.forEach(t),ar=l(Ve),Jn=s(Ve,"P",{});var qc=a(Jn);rr=i(qc,"Example:"),qc.forEach(t),ir=l(Ve),y(Kt.$$.fragment,Ve),Ve.forEach(t),ia=l(o),pt=s(o,"H2",{class:!0});var xa=a(pt);Lt=s(xa,"A",{id:!0,class:!0,href:!0});var Cc=a(Lt);Kn=s(Cc,"SPAN",{});var Pc=a(Kn);y(Zt.$$.fragment,Pc),Pc.forEach(t),Cc.forEach(t),dr=l(xa),Zn=s(xa,"SPAN",{});var Ac=a(Zn);lr=i(Ac,"XGLMTokenizer"),Ac.forEach(t),xa.forEach(t),da=l(o),D=s(o,"DIV",{class:!0});var ve=a(D);y(Qt.$$.fragment,ve),cr=l(ve),Ie=s(ve,"P",{});var Rt=a(Ie);pr=i(Rt,"Adapted from "),_n=s(Rt,"A",{href:!0});var jc=a(_n);hr=i(jc,"RobertaTokenizer"),jc.forEach(t),ur=i(Rt," and "),kn=s(Rt,"A",{href:!0});var Oc=a(kn);mr=i(Oc,"XLNetTokenizer"),Oc.forEach(t),fr=i(Rt,`. Based on
`),Yt=s(Rt,"A",{href:!0,rel:!0});var Dc=a(Yt);gr=i(Dc,"SentencePiece"),Dc.forEach(t),_r=i(Rt,"."),Rt.forEach(t),kr=l(ve),eo=s(ve,"P",{});var $a=a(eo);vr=i($a,"This tokenizer inherits from "),vn=s($a,"A",{href:!0});var Nc=a(vn);yr=i(Nc,"PreTrainedTokenizer"),Nc.forEach(t),Tr=i($a,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),$a.forEach(t),br=l(ve),Re=s(ve,"DIV",{class:!0});var In=a(Re);y(to.$$.fragment,In),Mr=l(In),Qn=s(In,"P",{});var Ic=a(Qn);wr=i(Ic,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Ic.forEach(t),Lr=l(In),oo=s(In,"UL",{});var za=a(oo);yn=s(za,"LI",{});var gc=a(yn);xr=i(gc,"single sequence: "),Yn=s(gc,"CODE",{});var Sc=a(Yn);$r=i(Sc,"<s> X </s>"),Sc.forEach(t),gc.forEach(t),zr=l(za),Tn=s(za,"LI",{});var _c=a(Tn);Xr=i(_c,"pair of sequences: "),es=s(_c,"CODE",{});var Wc=a(es);Fr=i(Wc,"<s> A </s></s> B </s>"),Wc.forEach(t),_c.forEach(t),za.forEach(t),In.forEach(t),Gr=l(ve),xt=s(ve,"DIV",{class:!0});var Xa=a(xt);y(no.$$.fragment,Xa),Er=l(Xa),so=s(Xa,"P",{});var Fa=a(so);qr=i(Fa,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
not make use of token type ids, therefore a list of zeros is returned.`),Bc.forEach(t),Ga.forEach(t),Dr=l(ve),bn=s(ve,"DIV",{class:!0});var Rc=a(bn);y(ro.$$.fragment,Rc),Rc.forEach(t),ve.forEach(t),la=l(o),ht=s(o,"H2",{class:!0});var Ea=a(ht);zt=s(Ea,"A",{id:!0,class:!0,href:!0});var Hc=a(zt);ns=s(Hc,"SPAN",{});var Vc=a(ns);y(io.$$.fragment,Vc),Vc.forEach(t),Hc.forEach(t),Nr=l(Ea),ss=s(Ea,"SPAN",{});var Jc=a(ss);Ir=i(Jc,"XGLMTokenizerFast"),Jc.forEach(t),Ea.forEach(t),ca=l(o),ie=s(o,"DIV",{class:!0});var Je=a(ie);y(lo.$$.fragment,Je),Sr=l(Je),we=s(Je,"P",{});var Ke=a(we);Wr=i(Ke,"Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),as=s(Ke,"EM",{});var Kc=a(as);Ur=i(Kc,"tokenizers"),Kc.forEach(t),Br=i(Ke," library). Adapted from "),Mn=s(Ke,"A",{href:!0});var Zc=a(Mn);Rr=i(Zc,"RobertaTokenizer"),Zc.forEach(t),Hr=i(Ke,`
and `),wn=s(Ke,"A",{href:!0});var Qc=a(wn);Vr=i(Qc,"XLNetTokenizer"),Qc.forEach(t),Jr=i(Ke,`. Based on
...
refer to this superclass for more information regarding those methods.`),qa.forEach(t),oi=l(Je),He=s(Je,"DIV",{class:!0});var Sn=a(He);y(ho.$$.fragment,Sn),ni=l(Sn),rs=s(Sn,"P",{});var tp=a(rs);si=i(tp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ja.forEach(t),yi=l(Ze),ko=s(Ze,"P",{});var Oa=a(ko);Ti=i(Oa,"This model is also a PyTorch "),vo=s(Oa,"A",{href:!0,rel:!0});var lp=a(vo);bi=i(lp,"torch.nn.Module"),lp.forEach(t),Mi=i(Oa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Oa.forEach(t),wi=l(Ze),Gt=s(Ze,"P",{});var aa=a(Gt);Li=i(aa,"Transformer decoder consisting of "),hs=s(aa,"EM",{});var cp=a(hs);xi=i(cp,"config.num_layers"),cp.forEach(t),$i=i(aa," layers. Each layer is a "),us=s(aa,"CODE",{});var pp=a(us);zi=i(pp,"XGLMDecoderLayer"),pp.forEach(t),aa.forEach(t),Xi=l(Ze),ue=s(Ze,"DIV",{class:!0});var Qe=a(ue);y(yo.$$.fragment,Qe),Fi=l(Qe),mt=s(Qe,"P",{});var Wn=a(mt);Gi=i(Wn,"The "),Xn=s(Wn,"A",{href:!0});var hp=a(Xn);Ei=i(hp,"XGLMModel"),hp.forEach(t),qi=i(Wn," forward method, overrides the "),ms=s(Wn,"CODE",{});var up=a(ms);Ci=i(up,"__call__"),up.forEach(t),Pi=i(Wn," special method."),Wn.forEach(t),Ai=l(Qe),y(Et.$$.fragment,Qe),ji=l(Qe),fs=s(Qe,"P",{});var mp=a(fs);Oi=i(mp,"Example:"),mp.forEach(t),Di=l(Qe),y(To.$$.fragment,Qe),Qe.forEach(t),Ze.forEach(t),ua=l(o),ft=s(o,"H2",{class:!0});var Da=a(ft);qt=s(Da,"A",{id:!0,class:!0,href:!0});var fp=a(qt);gs=s(fp,"SPAN",{});var gp=a(gs);y(bo.$$.fragment,gp),gp.forEach(t),fp.forEach(t),Ni=l(Da),_s=s(Da,"SPAN",{});var _p=a(_s);Ii=i(_p,"XGLMForCausalLM"),_p.forEach(t),Da.forEach(t),ma=l(o),le=s(o,"DIV",{class:!0});var Ye=a(le);y(Mo.$$.fragment,Ye),Si=l(Ye),ks=s(Ye,"P",{});var kp=a(ks);Wi=i(kp,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),kp.forEach(t),Ui=l(Ye),wo=s(Ye,"P",{});var Na=a(wo);Bi=i(Na,"This model inherits from "),Fn=s(Na,"A",{href:!0});var vp=a(Fn);Ri=i(vp,"PreTrainedModel"),vp.forEach(t),Hi=i(Na,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Na.forEach(t),Vi=l(Ye),Lo=s(Ye,"P",{});var Ia=a(Lo);Ji=i(Ia,"This model is also a PyTorch "),xo=s(Ia,"A",{href:!0,rel:!0});var yp=a(xo);Ki=i(yp,"torch.nn.Module"),yp.forEach(t),Zi=i(Ia,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ia.forEach(t),Qi=l(Ye),me=s(Ye,"DIV",{class:!0});var et=a(me);y($o.$$.fragment,et),Yi=l(et),gt=s(et,"P",{});var Un=a(gt);ed=i(Un,"The "),Gn=s(Un,"A",{href:!0});var Tp=a(Gn);td=i(Tp,"XGLMForCausalLM"),Tp.forEach(t),od=i(Un," forward method, overrides the "),vs=s(Un,"CODE",{});var bp=a(vs);nd=i(bp,"__call__"),bp.forEach(t),sd=i(Un," special method."),Un.forEach(t),ad=l(et),y(Ct.$$.fragment,et),rd=l(et),ys=s(et,"P",{});var Mp=a(ys);id=i(Mp,"Example:"),Mp.forEach(t),dd=l(et),y(zo.$$.fragment,et),et.forEach(t),Ye.forEach(t),fa=l(o),_t=s(o,"H2",{class:!0});var Sa=a(_t);Pt=s(Sa,"A",{id:!0,class:!0,href:!0});var wp=a(Pt);Ts=s(wp,"SPAN",{});var Lp=a(Ts);y(Xo.$$.fragment,Lp),Lp.forEach(t),wp.forEach(t),ld=l(Sa),bs=s(Sa,"SPAN",{});var xp=a(bs);cd=i(xp,"TFXGLMModel"),xp.forEach(t),Sa.forEach(t),ga=l(o),Z=s(o,"DIV",{class:!0});var ze=a(Z);y(Fo.$$.fragment,ze),pd=l(ze),Go=s(ze,"P",{});var Wa=a(Go);hd=i(Wa,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
`),Ho=s(Ka,"A",{href:!0,rel:!0});var Hp=a(Ho);ml=i(Hp,"flax.nn.Module"),Hp.forEach(t),fl=i(Ka,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ka.forEach(t),gl=l(Fe),Cs=s(Fe,"P",{});var Vp=a(Cs);_l=i(Vp,"Finally, this model supports inherent JAX features such as:"),Vp.forEach(t),kl=l(Fe),Se=s(Fe,"UL",{});var Ht=a(Se);Ps=s(Ht,"LI",{});var Jp=a(Ps);Vo=s(Jp,"A",{href:!0,rel:!0});var Kp=a(Vo);vl=i(Kp,"Just-In-Time (JIT) compilation"),Kp.forEach(t),Jp.forEach(t),yl=l(Ht),As=s(Ht,"LI",{});var Zp=a(As);Jo=s(Zp,"A",{href:!0,rel:!0});var Qp=a(Jo);Tl=i(Qp,"Automatic Differentiation"),Qp.forEach(t),Zp.forEach(t),bl=l(Ht),js=s(Ht,"LI",{});var Yp=a(js);Ko=s(Yp,"A",{href:!0,rel:!0});var eh=a(Ko);Ml=i(eh,"Vectorization"),eh.forEach(t),Yp.forEach(t),wl=l(Ht),Os=s(Ht,"LI",{});var th=a(Os);Zo=s(th,"A",{href:!0,rel:!0});var oh=a(Zo);Ll=i(oh,"Parallelization"),oh.forEach(t),th.forEach(t),Ht.forEach(t),xl=l(Fe),_e=s(Fe,"DIV",{class:!0});var nt=a(_e);y(Qo.$$.fragment,nt),$l=l(nt),bt=s(nt,"P",{});var Hn=a(bt);zl=i(Hn,"The "),Ds=s(Hn,"CODE",{});var nh=a(Ds);Xl=i(nh,"FlaxXGLMPreTrainedModel"),nh.forEach(t),Fl=i(Hn,"forward method, overrides the "),Ns=s(Hn,"CODE",{});var sh=a(Ns);Gl=i(sh,"__call__"),sh.forEach(t),El=i(Hn," special method."),Hn.forEach(t),ql=l(nt),y(Wt.$$.fragment,nt),Cl=l(nt),Is=s(nt,"P",{});var ah=a(Is);Pl=i(ah,"Example:"),ah.forEach(t),Al=l(nt),y(Yo.$$.fragment,nt),nt.forEach(t),Fe.forEach(t),Ta=l(o),Mt=s(o,"H2",{class:!0});var Za=a(Mt);Ut=s(Za,"A",{id:!0,class:!0,href:!0});var rh=a(Ut);Ss=s(rh,"SPAN",{});var ih=a(Ss);y(en.$$.fragment,ih),ih.forEach(t),rh.forEach(t),jl=l(Za),Ws=s(Za,"SPAN",{});var dh=a(Ws);Ol=i(dh,"FlaxXGLMForCausalLM"),dh.forEach(t),Za.forEach(t),ba=l(o),N=s(o,"DIV",{class:!0});var ye=a(N);y(tn.$$.fragment,ye),Dl=l(ye),Us=s(ye,"P",{});var lh=a(Us);Nl=i(lh,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
