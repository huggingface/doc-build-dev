...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function lh(z){let p,y,f,u,k,l,m,x,Fe,ce,X,ee,B,te,Ee,R,qe,ve,S,H,oe,fe,q,C,pe,ne,ye,he,V,Ce,be,F,Pe,j,Ae,je,O,Oe,De,W,J,A,ge;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=d(),u=n("ul"),k=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),m=d(),x=n("li"),Fe=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),X=n("p"),ee=r("This second option is useful when using "),B=n("code"),te=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),qe=r("model(inputs)"),ve=r("."),S=d(),H=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),fe=d(),q=n("ul"),C=n("li"),pe=r("a single Tensor with "),ne=n("code"),ye=r("input_ids"),he=r(" only and nothing else: "),V=n("code"),Ce=r("model(input_ids)"),be=d(),F=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
tensors in the first argument of the model call function: `),R=s(E,"CODE",{});var Ye=a(R);qe=i(Ye,"model(inputs)"),Ye.forEach(t),ve=i(E,"."),E.forEach(t),S=c(v),H=s(v,"P",{});var ae=a(H);oe=i(ae,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ae.forEach(t),fe=c(v),q=s(v,"UL",{});var K=a(q);C=s(K,"LI",{});var U=a(C);pe=i(U,"a single Tensor with "),ne=s(U,"CODE",{});var et=a(ne);ye=i(et,"input_ids"),et.forEach(t),he=i(U," only and nothing else: "),V=s(U,"CODE",{});var tt=a(V);Ce=i(tt,"model(input_ids)"),tt.forEach(t),U.forEach(t),be=c(K),F=s(K,"LI",{});var D=a(F);Pe=i(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),A=s(Ne,"CODE",{});var re=a(A);ge=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(v,G){g(v,p,G),e(p,y),g(v,f,G),g(v,u,G),e(u,k),e(k,l),e(u,m),e(u,x),e(x,Fe),g(v,ce,G),g(v,X,G),e(X,ee),e(X,B),e(B,te),e(X,Ee),e(X,R),e(R,qe),e(X,ve),g(v,S,G),g(v,H,G),e(H,oe),g(v,fe,G),g(v,q,G),e(q,C),e(C,pe),e(C,ne),e(ne,ye),e(C,he),e(C,V),e(V,Ce),e(q,be),e(q,F),e(F,Pe),e(F,j),e(j,Ae),e(F,je),e(F,O),e(O,Oe),e(q,De),e(q,W),e(W,J),e(W,A),e(A,ge)},d(v){v&&t(p),v&&t(f),v&&t(u),v&&t(ce),v&&t(X),v&&t(S),v&&t(H),v&&t(fe),v&&t(q)}}}function dh(z){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function ph(z){let p,y,f,u,k,l,m,x,Fe,ce,X,ee,B,te,Ee,R,qe,ve,S,H,oe,fe,q,C,pe,ne,ye,he,V,Ce,be,F,Pe,j,Ae,je,O,Oe,De,W,J,A,ge;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=d(),u=n("ul"),k=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),m=d(),x=n("li"),Fe=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),X=n("p"),ee=r("This second option is useful when using "),B=n("code"),te=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),qe=r("model(inputs)"),ve=r("."),S=d(),H=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),fe=d(),q=n("ul"),C=n("li"),pe=r("a single Tensor with "),ne=n("code"),ye=r("input_ids"),he=r(" only and nothing else: "),V=n("code"),Ce=r("model(input_ids)"),be=d(),F=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),j=n("code"),Ae=r("model([input_ids, attention_mask])"),je=r(" or "),O=n("code"),Oe=r("model([input_ids, attention_mask, token_type_ids])"),De=d(),W=n("li"),J=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=n("code"),ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){p=s(v,"P",{});var G=a(p);y=i(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=c(v),u=s(v,"UL",{});var se=a(u);k=s(se,"LI",{});var Qe=a(k);l=i(Qe,"having all inputs as keyword arguments (like PyTorch models), or"),Qe.forEach(t),m=c(se),x=s(se,"LI",{});var Be=a(x);Fe=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),se.forEach(t),ce=c(v),X=s(v,"P",{});var E=a(X);ee=i(E,"This second option is useful when using "),B=s(E,"CODE",{});var _e=a(B);te=i(_e,"tf.keras.Model.fit"),_e.forEach(t),Ee=i(E,` method which currently requires having all the
...
first positional argument :`),ae.forEach(t),fe=c(v),q=s(v,"UL",{});var K=a(q);C=s(K,"LI",{});var U=a(C);pe=i(U,"a single Tensor with "),ne=s(U,"CODE",{});var et=a(ne);ye=i(et,"input_ids"),et.forEach(t),he=i(U," only and nothing else: "),V=s(U,"CODE",{});var tt=a(V);Ce=i(tt,"model(input_ids)"),tt.forEach(t),U.forEach(t),be=c(K),F=s(K,"LI",{});var D=a(F);Pe=i(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),j=s(D,"CODE",{});var ot=a(j);Ae=i(ot,"model([input_ids, attention_mask])"),ot.forEach(t),je=i(D," or "),O=s(D,"CODE",{});var nt=a(O);Oe=i(nt,"model([input_ids, attention_mask, token_type_ids])"),nt.forEach(t),D.forEach(t),De=c(K),W=s(K,"LI",{});var Ne=a(W);J=i(Ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=s(Ne,"CODE",{});var re=a(A);ge=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(v,G){g(v,p,G),e(p,y),g(v,f,G),g(v,u,G),e(u,k),e(k,l),e(u,m),e(u,x),e(x,Fe),g(v,ce,G),g(v,X,G),e(X,ee),e(X,B),e(B,te),e(X,Ee),e(X,R),e(R,qe),e(X,ve),g(v,S,G),g(v,H,G),e(H,oe),g(v,fe,G),g(v,q,G),e(q,C),e(C,pe),e(C,ne),e(ne,ye),e(C,he),e(C,V),e(V,Ce),e(q,be),e(q,F),e(F,Pe),e(F,j),e(j,Ae),e(F,je),e(F,O),e(O,Oe),e(q,De),e(q,W),e(W,J),e(W,A),e(A,ge)},d(v){v&&t(p),v&&t(f),v&&t(u),v&&t(ce),v&&t(X),v&&t(S),v&&t(H),v&&t(fe),v&&t(q)}}}function hh(z){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/modeling_tf_xglm.py#L897",returnDescription:`
<p>A <a
...
Jeff Wang, Luke Zettlemoyer, Zornitsa Kozareva, Mona Diab, Veselin Stoyanov, Xian Li.`),C=d(),pe=n("p"),ne=r("The abstract from the paper is the following:"),ye=d(),he=n("p"),V=n("em"),Ce=r(`Large-scale autoregressive language models such as GPT-3 are few-shot learners that can perform a wide range of language
...
and `),zn=n("a"),Rr=r("XLNetTokenizer"),Hr=r(`. Based on
`),_o=n("a"),Vr=r("BPE"),Jr=r("."),Kr=d(),ko=n("p"),Zr=r("This tokenizer inherits from "),Xn=n("a"),Qr=r("PreTrainedTokenizerFast"),Yr=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),ei=d(),He=n("div"),b(vo.$$.fragment),ti=d(),ls=n("p"),oi=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nl=d(),b(Ot.$$.fragment),Il=d(),Le=n("div"),b(Bo.$$.fragment),Sl=d(),ut=n("p"),Wl=r("The "),Dn=n("a"),Ul=r("TFXGLMForCausalLM"),Bl=r(" forward method, overrides the "),Xs=n("code"),Rl=r("__call__"),Hl=r(" special method."),Vl=d(),b(Dt.$$.fragment),Jl=d(),b(Nt.$$.fragment),ya=d(),mt=n("h2"),It=n("a"),Gs=n("span"),b(Ro.$$.fragment),Kl=d(),Fs=n("span"),Zl=r("FlaxXGLMModel"),ba=d(),Y=n("div"),b(Ho.$$.fragment),Ql=d(),Vo=n("p"),Yl=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
showing in particular that it enables cross-lingual in-context learning on some tasks, while there is still room for improvement
on surface form robustness and adaptation to tasks that do not have a natural cloze form. Finally, we evaluate our models
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),sa.forEach(t),na.forEach(t),be=c(o),F=s(o,"P",{});var kt=a(F);Pe=i(kt,"This model was contributed by "),j=s(kt,"A",{href:!0,rel:!0});var aa=a(j);Ae=i(aa,"Suraj"),aa.forEach(t),je=i(kt,". The original code can be found "),O=s(kt,"A",{href:!0,rel:!0});var rc=a(O);Oe=i(rc,"here"),rc.forEach(t),De=i(kt,"."),kt.forEach(t),W=c(o),J=s(o,"H2",{class:!0});var La=a(J);A=s(La,"A",{id:!0,class:!0,href:!0});var ic=a(A);ge=s(ic,"SPAN",{});var lc=a(ge);T(v.$$.fragment,lc),lc.forEach(t),ic.forEach(t),G=c(La),se=s(La,"SPAN",{});var dc=a(se);Qe=i(dc,"XGLMConfig"),dc.forEach(t),La.forEach(t),Be=c(o),E=s(o,"DIV",{class:!0});var Ht=a(E);T(_e.$$.fragment,Ht),Ye=c(Ht),ae=s(Ht,"P",{});var Sn=a(ae);K=i(Sn,"This is the configuration class to store the configuration of a "),U=s(Sn,"A",{href:!0});var cc=a(U);et=i(cc,"XGLMModel"),cc.forEach(t),tt=i(Sn,`. It is used to instantiate an XGLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
`),D=s(Sn,"A",{href:!0,rel:!0});var pc=a(D);ot=i(pc,"facebook/xglm-564M"),pc.forEach(t),nt=i(Sn," architecture."),Sn.forEach(t),Ne=c(Ht),re=s(Ht,"P",{});var Wn=a(re);er=i(Wn,"Configuration objects inherit from "),vn=s(Wn,"A",{href:!0});var hc=a(vn);tr=i(hc,"PretrainedConfig"),hc.forEach(t),or=i(Wn,` and can be used to control the model outputs. Read the
documentation from `),yn=s(Wn,"A",{href:!0});var uc=a(yn);nr=i(uc,"PretrainedConfig"),uc.forEach(t),sr=i(Wn," for more information."),Wn.forEach(t),ar=c(Ht),T(vt.$$.fragment,Ht),Ht.forEach(t),la=c(o),st=s(o,"H2",{class:!0});var $a=a(st);yt=s($a,"A",{id:!0,class:!0,href:!0});var mc=a(yt);Qn=s(mc,"SPAN",{});var fc=a(Qn);T(so.$$.fragment,fc),fc.forEach(t),mc.forEach(t),rr=c($a),Yn=s($a,"SPAN",{});var gc=a(Yn);ir=i(gc,"XGLMTokenizer"),gc.forEach(t),$a.forEach(t),da=c(o),N=s(o,"DIV",{class:!0});var ue=a(N);T(ao.$$.fragment,ue),lr=c(ue),Ie=s(ue,"P",{});var Vt=a(Ie);dr=i(Vt,"Adapted from "),bn=s(Vt,"A",{href:!0});var _c=a(bn);cr=i(_c,"RobertaTokenizer"),_c.forEach(t),pr=i(Vt," and "),Tn=s(Vt,"A",{href:!0});var kc=a(Tn);hr=i(kc,"XLNetTokenizer"),kc.forEach(t),ur=i(Vt,`. Based on
`),ro=s(Vt,"A",{href:!0,rel:!0});var vc=a(ro);mr=i(vc,"SentencePiece"),vc.forEach(t),fr=i(Vt,"."),Vt.forEach(t),gr=c(ue),io=s(ue,"P",{});var xa=a(io);_r=i(xa,"This tokenizer inherits from "),Mn=s(xa,"A",{href:!0});var yc=a(Mn);kr=i(yc,"PreTrainedTokenizer"),yc.forEach(t),vr=i(xa,` which contains most of the main methods. Users should refer to
...
not make use of token type ids, therefore a list of zeros is returned.`),Lc.forEach(t),Fa.forEach(t),jr=c(ue),$n=s(ue,"DIV",{class:!0});var $c=a($n);T(mo.$$.fragment,$c),$c.forEach(t),ue.forEach(t),ca=c(o),at=s(o,"H2",{class:!0});var Ea=a(at);Mt=s(Ea,"A",{id:!0,class:!0,href:!0});var xc=a(Mt);as=s(xc,"SPAN",{});var zc=a(as);T(fo.$$.fragment,zc),zc.forEach(t),xc.forEach(t),Or=c(Ea),rs=s(Ea,"SPAN",{});var Xc=a(rs);Dr=i(Xc,"XGLMTokenizerFast"),Xc.forEach(t),Ea.forEach(t),pa=c(o),ie=s(o,"DIV",{class:!0});var Ve=a(ie);T(go.$$.fragment,Ve),Nr=c(Ve),ke=s(Ve,"P",{});var Je=a(ke);Ir=i(Je,"Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),is=s(Je,"EM",{});var Gc=a(is);Sr=i(Gc,"tokenizers"),Gc.forEach(t),Wr=i(Je," library). Adapted from "),xn=s(Je,"A",{href:!0});var Fc=a(xn);Ur=i(Fc,"RobertaTokenizer"),Fc.forEach(t),Br=i(Je,`
and `),zn=s(Je,"A",{href:!0});var Ec=a(zn);Rr=i(Ec,"XLNetTokenizer"),Ec.forEach(t),Hr=i(Je,`. Based on
`),_o=s(Je,"A",{href:!0,rel:!0});var qc=a(_o);Vr=i(qc,"BPE"),qc.forEach(t),Jr=i(Je,"."),Je.forEach(t),Kr=c(Ve),ko=s(Ve,"P",{});var qa=a(ko);Zr=i(qa,"This tokenizer inherits from "),Xn=s(qa,"A",{href:!0});var Cc=a(Xn);Qr=i(Cc,"PreTrainedTokenizerFast"),Cc.forEach(t),Yr=i(qa,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),qa.forEach(t),ei=c(Ve),He=s(Ve,"DIV",{class:!0});var Bn=a(He);T(vo.$$.fragment,Bn),ti=c(Bn),ls=s(Bn,"P",{});var Pc=a(ls);oi=i(Pc,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Pc.forEach(t),ni=c(Bn),yo=s(Bn,"UL",{});var Ca=a(yo);Gn=s(Ca,"LI",{});var sc=a(Gn);si=i(sc,"single sequence: "),ds=s(sc,"CODE",{});var Ac=a(ds);ai=i(Ac,"<s> X </s>"),Ac.forEach(t),sc.forEach(t),ri=c(Ca),Fn=s(Ca,"LI",{});var ac=a(Fn);ii=i(ac,"pair of sequences: "),cs=s(ac,"CODE",{});var jc=a(cs);li=i(jc,"<s> A </s></s> B </s>"),jc.forEach(t),ac.forEach(t),Ca.forEach(t),Bn.forEach(t),di=c(Ve),wt=s(Ve,"DIV",{class:!0});var Pa=a(wt);T(bo.$$.fragment,Pa),ci=c(Pa),ps=s(Pa,"P",{});var Oc=a(ps);pi=i(Oc,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),Oc.forEach(t),Pa.forEach(t),Ve.forEach(t),ha=c(o),rt=s(o,"H2",{class:!0});var Aa=a(rt);Lt=s(Aa,"A",{id:!0,class:!0,href:!0});var Dc=a(Lt);hs=s(Dc,"SPAN",{});var Nc=a(hs);T(To.$$.fragment,Nc),Nc.forEach(t),Dc.forEach(t),hi=c(Aa),us=s(Aa,"SPAN",{});var Ic=a(us);ui=i(Ic,"XGLMModel"),Ic.forEach(t),Aa.forEach(t),ua=c(o),le=s(o,"DIV",{class:!0});var Ke=a(le);T(Mo.$$.fragment,Ke),mi=c(Ke),wo=s(Ke,"P",{});var ja=a(wo);fi=i(ja,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Na.forEach(t),Ui=c(Ze),Fo=s(Ze,"P",{});var Ia=a(Fo);Bi=i(Ia,"This model is also a PyTorch "),Eo=s(Ia,"A",{href:!0,rel:!0});var Yc=a(Eo);Ri=i(Yc,"torch.nn.Module"),Yc.forEach(t),Hi=i(Ia,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ia.forEach(t),Vi=c(Ze),Me=s(Ze,"DIV",{class:!0});var Kt=a(Me);T(qo.$$.fragment,Kt),Ji=c(Kt),dt=s(Kt,"P",{});var Hn=a(dt);Ki=i(Hn,"The "),Pn=s(Hn,"A",{href:!0});var ep=a(Pn);Zi=i(ep,"XGLMForCausalLM"),ep.forEach(t),Qi=i(Hn," forward method, overrides the "),ys=s(Hn,"CODE",{});var tp=a(ys);Yi=i(tp,"__call__"),tp.forEach(t),el=i(Hn," special method."),Hn.forEach(t),tl=c(Kt),T(Gt.$$.fragment,Kt),ol=c(Kt),T(Ft.$$.fragment,Kt),Kt.forEach(t),Ze.forEach(t),ga=c(o),ct=s(o,"H2",{class:!0});var Sa=a(ct);Et=s(Sa,"A",{id:!0,class:!0,href:!0});var op=a(Et);bs=s(op,"SPAN",{});var np=a(bs);T(Co.$$.fragment,np),np.forEach(t),op.forEach(t),nl=c(Sa),Ts=s(Sa,"SPAN",{});var sp=a(Ts);sl=i(sp,"TFXGLMModel"),sp.forEach(t),Sa.forEach(t),_a=c(o),Z=s(o,"DIV",{class:!0});var ze=a(Z);T(Po.$$.fragment,ze),al=c(ze),Ao=s(ze,"P",{});var Wa=a(Ao);rl=i(Wa,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ra.forEach(t),Al=c(Xe),Wo=s(Xe,"P",{});var Ha=a(Wo);jl=i(Ha,"This model is also a "),Uo=s(Ha,"A",{href:!0,rel:!0});var gp=a(Uo);Ol=i(gp,"tf.keras.Model"),gp.forEach(t),Dl=i(Ha,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ha.forEach(t),Nl=c(Xe),T(Ot.$$.fragment,Xe),Il=c(Xe),Le=s(Xe,"DIV",{class:!0});var Qt=a(Le);T(Bo.$$.fragment,Qt),Sl=c(Qt),ut=s(Qt,"P",{});var Jn=a(ut);Wl=i(Jn,"The "),Dn=s(Jn,"A",{href:!0});var _p=a(Dn);Ul=i(_p,"TFXGLMForCausalLM"),_p.forEach(t),Bl=i(Jn," forward method, overrides the "),Xs=s(Jn,"CODE",{});var kp=a(Xs);Rl=i(kp,"__call__"),kp.forEach(t),Hl=i(Jn," special method."),Jn.forEach(t),Vl=c(Qt),T(Dt.$$.fragment,Qt),Jl=c(Qt),T(Nt.$$.fragment,Qt),Qt.forEach(t),Xe.forEach(t),ya=c(o),mt=s(o,"H2",{class:!0});var Va=a(mt);It=s(Va,"A",{id:!0,class:!0,href:!0});var vp=a(It);Gs=s(vp,"SPAN",{});var yp=a(Gs);T(Ro.$$.fragment,yp),yp.forEach(t),vp.forEach(t),Kl=c(Va),Fs=s(Va,"SPAN",{});var bp=a(Fs);Zl=i(bp,"FlaxXGLMModel"),bp.forEach(t),Va.forEach(t),ba=c(o),Y=s(o,"DIV",{class:!0});var Ge=a(Y);T(Ho.$$.fragment,Ge),Ql=c(Ge),Vo=s(Ge,"P",{});var Ja=a(Vo);Yl=i(Ja,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
