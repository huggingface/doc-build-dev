...
first positional argument :`),fe=d(),q=n("ul"),C=n("li"),pe=r("a single Tensor with "),ne=n("code"),ye=r("input_ids"),he=r(" only and nothing else: "),V=n("code"),Ce=r("model(input_ids)"),be=d(),G=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),A=s(Ne,"CODE",{});var re=a(A);ge=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(v,F){g(v,p,F),e(p,y),g(v,f,F),g(v,u,F),e(u,k),e(k,l),e(u,m),e(u,x),e(x,Ge),g(v,ce,F),g(v,X,F),e(X,ee),e(X,B),e(B,te),e(X,Ee),e(X,R),e(R,qe),e(X,ve),g(v,S,F),g(v,H,F),e(H,oe),g(v,fe,F),g(v,q,F),e(q,C),e(C,pe),e(C,ne),e(ne,ye),e(C,he),e(C,V),e(V,Ce),e(q,be),e(q,G),e(G,Pe),e(G,j),e(j,Ae),e(G,je),e(G,O),e(O,Oe),e(q,De),e(q,W),e(W,J),e(W,A),e(A,ge)},d(v){v&&t(p),v&&t(f),v&&t(u),v&&t(ce),v&&t(X),v&&t(S),v&&t(H),v&&t(fe),v&&t(q)}}}function dh(z){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function ph(z){let p,y,f,u,k,l,m,x,Ge,ce,X,ee,B,te,Ee,R,qe,ve,S,H,oe,fe,q,C,pe,ne,ye,he,V,Ce,be,G,Pe,j,Ae,je,O,Oe,De,W,J,A,ge;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=d(),u=n("ul"),k=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),m=d(),x=n("li"),Ge=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),X=n("p"),ee=r("This second option is useful when using "),B=n("code"),te=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),qe=r("model(inputs)"),ve=r("."),S=d(),H=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),fe=d(),q=n("ul"),C=n("li"),pe=r("a single Tensor with "),ne=n("code"),ye=r("input_ids"),he=r(" only and nothing else: "),V=n("code"),Ce=r("model(input_ids)"),be=d(),G=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),j=n("code"),Ae=r("model([input_ids, attention_mask])"),je=r(" or "),O=n("code"),Oe=r("model([input_ids, attention_mask, token_type_ids])"),De=d(),W=n("li"),J=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=n("code"),ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){p=s(v,"P",{});var F=a(p);y=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),f=c(v),u=s(v,"UL",{});var se=a(u);k=s(se,"LI",{});var Qe=a(k);l=i(Qe,"having all inputs as keyword arguments (like PyTorch models), or"),Qe.forEach(t),m=c(se),x=s(se,"LI",{});var Be=a(x);Ge=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),se.forEach(t),ce=c(v),X=s(v,"P",{});var E=a(X);ee=i(E,"This second option is useful when using "),B=s(E,"CODE",{});var _e=a(B);te=i(_e,"tf.keras.Model.fit"),_e.forEach(t),Ee=i(E,` method which currently requires having all the
...
first positional argument :`),ae.forEach(t),fe=c(v),q=s(v,"UL",{});var K=a(q);C=s(K,"LI",{});var U=a(C);pe=i(U,"a single Tensor with "),ne=s(U,"CODE",{});var et=a(ne);ye=i(et,"input_ids"),et.forEach(t),he=i(U," only and nothing else: "),V=s(U,"CODE",{});var tt=a(V);Ce=i(tt,"model(input_ids)"),tt.forEach(t),U.forEach(t),be=c(K),G=s(K,"LI",{});var D=a(G);Pe=i(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),j=s(D,"CODE",{});var ot=a(j);Ae=i(ot,"model([input_ids, attention_mask])"),ot.forEach(t),je=i(D," or "),O=s(D,"CODE",{});var nt=a(O);Oe=i(nt,"model([input_ids, attention_mask, token_type_ids])"),nt.forEach(t),D.forEach(t),De=c(K),W=s(K,"LI",{});var Ne=a(W);J=i(Ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=s(Ne,"CODE",{});var re=a(A);ge=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(v,F){g(v,p,F),e(p,y),g(v,f,F),g(v,u,F),e(u,k),e(k,l),e(u,m),e(u,x),e(x,Ge),g(v,ce,F),g(v,X,F),e(X,ee),e(X,B),e(B,te),e(X,Ee),e(X,R),e(R,qe),e(X,ve),g(v,S,F),g(v,H,F),e(H,oe),g(v,fe,F),g(v,q,F),e(q,C),e(C,pe),e(C,ne),e(ne,ye),e(C,he),e(C,V),e(V,Ce),e(q,be),e(q,G),e(G,Pe),e(G,j),e(j,Ae),e(G,je),e(G,O),e(O,Oe),e(q,De),e(q,W),e(W,J),e(W,A),e(A,ge)},d(v){v&&t(p),v&&t(f),v&&t(u),v&&t(ce),v&&t(X),v&&t(S),v&&t(H),v&&t(fe),v&&t(q)}}}function hh(z){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/modeling_tf_xglm.py#L787",returnDescription:`
<p>A <a
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/modeling_tf_xglm.py#L896",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ui=d(),Go=n("p"),Bi=r("This model is also a PyTorch "),Eo=n("a"),Ri=r("torch.nn.Module"),Hi=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nl=d(),b(Ot.$$.fragment),Il=d(),Le=n("div"),b(Bo.$$.fragment),Sl=d(),ut=n("p"),Wl=r("The "),Dn=n("a"),Ul=r("TFXGLMForCausalLM"),Bl=r(" forward method, overrides the "),Xs=n("code"),Rl=r("__call__"),Hl=r(" special method."),Vl=d(),b(Dt.$$.fragment),Jl=d(),b(Nt.$$.fragment),ya=d(),mt=n("h2"),It=n("a"),Fs=n("span"),b(Ro.$$.fragment),Kl=d(),Gs=n("span"),Zl=r("FlaxXGLMModel"),ba=d(),Y=n("div"),b(Ho.$$.fragment),Ql=d(),Vo=n("p"),Yl=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
