...
first positional argument :`),Te=d(),E=n("ul"),q=n("li"),pe=r("a single Tensor with "),ne=n("code"),xe=r("input_ids"),he=r(" only and nothing else: "),H=n("code"),Ce=r("model(input_ids)"),$e=d(),F=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),P=n("code"),be=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=s(m,"P",{});var X=a(p);x=i(X,"TF 2.0 models accepts two formats as inputs:"),X.forEach(t),f=l(m),k=s(m,"UL",{});var se=a(k);L=s(se,"LI",{});var at=a(L);_=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),g=l(se),$=s(se,"LI",{});var Be=a($);Fe=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),se.forEach(t),ce=l(m),z=s(m,"P",{});var G=a(z);ee=i(G,"This second option is useful when using "),B=s(G,"CODE",{});var Me=a(B);te=i(Me,"tf.keras.Model.fit"),Me.forEach(t),Ee=i(G,` method which currently requires having all the
tensors in the first argument of the model call function: `),R=s(G,"CODE",{});var rt=a(R);qe=i(rt,"model(inputs)"),rt.forEach(t),Le=i(G,"."),G.forEach(t),S=l(m),V=s(m,"P",{});var ae=a(V);oe=i(ae,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ae.forEach(t),Te=l(m),E=s(m,"UL",{});var K=a(E);q=s(K,"LI",{});var U=a(q);pe=i(U,"a single Tensor with "),ne=s(U,"CODE",{});var it=a(ne);xe=i(it,"input_ids"),it.forEach(t),he=i(U," only and nothing else: "),H=s(U,"CODE",{});var dt=a(H);Ce=i(dt,"model(input_ids)"),dt.forEach(t),U.forEach(t),$e=l(K),F=s(K,"LI",{});var O=a(F);Pe=i(O,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=n("meta"),x=d(),f=n("h1"),k=n("a"),L=n("span"),v(_.$$.fragment),g=d(),$=n("span"),Fe=r("XGLM"),ce=d(),z=n("h2"),ee=n("a"),B=n("span"),v(te.$$.fragment),Ee=d(),R=n("span"),qe=r("Overview"),Le=d(),S=n("p"),V=r("The XGLM model was proposed in "),oe=n("a"),Te=r("Few-shot Learning with Multilingual Language Models"),E=r(`
...
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),$e=d(),F=n("p"),Pe=r("This model was contributed by "),A=n("a"),Ae=r("Suraj"),je=r(". The original code can be found "),j=n("a"),Oe=r("here"),De=r("."),W=d(),J=n("h2"),P=n("a"),be=n("span"),v(m.$$.fragment),X=d(),se=n("span"),at=r("XGLMConfig"),Be=d(),G=n("div"),v(Me.$$.fragment),rt=d(),ae=n("p"),K=r("This is the configuration class to store the configuration of a "),U=n("a"),it=r("XGLMModel"),dt=r(`. It is used to instantiate an XGLM
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Lr=d(),oo=n("ul"),yn=n("li"),xr=r("single sequence: "),Yn=n("code"),$r=r("<s> X </s>"),zr=d(),Tn=n("li"),Xr=r("pair of sequences: "),es=n("code"),Gr=r("<s> A </s></s> B </s>"),Fr=d(),xt=n("div"),v(no.$$.fragment),Er=d(),so=n("p"),qr=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
not make use of token type ids, therefore a list of zeros is returned.`),pa=d(),ut=n("h2"),Gt=n("a"),cs=n("span"),v(fo.$$.fragment),mi=d(),ps=n("span"),fi=r("XGLMModel"),ha=d(),de=n("div"),v(go.$$.fragment),gi=d(),_o=n("p"),_i=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
and behavior.`),wi=d(),Ft=n("p"),Li=r("Transformer decoder consisting of "),hs=n("em"),xi=r("config.num_layers"),$i=r(" layers. Each layer is a "),us=n("code"),zi=r("XGLMDecoderLayer"),Xi=d(),ue=n("div"),v(yo.$$.fragment),Gi=d(),mt=n("p"),Fi=r("The "),Xn=n("a"),Ei=r("XGLMModel"),qi=r(" forward method, overrides the "),ms=n("code"),Ci=r("__call__"),Pi=r(" special method."),Ai=d(),v(Et.$$.fragment),ji=d(),fs=n("p"),Oi=r("Example:"),Di=d(),v(To.$$.fragment),ua=d(),ft=n("h2"),qt=n("a"),gs=n("span"),v(bo.$$.fragment),Ni=d(),_s=n("span"),Ii=r("XGLMForCausalLM"),ma=d(),le=n("div"),v(Mo.$$.fragment),Si=d(),ks=n("p"),Wi=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Ui=d(),wo=n("p"),Bi=r("This model inherits from "),Gn=n("a"),Ri=r("PreTrainedModel"),Vi=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hi=d(),Lo=n("p"),Ji=r("This model is also a PyTorch "),xo=n("a"),Ki=r("torch.nn.Module"),Zi=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qi=d(),me=n("div"),v($o.$$.fragment),Yi=d(),gt=n("p"),ed=r("The "),Fn=n("a"),td=r("XGLMForCausalLM"),od=r(" forward method, overrides the "),vs=n("code"),nd=r("__call__"),sd=r(" special method."),ad=d(),v(Ct.$$.fragment),rd=d(),ys=n("p"),id=r("Example:"),dd=d(),v(zo.$$.fragment),fa=d(),_t=n("h2"),Pt=n("a"),Ts=n("span"),v(Xo.$$.fragment),ld=d(),bs=n("span"),cd=r("TFXGLMModel"),ga=d(),Z=n("div"),v(Go.$$.fragment),pd=d(),Fo=n("p"),hd=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),vd=d(),v(At.$$.fragment),yd=d(),jt=n("p"),Td=r("Transformer decoder consisting of "),Ms=n("em"),bd=r("config.num_layers"),Md=r(" layers. Each layer is a "),ws=n("code"),wd=r("TFXGLMDecoderLayer"),Ld=d(),fe=n("div"),v(Co.$$.fragment),xd=d(),kt=n("p"),$d=r("The "),qn=n("a"),zd=r("TFXGLMModel"),Xd=r(" forward method, overrides the "),Ls=n("code"),Gd=r("__call__"),Fd=r(" special method."),Ed=d(),v(Ot.$$.fragment),qd=d(),xs=n("p"),Cd=r("Example:"),Pd=d(),v(Po.$$.fragment),_a=d(),vt=n("h2"),Dt=n("a"),$s=n("span"),v(Ao.$$.fragment),Ad=d(),zs=n("span"),jd=r("TFXGLMForCausalLM"),ka=d(),Q=n("div"),v(jo.$$.fragment),Od=d(),Xs=n("p"),Dd=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hd=d(),v(Nt.$$.fragment),Jd=d(),ge=n("div"),v(Io.$$.fragment),Kd=d(),yt=n("p"),Zd=r("The "),Pn=n("a"),Qd=r("TFXGLMForCausalLM"),Yd=r(" forward method, overrides the "),Gs=n("code"),el=r("__call__"),tl=r(" special method."),ol=d(),v(It.$$.fragment),nl=d(),Fs=n("p"),sl=r("Example:"),al=d(),v(So.$$.fragment),va=d(),Tt=n("h2"),St=n("a"),Es=n("span"),v(Wo.$$.fragment),rl=d(),qs=n("span"),il=r("FlaxXGLMModel"),ya=d(),Y=n("div"),v(Uo.$$.fragment),dl=d(),Bo=n("p"),ll=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
showing in particular that it enables cross-lingual in-context learning on some tasks, while there is still room for improvement
on surface form robustness and adaptation to tasks that do not have a natural cloze form. Finally, we evaluate our models
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),Mc.forEach(t),bc.forEach(t),$e=l(o),F=s(o,"P",{});var On=a(F);Pe=i(On,"This model was contributed by "),A=s(On,"A",{href:!0,rel:!0});var wc=a(A);Ae=i(wc,"Suraj"),wc.forEach(t),je=i(On,". The original code can be found "),j=s(On,"A",{href:!0,rel:!0});var Lc=a(j);Oe=i(Lc,"here"),Lc.forEach(t),De=i(On,"."),On.forEach(t),W=l(o),J=s(o,"H2",{class:!0});var La=a(J);P=s(La,"A",{id:!0,class:!0,href:!0});var xc=a(P);be=s(xc,"SPAN",{});var $c=a(be);y(m.$$.fragment,$c),$c.forEach(t),xc.forEach(t),X=l(La),se=s(La,"SPAN",{});var zc=a(se);at=i(zc,"XGLMConfig"),zc.forEach(t),La.forEach(t),Be=l(o),G=s(o,"DIV",{class:!0});var He=a(G);y(Me.$$.fragment,He),rt=l(He),ae=s(He,"P",{});var Dn=a(ae);K=i(Dn,"This is the configuration class to store the configuration of a "),U=s(Dn,"A",{href:!0});var Xc=a(U);it=i(Xc,"XGLMModel"),Xc.forEach(t),dt=i(Dn,`. It is used to instantiate an XGLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
`),O=s(Dn,"A",{href:!0,rel:!0});var Gc=a(O);lt=i(Gc,"facebook/xglm-564M"),Gc.forEach(t),ct=i(Dn," architecture."),Dn.forEach(t),Ne=l(He),re=s(He,"P",{});var Nn=a(re);er=i(Nn,"Configuration objects inherit from "),fn=s(Nn,"A",{href:!0});var Fc=a(fn);tr=i(Fc,"PretrainedConfig"),Fc.forEach(t),or=i(Nn,` and can be used to control the model outputs. Read the
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Ic.forEach(t),Lr=l(In),oo=s(In,"UL",{});var za=a(oo);yn=s(za,"LI",{});var gc=a(yn);xr=i(gc,"single sequence: "),Yn=s(gc,"CODE",{});var Sc=a(Yn);$r=i(Sc,"<s> X </s>"),Sc.forEach(t),gc.forEach(t),zr=l(za),Tn=s(za,"LI",{});var _c=a(Tn);Xr=i(_c,"pair of sequences: "),es=s(_c,"CODE",{});var Wc=a(es);Gr=i(Wc,"<s> A </s></s> B </s>"),Wc.forEach(t),_c.forEach(t),za.forEach(t),In.forEach(t),Fr=l(ve),xt=s(ve,"DIV",{class:!0});var Xa=a(xt);y(no.$$.fragment,Xa),Er=l(Xa),so=s(Xa,"P",{});var Ga=a(so);qr=i(Ga,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ts=s(Ga,"CODE",{});var Uc=a(ts);Cr=i(Uc,"prepare_for_model"),Uc.forEach(t),Pr=i(Ga," method."),Ga.forEach(t),Xa.forEach(t),Ar=l(ve),$t=s(ve,"DIV",{class:!0});var Fa=a($t);y(ao.$$.fragment,Fa),jr=l(Fa),os=s(Fa,"P",{});var Bc=a(os);Or=i(Bc,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),Bc.forEach(t),Fa.forEach(t),Dr=l(ve),bn=s(ve,"DIV",{class:!0});var Rc=a(bn);y(ro.$$.fragment,Rc),Rc.forEach(t),ve.forEach(t),la=l(o),ht=s(o,"H2",{class:!0});var Ea=a(ht);zt=s(Ea,"A",{id:!0,class:!0,href:!0});var Vc=a(zt);ns=s(Vc,"SPAN",{});var Hc=a(ns);y(io.$$.fragment,Hc),Hc.forEach(t),Vc.forEach(t),Nr=l(Ea),ss=s(Ea,"SPAN",{});var Jc=a(ss);Ir=i(Jc,"XGLMTokenizerFast"),Jc.forEach(t),Ea.forEach(t),ca=l(o),ie=s(o,"DIV",{class:!0});var Je=a(ie);y(lo.$$.fragment,Je),Sr=l(Je),we=s(Je,"P",{});var Ke=a(we);Wr=i(Ke,"Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),as=s(Ke,"EM",{});var Kc=a(as);Ur=i(Kc,"tokenizers"),Kc.forEach(t),Br=i(Ke," library). Adapted from "),Mn=s(Ke,"A",{href:!0});var Zc=a(Mn);Rr=i(Zc,"RobertaTokenizer"),Zc.forEach(t),Vr=i(Ke,`
...
not make use of token type ids, therefore a list of zeros is returned.`),sp.forEach(t),Pa.forEach(t),Je.forEach(t),pa=l(o),ut=s(o,"H2",{class:!0});var Aa=a(ut);Gt=s(Aa,"A",{id:!0,class:!0,href:!0});var ap=a(Gt);cs=s(ap,"SPAN",{});var rp=a(cs);y(fo.$$.fragment,rp),rp.forEach(t),ap.forEach(t),mi=l(Aa),ps=s(Aa,"SPAN",{});var ip=a(ps);fi=i(ip,"XGLMModel"),ip.forEach(t),Aa.forEach(t),ha=l(o),de=s(o,"DIV",{class:!0});var Ze=a(de);y(go.$$.fragment,Ze),gi=l(Ze),_o=s(Ze,"P",{});var ja=a(_o);_i=i(ja,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Va.forEach(t),Hd=l(Xe),y(Nt.$$.fragment,Xe),Jd=l(Xe),ge=s(Xe,"DIV",{class:!0});var ot=a(ge);y(Io.$$.fragment,ot),Kd=l(ot),yt=s(ot,"P",{});var Rn=a(yt);Zd=i(Rn,"The "),Pn=s(Rn,"A",{href:!0});var Np=a(Pn);Qd=i(Np,"TFXGLMForCausalLM"),Np.forEach(t),Yd=i(Rn," forward method, overrides the "),Gs=s(Rn,"CODE",{});var Ip=a(Gs);el=i(Ip,"__call__"),Ip.forEach(t),tl=i(Rn," special method."),Rn.forEach(t),ol=l(ot),y(It.$$.fragment,ot),nl=l(ot),Fs=s(ot,"P",{});var Sp=a(Fs);sl=i(Sp,"Example:"),Sp.forEach(t),al=l(ot),y(So.$$.fragment,ot),ot.forEach(t),Xe.forEach(t),va=l(o),Tt=s(o,"H2",{class:!0});var Ha=a(Tt);St=s(Ha,"A",{id:!0,class:!0,href:!0});var Wp=a(St);Es=s(Wp,"SPAN",{});var Up=a(Es);y(Wo.$$.fragment,Up),Up.forEach(t),Wp.forEach(t),rl=l(Ha),qs=s(Ha,"SPAN",{});var Bp=a(qs);il=i(Bp,"FlaxXGLMModel"),Bp.forEach(t),Ha.forEach(t),ya=l(o),Y=s(o,"DIV",{class:!0});var Ge=a(Y);y(Uo.$$.fragment,Ge),dl=l(Ge),Bo=s(Ge,"P",{});var Ja=a(Bo);ll=i(Ja,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ja.forEach(t),hl=l(Ge),Ro=s(Ge,"P",{});var Ka=a(Ro);ul=i(Ka,`This model is also a Flax Linen
`),Vo=s(Ka,"A",{href:!0,rel:!0});var Vp=a(Vo);ml=i(Vp,"flax.nn.Module"),Vp.forEach(t),fl=i(Ka,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ka.forEach(t),gl=l(Ge),Cs=s(Ge,"P",{});var Hp=a(Cs);_l=i(Hp,"Finally, this model supports inherent JAX features such as:"),Hp.forEach(t),kl=l(Ge),Se=s(Ge,"UL",{});var Vt=a(Se);Ps=s(Vt,"LI",{});var Jp=a(Ps);Ho=s(Jp,"A",{href:!0,rel:!0});var Kp=a(Ho);vl=i(Kp,"Just-In-Time (JIT) compilation"),Kp.forEach(t),Jp.forEach(t),yl=l(Vt),As=s(Vt,"LI",{});var Zp=a(As);Jo=s(Zp,"A",{href:!0,rel:!0});var Qp=a(Jo);Tl=i(Qp,"Automatic Differentiation"),Qp.forEach(t),Zp.forEach(t),bl=l(Vt),js=s(Vt,"LI",{});var Yp=a(js);Ko=s(Yp,"A",{href:!0,rel:!0});var eh=a(Ko);Ml=i(eh,"Vectorization"),eh.forEach(t),Yp.forEach(t),wl=l(Vt),Os=s(Vt,"LI",{});var th=a(Os);Zo=s(th,"A",{href:!0,rel:!0});var oh=a(Zo);Ll=i(oh,"Parallelization"),oh.forEach(t),th.forEach(t),Vt.forEach(t),xl=l(Ge),_e=s(Ge,"DIV",{class:!0});var nt=a(_e);y(Qo.$$.fragment,nt),$l=l(nt),bt=s(nt,"P",{});var Vn=a(bt);zl=i(Vn,"The "),Ds=s(Vn,"CODE",{});var nh=a(Ds);Xl=i(nh,"FlaxXGLMPreTrainedModel"),nh.forEach(t),Gl=i(Vn,"forward method, overrides the "),Ns=s(Vn,"CODE",{});var sh=a(Ns);Fl=i(sh,"__call__"),sh.forEach(t),El=i(Vn," special method."),Vn.forEach(t),ql=l(nt),y(Wt.$$.fragment,nt),Cl=l(nt),Is=s(nt,"P",{});var ah=a(Is);Pl=i(ah,"Example:"),ah.forEach(t),Al=l(nt),y(Yo.$$.fragment,nt),nt.forEach(t),Ge.forEach(t),Ta=l(o),Mt=s(o,"H2",{class:!0});var Za=a(Mt);Ut=s(Za,"A",{id:!0,class:!0,href:!0});var rh=a(Ut);Ss=s(rh,"SPAN",{});var ih=a(Ss);y(en.$$.fragment,ih),ih.forEach(t),rh.forEach(t),jl=l(Za),Ws=s(Za,"SPAN",{});var dh=a(Ws);Ol=i(dh,"FlaxXGLMForCausalLM"),dh.forEach(t),Za.forEach(t),ba=l(o),N=s(o,"DIV",{class:!0});var ye=a(N);y(tn.$$.fragment,ye),Dl=l(ye),Us=s(ye,"P",{});var lh=a(Us);Nl=i(lh,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
