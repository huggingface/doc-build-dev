import{S as Qp,i as Yp,s as eh,e as n,k as d,w as b,t as r,M as th,c as s,d as t,m as c,a,x as T,h as i,b as h,F as e,g,y as M,q as w,o as L,B as $,v as oh,L as _n}from"../../chunks/vendor-6b77c823.js";import{T as no}from"../../chunks/Tip-39098574.js";import{D as P}from"../../chunks/Docstring-1088f2fb.js";import{C as kn}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ue}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as gn}from"../../chunks/ExampleCodeBlock-5212b321.js";function nh(z){let p,y,f,u,k;return u=new kn({props:{code:`from transformers import XGLMModel, XGLMConfig
...
first positional argument :`),fe=d(),q=n("ul"),C=n("li"),pe=r("a single Tensor with "),ne=n("code"),ye=r("input_ids"),he=r(" only and nothing else: "),H=n("code"),Ce=r("model(input_ids)"),be=d(),F=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),A=n("code"),ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){p=s(v,"P",{});var G=a(p);y=i(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=c(v),u=s(v,"UL",{});var se=a(u);k=s(se,"LI",{});var Qe=a(k);l=i(Qe,"having all inputs as keyword arguments (like PyTorch models), or"),Qe.forEach(t),m=c(se),x=s(se,"LI",{});var Be=a(x);Fe=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),se.forEach(t),ce=c(v),X=s(v,"P",{});var E=a(X);ee=i(E,"This second option is useful when using "),B=s(E,"CODE",{});var _e=a(B);te=i(_e,"tf.keras.Model.fit"),_e.forEach(t),Ee=i(E,` method which currently requires having all the
...
`),A=s(Ne,"CODE",{});var re=a(A);ge=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(v,G){g(v,p,G),e(p,y),g(v,f,G),g(v,u,G),e(u,k),e(k,l),e(u,m),e(u,x),e(x,Fe),g(v,ce,G),g(v,X,G),e(X,ee),e(X,B),e(B,te),e(X,Ee),e(X,R),e(R,qe),e(X,ve),g(v,S,G),g(v,V,G),e(V,oe),g(v,fe,G),g(v,q,G),e(q,C),e(C,pe),e(C,ne),e(ne,ye),e(C,he),e(C,H),e(H,Ce),e(q,be),e(q,F),e(F,Pe),e(F,j),e(j,Ae),e(F,je),e(F,O),e(O,Oe),e(q,De),e(q,W),e(W,J),e(W,A),e(A,ge)},d(v){v&&t(p),v&&t(f),v&&t(u),v&&t(ce),v&&t(X),v&&t(S),v&&t(V),v&&t(fe),v&&t(q)}}}function dh(z){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function ph(z){let p,y,f,u,k,l,m,x,Fe,ce,X,ee,B,te,Ee,R,qe,ve,S,V,oe,fe,q,C,pe,ne,ye,he,H,Ce,be,F,Pe,j,Ae,je,O,Oe,De,W,J,A,ge;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=d(),u=n("ul"),k=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),m=d(),x=n("li"),Fe=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),X=n("p"),ee=r("This second option is useful when using "),B=n("code"),te=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),qe=r("model(inputs)"),ve=r("."),S=d(),V=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),fe=d(),q=n("ul"),C=n("li"),pe=r("a single Tensor with "),ne=n("code"),ye=r("input_ids"),he=r(" only and nothing else: "),H=n("code"),Ce=r("model(input_ids)"),be=d(),F=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),j=n("code"),Ae=r("model([input_ids, attention_mask])"),je=r(" or "),O=n("code"),Oe=r("model([input_ids, attention_mask, token_type_ids])"),De=d(),W=n("li"),J=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=n("code"),ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){p=s(v,"P",{});var G=a(p);y=i(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=c(v),u=s(v,"UL",{});var se=a(u);k=s(se,"LI",{});var Qe=a(k);l=i(Qe,"having all inputs as keyword arguments (like PyTorch models), or"),Qe.forEach(t),m=c(se),x=s(se,"LI",{});var Be=a(x);Fe=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),se.forEach(t),ce=c(v),X=s(v,"P",{});var E=a(X);ee=i(E,"This second option is useful when using "),B=s(E,"CODE",{});var _e=a(B);te=i(_e,"tf.keras.Model.fit"),_e.forEach(t),Ee=i(E,` method which currently requires having all the
...
first positional argument :`),ae.forEach(t),fe=c(v),q=s(v,"UL",{});var K=a(q);C=s(K,"LI",{});var U=a(C);pe=i(U,"a single Tensor with "),ne=s(U,"CODE",{});var et=a(ne);ye=i(et,"input_ids"),et.forEach(t),he=i(U," only and nothing else: "),H=s(U,"CODE",{});var tt=a(H);Ce=i(tt,"model(input_ids)"),tt.forEach(t),U.forEach(t),be=c(K),F=s(K,"LI",{});var D=a(F);Pe=i(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),j=s(D,"CODE",{});var ot=a(j);Ae=i(ot,"model([input_ids, attention_mask])"),ot.forEach(t),je=i(D," or "),O=s(D,"CODE",{});var nt=a(O);Oe=i(nt,"model([input_ids, attention_mask, token_type_ids])"),nt.forEach(t),D.forEach(t),De=c(K),W=s(K,"LI",{});var Ne=a(W);J=i(Ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=s(Ne,"CODE",{});var re=a(A);ge=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(v,G){g(v,p,G),e(p,y),g(v,f,G),g(v,u,G),e(u,k),e(k,l),e(u,m),e(u,x),e(x,Fe),g(v,ce,G),g(v,X,G),e(X,ee),e(X,B),e(B,te),e(X,Ee),e(X,R),e(R,qe),e(X,ve),g(v,S,G),g(v,V,G),e(V,oe),g(v,fe,G),g(v,q,G),e(q,C),e(C,pe),e(C,ne),e(ne,ye),e(C,he),e(C,H),e(H,Ce),e(q,be),e(q,F),e(F,Pe),e(F,j),e(j,Ae),e(F,je),e(F,O),e(O,Oe),e(q,De),e(q,W),e(W,J),e(W,A),e(A,ge)},d(v){v&&t(p),v&&t(f),v&&t(u),v&&t(ce),v&&t(X),v&&t(S),v&&t(V),v&&t(fe),v&&t(q)}}}function hh(z){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function kh(z){let p,y,f,u,k,l,m,x,Fe,ce,X,ee,B,te,Ee,R,qe,ve,S,V,oe,fe,q,C,pe,ne,ye,he,H,Ce,be,F,Pe,j,Ae,je,O,Oe,De,W,J,A,ge,v,G,se,Qe,Be,E,_e,Ye,ae,K,U,et,tt,D,ot,nt,Ne,re,er,vn,tr,or,yn,nr,sr,ar,vt,la,st,yt,Qn,so,rr,Yn,ir,da,N,ao,lr,Ie,dr,bn,cr,pr,Tn,hr,ur,ro,mr,fr,gr,io,_r,Mn,kr,vr,yr,Re,lo,br,es,Tr,Mr,co,wn,wr,ts,Lr,$r,Ln,xr,os,zr,Xr,bt,po,Gr,ho,Fr,ns,Er,qr,Cr,Tt,uo,Pr,ss,Ar,jr,$n,mo,ca,at,Mt,as,fo,Or,rs,Dr,pa,ie,go,Nr,ke,Ir,is,Sr,Wr,xn,Ur,Br,zn,Rr,Vr,_o,Hr,Jr,Kr,ko,Zr,Xn,Qr,Yr,ei,Ve,vo,ti,ls,oi,ni,yo,Gn,si,ds,ai,ri,Fn,ii,cs,li,di,wt,bo,ci,ps,pi,ha,rt,Lt,hs,To,hi,us,ui,ua,le,Mo,mi,wo,fi,En,gi,_i,ki,Lo,vi,$o,yi,bi,Ti,$t,Mi,ms,wi,Li,fs,$i,xi,Te,xo,zi,it,Xi,qn,Gi,Fi,gs,Ei,qi,Ci,xt,Pi,zt,ma,lt,Xt,_s,zo,Ai,ks,ji,fa,de,Xo,Oi,vs,Di,Ni,Go,Ii,Cn,Si,Wi,Ui,Fo,Bi,Eo,Ri,Vi,Hi,Me,qo,Ji,dt,Ki,Pn,Zi,Qi,ys,Yi,el,tl,Gt,ol,Ft,ga,ct,Et,bs,Co,nl,Ts,sl,_a,Z,Po,al,Ao,rl,An,il,ll,dl,jo,cl,Oo,pl,hl,ul,qt,ml,Ct,fl,Ms,gl,_l,ws,kl,vl,we,Do,yl,pt,bl,jn,Tl,Ml,Ls,wl,Ll,$l,Pt,xl,At,ka,ht,jt,$s,No,zl,xs,Xl,va,Q,Io,Gl,zs,Fl,El,So,ql,On,Cl,Pl,Al,Wo,jl,Uo,Ol,Dl,Nl,Ot,Il,Le,Bo,Sl,ut,Wl,Dn,Ul,Bl,Xs,Rl,Vl,Hl,Dt,Jl,Nt,ya,mt,It,Gs,Ro,Kl,Fs,Zl,ba,Y,Vo,Ql,Ho,Yl,Nn,ed,td,od,Jo,nd,Ko,sd,ad,rd,Es,id,ld,Se,qs,Zo,dd,cd,Cs,Qo,pd,hd,Ps,Yo,ud,md,As,en,fd,gd,$e,tn,_d,ft,kd,js,vd,yd,Os,bd,Td,Md,St,wd,Wt,Ta,gt,Ut,Ds,on,Ld,Ns,$d,Ma,I,nn,xd,Is,zd,Xd,sn,Gd,In,Fd,Ed,qd,an,Cd,rn,Pd,Ad,jd,Ss,Od,Dd,We,Ws,ln,Nd,Id,Us,dn,Sd,Wd,Bs,cn,Ud,Bd,Rs,pn,Rd,Vd,xe,hn,Hd,_t,Jd,Vs,Kd,Zd,Hs,Qd,Yd,ec,Bt,tc,Rt,wa;return l=new Ue({}),te=new Ue({}),v=new Ue({}),_e=new P({props:{name:"class transformers.XGLMConfig",anchor:"transformers.XGLMConfig",parameters:[{name:"vocab_size",val:" = 256008"},{name:"max_position_embeddings",val:" = 2048"},{name:"d_model",val:" = 1024"},{name:"ffn_dim",val:" = 4096"},{name:"num_layers",val:" = 24"},{name:"attention_heads",val:" = 16"},{name:"activation_function",val:" = 'gelu'"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.0"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"scale_embedding",val:" = True"},{name:"use_cache",val:" = True"},{name:"decoder_start_token_id",val:" = 2"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XGLMConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 256008) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/tokenization_xglm.py#L189",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/tokenization_xglm.py#L214",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/tokenization_xglm_fast.py#L139",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/tokenization_xglm_fast.py#L164",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/modeling_xglm.py#L852",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/modeling_tf_xglm.py#L776",returnDescription:`
<p>A <a
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16543/src/transformers/models/xglm/modeling_tf_xglm.py#L893",returnDescription:`
<p>A <a
...
`}}),Dt=new no({props:{$$slots:{default:[hh]},$$scope:{ctx:z}}}),Nt=new gn({props:{anchor:"transformers.TFXGLMForCausalLM.call.example",$$slots:{default:[uh]},$$scope:{ctx:z}}}),Ro=new Ue({}),Vo=new P({props:{name:"class transformers.FlaxXGLMModel",anchor:"transformers.FlaxXGLMModel",parameters:[{name:"config",val:": XGLMConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXGLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16543/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),St=new no({props:{$$slots:{default:[mh]},$$scope:{ctx:z}}}),Wt=new gn({props:{anchor:"transformers.FlaxXGLMModel.__call__.example",$$slots:{default:[fh]},$$scope:{ctx:z}}}),on=new Ue({}),nn=new P({props:{name:"class transformers.FlaxXGLMForCausalLM",anchor:"transformers.FlaxXGLMForCausalLM",parameters:[{name:"config",val:": XGLMConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXGLMForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16543/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Bt=new no({props:{$$slots:{default:[gh]},$$scope:{ctx:z}}}),Rt=new gn({props:{anchor:"transformers.FlaxXGLMForCausalLM.__call__.example",$$slots:{default:[_h]},$$scope:{ctx:z}}}),{c(){p=n("meta"),y=d(),f=n("h1"),u=n("a"),k=n("span"),b(l.$$.fragment),m=d(),x=n("span"),Fe=r("XGLM"),ce=d(),X=n("h2"),ee=n("a"),B=n("span"),b(te.$$.fragment),Ee=d(),R=n("span"),qe=r("Overview"),ve=d(),S=n("p"),V=r("The XGLM model was proposed in "),oe=n("a"),fe=r("Few-shot Learning with Multilingual Language Models"),q=r(`
...
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),be=d(),F=n("p"),Pe=r("This model was contributed by "),j=n("a"),Ae=r("Suraj"),je=r(". The original code can be found "),O=n("a"),Oe=r("here"),De=r("."),W=d(),J=n("h2"),A=n("a"),ge=n("span"),b(v.$$.fragment),G=d(),se=n("span"),Qe=r("XGLMConfig"),Be=d(),E=n("div"),b(_e.$$.fragment),Ye=d(),ae=n("p"),K=r("This is the configuration class to store the configuration of a "),U=n("a"),et=r("XGLMModel"),tt=r(`. It is used to instantiate an XGLM
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Mr=d(),co=n("ul"),wn=n("li"),wr=r("single sequence: "),ts=n("code"),Lr=r("<s> X </s>"),$r=d(),Ln=n("li"),xr=r("pair of sequences: "),os=n("code"),zr=r("<s> A </s></s> B </s>"),Xr=d(),bt=n("div"),b(po.$$.fragment),Gr=d(),ho=n("p"),Fr=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
and behavior.`),Ti=d(),$t=n("p"),Mi=r("Transformer decoder consisting of "),ms=n("em"),wi=r("config.num_layers"),Li=r(" layers. Each layer is a "),fs=n("code"),$i=r("XGLMDecoderLayer"),xi=d(),Te=n("div"),b(xo.$$.fragment),zi=d(),it=n("p"),Xi=r("The "),qn=n("a"),Gi=r("XGLMModel"),Fi=r(" forward method, overrides the "),gs=n("code"),Ei=r("__call__"),qi=r(" special method."),Ci=d(),b(xt.$$.fragment),Pi=d(),b(zt.$$.fragment),ma=d(),lt=n("h2"),Xt=n("a"),_s=n("span"),b(zo.$$.fragment),Ai=d(),ks=n("span"),ji=r("XGLMForCausalLM"),fa=d(),de=n("div"),b(Xo.$$.fragment),Oi=d(),vs=n("p"),Di=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Ni=d(),Go=n("p"),Ii=r("This model inherits from "),Cn=n("a"),Si=r("PreTrainedModel"),Wi=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ui=d(),Fo=n("p"),Bi=r("This model is also a PyTorch "),Eo=n("a"),Ri=r("torch.nn.Module"),Vi=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hi=d(),Me=n("div"),b(qo.$$.fragment),Ji=d(),dt=n("p"),Ki=r("The "),Pn=n("a"),Zi=r("XGLMForCausalLM"),Qi=r(" forward method, overrides the "),ys=n("code"),Yi=r("__call__"),el=r(" special method."),tl=d(),b(Gt.$$.fragment),ol=d(),b(Ft.$$.fragment),ga=d(),ct=n("h2"),Et=n("a"),bs=n("span"),b(Co.$$.fragment),nl=d(),Ts=n("span"),sl=r("TFXGLMModel"),_a=d(),Z=n("div"),b(Po.$$.fragment),al=d(),Ao=n("p"),rl=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),ul=d(),b(qt.$$.fragment),ml=d(),Ct=n("p"),fl=r("Transformer decoder consisting of "),Ms=n("em"),gl=r("config.num_layers"),_l=r(" layers. Each layer is a "),ws=n("code"),kl=r("TFXGLMDecoderLayer"),vl=d(),we=n("div"),b(Do.$$.fragment),yl=d(),pt=n("p"),bl=r("The "),jn=n("a"),Tl=r("TFXGLMModel"),Ml=r(" forward method, overrides the "),Ls=n("code"),wl=r("__call__"),Ll=r(" special method."),$l=d(),b(Pt.$$.fragment),xl=d(),b(At.$$.fragment),ka=d(),ht=n("h2"),jt=n("a"),$s=n("span"),b(No.$$.fragment),zl=d(),xs=n("span"),Xl=r("TFXGLMForCausalLM"),va=d(),Q=n("div"),b(Io.$$.fragment),Gl=d(),zs=n("p"),Fl=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nl=d(),b(Ot.$$.fragment),Il=d(),Le=n("div"),b(Bo.$$.fragment),Sl=d(),ut=n("p"),Wl=r("The "),Dn=n("a"),Ul=r("TFXGLMForCausalLM"),Bl=r(" forward method, overrides the "),Xs=n("code"),Rl=r("__call__"),Vl=r(" special method."),Hl=d(),b(Dt.$$.fragment),Jl=d(),b(Nt.$$.fragment),ya=d(),mt=n("h2"),It=n("a"),Gs=n("span"),b(Ro.$$.fragment),Kl=d(),Fs=n("span"),Zl=r("FlaxXGLMModel"),ba=d(),Y=n("div"),b(Vo.$$.fragment),Ql=d(),Ho=n("p"),Yl=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
showing in particular that it enables cross-lingual in-context learning on some tasks, while there is still room for improvement
on surface form robustness and adaptation to tasks that do not have a natural cloze form. Finally, we evaluate our models
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),sa.forEach(t),na.forEach(t),be=c(o),F=s(o,"P",{});var kt=a(F);Pe=i(kt,"This model was contributed by "),j=s(kt,"A",{href:!0,rel:!0});var aa=a(j);Ae=i(aa,"Suraj"),aa.forEach(t),je=i(kt,". The original code can be found "),O=s(kt,"A",{href:!0,rel:!0});var rc=a(O);Oe=i(rc,"here"),rc.forEach(t),De=i(kt,"."),kt.forEach(t),W=c(o),J=s(o,"H2",{class:!0});var La=a(J);A=s(La,"A",{id:!0,class:!0,href:!0});var ic=a(A);ge=s(ic,"SPAN",{});var lc=a(ge);T(v.$$.fragment,lc),lc.forEach(t),ic.forEach(t),G=c(La),se=s(La,"SPAN",{});var dc=a(se);Qe=i(dc,"XGLMConfig"),dc.forEach(t),La.forEach(t),Be=c(o),E=s(o,"DIV",{class:!0});var Vt=a(E);T(_e.$$.fragment,Vt),Ye=c(Vt),ae=s(Vt,"P",{});var Sn=a(ae);K=i(Sn,"This is the configuration class to store the configuration of a "),U=s(Sn,"A",{href:!0});var cc=a(U);et=i(cc,"XGLMModel"),cc.forEach(t),tt=i(Sn,`. It is used to instantiate an XGLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),bc.forEach(t),Mr=c(Un),co=s(Un,"UL",{});var za=a(co);wn=s(za,"LI",{});var oc=a(wn);wr=i(oc,"single sequence: "),ts=s(oc,"CODE",{});var Tc=a(ts);Lr=i(Tc,"<s> X </s>"),Tc.forEach(t),oc.forEach(t),$r=c(za),Ln=s(za,"LI",{});var nc=a(Ln);xr=i(nc,"pair of sequences: "),os=s(nc,"CODE",{});var Mc=a(os);zr=i(Mc,"<s> A </s></s> B </s>"),Mc.forEach(t),nc.forEach(t),za.forEach(t),Un.forEach(t),Xr=c(ue),bt=s(ue,"DIV",{class:!0});var Xa=a(bt);T(po.$$.fragment,Xa),Gr=c(Xa),ho=s(Xa,"P",{});var Ga=a(ho);Fr=i(Ga,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ns=s(Ga,"CODE",{});var wc=a(ns);Er=i(wc,"prepare_for_model"),wc.forEach(t),qr=i(Ga," method."),Ga.forEach(t),Xa.forEach(t),Cr=c(ue),Tt=s(ue,"DIV",{class:!0});var Fa=a(Tt);T(uo.$$.fragment,Fa),Pr=c(Fa),ss=s(Fa,"P",{});var Lc=a(ss);Ar=i(Lc,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),Lc.forEach(t),Fa.forEach(t),jr=c(ue),$n=s(ue,"DIV",{class:!0});var $c=a($n);T(mo.$$.fragment,$c),$c.forEach(t),ue.forEach(t),ca=c(o),at=s(o,"H2",{class:!0});var Ea=a(at);Mt=s(Ea,"A",{id:!0,class:!0,href:!0});var xc=a(Mt);as=s(xc,"SPAN",{});var zc=a(as);T(fo.$$.fragment,zc),zc.forEach(t),xc.forEach(t),Or=c(Ea),rs=s(Ea,"SPAN",{});var Xc=a(rs);Dr=i(Xc,"XGLMTokenizerFast"),Xc.forEach(t),Ea.forEach(t),pa=c(o),ie=s(o,"DIV",{class:!0});var He=a(ie);T(go.$$.fragment,He),Nr=c(He),ke=s(He,"P",{});var Je=a(ke);Ir=i(Je,"Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),is=s(Je,"EM",{});var Gc=a(is);Sr=i(Gc,"tokenizers"),Gc.forEach(t),Wr=i(Je," library). Adapted from "),xn=s(Je,"A",{href:!0});var Fc=a(xn);Ur=i(Fc,"RobertaTokenizer"),Fc.forEach(t),Br=i(Je,`
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ja.forEach(t),od=c(Ge),Jo=s(Ge,"P",{});var Ka=a(Jo);nd=i(Ka,`This model is also a Flax Linen
`),Ko=s(Ka,"A",{href:!0,rel:!0});var Mp=a(Ko);sd=i(Mp,"flax.nn.Module"),Mp.forEach(t),ad=i(Ka,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ka.forEach(t),rd=c(Ge),Es=s(Ge,"P",{});var wp=a(Es);id=i(wp,"Finally, this model supports inherent JAX features such as:"),wp.forEach(t),ld=c(Ge),Se=s(Ge,"UL",{});var Yt=a(Se);qs=s(Yt,"LI",{});var Lp=a(qs);Zo=s(Lp,"A",{href:!0,rel:!0});var $p=a(Zo);dd=i($p,"Just-In-Time (JIT) compilation"),$p.forEach(t),Lp.forEach(t),cd=c(Yt),Cs=s(Yt,"LI",{});var xp=a(Cs);Qo=s(xp,"A",{href:!0,rel:!0});var zp=a(Qo);pd=i(zp,"Automatic Differentiation"),zp.forEach(t),xp.forEach(t),hd=c(Yt),Ps=s(Yt,"LI",{});var Xp=a(Ps);Yo=s(Xp,"A",{href:!0,rel:!0});var Gp=a(Yo);ud=i(Gp,"Vectorization"),Gp.forEach(t),Xp.forEach(t),md=c(Yt),As=s(Yt,"LI",{});var Fp=a(As);en=s(Fp,"A",{href:!0,rel:!0});var Ep=a(en);fd=i(Ep,"Parallelization"),Ep.forEach(t),Fp.forEach(t),Yt.forEach(t),gd=c(Ge),$e=s(Ge,"DIV",{class:!0});var eo=a($e);T(tn.$$.fragment,eo),_d=c(eo),ft=s(eo,"P",{});var Kn=a(ft);kd=i(Kn,"The "),js=s(Kn,"CODE",{});var qp=a(js);vd=i(qp,"FlaxXGLMPreTrainedModel"),qp.forEach(t),yd=i(Kn," forward method, overrides the "),Os=s(Kn,"CODE",{});var Cp=a(Os);bd=i(Cp,"__call__"),Cp.forEach(t),Td=i(Kn," special method."),Kn.forEach(t),Md=c(eo),T(St.$$.fragment,eo),wd=c(eo),T(Wt.$$.fragment,eo),eo.forEach(t),Ge.forEach(t),Ta=c(o),gt=s(o,"H2",{class:!0});var Za=a(gt);Ut=s(Za,"A",{id:!0,class:!0,href:!0});var Pp=a(Ut);Ds=s(Pp,"SPAN",{});var Ap=a(Ds);T(on.$$.fragment,Ap),Ap.forEach(t),Pp.forEach(t),Ld=c(Za),Ns=s(Za,"SPAN",{});var jp=a(Ns);$d=i(jp,"FlaxXGLMForCausalLM"),jp.forEach(t),Za.forEach(t),Ma=c(o),I=s(o,"DIV",{class:!0});var me=a(I);T(nn.$$.fragment,me),xd=c(me),Is=s(me,"P",{});var Op=a(Is);zd=i(Op,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Op.forEach(t),Xd=c(me),sn=s(me,"P",{});var Qa=a(sn);Gd=i(Qa,"This model inherits from "),In=s(Qa,"A",{href:!0});var Dp=a(In);Fd=i(Dp,"FlaxPreTrainedModel"),Dp.forEach(t),Ed=i(Qa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
