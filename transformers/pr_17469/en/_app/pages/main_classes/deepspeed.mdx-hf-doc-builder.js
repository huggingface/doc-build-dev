...
`),Rp=o("a"),Q6=a("deepspeed-zero-inference"),e4=a("."),Aj=u(),Ip=o("p"),s4=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
...
context) `),uo=o("a"),V4=a("here"),Y4=a("."),ew=u(),Bp=o("p"),K4=a("You can check the archs pytorch was built with using:"),sw=u(),f(co.$$.fragment),tw=u(),Wp=o("p"),J4=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),aw=u(),f(ho.$$.fragment),nw=u(),Fp=o("p"),X4=a("If the output is:"),ow=u(),f(fo.$$.fragment),lw=u(),kt=o("p"),Q4=a("then you know that this card\u2019s arch is "),ff=o("code"),e$=a("8.6"),s$=a("."),rw=u(),Pt=o("p"),t$=a("You can also leave "),df=o("code"),a$=a("TORCH_CUDA_ARCH_LIST"),n$=a(` out completely and then the build program will automatically query the
...
important, getting a slightly slower training time could be a good trade.`),Gy=u(),He=o("p"),J9=a("Additionally, "),bd=o("code"),X9=a("deepspeed==0.4.4"),Q9=a(" added a new option "),qd=o("code"),e8=a("round_robin_gradients"),s8=a(" which you can enable with:"),My=u(),f(Qo.$$.fragment),Ly=u(),xi=o("p"),t8=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),Zy=u(),Ri=o("a"),Ny=u(),Rs=o("h4"),oa=o("a"),Ed=o("span"),f(el.$$.fragment),a8=u(),$d=o("span"),n8=a("ZeRO-3 Config"),Hy=u(),Ii=o("p"),o8=a("The following is an example of configuration for ZeRO stage 3:"),By=u(),f(sl.$$.fragment),Wy=u(),V=o("p"),l8=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),kd=o("code"),r8=a('"device": "cpu"'),p8=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Pd=o("code"),i8=a("none"),u8=a(" instead of "),zd=o("code"),c8=a("cpu"),h8=a(" for the "),Dd=o("code"),f8=a("device"),d8=a(` entry. Offloading to
NVMe is discussed further down.`),Fy=u(),Be=o("p"),m8=a("Pinned memory is enabled with "),Od=o("code"),_8=a("pin_memory"),v8=a(" set to "),Ad=o("code"),j8=a("true"),w8=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Vy=u(),Ui=o("p"),Td=o("strong"),y8=a("Performance tuning:"),Yy=u(),la=o("ul"),tl=o("li"),Sd=o("code"),g8=a("stage3_max_live_parameters"),b8=a(": "),Cd=o("code"),q8=a("1e9"),E8=u(),al=o("li"),xd=o("code"),$8=a("stage3_max_reuse_distance"),k8=a(": "),Rd=o("code"),P8=a("1e9"),Ky=u(),M=o("p"),z8=a("If hitting OOM reduce "),Id=o("code"),D8=a("stage3_max_live_parameters"),O8=a(" and "),Ud=o("code"),A8=a("stage3_max_reuse_distance"),T8=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Gd=o("code"),S8=a("1e9"),C8=a(` would consume ~2GB. The memory is shared by
`),Md=o("code"),x8=a("stage3_max_live_parameters"),R8=a(" and "),Ld=o("code"),I8=a("stage3_max_reuse_distance"),U8=a(", so it\u2019s not additive, it\u2019s just 2GB total."),Jy=u(),ze=o("p"),Zd=o("code"),G8=a("stage3_max_live_parameters"),M8=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Nd=o("code"),L8=a("stage3_max_reuse_distance"),Z8=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Hd=o("code"),N8=a("stage3_max_reuse_distance"),H8=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Xy=u(),Gi=o("p"),B8=a("The following configuration values depend on the model\u2019s hidden size:"),Qy=u(),We=o("ul"),nl=o("li"),Bd=o("code"),W8=a("reduce_bucket_size"),F8=a(": "),Wd=o("code"),V8=a("hidden_size*hidden_size"),Y8=u(),ol=o("li"),Fd=o("code"),K8=a("stage3_prefetch_bucket_size"),J8=a(": "),Vd=o("code"),X8=a("0.9 * hidden_size * hidden_size"),Q8=u(),ll=o("li"),Yd=o("code"),ek=a("stage3_param_persistence_threshold"),sk=a(": "),Kd=o("code"),tk=a("10 * hidden_size"),eg=u(),Fe=o("p"),ak=a("therefore set these values to "),Jd=o("code"),nk=a("auto"),ok=a(" and the "),Mi=o("a"),lk=a("Trainer"),rk=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),sg=u(),rl=o("p"),Xd=o("code"),pk=a("stage3_gather_16bit_weights_on_model_save"),ik=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),tg=u(),le=o("p"),uk=a("If you\u2019re migrating from ZeRO-2 configuration note that "),Qd=o("code"),ck=a("allgather_partitions"),hk=a(", "),em=o("code"),fk=a("allgather_bucket_size"),dk=a(` and
`),sm=o("code"),mk=a("reduce_scatter"),_k=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),ag=u(),Li=o("ul"),pl=o("li"),tm=o("code"),vk=a("sub_group_size"),jk=a(": "),am=o("code"),wk=a("1e9"),ng=u(),De=o("p"),nm=o("code"),yk=a("sub_group_size"),gk=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),om=o("code"),bk=a("sub_group_size"),qk=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),lm=o("code"),Ek=a("sub_group_size"),$k=a(` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),og=u(),Ve=o("p"),kk=a("You can leave "),rm=o("code"),Pk=a("sub_group_size"),zk=a(" to its default value of "),pm=o("em"),Dk=a("1e9"),Ok=a(` when not using NVMe offload. You may want to change its
default value in the following cases:`),lg=u(),ra=o("ol"),il=o("li"),Ak=a("Running into OOM during optimizer step: Reduce "),im=o("code"),Tk=a("sub_group_size"),Sk=a(" to reduce memory utilization of temporary buffers"),Ck=u(),ul=o("li"),xk=a("Optimizer Step is taking a long time: Increase "),um=o("code"),Rk=a("sub_group_size"),Ik=a(` to improve bandwidth utilization as a result of
the increased data buffers.`),rg=u(),Zi=o("a"),pg=u(),Is=o("h3"),pa=o("a"),cm=o("span"),f(cl.$$.fragment),Uk=u(),hm=o("span"),Gk=a("NVMe Support"),ig=u(),Ni=o("p"),Mk=a(`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
...
process. ZeRO-Infinity requires ZeRO-3 enabled.`),ug=u(),Hi=o("p"),Lk=a("The following configuration example enables NVMe to offload both optimizer states and the params:"),cg=u(),f(hl.$$.fragment),hg=u(),ia=o("p"),Zk=a(`You can choose to offload both optimizer states and params to NVMe, or just one of them or none. For example, if you
have copious amounts of CPU memory available, by all means offload to CPU memory only as it\u2019d be faster (hint:
`),fm=o("em"),Nk=a("\u201Cdevice\u201D: \u201Ccpu\u201D"),Hk=a(")."),fg=u(),Ye=o("p"),Bk=a("Here is the full documentation for offloading "),fl=o("a"),Wk=a("optimizer states"),Fk=a(" and "),dl=o("a"),Vk=a("parameters"),Yk=a("."),dg=u(),ua=o("p"),Kk=a("Make sure that your "),dm=o("code"),Jk=a("nvme_path"),Xk=a(` is actually an NVMe, since it will work with the normal hard drive or SSD, but it\u2019ll
be much much slower. The fast scalable training was designed with modern NVMe transfer speeds in mind (as of this
writing one can have ~3.5GB/s read, ~3GB/s write peak speeds).`),mg=u(),Ke=o("p"),Qk=a("In order to figure out the optimal "),mm=o("code"),eP=a("aio"),sP=a(` configuration block you must run a benchmark on your target setup, as
...
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(R0,"A",{href:!0});var YU=r(Rp);Q6=n(YU,"deepspeed-zero-inference"),YU.forEach(t),e4=n(R0,"."),R0.forEach(t),VU.forEach(t),Aj=c(e),Ip=l(e,"P",{});var KU=r(Ip);s4=n(KU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
...
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),TL.forEach(t),ph.forEach(t),Gy=c(e),He=l(e,"P",{});var uh=r(He);J9=n(uh,"Additionally, "),bd=l(uh,"CODE",{});var SL=r(bd);X9=n(SL,"deepspeed==0.4.4"),SL.forEach(t),Q9=n(uh," added a new option "),qd=l(uh,"CODE",{});var CL=r(qd);e8=n(CL,"round_robin_gradients"),CL.forEach(t),s8=n(uh," which you can enable with:"),uh.forEach(t),My=c(e),d(Qo.$$.fragment,e),Ly=c(e),xi=l(e,"P",{});var xL=r(xi);t8=n(xL,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),xL.forEach(t),Zy=c(e),Ri=l(e,"A",{id:!0}),r(Ri).forEach(t),Ny=c(e),Rs=l(e,"H4",{class:!0});var bq=r(Rs);oa=l(bq,"A",{id:!0,class:!0,href:!0});var RL=r(oa);Ed=l(RL,"SPAN",{});var IL=r(Ed);d(el.$$.fragment,IL),IL.forEach(t),RL.forEach(t),a8=c(bq),$d=l(bq,"SPAN",{});var UL=r($d);n8=n(UL,"ZeRO-3 Config"),UL.forEach(t),bq.forEach(t),Hy=c(e),Ii=l(e,"P",{});var GL=r(Ii);o8=n(GL,"The following is an example of configuration for ZeRO stage 3:"),GL.forEach(t),By=c(e),d(sl.$$.fragment,e),Wy=c(e),V=l(e,"P",{});var ws=r(V);l8=n(ws,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),kd=l(ws,"CODE",{});var ML=r(kd);r8=n(ML,'"device": "cpu"'),ML.forEach(t),p8=n(ws,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Pd=l(ws,"CODE",{});var LL=r(Pd);i8=n(LL,"none"),LL.forEach(t),u8=n(ws," instead of "),zd=l(ws,"CODE",{});var ZL=r(zd);c8=n(ZL,"cpu"),ZL.forEach(t),h8=n(ws," for the "),Dd=l(ws,"CODE",{});var NL=r(Dd);f8=n(NL,"device"),NL.forEach(t),d8=n(ws,` entry. Offloading to
NVMe is discussed further down.`),ws.forEach(t),Fy=c(e),Be=l(e,"P",{});var ch=r(Be);m8=n(ch,"Pinned memory is enabled with "),Od=l(ch,"CODE",{});var HL=r(Od);_8=n(HL,"pin_memory"),HL.forEach(t),v8=n(ch," set to "),Ad=l(ch,"CODE",{});var BL=r(Ad);j8=n(BL,"true"),BL.forEach(t),w8=n(ch,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),ch.forEach(t),Vy=c(e),Ui=l(e,"P",{});var WL=r(Ui);Td=l(WL,"STRONG",{});var FL=r(Td);y8=n(FL,"Performance tuning:"),FL.forEach(t),WL.forEach(t),Yy=c(e),la=l(e,"UL",{});var qq=r(la);tl=l(qq,"LI",{});var Eq=r(tl);Sd=l(Eq,"CODE",{});var VL=r(Sd);g8=n(VL,"stage3_max_live_parameters"),VL.forEach(t),b8=n(Eq,": "),Cd=l(Eq,"CODE",{});var YL=r(Cd);q8=n(YL,"1e9"),YL.forEach(t),Eq.forEach(t),E8=c(qq),al=l(qq,"LI",{});var $q=r(al);xd=l($q,"CODE",{});var KL=r(xd);$8=n(KL,"stage3_max_reuse_distance"),KL.forEach(t),k8=n($q,": "),Rd=l($q,"CODE",{});var JL=r(Rd);P8=n(JL,"1e9"),JL.forEach(t),$q.forEach(t),qq.forEach(t),Ky=c(e),M=l(e,"P",{});var ge=r(M);z8=n(ge,"If hitting OOM reduce "),Id=l(ge,"CODE",{});var XL=r(Id);D8=n(XL,"stage3_max_live_parameters"),XL.forEach(t),O8=n(ge," and "),Ud=l(ge,"CODE",{});var QL=r(Ud);A8=n(QL,"stage3_max_reuse_distance"),QL.forEach(t),T8=n(ge,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),Gd=l(ge,"CODE",{});var eZ=r(Gd);S8=n(eZ,"1e9"),eZ.forEach(t),C8=n(ge,` would consume ~2GB. The memory is shared by
`),Md=l(ge,"CODE",{});var sZ=r(Md);x8=n(sZ,"stage3_max_live_parameters"),sZ.forEach(t),R8=n(ge," and "),Ld=l(ge,"CODE",{});var tZ=r(Ld);I8=n(tZ,"stage3_max_reuse_distance"),tZ.forEach(t),U8=n(ge,", so it\u2019s not additive, it\u2019s just 2GB total."),ge.forEach(t),Jy=c(e),ze=l(e,"P",{});var gp=r(ze);Zd=l(gp,"CODE",{});var aZ=r(Zd);G8=n(aZ,"stage3_max_live_parameters"),aZ.forEach(t),M8=n(gp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),Nd=l(gp,"CODE",{});var nZ=r(Nd);L8=n(nZ,"stage3_max_reuse_distance"),nZ.forEach(t),Z8=n(gp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),Hd=l(gp,"CODE",{});var oZ=r(Hd);N8=n(oZ,"stage3_max_reuse_distance"),oZ.forEach(t),H8=n(gp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),gp.forEach(t),Xy=c(e),Gi=l(e,"P",{});var lZ=r(Gi);B8=n(lZ,"The following configuration values depend on the model\u2019s hidden size:"),lZ.forEach(t),Qy=c(e),We=l(e,"UL",{});var hh=r(We);nl=l(hh,"LI",{});var kq=r(nl);Bd=l(kq,"CODE",{});var rZ=r(Bd);W8=n(rZ,"reduce_bucket_size"),rZ.forEach(t),F8=n(kq,": "),Wd=l(kq,"CODE",{});var pZ=r(Wd);V8=n(pZ,"hidden_size*hidden_size"),pZ.forEach(t),kq.forEach(t),Y8=c(hh),ol=l(hh,"LI",{});var Pq=r(ol);Fd=l(Pq,"CODE",{});var iZ=r(Fd);K8=n(iZ,"stage3_prefetch_bucket_size"),iZ.forEach(t),J8=n(Pq,": "),Vd=l(Pq,"CODE",{});var uZ=r(Vd);X8=n(uZ,"0.9 * hidden_size * hidden_size"),uZ.forEach(t),Pq.forEach(t),Q8=c(hh),ll=l(hh,"LI",{});var zq=r(ll);Yd=l(zq,"CODE",{});var cZ=r(Yd);ek=n(cZ,"stage3_param_persistence_threshold"),cZ.forEach(t),sk=n(zq,": "),Kd=l(zq,"CODE",{});var hZ=r(Kd);tk=n(hZ,"10 * hidden_size"),hZ.forEach(t),zq.forEach(t),hh.forEach(t),eg=c(e),Fe=l(e,"P",{});var fh=r(Fe);ak=n(fh,"therefore set these values to "),Jd=l(fh,"CODE",{});var fZ=r(Jd);nk=n(fZ,"auto"),fZ.forEach(t),ok=n(fh," and the "),Mi=l(fh,"A",{href:!0});var dZ=r(Mi);lk=n(dZ,"Trainer"),dZ.forEach(t),rk=n(fh,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),fh.forEach(t),sg=c(e),rl=l(e,"P",{});var jU=r(rl);Xd=l(jU,"CODE",{});var mZ=r(Xd);pk=n(mZ,"stage3_gather_16bit_weights_on_model_save"),mZ.forEach(t),ik=n(jU,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),jU.forEach(t),tg=c(e),le=l(e,"P",{});var In=r(le);uk=n(In,"If you\u2019re migrating from ZeRO-2 configuration note that "),Qd=l(In,"CODE",{});var _Z=r(Qd);ck=n(_Z,"allgather_partitions"),_Z.forEach(t),hk=n(In,", "),em=l(In,"CODE",{});var vZ=r(em);fk=n(vZ,"allgather_bucket_size"),vZ.forEach(t),dk=n(In,` and
`),sm=l(In,"CODE",{});var jZ=r(sm);mk=n(jZ,"reduce_scatter"),jZ.forEach(t),_k=n(In,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),In.forEach(t),ag=c(e),Li=l(e,"UL",{});var wZ=r(Li);pl=l(wZ,"LI",{});var Dq=r(pl);tm=l(Dq,"CODE",{});var yZ=r(tm);vk=n(yZ,"sub_group_size"),yZ.forEach(t),jk=n(Dq,": "),am=l(Dq,"CODE",{});var gZ=r(am);wk=n(gZ,"1e9"),gZ.forEach(t),Dq.forEach(t),wZ.forEach(t),ng=c(e),De=l(e,"P",{});var bp=r(De);nm=l(bp,"CODE",{});var bZ=r(nm);yk=n(bZ,"sub_group_size"),bZ.forEach(t),gk=n(bp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),om=l(bp,"CODE",{});var qZ=r(om);bk=n(qZ,"sub_group_size"),qZ.forEach(t),qk=n(bp,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),lm=l(bp,"CODE",{});var EZ=r(lm);Ek=n(EZ,"sub_group_size"),EZ.forEach(t),$k=n(bp,` therefore controls the granularity in which model states are moved in and out of CPU
memory from NVMe during the optimizer step. This prevents running out of CPU memory for extremely large models.`),bp.forEach(t),og=c(e),Ve=l(e,"P",{});var dh=r(Ve);kk=n(dh,"You can leave "),rm=l(dh,"CODE",{});var $Z=r(rm);Pk=n($Z,"sub_group_size"),$Z.forEach(t),zk=n(dh," to its default value of "),pm=l(dh,"EM",{});var kZ=r(pm);Dk=n(kZ,"1e9"),kZ.forEach(t),Ok=n(dh,` when not using NVMe offload. You may want to change its
default value in the following cases:`),dh.forEach(t),lg=c(e),ra=l(e,"OL",{});var Oq=r(ra);il=l(Oq,"LI",{});var Aq=r(il);Ak=n(Aq,"Running into OOM during optimizer step: Reduce "),im=l(Aq,"CODE",{});var PZ=r(im);Tk=n(PZ,"sub_group_size"),PZ.forEach(t),Sk=n(Aq," to reduce memory utilization of temporary buffers"),Aq.forEach(t),Ck=c(Oq),ul=l(Oq,"LI",{});var Tq=r(ul);xk=n(Tq,"Optimizer Step is taking a long time: Increase "),um=l(Tq,"CODE",{});var zZ=r(um);Rk=n(zZ,"sub_group_size"),zZ.forEach(t),Ik=n(Tq,` to improve bandwidth utilization as a result of
the increased data buffers.`),Tq.forEach(t),Oq.forEach(t),rg=c(e),Zi=l(e,"A",{id:!0}),r(Zi).forEach(t),pg=c(e),Is=l(e,"H3",{class:!0});var Sq=r(Is);pa=l(Sq,"A",{id:!0,class:!0,href:!0});var DZ=r(pa);cm=l(DZ,"SPAN",{});var OZ=r(cm);d(cl.$$.fragment,OZ),OZ.forEach(t),DZ.forEach(t),Uk=c(Sq),hm=l(Sq,"SPAN",{});var AZ=r(hm);Gk=n(AZ,"NVMe Support"),AZ.forEach(t),Sq.forEach(t),ig=c(e),Ni=l(e,"P",{});var TZ=r(Ni);Mk=n(TZ,`ZeRO-Infinity allows for training incredibly large models by extending GPU and CPU memory with NVMe memory. Thanks to
smart partitioning and tiling algorithms each GPU needs to send and receive very small amounts of data during
offloading so modern NVMe proved to be fit to allow for an even larger total memory pool available to your training
process. ZeRO-Infinity requires ZeRO-3 enabled.`),TZ.forEach(t),ug=c(e),Hi=l(e,"P",{});var SZ=r(Hi);Lk=n(SZ,"The following configuration example enables NVMe to offload both optimizer states and the params:"),SZ.forEach(t),cg=c(e),d(hl.$$.fragment,e),hg=c(e),ia=l(e,"P",{});var Cq=r(ia);Zk=n(Cq,`You can choose to offload both optimizer states and params to NVMe, or just one of them or none. For example, if you
have copious amounts of CPU memory available, by all means offload to CPU memory only as it\u2019d be faster (hint:
`),fm=l(Cq,"EM",{});var CZ=r(fm);Nk=n(CZ,"\u201Cdevice\u201D: \u201Ccpu\u201D"),CZ.forEach(t),Hk=n(Cq,")."),Cq.forEach(t),fg=c(e),Ye=l(e,"P",{});var mh=r(Ye);Bk=n(mh,"Here is the full documentation for offloading "),fl=l(mh,"A",{href:!0,rel:!0});var xZ=r(fl);Wk=n(xZ,"optimizer states"),xZ.forEach(t),Fk=n(mh," and "),dl=l(mh,"A",{href:!0,rel:!0});var RZ=r(dl);Vk=n(RZ,"parameters"),RZ.forEach(t),Yk=n(mh,"."),mh.forEach(t),dg=c(e),ua=l(e,"P",{});var xq=r(ua);Kk=n(xq,"Make sure that your "),dm=l(xq,"CODE",{});var IZ=r(dm);Jk=n(IZ,"nvme_path"),IZ.forEach(t),Xk=n(xq,` is actually an NVMe, since it will work with the normal hard drive or SSD, but it\u2019ll
be much much slower. The fast scalable training was designed with modern NVMe transfer speeds in mind (as of this
writing one can have ~3.5GB/s read, ~3GB/s write peak speeds).`),xq.forEach(t),mg=c(e),Ke=l(e,"P",{});var _h=r(Ke);Qk=n(_h,"In order to figure out the optimal "),mm=l(_h,"CODE",{});var UZ=r(mm);eP=n(UZ,"aio"),UZ.forEach(t),sP=n(_h,` configuration block you must run a benchmark on your target setup, as
