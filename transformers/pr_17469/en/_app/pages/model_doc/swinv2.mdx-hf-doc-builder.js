import{S as xs,i as Ms,s as Es,e as s,k as u,w as b,t as i,M as Fs,c as a,d as o,m as g,a as r,x as $,h as l,b as c,G as e,g as _,y,q as S,o as k,B as T,v as js,L as oo}from"../../chunks/vendor-hf-doc-builder.js";import{T as Wn}from"../../chunks/Tip-hf-doc-builder.js";import{D as Le}from"../../chunks/Docstring-hf-doc-builder.js";import{C as no}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as rt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as to}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Cs(x){let d,v,f,p,w;return p=new no({props:{code:`from transformers import Swinv2Config, Swinv2Model
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),v=i("Example:"),f=u(),b(p.$$.fragment)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Example:"),h.forEach(o),f=g(n),$(p.$$.fragment,n)},m(n,h){_(n,d,h),e(d,v),_(n,f,h),y(p,n,h),w=!0},p:oo,i(n){w||(S(p.$$.fragment,n),w=!0)},o(n){k(p.$$.fragment,n),w=!1},d(n){n&&o(d),n&&o(f),T(p,n)}}}function Is(x){let d,v,f,p,w;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),p=i("Module"),w=i(`
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),{c(){d=s("p"),v=i("Examples:"),f=u(),b(p.$$.fragment)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Examples:"),h.forEach(o),f=g(n),$(p.$$.fragment,n)},m(n,h){_(n,d,h),e(d,v),_(n,f,h),y(p,n,h),w=!0},p:oo,i(n){w||(S(p.$$.fragment,n),w=!0)},o(n){k(p.$$.fragment,n),w=!1},d(n){n&&o(d),n&&o(f),T(p,n)}}}function zs(x){let d,v,f,p,w;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),p=i("Module"),w=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var M=r(f);p=l(M,"Module"),M.forEach(o),w=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
tabby, tabby cat`}}),{c(){d=s("p"),v=i("Example:"),f=u(),b(p.$$.fragment)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Example:"),h.forEach(o),f=g(n),$(p.$$.fragment,n)},m(n,h){_(n,d,h),e(d,v),_(n,f,h),y(p,n,h),w=!0},p:oo,i(n){w||(S(p.$$.fragment,n),w=!0)},o(n){k(p.$$.fragment,n),w=!1},d(n){n&&o(d),n&&o(f),T(p,n)}}}function Ns(x){let d,v,f,p,w,n,h,M,so,Ft,O,Y,it,he,ao,lt,ro,jt,G,io,me,lo,co,Ct,De,po,It,We,dt,ho,At,He,mo,Pt,q,fe,fo,Ve,uo,go,_o,ue,wo,ct,vo,bo,$o,ge,yo,pt,So,ko,qt,z,To,_e,xo,Mo,we,Eo,Fo,zt,N,K,ht,ve,jo,mt,Co,Ot,E,be,Io,L,Ao,Ue,Po,qo,$e,zo,Oo,No,D,Lo,Ze,Do,Wo,Be,Ho,Vo,Uo,J,Nt,W,X,ft,ye,Zo,ut,Bo,Lt,A,Se,Ro,ke,Yo,Te,Go,Ko,Jo,j,xe,Xo,H,Qo,Re,en,tn,gt,on,nn,sn,Q,an,ee,Dt,V,te,_t,Me,rn,wt,ln,Wt,P,Ee,dn,U,cn,Fe,pn,hn,je,mn,fn,un,C,Ce,gn,Z,_n,Ye,wn,vn,vt,bn,$n,yn,oe,Sn,ne,Ht,B,se,bt,Ie,kn,$t,Tn,Vt,F,Ae,xn,yt,Mn,En,Pe,Fn,qe,jn,Cn,In,I,ze,An,R,Pn,Ge,qn,zn,St,On,Nn,Ln,ae,Dn,re,Ut;return n=new rt({}),he=new rt({}),ve=new rt({}),be=new Le({props:{name:"class transformers.Swinv2Config",anchor:"transformers.Swinv2Config",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Swinv2Config.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_17469/src/transformers/models/swinv2/modeling_swinv2.py#L1067",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17469/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17469/src/transformers/models/swinv2/modeling_swinv2.py#L1162"}}),ze=new Le({props:{name:"forward",anchor:"transformers.Swinv2ForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Swinv2ForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_17469/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17469/src/transformers/models/swinv2/modeling_swinv2.py#L1177",returnDescription:`
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),un=u(),C=s("div"),b(Ce.$$.fragment),gn=u(),Z=s("p"),_n=i("The "),Ye=s("a"),wn=i("Swinv2ForMaskedImageModeling"),vn=i(" forward method, overrides the "),vt=s("code"),bn=i("__call__"),$n=i(" special method."),yn=u(),b(oe.$$.fragment),Sn=u(),b(ne.$$.fragment),Ht=u(),B=s("h2"),se=s("a"),bt=s("span"),b(Ie.$$.fragment),kn=u(),$t=s("span"),Tn=i("Swinv2ForImageClassification"),Vt=u(),F=s("div"),b(Ae.$$.fragment),xn=u(),yt=s("p"),Mn=i(`Swinv2 Model transformer with an image classification head on top (a linear layer on top of the final hidden state
...
documentation from `),Be=a(Qe,"A",{href:!0});var as=r(Be);Ho=l(as,"PretrainedConfig"),as.forEach(o),Vo=l(Qe," for more information."),Qe.forEach(o),Uo=g(ie),$(J.$$.fragment,ie),ie.forEach(o),Nt=g(t),W=a(t,"H2",{class:!0});var Kt=r(W);X=a(Kt,"A",{id:!0,class:!0,href:!0});var rs=r(X);ft=a(rs,"SPAN",{});var is=r(ft);$(ye.$$.fragment,is),is.forEach(o),rs.forEach(o),Zo=g(Kt),ut=a(Kt,"SPAN",{});var ls=r(ut);Bo=l(ls,"Swinv2Model"),ls.forEach(o),Kt.forEach(o),Lt=g(t),A=a(t,"DIV",{class:!0});var et=r(A);$(Se.$$.fragment,et),Ro=g(et),ke=a(et,"P",{});var Jt=r(ke);Yo=l(Jt,`The bare Swinv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Te=a(Jt,"A",{href:!0,rel:!0});var ds=r(Te);Go=l(ds,"torch.nn.Module"),ds.forEach(o),Ko=l(Jt,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
