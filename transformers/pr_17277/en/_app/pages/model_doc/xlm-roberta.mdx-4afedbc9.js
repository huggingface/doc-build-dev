...
documentation alongside usage examples.`),rf.forEach(t),Kw=p(tt),Et=s(tt,"DIV",{class:!0});var As=a(Et);y(Fi.$$.fragment,As),Gw=p(As),Uo=s(As,"P",{});var Jd=a(Uo);Yw=i(Jd,"The "),Wp=s(Jd,"CODE",{});var R0=a(Wp);Zw=i(R0,"FlaxRobertaPreTrainedModel"),R0.forEach(t),e2=i(Jd," forward method, overrides the "),Bp=s(Jd,"CODE",{});var L0=a(Bp);t2=i(L0,"__call__"),L0.forEach(t),o2=i(Jd," special method."),Jd.forEach(t),n2=p(As),y(gs.$$.fragment,As),s2=p(As),y(_s.$$.fragment,As),As.forEach(t),tt.forEach(t),Om=p(o),Qo=s(o,"H2",{class:!0});var lf=a(Qo);bs=s(lf,"A",{id:!0,class:!0,href:!0});var E0=a(bs);Up=s(E0,"SPAN",{});var z0=a(Up);y(xi.$$.fragment,z0),z0.forEach(t),E0.forEach(t),a2=p(lf),Qp=s(lf,"SPAN",{});var q0=a(Qp);r2=i(q0,"FlaxXLMRobertaForMultipleChoice"),q0.forEach(t),lf.forEach(t),Nm=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Ri.$$.fragment,ot),i2=p(ot),Hp=s(ot,"P",{});var C0=a(Hp);l2=i(C0,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),C0.forEach(t),d2=p(ot),Li=s(ot,"P",{});var df=a(Li);c2=i(df,"This model inherits from "),yd=s(df,"A",{href:!0});var j0=a(yd);p2=i(j0,"FlaxPreTrainedModel"),j0.forEach(t),h2=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),df.forEach(t),m2=p(ot),Ei=s(ot,"P",{});var cf=a(Ei);u2=i(cf,"This model is also a Flax Linen "),zi=s(cf,"A",{href:!0,rel:!0});var X0=a(zi);f2=i(X0,"flax.linen.Module"),X0.forEach(t),g2=i(cf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cf.forEach(t),_2=p(ot),Vp=s(ot,"P",{});var P0=a(Vp);b2=i(P0,"Finally, this model supports inherent JAX features such as:"),P0.forEach(t),k2=p(ot),Ut=s(ot,"UL",{});var Os=a(Ut);Jp=s(Os,"LI",{});var A0=a(Jp);qi=s(A0,"A",{href:!0,rel:!0});var O0=a(qi);v2=i(O0,"Just-In-Time (JIT) compilation"),O0.forEach(t),A0.forEach(t),T2=p(Os),Kp=s(Os,"LI",{});var N0=a(Kp);Ci=s(N0,"A",{href:!0,rel:!0});var I0=a(Ci);y2=i(I0,"Automatic Differentiation"),I0.forEach(t),N0.forEach(t),w2=p(Os),Gp=s(Os,"LI",{});var D0=a(Gp);ji=s(D0,"A",{href:!0,rel:!0});var S0=a(ji);$2=i(S0,"Vectorization"),S0.forEach(t),D0.forEach(t),M2=p(Os),Yp=s(Os,"LI",{});var W0=a(Yp);Xi=s(W0,"A",{href:!0,rel:!0});var B0=a(Xi);F2=i(B0,"Parallelization"),B0.forEach(t),W0.forEach(t),Os.forEach(t),x2=p(ot),Pi=s(ot,"P",{});var pf=a(Pi);R2=i(pf,"This class overrides "),wd=s(pf,"A",{href:!0});var U0=a(wd);L2=i(U0,"FlaxRobertaForMultipleChoice"),U0.forEach(t),E2=i(pf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),pf.forEach(t),z2=p(ot),zt=s(ot,"DIV",{class:!0});var Ns=a(zt);y(Ai.$$.fragment,Ns),q2=p(Ns),Ho=s(Ns,"P",{});var Kd=a(Ho);C2=i(Kd,"The "),Zp=s(Kd,"CODE",{});var Q0=a(Zp);j2=i(Q0,"FlaxRobertaPreTrainedModel"),Q0.forEach(t),X2=i(Kd," forward method, overrides the "),eh=s(Kd,"CODE",{});var H0=a(eh);P2=i(H0,"__call__"),H0.forEach(t),A2=i(Kd," special method."),Kd.forEach(t),O2=p(Ns),y(ks.$$.fragment,Ns),N2=p(Ns),y(vs.$$.fragment,Ns),Ns.forEach(t),ot.forEach(t),Im=p(o),Vo=s(o,"H2",{class:!0});var hf=a(Vo);Ts=s(hf,"A",{id:!0,class:!0,href:!0});var V0=a(Ts);th=s(V0,"SPAN",{});var J0=a(th);y(Oi.$$.fragment,J0),J0.forEach(t),V0.forEach(t),I2=p(hf),oh=s(hf,"SPAN",{});var K0=a(oh);D2=i(K0,"FlaxXLMRobertaForTokenClassification"),K0.forEach(t),hf.forEach(t),Dm=p(o),Xe=s(o,"DIV",{class:!0});var nt=a(Xe);y(Ni.$$.fragment,nt),S2=p(nt),nh=s(nt,"P",{});var G0=a(nh);W2=i(G0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),G0.forEach(t),B2=p(nt),Ii=s(nt,"P",{});var mf=a(Ii);U2=i(mf,"This model inherits from "),$d=s(mf,"A",{href:!0});var Y0=a($d);Q2=i(Y0,"FlaxPreTrainedModel"),Y0.forEach(t),H2=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mf.forEach(t),V2=p(nt),Di=s(nt,"P",{});var uf=a(Di);J2=i(uf,"This model is also a Flax Linen "),Si=s(uf,"A",{href:!0,rel:!0});var Z0=a(Si);K2=i(Z0,"flax.linen.Module"),Z0.forEach(t),G2=i(uf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Y2=p(nt),sh=s(nt,"P",{});var ex=a(sh);Z2=i(ex,"Finally, this model supports inherent JAX features such as:"),ex.forEach(t),e$=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var tx=a(ah);Wi=s(tx,"A",{href:!0,rel:!0});var ox=a(Wi);t$=i(ox,"Just-In-Time (JIT) compilation"),ox.forEach(t),tx.forEach(t),o$=p(Is),rh=s(Is,"LI",{});var nx=a(rh);Bi=s(nx,"A",{href:!0,rel:!0});var sx=a(Bi);n$=i(sx,"Automatic Differentiation"),sx.forEach(t),nx.forEach(t),s$=p(Is),ih=s(Is,"LI",{});var ax=a(ih);Ui=s(ax,"A",{href:!0,rel:!0});var rx=a(Ui);a$=i(rx,"Vectorization"),rx.forEach(t),ax.forEach(t),r$=p(Is),lh=s(Is,"LI",{});var ix=a(lh);Qi=s(ix,"A",{href:!0,rel:!0});var lx=a(Qi);i$=i(lx,"Parallelization"),lx.forEach(t),ix.forEach(t),Is.forEach(t),l$=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);d$=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var dx=a(Md);c$=i(dx,"FlaxRobertaForTokenClassification"),dx.forEach(t),p$=i(ff,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),ff.forEach(t),h$=p(nt),qt=s(nt,"DIV",{class:!0});var Ds=a(qt);y(Vi.$$.fragment,Ds),m$=p(Ds),Jo=s(Ds,"P",{});var Gd=a(Jo);u$=i(Gd,"The "),dh=s(Gd,"CODE",{});var cx=a(dh);f$=i(cx,"FlaxRobertaPreTrainedModel"),cx.forEach(t),g$=i(Gd," forward method, overrides the "),ch=s(Gd,"CODE",{});var px=a(ch);_$=i(px,"__call__"),px.forEach(t),b$=i(Gd," special method."),Gd.forEach(t),k$=p(Ds),y(ys.$$.fragment,Ds),v$=p(Ds),y(ws.$$.fragment,Ds),Ds.forEach(t),nt.forEach(t),Sm=p(o),Ko=s(o,"H2",{class:!0});var gf=a(Ko);$s=s(gf,"A",{id:!0,class:!0,href:!0});var hx=a($s);ph=s(hx,"SPAN",{});var mx=a(ph);y(Ji.$$.fragment,mx),mx.forEach(t),hx.forEach(t),T$=p(gf),hh=s(gf,"SPAN",{});var ux=a(hh);y$=i(ux,"FlaxXLMRobertaForQuestionAnswering"),ux.forEach(t),gf.forEach(t),Wm=p(o),Pe=s(o,"DIV",{class:!0});var st=a(Pe);y(Ki.$$.fragment,st),w$=p(st),Go=s(st,"P",{});var Yd=a(Go);$$=i(Yd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),mh=s(Yd,"CODE",{});var fx=a(mh);M$=i(fx,"span start logits"),fx.forEach(t),F$=i(Yd," and "),uh=s(Yd,"CODE",{});var gx=a(uh);x$=i(gx,"span end logits"),gx.forEach(t),R$=i(Yd,")."),Yd.forEach(t),L$=p(st),Gi=s(st,"P",{});var _f=a(Gi);E$=i(_f,"This model inherits from "),Fd=s(_f,"A",{href:!0});var _x=a(Fd);z$=i(_x,"FlaxPreTrainedModel"),_x.forEach(t),q$=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),_f.forEach(t),C$=p(st),Yi=s(st,"P",{});var bf=a(Yi);j$=i(bf,"This model is also a Flax Linen "),Zi=s(bf,"A",{href:!0,rel:!0});var bx=a(Zi);X$=i(bx,"flax.linen.Module"),bx.forEach(t),P$=i(bf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),bf.forEach(t),A$=p(st),fh=s(st,"P",{});var kx=a(fh);O$=i(kx,"Finally, this model supports inherent JAX features such as:"),kx.forEach(t),N$=p(st),Ht=s(st,"UL",{});var Ss=a(Ht);gh=s(Ss,"LI",{});var vx=a(gh);el=s(vx,"A",{href:!0,rel:!0});var Tx=a(el);I$=i(Tx,"Just-In-Time (JIT) compilation"),Tx.forEach(t),vx.forEach(t),D$=p(Ss),_h=s(Ss,"LI",{});var yx=a(_h);tl=s(yx,"A",{href:!0,rel:!0});var wx=a(tl);S$=i(wx,"Automatic Differentiation"),wx.forEach(t),yx.forEach(t),W$=p(Ss),bh=s(Ss,"LI",{});var $x=a(bh);ol=s($x,"A",{href:!0,rel:!0});var Mx=a(ol);B$=i(Mx,"Vectorization"),Mx.forEach(t),$x.forEach(t),U$=p(Ss),kh=s(Ss,"LI",{});var Fx=a(kh);nl=s(Fx,"A",{href:!0,rel:!0});var xx=a(nl);Q$=i(xx,"Parallelization"),xx.forEach(t),Fx.forEach(t),Ss.forEach(t),H$=p(st),sl=s(st,"P",{});var kf=a(sl);V$=i(kf,"This class overrides "),xd=s(kf,"A",{href:!0});var Rx=a(xd);J$=i(Rx,"FlaxRobertaForQuestionAnswering"),Rx.forEach(t),K$=i(kf,`. Please check the superclass for the appropriate
