import{S as Es,i as Ss,s as Ws,e as n,k as d,w as _,t as r,M as Ds,c as a,d as o,m as c,a as s,x as v,h as i,b as l,F as e,g as f,y as b,q as y,o as w,B as E,v as Ts}from"../../chunks/vendor-6b77c823.js";import{T as Ta}from"../../chunks/Tip-39098574.js";import{D as Je}from"../../chunks/Docstring-1088f2fb.js";import{C as ft}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ht}from"../../chunks/IconCopyLink-7a11ce68.js";function ks(X){let m,T,h,S,W;return{c(){m=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),S=r("Module"),W=r(`
...
instance of <a href="/docs/transformers/pr_16915/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.SEWDConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16915/en/model_doc/sew-d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.SEWDConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Dimensionality of the projection before token mean-pooling for classification.`,name:"classifier_proj_size"}],source:"https://github.com/huggingface/transformers/blob/pr_16915/src/transformers/models/sew_d/configuration_sew_d.py#L32"}}),_e=new ft({props:{code:`from transformers import SEWDModel, SEWDConfig
...
Whether or not to return a <a href="/docs/transformers/pr_16915/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16915/src/transformers/models/sew_d/modeling_sew_d.py#L1419",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16915/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16915/en/model_doc/sew-d#transformers.SEWDConfig"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16915/src/transformers/models/sew_d/modeling_sew_d.py#L1523",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16915/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16915/src/transformers/models/sew_d/modeling_sew_d.py#L1658",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){m=n("meta"),T=d(),h=n("h1"),S=n("a"),W=n("span"),_(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Ot=d(),I=n("h2"),Z=n("a"),ut=n("span"),_(ce.$$.fragment),bo=d(),gt=n("span"),yo=r("Overview"),Vt=d(),ee=n("p"),wo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),pe=n("a"),Eo=r(`Performance-Efficiency Trade-offs
...
documentation from `),et=n("a"),Jo=r("PretrainedConfig"),Qo=r(" for more information."),Bo=d(),wt=n("p"),Yo=r("Example:"),Go=d(),_(_e.$$.fragment),Jt=d(),R=n("h2"),ae=n("a"),Et=n("span"),_(ve.$$.fragment),Xo=d(),St=n("span"),Zo=r("SEWDModel"),Qt=d(),q=n("div"),_(be.$$.fragment),en=d(),ye=n("p"),tn=r(`The bare SEW-D Model transformer outputting raw hidden-states without any specific head on top.
SEW-D was proposed in `),we=n("a"),on=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ha=d(),C=n("div"),_(Ke.$$.fragment),ua=d(),G=n("p"),ga=r("The "),rt=n("a"),_a=r("SEWDForSequenceClassification"),va=r(" forward method, overrides the "),Ft=n("code"),ba=r("__call__"),ya=r(" special method."),wa=d(),_(de.$$.fragment),Ea=d(),Mt=n("p"),Sa=r("Example:"),Wa=d(),_(He.$$.fragment),Da=d(),_(Re.$$.fragment),this.h()},l(t){const p=Ds('[data-svelte="svelte-1phssyn"]',document.head);m=a(p,"META",{name:!0,content:!0}),p.forEach(o),T=c(t),h=a(t,"H1",{class:!0});var Ue=s(h);S=a(Ue,"A",{id:!0,class:!0,href:!0});var zt=s(S);W=a(zt,"SPAN",{});var At=s(W);v(u.$$.fragment,At),At.forEach(o),zt.forEach(o),g=c(Ue),j=a(Ue,"SPAN",{});var ka=s(j);vo=i(ka,"SEW-D"),ka.forEach(o),Ue.forEach(o),Ot=c(t),I=a(t,"H2",{class:!0});var eo=s(I);Z=a(eo,"A",{id:!0,class:!0,href:!0});var Ca=s(Z);ut=a(Ca,"SPAN",{});var $a=s(ut);v(ce.$$.fragment,$a),$a.forEach(o),Ca.forEach(o),bo=c(eo),gt=a(eo,"SPAN",{});var qa=s(gt);yo=i(qa,"Overview"),qa.forEach(o),eo.forEach(o),Vt=c(t),ee=a(t,"P",{});var to=s(ee);wo=i(to,"SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),pe=a(to,"A",{href:!0,rel:!0});var xa=s(pe);Eo=i(xa,`Performance-Efficiency Trade-offs
...
documentation from `),et=a(lt,"A",{href:!0});var Ra=s(et);Jo=i(Ra,"PretrainedConfig"),Ra.forEach(o),Qo=i(lt," for more information."),lt.forEach(o),Bo=c(A),wt=a(A,"P",{});var Ua=s(wt);Yo=i(Ua,"Example:"),Ua.forEach(o),Go=c(A),v(_e.$$.fragment,A),A.forEach(o),Jt=c(t),R=a(t,"H2",{class:!0});var ro=s(R);ae=a(ro,"A",{id:!0,class:!0,href:!0});var Ja=s(ae);Et=a(Ja,"SPAN",{});var Qa=s(Et);v(ve.$$.fragment,Qa),Qa.forEach(o),Ja.forEach(o),Xo=c(ro),St=a(ro,"SPAN",{});var Ba=s(St);Zo=i(Ba,"SEWDModel"),Ba.forEach(o),ro.forEach(o),Qt=c(t),q=a(t,"DIV",{class:!0});var O=s(q);v(be.$$.fragment,O),en=c(O),ye=a(O,"P",{});var io=s(ye);tn=i(io,`The bare SEW-D Model transformer outputting raw hidden-states without any specific head on top.
SEW-D was proposed in `),we=a(io,"A",{href:!0,rel:!0});var Ya=s(we);on=i(Ya,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o.forEach(o),ha=c(M),C=a(M,"DIV",{class:!0});var z=s(C);v(Ke.$$.fragment,z),ua=c(z),G=a(z,"P",{});var mt=s(G);ga=i(mt,"The "),rt=a(mt,"A",{href:!0});var bs=s(rt);_a=i(bs,"SEWDForSequenceClassification"),bs.forEach(o),va=i(mt," forward method, overrides the "),Ft=a(mt,"CODE",{});var ys=s(Ft);ba=i(ys,"__call__"),ys.forEach(o),ya=i(mt," special method."),mt.forEach(o),wa=c(z),v(de.$$.fragment,z),Ea=c(z),Mt=a(z,"P",{});var ws=s(Mt);Sa=i(ws,"Example:"),ws.forEach(o),Wa=c(z),v(He.$$.fragment,z),Da=c(z),v(Re.$$.fragment,z),z.forEach(o),M.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(xs)),l(S,"id","sewd"),l(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(S,"href","#sewd"),l(h,"class","relative group"),l(Z,"id","overview"),l(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Z,"href","#overview"),l(I,"class","relative group"),l(pe,"href","https://arxiv.org/abs/2109.06870"),l(pe,"rel","nofollow"),l(Ge,"href","/docs/transformers/pr_16915/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),l(fe,"href","https://huggingface.co/anton-l"),l(fe,"rel","nofollow"),l(ne,"id","transformers.SEWDConfig"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.SEWDConfig"),l(N,"class","relative group"),l(Xe,"href","/docs/transformers/pr_16915/en/model_doc/sew-d#transformers.SEWDModel"),l(ge,"href","https://huggingface.co/asapp/sew-d-tiny-100k"),l(ge,"rel","nofollow"),l(Ze,"href","/docs/transformers/pr_16915/en/main_classes/configuration#transformers.PretrainedConfig"),l(et,"href","/docs/transformers/pr_16915/en/main_classes/configuration#transformers.PretrainedConfig"),l($,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ae,"id","transformers.SEWDModel"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.SEWDModel"),l(R,"class","relative group"),l(we,"href","https://arxiv.org/abs/2109.06870"),l(we,"rel","nofollow"),l(tt,"href","/docs/transformers/pr_16915/en/main_classes/model#transformers.PreTrainedModel"),l(We,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(We,"rel","nofollow"),l(ot,"href","/docs/transformers/pr_16915/en/model_doc/sew-d#transformers.SEWDModel"),l(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(re,"id","transformers.SEWDForCTC"),l(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(re,"href","#transformers.SEWDForCTC"),l(J,"class","relative group"),l($e,"href","https://arxiv.org/abs/2109.06870"),l($e,"rel","nofollow"),l(nt,"href","/docs/transformers/pr_16915/en/main_classes/model#transformers.PreTrainedModel"),l(je,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(je,"rel","nofollow"),l(at,"href","/docs/transformers/pr_16915/en/model_doc/sew-d#transformers.SEWDForCTC"),l(k,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(le,"id","transformers.SEWDForSequenceClassification"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.SEWDForSequenceClassification"),l(Y,"class","relative group"),l(Ve,"href","https://arxiv.org/abs/2109.06870"),l(Ve,"rel","nofollow"),l(st,"href","/docs/transformers/pr_16915/en/main_classes/model#transformers.PreTrainedModel"),l(Ne,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ne,"rel","nofollow"),l(rt,"href","/docs/transformers/pr_16915/en/model_doc/sew-d#transformers.SEWDForSequenceClassification"),l(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,p){e(document.head,m),f(t,T,p),f(t,h,p),e(h,S),e(S,W),b(u,W,null),e(h,g),e(h,j),e(j,vo),f(t,Ot,p),f(t,I,p),e(I,Z),e(Z,ut),b(ce,ut,null),e(I,bo),e(I,gt),e(gt,yo),f(t,Vt,p),f(t,ee,p),e(ee,wo),e(ee,pe),e(pe,Eo),e(ee,So),f(t,Lt,p),f(t,Qe,p),e(Qe,Wo),f(t,It,p),f(t,Be,p),e(Be,_t),e(_t,Do),f(t,Nt,p),f(t,Ye,p),e(Ye,To),f(t,Kt,p),f(t,te,p),e(te,vt),e(vt,ko),e(te,Co),e(te,me),e(me,$o),e(me,Ge),e(Ge,qo),e(me,xo),f(t,Ht,p),f(t,oe,p),e(oe,jo),e(oe,fe),e(fe,Po),e(oe,Fo),f(t,Rt,p),f(t,N,p),e(N,ne),e(ne,bt),b(he,bt,null),e(N,Mo),e(N,yt),e(yt,zo),f(t,Ut,p),f(t,$,p),b(ue,$,null),e($,Ao),e($,K),e(K,Oo),e(K,Xe),e(Xe,Vo),e(K,Lo),e(K,ge),e(ge,Io),e(K,No),e($,Ko),e($,H),e(H,Ho),e(H,Ze),e(Ze,Ro),e(H,Uo),e(H,et),e(et,Jo),e(H,Qo),e($,Bo),e($,wt),e(wt,Yo),e($,Go),b(_e,$,null),f(t,Jt,p),f(t,R,p),e(R,ae),e(ae,Et),b(ve,Et,null),e(R,Xo),e(R,St),e(St,Zo),f(t,Qt,p),f(t,q,p),b(be,q,null),e(q,en),e(q,ye),e(ye,tn),e(ye,we),e(we,on),e(ye,nn),e(q,an),e(q,Ee),e(Ee,sn),e(Ee,tt),e(tt,rn),e(Ee,ln),e(q,dn),e(q,Se),e(Se,cn),e(Se,We),e(We,pn),e(Se,mn),e(q,fn),e(q,P),b(De,P,null),e(P,hn),e(P,U),e(U,un),e(U,ot),e(ot,gn),e(U,_n),e(U,Wt),e(Wt,vn),e(U,bn),e(P,yn),b(se,P,null),e(P,wn),e(P,Dt),e(Dt,En),e(P,Sn),b(Te,P,null),f(t,Bt,p),f(t,J,p),e(J,re),e(re,Tt),b(ke,Tt,null),e(J,Wn),e(J,kt),e(kt,Dn),f(t,Yt,p),f(t,x,p),b(Ce,x,null),e(x,Tn),e(x,Q),e(Q,kn),e(Q,Ct),e(Ct,Cn),e(Q,$n),e(Q,$e),e($e,qn),e(Q,xn),e(x,jn),e(x,qe),e(qe,Pn),e(qe,nt),e(nt,Fn),e(qe,Mn),e(x,zn),e(x,xe),e(xe,An),e(xe,je),e(je,On),e(xe,Vn),e(x,Ln),e(x,k),b(Pe,k,null),e(k,In),e(k,B),e(B,Nn),e(B,at),e(at,Kn),e(B,Hn),e(B,$t),e($t,Rn),e(B,Un),e(k,Jn),b(ie,k,null),e(k,Qn),e(k,qt),e(qt,Bn),e(k,Yn),b(Fe,k,null),e(k,Gn),b(Me,k,null),f(t,Gt,p),f(t,Y,p),e(Y,le),e(le,xt),b(ze,xt,null),e(Y,Xn),e(Y,jt),e(jt,Zn),f(t,Xt,p),f(t,D,p),b(Ae,D,null),e(D,ea),e(D,Pt),e(Pt,ta),e(D,oa),e(D,Oe),e(Oe,na),e(Oe,Ve),e(Ve,aa),e(Oe,sa),e(D,ra),e(D,Le),e(Le,ia),e(Le,st),e(st,la),e(Le,da),e(D,ca),e(D,Ie),e(Ie,pa),e(Ie,Ne),e(Ne,ma),e(Ie,fa),e(D,ha),e(D,C),b(Ke,C,null),e(C,ua),e(C,G),e(G,ga),e(G,rt),e(rt,_a),e(G,va),e(G,Ft),e(Ft,ba),e(G,ya),e(C,wa),b(de,C,null),e(C,Ea),e(C,Mt),e(Mt,Sa),e(C,Wa),b(He,C,null),e(C,Da),b(Re,C,null),Zt=!0},p(t,[p]){const Ue={};p&2&&(Ue.$$scope={dirty:p,ctx:t}),se.$set(Ue);const zt={};p&2&&(zt.$$scope={dirty:p,ctx:t}),ie.$set(zt);const At={};p&2&&(At.$$scope={dirty:p,ctx:t}),de.$set(At)},i(t){Zt||(y(u.$$.fragment,t),y(ce.$$.fragment,t),y(he.$$.fragment,t),y(ue.$$.fragment,t),y(_e.$$.fragment,t),y(ve.$$.fragment,t),y(be.$$.fragment,t),y(De.$$.fragment,t),y(se.$$.fragment,t),y(Te.$$.fragment,t),y(ke.$$.fragment,t),y(Ce.$$.fragment,t),y(Pe.$$.fragment,t),y(ie.$$.fragment,t),y(Fe.$$.fragment,t),y(Me.$$.fragment,t),y(ze.$$.fragment,t),y(Ae.$$.fragment,t),y(Ke.$$.fragment,t),y(de.$$.fragment,t),y(He.$$.fragment,t),y(Re.$$.fragment,t),Zt=!0)},o(t){w(u.$$.fragment,t),w(ce.$$.fragment,t),w(he.$$.fragment,t),w(ue.$$.fragment,t),w(_e.$$.fragment,t),w(ve.$$.fragment,t),w(be.$$.fragment,t),w(De.$$.fragment,t),w(se.$$.fragment,t),w(Te.$$.fragment,t),w(ke.$$.fragment,t),w(Ce.$$.fragment,t),w(Pe.$$.fragment,t),w(ie.$$.fragment,t),w(Fe.$$.fragment,t),w(Me.$$.fragment,t),w(ze.$$.fragment,t),w(Ae.$$.fragment,t),w(Ke.$$.fragment,t),w(de.$$.fragment,t),w(He.$$.fragment,t),w(Re.$$.fragment,t),Zt=!1},d(t){o(m),t&&o(T),t&&o(h),E(u),t&&o(Ot),t&&o(I),E(ce),t&&o(Vt),t&&o(ee),t&&o(Lt),t&&o(Qe),t&&o(It),t&&o(Be),t&&o(Nt),t&&o(Ye),t&&o(Kt),t&&o(te),t&&o(Ht),t&&o(oe),t&&o(Rt),t&&o(N),E(he),t&&o(Ut),t&&o($),E(ue),E(_e),t&&o(Jt),t&&o(R),E(ve),t&&o(Qt),t&&o(q),E(be),E(De),E(se),E(Te),t&&o(Bt),t&&o(J),E(ke),t&&o(Yt),t&&o(x),E(Ce),E(Pe),E(ie),E(Fe),E(Me),t&&o(Gt),t&&o(Y),E(ze),t&&o(Xt),t&&o(D),E(Ae),E(Ke),E(de),E(He),E(Re)}}}const xs={local:"sewd",sections:[{local:"overview",title:"Overview"},{local:"transformers.SEWDConfig",title:"SEWDConfig"},{local:"transformers.SEWDModel",title:"SEWDModel"},{local:"transformers.SEWDForCTC",title:"SEWDForCTC"},{local:"transformers.SEWDForSequenceClassification",title:"SEWDForSequenceClassification"}],title:"SEW-D"};function js(X){return Ts(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Os extends Es{constructor(m){super();Ss(this,m,js,qs,Ws,{})}}export{Os as default,xs as metadata};
