...
install `),yf=o("em"),e$=a("libaio-dev"),s$=a(" system-wide)."),vg=u(),zt=o("p"),t$=a("Edit "),wf=o("code"),a$=a("TORCH_CUDA_ARCH_LIST"),n$=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
of them like so `),qf=o("code"),u$=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),yg=u(),ti=o("p"),c$=a("If you need to use the same setup on multiple machines, make a binary wheel:"),wg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h$=a("it will generate something like "),$f=o("code"),f$=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d$=a(` which now you can install
as `),kf=o("code"),m$=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_$=a(" locally or on any other machine."),Eg=u(),Ot=o("p"),v$=a("Again, remember to ensure to adjust "),Pf=o("code"),j$=a("TORCH_CUDA_ARCH_LIST"),g$=a(" to the target architectures."),qg=u(),Ue=o("p"),y$=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Df=o("strong"),w$=a("Compute Capabilities"),b$=a(` (same as arch in this
context) `),jo=o("a"),E$=a("here"),q$=a("."),$g=u(),ai=o("p"),$$=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k$=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(yo.$$.fragment),zg=u(),oi=o("p"),P$=a("If the output is:"),Og=u(),f(wo.$$.fragment),Tg=u(),Tt=o("p"),D$=a("then you know that this card\u2019s arch is "),zf=o("code"),z$=a("8.6"),O$=a("."),Ag=u(),At=o("p"),T$=a("You can also leave "),Of=o("code"),A$=a("TORCH_CUDA_ARCH_LIST"),S$=a(` out completely and then the build program will automatically query the
...
the `),Nf=o("code"),g4=a("deepspeed"),y4=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
...
bigger models and data batches.`),sy=u(),fi=o("p"),H4=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),ty=u(),f(So.$$.fragment),ay=u(),di=o("p"),B4=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),ny=u(),Nt=o("p"),W4=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F4=a("post"),V4=a("."),oy=u(),mi=o("p"),Y4=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),ly=u(),_i=o("p"),K4=a("Notes:"),ry=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J4=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=o("code"),X4=a("CUDA_VISIBLE_DEVICES"),Q4=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),e9=u(),f(Ro.$$.fragment),s9=u(),Xf=o("p"),t9=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),py=u(),ji=o("a"),iy=u(),Ts=o("h3"),Ht=o("a"),Qf=o("span"),f(Io.$$.fragment),a9=u(),ed=o("span"),n9=a("Deployment in Notebooks"),uy=u(),Bt=o("p"),o9=a("The problem with running notebook cells as a script is that there is no normal "),sd=o("code"),l9=a("deepspeed"),r9=a(` launcher to rely on, so
under certain setups we have to emulate it.`),cy=u(),gi=o("p"),p9=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),hy=u(),f(Uo.$$.fragment),fy=u(),Wt=o("p"),i9=a("Note: "),td=o("code"),u9=a("..."),c9=a(" stands for the normal arguments that you\u2019d pass to the functions."),dy=u(),yi=o("p"),h9=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),my=u(),wi=o("p"),f9=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),_y=u(),f(Go.$$.fragment),vy=u(),Le=o("p"),d9=a("If the training script is in a normal file and not in the notebook cells, you can launch "),ad=o("code"),m9=a("deepspeed"),_9=a(` normally via
shell from a cell. For example, to use `),nd=o("code"),v9=a("run_translation.py"),j9=a(" you would launch it with:"),jy=u(),f(Lo.$$.fragment),gy=u(),Ft=o("p"),g9=a("or with "),od=o("code"),y9=a("%%bash"),w9=a(" magic, where you can write a multi-line code for the shell program to run:"),yy=u(),f(Mo.$$.fragment),wy=u(),bi=o("p"),b9=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),by=u(),Vt=o("p"),E9=a("Note: While "),ld=o("code"),q9=a("%%bash"),$9=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Ey=u(),Ei=o("a"),qy=u(),As=o("h3"),Yt=o("a"),rd=o("span"),f(Zo.$$.fragment),k9=u(),pd=o("span"),P9=a("Configuration"),$y=u(),Kt=o("p"),D9=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=o("a"),z9=a("following documentation"),O9=a("."),ky=u(),Jt=o("p"),T9=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=o("a"),A9=a(`the DeepSpeedExamples
repo`),S9=a(":"),Py=u(),f(Bo.$$.fragment),Dy=u(),Xt=o("p"),C9=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),id=o("code"),x9=a(".json"),R9=a(" files with:"),zy=u(),f(Wo.$$.fragment),Oy=u(),Qt=o("p"),I9=a("Some more examples are to be found in the "),Fo=o("a"),U9=a("main repo"),G9=a(" as well."),Ty=u(),qi=o("p"),L9=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Ay=u(),oe=o("p"),M9=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
...
precision training if `),hd=o("code"),W9=a("--fp16"),F9=a(" is passed:"),Sy=u(),f(Vo.$$.fragment),Cy=u(),ea=o("p"),V9=a("When you execute the program, DeepSpeed will log the configuration it received from the "),$i=o("a"),Y9=a("Trainer"),K9=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),xy=u(),ki=o("a"),Ry=u(),Ss=o("h3"),sa=o("a"),fd=o("span"),f(Yo.$$.fragment),J9=u(),dd=o("span"),X9=a("Passing Configuration"),Iy=u(),G=o("p"),Q9=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
and its typically accessed much faster than normal CPU memory.`),gw=u(),Ki=o("p"),Vd=o("strong"),Yk=a("Performance tuning:"),yw=u(),ca=o("ul"),il=o("li"),Yd=o("code"),Kk=a("stage3_max_live_parameters"),Jk=a(": "),Kd=o("code"),Xk=a("1e9"),Qk=u(),ul=o("li"),Jd=o("code"),e7=a("stage3_max_reuse_distance"),s7=a(": "),Xd=o("code"),t7=a("1e9"),ww=u(),M=o("p"),a7=a("If hitting OOM reduce "),Qd=o("code"),n7=a("stage3_max_live_parameters"),o7=a(" and "),em=o("code"),l7=a("stage3_max_reuse_distance"),r7=a(`. They should have minimal impact
...
`),tm=o("code"),u7=a("stage3_max_live_parameters"),c7=a(" and "),am=o("code"),h7=a("stage3_max_reuse_distance"),f7=a(", so it\u2019s not additive, it\u2019s just 2GB total."),bw=u(),ze=o("p"),nm=o("code"),d7=a("stage3_max_live_parameters"),m7=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
...
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ew=u(),Ji=o("p"),y7=a("The following configuration values depend on the model\u2019s hidden size:"),qw=u(),Fe=o("ul"),cl=o("li"),rm=o("code"),w7=a("reduce_bucket_size"),b7=a(": "),pm=o("code"),E7=a("hidden_size*hidden_size"),q7=u(),hl=o("li"),im=o("code"),$7=a("stage3_prefetch_bucket_size"),k7=a(": "),um=o("code"),P7=a("0.9 * hidden_size * hidden_size"),D7=u(),fl=o("li"),cm=o("code"),z7=a("stage3_param_persistence_threshold"),O7=a(": "),hm=o("code"),T7=a("10 * hidden_size"),$w=u(),Ve=o("p"),A7=a("therefore set these values to "),fm=o("code"),S7=a("auto"),C7=a(" and the "),Xi=o("a"),x7=a("Trainer"),R7=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),kw=u(),dl=o("p"),dm=o("code"),I7=a("stage3_gather_16bit_weights_on_model_save"),U7=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Pw=u(),re=o("p"),G7=a("If you\u2019re migrating from ZeRO-2 configuration note that "),mm=o("code"),L7=a("allgather_partitions"),M7=a(", "),_m=o("code"),Z7=a("allgather_bucket_size"),N7=a(` and
...
be ignored.`),Dw=u(),Qi=o("ul"),ml=o("li"),jm=o("code"),W7=a("sub_group_size"),F7=a(": "),gm=o("code"),V7=a("1e9"),zw=u(),Oe=o("p"),ym=o("code"),Y7=a("sub_group_size"),K7=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
...
install `),yf=l(uh,"EM",{});var mL=r(yf);e$=n(mL,"libaio-dev"),mL.forEach(t),s$=n(uh," system-wide)."),uh.forEach(t),vg=c(e),zt=l(e,"P",{});var cE=r(zt);t$=n(cE,"Edit "),wf=l(cE,"CODE",{});var _L=r(wf);a$=n(_L,"TORCH_CUDA_ARCH_LIST"),_L.forEach(t),n$=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
of them like so `),qf=l(Ap,"CODE",{});var gL=r(qf);u$=n(gL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),gL.forEach(t),Ap.forEach(t),yg=c(e),ti=l(e,"P",{});var yL=r(ti);c$=n(yL,"If you need to use the same setup on multiple machines, make a binary wheel:"),yL.forEach(t),wg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h$=n(ch,"it will generate something like "),$f=l(ch,"CODE",{});var wL=r($f);f$=n(wL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wL.forEach(t),d$=n(ch,` which now you can install
as `),kf=l(ch,"CODE",{});var bL=r(kf);m$=n(bL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),bL.forEach(t),_$=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),Ot=l(e,"P",{});var hE=r(Ot);v$=n(hE,"Again, remember to ensure to adjust "),Pf=l(hE,"CODE",{});var EL=r(Pf);j$=n(EL,"TORCH_CUDA_ARCH_LIST"),EL.forEach(t),g$=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);y$=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Df=l(hh,"STRONG",{});var qL=r(Df);w$=n(qL,"Compute Capabilities"),qL.forEach(t),b$=n(hh,` (same as arch in this
...
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var LL=r(qo);Q$=n(LL,"here"),LL.forEach(t),e4=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var ML=r(pi);s4=n(ML,"Therefore, if your original command line looked as follows:"),ML.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ZL=r(ii);t4=n(ZL,"Now it should be:"),ZL.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var ye=r(U);a4=n(ye,"Unlike, "),If=l(ye,"CODE",{});var NL=r(If);n4=n(NL,"torch.distributed.launch"),NL.forEach(t),o4=n(ye," where you have to specify how many GPUs to use with "),Uf=l(ye,"CODE",{});var HL=r(Uf);l4=n(HL,"--nproc_per_node"),HL.forEach(t),r4=n(ye,`, with the
`),Gf=l(ye,"CODE",{});var BL=r(Gf);p4=n(BL,"deepspeed"),BL.forEach(t),i4=n(ye," launcher you don\u2019t have to use the corresponding "),Lf=l(ye,"CODE",{});var WL=r(Lf);u4=n(WL,"--num_gpus"),WL.forEach(t),c4=n(ye,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=l(ye,"A",{href:!0,rel:!0});var FL=r(Po);h4=n(FL,"here"),FL.forEach(t),f4=n(ye,"."),ye.forEach(t),Ng=c(e),ne=l(e,"P",{});var Zn=r(ne);d4=n(Zn,"In fact, you can continue using "),Mf=l(Zn,"CODE",{});var VL=r(Mf);m4=n(VL,"-m torch.distributed.launch"),VL.forEach(t),_4=n(Zn,` with DeepSpeed as long as you don\u2019t need to use
...
bigger models and data batches.`),pM.forEach(t),qE.forEach(t),sy=c(e),fi=l(e,"P",{});var iM=r(fi);H4=n(iM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),iM.forEach(t),ty=c(e),d(So.$$.fragment,e),ay=c(e),di=l(e,"P",{});var uM=r(di);B4=n(uM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),uM.forEach(t),ny=c(e),Nt=l(e,"P",{});var $E=r(Nt);W4=n($E,"For a practical usage example of this type of deployment, please, see this "),Co=l($E,"A",{href:!0,rel:!0});var cM=r(Co);F4=n(cM,"post"),cM.forEach(t),V4=n($E,"."),$E.forEach(t),oy=c(e),mi=l(e,"P",{});var hM=r(mi);Y4=n(hM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),hM.forEach(t),ly=c(e),_i=l(e,"P",{});var fM=r(_i);K4=n(fM,"Notes:"),fM.forEach(t),ry=c(e),vi=l(e,"UL",{});var dM=r(vi);Os=l(dM,"LI",{});var mh=r(Os);xo=l(mh,"P",{});var kE=r(xo);J4=n(kE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=l(kE,"CODE",{});var mM=r(Jf);X4=n(mM,"CUDA_VISIBLE_DEVICES"),mM.forEach(t),Q4=n(kE,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),kE.forEach(t),e9=c(mh),d(Ro.$$.fragment,mh),s9=c(mh),Xf=l(mh,"P",{});var _M=r(Xf);t9=n(_M,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),_M.forEach(t),mh.forEach(t),dM.forEach(t),py=c(e),ji=l(e,"A",{id:!0}),r(ji).forEach(t),iy=c(e),Ts=l(e,"H3",{class:!0});var PE=r(Ts);Ht=l(PE,"A",{id:!0,class:!0,href:!0});var vM=r(Ht);Qf=l(vM,"SPAN",{});var jM=r(Qf);d(Io.$$.fragment,jM),jM.forEach(t),vM.forEach(t),a9=c(PE),ed=l(PE,"SPAN",{});var gM=r(ed);n9=n(gM,"Deployment in Notebooks"),gM.forEach(t),PE.forEach(t),uy=c(e),Bt=l(e,"P",{});var DE=r(Bt);o9=n(DE,"The problem with running notebook cells as a script is that there is no normal "),sd=l(DE,"CODE",{});var yM=r(sd);l9=n(yM,"deepspeed"),yM.forEach(t),r9=n(DE,` launcher to rely on, so
under certain setups we have to emulate it.`),DE.forEach(t),cy=c(e),gi=l(e,"P",{});var wM=r(gi);p9=n(wM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),wM.forEach(t),hy=c(e),d(Uo.$$.fragment,e),fy=c(e),Wt=l(e,"P",{});var zE=r(Wt);i9=n(zE,"Note: "),td=l(zE,"CODE",{});var bM=r(td);u9=n(bM,"..."),bM.forEach(t),c9=n(zE," stands for the normal arguments that you\u2019d pass to the functions."),zE.forEach(t),dy=c(e),yi=l(e,"P",{});var EM=r(yi);h9=n(EM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),EM.forEach(t),my=c(e),wi=l(e,"P",{});var qM=r(wi);f9=n(qM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),qM.forEach(t),_y=c(e),d(Go.$$.fragment,e),vy=c(e),Le=l(e,"P",{});var _h=r(Le);d9=n(_h,"If the training script is in a normal file and not in the notebook cells, you can launch "),ad=l(_h,"CODE",{});var $M=r(ad);m9=n($M,"deepspeed"),$M.forEach(t),_9=n(_h,` normally via
shell from a cell. For example, to use `),nd=l(_h,"CODE",{});var kM=r(nd);v9=n(kM,"run_translation.py"),kM.forEach(t),j9=n(_h," you would launch it with:"),_h.forEach(t),jy=c(e),d(Lo.$$.fragment,e),gy=c(e),Ft=l(e,"P",{});var OE=r(Ft);g9=n(OE,"or with "),od=l(OE,"CODE",{});var PM=r(od);y9=n(PM,"%%bash"),PM.forEach(t),w9=n(OE," magic, where you can write a multi-line code for the shell program to run:"),OE.forEach(t),yy=c(e),d(Mo.$$.fragment,e),wy=c(e),bi=l(e,"P",{});var DM=r(bi);b9=n(DM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),DM.forEach(t),by=c(e),Vt=l(e,"P",{});var TE=r(Vt);E9=n(TE,"Note: While "),ld=l(TE,"CODE",{});var zM=r(ld);q9=n(zM,"%%bash"),zM.forEach(t),$9=n(TE,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),TE.forEach(t),Ey=c(e),Ei=l(e,"A",{id:!0}),r(Ei).forEach(t),qy=c(e),As=l(e,"H3",{class:!0});var AE=r(As);Yt=l(AE,"A",{id:!0,class:!0,href:!0});var OM=r(Yt);rd=l(OM,"SPAN",{});var TM=r(rd);d(Zo.$$.fragment,TM),TM.forEach(t),OM.forEach(t),k9=c(AE),pd=l(AE,"SPAN",{});var AM=r(pd);P9=n(AM,"Configuration"),AM.forEach(t),AE.forEach(t),$y=c(e),Kt=l(e,"P",{});var SE=r(Kt);D9=n(SE,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=l(SE,"A",{href:!0,rel:!0});var SM=r(No);z9=n(SM,"following documentation"),SM.forEach(t),O9=n(SE,"."),SE.forEach(t),ky=c(e),Jt=l(e,"P",{});var CE=r(Jt);T9=n(CE,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=l(CE,"A",{href:!0,rel:!0});var CM=r(Ho);A9=n(CM,`the DeepSpeedExamples
repo`),CM.forEach(t),S9=n(CE,":"),CE.forEach(t),Py=c(e),d(Bo.$$.fragment,e),Dy=c(e),Xt=l(e,"P",{});var xE=r(Xt);C9=n(xE,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),id=l(xE,"CODE",{});var xM=r(id);x9=n(xM,".json"),xM.forEach(t),R9=n(xE," files with:"),xE.forEach(t),zy=c(e),d(Wo.$$.fragment,e),Oy=c(e),Qt=l(e,"P",{});var RE=r(Qt);I9=n(RE,"Some more examples are to be found in the "),Fo=l(RE,"A",{href:!0,rel:!0});var RM=r(Fo);U9=n(RM,"main repo"),RM.forEach(t),G9=n(RE," as well."),RE.forEach(t),Ty=c(e),qi=l(e,"P",{});var IM=r(qi);L9=n(IM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),IM.forEach(t),Ay=c(e),oe=l(e,"P",{});var Nn=r(oe);M9=n(Nn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
...
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Sp.forEach(t),Ew=c(e),Ji=l(e,"P",{});var iN=r(Ji);y7=n(iN,"The following configuration values depend on the model\u2019s hidden size:"),iN.forEach(t),qw=c(e),Fe=l(e,"UL",{});var qh=r(Fe);cl=l(qh,"LI",{});var JE=r(cl);rm=l(JE,"CODE",{});var uN=r(rm);w7=n(uN,"reduce_bucket_size"),uN.forEach(t),b7=n(JE,": "),pm=l(JE,"CODE",{});var cN=r(pm);E7=n(cN,"hidden_size*hidden_size"),cN.forEach(t),JE.forEach(t),q7=c(qh),hl=l(qh,"LI",{});var XE=r(hl);im=l(XE,"CODE",{});var hN=r(im);$7=n(hN,"stage3_prefetch_bucket_size"),hN.forEach(t),k7=n(XE,": "),um=l(XE,"CODE",{});var fN=r(um);P7=n(fN,"0.9 * hidden_size * hidden_size"),fN.forEach(t),XE.forEach(t),D7=c(qh),fl=l(qh,"LI",{});var QE=r(fl);cm=l(QE,"CODE",{});var dN=r(cm);z7=n(dN,"stage3_param_persistence_threshold"),dN.forEach(t),O7=n(QE,": "),hm=l(QE,"CODE",{});var mN=r(hm);T7=n(mN,"10 * hidden_size"),mN.forEach(t),QE.forEach(t),qh.forEach(t),$w=c(e),Ve=l(e,"P",{});var $h=r(Ve);A7=n($h,"therefore set these values to "),fm=l($h,"CODE",{});var _N=r(fm);S7=n(_N,"auto"),_N.forEach(t),C7=n($h," and the "),Xi=l($h,"A",{href:!0});var vN=r(Xi);x7=n(vN,"Trainer"),vN.forEach(t),R7=n($h,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),$h.forEach(t),kw=c(e),dl=l(e,"P",{});var wG=r(dl);dm=l(wG,"CODE",{});var jN=r(dm);I7=n(jN,"stage3_gather_16bit_weights_on_model_save"),jN.forEach(t),U7=n(wG,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),wG.forEach(t),Pw=c(e),re=l(e,"P",{});var Bn=r(re);G7=n(Bn,"If you\u2019re migrating from ZeRO-2 configuration note that "),mm=l(Bn,"CODE",{});var gN=r(mm);L7=n(gN,"allgather_partitions"),gN.forEach(t),M7=n(Bn,", "),_m=l(Bn,"CODE",{});var yN=r(_m);Z7=n(yN,"allgather_bucket_size"),yN.forEach(t),N7=n(Bn,` and
`),vm=l(Bn,"CODE",{});var wN=r(vm);H7=n(wN,"reduce_scatter"),wN.forEach(t),B7=n(Bn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Bn.forEach(t),Dw=c(e),Qi=l(e,"UL",{});var bN=r(Qi);ml=l(bN,"LI",{});var eq=r(ml);jm=l(eq,"CODE",{});var EN=r(jm);W7=n(EN,"sub_group_size"),EN.forEach(t),F7=n(eq,": "),gm=l(eq,"CODE",{});var qN=r(gm);V7=n(qN,"1e9"),qN.forEach(t),eq.forEach(t),bN.forEach(t),zw=c(e),Oe=l(e,"P",{});var Cp=r(Oe);ym=l(Cp,"CODE",{});var $N=r(ym);Y7=n($N,"sub_group_size"),$N.forEach(t),K7=n(Cp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),wm=l(Cp,"CODE",{});var kN=r(wm);J7=n(kN,"sub_group_size"),kN.forEach(t),X7=n(Cp,` and each buckets is updated one at a time. When used with NVMe offload in
...
circumstances you may find the following information to be needed.`),RF.forEach(t),k3=c(e),at=l(e,"H4",{class:!0});var a6=r(at);cn=l(a6,"A",{id:!0,class:!0,href:!0});var IF=r(cn);rv=l(IF,"SPAN",{});var UF=r(rv);d(Pr.$$.fragment,UF),UF.forEach(t),IF.forEach(t),yC=c(a6),pv=l(a6,"SPAN",{});var GF=r(pv);wC=n(GF,"Constructing Massive Models"),GF.forEach(t),a6.forEach(t),P3=c(e),hn=l(e,"P",{});var n6=r(hn);bC=n(n6,`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
...
`),yv=l(p6,"CODE",{});var oV=r(yv);lx=n(oV,"from_pretrained"),oV.forEach(t),rx=n(p6,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
...
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),g6.forEach(t),JV.forEach(t),j6.forEach(t),m0=c(e),it=l(e,"H3",{class:!0});var y6=r(it);qn=l(y6,"A",{id:!0,class:!0,href:!0});var QV=r(qn);Zv=l(QV,"SPAN",{});var eY=r(Zv);d(Jr.$$.fragment,eY),eY.forEach(t),QV.forEach(t),yR=c(y6),Nv=l(y6,"SPAN",{});var sY=r(Nv);wR=n(sY,"Troubleshooting"),sY.forEach(t),y6.forEach(t),_0=c(e),ut=l(e,"H4",{class:!0});var w6=r(ut);$n=l(w6,"A",{id:!0,class:!0,href:!0});var tY=r($n);Hv=l(tY,"SPAN",{});var aY=r(Hv);d(Xr.$$.fragment,aY),aY.forEach(t),tY.forEach(t),bR=c(w6),Qr=l(w6,"SPAN",{});var b6=r(Qr);ER=n(b6,"the "),Bv=l(b6,"CODE",{});var nY=r(Bv);qR=n(nY,"deepspeed"),nY.forEach(t),$R=n(b6," process gets killed at startup without a traceback"),b6.forEach(t),w6.forEach(t),v0=c(e),B=l(e,"P",{});var ke=r(B);kR=n(ke,"If the "),Wv=l(ke,"CODE",{});var oY=r(Wv);PR=n(oY,"deepspeed"),oY.forEach(t),DR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
