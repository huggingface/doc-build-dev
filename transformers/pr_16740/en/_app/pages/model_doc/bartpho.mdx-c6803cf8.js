import{S as jo,i as Do,s as So,e as s,k as c,w as _,t as r,M as Mo,c as n,d as o,m as d,a,x as k,h as i,b as p,F as t,g as h,y as b,L as Io,q as v,o as T,B as w,v as No}from"../../chunks/vendor-6b77c823.js";import{D as Ae}from"../../chunks/Docstring-af1d0ae0.js";import{C as Lo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as eo}from"../../chunks/IconCopyLink-7a11ce68.js";function Co(to){let y,$e,q,$,me,D,et,ue,tt,Ee,B,E,fe,S,ot,ge,st,Re,R,nt,M,at,rt,xe,Z,it,Pe,ee,_e,lt,Le,te,pt,je,I,De,oe,ct,Se,se,N,dt,ne,ht,mt,Me,C,Ie,ae,ke,ut,Ne,f,ft,O,gt,_t,F,kt,bt,Ce,z,x,be,V,vt,ve,Tt,Oe,m,X,wt,A,yt,re,qt,Bt,W,zt,At,$t,U,Et,ie,Rt,xt,Pt,g,G,Lt,Te,jt,Dt,H,le,St,we,Mt,It,pe,Nt,ye,Ct,Ot,P,K,Ft,qe,Vt,Xt,L,Q,Wt,Be,Ut,Gt,j,J,Ht,Y,Kt,ze,Qt,Jt,Fe;return D=new eo({}),S=new eo({}),I=new Lo({props:{code:`import torch
...
The <em>SentencePiece</em> processor that is used for every conversion (string, tokens and IDs).`,name:"sp_model"}]}}),G=new Ae({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.BartphoTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16740/src/transformers/models/bartpho/tokenization_bartpho.py#L193",parametersDescription:[{anchor:"transformers.BartphoTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`}}),K=new Ae({props:{name:"convert_tokens_to_string",anchor:"transformers.BartphoTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16740/src/transformers/models/bartpho/tokenization_bartpho.py#L295"}}),Q=new Ae({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16740/src/transformers/models/bartpho/tokenization_bartpho.py#L247",parametersDescription:[{anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),{c(){y=s("meta"),$e=c(),q=s("h1"),$=s("a"),me=s("span"),_(D.$$.fragment),et=c(),ue=s("span"),tt=r("BARTpho"),Ee=c(),B=s("h2"),E=s("a"),fe=s("span"),_(S.$$.fragment),ot=c(),ge=s("span"),st=r("Overview"),Re=c(),R=s("p"),nt=r("The BARTpho model was proposed in "),M=s("a"),at=r("BARTpho: Pre-trained Sequence-to-Sequence Models for Vietnamese"),rt=r(" by Nguyen Luong Tran, Duong Minh Le and Dat Quoc Nguyen."),xe=c(),Z=s("p"),it=r("The abstract from the paper is the following:"),Pe=c(),ee=s("p"),_e=s("em"),lt=r(`We present BARTpho with two versions \u2014 BARTpho_word and BARTpho_syllable \u2014 the first public large-scale monolingual
sequence-to-sequence models pre-trained for Vietnamese. Our BARTpho uses the \u201Clarge\u201D architecture and pre-training
scheme of the sequence-to-sequence denoising model BART, thus especially suitable for generative NLP tasks. Experiments
on a downstream task of Vietnamese text summarization show that in both automatic and human evaluations, our BARTpho
outperforms the strong baseline mBART and improves the state-of-the-art. We release BARTpho to facilitate future
research and applications of generative Vietnamese NLP tasks.`),Le=c(),te=s("p"),pt=r("Example of use:"),je=c(),_(I.$$.fragment),De=c(),oe=s("p"),ct=r("Tips:"),Se=c(),se=s("ul"),N=s("li"),dt=r(`Following mBART, BARTpho uses the \u201Clarge\u201D architecture of BART with an additional layer-normalization layer on top of
both the encoder and decoder. Thus, usage examples in the `),ne=s("a"),ht=r("documentation of BART"),mt=r(`, when adapting to use
with BARTpho, should be adjusted by replacing the BART-specialized classes with the mBART-specialized counterparts.
For example:`),Me=c(),_(C.$$.fragment),Ie=c(),ae=s("ul"),ke=s("li"),ut=r(`This implementation is only for tokenization: \u201Cmonolingual_vocab_file\u201D consists of Vietnamese-specialized types
extracted from the pre-trained SentencePiece model \u201Cvocab_file\u201D that is available from the multilingual XLM-RoBERTa.
Other languages, if employing this pre-trained multilingual SentencePiece model \u201Cvocab_file\u201D for subword
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),Ne=c(),f=s("p"),ft=r("This model was contributed by "),O=s("a"),gt=r("dqnguyen"),_t=r(". The original code can be found "),F=s("a"),kt=r("here"),bt=r("."),Ce=c(),z=s("h2"),x=s("a"),be=s("span"),_(V.$$.fragment),vt=c(),ve=s("span"),Tt=r("BartphoTokenizer"),Oe=c(),m=s("div"),_(X.$$.fragment),wt=c(),A=s("p"),yt=r("Adapted from "),re=s("a"),qt=r("XLMRobertaTokenizer"),Bt=r(". Based on "),W=s("a"),zt=r("SentencePiece"),At=r("."),$t=c(),U=s("p"),Et=r("This tokenizer inherits from "),ie=s("a"),Rt=r("PreTrainedTokenizer"),xt=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Pt=c(),g=s("div"),_(G.$$.fragment),Lt=c(),Te=s("p"),jt=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An BARTPho sequence has the following format:`),Dt=c(),H=s("ul"),le=s("li"),St=r("single sequence: "),we=s("code"),Mt=r("<s> X </s>"),It=c(),pe=s("li"),Nt=r("pair of sequences: "),ye=s("code"),Ct=r("<s> A </s></s> B </s>"),Ot=c(),P=s("div"),_(K.$$.fragment),Ft=c(),qe=s("p"),Vt=r("Converts a sequence of tokens (strings for sub-words) in a single string."),Xt=c(),L=s("div"),_(Q.$$.fragment),Wt=c(),Be=s("p"),Ut=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
make use of token type ids, therefore a list of zeros is returned.`),Gt=c(),j=s("div"),_(J.$$.fragment),Ht=c(),Y=s("p"),Kt=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ze=s("code"),Qt=r("prepare_for_model"),Jt=r(" method."),this.h()},l(e){const l=Mo('[data-svelte="svelte-1phssyn"]',document.head);y=n(l,"META",{name:!0,content:!0}),l.forEach(o),$e=d(e),q=n(e,"H1",{class:!0});var Ve=a(q);$=n(Ve,"A",{id:!0,class:!0,href:!0});var oo=a($);me=n(oo,"SPAN",{});var so=a(me);k(D.$$.fragment,so),so.forEach(o),oo.forEach(o),et=d(Ve),ue=n(Ve,"SPAN",{});var no=a(ue);tt=i(no,"BARTpho"),no.forEach(o),Ve.forEach(o),Ee=d(e),B=n(e,"H2",{class:!0});var Xe=a(B);E=n(Xe,"A",{id:!0,class:!0,href:!0});var ao=a(E);fe=n(ao,"SPAN",{});var ro=a(fe);k(S.$$.fragment,ro),ro.forEach(o),ao.forEach(o),ot=d(Xe),ge=n(Xe,"SPAN",{});var io=a(ge);st=i(io,"Overview"),io.forEach(o),Xe.forEach(o),Re=d(e),R=n(e,"P",{});var We=a(R);nt=i(We,"The BARTpho model was proposed in "),M=n(We,"A",{href:!0,rel:!0});var lo=a(M);at=i(lo,"BARTpho: Pre-trained Sequence-to-Sequence Models for Vietnamese"),lo.forEach(o),rt=i(We," by Nguyen Luong Tran, Duong Minh Le and Dat Quoc Nguyen."),We.forEach(o),xe=d(e),Z=n(e,"P",{});var po=a(Z);it=i(po,"The abstract from the paper is the following:"),po.forEach(o),Pe=d(e),ee=n(e,"P",{});var co=a(ee);_e=n(co,"EM",{});var ho=a(_e);lt=i(ho,`We present BARTpho with two versions \u2014 BARTpho_word and BARTpho_syllable \u2014 the first public large-scale monolingual
sequence-to-sequence models pre-trained for Vietnamese. Our BARTpho uses the \u201Clarge\u201D architecture and pre-training
scheme of the sequence-to-sequence denoising model BART, thus especially suitable for generative NLP tasks. Experiments
on a downstream task of Vietnamese text summarization show that in both automatic and human evaluations, our BARTpho
outperforms the strong baseline mBART and improves the state-of-the-art. We release BARTpho to facilitate future
research and applications of generative Vietnamese NLP tasks.`),ho.forEach(o),co.forEach(o),Le=d(e),te=n(e,"P",{});var mo=a(te);pt=i(mo,"Example of use:"),mo.forEach(o),je=d(e),k(I.$$.fragment,e),De=d(e),oe=n(e,"P",{});var uo=a(oe);ct=i(uo,"Tips:"),uo.forEach(o),Se=d(e),se=n(e,"UL",{});var fo=a(se);N=n(fo,"LI",{});var Ue=a(N);dt=i(Ue,`Following mBART, BARTpho uses the \u201Clarge\u201D architecture of BART with an additional layer-normalization layer on top of
both the encoder and decoder. Thus, usage examples in the `),ne=n(Ue,"A",{href:!0});var go=a(ne);ht=i(go,"documentation of BART"),go.forEach(o),mt=i(Ue,`, when adapting to use
with BARTpho, should be adjusted by replacing the BART-specialized classes with the mBART-specialized counterparts.
For example:`),Ue.forEach(o),fo.forEach(o),Me=d(e),k(C.$$.fragment,e),Ie=d(e),ae=n(e,"UL",{});var _o=a(ae);ke=n(_o,"LI",{});var ko=a(ke);ut=i(ko,`This implementation is only for tokenization: \u201Cmonolingual_vocab_file\u201D consists of Vietnamese-specialized types
extracted from the pre-trained SentencePiece model \u201Cvocab_file\u201D that is available from the multilingual XLM-RoBERTa.
Other languages, if employing this pre-trained multilingual SentencePiece model \u201Cvocab_file\u201D for subword
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),ko.forEach(o),_o.forEach(o),Ne=d(e),f=n(e,"P",{});var ce=a(f);ft=i(ce,"This model was contributed by "),O=n(ce,"A",{href:!0,rel:!0});var bo=a(O);gt=i(bo,"dqnguyen"),bo.forEach(o),_t=i(ce,". The original code can be found "),F=n(ce,"A",{href:!0,rel:!0});var vo=a(F);kt=i(vo,"here"),vo.forEach(o),bt=i(ce,"."),ce.forEach(o),Ce=d(e),z=n(e,"H2",{class:!0});var Ge=a(z);x=n(Ge,"A",{id:!0,class:!0,href:!0});var To=a(x);be=n(To,"SPAN",{});var wo=a(be);k(V.$$.fragment,wo),wo.forEach(o),To.forEach(o),vt=d(Ge),ve=n(Ge,"SPAN",{});var yo=a(ve);Tt=i(yo,"BartphoTokenizer"),yo.forEach(o),Ge.forEach(o),Oe=d(e),m=n(e,"DIV",{class:!0});var u=a(m);k(X.$$.fragment,u),wt=d(u),A=n(u,"P",{});var de=a(A);yt=i(de,"Adapted from "),re=n(de,"A",{href:!0});var qo=a(re);qt=i(qo,"XLMRobertaTokenizer"),qo.forEach(o),Bt=i(de,". Based on "),W=n(de,"A",{href:!0,rel:!0});var Bo=a(W);zt=i(Bo,"SentencePiece"),Bo.forEach(o),At=i(de,"."),de.forEach(o),$t=d(u),U=n(u,"P",{});var He=a(U);Et=i(He,"This tokenizer inherits from "),ie=n(He,"A",{href:!0});var zo=a(ie);Rt=i(zo,"PreTrainedTokenizer"),zo.forEach(o),xt=i(He,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),He.forEach(o),Pt=d(u),g=n(u,"DIV",{class:!0});var he=a(g);k(G.$$.fragment,he),Lt=d(he),Te=n(he,"P",{});var Ao=a(Te);jt=i(Ao,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An BARTPho sequence has the following format:`),Ao.forEach(o),Dt=d(he),H=n(he,"UL",{});var Ke=a(H);le=n(Ke,"LI",{});var Yt=a(le);St=i(Yt,"single sequence: "),we=n(Yt,"CODE",{});var $o=a(we);Mt=i($o,"<s> X </s>"),$o.forEach(o),Yt.forEach(o),It=d(Ke),pe=n(Ke,"LI",{});var Zt=a(pe);Nt=i(Zt,"pair of sequences: "),ye=n(Zt,"CODE",{});var Eo=a(ye);Ct=i(Eo,"<s> A </s></s> B </s>"),Eo.forEach(o),Zt.forEach(o),Ke.forEach(o),he.forEach(o),Ot=d(u),P=n(u,"DIV",{class:!0});var Qe=a(P);k(K.$$.fragment,Qe),Ft=d(Qe),qe=n(Qe,"P",{});var Ro=a(qe);Vt=i(Ro,"Converts a sequence of tokens (strings for sub-words) in a single string."),Ro.forEach(o),Qe.forEach(o),Xt=d(u),L=n(u,"DIV",{class:!0});var Je=a(L);k(Q.$$.fragment,Je),Wt=d(Je),Be=n(Je,"P",{});var xo=a(Be);Ut=i(xo,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
make use of token type ids, therefore a list of zeros is returned.`),xo.forEach(o),Je.forEach(o),Gt=d(u),j=n(u,"DIV",{class:!0});var Ye=a(j);k(J.$$.fragment,Ye),Ht=d(Ye),Y=n(Ye,"P",{});var Ze=a(Y);Kt=i(Ze,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ze=n(Ze,"CODE",{});var Po=a(ze);Qt=i(Po,"prepare_for_model"),Po.forEach(o),Jt=i(Ze," method."),Ze.forEach(o),Ye.forEach(o),u.forEach(o),this.h()},h(){p(y,"name","hf:doc:metadata"),p(y,"content",JSON.stringify(Oo)),p($,"id","bartpho"),p($,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p($,"href","#bartpho"),p(q,"class","relative group"),p(E,"id","overview"),p(E,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(E,"href","#overview"),p(B,"class","relative group"),p(M,"href","https://arxiv.org/abs/2109.09701"),p(M,"rel","nofollow"),p(ne,"href","bart"),p(O,"href","https://huggingface.co/dqnguyen"),p(O,"rel","nofollow"),p(F,"href","https://github.com/VinAIResearch/BARTpho"),p(F,"rel","nofollow"),p(x,"id","transformers.BartphoTokenizer"),p(x,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(x,"href","#transformers.BartphoTokenizer"),p(z,"class","relative group"),p(re,"href","/docs/transformers/pr_16740/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer"),p(W,"href","https://github.com/google/sentencepiece"),p(W,"rel","nofollow"),p(ie,"href","/docs/transformers/pr_16740/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(g,"class","docstring"),p(P,"class","docstring"),p(L,"class","docstring"),p(j,"class","docstring"),p(m,"class","docstring")},m(e,l){t(document.head,y),h(e,$e,l),h(e,q,l),t(q,$),t($,me),b(D,me,null),t(q,et),t(q,ue),t(ue,tt),h(e,Ee,l),h(e,B,l),t(B,E),t(E,fe),b(S,fe,null),t(B,ot),t(B,ge),t(ge,st),h(e,Re,l),h(e,R,l),t(R,nt),t(R,M),t(M,at),t(R,rt),h(e,xe,l),h(e,Z,l),t(Z,it),h(e,Pe,l),h(e,ee,l),t(ee,_e),t(_e,lt),h(e,Le,l),h(e,te,l),t(te,pt),h(e,je,l),b(I,e,l),h(e,De,l),h(e,oe,l),t(oe,ct),h(e,Se,l),h(e,se,l),t(se,N),t(N,dt),t(N,ne),t(ne,ht),t(N,mt),h(e,Me,l),b(C,e,l),h(e,Ie,l),h(e,ae,l),t(ae,ke),t(ke,ut),h(e,Ne,l),h(e,f,l),t(f,ft),t(f,O),t(O,gt),t(f,_t),t(f,F),t(F,kt),t(f,bt),h(e,Ce,l),h(e,z,l),t(z,x),t(x,be),b(V,be,null),t(z,vt),t(z,ve),t(ve,Tt),h(e,Oe,l),h(e,m,l),b(X,m,null),t(m,wt),t(m,A),t(A,yt),t(A,re),t(re,qt),t(A,Bt),t(A,W),t(W,zt),t(A,At),t(m,$t),t(m,U),t(U,Et),t(U,ie),t(ie,Rt),t(U,xt),t(m,Pt),t(m,g),b(G,g,null),t(g,Lt),t(g,Te),t(Te,jt),t(g,Dt),t(g,H),t(H,le),t(le,St),t(le,we),t(we,Mt),t(H,It),t(H,pe),t(pe,Nt),t(pe,ye),t(ye,Ct),t(m,Ot),t(m,P),b(K,P,null),t(P,Ft),t(P,qe),t(qe,Vt),t(m,Xt),t(m,L),b(Q,L,null),t(L,Wt),t(L,Be),t(Be,Ut),t(m,Gt),t(m,j),b(J,j,null),t(j,Ht),t(j,Y),t(Y,Kt),t(Y,ze),t(ze,Qt),t(Y,Jt),Fe=!0},p:Io,i(e){Fe||(v(D.$$.fragment,e),v(S.$$.fragment,e),v(I.$$.fragment,e),v(C.$$.fragment,e),v(V.$$.fragment,e),v(X.$$.fragment,e),v(G.$$.fragment,e),v(K.$$.fragment,e),v(Q.$$.fragment,e),v(J.$$.fragment,e),Fe=!0)},o(e){T(D.$$.fragment,e),T(S.$$.fragment,e),T(I.$$.fragment,e),T(C.$$.fragment,e),T(V.$$.fragment,e),T(X.$$.fragment,e),T(G.$$.fragment,e),T(K.$$.fragment,e),T(Q.$$.fragment,e),T(J.$$.fragment,e),Fe=!1},d(e){o(y),e&&o($e),e&&o(q),w(D),e&&o(Ee),e&&o(B),w(S),e&&o(Re),e&&o(R),e&&o(xe),e&&o(Z),e&&o(Pe),e&&o(ee),e&&o(Le),e&&o(te),e&&o(je),w(I,e),e&&o(De),e&&o(oe),e&&o(Se),e&&o(se),e&&o(Me),w(C,e),e&&o(Ie),e&&o(ae),e&&o(Ne),e&&o(f),e&&o(Ce),e&&o(z),w(V),e&&o(Oe),e&&o(m),w(X),w(G),w(K),w(Q),w(J)}}}const Oo={local:"bartpho",sections:[{local:"overview",title:"Overview"},{local:"transformers.BartphoTokenizer",title:"BartphoTokenizer"}],title:"BARTpho"};function Fo(to){return No(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Go extends jo{constructor(y){super();Do(this,y,Fo,Co,So,{})}}export{Go as default,Oo as metadata};
