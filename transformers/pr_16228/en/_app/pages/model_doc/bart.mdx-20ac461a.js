...
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16228/en/model_doc/bart#transformers.BartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16228/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16228/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16228/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16228/src/transformers/models/bart/modeling_flax_bart.py#L1320",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16228/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16228/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16228/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16228/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16228/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16228/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xp.forEach(t),og=l(fe),Sd=a(fe,"P",{});var Jv=s(Sd);ng=i(Jv,"Finally, this model supports inherent JAX features such as:"),Jv.forEach(t),ag=l(fe),pt=a(fe,"UL",{});var bn=s(pt);Id=a(bn,"LI",{});var Xv=s(Id);es=a(Xv,"A",{href:!0,rel:!0});var Kv=s(es);sg=i(Kv,"Just-In-Time (JIT) compilation"),Kv.forEach(t),Xv.forEach(t),rg=l(bn),Nd=a(bn,"LI",{});var Zv=s(Nd);ts=a(Zv,"A",{href:!0,rel:!0});var Yv=s(ts);ig=i(Yv,"Automatic Differentiation"),Yv.forEach(t),Zv.forEach(t),dg=l(bn),Ld=a(bn,"LI",{});var e2=s(Ld);os=a(e2,"A",{href:!0,rel:!0});var t2=s(os);lg=i(t2,"Vectorization"),t2.forEach(t),e2.forEach(t),cg=l(bn),Dd=a(bn,"LI",{});var o2=s(Dd);ns=a(o2,"A",{href:!0,rel:!0});var n2=s(ns);pg=i(n2,"Parallelization"),n2.forEach(t),o2.forEach(t),bn.forEach(t),hg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);f(as.$$.fragment,St),ug=l(St),bo=a(St,"P",{});var li=s(bo);mg=i(li,"The "),Gd=a(li,"CODE",{});var a2=s(Gd);fg=i(a2,"FlaxBartPreTrainedModel"),a2.forEach(t),_g=i(li,"forward method, overrides the "),Wd=a(li,"CODE",{});var s2=s(Wd);gg=i(s2,"__call__"),s2.forEach(t),kg=i(li," special method."),li.forEach(t),bg=l(St),f(an.$$.fragment,St),yg=l(St),Ud=a(St,"P",{});var r2=s(Ud);Tg=i(r2,"Example:"),r2.forEach(t),vg=l(St),f(ss.$$.fragment,St),St.forEach(t),wg=l(fe),yt=a(fe,"DIV",{class:!0});var ci=s(yt);f(rs.$$.fragment,ci),xg=l(ci),Rd=a(ci,"P",{});var i2=s(Rd);zg=i(i2,"Example:"),i2.forEach(t),Fg=l(ci),f(is.$$.fragment,ci),ci.forEach(t),Bg=l(fe),Tt=a(fe,"DIV",{class:!0});var pi=s(Tt);f(ds.$$.fragment,pi),qg=l(pi),Hd=a(pi,"P",{});var d2=s(Hd);$g=i(d2,"Example:"),d2.forEach(t),jg=l(pi),f(ls.$$.fragment,pi),pi.forEach(t),fe.forEach(t),$c=l(o),yo=a(o,"H2",{class:!0});var zp=s(yo);sn=a(zp,"A",{id:!0,class:!0,href:!0});var l2=s(sn);Qd=a(l2,"SPAN",{});var c2=s(Qd);f(cs.$$.fragment,c2),c2.forEach(t),l2.forEach(t),Mg=l(zp),Vd=a(zp,"SPAN",{});var p2=s(Vd);Pg=i(p2,"FlaxBartForConditionalGeneration"),p2.forEach(t),zp.forEach(t),jc=l(o),U=a(o,"DIV",{class:!0});var _e=s(U);f(ps.$$.fragment,_e),Eg=l(_e),hs=a(_e,"P",{});var Fp=s(hs);Cg=i(Fp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gr=a(Fp,"A",{href:!0});var h2=s(Gr);Ag=i(h2,"FlaxPreTrainedModel"),h2.forEach(t),Og=i(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp.forEach(t),Sg=l(_e),us=a(_e,"P",{});var Bp=s(us);Ig=i(Bp,`This model is also a Flax Linen
`),ms=a(Bp,"A",{href:!0,rel:!0});var u2=s(ms);Ng=i(u2,"flax.nn.Module"),u2.forEach(t),Lg=i(Bp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bp.forEach(t),Dg=l(_e),Jd=a(_e,"P",{});var m2=s(Jd);Gg=i(m2,"Finally, this model supports inherent JAX features such as:"),m2.forEach(t),Wg=l(_e),ht=a(_e,"UL",{});var yn=s(ht);Xd=a(yn,"LI",{});var f2=s(Xd);fs=a(f2,"A",{href:!0,rel:!0});var _2=s(fs);Ug=i(_2,"Just-In-Time (JIT) compilation"),_2.forEach(t),f2.forEach(t),Rg=l(yn),Kd=a(yn,"LI",{});var g2=s(Kd);_s=a(g2,"A",{href:!0,rel:!0});var k2=s(_s);Hg=i(k2,"Automatic Differentiation"),k2.forEach(t),g2.forEach(t),Qg=l(yn),Zd=a(yn,"LI",{});var b2=s(Zd);gs=a(b2,"A",{href:!0,rel:!0});var y2=s(gs);Vg=i(y2,"Vectorization"),y2.forEach(t),b2.forEach(t),Jg=l(yn),Yd=a(yn,"LI",{});var T2=s(Yd);ks=a(T2,"A",{href:!0,rel:!0});var v2=s(ks);Xg=i(v2,"Parallelization"),v2.forEach(t),T2.forEach(t),yn.forEach(t),Kg=l(_e),te=a(_e,"DIV",{class:!0});var Ge=s(te);f(bs.$$.fragment,Ge),Zg=l(Ge),To=a(Ge,"P",{});var hi=s(To);Yg=i(hi,"The "),el=a(hi,"CODE",{});var w2=s(el);ek=i(w2,"FlaxBartPreTrainedModel"),w2.forEach(t),tk=i(hi,"forward method, overrides the "),tl=a(hi,"CODE",{});var x2=s(tl);ok=i(x2,"__call__"),x2.forEach(t),nk=i(hi," special method."),hi.forEach(t),ak=l(Ge),f(rn.$$.fragment,Ge),sk=l(Ge),ol=a(Ge,"P",{});var z2=s(ol);rk=i(z2,"Summarization example:"),z2.forEach(t),ik=l(Ge),f(ys.$$.fragment,Ge),dk=l(Ge),nl=a(Ge,"P",{});var F2=s(nl);lk=i(F2,"Mask filling example:"),F2.forEach(t),ck=l(Ge),f(Ts.$$.fragment,Ge),Ge.forEach(t),pk=l(_e),vt=a(_e,"DIV",{class:!0});var ui=s(vt);f(vs.$$.fragment,ui),hk=l(ui),al=a(ui,"P",{});var B2=s(al);uk=i(B2,"Example:"),B2.forEach(t),mk=l(ui),f(ws.$$.fragment,ui),ui.forEach(t),fk=l(_e),wt=a(_e,"DIV",{class:!0});var mi=s(wt);f(xs.$$.fragment,mi),_k=l(mi),sl=a(mi,"P",{});var q2=s(sl);gk=i(q2,"Example:"),q2.forEach(t),kk=l(mi),f(zs.$$.fragment,mi),mi.forEach(t),_e.forEach(t),Mc=l(o),vo=a(o,"H2",{class:!0});var qp=s(vo);dn=a(qp,"A",{id:!0,class:!0,href:!0});var $2=s(dn);rl=a($2,"SPAN",{});var j2=s(rl);f(Fs.$$.fragment,j2),j2.forEach(t),$2.forEach(t),bk=l(qp),il=a(qp,"SPAN",{});var M2=s(il);yk=i(M2,"FlaxBartForSequenceClassification"),M2.forEach(t),qp.forEach(t),Pc=l(o),S=a(o,"DIV",{class:!0});var oe=s(S);f(Bs.$$.fragment,oe),Tk=l(oe),dl=a(oe,"P",{});var P2=s(dl);vk=i(P2,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),P2.forEach(t),wk=l(oe),qs=a(oe,"P",{});var $p=s(qs);xk=i($p,"This model inherits from "),Wr=a($p,"A",{href:!0});var E2=s(Wr);zk=i(E2,"FlaxPreTrainedModel"),E2.forEach(t),Fk=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),Bk=l(oe),$s=a(oe,"P",{});var jp=s($s);qk=i(jp,`This model is also a Flax Linen
`),js=a(jp,"A",{href:!0,rel:!0});var C2=s(js);$k=i(C2,"flax.nn.Module"),C2.forEach(t),jk=i(jp,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jp.forEach(t),Mk=l(oe),ll=a(oe,"P",{});var A2=s(ll);Pk=i(A2,"Finally, this model supports inherent JAX features such as:"),A2.forEach(t),Ek=l(oe),ut=a(oe,"UL",{});var Tn=s(ut);cl=a(Tn,"LI",{});var O2=s(cl);Ms=a(O2,"A",{href:!0,rel:!0});var S2=s(Ms);Ck=i(S2,"Just-In-Time (JIT) compilation"),S2.forEach(t),O2.forEach(t),Ak=l(Tn),pl=a(Tn,"LI",{});var I2=s(pl);Ps=a(I2,"A",{href:!0,rel:!0});var N2=s(Ps);Ok=i(N2,"Automatic Differentiation"),N2.forEach(t),I2.forEach(t),Sk=l(Tn),hl=a(Tn,"LI",{});var L2=s(hl);Es=a(L2,"A",{href:!0,rel:!0});var D2=s(Es);Ik=i(D2,"Vectorization"),D2.forEach(t),L2.forEach(t),Nk=l(Tn),ul=a(Tn,"LI",{});var G2=s(ul);Cs=a(G2,"A",{href:!0,rel:!0});var W2=s(Cs);Lk=i(W2,"Parallelization"),W2.forEach(t),G2.forEach(t),Tn.forEach(t),Dk=l(oe),Oe=a(oe,"DIV",{class:!0});var It=s(Oe);f(As.$$.fragment,It),Gk=l(It),wo=a(It,"P",{});var fi=s(wo);Wk=i(fi,"The "),ml=a(fi,"CODE",{});var U2=s(ml);Uk=i(U2,"FlaxBartPreTrainedModel"),U2.forEach(t),Rk=i(fi,"forward method, overrides the "),fl=a(fi,"CODE",{});var R2=s(fl);Hk=i(R2,"__call__"),R2.forEach(t),Qk=i(fi," special method."),fi.forEach(t),Vk=l(It),f(ln.$$.fragment,It),Jk=l(It),_l=a(It,"P",{});var H2=s(_l);Xk=i(H2,"Example:"),H2.forEach(t),Kk=l(It),f(Os.$$.fragment,It),It.forEach(t),Zk=l(oe),xt=a(oe,"DIV",{class:!0});var _i=s(xt);f(Ss.$$.fragment,_i),Yk=l(_i),gl=a(_i,"P",{});var Q2=s(gl);eb=i(Q2,"Example:"),Q2.forEach(t),tb=l(_i),f(Is.$$.fragment,_i),_i.forEach(t),ob=l(oe),zt=a(oe,"DIV",{class:!0});var gi=s(zt);f(Ns.$$.fragment,gi),nb=l(gi),kl=a(gi,"P",{});var V2=s(kl);ab=i(V2,"Example:"),V2.forEach(t),sb=l(gi),f(Ls.$$.fragment,gi),gi.forEach(t),oe.forEach(t),Ec=l(o),xo=a(o,"H2",{class:!0});var Mp=s(xo);cn=a(Mp,"A",{id:!0,class:!0,href:!0});var J2=s(cn);bl=a(J2,"SPAN",{});var X2=s(bl);f(Ds.$$.fragment,X2),X2.forEach(t),J2.forEach(t),rb=l(Mp),yl=a(Mp,"SPAN",{});var K2=s(yl);ib=i(K2,"FlaxBartForQuestionAnswering"),K2.forEach(t),Mp.forEach(t),Cc=l(o),I=a(o,"DIV",{class:!0});var ne=s(I);f(Gs.$$.fragment,ne),db=l(ne),zo=a(ne,"P",{});var ki=s(zo);lb=i(ki,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var Z2=s(Tl);cb=i(Z2,"span start logits"),Z2.forEach(t),pb=i(ki," and "),vl=a(ki,"CODE",{});var Y2=s(vl);hb=i(Y2,"span end logits"),Y2.forEach(t),ub=i(ki,")."),ki.forEach(t),mb=l(ne),Ws=a(ne,"P",{});var Pp=s(Ws);fb=i(Pp,"This model inherits from "),Ur=a(Pp,"A",{href:!0});var e1=s(Ur);_b=i(e1,"FlaxPreTrainedModel"),e1.forEach(t),gb=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
