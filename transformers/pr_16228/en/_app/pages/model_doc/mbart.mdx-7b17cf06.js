...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16228/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16228/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16228/en/model_doc/mbart#transformers.MBartConfig"
...
corpora in many languages using the BART objective. mBART is one of the first methods for pretraining a complete
sequence-to-sequence model by denoising full texts in multiple languages, while previous approaches have focused only
on the encoder, decoder, or reconstructing parts of the text.`),H2.forEach(t),Ze=l(o),se=a(o,"P",{});var fp=s(se);ye=i(fp,"This model was contributed by "),ve=a(fp,"A",{href:!0,rel:!0});var V2=s(ve);ht=i(V2,"valhalla"),V2.forEach(t),re=i(fp,". The Authors\u2019 code can be found "),Te=a(fp,"A",{href:!0,rel:!0});var Q2=s(Te);Me=i(Q2,"here"),Q2.forEach(t),fp.forEach(t),Ye=l(o),w=a(o,"H3",{class:!0});var ph=s(w);F=a(ph,"A",{id:!0,class:!0,href:!0});var J2=s(F);we=a(J2,"SPAN",{});var K2=s(we);f(He.$$.fragment,K2),K2.forEach(t),J2.forEach(t),Ut=l(ph),K=a(ph,"SPAN",{});var Z2=s(K);Xt=i(Z2,"Training of MBart"),Z2.forEach(t),ph.forEach(t),kt=l(o),X=a(o,"P",{});var jt=s(X);ie=i(jt,`MBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for translation task. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
...
target text format is `),Ve=a(jt,"CODE",{});var t1=s(Ve);Kt=i(t1,"[tgt_lang_code] X [eos]"),t1.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var o1=s(rd);Pu=i(o1,"bos"),o1.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Su=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var U2=s(Cn);id=a(U2,"STRONG",{});var n1=s(id);Au=i(n1,"call"),n1.forEach(t),Ou=i(U2,"()"),U2.forEach(t),Iu=i(Ei,` will encode source text format, and it should be wrapped
inside the context manager `),Zr=a(Ei,"A",{href:!0});var a1=s(Zr);Nu=i(a1,"as_target_tokenizer()"),a1.forEach(t),Du=i(Ei," to encode target text format."),Ei.forEach(t),gp=l(o),Yr=a(o,"UL",{});var s1=s(Yr);dd=a(s1,"LI",{});var r1=s(dd);Lu=i(r1,"Supervised training"),r1.forEach(t),s1.forEach(t),kp=l(o),f(Sn.$$.fragment,o),bp=l(o),ei=a(o,"UL",{});var i1=s(ei);An=a(i1,"LI",{});var hh=s(An);ld=a(hh,"P",{});var d1=s(ld);Gu=i(d1,"Generation"),d1.forEach(t),Wu=l(hh),Zt=a(hh,"P",{});var Pi=s(Zt);Ru=i(Pi,"While generating the target text set the "),cd=a(Pi,"CODE",{});var l1=s(cd);Uu=i(l1,"decoder_start_token_id"),l1.forEach(t),Xu=i(Pi,` to the target language id. The following
example shows how to translate English to Romanian using the `),pd=a(Pi,"EM",{});var c1=s(pd);Hu=i(c1,"facebook/mbart-large-en-ro"),c1.forEach(t),Vu=i(Pi," model."),Pi.forEach(t),hh.forEach(t),i1.forEach(t),yp=l(o),f(On.$$.fragment,o),vp=l(o),Yt=a(o,"H2",{class:!0});var uh=s(Yt);So=a(uh,"A",{id:!0,class:!0,href:!0});var p1=s(So);hd=a(p1,"SPAN",{});var h1=s(hd);f(In.$$.fragment,h1),h1.forEach(t),p1.forEach(t),Qu=l(uh),ud=a(uh,"SPAN",{});var u1=s(ud);Ju=i(u1,"Overview of MBart-50"),u1.forEach(t),uh.forEach(t),Tp=l(o),yt=a(o,"P",{});var Ci=s(yt);Ku=i(Ci,"MBart-50 was introduced in the "),Nn=a(Ci,"A",{href:!0,rel:!0});var m1=s(Nn);Zu=i(m1,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),m1.forEach(t),Yu=i(Ci,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),k1.forEach(t),g1.forEach(t),xp=l(o),eo=a(o,"H3",{class:!0});var mh=s(eo);Ao=a(mh,"A",{id:!0,class:!0,href:!0});var b1=s(Ao);_d=a(b1,"SPAN",{});var y1=s(_d);f(Dn.$$.fragment,y1),y1.forEach(t),b1.forEach(t),am=l(mh),gd=a(mh,"SPAN",{});var v1=s(gd);sm=i(v1,"Training of MBart-50"),v1.forEach(t),mh.forEach(t),zp=l(o),et=a(o,"P",{});var wn=s(et);rm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
language id for source text and target language id for target text, with `),yd=a(wn,"CODE",{});var w1=s(yd);pm=i(w1,"X"),w1.forEach(t),hm=i(wn,` being the source or target text
respectively.`),wn.forEach(t),qp=l(o),Oo=a(o,"P",{});var fh=s(Oo);um=i(fh,"MBart-50 has its own tokenizer "),ni=a(fh,"A",{href:!0});var x1=s(ni);mm=i(x1,"MBart50Tokenizer"),x1.forEach(t),fm=i(fh,"."),fh.forEach(t),Bp=l(o),ai=a(o,"UL",{});var z1=s(ai);vd=a(z1,"LI",{});var q1=s(vd);_m=i(q1,"Supervised training"),q1.forEach(t),z1.forEach(t),Fp=l(o),f(Ln.$$.fragment,o),$p=l(o),si=a(o,"UL",{});var B1=s(si);Gn=a(B1,"LI",{});var _h=s(Gn);Td=a(_h,"P",{});var F1=s(Td);gm=i(F1,"Generation"),F1.forEach(t),km=l(_h),xe=a(_h,"P",{});var nt=s(xe);bm=i(nt,"To generate using the mBART-50 multilingual translation models, "),Md=a(nt,"CODE",{});var $1=s(Md);ym=i($1,"eos_token_id"),$1.forEach(t),vm=i(nt,` is used as the
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),qd=a(nt,"EM",{});var C1=s(qd);Bm=i(C1,"facebook/mbart-50-large-many-to-many"),C1.forEach(t),Fm=i(nt," checkpoint."),nt.forEach(t),_h.forEach(t),B1.forEach(t),jp=l(o),f(Wn.$$.fragment,o),Ep=l(o),to=a(o,"H2",{class:!0});var gh=s(to);Io=a(gh,"A",{id:!0,class:!0,href:!0});var S1=s(Io);Bd=a(S1,"SPAN",{});var A1=s(Bd);f(Rn.$$.fragment,A1),A1.forEach(t),S1.forEach(t),$m=l(gh),Fd=a(gh,"SPAN",{});var O1=s(Fd);jm=i(O1,"MBartConfig"),O1.forEach(t),gh.forEach(t),Pp=l(o),ze=a(o,"DIV",{class:!0});var Et=s(ze);f(Un.$$.fragment,Et),Em=l(Et),oo=a(Et,"P",{});var Si=s(oo);Pm=i(Si,"This is the configuration class to store the configuration of a "),ri=a(Si,"A",{href:!0});var I1=s(ri);Cm=i(I1,"MBartModel"),I1.forEach(t),Sm=i(Si,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Xn=a(Si,"A",{href:!0,rel:!0});var N1=s(Xn);Am=i(N1,"facebook/mbart-large-cc25"),N1.forEach(t),Om=i(Si," architecture."),Si.forEach(t),Im=l(Et),no=a(Et,"P",{});var Ai=s(no);Nm=i(Ai,"Configuration objects inherit from "),ii=a(Ai,"A",{href:!0});var D1=s(ii);Dm=i(D1,"PretrainedConfig"),D1.forEach(t),Lm=i(Ai,` and can be used to control the model outputs. Read the
documentation from `),di=a(Ai,"A",{href:!0});var L1=s(di);Gm=i(L1,"PretrainedConfig"),L1.forEach(t),Wm=i(Ai," for more information."),Ai.forEach(t),Rm=l(Et),$d=a(Et,"P",{});var G1=s($d);Um=i(G1,"Example:"),G1.forEach(t),Xm=l(Et),f(Hn.$$.fragment,Et),Et.forEach(t),Cp=l(o),ao=a(o,"H2",{class:!0});var kh=s(ao);No=a(kh,"A",{id:!0,class:!0,href:!0});var W1=s(No);jd=a(W1,"SPAN",{});var R1=s(jd);f(Vn.$$.fragment,R1),R1.forEach(t),W1.forEach(t),Hm=l(kh),Ed=a(kh,"SPAN",{});var U1=s(Ed);Vm=i(U1,"MBartTokenizer"),U1.forEach(t),kh.forEach(t),Sp=l(o),L=a(o,"DIV",{class:!0});var he=s(L);f(Qn.$$.fragment,he),Qm=l(he),Pd=a(he,"P",{});var X1=s(Pd);Jm=i(X1,"Construct an MBART tokenizer."),X1.forEach(t),Km=l(he),ut=a(he,"P",{});var xn=s(ut);Zm=i(xn,"Adapted from "),li=a(xn,"A",{href:!0});var H1=s(li);Ym=i(H1,"RobertaTokenizer"),H1.forEach(t),ef=i(xn," and "),ci=a(xn,"A",{href:!0});var V1=s(ci);tf=i(V1,"XLNetTokenizer"),V1.forEach(t),of=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var Q1=s(Jn);nf=i(Q1,"SentencePiece"),Q1.forEach(t),af=i(xn,"."),xn.forEach(t),sf=l(he),Kn=a(he,"P",{});var bh=s(Kn);rf=i(bh,"The tokenization method is "),Cd=a(bh,"CODE",{});var J1=s(Cd);df=i(J1,"<tokens> <eos> <language code>"),J1.forEach(t),lf=i(bh," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),bh.forEach(t),cf=l(he),Sd=a(he,"P",{});var K1=s(Sd);pf=i(K1,"Examples:"),K1.forEach(t),hf=l(he),f(Zn.$$.fragment,he),uf=l(he),Do=a(he,"DIV",{class:!0});var yh=s(Do);f(Yn.$$.fragment,yh),mf=l(yh),Ad=a(yh,"P",{});var Z1=s(Ad);ff=i(Z1,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Z1.forEach(t),yh.forEach(t),_f=l(he),tt=a(he,"DIV",{class:!0});var zn=s(tt);f(ea.$$.fragment,zn),gf=l(zn),ta=a(zn,"P",{});var vh=s(ta);kf=i(vh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Od=a(vh,"CODE",{});var Y1=s(Od);bf=i(Y1,"X"),Y1.forEach(t),yf=i(vh," represents the sequence:"),vh.forEach(t),vf=l(zn),oa=a(zn,"UL",{});var Th=s(oa);na=a(Th,"LI",{});var Mh=s(na);Id=a(Mh,"CODE",{});var eM=s(Id);Tf=i(eM,"input_ids"),eM.forEach(t),Mf=i(Mh," (for encoder) "),Nd=a(Mh,"CODE",{});var tM=s(Nd);wf=i(tM,"X [eos, src_lang_code]"),tM.forEach(t),Mh.forEach(t),xf=l(Th),aa=a(Th,"LI",{});var wh=s(aa);Dd=a(wh,"CODE",{});var oM=s(Dd);zf=i(oM,"decoder_input_ids"),oM.forEach(t),qf=i(wh,": (for decoder) "),Ld=a(wh,"CODE",{});var nM=s(Ld);Bf=i(nM,"X [eos, tgt_lang_code]"),nM.forEach(t),wh.forEach(t),Th.forEach(t),Ff=l(zn),Gd=a(zn,"P",{});var aM=s(Gd);$f=i(aM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),aM.forEach(t),zn.forEach(t),he.forEach(t),Ap=l(o),so=a(o,"H2",{class:!0});var xh=s(so);Lo=a(xh,"A",{id:!0,class:!0,href:!0});var sM=s(Lo);Wd=a(sM,"SPAN",{});var rM=s(Wd);f(sa.$$.fragment,rM),rM.forEach(t),sM.forEach(t),jf=l(xh),Rd=a(xh,"SPAN",{});var iM=s(Rd);Ef=i(iM,"MBartTokenizerFast"),iM.forEach(t),xh.forEach(t),Op=l(o),C=a(o,"DIV",{class:!0});var H=s(C);f(ra.$$.fragment,H),Pf=l(H),ro=a(H,"P",{});var Oi=s(ro);Cf=i(Oi,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Ud=a(Oi,"EM",{});var dM=s(Ud);Sf=i(dM,"tokenizers"),dM.forEach(t),Af=i(Oi,` library). Based on
`),ia=a(Oi,"A",{href:!0,rel:!0});var lM=s(ia);Of=i(lM,"BPE"),lM.forEach(t),If=i(Oi,"."),Oi.forEach(t),Nf=l(H),vt=a(H,"P",{});var Kr=s(vt);pi=a(Kr,"A",{href:!0});var cM=s(pi);Df=i(cM,"MBartTokenizerFast"),cM.forEach(t),Lf=i(Kr," is a subclass of "),hi=a(Kr,"A",{href:!0});var pM=s(hi);Gf=i(pM,"XLMRobertaTokenizerFast"),pM.forEach(t),Wf=i(Kr,`. Refer to superclass
...
adding special tokens. The special tokens depend on calling set_lang.`),fM.forEach(t),o_=l(Pt),pa=a(Pt,"P",{});var qh=s(pa);n_=i(qh,"An MBART sequence has the following format, where "),Qd=a(qh,"CODE",{});var _M=s(Qd);a_=i(_M,"X"),_M.forEach(t),s_=i(qh," represents the sequence:"),qh.forEach(t),r_=l(Pt),ha=a(Pt,"UL",{});var Bh=s(ha);ua=a(Bh,"LI",{});var Fh=s(ua);Jd=a(Fh,"CODE",{});var gM=s(Jd);i_=i(gM,"input_ids"),gM.forEach(t),d_=i(Fh," (for encoder) "),Kd=a(Fh,"CODE",{});var kM=s(Kd);l_=i(kM,"X [eos, src_lang_code]"),kM.forEach(t),Fh.forEach(t),c_=l(Bh),ma=a(Bh,"LI",{});var $h=s(ma);Zd=a($h,"CODE",{});var bM=s(Zd);p_=i(bM,"decoder_input_ids"),bM.forEach(t),h_=i($h,": (for decoder) "),Yd=a($h,"CODE",{});var yM=s(Yd);u_=i(yM,"X [eos, tgt_lang_code]"),yM.forEach(t),$h.forEach(t),Bh.forEach(t),m_=l(Pt),el=a(Pt,"P",{});var vM=s(el);f_=i(vM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),vM.forEach(t),Pt.forEach(t),__=l(H),Go=a(H,"DIV",{class:!0});var jh=s(Go);f(fa.$$.fragment,jh),g_=l(jh),tl=a(jh,"P",{});var TM=s(tl);k_=i(TM,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),TM.forEach(t),jh.forEach(t),b_=l(H),Wo=a(H,"DIV",{class:!0});var Eh=s(Wo);f(_a.$$.fragment,Eh),y_=l(Eh),ol=a(Eh,"P",{});var MM=s(ol);v_=i(MM,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),MM.forEach(t),Eh.forEach(t),T_=l(H),Ro=a(H,"DIV",{class:!0});var Ph=s(Ro);f(ga.$$.fragment,Ph),M_=l(Ph),nl=a(Ph,"P",{});var wM=s(nl);w_=i(wM,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),wM.forEach(t),Ph.forEach(t),H.forEach(t),Ip=l(o),io=a(o,"H2",{class:!0});var Ch=s(io);Uo=a(Ch,"A",{id:!0,class:!0,href:!0});var xM=s(Uo);al=a(xM,"SPAN",{});var zM=s(al);f(ka.$$.fragment,zM),zM.forEach(t),xM.forEach(t),x_=l(Ch),sl=a(Ch,"SPAN",{});var qM=s(sl);z_=i(qM,"MBart50Tokenizer"),qM.forEach(t),Ch.forEach(t),Np=l(o),S=a(o,"DIV",{class:!0});var V=s(S);f(ba.$$.fragment,V),q_=l(V),ya=a(V,"P",{});var Sh=s(ya);B_=i(Sh,"Construct a MBart50 tokenizer. Based on "),va=a(Sh,"A",{href:!0,rel:!0});var BM=s(va);F_=i(BM,"SentencePiece"),BM.forEach(t),$_=i(Sh,"."),Sh.forEach(t),j_=l(V),Ta=a(V,"P",{});var Ah=s(Ta);E_=i(Ah,"This tokenizer inherits from "),mi=a(Ah,"A",{href:!0});var FM=s(mi);P_=i(FM,"PreTrainedTokenizer"),FM.forEach(t),C_=i(Ah,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ah.forEach(t),S_=l(V),rl=a(V,"P",{});var $M=s(rl);A_=i($M,"Examples:"),$M.forEach(t),O_=l(V),f(Ma.$$.fragment,V),I_=l(V),ot=a(V,"DIV",{class:!0});var qn=s(ot);f(wa.$$.fragment,qn),N_=l(qn),xa=a(qn,"P",{});var Oh=s(xa);D_=i(Oh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),il=a(Oh,"CODE",{});var jM=s(il);L_=i(jM,"X"),jM.forEach(t),G_=i(Oh," represents the sequence:"),Oh.forEach(t),W_=l(qn),za=a(qn,"UL",{});var Ih=s(za);qa=a(Ih,"LI",{});var Nh=s(qa);dl=a(Nh,"CODE",{});var EM=s(dl);R_=i(EM,"input_ids"),EM.forEach(t),U_=i(Nh," (for encoder) "),ll=a(Nh,"CODE",{});var PM=s(ll);X_=i(PM,"[src_lang_code] X [eos]"),PM.forEach(t),Nh.forEach(t),H_=l(Ih),Ba=a(Ih,"LI",{});var Dh=s(Ba);cl=a(Dh,"CODE",{});var CM=s(cl);V_=i(CM,"labels"),CM.forEach(t),Q_=i(Dh,": (for decoder) "),pl=a(Dh,"CODE",{});var SM=s(pl);J_=i(SM,"[tgt_lang_code] X [eos]"),SM.forEach(t),Dh.forEach(t),Ih.forEach(t),K_=l(qn),hl=a(qn,"P",{});var AM=s(hl);Z_=i(AM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),AM.forEach(t),qn.forEach(t),Y_=l(V),Xo=a(V,"DIV",{class:!0});var Lh=s(Xo);f(Fa.$$.fragment,Lh),eg=l(Lh),ul=a(Lh,"P",{});var OM=s(ul);tg=i(OM,"Converts a sequence of tokens (strings for sub-words) in a single string."),OM.forEach(t),Lh.forEach(t),og=l(V),Ho=a(V,"DIV",{class:!0});var Gh=s(Ho);f($a.$$.fragment,Gh),ng=l(Gh),ja=a(Gh,"P",{});var Wh=s(ja);ag=i(Wh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ml=a(Wh,"CODE",{});var IM=s(ml);sg=i(IM,"prepare_for_model"),IM.forEach(t),rg=i(Wh," method."),Wh.forEach(t),Gh.forEach(t),ig=l(V),Vo=a(V,"DIV",{class:!0});var Rh=s(Vo);f(Ea.$$.fragment,Rh),dg=l(Rh),fl=a(Rh,"P",{});var NM=s(fl);lg=i(NM,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),NM.forEach(t),Rh.forEach(t),cg=l(V),Qo=a(V,"DIV",{class:!0});var Uh=s(Qo);f(Pa.$$.fragment,Uh),pg=l(Uh),_l=a(Uh,"P",{});var DM=s(_l);hg=i(DM,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),DM.forEach(t),Uh.forEach(t),V.forEach(t),Dp=l(o),lo=a(o,"H2",{class:!0});var Xh=s(lo);Jo=a(Xh,"A",{id:!0,class:!0,href:!0});var LM=s(Jo);gl=a(LM,"SPAN",{});var GM=s(gl);f(Ca.$$.fragment,GM),GM.forEach(t),LM.forEach(t),ug=l(Xh),kl=a(Xh,"SPAN",{});var WM=s(kl);mg=i(WM,"MBart50TokenizerFast"),WM.forEach(t),Xh.forEach(t),Lp=l(o),G=a(o,"DIV",{class:!0});var ue=s(G);f(Sa.$$.fragment,ue),fg=l(ue),co=a(ue,"P",{});var Ii=s(co);_g=i(Ii,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),bl=a(Ii,"EM",{});var RM=s(bl);gg=i(RM,"tokenizers"),RM.forEach(t),kg=i(Ii,` library). Based on
`),Aa=a(Ii,"A",{href:!0,rel:!0});var UM=s(Aa);bg=i(UM,"BPE"),UM.forEach(t),yg=i(Ii,"."),Ii.forEach(t),vg=l(ue),Oa=a(ue,"P",{});var Hh=s(Oa);Tg=i(Hh,"This tokenizer inherits from "),fi=a(Hh,"A",{href:!0});var XM=s(fi);Mg=i(XM,"PreTrainedTokenizerFast"),XM.forEach(t),wg=i(Hh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hh.forEach(t),xg=l(ue),yl=a(ue,"P",{});var HM=s(yl);zg=i(HM,"Examples:"),HM.forEach(t),qg=l(ue),f(Ia.$$.fragment,ue),Bg=l(ue),Ce=a(ue,"DIV",{class:!0});var Ct=s(Ce);f(Na.$$.fragment,Ct),Fg=l(Ct),vl=a(Ct,"P",{});var VM=s(vl);$g=i(VM,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),VM.forEach(t),jg=l(Ct),Da=a(Ct,"P",{});var Vh=s(Da);Eg=i(Vh,"An MBART-50 sequence has the following format, where "),Tl=a(Vh,"CODE",{});var QM=s(Tl);Pg=i(QM,"X"),QM.forEach(t),Cg=i(Vh," represents the sequence:"),Vh.forEach(t),Sg=l(Ct),La=a(Ct,"UL",{});var Qh=s(La);Ga=a(Qh,"LI",{});var Jh=s(Ga);Ml=a(Jh,"CODE",{});var JM=s(Ml);Ag=i(JM,"input_ids"),JM.forEach(t),Og=i(Jh," (for encoder) "),wl=a(Jh,"CODE",{});var KM=s(wl);Ig=i(KM,"[src_lang_code] X [eos]"),KM.forEach(t),Jh.forEach(t),Ng=l(Qh),Wa=a(Qh,"LI",{});var Kh=s(Wa);xl=a(Kh,"CODE",{});var ZM=s(xl);Dg=i(ZM,"labels"),ZM.forEach(t),Lg=i(Kh,": (for decoder) "),zl=a(Kh,"CODE",{});var YM=s(zl);Gg=i(YM,"[tgt_lang_code] X [eos]"),YM.forEach(t),Kh.forEach(t),Qh.forEach(t),Wg=l(Ct),ql=a(Ct,"P",{});var ew=s(ql);Rg=i(ew,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
