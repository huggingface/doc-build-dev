...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var A=a(F);C=s(A,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),W=s(Y,"CODE",{});var Ae=a(W);Fe=i(Ae,"model(inputs_ids)"),Ae.forEach(t),Y.forEach(t),ye=l(A),P=s(A,"LI",{});var Z=a(P);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),O=s(Z,"CODE",{});var Le=a(O);Pe=i(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),Z.forEach(t),fe=l(A),N=s(A,"LI",{});var Ie=a(N);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(Ie,"CODE",{});var ft=a(U);Oe=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),A.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ke),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,W),e(W,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,O),e(O,Pe),e(F,fe),e(F,N),e(N,Ce),e(N,U),e(U,Oe)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function wy(L){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var A=a(F);C=s(A,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),W=s(Y,"CODE",{});var Ae=a(W);Fe=i(Ae,"model(inputs_ids)"),Ae.forEach(t),Y.forEach(t),ye=l(A),P=s(A,"LI",{});var Z=a(P);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),O=s(Z,"CODE",{});var Le=a(O);Pe=i(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),Z.forEach(t),fe=l(A),N=s(A,"LI",{});var Ie=a(N);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(Ie,"CODE",{});var ft=a(U);Oe=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),A.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ke),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,W),e(W,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,O),e(O,Pe),e(F,fe),e(F,N),e(N,Ce),e(N,U),e(U,Oe)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function zy(L){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16228/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Us=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16228/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16228/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
it will evenly distribute blocks across all devices.`),n2.forEach(t),Mg=l(Bt),Kd=s(Bt,"P",{});var o2=a(Kd);Pg=i(o2,"Example:"),o2.forEach(t),Cg=l(Bt),_(Ws.$$.fragment,Bt),Bt.forEach(t),Og=l(ze),kt=s(ze,"DIV",{class:!0});var mo=a(kt);_(Us.$$.fragment,mo),Ag=l(mo),Yd=s(mo,"P",{});var s2=a(Yd);Lg=i(s2,"Moves the model to cpu from a model parallel state."),s2.forEach(t),Ig=l(mo),Zd=s(mo,"P",{});var a2=a(Zd);Ng=i(a2,"Example:"),a2.forEach(t),Dg=l(mo),_(Rs.$$.fragment,mo),mo.forEach(t),ze.forEach(t),jc=l(n),un=s(n,"H2",{class:!0});var kp=a(un);Hn=s(kp,"A",{id:!0,class:!0,href:!0});var r2=a(Hn);Jd=s(r2,"SPAN",{});var i2=a(Jd);_(Hs.$$.fragment,i2),i2.forEach(t),r2.forEach(t),Sg=l(kp),Xd=s(kp,"SPAN",{});var d2=a(Xd);Gg=i(d2,"T5EncoderModel"),d2.forEach(t),kp.forEach(t),Fc=l(n),Q=s(n,"DIV",{class:!0});var $e=a(Q);_(Vs.$$.fragment,$e),Bg=l($e),Qd=s($e,"P",{});var l2=a(Qd);Wg=i(l2,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),l2.forEach(t),Ug=l($e),Ks=s($e,"P",{});var bp=a(Ks);Rg=i(bp,"The T5 model was proposed in "),Ys=s(bp,"A",{href:!0,rel:!0});var c2=a(Ys);Hg=i(c2,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Transformer`),z2.forEach(t),OT=i(zp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),zp.forEach(t),AT=l(at),la=s(at,"P",{});var $p=a(la);LT=i($p,"This model inherits from "),Mr=s($p,"A",{href:!0});var $2=a(Mr);IT=i($2,"TFPreTrainedModel"),$2.forEach(t),NT=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),DT=l(at),ca=s(at,"P",{});var qp=a(ca);ST=i(qp,"This model is also a "),pa=s(qp,"A",{href:!0,rel:!0});var q2=a(pa);GT=i(q2,"tf.keras.Model"),q2.forEach(t),BT=i(qp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qp.forEach(t),WT=l(at),_(Yn.$$.fragment,at),UT=l(at),Ze=s(at,"DIV",{class:!0});var Rt=a(Ze);_(ha.$$.fragment,Rt),RT=l(Rt),_n=s(Rt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Pr=s(Qr,"A",{href:!0});var E2=a(Pr);VT=i(E2,"TFT5Model"),E2.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var j2=a(cl);YT=i(j2,"__call__"),j2.forEach(t),ZT=i(Qr," special method."),Qr.forEach(t),JT=l(Rt),_(Zn.$$.fragment,Rt),XT=l(Rt),pl=s(Rt,"P",{});var F2=a(pl);QT=i(F2,"Examples:"),F2.forEach(t),ev=l(Rt),_(ua.$$.fragment,Rt),Rt.forEach(t),at.forEach(t),Cc=l(n),gn=s(n,"H2",{class:!0});var Ep=a(gn);Jn=s(Ep,"A",{id:!0,class:!0,href:!0});var M2=a(Jn);hl=s(M2,"SPAN",{});var P2=a(hl);_(ma.$$.fragment,P2),P2.forEach(t),M2.forEach(t),tv=l(Ep),ul=s(Ep,"SPAN",{});var C2=a(ul);nv=i(C2,"TFT5ForConditionalGeneration"),C2.forEach(t),Ep.forEach(t),Oc=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),ov=l(rt),_a=s(rt,"P",{});var jp=a(_a);sv=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var O2=a(ml);av=i(O2,"language modeling"),O2.forEach(t),rv=i(jp," head on top."),jp.forEach(t),iv=l(rt),ga=s(rt,"P",{});var Fp=a(ga);dv=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var A2=a(Ta);lv=i(A2,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),A2.forEach(t),cv=i(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
