...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,w),e(b,x)},d(T){T&&t(b)}}}function Uz(E){let b,z,v,w,x;return{c(){b=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var B=s(v);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,w),e(b,x)},d(T){T&&t(b)}}}function Xz(E){let b,z,v,w,x;return{c(){b=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var B=s(v);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,w),e(b,x)},d(T){T&&t(b)}}}function Hz(E){let b,z,v,w,x;return{c(){b=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var B=s(v);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,w),e(b,x)},d(T){T&&t(b)}}}function Vz(E){let b,z,v,w,x,T,y,B,rt,Pe,j,Ue,ke,it,be,ye,dt,Ke,J,N,Xe,se,P,A,lt,pe,he,ct,K,pt,ht,D,Ce,ve,Ze,re,Te,Me,ut,ie,we,xe,Ye;return{c(){b=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),rt=r("having all inputs as a list, tuple or dict in the first positional arguments."),Pe=d(),j=n("p"),Ue=r("This second option is useful when using "),ke=n("code"),it=r("tf.keras.Model.fit"),be=r(` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16058/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16058/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L169",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16058/en/model_doc/mbart#transformers.MBartConfig"
...
`}}),en=new st({props:{$$slots:{default:[Rz]},$$scope:{ctx:E}}}),Za=new $({props:{code:`from transformers import MBartTokenizer, MBartModel
import torch
...
`}}),on=new st({props:{$$slots:{default:[Uz]},$$scope:{ctx:E}}}),ss=new $({props:{code:`from transformers import MBartTokenizer, MBartForConditionalGeneration
...
`}}),an=new st({props:{$$slots:{default:[Xz]},$$scope:{ctx:E}}}),us=new $({props:{code:`from transformers import MBartTokenizer, MBartForQuestionAnswering
import torch
...
`}}),rn=new st({props:{$$slots:{default:[Hz]},$$scope:{ctx:E}}}),vs=new $({props:{code:`import torch
...
`}}),pn=new st({props:{$$slots:{default:[Qz]},$$scope:{ctx:E}}}),Ss=new $({props:{code:`from transformers import MBartTokenizer, TFMBartModel
...
`}}),mn=new st({props:{$$slots:{default:[Kz]},$$scope:{ctx:E}}}),Gs=new $({props:{code:`from transformers import MBartTokenizer, TFMBartForConditionalGeneration, MBartConfig
...
`}}),_n=new st({props:{$$slots:{default:[Zz]},$$scope:{ctx:E}}}),er=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),sr=new X({}),rr=new q({props:{name:"class transformers.FlaxMBartForConditionalGeneration",anchor:"transformers.FlaxMBartForConditionalGeneration",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16058/src/transformers/models/mbart/modeling_flax_mbart.py#L1352",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16058/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),kn=new st({props:{$$slots:{default:[Yz]},$$scope:{ctx:E}}}),fr=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartForConditionalGeneration, MBartConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),br=new q({props:{name:"decode",anchor:"transformers.FlaxMBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16058/src/transformers/models/mbart/modeling_flax_mbart.py#L1356",parametersDescription:[{anchor:"transformers.FlaxMBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16058/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16058/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16058/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
`}}),yn=new st({props:{$$slots:{default:[e2]},$$scope:{ctx:E}}}),jr=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartForSequenceClassification
...
`}}),Tn=new st({props:{$$slots:{default:[t2]},$$scope:{ctx:E}}}),Xr=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartForQuestionAnswering
...
refer to this superclass for more information regarding those methods.`),Jh.forEach(t),Bg=l(fe),Ml=a(fe,"P",{});var Yw=s(Ml);$g=i(Yw,"Examples:"),Yw.forEach(t),Fg=l(fe),m(Ia.$$.fragment,fe),jg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);m(Na.$$.fragment,St),Eg=l(St),wl=a(St,"P",{});var e0=s(wl);Pg=i(e0,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),e0.forEach(t),Cg=l(St),Da=a(St,"P",{});var Kh=s(Da);Sg=i(Kh,"An MBART-50 sequence has the following format, where "),xl=a(Kh,"CODE",{});var t0=s(xl);Ag=i(t0,"X"),t0.forEach(t),Og=i(Kh," represents the sequence:"),Kh.forEach(t),Ig=l(St),La=a(St,"UL",{});var Zh=s(La);Ga=a(Zh,"LI",{});var Yh=s(Ga);zl=a(Yh,"CODE",{});var o0=s(zl);Ng=i(o0,"input_ids"),o0.forEach(t),Dg=i(Yh," (for encoder) "),ql=a(Yh,"CODE",{});var n0=s(ql);Lg=i(n0,"[src_lang_code] X [eos]"),n0.forEach(t),Yh.forEach(t),Gg=l(Zh),Wa=a(Zh,"LI",{});var eu=s(Wa);Bl=a(eu,"CODE",{});var a0=s(Bl);Wg=i(a0,"labels"),a0.forEach(t),Rg=i(eu,": (for decoder) "),$l=a(eu,"CODE",{});var s0=s($l);Ug=i(s0,"[tgt_lang_code] X [eos]"),s0.forEach(t),eu.forEach(t),Zh.forEach(t),Xg=l(St),Fl=a(St,"P",{});var r0=s(Fl);Hg=i(r0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),r0.forEach(t),St.forEach(t),Vg=l(fe),Ko=a(fe,"DIV",{class:!0});var tu=s(Ko);m(Ra.$$.fragment,tu),Qg=l(tu),jl=a(tu,"P",{});var i0=s(jl);Jg=i(i0,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),i0.forEach(t),tu.forEach(t),Kg=l(fe),Zo=a(fe,"DIV",{class:!0});var ou=s(Zo);m(Ua.$$.fragment,ou),Zg=l(ou),El=a(ou,"P",{});var d0=s(El);Yg=i(d0,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),d0.forEach(t),ou.forEach(t),fe.forEach(t),Up=l(o),po=a(o,"H2",{class:!0});var nu=s(po);Yo=a(nu,"A",{id:!0,class:!0,href:!0});var l0=s(Yo);Pl=a(l0,"SPAN",{});var c0=s(Pl);m(Xa.$$.fragment,c0),c0.forEach(t),l0.forEach(t),ek=l(nu),Cl=a(nu,"SPAN",{});var p0=s(Cl);tk=i(p0,"MBartModel"),p0.forEach(t),nu.forEach(t),Xp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);m(Ha.$$.fragment,Bn),ok=l(Bn),Va=a(Bn,"P",{});var au=s(Va);nk=i(au,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),rk=l(Bn),Qa=a(Bn,"P",{});var su=s(Qa);ik=i(su,"This model is also a PyTorch "),Ja=a(su,"A",{href:!0,rel:!0});var u0=s(Ja);dk=i(u0,"torch.nn.Module"),u0.forEach(t),lk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),ck=l(Bn),Oe=a(Bn,"DIV",{class:!0});var At=s(Oe);m(Ka.$$.fragment,At),pk=l(At),ho=a(At,"P",{});var Gi=s(ho);hk=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var m0=s(yi);uk=i(m0,"MBartModel"),m0.forEach(t),mk=i(Gi," forward method, overrides the "),Sl=a(Gi,"CODE",{});var f0=s(Sl);fk=i(f0,"__call__"),f0.forEach(t),_k=i(Gi," special method."),Gi.forEach(t),gk=l(At),m(en.$$.fragment,At),kk=l(At),Al=a(At,"P",{});var _0=s(Al);bk=i(_0,"Example:"),_0.forEach(t),yk=l(At),m(Za.$$.fragment,At),At.forEach(t),Bn.forEach(t),Hp=l(o),uo=a(o,"H2",{class:!0});var ru=s(uo);tn=a(ru,"A",{id:!0,class:!0,href:!0});var g0=s(tn);Ol=a(g0,"SPAN",{});var k0=s(Ol);m(Ya.$$.fragment,k0),k0.forEach(t),g0.forEach(t),vk=l(ru),Il=a(ru,"SPAN",{});var b0=s(Il);Tk=i(b0,"MBartForConditionalGeneration"),b0.forEach(t),ru.forEach(t),Vp=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);m(es.$$.fragment,$n),Mk=l($n),ts=a($n,"P",{});var iu=s(ts);wk=i(iu,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),qk=l($n),os=a($n,"P",{});var du=s(os);Bk=i(du,"This model is also a PyTorch "),ns=a(du,"A",{href:!0,rel:!0});var v0=s(ns);$k=i(v0,"torch.nn.Module"),v0.forEach(t),Fk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),jk=l($n),Y=a($n,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Ek=l(Ge),mo=a(Ge,"P",{});var Wi=s(mo);Pk=i(Wi,"The "),Ti=a(Wi,"A",{href:!0});var T0=s(Ti);Ck=i(T0,"MBartForConditionalGeneration"),T0.forEach(t),Sk=i(Wi," forward method, overrides the "),Nl=a(Wi,"CODE",{});var M0=s(Nl);Ak=i(M0,"__call__"),M0.forEach(t),Ok=i(Wi," special method."),Wi.forEach(t),Ik=l(Ge),m(on.$$.fragment,Ge),Nk=l(Ge),Dl=a(Ge,"P",{});var w0=s(Dl);Dk=i(w0,"Translation example:"),w0.forEach(t),Lk=l(Ge),m(ss.$$.fragment,Ge),Gk=l(Ge),Ll=a(Ge,"P",{});var x0=s(Ll);Wk=i(x0,"Mask filling example:"),x0.forEach(t),Rk=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),$n.forEach(t),Qp=l(o),fo=a(o,"H2",{class:!0});var lu=s(fo);nn=a(lu,"A",{id:!0,class:!0,href:!0});var z0=s(nn);Gl=a(z0,"SPAN",{});var q0=s(Gl);m(is.$$.fragment,q0),q0.forEach(t),z0.forEach(t),Uk=l(lu),Wl=a(lu,"SPAN",{});var B0=s(Wl);Xk=i(B0,"MBartForQuestionAnswering"),B0.forEach(t),lu.forEach(t),Jp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);m(ds.$$.fragment,Ot),Hk=l(Ot),_o=a(Ot,"P",{});var Ri=s(_o);Vk=i(Ri,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Rl=a(Ri,"CODE",{});var $0=s(Rl);Qk=i($0,"span start logits"),$0.forEach(t),Jk=i(Ri," and "),Ul=a(Ri,"CODE",{});var F0=s(Ul);Kk=i(F0,"span end logits"),F0.forEach(t),Zk=i(Ri,")."),Ri.forEach(t),Yk=l(Ot),ls=a(Ot,"P",{});var cu=s(ls);eb=i(cu,"This model inherits from "),Mi=a(cu,"A",{href:!0});var j0=s(Mi);tb=i(j0,"PreTrainedModel"),j0.forEach(t),ob=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),nb=l(Ot),cs=a(Ot,"P",{});var pu=s(cs);ab=i(pu,"This model is also a PyTorch "),ps=a(pu,"A",{href:!0,rel:!0});var E0=s(ps);sb=i(E0,"torch.nn.Module"),E0.forEach(t),rb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),ib=l(Ot),ue=a(Ot,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),db=l(at),go=a(at,"P",{});var Ui=s(go);lb=i(Ui,"The "),wi=a(Ui,"A",{href:!0});var P0=s(wi);cb=i(P0,"MBartForQuestionAnswering"),P0.forEach(t),pb=i(Ui," forward method, overrides the "),Xl=a(Ui,"CODE",{});var C0=s(Xl);hb=i(C0,"__call__"),C0.forEach(t),ub=i(Ui," special method."),Ui.forEach(t),mb=l(at),m(an.$$.fragment,at),fb=l(at),Hl=a(at,"P",{});var S0=s(Hl);_b=i(S0,"Example:"),S0.forEach(t),gb=l(at),m(us.$$.fragment,at),kb=l(at),m(ms.$$.fragment,at),at.forEach(t),Ot.forEach(t),Kp=l(o),ko=a(o,"H2",{class:!0});var hu=s(ko);sn=a(hu,"A",{id:!0,class:!0,href:!0});var A0=s(sn);Vl=a(A0,"SPAN",{});var O0=s(Vl);m(fs.$$.fragment,O0),O0.forEach(t),A0.forEach(t),bb=l(hu),Ql=a(hu,"SPAN",{});var I0=s(Ql);yb=i(I0,"MBartForSequenceClassification"),I0.forEach(t),hu.forEach(t),Zp=l(o),Fe=a(o,"DIV",{class:!0});var It=s(Fe);m(_s.$$.fragment,It),vb=l(It),Jl=a(It,"P",{});var N0=s(Jl);Tb=i(N0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),N0.forEach(t),Mb=l(It),gs=a(It,"P",{});var uu=s(gs);wb=i(uu,"This model inherits from "),xi=a(uu,"A",{href:!0});var D0=s(xi);xb=i(D0,"PreTrainedModel"),D0.forEach(t),zb=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),qb=l(It),ks=a(It,"P",{});var mu=s(ks);Bb=i(mu,"This model is also a PyTorch "),bs=a(mu,"A",{href:!0,rel:!0});var L0=s(bs);$b=i(L0,"torch.nn.Module"),L0.forEach(t),Fb=i(mu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mu.forEach(t),jb=l(It),L=a(It,"DIV",{class:!0});var oe=s(L);m(ys.$$.fragment,oe),Eb=l(oe),bo=a(oe,"P",{});var Xi=s(bo);Pb=i(Xi,"The "),zi=a(Xi,"A",{href:!0});var G0=s(zi);Cb=i(G0,"MBartForSequenceClassification"),G0.forEach(t),Sb=i(Xi," forward method, overrides the "),Kl=a(Xi,"CODE",{});var W0=s(Kl);Ab=i(W0,"__call__"),W0.forEach(t),Ob=i(Xi," special method."),Xi.forEach(t),Ib=l(oe),m(rn.$$.fragment,oe),Nb=l(oe),Zl=a(oe,"P",{});var R0=s(Zl);Db=i(R0,"Example of single-label classification:"),R0.forEach(t),Lb=l(oe),m(vs.$$.fragment,oe),Gb=l(oe),m(Ts.$$.fragment,oe),Wb=l(oe),Yl=a(oe,"P",{});var U0=s(Yl);Rb=i(U0,"Example of multi-label classification:"),U0.forEach(t),Ub=l(oe),m(Ms.$$.fragment,oe),Xb=l(oe),m(ws.$$.fragment,oe),oe.forEach(t),It.forEach(t),Yp=l(o),yo=a(o,"H2",{class:!0});var fu=s(yo);dn=a(fu,"A",{id:!0,class:!0,href:!0});var X0=s(dn);ec=a(X0,"SPAN",{});var H0=s(ec);m(xs.$$.fragment,H0),H0.forEach(t),X0.forEach(t),Hb=l(fu),tc=a(fu,"SPAN",{});var V0=s(tc);Vb=i(V0,"MBartForCausalLM"),V0.forEach(t),fu.forEach(t),eh=l(o),vo=a(o,"DIV",{class:!0});var _u=s(vo);m(zs.$$.fragment,_u),Qb=l(_u),Mt=a(_u,"DIV",{class:!0});var Hi=s(Mt);m(qs.$$.fragment,Hi),Jb=l(Hi),oc=a(Hi,"P",{});var Q0=s(oc);Kb=i(Q0,"Example:"),Q0.forEach(t),Zb=l(Hi),m(Bs.$$.fragment,Hi),Hi.forEach(t),_u.forEach(t),th=l(o),To=a(o,"H2",{class:!0});var gu=s(To);ln=a(gu,"A",{id:!0,class:!0,href:!0});var J0=s(ln);nc=a(J0,"SPAN",{});var K0=s(nc);m($s.$$.fragment,K0),K0.forEach(t),J0.forEach(t),Yb=l(gu),ac=a(gu,"SPAN",{});var Z0=s(ac);ey=i(Z0,"TFMBartModel"),Z0.forEach(t),gu.forEach(t),oh=l(o),je=a(o,"DIV",{class:!0});var Nt=s(je);m(Fs.$$.fragment,Nt),ty=l(Nt),js=a(Nt,"P",{});var ku=s(js);oy=i(ku,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),sy=l(Nt),Es=a(Nt,"P",{});var bu=s(Es);ry=i(bu,"This model is also a "),Ps=a(bu,"A",{href:!0,rel:!0});var ex=s(Ps);iy=i(ex,"tf.keras.Model"),ex.forEach(t),dy=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),ly=l(Nt),m(cn.$$.fragment,Nt),cy=l(Nt),Ie=a(Nt,"DIV",{class:!0});var Dt=s(Ie);m(Cs.$$.fragment,Dt),py=l(Dt),Mo=a(Dt,"P",{});var Vi=s(Mo);hy=i(Vi,"The "),Bi=a(Vi,"A",{href:!0});var tx=s(Bi);uy=i(tx,"TFMBartModel"),tx.forEach(t),my=i(Vi," forward method, overrides the "),sc=a(Vi,"CODE",{});var ox=s(sc);fy=i(ox,"__call__"),ox.forEach(t),_y=i(Vi," special method."),Vi.forEach(t),gy=l(Dt),m(pn.$$.fragment,Dt),ky=l(Dt),rc=a(Dt,"P",{});var nx=s(rc);by=i(nx,"Example:"),nx.forEach(t),yy=l(Dt),m(Ss.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),nh=l(o),wo=a(o,"H2",{class:!0});var yu=s(wo);hn=a(yu,"A",{id:!0,class:!0,href:!0});var ax=s(hn);ic=a(ax,"SPAN",{});var sx=s(ic);m(As.$$.fragment,sx),sx.forEach(t),ax.forEach(t),vy=l(yu),dc=a(yu,"SPAN",{});var rx=s(dc);Ty=i(rx,"TFMBartForConditionalGeneration"),rx.forEach(t),yu.forEach(t),ah=l(o),Ee=a(o,"DIV",{class:!0});var Lt=s(Ee);m(Os.$$.fragment,Lt),My=l(Lt),Is=a(Lt,"P",{});var vu=s(Is);wy=i(vu,`The MBART Model with a language modeling head. Can be used for summarization.
