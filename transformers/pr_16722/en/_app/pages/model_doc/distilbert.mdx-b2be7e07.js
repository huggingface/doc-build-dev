...
<a href="/docs/transformers/pr_16722/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new re({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),rn=new be({}),an=new H({props:{name:"class transformers.DistilBertTokenizer",anchor:"transformers.DistilBertTokenizer",parameters:[{name:"vocab_file",val:""},{name:"do_lower_case",val:" = True"},{name:"do_basic_tokenize",val:" = True"},{name:"never_split",val:" = None"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16722/src/transformers/models/distilbert/tokenization_distilbert.py#L56"}}),dn=new be({}),cn=new H({props:{name:"class transformers.DistilBertTokenizerFast",anchor:"transformers.DistilBertTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16722/src/transformers/models/distilbert/tokenization_distilbert_fast.py#L65"}}),un=new be({}),mn=new H({props:{name:"class transformers.DistilBertModel",anchor:"transformers.DistilBertModel",parameters:[{name:"config",val:": PretrainedConfig"}],source:"https://github.com/huggingface/transformers/blob/pr_16722/src/transformers/models/distilbert/modeling_distilbert.py#L457",parametersDescription:[{anchor:"transformers.DistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16722/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16722/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new H({props:{name:"forward",anchor:"transformers.DistilBertModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16722/src/transformers/models/distilbert/modeling_distilbert.py#L529",parametersDescription:[{anchor:"transformers.DistilBertModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16722/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_16722/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16722/en/model_doc/distilbert#transformers.DistilBertConfig"
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yk=l(),nc=o("p"),Zk=a("Finally, this model supports inherent JAX features such as:"),e2=l(),Pt=o("ul"),rc=o("li"),va=o("a"),t2=a("Just-In-Time (JIT) compilation"),s2=l(),ac=o("li"),ba=o("a"),o2=a("Automatic Differentiation"),n2=l(),ic=o("li"),ka=o("a"),r2=a("Vectorization"),a2=l(),lc=o("li"),Ta=o("a"),i2=a("Parallelization"),l2=l(),at=o("div"),b(wa.$$.fragment),d2=l(),Ls=o("p"),c2=a("The "),dc=o("code"),p2=a("FlaxDistilBertPreTrainedModel"),h2=a(" forward method, overrides the "),cc=o("code"),u2=a("__call__"),m2=a(" special method."),f2=l(),b(qo.$$.fragment),g2=l(),pc=o("p"),_2=a("Example:"),v2=l(),b(ya.$$.fragment),oh=l(),Ss=o("h2"),Po=o("a"),hc=o("span"),b($a.$$.fragment),b2=l(),uc=o("span"),k2=a("FlaxDistilBertForSequenceClassification"),nh=l(),xe=o("div"),b(Fa.$$.fragment),T2=l(),mc=o("p"),w2=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),y2=l(),Da=o("p"),$2=a("This model inherits from "),el=o("a"),F2=a("FlaxPreTrainedModel"),D2=a(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),z2=l(),fc=o("p"),j2=a("Finally, this model supports inherent JAX features such as:"),C2=l(),At=o("ul"),gc=o("li"),Ea=o("a"),q2=a("Just-In-Time (JIT) compilation"),P2=l(),_c=o("li"),xa=o("a"),A2=a("Automatic Differentiation"),O2=l(),vc=o("li"),za=o("a"),N2=a("Vectorization"),L2=l(),bc=o("li"),ja=o("a"),S2=a("Parallelization"),I2=l(),it=o("div"),b(Ca.$$.fragment),W2=l(),Is=o("p"),R2=a("The "),kc=o("code"),U2=a("FlaxDistilBertPreTrainedModel"),Q2=a(" forward method, overrides the "),Tc=o("code"),H2=a("__call__"),V2=a(" special method."),K2=l(),b(Ao.$$.fragment),J2=l(),wc=o("p"),G2=a("Example:"),X2=l(),b(qa.$$.fragment),rh=l(),Ws=o("h2"),Oo=o("a"),yc=o("span"),b(Pa.$$.fragment),Y2=l(),$c=o("span"),Z2=a("FlaxDistilBertForMultipleChoice"),ah=l(),ze=o("div"),b(Aa.$$.fragment),eT=l(),Fc=o("p"),tT=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),rf=d(Ht),Ie=n(Ht,"DIV",{class:!0});var kt=r(Ie);k(Dn.$$.fragment,kt),af=d(kt),us=n(kt,"P",{});var al=r(us);lf=i(al,"The "),zi=n(al,"A",{href:!0});var q1=r(zi);df=i(q1,"DistilBertForMaskedLM"),q1.forEach(t),cf=i(al," forward method, overrides the "),Rl=n(al,"CODE",{});var P1=r(Rl);pf=i(P1,"__call__"),P1.forEach(t),hf=i(al," special method."),al.forEach(t),uf=d(kt),k(oo.$$.fragment,kt),mf=d(kt),Ul=n(kt,"P",{});var A1=r(Ul);ff=i(A1,"Example:"),A1.forEach(t),gf=d(kt),k(Bn.$$.fragment,kt),_f=d(kt),k(Mn.$$.fragment,kt),kt.forEach(t),Ht.forEach(t),Cp=d(s),ms=n(s,"H2",{class:!0});var Fh=r(ms);no=n(Fh,"A",{id:!0,class:!0,href:!0});var O1=r(no);Ql=n(O1,"SPAN",{});var N1=r(Ql);k(En.$$.fragment,N1),N1.forEach(t),O1.forEach(t),vf=d(Fh),Hl=n(Fh,"SPAN",{});var L1=r(Hl);bf=i(L1,"DistilBertForSequenceClassification"),L1.forEach(t),Fh.forEach(t),qp=d(s),Xe=n(s,"DIV",{class:!0});var Vt=r(Xe);k(xn.$$.fragment,Vt),kf=d(Vt),Vl=n(Vt,"P",{});var S1=r(Vl);Tf=i(S1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Yk=d(ht),nc=n(ht,"P",{});var H$=r(nc);Zk=i(H$,"Finally, this model supports inherent JAX features such as:"),H$.forEach(t),e2=d(ht),Pt=n(ht,"UL",{});var Vo=r(Pt);rc=n(Vo,"LI",{});var V$=r(rc);va=n(V$,"A",{href:!0,rel:!0});var K$=r(va);t2=i(K$,"Just-In-Time (JIT) compilation"),K$.forEach(t),V$.forEach(t),s2=d(Vo),ac=n(Vo,"LI",{});var J$=r(ac);ba=n(J$,"A",{href:!0,rel:!0});var G$=r(ba);o2=i(G$,"Automatic Differentiation"),G$.forEach(t),J$.forEach(t),n2=d(Vo),ic=n(Vo,"LI",{});var X$=r(ic);ka=n(X$,"A",{href:!0,rel:!0});var Y$=r(ka);r2=i(Y$,"Vectorization"),Y$.forEach(t),X$.forEach(t),a2=d(Vo),lc=n(Vo,"LI",{});var Z$=r(lc);Ta=n(Z$,"A",{href:!0,rel:!0});var eF=r(Ta);i2=i(eF,"Parallelization"),eF.forEach(t),Z$.forEach(t),Vo.forEach(t),l2=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);k(wa.$$.fragment,ts),d2=d(ts),Ls=n(ts,"P",{});var kl=r(Ls);c2=i(kl,"The "),dc=n(kl,"CODE",{});var tF=r(dc);p2=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),h2=i(kl," forward method, overrides the "),cc=n(kl,"CODE",{});var sF=r(cc);u2=i(sF,"__call__"),sF.forEach(t),m2=i(kl," special method."),kl.forEach(t),f2=d(ts),k(qo.$$.fragment,ts),g2=d(ts),pc=n(ts,"P",{});var oF=r(pc);_2=i(oF,"Example:"),oF.forEach(t),v2=d(ts),k(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ss=n(s,"H2",{class:!0});var du=r(Ss);Po=n(du,"A",{id:!0,class:!0,href:!0});var nF=r(Po);hc=n(nF,"SPAN",{});var rF=r(hc);k($a.$$.fragment,rF),rF.forEach(t),nF.forEach(t),b2=d(du),uc=n(du,"SPAN",{});var aF=r(uc);k2=i(aF,"FlaxDistilBertForSequenceClassification"),aF.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);k(Fa.$$.fragment,ut),T2=d(ut),mc=n(ut,"P",{});var iF=r(mc);w2=i(iF,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),iF.forEach(t),y2=d(ut),Da=n(ut,"P",{});var cu=r(Da);$2=i(cu,"This model inherits from "),el=n(cu,"A",{href:!0});var lF=r(el);F2=i(lF,"FlaxPreTrainedModel"),lF.forEach(t),D2=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),cu.forEach(t),B2=d(ut),Ba=n(ut,"P",{});var pu=r(Ba);M2=i(pu,"This model is also a Flax Linen "),Ma=n(pu,"A",{href:!0,rel:!0});var dF=r(Ma);E2=i(dF,"flax.linen.Module"),dF.forEach(t),x2=i(pu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),z2=d(ut),fc=n(ut,"P",{});var cF=r(fc);j2=i(cF,"Finally, this model supports inherent JAX features such as:"),cF.forEach(t),C2=d(ut),At=n(ut,"UL",{});var Ko=r(At);gc=n(Ko,"LI",{});var pF=r(gc);Ea=n(pF,"A",{href:!0,rel:!0});var hF=r(Ea);q2=i(hF,"Just-In-Time (JIT) compilation"),hF.forEach(t),pF.forEach(t),P2=d(Ko),_c=n(Ko,"LI",{});var uF=r(_c);xa=n(uF,"A",{href:!0,rel:!0});var mF=r(xa);A2=i(mF,"Automatic Differentiation"),mF.forEach(t),uF.forEach(t),O2=d(Ko),vc=n(Ko,"LI",{});var fF=r(vc);za=n(fF,"A",{href:!0,rel:!0});var gF=r(za);N2=i(gF,"Vectorization"),gF.forEach(t),fF.forEach(t),L2=d(Ko),bc=n(Ko,"LI",{});var _F=r(bc);ja=n(_F,"A",{href:!0,rel:!0});var vF=r(ja);S2=i(vF,"Parallelization"),vF.forEach(t),_F.forEach(t),Ko.forEach(t),I2=d(ut),it=n(ut,"DIV",{class:!0});var ss=r(it);k(Ca.$$.fragment,ss),W2=d(ss),Is=n(ss,"P",{});var Tl=r(Is);R2=i(Tl,"The "),kc=n(Tl,"CODE",{});var bF=r(kc);U2=i(bF,"FlaxDistilBertPreTrainedModel"),bF.forEach(t),Q2=i(Tl," forward method, overrides the "),Tc=n(Tl,"CODE",{});var kF=r(Tc);H2=i(kF,"__call__"),kF.forEach(t),V2=i(Tl," special method."),Tl.forEach(t),K2=d(ss),k(Ao.$$.fragment,ss),J2=d(ss),wc=n(ss,"P",{});var TF=r(wc);G2=i(TF,"Example:"),TF.forEach(t),X2=d(ss),k(qa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),rh=d(s),Ws=n(s,"H2",{class:!0});var hu=r(Ws);Oo=n(hu,"A",{id:!0,class:!0,href:!0});var wF=r(Oo);yc=n(wF,"SPAN",{});var yF=r(yc);k(Pa.$$.fragment,yF),yF.forEach(t),wF.forEach(t),Y2=d(hu),$c=n(hu,"SPAN",{});var $F=r($c);Z2=i($F,"FlaxDistilBertForMultipleChoice"),$F.forEach(t),hu.forEach(t),ah=d(s),ze=n(s,"DIV",{class:!0});var mt=r(ze);k(Aa.$$.fragment,mt),eT=d(mt),Fc=n(mt,"P",{});var FF=r(Fc);tT=i(FF,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
