import{S as mm,i as fm,s as um,e as a,k as d,w,t as n,M as gm,c as s,d as t,m as c,a as r,x as b,h as i,b as l,F as e,g as f,y,q as $,o as x,B as V}from"../../chunks/vendor-4833417e.js";import{T as _e}from"../../chunks/Tip-fffd6df1.js";import{D as W}from"../../chunks/Docstring-4f315ed9.js";import{C as Vt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as ve}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function _m(I){let h,v,m,g,T;return{c(){h=a("p"),v=n(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var F=r(m);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var F=r(m);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,h,u),e(h,v),e(h,m),e(m,g),e(h,T)},d(_){_&&t(h)}}}function ym(I){let h,v,m,g,T,_,u,F,he,R,k,ie,j,U,oe,C,pe,ae;return{c(){h=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),m=d(),g=a("ul"),T=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),F=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=n("This second option is useful when using "),j=a("code"),U=n("tf.keras.Model.fit"),oe=n(` method which currently requires having all the
...
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=r(C);pe=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,M){f(E,h,M),e(h,v),f(E,m,M),f(E,g,M),e(g,T),e(T,_),e(g,u),e(g,F),e(F,he),f(E,R,M),f(E,k,M),e(k,ie),e(k,j),e(j,U),e(k,oe),e(k,C),e(C,pe),e(k,ae)},d(E){E&&t(h),E&&t(m),E&&t(g),E&&t(R),E&&t(k)}}}function $m(I){let h,v,m,g,T;return{c(){h=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var F=r(m);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,h,u),e(h,v),e(h,m),e(m,g),e(h,T)},d(_){_&&t(h)}}}function xm(I){let h,v,m,g,T,_,u,F,he,R,k,ie,j,U,oe,C,pe,ae;return{c(){h=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),m=d(),g=a("ul"),T=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),F=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=n("This second option is useful when using "),j=a("code"),U=n("tf.keras.Model.fit"),oe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),C=a("code"),pe=n("model(inputs)"),ae=n(".")},l(E){h=s(E,"P",{});var M=r(h);v=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),m=c(E),g=s(E,"UL",{});var z=r(g);T=s(z,"LI",{});var Me=r(T);_=i(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),u=c(z),F=s(z,"LI",{});var se=r(F);he=i(se,"having all inputs as a list, tuple or dict in the first positional arguments."),se.forEach(t),z.forEach(t),R=c(E),k=s(E,"P",{});var L=r(k);ie=i(L,"This second option is useful when using "),j=s(L,"CODE",{});var je=r(j);U=i(je,"tf.keras.Model.fit"),je.forEach(t),oe=i(L,` method which currently requires having all the
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=r(C);pe=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,M){f(E,h,M),e(h,v),f(E,m,M),f(E,g,M),e(g,T),e(T,_),e(g,u),e(g,F),e(F,he),f(E,R,M),f(E,k,M),e(k,ie),e(k,j),e(j,U),e(k,oe),e(k,C),e(C,pe),e(k,ae)},d(E){E&&t(h),E&&t(m),E&&t(g),E&&t(R),E&&t(k)}}}function Vm(I){let h,v,m,g,T;return{c(){h=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var F=r(m);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,h,u),e(h,v),e(h,m),e(m,g),e(h,T)},d(_){_&&t(h)}}}function Fm(I){let h,v,m,g,T;return{c(){h=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var F=r(m);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var F=r(m);g=i(F,"Module"),F.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){f(_,h,u),e(h,v),e(h,m),e(m,g),e(h,T)},d(_){_&&t(h)}}}function km(I){let h,v,m,g,T,_,u,F,he,R,k,ie,j,U,oe,C,pe,ae,E,M,z,Me,se,L,je,Te,Xo,en,sr,Zo,Da,tn,rr,Qo,on,nr,N,Ft,an,Et,sn,rn,nn,Oa,ln,dn,kt,cn,Yo,hn,pn,mn,Pe,fn,Sa,un,gn,It,_n,vn,Tn,Ce,wn,Mt,bn,yn,jt,$n,xn,Vn,Ae,Fn,Pt,En,kn,Ct,In,Mn,jn,Wa,Pn,ir,ea,Cn,lr,le,Ua,P,ta,An,qn,oa,zn,Nn,aa,Ln,Dn,Ba,On,Sn,Ra,Wn,Un,Ha,Bn,Rn,Ja,Hn,Jn,sa,Kn,Gn,Xn,Ka,ra,na,Zn,Qn,Yn,Ga,At,ei,qt,ti,oi,ai,Xa,ia,la,si,ri,dr,we,ni,zt,ii,li,Nt,di,ci,cr,et,hi,Lt,pi,mi,hr,qe,tt,Za,Dt,fi,Qa,ui,pr,B,Ot,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Vi,ha,Fi,Ei,ki,Ya,Ii,Mi,Wt,mr,Le,ot,es,Ut,ji,ts,Pi,fr,re,Bt,Ci,os,Ai,qi,Rt,zi,pa,Ni,Li,Di,be,Ht,Oi,as,Si,Wi,at,ur,De,st,ss,Jt,Ui,rs,Bi,gr,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,ns,el,tl,ol,rt,al,is,sl,rl,Qt,_r,Se,nt,ls,Yt,nl,ds,il,vr,fe,eo,ll,We,dl,cs,cl,hl,to,pl,ml,fl,J,oo,ul,Ue,gl,fa,_l,vl,hs,Tl,wl,bl,it,yl,ps,$l,xl,ao,Tr,Be,lt,ms,so,Vl,fs,Fl,wr,ne,ro,El,us,kl,Il,no,Ml,io,jl,Pl,Cl,K,lo,Al,Re,ql,ua,zl,Nl,gs,Ll,Dl,Ol,dt,Sl,_s,Wl,Ul,co,br,He,ct,vs,ho,Bl,Ts,Rl,yr,D,po,Hl,ws,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,ht,ad,G,go,sd,Je,rd,_a,nd,id,bs,ld,dd,cd,pt,hd,ys,pd,md,_o,$r,Ke,mt,$s,vo,fd,xs,ud,xr,O,To,gd,Vs,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Vd,Fd,ft,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,Fs,Pd,Cd,Ad,ut,qd,Es,zd,Nd,xo,Vr,Xe,gt,ks,Vo,Ld,Is,Dd,Fr,A,Fo,Od,Ms,Sd,Wd,Eo,Ud,wa,Bd,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,js,Zd,Qd,ue,Ps,Mo,Yd,ec,Cs,jo,tc,oc,As,Po,ac,sc,qs,Co,rc,nc,Z,Ao,ic,Ze,lc,zs,dc,cc,Ns,hc,pc,mc,_t,fc,Ls,uc,gc,qo,Er,Qe,vt,Ds,zo,_c,Os,vc,kr,q,No,Tc,Ss,wc,bc,Lo,yc,ba,$c,xc,Vc,Do,Fc,Oo,Ec,kc,Ic,Ws,Mc,jc,ge,Us,So,Pc,Cc,Bs,Wo,Ac,qc,Rs,Uo,zc,Nc,Hs,Bo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Js,Wc,Uc,Ks,Bc,Rc,Hc,Tt,Jc,Gs,Kc,Gc,Ho,Ir;return _=new ve({}),k=new _e({props:{$$slots:{default:[_m]},$$scope:{ctx:I}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16049/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16049/en/model_doc/vit#transformers.ViTConfig"
...
`}}),rt=new _e({props:{$$slots:{default:[Tm]},$$scope:{ctx:I}}}),Qt=new Vt({props:{code:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">197</span>, <span class="hljs-number">768</span>]`}}),Yt=new ve({}),eo=new W({props:{name:"class transformers.ViTForMaskedImageModeling",anchor:"transformers.ViTForMaskedImageModeling",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16049/src/transformers/models/vit/modeling_vit.py#L592",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16049/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16049/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oo=new W({props:{name:"forward",anchor:"transformers.ViTForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"interpolate_pos_encoding",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16049/src/transformers/models/vit/modeling_vit.py#L606",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16049/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),so=new ve({}),ro=new W({props:{name:"class transformers.ViTForImageClassification",anchor:"transformers.ViTForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16049/src/transformers/models/vit/modeling_vit.py#L702",parametersDescription:[{anchor:"transformers.ViTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16049/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16049/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new W({props:{name:"forward",anchor:"transformers.ViTForImageClassification.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"interpolate_pos_encoding",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16049/src/transformers/models/vit/modeling_vit.py#L715",parametersDescription:[{anchor:"transformers.ViTForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16049/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_16049/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16049/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16049/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_16049/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){h=a("meta"),v=d(),m=a("h1"),g=a("a"),T=a("span"),w(_.$$.fragment),u=d(),F=a("span"),he=n("Vision Transformer (ViT)"),R=d(),w(k.$$.fragment),ie=d(),j=a("h2"),U=a("a"),oe=a("span"),w(C.$$.fragment),pe=d(),ae=a("span"),E=n("Overview"),M=d(),z=a("p"),Me=n("The Vision Transformer (ViT) model was proposed in "),se=a("a"),L=n(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
go to him!`),hr=d(),qe=a("h2"),tt=a("a"),Za=a("span"),w(Dt.$$.fragment),fi=d(),Qa=a("span"),ui=n("ViTConfig"),pr=d(),B=a("div"),w(Ot.$$.fragment),gi=d(),ze=a("p"),_i=n("This is the configuration class to store the configuration of a "),da=a("a"),vi=n("ViTModel"),Ti=n(`. It is used to instantiate an ViT
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fl=d(),J=a("div"),w(oo.$$.fragment),ul=d(),Ue=a("p"),gl=n("The "),fa=a("a"),_l=n("ViTForMaskedImageModeling"),vl=n(" forward method, overrides the "),hs=a("code"),Tl=n("__call__"),wl=n(" special method."),bl=d(),w(it.$$.fragment),yl=d(),ps=a("p"),$l=n("Examples:"),xl=d(),w(ao.$$.fragment),Tr=d(),Be=a("h2"),lt=a("a"),ms=a("span"),w(so.$$.fragment),Vl=d(),fs=a("span"),Fl=n("ViTForImageClassification"),wr=d(),ne=a("div"),w(ro.$$.fragment),El=d(),us=a("p"),kl=n(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Il=d(),no=a("p"),Ml=n("This model is a PyTorch "),io=a("a"),jl=n("torch.nn.Module"),Pl=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cl=d(),K=a("div"),w(lo.$$.fragment),Al=d(),Re=a("p"),ql=n("The "),ua=a("a"),zl=n("ViTForImageClassification"),Nl=n(" forward method, overrides the "),gs=a("code"),Ll=n("__call__"),Dl=n(" special method."),Ol=d(),w(dt.$$.fragment),Sl=d(),_s=a("p"),Wl=n("Example:"),Ul=d(),w(co.$$.fragment),br=d(),He=a("h2"),ct=a("a"),vs=a("span"),w(ho.$$.fragment),Bl=d(),Ts=a("span"),Rl=n("TFViTModel"),yr=d(),D=a("div"),w(po.$$.fragment),Hl=d(),ws=a("p"),Jl=n("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Kl=d(),mo=a("p"),Gl=n("This model inherits from "),ga=a("a"),Xl=n("TFPreTrainedModel"),Zl=n(`. Check the superclass documentation for the generic methods the
...
behavior.`),od=d(),w(ht.$$.fragment),ad=d(),G=a("div"),w(go.$$.fragment),sd=d(),Je=a("p"),rd=n("The "),_a=a("a"),nd=n("TFViTModel"),id=n(" forward method, overrides the "),bs=a("code"),ld=n("__call__"),dd=n(" special method."),cd=d(),w(pt.$$.fragment),hd=d(),ys=a("p"),pd=n("Examples:"),md=d(),w(_o.$$.fragment),$r=d(),Ke=a("h2"),mt=a("a"),$s=a("span"),w(vo.$$.fragment),fd=d(),xs=a("span"),ud=n("TFViTForImageClassification"),xr=d(),O=a("div"),w(To.$$.fragment),gd=d(),Vs=a("p"),_d=n(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fd=d(),w(ft.$$.fragment),Ed=d(),X=a("div"),w($o.$$.fragment),kd=d(),Ge=a("p"),Id=n("The "),Ta=a("a"),Md=n("TFViTForImageClassification"),jd=n(" forward method, overrides the "),Fs=a("code"),Pd=n("__call__"),Cd=n(" special method."),Ad=d(),w(ut.$$.fragment),qd=d(),Es=a("p"),zd=n("Examples:"),Nd=d(),w(xo.$$.fragment),Vr=d(),Xe=a("h2"),gt=a("a"),ks=a("span"),w(Vo.$$.fragment),Ld=d(),Is=a("span"),Dd=n("FlaxVitModel"),Fr=d(),A=a("div"),w(Fo.$$.fragment),Od=d(),Ms=a("p"),Sd=n("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Ud=n("This model inherits from "),wa=a("a"),Bd=n("FlaxPreTrainedModel"),Rd=n(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),js=a("p"),Zd=n("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Ps=a("li"),Mo=a("a"),Yd=n("Just-In-Time (JIT) compilation"),ec=d(),Cs=a("li"),jo=a("a"),tc=n("Automatic Differentiation"),oc=d(),As=a("li"),Po=a("a"),ac=n("Vectorization"),sc=d(),qs=a("li"),Co=a("a"),rc=n("Parallelization"),nc=d(),Z=a("div"),w(Ao.$$.fragment),ic=d(),Ze=a("p"),lc=n("The "),zs=a("code"),dc=n("FlaxViTPreTrainedModel"),cc=n("forward method, overrides the "),Ns=a("code"),hc=n("__call__"),pc=n(" special method."),mc=d(),w(_t.$$.fragment),fc=d(),Ls=a("p"),uc=n("Examples:"),gc=d(),w(qo.$$.fragment),Er=d(),Qe=a("h2"),vt=a("a"),Ds=a("span"),w(zo.$$.fragment),_c=d(),Os=a("span"),vc=n("FlaxViTForImageClassification"),kr=d(),q=a("div"),w(No.$$.fragment),Tc=d(),Ss=a("p"),wc=n(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
found `),Nt=s(Va,"A",{href:!0,rel:!0});var kh=r(Nt);di=i(kh,"here"),kh.forEach(t),ci=i(Va,"."),Va.forEach(t),cr=c(o),et=s(o,"P",{});var Cr=r(et);hi=i(Cr,"Note that we converted the weights from Ross Wightman\u2019s "),Lt=s(Cr,"A",{href:!0,rel:!0});var Ih=r(Lt);pi=i(Ih,"timm library"),Ih.forEach(t),mi=i(Cr,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),Cr.forEach(t),hr=c(o),qe=s(o,"H2",{class:!0});var Ar=r(qe);tt=s(Ar,"A",{id:!0,class:!0,href:!0});var Mh=r(tt);Za=s(Mh,"SPAN",{});var jh=r(Za);b(Dt.$$.fragment,jh),jh.forEach(t),Mh.forEach(t),fi=c(Ar),Qa=s(Ar,"SPAN",{});var Ph=r(Qa);ui=i(Ph,"ViTConfig"),Ph.forEach(t),Ar.forEach(t),pr=c(o),B=s(o,"DIV",{class:!0});var ye=r(B);b(Ot.$$.fragment,ye),gi=c(ye),ze=s(ye,"P",{});var Fa=r(ze);_i=i(Fa,"This is the configuration class to store the configuration of a "),da=s(Fa,"A",{href:!0});var Ch=r(da);vi=i(Ch,"ViTModel"),Ch.forEach(t),Ti=i(Fa,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pa.forEach(t),fl=c(ja),J=s(ja,"DIV",{class:!0});var xe=r(J);b(oo.$$.fragment,xe),ul=c(xe),Ue=s(xe,"P",{});var Ca=r(Ue);gl=i(Ca,"The "),fa=s(Ca,"A",{href:!0});var op=r(fa);_l=i(op,"ViTForMaskedImageModeling"),op.forEach(t),vl=i(Ca," forward method, overrides the "),hs=s(Ca,"CODE",{});var ap=r(hs);Tl=i(ap,"__call__"),ap.forEach(t),wl=i(Ca," special method."),Ca.forEach(t),bl=c(xe),b(it.$$.fragment,xe),yl=c(xe),ps=s(xe,"P",{});var sp=r(ps);$l=i(sp,"Examples:"),sp.forEach(t),xl=c(xe),b(ao.$$.fragment,xe),xe.forEach(t),ja.forEach(t),Tr=c(o),Be=s(o,"H2",{class:!0});var Or=r(Be);lt=s(Or,"A",{id:!0,class:!0,href:!0});var rp=r(lt);ms=s(rp,"SPAN",{});var np=r(ms);b(so.$$.fragment,np),np.forEach(t),rp.forEach(t),Vl=c(Or),fs=s(Or,"SPAN",{});var ip=r(fs);Fl=i(ip,"ViTForImageClassification"),ip.forEach(t),Or.forEach(t),wr=c(o),ne=s(o,"DIV",{class:!0});var yt=r(ne);b(ro.$$.fragment,yt),El=c(yt),us=s(yt,"P",{});var lp=r(us);kl=i(lp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
