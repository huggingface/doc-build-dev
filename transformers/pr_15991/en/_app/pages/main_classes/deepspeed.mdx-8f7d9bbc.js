...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/deepspeed.py#L114"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/deepspeed.py#L105"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/deepspeed.py#L146"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/deepspeed.py#L137"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),ks=o("h2"),$t=o("a"),hf=o("span"),f(po.$$.fragment),T$=u(),ff=o("span"),A$=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),Ps=o("h3"),kt=o("a"),df=o("span"),f(io.$$.fragment),S$=u(),mf=o("span"),C$=a("Installation"),rg=u(),Xp=o("p"),x$=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R$=a("or via "),_f=o("code"),I$=a("transformers"),U$=a("\u2019 "),vf=o("code"),G$=a("extras"),L$=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M$=a("or find more details on "),ho=o("a"),Z$=a("the DeepSpeed\u2019s GitHub page"),N$=a(` and
...
`),bo=o("a"),x4=a("Deepspeed"),R4=a(","),Cg=u(),li=o("a"),xg=u(),Ds=o("h3"),St=o("a"),Of=o("span"),f(Eo.$$.fragment),I4=u(),Tf=o("span"),U4=a("Deployment with multiple GPUs"),Rg=u(),Ct=o("p"),G4=a("To deploy this feature with multiple GPUs adjust the "),ri=o("a"),L4=a("Trainer"),M4=a(` command line arguments as
following:`),Ig=u(),xt=o("ol"),zs=o("li"),Z4=a("replace "),Af=o("code"),N4=a("python -m torch.distributed.launch"),H4=a(" with "),Sf=o("code"),B4=a("deepspeed"),W4=a("."),F4=u(),De=o("li"),V4=a("add a new argument "),Cf=o("code"),Y4=a("--deepspeed ds_config.json"),K4=a(", where "),xf=o("code"),J4=a("ds_config.json"),X4=a(` is the DeepSpeed configuration file as
documented `),qo=o("a"),Q4=a("here"),e6=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s6=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t6=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a6=a("Unlike, "),Rf=o("code"),n6=a("torch.distributed.launch"),o6=a(" where you have to specify how many GPUs to use with "),If=o("code"),l6=a("--nproc_per_node"),r6=a(`, with the
`),Uf=o("code"),p6=a("deepspeed"),i6=a(" launcher you don\u2019t have to use the corresponding "),Gf=o("code"),u6=a("--num_gpus"),c6=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=o("a"),h6=a("here"),f6=a("."),Ng=u(),ne=o("p"),d6=a("In fact, you can continue using "),Lf=o("code"),m6=a("-m torch.distributed.launch"),_6=a(` with DeepSpeed as long as you don\u2019t need to use
`),Mf=o("code"),v6=a("deepspeed"),j6=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Zf=o("code"),g6=a("deepspeed"),w6=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Hg=u(),Rt=o("p"),y6=a("Here is an example of running "),Nf=o("code"),b6=a("run_translation.py"),E6=a(" under DeepSpeed deploying all available GPUs:"),Bg=u(),f(Do.$$.fragment),Wg=u(),It=o("p"),q6=a("Note that in the DeepSpeed documentation you are likely to see "),Hf=o("code"),$6=a("--deepspeed --deepspeed_config ds_config.json"),k6=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Fg=u(),Ut=o("p"),P6=a("For some practical usage examples, please, see this "),zo=o("a"),D6=a("post"),z6=a("."),Vg=u(),ui=o("a"),Yg=u(),Os=o("h3"),Gt=o("a"),Bf=o("span"),f(Oo.$$.fragment),O6=u(),Wf=o("span"),T6=a("Deployment with one GPU"),Kg=u(),Lt=o("p"),A6=a("To deploy DeepSpeed with one GPU adjust the "),ci=o("a"),S6=a("Trainer"),C6=a(" command line arguments as follows:"),Jg=u(),f(To.$$.fragment),Xg=u(),Ge=o("p"),x6=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Ff=o("code"),R6=a("--num_gpus=1"),I6=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=o("a"),U6=a("documentation"),G6=a(" discusses the launcher options."),Qg=u(),hi=o("p"),L6=a("Why would you want to use DeepSpeed with just one GPU?"),ew=u(),Mt=o("ol"),Vf=o("li"),M6=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),Z6=u(),Yf=o("li"),N6=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),sw=u(),fi=o("p"),H6=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),tw=u(),f(So.$$.fragment),aw=u(),di=o("p"),B6=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),nw=u(),Zt=o("p"),W6=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F6=a("post"),V6=a("."),ow=u(),mi=o("p"),Y6=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),lw=u(),_i=o("p"),K6=a("Notes:"),rw=u(),vi=o("ul"),Ts=o("li"),xo=o("p"),J6=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=o("code"),X6=a("CUDA_VISIBLE_DEVICES"),Q6=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),e9=u(),f(Ro.$$.fragment),s9=u(),Jf=o("p"),t9=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),pw=u(),ji=o("a"),iw=u(),As=o("h3"),Nt=o("a"),Xf=o("span"),f(Io.$$.fragment),a9=u(),Qf=o("span"),n9=a("Deployment in Notebooks"),uw=u(),Ht=o("p"),o9=a("The problem with running notebook cells as a script is that there is no normal "),ed=o("code"),l9=a("deepspeed"),r9=a(` launcher to rely on, so
...
completes.`),Ew=u(),Ei=o("a"),qw=u(),Ss=o("h3"),Vt=o("a"),ld=o("span"),f(Zo.$$.fragment),k9=u(),rd=o("span"),P9=a("Configuration"),$w=u(),Yt=o("p"),D9=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
...
to the console, so you can see exactly what was the final configuration passed to it.`),xw=u(),ki=o("a"),Rw=u(),Cs=o("h3"),ea=o("a"),hd=o("span"),f(Yo.$$.fragment),J9=u(),fd=o("span"),X9=a("Passing Configuration"),Iw=u(),G=o("p"),Q9=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
the file system before passing it to `),zi=o("a"),p8=a("TrainingArguments"),i8=a("."),Uw=u(),Oi=o("p"),u8=a("To summarize you can do:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("p"),c8=a("or:"),Mw=u(),f(Jo.$$.fragment),Zw=u(),Ai=o("a"),Nw=u(),xs=o("h3"),sa=o("a"),_d=o("span"),f(Xo.$$.fragment),h8=u(),vd=o("span"),f8=a("Shared Configuration"),Hw=u(),f(ta.$$.fragment),Bw=u(),Me=o("p"),d8=a("Some configuration values are required by both the "),Si=o("a"),m8=a("Trainer"),_8=a(` and DeepSpeed to function correctly,
...
`),Li=o("a"),G8=a("Trainer"),L8=a(" during "),yd=o("code"),M8=a("train"),Z8=a(", but you can of course do the math yourself."),Xw=u(),Mi=o("a"),Qw=u(),Rs=o("h3"),la=o("a"),bd=o("span"),f(el.$$.fragment),N8=u(),Ed=o("span"),H8=a("ZeRO"),ey=u(),sl=o("p"),tl=o("a"),B8=a("Zero Redundancy Optimizer (ZeRO)"),W8=a(` is the workhorse of DeepSpeed. It
...
going to use.`),ny=u(),Hi=o("a"),oy=u(),Is=o("h4"),pa=o("a"),$d=o("span"),f(nl.$$.fragment),tk=u(),kd=o("span"),ak=a("ZeRO-2 Config"),ly=u(),Bi=o("p"),nk=a("The following is an example of configuration for ZeRO stage 2:"),ry=u(),f(ol.$$.fragment),py=u(),Wi=o("p"),Pd=o("strong"),ok=a("Performance tuning:"),iy=u(),He=o("ul"),Us=o("li"),lk=a("enabling "),Dd=o("code"),rk=a("offload_optimizer"),pk=a(" should reduce GPU RAM usage (it requires "),zd=o("code"),ik=a('"stage": 2'),uk=a(")"),ck=u(),L=o("li"),Od=o("code"),hk=a('"overlap_comm": true'),fk=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Td=o("code"),dk=a("overlap_comm"),mk=a(` uses 4.5x
...
`),bo=l(mE,"A",{href:!0,rel:!0});var OL=r(bo);x4=n(OL,"Deepspeed"),OL.forEach(t),R4=n(mE,","),mE.forEach(t),Cg=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),xg=c(e),Ds=l(e,"H3",{class:!0});var _E=r(Ds);St=l(_E,"A",{id:!0,class:!0,href:!0});var TL=r(St);Of=l(TL,"SPAN",{});var AL=r(Of);d(Eo.$$.fragment,AL),AL.forEach(t),TL.forEach(t),I4=c(_E),Tf=l(_E,"SPAN",{});var SL=r(Tf);U4=n(SL,"Deployment with multiple GPUs"),SL.forEach(t),_E.forEach(t),Rg=c(e),Ct=l(e,"P",{});var vE=r(Ct);G4=n(vE,"To deploy this feature with multiple GPUs adjust the "),ri=l(vE,"A",{href:!0});var CL=r(ri);L4=n(CL,"Trainer"),CL.forEach(t),M4=n(vE,` command line arguments as
following:`),vE.forEach(t),Ig=c(e),xt=l(e,"OL",{});var jE=r(xt);zs=l(jE,"LI",{});var fh=r(zs);Z4=n(fh,"replace "),Af=l(fh,"CODE",{});var xL=r(Af);N4=n(xL,"python -m torch.distributed.launch"),xL.forEach(t),H4=n(fh," with "),Sf=l(fh,"CODE",{});var RL=r(Sf);B4=n(RL,"deepspeed"),RL.forEach(t),W4=n(fh,"."),fh.forEach(t),F4=c(jE),De=l(jE,"LI",{});var Mn=r(De);V4=n(Mn,"add a new argument "),Cf=l(Mn,"CODE",{});var IL=r(Cf);Y4=n(IL,"--deepspeed ds_config.json"),IL.forEach(t),K4=n(Mn,", where "),xf=l(Mn,"CODE",{});var UL=r(xf);J4=n(UL,"ds_config.json"),UL.forEach(t),X4=n(Mn,` is the DeepSpeed configuration file as
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var GL=r(qo);Q4=n(GL,"here"),GL.forEach(t),e6=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var LL=r(pi);s6=n(LL,"Therefore, if your original command line looked as follows:"),LL.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ML=r(ii);t6=n(ML,"Now it should be:"),ML.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var we=r(U);a6=n(we,"Unlike, "),Rf=l(we,"CODE",{});var ZL=r(Rf);n6=n(ZL,"torch.distributed.launch"),ZL.forEach(t),o6=n(we," where you have to specify how many GPUs to use with "),If=l(we,"CODE",{});var NL=r(If);l6=n(NL,"--nproc_per_node"),NL.forEach(t),r6=n(we,`, with the
`),Uf=l(we,"CODE",{});var HL=r(Uf);p6=n(HL,"deepspeed"),HL.forEach(t),i6=n(we," launcher you don\u2019t have to use the corresponding "),Gf=l(we,"CODE",{});var BL=r(Gf);u6=n(BL,"--num_gpus"),BL.forEach(t),c6=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=l(we,"A",{href:!0,rel:!0});var WL=r(Po);h6=n(WL,"here"),WL.forEach(t),f6=n(we,"."),we.forEach(t),Ng=c(e),ne=l(e,"P",{});var Zn=r(ne);d6=n(Zn,"In fact, you can continue using "),Lf=l(Zn,"CODE",{});var FL=r(Lf);m6=n(FL,"-m torch.distributed.launch"),FL.forEach(t),_6=n(Zn,` with DeepSpeed as long as you don\u2019t need to use
`),Mf=l(Zn,"CODE",{});var VL=r(Mf);v6=n(VL,"deepspeed"),VL.forEach(t),j6=n(Zn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Zf=l(Zn,"CODE",{});var YL=r(Zf);g6=n(YL,"deepspeed"),YL.forEach(t),w6=n(Zn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Zn.forEach(t),Hg=c(e),Rt=l(e,"P",{});var gE=r(Rt);y6=n(gE,"Here is an example of running "),Nf=l(gE,"CODE",{});var KL=r(Nf);b6=n(KL,"run_translation.py"),KL.forEach(t),E6=n(gE," under DeepSpeed deploying all available GPUs:"),gE.forEach(t),Bg=c(e),d(Do.$$.fragment,e),Wg=c(e),It=l(e,"P",{});var wE=r(It);q6=n(wE,"Note that in the DeepSpeed documentation you are likely to see "),Hf=l(wE,"CODE",{});var JL=r(Hf);$6=n(JL,"--deepspeed --deepspeed_config ds_config.json"),JL.forEach(t),k6=n(wE,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),wE.forEach(t),Fg=c(e),Ut=l(e,"P",{});var yE=r(Ut);P6=n(yE,"For some practical usage examples, please, see this "),zo=l(yE,"A",{href:!0,rel:!0});var XL=r(zo);D6=n(XL,"post"),XL.forEach(t),z6=n(yE,"."),yE.forEach(t),Vg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Yg=c(e),Os=l(e,"H3",{class:!0});var bE=r(Os);Gt=l(bE,"A",{id:!0,class:!0,href:!0});var QL=r(Gt);Bf=l(QL,"SPAN",{});var eM=r(Bf);d(Oo.$$.fragment,eM),eM.forEach(t),QL.forEach(t),O6=c(bE),Wf=l(bE,"SPAN",{});var sM=r(Wf);T6=n(sM,"Deployment with one GPU"),sM.forEach(t),bE.forEach(t),Kg=c(e),Lt=l(e,"P",{});var EE=r(Lt);A6=n(EE,"To deploy DeepSpeed with one GPU adjust the "),ci=l(EE,"A",{href:!0});var tM=r(ci);S6=n(tM,"Trainer"),tM.forEach(t),C6=n(EE," command line arguments as follows:"),EE.forEach(t),Jg=c(e),d(To.$$.fragment,e),Xg=c(e),Ge=l(e,"P",{});var dh=r(Ge);x6=n(dh,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Ff=l(dh,"CODE",{});var aM=r(Ff);R6=n(aM,"--num_gpus=1"),aM.forEach(t),I6=n(dh,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=l(dh,"A",{href:!0,rel:!0});var nM=r(Ao);U6=n(nM,"documentation"),nM.forEach(t),G6=n(dh," discusses the launcher options."),dh.forEach(t),Qg=c(e),hi=l(e,"P",{});var oM=r(hi);L6=n(oM,"Why would you want to use DeepSpeed with just one GPU?"),oM.forEach(t),ew=c(e),Mt=l(e,"OL",{});var qE=r(Mt);Vf=l(qE,"LI",{});var lM=r(Vf);M6=n(lM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),lM.forEach(t),Z6=c(qE),Yf=l(qE,"LI",{});var rM=r(Yf);N6=n(rM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),rM.forEach(t),qE.forEach(t),sw=c(e),fi=l(e,"P",{});var pM=r(fi);H6=n(pM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),pM.forEach(t),tw=c(e),d(So.$$.fragment,e),aw=c(e),di=l(e,"P",{});var iM=r(di);B6=n(iM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),iM.forEach(t),nw=c(e),Zt=l(e,"P",{});var $E=r(Zt);W6=n($E,"For a practical usage example of this type of deployment, please, see this "),Co=l($E,"A",{href:!0,rel:!0});var uM=r(Co);F6=n(uM,"post"),uM.forEach(t),V6=n($E,"."),$E.forEach(t),ow=c(e),mi=l(e,"P",{});var cM=r(mi);Y6=n(cM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),cM.forEach(t),lw=c(e),_i=l(e,"P",{});var hM=r(_i);K6=n(hM,"Notes:"),hM.forEach(t),rw=c(e),vi=l(e,"UL",{});var fM=r(vi);Ts=l(fM,"LI",{});var mh=r(Ts);xo=l(mh,"P",{});var kE=r(xo);J6=n(kE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=l(kE,"CODE",{});var dM=r(Kf);X6=n(dM,"CUDA_VISIBLE_DEVICES"),dM.forEach(t),Q6=n(kE,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),kE.forEach(t),e9=c(mh),d(Ro.$$.fragment,mh),s9=c(mh),Jf=l(mh,"P",{});var mM=r(Jf);t9=n(mM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),mM.forEach(t),mh.forEach(t),fM.forEach(t),pw=c(e),ji=l(e,"A",{id:!0}),r(ji).forEach(t),iw=c(e),As=l(e,"H3",{class:!0});var PE=r(As);Nt=l(PE,"A",{id:!0,class:!0,href:!0});var _M=r(Nt);Xf=l(_M,"SPAN",{});var vM=r(Xf);d(Io.$$.fragment,vM),vM.forEach(t),_M.forEach(t),a9=c(PE),Qf=l(PE,"SPAN",{});var jM=r(Qf);n9=n(jM,"Deployment in Notebooks"),jM.forEach(t),PE.forEach(t),uw=c(e),Ht=l(e,"P",{});var DE=r(Ht);o9=n(DE,"The problem with running notebook cells as a script is that there is no normal "),ed=l(DE,"CODE",{});var gM=r(ed);l9=n(gM,"deepspeed"),gM.forEach(t),r9=n(DE,` launcher to rely on, so
