import{S as dn,i as cn,s as hn,e as r,k as d,w as v,t as s,M as pn,c as a,d as o,m as c,a as n,x as T,h as i,b as l,N as mn,F as e,g as m,y as w,q as P,o as b,B as D,v as fn}from"../../chunks/vendor-6b77c823.js";import{T as _o}from"../../chunks/Tip-39098574.js";import{D as ee}from"../../chunks/Docstring-abef54e3.js";import{C as vo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ge}from"../../chunks/IconCopyLink-7a11ce68.js";function un(S){let p,y;return{c(){p=r("p"),y=s(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
PIL images.`),u.forEach(o)},m(f,u){m(f,p,u),e(p,y)},d(f){f&&o(p)}}}function gn(S){let p,y,f,u,$;return{c(){p=r("p"),y=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),u=s("Module"),$=s(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(g,_){m(g,p,_),e(p,y),e(p,f),e(f,u),e(p,$)},d(g){g&&o(p)}}}function _n(S){let p,y,f,u,$;return{c(){p=r("p"),y=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),u=s("Module"),$=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var _=n(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var E=n(f);u=i(E,"Module"),E.forEach(o),$=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(g,_){m(g,p,_),e(p,y),e(p,f),e(f,u),e(p,$)},d(g){g&&o(p)}}}function vn(S){let p,y,f,u,$;return{c(){p=r("p"),y=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r("code"),u=s("Module"),$=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=a(g,"P",{});var _=n(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(_,"CODE",{});var E=n(f);u=i(E,"Module"),E.forEach(o),$=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(g,_){m(g,p,_),e(p,y),e(p,f),e(f,u),e(p,$)},d(g){g&&o(p)}}}function Tn(S){let p,y,f,u,$,g,_,E,To,Ot,U,te,ft,ge,wo,ut,Po,Wt,q,bo,_e,Do,yo,Ye,$o,xo,Ut,Je,Eo,Bt,Xe,gt,ko,Rt,oe,ma,Ht,re,Fo,ve,Io,jo,Kt,A,zo,Te,Co,Mo,we,So,qo,Gt,B,ae,_t,Pe,Ao,vt,Lo,Yt,x,be,No,R,Vo,Ze,Oo,Wo,De,Uo,Bo,Ro,H,Ho,Qe,Ko,Go,et,Yo,Jo,Xo,Tt,Zo,Qo,ye,Jt,K,ne,wt,$e,er,Pt,tr,Xt,j,xe,or,bt,rr,ar,Ee,nr,tt,sr,ir,lr,L,ke,dr,Dt,cr,hr,se,Zt,G,ie,yt,Fe,pr,$t,mr,Qt,M,Ie,fr,je,ur,ze,gr,_r,vr,k,Ce,Tr,Y,wr,ot,Pr,br,xt,Dr,yr,$r,le,xr,Et,Er,kr,Me,eo,J,de,kt,Se,Fr,Ft,Ir,to,z,qe,jr,It,zr,Cr,Ae,Mr,Le,Sr,qr,Ar,F,Ne,Lr,X,Nr,rt,Vr,Or,jt,Wr,Ur,Br,ce,Rr,zt,Hr,Kr,Ve,oo,Z,he,Ct,Oe,Gr,Mt,Yr,ro,C,We,Jr,St,Xr,Zr,Ue,Qr,Be,ea,ta,oa,I,Re,ra,Q,aa,at,na,sa,qt,ia,la,da,pe,ca,At,ha,pa,He,ao;return g=new Ge({}),ge=new Ge({}),Pe=new Ge({}),be=new ee({props:{name:"class transformers.DPTConfig",anchor:"transformers.DPTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 384"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"backbone_out_indices",val:" = [2, 5, 8, 11]"},{name:"readout_type",val:" = 'project'"},{name:"reassemble_factors",val:" = [4, 2, 1, 0.5]"},{name:"neck_hidden_sizes",val:" = [96, 192, 384, 768]"},{name:"fusion_hidden_size",val:" = 256"},{name:"head_in_index",val:" = -1"},{name:"use_batch_norm_in_fusion_residual",val:" = False"},{name:"use_auxiliary_head",val:" = True"},{name:"auxiliary_loss_weight",val:" = 0.4"},{name:"semantic_loss_ignore_index",val:" = 255"},{name:"semantic_classifier_dropout",val:" = 0.1"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/dpt/configuration_dpt.py#L29",parametersDescription:[{anchor:"transformers.DPTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=r("meta"),y=d(),f=r("h1"),u=r("a"),$=r("span"),v(g.$$.fragment),_=d(),E=r("span"),To=s("DPT"),Ot=d(),U=r("h2"),te=r("a"),ft=r("span"),v(ge.$$.fragment),wo=d(),ut=r("span"),Po=s("Overview"),Wt=d(),q=r("p"),bo=s("The DPT model was proposed in "),_e=r("a"),Do=s("Vision Transformers for Dense Prediction"),yo=s(` by Ren\xE9 Ranftl, Alexey Bochkovskiy, Vladlen Koltun.
DPT is a model that leverages the `),Ye=r("a"),$o=s("Vision Transformer (ViT)"),xo=s(" as backbone for dense prediction tasks like semantic segmentation and depth estimation."),Ut=d(),Je=r("p"),Eo=s("The abstract from the paper is the following:"),Bt=d(),Xe=r("p"),gt=r("em"),ko=s("We introduce dense vision transformers, an architecture that leverages vision transformers in place of convolutional networks as a backbone for dense prediction tasks. We assemble tokens from various stages of the vision transformer into image-like representations at various resolutions and progressively combine them into full-resolution predictions using a convolutional decoder. The transformer backbone processes representations at a constant and relatively high resolution and has a global receptive field at every stage. These properties allow the dense vision transformer to provide finer-grained and more globally coherent predictions when compared to fully-convolutional networks. Our experiments show that this architecture yields substantial improvements on dense prediction tasks, especially when a large amount of training data is available. For monocular depth estimation, we observe an improvement of up to 28% in relative performance when compared to a state-of-the-art fully-convolutional network. When applied to semantic segmentation, dense vision transformers set a new state of the art on ADE20K with 49.02% mIoU. We further show that the architecture can be fine-tuned on smaller datasets such as NYUv2, KITTI, and Pascal Context where it also sets the new state of the art."),Rt=d(),oe=r("img"),Ht=d(),re=r("small"),Fo=s("DPT architecture. Taken from the "),ve=r("a"),Io=s("original paper"),jo=s("."),Kt=d(),A=r("p"),zo=s("This model was contributed by "),Te=r("a"),Co=s("nielsr"),Mo=s(". The original code can be found "),we=r("a"),So=s("here"),qo=s("."),Gt=d(),B=r("h2"),ae=r("a"),_t=r("span"),v(Pe.$$.fragment),Ao=d(),vt=r("span"),Lo=s("DPTConfig"),Yt=d(),x=r("div"),v(be.$$.fragment),No=d(),R=r("p"),Vo=s("This is the configuration class to store the configuration of a "),Ze=r("a"),Oo=s("DPTModel"),Wo=s(`. It is used to instantiate an DPT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the DPT
`),De=r("a"),Uo=s("Intel/dpt-large"),Bo=s(" architecture."),Ro=d(),H=r("p"),Ho=s("Configuration objects inherit from "),Qe=r("a"),Ko=s("PretrainedConfig"),Go=s(` and can be used to control the model outputs. Read the
...
should refer to this superclass for more information regarding those methods.`),lr=d(),L=r("div"),v(ke.$$.fragment),dr=d(),Dt=r("p"),cr=s("Main method to prepare for the model one or several image(s)."),hr=d(),v(se.$$.fragment),Zt=d(),G=r("h2"),ie=r("a"),yt=r("span"),v(Fe.$$.fragment),pr=d(),$t=r("span"),mr=s("DPTModel"),Qt=d(),M=r("div"),v(Ie.$$.fragment),fr=d(),je=r("p"),ur=s(`The bare DPT Model transformer outputting raw hidden-states without any specific head on top.
