...
model.parallelize(device_map)`}}),Us=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[yw]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/t5/modeling_tf_t5.py#L1357",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15991/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[xw]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/t5/modeling_tf_t5.py#L1688",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
...
adding special tokens. A sequence has the following format:`),mb.forEach(t),zf=l(Vr),is=s(Vr,"UL",{});var op=a(is);vr=s(op,"LI",{});var Kk=a(vr);$f=i(Kk,"single sequence: "),kd=s(Kk,"CODE",{});var fb=a(kd);qf=i(fb,"X </s>"),fb.forEach(t),Kk.forEach(t),Ef=l(op),kr=s(op,"LI",{});var Yk=a(kr);jf=i(Yk,"pair of sequences: "),bd=s(Yk,"CODE",{});var _b=a(bd);Ff=i(_b,"A </s> B </s>"),_b.forEach(t),Yk.forEach(t),op.forEach(t),Vr.forEach(t),Mf=l(st),Nn=s(st,"DIV",{class:!0});var sp=a(Nn);_(ds.$$.fragment,sp),Pf=l(sp),ls=s(sp,"P",{});var ap=a(ls);Cf=i(ap,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),yd=s(ap,"CODE",{});var gb=a(yd);Of=i(gb,"prepare_for_model"),gb.forEach(t),Af=i(ap," method."),ap.forEach(t),sp.forEach(t),Lf=l(st),Dn=s(st,"DIV",{class:!0});var rp=a(Dn);_(cs.$$.fragment,rp),If=l(rp),wd=s(rp,"P",{});var Tb=a(wd);Nf=i(Tb,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Tb.forEach(t),rp.forEach(t),Df=l(st),br=s(st,"DIV",{class:!0});var vb=a(br);_(ps.$$.fragment,vb),vb.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);Sn=s(ip,"A",{id:!0,class:!0,href:!0});var kb=a(Sn);xd=s(kb,"SPAN",{});var bb=a(xd);_(hs.$$.fragment,bb),bb.forEach(t),kb.forEach(t),Sf=l(ip),zd=s(ip,"SPAN",{});var yb=a(zd);Gf=i(yb,"T5TokenizerFast"),yb.forEach(t),ip.forEach(t),xc=l(n),De=s(n,"DIV",{class:!0});var Nt=a(De);_(us.$$.fragment,Nt),Bf=l(Nt),dn=s(Nt,"P",{});var Kr=a(dn);Wf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),$d=s(Kr,"EM",{});var wb=a($d);Uf=i(wb,"tokenizers"),wb.forEach(t),Rf=i(Kr,` library). Based on
`),ms=s(Kr,"A",{href:!0,rel:!0});var xb=a(ms);Hf=i(xb,"Unigram"),xb.forEach(t),Vf=i(Kr,"."),Kr.forEach(t),Kf=l(Nt),fs=s(Nt,"P",{});var dp=a(fs);Yf=i(dp,"This tokenizer inherits from "),yr=s(dp,"A",{href:!0});var zb=a(yr);Zf=i(zb,"PreTrainedTokenizerFast"),zb.forEach(t),Jf=i(dp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),dp.forEach(t),Xf=l(Nt),Ft=s(Nt,"DIV",{class:!0});var Yr=a(Ft);_(_s.$$.fragment,Yr),Qf=l(Yr),qd=s(Yr,"P",{});var $b=a(qd);e_=i($b,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),$b.forEach(t),t_=l(Yr),gs=s(Yr,"UL",{});var lp=a(gs);wr=s(lp,"LI",{});var Zk=a(wr);n_=i(Zk,"single sequence: "),Ed=s(Zk,"CODE",{});var qb=a(Ed);o_=i(qb,"X </s>"),qb.forEach(t),Zk.forEach(t),s_=l(lp),xr=s(lp,"LI",{});var Jk=a(xr);a_=i(Jk,"pair of sequences: "),jd=s(Jk,"CODE",{});var Eb=a(jd);r_=i(Eb,"A </s> B </s>"),Eb.forEach(t),Jk.forEach(t),lp.forEach(t),Yr.forEach(t),i_=l(Nt),Gn=s(Nt,"DIV",{class:!0});var cp=a(Gn);_(Ts.$$.fragment,cp),d_=l(cp),Fd=s(cp,"P",{});var jb=a(Fd);l_=i(jb,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),jb.forEach(t),cp.forEach(t),Nt.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Bn=s(pp,"A",{id:!0,class:!0,href:!0});var Fb=a(Bn);Md=s(Fb,"SPAN",{});var Mb=a(Md);_(vs.$$.fragment,Mb),Mb.forEach(t),Fb.forEach(t),c_=l(pp),Pd=s(pp,"SPAN",{});var Pb=a(Pd);p_=i(Pb,"T5Model"),Pb.forEach(t),pp.forEach(t),$c=l(n),J=s(n,"DIV",{class:!0});var xe=a(J);_(ks.$$.fragment,xe),h_=l(xe),Cd=s(xe,"P",{});var Cb=a(Cd);u_=i(Cb,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Cb.forEach(t),m_=l(xe),bs=s(xe,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var Ob=a(ys);__=i(Ob,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ob.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l(xe),ws=s(xe,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var Ab=a(zr);k_=i(Ab,"PreTrainedModel"),Ab.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),$_=l(xe),Ue=s(xe,"DIV",{class:!0});var Dt=a(Ue);_($s.$$.fragment,Dt),q_=l(Dt),cn=s(Dt,"P",{});var Zr=a(cn);E_=i(Zr,"The "),$r=s(Zr,"A",{href:!0});var Ib=a($r);j_=i(Ib,"T5Model"),Ib.forEach(t),F_=i(Zr," forward method, overrides the "),Od=s(Zr,"CODE",{});var Nb=a(Od);M_=i(Nb,"__call__"),Nb.forEach(t),P_=i(Zr," special method."),Zr.forEach(t),C_=l(Dt),_(Wn.$$.fragment,Dt),O_=l(Dt),Ad=s(Dt,"P",{});var Db=a(Ad);A_=i(Db,"Example:"),Db.forEach(t),L_=l(Dt),_(qs.$$.fragment,Dt),Dt.forEach(t),I_=l(xe),Re=s(xe,"DIV",{class:!0});var St=a(Re);_(Es.$$.fragment,St),N_=l(St),Ld=s(St,"P",{});var Sb=a(Ld);D_=i(Sb,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Sb.forEach(t),S_=l(St),Id=s(St,"P",{});var Gb=a(Id);G_=i(Gb,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Gb.forEach(t),B_=l(St),Nd=s(St,"P",{});var Bb=a(Nd);W_=i(Bb,"Example:"),Bb.forEach(t),U_=l(St),_(js.$$.fragment,St),St.forEach(t),R_=l(xe),vt=s(xe,"DIV",{class:!0});var uo=a(vt);_(Fs.$$.fragment,uo),H_=l(uo),Dd=s(uo,"P",{});var Wb=a(Dd);V_=i(Wb,"Moves the model to cpu from a model parallel state."),Wb.forEach(t),K_=l(uo),Sd=s(uo,"P",{});var Ub=a(Sd);Y_=i(Ub,"Example:"),Ub.forEach(t),Z_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),xe.forEach(t),qc=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Un=s(fp,"A",{id:!0,class:!0,href:!0});var Rb=a(Un);Gd=s(Rb,"SPAN",{});var Hb=a(Gd);_(Ps.$$.fragment,Hb),Hb.forEach(t),Rb.forEach(t),J_=l(fp),Bd=s(fp,"SPAN",{});var Vb=a(Bd);X_=i(Vb,"T5ForConditionalGeneration"),Vb.forEach(t),fp.forEach(t),Ec=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),Os=s(ze,"P",{});var _p=a(Os);eg=i(_p,"T5 Model with a "),Wd=s(_p,"CODE",{});var Kb=a(Wd);tg=i(Kb,"language modeling"),Kb.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),As=s(ze,"P",{});var gp=a(As);sg=i(gp,"The T5 model was proposed in "),Ls=s(gp,"A",{href:!0,rel:!0});var Yb=a(Ls);ag=i(Yb,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Yb.forEach(t),rg=i(gp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),gp.forEach(t),ig=l(ze),Is=s(ze,"P",{});var Tp=a(Is);dg=i(Tp,"This model inherits from "),qr=s(Tp,"A",{href:!0});var Zb=a(qr);lg=i(Zb,"PreTrainedModel"),Zb.forEach(t),cg=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l(ze),Ns=s(ze,"P",{});var vp=a(Ns);hg=i(vp,"This model is also a PyTorch "),Ds=s(vp,"A",{href:!0,rel:!0});var Jb=a(Ds);ug=i(Jb,"torch.nn.Module"),Jb.forEach(t),mg=i(vp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
