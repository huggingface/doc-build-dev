...
<a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification">DistilBertForSequenceClassification</a>.`,name:"seq_classif_dropout"}]}}),nn=new re({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),lr=new be({}),dr=new Q({props:{name:"class transformers.TFDistilBertModel",anchor:"transformers.TFDistilBertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L523",parametersDescription:[{anchor:"transformers.TFDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new ge({props:{$$slots:{default:[PF]},$$scope:{ctx:j}}}),ur=new Q({props:{name:"call",anchor:"transformers.TFDistilBertModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L528",parametersDescription:[{anchor:"transformers.TFDistilBertModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),mr=new be({}),gr=new Q({props:{name:"class transformers.TFDistilBertForMaskedLM",anchor:"transformers.TFDistilBertForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L611",parametersDescription:[{anchor:"transformers.TFDistilBertForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),_o=new ge({props:{$$slots:{default:[AF]},$$scope:{ctx:j}}}),Tr=new Q({props:{name:"call",anchor:"transformers.TFDistilBertForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L631",parametersDescription:[{anchor:"transformers.TFDistilBertForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),jr=new be({}),Cr=new Q({props:{name:"class transformers.TFDistilBertForMultipleChoice",anchor:"transformers.TFDistilBertForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L867",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yo=new ge({props:{$$slots:{default:[LF]},$$scope:{ctx:j}}}),Or=new Q({props:{name:"call",anchor:"transformers.TFDistilBertForMultipleChoice.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L893",parametersDescription:[{anchor:"transformers.TFDistilBertForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ir=new be({}),Lr=new Q({props:{name:"class transformers.TFDistilBertForTokenClassification",anchor:"transformers.TFDistilBertForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L790",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Fo=new ge({props:{$$slots:{default:[WF]},$$scope:{ctx:j}}}),Ur=new Q({props:{name:"call",anchor:"transformers.TFDistilBertForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L801",parametersDescription:[{anchor:"transformers.TFDistilBertForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),Kr=new be({}),Vr=new Q({props:{name:"class transformers.TFDistilBertForQuestionAnswering",anchor:"transformers.TFDistilBertForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L993",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Eo=new ge({props:{$$slots:{default:[UF]},$$scope:{ctx:j}}}),Yr=new Q({props:{name:"call",anchor:"transformers.TFDistilBertForQuestionAnswering.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"start_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"end_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1004",parametersDescription:[{anchor:"transformers.TFDistilBertForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15991/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wa=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15991/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ti=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15991/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15991/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hi=new Q({props:{name:"__call__",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15991/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15991/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15991/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"},{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.attention_mask",description:`<strong>attention_mask</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),X_=d($t),k(_o.$$.fragment,$t),Y_=d($t),Ue=n($t,"DIV",{class:!0});var Dt=r(Ue);k(Tr.$$.fragment,Dt),Z_=d(Dt),Fs=n(Dt,"P",{});var ul=r(Fs);e1=i(ul,"The "),Ri=n(ul,"A",{href:!0});var A$=r(Ri);t1=i(A$,"TFDistilBertForMaskedLM"),A$.forEach(t),s1=i(ul," forward method, overrides the "),Td=n(ul,"CODE",{});var O$=r(Td);o1=i(O$,"__call__"),O$.forEach(t),n1=i(ul," special method."),ul.forEach(t),r1=d(Dt),k(vo.$$.fragment,Dt),a1=d(Dt),wd=n(Dt,"P",{});var N$=r(wd);i1=i(N$,"Example:"),N$.forEach(t),l1=d(Dt),k(wr.$$.fragment,Dt),d1=d(Dt),k(yr.$$.fragment,Dt),Dt.forEach(t),$t.forEach(t),Hp=d(s),Bs=n(s,"H2",{class:!0});var Uh=r(Bs);bo=n(Uh,"A",{id:!0,class:!0,href:!0});var I$=r(bo);yd=n(I$,"SPAN",{});var L$=r(yd);k($r.$$.fragment,L$),L$.forEach(t),I$.forEach(t),c1=d(Uh),$d=n(Uh,"SPAN",{});var S$=r($d);p1=i(S$,"TFDistilBertForSequenceClassification"),S$.forEach(t),Uh.forEach(t),Qp=d(s),Oe=n(s,"DIV",{class:!0});var Ft=r(Oe);k(Dr.$$.fragment,Ft),h1=d(Ft),Dd=n(Ft,"P",{});var W$=r(Dd);u1=i(W$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),W$.forEach(t),f1=d(Ft),Fr=n(Ft,"P",{});var Hh=r(Fr);m1=i(Hh,"This model inherits from "),Ui=n(Hh,"A",{href:!0});var R$=r(Ui);g1=i(R$,"TFPreTrainedModel"),R$.forEach(t),_1=i(Hh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh.forEach(t),v1=d(Ft),Br=n(Ft,"P",{});var Qh=r(Br);b1=i(Qh,"This model is also a "),Mr=n(Qh,"A",{href:!0,rel:!0});var U$=r(Mr);k1=i(U$,"tf.keras.Model"),U$.forEach(t),T1=i(Qh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qh.forEach(t),w1=d(Ft),k(ko.$$.fragment,Ft),y1=d(Ft),He=n(Ft,"DIV",{class:!0});var Bt=r(He);k(Er.$$.fragment,Bt),$1=d(Bt),Ms=n(Bt,"P",{});var fl=r(Ms);D1=i(fl,"The "),Hi=n(fl,"A",{href:!0});var H$=r(Hi);F1=i(H$,"TFDistilBertForSequenceClassification"),H$.forEach(t),B1=i(fl," forward method, overrides the "),Fd=n(fl,"CODE",{});var Q$=r(Fd);M1=i(Q$,"__call__"),Q$.forEach(t),E1=i(fl," special method."),fl.forEach(t),x1=d(Bt),k(To.$$.fragment,Bt),z1=d(Bt),Bd=n(Bt,"P",{});var K$=r(Bd);j1=i(K$,"Example:"),K$.forEach(t),C1=d(Bt),k(xr.$$.fragment,Bt),P1=d(Bt),k(zr.$$.fragment,Bt),Bt.forEach(t),Ft.forEach(t),Kp=d(s),Es=n(s,"H2",{class:!0});var Kh=r(Es);wo=n(Kh,"A",{id:!0,class:!0,href:!0});var V$=r(wo);Md=n(V$,"SPAN",{});var J$=r(Md);k(jr.$$.fragment,J$),J$.forEach(t),V$.forEach(t),q1=d(Kh),Ed=n(Kh,"SPAN",{});var G$=r(Ed);A1=i(G$,"TFDistilBertForMultipleChoice"),G$.forEach(t),Kh.forEach(t),Vp=d(s),Ne=n(s,"DIV",{class:!0});var Mt=r(Ne);k(Cr.$$.fragment,Mt),O1=d(Mt),xd=n(Mt,"P",{});var X$=r(xd);N1=i(X$,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),X$.forEach(t),I1=d(Mt),Pr=n(Mt,"P",{});var Vh=r(Pr);L1=i(Vh,"This model inherits from "),Qi=n(Vh,"A",{href:!0});var Y$=r(Qi);S1=i(Y$,"TFPreTrainedModel"),Y$.forEach(t),W1=i(Vh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vh.forEach(t),R1=d(Mt),qr=n(Mt,"P",{});var Jh=r(qr);U1=i(Jh,"This model is also a "),Ar=n(Jh,"A",{href:!0,rel:!0});var Z$=r(Ar);H1=i(Z$,"tf.keras.Model"),Z$.forEach(t),Q1=i(Jh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jh.forEach(t),K1=d(Mt),k(yo.$$.fragment,Mt),V1=d(Mt),nt=n(Mt,"DIV",{class:!0});var Zt=r(nt);k(Or.$$.fragment,Zt),J1=d(Zt),xs=n(Zt,"P",{});var ml=r(xs);G1=i(ml,"The "),Ki=n(ml,"A",{href:!0});var eD=r(Ki);X1=i(eD,"TFDistilBertForMultipleChoice"),eD.forEach(t),Y1=i(ml," forward method, overrides the "),zd=n(ml,"CODE",{});var tD=r(zd);Z1=i(tD,"__call__"),tD.forEach(t),ev=i(ml," special method."),ml.forEach(t),tv=d(Zt),k($o.$$.fragment,Zt),sv=d(Zt),jd=n(Zt,"P",{});var sD=r(jd);ov=i(sD,"Example:"),sD.forEach(t),nv=d(Zt),k(Nr.$$.fragment,Zt),Zt.forEach(t),Mt.forEach(t),Jp=d(s),zs=n(s,"H2",{class:!0});var Gh=r(zs);Do=n(Gh,"A",{id:!0,class:!0,href:!0});var oD=r(Do);Cd=n(oD,"SPAN",{});var nD=r(Cd);k(Ir.$$.fragment,nD),nD.forEach(t),oD.forEach(t),rv=d(Gh),Pd=n(Gh,"SPAN",{});var rD=r(Pd);av=i(rD,"TFDistilBertForTokenClassification"),rD.forEach(t),Gh.forEach(t),Gp=d(s),Ie=n(s,"DIV",{class:!0});var Et=r(Ie);k(Lr.$$.fragment,Et),iv=d(Et),qd=n(Et,"P",{});var aD=r(qd);lv=i(aD,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),Wv=d(zt),Gr=n(zt,"P",{});var tu=r(Gr);Rv=i(tu,"This model is also a "),Xr=n(tu,"A",{href:!0,rel:!0});var vD=r(Xr);Uv=i(vD,"tf.keras.Model"),vD.forEach(t),Hv=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Qv=d(zt),k(Eo.$$.fragment,zt),Kv=d(zt),Ke=n(zt,"DIV",{class:!0});var jt=r(Ke);k(Yr.$$.fragment,jt),Vv=d(jt),qs=n(jt,"P",{});var vl=r(qs);Jv=i(vl,"The "),Xi=n(vl,"A",{href:!0});var bD=r(Xi);Gv=i(bD,"TFDistilBertForQuestionAnswering"),bD.forEach(t),Xv=i(vl," forward method, overrides the "),Wd=n(vl,"CODE",{});var kD=r(Wd);Yv=i(kD,"__call__"),kD.forEach(t),Zv=i(vl," special method."),vl.forEach(t),eb=d(jt),k(xo.$$.fragment,jt),tb=d(jt),Rd=n(jt,"P",{});var TD=r(Rd);sb=i(TD,"Example:"),TD.forEach(t),ob=d(jt),k(Zr.$$.fragment,jt),nb=d(jt),k(ea.$$.fragment,jt),jt.forEach(t),zt.forEach(t),Zp=d(s),As=n(s,"H2",{class:!0});var su=r(As);zo=n(su,"A",{id:!0,class:!0,href:!0});var wD=r(zo);Ud=n(wD,"SPAN",{});var yD=r(Ud);k(ta.$$.fragment,yD),yD.forEach(t),wD.forEach(t),rb=d(su),Hd=n(su,"SPAN",{});var $D=r(Hd);ab=i($D,"FlaxDistilBertModel"),$D.forEach(t),su.forEach(t),eh=d(s),Me=n(s,"DIV",{class:!0});var pt=r(Me);k(sa.$$.fragment,pt),ib=d(pt),Qd=n(pt,"P",{});var DD=r(Qd);lb=i(DD,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),DD.forEach(t),db=d(pt),oa=n(pt,"P",{});var ou=r(oa);cb=i(ou,"This model inherits from "),Yi=n(ou,"A",{href:!0});var FD=r(Yi);pb=i(FD,"FlaxPreTrainedModel"),FD.forEach(t),hb=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ou.forEach(t),ub=d(pt),na=n(pt,"P",{});var nu=r(na);fb=i(nu,"This model is also a Flax Linen "),ra=n(nu,"A",{href:!0,rel:!0});var BD=r(ra);mb=i(BD,"flax.linen.Module"),BD.forEach(t),gb=i(nu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),nu.forEach(t),_b=d(pt),Kd=n(pt,"P",{});var MD=r(Kd);vb=i(MD,"Finally, this model supports inherent JAX features such as:"),MD.forEach(t),bb=d(pt),Pt=n(pt,"UL",{});var Qo=r(Pt);Vd=n(Qo,"LI",{});var ED=r(Vd);aa=n(ED,"A",{href:!0,rel:!0});var xD=r(aa);kb=i(xD,"Just-In-Time (JIT) compilation"),xD.forEach(t),ED.forEach(t),Tb=d(Qo),Jd=n(Qo,"LI",{});var zD=r(Jd);ia=n(zD,"A",{href:!0,rel:!0});var jD=r(ia);wb=i(jD,"Automatic Differentiation"),jD.forEach(t),zD.forEach(t),yb=d(Qo),Gd=n(Qo,"LI",{});var CD=r(Gd);la=n(CD,"A",{href:!0,rel:!0});var PD=r(la);$b=i(PD,"Vectorization"),PD.forEach(t),CD.forEach(t),Db=d(Qo),Xd=n(Qo,"LI",{});var qD=r(Xd);da=n(qD,"A",{href:!0,rel:!0});var AD=r(da);Fb=i(AD,"Parallelization"),AD.forEach(t),qD.forEach(t),Qo.forEach(t),Bb=d(pt),rt=n(pt,"DIV",{class:!0});var es=r(rt);k(ca.$$.fragment,es),Mb=d(es),Os=n(es,"P",{});var bl=r(Os);Eb=i(bl,"The "),Yd=n(bl,"CODE",{});var OD=r(Yd);xb=i(OD,"FlaxDistilBertPreTrainedModel"),OD.forEach(t),zb=i(bl,"forward method, overrides the "),Zd=n(bl,"CODE",{});var ND=r(Zd);jb=i(ND,"__call__"),ND.forEach(t),Cb=i(bl," special method."),bl.forEach(t),Pb=d(es),k(jo.$$.fragment,es),qb=d(es),ec=n(es,"P",{});var ID=r(ec);Ab=i(ID,"Example:"),ID.forEach(t),Ob=d(es),k(pa.$$.fragment,es),es.forEach(t),pt.forEach(t),th=d(s),Ns=n(s,"H2",{class:!0});var ru=r(Ns);Co=n(ru,"A",{id:!0,class:!0,href:!0});var LD=r(Co);tc=n(LD,"SPAN",{});var SD=r(tc);k(ha.$$.fragment,SD),SD.forEach(t),LD.forEach(t),Nb=d(ru),sc=n(ru,"SPAN",{});var WD=r(sc);Ib=i(WD,"FlaxDistilBertForMaskedLM"),WD.forEach(t),ru.forEach(t),sh=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);k(ua.$$.fragment,ht),Lb=d(ht),fa=n(ht,"P",{});var au=r(fa);Sb=i(au,"DistilBert Model with a "),oc=n(au,"CODE",{});var RD=r(oc);Wb=i(RD,"language modeling"),RD.forEach(t),Rb=i(au," head on top."),au.forEach(t),Ub=d(ht),ma=n(ht,"P",{});var iu=r(ma);Hb=i(iu,"This model inherits from "),Zi=n(iu,"A",{href:!0});var UD=r(Zi);Qb=i(UD,"FlaxPreTrainedModel"),UD.forEach(t),Kb=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Vb=d(ht),ga=n(ht,"P",{});var lu=r(ga);Jb=i(lu,"This model is also a Flax Linen "),_a=n(lu,"A",{href:!0,rel:!0});var HD=r(_a);Gb=i(HD,"flax.linen.Module"),HD.forEach(t),Xb=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Yb=d(ht),nc=n(ht,"P",{});var QD=r(nc);Zb=i(QD,"Finally, this model supports inherent JAX features such as:"),QD.forEach(t),ek=d(ht),qt=n(ht,"UL",{});var Ko=r(qt);rc=n(Ko,"LI",{});var KD=r(rc);va=n(KD,"A",{href:!0,rel:!0});var VD=r(va);tk=i(VD,"Just-In-Time (JIT) compilation"),VD.forEach(t),KD.forEach(t),sk=d(Ko),ac=n(Ko,"LI",{});var JD=r(ac);ba=n(JD,"A",{href:!0,rel:!0});var GD=r(ba);ok=i(GD,"Automatic Differentiation"),GD.forEach(t),JD.forEach(t),nk=d(Ko),ic=n(Ko,"LI",{});var XD=r(ic);ka=n(XD,"A",{href:!0,rel:!0});var YD=r(ka);rk=i(YD,"Vectorization"),YD.forEach(t),XD.forEach(t),ak=d(Ko),lc=n(Ko,"LI",{});var ZD=r(lc);Ta=n(ZD,"A",{href:!0,rel:!0});var e2=r(Ta);ik=i(e2,"Parallelization"),e2.forEach(t),ZD.forEach(t),Ko.forEach(t),lk=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);k(wa.$$.fragment,ts),dk=d(ts),Is=n(ts,"P",{});var kl=r(Is);ck=i(kl,"The "),dc=n(kl,"CODE",{});var t2=r(dc);pk=i(t2,"FlaxDistilBertPreTrainedModel"),t2.forEach(t),hk=i(kl,"forward method, overrides the "),cc=n(kl,"CODE",{});var s2=r(cc);uk=i(s2,"__call__"),s2.forEach(t),fk=i(kl," special method."),kl.forEach(t),mk=d(ts),k(Po.$$.fragment,ts),gk=d(ts),pc=n(ts,"P",{});var o2=r(pc);_k=i(o2,"Example:"),o2.forEach(t),vk=d(ts),k(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ls=n(s,"H2",{class:!0});var du=r(Ls);qo=n(du,"A",{id:!0,class:!0,href:!0});var n2=r(qo);hc=n(n2,"SPAN",{});var r2=r(hc);k($a.$$.fragment,r2),r2.forEach(t),n2.forEach(t),bk=d(du),uc=n(du,"SPAN",{});var a2=r(uc);kk=i(a2,"FlaxDistilBertForSequenceClassification"),a2.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);k(Da.$$.fragment,ut),Tk=d(ut),fc=n(ut,"P",{});var i2=r(fc);wk=i(i2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),i2.forEach(t),yk=d(ut),Fa=n(ut,"P",{});var cu=r(Fa);$k=i(cu,"This model inherits from "),el=n(cu,"A",{href:!0});var l2=r(el);Dk=i(l2,"FlaxPreTrainedModel"),l2.forEach(t),Fk=i(cu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),zk=d(ut),mc=n(ut,"P",{});var c2=r(mc);jk=i(c2,"Finally, this model supports inherent JAX features such as:"),c2.forEach(t),Ck=d(ut),At=n(ut,"UL",{});var Vo=r(At);gc=n(Vo,"LI",{});var p2=r(gc);Ea=n(p2,"A",{href:!0,rel:!0});var h2=r(Ea);Pk=i(h2,"Just-In-Time (JIT) compilation"),h2.forEach(t),p2.forEach(t),qk=d(Vo),_c=n(Vo,"LI",{});var u2=r(_c);xa=n(u2,"A",{href:!0,rel:!0});var f2=r(xa);Ak=i(f2,"Automatic Differentiation"),f2.forEach(t),u2.forEach(t),Ok=d(Vo),vc=n(Vo,"LI",{});var m2=r(vc);za=n(m2,"A",{href:!0,rel:!0});var g2=r(za);Nk=i(g2,"Vectorization"),g2.forEach(t),m2.forEach(t),Ik=d(Vo),bc=n(Vo,"LI",{});var _2=r(bc);ja=n(_2,"A",{href:!0,rel:!0});var v2=r(ja);Lk=i(v2,"Parallelization"),v2.forEach(t),_2.forEach(t),Vo.forEach(t),Sk=d(ut),it=n(ut,"DIV",{class:!0});var ss=r(it);k(Ca.$$.fragment,ss),Wk=d(ss),Ss=n(ss,"P",{});var Tl=r(Ss);Rk=i(Tl,"The "),kc=n(Tl,"CODE",{});var b2=r(kc);Uk=i(b2,"FlaxDistilBertPreTrainedModel"),b2.forEach(t),Hk=i(Tl,"forward method, overrides the "),Tc=n(Tl,"CODE",{});var k2=r(Tc);Qk=i(k2,"__call__"),k2.forEach(t),Kk=i(Tl," special method."),Tl.forEach(t),Vk=d(ss),k(Ao.$$.fragment,ss),Jk=d(ss),wc=n(ss,"P",{});var T2=r(wc);Gk=i(T2,"Example:"),T2.forEach(t),Xk=d(ss),k(Pa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),rh=d(s),Ws=n(s,"H2",{class:!0});var hu=r(Ws);Oo=n(hu,"A",{id:!0,class:!0,href:!0});var w2=r(Oo);yc=n(w2,"SPAN",{});var y2=r(yc);k(qa.$$.fragment,y2),y2.forEach(t),w2.forEach(t),Yk=d(hu),$c=n(hu,"SPAN",{});var $2=r($c);Zk=i($2,"FlaxDistilBertForMultipleChoice"),$2.forEach(t),hu.forEach(t),ah=d(s),ze=n(s,"DIV",{class:!0});var ft=r(ze);k(Aa.$$.fragment,ft),eT=d(ft),Dc=n(ft,"P",{});var D2=r(Dc);tT=i(D2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),D2.forEach(t),sT=d(ft),Oa=n(ft,"P",{});var uu=r(Oa);oT=i(uu,"This model inherits from "),tl=n(uu,"A",{href:!0});var F2=r(tl);nT=i(F2,"FlaxPreTrainedModel"),F2.forEach(t),rT=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),uu.forEach(t),aT=d(ft),Na=n(ft,"P",{});var fu=r(Na);iT=i(fu,"This model is also a Flax Linen "),Ia=n(fu,"A",{href:!0,rel:!0});var B2=r(Ia);lT=i(B2,"flax.linen.Module"),B2.forEach(t),dT=i(fu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),fu.forEach(t),cT=d(ft),Fc=n(ft,"P",{});var M2=r(Fc);pT=i(M2,"Finally, this model supports inherent JAX features such as:"),M2.forEach(t),hT=d(ft),Ot=n(ft,"UL",{});var Jo=r(Ot);Bc=n(Jo,"LI",{});var E2=r(Bc);La=n(E2,"A",{href:!0,rel:!0});var x2=r(La);uT=i(x2,"Just-In-Time (JIT) compilation"),x2.forEach(t),E2.forEach(t),fT=d(Jo),Mc=n(Jo,"LI",{});var z2=r(Mc);Sa=n(z2,"A",{href:!0,rel:!0});var j2=r(Sa);mT=i(j2,"Automatic Differentiation"),j2.forEach(t),z2.forEach(t),gT=d(Jo),Ec=n(Jo,"LI",{});var C2=r(Ec);Wa=n(C2,"A",{href:!0,rel:!0});var P2=r(Wa);_T=i(P2,"Vectorization"),P2.forEach(t),C2.forEach(t),vT=d(Jo),xc=n(Jo,"LI",{});var q2=r(xc);Ra=n(q2,"A",{href:!0,rel:!0});var A2=r(Ra);bT=i(A2,"Parallelization"),A2.forEach(t),q2.forEach(t),Jo.forEach(t),kT=d(ft),lt=n(ft,"DIV",{class:!0});var os=r(lt);k(Ua.$$.fragment,os),TT=d(os),Rs=n(os,"P",{});var wl=r(Rs);wT=i(wl,"The "),zc=n(wl,"CODE",{});var O2=r(zc);yT=i(O2,"FlaxDistilBertPreTrainedModel"),O2.forEach(t),$T=i(wl,"forward method, overrides the "),jc=n(wl,"CODE",{});var N2=r(jc);DT=i(N2,"__call__"),N2.forEach(t),FT=i(wl," special method."),wl.forEach(t),BT=d(os),k(No.$$.fragment,os),MT=d(os),Cc=n(os,"P",{});var I2=r(Cc);ET=i(I2,"Example:"),I2.forEach(t),xT=d(os),k(Ha.$$.fragment,os),os.forEach(t),ft.forEach(t),ih=d(s),Us=n(s,"H2",{class:!0});var mu=r(Us);Io=n(mu,"A",{id:!0,class:!0,href:!0});var L2=r(Io);Pc=n(L2,"SPAN",{});var S2=r(Pc);k(Qa.$$.fragment,S2),S2.forEach(t),L2.forEach(t),zT=d(mu),qc=n(mu,"SPAN",{});var W2=r(qc);jT=i(W2,"FlaxDistilBertForTokenClassification"),W2.forEach(t),mu.forEach(t),lh=d(s),je=n(s,"DIV",{class:!0});var mt=r(je);k(Ka.$$.fragment,mt),CT=d(mt),Ac=n(mt,"P",{});var R2=r(Ac);PT=i(R2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R2.forEach(t),qT=d(mt),Va=n(mt,"P",{});var gu=r(Va);AT=i(gu,"This model inherits from "),sl=n(gu,"A",{href:!0});var U2=r(sl);OT=i(U2,"FlaxPreTrainedModel"),U2.forEach(t),NT=i(gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),gu.forEach(t),IT=d(mt),Ja=n(mt,"P",{});var _u=r(Ja);LT=i(_u,"This model is also a Flax Linen "),Ga=n(_u,"A",{href:!0,rel:!0});var H2=r(Ga);ST=i(H2,"flax.linen.Module"),H2.forEach(t),WT=i(_u,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_u.forEach(t),RT=d(mt),Oc=n(mt,"P",{});var Q2=r(Oc);UT=i(Q2,"Finally, this model supports inherent JAX features such as:"),Q2.forEach(t),HT=d(mt),Nt=n(mt,"UL",{});var Go=r(Nt);Nc=n(Go,"LI",{});var K2=r(Nc);Xa=n(K2,"A",{href:!0,rel:!0});var V2=r(Xa);QT=i(V2,"Just-In-Time (JIT) compilation"),V2.forEach(t),K2.forEach(t),KT=d(Go),Ic=n(Go,"LI",{});var J2=r(Ic);Ya=n(J2,"A",{href:!0,rel:!0});var G2=r(Ya);VT=i(G2,"Automatic Differentiation"),G2.forEach(t),J2.forEach(t),JT=d(Go),Lc=n(Go,"LI",{});var X2=r(Lc);Za=n(X2,"A",{href:!0,rel:!0});var Y2=r(Za);GT=i(Y2,"Vectorization"),Y2.forEach(t),X2.forEach(t),XT=d(Go),Sc=n(Go,"LI",{});var Z2=r(Sc);ei=n(Z2,"A",{href:!0,rel:!0});var eF=r(ei);YT=i(eF,"Parallelization"),eF.forEach(t),Z2.forEach(t),Go.forEach(t),ZT=d(mt),dt=n(mt,"DIV",{class:!0});var ns=r(dt);k(ti.$$.fragment,ns),ew=d(ns),Hs=n(ns,"P",{});var yl=r(Hs);tw=i(yl,"The "),Wc=n(yl,"CODE",{});var tF=r(Wc);sw=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),ow=i(yl,"forward method, overrides the "),Rc=n(yl,"CODE",{});var sF=r(Rc);nw=i(sF,"__call__"),sF.forEach(t),rw=i(yl," special method."),yl.forEach(t),aw=d(ns),k(Lo.$$.fragment,ns),iw=d(ns),Uc=n(ns,"P",{});var oF=r(Uc);lw=i(oF,"Example:"),oF.forEach(t),dw=d(ns),k(si.$$.fragment,ns),ns.forEach(t),mt.forEach(t),dh=d(s),Qs=n(s,"H2",{class:!0});var vu=r(Qs);So=n(vu,"A",{id:!0,class:!0,href:!0});var nF=r(So);Hc=n(nF,"SPAN",{});var rF=r(Hc);k(oi.$$.fragment,rF),rF.forEach(t),nF.forEach(t),cw=d(vu),Qc=n(vu,"SPAN",{});var aF=r(Qc);pw=i(aF,"FlaxDistilBertForQuestionAnswering"),aF.forEach(t),vu.forEach(t),ch=d(s),Ce=n(s,"DIV",{class:!0});var gt=r(Ce);k(ni.$$.fragment,gt),hw=d(gt),Ks=n(gt,"P",{});var $l=r(Ks);uw=i($l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
