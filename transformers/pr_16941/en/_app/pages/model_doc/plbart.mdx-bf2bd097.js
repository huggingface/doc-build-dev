...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16941/en/model_doc/plbart#transformers.PLBartModel">PLBartModel</a>.`,name:"vocab_size"},{anchor:"transformers.PLBartConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/pr_16941/src/transformers/models/plbart/configuration_plbart.py#L32"}}),Ue=new X({props:{code:`from transformers import PLBartModel, PLBartConfig
...
BPE-dropout.</li>
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16941/src/transformers/models/plbart/tokenization_plbart.py#L75"}}),Ye=new X({props:{code:`from transformers import PLBartTokenizer
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16941/src/transformers/models/plbart/tokenization_plbart.py#L302",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16941/en/model_doc/plbart#transformers.PLBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16941/src/transformers/models/plbart/modeling_plbart.py#L1272",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16941/src/transformers/models/plbart/modeling_plbart.py#L1411",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16941/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16941/src/transformers/models/plbart/modeling_plbart.py#L1566",returnDescription:`
<p>A <a
