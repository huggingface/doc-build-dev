...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/tokenization_roberta.py#L396",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17585/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17585/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17585/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17585/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17585/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17585/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17585/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17585/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17585/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17585/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),T(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);TT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),T(gs.$$.fragment,mo),RT=h(mo),T(_s.$$.fragment,mo),MT=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);T(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var e5=a(Mp);zT=i(e5,"TFRobertaForMultipleChoice"),e5.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),CT=h(Dt),Ep=s(Dt,"P",{});var t5=a(Ep);qT=i(t5,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t5.forEach(t),jT=h(Dt),ni=s(Dt,"P",{});var Eu=a(ni);PT=i(Eu,"This model inherits from "),xd=s(Eu,"A",{href:!0});var o5=a(xd);LT=i(o5,"TFPreTrainedModel"),o5.forEach(t),AT=i(Eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eu.forEach(t),OT=h(Dt),si=s(Dt,"P",{});var zu=a(si);NT=i(zu,"This model is also a "),ai=s(zu,"A",{href:!0,rel:!0});var n5=a(ai);IT=i(n5,"tf.keras.Model"),n5.forEach(t),DT=i(zu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),T(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s5=a(Rd);HT=i(s5,"TFRobertaForMultipleChoice"),s5.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a5=a(zp);VT=i(a5,"__call__"),a5.forEach(t),JT=i(ec," special method."),ec.forEach(t),KT=h(aa),T(ys.$$.fragment,aa),GT=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var r5=a(ws);Cp=s(r5,"SPAN",{});var i5=a(Cp);T(ii.$$.fragment,i5),i5.forEach(t),r5.forEach(t),XT=h(Cu),qp=s(Cu,"SPAN",{});var l5=a(qp);YT=i(l5,"TFRobertaForTokenClassification"),l5.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var d5=a(jp);ew=i(d5,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d5.forEach(t),tw=h(St),di=s(St,"P",{});var qu=a(di);ow=i(qu,"This model inherits from "),Md=s(qu,"A",{href:!0});var c5=a(Md);nw=i(c5,"TFPreTrainedModel"),c5.forEach(t),sw=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),aw=h(St),ci=s(St,"P",{});var ju=a(ci);rw=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var p5=a(pi);iw=i(p5,"tf.keras.Model"),p5.forEach(t),lw=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dw=h(St),T($s.$$.fragment,St),cw=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);T(hi.$$.fragment,fo),pw=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hw=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h5=a(Ed);mw=i(h5,"TFRobertaForTokenClassification"),h5.forEach(t),fw=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var m5=a(Pp);uw=i(m5,"__call__"),m5.forEach(t),gw=i(tc," special method."),tc.forEach(t),_w=h(fo),T(Fs.$$.fragment,fo),bw=h(fo),T(xs.$$.fragment,fo),kw=h(fo),T(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var f5=a(Ms);Lp=s(f5,"SPAN",{});var u5=a(Lp);T(mi.$$.fragment,u5),u5.forEach(t),f5.forEach(t),vw=h(Pu),Ap=s(Pu,"SPAN",{});var g5=a(Ap);yw=i(g5,"TFRobertaForQuestionAnswering"),g5.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);T(fi.$$.fragment,Wt),Tw=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);ww=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _5=a(Op);$w=i(_5,"span start logits"),_5.forEach(t),Fw=i(oc," and "),Np=s(oc,"CODE",{});var b5=a(Np);xw=i(b5,"span end logits"),b5.forEach(t),Rw=i(oc,")."),oc.forEach(t),Mw=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ew=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var k5=a(zd);zw=i(k5,"TFPreTrainedModel"),k5.forEach(t),Cw=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),qw=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jw=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var v5=a(_i);Pw=i(v5,"tf.keras.Model"),v5.forEach(t),Lw=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Aw=h(Wt),T(Es.$$.fragment,Wt),Ow=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),Nw=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iw=i(nc,"The "),Cd=s(nc,"A",{href:!0});var y5=a(Cd);Dw=i(y5,"TFRobertaForQuestionAnswering"),y5.forEach(t),Sw=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var T5=a(Ip);Ww=i(T5,"__call__"),T5.forEach(t),Bw=i(nc," special method."),nc.forEach(t),Uw=h(uo),T(zs.$$.fragment,uo),Hw=h(uo),T(Cs.$$.fragment,uo),Qw=h(uo),T(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var w5=a(js);Dp=s(w5,"SPAN",{});var $5=a(Dp);T(ki.$$.fragment,$5),$5.forEach(t),w5.forEach(t),Vw=h(Ou),Sp=s(Ou,"SPAN",{});var F5=a(Sp);Jw=i(F5,"FlaxRobertaModel"),F5.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),Kw=h(gt),Wp=s(gt,"P",{});var x5=a(Wp);Gw=i(x5,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x5.forEach(t),Xw=h(gt),yi=s(gt,"P",{});var Nu=a(yi);Yw=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var R5=a(qd);Zw=i(R5,"FlaxPreTrainedModel"),R5.forEach(t),e1=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),t1=h(gt),Ti=s(gt,"P",{});var Iu=a(Ti);o1=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var M5=a(wi);n1=i(M5,"flax.linen.Module"),M5.forEach(t),s1=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),a1=h(gt),Bp=s(gt,"P",{});var E5=a(Bp);r1=i(E5,"Finally, this model supports inherent JAX features such as:"),E5.forEach(t),i1=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var z5=a(Up);$i=s(z5,"A",{href:!0,rel:!0});var C5=a($i);l1=i(C5,"Just-In-Time (JIT) compilation"),C5.forEach(t),z5.forEach(t),d1=h(ra),Hp=s(ra,"LI",{});var q5=a(Hp);Fi=s(q5,"A",{href:!0,rel:!0});var j5=a(Fi);c1=i(j5,"Automatic Differentiation"),j5.forEach(t),q5.forEach(t),p1=h(ra),Qp=s(ra,"LI",{});var P5=a(Qp);xi=s(P5,"A",{href:!0,rel:!0});var L5=a(xi);h1=i(L5,"Vectorization"),L5.forEach(t),P5.forEach(t),m1=h(ra),Vp=s(ra,"LI",{});var A5=a(Vp);Ri=s(A5,"A",{href:!0,rel:!0});var O5=a(Ri);f1=i(O5,"Parallelization"),O5.forEach(t),A5.forEach(t),ra.forEach(t),u1=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);T(Mi.$$.fragment,ia),g1=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_1=i(sc,"The "),Jp=s(sc,"CODE",{});var N5=a(Jp);b1=i(N5,"FlaxRobertaPreTrainedModel"),N5.forEach(t),k1=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var I5=a(Kp);v1=i(I5,"__call__"),I5.forEach(t),y1=i(sc," special method."),sc.forEach(t),T1=h(ia),T(Ps.$$.fragment,ia),w1=h(ia),T(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var D5=a(As);Gp=s(D5,"SPAN",{});var S5=a(Gp);T(Ei.$$.fragment,S5),S5.forEach(t),D5.forEach(t),$1=h(Du),Xp=s(Du,"SPAN",{});var W5=a(Xp);F1=i(W5,"FlaxRobertaForCausalLM"),W5.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);T(zi.$$.fragment,_t),x1=h(_t),Yp=s(_t,"P",{});var B5=a(Yp);R1=i(B5,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),B5.forEach(t),M1=h(_t),Ci=s(_t,"P",{});var Su=a(Ci);E1=i(Su,"This model inherits from "),jd=s(Su,"A",{href:!0});var U5=a(jd);z1=i(U5,"FlaxPreTrainedModel"),U5.forEach(t),C1=i(Su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Su.forEach(t),q1=h(_t),qi=s(_t,"P",{});var Wu=a(qi);j1=i(Wu,"This model is also a Flax Linen "),ji=s(Wu,"A",{href:!0,rel:!0});var H5=a(ji);P1=i(H5,"flax.linen.Module"),H5.forEach(t),L1=i(Wu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Wu.forEach(t),A1=h(_t),Zp=s(_t,"P",{});var Q5=a(Zp);O1=i(Q5,"Finally, this model supports inherent JAX features such as:"),Q5.forEach(t),N1=h(_t),Ht=s(_t,"UL",{});var la=a(Ht);eh=s(la,"LI",{});var V5=a(eh);Pi=s(V5,"A",{href:!0,rel:!0});var J5=a(Pi);I1=i(J5,"Just-In-Time (JIT) compilation"),J5.forEach(t),V5.forEach(t),D1=h(la),th=s(la,"LI",{});var K5=a(th);Li=s(K5,"A",{href:!0,rel:!0});var G5=a(Li);S1=i(G5,"Automatic Differentiation"),G5.forEach(t),K5.forEach(t),W1=h(la),oh=s(la,"LI",{});var X5=a(oh);Ai=s(X5,"A",{href:!0,rel:!0});var Y5=a(Ai);B1=i(Y5,"Vectorization"),Y5.forEach(t),X5.forEach(t),U1=h(la),nh=s(la,"LI",{});var Z5=a(nh);Oi=s(Z5,"A",{href:!0,rel:!0});var eR=a(Oi);H1=i(eR,"Parallelization"),eR.forEach(t),Z5.forEach(t),la.forEach(t),Q1=h(_t),Ct=s(_t,"DIV",{class:!0});var da=a(Ct);T(Ni.$$.fragment,da),V1=h(da),tn=s(da,"P",{});var ac=a(tn);J1=i(ac,"The "),sh=s(ac,"CODE",{});var tR=a(sh);K1=i(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),G1=i(ac," forward method, overrides the "),ah=s(ac,"CODE",{});var oR=a(ah);X1=i(oR,"__call__"),oR.forEach(t),Y1=i(ac," special method."),ac.forEach(t),Z1=h(da),T(Os.$$.fragment,da),e$=h(da),T(Ns.$$.fragment,da),da.forEach(t),_t.forEach(t),zf=h(o),on=s(o,"H2",{class:!0});var Bu=a(on);Is=s(Bu,"A",{id:!0,class:!0,href:!0});var nR=a(Is);rh=s(nR,"SPAN",{});var sR=a(rh);T(Ii.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t$=h(Bu),ih=s(Bu,"SPAN",{});var aR=a(ih);o$=i(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Bu.forEach(t),Cf=h(o),Ie=s(o,"DIV",{class:!0});var bt=a(Ie);T(Di.$$.fragment,bt),n$=h(bt),Si=s(bt,"P",{});var Uu=a(Si);s$=i(Uu,"RoBERTa Model with a "),lh=s(Uu,"CODE",{});var rR=a(lh);a$=i(rR,"language modeling"),rR.forEach(t),r$=i(Uu," head on top."),Uu.forEach(t),i$=h(bt),Wi=s(bt,"P",{});var Hu=a(Wi);l$=i(Hu,"This model inherits from "),Pd=s(Hu,"A",{href:!0});var iR=a(Pd);d$=i(iR,"FlaxPreTrainedModel"),iR.forEach(t),c$=i(Hu,`. Check the superclass documentation for the generic methods the
