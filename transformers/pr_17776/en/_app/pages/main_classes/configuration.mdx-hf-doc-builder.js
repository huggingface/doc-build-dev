...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&quot;foo&quot;</span>: <span class="hljs-literal">False</span>}`}}),{c(){f=n("p"),b=o("Examples:"),p=d(),y(u.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=r(_,"Examples:"),_.forEach(t),p=l(c),w(u.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,p,_),$(u,c,_),E=!0},p:Ps,i(c){E||(k(u.$$.fragment,c),E=!0)},o(c){P(u.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(p),C(u,c)}}}function Ss(z){let f,b;return{c(){f=n("p"),b=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(p){f=a(p,"P",{});var u=s(f);b=r(u,"This API is experimental and may have some slight breaking changes in the next releases."),u.forEach(t)},m(p,u){x(p,f,u),e(f,b)},d(p){p&&t(f)}}}function Fs(z){let f,b,p,u,E,c,_,q,Do,ao,H,jo,Ge,zo,Ao,so,D,Oo,dt,qo,So,lt,Fo,Io,ct,Lo,No,ft,Wo,Mo,io,R,G,mt,$e,Vo,ht,Bo,lo,m,ke,Ro,pt,Uo,Jo,X,Ho,ut,Go,Xo,S,W,gt,Ko,Qo,_t,Yo,Zo,Xe,er,tr,or,j,bt,rr,nr,vt,ar,sr,Ke,ir,dr,Qe,lr,cr,Ye,fr,mr,hr,K,yt,pr,ur,wt,gr,_r,br,Q,$t,vr,yr,kt,wr,$r,kr,Pt,Pr,Cr,F,Y,Ct,Er,xr,Et,Tr,Dr,jr,Z,xt,zr,Ar,Tt,Or,qr,Sr,ee,Dt,Fr,Ir,jt,Lr,Nr,Wr,te,zt,Mr,Vr,At,Br,Rr,Ur,M,Pe,Jr,Ce,Hr,Ot,Gr,Xr,Kr,oe,Qr,re,Ee,Yr,I,Zr,qt,en,tn,St,on,rn,Ft,nn,an,sn,ne,xe,dn,Te,ln,Ze,cn,fn,mn,ae,De,hn,je,pn,et,un,gn,_n,A,ze,bn,Ae,vn,tt,yn,wn,$n,se,kn,ie,Pn,de,Oe,Cn,L,En,It,xn,Tn,ot,Dn,jn,Lt,zn,An,On,V,qe,qn,Se,Sn,Nt,Fn,In,Ln,le,Nn,ce,Fe,Wn,U,Mn,Wt,Vn,Bn,rt,Rn,Un,Jn,fe,Ie,Hn,Mt,Gn,Xn,me,Le,Kn,Vt,Qn,Yn,he,Ne,Zn,Bt,ea,ta,pe,We,oa,Rt,ra,na,ue,Me,aa,Ve,sa,Ut,ia,da,la,O,Be,ca,Re,fa,Jt,ma,ha,pa,J,ua,Ht,ga,_a,Gt,ba,va,ya,Xt,wa,co;return c=new $s({}),$e=new $s({}),ke=new T({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
...
`),ft=n("code"),Wo=o("vocab_size"),Mo=o("."),io=d(),R=n("h2"),G=n("a"),mt=n("span"),y($e.$$.fragment),Vo=d(),ht=n("span"),Bo=o("PretrainedConfig"),lo=d(),m=n("div"),y(ke.$$.fragment),Ro=d(),pt=n("p"),Uo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
model.`),Wr=d(),te=n("li"),zt=n("strong"),Mr=o("num_hidden_layers"),Vr=o(" ("),At=n("code"),Br=o("int"),Rr=o(") \u2014 The number of blocks in the model."),Ur=d(),M=n("div"),y(Pe.$$.fragment),Jr=d(),Ce=n("p"),Hr=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
`),ot=n("a"),Dn=o("PretrainedConfig"),jn=o(" using "),Lt=n("code"),zn=o("from_dict"),An=o("."),On=d(),V=n("div"),y(qe.$$.fragment),qn=d(),Se=n("p"),Sn=o(`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Nt=n("code"),Fn=o("AutoConfig"),In=o("."),Ln=d(),y(le.$$.fragment),Nn=d(),ce=n("div"),y(Fe.$$.fragment),Wn=d(),U=n("p"),Mn=o("Save a configuration object to the directory "),Wt=n("code"),Vn=o("save_directory"),Bn=o(`, so that it can be re-loaded using the
`),rt=n("a"),Rn=o("from_pretrained()"),Un=o(" class method."),Jn=d(),fe=n("div"),y(Ie.$$.fragment),Hn=d(),Mt=n("p"),Gn=o("Serializes this instance to a Python dictionary."),Xn=d(),me=n("div"),y(Le.$$.fragment),Kn=d(),Vt=n("p"),Qn=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Yn=d(),he=n("div"),y(Ne.$$.fragment),Zn=d(),Bt=n("p"),ea=o("Save this instance to a JSON file."),ta=d(),pe=n("div"),y(We.$$.fragment),oa=d(),Rt=n("p"),ra=o("Serializes this instance to a JSON string."),na=d(),ue=n("div"),y(Me.$$.fragment),aa=d(),Ve=n("p"),sa=o("Updates attributes of this class with attributes from "),Ut=n("code"),ia=o("config_dict"),da=o("."),la=d(),O=n("div"),y(Be.$$.fragment),ca=d(),Re=n("p"),fa=o("Updates attributes of this class with attributes from "),Jt=n("code"),ma=o("update_str"),ha=o("."),pa=d(),J=n("p"),ua=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=n("code"),ga=o("true"),_a=o(" or "),Gt=n("code"),ba=o("false"),va=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),ya=d(),Xt=n("p"),wa=o("The keys to change have to already exist in the config object."),this.h()},l(i){const v=Ds('[data-svelte="svelte-1phssyn"]',document.head);f=a(v,"META",{name:!0,content:!0}),v.forEach(t),b=l(i),p=a(i,"H1",{class:!0});var Ue=s(p);u=a(Ue,"A",{id:!0,class:!0,href:!0});var Kt=s(u);E=a(Kt,"SPAN",{});var Qt=s(E);w(c.$$.fragment,Qt),Qt.forEach(t),Kt.forEach(t),_=l(Ue),q=a(Ue,"SPAN",{});var Yt=s(q);Do=r(Yt,"Configuration"),Yt.forEach(t),Ue.forEach(t),ao=l(i),H=a(i,"P",{});var Je=s(H);jo=r(Je,"The base class "),Ge=a(Je,"A",{href:!0});var ka=s(Ge);zo=r(ka,"PretrainedConfig"),ka.forEach(t),Ao=r(Je,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
outputs of the model during inference.`),Zt.forEach(t),br=l(ge),Q=a(ge,"LI",{});var eo=s(Q);$t=a(eo,"STRONG",{});var Ba=s($t);vr=r(Ba,"attribute_map"),Ba.forEach(t),yr=r(eo," ("),kt=a(eo,"CODE",{});var Ra=s(kt);wr=r(Ra,"Dict[str, str]"),Ra.forEach(t),$r=r(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
