...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17776/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17776/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17776/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17776/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
special tokens using the tokenizer `),yc=s(Ql,"CODE",{});var e7=a(yc);d_=i(e7,"prepare_for_model"),e7.forEach(t),c_=i(Ql," method."),Ql.forEach(t),Hl.forEach(t),p_=h(Fe),$n=s(Fe,"DIV",{class:!0});var Sf=a($n);y(ja.$$.fragment,Sf),h_=h(Sf),wc=s(Sf,"P",{});var t7=a(wc);u_=i(t7,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),t7.forEach(t),Sf.forEach(t),f_=h(Fe),od=s(Fe,"DIV",{class:!0});var o7=a(od);y(Pa.$$.fragment,o7),o7.forEach(t),Fe.forEach(t),Ku=h(o),vo=s(o,"H2",{class:!0});var Wf=a(vo);Fn=s(Wf,"A",{id:!0,class:!0,href:!0});var n7=a(Fn);$c=s(n7,"SPAN",{});var s7=a($c);y(La.$$.fragment,s7),s7.forEach(t),n7.forEach(t),m_=h(Wf),Fc=s(Wf,"SPAN",{});var a7=a(Fc);g_=i(a7,"RobertaTokenizerFast"),a7.forEach(t),Wf.forEach(t),Gu=h(o),Le=s(o,"DIV",{class:!0});var Ye=a(Le);y(Aa.$$.fragment,Ye),__=h(Ye),Oa=s(Ye,"P",{});var Bf=a(Oa);b_=i(Bf,"Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),xc=s(Bf,"EM",{});var r7=a(xc);k_=i(r7,"tokenizers"),r7.forEach(t),v_=i(Bf,` library), derived from the GPT-2
tokenizer, using byte-level Byte-Pair-Encoding.`),Bf.forEach(t),T_=h(Ye),Rc=s(Ye,"P",{});var i7=a(Rc);y_=i(i7,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),i7.forEach(t),w_=h(Ye),y(xn.$$.fragment,Ye),$_=h(Ye),Na=s(Ye,"P",{});var Uf=a(Na);F_=i(Uf,"You can get around that behavior by passing "),Mc=s(Uf,"CODE",{});var l7=a(Mc);x_=i(l7,"add_prefix_space=True"),l7.forEach(t),R_=i(Uf,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Uf.forEach(t),M_=h(Ye),y(Rn.$$.fragment,Ye),E_=h(Ye),Ia=s(Ye,"P",{});var Hf=a(Ia);z_=i(Hf,"This tokenizer inherits from "),nd=s(Hf,"A",{href:!0});var d7=a(nd);q_=i(d7,"PreTrainedTokenizerFast"),d7.forEach(t),C_=i(Hf,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hf.forEach(t),j_=h(Ye),sd=s(Ye,"DIV",{class:!0});var c7=a(sd);y(Da.$$.fragment,c7),c7.forEach(t),Ye.forEach(t),Xu=h(o),To=s(o,"H2",{class:!0});var Qf=a(To);Mn=s(Qf,"A",{id:!0,class:!0,href:!0});var p7=a(Mn);Ec=s(p7,"SPAN",{});var h7=a(Ec);y(Sa.$$.fragment,h7),h7.forEach(t),p7.forEach(t),P_=h(Qf),zc=s(Qf,"SPAN",{});var u7=a(zc);L_=i(u7,"RobertaModel"),u7.forEach(t),Qf.forEach(t),Yu=h(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);y(Wa.$$.fragment,Ze),A_=h(Ze),qc=s(Ze,"P",{});var f7=a(qc);O_=i(f7,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),f7.forEach(t),N_=h(Ze),Ba=s(Ze,"P",{});var Jf=a(Ba);I_=i(Jf,"This model inherits from "),ad=s(Jf,"A",{href:!0});var m7=a(ad);D_=i(m7,"PreTrainedModel"),m7.forEach(t),S_=i(Jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jf.forEach(t),W_=h(Ze),Ua=s(Ze,"P",{});var Vf=a(Ua);B_=i(Vf,"This model is also a PyTorch "),Ha=s(Vf,"A",{href:!0,rel:!0});var g7=a(Ha);U_=i(g7,"torch.nn.Module"),g7.forEach(t),H_=i(Vf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),Cc=s(Kf,"EM",{});var _7=a(Cc);V_=i(_7,`Attention is
...
`),Ac=s(ft,"CODE",{});var T7=a(Ac);sb=i(T7,"add_cross_attention"),T7.forEach(t),ab=i(ft," set to "),Oc=s(ft,"CODE",{});var y7=a(Oc);rb=i(y7,"True"),y7.forEach(t),ib=i(ft,"; an "),Nc=s(ft,"CODE",{});var w7=a(Nc);lb=i(w7,"encoder_hidden_states"),w7.forEach(t),db=i(ft," is then expected as an input to the forward pass."),ft.forEach(t),cb=h(Ze),En=s(Ze,"P",{});var Bu=a(En);pb=i(Bu,".. _"),Ic=s(Bu,"EM",{});var $7=a(Ic);hb=i($7,"Attention is all you need"),$7.forEach(t),ub=i(Bu,": "),Ja=s(Bu,"A",{href:!0,rel:!0});var F7=a(Ja);fb=i(F7,"https://arxiv.org/abs/1706.03762"),F7.forEach(t),Bu.forEach(t),mb=h(Ze),$t=s(Ze,"DIV",{class:!0});var ea=a($t);y(Va.$$.fragment,ea),gb=h(ea),yo=s(ea,"P",{});var Wd=a(yo);_b=i(Wd,"The "),rd=s(Wd,"A",{href:!0});var x7=a(rd);bb=i(x7,"RobertaModel"),x7.forEach(t),kb=i(Wd," forward method, overrides the "),Dc=s(Wd,"CODE",{});var R7=a(Dc);vb=i(R7,"__call__"),R7.forEach(t),Tb=i(Wd," special method."),Wd.forEach(t),yb=h(ea),y(zn.$$.fragment,ea),wb=h(ea),y(qn.$$.fragment,ea),ea.forEach(t),Ze.forEach(t),Zu=h(o),wo=s(o,"H2",{class:!0});var Gf=a(wo);Cn=s(Gf,"A",{id:!0,class:!0,href:!0});var M7=a(Cn);Sc=s(M7,"SPAN",{});var E7=a(Sc);y(Ka.$$.fragment,E7),E7.forEach(t),M7.forEach(t),$b=h(Gf),Wc=s(Gf,"SPAN",{});var z7=a(Wc);Fb=i(z7,"RobertaForCausalLM"),z7.forEach(t),Gf.forEach(t),ef=h(o),tt=s(o,"DIV",{class:!0});var oo=a(tt);y(Ga.$$.fragment,oo),xb=h(oo),Xa=s(oo,"P",{});var Xf=a(Xa);Rb=i(Xf,"RoBERTa Model with a "),Bc=s(Xf,"CODE",{});var q7=a(Bc);Mb=i(q7,"language modeling"),q7.forEach(t),Eb=i(Xf," head on top for CLM fine-tuning."),Xf.forEach(t),zb=h(oo),Ya=s(oo,"P",{});var Yf=a(Ya);qb=i(Yf,"This model inherits from "),id=s(Yf,"A",{href:!0});var C7=a(id);Cb=i(C7,"PreTrainedModel"),C7.forEach(t),jb=i(Yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zf.forEach(t),Nb=h(oo),Ft=s(oo,"DIV",{class:!0});var ta=a(Ft);y(tr.$$.fragment,ta),Ib=h(ta),$o=s(ta,"P",{});var Bd=a($o);Db=i(Bd,"The "),ld=s(Bd,"A",{href:!0});var P7=a(ld);Sb=i(P7,"RobertaForCausalLM"),P7.forEach(t),Wb=i(Bd," forward method, overrides the "),Uc=s(Bd,"CODE",{});var L7=a(Uc);Bb=i(L7,"__call__"),L7.forEach(t),Ub=i(Bd," special method."),Bd.forEach(t),Hb=h(ta),y(jn.$$.fragment,ta),Qb=h(ta),y(Pn.$$.fragment,ta),ta.forEach(t),oo.forEach(t),tf=h(o),Fo=s(o,"H2",{class:!0});var em=a(Fo);Ln=s(em,"A",{id:!0,class:!0,href:!0});var A7=a(Ln);Hc=s(A7,"SPAN",{});var O7=a(Hc);y(or.$$.fragment,O7),O7.forEach(t),A7.forEach(t),Jb=h(em),Qc=s(em,"SPAN",{});var N7=a(Qc);Vb=i(N7,"RobertaForMaskedLM"),N7.forEach(t),em.forEach(t),of=h(o),ot=s(o,"DIV",{class:!0});var no=a(ot);y(nr.$$.fragment,no),Kb=h(no),sr=s(no,"P",{});var tm=a(sr);Gb=i(tm,"RoBERTa Model with a "),Jc=s(tm,"CODE",{});var I7=a(Jc);Xb=i(I7,"language modeling"),I7.forEach(t),Yb=i(tm," head on top."),tm.forEach(t),Zb=h(no),ar=s(no,"P",{});var om=a(ar);ek=i(om,"This model inherits from "),dd=s(om,"A",{href:!0});var D7=a(dd);tk=i(D7,"PreTrainedModel"),D7.forEach(t),ok=i(om,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),om.forEach(t),nk=h(no),rr=s(no,"P",{});var nm=a(rr);sk=i(nm,"This model is also a PyTorch "),ir=s(nm,"A",{href:!0,rel:!0});var S7=a(ir);ak=i(S7,"torch.nn.Module"),S7.forEach(t),rk=i(nm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nm.forEach(t),ik=h(no),it=s(no,"DIV",{class:!0});var so=a(it);y(lr.$$.fragment,so),lk=h(so),xo=s(so,"P",{});var Ud=a(xo);dk=i(Ud,"The "),cd=s(Ud,"A",{href:!0});var W7=a(cd);ck=i(W7,"RobertaForMaskedLM"),W7.forEach(t),pk=i(Ud," forward method, overrides the "),Vc=s(Ud,"CODE",{});var B7=a(Vc);hk=i(B7,"__call__"),B7.forEach(t),uk=i(Ud," special method."),Ud.forEach(t),fk=h(so),y(An.$$.fragment,so),mk=h(so),y(On.$$.fragment,so),gk=h(so),y(Nn.$$.fragment,so),so.forEach(t),no.forEach(t),nf=h(o),Ro=s(o,"H2",{class:!0});var sm=a(Ro);In=s(sm,"A",{id:!0,class:!0,href:!0});var U7=a(In);Kc=s(U7,"SPAN",{});var H7=a(Kc);y(dr.$$.fragment,H7),H7.forEach(t),U7.forEach(t),_k=h(sm),Gc=s(sm,"SPAN",{});var Q7=a(Gc);bk=i(Q7,"RobertaForSequenceClassification"),Q7.forEach(t),sm.forEach(t),sf=h(o),nt=s(o,"DIV",{class:!0});var ao=a(nt);y(cr.$$.fragment,ao),kk=h(ao),Xc=s(ao,"P",{});var J7=a(Xc);vk=i(J7,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J7.forEach(t),Tk=h(ao),pr=s(ao,"P",{});var am=a(pr);yk=i(am,"This model inherits from "),pd=s(am,"A",{href:!0});var V7=a(pd);wk=i(V7,"PreTrainedModel"),V7.forEach(t),$k=i(am,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),am.forEach(t),Fk=h(ao),hr=s(ao,"P",{});var rm=a(hr);xk=i(rm,"This model is also a PyTorch "),ur=s(rm,"A",{href:!0,rel:!0});var K7=a(ur);Rk=i(K7,"torch.nn.Module"),K7.forEach(t),Mk=i(rm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rm.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var mt=a(Ue);y(fr.$$.fragment,mt),zk=h(mt),Mo=s(mt,"P",{});var Hd=a(Mo);qk=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var G7=a(hd);Ck=i(G7,"RobertaForSequenceClassification"),G7.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var X7=a(Yc);Pk=i(X7,"__call__"),X7.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(mt),y(Dn.$$.fragment,mt),Ok=h(mt),y(Sn.$$.fragment,mt),Nk=h(mt),y(Wn.$$.fragment,mt),Ik=h(mt),y(Bn.$$.fragment,mt),Dk=h(mt),y(Un.$$.fragment,mt),mt.forEach(t),ao.forEach(t),af=h(o),Eo=s(o,"H2",{class:!0});var im=a(Eo);Hn=s(im,"A",{id:!0,class:!0,href:!0});var Y7=a(Hn);Zc=s(Y7,"SPAN",{});var Z7=a(Zc);y(mr.$$.fragment,Z7),Z7.forEach(t),Y7.forEach(t),Sk=h(im),ep=s(im,"SPAN",{});var e0=a(ep);Wk=i(e0,"RobertaForMultipleChoice"),e0.forEach(t),im.forEach(t),rf=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);y(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var t0=a(tp);Uk=i(t0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t0.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lm=a(_r);Qk=i(lm,"This model inherits from "),ud=s(lm,"A",{href:!0});var o0=a(ud);Jk=i(o0,"PreTrainedModel"),o0.forEach(t),Vk=i(lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lm.forEach(t),Kk=h(ro),br=s(ro,"P",{});var dm=a(br);Gk=i(dm,"This model is also a PyTorch "),kr=s(dm,"A",{href:!0,rel:!0});var n0=a(kr);Xk=i(n0,"torch.nn.Module"),n0.forEach(t),Yk=i(dm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s0=a(fd);ov=i(s0,"RobertaForMultipleChoice"),s0.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a0=a(op);sv=i(a0,"__call__"),a0.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),y(Qn.$$.fragment,oa),iv=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cm=a(qo);Vn=s(cm,"A",{id:!0,class:!0,href:!0});var r0=a(Vn);np=s(r0,"SPAN",{});var i0=a(np);y(Tr.$$.fragment,i0),i0.forEach(t),r0.forEach(t),lv=h(cm),sp=s(cm,"SPAN",{});var l0=a(sp);dv=i(l0,"RobertaForTokenClassification"),l0.forEach(t),cm.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var d0=a(ap);pv=i(d0,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d0.forEach(t),hv=h(io),wr=s(io,"P",{});var pm=a(wr);uv=i(pm,"This model inherits from "),md=s(pm,"A",{href:!0});var c0=a(md);fv=i(c0,"PreTrainedModel"),c0.forEach(t),mv=i(pm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pm.forEach(t),gv=h(io),$r=s(io,"P",{});var hm=a($r);_v=i(hm,"This model is also a PyTorch "),Fr=s(hm,"A",{href:!0,rel:!0});var p0=a(Fr);bv=i(p0,"torch.nn.Module"),p0.forEach(t),kv=i(hm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),Tv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);yv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h0=a(gd);wv=i(h0,"RobertaForTokenClassification"),h0.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var u0=a(rp);Fv=i(u0,"__call__"),u0.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),y(Kn.$$.fragment,lo),Mv=h(lo),y(Gn.$$.fragment,lo),Ev=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var um=a(jo);Yn=s(um,"A",{id:!0,class:!0,href:!0});var f0=a(Yn);ip=s(f0,"SPAN",{});var m0=a(ip);y(Rr.$$.fragment,m0),m0.forEach(t),f0.forEach(t),zv=h(um),lp=s(um,"SPAN",{});var g0=a(lp);qv=i(g0,"RobertaForQuestionAnswering"),g0.forEach(t),um.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _0=a(dp);Pv=i(_0,"span start logits"),_0.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var b0=a(cp);Av=i(b0,"span end logits"),b0.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fm=a(Er);Iv=i(fm,"This model inherits from "),_d=s(fm,"A",{href:!0});var k0=a(_d);Dv=i(k0,"PreTrainedModel"),k0.forEach(t),Sv=i(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fm.forEach(t),Wv=h(co),zr=s(co,"P",{});var mm=a(zr);Bv=i(mm,"This model is also a PyTorch "),qr=s(mm,"A",{href:!0,rel:!0});var v0=a(qr);Uv=i(v0,"torch.nn.Module"),v0.forEach(t),Hv=i(mm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mm.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T0=a(bd);Kv=i(T0,"RobertaForQuestionAnswering"),T0.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y0=a(pp);Xv=i(y0,"__call__"),y0.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),eT=h(po),y(es.$$.fragment,po),tT=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gm=a(Ao);os=s(gm,"A",{id:!0,class:!0,href:!0});var w0=a(os);hp=s(w0,"SPAN",{});var $0=a(hp);y(jr.$$.fragment,$0),$0.forEach(t),w0.forEach(t),oT=h(gm),up=s(gm,"SPAN",{});var F0=a(up);nT=i(F0,"TFRobertaModel"),F0.forEach(t),gm.forEach(t),uf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sT=h(Ot),fp=s(Ot,"P",{});var x0=a(fp);aT=i(x0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x0.forEach(t),rT=h(Ot),Lr=s(Ot,"P",{});var _m=a(Lr);iT=i(_m,"This model inherits from "),kd=s(_m,"A",{href:!0});var R0=a(kd);lT=i(R0,"TFPreTrainedModel"),R0.forEach(t),dT=i(_m,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_m.forEach(t),cT=h(Ot),Ar=s(Ot,"P",{});var bm=a(Ar);pT=i(bm,"This model is also a "),Or=s(bm,"A",{href:!0,rel:!0});var M0=a(Or);hT=i(M0,"tf.keras.Model"),M0.forEach(t),uT=i(bm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bm.forEach(t),fT=h(Ot),y(ns.$$.fragment,Ot),mT=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gT=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_T=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E0=a(vd);bT=i(E0,"TFRobertaModel"),E0.forEach(t),kT=i(Gd," forward method, overrides the "),mp=s(Gd,"CODE",{});var z0=a(mp);vT=i(z0,"__call__"),z0.forEach(t),TT=i(Gd," special method."),Gd.forEach(t),yT=h(na),y(ss.$$.fragment,na),wT=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var km=a(No);rs=s(km,"A",{id:!0,class:!0,href:!0});var q0=a(rs);gp=s(q0,"SPAN",{});var C0=a(gp);y(Ir.$$.fragment,C0),C0.forEach(t),q0.forEach(t),$T=h(km),_p=s(km,"SPAN",{});var j0=a(_p);FT=i(j0,"TFRobertaForCausalLM"),j0.forEach(t),km.forEach(t),mf=h(o),Io=s(o,"DIV",{class:!0});var vm=a(Io);y(Dr.$$.fragment,vm),xT=h(vm),Mt=s(vm,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),RT=h(sa),Do=s(sa,"P",{});var Xd=a(Do);MT=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P0=a(Td);ET=i(P0,"TFRobertaForCausalLM"),P0.forEach(t),zT=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L0=a(bp);qT=i(L0,"__call__"),L0.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=h(sa),y(is.$$.fragment,sa),PT=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vm.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tm=a(So);ds=s(Tm,"A",{id:!0,class:!0,href:!0});var A0=a(ds);kp=s(A0,"SPAN",{});var O0=a(kp);y(Wr.$$.fragment,O0),O0.forEach(t),A0.forEach(t),LT=h(Tm),vp=s(Tm,"SPAN",{});var N0=a(vp);AT=i(N0,"TFRobertaForMaskedLM"),N0.forEach(t),Tm.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),OT=h(Nt),Ur=s(Nt,"P",{});var ym=a(Ur);NT=i(ym,"RoBERTa Model with a "),Tp=s(ym,"CODE",{});var I0=a(Tp);IT=i(I0,"language modeling"),I0.forEach(t),DT=i(ym," head on top."),ym.forEach(t),ST=h(Nt),Hr=s(Nt,"P",{});var wm=a(Hr);WT=i(wm,"This model inherits from "),yd=s(wm,"A",{href:!0});var D0=a(yd);BT=i(D0,"TFPreTrainedModel"),D0.forEach(t),UT=i(wm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wm.forEach(t),HT=h(Nt),Qr=s(Nt,"P",{});var $m=a(Qr);QT=i($m,"This model is also a "),Jr=s($m,"A",{href:!0,rel:!0});var S0=a(Jr);JT=i(S0,"tf.keras.Model"),S0.forEach(t),VT=i($m,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$m.forEach(t),KT=h(Nt),y(cs.$$.fragment,Nt),GT=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),XT=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);YT=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W0=a(wd);ZT=i(W0,"TFRobertaForMaskedLM"),W0.forEach(t),ey=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B0=a(yp);ty=i(B0,"__call__"),B0.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),y(ps.$$.fragment,ho),sy=h(ho),y(hs.$$.fragment,ho),ay=h(ho),y(us.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fm=a(Bo);fs=s(Fm,"A",{id:!0,class:!0,href:!0});var U0=a(fs);wp=s(U0,"SPAN",{});var H0=a(wp);y(Kr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),ry=h(Fm),$p=s(Fm,"SPAN",{});var Q0=a($p);iy=i(Q0,"TFRobertaForSequenceClassification"),Q0.forEach(t),Fm.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var J0=a(Fp);dy=i(J0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J0.forEach(t),cy=h(It),Xr=s(It,"P",{});var xm=a(Xr);py=i(xm,"This model inherits from "),$d=s(xm,"A",{href:!0});var V0=a($d);hy=i(V0,"TFPreTrainedModel"),V0.forEach(t),uy=i(xm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xm.forEach(t),fy=h(It),Yr=s(It,"P",{});var Rm=a(Yr);my=i(Rm,"This model is also a "),Zr=s(Rm,"A",{href:!0,rel:!0});var K0=a(Zr);gy=i(K0,"tf.keras.Model"),K0.forEach(t),_y=i(Rm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rm.forEach(t),by=h(It),y(ms.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vy=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);Ty=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G0=a(Fd);yy=i(G0,"TFRobertaForSequenceClassification"),G0.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X0=a(xp);$y=i(X0,"__call__"),X0.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(uo),y(gs.$$.fragment,uo),Ry=h(uo),y(_s.$$.fragment,uo),My=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mm=a(Ho);ks=s(Mm,"A",{id:!0,class:!0,href:!0});var Y0=a(ks);Rp=s(Y0,"SPAN",{});var Z0=a(Rp);y(ti.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),Ey=h(Mm),Mp=s(Mm,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mm.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);Cy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tx.forEach(t),jy=h(Dt),ni=s(Dt,"P",{});var Em=a(ni);Py=i(Em,"This model inherits from "),xd=s(Em,"A",{href:!0});var ox=a(xd);Ly=i(ox,"TFPreTrainedModel"),ox.forEach(t),Ay=i(Em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Em.forEach(t),Oy=h(Dt),si=s(Dt,"P",{});var zm=a(si);Ny=i(zm,"This model is also a "),ai=s(zm,"A",{href:!0,rel:!0});var nx=a(ai);Iy=i(nx,"tf.keras.Model"),nx.forEach(t),Dy=i(zm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zm.forEach(t),Sy=h(Dt),y(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sx=a(Rd);Hy=i(sx,"TFRobertaForMultipleChoice"),sx.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var ax=a(zp);Jy=i(ax,"__call__"),ax.forEach(t),Vy=i(ec," special method."),ec.forEach(t),Ky=h(aa),y(Ts.$$.fragment,aa),Gy=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qm=a(Jo);ws=s(qm,"A",{id:!0,class:!0,href:!0});var rx=a(ws);qp=s(rx,"SPAN",{});var ix=a(qp);y(ii.$$.fragment,ix),ix.forEach(t),rx.forEach(t),Xy=h(qm),Cp=s(qm,"SPAN",{});var lx=a(Cp);Yy=i(lx,"TFRobertaForTokenClassification"),lx.forEach(t),qm.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var dx=a(jp);ew=i(dx,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dx.forEach(t),tw=h(St),di=s(St,"P",{});var Cm=a(di);ow=i(Cm,"This model inherits from "),Md=s(Cm,"A",{href:!0});var cx=a(Md);nw=i(cx,"TFPreTrainedModel"),cx.forEach(t),sw=i(Cm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cm.forEach(t),aw=h(St),ci=s(St,"P",{});var jm=a(ci);rw=i(jm,"This model is also a "),pi=s(jm,"A",{href:!0,rel:!0});var px=a(pi);iw=i(px,"tf.keras.Model"),px.forEach(t),lw=i(jm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jm.forEach(t),dw=h(St),y($s.$$.fragment,St),cw=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),pw=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hw=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hx=a(Ed);uw=i(hx,"TFRobertaForTokenClassification"),hx.forEach(t),fw=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var ux=a(Pp);mw=i(ux,"__call__"),ux.forEach(t),gw=i(tc," special method."),tc.forEach(t),_w=h(fo),y(Fs.$$.fragment,fo),bw=h(fo),y(xs.$$.fragment,fo),kw=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pm=a(Ko);Ms=s(Pm,"A",{id:!0,class:!0,href:!0});var fx=a(Ms);Lp=s(fx,"SPAN",{});var mx=a(Lp);y(ui.$$.fragment,mx),mx.forEach(t),fx.forEach(t),vw=h(Pm),Ap=s(Pm,"SPAN",{});var gx=a(Ap);Tw=i(gx,"TFRobertaForQuestionAnswering"),gx.forEach(t),Pm.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yw=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);ww=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _x=a(Op);$w=i(_x,"span start logits"),_x.forEach(t),Fw=i(oc," and "),Np=s(oc,"CODE",{});var bx=a(Np);xw=i(bx,"span end logits"),bx.forEach(t),Rw=i(oc,")."),oc.forEach(t),Mw=h(Wt),mi=s(Wt,"P",{});var Lm=a(mi);Ew=i(Lm,"This model inherits from "),zd=s(Lm,"A",{href:!0});var kx=a(zd);zw=i(kx,"TFPreTrainedModel"),kx.forEach(t),qw=i(Lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lm.forEach(t),Cw=h(Wt),gi=s(Wt,"P",{});var Am=a(gi);jw=i(Am,"This model is also a "),_i=s(Am,"A",{href:!0,rel:!0});var vx=a(_i);Pw=i(vx,"tf.keras.Model"),vx.forEach(t),Lw=i(Am,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Am.forEach(t),Aw=h(Wt),y(Es.$$.fragment,Wt),Ow=h(Wt),ut=s(Wt,"DIV",{class:!0});var mo=a(ut);y(bi.$$.fragment,mo),Nw=h(mo),Xo=s(mo,"P",{});var nc=a(Xo);Iw=i(nc,"The "),qd=s(nc,"A",{href:!0});var Tx=a(qd);Dw=i(Tx,"TFRobertaForQuestionAnswering"),Tx.forEach(t),Sw=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yx=a(Ip);Ww=i(yx,"__call__"),yx.forEach(t),Bw=i(nc," special method."),nc.forEach(t),Uw=h(mo),y(zs.$$.fragment,mo),Hw=h(mo),y(qs.$$.fragment,mo),Qw=h(mo),y(Cs.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Om=a(Yo);js=s(Om,"A",{id:!0,class:!0,href:!0});var wx=a(js);Dp=s(wx,"SPAN",{});var $x=a(Dp);y(ki.$$.fragment,$x),$x.forEach(t),wx.forEach(t),Jw=h(Om),Sp=s(Om,"SPAN",{});var Fx=a(Sp);Vw=i(Fx,"FlaxRobertaModel"),Fx.forEach(t),Om.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Kw=h(gt),Wp=s(gt,"P",{});var xx=a(Wp);Gw=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),Xw=h(gt),Ti=s(gt,"P",{});var Nm=a(Ti);Yw=i(Nm,"This model inherits from "),Cd=s(Nm,"A",{href:!0});var Rx=a(Cd);Zw=i(Rx,"FlaxPreTrainedModel"),Rx.forEach(t),e1=i(Nm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nm.forEach(t),t1=h(gt),yi=s(gt,"P",{});var Im=a(yi);o1=i(Im,"This model is also a Flax Linen "),wi=s(Im,"A",{href:!0,rel:!0});var Mx=a(wi);n1=i(Mx,"flax.linen.Module"),Mx.forEach(t),s1=i(Im,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Im.forEach(t),a1=h(gt),Bp=s(gt,"P",{});var Ex=a(Bp);r1=i(Ex,"Finally, this model supports inherent JAX features such as:"),Ex.forEach(t),i1=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zx=a(Up);$i=s(zx,"A",{href:!0,rel:!0});var qx=a($i);l1=i(qx,"Just-In-Time (JIT) compilation"),qx.forEach(t),zx.forEach(t),d1=h(ra),Hp=s(ra,"LI",{});var Cx=a(Hp);Fi=s(Cx,"A",{href:!0,rel:!0});var jx=a(Fi);c1=i(jx,"Automatic Differentiation"),jx.forEach(t),Cx.forEach(t),p1=h(ra),Qp=s(ra,"LI",{});var Px=a(Qp);xi=s(Px,"A",{href:!0,rel:!0});var Lx=a(xi);h1=i(Lx,"Vectorization"),Lx.forEach(t),Px.forEach(t),u1=h(ra),Jp=s(ra,"LI",{});var Ax=a(Jp);Ri=s(Ax,"A",{href:!0,rel:!0});var Ox=a(Ri);f1=i(Ox,"Parallelization"),Ox.forEach(t),Ax.forEach(t),ra.forEach(t),m1=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),g1=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_1=i(sc,"The "),Vp=s(sc,"CODE",{});var Nx=a(Vp);b1=i(Nx,"FlaxRobertaPreTrainedModel"),Nx.forEach(t),k1=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var Ix=a(Kp);v1=i(Ix,"__call__"),Ix.forEach(t),T1=i(sc," special method."),sc.forEach(t),y1=h(ia),y(Ps.$$.fragment,ia),w1=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Dm=a(en);As=s(Dm,"A",{id:!0,class:!0,href:!0});var Dx=a(As);Gp=s(Dx,"SPAN",{});var Sx=a(Gp);y(Ei.$$.fragment,Sx),Sx.forEach(t),Dx.forEach(t),$1=h(Dm),Xp=s(Dm,"SPAN",{});var Wx=a(Xp);F1=i(Wx,"FlaxRobertaForCausalLM"),Wx.forEach(t),Dm.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),x1=h(_t),Yp=s(_t,"P",{});var Bx=a(Yp);R1=i(Bx,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),Bx.forEach(t),M1=h(_t),qi=s(_t,"P",{});var Sm=a(qi);E1=i(Sm,"This model inherits from "),jd=s(Sm,"A",{href:!0});var Ux=a(jd);z1=i(Ux,"FlaxPreTrainedModel"),Ux.forEach(t),q1=i(Sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Sm.forEach(t),C1=h(_t),Ci=s(_t,"P",{});var Wm=a(Ci);j1=i(Wm,"This model is also a Flax Linen "),ji=s(Wm,"A",{href:!0,rel:!0});var Hx=a(ji);P1=i(Hx,"flax.linen.Module"),Hx.forEach(t),L1=i(Wm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
