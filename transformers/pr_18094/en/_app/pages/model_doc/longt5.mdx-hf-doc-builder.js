...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),k(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),y(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),v(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(z){let l,b,m,p,_,n,c,L,la,bn,ee,ge,fo,Ke,ca,_o,pa,kn,fe,ua,Ze,ha,ma,yn,Yt,ga,vn,Rt,To,fa,wn,Jt,_a,$n,C,O,Vt,Ta,ba,Kt,ka,ya,bo,va,wa,ko,$a,xa,yo,za,La,vo,qa,ja,Fa,Qe,Ma,wo,Ea,Ca,Oa,Xe,Pa,$o,Ga,Sa,Aa,j,Na,xo,Ia,Da,zo,Ba,Wa,Lo,Ua,Ha,qo,Ya,Ra,jo,Ja,Va,Fo,Ka,Za,Qa,q,Mo,Xa,es,Eo,ts,os,Co,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,zn,Q,_s,nt,Ts,bs,at,ks,ys,Ln,te,_e,Ao,st,vs,No,ws,qn,K,rt,$s,Z,xs,Zt,zs,Ls,Qt,qs,js,dt,Fs,Ms,Es,oe,Cs,Xt,Os,Ps,eo,Gs,Ss,jn,ne,Te,Io,it,As,Do,Ns,Fn,F,lt,Is,Bo,Ds,Bs,ct,Ws,pt,Us,Hs,Ys,ut,Rs,to,Js,Vs,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,oo,nr,ar,Wo,sr,rr,dr,be,ir,ke,Mn,se,ye,Uo,ft,lr,Ho,cr,En,M,_t,pr,Tt,ur,Yo,hr,mr,gr,bt,fr,kt,_r,Tr,br,yt,kr,no,yr,vr,wr,vt,$r,wt,xr,zr,Lr,B,$t,qr,re,jr,ao,Fr,Mr,Ro,Er,Cr,Or,ve,Pr,we,Cn,de,$e,Jo,xt,Gr,Vo,Sr,On,E,zt,Ar,Ko,Nr,Ir,Lt,Dr,qt,Br,Wr,Ur,jt,Hr,so,Yr,Rr,Jr,Ft,Vr,Mt,Kr,Zr,Qr,W,Et,Xr,ie,ed,ro,td,od,Zo,nd,ad,sd,xe,rd,ze,Pn,le,Le,Qo,Ct,dd,Xo,id,Gn,A,Ot,ld,U,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,je,Td,Fe,Gt,bd,Me,kd,Ee,St,yd,Ce,Sn,pe,Oe,on,At,vd,nn,wd,An,N,Nt,$d,H,It,xd,ue,zd,an,Ld,qd,sn,jd,Fd,Md,Pe,Ed,Ge,Cd,Se,Dt,Od,Ae,Pd,Ne,Bt,Gd,Ie,Nn;return n=new Ve({}),Ke=new Ve({}),ot=new X({props:{code:`import evaluate
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18094/en/model_doc/longt5#transformers.LongT5Model">LongT5Model</a>.`,name:"vocab_size"},{anchor:"transformers.LongT5Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/longt5/configuration_longt5.py#L33"}}),it=new Ve({}),lt=new G({props:{name:"class transformers.LongT5Model",anchor:"transformers.LongT5Model",parameters:[{name:"config",val:": LongT5Config"}],parametersDescription:[{anchor:"transformers.LongT5Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18094/en/model_doc/longt5#transformers.LongT5Config">LongT5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18094/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/longt5/modeling_longt5.py#L1725"}}),gt=new G({props:{name:"forward",anchor:"transformers.LongT5Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18094/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18094/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18094/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18094/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/longt5/modeling_longt5.py#L1775",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18094/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18094/en/model_doc/longt5#transformers.LongT5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/longt5/modeling_longt5.py#L1931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18094/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18094/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/longt5/modeling_longt5.py#L2120"}}),Et=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18094/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18094/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18094/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18094/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/longt5/modeling_longt5.py#L2155",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/longt5/modeling_flax_longt5.py#L1695",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18094/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_18094/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_18094/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
and behavior.`),er=u(),D=r("div"),k(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),oo=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Wo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),k(be.$$.fragment),ir=u(),k(ke.$$.fragment),Mn=u(),se=r("h2"),ye=r("a"),Uo=r("span"),k(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),En=u(),M=r("div"),k(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Yo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),kt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
a few new parameters \u2014 global relative position biases and a layer normalization for global token\u2019s embedding.
The complexity of this mechanism is `),So=d(P,"CODE",{});var ni=i(So);ps=s(ni,"O(l(r + l/k))"),ni.forEach(o),us=s(P,"."),P.forEach(o),hs=h(Y),et=d(Y,"LI",{});var Bn=i(et);ms=s(Bn,"An example showing how to evaluate a fine-tuned LongT5 model on the "),tt=d(Bn,"A",{href:!0,rel:!0});var ai=i(tt);gs=s(ai,"pubmed dataset"),ai.forEach(o),fs=s(Bn," is below."),Bn.forEach(o),Y.forEach(o),xn=h(t),y(ot.$$.fragment,t),zn=h(t),Q=d(t,"P",{});var io=i(Q);_s=s(io,"This model was contributed by "),nt=d(io,"A",{href:!0,rel:!0});var si=i(nt);Ts=s(si,"stancld"),si.forEach(o),bs=s(io,`.
The original code can be found `),at=d(io,"A",{href:!0,rel:!0});var ri=i(at);ks=s(ri,"here"),ri.forEach(o),ys=s(io,"."),io.forEach(o),Ln=h(t),te=d(t,"H2",{class:!0});var Wn=i(te);_e=d(Wn,"A",{id:!0,class:!0,href:!0});var di=i(_e);Ao=d(di,"SPAN",{});var ii=i(Ao);y(st.$$.fragment,ii),ii.forEach(o),di.forEach(o),vs=h(Wn),No=d(Wn,"SPAN",{});var li=i(No);ws=s(li,"LongT5Config"),li.forEach(o),Wn.forEach(o),qn=h(t),K=d(t,"DIV",{class:!0});var lo=i(K);y(rt.$$.fragment,lo),$s=h(lo),Z=d(lo,"P",{});var De=i(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Zt=d(De,"A",{href:!0});var ci=i(Zt);zs=s(ci,"LongT5Model"),ci.forEach(o),Ls=s(De," or a "),Qt=d(De,"A",{href:!0});var pi=i(Qt);qs=s(pi,"FlaxLongT5Model"),pi.forEach(o),js=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
...
documentation from `),eo=d(co,"A",{href:!0});var mi=i(eo);Gs=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(co," for more information."),co.forEach(o),lo.forEach(o),jn=h(t),ne=d(t,"H2",{class:!0});var Un=i(ne);Te=d(Un,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);y(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),As=h(Un),Do=d(Un,"SPAN",{});var _i=i(Do);Ns=s(_i,"LongT5Model"),_i.forEach(o),Un.forEach(o),Fn=h(t),F=d(t,"DIV",{class:!0});var R=i(F);y(lt.$$.fragment,R),Is=h(R),Bo=d(R,"P",{});var Ti=i(Bo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Bs=h(R),ct=d(R,"P",{});var Hn=i(ct);Ws=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var bi=i(pt);Us=s(bi,`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rn.forEach(o),er=h(R),D=d(R,"DIV",{class:!0});var Be=i(D);y(gt.$$.fragment,Be),tr=h(Be),ae=d(Be,"P",{});var po=i(ae);or=s(po,"The "),oo=d(po,"A",{href:!0});var vi=i(oo);nr=s(vi,"LongT5Model"),vi.forEach(o),ar=s(po," forward method, overrides the "),Wo=d(po,"CODE",{});var wi=i(Wo);sr=s(wi,"__call__"),wi.forEach(o),rr=s(po," special method."),po.forEach(o),dr=h(Be),y(be.$$.fragment,Be),ir=h(Be),y(ke.$$.fragment,Be),Be.forEach(o),R.forEach(o),Mn=h(t),se=d(t,"H2",{class:!0});var Jn=i(se);ye=d(Jn,"A",{id:!0,class:!0,href:!0});var $i=i(ye);Uo=d($i,"SPAN",{});var xi=i(Uo);y(ft.$$.fragment,xi),xi.forEach(o),$i.forEach(o),lr=h(Jn),Ho=d(Jn,"SPAN",{});var zi=i(Ho);cr=s(zi,"LongT5ForConditionalGeneration"),zi.forEach(o),Jn.forEach(o),En=h(t),M=d(t,"DIV",{class:!0});var J=i(M);y(_t.$$.fragment,J),pr=h(J),Tt=d(J,"P",{});var Vn=i(Tt);ur=s(Vn,"LONGT5 Model with a "),Yo=d(Vn,"CODE",{});var Li=i(Yo);hr=s(Li,"language modeling"),Li.forEach(o),mr=s(Vn," head on top."),Vn.forEach(o),gr=h(J),bt=d(J,"P",{});var Kn=i(bt);fr=s(Kn,"The LongT5 model was proposed in "),kt=d(Kn,"A",{href:!0,rel:!0});var qi=i(kt);_r=s(qi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),qi.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),br=h(J),yt=d(J,"P",{});var Zn=i(yt);kr=s(Zn,"This model inherits from "),no=d(Zn,"A",{href:!0});var ji=i(no);yr=s(ji,"PreTrainedModel"),ji.forEach(o),vr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zn.forEach(o),wr=h(J),vt=d(J,"P",{});var Qn=i(vt);$r=s(Qn,"This model is also a PyTorch "),wt=d(Qn,"A",{href:!0,rel:!0});var Fi=i(wt);xr=s(Fi,"torch.nn.Module"),Fi.forEach(o),zr=s(Qn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),Lr=h(J),B=d(J,"DIV",{class:!0});var We=i(B);y($t.$$.fragment,We),qr=h(We),re=d(We,"P",{});var uo=i(re);jr=s(uo,"The "),ao=d(uo,"A",{href:!0});var Mi=i(ao);Fr=s(Mi,"LongT5ForConditionalGeneration"),Mi.forEach(o),Mr=s(uo," forward method, overrides the "),Ro=d(uo,"CODE",{});var Ei=i(Ro);Er=s(Ei,"__call__"),Ei.forEach(o),Cr=s(uo," special method."),uo.forEach(o),Or=h(We),y(ve.$$.fragment,We),Pr=h(We),y(we.$$.fragment,We),We.forEach(o),J.forEach(o),Cn=h(t),de=d(t,"H2",{class:!0});var Xn=i(de);$e=d(Xn,"A",{id:!0,class:!0,href:!0});var Ci=i($e);Jo=d(Ci,"SPAN",{});var Oi=i(Jo);y(xt.$$.fragment,Oi),Oi.forEach(o),Ci.forEach(o),Gr=h(Xn),Vo=d(Xn,"SPAN",{});var Pi=i(Vo);Sr=s(Pi,"LongT5EncoderModel"),Pi.forEach(o),Xn.forEach(o),On=h(t),E=d(t,"DIV",{class:!0});var V=i(E);y(zt.$$.fragment,V),Ar=h(V),Ko=d(V,"P",{});var Gi=i(Ko);Nr=s(Gi,"The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Gi.forEach(o),Ir=h(V),Lt=d(V,"P",{});var ea=i(Lt);Dr=s(ea,"The LongT5 model was proposed in "),qt=d(ea,"A",{href:!0,rel:!0});var Si=i(qt);Br=s(Si,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Si.forEach(o),Wr=s(ea,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),ea.forEach(o),Ur=h(V),jt=d(V,"P",{});var ta=i(jt);Hr=s(ta,"This model inherits from "),so=d(ta,"A",{href:!0});var Ai=i(so);Yr=s(Ai,"PreTrainedModel"),Ai.forEach(o),Rr=s(ta,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
