import{S as py,i as hy,s as my,e as r,k as h,w as v,t as n,M as uy,c as a,d as t,m,a as i,x as y,h as s,b,G as e,g,y as w,q as M,o as $,B as F,v as fy,L as xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Pe}from"../../chunks/Tip-hf-doc-builder.js";import{D as ie}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ze}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as qe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function gy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertModel, MobileBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=r("p"),_=n("Example:"),c=h(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=m(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function jy(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,_),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function Cy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertTokenizer, MobileBertForTokenClassification
import torch
...
first positional argument :`),G=h(),P=r("ul"),j=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=h(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),ke.forEach(t),G=m(f),P=a(f,"UL",{});var C=i(P);j=a(C,"LI",{});var I=i(j);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=m(C),q=a(C,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function mw(E){let d,_,c,p,T,l,u,x,he,V,z,J,L,X,me,D,ue,le,K,N,ee,G,P,j,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be,f,B,Y,ve,$e,S,we,Te,ke,C,I,Fe,ye,Q,Me,te,oe,Be,Mt,Ep,ya,xp,zp,wa,Pp,qp,is,jp,Cp,Np,Wt,Op,Ma,Sp,Ap,$a,Ip,Lp,Dp,jo,Wp,qi,Rp,Ad,Rt,Co,ji,ls,Up,Ci,Hp,Id,st,ds,Qp,Ni,Kp,Vp,No,Fa,Gp,Yp,Ba,Jp,Zp,Xp,cs,eh,Ea,th,oh,Ld,Ut,Oo,Oi,ps,nh,Si,sh,Dd,rt,hs,rh,ms,ah,Ai,ih,lh,dh,So,xa,ch,ph,za,hh,mh,uh,us,fh,Pa,gh,_h,Wd,Ht,Ao,Ii,fs,bh,Li,Th,Rd,Qt,gs,kh,_s,vh,qa,yh,wh,Ud,Kt,bs,Mh,Ts,$h,ja,Fh,Bh,Hd,Vt,Io,Di,ks,Eh,Wi,xh,Qd,Ce,vs,zh,Ri,Ph,qh,ys,jh,Ca,Ch,Nh,Oh,ws,Sh,Ms,Ah,Ih,Lh,Ui,$s,Dh,Wh,it,Fs,Rh,Gt,Uh,Na,Hh,Qh,Hi,Kh,Vh,Gh,Lo,Yh,Do,Kd,Yt,Wo,Qi,Bs,Jh,Ki,Zh,Vd,Re,Es,Xh,Jt,em,Vi,tm,om,Gi,nm,sm,rm,xs,am,Oa,im,lm,dm,zs,cm,Ps,pm,hm,mm,lt,qs,um,Zt,fm,Sa,gm,_m,Yi,bm,Tm,km,Ro,vm,Uo,Gd,Xt,Ho,Ji,js,ym,Zi,wm,Yd,Ue,Cs,Mm,Ns,$m,Xi,Fm,Bm,Em,Os,xm,Aa,zm,Pm,qm,Ss,jm,As,Cm,Nm,Om,Ye,Is,Sm,eo,Am,Ia,Im,Lm,el,Dm,Wm,Rm,Qo,Um,Ko,Hm,Vo,Jd,to,Go,tl,Ls,Qm,ol,Km,Zd,He,Ds,Vm,Ws,Gm,nl,Ym,Jm,Zm,Rs,Xm,La,eu,tu,ou,Us,nu,Hs,su,ru,au,dt,Qs,iu,oo,lu,Da,du,cu,sl,pu,hu,mu,Yo,uu,Jo,Xd,no,Zo,rl,Ks,fu,al,gu,ec,Qe,Vs,_u,il,bu,Tu,Gs,ku,Wa,vu,yu,wu,Ys,Mu,Js,$u,Fu,Bu,je,Zs,Eu,so,xu,Ra,zu,Pu,ll,qu,ju,Cu,Xo,Nu,en,Ou,tn,Su,on,Au,nn,tc,ro,sn,dl,Xs,Iu,cl,Lu,oc,Ke,er,Du,pl,Wu,Ru,tr,Uu,Ua,Hu,Qu,Ku,or,Vu,nr,Gu,Yu,Ju,ct,sr,Zu,ao,Xu,Ha,ef,tf,hl,of,nf,sf,rn,rf,an,nc,io,ln,ml,rr,af,ul,lf,sc,Ve,ar,df,fl,cf,pf,ir,hf,Qa,mf,uf,ff,lr,gf,dr,_f,bf,Tf,Je,cr,kf,lo,vf,Ka,yf,wf,gl,Mf,$f,Ff,dn,Bf,cn,Ef,pn,rc,co,hn,_l,pr,xf,bl,zf,ac,Ge,hr,Pf,po,qf,Tl,jf,Cf,kl,Nf,Of,Sf,mr,Af,Va,If,Lf,Df,ur,Wf,fr,Rf,Uf,Hf,Ze,gr,Qf,ho,Kf,Ga,Vf,Gf,vl,Yf,Jf,Zf,mn,Xf,un,eg,fn,ic,mo,gn,yl,_r,tg,wl,og,lc,Ne,br,ng,Ml,sg,rg,Tr,ag,Ya,ig,lg,dg,kr,cg,vr,pg,hg,mg,_n,ug,pt,yr,fg,uo,gg,Ja,_g,bg,$l,Tg,kg,vg,bn,yg,Tn,dc,fo,kn,Fl,wr,wg,Bl,Mg,cc,Oe,Mr,$g,go,Fg,El,Bg,Eg,xl,xg,zg,Pg,$r,qg,Za,jg,Cg,Ng,Fr,Og,Br,Sg,Ag,Ig,vn,Lg,ht,Er,Dg,_o,Wg,Xa,Rg,Ug,zl,Hg,Qg,Kg,yn,Vg,wn,pc,bo,Mn,Pl,xr,Gg,ql,Yg,hc,Se,zr,Jg,Pr,Zg,jl,Xg,e_,t_,qr,o_,ei,n_,s_,r_,jr,a_,Cr,i_,l_,d_,$n,c_,Xe,Nr,p_,To,h_,ti,m_,u_,Cl,f_,g_,__,Fn,b_,Bn,T_,En,mc,ko,xn,Nl,Or,k_,Ol,v_,uc,Ae,Sr,y_,Ar,w_,Sl,M_,$_,F_,Ir,B_,oi,E_,x_,z_,Lr,P_,Dr,q_,j_,C_,zn,N_,mt,Wr,O_,vo,S_,ni,A_,I_,Al,L_,D_,W_,Pn,R_,qn,fc,yo,jn,Il,Rr,U_,Ll,H_,gc,Ie,Ur,Q_,Dl,K_,V_,Hr,G_,si,Y_,J_,Z_,Qr,X_,Kr,eb,tb,ob,Cn,nb,et,Vr,sb,wo,rb,ri,ab,ib,Wl,lb,db,cb,Nn,pb,On,hb,Sn,_c,Mo,An,Rl,Gr,mb,Ul,ub,bc,Le,Yr,fb,Hl,gb,_b,Jr,bb,ai,Tb,kb,vb,Zr,yb,Xr,wb,Mb,$b,In,Fb,ut,ea,Bb,$o,Eb,ii,xb,zb,Ql,Pb,qb,jb,Ln,Cb,Dn,Tc,Fo,Wn,Kl,ta,Nb,Vl,Ob,kc,De,oa,Sb,Gl,Ab,Ib,na,Lb,li,Db,Wb,Rb,sa,Ub,ra,Hb,Qb,Kb,Rn,Vb,tt,aa,Gb,Bo,Yb,di,Jb,Zb,Yl,Xb,eT,tT,Un,oT,Hn,nT,Qn,vc,Eo,Kn,Jl,ia,sT,Zl,rT,yc,We,la,aT,xo,iT,Xl,lT,dT,ed,cT,pT,hT,da,mT,ci,uT,fT,gT,ca,_T,pa,bT,TT,kT,Vn,vT,ot,ha,yT,zo,wT,pi,MT,$T,td,FT,BT,ET,Gn,xT,Yn,zT,Jn,wc;return l=new qe({}),X=new qe({}),I=new qe({}),oe=new ie({props:{name:"class transformers.MobileBertConfig",anchor:"transformers.MobileBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 512"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 512"},{name:"hidden_act",val:" = 'relu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"embedding_size",val:" = 128"},{name:"trigram_input",val:" = True"},{name:"use_bottleneck",val:" = True"},{name:"intra_bottleneck_size",val:" = 128"},{name:"use_bottleneck_attention",val:" = False"},{name:"key_query_shared_bottleneck",val:" = True"},{name:"num_feedforward_networks",val:" = 4"},{name:"normalization_type",val:" = 'no_norm'"},{name:"classifier_activation",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MobileBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_18094/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_18094/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_18094/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18094/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_mobilebert.py#L950",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18094/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
`}}),Ro=new Pe({props:{$$slots:{default:[Ty]},$$scope:{ctx:E}}}),Uo=new Ee({props:{anchor:"transformers.MobileBertForPreTraining.forward.example",$$slots:{default:[ky]},$$scope:{ctx:E}}}),js=new qe({}),Cs=new ie({props:{name:"class transformers.MobileBertForMaskedLM",anchor:"transformers.MobileBertForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MobileBertForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18094/en/model_doc/mobilebert#transformers.MobileBertConfig">MobileBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_mobilebert.py#L1059",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_mobilebert.py#L1145",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_mobilebert.py#L1255",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_mobilebert.py#L1466",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_mobilebert.py#L1568",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_mobilebert.py#L1358",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18094/en/model_doc/mobilebert#transformers.MobileBertTokenizer">MobileBertTokenizer</a>. See <a href="/docs/transformers/pr_18094/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18094/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18094/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18094/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
...
approaches.`),j=h(),ne=r("p"),U=n("The abstract from the paper is the following:"),de=h(),se=r("p"),W=r("em"),fe=n(`Natural Language Processing (NLP) has recently achieved great success by using huge pre-trained models with hundreds
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mm=h(),lt=r("div"),v(qs.$$.fragment),um=h(),Zt=r("p"),fm=n("The "),Sa=r("a"),gm=n("MobileBertForPreTraining"),_m=n(" forward method, overrides the "),Yi=r("code"),bm=n("__call__"),Tm=n(" special method."),km=h(),v(Ro.$$.fragment),vm=h(),v(Uo.$$.fragment),Gd=h(),Xt=r("h2"),Ho=r("a"),Ji=r("span"),v(js.$$.fragment),ym=h(),Zi=r("span"),wm=n("MobileBertForMaskedLM"),Yd=h(),Ue=r("div"),v(Cs.$$.fragment),Mm=h(),Ns=r("p"),$m=n("MobileBert Model with a "),Xi=r("code"),Fm=n("language modeling"),Bm=n(" head on top."),Em=h(),Os=r("p"),xm=n("This model inherits from "),Aa=r("a"),zm=n("PreTrainedModel"),Pm=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bu=h(),je=r("div"),v(Zs.$$.fragment),Eu=h(),so=r("p"),xu=n("The "),Ra=r("a"),zu=n("MobileBertForSequenceClassification"),Pu=n(" forward method, overrides the "),ll=r("code"),qu=n("__call__"),ju=n(" special method."),Cu=h(),v(Xo.$$.fragment),Nu=h(),v(en.$$.fragment),Ou=h(),v(tn.$$.fragment),Su=h(),v(on.$$.fragment),Au=h(),v(nn.$$.fragment),tc=h(),ro=r("h2"),sn=r("a"),dl=r("span"),v(Xs.$$.fragment),Iu=h(),cl=r("span"),Lu=n("MobileBertForMultipleChoice"),oc=h(),Ke=r("div"),v(er.$$.fragment),Du=h(),pl=r("p"),Wu=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
linear layers on top of the hidden-states output to compute `),Tl=r("code"),jf=n("span start logits"),Cf=n(" and "),kl=r("code"),Nf=n("span end logits"),Of=n(")."),Sf=h(),mr=r("p"),Af=n("This model inherits from "),Va=r("a"),If=n("PreTrainedModel"),Lf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),d_=h(),v($n.$$.fragment),c_=h(),Xe=r("div"),v(Nr.$$.fragment),p_=h(),To=r("p"),h_=n("The "),ti=r("a"),m_=n("TFMobileBertForMaskedLM"),u_=n(" forward method, overrides the "),Cl=r("code"),f_=n("__call__"),g_=n(" special method."),__=h(),v(Fn.$$.fragment),b_=h(),v(Bn.$$.fragment),T_=h(),v(En.$$.fragment),mc=h(),ko=r("h2"),xn=r("a"),Nl=r("span"),v(Or.$$.fragment),k_=h(),Ol=r("span"),v_=n("TFMobileBertForNextSentencePrediction"),uc=h(),Ae=r("div"),v(Sr.$$.fragment),y_=h(),Ar=r("p"),w_=n("MobileBert Model with a "),Sl=r("code"),M_=n("next sentence prediction (classification)"),$_=n(" head on top."),F_=h(),Ir=r("p"),B_=n("This model inherits from "),oi=r("a"),E_=n("TFPreTrainedModel"),x_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),z_=h(),Lr=r("p"),P_=n("This model is also a "),Dr=r("a"),q_=n("tf.keras.Model"),j_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),C_=h(),v(zn.$$.fragment),N_=h(),mt=r("div"),v(Wr.$$.fragment),O_=h(),vo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),L_=n("__call__"),D_=n(" special method."),W_=h(),v(Pn.$$.fragment),R_=h(),v(qn.$$.fragment),fc=h(),yo=r("h2"),jn=r("a"),Il=r("span"),v(Rr.$$.fragment),U_=h(),Ll=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=h(),Ie=r("div"),v(Ur.$$.fragment),Q_=h(),Dl=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ob=h(),v(Cn.$$.fragment),nb=h(),et=r("div"),v(Vr.$$.fragment),sb=h(),wo=r("p"),rb=n("The "),ri=r("a"),ab=n("TFMobileBertForSequenceClassification"),ib=n(" forward method, overrides the "),Wl=r("code"),lb=n("__call__"),db=n(" special method."),cb=h(),v(Nn.$$.fragment),pb=h(),v(On.$$.fragment),hb=h(),v(Sn.$$.fragment),_c=h(),Mo=r("h2"),An=r("a"),Rl=r("span"),v(Gr.$$.fragment),mb=h(),Ul=r("span"),ub=n("TFMobileBertForMultipleChoice"),bc=h(),Le=r("div"),v(Yr.$$.fragment),fb=h(),Hl=r("p"),gb=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Zhou. It\u2019s a bidirectional transformer based on the BERT model, which is compressed and accelerated using several
approaches.`),fa.forEach(t),j=m(o),ne=a(o,"P",{});var dd=i(ne);U=s(dd,"The abstract from the paper is the following:"),dd.forEach(t),de=m(o),se=a(o,"P",{});var cd=i(se);W=a(cd,"EM",{});var pd=i(W);fe=s(pd,`Natural Language Processing (NLP) has recently achieved great success by using huge pre-trained models with hundreds
of millions of parameters. However, these models suffer from heavy model sizes and high latency such that they cannot
be deployed to resource-limited mobile devices. In this paper, we propose MobileBERT for compressing and accelerating
the popular BERT model. Like the original BERT, MobileBERT is task-agnostic, that is, it can be generically applied to
various downstream NLP tasks via simple fine-tuning. Basically, MobileBERT is a thin version of BERT_LARGE, while
...
splitting and wordpiece.`),Sd.forEach(t),uh=m(Bt),us=a(Bt,"P",{});var Mc=i(us);fh=s(Mc,"Refer to superclass "),Pa=a(Mc,"A",{href:!0});var jT=i(Pa);gh=s(jT,"BertTokenizerFast"),jT.forEach(t),_h=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=m(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var CT=i(Ao);Ii=a(CT,"SPAN",{});var NT=i(Ii);y(fs.$$.fragment,NT),NT.forEach(t),CT.forEach(t),bh=m($c),Li=a($c,"SPAN",{});var OT=i(Li);Th=s(OT,"MobileBert specific outputs"),OT.forEach(t),$c.forEach(t),Rd=m(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);y(gs.$$.fragment,Fc),kh=m(Fc),_s=a(Fc,"P",{});var Bc=i(_s);vh=s(Bc,"Output type of "),qa=a(Bc,"A",{href:!0});var ST=i(qa);yh=s(ST,"MobileBertForPreTraining"),ST.forEach(t),wh=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=m(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);y(bs.$$.fragment,Ec),Mh=m(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$h=s(xc,"Output type of "),ja=a(xc,"A",{href:!0});var AT=i(ja);Fh=s(AT,"TFMobileBertForPreTraining"),AT.forEach(t),Bh=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=m(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var IT=i(Io);Di=a(IT,"SPAN",{});var LT=i(Di);y(ks.$$.fragment,LT),LT.forEach(t),IT.forEach(t),Eh=m(zc),Wi=a(zc,"SPAN",{});var DT=i(Wi);xh=s(DT,"MobileBertModel"),DT.forEach(t),zc.forEach(t),Qd=m(o),Ce=a(o,"DIV",{class:!0});var ft=i(Ce);y(vs.$$.fragment,ft),zh=m(ft),Ri=a(ft,"P",{});var WT=i(Ri);Ph=s(WT,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),WT.forEach(t),qh=m(ft),ys=a(ft,"P",{});var Pc=i(ys);jh=s(Pc,"This model inherits from "),Ca=a(Pc,"A",{href:!0});var RT=i(Ca);Ch=s(RT,"PreTrainedModel"),RT.forEach(t),Nh=s(Pc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=m(qt),je=a(qt,"DIV",{class:!0});var nt=i(je);y(Zs.$$.fragment,nt),Eu=m(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var Fk=i(Ra);zu=s(Fk,"MobileBertForSequenceClassification"),Fk.forEach(t),Pu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var Bk=i(ll);qu=s(Bk,"__call__"),Bk.forEach(t),ju=s(_i," special method."),_i.forEach(t),Cu=m(nt),y(Xo.$$.fragment,nt),Nu=m(nt),y(en.$$.fragment,nt),Ou=m(nt),y(tn.$$.fragment,nt),Su=m(nt),y(on.$$.fragment,nt),Au=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var Ek=i(sn);dl=a(Ek,"SPAN",{});var xk=i(dl);y(Xs.$$.fragment,xk),xk.forEach(t),Ek.forEach(t),Iu=m(Kc),cl=a(Kc,"SPAN",{});var zk=i(cl);Lu=s(zk,"MobileBertForMultipleChoice"),zk.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var jt=i(Ke);y(er.$$.fragment,jt),Du=m(jt),pl=a(jt,"P",{});var Pk=i(pl);Wu=s(Pk,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Pk.forEach(t),Ru=m(jt),tr=a(jt,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qk=i(Ua);Hu=s(qk,"PreTrainedModel"),qk.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),Ku=m(jt),or=a(jt,"P",{});var Gc=i(or);Vu=s(Gc,"This model is also a PyTorch "),nr=a(Gc,"A",{href:!0,rel:!0});var jk=i(nr);Gu=s(jk,"torch.nn.Module"),jk.forEach(t),Yu=s(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(t),Ju=m(jt),ct=a(jt,"DIV",{class:!0});var os=i(ct);y(sr.$$.fragment,os),Zu=m(os),ao=a(os,"P",{});var bi=i(ao);Xu=s(bi,"The "),Ha=a(bi,"A",{href:!0});var Ck=i(Ha);ef=s(Ck,"MobileBertForMultipleChoice"),Ck.forEach(t),tf=s(bi," forward method, overrides the "),hl=a(bi,"CODE",{});var Nk=i(hl);of=s(Nk,"__call__"),Nk.forEach(t),nf=s(bi," special method."),bi.forEach(t),sf=m(os),y(rn.$$.fragment,os),rf=m(os),y(an.$$.fragment,os),os.forEach(t),jt.forEach(t),nc=m(o),io=a(o,"H2",{class:!0});var Yc=i(io);ln=a(Yc,"A",{id:!0,class:!0,href:!0});var Ok=i(ln);ml=a(Ok,"SPAN",{});var Sk=i(ml);y(rr.$$.fragment,Sk),Sk.forEach(t),Ok.forEach(t),af=m(Yc),ul=a(Yc,"SPAN",{});var Ak=i(ul);lf=s(Ak,"MobileBertForTokenClassification"),Ak.forEach(t),Yc.forEach(t),sc=m(o),Ve=a(o,"DIV",{class:!0});var Ct=i(Ve);y(ar.$$.fragment,Ct),df=m(Ct),fl=a(Ct,"P",{});var Ik=i(fl);cf=s(Ik,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ik.forEach(t),pf=m(Ct),ir=a(Ct,"P",{});var Jc=i(ir);hf=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var Lk=i(Qa);mf=s(Lk,"PreTrainedModel"),Lk.forEach(t),uf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),ff=m(Ct),lr=a(Ct,"P",{});var Zc=i(lr);gf=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var Dk=i(dr);_f=s(Dk,"torch.nn.Module"),Dk.forEach(t),bf=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tf=m(Ct),Je=a(Ct,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),kf=m(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vf=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var Wk=i(Ka);yf=s(Wk,"MobileBertForTokenClassification"),Wk.forEach(t),wf=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var Rk=i(gl);Mf=s(Rk,"__call__"),Rk.forEach(t),$f=s(Ti," special method."),Ti.forEach(t),Ff=m(Nt),y(dn.$$.fragment,Nt),Bf=m(Nt),y(cn.$$.fragment,Nt),Ef=m(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),Ct.forEach(t),rc=m(o),co=a(o,"H2",{class:!0});var Xc=i(co);hn=a(Xc,"A",{id:!0,class:!0,href:!0});var Uk=i(hn);_l=a(Uk,"SPAN",{});var Hk=i(_l);y(pr.$$.fragment,Hk),Hk.forEach(t),Uk.forEach(t),xf=m(Xc),bl=a(Xc,"SPAN",{});var Qk=i(bl);zf=s(Qk,"MobileBertForQuestionAnswering"),Qk.forEach(t),Xc.forEach(t),ac=m(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(hr.$$.fragment,Ot),Pf=m(Ot),po=a(Ot,"P",{});var ki=i(po);qf=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var Kk=i(Tl);jf=s(Kk,"span start logits"),Kk.forEach(t),Cf=s(ki," and "),kl=a(ki,"CODE",{});var Vk=i(kl);Nf=s(Vk,"span end logits"),Vk.forEach(t),Of=s(ki,")."),ki.forEach(t),Sf=m(Ot),mr=a(Ot,"P",{});var ep=i(mr);Af=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var Gk=i(Va);If=s(Gk,"PreTrainedModel"),Gk.forEach(t),Lf=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),xl=a(wi,"CODE",{});var pv=i(xl);xg=s(pv,"next sentence prediction (classification)"),pv.forEach(t),zg=s(wi," head."),wi.forEach(t),Pg=m(_t),$r=a(_t,"P",{});var ap=i($r);qg=s(ap,"This model inherits from "),Za=a(ap,"A",{href:!0});var hv=i(Za);jg=s(hv,"TFPreTrainedModel"),hv.forEach(t),Cg=s(ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip.forEach(t),Ig=m(_t),y(vn.$$.fragment,_t),Lg=m(_t),ht=a(_t,"DIV",{class:!0});var ss=i(ht);y(Er.$$.fragment,ss),Dg=m(ss),_o=a(ss,"P",{});var Mi=i(_o);Wg=s(Mi,"The "),Xa=a(Mi,"A",{href:!0});var uv=i(Xa);Rg=s(uv,"TFMobileBertForPreTraining"),uv.forEach(t),Ug=s(Mi," forward method, overrides the "),zl=a(Mi,"CODE",{});var fv=i(zl);Hg=s(fv,"__call__"),fv.forEach(t),Qg=s(Mi," special method."),Mi.forEach(t),Kg=m(ss),y(yn.$$.fragment,ss),Vg=m(ss),y(wn.$$.fragment,ss),ss.forEach(t),_t.forEach(t),pc=m(o),bo=a(o,"H2",{class:!0});var lp=i(bo);Mn=a(lp,"A",{id:!0,class:!0,href:!0});var gv=i(Mn);Pl=a(gv,"SPAN",{});var _v=i(Pl);y(xr.$$.fragment,_v),_v.forEach(t),gv.forEach(t),Gg=m(lp),ql=a(lp,"SPAN",{});var bv=i(ql);Yg=s(bv,"TFMobileBertForMaskedLM"),bv.forEach(t),lp.forEach(t),hc=m(o),Se=a(o,"DIV",{class:!0});var bt=i(Se);y(zr.$$.fragment,bt),Jg=m(bt),Pr=a(bt,"P",{});var dp=i(Pr);Zg=s(dp,"MobileBert Model with a "),jl=a(dp,"CODE",{});var Tv=i(jl);Xg=s(Tv,"language modeling"),Tv.forEach(t),e_=s(dp," head on top."),dp.forEach(t),t_=m(bt),qr=a(bt,"P",{});var cp=i(qr);o_=s(cp,"This model inherits from "),ei=a(cp,"A",{href:!0});var kv=i(ei);n_=s(kv,"TFPreTrainedModel"),kv.forEach(t),s_=s(cp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cp.forEach(t),r_=m(bt),jr=a(bt,"P",{});var pp=i(jr);a_=s(pp,"This model is also a "),Cr=a(pp,"A",{href:!0,rel:!0});var vv=i(Cr);i_=s(vv,"tf.keras.Model"),vv.forEach(t),l_=s(pp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pp.forEach(t),d_=m(bt),y($n.$$.fragment,bt),c_=m(bt),Xe=a(bt,"DIV",{class:!0});var At=i(Xe);y(Nr.$$.fragment,At),p_=m(At),To=a(At,"P",{});var $i=i(To);h_=s($i,"The "),ti=a($i,"A",{href:!0});var yv=i(ti);m_=s(yv,"TFMobileBertForMaskedLM"),yv.forEach(t),u_=s($i," forward method, overrides the "),Cl=a($i,"CODE",{});var wv=i(Cl);f_=s(wv,"__call__"),wv.forEach(t),g_=s($i," special method."),$i.forEach(t),__=m(At),y(Fn.$$.fragment,At),b_=m(At),y(Bn.$$.fragment,At),T_=m(At),y(En.$$.fragment,At),At.forEach(t),bt.forEach(t),mc=m(o),ko=a(o,"H2",{class:!0});var hp=i(ko);xn=a(hp,"A",{id:!0,class:!0,href:!0});var Mv=i(xn);Nl=a(Mv,"SPAN",{});var $v=i(Nl);y(Or.$$.fragment,$v),$v.forEach(t),Mv.forEach(t),k_=m(hp),Ol=a(hp,"SPAN",{});var Fv=i(Ol);v_=s(Fv,"TFMobileBertForNextSentencePrediction"),Fv.forEach(t),hp.forEach(t),uc=m(o),Ae=a(o,"DIV",{class:!0});var Tt=i(Ae);y(Sr.$$.fragment,Tt),y_=m(Tt),Ar=a(Tt,"P",{});var mp=i(Ar);w_=s(mp,"MobileBert Model with a "),Sl=a(mp,"CODE",{});var Bv=i(Sl);M_=s(Bv,"next sentence prediction (classification)"),Bv.forEach(t),$_=s(mp," head on top."),mp.forEach(t),F_=m(Tt),Ir=a(Tt,"P",{});var up=i(Ir);B_=s(up,"This model inherits from "),oi=a(up,"A",{href:!0});var Ev=i(oi);E_=s(Ev,"TFPreTrainedModel"),Ev.forEach(t),x_=s(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=m(Tt),Lr=a(Tt,"P",{});var fp=i(Lr);P_=s(fp,"This model is also a "),Dr=a(fp,"A",{href:!0,rel:!0});var xv=i(Dr);q_=s(xv,"tf.keras.Model"),xv.forEach(t),j_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),C_=m(Tt),y(zn.$$.fragment,Tt),N_=m(Tt),mt=a(Tt,"DIV",{class:!0});var rs=i(mt);y(Wr.$$.fragment,rs),O_=m(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zv=i(ni);A_=s(zv,"TFMobileBertForNextSentencePrediction"),zv.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Pv=i(Al);L_=s(Pv,"__call__"),Pv.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=m(rs),y(Pn.$$.fragment,rs),R_=m(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=m(o),yo=a(o,"H2",{class:!0});var gp=i(yo);jn=a(gp,"A",{id:!0,class:!0,href:!0});var qv=i(jn);Il=a(qv,"SPAN",{});var jv=i(Il);y(Rr.$$.fragment,jv),jv.forEach(t),qv.forEach(t),U_=m(gp),Ll=a(gp,"SPAN",{});var Cv=i(Ll);H_=s(Cv,"TFMobileBertForSequenceClassification"),Cv.forEach(t),gp.forEach(t),gc=m(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=m(kt),Dl=a(kt,"P",{});var Nv=i(Dl);K_=s(Nv,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
