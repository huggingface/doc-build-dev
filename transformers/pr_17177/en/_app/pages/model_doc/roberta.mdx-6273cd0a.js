...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17177/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17177/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17177/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);T(qr.$$.fragment,po),Vv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Jv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var y0=a(bd);Kv=i(y0,"RobertaForQuestionAnswering"),y0.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var T0=a(pp);Xv=i(T0,"__call__"),T0.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),T(Zn.$$.fragment,po),e1=h(po),T(es.$$.fragment,po),t1=h(po),T(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w0=a(os);hp=s(w0,"SPAN",{});var $0=a(hp);T(jr.$$.fragment,$0),$0.forEach(t),w0.forEach(t),o1=h(gu),mp=s(gu,"SPAN",{});var F0=a(mp);n1=i(F0,"TFRobertaModel"),F0.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);T(Pr.$$.fragment,Ot),s1=h(Ot),fp=s(Ot,"P",{});var x0=a(fp);a1=i(x0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x0.forEach(t),r1=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);i1=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R0=a(kd);l1=i(R0,"TFPreTrainedModel"),R0.forEach(t),d1=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),c1=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);p1=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var M0=a(Or);h1=i(M0,"tf.keras.Model"),M0.forEach(t),m1=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),f1=h(Ot),T(ns.$$.fragment,Ot),u1=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);T(Nr.$$.fragment,na),g1=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_1=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E0=a(vd);b1=i(E0,"TFRobertaModel"),E0.forEach(t),k1=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z0=a(up);v1=i(z0,"__call__"),z0.forEach(t),y1=i(Gd," special method."),Gd.forEach(t),T1=h(na),T(ss.$$.fragment,na),w1=h(na),T(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var C0=a(rs);gp=s(C0,"SPAN",{});var q0=a(gp);T(Ir.$$.fragment,q0),q0.forEach(t),C0.forEach(t),$1=h(ku),_p=s(ku,"SPAN",{});var j0=a(_p);F1=i(j0,"TFRobertaForCausalLM"),j0.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);T(Dr.$$.fragment,vu),x1=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);T(Sr.$$.fragment,sa),R1=h(sa),Do=s(sa,"P",{});var Xd=a(Do);M1=i(Xd,"The "),yd=s(Xd,"A",{href:!0});var P0=a(yd);E1=i(P0,"TFRobertaForCausalLM"),P0.forEach(t),z1=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L0=a(bp);C1=i(L0,"__call__"),L0.forEach(t),q1=i(Xd," special method."),Xd.forEach(t),j1=h(sa),T(is.$$.fragment,sa),P1=h(sa),T(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var yu=a(So);ds=s(yu,"A",{id:!0,class:!0,href:!0});var A0=a(ds);kp=s(A0,"SPAN",{});var O0=a(kp);T(Wr.$$.fragment,O0),O0.forEach(t),A0.forEach(t),L1=h(yu),vp=s(yu,"SPAN",{});var N0=a(vp);A1=i(N0,"TFRobertaForMaskedLM"),N0.forEach(t),yu.forEach(t),_f=h(o),Ve=s(o,"DIV",{class:!0});var Nt=a(Ve);T(Br.$$.fragment,Nt),O1=h(Nt),Ur=s(Nt,"P",{});var Tu=a(Ur);N1=i(Tu,"RoBERTa Model with a "),yp=s(Tu,"CODE",{});var I0=a(yp);I1=i(I0,"language modeling"),I0.forEach(t),D1=i(Tu," head on top."),Tu.forEach(t),S1=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);W1=i(wu,"This model inherits from "),Td=s(wu,"A",{href:!0});var D0=a(Td);B1=i(D0,"TFPreTrainedModel"),D0.forEach(t),U1=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),H1=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Q1=i($u,"This model is also a "),Vr=s($u,"A",{href:!0,rel:!0});var S0=a(Vr);V1=i(S0,"tf.keras.Model"),S0.forEach(t),J1=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),K1=h(Nt),T(cs.$$.fragment,Nt),G1=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);T(Jr.$$.fragment,ho),X1=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Y1=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W0=a(wd);Z1=i(W0,"TFRobertaForMaskedLM"),W0.forEach(t),ey=i(Yd," forward method, overrides the "),Tp=s(Yd,"CODE",{});var B0=a(Tp);ty=i(B0,"__call__"),B0.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),T(ps.$$.fragment,ho),sy=h(ho),T(hs.$$.fragment,ho),ay=h(ho),T(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U0=a(fs);wp=s(U0,"SPAN",{});var H0=a(wp);T(Kr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),ry=h(Fu),$p=s(Fu,"SPAN",{});var Q0=a($p);iy=i(Q0,"TFRobertaForSequenceClassification"),Q0.forEach(t),Fu.forEach(t),kf=h(o),Je=s(o,"DIV",{class:!0});var It=a(Je);T(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var V0=a(Fp);dy=i(V0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),V0.forEach(t),cy=h(It),Xr=s(It,"P",{});var xu=a(Xr);py=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var J0=a($d);hy=i(J0,"TFPreTrainedModel"),J0.forEach(t),my=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),by=h(It),T(us.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vy=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yy=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G0=a(Fd);Ty=i(G0,"TFRobertaForSequenceClassification"),G0.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X0=a(xp);$y=i(X0,"__call__"),X0.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(mo),T(gs.$$.fragment,mo),Ry=h(mo),T(_s.$$.fragment,mo),My=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y0=a(ks);Rp=s(Y0,"SPAN",{});var Z0=a(Rp);T(ti.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),Ey=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),Cy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);qy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
