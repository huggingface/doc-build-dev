...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15775/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_15775/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_15775/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yf.forEach(t),Fy=h(Nt),y(bs.$$.fragment,Nt),xy=h(Nt),pt=s(Nt,"DIV",{class:!0});var co=a(pt);y(ti.$$.fragment,co),Ry=h(co),Uo=s(co,"P",{});var qd=a(Uo);My=i(qd,"The "),rd=s(qd,"A",{href:!0});var X0=a(rd);Ey=i(X0,"TFRobertaForTokenClassification"),X0.forEach(t),zy=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var Y0=a(dp);qy=i(Y0,"__call__"),Y0.forEach(t),Cy=i(qd," special method."),qd.forEach(t),jy=h(co),y(ks.$$.fragment,co),Py=h(co),y(vs.$$.fragment,co),Ly=h(co),y(Ts.$$.fragment,co),co.forEach(t),Nt.forEach(t),Wm=h(o),Ho=s(o,"H2",{class:!0});var Zf=a(Ho);ys=s(Zf,"A",{id:!0,class:!0,href:!0});var Z0=a(ys);cp=s(Z0,"SPAN",{});var e5=a(cp);y(oi.$$.fragment,e5),e5.forEach(t),Z0.forEach(t),Ay=h(Zf),pp=s(Zf,"SPAN",{});var t5=a(pp);Oy=i(t5,"TFRobertaForQuestionAnswering"),t5.forEach(t),Zf.forEach(t),Bm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);y(ni.$$.fragment,It),Ny=h(It),Qo=s(It,"P",{});var Cd=a(Qo);Iy=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Cd,"CODE",{});var o5=a(hp);Dy=i(o5,"span start logits"),o5.forEach(t),Sy=i(Cd," and "),mp=s(Cd,"CODE",{});var n5=a(mp);Wy=i(n5,"span end logits"),n5.forEach(t),By=i(Cd,")."),Cd.forEach(t),Uy=h(It),si=s(It,"P",{});var eu=a(si);Hy=i(eu,"This model inherits from "),id=s(eu,"A",{href:!0});var s5=a(id);Qy=i(s5,"TFPreTrainedModel"),s5.forEach(t),Vy=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),Jy=h(It),ai=s(It,"P",{});var tu=a(ai);Ky=i(tu,"This model is also a "),ri=s(tu,"A",{href:!0,rel:!0});var a5=a(ri);Gy=i(a5,"tf.keras.Model"),a5.forEach(t),Xy=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Yy=h(It),y(ws.$$.fragment,It),Zy=h(It),ht=s(It,"DIV",{class:!0});var po=a(ht);y(ii.$$.fragment,po),ew=h(po),Vo=s(po,"P",{});var jd=a(Vo);tw=i(jd,"The "),ld=s(jd,"A",{href:!0});var r5=a(ld);ow=i(r5,"TFRobertaForQuestionAnswering"),r5.forEach(t),nw=i(jd," forward method, overrides the "),fp=s(jd,"CODE",{});var i5=a(fp);sw=i(i5,"__call__"),i5.forEach(t),aw=i(jd," special method."),jd.forEach(t),rw=h(po),y($s.$$.fragment,po),iw=h(po),y(Fs.$$.fragment,po),lw=h(po),y(xs.$$.fragment,po),po.forEach(t),It.forEach(t),Um=h(o),Jo=s(o,"H2",{class:!0});var ou=a(Jo);Rs=s(ou,"A",{id:!0,class:!0,href:!0});var l5=a(Rs);up=s(l5,"SPAN",{});var d5=a(up);y(li.$$.fragment,d5),d5.forEach(t),l5.forEach(t),dw=h(ou),gp=s(ou,"SPAN",{});var c5=a(gp);cw=i(c5,"FlaxRobertaModel"),c5.forEach(t),ou.forEach(t),Hm=h(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(di.$$.fragment,ut),pw=h(ut),_p=s(ut,"P",{});var p5=a(_p);hw=i(p5,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),p5.forEach(t),mw=h(ut),ci=s(ut,"P",{});var nu=a(ci);fw=i(nu,"This model inherits from "),dd=s(nu,"A",{href:!0});var h5=a(dd);uw=i(h5,"FlaxPreTrainedModel"),h5.forEach(t),gw=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),nu.forEach(t),_w=h(ut),pi=s(ut,"P",{});var su=a(pi);bw=i(su,"This model is also a Flax Linen "),hi=s(su,"A",{href:!0,rel:!0});var m5=a(hi);kw=i(m5,"flax.linen.Module"),m5.forEach(t),vw=i(su,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),su.forEach(t),Tw=h(ut),bp=s(ut,"P",{});var f5=a(bp);yw=i(f5,"Finally, this model supports inherent JAX features such as:"),f5.forEach(t),ww=h(ut),St=s(ut,"UL",{});var Xs=a(St);kp=s(Xs,"LI",{});var u5=a(kp);mi=s(u5,"A",{href:!0,rel:!0});var g5=a(mi);$w=i(g5,"Just-In-Time (JIT) compilation"),g5.forEach(t),u5.forEach(t),Fw=h(Xs),vp=s(Xs,"LI",{});var _5=a(vp);fi=s(_5,"A",{href:!0,rel:!0});var b5=a(fi);xw=i(b5,"Automatic Differentiation"),b5.forEach(t),_5.forEach(t),Rw=h(Xs),Tp=s(Xs,"LI",{});var k5=a(Tp);ui=s(k5,"A",{href:!0,rel:!0});var v5=a(ui);Mw=i(v5,"Vectorization"),v5.forEach(t),k5.forEach(t),Ew=h(Xs),yp=s(Xs,"LI",{});var T5=a(yp);gi=s(T5,"A",{href:!0,rel:!0});var y5=a(gi);zw=i(y5,"Parallelization"),y5.forEach(t),T5.forEach(t),Xs.forEach(t),qw=h(ut),Mt=s(ut,"DIV",{class:!0});var Ys=a(Mt);y(_i.$$.fragment,Ys),Cw=h(Ys),Ko=s(Ys,"P",{});var Pd=a(Ko);jw=i(Pd,"The "),wp=s(Pd,"CODE",{});var w5=a(wp);Pw=i(w5,"FlaxRobertaPreTrainedModel"),w5.forEach(t),Lw=i(Pd," forward method, overrides the "),$p=s(Pd,"CODE",{});var $5=a($p);Aw=i($5,"__call__"),$5.forEach(t),Ow=i(Pd," special method."),Pd.forEach(t),Nw=h(Ys),y(Ms.$$.fragment,Ys),Iw=h(Ys),y(Es.$$.fragment,Ys),Ys.forEach(t),ut.forEach(t),Qm=h(o),Go=s(o,"H2",{class:!0});var au=a(Go);zs=s(au,"A",{id:!0,class:!0,href:!0});var F5=a(zs);Fp=s(F5,"SPAN",{});var x5=a(Fp);y(bi.$$.fragment,x5),x5.forEach(t),F5.forEach(t),Dw=h(au),xp=s(au,"SPAN",{});var R5=a(xp);Sw=i(R5,"FlaxRobertaForMaskedLM"),R5.forEach(t),au.forEach(t),Vm=h(o),Ne=s(o,"DIV",{class:!0});var gt=a(Ne);y(ki.$$.fragment,gt),Ww=h(gt),vi=s(gt,"P",{});var ru=a(vi);Bw=i(ru,"RoBERTa Model with a "),Rp=s(ru,"CODE",{});var M5=a(Rp);Uw=i(M5,"language modeling"),M5.forEach(t),Hw=i(ru," head on top."),ru.forEach(t),Qw=h(gt),Ti=s(gt,"P",{});var iu=a(Ti);Vw=i(iu,"This model inherits from "),cd=s(iu,"A",{href:!0});var E5=a(cd);Jw=i(E5,"FlaxPreTrainedModel"),E5.forEach(t),Kw=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Gw=h(gt),yi=s(gt,"P",{});var lu=a(yi);Xw=i(lu,"This model is also a Flax Linen "),wi=s(lu,"A",{href:!0,rel:!0});var z5=a(wi);Yw=i(z5,"flax.linen.Module"),z5.forEach(t),Zw=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),e1=h(gt),Mp=s(gt,"P",{});var q5=a(Mp);t1=i(q5,"Finally, this model supports inherent JAX features such as:"),q5.forEach(t),o1=h(gt),Wt=s(gt,"UL",{});var Zs=a(Wt);Ep=s(Zs,"LI",{});var C5=a(Ep);$i=s(C5,"A",{href:!0,rel:!0});var j5=a($i);n1=i(j5,"Just-In-Time (JIT) compilation"),j5.forEach(t),C5.forEach(t),s1=h(Zs),zp=s(Zs,"LI",{});var P5=a(zp);Fi=s(P5,"A",{href:!0,rel:!0});var L5=a(Fi);a1=i(L5,"Automatic Differentiation"),L5.forEach(t),P5.forEach(t),r1=h(Zs),qp=s(Zs,"LI",{});var A5=a(qp);xi=s(A5,"A",{href:!0,rel:!0});var O5=a(xi);i1=i(O5,"Vectorization"),O5.forEach(t),A5.forEach(t),l1=h(Zs),Cp=s(Zs,"LI",{});var N5=a(Cp);Ri=s(N5,"A",{href:!0,rel:!0});var I5=a(Ri);d1=i(I5,"Parallelization"),I5.forEach(t),N5.forEach(t),Zs.forEach(t),c1=h(gt),Et=s(gt,"DIV",{class:!0});var ea=a(Et);y(Mi.$$.fragment,ea),p1=h(ea),Xo=s(ea,"P",{});var Ld=a(Xo);h1=i(Ld,"The "),jp=s(Ld,"CODE",{});var D5=a(jp);m1=i(D5,"FlaxRobertaPreTrainedModel"),D5.forEach(t),f1=i(Ld," forward method, overrides the "),Pp=s(Ld,"CODE",{});var S5=a(Pp);u1=i(S5,"__call__"),S5.forEach(t),g1=i(Ld," special method."),Ld.forEach(t),_1=h(ea),y(qs.$$.fragment,ea),b1=h(ea),y(Cs.$$.fragment,ea),ea.forEach(t),gt.forEach(t),Jm=h(o),Yo=s(o,"H2",{class:!0});var du=a(Yo);js=s(du,"A",{id:!0,class:!0,href:!0});var W5=a(js);Lp=s(W5,"SPAN",{});var B5=a(Lp);y(Ei.$$.fragment,B5),B5.forEach(t),W5.forEach(t),k1=h(du),Ap=s(du,"SPAN",{});var U5=a(Ap);v1=i(U5,"FlaxRobertaForSequenceClassification"),U5.forEach(t),du.forEach(t),Km=h(o),Ie=s(o,"DIV",{class:!0});var _t=a(Ie);y(zi.$$.fragment,_t),T1=h(_t),Op=s(_t,"P",{});var H5=a(Op);y1=i(H5,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),H5.forEach(t),w1=h(_t),qi=s(_t,"P",{});var cu=a(qi);$1=i(cu,"This model inherits from "),pd=s(cu,"A",{href:!0});var Q5=a(pd);F1=i(Q5,"FlaxPreTrainedModel"),Q5.forEach(t),x1=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),cu.forEach(t),R1=h(_t),Ci=s(_t,"P",{});var pu=a(Ci);M1=i(pu,"This model is also a Flax Linen "),ji=s(pu,"A",{href:!0,rel:!0});var V5=a(ji);E1=i(V5,"flax.linen.Module"),V5.forEach(t),z1=i(pu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),q1=h(_t),Np=s(_t,"P",{});var J5=a(Np);C1=i(J5,"Finally, this model supports inherent JAX features such as:"),J5.forEach(t),j1=h(_t),Bt=s(_t,"UL",{});var ta=a(Bt);Ip=s(ta,"LI",{});var K5=a(Ip);Pi=s(K5,"A",{href:!0,rel:!0});var G5=a(Pi);P1=i(G5,"Just-In-Time (JIT) compilation"),G5.forEach(t),K5.forEach(t),L1=h(ta),Dp=s(ta,"LI",{});var X5=a(Dp);Li=s(X5,"A",{href:!0,rel:!0});var Y5=a(Li);A1=i(Y5,"Automatic Differentiation"),Y5.forEach(t),X5.forEach(t),O1=h(ta),Sp=s(ta,"LI",{});var Z5=a(Sp);Ai=s(Z5,"A",{href:!0,rel:!0});var ex=a(Ai);N1=i(ex,"Vectorization"),ex.forEach(t),Z5.forEach(t),I1=h(ta),Wp=s(ta,"LI",{});var tx=a(Wp);Oi=s(tx,"A",{href:!0,rel:!0});var ox=a(Oi);D1=i(ox,"Parallelization"),ox.forEach(t),tx.forEach(t),ta.forEach(t),S1=h(_t),zt=s(_t,"DIV",{class:!0});var oa=a(zt);y(Ni.$$.fragment,oa),W1=h(oa),Zo=s(oa,"P",{});var Ad=a(Zo);B1=i(Ad,"The "),Bp=s(Ad,"CODE",{});var nx=a(Bp);U1=i(nx,"FlaxRobertaPreTrainedModel"),nx.forEach(t),H1=i(Ad," forward method, overrides the "),Up=s(Ad,"CODE",{});var sx=a(Up);Q1=i(sx,"__call__"),sx.forEach(t),V1=i(Ad," special method."),Ad.forEach(t),J1=h(oa),y(Ps.$$.fragment,oa),K1=h(oa),y(Ls.$$.fragment,oa),oa.forEach(t),_t.forEach(t),Gm=h(o),en=s(o,"H2",{class:!0});var hu=a(en);As=s(hu,"A",{id:!0,class:!0,href:!0});var ax=a(As);Hp=s(ax,"SPAN",{});var rx=a(Hp);y(Ii.$$.fragment,rx),rx.forEach(t),ax.forEach(t),G1=h(hu),Qp=s(hu,"SPAN",{});var ix=a(Qp);X1=i(ix,"FlaxRobertaForMultipleChoice"),ix.forEach(t),hu.forEach(t),Xm=h(o),De=s(o,"DIV",{class:!0});var bt=a(De);y(Di.$$.fragment,bt),Y1=h(bt),Vp=s(bt,"P",{});var lx=a(Vp);Z1=i(lx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
