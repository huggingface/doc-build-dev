...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var f=a(p);w=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(f,"CODE",{});var $=a(m);k=i($,"Module"),$.forEach(o),N=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,p,f),e(p,w),e(p,m),e(m,k),e(p,N)},d(g){g&&o(p)}}}function rd(O){let p,w,m,k,N,g,f,$,Jn,ln,oe,Te,ro,Ae,Rn,io,Xn,dn,J,Kn,Ie,Qn,Yn,Le,Zn,es,cn,Lt,ts,pn,ve,os,Se,ns,ss,hn,ne,ye,lo,De,as,co,rs,un,Pe,is,po,ls,ds,mn,Be,fn,se,be,ho,Oe,cs,uo,ps,gn,z,We,hs,ae,us,St,ms,fs,He,gs,_s,Ts,re,vs,Dt,ys,Ps,Bt,bs,ks,ws,mo,Ns,$s,Ue,_n,ie,ke,fo,Ve,Gs,go,xs,Tn,F,Je,Ms,_o,Es,zs,Re,Fs,Ot,qs,Cs,js,Xe,As,Ke,Is,Ls,Ss,C,Qe,Ds,le,Bs,Wt,Os,Ws,To,Hs,Us,Vs,we,Js,vo,Rs,Xs,Ye,vn,de,Ne,yo,Ze,Ks,Po,Qs,yn,q,et,Ys,bo,Zs,ea,tt,ta,Ht,oa,na,sa,ot,aa,nt,ra,ia,la,j,st,da,ce,ca,Ut,pa,ha,ko,ua,ma,fa,$e,ga,wo,_a,Ta,at,Pn,pe,Ge,No,rt,va,$o,ya,bn,G,it,Pa,Go,ba,ka,Vt,Jt,wa,Na,$a,W,Ga,xo,xa,Ma,Mo,Ea,za,Eo,Fa,qa,zo,Ca,ja,Aa,lt,Ia,Rt,La,Sa,Da,dt,Ba,ct,Oa,Wa,Ha,E,pt,Ua,he,Va,Xt,Ja,Ra,Fo,Xa,Ka,Qa,xe,Ya,qo,Za,er,ht,tr,Co,or,nr,ut,kn,ue,Me,jo,mt,sr,Ao,ar,wn,x,ft,rr,Io,ir,lr,gt,dr,Kt,cr,pr,hr,_t,ur,Tt,mr,fr,gr,Lo,_r,Tr,H,So,vt,vr,yr,Do,yt,Pr,br,Bo,Pt,kr,wr,Oo,bt,Nr,$r,A,kt,Gr,me,xr,Wo,Mr,Er,Ho,zr,Fr,qr,Ee,Cr,Uo,jr,Ar,wt,Nn,fe,ze,Vo,Nt,Ir,Jo,Lr,$n,M,$t,Sr,Ro,Dr,Br,Gt,Or,Qt,Wr,Hr,Ur,xt,Vr,Mt,Jr,Rr,Xr,Xo,Kr,Qr,U,Ko,Et,Yr,Zr,Qo,zt,ei,ti,Yo,Ft,oi,ni,Zo,qt,si,ai,I,Ct,ri,ge,ii,en,li,di,tn,ci,pi,hi,Fe,ui,on,mi,fi,jt,Gn;return g=new _e({}),Ae=new _e({}),De=new _e({}),Be=new je({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Ve=new _e({}),Je=new V({props:{name:"class transformers.GPTNeoModel",anchor:"transformers.GPTNeoModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L475",parametersDescription:[{anchor:"transformers.GPTNeoModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16033/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16033/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qe=new V({props:{name:"forward",anchor:"transformers.GPTNeoModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L496",parametersDescription:[{anchor:"transformers.GPTNeoModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/pr_16033/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16033/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16033/en/model_doc/gpt_neo#transformers.GPTNeoConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ze=new _e({}),et=new V({props:{name:"class transformers.GPTNeoForCausalLM",anchor:"transformers.GPTNeoForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L663",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16033/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16033/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),st=new V({props:{name:"forward",anchor:"transformers.GPTNeoForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L713",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<p>A <a
  href="/docs/transformers/pr_16033/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16033/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16033/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16033/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16033/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16033/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
256 tokens.`),pn=d(),ve=n("p"),os=r("This model was contributed by "),Se=n("a"),ns=r("valhalla"),ss=r("."),hn=d(),ne=n("h3"),ye=n("a"),lo=n("span"),_(De.$$.fragment),as=d(),co=n("span"),rs=r("Generation"),un=d(),Pe=n("p"),is=r("The "),po=n("code"),ls=r("generate()"),ds=r(" method can be used to generate text using GPT Neo model."),mn=d(),_(Be.$$.fragment),fn=d(),se=n("h2"),be=n("a"),ho=n("span"),_(Oe.$$.fragment),cs=d(),uo=n("span"),ps=r("GPTNeoConfig"),gn=d(),z=n("div"),_(We.$$.fragment),hs=d(),ae=n("p"),us=r("This is the configuration class to store the configuration of a "),St=n("a"),ms=r("GPTNeoModel"),fs=r(`. It is used to instantiate a GPT
...
documentation from `),Bt=n("a"),bs=r("PretrainedConfig"),ks=r(" for more information."),ws=d(),mo=n("p"),Ns=r("Example:"),$s=d(),_(Ue.$$.fragment),_n=d(),ie=n("h2"),ke=n("a"),fo=n("span"),_(Ve.$$.fragment),Gs=d(),go=n("span"),xs=r("GPTNeoModel"),Tn=d(),F=n("div"),_(Je.$$.fragment),Ms=d(),_o=n("p"),Es=r("The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),zs=d(),Re=n("p"),Fs=r("This model inherits from "),Ot=n("a"),qs=r("PreTrainedModel"),Cs=r(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ha=d(),E=n("div"),_(pt.$$.fragment),Ua=d(),he=n("p"),Va=r("The "),Xt=n("a"),Ja=r("GPTNeoForSequenceClassification"),Ra=r(" forward method, overrides the "),Fo=n("code"),Xa=r("__call__"),Ka=r(" special method."),Qa=d(),_(xe.$$.fragment),Ya=d(),qo=n("p"),Za=r("Example of single-label classification:"),er=d(),_(ht.$$.fragment),tr=d(),Co=n("p"),or=r("Example of multi-label classification:"),nr=d(),_(ut.$$.fragment),kn=d(),ue=n("h2"),Me=n("a"),jo=n("span"),_(mt.$$.fragment),sr=d(),Ao=n("span"),ar=r("FlaxGPTNeoModel"),wn=d(),x=n("div"),_(ft.$$.fragment),rr=d(),Io=n("p"),ir=r("The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),lr=d(),gt=n("p"),dr=r("This model inherits from "),Kt=n("a"),cr=r("FlaxPreTrainedModel"),pr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hr=d(),_t=n("p"),ur=r(`This model is also a Flax Linen
`),Tt=n("a"),mr=r("flax.nn.Module"),fr=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),gr=d(),Lo=n("p"),_r=r("Finally, this model supports inherent JAX features such as:"),Tr=d(),H=n("ul"),So=n("li"),vt=n("a"),vr=r("Just-In-Time (JIT) compilation"),yr=d(),Do=n("li"),yt=n("a"),Pr=r("Automatic Differentiation"),br=d(),Bo=n("li"),Pt=n("a"),kr=r("Vectorization"),wr=d(),Oo=n("li"),bt=n("a"),Nr=r("Parallelization"),$r=d(),A=n("div"),_(kt.$$.fragment),Gr=d(),me=n("p"),xr=r("The "),Wo=n("code"),Mr=r("FlaxGPTNeoPreTrainedModel"),Er=r("forward method, overrides the "),Ho=n("code"),zr=r("__call__"),Fr=r(" special method."),qr=d(),_(Ee.$$.fragment),Cr=d(),Uo=n("p"),jr=r("Example:"),Ar=d(),_(wt.$$.fragment),Nn=d(),fe=n("h2"),ze=n("a"),Vo=n("span"),_(Nt.$$.fragment),Ir=d(),Jo=n("span"),Lr=r("FlaxGPTNeoForCausalLM"),$n=d(),M=n("div"),_($t.$$.fragment),Sr=d(),Ro=n("p"),Dr=r(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
documentation from `),Bt=s(eo,"A",{href:!0});var Ci=a(Bt);bs=i(Ci,"PretrainedConfig"),Ci.forEach(o),ks=i(eo," for more information."),eo.forEach(o),ws=c(R),mo=s(R,"P",{});var ji=a(mo);Ns=i(ji,"Example:"),ji.forEach(o),$s=c(R),T(Ue.$$.fragment,R),R.forEach(o),_n=c(t),ie=s(t,"H2",{class:!0});var Fn=a(ie);ke=s(Fn,"A",{id:!0,class:!0,href:!0});var Ai=a(ke);fo=s(Ai,"SPAN",{});var Ii=a(fo);T(Ve.$$.fragment,Ii),Ii.forEach(o),Ai.forEach(o),Gs=c(Fn),go=s(Fn,"SPAN",{});var Li=a(go);xs=i(Li,"GPTNeoModel"),Li.forEach(o),Fn.forEach(o),Tn=c(t),F=s(t,"DIV",{class:!0});var X=a(F);T(Je.$$.fragment,X),Ms=c(X),_o=s(X,"P",{});var Si=a(_o);Es=i(Si,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),Si.forEach(o),zs=c(X),Re=s(X,"P",{});var qn=a(Re);Fs=i(qn,"This model inherits from "),Ot=s(qn,"A",{href:!0});var Di=a(Ot);qs=i(Di,"PreTrainedModel"),Di.forEach(o),Cs=i(qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Wn.forEach(o),gr=c(D),Lo=s(D,"P",{});var Pl=a(Lo);_r=i(Pl,"Finally, this model supports inherent JAX features such as:"),Pl.forEach(o),Tr=c(D),H=s(D,"UL",{});var qe=a(H);So=s(qe,"LI",{});var bl=a(So);vt=s(bl,"A",{href:!0,rel:!0});var kl=a(vt);vr=i(kl,"Just-In-Time (JIT) compilation"),kl.forEach(o),bl.forEach(o),yr=c(qe),Do=s(qe,"LI",{});var wl=a(Do);yt=s(wl,"A",{href:!0,rel:!0});var Nl=a(yt);Pr=i(Nl,"Automatic Differentiation"),Nl.forEach(o),wl.forEach(o),br=c(qe),Bo=s(qe,"LI",{});var $l=a(Bo);Pt=s($l,"A",{href:!0,rel:!0});var Gl=a(Pt);kr=i(Gl,"Vectorization"),Gl.forEach(o),$l.forEach(o),wr=c(qe),Oo=s(qe,"LI",{});var xl=a(Oo);bt=s(xl,"A",{href:!0,rel:!0});var Ml=a(bt);Nr=i(Ml,"Parallelization"),Ml.forEach(o),xl.forEach(o),qe.forEach(o),$r=c(D),A=s(D,"DIV",{class:!0});var ee=a(A);T(kt.$$.fragment,ee),Gr=c(ee),me=s(ee,"P",{});var so=a(me);xr=i(so,"The "),Wo=s(so,"CODE",{});var El=a(Wo);Mr=i(El,"FlaxGPTNeoPreTrainedModel"),El.forEach(o),Er=i(so,"forward method, overrides the "),Ho=s(so,"CODE",{});var zl=a(Ho);zr=i(zl,"__call__"),zl.forEach(o),Fr=i(so," special method."),so.forEach(o),qr=c(ee),T(Ee.$$.fragment,ee),Cr=c(ee),Uo=s(ee,"P",{});var Fl=a(Uo);jr=i(Fl,"Example:"),Fl.forEach(o),Ar=c(ee),T(wt.$$.fragment,ee),ee.forEach(o),D.forEach(o),Nn=c(t),fe=s(t,"H2",{class:!0});var Hn=a(fe);ze=s(Hn,"A",{id:!0,class:!0,href:!0});var ql=a(ze);Vo=s(ql,"SPAN",{});var Cl=a(Vo);T(Nt.$$.fragment,Cl),Cl.forEach(o),ql.forEach(o),Ir=c(Hn),Jo=s(Hn,"SPAN",{});var jl=a(Jo);Lr=i(jl,"FlaxGPTNeoForCausalLM"),jl.forEach(o),Hn.forEach(o),$n=c(t),M=s(t,"DIV",{class:!0});var B=a(M);T($t.$$.fragment,B),Sr=c(B),Ro=s(B,"P",{});var Al=a(Ro);Dr=i(Al,`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
