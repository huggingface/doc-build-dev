import{S as ij,i as lj,s as dj,e as o,k as l,w as c,t as r,M as pj,c as s,d as t,m as d,a,x as m,h as i,b as p,F as e,g as v,y as u,q as g,o as h,B as _}from"../../chunks/vendor-4833417e.js";import{T as Fp}from"../../chunks/Tip-fffd6df1.js";import{D as f}from"../../chunks/Docstring-4f315ed9.js";import{C as O}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function cj(ee){let x,E;return{c(){x=o("p"),E=r("Passing `use_auth_token=True\u201C is required when you want to use a private model.")},l(T){x=s(T,"P",{});var $=a(x);E=i($,"Passing `use_auth_token=True\u201C is required when you want to use a private model."),$.forEach(t)},m(T,$){v(T,x,$),e(x,E)},d(T){T&&t(x)}}}function mj(ee){let x,E,T,$,te;return{c(){x=o("p"),E=r("Activate the special "),T=o("a"),$=r("\u201Coffline-mode\u201D"),te=r(` to
...
Can be either:</p>
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16033/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string or path valid as input to <a href="/docs/transformers/pr_16033/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = BertModel.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, from_flax=<span class="hljs-literal">True</span>)`}}),no=new f({props:{name:"get_input_embeddings",anchor:"transformers.PreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L575",returnDescription:`
<p>A torch module mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),oo=new f({props:{name:"get_output_embeddings",anchor:"transformers.PreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L601",returnDescription:`
<p>A torch module mapping hidden states to vocabulary.</p>
`,returnType:`
<p><code>nn.Module</code></p>
`}}),so=new f({props:{name:"gradient_checkpointing_disable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_disable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L979"}}),ao=new f({props:{name:"gradient_checkpointing_enable",anchor:"transformers.PreTrainedModel.gradient_checkpointing_enable",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L968"}}),ro=new f({props:{name:"init_weights",anchor:"transformers.PreTrainedModel.init_weights",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L935"}}),io=new f({props:{name:"post_init",anchor:"transformers.PreTrainedModel.post_init",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L494"}}),lo=new f({props:{name:"prune_heads",anchor:"transformers.PreTrainedModel.prune_heads",parameters:[{name:"heads_to_prune",val:": typing.Dict[int, typing.List[int]]"}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L951",parametersDescription:[{anchor:"transformers.PreTrainedModel.prune_heads.heads_to_prune",description:`<strong>heads_to_prune</strong> (<code>Dict[int, List[int]]</code>) &#x2014;
...
`}}),go=new f({props:{name:"save_pretrained",anchor:"transformers.PreTrainedModel.save_pretrained",parameters:[{name:"save_directory",val:": typing.Union[str, os.PathLike]"},{name:"save_config",val:": bool = True"},{name:"state_dict",val:": typing.Optional[dict] = None"},{name:"save_function",val:": typing.Callable = <function save at 0x7fe93152ddc0>"},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L999",parametersDescription:[{anchor:"transformers.PreTrainedModel.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),Lo=new f({props:{name:"get_extended_attention_mask",anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask",parameters:[{name:"attention_mask",val:": Tensor"},{name:"input_shape",val:": typing.Tuple[int]"},{name:"device",val:": <property object at 0x7fe8c81601d0>"}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L271",parametersDescription:[{anchor:"transformers.modeling_utils.ModuleUtilsMixin.get_extended_attention_mask.attention_mask",description:`<strong>attention_mask</strong> (<code>torch.Tensor</code>) &#x2014;
...
`,returnType:`
<p><code>int</code></p>
`}}),zo=new f({props:{name:"reset_memory_hooks_state",anchor:"transformers.modeling_utils.ModuleUtilsMixin.reset_memory_hooks_state",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_utils.py#L194"}}),Do=new xt({}),Ao=new f({props:{name:"class transformers.TFPreTrainedModel",anchor:"transformers.TFPreTrainedModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_tf_utils.py#L646"}}),So=new f({props:{name:"push_to_hub",anchor:"transformers.file_utils.PushToHubMixin.push_to_hub",parameters:[{name:"repo_path_or_name",val:": typing.Optional[str] = None"},{name:"repo_url",val:": typing.Optional[str] = None"},{name:"use_temp_dir",val:": bool = False"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"organization",val:": typing.Optional[str] = None"},{name:"private",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Union[bool, str, NoneType] = None"},{name:"**model_card_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/file_utils.py#L2842",parametersDescription:[{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_path_or_name",description:`<strong>repo_path_or_name</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Can either be a repository name for your model in the Hub or a path to a local folder (in which case
the repository will have the name of that local folder). If not specified, will default to the name
given by <code>repo_url</code> and a local directory with that name will be created.`,name:"repo_path_or_name"},{anchor:"transformers.file_utils.PushToHubMixin.push_to_hub.repo_url",description:`<strong>repo_url</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Specify this in case you want to push to an existing repository in the hub. If unspecified, a new
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16033/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<ul>
<li>an instance of a class derived from <a href="/docs/transformers/pr_16033/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>,</li>
<li>a string valid as input to <a href="/docs/transformers/pr_16033/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained">from_pretrained()</a>.</li>
...
`}}),Xo=new f({props:{name:"get_input_embeddings",anchor:"transformers.TFPreTrainedModel.get_input_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_tf_utils.py#L756",returnDescription:`
<p>The embeddings layer mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ro=new f({props:{name:"get_lm_head",anchor:"transformers.TFPreTrainedModel.get_lm_head",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_tf_utils.py#L1116",returnDescription:`
<p>The LM head layer if the model has one, None if not.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Yo=new f({props:{name:"get_output_embeddings",anchor:"transformers.TFPreTrainedModel.get_output_embeddings",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_tf_utils.py#L1023",returnDescription:`
<p>The new weights mapping vocabulary to hidden states.</p>
`,returnType:`
<p><code>tf.Variable</code></p>
`}}),Ko=new f({props:{name:"get_output_layer_with_bias",anchor:"transformers.TFPreTrainedModel.get_output_layer_with_bias",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_tf_utils.py#L1060",returnDescription:`
<p>The layer that handles the bias, None if not an LM model.</p>
`,returnType:`
<p><code>tf.keras.layers.Layer</code></p>
`}}),Zo=new f({props:{name:"get_prefix_bias_name",anchor:"transformers.TFPreTrainedModel.get_prefix_bias_name",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/modeling_tf_utils.py#L1073",returnDescription:`
...
<a href="/docs/transformers/pr_16033/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"},{anchor:"transformers.FlaxPreTrainedModel.from_pretrained.model_args",description:`<strong>model_args</strong> (sequence of positional arguments, <em>optional</em>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
<p><a
  href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
>BeamSampleDecoderOnlyOutput</a>, <a
  href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
<a
  href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<p>A <a
  href="/docs/transformers/pr_16033/en/main_classes/output#transformers.file_utils.ModelOutput"
>ModelOutput</a> (if
...
<ul>
<li><a
  href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
...
An derived instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),ea=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_utils.GenerationMixin.prepare_inputs_for_generation",parameters:[{name:"input_ids",val:": LongTensor"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/generation_utils.py#L451"}}),na=new f({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/generation_utils.py#L1669",parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
Whether or not to return a <a href="/docs/transformers/pr_16033/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_kwargs &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Generated:&quot;</span>, tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),_a=new f({props:{name:"prepare_inputs_for_generation",anchor:"transformers.generation_tf_utils.TFGenerationMixin.prepare_inputs_for_generation",parameters:[{name:"inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/generation_tf_utils.py#L347"}}),ba=new f({props:{name:"sample",anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample",parameters:[{name:"input_ids",val:": Tensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_tf_logits_process.TFLogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16033/src/transformers/generation_tf_utils.py#L1979",parametersDescription:[{anchor:"transformers.generation_tf_utils.TFGenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.TFLogitsProcessor">TFLogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.TFLogitsProcessorList">TFLogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16033/en/internal/generation_utils#transformers.TFLogitsWarper">TFLogitsWarper</a>
...
`),Si=o("code"),zh=r("[from_pretrained()](/docs/transformers/pr_16033/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),Dh=r(" class method."),Ah=l(),Nt=o("div"),c(_o.$$.fragment),Gh=l(),Ni=o("p"),Sh=r("Set model\u2019s input embeddings."),Nh=l(),Be=o("div"),c(fo.$$.fragment),Ch=l(),Ci=o("p"),Ih=r("Tie the weights between the input embeddings and the output embeddings."),Bh=l(),bo=o("p"),Wh=r("If the "),Ii=o("code"),Uh=r("torchscript"),Hh=r(` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
...
`),Si=s(Tc,"CODE",{});var XT=a(Si);zh=i(XT,"[from_pretrained()](/docs/transformers/pr_16033/en/main_classes/model#transformers.PreTrainedModel.from_pretrained)"),XT.forEach(t),Dh=i(Tc," class method."),Tc.forEach(t),wc.forEach(t),Ah=d(j),Nt=s(j,"DIV",{class:!0});var jc=a(Nt);m(_o.$$.fragment,jc),Gh=d(jc),Ni=s(jc,"P",{});var RT=a(Ni);Sh=i(RT,"Set model\u2019s input embeddings."),RT.forEach(t),jc.forEach(t),Nh=d(j),Be=s(j,"DIV",{class:!0});var Tr=a(Be);m(fo.$$.fragment,Tr),Ch=d(Tr),Ci=s(Tr,"P",{});var YT=a(Ci);Ih=i(YT,"Tie the weights between the input embeddings and the output embeddings."),YT.forEach(t),Bh=d(Tr),bo=s(Tr,"P",{});var $c=a(bo);Wh=i($c,"If the "),Ii=s($c,"CODE",{});var KT=a(Ii);Uh=i(KT,"torchscript"),KT.forEach(t),Hh=i($c,` flag is set in the configuration, can\u2019t handle parameter sharing so we are cloning the
weights instead.`),$c.forEach(t),Tr.forEach(t),j.forEach(t),Np=d(n),Ka=s(n,"A",{id:!0}),a(Ka).forEach(t),Cp=d(n),rt=s(n,"H3",{class:!0});var Mc=a(rt);Ct=s(Mc,"A",{id:!0,class:!0,href:!0});var ZT=a(Ct);Bi=s(ZT,"SPAN",{});var JT=a(Bi);m(vo.$$.fragment,JT),JT.forEach(t),ZT.forEach(t),Vh=d(Mc),Wi=s(Mc,"SPAN",{});var QT=a(Wi);Xh=i(QT,"Model Instantiation dtype"),QT.forEach(t),Mc.forEach(t),Ip=d(n),de=s(n,"P",{});var Ln=a(de);Rh=i(Ln,"Under Pytorch a model normally gets instantiated with "),Ui=s(Ln,"CODE",{});var e3=a(Ui);Yh=i(e3,"torch.float32"),e3.forEach(t),Kh=i(Ln,` format. This can be an issue if one tries to
load a model whose weights are in fp16, since it\u2019d require twice as much memory. To overcome this limitation, you can
either explicitly pass the desired `),Hi=s(Ln,"CODE",{});var t3=a(Hi);Zh=i(t3,"dtype"),t3.forEach(t),Jh=i(Ln," using "),Vi=s(Ln,"CODE",{});var n3=a(Vi);Qh=i(n3,"torch_dtype"),n3.forEach(t),e_=i(Ln," argument:"),Ln.forEach(t),Bp=d(n),m(yo.$$.fragment,n),Wp=d(n),We=s(n,"P",{});var jr=a(We);t_=i(jr,"or, if you want the model to always load in the most optimal memory pattern, you can use the special value "),Xi=s(jr,"CODE",{});var o3=a(Xi);n_=i(o3,'"auto"'),o3.forEach(t),o_=i(jr,`,
and then `),Ri=s(jr,"CODE",{});var s3=a(Ri);s_=i(s3,"dtype"),s3.forEach(t),a_=i(jr," will be automatically derived from the model\u2019s weights:"),jr.forEach(t),Up=d(n),m(ko.$$.fragment,n),Hp=d(n),It=s(n,"P",{});var Pc=a(It);r_=i(Pc,"Models instantiated from scratch can also be told which "),Yi=s(Pc,"CODE",{});var a3=a(Yi);i_=i(a3,"dtype"),a3.forEach(t),l_=i(Pc," to use with:"),Pc.forEach(t),Vp=d(n),m(xo.$$.fragment,n),Xp=d(n),Za=s(n,"P",{});var r3=a(Za);d_=i(r3,"Due to Pytorch design, this functionality is only available for floating dtypes."),r3.forEach(t),Rp=d(n),it=s(n,"H2",{class:!0});var Ec=a(it);Bt=s(Ec,"A",{id:!0,class:!0,href:!0});var i3=a(Bt);Ki=s(i3,"SPAN",{});var l3=a(Ki);m(wo.$$.fragment,l3),l3.forEach(t),i3.forEach(t),p_=d(Ec),Zi=s(Ec,"SPAN",{});var d3=a(Zi);c_=i(d3,"ModuleUtilsMixin"),d3.forEach(t),Ec.forEach(t),Yp=d(n),L=s(n,"DIV",{class:!0});var D=a(L);m(To.$$.fragment,D),m_=d(D),jo=s(D,"P",{});var Lc=a(jo);u_=i(Lc,"A few utilities for "),Ji=s(Lc,"CODE",{});var p3=a(Ji);g_=i(p3,"torch.nn.Modules"),p3.forEach(t),h_=i(Lc,", to be used as a mixin."),Lc.forEach(t),__=d(D),Ue=s(D,"DIV",{class:!0});var $r=a(Ue);m($o.$$.fragment,$r),f_=d($r),Qi=s($r,"P",{});var c3=a(Qi);b_=i(c3,"Add a memory hook before and after each sub-module forward pass to record increase in memory consumption."),c3.forEach(t),v_=d($r),lt=s($r,"P",{});var Mr=a(lt);y_=i(Mr,"Increase in memory consumption is stored in a "),el=s(Mr,"CODE",{});var m3=a(el);k_=i(m3,"mem_rss_diff"),m3.forEach(t),x_=i(Mr,` attribute for each module and can be reset to zero
with `),tl=s(Mr,"CODE",{});var u3=a(tl);w_=i(u3,"model.reset_memory_hooks_state()"),u3.forEach(t),T_=i(Mr,"."),Mr.forEach(t),$r.forEach(t),j_=d(D),Wt=s(D,"DIV",{class:!0});var qc=a(Wt);m(Mo.$$.fragment,qc),$_=d(qc),nl=s(qc,"P",{});var g3=a(nl);M_=i(g3,"Helper function to estimate the total number of tokens from the model inputs."),g3.forEach(t),qc.forEach(t),P_=d(D),Ut=s(D,"DIV",{class:!0});var Fc=a(Ut);m(Po.$$.fragment,Fc),E_=d(Fc),dt=s(Fc,"P",{});var Pr=a(dt);L_=i(Pr,`Get number of (optionally, non-embeddings) floating-point operations for the forward and backward passes of a
batch with this transformer model. Default approximation neglects the quadratic dependency on the number of
tokens (valid if `),ol=s(Pr,"CODE",{});var h3=a(ol);q_=i(h3,"12 * d_model << sequence_length"),h3.forEach(t),F_=i(Pr,") as laid out in "),Eo=s(Pr,"A",{href:!0,rel:!0});var _3=a(Eo);O_=i(_3,`this
paper`),_3.forEach(t),z_=i(Pr,` section 2.1. Should be overridden for transformers with parameter
re-use e.g. Albert or Universal Transformers, or if doing long-range modeling with very high sequence lengths.`),Pr.forEach(t),Fc.forEach(t),D_=d(D),Ht=s(D,"DIV",{class:!0});var Oc=a(Ht);m(Lo.$$.fragment,Oc),A_=d(Oc),sl=s(Oc,"P",{});var f3=a(sl);G_=i(f3,"Makes broadcastable attention and causal masks so that future and masked tokens are ignored."),f3.forEach(t),Oc.forEach(t),S_=d(D),Vt=s(D,"DIV",{class:!0});var zc=a(Vt);m(qo.$$.fragment,zc),N_=d(zc),al=s(zc,"P",{});var b3=a(al);C_=i(b3,"Prepare the head mask if needed."),b3.forEach(t),zc.forEach(t),I_=d(D),Xt=s(D,"DIV",{class:!0});var Dc=a(Xt);m(Fo.$$.fragment,Dc),B_=d(Dc),rl=s(Dc,"P",{});var v3=a(rl);W_=i(v3,"Invert an attention mask (e.g., switches 0. and 1.)."),v3.forEach(t),Dc.forEach(t),U_=d(D),Rt=s(D,"DIV",{class:!0});var Ac=a(Rt);m(Oo.$$.fragment,Ac),H_=d(Ac),il=s(Ac,"P",{});var y3=a(il);V_=i(y3,"Get number of (optionally, trainable or non-embeddings) parameters in the module."),y3.forEach(t),Ac.forEach(t),X_=d(D),Yt=s(D,"DIV",{class:!0});var Gc=a(Yt);m(zo.$$.fragment,Gc),R_=d(Gc),pt=s(Gc,"P",{});var Er=a(pt);Y_=i(Er,"Reset the "),ll=s(Er,"CODE",{});var k3=a(ll);K_=i(k3,"mem_rss_diff"),k3.forEach(t),Z_=i(Er," attribute of each module (see "),Ja=s(Er,"A",{href:!0});var x3=a(Ja);J_=i(x3,"add_memory_hooks()"),x3.forEach(t),Q_=i(Er,")."),Er.forEach(t),Gc.forEach(t),D.forEach(t),Kp=d(n),ct=s(n,"H2",{class:!0});var Sc=a(ct);Kt=s(Sc,"A",{id:!0,class:!0,href:!0});var w3=a(Kt);dl=s(w3,"SPAN",{});var T3=a(dl);m(Do.$$.fragment,T3),T3.forEach(t),w3.forEach(t),ef=d(Sc),pl=s(Sc,"SPAN",{});var j3=a(pl);tf=i(j3,"TFPreTrainedModel"),j3.forEach(t),Sc.forEach(t),Zp=d(n),y=s(n,"DIV",{class:!0});var k=a(y);m(Ao.$$.fragment,k),nf=d(k),cl=s(k,"P",{});var $3=a(cl);of=i($3,"Base class for all TF models."),$3.forEach(t),sf=d(k),Qa=s(k,"P",{});var zw=a(Qa);er=s(zw,"A",{href:!0});var M3=a(er);af=i(M3,"TFPreTrainedModel"),M3.forEach(t),rf=i(zw,` takes care of storing the configuration of the models and handles methods for loading,
downloading and saving models as well as a few methods common to all models to:`),zw.forEach(t),lf=d(k),Go=s(k,"UL",{});var Nc=a(Go);ml=s(Nc,"LI",{});var P3=a(ml);df=i(P3,"resize the input embeddings,"),P3.forEach(t),pf=d(Nc),ul=s(Nc,"LI",{});var E3=a(ul);cf=i(E3,"prune heads in the self-attention heads."),E3.forEach(t),Nc.forEach(t),mf=d(k),gl=s(k,"P",{});var L3=a(gl);uf=i(L3,"Class attributes (overridden by derived classes):"),L3.forEach(t),gf=d(k),mt=s(k,"UL",{});var Lr=a(mt);He=s(Lr,"LI",{});var za=a(He);hl=s(za,"STRONG",{});var q3=a(hl);hf=i(q3,"config_class"),q3.forEach(t),_f=i(za," ("),tr=s(za,"A",{href:!0});var F3=a(tr);ff=i(F3,"PretrainedConfig"),F3.forEach(t),bf=i(za,") \u2014 A subclass of "),nr=s(za,"A",{href:!0});var O3=a(nr);vf=i(O3,"PretrainedConfig"),O3.forEach(t),yf=i(za,` to use as configuration class
for this model architecture.`),za.forEach(t),kf=d(Lr),Zt=s(Lr,"LI",{});var Lp=a(Zt);_l=s(Lp,"STRONG",{});var z3=a(_l);xf=i(z3,"base_model_prefix"),z3.forEach(t),wf=i(Lp," ("),fl=s(Lp,"CODE",{});var D3=a(fl);Tf=i(D3,"str"),D3.forEach(t),jf=i(Lp,`) \u2014 A string indicating the attribute associated to the base model in derived
classes of the same architecture adding modules on top of the base model.`),Lp.forEach(t),$f=d(Lr),X=s(Lr,"LI",{});var ze=a(X);bl=s(ze,"STRONG",{});var A3=a(bl);Mf=i(A3,"main_input_name"),A3.forEach(t),Pf=i(ze," ("),vl=s(ze,"CODE",{});var G3=a(vl);Ef=i(G3,"str"),G3.forEach(t),Lf=i(ze,") \u2014 The name of the principal input to the model (often "),yl=s(ze,"CODE",{});var S3=a(yl);qf=i(S3,"input_ids"),S3.forEach(t),Ff=i(ze,` for NLP
models, `),kl=s(ze,"CODE",{});var N3=a(kl);Of=i(N3,"pixel_values"),N3.forEach(t),zf=i(ze," for vision models and "),xl=s(ze,"CODE",{});var C3=a(xl);Df=i(C3,"input_values"),C3.forEach(t),Af=i(ze," for speech models)."),ze.forEach(t),Lr.forEach(t),Gf=d(k),pe=s(k,"DIV",{class:!0});var qn=a(pe);m(So.$$.fragment,qn),Sf=d(qn),No=s(qn,"P",{});var Cc=a(No);Nf=i(Cc,`Upload the model checkpoint to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),wl=s(Cc,"CODE",{});var I3=a(wl);Cf=i(I3,"repo_path_or_name"),I3.forEach(t),If=i(Cc,"."),Cc.forEach(t),Bf=d(qn),Tl=s(qn,"P",{});var B3=a(Tl);Wf=i(B3,"Examples:"),B3.forEach(t),Uf=d(qn),m(Co.$$.fragment,qn),qn.forEach(t),Hf=d(k),Jt=s(k,"DIV",{class:!0});var Ic=a(Jt);m(Io.$$.fragment,Ic),Vf=d(Ic),jl=s(Ic,"P",{});var W3=a(jl);Xf=i(W3,`This is a thin wrapper that sets the model\u2019s loss output head as the loss if the user does not specify a loss
function themselves.`),W3.forEach(t),Ic.forEach(t),Rf=d(k),S=s(k,"DIV",{class:!0});var Z=a(S);m(Bo.$$.fragment,Z),Yf=d(Z),$l=s(Z,"P",{});var U3=a($l);Kf=i(U3,"Instantiate a pretrained TF 2.0 model from a pre-trained model configuration."),U3.forEach(t),Zf=d(Z),Wo=s(Z,"P",{});var Bc=a(Wo);Jf=i(Bc,"The warning "),Ml=s(Bc,"EM",{});var H3=a(Ml);Qf=i(H3,"Weights from XXX not initialized from pretrained model"),H3.forEach(t),eb=i(Bc,` means that the weights of XXX do not come
pretrained with the rest of the model. It is up to you to train those weights with a downstream fine-tuning
task.`),Bc.forEach(t),tb=d(Z),Uo=s(Z,"P",{});var Wc=a(Uo);nb=i(Wc,"The warning "),Pl=s(Wc,"EM",{});var V3=a(Pl);ob=i(V3,"Weights from XXX not used in YYY"),V3.forEach(t),sb=i(Wc,` means that the layer XXX is not used by YYY, therefore those
weights are discarded.`),Wc.forEach(t),ab=d(Z),m(Qt.$$.fragment,Z),rb=d(Z),El=s(Z,"P",{});var X3=a(El);ib=i(X3,"Examples:"),X3.forEach(t),lb=d(Z),m(Ho.$$.fragment,Z),Z.forEach(t),db=d(k),en=s(k,"DIV",{class:!0});var Uc=a(en);m(Vo.$$.fragment,Uc),pb=d(Uc),Ll=s(Uc,"P",{});var R3=a(Ll);cb=i(R3,"Dict of bias attached to an LM head. The key represents the name of the bias attribute."),R3.forEach(t),Uc.forEach(t),mb=d(k),tn=s(k,"DIV",{class:!0});var Hc=a(tn);m(Xo.$$.fragment,Hc),ub=d(Hc),ql=s(Hc,"P",{});var Y3=a(ql);gb=i(Y3,"Returns the model\u2019s input embeddings layer."),Y3.forEach(t),Hc.forEach(t),hb=d(k),nn=s(k,"DIV",{class:!0});var Vc=a(nn);m(Ro.$$.fragment,Vc),_b=d(Vc),Fl=s(Vc,"P",{});var K3=a(Fl);fb=i(K3,"The LM Head layer. This method must be overwritten by all the models that have a lm head."),K3.forEach(t),Vc.forEach(t),bb=d(k),on=s(k,"DIV",{class:!0});var Xc=a(on);m(Yo.$$.fragment,Xc),vb=d(Xc),Ol=s(Xc,"P",{});var Z3=a(Ol);yb=i(Z3,"Returns the model\u2019s output embeddings"),Z3.forEach(t),Xc.forEach(t),kb=d(k),sn=s(k,"DIV",{class:!0});var Rc=a(sn);m(Ko.$$.fragment,Rc),xb=d(Rc),zl=s(Rc,"P",{});var J3=a(zl);wb=i(J3,`Get the layer that handles a bias attribute in case the model has an LM head with weights tied to the
embeddings`),J3.forEach(t),Rc.forEach(t),Tb=d(k),an=s(k,"DIV",{class:!0});var Yc=a(an);m(Zo.$$.fragment,Yc),jb=d(Yc),Dl=s(Yc,"P",{});var Q3=a(Dl);$b=i(Q3,"Get the concatenated _prefix name of the bias from the model name to the parent layer"),Q3.forEach(t),Yc.forEach(t),Mb=d(k),rn=s(k,"DIV",{class:!0});var Kc=a(rn);m(Jo.$$.fragment,Kc),Pb=d(Kc),Al=s(Kc,"P",{});var e2=a(Al);Eb=i(e2,`Loads a saved checkpoint (model weights and optimizer state) from a repo. Returns the current epoch count when
...
`),Od=s(et,"CODE",{});var o0=a(Od);w1=i(o0,"params"),o0.forEach(t),T1=i(et," in place."),et.forEach(t),j1=d(Qe),zd=s(Qe,"P",{});var s0=a(zd);$1=i(s0,`This method can be used on GPU to explicitly convert the model parameters to float16 precision to do full
half-precision training or to save weights in float16 for inference in order to save memory and improve speed.`),s0.forEach(t),M1=d(Qe),Dd=s(Qe,"P",{});var a0=a(Dd);P1=i(a0,"Examples:"),a0.forEach(t),E1=d(Qe),m(qs.$$.fragment,Qe),Qe.forEach(t),L1=d(q),ue=s(q,"DIV",{class:!0});var zn=a(ue);m(Fs.$$.fragment,zn),q1=d(zn),re=s(zn,"P",{});var tt=a(re);F1=i(tt,"Cast the floating-point "),Ad=s(tt,"CODE",{});var r0=a(Ad);O1=i(r0,"parmas"),r0.forEach(t),z1=i(tt," to "),Gd=s(tt,"CODE",{});var i0=a(Gd);D1=i(i0,"jax.numpy.float32"),i0.forEach(t),A1=i(tt,`. This method can be used to explicitly convert the
model parameters to fp32 precision. This returns a new `),Sd=s(tt,"CODE",{});var l0=a(Sd);G1=i(l0,"params"),l0.forEach(t),S1=i(tt," tree and does not cast the "),Nd=s(tt,"CODE",{});var d0=a(Nd);N1=i(d0,"params"),d0.forEach(t),C1=i(tt," in place."),tt.forEach(t),I1=d(zn),Cd=s(zn,"P",{});var p0=a(Cd);B1=i(p0,"Examples:"),p0.forEach(t),W1=d(zn),m(Os.$$.fragment,zn),zn.forEach(t),q.forEach(t),nc=d(n),bt=s(n,"H2",{class:!0});var fm=a(bt);xn=s(fm,"A",{id:!0,class:!0,href:!0});var c0=a(xn);Id=s(c0,"SPAN",{});var m0=a(Id);m(zs.$$.fragment,m0),m0.forEach(t),c0.forEach(t),U1=d(fm),Bd=s(fm,"SPAN",{});var u0=a(Bd);H1=i(u0,"Generation"),u0.forEach(t),fm.forEach(t),oc=d(n),P=s(n,"DIV",{class:!0});var F=a(P);m(Ds.$$.fragment,F),V1=d(F),As=s(F,"P",{});var bm=a(As);X1=i(bm,"A class containing all of the functions supporting generation, to be used as a mixin in "),lr=s(bm,"A",{href:!0});var g0=a(lr);R1=i(g0,"PreTrainedModel"),g0.forEach(t),Y1=i(bm,"."),bm.forEach(t),K1=d(F),wn=s(F,"DIV",{class:!0});var vm=a(wn);m(Gs.$$.fragment,vm),Z1=d(vm),Ss=s(vm,"P",{});var ym=a(Ss);J1=i(ym,"Implement in subclasses of "),dr=s(ym,"A",{href:!0});var h0=a(dr);Q1=i(h0,"PreTrainedModel"),h0.forEach(t),ek=i(ym," for custom behavior to adjust the logits in the generate method."),ym.forEach(t),vm.forEach(t),tk=d(F),ge=s(F,"DIV",{class:!0});var Dn=a(ge);m(Ns.$$.fragment,Dn),nk=d(Dn),Wd=s(Dn,"P",{});var _0=a(Wd);ok=i(_0,"Generates sequences for models with a language modeling head using beam search with multinomial sampling."),_0.forEach(t),sk=d(Dn),Ud=s(Dn,"P",{});var f0=a(Ud);ak=i(f0,"Examples:"),f0.forEach(t),rk=d(Dn),m(Cs.$$.fragment,Dn),Dn.forEach(t),ik=d(F),he=s(F,"DIV",{class:!0});var An=a(he);m(Is.$$.fragment,An),lk=d(An),Hd=s(An,"P",{});var b0=a(Hd);dk=i(b0,"Generates sequences for models with a language modeling head using beam search decoding."),b0.forEach(t),pk=d(An),Vd=s(An,"P",{});var v0=a(Vd);ck=i(v0,"Examples:"),v0.forEach(t),mk=d(An),m(Bs.$$.fragment,An),An.forEach(t),uk=d(F),Tn=s(F,"DIV",{class:!0});var km=a(Tn);m(Ws.$$.fragment,km),gk=d(km),Xd=s(km,"P",{});var y0=a(Xd);hk=i(y0,`compute the transition probabilities of sequences given generation
scores and beam indices`),y0.forEach(t),km.forEach(t),_k=d(F),_e=s(F,"DIV",{class:!0});var Gn=a(_e);m(Us.$$.fragment,Gn),fk=d(Gn),Rd=s(Gn,"P",{});var k0=a(Rd);bk=i(k0,"Generates sequences for models with a language modeling head using beam search decoding."),k0.forEach(t),vk=d(Gn),Yd=s(Gn,"P",{});var x0=a(Yd);yk=i(x0,"Examples:"),x0.forEach(t),kk=d(Gn),m(Hs.$$.fragment,Gn),Gn.forEach(t),xk=d(F),U=s(F,"DIV",{class:!0});var je=a(U);m(Vs.$$.fragment,je),wk=d(je),Kd=s(je,"P",{});var w0=a(Kd);Tk=i(w0,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
multinomial sampling, beam-search decoding, and beam-search multinomial sampling.`),w0.forEach(t),jk=d(je),vt=s(je,"P",{});var Gr=a(vt);$k=i(Gr,"Apart from "),Zd=s(Gr,"CODE",{});var T0=a(Zd);Mk=i(T0,"inputs"),T0.forEach(t),Pk=i(Gr,`, all the arguments below will default to the value of the attribute of the same name inside
the `),pr=s(Gr,"A",{href:!0});var j0=a(pr);Ek=i(j0,"PretrainedConfig"),j0.forEach(t),Lk=i(Gr," of the model. The default values indicated are the default values of those config."),Gr.forEach(t),qk=d(je),Xs=s(je,"P",{});var xm=a(Xs);Fk=i(xm,"Most of these parameters are explained in more detail in "),Rs=s(xm,"A",{href:!0,rel:!0});var $0=a(Rs);Ok=i($0,`this blog
post`),$0.forEach(t),zk=i(xm,"."),xm.forEach(t),Dk=d(je),Jd=s(je,"P",{});var M0=a(Jd);Ak=i(M0,"Examples:"),M0.forEach(t),Gk=d(je),m(Ys.$$.fragment,je),je.forEach(t),Sk=d(F),fe=s(F,"DIV",{class:!0});var Sn=a(fe);m(Ks.$$.fragment,Sn),Nk=d(Sn),Qd=s(Sn,"P",{});var P0=a(Qd);Ck=i(P0,"Generates sequences for models with a language modeling head using greedy decoding."),P0.forEach(t),Ik=d(Sn),ep=s(Sn,"P",{});var E0=a(ep);Bk=i(E0,"Examples:"),E0.forEach(t),Wk=d(Sn),m(Zs.$$.fragment,Sn),Sn.forEach(t),Uk=d(F),be=s(F,"DIV",{class:!0});var Nn=a(be);m(Js.$$.fragment,Nn),Hk=d(Nn),tp=s(Nn,"P",{});var L0=a(tp);Vk=i(L0,"Generates sequences for models with a language modeling head using beam search decoding."),L0.forEach(t),Xk=d(Nn),np=s(Nn,"P",{});var q0=a(np);Rk=i(q0,"Examples:"),q0.forEach(t),Yk=d(Nn),m(Qs.$$.fragment,Nn),Nn.forEach(t),Kk=d(F),jn=s(F,"DIV",{class:!0});var wm=a(jn);m(ea.$$.fragment,wm),Zk=d(wm),ta=s(wm,"P",{});var Tm=a(ta);Jk=i(Tm,"Implement in subclasses of "),cr=s(Tm,"A",{href:!0});var F0=a(cr);Qk=i(F0,"PreTrainedModel"),F0.forEach(t),ex=i(Tm," for custom behavior to prepare inputs in the generate method."),Tm.forEach(t),wm.forEach(t),tx=d(F),ve=s(F,"DIV",{class:!0});var Cn=a(ve);m(na.$$.fragment,Cn),nx=d(Cn),op=s(Cn,"P",{});var O0=a(op);ox=i(O0,"Generates sequences for models with a language modeling head using multinomial sampling."),O0.forEach(t),sx=d(Cn),sp=s(Cn,"P",{});var z0=a(sp);ax=i(z0,"Examples:"),z0.forEach(t),rx=d(Cn),m(oa.$$.fragment,Cn),Cn.forEach(t),F.forEach(t),sc=d(n),G=s(n,"DIV",{class:!0});var J=a(G);m(sa.$$.fragment,J),ix=d(J),aa=s(J,"P",{});var jm=a(aa);lx=i(jm,"A class containing all of the functions supporting generation, to be used as a mixin in "),mr=s(jm,"A",{href:!0});var D0=a(mr);dx=i(D0,"TFPreTrainedModel"),D0.forEach(t),px=i(jm,"."),jm.forEach(t),cx=d(J),$n=s(J,"DIV",{class:!0});var $m=a($n);m(ra.$$.fragment,$m),mx=d($m),ia=s($m,"P",{});var Mm=a(ia);ux=i(Mm,"Implement in subclasses of "),ur=s(Mm,"A",{href:!0});var A0=a(ur);gx=i(A0,"PreTrainedModel"),A0.forEach(t),hx=i(Mm," for custom behavior to adjust the logits in the generate method."),Mm.forEach(t),$m.forEach(t),_x=d(J),N=s(J,"DIV",{class:!0});var Q=a(N);m(la.$$.fragment,Q),fx=d(Q),ap=s(Q,"P",{});var G0=a(ap);bx=i(G0,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),S0.forEach(t),xx=i(Pm,"."),Pm.forEach(t),wx=d(Q),Ee=s(Q,"P",{});var In=a(Ee);Tx=i(In,"Apart from "),rp=s(In,"CODE",{});var N0=a(rp);jx=i(N0,"input_ids"),N0.forEach(t),$x=i(In," and "),ip=s(In,"CODE",{});var C0=a(ip);Mx=i(C0,"attention_mask"),C0.forEach(t),Px=i(In,`, all the arguments below will default to the value of the attribute
...
post`),B0.forEach(t),zx=i(Em,"."),Em.forEach(t),Dx=d(Q),lp=s(Q,"P",{});var W0=a(lp);Ax=i(W0,"Examples:"),W0.forEach(t),Gx=d(Q),m(ua.$$.fragment,Q),Q.forEach(t),Sx=d(J),ye=s(J,"DIV",{class:!0});var Bn=a(ye);m(ga.$$.fragment,Bn),Nx=d(Bn),dp=s(Bn,"P",{});var U0=a(dp);Cx=i(U0,"Generates sequences for models with a language modeling head using greedy decoding."),U0.forEach(t),Ix=d(Bn),pp=s(Bn,"P",{});var H0=a(pp);Bx=i(H0,"Examples:"),H0.forEach(t),Wx=d(Bn),m(ha.$$.fragment,Bn),Bn.forEach(t),Ux=d(J),Mn=s(J,"DIV",{class:!0});var Lm=a(Mn);m(_a.$$.fragment,Lm),Hx=d(Lm),fa=s(Lm,"P",{});var qm=a(fa);Vx=i(qm,"Implement in subclasses of "),hr=s(qm,"A",{href:!0});var V0=a(hr);Xx=i(V0,"TFPreTrainedModel"),V0.forEach(t),Rx=i(qm," for custom behavior to prepare inputs in the generate method."),qm.forEach(t),Lm.forEach(t),Yx=d(J),ke=s(J,"DIV",{class:!0});var Wn=a(ke);m(ba.$$.fragment,Wn),Kx=d(Wn),cp=s(Wn,"P",{});var X0=a(cp);Zx=i(X0,"Generates sequences for models with a language modeling head using multinomial sampling."),X0.forEach(t),Jx=d(Wn),mp=s(Wn,"P",{});var R0=a(mp);Qx=i(R0,"Examples:"),R0.forEach(t),ew=d(Wn),m(va.$$.fragment,Wn),Wn.forEach(t),J.forEach(t),ac=d(n),Le=s(n,"DIV",{class:!0});var Sr=a(Le);m(ya.$$.fragment,Sr),tw=d(Sr),ka=s(Sr,"P",{});var Fm=a(ka);nw=i(Fm,"A class containing all of the functions supporting generation, to be used as a mixin in "),_r=s(Fm,"A",{href:!0});var Y0=a(_r);ow=i(Y0,"FlaxPreTrainedModel"),Y0.forEach(t),sw=i(Fm,"."),Fm.forEach(t),aw=d(Sr),H=s(Sr,"DIV",{class:!0});var $e=a(H);m(xa.$$.fragment,$e),rw=d($e),up=s($e,"P",{});var K0=a(up);iw=i(K0,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
and, multinomial sampling.`),K0.forEach(t),lw=d($e),yt=s($e,"P",{});var Nr=a(yt);dw=i(Nr,"Apart from "),gp=s(Nr,"CODE",{});var Z0=a(gp);pw=i(Z0,"input_ids"),Z0.forEach(t),cw=i(Nr,`, all the arguments below will default to the value of the attribute of the same name
