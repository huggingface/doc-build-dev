...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16184/src/transformers/models/blenderbot/modeling_blenderbot.py#L1275",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16184/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16184/src/transformers/models/blenderbot/modeling_blenderbot.py#L1442",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16184/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1134",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16184/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1254",returnDescription:`
<p>A <a
