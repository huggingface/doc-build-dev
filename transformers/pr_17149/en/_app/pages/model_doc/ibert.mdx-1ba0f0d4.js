...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(s.$$.fragment)},l(c){w(s.$$.fragment,c)},m(c,p){$(s,c,p),g=!0},p:Q,i(c){g||(T(s.$$.fragment,c),g=!0)},o(c){y(s.$$.fragment,c),g=!1},d(c){I(s,c)}}}function zl(B){let s,g,c,p,b,n,h,q,Yn,pn,oe,we,wo,Ke,Zn,$o,Xn,hn,$e,es,Ye,ts,os,mn,Ut,ns,un,Vt,To,ss,fn,V,rs,Ze,as,is,Xe,ls,ds,gn,ne,Te,yo,et,cs,Io,ps,_n,U,tt,hs,se,ms,Gt,us,fs,ot,gs,_s,bs,re,ks,Jt,vs,ws,Kt,$s,Ts,bn,ae,ye,Bo,nt,ys,qo,Is,kn,z,st,Bs,Mo,qs,Ms,rt,zs,Yt,Fs,xs,Cs,at,Es,it,js,Ps,As,lt,Ls,dt,Ss,Os,Rs,R,ct,Ns,ie,Ds,Zt,Ws,Qs,zo,Hs,Us,Vs,Ie,Gs,Be,vn,le,qe,Fo,pt,Js,xo,Ks,wn,F,ht,Ys,mt,Zs,Co,Xs,er,tr,ut,or,Xt,nr,sr,rr,ft,ar,gt,ir,lr,dr,P,_t,cr,de,pr,eo,hr,mr,Eo,ur,fr,gr,Me,_r,ze,br,Fe,$n,ce,xe,jo,bt,kr,Po,vr,Tn,x,kt,wr,Ao,$r,Tr,vt,yr,to,Ir,Br,qr,wt,Mr,$t,zr,Fr,xr,M,Tt,Cr,pe,Er,oo,jr,Pr,Lo,Ar,Lr,Sr,Ce,Or,Ee,Rr,je,Nr,Pe,Dr,Ae,yn,he,Le,So,yt,Wr,Oo,Qr,In,C,It,Hr,Ro,Ur,Vr,Bt,Gr,no,Jr,Kr,Yr,qt,Zr,Mt,Xr,ea,ta,N,zt,oa,me,na,so,sa,ra,No,aa,ia,la,Se,da,Oe,Bn,ue,Re,Do,Ft,ca,Wo,pa,qn,E,xt,ha,Qo,ma,ua,Ct,fa,ro,ga,_a,ba,Et,ka,jt,va,wa,$a,A,Pt,Ta,fe,ya,ao,Ia,Ba,Ho,qa,Ma,za,Ne,Fa,De,xa,We,Mn,ge,Qe,Uo,At,Ca,Vo,Ea,zn,j,Lt,ja,_e,Pa,Go,Aa,La,Jo,Sa,Oa,Ra,St,Na,io,Da,Wa,Qa,Ot,Ha,Rt,Ua,Va,Ga,L,Nt,Ja,be,Ka,lo,Ya,Za,Ko,Xa,ei,ti,He,oi,Ue,ni,Ve,Fn;return n=new ve({}),Ke=new ve({}),et=new ve({}),tt=new O({props:{name:"class transformers.IBertConfig",anchor:"transformers.IBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"quant_mode",val:" = False"},{name:"force_dequant",val:" = 'none'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.IBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the I-BERT model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17149/en/model_doc/ibert#transformers.IBertModel">IBertModel</a>`,name:"vocab_size"},{anchor:"transformers.IBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17149/en/model_doc/ibert#transformers.IBertConfig"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17149/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/ibert/modeling_ibert.py#L858"}}),_t=new O({props:{name:"forward",anchor:"transformers.IBertForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.IBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17149/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17149/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17149/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/ibert/modeling_ibert.py#L877",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/ibert/modeling_ibert.py#L986",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/ibert/modeling_ibert.py#L1082",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17149/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/ibert/modeling_ibert.py#L1162"}}),Pt=new O({props:{name:"forward",anchor:"transformers.IBertForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.IBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17149/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17149/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17149/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/ibert/modeling_ibert.py#L1177",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17149/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/ibert/modeling_ibert.py#L1263"}}),Nt=new O({props:{name:"forward",anchor:"transformers.IBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.IBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17149/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_17149/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17149/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/ibert/modeling_ibert.py#L1277",returnDescription:`
<p>A <a
...
documentation from `),Kt=r("a"),$s=l("PretrainedConfig"),Ts=l(" for more information."),bn=u(),ae=r("h2"),ye=r("a"),Bo=r("span"),v(nt.$$.fragment),ys=u(),qo=r("span"),Is=l("IBertModel"),kn=u(),z=r("div"),v(st.$$.fragment),Bs=u(),Mo=r("p"),qs=l("The bare I-BERT Model transformer outputting raw hidden-states without any specific head on top."),Ms=u(),rt=r("p"),zs=l("This model inherits from "),Yt=r("a"),Fs=l("PreTrainedModel"),xs=l(`. Check the superclass documentation for the generic methods the
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Rs=u(),R=r("div"),v(ct.$$.fragment),Ns=u(),ie=r("p"),Ds=l("The "),Zt=r("a"),Ws=l("IBertModel"),Qs=l(" forward method, overrides the "),zo=r("code"),Hs=l("__call__"),Us=l(" special method."),Vs=u(),v(Ie.$$.fragment),Gs=u(),v(Be.$$.fragment),vn=u(),le=r("h2"),qe=r("a"),Fo=r("span"),v(pt.$$.fragment),Js=u(),xo=r("span"),Ks=l("IBertForMaskedLM"),wn=u(),F=r("div"),v(ht.$$.fragment),Ys=u(),mt=r("p"),Zs=l("I-BERT Model with a "),Co=r("code"),Xs=l("language modeling"),er=l(" head on top."),tr=u(),ut=r("p"),or=l("This model inherits from "),Xt=r("a"),nr=l("PreTrainedModel"),sr=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rr=u(),ft=r("p"),ar=l("This model is also a PyTorch "),gt=r("a"),ir=l("torch.nn.Module"),lr=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dr=u(),P=r("div"),v(_t.$$.fragment),cr=u(),de=r("p"),pr=l("The "),eo=r("a"),hr=l("IBertForMaskedLM"),mr=l(" forward method, overrides the "),Eo=r("code"),ur=l("__call__"),fr=l(" special method."),gr=u(),v(Me.$$.fragment),_r=u(),v(ze.$$.fragment),br=u(),v(Fe.$$.fragment),$n=u(),ce=r("h2"),xe=r("a"),jo=r("span"),v(bt.$$.fragment),kr=u(),Po=r("span"),vr=l("IBertForSequenceClassification"),Tn=u(),x=r("div"),v(kt.$$.fragment),wr=u(),Ao=r("p"),$r=l(`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qr=u(),wt=r("p"),Mr=l("This model is also a PyTorch "),$t=r("a"),zr=l("torch.nn.Module"),Fr=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta=u(),N=r("div"),v(zt.$$.fragment),oa=u(),me=r("p"),na=l("The "),so=r("a"),sa=l("IBertForMultipleChoice"),ra=l(" forward method, overrides the "),No=r("code"),aa=l("__call__"),ia=l(" special method."),la=u(),v(Se.$$.fragment),da=u(),v(Oe.$$.fragment),Bn=u(),ue=r("h2"),Re=r("a"),Do=r("span"),v(Ft.$$.fragment),ca=u(),Wo=r("span"),pa=l("IBertForTokenClassification"),qn=u(),E=r("div"),v(xt.$$.fragment),ha=u(),Qo=r("p"),ma=l(`I-BERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$a=u(),A=r("div"),v(Pt.$$.fragment),Ta=u(),fe=r("p"),ya=l("The "),ao=r("a"),Ia=l("IBertForTokenClassification"),Ba=l(" forward method, overrides the "),Ho=r("code"),qa=l("__call__"),Ma=l(" special method."),za=u(),v(Ne.$$.fragment),Fa=u(),v(De.$$.fragment),xa=u(),v(We.$$.fragment),Mn=u(),ge=r("h2"),Qe=r("a"),Uo=r("span"),v(At.$$.fragment),Ca=u(),Vo=r("span"),Ea=l("IBertForQuestionAnswering"),zn=u(),j=r("div"),v(Lt.$$.fragment),ja=u(),_e=r("p"),Pa=l(`I-BERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),jn.forEach(o),Rs=f(D),R=a(D,"DIV",{class:!0});var Ge=i(R);w(ct.$$.fragment,Ge),Ns=f(Ge),ie=a(Ge,"P",{});var mo=i(ie);Ds=d(mo,"The "),Zt=a(mo,"A",{href:!0});var _i=i(Zt);Ws=d(_i,"IBertModel"),_i.forEach(o),Qs=d(mo," forward method, overrides the "),zo=a(mo,"CODE",{});var bi=i(zo);Hs=d(bi,"__call__"),bi.forEach(o),Us=d(mo," special method."),mo.forEach(o),Vs=f(Ge),w(Ie.$$.fragment,Ge),Gs=f(Ge),w(Be.$$.fragment,Ge),Ge.forEach(o),D.forEach(o),vn=f(t),le=a(t,"H2",{class:!0});var Pn=i(le);qe=a(Pn,"A",{id:!0,class:!0,href:!0});var ki=i(qe);Fo=a(ki,"SPAN",{});var vi=i(Fo);w(pt.$$.fragment,vi),vi.forEach(o),ki.forEach(o),Js=f(Pn),xo=a(Pn,"SPAN",{});var wi=i(xo);Ks=d(wi,"IBertForMaskedLM"),wi.forEach(o),Pn.forEach(o),wn=f(t),F=a(t,"DIV",{class:!0});var G=i(F);w(ht.$$.fragment,G),Ys=f(G),mt=a(G,"P",{});var An=i(mt);Zs=d(An,"I-BERT Model with a "),Co=a(An,"CODE",{});var $i=i(Co);Xs=d($i,"language modeling"),$i.forEach(o),er=d(An," head on top."),An.forEach(o),tr=f(G),ut=a(G,"P",{});var Ln=i(ut);or=d(Ln,"This model inherits from "),Xt=a(Ln,"A",{href:!0});var Ti=i(Xt);nr=d(Ti,"PreTrainedModel"),Ti.forEach(o),sr=d(Ln,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),ta=f(Y),N=a(Y,"DIV",{class:!0});var Je=i(N);w(zt.$$.fragment,Je),oa=f(Je),me=a(Je,"P",{});var go=i(me);na=d(go,"The "),so=a(go,"A",{href:!0});var Ni=i(so);sa=d(Ni,"IBertForMultipleChoice"),Ni.forEach(o),ra=d(go," forward method, overrides the "),No=a(go,"CODE",{});var Di=i(No);aa=d(Di,"__call__"),Di.forEach(o),ia=d(go," special method."),go.forEach(o),la=f(Je),w(Se.$$.fragment,Je),da=f(Je),w(Oe.$$.fragment,Je),Je.forEach(o),Y.forEach(o),Bn=f(t),ue=a(t,"H2",{class:!0});var Hn=i(ue);Re=a(Hn,"A",{id:!0,class:!0,href:!0});var Wi=i(Re);Do=a(Wi,"SPAN",{});var Qi=i(Do);w(Ft.$$.fragment,Qi),Qi.forEach(o),Wi.forEach(o),ca=f(Hn),Wo=a(Hn,"SPAN",{});var Hi=i(Wo);pa=d(Hi,"IBertForTokenClassification"),Hi.forEach(o),Hn.forEach(o),qn=f(t),E=a(t,"DIV",{class:!0});var Z=i(E);w(xt.$$.fragment,Z),ha=f(Z),Qo=a(Z,"P",{});var Ui=i(Qo);ma=d(Ui,`I-BERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vn.forEach(o),$a=f(Z),A=a(Z,"DIV",{class:!0});var X=i(A);w(Pt.$$.fragment,X),Ta=f(X),fe=a(X,"P",{});var _o=i(fe);ya=d(_o,"The "),ao=a(_o,"A",{href:!0});var Ji=i(ao);Ia=d(Ji,"IBertForTokenClassification"),Ji.forEach(o),Ba=d(_o," forward method, overrides the "),Ho=a(_o,"CODE",{});var Ki=i(Ho);qa=d(Ki,"__call__"),Ki.forEach(o),Ma=d(_o," special method."),_o.forEach(o),za=f(X),w(Ne.$$.fragment,X),Fa=f(X),w(De.$$.fragment,X),xa=f(X),w(We.$$.fragment,X),X.forEach(o),Z.forEach(o),Mn=f(t),ge=a(t,"H2",{class:!0});var Gn=i(ge);Qe=a(Gn,"A",{id:!0,class:!0,href:!0});var Yi=i(Qe);Uo=a(Yi,"SPAN",{});var Zi=i(Uo);w(At.$$.fragment,Zi),Zi.forEach(o),Yi.forEach(o),Ca=f(Gn),Vo=a(Gn,"SPAN",{});var Xi=i(Vo);Ea=d(Xi,"IBertForQuestionAnswering"),Xi.forEach(o),Gn.forEach(o),zn=f(t),j=a(t,"DIV",{class:!0});var ee=i(j);w(Lt.$$.fragment,ee),ja=f(ee),_e=a(ee,"P",{});var bo=i(_e);Pa=d(bo,`I-BERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
