import{S as Mi,i as Fi,s as Ci,e as s,k as h,w as b,t as l,M as Ei,c as a,d as o,m as u,a as r,x as y,h as i,b as c,F as e,g as v,y as k,q as $,o as P,B as w,v as qi,L as ge}from"../../chunks/vendor-6b77c823.js";import{T as hn}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-1088f2fb.js";import{C as Q}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as me}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as fe}from"../../chunks/ExampleCodeBlock-5212b321.js";function zi(N){let d,_,p,m,T;return m=new Q({props:{code:`from transformers import GPTNeoModel, GPTNeoConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),_=l("Example:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function ji(N){let d,_,p,m,T;return{c(){d=s("p"),_=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s("code"),m=l("Module"),T=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(f,"CODE",{});var x=r(p);m=i(x,"Module"),x.forEach(o),T=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(n,f){v(n,d,f),e(d,_),e(d,p),e(p,m),e(d,T)},d(n){n&&o(d)}}}function Ai(N){let d,_,p,m,T;return m=new Q({props:{code:`from transformers import GPT2Tokenizer, GPTNeoModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),_=l("Example:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Ii(N){let d,_,p,m,T;return{c(){d=s("p"),_=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s("code"),m=l("Module"),T=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(f,"CODE",{});var x=r(p);m=i(x,"Module"),x.forEach(o),T=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(n,f){v(n,d,f),e(d,_),e(d,p),e(p,m),e(d,T)},d(n){n&&o(d)}}}function Li(N){let d,_,p,m,T;return m=new Q({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=s("p"),_=l("Example:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Si(N){let d,_,p,m,T;return{c(){d=s("p"),_=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s("code"),m=l("Module"),T=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(f,"CODE",{});var x=r(p);m=i(x,"Module"),x.forEach(o),T=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(n,f){v(n,d,f),e(d,_),e(d,p),e(p,m),e(d,T)},d(n){n&&o(d)}}}function Oi(N){let d,_,p,m,T;return m=new Q({props:{code:`import torch
...
`}}),{c(){d=s("p"),_=l("Example of single-label classification:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example of single-label classification:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Di(N){let d,_;return d=new Q({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){b(d.$$.fragment)},l(p){y(d.$$.fragment,p)},m(p,m){k(d,p,m),_=!0},p:ge,i(p){_||($(d.$$.fragment,p),_=!0)},o(p){P(d.$$.fragment,p),_=!1},d(p){w(d,p)}}}function Bi(N){let d,_,p,m,T;return m=new Q({props:{code:`import torch
from transformers import GPT2Tokenizer, GPTNeoForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=s("p"),_=l("Example of multi-label classification:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example of multi-label classification:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Wi(N){let d,_;return d=new Q({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){b(d.$$.fragment)},l(p){y(d.$$.fragment,p)},m(p,m){k(d,p,m),_=!0},p:ge,i(p){_||($(d.$$.fragment,p),_=!0)},o(p){P(d.$$.fragment,p),_=!1},d(p){w(d,p)}}}function Hi(N){let d,_,p,m,T;return{c(){d=s("p"),_=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s("code"),m=l("Module"),T=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(f,"CODE",{});var x=r(p);m=i(x,"Module"),x.forEach(o),T=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(n,f){v(n,d,f),e(d,_),e(d,p),e(p,m),e(d,T)},d(n){n&&o(d)}}}function Vi(N){let d,_,p,m,T;return m=new Q({props:{code:`from transformers import GPT2Tokenizer, FlaxGPTNeoModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),_=l("Example:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Ui(N){let d,_,p,m,T;return{c(){d=s("p"),_=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s("code"),m=l("Module"),T=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(f,"CODE",{});var x=r(p);m=i(x,"Module"),x.forEach(o),T=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(n,f){v(n,d,f),e(d,_),e(d,p),e(p,m),e(d,T)},d(n){n&&o(d)}}}function Ji(N){let d,_,p,m,T;return m=new Q({props:{code:`from transformers import GPT2Tokenizer, FlaxGPTNeoForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),_=l("Example:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=i(f,"Example:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Ri(N){let d,_,p,m,T,n,f,x,Qn,un,Y,_e,ho,Re,Yn,uo,Zn,mn,J,es,Xe,ts,os,Ke,ns,ss,fn,Ht,as,gn,Te,rs,Qe,ls,is,_n,Z,ve,mo,Ye,ds,fo,cs,Tn,be,ps,go,hs,us,vn,Ze,bn,ee,ye,_o,et,ms,To,fs,yn,L,tt,gs,te,_s,Vt,Ts,vs,ot,bs,ys,ks,oe,$s,Ut,Ps,ws,Jt,Ns,xs,Gs,ke,kn,ne,$e,vo,nt,Ms,bo,Fs,$n,E,st,Cs,yo,Es,qs,at,zs,Rt,js,As,Is,rt,Ls,lt,Ss,Os,Ds,O,it,Bs,se,Ws,Xt,Hs,Vs,ko,Us,Js,Rs,Pe,Xs,we,Pn,ae,Ne,$o,dt,Ks,Po,Qs,wn,q,ct,Ys,wo,Zs,ea,pt,ta,Kt,oa,na,sa,ht,aa,ut,ra,la,ia,D,mt,da,re,ca,Qt,pa,ha,No,ua,ma,fa,xe,ga,Ge,Nn,le,Me,xo,ft,_a,Go,Ta,xn,G,gt,va,Mo,ba,ya,Yt,Zt,ka,$a,Pa,S,wa,Fo,Na,xa,Co,Ga,Ma,Eo,Fa,Ca,qo,Ea,qa,za,_t,ja,eo,Aa,Ia,La,Tt,Sa,vt,Oa,Da,Ba,C,bt,Wa,ie,Ha,to,Va,Ua,zo,Ja,Ra,Xa,Fe,Ka,Ce,Qa,Ee,Ya,qe,Za,ze,Gn,de,je,jo,yt,er,Ao,tr,Mn,M,kt,or,Io,nr,sr,$t,ar,oo,rr,lr,ir,Pt,dr,wt,cr,pr,hr,Lo,ur,mr,H,So,Nt,fr,gr,Oo,xt,_r,Tr,Do,Gt,vr,br,Bo,Mt,yr,kr,B,Ft,$r,ce,Pr,Wo,wr,Nr,Ho,xr,Gr,Mr,Ae,Fr,Ie,Fn,pe,Le,Vo,Ct,Cr,Uo,Er,Cn,F,Et,qr,Jo,zr,jr,qt,Ar,no,Ir,Lr,Sr,zt,Or,jt,Dr,Br,Wr,Ro,Hr,Vr,V,Xo,At,Ur,Jr,Ko,It,Rr,Xr,Qo,Lt,Kr,Qr,Yo,St,Yr,Zr,W,Ot,el,he,tl,Zo,ol,nl,en,sl,al,rl,Se,ll,Oe,En;return n=new me({}),Re=new me({}),Ye=new me({}),Ze=new Q({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17149/en/model_doc/gpt_neo#transformers.GPTNeoModel">GPTNeoModel</a>. Vocabulary size of the model. Defines the different
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/pr_17149/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_17149/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L491",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17149/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17149/en/model_doc/gpt_neo#transformers.GPTNeoConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L709",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17149/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L824",returnDescription:`
...
<p>A <a
  href="/docs/transformers/pr_17149/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17149/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17149/src/transformers/models/gpt_neo/modeling_flax_gpt_neo.py#L402",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17149/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
256 tokens.`),gn=h(),Te=s("p"),rs=l("This model was contributed by "),Qe=s("a"),ls=l("valhalla"),is=l("."),_n=h(),Z=s("h3"),ve=s("a"),mo=s("span"),b(Ye.$$.fragment),ds=h(),fo=s("span"),cs=l("Generation"),Tn=h(),be=s("p"),ps=l("The "),go=s("code"),hs=l("generate()"),us=l(" method can be used to generate text using GPT Neo model."),vn=h(),b(Ze.$$.fragment),bn=h(),ee=s("h2"),ye=s("a"),_o=s("span"),b(et.$$.fragment),ms=h(),To=s("span"),fs=l("GPTNeoConfig"),yn=h(),L=s("div"),b(tt.$$.fragment),gs=h(),te=s("p"),_s=l("This is the configuration class to store the configuration of a "),Vt=s("a"),Ts=l("GPTNeoModel"),vs=l(`. It is used to instantiate a GPT
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ia=h(),D=s("div"),b(mt.$$.fragment),da=h(),re=s("p"),ca=l("The "),Qt=s("a"),pa=l("GPTNeoForCausalLM"),ha=l(" forward method, overrides the "),No=s("code"),ua=l("__call__"),ma=l(" special method."),fa=h(),b(xe.$$.fragment),ga=h(),b(Ge.$$.fragment),Nn=h(),le=s("h2"),Me=s("a"),xo=s("span"),b(ft.$$.fragment),_a=h(),Go=s("span"),Ta=l("GPTNeoForSequenceClassification"),xn=h(),G=s("div"),b(gt.$$.fragment),va=h(),Mo=s("p"),ba=l("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),ya=h(),Yt=s("p"),Zt=s("a"),ka=l("GPTNeoForSequenceClassification"),$a=l(` uses the last token in order to do the classification, as other causal models
...
`),Fo=s("code"),Na=l("pad_token_id"),xa=l(` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),Co=s("code"),Ga=l("pad_token_id"),Ma=l(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Eo=s("code"),Fa=l("inputs_embeds"),Ca=l(" are passed instead of "),qo=s("code"),Ea=l("input_ids"),qa=l(`, it does the same (take the last value in
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),La=h(),Tt=s("p"),Sa=l("This model is also a PyTorch "),vt=s("a"),Oa=l("torch.nn.Module"),Da=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ba=h(),C=s("div"),b(bt.$$.fragment),Wa=h(),ie=s("p"),Ha=l("The "),to=s("a"),Va=l("GPTNeoForSequenceClassification"),Ua=l(" forward method, overrides the "),zo=s("code"),Ja=l("__call__"),Ra=l(" special method."),Xa=h(),b(Fe.$$.fragment),Ka=h(),b(Ce.$$.fragment),Qa=h(),b(Ee.$$.fragment),Ya=h(),b(qe.$$.fragment),Za=h(),b(ze.$$.fragment),Gn=h(),de=s("h2"),je=s("a"),jo=s("span"),b(yt.$$.fragment),er=h(),Ao=s("span"),tr=l("FlaxGPTNeoModel"),Mn=h(),M=s("div"),b(kt.$$.fragment),or=h(),Io=s("p"),nr=l("The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),sr=h(),$t=s("p"),ar=l("This model inherits from "),oo=s("a"),rr=l("FlaxPreTrainedModel"),lr=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ir=h(),Pt=s("p"),dr=l(`This model is also a Flax Linen
`),wt=s("a"),cr=l("flax.nn.Module"),pr=l(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),hr=h(),Lo=s("p"),ur=l("Finally, this model supports inherent JAX features such as:"),mr=h(),H=s("ul"),So=s("li"),Nt=s("a"),fr=l("Just-In-Time (JIT) compilation"),gr=h(),Oo=s("li"),xt=s("a"),_r=l("Automatic Differentiation"),Tr=h(),Do=s("li"),Gt=s("a"),vr=l("Vectorization"),br=h(),Bo=s("li"),Mt=s("a"),yr=l("Parallelization"),kr=h(),B=s("div"),b(Ft.$$.fragment),$r=h(),ce=s("p"),Pr=l("The "),Wo=s("code"),wr=l("FlaxGPTNeoPreTrainedModel"),Nr=l(" forward method, overrides the "),Ho=s("code"),xr=l("__call__"),Gr=l(" special method."),Mr=h(),b(Ae.$$.fragment),Fr=h(),b(Ie.$$.fragment),Fn=h(),pe=s("h2"),Le=s("a"),Vo=s("span"),b(Ct.$$.fragment),Cr=h(),Uo=s("span"),Er=l("FlaxGPTNeoForCausalLM"),Cn=h(),F=s("div"),b(Et.$$.fragment),qr=h(),Jo=s("p"),zr=l(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
256 tokens.`),cn.forEach(o),gn=u(t),Te=a(t,"P",{});var Wt=r(Te);rs=i(Wt,"This model was contributed by "),Qe=a(Wt,"A",{href:!0,rel:!0});var pn=r(Qe);ls=i(pn,"valhalla"),pn.forEach(o),is=i(Wt,"."),Wt.forEach(o),_n=u(t),Z=a(t,"H3",{class:!0});var qn=r(Z);ve=a(qn,"A",{id:!0,class:!0,href:!0});var dl=r(ve);mo=a(dl,"SPAN",{});var cl=r(mo);y(Ye.$$.fragment,cl),cl.forEach(o),dl.forEach(o),ds=u(qn),fo=a(qn,"SPAN",{});var pl=r(fo);cs=i(pl,"Generation"),pl.forEach(o),qn.forEach(o),Tn=u(t),be=a(t,"P",{});var zn=r(be);ps=i(zn,"The "),go=a(zn,"CODE",{});var hl=r(go);hs=i(hl,"generate()"),hl.forEach(o),us=i(zn," method can be used to generate text using GPT Neo model."),zn.forEach(o),vn=u(t),y(Ze.$$.fragment,t),bn=u(t),ee=a(t,"H2",{class:!0});var jn=r(ee);ye=a(jn,"A",{id:!0,class:!0,href:!0});var ul=r(ye);_o=a(ul,"SPAN",{});var ml=r(_o);y(et.$$.fragment,ml),ml.forEach(o),ul.forEach(o),ms=u(jn),To=a(jn,"SPAN",{});var fl=r(To);fs=i(fl,"GPTNeoConfig"),fl.forEach(o),jn.forEach(o),yn=u(t),L=a(t,"DIV",{class:!0});var De=r(L);y(tt.$$.fragment,De),gs=u(De),te=a(De,"P",{});var so=r(te);_s=i(so,"This is the configuration class to store the configuration of a "),Vt=a(so,"A",{href:!0});var gl=r(Vt);Ts=i(gl,"GPTNeoModel"),gl.forEach(o),vs=i(so,`. It is used to instantiate a GPT
Neo model according to the specified arguments, defining the model architecture. Instantiating a configuration with
the defaults will yield a similar configuration to that of the GPTNeo
`),ot=a(so,"A",{href:!0,rel:!0});var _l=r(ot);bs=i(_l,"EleutherAI/gpt-neo-1.3B"),_l.forEach(o),ys=i(so," architecture."),so.forEach(o),ks=u(De),oe=a(De,"P",{});var ao=r(oe);$s=i(ao,"Configuration objects inherit from "),Ut=a(ao,"A",{href:!0});var Tl=r(Ut);Ps=i(Tl,"PretrainedConfig"),Tl.forEach(o),ws=i(ao,` and can be used to control the model outputs. Read the
documentation from `),Jt=a(ao,"A",{href:!0});var vl=r(Jt);Ns=i(vl,"PretrainedConfig"),vl.forEach(o),xs=i(ao," for more information."),ao.forEach(o),Gs=u(De),y(ke.$$.fragment,De),De.forEach(o),kn=u(t),ne=a(t,"H2",{class:!0});var An=r(ne);$e=a(An,"A",{id:!0,class:!0,href:!0});var bl=r($e);vo=a(bl,"SPAN",{});var yl=r(vo);y(nt.$$.fragment,yl),yl.forEach(o),bl.forEach(o),Ms=u(An),bo=a(An,"SPAN",{});var kl=r(bo);Fs=i(kl,"GPTNeoModel"),kl.forEach(o),An.forEach(o),$n=u(t),E=a(t,"DIV",{class:!0});var R=r(E);y(st.$$.fragment,R),Cs=u(R),yo=a(R,"P",{});var $l=r(yo);Es=i($l,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),$l.forEach(o),qs=u(R),at=a(R,"P",{});var In=r(at);zs=i(In,"This model inherits from "),Rt=a(In,"A",{href:!0});var Pl=r(Rt);js=i(Pl,"PreTrainedModel"),Pl.forEach(o),As=i(In,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ln.forEach(o),Ds=u(R),O=a(R,"DIV",{class:!0});var Be=r(O);y(it.$$.fragment,Be),Bs=u(Be),se=a(Be,"P",{});var ro=r(se);Ws=i(ro,"The "),Xt=a(ro,"A",{href:!0});var Nl=r(Xt);Hs=i(Nl,"GPTNeoModel"),Nl.forEach(o),Vs=i(ro," forward method, overrides the "),ko=a(ro,"CODE",{});var xl=r(ko);Us=i(xl,"__call__"),xl.forEach(o),Js=i(ro," special method."),ro.forEach(o),Rs=u(Be),y(Pe.$$.fragment,Be),Xs=u(Be),y(we.$$.fragment,Be),Be.forEach(o),R.forEach(o),Pn=u(t),ae=a(t,"H2",{class:!0});var Sn=r(ae);Ne=a(Sn,"A",{id:!0,class:!0,href:!0});var Gl=r(Ne);$o=a(Gl,"SPAN",{});var Ml=r($o);y(dt.$$.fragment,Ml),Ml.forEach(o),Gl.forEach(o),Ks=u(Sn),Po=a(Sn,"SPAN",{});var Fl=r(Po);Qs=i(Fl,"GPTNeoForCausalLM"),Fl.forEach(o),Sn.forEach(o),wn=u(t),q=a(t,"DIV",{class:!0});var X=r(q);y(ct.$$.fragment,X),Ys=u(X),wo=a(X,"P",{});var Cl=r(wo);Zs=i(Cl,`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dn.forEach(o),ia=u(X),D=a(X,"DIV",{class:!0});var We=r(D);y(mt.$$.fragment,We),da=u(We),re=a(We,"P",{});var lo=r(re);ca=i(lo,"The "),Qt=a(lo,"A",{href:!0});var zl=r(Qt);pa=i(zl,"GPTNeoForCausalLM"),zl.forEach(o),ha=i(lo," forward method, overrides the "),No=a(lo,"CODE",{});var jl=r(No);ua=i(jl,"__call__"),jl.forEach(o),ma=i(lo," special method."),lo.forEach(o),fa=u(We),y(xe.$$.fragment,We),ga=u(We),y(Ge.$$.fragment,We),We.forEach(o),X.forEach(o),Nn=u(t),le=a(t,"H2",{class:!0});var Bn=r(le);Me=a(Bn,"A",{id:!0,class:!0,href:!0});var Al=r(Me);xo=a(Al,"SPAN",{});var Il=r(xo);y(ft.$$.fragment,Il),Il.forEach(o),Al.forEach(o),_a=u(Bn),Go=a(Bn,"SPAN",{});var Ll=r(Go);Ta=i(Ll,"GPTNeoForSequenceClassification"),Ll.forEach(o),Bn.forEach(o),xn=u(t),G=a(t,"DIV",{class:!0});var z=r(G);y(gt.$$.fragment,z),va=u(z),Mo=a(z,"P",{});var Sl=r(Mo);ba=i(Sl,"The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),Sl.forEach(o),ya=u(z),Yt=a(z,"P",{});var il=r(Yt);Zt=a(il,"A",{href:!0});var Ol=r(Zt);ka=i(Ol,"GPTNeoForSequenceClassification"),Ol.forEach(o),$a=i(il,` uses the last token in order to do the classification, as other causal models
...
`),Fo=a(K,"CODE",{});var Dl=r(Fo);Na=i(Dl,"pad_token_id"),Dl.forEach(o),xa=i(K,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),Co=a(K,"CODE",{});var Bl=r(Co);Ga=i(Bl,"pad_token_id"),Bl.forEach(o),Ma=i(K,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Eo=a(K,"CODE",{});var Wl=r(Eo);Fa=i(Wl,"inputs_embeds"),Wl.forEach(o),Ca=i(K," are passed instead of "),qo=a(K,"CODE",{});var Hl=r(qo);Ea=i(Hl,"input_ids"),Hl.forEach(o),qa=i(K,`, it does the same (take the last value in
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wn.forEach(o),La=u(z),Tt=a(z,"P",{});var Hn=r(Tt);Sa=i(Hn,"This model is also a PyTorch "),vt=a(Hn,"A",{href:!0,rel:!0});var Ul=r(vt);Oa=i(Ul,"torch.nn.Module"),Ul.forEach(o),Da=i(Hn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hn.forEach(o),Ba=u(z),C=a(z,"DIV",{class:!0});var j=r(C);y(bt.$$.fragment,j),Wa=u(j),ie=a(j,"P",{});var io=r(ie);Ha=i(io,"The "),to=a(io,"A",{href:!0});var Jl=r(to);Va=i(Jl,"GPTNeoForSequenceClassification"),Jl.forEach(o),Ua=i(io," forward method, overrides the "),zo=a(io,"CODE",{});var Rl=r(zo);Ja=i(Rl,"__call__"),Rl.forEach(o),Ra=i(io," special method."),io.forEach(o),Xa=u(j),y(Fe.$$.fragment,j),Ka=u(j),y(Ce.$$.fragment,j),Qa=u(j),y(Ee.$$.fragment,j),Ya=u(j),y(qe.$$.fragment,j),Za=u(j),y(ze.$$.fragment,j),j.forEach(o),z.forEach(o),Gn=u(t),de=a(t,"H2",{class:!0});var Vn=r(de);je=a(Vn,"A",{id:!0,class:!0,href:!0});var Xl=r(je);jo=a(Xl,"SPAN",{});var Kl=r(jo);y(yt.$$.fragment,Kl),Kl.forEach(o),Xl.forEach(o),er=u(Vn),Ao=a(Vn,"SPAN",{});var Ql=r(Ao);tr=i(Ql,"FlaxGPTNeoModel"),Ql.forEach(o),Vn.forEach(o),Mn=u(t),M=a(t,"DIV",{class:!0});var A=r(M);y(kt.$$.fragment,A),or=u(A),Io=a(A,"P",{});var Yl=r(Io);nr=i(Yl,"The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),Yl.forEach(o),sr=u(A),$t=a(A,"P",{});var Un=r($t);ar=i(Un,"This model inherits from "),oo=a(Un,"A",{href:!0});var Zl=r(oo);rr=i(Zl,"FlaxPreTrainedModel"),Zl.forEach(o),lr=i(Un,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jn.forEach(o),hr=u(A),Lo=a(A,"P",{});var ti=r(Lo);ur=i(ti,"Finally, this model supports inherent JAX features such as:"),ti.forEach(o),mr=u(A),H=a(A,"UL",{});var He=r(H);So=a(He,"LI",{});var oi=r(So);Nt=a(oi,"A",{href:!0,rel:!0});var ni=r(Nt);fr=i(ni,"Just-In-Time (JIT) compilation"),ni.forEach(o),oi.forEach(o),gr=u(He),Oo=a(He,"LI",{});var si=r(Oo);xt=a(si,"A",{href:!0,rel:!0});var ai=r(xt);_r=i(ai,"Automatic Differentiation"),ai.forEach(o),si.forEach(o),Tr=u(He),Do=a(He,"LI",{});var ri=r(Do);Gt=a(ri,"A",{href:!0,rel:!0});var li=r(Gt);vr=i(li,"Vectorization"),li.forEach(o),ri.forEach(o),br=u(He),Bo=a(He,"LI",{});var ii=r(Bo);Mt=a(ii,"A",{href:!0,rel:!0});var di=r(Mt);yr=i(di,"Parallelization"),di.forEach(o),ii.forEach(o),He.forEach(o),kr=u(A),B=a(A,"DIV",{class:!0});var Ve=r(B);y(Ft.$$.fragment,Ve),$r=u(Ve),ce=a(Ve,"P",{});var co=r(ce);Pr=i(co,"The "),Wo=a(co,"CODE",{});var ci=r(Wo);wr=i(ci,"FlaxGPTNeoPreTrainedModel"),ci.forEach(o),Nr=i(co," forward method, overrides the "),Ho=a(co,"CODE",{});var pi=r(Ho);xr=i(pi,"__call__"),pi.forEach(o),Gr=i(co," special method."),co.forEach(o),Mr=u(Ve),y(Ae.$$.fragment,Ve),Fr=u(Ve),y(Ie.$$.fragment,Ve),Ve.forEach(o),A.forEach(o),Fn=u(t),pe=a(t,"H2",{class:!0});var Rn=r(pe);Le=a(Rn,"A",{id:!0,class:!0,href:!0});var hi=r(Le);Vo=a(hi,"SPAN",{});var ui=r(Vo);y(Ct.$$.fragment,ui),ui.forEach(o),hi.forEach(o),Cr=u(Rn),Uo=a(Rn,"SPAN",{});var mi=r(Uo);Er=i(mi,"FlaxGPTNeoForCausalLM"),mi.forEach(o),Rn.forEach(o),Cn=u(t),F=a(t,"DIV",{class:!0});var I=r(F);y(Et.$$.fragment,I),qr=u(I),Jo=a(I,"P",{});var fi=r(Jo);zr=i(fi,`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
