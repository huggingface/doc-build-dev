...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var A=a(F);C=s(A,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),W=s(Y,"CODE",{});var Ae=a(W);Fe=i(Ae,"model(inputs_ids)"),Ae.forEach(t),Y.forEach(t),ye=l(A),P=s(A,"LI",{});var Z=a(P);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),O=s(Z,"CODE",{});var Le=a(O);Pe=i(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),Z.forEach(t),fe=l(A),N=s(A,"LI",{});var Ie=a(N);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(Ie,"CODE",{});var ft=a(U);Oe=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),A.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ke),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,W),e(W,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,O),e(O,Pe),e(F,fe),e(F,N),e(N,Ce),e(N,U),e(U,Oe)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function bw(L){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var A=a(F);C=s(A,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),W=s(Y,"CODE",{});var Ae=a(W);Fe=i(Ae,"model(inputs_ids)"),Ae.forEach(t),Y.forEach(t),ye=l(A),P=s(A,"LI",{});var Z=a(P);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),O=s(Z,"CODE",{});var Le=a(O);Pe=i(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),Z.forEach(t),fe=l(A),N=s(A,"LI",{});var Ie=a(N);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(Ie,"CODE",{});var ft=a(U);Oe=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),A.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ke),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,W),e(W,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,O),e(O,Pe),e(F,fe),e(F,N),e(N,Ce),e(N,U),e(U,Oe)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function ww(L){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var A=a(F);C=s(A,"LI",{});var Y=a(C);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);be=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),W=s(Y,"CODE",{});var Ae=a(W);Fe=i(Ae,"model(inputs_ids)"),Ae.forEach(t),Y.forEach(t),ye=l(A),P=s(A,"LI",{});var Z=a(P);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),O=s(Z,"CODE",{});var Le=a(O);Pe=i(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),Z.forEach(t),fe=l(A),N=s(A,"LI",{});var Ie=a(N);Ce=i(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(Ie,"CODE",{});var ft=a(U);Oe=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ie.forEach(t),A.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ke),p(m,B,j),p(m,I,j),e(I,ae),p(m,pe,j),p(m,F,j),e(F,C),e(C,he),e(C,K),e(K,be),e(C,ue),e(C,W),e(W,Fe),e(F,ye),e(F,P),e(P,Me),e(P,H),e(H,V),e(P,me),e(P,O),e(O,Pe),e(F,fe),e(F,N),e(N,Ce),e(N,U),e(U,Oe)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(B),m&&t(I),m&&t(pe),m&&t(F)}}}function zw(L){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,$),e(u,b),e(b,w),e(u,z)},d(x){x&&t(u)}}}function Ew(L){let u,$,b,w,z,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,ke,B,I,ae,pe,F,C,he,K,be,ue,W,Fe,ye,P,Me,H,V,me,O,Pe,fe,N,Ce,U,Oe,m,j,te,Se,pt,D,Ge,ne,ht,A,Y,ut,Ae,Z,mt,Le,Ie,ft,Vl,Xa,Dp,Kl,Be,di,li,To,Sp,Gp,ci,pi,vo,Bp,Wp,hi,ui,ko,Up,Rp,mi,fi,bo,Hp,Vp,_i,Qa,yo,Kp,Yp,Yl,er,Zp,Zl,$t,gi,zn,Ti,Jp,Xp,tr,Qp,eh,th,vi,$n,ki,nh,oh,nr,sh,ah,rh,bi,qn,yi,ih,dh,or,lh,ch,Jl,En,ph,wo,hh,uh,Xl,qt,mh,xo,fh,_h,zo,gh,Th,Ql,sr,ec,Zt,jn,wi,$o,vh,xi,kh,tc,_t,bh,zi,yh,wh,$i,xh,zh,qi,$h,qh,nc,Fn,Eh,ar,jh,Fh,oc,Mn,dt,Ei,Mh,Ph,_e,Ch,ji,Oh,Ah,Fi,Lh,Ih,Mi,Nh,Dh,Pi,Sh,Gh,Ci,Bh,Wh,rr,Uh,Rh,Hh,Oi,Vh,Kh,qo,Yh,Eo,Zh,jo,Jh,Xh,Qh,ge,Ai,eu,tu,Li,nu,ou,Fo,su,re,au,Ii,ru,iu,Ni,du,lu,Di,cu,pu,Si,hu,uu,Gi,mu,fu,Bi,_u,gu,Wi,Tu,vu,ku,Jt,bu,Ui,yu,wu,Ri,xu,zu,$u,Te,qu,Hi,Eu,ju,Vi,Fu,Mu,Ki,Pu,Cu,Yi,Ou,Au,Mo,Lu,Iu,Zi,Nu,Du,Su,Po,sc,ir,Gu,ac,Et,Ji,Co,Bu,Xi,Wu,Uu,Ru,Qi,Xt,Hu,Oo,Vu,Ku,Ao,Yu,Zu,Ju,ed,Lo,Xu,td,Qu,em,rc,dr,ic,Qt,Pn,nd,Io,tm,od,nm,dc,gt,om,lr,sm,am,No,rm,im,Do,dm,lm,lc,So,cc,We,cm,sd,pm,hm,ad,um,mm,cr,fm,_m,rd,gm,Tm,pc,pr,vm,hc,Go,uc,hr,mc,en,Cn,id,Bo,km,dd,bm,fc,Tt,ym,Wo,wm,xm,ld,zm,$m,cd,qm,Em,_c,tn,On,pd,Uo,jm,hd,Fm,gc,ur,Mm,Tc,An,ud,nn,Pm,Ro,Cm,Om,Ho,Am,Lm,Im,md,Ne,Nm,Vo,Dm,Sm,Ko,Gm,Bm,Yo,Wm,Um,Zo,Rm,Hm,Jo,Vm,Km,vc,on,Ln,fd,Xo,Ym,_d,Zm,kc,wt,Qo,Jm,xt,Xm,mr,Qm,ef,fr,tf,nf,es,of,sf,af,sn,rf,_r,df,lf,gr,cf,pf,bc,an,In,gd,ts,hf,Td,uf,yc,ie,ns,mf,os,ff,ss,_f,gf,Tf,as,vf,Tr,kf,bf,yf,jt,rs,wf,vd,xf,zf,is,vr,$f,kd,qf,Ef,kr,jf,bd,Ff,Mf,Nn,ds,Pf,ls,Cf,yd,Of,Af,Lf,Dn,cs,If,wd,Nf,Df,br,ps,wc,rn,Sn,xd,hs,Sf,zd,Gf,xc,De,us,Bf,dn,Wf,$d,Uf,Rf,ms,Hf,Vf,Kf,fs,Yf,yr,Zf,Jf,Xf,Ft,_s,Qf,qd,e_,t_,gs,wr,n_,Ed,o_,s_,xr,a_,jd,r_,i_,Gn,Ts,d_,Fd,l_,zc,ln,Bn,Md,vs,c_,Pd,p_,$c,J,ks,h_,Cd,u_,m_,bs,f_,ys,__,g_,T_,ws,v_,zr,k_,b_,y_,xs,w_,zs,x_,z_,$_,Ue,$s,q_,cn,E_,$r,j_,F_,Od,M_,P_,C_,Wn,O_,Ad,A_,L_,qs,I_,Re,Es,N_,Ld,D_,S_,Id,G_,B_,Nd,W_,U_,js,R_,vt,Fs,H_,Dd,V_,K_,Sd,Y_,Z_,Ms,qc,pn,Un,Gd,Ps,J_,Bd,X_,Ec,X,Cs,Q_,Os,eg,Wd,tg,ng,og,As,sg,Ls,ag,rg,ig,Is,dg,qr,lg,cg,pg,Ns,hg,Ds,ug,mg,fg,He,Ss,_g,hn,gg,Er,Tg,vg,Ud,kg,bg,yg,Rn,wg,Rd,xg,zg,Gs,$g,Ve,Bs,qg,Hd,Eg,jg,Vd,Fg,Mg,Kd,Pg,Cg,Ws,Og,kt,Us,Ag,Yd,Lg,Ig,Zd,Ng,Dg,Rs,jc,un,Hn,Jd,Hs,Sg,Xd,Gg,Fc,Q,Vs,Bg,Qd,Wg,Ug,Ks,Rg,Ys,Hg,Vg,Kg,Zs,Yg,jr,Zg,Jg,Xg,Js,Qg,Xs,eT,tT,nT,Ke,Qs,oT,mn,sT,Fr,aT,rT,el,iT,dT,lT,Vn,cT,tl,pT,hT,ea,uT,Ye,ta,mT,nl,fT,_T,ol,gT,TT,sl,vT,kT,na,bT,bt,oa,yT,al,wT,xT,rl,zT,$T,sa,Mc,fn,Kn,il,aa,qT,dl,ET,Pc,de,ra,jT,ll,FT,MT,ia,PT,da,CT,OT,AT,la,LT,Mr,IT,NT,DT,ca,ST,pa,GT,BT,WT,Yn,UT,Ze,ha,RT,_n,HT,Pr,VT,KT,cl,YT,ZT,JT,Zn,XT,pl,QT,ev,ua,Cc,gn,Jn,hl,ma,tv,ul,nv,Oc,le,fa,ov,_a,sv,ml,av,rv,iv,ga,dv,Ta,lv,cv,pv,va,hv,Cr,uv,mv,fv,ka,_v,ba,gv,Tv,vv,Xn,kv,Je,ya,bv,Tn,yv,Or,wv,xv,fl,zv,$v,qv,Qn,Ev,_l,jv,Fv,wa,Ac,vn,eo,gl,xa,Mv,Tl,Pv,Lc,ce,za,Cv,vl,Ov,Av,$a,Lv,qa,Iv,Nv,Dv,Ea,Sv,Ar,Gv,Bv,Wv,ja,Uv,Fa,Rv,Hv,Vv,to,Kv,Xe,Ma,Yv,kn,Zv,Lr,Jv,Xv,kl,Qv,ek,tk,no,nk,bl,ok,sk,Pa,Ic,bn,oo,yl,Ca,ak,wl,rk,Nc,lt,Oa,ik,Qe,Aa,dk,yn,lk,xl,ck,pk,zl,hk,uk,mk,so,fk,$l,_k,gk,La,Tk,Mt,Ia,vk,ql,kk,bk,Na,yk,Pt,Da,wk,El,xk,zk,Sa,Dc,wn,ao,jl,Ga,$k,Fl,qk,Sc,ct,Ba,Ek,et,Wa,jk,xn,Fk,Ml,Mk,Pk,Pl,Ck,Ok,Ak,ro,Lk,Cl,Ik,Nk,Ua,Dk,Ct,Ra,Sk,Ol,Gk,Bk,Ha,Wk,Ot,Va,Uk,Al,Rk,Hk,Ka,Gc;return x=new ve({}),se=new ve({}),$o=new ve({}),qo=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16340/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16340/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Us=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16340/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16340/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16340/src/transformers/models/t5/modeling_t5.py#L1808",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16340/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16340/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16340/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16340/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16340/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16340/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[yw]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16340/src/transformers/models/t5/modeling_tf_t5.py#L1357",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16340/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16340/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16340/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16340/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[xw]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16340/src/transformers/models/t5/modeling_tf_t5.py#L1688",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16340/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16340/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16340/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16340/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16340/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16340/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16340/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
for summarization: `),U=o("em"),Oe=r("summarize: \u2026"),m=r("."),j=d(),te=o("li"),Se=o("p"),pt=r("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),D=d(),Ge=o("li"),ne=o("p"),ht=r("See the "),A=o("a"),Y=r("training"),ut=r(", "),Ae=o("a"),Z=r("inference"),mt=r(" and "),Le=o("a"),Ie=r("scripts"),ft=r(" sections below for all details regarding usage."),Vl=d(),Xa=o("p"),Dp=r("T5 comes in different sizes:"),Kl=d(),Be=o("ul"),di=o("li"),li=o("p"),To=o("a"),Sp=r("t5-small"),Gp=d(),ci=o("li"),pi=o("p"),vo=o("a"),Bp=r("t5-base"),Wp=d(),hi=o("li"),ui=o("p"),ko=o("a"),Up=r("t5-large"),Rp=d(),mi=o("li"),fi=o("p"),bo=o("a"),Hp=r("t5-3b"),Vp=d(),_i=o("li"),Qa=o("p"),yo=o("a"),Kp=r("t5-11b"),Yp=r("."),Yl=d(),er=o("p"),Zp=r("Based on the original T5 model, Google has released some follow-up works:"),Zl=d(),$t=o("ul"),gi=o("li"),zn=o("p"),Ti=o("strong"),Jp=r("T5v1.1"),Xp=r(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
language modeling head on top of the decoder.`),oc=d(),Mn=o("ul"),dt=o("li"),Ei=o("p"),Mh=r("Unsupervised denoising training"),Ph=d(),_e=o("p"),Ch=r("In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=o("em"),Oh=r("a.k.a"),Ah=r(` unique mask tokens) and
...
directory.`),Qh=d(),ge=o("li"),Ai=o("p"),eu=r("Supervised training"),tu=d(),Li=o("p"),nu=r(`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
...
of the `),Ki=o("code"),Pu=r("CrossEntropyLoss"),Cu=r(". In Flax, one can use the "),Yi=o("code"),Ou=r("decoder_attention_mask"),Au=r(` to ignore padded tokens from
...
pre-training mixture (see Appendix D of the `),Ao=o("a"),Yu=r("paper"),Zu=r(` for the task prefixes
...
special tokens using the tokenizer `),yd=o("code"),Of=r("prepare_for_model"),Af=r(" method."),Lf=d(),Dn=o("div"),f(cs.$$.fragment),If=d(),wd=o("p"),Nf=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
...
and behavior.`),$_=d(),Ue=o("div"),f($s.$$.fragment),q_=d(),cn=o("p"),E_=r("The "),$r=o("a"),j_=r("T5Model"),F_=r(" forward method, overrides the "),Od=o("code"),M_=r("__call__"),P_=r(" special method."),C_=d(),f(Wn.$$.fragment),O_=d(),Ad=o("p"),A_=r("Example:"),L_=d(),f(qs.$$.fragment),I_=d(),Re=o("div"),f(Es.$$.fragment),N_=d(),Ld=o("p"),D_=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),S_=d(),Id=o("p"),G_=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),B_=d(),Nd=o("p"),W_=r("Example:"),U_=d(),f(js.$$.fragment),R_=d(),vt=o("div"),f(Fs.$$.fragment),H_=d(),Dd=o("p"),V_=r("Moves the model to cpu from a model parallel state."),K_=d(),Sd=o("p"),Y_=r("Example:"),Z_=d(),f(Ms.$$.fragment),qc=d(),pn=o("h2"),Un=o("a"),Gd=o("span"),f(Ps.$$.fragment),J_=d(),Bd=o("span"),X_=r("T5ForConditionalGeneration"),Ec=d(),X=o("div"),f(Cs.$$.fragment),Q_=d(),Os=o("p"),eg=r("T5 Model with a "),Wd=o("code"),tg=r("language modeling"),ng=r(" head on top."),og=d(),As=o("p"),sg=r("The T5 model was proposed in "),Ls=o("a"),ag=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),AT=d(),la=o("p"),LT=r("This model inherits from "),Mr=o("a"),IT=r("TFPreTrainedModel"),NT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vv=d(),f(Xn.$$.fragment),kv=d(),Je=o("div"),f(ya.$$.fragment),bv=d(),Tn=o("p"),yv=r("The "),Or=o("a"),wv=r("TFT5ForConditionalGeneration"),xv=r(" forward method, overrides the "),fl=o("code"),zv=r("__call__"),$v=r(" special method."),qv=d(),f(Qn.$$.fragment),Ev=d(),_l=o("p"),jv=r("Examples:"),Fv=d(),f(wa.$$.fragment),Ac=d(),vn=o("h2"),eo=o("a"),gl=o("span"),f(xa.$$.fragment),Mv=d(),Tl=o("span"),Pv=r("TFT5EncoderModel"),Lc=d(),ce=o("div"),f(za.$$.fragment),Cv=d(),vl=o("p"),Ov=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Av=d(),$a=o("p"),Lv=r("The T5 model was proposed in "),qa=o("a"),Iv=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Nv=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Dv=d(),Ea=o("p"),Sv=r("This model inherits from "),Ar=o("a"),Gv=r("TFPreTrainedModel"),Bv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wv=d(),ja=o("p"),Uv=r("This model is also a "),Fa=o("a"),Rv=r("tf.keras.Model"),Hv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vv=d(),f(to.$$.fragment),Kv=d(),Xe=o("div"),f(Ma.$$.fragment),Yv=d(),kn=o("p"),Zv=r("The "),Lr=o("a"),Jv=r("TFT5EncoderModel"),Xv=r(" forward method, overrides the "),kl=o("code"),Qv=r("__call__"),ek=r(" special method."),tk=d(),f(no.$$.fragment),nk=d(),bl=o("p"),ok=r("Examples:"),sk=d(),f(Pa.$$.fragment),Ic=d(),bn=o("h2"),oo=o("a"),yl=o("span"),f(Ca.$$.fragment),ak=d(),wl=o("span"),rk=r("FlaxT5Model"),Nc=d(),lt=o("div"),f(Oa.$$.fragment),ik=d(),Qe=o("div"),f(Aa.$$.fragment),dk=d(),yn=o("p"),lk=r("The "),xl=o("code"),ck=r("FlaxT5PreTrainedModel"),pk=r("forward method, overrides the "),zl=o("code"),hk=r("__call__"),uk=r(" special method."),mk=d(),f(so.$$.fragment),fk=d(),$l=o("p"),_k=r("Example:"),gk=d(),f(La.$$.fragment),Tk=d(),Mt=o("div"),f(Ia.$$.fragment),vk=d(),ql=o("p"),kk=r("Example:"),bk=d(),f(Na.$$.fragment),yk=d(),Pt=o("div"),f(Da.$$.fragment),wk=d(),El=o("p"),xk=r("Example:"),zk=d(),f(Sa.$$.fragment),Dc=d(),wn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),$k=d(),Fl=o("span"),qk=r("FlaxT5ForConditionalGeneration"),Sc=d(),ct=o("div"),f(Ba.$$.fragment),Ek=d(),et=o("div"),f(Wa.$$.fragment),jk=d(),xn=o("p"),Fk=r("The "),Ml=o("code"),Mk=r("FlaxT5PreTrainedModel"),Pk=r("forward method, overrides the "),Pl=o("code"),Ck=r("__call__"),Ok=r(" special method."),Ak=d(),f(ro.$$.fragment),Lk=d(),Cl=o("p"),Ik=r("Example:"),Nk=d(),f(Ua.$$.fragment),Dk=d(),Ct=o("div"),f(Ra.$$.fragment),Sk=d(),Ol=o("p"),Gk=r("Example:"),Bk=d(),f(Ha.$$.fragment),Wk=d(),Ot=o("div"),f(Va.$$.fragment),Uk=d(),Al=o("p"),Rk=r("Example:"),Hk=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_w('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),$=l(n),b=s(n,"H1",{class:!0});var Ya=a(b);w=s(Ya,"A",{id:!0,class:!0,href:!0});var Ll=a(w);z=s(Ll,"SPAN",{});var Il=a(z);_(x.$$.fragment,Il),Il.forEach(t),Ll.forEach(t),y=l(Ya),q=s(Ya,"SPAN",{});var Nl=a(q);qe=i(Nl,"T5"),Nl.forEach(t),Ya.forEach(t),oe=l(n),E=s(n,"H2",{class:!0});var Za=a(E);ee=s(Za,"A",{id:!0,class:!0,href:!0});var Dl=a(ee);S=s(Dl,"SPAN",{});var Sl=a(S);_(se.$$.fragment,Sl),Sl.forEach(t),Dl.forEach(t),Ee=l(Za),G=s(Za,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Za.forEach(t),ke=l(n),B=s(n,"P",{});var Ja=a(B);I=i(Ja,"The T5 model was presented in "),ae=s(Ja,"A",{href:!0,rel:!0});var Bl=a(ae);pe=i(Bl,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Bl.forEach(t),F=i(Ja,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),U=s(Nr,"EM",{});var ob=a(U);Oe=i(ob,"summarize: \u2026"),ob.forEach(t),m=i(Nr,"."),Nr.forEach(t),tb.forEach(t),j=l(Ir),te=s(Ir,"LI",{});var sb=a(te);Se=s(sb,"P",{});var ab=a(Se);pt=i(ab,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),ab.forEach(t),sb.forEach(t),D=l(Ir),Ge=s(Ir,"LI",{});var rb=a(Ge);ne=s(rb,"P",{});var io=a(ne);ht=i(io,"See the "),A=s(io,"A",{href:!0});var ib=a(A);Y=i(ib,"training"),ib.forEach(t),ut=i(io,", "),Ae=s(io,"A",{href:!0});var db=a(Ae);Z=i(db,"inference"),db.forEach(t),mt=i(io," and "),Le=s(io,"A",{href:!0});var lb=a(Le);Ie=i(lb,"scripts"),lb.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rb.forEach(t),Ir.forEach(t),Vl=l(n),Xa=s(n,"P",{});var cb=a(Xa);Dp=i(cb,"T5 comes in different sizes:"),cb.forEach(t),Kl=l(n),Be=s(n,"UL",{});var At=a(Be);di=s(At,"LI",{});var pb=a(di);li=s(pb,"P",{});var hb=a(li);To=s(hb,"A",{href:!0,rel:!0});var ub=a(To);Sp=i(ub,"t5-small"),ub.forEach(t),hb.forEach(t),pb.forEach(t),Gp=l(At),ci=s(At,"LI",{});var mb=a(ci);pi=s(mb,"P",{});var fb=a(pi);vo=s(fb,"A",{href:!0,rel:!0});var _b=a(vo);Bp=i(_b,"t5-base"),_b.forEach(t),fb.forEach(t),mb.forEach(t),Wp=l(At),hi=s(At,"LI",{});var gb=a(hi);ui=s(gb,"P",{});var Tb=a(ui);ko=s(Tb,"A",{href:!0,rel:!0});var vb=a(ko);Up=i(vb,"t5-large"),vb.forEach(t),Tb.forEach(t),gb.forEach(t),Rp=l(At),mi=s(At,"LI",{});var kb=a(mi);fi=s(kb,"P",{});var bb=a(fi);bo=s(bb,"A",{href:!0,rel:!0});var yb=a(bo);Hp=i(yb,"t5-3b"),yb.forEach(t),bb.forEach(t),kb.forEach(t),Vp=l(At),_i=s(At,"LI",{});var wb=a(_i);Qa=s(wb,"P",{});var Vk=a(Qa);yo=s(Vk,"A",{href:!0,rel:!0});var xb=a(yo);Kp=i(xb,"t5-11b"),xb.forEach(t),Yp=i(Vk,"."),Vk.forEach(t),wb.forEach(t),At.forEach(t),Yl=l(n),er=s(n,"P",{});var zb=a(er);Zp=i(zb,"Based on the original T5 model, Google has released some follow-up works:"),zb.forEach(t),Zl=l(n),$t=s(n,"UL",{});var Dr=a($t);gi=s(Dr,"LI",{});var $b=a(gi);zn=s($b,"P",{});var Ul=a(zn);Ti=s(Ul,"STRONG",{});var qb=a(Ti);Jp=i(qb,"T5v1.1"),qb.forEach(t),Xp=i(Ul,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
language modeling head on top of the decoder.`),Uc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var Lt=a(dt);Ei=s(Lt,"P",{});var Rb=a(Ei);Mh=i(Rb,"Unsupervised denoising training"),Rb.forEach(t),Ph=l(Lt),_e=s(Lt,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var Hb=a(ji);Oh=i(Hb,"a.k.a"),Hb.forEach(t),Ah=i(tt,` unique mask tokens) and
...
`),rr=s(tt,"A",{href:!0});var Jb=a(rr);Uh=i(Jb,"T5Tokenizer"),Jb.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(Lt),Oi=s(Lt,"P",{});var Xb=a(Oi);Vh=i(Xb,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
directory.`),Hc.forEach(t),Lt.forEach(t),Qh=l(Rc),ge=s(Rc,"LI",{});var nt=a(ge);Ai=s(nt,"P",{});var e1=a(Ai);eu=i(e1,"Supervised training"),e1.forEach(t),tu=l(nt),Li=s(nt,"P",{});var t1=a(Li);nu=i(t1,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),t1.forEach(t),ou=l(nt),_(Fo.$$.fragment,nt),su=l(nt),re=s(nt,"P",{});var we=a(re);au=i(we,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ii=s(we,"CODE",{});var n1=a(Ii);ru=i(n1,"input_ids"),n1.forEach(t),iu=i(we,` (which are the
`),Ni=s(we,"CODE",{});var o1=a(Ni);du=i(o1,"input_ids"),o1.forEach(t),lu=i(we," of the encoded input sequence) and "),Di=s(we,"CODE",{});var s1=a(Di);cu=i(s1,"labels"),s1.forEach(t),pu=i(we," (which are the "),Si=s(we,"CODE",{});var a1=a(Si);hu=i(a1,"input_ids"),a1.forEach(t),uu=i(we,` of the encoded
target sequence). The model will automatically create the `),Gi=s(we,"CODE",{});var r1=a(Gi);mu=i(r1,"decoder_input_ids"),r1.forEach(t),fu=i(we," based on the "),Bi=s(we,"CODE",{});var i1=a(Bi);_u=i(i1,"labels"),i1.forEach(t),gu=i(we,`, by
shifting them one position to the right and prepending the `),Wi=s(we,"CODE",{});var d1=a(Wi);Tu=i(d1,"config.decoder_start_token_id"),d1.forEach(t),vu=i(we,`, which for T5 is
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Ui=s(Gr,"CODE",{});var l1=a(Ui);yu=i(l1,"max_source_length"),l1.forEach(t),wu=i(Gr," and "),Ri=s(Gr,"CODE",{});var c1=a(Ri);xu=i(c1,"max_target_length"),c1.forEach(t),zu=i(Gr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Gr.forEach(t),$u=l(nt),Te=s(nt,"P",{});var ot=a(Te);qu=i(ot,"In addition, we must make sure that padding token id\u2019s of the "),Hi=s(ot,"CODE",{});var p1=a(Hi);Eu=i(p1,"labels"),p1.forEach(t),ju=i(ot,` are not taken into account by the loss
function. In PyTorch and Tensorflow, this can be done by replacing them with -100, which is the `),Vi=s(ot,"CODE",{});var h1=a(Vi);Fu=i(h1,"ignore_index"),h1.forEach(t),Mu=i(ot,`
of the `),Ki=s(ot,"CODE",{});var u1=a(Ki);Pu=i(u1,"CrossEntropyLoss"),u1.forEach(t),Cu=i(ot,". In Flax, one can use the "),Yi=s(ot,"CODE",{});var m1=a(Yi);Ou=i(m1,"decoder_attention_mask"),m1.forEach(t),Au=i(ot,` to ignore padded tokens from
the loss (see the `),Mo=s(ot,"A",{href:!0,rel:!0});var f1=a(Mo);Lu=i(f1,"Flax summarization script"),f1.forEach(t),Iu=i(ot,` for details). We also pass
`),Zi=s(ot,"CODE",{});var _1=a(Zi);Nu=i(_1,"attention_mask"),_1.forEach(t),Du=i(ot,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),ot.forEach(t),Su=l(nt),_(Po.$$.fragment,nt),nt.forEach(t),Rc.forEach(t),sc=l(n),ir=s(n,"P",{});var g1=a(ir);Gu=i(g1,"Additional training tips:"),g1.forEach(t),ac=l(n),Et=s(n,"UL",{});var Br=a(Et);Ji=s(Br,"LI",{});var T1=a(Ji);Co=s(T1,"P",{});var Vc=a(Co);Bu=i(Vc,"T5 models need a slightly higher learning rate than the default one set in the "),Xi=s(Vc,"CODE",{});var v1=a(Xi);Wu=i(v1,"Trainer"),v1.forEach(t),Uu=i(Vc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Vc.forEach(t),T1.forEach(t),Ru=l(Br),Qi=s(Br,"LI",{});var k1=a(Qi);Xt=s(k1,"P",{});var Wr=a(Xt);Hu=i(Wr,"According to "),Oo=s(Wr,"A",{href:!0,rel:!0});var b1=a(Oo);Vu=i(b1,"this forum post"),b1.forEach(t),Ku=i(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Ao=s(Wr,"A",{href:!0,rel:!0});var y1=a(Ao);Yu=i(y1,"paper"),y1.forEach(t),Zu=i(Wr,` for the task prefixes
used).`),Wr.forEach(t),k1.forEach(t),Ju=l(Br),ed=s(Br,"LI",{});var w1=a(ed);Lo=s(w1,"P",{});var Kc=a(Lo);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
`),td=s(Kc,"EM",{});var x1=a(td);Qu=i(x1,"pad_to_multiple_of"),x1.forEach(t),em=i(Kc,` to have a small number of predefined bucket sizes to fit all examples in. Dynamically padding
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),Kc.forEach(t),w1.forEach(t),Br.forEach(t),rc=l(n),dr=s(n,"A",{id:!0}),a(dr).forEach(t),ic=l(n),Qt=s(n,"H2",{class:!0});var Yc=a(Qt);Pn=s(Yc,"A",{id:!0,class:!0,href:!0});var z1=a(Pn);nd=s(z1,"SPAN",{});var $1=a(nd);_(Io.$$.fragment,$1),$1.forEach(t),z1.forEach(t),tm=l(Yc),od=s(Yc,"SPAN",{});var q1=a(od);nm=i(q1,"Inference"),q1.forEach(t),Yc.forEach(t),dc=l(n),gt=s(n,"P",{});var co=a(gt);om=i(co,"At inference time, it is recommended to use "),lr=s(co,"A",{href:!0});var E1=a(lr);sm=i(E1,"generate()"),E1.forEach(t),am=i(co,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),No=s(co,"A",{href:!0,rel:!0});var j1=a(No);rm=i(j1,"this blog post"),j1.forEach(t),im=i(co,` to know all the details about generating text with Transformers.
There\u2019s also `),Do=s(co,"A",{href:!0,rel:!0});var F1=a(Do);dm=i(F1,"this blog post"),F1.forEach(t),lm=i(co,` which explains how
generation works in general in encoder-decoder models.`),co.forEach(t),lc=l(n),_(So.$$.fragment,n),cc=l(n),We=s(n,"P",{});var It=a(We);cm=i(It,"Note that T5 uses the "),sd=s(It,"CODE",{});var M1=a(sd);pm=i(M1,"pad_token_id"),M1.forEach(t),hm=i(It," as the "),ad=s(It,"CODE",{});var P1=a(ad);um=i(P1,"decoder_start_token_id"),P1.forEach(t),mm=i(It,`, so when doing generation without using
`),cr=s(It,"A",{href:!0});var C1=a(cr);fm=i(C1,"generate()"),C1.forEach(t),_m=i(It,", make sure you start it with the "),rd=s(It,"CODE",{});var O1=a(rd);gm=i(O1,"pad_token_id"),O1.forEach(t),Tm=i(It,"."),It.forEach(t),pc=l(n),pr=s(n,"P",{});var A1=a(pr);vm=i(A1,"The example above only shows a single example. You can also do batched inference, like so:"),A1.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Zc=a(en);Cn=s(Zc,"A",{id:!0,class:!0,href:!0});var L1=a(Cn);id=s(L1,"SPAN",{});var I1=a(id);_(Bo.$$.fragment,I1),I1.forEach(t),L1.forEach(t),km=l(Zc),dd=s(Zc,"SPAN",{});var N1=a(dd);bm=i(N1,"Performance"),N1.forEach(t),Zc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);ym=i(po,"If you\u2019d like a faster training and inference performance, install "),Wo=s(po,"A",{href:!0,rel:!0});var D1=a(Wo);wm=i(D1,"apex"),D1.forEach(t),xm=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var S1=a(ld);zm=i(S1,"apex.normalization.FusedRMSNorm"),S1.forEach(t),$m=i(po," instead of "),cd=s(po,"CODE",{});var G1=a(cd);qm=i(G1,"T5LayerNorm"),G1.forEach(t),Em=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Jc=a(tn);On=s(Jc,"A",{id:!0,class:!0,href:!0});var B1=a(On);pd=s(B1,"SPAN",{});var W1=a(pd);_(Uo.$$.fragment,W1),W1.forEach(t),B1.forEach(t),jm=l(Jc),hd=s(Jc,"SPAN",{});var U1=a(hd);Fm=i(U1,"Example scripts"),U1.forEach(t),Jc.forEach(t),gc=l(n),ur=s(n,"P",{});var R1=a(ur);Mm=i(R1,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),R1.forEach(t),Tc=l(n),An=s(n,"UL",{});var Xc=a(An);ud=s(Xc,"LI",{});var H1=a(ud);nn=s(H1,"P",{});var Ur=a(nn);Pm=i(Ur,"pre-training: the "),Ro=s(Ur,"A",{href:!0,rel:!0});var V1=a(Ro);Cm=i(V1,"run_t5_mlm_flax.py"),V1.forEach(t),Om=i(Ur,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Ur,"A",{href:!0,rel:!0});var K1=a(Ho);Am=i(K1,"t5_tokenizer_model.py"),K1.forEach(t),Lm=i(Ur,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Ur.forEach(t),H1.forEach(t),Im=l(Xc),md=s(Xc,"LI",{});var Y1=a(md);Ne=s(Y1,"P",{});var yt=a(Ne);Nm=i(yt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(yt,"A",{href:!0,rel:!0});var Z1=a(Vo);Dm=i(Z1,"PyTorch"),Z1.forEach(t),Sm=i(yt,", "),Ko=s(yt,"A",{href:!0,rel:!0});var J1=a(Ko);Gm=i(J1,"Tensorflow"),J1.forEach(t),Bm=i(yt,", and "),Yo=s(yt,"A",{href:!0,rel:!0});var X1=a(Yo);Wm=i(X1,"Flax"),X1.forEach(t),Um=i(yt,`) and translation scripts
(`),Zo=s(yt,"A",{href:!0,rel:!0});var Q1=a(Zo);Rm=i(Q1,"PyTorch"),Q1.forEach(t),Hm=i(yt," and "),Jo=s(yt,"A",{href:!0,rel:!0});var e5=a(Jo);Vm=i(e5,"Tensorflow"),e5.forEach(t),Km=i(yt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),yt.forEach(t),Y1.forEach(t),Xc.forEach(t),vc=l(n),on=s(n,"H2",{class:!0});var Qc=a(on);Ln=s(Qc,"A",{id:!0,class:!0,href:!0});var t5=a(Ln);fd=s(t5,"SPAN",{});var n5=a(fd);_(Xo.$$.fragment,n5),n5.forEach(t),t5.forEach(t),Ym=l(Qc),_d=s(Qc,"SPAN",{});var o5=a(_d);Zm=i(o5,"T5Config"),o5.forEach(t),Qc.forEach(t),kc=l(n),wt=s(n,"DIV",{class:!0});var Rr=a(wt);_(Qo.$$.fragment,Rr),Jm=l(Rr),xt=s(Rr,"P",{});var ho=a(xt);Xm=i(ho,"This is the configuration class to store the configuration of a "),mr=s(ho,"A",{href:!0});var s5=a(mr);Qm=i(s5,"T5Model"),s5.forEach(t),ef=i(ho," or a "),fr=s(ho,"A",{href:!0});var a5=a(fr);tf=i(a5,"TFT5Model"),a5.forEach(t),nf=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
documentation from `),gr=s(Hr,"A",{href:!0});var d5=a(gr);cf=i(d5,"PretrainedConfig"),d5.forEach(t),pf=i(Hr," for more information."),Hr.forEach(t),Rr.forEach(t),bc=l(n),an=s(n,"H2",{class:!0});var ep=a(an);In=s(ep,"A",{id:!0,class:!0,href:!0});var l5=a(In);gd=s(l5,"SPAN",{});var c5=a(gd);_(ts.$$.fragment,c5),c5.forEach(t),l5.forEach(t),hf=l(ep),Td=s(ep,"SPAN",{});var p5=a(Td);uf=i(p5,"T5Tokenizer"),p5.forEach(t),ep.forEach(t),yc=l(n),ie=s(n,"DIV",{class:!0});var st=a(ie);_(ns.$$.fragment,st),mf=l(st),os=s(st,"P",{});var tp=a(os);ff=i(tp,"Construct a T5 tokenizer. Based on "),ss=s(tp,"A",{href:!0,rel:!0});var h5=a(ss);_f=i(h5,"SentencePiece"),h5.forEach(t),gf=i(tp,"."),tp.forEach(t),Tf=l(st),as=s(st,"P",{});var np=a(as);vf=i(np,"This tokenizer inherits from "),Tr=s(np,"A",{href:!0});var u5=a(Tr);kf=i(u5,"PreTrainedTokenizer"),u5.forEach(t),bf=i(np,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),np.forEach(t),yf=l(st),jt=s(st,"DIV",{class:!0});var Vr=a(jt);_(rs.$$.fragment,Vr),wf=l(Vr),vd=s(Vr,"P",{});var m5=a(vd);xf=i(m5,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),m5.forEach(t),zf=l(Vr),is=s(Vr,"UL",{});var op=a(is);vr=s(op,"LI",{});var Kk=a(vr);$f=i(Kk,"single sequence: "),kd=s(Kk,"CODE",{});var f5=a(kd);qf=i(f5,"X </s>"),f5.forEach(t),Kk.forEach(t),Ef=l(op),kr=s(op,"LI",{});var Yk=a(kr);jf=i(Yk,"pair of sequences: "),bd=s(Yk,"CODE",{});var _5=a(bd);Ff=i(_5,"A </s> B </s>"),_5.forEach(t),Yk.forEach(t),op.forEach(t),Vr.forEach(t),Mf=l(st),Nn=s(st,"DIV",{class:!0});var sp=a(Nn);_(ds.$$.fragment,sp),Pf=l(sp),ls=s(sp,"P",{});var ap=a(ls);Cf=i(ap,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),yd=s(ap,"CODE",{});var g5=a(yd);Of=i(g5,"prepare_for_model"),g5.forEach(t),Af=i(ap," method."),ap.forEach(t),sp.forEach(t),Lf=l(st),Dn=s(st,"DIV",{class:!0});var rp=a(Dn);_(cs.$$.fragment,rp),If=l(rp),wd=s(rp,"P",{});var T5=a(wd);Nf=i(T5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),T5.forEach(t),rp.forEach(t),Df=l(st),br=s(st,"DIV",{class:!0});var v5=a(br);_(ps.$$.fragment,v5),v5.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);Sn=s(ip,"A",{id:!0,class:!0,href:!0});var k5=a(Sn);xd=s(k5,"SPAN",{});var b5=a(xd);_(hs.$$.fragment,b5),b5.forEach(t),k5.forEach(t),Sf=l(ip),zd=s(ip,"SPAN",{});var y5=a(zd);Gf=i(y5,"T5TokenizerFast"),y5.forEach(t),ip.forEach(t),xc=l(n),De=s(n,"DIV",{class:!0});var Nt=a(De);_(us.$$.fragment,Nt),Bf=l(Nt),dn=s(Nt,"P",{});var Kr=a(dn);Wf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),$d=s(Kr,"EM",{});var w5=a($d);Uf=i(w5,"tokenizers"),w5.forEach(t),Rf=i(Kr,` library). Based on
`),ms=s(Kr,"A",{href:!0,rel:!0});var x5=a(ms);Hf=i(x5,"Unigram"),x5.forEach(t),Vf=i(Kr,"."),Kr.forEach(t),Kf=l(Nt),fs=s(Nt,"P",{});var dp=a(fs);Yf=i(dp,"This tokenizer inherits from "),yr=s(dp,"A",{href:!0});var z5=a(yr);Zf=i(z5,"PreTrainedTokenizerFast"),z5.forEach(t),Jf=i(dp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),dp.forEach(t),Xf=l(Nt),Ft=s(Nt,"DIV",{class:!0});var Yr=a(Ft);_(_s.$$.fragment,Yr),Qf=l(Yr),qd=s(Yr,"P",{});var $5=a(qd);e_=i($5,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),$5.forEach(t),t_=l(Yr),gs=s(Yr,"UL",{});var lp=a(gs);wr=s(lp,"LI",{});var Zk=a(wr);n_=i(Zk,"single sequence: "),Ed=s(Zk,"CODE",{});var q5=a(Ed);o_=i(q5,"X </s>"),q5.forEach(t),Zk.forEach(t),s_=l(lp),xr=s(lp,"LI",{});var Jk=a(xr);a_=i(Jk,"pair of sequences: "),jd=s(Jk,"CODE",{});var E5=a(jd);r_=i(E5,"A </s> B </s>"),E5.forEach(t),Jk.forEach(t),lp.forEach(t),Yr.forEach(t),i_=l(Nt),Gn=s(Nt,"DIV",{class:!0});var cp=a(Gn);_(Ts.$$.fragment,cp),d_=l(cp),Fd=s(cp,"P",{});var j5=a(Fd);l_=i(j5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),j5.forEach(t),cp.forEach(t),Nt.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Bn=s(pp,"A",{id:!0,class:!0,href:!0});var F5=a(Bn);Md=s(F5,"SPAN",{});var M5=a(Md);_(vs.$$.fragment,M5),M5.forEach(t),F5.forEach(t),c_=l(pp),Pd=s(pp,"SPAN",{});var P5=a(Pd);p_=i(P5,"T5Model"),P5.forEach(t),pp.forEach(t),$c=l(n),J=s(n,"DIV",{class:!0});var xe=a(J);_(ks.$$.fragment,xe),h_=l(xe),Cd=s(xe,"P",{});var C5=a(Cd);u_=i(C5,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),C5.forEach(t),m_=l(xe),bs=s(xe,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var O5=a(ys);__=i(O5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),O5.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l(xe),ws=s(xe,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var A5=a(zr);k_=i(A5,"PreTrainedModel"),A5.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),$_=l(xe),Ue=s(xe,"DIV",{class:!0});var Dt=a(Ue);_($s.$$.fragment,Dt),q_=l(Dt),cn=s(Dt,"P",{});var Zr=a(cn);E_=i(Zr,"The "),$r=s(Zr,"A",{href:!0});var I5=a($r);j_=i(I5,"T5Model"),I5.forEach(t),F_=i(Zr," forward method, overrides the "),Od=s(Zr,"CODE",{});var N5=a(Od);M_=i(N5,"__call__"),N5.forEach(t),P_=i(Zr," special method."),Zr.forEach(t),C_=l(Dt),_(Wn.$$.fragment,Dt),O_=l(Dt),Ad=s(Dt,"P",{});var D5=a(Ad);A_=i(D5,"Example:"),D5.forEach(t),L_=l(Dt),_(qs.$$.fragment,Dt),Dt.forEach(t),I_=l(xe),Re=s(xe,"DIV",{class:!0});var St=a(Re);_(Es.$$.fragment,St),N_=l(St),Ld=s(St,"P",{});var S5=a(Ld);D_=i(S5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),S5.forEach(t),S_=l(St),Id=s(St,"P",{});var G5=a(Id);G_=i(G5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),G5.forEach(t),B_=l(St),Nd=s(St,"P",{});var B5=a(Nd);W_=i(B5,"Example:"),B5.forEach(t),U_=l(St),_(js.$$.fragment,St),St.forEach(t),R_=l(xe),vt=s(xe,"DIV",{class:!0});var uo=a(vt);_(Fs.$$.fragment,uo),H_=l(uo),Dd=s(uo,"P",{});var W5=a(Dd);V_=i(W5,"Moves the model to cpu from a model parallel state."),W5.forEach(t),K_=l(uo),Sd=s(uo,"P",{});var U5=a(Sd);Y_=i(U5,"Example:"),U5.forEach(t),Z_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),xe.forEach(t),qc=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Un=s(fp,"A",{id:!0,class:!0,href:!0});var R5=a(Un);Gd=s(R5,"SPAN",{});var H5=a(Gd);_(Ps.$$.fragment,H5),H5.forEach(t),R5.forEach(t),J_=l(fp),Bd=s(fp,"SPAN",{});var V5=a(Bd);X_=i(V5,"T5ForConditionalGeneration"),V5.forEach(t),fp.forEach(t),Ec=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),Os=s(ze,"P",{});var _p=a(Os);eg=i(_p,"T5 Model with a "),Wd=s(_p,"CODE",{});var K5=a(Wd);tg=i(K5,"language modeling"),K5.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),As=s(ze,"P",{});var gp=a(As);sg=i(gp,"The T5 model was proposed in "),Ls=s(gp,"A",{href:!0,rel:!0});var Y5=a(Ls);ag=i(Y5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Y5.forEach(t),rg=i(gp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),gp.forEach(t),ig=l(ze),Is=s(ze,"P",{});var Tp=a(Is);dg=i(Tp,"This model inherits from "),qr=s(Tp,"A",{href:!0});var Z5=a(qr);lg=i(Z5,"PreTrainedModel"),Z5.forEach(t),cg=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l(ze),Ns=s(ze,"P",{});var vp=a(Ns);hg=i(vp,"This model is also a PyTorch "),Ds=s(vp,"A",{href:!0,rel:!0});var J5=a(Ds);ug=i(J5,"torch.nn.Module"),J5.forEach(t),mg=i(vp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vp.forEach(t),fg=l(ze),He=s(ze,"DIV",{class:!0});var Gt=a(He);_(Ss.$$.fragment,Gt),_g=l(Gt),hn=s(Gt,"P",{});var Jr=a(hn);gg=i(Jr,"The "),Er=s(Jr,"A",{href:!0});var X5=a(Er);Tg=i(X5,"T5ForConditionalGeneration"),X5.forEach(t),vg=i(Jr," forward method, overrides the "),Ud=s(Jr,"CODE",{});var Q5=a(Ud);kg=i(Q5,"__call__"),Q5.forEach(t),bg=i(Jr," special method."),Jr.forEach(t),yg=l(Gt),_(Rn.$$.fragment,Gt),wg=l(Gt),Rd=s(Gt,"P",{});var ey=a(Rd);xg=i(ey,"Examples:"),ey.forEach(t),zg=l(Gt),_(Gs.$$.fragment,Gt),Gt.forEach(t),$g=l(ze),Ve=s(ze,"DIV",{class:!0});var Bt=a(Ve);_(Bs.$$.fragment,Bt),qg=l(Bt),Hd=s(Bt,"P",{});var ty=a(Hd);Eg=i(ty,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),ty.forEach(t),jg=l(Bt),Vd=s(Bt,"P",{});var ny=a(Vd);Fg=i(ny,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),ny.forEach(t),Mg=l(Bt),Kd=s(Bt,"P",{});var oy=a(Kd);Pg=i(oy,"Example:"),oy.forEach(t),Cg=l(Bt),_(Ws.$$.fragment,Bt),Bt.forEach(t),Og=l(ze),kt=s(ze,"DIV",{class:!0});var mo=a(kt);_(Us.$$.fragment,mo),Ag=l(mo),Yd=s(mo,"P",{});var sy=a(Yd);Lg=i(sy,"Moves the model to cpu from a model parallel state."),sy.forEach(t),Ig=l(mo),Zd=s(mo,"P",{});var ay=a(Zd);Ng=i(ay,"Example:"),ay.forEach(t),Dg=l(mo),_(Rs.$$.fragment,mo),mo.forEach(t),ze.forEach(t),jc=l(n),un=s(n,"H2",{class:!0});var kp=a(un);Hn=s(kp,"A",{id:!0,class:!0,href:!0});var ry=a(Hn);Jd=s(ry,"SPAN",{});var iy=a(Jd);_(Hs.$$.fragment,iy),iy.forEach(t),ry.forEach(t),Sg=l(kp),Xd=s(kp,"SPAN",{});var dy=a(Xd);Gg=i(dy,"T5EncoderModel"),dy.forEach(t),kp.forEach(t),Fc=l(n),Q=s(n,"DIV",{class:!0});var $e=a(Q);_(Vs.$$.fragment,$e),Bg=l($e),Qd=s($e,"P",{});var ly=a(Qd);Wg=i(ly,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),ly.forEach(t),Ug=l($e),Ks=s($e,"P",{});var bp=a(Ks);Rg=i(bp,"The T5 model was proposed in "),Ys=s(bp,"A",{href:!0,rel:!0});var cy=a(Ys);Hg=i(cy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Transformer`),zy.forEach(t),OT=i(zp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),zp.forEach(t),AT=l(at),la=s(at,"P",{});var $p=a(la);LT=i($p,"This model inherits from "),Mr=s($p,"A",{href:!0});var $y=a(Mr);IT=i($y,"TFPreTrainedModel"),$y.forEach(t),NT=i($p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$p.forEach(t),DT=l(at),ca=s(at,"P",{});var qp=a(ca);ST=i(qp,"This model is also a "),pa=s(qp,"A",{href:!0,rel:!0});var qy=a(pa);GT=i(qy,"tf.keras.Model"),qy.forEach(t),BT=i(qp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qp.forEach(t),WT=l(at),_(Yn.$$.fragment,at),UT=l(at),Ze=s(at,"DIV",{class:!0});var Rt=a(Ze);_(ha.$$.fragment,Rt),RT=l(Rt),_n=s(Rt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Pr=s(Qr,"A",{href:!0});var Ey=a(Pr);VT=i(Ey,"TFT5Model"),Ey.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var jy=a(cl);YT=i(jy,"__call__"),jy.forEach(t),ZT=i(Qr," special method."),Qr.forEach(t),JT=l(Rt),_(Zn.$$.fragment,Rt),XT=l(Rt),pl=s(Rt,"P",{});var Fy=a(pl);QT=i(Fy,"Examples:"),Fy.forEach(t),ev=l(Rt),_(ua.$$.fragment,Rt),Rt.forEach(t),at.forEach(t),Cc=l(n),gn=s(n,"H2",{class:!0});var Ep=a(gn);Jn=s(Ep,"A",{id:!0,class:!0,href:!0});var My=a(Jn);hl=s(My,"SPAN",{});var Py=a(hl);_(ma.$$.fragment,Py),Py.forEach(t),My.forEach(t),tv=l(Ep),ul=s(Ep,"SPAN",{});var Cy=a(ul);nv=i(Cy,"TFT5ForConditionalGeneration"),Cy.forEach(t),Ep.forEach(t),Oc=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),ov=l(rt),_a=s(rt,"P",{});var jp=a(_a);sv=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var Oy=a(ml);av=i(Oy,"language modeling"),Oy.forEach(t),rv=i(jp," head on top."),jp.forEach(t),iv=l(rt),ga=s(rt,"P",{});var Fp=a(ga);dv=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var Ay=a(Ta);lv=i(Ay,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ay.forEach(t),cv=i(Fp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
