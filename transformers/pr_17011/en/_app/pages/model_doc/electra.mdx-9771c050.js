...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17011/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17011/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17011/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17011/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17011/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17011/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17011/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17011/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17011/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17011/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17011/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17011/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17011/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17011/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17011/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17011/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17011/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17011/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17011/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17011/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17011/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17011/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Q_=c(),wt=n("div"),b(Ka.$$.fragment),B_=c(),$o=n("p"),V_=r("The "),dd=n("a"),K_=r("ElectraForPreTraining"),J_=r(" forward method, overrides the "),qc=n("code"),G_=r("__call__"),X_=r(" special method."),Y_=c(),b(Mn.$$.fragment),Z_=c(),b(zn.$$.fragment),nu=c(),Fo=n("h2"),Cn=n("a"),Pc=n("span"),b(Ja.$$.fragment),e1=c(),Ac=n("span"),t1=r("ElectraForCausalLM"),su=c(),et=n("div"),b(Ga.$$.fragment),o1=c(),Xa=n("p"),n1=r("ELECTRA Model with a "),Oc=n("code"),s1=r("language modeling"),a1=r(" head on top for CLM fine-tuning."),r1=c(),Ya=n("p"),i1=r("This model inherits from "),cd=n("a"),l1=r("PreTrainedModel"),d1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),c1=c(),Za=n("p"),p1=r("This model is also a PyTorch "),er=n("a"),h1=r("torch.nn.Module"),m1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),u1=c(),$t=n("div"),b(tr.$$.fragment),f1=c(),xo=n("p"),g1=r("The "),pd=n("a"),_1=r("ElectraForCausalLM"),k1=r(" forward method, overrides the "),Lc=n("code"),v1=r("__call__"),T1=r(" special method."),b1=c(),b(jn.$$.fragment),y1=c(),b(qn.$$.fragment),au=c(),Mo=n("h2"),Pn=n("a"),Nc=n("span"),b(or.$$.fragment),E1=c(),Ic=n("span"),w1=r("ElectraForMaskedLM"),ru=c(),Qe=n("div"),b(nr.$$.fragment),$1=c(),Sc=n("p"),F1=r("Electra model with a language modeling head on top."),x1=c(),Dc=n("p"),M1=r(`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),z1=c(),sr=n("p"),C1=r("This model inherits from "),hd=n("a"),j1=r("PreTrainedModel"),q1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),P1=c(),ar=n("p"),A1=r("This model is also a PyTorch "),rr=n("a"),O1=r("torch.nn.Module"),L1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),N1=c(),st=n("div"),b(ir.$$.fragment),I1=c(),zo=n("p"),S1=r("The "),md=n("a"),D1=r("ElectraForMaskedLM"),W1=r(" forward method, overrides the "),Wc=n("code"),U1=r("__call__"),R1=r(" special method."),H1=c(),b(An.$$.fragment),Q1=c(),b(On.$$.fragment),B1=c(),b(Ln.$$.fragment),iu=c(),Co=n("h2"),Nn=n("a"),Uc=n("span"),b(lr.$$.fragment),V1=c(),Rc=n("span"),K1=r("ElectraForSequenceClassification"),lu=c(),tt=n("div"),b(dr.$$.fragment),J1=c(),Hc=n("p"),G1=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X1=c(),cr=n("p"),Y1=r("This model inherits from "),ud=n("a"),Z1=r("PreTrainedModel"),ek=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tk=c(),pr=n("p"),ok=r("This model is also a PyTorch "),hr=n("a"),nk=r("torch.nn.Module"),sk=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ak=c(),Re=n("div"),b(mr.$$.fragment),rk=c(),jo=n("p"),ik=r("The "),fd=n("a"),lk=r("ElectraForSequenceClassification"),dk=r(" forward method, overrides the "),Qc=n("code"),ck=r("__call__"),pk=r(" special method."),hk=c(),b(In.$$.fragment),mk=c(),b(Sn.$$.fragment),uk=c(),b(Dn.$$.fragment),fk=c(),b(Wn.$$.fragment),gk=c(),b(Un.$$.fragment),du=c(),qo=n("h2"),Rn=n("a"),Bc=n("span"),b(ur.$$.fragment),_k=c(),Vc=n("span"),kk=r("ElectraForMultipleChoice"),cu=c(),ot=n("div"),b(fr.$$.fragment),vk=c(),Kc=n("p"),Tk=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),bk=c(),gr=n("p"),yk=r("This model inherits from "),gd=n("a"),Ek=r("PreTrainedModel"),wk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$k=c(),_r=n("p"),Fk=r("This model is also a PyTorch "),kr=n("a"),xk=r("torch.nn.Module"),Mk=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zk=c(),Ft=n("div"),b(vr.$$.fragment),Ck=c(),Po=n("p"),jk=r("The "),_d=n("a"),qk=r("ElectraForMultipleChoice"),Pk=r(" forward method, overrides the "),Jc=n("code"),Ak=r("__call__"),Ok=r(" special method."),Lk=c(),b(Hn.$$.fragment),Nk=c(),b(Qn.$$.fragment),pu=c(),Ao=n("h2"),Bn=n("a"),Gc=n("span"),b(Tr.$$.fragment),Ik=c(),Xc=n("span"),Sk=r("ElectraForTokenClassification"),hu=c(),Be=n("div"),b(br.$$.fragment),Dk=c(),Yc=n("p"),Wk=r("Electra model with a token classification head on top."),Uk=c(),Zc=n("p"),Rk=r("Both the discriminator and generator may be loaded into this model."),Hk=c(),yr=n("p"),Qk=r("This model inherits from "),kd=n("a"),Bk=r("PreTrainedModel"),Vk=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kk=c(),Er=n("p"),Jk=r("This model is also a PyTorch "),wr=n("a"),Gk=r("torch.nn.Module"),Xk=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yk=c(),at=n("div"),b($r.$$.fragment),Zk=c(),Oo=n("p"),ev=r("The "),vd=n("a"),tv=r("ElectraForTokenClassification"),ov=r(" forward method, overrides the "),ep=n("code"),nv=r("__call__"),sv=r(" special method."),av=c(),b(Vn.$$.fragment),rv=c(),b(Kn.$$.fragment),iv=c(),b(Jn.$$.fragment),mu=c(),Lo=n("h2"),Gn=n("a"),tp=n("span"),b(Fr.$$.fragment),lv=c(),op=n("span"),dv=r("ElectraForQuestionAnswering"),uu=c(),nt=n("div"),b(xr.$$.fragment),cv=c(),No=n("p"),pv=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zu.forEach(t),Q_=p(Nt),wt=s(Nt,"DIV",{class:!0});var oa=a(wt);y(Ka.$$.fragment,oa),B_=p(oa),$o=s(oa,"P",{});var Hd=a($o);V_=i(Hd,"The "),dd=s(Hd,"A",{href:!0});var u0=a(dd);K_=i(u0,"ElectraForPreTraining"),u0.forEach(t),J_=i(Hd," forward method, overrides the "),qc=s(Hd,"CODE",{});var f0=a(qc);G_=i(f0,"__call__"),f0.forEach(t),X_=i(Hd," special method."),Hd.forEach(t),Y_=p(oa),y(Mn.$$.fragment,oa),Z_=p(oa),y(zn.$$.fragment,oa),oa.forEach(t),Nt.forEach(t),nu=p(o),Fo=s(o,"H2",{class:!0});var ef=a(Fo);Cn=s(ef,"A",{id:!0,class:!0,href:!0});var g0=a(Cn);Pc=s(g0,"SPAN",{});var _0=a(Pc);y(Ja.$$.fragment,_0),_0.forEach(t),g0.forEach(t),e1=p(ef),Ac=s(ef,"SPAN",{});var k0=a(Ac);t1=i(k0,"ElectraForCausalLM"),k0.forEach(t),ef.forEach(t),su=p(o),et=s(o,"DIV",{class:!0});var so=a(et);y(Ga.$$.fragment,so),o1=p(so),Xa=s(so,"P",{});var tf=a(Xa);n1=i(tf,"ELECTRA Model with a "),Oc=s(tf,"CODE",{});var v0=a(Oc);s1=i(v0,"language modeling"),v0.forEach(t),a1=i(tf," head on top for CLM fine-tuning."),tf.forEach(t),r1=p(so),Ya=s(so,"P",{});var of=a(Ya);i1=i(of,"This model inherits from "),cd=s(of,"A",{href:!0});var T0=a(cd);l1=i(T0,"PreTrainedModel"),T0.forEach(t),d1=i(of,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),of.forEach(t),c1=p(so),Za=s(so,"P",{});var nf=a(Za);p1=i(nf,"This model is also a PyTorch "),er=s(nf,"A",{href:!0,rel:!0});var b0=a(er);h1=i(b0,"torch.nn.Module"),b0.forEach(t),m1=i(nf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nf.forEach(t),u1=p(so),$t=s(so,"DIV",{class:!0});var na=a($t);y(tr.$$.fragment,na),f1=p(na),xo=s(na,"P",{});var Qd=a(xo);g1=i(Qd,"The "),pd=s(Qd,"A",{href:!0});var y0=a(pd);_1=i(y0,"ElectraForCausalLM"),y0.forEach(t),k1=i(Qd," forward method, overrides the "),Lc=s(Qd,"CODE",{});var E0=a(Lc);v1=i(E0,"__call__"),E0.forEach(t),T1=i(Qd," special method."),Qd.forEach(t),b1=p(na),y(jn.$$.fragment,na),y1=p(na),y(qn.$$.fragment,na),na.forEach(t),so.forEach(t),au=p(o),Mo=s(o,"H2",{class:!0});var sf=a(Mo);Pn=s(sf,"A",{id:!0,class:!0,href:!0});var w0=a(Pn);Nc=s(w0,"SPAN",{});var $0=a(Nc);y(or.$$.fragment,$0),$0.forEach(t),w0.forEach(t),E1=p(sf),Ic=s(sf,"SPAN",{});var F0=a(Ic);w1=i(F0,"ElectraForMaskedLM"),F0.forEach(t),sf.forEach(t),ru=p(o),Qe=s(o,"DIV",{class:!0});var It=a(Qe);y(nr.$$.fragment,It),$1=p(It),Sc=s(It,"P",{});var x0=a(Sc);F1=i(x0,"Electra model with a language modeling head on top."),x0.forEach(t),x1=p(It),Dc=s(It,"P",{});var M0=a(Dc);M1=i(M0,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),M0.forEach(t),z1=p(It),sr=s(It,"P",{});var af=a(sr);C1=i(af,"This model inherits from "),hd=s(af,"A",{href:!0});var z0=a(hd);j1=i(z0,"PreTrainedModel"),z0.forEach(t),q1=i(af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),af.forEach(t),P1=p(It),ar=s(It,"P",{});var rf=a(ar);A1=i(rf,"This model is also a PyTorch "),rr=s(rf,"A",{href:!0,rel:!0});var C0=a(rr);O1=i(C0,"torch.nn.Module"),C0.forEach(t),L1=i(rf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rf.forEach(t),N1=p(It),st=s(It,"DIV",{class:!0});var ao=a(st);y(ir.$$.fragment,ao),I1=p(ao),zo=s(ao,"P",{});var Bd=a(zo);S1=i(Bd,"The "),md=s(Bd,"A",{href:!0});var j0=a(md);D1=i(j0,"ElectraForMaskedLM"),j0.forEach(t),W1=i(Bd," forward method, overrides the "),Wc=s(Bd,"CODE",{});var q0=a(Wc);U1=i(q0,"__call__"),q0.forEach(t),R1=i(Bd," special method."),Bd.forEach(t),H1=p(ao),y(An.$$.fragment,ao),Q1=p(ao),y(On.$$.fragment,ao),B1=p(ao),y(Ln.$$.fragment,ao),ao.forEach(t),It.forEach(t),iu=p(o),Co=s(o,"H2",{class:!0});var lf=a(Co);Nn=s(lf,"A",{id:!0,class:!0,href:!0});var P0=a(Nn);Uc=s(P0,"SPAN",{});var A0=a(Uc);y(lr.$$.fragment,A0),A0.forEach(t),P0.forEach(t),V1=p(lf),Rc=s(lf,"SPAN",{});var O0=a(Rc);K1=i(O0,"ElectraForSequenceClassification"),O0.forEach(t),lf.forEach(t),lu=p(o),tt=s(o,"DIV",{class:!0});var ro=a(tt);y(dr.$$.fragment,ro),J1=p(ro),Hc=s(ro,"P",{});var L0=a(Hc);G1=i(L0,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),L0.forEach(t),X1=p(ro),cr=s(ro,"P",{});var df=a(cr);Y1=i(df,"This model inherits from "),ud=s(df,"A",{href:!0});var N0=a(ud);Z1=i(N0,"PreTrainedModel"),N0.forEach(t),ek=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),df.forEach(t),tk=p(ro),pr=s(ro,"P",{});var cf=a(pr);ok=i(cf,"This model is also a PyTorch "),hr=s(cf,"A",{href:!0,rel:!0});var I0=a(hr);nk=i(I0,"torch.nn.Module"),I0.forEach(t),sk=i(cf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cf.forEach(t),ak=p(ro),Re=s(ro,"DIV",{class:!0});var pt=a(Re);y(mr.$$.fragment,pt),rk=p(pt),jo=s(pt,"P",{});var Vd=a(jo);ik=i(Vd,"The "),fd=s(Vd,"A",{href:!0});var S0=a(fd);lk=i(S0,"ElectraForSequenceClassification"),S0.forEach(t),dk=i(Vd," forward method, overrides the "),Qc=s(Vd,"CODE",{});var D0=a(Qc);ck=i(D0,"__call__"),D0.forEach(t),pk=i(Vd," special method."),Vd.forEach(t),hk=p(pt),y(In.$$.fragment,pt),mk=p(pt),y(Sn.$$.fragment,pt),uk=p(pt),y(Dn.$$.fragment,pt),fk=p(pt),y(Wn.$$.fragment,pt),gk=p(pt),y(Un.$$.fragment,pt),pt.forEach(t),ro.forEach(t),du=p(o),qo=s(o,"H2",{class:!0});var pf=a(qo);Rn=s(pf,"A",{id:!0,class:!0,href:!0});var W0=a(Rn);Bc=s(W0,"SPAN",{});var U0=a(Bc);y(ur.$$.fragment,U0),U0.forEach(t),W0.forEach(t),_k=p(pf),Vc=s(pf,"SPAN",{});var R0=a(Vc);kk=i(R0,"ElectraForMultipleChoice"),R0.forEach(t),pf.forEach(t),cu=p(o),ot=s(o,"DIV",{class:!0});var io=a(ot);y(fr.$$.fragment,io),vk=p(io),Kc=s(io,"P",{});var H0=a(Kc);Tk=i(H0,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),H0.forEach(t),bk=p(io),gr=s(io,"P",{});var hf=a(gr);yk=i(hf,"This model inherits from "),gd=s(hf,"A",{href:!0});var Q0=a(gd);Ek=i(Q0,"PreTrainedModel"),Q0.forEach(t),wk=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),$k=p(io),_r=s(io,"P",{});var mf=a(_r);Fk=i(mf,"This model is also a PyTorch "),kr=s(mf,"A",{href:!0,rel:!0});var B0=a(kr);xk=i(B0,"torch.nn.Module"),B0.forEach(t),Mk=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mf.forEach(t),zk=p(io),Ft=s(io,"DIV",{class:!0});var sa=a(Ft);y(vr.$$.fragment,sa),Ck=p(sa),Po=s(sa,"P",{});var Kd=a(Po);jk=i(Kd,"The "),_d=s(Kd,"A",{href:!0});var V0=a(_d);qk=i(V0,"ElectraForMultipleChoice"),V0.forEach(t),Pk=i(Kd," forward method, overrides the "),Jc=s(Kd,"CODE",{});var K0=a(Jc);Ak=i(K0,"__call__"),K0.forEach(t),Ok=i(Kd," special method."),Kd.forEach(t),Lk=p(sa),y(Hn.$$.fragment,sa),Nk=p(sa),y(Qn.$$.fragment,sa),sa.forEach(t),io.forEach(t),pu=p(o),Ao=s(o,"H2",{class:!0});var uf=a(Ao);Bn=s(uf,"A",{id:!0,class:!0,href:!0});var J0=a(Bn);Gc=s(J0,"SPAN",{});var G0=a(Gc);y(Tr.$$.fragment,G0),G0.forEach(t),J0.forEach(t),Ik=p(uf),Xc=s(uf,"SPAN",{});var X0=a(Xc);Sk=i(X0,"ElectraForTokenClassification"),X0.forEach(t),uf.forEach(t),hu=p(o),Be=s(o,"DIV",{class:!0});var St=a(Be);y(br.$$.fragment,St),Dk=p(St),Yc=s(St,"P",{});var Y0=a(Yc);Wk=i(Y0,"Electra model with a token classification head on top."),Y0.forEach(t),Uk=p(St),Zc=s(St,"P",{});var Z0=a(Zc);Rk=i(Z0,"Both the discriminator and generator may be loaded into this model."),Z0.forEach(t),Hk=p(St),yr=s(St,"P",{});var ff=a(yr);Qk=i(ff,"This model inherits from "),kd=s(ff,"A",{href:!0});var eF=a(kd);Bk=i(eF,"PreTrainedModel"),eF.forEach(t),Vk=i(ff,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ff.forEach(t),Kk=p(St),Er=s(St,"P",{});var gf=a(Er);Jk=i(gf,"This model is also a PyTorch "),wr=s(gf,"A",{href:!0,rel:!0});var tF=a(wr);Gk=i(tF,"torch.nn.Module"),tF.forEach(t),Xk=i(gf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gf.forEach(t),Yk=p(St),at=s(St,"DIV",{class:!0});var lo=a(at);y($r.$$.fragment,lo),Zk=p(lo),Oo=s(lo,"P",{});var Jd=a(Oo);ev=i(Jd,"The "),vd=s(Jd,"A",{href:!0});var oF=a(vd);tv=i(oF,"ElectraForTokenClassification"),oF.forEach(t),ov=i(Jd," forward method, overrides the "),ep=s(Jd,"CODE",{});var nF=a(ep);nv=i(nF,"__call__"),nF.forEach(t),sv=i(Jd," special method."),Jd.forEach(t),av=p(lo),y(Vn.$$.fragment,lo),rv=p(lo),y(Kn.$$.fragment,lo),iv=p(lo),y(Jn.$$.fragment,lo),lo.forEach(t),St.forEach(t),mu=p(o),Lo=s(o,"H2",{class:!0});var _f=a(Lo);Gn=s(_f,"A",{id:!0,class:!0,href:!0});var sF=a(Gn);tp=s(sF,"SPAN",{});var aF=a(tp);y(Fr.$$.fragment,aF),aF.forEach(t),sF.forEach(t),lv=p(_f),op=s(_f,"SPAN",{});var rF=a(op);dv=i(rF,"ElectraForQuestionAnswering"),rF.forEach(t),_f.forEach(t),uu=p(o),nt=s(o,"DIV",{class:!0});var co=a(nt);y(xr.$$.fragment,co),cv=p(co),No=s(co,"P",{});var Gd=a(No);pv=i(Gd,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
