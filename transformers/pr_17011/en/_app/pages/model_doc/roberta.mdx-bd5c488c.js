...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17011/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17011/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17011/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17011/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
...
layers on top of the hidden-states output to compute `),Nc=n("code"),Gk=r("span start logits"),Xk=r(" and "),Ic=n("code"),Yk=r("span end logits"),Zk=r(")."),e1=p(),br=n("p"),t1=r("This model inherits from "),Jl=n("a"),o1=r("PreTrainedModel"),n1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),s1=p(),kr=n("p"),a1=r("This model is also a PyTorch "),vr=n("a"),r1=r("torch.nn.Module"),i1=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),l1=p(),lt=n("div"),T(Tr.$$.fragment),d1=p(),qo=n("p"),c1=r("The "),Kl=n("a"),p1=r("RobertaForQuestionAnswering"),h1=r(" forward method, overrides the "),Dc=n("code"),m1=r("__call__"),f1=r(" special method."),u1=p(),T(Vn.$$.fragment),g1=p(),T(Jn.$$.fragment),_1=p(),T(Kn.$$.fragment),zm=p(),Co=n("h2"),Gn=n("a"),Sc=n("span"),T(yr.$$.fragment),b1=p(),Wc=n("span"),k1=r("TFRobertaModel"),qm=p(),He=n("div"),T(wr.$$.fragment),v1=p(),Bc=n("p"),T1=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),y1=p(),$r=n("p"),w1=r("This model inherits from "),Gl=n("a"),$1=r("TFPreTrainedModel"),F1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),x1=p(),Fr=n("p"),R1=r("This model is also a "),xr=n("a"),M1=r("tf.keras.Model"),E1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),z1=p(),T(Xn.$$.fragment),q1=p(),Ft=n("div"),T(Rr.$$.fragment),C1=p(),jo=n("p"),j1=r("The "),Xl=n("a"),P1=r("TFRobertaModel"),L1=r(" forward method, overrides the "),Uc=n("code"),A1=r("__call__"),O1=r(" special method."),N1=p(),T(Yn.$$.fragment),I1=p(),T(Zn.$$.fragment),Cm=p(),Po=n("h2"),es=n("a"),Hc=n("span"),T(Mr.$$.fragment),D1=p(),Qc=n("span"),S1=r("TFRobertaForCausalLM"),jm=p(),Lo=n("div"),T(Er.$$.fragment),W1=p(),xt=n("div"),T(zr.$$.fragment),B1=p(),Ao=n("p"),U1=r("The "),Yl=n("a"),H1=r("TFRobertaForCausalLM"),Q1=r(" forward method, overrides the "),Vc=n("code"),V1=r("__call__"),J1=r(" special method."),K1=p(),T(ts.$$.fragment),G1=p(),T(os.$$.fragment),Pm=p(),Oo=n("h2"),ns=n("a"),Jc=n("span"),T(qr.$$.fragment),X1=p(),Kc=n("span"),Y1=r("TFRobertaForMaskedLM"),Lm=p(),Qe=n("div"),T(Cr.$$.fragment),Z1=p(),jr=n("p"),ev=r("RoBERTa Model with a "),Gc=n("code"),tv=r("language modeling"),ov=r(" head on top."),nv=p(),Pr=n("p"),sv=r("This model inherits from "),Zl=n("a"),av=r("TFPreTrainedModel"),rv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iv=p(),Lr=n("p"),lv=r("This model is also a "),Ar=n("a"),dv=r("tf.keras.Model"),cv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pv=p(),T(ss.$$.fragment),hv=p(),dt=n("div"),T(Or.$$.fragment),mv=p(),No=n("p"),fv=r("The "),ed=n("a"),uv=r("TFRobertaForMaskedLM"),gv=r(" forward method, overrides the "),Xc=n("code"),_v=r("__call__"),bv=r(" special method."),kv=p(),T(as.$$.fragment),vv=p(),T(rs.$$.fragment),Tv=p(),T(is.$$.fragment),Am=p(),Io=n("h2"),ls=n("a"),Yc=n("span"),T(Nr.$$.fragment),yv=p(),Zc=n("span"),wv=r("TFRobertaForSequenceClassification"),Om=p(),Ve=n("div"),T(Ir.$$.fragment),$v=p(),ep=n("p"),Fv=r(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),xv=p(),Dr=n("p"),Rv=r("This model inherits from "),td=n("a"),Mv=r("TFPreTrainedModel"),Ev=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zv=p(),Sr=n("p"),qv=r("This model is also a "),Wr=n("a"),Cv=r("tf.keras.Model"),jv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pv=p(),T(ds.$$.fragment),Lv=p(),ct=n("div"),T(Br.$$.fragment),Av=p(),Do=n("p"),Ov=r("The "),od=n("a"),Nv=r("TFRobertaForSequenceClassification"),Iv=r(" forward method, overrides the "),tp=n("code"),Dv=r("__call__"),Sv=r(" special method."),Wv=p(),T(cs.$$.fragment),Bv=p(),T(ps.$$.fragment),Uv=p(),T(hs.$$.fragment),Nm=p(),So=n("h2"),ms=n("a"),op=n("span"),T(Ur.$$.fragment),Hv=p(),np=n("span"),Qv=r("TFRobertaForMultipleChoice"),Im=p(),Je=n("div"),T(Hr.$$.fragment),Vv=p(),sp=n("p"),Jv=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Kv=p(),Qr=n("p"),Gv=r("This model inherits from "),nd=n("a"),Xv=r("TFPreTrainedModel"),Yv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zv=p(),Vr=n("p"),eT=r("This model is also a "),Jr=n("a"),tT=r("tf.keras.Model"),oT=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
layers on top of the hidden-states output to compute `),Nc=s($d,"CODE",{});var oF=a(Nc);Gk=i(oF,"span start logits"),oF.forEach(t),Xk=i($d," and "),Ic=s($d,"CODE",{});var nF=a(Ic);Yk=i(nF,"span end logits"),nF.forEach(t),Zk=i($d,")."),$d.forEach(t),e1=h(ao),br=s(ao,"P",{});var jf=a(br);t1=i(jf,"This model inherits from "),Jl=s(jf,"A",{href:!0});var sF=a(Jl);o1=i(sF,"PreTrainedModel"),sF.forEach(t),n1=i(jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jf.forEach(t),s1=h(ao),kr=s(ao,"P",{});var Pf=a(kr);a1=i(Pf,"This model is also a PyTorch "),vr=s(Pf,"A",{href:!0,rel:!0});var aF=a(vr);r1=i(aF,"torch.nn.Module"),aF.forEach(t),i1=i(Pf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pf.forEach(t),l1=h(ao),lt=s(ao,"DIV",{class:!0});var ro=a(lt);y(Tr.$$.fragment,ro),d1=h(ro),qo=s(ro,"P",{});var Fd=a(qo);c1=i(Fd,"The "),Kl=s(Fd,"A",{href:!0});var rF=a(Kl);p1=i(rF,"RobertaForQuestionAnswering"),rF.forEach(t),h1=i(Fd," forward method, overrides the "),Dc=s(Fd,"CODE",{});var iF=a(Dc);m1=i(iF,"__call__"),iF.forEach(t),f1=i(Fd," special method."),Fd.forEach(t),u1=h(ro),y(Vn.$$.fragment,ro),g1=h(ro),y(Jn.$$.fragment,ro),_1=h(ro),y(Kn.$$.fragment,ro),ro.forEach(t),ao.forEach(t),zm=h(o),Co=s(o,"H2",{class:!0});var Lf=a(Co);Gn=s(Lf,"A",{id:!0,class:!0,href:!0});var lF=a(Gn);Sc=s(lF,"SPAN",{});var dF=a(Sc);y(yr.$$.fragment,dF),dF.forEach(t),lF.forEach(t),b1=h(Lf),Wc=s(Lf,"SPAN",{});var cF=a(Wc);k1=i(cF,"TFRobertaModel"),cF.forEach(t),Lf.forEach(t),qm=h(o),He=s(o,"DIV",{class:!0});var Pt=a(He);y(wr.$$.fragment,Pt),v1=h(Pt),Bc=s(Pt,"P",{});var pF=a(Bc);T1=i(pF,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),pF.forEach(t),y1=h(Pt),$r=s(Pt,"P",{});var Af=a($r);w1=i(Af,"This model inherits from "),Gl=s(Af,"A",{href:!0});var hF=a(Gl);$1=i(hF,"TFPreTrainedModel"),hF.forEach(t),F1=i(Af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Af.forEach(t),x1=h(Pt),Fr=s(Pt,"P",{});var Of=a(Fr);R1=i(Of,"This model is also a "),xr=s(Of,"A",{href:!0,rel:!0});var mF=a(xr);M1=i(mF,"tf.keras.Model"),mF.forEach(t),E1=i(Of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Of.forEach(t),z1=h(Pt),y(Xn.$$.fragment,Pt),q1=h(Pt),Ft=s(Pt,"DIV",{class:!0});var Js=a(Ft);y(Rr.$$.fragment,Js),C1=h(Js),jo=s(Js,"P",{});var xd=a(jo);j1=i(xd,"The "),Xl=s(xd,"A",{href:!0});var fF=a(Xl);P1=i(fF,"TFRobertaModel"),fF.forEach(t),L1=i(xd," forward method, overrides the "),Uc=s(xd,"CODE",{});var uF=a(Uc);A1=i(uF,"__call__"),uF.forEach(t),O1=i(xd," special method."),xd.forEach(t),N1=h(Js),y(Yn.$$.fragment,Js),I1=h(Js),y(Zn.$$.fragment,Js),Js.forEach(t),Pt.forEach(t),Cm=h(o),Po=s(o,"H2",{class:!0});var Nf=a(Po);es=s(Nf,"A",{id:!0,class:!0,href:!0});var gF=a(es);Hc=s(gF,"SPAN",{});var _F=a(Hc);y(Mr.$$.fragment,_F),_F.forEach(t),gF.forEach(t),D1=h(Nf),Qc=s(Nf,"SPAN",{});var bF=a(Qc);S1=i(bF,"TFRobertaForCausalLM"),bF.forEach(t),Nf.forEach(t),jm=h(o),Lo=s(o,"DIV",{class:!0});var If=a(Lo);y(Er.$$.fragment,If),W1=h(If),xt=s(If,"DIV",{class:!0});var Ks=a(xt);y(zr.$$.fragment,Ks),B1=h(Ks),Ao=s(Ks,"P",{});var Rd=a(Ao);U1=i(Rd,"The "),Yl=s(Rd,"A",{href:!0});var kF=a(Yl);H1=i(kF,"TFRobertaForCausalLM"),kF.forEach(t),Q1=i(Rd," forward method, overrides the "),Vc=s(Rd,"CODE",{});var vF=a(Vc);V1=i(vF,"__call__"),vF.forEach(t),J1=i(Rd," special method."),Rd.forEach(t),K1=h(Ks),y(ts.$$.fragment,Ks),G1=h(Ks),y(os.$$.fragment,Ks),Ks.forEach(t),If.forEach(t),Pm=h(o),Oo=s(o,"H2",{class:!0});var Df=a(Oo);ns=s(Df,"A",{id:!0,class:!0,href:!0});var TF=a(ns);Jc=s(TF,"SPAN",{});var yF=a(Jc);y(qr.$$.fragment,yF),yF.forEach(t),TF.forEach(t),X1=h(Df),Kc=s(Df,"SPAN",{});var wF=a(Kc);Y1=i(wF,"TFRobertaForMaskedLM"),wF.forEach(t),Df.forEach(t),Lm=h(o),Qe=s(o,"DIV",{class:!0});var Lt=a(Qe);y(Cr.$$.fragment,Lt),Z1=h(Lt),jr=s(Lt,"P",{});var Sf=a(jr);ev=i(Sf,"RoBERTa Model with a "),Gc=s(Sf,"CODE",{});var $F=a(Gc);tv=i($F,"language modeling"),$F.forEach(t),ov=i(Sf," head on top."),Sf.forEach(t),nv=h(Lt),Pr=s(Lt,"P",{});var Wf=a(Pr);sv=i(Wf,"This model inherits from "),Zl=s(Wf,"A",{href:!0});var FF=a(Zl);av=i(FF,"TFPreTrainedModel"),FF.forEach(t),rv=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),iv=h(Lt),Lr=s(Lt,"P",{});var Bf=a(Lr);lv=i(Bf,"This model is also a "),Ar=s(Bf,"A",{href:!0,rel:!0});var xF=a(Ar);dv=i(xF,"tf.keras.Model"),xF.forEach(t),cv=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),pv=h(Lt),y(ss.$$.fragment,Lt),hv=h(Lt),dt=s(Lt,"DIV",{class:!0});var io=a(dt);y(Or.$$.fragment,io),mv=h(io),No=s(io,"P",{});var Md=a(No);fv=i(Md,"The "),ed=s(Md,"A",{href:!0});var RF=a(ed);uv=i(RF,"TFRobertaForMaskedLM"),RF.forEach(t),gv=i(Md," forward method, overrides the "),Xc=s(Md,"CODE",{});var MF=a(Xc);_v=i(MF,"__call__"),MF.forEach(t),bv=i(Md," special method."),Md.forEach(t),kv=h(io),y(as.$$.fragment,io),vv=h(io),y(rs.$$.fragment,io),Tv=h(io),y(is.$$.fragment,io),io.forEach(t),Lt.forEach(t),Am=h(o),Io=s(o,"H2",{class:!0});var Uf=a(Io);ls=s(Uf,"A",{id:!0,class:!0,href:!0});var EF=a(ls);Yc=s(EF,"SPAN",{});var zF=a(Yc);y(Nr.$$.fragment,zF),zF.forEach(t),EF.forEach(t),yv=h(Uf),Zc=s(Uf,"SPAN",{});var qF=a(Zc);wv=i(qF,"TFRobertaForSequenceClassification"),qF.forEach(t),Uf.forEach(t),Om=h(o),Ve=s(o,"DIV",{class:!0});var At=a(Ve);y(Ir.$$.fragment,At),$v=h(At),ep=s(At,"P",{});var CF=a(ep);Fv=i(CF,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),CF.forEach(t),xv=h(At),Dr=s(At,"P",{});var Hf=a(Dr);Rv=i(Hf,"This model inherits from "),td=s(Hf,"A",{href:!0});var jF=a(td);Mv=i(jF,"TFPreTrainedModel"),jF.forEach(t),Ev=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hf.forEach(t),zv=h(At),Sr=s(At,"P",{});var Qf=a(Sr);qv=i(Qf,"This model is also a "),Wr=s(Qf,"A",{href:!0,rel:!0});var PF=a(Wr);Cv=i(PF,"tf.keras.Model"),PF.forEach(t),jv=i(Qf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qf.forEach(t),Pv=h(At),y(ds.$$.fragment,At),Lv=h(At),ct=s(At,"DIV",{class:!0});var lo=a(ct);y(Br.$$.fragment,lo),Av=h(lo),Do=s(lo,"P",{});var Ed=a(Do);Ov=i(Ed,"The "),od=s(Ed,"A",{href:!0});var LF=a(od);Nv=i(LF,"TFRobertaForSequenceClassification"),LF.forEach(t),Iv=i(Ed," forward method, overrides the "),tp=s(Ed,"CODE",{});var AF=a(tp);Dv=i(AF,"__call__"),AF.forEach(t),Sv=i(Ed," special method."),Ed.forEach(t),Wv=h(lo),y(cs.$$.fragment,lo),Bv=h(lo),y(ps.$$.fragment,lo),Uv=h(lo),y(hs.$$.fragment,lo),lo.forEach(t),At.forEach(t),Nm=h(o),So=s(o,"H2",{class:!0});var Vf=a(So);ms=s(Vf,"A",{id:!0,class:!0,href:!0});var OF=a(ms);op=s(OF,"SPAN",{});var NF=a(op);y(Ur.$$.fragment,NF),NF.forEach(t),OF.forEach(t),Hv=h(Vf),np=s(Vf,"SPAN",{});var IF=a(np);Qv=i(IF,"TFRobertaForMultipleChoice"),IF.forEach(t),Vf.forEach(t),Im=h(o),Je=s(o,"DIV",{class:!0});var Ot=a(Je);y(Hr.$$.fragment,Ot),Vv=h(Ot),sp=s(Ot,"P",{});var DF=a(sp);Jv=i(DF,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DF.forEach(t),Kv=h(Ot),Qr=s(Ot,"P",{});var Jf=a(Qr);Gv=i(Jf,"This model inherits from "),nd=s(Jf,"A",{href:!0});var SF=a(nd);Xv=i(SF,"TFPreTrainedModel"),SF.forEach(t),Yv=i(Jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jf.forEach(t),Zv=h(Ot),Vr=s(Ot,"P",{});var Kf=a(Vr);eT=i(Kf,"This model is also a "),Jr=s(Kf,"A",{href:!0,rel:!0});var WF=a(Jr);tT=i(WF,"tf.keras.Model"),WF.forEach(t),oT=i(Kf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
