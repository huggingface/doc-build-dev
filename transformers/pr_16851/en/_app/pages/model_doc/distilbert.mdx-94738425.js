...
first positional argument :`),ye.forEach(t),K=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var Q=r(z);ue=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),me=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var Fe=r(R);ie=i(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n(Z,"CODE",{});var De=r(L);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),fe=d(C),q=n(C,"LI",{});var ne=r(q);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,D),u(h,g,M),u(h,b,M),e(b,F),e(F,_),e(b,m),e(b,B),e(B,ce),u(h,V,M),u(h,E,M),e(E,G),e(E,S),e(S,X),e(E,pe),e(E,I),e(I,he),e(E,ae),u(h,N,M),u(h,P,M),e(P,Y),u(h,K,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,me),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,L),e(L,oe),e(x,fe),e(x,q),e(q,te),e(q,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(b),h&&t(V),h&&t(E),h&&t(N),h&&t(P),h&&t(K),h&&t(x)}}}function OD(j){let p,D,g,b,F;return{c(){p=o("p"),D=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),b=a("Module"),F=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var m=r(p);D=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(m,"CODE",{});var B=r(g);b=i(B,"Module"),B.forEach(t),F=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,D),e(p,g),e(g,b),e(p,F)},d(_){_&&t(p)}}}function ND(j){let p,D,g,b,F,_,m,B,ce,V,E,G,S,X,pe,I,he,ae,N,P,Y,K,x,z,ue,W,se,me,R,ie,ee,A,le,L,oe,fe,q,te,U,de;return{c(){p=o("p"),D=a("TF 2.0 models accepts two formats as inputs:"),g=l(),b=o("ul"),F=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),ce=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=o("p"),G=a("This second option is useful when using "),S=o("code"),X=a("tf.keras.Model.fit"),pe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),I=o("code"),he=a("model(inputs)"),ae=a("."),N=l(),P=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),x=o("ul"),z=o("li"),ue=a("a single Tensor with "),W=o("code"),se=a("input_ids"),me=a(" only and nothing else: "),R=o("code"),ie=a("model(inputs_ids)"),ee=l(),A=o("li"),le=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=o("code"),oe=a("model([input_ids, attention_mask])"),fe=l(),q=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=o("code"),de=a('model({"input_ids": input_ids})')},l(h){p=n(h,"P",{});var M=r(p);D=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),b=n(h,"UL",{});var J=r(b);F=n(J,"LI",{});var _e=r(F);_=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),m=d(J),B=n(J,"LI",{});var Te=r(B);ce=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),J.forEach(t),V=d(h),E=n(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),S=n(O,"CODE",{});var be=r(S);X=i(be,"tf.keras.Model.fit"),be.forEach(t),pe=i(O,` method which currently requires having all the
...
first positional argument :`),ye.forEach(t),K=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var Q=r(z);ue=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),me=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var Fe=r(R);ie=i(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n(Z,"CODE",{});var De=r(L);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),fe=d(C),q=n(C,"LI",{});var ne=r(q);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,D),u(h,g,M),u(h,b,M),e(b,F),e(F,_),e(b,m),e(b,B),e(B,ce),u(h,V,M),u(h,E,M),e(E,G),e(E,S),e(S,X),e(E,pe),e(E,I),e(I,he),e(E,ae),u(h,N,M),u(h,P,M),e(P,Y),u(h,K,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,me),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,L),e(L,oe),e(x,fe),e(x,q),e(q,te),e(q,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(b),h&&t(V),h&&t(E),h&&t(N),h&&t(P),h&&t(K),h&&t(x)}}}function LD(j){let p,D,g,b,F;return{c(){p=o("p"),D=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),b=a("Module"),F=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var m=r(p);D=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(m,"CODE",{});var B=r(g);b=i(B,"Module"),B.forEach(t),F=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,D),e(p,g),e(g,b),e(p,F)},d(_){_&&t(p)}}}function SD(j){let p,D,g,b,F,_,m,B,ce,V,E,G,S,X,pe,I,he,ae,N,P,Y,K,x,z,ue,W,se,me,R,ie,ee,A,le,L,oe,fe,q,te,U,de;return{c(){p=o("p"),D=a("TF 2.0 models accepts two formats as inputs:"),g=l(),b=o("ul"),F=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),ce=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=o("p"),G=a("This second option is useful when using "),S=o("code"),X=a("tf.keras.Model.fit"),pe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),I=o("code"),he=a("model(inputs)"),ae=a("."),N=l(),P=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),x=o("ul"),z=o("li"),ue=a("a single Tensor with "),W=o("code"),se=a("input_ids"),me=a(" only and nothing else: "),R=o("code"),ie=a("model(inputs_ids)"),ee=l(),A=o("li"),le=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=o("code"),oe=a("model([input_ids, attention_mask])"),fe=l(),q=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=o("code"),de=a('model({"input_ids": input_ids})')},l(h){p=n(h,"P",{});var M=r(p);D=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),b=n(h,"UL",{});var J=r(b);F=n(J,"LI",{});var _e=r(F);_=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),m=d(J),B=n(J,"LI",{});var Te=r(B);ce=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),J.forEach(t),V=d(h),E=n(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),S=n(O,"CODE",{});var be=r(S);X=i(be,"tf.keras.Model.fit"),be.forEach(t),pe=i(O,` method which currently requires having all the
...
first positional argument :`),ye.forEach(t),K=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var Q=r(z);ue=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),me=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var Fe=r(R);ie=i(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n(Z,"CODE",{});var De=r(L);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),fe=d(C),q=n(C,"LI",{});var ne=r(q);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,D),u(h,g,M),u(h,b,M),e(b,F),e(F,_),e(b,m),e(b,B),e(B,ce),u(h,V,M),u(h,E,M),e(E,G),e(E,S),e(S,X),e(E,pe),e(E,I),e(I,he),e(E,ae),u(h,N,M),u(h,P,M),e(P,Y),u(h,K,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,me),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,L),e(L,oe),e(x,fe),e(x,q),e(q,te),e(q,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(b),h&&t(V),h&&t(E),h&&t(N),h&&t(P),h&&t(K),h&&t(x)}}}function ID(j){let p,D,g,b,F;return{c(){p=o("p"),D=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),b=a("Module"),F=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var m=r(p);D=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(m,"CODE",{});var B=r(g);b=i(B,"Module"),B.forEach(t),F=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,D),e(p,g),e(g,b),e(p,F)},d(_){_&&t(p)}}}function WD(j){let p,D,g,b,F,_,m,B,ce,V,E,G,S,X,pe,I,he,ae,N,P,Y,K,x,z,ue,W,se,me,R,ie,ee,A,le,L,oe,fe,q,te,U,de;return{c(){p=o("p"),D=a("TF 2.0 models accepts two formats as inputs:"),g=l(),b=o("ul"),F=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),ce=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=o("p"),G=a("This second option is useful when using "),S=o("code"),X=a("tf.keras.Model.fit"),pe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),I=o("code"),he=a("model(inputs)"),ae=a("."),N=l(),P=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),x=o("ul"),z=o("li"),ue=a("a single Tensor with "),W=o("code"),se=a("input_ids"),me=a(" only and nothing else: "),R=o("code"),ie=a("model(inputs_ids)"),ee=l(),A=o("li"),le=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=o("code"),oe=a("model([input_ids, attention_mask])"),fe=l(),q=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=o("code"),de=a('model({"input_ids": input_ids})')},l(h){p=n(h,"P",{});var M=r(p);D=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),b=n(h,"UL",{});var J=r(b);F=n(J,"LI",{});var _e=r(F);_=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),m=d(J),B=n(J,"LI",{});var Te=r(B);ce=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),J.forEach(t),V=d(h),E=n(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),S=n(O,"CODE",{});var be=r(S);X=i(be,"tf.keras.Model.fit"),be.forEach(t),pe=i(O,` method which currently requires having all the
...
first positional argument :`),ye.forEach(t),K=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var Q=r(z);ue=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),me=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var Fe=r(R);ie=i(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n(Z,"CODE",{});var De=r(L);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),fe=d(C),q=n(C,"LI",{});var ne=r(q);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,D),u(h,g,M),u(h,b,M),e(b,F),e(F,_),e(b,m),e(b,B),e(B,ce),u(h,V,M),u(h,E,M),e(E,G),e(E,S),e(S,X),e(E,pe),e(E,I),e(I,he),e(E,ae),u(h,N,M),u(h,P,M),e(P,Y),u(h,K,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,me),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,L),e(L,oe),e(x,fe),e(x,q),e(q,te),e(q,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(b),h&&t(V),h&&t(E),h&&t(N),h&&t(P),h&&t(K),h&&t(x)}}}function RD(j){let p,D,g,b,F;return{c(){p=o("p"),D=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),b=a("Module"),F=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var m=r(p);D=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(m,"CODE",{});var B=r(g);b=i(B,"Module"),B.forEach(t),F=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,D),e(p,g),e(g,b),e(p,F)},d(_){_&&t(p)}}}function UD(j){let p,D,g,b,F,_,m,B,ce,V,E,G,S,X,pe,I,he,ae,N,P,Y,K,x,z,ue,W,se,me,R,ie,ee,A,le,L,oe,fe,q,te,U,de;return{c(){p=o("p"),D=a("TF 2.0 models accepts two formats as inputs:"),g=l(),b=o("ul"),F=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),ce=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=o("p"),G=a("This second option is useful when using "),S=o("code"),X=a("tf.keras.Model.fit"),pe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),I=o("code"),he=a("model(inputs)"),ae=a("."),N=l(),P=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),x=o("ul"),z=o("li"),ue=a("a single Tensor with "),W=o("code"),se=a("input_ids"),me=a(" only and nothing else: "),R=o("code"),ie=a("model(inputs_ids)"),ee=l(),A=o("li"),le=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=o("code"),oe=a("model([input_ids, attention_mask])"),fe=l(),q=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=o("code"),de=a('model({"input_ids": input_ids})')},l(h){p=n(h,"P",{});var M=r(p);D=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),b=n(h,"UL",{});var J=r(b);F=n(J,"LI",{});var _e=r(F);_=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),m=d(J),B=n(J,"LI",{});var Te=r(B);ce=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),J.forEach(t),V=d(h),E=n(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),S=n(O,"CODE",{});var be=r(S);X=i(be,"tf.keras.Model.fit"),be.forEach(t),pe=i(O,` method which currently requires having all the
...
first positional argument :`),ye.forEach(t),K=d(h),x=n(h,"UL",{});var C=r(x);z=n(C,"LI",{});var Q=r(z);ue=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var $e=r(W);se=i($e,"input_ids"),$e.forEach(t),me=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var Fe=r(R);ie=i(Fe,"model(inputs_ids)"),Fe.forEach(t),Q.forEach(t),ee=d(C),A=n(C,"LI",{});var Z=r(A);le=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n(Z,"CODE",{});var De=r(L);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),fe=d(C),q=n(C,"LI",{});var ne=r(q);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n(ne,"CODE",{});var Be=r(U);de=i(Be,'model({"input_ids": input_ids})'),Be.forEach(t),ne.forEach(t),C.forEach(t)},m(h,M){u(h,p,M),e(p,D),u(h,g,M),u(h,b,M),e(b,F),e(F,_),e(b,m),e(b,B),e(B,ce),u(h,V,M),u(h,E,M),e(E,G),e(E,S),e(S,X),e(E,pe),e(E,I),e(I,he),e(E,ae),u(h,N,M),u(h,P,M),e(P,Y),u(h,K,M),u(h,x,M),e(x,z),e(z,ue),e(z,W),e(W,se),e(z,me),e(z,R),e(R,ie),e(x,ee),e(x,A),e(A,le),e(A,L),e(L,oe),e(x,fe),e(x,q),e(q,te),e(q,U),e(U,de)},d(h){h&&t(p),h&&t(g),h&&t(b),h&&t(V),h&&t(E),h&&t(N),h&&t(P),h&&t(K),h&&t(x)}}}function QD(j){let p,D,g,b,F;return{c(){p=o("p"),D=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=o("code"),b=a("Module"),F=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=n(_,"P",{});var m=r(p);D=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(m,"CODE",{});var B=r(g);b=i(B,"Module"),B.forEach(t),F=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Whether or not to return a <a href="/docs/transformers/pr_16851/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_distilbert.py#L525",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16851/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16851/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16851/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16851/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458"}}),jo=new ge({props:{$$slots:{default:[HD]},$$scope:{ctx:j}}}),pa=new re({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertModel
...
Whether or not to return a <a href="/docs/transformers/pr_16851/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16851/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16851/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16851/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16851/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16851/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16851/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16851/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16851/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16851/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vb=l(),v(yo.$$.fragment),Kb=l(),nt=o("div"),v(Or.$$.fragment),Jb=l(),xs=o("p"),Gb=a("The "),Vi=o("a"),Xb=a("TFDistilBertForMultipleChoice"),Yb=a(" forward method, overrides the "),zd=o("code"),Zb=a("__call__"),e1=a(" special method."),t1=l(),v($o.$$.fragment),s1=l(),jd=o("p"),o1=a("Example:"),n1=l(),v(Nr.$$.fragment),Jp=l(),zs=o("h2"),Fo=o("a"),Cd=o("span"),v(Lr.$$.fragment),r1=l(),qd=o("span"),a1=a("TFDistilBertForTokenClassification"),Gp=l(),Le=o("div"),v(Sr.$$.fragment),i1=l(),Pd=o("p"),l1=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_1=l(),v(Do.$$.fragment),b1=l(),He=o("div"),v(Ur.$$.fragment),v1=l(),js=o("p"),k1=a("The "),Ji=o("a"),T1=a("TFDistilBertForTokenClassification"),w1=a(" forward method, overrides the "),Ad=o("code"),y1=a("__call__"),$1=a(" special method."),F1=l(),v(Bo.$$.fragment),D1=l(),Od=o("p"),B1=a("Example:"),M1=l(),v(Qr.$$.fragment),E1=l(),v(Hr.$$.fragment),Xp=l(),Cs=o("h2"),Mo=o("a"),Nd=o("span"),v(Vr.$$.fragment),x1=l(),Ld=o("span"),z1=a("TFDistilBertForQuestionAnswering"),Yp=l(),Se=o("div"),v(Kr.$$.fragment),j1=l(),qs=o("p"),C1=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
general usage and behavior.`),_v=l(),Vd=o("p"),bv=a("Finally, this model supports inherent JAX features such as:"),vv=l(),qt=o("ul"),Kd=o("li"),aa=o("a"),kv=a("Just-In-Time (JIT) compilation"),Tv=l(),Jd=o("li"),ia=o("a"),wv=a("Automatic Differentiation"),yv=l(),Gd=o("li"),la=o("a"),$v=a("Vectorization"),Fv=l(),Xd=o("li"),da=o("a"),Dv=a("Parallelization"),Bv=l(),rt=o("div"),v(ca.$$.fragment),Mv=l(),Os=o("p"),Ev=a("The "),Yd=o("code"),xv=a("FlaxDistilBertPreTrainedModel"),zv=a(" forward method, overrides the "),Zd=o("code"),jv=a("__call__"),Cv=a(" special method."),qv=l(),v(jo.$$.fragment),Pv=l(),ec=o("p"),Av=a("Example:"),Ov=l(),v(pa.$$.fragment),th=l(),Ns=o("h2"),Co=o("a"),tc=o("span"),v(ha.$$.fragment),Nv=l(),sc=o("span"),Lv=a("FlaxDistilBertForMaskedLM"),sh=l(),Ee=o("div"),v(ua.$$.fragment),Sv=l(),ma=o("p"),Iv=a("DistilBert Model with a "),oc=o("code"),Wv=a("language modeling"),Rv=a(" head on top."),Uv=l(),fa=o("p"),Qv=a("This model inherits from "),Zi=o("a"),Hv=a("FlaxPreTrainedModel"),Vv=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Kv=l(),ga=o("p"),Jv=a("This model is also a Flax Linen "),_a=o("a"),Gv=a("flax.linen.Module"),Xv=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cT=l(),Dc=o("p"),pT=a("Finally, this model supports inherent JAX features such as:"),hT=l(),Ot=o("ul"),Bc=o("li"),Sa=o("a"),uT=a("Just-In-Time (JIT) compilation"),mT=l(),Mc=o("li"),Ia=o("a"),fT=a("Automatic Differentiation"),gT=l(),Ec=o("li"),Wa=o("a"),_T=a("Vectorization"),bT=l(),xc=o("li"),Ra=o("a"),vT=a("Parallelization"),kT=l(),lt=o("div"),v(Ua.$$.fragment),TT=l(),Rs=o("p"),wT=a("The "),zc=o("code"),yT=a("FlaxDistilBertPreTrainedModel"),$T=a(" forward method, overrides the "),jc=o("code"),FT=a("__call__"),DT=a(" special method."),BT=l(),v(No.$$.fragment),MT=l(),Cc=o("p"),ET=a("Example:"),xT=l(),v(Qa.$$.fragment),ih=l(),Us=o("h2"),Lo=o("a"),qc=o("span"),v(Ha.$$.fragment),zT=l(),Pc=o("span"),jT=a("FlaxDistilBertForTokenClassification"),lh=l(),je=o("div"),v(Va.$$.fragment),CT=l(),Ac=o("p"),qT=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
necessary though, just let us know if you need this option.`),_i.forEach(t),gi.forEach(t),wp=d(s),vt=n(s,"P",{});var Wt=r(vt);wu=i(Wt,"This model was contributed by "),Yo=n(Wt,"A",{href:!0,rel:!0});var Vw=r(Yo);yu=i(Vw,"victorsanh"),Vw.forEach(t),$u=i(Wt,`. This model jax version was
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$h.forEach(t),rf=d(Ht),Ie=n(Ht,"DIV",{class:!0});var kt=r(Ie);k(Dn.$$.fragment,kt),af=d(kt),us=n(kt,"P",{});var al=r(us);lf=i(al,"The "),zi=n(al,"A",{href:!0});var qy=r(zi);df=i(qy,"DistilBertForMaskedLM"),qy.forEach(t),cf=i(al," forward method, overrides the "),Rl=n(al,"CODE",{});var Py=r(Rl);pf=i(Py,"__call__"),Py.forEach(t),hf=i(al," special method."),al.forEach(t),uf=d(kt),k(oo.$$.fragment,kt),mf=d(kt),Ul=n(kt,"P",{});var Ay=r(Ul);ff=i(Ay,"Example:"),Ay.forEach(t),gf=d(kt),k(Bn.$$.fragment,kt),_f=d(kt),k(Mn.$$.fragment,kt),kt.forEach(t),Ht.forEach(t),Cp=d(s),ms=n(s,"H2",{class:!0});var Fh=r(ms);no=n(Fh,"A",{id:!0,class:!0,href:!0});var Oy=r(no);Ql=n(Oy,"SPAN",{});var Ny=r(Ql);k(En.$$.fragment,Ny),Ny.forEach(t),Oy.forEach(t),bf=d(Fh),Hl=n(Fh,"SPAN",{});var Ly=r(Hl);vf=i(Ly,"DistilBertForSequenceClassification"),Ly.forEach(t),Fh.forEach(t),qp=d(s),Xe=n(s,"DIV",{class:!0});var Vt=r(Xe);k(xn.$$.fragment,Vt),kf=d(Vt),Vl=n(Vt,"P",{});var Sy=r(Vl);Tf=i(Sy,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh.forEach(t),ng=d(Kt),st=n(Kt,"DIV",{class:!0});var Jt=r(st);k(Un.$$.fragment,Jt),rg=d(Jt),_s=n(Jt,"P",{});var ll=r(_s);ag=i(ll,"The "),Pi=n(ll,"A",{href:!0});var Zy=r(Pi);ig=i(Zy,"DistilBertForMultipleChoice"),Zy.forEach(t),lg=i(ll," forward method, overrides the "),ed=n(ll,"CODE",{});var e2=r(ed);dg=i(e2,"__call__"),e2.forEach(t),cg=i(ll," special method."),ll.forEach(t),pg=d(Jt),k(io.$$.fragment,Jt),hg=d(Jt),td=n(Jt,"P",{});var t2=r(td);ug=i(t2,"Examples:"),t2.forEach(t),mg=d(Jt),k(Qn.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Op=d(s),bs=n(s,"H2",{class:!0});var zh=r(bs);lo=n(zh,"A",{id:!0,class:!0,href:!0});var s2=r(lo);sd=n(s2,"SPAN",{});var o2=r(sd);k(Hn.$$.fragment,o2),o2.forEach(t),s2.forEach(t),fg=d(zh),od=n(zh,"SPAN",{});var n2=r(od);gg=i(n2,"DistilBertForTokenClassification"),n2.forEach(t),zh.forEach(t),Np=d(s),Ze=n(s,"DIV",{class:!0});var Gt=r(Ze);k(Vn.$$.fragment,Gt),_g=d(Gt),nd=n(Gt,"P",{});var r2=r(nd);bg=i(r2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),r2.forEach(t),vg=d(Gt),Kn=n(Gt,"P",{});var jh=r(Kn);kg=i(jh,"This model inherits from "),Ai=n(jh,"A",{href:!0});var a2=r(Ai);Tg=i(a2,"PreTrainedModel"),a2.forEach(t),wg=i(jh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jh.forEach(t),yg=d(Gt),Jn=n(Gt,"P",{});var Ch=r(Jn);$g=i(Ch,"This model is also a PyTorch "),Gn=n(Ch,"A",{href:!0,rel:!0});var i2=r(Gn);Fg=i(i2,"torch.nn.Module"),i2.forEach(t),Dg=i(Ch,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ch.forEach(t),Bg=d(Gt),We=n(Gt,"DIV",{class:!0});var Tt=r(We);k(Xn.$$.fragment,Tt),Mg=d(Tt),vs=n(Tt,"P",{});var dl=r(vs);Eg=i(dl,"The "),Oi=n(dl,"A",{href:!0});var l2=r(Oi);xg=i(l2,"DistilBertForTokenClassification"),l2.forEach(t),zg=i(dl," forward method, overrides the "),rd=n(dl,"CODE",{});var d2=r(rd);jg=i(d2,"__call__"),d2.forEach(t),Cg=i(dl," special method."),dl.forEach(t),qg=d(Tt),k(co.$$.fragment,Tt),Pg=d(Tt),ad=n(Tt,"P",{});var c2=r(ad);Ag=i(c2,"Example:"),c2.forEach(t),Og=d(Tt),k(Yn.$$.fragment,Tt),Ng=d(Tt),k(Zn.$$.fragment,Tt),Tt.forEach(t),Gt.forEach(t),Lp=d(s),ks=n(s,"H2",{class:!0});var qh=r(ks);po=n(qh,"A",{id:!0,class:!0,href:!0});var p2=r(po);id=n(p2,"SPAN",{});var h2=r(id);k(er.$$.fragment,h2),h2.forEach(t),p2.forEach(t),Lg=d(qh),ld=n(qh,"SPAN",{});var u2=r(ld);Sg=i(u2,"DistilBertForQuestionAnswering"),u2.forEach(t),qh.forEach(t),Sp=d(s),et=n(s,"DIV",{class:!0});var Xt=r(et);k(tr.$$.fragment,Xt),Ig=d(Xt),Ts=n(Xt,"P",{});var cl=r(Ts);Wg=i(cl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),dd=n(cl,"CODE",{});var m2=r(dd);Rg=i(m2,"span start logits"),m2.forEach(t),Ug=i(cl," and "),cd=n(cl,"CODE",{});var f2=r(cd);Qg=i(f2,"span end logits"),f2.forEach(t),Hg=i(cl,")."),cl.forEach(t),Vg=d(Xt),sr=n(Xt,"P",{});var Ph=r(sr);Kg=i(Ph,"This model inherits from "),Ni=n(Ph,"A",{href:!0});var g2=r(Ni);Jg=i(g2,"PreTrainedModel"),g2.forEach(t),Gg=i(Ph,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ph.forEach(t),Xg=d(Xt),or=n(Xt,"P",{});var Ah=r(or);Yg=i(Ah,"This model is also a PyTorch "),nr=n(Ah,"A",{href:!0,rel:!0});var _2=r(nr);Zg=i(_2,"torch.nn.Module"),_2.forEach(t),e_=i(Ah,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ah.forEach(t),t_=d(Xt),Re=n(Xt,"DIV",{class:!0});var wt=r(Re);k(rr.$$.fragment,wt),s_=d(wt),ws=n(wt,"P",{});var pl=r(ws);o_=i(pl,"The "),Li=n(pl,"A",{href:!0});var b2=r(Li);n_=i(b2,"DistilBertForQuestionAnswering"),b2.forEach(t),r_=i(pl," forward method, overrides the "),pd=n(pl,"CODE",{});var v2=r(pd);a_=i(v2,"__call__"),v2.forEach(t),i_=i(pl," special method."),pl.forEach(t),l_=d(wt),k(ho.$$.fragment,wt),d_=d(wt),hd=n(wt,"P",{});var k2=r(hd);c_=i(k2,"Example:"),k2.forEach(t),p_=d(wt),k(ar.$$.fragment,wt),h_=d(wt),k(ir.$$.fragment,wt),wt.forEach(t),Xt.forEach(t),Ip=d(s),ys=n(s,"H2",{class:!0});var Oh=r(ys);uo=n(Oh,"A",{id:!0,class:!0,href:!0});var T2=r(uo);ud=n(T2,"SPAN",{});var w2=r(ud);k(lr.$$.fragment,w2),w2.forEach(t),T2.forEach(t),u_=d(Oh),md=n(Oh,"SPAN",{});var y2=r(md);m_=i(y2,"TFDistilBertModel"),y2.forEach(t),Oh.forEach(t),Wp=d(s),Pe=n(s,"DIV",{class:!0});var yt=r(Pe);k(dr.$$.fragment,yt),f_=d(yt),fd=n(yt,"P",{});var $2=r(fd);g_=i($2,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),$2.forEach(t),__=d(yt),cr=n(yt,"P",{});var Nh=r(cr);b_=i(Nh,"This model inherits from "),Si=n(Nh,"A",{href:!0});var F2=r(Si);v_=i(F2,"TFPreTrainedModel"),F2.forEach(t),k_=i(Nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nh.forEach(t),T_=d(yt),pr=n(yt,"P",{});var Lh=r(pr);w_=i(Lh,"This model is also a "),hr=n(Lh,"A",{href:!0,rel:!0});var D2=r(hr);y_=i(D2,"tf.keras.Model"),D2.forEach(t),$_=i(Lh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Lh.forEach(t),F_=d(yt),k(mo.$$.fragment,yt),D_=d(yt),ot=n(yt,"DIV",{class:!0});var Yt=r(ot);k(ur.$$.fragment,Yt),B_=d(Yt),$s=n(Yt,"P",{});var hl=r($s);M_=i(hl,"The "),Ii=n(hl,"A",{href:!0});var B2=r(Ii);E_=i(B2,"TFDistilBertModel"),B2.forEach(t),x_=i(hl," forward method, overrides the "),gd=n(hl,"CODE",{});var M2=r(gd);z_=i(M2,"__call__"),M2.forEach(t),j_=i(hl," special method."),hl.forEach(t),C_=d(Yt),k(fo.$$.fragment,Yt),q_=d(Yt),_d=n(Yt,"P",{});var E2=r(_d);P_=i(E2,"Example:"),E2.forEach(t),A_=d(Yt),k(mr.$$.fragment,Yt),Yt.forEach(t),yt.forEach(t),Rp=d(s),Fs=n(s,"H2",{class:!0});var Sh=r(Fs);go=n(Sh,"A",{id:!0,class:!0,href:!0});var x2=r(go);bd=n(x2,"SPAN",{});var z2=r(bd);k(fr.$$.fragment,z2),z2.forEach(t),x2.forEach(t),O_=d(Sh),vd=n(Sh,"SPAN",{});var j2=r(vd);N_=i(j2,"TFDistilBertForMaskedLM"),j2.forEach(t),Sh.forEach(t),Up=d(s),Ae=n(s,"DIV",{class:!0});var $t=r(Ae);k(gr.$$.fragment,$t),L_=d($t),_r=n($t,"P",{});var Ih=r(_r);S_=i(Ih,"DistilBert Model with a "),kd=n(Ih,"CODE",{});var C2=r(kd);I_=i(C2,"masked language modeling"),C2.forEach(t),W_=i(Ih," head on top."),Ih.forEach(t),R_=d($t),br=n($t,"P",{});var Wh=r(br);U_=i(Wh,"This model inherits from "),Wi=n(Wh,"A",{href:!0});var q2=r(Wi);Q_=i(q2,"TFPreTrainedModel"),q2.forEach(t),H_=i(Wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wh.forEach(t),V_=d($t),vr=n($t,"P",{});var Rh=r(vr);K_=i(Rh,"This model is also a "),kr=n(Rh,"A",{href:!0,rel:!0});var P2=r(kr);J_=i(P2,"tf.keras.Model"),P2.forEach(t),G_=i(Rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),X_=d($t),k(_o.$$.fragment,$t),Y_=d($t),Ue=n($t,"DIV",{class:!0});var Ft=r(Ue);k(Tr.$$.fragment,Ft),Z_=d(Ft),Ds=n(Ft,"P",{});var ul=r(Ds);eb=i(ul,"The "),Ri=n(ul,"A",{href:!0});var A2=r(Ri);tb=i(A2,"TFDistilBertForMaskedLM"),A2.forEach(t),sb=i(ul," forward method, overrides the "),Td=n(ul,"CODE",{});var O2=r(Td);ob=i(O2,"__call__"),O2.forEach(t),nb=i(ul," special method."),ul.forEach(t),rb=d(Ft),k(bo.$$.fragment,Ft),ab=d(Ft),wd=n(Ft,"P",{});var N2=r(wd);ib=i(N2,"Example:"),N2.forEach(t),lb=d(Ft),k(wr.$$.fragment,Ft),db=d(Ft),k(yr.$$.fragment,Ft),Ft.forEach(t),$t.forEach(t),Qp=d(s),Bs=n(s,"H2",{class:!0});var Uh=r(Bs);vo=n(Uh,"A",{id:!0,class:!0,href:!0});var L2=r(vo);yd=n(L2,"SPAN",{});var S2=r(yd);k($r.$$.fragment,S2),S2.forEach(t),L2.forEach(t),cb=d(Uh),$d=n(Uh,"SPAN",{});var I2=r($d);pb=i(I2,"TFDistilBertForSequenceClassification"),I2.forEach(t),Uh.forEach(t),Hp=d(s),Oe=n(s,"DIV",{class:!0});var Dt=r(Oe);k(Fr.$$.fragment,Dt),hb=d(Dt),Fd=n(Dt,"P",{});var W2=r(Fd);ub=i(W2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),W2.forEach(t),mb=d(Dt),Dr=n(Dt,"P",{});var Qh=r(Dr);fb=i(Qh,"This model inherits from "),Ui=n(Qh,"A",{href:!0});var R2=r(Ui);gb=i(R2,"TFPreTrainedModel"),R2.forEach(t),_b=i(Qh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qh.forEach(t),bb=d(Dt),Br=n(Dt,"P",{});var Hh=r(Br);vb=i(Hh,"This model is also a "),Mr=n(Hh,"A",{href:!0,rel:!0});var U2=r(Mr);kb=i(U2,"tf.keras.Model"),U2.forEach(t),Tb=i(Hh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hh.forEach(t),wb=d(Dt),k(ko.$$.fragment,Dt),yb=d(Dt),Qe=n(Dt,"DIV",{class:!0});var Bt=r(Qe);k(Er.$$.fragment,Bt),$b=d(Bt),Ms=n(Bt,"P",{});var ml=r(Ms);Fb=i(ml,"The "),Qi=n(ml,"A",{href:!0});var Q2=r(Qi);Db=i(Q2,"TFDistilBertForSequenceClassification"),Q2.forEach(t),Bb=i(ml," forward method, overrides the "),Dd=n(ml,"CODE",{});var H2=r(Dd);Mb=i(H2,"__call__"),H2.forEach(t),Eb=i(ml," special method."),ml.forEach(t),xb=d(Bt),k(To.$$.fragment,Bt),zb=d(Bt),Bd=n(Bt,"P",{});var V2=r(Bd);jb=i(V2,"Example:"),V2.forEach(t),Cb=d(Bt),k(xr.$$.fragment,Bt),qb=d(Bt),k(zr.$$.fragment,Bt),Bt.forEach(t),Dt.forEach(t),Vp=d(s),Es=n(s,"H2",{class:!0});var Vh=r(Es);wo=n(Vh,"A",{id:!0,class:!0,href:!0});var K2=r(wo);Md=n(K2,"SPAN",{});var J2=r(Md);k(jr.$$.fragment,J2),J2.forEach(t),K2.forEach(t),Pb=d(Vh),Ed=n(Vh,"SPAN",{});var G2=r(Ed);Ab=i(G2,"TFDistilBertForMultipleChoice"),G2.forEach(t),Vh.forEach(t),Kp=d(s),Ne=n(s,"DIV",{class:!0});var Mt=r(Ne);k(Cr.$$.fragment,Mt),Ob=d(Mt),xd=n(Mt,"P",{});var X2=r(xd);Nb=i(X2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),X2.forEach(t),Lb=d(Mt),qr=n(Mt,"P",{});var Kh=r(qr);Sb=i(Kh,"This model inherits from "),Hi=n(Kh,"A",{href:!0});var Y2=r(Hi);Ib=i(Y2,"TFPreTrainedModel"),Y2.forEach(t),Wb=i(Kh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kh.forEach(t),Rb=d(Mt),Pr=n(Mt,"P",{});var Jh=r(Pr);Ub=i(Jh,"This model is also a "),Ar=n(Jh,"A",{href:!0,rel:!0});var Z2=r(Ar);Qb=i(Z2,"tf.keras.Model"),Z2.forEach(t),Hb=i(Jh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jh.forEach(t),Vb=d(Mt),k(yo.$$.fragment,Mt),Kb=d(Mt),nt=n(Mt,"DIV",{class:!0});var Zt=r(nt);k(Or.$$.fragment,Zt),Jb=d(Zt),xs=n(Zt,"P",{});var fl=r(xs);Gb=i(fl,"The "),Vi=n(fl,"A",{href:!0});var e$=r(Vi);Xb=i(e$,"TFDistilBertForMultipleChoice"),e$.forEach(t),Yb=i(fl," forward method, overrides the "),zd=n(fl,"CODE",{});var t$=r(zd);Zb=i(t$,"__call__"),t$.forEach(t),e1=i(fl," special method."),fl.forEach(t),t1=d(Zt),k($o.$$.fragment,Zt),s1=d(Zt),jd=n(Zt,"P",{});var s$=r(jd);o1=i(s$,"Example:"),s$.forEach(t),n1=d(Zt),k(Nr.$$.fragment,Zt),Zt.forEach(t),Mt.forEach(t),Jp=d(s),zs=n(s,"H2",{class:!0});var Gh=r(zs);Fo=n(Gh,"A",{id:!0,class:!0,href:!0});var o$=r(Fo);Cd=n(o$,"SPAN",{});var n$=r(Cd);k(Lr.$$.fragment,n$),n$.forEach(t),o$.forEach(t),r1=d(Gh),qd=n(Gh,"SPAN",{});var r$=r(qd);a1=i(r$,"TFDistilBertForTokenClassification"),r$.forEach(t),Gh.forEach(t),Gp=d(s),Le=n(s,"DIV",{class:!0});var Et=r(Le);k(Sr.$$.fragment,Et),i1=d(Et),Pd=n(Et,"P",{});var a$=r(Pd);l1=i(a$,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xh.forEach(t),u1=d(Et),Wr=n(Et,"P",{});var Yh=r(Wr);m1=i(Yh,"This model is also a "),Rr=n(Yh,"A",{href:!0,rel:!0});var l$=r(Rr);f1=i(l$,"tf.keras.Model"),l$.forEach(t),g1=i(Yh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yh.forEach(t),_1=d(Et),k(Do.$$.fragment,Et),b1=d(Et),He=n(Et,"DIV",{class:!0});var xt=r(He);k(Ur.$$.fragment,xt),v1=d(xt),js=n(xt,"P",{});var gl=r(js);k1=i(gl,"The "),Ji=n(gl,"A",{href:!0});var d$=r(Ji);T1=i(d$,"TFDistilBertForTokenClassification"),d$.forEach(t),w1=i(gl," forward method, overrides the "),Ad=n(gl,"CODE",{});var c$=r(Ad);y1=i(c$,"__call__"),c$.forEach(t),$1=i(gl," special method."),gl.forEach(t),F1=d(xt),k(Bo.$$.fragment,xt),D1=d(xt),Od=n(xt,"P",{});var p$=r(Od);B1=i(p$,"Example:"),p$.forEach(t),M1=d(xt),k(Qr.$$.fragment,xt),E1=d(xt),k(Hr.$$.fragment,xt),xt.forEach(t),Et.forEach(t),Xp=d(s),Cs=n(s,"H2",{class:!0});var Zh=r(Cs);Mo=n(Zh,"A",{id:!0,class:!0,href:!0});var h$=r(Mo);Nd=n(h$,"SPAN",{});var u$=r(Nd);k(Vr.$$.fragment,u$),u$.forEach(t),h$.forEach(t),x1=d(Zh),Ld=n(Zh,"SPAN",{});var m$=r(Ld);z1=i(m$,"TFDistilBertForQuestionAnswering"),m$.forEach(t),Zh.forEach(t),Yp=d(s),Se=n(s,"DIV",{class:!0});var zt=r(Se);k(Kr.$$.fragment,zt),j1=d(zt),qs=n(zt,"P",{});var _l=r(qs);C1=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Sd=n(_l,"CODE",{});var f$=r(Sd);q1=i(f$,"span start logits"),f$.forEach(t),P1=i(_l," and "),Id=n(_l,"CODE",{});var g$=r(Id);A1=i(g$,"span end logits"),g$.forEach(t),O1=i(_l,")."),_l.forEach(t),N1=d(zt),Jr=n(zt,"P",{});var eu=r(Jr);L1=i(eu,"This model inherits from "),Gi=n(eu,"A",{href:!0});var _$=r(Gi);S1=i(_$,"TFPreTrainedModel"),_$.forEach(t),I1=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),W1=d(zt),Gr=n(zt,"P",{});var tu=r(Gr);R1=i(tu,"This model is also a "),Xr=n(tu,"A",{href:!0,rel:!0});var b$=r(Xr);U1=i(b$,"tf.keras.Model"),b$.forEach(t),Q1=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),H1=d(zt),k(Eo.$$.fragment,zt),V1=d(zt),Ve=n(zt,"DIV",{class:!0});var jt=r(Ve);k(Yr.$$.fragment,jt),K1=d(jt),Ps=n(jt,"P",{});var bl=r(Ps);J1=i(bl,"The "),Xi=n(bl,"A",{href:!0});var v$=r(Xi);G1=i(v$,"TFDistilBertForQuestionAnswering"),v$.forEach(t),X1=i(bl," forward method, overrides the "),Wd=n(bl,"CODE",{});var k$=r(Wd);Y1=i(k$,"__call__"),k$.forEach(t),Z1=i(bl," special method."),bl.forEach(t),ev=d(jt),k(xo.$$.fragment,jt),tv=d(jt),Rd=n(jt,"P",{});var T$=r(Rd);sv=i(T$,"Example:"),T$.forEach(t),ov=d(jt),k(Zr.$$.fragment,jt),nv=d(jt),k(ea.$$.fragment,jt),jt.forEach(t),zt.forEach(t),Zp=d(s),As=n(s,"H2",{class:!0});var su=r(As);zo=n(su,"A",{id:!0,class:!0,href:!0});var w$=r(zo);Ud=n(w$,"SPAN",{});var y$=r(Ud);k(ta.$$.fragment,y$),y$.forEach(t),w$.forEach(t),rv=d(su),Qd=n(su,"SPAN",{});var $$=r(Qd);av=i($$,"FlaxDistilBertModel"),$$.forEach(t),su.forEach(t),eh=d(s),Me=n(s,"DIV",{class:!0});var pt=r(Me);k(sa.$$.fragment,pt),iv=d(pt),Hd=n(pt,"P",{});var F$=r(Hd);lv=i(F$,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),F$.forEach(t),dv=d(pt),oa=n(pt,"P",{});var ou=r(oa);cv=i(ou,"This model inherits from "),Yi=n(ou,"A",{href:!0});var D$=r(Yi);pv=i(D$,"FlaxPreTrainedModel"),D$.forEach(t),hv=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ou.forEach(t),uv=d(pt),na=n(pt,"P",{});var nu=r(na);mv=i(nu,"This model is also a Flax Linen "),ra=n(nu,"A",{href:!0,rel:!0});var B$=r(ra);fv=i(B$,"flax.linen.Module"),B$.forEach(t),gv=i(nu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),nu.forEach(t),_v=d(pt),Vd=n(pt,"P",{});var M$=r(Vd);bv=i(M$,"Finally, this model supports inherent JAX features such as:"),M$.forEach(t),vv=d(pt),qt=n(pt,"UL",{});var Ho=r(qt);Kd=n(Ho,"LI",{});var E$=r(Kd);aa=n(E$,"A",{href:!0,rel:!0});var x$=r(aa);kv=i(x$,"Just-In-Time (JIT) compilation"),x$.forEach(t),E$.forEach(t),Tv=d(Ho),Jd=n(Ho,"LI",{});var z$=r(Jd);ia=n(z$,"A",{href:!0,rel:!0});var j$=r(ia);wv=i(j$,"Automatic Differentiation"),j$.forEach(t),z$.forEach(t),yv=d(Ho),Gd=n(Ho,"LI",{});var C$=r(Gd);la=n(C$,"A",{href:!0,rel:!0});var q$=r(la);$v=i(q$,"Vectorization"),q$.forEach(t),C$.forEach(t),Fv=d(Ho),Xd=n(Ho,"LI",{});var P$=r(Xd);da=n(P$,"A",{href:!0,rel:!0});var A$=r(da);Dv=i(A$,"Parallelization"),A$.forEach(t),P$.forEach(t),Ho.forEach(t),Bv=d(pt),rt=n(pt,"DIV",{class:!0});var es=r(rt);k(ca.$$.fragment,es),Mv=d(es),Os=n(es,"P",{});var vl=r(Os);Ev=i(vl,"The "),Yd=n(vl,"CODE",{});var O$=r(Yd);xv=i(O$,"FlaxDistilBertPreTrainedModel"),O$.forEach(t),zv=i(vl," forward method, overrides the "),Zd=n(vl,"CODE",{});var N$=r(Zd);jv=i(N$,"__call__"),N$.forEach(t),Cv=i(vl," special method."),vl.forEach(t),qv=d(es),k(jo.$$.fragment,es),Pv=d(es),ec=n(es,"P",{});var L$=r(ec);Av=i(L$,"Example:"),L$.forEach(t),Ov=d(es),k(pa.$$.fragment,es),es.forEach(t),pt.forEach(t),th=d(s),Ns=n(s,"H2",{class:!0});var ru=r(Ns);Co=n(ru,"A",{id:!0,class:!0,href:!0});var S$=r(Co);tc=n(S$,"SPAN",{});var I$=r(tc);k(ha.$$.fragment,I$),I$.forEach(t),S$.forEach(t),Nv=d(ru),sc=n(ru,"SPAN",{});var W$=r(sc);Lv=i(W$,"FlaxDistilBertForMaskedLM"),W$.forEach(t),ru.forEach(t),sh=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);k(ua.$$.fragment,ht),Sv=d(ht),ma=n(ht,"P",{});var au=r(ma);Iv=i(au,"DistilBert Model with a "),oc=n(au,"CODE",{});var R$=r(oc);Wv=i(R$,"language modeling"),R$.forEach(t),Rv=i(au," head on top."),au.forEach(t),Uv=d(ht),fa=n(ht,"P",{});var iu=r(fa);Qv=i(iu,"This model inherits from "),Zi=n(iu,"A",{href:!0});var U$=r(Zi);Hv=i(U$,"FlaxPreTrainedModel"),U$.forEach(t),Vv=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),iu.forEach(t),Kv=d(ht),ga=n(ht,"P",{});var lu=r(ga);Jv=i(lu,"This model is also a Flax Linen "),_a=n(lu,"A",{href:!0,rel:!0});var Q$=r(_a);Gv=i(Q$,"flax.linen.Module"),Q$.forEach(t),Xv=i(lu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Yv=d(ht),nc=n(ht,"P",{});var H$=r(nc);Zv=i(H$,"Finally, this model supports inherent JAX features such as:"),H$.forEach(t),ek=d(ht),Pt=n(ht,"UL",{});var Vo=r(Pt);rc=n(Vo,"LI",{});var V$=r(rc);ba=n(V$,"A",{href:!0,rel:!0});var K$=r(ba);tk=i(K$,"Just-In-Time (JIT) compilation"),K$.forEach(t),V$.forEach(t),sk=d(Vo),ac=n(Vo,"LI",{});var J$=r(ac);va=n(J$,"A",{href:!0,rel:!0});var G$=r(va);ok=i(G$,"Automatic Differentiation"),G$.forEach(t),J$.forEach(t),nk=d(Vo),ic=n(Vo,"LI",{});var X$=r(ic);ka=n(X$,"A",{href:!0,rel:!0});var Y$=r(ka);rk=i(Y$,"Vectorization"),Y$.forEach(t),X$.forEach(t),ak=d(Vo),lc=n(Vo,"LI",{});var Z$=r(lc);Ta=n(Z$,"A",{href:!0,rel:!0});var eF=r(Ta);ik=i(eF,"Parallelization"),eF.forEach(t),Z$.forEach(t),Vo.forEach(t),lk=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);k(wa.$$.fragment,ts),dk=d(ts),Ls=n(ts,"P",{});var kl=r(Ls);ck=i(kl,"The "),dc=n(kl,"CODE",{});var tF=r(dc);pk=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),hk=i(kl," forward method, overrides the "),cc=n(kl,"CODE",{});var sF=r(cc);uk=i(sF,"__call__"),sF.forEach(t),mk=i(kl," special method."),kl.forEach(t),fk=d(ts),k(qo.$$.fragment,ts),gk=d(ts),pc=n(ts,"P",{});var oF=r(pc);_k=i(oF,"Example:"),oF.forEach(t),bk=d(ts),k(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ss=n(s,"H2",{class:!0});var du=r(Ss);Po=n(du,"A",{id:!0,class:!0,href:!0});var nF=r(Po);hc=n(nF,"SPAN",{});var rF=r(hc);k($a.$$.fragment,rF),rF.forEach(t),nF.forEach(t),vk=d(du),uc=n(du,"SPAN",{});var aF=r(uc);kk=i(aF,"FlaxDistilBertForSequenceClassification"),aF.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);k(Fa.$$.fragment,ut),Tk=d(ut),mc=n(ut,"P",{});var iF=r(mc);wk=i(iF,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),zk=d(ut),fc=n(ut,"P",{});var cF=r(fc);jk=i(cF,"Finally, this model supports inherent JAX features such as:"),cF.forEach(t),Ck=d(ut),At=n(ut,"UL",{});var Ko=r(At);gc=n(Ko,"LI",{});var pF=r(gc);Ea=n(pF,"A",{href:!0,rel:!0});var hF=r(Ea);qk=i(hF,"Just-In-Time (JIT) compilation"),hF.forEach(t),pF.forEach(t),Pk=d(Ko),_c=n(Ko,"LI",{});var uF=r(_c);xa=n(uF,"A",{href:!0,rel:!0});var mF=r(xa);Ak=i(mF,"Automatic Differentiation"),mF.forEach(t),uF.forEach(t),Ok=d(Ko),bc=n(Ko,"LI",{});var fF=r(bc);za=n(fF,"A",{href:!0,rel:!0});var gF=r(za);Nk=i(gF,"Vectorization"),gF.forEach(t),fF.forEach(t),Lk=d(Ko),vc=n(Ko,"LI",{});var _F=r(vc);ja=n(_F,"A",{href:!0,rel:!0});var bF=r(ja);Sk=i(bF,"Parallelization"),bF.forEach(t),_F.forEach(t),Ko.forEach(t),Ik=d(ut),it=n(ut,"DIV",{class:!0});var ss=r(it);k(Ca.$$.fragment,ss),Wk=d(ss),Is=n(ss,"P",{});var Tl=r(Is);Rk=i(Tl,"The "),kc=n(Tl,"CODE",{});var vF=r(kc);Uk=i(vF,"FlaxDistilBertPreTrainedModel"),vF.forEach(t),Qk=i(Tl," forward method, overrides the "),Tc=n(Tl,"CODE",{});var kF=r(Tc);Hk=i(kF,"__call__"),kF.forEach(t),Vk=i(Tl," special method."),Tl.forEach(t),Kk=d(ss),k(Ao.$$.fragment,ss),Jk=d(ss),wc=n(ss,"P",{});var TF=r(wc);Gk=i(TF,"Example:"),TF.forEach(t),Xk=d(ss),k(qa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),rh=d(s),Ws=n(s,"H2",{class:!0});var hu=r(Ws);Oo=n(hu,"A",{id:!0,class:!0,href:!0});var wF=r(Oo);yc=n(wF,"SPAN",{});var yF=r(yc);k(Pa.$$.fragment,yF),yF.forEach(t),wF.forEach(t),Yk=d(hu),$c=n(hu,"SPAN",{});var $F=r($c);Zk=i($F,"FlaxDistilBertForMultipleChoice"),$F.forEach(t),hu.forEach(t),ah=d(s),ze=n(s,"DIV",{class:!0});var mt=r(ze);k(Aa.$$.fragment,mt),eT=d(mt),Fc=n(mt,"P",{});var FF=r(Fc);tT=i(FF,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
