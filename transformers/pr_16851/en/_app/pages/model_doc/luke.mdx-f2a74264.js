...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var f=i(h);E=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(f,"CODE",{});var z=i(m);w=s(z,"Module"),z.forEach(t),L=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,E),e(h,m),e(m,w),e(h,L)},d(g){g&&t(h)}}}function up(K){let h,E,m,w,L,g,f,z,Ds,Vo,le,xe,Nn,Ve,Ws,Dn,Us,Ho,$e,Bs,He,Ks,Rs,Yo,Jt,Vs,Qo,Xt,Wn,Hs,Jo,Gt,Ys,Xo,R,Un,Ye,Qs,Zt,Js,Xs,Gs,Bn,F,Zs,Kn,ea,ta,Rn,na,oa,Vn,sa,aa,Hn,ra,ia,en,da,la,ca,Qe,V,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,Ta,on,Gn,wa,La,Ea,B,Zn,za,xa,ce,Fe,sn,$a,Fa,Xe,qa,Ca,Ma,qe,an,Pa,ja,Ge,Aa,Ia,Oa,rn,dn,Sa,Na,Da,O,ln,Wa,Ua,eo,Ba,Ka,to,Ra,Va,no,Ha,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,er,Ze,tr,nr,or,et,sr,tt,ar,rr,Go,pn,ir,Zo,nt,es,H,dr,ot,lr,cr,st,pr,hr,at,ur,mr,ts,he,Ce,so,rt,fr,ao,gr,ns,q,it,_r,dt,kr,hn,yr,br,vr,ue,Tr,un,wr,Lr,mn,Er,zr,xr,ro,$r,Fr,lt,os,me,Me,io,ct,qr,lo,Cr,ss,C,pt,Mr,co,Pr,jr,x,Ar,fn,Ir,Or,gn,Sr,Nr,_n,Dr,Wr,po,Ur,Br,ho,Kr,Rr,uo,Vr,Hr,mo,Yr,Qr,Jr,Pe,ht,Xr,fo,Gr,Zr,kn,ut,as,fe,je,go,mt,ei,_o,ti,rs,M,ft,ni,ko,oi,si,gt,ai,yn,ri,ii,di,_t,li,kt,ci,pi,hi,S,yt,ui,ge,mi,bn,fi,gi,yo,_i,ki,yi,Ae,bi,bo,vi,Ti,bt,is,_e,Ie,vo,vt,wi,To,Li,ds,P,Tt,Ei,wo,zi,xi,wt,$i,vn,Fi,qi,Ci,Lt,Mi,Et,Pi,ji,Ai,J,zt,Ii,ke,Oi,Tn,Si,Ni,Lo,Di,Wi,Ui,Oe,ls,ye,Se,Eo,xt,Bi,zo,Ki,cs,j,$t,Ri,xo,Vi,Hi,Ft,Yi,wn,Qi,Ji,Xi,qt,Gi,Ct,Zi,ed,td,N,Mt,nd,be,od,Ln,sd,ad,$o,rd,id,dd,Ne,ld,Fo,cd,pd,Pt,ps,ve,De,qo,jt,hd,Co,ud,hs,A,At,md,Mo,fd,gd,It,_d,En,kd,yd,bd,Ot,vd,St,Td,wd,Ld,D,Nt,Ed,Te,zd,zn,xd,$d,Po,Fd,qd,Cd,We,Md,jo,Pd,jd,Dt,us,we,Ue,Ao,Wt,Ad,Io,Id,ms,I,Ut,Od,Oo,Sd,Nd,Bt,Dd,xn,Wd,Ud,Bd,Kt,Kd,Rt,Rd,Vd,Hd,W,Vt,Yd,Le,Qd,$n,Jd,Xd,So,Gd,Zd,el,Be,tl,No,nl,ol,Ht,fs;return g=new ze({}),Ve=new ze({}),nt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeModel">LukeModel</a>.`,name:"vocab_size"},{anchor:"transformers.LukeConfig.entity_vocab_size",description:`<strong>entity_vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 500000) &#x2014;
Entity vocabulary size of the LUKE model. Defines the number of different entities that can be represented
by the <code>entity_ids</code> passed when calling <a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeModel">LukeModel</a>.`,name:"entity_vocab_size"},{anchor:"transformers.LukeConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
al.)</a>.`,name:"use_entity_aware_attention"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/configuration_luke.py#L29"}}),lt=new Sn({props:{code:`from transformers import LukeConfig, LukeModel
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LukeTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16851/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16851/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/tokenization_luke.py#L260",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16851/en/main_classes/tokenizer#transformers.BatchEncoding"
...
<p><a
  href="/docs/transformers/pr_16851/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ut=new U({props:{name:"save_vocabulary",anchor:"transformers.LukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/tokenization_luke.py#L1378"}}),mt=new ze({}),ft=new U({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:": LukeConfig"},{name:"add_pooling_layer",val:": bool = True"}],parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/modeling_luke.py#L880"}}),yt=new U({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_16851/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>word_last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>entity_last_hidden_state = outputs.entity_last_hidden_state`}}),vt=new ze({}),Tt=new U({props:{name:"class transformers.LukeForMaskedLM",anchor:"transformers.LukeForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LukeForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/modeling_luke.py#L1133"}}),zt=new U({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_16851/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16851/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"entity_labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/modeling_luke.py#L1169",returnDescription:`
...
and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/modeling_luke.py#L1282",returnDescription:`
...
Predicted <span class="hljs-keyword">class</span>: person`}}),jt=new ze({}),At=new U({props:{name:"class transformers.LukeForEntityPairClassification",anchor:"transformers.LukeForEntityPairClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/modeling_luke.py#L1384"}}),Nt=new U({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_16851/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16851/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>[0, ..., config.num_labels - 1]</code>. If the shape is <code>(batch_size, num_labels)</code>, the binary cross entropy
loss is used for the multi-label classification. In this case, labels should only contain <code>[0, 1]</code>, where 0
and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/modeling_luke.py#L1397",returnDescription:`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_idx = logits.argmax(-<span class="hljs-number">1</span>).item()
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])
Predicted <span class="hljs-keyword">class</span>: per:cities_of_residence`}}),Wt=new ze({}),Ut=new U({props:{name:"class transformers.LukeForEntitySpanClassification",anchor:"transformers.LukeForEntitySpanClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/modeling_luke.py#L1504"}}),Vt=new U({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/pr_16851/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16851/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
labels should only contain <code>[0, 1]</code>, where 0 and 1 indicate false and true, respectively.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16851/src/transformers/models/luke/modeling_luke.py#L1517",returnDescription:`
...
`}}),Be=new Ro({props:{$$slots:{default:[hp]},$$scope:{ctx:K}}}),Ht=new Sn({props:{code:`from transformers import LukeTokenizer, LukeForEntitySpanClassification
...
Beyonc\xE9 PER
Los Angeles LOC`}}),{c(){h=a("meta"),E=l(),m=a("h1"),w=a("a"),L=a("span"),_(g.$$.fragment),f=l(),z=a("span"),Ds=o("LUKE"),Vo=l(),le=a("h2"),xe=a("a"),Nn=a("span"),_(Ve.$$.fragment),Ws=l(),Dn=a("span"),Us=o("Overview"),Ho=l(),$e=a("p"),Bs=o("The LUKE model was proposed in "),He=a("a"),Ks=o("LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),Rs=o(` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
...
This model places a linear head on top of the output entity representation.`),Ma=l(),qe=a("li"),an=a("a"),Pa=o("LukeForEntityPairClassification"),ja=o(`, for tasks to classify the relationship between two entities
...
documentation from `),mn=a("a"),Er=o("PretrainedConfig"),zr=o(" for more information."),xr=l(),ro=a("p"),$r=o("Examples:"),Fr=l(),_(lt.$$.fragment),os=l(),me=a("h2"),Me=a("a"),io=a("span"),_(ct.$$.fragment),qr=l(),lo=a("span"),Cr=o("LukeTokenizer"),ss=l(),C=a("div"),_(pt.$$.fragment),Mr=l(),co=a("p"),Pr=o("Construct a LUKE tokenizer."),jr=l(),x=a("p"),Ar=o("This tokenizer inherits from "),fn=a("a"),Ir=o("RobertaTokenizer"),Or=o(` which contains most of the main methods. Users should refer to
...
also creates entity sequences, namely `),po=a("code"),Ur=o("entity_ids"),Br=o(", "),ho=a("code"),Kr=o("entity_attention_mask"),Rr=o(", "),uo=a("code"),Vr=o("entity_token_type_ids"),Hr=o(`, and
...
sequences, depending on the task you want to prepare them for.`),Zr=l(),kn=a("div"),_(ut.$$.fragment),as=l(),fe=a("h2"),je=a("a"),go=a("span"),_(mt.$$.fragment),ei=l(),_o=a("span"),ti=o("LukeModel"),rs=l(),M=a("div"),_(ft.$$.fragment),ni=l(),ko=a("p"),oi=o("The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),si=l(),gt=a("p"),ai=o("This model inherits from "),yn=a("a"),ri=o("PreTrainedModel"),ii=o(`. Check the superclass documentation for the generic methods the
...
masked entity prediction.`),xi=l(),wt=a("p"),$i=o("This model inherits from "),vn=a("a"),Fi=o("PreTrainedModel"),qi=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ci=l(),Lt=a("p"),Mi=o("This model is also a PyTorch "),Et=a("a"),Pi=o("torch.nn.Module"),ji=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ai=l(),J=a("div"),_(zt.$$.fragment),Ii=l(),ke=a("p"),Oi=o("The "),Tn=a("a"),Si=o("LukeForMaskedLM"),Ni=o(" forward method, overrides the "),Lo=a("code"),Di=o("__call__"),Wi=o(" special method."),Ui=l(),_(Oe.$$.fragment),ls=l(),ye=a("h2"),Se=a("a"),Eo=a("span"),_(xt.$$.fragment),Bi=l(),zo=a("span"),Ki=o("LukeForEntityClassification"),cs=l(),j=a("div"),_($t.$$.fragment),Ri=l(),xo=a("p"),Vi=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Hi=l(),Ft=a("p"),Yi=o("This model inherits from "),wn=a("a"),Qi=o("PreTrainedModel"),Ji=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xi=l(),qt=a("p"),Gi=o("This model is also a PyTorch "),Ct=a("a"),Zi=o("torch.nn.Module"),ed=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),N=a("div"),_(Mt.$$.fragment),nd=l(),be=a("p"),od=o("The "),Ln=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),rd=o("__call__"),id=o(" special method."),dd=l(),_(Ne.$$.fragment),ld=l(),Fo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),De=a("a"),qo=a("span"),_(jt.$$.fragment),hd=l(),Co=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Mo=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld=l(),D=a("div"),_(Nt.$$.fragment),Ed=l(),Te=a("p"),zd=o("The "),zn=a("a"),xd=o("LukeForEntityPairClassification"),$d=o(" forward method, overrides the "),Po=a("code"),Fd=o("__call__"),qd=o(" special method."),Cd=l(),_(We.$$.fragment),Md=l(),jo=a("p"),Pd=o("Examples:"),jd=l(),_(Dt.$$.fragment),us=l(),we=a("h2"),Ue=a("a"),Ao=a("span"),_(Wt.$$.fragment),Ad=l(),Io=a("span"),Id=o("LukeForEntitySpanClassification"),ms=l(),I=a("div"),_(Ut.$$.fragment),Od=l(),Oo=a("p"),Sd=o(`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bd=l(),Kt=a("p"),Kd=o("This model is also a PyTorch "),Rt=a("a"),Rd=o("torch.nn.Module"),Vd=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hd=l(),W=a("div"),_(Vt.$$.fragment),Yd=l(),Le=a("p"),Qd=o("The "),$n=a("a"),Jd=o("LukeForEntitySpanClassification"),Xd=o(" forward method, overrides the "),So=a("code"),Gd=o("__call__"),Zd=o(" special method."),el=l(),_(Be.$$.fragment),tl=l(),No=a("p"),nl=o("Examples:"),ol=l(),_(Ht.$$.fragment),this.h()},l(n){const p=rp('[data-svelte="svelte-1phssyn"]',document.head);h=r(p,"META",{name:!0,content:!0}),p.forEach(t),E=c(n),m=r(n,"H1",{class:!0});var Yt=i(m);w=r(Yt,"A",{id:!0,class:!0,href:!0});var Do=i(w);L=r(Do,"SPAN",{});var Wo=i(L);k(g.$$.fragment,Wo),Wo.forEach(t),Do.forEach(t),f=c(Yt),z=r(Yt,"SPAN",{});var Uo=i(z);Ds=s(Uo,"LUKE"),Uo.forEach(t),Yt.forEach(t),Vo=c(n),le=r(n,"H2",{class:!0});var Qt=i(le);xe=r(Qt,"A",{id:!0,class:!0,href:!0});var il=i(xe);Nn=r(il,"SPAN",{});var dl=i(Nn);k(Ve.$$.fragment,dl),dl.forEach(t),il.forEach(t),Ws=c(Qt),Dn=r(Qt,"SPAN",{});var ll=i(Dn);Us=s(ll,"Overview"),ll.forEach(t),Qt.forEach(t),Ho=c(n),$e=r(n,"P",{});var gs=i($e);Bs=s(gs,"The LUKE model was proposed in "),He=r(gs,"A",{href:!0,rel:!0});var cl=i(He);Ks=s(cl,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),cl.forEach(t),Rs=s(gs,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
...
entity typing, e.g. the `),Xe=r(Bo,"A",{href:!0,rel:!0});var Cl=i(Xe);qa=s(Cl,"Open Entity dataset"),Cl.forEach(t),Ca=s(Bo,`.
This model places a linear head on top of the output entity representation.`),Bo.forEach(t),Ma=c(Fn),qe=r(Fn,"LI",{});var Ko=i(qe);an=r(Ko,"A",{href:!0});var Ml=i(an);Pa=s(Ml,"LukeForEntityPairClassification"),Ml.forEach(t),ja=s(Ko,`, for tasks to classify the relationship between two entities
...
also creates entity sequences, namely `),po=r($,"CODE",{});var ic=i(po);Ur=s(ic,"entity_ids"),ic.forEach(t),Br=s($,", "),ho=r($,"CODE",{});var dc=i(ho);Kr=s(dc,"entity_attention_mask"),dc.forEach(t),Rr=s($,", "),uo=r($,"CODE",{});var lc=i(uo);Vr=s(lc,"entity_token_type_ids"),lc.forEach(t),Hr=s($,`, and
...
masked entity prediction.`),Ec.forEach(t),xi=c(ne),wt=r(ne,"P",{});var Fs=i(wt);$i=s(Fs,"This model inherits from "),vn=r(Fs,"A",{href:!0});var zc=i(vn);Fi=s(zc,"PreTrainedModel"),zc.forEach(t),qi=s(Fs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fs.forEach(t),Ci=c(ne),Lt=r(ne,"P",{});var qs=i(Lt);Mi=s(qs,"This model is also a PyTorch "),Et=r(qs,"A",{href:!0,rel:!0});var xc=i(Et);Pi=s(xc,"torch.nn.Module"),xc.forEach(t),ji=s(qs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qs.forEach(t),Ai=c(ne),J=r(ne,"DIV",{class:!0});var Pn=i(J);k(zt.$$.fragment,Pn),Ii=c(Pn),ke=r(Pn,"P",{});var jn=i(ke);Oi=s(jn,"The "),Tn=r(jn,"A",{href:!0});var $c=i(Tn);Si=s($c,"LukeForMaskedLM"),$c.forEach(t),Ni=s(jn," forward method, overrides the "),Lo=r(jn,"CODE",{});var Fc=i(Lo);Di=s(Fc,"__call__"),Fc.forEach(t),Wi=s(jn," special method."),jn.forEach(t),Ui=c(Pn),k(Oe.$$.fragment,Pn),Pn.forEach(t),ne.forEach(t),ls=c(n),ye=r(n,"H2",{class:!0});var Cs=i(ye);Se=r(Cs,"A",{id:!0,class:!0,href:!0});var qc=i(Se);Eo=r(qc,"SPAN",{});var Cc=i(Eo);k(xt.$$.fragment,Cc),Cc.forEach(t),qc.forEach(t),Bi=c(Cs),zo=r(Cs,"SPAN",{});var Mc=i(zo);Ki=s(Mc,"LukeForEntityClassification"),Mc.forEach(t),Cs.forEach(t),cs=c(n),j=r(n,"DIV",{class:!0});var oe=i(j);k($t.$$.fragment,oe),Ri=c(oe),xo=r(oe,"P",{});var Pc=i(xo);Vi=s(Pc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Pc.forEach(t),Hi=c(oe),Ft=r(oe,"P",{});var Ms=i(Ft);Yi=s(Ms,"This model inherits from "),wn=r(Ms,"A",{href:!0});var jc=i(wn);Qi=s(jc,"PreTrainedModel"),jc.forEach(t),Ji=s(Ms,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ms.forEach(t),Xi=c(oe),qt=r(oe,"P",{});var Ps=i(qt);Gi=s(Ps,"This model is also a PyTorch "),Ct=r(Ps,"A",{href:!0,rel:!0});var Ac=i(Ct);Zi=s(Ac,"torch.nn.Module"),Ac.forEach(t),ed=s(Ps,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ps.forEach(t),td=c(oe),N=r(oe,"DIV",{class:!0});var se=i(N);k(Mt.$$.fragment,se),nd=c(se),be=r(se,"P",{});var An=i(be);od=s(An,"The "),Ln=r(An,"A",{href:!0});var Ic=i(Ln);sd=s(Ic,"LukeForEntityClassification"),Ic.forEach(t),ad=s(An," forward method, overrides the "),$o=r(An,"CODE",{});var Oc=i($o);rd=s(Oc,"__call__"),Oc.forEach(t),id=s(An," special method."),An.forEach(t),dd=c(se),k(Ne.$$.fragment,se),ld=c(se),Fo=r(se,"P",{});var Sc=i(Fo);cd=s(Sc,"Examples:"),Sc.forEach(t),pd=c(se),k(Pt.$$.fragment,se),se.forEach(t),oe.forEach(t),ps=c(n),ve=r(n,"H2",{class:!0});var js=i(ve);De=r(js,"A",{id:!0,class:!0,href:!0});var Nc=i(De);qo=r(Nc,"SPAN",{});var Dc=i(qo);k(jt.$$.fragment,Dc),Dc.forEach(t),Nc.forEach(t),hd=c(js),Co=r(js,"SPAN",{});var Wc=i(Co);ud=s(Wc,"LukeForEntityPairClassification"),Wc.forEach(t),js.forEach(t),hs=c(n),A=r(n,"DIV",{class:!0});var ae=i(A);k(At.$$.fragment,ae),md=c(ae),Mo=r(ae,"P",{});var Uc=i(Mo);fd=s(Uc,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ss.forEach(t),Bd=c(ie),Kt=r(ie,"P",{});var Ns=i(Kt);Kd=s(Ns,"This model is also a PyTorch "),Rt=r(Ns,"A",{href:!0,rel:!0});var Zc=i(Rt);Rd=s(Zc,"torch.nn.Module"),Zc.forEach(t),Vd=s(Ns,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ns.forEach(t),Hd=c(ie),W=r(ie,"DIV",{class:!0});var de=i(W);k(Vt.$$.fragment,de),Yd=c(de),Le=r(de,"P",{});var On=i(Le);Qd=s(On,"The "),$n=r(On,"A",{href:!0});var ep=i($n);Jd=s(ep,"LukeForEntitySpanClassification"),ep.forEach(t),Xd=s(On," forward method, overrides the "),So=r(On,"CODE",{});var tp=i(So);Gd=s(tp,"__call__"),tp.forEach(t),Zd=s(On," special method."),On.forEach(t),el=c(de),k(Be.$$.fragment,de),tl=c(de),No=r(de,"P",{});var np=i(No);nl=s(np,"Examples:"),np.forEach(t),ol=c(de),k(Ht.$$.fragment,de),de.forEach(t),ie.forEach(t),this.h()},h(){d(h,"name","hf:doc:metadata"),d(h,"content",JSON.stringify(mp)),d(w,"id","luke"),d(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(w,"href","#luke"),d(m,"class","relative group"),d(xe,"id","overview"),d(xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(xe,"href","#overview"),d(le,"class","relative group"),d(He,"href","https://arxiv.org/abs/2010.01057"),d(He,"rel","nofollow"),d(Zt,"href","/docs/transformers/pr_16851/en/model_doc/roberta#transformers.RobertaModel"),d(en,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeTokenizer"),d(tn,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeTokenizer"),d(sn,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeForEntityClassification"),d(Xe,"href","https://www.cs.utexas.edu/~eunsol/html_pages/open_entity.html"),d(Xe,"rel","nofollow"),d(an,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeForEntityPairClassification"),d(Ge,"href","https://nlp.stanford.edu/projects/tacred/"),d(Ge,"rel","nofollow"),d(dn,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeForEntitySpanClassification"),d(ln,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeTokenizer"),d(cn,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeForEntityPairClassification"),d(Ze,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/LUKE"),d(Ze,"rel","nofollow"),d(tt,"href","https://github.com/studio-ousia/luke/tree/master/notebooks"),d(tt,"rel","nofollow"),d(ot,"href","https://huggingface.co/ikuyamada"),d(ot,"rel","nofollow"),d(st,"href","https://huggingface.co/nielsr"),d(st,"rel","nofollow"),d(at,"href","https://github.com/studio-ousia/luke"),d(at,"rel","nofollow"),d(Ce,"id","transformers.LukeConfig"),d(Ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ce,"href","#transformers.LukeConfig"),d(he,"class","relative group"),d(hn,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeModel"),d(un,"href","/docs/transformers/pr_16851/en/main_classes/configuration#transformers.PretrainedConfig"),d(mn,"href","/docs/transformers/pr_16851/en/main_classes/configuration#transformers.PretrainedConfig"),d(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Me,"id","transformers.LukeTokenizer"),d(Me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Me,"href","#transformers.LukeTokenizer"),d(me,"class","relative group"),d(fn,"href","/docs/transformers/pr_16851/en/model_doc/roberta#transformers.RobertaTokenizer"),d(gn,"href","/docs/transformers/pr_16851/en/model_doc/roberta#transformers.RobertaTokenizer"),d(_n,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeTokenizer"),d(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(kn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(je,"id","transformers.LukeModel"),d(je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(je,"href","#transformers.LukeModel"),d(fe,"class","relative group"),d(yn,"href","/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel"),d(kt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(kt,"rel","nofollow"),d(bn,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeModel"),d(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ie,"id","transformers.LukeForMaskedLM"),d(Ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ie,"href","#transformers.LukeForMaskedLM"),d(_e,"class","relative group"),d(vn,"href","/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel"),d(Et,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Et,"rel","nofollow"),d(Tn,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeForMaskedLM"),d(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Se,"id","transformers.LukeForEntityClassification"),d(Se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Se,"href","#transformers.LukeForEntityClassification"),d(ye,"class","relative group"),d(wn,"href","/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel"),d(Ct,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Ct,"rel","nofollow"),d(Ln,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeForEntityClassification"),d(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(De,"id","transformers.LukeForEntityPairClassification"),d(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(De,"href","#transformers.LukeForEntityPairClassification"),d(ve,"class","relative group"),d(En,"href","/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel"),d(St,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(St,"rel","nofollow"),d(zn,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeForEntityPairClassification"),d(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ue,"id","transformers.LukeForEntitySpanClassification"),d(Ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ue,"href","#transformers.LukeForEntitySpanClassification"),d(we,"class","relative group"),d(xn,"href","/docs/transformers/pr_16851/en/main_classes/model#transformers.PreTrainedModel"),d(Rt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Rt,"rel","nofollow"),d($n,"href","/docs/transformers/pr_16851/en/model_doc/luke#transformers.LukeForEntitySpanClassification"),d(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,p){e(document.head,h),u(n,E,p),u(n,m,p),e(m,w),e(w,L),y(g,L,null),e(m,f),e(m,z),e(z,Ds),u(n,Vo,p),u(n,le,p),e(le,xe),e(xe,Nn),y(Ve,Nn,null),e(le,Ws),e(le,Dn),e(Dn,Us),u(n,Ho,p),u(n,$e,p),e($e,Bs),e($e,He),e(He,Ks),e($e,Rs),u(n,Yo,p),u(n,Jt,p),e(Jt,Vs),u(n,Qo,p),u(n,Xt,p),e(Xt,Wn),e(Wn,Hs),u(n,Jo,p),u(n,Gt,p),e(Gt,Ys),u(n,Xo,p),u(n,R,p),e(R,Un),e(Un,Ye),e(Ye,Qs),e(Ye,Zt),e(Zt,Js),e(Ye,Xs),e(R,Gs),e(R,Bn),e(Bn,F),e(F,Zs),e(F,Kn),e(Kn,ea),e(F,ta),e(F,Rn),e(Rn,na),e(F,oa),e(F,Vn),e(Vn,sa),e(F,aa),e(F,Hn),e(Hn,ra),e(F,ia),e(F,en),e(en,da),e(F,la),e(R,ca),e(R,Qe),e(Qe,V),e(V,tn),e(tn,pa),e(V,ha),e(V,Yn),e(Yn,ua),e(V,ma),e(V,Qn),e(Qn,fa),e(V,ga),e(V,Jn),e(Jn,_a),e(V,ka),e(Qe,ya),e(Qe,Je),e(Je,nn),e(nn,Xn),e(Xn,ba),e(nn,va),e(Je,Ta),e(Je,on),e(on,Gn),e(Gn,wa),e(on,La),e(R,Ea),e(R,B),e(B,Zn),e(Zn,za),e(B,xa),e(B,ce),e(ce,Fe),e(Fe,sn),e(sn,$a),e(Fe,Fa),e(Fe,Xe),e(Xe,qa),e(Fe,Ca),e(ce,Ma),e(ce,qe),e(qe,an),e(an,Pa),e(qe,ja),e(qe,Ge),e(Ge,Aa),e(qe,Ia),e(ce,Oa),e(ce,rn),e(rn,dn),e(dn,Sa),e(rn,Na),e(B,Da),e(B,O),e(O,ln),e(ln,Wa),e(O,Ua),e(O,eo),e(eo,Ba),e(O,Ka),e(O,to),e(to,Ra),e(O,Va),e(O,no),e(no,Ha),e(O,Ya),e(O,oo),e(oo,Qa),e(O,Ja),e(B,Xa),e(B,pe),e(pe,Ga),e(pe,cn),e(cn,Za),e(pe,er),e(pe,Ze),e(Ze,tr),e(pe,nr),e(B,or),e(B,et),e(et,sr),e(et,tt),e(tt,ar),e(et,rr),u(n,Go,p),u(n,pn,p),e(pn,ir),u(n,Zo,p),y(nt,n,p),u(n,es,p),u(n,H,p),e(H,dr),e(H,ot),e(ot,lr),e(H,cr),e(H,st),e(st,pr),e(H,hr),e(H,at),e(at,ur),e(H,mr),u(n,ts,p),u(n,he,p),e(he,Ce),e(Ce,so),y(rt,so,null),e(he,fr),e(he,ao),e(ao,gr),u(n,ns,p),u(n,q,p),y(it,q,null),e(q,_r),e(q,dt),e(dt,kr),e(dt,hn),e(hn,yr),e(dt,br),e(q,vr),e(q,ue),e(ue,Tr),e(ue,un),e(un,wr),e(ue,Lr),e(ue,mn),e(mn,Er),e(ue,zr),e(q,xr),e(q,ro),e(ro,$r),e(q,Fr),y(lt,q,null),u(n,os,p),u(n,me,p),e(me,Me),e(Me,io),y(ct,io,null),e(me,qr),e(me,lo),e(lo,Cr),u(n,ss,p),u(n,C,p),y(pt,C,null),e(C,Mr),e(C,co),e(co,Pr),e(C,jr),e(C,x),e(x,Ar),e(x,fn),e(fn,Ir),e(x,Or),e(x,gn),e(gn,Sr),e(x,Nr),e(x,_n),e(_n,Dr),e(x,Wr),e(x,po),e(po,Ur),e(x,Br),e(x,ho),e(ho,Kr),e(x,Rr),e(x,uo),e(uo,Vr),e(x,Hr),e(x,mo),e(mo,Yr),e(x,Qr),e(C,Jr),e(C,Pe),y(ht,Pe,null),e(Pe,Xr),e(Pe,fo),e(fo,Gr),e(C,Zr),e(C,kn),y(ut,kn,null),u(n,as,p),u(n,fe,p),e(fe,je),e(je,go),y(mt,go,null),e(fe,ei),e(fe,_o),e(_o,ti),u(n,rs,p),u(n,M,p),y(ft,M,null),e(M,ni),e(M,ko),e(ko,oi),e(M,si),e(M,gt),e(gt,ai),e(gt,yn),e(yn,ri),e(gt,ii),e(M,di),e(M,_t),e(_t,li),e(_t,kt),e(kt,ci),e(_t,pi),e(M,hi),e(M,S),y(yt,S,null),e(S,ui),e(S,ge),e(ge,mi),e(ge,bn),e(bn,fi),e(ge,gi),e(ge,yo),e(yo,_i),e(ge,ki),e(S,yi),y(Ae,S,null),e(S,bi),e(S,bo),e(bo,vi),e(S,Ti),y(bt,S,null),u(n,is,p),u(n,_e,p),e(_e,Ie),e(Ie,vo),y(vt,vo,null),e(_e,wi),e(_e,To),e(To,Li),u(n,ds,p),u(n,P,p),y(Tt,P,null),e(P,Ei),e(P,wo),e(wo,zi),e(P,xi),e(P,wt),e(wt,$i),e(wt,vn),e(vn,Fi),e(wt,qi),e(P,Ci),e(P,Lt),e(Lt,Mi),e(Lt,Et),e(Et,Pi),e(Lt,ji),e(P,Ai),e(P,J),y(zt,J,null),e(J,Ii),e(J,ke),e(ke,Oi),e(ke,Tn),e(Tn,Si),e(ke,Ni),e(ke,Lo),e(Lo,Di),e(ke,Wi),e(J,Ui),y(Oe,J,null),u(n,ls,p),u(n,ye,p),e(ye,Se),e(Se,Eo),y(xt,Eo,null),e(ye,Bi),e(ye,zo),e(zo,Ki),u(n,cs,p),u(n,j,p),y($t,j,null),e(j,Ri),e(j,xo),e(xo,Vi),e(j,Hi),e(j,Ft),e(Ft,Yi),e(Ft,wn),e(wn,Qi),e(Ft,Ji),e(j,Xi),e(j,qt),e(qt,Gi),e(qt,Ct),e(Ct,Zi),e(qt,ed),e(j,td),e(j,N),y(Mt,N,null),e(N,nd),e(N,be),e(be,od),e(be,Ln),e(Ln,sd),e(be,ad),e(be,$o),e($o,rd),e(be,id),e(N,dd),y(Ne,N,null),e(N,ld),e(N,Fo),e(Fo,cd),e(N,pd),y(Pt,N,null),u(n,ps,p),u(n,ve,p),e(ve,De),e(De,qo),y(jt,qo,null),e(ve,hd),e(ve,Co),e(Co,ud),u(n,hs,p),u(n,A,p),y(At,A,null),e(A,md),e(A,Mo),e(Mo,fd),e(A,gd),e(A,It),e(It,_d),e(It,En),e(En,kd),e(It,yd),e(A,bd),e(A,Ot),e(Ot,vd),e(Ot,St),e(St,Td),e(Ot,wd),e(A,Ld),e(A,D),y(Nt,D,null),e(D,Ed),e(D,Te),e(Te,zd),e(Te,zn),e(zn,xd),e(Te,$d),e(Te,Po),e(Po,Fd),e(Te,qd),e(D,Cd),y(We,D,null),e(D,Md),e(D,jo),e(jo,Pd),e(D,jd),y(Dt,D,null),u(n,us,p),u(n,we,p),e(we,Ue),e(Ue,Ao),y(Wt,Ao,null),e(we,Ad),e(we,Io),e(Io,Id),u(n,ms,p),u(n,I,p),y(Ut,I,null),e(I,Od),e(I,Oo),e(Oo,Sd),e(I,Nd),e(I,Bt),e(Bt,Dd),e(Bt,xn),e(xn,Wd),e(Bt,Ud),e(I,Bd),e(I,Kt),e(Kt,Kd),e(Kt,Rt),e(Rt,Rd),e(Kt,Vd),e(I,Hd),e(I,W),y(Vt,W,null),e(W,Yd),e(W,Le),e(Le,Qd),e(Le,$n),e($n,Jd),e(Le,Xd),e(Le,So),e(So,Gd),e(Le,Zd),e(W,el),y(Be,W,null),e(W,tl),e(W,No),e(No,nl),e(W,ol),y(Ht,W,null),fs=!0},p(n,[p]){const Yt={};p&2&&(Yt.$$scope={dirty:p,ctx:n}),Ae.$set(Yt);const Do={};p&2&&(Do.$$scope={dirty:p,ctx:n}),Oe.$set(Do);const Wo={};p&2&&(Wo.$$scope={dirty:p,ctx:n}),Ne.$set(Wo);const Uo={};p&2&&(Uo.$$scope={dirty:p,ctx:n}),We.$set(Uo);const Qt={};p&2&&(Qt.$$scope={dirty:p,ctx:n}),Be.$set(Qt)},i(n){fs||(b(g.$$.fragment,n),b(Ve.$$.fragment,n),b(nt.$$.fragment,n),b(rt.$$.fragment,n),b(it.$$.fragment,n),b(lt.$$.fragment,n),b(ct.$$.fragment,n),b(pt.$$.fragment,n),b(ht.$$.fragment,n),b(ut.$$.fragment,n),b(mt.$$.fragment,n),b(ft.$$.fragment,n),b(yt.$$.fragment,n),b(Ae.$$.fragment,n),b(bt.$$.fragment,n),b(vt.$$.fragment,n),b(Tt.$$.fragment,n),b(zt.$$.fragment,n),b(Oe.$$.fragment,n),b(xt.$$.fragment,n),b($t.$$.fragment,n),b(Mt.$$.fragment,n),b(Ne.$$.fragment,n),b(Pt.$$.fragment,n),b(jt.$$.fragment,n),b(At.$$.fragment,n),b(Nt.$$.fragment,n),b(We.$$.fragment,n),b(Dt.$$.fragment,n),b(Wt.$$.fragment,n),b(Ut.$$.fragment,n),b(Vt.$$.fragment,n),b(Be.$$.fragment,n),b(Ht.$$.fragment,n),fs=!0)},o(n){v(g.$$.fragment,n),v(Ve.$$.fragment,n),v(nt.$$.fragment,n),v(rt.$$.fragment,n),v(it.$$.fragment,n),v(lt.$$.fragment,n),v(ct.$$.fragment,n),v(pt.$$.fragment,n),v(ht.$$.fragment,n),v(ut.$$.fragment,n),v(mt.$$.fragment,n),v(ft.$$.fragment,n),v(yt.$$.fragment,n),v(Ae.$$.fragment,n),v(bt.$$.fragment,n),v(vt.$$.fragment,n),v(Tt.$$.fragment,n),v(zt.$$.fragment,n),v(Oe.$$.fragment,n),v(xt.$$.fragment,n),v($t.$$.fragment,n),v(Mt.$$.fragment,n),v(Ne.$$.fragment,n),v(Pt.$$.fragment,n),v(jt.$$.fragment,n),v(At.$$.fragment,n),v(Nt.$$.fragment,n),v(We.$$.fragment,n),v(Dt.$$.fragment,n),v(Wt.$$.fragment,n),v(Ut.$$.fragment,n),v(Vt.$$.fragment,n),v(Be.$$.fragment,n),v(Ht.$$.fragment,n),fs=!1},d(n){t(h),n&&t(E),n&&t(m),T(g),n&&t(Vo),n&&t(le),T(Ve),n&&t(Ho),n&&t($e),n&&t(Yo),n&&t(Jt),n&&t(Qo),n&&t(Xt),n&&t(Jo),n&&t(Gt),n&&t(Xo),n&&t(R),n&&t(Go),n&&t(pn),n&&t(Zo),T(nt,n),n&&t(es),n&&t(H),n&&t(ts),n&&t(he),T(rt),n&&t(ns),n&&t(q),T(it),T(lt),n&&t(os),n&&t(me),T(ct),n&&t(ss),n&&t(C),T(pt),T(ht),T(ut),n&&t(as),n&&t(fe),T(mt),n&&t(rs),n&&t(M),T(ft),T(yt),T(Ae),T(bt),n&&t(is),n&&t(_e),T(vt),n&&t(ds),n&&t(P),T(Tt),T(zt),T(Oe),n&&t(ls),n&&t(ye),T(xt),n&&t(cs),n&&t(j),T($t),T(Mt),T(Ne),T(Pt),n&&t(ps),n&&t(ve),T(jt),n&&t(hs),n&&t(A),T(At),T(Nt),T(We),T(Dt),n&&t(us),n&&t(we),T(Wt),n&&t(ms),n&&t(I),T(Ut),T(Vt),T(Be),T(Ht)}}}const mp={local:"luke",sections:[{local:"overview",title:"Overview"},{local:"transformers.LukeConfig",title:"LukeConfig"},{local:"transformers.LukeTokenizer",title:"LukeTokenizer"},{local:"transformers.LukeModel",title:"LukeModel"},{local:"transformers.LukeForMaskedLM",title:"LukeForMaskedLM"},{local:"transformers.LukeForEntityClassification",title:"LukeForEntityClassification"},{local:"transformers.LukeForEntityPairClassification",title:"LukeForEntityPairClassification"},{local:"transformers.LukeForEntitySpanClassification",title:"LukeForEntitySpanClassification"}],title:"LUKE"};function fp(K){return ip(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class vp extends op{constructor(h){super();sp(this,h,fp,up,ap,{})}}export{vp as default,mp as metadata};
