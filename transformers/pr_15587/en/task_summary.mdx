---
local: summary-of-the-tasks
sections:
- local: sequence-classification
  title: Sequence Classification
- local: extractive-question-answering
...
<h1 id="summary-of-the-tasks">Summary of the tasks</h1>

<DocNotebookDropdown hydrate-props={{
  classNames: "absolute z-10 right-0 top-0",
  options:[
    {label: "Mixed", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/task_summary.ipynb"},
    {label: "PyTorch", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/pytorch/task_summary.ipynb"},
    {label: "TensorFlow", value: "https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/tensorflow/task_summary.ipynb"},
    {label: "Mixed", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/transformers_doc/task_summary.ipynb"},
    {label: "PyTorch", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/transformers_doc/pytorch/task_summary.ipynb"},
    {label: "TensorFlow", value: "https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/transformers_doc/tensorflow/task_summary.ipynb"},
]}} />
...
automatically selecting the correct model architecture. Please check the [AutoModel](/docs/transformers/pr_15587/en/model_doc/auto#transformers.AutoModel) documentation
...
<h2 id="sequence-classification">Sequence Classification</h2>
...
...     print(f"&amp;lcub;classes[i]}: &amp;lcub;int(round(paraphrase_results[i] * 100))}%")
not paraphrase: 10%
is paraphrase: 90%

>>> # Should not be paraphrase
>>> for i in range(len(classes)):
...     print(f"&amp;lcub;classes[i]}: &amp;lcub;int(round(not_paraphrase_results[i] * 100))}%")
not paraphrase: 94%
is paraphrase: 6%
===PT-TF-SPLIT===
...
>>> print(
...     f"Answer: '&amp;lcub;result['answer']}', score: &amp;lcub;round(result['score'], 4)}, start: &amp;lcub;result['start']}, end: &amp;lcub;result['end']}"
... )
...
...     print(f"Question: &amp;lcub;question}")
...     print(f"Answer: &amp;lcub;answer}")
...
>>> pprint(
...     unmasker(
...         f"HuggingFace is creating a &amp;lcub;unmasker.tokenizer.mask_token} that the community uses to solve NLP tasks."
...     )
... )
[&amp;lcub;'score': 0.1793,
...
...     f"versions would help &amp;lcub;tokenizer.mask_token} our carbon footprint."
... )
...
In the next section, we show how [generation_utils.GenerationMixin.generate()](/docs/transformers/pr_15587/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) can be used to
...
[&amp;lcub;'generated_text': 'As far as I am concerned, I will be the first to admit that I am not a fan of the idea of a
...
[PreTrainedModel.generate()](/docs/transformers/pr_15587/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) to generate text. The default arguments for this method can be
...
...     print(entity)
&amp;lcub;'entity': 'I-ORG', 'score': 0.9996, 'index': 1, 'word': 'Hu', 'start': 0, 'end': 2}
&amp;lcub;'entity': 'I-ORG', 'score': 0.9910, 'index': 2, 'word': '##gging', 'start': 2, 'end': 7}
&amp;lcub;'entity': 'I-ORG', 'score': 0.9982, 'index': 3, 'word': 'Face', 'start': 8, 'end': 12}
&amp;lcub;'entity': 'I-ORG', 'score': 0.9995, 'index': 4, 'word': 'Inc', 'start': 13, 'end': 16}
&amp;lcub;'entity': 'I-LOC', 'score': 0.9994, 'index': 11, 'word': 'New', 'start': 40, 'end': 43}
&amp;lcub;'entity': 'I-LOC', 'score': 0.9993, 'index': 12, 'word': 'York', 'start': 44, 'end': 48}
&amp;lcub;'entity': 'I-LOC', 'score': 0.9994, 'index': 13, 'word': 'City', 'start': 49, 'end': 53}
&amp;lcub;'entity': 'I-LOC', 'score': 0.9863, 'index': 19, 'word': 'D', 'start': 79, 'end': 80}
&amp;lcub;'entity': 'I-LOC', 'score': 0.9514, 'index': 20, 'word': '##UM', 'start': 80, 'end': 82}
&amp;lcub;'entity': 'I-LOC', 'score': 0.9337, 'index': 21, 'word': '##BO', 'start': 82, 'end': 84}
&amp;lcub;'entity': 'I-LOC', 'score': 0.9762, 'index': 28, 'word': 'Manhattan', 'start': 114, 'end': 123}
&amp;lcub;'entity': 'I-LOC', 'score': 0.9915, 'index': 29, 'word': 'Bridge', 'start': 124, 'end': 130}
```
...
[&amp;lcub;'summary_text': ' Liana Barrientos, 39, is charged with two counts of "offering a false instrument for filing in
...
[&amp;lcub;'translation_text': 'Hugging Face ist ein Technologieunternehmen mit Sitz in New York und Paris.'}]
```
