...
Now let's see how to make sure that when we do [save_pretrained()](/docs/transformers/pr_15587/en/main_classes/model#transformers.PreTrainedModel.save_pretrained) or [push_to_hub()](/docs/transformers/pr_15587/en/main_classes/model#transformers.file_utils.PushToHubMixin.push_to_hub), the
