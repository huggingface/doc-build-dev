...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15841/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_15841/src/transformers/deepspeed.py#L114"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15841/src/transformers/deepspeed.py#L105"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15841/src/transformers/deepspeed.py#L146"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15841/src/transformers/deepspeed.py#L137"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),ks=o("h2"),$t=o("a"),hf=o("span"),f(po.$$.fragment),T5=u(),ff=o("span"),A5=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),Ps=o("h3"),kt=o("a"),df=o("span"),f(io.$$.fragment),S5=u(),mf=o("span"),C5=a("Installation"),rg=u(),Xp=o("p"),x5=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R5=a("or via "),_f=o("code"),I5=a("transformers"),U5=a("\u2019 "),vf=o("code"),G5=a("extras"),L5=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M5=a("or find more details on "),ho=o("a"),Z5=a("the DeepSpeed\u2019s GitHub page"),N5=a(` and
...
documented `),qo=o("a"),Q$=a("here"),e6=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s6=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t6=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a6=a("Unlike, "),Rf=o("code"),n6=a("torch.distributed.launch"),o6=a(" where you have to specify how many GPUs to use with "),If=o("code"),l6=a("--nproc_per_node"),r6=a(`, with the
