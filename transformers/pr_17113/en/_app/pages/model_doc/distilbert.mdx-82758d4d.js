...
Whether or not to return a <a href="/docs/transformers/pr_17113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_distilbert.py#L525",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17113/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
<a href="/docs/transformers/pr_17113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17113/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17113/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17113/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17113/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17113/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17113/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),e1=p(),Rr=s("p"),t1=a("This model is also a "),Ur=s("a"),o1=a("tf.keras.Model"),s1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),n1=p(),T(zs.$$.fragment),r1=p(),Ye=s("div"),T(Hr.$$.fragment),a1=p(),wo=s("p"),i1=a("The "),Zi=s("a"),l1=a("TFDistilBertForSequenceClassification"),d1=a(" forward method, overrides the "),wd=s("code"),c1=a("__call__"),p1=a(" special method."),h1=p(),T(js.$$.fragment),u1=p(),T(Cs.$$.fragment),f1=p(),T(qs.$$.fragment),Zp=p(),yo=s("h2"),Ps=s("a"),yd=s("span"),T(Vr.$$.fragment),m1=p(),Dd=s("span"),g1=a("TFDistilBertForMultipleChoice"),eh=p(),Le=s("div"),T(Kr.$$.fragment),_1=p(),Fd=s("p"),b1=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),v1=p(),Jr=s("p"),k1=a("This model inherits from "),el=s("a"),T1=a("TFPreTrainedModel"),$1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),w1=p(),Gr=s("p"),y1=a("This model is also a "),Xr=s("a"),D1=a("tf.keras.Model"),F1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),B1=p(),T(As.$$.fragment),x1=p(),mt=s("div"),T(Yr.$$.fragment),M1=p(),Do=s("p"),E1=a("The "),tl=s("a"),z1=a("TFDistilBertForMultipleChoice"),j1=a(" forward method, overrides the "),Bd=s("code"),C1=a("__call__"),q1=a(" special method."),P1=p(),T(Os.$$.fragment),A1=p(),T(Ns.$$.fragment),th=p(),Fo=s("h2"),Ls=s("a"),xd=s("span"),T(Zr.$$.fragment),O1=p(),Md=s("span"),N1=a("TFDistilBertForTokenClassification"),oh=p(),Se=s("div"),T(ea.$$.fragment),L1=p(),Ed=s("p"),S1=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),I1=p(),ta=s("p"),W1=a("This model inherits from "),ol=s("a"),Q1=a("TFPreTrainedModel"),R1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),U1=p(),oa=s("p"),H1=a("This model is also a "),sa=s("a"),V1=a("tf.keras.Model"),K1=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),J1=p(),T(Ss.$$.fragment),G1=p(),Ze=s("div"),T(na.$$.fragment),X1=p(),Bo=s("p"),Y1=a("The "),sl=s("a"),Z1=a("TFDistilBertForTokenClassification"),eb=a(" forward method, overrides the "),zd=s("code"),tb=a("__call__"),ob=a(" special method."),sb=p(),T(Is.$$.fragment),nb=p(),T(Ws.$$.fragment),rb=p(),T(Qs.$$.fragment),sh=p(),xo=s("h2"),Rs=s("a"),jd=s("span"),T(ra.$$.fragment),ab=p(),Cd=s("span"),ib=a("TFDistilBertForQuestionAnswering"),nh=p(),Ie=s("div"),T(aa.$$.fragment),lb=p(),Mo=s("p"),db=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bb=p(),la=s("p"),vb=a("This model is also a "),da=s("a"),kb=a("tf.keras.Model"),Tb=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
general usage and behavior.`),Ub=p(),Sd=s("p"),Hb=a("Finally, this model supports inherent JAX features such as:"),Vb=p(),Mt=s("ul"),Id=s("li"),ga=s("a"),Kb=a("Just-In-Time (JIT) compilation"),Jb=p(),Wd=s("li"),_a=s("a"),Gb=a("Automatic Differentiation"),Xb=p(),Qd=s("li"),ba=s("a"),Yb=a("Vectorization"),Zb=p(),Rd=s("li"),va=s("a"),ev=a("Parallelization"),tv=p(),gt=s("div"),T(ka.$$.fragment),ov=p(),jo=s("p"),sv=a("The "),Ud=s("code"),nv=a("FlaxDistilBertPreTrainedModel"),rv=a(" forward method, overrides the "),Hd=s("code"),av=a("__call__"),iv=a(" special method."),lv=p(),T(Gs.$$.fragment),dv=p(),T(Xs.$$.fragment),ih=p(),Co=s("h2"),Ys=s("a"),Vd=s("span"),T(Ta.$$.fragment),cv=p(),Kd=s("span"),pv=a("FlaxDistilBertForMaskedLM"),lh=p(),Ee=s("div"),T($a.$$.fragment),hv=p(),wa=s("p"),uv=a("DistilBert Model with a "),Jd=s("code"),fv=a("language modeling"),mv=a(" head on top."),gv=p(),ya=s("p"),_v=a("This model inherits from "),il=s("a"),bv=a("FlaxPreTrainedModel"),vv=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),kv=p(),Da=s("p"),Tv=a("This model is also a Flax Linen "),Fa=s("a"),$v=a("flax.linen.Module"),wv=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),yv=p(),Gd=s("p"),Dv=a("Finally, this model supports inherent JAX features such as:"),Fv=p(),Et=s("ul"),Xd=s("li"),Ba=s("a"),Bv=a("Just-In-Time (JIT) compilation"),xv=p(),Yd=s("li"),xa=s("a"),Mv=a("Automatic Differentiation"),Ev=p(),Zd=s("li"),Ma=s("a"),zv=a("Vectorization"),jv=p(),ec=s("li"),Ea=s("a"),Cv=a("Parallelization"),qv=p(),_t=s("div"),T(za.$$.fragment),Pv=p(),qo=s("p"),Av=a("The "),tc=s("code"),Ov=a("FlaxDistilBertPreTrainedModel"),Nv=a(" forward method, overrides the "),oc=s("code"),Lv=a("__call__"),Sv=a(" special method."),Iv=p(),T(Zs.$$.fragment),Wv=p(),T(en.$$.fragment),dh=p(),Po=s("h2"),tn=s("a"),sc=s("span"),T(ja.$$.fragment),Qv=p(),nc=s("span"),Rv=a("FlaxDistilBertForSequenceClassification"),ch=p(),ze=s("div"),T(Ca.$$.fragment),Uv=p(),rc=s("p"),Hv=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Vv=p(),qa=s("p"),Kv=a("This model inherits from "),ll=s("a"),Jv=a("FlaxPreTrainedModel"),Gv=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xv=p(),Pa=s("p"),Yv=a("This model is also a Flax Linen "),Aa=s("a"),Zv=a("flax.linen.Module"),ek=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vh.forEach(t),e1=h(yt),Rr=n(yt,"P",{});var Kh=r(Rr);t1=i(Kh,"This model is also a "),Ur=n(Kh,"A",{href:!0,rel:!0});var Ew=r(Ur);o1=i(Ew,"tf.keras.Model"),Ew.forEach(t),s1=i(Kh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kh.forEach(t),n1=h(yt),$(zs.$$.fragment,yt),r1=h(yt),Ye=n(yt,"DIV",{class:!0});var Xt=r(Ye);$(Hr.$$.fragment,Xt),a1=h(Xt),wo=n(Xt,"P",{});var Tl=r(wo);i1=i(Tl,"The "),Zi=n(Tl,"A",{href:!0});var zw=r(Zi);l1=i(zw,"TFDistilBertForSequenceClassification"),zw.forEach(t),d1=i(Tl," forward method, overrides the "),wd=n(Tl,"CODE",{});var jw=r(wd);c1=i(jw,"__call__"),jw.forEach(t),p1=i(Tl," special method."),Tl.forEach(t),h1=h(Xt),$(js.$$.fragment,Xt),u1=h(Xt),$(Cs.$$.fragment,Xt),f1=h(Xt),$(qs.$$.fragment,Xt),Xt.forEach(t),yt.forEach(t),Zp=h(o),yo=n(o,"H2",{class:!0});var Jh=r(yo);Ps=n(Jh,"A",{id:!0,class:!0,href:!0});var Cw=r(Ps);yd=n(Cw,"SPAN",{});var qw=r(yd);$(Vr.$$.fragment,qw),qw.forEach(t),Cw.forEach(t),m1=h(Jh),Dd=n(Jh,"SPAN",{});var Pw=r(Dd);g1=i(Pw,"TFDistilBertForMultipleChoice"),Pw.forEach(t),Jh.forEach(t),eh=h(o),Le=n(o,"DIV",{class:!0});var Dt=r(Le);$(Kr.$$.fragment,Dt),_1=h(Dt),Fd=n(Dt,"P",{});var Aw=r(Fd);b1=i(Aw,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Aw.forEach(t),v1=h(Dt),Jr=n(Dt,"P",{});var Gh=r(Jr);k1=i(Gh,"This model inherits from "),el=n(Gh,"A",{href:!0});var Ow=r(el);T1=i(Ow,"TFPreTrainedModel"),Ow.forEach(t),$1=i(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh.forEach(t),w1=h(Dt),Gr=n(Dt,"P",{});var Xh=r(Gr);y1=i(Xh,"This model is also a "),Xr=n(Xh,"A",{href:!0,rel:!0});var Nw=r(Xr);D1=i(Nw,"tf.keras.Model"),Nw.forEach(t),F1=i(Xh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),B1=h(Dt),$(As.$$.fragment,Dt),x1=h(Dt),mt=n(Dt,"DIV",{class:!0});var vn=r(mt);$(Yr.$$.fragment,vn),M1=h(vn),Do=n(vn,"P",{});var $l=r(Do);E1=i($l,"The "),tl=n($l,"A",{href:!0});var Lw=r(tl);z1=i(Lw,"TFDistilBertForMultipleChoice"),Lw.forEach(t),j1=i($l," forward method, overrides the "),Bd=n($l,"CODE",{});var Sw=r(Bd);C1=i(Sw,"__call__"),Sw.forEach(t),q1=i($l," special method."),$l.forEach(t),P1=h(vn),$(Os.$$.fragment,vn),A1=h(vn),$(Ns.$$.fragment,vn),vn.forEach(t),Dt.forEach(t),th=h(o),Fo=n(o,"H2",{class:!0});var Yh=r(Fo);Ls=n(Yh,"A",{id:!0,class:!0,href:!0});var Iw=r(Ls);xd=n(Iw,"SPAN",{});var Ww=r(xd);$(Zr.$$.fragment,Ww),Ww.forEach(t),Iw.forEach(t),O1=h(Yh),Md=n(Yh,"SPAN",{});var Qw=r(Md);N1=i(Qw,"TFDistilBertForTokenClassification"),Qw.forEach(t),Yh.forEach(t),oh=h(o),Se=n(o,"DIV",{class:!0});var Ft=r(Se);$(ea.$$.fragment,Ft),L1=h(Ft),Ed=n(Ft,"P",{});var Rw=r(Ed);S1=i(Rw,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Rw.forEach(t),I1=h(Ft),ta=n(Ft,"P",{});var Zh=r(ta);W1=i(Zh,"This model inherits from "),ol=n(Zh,"A",{href:!0});var Uw=r(ol);Q1=i(Uw,"TFPreTrainedModel"),Uw.forEach(t),R1=i(Zh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),U1=h(Ft),oa=n(Ft,"P",{});var eu=r(oa);H1=i(eu,"This model is also a "),sa=n(eu,"A",{href:!0,rel:!0});var Hw=r(sa);V1=i(Hw,"tf.keras.Model"),Hw.forEach(t),K1=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),J1=h(Ft),$(Ss.$$.fragment,Ft),G1=h(Ft),Ze=n(Ft,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),X1=h(Yt),Bo=n(Yt,"P",{});var wl=r(Bo);Y1=i(wl,"The "),sl=n(wl,"A",{href:!0});var Vw=r(sl);Z1=i(Vw,"TFDistilBertForTokenClassification"),Vw.forEach(t),eb=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var Kw=r(zd);tb=i(Kw,"__call__"),Kw.forEach(t),ob=i(wl," special method."),wl.forEach(t),sb=h(Yt),$(Is.$$.fragment,Yt),nb=h(Yt),$(Ws.$$.fragment,Yt),rb=h(Yt),$(Qs.$$.fragment,Yt),Yt.forEach(t),Ft.forEach(t),sh=h(o),xo=n(o,"H2",{class:!0});var tu=r(xo);Rs=n(tu,"A",{id:!0,class:!0,href:!0});var Jw=r(Rs);jd=n(Jw,"SPAN",{});var Gw=r(jd);$(ra.$$.fragment,Gw),Gw.forEach(t),Jw.forEach(t),ab=h(tu),Cd=n(tu,"SPAN",{});var Xw=r(Cd);ib=i(Xw,"TFDistilBertForQuestionAnswering"),Xw.forEach(t),tu.forEach(t),nh=h(o),Ie=n(o,"DIV",{class:!0});var Bt=r(Ie);$(aa.$$.fragment,Bt),lb=h(Bt),Mo=n(Bt,"P",{});var yl=r(Mo);db=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),bb=h(Bt),la=n(Bt,"P",{});var su=r(la);vb=i(su,"This model is also a "),da=n(su,"A",{href:!0,rel:!0});var ty=r(da);kb=i(ty,"tf.keras.Model"),ty.forEach(t),Tb=i(su,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Ub=h(ot),Sd=n(ot,"P",{});var cy=r(Sd);Hb=i(cy,"Finally, this model supports inherent JAX features such as:"),cy.forEach(t),Vb=h(ot),Mt=n(ot,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var py=r(Id);ga=n(py,"A",{href:!0,rel:!0});var hy=r(ga);Kb=i(hy,"Just-In-Time (JIT) compilation"),hy.forEach(t),py.forEach(t),Jb=h(kn),Wd=n(kn,"LI",{});var uy=r(Wd);_a=n(uy,"A",{href:!0,rel:!0});var fy=r(_a);Gb=i(fy,"Automatic Differentiation"),fy.forEach(t),uy.forEach(t),Xb=h(kn),Qd=n(kn,"LI",{});var my=r(Qd);ba=n(my,"A",{href:!0,rel:!0});var gy=r(ba);Yb=i(gy,"Vectorization"),gy.forEach(t),my.forEach(t),Zb=h(kn),Rd=n(kn,"LI",{});var _y=r(Rd);va=n(_y,"A",{href:!0,rel:!0});var by=r(va);ev=i(by,"Parallelization"),by.forEach(t),_y.forEach(t),kn.forEach(t),tv=h(ot),gt=n(ot,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),ov=h(Tn),jo=n(Tn,"P",{});var Fl=r(jo);sv=i(Fl,"The "),Ud=n(Fl,"CODE",{});var vy=r(Ud);nv=i(vy,"FlaxDistilBertPreTrainedModel"),vy.forEach(t),rv=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var ky=r(Hd);av=i(ky,"__call__"),ky.forEach(t),iv=i(Fl," special method."),Fl.forEach(t),lv=h(Tn),$(Gs.$$.fragment,Tn),dv=h(Tn),$(Xs.$$.fragment,Tn),Tn.forEach(t),ot.forEach(t),ih=h(o),Co=n(o,"H2",{class:!0});var iu=r(Co);Ys=n(iu,"A",{id:!0,class:!0,href:!0});var Ty=r(Ys);Vd=n(Ty,"SPAN",{});var $y=r(Vd);$(Ta.$$.fragment,$y),$y.forEach(t),Ty.forEach(t),cv=h(iu),Kd=n(iu,"SPAN",{});var wy=r(Kd);pv=i(wy,"FlaxDistilBertForMaskedLM"),wy.forEach(t),iu.forEach(t),lh=h(o),Ee=n(o,"DIV",{class:!0});var st=r(Ee);$($a.$$.fragment,st),hv=h(st),wa=n(st,"P",{});var lu=r(wa);uv=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var yy=r(Jd);fv=i(yy,"language modeling"),yy.forEach(t),mv=i(lu," head on top."),lu.forEach(t),gv=h(st),ya=n(st,"P",{});var du=r(ya);_v=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var Dy=r(il);bv=i(Dy,"FlaxPreTrainedModel"),Dy.forEach(t),vv=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kv=h(st),Da=n(st,"P",{});var cu=r(Da);Tv=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var Fy=r(Fa);$v=i(Fy,"flax.linen.Module"),Fy.forEach(t),wv=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yv=h(st),Gd=n(st,"P",{});var By=r(Gd);Dv=i(By,"Finally, this model supports inherent JAX features such as:"),By.forEach(t),Fv=h(st),Et=n(st,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var xy=r(Xd);Ba=n(xy,"A",{href:!0,rel:!0});var My=r(Ba);Bv=i(My,"Just-In-Time (JIT) compilation"),My.forEach(t),xy.forEach(t),xv=h($n),Yd=n($n,"LI",{});var Ey=r(Yd);xa=n(Ey,"A",{href:!0,rel:!0});var zy=r(xa);Mv=i(zy,"Automatic Differentiation"),zy.forEach(t),Ey.forEach(t),Ev=h($n),Zd=n($n,"LI",{});var jy=r(Zd);Ma=n(jy,"A",{href:!0,rel:!0});var Cy=r(Ma);zv=i(Cy,"Vectorization"),Cy.forEach(t),jy.forEach(t),jv=h($n),ec=n($n,"LI",{});var qy=r(ec);Ea=n(qy,"A",{href:!0,rel:!0});var Py=r(Ea);Cv=i(Py,"Parallelization"),Py.forEach(t),qy.forEach(t),$n.forEach(t),qv=h(st),_t=n(st,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pv=h(wn),qo=n(wn,"P",{});var Bl=r(qo);Av=i(Bl,"The "),tc=n(Bl,"CODE",{});var Ay=r(tc);Ov=i(Ay,"FlaxDistilBertPreTrainedModel"),Ay.forEach(t),Nv=i(Bl," forward method, overrides the "),oc=n(Bl,"CODE",{});var Oy=r(oc);Lv=i(Oy,"__call__"),Oy.forEach(t),Sv=i(Bl," special method."),Bl.forEach(t),Iv=h(wn),$(Zs.$$.fragment,wn),Wv=h(wn),$(en.$$.fragment,wn),wn.forEach(t),st.forEach(t),dh=h(o),Po=n(o,"H2",{class:!0});var pu=r(Po);tn=n(pu,"A",{id:!0,class:!0,href:!0});var Ny=r(tn);sc=n(Ny,"SPAN",{});var Ly=r(sc);$(ja.$$.fragment,Ly),Ly.forEach(t),Ny.forEach(t),Qv=h(pu),nc=n(pu,"SPAN",{});var Sy=r(nc);Rv=i(Sy,"FlaxDistilBertForSequenceClassification"),Sy.forEach(t),pu.forEach(t),ch=h(o),ze=n(o,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uv=h(nt),rc=n(nt,"P",{});var Iy=r(rc);Hv=i(Iy,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Iy.forEach(t),Vv=h(nt),qa=n(nt,"P",{});var hu=r(qa);Kv=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var Wy=r(ll);Jv=i(Wy,"FlaxPreTrainedModel"),Wy.forEach(t),Gv=i(hu,`. Check the superclass documentation for the generic methods the
