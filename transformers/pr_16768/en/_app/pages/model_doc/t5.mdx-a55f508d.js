...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16768/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),$s=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16768/src/transformers/models/t5/modeling_t5.py#L1312"}}),zs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Ds=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16768/src/transformers/models/t5/modeling_t5.py#L1507"}}),Ss=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16768/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ks=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16768/src/transformers/models/t5/modeling_t5.py#L1809",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16768/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16768/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16768/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
model.parallelize(device_map)`}}),Xs=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16768/src/transformers/models/t5/modeling_t5.py#L1783"}}),Qs=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16768/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16768/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_16768/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16768/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16768/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16768/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16768/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16768/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16768/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
use of token type ids, therefore a list of zeros is returned.`),_1.forEach(n),fp.forEach(n),Lf=l(nt),yr=r(nt,"DIV",{class:!0});var g1=i(yr);_(rs.$$.fragment,g1),g1.forEach(n),nt.forEach(n),Pc=l(t),tn=r(t,"H2",{class:!0});var _p=i(tn);Ln=r(_p,"A",{id:!0,class:!0,href:!0});var T1=i(Ln);vd=r(T1,"SPAN",{});var v1=i(vd);_(is.$$.fragment,v1),v1.forEach(n),T1.forEach(n),Af=l(_p),kd=r(_p,"SPAN",{});var k1=i(kd);If=s(k1,"T5TokenizerFast"),k1.forEach(n),_p.forEach(n),Nc=l(t),Ie=r(t,"DIV",{class:!0});var Ot=i(Ie);_(ds.$$.fragment,Ot),Df=l(Ot),nn=r(Ot,"P",{});var Kr=i(nn);Sf=s(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),bd=r(Kr,"EM",{});var b1=i(bd);Gf=s(b1,"tokenizers"),b1.forEach(n),Uf=s(Kr,` library). Based on
...
adding special tokens. A sequence has the following format:`),x1.forEach(n),Xf=l(Yr),hs=r(Yr,"UL",{});var Tp=i(hs);xr=r(Tp,"LI",{});var Vk=i(xr);Qf=s(Vk,"single sequence: "),wd=r(Vk,"CODE",{});var $1=i(wd);e_=s($1,"X </s>"),$1.forEach(n),Vk.forEach(n),t_=l(Tp),$r=r(Tp,"LI",{});var Kk=i($r);n_=s(Kk,"pair of sequences: "),xd=r(Kk,"CODE",{});var z1=i(xd);o_=s(z1,"A </s> B </s>"),z1.forEach(n),Kk.forEach(n),Tp.forEach(n),Yr.forEach(n),s_=l(Ot),An=r(Ot,"DIV",{class:!0});var vp=i(An);_(us.$$.fragment,vp),a_=l(vp),$d=r(vp,"P",{});var j1=i($d);r_=s(j1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),j1.forEach(n),vp.forEach(n),Ot.forEach(n),Oc=l(t),on=r(t,"H2",{class:!0});var kp=i(on);In=r(kp,"A",{id:!0,class:!0,href:!0});var q1=i(In);zd=r(q1,"SPAN",{});var E1=i(zd);_(ms.$$.fragment,E1),E1.forEach(n),q1.forEach(n),i_=l(kp),jd=r(kp,"SPAN",{});var F1=i(jd);d_=s(F1,"T5Model"),F1.forEach(n),kp.forEach(n),Lc=l(t),J=r(t,"DIV",{class:!0});var we=i(J);_(fs.$$.fragment,we),l_=l(we),qd=r(we,"P",{});var M1=i(qd);c_=s(M1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),M1.forEach(n),p_=l(we),_s=r(we,"P",{});var bp=i(_s);h_=s(bp,"The T5 model was proposed in "),gs=r(bp,"A",{href:!0,rel:!0});var C1=i(gs);u_=s(C1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),C1.forEach(n),m_=s(bp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),bp.forEach(n),f_=l(we),Ts=r(we,"P",{});var yp=i(Ts);__=s(yp,"This model inherits from "),zr=r(yp,"A",{href:!0});var P1=i(zr);g_=s(P1,"PreTrainedModel"),P1.forEach(n),T_=s(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(n),v_=l(we),vs=r(we,"P",{});var wp=i(vs);k_=s(wp,"This model is also a PyTorch "),ks=r(wp,"A",{href:!0,rel:!0});var N1=i(ks);b_=s(N1,"torch.nn.Module"),N1.forEach(n),y_=s(wp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wp.forEach(n),w_=l(we),We=r(we,"DIV",{class:!0});var Lt=i(We);_(bs.$$.fragment,Lt),x_=l(Lt),sn=r(Lt,"P",{});var Zr=i(sn);$_=s(Zr,"The "),jr=r(Zr,"A",{href:!0});var O1=i(jr);z_=s(O1,"T5Model"),O1.forEach(n),j_=s(Zr," forward method, overrides the "),Ed=r(Zr,"CODE",{});var L1=i(Ed);q_=s(L1,"__call__"),L1.forEach(n),E_=s(Zr," special method."),Zr.forEach(n),F_=l(Lt),_(Dn.$$.fragment,Lt),M_=l(Lt),Fd=r(Lt,"P",{});var A1=i(Fd);C_=s(A1,"Example:"),A1.forEach(n),P_=l(Lt),_(ys.$$.fragment,Lt),Lt.forEach(n),N_=l(we),Re=r(we,"DIV",{class:!0});var At=i(Re);_(ws.$$.fragment,At),O_=l(At),Md=r(At,"P",{});var I1=i(Md);L_=s(I1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),I1.forEach(n),A_=l(At),Cd=r(At,"P",{});var D1=i(Cd);I_=s(D1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
