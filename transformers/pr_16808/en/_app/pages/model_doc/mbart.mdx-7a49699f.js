import{S as Cx,i as Ex,s as Px,e as n,k as d,w as u,t as r,M as Sx,c as a,d as t,m as l,a as s,x as m,h as i,b as c,F as e,g as h,y as f,q as _,o as g,B as b,v as Ax}from"../../chunks/vendor-6b77c823.js";import{T as st}from"../../chunks/Tip-39098574.js";import{D as F}from"../../chunks/Docstring-17b815d9.js";import{C as $}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as X}from"../../chunks/IconCopyLink-7a11ce68.js";function Ox(C){let k,z,v,M,x;return{c(){k=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),M=r("Module"),x=r(`
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/configuration_mbart.py#L34"}}),Xn=new $({props:{code:`from transformers import MBartModel, MBartConfig
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/tokenization_mbart_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),_a=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/tokenization_mbart_fast.py#L249"}}),ga=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/tokenization_mbart_fast.py#L264"}}),ba=new X({}),ka=new F({props:{name:"class transformers.MBart50Tokenizer",anchor:"transformers.MBart50Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart50/tokenization_mbart50.py#L48"}}),wa=new $({props:{code:`from transformers import MBart50Tokenizer
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart50/tokenization_mbart50.py#L257",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ca=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart50/tokenization_mbart50.py#L348"}}),Ea=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart50/tokenization_mbart50.py#L354"}}),Pa=new X({}),Sa=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
The token used for masking values. This is the token used when training this model with masked language
modeling. This is the token which the model will try to predict.`,name:"mask_token"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L56"}}),Ia=new $({props:{code:`from transformers import MBart50TokenizerFast
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_mbart.py#L1167",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16808/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_mbart.py#L1301",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_mbart.py#L1570",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_mbart.py#L1443",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_mbart.py#L1722",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_tf_mbart.py#L1158",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_tf_mbart.py#L1266",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_flax_mbart.py#L1203",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_flax_mbart.py#L1027",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_flax_mbart.py#L1090",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_flax_mbart.py#L1203",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_flax_mbart.py#L1357",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_flax_mbart.py#L1203",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/mbart/modeling_flax_mbart.py#L1203",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Pi.forEach(t),wp=l(o),ni=a(o,"P",{});var gw=s(ni);nm=i(gw,"According to the abstract"),gw.forEach(t),Mp=l(o),ai=a(o,"P",{});var bw=s(ai);fd=a(bw,"EM",{});var kw=s(fd);am=i(kw,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),kw.forEach(t),bw.forEach(t),xp=l(o),Yt=a(o,"H3",{class:!0});var mh=s(Yt);So=a(mh,"A",{id:!0,class:!0,href:!0});var yw=s(So);_d=a(yw,"SPAN",{});var vw=s(_d);m(Nn.$$.fragment,vw),vw.forEach(t),yw.forEach(t),sm=l(mh),gd=a(mh,"SPAN",{});var Tw=s(gd);rm=i(Tw,"Training of MBart-50"),Tw.forEach(t),mh.forEach(t),zp=l(o),et=a(o,"P",{});var wn=s(et);im=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
This model inherits from `),_i=a(ou,"A",{href:!0});var s0=s(_i);Yg=i(s0,"PreTrainedModel"),s0.forEach(t),eb=i(ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nu.forEach(t),sb=l(Fn),Oe=a(Fn,"DIV",{class:!0});var St=s(Oe);m(Ka.$$.fragment,St),rb=l(St),po=a(St,"P",{});var Ni=s(po);ib=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var i0=s(gi);db=i(i0,"MBartModel"),i0.forEach(t),lb=i(Ni," forward method, overrides the "),Cl=a(Ni,"CODE",{});var d0=s(Cl);cb=i(d0,"__call__"),d0.forEach(t),pb=i(Ni," special method."),Ni.forEach(t),hb=l(St),m(Yo.$$.fragment,St),ub=l(St),El=a(St,"P",{});var l0=s(El);mb=i(l0,"Example:"),l0.forEach(t),fb=l(St),m(Za.$$.fragment,St),St.forEach(t),Fn.forEach(t),Up=l(o),ho=a(o,"H2",{class:!0});var au=s(ho);en=a(au,"A",{id:!0,class:!0,href:!0});var c0=s(en);Pl=a(c0,"SPAN",{});var p0=s(Pl);m(Ya.$$.fragment,p0),p0.forEach(t),c0.forEach(t),_b=l(au),Sl=a(au,"SPAN",{});var h0=s(Sl);gb=i(h0,"MBartForConditionalGeneration"),h0.forEach(t),au.forEach(t),Rp=l(o),Je=a(o,"DIV",{class:!0});var qn=s(Je);m(es.$$.fragment,qn),bb=l(qn),ts=a(qn,"P",{});var su=s(ts);kb=i(su,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),bi=a(su,"A",{href:!0});var u0=s(bi);yb=i(u0,"PreTrainedModel"),u0.forEach(t),vb=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru.forEach(t),zb=l(qn),Y=a(qn,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Fb=l(Ge),uo=a(Ge,"P",{});var Di=s(uo);qb=i(Di,"The "),ki=a(Di,"A",{href:!0});var f0=s(ki);$b=i(f0,"MBartForConditionalGeneration"),f0.forEach(t),Bb=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var _0=s(Al);jb=i(_0,"__call__"),_0.forEach(t),Cb=i(Di," special method."),Di.forEach(t),Eb=l(Ge),m(tn.$$.fragment,Ge),Pb=l(Ge),Ol=a(Ge,"P",{});var g0=s(Ol);Sb=i(g0,"Translation example:"),g0.forEach(t),Ab=l(Ge),m(ss.$$.fragment,Ge),Ob=l(Ge),Il=a(Ge,"P",{});var b0=s(Il);Ib=i(b0,"Mask filling example:"),b0.forEach(t),Nb=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),qn.forEach(t),Xp=l(o),mo=a(o,"H2",{class:!0});var iu=s(mo);on=a(iu,"A",{id:!0,class:!0,href:!0});var k0=s(on);Nl=a(k0,"SPAN",{});var y0=s(Nl);m(is.$$.fragment,y0),y0.forEach(t),k0.forEach(t),Db=l(iu),Dl=a(iu,"SPAN",{});var v0=s(Dl);Lb=i(v0,"MBartForQuestionAnswering"),v0.forEach(t),iu.forEach(t),Vp=l(o),$e=a(o,"DIV",{class:!0});var At=s($e);m(ds.$$.fragment,At),Gb=l(At),fo=a(At,"P",{});var Li=s(fo);Wb=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var T0=s(Ll);Ub=i(T0,"span start logits"),T0.forEach(t),Rb=i(Li," and "),Gl=a(Li,"CODE",{});var w0=s(Gl);Xb=i(w0,"span end logits"),w0.forEach(t),Vb=i(Li,")."),Li.forEach(t),Qb=l(At),ls=a(At,"P",{});var du=s(ls);Hb=i(du,"This model inherits from "),yi=a(du,"A",{href:!0});var M0=s(yi);Jb=i(M0,"PreTrainedModel"),M0.forEach(t),Kb=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lu.forEach(t),ok=l(At),ue=a(At,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),nk=l(at),_o=a(at,"P",{});var Gi=s(_o);ak=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var z0=s(vi);sk=i(z0,"MBartForQuestionAnswering"),z0.forEach(t),rk=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var F0=s(Wl);ik=i(F0,"__call__"),F0.forEach(t),dk=i(Gi," special method."),Gi.forEach(t),lk=l(at),m(nn.$$.fragment,at),ck=l(at),Ul=a(at,"P",{});var q0=s(Ul);pk=i(q0,"Example:"),q0.forEach(t),hk=l(at),m(us.$$.fragment,at),uk=l(at),m(ms.$$.fragment,at),at.forEach(t),At.forEach(t),Qp=l(o),go=a(o,"H2",{class:!0});var cu=s(go);an=a(cu,"A",{id:!0,class:!0,href:!0});var $0=s(an);Rl=a($0,"SPAN",{});var B0=s(Rl);m(fs.$$.fragment,B0),B0.forEach(t),$0.forEach(t),mk=l(cu),Xl=a(cu,"SPAN",{});var j0=s(Xl);fk=i(j0,"MBartForSequenceClassification"),j0.forEach(t),cu.forEach(t),Hp=l(o),Be=a(o,"DIV",{class:!0});var Ot=s(Be);m(_s.$$.fragment,Ot),_k=l(Ot),Vl=a(Ot,"P",{});var C0=s(Vl);gk=i(C0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),C0.forEach(t),bk=l(Ot),gs=a(Ot,"P",{});var pu=s(gs);kk=i(pu,"This model inherits from "),Ti=a(pu,"A",{href:!0});var E0=s(Ti);yk=i(E0,"PreTrainedModel"),E0.forEach(t),vk=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),zk=l(Ot),L=a(Ot,"DIV",{class:!0});var oe=s(L);m(ys.$$.fragment,oe),Fk=l(oe),bo=a(oe,"P",{});var Wi=s(bo);qk=i(Wi,"The "),wi=a(Wi,"A",{href:!0});var S0=s(wi);$k=i(S0,"MBartForSequenceClassification"),S0.forEach(t),Bk=i(Wi," forward method, overrides the "),Ql=a(Wi,"CODE",{});var A0=s(Ql);jk=i(A0,"__call__"),A0.forEach(t),Ck=i(Wi," special method."),Wi.forEach(t),Ek=l(oe),m(sn.$$.fragment,oe),Pk=l(oe),Hl=a(oe,"P",{});var O0=s(Hl);Sk=i(O0,"Example of single-label classification:"),O0.forEach(t),Ak=l(oe),m(vs.$$.fragment,oe),Ok=l(oe),m(Ts.$$.fragment,oe),Ik=l(oe),Jl=a(oe,"P",{});var I0=s(Jl);Nk=i(I0,"Example of multi-label classification:"),I0.forEach(t),Dk=l(oe),m(ws.$$.fragment,oe),Lk=l(oe),m(Ms.$$.fragment,oe),oe.forEach(t),Ot.forEach(t),Jp=l(o),ko=a(o,"H2",{class:!0});var uu=s(ko);rn=a(uu,"A",{id:!0,class:!0,href:!0});var N0=s(rn);Kl=a(N0,"SPAN",{});var D0=s(Kl);m(xs.$$.fragment,D0),D0.forEach(t),N0.forEach(t),Gk=l(uu),Zl=a(uu,"SPAN",{});var L0=s(Zl);Wk=i(L0,"MBartForCausalLM"),L0.forEach(t),uu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var mu=s(yo);m(zs.$$.fragment,mu),Uk=l(mu),Tt=a(mu,"DIV",{class:!0});var Ui=s(Tt);m(Fs.$$.fragment,Ui),Rk=l(Ui),Yl=a(Ui,"P",{});var G0=s(Yl);Xk=i(G0,"Example:"),G0.forEach(t),Vk=l(Ui),m(qs.$$.fragment,Ui),Ui.forEach(t),mu.forEach(t),Zp=l(o),vo=a(o,"H2",{class:!0});var fu=s(vo);dn=a(fu,"A",{id:!0,class:!0,href:!0});var W0=s(dn);ec=a(W0,"SPAN",{});var U0=s(ec);m($s.$$.fragment,U0),U0.forEach(t),W0.forEach(t),Qk=l(fu),tc=a(fu,"SPAN",{});var R0=s(tc);Hk=i(R0,"TFMBartModel"),R0.forEach(t),fu.forEach(t),Yp=l(o),je=a(o,"DIV",{class:!0});var It=s(je);m(Bs.$$.fragment,It),Jk=l(It),js=a(It,"P",{});var _u=s(js);Kk=i(_u,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Mi=a(_u,"A",{href:!0});var X0=s(Mi);Zk=i(X0,"TFPreTrainedModel"),X0.forEach(t),Yk=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gu.forEach(t),ay=l(It),m(ln.$$.fragment,It),sy=l(It),Ie=a(It,"DIV",{class:!0});var Nt=s(Ie);m(Ps.$$.fragment,Nt),ry=l(Nt),To=a(Nt,"P",{});var Ri=s(To);iy=i(Ri,"The "),xi=a(Ri,"A",{href:!0});var Q0=s(xi);dy=i(Q0,"TFMBartModel"),Q0.forEach(t),ly=i(Ri," forward method, overrides the "),oc=a(Ri,"CODE",{});var H0=s(oc);cy=i(H0,"__call__"),H0.forEach(t),py=i(Ri," special method."),Ri.forEach(t),hy=l(Nt),m(cn.$$.fragment,Nt),uy=l(Nt),nc=a(Nt,"P",{});var J0=s(nc);my=i(J0,"Example:"),J0.forEach(t),fy=l(Nt),m(Ss.$$.fragment,Nt),Nt.forEach(t),It.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var bu=s(wo);pn=a(bu,"A",{id:!0,class:!0,href:!0});var K0=s(pn);ac=a(K0,"SPAN",{});var Z0=s(ac);m(As.$$.fragment,Z0),Z0.forEach(t),K0.forEach(t),_y=l(bu),sc=a(bu,"SPAN",{});var Y0=s(sc);gy=i(Y0,"TFMBartForConditionalGeneration"),Y0.forEach(t),bu.forEach(t),th=l(o),Ce=a(o,"DIV",{class:!0});var Dt=s(Ce);m(Os.$$.fragment,Dt),by=l(Dt),Is=a(Dt,"P",{});var ku=s(Is);ky=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var e2=s(zi);yy=i(e2,"TFPreTrainedModel"),e2.forEach(t),vy=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),Ty=l(Dt),Ns=a(Dt,"P",{});var yu=s(Ns);wy=i(yu,"This model is also a "),Ds=a(yu,"A",{href:!0,rel:!0});var t2=s(Ds);My=i(t2,"tf.keras.Model"),t2.forEach(t),xy=i(yu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yu.forEach(t),zy=l(Dt),m(hn.$$.fragment,Dt),Fy=l(Dt),ee=a(Dt,"DIV",{class:!0});var We=s(ee);m(Ls.$$.fragment,We),qy=l(We),Mo=a(We,"P",{});var Xi=s(Mo);$y=i(Xi,"The "),Fi=a(Xi,"A",{href:!0});var o2=s(Fi);By=i(o2,"TFMBartForConditionalGeneration"),o2.forEach(t),jy=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var n2=s(rc);Cy=i(n2,"__call__"),n2.forEach(t),Ey=i(Xi," special method."),Xi.forEach(t),Py=l(We),m(un.$$.fragment,We),Sy=l(We),ic=a(We,"P",{});var a2=s(ic);Ay=i(a2,"Summarization example:"),a2.forEach(t),Oy=l(We),m(Gs.$$.fragment,We),Iy=l(We),dc=a(We,"P",{});var s2=s(dc);Ny=i(s2,"Mask filling example:"),s2.forEach(t),Dy=l(We),m(Ws.$$.fragment,We),We.forEach(t),Dt.forEach(t),oh=l(o),xo=a(o,"H2",{class:!0});var vu=s(xo);mn=a(vu,"A",{id:!0,class:!0,href:!0});var r2=s(mn);lc=a(r2,"SPAN",{});var i2=s(lc);m(Us.$$.fragment,i2),i2.forEach(t),r2.forEach(t),Ly=l(vu),cc=a(vu,"SPAN",{});var d2=s(cc);Gy=i(d2,"FlaxMBartModel"),d2.forEach(t),vu.forEach(t),nh=l(o),U=a(o,"DIV",{class:!0});var _e=s(U);m(Rs.$$.fragment,_e),Wy=l(_e),Xs=a(_e,"P",{});var Tu=s(Xs);Uy=i(Tu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),qi=a(Tu,"A",{href:!0});var l2=s(qi);Ry=i(l2,"FlaxPreTrainedModel"),l2.forEach(t),Xy=i(Tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wu.forEach(t),Ky=l(_e),pc=a(_e,"P",{});var p2=s(pc);Zy=i(p2,"Finally, this model supports inherent JAX features such as:"),p2.forEach(t),Yy=l(_e),ft=a(_e,"UL",{});var $n=s(ft);hc=a($n,"LI",{});var h2=s(hc);Hs=a(h2,"A",{href:!0,rel:!0});var u2=s(Hs);ev=i(u2,"Just-In-Time (JIT) compilation"),u2.forEach(t),h2.forEach(t),tv=l($n),uc=a($n,"LI",{});var m2=s(uc);Js=a(m2,"A",{href:!0,rel:!0});var f2=s(Js);ov=i(f2,"Automatic Differentiation"),f2.forEach(t),m2.forEach(t),nv=l($n),mc=a($n,"LI",{});var _2=s(mc);Ks=a(_2,"A",{href:!0,rel:!0});var g2=s(Ks);av=i(g2,"Vectorization"),g2.forEach(t),_2.forEach(t),sv=l($n),fc=a($n,"LI",{});var b2=s(fc);Zs=a(b2,"A",{href:!0,rel:!0});var k2=s(Zs);rv=i(k2,"Parallelization"),k2.forEach(t),b2.forEach(t),$n.forEach(t),iv=l(_e),Ne=a(_e,"DIV",{class:!0});var Lt=s(Ne);m(Ys.$$.fragment,Lt),dv=l(Lt),zo=a(Lt,"P",{});var Vi=s(zo);lv=i(Vi,"The "),_c=a(Vi,"CODE",{});var y2=s(_c);cv=i(y2,"FlaxMBartPreTrainedModel"),y2.forEach(t),pv=i(Vi," forward method, overrides the "),gc=a(Vi,"CODE",{});var v2=s(gc);hv=i(v2,"__call__"),v2.forEach(t),uv=i(Vi," special method."),Vi.forEach(t),mv=l(Lt),m(fn.$$.fragment,Lt),fv=l(Lt),bc=a(Lt,"P",{});var T2=s(bc);_v=i(T2,"Example:"),T2.forEach(t),gv=l(Lt),m(er.$$.fragment,Lt),Lt.forEach(t),bv=l(_e),wt=a(_e,"DIV",{class:!0});var Qi=s(wt);m(tr.$$.fragment,Qi),kv=l(Qi),kc=a(Qi,"P",{});var w2=s(kc);yv=i(w2,"Example:"),w2.forEach(t),vv=l(Qi),m(or.$$.fragment,Qi),Qi.forEach(t),Tv=l(_e),Mt=a(_e,"DIV",{class:!0});var Hi=s(Mt);m(nr.$$.fragment,Hi),wv=l(Hi),yc=a(Hi,"P",{});var M2=s(yc);Mv=i(M2,"Example:"),M2.forEach(t),xv=l(Hi),m(ar.$$.fragment,Hi),Hi.forEach(t),_e.forEach(t),ah=l(o),Fo=a(o,"H2",{class:!0});var Mu=s(Fo);_n=a(Mu,"A",{id:!0,class:!0,href:!0});var x2=s(_n);vc=a(x2,"SPAN",{});var z2=s(vc);m(sr.$$.fragment,z2),z2.forEach(t),x2.forEach(t),zv=l(Mu),Tc=a(Mu,"SPAN",{});var F2=s(Tc);Fv=i(F2,"FlaxMBartForConditionalGeneration"),F2.forEach(t),Mu.forEach(t),sh=l(o),R=a(o,"DIV",{class:!0});var ge=s(R);m(rr.$$.fragment,ge),qv=l(ge),ir=a(ge,"P",{});var xu=s(ir);$v=i(xu,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),$i=a(xu,"A",{href:!0});var q2=s($i);Bv=i(q2,"FlaxPreTrainedModel"),q2.forEach(t),jv=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zu.forEach(t),Av=l(ge),wc=a(ge,"P",{});var B2=s(wc);Ov=i(B2,"Finally, this model supports inherent JAX features such as:"),B2.forEach(t),Iv=l(ge),_t=a(ge,"UL",{});var Bn=s(_t);Mc=a(Bn,"LI",{});var j2=s(Mc);cr=a(j2,"A",{href:!0,rel:!0});var C2=s(cr);Nv=i(C2,"Just-In-Time (JIT) compilation"),C2.forEach(t),j2.forEach(t),Dv=l(Bn),xc=a(Bn,"LI",{});var E2=s(xc);pr=a(E2,"A",{href:!0,rel:!0});var P2=s(pr);Lv=i(P2,"Automatic Differentiation"),P2.forEach(t),E2.forEach(t),Gv=l(Bn),zc=a(Bn,"LI",{});var S2=s(zc);hr=a(S2,"A",{href:!0,rel:!0});var A2=s(hr);Wv=i(A2,"Vectorization"),A2.forEach(t),S2.forEach(t),Uv=l(Bn),Fc=a(Bn,"LI",{});var O2=s(Fc);ur=a(O2,"A",{href:!0,rel:!0});var I2=s(ur);Rv=i(I2,"Parallelization"),I2.forEach(t),O2.forEach(t),Bn.forEach(t),Xv=l(ge),te=a(ge,"DIV",{class:!0});var Ue=s(te);m(mr.$$.fragment,Ue),Vv=l(Ue),qo=a(Ue,"P",{});var Ji=s(qo);Qv=i(Ji,"The "),qc=a(Ji,"CODE",{});var N2=s(qc);Hv=i(N2,"FlaxMBartPreTrainedModel"),N2.forEach(t),Jv=i(Ji," forward method, overrides the "),$c=a(Ji,"CODE",{});var D2=s($c);Kv=i(D2,"__call__"),D2.forEach(t),Zv=i(Ji," special method."),Ji.forEach(t),Yv=l(Ue),m(gn.$$.fragment,Ue),eT=l(Ue),Bc=a(Ue,"P",{});var L2=s(Bc);tT=i(L2,"Summarization example:"),L2.forEach(t),oT=l(Ue),m(fr.$$.fragment,Ue),nT=l(Ue),jc=a(Ue,"P",{});var G2=s(jc);aT=i(G2,"Mask filling example:"),G2.forEach(t),sT=l(Ue),m(_r.$$.fragment,Ue),Ue.forEach(t),rT=l(ge),xt=a(ge,"DIV",{class:!0});var Ki=s(xt);m(gr.$$.fragment,Ki),iT=l(Ki),Cc=a(Ki,"P",{});var W2=s(Cc);dT=i(W2,"Example:"),W2.forEach(t),lT=l(Ki),m(br.$$.fragment,Ki),Ki.forEach(t),cT=l(ge),zt=a(ge,"DIV",{class:!0});var Zi=s(zt);m(kr.$$.fragment,Zi),pT=l(Zi),Ec=a(Zi,"P",{});var U2=s(Ec);hT=i(U2,"Example:"),U2.forEach(t),uT=l(Zi),m(yr.$$.fragment,Zi),Zi.forEach(t),ge.forEach(t),rh=l(o),$o=a(o,"H2",{class:!0});var Fu=s($o);bn=a(Fu,"A",{id:!0,class:!0,href:!0});var R2=s(bn);Pc=a(R2,"SPAN",{});var X2=s(Pc);m(vr.$$.fragment,X2),X2.forEach(t),R2.forEach(t),mT=l(Fu),Sc=a(Fu,"SPAN",{});var V2=s(Sc);fT=i(V2,"FlaxMBartForSequenceClassification"),V2.forEach(t),Fu.forEach(t),ih=l(o),O=a(o,"DIV",{class:!0});var ne=s(O);m(Tr.$$.fragment,ne),_T=l(ne),Ac=a(ne,"P",{});var Q2=s(Ac);gT=i(Q2,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Q2.forEach(t),bT=l(ne),wr=a(ne,"P",{});var qu=s(wr);kT=i(qu,"This model inherits from "),Bi=a(qu,"A",{href:!0});var H2=s(Bi);yT=i(H2,"FlaxPreTrainedModel"),H2.forEach(t),vT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
