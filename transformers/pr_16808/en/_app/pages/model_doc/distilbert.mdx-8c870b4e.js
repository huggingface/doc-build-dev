...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_distilbert.py#L525",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16808/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16808/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),ta=new ve({}),sa=new H({props:{name:"class transformers.FlaxDistilBertModel",anchor:"transformers.FlaxDistilBertModel",parameters:[{name:"config",val:": DistilBertConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxDistilBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16808/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16808/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_flax_distilbert.py#L523"}}),ca=new H({props:{name:"__call__",anchor:"transformers.FlaxDistilBertModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxDistilBertModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16808/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16808/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16808/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16808/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_flax_distilbert.py#L446"}}),jo=new ge({props:{$$slots:{default:[HF]},$$scope:{ctx:j}}}),pa=new re({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Pa=new ve({}),Aa=new H({props:{name:"class transformers.FlaxDistilBertForMultipleChoice",anchor:"transformers.FlaxDistilBertForMultipleChoice",parameters:[{name:"config",val:": DistilBertConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxDistilBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16808/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16808/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_flax_distilbert.py#L745"}}),Ua=new H({props:{name:"__call__",anchor:"transformers.FlaxDistilBertForMultipleChoice.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxDistilBertForMultipleChoice.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16808/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16808/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16808/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),oi=new ve({}),ni=new H({props:{name:"class transformers.FlaxDistilBertForQuestionAnswering",anchor:"transformers.FlaxDistilBertForQuestionAnswering",parameters:[{name:"config",val:": DistilBertConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxDistilBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16808/en/model_doc/distilbert#transformers.DistilBertConfig">DistilBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16808/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16808/src/transformers/models/distilbert/modeling_flax_distilbert.py#L881"}}),hi=new H({props:{name:"__call__",anchor:"transformers.FlaxDistilBertForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxDistilBertForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16808/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16808/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16808/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh.forEach(t),ng=d(Kt),st=n(Kt,"DIV",{class:!0});var Jt=r(st);k(Un.$$.fragment,Jt),rg=d(Jt),_s=n(Jt,"P",{});var ll=r(_s);ag=i(ll,"The "),Pi=n(ll,"A",{href:!0});var Zy=r(Pi);ig=i(Zy,"DistilBertForMultipleChoice"),Zy.forEach(t),lg=i(ll," forward method, overrides the "),ed=n(ll,"CODE",{});var e0=r(ed);dg=i(e0,"__call__"),e0.forEach(t),cg=i(ll," special method."),ll.forEach(t),pg=d(Jt),k(io.$$.fragment,Jt),hg=d(Jt),td=n(Jt,"P",{});var t0=r(td);ug=i(t0,"Examples:"),t0.forEach(t),mg=d(Jt),k(Qn.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Op=d(s),bs=n(s,"H2",{class:!0});var zh=r(bs);lo=n(zh,"A",{id:!0,class:!0,href:!0});var s0=r(lo);sd=n(s0,"SPAN",{});var o0=r(sd);k(Hn.$$.fragment,o0),o0.forEach(t),s0.forEach(t),fg=d(zh),od=n(zh,"SPAN",{});var n0=r(od);gg=i(n0,"DistilBertForTokenClassification"),n0.forEach(t),zh.forEach(t),Np=d(s),Ze=n(s,"DIV",{class:!0});var Gt=r(Ze);k(Vn.$$.fragment,Gt),_g=d(Gt),nd=n(Gt,"P",{});var r0=r(nd);bg=i(r0,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),r0.forEach(t),vg=d(Gt),Kn=n(Gt,"P",{});var jh=r(Kn);kg=i(jh,"This model inherits from "),Ai=n(jh,"A",{href:!0});var a0=r(Ai);Tg=i(a0,"PreTrainedModel"),a0.forEach(t),wg=i(jh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jh.forEach(t),yg=d(Gt),Jn=n(Gt,"P",{});var Ch=r(Jn);$g=i(Ch,"This model is also a PyTorch "),Gn=n(Ch,"A",{href:!0,rel:!0});var i0=r(Gn);Fg=i(i0,"torch.nn.Module"),i0.forEach(t),Dg=i(Ch,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ch.forEach(t),Bg=d(Gt),We=n(Gt,"DIV",{class:!0});var Tt=r(We);k(Xn.$$.fragment,Tt),Mg=d(Tt),vs=n(Tt,"P",{});var dl=r(vs);Eg=i(dl,"The "),Oi=n(dl,"A",{href:!0});var l0=r(Oi);xg=i(l0,"DistilBertForTokenClassification"),l0.forEach(t),zg=i(dl," forward method, overrides the "),rd=n(dl,"CODE",{});var d0=r(rd);jg=i(d0,"__call__"),d0.forEach(t),Cg=i(dl," special method."),dl.forEach(t),qg=d(Tt),k(co.$$.fragment,Tt),Pg=d(Tt),ad=n(Tt,"P",{});var c0=r(ad);Ag=i(c0,"Example:"),c0.forEach(t),Og=d(Tt),k(Yn.$$.fragment,Tt),Ng=d(Tt),k(Zn.$$.fragment,Tt),Tt.forEach(t),Gt.forEach(t),Lp=d(s),ks=n(s,"H2",{class:!0});var qh=r(ks);po=n(qh,"A",{id:!0,class:!0,href:!0});var p0=r(po);id=n(p0,"SPAN",{});var h0=r(id);k(er.$$.fragment,h0),h0.forEach(t),p0.forEach(t),Lg=d(qh),ld=n(qh,"SPAN",{});var u0=r(ld);Sg=i(u0,"DistilBertForQuestionAnswering"),u0.forEach(t),qh.forEach(t),Sp=d(s),et=n(s,"DIV",{class:!0});var Xt=r(et);k(tr.$$.fragment,Xt),Ig=d(Xt),Ts=n(Xt,"P",{});var cl=r(Ts);Wg=i(cl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),dd=n(cl,"CODE",{});var m0=r(dd);Rg=i(m0,"span start logits"),m0.forEach(t),Ug=i(cl," and "),cd=n(cl,"CODE",{});var f0=r(cd);Qg=i(f0,"span end logits"),f0.forEach(t),Hg=i(cl,")."),cl.forEach(t),Vg=d(Xt),sr=n(Xt,"P",{});var Ph=r(sr);Kg=i(Ph,"This model inherits from "),Ni=n(Ph,"A",{href:!0});var g0=r(Ni);Jg=i(g0,"PreTrainedModel"),g0.forEach(t),Gg=i(Ph,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ph.forEach(t),Xg=d(Xt),or=n(Xt,"P",{});var Ah=r(or);Yg=i(Ah,"This model is also a PyTorch "),nr=n(Ah,"A",{href:!0,rel:!0});var _0=r(nr);Zg=i(_0,"torch.nn.Module"),_0.forEach(t),e_=i(Ah,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ah.forEach(t),t_=d(Xt),Re=n(Xt,"DIV",{class:!0});var wt=r(Re);k(rr.$$.fragment,wt),s_=d(wt),ws=n(wt,"P",{});var pl=r(ws);o_=i(pl,"The "),Li=n(pl,"A",{href:!0});var b0=r(Li);n_=i(b0,"DistilBertForQuestionAnswering"),b0.forEach(t),r_=i(pl," forward method, overrides the "),pd=n(pl,"CODE",{});var v0=r(pd);a_=i(v0,"__call__"),v0.forEach(t),i_=i(pl," special method."),pl.forEach(t),l_=d(wt),k(ho.$$.fragment,wt),d_=d(wt),hd=n(wt,"P",{});var k0=r(hd);c_=i(k0,"Example:"),k0.forEach(t),p_=d(wt),k(ar.$$.fragment,wt),h_=d(wt),k(ir.$$.fragment,wt),wt.forEach(t),Xt.forEach(t),Ip=d(s),ys=n(s,"H2",{class:!0});var Oh=r(ys);uo=n(Oh,"A",{id:!0,class:!0,href:!0});var T0=r(uo);ud=n(T0,"SPAN",{});var w0=r(ud);k(lr.$$.fragment,w0),w0.forEach(t),T0.forEach(t),u_=d(Oh),md=n(Oh,"SPAN",{});var y0=r(md);m_=i(y0,"TFDistilBertModel"),y0.forEach(t),Oh.forEach(t),Wp=d(s),Pe=n(s,"DIV",{class:!0});var yt=r(Pe);k(dr.$$.fragment,yt),f_=d(yt),fd=n(yt,"P",{});var $0=r(fd);g_=i($0,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),$0.forEach(t),__=d(yt),cr=n(yt,"P",{});var Nh=r(cr);b_=i(Nh,"This model inherits from "),Si=n(Nh,"A",{href:!0});var F0=r(Si);v_=i(F0,"TFPreTrainedModel"),F0.forEach(t),k_=i(Nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nh.forEach(t),T_=d(yt),pr=n(yt,"P",{});var Lh=r(pr);w_=i(Lh,"This model is also a "),hr=n(Lh,"A",{href:!0,rel:!0});var D0=r(hr);y_=i(D0,"tf.keras.Model"),D0.forEach(t),$_=i(Lh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Lh.forEach(t),F_=d(yt),k(mo.$$.fragment,yt),D_=d(yt),ot=n(yt,"DIV",{class:!0});var Yt=r(ot);k(ur.$$.fragment,Yt),B_=d(Yt),$s=n(Yt,"P",{});var hl=r($s);M_=i(hl,"The "),Ii=n(hl,"A",{href:!0});var B0=r(Ii);E_=i(B0,"TFDistilBertModel"),B0.forEach(t),x_=i(hl," forward method, overrides the "),gd=n(hl,"CODE",{});var M0=r(gd);z_=i(M0,"__call__"),M0.forEach(t),j_=i(hl," special method."),hl.forEach(t),C_=d(Yt),k(fo.$$.fragment,Yt),q_=d(Yt),_d=n(Yt,"P",{});var E0=r(_d);P_=i(E0,"Example:"),E0.forEach(t),A_=d(Yt),k(mr.$$.fragment,Yt),Yt.forEach(t),yt.forEach(t),Rp=d(s),Fs=n(s,"H2",{class:!0});var Sh=r(Fs);go=n(Sh,"A",{id:!0,class:!0,href:!0});var x0=r(go);bd=n(x0,"SPAN",{});var z0=r(bd);k(fr.$$.fragment,z0),z0.forEach(t),x0.forEach(t),O_=d(Sh),vd=n(Sh,"SPAN",{});var j0=r(vd);N_=i(j0,"TFDistilBertForMaskedLM"),j0.forEach(t),Sh.forEach(t),Up=d(s),Ae=n(s,"DIV",{class:!0});var $t=r(Ae);k(gr.$$.fragment,$t),L_=d($t),_r=n($t,"P",{});var Ih=r(_r);S_=i(Ih,"DistilBert Model with a "),kd=n(Ih,"CODE",{});var C0=r(kd);I_=i(C0,"masked language modeling"),C0.forEach(t),W_=i(Ih," head on top."),Ih.forEach(t),R_=d($t),br=n($t,"P",{});var Wh=r(br);U_=i(Wh,"This model inherits from "),Wi=n(Wh,"A",{href:!0});var q0=r(Wi);Q_=i(q0,"TFPreTrainedModel"),q0.forEach(t),H_=i(Wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wh.forEach(t),V_=d($t),vr=n($t,"P",{});var Rh=r(vr);K_=i(Rh,"This model is also a "),kr=n(Rh,"A",{href:!0,rel:!0});var P0=r(kr);J_=i(P0,"tf.keras.Model"),P0.forEach(t),G_=i(Rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),X_=d($t),k(_o.$$.fragment,$t),Y_=d($t),Ue=n($t,"DIV",{class:!0});var Ft=r(Ue);k(Tr.$$.fragment,Ft),Z_=d(Ft),Ds=n(Ft,"P",{});var ul=r(Ds);eb=i(ul,"The "),Ri=n(ul,"A",{href:!0});var A0=r(Ri);tb=i(A0,"TFDistilBertForMaskedLM"),A0.forEach(t),sb=i(ul," forward method, overrides the "),Td=n(ul,"CODE",{});var O0=r(Td);ob=i(O0,"__call__"),O0.forEach(t),nb=i(ul," special method."),ul.forEach(t),rb=d(Ft),k(bo.$$.fragment,Ft),ab=d(Ft),wd=n(Ft,"P",{});var N0=r(wd);ib=i(N0,"Example:"),N0.forEach(t),lb=d(Ft),k(wr.$$.fragment,Ft),db=d(Ft),k(yr.$$.fragment,Ft),Ft.forEach(t),$t.forEach(t),Qp=d(s),Bs=n(s,"H2",{class:!0});var Uh=r(Bs);vo=n(Uh,"A",{id:!0,class:!0,href:!0});var L0=r(vo);yd=n(L0,"SPAN",{});var S0=r(yd);k($r.$$.fragment,S0),S0.forEach(t),L0.forEach(t),cb=d(Uh),$d=n(Uh,"SPAN",{});var I0=r($d);pb=i(I0,"TFDistilBertForSequenceClassification"),I0.forEach(t),Uh.forEach(t),Hp=d(s),Oe=n(s,"DIV",{class:!0});var Dt=r(Oe);k(Fr.$$.fragment,Dt),hb=d(Dt),Fd=n(Dt,"P",{});var W0=r(Fd);ub=i(W0,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),W0.forEach(t),mb=d(Dt),Dr=n(Dt,"P",{});var Qh=r(Dr);fb=i(Qh,"This model inherits from "),Ui=n(Qh,"A",{href:!0});var R0=r(Ui);gb=i(R0,"TFPreTrainedModel"),R0.forEach(t),_b=i(Qh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qh.forEach(t),bb=d(Dt),Br=n(Dt,"P",{});var Hh=r(Br);vb=i(Hh,"This model is also a "),Mr=n(Hh,"A",{href:!0,rel:!0});var U0=r(Mr);kb=i(U0,"tf.keras.Model"),U0.forEach(t),Tb=i(Hh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hh.forEach(t),wb=d(Dt),k(ko.$$.fragment,Dt),yb=d(Dt),Qe=n(Dt,"DIV",{class:!0});var Bt=r(Qe);k(Er.$$.fragment,Bt),$b=d(Bt),Ms=n(Bt,"P",{});var ml=r(Ms);Fb=i(ml,"The "),Qi=n(ml,"A",{href:!0});var Q0=r(Qi);Db=i(Q0,"TFDistilBertForSequenceClassification"),Q0.forEach(t),Bb=i(ml," forward method, overrides the "),Dd=n(ml,"CODE",{});var H0=r(Dd);Mb=i(H0,"__call__"),H0.forEach(t),Eb=i(ml," special method."),ml.forEach(t),xb=d(Bt),k(To.$$.fragment,Bt),zb=d(Bt),Bd=n(Bt,"P",{});var V0=r(Bd);jb=i(V0,"Example:"),V0.forEach(t),Cb=d(Bt),k(xr.$$.fragment,Bt),qb=d(Bt),k(zr.$$.fragment,Bt),Bt.forEach(t),Dt.forEach(t),Vp=d(s),Es=n(s,"H2",{class:!0});var Vh=r(Es);wo=n(Vh,"A",{id:!0,class:!0,href:!0});var K0=r(wo);Md=n(K0,"SPAN",{});var J0=r(Md);k(jr.$$.fragment,J0),J0.forEach(t),K0.forEach(t),Pb=d(Vh),Ed=n(Vh,"SPAN",{});var G0=r(Ed);Ab=i(G0,"TFDistilBertForMultipleChoice"),G0.forEach(t),Vh.forEach(t),Kp=d(s),Ne=n(s,"DIV",{class:!0});var Mt=r(Ne);k(Cr.$$.fragment,Mt),Ob=d(Mt),xd=n(Mt,"P",{});var X0=r(xd);Nb=i(X0,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),X0.forEach(t),Lb=d(Mt),qr=n(Mt,"P",{});var Kh=r(qr);Sb=i(Kh,"This model inherits from "),Hi=n(Kh,"A",{href:!0});var Y0=r(Hi);Ib=i(Y0,"TFPreTrainedModel"),Y0.forEach(t),Wb=i(Kh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kh.forEach(t),Rb=d(Mt),Pr=n(Mt,"P",{});var Jh=r(Pr);Ub=i(Jh,"This model is also a "),Ar=n(Jh,"A",{href:!0,rel:!0});var Z0=r(Ar);Qb=i(Z0,"tf.keras.Model"),Z0.forEach(t),Hb=i(Jh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jh.forEach(t),Vb=d(Mt),k(yo.$$.fragment,Mt),Kb=d(Mt),nt=n(Mt,"DIV",{class:!0});var Zt=r(nt);k(Or.$$.fragment,Zt),Jb=d(Zt),xs=n(Zt,"P",{});var fl=r(xs);Gb=i(fl,"The "),Vi=n(fl,"A",{href:!0});var e2=r(Vi);Xb=i(e2,"TFDistilBertForMultipleChoice"),e2.forEach(t),Yb=i(fl," forward method, overrides the "),zd=n(fl,"CODE",{});var t2=r(zd);Zb=i(t2,"__call__"),t2.forEach(t),ev=i(fl," special method."),fl.forEach(t),tv=d(Zt),k($o.$$.fragment,Zt),sv=d(Zt),jd=n(Zt,"P",{});var s2=r(jd);ov=i(s2,"Example:"),s2.forEach(t),nv=d(Zt),k(Nr.$$.fragment,Zt),Zt.forEach(t),Mt.forEach(t),Jp=d(s),zs=n(s,"H2",{class:!0});var Gh=r(zs);Fo=n(Gh,"A",{id:!0,class:!0,href:!0});var o2=r(Fo);Cd=n(o2,"SPAN",{});var n2=r(Cd);k(Lr.$$.fragment,n2),n2.forEach(t),o2.forEach(t),rv=d(Gh),qd=n(Gh,"SPAN",{});var r2=r(qd);av=i(r2,"TFDistilBertForTokenClassification"),r2.forEach(t),Gh.forEach(t),Gp=d(s),Le=n(s,"DIV",{class:!0});var Et=r(Le);k(Sr.$$.fragment,Et),iv=d(Et),Pd=n(Et,"P",{});var a2=r(Pd);lv=i(a2,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),a2.forEach(t),dv=d(Et),Ir=n(Et,"P",{});var Xh=r(Ir);cv=i(Xh,"This model inherits from "),Ki=n(Xh,"A",{href:!0});var i2=r(Ki);pv=i(i2,"TFPreTrainedModel"),i2.forEach(t),hv=i(Xh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xh.forEach(t),uv=d(Et),Wr=n(Et,"P",{});var Yh=r(Wr);mv=i(Yh,"This model is also a "),Rr=n(Yh,"A",{href:!0,rel:!0});var l2=r(Rr);fv=i(l2,"tf.keras.Model"),l2.forEach(t),gv=i(Yh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yh.forEach(t),_v=d(Et),k(Do.$$.fragment,Et),bv=d(Et),He=n(Et,"DIV",{class:!0});var xt=r(He);k(Ur.$$.fragment,xt),vv=d(xt),js=n(xt,"P",{});var gl=r(js);kv=i(gl,"The "),Ji=n(gl,"A",{href:!0});var d2=r(Ji);Tv=i(d2,"TFDistilBertForTokenClassification"),d2.forEach(t),wv=i(gl," forward method, overrides the "),Ad=n(gl,"CODE",{});var c2=r(Ad);yv=i(c2,"__call__"),c2.forEach(t),$v=i(gl," special method."),gl.forEach(t),Fv=d(xt),k(Bo.$$.fragment,xt),Dv=d(xt),Od=n(xt,"P",{});var p2=r(Od);Bv=i(p2,"Example:"),p2.forEach(t),Mv=d(xt),k(Qr.$$.fragment,xt),Ev=d(xt),k(Hr.$$.fragment,xt),xt.forEach(t),Et.forEach(t),Xp=d(s),Cs=n(s,"H2",{class:!0});var Zh=r(Cs);Mo=n(Zh,"A",{id:!0,class:!0,href:!0});var h2=r(Mo);Nd=n(h2,"SPAN",{});var u2=r(Nd);k(Vr.$$.fragment,u2),u2.forEach(t),h2.forEach(t),xv=d(Zh),Ld=n(Zh,"SPAN",{});var m2=r(Ld);zv=i(m2,"TFDistilBertForQuestionAnswering"),m2.forEach(t),Zh.forEach(t),Yp=d(s),Se=n(s,"DIV",{class:!0});var zt=r(Se);k(Kr.$$.fragment,zt),jv=d(zt),qs=n(zt,"P",{});var _l=r(qs);Cv=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Sd=n(_l,"CODE",{});var f2=r(Sd);qv=i(f2,"span start logits"),f2.forEach(t),Pv=i(_l," and "),Id=n(_l,"CODE",{});var g2=r(Id);Av=i(g2,"span end logits"),g2.forEach(t),Ov=i(_l,")."),_l.forEach(t),Nv=d(zt),Jr=n(zt,"P",{});var eu=r(Jr);Lv=i(eu,"This model inherits from "),Gi=n(eu,"A",{href:!0});var _2=r(Gi);Sv=i(_2,"TFPreTrainedModel"),_2.forEach(t),Iv=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),Wv=d(zt),Gr=n(zt,"P",{});var tu=r(Gr);Rv=i(tu,"This model is also a "),Xr=n(tu,"A",{href:!0,rel:!0});var b2=r(Xr);Uv=i(b2,"tf.keras.Model"),b2.forEach(t),Qv=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Hv=d(zt),k(Eo.$$.fragment,zt),Vv=d(zt),Ve=n(zt,"DIV",{class:!0});var jt=r(Ve);k(Yr.$$.fragment,jt),Kv=d(jt),Ps=n(jt,"P",{});var bl=r(Ps);Jv=i(bl,"The "),Xi=n(bl,"A",{href:!0});var v2=r(Xi);Gv=i(v2,"TFDistilBertForQuestionAnswering"),v2.forEach(t),Xv=i(bl," forward method, overrides the "),Wd=n(bl,"CODE",{});var k2=r(Wd);Yv=i(k2,"__call__"),k2.forEach(t),Zv=i(bl," special method."),bl.forEach(t),ek=d(jt),k(xo.$$.fragment,jt),tk=d(jt),Rd=n(jt,"P",{});var T2=r(Rd);sk=i(T2,"Example:"),T2.forEach(t),ok=d(jt),k(Zr.$$.fragment,jt),nk=d(jt),k(ea.$$.fragment,jt),jt.forEach(t),zt.forEach(t),Zp=d(s),As=n(s,"H2",{class:!0});var su=r(As);zo=n(su,"A",{id:!0,class:!0,href:!0});var w2=r(zo);Ud=n(w2,"SPAN",{});var y2=r(Ud);k(ta.$$.fragment,y2),y2.forEach(t),w2.forEach(t),rk=d(su),Qd=n(su,"SPAN",{});var $2=r(Qd);ak=i($2,"FlaxDistilBertModel"),$2.forEach(t),su.forEach(t),eh=d(s),Me=n(s,"DIV",{class:!0});var pt=r(Me);k(sa.$$.fragment,pt),ik=d(pt),Hd=n(pt,"P",{});var F2=r(Hd);lk=i(F2,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),F2.forEach(t),dk=d(pt),oa=n(pt,"P",{});var ou=r(oa);ck=i(ou,"This model inherits from "),Yi=n(ou,"A",{href:!0});var D2=r(Yi);pk=i(D2,"FlaxPreTrainedModel"),D2.forEach(t),hk=i(ou,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),nu.forEach(t),_k=d(pt),Vd=n(pt,"P",{});var M2=r(Vd);bk=i(M2,"Finally, this model supports inherent JAX features such as:"),M2.forEach(t),vk=d(pt),qt=n(pt,"UL",{});var Ho=r(qt);Kd=n(Ho,"LI",{});var E2=r(Kd);aa=n(E2,"A",{href:!0,rel:!0});var x2=r(aa);kk=i(x2,"Just-In-Time (JIT) compilation"),x2.forEach(t),E2.forEach(t),Tk=d(Ho),Jd=n(Ho,"LI",{});var z2=r(Jd);ia=n(z2,"A",{href:!0,rel:!0});var j2=r(ia);wk=i(j2,"Automatic Differentiation"),j2.forEach(t),z2.forEach(t),yk=d(Ho),Gd=n(Ho,"LI",{});var C2=r(Gd);la=n(C2,"A",{href:!0,rel:!0});var q2=r(la);$k=i(q2,"Vectorization"),q2.forEach(t),C2.forEach(t),Fk=d(Ho),Xd=n(Ho,"LI",{});var P2=r(Xd);da=n(P2,"A",{href:!0,rel:!0});var A2=r(da);Dk=i(A2,"Parallelization"),A2.forEach(t),P2.forEach(t),Ho.forEach(t),Bk=d(pt),rt=n(pt,"DIV",{class:!0});var es=r(rt);k(ca.$$.fragment,es),Mk=d(es),Os=n(es,"P",{});var vl=r(Os);Ek=i(vl,"The "),Yd=n(vl,"CODE",{});var O2=r(Yd);xk=i(O2,"FlaxDistilBertPreTrainedModel"),O2.forEach(t),zk=i(vl," forward method, overrides the "),Zd=n(vl,"CODE",{});var N2=r(Zd);jk=i(N2,"__call__"),N2.forEach(t),Ck=i(vl," special method."),vl.forEach(t),qk=d(es),k(jo.$$.fragment,es),Pk=d(es),ec=n(es,"P",{});var L2=r(ec);Ak=i(L2,"Example:"),L2.forEach(t),Ok=d(es),k(pa.$$.fragment,es),es.forEach(t),pt.forEach(t),th=d(s),Ns=n(s,"H2",{class:!0});var ru=r(Ns);Co=n(ru,"A",{id:!0,class:!0,href:!0});var S2=r(Co);tc=n(S2,"SPAN",{});var I2=r(tc);k(ha.$$.fragment,I2),I2.forEach(t),S2.forEach(t),Nk=d(ru),sc=n(ru,"SPAN",{});var W2=r(sc);Lk=i(W2,"FlaxDistilBertForMaskedLM"),W2.forEach(t),ru.forEach(t),sh=d(s),Ee=n(s,"DIV",{class:!0});var ht=r(Ee);k(ua.$$.fragment,ht),Sk=d(ht),ma=n(ht,"P",{});var au=r(ma);Ik=i(au,"DistilBert Model with a "),oc=n(au,"CODE",{});var R2=r(oc);Wk=i(R2,"language modeling"),R2.forEach(t),Rk=i(au," head on top."),au.forEach(t),Uk=d(ht),fa=n(ht,"P",{});var iu=r(fa);Qk=i(iu,"This model inherits from "),Zi=n(iu,"A",{href:!0});var U2=r(Zi);Hk=i(U2,"FlaxPreTrainedModel"),U2.forEach(t),Vk=i(iu,`. Check the superclass documentation for the generic methods the
