import{S as Nr,i as Or,s as Br,e as n,k as d,w as _,t as r,M as Wr,c as s,d as t,m as c,a,x,h as i,b as l,F as e,g as h,y as v,q as T,o as b,B as E,v as Rr}from"../../chunks/vendor-6b77c823.js";import{T as Sr}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-17b815d9.js";import{C as wa}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as $t}from"../../chunks/IconCopyLink-7a11ce68.js";function Ur(et){let m,q,g,$,A;return{c(){m=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),$=r("Module"),A=r(`
...
Dictionary of keyword arguments.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_15529/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L28"}}),_e=new wa({props:{code:`from transformers import ViTConfig, BertConfig, VisionTextDualEncoderConfig, VisionTextDualEncoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = VisionTextDualEncoderModel.from_pretrained(<span class="hljs-string">&quot;vit-bert&quot;</span>, config=vision_text_config)`}}),xe=new U({props:{name:"from_vision_text_configs",anchor:"transformers.VisionTextDualEncoderConfig.from_vision_text_configs",parameters:[{name:"vision_config",val:": PretrainedConfig"},{name:"text_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15529/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L105",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/pr_15529/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig"
>VisionTextDualEncoderConfig</a></p>
`}}),Te=new U({props:{name:"to_dict",anchor:"transformers.VisionTextDualEncoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15529/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L117",returnDescription:`
...
The feature extractor is a required input.`,name:"feature_extractor"},{anchor:"transformers.VisionTextDualEncoderProcessor.tokenizer",description:`<strong>tokenizer</strong> (<a href="/docs/transformers/pr_15529/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/pr_15529/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L23"}}),je=new U({props:{name:"batch_decode",anchor:"transformers.VisionTextDualEncoderProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15529/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L98"}}),Ve=new U({props:{name:"decode",anchor:"transformers.VisionTextDualEncoderProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15529/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L105"}}),De=new $t({}),$e=new U({props:{name:"class transformers.VisionTextDualEncoderModel",anchor:"transformers.VisionTextDualEncoderModel",parameters:[{name:"config",val:": typing.Optional[transformers.models.vision_text_dual_encoder.configuration_vision_text_dual_encoder.VisionTextDualEncoderConfig] = None"},{name:"vision_model",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"text_model",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15529/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15529/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_15529/src/transformers/models/vision_text_dual_encoder/modeling_vision_text_dual_encoder.py#L162"}}),Ae=new U({props:{name:"forward",anchor:"transformers.VisionTextDualEncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"return_loss",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15529/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/pr_15529/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
a feature extractor (e.g. if you use ViT as the encoder, you should use <a href="/docs/transformers/pr_15529/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>). See
<a href="/docs/transformers/pr_15529/en/model_doc/vit#transformers.ViTFeatureExtractor.__call__">ViTFeatureExtractor.<strong>call</strong>()</a> for details.`,name:"pixel_values"},{anchor:"transformers.VisionTextDualEncoderModel.forward.return_loss",description:`<strong>return_loss</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_15529/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_15529/src/transformers/models/vision_text_dual_encoder/modeling_vision_text_dual_encoder.py#L294",returnDescription:`
...
<li><strong>text_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_15529/en/model_doc/clip#transformers.CLIPTextModel"
>CLIPTextModel</a>.</li>
<li><strong>image_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The image embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/pr_15529/en/model_doc/clip#transformers.CLIPVisionModel"
...
<a
  href="/docs/transformers/pr_15529/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
<a
  href="/docs/transformers/pr_15529/en/model_doc/clip#transformers.FlaxCLIPVisionModel"
...
documentation from `),pt=n("a"),bn=r("PretrainedConfig"),En=r(" for more information."),yn=d(),At=n("p"),jn=r("Examples:"),wn=d(),_(_e.$$.fragment),Vn=d(),ne=n("div"),_(xe.$$.fragment),kn=d(),ve=n("p"),Dn=r("Instantiate a "),mt=n("a"),$n=r("VisionTextDualEncoderConfig"),Pn=r(` (or a derived class) from text model configuration and vision
...
`),xt=n("a"),es=r("batch_decode()"),ts=r(". Please refer to the docstring of this method for more information."),os=d(),ie=n("div"),_(Ve.$$.fragment),ns=d(),ke=n("p"),ss=r("This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),vt=n("a"),as=r("decode()"),rs=r(`.
...
on new zero-shot vision tasks such as image classification or retrieval.`),_s=d(),Wt=n("p"),xs=r(`After such a Vision-Text-Dual-Encoder model has been trained/fine-tuned, it can be saved/loaded just like any other
models (see the examples for more information).`),vs=d(),Ce=n("p"),Ts=r("This model inherits from "),bt=n("a"),bs=r("PreTrainedModel"),Es=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),sa=d(),Gt=n("p"),aa=r("Finally, this model supports inherent JAX features such as:"),ra=d(),S=n("ul"),Xt=n("li"),Je=n("a"),ia=r("Just-In-Time (JIT) compilation"),la=d(),Kt=n("li"),He=n("a"),da=r("Automatic Differentiation"),ca=d(),Qt=n("li"),Ze=n("a"),pa=r("Vectorization"),ma=d(),Yt=n("li"),Ge=n("a"),ha=r("Parallelization"),fa=d(),C=n("div"),_(Xe.$$.fragment),ua=d(),Y=n("p"),ga=r("The "),wt=n("a"),_a=r("FlaxVisionTextDualEncoderModel"),xa=r(" forward method, overrides the "),eo=n("code"),va=r("__call__"),Ta=r(" special method."),ba=d(),_(pe.$$.fragment),Ea=d(),to=n("p"),ya=r("Examples:"),ja=d(),_(Ke.$$.fragment),this.h()},l(o){const p=Wr('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(t),q=c(o),g=s(o,"H1",{class:!0});var Qe=a(g);$=s(Qe,"A",{id:!0,class:!0,href:!0});var oo=a($);A=s(oo,"SPAN",{});var Va=a(A);x(y.$$.fragment,Va),Va.forEach(t),oo.forEach(t),D=c(Qe),L=s(Qe,"SPAN",{});var ka=a(L);Lo=i(ka,"VisionTextDualEncoder"),ka.forEach(t),Qe.forEach(t),no=c(o),J=s(o,"H2",{class:!0});var go=a(J);ee=s(go,"A",{id:!0,class:!0,href:!0});var Da=a(ee);Pt=s(Da,"SPAN",{});var $a=a(Pt);x(he.$$.fragment,$a),$a.forEach(t),Da.forEach(t),So=c(go),Mt=s(go,"SPAN",{});var Pa=a(Mt);No=i(Pa,"Overview"),Pa.forEach(t),go.forEach(t),so=c(o),u=s(o,"P",{});var V=a(u);Oo=i(V,"The "),tt=s(V,"A",{href:!0});var Ma=a(tt);Bo=i(Ma,"VisionTextDualEncoderModel"),Ma.forEach(t),Wo=i(V,` can be used to initialize a vision-text dual encoder model with
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment on
new zero-shot vision tasks such as image classification or retrieval.`),_o.forEach(t),ro=c(o),H=s(o,"H2",{class:!0});var xo=a(H);oe=s(xo,"A",{id:!0,class:!0,href:!0});var Na=a(oe);Ft=s(Na,"SPAN",{});var Oa=a(Ft);x(ue.$$.fragment,Oa),Oa.forEach(t),Na.forEach(t),ln=c(xo),It=s(xo,"SPAN",{});var Ba=a(It);dn=i(Ba,"VisionTextDualEncoderConfig"),Ba.forEach(t),xo.forEach(t),io=c(o),j=s(o,"DIV",{class:!0});var F=a(j);x(ge.$$.fragment,F),cn=c(F),O=s(F,"P",{});var Ye=a(O);it=s(Ye,"A",{href:!0});var Wa=a(it);pn=i(Wa,"VisionTextDualEncoderConfig"),Wa.forEach(t),mn=i(Ye,` is the configuration class to store the configuration of a
...
specified arguments, defining the text model and vision model configs.`),Ye.forEach(t),_n=c(F),Z=s(F,"P",{});var Vt=a(Z);xn=i(Vt,"Configuration objects inherit from "),ct=s(Vt,"A",{href:!0});var Ja=a(ct);vn=i(Ja,"PretrainedConfig"),Ja.forEach(t),Tn=i(Vt,` and can be used to control the model outputs. Read the
documentation from `),pt=s(Vt,"A",{href:!0});var Ha=a(pt);bn=i(Ha,"PretrainedConfig"),Ha.forEach(t),En=i(Vt," for more information."),Vt.forEach(t),yn=c(F),At=s(F,"P",{});var Za=a(At);jn=i(Za,"Examples:"),Za.forEach(t),wn=c(F),x(_e.$$.fragment,F),Vn=c(F),ne=s(F,"DIV",{class:!0});var vo=a(ne);x(xe.$$.fragment,vo),kn=c(vo),ve=s(vo,"P",{});var To=a(ve);Dn=i(To,"Instantiate a "),mt=s(To,"A",{href:!0});var Ga=a(mt);$n=i(Ga,"VisionTextDualEncoderConfig"),Ga.forEach(t),Pn=i(To,` (or a derived class) from text model configuration and vision
model configuration.`),To.forEach(t),vo.forEach(t),Mn=c(F),se=s(F,"DIV",{class:!0});var bo=a(se);x(Te.$$.fragment,bo),zn=c(bo),be=s(bo,"P",{});var Eo=a(be);Cn=i(Eo,"Serializes this instance to a Python dictionary. Override the default "),ht=s(Eo,"A",{href:!0});var Xa=a(ht);Fn=i(Xa,"to_dict()"),Xa.forEach(t),In=i(Eo,"."),Eo.forEach(t),bo.forEach(t),F.forEach(t),lo=c(o),G=s(o,"H2",{class:!0});var yo=a(G);ae=s(yo,"A",{id:!0,class:!0,href:!0});var Ka=a(ae);qt=s(Ka,"SPAN",{});var Qa=a(qt);x(Ee.$$.fragment,Qa),Qa.forEach(t),Ka.forEach(t),An=c(yo),Lt=s(yo,"SPAN",{});var Ya=a(Lt);qn=i(Ya,"VisionTextDualEncoderProcessor"),Ya.forEach(t),yo.forEach(t),co=c(o),P=s(o,"DIV",{class:!0});var B=a(P);x(ye.$$.fragment,B),Ln=c(B),St=s(B,"P",{});var er=a(St);Sn=i(er,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
`),_t=s(N,"A",{href:!0});var ar=a(_t);Gn=i(ar,"decode()"),ar.forEach(t),Xn=i(N," for more information."),N.forEach(t),Kn=c(B),re=s(B,"DIV",{class:!0});var jo=a(re);x(je.$$.fragment,jo),Qn=c(jo),we=s(jo,"P",{});var wo=a(we);Yn=i(wo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
`),xt=s(wo,"A",{href:!0});var rr=a(xt);es=i(rr,"batch_decode()"),rr.forEach(t),ts=i(wo,". Please refer to the docstring of this method for more information."),wo.forEach(t),jo.forEach(t),os=c(B),ie=s(B,"DIV",{class:!0});var Vo=a(ie);x(Ve.$$.fragment,Vo),ns=c(Vo),ke=s(Vo,"P",{});var ko=a(ke);ss=i(ko,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),vt=s(ko,"A",{href:!0});var ir=a(vt);as=i(ir,"decode()"),ir.forEach(t),rs=i(ko,`.
Please refer to the docstring of this method for more information.`),ko.forEach(t),Vo.forEach(t),B.forEach(t),po=c(o),X=s(o,"H2",{class:!0});var Do=a(X);le=s(Do,"A",{id:!0,class:!0,href:!0});var lr=a(le);Ot=s(lr,"SPAN",{});var dr=a(Ot);x(De.$$.fragment,dr),dr.forEach(t),lr.forEach(t),is=c(Do),Bt=s(Do,"SPAN",{});var cr=a(Bt);ls=i(cr,"VisionTextDualEncoderModel"),cr.forEach(t),Do.forEach(t),mo=c(o),w=s(o,"DIV",{class:!0});var I=a(w);x($e.$$.fragment,I),ds=c(I),Pe=s(I,"P",{});var $o=a(Pe);cs=i($o,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
on new zero-shot vision tasks such as image classification or retrieval.`),Po.forEach(t),_s=c(I),Wt=s(I,"P",{});var hr=a(Wt);xs=i(hr,`After such a Vision-Text-Dual-Encoder model has been trained/fine-tuned, it can be saved/loaded just like any other
models (see the examples for more information).`),hr.forEach(t),vs=c(I),Ce=s(I,"P",{});var Mo=a(Ce);Ts=i(Mo,"This model inherits from "),bt=s(Mo,"A",{href:!0});var fr=a(bt);bs=i(fr,"PreTrainedModel"),fr.forEach(t),Es=i(Mo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zo.forEach(t),ks=c(I),z=s(I,"DIV",{class:!0});var W=a(z);x(Ae.$$.fragment,W),Ds=c(W),K=s(W,"P",{});var kt=a(K);$s=i(kt,"The "),Et=s(kt,"A",{href:!0});var gr=a(Et);Ps=i(gr,"VisionTextDualEncoderModel"),gr.forEach(t),Ms=i(kt," forward method, overrides the "),Rt=s(kt,"CODE",{});var _r=a(Rt);zs=i(_r,"__call__"),_r.forEach(t),Cs=i(kt," special method."),kt.forEach(t),Fs=c(W),x(de.$$.fragment,W),Is=c(W),Ut=s(W,"P",{});var xr=a(Ut);As=i(xr,"Examples:"),xr.forEach(t),qs=c(W),x(qe.$$.fragment,W),W.forEach(t),I.forEach(t),ho=c(o),Q=s(o,"H2",{class:!0});var Co=a(Q);ce=s(Co,"A",{id:!0,class:!0,href:!0});var vr=a(ce);Jt=s(vr,"SPAN",{});var Tr=a(Jt);x(Le.$$.fragment,Tr),Tr.forEach(t),vr.forEach(t),Ls=c(Co),Ht=s(Co,"SPAN",{});var br=a(Ht);Ss=i(br,"FlaxVisionTextDualEncoderModel"),br.forEach(t),Co.forEach(t),fo=c(o),f=s(o,"DIV",{class:!0});var k=a(f);x(Se.$$.fragment,k),Ns=c(k),Ne=s(k,"P",{});var Fo=a(Ne);Os=i(Fo,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
