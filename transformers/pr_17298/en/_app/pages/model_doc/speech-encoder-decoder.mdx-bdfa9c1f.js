import{S as ds,i as cs,s as is,e as a,k as h,w as E,t as n,M as ls,c as s,d as o,m,a as c,x as k,h as t,b as l,F as e,g as b,y as S,q as x,o as $,B as T,v as ps,L as en}from"../../chunks/vendor-6b77c823.js";import{T as ss}from"../../chunks/Tip-39098574.js";import{D as ee}from"../../chunks/Docstring-1088f2fb.js";import{C as on}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Tn}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Xo}from"../../chunks/ExampleCodeBlock-5212b321.js";function hs(q){let i,v,u,p,g;return p=new on({props:{code:`from transformers import BertConfig, Wav2Vec2Config, SpeechEncoderDecoderConfig, SpeechEncoderDecoderModel
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/pr_17298/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/pr_17298/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17298/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_17298/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17298/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_17298/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<a href="/docs/transformers/pr_17298/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor">Speech2TextFeatureExtractor</a> should be used for extracting the fbank features, padding and conversion
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17298/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L442",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17298/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<a href="/docs/transformers/pr_17298/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17298/src/transformers/models/speech_encoder_decoder/modeling_flax_speech_encoder_decoder.py#L662",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17298/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_17298/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
`),Qe=a("a"),Hn=n("Speech2Text2"),Gn=n("."),an=h(),R=a("h2"),oe=a("a"),To=a("span"),E(ve.$$.fragment),Jn=h(),Mo=a("span"),Yn=n("SpeechEncoderDecoderConfig"),sn=h(),j=a("div"),E(be.$$.fragment),Zn=h(),ne=a("p"),Xe=a("a"),Kn=n("SpeechEncoderDecoderConfig"),Qn=n(` is the configuration class to store the configuration of a
...
configuration and decoder model configuration.`),mt=h(),ae=a("div"),E(Ee.$$.fragment),ft=h(),H=a("p"),ut=n("Serializes this instance to a Python dictionary. Override the default "),Do=a("em"),gt=n("to_dict()"),_t=n(" from "),jo=a("em"),vt=n("PretrainedConfig"),bt=n("."),dn=h(),G=a("h2"),se=a("a"),qo=a("span"),E(ke.$$.fragment),yt=h(),Po=a("span"),wt=n("SpeechEncoderDecoderModel"),cn=h(),y=a("div"),E(Se.$$.fragment),Et=h(),J=a("p"),kt=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
...
and behavior.`),Ht=h(),W=a("p"),co=a("a"),Gt=n("SpeechEncoderDecoderModel"),Jt=n(` is a generic model class that will be instantiated as a transformer architecture with
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Rr=h(),O=a("p"),mo=a("a"),Ur=n("FlaxSpeechEncoderDecoderModel"),Hr=n(` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one
as decoder module when created with the :meth`),Bo=a("em"),Gr=n("~transformers.FlaxAutoModel.from_pretrained"),Jr=n(` class method for the
encoder and :meth`),Ro=a("em"),Yr=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Zr=n(" class method for the decoder."),Kr=h(),A=a("div"),E(Be.$$.fragment),Qr=h(),X=a("p"),Xr=n("The "),fo=a("a"),ea=n("FlaxSpeechEncoderDecoderModel"),oa=n(" forward method, overrides the "),Uo=a("code"),na=n("__call__"),ta=n(" special method."),ra=h(),E(pe.$$.fragment),aa=h(),E(he.$$.fragment),sa=h(),B=a("div"),E(Re.$$.fragment),da=h(),Ho=a("p"),ca=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ia=h(),E(me.$$.fragment),this.h()},l(r){const _=ls('[data-svelte="svelte-1phssyn"]',document.head);i=s(_,"META",{name:!0,content:!0}),_.forEach(o),v=m(r),u=s(r,"H1",{class:!0});var Ue=c(u);p=s(Ue,"A",{id:!0,class:!0,href:!0});var Go=c(p);g=s(Go,"SPAN",{});var Jo=c(g);k(d.$$.fragment,Jo),Jo.forEach(o),Go.forEach(o),f=m(Ue),N=s(Ue,"SPAN",{});var Yo=c(N);Mn=t(Yo,"Speech Encoder Decoder Models"),Yo.forEach(o),Ue.forEach(o),nn=m(r),P=s(r,"P",{});var z=c(P);Dn=t(z,"The "),Je=s(z,"A",{href:!0});var Zo=c(Je);jn=t(Zo,"SpeechEncoderDecoderModel"),Zo.forEach(o),qn=t(z,` can be used to initialize a speech-sequence-to-text-sequence model
...
configuration and decoder model configuration.`),un.forEach(o),fn.forEach(o),mt=m(L),ae=s(L,"DIV",{class:!0});var gn=c(ae);k(Ee.$$.fragment,gn),ft=m(gn),H=s(gn,"P",{});var vo=c(H);ut=t(vo,"Serializes this instance to a Python dictionary. Override the default "),Do=s(vo,"EM",{});var Sa=c(Do);gt=t(Sa,"to_dict()"),Sa.forEach(o),_t=t(vo," from "),jo=s(vo,"EM",{});var xa=c(jo);vt=t(xa,"PretrainedConfig"),xa.forEach(o),bt=t(vo,"."),vo.forEach(o),gn.forEach(o),L.forEach(o),dn=m(r),G=s(r,"H2",{class:!0});var _n=c(G);se=s(_n,"A",{id:!0,class:!0,href:!0});var $a=c(se);qo=s($a,"SPAN",{});var Ta=c(qo);k(ke.$$.fragment,Ta),Ta.forEach(o),$a.forEach(o),yt=m(_n),Po=s(_n,"SPAN",{});var Ma=c(Po);wt=t(Ma,"SpeechEncoderDecoderModel"),Ma.forEach(o),_n.forEach(o),cn=m(r),y=s(r,"DIV",{class:!0});var M=c(y);k(Se.$$.fragment,M),Et=m(M),J=s(M,"P",{});var bo=c(J);kt=t(bo,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wn.forEach(o),Ht=m(M),W=s(M,"P",{});var He=c(W);co=s(He,"A",{href:!0});var Aa=c(co);Gt=t(Aa,"SpeechEncoderDecoderModel"),Aa.forEach(o),Jt=t(He,` is a generic model class that will be instantiated as a transformer architecture with
one of the base model classes of the library as encoder and another one as decoder when created with the
:meth`),Fo=s(He,"EM",{});var La=c(Fo);Yt=t(La,"~transformers.AutoModel.from_pretrained"),La.forEach(o),Zt=t(He,` class method for the encoder and
:meth`),Co=s(He,"EM",{});var Na=c(Co);Kt=t(Na,"~transformers.AutoModelForCausalLM.from_pretrained"),Na.forEach(o),Qt=t(He," class method for the decoder."),He.forEach(o),Xt=m(M),F=s(M,"DIV",{class:!0});var fe=c(F);k(Pe.$$.fragment,fe),er=m(fe),Y=s(fe,"P",{});var yo=c(Y);or=t(yo,"The "),io=s(yo,"A",{href:!0});var Ia=c(io);nr=t(Ia,"SpeechEncoderDecoderModel"),Ia.forEach(o),tr=t(yo," forward method, overrides the "),Ao=s(yo,"CODE",{});var Va=c(Ao);rr=t(Va,"__call__"),Va.forEach(o),ar=t(yo," special method."),yo.forEach(o),sr=m(fe),k(de.$$.fragment,fe),dr=m(fe),k(ce.$$.fragment,fe),fe.forEach(o),cr=m(M),C=s(M,"DIV",{class:!0});var ue=c(C);k(ze.$$.fragment,ue),ir=m(ue),Lo=s(ue,"P",{});var Wa=c(Lo);lr=t(Wa,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Io=s(wo,"CODE",{});var Ba=c(Io);ur=t(Ba,"model.train()"),Ba.forEach(o),gr=t(wo,"."),wo.forEach(o),_r=m(ue),k(ie.$$.fragment,ue),ue.forEach(o),M.forEach(o),ln=m(r),K=s(r,"H2",{class:!0});var En=c(K);le=s(En,"A",{id:!0,class:!0,href:!0});var Ra=c(le);Vo=s(Ra,"SPAN",{});var Ua=c(Vo);k(Fe.$$.fragment,Ua),Ua.forEach(o),Ra.forEach(o),vr=m(En),Wo=s(En,"SPAN",{});var Ha=c(Wo);br=t(Ha,"FlaxSpeechEncoderDecoderModel"),Ha.forEach(o),En.forEach(o),pn=m(r),w=s(r,"DIV",{class:!0});var D=c(w);k(Ce.$$.fragment,D),yr=m(D),Q=s(D,"P",{});var Eo=c(Q);wr=t(Eo,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),lo=s(Eo,"A",{href:!0});var Ga=c(lo);Er=t(Ga,"from_pretrained()"),Ga.forEach(o),kr=t(Eo,` function and the decoder is loaded via
