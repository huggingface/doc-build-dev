...
the file system before passing it to `),zi=o("a"),p7=a("TrainingArguments"),i7=a("."),Uw=u(),Oi=o("p"),u7=a("To summarize you can do:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("p"),c7=a("or:"),Mw=u(),f(Jo.$$.fragment),Zw=u(),Ai=o("a"),Nw=u(),Cs=o("h3"),ta=o("a"),vd=o("span"),f(Xo.$$.fragment),h7=u(),jd=o("span"),f7=a("Shared Configuration"),Hw=u(),f(aa.$$.fragment),Bw=u(),Me=o("p"),d7=a("Some configuration values are required by both the "),Si=o("a"),m7=a("Trainer"),_7=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),v7=a("Trainer"),j7=a(" command line arguments."),Ww=u(),na=o("p"),g7=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),w7=a("Trainer"),y7=a(` do the majority
of configuration for you.`),Fw=u(),Ze=o("p"),b7=a("Therefore, in the rest of this guide you will find a special configuration value: "),gd=o("code"),E7=a("auto"),q7=a(`, which when set will be
...
your needs.`),Yw=u(),oa=o("p"),D7=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),z7=a("TrainingArguments"),O7=a(" based on that. The steps are:"),Kw=u(),la=o("ol"),wd=o("li"),T7=a("Create or load the DeepSpeed configuration to be used as a master configuration"),A7=u(),Qo=o("li"),S7=a("Create the "),Gi=o("a"),C7=a("TrainingArguments"),x7=a(" object based on these values"),Jw=u(),le=o("p"),R7=a("Do note that some values, such as "),yd=o("code"),I7=a("scheduler.params.total_num_steps"),U7=a(` are calculated by
`),Li=o("a"),G7=a("Trainer"),L7=a(" during "),bd=o("code"),M7=a("train"),Z7=a(", but you can of course do the math yourself."),Xw=u(),Mi=o("a"),Qw=u(),xs=o("h3"),ra=o("a"),Ed=o("span"),f(el.$$.fragment),N7=u(),qd=o("span"),H7=a("ZeRO"),ey=u(),sl=o("p"),tl=o("a"),B7=a("Zero Redundancy Optimizer (ZeRO)"),W7=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sy=u(),Ne=o("p"),F7=a("The "),$d=o("code"),V7=a("zero_optimization"),Y7=a(" section of the configuration file is the most important part ("),al=o("a"),K7=a("docs"),J7=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),ty=u(),pa=o("p"),X7=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q7=a("Trainer"),e9=a(` provides
no equivalent command line arguments.`),ay=u(),Ni=o("p"),s9=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),ny=u(),Hi=o("a"),oy=u(),Rs=o("h4"),ia=o("a"),kd=o("span"),f(nl.$$.fragment),t9=u(),Pd=o("span"),a9=a("ZeRO-2 Config"),ly=u(),Bi=o("p"),n9=a("The following is an example of configuration for ZeRO stage 2:"),ry=u(),f(ol.$$.fragment),py=u(),Wi=o("p"),Dd=o("strong"),o9=a("Performance tuning:"),iy=u(),He=o("ul"),Is=o("li"),l9=a("enabling "),zd=o("code"),r9=a("offload_optimizer"),p9=a(" should reduce GPU RAM usage (it requires "),Od=o("code"),i9=a('"stage": 2'),u9=a(")"),c9=u(),L=o("li"),Td=o("code"),h9=a('"overlap_comm": true'),f9=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=o("code"),d9=a("overlap_comm"),m9=a(` uses 4.5x
...
footprint (`),xd=o("code"),w9=a("5e8 x 2Bytes x 2 x 4.5"),y9=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
...
important, getting a slightly slower training time could be a good trade.`),uy=u(),Be=o("p"),k9=a("Additionally, "),Ud=o("code"),P9=a("deepspeed==0.4.4"),D9=a(" added a new option "),Gd=o("code"),z9=a("round_robin_gradients"),O9=a(" which you can enable with:"),cy=u(),f(ll.$$.fragment),hy=u(),Fi=o("p"),T9=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),fy=u(),Vi=o("a"),dy=u(),Us=o("h4"),ua=o("a"),Ld=o("span"),f(rl.$$.fragment),A9=u(),Md=o("span"),S9=a("ZeRO-3 Config"),my=u(),Yi=o("p"),C9=a("The following is an example of configuration for ZeRO stage 3:"),_y=u(),f(pl.$$.fragment),vy=u(),K=o("p"),x9=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
...
NVMe is discussed further down.`),jy=u(),We=o("p"),H9=a("Pinned memory is enabled with "),Wd=o("code"),B9=a("pin_memory"),W9=a(" set to "),Fd=o("code"),F9=a("true"),V9=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),gy=u(),Ki=o("p"),Vd=o("strong"),Y9=a("Performance tuning:"),wy=u(),ca=o("ul"),il=o("li"),Yd=o("code"),K9=a("stage3_max_live_parameters"),J9=a(": "),Kd=o("code"),X9=a("1e9"),Q9=u(),ul=o("li"),Jd=o("code"),ek=a("stage3_max_reuse_distance"),sk=a(": "),Xd=o("code"),tk=a("1e9"),yy=u(),M=o("p"),ak=a("If hitting OOM reduce "),Qd=o("code"),nk=a("stage3_max_live_parameters"),ok=a(" and "),em=o("code"),lk=a("stage3_max_reuse_distance"),rk=a(`. They should have minimal impact
...
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(ye,"A",{href:!0});var BM=r(Pi);e7=n(BM,"Trainer"),BM.forEach(t),s7=n(ye," via "),Di=l(ye,"A",{href:!0});var WM=r(Di);t7=n(WM,"TrainingArguments"),WM.forEach(t),a7=n(ye," then for the "),md=l(ye,"CODE",{});var FM=r(md);n7=n(FM,"deepspeed"),FM.forEach(t),o7=n(ye,` argument you can
pass a nested `),_d=l(ye,"CODE",{});var VM=r(_d);l7=n(VM,"dict"),VM.forEach(t),r7=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(ye,"A",{href:!0});var YM=r(zi);p7=n(YM,"TrainingArguments"),YM.forEach(t),i7=n(ye,"."),ye.forEach(t),Uw=c(e),Oi=l(e,"P",{});var KM=r(Oi);u7=n(KM,"To summarize you can do:"),KM.forEach(t),Gw=c(e),d(Ko.$$.fragment,e),Lw=c(e),Ti=l(e,"P",{});var JM=r(Ti);c7=n(JM,"or:"),JM.forEach(t),Mw=c(e),d(Jo.$$.fragment,e),Zw=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Nw=c(e),Cs=l(e,"H3",{class:!0});var GE=r(Cs);ta=l(GE,"A",{id:!0,class:!0,href:!0});var XM=r(ta);vd=l(XM,"SPAN",{});var QM=r(vd);d(Xo.$$.fragment,QM),QM.forEach(t),XM.forEach(t),h7=c(GE),jd=l(GE,"SPAN",{});var eZ=r(jd);f7=n(eZ,"Shared Configuration"),eZ.forEach(t),GE.forEach(t),Hw=c(e),d(aa.$$.fragment,e),Bw=c(e),Me=l(e,"P",{});var vh=r(Me);d7=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var sZ=r(Si);m7=n(sZ,"Trainer"),sZ.forEach(t),_7=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var tZ=r(Ci);v7=n(tZ,"Trainer"),tZ.forEach(t),j7=n(vh," command line arguments."),vh.forEach(t),Ww=c(e),na=l(e,"P",{});var LE=r(na);g7=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var aZ=r(xi);w7=n(aZ,"Trainer"),aZ.forEach(t),y7=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fw=c(e),Ze=l(e,"P",{});var jh=r(Ze);b7=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),gd=l(jh,"CODE",{});var nZ=r(gd);E7=n(nZ,"auto"),nZ.forEach(t),q7=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
...
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vw=c(e),Ii=l(e,"P",{});var lZ=r(Ii);P7=n(lZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),lZ.forEach(t),Yw=c(e),oa=l(e,"P",{});var ME=r(oa);D7=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var rZ=r(Ui);z7=n(rZ,"TrainingArguments"),rZ.forEach(t),O7=n(ME," based on that. The steps are:"),ME.forEach(t),Kw=c(e),la=l(e,"OL",{});var ZE=r(la);wd=l(ZE,"LI",{});var pZ=r(wd);T7=n(pZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),pZ.forEach(t),A7=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);S7=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var iZ=r(Gi);C7=n(iZ,"TrainingArguments"),iZ.forEach(t),x7=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jw=c(e),le=l(e,"P",{});var Hn=r(le);R7=n(Hn,"Do note that some values, such as "),yd=l(Hn,"CODE",{});var uZ=r(yd);I7=n(uZ,"scheduler.params.total_num_steps"),uZ.forEach(t),U7=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var cZ=r(Li);G7=n(cZ,"Trainer"),cZ.forEach(t),L7=n(Hn," during "),bd=l(Hn,"CODE",{});var hZ=r(bd);M7=n(hZ,"train"),hZ.forEach(t),Z7=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xw=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qw=c(e),xs=l(e,"H3",{class:!0});var HE=r(xs);ra=l(HE,"A",{id:!0,class:!0,href:!0});var fZ=r(ra);Ed=l(fZ,"SPAN",{});var dZ=r(Ed);d(el.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),N7=c(HE),qd=l(HE,"SPAN",{});var mZ=r(qd);H7=n(mZ,"ZeRO"),mZ.forEach(t),HE.forEach(t),ey=c(e),sl=l(e,"P",{});var wG=r(sl);tl=l(wG,"A",{href:!0,rel:!0});var _Z=r(tl);B7=n(_Z,"Zero Redundancy Optimizer (ZeRO)"),_Z.forEach(t),W7=n(wG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
...
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),ty=c(e),pa=l(e,"P",{});var BE=r(pa);X7=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var gZ=r(Zi);Q7=n(gZ,"Trainer"),gZ.forEach(t),e9=n(BE,` provides
no equivalent command line arguments.`),BE.forEach(t),ay=c(e),Ni=l(e,"P",{});var wZ=r(Ni);s9=n(wZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),wZ.forEach(t),ny=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),oy=c(e),Rs=l(e,"H4",{class:!0});var WE=r(Rs);ia=l(WE,"A",{id:!0,class:!0,href:!0});var yZ=r(ia);kd=l(yZ,"SPAN",{});var bZ=r(kd);d(nl.$$.fragment,bZ),bZ.forEach(t),yZ.forEach(t),t9=c(WE),Pd=l(WE,"SPAN",{});var EZ=r(Pd);a9=n(EZ,"ZeRO-2 Config"),EZ.forEach(t),WE.forEach(t),ly=c(e),Bi=l(e,"P",{});var qZ=r(Bi);n9=n(qZ,"The following is an example of configuration for ZeRO stage 2:"),qZ.forEach(t),ry=c(e),d(ol.$$.fragment,e),py=c(e),Wi=l(e,"P",{});var $Z=r(Wi);Dd=l($Z,"STRONG",{});var kZ=r(Dd);o9=n(kZ,"Performance tuning:"),kZ.forEach(t),$Z.forEach(t),iy=c(e),He=l(e,"UL",{});var wh=r(He);Is=l(wh,"LI",{});var yh=r(Is);l9=n(yh,"enabling "),zd=l(yh,"CODE",{});var PZ=r(zd);r9=n(PZ,"offload_optimizer"),PZ.forEach(t),p9=n(yh," should reduce GPU RAM usage (it requires "),Od=l(yh,"CODE",{});var DZ=r(Od);i9=n(DZ,'"stage": 2'),DZ.forEach(t),u9=n(yh,")"),yh.forEach(t),c9=c(wh),L=l(wh,"LI",{});var te=r(L);Td=l(te,"CODE",{});var zZ=r(Td);h9=n(zZ,'"overlap_comm": true'),zZ.forEach(t),f9=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=l(te,"CODE",{});var OZ=r(Ad);d9=n(OZ,"overlap_comm"),OZ.forEach(t),m9=n(te,` uses 4.5x
...
footprint (`),xd=l(te,"CODE",{});var SZ=r(xd);w9=n(SZ,"5e8 x 2Bytes x 2 x 4.5"),SZ.forEach(t),y9=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
