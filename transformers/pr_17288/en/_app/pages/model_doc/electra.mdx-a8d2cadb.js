...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17288/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17288/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17288/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17288/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17288/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17288/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17288/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17288/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17288/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Cg.forEach(t),Qw=p(_t),Ph=s(_t,"P",{});var b8=a(Ph);Vw=i(b8,"Finally, this model supports inherent JAX features such as:"),b8.forEach(t),Kw=p(_t),Gt=s(_t,"UL",{});var ba=a(Gt);Ah=s(ba,"LI",{});var y8=a(Ah);ol=s(y8,"A",{href:!0,rel:!0});var E8=a(ol);Jw=i(E8,"Just-In-Time (JIT) compilation"),E8.forEach(t),y8.forEach(t),Gw=p(ba),Oh=s(ba,"LI",{});var w8=a(Oh);nl=s(w8,"A",{href:!0,rel:!0});var $8=a(nl);Xw=i($8,"Automatic Differentiation"),$8.forEach(t),w8.forEach(t),Yw=p(ba),Lh=s(ba,"LI",{});var F8=a(Lh);sl=s(F8,"A",{href:!0,rel:!0});var x8=a(sl);Zw=i(x8,"Vectorization"),x8.forEach(t),F8.forEach(t),e2=p(ba),Nh=s(ba,"LI",{});var M8=a(Nh);al=s(M8,"A",{href:!0,rel:!0});var z8=a(al);t2=i(z8,"Parallelization"),z8.forEach(t),M8.forEach(t),ba.forEach(t),o2=p(_t),At=s(_t,"DIV",{class:!0});var ya=a(At);y(rl.$$.fragment,ya),n2=p(ya),cn=s(ya,"P",{});var qc=a(cn);s2=i(qc,"The "),Ih=s(qc,"CODE",{});var C8=a(Ih);a2=i(C8,"FlaxElectraPreTrainedModel"),C8.forEach(t),r2=i(qc," forward method, overrides the "),Dh=s(qc,"CODE",{});var j8=a(Dh);i2=i(j8,"__call__"),j8.forEach(t),l2=i(qc," special method."),qc.forEach(t),d2=p(ya),y(Bs.$$.fragment,ya),c2=p(ya),y(Qs.$$.fragment,ya),ya.forEach(t),_t.forEach(t),_f=p(o),pn=s(o,"H2",{class:!0});var jg=a(pn);Vs=s(jg,"A",{id:!0,class:!0,href:!0});var q8=a(Vs);Sh=s(q8,"SPAN",{});var P8=a(Sh);y(il.$$.fragment,P8),P8.forEach(t),q8.forEach(t),p2=p(jg),Wh=s(jg,"SPAN",{});var A8=a(Wh);h2=i(A8,"FlaxElectraForMaskedLM"),A8.forEach(t),jg.forEach(t),kf=p(o),Se=s(o,"DIV",{class:!0});var kt=a(Se);y(ll.$$.fragment,kt),m2=p(kt),dl=s(kt,"P",{});var qg=a(dl);u2=i(qg,"Electra Model with a "),Uh=s(qg,"CODE",{});var O8=a(Uh);f2=i(O8,"language modeling"),O8.forEach(t),g2=i(qg," head on top."),qg.forEach(t),_2=p(kt),cl=s(kt,"P",{});var Pg=a(cl);k2=i(Pg,"This model inherits from "),lc=s(Pg,"A",{href:!0});var L8=a(lc);v2=i(L8,"FlaxPreTrainedModel"),L8.forEach(t),T2=i(Pg,`. Check the superclass documentation for the generic methods the
...
`),hl=s(Ag,"A",{href:!0,rel:!0});var N8=a(hl);E2=i(N8,"flax.nn.Module"),N8.forEach(t),w2=i(Ag,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$2=p(kt),Rh=s(kt,"P",{});var I8=a(Rh);F2=i(I8,"Finally, this model supports inherent JAX features such as:"),I8.forEach(t),x2=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var D8=a(Hh);ml=s(D8,"A",{href:!0,rel:!0});var S8=a(ml);M2=i(S8,"Just-In-Time (JIT) compilation"),S8.forEach(t),D8.forEach(t),z2=p(Ea),Bh=s(Ea,"LI",{});var W8=a(Bh);ul=s(W8,"A",{href:!0,rel:!0});var U8=a(ul);C2=i(U8,"Automatic Differentiation"),U8.forEach(t),W8.forEach(t),j2=p(Ea),Qh=s(Ea,"LI",{});var R8=a(Qh);fl=s(R8,"A",{href:!0,rel:!0});var H8=a(fl);q2=i(H8,"Vectorization"),H8.forEach(t),R8.forEach(t),P2=p(Ea),Vh=s(Ea,"LI",{});var B8=a(Vh);gl=s(B8,"A",{href:!0,rel:!0});var Q8=a(gl);A2=i(Q8,"Parallelization"),Q8.forEach(t),B8.forEach(t),Ea.forEach(t),O2=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L2=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N2=i(Pc,"The "),Kh=s(Pc,"CODE",{});var V8=a(Kh);I2=i(V8,"FlaxElectraPreTrainedModel"),V8.forEach(t),D2=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var K8=a(Jh);S2=i(K8,"__call__"),K8.forEach(t),W2=i(Pc," special method."),Pc.forEach(t),U2=p(wa),y(Ks.$$.fragment,wa),R2=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var J8=a(Gs);Gh=s(J8,"SPAN",{});var G8=a(Gh);y(kl.$$.fragment,G8),G8.forEach(t),J8.forEach(t),H2=p(Og),Xh=s(Og,"SPAN",{});var X8=a(Xh);B2=i(X8,"FlaxElectraForSequenceClassification"),X8.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Q2=p(vt),Yh=s(vt,"P",{});var Y8=a(Yh);V2=i(Y8,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Y8.forEach(t),K2=p(vt),Tl=s(vt,"P",{});var Lg=a(Tl);J2=i(Lg,"This model inherits from "),dc=s(Lg,"A",{href:!0});var Z8=a(dc);G2=i(Z8,"FlaxPreTrainedModel"),Z8.forEach(t),X2=i(Lg,`. Check the superclass documentation for the generic methods the
