...
tabby, tabby cat`}}),{c(){d=a("p"),b=n("Example:"),m=f(),v(h.$$.fragment)},l(l){d=r(l,"P",{});var p=s(d);b=i(p,"Example:"),p.forEach(o),m=u(l),w(h.$$.fragment,l)},m(l,p){_(l,d,p),e(d,b),_(l,m,p),$(h,l,p),T=!0},p:Co,i(l){T||(y(h.$$.fragment,l),T=!0)},o(l){D(h.$$.fragment,l),T=!1},d(l){l&&o(d),l&&o(m),k(h,l)}}}function pi(x){let d,b,m,h,T,l,p,I,ha,Po,le,zo,J,de,Vt,qe,pa,Bt,ma,qo,q,fa,Ae,ua,ga,mt,_a,Ta,Ne,ba,va,Ao,ft,wa,No,ut,Ht,$a,Lo,gt,ya,Oo,C,Rt,Da,ka,G,xa,_t,Ia,Ea,Tt,Fa,Ma,Ca,Ut,ja,Pa,Jt,za,qa,E,Aa,bt,Na,La,vt,Oa,Wa,Gt,Sa,Va,Kt,Ba,Ha,Xt,Ra,Ua,Zt,Ja,Ga,wt,Ka,Xa,Wo,ce,Za,Le,Qa,Ya,So,K,he,Qt,Oe,er,Yt,tr,Vo,j,We,or,X,ar,$t,rr,sr,Se,nr,ir,lr,Z,dr,yt,cr,hr,Dt,pr,mr,fr,pe,Bo,Q,me,eo,Ve,ur,to,gr,Ho,P,Be,_r,oo,Tr,br,He,vr,kt,wr,$r,yr,R,Re,Dr,ao,kr,xr,fe,Ro,Y,ue,ro,Ue,Ir,so,Er,Uo,S,Je,Fr,Ge,Mr,Ke,Cr,jr,Pr,A,Xe,zr,ee,qr,xt,Ar,Nr,no,Lr,Or,Wr,ge,Sr,_e,Jo,te,Te,io,Ze,Vr,lo,Br,Go,V,Qe,Hr,oe,Rr,co,Ur,Jr,Ye,Gr,Kr,Xr,N,et,Zr,ae,Qr,It,Yr,es,ho,ts,os,as,be,rs,ve,Ko,re,we,po,tt,ss,mo,ns,Xo,z,ot,is,fo,ls,ds,at,cs,rt,hs,ps,ms,L,st,fs,se,us,Et,gs,_s,uo,Ts,bs,vs,$e,ws,ye,Zo,ne,De,go,nt,$s,_o,ys,Qo,F,it,Ds,To,ks,xs,bo,Is,Es,vo,Fs,Ms,lt,Cs,dt,js,Ps,zs,O,ct,qs,ie,As,Ft,Ns,Ls,wo,Os,Ws,Ss,ke,Vs,xe,Yo;return l=new ze({}),le=new St({props:{$$slots:{default:[ti]},$$scope:{ctx:x}}}),qe=new ze({}),Oe=new ze({}),We=new H({props:{name:"class transformers.DeiTConfig",anchor:"transformers.DeiTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DeiTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_41/src/transformers/models/deit/feature_extraction_deit.py#L91",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_41/en/main_classes/feature_extractor#transformers.BatchFeature"
...
Whether or not to return a <a href="/docs/transformers/pr_41/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_41/src/transformers/models/deit/modeling_deit.py#L497",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_41/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_41/en/model_doc/deit#transformers.DeiTConfig"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_41/src/transformers/models/deit/modeling_deit.py#L591",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_41/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_41/src/transformers/models/deit/modeling_deit.py#L698",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_41/en/main_classes/output#transformers.modeling_outputs.ImageClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_41/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_41/src/transformers/models/deit/modeling_deit.py#L852",returnDescription:`
...
`}}),ke=new St({props:{$$slots:{default:[ci]},$$scope:{ctx:x}}}),xe=new Mo({props:{anchor:"transformers.DeiTForImageClassificationWithTeacher.forward.example",$$slots:{default:[hi]},$$scope:{ctx:x}}}),{c(){d=a("meta"),b=f(),m=a("h1"),h=a("a"),T=a("span"),v(l.$$.fragment),p=f(),I=a("span"),ha=n("DeiT"),Po=f(),v(le.$$.fragment),zo=f(),J=a("h2"),de=a("a"),Vt=a("span"),v(qe.$$.fragment),pa=f(),Bt=a("span"),ma=n("Overview"),qo=f(),q=a("p"),fa=n("The DeiT model was proposed in "),Ae=a("a"),ua=n("Training data-efficient image transformers & distillation through attention"),ga=n(` by Hugo Touvron, Matthieu Cord, Matthijs Douze, Francisco Massa, Alexandre
...
documentation from `),Dt=a("a"),pr=n("PretrainedConfig"),mr=n(" for more information."),fr=f(),v(pe.$$.fragment),Bo=f(),Q=a("h2"),me=a("a"),eo=a("span"),v(Ve.$$.fragment),ur=f(),to=a("span"),gr=n("DeiTFeatureExtractor"),Ho=f(),P=a("div"),v(Be.$$.fragment),_r=f(),oo=a("p"),Tr=n("Constructs a DeiT feature extractor."),br=f(),He=a("p"),vr=n("This feature extractor inherits from "),kt=a("a"),wr=n("FeatureExtractionMixin"),$r=n(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),yr=f(),R=a("div"),v(Re.$$.fragment),Dr=f(),ao=a("p"),kr=n("Main method to prepare for the model one or several image(s)."),xr=f(),v(fe.$$.fragment),Ro=f(),Y=a("h2"),ue=a("a"),ro=a("span"),v(Ue.$$.fragment),Ir=f(),so=a("span"),Er=n("DeiTModel"),Uo=f(),S=a("div"),v(Je.$$.fragment),Fr=f(),Ge=a("p"),Mr=n(`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Ke=a("a"),Cr=n("torch.nn.Module"),jr=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pr=f(),A=a("div"),v(Xe.$$.fragment),zr=f(),ee=a("p"),qr=n("The "),xt=a("a"),Ar=n("DeiTModel"),Nr=n(" forward method, overrides the "),no=a("code"),Lr=n("__call__"),Or=n(" special method."),Wr=f(),v(ge.$$.fragment),Sr=f(),v(_e.$$.fragment),Jo=f(),te=a("h2"),Te=a("a"),io=a("span"),v(Ze.$$.fragment),Vr=f(),lo=a("span"),Br=n("DeiTForMaskedImageModeling"),Go=f(),V=a("div"),v(Qe.$$.fragment),Hr=f(),oe=a("p"),Rr=n("DeiT Model with a decoder on top for masked image modeling, as proposed in "),co=a("code"),Ur=n("SimMIM <https://arxiv.org/abs/2111.09886>"),Jr=n(`__.
This model is a PyTorch `),Ye=a("a"),Gr=n("torch.nn.Module"),Kr=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xr=f(),N=a("div"),v(et.$$.fragment),Zr=f(),ae=a("p"),Qr=n("The "),It=a("a"),Yr=n("DeiTForMaskedImageModeling"),es=n(" forward method, overrides the "),ho=a("code"),ts=n("__call__"),os=n(" special method."),as=f(),v(be.$$.fragment),rs=f(),v(ve.$$.fragment),Ko=f(),re=a("h2"),we=a("a"),po=a("span"),v(tt.$$.fragment),ss=f(),mo=a("span"),ns=n("DeiTForImageClassification"),Xo=f(),z=a("div"),v(ot.$$.fragment),is=f(),fo=a("p"),ls=n(`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),ds=f(),at=a("p"),cs=n("This model is a PyTorch "),rt=a("a"),hs=n("torch.nn.Module"),ps=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ms=f(),L=a("div"),v(st.$$.fragment),fs=f(),se=a("p"),us=n("The "),Et=a("a"),gs=n("DeiTForImageClassification"),_s=n(" forward method, overrides the "),uo=a("code"),Ts=n("__call__"),bs=n(" special method."),vs=f(),v($e.$$.fragment),ws=f(),v(ye.$$.fragment),Zo=f(),ne=a("h2"),De=a("a"),go=a("span"),v(nt.$$.fragment),$s=f(),_o=a("span"),ys=n("DeiTForImageClassificationWithTeacher"),Qo=f(),F=a("div"),v(it.$$.fragment),Ds=f(),To=a("p"),ks=n(`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zs=f(),O=a("div"),v(ct.$$.fragment),qs=f(),ie=a("p"),As=n("The "),Ft=a("a"),Ns=n("DeiTForImageClassificationWithTeacher"),Ls=n(" forward method, overrides the "),wo=a("code"),Os=n("__call__"),Ws=n(" special method."),Ss=f(),v(ke.$$.fragment),Vs=f(),v(xe.$$.fragment),this.h()},l(t){const g=Yn('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(o),b=u(t),m=r(t,"H1",{class:!0});var ht=s(m);h=r(ht,"A",{id:!0,class:!0,href:!0});var $o=s(h);T=r($o,"SPAN",{});var yo=s(T);w(l.$$.fragment,yo),yo.forEach(o),$o.forEach(o),p=u(ht),I=r(ht,"SPAN",{});var Do=s(I);ha=i(Do,"DeiT"),Do.forEach(o),ht.forEach(o),Po=u(t),w(le.$$.fragment,t),zo=u(t),J=r(t,"H2",{class:!0});var pt=s(J);de=r(pt,"A",{id:!0,class:!0,href:!0});var ko=s(de);Vt=r(ko,"SPAN",{});var xo=s(Vt);w(qe.$$.fragment,xo),xo.forEach(o),ko.forEach(o),pa=u(pt),Bt=r(pt,"SPAN",{});var Io=s(Bt);ma=i(Io,"Overview"),Io.forEach(o),pt.forEach(o),qo=u(t),q=r(t,"P",{});var B=s(q);fa=i(B,"The DeiT model was proposed in "),Ae=r(B,"A",{href:!0,rel:!0});var Eo=s(Ae);ua=i(Eo,"Training data-efficient image transformers & distillation through attention"),Eo.forEach(o),ga=i(B,` by Hugo Touvron, Matthieu Cord, Matthijs Douze, Francisco Massa, Alexandre
...
expensive infrastructure for multiple weeks, using external data. DeiT (data-efficient image transformers) are more
efficiently trained transformers for image classification, requiring far less data and far less computing resources
compared to the original ViT models.`),B.forEach(o),Ao=u(t),ft=r(t,"P",{});var Hs=s(ft);wa=i(Hs,"The abstract from the paper is the following:"),Hs.forEach(o),No=u(t),ut=r(t,"P",{});var Rs=s(ut);Ht=r(Rs,"EM",{});var Us=s(Ht);$a=i(Us,`Recently, neural networks purely based on attention were shown to address image understanding tasks such as image
classification. However, these visual transformers are pre-trained with hundreds of millions of images using an
expensive infrastructure, thereby limiting their adoption. In this work, we produce a competitive convolution-free
transformer by training on Imagenet only. We train them on a single computer in less than 3 days. Our reference vision
transformer (86M parameters) achieves top-1 accuracy of 83.1% (single-crop evaluation) on ImageNet with no external
...
distillation, especially when using a convnet as a teacher. This leads us to report results competitive with convnets
for both Imagenet (where we obtain up to 85.2% accuracy) and when transferring to other tasks. We share our code and
models.`),Us.forEach(o),Rs.forEach(o),Lo=u(t),gt=r(t,"P",{});var Js=s(gt);ya=i(Js,"Tips:"),Js.forEach(o),Oo=u(t),C=r(t,"UL",{});var U=s(C);Rt=r(U,"LI",{});var Gs=s(Rt);Da=i(Gs,`Compared to ViT, DeiT models use a so-called distillation token to effectively learn from a teacher (which, in the
DeiT paper, is a ResNet like-model). The distillation token is learned through backpropagation, by interacting with
the class ([CLS]) and patch tokens through the self-attention layers.`),Gs.forEach(o),ka=u(U),G=r(U,"LI",{});var Mt=s(G);xa=i(Mt,`There are 2 ways to fine-tune distilled models, either (1) in a classic way, by only placing a prediction head on top
of the final hidden state of the class token and not using the distillation signal, or (2) by placing both a
prediction head on top of the class token and on top of the distillation token. In that case, the [CLS] prediction
head is trained using regular cross-entropy between the prediction of the head and the ground-truth label, while the
distillation prediction head is trained using hard distillation (cross-entropy between the prediction of the
...
between both heads as final prediction. (2) is also called \u201Cfine-tuning with distillation\u201D, because one relies on a
teacher that has already been fine-tuned on the downstream dataset. In terms of models, (1) corresponds to
`),_t=r(Mt,"A",{href:!0});var Ks=s(_t);Ia=i(Ks,"DeiTForImageClassification"),Ks.forEach(o),Ea=i(Mt,` and (2) corresponds to
`),Tt=r(Mt,"A",{href:!0});var Xs=s(Tt);Fa=i(Xs,"DeiTForImageClassificationWithTeacher"),Xs.forEach(o),Ma=i(Mt,"."),Mt.forEach(o),Ca=u(U),Ut=r(U,"LI",{});var Zs=s(Ut);ja=i(Zs,`Note that the authors also did try soft distillation for (2) (in which case the distillation prediction head is
trained using KL divergence to match the softmax output of the teacher), but hard distillation gave the best results.`),Zs.forEach(o),Pa=u(U),Jt=r(U,"LI",{});var Qs=s(Jt);za=i(Qs,`All released checkpoints were pre-trained and fine-tuned on ImageNet-1k only. No external data was used. This is in
contrast with the original ViT model, which used external data like the JFT-300M dataset/Imagenet-21k for
...
prepare images for the model.`),M.forEach(o),U.forEach(o),Wo=u(t),ce=r(t,"P",{});var ea=s(ce);Za=i(ea,"This model was contributed by "),Le=r(ea,"A",{href:!0,rel:!0});var nn=s(Le);Qa=i(nn,"nielsr"),nn.forEach(o),Ya=i(ea,"."),ea.forEach(o),So=u(t),K=r(t,"H2",{class:!0});var ta=s(K);he=r(ta,"A",{id:!0,class:!0,href:!0});var ln=s(he);Qt=r(ln,"SPAN",{});var dn=s(Qt);w(Oe.$$.fragment,dn),dn.forEach(o),ln.forEach(o),er=u(ta),Yt=r(ta,"SPAN",{});var cn=s(Yt);tr=i(cn,"DeiTConfig"),cn.forEach(o),ta.forEach(o),Vo=u(t),j=r(t,"DIV",{class:!0});var Ie=s(j);w(We.$$.fragment,Ie),or=u(Ie),X=r(Ie,"P",{});var Ct=s(X);ar=i(Ct,"This is the configuration class to store the configuration of a "),$t=r(Ct,"A",{href:!0});var hn=s($t);rr=i(hn,"DeiTModel"),hn.forEach(o),sr=i(Ct,`. It is used to instantiate an DeiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the DeiT
`),Se=r(Ct,"A",{href:!0,rel:!0});var pn=s(Se);nr=i(pn,"facebook/deit-base-distilled-patch16-224"),pn.forEach(o),ir=i(Ct,`
architecture.`),Ct.forEach(o),lr=u(Ie),Z=r(Ie,"P",{});var jt=s(Z);dr=i(jt,"Configuration objects inherit from "),yt=r(jt,"A",{href:!0});var mn=s(yt);cr=i(mn,"PretrainedConfig"),mn.forEach(o),hr=i(jt,` and can be used to control the model outputs. Read the
documentation from `),Dt=r(jt,"A",{href:!0});var fn=s(Dt);pr=i(fn,"PretrainedConfig"),fn.forEach(o),mr=i(jt," for more information."),jt.forEach(o),fr=u(Ie),w(pe.$$.fragment,Ie),Ie.forEach(o),Bo=u(t),Q=r(t,"H2",{class:!0});var oa=s(Q);me=r(oa,"A",{id:!0,class:!0,href:!0});var un=s(me);eo=r(un,"SPAN",{});var gn=s(eo);w(Ve.$$.fragment,gn),gn.forEach(o),un.forEach(o),ur=u(oa),to=r(oa,"SPAN",{});var _n=s(to);gr=i(_n,"DeiTFeatureExtractor"),_n.forEach(o),oa.forEach(o),Ho=u(t),P=r(t,"DIV",{class:!0});var Ee=s(P);w(Be.$$.fragment,Ee),_r=u(Ee),oo=r(Ee,"P",{});var Tn=s(oo);Tr=i(Tn,"Constructs a DeiT feature extractor."),Tn.forEach(o),br=u(Ee),He=r(Ee,"P",{});var aa=s(He);vr=i(aa,"This feature extractor inherits from "),kt=r(aa,"A",{href:!0});var bn=s(kt);wr=i(bn,"FeatureExtractionMixin"),bn.forEach(o),$r=i(aa,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),aa.forEach(o),yr=u(Ee),R=r(Ee,"DIV",{class:!0});var Pt=s(R);w(Re.$$.fragment,Pt),Dr=u(Pt),ao=r(Pt,"P",{});var vn=s(ao);kr=i(vn,"Main method to prepare for the model one or several image(s)."),vn.forEach(o),xr=u(Pt),w(fe.$$.fragment,Pt),Pt.forEach(o),Ee.forEach(o),Ro=u(t),Y=r(t,"H2",{class:!0});var ra=s(Y);ue=r(ra,"A",{id:!0,class:!0,href:!0});var wn=s(ue);ro=r(wn,"SPAN",{});var $n=s(ro);w(Ue.$$.fragment,$n),$n.forEach(o),wn.forEach(o),Ir=u(ra),so=r(ra,"SPAN",{});var yn=s(so);Er=i(yn,"DeiTModel"),yn.forEach(o),ra.forEach(o),Uo=u(t),S=r(t,"DIV",{class:!0});var zt=s(S);w(Je.$$.fragment,zt),Fr=u(zt),Ge=r(zt,"P",{});var sa=s(Ge);Mr=i(sa,`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Ke=r(sa,"A",{href:!0,rel:!0});var Dn=s(Ke);Cr=i(Dn,"torch.nn.Module"),Dn.forEach(o),jr=i(sa,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sa.forEach(o),Pr=u(zt),A=r(zt,"DIV",{class:!0});var Fe=s(A);w(Xe.$$.fragment,Fe),zr=u(Fe),ee=r(Fe,"P",{});var qt=s(ee);qr=i(qt,"The "),xt=r(qt,"A",{href:!0});var kn=s(xt);Ar=i(kn,"DeiTModel"),kn.forEach(o),Nr=i(qt," forward method, overrides the "),no=r(qt,"CODE",{});var xn=s(no);Lr=i(xn,"__call__"),xn.forEach(o),Or=i(qt," special method."),qt.forEach(o),Wr=u(Fe),w(ge.$$.fragment,Fe),Sr=u(Fe),w(_e.$$.fragment,Fe),Fe.forEach(o),zt.forEach(o),Jo=u(t),te=r(t,"H2",{class:!0});var na=s(te);Te=r(na,"A",{id:!0,class:!0,href:!0});var In=s(Te);io=r(In,"SPAN",{});var En=s(io);w(Ze.$$.fragment,En),En.forEach(o),In.forEach(o),Vr=u(na),lo=r(na,"SPAN",{});var Fn=s(lo);Br=i(Fn,"DeiTForMaskedImageModeling"),Fn.forEach(o),na.forEach(o),Go=u(t),V=r(t,"DIV",{class:!0});var At=s(V);w(Qe.$$.fragment,At),Hr=u(At),oe=r(At,"P",{});var Nt=s(oe);Rr=i(Nt,"DeiT Model with a decoder on top for masked image modeling, as proposed in "),co=r(Nt,"CODE",{});var Mn=s(co);Ur=i(Mn,"SimMIM <https://arxiv.org/abs/2111.09886>"),Mn.forEach(o),Jr=i(Nt,`__.
This model is a PyTorch `),Ye=r(Nt,"A",{href:!0,rel:!0});var Cn=s(Ye);Gr=i(Cn,"torch.nn.Module"),Cn.forEach(o),Kr=i(Nt,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Nt.forEach(o),Xr=u(At),N=r(At,"DIV",{class:!0});var Me=s(N);w(et.$$.fragment,Me),Zr=u(Me),ae=r(Me,"P",{});var Lt=s(ae);Qr=i(Lt,"The "),It=r(Lt,"A",{href:!0});var jn=s(It);Yr=i(jn,"DeiTForMaskedImageModeling"),jn.forEach(o),es=i(Lt," forward method, overrides the "),ho=r(Lt,"CODE",{});var Pn=s(ho);ts=i(Pn,"__call__"),Pn.forEach(o),os=i(Lt," special method."),Lt.forEach(o),as=u(Me),w(be.$$.fragment,Me),rs=u(Me),w(ve.$$.fragment,Me),Me.forEach(o),At.forEach(o),Ko=u(t),re=r(t,"H2",{class:!0});var ia=s(re);we=r(ia,"A",{id:!0,class:!0,href:!0});var zn=s(we);po=r(zn,"SPAN",{});var qn=s(po);w(tt.$$.fragment,qn),qn.forEach(o),zn.forEach(o),ss=u(ia),mo=r(ia,"SPAN",{});var An=s(mo);ns=i(An,"DeiTForImageClassification"),An.forEach(o),ia.forEach(o),Xo=u(t),z=r(t,"DIV",{class:!0});var Ce=s(z);w(ot.$$.fragment,Ce),is=u(Ce),fo=r(Ce,"P",{});var Nn=s(fo);ls=i(Nn,`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Nn.forEach(o),ds=u(Ce),at=r(Ce,"P",{});var la=s(at);cs=i(la,"This model is a PyTorch "),rt=r(la,"A",{href:!0,rel:!0});var Ln=s(rt);hs=i(Ln,"torch.nn.Module"),Ln.forEach(o),ps=i(la,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),la.forEach(o),ms=u(Ce),L=r(Ce,"DIV",{class:!0});var je=s(L);w(st.$$.fragment,je),fs=u(je),se=r(je,"P",{});var Ot=s(se);us=i(Ot,"The "),Et=r(Ot,"A",{href:!0});var On=s(Et);gs=i(On,"DeiTForImageClassification"),On.forEach(o),_s=i(Ot," forward method, overrides the "),uo=r(Ot,"CODE",{});var Wn=s(uo);Ts=i(Wn,"__call__"),Wn.forEach(o),bs=i(Ot," special method."),Ot.forEach(o),vs=u(je),w($e.$$.fragment,je),ws=u(je),w(ye.$$.fragment,je),je.forEach(o),Ce.forEach(o),Zo=u(t),ne=r(t,"H2",{class:!0});var da=s(ne);De=r(da,"A",{id:!0,class:!0,href:!0});var Sn=s(De);go=r(Sn,"SPAN",{});var Vn=s(go);w(nt.$$.fragment,Vn),Vn.forEach(o),Sn.forEach(o),$s=u(da),_o=r(da,"SPAN",{});var Bn=s(_o);ys=i(Bn,"DeiTForImageClassificationWithTeacher"),Bn.forEach(o),da.forEach(o),Qo=u(t),F=r(t,"DIV",{class:!0});var W=s(F);w(it.$$.fragment,W),Ds=u(W),To=r(W,"P",{});var Hn=s(To);ks=i(Hn,`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
