...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(u){k(l.$$.fragment,u)},m(u,m){w(l,u,m),b=!0},p:Pe,i(u){b||(y(l.$$.fragment,u),b=!0)},o(u){E(l.$$.fragment,u),b=!1},d(u){q(l,u)}}}function vf($){let l,b,u,m,v,i,f,D,je,fe,F,Z,W,oe,Ie,U,Be,De,B,V,ne,we,C,A,_e,se,Fe,ge,R,Ge,ze,O,Qe,Y,S,M,G,He,We,j,Ue,ae,ye;return{c(){l=n("p"),b=r("TF 2.0 models accepts two formats as inputs:"),u=c(),m=n("ul"),v=n("li"),i=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=n("li"),je=r("having all inputs as a list, tuple or dict in the first positional arguments."),fe=c(),F=n("p"),Z=r("This second option is useful when using "),W=n("code"),oe=r("tf.keras.Model.fit"),Ie=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),Be=r("model(inputs)"),De=r("."),B=c(),V=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),we=c(),C=n("ul"),A=n("li"),_e=r("a single Tensor with "),se=n("code"),Fe=r("input_ids"),ge=r(" only and nothing else: "),R=n("code"),Ge=r("model(input_ids)"),ze=c(),O=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=n("code"),S=r("model([input_ids, attention_mask])"),M=r(" or "),G=n("code"),He=r("model([input_ids, attention_mask, token_type_ids])"),We=c(),j=n("li"),Ue=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
tensors in the first argument of the model call function: `),U=s(I,"CODE",{});var rt=a(U);Be=d(rt,"model(inputs)"),rt.forEach(t),De=d(I,"."),I.forEach(t),B=h(L),V=s(L,"P",{});var xe=a(V);ne=d(xe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),xe.forEach(t),we=h(L),C=s(L,"UL",{});var K=a(C);A=s(K,"LI",{});var de=a(A);_e=d(de,"a single Tensor with "),se=s(de,"CODE",{});var Se=a(se);Fe=d(Se,"input_ids"),Se.forEach(t),ge=d(de," only and nothing else: "),R=s(de,"CODE",{});var dt=a(R);Ge=d(dt,"model(input_ids)"),dt.forEach(t),de.forEach(t),ze=h(K),O=s(K,"LI",{});var ie=a(O);Qe=d(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=s(ie,"CODE",{});var it=a(Y);S=d(it,"model([input_ids, attention_mask])"),it.forEach(t),M=d(ie," or "),G=s(ie,"CODE",{});var le=a(G);He=d(le,"model([input_ids, attention_mask, token_type_ids])"),le.forEach(t),ie.forEach(t),We=h(K),j=s(K,"LI",{});var Ve=a(j);Ue=d(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ae=s(Ve,"CODE",{});var Re=a(ae);ye=d(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),K.forEach(t)},m(L,z){g(L,l,z),e(l,b),g(L,u,z),g(L,m,z),e(m,v),e(v,i),e(m,f),e(m,D),e(D,je),g(L,fe,z),g(L,F,z),e(F,Z),e(F,W),e(W,oe),e(F,Ie),e(F,U),e(U,Be),e(F,De),g(L,B,z),g(L,V,z),e(V,ne),g(L,we,z),g(L,C,z),e(C,A),e(A,_e),e(A,se),e(se,Fe),e(A,ge),e(A,R),e(R,Ge),e(C,ze),e(C,O),e(O,Qe),e(O,Y),e(Y,S),e(O,M),e(O,G),e(G,He),e(C,We),e(C,j),e(j,Ue),e(j,ae),e(ae,ye)},d(L){L&&t(l),L&&t(u),L&&t(m),L&&t(fe),L&&t(F),L&&t(B),L&&t(V),L&&t(we),L&&t(C)}}}function Tf($){let l,b,u,m,v;return{c(){l=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var D=a(u);m=d(D,"Module"),D.forEach(t),v=d(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),b=r("Example:"),u=c(),T(m.$$.fragment)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Example:"),f.forEach(t),u=h(i),k(m.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,u,f),w(m,i,f),v=!0},p:Pe,i(i){v||(y(m.$$.fragment,i),v=!0)},o(i){E(m.$$.fragment,i),v=!1},d(i){i&&t(l),i&&t(u),q(m,i)}}}function wf($){let l,b,u,m,v,i,f,D,je,fe,F,Z,W,oe,Ie,U,Be,De,B,V,ne,we,C,A,_e,se,Fe,ge,R,Ge,ze,O,Qe,Y,S,M,G,He,We,j,Ue,ae,ye;return{c(){l=n("p"),b=r("TF 2.0 models accepts two formats as inputs:"),u=c(),m=n("ul"),v=n("li"),i=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=n("li"),je=r("having all inputs as a list, tuple or dict in the first positional arguments."),fe=c(),F=n("p"),Z=r("This second option is useful when using "),W=n("code"),oe=r("tf.keras.Model.fit"),Ie=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),Be=r("model(inputs)"),De=r("."),B=c(),V=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),we=c(),C=n("ul"),A=n("li"),_e=r("a single Tensor with "),se=n("code"),Fe=r("input_ids"),ge=r(" only and nothing else: "),R=n("code"),Ge=r("model(input_ids)"),ze=c(),O=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=n("code"),S=r("model([input_ids, attention_mask])"),M=r(" or "),G=n("code"),He=r("model([input_ids, attention_mask, token_type_ids])"),We=c(),j=n("li"),Ue=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ae=n("code"),ye=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(L){l=s(L,"P",{});var z=a(l);b=d(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),u=h(L),m=s(L,"UL",{});var re=a(m);v=s(re,"LI",{});var nt=a(v);i=d(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(re),D=s(re,"LI",{});var st=a(D);je=d(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),re.forEach(t),fe=h(L),F=s(L,"P",{});var I=a(F);Z=d(I,"This second option is useful when using "),W=s(I,"CODE",{});var at=a(W);oe=d(at,"tf.keras.Model.fit"),at.forEach(t),Ie=d(I,` method which currently requires having all the
...
first positional argument :`),xe.forEach(t),we=h(L),C=s(L,"UL",{});var K=a(C);A=s(K,"LI",{});var de=a(A);_e=d(de,"a single Tensor with "),se=s(de,"CODE",{});var Se=a(se);Fe=d(Se,"input_ids"),Se.forEach(t),ge=d(de," only and nothing else: "),R=s(de,"CODE",{});var dt=a(R);Ge=d(dt,"model(input_ids)"),dt.forEach(t),de.forEach(t),ze=h(K),O=s(K,"LI",{});var ie=a(O);Qe=d(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=s(ie,"CODE",{});var it=a(Y);S=d(it,"model([input_ids, attention_mask])"),it.forEach(t),M=d(ie," or "),G=s(ie,"CODE",{});var le=a(G);He=d(le,"model([input_ids, attention_mask, token_type_ids])"),le.forEach(t),ie.forEach(t),We=h(K),j=s(K,"LI",{});var Ve=a(j);Ue=d(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ae=s(Ve,"CODE",{});var Re=a(ae);ye=d(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),K.forEach(t)},m(L,z){g(L,l,z),e(l,b),g(L,u,z),g(L,m,z),e(m,v),e(v,i),e(m,f),e(m,D),e(D,je),g(L,fe,z),g(L,F,z),e(F,Z),e(F,W),e(W,oe),e(F,Ie),e(F,U),e(U,Be),e(F,De),g(L,B,z),g(L,V,z),e(V,ne),g(L,we,z),g(L,C,z),e(C,A),e(A,_e),e(A,se),e(se,Fe),e(A,ge),e(A,R),e(R,Ge),e(C,ze),e(C,O),e(O,Qe),e(O,Y),e(Y,S),e(O,M),e(O,G),e(G,He),e(C,We),e(C,j),e(j,Ue),e(j,ae),e(ae,ye)},d(L){L&&t(l),L&&t(u),L&&t(m),L&&t(fe),L&&t(F),L&&t(B),L&&t(V),L&&t(we),L&&t(C)}}}function yf($){let l,b,u,m,v;return{c(){l=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var D=a(u);m=d(D,"Module"),D.forEach(t),v=d(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=n("p"),b=r("Examples:"),u=c(),T(m.$$.fragment)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Examples:"),f.forEach(t),u=h(i),k(m.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,u,f),w(m,i,f),v=!0},p:Pe,i(i){v||(y(m.$$.fragment,i),v=!0)},o(i){E(m.$$.fragment,i),v=!1},d(i){i&&t(l),i&&t(u),q(m,i)}}}function qf($){let l,b,u,m,v,i,f,D,je,fe,F,Z,W,oe,Ie,U,Be,De,B,V,ne,we,C,A,_e,se,Fe,ge,R,Ge,ze,O,Qe,Y,S,M,G,He,We,j,Ue,ae,ye,L,z,re,nt,st,I,at,rt,xe,K,de,Se,dt,ie,it,le,Ve,Re,Nd,jd,As,Id,Bd,Gd,Ee,Qd,Ps,Hd,Wd,Ns,Ud,Vd,Zn,Rd,Kd,js,Xd,Jd,Zd,X,Yd,Is,ei,ti,Bs,oi,ni,Yn,si,ai,Gs,ri,di,Qs,ii,li,Hs,ci,hi,pi,lt,ui,Ws,mi,fi,Us,_i,gi,bi,So,vi,Mo,Ti,ki,wi,Co,yi,Oo,Ei,qi,vr,Pt,Li,Ao,$i,Di,Tr,ct,Nt,Vs,Po,Fi,Rs,zi,kr,P,No,xi,ht,Si,es,Mi,Ci,jo,Oi,Ai,Pi,pt,Ni,ts,ji,Ii,os,Bi,Gi,Qi,jt,Hi,Ks,Xs,Js,Zs,Wi,Ui,Ys,ea,ta,It,Bt,oa,Io,Vi,na,Ri,Ki,sa,aa,Bo,Gt,Qt,ra,Go,Xi,da,Ji,Zi,ia,Yi,el,la,ca,ha,Ht,Wt,pa,Qo,tl,ua,ol,wr,ut,Ut,ma,Ho,nl,fa,sl,yr,N,Wo,al,_a,rl,dl,Vt,ns,il,ll,ss,cl,hl,pl,Uo,ul,as,ml,fl,_l,Ke,Vo,gl,ga,bl,vl,Ro,rs,Tl,ba,kl,wl,ds,yl,va,El,ql,Rt,Ko,Ll,Xo,$l,Ta,Dl,Fl,zl,Kt,Jo,xl,ka,Sl,Ml,is,Zo,Er,mt,Xt,wa,Yo,Cl,ya,Ol,qr,qe,en,Al,tn,Pl,Ea,Nl,jl,Il,Jt,ls,Bl,Gl,cs,Ql,Hl,Wl,on,Ul,hs,Vl,Rl,Lr,ft,Zt,qa,nn,Kl,La,Xl,$r,_t,sn,Jl,$a,Zl,Dr,gt,an,Yl,Da,ec,Fr,bt,rn,tc,Fa,oc,zr,vt,dn,nc,za,sc,xr,Tt,ln,ac,xa,rc,Sr,kt,cn,dc,Sa,ic,Mr,wt,hn,lc,Ma,cc,Cr,yt,pn,hc,Ca,pc,Or,Et,Yt,Oa,un,uc,Aa,mc,Ar,Le,mn,fc,fn,_c,ps,gc,bc,vc,_n,Tc,gn,kc,wc,yc,Me,bn,Ec,qt,qc,us,Lc,$c,Pa,Dc,Fc,zc,eo,xc,to,Pr,Lt,oo,Na,vn,Sc,ja,Mc,Nr,$e,Tn,Cc,kn,Oc,ms,Ac,Pc,Nc,wn,jc,yn,Ic,Bc,Gc,be,En,Qc,$t,Hc,fs,Wc,Uc,Ia,Vc,Rc,Kc,no,Xc,so,Jc,ao,jr,Dt,ro,Ba,qn,Zc,Ga,Yc,Ir,ce,Ln,eh,Qa,th,oh,$n,nh,_s,sh,ah,rh,Dn,dh,Fn,ih,lh,ch,Q,zn,hh,Ft,ph,gs,uh,mh,Ha,fh,_h,gh,io,bh,lo,vh,co,Th,ho,kh,po,Br,zt,uo,Wa,xn,wh,Ua,yh,Gr,he,Sn,Eh,xt,qh,Va,Lh,$h,Ra,Dh,Fh,zh,Mn,xh,bs,Sh,Mh,Ch,Cn,Oh,On,Ah,Ph,Nh,ve,An,jh,St,Ih,vs,Bh,Gh,Ka,Qh,Hh,Wh,mo,Uh,fo,Vh,_o,Qr,Mt,go,Xa,Pn,Rh,Ja,Kh,Hr,pe,Nn,Xh,jn,Jh,Ts,Zh,Yh,ep,In,tp,Bn,op,np,sp,bo,ap,Ce,Gn,rp,Ct,dp,ks,ip,lp,Za,cp,hp,pp,vo,up,To,Wr,Ot,ko,Ya,Qn,mp,er,fp,Ur,ue,Hn,_p,Wn,gp,ws,bp,vp,Tp,Un,kp,Vn,wp,yp,Ep,wo,qp,Oe,Rn,Lp,At,$p,ys,Dp,Fp,tr,zp,xp,Sp,yo,Mp,Eo,Vr;return i=new me({}),oe=new me({}),Po=new me({}),No=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/configuration_led.py#L31"}}),jt=new Ae({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[sf]},$$scope:{ctx:$}}}),Io=new me({}),Go=new me({}),Qo=new me({}),Ho=new me({}),Wo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/tokenization_led.py#L43"}}),Vo=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/modeling_tf_led.py#L1373"}}),pn=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/pr_17020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17020/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17020/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/modeling_led.py#L2186",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17020/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/modeling_led.py#L2326",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/modeling_led.py#L2486",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/modeling_led.py#L2613",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
configuration. Check out the <a href="/docs/transformers/pr_17020/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/modeling_tf_led.py#L2191"}}),bo=new xo({props:{$$slots:{default:[vf]},$$scope:{ctx:$}}}),Gn=new x({props:{name:"call",anchor:"transformers.TFLEDModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput, NoneType] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLEDModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17020/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17020/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/modeling_tf_led.py#L2203",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/led/modeling_tf_led.py#L2312",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
`}}),yo=new xo({props:{$$slots:{default:[yf]},$$scope:{ctx:$}}}),Eo=new Ae({props:{anchor:"transformers.TFLEDForConditionalGeneration.call.example",$$slots:{default:[Ef]},$$scope:{ctx:$}}}),{c(){l=n("meta"),b=c(),u=n("h1"),m=n("a"),v=n("span"),T(i.$$.fragment),f=c(),D=n("span"),je=r("LED"),fe=c(),F=n("h2"),Z=n("a"),W=n("span"),T(oe.$$.fragment),Ie=c(),U=n("span"),Be=r("Overview"),De=c(),B=n("p"),V=r("The LED model was proposed in "),ne=n("a"),we=r("Longformer: The Long-Document Transformer"),C=r(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),A=c(),_e=n("p"),se=r("The abstract from the paper is the following:"),Fe=c(),ge=n("p"),R=n("em"),Ge=r(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
dataset.`),ze=c(),O=n("p"),Qe=r("Tips:"),Y=c(),S=n("ul"),M=n("li"),G=n("a"),He=r("LEDForConditionalGeneration"),We=r(` is an extension of
...
`),Se=n("a"),dt=r("BartTokenizer"),ie=r("."),it=c(),le=n("li"),Ve=r("LED works very well on long-range "),Re=n("em"),Nd=r("sequence-to-sequence"),jd=r(" tasks where the "),As=n("code"),Id=r("input_ids"),Bd=r(` largely exceed a length of
1024 tokens.`),Gd=c(),Ee=n("li"),Qd=r("LED pads the "),Ps=n("code"),Hd=r("input_ids"),Wd=r(" to be a multiple of "),Ns=n("code"),Ud=r("config.attention_window"),Vd=r(` if required. Therefore a small speed-up is
gained, when `),Zn=n("a"),Rd=r("LEDTokenizer"),Kd=r(" is used with the "),js=n("code"),Xd=r("pad_to_multiple_of"),Jd=r(" argument."),Zd=c(),X=n("li"),Yd=r("LED makes use of "),Is=n("em"),ei=r("global attention"),ti=r(" by means of the "),Bs=n("code"),oi=r("global_attention_mask"),ni=r(` (see
`),Yn=n("a"),si=r("LongformerModel"),ai=r("). For summarization, it is advised to put "),Gs=n("em"),ri=r("global attention"),di=r(` only on the first
...
documentation from `),os=n("a"),Bi=r("PretrainedConfig"),Gi=r(" for more information."),Qi=c(),T(jt.$$.fragment),Hi=c(),Ks=n("blockquote"),Xs=n("blockquote"),Js=n("blockquote"),Zs=n("p"),Wi=r("from transformers import LEDModel, LEDConfig"),Ui=c(),Ys=n("blockquote"),ea=n("blockquote"),ta=n("blockquote"),It=n("h1"),Bt=n("a"),oa=n("span"),T(Io.$$.fragment),Vi=c(),na=n("span"),Ri=r("Initializing a LED allenai/led-base-16384 style configuration >>> configuration = LEDConfig()"),Ki=c(),sa=n("blockquote"),aa=n("blockquote"),Bo=n("blockquote"),Gt=n("h1"),Qt=n("a"),ra=n("span"),T(Go.$$.fragment),Xi=c(),da=n("span"),Ji=r("Initializing a model from the allenai/led-base-16384 style configuration >>> model ="),Zi=c(),ia=n("p"),Yi=r("LEDModel(configuration)"),el=c(),la=n("blockquote"),ca=n("blockquote"),ha=n("blockquote"),Ht=n("h1"),Wt=n("a"),pa=n("span"),T(Qo.$$.fragment),tl=c(),ua=n("span"),ol=r("Accessing the model configuration >>> configuration = model.config"),wr=c(),ut=n("h2"),Ut=n("a"),ma=n("span"),T(Ho.$$.fragment),nl=c(),fa=n("span"),sl=r("LEDTokenizer"),yr=c(),N=n("div"),T(Wo.$$.fragment),al=c(),_a=n("p"),rl=r("Construct a LED tokenizer."),dl=c(),Vt=n("p"),ns=n("a"),il=r("LEDTokenizer"),ll=r(" is identical to "),ss=n("a"),cl=r("BartTokenizer"),hl=r(` and runs end-to-end tokenization: punctuation splitting and
...
make use of token type ids, therefore a list of zeros is returned.`),Ml=c(),is=n("div"),T(Zo.$$.fragment),Er=c(),mt=n("h2"),Xt=n("a"),wa=n("span"),T(Yo.$$.fragment),Cl=c(),ya=n("span"),Ol=r("LEDTokenizerFast"),qr=c(),qe=n("div"),T(en.$$.fragment),Al=c(),tn=n("p"),Pl=r("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Ea=n("em"),Nl=r("tokenizers"),jl=r(" library)."),Il=c(),Jt=n("p"),ls=n("a"),Bl=r("LEDTokenizerFast"),Gl=r(" is identical to "),cs=n("a"),Ql=r("BartTokenizerFast"),Hl=r(` and runs end-to-end tokenization: punctuation splitting
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nc=c(),wn=n("p"),jc=r("This model is also a PyTorch "),yn=n("a"),Ic=r("torch.nn.Module"),Bc=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc=c(),be=n("div"),T(En.$$.fragment),Qc=c(),$t=n("p"),Hc=r("The "),fs=n("a"),Wc=r("LEDForConditionalGeneration"),Uc=r(" forward method, overrides the "),Ia=n("code"),Vc=r("__call__"),Rc=r(" special method."),Kc=c(),T(no.$$.fragment),Xc=c(),T(so.$$.fragment),Jc=c(),T(ao.$$.fragment),jr=c(),Dt=n("h2"),ro=n("a"),Ba=n("span"),T(qn.$$.fragment),Zc=c(),Ga=n("span"),Yc=r("LEDForSequenceClassification"),Ir=c(),ce=n("div"),T(Ln.$$.fragment),eh=c(),Qa=n("p"),th=r(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ch=c(),Q=n("div"),T(zn.$$.fragment),hh=c(),Ft=n("p"),ph=r("The "),gs=n("a"),uh=r("LEDForSequenceClassification"),mh=r(" forward method, overrides the "),Ha=n("code"),fh=r("__call__"),_h=r(" special method."),gh=c(),T(io.$$.fragment),bh=c(),T(lo.$$.fragment),vh=c(),T(co.$$.fragment),Th=c(),T(ho.$$.fragment),kh=c(),T(po.$$.fragment),Br=c(),zt=n("h2"),uo=n("a"),Wa=n("span"),T(xn.$$.fragment),wh=c(),Ua=n("span"),yh=r("LEDForQuestionAnswering"),Gr=c(),he=n("div"),T(Sn.$$.fragment),Eh=c(),xt=n("p"),qh=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nh=c(),ve=n("div"),T(An.$$.fragment),jh=c(),St=n("p"),Ih=r("The "),vs=n("a"),Bh=r("LEDForQuestionAnswering"),Gh=r(" forward method, overrides the "),Ka=n("code"),Qh=r("__call__"),Hh=r(" special method."),Wh=c(),T(mo.$$.fragment),Uh=c(),T(fo.$$.fragment),Vh=c(),T(_o.$$.fragment),Qr=c(),Mt=n("h2"),go=n("a"),Xa=n("span"),T(Pn.$$.fragment),Rh=c(),Ja=n("span"),Kh=r("TFLEDModel"),Hr=c(),pe=n("div"),T(Nn.$$.fragment),Xh=c(),jn=n("p"),Jh=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep=c(),In=n("p"),tp=r("This model is also a "),Bn=n("a"),op=r("tf.keras.Model"),np=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sp=c(),T(bo.$$.fragment),ap=c(),Ce=n("div"),T(Gn.$$.fragment),rp=c(),Ct=n("p"),dp=r("The "),ks=n("a"),ip=r("TFLEDModel"),lp=r(" forward method, overrides the "),Za=n("code"),cp=r("__call__"),hp=r(" special method."),pp=c(),T(vo.$$.fragment),up=c(),T(To.$$.fragment),Wr=c(),Ot=n("h2"),ko=n("a"),Ya=n("span"),T(Qn.$$.fragment),mp=c(),er=n("span"),fp=r("TFLEDForConditionalGeneration"),Ur=c(),ue=n("div"),T(Hn.$$.fragment),_p=c(),Wn=n("p"),gp=r(`The LED Model with a language modeling head. Can be used for summarization.
...
WikiHop and TriviaQA. We finally introduce the Longformer-Encoder-Decoder (LED), a Longformer variant for supporting
long document generative sequence-to-sequence tasks, and demonstrate its effectiveness on the arXiv summarization
dataset.`),hr.forEach(t),cr.forEach(t),ze=h(o),O=s(o,"P",{});var pr=a(O);Qe=d(pr,"Tips:"),pr.forEach(t),Y=h(o),S=s(o,"UL",{});var J=a(S);M=s(J,"LI",{});var H=a(M);G=s(H,"A",{href:!0});var ur=a(G);He=d(ur,"LEDForConditionalGeneration"),ur.forEach(t),We=d(H,` is an extension of
...
`),Se=s(H,"A",{href:!0});var Np=a(Se);dt=d(Np,"BartTokenizer"),Np.forEach(t),ie=d(H,"."),H.forEach(t),it=h(J),le=s(J,"LI",{});var Es=a(le);Ve=d(Es,"LED works very well on long-range "),Re=s(Es,"EM",{});var jp=a(Re);Nd=d(jp,"sequence-to-sequence"),jp.forEach(t),jd=d(Es," tasks where the "),As=s(Es,"CODE",{});var Ip=a(As);Id=d(Ip,"input_ids"),Ip.forEach(t),Bd=d(Es,` largely exceed a length of
1024 tokens.`),Es.forEach(t),Gd=h(J),Ee=s(J,"LI",{});var Xe=a(Ee);Qd=d(Xe,"LED pads the "),Ps=s(Xe,"CODE",{});var Bp=a(Ps);Hd=d(Bp,"input_ids"),Bp.forEach(t),Wd=d(Xe," to be a multiple of "),Ns=s(Xe,"CODE",{});var Gp=a(Ns);Ud=d(Gp,"config.attention_window"),Gp.forEach(t),Vd=d(Xe,` if required. Therefore a small speed-up is
gained, when `),Zn=s(Xe,"A",{href:!0});var Qp=a(Zn);Rd=d(Qp,"LEDTokenizer"),Qp.forEach(t),Kd=d(Xe," is used with the "),js=s(Xe,"CODE",{});var Hp=a(js);Xd=d(Hp,"pad_to_multiple_of"),Hp.forEach(t),Jd=d(Xe," argument."),Xe.forEach(t),Zd=h(J),X=s(J,"LI",{});var Te=a(X);Yd=d(Te,"LED makes use of "),Is=s(Te,"EM",{});var Wp=a(Is);ei=d(Wp,"global attention"),Wp.forEach(t),ti=d(Te," by means of the "),Bs=s(Te,"CODE",{});var Up=a(Bs);oi=d(Up,"global_attention_mask"),Up.forEach(t),ni=d(Te,` (see
`),Yn=s(Te,"A",{href:!0});var Vp=a(Yn);si=d(Vp,"LongformerModel"),Vp.forEach(t),ai=d(Te,"). For summarization, it is advised to put "),Gs=s(Te,"EM",{});var Rp=a(Gs);ri=d(Rp,"global attention"),Rp.forEach(t),di=d(Te,` only on the first
...
special tokens using the tokenizer `),Ta=s(rd,"CODE",{});var Bu=a(Ta);Dl=d(Bu,"prepare_for_model"),Bu.forEach(t),Fl=d(rd," method."),rd.forEach(t),ad.forEach(t),zl=h(te),Kt=s(te,"DIV",{class:!0});var dd=a(Kt);k(Jo.$$.fragment,dd),xl=h(dd),ka=s(dd,"P",{});var Gu=a(ka);Sl=d(Gu,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Gu.forEach(t),dd.forEach(t),Ml=h(te),is=s(te,"DIV",{class:!0});var Qu=a(is);k(Zo.$$.fragment,Qu),Qu.forEach(t),te.forEach(t),Er=h(o),mt=s(o,"H2",{class:!0});var id=a(mt);Xt=s(id,"A",{id:!0,class:!0,href:!0});var Hu=a(Xt);wa=s(Hu,"SPAN",{});var Wu=a(wa);k(Yo.$$.fragment,Wu),Wu.forEach(t),Hu.forEach(t),Cl=h(id),ya=s(id,"SPAN",{});var Uu=a(ya);Ol=d(Uu,"LEDTokenizerFast"),Uu.forEach(t),id.forEach(t),qr=h(o),qe=s(o,"DIV",{class:!0});var qo=a(qe);k(en.$$.fragment,qo),Al=h(qo),tn=s(qo,"P",{});var ld=a(tn);Pl=d(ld,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Ea=s(ld,"EM",{});var Vu=a(Ea);Nl=d(Vu,"tokenizers"),Vu.forEach(t),jl=d(ld," library)."),ld.forEach(t),Il=h(qo),Jt=s(qo,"P",{});var br=a(Jt);ls=s(br,"A",{href:!0});var Ru=a(ls);Bl=d(Ru,"LEDTokenizerFast"),Ru.forEach(t),Gl=d(br," is identical to "),cs=s(br,"A",{href:!0});var Ku=a(cs);Ql=d(Ku,"BartTokenizerFast"),Ku.forEach(t),Hl=d(br,` and runs end-to-end tokenization: punctuation splitting
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xd.forEach(t),Nh=h(Ye),ve=s(Ye,"DIV",{class:!0});var et=a(ve);k(An.$$.fragment,et),jh=h(et),St=s(et,"P",{});var Ms=a(St);Ih=d(Ms,"The "),vs=s(Ms,"A",{href:!0});var Pm=a(vs);Bh=d(Pm,"LEDForQuestionAnswering"),Pm.forEach(t),Gh=d(Ms," forward method, overrides the "),Ka=s(Ms,"CODE",{});var Nm=a(Ka);Qh=d(Nm,"__call__"),Nm.forEach(t),Hh=d(Ms," special method."),Ms.forEach(t),Wh=h(et),k(mo.$$.fragment,et),Uh=h(et),k(fo.$$.fragment,et),Vh=h(et),k(_o.$$.fragment,et),et.forEach(t),Ye.forEach(t),Qr=h(o),Mt=s(o,"H2",{class:!0});var Sd=a(Mt);go=s(Sd,"A",{id:!0,class:!0,href:!0});var jm=a(go);Xa=s(jm,"SPAN",{});var Im=a(Xa);k(Pn.$$.fragment,Im),Im.forEach(t),jm.forEach(t),Rh=h(Sd),Ja=s(Sd,"SPAN",{});var Bm=a(Ja);Kh=d(Bm,"TFLEDModel"),Bm.forEach(t),Sd.forEach(t),Hr=h(o),pe=s(o,"DIV",{class:!0});var tt=a(pe);k(Nn.$$.fragment,tt),Xh=h(tt),jn=s(tt,"P",{});var Md=a(jn);Jh=d(Md,`The bare LED Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ts=s(Md,"A",{href:!0});var Gm=a(Ts);Zh=d(Gm,"TFPreTrainedModel"),Gm.forEach(t),Yh=d(Md,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Md.forEach(t),ep=h(tt),In=s(tt,"P",{});var Cd=a(In);tp=d(Cd,"This model is also a "),Bn=s(Cd,"A",{href:!0,rel:!0});var Qm=a(Bn);op=d(Qm,"tf.keras.Model"),Qm.forEach(t),np=d(Cd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cd.forEach(t),sp=h(tt),k(bo.$$.fragment,tt),ap=h(tt),Ce=s(tt,"DIV",{class:!0});var Fo=a(Ce);k(Gn.$$.fragment,Fo),rp=h(Fo),Ct=s(Fo,"P",{});var Cs=a(Ct);dp=d(Cs,"The "),ks=s(Cs,"A",{href:!0});var Hm=a(ks);ip=d(Hm,"TFLEDModel"),Hm.forEach(t),lp=d(Cs," forward method, overrides the "),Za=s(Cs,"CODE",{});var Wm=a(Za);cp=d(Wm,"__call__"),Wm.forEach(t),hp=d(Cs," special method."),Cs.forEach(t),pp=h(Fo),k(vo.$$.fragment,Fo),up=h(Fo),k(To.$$.fragment,Fo),Fo.forEach(t),tt.forEach(t),Wr=h(o),Ot=s(o,"H2",{class:!0});var Od=a(Ot);ko=s(Od,"A",{id:!0,class:!0,href:!0});var Um=a(ko);Ya=s(Um,"SPAN",{});var Vm=a(Ya);k(Qn.$$.fragment,Vm),Vm.forEach(t),Um.forEach(t),mp=h(Od),er=s(Od,"SPAN",{});var Rm=a(er);fp=d(Rm,"TFLEDForConditionalGeneration"),Rm.forEach(t),Od.forEach(t),Ur=h(o),ue=s(o,"DIV",{class:!0});var ot=a(ue);k(Hn.$$.fragment,ot),_p=h(ot),Wn=s(ot,"P",{});var Ad=a(Wn);gp=d(Ad,`The LED Model with a language modeling head. Can be used for summarization.
