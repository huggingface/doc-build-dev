...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17020/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_17020/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17020/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17020/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17020/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17020/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17020/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17020/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17020/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17020/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17020/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17020/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17020/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17020/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_17020/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17020/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ww=c(),kh=n("p"),Uw=r("Finally, this model supports inherent JAX features such as:"),Rw=c(),Kt=n("ul"),vh=n("li"),ol=n("a"),Hw=r("Just-In-Time (JIT) compilation"),Qw=c(),Th=n("li"),nl=n("a"),Bw=r("Automatic Differentiation"),Vw=c(),bh=n("li"),sl=n("a"),Kw=r("Vectorization"),Jw=c(),yh=n("li"),al=n("a"),Gw=r("Parallelization"),Xw=c(),Pt=n("div"),b(rl.$$.fragment),Yw=c(),ln=n("p"),Zw=r("The "),Eh=n("code"),e2=r("FlaxElectraPreTrainedModel"),t2=r(" forward method, overrides the "),wh=n("code"),o2=r("__call__"),n2=r(" special method."),s2=c(),b(Us.$$.fragment),a2=c(),b(Rs.$$.fragment),Nu=c(),dn=n("h2"),Hs=n("a"),$h=n("span"),b(il.$$.fragment),r2=c(),Fh=n("span"),i2=r("FlaxElectraForMultipleChoice"),Iu=c(),We=n("div"),b(ll.$$.fragment),l2=c(),xh=n("p"),d2=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),c2=c(),dl=n("p"),p2=r("This model inherits from "),Dd=n("a"),h2=r("FlaxPreTrainedModel"),m2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),u2=c(),cl=n("p"),f2=r(`This model is also a Flax Linen
`),pl=n("a"),g2=r("flax.nn.Module"),_2=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),k2=c(),Mh=n("p"),v2=r("Finally, this model supports inherent JAX features such as:"),T2=c(),Jt=n("ul"),zh=n("li"),hl=n("a"),b2=r("Just-In-Time (JIT) compilation"),y2=c(),Ch=n("li"),ml=n("a"),E2=r("Automatic Differentiation"),w2=c(),jh=n("li"),ul=n("a"),$2=r("Vectorization"),F2=c(),qh=n("li"),fl=n("a"),x2=r("Parallelization"),M2=c(),At=n("div"),b(gl.$$.fragment),z2=c(),cn=n("p"),C2=r("The "),Ph=n("code"),j2=r("FlaxElectraPreTrainedModel"),q2=r(" forward method, overrides the "),Ah=n("code"),P2=r("__call__"),A2=r(" special method."),O2=c(),b(Qs.$$.fragment),L2=c(),b(Bs.$$.fragment),Su=c(),pn=n("h2"),Vs=n("a"),Oh=n("span"),b(_l.$$.fragment),N2=c(),Lh=n("span"),I2=r("FlaxElectraForTokenClassification"),Du=c(),Ae=n("div"),b(kl.$$.fragment),S2=c(),Nh=n("p"),D2=r("Electra model with a token classification head on top."),W2=c(),Ih=n("p"),U2=r("Both the discriminator and generator may be loaded into this model."),R2=c(),vl=n("p"),H2=r("This model inherits from "),Wd=n("a"),Q2=r("FlaxPreTrainedModel"),B2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),V2=c(),Tl=n("p"),K2=r(`This model is also a Flax Linen
`),bl=n("a"),J2=r("flax.nn.Module"),G2=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),X2=c(),Sh=n("p"),Y2=r("Finally, this model supports inherent JAX features such as:"),Z2=c(),Gt=n("ul"),Dh=n("li"),yl=n("a"),e0=r("Just-In-Time (JIT) compilation"),t0=c(),Wh=n("li"),El=n("a"),o0=r("Automatic Differentiation"),n0=c(),Uh=n("li"),wl=n("a"),s0=r("Vectorization"),a0=c(),Rh=n("li"),$l=n("a"),r0=r("Parallelization"),i0=c(),Ot=n("div"),b(Fl.$$.fragment),l0=c(),hn=n("p"),d0=r("The "),Hh=n("code"),c0=r("FlaxElectraPreTrainedModel"),p0=r(" forward method, overrides the "),Qh=n("code"),h0=r("__call__"),m0=r(" special method."),u0=c(),b(Ks.$$.fragment),f0=c(),b(Js.$$.fragment),Wu=c(),mn=n("h2"),Gs=n("a"),Bh=n("span"),b(xl.$$.fragment),g0=c(),Vh=n("span"),_0=r("FlaxElectraForQuestionAnswering"),Uu=c(),Ue=n("div"),b(Ml.$$.fragment),k0=c(),un=n("p"),v0=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Kh=n("code"),T0=r("span start logits"),b0=r(" and "),Jh=n("code"),y0=r("span end logits"),E0=r(")."),w0=c(),zl=n("p"),$0=r("This model inherits from "),Ud=n("a"),F0=r("FlaxPreTrainedModel"),x0=r(`. Check the superclass documentation for the generic methods the
...
splitting and wordpiece.`),ea.forEach(t),Gg=p(oo),ja=s(oo,"P",{});var Bl=a(ja);Xg=i(Bl,"Refer to superclass "),nd=s(Bl,"A",{href:!0});var Wm=a(nd);Yg=i(Wm,"BertTokenizerFast"),Wm.forEach(t),Zg=i(Bl," for usage examples and documentation concerning parameters."),Bl.forEach(t),oo.forEach(t),Gm=p(o),vo=s(o,"H2",{class:!0});var Vl=a(vo);En=s(Vl,"A",{id:!0,class:!0,href:!0});var Um=a(En);yc=s(Um,"SPAN",{});var Rm=a(yc);y(qa.$$.fragment,Rm),Rm.forEach(t),Um.forEach(t),e_=p(Vl),Ec=s(Vl,"SPAN",{});var Hm=a(Ec);t_=i(Hm,"Electra specific outputs"),Hm.forEach(t),Vl.forEach(t),Xm=p(o),To=s(o,"DIV",{class:!0});var Hu=a(To);y(Pa.$$.fragment,Hu),o_=p(Hu),Aa=s(Hu,"P",{});var Qu=a(Aa);n_=i(Qu,"Output type of "),sd=s(Qu,"A",{href:!0});var X0=a(sd);s_=i(X0,"ElectraForPreTraining"),X0.forEach(t),a_=i(Qu,"."),Qu.forEach(t),Hu.forEach(t),Ym=p(o),bo=s(o,"DIV",{class:!0});var Bu=a(bo);y(Oa.$$.fragment,Bu),r_=p(Bu),La=s(Bu,"P",{});var Vu=a(La);i_=i(Vu,"Output type of "),ad=s(Vu,"A",{href:!0});var Y0=a(ad);l_=i(Y0,"TFElectraForPreTraining"),Y0.forEach(t),d_=i(Vu,"."),Vu.forEach(t),Bu.forEach(t),Zm=p(o),yo=s(o,"H2",{class:!0});var Ku=a(yo);wn=s(Ku,"A",{id:!0,class:!0,href:!0});var Z0=a(wn);wc=s(Z0,"SPAN",{});var e$=a(wc);y(Na.$$.fragment,e$),e$.forEach(t),Z0.forEach(t),c_=p(Ku),$c=s(Ku,"SPAN",{});var t$=a($c);p_=i(t$,"ElectraModel"),t$.forEach(t),Ku.forEach(t),eu=p(o),Ze=s(o,"DIV",{class:!0});var no=a(Ze);y(Ia.$$.fragment,no),h_=p(no),Fc=s(no,"P",{});var o$=a(Fc);m_=i(o$,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),o$.forEach(t),u_=p(no),Sa=s(no,"P",{});var Ju=a(Sa);f_=i(Ju,"This model inherits from "),rd=s(Ju,"A",{href:!0});var n$=a(rd);g_=i(n$,"PreTrainedModel"),n$.forEach(t),__=i(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju.forEach(t),k_=p(no),Da=s(no,"P",{});var Gu=a(Da);v_=i(Gu,"This model is also a PyTorch "),Wa=s(Gu,"A",{href:!0,rel:!0});var s$=a(Wa);T_=i(s$,"torch.nn.Module"),s$.forEach(t),b_=i(Gu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gu.forEach(t),y_=p(no),Et=s(no,"DIV",{class:!0});var ta=a(Et);y(Ua.$$.fragment,ta),E_=p(ta),Eo=s(ta,"P",{});var Rd=a(Eo);w_=i(Rd,"The "),id=s(Rd,"A",{href:!0});var a$=a(id);$_=i(a$,"ElectraModel"),a$.forEach(t),F_=i(Rd," forward method, overrides the "),xc=s(Rd,"CODE",{});var r$=a(xc);x_=i(r$,"__call__"),r$.forEach(t),M_=i(Rd," special method."),Rd.forEach(t),z_=p(ta),y($n.$$.fragment,ta),C_=p(ta),y(Fn.$$.fragment,ta),ta.forEach(t),no.forEach(t),tu=p(o),wo=s(o,"H2",{class:!0});var Xu=a(wo);xn=s(Xu,"A",{id:!0,class:!0,href:!0});var i$=a(xn);Mc=s(i$,"SPAN",{});var l$=a(Mc);y(Ra.$$.fragment,l$),l$.forEach(t),i$.forEach(t),j_=p(Xu),zc=s(Xu,"SPAN",{});var d$=a(zc);q_=i(d$,"ElectraForPreTraining"),d$.forEach(t),Xu.forEach(t),ou=p(o),He=s(o,"DIV",{class:!0});var Nt=a(He);y(Ha.$$.fragment,Nt),P_=p(Nt),Cc=s(Nt,"P",{});var c$=a(Cc);A_=i(c$,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),c$.forEach(t),O_=p(Nt),jc=s(Nt,"P",{});var p$=a(jc);L_=i(p$,"It is recommended to load the discriminator checkpoint into that model."),p$.forEach(t),N_=p(Nt),Qa=s(Nt,"P",{});var Yu=a(Qa);I_=i(Yu,"This model inherits from "),ld=s(Yu,"A",{href:!0});var h$=a(ld);S_=i(h$,"PreTrainedModel"),h$.forEach(t),D_=i(Yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yu.forEach(t),W_=p(Nt),Ba=s(Nt,"P",{});var Zu=a(Ba);U_=i(Zu,"This model is also a PyTorch "),Va=s(Zu,"A",{href:!0,rel:!0});var m$=a(Va);R_=i(m$,"torch.nn.Module"),m$.forEach(t),H_=i(Zu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zu.forEach(t),Q_=p(Nt),wt=s(Nt,"DIV",{class:!0});var oa=a(wt);y(Ka.$$.fragment,oa),B_=p(oa),$o=s(oa,"P",{});var Hd=a($o);V_=i(Hd,"The "),dd=s(Hd,"A",{href:!0});var u$=a(dd);K_=i(u$,"ElectraForPreTraining"),u$.forEach(t),J_=i(Hd," forward method, overrides the "),qc=s(Hd,"CODE",{});var f$=a(qc);G_=i(f$,"__call__"),f$.forEach(t),X_=i(Hd," special method."),Hd.forEach(t),Y_=p(oa),y(Mn.$$.fragment,oa),Z_=p(oa),y(zn.$$.fragment,oa),oa.forEach(t),Nt.forEach(t),nu=p(o),Fo=s(o,"H2",{class:!0});var ef=a(Fo);Cn=s(ef,"A",{id:!0,class:!0,href:!0});var g$=a(Cn);Pc=s(g$,"SPAN",{});var _$=a(Pc);y(Ja.$$.fragment,_$),_$.forEach(t),g$.forEach(t),ek=p(ef),Ac=s(ef,"SPAN",{});var k$=a(Ac);tk=i(k$,"ElectraForCausalLM"),k$.forEach(t),ef.forEach(t),su=p(o),et=s(o,"DIV",{class:!0});var so=a(et);y(Ga.$$.fragment,so),ok=p(so),Xa=s(so,"P",{});var tf=a(Xa);nk=i(tf,"ELECTRA Model with a "),Oc=s(tf,"CODE",{});var v$=a(Oc);sk=i(v$,"language modeling"),v$.forEach(t),ak=i(tf," head on top for CLM fine-tuning."),tf.forEach(t),rk=p(so),Ya=s(so,"P",{});var of=a(Ya);ik=i(of,"This model inherits from "),cd=s(of,"A",{href:!0});var T$=a(cd);lk=i(T$,"PreTrainedModel"),T$.forEach(t),dk=i(of,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),of.forEach(t),ck=p(so),Za=s(so,"P",{});var nf=a(Za);pk=i(nf,"This model is also a PyTorch "),er=s(nf,"A",{href:!0,rel:!0});var b$=a(er);hk=i(b$,"torch.nn.Module"),b$.forEach(t),mk=i(nf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nf.forEach(t),uk=p(so),$t=s(so,"DIV",{class:!0});var na=a($t);y(tr.$$.fragment,na),fk=p(na),xo=s(na,"P",{});var Qd=a(xo);gk=i(Qd,"The "),pd=s(Qd,"A",{href:!0});var y$=a(pd);_k=i(y$,"ElectraForCausalLM"),y$.forEach(t),kk=i(Qd," forward method, overrides the "),Lc=s(Qd,"CODE",{});var E$=a(Lc);vk=i(E$,"__call__"),E$.forEach(t),Tk=i(Qd," special method."),Qd.forEach(t),bk=p(na),y(jn.$$.fragment,na),yk=p(na),y(qn.$$.fragment,na),na.forEach(t),so.forEach(t),au=p(o),Mo=s(o,"H2",{class:!0});var sf=a(Mo);Pn=s(sf,"A",{id:!0,class:!0,href:!0});var w$=a(Pn);Nc=s(w$,"SPAN",{});var $$=a(Nc);y(or.$$.fragment,$$),$$.forEach(t),w$.forEach(t),Ek=p(sf),Ic=s(sf,"SPAN",{});var F$=a(Ic);wk=i(F$,"ElectraForMaskedLM"),F$.forEach(t),sf.forEach(t),ru=p(o),Qe=s(o,"DIV",{class:!0});var It=a(Qe);y(nr.$$.fragment,It),$k=p(It),Sc=s(It,"P",{});var x$=a(Sc);Fk=i(x$,"Electra model with a language modeling head on top."),x$.forEach(t),xk=p(It),Dc=s(It,"P",{});var M$=a(Dc);Mk=i(M$,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),M$.forEach(t),zk=p(It),sr=s(It,"P",{});var af=a(sr);Ck=i(af,"This model inherits from "),hd=s(af,"A",{href:!0});var z$=a(hd);jk=i(z$,"PreTrainedModel"),z$.forEach(t),qk=i(af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),af.forEach(t),Pk=p(It),ar=s(It,"P",{});var rf=a(ar);Ak=i(rf,"This model is also a PyTorch "),rr=s(rf,"A",{href:!0,rel:!0});var C$=a(rr);Ok=i(C$,"torch.nn.Module"),C$.forEach(t),Lk=i(rf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rf.forEach(t),Nk=p(It),st=s(It,"DIV",{class:!0});var ao=a(st);y(ir.$$.fragment,ao),Ik=p(ao),zo=s(ao,"P",{});var Bd=a(zo);Sk=i(Bd,"The "),md=s(Bd,"A",{href:!0});var j$=a(md);Dk=i(j$,"ElectraForMaskedLM"),j$.forEach(t),Wk=i(Bd," forward method, overrides the "),Wc=s(Bd,"CODE",{});var q$=a(Wc);Uk=i(q$,"__call__"),q$.forEach(t),Rk=i(Bd," special method."),Bd.forEach(t),Hk=p(ao),y(An.$$.fragment,ao),Qk=p(ao),y(On.$$.fragment,ao),Bk=p(ao),y(Ln.$$.fragment,ao),ao.forEach(t),It.forEach(t),iu=p(o),Co=s(o,"H2",{class:!0});var lf=a(Co);Nn=s(lf,"A",{id:!0,class:!0,href:!0});var P$=a(Nn);Uc=s(P$,"SPAN",{});var A$=a(Uc);y(lr.$$.fragment,A$),A$.forEach(t),P$.forEach(t),Vk=p(lf),Rc=s(lf,"SPAN",{});var O$=a(Rc);Kk=i(O$,"ElectraForSequenceClassification"),O$.forEach(t),lf.forEach(t),lu=p(o),tt=s(o,"DIV",{class:!0});var ro=a(tt);y(dr.$$.fragment,ro),Jk=p(ro),Hc=s(ro,"P",{});var L$=a(Hc);Gk=i(L$,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),L$.forEach(t),Xk=p(ro),cr=s(ro,"P",{});var df=a(cr);Yk=i(df,"This model inherits from "),ud=s(df,"A",{href:!0});var N$=a(ud);Zk=i(N$,"PreTrainedModel"),N$.forEach(t),ev=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),df.forEach(t),tv=p(ro),pr=s(ro,"P",{});var cf=a(pr);ov=i(cf,"This model is also a PyTorch "),hr=s(cf,"A",{href:!0,rel:!0});var I$=a(hr);nv=i(I$,"torch.nn.Module"),I$.forEach(t),sv=i(cf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cf.forEach(t),av=p(ro),Re=s(ro,"DIV",{class:!0});var pt=a(Re);y(mr.$$.fragment,pt),rv=p(pt),jo=s(pt,"P",{});var Vd=a(jo);iv=i(Vd,"The "),fd=s(Vd,"A",{href:!0});var S$=a(fd);lv=i(S$,"ElectraForSequenceClassification"),S$.forEach(t),dv=i(Vd," forward method, overrides the "),Qc=s(Vd,"CODE",{});var D$=a(Qc);cv=i(D$,"__call__"),D$.forEach(t),pv=i(Vd," special method."),Vd.forEach(t),hv=p(pt),y(In.$$.fragment,pt),mv=p(pt),y(Sn.$$.fragment,pt),uv=p(pt),y(Dn.$$.fragment,pt),fv=p(pt),y(Wn.$$.fragment,pt),gv=p(pt),y(Un.$$.fragment,pt),pt.forEach(t),ro.forEach(t),du=p(o),qo=s(o,"H2",{class:!0});var pf=a(qo);Rn=s(pf,"A",{id:!0,class:!0,href:!0});var W$=a(Rn);Bc=s(W$,"SPAN",{});var U$=a(Bc);y(ur.$$.fragment,U$),U$.forEach(t),W$.forEach(t),_v=p(pf),Vc=s(pf,"SPAN",{});var R$=a(Vc);kv=i(R$,"ElectraForMultipleChoice"),R$.forEach(t),pf.forEach(t),cu=p(o),ot=s(o,"DIV",{class:!0});var io=a(ot);y(fr.$$.fragment,io),vv=p(io),Kc=s(io,"P",{});var H$=a(Kc);Tv=i(H$,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),H$.forEach(t),bv=p(io),gr=s(io,"P",{});var hf=a(gr);yv=i(hf,"This model inherits from "),gd=s(hf,"A",{href:!0});var Q$=a(gd);Ev=i(Q$,"PreTrainedModel"),Q$.forEach(t),wv=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),$v=p(io),_r=s(io,"P",{});var mf=a(_r);Fv=i(mf,"This model is also a PyTorch "),kr=s(mf,"A",{href:!0,rel:!0});var B$=a(kr);xv=i(B$,"torch.nn.Module"),B$.forEach(t),Mv=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mf.forEach(t),zv=p(io),Ft=s(io,"DIV",{class:!0});var sa=a(Ft);y(vr.$$.fragment,sa),Cv=p(sa),Po=s(sa,"P",{});var Kd=a(Po);jv=i(Kd,"The "),_d=s(Kd,"A",{href:!0});var V$=a(_d);qv=i(V$,"ElectraForMultipleChoice"),V$.forEach(t),Pv=i(Kd," forward method, overrides the "),Jc=s(Kd,"CODE",{});var K$=a(Jc);Av=i(K$,"__call__"),K$.forEach(t),Ov=i(Kd," special method."),Kd.forEach(t),Lv=p(sa),y(Hn.$$.fragment,sa),Nv=p(sa),y(Qn.$$.fragment,sa),sa.forEach(t),io.forEach(t),pu=p(o),Ao=s(o,"H2",{class:!0});var uf=a(Ao);Bn=s(uf,"A",{id:!0,class:!0,href:!0});var J$=a(Bn);Gc=s(J$,"SPAN",{});var G$=a(Gc);y(Tr.$$.fragment,G$),G$.forEach(t),J$.forEach(t),Iv=p(uf),Xc=s(uf,"SPAN",{});var X$=a(Xc);Sv=i(X$,"ElectraForTokenClassification"),X$.forEach(t),uf.forEach(t),hu=p(o),Be=s(o,"DIV",{class:!0});var St=a(Be);y(br.$$.fragment,St),Dv=p(St),Yc=s(St,"P",{});var Y$=a(Yc);Wv=i(Y$,"Electra model with a token classification head on top."),Y$.forEach(t),Uv=p(St),Zc=s(St,"P",{});var Z$=a(Zc);Rv=i(Z$,"Both the discriminator and generator may be loaded into this model."),Z$.forEach(t),Hv=p(St),yr=s(St,"P",{});var ff=a(yr);Qv=i(ff,"This model inherits from "),kd=s(ff,"A",{href:!0});var eF=a(kd);Bv=i(eF,"PreTrainedModel"),eF.forEach(t),Vv=i(ff,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
