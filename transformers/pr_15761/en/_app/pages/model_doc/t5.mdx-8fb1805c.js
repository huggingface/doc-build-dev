...
configuration. Check out the <a href="/docs/transformers/pr_15761/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ys=new P({props:{name:"forward",anchor:"transformers.T5Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15761/src/transformers/models/t5/modeling_t5.py#L1340",parametersDescription:[{anchor:"transformers.T5Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15761/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15761/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15761/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15761/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Es=new P({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15761/src/transformers/models/t5/modeling_t5.py#L1308"}}),qs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),Gs=new P({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15761/src/transformers/models/t5/modeling_t5.py#L1503"}}),Bs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)`}}),ea=new P({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15761/src/transformers/models/t5/modeling_t5.py#L1779"}}),ta=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wk=d(),f(to.$$.fragment),Rk=d(),Xe=o("div"),f(qa.$$.fragment),Hk=d(),vn=o("p"),Vk=r("The "),Fr=o("a"),Kk=r("TFT5EncoderModel"),Yk=r(" forward method, overrides the "),gl=o("code"),Jk=r("__call__"),Zk=r(" special method."),Xk=d(),f(no.$$.fragment),Qk=d(),Tl=o("p"),e1=r("Examples:"),t1=d(),f(ja.$$.fragment),Ac=d(),bn=o("h2"),oo=o("a"),kl=o("span"),f(Fa.$$.fragment),n1=d(),vl=o("span"),o1=r("FlaxT5Model"),Nc=d(),yt=o("div"),Qe=o("div"),f(Ma.$$.fragment),s1=d(),wn=o("p"),a1=r("The "),bl=o("code"),r1=r("FlaxT5PreTrainedModel"),i1=r("forward method, overrides the "),wl=o("code"),d1=r("__call__"),l1=r(" special method."),c1=d(),f(so.$$.fragment),p1=d(),yl=o("p"),h1=r("Example:"),u1=d(),f(Pa.$$.fragment),m1=d(),Mt=o("div"),f(Ca.$$.fragment),f1=d(),zl=o("p"),_1=r("Example:"),g1=d(),f(Aa.$$.fragment),T1=d(),Pt=o("div"),f(Na.$$.fragment),k1=d(),$l=o("p"),v1=r("Example:"),b1=d(),f(La.$$.fragment),Lc=d(),yn=o("h2"),ao=o("a"),xl=o("span"),f(Ia.$$.fragment),w1=d(),El=o("span"),y1=r("FlaxT5ForConditionalGeneration"),Ic=d(),zt=o("div"),et=o("div"),f(Da.$$.fragment),z1=d(),zn=o("p"),$1=r("The "),ql=o("code"),x1=r("FlaxT5PreTrainedModel"),E1=r("forward method, overrides the "),jl=o("code"),q1=r("__call__"),j1=r(" special method."),F1=d(),f(ro.$$.fragment),M1=d(),Fl=o("p"),P1=r("Example:"),C1=d(),f(Sa.$$.fragment),A1=d(),Ct=o("div"),f(Oa.$$.fragment),N1=d(),Ml=o("p"),L1=r("Example:"),I1=d(),f(Ga.$$.fragment),D1=d(),At=o("div"),f(Ba.$$.fragment),S1=d(),Pl=o("p"),O1=r("Example:"),G1=d(),f(Ua.$$.fragment),this.h()},l(n){const h=cy('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),x=l(n),b=s(n,"H1",{class:!0});var Wa=a(b);y=s(Wa,"A",{id:!0,class:!0,href:!0});var Cl=a(y);$=s(Cl,"SPAN",{});var Al=a($);_(z.$$.fragment,Al),Al.forEach(t),Cl.forEach(t),w=l(Wa),E=s(Wa,"SPAN",{});var Nl=a(E);Ee=i(Nl,"T5"),Nl.forEach(t),Wa.forEach(t),oe=l(n),q=s(n,"H2",{class:!0});var Ra=a(q);ee=s(Ra,"A",{id:!0,class:!0,href:!0});var Ll=a(ee);O=s(Ll,"SPAN",{});var Il=a(O);_(se.$$.fragment,Il),Il.forEach(t),Ll.forEach(t),qe=l(Ra),G=s(Ra,"SPAN",{});var Dl=a(G);je=i(Dl,"Overview"),Dl.forEach(t),Ra.forEach(t),ve=l(n),B=s(n,"P",{});var Ha=a(B);I=i(Ha,"The T5 model was presented in "),ae=s(Ha,"A",{href:!0,rel:!0});var Sl=a(ae);pe=i(Sl,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Sl.forEach(t),F=i(Ha,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),Ha.forEach(t),C=l(n),he=s(n,"P",{});var Ol=a(he);K=i(Ol,"The abstract from the paper is the following:"),Ol.forEach(t),be=l(n),ue=s(n,"P",{});var V1=a(ue);U=s(V1,"EM",{});var K1=a(U);Fe=i(K1,`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
task, has emerged as a powerful technique in natural language processing (NLP). The effectiveness of transfer learning
has given rise to a diversity of approaches, methodology, and practice. In this paper, we explore the landscape of
transfer learning techniques for NLP by introducing a unified framework that converts every language problem into a
text-to-text format. Our systematic study compares pretraining objectives, architectures, unlabeled datasets, transfer
...
with scale and our new \u201CColossal Clean Crawled Corpus\u201D, we achieve state-of-the-art results on many benchmarks covering
summarization, question answering, text classification, and more. To facilitate future work on transfer learning for
NLP, we release our dataset, pre-trained models, and code.`),K1.forEach(t),V1.forEach(t),we=l(n),M=s(n,"P",{});var Y1=a(M);Me=i(Y1,"Tips:"),Y1.forEach(t),H=l(n),V=s(n,"UL",{});var Mr=a(V);me=s(Mr,"LI",{});var J1=a(me);A=s(J1,"P",{});var Pr=a(A);Pe=i(Pr,`T5 is an encoder-decoder model pre-trained on a multi-task mixture of unsupervised and supervised tasks and for which
each task is converted into a text-to-text format. T5 works well on a variety of tasks out-of-the-box by prepending a
different prefix to the input corresponding to each task, e.g., for translation: `),fe=s(Pr,"EM",{});var Z1=a(fe);D=i(Z1,"translate English to German: \u2026"),Z1.forEach(t),Ce=i(Pr,`,
for summarization: `),W=s(Pr,"EM",{});var X1=a(W);Ae=i(X1,"summarize: \u2026"),X1.forEach(t),m=i(Pr,"."),Pr.forEach(t),J1.forEach(t),j=l(Mr),te=s(Mr,"LI",{});var Q1=a(te);Oe=s(Q1,"P",{});var ev=a(Oe);lt=i(ev,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),ev.forEach(t),Q1.forEach(t),S=l(Mr),Ge=s(Mr,"LI",{});var tv=a(Ge);ne=s(tv,"P",{});var io=a(ne);ct=i(io,"See the "),N=s(io,"A",{href:!0});var nv=a(N);Y=i(nv,"training"),nv.forEach(t),pt=i(io,", "),Ne=s(io,"A",{href:!0});var ov=a(Ne);J=i(ov,"inference"),ov.forEach(t),ht=i(io," and "),Le=s(io,"A",{href:!0});var sv=a(Le);Ie=i(sv,"scripts"),sv.forEach(t),ut=i(io," sections below for all details regarding usage."),io.forEach(t),tv.forEach(t),Mr.forEach(t),Wl=l(n),Va=s(n,"P",{});var av=a(Va);Lp=i(av,"T5 comes in different sizes:"),av.forEach(t),Rl=l(n),Be=s(n,"UL",{});var Nt=a(Be);si=s(Nt,"LI",{});var rv=a(si);ai=s(rv,"P",{});var iv=a(ai);_o=s(iv,"A",{href:!0,rel:!0});var dv=a(_o);Ip=i(dv,"t5-small"),dv.forEach(t),iv.forEach(t),rv.forEach(t),Dp=l(Nt),ri=s(Nt,"LI",{});var lv=a(ri);ii=s(lv,"P",{});var cv=a(ii);go=s(cv,"A",{href:!0,rel:!0});var pv=a(go);Sp=i(pv,"t5-base"),pv.forEach(t),cv.forEach(t),lv.forEach(t),Op=l(Nt),di=s(Nt,"LI",{});var hv=a(di);li=s(hv,"P",{});var uv=a(li);To=s(uv,"A",{href:!0,rel:!0});var mv=a(To);Gp=i(mv,"t5-large"),mv.forEach(t),uv.forEach(t),hv.forEach(t),Bp=l(Nt),ci=s(Nt,"LI",{});var fv=a(ci);pi=s(fv,"P",{});var _v=a(pi);ko=s(_v,"A",{href:!0,rel:!0});var gv=a(ko);Up=i(gv,"t5-3b"),gv.forEach(t),_v.forEach(t),fv.forEach(t),Wp=l(Nt),hi=s(Nt,"LI",{});var Tv=a(hi);Ka=s(Tv,"P",{});var B1=a(Ka);vo=s(B1,"A",{href:!0,rel:!0});var kv=a(vo);Rp=i(kv,"t5-11b"),kv.forEach(t),Hp=i(B1,"."),B1.forEach(t),Tv.forEach(t),Nt.forEach(t),Hl=l(n),Ya=s(n,"P",{});var vv=a(Ya);Vp=i(vv,"Based on the original T5 model, Google has released some follow-up works:"),vv.forEach(t),Vl=l(n),xt=s(n,"UL",{});var Cr=a(xt);ui=s(Cr,"LI",{});var bv=a(ui);$n=s(bv,"P",{});var Gl=a($n);mi=s(Gl,"STRONG",{});var wv=a(mi);Kp=i(wv,"T5v1.1"),wv.forEach(t),Yp=i(Gl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
`),Ai=s(ye,"CODE",{});var Xv=a(Ai);au=i(Xv,"input_ids"),Xv.forEach(t),ru=i(ye," of the encoded input sequence) and "),Ni=s(ye,"CODE",{});var Qv=a(Ni);iu=i(Qv,"labels"),Qv.forEach(t),du=i(ye," (which are the "),Li=s(ye,"CODE",{});var e5=a(Li);lu=i(e5,"input_ids"),e5.forEach(t),cu=i(ye,` of the encoded
...
you to easily fine-tune T5 on custom data for summarization/translation.`),vt.forEach(t),W5.forEach(t),Yc.forEach(t),_c=l(n),on=s(n,"H2",{class:!0});var Jc=a(on);Ln=s(Jc,"A",{id:!0,class:!0,href:!0});var J5=a(Ln);pd=s(J5,"SPAN",{});var Z5=a(pd);_(Jo.$$.fragment,Z5),Z5.forEach(t),J5.forEach(t),Hm=l(Jc),hd=s(Jc,"SPAN",{});var X5=a(hd);Vm=i(X5,"T5Config"),X5.forEach(t),Jc.forEach(t),gc=l(n),bt=s(n,"DIV",{class:!0});var Sr=a(bt);_(Zo.$$.fragment,Sr),Km=l(Sr),wt=s(Sr,"P",{});var ho=a(wt);Ym=i(ho,"This is the configuration class to store the configuration of a "),lr=s(ho,"A",{href:!0});var Q5=a(lr);Jm=i(Q5,"T5Model"),Q5.forEach(t),Zm=i(ho," or a "),cr=s(ho,"A",{href:!0});var eb=a(cr);Xm=i(eb,"TFT5Model"),eb.forEach(t),Qm=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),Xo=s(ho,"A",{href:!0,rel:!0});var tb=a(Xo);ef=i(tb,"t5-small"),tb.forEach(t),tf=i(ho," architecture."),ho.forEach(t),nf=l(Sr),sn=s(Sr,"P",{});var Or=a(sn);of=i(Or,"Configuration objects inherit from "),pr=s(Or,"A",{href:!0});var nb=a(pr);sf=i(nb,"PretrainedConfig"),nb.forEach(t),af=i(Or,` and can be used to control the model outputs. Read the
documentation from `),hr=s(Or,"A",{href:!0});var ob=a(hr);rf=i(ob,"PretrainedConfig"),ob.forEach(t),df=i(Or," for more information."),Or.forEach(t),Sr.forEach(t),Tc=l(n),an=s(n,"H2",{class:!0});var Zc=a(an);In=s(Zc,"A",{id:!0,class:!0,href:!0});var sb=a(In);ud=s(sb,"SPAN",{});var ab=a(ud);_(Qo.$$.fragment,ab),ab.forEach(t),sb.forEach(t),lf=l(Zc),md=s(Zc,"SPAN",{});var rb=a(md);cf=i(rb,"T5Tokenizer"),rb.forEach(t),Zc.forEach(t),kc=l(n),ie=s(n,"DIV",{class:!0});var st=a(ie);_(es.$$.fragment,st),pf=l(st),ts=s(st,"P",{});var Xc=a(ts);hf=i(Xc,"Construct a T5 tokenizer. Based on "),ns=s(Xc,"A",{href:!0,rel:!0});var ib=a(ns);uf=i(ib,"SentencePiece"),ib.forEach(t),mf=i(Xc,"."),Xc.forEach(t),ff=l(st),os=s(st,"P",{});var Qc=a(os);_f=i(Qc,"This tokenizer inherits from "),ur=s(Qc,"A",{href:!0});var db=a(ur);gf=i(db,"PreTrainedTokenizer"),db.forEach(t),Tf=i(Qc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Qc.forEach(t),kf=l(st),jt=s(st,"DIV",{class:!0});var Gr=a(jt);_(ss.$$.fragment,Gr),vf=l(Gr),fd=s(Gr,"P",{});var lb=a(fd);bf=i(lb,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),lb.forEach(t),wf=l(Gr),as=s(Gr,"UL",{});var ep=a(as);mr=s(ep,"LI",{});var U1=a(mr);yf=i(U1,"single sequence: "),_d=s(U1,"CODE",{});var cb=a(_d);zf=i(cb,"X </s>"),cb.forEach(t),U1.forEach(t),$f=l(ep),fr=s(ep,"LI",{});var W1=a(fr);xf=i(W1,"pair of sequences: "),gd=s(W1,"CODE",{});var pb=a(gd);Ef=i(pb,"A </s> B </s>"),pb.forEach(t),W1.forEach(t),ep.forEach(t),Gr.forEach(t),qf=l(st),Dn=s(st,"DIV",{class:!0});var tp=a(Dn);_(rs.$$.fragment,tp),jf=l(tp),is=s(tp,"P",{});var np=a(is);Ff=i(np,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Td=s(np,"CODE",{});var hb=a(Td);Mf=i(hb,"prepare_for_model"),hb.forEach(t),Pf=i(np," method."),np.forEach(t),tp.forEach(t),Cf=l(st),Sn=s(st,"DIV",{class:!0});var op=a(Sn);_(ds.$$.fragment,op),Af=l(op),kd=s(op,"P",{});var ub=a(kd);Nf=i(ub,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),ub.forEach(t),op.forEach(t),Lf=l(st),vd=s(st,"DIV",{class:!0}),a(vd).forEach(t),st.forEach(t),vc=l(n),rn=s(n,"H2",{class:!0});var sp=a(rn);On=s(sp,"A",{id:!0,class:!0,href:!0});var mb=a(On);bd=s(mb,"SPAN",{});var fb=a(bd);_(ls.$$.fragment,fb),fb.forEach(t),mb.forEach(t),If=l(sp),wd=s(sp,"SPAN",{});var _b=a(wd);Df=i(_b,"T5TokenizerFast"),_b.forEach(t),sp.forEach(t),bc=l(n),Se=s(n,"DIV",{class:!0});var Dt=a(Se);_(cs.$$.fragment,Dt),Sf=l(Dt),dn=s(Dt,"P",{});var Br=a(dn);Of=i(Br,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),yd=s(Br,"EM",{});var gb=a(yd);Gf=i(gb,"tokenizers"),gb.forEach(t),Bf=i(Br,` library). Based on
`),ps=s(Br,"A",{href:!0,rel:!0});var Tb=a(ps);Uf=i(Tb,"Unigram"),Tb.forEach(t),Wf=i(Br,"."),Br.forEach(t),Rf=l(Dt),hs=s(Dt,"P",{});var ap=a(hs);Hf=i(ap,"This tokenizer inherits from "),_r=s(ap,"A",{href:!0});var kb=a(_r);Vf=i(kb,"PreTrainedTokenizerFast"),kb.forEach(t),Kf=i(ap,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),ap.forEach(t),Yf=l(Dt),Ft=s(Dt,"DIV",{class:!0});var Ur=a(Ft);_(us.$$.fragment,Ur),Jf=l(Ur),zd=s(Ur,"P",{});var vb=a(zd);Zf=i(vb,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),vb.forEach(t),Xf=l(Ur),ms=s(Ur,"UL",{});var rp=a(ms);gr=s(rp,"LI",{});var R1=a(gr);Qf=i(R1,"single sequence: "),$d=s(R1,"CODE",{});var bb=a($d);e_=i(bb,"X </s>"),bb.forEach(t),R1.forEach(t),t_=l(rp),Tr=s(rp,"LI",{});var H1=a(Tr);n_=i(H1,"pair of sequences: "),xd=s(H1,"CODE",{});var wb=a(xd);o_=i(wb,"A </s> B </s>"),wb.forEach(t),H1.forEach(t),rp.forEach(t),Ur.forEach(t),s_=l(Dt),Gn=s(Dt,"DIV",{class:!0});var ip=a(Gn);_(fs.$$.fragment,ip),a_=l(ip),Ed=s(ip,"P",{});var yb=a(Ed);r_=i(yb,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),yb.forEach(t),ip.forEach(t),Dt.forEach(t),wc=l(n),ln=s(n,"H2",{class:!0});var dp=a(ln);Bn=s(dp,"A",{id:!0,class:!0,href:!0});var zb=a(Bn);qd=s(zb,"SPAN",{});var $b=a(qd);_(_s.$$.fragment,$b),$b.forEach(t),zb.forEach(t),i_=l(dp),jd=s(dp,"SPAN",{});var xb=a(jd);d_=i(xb,"T5Model"),xb.forEach(t),dp.forEach(t),yc=l(n),Z=s(n,"DIV",{class:!0});var ze=a(Z);_(gs.$$.fragment,ze),l_=l(ze),Fd=s(ze,"P",{});var Eb=a(Fd);c_=i(Eb,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Eb.forEach(t),p_=l(ze),Ts=s(ze,"P",{});var lp=a(Ts);h_=i(lp,"The T5 model was proposed in "),ks=s(lp,"A",{href:!0,rel:!0});var qb=a(ks);u_=i(qb,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),qb.forEach(t),m_=i(lp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),lp.forEach(t),f_=l(ze),vs=s(ze,"P",{});var cp=a(vs);__=i(cp,"This model inherits from "),kr=s(cp,"A",{href:!0});var jb=a(kr);g_=i(jb,"PreTrainedModel"),jb.forEach(t),T_=i(cp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cp.forEach(t),k_=l(ze),bs=s(ze,"P",{});var pp=a(bs);v_=i(pp,"This model is also a PyTorch "),ws=s(pp,"A",{href:!0,rel:!0});var Fb=a(ws);b_=i(Fb,"torch.nn.Module"),Fb.forEach(t),w_=i(pp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pp.forEach(t),y_=l(ze),We=s(ze,"DIV",{class:!0});var St=a(We);_(ys.$$.fragment,St),z_=l(St),cn=s(St,"P",{});var Wr=a(cn);$_=i(Wr,"The "),vr=s(Wr,"A",{href:!0});var Mb=a(vr);x_=i(Mb,"T5Model"),Mb.forEach(t),E_=i(Wr," forward method, overrides the "),Md=s(Wr,"CODE",{});var Pb=a(Md);q_=i(Pb,"__call__"),Pb.forEach(t),j_=i(Wr," special method."),Wr.forEach(t),F_=l(St),_(Un.$$.fragment,St),M_=l(St),Pd=s(St,"P",{});var Cb=a(Pd);P_=i(Cb,"Example:"),Cb.forEach(t),C_=l(St),_(zs.$$.fragment,St),St.forEach(t),A_=l(ze),Re=s(ze,"DIV",{class:!0});var Ot=a(Re);_($s.$$.fragment,Ot),N_=l(Ot),Cd=s(Ot,"P",{});var Ab=a(Cd);L_=i(Ab,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Ab.forEach(t),I_=l(Ot),Ad=s(Ot,"P",{});var Nb=a(Ad);D_=i(Nb,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Nb.forEach(t),S_=l(Ot),Nd=s(Ot,"P",{});var Lb=a(Nd);O_=i(Lb,"Example:"),Lb.forEach(t),G_=l(Ot),_(xs.$$.fragment,Ot),Ot.forEach(t),B_=l(ze),gt=s(ze,"DIV",{class:!0});var uo=a(gt);_(Es.$$.fragment,uo),U_=l(uo),Ld=s(uo,"P",{});var Ib=a(Ld);W_=i(Ib,"Moves the model to cpu from a model parallel state."),Ib.forEach(t),R_=l(uo),Id=s(uo,"P",{});var Db=a(Id);H_=i(Db,"Example:"),Db.forEach(t),V_=l(uo),_(qs.$$.fragment,uo),uo.forEach(t),ze.forEach(t),zc=l(n),pn=s(n,"H2",{class:!0});var hp=a(pn);Wn=s(hp,"A",{id:!0,class:!0,href:!0});var Sb=a(Wn);Dd=s(Sb,"SPAN",{});var Ob=a(Dd);_(js.$$.fragment,Ob),Ob.forEach(t),Sb.forEach(t),K_=l(hp),Sd=s(hp,"SPAN",{});var Gb=a(Sd);Y_=i(Gb,"T5ForConditionalGeneration"),Gb.forEach(t),hp.forEach(t),$c=l(n),X=s(n,"DIV",{class:!0});var $e=a(X);_(Fs.$$.fragment,$e),J_=l($e),Ms=s($e,"P",{});var up=a(Ms);Z_=i(up,"T5 Model with a "),Od=s(up,"CODE",{});var Bb=a(Od);X_=i(Bb,"language modeling"),Bb.forEach(t),Q_=i(up," head on top."),up.forEach(t),eg=l($e),Ps=s($e,"P",{});var mp=a(Ps);tg=i(mp,"The T5 model was proposed in "),Cs=s(mp,"A",{href:!0,rel:!0});var Ub=a(Cs);ng=i(Ub,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ub.forEach(t),og=i(mp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),mp.forEach(t),sg=l($e),As=s($e,"P",{});var fp=a(As);ag=i(fp,"This model inherits from "),br=s(fp,"A",{href:!0});var Wb=a(br);rg=i(Wb,"PreTrainedModel"),Wb.forEach(t),ig=i(fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),dg=l($e),Ns=s($e,"P",{});var _p=a(Ns);lg=i(_p,"This model is also a PyTorch "),Ls=s(_p,"A",{href:!0,rel:!0});var Rb=a(Ls);cg=i(Rb,"torch.nn.Module"),Rb.forEach(t),pg=i(_p,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p.forEach(t),hg=l($e),He=s($e,"DIV",{class:!0});var Gt=a(He);_(Is.$$.fragment,Gt),ug=l(Gt),hn=s(Gt,"P",{});var Rr=a(hn);mg=i(Rr,"The "),wr=s(Rr,"A",{href:!0});var Hb=a(wr);fg=i(Hb,"T5ForConditionalGeneration"),Hb.forEach(t),_g=i(Rr," forward method, overrides the "),Gd=s(Rr,"CODE",{});var Vb=a(Gd);gg=i(Vb,"__call__"),Vb.forEach(t),Tg=i(Rr," special method."),Rr.forEach(t),kg=l(Gt),_(Rn.$$.fragment,Gt),vg=l(Gt),Bd=s(Gt,"P",{});var Kb=a(Bd);bg=i(Kb,"Examples:"),Kb.forEach(t),wg=l(Gt),_(Ds.$$.fragment,Gt),Gt.forEach(t),yg=l($e),Ve=s($e,"DIV",{class:!0});var Bt=a(Ve);_(Ss.$$.fragment,Bt),zg=l(Bt),Ud=s(Bt,"P",{});var Yb=a(Ud);$g=i(Yb,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Yb.forEach(t),xg=l(Bt),Wd=s(Bt,"P",{});var Jb=a(Wd);Eg=i(Jb,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Jb.forEach(t),qg=l(Bt),Rd=s(Bt,"P",{});var Zb=a(Rd);jg=i(Zb,"Example:"),Zb.forEach(t),Fg=l(Bt),_(Os.$$.fragment,Bt),Bt.forEach(t),Mg=l($e),Tt=s($e,"DIV",{class:!0});var mo=a(Tt);_(Gs.$$.fragment,mo),Pg=l(mo),Hd=s(mo,"P",{});var Xb=a(Hd);Cg=i(Xb,"Moves the model to cpu from a model parallel state."),Xb.forEach(t),Ag=l(mo),Vd=s(mo,"P",{});var Qb=a(Vd);Ng=i(Qb,"Example:"),Qb.forEach(t),Lg=l(mo),_(Bs.$$.fragment,mo),mo.forEach(t),$e.forEach(t),xc=l(n),un=s(n,"H2",{class:!0});var gp=a(un);Hn=s(gp,"A",{id:!0,class:!0,href:!0});var ew=a(Hn);Kd=s(ew,"SPAN",{});var tw=a(Kd);_(Us.$$.fragment,tw),tw.forEach(t),ew.forEach(t),Ig=l(gp),Yd=s(gp,"SPAN",{});var nw=a(Yd);Dg=i(nw,"T5EncoderModel"),nw.forEach(t),gp.forEach(t),Ec=l(n),Q=s(n,"DIV",{class:!0});var xe=a(Q);_(Ws.$$.fragment,xe),Sg=l(xe),Jd=s(xe,"P",{});var ow=a(Jd);Og=i(ow,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),ow.forEach(t),Gg=l(xe),Rs=s(xe,"P",{});var Tp=a(Rs);Bg=i(Tp,"The T5 model was proposed in "),Hs=s(Tp,"A",{href:!0,rel:!0});var sw=a(Hs);Ug=i(sw,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
