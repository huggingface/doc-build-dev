...
In the following example, you will use the [pipeline()](/docs/transformers/pr_15098/en/main_classes/pipelines#transformers.pipeline) for sentiment analysis.
...
Let's return to our example and see how you can use the `AutoClass` to replicate the results of the [pipeline()](/docs/transformers/pr_15098/en/main_classes/pipelines#transformers.pipeline).
