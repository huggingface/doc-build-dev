...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_roberta.py#L737",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17021/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_roberta.py#L904",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_roberta.py#L1059",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_roberta.py#L1175",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_roberta.py#L1274",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_roberta.py#L1372",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_roberta.py#L1477",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17021/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17021/src/transformers/models/roberta/modeling_flax_roberta.py#L620",returnDescription:`
<p>A <a
...
refer to this superclass for more information regarding those methods.`),cf.forEach(t),Kg=h(Xe),Ll=s(Xe,"DIV",{class:!0});var K2=a(Ll);y(Ea.$$.fragment,K2),K2.forEach(t),Xe.forEach(t),gm=h(o),_o=s(o,"H2",{class:!0});var pf=a(_o);yn=s(pf,"A",{id:!0,class:!0,href:!0});var G2=a(yn);sc=s(G2,"SPAN",{});var X2=a(sc);y(za.$$.fragment,X2),X2.forEach(t),G2.forEach(t),Gg=h(pf),ac=s(pf,"SPAN",{});var Y2=a(ac);Xg=i(Y2,"RobertaModel"),Y2.forEach(t),pf.forEach(t),_m=h(o),Ae=s(o,"DIV",{class:!0});var Ye=a(Ae);y(qa.$$.fragment,Ye),Yg=h(Ye),rc=s(Ye,"P",{});var Z2=a(rc);Zg=i(Z2,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Z2.forEach(t),e_=h(Ye),Ca=s(Ye,"P",{});var hf=a(Ca);t_=i(hf,"This model inherits from "),Al=s(hf,"A",{href:!0});var e0=a(Al);o_=i(e0,"PreTrainedModel"),e0.forEach(t),n_=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),s_=h(Ye),ja=s(Ye,"P",{});var mf=a(ja);a_=i(mf,"This model is also a PyTorch "),Pa=s(mf,"A",{href:!0,rel:!0});var t0=a(Pa);r_=i(t0,"torch.nn.Module"),t0.forEach(t),i_=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),ic=s(ff,"EM",{});var o0=a(ic);c_=i(o0,`Attention is
all you need`),o0.forEach(t),p_=i(ff,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),ff.forEach(t),h_=h(Ye),Ue=s(Ye,"P",{});var mt=a(Ue);m_=i(mt,"To behave as an decoder the model needs to be initialized with the "),lc=s(mt,"CODE",{});var n0=a(lc);f_=i(n0,"is_decoder"),n0.forEach(t),u_=i(mt,` argument of the configuration set
to `),dc=s(mt,"CODE",{});var s0=a(dc);g_=i(s0,"True"),s0.forEach(t),__=i(mt,". To be used in a Seq2Seq model, the model needs to initialized with both "),cc=s(mt,"CODE",{});var a0=a(cc);b_=i(a0,"is_decoder"),a0.forEach(t),k_=i(mt,` argument and
`),pc=s(mt,"CODE",{});var r0=a(pc);v_=i(r0,"add_cross_attention"),r0.forEach(t),T_=i(mt," set to "),hc=s(mt,"CODE",{});var i0=a(hc);y_=i(i0,"True"),i0.forEach(t),w_=i(mt,"; an "),mc=s(mt,"CODE",{});var l0=a(mc);$_=i(l0,"encoder_hidden_states"),l0.forEach(t),F_=i(mt," is then expected as an input to the forward pass."),mt.forEach(t),x_=h(Ye),wn=s(Ye,"P",{});var lm=a(wn);R_=i(lm,".. _"),fc=s(lm,"EM",{});var d0=a(fc);M_=i(d0,"Attention is all you need"),d0.forEach(t),E_=i(lm,": "),Aa=s(lm,"A",{href:!0,rel:!0});var c0=a(Aa);z_=i(c0,"https://arxiv.org/abs/1706.03762"),c0.forEach(t),lm.forEach(t),q_=h(Ye),yt=s(Ye,"DIV",{class:!0});var Hs=a(yt);y(Oa.$$.fragment,Hs),C_=h(Hs),bo=s(Hs,"P",{});var bd=a(bo);j_=i(bd,"The "),Ol=s(bd,"A",{href:!0});var p0=a(Ol);P_=i(p0,"RobertaModel"),p0.forEach(t),L_=i(bd," forward method, overrides the "),uc=s(bd,"CODE",{});var h0=a(uc);A_=i(h0,"__call__"),h0.forEach(t),O_=i(bd," special method."),bd.forEach(t),N_=h(Hs),y($n.$$.fragment,Hs),I_=h(Hs),y(Fn.$$.fragment,Hs),Hs.forEach(t),Ye.forEach(t),bm=h(o),ko=s(o,"H2",{class:!0});var uf=a(ko);xn=s(uf,"A",{id:!0,class:!0,href:!0});var m0=a(xn);gc=s(m0,"SPAN",{});var f0=a(gc);y(Na.$$.fragment,f0),f0.forEach(t),m0.forEach(t),D_=h(uf),_c=s(uf,"SPAN",{});var u0=a(_c);S_=i(u0,"RobertaForCausalLM"),u0.forEach(t),uf.forEach(t),km=h(o),et=s(o,"DIV",{class:!0});var Yt=a(et);y(Ia.$$.fragment,Yt),W_=h(Yt),Da=s(Yt,"P",{});var gf=a(Da);B_=i(gf,"RoBERTa Model with a "),bc=s(gf,"CODE",{});var g0=a(bc);U_=i(g0,"language modeling"),g0.forEach(t),H_=i(gf," head on top for CLM fine-tuning."),gf.forEach(t),Q_=h(Yt),Sa=s(Yt,"P",{});var _f=a(Sa);V_=i(_f,"This model inherits from "),Nl=s(_f,"A",{href:!0});var _0=a(Nl);J_=i(_0,"PreTrainedModel"),_0.forEach(t),K_=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_f.forEach(t),G_=h(Yt),Wa=s(Yt,"P",{});var bf=a(Wa);X_=i(bf,"This model is also a PyTorch "),Ba=s(bf,"A",{href:!0,rel:!0});var b0=a(Ba);Y_=i(b0,"torch.nn.Module"),b0.forEach(t),Z_=i(bf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bf.forEach(t),eb=h(Yt),wt=s(Yt,"DIV",{class:!0});var Qs=a(wt);y(Ua.$$.fragment,Qs),tb=h(Qs),vo=s(Qs,"P",{});var kd=a(vo);ob=i(kd,"The "),Il=s(kd,"A",{href:!0});var k0=a(Il);nb=i(k0,"RobertaForCausalLM"),k0.forEach(t),sb=i(kd," forward method, overrides the "),kc=s(kd,"CODE",{});var v0=a(kc);ab=i(v0,"__call__"),v0.forEach(t),rb=i(kd," special method."),kd.forEach(t),ib=h(Qs),y(Rn.$$.fragment,Qs),lb=h(Qs),y(Mn.$$.fragment,Qs),Qs.forEach(t),Yt.forEach(t),vm=h(o),To=s(o,"H2",{class:!0});var kf=a(To);En=s(kf,"A",{id:!0,class:!0,href:!0});var T0=a(En);vc=s(T0,"SPAN",{});var y0=a(vc);y(Ha.$$.fragment,y0),y0.forEach(t),T0.forEach(t),db=h(kf),Tc=s(kf,"SPAN",{});var w0=a(Tc);cb=i(w0,"RobertaForMaskedLM"),w0.forEach(t),kf.forEach(t),Tm=h(o),tt=s(o,"DIV",{class:!0});var Zt=a(tt);y(Qa.$$.fragment,Zt),pb=h(Zt),Va=s(Zt,"P",{});var vf=a(Va);hb=i(vf,"RoBERTa Model with a "),yc=s(vf,"CODE",{});var $0=a(yc);mb=i($0,"language modeling"),$0.forEach(t),fb=i(vf," head on top."),vf.forEach(t),ub=h(Zt),Ja=s(Zt,"P",{});var Tf=a(Ja);gb=i(Tf,"This model inherits from "),Dl=s(Tf,"A",{href:!0});var F0=a(Dl);_b=i(F0,"PreTrainedModel"),F0.forEach(t),bb=i(Tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tf.forEach(t),kb=h(Zt),Ka=s(Zt,"P",{});var yf=a(Ka);vb=i(yf,"This model is also a PyTorch "),Ga=s(yf,"A",{href:!0,rel:!0});var x0=a(Ga);Tb=i(x0,"torch.nn.Module"),x0.forEach(t),yb=i(yf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yf.forEach(t),wb=h(Zt),rt=s(Zt,"DIV",{class:!0});var eo=a(rt);y(Xa.$$.fragment,eo),$b=h(eo),yo=s(eo,"P",{});var vd=a(yo);Fb=i(vd,"The "),Sl=s(vd,"A",{href:!0});var R0=a(Sl);xb=i(R0,"RobertaForMaskedLM"),R0.forEach(t),Rb=i(vd," forward method, overrides the "),wc=s(vd,"CODE",{});var M0=a(wc);Mb=i(M0,"__call__"),M0.forEach(t),Eb=i(vd," special method."),vd.forEach(t),zb=h(eo),y(zn.$$.fragment,eo),qb=h(eo),y(qn.$$.fragment,eo),Cb=h(eo),y(Cn.$$.fragment,eo),eo.forEach(t),Zt.forEach(t),ym=h(o),wo=s(o,"H2",{class:!0});var wf=a(wo);jn=s(wf,"A",{id:!0,class:!0,href:!0});var E0=a(jn);$c=s(E0,"SPAN",{});var z0=a($c);y(Ya.$$.fragment,z0),z0.forEach(t),E0.forEach(t),jb=h(wf),Fc=s(wf,"SPAN",{});var q0=a(Fc);Pb=i(q0,"RobertaForSequenceClassification"),q0.forEach(t),wf.forEach(t),wm=h(o),ot=s(o,"DIV",{class:!0});var to=a(ot);y(Za.$$.fragment,to),Lb=h(to),xc=s(to,"P",{});var C0=a(xc);Ab=i(C0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C0.forEach(t),Ob=h(to),er=s(to,"P",{});var $f=a(er);Nb=i($f,"This model inherits from "),Wl=s($f,"A",{href:!0});var j0=a(Wl);Ib=i(j0,"PreTrainedModel"),j0.forEach(t),Db=i($f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f.forEach(t),Sb=h(to),tr=s(to,"P",{});var Ff=a(tr);Wb=i(Ff,"This model is also a PyTorch "),or=s(Ff,"A",{href:!0,rel:!0});var P0=a(or);Bb=i(P0,"torch.nn.Module"),P0.forEach(t),Ub=i(Ff,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ff.forEach(t),Hb=h(to),Be=s(to,"DIV",{class:!0});var ft=a(Be);y(nr.$$.fragment,ft),Qb=h(ft),$o=s(ft,"P",{});var Td=a($o);Vb=i(Td,"The "),Bl=s(Td,"A",{href:!0});var L0=a(Bl);Jb=i(L0,"RobertaForSequenceClassification"),L0.forEach(t),Kb=i(Td," forward method, overrides the "),Rc=s(Td,"CODE",{});var A0=a(Rc);Gb=i(A0,"__call__"),A0.forEach(t),Xb=i(Td," special method."),Td.forEach(t),Yb=h(ft),y(Pn.$$.fragment,ft),Zb=h(ft),y(Ln.$$.fragment,ft),ek=h(ft),y(An.$$.fragment,ft),tk=h(ft),y(On.$$.fragment,ft),ok=h(ft),y(Nn.$$.fragment,ft),ft.forEach(t),to.forEach(t),$m=h(o),Fo=s(o,"H2",{class:!0});var xf=a(Fo);In=s(xf,"A",{id:!0,class:!0,href:!0});var O0=a(In);Mc=s(O0,"SPAN",{});var N0=a(Mc);y(sr.$$.fragment,N0),N0.forEach(t),O0.forEach(t),nk=h(xf),Ec=s(xf,"SPAN",{});var I0=a(Ec);sk=i(I0,"RobertaForMultipleChoice"),I0.forEach(t),xf.forEach(t),Fm=h(o),nt=s(o,"DIV",{class:!0});var oo=a(nt);y(ar.$$.fragment,oo),ak=h(oo),zc=s(oo,"P",{});var D0=a(zc);rk=i(D0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D0.forEach(t),ik=h(oo),rr=s(oo,"P",{});var Rf=a(rr);lk=i(Rf,"This model inherits from "),Ul=s(Rf,"A",{href:!0});var S0=a(Ul);dk=i(S0,"PreTrainedModel"),S0.forEach(t),ck=i(Rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rf.forEach(t),pk=h(oo),ir=s(oo,"P",{});var Mf=a(ir);hk=i(Mf,"This model is also a PyTorch "),lr=s(Mf,"A",{href:!0,rel:!0});var W0=a(lr);mk=i(W0,"torch.nn.Module"),W0.forEach(t),fk=i(Mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mf.forEach(t),uk=h(oo),$t=s(oo,"DIV",{class:!0});var Vs=a($t);y(dr.$$.fragment,Vs),gk=h(Vs),xo=s(Vs,"P",{});var yd=a(xo);_k=i(yd,"The "),Hl=s(yd,"A",{href:!0});var B0=a(Hl);bk=i(B0,"RobertaForMultipleChoice"),B0.forEach(t),kk=i(yd," forward method, overrides the "),qc=s(yd,"CODE",{});var U0=a(qc);vk=i(U0,"__call__"),U0.forEach(t),Tk=i(yd," special method."),yd.forEach(t),yk=h(Vs),y(Dn.$$.fragment,Vs),wk=h(Vs),y(Sn.$$.fragment,Vs),Vs.forEach(t),oo.forEach(t),xm=h(o),Ro=s(o,"H2",{class:!0});var Ef=a(Ro);Wn=s(Ef,"A",{id:!0,class:!0,href:!0});var H0=a(Wn);Cc=s(H0,"SPAN",{});var Q0=a(Cc);y(cr.$$.fragment,Q0),Q0.forEach(t),H0.forEach(t),$k=h(Ef),jc=s(Ef,"SPAN",{});var V0=a(jc);Fk=i(V0,"RobertaForTokenClassification"),V0.forEach(t),Ef.forEach(t),Rm=h(o),st=s(o,"DIV",{class:!0});var no=a(st);y(pr.$$.fragment,no),xk=h(no),Pc=s(no,"P",{});var J0=a(Pc);Rk=i(J0,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),J0.forEach(t),Mk=h(no),hr=s(no,"P",{});var zf=a(hr);Ek=i(zf,"This model inherits from "),Ql=s(zf,"A",{href:!0});var K0=a(Ql);zk=i(K0,"PreTrainedModel"),K0.forEach(t),qk=i(zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zf.forEach(t),Ck=h(no),mr=s(no,"P",{});var qf=a(mr);jk=i(qf,"This model is also a PyTorch "),fr=s(qf,"A",{href:!0,rel:!0});var G0=a(fr);Pk=i(G0,"torch.nn.Module"),G0.forEach(t),Lk=i(qf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qf.forEach(t),Ak=h(no),it=s(no,"DIV",{class:!0});var so=a(it);y(ur.$$.fragment,so),Ok=h(so),Mo=s(so,"P",{});var wd=a(Mo);Nk=i(wd,"The "),Vl=s(wd,"A",{href:!0});var X0=a(Vl);Ik=i(X0,"RobertaForTokenClassification"),X0.forEach(t),Dk=i(wd," forward method, overrides the "),Lc=s(wd,"CODE",{});var Y0=a(Lc);Sk=i(Y0,"__call__"),Y0.forEach(t),Wk=i(wd," special method."),wd.forEach(t),Bk=h(so),y(Bn.$$.fragment,so),Uk=h(so),y(Un.$$.fragment,so),Hk=h(so),y(Hn.$$.fragment,so),so.forEach(t),no.forEach(t),Mm=h(o),Eo=s(o,"H2",{class:!0});var Cf=a(Eo);Qn=s(Cf,"A",{id:!0,class:!0,href:!0});var Z0=a(Qn);Ac=s(Z0,"SPAN",{});var eF=a(Ac);y(gr.$$.fragment,eF),eF.forEach(t),Z0.forEach(t),Qk=h(Cf),Oc=s(Cf,"SPAN",{});var tF=a(Oc);Vk=i(tF,"RobertaForQuestionAnswering"),tF.forEach(t),Cf.forEach(t),Em=h(o),at=s(o,"DIV",{class:!0});var ao=a(at);y(_r.$$.fragment,ao),Jk=h(ao),zo=s(ao,"P",{});var $d=a(zo);Kk=i($d,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
