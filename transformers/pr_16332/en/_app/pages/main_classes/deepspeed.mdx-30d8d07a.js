...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16332/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16332/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16332/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16332/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16332/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
won\u2019t be possible on a single GPU.`),Yj=u(),Et=o("p"),o$=a("\u{1F917} Transformers integrates "),oo=o("a"),l$=a("DeepSpeed"),r$=a(" via 2 options:"),Kj=u(),qt=o("ol"),lo=o("li"),p$=a("Integration of the core DeepSpeed features via "),Lp=o("a"),i$=a("Trainer"),u$=a(`. This is an everything-done-for-you type
...
yourself, core functionality functions like `),rf=o("code"),m$=a("from_pretrained"),_$=a(" and "),pf=o("code"),v$=a("from_config"),j$=a(` include integration of essential
parts of DeepSpeed like `),uf=o("code"),g$=a("zero.Init"),w$=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=o("a"),y$=a("deepspeed-non-trainer-integration"),b$=a("."),Jj=u(),Np=o("p"),E$=a("What is integrated:"),Xj=u(),Hp=o("p"),q$=a("Training:"),Qj=u(),Bp=o("ol"),cf=o("li"),$$=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),eg=u(),Wp=o("p"),k$=a("Inference:"),sg=u(),Fp=o("ol"),ro=o("li"),P$=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
...
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),$s=o("h2"),$t=o("a"),hf=o("span"),f(po.$$.fragment),T$=u(),ff=o("span"),A$=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),ks=o("h3"),kt=o("a"),df=o("span"),f(io.$$.fragment),S$=u(),mf=o("span"),C$=a("Installation"),rg=u(),Xp=o("p"),x$=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R$=a("or via "),_f=o("code"),I$=a("transformers"),U$=a("\u2019 "),vf=o("code"),G$=a("extras"),L$=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M$=a("or find more details on "),ho=o("a"),Z$=a("the DeepSpeed\u2019s GitHub page"),N$=a(` and
`),fo=o("a"),H$=a("advanced install"),B$=a("."),hg=u(),Pt=o("p"),W$=a("If you\u2019re still struggling with the build, first make sure to read "),Qp=o("a"),F$=a("zero-install-notes"),V$=a("."),fg=u(),ei=o("p"),Y$=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),dg=u(),si=o("p"),K$=a("To make a local build for DeepSpeed:"),mg=u(),f(mo.$$.fragment),_g=u(),Re=o("p"),J$=a("If you intend to use NVMe offload you will also need to include "),jf=o("code"),X$=a("DS_BUILD_AIO=1"),Q$=a(` in the instructions above (and also
install `),gf=o("em"),e4=a("libaio-dev"),s4=a(" system-wide)."),vg=u(),Dt=o("p"),t4=a("Edit "),wf=o("code"),a4=a("TORCH_CUDA_ARCH_LIST"),n4=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),jg=u(),f(_o.$$.fragment),gg=u(),Pe=o("p"),o4=a("So if you get "),yf=o("code"),l4=a("8, 6"),r4=a(", then use "),bf=o("code"),p4=a('TORCH_CUDA_ARCH_LIST="8.6"'),i4=a(`. If you have multiple different cards, you can list all
of them like so `),Ef=o("code"),u4=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),wg=u(),ti=o("p"),c4=a("If you need to use the same setup on multiple machines, make a binary wheel:"),yg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h4=a("it will generate something like "),qf=o("code"),f4=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d4=a(` which now you can install
as `),$f=o("code"),m4=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_4=a(" locally or on any other machine."),Eg=u(),zt=o("p"),v4=a("Again, remember to ensure to adjust "),kf=o("code"),j4=a("TORCH_CUDA_ARCH_LIST"),g4=a(" to the target architectures."),qg=u(),Ue=o("p"),w4=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Pf=o("strong"),y4=a("Compute Capabilities"),b4=a(` (same as arch in this
context) `),jo=o("a"),E4=a("here"),q4=a("."),$g=u(),ai=o("p"),$4=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k4=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(wo.$$.fragment),zg=u(),oi=o("p"),P4=a("If the output is:"),Og=u(),f(yo.$$.fragment),Tg=u(),Ot=o("p"),D4=a("then you know that this card\u2019s arch is "),Df=o("code"),z4=a("8.6"),O4=a("."),Ag=u(),Tt=o("p"),T4=a("You can also leave "),zf=o("code"),A4=a("TORCH_CUDA_ARCH_LIST"),S4=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Sg=u(),At=o("p"),C4=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=o("a"),x4=a("Deepspeed"),R4=a(","),Cg=u(),li=o("a"),xg=u(),Ps=o("h3"),St=o("a"),Of=o("span"),f(Eo.$$.fragment),I4=u(),Tf=o("span"),U4=a("Deployment with multiple GPUs"),Rg=u(),Ct=o("p"),G4=a("To deploy this feature with multiple GPUs adjust the "),ri=o("a"),L4=a("Trainer"),M4=a(` command line arguments as
following:`),Ig=u(),xt=o("ol"),Ds=o("li"),Z4=a("replace "),Af=o("code"),N4=a("python -m torch.distributed.launch"),H4=a(" with "),Sf=o("code"),B4=a("deepspeed"),W4=a("."),F4=u(),De=o("li"),V4=a("add a new argument "),Cf=o("code"),Y4=a("--deepspeed ds_config.json"),K4=a(", where "),xf=o("code"),J4=a("ds_config.json"),X4=a(` is the DeepSpeed configuration file as
documented `),qo=o("a"),Q4=a("here"),e5=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s5=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t5=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a5=a("Unlike, "),Rf=o("code"),n5=a("torch.distributed.launch"),o5=a(" where you have to specify how many GPUs to use with "),If=o("code"),l5=a("--nproc_per_node"),r5=a(`, with the
...
find more details in the discussion below.`),nw=u(),Zt=o("p"),W5=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F5=a("post"),V5=a("."),ow=u(),mi=o("p"),Y5=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),lw=u(),_i=o("p"),K5=a("Notes:"),rw=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J5=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Kf=o("code"),X5=a("CUDA_VISIBLE_DEVICES"),Q5=a(` to limit
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Op=o("a"),vG=a("DeepSpeed GitHub"),jG=a("."),this.h()},l(e){const p=MK('[data-svelte="svelte-1phssyn"]',document.head);y=l(p,"META",{name:!0,content:!0}),p.forEach(t),C=c(e),b=l(e,"H1",{class:!0});var Tp=r(b);k=l(Tp,"A",{id:!0,class:!0,href:!0});var Uj=r(k);ee=l(Uj,"SPAN",{});var Gj=r(ee);d(z.$$.fragment,Gj),Gj.forEach(t),Uj.forEach(t),x=c(Tp),se=l(Tp,"SPAN",{});var $G=r(se);R=n($G,"DeepSpeed Integration"),$G.forEach(t),Tp.forEach(t),ae=c(e),S=l(e,"P",{});var Lj=r(S);E=l(Lj,"A",{href:!0,rel:!0});var kG=r(E);q=n(kG,"DeepSpeed"),kG.forEach(t),Es=n(Lj," implements everything described in the "),V=l(Lj,"A",{href:!0,rel:!0});var PG=r(V);qs=n(PG,"ZeRO paper"),PG.forEach(t),L6=n(Lj,". Currently it provides full support for:"),Lj.forEach(t),Bj=c(e),I=l(e,"OL",{});var je=r(I);sf=l(je,"LI",{});var DG=r(sf);M6=n(DG,"Optimizer state partitioning (ZeRO stage 1)"),DG.forEach(t),Z6=c(je),tf=l(je,"LI",{});var zG=r(tf);N6=n(zG,"Gradient partitioning (ZeRO stage 2)"),zG.forEach(t),H6=c(je),af=l(je,"LI",{});var OG=r(af);B6=n(OG,"Parameter partitioning (ZeRO stage 3)"),OG.forEach(t),W6=c(je),nf=l(je,"LI",{});var TG=r(nf);F6=n(TG,"Custom mixed precision training handling"),TG.forEach(t),V6=c(je),of=l(je,"LI",{});var AG=r(of);Y6=n(AG,"A range of fast CUDA-extension-based optimizers"),AG.forEach(t),K6=c(je),lf=l(je,"LI",{});var SG=r(lf);J6=n(SG,"ZeRO-Offload to CPU and NVMe"),SG.forEach(t),je.forEach(t),Wj=c(e),Se=l(e,"P",{});var rh=r(Se);X6=n(rh,"ZeRO-Offload has its own dedicated paper: "),ao=l(rh,"A",{href:!0,rel:!0});var CG=r(ao);Q6=n(CG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),CG.forEach(t),e$=n(rh,". And NVMe-support is described in the paper "),no=l(rh,"A",{href:!0,rel:!0});var xG=r(no);s$=n(xG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),xG.forEach(t),t$=n(rh,"."),rh.forEach(t),Fj=c(e),Up=l(e,"P",{});var RG=r(Up);a$=n(RG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),RG.forEach(t),Vj=c(e),Gp=l(e,"P",{});var IG=r(Gp);n$=n(IG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),IG.forEach(t),Yj=c(e),Et=l(e,"P",{});var nE=r(Et);o$=n(nE,"\u{1F917} Transformers integrates "),oo=l(nE,"A",{href:!0,rel:!0});var UG=r(oo);l$=n(UG,"DeepSpeed"),UG.forEach(t),r$=n(nE," via 2 options:"),nE.forEach(t),Kj=c(e),qt=l(e,"OL",{});var oE=r(qt);lo=l(oE,"LI",{});var lE=r(lo);p$=n(lE,"Integration of the core DeepSpeed features via "),Lp=l(lE,"A",{href:!0});var GG=r(Lp);i$=n(GG,"Trainer"),GG.forEach(t),u$=n(lE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),lE.forEach(t),c$=c(oE),Y=l(oE,"LI",{});var ge=r(Y);h$=n(ge,"If you don\u2019t use "),Mp=l(ge,"A",{href:!0});var LG=r(Mp);f$=n(LG,"Trainer"),LG.forEach(t),d$=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),rf=l(ge,"CODE",{});var MG=r(rf);m$=n(MG,"from_pretrained"),MG.forEach(t),_$=n(ge," and "),pf=l(ge,"CODE",{});var ZG=r(pf);v$=n(ZG,"from_config"),ZG.forEach(t),j$=n(ge,` include integration of essential
parts of DeepSpeed like `),uf=l(ge,"CODE",{});var NG=r(uf);g$=n(NG,"zero.Init"),NG.forEach(t),w$=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=l(ge,"A",{href:!0});var HG=r(Zp);y$=n(HG,"deepspeed-non-trainer-integration"),HG.forEach(t),b$=n(ge,"."),ge.forEach(t),oE.forEach(t),Jj=c(e),Np=l(e,"P",{});var BG=r(Np);E$=n(BG,"What is integrated:"),BG.forEach(t),Xj=c(e),Hp=l(e,"P",{});var WG=r(Hp);q$=n(WG,"Training:"),WG.forEach(t),Qj=c(e),Bp=l(e,"OL",{});var FG=r(Bp);cf=l(FG,"LI",{});var VG=r(cf);$$=n(VG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),VG.forEach(t),FG.forEach(t),eg=c(e),Wp=l(e,"P",{});var YG=r(Wp);k$=n(YG,"Inference:"),YG.forEach(t),sg=c(e),Fp=l(e,"OL",{});var KG=r(Fp);ro=l(KG,"LI",{});var rE=r(ro);P$=n(rE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Vp=l(rE,"A",{href:!0});var JG=r(Vp);D$=n(JG,"deepspeed-zero-inference"),JG.forEach(t),z$=n(rE,"."),rE.forEach(t),KG.forEach(t),tg=c(e),Yp=l(e,"P",{});var XG=r(Yp);O$=n(XG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),XG.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),$s=l(e,"H2",{class:!0});var pE=r($s);$t=l(pE,"A",{id:!0,class:!0,href:!0});var QG=r($t);hf=l(QG,"SPAN",{});var eL=r(hf);d(po.$$.fragment,eL),eL.forEach(t),QG.forEach(t),T$=c(pE),ff=l(pE,"SPAN",{});var sL=r(ff);A$=n(sL,"Trainer Deepspeed Integration"),sL.forEach(t),pE.forEach(t),og=c(e),Jp=l(e,"A",{id:!0}),r(Jp).forEach(t),lg=c(e),ks=l(e,"H3",{class:!0});var iE=r(ks);kt=l(iE,"A",{id:!0,class:!0,href:!0});var tL=r(kt);df=l(tL,"SPAN",{});var aL=r(df);d(io.$$.fragment,aL),aL.forEach(t),tL.forEach(t),S$=c(iE),mf=l(iE,"SPAN",{});var nL=r(mf);C$=n(nL,"Installation"),nL.forEach(t),iE.forEach(t),rg=c(e),Xp=l(e,"P",{});var oL=r(Xp);x$=n(oL,"Install the library via pypi:"),oL.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),Ce=l(e,"P",{});var ph=r(Ce);R$=n(ph,"or via "),_f=l(ph,"CODE",{});var lL=r(_f);I$=n(lL,"transformers"),lL.forEach(t),U$=n(ph,"\u2019 "),vf=l(ph,"CODE",{});var rL=r(vf);G$=n(rL,"extras"),rL.forEach(t),L$=n(ph,":"),ph.forEach(t),ug=c(e),d(co.$$.fragment,e),cg=c(e),xe=l(e,"P",{});var ih=r(xe);M$=n(ih,"or find more details on "),ho=l(ih,"A",{href:!0,rel:!0});var pL=r(ho);Z$=n(pL,"the DeepSpeed\u2019s GitHub page"),pL.forEach(t),N$=n(ih,` and
`),fo=l(ih,"A",{href:!0,rel:!0});var iL=r(fo);H$=n(iL,"advanced install"),iL.forEach(t),B$=n(ih,"."),ih.forEach(t),hg=c(e),Pt=l(e,"P",{});var uE=r(Pt);W$=n(uE,"If you\u2019re still struggling with the build, first make sure to read "),Qp=l(uE,"A",{href:!0});var uL=r(Qp);F$=n(uL,"zero-install-notes"),uL.forEach(t),V$=n(uE,"."),uE.forEach(t),fg=c(e),ei=l(e,"P",{});var cL=r(ei);Y$=n(cL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),cL.forEach(t),dg=c(e),si=l(e,"P",{});var hL=r(si);K$=n(hL,"To make a local build for DeepSpeed:"),hL.forEach(t),mg=c(e),d(mo.$$.fragment,e),_g=c(e),Re=l(e,"P",{});var uh=r(Re);J$=n(uh,"If you intend to use NVMe offload you will also need to include "),jf=l(uh,"CODE",{});var fL=r(jf);X$=n(fL,"DS_BUILD_AIO=1"),fL.forEach(t),Q$=n(uh,` in the instructions above (and also
install `),gf=l(uh,"EM",{});var dL=r(gf);e4=n(dL,"libaio-dev"),dL.forEach(t),s4=n(uh," system-wide)."),uh.forEach(t),vg=c(e),Dt=l(e,"P",{});var cE=r(Dt);t4=n(cE,"Edit "),wf=l(cE,"CODE",{});var mL=r(wf);a4=n(mL,"TORCH_CUDA_ARCH_LIST"),mL.forEach(t),n4=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),cE.forEach(t),jg=c(e),d(_o.$$.fragment,e),gg=c(e),Pe=l(e,"P",{});var Ap=r(Pe);o4=n(Ap,"So if you get "),yf=l(Ap,"CODE",{});var _L=r(yf);l4=n(_L,"8, 6"),_L.forEach(t),r4=n(Ap,", then use "),bf=l(Ap,"CODE",{});var vL=r(bf);p4=n(vL,'TORCH_CUDA_ARCH_LIST="8.6"'),vL.forEach(t),i4=n(Ap,`. If you have multiple different cards, you can list all
of them like so `),Ef=l(Ap,"CODE",{});var jL=r(Ef);u4=n(jL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),jL.forEach(t),Ap.forEach(t),wg=c(e),ti=l(e,"P",{});var gL=r(ti);c4=n(gL,"If you need to use the same setup on multiple machines, make a binary wheel:"),gL.forEach(t),yg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h4=n(ch,"it will generate something like "),qf=l(ch,"CODE",{});var wL=r(qf);f4=n(wL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wL.forEach(t),d4=n(ch,` which now you can install
as `),$f=l(ch,"CODE",{});var yL=r($f);m4=n(yL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),yL.forEach(t),_4=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),zt=l(e,"P",{});var hE=r(zt);v4=n(hE,"Again, remember to ensure to adjust "),kf=l(hE,"CODE",{});var bL=r(kf);j4=n(bL,"TORCH_CUDA_ARCH_LIST"),bL.forEach(t),g4=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);w4=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Pf=l(hh,"STRONG",{});var EL=r(Pf);y4=n(EL,"Compute Capabilities"),EL.forEach(t),b4=n(hh,` (same as arch in this
context) `),jo=l(hh,"A",{href:!0,rel:!0});var qL=r(jo);E4=n(qL,"here"),qL.forEach(t),q4=n(hh,"."),hh.forEach(t),$g=c(e),ai=l(e,"P",{});var $L=r(ai);$4=n($L,"You can check the archs pytorch was built with using:"),$L.forEach(t),kg=c(e),d(go.$$.fragment,e),Pg=c(e),ni=l(e,"P",{});var kL=r(ni);k4=n(kL,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),kL.forEach(t),Dg=c(e),d(wo.$$.fragment,e),zg=c(e),oi=l(e,"P",{});var PL=r(oi);P4=n(PL,"If the output is:"),PL.forEach(t),Og=c(e),d(yo.$$.fragment,e),Tg=c(e),Ot=l(e,"P",{});var fE=r(Ot);D4=n(fE,"then you know that this card\u2019s arch is "),Df=l(fE,"CODE",{});var DL=r(Df);z4=n(DL,"8.6"),DL.forEach(t),O4=n(fE,"."),fE.forEach(t),Ag=c(e),Tt=l(e,"P",{});var dE=r(Tt);T4=n(dE,"You can also leave "),zf=l(dE,"CODE",{});var zL=r(zf);A4=n(zL,"TORCH_CUDA_ARCH_LIST"),zL.forEach(t),S4=n(dE,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),dE.forEach(t),Sg=c(e),At=l(e,"P",{});var mE=r(At);C4=n(mE,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=l(mE,"A",{href:!0,rel:!0});var OL=r(bo);x4=n(OL,"Deepspeed"),OL.forEach(t),R4=n(mE,","),mE.forEach(t),Cg=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),xg=c(e),Ps=l(e,"H3",{class:!0});var _E=r(Ps);St=l(_E,"A",{id:!0,class:!0,href:!0});var TL=r(St);Of=l(TL,"SPAN",{});var AL=r(Of);d(Eo.$$.fragment,AL),AL.forEach(t),TL.forEach(t),I4=c(_E),Tf=l(_E,"SPAN",{});var SL=r(Tf);U4=n(SL,"Deployment with multiple GPUs"),SL.forEach(t),_E.forEach(t),Rg=c(e),Ct=l(e,"P",{});var vE=r(Ct);G4=n(vE,"To deploy this feature with multiple GPUs adjust the "),ri=l(vE,"A",{href:!0});var CL=r(ri);L4=n(CL,"Trainer"),CL.forEach(t),M4=n(vE,` command line arguments as
following:`),vE.forEach(t),Ig=c(e),xt=l(e,"OL",{});var jE=r(xt);Ds=l(jE,"LI",{});var fh=r(Ds);Z4=n(fh,"replace "),Af=l(fh,"CODE",{});var xL=r(Af);N4=n(xL,"python -m torch.distributed.launch"),xL.forEach(t),H4=n(fh," with "),Sf=l(fh,"CODE",{});var RL=r(Sf);B4=n(RL,"deepspeed"),RL.forEach(t),W4=n(fh,"."),fh.forEach(t),F4=c(jE),De=l(jE,"LI",{});var Mn=r(De);V4=n(Mn,"add a new argument "),Cf=l(Mn,"CODE",{});var IL=r(Cf);Y4=n(IL,"--deepspeed ds_config.json"),IL.forEach(t),K4=n(Mn,", where "),xf=l(Mn,"CODE",{});var UL=r(xf);J4=n(UL,"ds_config.json"),UL.forEach(t),X4=n(Mn,` is the DeepSpeed configuration file as
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var GL=r(qo);Q4=n(GL,"here"),GL.forEach(t),e5=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var LL=r(pi);s5=n(LL,"Therefore, if your original command line looked as follows:"),LL.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ML=r(ii);t5=n(ML,"Now it should be:"),ML.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var we=r(U);a5=n(we,"Unlike, "),Rf=l(we,"CODE",{});var ZL=r(Rf);n5=n(ZL,"torch.distributed.launch"),ZL.forEach(t),o5=n(we," where you have to specify how many GPUs to use with "),If=l(we,"CODE",{});var NL=r(If);l5=n(NL,"--nproc_per_node"),NL.forEach(t),r5=n(we,`, with the
