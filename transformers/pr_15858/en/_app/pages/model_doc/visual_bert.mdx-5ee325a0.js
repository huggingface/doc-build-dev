import{S as Dd,i as Ld,s as Sd,e as o,k as d,w as _,t as r,M as Wd,c as n,d as s,m as c,a,x as v,h as i,b as l,F as e,g as p,y as b,q as k,o as T,B as w}from"../../chunks/vendor-4833417e.js";import{T as qs}from"../../chunks/Tip-fffd6df1.js";import{D as L}from"../../chunks/Docstring-44c5af16.js";import{C as Le}from"../../chunks/CodeBlock-90ffda97.js";import{I as se}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function Od(z){let h,B,m,y,V;return{c(){h=o("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=o("code"),y=r("Module"),V=r(`
...
the latter silently ignores them.`)},l(g){h=n(g,"P",{});var f=a(h);B=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n(f,"CODE",{});var $=a(m);y=i($,"Module"),$.forEach(s),V=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(s)},m(g,f){p(g,h,f),e(h,B),e(h,m),e(m,y),e(h,V)},d(g){g&&s(h)}}}function Gd(z){let h,B,m,y,V,g,f,$,$n,yo,oe,Te,xs,Se,zn,Fs,qn,Bo,we,xn,We,Fn,En,Vo,Ut,Pn,$o,Kt,Es,Mn,zo,Jt,An,qo,ye,Ps,Oe,jn,Gt,Cn,Rn,Nn,Ms,As,In,xo,ne,Be,js,Qe,Dn,Cs,Ln,Fo,Yt,Sn,Eo,Xt,Wn,Po,Ve,On,Zt,Qn,Hn,Mo,$e,Rs,es,He,Un,Kn,Jn,Ns,ts,Ue,Gn,Yn,Ao,ze,Xn,ss,Zn,ea,jo,Ke,Co,S,ta,Je,sa,oa,Ge,na,aa,Ro,ae,qe,Is,Ye,ra,Ds,ia,No,q,Xe,la,re,da,os,ca,ua,Ze,ha,pa,ma,ie,fa,ns,ga,_a,as,va,ba,ka,Ls,Ta,wa,et,Io,le,xe,Ss,tt,ya,Ws,Ba,Do,x,st,Va,ot,$a,rs,za,qa,xa,nt,Fa,at,Ea,Pa,Ma,rt,Aa,it,ja,Ca,Ra,j,lt,Na,de,Ia,is,Da,La,Os,Sa,Wa,Oa,Fe,Qa,Qs,Ha,Ua,dt,Lo,ce,Ee,Hs,ct,Ka,Us,Ja,So,F,ut,Ga,ue,Ya,Ks,Xa,Za,Js,er,tr,sr,ht,or,ls,nr,ar,rr,pt,ir,mt,lr,dr,cr,C,ft,ur,he,hr,ds,pr,mr,Gs,fr,gr,_r,Pe,vr,Ys,br,kr,gt,Wo,pe,Me,Xs,_t,Tr,Zs,wr,Oo,E,vt,yr,eo,Br,Vr,bt,$r,cs,zr,qr,xr,kt,Fr,Tt,Er,Pr,Mr,R,wt,Ar,me,jr,us,Cr,Rr,to,Nr,Ir,Dr,Ae,Lr,so,Sr,Wr,yt,Qo,fe,je,oo,Bt,Or,no,Qr,Ho,P,Vt,Hr,ao,Ur,Kr,$t,Jr,hs,Gr,Yr,Xr,zt,Zr,qt,ei,ti,si,N,xt,oi,ge,ni,ps,ai,ri,ro,ii,li,di,Ce,ci,io,ui,hi,Ft,Uo,_e,Re,lo,Et,pi,co,mi,Ko,M,Pt,fi,uo,gi,_i,Mt,vi,ms,bi,ki,Ti,At,wi,jt,yi,Bi,Vi,I,Ct,$i,ve,zi,fs,qi,xi,ho,Fi,Ei,Pi,Ne,Mi,po,Ai,ji,Rt,Jo,be,Ie,mo,Nt,Ci,fo,Ri,Go,A,It,Ni,go,Ii,Di,Dt,Li,gs,Si,Wi,Oi,Lt,Qi,St,Hi,Ui,Ki,D,Wt,Ji,ke,Gi,_s,Yi,Xi,_o,Zi,el,tl,De,sl,vo,ol,nl,Ot,Yo;return g=new se({}),Se=new se({}),Qe=new se({}),Ke=new Le({props:{code:`import torch
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15858/en/model_doc/visual_bert#transformers.VisualBertConfig"
...
`}}),Pe=new qs({props:{$$slots:{default:[Qd]},$$scope:{ctx:z}}}),gt=new Le({props:{code:`# Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
...
loss = outputs.loss
prediction_logits = outputs.prediction_logits
seq_relationship_logits = outputs.seq_relationship_logits`}}),_t=new se({}),vt=new L({props:{name:"class transformers.VisualBertForQuestionAnswering",anchor:"transformers.VisualBertForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15858/src/transformers/models/visual_bert/modeling_visual_bert.py#L1178",parametersDescription:[{anchor:"transformers.VisualBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15858/en/model_doc/visual_bert#transformers.VisualBertConfig">VisualBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15858/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wt=new L({props:{name:"forward",anchor:"transformers.VisualBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"visual_embeds",val:" = None"},{name:"visual_attention_mask",val:" = None"},{name:"visual_token_type_ids",val:" = None"},{name:"image_text_alignment",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15858/src/transformers/models/visual_bert/modeling_visual_bert.py#L1190",parametersDescription:[{anchor:"transformers.VisualBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15858/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15858/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15858/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),Bt=new se({}),Vt=new L({props:{name:"class transformers.VisualBertForMultipleChoice",anchor:"transformers.VisualBertForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15858/src/transformers/models/visual_bert/modeling_visual_bert.py#L1025",parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15858/en/model_doc/visual_bert#transformers.VisualBertConfig">VisualBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15858/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xt=new L({props:{name:"forward",anchor:"transformers.VisualBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"visual_embeds",val:" = None"},{name:"visual_attention_mask",val:" = None"},{name:"visual_token_type_ids",val:" = None"},{name:"image_text_alignment",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15858/src/transformers/models/visual_bert/modeling_visual_bert.py#L1036",parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15858/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15858/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15858/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss = outputs.loss
logits = outputs.logits`}}),Et=new se({}),Pt=new L({props:{name:"class transformers.VisualBertForVisualReasoning",anchor:"transformers.VisualBertForVisualReasoning",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15858/src/transformers/models/visual_bert/modeling_visual_bert.py#L1304",parametersDescription:[{anchor:"transformers.VisualBertForVisualReasoning.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15858/en/model_doc/visual_bert#transformers.VisualBertConfig">VisualBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15858/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ct=new L({props:{name:"forward",anchor:"transformers.VisualBertForVisualReasoning.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"visual_embeds",val:" = None"},{name:"visual_attention_mask",val:" = None"},{name:"visual_token_type_ids",val:" = None"},{name:"image_text_alignment",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15858/src/transformers/models/visual_bert/modeling_visual_bert.py#L1316",parametersDescription:[{anchor:"transformers.VisualBertForVisualReasoning.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15858/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15858/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15858/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),Nt=new se({}),It=new L({props:{name:"class transformers.VisualBertForRegionToPhraseAlignment",anchor:"transformers.VisualBertForRegionToPhraseAlignment",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15858/src/transformers/models/visual_bert/modeling_visual_bert.py#L1464",parametersDescription:[{anchor:"transformers.VisualBertForRegionToPhraseAlignment.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15858/en/model_doc/visual_bert#transformers.VisualBertConfig">VisualBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15858/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Wt=new L({props:{name:"forward",anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"visual_embeds",val:" = None"},{name:"visual_attention_mask",val:" = None"},{name:"visual_token_type_ids",val:" = None"},{name:"image_text_alignment",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"region_to_phrase_position",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15858/src/transformers/models/visual_bert/modeling_visual_bert.py#L1476",parametersDescription:[{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15858/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15858/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15858/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
VisualBERT is a neural network trained on a variety of (image, text) pairs.`),Vo=d(),Ut=o("p"),Pn=r("The abstract from the paper is the following:"),$o=d(),Kt=o("p"),Es=o("em"),Mn=r(`We propose VisualBERT, a simple and flexible framework for modeling a broad range of vision-and-language tasks.
...
verbs and image regions corresponding to their arguments.`),zo=d(),Jt=o("p"),An=r("Tips:"),qo=d(),ye=o("ol"),Ps=o("li"),Oe=o("p"),jn=r("Most of the checkpoints provided work with the "),Gt=o("a"),Cn=r("VisualBertForPreTraining"),Rn=r(` configuration. Other
...
dimension.`),Eo=d(),Xt=o("p"),Wn=r(`To feed images to the model, each image is passed through a pre-trained object detector and the regions and the
...
appropriately for the textual and visual parts.`),Po=d(),Ve=o("p"),On=r("The "),Zt=o("a"),Qn=r("BertTokenizer"),Hn=r(` is used to encode the text. A custom detector/feature extractor must be used
...
etc.)`),xa=d(),nt=o("p"),Fa=r("This model is also a PyTorch "),at=o("a"),Ea=r("torch.nn.Module"),Pa=r(` subclass.
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ra=d(),j=o("div"),_(lt.$$.fragment),Na=d(),de=o("p"),Ia=r("The "),is=o("a"),Da=r("VisualBertModel"),La=r(" forward method, overrides the "),Os=o("code"),Sa=r("__call__"),Wa=r(" special method."),Oa=d(),_(Fe.$$.fragment),Qa=d(),Qs=o("p"),Ha=r("Example:"),Ua=d(),_(dt.$$.fragment),Lo=d(),ce=o("h2"),Ee=o("a"),Hs=o("span"),_(ct.$$.fragment),Ka=d(),Us=o("span"),Ja=r("VisualBertForPreTraining"),So=d(),F=o("div"),_(ut.$$.fragment),Ga=d(),ue=o("p"),Ya=r("VisualBert Model with two heads on top as done during the pretraining: a "),Ks=o("code"),Xa=r("masked language modeling"),Za=r(` head and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cr=d(),C=o("div"),_(ft.$$.fragment),ur=d(),he=o("p"),hr=r("The "),ds=o("a"),pr=r("VisualBertForPreTraining"),mr=r(" forward method, overrides the "),Gs=o("code"),fr=r("__call__"),gr=r(" special method."),_r=d(),_(Pe.$$.fragment),vr=d(),Ys=o("p"),br=r("Example:"),kr=d(),_(gt.$$.fragment),Wo=d(),pe=o("h2"),Me=o("a"),Xs=o("span"),_(_t.$$.fragment),Tr=d(),Zs=o("span"),wr=r("VisualBertForQuestionAnswering"),Oo=d(),E=o("div"),_(vt.$$.fragment),yr=d(),eo=o("p"),Br=r(`VisualBert Model with a classification/regression head on top (a dropout and a linear layer on top of the pooled
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xr=d(),kt=o("p"),Fr=r("This model is also a PyTorch "),Tt=o("a"),Er=r("torch.nn.Module"),Pr=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),si=d(),N=o("div"),_(xt.$$.fragment),oi=d(),ge=o("p"),ni=r("The "),ps=o("a"),ai=r("VisualBertForMultipleChoice"),ri=r(" forward method, overrides the "),ro=o("code"),ii=r("__call__"),li=r(" special method."),di=d(),_(Ce.$$.fragment),ci=d(),io=o("p"),ui=r("Example:"),hi=d(),_(Ft.$$.fragment),Uo=d(),_e=o("h2"),Re=o("a"),lo=o("span"),_(Et.$$.fragment),pi=d(),co=o("span"),mi=r("VisualBertForVisualReasoning"),Ko=d(),M=o("div"),_(Pt.$$.fragment),fi=d(),uo=o("p"),gi=r(`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vi=d(),I=o("div"),_(Ct.$$.fragment),$i=d(),ve=o("p"),zi=r("The "),fs=o("a"),qi=r("VisualBertForVisualReasoning"),xi=r(" forward method, overrides the "),ho=o("code"),Fi=r("__call__"),Ei=r(" special method."),Pi=d(),_(Ne.$$.fragment),Mi=d(),po=o("p"),Ai=r("Example:"),ji=d(),_(Rt.$$.fragment),Jo=d(),be=o("h2"),Ie=o("a"),mo=o("span"),_(Nt.$$.fragment),Ci=d(),fo=o("span"),Ri=r("VisualBertForRegionToPhraseAlignment"),Go=d(),A=o("div"),_(It.$$.fragment),Ni=d(),go=o("p"),Ii=r(`VisualBert Model with a Masked Language Modeling head and an attention layer on top for Region-to-Phrase Alignment
...
visual reasoning and region-to-phrase correspondence tasks. VisualBERT uses a BERT-like transformer to prepare
embeddings for image-text pairs. Both the text and visual features are then projected to a latent space with identical
dimension.`),Tl.forEach(s),Eo=c(t),Xt=n(t,"P",{});var wl=a(Xt);Wn=i(wl,`To feed images to the model, each image is passed through a pre-trained object detector and the regions and the
bounding boxes are extracted. The authors use the features generated after passing these regions through a pre-trained
CNN like ResNet as visual embeddings. They also add absolute position embeddings, and feed the resulting sequence of
vectors to a standard BERT model. The text input is concatenated in the front of the visual embeddings in the embedding
layer, and is expected to be bound by [CLS] and a [SEP] tokens, as in BERT. The segment IDs must also be set
appropriately for the textual and visual parts.`),wl.forEach(s),Po=c(t),Ve=n(t,"P",{});var sn=a(Ve);On=i(sn,"The "),Zt=n(sn,"A",{href:!0});var yl=a(Zt);Qn=i(yl,"BertTokenizer"),yl.forEach(s),Hn=i(sn,` is used to encode the text. A custom detector/feature extractor must be used
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ln.forEach(s),xa=c(O),nt=n(O,"P",{});var dn=a(nt);Fa=i(dn,"This model is also a PyTorch "),at=n(dn,"A",{href:!0,rel:!0});var Wl=a(at);Ea=i(Wl,"torch.nn.Module"),Wl.forEach(s),Pa=i(dn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fn.forEach(s),xr=c(K),kt=n(K,"P",{});var gn=a(kt);Fr=i(gn,"This model is also a PyTorch "),Tt=n(gn,"A",{href:!0,rel:!0});var dd=a(Tt);Er=i(dd,"torch.nn.Module"),dd.forEach(s),Pr=i(gn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
