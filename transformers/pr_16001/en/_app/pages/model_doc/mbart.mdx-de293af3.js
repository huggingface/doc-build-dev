...
<a href="/docs/transformers/pr_16001/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ka=new B({props:{name:"forward",anchor:"transformers.MBartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16001/src/transformers/models/mbart/modeling_mbart.py#L1150",parametersDescription:[{anchor:"transformers.MBartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16001/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hs=new B({props:{name:"forward",anchor:"transformers.MBartForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16001/src/transformers/models/mbart/modeling_mbart.py#L1550",parametersDescription:[{anchor:"transformers.MBartForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16001/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16001/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16001/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16001/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bs=new B({props:{name:"forward",anchor:"transformers.MBartForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16001/src/transformers/models/mbart/modeling_mbart.py#L1425",parametersDescription:[{anchor:"transformers.MBartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16001/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16001/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16001/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16001/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Rx]},$$scope:{ctx:E}}}),Ns=new B({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16001/src/transformers/models/mbart/modeling_tf_mbart.py#L1335",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16001/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16001/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16001/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
target text format is `),Ve=a(jt,"CODE",{});var t0=s(Ve);Kt=i(t0,"[tgt_lang_code] X [eos]"),t0.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var o0=s(rd);Pu=i(o0,"bos"),o0.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Au=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var UT=s(Cn);id=a(UT,"STRONG",{});var n0=s(id);Su=i(n0,"call"),n0.forEach(t),Iu=i(UT,"()"),UT.forEach(t),Nu=i(Ei,` will encode source text format, and it should be wrapped
inside the context manager `),Zr=a(Ei,"A",{href:!0});var a0=s(Zr);Ou=i(a0,"as_target_tokenizer()"),a0.forEach(t),Du=i(Ei," to encode target text format."),Ei.forEach(t),gp=l(o),Yr=a(o,"UL",{});var s0=s(Yr);dd=a(s0,"LI",{});var r0=s(dd);Lu=i(r0,"Supervised training"),r0.forEach(t),s0.forEach(t),kp=l(o),f(An.$$.fragment,o),bp=l(o),ei=a(o,"UL",{});var i0=s(ei);Sn=a(i0,"LI",{});var hh=s(Sn);ld=a(hh,"P",{});var d0=s(ld);Gu=i(d0,"Generation"),d0.forEach(t),Ru=l(hh),Zt=a(hh,"P",{});var Pi=s(Zt);Wu=i(Pi,"While generating the target text set the "),cd=a(Pi,"CODE",{});var l0=s(cd);Uu=i(l0,"decoder_start_token_id"),l0.forEach(t),Xu=i(Pi,` to the target language id. The following
example shows how to translate English to Romanian using the `),pd=a(Pi,"EM",{});var c0=s(pd);Hu=i(c0,"facebook/mbart-large-en-ro"),c0.forEach(t),Vu=i(Pi," model."),Pi.forEach(t),hh.forEach(t),i0.forEach(t),vp=l(o),f(In.$$.fragment,o),yp=l(o),Yt=a(o,"H2",{class:!0});var uh=s(Yt);Ao=a(uh,"A",{id:!0,class:!0,href:!0});var p0=s(Ao);hd=a(p0,"SPAN",{});var h0=s(hd);f(Nn.$$.fragment,h0),h0.forEach(t),p0.forEach(t),Qu=l(uh),ud=a(uh,"SPAN",{});var u0=s(ud);Ju=i(u0,"Overview of MBart-50"),u0.forEach(t),uh.forEach(t),Tp=l(o),vt=a(o,"P",{});var Ci=s(vt);Ku=i(Ci,"MBart-50 was introduced in the "),On=a(Ci,"A",{href:!0,rel:!0});var m0=s(On);Zu=i(m0,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),m0.forEach(t),Yu=i(Ci,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),k0.forEach(t),g0.forEach(t),zp=l(o),eo=a(o,"H3",{class:!0});var mh=s(eo);So=a(mh,"A",{id:!0,class:!0,href:!0});var b0=s(So);_d=a(b0,"SPAN",{});var v0=s(_d);f(Dn.$$.fragment,v0),v0.forEach(t),b0.forEach(t),am=l(mh),gd=a(mh,"SPAN",{});var y0=s(gd);sm=i(y0,"Training of MBart-50"),y0.forEach(t),mh.forEach(t),xp=l(o),et=a(o,"P",{});var wn=s(et);rm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
respectively.`),wn.forEach(t),Bp=l(o),Io=a(o,"P",{});var fh=s(Io);um=i(fh,"MBart-50 has its own tokenizer "),ni=a(fh,"A",{href:!0});var z0=s(ni);mm=i(z0,"MBart50Tokenizer"),z0.forEach(t),fm=i(fh,"."),fh.forEach(t),qp=l(o),ai=a(o,"UL",{});var x0=s(ai);yd=a(x0,"LI",{});var B0=s(yd);_m=i(B0,"Supervised training"),B0.forEach(t),x0.forEach(t),$p=l(o),f(Ln.$$.fragment,o),Fp=l(o),si=a(o,"UL",{});var q0=s(si);Gn=a(q0,"LI",{});var _h=s(Gn);Td=a(_h,"P",{});var $0=s(Td);gm=i($0,"Generation"),$0.forEach(t),km=l(_h),ze=a(_h,"P",{});var nt=s(ze);bm=i(nt,"To generate using the mBART-50 multilingual translation models, "),Md=a(nt,"CODE",{});var F0=s(Md);vm=i(F0,"eos_token_id"),F0.forEach(t),ym=i(nt,` is used as the
...
target language id as the first generated token, pass the `),zd=a(nt,"EM",{});var E0=s(zd);wm=i(E0,"forced_bos_token_id"),E0.forEach(t),zm=i(nt," parameter to the "),xd=a(nt,"EM",{});var P0=s(xd);xm=i(P0,"generate"),P0.forEach(t),Bm=i(nt,` method.
The following example shows how to translate between Hindi to French and Arabic to English using the
`),Bd=a(nt,"EM",{});var C0=s(Bd);qm=i(C0,"facebook/mbart-50-large-many-to-many"),C0.forEach(t),$m=i(nt," checkpoint."),nt.forEach(t),_h.forEach(t),q0.forEach(t),jp=l(o),f(Rn.$$.fragment,o),Ep=l(o),to=a(o,"H2",{class:!0});var gh=s(to);No=a(gh,"A",{id:!0,class:!0,href:!0});var A0=s(No);qd=a(A0,"SPAN",{});var S0=s(qd);f(Wn.$$.fragment,S0),S0.forEach(t),A0.forEach(t),Fm=l(gh),$d=a(gh,"SPAN",{});var I0=s($d);jm=i(I0,"MBartConfig"),I0.forEach(t),gh.forEach(t),Pp=l(o),xe=a(o,"DIV",{class:!0});var Et=s(xe);f(Un.$$.fragment,Et),Em=l(Et),oo=a(Et,"P",{});var Ai=s(oo);Pm=i(Ai,"This is the configuration class to store the configuration of a "),ri=a(Ai,"A",{href:!0});var N0=s(ri);Cm=i(N0,"MBartModel"),N0.forEach(t),Am=i(Ai,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Xn=a(Ai,"A",{href:!0,rel:!0});var O0=s(Xn);Sm=i(O0,"facebook/mbart-large-cc25"),O0.forEach(t),Im=i(Ai," architecture."),Ai.forEach(t),Nm=l(Et),no=a(Et,"P",{});var Si=s(no);Om=i(Si,"Configuration objects inherit from "),ii=a(Si,"A",{href:!0});var D0=s(ii);Dm=i(D0,"PretrainedConfig"),D0.forEach(t),Lm=i(Si,` and can be used to control the model outputs. Read the
documentation from `),di=a(Si,"A",{href:!0});var L0=s(di);Gm=i(L0,"PretrainedConfig"),L0.forEach(t),Rm=i(Si," for more information."),Si.forEach(t),Wm=l(Et),Fd=a(Et,"P",{});var G0=s(Fd);Um=i(G0,"Example:"),G0.forEach(t),Xm=l(Et),f(Hn.$$.fragment,Et),Et.forEach(t),Cp=l(o),ao=a(o,"H2",{class:!0});var kh=s(ao);Oo=a(kh,"A",{id:!0,class:!0,href:!0});var R0=s(Oo);jd=a(R0,"SPAN",{});var W0=s(jd);f(Vn.$$.fragment,W0),W0.forEach(t),R0.forEach(t),Hm=l(kh),Ed=a(kh,"SPAN",{});var U0=s(Ed);Vm=i(U0,"MBartTokenizer"),U0.forEach(t),kh.forEach(t),Ap=l(o),L=a(o,"DIV",{class:!0});var he=s(L);f(Qn.$$.fragment,he),Qm=l(he),Pd=a(he,"P",{});var X0=s(Pd);Jm=i(X0,"Construct an MBART tokenizer."),X0.forEach(t),Km=l(he),ut=a(he,"P",{});var zn=s(ut);Zm=i(zn,"Adapted from "),li=a(zn,"A",{href:!0});var H0=s(li);Ym=i(H0,"RobertaTokenizer"),H0.forEach(t),ef=i(zn," and "),ci=a(zn,"A",{href:!0});var V0=s(ci);tf=i(V0,"XLNetTokenizer"),V0.forEach(t),of=i(zn,`. Based on
`),Jn=a(zn,"A",{href:!0,rel:!0});var Q0=s(Jn);nf=i(Q0,"SentencePiece"),Q0.forEach(t),af=i(zn,"."),zn.forEach(t),sf=l(he),Kn=a(he,"P",{});var bh=s(Kn);rf=i(bh,"The tokenization method is "),Cd=a(bh,"CODE",{});var J0=s(Cd);df=i(J0,"<tokens> <eos> <language code>"),J0.forEach(t),lf=i(bh," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),bh.forEach(t),cf=l(he),Ad=a(he,"P",{});var K0=s(Ad);pf=i(K0,"Examples:"),K0.forEach(t),hf=l(he),f(Zn.$$.fragment,he),uf=l(he),Do=a(he,"DIV",{class:!0});var vh=s(Do);f(Yn.$$.fragment,vh),mf=l(vh),Sd=a(vh,"P",{});var Z0=s(Sd);ff=i(Z0,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Z0.forEach(t),vh.forEach(t),_f=l(he),tt=a(he,"DIV",{class:!0});var xn=s(tt);f(ea.$$.fragment,xn),gf=l(xn),ta=a(xn,"P",{});var yh=s(ta);kf=i(yh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
