...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16001/en/model_doc/mbart#transformers.MBartConfig"
...
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
source and target text. The source text format is `),de=a(jt,"CODE",{});var YT=s(de);Ht=i(YT,"X [eos, src_lang_code]"),YT.forEach(t),Vt=i(jt," where "),le=a(jt,"CODE",{});var e0=s(le);Qt=i(e0,"X"),e0.forEach(t),Jt=i(jt,` is the source text. The
target text format is `),Ve=a(jt,"CODE",{});var t0=s(Ve);Kt=i(t0,"[tgt_lang_code] X [eos]"),t0.forEach(t),Eu=i(jt,". "),rd=a(jt,"CODE",{});var o0=s(rd);Pu=i(o0,"bos"),o0.forEach(t),Cu=i(jt," is never used."),jt.forEach(t),_p=l(o),bt=a(o,"P",{});var Ei=s(bt);Su=i(Ei,"The regular "),Cn=a(Ei,"A",{href:!0});var UT=s(Cn);id=a(UT,"STRONG",{});var n0=s(id);Au=i(n0,"call"),n0.forEach(t),Iu=i(UT,"()"),UT.forEach(t),Nu=i(Ei,` will encode source text format, and it should be wrapped
inside the context manager `),Zr=a(Ei,"A",{href:!0});var a0=s(Zr);Ou=i(a0,"as_target_tokenizer()"),a0.forEach(t),Du=i(Ei," to encode target text format."),Ei.forEach(t),gp=l(o),Yr=a(o,"UL",{});var s0=s(Yr);dd=a(s0,"LI",{});var r0=s(dd);Lu=i(r0,"Supervised training"),r0.forEach(t),s0.forEach(t),kp=l(o),f(Sn.$$.fragment,o),bp=l(o),ei=a(o,"UL",{});var i0=s(ei);An=a(i0,"LI",{});var hh=s(An);ld=a(hh,"P",{});var d0=s(ld);Gu=i(d0,"Generation"),d0.forEach(t),Wu=l(hh),Zt=a(hh,"P",{});var Pi=s(Zt);Ru=i(Pi,"While generating the target text set the "),cd=a(Pi,"CODE",{});var l0=s(cd);Uu=i(l0,"decoder_start_token_id"),l0.forEach(t),Xu=i(Pi,` to the target language id. The following
example shows how to translate English to Romanian using the `),pd=a(Pi,"EM",{});var c0=s(pd);Hu=i(c0,"facebook/mbart-large-en-ro"),c0.forEach(t),Vu=i(Pi," model."),Pi.forEach(t),hh.forEach(t),i0.forEach(t),vp=l(o),f(In.$$.fragment,o),yp=l(o),Yt=a(o,"H2",{class:!0});var uh=s(Yt);So=a(uh,"A",{id:!0,class:!0,href:!0});var p0=s(So);hd=a(p0,"SPAN",{});var h0=s(hd);f(Nn.$$.fragment,h0),h0.forEach(t),p0.forEach(t),Qu=l(uh),ud=a(uh,"SPAN",{});var u0=s(ud);Ju=i(u0,"Overview of MBart-50"),u0.forEach(t),uh.forEach(t),Tp=l(o),vt=a(o,"P",{});var Ci=s(vt);Ku=i(Ci,"MBart-50 was introduced in the "),On=a(Ci,"A",{href:!0,rel:!0});var m0=s(On);Zu=i(m0,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),m0.forEach(t),Yu=i(Ci,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
Chaudhary, Jiatao Gu, Angela Fan. MBart-50 is created using the original `),md=a(Ci,"EM",{});var f0=s(md);em=i(f0,"mbart-large-cc25"),f0.forEach(t),tm=i(Ci,` checkpoint by extendeding
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Ci.forEach(t),Mp=l(o),ti=a(o,"P",{});var _0=s(ti);om=i(_0,"According to the abstract"),_0.forEach(t),wp=l(o),oi=a(o,"P",{});var g0=s(oi);fd=a(g0,"EM",{});var k0=s(fd);nm=i(k0,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),k0.forEach(t),g0.forEach(t),xp=l(o),eo=a(o,"H3",{class:!0});var mh=s(eo);Ao=a(mh,"A",{id:!0,class:!0,href:!0});var b0=s(Ao);_d=a(b0,"SPAN",{});var v0=s(_d);f(Dn.$$.fragment,v0),v0.forEach(t),b0.forEach(t),am=l(mh),gd=a(mh,"SPAN",{});var y0=s(gd);sm=i(y0,"Training of MBart-50"),y0.forEach(t),mh.forEach(t),zp=l(o),et=a(o,"P",{});var wn=s(et);rm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),kd=a(wn,"CODE",{});var T0=s(kd);im=i(T0,"[lang_code] X [eos]"),T0.forEach(t),dm=i(wn,", where "),bd=a(wn,"CODE",{});var M0=s(bd);lm=i(M0,"lang_code"),M0.forEach(t),cm=i(wn,` is source
language id for source text and target language id for target text, with `),vd=a(wn,"CODE",{});var w0=s(vd);pm=i(w0,"X"),w0.forEach(t),hm=i(wn,` being the source or target text
respectively.`),wn.forEach(t),qp=l(o),Io=a(o,"P",{});var fh=s(Io);um=i(fh,"MBart-50 has its own tokenizer "),ni=a(fh,"A",{href:!0});var x0=s(ni);mm=i(x0,"MBart50Tokenizer"),x0.forEach(t),fm=i(fh,"."),fh.forEach(t),Bp=l(o),ai=a(o,"UL",{});var z0=s(ai);yd=a(z0,"LI",{});var q0=s(yd);_m=i(q0,"Supervised training"),q0.forEach(t),z0.forEach(t),$p=l(o),f(Ln.$$.fragment,o),Fp=l(o),si=a(o,"UL",{});var B0=s(si);Gn=a(B0,"LI",{});var _h=s(Gn);Td=a(_h,"P",{});var $0=s(Td);gm=i($0,"Generation"),$0.forEach(t),km=l(_h),xe=a(_h,"P",{});var nt=s(xe);bm=i(nt,"To generate using the mBART-50 multilingual translation models, "),Md=a(nt,"CODE",{});var F0=s(Md);vm=i(F0,"eos_token_id"),F0.forEach(t),ym=i(nt,` is used as the
`),wd=a(nt,"CODE",{});var j0=s(wd);Tm=i(j0,"decoder_start_token_id"),j0.forEach(t),Mm=i(nt,` and the target language id is forced as the first generated token. To force the
target language id as the first generated token, pass the `),xd=a(nt,"EM",{});var E0=s(xd);wm=i(E0,"forced_bos_token_id"),E0.forEach(t),xm=i(nt," parameter to the "),zd=a(nt,"EM",{});var P0=s(zd);zm=i(P0,"generate"),P0.forEach(t),qm=i(nt,` method.
The following example shows how to translate between Hindi to French and Arabic to English using the
`),qd=a(nt,"EM",{});var C0=s(qd);Bm=i(C0,"facebook/mbart-50-large-many-to-many"),C0.forEach(t),$m=i(nt," checkpoint."),nt.forEach(t),_h.forEach(t),B0.forEach(t),jp=l(o),f(Wn.$$.fragment,o),Ep=l(o),to=a(o,"H2",{class:!0});var gh=s(to);No=a(gh,"A",{id:!0,class:!0,href:!0});var S0=s(No);Bd=a(S0,"SPAN",{});var A0=s(Bd);f(Rn.$$.fragment,A0),A0.forEach(t),S0.forEach(t),Fm=l(gh),$d=a(gh,"SPAN",{});var I0=s($d);jm=i(I0,"MBartConfig"),I0.forEach(t),gh.forEach(t),Pp=l(o),ze=a(o,"DIV",{class:!0});var Et=s(ze);f(Un.$$.fragment,Et),Em=l(Et),oo=a(Et,"P",{});var Si=s(oo);Pm=i(Si,"This is the configuration class to store the configuration of a "),ri=a(Si,"A",{href:!0});var N0=s(ri);Cm=i(N0,"MBartModel"),N0.forEach(t),Sm=i(Si,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Xn=a(Si,"A",{href:!0,rel:!0});var O0=s(Xn);Am=i(O0,"facebook/mbart-large-cc25"),O0.forEach(t),Im=i(Si," architecture."),Si.forEach(t),Nm=l(Et),no=a(Et,"P",{});var Ai=s(no);Om=i(Ai,"Configuration objects inherit from "),ii=a(Ai,"A",{href:!0});var D0=s(ii);Dm=i(D0,"PretrainedConfig"),D0.forEach(t),Lm=i(Ai,` and can be used to control the model outputs. Read the
documentation from `),di=a(Ai,"A",{href:!0});var L0=s(di);Gm=i(L0,"PretrainedConfig"),L0.forEach(t),Wm=i(Ai," for more information."),Ai.forEach(t),Rm=l(Et),Fd=a(Et,"P",{});var G0=s(Fd);Um=i(G0,"Example:"),G0.forEach(t),Xm=l(Et),f(Hn.$$.fragment,Et),Et.forEach(t),Cp=l(o),ao=a(o,"H2",{class:!0});var kh=s(ao);Oo=a(kh,"A",{id:!0,class:!0,href:!0});var W0=s(Oo);jd=a(W0,"SPAN",{});var R0=s(jd);f(Vn.$$.fragment,R0),R0.forEach(t),W0.forEach(t),Hm=l(kh),Ed=a(kh,"SPAN",{});var U0=s(Ed);Vm=i(U0,"MBartTokenizer"),U0.forEach(t),kh.forEach(t),Sp=l(o),L=a(o,"DIV",{class:!0});var he=s(L);f(Qn.$$.fragment,he),Qm=l(he),Pd=a(he,"P",{});var X0=s(Pd);Jm=i(X0,"Construct an MBART tokenizer."),X0.forEach(t),Km=l(he),ut=a(he,"P",{});var xn=s(ut);Zm=i(xn,"Adapted from "),li=a(xn,"A",{href:!0});var H0=s(li);Ym=i(H0,"RobertaTokenizer"),H0.forEach(t),ef=i(xn," and "),ci=a(xn,"A",{href:!0});var V0=s(ci);tf=i(V0,"XLNetTokenizer"),V0.forEach(t),of=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var Q0=s(Jn);nf=i(Q0,"SentencePiece"),Q0.forEach(t),af=i(xn,"."),xn.forEach(t),sf=l(he),Kn=a(he,"P",{});var bh=s(Kn);rf=i(bh,"The tokenization method is "),Cd=a(bh,"CODE",{});var J0=s(Cd);df=i(J0,"<tokens> <eos> <language code>"),J0.forEach(t),lf=i(bh," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),bh.forEach(t),cf=l(he),Sd=a(he,"P",{});var K0=s(Sd);pf=i(K0,"Examples:"),K0.forEach(t),hf=l(he),f(Zn.$$.fragment,he),uf=l(he),Do=a(he,"DIV",{class:!0});var vh=s(Do);f(Yn.$$.fragment,vh),mf=l(vh),Ad=a(vh,"P",{});var Z0=s(Ad);ff=i(Z0,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Z0.forEach(t),vh.forEach(t),_f=l(he),tt=a(he,"DIV",{class:!0});var zn=s(tt);f(ea.$$.fragment,zn),gf=l(zn),ta=a(zn,"P",{});var yh=s(ta);kf=i(yh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Id=a(yh,"CODE",{});var Y0=s(Id);bf=i(Y0,"X"),Y0.forEach(t),vf=i(yh," represents the sequence:"),yh.forEach(t),yf=l(zn),oa=a(zn,"UL",{});var Th=s(oa);na=a(Th,"LI",{});var Mh=s(na);Nd=a(Mh,"CODE",{});var eM=s(Nd);Tf=i(eM,"input_ids"),eM.forEach(t),Mf=i(Mh," (for encoder) "),Od=a(Mh,"CODE",{});var tM=s(Od);wf=i(tM,"X [eos, src_lang_code]"),tM.forEach(t),Mh.forEach(t),xf=l(Th),aa=a(Th,"LI",{});var wh=s(aa);Dd=a(wh,"CODE",{});var oM=s(Dd);zf=i(oM,"decoder_input_ids"),oM.forEach(t),qf=i(wh,": (for decoder) "),Ld=a(wh,"CODE",{});var nM=s(Ld);Bf=i(nM,"X [eos, tgt_lang_code]"),nM.forEach(t),wh.forEach(t),Th.forEach(t),$f=l(zn),Gd=a(zn,"P",{});var aM=s(Gd);Ff=i(aM,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
