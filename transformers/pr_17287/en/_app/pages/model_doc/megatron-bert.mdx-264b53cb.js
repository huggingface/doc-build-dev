import{S as cm,i as pm,s as hm,e as a,k as m,w as v,t as r,M as mm,c as i,d as o,m as g,a as l,x as M,h as s,b as f,F as e,g as b,y as T,q as w,o as $,B as y,v as gm,L as j}from"../../chunks/vendor-6b77c823.js";import{T as We}from"../../chunks/Tip-39098574.js";import{D as P}from"../../chunks/Docstring-1088f2fb.js";import{C as z}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as te}from"../../chunks/IconCopyLink-7a11ce68.js";import{E}from"../../chunks/ExampleCodeBlock-5212b321.js";function um(B){let d,_,c,h,k;return h=new z({props:{code:`from transformers import MegatronBertModel, MegatronBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){T(d,c,h),_=!0},p:j,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Im(B){let d,_,c,h,k,n,p,F,$a,ls,fe,Re,Qn,Et,ya,Gn,Ba,ds,He,Fa,jt,za,xa,cs,nn,Pa,ps,rn,Vn,qa,hs,sn,Ca,ms,Ue,Ea,Ot,ja,Oa,gs,oe,Aa,At,La,Sa,Lt,Na,Ia,us,an,Da,fs,ln,Wa,_s,St,bs,dn,Ra,ks,Nt,vs,cn,Ha,Ms,ne,Ua,Jn,Qa,Ga,Kn,Va,Ja,Ts,It,ws,Dt,$s,re,Ka,Wt,Ya,Xa,Rt,Za,ei,ys,_e,Qe,Yn,Ht,ti,Xn,oi,Bs,J,Ut,ni,be,ri,pn,si,ai,Qt,ii,li,di,ke,ci,hn,pi,hi,mn,mi,gi,ui,Ge,Fs,ve,Ve,Zn,Gt,fi,er,_i,zs,x,Vt,bi,tr,ki,vi,Jt,Mi,gn,Ti,wi,$i,Kt,yi,Yt,Bi,Fi,zi,Xt,xi,Zt,Pi,qi,Ci,C,Ei,or,ji,Oi,nr,Ai,Li,rr,Si,Ni,sr,Ii,Di,ar,Wi,Ri,ir,Hi,Ui,Qi,K,eo,Gi,Me,Vi,un,Ji,Ki,lr,Yi,Xi,Zi,Je,el,Ke,xs,Te,Ye,dr,to,tl,cr,ol,Ps,O,oo,nl,no,rl,pr,sl,al,il,ro,ll,fn,dl,cl,pl,so,hl,ao,ml,gl,ul,R,io,fl,we,_l,_n,bl,kl,hr,vl,Ml,Tl,Xe,wl,Ze,$l,et,qs,$e,tt,mr,lo,yl,gr,Bl,Cs,A,co,Fl,po,zl,ur,xl,Pl,ql,ho,Cl,bn,El,jl,Ol,mo,Al,go,Ll,Sl,Nl,Y,uo,Il,ye,Dl,kn,Wl,Rl,fr,Hl,Ul,Ql,ot,Gl,nt,Es,Be,rt,_r,fo,Vl,br,Jl,js,L,_o,Kl,bo,Yl,kr,Xl,Zl,ed,ko,td,vn,od,nd,rd,vo,sd,Mo,ad,id,ld,X,To,dd,Fe,cd,Mn,pd,hd,vr,md,gd,ud,st,fd,at,Os,ze,it,Mr,wo,_d,Tr,bd,As,S,$o,kd,xe,vd,wr,Md,Td,$r,wd,$d,yd,yo,Bd,Tn,Fd,zd,xd,Bo,Pd,Fo,qd,Cd,Ed,Z,zo,jd,Pe,Od,wn,Ad,Ld,yr,Sd,Nd,Id,lt,Dd,dt,Ls,qe,ct,Br,xo,Wd,Fr,Rd,Ss,N,Po,Hd,zr,Ud,Qd,qo,Gd,$n,Vd,Jd,Kd,Co,Yd,Eo,Xd,Zd,ec,q,jo,tc,Ce,oc,yn,nc,rc,xr,sc,ac,ic,pt,lc,ht,dc,mt,cc,gt,pc,ut,Ns,Ee,ft,Pr,Oo,hc,qr,mc,Is,I,Ao,gc,Cr,uc,fc,Lo,_c,Bn,bc,kc,vc,So,Mc,No,Tc,wc,$c,ee,Io,yc,je,Bc,Fn,Fc,zc,Er,xc,Pc,qc,_t,Cc,bt,Ds,Oe,kt,jr,Do,Ec,Or,jc,Ws,D,Wo,Oc,Ar,Ac,Lc,Ro,Sc,zn,Nc,Ic,Dc,Ho,Wc,Uo,Rc,Hc,Uc,H,Qo,Qc,Ae,Gc,xn,Vc,Jc,Lr,Kc,Yc,Xc,vt,Zc,Mt,ep,Tt,Rs,Le,wt,Sr,Go,tp,Nr,op,Hs,W,Vo,np,Se,rp,Ir,sp,ap,Dr,ip,lp,dp,Jo,cp,Pn,pp,hp,mp,Ko,gp,Yo,up,fp,_p,U,Xo,bp,Ne,kp,qn,vp,Mp,Wr,Tp,wp,$p,$t,yp,yt,Bp,Bt,Us;return n=new te({}),Et=new te({}),St=new z({props:{code:`wget --content-disposition https://api.ngc.nvidia.com/v2/models/nvidia/megatron_bert_345m/versions/v0.1_uncased/zip
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L873",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17287/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17287/en/model_doc/megatron-bert#transformers.MegatronBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1287",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1138",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1384",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1027",returnDescription:`
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1490",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1587",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1685",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1766",returnDescription:`
<p>A <a
...
`}}),$t=new We({props:{$$slots:{default:[Lm]},$$scope:{ctx:B}}}),yt=new E({props:{anchor:"transformers.MegatronBertForQuestionAnswering.forward.example",$$slots:{default:[Sm]},$$scope:{ctx:B}}}),Bt=new E({props:{anchor:"transformers.MegatronBertForQuestionAnswering.forward.example-2",$$slots:{default:[Nm]},$$scope:{ctx:B}}}),{c(){d=a("meta"),_=m(),c=a("h1"),h=a("a"),k=a("span"),v(n.$$.fragment),p=m(),F=a("span"),$a=r("MegatronBERT"),ls=m(),fe=a("h2"),Re=a("a"),Qn=a("span"),v(Et.$$.fragment),ya=m(),Gn=a("span"),Ba=r("Overview"),ds=m(),He=a("p"),Fa=r("The MegatronBERT model was proposed in "),jt=a("a"),za=r(`Megatron-LM: Training Multi-Billion Parameter Language Models Using Model
...
`),sr=a("code"),Ii=r("add_cross_attention"),Di=r(" set to "),ar=a("code"),Wi=r("True"),Ri=r("; an "),ir=a("code"),Hi=r("encoder_hidden_states"),Ui=r(" is then expected as an input to the forward pass."),Qi=m(),K=a("div"),v(eo.$$.fragment),Gi=m(),Me=a("p"),Vi=r("The "),un=a("a"),Ji=r("MegatronBertModel"),Ki=r(" forward method, overrides the "),lr=a("code"),Yi=r("__call__"),Xi=r(" special method."),Zi=m(),v(Je.$$.fragment),el=m(),v(Ke.$$.fragment),xs=m(),Te=a("h2"),Ye=a("a"),dr=a("span"),v(to.$$.fragment),tl=m(),cr=a("span"),ol=r("MegatronBertForMaskedLM"),Ps=m(),O=a("div"),v(oo.$$.fragment),nl=m(),no=a("p"),rl=r("MegatronBert Model with a "),pr=a("code"),sl=r("language modeling"),al=r(" head on top."),il=m(),ro=a("p"),ll=r("This model inherits from "),fn=a("a"),dl=r("PreTrainedModel"),cl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nl=m(),Y=a("div"),v(uo.$$.fragment),Il=m(),ye=a("p"),Dl=r("The "),kn=a("a"),Wl=r("MegatronBertForCausalLM"),Rl=r(" forward method, overrides the "),fr=a("code"),Hl=r("__call__"),Ul=r(" special method."),Ql=m(),v(ot.$$.fragment),Gl=m(),v(nt.$$.fragment),Es=m(),Be=a("h2"),rt=a("a"),_r=a("span"),v(fo.$$.fragment),Vl=m(),br=a("span"),Jl=r("MegatronBertForNextSentencePrediction"),js=m(),L=a("div"),v(_o.$$.fragment),Kl=m(),bo=a("p"),Yl=r("MegatronBert Model with a "),kr=a("code"),Xl=r("next sentence prediction (classification)"),Zl=r(" head on top."),ed=m(),ko=a("p"),td=r("This model inherits from "),vn=a("a"),od=r("PreTrainedModel"),nd=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
pooled output) e.g. for GLUE tasks.`),Qd=m(),qo=a("p"),Gd=r("This model inherits from "),$n=a("a"),Vd=r("PreTrainedModel"),Jd=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uc=m(),H=a("div"),v(Qo.$$.fragment),Qc=m(),Ae=a("p"),Gc=r("The "),xn=a("a"),Vc=r("MegatronBertForTokenClassification"),Jc=r(" forward method, overrides the "),Lr=a("code"),Kc=r("__call__"),Yc=r(" special method."),Xc=m(),v(vt.$$.fragment),Zc=m(),v(Mt.$$.fragment),ep=m(),v(Tt.$$.fragment),Rs=m(),Le=a("h2"),wt=a("a"),Sr=a("span"),v(Go.$$.fragment),tp=m(),Nr=a("span"),op=r("MegatronBertForQuestionAnswering"),Hs=m(),W=a("div"),v(Vo.$$.fragment),np=m(),Se=a("p"),rp=r(`MegatronBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
MEGATRON_BERT model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the MEGATRON_BERT
`),Qt=i(En,"A",{href:!0,rel:!0});var jp=l(Qt);ii=s(jp,"nvidia/megatron-bert-uncased-345m"),jp.forEach(o),li=s(En," architecture."),En.forEach(o),di=g(Ft),ke=i(Ft,"P",{});var jn=l(ke);ci=s(jn,"Configuration objects inherit from "),hn=i(jn,"A",{href:!0});var Op=l(hn);pi=s(Op,"PretrainedConfig"),Op.forEach(o),hi=s(jn,` and can be used to control the model outputs. Read the
documentation from `),mn=i(jn,"A",{href:!0});var Ap=l(mn);mi=s(Ap,"PretrainedConfig"),Ap.forEach(o),gi=s(jn," for more information."),jn.forEach(o),ui=g(Ft),M(Ge.$$.fragment,Ft),Ft.forEach(o),Fs=g(t),ve=i(t,"H2",{class:!0});var Gs=l(ve);Ve=i(Gs,"A",{id:!0,class:!0,href:!0});var Lp=l(Ve);Zn=i(Lp,"SPAN",{});var Sp=l(Zn);M(Gt.$$.fragment,Sp),Sp.forEach(o),Lp.forEach(o),fi=g(Gs),er=i(Gs,"SPAN",{});var Np=l(er);_i=s(Np,"MegatronBertModel"),Np.forEach(o),Gs.forEach(o),zs=g(t),x=i(t,"DIV",{class:!0});var Q=l(x);M(Vt.$$.fragment,Q),bi=g(Q),tr=i(Q,"P",{});var Ip=l(tr);ki=s(Ip,"The bare MegatronBert Model transformer outputting raw hidden-states without any specific head on top."),Ip.forEach(o),vi=g(Q),Jt=i(Q,"P",{});var Vs=l(Jt);Mi=s(Vs,"This model inherits from "),gn=i(Vs,"A",{href:!0});var Dp=l(gn);Ti=s(Dp,"PreTrainedModel"),Dp.forEach(o),wi=s(Vs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vs.forEach(o),$i=g(Q),Kt=i(Q,"P",{});var Js=l(Kt);yi=s(Js,"This model is also a PyTorch "),Yt=i(Js,"A",{href:!0,rel:!0});var Wp=l(Yt);Bi=s(Wp,"torch.nn.Module"),Wp.forEach(o),Fi=s(Js,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ks.forEach(o),Ci=g(Q),C=i(Q,"P",{});var G=l(C);Ei=s(G,"To behave as an decoder the model needs to be initialized with the "),or=i(G,"CODE",{});var Hp=l(or);ji=s(Hp,"is_decoder"),Hp.forEach(o),Oi=s(G,` argument of the configuration set
to `),nr=i(G,"CODE",{});var Up=l(nr);Ai=s(Up,"True"),Up.forEach(o),Li=s(G,". To be used in a Seq2Seq model, the model needs to initialized with both "),rr=i(G,"CODE",{});var Qp=l(rr);Si=s(Qp,"is_decoder"),Qp.forEach(o),Ni=s(G,` argument and
`),sr=i(G,"CODE",{});var Gp=l(sr);Ii=s(Gp,"add_cross_attention"),Gp.forEach(o),Di=s(G," set to "),ar=i(G,"CODE",{});var Vp=l(ar);Wi=s(Vp,"True"),Vp.forEach(o),Ri=s(G,"; an "),ir=i(G,"CODE",{});var Jp=l(ir);Hi=s(Jp,"encoder_hidden_states"),Jp.forEach(o),Ui=s(G," is then expected as an input to the forward pass."),G.forEach(o),Qi=g(Q),K=i(Q,"DIV",{class:!0});var zt=l(K);M(eo.$$.fragment,zt),Gi=g(zt),Me=i(zt,"P",{});var On=l(Me);Vi=s(On,"The "),un=i(On,"A",{href:!0});var Kp=l(un);Ji=s(Kp,"MegatronBertModel"),Kp.forEach(o),Ki=s(On," forward method, overrides the "),lr=i(On,"CODE",{});var Yp=l(lr);Yi=s(Yp,"__call__"),Yp.forEach(o),Xi=s(On," special method."),On.forEach(o),Zi=g(zt),M(Je.$$.fragment,zt),el=g(zt),M(Ke.$$.fragment,zt),zt.forEach(o),Q.forEach(o),xs=g(t),Te=i(t,"H2",{class:!0});var Ys=l(Te);Ye=i(Ys,"A",{id:!0,class:!0,href:!0});var Xp=l(Ye);dr=i(Xp,"SPAN",{});var Zp=l(dr);M(to.$$.fragment,Zp),Zp.forEach(o),Xp.forEach(o),tl=g(Ys),cr=i(Ys,"SPAN",{});var eh=l(cr);ol=s(eh,"MegatronBertForMaskedLM"),eh.forEach(o),Ys.forEach(o),Ps=g(t),O=i(t,"DIV",{class:!0});var se=l(O);M(oo.$$.fragment,se),nl=g(se),no=i(se,"P",{});var Xs=l(no);rl=s(Xs,"MegatronBert Model with a "),pr=i(Xs,"CODE",{});var th=l(pr);sl=s(th,"language modeling"),th.forEach(o),al=s(Xs," head on top."),Xs.forEach(o),il=g(se),ro=i(se,"P",{});var Zs=l(ro);ll=s(Zs,"This model inherits from "),fn=i(Zs,"A",{href:!0});var oh=l(fn);dl=s(oh,"PreTrainedModel"),oh.forEach(o),cl=s(Zs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
pooled output) e.g. for GLUE tasks.`),jh.forEach(o),Qd=g(ce),qo=i(ce,"P",{});var ma=l(qo);Gd=s(ma,"This model inherits from "),$n=i(ma,"A",{href:!0});var Oh=l($n);Vd=s(Oh,"PreTrainedModel"),Oh.forEach(o),Jd=s(ma,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
