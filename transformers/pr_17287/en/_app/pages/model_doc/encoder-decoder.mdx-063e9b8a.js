import{S as ip,i as cp,s as lp,e as a,k as l,w as y,t as n,M as pp,c as s,d as t,m as p,a as d,x as k,h as r,b as c,F as e,g as u,y as w,q as E,o as T,B as $,v as mp,L as et}from"../../chunks/vendor-6b77c823.js";import{T as vc}from"../../chunks/Tip-39098574.js";import{D as W}from"../../chunks/Docstring-1088f2fb.js";import{C as V}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ee}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Xo}from"../../chunks/ExampleCodeBlock-5212b321.js";function hp(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,v),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function up(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import EncoderDecoderModel, BertTokenizer
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids)`}}),{c(){h=a("p"),v=n("Examples:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Examples:"),g.forEach(t),_=p(i),k(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),w(f,i,g),b=!0},p:et,i(i){b||(E(f.$$.fragment,i),b=!0)},o(i){T(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function gp(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import EncoderDecoderModel
...
the latter silently ignores them.`)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(g,"CODE",{});var S=d(_);f=r(S,"Module"),S.forEach(t),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,v),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function bp(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import TFEncoderDecoderModel, BertTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># generation</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids, decoder_start_token_id=model.config.decoder.bos_token_id)`}}),{c(){h=a("p"),v=n("Examples:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Examples:"),g.forEach(t),_=p(i),k(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),w(f,i,g),b=!0},p:et,i(i){b||(E(f.$$.fragment,i),b=!0)},o(i){T(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function vp(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import TFEncoderDecoderModel
...
the latter silently ignores them.`)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(g,"CODE",{});var S=d(_);f=r(S,"Module"),S.forEach(t),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,v),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function kp(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> summary == <span class="hljs-string">&quot;SAS Alpha Epsilon suspended Sigma Alpha Epsilon members&quot;</span>`}}),{c(){h=a("p"),v=n("Examples:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Examples:"),g.forEach(t),_=p(i),k(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),w(f,i,g),b=!0},p:et,i(i){b||(E(f.$$.fragment,i),b=!0)},o(i){T(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function wp(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import FlaxEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){h=a("p"),v=n("Example:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Example:"),g.forEach(t),_=p(i),k(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),w(f,i,g),b=!0},p:et,i(i){b||(E(f.$$.fragment,i),b=!0)},o(i){T(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function Ep(j){let h,v,_,f,b,i,g,S,Xr,Qn,oe,ke,Gt,Xe,ea,Ht,oa,Xn,we,ta,ot,na,ra,er,Ee,aa,eo,sa,da,or,Te,ia,tt,ca,la,tr,G,pa,nt,ma,ha,oo,fa,ua,nr,te,$e,Ut,to,ga,Yt,_a,rr,ne,rt,ba,va,at,ya,ka,ar,no,sr,re,Me,Jt,ro,wa,Zt,Ea,dr,M,st,Ta,$a,Kt,Ma,Da,Qt,xa,qa,Xt,ja,za,en,Fa,Pa,dt,Aa,Ca,De,Sa,on,Na,Ia,tn,La,Ba,it,Oa,Ra,ir,ao,cr,ae,xe,nn,so,Wa,rn,Va,lr,H,Ga,an,Ha,Ua,sn,Ya,Ja,pr,io,mr,qe,Za,dn,Ka,Qa,hr,se,cn,Xa,es,ln,os,ts,fr,co,ur,de,je,pn,lo,ns,mn,rs,gr,N,as,hn,ss,ds,fn,is,cs,un,ls,ps,gn,ms,hs,_r,po,br,ze,fs,mo,us,gs,vr,U,_s,ho,bs,vs,fo,ys,ks,yr,ie,Fe,_n,uo,ws,bn,Es,kr,C,go,Ts,Pe,ct,$s,Ms,lt,Ds,xs,qs,ce,js,pt,zs,Fs,mt,Ps,As,Cs,Ae,Ss,Ce,_o,Ns,bo,Is,ht,Ls,Bs,Os,Se,vo,Rs,le,Ws,vn,Vs,Gs,yn,Hs,Us,wr,pe,Ne,kn,yo,Ys,wn,Js,Er,D,ko,Zs,me,Ks,ft,Qs,Xs,ut,ed,od,td,wo,nd,Eo,rd,ad,sd,En,dd,id,To,cd,gt,ld,pd,md,$o,hd,Mo,fd,ud,gd,Y,_t,_d,bd,Tn,vd,yd,$n,kd,wd,Ed,I,Do,Td,he,$d,bt,Md,Dd,Mn,xd,qd,jd,Ie,zd,Le,Fd,L,xo,Pd,Dn,Ad,Cd,fe,Sd,xn,Nd,Id,qn,Ld,Bd,Od,Be,Tr,ue,Oe,jn,qo,Rd,zn,Wd,$r,x,jo,Vd,ge,Gd,vt,Hd,Ud,yt,Yd,Jd,Zd,zo,Kd,Fo,Qd,Xd,ei,Fn,oi,ti,Po,ni,kt,ri,ai,si,Ao,di,Co,ii,ci,li,J,wt,pi,mi,Et,hi,fi,Tt,ui,gi,_i,B,So,bi,_e,vi,$t,yi,ki,Pn,wi,Ei,Ti,Re,$i,We,Mi,Z,No,Di,An,xi,qi,Ve,Mr,be,Ge,Cn,Io,ji,Sn,zi,Dr,q,Lo,Fi,ve,Pi,Mt,Ai,Ci,Dt,Si,Ni,Ii,Bo,Li,Oo,Bi,Oi,Ri,Nn,Wi,Vi,Ro,Gi,xt,Hi,Ui,Yi,Wo,Ji,Vo,Zi,Ki,Qi,K,qt,Xi,ec,In,oc,tc,Ln,nc,rc,ac,O,Go,sc,ye,dc,jt,ic,cc,Bn,lc,pc,mc,He,hc,Ue,fc,Q,Ho,uc,On,gc,_c,Ye,xr;return i=new ee({}),Xe=new ee({}),to=new ee({}),no=new V({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
<span class="hljs-number">0.72</span>`}}),uo=new ee({}),go=new W({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),Ae=new Xo({props:{anchor:"transformers.EncoderDecoderConfig.example",$$slots:{default:[hp]},$$scope:{ctx:j}}}),_o=new W({props:{name:"from_encoder_decoder_configs",anchor:"transformers.EncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L91",returnDescription:`
...
`}}),vo=new W({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
`}}),Ie=new vc({props:{$$slots:{default:[fp]},$$scope:{ctx:j}}}),Le=new Xo({props:{anchor:"transformers.EncoderDecoderModel.forward.example",$$slots:{default:[up]},$$scope:{ctx:j}}}),xo=new W({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L280"}}),Be=new Xo({props:{anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[gp]},$$scope:{ctx:j}}}),qo=new ee({}),jo=new W({props:{name:"class transformers.TFEncoderDecoderModel",anchor:"transformers.TFEncoderDecoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17287/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Re=new vc({props:{$$slots:{default:[_p]},$$scope:{ctx:j}}}),We=new Xo({props:{anchor:"transformers.TFEncoderDecoderModel.call.example",$$slots:{default:[bp]},$$scope:{ctx:j}}}),No=new W({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Information necessary to initiate the encoder. Can be either:</p>
<ul>
<li>A string, the <em>model id</em> of a pretrained model hosted inside a model repo on huggingface.co.
Valid model ids can be located at the root-level, like <code>bert-base-uncased</code>, or namespaced under a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L332"}}),Ve=new Xo({props:{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[vp]},$$scope:{ctx:j}}}),Io=new ee({}),Lo=new W({props:{name:"class transformers.FlaxEncoderDecoderModel",anchor:"transformers.FlaxEncoderDecoderModel",parameters:[{name:"config",val:": EncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17287/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
configs.`),qs=l(),ce=a("p"),js=n("Configuration objects inherit from "),pt=a("a"),zs=n("PretrainedConfig"),Fs=n(` and can be used to control the model outputs. Read the
...
:meth`),$n=a("em"),kd=n("~transformers.AutoModelForCausalLM.from_pretrained"),wd=n(" class method for the decoder."),Ed=l(),I=a("div"),y(Do.$$.fragment),Td=l(),he=a("p"),$d=n("The "),bt=a("a"),Md=n("EncoderDecoderModel"),Dd=n(" forward method, overrides the "),Mn=a("code"),xd=n("__call__"),qd=n(" special method."),jd=l(),y(Ie.$$.fragment),zd=l(),y(Le.$$.fragment),Fd=l(),L=a("div"),y(xo.$$.fragment),Pd=l(),Dn=a("p"),Ad=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),qn=a("code"),Ld=n("model.train()"),Bd=n("."),Od=l(),y(Be.$$.fragment),Tr=l(),ue=a("h2"),Oe=a("a"),jn=a("span"),y(qo.$$.fragment),Rd=l(),zn=a("span"),Wd=n("TFEncoderDecoderModel"),$r=l(),x=a("div"),y(jo.$$.fragment),Vd=l(),ge=a("p"),Gd=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
checkpoints.`),qi=l(),y(Ve.$$.fragment),Mr=l(),be=a("h2"),Ge=a("a"),Cn=a("span"),y(Io.$$.fragment),ji=l(),Sn=a("span"),zi=n("FlaxEncoderDecoderModel"),Dr=l(),q=a("div"),y(Lo.$$.fragment),Fi=l(),ve=a("p"),Pi=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
encoder and :meth`),Ln=a("em"),nc=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),rc=n(" class method for the decoder."),ac=l(),O=a("div"),y(Go.$$.fragment),sc=l(),ye=a("p"),dc=n("The "),jt=a("a"),ic=n("FlaxEncoderDecoderModel"),cc=n(" forward method, overrides the "),Bn=a("code"),lc=n("__call__"),pc=n(" special method."),mc=l(),y(He.$$.fragment),hc=l(),y(Ue.$$.fragment),fc=l(),Q=a("div"),y(Ho.$$.fragment),uc=l(),On=a("p"),gc=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
To do so, the `),tn=s(z,"CODE",{});var Lc=d(tn);La=r(Lc,"EncoderDecoderModel"),Lc.forEach(t),Ba=r(z," class provides a "),it=s(z,"A",{href:!0});var Bc=d(it);Oa=r(Bc,"EncoderDecoderModel.from_encoder_decoder_pretrained()"),Bc.forEach(t),Ra=r(z," function."),z.forEach(t),ir=p(o),k(ao.$$.fragment,o),cr=p(o),ae=s(o,"H2",{class:!0});var Pr=d(ae);xe=s(Pr,"A",{id:!0,class:!0,href:!0});var Oc=d(xe);nn=s(Oc,"SPAN",{});var Rc=d(nn);k(so.$$.fragment,Rc),Rc.forEach(t),Oc.forEach(t),Wa=p(Pr),rn=s(Pr,"SPAN",{});var Wc=d(rn);Va=r(Wc,"Loading an existing [EncoderDecoderModel](/docs/transformers/pr_17287/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) checkpoint."),Wc.forEach(t),Pr.forEach(t),lr=p(o),H=s(o,"P",{});var Ft=d(H);Ga=r(Ft,"To load fine-tuned checkpoints of the "),an=s(Ft,"CODE",{});var Vc=d(an);Ha=r(Vc,"EncoderDecoderModel"),Vc.forEach(t),Ua=r(Ft," class, [\u2018EncoderDecoderModel`] provides the "),sn=s(Ft,"CODE",{});var Gc=d(sn);Ya=r(Gc,"from_pretrained(...)"),Gc.forEach(t),Ja=r(Ft," method just like any other model architectures in Transformers."),Ft.forEach(t),pr=p(o),k(io.$$.fragment,o),mr=p(o),qe=s(o,"P",{});var Ar=d(qe);Za=r(Ar,"##Loading a PyTorch checkpoint into "),dn=s(Ar,"CODE",{});var Hc=d(dn);Ka=r(Hc,"TFEncoderDecoderModel"),Hc.forEach(t),Qa=r(Ar,"."),Ar.forEach(t),hr=p(o),se=s(o,"P",{});var Zn=d(se);cn=s(Zn,"CODE",{});var Uc=d(cn);Xa=r(Uc,"TFEncoderDecoderModel.from_pretrained()"),Uc.forEach(t),es=r(Zn,` currently doesn\u2019t support initializing the model from a
...
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),Kn.forEach(t),qs=p(R),ce=s(R,"P",{});var At=d(ce);js=r(At,"Configuration objects inherit from "),pt=s(At,"A",{href:!0});var ll=d(pt);zs=r(ll,"PretrainedConfig"),ll.forEach(t),Fs=r(At,` and can be used to control the model outputs. Read the
...
the model, you need to first set it back in training mode with `),qn=s(It,"CODE",{});var zl=d(qn);Ld=r(zl,"model.train()"),zl.forEach(t),Bd=r(It,"."),It.forEach(t),Od=p(Ze),k(Be.$$.fragment,Ze),Ze.forEach(t),F.forEach(t),Tr=p(o),ue=s(o,"H2",{class:!0});var Gr=d(ue);Oe=s(Gr,"A",{id:!0,class:!0,href:!0});var Fl=d(Oe);jn=s(Fl,"SPAN",{});var Pl=d(jn);k(qo.$$.fragment,Pl),Pl.forEach(t),Fl.forEach(t),Rd=p(Gr),zn=s(Gr,"SPAN",{});var Al=d(zn);Wd=r(Al,"TFEncoderDecoderModel"),Al.forEach(t),Gr.forEach(t),$r=p(o),x=s(o,"DIV",{class:!0});var P=d(x);k(jo.$$.fragment,P),Vd=p(P),ge=s(P,"P",{});var Lt=d(ge);Gd=r(Lt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Lt.forEach(t),Zd=p(P),zo=s(P,"P",{});var Hr=d(zo);Kd=r(Hr,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
checkpoints.`),Hl.forEach(t),qi=p(Ot),k(Ve.$$.fragment,Ot),Ot.forEach(t),P.forEach(t),Mr=p(o),be=s(o,"H2",{class:!0});var Jr=d(be);Ge=s(Jr,"A",{id:!0,class:!0,href:!0});var Ul=d(Ge);Cn=s(Ul,"SPAN",{});var Yl=d(Cn);k(Io.$$.fragment,Yl),Yl.forEach(t),Ul.forEach(t),ji=p(Jr),Sn=s(Jr,"SPAN",{});var Jl=d(Sn);zi=r(Jl,"FlaxEncoderDecoderModel"),Jl.forEach(t),Jr.forEach(t),Dr=p(o),q=s(o,"DIV",{class:!0});var A=d(q);k(Lo.$$.fragment,A),Fi=p(A),ve=s(A,"P",{});var Rt=d(ve);Pi=r(Rt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
