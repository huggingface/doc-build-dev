...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,v),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function hl(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import EncoderDecoderModel, BertTokenizer
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids)`}}),{c(){h=a("p"),v=n("Examples:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Examples:"),g.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),k(f,i,g),b=!0},p:Yo,i(i){b||(T(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function fl(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import EncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2bert&quot;</span>)`}}),{c(){h=a("p"),v=n("Example:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Example:"),g.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),k(f,i,g),b=!0},p:Yo,i(i){b||(T(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function ul(j){let h,v,_,f,b;return{c(){h=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(g,"CODE",{});var C=d(_);f=r(C,"Module"),C.forEach(t),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,v),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function gl(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import TFEncoderDecoderModel, BertTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># generation</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids, decoder_start_token_id=model.config.decoder.bos_token_id)`}}),{c(){h=a("p"),v=n("Examples:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Examples:"),g.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),k(f,i,g),b=!0},p:Yo,i(i){b||(T(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function _l(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import TFEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){h=a("p"),v=n("Example:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Example:"),g.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),k(f,i,g),b=!0},p:Yo,i(i){b||(T(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function bl(j){let h,v,_,f,b;return{c(){h=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(g,"CODE",{});var C=d(_);f=r(C,"Module"),C.forEach(t),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,v),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function vl(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> summary == <span class="hljs-string">&quot;SAS Alpha Epsilon suspended Sigma Alpha Epsilon members&quot;</span>`}}),{c(){h=a("p"),v=n("Examples:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Examples:"),g.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),k(f,i,g),b=!0},p:Yo,i(i){b||(T(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function yl(j){let h,v,_,f,b;return f=new V({props:{code:`from transformers import FlaxEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){h=a("p"),v=n("Example:"),_=l(),y(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);v=r(g,"Example:"),g.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,v),u(i,_,g),k(f,i,g),b=!0},p:Yo,i(i){b||(T(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),$(f,i)}}}function wl(j){let h,v,_,f,b,i,g,C,Cr,Cn,X,_e,Nt,Ue,Ar,Lt,Sr,An,be,Ir,Jo,Nr,Lr,Sn,ve,Br,Ye,Or,Vr,In,ye,Wr,Zo,Rr,Gr,Nn,W,Hr,Ko,Ur,Yr,Je,Jr,Zr,Ln,ee,we,Bt,Ze,Kr,Ot,Qr,Bn,Qo,Xr,On,Ke,Vn,oe,ke,Vt,Qe,ea,Wt,oa,Wn,Xo,ta,Rn,Xe,Gn,te,Te,Rt,eo,na,Gt,ra,Hn,et,aa,Un,oo,Yn,ot,sa,Jn,R,da,Ht,ia,ca,Ut,la,pa,Zn,to,Kn,ne,Ee,Yt,no,ma,Jt,ha,Qn,A,fa,Zt,ua,ga,Kt,_a,ba,Qt,va,ya,Xt,wa,ka,Xn,ro,er,$e,Ta,ao,Ea,$a,or,G,Ma,so,Da,xa,io,ja,qa,tr,re,Me,en,co,za,on,Pa,nr,F,lo,Fa,De,tt,Ca,Aa,nt,Sa,Ia,Na,ae,La,rt,Ba,Oa,at,Va,Wa,Ra,xe,Ga,je,po,Ha,mo,Ua,st,Ya,Ja,Za,qe,ho,Ka,se,Qa,tn,Xa,es,nn,os,ts,rr,de,ze,rn,fo,ns,an,rs,ar,M,uo,as,ie,ss,dt,ds,is,it,cs,ls,ps,go,ms,_o,hs,fs,us,sn,gs,_s,bo,bs,ct,vs,ys,ws,vo,ks,yo,Ts,Es,$s,H,lt,Ms,Ds,dn,xs,js,cn,qs,zs,Ps,S,wo,Fs,ce,Cs,pt,As,Ss,ln,Is,Ns,Ls,Pe,Bs,Fe,Os,I,ko,Vs,pn,Ws,Rs,le,Gs,mn,Hs,Us,hn,Ys,Js,Zs,Ce,sr,pe,Ae,fn,To,Ks,un,Qs,dr,D,Eo,Xs,me,ed,mt,od,td,ht,nd,rd,ad,$o,sd,Mo,dd,id,cd,gn,ld,pd,Do,md,ft,hd,fd,ud,xo,gd,jo,_d,bd,vd,U,ut,yd,wd,gt,kd,Td,_t,Ed,$d,Md,N,qo,Dd,he,xd,bt,jd,qd,_n,zd,Pd,Fd,Se,Cd,Ie,Ad,Y,zo,Sd,bn,Id,Nd,Ne,ir,fe,Le,vn,Po,Ld,yn,Bd,cr,x,Fo,Od,ue,Vd,vt,Wd,Rd,yt,Gd,Hd,Ud,Co,Yd,Ao,Jd,Zd,Kd,wn,Qd,Xd,So,ei,wt,oi,ti,ni,Io,ri,No,ai,si,di,J,kt,ii,ci,kn,li,pi,Tn,mi,hi,fi,L,Lo,ui,ge,gi,Tt,_i,bi,En,vi,yi,wi,Be,ki,Oe,Ti,Z,Bo,Ei,$n,$i,Mi,Ve,lr;return i=new Q({}),Ue=new Q({}),Ze=new Q({}),Ke=new V({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>config = EncoderDecoderConfig.from_encoder_decoder_configs(config_encoder, config_decoder)
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel(config=config)`}}),Qe=new Q({}),Xe=new V({props:{code:`from transformers import EncoderDecoderModel, BertTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer = BertTokenizer.from_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_encoder_decoder_pretrained(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, <span class="hljs-string">&quot;bert-base-uncased&quot;</span>)`}}),eo=new Q({}),oo=new V({props:{code:`from transformers import EncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),no=new Q({}),ro=new V({props:{code:`from transformers import EncoderDecoderModel, BertTokenizer
...
<span class="hljs-number">0.72</span>`}}),co=new Q({}),lo=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),xe=new Uo({props:{anchor:"transformers.EncoderDecoderConfig.example",$$slots:{default:[pl]},$$scope:{ctx:j}}}),po=new O({props:{name:"from_encoder_decoder_configs",anchor:"transformers.EncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L91",returnDescription:`
...
`}}),Pe=new Di({props:{$$slots:{default:[ml]},$$scope:{ctx:j}}}),Fe=new Uo({props:{anchor:"transformers.EncoderDecoderModel.forward.example",$$slots:{default:[hl]},$$scope:{ctx:j}}}),ko=new O({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
`}}),Se=new Di({props:{$$slots:{default:[ul]},$$scope:{ctx:j}}}),Ie=new Uo({props:{anchor:"transformers.TFEncoderDecoderModel.call.example",$$slots:{default:[gl]},$$scope:{ctx:j}}}),zo=new O({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
Information necessary to initiate the encoder. Can be either:</p>
<ul>
<li>A string, the <em>model id</em> of a pretrained model hosted inside a model repo on huggingface.co.
Valid model ids can be located at the root-level, like <code>bert-base-uncased</code>, or namespaced under a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L332"}}),Ne=new Uo({props:{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[_l]},$$scope:{ctx:j}}}),Po=new Q({}),Fo=new O({props:{name:"class transformers.FlaxEncoderDecoderModel",anchor:"transformers.FlaxEncoderDecoderModel",parameters:[{name:"config",val:": EncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17287/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17287/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L760"}}),Ve=new Uo({props:{anchor:"transformers.FlaxEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[yl]},$$scope:{ctx:j}}}),{c(){h=a("meta"),v=l(),_=a("h1"),f=a("a"),b=a("span"),y(i.$$.fragment),g=l(),C=a("span"),Cr=n("Encoder Decoder Models"),Cn=l(),X=a("h2"),_e=a("a"),Nt=a("span"),y(Ue.$$.fragment),Ar=l(),Lt=a("span"),Sr=n("Overview"),An=l(),be=a("p"),Ir=n("The "),Jo=a("a"),Nr=n("EncoderDecoderModel"),Lr=n(` can be used to initialize a sequence-to-sequence model with any
...
documentation from `),at=a("a"),Va=n("PretrainedConfig"),Wa=n(" for more information."),Ra=l(),y(xe.$$.fragment),Ga=l(),je=a("div"),y(po.$$.fragment),Ha=l(),mo=a("p"),Ua=n("Instantiate a "),st=a("a"),Ya=n("EncoderDecoderConfig"),Ja=n(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),Za=l(),qe=a("div"),y(ho.$$.fragment),Ka=l(),se=a("p"),Qa=n("Serializes this instance to a Python dictionary. Override the default "),tn=a("em"),Xa=n("to_dict()"),es=n(" from "),nn=a("em"),os=n("PretrainedConfig"),ts=n("."),rr=l(),de=a("h2"),ze=a("a"),rn=a("span"),y(fo.$$.fragment),ns=l(),an=a("span"),rs=n("EncoderDecoderModel"),ar=l(),M=a("div"),y(uo.$$.fragment),as=l(),ie=a("p"),ss=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ud=l(),xo=a("p"),gd=n("This model is also a "),jo=a("a"),_d=n("tf.keras.Model"),bd=n(` subclass. Use it
...
method for the decoder.`),Md=l(),N=a("div"),y(qo.$$.fragment),Dd=l(),he=a("p"),xd=n("The "),bt=a("a"),jd=n("TFEncoderDecoderModel"),qd=n(" forward method, overrides the "),_n=a("code"),zd=n("__call__"),Pd=n(" special method."),Fd=l(),y(Se.$$.fragment),Cd=l(),y(Ie.$$.fragment),Ad=l(),Y=a("div"),y(zo.$$.fragment),Sd=l(),bn=a("p"),Id=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
Sascha Rothe, Shashi Narayan, Aliaksei Severyn.`),pr.forEach(t),In=p(o),ye=s(o,"P",{});var mr=d(ye);Wr=r(mr,"After such an "),Zo=s(mr,"A",{href:!0});var ji=d(Zo);Rr=r(ji,"EncoderDecoderModel"),ji.forEach(t),Gr=r(mr,` has been trained/fine-tuned, it can be saved/loaded just like
any other models (see the examples for more information).`),mr.forEach(t),Nn=p(o),W=s(o,"P",{});var Et=d(W);Hr=r(Et,"An application of this architecture could be to leverage two pretrained "),Ko=s(Et,"A",{href:!0});var qi=d(Ko);Ur=r(qi,"BertModel"),qi.forEach(t),Yr=r(Et,` as the encoder
...
documentation from `),at=s(Dt,"A",{href:!0});var cc=d(at);Va=r(cc,"PretrainedConfig"),cc.forEach(t),Wa=r(Dt," for more information."),Dt.forEach(t),Ra=p(B),w(xe.$$.fragment,B),Ga=p(B),je=s(B,"DIV",{class:!0});var vr=d(je);w(po.$$.fragment,vr),Ha=p(vr),mo=s(vr,"P",{});var yr=d(mo);Ua=r(yr,"Instantiate a "),st=s(yr,"A",{href:!0});var lc=d(st);Ya=r(lc,"EncoderDecoderConfig"),lc.forEach(t),Ja=r(yr,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),yr.forEach(t),vr.forEach(t),Za=p(B),qe=s(B,"DIV",{class:!0});var wr=d(qe);w(ho.$$.fragment,wr),Ka=p(wr),se=s(wr,"P",{});var xt=d(se);Qa=r(xt,"Serializes this instance to a Python dictionary. Override the default "),tn=s(xt,"EM",{});var pc=d(tn);Xa=r(pc,"to_dict()"),pc.forEach(t),es=r(xt," from "),nn=s(xt,"EM",{});var mc=d(nn);os=r(mc,"PretrainedConfig"),mc.forEach(t),ts=r(xt,"."),xt.forEach(t),wr.forEach(t),B.forEach(t),rr=p(o),de=s(o,"H2",{class:!0});var kr=d(de);ze=s(kr,"A",{id:!0,class:!0,href:!0});var hc=d(ze);rn=s(hc,"SPAN",{});var fc=d(rn);w(fo.$$.fragment,fc),fc.forEach(t),hc.forEach(t),ns=p(kr),an=s(kr,"SPAN",{});var uc=d(an);rs=r(uc,"EncoderDecoderModel"),uc.forEach(t),kr.forEach(t),ar=p(o),M=s(o,"DIV",{class:!0});var q=d(M);w(uo.$$.fragment,q),as=p(q),ie=s(q,"P",{});var jt=d(ie);ss=r(jt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),dt=s(jt,"A",{href:!0});var gc=d(dt);ds=r(gc,"from_pretrained()"),gc.forEach(t),is=r(jt," function and the decoder is loaded via "),it=s(jt,"A",{href:!0});var _c=d(it);cs=r(_c,"from_pretrained()"),_c.forEach(t),ls=r(jt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),jt.forEach(t),ps=p(q),go=s(q,"P",{});var Tr=d(go);ms=r(Tr,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Tr.forEach(t),us=p(q),sn=s(q,"P",{});var vc=d(sn);gs=r(vc,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),vc.forEach(t),_s=p(q),bo=s(q,"P",{});var Er=d(bo);bs=r(Er,"This model inherits from "),ct=s(Er,"A",{href:!0});var yc=d(ct);vs=r(yc,"PreTrainedModel"),yc.forEach(t),ys=r(Er,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Er.forEach(t),ws=p(q),vo=s(q,"P",{});var $r=d(vo);ks=r($r,"This model is also a PyTorch "),yo=s($r,"A",{href:!0,rel:!0});var wc=d(yo);Ts=r(wc,"torch.nn.Module"),wc.forEach(t),Es=r($r,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$r.forEach(t),$s=p(q),H=s(q,"P",{});var Ro=d(H);lt=s(Ro,"A",{href:!0});var kc=d(lt);Ms=r(kc,"EncoderDecoderModel"),kc.forEach(t),Ds=r(Ro,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
:meth`),dn=s(Ro,"EM",{});var Tc=d(dn);xs=r(Tc,"~transformers.AutoModel.from_pretrained"),Tc.forEach(t),js=r(Ro,` class method for the encoder and
:meth`),cn=s(Ro,"EM",{});var Ec=d(cn);qs=r(Ec,"~transformers.AutoModelForCausalLM.from_pretrained"),Ec.forEach(t),zs=r(Ro," class method for the decoder."),Ro.forEach(t),Ps=p(q),S=s(q,"DIV",{class:!0});var We=d(S);w(wo.$$.fragment,We),Fs=p(We),ce=s(We,"P",{});var qt=d(ce);Cs=r(qt,"The "),pt=s(qt,"A",{href:!0});var $c=d(pt);As=r($c,"EncoderDecoderModel"),$c.forEach(t),Ss=r(qt," forward method, overrides the "),ln=s(qt,"CODE",{});var Mc=d(ln);Is=r(Mc,"__call__"),Mc.forEach(t),Ns=r(qt," special method."),qt.forEach(t),Ls=p(We),w(Pe.$$.fragment,We),Bs=p(We),w(Fe.$$.fragment,We),We.forEach(t),Os=p(q),I=s(q,"DIV",{class:!0});var Re=d(I);w(ko.$$.fragment,Re),Vs=p(Re),pn=s(Re,"P",{});var Dc=d(pn);Ws=r(Dc,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),hn=s(zt,"CODE",{});var jc=d(hn);Ys=r(jc,"model.train()"),jc.forEach(t),Js=r(zt,"."),zt.forEach(t),Zs=p(Re),w(Ce.$$.fragment,Re),Re.forEach(t),q.forEach(t),sr=p(o),pe=s(o,"H2",{class:!0});var Mr=d(pe);Ae=s(Mr,"A",{id:!0,class:!0,href:!0});var qc=d(Ae);fn=s(qc,"SPAN",{});var zc=d(fn);w(To.$$.fragment,zc),zc.forEach(t),qc.forEach(t),Ks=p(Mr),un=s(Mr,"SPAN",{});var Pc=d(un);Qs=r(Pc,"TFEncoderDecoderModel"),Pc.forEach(t),Mr.forEach(t),dr=p(o),D=s(o,"DIV",{class:!0});var z=d(D);w(Eo.$$.fragment,z),Xs=p(z),me=s(z,"P",{});var Pt=d(me);ed=r(Pt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xr.forEach(t),ud=p(z),xo=s(z,"P",{});var jr=d(xo);gd=r(jr,"This model is also a "),jo=s(jr,"A",{href:!0,rel:!0});var Nc=d(jo);_d=r(Nc,"tf.keras.Model"),Nc.forEach(t),bd=r(jr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jr.forEach(t),vd=p(z),U=s(z,"P",{});var Go=d(U);ut=s(Go,"A",{href:!0});var Lc=d(ut);yd=r(Lc,"TFEncoderDecoderModel"),Lc.forEach(t),wd=r(Go,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
method for the decoder.`),Go.forEach(t),Md=p(z),N=s(z,"DIV",{class:!0});var Ge=d(N);w(qo.$$.fragment,Ge),Dd=p(Ge),he=s(Ge,"P",{});var Ft=d(he);xd=r(Ft,"The "),bt=s(Ft,"A",{href:!0});var Vc=d(bt);jd=r(Vc,"TFEncoderDecoderModel"),Vc.forEach(t),qd=r(Ft," forward method, overrides the "),_n=s(Ft,"CODE",{});var Wc=d(_n);zd=r(Wc,"__call__"),Wc.forEach(t),Pd=r(Ft," special method."),Ft.forEach(t),Fd=p(Ge),w(Se.$$.fragment,Ge),Cd=p(Ge),w(Ie.$$.fragment,Ge),Ge.forEach(t),Ad=p(z),Y=s(z,"DIV",{class:!0});var Ct=d(Y);w(zo.$$.fragment,Ct),Sd=p(Ct),bn=s(Ct,"P",{});var Rc=d(bn);Id=r(Rc,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Rc.forEach(t),Nd=p(Ct),w(Ne.$$.fragment,Ct),Ct.forEach(t),z.forEach(t),ir=p(o),fe=s(o,"H2",{class:!0});var qr=d(fe);Le=s(qr,"A",{id:!0,class:!0,href:!0});var Gc=d(Le);vn=s(Gc,"SPAN",{});var Hc=d(vn);w(Po.$$.fragment,Hc),Hc.forEach(t),Gc.forEach(t),Ld=p(qr),yn=s(qr,"SPAN",{});var Uc=d(yn);Bd=r(Uc,"FlaxEncoderDecoderModel"),Uc.forEach(t),qr.forEach(t),cr=p(o),x=s(o,"DIV",{class:!0});var P=d(x);w(Fo.$$.fragment,P),Od=p(P),ue=s(P,"P",{});var At=d(ue);Vd=r(At,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
