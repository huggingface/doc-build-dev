import{S as mf,i as uf,s as gf,e as a,k as d,w,t as n,L as _f,c as s,d as t,m as c,a as r,x as b,h as i,b as l,J as e,g as m,y,q as $,o as x,B as F}from"../../chunks/vendor-9e2b328e.js";import{T as _e}from"../../chunks/Tip-76f97a76.js";import{D as W}from"../../chunks/Docstring-50fd6873.js";import{C as Ft}from"../../chunks/CodeBlock-88e23343.js";import{I as ve}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function vf(I){let h,v,f,g,T;return{c(){h=a("p"),v=n(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=r(f);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=r(f);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,v),e(h,f),e(f,g),e(h,T)},d(_){_&&t(h)}}}function $f(I){let h,v,f,g,T,_,u,V,he,R,k,ie,j,B,oe,C,pe,ae;return{c(){h=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),f=d(),g=a("ul"),T=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),V=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=n("This second option is useful when using "),j=a("code"),B=n("tf.keras.Model.fit"),oe=n(` method which currently requires having all the
...
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=r(C);pe=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,M){m(E,h,M),e(h,v),m(E,f,M),m(E,g,M),e(g,T),e(T,_),e(g,u),e(g,V),e(V,he),m(E,R,M),m(E,k,M),e(k,ie),e(k,j),e(j,B),e(k,oe),e(k,C),e(C,pe),e(k,ae)},d(E){E&&t(h),E&&t(f),E&&t(g),E&&t(R),E&&t(k)}}}function xf(I){let h,v,f,g,T;return{c(){h=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=r(f);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,v),e(h,f),e(f,g),e(h,T)},d(_){_&&t(h)}}}function Ff(I){let h,v,f,g,T,_,u,V,he,R,k,ie,j,B,oe,C,pe,ae;return{c(){h=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),f=d(),g=a("ul"),T=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),u=d(),V=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),R=d(),k=a("p"),ie=n("This second option is useful when using "),j=a("code"),B=n("tf.keras.Model.fit"),oe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),C=a("code"),pe=n("model(inputs)"),ae=n(".")},l(E){h=s(E,"P",{});var M=r(h);v=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),f=c(E),g=s(E,"UL",{});var z=r(g);T=s(z,"LI",{});var Me=r(T);_=i(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),u=c(z),V=s(z,"LI",{});var se=r(V);he=i(se,"having all inputs as a list, tuple or dict in the first positional arguments."),se.forEach(t),z.forEach(t),R=c(E),k=s(E,"P",{});var L=r(k);ie=i(L,"This second option is useful when using "),j=s(L,"CODE",{});var je=r(j);B=i(je,"tf.keras.Model.fit"),je.forEach(t),oe=i(L,` method which currently requires having all the
tensors in the first argument of the model call function: `),C=s(L,"CODE",{});var Te=r(C);pe=i(Te,"model(inputs)"),Te.forEach(t),ae=i(L,"."),L.forEach(t)},m(E,M){m(E,h,M),e(h,v),m(E,f,M),m(E,g,M),e(g,T),e(T,_),e(g,u),e(g,V),e(V,he),m(E,R,M),m(E,k,M),e(k,ie),e(k,j),e(j,B),e(k,oe),e(k,C),e(C,pe),e(k,ae)},d(E){E&&t(h),E&&t(f),E&&t(g),E&&t(R),E&&t(k)}}}function Vf(I){let h,v,f,g,T;return{c(){h=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=r(f);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=r(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=r(f);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,v),e(h,f),e(f,g),e(h,T)},d(_){_&&t(h)}}}function If(I){let h,v,f,g,T,_,u,V,he,R,k,ie,j,B,oe,C,pe,ae,E,M,z,Me,se,L,je,Te,Xo,en,sr,Zo,Da,tn,rr,Qo,on,nr,N,Vt,an,Et,sn,rn,nn,Oa,ln,dn,kt,cn,Yo,hn,pn,fn,Pe,mn,Sa,un,gn,It,_n,vn,Tn,Ce,wn,Mt,bn,yn,jt,$n,xn,Fn,qe,Vn,Pt,En,kn,Ct,In,Mn,jn,Wa,Pn,ir,ea,Cn,lr,le,Ba,P,ta,qn,An,oa,zn,Nn,aa,Ln,Dn,Ua,On,Sn,Ra,Wn,Bn,Ha,Un,Rn,Ja,Hn,Jn,sa,Kn,Gn,Xn,Ka,ra,na,Zn,Qn,Yn,Ga,qt,ei,At,ti,oi,ai,Xa,ia,la,si,ri,dr,we,ni,zt,ii,li,Nt,di,ci,cr,et,hi,Lt,pi,fi,hr,Ae,tt,Za,Dt,mi,Qa,ui,pr,U,Ot,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Fi,ha,Vi,Ei,ki,Ya,Ii,Mi,Wt,fr,Le,ot,es,Bt,ji,ts,Pi,mr,re,Ut,Ci,os,qi,Ai,Rt,zi,pa,Ni,Li,Di,be,Ht,Oi,as,Si,Wi,at,ur,De,st,ss,Jt,Bi,rs,Ui,gr,fe,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,fa,Qi,Yi,ns,el,tl,ol,rt,al,is,sl,rl,Qt,_r,Se,nt,ls,Yt,nl,ds,il,vr,me,eo,ll,We,dl,cs,cl,hl,to,pl,fl,ml,J,oo,ul,Be,gl,ma,_l,vl,hs,Tl,wl,bl,it,yl,ps,$l,xl,ao,Tr,Ue,lt,fs,so,Fl,ms,Vl,wr,ne,ro,El,us,kl,Il,no,Ml,io,jl,Pl,Cl,K,lo,ql,Re,Al,ua,zl,Nl,gs,Ll,Dl,Ol,dt,Sl,_s,Wl,Bl,co,br,He,ct,vs,ho,Ul,Ts,Rl,yr,D,po,Hl,ws,Jl,Kl,fo,Gl,ga,Xl,Zl,Ql,mo,Yl,uo,ed,td,od,ht,ad,G,go,sd,Je,rd,_a,nd,id,bs,ld,dd,cd,pt,hd,ys,pd,fd,_o,$r,Ke,ft,$s,vo,md,xs,ud,xr,O,To,gd,Fs,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Fd,Vd,mt,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,Vs,Pd,Cd,qd,ut,Ad,Es,zd,Nd,xo,Fr,Xe,gt,ks,Fo,Ld,Is,Dd,Vr,q,Vo,Od,Ms,Sd,Wd,Eo,Bd,wa,Ud,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,js,Zd,Qd,ue,Ps,Mo,Yd,ec,Cs,jo,tc,oc,qs,Po,ac,sc,As,Co,rc,nc,Z,qo,ic,Ze,lc,zs,dc,cc,Ns,hc,pc,fc,_t,mc,Ls,uc,gc,Ao,Er,Qe,vt,Ds,zo,_c,Os,vc,kr,A,No,Tc,Ss,wc,bc,Lo,yc,ba,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Ic,Ws,Mc,jc,ge,Bs,So,Pc,Cc,Us,Wo,qc,Ac,Rs,Bo,zc,Nc,Hs,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Js,Wc,Bc,Ks,Uc,Rc,Hc,Tt,Jc,Gs,Kc,Gc,Ho,Ir;return _=new ve({}),k=new _e({props:{$$slots:{default:[vf]},$$scope:{ctx:I}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15727/src/transformers/models/vit/configuration_vit.py#L29",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_15727/en/main_classes/feature_extractor#transformers.BatchFeature"
...
Whether or not to return a <a href="/docs/transformers/pr_15727/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15727/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15727/en/model_doc/vit#transformers.ViTConfig"
...
`}}),rt=new _e({props:{$$slots:{default:[wf]},$$scope:{ctx:I}}}),Qt=new Ft({props:{code:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">197</span>, <span class="hljs-number">768</span>]`}}),Yt=new ve({}),eo=new W({props:{name:"class transformers.ViTForMaskedImageModeling",anchor:"transformers.ViTForMaskedImageModeling",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15727/src/transformers/models/vit/modeling_vit.py#L592",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15727/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15727/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oo=new W({props:{name:"forward",anchor:"transformers.ViTForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"interpolate_pos_encoding",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15727/src/transformers/models/vit/modeling_vit.py#L606",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_15727/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),so=new ve({}),ro=new W({props:{name:"class transformers.ViTForImageClassification",anchor:"transformers.ViTForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15727/src/transformers/models/vit/modeling_vit.py#L696",parametersDescription:[{anchor:"transformers.ViTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15727/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15727/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new W({props:{name:"forward",anchor:"transformers.ViTForImageClassification.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"interpolate_pos_encoding",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15727/src/transformers/models/vit/modeling_vit.py#L709",parametersDescription:[{anchor:"transformers.ViTForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_15727/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_15727/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_15727/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15727/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_15727/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){h=a("meta"),v=d(),f=a("h1"),g=a("a"),T=a("span"),w(_.$$.fragment),u=d(),V=a("span"),he=n("Vision Transformer (ViT)"),R=d(),w(k.$$.fragment),ie=d(),j=a("h2"),B=a("a"),oe=a("span"),w(C.$$.fragment),pe=d(),ae=a("span"),E=n("Overview"),M=d(),z=a("p"),Me=n("The Vision Transformer (ViT) model was proposed in "),se=a("a"),L=n(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
go to him!`),hr=d(),Ae=a("h2"),tt=a("a"),Za=a("span"),w(Dt.$$.fragment),mi=d(),Qa=a("span"),ui=n("ViTConfig"),pr=d(),U=a("div"),w(Ot.$$.fragment),gi=d(),ze=a("p"),_i=n("This is the configuration class to store the configuration of a "),da=a("a"),vi=n("ViTModel"),Ti=n(`. It is used to instantiate an ViT
...
documentation from `),ha=a("a"),Vi=n("PretrainedConfig"),Ei=n(" for more information."),ki=d(),Ya=a("p"),Ii=n("Example:"),Mi=d(),w(Wt.$$.fragment),fr=d(),Le=a("h2"),ot=a("a"),es=a("span"),w(Bt.$$.fragment),ji=d(),ts=a("span"),Pi=n("ViTFeatureExtractor"),mr=d(),re=a("div"),w(Ut.$$.fragment),Ci=d(),os=a("p"),qi=n("Constructs a ViT feature extractor."),Ai=d(),Rt=a("p"),zi=n("This feature extractor inherits from "),pa=a("a"),Ni=n("FeatureExtractionMixin"),Li=n(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Di=d(),be=a("div"),w(Ht.$$.fragment),Oi=d(),as=a("p"),Si=n("Main method to prepare for the model one or several image(s)."),Wi=d(),w(at.$$.fragment),ur=d(),De=a("h2"),st=a("a"),ss=a("span"),w(Jt.$$.fragment),Bi=d(),rs=a("span"),Ui=n("ViTModel"),gr=d(),fe=a("div"),w(Kt.$$.fragment),Ri=d(),Gt=a("p"),Hi=n(`The bare ViT Model transformer outputting raw hidden-states without any specific head on top.
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ml=d(),J=a("div"),w(oo.$$.fragment),ul=d(),Be=a("p"),gl=n("The "),ma=a("a"),_l=n("ViTForMaskedImageModeling"),vl=n(" forward method, overrides the "),hs=a("code"),Tl=n("__call__"),wl=n(" special method."),bl=d(),w(it.$$.fragment),yl=d(),ps=a("p"),$l=n("Examples:"),xl=d(),w(ao.$$.fragment),Tr=d(),Ue=a("h2"),lt=a("a"),fs=a("span"),w(so.$$.fragment),Fl=d(),ms=a("span"),Vl=n("ViTForImageClassification"),wr=d(),ne=a("div"),w(ro.$$.fragment),El=d(),us=a("p"),kl=n(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Il=d(),no=a("p"),Ml=n("This model is a PyTorch "),io=a("a"),jl=n("torch.nn.Module"),Pl=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cl=d(),K=a("div"),w(lo.$$.fragment),ql=d(),Re=a("p"),Al=n("The "),ua=a("a"),zl=n("ViTForImageClassification"),Nl=n(" forward method, overrides the "),gs=a("code"),Ll=n("__call__"),Dl=n(" special method."),Ol=d(),w(dt.$$.fragment),Sl=d(),_s=a("p"),Wl=n("Example:"),Bl=d(),w(co.$$.fragment),br=d(),He=a("h2"),ct=a("a"),vs=a("span"),w(ho.$$.fragment),Ul=d(),Ts=a("span"),Rl=n("TFViTModel"),yr=d(),D=a("div"),w(po.$$.fragment),Hl=d(),ws=a("p"),Jl=n("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Kl=d(),fo=a("p"),Gl=n("This model inherits from "),ga=a("a"),Xl=n("TFPreTrainedModel"),Zl=n(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),w(mt.$$.fragment),Ed=d(),X=a("div"),w($o.$$.fragment),kd=d(),Ge=a("p"),Id=n("The "),Ta=a("a"),Md=n("TFViTForImageClassification"),jd=n(" forward method, overrides the "),Vs=a("code"),Pd=n("__call__"),Cd=n(" special method."),qd=d(),w(ut.$$.fragment),Ad=d(),Es=a("p"),zd=n("Examples:"),Nd=d(),w(xo.$$.fragment),Fr=d(),Xe=a("h2"),gt=a("a"),ks=a("span"),w(Fo.$$.fragment),Ld=d(),Is=a("span"),Dd=n("FlaxVitModel"),Vr=d(),q=a("div"),w(Vo.$$.fragment),Od=d(),Ms=a("p"),Sd=n("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Bd=n("This model inherits from "),wa=a("a"),Ud=n("FlaxPreTrainedModel"),Rd=n(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),js=a("p"),Zd=n("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Ps=a("li"),Mo=a("a"),Yd=n("Just-In-Time (JIT) compilation"),ec=d(),Cs=a("li"),jo=a("a"),tc=n("Automatic Differentiation"),oc=d(),qs=a("li"),Po=a("a"),ac=n("Vectorization"),sc=d(),As=a("li"),Co=a("a"),rc=n("Parallelization"),nc=d(),Z=a("div"),w(qo.$$.fragment),ic=d(),Ze=a("p"),lc=n("The "),zs=a("code"),dc=n("FlaxViTPreTrainedModel"),cc=n("forward method, overrides the "),Ns=a("code"),hc=n("__call__"),pc=n(" special method."),fc=d(),w(_t.$$.fragment),mc=d(),Ls=a("p"),uc=n("Examples:"),gc=d(),w(Ao.$$.fragment),Er=d(),Qe=a("h2"),vt=a("a"),Ds=a("span"),w(zo.$$.fragment),_c=d(),Os=a("span"),vc=n("FlaxViTForImageClassification"),kr=d(),A=a("div"),w(No.$$.fragment),Tc=d(),Ss=a("p"),wc=n(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
found `),Nt=s(Fa,"A",{href:!0,rel:!0});var kh=r(Nt);di=i(kh,"here"),kh.forEach(t),ci=i(Fa,"."),Fa.forEach(t),cr=c(o),et=s(o,"P",{});var Cr=r(et);hi=i(Cr,"Note that we converted the weights from Ross Wightman\u2019s "),Lt=s(Cr,"A",{href:!0,rel:!0});var Ih=r(Lt);pi=i(Ih,"timm library"),Ih.forEach(t),fi=i(Cr,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),Cr.forEach(t),hr=c(o),Ae=s(o,"H2",{class:!0});var qr=r(Ae);tt=s(qr,"A",{id:!0,class:!0,href:!0});var Mh=r(tt);Za=s(Mh,"SPAN",{});var jh=r(Za);b(Dt.$$.fragment,jh),jh.forEach(t),Mh.forEach(t),mi=c(qr),Qa=s(qr,"SPAN",{});var Ph=r(Qa);ui=i(Ph,"ViTConfig"),Ph.forEach(t),qr.forEach(t),pr=c(o),U=s(o,"DIV",{class:!0});var ye=r(U);b(Ot.$$.fragment,ye),gi=c(ye),ze=s(ye,"P",{});var Va=r(ze);_i=i(Va,"This is the configuration class to store the configuration of a "),da=s(Va,"A",{href:!0});var Ch=r(da);vi=i(Ch,"ViTModel"),Ch.forEach(t),Ti=i(Va,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pa.forEach(t),ml=c(ja),J=s(ja,"DIV",{class:!0});var xe=r(J);b(oo.$$.fragment,xe),ul=c(xe),Be=s(xe,"P",{});var Ca=r(Be);gl=i(Ca,"The "),ma=s(Ca,"A",{href:!0});var op=r(ma);_l=i(op,"ViTForMaskedImageModeling"),op.forEach(t),vl=i(Ca," forward method, overrides the "),hs=s(Ca,"CODE",{});var ap=r(hs);Tl=i(ap,"__call__"),ap.forEach(t),wl=i(Ca," special method."),Ca.forEach(t),bl=c(xe),b(it.$$.fragment,xe),yl=c(xe),ps=s(xe,"P",{});var sp=r(ps);$l=i(sp,"Examples:"),sp.forEach(t),xl=c(xe),b(ao.$$.fragment,xe),xe.forEach(t),ja.forEach(t),Tr=c(o),Ue=s(o,"H2",{class:!0});var Or=r(Ue);lt=s(Or,"A",{id:!0,class:!0,href:!0});var rp=r(lt);fs=s(rp,"SPAN",{});var np=r(fs);b(so.$$.fragment,np),np.forEach(t),rp.forEach(t),Fl=c(Or),ms=s(Or,"SPAN",{});var ip=r(ms);Vl=i(ip,"ViTForImageClassification"),ip.forEach(t),Or.forEach(t),wr=c(o),ne=s(o,"DIV",{class:!0});var yt=r(ne);b(ro.$$.fragment,yt),El=c(yt),us=s(yt,"P",{});var lp=r(us);kl=i(lp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Sr.forEach(t),Cl=c(yt),K=s(yt,"DIV",{class:!0});var Fe=r(K);b(lo.$$.fragment,Fe),ql=c(Fe),Re=s(Fe,"P",{});var qa=r(Re);Al=i(qa,"The "),ua=s(qa,"A",{href:!0});var cp=r(ua);zl=i(cp,"ViTForImageClassification"),cp.forEach(t),Nl=i(qa," forward method, overrides the "),gs=s(qa,"CODE",{});var hp=r(gs);Ll=i(hp,"__call__"),hp.forEach(t),Dl=i(qa," special method."),qa.forEach(t),Ol=c(Fe),b(dt.$$.fragment,Fe),Sl=c(Fe),_s=s(Fe,"P",{});var pp=r(_s);Wl=i(pp,"Example:"),pp.forEach(t),Bl=c(Fe),b(co.$$.fragment,Fe),Fe.forEach(t),yt.forEach(t),br=c(o),He=s(o,"H2",{class:!0});var Wr=r(He);ct=s(Wr,"A",{id:!0,class:!0,href:!0});var fp=r(ct);vs=s(fp,"SPAN",{});var mp=r(vs);b(ho.$$.fragment,mp),mp.forEach(t),fp.forEach(t),Ul=c(Wr),Ts=s(Wr,"SPAN",{});var up=r(Ts);Rl=i(up,"TFViTModel"),up.forEach(t),Wr.forEach(t),yr=c(o),D=s(o,"DIV",{class:!0});var de=r(D);b(po.$$.fragment,de),Hl=c(de),ws=s(de,"P",{});var gp=r(ws);Jl=i(gp,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),gp.forEach(t),Kl=c(de),fo=s(de,"P",{});var Br=r(fo);Gl=i(Br,"This model inherits from "),ga=s(Br,"A",{href:!0});var _p=r(ga);Xl=i(_p,"TFPreTrainedModel"),_p.forEach(t),Zl=i(Br,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Br.forEach(t),Ql=c(de),mo=s(de,"P",{});var Ur=r(mo);Yl=i(Ur,"This model is also a "),uo=s(Ur,"A",{href:!0,rel:!0});var vp=r(uo);ed=i(vp,"tf.keras.Model"),vp.forEach(t),td=i(Ur,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ur.forEach(t),od=c(de),b(ht.$$.fragment,de),ad=c(de),G=s(de,"DIV",{class:!0});var Ve=r(G);b(go.$$.fragment,Ve),sd=c(Ve),Je=s(Ve,"P",{});var Aa=r(Je);rd=i(Aa,"The "),_a=s(Aa,"A",{href:!0});var Tp=r(_a);nd=i(Tp,"TFViTModel"),Tp.forEach(t),id=i(Aa," forward method, overrides the "),bs=s(Aa,"CODE",{});var wp=r(bs);ld=i(wp,"__call__"),wp.forEach(t),dd=i(Aa," special method."),Aa.forEach(t),cd=c(Ve),b(pt.$$.fragment,Ve),hd=c(Ve),ys=s(Ve,"P",{});var bp=r(ys);pd=i(bp,"Examples:"),bp.forEach(t),fd=c(Ve),b(_o.$$.fragment,Ve),Ve.forEach(t),de.forEach(t),$r=c(o),Ke=s(o,"H2",{class:!0});var Rr=r(Ke);ft=s(Rr,"A",{id:!0,class:!0,href:!0});var yp=r(ft);$s=s(yp,"SPAN",{});var $p=r($s);b(vo.$$.fragment,$p),$p.forEach(t),yp.forEach(t),md=c(Rr),xs=s(Rr,"SPAN",{});var xp=r(xs);ud=i(xp,"TFViTForImageClassification"),xp.forEach(t),Rr.forEach(t),xr=c(o),O=s(o,"DIV",{class:!0});var ce=r(O);b(To.$$.fragment,ce),gd=c(ce),Fs=s(ce,"P",{});var Fp=r(Fs);_d=i(Fp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
