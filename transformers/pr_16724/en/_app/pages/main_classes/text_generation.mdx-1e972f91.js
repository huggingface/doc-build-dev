import{S as Cm,i as Im,s as Bm,e as s,k as l,w as m,t,M as Wm,c as a,d as o,m as d,a as r,x as g,h as n,b as c,F as e,g as M,y as _,q as u,o as h,B as f,v as Hm}from"../../chunks/vendor-6b77c823.js";import{T as Nm}from"../../chunks/Tip-39098574.js";import{D as _e}from"../../chunks/Docstring-af1d0ae0.js";import{C as be}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Bs}from"../../chunks/IconCopyLink-7a11ce68.js";function Rm(en){let p,C,L,q,D,w,ue,N,O,I,G;return{c(){p=s("p"),C=t("Apart from "),L=s("code"),q=t("inputs"),D=t(`, all the arguments below will default to the value of the attribute of the same name as
...
<p>A <a
  href="/docs/transformers/pr_16724/en/main_classes/output#transformers.utils.ModelOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
>SampleDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
>BeamSearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
>SampleEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
An instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
An derived instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
A derived instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An derived instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
documentation of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_16724/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
post`),Yl=t("."),ed=l(),Co=s("p"),td=t("Examples:"),nd=l(),m(Ht.$$.fragment),ks=l(),Oe=s("h2"),Ye=s("a"),Io=s("span"),m(Rt.$$.fragment),od=l(),Bo=s("span"),sd=t("FlaxGenerationMixin"),vs=l(),A=s("div"),m(Ut.$$.fragment),ad=l(),Vt=s("p"),rd=t(`A class containing all functions for auto-regressive text generation, to be used as a mixin in
...
post`),am.forEach(o),Yl=n(Ps,"."),Ps.forEach(o),ed=d(z),Co=a(z,"P",{});var rm=r(Co);td=n(rm,"Examples:"),rm.forEach(o),nd=d(z),g(Ht.$$.fragment,z),z.forEach(o),qn.forEach(o),ks=d(i),Oe=a(i,"H2",{class:!0});var Ds=r(Oe);Ye=a(Ds,"A",{id:!0,class:!0,href:!0});var im=r(Ye);Io=a(im,"SPAN",{});var lm=r(Io);g(Rt.$$.fragment,lm),lm.forEach(o),im.forEach(o),od=d(Ds),Bo=a(Ds,"SPAN",{});var dm=r(Bo);sd=n(dm,"FlaxGenerationMixin"),dm.forEach(o),Ds.forEach(o),vs=d(i),A=a(i,"DIV",{class:!0});var ve=r(A);g(Ut.$$.fragment,ve),ad=d(ve),Vt=a(ve,"P",{});var Ns=r(Vt);rd=n(Ns,`A class containing all functions for auto-regressive text generation, to be used as a mixin in
...
post`),Pm.forEach(o),kc=n(Is,"."),Is.forEach(o),vc=d(P),_s=a(P,"P",{});var Dm=r(_s);yc=n(Dm,"Examples:"),Dm.forEach(o),jc=d(P),g(Qt.$$.fragment,P),P.forEach(o),ve.forEach(o),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(Km)),c(q,"id","generation"),c(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(q,"href","#generation"),c(L,"class","relative group"),c(tn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(nn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin"),c(on,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin.generate"),c(sn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin"),c(an,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),c(rn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin"),c(Xe,"id","transformers.generation_utils.GenerationMixin"),c(Xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xe,"href","#transformers.generation_utils.GenerationMixin"),c(Te,"class","relative group"),c(ln,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.PreTrainedModel"),c(dn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(cn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),c(pn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),c(mn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),c(gn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),c(_n,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),c(un,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),c(hn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),c(fn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),c(bn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),c(xn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),c(kn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),c(vn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),c(_t,"href","https://huggingface.co/blog/how-to-generate"),c(_t,"rel","nofollow"),c(b,"class","docstring"),c(ee,"class","docstring"),c(te,"class","docstring"),c(ne,"class","docstring"),c(oe,"class","docstring"),c(se,"class","docstring"),c(ae,"class","docstring"),c(k,"class","docstring"),c(Qe,"id","transformers.generation_tf_utils.TFGenerationMixin"),c(Qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qe,"href","#transformers.generation_tf_utils.TFGenerationMixin"),c(Ee,"class","relative group"),c(yn,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.TFPreTrainedModel"),c(It,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),c(It,"rel","nofollow"),c(jn,"href","/docs/transformers/pr_16724/en/main_classes/configuration#transformers.PretrainedConfig"),c(Wt,"href","https://huggingface.co/blog/how-to-generate"),c(Wt,"rel","nofollow"),c(T,"class","docstring"),c(he,"class","docstring"),c(Ye,"id","transformers.generation_flax_utils.FlaxGenerationMixin"),c(Ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ye,"href","#transformers.generation_flax_utils.FlaxGenerationMixin"),c(Oe,"class","relative group"),c(Ln,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Mn,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),c(Jt,"href","https://huggingface.co/blog/how-to-generate"),c(Jt,"rel","nofollow"),c(E,"class","docstring"),c(A,"class","docstring")},m(i,v){e(document.head,p),M(i,C,v),M(i,L,v),e(L,q),e(q,D),_(w,D,null),e(L,ue),e(L,N),e(N,O),M(i,I,v),M(i,G,v),e(G,S),e(G,x),e(x,ye),e(G,je),M(i,xe,v),M(i,ke,v),e(ke,Le),e(Le,Ws),e(Le,tn),e(tn,Hs),e(Le,Rs),e(Le,nn),e(nn,Us),e(Le,Vs),e(ke,Ks),e(ke,Me),e(Me,Zs),e(Me,on),e(on,Xs),e(Me,Js),e(Me,sn),e(sn,Qs),e(Me,Ys),e(ke,ea),e(ke,we),e(we,ta),e(we,an),e(an,na),e(we,oa),e(we,rn),e(rn,sa),e(we,aa),M(i,hs,v),M(i,Te,v),e(Te,Xe),e(Xe,$n),_(lt,$n,null),e(Te,ra),e(Te,Fn),e(Fn,ia),M(i,fs,v),M(i,k,v),_(dt,k,null),e(k,la),e(k,ct),e(ct,da),e(ct,ln),e(ln,ca),e(ct,pa),e(k,ma),e(k,pt),e(pt,ga),e(pt,dn),e(dn,_a),e(pt,ua),e(k,ha),e(k,$),e($,B),e(B,An),e(An,fa),e(B,ba),e(B,cn),e(cn,xa),e(B,ka),e(B,zn),e(zn,va),e(B,ya),e(B,Pn),e(Pn,ja),e(B,La),e($,Ma),e($,W),e(W,Dn),e(Dn,wa),e(W,Ta),e(W,pn),e(pn,Ea),e(W,Oa),e(W,Nn),e(Nn,qa),e(W,Ga),e(W,Cn),e(Cn,Sa),e(W,$a),e($,Fa),e($,H),e(H,In),e(In,Aa),e(H,za),e(H,mn),e(mn,Pa),e(H,Da),e(H,Bn),e(Bn,Na),e(H,Ca),e(H,Wn),e(Wn,Ia),e(H,Ba),e($,Wa),e($,R),e(R,Hn),e(Hn,Ha),e(R,Ra),e(R,gn),e(gn,Ua),e(R,Va),e(R,Rn),e(Rn,Ka),e(R,Za),e(R,Un),e(Un,Xa),e(R,Ja),e($,Qa),e($,U),e(U,Vn),e(Vn,Ya),e(U,er),e(U,_n),e(_n,tr),e(U,nr),e(U,Kn),e(Kn,or),e(U,sr),e(U,Zn),e(Zn,ar),e(U,rr),e($,ir),e($,V),e(V,Xn),e(Xn,lr),e(V,dr),e(V,un),e(un,cr),e(V,pr),e(V,Jn),e(Jn,mr),e(V,gr),e(V,Qn),e(Qn,_r),e(V,ur),e(k,hr),e(k,b),_(mt,b,null),e(b,fr),e(b,Yn),e(Yn,br),e(b,xr),e(b,F),e(F,K),e(K,eo),e(eo,kr),e(K,vr),e(K,hn),e(hn,yr),e(K,jr),e(K,to),e(to,Lr),e(K,Mr),e(K,no),e(no,wr),e(K,Tr),e(F,Er),e(F,Z),e(Z,oo),e(oo,Or),e(Z,qr),e(Z,fn),e(fn,Gr),e(Z,Sr),e(Z,so),e(so,$r),e(Z,Fr),e(Z,ao),e(ao,Ar),e(Z,zr),e(F,Pr),e(F,X),e(X,ro),e(ro,Dr),e(X,Nr),e(X,bn),e(bn,Cr),e(X,Ir),e(X,io),e(io,Br),e(X,Wr),e(X,lo),e(lo,Hr),e(X,Rr),e(F,Ur),e(F,J),e(J,co),e(co,Vr),e(J,Kr),e(J,xn),e(xn,Zr),e(J,Xr),e(J,po),e(po,Jr),e(J,Qr),e(J,mo),e(mo,Yr),e(J,ei),e(F,ti),e(F,Q),e(Q,go),e(go,ni),e(Q,oi),e(Q,kn),e(kn,si),e(Q,ai),e(Q,_o),e(_o,ri),e(Q,ii),e(Q,uo),e(uo,li),e(Q,di),e(F,ci),e(F,Y),e(Y,ho),e(ho,pi),e(Y,mi),e(Y,vn),e(vn,gi),e(Y,_i),e(Y,fo),e(fo,ui),e(Y,hi),e(Y,bo),e(bo,fi),e(Y,bi),e(b,xi),_(Je,b,null),e(b,ki),e(b,gt),e(gt,vi),e(gt,_t),e(_t,yi),e(gt,ji),e(b,Li),e(b,xo),e(xo,Mi),e(b,wi),e(b,ko),e(ko,Ti),e(b,Ei),_(ut,b,null),e(b,Oi),e(b,vo),e(vo,qi),e(b,Gi),_(ht,b,null),e(b,Si),e(b,yo),e(yo,$i),e(b,Fi),_(ft,b,null),e(k,Ai),e(k,ee),_(bt,ee,null),e(ee,zi),e(ee,xt),e(xt,Pi),e(xt,jo),e(jo,Di),e(xt,Ni),e(ee,Ci),e(ee,Lo),e(Lo,Ii),e(ee,Bi),_(kt,ee,null),e(k,Wi),e(k,te),_(vt,te,null),e(te,Hi),e(te,yt),e(yt,Ri),e(yt,Mo),e(Mo,Ui),e(yt,Vi),e(te,Ki),e(te,wo),e(wo,Zi),e(te,Xi),_(jt,te,null),e(k,Ji),e(k,ne),_(Lt,ne,null),e(ne,Qi),e(ne,Mt),e(Mt,Yi),e(Mt,To),e(To,el),e(Mt,tl),e(ne,nl),e(ne,Eo),e(Eo,ol),e(ne,sl),_(wt,ne,null),e(k,al),e(k,oe),_(Tt,oe,null),e(oe,rl),e(oe,Et),e(Et,il),e(Et,Oo),e(Oo,ll),e(Et,dl),e(oe,cl),e(oe,qo),e(qo,pl),e(oe,ml),_(Ot,oe,null),e(k,gl),e(k,se),_(qt,se,null),e(se,_l),e(se,Gt),e(Gt,ul),e(Gt,Go),e(Go,hl),e(Gt,fl),e(se,bl),e(se,So),e(So,xl),e(se,kl),_(St,se,null),e(k,vl),e(k,ae),_($t,ae,null),e(ae,yl),e(ae,Ft),e(Ft,jl),e(Ft,$o),e($o,Ll),e(Ft,Ml),e(ae,wl),e(ae,Fo),e(Fo,Tl),e(ae,El),_(At,ae,null),M(i,bs,v),M(i,Ee,v),e(Ee,Qe),e(Qe,Ao),_(zt,Ao,null),e(Ee,Ol),e(Ee,zo),e(zo,ql),M(i,xs,v),M(i,he,v),_(Pt,he,null),e(he,Gl),e(he,Dt),e(Dt,Sl),e(Dt,yn),e(yn,$l),e(Dt,Fl),e(he,Al),e(he,T),_(Nt,T,null),e(T,zl),e(T,Po),e(Po,Pl),e(T,Dl),e(T,Ct),e(Ct,Nl),e(Ct,It),e(It,Cl),e(Ct,Il),e(T,Bl),e(T,fe),e(fe,Wl),e(fe,Do),e(Do,Hl),e(fe,Rl),e(fe,No),e(No,Ul),e(fe,Vl),e(fe,jn),e(jn,Kl),e(fe,Zl),e(T,Xl),e(T,Bt),e(Bt,Jl),e(Bt,Wt),e(Wt,Ql),e(Bt,Yl),e(T,ed),e(T,Co),e(Co,td),e(T,nd),_(Ht,T,null),M(i,ks,v),M(i,Oe,v),e(Oe,Ye),e(Ye,Io),_(Rt,Io,null),e(Oe,od),e(Oe,Bo),e(Bo,sd),M(i,vs,v),M(i,A,v),_(Ut,A,null),e(A,ad),e(A,Vt),e(Vt,rd),e(Vt,Ln),e(Ln,id),e(Vt,ld),e(A,dd),e(A,Kt),e(Kt,cd),e(Kt,Mn),e(Mn,pd),e(Kt,md),e(A,gd),e(A,qe),e(qe,re),e(re,Wo),e(Wo,_d),e(re,ud),e(re,Ho),e(Ho,hd),e(re,fd),e(re,Ro),e(Ro,bd),e(re,xd),e(re,Uo),e(Uo,kd),e(re,vd),e(qe,yd),e(qe,ie),e(ie,Vo),e(Vo,jd),e(ie,Ld),e(ie,Ko),e(Ko,Md),e(ie,wd),e(ie,Zo),e(Zo,Td),e(ie,Ed),e(ie,Xo),e(Xo,Od),e(ie,qd),e(qe,Gd),e(qe,le),e(le,Jo),e(Jo,Sd),e(le,$d),e(le,Qo),e(Qo,Fd),e(le,Ad),e(le,Yo),e(Yo,zd),e(le,Pd),e(le,es),e(es,Dd),e(le,Nd),e(A,Cd),e(A,E),_(Zt,E,null),e(E,Id),e(E,ts),e(ts,Bd),e(E,Wd),e(E,Ge),e(Ge,de),e(de,ns),e(ns,Hd),e(de,Rd),e(de,os),e(os,Ud),e(de,Vd),e(de,ss),e(ss,Kd),e(de,Zd),e(de,as),e(as,Xd),e(de,Jd),e(Ge,Qd),e(Ge,ce),e(ce,rs),e(rs,Yd),e(ce,ec),e(ce,is),e(is,tc),e(ce,nc),e(ce,ls),e(ls,oc),e(ce,sc),e(ce,ds),e(ds,ac),e(ce,rc),e(Ge,ic),e(Ge,pe),e(pe,cs),e(cs,lc),e(pe,dc),e(pe,ps),e(ps,cc),e(pe,pc),e(pe,ms),e(ms,mc),e(pe,gc),e(pe,gs),e(gs,_c),e(pe,uc),e(E,hc),_(et,E,null),e(E,fc),e(E,Xt),e(Xt,bc),e(Xt,Jt),e(Jt,xc),e(Xt,kc),e(E,vc),e(E,_s),e(_s,yc),e(E,jc),_(Qt,E,null),ys=!0},p(i,[v]){const Yt={};v&2&&(Yt.$$scope={dirty:v,ctx:i}),Je.$set(Yt);const us={};v&2&&(us.$$scope={dirty:v,ctx:i}),et.$set(us)},i(i){ys||(u(w.$$.fragment,i),u(lt.$$.fragment,i),u(dt.$$.fragment,i),u(mt.$$.fragment,i),u(Je.$$.fragment,i),u(ut.$$.fragment,i),u(ht.$$.fragment,i),u(ft.$$.fragment,i),u(bt.$$.fragment,i),u(kt.$$.fragment,i),u(vt.$$.fragment,i),u(jt.$$.fragment,i),u(Lt.$$.fragment,i),u(wt.$$.fragment,i),u(Tt.$$.fragment,i),u(Ot.$$.fragment,i),u(qt.$$.fragment,i),u(St.$$.fragment,i),u($t.$$.fragment,i),u(At.$$.fragment,i),u(zt.$$.fragment,i),u(Pt.$$.fragment,i),u(Nt.$$.fragment,i),u(Ht.$$.fragment,i),u(Rt.$$.fragment,i),u(Ut.$$.fragment,i),u(Zt.$$.fragment,i),u(et.$$.fragment,i),u(Qt.$$.fragment,i),ys=!0)},o(i){h(w.$$.fragment,i),h(lt.$$.fragment,i),h(dt.$$.fragment,i),h(mt.$$.fragment,i),h(Je.$$.fragment,i),h(ut.$$.fragment,i),h(ht.$$.fragment,i),h(ft.$$.fragment,i),h(bt.$$.fragment,i),h(kt.$$.fragment,i),h(vt.$$.fragment,i),h(jt.$$.fragment,i),h(Lt.$$.fragment,i),h(wt.$$.fragment,i),h(Tt.$$.fragment,i),h(Ot.$$.fragment,i),h(qt.$$.fragment,i),h(St.$$.fragment,i),h($t.$$.fragment,i),h(At.$$.fragment,i),h(zt.$$.fragment,i),h(Pt.$$.fragment,i),h(Nt.$$.fragment,i),h(Ht.$$.fragment,i),h(Rt.$$.fragment,i),h(Ut.$$.fragment,i),h(Zt.$$.fragment,i),h(et.$$.fragment,i),h(Qt.$$.fragment,i),ys=!1},d(i){o(p),i&&o(C),i&&o(L),f(w),i&&o(I),i&&o(G),i&&o(xe),i&&o(ke),i&&o(hs),i&&o(Te),f(lt),i&&o(fs),i&&o(k),f(dt),f(mt),f(Je),f(ut),f(ht),f(ft),f(bt),f(kt),f(vt),f(jt),f(Lt),f(wt),f(Tt),f(Ot),f(qt),f(St),f($t),f(At),i&&o(bs),i&&o(Ee),f(zt),i&&o(xs),i&&o(he),f(Pt),f(Nt),f(Ht),i&&o(ks),i&&o(Oe),f(Rt),i&&o(vs),i&&o(A),f(Ut),f(Zt),f(et),f(Qt)}}}const Km={local:"generation",sections:[{local:"transformers.generation_utils.GenerationMixin",title:"GenerationMixin"},{local:"transformers.generation_tf_utils.TFGenerationMixin",title:"TFGenerationMixin"},{local:"transformers.generation_flax_utils.FlaxGenerationMixin",title:"FlaxGenerationMixin"}],title:"Generation"};function Zm(en){return Hm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class tg extends Cm{constructor(p){super();Im(this,p,Zm,Vm,Bm,{})}}export{tg as default,Km as metadata};
