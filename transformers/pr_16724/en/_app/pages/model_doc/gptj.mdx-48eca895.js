...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function dg(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,U,fe,ie,N,A,ee,te,E,J,ge,Q,le,Y,H,oe,_e,M,de,L,Te,ce,S,W,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),x=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),fe=n("model(inputs)"),ie=n("."),N=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),E=a("ul"),J=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),W=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),x=r(h,"P",{});var C=i(x);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Ne=i(O);Z=s(Ne,"tf.keras.Model.fit"),Ne.forEach(t),me=s(C,` method which currently requires having all the
tensors in the first argument of the model call function: `),U=r(C,"CODE",{});var Le=i(U);fe=s(Le,"model(inputs)"),Le.forEach(t),ie=s(C,"."),C.forEach(t),N=d(h),A=r(h,"P",{});var Je=i(A);ee=s(Je,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Je.forEach(t),te=d(h),E=r(h,"UL",{});var z=i(E);J=r(z,"LI",{});var B=i(J);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(D,"CODE",{});var Se=i(L);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);W=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,x,G),e(x,X),e(x,O),e(O,Z),e(x,me),e(x,U),e(U,fe),e(x,ie),u(h,N,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,E,G),e(E,J),e(J,ge),e(J,Q),e(Q,le),e(J,Y),e(J,H),e(H,oe),e(E,_e),e(E,M),e(M,de),e(M,L),e(L,Te),e(M,ce),e(M,S),e(S,W),e(E,ye),e(E,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(x),h&&t(N),h&&t(A),h&&t(te),h&&t(E)}}}function cg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function pg(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,U,fe,ie,N,A,ee,te,E,J,ge,Q,le,Y,H,oe,_e,M,de,L,Te,ce,S,W,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),x=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),fe=n("model(inputs)"),ie=n("."),N=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),E=a("ul"),J=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),W=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),x=r(h,"P",{});var C=i(x);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Ne=i(O);Z=s(Ne,"tf.keras.Model.fit"),Ne.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),E=r(h,"UL",{});var z=i(E);J=r(z,"LI",{});var B=i(J);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(D,"CODE",{});var Se=i(L);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);W=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,x,G),e(x,X),e(x,O),e(O,Z),e(x,me),e(x,U),e(U,fe),e(x,ie),u(h,N,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,E,G),e(E,J),e(J,ge),e(J,Q),e(Q,le),e(J,Y),e(J,H),e(H,oe),e(E,_e),e(E,M),e(M,de),e(M,L),e(L,Te),e(M,ce),e(M,S),e(S,W),e(E,ye),e(E,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(x),h&&t(N),h&&t(A),h&&t(te),h&&t(E)}}}function hg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function ug(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,U,fe,ie,N,A,ee,te,E,J,ge,Q,le,Y,H,oe,_e,M,de,L,Te,ce,S,W,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),x=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),fe=n("model(inputs)"),ie=n("."),N=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),E=a("ul"),J=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),W=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),x=r(h,"P",{});var C=i(x);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Ne=i(O);Z=s(Ne,"tf.keras.Model.fit"),Ne.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),E=r(h,"UL",{});var z=i(E);J=r(z,"LI",{});var B=i(J);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(D,"CODE",{});var Se=i(L);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);W=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,x,G),e(x,X),e(x,O),e(O,Z),e(x,me),e(x,U),e(U,fe),e(x,ie),u(h,N,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,E,G),e(E,J),e(J,ge),e(J,Q),e(Q,le),e(J,Y),e(J,H),e(H,oe),e(E,_e),e(E,M),e(M,de),e(M,L),e(L,Te),e(M,ce),e(M,S),e(S,W),e(E,ye),e(E,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(x),h&&t(N),h&&t(A),h&&t(te),h&&t(E)}}}function mg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function fg(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,U,fe,ie,N,A,ee,te,E,J,ge,Q,le,Y,H,oe,_e,M,de,L,Te,ce,S,W,ye,q,ve,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),y=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),x=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),fe=n("model(inputs)"),ie=n("."),N=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),E=a("ul"),J=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),W=n("model([input_ids, attention_mask, token_type_ids])"),ye=l(),q=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);y=r(V,"LI",{});var Ae=i(y);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),x=r(h,"P",{});var C=i(x);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Ne=i(O);Z=s(Ne,"tf.keras.Model.fit"),Ne.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),E=r(h,"UL",{});var z=i(E);J=r(z,"LI",{});var B=i(J);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(D,"CODE",{});var Se=i(L);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);W=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ye=d(z),q=r(z,"LI",{});var we=i(q);ve=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,y),e(y,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,x,G),e(x,X),e(x,O),e(O,Z),e(x,me),e(x,U),e(U,fe),e(x,ie),u(h,N,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,E,G),e(E,J),e(J,ge),e(J,Q),e(Q,le),e(J,Y),e(J,H),e(H,oe),e(E,_e),e(E,M),e(M,de),e(M,L),e(L,Te),e(M,ce),e(M,S),e(S,W),e(E,ye),e(E,q),e(q,ve),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(x),h&&t(N),h&&t(A),h&&t(te),h&&t(E)}}}function gg(I){let p,F,f,_,y;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),y=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,y)},d(T){T&&t(p)}}}function yg(I){let p,F,f,_,y,T,g,j,ue,K,x,X,O,Z,me,U,fe,ie,N,A,ee,te,E,J,ge,Q,le,Y,H,oe,_e,M,de,L,Te,ce,S,W,ye,q,ve,R,se,h,G,V,Ae,Ie,C,Ne,Le,Je,z,B,pe,Fe,D,Se,ke,we,De,Ks,pt,Ai,Eo,Ii,Ni,Xs,Li,Si,Ys,Di,Oi,Mr,$t,Kt,Zs,Jo,Ui,ea,Wi,qr,Xt,Bi,ms,Qi,Hi,Cr,Mo,zr,fs,Ri,Ar,qo,Ir,Ft,Yt,ta,Co,Vi,oa,Ki,Nr,Ye,zo,Xi,Ze,Yi,gs,Zi,el,Ao,tl,ol,_s,nl,sl,Ts,al,rl,il,na,ll,dl,Io,Lr,jt,Zt,sa,No,cl,aa,pl,Sr,ht,Lo,hl,So,ul,Do,ml,fl,gl,Oe,Oo,_l,Gt,Tl,ys,yl,vl,ra,kl,wl,bl,eo,Pl,ia,$l,Fl,Uo,Dr,xt,to,la,Wo,jl,da,Gl,Or,et,Bo,xl,ca,El,Jl,Qo,Ml,Ho,ql,Cl,zl,Ue,Ro,Al,Et,Il,vs,Nl,Ll,pa,Sl,Dl,Ol,oo,Ul,ha,Wl,Bl,Vo,Ur,Jt,no,ua,Ko,Ql,ma,Hl,Wr,je,Xo,Rl,fa,Vl,Kl,ks,ws,Xl,Yl,Zl,tt,ed,ga,td,od,_a,nd,sd,Ta,ad,rd,ya,id,ld,dd,Yo,cd,Zo,pd,hd,ud,ne,en,md,Mt,fd,bs,gd,_d,va,Td,yd,vd,so,kd,ka,wd,bd,tn,Pd,on,$d,wa,Fd,jd,nn,Gd,sn,Br,qt,ao,ba,an,xd,Pa,Ed,Qr,ot,rn,Jd,Ct,Md,$a,qd,Cd,Fa,zd,Ad,Id,ln,Nd,dn,Ld,Sd,Dd,Me,cn,Od,zt,Ud,Ps,Wd,Bd,ja,Qd,Hd,Rd,ro,Vd,Ga,Kd,Xd,pn,Yd,hn,Hr,At,io,xa,un,Zd,Ea,ec,Rr,Ge,mn,tc,Ja,oc,nc,fn,sc,$s,ac,rc,ic,gn,lc,_n,dc,cc,pc,lo,hc,We,Tn,uc,It,mc,Fs,fc,gc,Ma,_c,Tc,yc,co,vc,qa,kc,wc,yn,Vr,Nt,po,Ca,vn,bc,za,Pc,Kr,xe,kn,$c,Aa,Fc,jc,wn,Gc,js,xc,Ec,Jc,bn,Mc,Pn,qc,Cc,zc,ho,Ac,Be,$n,Ic,Lt,Nc,Gs,Lc,Sc,Ia,Dc,Oc,Uc,uo,Wc,Na,Bc,Qc,Fn,Xr,St,mo,La,jn,Hc,Sa,Rc,Yr,ae,Gn,Vc,Da,Kc,Xc,xs,Es,Yc,Zc,ep,nt,tp,Oa,op,np,Ua,sp,ap,Wa,rp,ip,Ba,lp,dp,cp,xn,pp,Js,hp,up,mp,En,fp,Jn,gp,_p,Tp,fo,yp,qe,Mn,vp,Dt,kp,Ms,wp,bp,Qa,Pp,$p,Fp,go,jp,Ha,Gp,xp,qn,Ep,Cn,Zr,Ot,_o,Ra,zn,Jp,Va,Mp,ei,Ee,An,qp,Ut,Cp,Ka,zp,Ap,Xa,Ip,Np,Lp,In,Sp,qs,Dp,Op,Up,Nn,Wp,Ln,Bp,Qp,Hp,To,Rp,Ce,Sn,Vp,Wt,Kp,Cs,Xp,Yp,Ya,Zp,eh,th,yo,oh,Za,nh,sh,Dn,ah,On,ti,Bt,vo,er,Un,rh,tr,ih,oi,be,Wn,lh,or,dh,ch,Bn,ph,zs,hh,uh,mh,Qn,fh,Hn,gh,_h,Th,nr,yh,vh,ut,sr,Rn,kh,wh,ar,Vn,bh,Ph,rr,Kn,$h,Fh,ir,Xn,jh,Gh,Qe,Yn,xh,Qt,Eh,lr,Jh,Mh,dr,qh,Ch,zh,ko,Ah,cr,Ih,Nh,Zn,ni,Ht,wo,pr,es,Lh,hr,Sh,si,Pe,ts,Dh,ur,Oh,Uh,os,Wh,As,Bh,Qh,Hh,ns,Rh,ss,Vh,Kh,Xh,mr,Yh,Zh,mt,fr,as,eu,tu,gr,rs,ou,nu,_r,is,su,au,Tr,ls,ru,iu,He,ds,lu,Rt,du,yr,cu,pu,vr,hu,uu,mu,bo,fu,kr,gu,_u,cs,ai;return T=new Xe({}),Z=new Xe({}),z=new he({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),No=new Xe({}),Lo=new re({props:{name:"class transformers.GPTJModel",anchor:"transformers.GPTJModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_gptj.py#L459",parametersDescription:[{anchor:"transformers.GPTJModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16724/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Oo=new re({props:{name:"forward",anchor:"transformers.GPTJModel.forward",parameters:[{name:"input_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"past_key_values",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"attention_mask",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"position_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"head_mask",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_gptj.py#L515",parametersDescription:[{anchor:"transformers.GPTJModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16724/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16724/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJConfig"
...
`}}),eo=new Ke({props:{$$slots:{default:[ag]},$$scope:{ctx:I}}}),Uo=new he({props:{code:`from transformers import GPT2Tokenizer, GPTJModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Wo=new Xe({}),Bo=new re({props:{name:"class transformers.GPTJForCausalLM",anchor:"transformers.GPTJForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_gptj.py#L699",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16724/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new re({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"past_key_values",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"attention_mask",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"position_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"head_mask",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"labels",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_gptj.py#L768",parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16724/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16724/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16724/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ko=new Xe({}),Xo=new re({props:{name:"class transformers.GPTJForSequenceClassification",anchor:"transformers.GPTJForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_gptj.py#L874",parametersDescription:[{anchor:"transformers.GPTJForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16724/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),en=new re({props:{name:"forward",anchor:"transformers.GPTJForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"past_key_values",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"attention_mask",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"position_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"head_mask",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"labels",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_gptj.py#L890",parametersDescription:[{anchor:"transformers.GPTJForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16724/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16724/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),an=new Xe({}),rn=new re({props:{name:"class transformers.GPTJForQuestionAnswering",anchor:"transformers.GPTJForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_gptj.py#L1000",parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16724/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),cn=new re({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"attention_mask",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"position_ids",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"head_mask",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"start_positions",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"end_positions",val:": typing.Union[<built-in method tensor of type object at 0x7fd32fa39740>, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_gptj.py#L1016",parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16724/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16724/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16724/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_16724/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_16724/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16724/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),jn=new Xe({}),Gn=new re({props:{name:"class transformers.TFGPTJForSequenceClassification",anchor:"transformers.TFGPTJForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_tf_gptj.py#L849",parametersDescription:[{anchor:"transformers.TFGPTJForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16724/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),fo=new Ke({props:{$$slots:{default:[ug]},$$scope:{ctx:I}}}),Mn=new re({props:{name:"call",anchor:"transformers.TFGPTJForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16724/src/transformers/models/gptj/modeling_tf_gptj.py#L863",parametersDescription:[{anchor:"transformers.TFGPTJForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_16724/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=a("meta"),F=l(),f=a("h1"),_=a("a"),y=a("span"),v(T.$$.fragment),g=l(),j=a("span"),ue=n("GPT-J"),K=l(),x=a("h2"),X=a("a"),O=a("span"),v(Z.$$.fragment),me=l(),U=a("span"),fe=n("Overview"),ie=l(),N=a("p"),A=n("The GPT-J model was released in the "),ee=a("a"),te=n("kingoflolz/mesh-transformer-jax"),E=n(` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),J=a("a"),ge=n("the Pile"),Q=n(" dataset."),le=l(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),_e=n("Stella Biderman"),M=n("."),de=l(),L=a("p"),Te=n("Tips:"),ce=l(),S=a("ul"),W=a("li"),ye=n("To load "),q=a("a"),ve=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
usage to 1x. There is also a `),C=a("a"),Ne=n("fp16 branch"),Le=n(` which stores
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),Je=l(),v(z.$$.fragment),B=l(),pe=a("ul"),Fe=a("li"),D=a("p"),Se=n(`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
...
size, the tokenizer for `),Eo=a("a"),Ii=n("GPT-J"),Ni=n(` contains 143 extra tokens
`),Xs=a("code"),Li=n("<|extratoken_1|>... <|extratoken_143|>"),Si=n(", so the "),Ys=a("code"),Di=n("vocab_size"),Oi=n(" of tokenizer also becomes 50400."),Mr=l(),$t=a("h3"),Kt=a("a"),Zs=a("span"),v(Jo.$$.fragment),Ui=l(),ea=a("span"),Wi=n("Generation"),qr=l(),Xt=a("p"),Bi=n("The "),ms=a("a"),Qi=n("generate()"),Hi=n(` method can be used to generate text using GPT-J
model.`),Cr=l(),v(Mo.$$.fragment),zr=l(),fs=a("p"),Ri=n("\u2026or in float16 precision:"),Ar=l(),v(qo.$$.fragment),Ir=l(),Ft=a("h2"),Yt=a("a"),ta=a("span"),v(Co.$$.fragment),Vi=l(),oa=a("span"),Ki=n("GPTJConfig"),Nr=l(),Ye=a("div"),v(zo.$$.fragment),Xi=l(),Ze=a("p"),Yi=n("This is the configuration class to store the configuration of a "),gs=a("a"),Zi=n("GPTJModel"),el=n(`. It is used to instantiate a GPT-J
...
for more information.`),il=l(),na=a("p"),ll=n("Example:"),dl=l(),v(Io.$$.fragment),Lr=l(),jt=a("h2"),Zt=a("a"),sa=a("span"),v(No.$$.fragment),cl=l(),aa=a("span"),pl=n("GPTJModel"),Sr=l(),ht=a("div"),v(Lo.$$.fragment),hl=l(),So=a("p"),ul=n(`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Do=a("a"),ml=n("torch.nn.Module"),fl=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),gl=l(),Oe=a("div"),v(Oo.$$.fragment),_l=l(),Gt=a("p"),Tl=n("The "),ys=a("a"),yl=n("GPTJModel"),vl=n(" forward method, overrides the "),ra=a("code"),kl=n("__call__"),wl=n(" special method."),bl=l(),v(eo.$$.fragment),Pl=l(),ia=a("p"),$l=n("Example:"),Fl=l(),v(Uo.$$.fragment),Dr=l(),xt=a("h2"),to=a("a"),la=a("span"),v(Wo.$$.fragment),jl=l(),da=a("span"),Gl=n("GPTJForCausalLM"),Or=l(),et=a("div"),v(Bo.$$.fragment),xl=l(),ca=a("p"),El=n("The GPT-J Model transformer with a language modeling head on top."),Jl=l(),Qo=a("p"),Ml=n("This model is a PyTorch "),Ho=a("a"),ql=n("torch.nn.Module"),Cl=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zl=l(),Ue=a("div"),v(Ro.$$.fragment),Al=l(),Et=a("p"),Il=n("The "),vs=a("a"),Nl=n("GPTJForCausalLM"),Ll=n(" forward method, overrides the "),pa=a("code"),Sl=n("__call__"),Dl=n(" special method."),Ol=l(),v(oo.$$.fragment),Ul=l(),ha=a("p"),Wl=n("Example:"),Bl=l(),v(Vo.$$.fragment),Ur=l(),Jt=a("h2"),no=a("a"),ua=a("span"),v(Ko.$$.fragment),Ql=l(),ma=a("span"),Hl=n("GPTJForSequenceClassification"),Wr=l(),je=a("div"),v(Xo.$$.fragment),Rl=l(),fa=a("p"),Vl=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Kl=l(),ks=a("p"),ws=a("a"),Xl=n("GPTJForSequenceClassification"),Yl=n(` uses the last token in order to do the classification, as other causal models
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ud=l(),ne=a("div"),v(en.$$.fragment),md=l(),Mt=a("p"),fd=n("The "),bs=a("a"),gd=n("GPTJForSequenceClassification"),_d=n(" forward method, overrides the "),va=a("code"),Td=n("__call__"),yd=n(" special method."),vd=l(),v(so.$$.fragment),kd=l(),ka=a("p"),wd=n("Example of single-label classification:"),bd=l(),v(tn.$$.fragment),Pd=l(),v(on.$$.fragment),$d=l(),wa=a("p"),Fd=n("Example of multi-label classification:"),jd=l(),v(nn.$$.fragment),Gd=l(),v(sn.$$.fragment),Br=l(),qt=a("h2"),ao=a("a"),ba=a("span"),v(an.$$.fragment),xd=l(),Pa=a("span"),Ed=n("GPTJForQuestionAnswering"),Qr=l(),ot=a("div"),v(rn.$$.fragment),Jd=l(),Ct=a("p"),Md=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),$a=a("code"),qd=n("span start logits"),Cd=n(" and "),Fa=a("code"),zd=n("span end logits"),Ad=n(")."),Id=l(),ln=a("p"),Nd=n("This model is a PyTorch "),dn=a("a"),Ld=n("torch.nn.Module"),Sd=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dd=l(),Me=a("div"),v(cn.$$.fragment),Od=l(),zt=a("p"),Ud=n("The "),Ps=a("a"),Wd=n("GPTJForQuestionAnswering"),Bd=n(" forward method, overrides the "),ja=a("code"),Qd=n("__call__"),Hd=n(" special method."),Rd=l(),v(ro.$$.fragment),Vd=l(),Ga=a("p"),Kd=n("Example:"),Xd=l(),v(pn.$$.fragment),Yd=l(),v(hn.$$.fragment),Hr=l(),At=a("h2"),io=a("a"),xa=a("span"),v(un.$$.fragment),Zd=l(),Ea=a("span"),ec=n("TFGPTJModel"),Rr=l(),Ge=a("div"),v(mn.$$.fragment),tc=l(),Ja=a("p"),oc=n("The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),nc=l(),fn=a("p"),sc=n("This model inherits from "),$s=a("a"),ac=n("TFPreTrainedModel"),rc=n(`. Check the superclass documentation for the generic methods the
...
behavior.`),pc=l(),v(lo.$$.fragment),hc=l(),We=a("div"),v(Tn.$$.fragment),uc=l(),It=a("p"),mc=n("The "),Fs=a("a"),fc=n("TFGPTJModel"),gc=n(" forward method, overrides the "),Ma=a("code"),_c=n("__call__"),Tc=n(" special method."),yc=l(),v(co.$$.fragment),vc=l(),qa=a("p"),kc=n("Example:"),wc=l(),v(yn.$$.fragment),Vr=l(),Nt=a("h2"),po=a("a"),Ca=a("span"),v(vn.$$.fragment),bc=l(),za=a("span"),Pc=n("TFGPTJForCausalLM"),Kr=l(),xe=a("div"),v(kn.$$.fragment),$c=l(),Aa=a("p"),Fc=n("The GPT-J Model transformer with a language modeling head on top."),jc=l(),wn=a("p"),Gc=n("This model inherits from "),js=a("a"),xc=n("TFPreTrainedModel"),Ec=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc=l(),bn=a("p"),Mc=n("This model is also a "),Pn=a("a"),qc=n("tf.keras.Model"),Cc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zc=l(),v(ho.$$.fragment),Ac=l(),Be=a("div"),v($n.$$.fragment),Ic=l(),Lt=a("p"),Nc=n("The "),Gs=a("a"),Lc=n("TFGPTJForCausalLM"),Sc=n(" forward method, overrides the "),Ia=a("code"),Dc=n("__call__"),Oc=n(" special method."),Uc=l(),v(uo.$$.fragment),Wc=l(),Na=a("p"),Bc=n("Example:"),Qc=l(),v(Fn.$$.fragment),Xr=l(),St=a("h2"),mo=a("a"),La=a("span"),v(jn.$$.fragment),Hc=l(),Sa=a("span"),Rc=n("TFGPTJForSequenceClassification"),Yr=l(),ae=a("div"),v(Gn.$$.fragment),Vc=l(),Da=a("p"),Kc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Xc=l(),xs=a("p"),Es=a("a"),Yc=n("GPTJForSequenceClassification"),Zc=n(` uses the last token in order to do the classification, as other causal models
...
no `),Ua=a("code"),sp=n("pad_token_id"),ap=n(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Wa=a("code"),rp=n("inputs_embeds"),ip=n(" are passed instead of "),Ba=a("code"),lp=n("input_ids"),dp=n(`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp=l(),v(fo.$$.fragment),yp=l(),qe=a("div"),v(Mn.$$.fragment),vp=l(),Dt=a("p"),kp=n("The "),Ms=a("a"),wp=n("TFGPTJForSequenceClassification"),bp=n(" forward method, overrides the "),Qa=a("code"),Pp=n("__call__"),$p=n(" special method."),Fp=l(),v(go.$$.fragment),jp=l(),Ha=a("p"),Gp=n("Example:"),xp=l(),v(qn.$$.fragment),Ep=l(),v(Cn.$$.fragment),Zr=l(),Ot=a("h2"),_o=a("a"),Ra=a("span"),v(zn.$$.fragment),Jp=l(),Va=a("span"),Mp=n("TFGPTJForQuestionAnswering"),ei=l(),Ee=a("div"),v(An.$$.fragment),qp=l(),Ut=a("p"),Cp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Ka=a("code"),zp=n("span start logits"),Ap=n(" and "),Xa=a("code"),Ip=n("span end logits"),Np=n(")."),Lp=l(),In=a("p"),Sp=n("This model inherits from "),qs=a("a"),Dp=n("TFPreTrainedModel"),Op=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Up=l(),Nn=a("p"),Wp=n("This model is also a "),Ln=a("a"),Bp=n("tf.keras.Model"),Qp=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp=l(),v(To.$$.fragment),Rp=l(),Ce=a("div"),v(Sn.$$.fragment),Vp=l(),Wt=a("p"),Kp=n("The "),Cs=a("a"),Xp=n("TFGPTJForQuestionAnswering"),Yp=n(" forward method, overrides the "),Ya=a("code"),Zp=n("__call__"),eh=n(" special method."),th=l(),v(yo.$$.fragment),oh=l(),Za=a("p"),nh=n("Example:"),sh=l(),v(Dn.$$.fragment),ah=l(),v(On.$$.fragment),ti=l(),Bt=a("h2"),vo=a("a"),er=a("span"),v(Un.$$.fragment),rh=l(),tr=a("span"),ih=n("FlaxGPTJModel"),oi=l(),be=a("div"),v(Wn.$$.fragment),lh=l(),or=a("p"),dh=n("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),ch=l(),Bn=a("p"),ph=n("This model inherits from "),zs=a("a"),hh=n("FlaxPreTrainedModel"),uh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mh=l(),Qn=a("p"),fh=n(`This model is also a Flax Linen
`),Hn=a("a"),gh=n("flax.nn.Module"),_h=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Th=l(),nr=a("p"),yh=n("Finally, this model supports inherent JAX features such as:"),vh=l(),ut=a("ul"),sr=a("li"),Rn=a("a"),kh=n("Just-In-Time (JIT) compilation"),wh=l(),ar=a("li"),Vn=a("a"),bh=n("Automatic Differentiation"),Ph=l(),rr=a("li"),Kn=a("a"),$h=n("Vectorization"),Fh=l(),ir=a("li"),Xn=a("a"),jh=n("Parallelization"),Gh=l(),Qe=a("div"),v(Yn.$$.fragment),xh=l(),Qt=a("p"),Eh=n("The "),lr=a("code"),Jh=n("FlaxGPTJPreTrainedModel"),Mh=n(" forward method, overrides the "),dr=a("code"),qh=n("__call__"),Ch=n(" special method."),zh=l(),v(ko.$$.fragment),Ah=l(),cr=a("p"),Ih=n("Example:"),Nh=l(),v(Zn.$$.fragment),ni=l(),Ht=a("h2"),wo=a("a"),pr=a("span"),v(es.$$.fragment),Lh=l(),hr=a("span"),Sh=n("FlaxGPTJForCausalLM"),si=l(),Pe=a("div"),v(ts.$$.fragment),Dh=l(),ur=a("p"),Oh=n("The GPTJ Model transformer with a language modeling head on top."),Uh=l(),os=a("p"),Wh=n("This model inherits from "),As=a("a"),Bh=n("FlaxPreTrainedModel"),Qh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh=l(),ns=a("p"),Rh=n(`This model is also a Flax Linen
`),ss=a("a"),Vh=n("flax.nn.Module"),Kh=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Xh=l(),mr=a("p"),Yh=n("Finally, this model supports inherent JAX features such as:"),Zh=l(),mt=a("ul"),fr=a("li"),as=a("a"),eu=n("Just-In-Time (JIT) compilation"),tu=l(),gr=a("li"),rs=a("a"),ou=n("Automatic Differentiation"),nu=l(),_r=a("li"),is=a("a"),su=n("Vectorization"),au=l(),Tr=a("li"),ls=a("a"),ru=n("Parallelization"),iu=l(),He=a("div"),v(ds.$$.fragment),lu=l(),Rt=a("p"),du=n("The "),yr=a("code"),cu=n("FlaxGPTJPreTrainedModel"),pu=n(" forward method, overrides the "),vr=a("code"),hu=n("__call__"),uu=n(" special method."),mu=l(),v(bo.$$.fragment),fu=l(),kr=a("p"),gu=n("Example:"),_u=l(),v(cs.$$.fragment),this.h()},l(o){const m=ng('[data-svelte="svelte-1phssyn"]',document.head);p=r(m,"META",{name:!0,content:!0}),m.forEach(t),F=d(o),f=r(o,"H1",{class:!0});var ps=i(f);_=r(ps,"A",{id:!0,class:!0,href:!0});var wr=i(_);y=r(wr,"SPAN",{});var br=i(y);k(T.$$.fragment,br),br.forEach(t),wr.forEach(t),g=d(ps),j=r(ps,"SPAN",{});var Pr=i(j);ue=s(Pr,"GPT-J"),Pr.forEach(t),ps.forEach(t),K=d(o),x=r(o,"H2",{class:!0});var hs=i(x);X=r(hs,"A",{id:!0,class:!0,href:!0});var $r=i(X);O=r($r,"SPAN",{});var Fr=i(O);k(Z.$$.fragment,Fr),Fr.forEach(t),$r.forEach(t),me=d(hs),U=r(hs,"SPAN",{});var jr=i(U);fe=s(jr,"Overview"),jr.forEach(t),hs.forEach(t),ie=d(o),N=r(o,"P",{});var Vt=i(N);A=s(Vt,"The GPT-J model was released in the "),ee=r(Vt,"A",{href:!0,rel:!0});var Gr=i(ee);te=s(Gr,"kingoflolz/mesh-transformer-jax"),Gr.forEach(t),E=s(Vt,` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),J=r(Vt,"A",{href:!0,rel:!0});var xr=i(J);ge=s(xr,"the Pile"),xr.forEach(t),Q=s(Vt," dataset."),Vt.forEach(t),le=d(o),Y=r(o,"P",{});var us=i(Y);H=s(us,"This model was contributed by "),oe=r(us,"A",{href:!0,rel:!0});var Er=i(oe);_e=s(Er,"Stella Biderman"),Er.forEach(t),M=s(us,"."),us.forEach(t),de=d(o),L=r(o,"P",{});var Jr=i(L);Te=s(Jr,"Tips:"),Jr.forEach(t),ce=d(o),S=r(o,"UL",{});var ku=i(S);W=r(ku,"LI",{});var ft=i(W);ye=s(ft,"To load "),q=r(ft,"A",{href:!0,rel:!0});var wu=i(q);ve=s(wu,"GPT-J"),wu.forEach(t),R=s(ft,` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
...
usage to 1x. There is also a `),C=r(ft,"A",{href:!0,rel:!0});var $u=i(C);Ne=s($u,"fp16 branch"),$u.forEach(t),Le=s(ft,` which stores
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
...
tokens are added for the sake of efficiency on TPUs. To avoid the mis-match between embedding matrix size and vocab
size, the tokenizer for `),Eo=r(Po,"A",{href:!0,rel:!0});var xu=i(Eo);Ii=s(xu,"GPT-J"),xu.forEach(t),Ni=s(Po,` contains 143 extra tokens
`),Xs=r(Po,"CODE",{});var Eu=i(Xs);Li=s(Eu,"<|extratoken_1|>... <|extratoken_143|>"),Eu.forEach(t),Si=s(Po,", so the "),Ys=r(Po,"CODE",{});var Ju=i(Ys);Di=s(Ju,"vocab_size"),Ju.forEach(t),Oi=s(Po," of tokenizer also becomes 50400."),Po.forEach(t),Gu.forEach(t),ri.forEach(t),Mr=d(o),$t=r(o,"H3",{class:!0});var ii=i($t);Kt=r(ii,"A",{id:!0,class:!0,href:!0});var Mu=i(Kt);Zs=r(Mu,"SPAN",{});var qu=i(Zs);k(Jo.$$.fragment,qu),qu.forEach(t),Mu.forEach(t),Ui=d(ii),ea=r(ii,"SPAN",{});var Cu=i(ea);Wi=s(Cu,"Generation"),Cu.forEach(t),ii.forEach(t),qr=d(o),Xt=r(o,"P",{});var li=i(Xt);Bi=s(li,"The "),ms=r(li,"A",{href:!0});var zu=i(ms);Qi=s(zu,"generate()"),zu.forEach(t),Hi=s(li,` method can be used to generate text using GPT-J
model.`),li.forEach(t),Cr=d(o),k(Mo.$$.fragment,o),zr=d(o),fs=r(o,"P",{});var Au=i(fs);Ri=s(Au,"\u2026or in float16 precision:"),Au.forEach(t),Ar=d(o),k(qo.$$.fragment,o),Ir=d(o),Ft=r(o,"H2",{class:!0});var di=i(Ft);Yt=r(di,"A",{id:!0,class:!0,href:!0});var Iu=i(Yt);ta=r(Iu,"SPAN",{});var Nu=i(ta);k(Co.$$.fragment,Nu),Nu.forEach(t),Iu.forEach(t),Vi=d(di),oa=r(di,"SPAN",{});var Lu=i(oa);Ki=s(Lu,"GPTJConfig"),Lu.forEach(t),di.forEach(t),Nr=d(o),Ye=r(o,"DIV",{class:!0});var $o=i(Ye);k(zo.$$.fragment,$o),Xi=d($o),Ze=r($o,"P",{});var gt=i(Ze);Yi=s(gt,"This is the configuration class to store the configuration of a "),gs=r(gt,"A",{href:!0});var Su=i(gs);Zi=s(Su,"GPTJModel"),Su.forEach(t),el=s(gt,`. It is used to instantiate a GPT-J
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the GPT-J
`),Ao=r(gt,"A",{href:!0,rel:!0});var Du=i(Ao);tl=s(Du,"gpt-j-6B"),Du.forEach(t),ol=s(gt,` architecture. Configuration objects inherit from
`),_s=r(gt,"A",{href:!0});var Ou=i(_s);nl=s(Ou,"PretrainedConfig"),Ou.forEach(t),sl=s(gt," and can be used to control the model outputs. Read the documentation from "),Ts=r(gt,"A",{href:!0});var Uu=i(Ts);al=s(Uu,"PretrainedConfig"),Uu.forEach(t),rl=s(gt,`
for more information.`),gt.forEach(t),il=d($o),na=r($o,"P",{});var Wu=i(na);ll=s(Wu,"Example:"),Wu.forEach(t),dl=d($o),k(Io.$$.fragment,$o),$o.forEach(t),Lr=d(o),jt=r(o,"H2",{class:!0});var ci=i(jt);Zt=r(ci,"A",{id:!0,class:!0,href:!0});var Bu=i(Zt);sa=r(Bu,"SPAN",{});var Qu=i(sa);k(No.$$.fragment,Qu),Qu.forEach(t),Bu.forEach(t),cl=d(ci),aa=r(ci,"SPAN",{});var Hu=i(aa);pl=s(Hu,"GPTJModel"),Hu.forEach(t),ci.forEach(t),Sr=d(o),ht=r(o,"DIV",{class:!0});var Is=i(ht);k(Lo.$$.fragment,Is),hl=d(Is),So=r(Is,"P",{});var pi=i(So);ul=s(pi,`The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Do=r(pi,"A",{href:!0,rel:!0});var Ru=i(Do);ml=s(Ru,"torch.nn.Module"),Ru.forEach(t),fl=s(pi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),pi.forEach(t),gl=d(Is),Oe=r(Is,"DIV",{class:!0});var _t=i(Oe);k(Oo.$$.fragment,_t),_l=d(_t),Gt=r(_t,"P",{});var Ns=i(Gt);Tl=s(Ns,"The "),ys=r(Ns,"A",{href:!0});var Vu=i(ys);yl=s(Vu,"GPTJModel"),Vu.forEach(t),vl=s(Ns," forward method, overrides the "),ra=r(Ns,"CODE",{});var Ku=i(ra);kl=s(Ku,"__call__"),Ku.forEach(t),wl=s(Ns," special method."),Ns.forEach(t),bl=d(_t),k(eo.$$.fragment,_t),Pl=d(_t),ia=r(_t,"P",{});var Xu=i(ia);$l=s(Xu,"Example:"),Xu.forEach(t),Fl=d(_t),k(Uo.$$.fragment,_t),_t.forEach(t),Is.forEach(t),Dr=d(o),xt=r(o,"H2",{class:!0});var hi=i(xt);to=r(hi,"A",{id:!0,class:!0,href:!0});var Yu=i(to);la=r(Yu,"SPAN",{});var Zu=i(la);k(Wo.$$.fragment,Zu),Zu.forEach(t),Yu.forEach(t),jl=d(hi),da=r(hi,"SPAN",{});var em=i(da);Gl=s(em,"GPTJForCausalLM"),em.forEach(t),hi.forEach(t),Or=d(o),et=r(o,"DIV",{class:!0});var Fo=i(et);k(Bo.$$.fragment,Fo),xl=d(Fo),ca=r(Fo,"P",{});var tm=i(ca);El=s(tm,"The GPT-J Model transformer with a language modeling head on top."),tm.forEach(t),Jl=d(Fo),Qo=r(Fo,"P",{});var ui=i(Qo);Ml=s(ui,"This model is a PyTorch "),Ho=r(ui,"A",{href:!0,rel:!0});var om=i(Ho);ql=s(om,"torch.nn.Module"),om.forEach(t),Cl=s(ui,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ui.forEach(t),zl=d(Fo),Ue=r(Fo,"DIV",{class:!0});var Tt=i(Ue);k(Ro.$$.fragment,Tt),Al=d(Tt),Et=r(Tt,"P",{});var Ls=i(Et);Il=s(Ls,"The "),vs=r(Ls,"A",{href:!0});var nm=i(vs);Nl=s(nm,"GPTJForCausalLM"),nm.forEach(t),Ll=s(Ls," forward method, overrides the "),pa=r(Ls,"CODE",{});var sm=i(pa);Sl=s(sm,"__call__"),sm.forEach(t),Dl=s(Ls," special method."),Ls.forEach(t),Ol=d(Tt),k(oo.$$.fragment,Tt),Ul=d(Tt),ha=r(Tt,"P",{});var am=i(ha);Wl=s(am,"Example:"),am.forEach(t),Bl=d(Tt),k(Vo.$$.fragment,Tt),Tt.forEach(t),Fo.forEach(t),Ur=d(o),Jt=r(o,"H2",{class:!0});var mi=i(Jt);no=r(mi,"A",{id:!0,class:!0,href:!0});var rm=i(no);ua=r(rm,"SPAN",{});var im=i(ua);k(Ko.$$.fragment,im),im.forEach(t),rm.forEach(t),Ql=d(mi),ma=r(mi,"SPAN",{});var lm=i(ma);Hl=s(lm,"GPTJForSequenceClassification"),lm.forEach(t),mi.forEach(t),Wr=d(o),je=r(o,"DIV",{class:!0});var st=i(je);k(Xo.$$.fragment,st),Rl=d(st),fa=r(st,"P",{});var dm=i(fa);Vl=s(dm,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),dm.forEach(t),Kl=d(st),ks=r(st,"P",{});var yu=i(ks);ws=r(yu,"A",{href:!0});var cm=i(ws);Xl=s(cm,"GPTJForSequenceClassification"),cm.forEach(t),Yl=s(yu,` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vi.forEach(t),pc=d(rt),k(lo.$$.fragment,rt),hc=d(rt),We=r(rt,"DIV",{class:!0});var vt=i(We);k(Tn.$$.fragment,vt),uc=d(vt),It=r(vt,"P",{});var Us=i(It);mc=s(Us,"The "),Fs=r(Us,"A",{href:!0});var zm=i(Fs);fc=s(zm,"TFGPTJModel"),zm.forEach(t),gc=s(Us," forward method, overrides the "),Ma=r(Us,"CODE",{});var Am=i(Ma);_c=s(Am,"__call__"),Am.forEach(t),Tc=s(Us," special method."),Us.forEach(t),yc=d(vt),k(co.$$.fragment,vt),vc=d(vt),qa=r(vt,"P",{});var Im=i(qa);kc=s(Im,"Example:"),Im.forEach(t),wc=d(vt),k(yn.$$.fragment,vt),vt.forEach(t),rt.forEach(t),Vr=d(o),Nt=r(o,"H2",{class:!0});var ki=i(Nt);po=r(ki,"A",{id:!0,class:!0,href:!0});var Nm=i(po);Ca=r(Nm,"SPAN",{});var Lm=i(Ca);k(vn.$$.fragment,Lm),Lm.forEach(t),Nm.forEach(t),bc=d(ki),za=r(ki,"SPAN",{});var Sm=i(za);Pc=s(Sm,"TFGPTJForCausalLM"),Sm.forEach(t),ki.forEach(t),Kr=d(o),xe=r(o,"DIV",{class:!0});var it=i(xe);k(kn.$$.fragment,it),$c=d(it),Aa=r(it,"P",{});var Dm=i(Aa);Fc=s(Dm,"The GPT-J Model transformer with a language modeling head on top."),Dm.forEach(t),jc=d(it),wn=r(it,"P",{});var wi=i(wn);Gc=s(wi,"This model inherits from "),js=r(wi,"A",{href:!0});var Om=i(js);xc=s(Om,"TFPreTrainedModel"),Om.forEach(t),Ec=s(wi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wi.forEach(t),Jc=d(it),bn=r(it,"P",{});var bi=i(bn);Mc=s(bi,"This model is also a "),Pn=r(bi,"A",{href:!0,rel:!0});var Um=i(Pn);qc=s(Um,"tf.keras.Model"),Um.forEach(t),Cc=s(bi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bi.forEach(t),zc=d(it),k(ho.$$.fragment,it),Ac=d(it),Be=r(it,"DIV",{class:!0});var kt=i(Be);k($n.$$.fragment,kt),Ic=d(kt),Lt=r(kt,"P",{});var Ws=i(Lt);Nc=s(Ws,"The "),Gs=r(Ws,"A",{href:!0});var Wm=i(Gs);Lc=s(Wm,"TFGPTJForCausalLM"),Wm.forEach(t),Sc=s(Ws," forward method, overrides the "),Ia=r(Ws,"CODE",{});var Bm=i(Ia);Dc=s(Bm,"__call__"),Bm.forEach(t),Oc=s(Ws," special method."),Ws.forEach(t),Uc=d(kt),k(uo.$$.fragment,kt),Wc=d(kt),Na=r(kt,"P",{});var Qm=i(Na);Bc=s(Qm,"Example:"),Qm.forEach(t),Qc=d(kt),k(Fn.$$.fragment,kt),kt.forEach(t),it.forEach(t),Xr=d(o),St=r(o,"H2",{class:!0});var Pi=i(St);mo=r(Pi,"A",{id:!0,class:!0,href:!0});var Hm=i(mo);La=r(Hm,"SPAN",{});var Rm=i(La);k(jn.$$.fragment,Rm),Rm.forEach(t),Hm.forEach(t),Hc=d(Pi),Sa=r(Pi,"SPAN",{});var Vm=i(Sa);Rc=s(Vm,"TFGPTJForSequenceClassification"),Vm.forEach(t),Pi.forEach(t),Yr=d(o),ae=r(o,"DIV",{class:!0});var ze=i(ae);k(Gn.$$.fragment,ze),Vc=d(ze),Da=r(ze,"P",{});var Km=i(Da);Kc=s(Km,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Km.forEach(t),Xc=d(ze),xs=r(ze,"P",{});var vu=i(xs);Es=r(vu,"A",{href:!0});var Xm=i(Es);Yc=s(Xm,"GPTJForSequenceClassification"),Xm.forEach(t),Zc=s(vu,` uses the last token in order to do the classification, as other causal models
...
no `),Ua=r(wt,"CODE",{});var Zm=i(Ua);sp=s(Zm,"pad_token_id"),Zm.forEach(t),ap=s(wt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Wa=r(wt,"CODE",{});var ef=i(Wa);rp=s(ef,"inputs_embeds"),ef.forEach(t),ip=s(wt," are passed instead of "),Ba=r(wt,"CODE",{});var tf=i(Ba);lp=s(tf,"input_ids"),tf.forEach(t),dp=s(wt,`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),Tp=d(ze),k(fo.$$.fragment,ze),yp=d(ze),qe=r(ze,"DIV",{class:!0});var lt=i(qe);k(Mn.$$.fragment,lt),vp=d(lt),Dt=r(lt,"P",{});var Bs=i(Dt);kp=s(Bs,"The "),Ms=r(Bs,"A",{href:!0});var sf=i(Ms);wp=s(sf,"TFGPTJForSequenceClassification"),sf.forEach(t),bp=s(Bs," forward method, overrides the "),Qa=r(Bs,"CODE",{});var af=i(Qa);Pp=s(af,"__call__"),af.forEach(t),$p=s(Bs," special method."),Bs.forEach(t),Fp=d(lt),k(go.$$.fragment,lt),jp=d(lt),Ha=r(lt,"P",{});var rf=i(Ha);Gp=s(rf,"Example:"),rf.forEach(t),xp=d(lt),k(qn.$$.fragment,lt),Ep=d(lt),k(Cn.$$.fragment,lt),lt.forEach(t),ze.forEach(t),Zr=d(o),Ot=r(o,"H2",{class:!0});var ji=i(Ot);_o=r(ji,"A",{id:!0,class:!0,href:!0});var lf=i(_o);Ra=r(lf,"SPAN",{});var df=i(Ra);k(zn.$$.fragment,df),df.forEach(t),lf.forEach(t),Jp=d(ji),Va=r(ji,"SPAN",{});var cf=i(Va);Mp=s(cf,"TFGPTJForQuestionAnswering"),cf.forEach(t),ji.forEach(t),ei=d(o),Ee=r(o,"DIV",{class:!0});var dt=i(Ee);k(An.$$.fragment,dt),qp=d(dt),Ut=r(dt,"P",{});var Qs=i(Ut);Cp=s(Qs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Ka=r(Qs,"CODE",{});var pf=i(Ka);zp=s(pf,"span start logits"),pf.forEach(t),Ap=s(Qs," and "),Xa=r(Qs,"CODE",{});var hf=i(Xa);Ip=s(hf,"span end logits"),hf.forEach(t),Np=s(Qs,")."),Qs.forEach(t),Lp=d(dt),In=r(dt,"P",{});var Gi=i(In);Sp=s(Gi,"This model inherits from "),qs=r(Gi,"A",{href:!0});var uf=i(qs);Dp=s(uf,"TFPreTrainedModel"),uf.forEach(t),Op=s(Gi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gi.forEach(t),Up=d(dt),Nn=r(dt,"P",{});var xi=i(Nn);Wp=s(xi,"This model is also a "),Ln=r(xi,"A",{href:!0,rel:!0});var mf=i(Ln);Bp=s(mf,"tf.keras.Model"),mf.forEach(t),Qp=s(xi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xi.forEach(t),Hp=d(dt),k(To.$$.fragment,dt),Rp=d(dt),Ce=r(dt,"DIV",{class:!0});var ct=i(Ce);k(Sn.$$.fragment,ct),Vp=d(ct),Wt=r(ct,"P",{});var Hs=i(Wt);Kp=s(Hs,"The "),Cs=r(Hs,"A",{href:!0});var ff=i(Cs);Xp=s(ff,"TFGPTJForQuestionAnswering"),ff.forEach(t),Yp=s(Hs," forward method, overrides the "),Ya=r(Hs,"CODE",{});var gf=i(Ya);Zp=s(gf,"__call__"),gf.forEach(t),eh=s(Hs," special method."),Hs.forEach(t),th=d(ct),k(yo.$$.fragment,ct),oh=d(ct),Za=r(ct,"P",{});var _f=i(Za);nh=s(_f,"Example:"),_f.forEach(t),sh=d(ct),k(Dn.$$.fragment,ct),ah=d(ct),k(On.$$.fragment,ct),ct.forEach(t),dt.forEach(t),ti=d(o),Bt=r(o,"H2",{class:!0});var Ei=i(Bt);vo=r(Ei,"A",{id:!0,class:!0,href:!0});var Tf=i(vo);er=r(Tf,"SPAN",{});var yf=i(er);k(Un.$$.fragment,yf),yf.forEach(t),Tf.forEach(t),rh=d(Ei),tr=r(Ei,"SPAN",{});var vf=i(tr);ih=s(vf,"FlaxGPTJModel"),vf.forEach(t),Ei.forEach(t),oi=d(o),be=r(o,"DIV",{class:!0});var Re=i(be);k(Wn.$$.fragment,Re),lh=d(Re),or=r(Re,"P",{});var kf=i(or);dh=s(kf,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),kf.forEach(t),ch=d(Re),Bn=r(Re,"P",{});var Ji=i(Bn);ph=s(Ji,"This model inherits from "),zs=r(Ji,"A",{href:!0});var wf=i(zs);hh=s(wf,"FlaxPreTrainedModel"),wf.forEach(t),uh=s(Ji,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mi.forEach(t),Th=d(Re),nr=r(Re,"P",{});var Pf=i(nr);yh=s(Pf,"Finally, this model supports inherent JAX features such as:"),Pf.forEach(t),vh=d(Re),ut=r(Re,"UL",{});var Go=i(ut);sr=r(Go,"LI",{});var $f=i(sr);Rn=r($f,"A",{href:!0,rel:!0});var Ff=i(Rn);kh=s(Ff,"Just-In-Time (JIT) compilation"),Ff.forEach(t),$f.forEach(t),wh=d(Go),ar=r(Go,"LI",{});var jf=i(ar);Vn=r(jf,"A",{href:!0,rel:!0});var Gf=i(Vn);bh=s(Gf,"Automatic Differentiation"),Gf.forEach(t),jf.forEach(t),Ph=d(Go),rr=r(Go,"LI",{});var xf=i(rr);Kn=r(xf,"A",{href:!0,rel:!0});var Ef=i(Kn);$h=s(Ef,"Vectorization"),Ef.forEach(t),xf.forEach(t),Fh=d(Go),ir=r(Go,"LI",{});var Jf=i(ir);Xn=r(Jf,"A",{href:!0,rel:!0});var Mf=i(Xn);jh=s(Mf,"Parallelization"),Mf.forEach(t),Jf.forEach(t),Go.forEach(t),Gh=d(Re),Qe=r(Re,"DIV",{class:!0});var bt=i(Qe);k(Yn.$$.fragment,bt),xh=d(bt),Qt=r(bt,"P",{});var Rs=i(Qt);Eh=s(Rs,"The "),lr=r(Rs,"CODE",{});var qf=i(lr);Jh=s(qf,"FlaxGPTJPreTrainedModel"),qf.forEach(t),Mh=s(Rs," forward method, overrides the "),dr=r(Rs,"CODE",{});var Cf=i(dr);qh=s(Cf,"__call__"),Cf.forEach(t),Ch=s(Rs," special method."),Rs.forEach(t),zh=d(bt),k(ko.$$.fragment,bt),Ah=d(bt),cr=r(bt,"P",{});var zf=i(cr);Ih=s(zf,"Example:"),zf.forEach(t),Nh=d(bt),k(Zn.$$.fragment,bt),bt.forEach(t),Re.forEach(t),ni=d(o),Ht=r(o,"H2",{class:!0});var qi=i(Ht);wo=r(qi,"A",{id:!0,class:!0,href:!0});var Af=i(wo);pr=r(Af,"SPAN",{});var If=i(pr);k(es.$$.fragment,If),If.forEach(t),Af.forEach(t),Lh=d(qi),hr=r(qi,"SPAN",{});var Nf=i(hr);Sh=s(Nf,"FlaxGPTJForCausalLM"),Nf.forEach(t),qi.forEach(t),si=d(o),Pe=r(o,"DIV",{class:!0});var Ve=i(Pe);k(ts.$$.fragment,Ve),Dh=d(Ve),ur=r(Ve,"P",{});var Lf=i(ur);Oh=s(Lf,"The GPTJ Model transformer with a language modeling head on top."),Lf.forEach(t),Uh=d(Ve),os=r(Ve,"P",{});var Ci=i(os);Wh=s(Ci,"This model inherits from "),As=r(Ci,"A",{href:!0});var Sf=i(As);Bh=s(Sf,"FlaxPreTrainedModel"),Sf.forEach(t),Qh=s(Ci,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zi.forEach(t),Xh=d(Ve),mr=r(Ve,"P",{});var Of=i(mr);Yh=s(Of,"Finally, this model supports inherent JAX features such as:"),Of.forEach(t),Zh=d(Ve),mt=r(Ve,"UL",{});var xo=i(mt);fr=r(xo,"LI",{});var Uf=i(fr);as=r(Uf,"A",{href:!0,rel:!0});var Wf=i(as);eu=s(Wf,"Just-In-Time (JIT) compilation"),Wf.forEach(t),Uf.forEach(t),tu=d(xo),gr=r(xo,"LI",{});var Bf=i(gr);rs=r(Bf,"A",{href:!0,rel:!0});var Qf=i(rs);ou=s(Qf,"Automatic Differentiation"),Qf.forEach(t),Bf.forEach(t),nu=d(xo),_r=r(xo,"LI",{});var Hf=i(_r);is=r(Hf,"A",{href:!0,rel:!0});var Rf=i(is);su=s(Rf,"Vectorization"),Rf.forEach(t),Hf.forEach(t),au=d(xo),Tr=r(xo,"LI",{});var Vf=i(Tr);ls=r(Vf,"A",{href:!0,rel:!0});var Kf=i(ls);ru=s(Kf,"Parallelization"),Kf.forEach(t),Vf.forEach(t),xo.forEach(t),iu=d(Ve),He=r(Ve,"DIV",{class:!0});var Pt=i(He);k(ds.$$.fragment,Pt),lu=d(Pt),Rt=r(Pt,"P",{});var Vs=i(Rt);du=s(Vs,"The "),yr=r(Vs,"CODE",{});var Xf=i(yr);cu=s(Xf,"FlaxGPTJPreTrainedModel"),Xf.forEach(t),pu=s(Vs," forward method, overrides the "),vr=r(Vs,"CODE",{});var Yf=i(vr);hu=s(Yf,"__call__"),Yf.forEach(t),uu=s(Vs," special method."),Vs.forEach(t),mu=d(Pt),k(bo.$$.fragment,Pt),fu=d(Pt),kr=r(Pt,"P",{});var Zf=i(kr);gu=s(Zf,"Example:"),Zf.forEach(t),_u=d(Pt),k(cs.$$.fragment,Pt),Pt.forEach(t),Ve.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(vg)),c(_,"id","gptj"),c(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_,"href","#gptj"),c(f,"class","relative group"),c(X,"id","overview"),c(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(X,"href","#overview"),c(x,"class","relative group"),c(ee,"href","https://github.com/kingoflolz/mesh-transformer-jax"),c(ee,"rel","nofollow"),c(J,"href","https://pile.eleuther.ai/"),c(J,"rel","nofollow"),c(oe,"href","https://huggingface.co/stellaathena"),c(oe,"rel","nofollow"),c(q,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(q,"rel","nofollow"),c(C,"href","https://huggingface.co/EleutherAI/gpt-j-6B/tree/float16"),c(C,"rel","nofollow"),c(ke,"href","https://github.com/kingoflolz/mesh-transformer-jax/blob/master/howto_finetune.md"),c(ke,"rel","nofollow"),c(Eo,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Eo,"rel","nofollow"),c(Kt,"id","generation"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#generation"),c($t,"class","relative group"),c(ms,"href","/docs/transformers/pr_16724/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(Yt,"id","transformers.GPTJConfig"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.GPTJConfig"),c(Ft,"class","relative group"),c(gs,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJModel"),c(Ao,"href","https://huggingface.co/EleutherAI/gpt-j-6B"),c(Ao,"rel","nofollow"),c(_s,"href","/docs/transformers/pr_16724/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ts,"href","/docs/transformers/pr_16724/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ye,"class","docstring"),c(Zt,"id","transformers.GPTJModel"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.GPTJModel"),c(jt,"class","relative group"),c(Do,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Do,"rel","nofollow"),c(ys,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJModel"),c(Oe,"class","docstring"),c(ht,"class","docstring"),c(to,"id","transformers.GPTJForCausalLM"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.GPTJForCausalLM"),c(xt,"class","relative group"),c(Ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ho,"rel","nofollow"),c(vs,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJForCausalLM"),c(Ue,"class","docstring"),c(et,"class","docstring"),c(no,"id","transformers.GPTJForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.GPTJForSequenceClassification"),c(Jt,"class","relative group"),c(ws,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(Zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Zo,"rel","nofollow"),c(bs,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(ne,"class","docstring"),c(je,"class","docstring"),c(ao,"id","transformers.GPTJForQuestionAnswering"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.GPTJForQuestionAnswering"),c(qt,"class","relative group"),c(dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(dn,"rel","nofollow"),c(Ps,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJForQuestionAnswering"),c(Me,"class","docstring"),c(ot,"class","docstring"),c(io,"id","transformers.TFGPTJModel"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.TFGPTJModel"),c(At,"class","relative group"),c($s,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.TFPreTrainedModel"),c(_n,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(_n,"rel","nofollow"),c(Fs,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.TFGPTJModel"),c(We,"class","docstring"),c(Ge,"class","docstring"),c(po,"id","transformers.TFGPTJForCausalLM"),c(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(po,"href","#transformers.TFGPTJForCausalLM"),c(Nt,"class","relative group"),c(js,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.TFPreTrainedModel"),c(Pn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Pn,"rel","nofollow"),c(Gs,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.TFGPTJForCausalLM"),c(Be,"class","docstring"),c(xe,"class","docstring"),c(mo,"id","transformers.TFGPTJForSequenceClassification"),c(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(mo,"href","#transformers.TFGPTJForSequenceClassification"),c(St,"class","relative group"),c(Es,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.GPTJForSequenceClassification"),c(Js,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.TFPreTrainedModel"),c(Jn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Jn,"rel","nofollow"),c(Ms,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.TFGPTJForSequenceClassification"),c(qe,"class","docstring"),c(ae,"class","docstring"),c(_o,"id","transformers.TFGPTJForQuestionAnswering"),c(_o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_o,"href","#transformers.TFGPTJForQuestionAnswering"),c(Ot,"class","relative group"),c(qs,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.TFPreTrainedModel"),c(Ln,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Ln,"rel","nofollow"),c(Cs,"href","/docs/transformers/pr_16724/en/model_doc/gptj#transformers.TFGPTJForQuestionAnswering"),c(Ce,"class","docstring"),c(Ee,"class","docstring"),c(vo,"id","transformers.FlaxGPTJModel"),c(vo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(vo,"href","#transformers.FlaxGPTJModel"),c(Bt,"class","relative group"),c(zs,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Hn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Hn,"rel","nofollow"),c(Rn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Rn,"rel","nofollow"),c(Vn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Vn,"rel","nofollow"),c(Kn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Kn,"rel","nofollow"),c(Xn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Xn,"rel","nofollow"),c(Qe,"class","docstring"),c(be,"class","docstring"),c(wo,"id","transformers.FlaxGPTJForCausalLM"),c(wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(wo,"href","#transformers.FlaxGPTJForCausalLM"),c(Ht,"class","relative group"),c(As,"href","/docs/transformers/pr_16724/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(ss,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(ss,"rel","nofollow"),c(as,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(as,"rel","nofollow"),c(rs,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(rs,"rel","nofollow"),c(is,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(is,"rel","nofollow"),c(ls,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(ls,"rel","nofollow"),c(He,"class","docstring"),c(Pe,"class","docstring")},m(o,m){e(document.head,p),u(o,F,m),u(o,f,m),e(f,_),e(_,y),w(T,y,null),e(f,g),e(f,j),e(j,ue),u(o,K,m),u(o,x,m),e(x,X),e(X,O),w(Z,O,null),e(x,me),e(x,U),e(U,fe),u(o,ie,m),u(o,N,m),e(N,A),e(N,ee),e(ee,te),e(N,E),e(N,J),e(J,ge),e(N,Q),u(o,le,m),u(o,Y,m),e(Y,H),e(Y,oe),e(oe,_e),e(Y,M),u(o,de,m),u(o,L,m),e(L,Te),u(o,ce,m),u(o,S,m),e(S,W),e(W,ye),e(W,q),e(q,ve),e(W,R),e(W,se),e(se,h),e(W,G),e(W,V),e(V,Ae),e(W,Ie),e(W,C),e(C,Ne),e(W,Le),u(o,Je,m),w(z,o,m),u(o,B,m),u(o,pe,m),e(pe,Fe),e(Fe,D),e(D,Se),e(D,ke),e(ke,we),e(pe,De),e(pe,Ks),e(Ks,pt),e(pt,Ai),e(pt,Eo),e(Eo,Ii),e(pt,Ni),e(pt,Xs),e(Xs,Li),e(pt,Si),e(pt,Ys),e(Ys,Di),e(pt,Oi),u(o,Mr,m),u(o,$t,m),e($t,Kt),e(Kt,Zs),w(Jo,Zs,null),e($t,Ui),e($t,ea),e(ea,Wi),u(o,qr,m),u(o,Xt,m),e(Xt,Bi),e(Xt,ms),e(ms,Qi),e(Xt,Hi),u(o,Cr,m),w(Mo,o,m),u(o,zr,m),u(o,fs,m),e(fs,Ri),u(o,Ar,m),w(qo,o,m),u(o,Ir,m),u(o,Ft,m),e(Ft,Yt),e(Yt,ta),w(Co,ta,null),e(Ft,Vi),e(Ft,oa),e(oa,Ki),u(o,Nr,m),u(o,Ye,m),w(zo,Ye,null),e(Ye,Xi),e(Ye,Ze),e(Ze,Yi),e(Ze,gs),e(gs,Zi),e(Ze,el),e(Ze,Ao),e(Ao,tl),e(Ze,ol),e(Ze,_s),e(_s,nl),e(Ze,sl),e(Ze,Ts),e(Ts,al),e(Ze,rl),e(Ye,il),e(Ye,na),e(na,ll),e(Ye,dl),w(Io,Ye,null),u(o,Lr,m),u(o,jt,m),e(jt,Zt),e(Zt,sa),w(No,sa,null),e(jt,cl),e(jt,aa),e(aa,pl),u(o,Sr,m),u(o,ht,m),w(Lo,ht,null),e(ht,hl),e(ht,So),e(So,ul),e(So,Do),e(Do,ml),e(So,fl),e(ht,gl),e(ht,Oe),w(Oo,Oe,null),e(Oe,_l),e(Oe,Gt),e(Gt,Tl),e(Gt,ys),e(ys,yl),e(Gt,vl),e(Gt,ra),e(ra,kl),e(Gt,wl),e(Oe,bl),w(eo,Oe,null),e(Oe,Pl),e(Oe,ia),e(ia,$l),e(Oe,Fl),w(Uo,Oe,null),u(o,Dr,m),u(o,xt,m),e(xt,to),e(to,la),w(Wo,la,null),e(xt,jl),e(xt,da),e(da,Gl),u(o,Or,m),u(o,et,m),w(Bo,et,null),e(et,xl),e(et,ca),e(ca,El),e(et,Jl),e(et,Qo),e(Qo,Ml),e(Qo,Ho),e(Ho,ql),e(Qo,Cl),e(et,zl),e(et,Ue),w(Ro,Ue,null),e(Ue,Al),e(Ue,Et),e(Et,Il),e(Et,vs),e(vs,Nl),e(Et,Ll),e(Et,pa),e(pa,Sl),e(Et,Dl),e(Ue,Ol),w(oo,Ue,null),e(Ue,Ul),e(Ue,ha),e(ha,Wl),e(Ue,Bl),w(Vo,Ue,null),u(o,Ur,m),u(o,Jt,m),e(Jt,no),e(no,ua),w(Ko,ua,null),e(Jt,Ql),e(Jt,ma),e(ma,Hl),u(o,Wr,m),u(o,je,m),w(Xo,je,null),e(je,Rl),e(je,fa),e(fa,Vl),e(je,Kl),e(je,ks),e(ks,ws),e(ws,Xl),e(ks,Yl),e(je,Zl),e(je,tt),e(tt,ed),e(tt,ga),e(ga,td),e(tt,od),e(tt,_a),e(_a,nd),e(tt,sd),e(tt,Ta),e(Ta,ad),e(tt,rd),e(tt,ya),e(ya,id),e(tt,ld),e(je,dd),e(je,Yo),e(Yo,cd),e(Yo,Zo),e(Zo,pd),e(Yo,hd),e(je,ud),e(je,ne),w(en,ne,null),e(ne,md),e(ne,Mt),e(Mt,fd),e(Mt,bs),e(bs,gd),e(Mt,_d),e(Mt,va),e(va,Td),e(Mt,yd),e(ne,vd),w(so,ne,null),e(ne,kd),e(ne,ka),e(ka,wd),e(ne,bd),w(tn,ne,null),e(ne,Pd),w(on,ne,null),e(ne,$d),e(ne,wa),e(wa,Fd),e(ne,jd),w(nn,ne,null),e(ne,Gd),w(sn,ne,null),u(o,Br,m),u(o,qt,m),e(qt,ao),e(ao,ba),w(an,ba,null),e(qt,xd),e(qt,Pa),e(Pa,Ed),u(o,Qr,m),u(o,ot,m),w(rn,ot,null),e(ot,Jd),e(ot,Ct),e(Ct,Md),e(Ct,$a),e($a,qd),e(Ct,Cd),e(Ct,Fa),e(Fa,zd),e(Ct,Ad),e(ot,Id),e(ot,ln),e(ln,Nd),e(ln,dn),e(dn,Ld),e(ln,Sd),e(ot,Dd),e(ot,Me),w(cn,Me,null),e(Me,Od),e(Me,zt),e(zt,Ud),e(zt,Ps),e(Ps,Wd),e(zt,Bd),e(zt,ja),e(ja,Qd),e(zt,Hd),e(Me,Rd),w(ro,Me,null),e(Me,Vd),e(Me,Ga),e(Ga,Kd),e(Me,Xd),w(pn,Me,null),e(Me,Yd),w(hn,Me,null),u(o,Hr,m),u(o,At,m),e(At,io),e(io,xa),w(un,xa,null),e(At,Zd),e(At,Ea),e(Ea,ec),u(o,Rr,m),u(o,Ge,m),w(mn,Ge,null),e(Ge,tc),e(Ge,Ja),e(Ja,oc),e(Ge,nc),e(Ge,fn),e(fn,sc),e(fn,$s),e($s,ac),e(fn,rc),e(Ge,ic),e(Ge,gn),e(gn,lc),e(gn,_n),e(_n,dc),e(gn,cc),e(Ge,pc),w(lo,Ge,null),e(Ge,hc),e(Ge,We),w(Tn,We,null),e(We,uc),e(We,It),e(It,mc),e(It,Fs),e(Fs,fc),e(It,gc),e(It,Ma),e(Ma,_c),e(It,Tc),e(We,yc),w(co,We,null),e(We,vc),e(We,qa),e(qa,kc),e(We,wc),w(yn,We,null),u(o,Vr,m),u(o,Nt,m),e(Nt,po),e(po,Ca),w(vn,Ca,null),e(Nt,bc),e(Nt,za),e(za,Pc),u(o,Kr,m),u(o,xe,m),w(kn,xe,null),e(xe,$c),e(xe,Aa),e(Aa,Fc),e(xe,jc),e(xe,wn),e(wn,Gc),e(wn,js),e(js,xc),e(wn,Ec),e(xe,Jc),e(xe,bn),e(bn,Mc),e(bn,Pn),e(Pn,qc),e(bn,Cc),e(xe,zc),w(ho,xe,null),e(xe,Ac),e(xe,Be),w($n,Be,null),e(Be,Ic),e(Be,Lt),e(Lt,Nc),e(Lt,Gs),e(Gs,Lc),e(Lt,Sc),e(Lt,Ia),e(Ia,Dc),e(Lt,Oc),e(Be,Uc),w(uo,Be,null),e(Be,Wc),e(Be,Na),e(Na,Bc),e(Be,Qc),w(Fn,Be,null),u(o,Xr,m),u(o,St,m),e(St,mo),e(mo,La),w(jn,La,null),e(St,Hc),e(St,Sa),e(Sa,Rc),u(o,Yr,m),u(o,ae,m),w(Gn,ae,null),e(ae,Vc),e(ae,Da),e(Da,Kc),e(ae,Xc),e(ae,xs),e(xs,Es),e(Es,Yc),e(xs,Zc),e(ae,ep),e(ae,nt),e(nt,tp),e(nt,Oa),e(Oa,op),e(nt,np),e(nt,Ua),e(Ua,sp),e(nt,ap),e(nt,Wa),e(Wa,rp),e(nt,ip),e(nt,Ba),e(Ba,lp),e(nt,dp),e(ae,cp),e(ae,xn),e(xn,pp),e(xn,Js),e(Js,hp),e(xn,up),e(ae,mp),e(ae,En),e(En,fp),e(En,Jn),e(Jn,gp),e(En,_p),e(ae,Tp),w(fo,ae,null),e(ae,yp),e(ae,qe),w(Mn,qe,null),e(qe,vp),e(qe,Dt),e(Dt,kp),e(Dt,Ms),e(Ms,wp),e(Dt,bp),e(Dt,Qa),e(Qa,Pp),e(Dt,$p),e(qe,Fp),w(go,qe,null),e(qe,jp),e(qe,Ha),e(Ha,Gp),e(qe,xp),w(qn,qe,null),e(qe,Ep),w(Cn,qe,null),u(o,Zr,m),u(o,Ot,m),e(Ot,_o),e(_o,Ra),w(zn,Ra,null),e(Ot,Jp),e(Ot,Va),e(Va,Mp),u(o,ei,m),u(o,Ee,m),w(An,Ee,null),e(Ee,qp),e(Ee,Ut),e(Ut,Cp),e(Ut,Ka),e(Ka,zp),e(Ut,Ap),e(Ut,Xa),e(Xa,Ip),e(Ut,Np),e(Ee,Lp),e(Ee,In),e(In,Sp),e(In,qs),e(qs,Dp),e(In,Op),e(Ee,Up),e(Ee,Nn),e(Nn,Wp),e(Nn,Ln),e(Ln,Bp),e(Nn,Qp),e(Ee,Hp),w(To,Ee,null),e(Ee,Rp),e(Ee,Ce),w(Sn,Ce,null),e(Ce,Vp),e(Ce,Wt),e(Wt,Kp),e(Wt,Cs),e(Cs,Xp),e(Wt,Yp),e(Wt,Ya),e(Ya,Zp),e(Wt,eh),e(Ce,th),w(yo,Ce,null),e(Ce,oh),e(Ce,Za),e(Za,nh),e(Ce,sh),w(Dn,Ce,null),e(Ce,ah),w(On,Ce,null),u(o,ti,m),u(o,Bt,m),e(Bt,vo),e(vo,er),w(Un,er,null),e(Bt,rh),e(Bt,tr),e(tr,ih),u(o,oi,m),u(o,be,m),w(Wn,be,null),e(be,lh),e(be,or),e(or,dh),e(be,ch),e(be,Bn),e(Bn,ph),e(Bn,zs),e(zs,hh),e(Bn,uh),e(be,mh),e(be,Qn),e(Qn,fh),e(Qn,Hn),e(Hn,gh),e(Qn,_h),e(be,Th),e(be,nr),e(nr,yh),e(be,vh),e(be,ut),e(ut,sr),e(sr,Rn),e(Rn,kh),e(ut,wh),e(ut,ar),e(ar,Vn),e(Vn,bh),e(ut,Ph),e(ut,rr),e(rr,Kn),e(Kn,$h),e(ut,Fh),e(ut,ir),e(ir,Xn),e(Xn,jh),e(be,Gh),e(be,Qe),w(Yn,Qe,null),e(Qe,xh),e(Qe,Qt),e(Qt,Eh),e(Qt,lr),e(lr,Jh),e(Qt,Mh),e(Qt,dr),e(dr,qh),e(Qt,Ch),e(Qe,zh),w(ko,Qe,null),e(Qe,Ah),e(Qe,cr),e(cr,Ih),e(Qe,Nh),w(Zn,Qe,null),u(o,ni,m),u(o,Ht,m),e(Ht,wo),e(wo,pr),w(es,pr,null),e(Ht,Lh),e(Ht,hr),e(hr,Sh),u(o,si,m),u(o,Pe,m),w(ts,Pe,null),e(Pe,Dh),e(Pe,ur),e(ur,Oh),e(Pe,Uh),e(Pe,os),e(os,Wh),e(os,As),e(As,Bh),e(os,Qh),e(Pe,Hh),e(Pe,ns),e(ns,Rh),e(ns,ss),e(ss,Vh),e(ns,Kh),e(Pe,Xh),e(Pe,mr),e(mr,Yh),e(Pe,Zh),e(Pe,mt),e(mt,fr),e(fr,as),e(as,eu),e(mt,tu),e(mt,gr),e(gr,rs),e(rs,ou),e(mt,nu),e(mt,_r),e(_r,is),e(is,su),e(mt,au),e(mt,Tr),e(Tr,ls),e(ls,ru),e(Pe,iu),e(Pe,He),w(ds,He,null),e(He,lu),e(He,Rt),e(Rt,du),e(Rt,yr),e(yr,cu),e(Rt,pu),e(Rt,vr),e(vr,hu),e(Rt,uu),e(He,mu),w(bo,He,null),e(He,fu),e(He,kr),e(kr,gu),e(He,_u),w(cs,He,null),ai=!0},p(o,[m]){const ps={};m&2&&(ps.$$scope={dirty:m,ctx:o}),eo.$set(ps);const wr={};m&2&&(wr.$$scope={dirty:m,ctx:o}),oo.$set(wr);const br={};m&2&&(br.$$scope={dirty:m,ctx:o}),so.$set(br);const Pr={};m&2&&(Pr.$$scope={dirty:m,ctx:o}),ro.$set(Pr);const hs={};m&2&&(hs.$$scope={dirty:m,ctx:o}),lo.$set(hs);const $r={};m&2&&($r.$$scope={dirty:m,ctx:o}),co.$set($r);const Fr={};m&2&&(Fr.$$scope={dirty:m,ctx:o}),ho.$set(Fr);const jr={};m&2&&(jr.$$scope={dirty:m,ctx:o}),uo.$set(jr);const Vt={};m&2&&(Vt.$$scope={dirty:m,ctx:o}),fo.$set(Vt);const Gr={};m&2&&(Gr.$$scope={dirty:m,ctx:o}),go.$set(Gr);const xr={};m&2&&(xr.$$scope={dirty:m,ctx:o}),To.$set(xr);const us={};m&2&&(us.$$scope={dirty:m,ctx:o}),yo.$set(us);const Er={};m&2&&(Er.$$scope={dirty:m,ctx:o}),ko.$set(Er);const Jr={};m&2&&(Jr.$$scope={dirty:m,ctx:o}),bo.$set(Jr)},i(o){ai||(b(T.$$.fragment,o),b(Z.$$.fragment,o),b(z.$$.fragment,o),b(Jo.$$.fragment,o),b(Mo.$$.fragment,o),b(qo.$$.fragment,o),b(Co.$$.fragment,o),b(zo.$$.fragment,o),b(Io.$$.fragment,o),b(No.$$.fragment,o),b(Lo.$$.fragment,o),b(Oo.$$.fragment,o),b(eo.$$.fragment,o),b(Uo.$$.fragment,o),b(Wo.$$.fragment,o),b(Bo.$$.fragment,o),b(Ro.$$.fragment,o),b(oo.$$.fragment,o),b(Vo.$$.fragment,o),b(Ko.$$.fragment,o),b(Xo.$$.fragment,o),b(en.$$.fragment,o),b(so.$$.fragment,o),b(tn.$$.fragment,o),b(on.$$.fragment,o),b(nn.$$.fragment,o),b(sn.$$.fragment,o),b(an.$$.fragment,o),b(rn.$$.fragment,o),b(cn.$$.fragment,o),b(ro.$$.fragment,o),b(pn.$$.fragment,o),b(hn.$$.fragment,o),b(un.$$.fragment,o),b(mn.$$.fragment,o),b(lo.$$.fragment,o),b(Tn.$$.fragment,o),b(co.$$.fragment,o),b(yn.$$.fragment,o),b(vn.$$.fragment,o),b(kn.$$.fragment,o),b(ho.$$.fragment,o),b($n.$$.fragment,o),b(uo.$$.fragment,o),b(Fn.$$.fragment,o),b(jn.$$.fragment,o),b(Gn.$$.fragment,o),b(fo.$$.fragment,o),b(Mn.$$.fragment,o),b(go.$$.fragment,o),b(qn.$$.fragment,o),b(Cn.$$.fragment,o),b(zn.$$.fragment,o),b(An.$$.fragment,o),b(To.$$.fragment,o),b(Sn.$$.fragment,o),b(yo.$$.fragment,o),b(Dn.$$.fragment,o),b(On.$$.fragment,o),b(Un.$$.fragment,o),b(Wn.$$.fragment,o),b(Yn.$$.fragment,o),b(ko.$$.fragment,o),b(Zn.$$.fragment,o),b(es.$$.fragment,o),b(ts.$$.fragment,o),b(ds.$$.fragment,o),b(bo.$$.fragment,o),b(cs.$$.fragment,o),ai=!0)},o(o){P(T.$$.fragment,o),P(Z.$$.fragment,o),P(z.$$.fragment,o),P(Jo.$$.fragment,o),P(Mo.$$.fragment,o),P(qo.$$.fragment,o),P(Co.$$.fragment,o),P(zo.$$.fragment,o),P(Io.$$.fragment,o),P(No.$$.fragment,o),P(Lo.$$.fragment,o),P(Oo.$$.fragment,o),P(eo.$$.fragment,o),P(Uo.$$.fragment,o),P(Wo.$$.fragment,o),P(Bo.$$.fragment,o),P(Ro.$$.fragment,o),P(oo.$$.fragment,o),P(Vo.$$.fragment,o),P(Ko.$$.fragment,o),P(Xo.$$.fragment,o),P(en.$$.fragment,o),P(so.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(nn.$$.fragment,o),P(sn.$$.fragment,o),P(an.$$.fragment,o),P(rn.$$.fragment,o),P(cn.$$.fragment,o),P(ro.$$.fragment,o),P(pn.$$.fragment,o),P(hn.$$.fragment,o),P(un.$$.fragment,o),P(mn.$$.fragment,o),P(lo.$$.fragment,o),P(Tn.$$.fragment,o),P(co.$$.fragment,o),P(yn.$$.fragment,o),P(vn.$$.fragment,o),P(kn.$$.fragment,o),P(ho.$$.fragment,o),P($n.$$.fragment,o),P(uo.$$.fragment,o),P(Fn.$$.fragment,o),P(jn.$$.fragment,o),P(Gn.$$.fragment,o),P(fo.$$.fragment,o),P(Mn.$$.fragment,o),P(go.$$.fragment,o),P(qn.$$.fragment,o),P(Cn.$$.fragment,o),P(zn.$$.fragment,o),P(An.$$.fragment,o),P(To.$$.fragment,o),P(Sn.$$.fragment,o),P(yo.$$.fragment,o),P(Dn.$$.fragment,o),P(On.$$.fragment,o),P(Un.$$.fragment,o),P(Wn.$$.fragment,o),P(Yn.$$.fragment,o),P(ko.$$.fragment,o),P(Zn.$$.fragment,o),P(es.$$.fragment,o),P(ts.$$.fragment,o),P(ds.$$.fragment,o),P(bo.$$.fragment,o),P(cs.$$.fragment,o),ai=!1},d(o){t(p),o&&t(F),o&&t(f),$(T),o&&t(K),o&&t(x),$(Z),o&&t(ie),o&&t(N),o&&t(le),o&&t(Y),o&&t(de),o&&t(L),o&&t(ce),o&&t(S),o&&t(Je),$(z,o),o&&t(B),o&&t(pe),o&&t(Mr),o&&t($t),$(Jo),o&&t(qr),o&&t(Xt),o&&t(Cr),$(Mo,o),o&&t(zr),o&&t(fs),o&&t(Ar),$(qo,o),o&&t(Ir),o&&t(Ft),$(Co),o&&t(Nr),o&&t(Ye),$(zo),$(Io),o&&t(Lr),o&&t(jt),$(No),o&&t(Sr),o&&t(ht),$(Lo),$(Oo),$(eo),$(Uo),o&&t(Dr),o&&t(xt),$(Wo),o&&t(Or),o&&t(et),$(Bo),$(Ro),$(oo),$(Vo),o&&t(Ur),o&&t(Jt),$(Ko),o&&t(Wr),o&&t(je),$(Xo),$(en),$(so),$(tn),$(on),$(nn),$(sn),o&&t(Br),o&&t(qt),$(an),o&&t(Qr),o&&t(ot),$(rn),$(cn),$(ro),$(pn),$(hn),o&&t(Hr),o&&t(At),$(un),o&&t(Rr),o&&t(Ge),$(mn),$(lo),$(Tn),$(co),$(yn),o&&t(Vr),o&&t(Nt),$(vn),o&&t(Kr),o&&t(xe),$(kn),$(ho),$($n),$(uo),$(Fn),o&&t(Xr),o&&t(St),$(jn),o&&t(Yr),o&&t(ae),$(Gn),$(fo),$(Mn),$(go),$(qn),$(Cn),o&&t(Zr),o&&t(Ot),$(zn),o&&t(ei),o&&t(Ee),$(An),$(To),$(Sn),$(yo),$(Dn),$(On),o&&t(ti),o&&t(Bt),$(Un),o&&t(oi),o&&t(be),$(Wn),$(Yn),$(ko),$(Zn),o&&t(ni),o&&t(Ht),$(es),o&&t(si),o&&t(Pe),$(ts),$(ds),$(bo),$(cs)}}}const vg={local:"gptj",sections:[{local:"overview",sections:[{local:"generation",title:"Generation"}],title:"Overview"},{local:"transformers.GPTJConfig",title:"GPTJConfig"},{local:"transformers.GPTJModel",title:"GPTJModel"},{local:"transformers.GPTJForCausalLM",title:"GPTJForCausalLM"},{local:"transformers.GPTJForSequenceClassification",title:"GPTJForSequenceClassification"},{local:"transformers.GPTJForQuestionAnswering",title:"GPTJForQuestionAnswering"},{local:"transformers.TFGPTJModel",title:"TFGPTJModel"},{local:"transformers.TFGPTJForCausalLM",title:"TFGPTJForCausalLM"},{local:"transformers.TFGPTJForSequenceClassification",title:"TFGPTJForSequenceClassification"},{local:"transformers.TFGPTJForQuestionAnswering",title:"TFGPTJForQuestionAnswering"},{local:"transformers.FlaxGPTJModel",title:"FlaxGPTJModel"},{local:"transformers.FlaxGPTJForCausalLM",title:"FlaxGPTJForCausalLM"}],title:"GPT-J"};function kg(I){return sg(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class jg extends eg{constructor(p){super();tg(this,p,kg,yg,og,{})}}export{jg as default,vg as metadata};
