...
DeepSpeed docs.`),tw=u(),pa=o("p"),X7=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q7=a("Trainer"),ek=a(` provides
...
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),tw=c(e),pa=l(e,"P",{});var BE=r(pa);X7=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var gZ=r(Zi);Q7=n(gZ,"Trainer"),gZ.forEach(t),ek=n(BE,` provides
