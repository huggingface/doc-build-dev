import{S as ei,i as oi,s as ti,e as a,k as g,w as k,t as d,M as ni,c as i,d as t,m as _,a as l,x as $,h as c,b as u,G as e,g as b,y as w,q as v,o as T,B as N,v as si,L as D}from"../../chunks/vendor-hf-doc-builder.js";import{T as it}from"../../chunks/Tip-hf-doc-builder.js";import{D as L}from"../../chunks/Docstring-hf-doc-builder.js";import{C as W}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ue}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as I}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function ri(M){let s,f,r,m,y;return m=new W({props:{code:`from transformers import NystromformerModel, NystromformerConfig
...
`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function mi(M){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var F=l(r);m=c(F,"Module"),F.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function hi(M){let s,f,r,m,y;return m=new W({props:{code:`import torch
from transformers import AutoTokenizer, NystromformerForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function gi(M){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var F=l(r);m=c(F,"Module"),F.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),$(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||(v(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function ki(M){let s,f;return s=new W({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function $i(M){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var F=l(r);m=c(F,"Module"),F.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){b(n,s,p),e(s,f),e(s,r),e(r,m),e(s,y)},d(n){n&&t(s)}}}function wi(M){let s,f,r,m,y;return m=new W({props:{code:`from transformers import AutoTokenizer, NystromformerForQuestionAnswering
import torch
...
`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),$(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||(v(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function vi(M){let s,f;return s=new W({props:{code:`# target is "nice puppet"
...
<p>A <a
  href="/docs/transformers/pr_17897/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPastAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17897/en/model_doc/nystromformer#transformers.NystromformerConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17897/src/transformers/models/nystromformer/modeling_nystromformer.py#L680",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17897/src/transformers/models/nystromformer/modeling_nystromformer.py#L778",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17897/src/transformers/models/nystromformer/modeling_nystromformer.py#L873",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17897/src/transformers/models/nystromformer/modeling_nystromformer.py#L970",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17897/src/transformers/models/nystromformer/modeling_nystromformer.py#L1050",returnDescription:`
<p>A <a
...
`}}),We=new it({props:{$$slots:{default:[$i]},$$scope:{ctx:M}}}),Qe=new I({props:{anchor:"transformers.NystromformerForQuestionAnswering.forward.example",$$slots:{default:[wi]},$$scope:{ctx:M}}}),Be=new I({props:{anchor:"transformers.NystromformerForQuestionAnswering.forward.example-2",$$slots:{default:[vi]},$$scope:{ctx:M}}}),{c(){s=a("meta"),f=g(),r=a("h1"),m=a("a"),y=a("span"),k(n.$$.fragment),p=g(),F=a("span"),zn=d("Nystr\xF6mformer"),Zt=g(),Y=a("h2"),ge=a("a"),lt=a("span"),k(Je.$$.fragment),jn=g(),dt=a("span"),Cn=d("Overview"),Xt=g(),_e=a("p"),An=d("The Nystr\xF6mformer model was proposed in "),Ze=a("a"),ct=a("em"),En=d("Nystr\xF6mformer: A Nystr\xF6m-Based Algorithm for Approximating Self-Attention"),Pn=d(` by Yunyang Xiong, Zhanpeng Zeng, Rudrasis Chakraborty, Mingxing Tan, Glenn
...
behavior.`),cs=g(),Q=a("div"),k(lo.$$.fragment),ms=g(),oe=a("p"),ps=d("The "),Bo=a("a"),fs=d("NystromformerModel"),hs=d(" forward method, overrides the "),gt=a("code"),us=d("__call__"),gs=d(" special method."),_s=g(),k($e.$$.fragment),ys=g(),k(we.$$.fragment),ln=g(),te=a("h2"),ve=a("a"),_t=a("span"),k(co.$$.fragment),bs=g(),yt=a("span"),ks=d("NystromformerForMaskedLM"),dn=g(),U=a("div"),k(mo.$$.fragment),$s=g(),ne=a("p"),ws=d("Nystr\xF6mformer Model with a "),bt=a("code"),vs=d("language modeling"),Ts=d(` head on top.
This model is a PyTorch `),po=a("a"),Ns=d("torch.nn.Module"),Ms=d(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fs=g(),q=a("div"),k(fo.$$.fragment),xs=g(),se=a("p"),qs=d("The "),Ho=a("a"),zs=d("NystromformerForMaskedLM"),js=d(" forward method, overrides the "),kt=a("code"),Cs=d("__call__"),As=d(" special method."),Es=g(),k(Te.$$.fragment),Ps=g(),k(Ne.$$.fragment),Os=g(),k(Me.$$.fragment),cn=g(),re=a("h2"),Fe=a("a"),$t=a("span"),k(ho.$$.fragment),Ss=g(),wt=a("span"),Ls=d("NystromformerForSequenceClassification"),mn=g(),E=a("div"),k(uo.$$.fragment),Is=g(),vt=a("p"),Ds=d(`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),mr=g(),B=a("div"),k(vo.$$.fragment),pr=g(),le=a("p"),fr=d("The "),Ro=a("a"),hr=d("NystromformerForMultipleChoice"),ur=d(" forward method, overrides the "),xt=a("code"),gr=d("__call__"),_r=d(" special method."),yr=g(),k(Ee.$$.fragment),br=g(),k(Pe.$$.fragment),hn=g(),de=a("h2"),Oe=a("a"),qt=a("span"),k(To.$$.fragment),kr=g(),zt=a("span"),$r=d("NystromformerForTokenClassification"),un=g(),O=a("div"),k(No.$$.fragment),wr=g(),jt=a("p"),vr=d(`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Yr=g(),j=a("div"),k(Ao.$$.fragment),Jr=g(),fe=a("p"),Zr=d("The "),Go=a("a"),Xr=d("NystromformerForQuestionAnswering"),ea=d(" forward method, overrides the "),St=a("code"),oa=d("__call__"),ta=d(" special method."),na=g(),k(We.$$.fragment),sa=g(),k(Qe.$$.fragment),ra=g(),k(Be.$$.fragment),this.h()},l(o){const h=ni('[data-svelte="svelte-1phssyn"]',document.head);s=i(h,"META",{name:!0,content:!0}),h.forEach(t),f=_(o),r=i(o,"H1",{class:!0});var Eo=l(r);m=i(Eo,"A",{id:!0,class:!0,href:!0});var Lt=l(m);y=i(Lt,"SPAN",{});var It=l(y);$(n.$$.fragment,It),It.forEach(t),Lt.forEach(t),p=_(Eo),F=i(Eo,"SPAN",{});var Dt=l(F);zn=c(Dt,"Nystr\xF6mformer"),Dt.forEach(t),Eo.forEach(t),Zt=_(o),Y=i(o,"H2",{class:!0});var Po=l(Y);ge=i(Po,"A",{id:!0,class:!0,href:!0});var Wt=l(ge);lt=i(Wt,"SPAN",{});var Qt=l(lt);$(Je.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),jn=_(Po),dt=i(Po,"SPAN",{});var Bt=l(dt);Cn=c(Bt,"Overview"),Bt.forEach(t),Po.forEach(t),Xt=_(o),_e=i(o,"P",{});var Oo=l(_e);An=c(Oo,"The Nystr\xF6mformer model was proposed in "),Ze=i(Oo,"A",{href:!0,rel:!0});var Ht=l(Ze);ct=i(Ht,"EM",{});var Ut=l(ct);En=c(Ut,"Nystr\xF6mformer: A Nystr\xF6m-Based Algorithm for Approximating Self-Attention"),Ut.forEach(t),Ht.forEach(t),Pn=c(Oo,` by Yunyang Xiong, Zhanpeng Zeng, Rudrasis Chakraborty, Mingxing Tan, Glenn
...
sequence length, and find that our Nystr\xF6mformer performs comparably, or in a few cases, even slightly better, than
standard self-attention. On longer sequence tasks in the Long Range Arena (LRA) benchmark, Nystr\xF6mformer performs
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),Gt.forEach(t),Vt.forEach(t),tn=_(o),R=i(o,"P",{});var he=l(R);Ln=c(he,"This model was contributed by "),Xe=i(he,"A",{href:!0,rel:!0});var Kt=l(Xe);In=c(Kt,"novice03"),Kt.forEach(t),Dn=c(he,". The original code can be found "),eo=i(he,"A",{href:!0,rel:!0});var Yt=l(eo);Wn=c(Yt,"here"),Yt.forEach(t),Qn=c(he,"."),he.forEach(t),nn=_(o),J=i(o,"H2",{class:!0});var So=l(J);ye=i(So,"A",{id:!0,class:!0,href:!0});var Jt=l(ye);pt=i(Jt,"SPAN",{});var aa=l(pt);$(oo.$$.fragment,aa),aa.forEach(t),Jt.forEach(t),Bn=_(So),ft=i(So,"SPAN",{});var ia=l(ft);Hn=c(ia,"NystromformerConfig"),ia.forEach(t),So.forEach(t),sn=_(o),A=i(o,"DIV",{class:!0});var He=l(A);$(to.$$.fragment,He),Un=_(He),Z=i(He,"P",{});var Ko=l(Z);Rn=c(Ko,"This is the configuration class to store the configuration of a "),Do=i(Ko,"A",{href:!0});var la=l(Do);Vn=c(la,"NystromformerModel"),la.forEach(t),Gn=c(Ko,`. It is used to instantiate
an Nystromformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Nystromformer
...
documentation from `),Qo=i(Yo,"A",{href:!0});var ma=l(Qo);os=c(ma,"PretrainedConfig"),ma.forEach(t),ts=c(Yo," for more information."),Yo.forEach(t),ns=_(He),$(be.$$.fragment,He),He.forEach(t),rn=_(o),ee=i(o,"H2",{class:!0});var bn=l(ee);ke=i(bn,"A",{id:!0,class:!0,href:!0});var pa=l(ke);ht=i(pa,"SPAN",{});var fa=l(ht);$(so.$$.fragment,fa),fa.forEach(t),pa.forEach(t),ss=_(bn),ut=i(bn,"SPAN",{});var ha=l(ut);rs=c(ha,"NystromformerModel"),ha.forEach(t),bn.forEach(t),an=_(o),H=i(o,"DIV",{class:!0});var Jo=l(H);$(ro.$$.fragment,Jo),as=_(Jo),ao=i(Jo,"P",{});var kn=l(ao);is=c(kn,`The bare Nystr\xF6mformer Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),io=i(kn,"A",{href:!0,rel:!0});var ua=l(io);ls=c(ua,"torch.nn.Module"),ua.forEach(t),ds=c(kn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kn.forEach(t),cs=_(Jo),Q=i(Jo,"DIV",{class:!0});var Ue=l(Q);$(lo.$$.fragment,Ue),ms=_(Ue),oe=i(Ue,"P",{});var Zo=l(oe);ps=c(Zo,"The "),Bo=i(Zo,"A",{href:!0});var ga=l(Bo);fs=c(ga,"NystromformerModel"),ga.forEach(t),hs=c(Zo," forward method, overrides the "),gt=i(Zo,"CODE",{});var _a=l(gt);us=c(_a,"__call__"),_a.forEach(t),gs=c(Zo," special method."),Zo.forEach(t),_s=_(Ue),$($e.$$.fragment,Ue),ys=_(Ue),$(we.$$.fragment,Ue),Ue.forEach(t),Jo.forEach(t),ln=_(o),te=i(o,"H2",{class:!0});var $n=l(te);ve=i($n,"A",{id:!0,class:!0,href:!0});var ya=l(ve);_t=i(ya,"SPAN",{});var ba=l(_t);$(co.$$.fragment,ba),ba.forEach(t),ya.forEach(t),bs=_($n),yt=i($n,"SPAN",{});var ka=l(yt);ks=c(ka,"NystromformerForMaskedLM"),ka.forEach(t),$n.forEach(t),dn=_(o),U=i(o,"DIV",{class:!0});var Xo=l(U);$(mo.$$.fragment,Xo),$s=_(Xo),ne=i(Xo,"P",{});var et=l(ne);ws=c(et,"Nystr\xF6mformer Model with a "),bt=i(et,"CODE",{});var $a=l(bt);vs=c($a,"language modeling"),$a.forEach(t),Ts=c(et,` head on top.
This model is a PyTorch `),po=i(et,"A",{href:!0,rel:!0});var wa=l(po);Ns=c(wa,"torch.nn.Module"),wa.forEach(t),Ms=c(et,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),et.forEach(t),Fs=_(Xo),q=i(Xo,"DIV",{class:!0});var V=l(q);$(fo.$$.fragment,V),xs=_(V),se=i(V,"P",{});var ot=l(se);qs=c(ot,"The "),Ho=i(ot,"A",{href:!0});var va=l(Ho);zs=c(va,"NystromformerForMaskedLM"),va.forEach(t),js=c(ot," forward method, overrides the "),kt=i(ot,"CODE",{});var Ta=l(kt);Cs=c(Ta,"__call__"),Ta.forEach(t),As=c(ot," special method."),ot.forEach(t),Es=_(V),$(Te.$$.fragment,V),Ps=_(V),$(Ne.$$.fragment,V),Os=_(V),$(Me.$$.fragment,V),V.forEach(t),Xo.forEach(t),cn=_(o),re=i(o,"H2",{class:!0});var wn=l(re);Fe=i(wn,"A",{id:!0,class:!0,href:!0});var Na=l(Fe);$t=i(Na,"SPAN",{});var Ma=l($t);$(ho.$$.fragment,Ma),Ma.forEach(t),Na.forEach(t),Ss=_(wn),wt=i(wn,"SPAN",{});var Fa=l(wt);Ls=c(Fa,"NystromformerForSequenceClassification"),Fa.forEach(t),wn.forEach(t),mn=_(o),E=i(o,"DIV",{class:!0});var Re=l(E);$(uo.$$.fragment,Re),Is=_(Re),vt=i(Re,"P",{});var xa=l(vt);Ds=c(xa,`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),xa.forEach(t),Ws=_(Re),go=i(Re,"P",{});var vn=l(go);Qs=c(vn,"This model is a PyTorch "),_o=i(vn,"A",{href:!0,rel:!0});var qa=l(_o);Bs=c(qa,"torch.nn.Module"),qa.forEach(t),Hs=c(vn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vn.forEach(t),Us=_(Re),x=i(Re,"DIV",{class:!0});var C=l(x);$(yo.$$.fragment,C),Rs=_(C),ae=i(C,"P",{});var tt=l(ae);Vs=c(tt,"The "),Uo=i(tt,"A",{href:!0});var za=l(Uo);Gs=c(za,"NystromformerForSequenceClassification"),za.forEach(t),Ks=c(tt," forward method, overrides the "),Tt=i(tt,"CODE",{});var ja=l(Tt);Ys=c(ja,"__call__"),ja.forEach(t),Js=c(tt," special method."),tt.forEach(t),Zs=_(C),$(xe.$$.fragment,C),Xs=_(C),$(qe.$$.fragment,C),er=_(C),$(ze.$$.fragment,C),or=_(C),$(je.$$.fragment,C),tr=_(C),$(Ce.$$.fragment,C),C.forEach(t),Re.forEach(t),pn=_(o),ie=i(o,"H2",{class:!0});var Tn=l(ie);Ae=i(Tn,"A",{id:!0,class:!0,href:!0});var Ca=l(Ae);Nt=i(Ca,"SPAN",{});var Aa=l(Nt);$(bo.$$.fragment,Aa),Aa.forEach(t),Ca.forEach(t),nr=_(Tn),Mt=i(Tn,"SPAN",{});var Ea=l(Mt);sr=c(Ea,"NystromformerForMultipleChoice"),Ea.forEach(t),Tn.forEach(t),fn=_(o),P=i(o,"DIV",{class:!0});var Ve=l(P);$(ko.$$.fragment,Ve),rr=_(Ve),Ft=i(Ve,"P",{});var Pa=l(Ft);ar=c(Pa,`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
and a softmax) e.g. for RocStories/SWAG tasks.`),Pa.forEach(t),ir=_(Ve),$o=i(Ve,"P",{});var Nn=l($o);lr=c(Nn,"This model is a PyTorch "),wo=i(Nn,"A",{href:!0,rel:!0});var Oa=l(wo);dr=c(Oa,"torch.nn.Module"),Oa.forEach(t),cr=c(Nn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Nn.forEach(t),mr=_(Ve),B=i(Ve,"DIV",{class:!0});var Ge=l(B);$(vo.$$.fragment,Ge),pr=_(Ge),le=i(Ge,"P",{});var nt=l(le);fr=c(nt,"The "),Ro=i(nt,"A",{href:!0});var Sa=l(Ro);hr=c(Sa,"NystromformerForMultipleChoice"),Sa.forEach(t),ur=c(nt," forward method, overrides the "),xt=i(nt,"CODE",{});var La=l(xt);gr=c(La,"__call__"),La.forEach(t),_r=c(nt," special method."),nt.forEach(t),yr=_(Ge),$(Ee.$$.fragment,Ge),br=_(Ge),$(Pe.$$.fragment,Ge),Ge.forEach(t),Ve.forEach(t),hn=_(o),de=i(o,"H2",{class:!0});var Mn=l(de);Oe=i(Mn,"A",{id:!0,class:!0,href:!0});var Ia=l(Oe);qt=i(Ia,"SPAN",{});var Da=l(qt);$(To.$$.fragment,Da),Da.forEach(t),Ia.forEach(t),kr=_(Mn),zt=i(Mn,"SPAN",{});var Wa=l(zt);$r=c(Wa,"NystromformerForTokenClassification"),Wa.forEach(t),Mn.forEach(t),un=_(o),O=i(o,"DIV",{class:!0});var Ke=l(O);$(No.$$.fragment,Ke),wr=_(Ke),jt=i(Ke,"P",{});var Qa=l(jt);vr=c(Qa,`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fn.forEach(t),xr=_(Ke),z=i(Ke,"DIV",{class:!0});var G=l(z);$(xo.$$.fragment,G),qr=_(G),ce=i(G,"P",{});var st=l(ce);zr=c(st,"The "),Vo=i(st,"A",{href:!0});var Ha=l(Vo);jr=c(Ha,"NystromformerForTokenClassification"),Ha.forEach(t),Cr=c(st," forward method, overrides the "),Ct=i(st,"CODE",{});var Ua=l(Ct);Ar=c(Ua,"__call__"),Ua.forEach(t),Er=c(st," special method."),st.forEach(t),Pr=_(G),$(Se.$$.fragment,G),Or=_(G),$(Le.$$.fragment,G),Sr=_(G),$(Ie.$$.fragment,G),G.forEach(t),Ke.forEach(t),gn=_(o),me=i(o,"H2",{class:!0});var xn=l(me);De=i(xn,"A",{id:!0,class:!0,href:!0});var Ra=l(De);At=i(Ra,"SPAN",{});var Va=l(At);$(qo.$$.fragment,Va),Va.forEach(t),Ra.forEach(t),Lr=_(xn),Et=i(xn,"SPAN",{});var Ga=l(Et);Ir=c(Ga,"NystromformerForQuestionAnswering"),Ga.forEach(t),xn.forEach(t),_n=_(o),S=i(o,"DIV",{class:!0});var Ye=l(S);$(zo.$$.fragment,Ye),Dr=_(Ye),pe=i(Ye,"P",{});var rt=l(pe);Wr=c(rt,`Nystr\xF6mformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
