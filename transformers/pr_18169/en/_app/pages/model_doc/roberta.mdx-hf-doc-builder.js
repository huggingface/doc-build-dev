...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18169/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18169/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_18169/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18169/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18169/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18169/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18169/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18169/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Q1=p(),dt=n("div"),T(Cr.$$.fragment),J1=p(),Lo=n("p"),V1=r("The "),bd=n("a"),K1=r("RobertaForQuestionAnswering"),G1=r(" forward method, overrides the "),pp=n("code"),X1=r("__call__"),Y1=r(" special method."),Z1=p(),T(Zn.$$.fragment),ev=p(),T(es.$$.fragment),tv=p(),T(ts.$$.fragment),hf=p(),Ao=n("h2"),os=n("a"),hp=n("span"),T(jr.$$.fragment),ov=p(),mp=n("span"),nv=r("TFRobertaModel"),mf=p(),Qe=n("div"),T(Pr.$$.fragment),sv=p(),fp=n("p"),av=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),rv=p(),Lr=n("p"),iv=r("This model inherits from "),kd=n("a"),lv=r("TFPreTrainedModel"),dv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cv=p(),Ar=n("p"),pv=r("This model is also a "),Or=n("a"),hv=r("tf.keras.Model"),mv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fv=p(),T(ns.$$.fragment),uv=p(),Rt=n("div"),T(Nr.$$.fragment),gv=p(),Oo=n("p"),_v=r("The "),vd=n("a"),bv=r("TFRobertaModel"),kv=r(" forward method, overrides the "),up=n("code"),vv=r("__call__"),Tv=r(" special method."),yv=p(),T(ss.$$.fragment),wv=p(),T(as.$$.fragment),ff=p(),No=n("h2"),rs=n("a"),gp=n("span"),T(Ir.$$.fragment),$v=p(),_p=n("span"),Fv=r("TFRobertaForCausalLM"),uf=p(),Io=n("div"),T(Dr.$$.fragment),xv=p(),Mt=n("div"),T(Sr.$$.fragment),Rv=p(),Do=n("p"),Mv=r("The "),Td=n("a"),Ev=r("TFRobertaForCausalLM"),zv=r(" forward method, overrides the "),bp=n("code"),qv=r("__call__"),Cv=r(" special method."),jv=p(),T(is.$$.fragment),Pv=p(),T(ls.$$.fragment),gf=p(),So=n("h2"),ds=n("a"),kp=n("span"),T(Wr.$$.fragment),Lv=p(),vp=n("span"),Av=r("TFRobertaForMaskedLM"),_f=p(),Je=n("div"),T(Br.$$.fragment),Ov=p(),Ur=n("p"),Nv=r("RoBERTa Model with a "),Tp=n("code"),Iv=r("language modeling"),Dv=r(" head on top."),Sv=p(),Hr=n("p"),Wv=r("This model inherits from "),yd=n("a"),Bv=r("TFPreTrainedModel"),Uv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),e1=h(oa),zo=s(oa,"P",{});var Qd=a(zo);t1=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var sx=a(fd);o1=i(sx,"RobertaForMultipleChoice"),sx.forEach(t),n1=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var ax=a(op);s1=i(ax,"__call__"),ax.forEach(t),a1=i(Qd," special method."),Qd.forEach(t),r1=h(oa),y(Qn.$$.fragment,oa),i1=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cu=a(qo);Vn=s(cu,"A",{id:!0,class:!0,href:!0});var rx=a(Vn);np=s(rx,"SPAN",{});var ix=a(np);y(Tr.$$.fragment,ix),ix.forEach(t),rx.forEach(t),l1=h(cu),sp=s(cu,"SPAN",{});var lx=a(sp);d1=i(lx,"RobertaForTokenClassification"),lx.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),c1=h(io),ap=s(io,"P",{});var dx=a(ap);p1=i(dx,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),v1=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),T1=h(lo),Co=s(lo,"P",{});var Jd=a(Co);y1=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var hx=a(gd);w1=i(hx,"RobertaForTokenClassification"),hx.forEach(t),$1=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var mx=a(rp);F1=i(mx,"__call__"),mx.forEach(t),x1=i(Jd," special method."),Jd.forEach(t),R1=h(lo),y(Kn.$$.fragment,lo),M1=h(lo),y(Gn.$$.fragment,lo),E1=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var fx=a(Yn);ip=s(fx,"SPAN",{});var ux=a(ip);y(Rr.$$.fragment,ux),ux.forEach(t),fx.forEach(t),z1=h(mu),lp=s(mu,"SPAN",{});var gx=a(lp);q1=i(gx,"RobertaForQuestionAnswering"),gx.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),C1=h(co),Po=s(co,"P",{});var Vd=a(Po);j1=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Q1=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),J1=h(po),Lo=s(po,"P",{});var Kd=a(Lo);V1=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var Tx=a(bd);K1=i(Tx,"RobertaForQuestionAnswering"),Tx.forEach(t),G1=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var yx=a(pp);X1=i(yx,"__call__"),yx.forEach(t),Y1=i(Kd," special method."),Kd.forEach(t),Z1=h(po),y(Zn.$$.fragment,po),ev=h(po),y(es.$$.fragment,po),tv=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var wx=a(os);hp=s(wx,"SPAN",{});var $x=a(hp);y(jr.$$.fragment,$x),$x.forEach(t),wx.forEach(t),ov=h(gu),mp=s(gu,"SPAN",{});var Fx=a(mp);nv=i(Fx,"TFRobertaModel"),Fx.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sv=h(Ot),fp=s(Ot,"P",{});var xx=a(fp);av=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),rv=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iv=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var Rx=a(kd);lv=i(Rx,"TFPreTrainedModel"),Rx.forEach(t),dv=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fv=h(Ot),y(ns.$$.fragment,Ot),uv=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gv=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_v=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var Ex=a(vd);bv=i(Ex,"TFRobertaModel"),Ex.forEach(t),kv=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var zx=a(up);vv=i(zx,"__call__"),zx.forEach(t),Tv=i(Gd," special method."),Gd.forEach(t),yv=h(na),y(ss.$$.fragment,na),wv=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var qx=a(rs);gp=s(qx,"SPAN",{});var Cx=a(gp);y(Ir.$$.fragment,Cx),Cx.forEach(t),qx.forEach(t),$v=h(ku),_p=s(ku,"SPAN",{});var jx=a(_p);Fv=i(jx,"TFRobertaForCausalLM"),jx.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);y(Dr.$$.fragment,vu),xv=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),Rv=h(sa),Do=s(sa,"P",{});var Xd=a(Do);Mv=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var Px=a(Td);Ev=i(Px,"TFRobertaForCausalLM"),Px.forEach(t),zv=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var Lx=a(bp);qv=i(Lx,"__call__"),Lx.forEach(t),Cv=i(Xd," special method."),Xd.forEach(t),jv=h(sa),y(is.$$.fragment,sa),Pv=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tu=a(So);ds=s(Tu,"A",{id:!0,class:!0,href:!0});var Ax=a(ds);kp=s(Ax,"SPAN",{});var Ox=a(kp);y(Wr.$$.fragment,Ox),Ox.forEach(t),Ax.forEach(t),Lv=h(Tu),vp=s(Tu,"SPAN",{});var Nx=a(vp);Av=i(Nx,"TFRobertaForMaskedLM"),Nx.forEach(t),Tu.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),Ov=h(Nt),Ur=s(Nt,"P",{});var yu=a(Ur);Nv=i(yu,"RoBERTa Model with a "),Tp=s(yu,"CODE",{});var Ix=a(Tp);Iv=i(Ix,"language modeling"),Ix.forEach(t),Dv=i(yu," head on top."),yu.forEach(t),Sv=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);Wv=i(wu,"This model inherits from "),yd=s(wu,"A",{href:!0});var Dx=a(yd);Bv=i(Dx,"TFPreTrainedModel"),Dx.forEach(t),Uv=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),y(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);yT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),y(gs.$$.fragment,mo),RT=h(mo),y(_s.$$.fragment,mo),MT=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);y(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var eR=a(Mp);zT=i(eR,"TFRobertaForMultipleChoice"),eR.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var tR=a(Ep);CT=i(tR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sR=a(Rd);HT=i(sR,"TFRobertaForMultipleChoice"),sR.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var aR=a(zp);JT=i(aR,"__call__"),aR.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var rR=a(ws);qp=s(rR,"SPAN",{});var iR=a(qp);y(ii.$$.fragment,iR),iR.forEach(t),rR.forEach(t),XT=h(qu),Cp=s(qu,"SPAN",{});var lR=a(Cp);YT=i(lR,"TFRobertaForTokenClassification"),lR.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var dR=a(jp);ey=i(dR,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dR.forEach(t),ty=h(St),di=s(St,"P",{});var Cu=a(di);oy=i(Cu,"This model inherits from "),Md=s(Cu,"A",{href:!0});var cR=a(Md);ny=i(cR,"TFPreTrainedModel"),cR.forEach(t),sy=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),ay=h(St),ci=s(St,"P",{});var ju=a(ci);ry=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var pR=a(pi);iy=i(pR,"tf.keras.Model"),pR.forEach(t),ly=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),py=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hR=a(Ed);my=i(hR,"TFRobertaForTokenClassification"),hR.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mR=a(Pp);uy=i(mR,"__call__"),mR.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),y(Fs.$$.fragment,fo),by=h(fo),y(xs.$$.fragment,fo),ky=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fR=a(Ms);Lp=s(fR,"SPAN",{});var uR=a(Lp);y(mi.$$.fragment,uR),uR.forEach(t),fR.forEach(t),vy=h(Pu),Ap=s(Pu,"SPAN",{});var gR=a(Ap);Ty=i(gR,"TFRobertaForQuestionAnswering"),gR.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _R=a(Op);$y=i(_R,"span start logits"),_R.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var bR=a(Np);xy=i(bR,"span end logits"),bR.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ey=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var kR=a(zd);zy=i(kR,"TFPreTrainedModel"),kR.forEach(t),qy=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),Cy=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jy=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var vR=a(_i);Py=i(vR,"tf.keras.Model"),vR.forEach(t),Ly=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),qd=s(nc,"A",{href:!0});var TR=a(qd);Dy=i(TR,"TFRobertaForQuestionAnswering"),TR.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yR=a(Ip);Wy=i(yR,"__call__"),yR.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),y(zs.$$.fragment,uo),Hy=h(uo),y(qs.$$.fragment,uo),Qy=h(uo),y(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wR=a(js);Dp=s(wR,"SPAN",{});var $R=a(Dp);y(ki.$$.fragment,$R),$R.forEach(t),wR.forEach(t),Jy=h(Ou),Sp=s(Ou,"SPAN",{});var FR=a(Sp);Vy=i(FR,"FlaxRobertaModel"),FR.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var xR=a(Wp);Gy=i(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yy=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var RR=a(Cd);Zy=i(RR,"FlaxPreTrainedModel"),RR.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),tw=h(gt),yi=s(gt,"P",{});var Iu=a(yi);ow=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var MR=a(wi);nw=i(MR,"flax.linen.Module"),MR.forEach(t),sw=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),aw=h(gt),Bp=s(gt,"P",{});var ER=a(Bp);rw=i(ER,"Finally, this model supports inherent JAX features such as:"),ER.forEach(t),iw=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zR=a(Up);$i=s(zR,"A",{href:!0,rel:!0});var qR=a($i);lw=i(qR,"Just-In-Time (JIT) compilation"),qR.forEach(t),zR.forEach(t),dw=h(ra),Hp=s(ra,"LI",{});var CR=a(Hp);Fi=s(CR,"A",{href:!0,rel:!0});var jR=a(Fi);cw=i(jR,"Automatic Differentiation"),jR.forEach(t),CR.forEach(t),pw=h(ra),Qp=s(ra,"LI",{});var PR=a(Qp);xi=s(PR,"A",{href:!0,rel:!0});var LR=a(xi);hw=i(LR,"Vectorization"),LR.forEach(t),PR.forEach(t),mw=h(ra),Jp=s(ra,"LI",{});var AR=a(Jp);Ri=s(AR,"A",{href:!0,rel:!0});var OR=a(Ri);fw=i(OR,"Parallelization"),OR.forEach(t),AR.forEach(t),ra.forEach(t),uw=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),gw=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_w=i(sc,"The "),Vp=s(sc,"CODE",{});var NR=a(Vp);bw=i(NR,"FlaxRobertaPreTrainedModel"),NR.forEach(t),kw=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var IR=a(Kp);vw=i(IR,"__call__"),IR.forEach(t),Tw=i(sc," special method."),sc.forEach(t),yw=h(ia),y(Ps.$$.fragment,ia),ww=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var DR=a(As);Gp=s(DR,"SPAN",{});var SR=a(Gp);y(Ei.$$.fragment,SR),SR.forEach(t),DR.forEach(t),$w=h(Du),Xp=s(Du,"SPAN",{});var WR=a(Xp);Fw=i(WR,"FlaxRobertaForCausalLM"),WR.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),xw=h(_t),Yp=s(_t,"P",{});var BR=a(Yp);Rw=i(BR,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
