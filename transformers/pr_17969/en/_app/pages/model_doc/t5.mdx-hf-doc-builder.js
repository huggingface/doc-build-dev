import{S as q5,i as F5,s as M5,e as a,k as d,w as k,t as o,M as C5,c as r,d as t,m as c,a as i,x as v,h as s,b as h,G as e,g as m,y,q as w,o as $,B as x,v as P5,L as Te}from"../../chunks/vendor-hf-doc-builder.js";import{T as kt}from"../../chunks/Tip-hf-doc-builder.js";import{D as M}from"../../chunks/Docstring-hf-doc-builder.js";import{C as S}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as _e}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ge}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function N5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){m(l,p,_),e(p,b),e(p,g),e(g,u),e(p,T)},d(l){l&&t(p)}}}function O5(j){let p,b,g,u,T;return u=new S({props:{code:`from transformers import T5Tokenizer, T5Model
...
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),{c(){p=a("p"),b=o("Example:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Example:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function I5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){m(l,p,_),e(p,b),e(p,g),e(g,u),e(p,T)},d(l){l&&t(p)}}}function D5(j){let p,b,g,u,T;return u=new S({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
model.parallelize(device_map)`}}),{c(){p=a("p"),b=o("Example:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Example:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function G5(j){let p,b,g,u,T;return u=new S({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)  <span class="hljs-comment"># Splits the model across several devices</span>
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),{c(){p=a("p"),b=o("Example:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Example:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function U5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){m(l,p,_),e(p,b),e(p,g),e(g,u),e(p,T)},d(l){l&&t(p)}}}function B5(j){let p,b,g,u,T;return u=new S({props:{code:`from transformers import T5Tokenizer, T5EncoderModel
...
model.parallelize(device_map)  <span class="hljs-comment"># Splits the model across several devices</span>
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),{c(){p=a("p"),b=o("Example:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Example:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function H5(j){let p,b,g,u,T,l,_,E,Ee,se,q,ee,G,ae,qe,U,Fe,ve,B,A,re,pe,C,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,be,O,Pe,ke,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),E=a("li"),Ee=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),q=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),qe=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),C=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
tensors in the first argument of the model call function: `),U=r(D,"CODE",{});var ne=i(U);Fe=s(ne,"model(inputs)"),ne.forEach(t),ve=s(D,"."),D.forEach(t),B=c(z),A=r(z,"P",{});var tt=i(A);re=s(tt,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),tt.forEach(t),pe=c(z),C=r(z,"UL",{});var L=i(C);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,E),e(E,Ee),m(z,se,F),m(z,q,F),e(q,ee),e(q,G),e(G,ae),e(q,qe),e(q,U),e(U,Fe),e(q,ve),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,C,F),e(C,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(C,we),e(C,P),e(P,Ce),e(P,H),e(H,V),e(P,be),e(P,O),e(O,Pe),e(C,ke),e(C,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(q),z&&t(B),z&&t(A),z&&t(pe),z&&t(C)}}}function V5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){m(l,p,_),e(p,b),e(p,g),e(g,u),e(p,T)},d(l){l&&t(p)}}}function K5(j){let p,b,g,u,T;return u=new S({props:{code:`from transformers import T5Tokenizer, TFT5Model
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function Y5(j){let p,b,g,u,T,l,_,E,Ee,se,q,ee,G,ae,qe,U,Fe,ve,B,A,re,pe,C,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,be,O,Pe,ke,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),E=a("li"),Ee=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),q=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),qe=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),C=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),be=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),ke=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),E=r(te,"LI",{});var et=i(E);Ee=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),q=r(z,"P",{});var D=i(q);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),qe=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),C=r(z,"UL",{});var L=i(C);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),be=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),ke=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,E),e(E,Ee),m(z,se,F),m(z,q,F),e(q,ee),e(q,G),e(G,ae),e(q,qe),e(q,U),e(U,Fe),e(q,ve),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,C,F),e(C,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(C,we),e(C,P),e(P,Ce),e(P,H),e(H,V),e(P,be),e(P,O),e(O,Pe),e(C,ke),e(C,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(q),z&&t(B),z&&t(A),z&&t(pe),z&&t(C)}}}function Z5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){m(l,p,_),e(p,b),e(p,g),e(g,u),e(p,T)},d(l){l&&t(p)}}}function J5(j){let p,b,g,u,T;return u=new S({props:{code:`from transformers import T5Tokenizer, TFT5ForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function X5(j){let p,b,g,u,T,l,_,E,Ee,se,q,ee,G,ae,qe,U,Fe,ve,B,A,re,pe,C,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,be,O,Pe,ke,I,Ne,R,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),E=a("li"),Ee=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),q=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),qe=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),C=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),be=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),ke=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),E=r(te,"LI",{});var et=i(E);Ee=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),q=r(z,"P",{});var D=i(q);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),qe=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),C=r(z,"UL",{});var L=i(C);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),be=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),ke=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,E),e(E,Ee),m(z,se,F),m(z,q,F),e(q,ee),e(q,G),e(G,ae),e(q,qe),e(q,U),e(U,Fe),e(q,ve),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,C,F),e(C,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(C,we),e(C,P),e(P,Ce),e(P,H),e(H,V),e(P,be),e(P,O),e(O,Pe),e(C,ke),e(C,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(q),z&&t(B),z&&t(A),z&&t(pe),z&&t(C)}}}function Q5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(l,_){m(l,p,_),e(p,b),e(p,g),e(g,u),e(p,T)},d(l){l&&t(p)}}}function cw(j){let p,b,g,u,T,l,_,E,Ee,se,q,ee,G,ae,qe,U,Fe,ve,B,A,re,pe,C,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,be,O,Pe,ke,I,Ne,R,Oe,z,F,te,Ge,et,D,Ue,ne,tt,L,Y,nt,Le,Z,ot,Ae,Ie,st,Xd,or,hh,Qd,Be,Ti,bi,Do,uh,mh,ki,vi,So,fh,_h,yi,wi,Go,gh,Th,$i,xi,Uo,bh,kh,zi,sr,Bo,vh,yh,ec,ar,wh,tc,$t,ji,mn,Ei,$h,xh,rr,zh,jh,Eh,qi,fn,Fi,qh,Fh,ir,Mh,Ch,Ph,Mi,_n,Ci,Nh,Oh,lr,Lh,Ah,nc,gn,Ih,Wo,Dh,Sh,oc,xt,Gh,Ro,Uh,Bh,Ho,Wh,Rh,sc,dr,ac,Lt,Tn,Pi,Vo,Hh,Ni,Vh,rc,at,Kh,Oi,Yh,Zh,Li,Jh,Xh,Ai,Qh,eu,ic,bn,tu,cr,nu,ou,lc,pr,Ii,su,dc,me,au,Di,ru,iu,Si,lu,du,Gi,cu,pu,Ui,hu,uu,Bi,mu,fu,hr,_u,gu,cc,ur,Tu,pc,Ko,hc,kn,bu,Yo,ku,vu,uc,mr,Wi,yu,mc,fr,wu,fc,Zo,_c,oe,$u,Ri,xu,zu,Hi,ju,Eu,Vi,qu,Fu,Ki,Mu,Cu,Yi,Pu,Nu,Zi,Ou,Lu,Ji,Au,Iu,gc,zt,Du,Xi,Su,Gu,Qi,Uu,Bu,Tc,fe,Wu,el,Ru,Hu,tl,Vu,Ku,nl,Yu,Zu,ol,Ju,Xu,Jo,Qu,em,sl,tm,nm,bc,Xo,kc,_r,om,vc,gr,Qo,sm,al,am,rm,yc,jt,im,es,lm,dm,ts,cm,pm,wc,vn,hm,rl,um,mm,$c,Tr,xc,At,yn,il,ns,fm,ll,_m,zc,rt,gm,br,Tm,bm,os,km,vm,ss,ym,wm,jc,as,Ec,We,$m,dl,xm,zm,cl,jm,Em,kr,qm,Fm,pl,Mm,Cm,qc,vr,Pm,Fc,rs,Mc,yr,Nm,Cc,is,Pc,wr,Nc,It,wn,hl,ls,Om,ul,Lm,Oc,it,Am,ds,Im,Dm,ml,Sm,Gm,fl,Um,Bm,Lc,Dt,$n,_l,cs,Wm,gl,Rm,Ac,$r,Hm,Ic,xn,Tl,St,Vm,ps,Km,Ym,hs,Zm,Jm,Xm,bl,De,Qm,us,ef,tf,ms,nf,of,fs,sf,af,_s,rf,lf,gs,df,cf,Dc,Gt,zn,kl,Ts,pf,vl,hf,Sc,vt,bs,uf,yt,mf,xr,ff,_f,zr,gf,Tf,ks,bf,kf,vf,Ut,yf,jr,wf,$f,Er,xf,zf,Gc,Bt,jn,yl,vs,jf,wl,Ef,Uc,ie,ys,qf,ws,Ff,$s,Mf,Cf,Pf,xs,Nf,qr,Of,Lf,Af,Et,zs,If,$l,Df,Sf,js,Fr,Gf,xl,Uf,Bf,Mr,Wf,zl,Rf,Hf,En,Es,Vf,qs,Kf,jl,Yf,Zf,Jf,qn,Fs,Xf,El,Qf,e_,Cr,Ms,Bc,Wt,Fn,ql,Cs,t_,Fl,n_,Wc,Se,Ps,o_,Rt,s_,Ml,a_,r_,Ns,i_,l_,d_,Os,c_,Pr,p_,h_,u_,qt,Ls,m_,Cl,f_,__,As,Nr,g_,Pl,T_,b_,Or,k_,Nl,v_,y_,Mn,Is,w_,Ol,$_,Rc,Ht,Cn,Ll,Ds,x_,Al,z_,Hc,J,Ss,j_,Il,E_,q_,Gs,F_,Us,M_,C_,P_,Bs,N_,Lr,O_,L_,A_,Ws,I_,Rs,D_,S_,G_,lt,Hs,U_,Vt,B_,Ar,W_,R_,Dl,H_,V_,K_,Pn,Y_,Nn,Z_,dt,Vs,J_,Sl,X_,Q_,Gl,eg,tg,On,ng,Ft,Ks,og,Ul,sg,ag,Ln,Vc,Kt,An,Bl,Ys,rg,Wl,ig,Kc,X,Zs,lg,Js,dg,Rl,cg,pg,hg,Xs,ug,Qs,mg,fg,_g,ea,gg,Ir,Tg,bg,kg,ta,vg,na,yg,wg,$g,ct,oa,xg,Yt,zg,Dr,jg,Eg,Hl,qg,Fg,Mg,In,Cg,Dn,Pg,pt,sa,Ng,Vl,Og,Lg,Kl,Ag,Ig,Sn,Dg,Mt,aa,Sg,Yl,Gg,Ug,Gn,Yc,Zt,Un,Zl,ra,Bg,Jl,Wg,Zc,Q,ia,Rg,Xl,Hg,Vg,la,Kg,da,Yg,Zg,Jg,ca,Xg,Sr,Qg,eT,tT,pa,nT,ha,oT,sT,aT,ht,ua,rT,Jt,iT,Gr,lT,dT,Ql,cT,pT,hT,Bn,uT,Wn,mT,ut,ma,fT,ed,_T,gT,td,TT,bT,Rn,kT,Ct,fa,vT,nd,yT,wT,Hn,Jc,Xt,Vn,od,_a,$T,sd,xT,Xc,le,ga,zT,ad,jT,ET,Ta,qT,ba,FT,MT,CT,ka,PT,Ur,NT,OT,LT,va,AT,ya,IT,DT,ST,Kn,GT,mt,wa,UT,Qt,BT,Br,WT,RT,rd,HT,VT,KT,Yn,YT,Zn,Qc,en,Jn,id,$a,ZT,ld,JT,ep,de,xa,XT,za,QT,dd,eb,tb,nb,ja,ob,Ea,sb,ab,rb,qa,ib,Wr,lb,db,cb,Fa,pb,Ma,hb,ub,mb,Xn,fb,ft,Ca,_b,tn,gb,Rr,Tb,bb,cd,kb,vb,yb,Qn,wb,eo,tp,nn,to,pd,Pa,$b,hd,xb,np,ce,Na,zb,ud,jb,Eb,Oa,qb,La,Fb,Mb,Cb,Aa,Pb,Hr,Nb,Ob,Lb,Ia,Ab,Da,Ib,Db,Sb,no,Gb,_t,Sa,Ub,on,Bb,Vr,Wb,Rb,md,Hb,Vb,Kb,oo,Yb,so,op,sn,ao,fd,Ga,Zb,_d,Jb,sp,Je,Ua,Xb,gt,Ba,Qb,an,ek,gd,tk,nk,Td,ok,sk,ak,ro,rk,io,ik,lo,Wa,lk,co,dk,po,Ra,ck,ho,ap,rn,uo,bd,Ha,pk,kd,hk,rp,Xe,Va,uk,Tt,Ka,mk,ln,fk,vd,_k,gk,yd,Tk,bk,kk,mo,vk,fo,yk,_o,Ya,wk,go,$k,To,Za,xk,bo,ip,dn,ko,wd,Ja,zk,$d,jk,lp,cn,Xa,Ek,Pt,Qa,qk,pn,Fk,Kr,Mk,Ck,xd,Pk,Nk,Ok,vo,dp;return l=new _e({}),ae=new _e({}),Vo=new _e({}),Ko=new S({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17969/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17969/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17969/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5Config"
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_t5.py#L1299"}}),On=new ge({props:{anchor:"transformers.T5Model.parallelize.example",$$slots:{default:[L5]},$$scope:{ctx:j}}}),Ks=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ln=new ge({props:{anchor:"transformers.T5Model.deparallelize.example",$$slots:{default:[A5]},$$scope:{ctx:j}}}),Ys=new _e({}),Zs=new M({props:{name:"class transformers.T5ForConditionalGeneration",anchor:"transformers.T5ForConditionalGeneration",parameters:[{name:"config",val:": T5Config"}],parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17969/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"},{anchor:"transformers.T5ForConditionalGeneration.forward.labels",description:`<strong>labels</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size,)</code>, <em>optional</em>) &#x2014;
Labels for computing the sequence classification/regression loss. Indices should be in <code>[-100, 0, ..., config.vocab_size - 1]</code>. All labels set to <code>-100</code> are ignored (masked), the loss is only computed for
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),In=new kt({props:{$$slots:{default:[I5]},$$scope:{ctx:j}}}),Dn=new ge({props:{anchor:"transformers.T5ForConditionalGeneration.forward.example",$$slots:{default:[D5]},$$scope:{ctx:j}}}),sa=new M({props:{name:"parallelize",anchor:"transformers.T5ForConditionalGeneration.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the t5 models have the
following number of attention modules:</p>
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_t5.py#L1492"}}),Sn=new ge({props:{anchor:"transformers.T5ForConditionalGeneration.parallelize.example",$$slots:{default:[S5]},$$scope:{ctx:j}}}),aa=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_t5.py#L1505"}}),Gn=new ge({props:{anchor:"transformers.T5ForConditionalGeneration.deparallelize.example",$$slots:{default:[G5]},$$scope:{ctx:j}}}),ra=new _e({}),ia=new M({props:{name:"class transformers.T5EncoderModel",anchor:"transformers.T5EncoderModel",parameters:[{name:"config",val:": T5Config"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17969/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
`}}),Bn=new kt({props:{$$slots:{default:[U5]},$$scope:{ctx:j}}}),Wn=new ge({props:{anchor:"transformers.T5EncoderModel.forward.example",$$slots:{default:[B5]},$$scope:{ctx:j}}}),ma=new M({props:{name:"parallelize",anchor:"transformers.T5EncoderModel.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the t5 models have the
following number of attention modules:</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17969/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_tf_t5.py#L1146",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
`}}),Yn=new kt({props:{$$slots:{default:[V5]},$$scope:{ctx:j}}}),Zn=new ge({props:{anchor:"transformers.TFT5Model.call.example",$$slots:{default:[K5]},$$scope:{ctx:j}}}),$a=new _e({}),xa=new M({props:{name:"class transformers.TFT5ForConditionalGeneration",anchor:"transformers.TFT5ForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17969/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_tf_t5.py#L1266"}}),Xn=new kt({props:{$$slots:{default:[Y5]},$$scope:{ctx:j}}}),Ca=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_input_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"encoder_outputs",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17969/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17969/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17969/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_tf_t5.py#L1322",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_tf_t5.py#L1569",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_flax_t5.py#L956",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_17969/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17969/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17969/src/transformers/models/t5/modeling_flax_t5.py#L1407"}}),vo=new kt({props:{$$slots:{default:[dw]},$$scope:{ctx:j}}}),{c(){p=a("meta"),b=d(),g=a("h1"),u=a("a"),T=a("span"),k(l.$$.fragment),_=d(),E=a("span"),Ee=o("T5"),se=d(),q=a("h2"),ee=a("a"),G=a("span"),k(ae.$$.fragment),qe=d(),U=a("span"),Fe=o("Overview"),ve=d(),B=a("p"),A=o("The T5 model was presented in "),re=a("a"),pe=o("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),C=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),N=d(),he=a("p"),K=o("The abstract from the paper is the following:"),ye=d(),ue=a("p"),W=a("em"),Me=o(`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
...
for summarization: `),R=a("em"),Oe=o("summarize: \u2026"),z=o("."),F=d(),te=a("li"),Ge=a("p"),et=o("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),D=d(),Ue=a("li"),ne=a("p"),tt=o("See the "),L=a("a"),Y=o("training"),nt=o(", "),Le=a("a"),Z=o("inference"),ot=o(" and "),Ae=a("a"),Ie=o("scripts"),st=o(" sections below for all details regarding usage."),Xd=d(),or=a("p"),hh=o("T5 comes in different sizes:"),Qd=d(),Be=a("ul"),Ti=a("li"),bi=a("p"),Do=a("a"),uh=o("t5-small"),mh=d(),ki=a("li"),vi=a("p"),So=a("a"),fh=o("t5-base"),_h=d(),yi=a("li"),wi=a("p"),Go=a("a"),gh=o("t5-large"),Th=d(),$i=a("li"),xi=a("p"),Uo=a("a"),bh=o("t5-3b"),kh=d(),zi=a("li"),sr=a("p"),Bo=a("a"),vh=o("t5-11b"),yh=o("."),ec=d(),ar=a("p"),wh=o("Based on the original T5 model, Google has released some follow-up works:"),tc=d(),$t=a("ul"),ji=a("li"),mn=a("p"),Ei=a("strong"),$h=o("T5v1.1"),xh=o(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),lr=a("a"),Lh=o("here"),Ah=o("."),nc=d(),gn=a("p"),Ih=o("All checkpoints can be found on the "),Wo=a("a"),Dh=o("hub"),Sh=o("."),oc=d(),xt=a("p"),Gh=o("This model was contributed by "),Ro=a("a"),Uh=o("thomwolf"),Bh=o(". The original code can be found "),Ho=a("a"),Wh=o("here"),Rh=o("."),sc=d(),dr=a("a"),ac=d(),Lt=a("h2"),Tn=a("a"),Pi=a("span"),k(Vo.$$.fragment),Hh=d(),Ni=a("span"),Vh=o("Training"),rc=d(),at=a("p"),Kh=o(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
`),Ui=a("code"),hu=o("<extra_id_1>"),uu=o(", \u2026 up to "),Bi=a("code"),mu=o("<extra_id_99>"),fu=o(`. As a default, 100 sentinel tokens are available in
...
directory.`),uc=d(),mr=a("ul"),Wi=a("li"),yu=o("Supervised training"),mc=d(),fr=a("p"),wu=o(`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),fc=d(),k(Zo.$$.fragment),_c=d(),oe=a("p"),$u=o("As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ri=a("code"),xu=o("input_ids"),zu=o(` (which are the
...
typically defines a `),Xi=a("code"),Su=o("max_source_length"),Gu=o(" and "),Qi=a("code"),Uu=o("max_target_length"),Bu=o(`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Tc=d(),fe=a("p"),Wu=o("In addition, we must make sure that padding token id\u2019s of the "),el=a("code"),Ru=o("labels"),Hu=o(` are not taken into account by the loss
...
generation works in general in encoder-decoder models.`),jc=d(),k(as.$$.fragment),Ec=d(),We=a("p"),$m=o("Note that T5 uses the "),dl=a("code"),xm=o("pad_token_id"),zm=o(" as the "),cl=a("code"),jm=o("decoder_start_token_id"),Em=o(`, so when doing generation without using
...
The predicted tokens will then be placed between the sentinel tokens.`),Cc=d(),k(is.$$.fragment),Pc=d(),wr=a("a"),Nc=d(),It=a("h2"),wn=a("a"),hl=a("span"),k(ls.$$.fragment),Om=d(),ul=a("span"),Lm=o("Performance"),Oc=d(),it=a("p"),Am=o("If you\u2019d like a faster training and inference performance, install "),ds=a("a"),Im=o("apex"),Dm=o(" and then the model will automatically use "),ml=a("code"),Sm=o("apex.normalization.FusedRMSNorm"),Gm=o(" instead of "),fl=a("code"),Um=o("T5LayerNorm"),Bm=o(". The former uses an optimized fused kernel which is several times faster than the latter."),Lc=d(),Dt=a("h2"),$n=a("a"),_l=a("span"),k(cs.$$.fragment),Wm=d(),gl=a("span"),Rm=o("Example scripts"),Ac=d(),$r=a("p"),Hm=o("T5 is supported by several example scripts, both for pre-training and fine-tuning."),Ic=d(),xn=a("ul"),Tl=a("li"),St=a("p"),Vm=o("pre-training: the "),ps=a("a"),Km=o("run_t5_mlm_flax.py"),Ym=o(`
...
adding special tokens. A sequence has the following format:`),Sf=d(),js=a("ul"),Fr=a("li"),Gf=o("single sequence: "),xl=a("code"),Uf=o("X </s>"),Bf=d(),Mr=a("li"),Wf=o("pair of sequences: "),zl=a("code"),Rf=o("A </s> B </s>"),Hf=d(),En=a("div"),k(Es.$$.fragment),Vf=d(),qs=a("p"),Kf=o(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
use of token type ids, therefore a list of zeros is returned.`),e_=d(),Cr=a("div"),k(Ms.$$.fragment),Bc=d(),Wt=a("h2"),Fn=a("a"),ql=a("span"),k(Cs.$$.fragment),t_=d(),Fl=a("span"),n_=o("T5TokenizerFast"),Wc=d(),Se=a("div"),k(Ps.$$.fragment),o_=d(),Rt=a("p"),s_=o("Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),Ml=a("em"),a_=o("tokenizers"),r_=o(` library). Based on
...
use of token type ids, therefore a list of zeros is returned.`),Rc=d(),Ht=a("h2"),Cn=a("a"),Ll=a("span"),k(Ds.$$.fragment),x_=d(),Al=a("span"),z_=o("T5Model"),Hc=d(),J=a("div"),k(Ss.$$.fragment),j_=d(),Il=a("p"),E_=o("The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),q_=d(),Gs=a("p"),F_=o("The T5 model was proposed in "),Us=a("a"),M_=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),C_=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),P_=d(),Bs=a("p"),N_=o("This model inherits from "),Lr=a("a"),O_=o("PreTrainedModel"),L_=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),A_=d(),Ws=a("p"),I_=o("This model is also a PyTorch "),Rs=a("a"),D_=o("torch.nn.Module"),S_=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),G_=d(),lt=a("div"),k(Hs.$$.fragment),U_=d(),Vt=a("p"),B_=o("The "),Ar=a("a"),W_=o("T5Model"),R_=o(" forward method, overrides the "),Dl=a("code"),H_=o("__call__"),V_=o(" special method."),K_=d(),k(Pn.$$.fragment),Y_=d(),k(Nn.$$.fragment),Z_=d(),dt=a("div"),k(Vs.$$.fragment),J_=d(),Sl=a("p"),X_=o("This is an experimental feature and is a subject to change at a moment\u2019s notice."),Q_=d(),Gl=a("p"),eg=o(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),tg=d(),k(On.$$.fragment),ng=d(),Ft=a("div"),k(Ks.$$.fragment),og=d(),Ul=a("p"),sg=o("Moves the model to cpu from a model parallel state."),ag=d(),k(Ln.$$.fragment),Vc=d(),Kt=a("h2"),An=a("a"),Bl=a("span"),k(Ys.$$.fragment),rg=d(),Wl=a("span"),ig=o("T5ForConditionalGeneration"),Kc=d(),X=a("div"),k(Zs.$$.fragment),lg=d(),Js=a("p"),dg=o("T5 Model with a "),Rl=a("code"),cg=o("language modeling"),pg=o(" head on top."),hg=d(),Xs=a("p"),ug=o("The T5 model was proposed in "),Qs=a("a"),mg=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
it will evenly distribute blocks across all devices.`),Ig=d(),k(Sn.$$.fragment),Dg=d(),Mt=a("div"),k(aa.$$.fragment),Sg=d(),Yl=a("p"),Gg=o("Moves the model to cpu from a model parallel state."),Ug=d(),k(Gn.$$.fragment),Yc=d(),Zt=a("h2"),Un=a("a"),Zl=a("span"),k(ra.$$.fragment),Bg=d(),Jl=a("span"),Wg=o("T5EncoderModel"),Zc=d(),Q=a("div"),k(ia.$$.fragment),Rg=d(),Xl=a("p"),Hg=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Vg=d(),la=a("p"),Kg=o("The T5 model was proposed in "),da=a("a"),Yg=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sb=d(),k(no.$$.fragment),Gb=d(),_t=a("div"),k(Sa.$$.fragment),Ub=d(),on=a("p"),Bb=o("The "),Vr=a("a"),Wb=o("TFT5EncoderModel"),Rb=o(" forward method, overrides the "),md=a("code"),Hb=o("__call__"),Vb=o(" special method."),Kb=d(),k(oo.$$.fragment),Yb=d(),k(so.$$.fragment),op=d(),sn=a("h2"),ao=a("a"),fd=a("span"),k(Ga.$$.fragment),Zb=d(),_d=a("span"),Jb=o("FlaxT5Model"),sp=d(),Je=a("div"),k(Ua.$$.fragment),Xb=d(),gt=a("div"),k(Ba.$$.fragment),Qb=d(),an=a("p"),ek=o("The "),gd=a("code"),tk=o("FlaxT5PreTrainedModel"),nk=o(" forward method, overrides the "),Td=a("code"),ok=o("__call__"),sk=o(" special method."),ak=d(),k(ro.$$.fragment),rk=d(),k(io.$$.fragment),ik=d(),lo=a("div"),k(Wa.$$.fragment),lk=d(),k(co.$$.fragment),dk=d(),po=a("div"),k(Ra.$$.fragment),ck=d(),k(ho.$$.fragment),ap=d(),rn=a("h2"),uo=a("a"),bd=a("span"),k(Ha.$$.fragment),pk=d(),kd=a("span"),hk=o("FlaxT5ForConditionalGeneration"),rp=d(),Xe=a("div"),k(Va.$$.fragment),uk=d(),Tt=a("div"),k(Ka.$$.fragment),mk=d(),ln=a("p"),fk=o("The "),vd=a("code"),_k=o("FlaxT5PreTrainedModel"),gk=o(" forward method, overrides the "),yd=a("code"),Tk=o("__call__"),bk=o(" special method."),kk=d(),k(mo.$$.fragment),vk=d(),k(fo.$$.fragment),yk=d(),_o=a("div"),k(Ya.$$.fragment),wk=d(),k(go.$$.fragment),$k=d(),To=a("div"),k(Za.$$.fragment),xk=d(),k(bo.$$.fragment),ip=d(),dn=a("h2"),ko=a("a"),wd=a("span"),k(Ja.$$.fragment),zk=d(),$d=a("span"),jk=o("FlaxT5EncoderModel"),lp=d(),cn=a("div"),k(Xa.$$.fragment),Ek=d(),Pt=a("div"),k(Qa.$$.fragment),qk=d(),pn=a("p"),Fk=o("The "),Kr=a("a"),Mk=o("FlaxT5EncoderModel"),Ck=o(" forward method, overrides the "),xd=a("code"),Pk=o("__call__"),Nk=o(" special method."),Ok=d(),k(vo.$$.fragment),this.h()},l(n){const f=C5('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),b=c(n),g=r(n,"H1",{class:!0});var er=i(g);u=r(er,"A",{id:!0,class:!0,href:!0});var zd=i(u);T=r(zd,"SPAN",{});var jd=i(T);v(l.$$.fragment,jd),jd.forEach(t),zd.forEach(t),_=c(er),E=r(er,"SPAN",{});var Ed=i(E);Ee=s(Ed,"T5"),Ed.forEach(t),er.forEach(t),se=c(n),q=r(n,"H2",{class:!0});var tr=i(q);ee=r(tr,"A",{id:!0,class:!0,href:!0});var qd=i(ee);G=r(qd,"SPAN",{});var Fd=i(G);v(ae.$$.fragment,Fd),Fd.forEach(t),qd.forEach(t),qe=c(tr),U=r(tr,"SPAN",{});var Md=i(U);Fe=s(Md,"Overview"),Md.forEach(t),tr.forEach(t),ve=c(n),B=r(n,"P",{});var nr=i(B);A=s(nr,"The T5 model was presented in "),re=r(nr,"A",{href:!0,rel:!0});var Cd=i(re);pe=s(Cd,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Cd.forEach(t),C=s(nr,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),nr.forEach(t),N=c(n),he=r(n,"P",{});var Pd=i(he);K=s(Pd,"The abstract from the paper is the following:"),Pd.forEach(t),ye=c(n),ue=r(n,"P",{});var Nd=i(ue);W=r(Nd,"EM",{});var Od=i(W);Me=s(Od,`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
task, has emerged as a powerful technique in natural language processing (NLP). The effectiveness of transfer learning
has given rise to a diversity of approaches, methodology, and practice. In this paper, we explore the landscape of
transfer learning techniques for NLP by introducing a unified framework that converts every language problem into a
text-to-text format. Our systematic study compares pretraining objectives, architectures, unlabeled datasets, transfer
...
for summarization: `),R=r(un,"EM",{});var Dd=i(R);Oe=s(Dd,"summarize: \u2026"),Dd.forEach(t),z=s(un,"."),un.forEach(t),Ad.forEach(t),F=c(hn),te=r(hn,"LI",{});var Sd=i(te);Ge=r(Sd,"P",{});var Gd=i(Ge);et=s(Gd,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),Gd.forEach(t),Sd.forEach(t),D=c(hn),Ue=r(hn,"LI",{});var Ud=i(Ue);ne=r(Ud,"P",{});var wt=i(ne);tt=s(wt,"See the "),L=r(wt,"A",{href:!0});var Bd=i(L);Y=s(Bd,"training"),Bd.forEach(t),nt=s(wt,", "),Le=r(wt,"A",{href:!0});var Wd=i(Le);Z=s(Wd,"inference"),Wd.forEach(t),ot=s(wt," and "),Ae=r(wt,"A",{href:!0});var Rd=i(Ae);Ie=s(Rd,"scripts"),Rd.forEach(t),st=s(wt," sections below for all details regarding usage."),wt.forEach(t),Ud.forEach(t),hn.forEach(t),Xd=c(n),or=r(n,"P",{});var Hd=i(or);hh=s(Hd,"T5 comes in different sizes:"),Hd.forEach(t),Qd=c(n),Be=r(n,"UL",{});var Qe=i(Be);Ti=r(Qe,"LI",{});var Vd=i(Ti);bi=r(Vd,"P",{});var Kd=i(bi);Do=r(Kd,"A",{href:!0,rel:!0});var Gk=i(Do);uh=s(Gk,"t5-small"),Gk.forEach(t),Kd.forEach(t),Vd.forEach(t),mh=c(Qe),ki=r(Qe,"LI",{});var Uk=i(ki);vi=r(Uk,"P",{});var Bk=i(vi);So=r(Bk,"A",{href:!0,rel:!0});var Wk=i(So);fh=s(Wk,"t5-base"),Wk.forEach(t),Bk.forEach(t),Uk.forEach(t),_h=c(Qe),yi=r(Qe,"LI",{});var Rk=i(yi);wi=r(Rk,"P",{});var Hk=i(wi);Go=r(Hk,"A",{href:!0,rel:!0});var Vk=i(Go);gh=s(Vk,"t5-large"),Vk.forEach(t),Hk.forEach(t),Rk.forEach(t),Th=c(Qe),$i=r(Qe,"LI",{});var Kk=i($i);xi=r(Kk,"P",{});var Yk=i(xi);Uo=r(Yk,"A",{href:!0,rel:!0});var Zk=i(Uo);bh=s(Zk,"t5-3b"),Zk.forEach(t),Yk.forEach(t),Kk.forEach(t),kh=c(Qe),zi=r(Qe,"LI",{});var Jk=i(zi);sr=r(Jk,"P",{});var Lk=i(sr);Bo=r(Lk,"A",{href:!0,rel:!0});var Xk=i(Bo);vh=s(Xk,"t5-11b"),Xk.forEach(t),yh=s(Lk,"."),Lk.forEach(t),Jk.forEach(t),Qe.forEach(t),ec=c(n),ar=r(n,"P",{});var Qk=i(ar);wh=s(Qk,"Based on the original T5 model, Google has released some follow-up works:"),Qk.forEach(t),tc=c(n),$t=r(n,"UL",{});var Yr=i($t);ji=r(Yr,"LI",{});var ev=i(ji);mn=r(ev,"P",{});var Yd=i(mn);Ei=r(Yd,"STRONG",{});var tv=i(Ei);$h=s(tv,"T5v1.1"),tv.forEach(t),xh=s(Yd,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),lr=r(Jd,"A",{href:!0});var lv=i(lr);Lh=s(lv,"here"),lv.forEach(t),Ah=s(Jd,"."),Jd.forEach(t),rv.forEach(t),Yr.forEach(t),nc=c(n),gn=r(n,"P",{});var cp=i(gn);Ih=s(cp,"All checkpoints can be found on the "),Wo=r(cp,"A",{href:!0,rel:!0});var dv=i(Wo);Dh=s(dv,"hub"),dv.forEach(t),Sh=s(cp,"."),cp.forEach(t),oc=c(n),xt=r(n,"P",{});var Zr=i(xt);Gh=s(Zr,"This model was contributed by "),Ro=r(Zr,"A",{href:!0,rel:!0});var cv=i(Ro);Uh=s(cv,"thomwolf"),cv.forEach(t),Bh=s(Zr,". The original code can be found "),Ho=r(Zr,"A",{href:!0,rel:!0});var pv=i(Ho);Wh=s(pv,"here"),pv.forEach(t),Rh=s(Zr,"."),Zr.forEach(t),sc=c(n),dr=r(n,"A",{id:!0}),i(dr).forEach(t),ac=c(n),Lt=r(n,"H2",{class:!0});var pp=i(Lt);Tn=r(pp,"A",{id:!0,class:!0,href:!0});var hv=i(Tn);Pi=r(hv,"SPAN",{});var uv=i(Pi);v(Vo.$$.fragment,uv),uv.forEach(t),hv.forEach(t),Hh=c(pp),Ni=r(pp,"SPAN",{});var mv=i(Ni);Vh=s(mv,"Training"),mv.forEach(t),pp.forEach(t),rc=c(n),at=r(n,"P",{});var yo=i(at);Kh=s(yo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),hp.forEach(t),lc=c(n),pr=r(n,"UL",{});var bv=i(pr);Ii=r(bv,"LI",{});var kv=i(Ii);su=s(kv,"Unsupervised denoising training"),kv.forEach(t),bv.forEach(t),dc=c(n),me=r(n,"P",{});var Re=i(me);au=s(Re,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),Di=r(Re,"EM",{});var vv=i(Di);ru=s(vv,"a.k.a"),vv.forEach(t),iu=s(Re,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Si=r(Re,"EM",{});var yv=i(Si);lu=s(yv,"real"),yv.forEach(t),du=s(Re,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Gi=r(Re,"CODE",{});var wv=i(Gi);cu=s(wv,"<extra_id_0>"),wv.forEach(t),pu=s(Re,`,
`),Ui=r(Re,"CODE",{});var $v=i(Ui);hu=s($v,"<extra_id_1>"),$v.forEach(t),uu=s(Re,", \u2026 up to "),Bi=r(Re,"CODE",{});var xv=i(Bi);mu=s(xv,"<extra_id_99>"),xv.forEach(t),fu=s(Re,`. As a default, 100 sentinel tokens are available in
`),hr=r(Re,"A",{href:!0});var zv=i(hr);_u=s(zv,"T5Tokenizer"),zv.forEach(t),gu=s(Re,"."),Re.forEach(t),cc=c(n),ur=r(n,"P",{});var jv=i(ur);Tu=s(jv,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
directory.`),up.forEach(t),uc=c(n),mr=r(n,"UL",{});var qv=i(mr);Wi=r(qv,"LI",{});var Fv=i(Wi);yu=s(Fv,"Supervised training"),Fv.forEach(t),qv.forEach(t),mc=c(n),fr=r(n,"P",{});var Mv=i(fr);wu=s(Mv,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),Mv.forEach(t),fc=c(n),v(Zo.$$.fragment,n),_c=c(n),oe=r(n,"P",{});var $e=i(oe);$u=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ri=r($e,"CODE",{});var Cv=i(Ri);xu=s(Cv,"input_ids"),Cv.forEach(t),zu=s($e,` (which are the
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Xi=r(Jr,"CODE",{});var Dv=i(Xi);Su=s(Dv,"max_source_length"),Dv.forEach(t),Gu=s(Jr," and "),Qi=r(Jr,"CODE",{});var Sv=i(Qi);Uu=s(Sv,"max_target_length"),Sv.forEach(t),Bu=s(Jr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Jr.forEach(t),Tc=c(n),fe=r(n,"P",{});var He=i(fe);Wu=s(He,"In addition, we must make sure that padding token id\u2019s of the "),el=r(He,"CODE",{});var Gv=i(el);Ru=s(Gv,"labels"),Gv.forEach(t),Hu=s(He,` are not taken into account by the loss
...
of the `),nl=r(He,"CODE",{});var Bv=i(nl);Yu=s(Bv,"CrossEntropyLoss"),Bv.forEach(t),Zu=s(He,". In Flax, one can use the "),ol=r(He,"CODE",{});var Wv=i(ol);Ju=s(Wv,"decoder_attention_mask"),Wv.forEach(t),Xu=s(He,` to ignore padded tokens from
the loss (see the `),Jo=r(He,"A",{href:!0,rel:!0});var Rv=i(Jo);Qu=s(Rv,"Flax summarization script"),Rv.forEach(t),em=s(He,` for details). We also pass
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),fp.forEach(t),$c=c(n),Tr=r(n,"A",{id:!0}),i(Tr).forEach(t),xc=c(n),At=r(n,"H2",{class:!0});var _p=i(At);yn=r(_p,"A",{id:!0,class:!0,href:!0});var Qv=i(yn);il=r(Qv,"SPAN",{});var e1=i(il);v(ns.$$.fragment,e1),e1.forEach(t),Qv.forEach(t),fm=c(_p),ll=r(_p,"SPAN",{});var t1=i(ll);_m=s(t1,"Inference"),t1.forEach(t),_p.forEach(t),zc=c(n),rt=r(n,"P",{});var wo=i(rt);gm=s(wo,"At inference time, it is recommended to use "),br=r(wo,"A",{href:!0});var n1=i(br);Tm=s(n1,"generate()"),n1.forEach(t),bm=s(wo,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),os=r(wo,"A",{href:!0,rel:!0});var o1=i(os);km=s(o1,"this blog post"),o1.forEach(t),vm=s(wo,` to know all the details about generating text with Transformers.
There\u2019s also `),ss=r(wo,"A",{href:!0,rel:!0});var s1=i(ss);ym=s(s1,"this blog post"),s1.forEach(t),wm=s(wo,` which explains how
generation works in general in encoder-decoder models.`),wo.forEach(t),jc=c(n),v(as.$$.fragment,n),Ec=c(n),We=r(n,"P",{});var Nt=i(We);$m=s(Nt,"Note that T5 uses the "),dl=r(Nt,"CODE",{});var a1=i(dl);xm=s(a1,"pad_token_id"),a1.forEach(t),zm=s(Nt," as the "),cl=r(Nt,"CODE",{});var r1=i(cl);jm=s(r1,"decoder_start_token_id"),r1.forEach(t),Em=s(Nt,`, so when doing generation without using
`),kr=r(Nt,"A",{href:!0});var i1=i(kr);qm=s(i1,"generate()"),i1.forEach(t),Fm=s(Nt,", make sure you start it with the "),pl=r(Nt,"CODE",{});var l1=i(pl);Mm=s(l1,"pad_token_id"),l1.forEach(t),Cm=s(Nt,"."),Nt.forEach(t),qc=c(n),vr=r(n,"P",{});var d1=i(vr);Pm=s(d1,"The example above only shows a single example. You can also do batched inference, like so:"),d1.forEach(t),Fc=c(n),v(rs.$$.fragment,n),Mc=c(n),yr=r(n,"P",{});var c1=i(yr);Nm=s(c1,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),c1.forEach(t),Cc=c(n),v(is.$$.fragment,n),Pc=c(n),wr=r(n,"A",{id:!0}),i(wr).forEach(t),Nc=c(n),It=r(n,"H2",{class:!0});var gp=i(It);wn=r(gp,"A",{id:!0,class:!0,href:!0});var p1=i(wn);hl=r(p1,"SPAN",{});var h1=i(hl);v(ls.$$.fragment,h1),h1.forEach(t),p1.forEach(t),Om=c(gp),ul=r(gp,"SPAN",{});var u1=i(ul);Lm=s(u1,"Performance"),u1.forEach(t),gp.forEach(t),Oc=c(n),it=r(n,"P",{});var $o=i(it);Am=s($o,"If you\u2019d like a faster training and inference performance, install "),ds=r($o,"A",{href:!0,rel:!0});var m1=i(ds);Im=s(m1,"apex"),m1.forEach(t),Dm=s($o," and then the model will automatically use "),ml=r($o,"CODE",{});var f1=i(ml);Sm=s(f1,"apex.normalization.FusedRMSNorm"),f1.forEach(t),Gm=s($o," instead of "),fl=r($o,"CODE",{});var _1=i(fl);Um=s(_1,"T5LayerNorm"),_1.forEach(t),Bm=s($o,". The former uses an optimized fused kernel which is several times faster than the latter."),$o.forEach(t),Lc=c(n),Dt=r(n,"H2",{class:!0});var Tp=i(Dt);$n=r(Tp,"A",{id:!0,class:!0,href:!0});var g1=i($n);_l=r(g1,"SPAN",{});var T1=i(_l);v(cs.$$.fragment,T1),T1.forEach(t),g1.forEach(t),Wm=c(Tp),gl=r(Tp,"SPAN",{});var b1=i(gl);Rm=s(b1,"Example scripts"),b1.forEach(t),Tp.forEach(t),Ac=c(n),$r=r(n,"P",{});var k1=i($r);Hm=s(k1,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),k1.forEach(t),Ic=c(n),xn=r(n,"UL",{});var bp=i(xn);Tl=r(bp,"LI",{});var v1=i(Tl);St=r(v1,"P",{});var Qr=i(St);Vm=s(Qr,"pre-training: the "),ps=r(Qr,"A",{href:!0,rel:!0});var y1=i(ps);Km=s(y1,"run_t5_mlm_flax.py"),y1.forEach(t),Ym=s(Qr,`
...
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Qr.forEach(t),v1.forEach(t),Xm=c(bp),bl=r(bp,"LI",{});var $1=i(bl);De=r($1,"P",{});var bt=i(De);Qm=s(bt,"fine-tuning: T5 is supported by the official summarization scripts ("),us=r(bt,"A",{href:!0,rel:!0});var x1=i(us);ef=s(x1,"PyTorch"),x1.forEach(t),tf=s(bt,", "),ms=r(bt,"A",{href:!0,rel:!0});var z1=i(ms);nf=s(z1,"Tensorflow"),z1.forEach(t),of=s(bt,", and "),fs=r(bt,"A",{href:!0,rel:!0});var j1=i(fs);sf=s(j1,"Flax"),j1.forEach(t),af=s(bt,`) and translation scripts
(`),_s=r(bt,"A",{href:!0,rel:!0});var E1=i(_s);rf=s(E1,"PyTorch"),E1.forEach(t),lf=s(bt," and "),gs=r(bt,"A",{href:!0,rel:!0});var q1=i(gs);df=s(q1,"Tensorflow"),q1.forEach(t),cf=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),$1.forEach(t),bp.forEach(t),Dc=c(n),Gt=r(n,"H2",{class:!0});var kp=i(Gt);zn=r(kp,"A",{id:!0,class:!0,href:!0});var F1=i(zn);kl=r(F1,"SPAN",{});var M1=i(kl);v(Ts.$$.fragment,M1),M1.forEach(t),F1.forEach(t),pf=c(kp),vl=r(kp,"SPAN",{});var C1=i(vl);hf=s(C1,"T5Config"),C1.forEach(t),kp.forEach(t),Sc=c(n),vt=r(n,"DIV",{class:!0});var ei=i(vt);v(bs.$$.fragment,ei),uf=c(ei),yt=r(ei,"P",{});var xo=i(yt);mf=s(xo,"This is the configuration class to store the configuration of a "),xr=r(xo,"A",{href:!0});var P1=i(xr);ff=s(P1,"T5Model"),P1.forEach(t),_f=s(xo," or a "),zr=r(xo,"A",{href:!0});var N1=i(zr);gf=s(N1,"TFT5Model"),N1.forEach(t),Tf=s(xo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ks=r(xo,"A",{href:!0,rel:!0});var O1=i(ks);bf=s(O1,"t5-small"),O1.forEach(t),kf=s(xo," architecture."),xo.forEach(t),vf=c(ei),Ut=r(ei,"P",{});var ti=i(Ut);yf=s(ti,"Configuration objects inherit from "),jr=r(ti,"A",{href:!0});var L1=i(jr);wf=s(L1,"PretrainedConfig"),L1.forEach(t),$f=s(ti,` and can be used to control the model outputs. Read the
documentation from `),Er=r(ti,"A",{href:!0});var A1=i(Er);xf=s(A1,"PretrainedConfig"),A1.forEach(t),zf=s(ti," for more information."),ti.forEach(t),ei.forEach(t),Gc=c(n),Bt=r(n,"H2",{class:!0});var vp=i(Bt);jn=r(vp,"A",{id:!0,class:!0,href:!0});var I1=i(jn);yl=r(I1,"SPAN",{});var D1=i(yl);v(vs.$$.fragment,D1),D1.forEach(t),I1.forEach(t),jf=c(vp),wl=r(vp,"SPAN",{});var S1=i(wl);Ef=s(S1,"T5Tokenizer"),S1.forEach(t),vp.forEach(t),Uc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);v(ys.$$.fragment,Ve),qf=c(Ve),ws=r(Ve,"P",{});var yp=i(ws);Ff=s(yp,"Construct a T5 tokenizer. Based on "),$s=r(yp,"A",{href:!0,rel:!0});var G1=i($s);Mf=s(G1,"SentencePiece"),G1.forEach(t),Cf=s(yp,"."),yp.forEach(t),Pf=c(Ve),xs=r(Ve,"P",{});var wp=i(xs);Nf=s(wp,"This tokenizer inherits from "),qr=r(wp,"A",{href:!0});var U1=i(qr);Of=s(U1,"PreTrainedTokenizer"),U1.forEach(t),Lf=s(wp,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),wp.forEach(t),Af=c(Ve),Et=r(Ve,"DIV",{class:!0});var ni=i(Et);v(zs.$$.fragment,ni),If=c(ni),$l=r(ni,"P",{});var B1=i($l);Df=s(B1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),B1.forEach(t),Sf=c(ni),js=r(ni,"UL",{});var $p=i(js);Fr=r($p,"LI",{});var Ak=i(Fr);Gf=s(Ak,"single sequence: "),xl=r(Ak,"CODE",{});var W1=i(xl);Uf=s(W1,"X </s>"),W1.forEach(t),Ak.forEach(t),Bf=c($p),Mr=r($p,"LI",{});var Ik=i(Mr);Wf=s(Ik,"pair of sequences: "),zl=r(Ik,"CODE",{});var R1=i(zl);Rf=s(R1,"A </s> B </s>"),R1.forEach(t),Ik.forEach(t),$p.forEach(t),ni.forEach(t),Hf=c(Ve),En=r(Ve,"DIV",{class:!0});var xp=i(En);v(Es.$$.fragment,xp),Vf=c(xp),qs=r(xp,"P",{});var zp=i(qs);Kf=s(zp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),jl=r(zp,"CODE",{});var H1=i(jl);Yf=s(H1,"prepare_for_model"),H1.forEach(t),Zf=s(zp," method."),zp.forEach(t),xp.forEach(t),Jf=c(Ve),qn=r(Ve,"DIV",{class:!0});var jp=i(qn);v(Fs.$$.fragment,jp),Xf=c(jp),El=r(jp,"P",{});var V1=i(El);Qf=s(V1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),V1.forEach(t),jp.forEach(t),e_=c(Ve),Cr=r(Ve,"DIV",{class:!0});var K1=i(Cr);v(Ms.$$.fragment,K1),K1.forEach(t),Ve.forEach(t),Bc=c(n),Wt=r(n,"H2",{class:!0});var Ep=i(Wt);Fn=r(Ep,"A",{id:!0,class:!0,href:!0});var Y1=i(Fn);ql=r(Y1,"SPAN",{});var Z1=i(ql);v(Cs.$$.fragment,Z1),Z1.forEach(t),Y1.forEach(t),t_=c(Ep),Fl=r(Ep,"SPAN",{});var J1=i(Fl);n_=s(J1,"T5TokenizerFast"),J1.forEach(t),Ep.forEach(t),Wc=c(n),Se=r(n,"DIV",{class:!0});var Ot=i(Se);v(Ps.$$.fragment,Ot),o_=c(Ot),Rt=r(Ot,"P",{});var oi=i(Rt);s_=s(oi,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),Ml=r(oi,"EM",{});var X1=i(Ml);a_=s(X1,"tokenizers"),X1.forEach(t),r_=s(oi,` library). Based on
...
refer to this superclass for more information regarding those methods.`),qp.forEach(t),u_=c(Ot),qt=r(Ot,"DIV",{class:!0});var si=i(qt);v(Ls.$$.fragment,si),m_=c(si),Cl=r(si,"P",{});var ty=i(Cl);f_=s(ty,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),ty.forEach(t),__=c(si),As=r(si,"UL",{});var Fp=i(As);Nr=r(Fp,"LI",{});var Dk=i(Nr);g_=s(Dk,"single sequence: "),Pl=r(Dk,"CODE",{});var ny=i(Pl);T_=s(ny,"X </s>"),ny.forEach(t),Dk.forEach(t),b_=c(Fp),Or=r(Fp,"LI",{});var Sk=i(Or);k_=s(Sk,"pair of sequences: "),Nl=r(Sk,"CODE",{});var oy=i(Nl);v_=s(oy,"A </s> B </s>"),oy.forEach(t),Sk.forEach(t),Fp.forEach(t),si.forEach(t),y_=c(Ot),Mn=r(Ot,"DIV",{class:!0});var Mp=i(Mn);v(Is.$$.fragment,Mp),w_=c(Mp),Ol=r(Mp,"P",{});var sy=i(Ol);$_=s(sy,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),sy.forEach(t),Mp.forEach(t),Ot.forEach(t),Rc=c(n),Ht=r(n,"H2",{class:!0});var Cp=i(Ht);Cn=r(Cp,"A",{id:!0,class:!0,href:!0});var ay=i(Cn);Ll=r(ay,"SPAN",{});var ry=i(Ll);v(Ds.$$.fragment,ry),ry.forEach(t),ay.forEach(t),x_=c(Cp),Al=r(Cp,"SPAN",{});var iy=i(Al);z_=s(iy,"T5Model"),iy.forEach(t),Cp.forEach(t),Hc=c(n),J=r(n,"DIV",{class:!0});var xe=i(J);v(Ss.$$.fragment,xe),j_=c(xe),Il=r(xe,"P",{});var ly=i(Il);E_=s(ly,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),ly.forEach(t),q_=c(xe),Gs=r(xe,"P",{});var Pp=i(Gs);F_=s(Pp,"The T5 model was proposed in "),Us=r(Pp,"A",{href:!0,rel:!0});var dy=i(Us);M_=s(dy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),dy.forEach(t),C_=s(Pp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Pp.forEach(t),P_=c(xe),Bs=r(xe,"P",{});var Np=i(Bs);N_=s(Np,"This model inherits from "),Lr=r(Np,"A",{href:!0});var cy=i(Lr);O_=s(cy,"PreTrainedModel"),cy.forEach(t),L_=s(Np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Np.forEach(t),A_=c(xe),Ws=r(xe,"P",{});var Op=i(Ws);I_=s(Op,"This model is also a PyTorch "),Rs=r(Op,"A",{href:!0,rel:!0});var py=i(Rs);D_=s(py,"torch.nn.Module"),py.forEach(t),S_=s(Op,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Op.forEach(t),G_=c(xe),lt=r(xe,"DIV",{class:!0});var zo=i(lt);v(Hs.$$.fragment,zo),U_=c(zo),Vt=r(zo,"P",{});var ai=i(Vt);B_=s(ai,"The "),Ar=r(ai,"A",{href:!0});var hy=i(Ar);W_=s(hy,"T5Model"),hy.forEach(t),R_=s(ai," forward method, overrides the "),Dl=r(ai,"CODE",{});var uy=i(Dl);H_=s(uy,"__call__"),uy.forEach(t),V_=s(ai," special method."),ai.forEach(t),K_=c(zo),v(Pn.$$.fragment,zo),Y_=c(zo),v(Nn.$$.fragment,zo),zo.forEach(t),Z_=c(xe),dt=r(xe,"DIV",{class:!0});var jo=i(dt);v(Vs.$$.fragment,jo),J_=c(jo),Sl=r(jo,"P",{});var my=i(Sl);X_=s(my,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),my.forEach(t),Q_=c(jo),Gl=r(jo,"P",{});var fy=i(Gl);eg=s(fy,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),fy.forEach(t),tg=c(jo),v(On.$$.fragment,jo),jo.forEach(t),ng=c(xe),Ft=r(xe,"DIV",{class:!0});var ri=i(Ft);v(Ks.$$.fragment,ri),og=c(ri),Ul=r(ri,"P",{});var _y=i(Ul);sg=s(_y,"Moves the model to cpu from a model parallel state."),_y.forEach(t),ag=c(ri),v(Ln.$$.fragment,ri),ri.forEach(t),xe.forEach(t),Vc=c(n),Kt=r(n,"H2",{class:!0});var Lp=i(Kt);An=r(Lp,"A",{id:!0,class:!0,href:!0});var gy=i(An);Bl=r(gy,"SPAN",{});var Ty=i(Bl);v(Ys.$$.fragment,Ty),Ty.forEach(t),gy.forEach(t),rg=c(Lp),Wl=r(Lp,"SPAN",{});var by=i(Wl);ig=s(by,"T5ForConditionalGeneration"),by.forEach(t),Lp.forEach(t),Kc=c(n),X=r(n,"DIV",{class:!0});var ze=i(X);v(Zs.$$.fragment,ze),lg=c(ze),Js=r(ze,"P",{});var Ap=i(Js);dg=s(Ap,"T5 Model with a "),Rl=r(Ap,"CODE",{});var ky=i(Rl);cg=s(ky,"language modeling"),ky.forEach(t),pg=s(Ap," head on top."),Ap.forEach(t),hg=c(ze),Xs=r(ze,"P",{});var Ip=i(Xs);ug=s(Ip,"The T5 model was proposed in "),Qs=r(Ip,"A",{href:!0,rel:!0});var vy=i(Qs);mg=s(vy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),vy.forEach(t),fg=s(Ip,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Ip.forEach(t),_g=c(ze),ea=r(ze,"P",{});var Dp=i(ea);gg=s(Dp,"This model inherits from "),Ir=r(Dp,"A",{href:!0});var yy=i(Ir);Tg=s(yy,"PreTrainedModel"),yy.forEach(t),bg=s(Dp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dp.forEach(t),kg=c(ze),ta=r(ze,"P",{});var Sp=i(ta);vg=s(Sp,"This model is also a PyTorch "),na=r(Sp,"A",{href:!0,rel:!0});var wy=i(na);yg=s(wy,"torch.nn.Module"),wy.forEach(t),wg=s(Sp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sp.forEach(t),$g=c(ze),ct=r(ze,"DIV",{class:!0});var Eo=i(ct);v(oa.$$.fragment,Eo),xg=c(Eo),Yt=r(Eo,"P",{});var ii=i(Yt);zg=s(ii,"The "),Dr=r(ii,"A",{href:!0});var $y=i(Dr);jg=s($y,"T5ForConditionalGeneration"),$y.forEach(t),Eg=s(ii," forward method, overrides the "),Hl=r(ii,"CODE",{});var xy=i(Hl);qg=s(xy,"__call__"),xy.forEach(t),Fg=s(ii," special method."),ii.forEach(t),Mg=c(Eo),v(In.$$.fragment,Eo),Cg=c(Eo),v(Dn.$$.fragment,Eo),Eo.forEach(t),Pg=c(ze),pt=r(ze,"DIV",{class:!0});var qo=i(pt);v(sa.$$.fragment,qo),Ng=c(qo),Vl=r(qo,"P",{});var zy=i(Vl);Og=s(zy,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),zy.forEach(t),Lg=c(qo),Kl=r(qo,"P",{});var jy=i(Kl);Ag=s(jy,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),jy.forEach(t),Ig=c(qo),v(Sn.$$.fragment,qo),qo.forEach(t),Dg=c(ze),Mt=r(ze,"DIV",{class:!0});var li=i(Mt);v(aa.$$.fragment,li),Sg=c(li),Yl=r(li,"P",{});var Ey=i(Yl);Gg=s(Ey,"Moves the model to cpu from a model parallel state."),Ey.forEach(t),Ug=c(li),v(Gn.$$.fragment,li),li.forEach(t),ze.forEach(t),Yc=c(n),Zt=r(n,"H2",{class:!0});var Gp=i(Zt);Un=r(Gp,"A",{id:!0,class:!0,href:!0});var qy=i(Un);Zl=r(qy,"SPAN",{});var Fy=i(Zl);v(ra.$$.fragment,Fy),Fy.forEach(t),qy.forEach(t),Bg=c(Gp),Jl=r(Gp,"SPAN",{});var My=i(Jl);Wg=s(My,"T5EncoderModel"),My.forEach(t),Gp.forEach(t),Zc=c(n),Q=r(n,"DIV",{class:!0});var je=i(Q);v(ia.$$.fragment,je),Rg=c(je),Xl=r(je,"P",{});var Cy=i(Xl);Hg=s(Cy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Cy.forEach(t),Vg=c(je),la=r(je,"P",{});var Up=i(la);Kg=s(Up,"The T5 model was proposed in "),da=r(Up,"A",{href:!0,rel:!0});var Py=i(da);Yg=s(Py,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Py.forEach(t),Zg=s(Up,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Up.forEach(t),Jg=c(je),ca=r(je,"P",{});var Bp=i(ca);Xg=s(Bp,"This model inherits from "),Sr=r(Bp,"A",{href:!0});var Ny=i(Sr);Qg=s(Ny,"PreTrainedModel"),Ny.forEach(t),eT=s(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bp.forEach(t),tT=c(je),pa=r(je,"P",{});var Wp=i(pa);nT=s(Wp,"This model is also a PyTorch "),ha=r(Wp,"A",{href:!0,rel:!0});var Oy=i(ha);oT=s(Oy,"torch.nn.Module"),Oy.forEach(t),sT=s(Wp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wp.forEach(t),aT=c(je),ht=r(je,"DIV",{class:!0});var Fo=i(ht);v(ua.$$.fragment,Fo),rT=c(Fo),Jt=r(Fo,"P",{});var di=i(Jt);iT=s(di,"The "),Gr=r(di,"A",{href:!0});var Ly=i(Gr);lT=s(Ly,"T5EncoderModel"),Ly.forEach(t),dT=s(di," forward method, overrides the "),Ql=r(di,"CODE",{});var Ay=i(Ql);cT=s(Ay,"__call__"),Ay.forEach(t),pT=s(di," special method."),di.forEach(t),hT=c(Fo),v(Bn.$$.fragment,Fo),uT=c(Fo),v(Wn.$$.fragment,Fo),Fo.forEach(t),mT=c(je),ut=r(je,"DIV",{class:!0});var Mo=i(ut);v(ma.$$.fragment,Mo),fT=c(Mo),ed=r(Mo,"P",{});var Iy=i(ed);_T=s(Iy,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Iy.forEach(t),gT=c(Mo),td=r(Mo,"P",{});var Dy=i(td);TT=s(Dy,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Dy.forEach(t),bT=c(Mo),v(Rn.$$.fragment,Mo),Mo.forEach(t),kT=c(je),Ct=r(je,"DIV",{class:!0});var ci=i(Ct);v(fa.$$.fragment,ci),vT=c(ci),nd=r(ci,"P",{});var Sy=i(nd);yT=s(Sy,"Moves the model to cpu from a model parallel state."),Sy.forEach(t),wT=c(ci),v(Hn.$$.fragment,ci),ci.forEach(t),je.forEach(t),Jc=c(n),Xt=r(n,"H2",{class:!0});var Rp=i(Xt);Vn=r(Rp,"A",{id:!0,class:!0,href:!0});var Gy=i(Vn);od=r(Gy,"SPAN",{});var Uy=i(od);v(_a.$$.fragment,Uy),Uy.forEach(t),Gy.forEach(t),$T=c(Rp),sd=r(Rp,"SPAN",{});var By=i(sd);xT=s(By,"TFT5Model"),By.forEach(t),Rp.forEach(t),Xc=c(n),le=r(n,"DIV",{class:!0});var Ke=i(le);v(ga.$$.fragment,Ke),zT=c(Ke),ad=r(Ke,"P",{});var Wy=i(ad);jT=s(Wy,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),Wy.forEach(t),ET=c(Ke),Ta=r(Ke,"P",{});var Hp=i(Ta);qT=s(Hp,"The T5 model was proposed in "),ba=r(Hp,"A",{href:!0,rel:!0});var Ry=i(ba);FT=s(Ry,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ry.forEach(t),MT=s(Hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Hp.forEach(t),CT=c(Ke),ka=r(Ke,"P",{});var Vp=i(ka);PT=s(Vp,"This model inherits from "),Ur=r(Vp,"A",{href:!0});var Hy=i(Ur);NT=s(Hy,"TFPreTrainedModel"),Hy.forEach(t),OT=s(Vp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vp.forEach(t),LT=c(Ke),va=r(Ke,"P",{});var Kp=i(va);AT=s(Kp,"This model is also a "),ya=r(Kp,"A",{href:!0,rel:!0});var Vy=i(ya);IT=s(Vy,"tf.keras.Model"),Vy.forEach(t),DT=s(Kp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kp.forEach(t),ST=c(Ke),v(Kn.$$.fragment,Ke),GT=c(Ke),mt=r(Ke,"DIV",{class:!0});var Co=i(mt);v(wa.$$.fragment,Co),UT=c(Co),Qt=r(Co,"P",{});var pi=i(Qt);BT=s(pi,"The "),Br=r(pi,"A",{href:!0});var Ky=i(Br);WT=s(Ky,"TFT5Model"),Ky.forEach(t),RT=s(pi," forward method, overrides the "),rd=r(pi,"CODE",{});var Yy=i(rd);HT=s(Yy,"__call__"),Yy.forEach(t),VT=s(pi," special method."),pi.forEach(t),KT=c(Co),v(Yn.$$.fragment,Co),YT=c(Co),v(Zn.$$.fragment,Co),Co.forEach(t),Ke.forEach(t),Qc=c(n),en=r(n,"H2",{class:!0});var Yp=i(en);Jn=r(Yp,"A",{id:!0,class:!0,href:!0});var Zy=i(Jn);id=r(Zy,"SPAN",{});var Jy=i(id);v($a.$$.fragment,Jy),Jy.forEach(t),Zy.forEach(t),ZT=c(Yp),ld=r(Yp,"SPAN",{});var Xy=i(ld);JT=s(Xy,"TFT5ForConditionalGeneration"),Xy.forEach(t),Yp.forEach(t),ep=c(n),de=r(n,"DIV",{class:!0});var Ye=i(de);v(xa.$$.fragment,Ye),XT=c(Ye),za=r(Ye,"P",{});var Zp=i(za);QT=s(Zp,"T5 Model with a "),dd=r(Zp,"CODE",{});var Qy=i(dd);eb=s(Qy,"language modeling"),Qy.forEach(t),tb=s(Zp," head on top."),Zp.forEach(t),nb=c(Ye),ja=r(Ye,"P",{});var Jp=i(ja);ob=s(Jp,"The T5 model was proposed in "),Ea=r(Jp,"A",{href:!0,rel:!0});var e5=i(Ea);sb=s(e5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),e5.forEach(t),ab=s(Jp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Jp.forEach(t),rb=c(Ye),qa=r(Ye,"P",{});var Xp=i(qa);ib=s(Xp,"This model inherits from "),Wr=r(Xp,"A",{href:!0});var t5=i(Wr);lb=s(t5,"TFPreTrainedModel"),t5.forEach(t),db=s(Xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xp.forEach(t),cb=c(Ye),Fa=r(Ye,"P",{});var Qp=i(Fa);pb=s(Qp,"This model is also a "),Ma=r(Qp,"A",{href:!0,rel:!0});var n5=i(Ma);hb=s(n5,"tf.keras.Model"),n5.forEach(t),ub=s(Qp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qp.forEach(t),mb=c(Ye),v(Xn.$$.fragment,Ye),fb=c(Ye),ft=r(Ye,"DIV",{class:!0});var Po=i(ft);v(Ca.$$.fragment,Po),_b=c(Po),tn=r(Po,"P",{});var hi=i(tn);gb=s(hi,"The "),Rr=r(hi,"A",{href:!0});var o5=i(Rr);Tb=s(o5,"TFT5ForConditionalGeneration"),o5.forEach(t),bb=s(hi," forward method, overrides the "),cd=r(hi,"CODE",{});var s5=i(cd);kb=s(s5,"__call__"),s5.forEach(t),vb=s(hi," special method."),hi.forEach(t),yb=c(Po),v(Qn.$$.fragment,Po),wb=c(Po),v(eo.$$.fragment,Po),Po.forEach(t),Ye.forEach(t),tp=c(n),nn=r(n,"H2",{class:!0});var eh=i(nn);to=r(eh,"A",{id:!0,class:!0,href:!0});var a5=i(to);pd=r(a5,"SPAN",{});var r5=i(pd);v(Pa.$$.fragment,r5),r5.forEach(t),a5.forEach(t),$b=c(eh),hd=r(eh,"SPAN",{});var i5=i(hd);xb=s(i5,"TFT5EncoderModel"),i5.forEach(t),eh.forEach(t),np=c(n),ce=r(n,"DIV",{class:!0});var Ze=i(ce);v(Na.$$.fragment,Ze),zb=c(Ze),ud=r(Ze,"P",{});var l5=i(ud);jb=s(l5,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),l5.forEach(t),Eb=c(Ze),Oa=r(Ze,"P",{});var th=i(Oa);qb=s(th,"The T5 model was proposed in "),La=r(th,"A",{href:!0,rel:!0});var d5=i(La);Fb=s(d5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),d5.forEach(t),Mb=s(th,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),th.forEach(t),Cb=c(Ze),Aa=r(Ze,"P",{});var nh=i(Aa);Pb=s(nh,"This model inherits from "),Hr=r(nh,"A",{href:!0});var c5=i(Hr);Nb=s(c5,"TFPreTrainedModel"),c5.forEach(t),Ob=s(nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nh.forEach(t),Lb=c(Ze),Ia=r(Ze,"P",{});var oh=i(Ia);Ab=s(oh,"This model is also a "),Da=r(oh,"A",{href:!0,rel:!0});var p5=i(Da);Ib=s(p5,"tf.keras.Model"),p5.forEach(t),Db=s(oh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),oh.forEach(t),Sb=c(Ze),v(no.$$.fragment,Ze),Gb=c(Ze),_t=r(Ze,"DIV",{class:!0});var No=i(_t);v(Sa.$$.fragment,No),Ub=c(No),on=r(No,"P",{});var ui=i(on);Bb=s(ui,"The "),Vr=r(ui,"A",{href:!0});var h5=i(Vr);Wb=s(h5,"TFT5EncoderModel"),h5.forEach(t),Rb=s(ui," forward method, overrides the "),md=r(ui,"CODE",{});var u5=i(md);Hb=s(u5,"__call__"),u5.forEach(t),Vb=s(ui," special method."),ui.forEach(t),Kb=c(No),v(oo.$$.fragment,No),Yb=c(No),v(so.$$.fragment,No),No.forEach(t),Ze.forEach(t),op=c(n),sn=r(n,"H2",{class:!0});var sh=i(sn);ao=r(sh,"A",{id:!0,class:!0,href:!0});var m5=i(ao);fd=r(m5,"SPAN",{});var f5=i(fd);v(Ga.$$.fragment,f5),f5.forEach(t),m5.forEach(t),Zb=c(sh),_d=r(sh,"SPAN",{});var _5=i(_d);Jb=s(_5,"FlaxT5Model"),_5.forEach(t),sh.forEach(t),sp=c(n),Je=r(n,"DIV",{class:!0});var Oo=i(Je);v(Ua.$$.fragment,Oo),Xb=c(Oo),gt=r(Oo,"DIV",{class:!0});var Lo=i(gt);v(Ba.$$.fragment,Lo),Qb=c(Lo),an=r(Lo,"P",{});var mi=i(an);ek=s(mi,"The "),gd=r(mi,"CODE",{});var g5=i(gd);tk=s(g5,"FlaxT5PreTrainedModel"),g5.forEach(t),nk=s(mi," forward method, overrides the "),Td=r(mi,"CODE",{});var T5=i(Td);ok=s(T5,"__call__"),T5.forEach(t),sk=s(mi," special method."),mi.forEach(t),ak=c(Lo),v(ro.$$.fragment,Lo),rk=c(Lo),v(io.$$.fragment,Lo),Lo.forEach(t),ik=c(Oo),lo=r(Oo,"DIV",{class:!0});var ah=i(lo);v(Wa.$$.fragment,ah),lk=c(ah),v(co.$$.fragment,ah),ah.forEach(t),dk=c(Oo),po=r(Oo,"DIV",{class:!0});var rh=i(po);v(Ra.$$.fragment,rh),ck=c(rh),v(ho.$$.fragment,rh),rh.forEach(t),Oo.forEach(t),ap=c(n),rn=r(n,"H2",{class:!0});var ih=i(rn);uo=r(ih,"A",{id:!0,class:!0,href:!0});var b5=i(uo);bd=r(b5,"SPAN",{});var k5=i(bd);v(Ha.$$.fragment,k5),k5.forEach(t),b5.forEach(t),pk=c(ih),kd=r(ih,"SPAN",{});var v5=i(kd);hk=s(v5,"FlaxT5ForConditionalGeneration"),v5.forEach(t),ih.forEach(t),rp=c(n),Xe=r(n,"DIV",{class:!0});var Ao=i(Xe);v(Va.$$.fragment,Ao),uk=c(Ao),Tt=r(Ao,"DIV",{class:!0});var Io=i(Tt);v(Ka.$$.fragment,Io),mk=c(Io),ln=r(Io,"P",{});var fi=i(ln);fk=s(fi,"The "),vd=r(fi,"CODE",{});var y5=i(vd);_k=s(y5,"FlaxT5PreTrainedModel"),y5.forEach(t),gk=s(fi," forward method, overrides the "),yd=r(fi,"CODE",{});var w5=i(yd);Tk=s(w5,"__call__"),w5.forEach(t),bk=s(fi," special method."),fi.forEach(t),kk=c(Io),v(mo.$$.fragment,Io),vk=c(Io),v(fo.$$.fragment,Io),Io.forEach(t),yk=c(Ao),_o=r(Ao,"DIV",{class:!0});var lh=i(_o);v(Ya.$$.fragment,lh),wk=c(lh),v(go.$$.fragment,lh),lh.forEach(t),$k=c(Ao),To=r(Ao,"DIV",{class:!0});var dh=i(To);v(Za.$$.fragment,dh),xk=c(dh),v(bo.$$.fragment,dh),dh.forEach(t),Ao.forEach(t),ip=c(n),dn=r(n,"H2",{class:!0});var ch=i(dn);ko=r(ch,"A",{id:!0,class:!0,href:!0});var $5=i(ko);wd=r($5,"SPAN",{});var x5=i(wd);v(Ja.$$.fragment,x5),x5.forEach(t),$5.forEach(t),zk=c(ch),$d=r(ch,"SPAN",{});var z5=i($d);jk=s(z5,"FlaxT5EncoderModel"),z5.forEach(t),ch.forEach(t),lp=c(n),cn=r(n,"DIV",{class:!0});var ph=i(cn);v(Xa.$$.fragment,ph),Ek=c(ph),Pt=r(ph,"DIV",{class:!0});var _i=i(Pt);v(Qa.$$.fragment,_i),qk=c(_i),pn=r(_i,"P",{});var gi=i(pn);Fk=s(gi,"The "),Kr=r(gi,"A",{href:!0});var j5=i(Kr);Mk=s(j5,"FlaxT5EncoderModel"),j5.forEach(t),Ck=s(gi," forward method, overrides the "),xd=r(gi,"CODE",{});var E5=i(xd);Pk=s(E5,"__call__"),E5.forEach(t),Nk=s(gi," special method."),gi.forEach(t),Ok=c(_i),v(vo.$$.fragment,_i),_i.forEach(t),ph.forEach(t),this.h()},h(){h(p,"name","hf:doc:metadata"),h(p,"content",JSON.stringify(pw)),h(u,"id","t5"),h(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(u,"href","#t5"),h(g,"class","relative group"),h(ee,"id","overview"),h(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ee,"href","#overview"),h(q,"class","relative group"),h(re,"href","https://arxiv.org/pdf/1910.10683.pdf"),h(re,"rel","nofollow"),h(L,"href","#training"),h(Le,"href","#inference"),h(Ae,"href","#scripts"),h(Do,"href","https://huggingface.co/t5-small"),h(Do,"rel","nofollow"),h(So,"href","https://huggingface.co/t5-base"),h(So,"rel","nofollow"),h(Go,"href","https://huggingface.co/t5-large"),h(Go,"rel","nofollow"),h(Uo,"href","https://huggingface.co/t5-3b"),h(Uo,"rel","nofollow"),h(Bo,"href","https://huggingface.co/t5-11b"),h(Bo,"rel","nofollow"),h(rr,"href","t5v1.1"),h(ir,"href","mt5"),h(lr,"href","byt5"),h(Wo,"href","https://huggingface.co/models?search=t5"),h(Wo,"rel","nofollow"),h(Ro,"href","https://huggingface.co/thomwolf"),h(Ro,"rel","nofollow"),h(Ho,"href","https://github.com/google-research/text-to-text-transfer-transformer"),h(Ho,"rel","nofollow"),h(dr,"id","training"),h(Tn,"id","training"),h(Tn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Tn,"href","#training"),h(Lt,"class","relative group"),h(cr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5ForConditionalGeneration"),h(hr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5Tokenizer"),h(Yo,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/language-modeling"),h(Yo,"rel","nofollow"),h(Jo,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/summarization"),h(Jo,"rel","nofollow"),h(es,"href","https://discuss.huggingface.co/t/t5-finetuning-tips/684"),h(es,"rel","nofollow"),h(ts,"href","https://arxiv.org/pdf/1910.10683.pdf"),h(ts,"rel","nofollow"),h(Tr,"id","inference"),h(yn,"id","inference"),h(yn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(yn,"href","#inference"),h(At,"class","relative group"),h(br,"href","/docs/transformers/pr_17969/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(os,"href","https://huggingface.co/blog/how-to-generate"),h(os,"rel","nofollow"),h(ss,"href","https://huggingface.co/blog/encoder-decoder#encoder-decoder"),h(ss,"rel","nofollow"),h(kr,"href","/docs/transformers/pr_17969/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(wr,"id","scripts"),h(wn,"id","performance"),h(wn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(wn,"href","#performance"),h(It,"class","relative group"),h(ds,"href","https://github.com/NVIDIA/apex#quick-start"),h(ds,"rel","nofollow"),h($n,"id","example-scripts"),h($n,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h($n,"href","#example-scripts"),h(Dt,"class","relative group"),h(ps,"href","https://github.com/huggingface/transformers/blob/main/examples/flax/language-modeling/run_t5_mlm_flax.py"),h(ps,"rel","nofollow"),h(hs,"href","https://github.com/huggingface/transformers/blob/main/examples/flax/language-modeling/t5_tokenizer_model.py"),h(hs,"rel","nofollow"),h(us,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/summarization"),h(us,"rel","nofollow"),h(ms,"href","https://github.com/huggingface/transformers/tree/main/examples/tensorflow/summarization"),h(ms,"rel","nofollow"),h(fs,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/summarization"),h(fs,"rel","nofollow"),h(_s,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/translation"),h(_s,"rel","nofollow"),h(gs,"href","https://github.com/huggingface/transformers/tree/main/examples/tensorflow/translation"),h(gs,"rel","nofollow"),h(zn,"id","transformers.T5Config"),h(zn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(zn,"href","#transformers.T5Config"),h(Gt,"class","relative group"),h(xr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5Model"),h(zr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.TFT5Model"),h(ks,"href","https://huggingface.co/t5-small"),h(ks,"rel","nofollow"),h(jr,"href","/docs/transformers/pr_17969/en/main_classes/configuration#transformers.PretrainedConfig"),h(Er,"href","/docs/transformers/pr_17969/en/main_classes/configuration#transformers.PretrainedConfig"),h(vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(jn,"id","transformers.T5Tokenizer"),h(jn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(jn,"href","#transformers.T5Tokenizer"),h(Bt,"class","relative group"),h($s,"href","https://github.com/google/sentencepiece"),h($s,"rel","nofollow"),h(qr,"href","/docs/transformers/pr_17969/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),h(Et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(En,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(qn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Cr,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Fn,"id","transformers.T5TokenizerFast"),h(Fn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Fn,"href","#transformers.T5TokenizerFast"),h(Wt,"class","relative group"),h(Ns,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),h(Ns,"rel","nofollow"),h(Pr,"href","/docs/transformers/pr_17969/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),h(qt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Mn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Cn,"id","transformers.T5Model"),h(Cn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Cn,"href","#transformers.T5Model"),h(Ht,"class","relative group"),h(Us,"href","https://arxiv.org/abs/1910.10683"),h(Us,"rel","nofollow"),h(Lr,"href","/docs/transformers/pr_17969/en/main_classes/model#transformers.PreTrainedModel"),h(Rs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Rs,"rel","nofollow"),h(Ar,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5Model"),h(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(dt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(An,"id","transformers.T5ForConditionalGeneration"),h(An,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(An,"href","#transformers.T5ForConditionalGeneration"),h(Kt,"class","relative group"),h(Qs,"href","https://arxiv.org/abs/1910.10683"),h(Qs,"rel","nofollow"),h(Ir,"href","/docs/transformers/pr_17969/en/main_classes/model#transformers.PreTrainedModel"),h(na,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(na,"rel","nofollow"),h(Dr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5ForConditionalGeneration"),h(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Un,"id","transformers.T5EncoderModel"),h(Un,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Un,"href","#transformers.T5EncoderModel"),h(Zt,"class","relative group"),h(da,"href","https://arxiv.org/abs/1910.10683"),h(da,"rel","nofollow"),h(Sr,"href","/docs/transformers/pr_17969/en/main_classes/model#transformers.PreTrainedModel"),h(ha,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(ha,"rel","nofollow"),h(Gr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.T5EncoderModel"),h(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ut,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Vn,"id","transformers.TFT5Model"),h(Vn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Vn,"href","#transformers.TFT5Model"),h(Xt,"class","relative group"),h(ba,"href","https://arxiv.org/abs/1910.10683"),h(ba,"rel","nofollow"),h(Ur,"href","/docs/transformers/pr_17969/en/main_classes/model#transformers.TFPreTrainedModel"),h(ya,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(ya,"rel","nofollow"),h(Br,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.TFT5Model"),h(mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Jn,"id","transformers.TFT5ForConditionalGeneration"),h(Jn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Jn,"href","#transformers.TFT5ForConditionalGeneration"),h(en,"class","relative group"),h(Ea,"href","https://arxiv.org/abs/1910.10683"),h(Ea,"rel","nofollow"),h(Wr,"href","/docs/transformers/pr_17969/en/main_classes/model#transformers.TFPreTrainedModel"),h(Ma,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Ma,"rel","nofollow"),h(Rr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.TFT5ForConditionalGeneration"),h(ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(to,"id","transformers.TFT5EncoderModel"),h(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(to,"href","#transformers.TFT5EncoderModel"),h(nn,"class","relative group"),h(La,"href","https://arxiv.org/abs/1910.10683"),h(La,"rel","nofollow"),h(Hr,"href","/docs/transformers/pr_17969/en/main_classes/model#transformers.TFPreTrainedModel"),h(Da,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Da,"rel","nofollow"),h(Vr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.TFT5EncoderModel"),h(_t,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ao,"id","transformers.FlaxT5Model"),h(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ao,"href","#transformers.FlaxT5Model"),h(sn,"class","relative group"),h(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(lo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(po,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(uo,"id","transformers.FlaxT5ForConditionalGeneration"),h(uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(uo,"href","#transformers.FlaxT5ForConditionalGeneration"),h(rn,"class","relative group"),h(Tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(_o,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(To,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ko,"id","transformers.FlaxT5EncoderModel"),h(ko,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ko,"href","#transformers.FlaxT5EncoderModel"),h(dn,"class","relative group"),h(Kr,"href","/docs/transformers/pr_17969/en/model_doc/t5#transformers.FlaxT5EncoderModel"),h(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(cn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,f){e(document.head,p),m(n,b,f),m(n,g,f),e(g,u),e(u,T),y(l,T,null),e(g,_),e(g,E),e(E,Ee),m(n,se,f),m(n,q,f),e(q,ee),e(ee,G),y(ae,G,null),e(q,qe),e(q,U),e(U,Fe),m(n,ve,f),m(n,B,f),e(B,A),e(B,re),e(re,pe),e(B,C),m(n,N,f),m(n,he,f),e(he,K),m(n,ye,f),m(n,ue,f),e(ue,W),e(W,Me),m(n,we,f),m(n,P,f),e(P,Ce),m(n,H,f),m(n,V,f),e(V,be),e(be,O),e(O,Pe),e(O,ke),e(ke,I),e(O,Ne),e(O,R),e(R,Oe),e(O,z),e(V,F),e(V,te),e(te,Ge),e(Ge,et),e(V,D),e(V,Ue),e(Ue,ne),e(ne,tt),e(ne,L),e(L,Y),e(ne,nt),e(ne,Le),e(Le,Z),e(ne,ot),e(ne,Ae),e(Ae,Ie),e(ne,st),m(n,Xd,f),m(n,or,f),e(or,hh),m(n,Qd,f),m(n,Be,f),e(Be,Ti),e(Ti,bi),e(bi,Do),e(Do,uh),e(Be,mh),e(Be,ki),e(ki,vi),e(vi,So),e(So,fh),e(Be,_h),e(Be,yi),e(yi,wi),e(wi,Go),e(Go,gh),e(Be,Th),e(Be,$i),e($i,xi),e(xi,Uo),e(Uo,bh),e(Be,kh),e(Be,zi),e(zi,sr),e(sr,Bo),e(Bo,vh),e(sr,yh),m(n,ec,f),m(n,ar,f),e(ar,wh),m(n,tc,f),m(n,$t,f),e($t,ji),e(ji,mn),e(mn,Ei),e(Ei,$h),e(mn,xh),e(mn,rr),e(rr,zh),e(mn,jh),e($t,Eh),e($t,qi),e(qi,fn),e(fn,Fi),e(Fi,qh),e(fn,Fh),e(fn,ir),e(ir,Mh),e(fn,Ch),e($t,Ph),e($t,Mi),e(Mi,_n),e(_n,Ci),e(Ci,Nh),e(_n,Oh),e(_n,lr),e(lr,Lh),e(_n,Ah),m(n,nc,f),m(n,gn,f),e(gn,Ih),e(gn,Wo),e(Wo,Dh),e(gn,Sh),m(n,oc,f),m(n,xt,f),e(xt,Gh),e(xt,Ro),e(Ro,Uh),e(xt,Bh),e(xt,Ho),e(Ho,Wh),e(xt,Rh),m(n,sc,f),m(n,dr,f),m(n,ac,f),m(n,Lt,f),e(Lt,Tn),e(Tn,Pi),y(Vo,Pi,null),e(Lt,Hh),e(Lt,Ni),e(Ni,Vh),m(n,rc,f),m(n,at,f),e(at,Kh),e(at,Oi),e(Oi,Yh),e(at,Zh),e(at,Li),e(Li,Jh),e(at,Xh),e(at,Ai),e(Ai,Qh),e(at,eu),m(n,ic,f),m(n,bn,f),e(bn,tu),e(bn,cr),e(cr,nu),e(bn,ou),m(n,lc,f),m(n,pr,f),e(pr,Ii),e(Ii,su),m(n,dc,f),m(n,me,f),e(me,au),e(me,Di),e(Di,ru),e(me,iu),e(me,Si),e(Si,lu),e(me,du),e(me,Gi),e(Gi,cu),e(me,pu),e(me,Ui),e(Ui,hu),e(me,uu),e(me,Bi),e(Bi,mu),e(me,fu),e(me,hr),e(hr,_u),e(me,gu),m(n,cc,f),m(n,ur,f),e(ur,Tu),m(n,pc,f),y(Ko,n,f),m(n,hc,f),m(n,kn,f),e(kn,bu),e(kn,Yo),e(Yo,ku),e(kn,vu),m(n,uc,f),m(n,mr,f),e(mr,Wi),e(Wi,yu),m(n,mc,f),m(n,fr,f),e(fr,wu),m(n,fc,f),y(Zo,n,f),m(n,_c,f),m(n,oe,f),e(oe,$u),e(oe,Ri),e(Ri,xu),e(oe,zu),e(oe,Hi),e(Hi,ju),e(oe,Eu),e(oe,Vi),e(Vi,qu),e(oe,Fu),e(oe,Ki),e(Ki,Mu),e(oe,Cu),e(oe,Yi),e(Yi,Pu),e(oe,Nu),e(oe,Zi),e(Zi,Ou),e(oe,Lu),e(oe,Ji),e(Ji,Au),e(oe,Iu),m(n,gc,f),m(n,zt,f),e(zt,Du),e(zt,Xi),e(Xi,Su),e(zt,Gu),e(zt,Qi),e(Qi,Uu),e(zt,Bu),m(n,Tc,f),m(n,fe,f),e(fe,Wu),e(fe,el),e(el,Ru),e(fe,Hu),e(fe,tl),e(tl,Vu),e(fe,Ku),e(fe,nl),e(nl,Yu),e(fe,Zu),e(fe,ol),e(ol,Ju),e(fe,Xu),e(fe,Jo),e(Jo,Qu),e(fe,em),e(fe,sl),e(sl,tm),e(fe,nm),m(n,bc,f),y(Xo,n,f),m(n,kc,f),m(n,_r,f),e(_r,om),m(n,vc,f),m(n,gr,f),e(gr,Qo),e(Qo,sm),e(Qo,al),e(al,am),e(Qo,rm),m(n,yc,f),m(n,jt,f),e(jt,im),e(jt,es),e(es,lm),e(jt,dm),e(jt,ts),e(ts,cm),e(jt,pm),m(n,wc,f),m(n,vn,f),e(vn,hm),e(vn,rl),e(rl,um),e(vn,mm),m(n,$c,f),m(n,Tr,f),m(n,xc,f),m(n,At,f),e(At,yn),e(yn,il),y(ns,il,null),e(At,fm),e(At,ll),e(ll,_m),m(n,zc,f),m(n,rt,f),e(rt,gm),e(rt,br),e(br,Tm),e(rt,bm),e(rt,os),e(os,km),e(rt,vm),e(rt,ss),e(ss,ym),e(rt,wm),m(n,jc,f),y(as,n,f),m(n,Ec,f),m(n,We,f),e(We,$m),e(We,dl),e(dl,xm),e(We,zm),e(We,cl),e(cl,jm),e(We,Em),e(We,kr),e(kr,qm),e(We,Fm),e(We,pl),e(pl,Mm),e(We,Cm),m(n,qc,f),m(n,vr,f),e(vr,Pm),m(n,Fc,f),y(rs,n,f),m(n,Mc,f),m(n,yr,f),e(yr,Nm),m(n,Cc,f),y(is,n,f),m(n,Pc,f),m(n,wr,f),m(n,Nc,f),m(n,It,f),e(It,wn),e(wn,hl),y(ls,hl,null),e(It,Om),e(It,ul),e(ul,Lm),m(n,Oc,f),m(n,it,f),e(it,Am),e(it,ds),e(ds,Im),e(it,Dm),e(it,ml),e(ml,Sm),e(it,Gm),e(it,fl),e(fl,Um),e(it,Bm),m(n,Lc,f),m(n,Dt,f),e(Dt,$n),e($n,_l),y(cs,_l,null),e(Dt,Wm),e(Dt,gl),e(gl,Rm),m(n,Ac,f),m(n,$r,f),e($r,Hm),m(n,Ic,f),m(n,xn,f),e(xn,Tl),e(Tl,St),e(St,Vm),e(St,ps),e(ps,Km),e(St,Ym),e(St,hs),e(hs,Zm),e(St,Jm),e(xn,Xm),e(xn,bl),e(bl,De),e(De,Qm),e(De,us),e(us,ef),e(De,tf),e(De,ms),e(ms,nf),e(De,of),e(De,fs),e(fs,sf),e(De,af),e(De,_s),e(_s,rf),e(De,lf),e(De,gs),e(gs,df),e(De,cf),m(n,Dc,f),m(n,Gt,f),e(Gt,zn),e(zn,kl),y(Ts,kl,null),e(Gt,pf),e(Gt,vl),e(vl,hf),m(n,Sc,f),m(n,vt,f),y(bs,vt,null),e(vt,uf),e(vt,yt),e(yt,mf),e(yt,xr),e(xr,ff),e(yt,_f),e(yt,zr),e(zr,gf),e(yt,Tf),e(yt,ks),e(ks,bf),e(yt,kf),e(vt,vf),e(vt,Ut),e(Ut,yf),e(Ut,jr),e(jr,wf),e(Ut,$f),e(Ut,Er),e(Er,xf),e(Ut,zf),m(n,Gc,f),m(n,Bt,f),e(Bt,jn),e(jn,yl),y(vs,yl,null),e(Bt,jf),e(Bt,wl),e(wl,Ef),m(n,Uc,f),m(n,ie,f),y(ys,ie,null),e(ie,qf),e(ie,ws),e(ws,Ff),e(ws,$s),e($s,Mf),e(ws,Cf),e(ie,Pf),e(ie,xs),e(xs,Nf),e(xs,qr),e(qr,Of),e(xs,Lf),e(ie,Af),e(ie,Et),y(zs,Et,null),e(Et,If),e(Et,$l),e($l,Df),e(Et,Sf),e(Et,js),e(js,Fr),e(Fr,Gf),e(Fr,xl),e(xl,Uf),e(js,Bf),e(js,Mr),e(Mr,Wf),e(Mr,zl),e(zl,Rf),e(ie,Hf),e(ie,En),y(Es,En,null),e(En,Vf),e(En,qs),e(qs,Kf),e(qs,jl),e(jl,Yf),e(qs,Zf),e(ie,Jf),e(ie,qn),y(Fs,qn,null),e(qn,Xf),e(qn,El),e(El,Qf),e(ie,e_),e(ie,Cr),y(Ms,Cr,null),m(n,Bc,f),m(n,Wt,f),e(Wt,Fn),e(Fn,ql),y(Cs,ql,null),e(Wt,t_),e(Wt,Fl),e(Fl,n_),m(n,Wc,f),m(n,Se,f),y(Ps,Se,null),e(Se,o_),e(Se,Rt),e(Rt,s_),e(Rt,Ml),e(Ml,a_),e(Rt,r_),e(Rt,Ns),e(Ns,i_),e(Rt,l_),e(Se,d_),e(Se,Os),e(Os,c_),e(Os,Pr),e(Pr,p_),e(Os,h_),e(Se,u_),e(Se,qt),y(Ls,qt,null),e(qt,m_),e(qt,Cl),e(Cl,f_),e(qt,__),e(qt,As),e(As,Nr),e(Nr,g_),e(Nr,Pl),e(Pl,T_),e(As,b_),e(As,Or),e(Or,k_),e(Or,Nl),e(Nl,v_),e(Se,y_),e(Se,Mn),y(Is,Mn,null),e(Mn,w_),e(Mn,Ol),e(Ol,$_),m(n,Rc,f),m(n,Ht,f),e(Ht,Cn),e(Cn,Ll),y(Ds,Ll,null),e(Ht,x_),e(Ht,Al),e(Al,z_),m(n,Hc,f),m(n,J,f),y(Ss,J,null),e(J,j_),e(J,Il),e(Il,E_),e(J,q_),e(J,Gs),e(Gs,F_),e(Gs,Us),e(Us,M_),e(Gs,C_),e(J,P_),e(J,Bs),e(Bs,N_),e(Bs,Lr),e(Lr,O_),e(Bs,L_),e(J,A_),e(J,Ws),e(Ws,I_),e(Ws,Rs),e(Rs,D_),e(Ws,S_),e(J,G_),e(J,lt),y(Hs,lt,null),e(lt,U_),e(lt,Vt),e(Vt,B_),e(Vt,Ar),e(Ar,W_),e(Vt,R_),e(Vt,Dl),e(Dl,H_),e(Vt,V_),e(lt,K_),y(Pn,lt,null),e(lt,Y_),y(Nn,lt,null),e(J,Z_),e(J,dt),y(Vs,dt,null),e(dt,J_),e(dt,Sl),e(Sl,X_),e(dt,Q_),e(dt,Gl),e(Gl,eg),e(dt,tg),y(On,dt,null),e(J,ng),e(J,Ft),y(Ks,Ft,null),e(Ft,og),e(Ft,Ul),e(Ul,sg),e(Ft,ag),y(Ln,Ft,null),m(n,Vc,f),m(n,Kt,f),e(Kt,An),e(An,Bl),y(Ys,Bl,null),e(Kt,rg),e(Kt,Wl),e(Wl,ig),m(n,Kc,f),m(n,X,f),y(Zs,X,null),e(X,lg),e(X,Js),e(Js,dg),e(Js,Rl),e(Rl,cg),e(Js,pg),e(X,hg),e(X,Xs),e(Xs,ug),e(Xs,Qs),e(Qs,mg),e(Xs,fg),e(X,_g),e(X,ea),e(ea,gg),e(ea,Ir),e(Ir,Tg),e(ea,bg),e(X,kg),e(X,ta),e(ta,vg),e(ta,na),e(na,yg),e(ta,wg),e(X,$g),e(X,ct),y(oa,ct,null),e(ct,xg),e(ct,Yt),e(Yt,zg),e(Yt,Dr),e(Dr,jg),e(Yt,Eg),e(Yt,Hl),e(Hl,qg),e(Yt,Fg),e(ct,Mg),y(In,ct,null),e(ct,Cg),y(Dn,ct,null),e(X,Pg),e(X,pt),y(sa,pt,null),e(pt,Ng),e(pt,Vl),e(Vl,Og),e(pt,Lg),e(pt,Kl),e(Kl,Ag),e(pt,Ig),y(Sn,pt,null),e(X,Dg),e(X,Mt),y(aa,Mt,null),e(Mt,Sg),e(Mt,Yl),e(Yl,Gg),e(Mt,Ug),y(Gn,Mt,null),m(n,Yc,f),m(n,Zt,f),e(Zt,Un),e(Un,Zl),y(ra,Zl,null),e(Zt,Bg),e(Zt,Jl),e(Jl,Wg),m(n,Zc,f),m(n,Q,f),y(ia,Q,null),e(Q,Rg),e(Q,Xl),e(Xl,Hg),e(Q,Vg),e(Q,la),e(la,Kg),e(la,da),e(da,Yg),e(la,Zg),e(Q,Jg),e(Q,ca),e(ca,Xg),e(ca,Sr),e(Sr,Qg),e(ca,eT),e(Q,tT),e(Q,pa),e(pa,nT),e(pa,ha),e(ha,oT),e(pa,sT),e(Q,aT),e(Q,ht),y(ua,ht,null),e(ht,rT),e(ht,Jt),e(Jt,iT),e(Jt,Gr),e(Gr,lT),e(Jt,dT),e(Jt,Ql),e(Ql,cT),e(Jt,pT),e(ht,hT),y(Bn,ht,null),e(ht,uT),y(Wn,ht,null),e(Q,mT),e(Q,ut),y(ma,ut,null),e(ut,fT),e(ut,ed),e(ed,_T),e(ut,gT),e(ut,td),e(td,TT),e(ut,bT),y(Rn,ut,null),e(Q,kT),e(Q,Ct),y(fa,Ct,null),e(Ct,vT),e(Ct,nd),e(nd,yT),e(Ct,wT),y(Hn,Ct,null),m(n,Jc,f),m(n,Xt,f),e(Xt,Vn),e(Vn,od),y(_a,od,null),e(Xt,$T),e(Xt,sd),e(sd,xT),m(n,Xc,f),m(n,le,f),y(ga,le,null),e(le,zT),e(le,ad),e(ad,jT),e(le,ET),e(le,Ta),e(Ta,qT),e(Ta,ba),e(ba,FT),e(Ta,MT),e(le,CT),e(le,ka),e(ka,PT),e(ka,Ur),e(Ur,NT),e(ka,OT),e(le,LT),e(le,va),e(va,AT),e(va,ya),e(ya,IT),e(va,DT),e(le,ST),y(Kn,le,null),e(le,GT),e(le,mt),y(wa,mt,null),e(mt,UT),e(mt,Qt),e(Qt,BT),e(Qt,Br),e(Br,WT),e(Qt,RT),e(Qt,rd),e(rd,HT),e(Qt,VT),e(mt,KT),y(Yn,mt,null),e(mt,YT),y(Zn,mt,null),m(n,Qc,f),m(n,en,f),e(en,Jn),e(Jn,id),y($a,id,null),e(en,ZT),e(en,ld),e(ld,JT),m(n,ep,f),m(n,de,f),y(xa,de,null),e(de,XT),e(de,za),e(za,QT),e(za,dd),e(dd,eb),e(za,tb),e(de,nb),e(de,ja),e(ja,ob),e(ja,Ea),e(Ea,sb),e(ja,ab),e(de,rb),e(de,qa),e(qa,ib),e(qa,Wr),e(Wr,lb),e(qa,db),e(de,cb),e(de,Fa),e(Fa,pb),e(Fa,Ma),e(Ma,hb),e(Fa,ub),e(de,mb),y(Xn,de,null),e(de,fb),e(de,ft),y(Ca,ft,null),e(ft,_b),e(ft,tn),e(tn,gb),e(tn,Rr),e(Rr,Tb),e(tn,bb),e(tn,cd),e(cd,kb),e(tn,vb),e(ft,yb),y(Qn,ft,null),e(ft,wb),y(eo,ft,null),m(n,tp,f),m(n,nn,f),e(nn,to),e(to,pd),y(Pa,pd,null),e(nn,$b),e(nn,hd),e(hd,xb),m(n,np,f),m(n,ce,f),y(Na,ce,null),e(ce,zb),e(ce,ud),e(ud,jb),e(ce,Eb),e(ce,Oa),e(Oa,qb),e(Oa,La),e(La,Fb),e(Oa,Mb),e(ce,Cb),e(ce,Aa),e(Aa,Pb),e(Aa,Hr),e(Hr,Nb),e(Aa,Ob),e(ce,Lb),e(ce,Ia),e(Ia,Ab),e(Ia,Da),e(Da,Ib),e(Ia,Db),e(ce,Sb),y(no,ce,null),e(ce,Gb),e(ce,_t),y(Sa,_t,null),e(_t,Ub),e(_t,on),e(on,Bb),e(on,Vr),e(Vr,Wb),e(on,Rb),e(on,md),e(md,Hb),e(on,Vb),e(_t,Kb),y(oo,_t,null),e(_t,Yb),y(so,_t,null),m(n,op,f),m(n,sn,f),e(sn,ao),e(ao,fd),y(Ga,fd,null),e(sn,Zb),e(sn,_d),e(_d,Jb),m(n,sp,f),m(n,Je,f),y(Ua,Je,null),e(Je,Xb),e(Je,gt),y(Ba,gt,null),e(gt,Qb),e(gt,an),e(an,ek),e(an,gd),e(gd,tk),e(an,nk),e(an,Td),e(Td,ok),e(an,sk),e(gt,ak),y(ro,gt,null),e(gt,rk),y(io,gt,null),e(Je,ik),e(Je,lo),y(Wa,lo,null),e(lo,lk),y(co,lo,null),e(Je,dk),e(Je,po),y(Ra,po,null),e(po,ck),y(ho,po,null),m(n,ap,f),m(n,rn,f),e(rn,uo),e(uo,bd),y(Ha,bd,null),e(rn,pk),e(rn,kd),e(kd,hk),m(n,rp,f),m(n,Xe,f),y(Va,Xe,null),e(Xe,uk),e(Xe,Tt),y(Ka,Tt,null),e(Tt,mk),e(Tt,ln),e(ln,fk),e(ln,vd),e(vd,_k),e(ln,gk),e(ln,yd),e(yd,Tk),e(ln,bk),e(Tt,kk),y(mo,Tt,null),e(Tt,vk),y(fo,Tt,null),e(Xe,yk),e(Xe,_o),y(Ya,_o,null),e(_o,wk),y(go,_o,null),e(Xe,$k),e(Xe,To),y(Za,To,null),e(To,xk),y(bo,To,null),m(n,ip,f),m(n,dn,f),e(dn,ko),e(ko,wd),y(Ja,wd,null),e(dn,zk),e(dn,$d),e($d,jk),m(n,lp,f),m(n,cn,f),y(Xa,cn,null),e(cn,Ek),e(cn,Pt),y(Qa,Pt,null),e(Pt,qk),e(Pt,pn),e(pn,Fk),e(pn,Kr),e(Kr,Mk),e(pn,Ck),e(pn,xd),e(xd,Pk),e(pn,Nk),e(Pt,Ok),y(vo,Pt,null),dp=!0},p(n,[f]){const er={};f&2&&(er.$$scope={dirty:f,ctx:n}),Pn.$set(er);const zd={};f&2&&(zd.$$scope={dirty:f,ctx:n}),Nn.$set(zd);const jd={};f&2&&(jd.$$scope={dirty:f,ctx:n}),On.$set(jd);const Ed={};f&2&&(Ed.$$scope={dirty:f,ctx:n}),Ln.$set(Ed);const tr={};f&2&&(tr.$$scope={dirty:f,ctx:n}),In.$set(tr);const qd={};f&2&&(qd.$$scope={dirty:f,ctx:n}),Dn.$set(qd);const Fd={};f&2&&(Fd.$$scope={dirty:f,ctx:n}),Sn.$set(Fd);const Md={};f&2&&(Md.$$scope={dirty:f,ctx:n}),Gn.$set(Md);const nr={};f&2&&(nr.$$scope={dirty:f,ctx:n}),Bn.$set(nr);const Cd={};f&2&&(Cd.$$scope={dirty:f,ctx:n}),Wn.$set(Cd);const Pd={};f&2&&(Pd.$$scope={dirty:f,ctx:n}),Rn.$set(Pd);const Nd={};f&2&&(Nd.$$scope={dirty:f,ctx:n}),Hn.$set(Nd);const Od={};f&2&&(Od.$$scope={dirty:f,ctx:n}),Kn.$set(Od);const Ld={};f&2&&(Ld.$$scope={dirty:f,ctx:n}),Yn.$set(Ld);const hn={};f&2&&(hn.$$scope={dirty:f,ctx:n}),Zn.$set(hn);const Ad={};f&2&&(Ad.$$scope={dirty:f,ctx:n}),Xn.$set(Ad);const un={};f&2&&(un.$$scope={dirty:f,ctx:n}),Qn.$set(un);const Id={};f&2&&(Id.$$scope={dirty:f,ctx:n}),eo.$set(Id);const Dd={};f&2&&(Dd.$$scope={dirty:f,ctx:n}),no.$set(Dd);const Sd={};f&2&&(Sd.$$scope={dirty:f,ctx:n}),oo.$set(Sd);const Gd={};f&2&&(Gd.$$scope={dirty:f,ctx:n}),so.$set(Gd);const Ud={};f&2&&(Ud.$$scope={dirty:f,ctx:n}),ro.$set(Ud);const wt={};f&2&&(wt.$$scope={dirty:f,ctx:n}),io.$set(wt);const Bd={};f&2&&(Bd.$$scope={dirty:f,ctx:n}),co.$set(Bd);const Wd={};f&2&&(Wd.$$scope={dirty:f,ctx:n}),ho.$set(Wd);const Rd={};f&2&&(Rd.$$scope={dirty:f,ctx:n}),mo.$set(Rd);const Hd={};f&2&&(Hd.$$scope={dirty:f,ctx:n}),fo.$set(Hd);const Qe={};f&2&&(Qe.$$scope={dirty:f,ctx:n}),go.$set(Qe);const Vd={};f&2&&(Vd.$$scope={dirty:f,ctx:n}),bo.$set(Vd);const Kd={};f&2&&(Kd.$$scope={dirty:f,ctx:n}),vo.$set(Kd)},i(n){dp||(w(l.$$.fragment,n),w(ae.$$.fragment,n),w(Vo.$$.fragment,n),w(Ko.$$.fragment,n),w(Zo.$$.fragment,n),w(Xo.$$.fragment,n),w(ns.$$.fragment,n),w(as.$$.fragment,n),w(rs.$$.fragment,n),w(is.$$.fragment,n),w(ls.$$.fragment,n),w(cs.$$.fragment,n),w(Ts.$$.fragment,n),w(bs.$$.fragment,n),w(vs.$$.fragment,n),w(ys.$$.fragment,n),w(zs.$$.fragment,n),w(Es.$$.fragment,n),w(Fs.$$.fragment,n),w(Ms.$$.fragment,n),w(Cs.$$.fragment,n),w(Ps.$$.fragment,n),w(Ls.$$.fragment,n),w(Is.$$.fragment,n),w(Ds.$$.fragment,n),w(Ss.$$.fragment,n),w(Hs.$$.fragment,n),w(Pn.$$.fragment,n),w(Nn.$$.fragment,n),w(Vs.$$.fragment,n),w(On.$$.fragment,n),w(Ks.$$.fragment,n),w(Ln.$$.fragment,n),w(Ys.$$.fragment,n),w(Zs.$$.fragment,n),w(oa.$$.fragment,n),w(In.$$.fragment,n),w(Dn.$$.fragment,n),w(sa.$$.fragment,n),w(Sn.$$.fragment,n),w(aa.$$.fragment,n),w(Gn.$$.fragment,n),w(ra.$$.fragment,n),w(ia.$$.fragment,n),w(ua.$$.fragment,n),w(Bn.$$.fragment,n),w(Wn.$$.fragment,n),w(ma.$$.fragment,n),w(Rn.$$.fragment,n),w(fa.$$.fragment,n),w(Hn.$$.fragment,n),w(_a.$$.fragment,n),w(ga.$$.fragment,n),w(Kn.$$.fragment,n),w(wa.$$.fragment,n),w(Yn.$$.fragment,n),w(Zn.$$.fragment,n),w($a.$$.fragment,n),w(xa.$$.fragment,n),w(Xn.$$.fragment,n),w(Ca.$$.fragment,n),w(Qn.$$.fragment,n),w(eo.$$.fragment,n),w(Pa.$$.fragment,n),w(Na.$$.fragment,n),w(no.$$.fragment,n),w(Sa.$$.fragment,n),w(oo.$$.fragment,n),w(so.$$.fragment,n),w(Ga.$$.fragment,n),w(Ua.$$.fragment,n),w(Ba.$$.fragment,n),w(ro.$$.fragment,n),w(io.$$.fragment,n),w(Wa.$$.fragment,n),w(co.$$.fragment,n),w(Ra.$$.fragment,n),w(ho.$$.fragment,n),w(Ha.$$.fragment,n),w(Va.$$.fragment,n),w(Ka.$$.fragment,n),w(mo.$$.fragment,n),w(fo.$$.fragment,n),w(Ya.$$.fragment,n),w(go.$$.fragment,n),w(Za.$$.fragment,n),w(bo.$$.fragment,n),w(Ja.$$.fragment,n),w(Xa.$$.fragment,n),w(Qa.$$.fragment,n),w(vo.$$.fragment,n),dp=!0)},o(n){$(l.$$.fragment,n),$(ae.$$.fragment,n),$(Vo.$$.fragment,n),$(Ko.$$.fragment,n),$(Zo.$$.fragment,n),$(Xo.$$.fragment,n),$(ns.$$.fragment,n),$(as.$$.fragment,n),$(rs.$$.fragment,n),$(is.$$.fragment,n),$(ls.$$.fragment,n),$(cs.$$.fragment,n),$(Ts.$$.fragment,n),$(bs.$$.fragment,n),$(vs.$$.fragment,n),$(ys.$$.fragment,n),$(zs.$$.fragment,n),$(Es.$$.fragment,n),$(Fs.$$.fragment,n),$(Ms.$$.fragment,n),$(Cs.$$.fragment,n),$(Ps.$$.fragment,n),$(Ls.$$.fragment,n),$(Is.$$.fragment,n),$(Ds.$$.fragment,n),$(Ss.$$.fragment,n),$(Hs.$$.fragment,n),$(Pn.$$.fragment,n),$(Nn.$$.fragment,n),$(Vs.$$.fragment,n),$(On.$$.fragment,n),$(Ks.$$.fragment,n),$(Ln.$$.fragment,n),$(Ys.$$.fragment,n),$(Zs.$$.fragment,n),$(oa.$$.fragment,n),$(In.$$.fragment,n),$(Dn.$$.fragment,n),$(sa.$$.fragment,n),$(Sn.$$.fragment,n),$(aa.$$.fragment,n),$(Gn.$$.fragment,n),$(ra.$$.fragment,n),$(ia.$$.fragment,n),$(ua.$$.fragment,n),$(Bn.$$.fragment,n),$(Wn.$$.fragment,n),$(ma.$$.fragment,n),$(Rn.$$.fragment,n),$(fa.$$.fragment,n),$(Hn.$$.fragment,n),$(_a.$$.fragment,n),$(ga.$$.fragment,n),$(Kn.$$.fragment,n),$(wa.$$.fragment,n),$(Yn.$$.fragment,n),$(Zn.$$.fragment,n),$($a.$$.fragment,n),$(xa.$$.fragment,n),$(Xn.$$.fragment,n),$(Ca.$$.fragment,n),$(Qn.$$.fragment,n),$(eo.$$.fragment,n),$(Pa.$$.fragment,n),$(Na.$$.fragment,n),$(no.$$.fragment,n),$(Sa.$$.fragment,n),$(oo.$$.fragment,n),$(so.$$.fragment,n),$(Ga.$$.fragment,n),$(Ua.$$.fragment,n),$(Ba.$$.fragment,n),$(ro.$$.fragment,n),$(io.$$.fragment,n),$(Wa.$$.fragment,n),$(co.$$.fragment,n),$(Ra.$$.fragment,n),$(ho.$$.fragment,n),$(Ha.$$.fragment,n),$(Va.$$.fragment,n),$(Ka.$$.fragment,n),$(mo.$$.fragment,n),$(fo.$$.fragment,n),$(Ya.$$.fragment,n),$(go.$$.fragment,n),$(Za.$$.fragment,n),$(bo.$$.fragment,n),$(Ja.$$.fragment,n),$(Xa.$$.fragment,n),$(Qa.$$.fragment,n),$(vo.$$.fragment,n),dp=!1},d(n){t(p),n&&t(b),n&&t(g),x(l),n&&t(se),n&&t(q),x(ae),n&&t(ve),n&&t(B),n&&t(N),n&&t(he),n&&t(ye),n&&t(ue),n&&t(we),n&&t(P),n&&t(H),n&&t(V),n&&t(Xd),n&&t(or),n&&t(Qd),n&&t(Be),n&&t(ec),n&&t(ar),n&&t(tc),n&&t($t),n&&t(nc),n&&t(gn),n&&t(oc),n&&t(xt),n&&t(sc),n&&t(dr),n&&t(ac),n&&t(Lt),x(Vo),n&&t(rc),n&&t(at),n&&t(ic),n&&t(bn),n&&t(lc),n&&t(pr),n&&t(dc),n&&t(me),n&&t(cc),n&&t(ur),n&&t(pc),x(Ko,n),n&&t(hc),n&&t(kn),n&&t(uc),n&&t(mr),n&&t(mc),n&&t(fr),n&&t(fc),x(Zo,n),n&&t(_c),n&&t(oe),n&&t(gc),n&&t(zt),n&&t(Tc),n&&t(fe),n&&t(bc),x(Xo,n),n&&t(kc),n&&t(_r),n&&t(vc),n&&t(gr),n&&t(yc),n&&t(jt),n&&t(wc),n&&t(vn),n&&t($c),n&&t(Tr),n&&t(xc),n&&t(At),x(ns),n&&t(zc),n&&t(rt),n&&t(jc),x(as,n),n&&t(Ec),n&&t(We),n&&t(qc),n&&t(vr),n&&t(Fc),x(rs,n),n&&t(Mc),n&&t(yr),n&&t(Cc),x(is,n),n&&t(Pc),n&&t(wr),n&&t(Nc),n&&t(It),x(ls),n&&t(Oc),n&&t(it),n&&t(Lc),n&&t(Dt),x(cs),n&&t(Ac),n&&t($r),n&&t(Ic),n&&t(xn),n&&t(Dc),n&&t(Gt),x(Ts),n&&t(Sc),n&&t(vt),x(bs),n&&t(Gc),n&&t(Bt),x(vs),n&&t(Uc),n&&t(ie),x(ys),x(zs),x(Es),x(Fs),x(Ms),n&&t(Bc),n&&t(Wt),x(Cs),n&&t(Wc),n&&t(Se),x(Ps),x(Ls),x(Is),n&&t(Rc),n&&t(Ht),x(Ds),n&&t(Hc),n&&t(J),x(Ss),x(Hs),x(Pn),x(Nn),x(Vs),x(On),x(Ks),x(Ln),n&&t(Vc),n&&t(Kt),x(Ys),n&&t(Kc),n&&t(X),x(Zs),x(oa),x(In),x(Dn),x(sa),x(Sn),x(aa),x(Gn),n&&t(Yc),n&&t(Zt),x(ra),n&&t(Zc),n&&t(Q),x(ia),x(ua),x(Bn),x(Wn),x(ma),x(Rn),x(fa),x(Hn),n&&t(Jc),n&&t(Xt),x(_a),n&&t(Xc),n&&t(le),x(ga),x(Kn),x(wa),x(Yn),x(Zn),n&&t(Qc),n&&t(en),x($a),n&&t(ep),n&&t(de),x(xa),x(Xn),x(Ca),x(Qn),x(eo),n&&t(tp),n&&t(nn),x(Pa),n&&t(np),n&&t(ce),x(Na),x(no),x(Sa),x(oo),x(so),n&&t(op),n&&t(sn),x(Ga),n&&t(sp),n&&t(Je),x(Ua),x(Ba),x(ro),x(io),x(Wa),x(co),x(Ra),x(ho),n&&t(ap),n&&t(rn),x(Ha),n&&t(rp),n&&t(Xe),x(Va),x(Ka),x(mo),x(fo),x(Ya),x(go),x(Za),x(bo),n&&t(ip),n&&t(dn),x(Ja),n&&t(lp),n&&t(cn),x(Xa),x(Qa),x(vo)}}}const pw={local:"t5",sections:[{local:"overview",title:"Overview"},{local:"training",title:"Training"},{local:"inference",title:"Inference"},{local:"performance",title:"Performance"},{local:"example-scripts",title:"Example scripts"},{local:"transformers.T5Config",title:"T5Config"},{local:"transformers.T5Tokenizer",title:"T5Tokenizer"},{local:"transformers.T5TokenizerFast",title:"T5TokenizerFast"},{local:"transformers.T5Model",title:"T5Model"},{local:"transformers.T5ForConditionalGeneration",title:"T5ForConditionalGeneration"},{local:"transformers.T5EncoderModel",title:"T5EncoderModel"},{local:"transformers.TFT5Model",title:"TFT5Model"},{local:"transformers.TFT5ForConditionalGeneration",title:"TFT5ForConditionalGeneration"},{local:"transformers.TFT5EncoderModel",title:"TFT5EncoderModel"},{local:"transformers.FlaxT5Model",title:"FlaxT5Model"},{local:"transformers.FlaxT5ForConditionalGeneration",title:"FlaxT5ForConditionalGeneration"},{local:"transformers.FlaxT5EncoderModel",title:"FlaxT5EncoderModel"}],title:"T5"};function hw(j){return P5(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class bw extends q5{constructor(p){super();F5(this,p,hw,cw,M5,{})}}export{bw as default,pw as metadata};
