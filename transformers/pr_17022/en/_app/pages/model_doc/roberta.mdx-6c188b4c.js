...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17022/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17022/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17022/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ZT=p(),Vr=n("p"),e2=r("This model is also a "),Jr=n("a"),t2=r("tf.keras.Model"),o2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),n2=p(),T(fs.$$.fragment),s2=p(),Rt=n("div"),T(Kr.$$.fragment),a2=p(),Wo=n("p"),r2=r("The "),sd=n("a"),i2=r("TFRobertaForMultipleChoice"),l2=r(" forward method, overrides the "),ap=n("code"),d2=r("__call__"),c2=r(" special method."),p2=p(),T(us.$$.fragment),h2=p(),T(gs.$$.fragment),Dm=p(),Bo=n("h2"),_s=n("a"),rp=n("span"),T(Gr.$$.fragment),m2=p(),ip=n("span"),f2=r("TFRobertaForTokenClassification"),Sm=p(),Ke=n("div"),T(Xr.$$.fragment),u2=p(),lp=n("p"),g2=r(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),_2=p(),Yr=n("p"),b2=r("This model inherits from "),ad=n("a"),k2=r("TFPreTrainedModel"),v2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),T2=p(),Zr=n("p"),y2=r("This model is also a "),ei=n("a"),w2=r("tf.keras.Model"),$2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),F2=p(),T(bs.$$.fragment),x2=p(),pt=n("div"),T(ti.$$.fragment),R2=p(),Uo=n("p"),M2=r("The "),rd=n("a"),E2=r("TFRobertaForTokenClassification"),z2=r(" forward method, overrides the "),dp=n("code"),q2=r("__call__"),C2=r(" special method."),j2=p(),T(ks.$$.fragment),P2=p(),T(vs.$$.fragment),L2=p(),T(Ts.$$.fragment),Wm=p(),Ho=n("h2"),ys=n("a"),cp=n("span"),T(oi.$$.fragment),A2=p(),pp=n("span"),O2=r("TFRobertaForQuestionAnswering"),Bm=p(),Ge=n("div"),T(ni.$$.fragment),N2=p(),Qo=n("p"),I2=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=n("code"),D2=r("span start logits"),S2=r(" and "),mp=n("code"),W2=r("span end logits"),B2=r(")."),U2=p(),si=n("p"),H2=r("This model inherits from "),id=n("a"),Q2=r("TFPreTrainedModel"),V2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),J2=p(),ai=n("p"),K2=r("This model is also a "),ri=n("a"),G2=r("tf.keras.Model"),X2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Y2=p(),T(ws.$$.fragment),Z2=p(),ht=n("div"),T(ii.$$.fragment),ey=p(),Vo=n("p"),ty=r("The "),ld=n("a"),oy=r("TFRobertaForQuestionAnswering"),ny=r(" forward method, overrides the "),fp=n("code"),sy=r("__call__"),ay=r(" special method."),ry=p(),T($s.$$.fragment),iy=p(),T(Fs.$$.fragment),ly=p(),T(xs.$$.fragment),Um=p(),Jo=n("h2"),Rs=n("a"),up=n("span"),T(li.$$.fragment),dy=p(),gp=n("span"),cy=r("FlaxRobertaModel"),Hm=p(),Oe=n("div"),T(di.$$.fragment),py=p(),_p=n("p"),hy=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),my=p(),ci=n("p"),fy=r("This model inherits from "),dd=n("a"),uy=r("FlaxPreTrainedModel"),gy=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),I1=p(),sh=n("p"),D1=r("Finally, this model supports inherent JAX features such as:"),S1=p(),Ht=n("ul"),ah=n("li"),el=n("a"),W1=r("Just-In-Time (JIT) compilation"),B1=p(),rh=n("li"),tl=n("a"),U1=r("Automatic Differentiation"),H1=p(),ih=n("li"),ol=n("a"),Q1=r("Vectorization"),V1=p(),lh=n("li"),nl=n("a"),J1=r("Parallelization"),K1=p(),Ct=n("div"),T(sl.$$.fragment),G1=p(),nn=n("p"),X1=r("The "),dh=n("code"),Y1=r("FlaxRobertaPreTrainedModel"),Z1=r(" forward method, overrides the "),ch=n("code"),e$=r("__call__"),t$=r(" special method."),o$=p(),T(Ds.$$.fragment),n$=p(),T(Ss.$$.fragment),ef=p(),sn=n("h2"),Ws=n("a"),ph=n("span"),T(al.$$.fragment),s$=p(),hh=n("span"),a$=r("FlaxRobertaForQuestionAnswering"),tf=p(),We=n("div"),T(rl.$$.fragment),r$=p(),an=n("p"),i$=r(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),mh=n("code"),l$=r("span start logits"),d$=r(" and "),fh=n("code"),c$=r("span end logits"),p$=r(")."),h$=p(),il=n("p"),m$=r("This model inherits from "),fd=n("a"),f$=r("FlaxPreTrainedModel"),u$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),g$=p(),ll=n("p"),_$=r("This model is also a Flax Linen "),dl=n("a"),b$=r("flax.linen.Module"),k$=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),v$=p(),uh=n("p"),T$=r("Finally, this model supports inherent JAX features such as:"),y$=p(),Qt=n("ul"),gh=n("li"),cl=n("a"),w$=r("Just-In-Time (JIT) compilation"),$$=p(),_h=n("li"),pl=n("a"),F$=r("Automatic Differentiation"),x$=p(),bh=n("li"),hl=n("a"),R$=r("Vectorization"),M$=p(),kh=n("li"),ml=n("a"),E$=r("Parallelization"),z$=p(),jt=n("div"),T(fl.$$.fragment),q$=p(),rn=n("p"),C$=r("The "),vh=n("code"),j$=r("FlaxRobertaPreTrainedModel"),P$=r(" forward method, overrides the "),Th=n("code"),L$=r("__call__"),A$=r(" special method."),O$=p(),T(Bs.$$.fragment),N$=p(),T(Us.$$.fragment),this.h()},l(o){const b=rM('[data-svelte="svelte-1phssyn"]',document.head);d=s(b,"META",{name:!0,content:!0}),b.forEach(t),g=h(o),c=s(o,"H1",{class:!0});var ul=a(c);m=s(ul,"A",{id:!0,class:!0,href:!0});var yh=a(m);_=s(yh,"SPAN",{});var wh=a(_);y(l.$$.fragment,wh),wh.forEach(t),yh.forEach(t),f=h(ul),M=s(ul,"SPAN",{});var $h=a(M);Y=i($h,"RoBERTa"),$h.forEach(t),ul.forEach(t),I=h(o),z=s(o,"H2",{class:!0});var gl=a(z);X=s(gl,"A",{id:!0,class:!0,href:!0});var Fh=a(X);D=s(Fh,"SPAN",{});var xh=a(D);y(se.$$.fragment,xh),xh.forEach(t),Fh.forEach(t),be=h(gl),S=s(gl,"SPAN",{});var Rh=a(S);ke=i(Rh,"Overview"),Rh.forEach(t),gl.forEach(t),fe=h(o),K=s(o,"P",{});var _l=a(K);A=i(_l,"The RoBERTa model was proposed in "),ae=s(_l,"A",{href:!0,rel:!0});var Mh=a(ae);Z=i(Mh,"RoBERTa: A Robustly Optimized BERT Pretraining Approach"),Mh.forEach(t),q=i(_l,` by Yinhan Liu, Myle Ott, Naman Goyal, Jingfei Du, Mandar Joshi, Danqi Chen, Omer
...
special tokens using the tokenizer `),Xd=s(sf,"CODE",{});var I$=a(Xd);Fg=i(I$,"prepare_for_model"),I$.forEach(t),xg=i(sf," method."),sf.forEach(t),nf.forEach(t),Rg=h($e),bn=s($e,"DIV",{class:!0});var af=a(bn);y(ya.$$.fragment,af),Mg=h(af),Yd=s(af,"P",{});var D$=a(Yd);Eg=i(D$,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),D$.forEach(t),af.forEach(t),zg=h($e),jl=s($e,"DIV",{class:!0});var S$=a(jl);y(wa.$$.fragment,S$),S$.forEach(t),$e.forEach(t),fm=h(o),go=s(o,"H2",{class:!0});var rf=a(go);kn=s(rf,"A",{id:!0,class:!0,href:!0});var W$=a(kn);Zd=s(W$,"SPAN",{});var B$=a(Zd);y($a.$$.fragment,B$),B$.forEach(t),W$.forEach(t),qg=h(rf),ec=s(rf,"SPAN",{});var U$=a(ec);Cg=i(U$,"RobertaTokenizerFast"),U$.forEach(t),rf.forEach(t),um=h(o),Le=s(o,"DIV",{class:!0});var Xe=a(Le);y(Fa.$$.fragment,Xe),jg=h(Xe),xa=s(Xe,"P",{});var lf=a(xa);Pg=i(lf,"Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),tc=s(lf,"EM",{});var H$=a(tc);Lg=i(H$,"tokenizers"),H$.forEach(t),Ag=i(lf,` library), derived from the GPT-2
tokenizer, using byte-level Byte-Pair-Encoding.`),lf.forEach(t),Og=h(Xe),oc=s(Xe,"P",{});var Q$=a(oc);Ng=i(Q$,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Q$.forEach(t),Ig=h(Xe),y(vn.$$.fragment,Xe),Dg=h(Xe),Ra=s(Xe,"P",{});var df=a(Ra);Sg=i(df,"You can get around that behavior by passing "),nc=s(df,"CODE",{});var V$=a(nc);Wg=i(V$,"add_prefix_space=True"),V$.forEach(t),Bg=i(df,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),df.forEach(t),Ug=h(Xe),y(Tn.$$.fragment,Xe),Hg=h(Xe),Ma=s(Xe,"P",{});var cf=a(Ma);Qg=i(cf,"This tokenizer inherits from "),Pl=s(cf,"A",{href:!0});var J$=a(Pl);Vg=i(J$,"PreTrainedTokenizerFast"),J$.forEach(t),Jg=i(cf,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),cf.forEach(t),Kg=h(Xe),Ll=s(Xe,"DIV",{class:!0});var K$=a(Ll);y(Ea.$$.fragment,K$),K$.forEach(t),Xe.forEach(t),gm=h(o),_o=s(o,"H2",{class:!0});var pf=a(_o);yn=s(pf,"A",{id:!0,class:!0,href:!0});var G$=a(yn);sc=s(G$,"SPAN",{});var X$=a(sc);y(za.$$.fragment,X$),X$.forEach(t),G$.forEach(t),Gg=h(pf),ac=s(pf,"SPAN",{});var Y$=a(ac);Xg=i(Y$,"RobertaModel"),Y$.forEach(t),pf.forEach(t),_m=h(o),Ae=s(o,"DIV",{class:!0});var Ye=a(Ae);y(qa.$$.fragment,Ye),Yg=h(Ye),rc=s(Ye,"P",{});var Z$=a(rc);Zg=i(Z$,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Z$.forEach(t),e_=h(Ye),Ca=s(Ye,"P",{});var hf=a(Ca);t_=i(hf,"This model inherits from "),Al=s(hf,"A",{href:!0});var e0=a(Al);o_=i(e0,"PreTrainedModel"),e0.forEach(t),n_=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jf.forEach(t),ZT=h(Ot),Vr=s(Ot,"P",{});var Kf=a(Vr);e2=i(Kf,"This model is also a "),Jr=s(Kf,"A",{href:!0,rel:!0});var WF=a(Jr);t2=i(WF,"tf.keras.Model"),WF.forEach(t),o2=i(Kf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kf.forEach(t),n2=h(Ot),y(fs.$$.fragment,Ot),s2=h(Ot),Rt=s(Ot,"DIV",{class:!0});var Gs=a(Rt);y(Kr.$$.fragment,Gs),a2=h(Gs),Wo=s(Gs,"P",{});var zd=a(Wo);r2=i(zd,"The "),sd=s(zd,"A",{href:!0});var BF=a(sd);i2=i(BF,"TFRobertaForMultipleChoice"),BF.forEach(t),l2=i(zd," forward method, overrides the "),ap=s(zd,"CODE",{});var UF=a(ap);d2=i(UF,"__call__"),UF.forEach(t),c2=i(zd," special method."),zd.forEach(t),p2=h(Gs),y(us.$$.fragment,Gs),h2=h(Gs),y(gs.$$.fragment,Gs),Gs.forEach(t),Ot.forEach(t),Dm=h(o),Bo=s(o,"H2",{class:!0});var Gf=a(Bo);_s=s(Gf,"A",{id:!0,class:!0,href:!0});var HF=a(_s);rp=s(HF,"SPAN",{});var QF=a(rp);y(Gr.$$.fragment,QF),QF.forEach(t),HF.forEach(t),m2=h(Gf),ip=s(Gf,"SPAN",{});var VF=a(ip);f2=i(VF,"TFRobertaForTokenClassification"),VF.forEach(t),Gf.forEach(t),Sm=h(o),Ke=s(o,"DIV",{class:!0});var Nt=a(Ke);y(Xr.$$.fragment,Nt),u2=h(Nt),lp=s(Nt,"P",{});var JF=a(lp);g2=i(JF,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),JF.forEach(t),_2=h(Nt),Yr=s(Nt,"P",{});var Xf=a(Yr);b2=i(Xf,"This model inherits from "),ad=s(Xf,"A",{href:!0});var KF=a(ad);k2=i(KF,"TFPreTrainedModel"),KF.forEach(t),v2=i(Xf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xf.forEach(t),T2=h(Nt),Zr=s(Nt,"P",{});var Yf=a(Zr);y2=i(Yf,"This model is also a "),ei=s(Yf,"A",{href:!0,rel:!0});var GF=a(ei);w2=i(GF,"tf.keras.Model"),GF.forEach(t),$2=i(Yf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yf.forEach(t),F2=h(Nt),y(bs.$$.fragment,Nt),x2=h(Nt),pt=s(Nt,"DIV",{class:!0});var co=a(pt);y(ti.$$.fragment,co),R2=h(co),Uo=s(co,"P",{});var qd=a(Uo);M2=i(qd,"The "),rd=s(qd,"A",{href:!0});var XF=a(rd);E2=i(XF,"TFRobertaForTokenClassification"),XF.forEach(t),z2=i(qd," forward method, overrides the "),dp=s(qd,"CODE",{});var YF=a(dp);q2=i(YF,"__call__"),YF.forEach(t),C2=i(qd," special method."),qd.forEach(t),j2=h(co),y(ks.$$.fragment,co),P2=h(co),y(vs.$$.fragment,co),L2=h(co),y(Ts.$$.fragment,co),co.forEach(t),Nt.forEach(t),Wm=h(o),Ho=s(o,"H2",{class:!0});var Zf=a(Ho);ys=s(Zf,"A",{id:!0,class:!0,href:!0});var ZF=a(ys);cp=s(ZF,"SPAN",{});var ex=a(cp);y(oi.$$.fragment,ex),ex.forEach(t),ZF.forEach(t),A2=h(Zf),pp=s(Zf,"SPAN",{});var tx=a(pp);O2=i(tx,"TFRobertaForQuestionAnswering"),tx.forEach(t),Zf.forEach(t),Bm=h(o),Ge=s(o,"DIV",{class:!0});var It=a(Ge);y(ni.$$.fragment,It),N2=h(It),Qo=s(It,"P",{});var Cd=a(Qo);I2=i(Cd,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Cd,"CODE",{});var ox=a(hp);D2=i(ox,"span start logits"),ox.forEach(t),S2=i(Cd," and "),mp=s(Cd,"CODE",{});var nx=a(mp);W2=i(nx,"span end logits"),nx.forEach(t),B2=i(Cd,")."),Cd.forEach(t),U2=h(It),si=s(It,"P",{});var eu=a(si);H2=i(eu,"This model inherits from "),id=s(eu,"A",{href:!0});var sx=a(id);Q2=i(sx,"TFPreTrainedModel"),sx.forEach(t),V2=i(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),J2=h(It),ai=s(It,"P",{});var tu=a(ai);K2=i(tu,"This model is also a "),ri=s(tu,"A",{href:!0,rel:!0});var ax=a(ri);G2=i(ax,"tf.keras.Model"),ax.forEach(t),X2=i(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),Y2=h(It),y(ws.$$.fragment,It),Z2=h(It),ht=s(It,"DIV",{class:!0});var po=a(ht);y(ii.$$.fragment,po),ey=h(po),Vo=s(po,"P",{});var jd=a(Vo);ty=i(jd,"The "),ld=s(jd,"A",{href:!0});var rx=a(ld);oy=i(rx,"TFRobertaForQuestionAnswering"),rx.forEach(t),ny=i(jd," forward method, overrides the "),fp=s(jd,"CODE",{});var ix=a(fp);sy=i(ix,"__call__"),ix.forEach(t),ay=i(jd," special method."),jd.forEach(t),ry=h(po),y($s.$$.fragment,po),iy=h(po),y(Fs.$$.fragment,po),ly=h(po),y(xs.$$.fragment,po),po.forEach(t),It.forEach(t),Um=h(o),Jo=s(o,"H2",{class:!0});var ou=a(Jo);Rs=s(ou,"A",{id:!0,class:!0,href:!0});var lx=a(Rs);up=s(lx,"SPAN",{});var dx=a(up);y(li.$$.fragment,dx),dx.forEach(t),lx.forEach(t),dy=h(ou),gp=s(ou,"SPAN",{});var cx=a(gp);cy=i(cx,"FlaxRobertaModel"),cx.forEach(t),ou.forEach(t),Hm=h(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(di.$$.fragment,ut),py=h(ut),_p=s(ut,"P",{});var px=a(_p);hy=i(px,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),px.forEach(t),my=h(ut),ci=s(ut,"P",{});var nu=a(ci);fy=i(nu,"This model inherits from "),dd=s(nu,"A",{href:!0});var hx=a(dd);uy=i(hx,"FlaxPreTrainedModel"),hx.forEach(t),gy=i(nu,`. Check the superclass documentation for the generic methods the
