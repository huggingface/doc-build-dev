import{S as zd,i as xd,s as Fd,e as n,k as h,w as y,t as i,M as Cd,c as s,d as t,m as g,a,x as w,h as d,b as p,F as e,g as b,y as k,q as B,o as T,B as $,v as Ed,L as K}from"../../chunks/vendor-6b77c823.js";import{T as rs}from"../../chunks/Tip-39098574.js";import{D as Q}from"../../chunks/Docstring-1088f2fb.js";import{C as J}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as W}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as V}from"../../chunks/ExampleCodeBlock-5212b321.js";function Md(P){let l,_,c,u,v;return u=new J({props:{code:"",highlighted:""}}),{c(){l=n("p"),_=i("Example:"),c=h(),y(u.$$.fragment)},l(r){l=s(r,"P",{});var m=a(l);_=d(m,"Example:"),m.forEach(t),c=g(r),w(u.$$.fragment,r)},m(r,m){b(r,l,m),e(l,_),b(r,c,m),k(u,r,m),v=!0},p:K,i(r){v||(B(u.$$.fragment,r),v=!0)},o(r){T(u.$$.fragment,r),v=!1},d(r){r&&t(l),r&&t(c),$(u,r)}}}function jd(P){let l,_,c,u,v;return{c(){l=n("p"),_=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),u=i("Module"),v=i(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),_=i("Example:"),c=h(),y(u.$$.fragment)},l(r){l=s(r,"P",{});var m=a(l);_=d(m,"Example:"),m.forEach(t),c=g(r),w(u.$$.fragment,r)},m(r,m){b(r,l,m),e(l,_),b(r,c,m),k(u,r,m),v=!0},p:K,i(r){v||(B(u.$$.fragment,r),v=!0)},o(r){T(u.$$.fragment,r),v=!1},d(r){r&&t(l),r&&t(c),$(u,r)}}}function Ad(P){let l,_,c,u,v;return{c(){l=n("p"),_=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),u=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=s(r,"P",{});var m=a(l);_=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(m,"CODE",{});var F=a(c);u=d(F,"Module"),F.forEach(t),v=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(r,m){b(r,l,m),e(l,_),e(l,c),e(c,u),e(l,v)},d(r){r&&t(l)}}}function Od(P){let l,_,c,u,v;return u=new J({props:{code:`from transformers import PegasusTokenizer, BigBirdPegasusForConditionalGeneration
...
<p>A <a
  href="/docs/transformers/pr_17022/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17022/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17022/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2510",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17022/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17022/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17022/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2781",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17022/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17022/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
`}}),De=new V({props:{anchor:"transformers.BigBirdPegasusForCausalLM.forward.example",$$slots:{default:[Hd]},$$scope:{ctx:P}}}),{c(){l=n("meta"),_=h(),c=n("h1"),u=n("a"),v=n("span"),y(r.$$.fragment),m=h(),F=n("span"),is=i("BigBirdPegasus"),gn=h(),Z=n("h2"),pe=n("a"),it=n("span"),y(He.$$.fragment),ds=h(),dt=n("span"),ls=i("Overview"),mn=h(),he=n("p"),cs=i("The BigBird model was proposed in "),Re=n("a"),us=i("Big Bird: Transformers for Longer Sequences"),ps=i(` by
...
propose novel applications to genomics data.`),bn=h(),Qo=n("p"),ms=i("Tips:"),vn=h(),z=n("ul"),Ve=n("li"),fs=i("For an in-detail explanation on how BigBird\u2019s attention works, see "),Ke=n("a"),_s=i("this blog post"),bs=i("."),vs=h(),O=n("li"),ys=i("BigBird comes with 2 implementations: "),ct=n("strong"),ws=i("original_full"),ks=i(" & "),ut=n("strong"),Bs=i("block_sparse"),Ts=i(`. For the sequence length < 1024, using
`),pt=n("strong"),$s=i("original_full"),Ps=i(" is advised as there is no benefit in using "),ht=n("strong"),qs=i("block_sparse"),zs=i(" attention."),xs=h(),gt=n("li"),Fs=i("The code currently uses window size of 3 blocks and 2 global blocks."),Cs=h(),mt=n("li"),Es=i("Sequence length must be divisible by block size."),Ms=h(),Je=n("li"),js=i("Current implementation supports only "),ft=n("strong"),Ss=i("ITC"),As=i("."),Os=h(),Ze=n("li"),Ls=i("Current implementation doesn\u2019t support "),_t=n("strong"),Ns=i("num_random_blocks = 0"),Is=i("."),Ds=h(),Ye=n("li"),Qs=i("BigBirdPegasus uses the "),Xe=n("a"),Ws=i("PegasusTokenizer"),Gs=i("."),yn=h(),ge=n("p"),Us=i("The original code can be found "),eo=n("a"),Hs=i("here"),Rs=i("."),wn=h(),Y=n("h2"),me=n("a"),bt=n("span"),y(oo.$$.fragment),Vs=h(),vt=n("span"),Ks=i("BigBirdPegasusConfig"),kn=h(),q=n("div"),y(to.$$.fragment),Js=h(),X=n("p"),Zs=i("This is the configuration class to store the configuration of a "),Wo=n("a"),Ys=i("BigBirdPegasusModel"),Xs=i(`. It is used to instantiate
...
documentation from `),Uo=n("a"),ra=i("PretrainedConfig"),ia=i(" for more information."),da=h(),y(fe.$$.fragment),la=h(),yt=n("blockquote"),wt=n("blockquote"),kt=n("blockquote"),Bt=n("p"),ca=i("from transformers import BigBirdPegasusModel, BigBirdPegasusConfig"),ua=h(),Tt=n("blockquote"),$t=n("blockquote"),so=n("blockquote"),_e=n("h1"),be=n("a"),Pt=n("span"),y(ao.$$.fragment),pa=h(),qt=n("span"),ha=i("Initializing a BigBirdPegasus bigbird-pegasus-base style configuration >>> configuration ="),ga=h(),zt=n("p"),ma=i("BigBirdPegasusConfig()"),fa=h(),xt=n("blockquote"),Ft=n("blockquote"),ro=n("blockquote"),ve=n("h1"),ye=n("a"),Ct=n("span"),y(io.$$.fragment),_a=h(),Et=n("span"),ba=i("Initializing a model from the bigbird-pegasus-base style configuration >>> model ="),va=h(),Mt=n("p"),ya=i("BigBirdPegasusModel(configuration)"),wa=h(),jt=n("blockquote"),St=n("blockquote"),At=n("blockquote"),we=n("h1"),ke=n("a"),Ot=n("span"),y(lo.$$.fragment),ka=h(),Lt=n("span"),Ba=i("Accessing the model configuration >>> configuration = model.config"),Bn=h(),oe=n("h2"),Be=n("a"),Nt=n("span"),y(co.$$.fragment),Ta=h(),It=n("span"),$a=i("BigBirdPegasusModel"),Tn=h(),L=n("div"),y(uo.$$.fragment),Pa=h(),po=n("p"),qa=i(`The bare BigBirdPegasus Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xa=h(),D=n("div"),y(wo.$$.fragment),er=h(),se=n("p"),or=i("The "),Ko=n("a"),tr=i("BigBirdPegasusForConditionalGeneration"),nr=i(" forward method, overrides the "),Gt=n("code"),sr=i("__call__"),ar=i(" special method."),rr=h(),y(qe.$$.fragment),ir=h(),y(ze.$$.fragment),qn=h(),ae=n("h2"),xe=n("a"),Ut=n("span"),y(ko.$$.fragment),dr=h(),Ht=n("span"),lr=i("BigBirdPegasusForSequenceClassification"),zn=h(),E=n("div"),y(Bo.$$.fragment),cr=h(),Rt=n("p"),ur=i(`BigBirdPegasus model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yr=h(),x=n("div"),y(qo.$$.fragment),wr=h(),re=n("p"),kr=i("The "),Zo=n("a"),Br=i("BigBirdPegasusForSequenceClassification"),Tr=i(" forward method, overrides the "),Vt=n("code"),$r=i("__call__"),Pr=i(" special method."),qr=h(),y(Fe.$$.fragment),zr=h(),y(Ce.$$.fragment),xr=h(),y(Ee.$$.fragment),Fr=h(),y(Me.$$.fragment),Cr=h(),y(je.$$.fragment),xn=h(),ie=n("h2"),Se=n("a"),Kt=n("span"),y(zo.$$.fragment),Er=h(),Jt=n("span"),Mr=i("BigBirdPegasusForQuestionAnswering"),Fn=h(),M=n("div"),y(xo.$$.fragment),jr=h(),de=n("p"),Sr=i(`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Zt=n("code"),Ar=i("span start logits"),Or=i(" and "),Yt=n("code"),Lr=i("span end logits"),Nr=i(")."),Ir=h(),Fo=n("p"),Dr=i("This model inherits from "),Yo=n("a"),Qr=i("PreTrainedModel"),Wr=i(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vr=h(),j=n("div"),y(Mo.$$.fragment),Kr=h(),le=n("p"),Jr=i("The "),Xo=n("a"),Zr=i("BigBirdPegasusForQuestionAnswering"),Yr=i(" forward method, overrides the "),Xt=n("code"),Xr=i("__call__"),ei=i(" special method."),oi=h(),y(Ae.$$.fragment),ti=h(),y(Oe.$$.fragment),ni=h(),y(Le.$$.fragment),Cn=h(),ce=n("h2"),Ne=n("a"),en=n("span"),y(jo.$$.fragment),si=h(),on=n("span"),ai=i("BigBirdPegasusForCausalLM"),En=h(),ue=n("div"),y(So.$$.fragment),ri=h(),Ie=n("div"),y(Ao.$$.fragment),ii=h(),y(De.$$.fragment),this.h()},l(o){const f=Cd('[data-svelte="svelte-1phssyn"]',document.head);l=s(f,"META",{name:!0,content:!0}),f.forEach(t),_=g(o),c=s(o,"H1",{class:!0});var Oo=a(c);u=s(Oo,"A",{id:!0,class:!0,href:!0});var tn=a(u);v=s(tn,"SPAN",{});var nn=a(v);w(r.$$.fragment,nn),nn.forEach(t),tn.forEach(t),m=g(Oo),F=s(Oo,"SPAN",{});var sn=a(F);is=d(sn,"BigBirdPegasus"),sn.forEach(t),Oo.forEach(t),gn=g(o),Z=s(o,"H2",{class:!0});var Lo=a(Z);pe=s(Lo,"A",{id:!0,class:!0,href:!0});var an=a(pe);it=s(an,"SPAN",{});var rn=a(it);w(He.$$.fragment,rn),rn.forEach(t),an.forEach(t),ds=g(Lo),dt=s(Lo,"SPAN",{});var dn=a(dt);ls=d(dn,"Overview"),dn.forEach(t),Lo.forEach(t),mn=g(o),he=s(o,"P",{});var No=a(he);cs=d(No,"The BigBird model was proposed in "),Re=s(No,"A",{href:!0,rel:!0});var ln=a(Re);us=d(ln,"Big Bird: Transformers for Longer Sequences"),ln.forEach(t),ps=d(No,` by
Zaheer, Manzil and Guruganesh, Guru and Dubey, Kumar Avinava and Ainslie, Joshua and Alberti, Chris and Ontanon,
Santiago and Pham, Philip and Ravula, Anirudh and Wang, Qifan and Yang, Li and others. BigBird, is a sparse-attention
based transformer which extends Transformer based models, such as BERT to much longer sequences. In addition to sparse
attention, BigBird also applies global attention as well as random attention to the input sequence. Theoretically, it
...
documentation from `),Uo=s(ot,"A",{href:!0});var $i=a(Uo);ra=d($i,"PretrainedConfig"),$i.forEach(t),ia=d(ot," for more information."),ot.forEach(t),da=g(C),w(fe.$$.fragment,C),la=g(C),yt=s(C,"BLOCKQUOTE",{});var Pi=a(yt);wt=s(Pi,"BLOCKQUOTE",{});var qi=a(wt);kt=s(qi,"BLOCKQUOTE",{});var zi=a(kt);Bt=s(zi,"P",{});var xi=a(Bt);ca=d(xi,"from transformers import BigBirdPegasusModel, BigBirdPegasusConfig"),xi.forEach(t),zi.forEach(t),qi.forEach(t),Pi.forEach(t),ua=g(C),Tt=s(C,"BLOCKQUOTE",{});var Fi=a(Tt);$t=s(Fi,"BLOCKQUOTE",{});var Ci=a($t);so=s(Ci,"BLOCKQUOTE",{});var In=a(so);_e=s(In,"H1",{class:!0});var Dn=a(_e);be=s(Dn,"A",{id:!0,class:!0,href:!0});var Ei=a(be);Pt=s(Ei,"SPAN",{});var Mi=a(Pt);w(ao.$$.fragment,Mi),Mi.forEach(t),Ei.forEach(t),pa=g(Dn),qt=s(Dn,"SPAN",{});var ji=a(qt);ha=d(ji,"Initializing a BigBirdPegasus bigbird-pegasus-base style configuration >>> configuration ="),ji.forEach(t),Dn.forEach(t),ga=g(In),zt=s(In,"P",{});var Si=a(zt);ma=d(Si,"BigBirdPegasusConfig()"),Si.forEach(t),In.forEach(t),Ci.forEach(t),Fi.forEach(t),fa=g(C),xt=s(C,"BLOCKQUOTE",{});var Ai=a(xt);Ft=s(Ai,"BLOCKQUOTE",{});var Oi=a(Ft);ro=s(Oi,"BLOCKQUOTE",{});var Qn=a(ro);ve=s(Qn,"H1",{class:!0});var Wn=a(ve);ye=s(Wn,"A",{id:!0,class:!0,href:!0});var Li=a(ye);Ct=s(Li,"SPAN",{});var Ni=a(Ct);w(io.$$.fragment,Ni),Ni.forEach(t),Li.forEach(t),_a=g(Wn),Et=s(Wn,"SPAN",{});var Ii=a(Et);ba=d(Ii,"Initializing a model from the bigbird-pegasus-base style configuration >>> model ="),Ii.forEach(t),Wn.forEach(t),va=g(Qn),Mt=s(Qn,"P",{});var Di=a(Mt);ya=d(Di,"BigBirdPegasusModel(configuration)"),Di.forEach(t),Qn.forEach(t),Oi.forEach(t),Ai.forEach(t),wa=g(C),jt=s(C,"BLOCKQUOTE",{});var Qi=a(jt);St=s(Qi,"BLOCKQUOTE",{});var Wi=a(St);At=s(Wi,"BLOCKQUOTE",{});var Gi=a(At);we=s(Gi,"H1",{class:!0});var Gn=a(we);ke=s(Gn,"A",{id:!0,class:!0,href:!0});var Ui=a(ke);Ot=s(Ui,"SPAN",{});var Hi=a(Ot);w(lo.$$.fragment,Hi),Hi.forEach(t),Ui.forEach(t),ka=g(Gn),Lt=s(Gn,"SPAN",{});var Ri=a(Lt);Ba=d(Ri,"Accessing the model configuration >>> configuration = model.config"),Ri.forEach(t),Gn.forEach(t),Gi.forEach(t),Wi.forEach(t),Qi.forEach(t),C.forEach(t),Bn=g(o),oe=s(o,"H2",{class:!0});var Un=a(oe);Be=s(Un,"A",{id:!0,class:!0,href:!0});var Vi=a(Be);Nt=s(Vi,"SPAN",{});var Ki=a(Nt);w(co.$$.fragment,Ki),Ki.forEach(t),Vi.forEach(t),Ta=g(Un),It=s(Un,"SPAN",{});var Ji=a(It);$a=d(Ji,"BigBirdPegasusModel"),Ji.forEach(t),Un.forEach(t),Tn=g(o),L=s(o,"DIV",{class:!0});var Qe=a(L);w(uo.$$.fragment,Qe),Pa=g(Qe),po=s(Qe,"P",{});var Hn=a(po);qa=d(Hn,`The bare BigBirdPegasus Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jn.forEach(t),Xa=g(Ge),D=s(Ge,"DIV",{class:!0});var Ue=a(D);w(wo.$$.fragment,Ue),er=g(Ue),se=s(Ue,"P",{});var nt=a(se);or=d(nt,"The "),Ko=s(nt,"A",{href:!0});var rd=a(Ko);tr=d(rd,"BigBirdPegasusForConditionalGeneration"),rd.forEach(t),nr=d(nt," forward method, overrides the "),Gt=s(nt,"CODE",{});var id=a(Gt);sr=d(id,"__call__"),id.forEach(t),ar=d(nt," special method."),nt.forEach(t),rr=g(Ue),w(qe.$$.fragment,Ue),ir=g(Ue),w(ze.$$.fragment,Ue),Ue.forEach(t),Ge.forEach(t),qn=g(o),ae=s(o,"H2",{class:!0});var Zn=a(ae);xe=s(Zn,"A",{id:!0,class:!0,href:!0});var dd=a(xe);Ut=s(dd,"SPAN",{});var ld=a(Ut);w(ko.$$.fragment,ld),ld.forEach(t),dd.forEach(t),dr=g(Zn),Ht=s(Zn,"SPAN",{});var cd=a(Ht);lr=d(cd,"BigBirdPegasusForSequenceClassification"),cd.forEach(t),Zn.forEach(t),zn=g(o),E=s(o,"DIV",{class:!0});var U=a(E);w(Bo.$$.fragment,U),cr=g(U),Rt=s(U,"P",{});var ud=a(Rt);ur=d(ud,`BigBirdPegasus model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xn.forEach(t),yr=g(U),x=s(U,"DIV",{class:!0});var A=a(x);w(qo.$$.fragment,A),wr=g(A),re=s(A,"P",{});var st=a(re);kr=d(st,"The "),Zo=s(st,"A",{href:!0});var gd=a(Zo);Br=d(gd,"BigBirdPegasusForSequenceClassification"),gd.forEach(t),Tr=d(st," forward method, overrides the "),Vt=s(st,"CODE",{});var md=a(Vt);$r=d(md,"__call__"),md.forEach(t),Pr=d(st," special method."),st.forEach(t),qr=g(A),w(Fe.$$.fragment,A),zr=g(A),w(Ce.$$.fragment,A),xr=g(A),w(Ee.$$.fragment,A),Fr=g(A),w(Me.$$.fragment,A),Cr=g(A),w(je.$$.fragment,A),A.forEach(t),U.forEach(t),xn=g(o),ie=s(o,"H2",{class:!0});var es=a(ie);Se=s(es,"A",{id:!0,class:!0,href:!0});var fd=a(Se);Kt=s(fd,"SPAN",{});var _d=a(Kt);w(zo.$$.fragment,_d),_d.forEach(t),fd.forEach(t),Er=g(es),Jt=s(es,"SPAN",{});var bd=a(Jt);Mr=d(bd,"BigBirdPegasusForQuestionAnswering"),bd.forEach(t),es.forEach(t),Fn=g(o),M=s(o,"DIV",{class:!0});var H=a(M);w(xo.$$.fragment,H),jr=g(H),de=s(H,"P",{});var at=a(de);Sr=d(at,`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Zt=s(at,"CODE",{});var vd=a(Zt);Ar=d(vd,"span start logits"),vd.forEach(t),Or=d(at," and "),Yt=s(at,"CODE",{});var yd=a(Yt);Lr=d(yd,"span end logits"),yd.forEach(t),Nr=d(at,")."),at.forEach(t),Ir=g(H),Fo=s(H,"P",{});var os=a(Fo);Dr=d(os,"This model inherits from "),Yo=s(os,"A",{href:!0});var wd=a(Yo);Qr=d(wd,"PreTrainedModel"),wd.forEach(t),Wr=d(os,`. Check the superclass documentation for the generic methods the
