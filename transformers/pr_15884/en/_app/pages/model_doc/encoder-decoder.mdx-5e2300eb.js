import{S as xi,i as ji,s as $i,e as a,k as i,w as u,t as n,M as qi,c as s,d as o,m as c,a as d,x as g,h as r,b as l,F as e,g as m,y as _,q as b,o as v,B as y}from"../../chunks/vendor-4833417e.js";import{T as dd}from"../../chunks/Tip-fffd6df1.js";import{D as O}from"../../chunks/Docstring-44c5af16.js";import{C as Me}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Rt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Pi(Q){let h,x,f,w,P;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){h=s(k,"P",{});var T=d(h);x=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){m(k,h,T),e(h,x),e(h,f),e(f,w),e(h,P)},d(k){k&&o(h)}}}function Fi(Q){let h,x,f,w,P;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){h=s(k,"P",{});var T=d(h);x=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){m(k,h,T),e(h,x),e(h,f),e(f,w),e(h,P)},d(k){k&&o(h)}}}function Ci(Q){let h,x,f,w,P;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){h=s(k,"P",{});var T=d(h);x=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){m(k,h,T),e(h,x),e(h,f),e(f,w),e(h,P)},d(k){k&&o(h)}}}function Ai(Q){let h,x,f,w,P,k,T,F,zn,Gt,he,Mn,wo,xn,jn,Ut,me,$n,xe,qn,Pn,Vt,fe,Fn,Eo,Cn,An,Ht,W,Sn,Do,Nn,In,je,Ln,Bn,Yt,R,On,Qo,Wn,Rn,Xo,Gn,Un,Jt,$e,Zt,G,Vn,qe,Hn,Yn,Pe,Jn,Zn,Kt,X,ue,et,Fe,Kn,ot,Qn,Qt,M,Ce,Xn,ge,zo,er,or,Mo,tr,nr,rr,ee,ar,xo,sr,dr,jo,ir,cr,lr,tt,pr,hr,Ae,mr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,oe,yr,nt,kr,Tr,rt,wr,Er,Xt,te,ve,at,Le,Dr,st,zr,en,E,Be,Mr,ne,xr,dt,jr,$r,it,qr,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ct,Ir,Lr,Re,Br,qo,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Yr,Jr,lt,Zr,Kr,pt,Qr,Xr,ea,C,Ve,oa,re,ta,Fo,na,ra,ht,aa,sa,da,ye,ia,mt,ca,la,He,pa,A,Ye,ha,ft,ma,fa,ae,ua,ut,ga,_a,gt,ba,va,ya,_t,ka,Ta,Je,on,se,ke,bt,Ze,wa,vt,Ea,tn,D,Ke,Da,de,za,yt,Ma,xa,kt,ja,$a,qa,Qe,Pa,Xe,Fa,Ca,Aa,Tt,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,to,Ra,Ga,Ua,V,Ao,Va,Ha,wt,Ya,Ja,Et,Za,Ka,Qa,S,no,Xa,ie,es,So,os,ts,Dt,ns,rs,as,Te,ss,zt,ds,is,ro,cs,L,ao,ls,Mt,ps,hs,xt,ms,fs,so,nn,ce,we,jt,io,us,$t,gs,rn,z,co,_s,le,bs,qt,vs,ys,Pt,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Ft,xs,js,ho,$s,No,qs,Ps,Fs,mo,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,Ct,Bs,Os,At,Ws,Rs,Gs,N,uo,Us,pe,Vs,Lo,Hs,Ys,St,Js,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,bo,an;return k=new Rt({}),$e=new Me({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),Fe=new Rt({}),Ce=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15884/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26",parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_15884/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_15884/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_15884/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),Ie=new O({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15884/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
configuration. Check out the <a href="/docs/transformers/pr_15884/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ve=new O({props:{name:"forward",anchor:"transformers.EncoderDecoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15884/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L430",parametersDescription:[{anchor:"transformers.EncoderDecoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15884/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_15884/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<a href="/docs/transformers/pr_15884/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/pr_15884/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_15884/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_15884/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
...
<p>A <a
  href="/docs/transformers/pr_15884/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15884/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_15884/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15884/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15884/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){h=a("meta"),x=i(),f=a("h1"),w=a("a"),P=a("span"),u(k.$$.fragment),T=i(),F=a("span"),zn=n("Encoder Decoder Models"),Gt=i(),he=a("p"),Mn=n("The "),wo=a("a"),xn=n("EncoderDecoderModel"),jn=n(` can be used to initialize a sequence-to-sequence model with any
pretrained autoencoding model as the encoder and any pretrained autoregressive model as the decoder.`),Ut=i(),me=a("p"),$n=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation tasks
...
documentation from `),jo=a("a"),ir=n("PretrainedConfig"),cr=n(" for more information."),lr=i(),tt=a("p"),pr=n("Examples:"),hr=i(),u(Ae.$$.fragment),mr=i(),_e=a("div"),u(Se.$$.fragment),fr=i(),Ne=a("p"),ur=n("Instantiate a "),$o=a("a"),gr=n("EncoderDecoderConfig"),_r=n(` (or a derived class) from a pre-trained encoder model configuration and
...
:meth`),pt=a("em"),Qr=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xr=n(" class method for the decoder."),ea=i(),C=a("div"),u(Ve.$$.fragment),oa=i(),re=a("p"),ta=n("The "),Fo=a("a"),na=n("EncoderDecoderModel"),ra=n(" forward method, overrides the "),ht=a("code"),aa=n("__call__"),sa=n(" special method."),da=i(),u(ye.$$.fragment),ia=i(),mt=a("p"),ca=n("Examples:"),la=i(),u(He.$$.fragment),pa=i(),A=a("div"),u(Ye.$$.fragment),ha=i(),ft=a("p"),ma=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
checkpoints.`),hs=i(),xt=a("p"),ms=n("Example:"),fs=i(),u(so.$$.fragment),nn=i(),ce=a("h2"),we=a("a"),jt=a("span"),u(io.$$.fragment),us=i(),$t=a("span"),gs=n("FlaxEncoderDecoderModel"),rn=i(),z=a("div"),u(co.$$.fragment),_s=i(),le=a("p"),bs=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
(see the examples for more information).`),js=i(),ho=a("p"),$s=n("This model inherits from "),No=a("a"),qs=n("FlaxPreTrainedModel"),Ps=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fs=i(),mo=a("p"),Cs=n(`This model is also a Flax Linen
...
checkpoints.`),rd=i(),Lt=a("p"),ad=n("Example:"),sd=i(),u(bo.$$.fragment),this.h()},l(t){const p=qi('[data-svelte="svelte-1phssyn"]',document.head);h=s(p,"META",{name:!0,content:!0}),p.forEach(o),x=c(t),f=s(t,"H1",{class:!0});var vo=d(f);w=s(vo,"A",{id:!0,class:!0,href:!0});var Bt=d(w);P=s(Bt,"SPAN",{});var Ot=d(P);g(k.$$.fragment,Ot),Ot.forEach(o),Bt.forEach(o),T=c(vo),F=s(vo,"SPAN",{});var id=d(F);zn=r(id,"Encoder Decoder Models"),id.forEach(o),vo.forEach(o),Gt=c(t),he=s(t,"P",{});var sn=d(he);Mn=r(sn,"The "),wo=s(sn,"A",{href:!0});var cd=d(wo);xn=r(cd,"EncoderDecoderModel"),cd.forEach(o),jn=r(sn,` can be used to initialize a sequence-to-sequence model with any
pretrained autoencoding model as the encoder and any pretrained autoregressive model as the decoder.`),sn.forEach(o),Ut=c(t),me=s(t,"P",{});var dn=d(me);$n=r(dn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation tasks
...
any other models (see the examples for more information).`),cn.forEach(o),Ht=c(t),W=s(t,"P",{});var Bo=d(W);Sn=r(Bo,"An application of this architecture could be to leverage two pretrained "),Do=s(Bo,"A",{href:!0});var hd=d(Do);Nn=r(hd,"BertModel"),hd.forEach(o),In=r(Bo,` as the encoder
and decoder for a summarization model as was shown in: `),je=s(Bo,"A",{href:!0,rel:!0});var md=d(je);Ln=r(md,"Text Summarization with Pretrained Encoders"),md.forEach(o),Bn=r(Bo," by Yang Liu and Mirella Lapata."),Bo.forEach(o),Yt=c(t),R=s(t,"P",{});var Oo=d(R);On=r(Oo,"The "),Qo=s(Oo,"CODE",{});var fd=d(Qo);Wn=r(fd,"from_pretrained()"),fd.forEach(o),Rn=r(Oo,`currently doesn\u2019t support initializing the model from a
...
documentation from `),jo=s(Ro,"A",{href:!0});var Ed=d(jo);ir=r(Ed,"PretrainedConfig"),Ed.forEach(o),cr=r(Ro," for more information."),Ro.forEach(o),lr=c(I),tt=s(I,"P",{});var Dd=d(tt);pr=r(Dd,"Examples:"),Dd.forEach(o),hr=c(I),g(Ae.$$.fragment,I),mr=c(I),_e=s(I,"DIV",{class:!0});var pn=d(_e);g(Se.$$.fragment,pn),fr=c(pn),Ne=s(pn,"P",{});var hn=d(Ne);ur=r(hn,"Instantiate a "),$o=s(hn,"A",{href:!0});var zd=d($o);gr=r(zd,"EncoderDecoderConfig"),zd.forEach(o),_r=r(hn,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),hn.forEach(o),pn.forEach(o),br=c(I),be=s(I,"DIV",{class:!0});var mn=d(be);g(Ie.$$.fragment,mn),vr=c(mn),oe=s(mn,"P",{});var Go=d(oe);yr=r(Go,"Serializes this instance to a Python dictionary. Override the default "),nt=s(Go,"EM",{});var Md=d(nt);kr=r(Md,"to_dict()"),Md.forEach(o),Tr=r(Go," from "),rt=s(Go,"EM",{});var xd=d(rt);wr=r(xd,"PretrainedConfig"),xd.forEach(o),Er=r(Go,"."),Go.forEach(o),mn.forEach(o),I.forEach(o),Xt=c(t),te=s(t,"H2",{class:!0});var fn=d(te);ve=s(fn,"A",{id:!0,class:!0,href:!0});var jd=d(ve);at=s(jd,"SPAN",{});var $d=d(at);g(Le.$$.fragment,$d),$d.forEach(o),jd.forEach(o),Dr=c(fn),st=s(fn,"SPAN",{});var qd=d(st);zr=r(qd,"EncoderDecoderModel"),qd.forEach(o),fn.forEach(o),en=c(t),E=s(t,"DIV",{class:!0});var j=d(E);g(Be.$$.fragment,j),Mr=c(j),ne=s(j,"P",{});var Uo=d(ne);xr=r(Uo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
:meth`),pt=s(yo,"EM",{});var Bd=d(pt);Qr=r(Bd,"~transformers.AutoModelForCausalLM.from_pretrained"),Bd.forEach(o),Xr=r(yo," class method for the decoder."),yo.forEach(o),ea=c(j),C=s(j,"DIV",{class:!0});var Y=d(C);g(Ve.$$.fragment,Y),oa=c(Y),re=s(Y,"P",{});var Vo=d(re);ta=r(Vo,"The "),Fo=s(Vo,"A",{href:!0});var Od=d(Fo);na=r(Od,"EncoderDecoderModel"),Od.forEach(o),ra=r(Vo," forward method, overrides the "),ht=s(Vo,"CODE",{});var Wd=d(ht);aa=r(Wd,"__call__"),Wd.forEach(o),sa=r(Vo," special method."),Vo.forEach(o),da=c(Y),g(ye.$$.fragment,Y),ia=c(Y),mt=s(Y,"P",{});var Rd=d(mt);ca=r(Rd,"Examples:"),Rd.forEach(o),la=c(Y),g(He.$$.fragment,Y),Y.forEach(o),pa=c(j),A=s(j,"DIV",{class:!0});var J=d(A);g(Ye.$$.fragment,J),ha=c(J),ft=s(J,"P",{});var Gd=d(ft);ma=r(Gd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
checkpoints.`),ci.forEach(o),hs=c(De),xt=s(De,"P",{});var li=d(xt);ms=r(li,"Example:"),li.forEach(o),fs=c(De),g(so.$$.fragment,De),De.forEach(o),$.forEach(o),nn=c(t),ce=s(t,"H2",{class:!0});var Tn=d(ce);we=s(Tn,"A",{id:!0,class:!0,href:!0});var pi=d(we);jt=s(pi,"SPAN",{});var hi=d(jt);g(io.$$.fragment,hi),hi.forEach(o),pi.forEach(o),us=c(Tn),$t=s(Tn,"SPAN",{});var mi=d($t);gs=r(mi,"FlaxEncoderDecoderModel"),mi.forEach(o),Tn.forEach(o),rn=c(t),z=s(t,"DIV",{class:!0});var q=d(z);g(co.$$.fragment,q),_s=c(q),le=s(q,"P",{});var Zo=d(le);bs=r(Zo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
(see the examples for more information).`),_i.forEach(o),js=c(q),ho=s(q,"P",{});var En=d(ho);$s=r(En,"This model inherits from "),No=s(En,"A",{href:!0});var bi=d(No);qs=r(bi,"FlaxPreTrainedModel"),bi.forEach(o),Ps=r(En,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),En.forEach(o),Fs=c(q),mo=s(q,"P",{});var Dn=d(mo);Cs=r(Dn,`This model is also a Flax Linen
