...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17112/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17112/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou.forEach(t),bb=h(Bt),la=n(Bt,"P",{});var su=r(la);vb=i(su,"This model is also a "),da=n(su,"A",{href:!0,rel:!0});var t2=r(da);kb=i(t2,"tf.keras.Model"),t2.forEach(t),Tb=i(su,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Ub=h(ot),Sd=n(ot,"P",{});var c2=r(Sd);Hb=i(c2,"Finally, this model supports inherent JAX features such as:"),c2.forEach(t),Vb=h(ot),Mt=n(ot,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p2=r(Id);ga=n(p2,"A",{href:!0,rel:!0});var h2=r(ga);Kb=i(h2,"Just-In-Time (JIT) compilation"),h2.forEach(t),p2.forEach(t),Jb=h(kn),Wd=n(kn,"LI",{});var u2=r(Wd);_a=n(u2,"A",{href:!0,rel:!0});var f2=r(_a);Gb=i(f2,"Automatic Differentiation"),f2.forEach(t),u2.forEach(t),Xb=h(kn),Qd=n(kn,"LI",{});var m2=r(Qd);ba=n(m2,"A",{href:!0,rel:!0});var g2=r(ba);Yb=i(g2,"Vectorization"),g2.forEach(t),m2.forEach(t),Zb=h(kn),Rd=n(kn,"LI",{});var _2=r(Rd);va=n(_2,"A",{href:!0,rel:!0});var b2=r(va);ev=i(b2,"Parallelization"),b2.forEach(t),_2.forEach(t),kn.forEach(t),tv=h(ot),gt=n(ot,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),ov=h(Tn),jo=n(Tn,"P",{});var Fl=r(jo);sv=i(Fl,"The "),Ud=n(Fl,"CODE",{});var v2=r(Ud);nv=i(v2,"FlaxDistilBertPreTrainedModel"),v2.forEach(t),rv=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var k2=r(Hd);av=i(k2,"__call__"),k2.forEach(t),iv=i(Fl," special method."),Fl.forEach(t),lv=h(Tn),$(Gs.$$.fragment,Tn),dv=h(Tn),$(Xs.$$.fragment,Tn),Tn.forEach(t),ot.forEach(t),ih=h(o),Co=n(o,"H2",{class:!0});var iu=r(Co);Ys=n(iu,"A",{id:!0,class:!0,href:!0});var T2=r(Ys);Vd=n(T2,"SPAN",{});var $2=r(Vd);$(Ta.$$.fragment,$2),$2.forEach(t),T2.forEach(t),cv=h(iu),Kd=n(iu,"SPAN",{});var w2=r(Kd);pv=i(w2,"FlaxDistilBertForMaskedLM"),w2.forEach(t),iu.forEach(t),lh=h(o),Ee=n(o,"DIV",{class:!0});var st=r(Ee);$($a.$$.fragment,st),hv=h(st),wa=n(st,"P",{});var lu=r(wa);uv=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y2=r(Jd);fv=i(y2,"language modeling"),y2.forEach(t),mv=i(lu," head on top."),lu.forEach(t),gv=h(st),ya=n(st,"P",{});var du=r(ya);_v=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var D2=r(il);bv=i(D2,"FlaxPreTrainedModel"),D2.forEach(t),vv=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kv=h(st),Da=n(st,"P",{});var cu=r(Da);Tv=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var F2=r(Fa);$v=i(F2,"flax.linen.Module"),F2.forEach(t),wv=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yv=h(st),Gd=n(st,"P",{});var B2=r(Gd);Dv=i(B2,"Finally, this model supports inherent JAX features such as:"),B2.forEach(t),Fv=h(st),Et=n(st,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var x2=r(Xd);Ba=n(x2,"A",{href:!0,rel:!0});var M2=r(Ba);Bv=i(M2,"Just-In-Time (JIT) compilation"),M2.forEach(t),x2.forEach(t),xv=h($n),Yd=n($n,"LI",{});var E2=r(Yd);xa=n(E2,"A",{href:!0,rel:!0});var z2=r(xa);Mv=i(z2,"Automatic Differentiation"),z2.forEach(t),E2.forEach(t),Ev=h($n),Zd=n($n,"LI",{});var j2=r(Zd);Ma=n(j2,"A",{href:!0,rel:!0});var C2=r(Ma);zv=i(C2,"Vectorization"),C2.forEach(t),j2.forEach(t),jv=h($n),ec=n($n,"LI",{});var q2=r(ec);Ea=n(q2,"A",{href:!0,rel:!0});var P2=r(Ea);Cv=i(P2,"Parallelization"),P2.forEach(t),q2.forEach(t),$n.forEach(t),qv=h(st),_t=n(st,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pv=h(wn),qo=n(wn,"P",{});var Bl=r(qo);Av=i(Bl,"The "),tc=n(Bl,"CODE",{});var A2=r(tc);Ov=i(A2,"FlaxDistilBertPreTrainedModel"),A2.forEach(t),Nv=i(Bl," forward method, overrides the "),oc=n(Bl,"CODE",{});var O2=r(oc);Lv=i(O2,"__call__"),O2.forEach(t),Sv=i(Bl," special method."),Bl.forEach(t),Iv=h(wn),$(Zs.$$.fragment,wn),Wv=h(wn),$(en.$$.fragment,wn),wn.forEach(t),st.forEach(t),dh=h(o),Po=n(o,"H2",{class:!0});var pu=r(Po);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N2=r(tn);sc=n(N2,"SPAN",{});var L2=r(sc);$(ja.$$.fragment,L2),L2.forEach(t),N2.forEach(t),Qv=h(pu),nc=n(pu,"SPAN",{});var S2=r(nc);Rv=i(S2,"FlaxDistilBertForSequenceClassification"),S2.forEach(t),pu.forEach(t),ch=h(o),ze=n(o,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uv=h(nt),rc=n(nt,"P",{});var I2=r(rc);Hv=i(I2,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I2.forEach(t),Vv=h(nt),qa=n(nt,"P",{});var hu=r(qa);Kv=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W2=r(ll);Jv=i(W2,"FlaxPreTrainedModel"),W2.forEach(t),Gv=i(hu,`. Check the superclass documentation for the generic methods the
