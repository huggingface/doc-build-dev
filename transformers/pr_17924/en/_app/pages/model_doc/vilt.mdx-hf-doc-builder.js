...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var h=r(d);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(h,"CODE",{});var F=r(g);u=i(F,"Module"),F.forEach(o),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(l,h){_(l,d,h),e(d,b),e(d,g),e(g,u),e(d,v)},d(l){l&&o(d)}}}function Bd(V){let d,b,g,u,v;return u=new Io({props:{code:`from transformers import ViltProcessor, ViltForQuestionAnswering
import requests
from PIL import Image
...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var h=r(d);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(h,"CODE",{});var F=r(g);u=i(F,"Module"),F.forEach(o),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(l,h){_(l,d,h),e(d,b),e(d,g),e(g,u),e(d,v)},d(l){l&&o(d)}}}function Rd(V){let d,b,g,u,v;return u=new Io({props:{code:`from transformers import ViltProcessor, ViltForImagesAndTextClassification
import requests
from PIL import Image
...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var h=r(d);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(h,"CODE",{});var F=r(g);u=i(F,"Module"),F.forEach(o),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(l,h){_(l,d,h),e(d,b),e(d,g),e(g,u),e(d,v)},d(l){l&&o(d)}}}function Kd(V){let d,b,g,u,v,l,h,F,As,Dn,Z,ve,Ao,at,Ls,Lo,Cs,Bn,be,qs,it,Ns,Ss,Wn,Jt,Os,Rn,Xt,Co,Ds,Qn,Zt,Bs,Un,q,lt,Ws,dt,Rs,Qs,Us,W,Hs,qo,Ks,Gs,No,Js,Xs,Yt,Zs,Ys,er,Y,tr,So,or,nr,eo,sr,rr,ar,Oo,ir,Hn,ke,al,Kn,we,lr,to,dr,cr,Gn,K,mr,ct,pr,hr,mt,fr,ur,Jn,ee,xe,Do,pt,gr,Bo,_r,Xn,P,ht,vr,te,br,Wo,kr,wr,ft,xr,Tr,yr,oe,$r,oo,Vr,Fr,no,Er,Mr,Pr,Te,Zn,ne,ye,Ro,ut,jr,Qo,zr,Yn,j,gt,Ir,Uo,Ar,Lr,_t,Cr,so,qr,Nr,Sr,G,vt,Or,Ho,Dr,Br,$e,es,se,Ve,Ko,bt,Wr,Go,Rr,ts,z,kt,Qr,Jo,Ur,Hr,M,ro,Kr,Gr,ao,Jr,Xr,io,Zr,Yr,wt,Xo,ea,ta,oa,Zo,na,sa,ra,J,xt,aa,re,ia,Fe,la,Yo,da,ca,ma,Ee,pa,en,ha,fa,ua,ga,tn,_a,os,ae,Me,on,Tt,va,nn,ba,ns,R,yt,ka,$t,wa,sn,xa,Ta,ya,N,Vt,$a,ie,Va,lo,Fa,Ea,rn,Ma,Pa,ja,Pe,za,je,ss,le,ze,an,Ft,Ia,ln,Aa,rs,I,Et,La,dn,Ca,qa,Mt,Na,cn,Sa,Oa,Da,S,Pt,Ba,de,Wa,co,Ra,Qa,mn,Ua,Ha,Ka,Ie,Ga,Ae,as,ce,Le,pn,jt,Ja,hn,Xa,is,A,zt,Za,fn,Ya,ei,It,ti,un,oi,ni,si,O,At,ri,me,ai,mo,ii,li,gn,di,ci,mi,Ce,pi,qe,ls,pe,Ne,_n,Lt,hi,vn,fi,ds,Q,Ct,ui,bn,gi,_i,D,qt,vi,he,bi,po,ki,wi,kn,xi,Ti,yi,Se,$i,Oe,cs,fe,De,wn,Nt,Vi,xn,Fi,ms,L,St,Ei,Tn,Mi,Pi,Ot,ji,yn,zi,Ii,Ai,B,Dt,Li,ue,Ci,ho,qi,Ni,$n,Si,Oi,Di,Be,Bi,We,ps,ge,Re,Vn,Bt,Wi,Fn,Ri,hs,C,Wt,Qi,En,Ui,Hi,Rt,Ki,Mn,Gi,Ji,Xi,X,Qt,Zi,_e,Yi,fo,el,tl,Pn,ol,nl,sl,Qe,fs;return l=new H({}),at=new H({}),pt=new H({}),ht=new E({props:{name:"class transformers.ViltConfig",anchor:"transformers.ViltConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"type_vocab_size",val:" = 2"},{name:"modality_type_vocab_size",val:" = 2"},{name:"max_position_embeddings",val:" = 40"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 384"},{name:"patch_size",val:" = 32"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"max_image_length",val:" = -1"},{name:"tie_word_embeddings",val:" = False"},{name:"num_images",val:" = -1"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViltConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
`}}),Ce=new Gt({props:{$$slots:{default:[Dd]},$$scope:{ctx:V}}}),qe=new jo({props:{anchor:"transformers.ViltForQuestionAnswering.forward.example",$$slots:{default:[Bd]},$$scope:{ctx:V}}}),Lt=new H({}),Ct=new E({props:{name:"class transformers.ViltForImagesAndTextClassification",anchor:"transformers.ViltForImagesAndTextClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/pr_17924/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/pr_17924/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_17924/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
`}}),Se=new Gt({props:{$$slots:{default:[Wd]},$$scope:{ctx:V}}}),Oe=new jo({props:{anchor:"transformers.ViltForImagesAndTextClassification.forward.example",$$slots:{default:[Rd]},$$scope:{ctx:V}}}),Nt=new H({}),St=new E({props:{name:"class transformers.ViltForImageAndTextRetrieval",anchor:"transformers.ViltForImageAndTextRetrieval",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17924/en/model_doc/vilt#transformers.ViltConfig">ViltConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
for Vision-and-Language Pre-training (VLP).`),Wn=m(),Jt=n("p"),Os=a("The abstract from the paper is the following:"),Rn=m(),Xt=n("p"),Co=n("em"),Ds=a(`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
...
times faster than previous VLP models, yet with competitive or better downstream task performance.`),Qn=m(),Zt=n("p"),Bs=a("Tips:"),Un=m(),q=n("ul"),lt=n("li"),Ws=a("The quickest way to get started with ViLT is by checking the "),dt=n("a"),Rs=a("example notebooks"),Qs=a(`
(which showcase both inference and fine-tuning on custom data).`),Us=m(),W=n("li"),Hs=a("ViLT is a model that takes both "),qo=n("code"),Ks=a("pixel_values"),Gs=a(" and "),No=n("code"),Js=a("input_ids"),Xs=a(" as input. One can use "),Yt=n("a"),Zs=a("ViltProcessor"),Ys=a(` to prepare data for the model.
...
additional embedding layers for the language modality.`),Hn=m(),ke=n("img"),Kn=m(),we=n("small"),lr=a("ViLT architecture. Taken from the "),to=n("a"),dr=a("original paper"),cr=a("."),Gn=m(),K=n("p"),mr=a("This model was contributed by "),ct=n("a"),pr=a("nielsr"),hr=a(". The original code can be found "),mt=n("a"),fr=a("here"),ur=a("."),Jn=m(),ee=n("h2"),xe=n("a"),Do=n("span"),k(pt.$$.fragment),gr=m(),Bo=n("span"),_r=a("ViltConfig"),Xn=m(),P=n("div"),k(ht.$$.fragment),vr=m(),te=n("p"),br=a("This is the configuration class to store the configuration of a "),Wo=n("code"),kr=a("ViLTModel"),wr=a(`. It is used to instantiate an ViLT
...
`),Ee=n("a"),pa=a("BertTokenizerFast."),en=n("strong"),ha=a("call"),fa=a("()"),ua=a(" to prepare text for the model."),ga=m(),tn=n("p"),_a=a("Please refer to the docstring of the above two methods for more information."),os=m(),ae=n("h2"),Me=n("a"),on=n("span"),k(Tt.$$.fragment),va=m(),nn=n("span"),ba=a("ViltModel"),ns=m(),R=n("div"),k(yt.$$.fragment),ka=m(),$t=n("p"),wa=a(`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ai=m(),B=n("div"),k(Dt.$$.fragment),Li=m(),ue=n("p"),Ci=a("The "),ho=n("a"),qi=a("ViltForImageAndTextRetrieval"),Ni=a(" forward method, overrides the "),$n=n("code"),Si=a("__call__"),Oi=a(" special method."),Di=m(),k(Be.$$.fragment),Bi=m(),k(We.$$.fragment),ps=m(),ge=n("h2"),Re=n("a"),Vn=n("span"),k(Bt.$$.fragment),Wi=m(),Fn=n("span"),Ri=a("ViltForTokenClassification"),hs=m(),C=n("div"),k(Wt.$$.fragment),Qi=m(),En=n("p"),Ui=a(`Vilt Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Hi=m(),Rt=n("p"),Ki=a("This model is a PyTorch "),Mn=n("code"),Gi=a("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),Ji=a(`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xi=m(),X=n("div"),k(Qt.$$.fragment),Zi=m(),_e=n("p"),Yi=a("The "),fo=n("a"),el=a("ViltForTokenClassification"),tl=a(" forward method, overrides the "),Pn=n("code"),ol=a("__call__"),nl=a(" special method."),sl=m(),k(Qe.$$.fragment),this.h()},l(t){const f=zd('[data-svelte="svelte-1phssyn"]',document.head);d=s(f,"META",{name:!0,content:!0}),f.forEach(o),b=p(t),g=s(t,"H1",{class:!0});var Ut=r(g);u=s(Ut,"A",{id:!0,class:!0,href:!0});var jn=r(u);v=s(jn,"SPAN",{});var zn=r(v);w(l.$$.fragment,zn),zn.forEach(o),jn.forEach(o),h=p(Ut),F=s(Ut,"SPAN",{});var In=r(F);As=i(In,"ViLT"),In.forEach(o),Ut.forEach(o),Dn=p(t),Z=s(t,"H2",{class:!0});var Ht=r(Z);ve=s(Ht,"A",{id:!0,class:!0,href:!0});var An=r(ve);Ao=s(An,"SPAN",{});var Ln=r(Ao);w(at.$$.fragment,Ln),Ln.forEach(o),An.forEach(o),Ls=p(Ht),Lo=s(Ht,"SPAN",{});var Cn=r(Lo);Cs=i(Cn,"Overview"),Cn.forEach(o),Ht.forEach(o),Bn=p(t),be=s(t,"P",{});var Kt=r(be);qs=i(Kt,"The ViLT model was proposed in "),it=s(Kt,"A",{href:!0,rel:!0});var qn=r(it);Ns=i(qn,"ViLT: Vision-and-Language Transformer Without Convolution or Region Supervision"),qn.forEach(o),Ss=i(Kt,`
by Wonjae Kim, Bokyung Son, Ildoo Kim. ViLT incorporates text embeddings into a Vision Transformer (ViT), allowing it to have a minimal design
for Vision-and-Language Pre-training (VLP).`),Kt.forEach(o),Wn=p(t),Jt=s(t,"P",{});var Nn=r(Jt);Os=i(Nn,"The abstract from the paper is the following:"),Nn.forEach(o),Rn=p(t),Xt=s(t,"P",{});var Sn=r(Xt);Co=s(Sn,"EM",{});var On=r(Co);Ds=i(On,`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
Current approaches to VLP heavily rely on image feature extraction processes, most of which involve region supervision
(e.g., object detection) and the convolutional architecture (e.g., ResNet). Although disregarded in the literature, we
find it problematic in terms of both (1) efficiency/speed, that simply extracting input features requires much more
computation than the multimodal interaction steps; and (2) expressive power, as it is upper bounded to the expressive
...
Vision-and-Language Transformer (ViLT), monolithic in the sense that the processing of visual inputs is drastically
simplified to just the same convolution-free manner that we process textual inputs. We show that ViLT is up to tens of
times faster than previous VLP models, yet with competitive or better downstream task performance.`),On.forEach(o),Sn.forEach(o),Qn=p(t),Zt=s(t,"P",{});var il=r(Zt);Bs=i(il,"Tips:"),il.forEach(o),Un=p(t),q=s(t,"UL",{});var Ue=r(q);lt=s(Ue,"LI",{});var us=r(lt);Ws=i(us,"The quickest way to get started with ViLT is by checking the "),dt=s(us,"A",{href:!0,rel:!0});var ll=r(dt);Rs=i(ll,"example notebooks"),ll.forEach(o),Qs=i(us,`
(which showcase both inference and fine-tuning on custom data).`),us.forEach(o),Us=p(Ue),W=s(Ue,"LI",{});var He=r(W);Hs=i(He,"ViLT is a model that takes both "),qo=s(He,"CODE",{});var dl=r(qo);Ks=i(dl,"pixel_values"),dl.forEach(o),Gs=i(He," and "),No=s(He,"CODE",{});var cl=r(No);Js=i(cl,"input_ids"),cl.forEach(o),Xs=i(He," as input. One can use "),Yt=s(He,"A",{href:!0});var ml=r(Yt);Zs=i(ml,"ViltProcessor"),ml.forEach(o),Ys=i(He,` to prepare data for the model.
...
`),Ee=s(wo,"A",{href:!0});var xs=r(Ee);pa=i(xs,"BertTokenizerFast."),en=s(xs,"STRONG",{});var Dl=r(en);ha=i(Dl,"call"),Dl.forEach(o),fa=i(xs,"()"),xs.forEach(o),ua=i(wo," to prepare text for the model."),wo.forEach(o),ga=p(ko),tn=s(ko,"P",{});var Bl=r(tn);_a=i(Bl,"Please refer to the docstring of the above two methods for more information."),Bl.forEach(o),ko.forEach(o),Je.forEach(o),os=p(t),ae=s(t,"H2",{class:!0});var Ts=r(ae);Me=s(Ts,"A",{id:!0,class:!0,href:!0});var Wl=r(Me);on=s(Wl,"SPAN",{});var Rl=r(on);w(Tt.$$.fragment,Rl),Rl.forEach(o),Wl.forEach(o),va=p(Ts),nn=s(Ts,"SPAN",{});var Ql=r(nn);ba=i(Ql,"ViltModel"),Ql.forEach(o),Ts.forEach(o),ns=p(t),R=s(t,"DIV",{class:!0});var xo=r(R);w(yt.$$.fragment,xo),ka=p(xo),$t=s(xo,"P",{});var ys=r($t);wa=i(ys,`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
