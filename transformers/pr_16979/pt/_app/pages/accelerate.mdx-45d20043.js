import{S as Wo,i as Qo,s as Jo,e as r,k as m,w as u,t as c,M as Ro,c as s,d as a,m as d,a as l,x as f,h as p,b as n,F as o,g as i,y as h,L as Ko,q as v,o as _,B as $,v as Vo}from"../chunks/vendor-aeea7ff3.js";import{I as ie,C as M}from"../chunks/CodeBlock-35f79fb9.js";function Xo(lo){let w,Oe,k,q,he,U,ba,ve,ga,De,S,wa,G,ka,Aa,He,A,C,_e,B,Ea,$e,ja,Fe,ne,Pa,Le,I,Me,b,ya,W,be,za,qa,ge,Sa,Ca,Ue,Q,Ge,E,N,we,J,Na,ke,xa,Be,x,Ta,R,Ae,Oa,Da,Ie,K,We,j,T,Ee,V,Ha,je,Fa,Qe,g,La,Pe,Ma,Ua,X,ye,Ga,Ba,Je,Y,Re,ce,Ia,Ke,Z,Ve,P,O,ze,ee,Wa,qe,Qa,Xe,pe,Ja,Ye,y,D,Se,ae,Ra,Ce,Ka,Ze,me,Va,ea,oe,aa,de,Xa,oa,te,ta,z,H,Ne,re,Ya,xe,Za,ra,F,eo,Te,ao,oo,sa,se,la,L,to,le,ro,so,ia;return U=new ie({}),B=new ie({}),I=new M({props:{code:"pip install accelerate",highlighted:"pip install accelerate"}}),Q=new M({props:{code:`from accelerate import Accelerator
...
<span class="hljs-meta">&gt;&gt;&gt; </span>notebook_launcher(training_function)`}}),{c(){w=r("meta"),Oe=m(),k=r("h1"),q=r("a"),he=r("span"),u(U.$$.fragment),ba=m(),ve=r("span"),ga=c("Treinamento distribu\xEDdo com o \u{1F917} Accelerate"),De=m(),S=r("p"),wa=c(`O paralelismo surgiu como uma estrat\xE9gia para treinar modelos grandes em hardware limitado e aumentar a velocidade
...
personalizar seu la\xE7o de treinamento de PyTorch nativo para poder treinar em ambientes distribu\xEDdos.`),He=m(),A=r("h2"),C=r("a"),_e=r("span"),u(B.$$.fragment),Ea=m(),$e=r("span"),ja=c("Configura\xE7\xE3o"),Fe=m(),ne=r("p"),Pa=c("De in\xEDcio, instale o \u{1F917} Accelerate:"),Le=m(),u(I.$$.fragment),Me=m(),b=r("p"),ya=c("Logo, devemos importar e criar um objeto "),W=r("a"),be=r("code"),za=c("Accelerator"),qa=c(`.
`),ge=r("code"),Sa=c("Accelerator"),Ca=c(` detectar\xE1 autom\xE1ticamente o tipo de configura\xE7\xE3o distribu\xEDda que est\xE1 dispon\xEDvel e inicializar\xE1 todos os
componentes necess\xE1rios para o treinamento. N\xE3o h\xE1 necessidade portanto de especificar o dispositivo onde deve colocar seu modelo.`),Ue=m(),u(Q.$$.fragment),Ge=m(),E=r("h2"),N=r("a"),we=r("span"),u(J.$$.fragment),Na=m(),ke=r("span"),xa=c("Preparando a acelera\xE7\xE3o"),Be=m(),x=r("p"),Ta=c("Passe todos os objetos relevantes para o treinamento ao m\xE9todo "),R=r("a"),Ae=r("code"),Oa=c("prepare"),Da=c(`.
Isto inclui os DataLoaders de treino e evalua\xE7\xE3o, um modelo e um otimizador:`),Ie=m(),u(K.$$.fragment),We=m(),j=r("h2"),T=r("a"),Ee=r("span"),u(V.$$.fragment),Ha=m(),je=r("span"),Fa=c("Backward"),Qe=m(),g=r("p"),La=c("Por \xFAltimo, substitua o "),Pe=r("code"),Ma=c("loss.backward()"),Ua=c(" padr\xE3o em teu la\xE7o de treinamento com o m\xE9todo "),X=r("a"),ye=r("code"),Ga=c("backward"),Ba=c(" do \u{1F917} Accelerate:"),Je=m(),u(Y.$$.fragment),Re=m(),ce=r("p"),Ia=c(`Como se poder ver no seguinte c\xF3digo, s\xF3 precisar\xE1 adicionar quatro linhas de c\xF3digo ao seu la\xE7o de treinamento
para habilitar o treinamento distribu\xEDdo!`),Ke=m(),u(Z.$$.fragment),Ve=m(),P=r("h2"),O=r("a"),ze=r("span"),u(ee.$$.fragment),Wa=m(),qe=r("span"),Qa=c("Treinamento"),Xe=m(),pe=r("p"),Ja=c("Quando tiver adicionado as linhas de c\xF3digo relevantes, inicie o treinamento por um script ou notebook como o Colab."),Ye=m(),y=r("h3"),D=r("a"),Se=r("span"),u(ae.$$.fragment),Ra=m(),Ce=r("span"),Ka=c("Treinamento em um Script"),Ze=m(),me=r("p"),Va=c("Se estiver rodando seu treinamento em um Script, execute o seguinte comando para criar e guardar um arquivo de configura\xE7\xE3o:"),ea=m(),u(oe.$$.fragment),aa=m(),de=r("p"),Xa=c("Comece seu treinamento com:"),oa=m(),u(te.$$.fragment),ta=m(),z=r("h3"),H=r("a"),Ne=r("span"),u(re.$$.fragment),Ya=m(),xe=r("span"),Za=c("Treinamento em um Notebook"),ra=m(),F=r("p"),eo=c(`O \u{1F917} Accelerate pode rodar em um notebook, por exemplo, se estiver planejando usar as TPUs do Google Colab.
Encapsule o c\xF3digo respons\xE1vel pelo treinamento de uma fun\xE7\xE3o e passe-o ao `),Te=r("code"),ao=c("notebook_launcher"),oo=c(":"),sa=m(),u(se.$$.fragment),la=m(),L=r("p"),to=c("Para obter mais informa\xE7\xF5es sobre o \u{1F917} Accelerate e suas numerosas fun\xE7\xF5es, consulte a "),le=r("a"),ro=c("documentaci\xF3n"),so=c("."),this.h()},l(e){const t=Ro('[data-svelte="svelte-1phssyn"]',document.head);w=s(t,"META",{name:!0,content:!0}),t.forEach(a),Oe=d(e),k=s(e,"H1",{class:!0});var na=l(k);q=s(na,"A",{id:!0,class:!0,href:!0});var io=l(q);he=s(io,"SPAN",{});var no=l(he);f(U.$$.fragment,no),no.forEach(a),io.forEach(a),ba=d(na),ve=s(na,"SPAN",{});var co=l(ve);ga=p(co,"Treinamento distribu\xEDdo com o \u{1F917} Accelerate"),co.forEach(a),na.forEach(a),De=d(e),S=s(e,"P",{});var ca=l(S);wa=p(ca,`O paralelismo surgiu como uma estrat\xE9gia para treinar modelos grandes em hardware limitado e aumentar a velocidade
