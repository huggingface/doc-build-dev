...
personalizar seu la\xE7o de treinamento de PyTorch nativo para poder treinar em ambientes distribu\xEDdos.`),He=m(),A=r("h2"),C=r("a"),_e=r("span"),u(B.$$.fragment),Ea=m(),$e=r("span"),ja=c("Configura\xE7\xE3o"),Fe=m(),ne=r("p"),Pa=c("De in\xEDcio, instale o \u{1F917} Accelerate:"),Le=m(),u(I.$$.fragment),Me=m(),b=r("p"),ya=c("Logo, devemos importar e criar um objeto "),W=r("a"),be=r("code"),za=c("Accelerator"),Sa=c(`.
