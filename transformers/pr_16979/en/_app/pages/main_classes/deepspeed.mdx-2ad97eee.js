...
documented `),qo=o("a"),Q4=a("here"),e5=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s5=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t5=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a5=a("Unlike, "),If=o("code"),n5=a("torch.distributed.launch"),o5=a(" where you have to specify how many GPUs to use with "),Uf=o("code"),l5=a("--nproc_per_node"),r5=a(`, with the
...
DeepSpeed docs.`),tw=u(),pa=o("p"),X7=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q7=a("Trainer"),e8=a(` provides
no equivalent command line arguments.`),aw=u(),Ni=o("p"),s8=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),nw=u(),Hi=o("a"),ow=u(),Rs=o("h4"),ia=o("a"),kd=o("span"),f(nl.$$.fragment),t8=u(),Pd=o("span"),a8=a("ZeRO-2 Config"),lw=u(),Bi=o("p"),n8=a("The following is an example of configuration for ZeRO stage 2:"),rw=u(),f(ol.$$.fragment),pw=u(),Wi=o("p"),Dd=o("strong"),o8=a("Performance tuning:"),iw=u(),He=o("ul"),Is=o("li"),l8=a("enabling "),zd=o("code"),r8=a("offload_optimizer"),p8=a(" should reduce GPU RAM usage (it requires "),Od=o("code"),i8=a('"stage": 2'),u8=a(")"),c8=u(),L=o("li"),Td=o("code"),h8=a('"overlap_comm": true'),f8=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=o("code"),d8=a("overlap_comm"),m8=a(` uses 4.5x
the `),Sd=o("code"),_8=a("allgather_bucket_size"),v8=a(" and "),Cd=o("code"),j8=a("reduce_bucket_size"),g8=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),xd=o("code"),y8=a("5e8 x 2Bytes x 2 x 4.5"),w8=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),Rd=o("code"),b8=a("2e8"),E8=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),q8=u(),Id=o("li"),$8=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),uw=u(),Be=o("p"),k8=a("Additionally, "),Ud=o("code"),P8=a("deepspeed==0.4.4"),D8=a(" added a new option "),Gd=o("code"),z8=a("round_robin_gradients"),O8=a(" which you can enable with:"),cw=u(),f(ll.$$.fragment),hw=u(),Fi=o("p"),T8=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),fw=u(),Vi=o("a"),dw=u(),Us=o("h4"),ua=o("a"),Ld=o("span"),f(rl.$$.fragment),A8=u(),Md=o("span"),S8=a("ZeRO-3 Config"),mw=u(),Yi=o("p"),C8=a("The following is an example of configuration for ZeRO stage 3:"),_w=u(),f(pl.$$.fragment),vw=u(),K=o("p"),x8=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Zd=o("code"),R8=a('"device": "cpu"'),I8=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Nd=o("code"),U8=a("none"),G8=a(" instead of "),Hd=o("code"),L8=a("cpu"),M8=a(" for the "),Bd=o("code"),Z8=a("device"),N8=a(` entry. Offloading to
NVMe is discussed further down.`),jw=u(),We=o("p"),H8=a("Pinned memory is enabled with "),Wd=o("code"),B8=a("pin_memory"),W8=a(" set to "),Fd=o("code"),F8=a("true"),V8=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),gw=u(),Ki=o("p"),Vd=o("strong"),Y8=a("Performance tuning:"),yw=u(),ca=o("ul"),il=o("li"),Yd=o("code"),K8=a("stage3_max_live_parameters"),J8=a(": "),Kd=o("code"),X8=a("1e9"),Q8=u(),ul=o("li"),Jd=o("code"),ek=a("stage3_max_reuse_distance"),sk=a(": "),Xd=o("code"),tk=a("1e9"),ww=u(),M=o("p"),ak=a("If hitting OOM reduce "),Qd=o("code"),nk=a("stage3_max_live_parameters"),ok=a(" and "),em=o("code"),lk=a("stage3_max_reuse_distance"),rk=a(`. They should have minimal impact
...
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),tw=c(e),pa=l(e,"P",{});var BE=r(pa);X7=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var gZ=r(Zi);Q7=n(gZ,"Trainer"),gZ.forEach(t),e8=n(BE,` provides
no equivalent command line arguments.`),BE.forEach(t),aw=c(e),Ni=l(e,"P",{});var yZ=r(Ni);s8=n(yZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),yZ.forEach(t),nw=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),ow=c(e),Rs=l(e,"H4",{class:!0});var WE=r(Rs);ia=l(WE,"A",{id:!0,class:!0,href:!0});var wZ=r(ia);kd=l(wZ,"SPAN",{});var bZ=r(kd);d(nl.$$.fragment,bZ),bZ.forEach(t),wZ.forEach(t),t8=c(WE),Pd=l(WE,"SPAN",{});var EZ=r(Pd);a8=n(EZ,"ZeRO-2 Config"),EZ.forEach(t),WE.forEach(t),lw=c(e),Bi=l(e,"P",{});var qZ=r(Bi);n8=n(qZ,"The following is an example of configuration for ZeRO stage 2:"),qZ.forEach(t),rw=c(e),d(ol.$$.fragment,e),pw=c(e),Wi=l(e,"P",{});var $Z=r(Wi);Dd=l($Z,"STRONG",{});var kZ=r(Dd);o8=n(kZ,"Performance tuning:"),kZ.forEach(t),$Z.forEach(t),iw=c(e),He=l(e,"UL",{});var yh=r(He);Is=l(yh,"LI",{});var wh=r(Is);l8=n(wh,"enabling "),zd=l(wh,"CODE",{});var PZ=r(zd);r8=n(PZ,"offload_optimizer"),PZ.forEach(t),p8=n(wh," should reduce GPU RAM usage (it requires "),Od=l(wh,"CODE",{});var DZ=r(Od);i8=n(DZ,'"stage": 2'),DZ.forEach(t),u8=n(wh,")"),wh.forEach(t),c8=c(yh),L=l(yh,"LI",{});var te=r(L);Td=l(te,"CODE",{});var zZ=r(Td);h8=n(zZ,'"overlap_comm": true'),zZ.forEach(t),f8=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=l(te,"CODE",{});var OZ=r(Ad);d8=n(OZ,"overlap_comm"),OZ.forEach(t),m8=n(te,` uses 4.5x
the `),Sd=l(te,"CODE",{});var TZ=r(Sd);_8=n(TZ,"allgather_bucket_size"),TZ.forEach(t),v8=n(te," and "),Cd=l(te,"CODE",{});var AZ=r(Cd);j8=n(AZ,"reduce_bucket_size"),AZ.forEach(t),g8=n(te,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),xd=l(te,"CODE",{});var SZ=r(xd);y8=n(SZ,"5e8 x 2Bytes x 2 x 4.5"),SZ.forEach(t),w8=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),Rd=l(te,"CODE",{});var CZ=r(Rd);b8=n(CZ,"2e8"),CZ.forEach(t),E8=n(te,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),te.forEach(t),q8=c(yh),Id=l(yh,"LI",{});var xZ=r(Id);$8=n(xZ,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),xZ.forEach(t),yh.forEach(t),uw=c(e),Be=l(e,"P",{});var bh=r(Be);k8=n(bh,"Additionally, "),Ud=l(bh,"CODE",{});var RZ=r(Ud);P8=n(RZ,"deepspeed==0.4.4"),RZ.forEach(t),D8=n(bh," added a new option "),Gd=l(bh,"CODE",{});var IZ=r(Gd);z8=n(IZ,"round_robin_gradients"),IZ.forEach(t),O8=n(bh," which you can enable with:"),bh.forEach(t),cw=c(e),d(ll.$$.fragment,e),hw=c(e),Fi=l(e,"P",{});var UZ=r(Fi);T8=n(UZ,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),UZ.forEach(t),fw=c(e),Vi=l(e,"A",{id:!0}),r(Vi).forEach(t),dw=c(e),Us=l(e,"H4",{class:!0});var FE=r(Us);ua=l(FE,"A",{id:!0,class:!0,href:!0});var GZ=r(ua);Ld=l(GZ,"SPAN",{});var LZ=r(Ld);d(rl.$$.fragment,LZ),LZ.forEach(t),GZ.forEach(t),A8=c(FE),Md=l(FE,"SPAN",{});var MZ=r(Md);S8=n(MZ,"ZeRO-3 Config"),MZ.forEach(t),FE.forEach(t),mw=c(e),Yi=l(e,"P",{});var ZZ=r(Yi);C8=n(ZZ,"The following is an example of configuration for ZeRO stage 3:"),ZZ.forEach(t),_w=c(e),d(pl.$$.fragment,e),vw=c(e),K=l(e,"P",{});var ws=r(K);x8=n(ws,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Zd=l(ws,"CODE",{});var NZ=r(Zd);R8=n(NZ,'"device": "cpu"'),NZ.forEach(t),I8=n(ws,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Nd=l(ws,"CODE",{});var HZ=r(Nd);U8=n(HZ,"none"),HZ.forEach(t),G8=n(ws," instead of "),Hd=l(ws,"CODE",{});var BZ=r(Hd);L8=n(BZ,"cpu"),BZ.forEach(t),M8=n(ws," for the "),Bd=l(ws,"CODE",{});var WZ=r(Bd);Z8=n(WZ,"device"),WZ.forEach(t),N8=n(ws,` entry. Offloading to
NVMe is discussed further down.`),ws.forEach(t),jw=c(e),We=l(e,"P",{});var Eh=r(We);H8=n(Eh,"Pinned memory is enabled with "),Wd=l(Eh,"CODE",{});var FZ=r(Wd);B8=n(FZ,"pin_memory"),FZ.forEach(t),W8=n(Eh," set to "),Fd=l(Eh,"CODE",{});var VZ=r(Fd);F8=n(VZ,"true"),VZ.forEach(t),V8=n(Eh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Eh.forEach(t),gw=c(e),Ki=l(e,"P",{});var YZ=r(Ki);Vd=l(YZ,"STRONG",{});var KZ=r(Vd);Y8=n(KZ,"Performance tuning:"),KZ.forEach(t),YZ.forEach(t),yw=c(e),ca=l(e,"UL",{});var VE=r(ca);il=l(VE,"LI",{});var YE=r(il);Yd=l(YE,"CODE",{});var JZ=r(Yd);K8=n(JZ,"stage3_max_live_parameters"),JZ.forEach(t),J8=n(YE,": "),Kd=l(YE,"CODE",{});var XZ=r(Kd);X8=n(XZ,"1e9"),XZ.forEach(t),YE.forEach(t),Q8=c(VE),ul=l(VE,"LI",{});var KE=r(ul);Jd=l(KE,"CODE",{});var QZ=r(Jd);ek=n(QZ,"stage3_max_reuse_distance"),QZ.forEach(t),sk=n(KE,": "),Xd=l(KE,"CODE",{});var eN=r(Xd);tk=n(eN,"1e9"),eN.forEach(t),KE.forEach(t),VE.forEach(t),ww=c(e),M=l(e,"P",{});var be=r(M);ak=n(be,"If hitting OOM reduce "),Qd=l(be,"CODE",{});var sN=r(Qd);nk=n(sN,"stage3_max_live_parameters"),sN.forEach(t),ok=n(be," and "),em=l(be,"CODE",{});var tN=r(em);lk=n(tN,"stage3_max_reuse_distance"),tN.forEach(t),rk=n(be,`. They should have minimal impact
