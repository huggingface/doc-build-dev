import{S as ls,i as ds,s as cs,e as n,k as m,w as v,t as s,M as hs,c as a,d as o,m as f,a as i,x as $,h as r,b as c,N as ps,F as e,g as _,y as S,q as y,o as T,B as x,v as ms,L as uo}from"../../chunks/vendor-6b77c823.js";import{T as ua}from"../../chunks/Tip-39098574.js";import{D as He}from"../../chunks/Docstring-1088f2fb.js";import{C as go}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as dt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as fo}from"../../chunks/ExampleCodeBlock-5212b321.js";function fs(M){let d,w;return d=new go({props:{code:`from transformers import SwinModel, SwinConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){v(d.$$.fragment)},l(p){$(d.$$.fragment,p)},m(p,u){S(d,p,u),w=!0},p:uo,i(p){w||(y(d.$$.fragment,p),w=!0)},o(p){T(d.$$.fragment,p),w=!1},d(p){x(d,p)}}}function us(M){let d,w,p,u,b;return{c(){d=n("p"),w=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=s("Module"),b=s(`
...
tabby, tabby cat`}}),{c(){d=n("p"),w=s("Example:"),p=m(),v(u.$$.fragment)},l(l){d=a(l,"P",{});var g=i(d);w=r(g,"Example:"),g.forEach(o),p=f(l),$(u.$$.fragment,l)},m(l,g){_(l,d,g),e(d,w),_(l,p,g),S(u,l,g),b=!0},p:uo,i(l){b||(y(u.$$.fragment,l),b=!0)},o(l){T(u.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(u,l)}}}function $s(M){let d,w,p,u,b,l,g,F,_o,Lt,N,J,ct,ge,wo,ht,bo,Ht,L,vo,_e,$o,So,yo,Wt,We,To,Ut,Ue,pt,xo,Bt,Be,ko,Vt,O,we,Mo,Ve,Eo,Fo,Co,be,jo,mt,Io,Ao,Po,k,qo,ft,zo,Oo,ut,Do,No,gt,Lo,Ho,_t,Wo,Uo,wt,Bo,Vo,bt,Ko,Ro,vt,Yo,Zo,Kt,Q,ga,Rt,X,Go,Ke,Jo,Qo,Yt,D,Xo,ve,en,tn,$e,on,nn,Zt,H,ee,$t,Se,an,St,sn,Gt,C,ye,rn,W,ln,Re,dn,cn,Te,hn,pn,mn,U,fn,Ye,un,gn,Ze,_n,wn,bn,te,Jt,B,oe,yt,xe,vn,Tt,$n,Qt,q,ke,Sn,Me,yn,Ee,Tn,xn,kn,I,Fe,Mn,V,En,Ge,Fn,Cn,xt,jn,In,An,ne,Pn,ae,Xt,K,se,kt,Ce,qn,Mt,zn,eo,z,je,On,R,Dn,Et,Nn,Ln,Ie,Hn,Wn,Un,A,Ae,Bn,Y,Vn,Je,Kn,Rn,Ft,Yn,Zn,Gn,re,Jn,ie,to,Z,le,Ct,Pe,Qn,jt,Xn,oo,j,qe,ea,It,ta,oa,ze,na,Oe,aa,sa,ra,P,De,ia,G,la,Qe,da,ca,At,ha,pa,ma,de,fa,ce,no;return l=new dt({}),ge=new dt({}),Se=new dt({}),ye=new He({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
<p>Example &#x2014;`,name:"encoder_stride"}],source:"https://github.com/huggingface/transformers/blob/vr_16979/src/transformers/models/swin/configuration_swin.py#L31"}}),te=new fo({props:{anchor:"transformers.SwinConfig.example",$$slots:{default:[fs]},$$scope:{ctx:M}}}),xe=new dt({}),ke=new He({props:{name:"class transformers.SwinModel",anchor:"transformers.SwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],parametersDescription:[{anchor:"transformers.SwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16979/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16979/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16979/src/transformers/models/swin/modeling_swin.py#L905"}}),Fe=new He({props:{name:"forward",anchor:"transformers.SwinModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16979/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16979/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16979/src/transformers/models/swin/modeling_swin.py#L1004"}}),Ae=new He({props:{name:"forward",anchor:"transformers.SwinForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16979/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_16979/src/transformers/models/swin/modeling_swin.py#L1019",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16979/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16979/src/transformers/models/swin/modeling_swin.py#L1114"}}),De=new He({props:{name:"forward",anchor:"transformers.SwinForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16979/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16979/src/transformers/models/swin/modeling_swin.py#L1129",returnDescription:`
...
`}}),de=new ua({props:{$$slots:{default:[bs]},$$scope:{ctx:M}}}),ce=new fo({props:{anchor:"transformers.SwinForImageClassification.forward.example",$$slots:{default:[vs]},$$scope:{ctx:M}}}),{c(){d=n("meta"),w=m(),p=n("h1"),u=n("a"),b=n("span"),v(l.$$.fragment),g=m(),F=n("span"),_o=s("Swin Transformer"),Lt=m(),N=n("h2"),J=n("a"),ct=n("span"),v(ge.$$.fragment),wo=m(),ht=n("span"),bo=s("Overview"),Ht=m(),L=n("p"),vo=s("The Swin Transformer was proposed in "),_e=n("a"),$o=s("Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),So=n("br"),yo=s(`
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),Wt=m(),We=n("p"),To=s("The abstract from the paper is the following:"),Ut=m(),Ue=n("p"),pt=n("em"),xo=s(`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),Bt=m(),Be=n("p"),ko=s("Tips:"),Vt=m(),O=n("ul"),we=n("li"),Mo=s("One can use the "),Ve=n("a"),Eo=s("AutoFeatureExtractor"),Fo=s(" API to prepare images for the model."),Co=m(),be=n("li"),jo=s("Swin pads the inputs supporting any input height and width (if divisible by "),mt=n("code"),Io=s("32"),Ao=s(")."),Po=m(),k=n("li"),qo=s("Swin can be used as a "),ft=n("em"),zo=s("backbone"),Oo=s(". When "),ut=n("code"),Do=s("output_hidden_states = True"),No=s(", it will output both "),gt=n("code"),Lo=s("hidden_states"),Ho=s(" and "),_t=n("code"),Wo=s("reshaped_hidden_states"),Uo=s(". The "),wt=n("code"),Bo=s("reshaped_hidden_states"),Vo=s(" have a shape of "),bt=n("code"),Ko=s("(batch, num_channels, height, width)"),Ro=s(" rather than "),vt=n("code"),Yo=s("(batch_size, sequence_length, num_channels)"),Zo=s("."),Kt=m(),Q=n("img"),Rt=m(),X=n("small"),Go=s("Swin Transformer architecture. Taken from the "),Ke=n("a"),Jo=s("original paper"),Qo=s("."),Yt=m(),D=n("p"),Xo=s("This model was contributed by "),ve=n("a"),en=s("novice03"),tn=s(". The original code can be found "),$e=n("a"),on=s("here"),nn=s("."),Zt=m(),H=n("h2"),ee=n("a"),$t=n("span"),v(Se.$$.fragment),an=m(),St=n("span"),sn=s("SwinConfig"),Gt=m(),C=n("div"),v(ye.$$.fragment),rn=m(),W=n("p"),ln=s("This is the configuration class to store the configuration of a "),Re=n("a"),dn=s("SwinModel"),cn=s(`. It is used to instantiate a Swin
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the Swin
`),Te=n("a"),hn=s("microsoft/swin-tiny-patch4-window7-224"),pn=s(`
