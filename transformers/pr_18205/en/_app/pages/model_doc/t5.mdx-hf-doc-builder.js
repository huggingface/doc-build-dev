import{S as qy,i as Fy,s as My,e as a,k as d,w as k,t as o,M as Cy,c as r,d as t,m as c,a as i,x as v,h as s,b as h,G as e,g as m,y,q as w,o as $,B as x,v as Py,L as Te}from"../../chunks/vendor-hf-doc-builder.js";import{T as kt}from"../../chunks/Tip-hf-doc-builder.js";import{D as M}from"../../chunks/Docstring-hf-doc-builder.js";import{C as S}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as _e}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ge}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ny(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function Yy(j){let p,b,g,u,T,l,_,E,Ee,se,q,ee,G,ae,qe,U,Fe,ve,W,A,re,pe,C,N,he,K,ye,ue,R,Me,we,P,Ce,H,V,be,O,Pe,ke,I,Ne,B,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),E=a("li"),Ee=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),q=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),qe=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),W=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),C=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),R=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),be=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),ke=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),E=r(te,"LI",{});var et=i(E);Ee=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),q=r(z,"P",{});var D=i(q);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),qe=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),C=r(z,"UL",{});var L=i(C);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),R=r(Y,"CODE",{});var Le=i(R);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),be=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),ke=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(Ie,"CODE",{});var st=i(B);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,E),e(E,Ee),m(z,se,F),m(z,q,F),e(q,ee),e(q,G),e(G,ae),e(q,qe),e(q,U),e(U,Fe),e(q,ve),m(z,W,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,C,F),e(C,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,R),e(R,Me),e(C,we),e(C,P),e(P,Ce),e(P,H),e(H,V),e(P,be),e(P,O),e(O,Pe),e(C,ke),e(C,I),e(I,Ne),e(I,B),e(B,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(q),z&&t(W),z&&t(A),z&&t(pe),z&&t(C)}}}function Zy(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Examples:"),_.forEach(t),g=c(l),v(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,b),m(l,g,_),y(u,l,_),T=!0},p:Te,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function Xy(j){let p,b,g,u,T,l,_,E,Ee,se,q,ee,G,ae,qe,U,Fe,ve,W,A,re,pe,C,N,he,K,ye,ue,R,Me,we,P,Ce,H,V,be,O,Pe,ke,I,Ne,B,Oe;return{c(){p=a("p"),b=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),E=a("li"),Ee=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),q=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),qe=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ve=o("."),W=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),C=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),R=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),be=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),ke=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),E=r(te,"LI",{});var et=i(E);Ee=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),q=r(z,"P",{});var D=i(q);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),qe=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),C=r(z,"UL",{});var L=i(C);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),R=r(Y,"CODE",{});var Le=i(R);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),be=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),ke=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(Ie,"CODE",{});var st=i(B);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,b),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,E),e(E,Ee),m(z,se,F),m(z,q,F),e(q,ee),e(q,G),e(G,ae),e(q,qe),e(q,U),e(U,Fe),e(q,ve),m(z,W,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,C,F),e(C,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,R),e(R,Me),e(C,we),e(C,P),e(P,Ce),e(P,H),e(H,V),e(P,be),e(P,O),e(O,Pe),e(C,ke),e(C,I),e(I,Ne),e(I,B),e(B,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(q),z&&t(W),z&&t(A),z&&t(pe),z&&t(C)}}}function Qy(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var E=i(g);u=s(E,"Module"),E.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18205/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18205/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18205/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18205/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_t5.py#L1345",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18205/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_t5.py#L1538",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_t5.py#L1494"}}),Sn=new ge({props:{anchor:"transformers.T5ForConditionalGeneration.parallelize.example",$$slots:{default:[Sy]},$$scope:{ctx:j}}}),aa=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_t5.py#L1507"}}),Gn=new ge({props:{anchor:"transformers.T5ForConditionalGeneration.deparallelize.example",$$slots:{default:[Gy]},$$scope:{ctx:j}}}),ra=new _e({}),ia=new M({props:{name:"class transformers.T5EncoderModel",anchor:"transformers.T5EncoderModel",parameters:[{name:"config",val:": T5Config"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18205/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_18205/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_t5.py#L1809",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18205/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
`}}),Wn=new kt({props:{$$slots:{default:[Uy]},$$scope:{ctx:j}}}),Rn=new ge({props:{anchor:"transformers.T5EncoderModel.forward.example",$$slots:{default:[Wy]},$$scope:{ctx:j}}}),ma=new M({props:{name:"parallelize",anchor:"transformers.T5EncoderModel.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the t5 models have the
following number of attention modules:</p>
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_tf_t5.py#L1146",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18205/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
`}}),Yn=new kt({props:{$$slots:{default:[Vy]},$$scope:{ctx:j}}}),Zn=new ge({props:{anchor:"transformers.TFT5Model.call.example",$$slots:{default:[Ky]},$$scope:{ctx:j}}}),$a=new _e({}),xa=new M({props:{name:"class transformers.TFT5ForConditionalGeneration",anchor:"transformers.TFT5ForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18205/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18205/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_tf_t5.py#L1266"}}),Xn=new kt({props:{$$slots:{default:[Yy]},$$scope:{ctx:j}}}),Ca=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_input_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"encoder_outputs",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18205/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18205/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18205/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_tf_t5.py#L1322",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18205/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_tf_t5.py#L1569",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18205/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18205/src/transformers/models/t5/modeling_flax_t5.py#L956",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18205/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_18205/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_18205/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),fp.forEach(t),$c=c(n),Tr=r(n,"A",{id:!0}),i(Tr).forEach(t),xc=c(n),At=r(n,"H2",{class:!0});var _p=i(At);yn=r(_p,"A",{id:!0,class:!0,href:!0});var Qv=i(yn);il=r(Qv,"SPAN",{});var e5=i(il);v(ns.$$.fragment,e5),e5.forEach(t),Qv.forEach(t),fm=c(_p),ll=r(_p,"SPAN",{});var t5=i(ll);_m=s(t5,"Inference"),t5.forEach(t),_p.forEach(t),zc=c(n),rt=r(n,"P",{});var wo=i(rt);gm=s(wo,"At inference time, it is recommended to use "),br=r(wo,"A",{href:!0});var n5=i(br);Tm=s(n5,"generate()"),n5.forEach(t),bm=s(wo,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),os=r(wo,"A",{href:!0,rel:!0});var o5=i(os);km=s(o5,"this blog post"),o5.forEach(t),vm=s(wo,` to know all the details about generating text with Transformers.
...
`),kr=r(Nt,"A",{href:!0});var i5=i(kr);qm=s(i5,"generate()"),i5.forEach(t),Fm=s(Nt,", make sure you start it with the "),pl=r(Nt,"CODE",{});var l5=i(pl);Mm=s(l5,"pad_token_id"),l5.forEach(t),Cm=s(Nt,"."),Nt.forEach(t),qc=c(n),vr=r(n,"P",{});var d5=i(vr);Pm=s(d5,"The example above only shows a single example. You can also do batched inference, like so:"),d5.forEach(t),Fc=c(n),v(rs.$$.fragment,n),Mc=c(n),yr=r(n,"P",{});var c5=i(yr);Nm=s(c5,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),c5.forEach(t),Cc=c(n),v(is.$$.fragment,n),Pc=c(n),wr=r(n,"A",{id:!0}),i(wr).forEach(t),Nc=c(n),It=r(n,"H2",{class:!0});var gp=i(It);wn=r(gp,"A",{id:!0,class:!0,href:!0});var p5=i(wn);hl=r(p5,"SPAN",{});var h5=i(hl);v(ls.$$.fragment,h5),h5.forEach(t),p5.forEach(t),Om=c(gp),ul=r(gp,"SPAN",{});var u5=i(ul);Lm=s(u5,"Performance"),u5.forEach(t),gp.forEach(t),Oc=c(n),it=r(n,"P",{});var $o=i(it);Am=s($o,"If you\u2019d like a faster training and inference performance, install "),ds=r($o,"A",{href:!0,rel:!0});var m5=i(ds);Im=s(m5,"apex"),m5.forEach(t),Dm=s($o," and then the model will automatically use "),ml=r($o,"CODE",{});var f5=i(ml);Sm=s(f5,"apex.normalization.FusedRMSNorm"),f5.forEach(t),Gm=s($o," instead of "),fl=r($o,"CODE",{});var _5=i(fl);Um=s(_5,"T5LayerNorm"),_5.forEach(t),Wm=s($o,". The former uses an optimized fused kernel which is several times faster than the latter."),$o.forEach(t),Lc=c(n),Dt=r(n,"H2",{class:!0});var Tp=i(Dt);$n=r(Tp,"A",{id:!0,class:!0,href:!0});var g5=i($n);_l=r(g5,"SPAN",{});var T5=i(_l);v(cs.$$.fragment,T5),T5.forEach(t),g5.forEach(t),Rm=c(Tp),gl=r(Tp,"SPAN",{});var b5=i(gl);Bm=s(b5,"Example scripts"),b5.forEach(t),Tp.forEach(t),Ac=c(n),$r=r(n,"P",{});var k5=i($r);Hm=s(k5,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),k5.forEach(t),Ic=c(n),xn=r(n,"UL",{});var bp=i(xn);Tl=r(bp,"LI",{});var v5=i(Tl);St=r(v5,"P",{});var Qr=i(St);Vm=s(Qr,"pre-training: the "),ps=r(Qr,"A",{href:!0,rel:!0});var y5=i(ps);Km=s(y5,"run_t5_mlm_flax.py"),y5.forEach(t),Ym=s(Qr,`
...
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Qr.forEach(t),v5.forEach(t),Xm=c(bp),bl=r(bp,"LI",{});var $5=i(bl);De=r($5,"P",{});var bt=i(De);Qm=s(bt,"fine-tuning: T5 is supported by the official summarization scripts ("),us=r(bt,"A",{href:!0,rel:!0});var x5=i(us);ef=s(x5,"PyTorch"),x5.forEach(t),tf=s(bt,", "),ms=r(bt,"A",{href:!0,rel:!0});var z5=i(ms);nf=s(z5,"Tensorflow"),z5.forEach(t),of=s(bt,", and "),fs=r(bt,"A",{href:!0,rel:!0});var j5=i(fs);sf=s(j5,"Flax"),j5.forEach(t),af=s(bt,`) and translation scripts
...
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),$5.forEach(t),bp.forEach(t),Dc=c(n),Gt=r(n,"H2",{class:!0});var kp=i(Gt);zn=r(kp,"A",{id:!0,class:!0,href:!0});var F5=i(zn);kl=r(F5,"SPAN",{});var M5=i(kl);v(Ts.$$.fragment,M5),M5.forEach(t),F5.forEach(t),pf=c(kp),vl=r(kp,"SPAN",{});var C5=i(vl);hf=s(C5,"T5Config"),C5.forEach(t),kp.forEach(t),Sc=c(n),vt=r(n,"DIV",{class:!0});var ei=i(vt);v(bs.$$.fragment,ei),uf=c(ei),yt=r(ei,"P",{});var xo=i(yt);mf=s(xo,"This is the configuration class to store the configuration of a "),xr=r(xo,"A",{href:!0});var P5=i(xr);ff=s(P5,"T5Model"),P5.forEach(t),_f=s(xo," or a "),zr=r(xo,"A",{href:!0});var N5=i(zr);gf=s(N5,"TFT5Model"),N5.forEach(t),Tf=s(xo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ks=r(xo,"A",{href:!0,rel:!0});var O5=i(ks);bf=s(O5,"t5-small"),O5.forEach(t),kf=s(xo," architecture."),xo.forEach(t),vf=c(ei),Ut=r(ei,"P",{});var ti=i(Ut);yf=s(ti,"Configuration objects inherit from "),jr=r(ti,"A",{href:!0});var L5=i(jr);wf=s(L5,"PretrainedConfig"),L5.forEach(t),$f=s(ti,` and can be used to control the model outputs. Read the
documentation from `),Er=r(ti,"A",{href:!0});var A5=i(Er);xf=s(A5,"PretrainedConfig"),A5.forEach(t),zf=s(ti," for more information."),ti.forEach(t),ei.forEach(t),Gc=c(n),Wt=r(n,"H2",{class:!0});var vp=i(Wt);jn=r(vp,"A",{id:!0,class:!0,href:!0});var I5=i(jn);yl=r(I5,"SPAN",{});var D5=i(yl);v(vs.$$.fragment,D5),D5.forEach(t),I5.forEach(t),jf=c(vp),wl=r(vp,"SPAN",{});var S5=i(wl);Ef=s(S5,"T5Tokenizer"),S5.forEach(t),vp.forEach(t),Uc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);v(ys.$$.fragment,Ve),qf=c(Ve),ws=r(Ve,"P",{});var yp=i(ws);Ff=s(yp,"Construct a T5 tokenizer. Based on "),$s=r(yp,"A",{href:!0,rel:!0});var G5=i($s);Mf=s(G5,"SentencePiece"),G5.forEach(t),Cf=s(yp,"."),yp.forEach(t),Pf=c(Ve),xs=r(Ve,"P",{});var wp=i(xs);Nf=s(wp,"This tokenizer inherits from "),qr=r(wp,"A",{href:!0});var U5=i(qr);Of=s(U5,"PreTrainedTokenizer"),U5.forEach(t),Lf=s(wp,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),wp.forEach(t),Af=c(Ve),Et=r(Ve,"DIV",{class:!0});var ni=i(Et);v(zs.$$.fragment,ni),If=c(ni),$l=r(ni,"P",{});var W5=i($l);Df=s(W5,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),W5.forEach(t),Sf=c(ni),js=r(ni,"UL",{});var $p=i(js);Fr=r($p,"LI",{});var Ak=i(Fr);Gf=s(Ak,"single sequence: "),xl=r(Ak,"CODE",{});var R5=i(xl);Uf=s(R5,"X </s>"),R5.forEach(t),Ak.forEach(t),Wf=c($p),Mr=r($p,"LI",{});var Ik=i(Mr);Rf=s(Ik,"pair of sequences: "),zl=r(Ik,"CODE",{});var B5=i(zl);Bf=s(B5,"A </s> B </s>"),B5.forEach(t),Ik.forEach(t),$p.forEach(t),ni.forEach(t),Hf=c(Ve),En=r(Ve,"DIV",{class:!0});var xp=i(En);v(Es.$$.fragment,xp),Vf=c(xp),qs=r(xp,"P",{});var zp=i(qs);Kf=s(zp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),jl=r(zp,"CODE",{});var H5=i(jl);Yf=s(H5,"prepare_for_model"),H5.forEach(t),Zf=s(zp," method."),zp.forEach(t),xp.forEach(t),Jf=c(Ve),qn=r(Ve,"DIV",{class:!0});var jp=i(qn);v(Fs.$$.fragment,jp),Xf=c(jp),El=r(jp,"P",{});var V5=i(El);Qf=s(V5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),V5.forEach(t),jp.forEach(t),e_=c(Ve),Cr=r(Ve,"DIV",{class:!0});var K5=i(Cr);v(Ms.$$.fragment,K5),K5.forEach(t),Ve.forEach(t),Wc=c(n),Rt=r(n,"H2",{class:!0});var Ep=i(Rt);Fn=r(Ep,"A",{id:!0,class:!0,href:!0});var Y5=i(Fn);ql=r(Y5,"SPAN",{});var Z5=i(ql);v(Cs.$$.fragment,Z5),Z5.forEach(t),Y5.forEach(t),t_=c(Ep),Fl=r(Ep,"SPAN",{});var J5=i(Fl);n_=s(J5,"T5TokenizerFast"),J5.forEach(t),Ep.forEach(t),Rc=c(n),Se=r(n,"DIV",{class:!0});var Ot=i(Se);v(Ps.$$.fragment,Ot),o_=c(Ot),Bt=r(Ot,"P",{});var oi=i(Bt);s_=s(oi,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),Ml=r(oi,"EM",{});var X5=i(Ml);a_=s(X5,"tokenizers"),X5.forEach(t),r_=s(oi,` library). Based on
...
refer to this superclass for more information regarding those methods.`),qp.forEach(t),u_=c(Ot),qt=r(Ot,"DIV",{class:!0});var si=i(qt);v(Ls.$$.fragment,si),m_=c(si),Cl=r(si,"P",{});var t1=i(Cl);f_=s(t1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),t1.forEach(t),__=c(si),As=r(si,"UL",{});var Fp=i(As);Nr=r(Fp,"LI",{});var Dk=i(Nr);g_=s(Dk,"single sequence: "),Pl=r(Dk,"CODE",{});var n1=i(Pl);T_=s(n1,"X </s>"),n1.forEach(t),Dk.forEach(t),b_=c(Fp),Or=r(Fp,"LI",{});var Sk=i(Or);k_=s(Sk,"pair of sequences: "),Nl=r(Sk,"CODE",{});var o1=i(Nl);v_=s(o1,"A </s> B </s>"),o1.forEach(t),Sk.forEach(t),Fp.forEach(t),si.forEach(t),y_=c(Ot),Mn=r(Ot,"DIV",{class:!0});var Mp=i(Mn);v(Is.$$.fragment,Mp),w_=c(Mp),Ol=r(Mp,"P",{});var s1=i(Ol);$_=s(s1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),s1.forEach(t),Mp.forEach(t),Ot.forEach(t),Bc=c(n),Ht=r(n,"H2",{class:!0});var Cp=i(Ht);Cn=r(Cp,"A",{id:!0,class:!0,href:!0});var a1=i(Cn);Ll=r(a1,"SPAN",{});var r1=i(Ll);v(Ds.$$.fragment,r1),r1.forEach(t),a1.forEach(t),x_=c(Cp),Al=r(Cp,"SPAN",{});var i1=i(Al);z_=s(i1,"T5Model"),i1.forEach(t),Cp.forEach(t),Hc=c(n),J=r(n,"DIV",{class:!0});var xe=i(J);v(Ss.$$.fragment,xe),j_=c(xe),Il=r(xe,"P",{});var l1=i(Il);E_=s(l1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),l1.forEach(t),q_=c(xe),Gs=r(xe,"P",{});var Pp=i(Gs);F_=s(Pp,"The T5 model was proposed in "),Us=r(Pp,"A",{href:!0,rel:!0});var d1=i(Us);M_=s(d1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Op.forEach(t),G_=c(xe),lt=r(xe,"DIV",{class:!0});var zo=i(lt);v(Hs.$$.fragment,zo),U_=c(zo),Vt=r(zo,"P",{});var ai=i(Vt);W_=s(ai,"The "),Ar=r(ai,"A",{href:!0});var h1=i(Ar);R_=s(h1,"T5Model"),h1.forEach(t),B_=s(ai," forward method, overrides the "),Dl=r(ai,"CODE",{});var u1=i(Dl);H_=s(u1,"__call__"),u1.forEach(t),V_=s(ai," special method."),ai.forEach(t),K_=c(zo),v(Pn.$$.fragment,zo),Y_=c(zo),v(Nn.$$.fragment,zo),zo.forEach(t),Z_=c(xe),dt=r(xe,"DIV",{class:!0});var jo=i(dt);v(Vs.$$.fragment,jo),J_=c(jo),Sl=r(jo,"P",{});var m1=i(Sl);X_=s(m1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),m1.forEach(t),Q_=c(jo),Gl=r(jo,"P",{});var f1=i(Gl);eg=s(f1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),f1.forEach(t),tg=c(jo),v(On.$$.fragment,jo),jo.forEach(t),ng=c(xe),Ft=r(xe,"DIV",{class:!0});var ri=i(Ft);v(Ks.$$.fragment,ri),og=c(ri),Ul=r(ri,"P",{});var _1=i(Ul);sg=s(_1,"Moves the model to cpu from a model parallel state."),_1.forEach(t),ag=c(ri),v(Ln.$$.fragment,ri),ri.forEach(t),xe.forEach(t),Vc=c(n),Kt=r(n,"H2",{class:!0});var Lp=i(Kt);An=r(Lp,"A",{id:!0,class:!0,href:!0});var g1=i(An);Wl=r(g1,"SPAN",{});var T1=i(Wl);v(Ys.$$.fragment,T1),T1.forEach(t),g1.forEach(t),rg=c(Lp),Rl=r(Lp,"SPAN",{});var b1=i(Rl);ig=s(b1,"T5ForConditionalGeneration"),b1.forEach(t),Lp.forEach(t),Kc=c(n),X=r(n,"DIV",{class:!0});var ze=i(X);v(Zs.$$.fragment,ze),lg=c(ze),Js=r(ze,"P",{});var Ap=i(Js);dg=s(Ap,"T5 Model with a "),Bl=r(Ap,"CODE",{});var k1=i(Bl);cg=s(k1,"language modeling"),k1.forEach(t),pg=s(Ap," head on top."),Ap.forEach(t),hg=c(ze),Xs=r(ze,"P",{});var Ip=i(Xs);ug=s(Ip,"The T5 model was proposed in "),Qs=r(Ip,"A",{href:!0,rel:!0});var v1=i(Qs);mg=s(v1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),v1.forEach(t),fg=s(Ip,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dp.forEach(t),kg=c(ze),ta=r(ze,"P",{});var Sp=i(ta);vg=s(Sp,"This model is also a PyTorch "),na=r(Sp,"A",{href:!0,rel:!0});var w1=i(na);yg=s(w1,"torch.nn.Module"),w1.forEach(t),wg=s(Sp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sp.forEach(t),$g=c(ze),ct=r(ze,"DIV",{class:!0});var Eo=i(ct);v(oa.$$.fragment,Eo),xg=c(Eo),Yt=r(Eo,"P",{});var ii=i(Yt);zg=s(ii,"The "),Dr=r(ii,"A",{href:!0});var $1=i(Dr);jg=s($1,"T5ForConditionalGeneration"),$1.forEach(t),Eg=s(ii," forward method, overrides the "),Hl=r(ii,"CODE",{});var x1=i(Hl);qg=s(x1,"__call__"),x1.forEach(t),Fg=s(ii," special method."),ii.forEach(t),Mg=c(Eo),v(In.$$.fragment,Eo),Cg=c(Eo),v(Dn.$$.fragment,Eo),Eo.forEach(t),Pg=c(ze),pt=r(ze,"DIV",{class:!0});var qo=i(pt);v(sa.$$.fragment,qo),Ng=c(qo),Vl=r(qo,"P",{});var z1=i(Vl);Og=s(z1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),z1.forEach(t),Lg=c(qo),Kl=r(qo,"P",{});var j1=i(Kl);Ag=s(j1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),j1.forEach(t),Ig=c(qo),v(Sn.$$.fragment,qo),qo.forEach(t),Dg=c(ze),Mt=r(ze,"DIV",{class:!0});var li=i(Mt);v(aa.$$.fragment,li),Sg=c(li),Yl=r(li,"P",{});var E1=i(Yl);Gg=s(E1,"Moves the model to cpu from a model parallel state."),E1.forEach(t),Ug=c(li),v(Gn.$$.fragment,li),li.forEach(t),ze.forEach(t),Yc=c(n),Zt=r(n,"H2",{class:!0});var Gp=i(Zt);Un=r(Gp,"A",{id:!0,class:!0,href:!0});var q1=i(Un);Zl=r(q1,"SPAN",{});var F1=i(Zl);v(ra.$$.fragment,F1),F1.forEach(t),q1.forEach(t),Wg=c(Gp),Jl=r(Gp,"SPAN",{});var M1=i(Jl);Rg=s(M1,"T5EncoderModel"),M1.forEach(t),Gp.forEach(t),Zc=c(n),Q=r(n,"DIV",{class:!0});var je=i(Q);v(ia.$$.fragment,je),Bg=c(je),Xl=r(je,"P",{});var C1=i(Xl);Hg=s(C1,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),C1.forEach(t),Vg=c(je),la=r(je,"P",{});var Up=i(la);Kg=s(Up,"The T5 model was proposed in "),da=r(Up,"A",{href:!0,rel:!0});var P1=i(da);Yg=s(P1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rp.forEach(t),aT=c(je),ht=r(je,"DIV",{class:!0});var Fo=i(ht);v(ua.$$.fragment,Fo),rT=c(Fo),Jt=r(Fo,"P",{});var di=i(Jt);iT=s(di,"The "),Gr=r(di,"A",{href:!0});var L1=i(Gr);lT=s(L1,"T5EncoderModel"),L1.forEach(t),dT=s(di," forward method, overrides the "),Ql=r(di,"CODE",{});var A1=i(Ql);cT=s(A1,"__call__"),A1.forEach(t),pT=s(di," special method."),di.forEach(t),hT=c(Fo),v(Wn.$$.fragment,Fo),uT=c(Fo),v(Rn.$$.fragment,Fo),Fo.forEach(t),mT=c(je),ut=r(je,"DIV",{class:!0});var Mo=i(ut);v(ma.$$.fragment,Mo),fT=c(Mo),ed=r(Mo,"P",{});var I1=i(ed);_T=s(I1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),I1.forEach(t),gT=c(Mo),td=r(Mo,"P",{});var D1=i(td);TT=s(D1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),D1.forEach(t),bT=c(Mo),v(Bn.$$.fragment,Mo),Mo.forEach(t),kT=c(je),Ct=r(je,"DIV",{class:!0});var ci=i(Ct);v(fa.$$.fragment,ci),vT=c(ci),nd=r(ci,"P",{});var S1=i(nd);yT=s(S1,"Moves the model to cpu from a model parallel state."),S1.forEach(t),wT=c(ci),v(Hn.$$.fragment,ci),ci.forEach(t),je.forEach(t),Jc=c(n),Xt=r(n,"H2",{class:!0});var Bp=i(Xt);Vn=r(Bp,"A",{id:!0,class:!0,href:!0});var G1=i(Vn);od=r(G1,"SPAN",{});var U1=i(od);v(_a.$$.fragment,U1),U1.forEach(t),G1.forEach(t),$T=c(Bp),sd=r(Bp,"SPAN",{});var W1=i(sd);xT=s(W1,"TFT5Model"),W1.forEach(t),Bp.forEach(t),Xc=c(n),le=r(n,"DIV",{class:!0});var Ke=i(le);v(ga.$$.fragment,Ke),zT=c(Ke),ad=r(Ke,"P",{});var R1=i(ad);jT=s(R1,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),R1.forEach(t),ET=c(Ke),Ta=r(Ke,"P",{});var Hp=i(Ta);qT=s(Hp,"The T5 model was proposed in "),ba=r(Hp,"A",{href:!0,rel:!0});var B1=i(ba);FT=s(B1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),B1.forEach(t),MT=s(Hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Hp.forEach(t),CT=c(Ke),ka=r(Ke,"P",{});var Vp=i(ka);PT=s(Vp,"This model inherits from "),Ur=r(Vp,"A",{href:!0});var H1=i(Ur);NT=s(H1,"TFPreTrainedModel"),H1.forEach(t),OT=s(Vp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vp.forEach(t),LT=c(Ke),va=r(Ke,"P",{});var Kp=i(va);AT=s(Kp,"This model is also a "),ya=r(Kp,"A",{href:!0,rel:!0});var V1=i(ya);IT=s(V1,"tf.keras.Model"),V1.forEach(t),DT=s(Kp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kp.forEach(t),ST=c(Ke),v(Kn.$$.fragment,Ke),GT=c(Ke),mt=r(Ke,"DIV",{class:!0});var Co=i(mt);v(wa.$$.fragment,Co),UT=c(Co),Qt=r(Co,"P",{});var pi=i(Qt);WT=s(pi,"The "),Wr=r(pi,"A",{href:!0});var K1=i(Wr);RT=s(K1,"TFT5Model"),K1.forEach(t),BT=s(pi," forward method, overrides the "),rd=r(pi,"CODE",{});var Y1=i(rd);HT=s(Y1,"__call__"),Y1.forEach(t),VT=s(pi," special method."),pi.forEach(t),KT=c(Co),v(Yn.$$.fragment,Co),YT=c(Co),v(Zn.$$.fragment,Co),Co.forEach(t),Ke.forEach(t),Qc=c(n),en=r(n,"H2",{class:!0});var Yp=i(en);Jn=r(Yp,"A",{id:!0,class:!0,href:!0});var Z1=i(Jn);id=r(Z1,"SPAN",{});var J1=i(id);v($a.$$.fragment,J1),J1.forEach(t),Z1.forEach(t),ZT=c(Yp),ld=r(Yp,"SPAN",{});var X1=i(ld);JT=s(X1,"TFT5ForConditionalGeneration"),X1.forEach(t),Yp.forEach(t),ep=c(n),de=r(n,"DIV",{class:!0});var Ye=i(de);v(xa.$$.fragment,Ye),XT=c(Ye),za=r(Ye,"P",{});var Zp=i(za);QT=s(Zp,"T5 Model with a "),dd=r(Zp,"CODE",{});var Q1=i(dd);eb=s(Q1,"language modeling"),Q1.forEach(t),tb=s(Zp," head on top."),Zp.forEach(t),nb=c(Ye),ja=r(Ye,"P",{});var Jp=i(ja);ob=s(Jp,"The T5 model was proposed in "),Ea=r(Jp,"A",{href:!0,rel:!0});var ey=i(Ea);sb=s(ey,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qp.forEach(t),mb=c(Ye),v(Xn.$$.fragment,Ye),fb=c(Ye),ft=r(Ye,"DIV",{class:!0});var Po=i(ft);v(Ca.$$.fragment,Po),_b=c(Po),tn=r(Po,"P",{});var hi=i(tn);gb=s(hi,"The "),Br=r(hi,"A",{href:!0});var oy=i(Br);Tb=s(oy,"TFT5ForConditionalGeneration"),oy.forEach(t),bb=s(hi," forward method, overrides the "),cd=r(hi,"CODE",{});var sy=i(cd);kb=s(sy,"__call__"),sy.forEach(t),vb=s(hi," special method."),hi.forEach(t),yb=c(Po),v(Qn.$$.fragment,Po),wb=c(Po),v(eo.$$.fragment,Po),Po.forEach(t),Ye.forEach(t),tp=c(n),nn=r(n,"H2",{class:!0});var eh=i(nn);to=r(eh,"A",{id:!0,class:!0,href:!0});var ay=i(to);pd=r(ay,"SPAN",{});var ry=i(pd);v(Pa.$$.fragment,ry),ry.forEach(t),ay.forEach(t),$b=c(eh),hd=r(eh,"SPAN",{});var iy=i(hd);xb=s(iy,"TFT5EncoderModel"),iy.forEach(t),eh.forEach(t),np=c(n),ce=r(n,"DIV",{class:!0});var Ze=i(ce);v(Na.$$.fragment,Ze),zb=c(Ze),ud=r(Ze,"P",{});var ly=i(ud);jb=s(ly,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),ly.forEach(t),Eb=c(Ze),Oa=r(Ze,"P",{});var th=i(Oa);qb=s(th,"The T5 model was proposed in "),La=r(th,"A",{href:!0,rel:!0});var dy=i(La);Fb=s(dy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
