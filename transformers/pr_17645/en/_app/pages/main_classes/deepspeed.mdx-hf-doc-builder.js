...
install `),yf=o("em"),e5=a("libaio-dev"),s5=a(" system-wide)."),vg=u(),zt=o("p"),t5=a("Edit "),wf=o("code"),a5=a("TORCH_CUDA_ARCH_LIST"),n5=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),jg=u(),f(_o.$$.fragment),gg=u(),Pe=o("p"),o5=a("So if you get "),bf=o("code"),l5=a("8, 6"),r5=a(", then use "),Ef=o("code"),p5=a('TORCH_CUDA_ARCH_LIST="8.6"'),i5=a(`. If you have multiple different cards, you can list all
of them like so `),qf=o("code"),u5=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),yg=u(),ti=o("p"),c5=a("If you need to use the same setup on multiple machines, make a binary wheel:"),wg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h5=a("it will generate something like "),$f=o("code"),f5=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d5=a(` which now you can install
as `),kf=o("code"),m5=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_5=a(" locally or on any other machine."),Eg=u(),Ot=o("p"),v5=a("Again, remember to ensure to adjust "),Pf=o("code"),j5=a("TORCH_CUDA_ARCH_LIST"),g5=a(" to the target architectures."),qg=u(),Ue=o("p"),y5=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Df=o("strong"),w5=a("Compute Capabilities"),b5=a(` (same as arch in this
context) `),jo=o("a"),E5=a("here"),q5=a("."),$g=u(),ai=o("p"),$5=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k5=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(yo.$$.fragment),zg=u(),oi=o("p"),P5=a("If the output is:"),Og=u(),f(wo.$$.fragment),Tg=u(),Tt=o("p"),D5=a("then you know that this card\u2019s arch is "),zf=o("code"),z5=a("8.6"),O5=a("."),Ag=u(),At=o("p"),T5=a("You can also leave "),Of=o("code"),A5=a("TORCH_CUDA_ARCH_LIST"),S5=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),Sg=u(),St=o("p"),C5=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=o("a"),x5=a("Deepspeed"),R5=a(","),Cg=u(),li=o("a"),xg=u(),Ps=o("h3"),Ct=o("a"),Tf=o("span"),f(Eo.$$.fragment),I5=u(),Af=o("span"),U5=a("Deployment with multiple GPUs"),Rg=u(),xt=o("p"),G5=a("To deploy this feature with multiple GPUs adjust the "),ri=o("a"),L5=a("Trainer"),M5=a(` command line arguments as
following:`),Ig=u(),Rt=o("ol"),Ds=o("li"),Z5=a("replace "),Sf=o("code"),N5=a("python -m torch.distributed.launch"),H5=a(" with "),Cf=o("code"),B5=a("deepspeed"),W5=a("."),F5=u(),De=o("li"),V5=a("add a new argument "),xf=o("code"),Y5=a("--deepspeed ds_config.json"),K5=a(", where "),Rf=o("code"),J5=a("ds_config.json"),X5=a(` is the DeepSpeed configuration file as
documented `),qo=o("a"),Q5=a("here"),e$=a(". The file naming is up to you."),Ug=u(),pi=o("p"),s$=a("Therefore, if your original command line looked as follows:"),Gg=u(),f($o.$$.fragment),Lg=u(),ii=o("p"),t$=a("Now it should be:"),Mg=u(),f(ko.$$.fragment),Zg=u(),U=o("p"),a$=a("Unlike, "),If=o("code"),n$=a("torch.distributed.launch"),o$=a(" where you have to specify how many GPUs to use with "),Uf=o("code"),l$=a("--nproc_per_node"),r$=a(`, with the
`),Gf=o("code"),p$=a("deepspeed"),i$=a(" launcher you don\u2019t have to use the corresponding "),Lf=o("code"),u$=a("--num_gpus"),c$=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=o("a"),h$=a("here"),f$=a("."),Ng=u(),ne=o("p"),d$=a("In fact, you can continue using "),Mf=o("code"),m$=a("-m torch.distributed.launch"),_$=a(` with DeepSpeed as long as you don\u2019t need to use
`),Zf=o("code"),v$=a("deepspeed"),j$=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Nf=o("code"),g$=a("deepspeed"),y$=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Hg=u(),It=o("p"),w$=a("Here is an example of running "),Hf=o("code"),b$=a("run_translation.py"),E$=a(" under DeepSpeed deploying all available GPUs:"),Bg=u(),f(Do.$$.fragment),Wg=u(),Ut=o("p"),q$=a("Note that in the DeepSpeed documentation you are likely to see "),Bf=o("code"),$$=a("--deepspeed --deepspeed_config ds_config.json"),k$=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Fg=u(),Gt=o("p"),P$=a("For some practical usage examples, please, see this "),zo=o("a"),D$=a("post"),z$=a("."),Vg=u(),ui=o("a"),Yg=u(),zs=o("h3"),Lt=o("a"),Wf=o("span"),f(Oo.$$.fragment),O$=u(),Ff=o("span"),T$=a("Deployment with one GPU"),Kg=u(),Mt=o("p"),A$=a("To deploy DeepSpeed with one GPU adjust the "),ci=o("a"),S$=a("Trainer"),C$=a(" command line arguments as follows:"),Jg=u(),f(To.$$.fragment),Xg=u(),Ge=o("p"),x$=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Vf=o("code"),R$=a("--num_gpus=1"),I$=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=o("a"),U$=a("documentation"),G$=a(" discusses the launcher options."),Qg=u(),hi=o("p"),L$=a("Why would you want to use DeepSpeed with just one GPU?"),ey=u(),Zt=o("ol"),Yf=o("li"),M$=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),Z$=u(),Kf=o("li"),N$=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),sy=u(),fi=o("p"),H$=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),ty=u(),f(So.$$.fragment),ay=u(),di=o("p"),B$=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),ny=u(),Nt=o("p"),W$=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F$=a("post"),V$=a("."),oy=u(),mi=o("p"),Y$=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),ly=u(),_i=o("p"),K$=a("Notes:"),ry=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J$=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=o("code"),X$=a("CUDA_VISIBLE_DEVICES"),Q$=a(` to limit
...
install `),yf=l(uh,"EM",{});var mL=r(yf);e5=n(mL,"libaio-dev"),mL.forEach(t),s5=n(uh," system-wide)."),uh.forEach(t),vg=c(e),zt=l(e,"P",{});var cE=r(zt);t5=n(cE,"Edit "),wf=l(cE,"CODE",{});var _L=r(wf);a5=n(_L,"TORCH_CUDA_ARCH_LIST"),_L.forEach(t),n5=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),cE.forEach(t),jg=c(e),d(_o.$$.fragment,e),gg=c(e),Pe=l(e,"P",{});var Ap=r(Pe);o5=n(Ap,"So if you get "),bf=l(Ap,"CODE",{});var vL=r(bf);l5=n(vL,"8, 6"),vL.forEach(t),r5=n(Ap,", then use "),Ef=l(Ap,"CODE",{});var jL=r(Ef);p5=n(jL,'TORCH_CUDA_ARCH_LIST="8.6"'),jL.forEach(t),i5=n(Ap,`. If you have multiple different cards, you can list all
of them like so `),qf=l(Ap,"CODE",{});var gL=r(qf);u5=n(gL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),gL.forEach(t),Ap.forEach(t),yg=c(e),ti=l(e,"P",{});var yL=r(ti);c5=n(yL,"If you need to use the same setup on multiple machines, make a binary wheel:"),yL.forEach(t),wg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h5=n(ch,"it will generate something like "),$f=l(ch,"CODE",{});var wL=r($f);f5=n(wL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wL.forEach(t),d5=n(ch,` which now you can install
as `),kf=l(ch,"CODE",{});var bL=r(kf);m5=n(bL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),bL.forEach(t),_5=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),Ot=l(e,"P",{});var hE=r(Ot);v5=n(hE,"Again, remember to ensure to adjust "),Pf=l(hE,"CODE",{});var EL=r(Pf);j5=n(EL,"TORCH_CUDA_ARCH_LIST"),EL.forEach(t),g5=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);y5=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Df=l(hh,"STRONG",{});var qL=r(Df);w5=n(qL,"Compute Capabilities"),qL.forEach(t),b5=n(hh,` (same as arch in this
context) `),jo=l(hh,"A",{href:!0,rel:!0});var $L=r(jo);E5=n($L,"here"),$L.forEach(t),q5=n(hh,"."),hh.forEach(t),$g=c(e),ai=l(e,"P",{});var kL=r(ai);$5=n(kL,"You can check the archs pytorch was built with using:"),kL.forEach(t),kg=c(e),d(go.$$.fragment,e),Pg=c(e),ni=l(e,"P",{});var PL=r(ni);k5=n(PL,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),PL.forEach(t),Dg=c(e),d(yo.$$.fragment,e),zg=c(e),oi=l(e,"P",{});var DL=r(oi);P5=n(DL,"If the output is:"),DL.forEach(t),Og=c(e),d(wo.$$.fragment,e),Tg=c(e),Tt=l(e,"P",{});var fE=r(Tt);D5=n(fE,"then you know that this card\u2019s arch is "),zf=l(fE,"CODE",{});var zL=r(zf);z5=n(zL,"8.6"),zL.forEach(t),O5=n(fE,"."),fE.forEach(t),Ag=c(e),At=l(e,"P",{});var dE=r(At);T5=n(dE,"You can also leave "),Of=l(dE,"CODE",{});var OL=r(Of);A5=n(OL,"TORCH_CUDA_ARCH_LIST"),OL.forEach(t),S5=n(dE,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),dE.forEach(t),Sg=c(e),St=l(e,"P",{});var mE=r(St);C5=n(mE,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),bo=l(mE,"A",{href:!0,rel:!0});var TL=r(bo);x5=n(TL,"Deepspeed"),TL.forEach(t),R5=n(mE,","),mE.forEach(t),Cg=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),xg=c(e),Ps=l(e,"H3",{class:!0});var _E=r(Ps);Ct=l(_E,"A",{id:!0,class:!0,href:!0});var AL=r(Ct);Tf=l(AL,"SPAN",{});var SL=r(Tf);d(Eo.$$.fragment,SL),SL.forEach(t),AL.forEach(t),I5=c(_E),Af=l(_E,"SPAN",{});var CL=r(Af);U5=n(CL,"Deployment with multiple GPUs"),CL.forEach(t),_E.forEach(t),Rg=c(e),xt=l(e,"P",{});var vE=r(xt);G5=n(vE,"To deploy this feature with multiple GPUs adjust the "),ri=l(vE,"A",{href:!0});var xL=r(ri);L5=n(xL,"Trainer"),xL.forEach(t),M5=n(vE,` command line arguments as
following:`),vE.forEach(t),Ig=c(e),Rt=l(e,"OL",{});var jE=r(Rt);Ds=l(jE,"LI",{});var fh=r(Ds);Z5=n(fh,"replace "),Sf=l(fh,"CODE",{});var RL=r(Sf);N5=n(RL,"python -m torch.distributed.launch"),RL.forEach(t),H5=n(fh," with "),Cf=l(fh,"CODE",{});var IL=r(Cf);B5=n(IL,"deepspeed"),IL.forEach(t),W5=n(fh,"."),fh.forEach(t),F5=c(jE),De=l(jE,"LI",{});var Mn=r(De);V5=n(Mn,"add a new argument "),xf=l(Mn,"CODE",{});var UL=r(xf);Y5=n(UL,"--deepspeed ds_config.json"),UL.forEach(t),K5=n(Mn,", where "),Rf=l(Mn,"CODE",{});var GL=r(Rf);J5=n(GL,"ds_config.json"),GL.forEach(t),X5=n(Mn,` is the DeepSpeed configuration file as
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var LL=r(qo);Q5=n(LL,"here"),LL.forEach(t),e$=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var ML=r(pi);s$=n(ML,"Therefore, if your original command line looked as follows:"),ML.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ZL=r(ii);t$=n(ZL,"Now it should be:"),ZL.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var ye=r(U);a$=n(ye,"Unlike, "),If=l(ye,"CODE",{});var NL=r(If);n$=n(NL,"torch.distributed.launch"),NL.forEach(t),o$=n(ye," where you have to specify how many GPUs to use with "),Uf=l(ye,"CODE",{});var HL=r(Uf);l$=n(HL,"--nproc_per_node"),HL.forEach(t),r$=n(ye,`, with the
`),Gf=l(ye,"CODE",{});var BL=r(Gf);p$=n(BL,"deepspeed"),BL.forEach(t),i$=n(ye," launcher you don\u2019t have to use the corresponding "),Lf=l(ye,"CODE",{});var WL=r(Lf);u$=n(WL,"--num_gpus"),WL.forEach(t),c$=n(ye,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=l(ye,"A",{href:!0,rel:!0});var FL=r(Po);h$=n(FL,"here"),FL.forEach(t),f$=n(ye,"."),ye.forEach(t),Ng=c(e),ne=l(e,"P",{});var Zn=r(ne);d$=n(Zn,"In fact, you can continue using "),Mf=l(Zn,"CODE",{});var VL=r(Mf);m$=n(VL,"-m torch.distributed.launch"),VL.forEach(t),_$=n(Zn,` with DeepSpeed as long as you don\u2019t need to use
`),Zf=l(Zn,"CODE",{});var YL=r(Zf);v$=n(YL,"deepspeed"),YL.forEach(t),j$=n(Zn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),Nf=l(Zn,"CODE",{});var KL=r(Nf);g$=n(KL,"deepspeed"),KL.forEach(t),y$=n(Zn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Zn.forEach(t),Hg=c(e),It=l(e,"P",{});var gE=r(It);w$=n(gE,"Here is an example of running "),Hf=l(gE,"CODE",{});var JL=r(Hf);b$=n(JL,"run_translation.py"),JL.forEach(t),E$=n(gE," under DeepSpeed deploying all available GPUs:"),gE.forEach(t),Bg=c(e),d(Do.$$.fragment,e),Wg=c(e),Ut=l(e,"P",{});var yE=r(Ut);q$=n(yE,"Note that in the DeepSpeed documentation you are likely to see "),Bf=l(yE,"CODE",{});var XL=r(Bf);$$=n(XL,"--deepspeed --deepspeed_config ds_config.json"),XL.forEach(t),k$=n(yE,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),yE.forEach(t),Fg=c(e),Gt=l(e,"P",{});var wE=r(Gt);P$=n(wE,"For some practical usage examples, please, see this "),zo=l(wE,"A",{href:!0,rel:!0});var QL=r(zo);D$=n(QL,"post"),QL.forEach(t),z$=n(wE,"."),wE.forEach(t),Vg=c(e),ui=l(e,"A",{id:!0}),r(ui).forEach(t),Yg=c(e),zs=l(e,"H3",{class:!0});var bE=r(zs);Lt=l(bE,"A",{id:!0,class:!0,href:!0});var eM=r(Lt);Wf=l(eM,"SPAN",{});var sM=r(Wf);d(Oo.$$.fragment,sM),sM.forEach(t),eM.forEach(t),O$=c(bE),Ff=l(bE,"SPAN",{});var tM=r(Ff);T$=n(tM,"Deployment with one GPU"),tM.forEach(t),bE.forEach(t),Kg=c(e),Mt=l(e,"P",{});var EE=r(Mt);A$=n(EE,"To deploy DeepSpeed with one GPU adjust the "),ci=l(EE,"A",{href:!0});var aM=r(ci);S$=n(aM,"Trainer"),aM.forEach(t),C$=n(EE," command line arguments as follows:"),EE.forEach(t),Jg=c(e),d(To.$$.fragment,e),Xg=c(e),Ge=l(e,"P",{});var dh=r(Ge);x$=n(dh,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Vf=l(dh,"CODE",{});var nM=r(Vf);R$=n(nM,"--num_gpus=1"),nM.forEach(t),I$=n(dh,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),Ao=l(dh,"A",{href:!0,rel:!0});var oM=r(Ao);U$=n(oM,"documentation"),oM.forEach(t),G$=n(dh," discusses the launcher options."),dh.forEach(t),Qg=c(e),hi=l(e,"P",{});var lM=r(hi);L$=n(lM,"Why would you want to use DeepSpeed with just one GPU?"),lM.forEach(t),ey=c(e),Zt=l(e,"OL",{});var qE=r(Zt);Yf=l(qE,"LI",{});var rM=r(Yf);M$=n(rM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),rM.forEach(t),Z$=c(qE),Kf=l(qE,"LI",{});var pM=r(Kf);N$=n(pM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),pM.forEach(t),qE.forEach(t),sy=c(e),fi=l(e,"P",{});var iM=r(fi);H$=n(iM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),iM.forEach(t),ty=c(e),d(So.$$.fragment,e),ay=c(e),di=l(e,"P",{});var uM=r(di);B$=n(uM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),uM.forEach(t),ny=c(e),Nt=l(e,"P",{});var $E=r(Nt);W$=n($E,"For a practical usage example of this type of deployment, please, see this "),Co=l($E,"A",{href:!0,rel:!0});var cM=r(Co);F$=n(cM,"post"),cM.forEach(t),V$=n($E,"."),$E.forEach(t),oy=c(e),mi=l(e,"P",{});var hM=r(mi);Y$=n(hM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),hM.forEach(t),ly=c(e),_i=l(e,"P",{});var fM=r(_i);K$=n(fM,"Notes:"),fM.forEach(t),ry=c(e),vi=l(e,"UL",{});var dM=r(vi);Os=l(dM,"LI",{});var mh=r(Os);xo=l(mh,"P",{});var kE=r(xo);J$=n(kE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=l(kE,"CODE",{});var mM=r(Jf);X$=n(mM,"CUDA_VISIBLE_DEVICES"),mM.forEach(t),Q$=n(kE,` to limit
