...
<docstring><name>class transformers.TFSharedEmbeddings</name><anchor>transformers.TFSharedEmbeddings</anchor><source>https://github.com/huggingface/transformers/blob/pr_15319/src/transformers/modeling_tf_utils.py#L1799</source><parameters>[{"name": "*args", "val": ""}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **vocab_size** (`int`) --
...
<div class="docstring">
<docstring><name>call</name><anchor>transformers.TFSharedEmbeddings.call</anchor><source>https://github.com/huggingface/transformers/blob/pr_15319/src/transformers/modeling_tf_utils.py#L1844</source><parameters>[{"name": "inputs", "val": ": Tensor"}, {"name": "mode", "val": ": str = 'embedding'"}]</parameters><paramsdesc>- **inputs** (`tf.Tensor`) --
