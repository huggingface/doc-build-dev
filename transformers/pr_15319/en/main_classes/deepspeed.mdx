...
1. Integration of the core DeepSpeed features via [Trainer](/docs/transformers/pr_15319/en/main_classes/trainer#transformers.Trainer). This is everything done for your type
