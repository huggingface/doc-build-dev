import{S as Lm,i as Sm,s as Dm,e as n,k as l,w as v,t as a,M as Gm,c as r,d as t,m as c,a as s,x as y,h as d,b as h,G as e,g as f,y as T,q as w,o as $,B as x,v as Wm,L as nt}from"../../chunks/vendor-hf-doc-builder.js";import{T as xo}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ve}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ce}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ot}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Um(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),k=a("Example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Rm(z){let p,k,g,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Hm(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">6</span>, <span class="hljs-number">1280</span>]`}}),{c(){p=n("p"),k=a("Example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Vm(z){let p,k,g,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Km(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Bot:   That&#x27;s too bad. Have you tried encouraging them to change their eating habits?</span>`}}),{c(){p=n("p"),k=a("Conversation example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Conversation example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Jm(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),k=a("Example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Qm(z){let p,k,g,u,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,he,re,$e,ue,H,Ie,xe,C,Le,U,Se;return{c(){p=n("p"),k=a("TF 2.0 models accepts two formats as inputs:"),g=l(),u=n("ul"),b=n("li"),i=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Me=a("having all inputs as a list, tuple or dict in the first positional arguments."),pe=l(),E=n("p"),fe=a("This second option is useful when using "),te=n("code"),Ce=a("tf.keras.Model.fit"),oe=a(` method which currently requires having all the
...
`),U=n("code"),Se=a('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(B){p=r(B,"P",{});var q=s(p);k=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(B),u=r(B,"UL",{});var ge=s(u);b=r(ge,"LI",{});var rt=s(b);i=d(rt,"having all inputs as keyword arguments (like PyTorch models), or"),rt.forEach(t),m=c(ge),F=r(ge,"LI",{});var Ke=s(F);Me=d(Ke,"having all inputs as a list, tuple or dict in the first positional arguments."),Ke.forEach(t),ge.forEach(t),pe=c(B),E=r(B,"P",{});var O=s(E);fe=d(O,"This second option is useful when using "),te=r(O,"CODE",{});var me=s(te);Ce=d(me,"tf.keras.Model.fit"),me.forEach(t),oe=d(O,` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=r(O,"CODE",{});var De=s(ne);je=d(De,"model(inputs)"),De.forEach(t),we=d(O,"."),O.forEach(t),G=c(B),N=r(B,"P",{});var be=s(N);_e=d(be,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),be.forEach(t),R=c(B),M=r(B,"UL",{});var V=s(M);j=r(V,"LI",{});var K=s(j);Oe=d(K,"a single Tensor with "),J=r(K,"CODE",{});var st=s(J);Q=d(st,"input_ids"),st.forEach(t),Pe=d(K," only and nothing else: "),W=r(K,"CODE",{});var Je=s(W);Ne=d(Je,"model(input_ids)"),Je.forEach(t),K.forEach(t),Ae=c(V),A=r(V,"LI",{});var I=s(A);he=d(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=r(I,"CODE",{});var ke=s(re);$e=d(ke,"model([input_ids, attention_mask])"),ke.forEach(t),ue=d(I," or "),H=r(I,"CODE",{});var at=s(H);Ie=d(at,"model([input_ids, attention_mask, token_type_ids])"),at.forEach(t),I.forEach(t),xe=c(V),C=r(V,"LI",{});var se=s(C);Le=d(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(se,"CODE",{});var dt=s(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),se.forEach(t),V.forEach(t)},m(B,q){f(B,p,q),e(p,k),f(B,g,q),f(B,u,q),e(u,b),e(b,i),e(u,m),e(u,F),e(F,Me),f(B,pe,q),f(B,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(B,G,q),f(B,N,q),e(N,_e),f(B,R,q),f(B,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,re),e(re,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(B){B&&t(p),B&&t(g),B&&t(u),B&&t(pe),B&&t(E),B&&t(G),B&&t(N),B&&t(R),B&&t(M)}}}function Xm(z){let p,k,g,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function Ym(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, TFBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=a("Example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Zm(z){let p,k,g,u,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,he,re,$e,ue,H,Ie,xe,C,Le,U,Se;return{c(){p=n("p"),k=a("TF 2.0 models accepts two formats as inputs:"),g=l(),u=n("ul"),b=n("li"),i=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Me=a("having all inputs as a list, tuple or dict in the first positional arguments."),pe=l(),E=n("p"),fe=a("This second option is useful when using "),te=n("code"),Ce=a("tf.keras.Model.fit"),oe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=n("code"),je=a("model(inputs)"),we=a("."),G=l(),N=n("p"),_e=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=l(),M=n("ul"),j=n("li"),Oe=a("a single Tensor with "),J=n("code"),Q=a("input_ids"),Pe=a(" only and nothing else: "),W=n("code"),Ne=a("model(input_ids)"),Ae=l(),A=n("li"),he=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),$e=a("model([input_ids, attention_mask])"),ue=a(" or "),H=n("code"),Ie=a("model([input_ids, attention_mask, token_type_ids])"),xe=l(),C=n("li"),Le=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),Se=a('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(B){p=r(B,"P",{});var q=s(p);k=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(B),u=r(B,"UL",{});var ge=s(u);b=r(ge,"LI",{});var rt=s(b);i=d(rt,"having all inputs as keyword arguments (like PyTorch models), or"),rt.forEach(t),m=c(ge),F=r(ge,"LI",{});var Ke=s(F);Me=d(Ke,"having all inputs as a list, tuple or dict in the first positional arguments."),Ke.forEach(t),ge.forEach(t),pe=c(B),E=r(B,"P",{});var O=s(E);fe=d(O,"This second option is useful when using "),te=r(O,"CODE",{});var me=s(te);Ce=d(me,"tf.keras.Model.fit"),me.forEach(t),oe=d(O,` method which currently requires having all the
...
first positional argument :`),be.forEach(t),R=c(B),M=r(B,"UL",{});var V=s(M);j=r(V,"LI",{});var K=s(j);Oe=d(K,"a single Tensor with "),J=r(K,"CODE",{});var st=s(J);Q=d(st,"input_ids"),st.forEach(t),Pe=d(K," only and nothing else: "),W=r(K,"CODE",{});var Je=s(W);Ne=d(Je,"model(input_ids)"),Je.forEach(t),K.forEach(t),Ae=c(V),A=r(V,"LI",{});var I=s(A);he=d(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=r(I,"CODE",{});var ke=s(re);$e=d(ke,"model([input_ids, attention_mask])"),ke.forEach(t),ue=d(I," or "),H=r(I,"CODE",{});var at=s(H);Ie=d(at,"model([input_ids, attention_mask, token_type_ids])"),at.forEach(t),I.forEach(t),xe=c(V),C=r(V,"LI",{});var se=s(C);Le=d(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(se,"CODE",{});var dt=s(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),se.forEach(t),V.forEach(t)},m(B,q){f(B,p,q),e(p,k),f(B,g,q),f(B,u,q),e(u,b),e(b,i),e(u,m),e(u,F),e(F,Me),f(B,pe,q),f(B,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(B,G,q),f(B,N,q),e(N,_e),f(B,R,q),f(B,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,re),e(re,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(B){B&&t(p),B&&t(g),B&&t(u),B&&t(pe),B&&t(E),B&&t(G),B&&t(N),B&&t(R),B&&t(M)}}}function ef(z){let p,k,g,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function tf(z){let p,k,g,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function of(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=a("Example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function rf(z){let p,k,g,u,b;return u=new Ve({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=a("Example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function sf(z){let p,k,g,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function af(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=a("Example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function df(z){let p,k,g,u,b;return u=new Ve({props:{code:`import jax.numpy as jnp
from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=a("Example:"),g=l(),v(u.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function lf(z){let p,k,g,u,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,he,re,$e,ue,H,Ie,xe,C,Le,U,Se,B,q,ge,rt,Ke,O,me,De,be,V,K,st,Je,I,ke,at,se,dt,Fd,qd,Bo,Ed,zo,Md,Cd,jd,Ge,Od,zr,Pd,Nd,Fr,Ad,Id,Kn,Ld,Sd,ba,it,qt,qr,Fo,Dd,Er,Gd,ka,Jn,Wd,va,qo,ya,lt,Et,Mr,Eo,Ud,Cr,Rd,Ta,ve,Mo,Hd,ct,Vd,Qn,Kd,Jd,Co,Qd,Xd,Yd,pt,Zd,Xn,ei,ti,Yn,oi,ni,ri,Mt,wa,ht,Ct,jr,jo,si,Or,ai,$a,ae,Oo,di,Pr,ii,li,jt,Nr,ci,pi,Zn,hi,ui,mi,Po,fi,er,_i,gi,bi,Qe,No,ki,Ar,vi,yi,Ir,tr,Ti,Lr,wi,xa,ut,Ot,Sr,Ao,$i,Dr,xi,Ba,de,Io,Bi,Lo,zi,Gr,Fi,qi,Ei,Pt,Wr,Mi,Ci,or,ji,Oi,Pi,So,Ni,nr,Ai,Ii,Li,Xe,Do,Si,Ur,Di,Gi,Rr,rr,Wi,Hr,Ui,za,mt,Nt,Vr,Go,Ri,Kr,Hi,Fa,We,Vi,Jr,Ki,Ji,Qr,Qi,Xi,Xr,Yi,qa,ye,Wo,Zi,Uo,el,sr,tl,ol,nl,Ro,rl,Ho,sl,al,dl,Be,Vo,il,ft,ll,ar,cl,pl,Yr,hl,ul,ml,At,fl,It,Ea,_t,Lt,Zr,Ko,_l,es,gl,Ma,Ue,bl,dr,kl,vl,ts,yl,Tl,os,wl,Ca,Te,Jo,$l,Qo,xl,ir,Bl,zl,Fl,Xo,ql,Yo,El,Ml,Cl,ze,Zo,jl,gt,Ol,lr,Pl,Nl,ns,Al,Il,Ll,St,Sl,Dt,ja,bt,Gt,rs,en,Dl,ss,Gl,Oa,kt,tn,Wl,Wt,on,Ul,Ut,Pa,vt,Rt,as,nn,Rl,ds,Hl,Na,ie,rn,Vl,sn,Kl,cr,Jl,Ql,Xl,an,Yl,dn,Zl,ec,tc,Ht,oc,Fe,ln,nc,yt,rc,pr,sc,ac,is,dc,ic,lc,Vt,cc,Kt,Aa,Tt,Jt,ls,cn,pc,cs,hc,Ia,le,pn,uc,hn,mc,hr,fc,_c,gc,un,bc,mn,kc,vc,yc,Qt,Tc,X,fn,wc,wt,$c,ur,xc,Bc,ps,zc,Fc,qc,Xt,Ec,hs,Mc,Cc,us,ms,fs,_s,jc,Oc,gs,bs,ks,_n,Pc,vs,Nc,Ac,La,$t,Yt,ys,gn,Ic,Ts,Lc,Sa,L,bn,Sc,kn,Dc,mr,Gc,Wc,Uc,vn,Rc,yn,Hc,Vc,Kc,ws,Jc,Qc,Re,$s,Tn,Xc,Yc,xs,wn,Zc,ep,Bs,$n,tp,op,zs,xn,np,rp,qe,Bn,sp,xt,ap,Fs,dp,ip,qs,lp,cp,pp,Zt,hp,eo,up,to,zn,mp,oo,fp,no,Fn,_p,ro,Da,Bt,so,Es,qn,gp,Ms,bp,Ga,S,En,kp,Mn,vp,fr,yp,Tp,wp,Cn,$p,jn,xp,Bp,zp,Cs,Fp,qp,He,js,On,Ep,Mp,Os,Pn,Cp,jp,Ps,Nn,Op,Pp,Ns,An,Np,Ap,D,In,Ip,zt,Lp,As,Sp,Dp,Is,Gp,Wp,Up,ao,Rp,Ls,Hp,Vp,Ss,Ds,Gs,Ws,Kp,Jp,Us,Rs,Hs,Vs,Qp,Xp,Ks,Js,Qs,Xs,Yp,Zp,Ys,Zs,Ln,io,lo,ea,Sn,eh,ta,th,oh,oa,nh,rh,co,Dn,sh,po,ah,ho,Gn,dh,uo,Wa;return i=new ce({}),R=new ce({}),be=new ce({}),Fo=new ce({}),qo=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Will be ignored`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/tokenization_blenderbot_fast.py#L61",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_17656/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/modeling_blenderbot.py#L1127",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17656/en/model_doc/blenderbot#transformers.BlenderbotConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/modeling_blenderbot.py#L1284",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17656/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/modeling_blenderbot.py#L1451",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_17656/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1155",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1278",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17656/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/modeling_flax_blenderbot.py#L1037",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
`}}),ro=new ot({props:{anchor:"transformers.FlaxBlenderbotModel.decode.example",$$slots:{default:[rf]},$$scope:{ctx:z}}}),qn=new ce({}),En=new P({props:{name:"class transformers.FlaxBlenderbotForConditionalGeneration",anchor:"transformers.FlaxBlenderbotForConditionalGeneration",parameters:[{name:"config",val:": BlenderbotConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxBlenderbotForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17656/en/model_doc/blenderbot#transformers.BlenderbotConfig">BlenderbotConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_17656/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/modeling_flax_blenderbot.py#L1153",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17656/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17656/src/transformers/models/blenderbot/modeling_flax_blenderbot.py#L1309",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17656/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
`}}),uo=new ot({props:{anchor:"transformers.FlaxBlenderbotForConditionalGeneration.decode.example",$$slots:{default:[df]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=l(),g=n("h1"),u=n("a"),b=n("span"),v(i.$$.fragment),m=l(),F=n("span"),Me=a("Blenderbot"),pe=l(),E=n("p"),fe=n("strong"),te=a("DISCLAIMER:"),Ce=a(" If you see something strange, file a "),oe=n("a"),ne=a("Github Issue"),je=a(" ."),we=l(),G=n("h2"),N=n("a"),_e=n("span"),v(R.$$.fragment),M=l(),j=n("span"),Oe=a("Overview"),J=l(),Q=n("p"),Pe=a("The Blender chatbot model was proposed in "),W=n("a"),Ne=a("Recipes for building an open-domain chatbot"),Ae=a(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
failure cases of our models.`),xe=l(),C=n("p"),Le=a("This model was contributed by "),U=n("a"),Se=a("sshleifer"),B=a(". The authors\u2019 code can be found "),q=n("a"),ge=a("here"),rt=a(" ."),Ke=l(),O=n("h2"),me=n("a"),De=n("span"),v(be.$$.fragment),V=l(),K=n("span"),st=a("Implementation Notes"),Je=l(),I=n("ul"),ke=n("li"),at=a("Blenderbot uses a standard "),se=n("a"),dt=a("seq2seq model transformer"),Fd=a(" based architecture."),qd=l(),Bo=n("li"),Ed=a("Available checkpoints can be found in the "),zo=n("a"),Md=a("model hub"),Cd=a("."),jd=l(),Ge=n("li"),Od=a("This is the "),zr=n("em"),Pd=a("default"),Nd=a(` Blenderbot model class. However, some smaller checkpoints, such as
`),Fr=n("code"),Ad=a("facebook/blenderbot_small_90M"),Id=a(`, have a different architecture and consequently should be used with
`),Kn=n("a"),Ld=a("BlenderbotSmall"),Sd=a("."),ba=l(),it=n("h2"),qt=n("a"),qr=n("span"),v(Fo.$$.fragment),Dd=l(),Er=n("span"),Gd=a("Usage"),ka=l(),Jn=n("p"),Wd=a("Here is an example of model usage:"),va=l(),v(qo.$$.fragment),ya=l(),lt=n("h2"),Et=n("a"),Mr=n("span"),v(Eo.$$.fragment),Ud=l(),Cr=n("span"),Rd=a("BlenderbotConfig"),Ta=l(),ve=n("div"),v(Mo.$$.fragment),Hd=l(),ct=n("p"),Vd=a("This is the configuration class to store the configuration of a "),Qn=n("a"),Kd=a("BlenderbotModel"),Jd=a(`. It is used to instantiate an
...
documentation from `),Yn=n("a"),oi=a("PretrainedConfig"),ni=a(" for more information."),ri=l(),v(Mt.$$.fragment),wa=l(),ht=n("h2"),Ct=n("a"),jr=n("span"),v(jo.$$.fragment),si=l(),Or=n("span"),ai=a("BlenderbotTokenizer"),$a=l(),ae=n("div"),v(Oo.$$.fragment),di=l(),Pr=n("p"),ii=a("Construct a Blenderbot tokenizer."),li=l(),jt=n("p"),Nr=n("code"),ci=a("Blenderbot"),pi=a(" is nearly identical to "),Zn=n("a"),hi=a("RobertaTokenizer"),ui=a(` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),mi=l(),Po=n("p"),fi=a("Refer to superclass "),er=n("a"),_i=a("RobertaTokenizer"),gi=a(" for usage examples and documentation concerning parameters."),bi=l(),Qe=n("div"),v(No.$$.fragment),ki=l(),Ar=n("p"),vi=a(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),yi=l(),Ir=n("ul"),tr=n("li"),Ti=a("single sequence: "),Lr=n("code"),wi=a("X </s>"),xa=l(),ut=n("h2"),Ot=n("a"),Sr=n("span"),v(Ao.$$.fragment),$i=l(),Dr=n("span"),xi=a("BlenderbotTokenizerFast"),Ba=l(),de=n("div"),v(Io.$$.fragment),Bi=l(),Lo=n("p"),zi=a("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Gr=n("em"),Fi=a("tokenizers"),qi=a(" library)."),Ei=l(),Pt=n("p"),Wr=n("code"),Mi=a("BlenderbotFast"),Ci=a(" is nearly identical to "),or=n("a"),ji=a("RobertaTokenizerFast"),Oi=a(` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Pi=l(),So=n("p"),Ni=a("Refer to superclass "),nr=n("a"),Ai=a("RobertaTokenizerFast"),Ii=a(" for usage examples and documentation concerning parameters."),Li=l(),Xe=n("div"),v(Do.$$.fragment),Si=l(),Ur=n("p"),Di=a(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),Rr=n("ul"),rr=n("li"),Wi=a("single sequence: "),Hr=n("code"),Ui=a("X </s>"),za=l(),mt=n("h2"),Nt=n("a"),Vr=n("span"),v(Go.$$.fragment),Ri=l(),Kr=n("span"),Hi=a("BlenderbotModel"),Fa=l(),We=n("p"),Vi=a("See "),Jr=n("code"),Ki=a("transformers.BartModel"),Ji=a(" for arguments to "),Qr=n("em"),Qi=a("forward"),Xi=a(" and "),Xr=n("em"),Yi=a("generate"),qa=l(),ye=n("div"),v(Wo.$$.fragment),Zi=l(),Uo=n("p"),el=a(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),dl=l(),Be=n("div"),v(Vo.$$.fragment),il=l(),ft=n("p"),ll=a("The "),ar=n("a"),cl=a("BlenderbotModel"),pl=a(" forward method, overrides the "),Yr=n("code"),hl=a("__call__"),ul=a(" special method."),ml=l(),v(At.$$.fragment),fl=l(),v(It.$$.fragment),Ea=l(),_t=n("h2"),Lt=n("a"),Zr=n("span"),v(Ko.$$.fragment),_l=l(),es=n("span"),gl=a("BlenderbotForConditionalGeneration"),Ma=l(),Ue=n("p"),bl=a("See "),dr=n("a"),kl=a("BartForConditionalGeneration"),vl=a(" for arguments to "),ts=n("em"),yl=a("forward"),Tl=a(" and "),os=n("em"),wl=a("generate"),Ca=l(),Te=n("div"),v(Jo.$$.fragment),$l=l(),Qo=n("p"),xl=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),ir=n("a"),Bl=a("PreTrainedModel"),zl=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fl=l(),Xo=n("p"),ql=a("This model is also a PyTorch "),Yo=n("a"),El=a("torch.nn.Module"),Ml=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cl=l(),ze=n("div"),v(Zo.$$.fragment),jl=l(),gt=n("p"),Ol=a("The "),lr=n("a"),Pl=a("BlenderbotForConditionalGeneration"),Nl=a(" forward method, overrides the "),ns=n("code"),Al=a("__call__"),Il=a(" special method."),Ll=l(),v(St.$$.fragment),Sl=l(),v(Dt.$$.fragment),ja=l(),bt=n("h2"),Gt=n("a"),rs=n("span"),v(en.$$.fragment),Dl=l(),ss=n("span"),Gl=a("BlenderbotForCausalLM"),Oa=l(),kt=n("div"),v(tn.$$.fragment),Wl=l(),Wt=n("div"),v(on.$$.fragment),Ul=l(),v(Ut.$$.fragment),Pa=l(),vt=n("h2"),Rt=n("a"),as=n("span"),v(nn.$$.fragment),Rl=l(),ds=n("span"),Hl=a("TFBlenderbotModel"),Na=l(),ie=n("div"),v(rn.$$.fragment),Vl=l(),sn=n("p"),Kl=a(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),tc=l(),v(Ht.$$.fragment),oc=l(),Fe=n("div"),v(ln.$$.fragment),nc=l(),yt=n("p"),rc=a("The "),pr=n("a"),sc=a("TFBlenderbotModel"),ac=a(" forward method, overrides the "),is=n("code"),dc=a("__call__"),ic=a(" special method."),lc=l(),v(Vt.$$.fragment),cc=l(),v(Kt.$$.fragment),Aa=l(),Tt=n("h2"),Jt=n("a"),ls=n("span"),v(cn.$$.fragment),pc=l(),cs=n("span"),hc=a("TFBlenderbotForConditionalGeneration"),Ia=l(),le=n("div"),v(pn.$$.fragment),uc=l(),hn=n("p"),mc=a(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gc=l(),un=n("p"),bc=a("This model is also a "),mn=n("a"),kc=a("tf.keras.Model"),vc=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc=l(),v(Qt.$$.fragment),Tc=l(),X=n("div"),v(fn.$$.fragment),wc=l(),wt=n("p"),$c=a("The "),ur=n("a"),xc=a("TFBlenderbotForConditionalGeneration"),Bc=a(" forward method, overrides the "),ps=n("code"),zc=a("__call__"),Fc=a(" special method."),qc=l(),v(Xt.$$.fragment),Ec=l(),hs=n("p"),Mc=a("Conversation example::"),Cc=l(),us=n("blockquote"),ms=n("blockquote"),fs=n("blockquote"),_s=n("p"),jc=a(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
skip_special_tokens=True)[0])`),Oc=l(),gs=n("blockquote"),bs=n("blockquote"),ks=n("blockquote"),_n=n("p"),Pc=a(`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
eat too many carbs.</s> `),vs=n("s"),Nc=a(`That\u2019s unfortunate. \u201D \u2026 \u201CAre they trying to lose weight or are they just trying to
be healthier?`),Ac=a(` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),La=l(),$t=n("h2"),Yt=n("a"),ys=n("span"),v(gn.$$.fragment),Ic=l(),Ts=n("span"),Lc=a("FlaxBlenderbotModel"),Sa=l(),L=n("div"),v(bn.$$.fragment),Sc=l(),kn=n("p"),Dc=a(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uc=l(),vn=n("p"),Rc=a(`This model is also a Flax Linen
`),yn=n("a"),Hc=a("flax.nn.Module"),Vc=a(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Kc=l(),ws=n("p"),Jc=a("Finally, this model supports inherent JAX features such as:"),Qc=l(),Re=n("ul"),$s=n("li"),Tn=n("a"),Xc=a("Just-In-Time (JIT) compilation"),Yc=l(),xs=n("li"),wn=n("a"),Zc=a("Automatic Differentiation"),ep=l(),Bs=n("li"),$n=n("a"),tp=a("Vectorization"),op=l(),zs=n("li"),xn=n("a"),np=a("Parallelization"),rp=l(),qe=n("div"),v(Bn.$$.fragment),sp=l(),xt=n("p"),ap=a("The "),Fs=n("code"),dp=a("FlaxBlenderbotPreTrainedModel"),ip=a(" forward method, overrides the "),qs=n("code"),lp=a("__call__"),cp=a(" special method."),pp=l(),v(Zt.$$.fragment),hp=l(),v(eo.$$.fragment),up=l(),to=n("div"),v(zn.$$.fragment),mp=l(),v(oo.$$.fragment),fp=l(),no=n("div"),v(Fn.$$.fragment),_p=l(),v(ro.$$.fragment),Da=l(),Bt=n("h2"),so=n("a"),Es=n("span"),v(qn.$$.fragment),gp=l(),Ms=n("span"),bp=a("FlaxBlenderbotForConditionalGeneration"),Ga=l(),S=n("div"),v(En.$$.fragment),kp=l(),Mn=n("p"),vp=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),jn=n("a"),xp=a("flax.nn.Module"),Bp=a(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zp=l(),Cs=n("p"),Fp=a("Finally, this model supports inherent JAX features such as:"),qp=l(),He=n("ul"),js=n("li"),On=n("a"),Ep=a("Just-In-Time (JIT) compilation"),Mp=l(),Os=n("li"),Pn=n("a"),Cp=a("Automatic Differentiation"),jp=l(),Ps=n("li"),Nn=n("a"),Op=a("Vectorization"),Pp=l(),Ns=n("li"),An=n("a"),Np=a("Parallelization"),Ap=l(),D=n("div"),v(In.$$.fragment),Ip=l(),zt=n("p"),Lp=a("The "),As=n("code"),Sp=a("FlaxBlenderbotPreTrainedModel"),Dp=a(" forward method, overrides the "),Is=n("code"),Gp=a("__call__"),Wp=a(" special method."),Up=l(),v(ao.$$.fragment),Rp=l(),Ls=n("p"),Hp=a("Conversation example::"),Vp=l(),Ss=n("blockquote"),Ds=n("blockquote"),Gs=n("blockquote"),Ws=n("p"),Kp=a("from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),Jp=l(),Us=n("blockquote"),Rs=n("blockquote"),Hs=n("blockquote"),Vs=n("p"),Qp=a(`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019)`),Xp=l(),Ks=n("blockquote"),Js=n("blockquote"),Qs=n("blockquote"),Xs=n("p"),Yp=a(`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs = tokenizer([UTTERANCE],
max_length=1024, return_tensors=\u2018np\u2019)`),Zp=l(),Ys=n("blockquote"),Zs=n("blockquote"),Ln=n("blockquote"),io=n("h1"),lo=n("a"),ea=n("span"),v(Sn.$$.fragment),eh=l(),ta=n("span"),th=a("Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),oh=l(),oa=n("p"),nh=a(`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),rh=l(),co=n("div"),v(Dn.$$.fragment),sh=l(),v(po.$$.fragment),ah=l(),ho=n("div"),v(Gn.$$.fragment),dh=l(),v(uo.$$.fragment),this.h()},l(o){const _=Gm('[data-svelte="svelte-1phssyn"]',document.head);p=r(_,"META",{name:!0,content:!0}),_.forEach(t),k=c(o),g=r(o,"H1",{class:!0});var Wn=s(g);u=r(Wn,"A",{id:!0,class:!0,href:!0});var na=s(u);b=r(na,"SPAN",{});var ra=s(b);y(i.$$.fragment,ra),ra.forEach(t),na.forEach(t),m=c(Wn),F=r(Wn,"SPAN",{});var sa=s(F);Me=d(sa,"Blenderbot"),sa.forEach(t),Wn.forEach(t),pe=c(o),E=r(o,"P",{});var mo=s(E);fe=r(mo,"STRONG",{});var aa=s(fe);te=d(aa,"DISCLAIMER:"),aa.forEach(t),Ce=d(mo," If you see something strange, file a "),oe=r(mo,"A",{href:!0,rel:!0});var da=s(oe);ne=d(da,"Github Issue"),da.forEach(t),je=d(mo," ."),mo.forEach(t),we=c(o),G=r(o,"H2",{class:!0});var Un=s(G);N=r(Un,"A",{id:!0,class:!0,href:!0});var ia=s(N);_e=r(ia,"SPAN",{});var la=s(_e);y(R.$$.fragment,la),la.forEach(t),ia.forEach(t),M=c(Un),j=r(Un,"SPAN",{});var ca=s(j);Oe=d(ca,"Overview"),ca.forEach(t),Un.forEach(t),J=c(o),Q=r(o,"P",{});var Rn=s(Q);Pe=d(Rn,"The Blender chatbot model was proposed in "),W=r(Rn,"A",{href:!0,rel:!0});var pa=s(W);Ne=d(pa,"Recipes for building an open-domain chatbot"),pa.forEach(t),Ae=d(Rn,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),ma.forEach(t),ua.forEach(t),xe=c(o),C=r(o,"P",{});var Ft=s(C);Le=d(Ft,"This model was contributed by "),U=r(Ft,"A",{href:!0,rel:!0});var fa=s(U);Se=d(fa,"sshleifer"),fa.forEach(t),B=d(Ft,". The authors\u2019 code can be found "),q=r(Ft,"A",{href:!0,rel:!0});var ch=s(q);ge=d(ch,"here"),ch.forEach(t),rt=d(Ft," ."),Ft.forEach(t),Ke=c(o),O=r(o,"H2",{class:!0});var Ua=s(O);me=r(Ua,"A",{id:!0,class:!0,href:!0});var ph=s(me);De=r(ph,"SPAN",{});var hh=s(De);y(be.$$.fragment,hh),hh.forEach(t),ph.forEach(t),V=c(Ua),K=r(Ua,"SPAN",{});var uh=s(K);st=d(uh,"Implementation Notes"),uh.forEach(t),Ua.forEach(t),Je=c(o),I=r(o,"UL",{});var _r=s(I);ke=r(_r,"LI",{});var Ra=s(ke);at=d(Ra,"Blenderbot uses a standard "),se=r(Ra,"A",{href:!0,rel:!0});var mh=s(se);dt=d(mh,"seq2seq model transformer"),mh.forEach(t),Fd=d(Ra," based architecture."),Ra.forEach(t),qd=c(_r),Bo=r(_r,"LI",{});var Ha=s(Bo);Ed=d(Ha,"Available checkpoints can be found in the "),zo=r(Ha,"A",{href:!0,rel:!0});var fh=s(zo);Md=d(fh,"model hub"),fh.forEach(t),Cd=d(Ha,"."),Ha.forEach(t),jd=c(_r),Ge=r(_r,"LI",{});var fo=s(Ge);Od=d(fo,"This is the "),zr=r(fo,"EM",{});var _h=s(zr);Pd=d(_h,"default"),_h.forEach(t),Nd=d(fo,` Blenderbot model class. However, some smaller checkpoints, such as
`),Fr=r(fo,"CODE",{});var gh=s(Fr);Ad=d(gh,"facebook/blenderbot_small_90M"),gh.forEach(t),Id=d(fo,`, have a different architecture and consequently should be used with
`),Kn=r(fo,"A",{href:!0});var bh=s(Kn);Ld=d(bh,"BlenderbotSmall"),bh.forEach(t),Sd=d(fo,"."),fo.forEach(t),_r.forEach(t),ba=c(o),it=r(o,"H2",{class:!0});var Va=s(it);qt=r(Va,"A",{id:!0,class:!0,href:!0});var kh=s(qt);qr=r(kh,"SPAN",{});var vh=s(qr);y(Fo.$$.fragment,vh),vh.forEach(t),kh.forEach(t),Dd=c(Va),Er=r(Va,"SPAN",{});var yh=s(Er);Gd=d(yh,"Usage"),yh.forEach(t),Va.forEach(t),ka=c(o),Jn=r(o,"P",{});var Th=s(Jn);Wd=d(Th,"Here is an example of model usage:"),Th.forEach(t),va=c(o),y(qo.$$.fragment,o),ya=c(o),lt=r(o,"H2",{class:!0});var Ka=s(lt);Et=r(Ka,"A",{id:!0,class:!0,href:!0});var wh=s(Et);Mr=r(wh,"SPAN",{});var $h=s(Mr);y(Eo.$$.fragment,$h),$h.forEach(t),wh.forEach(t),Ud=c(Ka),Cr=r(Ka,"SPAN",{});var xh=s(Cr);Rd=d(xh,"BlenderbotConfig"),xh.forEach(t),Ka.forEach(t),Ta=c(o),ve=r(o,"DIV",{class:!0});var _o=s(ve);y(Mo.$$.fragment,_o),Hd=c(_o),ct=r(_o,"P",{});var gr=s(ct);Vd=d(gr,"This is the configuration class to store the configuration of a "),Qn=r(gr,"A",{href:!0});var Bh=s(Qn);Kd=d(Bh,"BlenderbotModel"),Bh.forEach(t),Jd=d(gr,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),Co=r(gr,"A",{href:!0,rel:!0});var zh=s(Co);Qd=d(zh,"facebook/blenderbot-3B"),zh.forEach(t),Xd=d(gr," architecture."),gr.forEach(t),Yd=c(_o),pt=r(_o,"P",{});var br=s(pt);Zd=d(br,"Configuration objects inherit from "),Xn=r(br,"A",{href:!0});var Fh=s(Xn);ei=d(Fh,"PretrainedConfig"),Fh.forEach(t),ti=d(br,` and can be used to control the model outputs. Read the
...
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),_a.forEach(t),mi=c(Ye),Po=r(Ye,"P",{});var Qa=s(Po);fi=d(Qa,"Refer to superclass "),er=r(Qa,"A",{href:!0});var Nh=s(er);_i=d(Nh,"RobertaTokenizer"),Nh.forEach(t),gi=d(Qa," for usage examples and documentation concerning parameters."),Qa.forEach(t),bi=c(Ye),Qe=r(Ye,"DIV",{class:!0});var kr=s(Qe);y(No.$$.fragment,kr),ki=c(kr),Ar=r(kr,"P",{});var Ah=s(Ar);vi=d(Ah,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Ah.forEach(t),yi=c(kr),Ir=r(kr,"UL",{});var Ih=s(Ir);tr=r(Ih,"LI",{});var ih=s(tr);Ti=d(ih,"single sequence: "),Lr=r(ih,"CODE",{});var Lh=s(Lr);wi=d(Lh,"X </s>"),Lh.forEach(t),ih.forEach(t),Ih.forEach(t),kr.forEach(t),Ye.forEach(t),xa=c(o),ut=r(o,"H2",{class:!0});var Xa=s(ut);Ot=r(Xa,"A",{id:!0,class:!0,href:!0});var Sh=s(Ot);Sr=r(Sh,"SPAN",{});var Dh=s(Sr);y(Ao.$$.fragment,Dh),Dh.forEach(t),Sh.forEach(t),$i=c(Xa),Dr=r(Xa,"SPAN",{});var Gh=s(Dr);xi=d(Gh,"BlenderbotTokenizerFast"),Gh.forEach(t),Xa.forEach(t),Ba=c(o),de=r(o,"DIV",{class:!0});var Ze=s(de);y(Io.$$.fragment,Ze),Bi=c(Ze),Lo=r(Ze,"P",{});var Ya=s(Lo);zi=d(Ya,"Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Gr=r(Ya,"EM",{});var Wh=s(Gr);Fi=d(Wh,"tokenizers"),Wh.forEach(t),qi=d(Ya," library)."),Ya.forEach(t),Ei=c(Ze),Pt=r(Ze,"P",{});var ga=s(Pt);Wr=r(ga,"CODE",{});var Uh=s(Wr);Mi=d(Uh,"BlenderbotFast"),Uh.forEach(t),Ci=d(ga," is nearly identical to "),or=r(ga,"A",{href:!0});var Rh=s(or);ji=d(Rh,"RobertaTokenizerFast"),Rh.forEach(t),Oi=d(ga,` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),ga.forEach(t),Pi=c(Ze),So=r(Ze,"P",{});var Za=s(So);Ni=d(Za,"Refer to superclass "),nr=r(Za,"A",{href:!0});var Hh=s(nr);Ai=d(Hh,"RobertaTokenizerFast"),Hh.forEach(t),Ii=d(Za," for usage examples and documentation concerning parameters."),Za.forEach(t),Li=c(Ze),Xe=r(Ze,"DIV",{class:!0});var vr=s(Xe);y(Do.$$.fragment,vr),Si=c(vr),Ur=r(vr,"P",{});var Vh=s(Ur);Di=d(Vh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Vh.forEach(t),Gi=c(vr),Rr=r(vr,"UL",{});var Kh=s(Rr);rr=r(Kh,"LI",{});var lh=s(rr);Wi=d(lh,"single sequence: "),Hr=r(lh,"CODE",{});var Jh=s(Hr);Ui=d(Jh,"X </s>"),Jh.forEach(t),lh.forEach(t),Kh.forEach(t),vr.forEach(t),Ze.forEach(t),za=c(o),mt=r(o,"H2",{class:!0});var ed=s(mt);Nt=r(ed,"A",{id:!0,class:!0,href:!0});var Qh=s(Nt);Vr=r(Qh,"SPAN",{});var Xh=s(Vr);y(Go.$$.fragment,Xh),Xh.forEach(t),Qh.forEach(t),Ri=c(ed),Kr=r(ed,"SPAN",{});var Yh=s(Kr);Hi=d(Yh,"BlenderbotModel"),Yh.forEach(t),ed.forEach(t),Fa=c(o),We=r(o,"P",{});var Hn=s(We);Vi=d(Hn,"See "),Jr=r(Hn,"CODE",{});var Zh=s(Jr);Ki=d(Zh,"transformers.BartModel"),Zh.forEach(t),Ji=d(Hn," for arguments to "),Qr=r(Hn,"EM",{});var eu=s(Qr);Qi=d(eu,"forward"),eu.forEach(t),Xi=d(Hn," and "),Xr=r(Hn,"EM",{});var tu=s(Xr);Yi=d(tu,"generate"),tu.forEach(t),Hn.forEach(t),qa=c(o),ye=r(o,"DIV",{class:!0});var go=s(ye);y(Wo.$$.fragment,go),Zi=c(go),Uo=r(go,"P",{});var td=s(Uo);el=d(td,`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),od.forEach(t),dl=c(go),Be=r(go,"DIV",{class:!0});var bo=s(Be);y(Vo.$$.fragment,bo),il=c(bo),ft=r(bo,"P",{});var yr=s(ft);ll=d(yr,"The "),ar=r(yr,"A",{href:!0});var ru=s(ar);cl=d(ru,"BlenderbotModel"),ru.forEach(t),pl=d(yr," forward method, overrides the "),Yr=r(yr,"CODE",{});var su=s(Yr);hl=d(su,"__call__"),su.forEach(t),ul=d(yr," special method."),yr.forEach(t),ml=c(bo),y(At.$$.fragment,bo),fl=c(bo),y(It.$$.fragment,bo),bo.forEach(t),go.forEach(t),Ea=c(o),_t=r(o,"H2",{class:!0});var nd=s(_t);Lt=r(nd,"A",{id:!0,class:!0,href:!0});var au=s(Lt);Zr=r(au,"SPAN",{});var du=s(Zr);y(Ko.$$.fragment,du),du.forEach(t),au.forEach(t),_l=c(nd),es=r(nd,"SPAN",{});var iu=s(es);gl=d(iu,"BlenderbotForConditionalGeneration"),iu.forEach(t),nd.forEach(t),Ma=c(o),Ue=r(o,"P",{});var Vn=s(Ue);bl=d(Vn,"See "),dr=r(Vn,"A",{href:!0});var lu=s(dr);kl=d(lu,"BartForConditionalGeneration"),lu.forEach(t),vl=d(Vn," for arguments to "),ts=r(Vn,"EM",{});var cu=s(ts);yl=d(cu,"forward"),cu.forEach(t),Tl=d(Vn," and "),os=r(Vn,"EM",{});var pu=s(os);wl=d(pu,"generate"),pu.forEach(t),Vn.forEach(t),Ca=c(o),Te=r(o,"DIV",{class:!0});var ko=s(Te);y(Jo.$$.fragment,ko),$l=c(ko),Qo=r(ko,"P",{});var rd=s(Qo);xl=d(rd,`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),ir=r(rd,"A",{href:!0});var hu=s(ir);Bl=d(hu,"PreTrainedModel"),hu.forEach(t),zl=d(rd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rd.forEach(t),Fl=c(ko),Xo=r(ko,"P",{});var sd=s(Xo);ql=d(sd,"This model is also a PyTorch "),Yo=r(sd,"A",{href:!0,rel:!0});var uu=s(Yo);El=d(uu,"torch.nn.Module"),uu.forEach(t),Ml=d(sd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sd.forEach(t),Cl=c(ko),ze=r(ko,"DIV",{class:!0});var vo=s(ze);y(Zo.$$.fragment,vo),jl=c(vo),gt=r(vo,"P",{});var Tr=s(gt);Ol=d(Tr,"The "),lr=r(Tr,"A",{href:!0});var mu=s(lr);Pl=d(mu,"BlenderbotForConditionalGeneration"),mu.forEach(t),Nl=d(Tr," forward method, overrides the "),ns=r(Tr,"CODE",{});var fu=s(ns);Al=d(fu,"__call__"),fu.forEach(t),Il=d(Tr," special method."),Tr.forEach(t),Ll=c(vo),y(St.$$.fragment,vo),Sl=c(vo),y(Dt.$$.fragment,vo),vo.forEach(t),ko.forEach(t),ja=c(o),bt=r(o,"H2",{class:!0});var ad=s(bt);Gt=r(ad,"A",{id:!0,class:!0,href:!0});var _u=s(Gt);rs=r(_u,"SPAN",{});var gu=s(rs);y(en.$$.fragment,gu),gu.forEach(t),_u.forEach(t),Dl=c(ad),ss=r(ad,"SPAN",{});var bu=s(ss);Gl=d(bu,"BlenderbotForCausalLM"),bu.forEach(t),ad.forEach(t),Oa=c(o),kt=r(o,"DIV",{class:!0});var dd=s(kt);y(tn.$$.fragment,dd),Wl=c(dd),Wt=r(dd,"DIV",{class:!0});var id=s(Wt);y(on.$$.fragment,id),Ul=c(id),y(Ut.$$.fragment,id),id.forEach(t),dd.forEach(t),Pa=c(o),vt=r(o,"H2",{class:!0});var ld=s(vt);Rt=r(ld,"A",{id:!0,class:!0,href:!0});var ku=s(Rt);as=r(ku,"SPAN",{});var vu=s(as);y(nn.$$.fragment,vu),vu.forEach(t),ku.forEach(t),Rl=c(ld),ds=r(ld,"SPAN",{});var yu=s(ds);Hl=d(yu,"TFBlenderbotModel"),yu.forEach(t),ld.forEach(t),Na=c(o),ie=r(o,"DIV",{class:!0});var et=s(ie);y(rn.$$.fragment,et),Vl=c(et),sn=r(et,"P",{});var cd=s(sn);Kl=d(cd,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pd.forEach(t),tc=c(et),y(Ht.$$.fragment,et),oc=c(et),Fe=r(et,"DIV",{class:!0});var yo=s(Fe);y(ln.$$.fragment,yo),nc=c(yo),yt=r(yo,"P",{});var wr=s(yt);rc=d(wr,"The "),pr=r(wr,"A",{href:!0});var $u=s(pr);sc=d($u,"TFBlenderbotModel"),$u.forEach(t),ac=d(wr," forward method, overrides the "),is=r(wr,"CODE",{});var xu=s(is);dc=d(xu,"__call__"),xu.forEach(t),ic=d(wr," special method."),wr.forEach(t),lc=c(yo),y(Vt.$$.fragment,yo),cc=c(yo),y(Kt.$$.fragment,yo),yo.forEach(t),et.forEach(t),Aa=c(o),Tt=r(o,"H2",{class:!0});var hd=s(Tt);Jt=r(hd,"A",{id:!0,class:!0,href:!0});var Bu=s(Jt);ls=r(Bu,"SPAN",{});var zu=s(ls);y(cn.$$.fragment,zu),zu.forEach(t),Bu.forEach(t),pc=c(hd),cs=r(hd,"SPAN",{});var Fu=s(cs);hc=d(Fu,"TFBlenderbotForConditionalGeneration"),Fu.forEach(t),hd.forEach(t),Ia=c(o),le=r(o,"DIV",{class:!0});var tt=s(le);y(pn.$$.fragment,tt),uc=c(tt),hn=r(tt,"P",{});var ud=s(hn);mc=d(ud,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ud.forEach(t),gc=c(tt),un=r(tt,"P",{});var md=s(un);bc=d(md,"This model is also a "),mn=r(md,"A",{href:!0,rel:!0});var Eu=s(mn);kc=d(Eu,"tf.keras.Model"),Eu.forEach(t),vc=d(md,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),md.forEach(t),yc=c(tt),y(Qt.$$.fragment,tt),Tc=c(tt),X=r(tt,"DIV",{class:!0});var Ee=s(X);y(fn.$$.fragment,Ee),wc=c(Ee),wt=r(Ee,"P",{});var $r=s(wt);$c=d($r,"The "),ur=r($r,"A",{href:!0});var Mu=s(ur);xc=d(Mu,"TFBlenderbotForConditionalGeneration"),Mu.forEach(t),Bc=d($r," forward method, overrides the "),ps=r($r,"CODE",{});var Cu=s(ps);zc=d(Cu,"__call__"),Cu.forEach(t),Fc=d($r," special method."),$r.forEach(t),qc=c(Ee),y(Xt.$$.fragment,Ee),Ec=c(Ee),hs=r(Ee,"P",{});var ju=s(hs);Mc=d(ju,"Conversation example::"),ju.forEach(t),Cc=c(Ee),us=r(Ee,"BLOCKQUOTE",{});var Ou=s(us);ms=r(Ou,"BLOCKQUOTE",{});var Pu=s(ms);fs=r(Pu,"BLOCKQUOTE",{});var Nu=s(fs);_s=r(Nu,"P",{});var Au=s(_s);jc=d(Au,`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
\u2018facebook/blenderbot-400M-distill\u2019 >>> model = TFBlenderbotForConditionalGeneration.from_pretrained(mname) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(mname) >>> UTTERANCE = \u201CMy friends are cool but they eat too
many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs = tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019) >>>
reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
skip_special_tokens=True)[0])`),Au.forEach(t),Nu.forEach(t),Pu.forEach(t),Ou.forEach(t),Oc=c(Ee),gs=r(Ee,"BLOCKQUOTE",{});var Iu=s(gs);bs=r(Iu,"BLOCKQUOTE",{});var Lu=s(bs);ks=r(Lu,"BLOCKQUOTE",{});var Su=s(ks);_n=r(Su,"P",{});var fd=s(_n);Pc=d(fd,`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
eat too many carbs.</s> `),vs=r(fd,"S",{});var Du=s(vs);Nc=d(Du,`That\u2019s unfortunate. \u201D \u2026 \u201CAre they trying to lose weight or are they just trying to
be healthier?`),Du.forEach(t),Ac=d(fd,` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),fd.forEach(t),Su.forEach(t),Lu.forEach(t),Iu.forEach(t),Ee.forEach(t),tt.forEach(t),La=c(o),$t=r(o,"H2",{class:!0});var _d=s($t);Yt=r(_d,"A",{id:!0,class:!0,href:!0});var Gu=s(Yt);ys=r(Gu,"SPAN",{});var Wu=s(ys);y(gn.$$.fragment,Wu),Wu.forEach(t),Gu.forEach(t),Ic=c(_d),Ts=r(_d,"SPAN",{});var Uu=s(Ts);Lc=d(Uu,"FlaxBlenderbotModel"),Uu.forEach(t),_d.forEach(t),Sa=c(o),L=r(o,"DIV",{class:!0});var Y=s(L);y(bn.$$.fragment,Y),Sc=c(Y),kn=r(Y,"P",{});var gd=s(kn);Dc=d(gd,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gd.forEach(t),Uc=c(Y),vn=r(Y,"P",{});var bd=s(vn);Rc=d(bd,`This model is also a Flax Linen
`),yn=r(bd,"A",{href:!0,rel:!0});var Hu=s(yn);Hc=d(Hu,"flax.nn.Module"),Hu.forEach(t),Vc=d(bd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bd.forEach(t),Kc=c(Y),ws=r(Y,"P",{});var Vu=s(ws);Jc=d(Vu,"Finally, this model supports inherent JAX features such as:"),Vu.forEach(t),Qc=c(Y),Re=r(Y,"UL",{});var To=s(Re);$s=r(To,"LI",{});var Ku=s($s);Tn=r(Ku,"A",{href:!0,rel:!0});var Ju=s(Tn);Xc=d(Ju,"Just-In-Time (JIT) compilation"),Ju.forEach(t),Ku.forEach(t),Yc=c(To),xs=r(To,"LI",{});var Qu=s(xs);wn=r(Qu,"A",{href:!0,rel:!0});var Xu=s(wn);Zc=d(Xu,"Automatic Differentiation"),Xu.forEach(t),Qu.forEach(t),ep=c(To),Bs=r(To,"LI",{});var Yu=s(Bs);$n=r(Yu,"A",{href:!0,rel:!0});var Zu=s($n);tp=d(Zu,"Vectorization"),Zu.forEach(t),Yu.forEach(t),op=c(To),zs=r(To,"LI",{});var em=s(zs);xn=r(em,"A",{href:!0,rel:!0});var tm=s(xn);np=d(tm,"Parallelization"),tm.forEach(t),em.forEach(t),To.forEach(t),rp=c(Y),qe=r(Y,"DIV",{class:!0});var wo=s(qe);y(Bn.$$.fragment,wo),sp=c(wo),xt=r(wo,"P",{});var xr=s(xt);ap=d(xr,"The "),Fs=r(xr,"CODE",{});var om=s(Fs);dp=d(om,"FlaxBlenderbotPreTrainedModel"),om.forEach(t),ip=d(xr," forward method, overrides the "),qs=r(xr,"CODE",{});var nm=s(qs);lp=d(nm,"__call__"),nm.forEach(t),cp=d(xr," special method."),xr.forEach(t),pp=c(wo),y(Zt.$$.fragment,wo),hp=c(wo),y(eo.$$.fragment,wo),wo.forEach(t),up=c(Y),to=r(Y,"DIV",{class:!0});var kd=s(to);y(zn.$$.fragment,kd),mp=c(kd),y(oo.$$.fragment,kd),kd.forEach(t),fp=c(Y),no=r(Y,"DIV",{class:!0});var vd=s(no);y(Fn.$$.fragment,vd),_p=c(vd),y(ro.$$.fragment,vd),vd.forEach(t),Y.forEach(t),Da=c(o),Bt=r(o,"H2",{class:!0});var yd=s(Bt);so=r(yd,"A",{id:!0,class:!0,href:!0});var rm=s(so);Es=r(rm,"SPAN",{});var sm=s(Es);y(qn.$$.fragment,sm),sm.forEach(t),rm.forEach(t),gp=c(yd),Ms=r(yd,"SPAN",{});var am=s(Ms);bp=d(am,"FlaxBlenderbotForConditionalGeneration"),am.forEach(t),yd.forEach(t),Ga=c(o),S=r(o,"DIV",{class:!0});var Z=s(S);y(En.$$.fragment,Z),kp=c(Z),Mn=r(Z,"P",{});var Td=s(Mn);vp=d(Td,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),jn=r(wd,"A",{href:!0,rel:!0});var im=s(jn);xp=d(im,"flax.nn.Module"),im.forEach(t),Bp=d(wd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wd.forEach(t),zp=c(Z),Cs=r(Z,"P",{});var lm=s(Cs);Fp=d(lm,"Finally, this model supports inherent JAX features such as:"),lm.forEach(t),qp=c(Z),He=r(Z,"UL",{});var $o=s(He);js=r($o,"LI",{});var cm=s(js);On=r(cm,"A",{href:!0,rel:!0});var pm=s(On);Ep=d(pm,"Just-In-Time (JIT) compilation"),pm.forEach(t),cm.forEach(t),Mp=c($o),Os=r($o,"LI",{});var hm=s(Os);Pn=r(hm,"A",{href:!0,rel:!0});var um=s(Pn);Cp=d(um,"Automatic Differentiation"),um.forEach(t),hm.forEach(t),jp=c($o),Ps=r($o,"LI",{});var mm=s(Ps);Nn=r(mm,"A",{href:!0,rel:!0});var fm=s(Nn);Op=d(fm,"Vectorization"),fm.forEach(t),mm.forEach(t),Pp=c($o),Ns=r($o,"LI",{});var _m=s(Ns);An=r(_m,"A",{href:!0,rel:!0});var gm=s(An);Np=d(gm,"Parallelization"),gm.forEach(t),_m.forEach(t),$o.forEach(t),Ap=c(Z),D=r(Z,"DIV",{class:!0});var ee=s(D);y(In.$$.fragment,ee),Ip=c(ee),zt=r(ee,"P",{});var Br=s(zt);Lp=d(Br,"The "),As=r(Br,"CODE",{});var bm=s(As);Sp=d(bm,"FlaxBlenderbotPreTrainedModel"),bm.forEach(t),Dp=d(Br," forward method, overrides the "),Is=r(Br,"CODE",{});var km=s(Is);Gp=d(km,"__call__"),km.forEach(t),Wp=d(Br," special method."),Br.forEach(t),Up=c(ee),y(ao.$$.fragment,ee),Rp=c(ee),Ls=r(ee,"P",{});var vm=s(Ls);Hp=d(vm,"Conversation example::"),vm.forEach(t),Vp=c(ee),Ss=r(ee,"BLOCKQUOTE",{});var ym=s(Ss);Ds=r(ym,"BLOCKQUOTE",{});var Tm=s(Ds);Gs=r(Tm,"BLOCKQUOTE",{});var wm=s(Gs);Ws=r(wm,"P",{});var $m=s(Ws);Kp=d($m,"from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),$m.forEach(t),wm.forEach(t),Tm.forEach(t),ym.forEach(t),Jp=c(ee),Us=r(ee,"BLOCKQUOTE",{});var xm=s(Us);Rs=r(xm,"BLOCKQUOTE",{});var Bm=s(Rs);Hs=r(Bm,"BLOCKQUOTE",{});var zm=s(Hs);Vs=r(zm,"P",{});var Fm=s(Vs);Qp=d(Fm,`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019)`),Fm.forEach(t),zm.forEach(t),Bm.forEach(t),xm.forEach(t),Xp=c(ee),Ks=r(ee,"BLOCKQUOTE",{});var qm=s(Ks);Js=r(qm,"BLOCKQUOTE",{});var Em=s(Js);Qs=r(Em,"BLOCKQUOTE",{});var Mm=s(Qs);Xs=r(Mm,"P",{});var Cm=s(Xs);Yp=d(Cm,`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs = tokenizer([UTTERANCE],
...
clean_up_tokenization_spaces=False) for g in reply_ids])`),Im.forEach(t),$d.forEach(t),Om.forEach(t),jm.forEach(t),ee.forEach(t),rh=c(Z),co=r(Z,"DIV",{class:!0});var Bd=s(co);y(Dn.$$.fragment,Bd),sh=c(Bd),y(po.$$.fragment,Bd),Bd.forEach(t),ah=c(Z),ho=r(Z,"DIV",{class:!0});var zd=s(ho);y(Gn.$$.fragment,zd),dh=c(zd),y(uo.$$.fragment,zd),zd.forEach(t),Z.forEach(t),this.h()},h(){h(p,"name","hf:doc:metadata"),h(p,"content",JSON.stringify(cf)),h(u,"id","blenderbot"),h(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(u,"href","#blenderbot"),h(g,"class","relative group"),h(oe,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),h(oe,"rel","nofollow"),h(N,"id","overview"),h(N,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(N,"href","#overview"),h(G,"class","relative group"),h(W,"href","https://arxiv.org/pdf/2004.13637.pdf"),h(W,"rel","nofollow"),h(U,"href","https://huggingface.co/sshleifer"),h(U,"rel","nofollow"),h(q,"href","https://github.com/facebookresearch/ParlAI"),h(q,"rel","nofollow"),h(me,"id","implementation-notes"),h(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(me,"href","#implementation-notes"),h(O,"class","relative group"),h(se,"href","https://arxiv.org/pdf/1706.03762.pdf"),h(se,"rel","nofollow"),h(zo,"href","https://huggingface.co/models?search=blenderbot"),h(zo,"rel","nofollow"),h(Kn,"href","blenderbot-small"),h(qt,"id","usage"),h(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(qt,"href","#usage"),h(it,"class","relative group"),h(Et,"id","transformers.BlenderbotConfig"),h(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Et,"href","#transformers.BlenderbotConfig"),h(lt,"class","relative group"),h(Qn,"href","/docs/transformers/pr_17656/en/model_doc/blenderbot#transformers.BlenderbotModel"),h(Co,"href","https://huggingface.co/facebook/blenderbot-3B"),h(Co,"rel","nofollow"),h(Xn,"href","/docs/transformers/pr_17656/en/main_classes/configuration#transformers.PretrainedConfig"),h(Yn,"href","/docs/transformers/pr_17656/en/main_classes/configuration#transformers.PretrainedConfig"),h(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ct,"id","transformers.BlenderbotTokenizer"),h(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ct,"href","#transformers.BlenderbotTokenizer"),h(ht,"class","relative group"),h(Zn,"href","/docs/transformers/pr_17656/en/model_doc/roberta#transformers.RobertaTokenizer"),h(er,"href","/docs/transformers/pr_17656/en/model_doc/roberta#transformers.RobertaTokenizer"),h(Qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ot,"id","transformers.BlenderbotTokenizerFast"),h(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Ot,"href","#transformers.BlenderbotTokenizerFast"),h(ut,"class","relative group"),h(or,"href","/docs/transformers/pr_17656/en/model_doc/roberta#transformers.RobertaTokenizerFast"),h(nr,"href","/docs/transformers/pr_17656/en/model_doc/roberta#transformers.RobertaTokenizerFast"),h(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Nt,"id","transformers.BlenderbotModel"),h(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Nt,"href","#transformers.BlenderbotModel"),h(mt,"class","relative group"),h(sr,"href","/docs/transformers/pr_17656/en/main_classes/model#transformers.PreTrainedModel"),h(Ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Ho,"rel","nofollow"),h(ar,"href","/docs/transformers/pr_17656/en/model_doc/blenderbot#transformers.BlenderbotModel"),h(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Lt,"id","transformers.BlenderbotForConditionalGeneration"),h(Lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Lt,"href","#transformers.BlenderbotForConditionalGeneration"),h(_t,"class","relative group"),h(dr,"href","/docs/transformers/pr_17656/en/model_doc/bart#transformers.BartForConditionalGeneration"),h(ir,"href","/docs/transformers/pr_17656/en/main_classes/model#transformers.PreTrainedModel"),h(Yo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Yo,"rel","nofollow"),h(lr,"href","/docs/transformers/pr_17656/en/model_doc/blenderbot#transformers.BlenderbotForConditionalGeneration"),h(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Gt,"id","transformers.BlenderbotForCausalLM"),h(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Gt,"href","#transformers.BlenderbotForCausalLM"),h(bt,"class","relative group"),h(Wt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Rt,"id","transformers.TFBlenderbotModel"),h(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Rt,"href","#transformers.TFBlenderbotModel"),h(vt,"class","relative group"),h(cr,"href","/docs/transformers/pr_17656/en/main_classes/model#transformers.TFPreTrainedModel"),h(dn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(dn,"rel","nofollow"),h(pr,"href","/docs/transformers/pr_17656/en/model_doc/blenderbot#transformers.TFBlenderbotModel"),h(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Jt,"id","transformers.TFBlenderbotForConditionalGeneration"),h(Jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Jt,"href","#transformers.TFBlenderbotForConditionalGeneration"),h(Tt,"class","relative group"),h(hr,"href","/docs/transformers/pr_17656/en/main_classes/model#transformers.TFPreTrainedModel"),h(mn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(mn,"rel","nofollow"),h(ur,"href","/docs/transformers/pr_17656/en/model_doc/blenderbot#transformers.TFBlenderbotForConditionalGeneration"),h(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Yt,"id","transformers.FlaxBlenderbotModel"),h(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Yt,"href","#transformers.FlaxBlenderbotModel"),h($t,"class","relative group"),h(mr,"href","/docs/transformers/pr_17656/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(yn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),h(yn,"rel","nofollow"),h(Tn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),h(Tn,"rel","nofollow"),h(wn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),h(wn,"rel","nofollow"),h($n,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),h($n,"rel","nofollow"),h(xn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),h(xn,"rel","nofollow"),h(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(to,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(no,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(so,"id","transformers.FlaxBlenderbotForConditionalGeneration"),h(so,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(so,"href","#transformers.FlaxBlenderbotForConditionalGeneration"),h(Bt,"class","relative group"),h(fr,"href","/docs/transformers/pr_17656/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(jn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),h(jn,"rel","nofollow"),h(On,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),h(On,"rel","nofollow"),h(Pn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),h(Pn,"rel","nofollow"),h(Nn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),h(Nn,"rel","nofollow"),h(An,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),h(An,"rel","nofollow"),h(lo,"id","generate-reply->>>-reply_ids-=-model.generate(inputs[\u2018input_ids\u2019],-num_beams=4,-max_length=5,"),h(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(lo,"href","#generate-reply->>>-reply_ids-=-model.generate(inputs[\u2018input_ids\u2019],-num_beams=4,-max_length=5,"),h(io,"class","relative group"),h(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(co,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ho,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,p),f(o,k,_),f(o,g,_),e(g,u),e(u,b),T(i,b,null),e(g,m),e(g,F),e(F,Me),f(o,pe,_),f(o,E,_),e(E,fe),e(fe,te),e(E,Ce),e(E,oe),e(oe,ne),e(E,je),f(o,we,_),f(o,G,_),e(G,N),e(N,_e),T(R,_e,null),e(G,M),e(G,j),e(j,Oe),f(o,J,_),f(o,Q,_),e(Q,Pe),e(Q,W),e(W,Ne),e(Q,Ae),f(o,A,_),f(o,he,_),e(he,re),f(o,$e,_),f(o,ue,_),e(ue,H),e(H,Ie),f(o,xe,_),f(o,C,_),e(C,Le),e(C,U),e(U,Se),e(C,B),e(C,q),e(q,ge),e(C,rt),f(o,Ke,_),f(o,O,_),e(O,me),e(me,De),T(be,De,null),e(O,V),e(O,K),e(K,st),f(o,Je,_),f(o,I,_),e(I,ke),e(ke,at),e(ke,se),e(se,dt),e(ke,Fd),e(I,qd),e(I,Bo),e(Bo,Ed),e(Bo,zo),e(zo,Md),e(Bo,Cd),e(I,jd),e(I,Ge),e(Ge,Od),e(Ge,zr),e(zr,Pd),e(Ge,Nd),e(Ge,Fr),e(Fr,Ad),e(Ge,Id),e(Ge,Kn),e(Kn,Ld),e(Ge,Sd),f(o,ba,_),f(o,it,_),e(it,qt),e(qt,qr),T(Fo,qr,null),e(it,Dd),e(it,Er),e(Er,Gd),f(o,ka,_),f(o,Jn,_),e(Jn,Wd),f(o,va,_),T(qo,o,_),f(o,ya,_),f(o,lt,_),e(lt,Et),e(Et,Mr),T(Eo,Mr,null),e(lt,Ud),e(lt,Cr),e(Cr,Rd),f(o,Ta,_),f(o,ve,_),T(Mo,ve,null),e(ve,Hd),e(ve,ct),e(ct,Vd),e(ct,Qn),e(Qn,Kd),e(ct,Jd),e(ct,Co),e(Co,Qd),e(ct,Xd),e(ve,Yd),e(ve,pt),e(pt,Zd),e(pt,Xn),e(Xn,ei),e(pt,ti),e(pt,Yn),e(Yn,oi),e(pt,ni),e(ve,ri),T(Mt,ve,null),f(o,wa,_),f(o,ht,_),e(ht,Ct),e(Ct,jr),T(jo,jr,null),e(ht,si),e(ht,Or),e(Or,ai),f(o,$a,_),f(o,ae,_),T(Oo,ae,null),e(ae,di),e(ae,Pr),e(Pr,ii),e(ae,li),e(ae,jt),e(jt,Nr),e(Nr,ci),e(jt,pi),e(jt,Zn),e(Zn,hi),e(jt,ui),e(ae,mi),e(ae,Po),e(Po,fi),e(Po,er),e(er,_i),e(Po,gi),e(ae,bi),e(ae,Qe),T(No,Qe,null),e(Qe,ki),e(Qe,Ar),e(Ar,vi),e(Qe,yi),e(Qe,Ir),e(Ir,tr),e(tr,Ti),e(tr,Lr),e(Lr,wi),f(o,xa,_),f(o,ut,_),e(ut,Ot),e(Ot,Sr),T(Ao,Sr,null),e(ut,$i),e(ut,Dr),e(Dr,xi),f(o,Ba,_),f(o,de,_),T(Io,de,null),e(de,Bi),e(de,Lo),e(Lo,zi),e(Lo,Gr),e(Gr,Fi),e(Lo,qi),e(de,Ei),e(de,Pt),e(Pt,Wr),e(Wr,Mi),e(Pt,Ci),e(Pt,or),e(or,ji),e(Pt,Oi),e(de,Pi),e(de,So),e(So,Ni),e(So,nr),e(nr,Ai),e(So,Ii),e(de,Li),e(de,Xe),T(Do,Xe,null),e(Xe,Si),e(Xe,Ur),e(Ur,Di),e(Xe,Gi),e(Xe,Rr),e(Rr,rr),e(rr,Wi),e(rr,Hr),e(Hr,Ui),f(o,za,_),f(o,mt,_),e(mt,Nt),e(Nt,Vr),T(Go,Vr,null),e(mt,Ri),e(mt,Kr),e(Kr,Hi),f(o,Fa,_),f(o,We,_),e(We,Vi),e(We,Jr),e(Jr,Ki),e(We,Ji),e(We,Qr),e(Qr,Qi),e(We,Xi),e(We,Xr),e(Xr,Yi),f(o,qa,_),f(o,ye,_),T(Wo,ye,null),e(ye,Zi),e(ye,Uo),e(Uo,el),e(Uo,sr),e(sr,tl),e(Uo,ol),e(ye,nl),e(ye,Ro),e(Ro,rl),e(Ro,Ho),e(Ho,sl),e(Ro,al),e(ye,dl),e(ye,Be),T(Vo,Be,null),e(Be,il),e(Be,ft),e(ft,ll),e(ft,ar),e(ar,cl),e(ft,pl),e(ft,Yr),e(Yr,hl),e(ft,ul),e(Be,ml),T(At,Be,null),e(Be,fl),T(It,Be,null),f(o,Ea,_),f(o,_t,_),e(_t,Lt),e(Lt,Zr),T(Ko,Zr,null),e(_t,_l),e(_t,es),e(es,gl),f(o,Ma,_),f(o,Ue,_),e(Ue,bl),e(Ue,dr),e(dr,kl),e(Ue,vl),e(Ue,ts),e(ts,yl),e(Ue,Tl),e(Ue,os),e(os,wl),f(o,Ca,_),f(o,Te,_),T(Jo,Te,null),e(Te,$l),e(Te,Qo),e(Qo,xl),e(Qo,ir),e(ir,Bl),e(Qo,zl),e(Te,Fl),e(Te,Xo),e(Xo,ql),e(Xo,Yo),e(Yo,El),e(Xo,Ml),e(Te,Cl),e(Te,ze),T(Zo,ze,null),e(ze,jl),e(ze,gt),e(gt,Ol),e(gt,lr),e(lr,Pl),e(gt,Nl),e(gt,ns),e(ns,Al),e(gt,Il),e(ze,Ll),T(St,ze,null),e(ze,Sl),T(Dt,ze,null),f(o,ja,_),f(o,bt,_),e(bt,Gt),e(Gt,rs),T(en,rs,null),e(bt,Dl),e(bt,ss),e(ss,Gl),f(o,Oa,_),f(o,kt,_),T(tn,kt,null),e(kt,Wl),e(kt,Wt),T(on,Wt,null),e(Wt,Ul),T(Ut,Wt,null),f(o,Pa,_),f(o,vt,_),e(vt,Rt),e(Rt,as),T(nn,as,null),e(vt,Rl),e(vt,ds),e(ds,Hl),f(o,Na,_),f(o,ie,_),T(rn,ie,null),e(ie,Vl),e(ie,sn),e(sn,Kl),e(sn,cr),e(cr,Jl),e(sn,Ql),e(ie,Xl),e(ie,an),e(an,Yl),e(an,dn),e(dn,Zl),e(an,ec),e(ie,tc),T(Ht,ie,null),e(ie,oc),e(ie,Fe),T(ln,Fe,null),e(Fe,nc),e(Fe,yt),e(yt,rc),e(yt,pr),e(pr,sc),e(yt,ac),e(yt,is),e(is,dc),e(yt,ic),e(Fe,lc),T(Vt,Fe,null),e(Fe,cc),T(Kt,Fe,null),f(o,Aa,_),f(o,Tt,_),e(Tt,Jt),e(Jt,ls),T(cn,ls,null),e(Tt,pc),e(Tt,cs),e(cs,hc),f(o,Ia,_),f(o,le,_),T(pn,le,null),e(le,uc),e(le,hn),e(hn,mc),e(hn,hr),e(hr,fc),e(hn,_c),e(le,gc),e(le,un),e(un,bc),e(un,mn),e(mn,kc),e(un,vc),e(le,yc),T(Qt,le,null),e(le,Tc),e(le,X),T(fn,X,null),e(X,wc),e(X,wt),e(wt,$c),e(wt,ur),e(ur,xc),e(wt,Bc),e(wt,ps),e(ps,zc),e(wt,Fc),e(X,qc),T(Xt,X,null),e(X,Ec),e(X,hs),e(hs,Mc),e(X,Cc),e(X,us),e(us,ms),e(ms,fs),e(fs,_s),e(_s,jc),e(X,Oc),e(X,gs),e(gs,bs),e(bs,ks),e(ks,_n),e(_n,Pc),e(_n,vs),e(vs,Nc),e(_n,Ac),f(o,La,_),f(o,$t,_),e($t,Yt),e(Yt,ys),T(gn,ys,null),e($t,Ic),e($t,Ts),e(Ts,Lc),f(o,Sa,_),f(o,L,_),T(bn,L,null),e(L,Sc),e(L,kn),e(kn,Dc),e(kn,mr),e(mr,Gc),e(kn,Wc),e(L,Uc),e(L,vn),e(vn,Rc),e(vn,yn),e(yn,Hc),e(vn,Vc),e(L,Kc),e(L,ws),e(ws,Jc),e(L,Qc),e(L,Re),e(Re,$s),e($s,Tn),e(Tn,Xc),e(Re,Yc),e(Re,xs),e(xs,wn),e(wn,Zc),e(Re,ep),e(Re,Bs),e(Bs,$n),e($n,tp),e(Re,op),e(Re,zs),e(zs,xn),e(xn,np),e(L,rp),e(L,qe),T(Bn,qe,null),e(qe,sp),e(qe,xt),e(xt,ap),e(xt,Fs),e(Fs,dp),e(xt,ip),e(xt,qs),e(qs,lp),e(xt,cp),e(qe,pp),T(Zt,qe,null),e(qe,hp),T(eo,qe,null),e(L,up),e(L,to),T(zn,to,null),e(to,mp),T(oo,to,null),e(L,fp),e(L,no),T(Fn,no,null),e(no,_p),T(ro,no,null),f(o,Da,_),f(o,Bt,_),e(Bt,so),e(so,Es),T(qn,Es,null),e(Bt,gp),e(Bt,Ms),e(Ms,bp),f(o,Ga,_),f(o,S,_),T(En,S,null),e(S,kp),e(S,Mn),e(Mn,vp),e(Mn,fr),e(fr,yp),e(Mn,Tp),e(S,wp),e(S,Cn),e(Cn,$p),e(Cn,jn),e(jn,xp),e(Cn,Bp),e(S,zp),e(S,Cs),e(Cs,Fp),e(S,qp),e(S,He),e(He,js),e(js,On),e(On,Ep),e(He,Mp),e(He,Os),e(Os,Pn),e(Pn,Cp),e(He,jp),e(He,Ps),e(Ps,Nn),e(Nn,Op),e(He,Pp),e(He,Ns),e(Ns,An),e(An,Np),e(S,Ap),e(S,D),T(In,D,null),e(D,Ip),e(D,zt),e(zt,Lp),e(zt,As),e(As,Sp),e(zt,Dp),e(zt,Is),e(Is,Gp),e(zt,Wp),e(D,Up),T(ao,D,null),e(D,Rp),e(D,Ls),e(Ls,Hp),e(D,Vp),e(D,Ss),e(Ss,Ds),e(Ds,Gs),e(Gs,Ws),e(Ws,Kp),e(D,Jp),e(D,Us),e(Us,Rs),e(Rs,Hs),e(Hs,Vs),e(Vs,Qp),e(D,Xp),e(D,Ks),e(Ks,Js),e(Js,Qs),e(Qs,Xs),e(Xs,Yp),e(D,Zp),e(D,Ys),e(Ys,Zs),e(Zs,Ln),e(Ln,io),e(io,lo),e(lo,ea),T(Sn,ea,null),e(io,eh),e(io,ta),e(ta,th),e(Ln,oh),e(Ln,oa),e(oa,nh),e(S,rh),e(S,co),T(Dn,co,null),e(co,sh),T(po,co,null),e(S,ah),e(S,ho),T(Gn,ho,null),e(ho,dh),T(uo,ho,null),Wa=!0},p(o,[_]){const Wn={};_&2&&(Wn.$$scope={dirty:_,ctx:o}),Mt.$set(Wn);const na={};_&2&&(na.$$scope={dirty:_,ctx:o}),At.$set(na);const ra={};_&2&&(ra.$$scope={dirty:_,ctx:o}),It.$set(ra);const sa={};_&2&&(sa.$$scope={dirty:_,ctx:o}),St.$set(sa);const mo={};_&2&&(mo.$$scope={dirty:_,ctx:o}),Dt.$set(mo);const aa={};_&2&&(aa.$$scope={dirty:_,ctx:o}),Ut.$set(aa);const da={};_&2&&(da.$$scope={dirty:_,ctx:o}),Ht.$set(da);const Un={};_&2&&(Un.$$scope={dirty:_,ctx:o}),Vt.$set(Un);const ia={};_&2&&(ia.$$scope={dirty:_,ctx:o}),Kt.$set(ia);const la={};_&2&&(la.$$scope={dirty:_,ctx:o}),Qt.$set(la);const ca={};_&2&&(ca.$$scope={dirty:_,ctx:o}),Xt.$set(ca);const Rn={};_&2&&(Rn.$$scope={dirty:_,ctx:o}),Zt.$set(Rn);const pa={};_&2&&(pa.$$scope={dirty:_,ctx:o}),eo.$set(pa);const ha={};_&2&&(ha.$$scope={dirty:_,ctx:o}),oo.$set(ha);const ua={};_&2&&(ua.$$scope={dirty:_,ctx:o}),ro.$set(ua);const ma={};_&2&&(ma.$$scope={dirty:_,ctx:o}),ao.$set(ma);const Ft={};_&2&&(Ft.$$scope={dirty:_,ctx:o}),po.$set(Ft);const fa={};_&2&&(fa.$$scope={dirty:_,ctx:o}),uo.$set(fa)},i(o){Wa||(w(i.$$.fragment,o),w(R.$$.fragment,o),w(be.$$.fragment,o),w(Fo.$$.fragment,o),w(qo.$$.fragment,o),w(Eo.$$.fragment,o),w(Mo.$$.fragment,o),w(Mt.$$.fragment,o),w(jo.$$.fragment,o),w(Oo.$$.fragment,o),w(No.$$.fragment,o),w(Ao.$$.fragment,o),w(Io.$$.fragment,o),w(Do.$$.fragment,o),w(Go.$$.fragment,o),w(Wo.$$.fragment,o),w(Vo.$$.fragment,o),w(At.$$.fragment,o),w(It.$$.fragment,o),w(Ko.$$.fragment,o),w(Jo.$$.fragment,o),w(Zo.$$.fragment,o),w(St.$$.fragment,o),w(Dt.$$.fragment,o),w(en.$$.fragment,o),w(tn.$$.fragment,o),w(on.$$.fragment,o),w(Ut.$$.fragment,o),w(nn.$$.fragment,o),w(rn.$$.fragment,o),w(Ht.$$.fragment,o),w(ln.$$.fragment,o),w(Vt.$$.fragment,o),w(Kt.$$.fragment,o),w(cn.$$.fragment,o),w(pn.$$.fragment,o),w(Qt.$$.fragment,o),w(fn.$$.fragment,o),w(Xt.$$.fragment,o),w(gn.$$.fragment,o),w(bn.$$.fragment,o),w(Bn.$$.fragment,o),w(Zt.$$.fragment,o),w(eo.$$.fragment,o),w(zn.$$.fragment,o),w(oo.$$.fragment,o),w(Fn.$$.fragment,o),w(ro.$$.fragment,o),w(qn.$$.fragment,o),w(En.$$.fragment,o),w(In.$$.fragment,o),w(ao.$$.fragment,o),w(Sn.$$.fragment,o),w(Dn.$$.fragment,o),w(po.$$.fragment,o),w(Gn.$$.fragment,o),w(uo.$$.fragment,o),Wa=!0)},o(o){$(i.$$.fragment,o),$(R.$$.fragment,o),$(be.$$.fragment,o),$(Fo.$$.fragment,o),$(qo.$$.fragment,o),$(Eo.$$.fragment,o),$(Mo.$$.fragment,o),$(Mt.$$.fragment,o),$(jo.$$.fragment,o),$(Oo.$$.fragment,o),$(No.$$.fragment,o),$(Ao.$$.fragment,o),$(Io.$$.fragment,o),$(Do.$$.fragment,o),$(Go.$$.fragment,o),$(Wo.$$.fragment,o),$(Vo.$$.fragment,o),$(At.$$.fragment,o),$(It.$$.fragment,o),$(Ko.$$.fragment,o),$(Jo.$$.fragment,o),$(Zo.$$.fragment,o),$(St.$$.fragment,o),$(Dt.$$.fragment,o),$(en.$$.fragment,o),$(tn.$$.fragment,o),$(on.$$.fragment,o),$(Ut.$$.fragment,o),$(nn.$$.fragment,o),$(rn.$$.fragment,o),$(Ht.$$.fragment,o),$(ln.$$.fragment,o),$(Vt.$$.fragment,o),$(Kt.$$.fragment,o),$(cn.$$.fragment,o),$(pn.$$.fragment,o),$(Qt.$$.fragment,o),$(fn.$$.fragment,o),$(Xt.$$.fragment,o),$(gn.$$.fragment,o),$(bn.$$.fragment,o),$(Bn.$$.fragment,o),$(Zt.$$.fragment,o),$(eo.$$.fragment,o),$(zn.$$.fragment,o),$(oo.$$.fragment,o),$(Fn.$$.fragment,o),$(ro.$$.fragment,o),$(qn.$$.fragment,o),$(En.$$.fragment,o),$(In.$$.fragment,o),$(ao.$$.fragment,o),$(Sn.$$.fragment,o),$(Dn.$$.fragment,o),$(po.$$.fragment,o),$(Gn.$$.fragment,o),$(uo.$$.fragment,o),Wa=!1},d(o){t(p),o&&t(k),o&&t(g),x(i),o&&t(pe),o&&t(E),o&&t(we),o&&t(G),x(R),o&&t(J),o&&t(Q),o&&t(A),o&&t(he),o&&t($e),o&&t(ue),o&&t(xe),o&&t(C),o&&t(Ke),o&&t(O),x(be),o&&t(Je),o&&t(I),o&&t(ba),o&&t(it),x(Fo),o&&t(ka),o&&t(Jn),o&&t(va),x(qo,o),o&&t(ya),o&&t(lt),x(Eo),o&&t(Ta),o&&t(ve),x(Mo),x(Mt),o&&t(wa),o&&t(ht),x(jo),o&&t($a),o&&t(ae),x(Oo),x(No),o&&t(xa),o&&t(ut),x(Ao),o&&t(Ba),o&&t(de),x(Io),x(Do),o&&t(za),o&&t(mt),x(Go),o&&t(Fa),o&&t(We),o&&t(qa),o&&t(ye),x(Wo),x(Vo),x(At),x(It),o&&t(Ea),o&&t(_t),x(Ko),o&&t(Ma),o&&t(Ue),o&&t(Ca),o&&t(Te),x(Jo),x(Zo),x(St),x(Dt),o&&t(ja),o&&t(bt),x(en),o&&t(Oa),o&&t(kt),x(tn),x(on),x(Ut),o&&t(Pa),o&&t(vt),x(nn),o&&t(Na),o&&t(ie),x(rn),x(Ht),x(ln),x(Vt),x(Kt),o&&t(Aa),o&&t(Tt),x(cn),o&&t(Ia),o&&t(le),x(pn),x(Qt),x(fn),x(Xt),o&&t(La),o&&t($t),x(gn),o&&t(Sa),o&&t(L),x(bn),x(Bn),x(Zt),x(eo),x(zn),x(oo),x(Fn),x(ro),o&&t(Da),o&&t(Bt),x(qn),o&&t(Ga),o&&t(S),x(En),x(In),x(ao),x(Sn),x(Dn),x(po),x(Gn),x(uo)}}}const cf={local:"blenderbot",sections:[{local:"overview",title:"Overview"},{local:"implementation-notes",title:"Implementation Notes"},{local:"usage",title:"Usage"},{local:"transformers.BlenderbotConfig",title:"BlenderbotConfig"},{local:"transformers.BlenderbotTokenizer",title:"BlenderbotTokenizer"},{local:"transformers.BlenderbotTokenizerFast",title:"BlenderbotTokenizerFast"},{local:"transformers.BlenderbotModel",title:"BlenderbotModel"},{local:"transformers.BlenderbotForConditionalGeneration",title:"BlenderbotForConditionalGeneration"},{local:"transformers.BlenderbotForCausalLM",title:"BlenderbotForCausalLM"},{local:"transformers.TFBlenderbotModel",title:"TFBlenderbotModel"},{local:"transformers.TFBlenderbotForConditionalGeneration",title:"TFBlenderbotForConditionalGeneration"},{local:"transformers.FlaxBlenderbotModel",title:"FlaxBlenderbotModel"},{local:"transformers.FlaxBlenderbotForConditionalGeneration",title:"FlaxBlenderbotForConditionalGeneration"}],title:"Blenderbot"};function pf(z){return Wm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class bf extends Lm{constructor(p){super();Sm(this,p,pf,lf,Dm,{})}}export{bf as default,cf as metadata};
