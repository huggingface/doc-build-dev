...
Whether or not to return a <a href="/docs/transformers/pr_18224/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18224/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_distilbert.py#L625",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_distilbert.py#L723",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_distilbert.py#L1051",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_distilbert.py#L956",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_distilbert.py#L839",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18224/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18224/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18224/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18224/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18224/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18224/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/distilbert/modeling_flax_distilbert.py#L458",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xk=p(),Pa=o("p"),Yk=a("This model is also a Flax Linen "),Aa=o("a"),Zk=a("flax.linen.Module"),e2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t2=p(),ac=o("p"),s2=a("Finally, this model supports inherent JAX features such as:"),o2=p(),zt=o("ul"),ic=o("li"),Oa=o("a"),n2=a("Just-In-Time (JIT) compilation"),r2=p(),lc=o("li"),Na=o("a"),a2=a("Automatic Differentiation"),i2=p(),dc=o("li"),La=o("a"),l2=a("Vectorization"),d2=p(),cc=o("li"),Sa=o("a"),c2=a("Parallelization"),p2=p(),bt=o("div"),T(Ia.$$.fragment),h2=p(),Ps=o("p"),u2=a("The "),pc=o("code"),f2=a("FlaxDistilBertPreTrainedModel"),m2=a(" forward method, overrides the "),hc=o("code"),g2=a("__call__"),_2=a(" special method."),b2=p(),T(sn.$$.fragment),v2=p(),T(on.$$.fragment),ph=p(),As=o("h2"),nn=o("a"),uc=o("span"),T(Wa.$$.fragment),k2=p(),fc=o("span"),T2=a("FlaxDistilBertForMultipleChoice"),hh=p(),je=o("div"),T(Qa.$$.fragment),$2=p(),mc=o("p"),w2=a(`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),y2=p(),Ra=o("p"),F2=a("This model inherits from "),dl=o("a"),D2=a("FlaxPreTrainedModel"),x2=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),B2=p(),Ua=o("p"),M2=a("This model is also a Flax Linen "),Ha=o("a"),E2=a("flax.linen.Module"),z2=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),j2=p(),gc=o("p"),C2=a("Finally, this model supports inherent JAX features such as:"),q2=p(),jt=o("ul"),_c=o("li"),Ka=o("a"),P2=a("Just-In-Time (JIT) compilation"),A2=p(),bc=o("li"),Va=o("a"),O2=a("Automatic Differentiation"),N2=p(),vc=o("li"),Ja=o("a"),L2=a("Vectorization"),S2=p(),kc=o("li"),Ga=o("a"),I2=a("Parallelization"),W2=p(),vt=o("div"),T(Xa.$$.fragment),Q2=p(),Os=o("p"),R2=a("The "),Tc=o("code"),U2=a("FlaxDistilBertPreTrainedModel"),H2=a(" forward method, overrides the "),$c=o("code"),K2=a("__call__"),V2=a(" special method."),J2=p(),T(rn.$$.fragment),G2=p(),T(an.$$.fragment),uh=p(),Ns=o("h2"),ln=o("a"),wc=o("span"),T(Ya.$$.fragment),X2=p(),yc=o("span"),Y2=a("FlaxDistilBertForTokenClassification"),fh=p(),Ce=o("div"),T(Za.$$.fragment),Z2=p(),Fc=o("p"),eT=a(`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jb=h(Dt),$(So.$$.fragment,Dt),Gb=h(Dt),Ze=n(Dt,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xb=h(Yt),Ds=n(Yt,"P",{});var wl=r(Ds);Yb=i(wl,"The "),ol=n(wl,"A",{href:!0});var Kw=r(ol);Zb=i(Kw,"TFDistilBertForTokenClassification"),Kw.forEach(t),ev=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var Vw=r(zd);tv=i(Vw,"__call__"),Vw.forEach(t),sv=i(wl," special method."),wl.forEach(t),ov=h(Yt),$(Io.$$.fragment,Yt),nv=h(Yt),$(Wo.$$.fragment,Yt),rv=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),oh=h(s),xs=n(s,"H2",{class:!0});var tu=r(xs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var Jw=r(Ro);jd=n(Jw,"SPAN",{});var Gw=r(jd);$(ra.$$.fragment,Gw),Gw.forEach(t),Jw.forEach(t),av=h(tu),Cd=n(tu,"SPAN",{});var Xw=r(Cd);iv=i(Xw,"TFDistilBertForQuestionAnswering"),Xw.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var xt=r(Ie);$(aa.$$.fragment,xt),lv=h(xt),Bs=n(xt,"P",{});var yl=r(Bs);dv=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Yw=r(qd);cv=i(Yw,"span start logits"),Yw.forEach(t),pv=i(yl," and "),Pd=n(yl,"CODE",{});var Zw=r(Pd);hv=i(Zw,"span end logits"),Zw.forEach(t),uv=i(yl,")."),yl.forEach(t),fv=h(xt),ia=n(xt,"P",{});var su=r(ia);mv=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var e1=r(nl);gv=i(e1,"TFPreTrainedModel"),e1.forEach(t),_v=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),bv=h(xt),la=n(xt,"P",{});var ou=r(la);vv=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var t1=r(da);kv=i(t1,"tf.keras.Model"),t1.forEach(t),Tv=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$v=h(xt),$(Uo.$$.fragment,xt),wv=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yv=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);Fv=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var s1=r(rl);Dv=i(s1,"TFDistilBertForQuestionAnswering"),s1.forEach(t),xv=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var o1=r(Ad);Bv=i(o1,"__call__"),o1.forEach(t),Mv=i(Fl," special method."),Fl.forEach(t),Ev=h(Zt),$(Ho.$$.fragment,Zt),zv=h(Zt),$(Ko.$$.fragment,Zt),jv=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var n1=r(Jo);Od=n(n1,"SPAN",{});var r1=r(Od);$(pa.$$.fragment,r1),r1.forEach(t),n1.forEach(t),Cv=h(nu),Nd=n(nu,"SPAN",{});var a1=r(Nd);qv=i(a1,"FlaxDistilBertModel"),a1.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),Pv=h(st),Ld=n(st,"P",{});var i1=r(Ld);Av=i(i1,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i1.forEach(t),Ov=h(st),ua=n(st,"P",{});var ru=r(ua);Nv=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l1=r(al);Lv=i(l1,"FlaxPreTrainedModel"),l1.forEach(t),Sv=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Iv=h(st),fa=n(st,"P",{});var au=r(fa);Wv=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d1=r(ma);Qv=i(d1,"flax.linen.Module"),d1.forEach(t),Rv=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(st),Sd=n(st,"P",{});var c1=r(Sd);Hv=i(c1,"Finally, this model supports inherent JAX features such as:"),c1.forEach(t),Kv=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p1=r(Id);ga=n(p1,"A",{href:!0,rel:!0});var h1=r(ga);Vv=i(h1,"Just-In-Time (JIT) compilation"),h1.forEach(t),p1.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var u1=r(Wd);_a=n(u1,"A",{href:!0,rel:!0});var f1=r(_a);Gv=i(f1,"Automatic Differentiation"),f1.forEach(t),u1.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var m1=r(Qd);ba=n(m1,"A",{href:!0,rel:!0});var g1=r(ba);Yv=i(g1,"Vectorization"),g1.forEach(t),m1.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _1=r(Rd);va=n(_1,"A",{href:!0,rel:!0});var b1=r(va);ek=i(b1,"Parallelization"),b1.forEach(t),_1.forEach(t),kn.forEach(t),tk=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sk=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ok=i(Dl,"The "),Ud=n(Dl,"CODE",{});var v1=r(Ud);nk=i(v1,"FlaxDistilBertPreTrainedModel"),v1.forEach(t),rk=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var k1=r(Hd);ak=i(k1,"__call__"),k1.forEach(t),ik=i(Dl," special method."),Dl.forEach(t),lk=h(Tn),$(Go.$$.fragment,Tn),dk=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T1=r(Yo);Kd=n(T1,"SPAN",{});var $1=r(Kd);$(Ta.$$.fragment,$1),$1.forEach(t),T1.forEach(t),ck=h(iu),Vd=n(iu,"SPAN",{});var w1=r(Vd);pk=i(w1,"FlaxDistilBertForMaskedLM"),w1.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hk=h(ot),wa=n(ot,"P",{});var lu=r(wa);uk=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y1=r(Jd);fk=i(y1,"language modeling"),y1.forEach(t),mk=i(lu," head on top."),lu.forEach(t),gk=h(ot),ya=n(ot,"P",{});var du=r(ya);_k=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var F1=r(il);bk=i(F1,"FlaxPreTrainedModel"),F1.forEach(t),vk=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kk=h(ot),Fa=n(ot,"P",{});var cu=r(Fa);Tk=i(cu,"This model is also a Flax Linen "),Da=n(cu,"A",{href:!0,rel:!0});var D1=r(Da);$k=i(D1,"flax.linen.Module"),D1.forEach(t),wk=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yk=h(ot),Gd=n(ot,"P",{});var x1=r(Gd);Fk=i(x1,"Finally, this model supports inherent JAX features such as:"),x1.forEach(t),Dk=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var B1=r(Xd);xa=n(B1,"A",{href:!0,rel:!0});var M1=r(xa);xk=i(M1,"Just-In-Time (JIT) compilation"),M1.forEach(t),B1.forEach(t),Bk=h($n),Yd=n($n,"LI",{});var E1=r(Yd);Ba=n(E1,"A",{href:!0,rel:!0});var z1=r(Ba);Mk=i(z1,"Automatic Differentiation"),z1.forEach(t),E1.forEach(t),Ek=h($n),Zd=n($n,"LI",{});var j1=r(Zd);Ma=n(j1,"A",{href:!0,rel:!0});var C1=r(Ma);zk=i(C1,"Vectorization"),C1.forEach(t),j1.forEach(t),jk=h($n),ec=n($n,"LI",{});var q1=r(ec);Ea=n(q1,"A",{href:!0,rel:!0});var P1=r(Ea);Ck=i(P1,"Parallelization"),P1.forEach(t),q1.forEach(t),$n.forEach(t),qk=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pk=h(wn),Cs=n(wn,"P",{});var xl=r(Cs);Ak=i(xl,"The "),tc=n(xl,"CODE",{});var A1=r(tc);Ok=i(A1,"FlaxDistilBertPreTrainedModel"),A1.forEach(t),Nk=i(xl," forward method, overrides the "),sc=n(xl,"CODE",{});var O1=r(sc);Lk=i(O1,"__call__"),O1.forEach(t),Sk=i(xl," special method."),xl.forEach(t),Ik=h(wn),$(Zo.$$.fragment,wn),Wk=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N1=r(tn);oc=n(N1,"SPAN",{});var L1=r(oc);$(ja.$$.fragment,L1),L1.forEach(t),N1.forEach(t),Qk=h(pu),nc=n(pu,"SPAN",{});var S1=r(nc);Rk=i(S1,"FlaxDistilBertForSequenceClassification"),S1.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uk=h(nt),rc=n(nt,"P",{});var I1=r(rc);Hk=i(I1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I1.forEach(t),Kk=h(nt),qa=n(nt,"P",{});var hu=r(qa);Vk=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W1=r(ll);Jk=i(W1,"FlaxPreTrainedModel"),W1.forEach(t),Gk=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xk=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yk=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q1=r(Aa);Zk=i(Q1,"flax.linen.Module"),Q1.forEach(t),e2=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),t2=h(nt),ac=n(nt,"P",{});var R1=r(ac);s2=i(R1,"Finally, this model supports inherent JAX features such as:"),R1.forEach(t),o2=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U1=r(ic);Oa=n(U1,"A",{href:!0,rel:!0});var H1=r(Oa);n2=i(H1,"Just-In-Time (JIT) compilation"),H1.forEach(t),U1.forEach(t),r2=h(yn),lc=n(yn,"LI",{});var K1=r(lc);Na=n(K1,"A",{href:!0,rel:!0});var V1=r(Na);a2=i(V1,"Automatic Differentiation"),V1.forEach(t),K1.forEach(t),i2=h(yn),dc=n(yn,"LI",{});var J1=r(dc);La=n(J1,"A",{href:!0,rel:!0});var G1=r(La);l2=i(G1,"Vectorization"),G1.forEach(t),J1.forEach(t),d2=h(yn),cc=n(yn,"LI",{});var X1=r(cc);Sa=n(X1,"A",{href:!0,rel:!0});var Y1=r(Sa);c2=i(Y1,"Parallelization"),Y1.forEach(t),X1.forEach(t),yn.forEach(t),p2=h(nt),bt=n(nt,"DIV",{class:!0});var Fn=r(bt);$(Ia.$$.fragment,Fn),h2=h(Fn),Ps=n(Fn,"P",{});var Bl=r(Ps);u2=i(Bl,"The "),pc=n(Bl,"CODE",{});var Z1=r(pc);f2=i(Z1,"FlaxDistilBertPreTrainedModel"),Z1.forEach(t),m2=i(Bl," forward method, overrides the "),hc=n(Bl,"CODE",{});var ey=r(hc);g2=i(ey,"__call__"),ey.forEach(t),_2=i(Bl," special method."),Bl.forEach(t),b2=h(Fn),$(sn.$$.fragment,Fn),v2=h(Fn),$(on.$$.fragment,Fn),Fn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),k2=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);T2=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$2=h(rt),mc=n(rt,"P",{});var ny=r(mc);w2=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),ny.forEach(t),y2=h(rt),Ra=n(rt,"P",{});var mu=r(Ra);F2=i(mu,"This model inherits from "),dl=n(mu,"A",{href:!0});var ry=r(dl);D2=i(ry,"FlaxPreTrainedModel"),ry.forEach(t),x2=i(mu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mu.forEach(t),B2=h(rt),Ua=n(rt,"P",{});var gu=r(Ua);M2=i(gu,"This model is also a Flax Linen "),Ha=n(gu,"A",{href:!0,rel:!0});var ay=r(Ha);E2=i(ay,"flax.linen.Module"),ay.forEach(t),z2=i(gu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),j2=h(rt),gc=n(rt,"P",{});var iy=r(gc);C2=i(iy,"Finally, this model supports inherent JAX features such as:"),iy.forEach(t),q2=h(rt),jt=n(rt,"UL",{});var Dn=r(jt);_c=n(Dn,"LI",{});var ly=r(_c);Ka=n(ly,"A",{href:!0,rel:!0});var dy=r(Ka);P2=i(dy,"Just-In-Time (JIT) compilation"),dy.forEach(t),ly.forEach(t),A2=h(Dn),bc=n(Dn,"LI",{});var cy=r(bc);Va=n(cy,"A",{href:!0,rel:!0});var py=r(Va);O2=i(py,"Automatic Differentiation"),py.forEach(t),cy.forEach(t),N2=h(Dn),vc=n(Dn,"LI",{});var hy=r(vc);Ja=n(hy,"A",{href:!0,rel:!0});var uy=r(Ja);L2=i(uy,"Vectorization"),uy.forEach(t),hy.forEach(t),S2=h(Dn),kc=n(Dn,"LI",{});var fy=r(kc);Ga=n(fy,"A",{href:!0,rel:!0});var my=r(Ga);I2=i(my,"Parallelization"),my.forEach(t),fy.forEach(t),Dn.forEach(t),W2=h(rt),vt=n(rt,"DIV",{class:!0});var xn=r(vt);$(Xa.$$.fragment,xn),Q2=h(xn),Os=n(xn,"P",{});var Ml=r(Os);R2=i(Ml,"The "),Tc=n(Ml,"CODE",{});var gy=r(Tc);U2=i(gy,"FlaxDistilBertPreTrainedModel"),gy.forEach(t),H2=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _y=r($c);K2=i(_y,"__call__"),_y.forEach(t),V2=i(Ml," special method."),Ml.forEach(t),J2=h(xn),$(rn.$$.fragment,xn),G2=h(xn),$(an.$$.fragment,xn),xn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var by=r(ln);wc=n(by,"SPAN",{});var vy=r(wc);$(Ya.$$.fragment,vy),vy.forEach(t),by.forEach(t),X2=h(_u),yc=n(_u,"SPAN",{});var ky=r(yc);Y2=i(ky,"FlaxDistilBertForTokenClassification"),ky.forEach(t),_u.forEach(t),fh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),Z2=h(at),Fc=n(at,"P",{});var Ty=r(Fc);eT=i(Ty,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
