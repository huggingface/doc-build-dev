import{S as Mv,i as $v,s as Ev,e as a,k as c,w as v,t as n,M as zv,c as r,d as o,m as p,a as i,x as y,h as s,b as l,G as e,g as u,y as b,q as L,o as k,B as w,v as qv,L as sn}from"../../chunks/vendor-hf-doc-builder.js";import{T as Gi}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as W}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as de}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as nn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function jv(j){let h,x,f,g,T;return g=new W({props:{code:`from transformers import LayoutLMv2Model, LayoutLMv2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoding = feature_extractor(image, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(encoding.keys())
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># dict_keys([&#x27;pixel_values&#x27;])</span>`}}),{c(){h=a("p"),x=n("Examples:"),f=c(),v(g.$$.fragment)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Examples:"),_.forEach(o),f=p(m),y(g.$$.fragment,m)},m(m,_){u(m,h,_),e(h,x),u(m,f,_),b(g,m,_),T=!0},p:sn,i(m){T||(L(g.$$.fragment,m),T=!0)},o(m){k(g.$$.fragment,m),T=!1},d(m){m&&o(h),m&&o(f),w(g,m)}}}function Pv(j){let h,x,f,g,T;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var A=i(f);g=s(A,"Module"),A.forEach(o),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
(<span class="hljs-number">4</span>, <span class="hljs-string">&#x27;advertisement&#x27;</span>)`}}),{c(){h=a("p"),x=n("Example:"),f=c(),v(g.$$.fragment)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Example:"),_.forEach(o),f=p(m),y(g.$$.fragment,m)},m(m,_){u(m,h,_),e(h,x),u(m,f,_),b(g,m,_),T=!0},p:sn,i(m){T||(L(g.$$.fragment,m),T=!0)},o(m){k(g.$$.fragment,m),T=!1},d(m){m&&o(h),m&&o(f),w(g,m)}}}function Ov(j){let h,x,f,g,T;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var A=i(f);g=s(A,"Module"),A.forEach(o),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(m,_){u(m,h,_),e(h,x),e(h,f),e(f,g),e(h,T)},d(m){m&&o(h)}}}function Av(j){let h,x,f,g,T;return g=new W({props:{code:`from transformers import LayoutLMv2Processor, LayoutLMv2ForTokenClassification, set_seed
from PIL import Image
from datasets import load_dataset
...
<span class="hljs-string">&#x27;council mem - bers conducted by trrf treasurer philip g. kuehn to get answers which the public ...</span>`}}),{c(){v(h.$$.fragment)},l(f){y(h.$$.fragment,f)},m(f,g){b(h,f,g),x=!0},p:sn,i(f){x||(L(h.$$.fragment,f),x=!0)},o(f){k(h.$$.fragment,f),x=!1},d(f){w(h,f)}}}function Rv(j){let h,x;return h=new W({props:{code:`target_start_index = torch.tensor([7])
...
(<span class="hljs-number">154</span>, <span class="hljs-number">287</span>)`}}),{c(){v(h.$$.fragment)},l(f){y(h.$$.fragment,f)},m(f,g){b(h,f,g),x=!0},p:sn,i(f){x||(L(h.$$.fragment,f),x=!0)},o(f){k(h.$$.fragment,f),x=!1},d(f){w(h,f)}}}function Wv(j){let h,x,f,g,T,m,_,A,Hi,gr,Me,Ve,_s,Et,Ki,vs,Xi,_r,me,Yi,zt,Zi,Ji,an,el,tl,vr,he,X,ol,qt,nl,sl,jt,al,rl,Ft,il,ll,Pt,dl,cl,pl,Ct,ul,It,ml,hl,fl,Dt,gl,Ot,_l,vl,yr,rn,yl,br,ln,ys,bl,Lr,se,Ll,bs,kl,wl,Ls,xl,Tl,ks,Ml,$l,kr,At,wr,dn,El,xr,cn,zl,Tr,V,ws,ql,jl,Nt,Fl,St,Pl,Cl,Il,Rt,Dl,Wt,Ol,Al,Nl,$e,Sl,Ut,Rl,Wl,Bt,Ul,Bl,Vl,M,Ql,xs,Gl,Hl,pn,Kl,Xl,Ts,Yl,Zl,Ms,Jl,ed,$s,td,od,Es,nd,sd,zs,ad,rd,qs,id,ld,js,dd,cd,un,pd,ud,Vt,md,hd,Qt,fd,gd,Mr,Gt,$r,fe,_d,Fs,vd,yd,Ps,bd,Ld,Er,Ht,zr,Qe,kd,mn,wd,xd,qr,ge,I,Td,hn,Md,$d,Cs,Ed,zd,Is,qd,jd,fn,Fd,Pd,Ds,Cd,Id,Os,Dd,Od,As,Ad,Nd,Sd,Kt,Rd,gn,Wd,Ud,Bd,Xt,Vd,Ns,Qd,Gd,jr,Ge,Hd,_n,Kd,Xd,Fr,Ee,He,Ss,Yt,Yd,Rs,Zd,Pr,Q,Jd,vn,ec,tc,yn,oc,nc,bn,sc,ac,Ln,rc,ic,Cr,Zt,Ir,E,lc,kn,dc,cc,wn,pc,uc,Ws,mc,hc,xn,fc,gc,Tn,_c,vc,Us,yc,bc,Bs,Lc,kc,Vs,wc,xc,Qs,Tc,Mc,Gs,$c,Ec,Dr,U,Mn,zc,qc,Jt,jc,Fc,$n,Pc,Cc,Hs,Ic,Dc,Ks,Oc,Ac,Or,En,Nc,Ar,zn,Xs,Sc,Nr,qn,Rc,Sr,eo,Rr,jn,Ys,Wc,Wr,_e,Uc,Zs,Bc,Vc,Js,Qc,Gc,Ur,to,Br,Fn,ea,Hc,Vr,G,Kc,ta,Xc,Yc,oa,Zc,Jc,na,ep,tp,sa,op,np,Qr,oo,Gr,Pn,aa,sp,Hr,Cn,ap,Kr,no,Xr,In,ra,rp,Yr,Dn,ip,Zr,so,Jr,ze,Ke,ia,ao,lp,la,dp,ei,Y,ro,cp,qe,pp,On,up,mp,io,hp,fp,gp,je,_p,An,vp,yp,Nn,bp,Lp,kp,Xe,ti,Fe,Ye,da,lo,wp,ca,xp,oi,Z,co,Tp,pa,Mp,$p,po,Ep,ua,zp,qp,jp,ve,uo,Fp,ma,Pp,Cp,Ze,ni,Pe,Je,ha,mo,Ip,fa,Dp,si,N,ho,Op,S,Ap,Sn,Np,Sp,ga,Rp,Wp,_a,Up,Bp,va,Vp,Qp,ya,Gp,Hp,ba,Kp,Xp,Yp,fo,Zp,Rn,Jp,eu,tu,Wn,Un,ou,nu,su,et,go,au,La,ru,iu,Bn,_o,ai,Ce,tt,ka,vo,lu,wa,du,ri,J,yo,cu,bo,pu,xa,uu,mu,hu,Lo,fu,Vn,gu,_u,vu,ot,ko,yu,Ta,bu,ii,Ie,nt,Ma,wo,Lu,$a,ku,li,B,xo,wu,Ea,xu,Tu,Qn,Gn,Mu,$u,Eu,F,zu,Hn,qu,ju,Kn,Fu,Pu,Xn,Cu,Iu,za,Du,Ou,qa,Au,Nu,ja,Su,Ru,Fa,Wu,Uu,Pa,Bu,Vu,Ca,Qu,Gu,Hu,ye,To,Ku,$,Xu,Ia,Yu,Zu,Mo,Da,Ju,em,tm,Yn,om,nm,Oa,sm,am,Aa,rm,im,$o,Na,lm,dm,cm,Sa,pm,um,Zn,mm,hm,Ra,fm,gm,Wa,_m,vm,Ua,ym,bm,Ba,Lm,km,wm,Va,xm,di,De,st,Qa,Eo,Tm,Ga,Mm,ci,ce,zo,$m,qo,Em,jo,zm,qm,jm,ae,Fo,Fm,Oe,Pm,Jn,Cm,Im,Ha,Dm,Om,Am,at,Nm,rt,pi,Ae,it,Ka,Po,Sm,Xa,Rm,ui,ee,Co,Wm,Io,Um,Do,Bm,Vm,Qm,Oo,Gm,Ao,Hm,Km,Xm,re,No,Ym,Ne,Zm,es,Jm,eh,Ya,th,oh,nh,lt,sh,dt,mi,Se,ct,Za,So,ah,Ja,rh,hi,te,Ro,ih,oe,lh,Wo,dh,ch,Uo,ph,uh,Bo,mh,hh,Vo,fh,gh,_h,Qo,vh,Go,yh,bh,Lh,ie,Ho,kh,Re,wh,ts,xh,Th,er,Mh,$h,Eh,pt,zh,ut,fi,We,mt,tr,Ko,qh,or,jh,gi,ne,Xo,Fh,pe,Ph,Yo,Ch,Ih,nr,Dh,Oh,sr,Ah,Nh,Sh,Zo,Rh,Jo,Wh,Uh,Bh,D,en,Vh,Ue,Qh,os,Gh,Hh,ar,Kh,Xh,Yh,ht,Zh,rr,Jh,ef,ir,tf,of,ft,nf,gt,_i;return m=new de({}),Et=new de({}),At=new W({props:{code:`python -m pip install 'git+https://github.com/facebookresearch/detectron2.git'
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Model">LayoutLMv2Model</a> or
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/feature_extraction_layoutlmv2.py#L123",returnDescription:`
<p>A <a
...
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LayoutLMv2Tokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_18224/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_18224/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L426",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/pr_18224/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),_o=new O({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L406"}}),vo=new de({}),yo=new O({props:{name:"class transformers.LayoutLMv2TokenizerFast",anchor:"transformers.LayoutLMv2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/tokenization_layoutlmv2_fast.py#L179",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18224/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
An instance of <a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a> or <a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2TokenizerFast">LayoutLMv2TokenizerFast</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L25"}}),To=new O({props:{name:"__call__",anchor:"transformers.LayoutLMv2Processor.__call__",parameters:[{name:"images",val:""},{name:"text",val:": typing.Union[str, typing.List[str], typing.List[typing.List[str]]] = None"},{name:"text_pair",val:": typing.Union[typing.List[str], typing.List[typing.List[str]], NoneType] = None"},{name:"boxes",val:": typing.Union[typing.List[typing.List[int]], typing.List[typing.List[typing.List[int]]]] = None"},{name:"word_labels",val:": typing.Union[typing.List[int], typing.List[typing.List[int]], NoneType] = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L47"}}),Eo=new de({}),zo=new O({props:{name:"class transformers.LayoutLMv2Model",anchor:"transformers.LayoutLMv2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18224/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L710"}}),Fo=new O({props:{name:"forward",anchor:"transformers.LayoutLMv2Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_18224/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config"
...
`}}),at=new Gi({props:{$$slots:{default:[Pv]},$$scope:{ctx:j}}}),rt=new nn({props:{anchor:"transformers.LayoutLMv2Model.forward.example",$$slots:{default:[Cv]},$$scope:{ctx:j}}}),Po=new de({}),Co=new O({props:{name:"class transformers.LayoutLMv2ForSequenceClassification",anchor:"transformers.LayoutLMv2ForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18224/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L966"}}),No=new O({props:{name:"forward",anchor:"transformers.LayoutLMv2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_18224/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18224/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L980",returnDescription:`
<p>A <a
...
`}}),lt=new Gi({props:{$$slots:{default:[Iv]},$$scope:{ctx:j}}}),dt=new nn({props:{anchor:"transformers.LayoutLMv2ForSequenceClassification.forward.example",$$slots:{default:[Dv]},$$scope:{ctx:j}}}),So=new de({}),Ro=new O({props:{name:"class transformers.LayoutLMv2ForTokenClassification",anchor:"transformers.LayoutLMv2ForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18224/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1147"}}),Ho=new O({props:{name:"forward",anchor:"transformers.LayoutLMv2ForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/pr_18224/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18224/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1161",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18224/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1292",returnDescription:`
<p>A <a
...
400,000 images belonging to one of 16 classes).`),fl=c(),Dt=a("li"),gl=n("document visual question answering: the "),Ot=a("a"),_l=n("DocVQA"),vl=n(` dataset (a collection of 50,000
...
this https URL.`),Lr=c(),se=a("p"),Ll=n("LayoutLMv2 depends on "),bs=a("code"),kl=n("detectron2"),wl=n(", "),Ls=a("code"),xl=n("torchvision"),Tl=n(" and "),ks=a("code"),Ml=n("tesseract"),$l=n(`. Run the
following to install them:`),kr=c(),v(At.$$.fragment),wr=c(),dn=a("p"),El=n("(If you are developing for LayoutLMv2, note that passing the doctests also requires the installation of these packages.)"),xr=c(),cn=a("p"),zl=n("Tips:"),Tr=c(),V=a("ul"),ws=a("li"),ql=n(`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
...
follows:`),Er=c(),v(Ht.$$.fragment),zr=c(),Qe=a("p"),kd=n("However, this model includes a brand new "),mn=a("a"),wd=n("LayoutLMv2Processor"),xd=n(` which can be used to directly
...
will have a shape of `),Ds=a("code"),Cd=n("seq_length"),Id=n(" + "),Os=a("code"),Dd=n("image_feature_pool_shape[0]"),Od=n(` *
`),As=a("code"),Ad=n("config.image_feature_pool_shape[1]"),Nd=n("."),Sd=c(),Kt=a("li"),Rd=n("When calling "),gn=a("a"),Wd=n("from_pretrained()"),Ud=n(`, a warning will be printed with a long list of
...
modality.`),Cr=c(),v(Zt.$$.fragment),Ir=c(),E=a("p"),lc=n("In short, one can provide a document image (and possibly additional data) to "),kn=a("a"),dc=n("LayoutLMv2Processor"),cc=n(`,
and it will create the inputs expected by the model. Internally, the processor first uses
`),wn=a("a"),pc=n("LayoutLMv2FeatureExtractor"),uc=n(` to apply OCR on the image to get a list of words and normalized
...
`),Bs=a("code"),Lc=n("attention_mask"),kc=n(", "),Vs=a("code"),wc=n("token_type_ids"),xc=n(", "),Qs=a("code"),Tc=n("bbox"),Mc=n(`. Optionally, one can provide word labels to the processor,
...
`),$n=a("a"),Pc=n("LayoutLMv2FeatureExtractor"),Cc=n(" with "),Hs=a("code"),Ic=n("apply_ocr"),Dc=n(" set to "),Ks=a("code"),Oc=n("False"),Ac=n("."),Or=c(),En=a("p"),Nc=n(`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
use cases work for both batched and non-batched inputs (we illustrate them for non-batched inputs).`),Ar=c(),zn=a("p"),Xs=a("strong"),Sc=n(`Use case 1: document image classification (training, inference) + token classification (inference), apply_ocr =
...
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Zr=c(),v(so.$$.fragment),Jr=c(),ze=a("h2"),Ke=a("a"),ia=a("span"),v(ao.$$.fragment),lp=c(),la=a("span"),dp=n("LayoutLMv2Config"),ei=c(),Y=a("div"),v(ro.$$.fragment),cp=c(),qe=a("p"),pp=n("This is the configuration class to store the configuration of a "),On=a("a"),up=n("LayoutLMv2Model"),mp=n(`. It is used to instantiate an
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
`),io=a("a"),hp=n("microsoft/layoutlmv2-base-uncased"),fp=n(" architecture."),gp=c(),je=a("p"),_p=n("Configuration objects inherit from "),An=a("a"),vp=n("PretrainedConfig"),yp=n(` and can be used to control the model outputs. Read the
documentation from `),Nn=a("a"),bp=n("PretrainedConfig"),Lp=n(" for more information."),kp=c(),v(Xe.$$.fragment),ti=c(),Fe=a("h2"),Ye=a("a"),da=a("span"),v(lo.$$.fragment),wp=c(),ca=a("span"),xp=n("LayoutLMv2FeatureExtractor"),oi=c(),Z=a("div"),v(co.$$.fragment),Tp=c(),pa=a("p"),Mp=n(`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
sequences with word-level normalized bounding boxes and optional labels.`),iu=c(),Bn=a("div"),v(_o.$$.fragment),ai=c(),Ce=a("h2"),tt=a("a"),ka=a("span"),v(vo.$$.fragment),lu=c(),wa=a("span"),du=n("LayoutLMv2TokenizerFast"),ri=c(),J=a("div"),v(yo.$$.fragment),cu=c(),bo=a("p"),pu=n("Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),xa=a("em"),uu=n("tokenizers"),mu=n(" library). Based on WordPiece."),hu=c(),Lo=a("p"),fu=n("This tokenizer inherits from "),Vn=a("a"),gu=n("PreTrainedTokenizerFast"),_u=n(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),vu=c(),ot=a("div"),v(ko.$$.fragment),yu=c(),Ta=a("p"),bu=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),ii=c(),Ie=a("h2"),nt=a("a"),Ma=a("span"),v(wo.$$.fragment),Lu=c(),$a=a("span"),ku=n("LayoutLMv2Processor"),li=c(),B=a("div"),v(xo.$$.fragment),wu=c(),Ea=a("p"),xu=n(`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
...
`),Xn=a("a"),Cu=n("LayoutLMv2TokenizerFast"),Iu=n(", which turns the words and bounding boxes into token-level "),za=a("code"),Du=n("input_ids"),Ou=n(`,
`),qa=a("code"),Au=n("attention_mask"),Nu=n(", "),ja=a("code"),Su=n("token_type_ids"),Ru=n(", "),Fa=a("code"),Wu=n("bbox"),Uu=n(". Optionally, one can provide integer "),Pa=a("code"),Bu=n("word_labels"),Vu=n(`, which are turned
...
`),Yn=a("a"),om=n("LayoutLMv2FeatureExtractor"),nm=n(" was initialized with "),Oa=a("code"),sm=n("apply_ocr"),am=n(" set to "),Aa=a("code"),rm=n("True"),im=n(`, it passes the obtained words and
...
`),Wa=a("code"),_m=n("False"),vm=n(", it passes the words ("),Ua=a("code"),ym=n("text"),bm=n("/"),Ba=a("code"),Lm=n("text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),km=n("."),wm=c(),Va=a("p"),xm=n("Please refer to the docstring of the above two methods for more information."),di=c(),De=a("h2"),st=a("a"),Qa=a("span"),v(Eo.$$.fragment),Tm=c(),Ga=a("span"),Mm=n("LayoutLMv2Model"),ci=c(),ce=a("div"),v(zo.$$.fragment),$m=c(),qo=a("p"),Em=n(`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),jo=a("a"),zm=n("torch.nn.Module"),qm=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),jm=c(),ae=a("div"),v(Fo.$$.fragment),Fm=c(),Oe=a("p"),Pm=n("The "),Jn=a("a"),Cm=n("LayoutLMv2Model"),Im=n(" forward method, overrides the "),Ha=a("code"),Dm=n("__call__"),Om=n(" special method."),Am=c(),v(at.$$.fragment),Nm=c(),v(rt.$$.fragment),pi=c(),Ae=a("h2"),it=a("a"),Ka=a("span"),v(Po.$$.fragment),Sm=c(),Xa=a("span"),Rm=n("LayoutLMv2ForSequenceClassification"),ui=c(),ee=a("div"),v(Co.$$.fragment),Wm=c(),Io=a("p"),Um=n(`LayoutLMv2 Model with a sequence classification head on top (a linear layer on top of the concatenation of the
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
`),Do=a("a"),Bm=n("RVL-CDIP"),Vm=n(" dataset."),Qm=c(),Oo=a("p"),Gm=n("This model is a PyTorch "),Ao=a("a"),Hm=n("torch.nn.Module"),Km=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lh=c(),ie=a("div"),v(Ho.$$.fragment),kh=c(),Re=a("p"),wh=n("The "),ts=a("a"),xh=n("LayoutLMv2ForTokenClassification"),Th=n(" forward method, overrides the "),er=a("code"),Mh=n("__call__"),$h=n(" special method."),Eh=c(),v(pt.$$.fragment),zh=c(),v(ut.$$.fragment),fi=c(),We=a("h2"),mt=a("a"),tr=a("span"),v(Ko.$$.fragment),qh=c(),or=a("span"),jh=n("LayoutLMv2ForQuestionAnswering"),gi=c(),ne=a("div"),v(Xo.$$.fragment),Fh=c(),pe=a("p"),Ph=n(`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
`),Yo=a("a"),Ch=n("DocVQA"),Ih=n(` (a linear layer on top of the text part of the hidden-states output to
compute `),nr=a("code"),Dh=n("span start logits"),Oh=n(" and "),sr=a("code"),Ah=n("span end logits"),Nh=n(")."),Sh=c(),Zo=a("p"),Rh=n("This model is a PyTorch "),Jo=a("a"),Wh=n("torch.nn.Module"),Uh=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
400,000 images belonging to one of 16 classes).`),vi.forEach(o),fl=p(ns),Dt=r(ns,"LI",{});var yi=i(Dt);gl=s(yi,"document visual question answering: the "),Ot=r(yi,"A",{href:!0,rel:!0});var hf=i(Ot);_l=s(hf,"DocVQA"),hf.forEach(o),vl=s(yi,` dataset (a collection of 50,000
...
including FUNSD (0.7895 -> 0.8420), CORD (0.9493 -> 0.9601), SROIE (0.9524 -> 0.9781), Kleister-NDA (0.834 -> 0.852),
RVL-CDIP (0.9443 -> 0.9564), and DocVQA (0.7295 -> 0.8672). The pre-trained LayoutLMv2 model is publicly available at
this https URL.`),_f.forEach(o),gf.forEach(o),Lr=p(t),se=r(t,"P",{});var _t=i(se);Ll=s(_t,"LayoutLMv2 depends on "),bs=r(_t,"CODE",{});var vf=i(bs);kl=s(vf,"detectron2"),vf.forEach(o),wl=s(_t,", "),Ls=r(_t,"CODE",{});var yf=i(Ls);xl=s(yf,"torchvision"),yf.forEach(o),Tl=s(_t," and "),ks=r(_t,"CODE",{});var bf=i(ks);Ml=s(bf,"tesseract"),bf.forEach(o),$l=s(_t,`. Run the
following to install them:`),_t.forEach(o),kr=p(t),y(At.$$.fragment,t),wr=p(t),dn=r(t,"P",{});var Lf=i(dn);El=s(Lf,"(If you are developing for LayoutLMv2, note that passing the doctests also requires the installation of these packages.)"),Lf.forEach(o),xr=p(t),cn=r(t,"P",{});var kf=i(cn);zl=s(kf,"Tips:"),kf.forEach(o),Tr=p(t),V=r(t,"UL",{});var Le=i(V);ws=r(Le,"LI",{});var wf=i(ws);ql=s(wf,`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
pre-training (while LayoutLMv1 only adds visual embeddings during fine-tuning).`),wf.forEach(o),jl=p(Le),Nt=r(Le,"LI",{});var bi=i(Nt);Fl=s(bi,`LayoutLMv2 adds both a relative 1D attention bias as well as a spatial 2D attention bias to the attention scores in
the self-attention layers. Details can be found on page 5 of the `),St=r(bi,"A",{href:!0,rel:!0});var xf=i(St);Pl=s(xf,"paper"),xf.forEach(o),Cl=s(bi,"."),bi.forEach(o),Il=p(Le),Rt=r(Le,"LI",{});var Li=i(Rt);Dl=s(Li,"Demo notebooks on how to use the LayoutLMv2 model on RVL-CDIP, FUNSD, DocVQA, CORD can be found "),Wt=r(Li,"A",{href:!0,rel:!0});var Tf=i(Wt);Ol=s(Tf,"here"),Tf.forEach(o),Al=s(Li,"."),Li.forEach(o),Nl=p(Le),$e=r(Le,"LI",{});var ss=i($e);Sl=s(ss,"LayoutLMv2 uses Facebook AI\u2019s "),Ut=r(ss,"A",{href:!0,rel:!0});var Mf=i(Ut);Rl=s(Mf,"Detectron2"),Mf.forEach(o),Wl=s(ss,` package for its visual
...
of the input text tokens. This is identical to `),un=r(z,"A",{href:!0});var Of=i(un);pd=s(Of,"LayoutLMModel"),Of.forEach(o),ud=s(z,`. These can be obtained using an
external OCR engine such as Google\u2019s `),Vt=r(z,"A",{href:!0,rel:!0});var Af=i(Vt);md=s(Af,"Tesseract"),Af.forEach(o),hd=s(z," (there\u2019s a "),Qt=r(z,"A",{href:!0,rel:!0});var Nf=i(Qt);fd=s(Nf,`Python
...
occurs (before resizing the image). Those can be obtained using the Python Image Library (PIL) library for example, as
follows:`),as.forEach(o),Er=p(t),y(Ht.$$.fragment,t),zr=p(t),Qe=r(t,"P",{});var ki=i(Qe);kd=s(ki,"However, this model includes a brand new "),mn=r(ki,"A",{href:!0});var Wf=i(mn);wd=s(Wf,"LayoutLMv2Processor"),Wf.forEach(o),xd=s(ki,` which can be used to directly
prepare data for the model (including applying OCR under the hood). More information can be found in the \u201CUsage\u201D
section below.`),ki.forEach(o),qr=p(t),ge=r(t,"UL",{});var rs=i(ge);I=r(rs,"LI",{});var R=i(I);Td=s(R,"Internally, "),hn=r(R,"A",{href:!0});var Uf=i(hn);Md=s(Uf,"LayoutLMv2Model"),Uf.forEach(o),$d=s(R," will send the "),Cs=r(R,"CODE",{});var Bf=i(Cs);Ed=s(Bf,"image"),Bf.forEach(o),zd=s(R,` input through its visual backbone to
...
tokens, and send through the Transformer encoder. This means that the last hidden states of the model will have a
length of 512 + 49 = 561, if you pad the text tokens up to the max length. More generally, the last hidden states
will have a shape of `),Ds=r(R,"CODE",{});var Gf=i(Ds);Cd=s(Gf,"seq_length"),Gf.forEach(o),Id=s(R," + "),Os=r(R,"CODE",{});var Hf=i(Os);Dd=s(Hf,"image_feature_pool_shape[0]"),Hf.forEach(o),Od=s(R,` *
`),As=r(R,"CODE",{});var Kf=i(As);Ad=s(Kf,"config.image_feature_pool_shape[1]"),Kf.forEach(o),Nd=s(R,"."),R.forEach(o),Sd=p(rs),Kt=r(rs,"LI",{});var wi=i(Kt);Rd=s(wi,"When calling "),gn=r(wi,"A",{href:!0});var Xf=i(gn);Wd=s(Xf,"from_pretrained()"),Xf.forEach(o),Ud=s(wi,`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),wi.forEach(o),Bd=p(rs),Xt=r(rs,"LI",{});var xi=i(Xt);Vd=s(xi,"If you want to train the model in a distributed environment, make sure to call "),Ns=r(xi,"CODE",{});var Yf=i(Ns);Qd=s(Yf,"synchronize_batch_norm"),Yf.forEach(o),Gd=s(xi,` on the
...
`),_n=r(Ti,"A",{href:!0});var Zf=i(_n);Kd=s(Zf,"LayoutXLM\u2019s documentation page"),Zf.forEach(o),Xd=s(Ti,"."),Ti.forEach(o),Fr=p(t),Ee=r(t,"H2",{class:!0});var Mi=i(Ee);He=r(Mi,"A",{id:!0,class:!0,href:!0});var Jf=i(He);Ss=r(Jf,"SPAN",{});var eg=i(Ss);y(Yt.$$.fragment,eg),eg.forEach(o),Jf.forEach(o),Yd=p(Mi),Rs=r(Mi,"SPAN",{});var tg=i(Rs);Zd=s(tg,"Usage: LayoutLMv2Processor"),tg.forEach(o),Mi.forEach(o),Pr=p(t),Q=r(t,"P",{});var ke=i(Q);Jd=s(ke,"The easiest way to prepare data for the model is to use "),vn=r(ke,"A",{href:!0});var og=i(vn);ec=s(og,"LayoutLMv2Processor"),og.forEach(o),tc=s(ke,`, which internally
combines a feature extractor (`),yn=r(ke,"A",{href:!0});var ng=i(yn);oc=s(ng,"LayoutLMv2FeatureExtractor"),ng.forEach(o),nc=s(ke,`) and a tokenizer
(`),bn=r(ke,"A",{href:!0});var sg=i(bn);sc=s(sg,"LayoutLMv2Tokenizer"),sg.forEach(o),ac=s(ke," or "),Ln=r(ke,"A",{href:!0});var ag=i(Ln);rc=s(ag,"LayoutLMv2TokenizerFast"),ag.forEach(o),ic=s(ke,`). The feature extractor
handles the image modality, while the tokenizer handles the text modality. A processor combines both, which is ideal
for a multi-modal model like LayoutLMv2. Note that you can still use both separately, if you only want to handle one
modality.`),ke.forEach(o),Cr=p(t),y(Zt.$$.fragment,t),Ir=p(t),E=r(t,"P",{});var P=i(E);lc=s(P,"In short, one can provide a document image (and possibly additional data) to "),kn=r(P,"A",{href:!0});var rg=i(kn);dc=s(rg,"LayoutLMv2Processor"),rg.forEach(o),cc=s(P,`,
and it will create the inputs expected by the model. Internally, the processor first uses
`),wn=r(P,"A",{href:!0});var ig=i(wn);pc=s(ig,"LayoutLMv2FeatureExtractor"),ig.forEach(o),uc=s(P,` to apply OCR on the image to get a list of words and normalized
...
`),Bs=r(P,"CODE",{});var ug=i(Bs);Lc=s(ug,"attention_mask"),ug.forEach(o),kc=s(P,", "),Vs=r(P,"CODE",{});var mg=i(Vs);wc=s(mg,"token_type_ids"),mg.forEach(o),xc=s(P,", "),Qs=r(P,"CODE",{});var hg=i(Qs);Tc=s(hg,"bbox"),hg.forEach(o),Mc=s(P,`. Optionally, one can provide word labels to the processor,
...
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
`),$n=r(ue,"A",{href:!0});var vg=i($n);Pc=s(vg,"LayoutLMv2FeatureExtractor"),vg.forEach(o),Cc=s(ue," with "),Hs=r(ue,"CODE",{});var yg=i(Hs);Ic=s(yg,"apply_ocr"),yg.forEach(o),Dc=s(ue," set to "),Ks=r(ue,"CODE",{});var bg=i(Ks);Oc=s(bg,"False"),bg.forEach(o),Ac=s(ue,"."),ue.forEach(o),Or=p(t),En=r(t,"P",{});var Lg=i(En);Nc=s(Lg,`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
use cases work for both batched and non-batched inputs (we illustrate them for non-batched inputs).`),Lg.forEach(o),Ar=p(t),zn=r(t,"P",{});var kg=i(zn);Xs=r(kg,"STRONG",{});var wg=i(Xs);Sc=s(wg,`Use case 1: document image classification (training, inference) + token classification (inference), apply_ocr =
True`),wg.forEach(o),kg.forEach(o),Nr=p(t),qn=r(t,"P",{});var xg=i(qn);Rc=s(xg,`This is the simplest case, in which the processor (actually the feature extractor) will perform OCR on the image to get
...
the processor.`),is.forEach(o),Ur=p(t),y(to.$$.fragment,t),Br=p(t),Fn=r(t,"P",{});var zg=i(Fn);ea=r(zg,"STRONG",{});var qg=i(ea);Hc=s(qg,"Use case 3: token classification (training), apply_ocr=False"),qg.forEach(o),zg.forEach(o),Vr=p(t),G=r(t,"P",{});var we=i(G);Kc=s(we,`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
labels in order to train a model. The processor will then convert these into token-level `),ta=r(we,"CODE",{});var jg=i(ta);Xc=s(jg,"labels"),jg.forEach(o),Yc=s(we,`. By default, it
will only label the first wordpiece of a word, and label the remaining wordpieces with -100, which is the
`),oa=r(we,"CODE",{});var Fg=i(oa);Zc=s(Fg,"ignore_index"),Fg.forEach(o),Jc=s(we,` of PyTorch\u2019s CrossEntropyLoss. In case you want all wordpieces of a word to be labeled, you can
initialize the tokenizer with `),na=r(we,"CODE",{});var Pg=i(na);ep=s(Pg,"only_label_first_subword"),Pg.forEach(o),tp=s(we," set to "),sa=r(we,"CODE",{});var Cg=i(sa);op=s(Cg,"False"),Cg.forEach(o),np=s(we,"."),we.forEach(o),Qr=p(t),y(oo.$$.fragment,t),Gr=p(t),Pn=r(t,"P",{});var Ig=i(Pn);aa=r(Ig,"STRONG",{});var Dg=i(aa);sp=s(Dg,"Use case 4: visual question answering (inference), apply_ocr=True"),Dg.forEach(o),Ig.forEach(o),Hr=p(t),Cn=r(t,"P",{});var Og=i(Cn);ap=s(Og,`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. By default, the
processor will apply OCR on the image, and create [CLS] question tokens [SEP] word tokens [SEP].`),Og.forEach(o),Kr=p(t),y(no.$$.fragment,t),Xr=p(t),In=r(t,"P",{});var Ag=i(In);ra=r(Ag,"STRONG",{});var Ng=i(ra);rp=s(Ng,"Use case 5: visual question answering (inference), apply_ocr=False"),Ng.forEach(o),Ag.forEach(o),Yr=p(t),Dn=r(t,"P",{});var Sg=i(Dn);ip=s(Sg,`For visual question answering tasks (such as DocVQA), you can provide a question to the processor. If you want to
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),Sg.forEach(o),Zr=p(t),y(so.$$.fragment,t),Jr=p(t),ze=r(t,"H2",{class:!0});var $i=i(ze);Ke=r($i,"A",{id:!0,class:!0,href:!0});var Rg=i(Ke);ia=r(Rg,"SPAN",{});var Wg=i(ia);y(ao.$$.fragment,Wg),Wg.forEach(o),Rg.forEach(o),lp=p($i),la=r($i,"SPAN",{});var Ug=i(la);dp=s(Ug,"LayoutLMv2Config"),Ug.forEach(o),$i.forEach(o),ei=p(t),Y=r(t,"DIV",{class:!0});var vt=i(Y);y(ro.$$.fragment,vt),cp=p(vt),qe=r(vt,"P",{});var ls=i(qe);pp=s(ls,"This is the configuration class to store the configuration of a "),On=r(ls,"A",{href:!0});var Bg=i(On);up=s(Bg,"LayoutLMv2Model"),Bg.forEach(o),mp=s(ls,`. It is used to instantiate an
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
`),io=r(ls,"A",{href:!0,rel:!0});var Vg=i(io);hp=s(Vg,"microsoft/layoutlmv2-base-uncased"),Vg.forEach(o),fp=s(ls," architecture."),ls.forEach(o),gp=p(vt),je=r(vt,"P",{});var ds=i(je);_p=s(ds,"Configuration objects inherit from "),An=r(ds,"A",{href:!0});var Qg=i(An);vp=s(Qg,"PretrainedConfig"),Qg.forEach(o),yp=s(ds,` and can be used to control the model outputs. Read the
documentation from `),Nn=r(ds,"A",{href:!0});var Gg=i(Nn);bp=s(Gg,"PretrainedConfig"),Gg.forEach(o),Lp=s(ds," for more information."),ds.forEach(o),kp=p(vt),y(Xe.$$.fragment,vt),vt.forEach(o),ti=p(t),Fe=r(t,"H2",{class:!0});var Ei=i(Fe);Ye=r(Ei,"A",{id:!0,class:!0,href:!0});var Hg=i(Ye);da=r(Hg,"SPAN",{});var Kg=i(da);y(lo.$$.fragment,Kg),Kg.forEach(o),Hg.forEach(o),wp=p(Ei),ca=r(Ei,"SPAN",{});var Xg=i(ca);xp=s(Xg,"LayoutLMv2FeatureExtractor"),Xg.forEach(o),Ei.forEach(o),oi=p(t),Z=r(t,"DIV",{class:!0});var yt=i(Z);y(co.$$.fragment,yt),Tp=p(yt),pa=r(yt,"P",{});var Yg=i(pa);Mp=s(Yg,`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),zi.forEach(o),jp=p(yt),ve=r(yt,"DIV",{class:!0});var cs=i(ve);y(uo.$$.fragment,cs),Fp=p(cs),ma=r(cs,"P",{});var Jg=i(ma);Pp=s(Jg,"Main method to prepare for the model one or several image(s)."),Jg.forEach(o),Cp=p(cs),y(Ze.$$.fragment,cs),cs.forEach(o),yt.forEach(o),ni=p(t),Pe=r(t,"H2",{class:!0});var qi=i(Pe);Je=r(qi,"A",{id:!0,class:!0,href:!0});var e_=i(Je);ha=r(e_,"SPAN",{});var t_=i(ha);y(mo.$$.fragment,t_),t_.forEach(o),e_.forEach(o),Ip=p(qi),fa=r(qi,"SPAN",{});var o_=i(fa);Dp=s(o_,"LayoutLMv2Tokenizer"),o_.forEach(o),qi.forEach(o),si=p(t),N=r(t,"DIV",{class:!0});var le=i(N);y(ho.$$.fragment,le),Op=p(le),S=r(le,"P",{});var H=i(S);Ap=s(H,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),Sn=r(H,"A",{href:!0});var n_=i(Sn);Np=s(n_,"LayoutLMv2Tokenizer"),n_.forEach(o),Sp=s(H,` can be used to turn words, word-level
...
sequences with word-level normalized bounding boxes and optional labels.`),p_.forEach(o),Fi.forEach(o),iu=p(le),Bn=r(le,"DIV",{class:!0});var u_=i(Bn);y(_o.$$.fragment,u_),u_.forEach(o),le.forEach(o),ai=p(t),Ce=r(t,"H2",{class:!0});var Pi=i(Ce);tt=r(Pi,"A",{id:!0,class:!0,href:!0});var m_=i(tt);ka=r(m_,"SPAN",{});var h_=i(ka);y(vo.$$.fragment,h_),h_.forEach(o),m_.forEach(o),lu=p(Pi),wa=r(Pi,"SPAN",{});var f_=i(wa);du=s(f_,"LayoutLMv2TokenizerFast"),f_.forEach(o),Pi.forEach(o),ri=p(t),J=r(t,"DIV",{class:!0});var bt=i(J);y(yo.$$.fragment,bt),cu=p(bt),bo=r(bt,"P",{});var Ci=i(bo);pu=s(Ci,"Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),xa=r(Ci,"EM",{});var g_=i(xa);uu=s(g_,"tokenizers"),g_.forEach(o),mu=s(Ci," library). Based on WordPiece."),Ci.forEach(o),hu=p(bt),Lo=r(bt,"P",{});var Ii=i(Lo);fu=s(Ii,"This tokenizer inherits from "),Vn=r(Ii,"A",{href:!0});var __=i(Vn);gu=s(__,"PreTrainedTokenizerFast"),__.forEach(o),_u=s(Ii,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Ii.forEach(o),vu=p(bt),ot=r(bt,"DIV",{class:!0});var Di=i(ot);y(ko.$$.fragment,Di),yu=p(Di),Ta=r(Di,"P",{});var v_=i(Ta);bu=s(v_,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),v_.forEach(o),Di.forEach(o),bt.forEach(o),ii=p(t),Ie=r(t,"H2",{class:!0});var Oi=i(Ie);nt=r(Oi,"A",{id:!0,class:!0,href:!0});var y_=i(nt);Ma=r(y_,"SPAN",{});var b_=i(Ma);y(wo.$$.fragment,b_),b_.forEach(o),y_.forEach(o),Lu=p(Oi),$a=r(Oi,"SPAN",{});var L_=i($a);ku=s(L_,"LayoutLMv2Processor"),L_.forEach(o),Oi.forEach(o),li=p(t),B=r(t,"DIV",{class:!0});var xe=i(B);y(xo.$$.fragment,xe),wu=p(xe),Ea=r(xe,"P",{});var k_=i(Ea);xu=s(k_,`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
single processor.`),k_.forEach(o),Tu=p(xe),Qn=r(xe,"P",{});var af=i(Qn);Gn=r(af,"A",{href:!0});var w_=i(Gn);Mu=s(w_,"LayoutLMv2Processor"),w_.forEach(o),$u=s(af," offers all the functionalities you need to prepare data for the model."),af.forEach(o),Eu=p(xe),F=r(xe,"P",{});var C=i(F);zu=s(C,"It first uses "),Hn=r(C,"A",{href:!0});var x_=i(Hn);qu=s(x_,"LayoutLMv2FeatureExtractor"),x_.forEach(o),ju=s(C,` to resize document images to a fixed size, and optionally applies OCR
...
`),Xn=r(C,"A",{href:!0});var M_=i(Xn);Cu=s(M_,"LayoutLMv2TokenizerFast"),M_.forEach(o),Iu=s(C,", which turns the words and bounding boxes into token-level "),za=r(C,"CODE",{});var $_=i(za);Du=s($_,"input_ids"),$_.forEach(o),Ou=s(C,`,
`),qa=r(C,"CODE",{});var E_=i(qa);Au=s(E_,"attention_mask"),E_.forEach(o),Nu=s(C,", "),ja=r(C,"CODE",{});var z_=i(ja);Su=s(z_,"token_type_ids"),z_.forEach(o),Ru=s(C,", "),Fa=r(C,"CODE",{});var q_=i(Fa);Wu=s(q_,"bbox"),q_.forEach(o),Uu=s(C,". Optionally, one can provide integer "),Pa=r(C,"CODE",{});var j_=i(Pa);Bu=s(j_,"word_labels"),j_.forEach(o),Vu=s(C,`, which are turned
...
`),Yn=r(q,"A",{href:!0});var I_=i(Yn);om=s(I_,"LayoutLMv2FeatureExtractor"),I_.forEach(o),nm=s(q," was initialized with "),Oa=r(q,"CODE",{});var D_=i(Oa);sm=s(D_,"apply_ocr"),D_.forEach(o),am=s(q," set to "),Aa=r(q,"CODE",{});var O_=i(Aa);rm=s(O_,"True"),O_.forEach(o),im=s(q,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),$o=r(q,"A",{href:!0});var lf=i($o);Na=r(lf,"STRONG",{});var A_=i(Na);lm=s(A_,"call"),A_.forEach(o),dm=s(lf,"()"),lf.forEach(o),cm=s(q,` and returns the output,
...
`),Wa=r(q,"CODE",{});var W_=i(Wa);_m=s(W_,"False"),W_.forEach(o),vm=s(q,", it passes the words ("),Ua=r(q,"CODE",{});var U_=i(Ua);ym=s(U_,"text"),U_.forEach(o),bm=s(q,"/"),Ba=r(q,"CODE",{});var B_=i(Ba);Lm=s(B_,"text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/pr_18224/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),B_.forEach(o),km=s(q,"."),q.forEach(o),wm=p(ps),Va=r(ps,"P",{});var V_=i(Va);xm=s(V_,"Please refer to the docstring of the above two methods for more information."),V_.forEach(o),ps.forEach(o),xe.forEach(o),di=p(t),De=r(t,"H2",{class:!0});var Ai=i(De);st=r(Ai,"A",{id:!0,class:!0,href:!0});var Q_=i(st);Qa=r(Q_,"SPAN",{});var G_=i(Qa);y(Eo.$$.fragment,G_),G_.forEach(o),Q_.forEach(o),Tm=p(Ai),Ga=r(Ai,"SPAN",{});var H_=i(Ga);Mm=s(H_,"LayoutLMv2Model"),H_.forEach(o),Ai.forEach(o),ci=p(t),ce=r(t,"DIV",{class:!0});var us=i(ce);y(zo.$$.fragment,us),$m=p(us),qo=r(us,"P",{});var Ni=i(qo);Em=s(Ni,`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),jo=r(Ni,"A",{href:!0,rel:!0});var K_=i(jo);zm=s(K_,"torch.nn.Module"),K_.forEach(o),qm=s(Ni,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ni.forEach(o),jm=p(us),ae=r(us,"DIV",{class:!0});var Lt=i(ae);y(Fo.$$.fragment,Lt),Fm=p(Lt),Oe=r(Lt,"P",{});var ms=i(Oe);Pm=s(ms,"The "),Jn=r(ms,"A",{href:!0});var X_=i(Jn);Cm=s(X_,"LayoutLMv2Model"),X_.forEach(o),Im=s(ms," forward method, overrides the "),Ha=r(ms,"CODE",{});var Y_=i(Ha);Dm=s(Y_,"__call__"),Y_.forEach(o),Om=s(ms," special method."),ms.forEach(o),Am=p(Lt),y(at.$$.fragment,Lt),Nm=p(Lt),y(rt.$$.fragment,Lt),Lt.forEach(o),us.forEach(o),pi=p(t),Ae=r(t,"H2",{class:!0});var Si=i(Ae);it=r(Si,"A",{id:!0,class:!0,href:!0});var Z_=i(it);Ka=r(Z_,"SPAN",{});var J_=i(Ka);y(Po.$$.fragment,J_),J_.forEach(o),Z_.forEach(o),Sm=p(Si),Xa=r(Si,"SPAN",{});var ev=i(Xa);Rm=s(ev,"LayoutLMv2ForSequenceClassification"),ev.forEach(o),Si.forEach(o),ui=p(t),ee=r(t,"DIV",{class:!0});var kt=i(ee);y(Co.$$.fragment,kt),Wm=p(kt),Io=r(kt,"P",{});var Ri=i(Io);Um=s(Ri,`LayoutLMv2 Model with a sequence classification head on top (a linear layer on top of the concatenation of the
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
`),Do=r(Ri,"A",{href:!0,rel:!0});var tv=i(Do);Bm=s(tv,"RVL-CDIP"),tv.forEach(o),Vm=s(Ri," dataset."),Ri.forEach(o),Qm=p(kt),Oo=r(kt,"P",{});var Wi=i(Oo);Gm=s(Wi,"This model is a PyTorch "),Ao=r(Wi,"A",{href:!0,rel:!0});var ov=i(Ao);Hm=s(ov,"torch.nn.Module"),ov.forEach(o),Km=s(Wi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wi.forEach(o),Xm=p(kt),re=r(kt,"DIV",{class:!0});var wt=i(re);y(No.$$.fragment,wt),Ym=p(wt),Ne=r(wt,"P",{});var hs=i(Ne);Zm=s(hs,"The "),es=r(hs,"A",{href:!0});var nv=i(es);Jm=s(nv,"LayoutLMv2ForSequenceClassification"),nv.forEach(o),eh=s(hs," forward method, overrides the "),Ya=r(hs,"CODE",{});var sv=i(Ya);th=s(sv,"__call__"),sv.forEach(o),oh=s(hs," special method."),hs.forEach(o),nh=p(wt),y(lt.$$.fragment,wt),sh=p(wt),y(dt.$$.fragment,wt),wt.forEach(o),kt.forEach(o),mi=p(t),Se=r(t,"H2",{class:!0});var Ui=i(Se);ct=r(Ui,"A",{id:!0,class:!0,href:!0});var av=i(ct);Za=r(av,"SPAN",{});var rv=i(Za);y(So.$$.fragment,rv),rv.forEach(o),av.forEach(o),ah=p(Ui),Ja=r(Ui,"SPAN",{});var iv=i(Ja);rh=s(iv,"LayoutLMv2ForTokenClassification"),iv.forEach(o),Ui.forEach(o),hi=p(t),te=r(t,"DIV",{class:!0});var xt=i(te);y(Ro.$$.fragment,xt),ih=p(xt),oe=r(xt,"P",{});var Te=i(oe);lh=s(Te,`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
