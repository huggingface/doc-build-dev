...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){$(s.$$.fragment,c)},m(c,h){v(s,c,h),g=!0},p:D,i(c){g||(w(s.$$.fragment,c),g=!0)},o(c){T(s.$$.fragment,c),g=!1},d(c){y(s,c)}}}function Nh(N){let s,g,c,h,b,n,p,F,ua,_s,pe,Oe,cn,$t,fa,hn,ga,bs,Se,_a,vt,ba,za,zs,Po,ka,ks,qo,pn,$a,$s,te,va,wt,wa,Ta,Tt,ya,Na,vs,me,Le,mn,yt,Fa,un,Ma,ws,Z,Nt,xa,ue,ja,Co,Pa,qa,Ft,Ca,Ea,Aa,fe,Oa,Eo,Sa,La,Ao,Ia,Da,Ba,Ie,Ts,ge,De,fn,Mt,Wa,gn,Ha,ys,M,xt,Qa,_n,Ua,Va,jt,Ra,Oo,Za,Ja,Ka,Pt,Ga,qt,Xa,Ya,er,Ct,tr,Et,or,nr,sr,j,ar,bn,rr,ir,zn,lr,dr,kn,cr,hr,$n,pr,mr,vn,ur,fr,wn,gr,_r,br,J,At,zr,_e,kr,So,$r,vr,Tn,wr,Tr,yr,Be,Nr,We,Ns,be,He,yn,Ot,Fr,Nn,Mr,Fs,q,St,xr,ze,jr,Fn,Pr,qr,Mn,Cr,Er,Ar,Lt,Or,Lo,Sr,Lr,Ir,It,Dr,Dt,Br,Wr,Hr,K,Bt,Qr,ke,Ur,Io,Vr,Rr,xn,Zr,Jr,Kr,Qe,Gr,Ue,Ms,$e,Ve,jn,Wt,Xr,Pn,Yr,xs,C,Ht,ei,Qt,ti,qn,oi,ni,si,Ut,ai,Do,ri,ii,li,Vt,di,Rt,ci,hi,pi,W,Zt,mi,ve,ui,Bo,fi,gi,Cn,_i,bi,zi,Re,ki,Ze,$i,Je,js,we,Ke,En,Jt,vi,An,wi,Ps,E,Kt,Ti,Gt,yi,On,Ni,Fi,Mi,Xt,xi,Wo,ji,Pi,qi,Yt,Ci,eo,Ei,Ai,Oi,G,to,Si,Te,Li,Ho,Ii,Di,Sn,Bi,Wi,Hi,Ge,Qi,Xe,qs,ye,Ye,Ln,oo,Ui,In,Vi,Cs,A,no,Ri,Dn,Zi,Ji,so,Ki,Qo,Gi,Xi,Yi,ao,el,ro,tl,ol,nl,x,io,sl,Ne,al,Uo,rl,il,Bn,ll,dl,cl,et,hl,tt,pl,ot,ml,nt,ul,st,Es,Fe,at,Wn,lo,fl,Hn,gl,As,O,co,_l,Qn,bl,zl,ho,kl,Vo,$l,vl,wl,po,Tl,mo,yl,Nl,Fl,X,uo,Ml,Me,xl,Ro,jl,Pl,Un,ql,Cl,El,rt,Al,it,Os,xe,lt,Vn,fo,Ol,Rn,Sl,Ss,S,go,Ll,Zn,Il,Dl,_o,Bl,Zo,Wl,Hl,Ql,bo,Ul,zo,Vl,Rl,Zl,H,ko,Jl,je,Kl,Jo,Gl,Xl,Jn,Yl,ed,td,dt,od,ct,nd,ht,Ls,Pe,pt,Kn,$o,sd,Gn,ad,Is,L,vo,rd,qe,id,Xn,ld,dd,Yn,cd,hd,pd,wo,md,Ko,ud,fd,gd,To,_d,yo,bd,zd,kd,Q,No,$d,Ce,vd,Go,wd,Td,es,yd,Nd,Fd,mt,Md,ut,xd,ft,Ds;return n=new ee({}),$t=new ee({}),yt=new ee({}),Nt=new P({props:{name:"class transformers.NezhaConfig",anchor:"transformers.NezhaConfig",parameters:[{name:"vocab_size",val:" = 21128"},{name:"embedding_size",val:" = 128"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"max_relative_position",val:" = 64"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"classifier_dropout",val:" = 0.1"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 3"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.NezhaConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, optional, defaults to 21128) &#x2014;
Vocabulary size of the NEZHA model. Defines the different tokens that can be represented by the
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/pr_18192/en/model_doc/nezha#transformers.NezhaModel">NezhaModel</a>.`,name:"vocab_size"},{anchor:"transformers.NezhaConfig.embedding_size",description:`<strong>embedding_size</strong> (<code>int</code>, optional, defaults to 128) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18192/src/transformers/models/nezha/modeling_nezha.py#L903",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18192/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18192/en/model_doc/nezha#transformers.NezhaConfig"
...
Whether or not to return a <a href="/docs/transformers/pr_18192/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.</p>
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18192/src/transformers/models/nezha/modeling_nezha.py#L1060",returnDescription:`
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18192/src/transformers/models/nezha/modeling_nezha.py#L1170",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18192/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18192/src/transformers/models/nezha/modeling_nezha.py#L1263",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18192/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18192/src/transformers/models/nezha/modeling_nezha.py#L1372",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18192/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18192/src/transformers/models/nezha/modeling_nezha.py#L1470",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18192/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18192/src/transformers/models/nezha/modeling_nezha.py#L1567",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18192/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18192/src/transformers/models/nezha/modeling_nezha.py#L1646",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18192/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kd=m(),Q=i("div"),k(No.$$.fragment),$d=m(),Ce=i("p"),vd=a("The "),Go=i("a"),wd=a("NezhaForQuestionAnswering"),Td=a(" forward method, overrides the "),es=i("code"),yd=a("__call__"),Nd=a(" special method."),Fd=m(),k(mt.$$.fragment),Md=m(),k(ut.$$.fragment),xd=m(),k(ft.$$.fragment),this.h()},l(t){const _=th('[data-svelte="svelte-1phssyn"]',document.head);s=l(_,"META",{name:!0,content:!0}),_.forEach(o),g=u(t),c=l(t,"H1",{class:!0});var Fo=d(c);h=l(Fo,"A",{id:!0,class:!0,href:!0});var ts=d(h);b=l(ts,"SPAN",{});var os=d(b);$(n.$$.fragment,os),os.forEach(o),ts.forEach(o),p=u(Fo),F=l(Fo,"SPAN",{});var ns=d(F);ua=r(ns,"Nezha"),ns.forEach(o),Fo.forEach(o),_s=u(t),pe=l(t,"H2",{class:!0});var Mo=d(pe);Oe=l(Mo,"A",{id:!0,class:!0,href:!0});var ss=d(Oe);cn=l(ss,"SPAN",{});var as=d(cn);$($t.$$.fragment,as),as.forEach(o),ss.forEach(o),fa=u(Mo),hn=l(Mo,"SPAN",{});var rs=d(hn);ga=r(rs,"Overview"),rs.forEach(o),Mo.forEach(o),bs=u(t),Se=l(t,"P",{});var xo=d(Se);_a=r(xo,"The Nezha model was proposed in "),vt=l(xo,"A",{href:!0,rel:!0});var is=d(vt);ba=r(is,"NEZHA: Neural Contextualized Representation for Chinese Language Understanding"),is.forEach(o),za=r(xo," by Junqiu Wei et al."),xo.forEach(o),zs=u(t),Po=l(t,"P",{});var ls=d(Po);ka=r(ls,"The abstract from the paper is the following:"),ls.forEach(o),ks=u(t),qo=l(t,"P",{});var ds=d(qo);pn=l(ds,"EM",{});var cs=d(pn);$a=r(cs,`The pre-trained language models have achieved great successes in various natural language understanding (NLU) tasks
due to its capacity to capture the deep contextualized information in text by pre-training on large-scale corpora.
In this technical report, we present our practice of pre-training language models named NEZHA (NEural contextualiZed
representation for CHinese lAnguage understanding) on Chinese corpora and finetuning for the Chinese NLU tasks.
The current version of NEZHA is based on BERT with a collection of proven improvements, which include Functional
...
documentation from `),Ao=l(Xo,"A",{href:!0});var qd=d(Ao);Ia=r(qd,"PretrainedConfig"),qd.forEach(o),Da=r(Xo," for more information."),Xo.forEach(o),Ba=u(Y),$(Ie.$$.fragment,Y),Y.forEach(o),Ts=u(t),ge=l(t,"H2",{class:!0});var Bs=d(ge);De=l(Bs,"A",{id:!0,class:!0,href:!0});var Cd=d(De);fn=l(Cd,"SPAN",{});var Ed=d(fn);$(Mt.$$.fragment,Ed),Ed.forEach(o),Cd.forEach(o),Wa=u(Bs),gn=l(Bs,"SPAN",{});var Ad=d(gn);Ha=r(Ad,"NezhaModel"),Ad.forEach(o),Bs.forEach(o),ys=u(t),M=l(t,"DIV",{class:!0});var U=d(M);$(xt.$$.fragment,U),Qa=u(U),_n=l(U,"P",{});var Od=d(_n);Ua=r(Od,"The bare Nezha Model transformer outputting raw hidden-states without any specific head on top."),Od.forEach(o),Va=u(U),jt=l(U,"P",{});var Ws=d(jt);Ra=r(Ws,"This model inherits from "),Oo=l(Ws,"A",{href:!0});var Sd=d(Oo);Za=r(Sd,"PreTrainedModel"),Sd.forEach(o),Ja=r(Ws,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa.forEach(o),nl=u(re),x=l(re,"DIV",{class:!0});var R=d(x);$(io.$$.fragment,R),sl=u(R),Ne=l(R,"P",{});var sn=d(Ne);al=r(sn,"The "),Uo=l(sn,"A",{href:!0});var yc=d(Uo);rl=r(yc,"NezhaForSequenceClassification"),yc.forEach(o),il=r(sn," forward method, overrides the "),Bn=l(sn,"CODE",{});var Nc=d(Bn);ll=r(Nc,"__call__"),Nc.forEach(o),dl=r(sn," special method."),sn.forEach(o),cl=u(R),$(et.$$.fragment,R),hl=u(R),$(tt.$$.fragment,R),pl=u(R),$(ot.$$.fragment,R),ml=u(R),$(nt.$$.fragment,R),ul=u(R),$(st.$$.fragment,R),R.forEach(o),re.forEach(o),Es=u(t),Fe=l(t,"H2",{class:!0});var aa=d(Fe);at=l(aa,"A",{id:!0,class:!0,href:!0});var Fc=d(at);Wn=l(Fc,"SPAN",{});var Mc=d(Wn);$(lo.$$.fragment,Mc),Mc.forEach(o),Fc.forEach(o),fl=u(aa),Hn=l(aa,"SPAN",{});var xc=d(Hn);gl=r(xc,"NezhaForMultipleChoice"),xc.forEach(o),aa.forEach(o),As=u(t),O=l(t,"DIV",{class:!0});var ie=d(O);$(co.$$.fragment,ie),_l=u(ie),Qn=l(ie,"P",{});var jc=d(Qn);bl=r(jc,`Nezha Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
