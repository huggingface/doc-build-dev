...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17555/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17555/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17555/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17555/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17555/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/modeling_t5.py#L1537",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17555/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/modeling_t5.py#L1808",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/modeling_tf_t5.py#L1137",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/modeling_tf_t5.py#L1313",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17555/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17555/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17555/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/modeling_tf_t5.py#L1624",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/t5/modeling_flax_t5.py#L955",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),KT=d(),v(Kn.$$.fragment),YT=d(),ft=a("div"),v(za.$$.fragment),ZT=d(),en=a("p"),JT=o("The "),Lr=a("a"),XT=o("TFT5ForConditionalGeneration"),QT=o(" forward method, overrides the "),Xl=a("code"),e5=o("__call__"),t5=o(" special method."),n5=d(),v(Yn.$$.fragment),o5=d(),v(Zn.$$.fragment),Dc=d(),tn=a("h2"),Jn=a("a"),Ql=a("span"),v(ja.$$.fragment),s5=d(),ed=a("span"),a5=o("TFT5EncoderModel"),Sc=d(),ce=a("div"),v(qa.$$.fragment),r5=d(),td=a("p"),i5=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),l5=d(),Ea=a("p"),d5=o("The T5 model was proposed in "),Fa=a("a"),c5=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),p5=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),h5=d(),Ma=a("p"),u5=o("This model inherits from "),Ar=a("a"),m5=o("TFPreTrainedModel"),f5=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_5=d(),Ca=a("p"),g5=o("This model is also a "),Pa=a("a"),T5=o("tf.keras.Model"),b5=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),v5=d(),v(Xn.$$.fragment),k5=d(),_t=a("div"),v(Na.$$.fragment),y5=d(),nn=a("p"),w5=o("The "),Ir=a("a"),$5=o("TFT5EncoderModel"),x5=o(" forward method, overrides the "),nd=a("code"),z5=o("__call__"),j5=o(" special method."),q5=d(),v(Qn.$$.fragment),E5=d(),v(eo.$$.fragment),Gc=d(),on=a("h2"),to=a("a"),od=a("span"),v(Oa.$$.fragment),F5=d(),sd=a("span"),M5=o("FlaxT5Model"),Uc=d(),Je=a("div"),v(La.$$.fragment),C5=d(),gt=a("div"),v(Aa.$$.fragment),P5=d(),sn=a("p"),N5=o("The "),ad=a("code"),O5=o("FlaxT5PreTrainedModel"),L5=o(" forward method, overrides the "),rd=a("code"),A5=o("__call__"),I5=o(" special method."),D5=d(),v(no.$$.fragment),S5=d(),v(oo.$$.fragment),G5=d(),so=a("div"),v(Ia.$$.fragment),U5=d(),v(ao.$$.fragment),W5=d(),ro=a("div"),v(Da.$$.fragment),B5=d(),v(io.$$.fragment),Wc=d(),an=a("h2"),lo=a("a"),id=a("span"),v(Sa.$$.fragment),R5=d(),ld=a("span"),H5=o("FlaxT5ForConditionalGeneration"),Bc=d(),Xe=a("div"),v(Ga.$$.fragment),V5=d(),Tt=a("div"),v(Ua.$$.fragment),K5=d(),rn=a("p"),Y5=o("The "),dd=a("code"),Z5=o("FlaxT5PreTrainedModel"),J5=o(" forward method, overrides the "),cd=a("code"),X5=o("__call__"),Q5=o(" special method."),eb=d(),v(co.$$.fragment),tb=d(),v(po.$$.fragment),nb=d(),ho=a("div"),v(Wa.$$.fragment),ob=d(),v(uo.$$.fragment),sb=d(),mo=a("div"),v(Ba.$$.fragment),ab=d(),v(fo.$$.fragment),this.h()},l(n){const f=Xy('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),b=c(n),g=r(n,"H1",{class:!0});var Ra=i(g);u=r(Ra,"A",{id:!0,class:!0,href:!0});var pd=i(u);T=r(pd,"SPAN",{});var hd=i(T);k(l.$$.fragment,hd),hd.forEach(t),pd.forEach(t),_=c(Ra),q=r(Ra,"SPAN",{});var ud=i(q);qe=s(ud,"T5"),ud.forEach(t),Ra.forEach(t),se=c(n),E=r(n,"H2",{class:!0});var Ha=i(E);ee=r(Ha,"A",{id:!0,class:!0,href:!0});var md=i(ee);G=r(md,"SPAN",{});var fd=i(G);k(ae.$$.fragment,fd),fd.forEach(t),md.forEach(t),Ee=c(Ha),U=r(Ha,"SPAN",{});var _d=i(U);Fe=s(_d,"Overview"),_d.forEach(t),Ha.forEach(t),ke=c(n),W=r(n,"P",{});var Va=i(W);A=s(Va,"The T5 model was presented in "),re=r(Va,"A",{href:!0,rel:!0});var gd=i(re);pe=s(gd,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),gd.forEach(t),M=s(Va,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
