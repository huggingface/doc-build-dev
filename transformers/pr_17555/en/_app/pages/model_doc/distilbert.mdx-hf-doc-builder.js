...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17555/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17555/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y1=r(qd);cv=i(Y1,"span start logits"),Y1.forEach(t),pv=i(yl," and "),Pd=n(yl,"CODE",{});var Z1=r(Pd);hv=i(Z1,"span end logits"),Z1.forEach(t),uv=i(yl,")."),yl.forEach(t),fv=h(Bt),ia=n(Bt,"P",{});var su=r(ia);mv=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var e5=r(nl);gv=i(e5,"TFPreTrainedModel"),e5.forEach(t),_v=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),bv=h(Bt),la=n(Bt,"P",{});var ou=r(la);vv=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var t5=r(da);kv=i(t5,"tf.keras.Model"),t5.forEach(t),Tv=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$v=h(Bt),$(Uo.$$.fragment,Bt),wv=h(Bt),et=n(Bt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yv=h(Zt),Ms=n(Zt,"P",{});var Dl=r(Ms);Dv=i(Dl,"The "),rl=n(Dl,"A",{href:!0});var s5=r(rl);Fv=i(s5,"TFDistilBertForQuestionAnswering"),s5.forEach(t),Bv=i(Dl," forward method, overrides the "),Ad=n(Dl,"CODE",{});var o5=r(Ad);xv=i(o5,"__call__"),o5.forEach(t),Mv=i(Dl," special method."),Dl.forEach(t),Ev=h(Zt),$(Ho.$$.fragment,Zt),zv=h(Zt),$(Vo.$$.fragment,Zt),jv=h(Zt),$(Ko.$$.fragment,Zt),Zt.forEach(t),Bt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var n5=r(Jo);Od=n(n5,"SPAN",{});var r5=r(Od);$(pa.$$.fragment,r5),r5.forEach(t),n5.forEach(t),Cv=h(nu),Nd=n(nu,"SPAN",{});var a5=r(Nd);qv=i(a5,"FlaxDistilBertModel"),a5.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),Pv=h(st),Ld=n(st,"P",{});var i5=r(Ld);Av=i(i5,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i5.forEach(t),Ov=h(st),ua=n(st,"P",{});var ru=r(ua);Nv=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l5=r(al);Lv=i(l5,"FlaxPreTrainedModel"),l5.forEach(t),Sv=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Iv=h(st),fa=n(st,"P",{});var au=r(fa);Wv=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d5=r(ma);Qv=i(d5,"flax.linen.Module"),d5.forEach(t),Rv=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uv=h(st),Sd=n(st,"P",{});var c5=r(Sd);Hv=i(c5,"Finally, this model supports inherent JAX features such as:"),c5.forEach(t),Vv=h(st),Mt=n(st,"UL",{});var kn=r(Mt);Id=n(kn,"LI",{});var p5=r(Id);ga=n(p5,"A",{href:!0,rel:!0});var h5=r(ga);Kv=i(h5,"Just-In-Time (JIT) compilation"),h5.forEach(t),p5.forEach(t),Jv=h(kn),Wd=n(kn,"LI",{});var u5=r(Wd);_a=n(u5,"A",{href:!0,rel:!0});var f5=r(_a);Gv=i(f5,"Automatic Differentiation"),f5.forEach(t),u5.forEach(t),Xv=h(kn),Qd=n(kn,"LI",{});var m5=r(Qd);ba=n(m5,"A",{href:!0,rel:!0});var g5=r(ba);Yv=i(g5,"Vectorization"),g5.forEach(t),m5.forEach(t),Zv=h(kn),Rd=n(kn,"LI",{});var _5=r(Rd);va=n(_5,"A",{href:!0,rel:!0});var b5=r(va);ek=i(b5,"Parallelization"),b5.forEach(t),_5.forEach(t),kn.forEach(t),tk=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(ka.$$.fragment,Tn),sk=h(Tn),zs=n(Tn,"P",{});var Fl=r(zs);ok=i(Fl,"The "),Ud=n(Fl,"CODE",{});var v5=r(Ud);nk=i(v5,"FlaxDistilBertPreTrainedModel"),v5.forEach(t),rk=i(Fl," forward method, overrides the "),Hd=n(Fl,"CODE",{});var k5=r(Hd);ak=i(k5,"__call__"),k5.forEach(t),ik=i(Fl," special method."),Fl.forEach(t),lk=h(Tn),$(Go.$$.fragment,Tn),dk=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T5=r(Yo);Vd=n(T5,"SPAN",{});var $5=r(Vd);$(Ta.$$.fragment,$5),$5.forEach(t),T5.forEach(t),ck=h(iu),Kd=n(iu,"SPAN",{});var w5=r(Kd);pk=i(w5,"FlaxDistilBertForMaskedLM"),w5.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hk=h(ot),wa=n(ot,"P",{});var lu=r(wa);uk=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y5=r(Jd);fk=i(y5,"language modeling"),y5.forEach(t),mk=i(lu," head on top."),lu.forEach(t),gk=h(ot),ya=n(ot,"P",{});var du=r(ya);_k=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var D5=r(il);bk=i(D5,"FlaxPreTrainedModel"),D5.forEach(t),vk=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),kk=h(ot),Da=n(ot,"P",{});var cu=r(Da);Tk=i(cu,"This model is also a Flax Linen "),Fa=n(cu,"A",{href:!0,rel:!0});var F5=r(Fa);$k=i(F5,"flax.linen.Module"),F5.forEach(t),wk=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cu.forEach(t),yk=h(ot),Gd=n(ot,"P",{});var B5=r(Gd);Dk=i(B5,"Finally, this model supports inherent JAX features such as:"),B5.forEach(t),Fk=h(ot),Et=n(ot,"UL",{});var $n=r(Et);Xd=n($n,"LI",{});var x5=r(Xd);Ba=n(x5,"A",{href:!0,rel:!0});var M5=r(Ba);Bk=i(M5,"Just-In-Time (JIT) compilation"),M5.forEach(t),x5.forEach(t),xk=h($n),Yd=n($n,"LI",{});var E5=r(Yd);xa=n(E5,"A",{href:!0,rel:!0});var z5=r(xa);Mk=i(z5,"Automatic Differentiation"),z5.forEach(t),E5.forEach(t),Ek=h($n),Zd=n($n,"LI",{});var j5=r(Zd);Ma=n(j5,"A",{href:!0,rel:!0});var C5=r(Ma);zk=i(C5,"Vectorization"),C5.forEach(t),j5.forEach(t),jk=h($n),ec=n($n,"LI",{});var q5=r(ec);Ea=n(q5,"A",{href:!0,rel:!0});var P5=r(Ea);Ck=i(P5,"Parallelization"),P5.forEach(t),q5.forEach(t),$n.forEach(t),qk=h(ot),_t=n(ot,"DIV",{class:!0});var wn=r(_t);$(za.$$.fragment,wn),Pk=h(wn),Cs=n(wn,"P",{});var Bl=r(Cs);Ak=i(Bl,"The "),tc=n(Bl,"CODE",{});var A5=r(tc);Ok=i(A5,"FlaxDistilBertPreTrainedModel"),A5.forEach(t),Nk=i(Bl," forward method, overrides the "),sc=n(Bl,"CODE",{});var O5=r(sc);Lk=i(O5,"__call__"),O5.forEach(t),Sk=i(Bl," special method."),Bl.forEach(t),Ik=h(wn),$(Zo.$$.fragment,wn),Wk=h(wn),$(en.$$.fragment,wn),wn.forEach(t),ot.forEach(t),dh=h(s),qs=n(s,"H2",{class:!0});var pu=r(qs);tn=n(pu,"A",{id:!0,class:!0,href:!0});var N5=r(tn);oc=n(N5,"SPAN",{});var L5=r(oc);$(ja.$$.fragment,L5),L5.forEach(t),N5.forEach(t),Qk=h(pu),nc=n(pu,"SPAN",{});var S5=r(nc);Rk=i(S5,"FlaxDistilBertForSequenceClassification"),S5.forEach(t),pu.forEach(t),ch=h(s),ze=n(s,"DIV",{class:!0});var nt=r(ze);$(Ca.$$.fragment,nt),Uk=h(nt),rc=n(nt,"P",{});var I5=r(rc);Hk=i(I5,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),I5.forEach(t),Vk=h(nt),qa=n(nt,"P",{});var hu=r(qa);Kk=i(hu,"This model inherits from "),ll=n(hu,"A",{href:!0});var W5=r(ll);Jk=i(W5,"FlaxPreTrainedModel"),W5.forEach(t),Gk=i(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),hu.forEach(t),Xk=h(nt),Pa=n(nt,"P",{});var uu=r(Pa);Yk=i(uu,"This model is also a Flax Linen "),Aa=n(uu,"A",{href:!0,rel:!0});var Q5=r(Aa);Zk=i(Q5,"flax.linen.Module"),Q5.forEach(t),eT=i(uu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uu.forEach(t),tT=h(nt),ac=n(nt,"P",{});var R5=r(ac);sT=i(R5,"Finally, this model supports inherent JAX features such as:"),R5.forEach(t),oT=h(nt),zt=n(nt,"UL",{});var yn=r(zt);ic=n(yn,"LI",{});var U5=r(ic);Oa=n(U5,"A",{href:!0,rel:!0});var H5=r(Oa);nT=i(H5,"Just-In-Time (JIT) compilation"),H5.forEach(t),U5.forEach(t),rT=h(yn),lc=n(yn,"LI",{});var V5=r(lc);Na=n(V5,"A",{href:!0,rel:!0});var K5=r(Na);aT=i(K5,"Automatic Differentiation"),K5.forEach(t),V5.forEach(t),iT=h(yn),dc=n(yn,"LI",{});var J5=r(dc);La=n(J5,"A",{href:!0,rel:!0});var G5=r(La);lT=i(G5,"Vectorization"),G5.forEach(t),J5.forEach(t),dT=h(yn),cc=n(yn,"LI",{});var X5=r(cc);Sa=n(X5,"A",{href:!0,rel:!0});var Y5=r(Sa);cT=i(Y5,"Parallelization"),Y5.forEach(t),X5.forEach(t),yn.forEach(t),pT=h(nt),bt=n(nt,"DIV",{class:!0});var Dn=r(bt);$(Ia.$$.fragment,Dn),hT=h(Dn),Ps=n(Dn,"P",{});var xl=r(Ps);uT=i(xl,"The "),pc=n(xl,"CODE",{});var Z5=r(pc);fT=i(Z5,"FlaxDistilBertPreTrainedModel"),Z5.forEach(t),mT=i(xl," forward method, overrides the "),hc=n(xl,"CODE",{});var ey=r(hc);gT=i(ey,"__call__"),ey.forEach(t),_T=i(xl," special method."),xl.forEach(t),bT=h(Dn),$(sn.$$.fragment,Dn),vT=h(Dn),$(on.$$.fragment,Dn),Dn.forEach(t),nt.forEach(t),ph=h(s),As=n(s,"H2",{class:!0});var fu=r(As);nn=n(fu,"A",{id:!0,class:!0,href:!0});var ty=r(nn);uc=n(ty,"SPAN",{});var sy=r(uc);$(Wa.$$.fragment,sy),sy.forEach(t),ty.forEach(t),kT=h(fu),fc=n(fu,"SPAN",{});var oy=r(fc);TT=i(oy,"FlaxDistilBertForMultipleChoice"),oy.forEach(t),fu.forEach(t),hh=h(s),je=n(s,"DIV",{class:!0});var rt=r(je);$(Qa.$$.fragment,rt),$T=h(rt),mc=n(rt,"P",{});var ny=r(mc);wT=i(ny,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
