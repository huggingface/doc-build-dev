import{S as Di,i as xi,s as $i,e as a,k as c,w as f,t as n,M as ji,c as s,d as o,m as l,a as d,x as u,h as r,b as i,F as e,g as h,y as g,q as _,o as b,B as v,v as Fi}from"../../chunks/vendor-6b77c823.js";import{T as dd}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-abef54e3.js";import{C as qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Wt}from"../../chunks/IconCopyLink-7a11ce68.js";function Pi(pe){let m,F,y,z,j;return{c(){m=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);z=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Ai(pe){let m,F,y,z,j;return{c(){m=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);z=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Ci(pe){let m,F,y,z,j;return{c(){m=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=n("Module"),j=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);z=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Si(pe){let m,F,y,z,j,k,T,P,zn,Rt,me,qn,wo,Dn,xn,Gt,he,$n,De,jn,Fn,Ut,fe,Pn,Eo,An,Cn,Ht,V,Sn,Mo,Nn,In,xe,Ln,Bn,Yt,W,On,st,Vn,Wn,dt,Rn,Gn,Jt,$e,Zt,R,Un,je,Hn,Yn,Fe,Jn,Zn,Kt,Q,ue,it,Pe,Kn,ct,Qn,Qt,q,Ae,Xn,ge,zo,er,or,qo,tr,nr,rr,X,ar,Do,sr,dr,xo,ir,cr,lr,lt,pr,mr,Ce,hr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,ee,yr,pt,kr,Tr,mt,wr,Er,Xt,oe,ve,ht,Le,Mr,ft,zr,en,w,Be,qr,te,Dr,jo,xr,$r,Fo,jr,Fr,Pr,Oe,Ar,Ve,Cr,Sr,Nr,ut,Ir,Lr,We,Br,Po,Or,Vr,Wr,Re,Rr,Ge,Gr,Ur,Hr,G,Ao,Yr,Jr,gt,Zr,Kr,_t,Qr,Xr,ea,A,Ue,oa,ne,ta,Co,na,ra,bt,aa,sa,da,ye,ia,vt,ca,la,He,pa,C,Ye,ma,yt,ha,fa,re,ua,kt,ga,_a,Tt,ba,va,ya,wt,ka,Ta,Je,on,ae,ke,Et,Ze,wa,Mt,Ea,tn,E,Ke,Ma,se,za,So,qa,Da,No,xa,$a,ja,Qe,Fa,Xe,Pa,Aa,Ca,zt,Sa,Na,eo,Ia,Io,La,Ba,Oa,oo,Va,to,Wa,Ra,Ga,U,Lo,Ua,Ha,Bo,Ya,Ja,Oo,Za,Ka,Qa,S,no,Xa,de,es,Vo,os,ts,qt,ns,rs,as,Te,ss,Dt,ds,is,ro,cs,L,ao,ls,xt,ps,ms,$t,hs,fs,so,nn,ie,we,jt,io,us,Ft,gs,rn,M,co,_s,ce,bs,Wo,vs,ys,Ro,ks,Ts,ws,lo,Es,po,Ms,zs,qs,Pt,Ds,xs,mo,$s,Go,js,Fs,Ps,ho,As,fo,Cs,Ss,Ns,H,Uo,Is,Ls,At,Bs,Os,Ct,Vs,Ws,Rs,N,uo,Gs,le,Us,Ho,Hs,Ys,St,Js,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,bo,an;return k=new Wt({}),$e=new qe({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),Pe=new Wt({}),Ae=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16648/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26",parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_16648/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_16648/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}]}}),Ce=new qe({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_16648/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),Ie=new O({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16648/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
configuration. Check out the <a href="/docs/transformers/pr_16648/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ue=new O({props:{name:"forward",anchor:"transformers.EncoderDecoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16648/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L429",parametersDescription:[{anchor:"transformers.EncoderDecoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16648/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16648/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16648/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16648/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<a href="/docs/transformers/pr_16648/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),Je=new qe({props:{code:`from transformers import EncoderDecoderModel
...
<a href="/docs/transformers/pr_16648/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_16648/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/pr_16648/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
...
<p>A <a
  href="/docs/transformers/pr_16648/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16648/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),so=new qe({props:{code:`from transformers import TFEncoderDecoderModel
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16648/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16648/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_16648/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),bo=new qe({props:{code:`from transformers import FlaxEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){m=a("meta"),F=c(),y=a("h1"),z=a("a"),j=a("span"),f(k.$$.fragment),T=c(),P=a("span"),zn=n("Encoder Decoder Models"),Rt=c(),me=a("p"),qn=n("The "),wo=a("a"),Dn=n("EncoderDecoderModel"),xn=n(` can be used to initialize a sequence-to-sequence model with any
...
decoder model configuration.`),br=c(),be=a("div"),f(Ie.$$.fragment),vr=c(),ee=a("p"),yr=n("Serializes this instance to a Python dictionary. Override the default "),pt=a("em"),kr=n("to_dict()"),Tr=n(" from "),mt=a("em"),wr=n("PretrainedConfig"),Er=n("."),Xt=c(),oe=a("h2"),ve=a("a"),ht=a("span"),f(Le.$$.fragment),Mr=c(),ft=a("span"),zr=n("EncoderDecoderModel"),en=c(),w=a("div"),f(Be.$$.fragment),qr=c(),te=a("p"),Dr=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
the model, you need to first set it back in training mode with `),Tt=a("code"),ba=n("model.train()"),va=n("."),ya=c(),wt=a("p"),ka=n("Example:"),Ta=c(),f(Je.$$.fragment),on=c(),ae=a("h2"),ke=a("a"),Et=a("span"),f(Ze.$$.fragment),wa=c(),Mt=a("span"),Ea=n("TFEncoderDecoderModel"),tn=c(),E=a("div"),f(Ke.$$.fragment),Ma=c(),se=a("p"),za=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),So=a("a"),qa=n("from_pretrained()"),Da=n(" function and the decoder is loaded via "),No=a("a"),xa=n("from_pretrained()"),$a=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),Ca=c(),zt=a("p"),Sa=n(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
method for the decoder.`),Qa=c(),S=a("div"),f(no.$$.fragment),Xa=c(),de=a("p"),es=n("The "),Vo=a("a"),os=n("TFEncoderDecoderModel"),ts=n(" forward method, overrides the "),qt=a("code"),ns=n("__call__"),rs=n(" special method."),as=c(),f(Te.$$.fragment),ss=c(),Dt=a("p"),ds=n("Examples:"),is=c(),f(ro.$$.fragment),cs=c(),L=a("div"),f(ao.$$.fragment),ls=c(),xt=a("p"),ps=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
checkpoints.`),rd=c(),Lt=a("p"),ad=n("Example:"),sd=c(),f(bo.$$.fragment),this.h()},l(t){const p=ji('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),F=l(t),y=s(t,"H1",{class:!0});var vo=d(y);z=s(vo,"A",{id:!0,class:!0,href:!0});var Bt=d(z);j=s(Bt,"SPAN",{});var Ot=d(j);u(k.$$.fragment,Ot),Ot.forEach(o),Bt.forEach(o),T=l(vo),P=s(vo,"SPAN",{});var id=d(P);zn=r(id,"Encoder Decoder Models"),id.forEach(o),vo.forEach(o),Rt=l(t),me=s(t,"P",{});var sn=d(me);qn=r(sn,"The "),wo=s(sn,"A",{href:!0});var cd=d(wo);Dn=r(cd,"EncoderDecoderModel"),cd.forEach(o),xn=r(sn,` can be used to initialize a sequence-to-sequence model with any
...
the model, you need to first set it back in training mode with `),Tt=s(ot,"CODE",{});var Ud=d(Tt);ba=r(Ud,"model.train()"),Ud.forEach(o),va=r(ot,"."),ot.forEach(o),ya=l(J),wt=s(J,"P",{});var Hd=d(wt);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=l(J),u(Je.$$.fragment,J),J.forEach(o),D.forEach(o),on=l(t),ae=s(t,"H2",{class:!0});var bn=d(ae);ke=s(bn,"A",{id:!0,class:!0,href:!0});var Yd=d(ke);Et=s(Yd,"SPAN",{});var Jd=d(Et);u(Ze.$$.fragment,Jd),Jd.forEach(o),Yd.forEach(o),wa=l(bn),Mt=s(bn,"SPAN",{});var Zd=d(Mt);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),bn.forEach(o),tn=l(t),E=s(t,"DIV",{class:!0});var x=d(E);u(Ke.$$.fragment,x),Ma=l(x),se=s(x,"P",{});var tt=d(se);za=r(tt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),So=s(tt,"A",{href:!0});var Kd=d(So);qa=r(Kd,"from_pretrained()"),Kd.forEach(o),Da=r(tt," function and the decoder is loaded via "),No=s(tt,"A",{href:!0});var Qd=d(No);xa=r(Qd,"from_pretrained()"),Qd.forEach(o),$a=r(tt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),tt.forEach(o),ja=l(x),Qe=s(x,"P",{});var vn=d(Qe);Fa=r(vn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),vn.forEach(o),Ca=l(x),zt=s(x,"P",{});var ei=d(zt);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
method for the decoder.`),ko.forEach(o),Qa=l(x),S=s(x,"DIV",{class:!0});var Z=d(S);u(no.$$.fragment,Z),Xa=l(Z),de=s(Z,"P",{});var nt=d(de);es=r(nt,"The "),Vo=s(nt,"A",{href:!0});var si=d(Vo);os=r(si,"TFEncoderDecoderModel"),si.forEach(o),ts=r(nt," forward method, overrides the "),qt=s(nt,"CODE",{});var di=d(qt);ns=r(di,"__call__"),di.forEach(o),rs=r(nt," special method."),nt.forEach(o),as=l(Z),u(Te.$$.fragment,Z),ss=l(Z),Dt=s(Z,"P",{});var ii=d(Dt);ds=r(ii,"Examples:"),ii.forEach(o),is=l(Z),u(ro.$$.fragment,Z),Z.forEach(o),cs=l(x),L=s(x,"DIV",{class:!0});var Me=d(L);u(ao.$$.fragment,Me),ls=l(Me),xt=s(Me,"P",{});var ci=d(xt);ps=r(ci,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
(see the examples for more information).`),_i.forEach(o),xs=l($),mo=s($,"P",{});var En=d(mo);$s=r(En,"This model inherits from "),Go=s(En,"A",{href:!0});var bi=d(Go);js=r(bi,"FlaxPreTrainedModel"),bi.forEach(o),Fs=r(En,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
