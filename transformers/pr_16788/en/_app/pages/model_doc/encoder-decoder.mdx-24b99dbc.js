import{S as zi,i as xi,s as $i,e as a,k as c,w as f,t as n,M as ji,c as s,d as o,m as l,a as d,x as u,h as r,b as i,F as e,g as h,y as g,q as _,o as b,B as v,v as Fi}from"../../chunks/vendor-6b77c823.js";import{T as dd}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-90e3aa51.js";import{C as De}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Wt}from"../../chunks/IconCopyLink-7a11ce68.js";function Pi(pe){let m,F,y,q,j;return{c(){m=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),q=n("Module"),j=n(`
...
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);q=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,q),e(m,j)},d(k){k&&o(m)}}}function Si(pe){let m,F,y,q,j,k,T,P,qn,Rt,me,Dn,wo,zn,xn,Gt,he,$n,ze,jn,Fn,Ut,fe,Pn,Eo,An,Cn,Ht,V,Sn,Mo,Nn,In,xe,Ln,Bn,Yt,W,On,st,Vn,Wn,dt,Rn,Gn,Jt,$e,Zt,R,Un,je,Hn,Yn,Fe,Jn,Zn,Kt,Q,ue,it,Pe,Kn,ct,Qn,Qt,D,Ae,Xn,ge,qo,er,or,Do,tr,nr,rr,X,ar,zo,sr,dr,xo,ir,cr,lr,lt,pr,mr,Ce,hr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,ee,yr,pt,kr,Tr,mt,wr,Er,Xt,oe,ve,ht,Le,Mr,ft,qr,en,w,Be,Dr,te,zr,jo,xr,$r,Fo,jr,Fr,Pr,Oe,Ar,Ve,Cr,Sr,Nr,ut,Ir,Lr,We,Br,Po,Or,Vr,Wr,Re,Rr,Ge,Gr,Ur,Hr,G,Ao,Yr,Jr,gt,Zr,Kr,_t,Qr,Xr,ea,A,Ue,oa,ne,ta,Co,na,ra,bt,aa,sa,da,ye,ia,vt,ca,la,He,pa,C,Ye,ma,yt,ha,fa,re,ua,kt,ga,_a,Tt,ba,va,ya,wt,ka,Ta,Je,on,ae,ke,Et,Ze,wa,Mt,Ea,tn,E,Ke,Ma,se,qa,So,Da,za,No,xa,$a,ja,Qe,Fa,Xe,Pa,Aa,Ca,qt,Sa,Na,eo,Ia,Io,La,Ba,Oa,oo,Va,to,Wa,Ra,Ga,U,Lo,Ua,Ha,Bo,Ya,Ja,Oo,Za,Ka,Qa,S,no,Xa,de,es,Vo,os,ts,Dt,ns,rs,as,Te,ss,zt,ds,is,ro,cs,L,ao,ls,xt,ps,ms,$t,hs,fs,so,nn,ie,we,jt,io,us,Ft,gs,rn,M,co,_s,ce,bs,Wo,vs,ys,Ro,ks,Ts,ws,lo,Es,po,Ms,qs,Ds,Pt,zs,xs,mo,$s,Go,js,Fs,Ps,ho,As,fo,Cs,Ss,Ns,H,Uo,Is,Ls,At,Bs,Os,Ct,Vs,Ws,Rs,N,uo,Gs,le,Us,Ho,Hs,Ys,St,Js,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,bo,an;return k=new Wt({}),$e=new De({props:{code:`# a workaround to load from pytorch checkpoint
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16788/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),Ce=new De({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16788/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L429",returnDescription:`
<p>A <a
...
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16788/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L494",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16788/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L330"}}),so=new De({props:{code:`from transformers import TFEncoderDecoderModel
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16788/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L610",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16788/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L741"}}),bo=new De({props:{code:`from transformers import FlaxEncoderDecoderModel
...
decoder model configuration.`),br=c(),be=a("div"),f(Ie.$$.fragment),vr=c(),ee=a("p"),yr=n("Serializes this instance to a Python dictionary. Override the default "),pt=a("em"),kr=n("to_dict()"),Tr=n(" from "),mt=a("em"),wr=n("PretrainedConfig"),Er=n("."),Xt=c(),oe=a("h2"),ve=a("a"),ht=a("span"),f(Le.$$.fragment),Mr=c(),ft=a("span"),qr=n("EncoderDecoderModel"),en=c(),w=a("div"),f(Be.$$.fragment),Dr=c(),te=a("p"),zr=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
checkpoints.`),rd=c(),Lt=a("p"),ad=n("Example:"),sd=c(),f(bo.$$.fragment),this.h()},l(t){const p=ji('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),F=l(t),y=s(t,"H1",{class:!0});var vo=d(y);q=s(vo,"A",{id:!0,class:!0,href:!0});var Bt=d(q);j=s(Bt,"SPAN",{});var Ot=d(j);u(k.$$.fragment,Ot),Ot.forEach(o),Bt.forEach(o),T=l(vo),P=s(vo,"SPAN",{});var id=d(P);qn=r(id,"Encoder Decoder Models"),id.forEach(o),vo.forEach(o),Rt=l(t),me=s(t,"P",{});var sn=d(me);Dn=r(sn,"The "),wo=s(sn,"A",{href:!0});var cd=d(wo);zn=r(cd,"EncoderDecoderModel"),cd.forEach(o),xn=r(sn,` can be used to initialize a sequence-to-sequence model with any
...
the model, you need to first set it back in training mode with `),Tt=s(ot,"CODE",{});var Ud=d(Tt);ba=r(Ud,"model.train()"),Ud.forEach(o),va=r(ot,"."),ot.forEach(o),ya=l(J),wt=s(J,"P",{});var Hd=d(wt);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=l(J),u(Je.$$.fragment,J),J.forEach(o),z.forEach(o),on=l(t),ae=s(t,"H2",{class:!0});var bn=d(ae);ke=s(bn,"A",{id:!0,class:!0,href:!0});var Yd=d(ke);Et=s(Yd,"SPAN",{});var Jd=d(Et);u(Ze.$$.fragment,Jd),Jd.forEach(o),Yd.forEach(o),wa=l(bn),Mt=s(bn,"SPAN",{});var Zd=d(Mt);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),bn.forEach(o),tn=l(t),E=s(t,"DIV",{class:!0});var x=d(E);u(Ke.$$.fragment,x),Ma=l(x),se=s(x,"P",{});var tt=d(se);qa=r(tt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
Zhou, Wei Li, Peter J. Liu.`),vn.forEach(o),Ca=l(x),qt=s(x,"P",{});var ei=d(qt);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
