...
PyTorch tensors, you will lose the specific device of your tensors however.`),W.forEach(t)},m(_e,W){P(_e,p,W),e(p,$),e(p,f),e(f,h),e(p,x),e(p,c),e(c,_),e(p,L)},d(_e){_e&&t(p)}}}function Hm(E){let p,$,f,h,x;return h=new bs({props:{code:`
...
<span class="hljs-keyword">assert</span> tokenizer.cls_token == <span class="hljs-string">&quot;&lt;CLS&gt;&quot;</span>`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Jm(E){let p,$,f,h,x;return h=new bs({props:{code:"",highlighted:`<span class="hljs-comment"># Let&#x27;s see how to increase the vocabulary of Bert model and tokenizer</span>
...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Km(E){let p,$,f,h,x,c,_,L,_e,W,D,no,ro,vs,Ts,so,ys,ws,ao,zs,xs,io,$s,Ps,qr,lo,qs,Er,ge,Le,Fo,st,Es,Co,Bs,Br,u,at,Ls,ke,Ds,co,Is,Ns,po,As,Ss,Fs,Oo,Cs,Os,Wo,Ws,js,I,Z,jo,Rs,Us,Ro,Ms,Vs,Uo,Gs,Hs,Xs,S,Mo,Ys,Js,Vo,Ks,Qs,Go,Zs,ea,Ho,ta,oa,Xo,na,ra,sa,M,Yo,aa,ia,Jo,da,la,Ko,ca,pa,Qo,ma,ha,ua,F,Zo,fa,_a,en,ga,ka,tn,ba,va,on,Ta,ya,mo,wa,za,xa,De,nn,$a,Pa,rn,qa,Ea,Ba,V,sn,La,Da,an,Ia,Na,dn,Aa,Sa,ln,Fa,Ca,Oa,G,cn,Wa,ja,pn,Ra,Ua,mn,Ma,Va,hn,Ga,Ha,Xa,Ie,it,Ya,un,Ja,Ka,Ne,dt,Qa,fn,Za,ei,Ae,lt,ti,_n,oi,ni,ee,ct,ri,gn,si,ai,Se,ii,te,pt,di,kn,li,ci,bn,pi,mi,Fe,mt,hi,vn,ui,fi,Ce,ht,_i,ut,gi,Tn,ki,bi,vi,oe,ft,Ti,ho,yi,uo,wi,zi,yn,xi,$i,ne,_t,Pi,wn,qi,Ei,gt,Bi,zn,Li,Di,Ii,re,kt,Ni,xn,Ai,Si,bt,Fi,$n,Ci,Oi,Wi,se,vt,ji,Pn,Ri,Ui,Oe,Mi,H,Tt,Vi,yt,Gi,fo,Hi,Xi,Yi,We,Ji,je,Ki,Re,wt,Qi,be,Zi,qn,ed,td,En,od,nd,rd,ae,zt,sd,Bn,ad,id,ie,Ln,dd,ld,Dn,cd,pd,In,md,hd,ud,X,xt,fd,Nn,_d,gd,J,kd,An,bd,vd,Sn,Td,yd,Fn,wd,zd,xd,Ue,$d,Me,$t,Pd,j,qd,Cn,Ed,Bd,On,Ld,Dd,Wn,Id,Nd,jn,Ad,Sd,Fd,Ve,Pt,Cd,Rn,Od,Wd,de,qt,jd,Et,Rd,Un,Ud,Md,Vd,Ge,Gd,le,Bt,Hd,Lt,Xd,Mn,Yd,Jd,Kd,He,Qd,Y,Dt,Zd,Vn,el,tl,It,ol,Gn,nl,rl,sl,Nt,al,Hn,il,dl,ll,ce,At,cl,Xn,pl,ml,St,hl,Yn,ul,fl,_l,Xe,Ft,gl,Ct,kl,Jn,bl,vl,Tl,Ye,Ot,yl,Kn,wl,Lr,ve,Je,Qn,Wt,zl,Zn,xl,Dr,A,jt,$l,Te,Pl,_o,ql,El,go,Bl,Ll,Dl,B,Rt,Il,er,Nl,Al,tr,Sl,Fl,Ut,Cl,ko,Ol,Wl,jl,Mt,Rl,or,Ul,Ml,Vl,Vt,nr,Gl,Hl,Gt,Xl,rr,Yl,Jl,Kl,R,Ql,bo,Zl,ec,sr,tc,oc,ar,nc,rc,ir,sc,ac,ic,Ke,dc,C,Ht,lc,dr,cc,pc,lr,mc,hc,Xt,uc,vo,fc,_c,gc,Qe,kc,pe,Yt,bc,ye,vc,cr,Tc,yc,pr,wc,zc,xc,mr,$c,Ir,we,Ze,hr,Jt,Pc,ur,qc,Nr,ze,Kt,Ec,xe,Bc,fr,Lc,Dc,et,Ic,_r,Nc,Ac,Sc,Ar,$e,Qt,Fc,gr,Cc,Sr,Pe,Zt,Oc,kr,Wc,Fr;return c=new _s({}),st=new _s({}),at=new q({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
The maximum length (in number of tokens) for the inputs to the transformer model. When the tokenizer is
loaded with <a href="/docs/transformers/pr_17931/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained">from_pretrained()</a>, this will be set to the
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17931/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L2429",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L3303",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L2652",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L3336",returnDescription:`
...
<p>**kwargs &#x2014; Passed along to the <code>.tokenize()</code> method.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L2239",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L2556",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
using the <a href="/docs/transformers/pr_17931/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained">save_pretrained()</a> method, e.g.,
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L3381",returnDescription:`
<p>1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p>A list of integers in the range [0, 1]</p>
`}}),zt=new q({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L1557",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
`}}),xt=new q({props:{name:"pad",anchor:"transformers.PreTrainedTokenizerBase.pad",parameters:[{name:"encoded_inputs",val:": typing.Union[transformers.tokenization_utils_base.BatchEncoding, typing.List[transformers.tokenization_utils_base.BatchEncoding], typing.Dict[str, typing.List[int]], typing.Dict[str, typing.List[typing.List[int]]], typing.List[typing.Dict[str, typing.List[int]]]]"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = True"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"verbose",val:": bool = True"}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.pad.encoded_inputs",description:`<strong>encoded_inputs</strong> (<a href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, list of <a href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <code>Dict[str, List[int]]</code>, <code>Dict[str, List[List[int]]</code> or <code>List[Dict[str, List[int]]]</code>) &#x2014;
Tokenized inputs. Can represent one input (<a href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> or <code>Dict[str, List[int]]</code>) or a batch of
tokenized inputs (list of <a href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <em>Dict[str, List[List[int]]]</em> or <em>List[Dict[str,
...
the note above for the return type.`,name:"encoded_inputs"},{anchor:"transformers.PreTrainedTokenizerBase.pad.padding",description:`<strong>padding</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17931/en/internal/file_utils#transformers.utils.PaddingStrategy">PaddingStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L2956",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_17931/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_17931/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Activates and controls truncation. Accepts the following values:</p>
<ul>
<li><code>True</code> or <code>&apos;longest_first&apos;</code>: Truncate to a maximum length specified with the argument <code>max_length</code> or
to the maximum acceptable input length for the model if that argument is not provided. This will
...
</ul>`,name:"truncation"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L3491",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17931/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<code>repo_url</code> is not specified.`,name:"use_auth_token"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/utils/hub.py#L855",returnDescription:`
...
folder. Pass along <code>temp_dir=True</code> to use a temporary directory instead.</p>
					...
					</div>`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L2038",returnDescription:`
<p>The files saved.</p>
`,returnType:`
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L2201",returnDescription:`
...
<a href="/docs/transformers/pr_17931/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L2219",returnDescription:`
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L3092",returnDescription:`
...
assign the index of the <code>unk_token</code> to them).`,name:"special_tokens_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17931/src/transformers/tokenization_utils_base.py#L844",returnDescription:`
...
(string).`),Xs=d(),S=r("li"),Mo=r("strong"),Ys=o("pretrained_vocab_files_map"),Js=o(" ("),Vo=r("code"),Ks=o("Dict[str, Dict[str, str]]"),Qs=o(`) \u2014 A dictionary of dictionaries, with the
...
Should be `),dn=r("code"),Aa=o("'right'"),Sa=o(" or "),ln=r("code"),Fa=o("'left'"),Ca=o("."),Oa=d(),G=r("li"),cn=r("strong"),Wa=o("truncation_side"),ja=o(" ("),pn=r("code"),Ra=o("str"),Ua=o(`) \u2014 The default value for the side on which the model should have truncation
...
`),Sn=r("code"),Td=o("self.pad_token_id"),yd=o(" and "),Fn=r("code"),wd=o("self.pad_token_type_id"),zd=o(")"),xd=d(),k(Ue.$$.fragment),$d=d(),Me=r("div"),k($t.$$.fragment),Pd=d(),j=r("p"),qd=o(`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
...
`),so=s(U,"A",{href:!0});var wr=a(so);ys=n(wr,"PreTrainedTokenizer"),wr.forEach(t),ws=n(U," and "),ao=s(U,"A",{href:!0});var zr=a(ao);zs=n(zr,"PreTrainedTokenizerFast"),zr.forEach(t),xs=n(U,` and the mixin
`),io=s(U,"A",{href:!0});var xr=a(io);$s=n(xr,"SpecialTokensMixin"),xr.forEach(t),Ps=n(U,"."),U.forEach(t),qr=l(i),lo=s(i,"P",{});var Rc=a(lo);qs=n(Rc,"Most of those are only useful if you are studying the code of the tokenizers in the library."),Rc.forEach(t),Er=l(i),ge=s(i,"H2",{class:!0});var Cr=a(ge);Le=s(Cr,"A",{id:!0,class:!0,href:!0});var Uc=a(Le);Fo=s(Uc,"SPAN",{});var Mc=a(Fo);b(st.$$.fragment,Mc),Mc.forEach(t),Uc.forEach(t),Es=l(Cr),Co=s(Cr,"SPAN",{});var Vc=a(Co);Bs=n(Vc,"PreTrainedTokenizerBase"),Vc.forEach(t),Cr.forEach(t),Br=l(i),u=s(i,"DIV",{class:!0});var g=a(u);b(at.$$.fragment,g),Ls=l(g),ke=s(g,"P",{});var To=a(ke);Ds=n(To,"Base class for "),co=s(To,"A",{href:!0});var Gc=a(co);Is=n(Gc,"PreTrainedTokenizer"),Gc.forEach(t),Ns=n(To," and "),po=s(To,"A",{href:!0});var Hc=a(po);As=n(Hc,"PreTrainedTokenizerFast"),Hc.forEach(t),Ss=n(To,"."),To.forEach(t),Fs=l(g),Oo=s(g,"P",{});var Xc=a(Oo);Cs=n(Xc,"Handles shared (mostly boiler plate) methods for those two classes."),Xc.forEach(t),Os=l(g),Wo=s(g,"P",{});var Yc=a(Wo);Ws=n(Yc,"Class attributes (overridden by derived classes)"),Yc.forEach(t),js=l(g),I=s(g,"UL",{});var O=a(I);Z=s(O,"LI",{});var to=a(Z);jo=s(to,"STRONG",{});var Jc=a(jo);Rs=n(Jc,"vocab_files_names"),Jc.forEach(t),Us=n(to," ("),Ro=s(to,"CODE",{});var Kc=a(Ro);Ms=n(Kc,"Dict[str, str]"),Kc.forEach(t),Vs=n(to,") \u2014 A dictionary with, as keys, the "),Uo=s(to,"CODE",{});var Qc=a(Uo);Gs=n(Qc,"__init__"),Qc.forEach(t),Hs=n(to,` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),to.forEach(t),Xs=l(O),S=s(O,"LI",{});var K=a(S);Mo=s(K,"STRONG",{});var Zc=a(Mo);Ys=n(Zc,"pretrained_vocab_files_map"),Zc.forEach(t),Js=n(K," ("),Vo=s(K,"CODE",{});var ep=a(Vo);Ks=n(ep,"Dict[str, Dict[str, str]]"),ep.forEach(t),Qs=n(K,`) \u2014 A dictionary of dictionaries, with the
...
often want to remove sub-word tokenization artifacts at the same time.`),Mr.forEach(t),Ur.forEach(t),vi=l(g),oe=s(g,"DIV",{class:!0});var zo=a(oe);b(ft.$$.fragment,zo),Ti=l(zo),ho=s(zo,"P",{});var jc=a(ho);yi=n(jc,"Create the token type IDs corresponding to the sequences passed. "),uo=s(jc,"A",{href:!0});var Lp=a(uo);wi=n(Lp,`What are token type
