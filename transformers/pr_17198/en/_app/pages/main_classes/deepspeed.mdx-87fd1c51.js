...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),bp=new y({}),{c(){w=o("meta"),C=u(),b=o("h1"),k=o("a"),ee=o("span"),f(z.$$.fragment),x=u(),se=o("span"),R=a("DeepSpeed Integration"),ae=u(),S=o("p"),E=o("a"),q=a("DeepSpeed"),Es=a(" implements everything described in the "),V=o("a"),qs=a("ZeRO paper"),L$=a(". Currently it provides full support for:"),Bj=u(),I=o("ol"),tf=o("li"),M$=a("Optimizer state partitioning (ZeRO stage 1)"),Z$=u(),af=o("li"),N$=a("Gradient partitioning (ZeRO stage 2)"),H$=u(),nf=o("li"),B$=a("Parameter partitioning (ZeRO stage 3)"),W$=u(),of=o("li"),F$=a("Custom mixed precision training handling"),V$=u(),lf=o("li"),Y$=a("A range of fast CUDA-extension-based optimizers"),K$=u(),rf=o("li"),J$=a("ZeRO-Offload to CPU and NVMe"),Wj=u(),Se=o("p"),X$=a("ZeRO-Offload has its own dedicated paper: "),ao=o("a"),Q$=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),e4=a(". And NVMe-support is described in the paper "),no=o("a"),s4=a(`ZeRO-Infinity: Breaking the GPU
...
won\u2019t be possible on a single GPU.`),Yj=u(),qt=o("p"),o4=a("\u{1F917} Transformers integrates "),oo=o("a"),l4=a("DeepSpeed"),r4=a(" via 2 options:"),Kj=u(),$t=o("ol"),lo=o("li"),p4=a("Integration of the core DeepSpeed features via "),Lp=o("a"),i4=a("Trainer"),u4=a(`. This is an everything-done-for-you type
...
yourself, core functionality functions like `),pf=o("code"),m4=a("from_pretrained"),_4=a(" and "),uf=o("code"),v4=a("from_config"),j4=a(` include integration of essential
parts of DeepSpeed like `),cf=o("code"),g4=a("zero.Init"),y4=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=o("a"),w4=a("deepspeed-non-trainer-integration"),b4=a("."),Jj=u(),Np=o("p"),E4=a("What is integrated:"),Xj=u(),Hp=o("p"),q4=a("Training:"),Qj=u(),Bp=o("ol"),hf=o("li"),$4=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),eg=u(),Wp=o("p"),k4=a("Inference:"),sg=u(),Fp=o("ol"),ro=o("li"),P4=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
...
ZeRO (coming soon).`),ag=u(),Kp=o("a"),ng=u(),$s=o("h2"),kt=o("a"),ff=o("span"),f(po.$$.fragment),T4=u(),df=o("span"),A4=a("Trainer Deepspeed Integration"),og=u(),Jp=o("a"),lg=u(),ks=o("h3"),Pt=o("a"),mf=o("span"),f(io.$$.fragment),S4=u(),_f=o("span"),C4=a("Installation"),rg=u(),Xp=o("p"),x4=a("Install the library via pypi:"),pg=u(),f(uo.$$.fragment),ig=u(),Ce=o("p"),R4=a("or via "),vf=o("code"),I4=a("transformers"),U4=a("\u2019 "),jf=o("code"),G4=a("extras"),L4=a(":"),ug=u(),f(co.$$.fragment),cg=u(),xe=o("p"),M4=a("or find more details on "),ho=o("a"),Z4=a("the DeepSpeed\u2019s GitHub page"),N4=a(` and
`),fo=o("a"),H4=a("advanced install"),B4=a("."),hg=u(),Dt=o("p"),W4=a("If you\u2019re still struggling with the build, first make sure to read "),Qp=o("a"),F4=a("zero-install-notes"),V4=a("."),fg=u(),ei=o("p"),Y4=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),dg=u(),si=o("p"),K4=a("To make a local build for DeepSpeed:"),mg=u(),f(mo.$$.fragment),_g=u(),Re=o("p"),J4=a("If you intend to use NVMe offload you will also need to include "),gf=o("code"),X4=a("DS_BUILD_AIO=1"),Q4=a(` in the instructions above (and also
install `),yf=o("em"),e6=a("libaio-dev"),s6=a(" system-wide)."),vg=u(),zt=o("p"),t6=a("Edit "),wf=o("code"),a6=a("TORCH_CUDA_ARCH_LIST"),n6=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
of them like so `),qf=o("code"),u6=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),yg=u(),ti=o("p"),c6=a("If you need to use the same setup on multiple machines, make a binary wheel:"),wg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h6=a("it will generate something like "),$f=o("code"),f6=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d6=a(` which now you can install
as `),kf=o("code"),m6=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_6=a(" locally or on any other machine."),Eg=u(),Ot=o("p"),v6=a("Again, remember to ensure to adjust "),Pf=o("code"),j6=a("TORCH_CUDA_ARCH_LIST"),g6=a(" to the target architectures."),qg=u(),Ue=o("p"),y6=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Df=o("strong"),w6=a("Compute Capabilities"),b6=a(` (same as arch in this
context) `),jo=o("a"),E6=a("here"),q6=a("."),$g=u(),ai=o("p"),$6=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k6=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(yo.$$.fragment),zg=u(),oi=o("p"),P6=a("If the output is:"),Og=u(),f(wo.$$.fragment),Tg=u(),Tt=o("p"),D6=a("then you know that this card\u2019s arch is "),zf=o("code"),z6=a("8.6"),O6=a("."),Ag=u(),At=o("p"),T6=a("You can also leave "),Of=o("code"),A6=a("TORCH_CUDA_ARCH_LIST"),S6=a(` out completely and then the build program will automatically query the
...
bigger models and data batches.`),sy=u(),fi=o("p"),H5=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),ty=u(),f(So.$$.fragment),ay=u(),di=o("p"),B5=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),ny=u(),Nt=o("p"),W5=a("For a practical usage example of this type of deployment, please, see this "),Co=o("a"),F5=a("post"),V5=a("."),oy=u(),mi=o("p"),Y5=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),ly=u(),_i=o("p"),K5=a("Notes:"),ry=u(),vi=o("ul"),Os=o("li"),xo=o("p"),J5=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=o("code"),X5=a("CUDA_VISIBLE_DEVICES"),Q5=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),e8=u(),f(Ro.$$.fragment),s8=u(),Xf=o("p"),t8=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),py=u(),ji=o("a"),iy=u(),Ts=o("h3"),Ht=o("a"),Qf=o("span"),f(Io.$$.fragment),a8=u(),ed=o("span"),n8=a("Deployment in Notebooks"),uy=u(),Bt=o("p"),o8=a("The problem with running notebook cells as a script is that there is no normal "),sd=o("code"),l8=a("deepspeed"),r8=a(` launcher to rely on, so
under certain setups we have to emulate it.`),cy=u(),gi=o("p"),p8=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),hy=u(),f(Uo.$$.fragment),fy=u(),Wt=o("p"),i8=a("Note: "),td=o("code"),u8=a("..."),c8=a(" stands for the normal arguments that you\u2019d pass to the functions."),dy=u(),yi=o("p"),h8=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),my=u(),wi=o("p"),f8=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),_y=u(),f(Go.$$.fragment),vy=u(),Le=o("p"),d8=a("If the training script is in a normal file and not in the notebook cells, you can launch "),ad=o("code"),m8=a("deepspeed"),_8=a(` normally via
shell from a cell. For example, to use `),nd=o("code"),v8=a("run_translation.py"),j8=a(" you would launch it with:"),jy=u(),f(Lo.$$.fragment),gy=u(),Ft=o("p"),g8=a("or with "),od=o("code"),y8=a("%%bash"),w8=a(" magic, where you can write a multi-line code for the shell program to run:"),yy=u(),f(Mo.$$.fragment),wy=u(),bi=o("p"),b8=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),by=u(),Vt=o("p"),E8=a("Note: While "),ld=o("code"),q8=a("%%bash"),$8=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Ey=u(),Ei=o("a"),qy=u(),As=o("h3"),Yt=o("a"),rd=o("span"),f(Zo.$$.fragment),k8=u(),pd=o("span"),P8=a("Configuration"),$y=u(),Kt=o("p"),D8=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=o("a"),z8=a("following documentation"),O8=a("."),ky=u(),Jt=o("p"),T8=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=o("a"),A8=a(`the DeepSpeedExamples
repo`),S8=a(":"),Py=u(),f(Bo.$$.fragment),Dy=u(),Xt=o("p"),C8=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),id=o("code"),x8=a(".json"),R8=a(" files with:"),zy=u(),f(Wo.$$.fragment),Oy=u(),Qt=o("p"),I8=a("Some more examples are to be found in the "),Fo=o("a"),U8=a("main repo"),G8=a(" as well."),Ty=u(),qi=o("p"),L8=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),Ay=u(),oe=o("p"),M8=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
...
precision training if `),hd=o("code"),W8=a("--fp16"),F8=a(" is passed:"),Sy=u(),f(Vo.$$.fragment),Cy=u(),ea=o("p"),V8=a("When you execute the program, DeepSpeed will log the configuration it received from the "),$i=o("a"),Y8=a("Trainer"),K8=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),xy=u(),ki=o("a"),Ry=u(),Ss=o("h3"),sa=o("a"),fd=o("span"),f(Yo.$$.fragment),J8=u(),dd=o("span"),X8=a("Passing Configuration"),Iy=u(),G=o("p"),Q8=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),Pi=o("a"),e7=a("Trainer"),s7=a(" via "),Di=o("a"),t7=a("TrainingArguments"),a7=a(" then for the "),md=o("code"),n7=a("deepspeed"),o7=a(` argument you can
pass a nested `),_d=o("code"),l7=a("dict"),r7=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=o("a"),p7=a("TrainingArguments"),i7=a("."),Uy=u(),Oi=o("p"),u7=a("To summarize you can do:"),Gy=u(),f(Ko.$$.fragment),Ly=u(),Ti=o("p"),c7=a("or:"),My=u(),f(Jo.$$.fragment),Zy=u(),Ai=o("a"),Ny=u(),Cs=o("h3"),ta=o("a"),vd=o("span"),f(Xo.$$.fragment),h7=u(),jd=o("span"),f7=a("Shared Configuration"),Hy=u(),f(aa.$$.fragment),By=u(),Me=o("p"),d7=a("Some configuration values are required by both the "),Si=o("a"),m7=a("Trainer"),_7=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=o("a"),v7=a("Trainer"),j7=a(" command line arguments."),Wy=u(),na=o("p"),g7=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=o("a"),y7=a("Trainer"),w7=a(` do the majority
of configuration for you.`),Fy=u(),Ze=o("p"),b7=a("Therefore, in the rest of this guide you will find a special configuration value: "),gd=o("code"),E7=a("auto"),q7=a(`, which when set will be
...
`),Ri=o("a"),$7=a("Trainer"),k7=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),Vy=u(),Ii=o("p"),P7=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Yy=u(),oa=o("p"),D7=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=o("a"),z7=a("TrainingArguments"),O7=a(" based on that. The steps are:"),Ky=u(),la=o("ol"),yd=o("li"),T7=a("Create or load the DeepSpeed configuration to be used as a master configuration"),A7=u(),Qo=o("li"),S7=a("Create the "),Gi=o("a"),C7=a("TrainingArguments"),x7=a(" object based on these values"),Jy=u(),le=o("p"),R7=a("Do note that some values, such as "),wd=o("code"),I7=a("scheduler.params.total_num_steps"),U7=a(` are calculated by
`),Li=o("a"),G7=a("Trainer"),L7=a(" during "),bd=o("code"),M7=a("train"),Z7=a(", but you can of course do the math yourself."),Xy=u(),Mi=o("a"),Qy=u(),xs=o("h3"),ra=o("a"),Ed=o("span"),f(el.$$.fragment),N7=u(),qd=o("span"),H7=a("ZeRO"),ew=u(),sl=o("p"),tl=o("a"),B7=a("Zero Redundancy Optimizer (ZeRO)"),W7=a(` is the workhorse of DeepSpeed. It
...
You will find more indepth information in the DeepSpeed documentation.`),sw=u(),Ne=o("p"),F7=a("The "),$d=o("code"),V7=a("zero_optimization"),Y7=a(" section of the configuration file is the most important part ("),al=o("a"),K7=a("docs"),J7=a(`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),tw=u(),pa=o("p"),X7=a("This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=o("a"),Q7=a("Trainer"),e9=a(` provides
no equivalent command line arguments.`),aw=u(),Ni=o("p"),s9=a(`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),nw=u(),Hi=o("a"),ow=u(),Rs=o("h4"),ia=o("a"),kd=o("span"),f(nl.$$.fragment),t9=u(),Pd=o("span"),a9=a("ZeRO-2 Config"),lw=u(),Bi=o("p"),n9=a("The following is an example of configuration for ZeRO stage 2:"),rw=u(),f(ol.$$.fragment),pw=u(),Wi=o("p"),Dd=o("strong"),o9=a("Performance tuning:"),iw=u(),He=o("ul"),Is=o("li"),l9=a("enabling "),zd=o("code"),r9=a("offload_optimizer"),p9=a(" should reduce GPU RAM usage (it requires "),Od=o("code"),i9=a('"stage": 2'),u9=a(")"),c9=u(),L=o("li"),Td=o("code"),h9=a('"overlap_comm": true'),f9=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=o("code"),d9=a("overlap_comm"),m9=a(` uses 4.5x
the `),Sd=o("code"),_9=a("allgather_bucket_size"),v9=a(" and "),Cd=o("code"),j9=a("reduce_bucket_size"),g9=a(` values. So if they are set to 5e8, this requires a 9GB
footprint (`),xd=o("code"),y9=a("5e8 x 2Bytes x 2 x 4.5"),w9=a(`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),Rd=o("code"),b9=a("2e8"),E9=a(`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),q9=u(),Id=o("li"),$9=a(`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),uw=u(),Be=o("p"),k9=a("Additionally, "),Ud=o("code"),P9=a("deepspeed==0.4.4"),D9=a(" added a new option "),Gd=o("code"),z9=a("round_robin_gradients"),O9=a(" which you can enable with:"),cw=u(),f(ll.$$.fragment),hw=u(),Fi=o("p"),T9=a("This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),fw=u(),Vi=o("a"),dw=u(),Us=o("h4"),ua=o("a"),Ld=o("span"),f(rl.$$.fragment),A9=u(),Md=o("span"),S9=a("ZeRO-3 Config"),mw=u(),Yi=o("p"),C9=a("The following is an example of configuration for ZeRO stage 3:"),_w=u(),f(pl.$$.fragment),vw=u(),K=o("p"),x9=a(`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Zd=o("code"),R9=a('"device": "cpu"'),I9=a(` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Nd=o("code"),U9=a("none"),G9=a(" instead of "),Hd=o("code"),L9=a("cpu"),M9=a(" for the "),Bd=o("code"),Z9=a("device"),N9=a(` entry. Offloading to
NVMe is discussed further down.`),jw=u(),We=o("p"),H9=a("Pinned memory is enabled with "),Wd=o("code"),B9=a("pin_memory"),W9=a(" set to "),Fd=o("code"),F9=a("true"),V9=a(`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),gw=u(),Ki=o("p"),Vd=o("strong"),Y9=a("Performance tuning:"),yw=u(),ca=o("ul"),il=o("li"),Yd=o("code"),K9=a("stage3_max_live_parameters"),J9=a(": "),Kd=o("code"),X9=a("1e9"),Q9=u(),ul=o("li"),Jd=o("code"),ek=a("stage3_max_reuse_distance"),sk=a(": "),Xd=o("code"),tk=a("1e9"),ww=u(),M=o("p"),ak=a("If hitting OOM reduce "),Qd=o("code"),nk=a("stage3_max_live_parameters"),ok=a(" and "),em=o("code"),lk=a("stage3_max_reuse_distance"),rk=a(`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),sm=o("code"),pk=a("1e9"),ik=a(` would consume ~2GB. The memory is shared by
`),tm=o("code"),uk=a("stage3_max_live_parameters"),ck=a(" and "),am=o("code"),hk=a("stage3_max_reuse_distance"),fk=a(", so it\u2019s not additive, it\u2019s just 2GB total."),bw=u(),ze=o("p"),nm=o("code"),dk=a("stage3_max_live_parameters"),mk=a(` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),om=o("code"),_k=a("stage3_max_reuse_distance"),vk=a(` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),lm=o("code"),jk=a("stage3_max_reuse_distance"),gk=a(`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Ew=u(),Ji=o("p"),yk=a("The following configuration values depend on the model\u2019s hidden size:"),qw=u(),Fe=o("ul"),cl=o("li"),rm=o("code"),wk=a("reduce_bucket_size"),bk=a(": "),pm=o("code"),Ek=a("hidden_size*hidden_size"),qk=u(),hl=o("li"),im=o("code"),$k=a("stage3_prefetch_bucket_size"),kk=a(": "),um=o("code"),Pk=a("0.9 * hidden_size * hidden_size"),Dk=u(),fl=o("li"),cm=o("code"),zk=a("stage3_param_persistence_threshold"),Ok=a(": "),hm=o("code"),Tk=a("10 * hidden_size"),$w=u(),Ve=o("p"),Ak=a("therefore set these values to "),fm=o("code"),Sk=a("auto"),Ck=a(" and the "),Xi=o("a"),xk=a("Trainer"),Rk=a(` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),kw=u(),dl=o("p"),dm=o("code"),Ik=a("stage3_gather_16bit_weights_on_model_save"),Uk=a(` enables model fp16 weights consolidation when model gets saved. With large
...
flexible.`),Pw=u(),re=o("p"),Gk=a("If you\u2019re migrating from ZeRO-2 configuration note that "),mm=o("code"),Lk=a("allgather_partitions"),Mk=a(", "),_m=o("code"),Zk=a("allgather_bucket_size"),Nk=a(` and
`),vm=o("code"),Hk=a("reduce_scatter"),Bk=a(` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Dw=u(),Qi=o("ul"),ml=o("li"),jm=o("code"),Wk=a("sub_group_size"),Fk=a(": "),gm=o("code"),Vk=a("1e9"),zw=u(),Oe=o("p"),ym=o("code"),Yk=a("sub_group_size"),Kk=a(` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),wm=o("code"),Jk=a("sub_group_size"),Xk=a(` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),bm=o("code"),Qk=a("sub_group_size"),eP=a(` therefore controls the granularity in which model states are moved in and out of CPU
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),Op=o("a"),jG=a("DeepSpeed GitHub"),gG=a("."),this.h()},l(e){const p=ZK('[data-svelte="svelte-1phssyn"]',document.head);w=l(p,"META",{name:!0,content:!0}),p.forEach(t),C=c(e),b=l(e,"H1",{class:!0});var Tp=r(b);k=l(Tp,"A",{id:!0,class:!0,href:!0});var Gj=r(k);ee=l(Gj,"SPAN",{});var Lj=r(ee);d(z.$$.fragment,Lj),Lj.forEach(t),Gj.forEach(t),x=c(Tp),se=l(Tp,"SPAN",{});var kG=r(se);R=n(kG,"DeepSpeed Integration"),kG.forEach(t),Tp.forEach(t),ae=c(e),S=l(e,"P",{});var Mj=r(S);E=l(Mj,"A",{href:!0,rel:!0});var PG=r(E);q=n(PG,"DeepSpeed"),PG.forEach(t),Es=n(Mj," implements everything described in the "),V=l(Mj,"A",{href:!0,rel:!0});var DG=r(V);qs=n(DG,"ZeRO paper"),DG.forEach(t),L$=n(Mj,". Currently it provides full support for:"),Mj.forEach(t),Bj=c(e),I=l(e,"OL",{});var je=r(I);tf=l(je,"LI",{});var zG=r(tf);M$=n(zG,"Optimizer state partitioning (ZeRO stage 1)"),zG.forEach(t),Z$=c(je),af=l(je,"LI",{});var OG=r(af);N$=n(OG,"Gradient partitioning (ZeRO stage 2)"),OG.forEach(t),H$=c(je),nf=l(je,"LI",{});var TG=r(nf);B$=n(TG,"Parameter partitioning (ZeRO stage 3)"),TG.forEach(t),W$=c(je),of=l(je,"LI",{});var AG=r(of);F$=n(AG,"Custom mixed precision training handling"),AG.forEach(t),V$=c(je),lf=l(je,"LI",{});var SG=r(lf);Y$=n(SG,"A range of fast CUDA-extension-based optimizers"),SG.forEach(t),K$=c(je),rf=l(je,"LI",{});var CG=r(rf);J$=n(CG,"ZeRO-Offload to CPU and NVMe"),CG.forEach(t),je.forEach(t),Wj=c(e),Se=l(e,"P",{});var rh=r(Se);X$=n(rh,"ZeRO-Offload has its own dedicated paper: "),ao=l(rh,"A",{href:!0,rel:!0});var xG=r(ao);Q$=n(xG,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),xG.forEach(t),e4=n(rh,". And NVMe-support is described in the paper "),no=l(rh,"A",{href:!0,rel:!0});var RG=r(no);s4=n(RG,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),RG.forEach(t),t4=n(rh,"."),rh.forEach(t),Fj=c(e),Up=l(e,"P",{});var IG=r(Up);a4=n(IG,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),IG.forEach(t),Vj=c(e),Gp=l(e,"P",{});var UG=r(Gp);n4=n(UG,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),UG.forEach(t),Yj=c(e),qt=l(e,"P",{});var nE=r(qt);o4=n(nE,"\u{1F917} Transformers integrates "),oo=l(nE,"A",{href:!0,rel:!0});var GG=r(oo);l4=n(GG,"DeepSpeed"),GG.forEach(t),r4=n(nE," via 2 options:"),nE.forEach(t),Kj=c(e),$t=l(e,"OL",{});var oE=r($t);lo=l(oE,"LI",{});var lE=r(lo);p4=n(lE,"Integration of the core DeepSpeed features via "),Lp=l(lE,"A",{href:!0});var LG=r(Lp);i4=n(LG,"Trainer"),LG.forEach(t),u4=n(lE,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),lE.forEach(t),c4=c(oE),Y=l(oE,"LI",{});var ge=r(Y);h4=n(ge,"If you don\u2019t use "),Mp=l(ge,"A",{href:!0});var MG=r(Mp);f4=n(MG,"Trainer"),MG.forEach(t),d4=n(ge,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),pf=l(ge,"CODE",{});var ZG=r(pf);m4=n(ZG,"from_pretrained"),ZG.forEach(t),_4=n(ge," and "),uf=l(ge,"CODE",{});var NG=r(uf);v4=n(NG,"from_config"),NG.forEach(t),j4=n(ge,` include integration of essential
parts of DeepSpeed like `),cf=l(ge,"CODE",{});var HG=r(cf);g4=n(HG,"zero.Init"),HG.forEach(t),y4=n(ge,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Zp=l(ge,"A",{href:!0});var BG=r(Zp);w4=n(BG,"deepspeed-non-trainer-integration"),BG.forEach(t),b4=n(ge,"."),ge.forEach(t),oE.forEach(t),Jj=c(e),Np=l(e,"P",{});var WG=r(Np);E4=n(WG,"What is integrated:"),WG.forEach(t),Xj=c(e),Hp=l(e,"P",{});var FG=r(Hp);q4=n(FG,"Training:"),FG.forEach(t),Qj=c(e),Bp=l(e,"OL",{});var VG=r(Bp);hf=l(VG,"LI",{});var YG=r(hf);$4=n(YG,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),YG.forEach(t),VG.forEach(t),eg=c(e),Wp=l(e,"P",{});var KG=r(Wp);k4=n(KG,"Inference:"),KG.forEach(t),sg=c(e),Fp=l(e,"OL",{});var JG=r(Fp);ro=l(JG,"LI",{});var rE=r(ro);P4=n(rE,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Vp=l(rE,"A",{href:!0});var XG=r(Vp);D4=n(XG,"deepspeed-zero-inference"),XG.forEach(t),z4=n(rE,"."),rE.forEach(t),JG.forEach(t),tg=c(e),Yp=l(e,"P",{});var QG=r(Yp);O4=n(QG,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),QG.forEach(t),ag=c(e),Kp=l(e,"A",{id:!0}),r(Kp).forEach(t),ng=c(e),$s=l(e,"H2",{class:!0});var pE=r($s);kt=l(pE,"A",{id:!0,class:!0,href:!0});var eL=r(kt);ff=l(eL,"SPAN",{});var sL=r(ff);d(po.$$.fragment,sL),sL.forEach(t),eL.forEach(t),T4=c(pE),df=l(pE,"SPAN",{});var tL=r(df);A4=n(tL,"Trainer Deepspeed Integration"),tL.forEach(t),pE.forEach(t),og=c(e),Jp=l(e,"A",{id:!0}),r(Jp).forEach(t),lg=c(e),ks=l(e,"H3",{class:!0});var iE=r(ks);Pt=l(iE,"A",{id:!0,class:!0,href:!0});var aL=r(Pt);mf=l(aL,"SPAN",{});var nL=r(mf);d(io.$$.fragment,nL),nL.forEach(t),aL.forEach(t),S4=c(iE),_f=l(iE,"SPAN",{});var oL=r(_f);C4=n(oL,"Installation"),oL.forEach(t),iE.forEach(t),rg=c(e),Xp=l(e,"P",{});var lL=r(Xp);x4=n(lL,"Install the library via pypi:"),lL.forEach(t),pg=c(e),d(uo.$$.fragment,e),ig=c(e),Ce=l(e,"P",{});var ph=r(Ce);R4=n(ph,"or via "),vf=l(ph,"CODE",{});var rL=r(vf);I4=n(rL,"transformers"),rL.forEach(t),U4=n(ph,"\u2019 "),jf=l(ph,"CODE",{});var pL=r(jf);G4=n(pL,"extras"),pL.forEach(t),L4=n(ph,":"),ph.forEach(t),ug=c(e),d(co.$$.fragment,e),cg=c(e),xe=l(e,"P",{});var ih=r(xe);M4=n(ih,"or find more details on "),ho=l(ih,"A",{href:!0,rel:!0});var iL=r(ho);Z4=n(iL,"the DeepSpeed\u2019s GitHub page"),iL.forEach(t),N4=n(ih,` and
`),fo=l(ih,"A",{href:!0,rel:!0});var uL=r(fo);H4=n(uL,"advanced install"),uL.forEach(t),B4=n(ih,"."),ih.forEach(t),hg=c(e),Dt=l(e,"P",{});var uE=r(Dt);W4=n(uE,"If you\u2019re still struggling with the build, first make sure to read "),Qp=l(uE,"A",{href:!0});var cL=r(Qp);F4=n(cL,"zero-install-notes"),cL.forEach(t),V4=n(uE,"."),uE.forEach(t),fg=c(e),ei=l(e,"P",{});var hL=r(ei);Y4=n(hL,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),hL.forEach(t),dg=c(e),si=l(e,"P",{});var fL=r(si);K4=n(fL,"To make a local build for DeepSpeed:"),fL.forEach(t),mg=c(e),d(mo.$$.fragment,e),_g=c(e),Re=l(e,"P",{});var uh=r(Re);J4=n(uh,"If you intend to use NVMe offload you will also need to include "),gf=l(uh,"CODE",{});var dL=r(gf);X4=n(dL,"DS_BUILD_AIO=1"),dL.forEach(t),Q4=n(uh,` in the instructions above (and also
install `),yf=l(uh,"EM",{});var mL=r(yf);e6=n(mL,"libaio-dev"),mL.forEach(t),s6=n(uh," system-wide)."),uh.forEach(t),vg=c(e),zt=l(e,"P",{});var cE=r(zt);t6=n(cE,"Edit "),wf=l(cE,"CODE",{});var _L=r(wf);a6=n(_L,"TORCH_CUDA_ARCH_LIST"),_L.forEach(t),n6=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
of them like so `),qf=l(Ap,"CODE",{});var gL=r(qf);u6=n(gL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),gL.forEach(t),Ap.forEach(t),yg=c(e),ti=l(e,"P",{});var yL=r(ti);c6=n(yL,"If you need to use the same setup on multiple machines, make a binary wheel:"),yL.forEach(t),wg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h6=n(ch,"it will generate something like "),$f=l(ch,"CODE",{});var wL=r($f);f6=n(wL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),wL.forEach(t),d6=n(ch,` which now you can install
as `),kf=l(ch,"CODE",{});var bL=r(kf);m6=n(bL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),bL.forEach(t),_6=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),Ot=l(e,"P",{});var hE=r(Ot);v6=n(hE,"Again, remember to ensure to adjust "),Pf=l(hE,"CODE",{});var EL=r(Pf);j6=n(EL,"TORCH_CUDA_ARCH_LIST"),EL.forEach(t),g6=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);y6=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Df=l(hh,"STRONG",{});var qL=r(Df);w6=n(qL,"Compute Capabilities"),qL.forEach(t),b6=n(hh,` (same as arch in this
...
documented `),qo=l(Mn,"A",{href:!0,rel:!0});var LL=r(qo);Q6=n(LL,"here"),LL.forEach(t),e5=n(Mn,". The file naming is up to you."),Mn.forEach(t),jE.forEach(t),Ug=c(e),pi=l(e,"P",{});var ML=r(pi);s5=n(ML,"Therefore, if your original command line looked as follows:"),ML.forEach(t),Gg=c(e),d($o.$$.fragment,e),Lg=c(e),ii=l(e,"P",{});var ZL=r(ii);t5=n(ZL,"Now it should be:"),ZL.forEach(t),Mg=c(e),d(ko.$$.fragment,e),Zg=c(e),U=l(e,"P",{});var ye=r(U);a5=n(ye,"Unlike, "),If=l(ye,"CODE",{});var NL=r(If);n5=n(NL,"torch.distributed.launch"),NL.forEach(t),o5=n(ye," where you have to specify how many GPUs to use with "),Uf=l(ye,"CODE",{});var HL=r(Uf);l5=n(HL,"--nproc_per_node"),HL.forEach(t),r5=n(ye,`, with the
`),Gf=l(ye,"CODE",{});var BL=r(Gf);p5=n(BL,"deepspeed"),BL.forEach(t),i5=n(ye," launcher you don\u2019t have to use the corresponding "),Lf=l(ye,"CODE",{});var WL=r(Lf);u5=n(WL,"--num_gpus"),WL.forEach(t),c5=n(ye,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),Po=l(ye,"A",{href:!0,rel:!0});var FL=r(Po);h5=n(FL,"here"),FL.forEach(t),f5=n(ye,"."),ye.forEach(t),Ng=c(e),ne=l(e,"P",{});var Zn=r(ne);d5=n(Zn,"In fact, you can continue using "),Mf=l(Zn,"CODE",{});var VL=r(Mf);m5=n(VL,"-m torch.distributed.launch"),VL.forEach(t),_5=n(Zn,` with DeepSpeed as long as you don\u2019t need to use
...
bigger models and data batches.`),pM.forEach(t),qE.forEach(t),sy=c(e),fi=l(e,"P",{});var iM=r(fi);H5=n(iM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),iM.forEach(t),ty=c(e),d(So.$$.fragment,e),ay=c(e),di=l(e,"P",{});var uM=r(di);B5=n(uM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),uM.forEach(t),ny=c(e),Nt=l(e,"P",{});var $E=r(Nt);W5=n($E,"For a practical usage example of this type of deployment, please, see this "),Co=l($E,"A",{href:!0,rel:!0});var cM=r(Co);F5=n(cM,"post"),cM.forEach(t),V5=n($E,"."),$E.forEach(t),oy=c(e),mi=l(e,"P",{});var hM=r(mi);Y5=n(hM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),hM.forEach(t),ly=c(e),_i=l(e,"P",{});var fM=r(_i);K5=n(fM,"Notes:"),fM.forEach(t),ry=c(e),vi=l(e,"UL",{});var dM=r(vi);Os=l(dM,"LI",{});var mh=r(Os);xo=l(mh,"P",{});var kE=r(xo);J5=n(kE,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Jf=l(kE,"CODE",{});var mM=r(Jf);X5=n(mM,"CUDA_VISIBLE_DEVICES"),mM.forEach(t),Q5=n(kE,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),kE.forEach(t),e8=c(mh),d(Ro.$$.fragment,mh),s8=c(mh),Xf=l(mh,"P",{});var _M=r(Xf);t8=n(_M,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),_M.forEach(t),mh.forEach(t),dM.forEach(t),py=c(e),ji=l(e,"A",{id:!0}),r(ji).forEach(t),iy=c(e),Ts=l(e,"H3",{class:!0});var PE=r(Ts);Ht=l(PE,"A",{id:!0,class:!0,href:!0});var vM=r(Ht);Qf=l(vM,"SPAN",{});var jM=r(Qf);d(Io.$$.fragment,jM),jM.forEach(t),vM.forEach(t),a8=c(PE),ed=l(PE,"SPAN",{});var gM=r(ed);n8=n(gM,"Deployment in Notebooks"),gM.forEach(t),PE.forEach(t),uy=c(e),Bt=l(e,"P",{});var DE=r(Bt);o8=n(DE,"The problem with running notebook cells as a script is that there is no normal "),sd=l(DE,"CODE",{});var yM=r(sd);l8=n(yM,"deepspeed"),yM.forEach(t),r8=n(DE,` launcher to rely on, so
under certain setups we have to emulate it.`),DE.forEach(t),cy=c(e),gi=l(e,"P",{});var wM=r(gi);p8=n(wM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),wM.forEach(t),hy=c(e),d(Uo.$$.fragment,e),fy=c(e),Wt=l(e,"P",{});var zE=r(Wt);i8=n(zE,"Note: "),td=l(zE,"CODE",{});var bM=r(td);u8=n(bM,"..."),bM.forEach(t),c8=n(zE," stands for the normal arguments that you\u2019d pass to the functions."),zE.forEach(t),dy=c(e),yi=l(e,"P",{});var EM=r(yi);h8=n(EM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),EM.forEach(t),my=c(e),wi=l(e,"P",{});var qM=r(wi);f8=n(qM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),qM.forEach(t),_y=c(e),d(Go.$$.fragment,e),vy=c(e),Le=l(e,"P",{});var _h=r(Le);d8=n(_h,"If the training script is in a normal file and not in the notebook cells, you can launch "),ad=l(_h,"CODE",{});var $M=r(ad);m8=n($M,"deepspeed"),$M.forEach(t),_8=n(_h,` normally via
shell from a cell. For example, to use `),nd=l(_h,"CODE",{});var kM=r(nd);v8=n(kM,"run_translation.py"),kM.forEach(t),j8=n(_h," you would launch it with:"),_h.forEach(t),jy=c(e),d(Lo.$$.fragment,e),gy=c(e),Ft=l(e,"P",{});var OE=r(Ft);g8=n(OE,"or with "),od=l(OE,"CODE",{});var PM=r(od);y8=n(PM,"%%bash"),PM.forEach(t),w8=n(OE," magic, where you can write a multi-line code for the shell program to run:"),OE.forEach(t),yy=c(e),d(Mo.$$.fragment,e),wy=c(e),bi=l(e,"P",{});var DM=r(bi);b8=n(DM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),DM.forEach(t),by=c(e),Vt=l(e,"P",{});var TE=r(Vt);E8=n(TE,"Note: While "),ld=l(TE,"CODE",{});var zM=r(ld);q8=n(zM,"%%bash"),zM.forEach(t),$8=n(TE,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),TE.forEach(t),Ey=c(e),Ei=l(e,"A",{id:!0}),r(Ei).forEach(t),qy=c(e),As=l(e,"H3",{class:!0});var AE=r(As);Yt=l(AE,"A",{id:!0,class:!0,href:!0});var OM=r(Yt);rd=l(OM,"SPAN",{});var TM=r(rd);d(Zo.$$.fragment,TM),TM.forEach(t),OM.forEach(t),k8=c(AE),pd=l(AE,"SPAN",{});var AM=r(pd);P8=n(AM,"Configuration"),AM.forEach(t),AE.forEach(t),$y=c(e),Kt=l(e,"P",{});var SE=r(Kt);D8=n(SE,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),No=l(SE,"A",{href:!0,rel:!0});var SM=r(No);z8=n(SM,"following documentation"),SM.forEach(t),O8=n(SE,"."),SE.forEach(t),ky=c(e),Jt=l(e,"P",{});var CE=r(Jt);T8=n(CE,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Ho=l(CE,"A",{href:!0,rel:!0});var CM=r(Ho);A8=n(CM,`the DeepSpeedExamples
repo`),CM.forEach(t),S8=n(CE,":"),CE.forEach(t),Py=c(e),d(Bo.$$.fragment,e),Dy=c(e),Xt=l(e,"P",{});var xE=r(Xt);C8=n(xE,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),id=l(xE,"CODE",{});var xM=r(id);x8=n(xM,".json"),xM.forEach(t),R8=n(xE," files with:"),xE.forEach(t),zy=c(e),d(Wo.$$.fragment,e),Oy=c(e),Qt=l(e,"P",{});var RE=r(Qt);I8=n(RE,"Some more examples are to be found in the "),Fo=l(RE,"A",{href:!0,rel:!0});var RM=r(Fo);U8=n(RM,"main repo"),RM.forEach(t),G8=n(RE," as well."),RE.forEach(t),Ty=c(e),qi=l(e,"P",{});var IM=r(qi);L8=n(IM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),IM.forEach(t),Ay=c(e),oe=l(e,"P",{});var Nn=r(oe);M8=n(Nn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
...
precision training if `),hd=l(Nn,"CODE",{});var LM=r(hd);W8=n(LM,"--fp16"),LM.forEach(t),F8=n(Nn," is passed:"),Nn.forEach(t),Sy=c(e),d(Vo.$$.fragment,e),Cy=c(e),ea=l(e,"P",{});var IE=r(ea);V8=n(IE,"When you execute the program, DeepSpeed will log the configuration it received from the "),$i=l(IE,"A",{href:!0});var MM=r($i);Y8=n(MM,"Trainer"),MM.forEach(t),K8=n(IE,`
to the console, so you can see exactly what was the final configuration passed to it.`),IE.forEach(t),xy=c(e),ki=l(e,"A",{id:!0}),r(ki).forEach(t),Ry=c(e),Ss=l(e,"H3",{class:!0});var UE=r(Ss);sa=l(UE,"A",{id:!0,class:!0,href:!0});var ZM=r(sa);fd=l(ZM,"SPAN",{});var NM=r(fd);d(Yo.$$.fragment,NM),NM.forEach(t),ZM.forEach(t),J8=c(UE),dd=l(UE,"SPAN",{});var HM=r(dd);X8=n(HM,"Passing Configuration"),HM.forEach(t),UE.forEach(t),Iy=c(e),G=l(e,"P",{});var we=r(G);Q8=n(we,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),Pi=l(we,"A",{href:!0});var BM=r(Pi);e7=n(BM,"Trainer"),BM.forEach(t),s7=n(we," via "),Di=l(we,"A",{href:!0});var WM=r(Di);t7=n(WM,"TrainingArguments"),WM.forEach(t),a7=n(we," then for the "),md=l(we,"CODE",{});var FM=r(md);n7=n(FM,"deepspeed"),FM.forEach(t),o7=n(we,` argument you can
pass a nested `),_d=l(we,"CODE",{});var VM=r(_d);l7=n(VM,"dict"),VM.forEach(t),r7=n(we,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),zi=l(we,"A",{href:!0});var YM=r(zi);p7=n(YM,"TrainingArguments"),YM.forEach(t),i7=n(we,"."),we.forEach(t),Uy=c(e),Oi=l(e,"P",{});var KM=r(Oi);u7=n(KM,"To summarize you can do:"),KM.forEach(t),Gy=c(e),d(Ko.$$.fragment,e),Ly=c(e),Ti=l(e,"P",{});var JM=r(Ti);c7=n(JM,"or:"),JM.forEach(t),My=c(e),d(Jo.$$.fragment,e),Zy=c(e),Ai=l(e,"A",{id:!0}),r(Ai).forEach(t),Ny=c(e),Cs=l(e,"H3",{class:!0});var GE=r(Cs);ta=l(GE,"A",{id:!0,class:!0,href:!0});var XM=r(ta);vd=l(XM,"SPAN",{});var QM=r(vd);d(Xo.$$.fragment,QM),QM.forEach(t),XM.forEach(t),h7=c(GE),jd=l(GE,"SPAN",{});var eZ=r(jd);f7=n(eZ,"Shared Configuration"),eZ.forEach(t),GE.forEach(t),Hy=c(e),d(aa.$$.fragment,e),By=c(e),Me=l(e,"P",{});var vh=r(Me);d7=n(vh,"Some configuration values are required by both the "),Si=l(vh,"A",{href:!0});var sZ=r(Si);m7=n(sZ,"Trainer"),sZ.forEach(t),_7=n(vh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),Ci=l(vh,"A",{href:!0});var tZ=r(Ci);v7=n(tZ,"Trainer"),tZ.forEach(t),j7=n(vh," command line arguments."),vh.forEach(t),Wy=c(e),na=l(e,"P",{});var LE=r(na);g7=n(LE,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),xi=l(LE,"A",{href:!0});var aZ=r(xi);y7=n(aZ,"Trainer"),aZ.forEach(t),w7=n(LE,` do the majority
of configuration for you.`),LE.forEach(t),Fy=c(e),Ze=l(e,"P",{});var jh=r(Ze);b7=n(jh,"Therefore, in the rest of this guide you will find a special configuration value: "),gd=l(jh,"CODE",{});var nZ=r(gd);E7=n(nZ,"auto"),nZ.forEach(t),q7=n(jh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),Ri=l(jh,"A",{href:!0});var oZ=r(Ri);$7=n(oZ,"Trainer"),oZ.forEach(t),k7=n(jh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),jh.forEach(t),Vy=c(e),Ii=l(e,"P",{});var lZ=r(Ii);P7=n(lZ,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),lZ.forEach(t),Yy=c(e),oa=l(e,"P",{});var ME=r(oa);D7=n(ME,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
and configure `),Ui=l(ME,"A",{href:!0});var rZ=r(Ui);z7=n(rZ,"TrainingArguments"),rZ.forEach(t),O7=n(ME," based on that. The steps are:"),ME.forEach(t),Ky=c(e),la=l(e,"OL",{});var ZE=r(la);yd=l(ZE,"LI",{});var pZ=r(yd);T7=n(pZ,"Create or load the DeepSpeed configuration to be used as a master configuration"),pZ.forEach(t),A7=c(ZE),Qo=l(ZE,"LI",{});var NE=r(Qo);S7=n(NE,"Create the "),Gi=l(NE,"A",{href:!0});var iZ=r(Gi);C7=n(iZ,"TrainingArguments"),iZ.forEach(t),x7=n(NE," object based on these values"),NE.forEach(t),ZE.forEach(t),Jy=c(e),le=l(e,"P",{});var Hn=r(le);R7=n(Hn,"Do note that some values, such as "),wd=l(Hn,"CODE",{});var uZ=r(wd);I7=n(uZ,"scheduler.params.total_num_steps"),uZ.forEach(t),U7=n(Hn,` are calculated by
`),Li=l(Hn,"A",{href:!0});var cZ=r(Li);G7=n(cZ,"Trainer"),cZ.forEach(t),L7=n(Hn," during "),bd=l(Hn,"CODE",{});var hZ=r(bd);M7=n(hZ,"train"),hZ.forEach(t),Z7=n(Hn,", but you can of course do the math yourself."),Hn.forEach(t),Xy=c(e),Mi=l(e,"A",{id:!0}),r(Mi).forEach(t),Qy=c(e),xs=l(e,"H3",{class:!0});var HE=r(xs);ra=l(HE,"A",{id:!0,class:!0,href:!0});var fZ=r(ra);Ed=l(fZ,"SPAN",{});var dZ=r(Ed);d(el.$$.fragment,dZ),dZ.forEach(t),fZ.forEach(t),N7=c(HE),qd=l(HE,"SPAN",{});var mZ=r(qd);H7=n(mZ,"ZeRO"),mZ.forEach(t),HE.forEach(t),ew=c(e),sl=l(e,"P",{});var yG=r(sl);tl=l(yG,"A",{href:!0,rel:!0});var _Z=r(tl);B7=n(_Z,"Zero Redundancy Optimizer (ZeRO)"),_Z.forEach(t),W7=n(yG,` is the workhorse of DeepSpeed. It
supports 3 different levels (stages) of optimization. The first one is not quite interesting for scalability purposes,
therefore this document focuses on stages 2 and 3. Stage 3 is further improved by the latest addition of ZeRO-Infinity.
You will find more indepth information in the DeepSpeed documentation.`),yG.forEach(t),sw=c(e),Ne=l(e,"P",{});var gh=r(Ne);F7=n(gh,"The "),$d=l(gh,"CODE",{});var vZ=r($d);V7=n(vZ,"zero_optimization"),vZ.forEach(t),Y7=n(gh," section of the configuration file is the most important part ("),al=l(gh,"A",{href:!0,rel:!0});var jZ=r(al);K7=n(jZ,"docs"),jZ.forEach(t),J7=n(gh,`), since that is where you define
which ZeRO stages you want to enable and how to configure them. You will find the explanation for each parameter in the
DeepSpeed docs.`),gh.forEach(t),tw=c(e),pa=l(e,"P",{});var BE=r(pa);X7=n(BE,"This section has to be configured exclusively via DeepSpeed configuration - the "),Zi=l(BE,"A",{href:!0});var gZ=r(Zi);Q7=n(gZ,"Trainer"),gZ.forEach(t),e9=n(BE,` provides
no equivalent command line arguments.`),BE.forEach(t),aw=c(e),Ni=l(e,"P",{});var yZ=r(Ni);s9=n(yZ,`Note: currently DeepSpeed doesn\u2019t validate parameter names, so if you misspell any, it\u2019ll use the default setting for
the parameter that got misspelled. You can watch the DeepSpeed engine start up log messages to see what values it is
going to use.`),yZ.forEach(t),nw=c(e),Hi=l(e,"A",{id:!0}),r(Hi).forEach(t),ow=c(e),Rs=l(e,"H4",{class:!0});var WE=r(Rs);ia=l(WE,"A",{id:!0,class:!0,href:!0});var wZ=r(ia);kd=l(wZ,"SPAN",{});var bZ=r(kd);d(nl.$$.fragment,bZ),bZ.forEach(t),wZ.forEach(t),t9=c(WE),Pd=l(WE,"SPAN",{});var EZ=r(Pd);a9=n(EZ,"ZeRO-2 Config"),EZ.forEach(t),WE.forEach(t),lw=c(e),Bi=l(e,"P",{});var qZ=r(Bi);n9=n(qZ,"The following is an example of configuration for ZeRO stage 2:"),qZ.forEach(t),rw=c(e),d(ol.$$.fragment,e),pw=c(e),Wi=l(e,"P",{});var $Z=r(Wi);Dd=l($Z,"STRONG",{});var kZ=r(Dd);o9=n(kZ,"Performance tuning:"),kZ.forEach(t),$Z.forEach(t),iw=c(e),He=l(e,"UL",{});var yh=r(He);Is=l(yh,"LI",{});var wh=r(Is);l9=n(wh,"enabling "),zd=l(wh,"CODE",{});var PZ=r(zd);r9=n(PZ,"offload_optimizer"),PZ.forEach(t),p9=n(wh," should reduce GPU RAM usage (it requires "),Od=l(wh,"CODE",{});var DZ=r(Od);i9=n(DZ,'"stage": 2'),DZ.forEach(t),u9=n(wh,")"),wh.forEach(t),c9=c(yh),L=l(yh,"LI",{});var te=r(L);Td=l(te,"CODE",{});var zZ=r(Td);h9=n(zZ,'"overlap_comm": true'),zZ.forEach(t),f9=n(te," trades off increased GPU RAM usage to lower all-reduce latency. "),Ad=l(te,"CODE",{});var OZ=r(Ad);d9=n(OZ,"overlap_comm"),OZ.forEach(t),m9=n(te,` uses 4.5x
the `),Sd=l(te,"CODE",{});var TZ=r(Sd);_9=n(TZ,"allgather_bucket_size"),TZ.forEach(t),v9=n(te," and "),Cd=l(te,"CODE",{});var AZ=r(Cd);j9=n(AZ,"reduce_bucket_size"),AZ.forEach(t),g9=n(te,` values. So if they are set to 5e8, this requires a 9GB
footprint (`),xd=l(te,"CODE",{});var SZ=r(xd);y9=n(SZ,"5e8 x 2Bytes x 2 x 4.5"),SZ.forEach(t),w9=n(te,`). Therefore, if you have a GPU with 8GB or less RAM, to avoid getting
OOM-errors you will need to reduce those parameters to about `),Rd=l(te,"CODE",{});var CZ=r(Rd);b9=n(CZ,"2e8"),CZ.forEach(t),E9=n(te,`, which would require 3.6GB. You will want to do
the same on larger capacity GPU as well, if you\u2019re starting to hit OOM.`),te.forEach(t),q9=c(yh),Id=l(yh,"LI",{});var xZ=r(Id);$9=n(xZ,`when reducing these buffers you\u2019re trading communication speed to avail more GPU RAM. The smaller the buffer size is,
the slower the communication gets, and the more GPU RAM will be available to other tasks. So if a bigger batch size is
important, getting a slightly slower training time could be a good trade.`),xZ.forEach(t),yh.forEach(t),uw=c(e),Be=l(e,"P",{});var bh=r(Be);k9=n(bh,"Additionally, "),Ud=l(bh,"CODE",{});var RZ=r(Ud);P9=n(RZ,"deepspeed==0.4.4"),RZ.forEach(t),D9=n(bh," added a new option "),Gd=l(bh,"CODE",{});var IZ=r(Gd);z9=n(IZ,"round_robin_gradients"),IZ.forEach(t),O9=n(bh," which you can enable with:"),bh.forEach(t),cw=c(e),d(ll.$$.fragment,e),hw=c(e),Fi=l(e,"P",{});var UZ=r(Fi);T9=n(UZ,"This is a stage 2 optimization for CPU offloading that parallelizes gradient copying to CPU memory among ranks by fine-grained gradient partitioning. Performance benefit grows with gradient accumulation steps (more copying between optimizer steps) or GPU count (increased parallelism)."),UZ.forEach(t),fw=c(e),Vi=l(e,"A",{id:!0}),r(Vi).forEach(t),dw=c(e),Us=l(e,"H4",{class:!0});var FE=r(Us);ua=l(FE,"A",{id:!0,class:!0,href:!0});var GZ=r(ua);Ld=l(GZ,"SPAN",{});var LZ=r(Ld);d(rl.$$.fragment,LZ),LZ.forEach(t),GZ.forEach(t),A9=c(FE),Md=l(FE,"SPAN",{});var MZ=r(Md);S9=n(MZ,"ZeRO-3 Config"),MZ.forEach(t),FE.forEach(t),mw=c(e),Yi=l(e,"P",{});var ZZ=r(Yi);C9=n(ZZ,"The following is an example of configuration for ZeRO stage 3:"),ZZ.forEach(t),_w=c(e),d(pl.$$.fragment,e),vw=c(e),K=l(e,"P",{});var ws=r(K);x9=n(ws,`If you are getting OOMs, because your model or activations don\u2019t fit into the GPU memory and you have unutilized CPU
memory offloading the optimizer states and parameters to CPU memory with `),Zd=l(ws,"CODE",{});var NZ=r(Zd);R9=n(NZ,'"device": "cpu"'),NZ.forEach(t),I9=n(ws,` may solve this limitation.
If you don\u2019t want to offload to CPU memory, use `),Nd=l(ws,"CODE",{});var HZ=r(Nd);U9=n(HZ,"none"),HZ.forEach(t),G9=n(ws," instead of "),Hd=l(ws,"CODE",{});var BZ=r(Hd);L9=n(BZ,"cpu"),BZ.forEach(t),M9=n(ws," for the "),Bd=l(ws,"CODE",{});var WZ=r(Bd);Z9=n(WZ,"device"),WZ.forEach(t),N9=n(ws,` entry. Offloading to
NVMe is discussed further down.`),ws.forEach(t),jw=c(e),We=l(e,"P",{});var Eh=r(We);H9=n(Eh,"Pinned memory is enabled with "),Wd=l(Eh,"CODE",{});var FZ=r(Wd);B9=n(FZ,"pin_memory"),FZ.forEach(t),W9=n(Eh," set to "),Fd=l(Eh,"CODE",{});var VZ=r(Fd);F9=n(VZ,"true"),VZ.forEach(t),V9=n(Eh,`. This feature can improve the throughput at the cost of
making less memory available to other processes. Pinned memory is set aside to the specific process that requested it
and its typically accessed much faster than normal CPU memory.`),Eh.forEach(t),gw=c(e),Ki=l(e,"P",{});var YZ=r(Ki);Vd=l(YZ,"STRONG",{});var KZ=r(Vd);Y9=n(KZ,"Performance tuning:"),KZ.forEach(t),YZ.forEach(t),yw=c(e),ca=l(e,"UL",{});var VE=r(ca);il=l(VE,"LI",{});var YE=r(il);Yd=l(YE,"CODE",{});var JZ=r(Yd);K9=n(JZ,"stage3_max_live_parameters"),JZ.forEach(t),J9=n(YE,": "),Kd=l(YE,"CODE",{});var XZ=r(Kd);X9=n(XZ,"1e9"),XZ.forEach(t),YE.forEach(t),Q9=c(VE),ul=l(VE,"LI",{});var KE=r(ul);Jd=l(KE,"CODE",{});var QZ=r(Jd);ek=n(QZ,"stage3_max_reuse_distance"),QZ.forEach(t),sk=n(KE,": "),Xd=l(KE,"CODE",{});var eN=r(Xd);tk=n(eN,"1e9"),eN.forEach(t),KE.forEach(t),VE.forEach(t),ww=c(e),M=l(e,"P",{});var be=r(M);ak=n(be,"If hitting OOM reduce "),Qd=l(be,"CODE",{});var sN=r(Qd);nk=n(sN,"stage3_max_live_parameters"),sN.forEach(t),ok=n(be," and "),em=l(be,"CODE",{});var tN=r(em);lk=n(tN,"stage3_max_reuse_distance"),tN.forEach(t),rk=n(be,`. They should have minimal impact
on performance unless you are doing activation checkpointing. `),sm=l(be,"CODE",{});var aN=r(sm);pk=n(aN,"1e9"),aN.forEach(t),ik=n(be,` would consume ~2GB. The memory is shared by
`),tm=l(be,"CODE",{});var nN=r(tm);uk=n(nN,"stage3_max_live_parameters"),nN.forEach(t),ck=n(be," and "),am=l(be,"CODE",{});var oN=r(am);hk=n(oN,"stage3_max_reuse_distance"),oN.forEach(t),fk=n(be,", so it\u2019s not additive, it\u2019s just 2GB total."),be.forEach(t),bw=c(e),ze=l(e,"P",{});var Sp=r(ze);nm=l(Sp,"CODE",{});var lN=r(nm);dk=n(lN,"stage3_max_live_parameters"),lN.forEach(t),mk=n(Sp,` is the upper limit on how many full parameters you want to keep on the GPU at any given
time. \u201Creuse distance\u201D is a metric we are using to figure out when will a parameter be used again in the future, and we
use the `),om=l(Sp,"CODE",{});var rN=r(om);_k=n(rN,"stage3_max_reuse_distance"),rN.forEach(t),vk=n(Sp,` to decide whether to throw away the parameter or to keep it. If a parameter is
going to be used again in near future (less than `),lm=l(Sp,"CODE",{});var pN=r(lm);jk=n(pN,"stage3_max_reuse_distance"),pN.forEach(t),gk=n(Sp,`) then we keep it to reduce communication
overhead. This is super helpful when you have activation checkpointing enabled, where we do a forward recompute and
backward passes a a single layer granularity and want to keep the parameter in the forward recompute till the backward`),Sp.forEach(t),Ew=c(e),Ji=l(e,"P",{});var iN=r(Ji);yk=n(iN,"The following configuration values depend on the model\u2019s hidden size:"),iN.forEach(t),qw=c(e),Fe=l(e,"UL",{});var qh=r(Fe);cl=l(qh,"LI",{});var JE=r(cl);rm=l(JE,"CODE",{});var uN=r(rm);wk=n(uN,"reduce_bucket_size"),uN.forEach(t),bk=n(JE,": "),pm=l(JE,"CODE",{});var cN=r(pm);Ek=n(cN,"hidden_size*hidden_size"),cN.forEach(t),JE.forEach(t),qk=c(qh),hl=l(qh,"LI",{});var XE=r(hl);im=l(XE,"CODE",{});var hN=r(im);$k=n(hN,"stage3_prefetch_bucket_size"),hN.forEach(t),kk=n(XE,": "),um=l(XE,"CODE",{});var fN=r(um);Pk=n(fN,"0.9 * hidden_size * hidden_size"),fN.forEach(t),XE.forEach(t),Dk=c(qh),fl=l(qh,"LI",{});var QE=r(fl);cm=l(QE,"CODE",{});var dN=r(cm);zk=n(dN,"stage3_param_persistence_threshold"),dN.forEach(t),Ok=n(QE,": "),hm=l(QE,"CODE",{});var mN=r(hm);Tk=n(mN,"10 * hidden_size"),mN.forEach(t),QE.forEach(t),qh.forEach(t),$w=c(e),Ve=l(e,"P",{});var $h=r(Ve);Ak=n($h,"therefore set these values to "),fm=l($h,"CODE",{});var _N=r(fm);Sk=n(_N,"auto"),_N.forEach(t),Ck=n($h," and the "),Xi=l($h,"A",{href:!0});var vN=r(Xi);xk=n(vN,"Trainer"),vN.forEach(t),Rk=n($h,` will automatically assign the recommended
values. But, of course, feel free to set these explicitly as well.`),$h.forEach(t),kw=c(e),dl=l(e,"P",{});var wG=r(dl);dm=l(wG,"CODE",{});var jN=r(dm);Ik=n(jN,"stage3_gather_16bit_weights_on_model_save"),jN.forEach(t),Uk=n(wG,` enables model fp16 weights consolidation when model gets saved. With large
models and multiple GPUs this is an expensive operation both in terms of memory and speed. It\u2019s currently required if
you plan to resume the training. Watch out for future updates that will remove this limitation and make things more
flexible.`),wG.forEach(t),Pw=c(e),re=l(e,"P",{});var Bn=r(re);Gk=n(Bn,"If you\u2019re migrating from ZeRO-2 configuration note that "),mm=l(Bn,"CODE",{});var gN=r(mm);Lk=n(gN,"allgather_partitions"),gN.forEach(t),Mk=n(Bn,", "),_m=l(Bn,"CODE",{});var yN=r(_m);Zk=n(yN,"allgather_bucket_size"),yN.forEach(t),Nk=n(Bn,` and
`),vm=l(Bn,"CODE",{});var wN=r(vm);Hk=n(wN,"reduce_scatter"),wN.forEach(t),Bk=n(Bn,` configuration parameters are not used in ZeRO-3. If you keep these in the config file they will just
be ignored.`),Bn.forEach(t),Dw=c(e),Qi=l(e,"UL",{});var bN=r(Qi);ml=l(bN,"LI",{});var eq=r(ml);jm=l(eq,"CODE",{});var EN=r(jm);Wk=n(EN,"sub_group_size"),EN.forEach(t),Fk=n(eq,": "),gm=l(eq,"CODE",{});var qN=r(gm);Vk=n(qN,"1e9"),qN.forEach(t),eq.forEach(t),bN.forEach(t),zw=c(e),Oe=l(e,"P",{});var Cp=r(Oe);ym=l(Cp,"CODE",{});var $N=r(ym);Yk=n($N,"sub_group_size"),$N.forEach(t),Kk=n(Cp,` controls the granularity in which parameters are updated during optimizer steps. Parameters are
grouped into buckets of `),wm=l(Cp,"CODE",{});var kN=r(wm);Jk=n(kN,"sub_group_size"),kN.forEach(t),Xk=n(Cp,` and each buckets is updated one at a time. When used with NVMe offload in
ZeRO-Infinity, `),bm=l(Cp,"CODE",{});var PN=r(bm);Qk=n(PN,"sub_group_size"),PN.forEach(t),eP=n(Cp,` therefore controls the granularity in which model states are moved in and out of CPU
...
`),dv=l(W,"CODE",{});var VF=r(dv);GC=n(VF,"from_pretrained"),VF.forEach(t),LC=n(W,". Here is an example of a possible sequence:"),W.forEach(t),T3=c(e),d(zr.$$.fragment,e),A3=c(e),fn=l(e,"P",{});var o$=r(fn);MC=n(o$,"If you\u2019re using the official example scripts and your command line arguments include "),mv=l(o$,"CODE",{});var YF=r(mv);ZC=n(YF,"--deepspeed ds_config.json"),YF.forEach(t),NC=n(o$,`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),o$.forEach(t),S3=c(e),dc=l(e,"P",{});var KF=r(dc);HC=n(KF,"Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),KF.forEach(t),C3=c(e),dn=l(e,"P",{});var l$=r(dn);BC=n(l$,"For full details on this method and other related features please refer to "),Or=l(l$,"A",{href:!0,rel:!0});var JF=r(Or);WC=n(JF,"Constructing Massive Models"),JF.forEach(t),FC=n(l$,"."),l$.forEach(t),x3=c(e),fe=l(e,"P",{});var Jn=r(fe);VC=n(Jn,"Also when loading fp16-pretrained models, you will want to tell "),_v=l(Jn,"CODE",{});var XF=r(_v);YC=n(XF,"from_pretrained"),XF.forEach(t),KC=n(Jn,` to use
`),vv=l(Jn,"CODE",{});var QF=r(vv);JC=n(QF,"torch_dtype=torch.float16"),QF.forEach(t),XC=n(Jn,". For details, please, see "),mc=l(Jn,"A",{href:!0});var eV=r(mc);QC=n(eV,"from_pretrained-torch-dtype"),eV.forEach(t),ex=n(Jn,"."),Jn.forEach(t),R3=c(e),nt=l(e,"H4",{class:!0});var r$=r(nt);mn=l(r$,"A",{id:!0,class:!0,href:!0});var sV=r(mn);jv=l(sV,"SPAN",{});var tV=r(jv);d(Tr.$$.fragment,tV),tV.forEach(t),sV.forEach(t),sx=c(r$),gv=l(r$,"SPAN",{});var aV=r(gv);tx=n(aV,"Gathering Parameters"),aV.forEach(t),r$.forEach(t),I3=c(e),Ar=l(e,"P",{});var EG=r(Ar);ax=n(EG,`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),Sr=l(EG,"A",{href:!0,rel:!0});var nV=r(Sr);nx=n(nV,"Gathering Parameters"),nV.forEach(t),EG.forEach(t),U3=c(e),_n=l(e,"P",{});var p$=r(_n);ox=n(p$,`We do however use it internally in several places, one such example is when loading pretrained model weights in
`),yv=l(p$,"CODE",{});var oV=r(yv);lx=n(oV,"from_pretrained"),oV.forEach(t),rx=n(p$,`. We load one layer at a time and immediately partition it to all participating GPUs, as for very
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
...
dump the `),Cc=l(Xn,"A",{href:!0});var GV=r(Cc);Yx=n(GV,"TrainingArguments"),GV.forEach(t),Kx=n(Xn," as it has dozens of entries that are irrelevant."),Xn.forEach(t),RV.forEach(t),Jx=c($e),Nr=l($e,"LI",{});var m$=r(Nr);Sv=l(m$,"P",{});var LV=r(Sv);Xx=n(LV,"Output of:"),LV.forEach(t),Qx=c(m$),d(Hr.$$.fragment,m$),m$.forEach(t),eR=c($e),Cv=l($e,"LI",{});var MV=r(Cv);Br=l(MV,"P",{});var _$=r(Br);sR=n(_$,`If possible include a link to a Google Colab notebook that we can reproduce the problem with. You can use this
`),Wr=l(_$,"A",{href:!0,rel:!0});var ZV=r(Wr);tR=n(ZV,"notebook"),ZV.forEach(t),aR=n(_$,` as
a starting point.`),_$.forEach(t),MV.forEach(t),nR=c($e),xv=l($e,"LI",{});var NV=r(xv);Rv=l(NV,"P",{});var HV=r(Rv);oR=n(HV,"Unless it\u2019s impossible please always use a standard dataset that we can use and not something custom."),HV.forEach(t),NV.forEach(t),lR=c($e),Iv=l($e,"LI",{});var BV=r(Iv);Fr=l(BV,"P",{});var v$=r(Fr);rR=n(v$,"If possible try to use one of the existing "),Vr=l(v$,"A",{href:!0,rel:!0});var WV=r(Vr);pR=n(WV,"examples"),WV.forEach(t),iR=n(v$," to reproduce the problem with."),v$.forEach(t),BV.forEach(t),$e.forEach(t),f0=c(e),xc=l(e,"P",{});var FV=r(xc);uR=n(FV,"Things to consider:"),FV.forEach(t),d0=c(e),En=l(e,"UL",{});var j$=r(En);pt=l(j$,"LI",{});var Hh=r(pt);Uv=l(Hh,"P",{});var VV=r(Uv);cR=n(VV,"Deepspeed is often not the cause of the problem."),VV.forEach(t),hR=c(Hh),Gv=l(Hh,"P",{});var YV=r(Gv);fR=n(YV,`Some of the filed issues proved to be Deepspeed-unrelated. That is once Deepspeed was removed from the setup, the
...
exception and you can see that DeepSpeed modules are involved, first re-test your setup without DeepSpeed in it.
And only if the problem persists then do mentioned Deepspeed and supply all the required details.`),KV.forEach(t),Hh.forEach(t),_R=c(j$),Mv=l(j$,"LI",{});var JV=r(Mv);Yr=l(JV,"P",{});var g$=r(Yr);vR=n(g$,`If it\u2019s clear to you that the issue is in the DeepSpeed core and not the integration part, please file the Issue
directly with `),Kr=l(g$,"A",{href:!0,rel:!0});var XV=r(Kr);jR=n(XV,"Deepspeed"),XV.forEach(t),gR=n(g$,`. If you aren\u2019t sure, please do not worry,
either Issue tracker will do, we will figure it out once you posted it and redirect you to another Issue tracker if
need be.`),g$.forEach(t),JV.forEach(t),j$.forEach(t),m0=c(e),it=l(e,"H3",{class:!0});var y$=r(it);qn=l(y$,"A",{id:!0,class:!0,href:!0});var QV=r(qn);Zv=l(QV,"SPAN",{});var eY=r(Zv);d(Jr.$$.fragment,eY),eY.forEach(t),QV.forEach(t),yR=c(y$),Nv=l(y$,"SPAN",{});var sY=r(Nv);wR=n(sY,"Troubleshooting"),sY.forEach(t),y$.forEach(t),_0=c(e),ut=l(e,"H4",{class:!0});var w$=r(ut);$n=l(w$,"A",{id:!0,class:!0,href:!0});var tY=r($n);Hv=l(tY,"SPAN",{});var aY=r(Hv);d(Xr.$$.fragment,aY),aY.forEach(t),tY.forEach(t),bR=c(w$),Qr=l(w$,"SPAN",{});var b$=r(Qr);ER=n(b$,"the "),Bv=l(b$,"CODE",{});var nY=r(Bv);qR=n(nY,"deepspeed"),nY.forEach(t),$R=n(b$," process gets killed at startup without a traceback"),b$.forEach(t),w$.forEach(t),v0=c(e),B=l(e,"P",{});var ke=r(B);kR=n(ke,"If the "),Wv=l(ke,"CODE",{});var oY=r(Wv);PR=n(oY,"deepspeed"),oY.forEach(t),DR=n(ke,` process gets killed at launch time without a traceback, that usually means that the program tried
to allocate more CPU memory than your system has or your process is allowed to allocate and the OS kernel killed that
