...
When using `lr=None` with [Trainer](/docs/transformers/pr_15288/en/main_classes/trainer#transformers.Trainer) you will most likely need to use `AdafactorSchedule`
