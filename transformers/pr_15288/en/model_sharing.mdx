...
- local: push-a-model-to-the-hub
  sections:
  - local: push-to-hub-after-training
    title: Push to Hub after training
  title: Push a model to the Hub
...
<h2 id="push-a-model-to-the-hub">Push a model to the Hub</h2>
...
Then pass your training arguments as usual to [Trainer](/docs/transformers/pr_15288/en/main_classes/trainer#transformers.Trainer), and it will push the trained model to the Hub. 🤗 Transformers will even automatically add training hyperparameters, training results and framework versions to your model card when you use the `push_to_hub` parameter!
...
<h3 id="push-to-hub-after-training">Push to Hub after training</h3>
