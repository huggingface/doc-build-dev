...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18022/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18022/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18022/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sy=p(),T(vs.$$.fragment),Wy=p(),Et=n("div"),T(ri.$$.fragment),By=p(),Qo=n("p"),Uy=r("The "),Rd=n("a"),Hy=r("TFRobertaForMultipleChoice"),Qy=r(" forward method, overrides the "),zp=n("code"),Jy=r("__call__"),Vy=r(" special method."),Ky=p(),T(Ts.$$.fragment),Gy=p(),T(ys.$$.fragment),Tm=p(),Jo=n("h2"),ws=n("a"),qp=n("span"),T(ii.$$.fragment),Xy=p(),Cp=n("span"),Yy=r("TFRobertaForTokenClassification"),ym=p(),Ge=n("div"),T(li.$$.fragment),Zy=p(),jp=n("p"),e2=r(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),d2=p(),T($s.$$.fragment),c2=p(),ht=n("div"),T(hi.$$.fragment),p2=p(),Vo=n("p"),h2=r("The "),Ed=n("a"),u2=r("TFRobertaForTokenClassification"),m2=r(" forward method, overrides the "),Pp=n("code"),f2=r("__call__"),g2=r(" special method."),_2=p(),T(Fs.$$.fragment),b2=p(),T(xs.$$.fragment),k2=p(),T(Rs.$$.fragment),wm=p(),Ko=n("h2"),Ms=n("a"),Lp=n("span"),T(ui.$$.fragment),v2=p(),Ap=n("span"),T2=r("TFRobertaForQuestionAnswering"),$m=p(),Xe=n("div"),T(mi.$$.fragment),y2=p(),Go=n("p"),w2=r(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=n("code"),$2=r("span start logits"),F2=r(" and "),Np=n("code"),x2=r("span end logits"),R2=r(")."),M2=p(),fi=n("p"),E2=r("This model inherits from "),zd=n("a"),z2=r("TFPreTrainedModel"),q2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),C2=p(),gi=n("p"),j2=r("This model is also a "),_i=n("a"),P2=r("tf.keras.Model"),L2=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),A2=p(),T(Es.$$.fragment),O2=p(),ut=n("div"),T(bi.$$.fragment),N2=p(),Xo=n("p"),I2=r("The "),qd=n("a"),D2=r("TFRobertaForQuestionAnswering"),S2=r(" forward method, overrides the "),Ip=n("code"),W2=r("__call__"),B2=r(" special method."),U2=p(),T(zs.$$.fragment),H2=p(),T(qs.$$.fragment),Q2=p(),T(Cs.$$.fragment),Fm=p(),Yo=n("h2"),js=n("a"),Dp=n("span"),T(ki.$$.fragment),J2=p(),Sp=n("span"),V2=r("FlaxRobertaModel"),xm=p(),Oe=n("div"),T(vi.$$.fragment),K2=p(),Wp=n("p"),G2=r("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),X2=p(),Ti=n("p"),Y2=r("This model inherits from "),Cd=n("a"),Z2=r("FlaxPreTrainedModel"),ew=r(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zf.forEach(t),Sy=h(Dt),y(vs.$$.fragment,Dt),Wy=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),By=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);Uy=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sR=a(Rd);Hy=i(sR,"TFRobertaForMultipleChoice"),sR.forEach(t),Qy=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var aR=a(zp);Jy=i(aR,"__call__"),aR.forEach(t),Vy=i(ec," special method."),ec.forEach(t),Ky=h(aa),y(Ts.$$.fragment,aa),Gy=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tm=h(o),Jo=s(o,"H2",{class:!0});var qf=a(Jo);ws=s(qf,"A",{id:!0,class:!0,href:!0});var rR=a(ws);qp=s(rR,"SPAN",{});var iR=a(qp);y(ii.$$.fragment,iR),iR.forEach(t),rR.forEach(t),Xy=h(qf),Cp=s(qf,"SPAN",{});var lR=a(Cp);Yy=i(lR,"TFRobertaForTokenClassification"),lR.forEach(t),qf.forEach(t),ym=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),Zy=h(St),jp=s(St,"P",{});var dR=a(jp);e2=i(dR,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dR.forEach(t),t2=h(St),di=s(St,"P",{});var Cf=a(di);o2=i(Cf,"This model inherits from "),Md=s(Cf,"A",{href:!0});var cR=a(Md);n2=i(cR,"TFPreTrainedModel"),cR.forEach(t),s2=i(Cf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cf.forEach(t),a2=h(St),ci=s(St,"P",{});var jf=a(ci);r2=i(jf,"This model is also a "),pi=s(jf,"A",{href:!0,rel:!0});var pR=a(pi);i2=i(pR,"tf.keras.Model"),pR.forEach(t),l2=i(jf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jf.forEach(t),d2=h(St),y($s.$$.fragment,St),c2=h(St),ht=s(St,"DIV",{class:!0});var mo=a(ht);y(hi.$$.fragment,mo),p2=h(mo),Vo=s(mo,"P",{});var tc=a(Vo);h2=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hR=a(Ed);u2=i(hR,"TFRobertaForTokenClassification"),hR.forEach(t),m2=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var uR=a(Pp);f2=i(uR,"__call__"),uR.forEach(t),g2=i(tc," special method."),tc.forEach(t),_2=h(mo),y(Fs.$$.fragment,mo),b2=h(mo),y(xs.$$.fragment,mo),k2=h(mo),y(Rs.$$.fragment,mo),mo.forEach(t),St.forEach(t),wm=h(o),Ko=s(o,"H2",{class:!0});var Pf=a(Ko);Ms=s(Pf,"A",{id:!0,class:!0,href:!0});var mR=a(Ms);Lp=s(mR,"SPAN",{});var fR=a(Lp);y(ui.$$.fragment,fR),fR.forEach(t),mR.forEach(t),v2=h(Pf),Ap=s(Pf,"SPAN",{});var gR=a(Ap);T2=i(gR,"TFRobertaForQuestionAnswering"),gR.forEach(t),Pf.forEach(t),$m=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(mi.$$.fragment,Wt),y2=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);w2=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _R=a(Op);$2=i(_R,"span start logits"),_R.forEach(t),F2=i(oc," and "),Np=s(oc,"CODE",{});var bR=a(Np);x2=i(bR,"span end logits"),bR.forEach(t),R2=i(oc,")."),oc.forEach(t),M2=h(Wt),fi=s(Wt,"P",{});var Lf=a(fi);E2=i(Lf,"This model inherits from "),zd=s(Lf,"A",{href:!0});var kR=a(zd);z2=i(kR,"TFPreTrainedModel"),kR.forEach(t),q2=i(Lf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lf.forEach(t),C2=h(Wt),gi=s(Wt,"P",{});var Af=a(gi);j2=i(Af,"This model is also a "),_i=s(Af,"A",{href:!0,rel:!0});var vR=a(_i);P2=i(vR,"tf.keras.Model"),vR.forEach(t),L2=i(Af,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Af.forEach(t),A2=h(Wt),y(Es.$$.fragment,Wt),O2=h(Wt),ut=s(Wt,"DIV",{class:!0});var fo=a(ut);y(bi.$$.fragment,fo),N2=h(fo),Xo=s(fo,"P",{});var nc=a(Xo);I2=i(nc,"The "),qd=s(nc,"A",{href:!0});var TR=a(qd);D2=i(TR,"TFRobertaForQuestionAnswering"),TR.forEach(t),S2=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yR=a(Ip);W2=i(yR,"__call__"),yR.forEach(t),B2=i(nc," special method."),nc.forEach(t),U2=h(fo),y(zs.$$.fragment,fo),H2=h(fo),y(qs.$$.fragment,fo),Q2=h(fo),y(Cs.$$.fragment,fo),fo.forEach(t),Wt.forEach(t),Fm=h(o),Yo=s(o,"H2",{class:!0});var Of=a(Yo);js=s(Of,"A",{id:!0,class:!0,href:!0});var wR=a(js);Dp=s(wR,"SPAN",{});var $R=a(Dp);y(ki.$$.fragment,$R),$R.forEach(t),wR.forEach(t),J2=h(Of),Sp=s(Of,"SPAN",{});var FR=a(Sp);V2=i(FR,"FlaxRobertaModel"),FR.forEach(t),Of.forEach(t),xm=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),K2=h(gt),Wp=s(gt,"P",{});var xR=a(Wp);G2=i(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),X2=h(gt),Ti=s(gt,"P",{});var Nf=a(Ti);Y2=i(Nf,"This model inherits from "),Cd=s(Nf,"A",{href:!0});var RR=a(Cd);Z2=i(RR,"FlaxPreTrainedModel"),RR.forEach(t),ew=i(Nf,`. Check the superclass documentation for the generic methods the
