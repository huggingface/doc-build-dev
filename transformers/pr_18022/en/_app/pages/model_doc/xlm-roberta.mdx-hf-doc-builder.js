...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18022/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_18022/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18022/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_18022/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18022/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18022/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18022/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18022/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
documentation alongside usage examples.`),w2=c(),pt=n("div"),T(Dr.$$.fragment),$2=c(),Xo=n("p"),M2=r("The "),md=n("a"),F2=r("TFRobertaForTokenClassification"),x2=r(" forward method, overrides the "),dp=n("code"),R2=r("__call__"),L2=r(" special method."),E2=c(),T(ts.$$.fragment),z2=c(),T(os.$$.fragment),q2=c(),T(ns.$$.fragment),Em=c(),Po=n("h2"),ss=n("a"),cp=n("span"),T(Sr.$$.fragment),C2=c(),pp=n("span"),j2=r("TFXLMRobertaForQuestionAnswering"),zm=c(),Be=n("div"),T(Br.$$.fragment),X2=c(),Ao=n("p"),P2=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=n("code"),A2=r("span start logits"),O2=r(" and "),mp=n("code"),N2=r("span end logits"),I2=r(")."),D2=c(),Wr=n("p"),S2=r("This model inherits from "),ud=n("a"),B2=r("TFPreTrainedModel"),W2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation alongside usage examples.`),hu.forEach(t),Tb=p(At),Qe=s(At,"DIV",{class:!0});var mt=a(Qe);y(Oa.$$.fragment,mt),yb=p(mt),bo=s(mt,"P",{});var jd=a(bo);wb=i(jd,"The "),Bl=s(jd,"A",{href:!0});var e0=a(Bl);$b=i(e0,"RobertaForSequenceClassification"),e0.forEach(t),Mb=i(jd," forward method, overrides the "),Ec=s(jd,"CODE",{});var t0=a(Ec);Fb=i(t0,"__call__"),t0.forEach(t),xb=i(jd," special method."),jd.forEach(t),Rb=p(mt),y(kn.$$.fragment,mt),Lb=p(mt),y(vn.$$.fragment,mt),Eb=p(mt),y(Tn.$$.fragment,mt),zb=p(mt),y(yn.$$.fragment,mt),qb=p(mt),y(wn.$$.fragment,mt),mt.forEach(t),At.forEach(t),um=p(o),ko=s(o,"H2",{class:!0});var mu=a(ko);$n=s(mu,"A",{id:!0,class:!0,href:!0});var o0=a($n);zc=s(o0,"SPAN",{});var n0=a(zc);y(Na.$$.fragment,n0),n0.forEach(t),o0.forEach(t),Cb=p(mu),qc=s(mu,"SPAN",{});var s0=a(qc);jb=i(s0,"XLMRobertaForMultipleChoice"),s0.forEach(t),mu.forEach(t),fm=p(o),Ge=s(o,"DIV",{class:!0});var Ot=a(Ge);y(Ia.$$.fragment,Ot),Xb=p(Ot),Cc=s(Ot,"P",{});var a0=a(Cc);Pb=i(a0,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),a0.forEach(t),Ab=p(Ot),Da=s(Ot,"P",{});var uu=a(Da);Ob=i(uu,"This model inherits from "),Wl=s(uu,"A",{href:!0});var r0=a(Wl);Nb=i(r0,"PreTrainedModel"),r0.forEach(t),Ib=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),Db=p(Ot),Sa=s(Ot,"P",{});var fu=a(Sa);Sb=i(fu,"This model is also a PyTorch "),Ba=s(fu,"A",{href:!0,rel:!0});var i0=a(Ba);Bb=i(i0,"torch.nn.Module"),i0.forEach(t),Wb=i(fu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fu.forEach(t),Ub=p(Ot),Wa=s(Ot,"P",{});var gu=a(Wa);Qb=i(gu,"This class overrides "),Ul=s(gu,"A",{href:!0});var l0=a(Ul);Hb=i(l0,"RobertaForMultipleChoice"),l0.forEach(t),Vb=i(gu,`. Please check the superclass for the appropriate documentation
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yu.forEach(t),Sk=p(It),or=s(It,"P",{});var wu=a(or);Bk=i(wu,"This model is also a PyTorch "),nr=s(wu,"A",{href:!0,rel:!0});var F0=a(nr);Wk=i(F0,"torch.nn.Module"),F0.forEach(t),Uk=i(wu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
for Named-Entity-Recognition (NER) tasks.`),fF.forEach(t),c2=p(bt),Ar=s(bt,"P",{});var Bu=a(Ar);p2=i(Bu,"This model inherits from "),pd=s(Bu,"A",{href:!0});var gF=a(pd);h2=i(gF,"TFPreTrainedModel"),gF.forEach(t),m2=i(Bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bu.forEach(t),u2=p(bt),Or=s(bt,"P",{});var Wu=a(Or);f2=i(Wu,"This model is also a "),Nr=s(Wu,"A",{href:!0,rel:!0});var _F=a(Nr);g2=i(_F,"tf.keras.Model"),_F.forEach(t),_2=i(Wu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wu.forEach(t),b2=p(bt),y(es.$$.fragment,bt),k2=p(bt),Ir=s(bt,"P",{});var Uu=a(Ir);v2=i(Uu,"This class overrides "),hd=s(Uu,"A",{href:!0});var bF=a(hd);T2=i(bF,"TFRobertaForTokenClassification"),bF.forEach(t),y2=i(Uu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Uu.forEach(t),w2=p(bt),pt=s(bt,"DIV",{class:!0});var so=a(pt);y(Dr.$$.fragment,so),$2=p(so),Xo=s(so,"P",{});var Bd=a(Xo);M2=i(Bd,"The "),md=s(Bd,"A",{href:!0});var kF=a(md);F2=i(kF,"TFRobertaForTokenClassification"),kF.forEach(t),x2=i(Bd," forward method, overrides the "),dp=s(Bd,"CODE",{});var vF=a(dp);R2=i(vF,"__call__"),vF.forEach(t),L2=i(Bd," special method."),Bd.forEach(t),E2=p(so),y(ts.$$.fragment,so),z2=p(so),y(os.$$.fragment,so),q2=p(so),y(ns.$$.fragment,so),so.forEach(t),bt.forEach(t),Em=p(o),Po=s(o,"H2",{class:!0});var Qu=a(Po);ss=s(Qu,"A",{id:!0,class:!0,href:!0});var TF=a(ss);cp=s(TF,"SPAN",{});var yF=a(cp);y(Sr.$$.fragment,yF),yF.forEach(t),TF.forEach(t),C2=p(Qu),pp=s(Qu,"SPAN",{});var wF=a(pp);j2=i(wF,"TFXLMRobertaForQuestionAnswering"),wF.forEach(t),Qu.forEach(t),zm=p(o),Be=s(o,"DIV",{class:!0});var kt=a(Be);y(Br.$$.fragment,kt),X2=p(kt),Ao=s(kt,"P",{});var Wd=a(Ao);P2=i(Wd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Wd,"CODE",{});var $F=a(hp);A2=i($F,"span start logits"),$F.forEach(t),O2=i(Wd," and "),mp=s(Wd,"CODE",{});var MF=a(mp);N2=i(MF,"span end logits"),MF.forEach(t),I2=i(Wd,")."),Wd.forEach(t),D2=p(kt),Wr=s(kt,"P",{});var Hu=a(Wr);S2=i(Hu,"This model inherits from "),ud=s(Hu,"A",{href:!0});var FF=a(ud);B2=i(FF,"TFPreTrainedModel"),FF.forEach(t),W2=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
