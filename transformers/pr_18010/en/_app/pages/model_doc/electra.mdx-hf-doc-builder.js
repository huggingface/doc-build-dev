...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18010/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18010/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18010/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18010/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$0=p(kt),Rh=s(kt,"P",{});var Iz=a(Rh);F0=i(Iz,"Finally, this model supports inherent JAX features such as:"),Iz.forEach(t),x0=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var Dz=a(Hh);ml=s(Dz,"A",{href:!0,rel:!0});var Sz=a(ml);M0=i(Sz,"Just-In-Time (JIT) compilation"),Sz.forEach(t),Dz.forEach(t),z0=p(Ea),Qh=s(Ea,"LI",{});var Wz=a(Qh);ul=s(Wz,"A",{href:!0,rel:!0});var Uz=a(ul);j0=i(Uz,"Automatic Differentiation"),Uz.forEach(t),Wz.forEach(t),C0=p(Ea),Bh=s(Ea,"LI",{});var Rz=a(Bh);fl=s(Rz,"A",{href:!0,rel:!0});var Hz=a(fl);q0=i(Hz,"Vectorization"),Hz.forEach(t),Rz.forEach(t),P0=p(Ea),Vh=s(Ea,"LI",{});var Qz=a(Vh);gl=s(Qz,"A",{href:!0,rel:!0});var Bz=a(gl);A0=i(Bz,"Parallelization"),Bz.forEach(t),Qz.forEach(t),Ea.forEach(t),O0=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L0=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N0=i(Pc,"The "),Kh=s(Pc,"CODE",{});var Vz=a(Kh);I0=i(Vz,"FlaxElectraPreTrainedModel"),Vz.forEach(t),D0=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var Kz=a(Jh);S0=i(Kz,"__call__"),Kz.forEach(t),W0=i(Pc," special method."),Pc.forEach(t),U0=p(wa),y(Ks.$$.fragment,wa),R0=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var Jz=a(Gs);Gh=s(Jz,"SPAN",{});var Gz=a(Gh);y(kl.$$.fragment,Gz),Gz.forEach(t),Jz.forEach(t),H0=p(Og),Xh=s(Og,"SPAN",{});var Xz=a(Xh);Q0=i(Xz,"FlaxElectraForSequenceClassification"),Xz.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),B0=p(vt),Yh=s(vt,"P",{});var Yz=a(Yh);V0=i(Yz,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
