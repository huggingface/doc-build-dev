...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/tokenization_mbart_fast.py#L165",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18010/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_mbart.py#L1448",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18010/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_mbart.py#L1727",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18010/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18010/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18010/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18010/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18010/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
...
adding special tokens. An MBART-50 sequence has the following format, where `),tl=s(xu,"CODE",{});var ZT=r(tl);q_=d(ZT,"X"),ZT.forEach(t),F_=d(xu," represents the sequence:"),xu.forEach(t),B_=u(aa),ss=s(aa,"UL",{});var zu=r(ss);rs=s(zu,"LI",{});var qu=r(rs);ol=s(qu,"CODE",{});var YT=r(ol);j_=d(YT,"input_ids"),YT.forEach(t),E_=d(qu," (for encoder) "),nl=s(qu,"CODE",{});var e0=r(nl);C_=d(e0,"[src_lang_code] X [eos]"),e0.forEach(t),qu.forEach(t),P_=u(zu),is=s(zu,"LI",{});var Fu=r(is);al=s(Fu,"CODE",{});var t0=r(al);S_=d(t0,"labels"),t0.forEach(t),A_=d(Fu,": (for decoder) "),sl=s(Fu,"CODE",{});var o0=r(sl);O_=d(o0,"[tgt_lang_code] X [eos]"),o0.forEach(t),Fu.forEach(t),zu.forEach(t),I_=u(aa),rl=s(aa,"P",{});var n0=r(rl);N_=d(n0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
special tokens using the tokenizer `),dl=s(Eu,"CODE",{});var s0=r(dl);X_=d(s0,"prepare_for_model"),s0.forEach(t),Q_=d(Eu," method."),Eu.forEach(t),ju.forEach(t),H_=u(ee),Lo=s(ee,"DIV",{class:!0});var Cu=r(Lo);v(ps.$$.fragment,Cu),V_=u(Cu),ll=s(Cu,"P",{});var r0=r(ll);J_=d(r0,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),r0.forEach(t),Cu.forEach(t),K_=u(ee),Go=s(ee,"DIV",{class:!0});var Pu=r(Go);v(us.$$.fragment,Pu),Z_=u(Pu),cl=s(Pu,"P",{});var i0=r(cl);Y_=d(i0,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),i0.forEach(t),Pu.forEach(t),ee.forEach(t),jp=u(o),Ht=s(o,"H2",{class:!0});var Su=r(Ht);Wo=s(Su,"A",{id:!0,class:!0,href:!0});var d0=r(Wo);pl=s(d0,"SPAN",{});var l0=r(pl);v(hs.$$.fragment,l0),l0.forEach(t),d0.forEach(t),eg=u(Su),ul=s(Su,"SPAN",{});var c0=r(ul);tg=d(c0,"MBart50TokenizerFast"),c0.forEach(t),Su.forEach(t),Ep=u(o),K=s(o,"DIV",{class:!0});var Ae=r(K);v(ms.$$.fragment,Ae),og=u(Ae),Vt=s(Ae,"P",{});var Ui=r(Vt);ng=d(Ui,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),hl=s(Ui,"EM",{});var p0=r(hl);ag=d(p0,"tokenizers"),p0.forEach(t),sg=d(Ui,` library). Based on
`),fs=s(Ui,"A",{href:!0,rel:!0});var u0=r(fs);rg=d(u0,"BPE"),u0.forEach(t),ig=d(Ui,"."),Ui.forEach(t),dg=u(Ae),_s=s(Ae,"P",{});var Au=r(_s);lg=d(Au,"This tokenizer inherits from "),Mi=s(Au,"A",{href:!0});var h0=r(Mi);cg=d(h0,"PreTrainedTokenizerFast"),h0.forEach(t),pg=d(Au,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Au.forEach(t),ug=u(Ae),v(Ro.$$.fragment,Ae),hg=u(Ae),Be=s(Ae,"DIV",{class:!0});var Tt=r(Be);v(gs.$$.fragment,Tt),mg=u(Tt),ml=s(Tt,"P",{});var m0=r(ml);fg=d(m0,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),m0.forEach(t),_g=u(Tt),bs=s(Tt,"P",{});var Ou=r(bs);gg=d(Ou,"An MBART-50 sequence has the following format, where "),fl=s(Ou,"CODE",{});var f0=r(fl);bg=d(f0,"X"),f0.forEach(t),kg=d(Ou," represents the sequence:"),Ou.forEach(t),yg=u(Tt),ks=s(Tt,"UL",{});var Iu=r(ks);ys=s(Iu,"LI",{});var Nu=r(ys);_l=s(Nu,"CODE",{});var _0=r(_l);vg=d(_0,"input_ids"),_0.forEach(t),Tg=d(Nu," (for encoder) "),gl=s(Nu,"CODE",{});var g0=r(gl);wg=d(g0,"[src_lang_code] X [eos]"),g0.forEach(t),Nu.forEach(t),Mg=u(Iu),vs=s(Iu,"LI",{});var Du=r(vs);bl=s(Du,"CODE",{});var b0=r(bl);$g=d(b0,"labels"),b0.forEach(t),xg=d(Du,": (for decoder) "),kl=s(Du,"CODE",{});var k0=r(kl);zg=d(k0,"[tgt_lang_code] X [eos]"),k0.forEach(t),Du.forEach(t),Iu.forEach(t),qg=u(Tt),yl=s(Tt,"P",{});var y0=r(yl);Fg=d(y0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),y0.forEach(t),Tt.forEach(t),Bg=u(Ae),Uo=s(Ae,"DIV",{class:!0});var Lu=r(Uo);v(Ts.$$.fragment,Lu),jg=u(Lu),vl=s(Lu,"P",{});var v0=r(vl);Eg=d(v0,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),v0.forEach(t),Lu.forEach(t),Cg=u(Ae),Xo=s(Ae,"DIV",{class:!0});var Gu=r(Xo);v(ws.$$.fragment,Gu),Pg=u(Gu),Tl=s(Gu,"P",{});var T0=r(Tl);Sg=d(T0,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),T0.forEach(t),Gu.forEach(t),Ae.forEach(t),Cp=u(o),Jt=s(o,"H2",{class:!0});var Wu=r(Jt);Qo=s(Wu,"A",{id:!0,class:!0,href:!0});var w0=r(Qo);wl=s(w0,"SPAN",{});var M0=r(wl);v(Ms.$$.fragment,M0),M0.forEach(t),w0.forEach(t),Ag=u(Wu),Ml=s(Wu,"SPAN",{});var $0=r(Ml);Og=d($0,"MBartModel"),$0.forEach(t),Wu.forEach(t),Pp=u(o),We=s(o,"DIV",{class:!0});var sa=r(We);v($s.$$.fragment,sa),Ig=u(sa),xs=s(sa,"P",{});var Ru=r(xs);Ng=d(Ru,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),$i=s(Ru,"A",{href:!0});var x0=r($i);Dg=d(x0,"PreTrainedModel"),x0.forEach(t),Lg=d(Ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ru.forEach(t),Gg=u(sa),zs=s(sa,"P",{});var Uu=r(zs);Wg=d(Uu,"This model is also a PyTorch "),qs=s(Uu,"A",{href:!0,rel:!0});var z0=r(qs);Rg=d(z0,"torch.nn.Module"),z0.forEach(t),Ug=d(Uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uu.forEach(t),Xg=u(sa),Ze=s(sa,"DIV",{class:!0});var ra=r(Ze);v(Fs.$$.fragment,ra),Qg=u(ra),Kt=s(ra,"P",{});var Xi=r(Kt);Hg=d(Xi,"The "),xi=s(Xi,"A",{href:!0});var q0=r(xi);Vg=d(q0,"MBartModel"),q0.forEach(t),Jg=d(Xi," forward method, overrides the "),$l=s(Xi,"CODE",{});var F0=r($l);Kg=d(F0,"__call__"),F0.forEach(t),Zg=d(Xi," special method."),Xi.forEach(t),Yg=u(ra),v(Ho.$$.fragment,ra),eb=u(ra),v(Vo.$$.fragment,ra),ra.forEach(t),sa.forEach(t),Sp=u(o),Zt=s(o,"H2",{class:!0});var Xu=r(Zt);Jo=s(Xu,"A",{id:!0,class:!0,href:!0});var B0=r(Jo);xl=s(B0,"SPAN",{});var j0=r(xl);v(Bs.$$.fragment,j0),j0.forEach(t),B0.forEach(t),tb=u(Xu),zl=s(Xu,"SPAN",{});var E0=r(zl);ob=d(E0,"MBartForConditionalGeneration"),E0.forEach(t),Xu.forEach(t),Ap=u(o),Re=s(o,"DIV",{class:!0});var ia=r(Re);v(js.$$.fragment,ia),nb=u(ia),Es=s(ia,"P",{});var Qu=r(Es);ab=d(Qu,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hu.forEach(t),pb=u(ia),je=s(ia,"DIV",{class:!0});var wt=r(je);v(Ss.$$.fragment,wt),ub=u(wt),Yt=s(wt,"P",{});var Qi=r(Yt);hb=d(Qi,"The "),qi=s(Qi,"A",{href:!0});var S0=r(qi);mb=d(S0,"MBartForConditionalGeneration"),S0.forEach(t),fb=d(Qi," forward method, overrides the "),ql=s(Qi,"CODE",{});var A0=r(ql);_b=d(A0,"__call__"),A0.forEach(t),gb=d(Qi," special method."),Qi.forEach(t),bb=u(wt),v(Ko.$$.fragment,wt),kb=u(wt),v(Zo.$$.fragment,wt),yb=u(wt),v(Yo.$$.fragment,wt),wt.forEach(t),ia.forEach(t),Op=u(o),eo=s(o,"H2",{class:!0});var Vu=r(eo);en=s(Vu,"A",{id:!0,class:!0,href:!0});var O0=r(en);Fl=s(O0,"SPAN",{});var I0=r(Fl);v(As.$$.fragment,I0),I0.forEach(t),O0.forEach(t),vb=u(Vu),Bl=s(Vu,"SPAN",{});var N0=r(Bl);Tb=d(N0,"MBartForQuestionAnswering"),N0.forEach(t),Vu.forEach(t),Ip=u(o),we=s(o,"DIV",{class:!0});var Mt=r(we);v(Os.$$.fragment,Mt),wb=u(Mt),to=s(Mt,"P",{});var Hi=r(to);Mb=d(Hi,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),jl=s(Hi,"CODE",{});var D0=r(jl);$b=d(D0,"span start logits"),D0.forEach(t),xb=d(Hi," and "),El=s(Hi,"CODE",{});var L0=r(El);zb=d(L0,"span end logits"),L0.forEach(t),qb=d(Hi,")."),Hi.forEach(t),Fb=u(Mt),Is=s(Mt,"P",{});var Ju=r(Is);Bb=d(Ju,"This model inherits from "),Fi=s(Ju,"A",{href:!0});var G0=r(Fi);jb=d(G0,"PreTrainedModel"),G0.forEach(t),Eb=d(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ku.forEach(t),Ob=u(Mt),Ee=s(Mt,"DIV",{class:!0});var $t=r(Ee);v(Ls.$$.fragment,$t),Ib=u($t),oo=s($t,"P",{});var Vi=r(oo);Nb=d(Vi,"The "),Bi=s(Vi,"A",{href:!0});var R0=r(Bi);Db=d(R0,"MBartForQuestionAnswering"),R0.forEach(t),Lb=d(Vi," forward method, overrides the "),Cl=s(Vi,"CODE",{});var U0=r(Cl);Gb=d(U0,"__call__"),U0.forEach(t),Wb=d(Vi," special method."),Vi.forEach(t),Rb=u($t),v(tn.$$.fragment,$t),Ub=u($t),v(on.$$.fragment,$t),Xb=u($t),v(nn.$$.fragment,$t),$t.forEach(t),Mt.forEach(t),Np=u(o),no=s(o,"H2",{class:!0});var Zu=r(no);an=s(Zu,"A",{id:!0,class:!0,href:!0});var X0=r(an);Pl=s(X0,"SPAN",{});var Q0=r(Pl);v(Gs.$$.fragment,Q0),Q0.forEach(t),X0.forEach(t),Qb=u(Zu),Sl=s(Zu,"SPAN",{});var H0=r(Sl);Hb=d(H0,"MBartForSequenceClassification"),H0.forEach(t),Zu.forEach(t),Dp=u(o),Me=s(o,"DIV",{class:!0});var xt=r(Me);v(Ws.$$.fragment,xt),Vb=u(xt),Al=s(xt,"P",{});var V0=r(Al);Jb=d(V0,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),V0.forEach(t),Kb=u(xt),Rs=s(xt,"P",{});var Yu=r(Rs);Zb=d(Yu,"This model inherits from "),ji=s(Yu,"A",{href:!0});var J0=r(ji);Yb=d(J0,"PreTrainedModel"),J0.forEach(t),ek=d(Yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yu.forEach(t),tk=u(xt),Us=s(xt,"P",{});var eh=r(Us);ok=d(eh,"This model is also a PyTorch "),Xs=s(eh,"A",{href:!0,rel:!0});var K0=r(Xs);nk=d(K0,"torch.nn.Module"),K0.forEach(t),ak=d(eh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
