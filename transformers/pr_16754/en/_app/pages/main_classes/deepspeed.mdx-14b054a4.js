...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16754/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16754/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16754/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16754/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16754/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
install `),wf=o("em"),e5=a("libaio-dev"),s5=a(" system-wide)."),vg=u(),zt=o("p"),t5=a("Edit "),yf=o("code"),a5=a("TORCH_CUDA_ARCH_LIST"),n5=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
of them like so `),qf=o("code"),u5=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),wg=u(),ti=o("p"),c5=a("If you need to use the same setup on multiple machines, make a binary wheel:"),yg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h5=a("it will generate something like "),$f=o("code"),f5=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d5=a(` which now you can install
as `),kf=o("code"),m5=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_5=a(" locally or on any other machine."),Eg=u(),Ot=o("p"),v5=a("Again, remember to ensure to adjust "),Pf=o("code"),j5=a("TORCH_CUDA_ARCH_LIST"),g5=a(" to the target architectures."),qg=u(),Ue=o("p"),w5=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Df=o("strong"),y5=a("Compute Capabilities"),b5=a(` (same as arch in this
context) `),jo=o("a"),E5=a("here"),q5=a("."),$g=u(),ai=o("p"),$5=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k5=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(wo.$$.fragment),zg=u(),oi=o("p"),P5=a("If the output is:"),Og=u(),f(yo.$$.fragment),Tg=u(),Tt=o("p"),D5=a("then you know that this card\u2019s arch is "),zf=o("code"),z5=a("8.6"),O5=a("."),Ag=u(),At=o("p"),T5=a("You can also leave "),Of=o("code"),A5=a("TORCH_CUDA_ARCH_LIST"),S5=a(` out completely and then the build program will automatically query the
...
install `),wf=l(uh,"EM",{});var mL=r(wf);e5=n(mL,"libaio-dev"),mL.forEach(t),s5=n(uh," system-wide)."),uh.forEach(t),vg=c(e),zt=l(e,"P",{});var cE=r(zt);t5=n(cE,"Edit "),yf=l(cE,"CODE",{});var _L=r(yf);a5=n(_L,"TORCH_CUDA_ARCH_LIST"),_L.forEach(t),n5=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
of them like so `),qf=l(Ap,"CODE",{});var gL=r(qf);u5=n(gL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),gL.forEach(t),Ap.forEach(t),wg=c(e),ti=l(e,"P",{});var wL=r(ti);c5=n(wL,"If you need to use the same setup on multiple machines, make a binary wheel:"),wL.forEach(t),yg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h5=n(ch,"it will generate something like "),$f=l(ch,"CODE",{});var yL=r($f);f5=n(yL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),yL.forEach(t),d5=n(ch,` which now you can install
as `),kf=l(ch,"CODE",{});var bL=r(kf);m5=n(bL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),bL.forEach(t),_5=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),Ot=l(e,"P",{});var hE=r(Ot);v5=n(hE,"Again, remember to ensure to adjust "),Pf=l(hE,"CODE",{});var EL=r(Pf);j5=n(EL,"TORCH_CUDA_ARCH_LIST"),EL.forEach(t),g5=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);w5=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Df=l(hh,"STRONG",{});var qL=r(Df);y5=n(qL,"Compute Capabilities"),qL.forEach(t),b5=n(hh,` (same as arch in this
