import{S as Qu,i as Hu,s as Wu,e as a,k as c,w as v,t as n,M as Ru,c as r,d as t,m as h,a as d,x as k,h as s,b as m,G as e,g,y as w,q as y,o as E,B as L,v as Uu,L as je}from"../../chunks/vendor-hf-doc-builder.js";import{T as qo}from"../../chunks/Tip-hf-doc-builder.js";import{D as x}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ae}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Oe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ce}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vu($){let l,b,p,u,T;return u=new Ae({props:{code:`from transformers import LEDModel, LEDConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,u){w(l,p,u),b=!0},p:je,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function im($){let l,b,p,u,T,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,Te,O,j,ue,oe,$e,me,U,Be,De,C,Ge,K,M,S,B,Qe,He,P,We,ne,ve;return{c(){l=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),T=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),R=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=c(),O=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Be=n("model(input_ids)"),De=c(),C=a("li"),Ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),B=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),He=c(),P=a("li"),We=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),ve=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);T=r(se,"LI",{});var nt=d(T);i=s(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(se),D=r(se,"LI",{});var st=d(D);Pe=s(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var N=d(F);Z=s(N,"This second option is useful when using "),H=r(N,"CODE",{});var at=d(H);ee=s(at,"tf.keras.Model.fit"),at.forEach(t),Ne=s(N,` method which currently requires having all the
tensors in the first argument of the model call function: `),W=r(N,"CODE",{});var rt=d(W);Ie=s(rt,"model(inputs)"),rt.forEach(t),qe=s(N,"."),N.forEach(t),I=h(q),R=r(q,"P",{});var Fe=d(R);te=s(Fe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Fe.forEach(t),Te=h(q),O=r(q,"UL",{});var V=d(O);j=r(V,"LI",{});var ae=d(j);ue=s(ae,"a single Tensor with "),oe=r(ae,"CODE",{});var ze=d(oe);$e=s(ze,"input_ids"),ze.forEach(t),me=s(ae," only and nothing else: "),U=r(ae,"CODE",{});var dt=d(U);Be=s(dt,"model(input_ids)"),dt.forEach(t),ae.forEach(t),De=h(V),C=r(V,"LI",{});var re=d(C);Ge=s(re,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=r(re,"CODE",{});var it=d(K);M=s(it,"model([input_ids, attention_mask])"),it.forEach(t),S=s(re," or "),B=r(re,"CODE",{});var de=d(B);Qe=s(de,"model([input_ids, attention_mask, token_type_ids])"),de.forEach(t),re.forEach(t),He=h(V),P=r(V,"LI",{});var Re=d(P);We=s(Re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=r(Re,"CODE",{});var Ue=d(ne);ve=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),Re.forEach(t),V.forEach(t)},m(q,z){g(q,l,z),e(l,b),g(q,p,z),g(q,u,z),e(u,T),e(T,i),e(u,f),e(u,D),e(D,Pe),g(q,pe,z),g(q,F,z),e(F,Z),e(F,H),e(H,ee),e(F,Ne),e(F,W),e(W,Ie),e(F,qe),g(q,I,z),g(q,R,z),e(R,te),g(q,Te,z),g(q,O,z),e(O,j),e(j,ue),e(j,oe),e(oe,$e),e(j,me),e(j,U),e(U,Be),e(O,De),e(O,C),e(C,Ge),e(C,K),e(K,M),e(C,S),e(C,B),e(B,Qe),e(O,He),e(O,P),e(P,We),e(P,ne),e(ne,ve)},d(q){q&&t(l),q&&t(p),q&&t(u),q&&t(pe),q&&t(F),q&&t(I),q&&t(R),q&&t(Te),q&&t(O)}}}function lm($){let l,b,p,u,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function hm($){let l,b,p,u,T,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,Te,O,j,ue,oe,$e,me,U,Be,De,C,Ge,K,M,S,B,Qe,He,P,We,ne,ve;return{c(){l=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),T=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),R=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=c(),O=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Be=n("model(input_ids)"),De=c(),C=a("li"),Ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),B=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),He=c(),P=a("li"),We=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),ve=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);T=r(se,"LI",{});var nt=d(T);i=s(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(se),D=r(se,"LI",{});var st=d(D);Pe=s(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var N=d(F);Z=s(N,"This second option is useful when using "),H=r(N,"CODE",{});var at=d(H);ee=s(at,"tf.keras.Model.fit"),at.forEach(t),Ne=s(N,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),Te=h(q),O=r(q,"UL",{});var V=d(O);j=r(V,"LI",{});var ae=d(j);ue=s(ae,"a single Tensor with "),oe=r(ae,"CODE",{});var ze=d(oe);$e=s(ze,"input_ids"),ze.forEach(t),me=s(ae," only and nothing else: "),U=r(ae,"CODE",{});var dt=d(U);Be=s(dt,"model(input_ids)"),dt.forEach(t),ae.forEach(t),De=h(V),C=r(V,"LI",{});var re=d(C);Ge=s(re,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=r(re,"CODE",{});var it=d(K);M=s(it,"model([input_ids, attention_mask])"),it.forEach(t),S=s(re," or "),B=r(re,"CODE",{});var de=d(B);Qe=s(de,"model([input_ids, attention_mask, token_type_ids])"),de.forEach(t),re.forEach(t),He=h(V),P=r(V,"LI",{});var Re=d(P);We=s(Re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=r(Re,"CODE",{});var Ue=d(ne);ve=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),Re.forEach(t),V.forEach(t)},m(q,z){g(q,l,z),e(l,b),g(q,p,z),g(q,u,z),e(u,T),e(T,i),e(u,f),e(u,D),e(D,Pe),g(q,pe,z),g(q,F,z),e(F,Z),e(F,H),e(H,ee),e(F,Ne),e(F,W),e(W,Ie),e(F,qe),g(q,I,z),g(q,R,z),e(R,te),g(q,Te,z),g(q,O,z),e(O,j),e(j,ue),e(j,oe),e(oe,$e),e(j,me),e(j,U),e(U,Be),e(O,De),e(O,C),e(C,Ge),e(C,K),e(K,M),e(C,S),e(C,B),e(B,Qe),e(O,He),e(O,P),e(P,We),e(P,ne),e(ne,ve)},d(q){q&&t(l),q&&t(p),q&&t(u),q&&t(pe),q&&t(F),q&&t(I),q&&t(R),q&&t(Te),q&&t(O)}}}function pm($){let l,b,p,u,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),T=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),v(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);b=s(f,"Examples:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,p,f),w(u,i,f),T=!0},p:je,i(i){T||(y(u.$$.fragment,i),T=!0)},o(i){E(u.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function mm($){let l,b,p,u,T,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,Te,O,j,ue,oe,$e,me,U,Be,De,C,Ge,K,M,S,B,Qe,He,P,We,ne,ve,q,z,se,nt,st,N,at,rt,Fe,V,ae,ze,dt,re,it,de,Re,Ue,rd,dd,qs,id,ld,cd,ke,hd,$s,pd,ud,Ds,md,fd,Qn,_d,gd,Fs,bd,Td,vd,X,kd,zs,wd,yd,xs,Ed,Ld,Hn,qd,$d,Ms,Dd,Fd,Ss,zd,xd,Os,Md,Sd,Od,Ve,Cd,Cs,jd,Ad,js,Pd,Nd,As,Id,Bd,Gd,$o,Qd,Do,Hd,Wd,Rd,Fo,Ud,zo,Vd,Xd,Wa,jt,Jd,xo,Zd,Kd,Ra,lt,At,Ps,Mo,Yd,Ns,ei,Ua,we,So,ti,ct,oi,Wn,ni,si,Oo,ai,ri,di,ht,ii,Rn,li,ci,Un,hi,pi,ui,Pt,Va,pt,Nt,Is,Co,mi,Bs,fi,Xa,A,jo,_i,Gs,gi,bi,It,Vn,Ti,vi,Xn,ki,wi,yi,Ao,Ei,Jn,Li,qi,$i,Xe,Po,Di,Qs,Fi,zi,No,Zn,xi,Hs,Mi,Si,Kn,Oi,Ws,Ci,ji,Bt,Io,Ai,Bo,Pi,Rs,Ni,Ii,Bi,Gt,Go,Gi,Us,Qi,Hi,Yn,Qo,Ja,ut,Qt,Vs,Ho,Wi,Xs,Ri,Za,ye,Wo,Ui,Ro,Vi,Js,Xi,Ji,Zi,Ht,es,Ki,Yi,ts,el,tl,ol,Uo,nl,os,sl,al,Ka,mt,Wt,Zs,Vo,rl,Ks,dl,Ya,ft,Xo,il,Ys,ll,er,_t,Jo,cl,ea,hl,tr,gt,Zo,pl,ta,ul,or,bt,Ko,ml,oa,fl,nr,Tt,Yo,_l,na,gl,sr,vt,en,bl,sa,Tl,ar,kt,tn,vl,aa,kl,rr,wt,on,wl,ra,yl,dr,yt,Rt,da,nn,El,ia,Ll,ir,Ee,sn,ql,an,$l,ns,Dl,Fl,zl,rn,xl,dn,Ml,Sl,Ol,xe,ln,Cl,Et,jl,ss,Al,Pl,la,Nl,Il,Bl,Ut,Gl,Vt,lr,Lt,Xt,ca,cn,Ql,ha,Hl,cr,Le,hn,Wl,pn,Rl,as,Ul,Vl,Xl,un,Jl,mn,Zl,Kl,Yl,fe,fn,ec,qt,tc,rs,oc,nc,pa,sc,ac,rc,Jt,dc,Zt,ic,Kt,hr,$t,Yt,ua,_n,lc,ma,cc,pr,ie,gn,hc,fa,pc,uc,bn,mc,ds,fc,_c,gc,Tn,bc,vn,Tc,vc,kc,G,kn,wc,Dt,yc,is,Ec,Lc,_a,qc,$c,Dc,eo,Fc,to,zc,oo,xc,no,Mc,so,ur,Ft,ao,ga,wn,Sc,ba,Oc,mr,le,yn,Cc,zt,jc,Ta,Ac,Pc,va,Nc,Ic,Bc,En,Gc,ls,Qc,Hc,Wc,Ln,Rc,qn,Uc,Vc,Xc,_e,$n,Jc,xt,Zc,cs,Kc,Yc,ka,eh,th,oh,ro,nh,io,sh,lo,fr,Mt,co,wa,Dn,ah,ya,rh,_r,ce,Fn,dh,zn,ih,hs,lh,ch,hh,xn,ph,Mn,uh,mh,fh,ho,_h,Me,Sn,gh,St,bh,ps,Th,vh,Ea,kh,wh,yh,po,Eh,uo,gr,Ot,mo,La,On,Lh,qa,qh,br,he,Cn,$h,jn,Dh,us,Fh,zh,xh,An,Mh,Pn,Sh,Oh,Ch,fo,jh,Se,Nn,Ah,Ct,Ph,ms,Nh,Ih,$a,Bh,Gh,Qh,_o,Hh,go,Tr;return i=new Oe({}),ee=new Oe({}),Mo=new Oe({}),So=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/configuration_led.py#L31"}}),Pt=new Ce({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Vu]},$$scope:{ctx:$}}}),Co=new Oe({}),jo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/tokenization_led.py#L43"}}),Po=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/bart/tokenization_bart.py#L390",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Qo=new x({props:{name:"save_vocabulary",anchor:"transformers.LEDTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/bart/tokenization_bart.py#L309"}}),Ho=new Oe({}),Wo=new x({props:{name:"class transformers.LEDTokenizerFast",anchor:"transformers.LEDTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"trim_offsets",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/tokenization_led_fast.py#L44"}}),Vo=new Oe({}),Xo=new x({props:{name:"class transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",anchor:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",parameters:[{name:"last_hidden_state",val:": FloatTensor"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"global_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_tf_led.py#L1411"}}),on=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17973/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_led.py#L2201",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17973/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_led.py#L2341",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17973/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),Jt=new qo({props:{$$slots:{default:[Zu]},$$scope:{ctx:$}}}),Zt=new Ce({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example",$$slots:{default:[Ku]},$$scope:{ctx:$}}}),Kt=new Ce({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example-2",$$slots:{default:[Yu]},$$scope:{ctx:$}}}),_n=new Oe({}),gn=new x({props:{name:"class transformers.LEDForSequenceClassification",anchor:"transformers.LEDForSequenceClassification",parameters:[{name:"config",val:": LEDConfig"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_17973/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_led.py#L2490"}}),kn=new x({props:{name:"forward",anchor:"transformers.LEDForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_led.py#L2503",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17973/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
`}}),eo=new qo({props:{$$slots:{default:[em]},$$scope:{ctx:$}}}),to=new Ce({props:{anchor:"transformers.LEDForSequenceClassification.forward.example",$$slots:{default:[tm]},$$scope:{ctx:$}}}),oo=new Ce({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-2",$$slots:{default:[om]},$$scope:{ctx:$}}}),no=new Ce({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-3",$$slots:{default:[nm]},$$scope:{ctx:$}}}),so=new Ce({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-4",$$slots:{default:[sm]},$$scope:{ctx:$}}}),wn=new Oe({}),yn=new x({props:{name:"class transformers.LEDForQuestionAnswering",anchor:"transformers.LEDForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_17973/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_led.py#L2618"}}),$n=new x({props:{name:"forward",anchor:"transformers.LEDForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_led.py#L2630",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17973/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
`}}),ro=new qo({props:{$$slots:{default:[am]},$$scope:{ctx:$}}}),io=new Ce({props:{anchor:"transformers.LEDForQuestionAnswering.forward.example",$$slots:{default:[rm]},$$scope:{ctx:$}}}),lo=new Ce({props:{anchor:"transformers.LEDForQuestionAnswering.forward.example-2",$$slots:{default:[dm]},$$scope:{ctx:$}}}),Dn=new Oe({}),Fn=new x({props:{name:"class transformers.TFLEDModel",anchor:"transformers.TFLEDModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17973/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_tf_led.py#L2235"}}),ho=new qo({props:{$$slots:{default:[im]},$$scope:{ctx:$}}}),Sn=new x({props:{name:"call",anchor:"transformers.TFLEDModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput, NoneType] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLEDModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17973/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_tf_led.py#L2247",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17973/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
`}}),po=new qo({props:{$$slots:{default:[lm]},$$scope:{ctx:$}}}),uo=new Ce({props:{anchor:"transformers.TFLEDModel.call.example",$$slots:{default:[cm]},$$scope:{ctx:$}}}),On=new Oe({}),Cn=new x({props:{name:"class transformers.TFLEDForConditionalGeneration",anchor:"transformers.TFLEDForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17973/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_tf_led.py#L2323"}}),fo=new qo({props:{$$slots:{default:[hm]},$$scope:{ctx:$}}}),Nn=new x({props:{name:"call",anchor:"transformers.TFLEDForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17973/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17973/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17973/src/transformers/models/led/modeling_tf_led.py#L2358",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17973/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
`}}),_o=new qo({props:{$$slots:{default:[pm]},$$scope:{ctx:$}}}),go=new Ce({props:{anchor:"transformers.TFLEDForConditionalGeneration.call.example",$$slots:{default:[um]},$$scope:{ctx:$}}}),{c(){l=a("meta"),b=c(),p=a("h1"),u=a("a"),T=a("span"),v(i.$$.fragment),f=c(),D=a("span"),Pe=n("LED"),pe=c(),F=a("h2"),Z=a("a"),H=a("span"),v(ee.$$.fragment),Ne=c(),W=a("span"),Ie=n("Overview"),qe=c(),I=a("p"),R=n("The LED model was proposed in "),te=a("a"),Te=n("Longformer: The Long-Document Transformer"),O=n(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),j=c(),ue=a("p"),oe=n("The abstract from the paper is the following:"),$e=c(),me=a("p"),U=a("em"),Be=n(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
dataset.`),De=c(),C=a("p"),Ge=n("Tips:"),K=c(),M=a("ul"),S=a("li"),B=a("a"),Qe=n("LEDForConditionalGeneration"),He=n(` is an extension of
`),P=a("a"),We=n("BartForConditionalGeneration"),ne=n(" exchanging the traditional "),ve=a("em"),q=n("self-attention"),z=n(` layer with
`),se=a("em"),nt=n("Longformer"),st=n("\u2019s "),N=a("em"),at=n("chunked self-attention"),rt=n(" layer. "),Fe=a("a"),V=n("LEDTokenizer"),ae=n(` is an alias of
`),ze=a("a"),dt=n("BartTokenizer"),re=n("."),it=c(),de=a("li"),Re=n("LED works very well on long-range "),Ue=a("em"),rd=n("sequence-to-sequence"),dd=n(" tasks where the "),qs=a("code"),id=n("input_ids"),ld=n(` largely exceed a length of
...
`),Hn=a("a"),qd=n("LongformerModel"),$d=n("). For summarization, it is advised to put "),Ms=a("em"),Dd=n("global attention"),Fd=n(` only on the first
`),Ss=a("code"),zd=n("<s>"),xd=n(" token. For question answering, it is advised to put "),Os=a("em"),Md=n("global attention"),Sd=n(" on all tokens of the question."),Od=c(),Ve=a("li"),Cd=n("To fine-tune LED on all 16384, "),Cs=a("em"),jd=n("gradient checkpointing"),Ad=n(` can be enabled in case training leads to out-of-memory (OOM)
errors. This can be done by executing `),js=a("code"),Pd=n("model.gradient_checkpointing_enable()"),Nd=n(`.
Moreover, the `),As=a("code"),Id=n("use_cache=False"),Bd=n(`
flag can be used to disable the caching mechanism to save memory.`),Gd=c(),$o=a("li"),Qd=n("A notebook showing how to evaluate LED, can be accessed "),Do=a("a"),Hd=n("here"),Wd=n("."),Rd=c(),Fo=a("li"),Ud=n("A notebook showing how to fine-tune LED, can be accessed "),zo=a("a"),Vd=n("here"),Xd=n("."),Wa=c(),jt=a("p"),Jd=n("This model was contributed by "),xo=a("a"),Zd=n("patrickvonplaten"),Kd=n("."),Ra=c(),lt=a("h2"),At=a("a"),Ps=a("span"),v(Mo.$$.fragment),Yd=c(),Ns=a("span"),ei=n("LEDConfig"),Ua=c(),we=a("div"),v(So.$$.fragment),ti=c(),ct=a("p"),oi=n("This is the configuration class to store the configuration of a "),Wn=a("a"),ni=n("LEDModel"),si=n(`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),Oo=a("a"),ai=n("allenai/led-base-16384"),ri=n(" architecture."),di=c(),ht=a("p"),ii=n("Configuration objects inherit from "),Rn=a("a"),li=n("PretrainedConfig"),ci=n(` and can be used to control the model outputs. Read the
documentation from `),Un=a("a"),hi=n("PretrainedConfig"),pi=n(" for more information."),ui=c(),v(Pt.$$.fragment),Va=c(),pt=a("h2"),Nt=a("a"),Is=a("span"),v(Co.$$.fragment),mi=c(),Bs=a("span"),fi=n("LEDTokenizer"),Xa=c(),A=a("div"),v(jo.$$.fragment),_i=c(),Gs=a("p"),gi=n("Construct a LED tokenizer."),bi=c(),It=a("p"),Vn=a("a"),Ti=n("LEDTokenizer"),vi=n(" is identical to "),Xn=a("a"),ki=n("BartTokenizer"),wi=n(` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),zi=c(),No=a("ul"),Zn=a("li"),xi=n("single sequence: "),Hs=a("code"),Mi=n("<s> X </s>"),Si=c(),Kn=a("li"),Oi=n("pair of sequences: "),Ws=a("code"),Ci=n("<s> A </s></s> B </s>"),ji=c(),Bt=a("div"),v(Io.$$.fragment),Ai=c(),Bo=a("p"),Pi=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Rs=a("code"),Ni=n("prepare_for_model"),Ii=n(" method."),Bi=c(),Gt=a("div"),v(Go.$$.fragment),Gi=c(),Us=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Hi=c(),Yn=a("div"),v(Qo.$$.fragment),Ja=c(),ut=a("h2"),Qt=a("a"),Vs=a("span"),v(Ho.$$.fragment),Wi=c(),Xs=a("span"),Ri=n("LEDTokenizerFast"),Za=c(),ye=a("div"),v(Wo.$$.fragment),Ui=c(),Ro=a("p"),Vi=n("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Js=a("em"),Xi=n("tokenizers"),Ji=n(" library)."),Zi=c(),Ht=a("p"),es=a("a"),Ki=n("LEDTokenizerFast"),Yi=n(" is identical to "),ts=a("a"),el=n("BartTokenizerFast"),tl=n(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),ol=c(),Uo=a("p"),nl=n("Refer to superclass "),os=a("a"),sl=n("BartTokenizerFast"),al=n(" for usage examples and documentation concerning parameters."),Ka=c(),mt=a("h2"),Wt=a("a"),Zs=a("span"),v(Vo.$$.fragment),rl=c(),Ks=a("span"),dl=n("LED specific outputs"),Ya=c(),ft=a("div"),v(Xo.$$.fragment),il=c(),Ys=a("p"),ll=n("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),er=c(),_t=a("div"),v(Jo.$$.fragment),cl=c(),ea=a("p"),hl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
decoding.`),rr=c(),wt=a("div"),v(on.$$.fragment),wl=c(),ra=a("p"),yl=n("Base class for sequence-to-sequence language models outputs."),dr=c(),yt=a("h2"),Rt=a("a"),da=a("span"),v(nn.$$.fragment),El=c(),ia=a("span"),Ll=n("LEDModel"),ir=c(),Ee=a("div"),v(sn.$$.fragment),ql=c(),an=a("p"),$l=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ol=c(),xe=a("div"),v(ln.$$.fragment),Cl=c(),Et=a("p"),jl=n("The "),ss=a("a"),Al=n("LEDModel"),Pl=n(" forward method, overrides the "),la=a("code"),Nl=n("__call__"),Il=n(" special method."),Bl=c(),v(Ut.$$.fragment),Gl=c(),v(Vt.$$.fragment),lr=c(),Lt=a("h2"),Xt=a("a"),ca=a("span"),v(cn.$$.fragment),Ql=c(),ha=a("span"),Hl=n("LEDForConditionalGeneration"),cr=c(),Le=a("div"),v(hn.$$.fragment),Wl=c(),pn=a("p"),Rl=n(`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),as=a("a"),Ul=n("PreTrainedModel"),Vl=n(`. See the superclass documentation for the generic methods the library
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),kc=c(),G=a("div"),v(kn.$$.fragment),wc=c(),Dt=a("p"),yc=n("The "),is=a("a"),Ec=n("LEDForSequenceClassification"),Lc=n(" forward method, overrides the "),_a=a("code"),qc=n("__call__"),$c=n(" special method."),Dc=c(),v(eo.$$.fragment),Fc=c(),v(to.$$.fragment),zc=c(),v(oo.$$.fragment),xc=c(),v(no.$$.fragment),Mc=c(),v(so.$$.fragment),ur=c(),Ft=a("h2"),ao=a("a"),ga=a("span"),v(wn.$$.fragment),Sc=c(),ba=a("span"),Oc=n("LEDForQuestionAnswering"),mr=c(),le=a("div"),v(yn.$$.fragment),Cc=c(),zt=a("p"),jc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ta=a("code"),Ac=n("span start logits"),Pc=n(" and "),va=a("code"),Nc=n("span end logits"),Ic=n(")."),Bc=c(),En=a("p"),Gc=n("This model inherits from "),ls=a("a"),Qc=n("PreTrainedModel"),Hc=n(`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Wc=c(),Ln=a("p"),Rc=n("This model is also a PyTorch "),qn=a("a"),Uc=n("torch.nn.Module"),Vc=n(` subclass.
...
behavior.`),fh=c(),v(ho.$$.fragment),_h=c(),Me=a("div"),v(Sn.$$.fragment),gh=c(),St=a("p"),bh=n("The "),ps=a("a"),Th=n("TFLEDModel"),vh=n(" forward method, overrides the "),Ea=a("code"),kh=n("__call__"),wh=n(" special method."),yh=c(),v(po.$$.fragment),Eh=c(),v(uo.$$.fragment),gr=c(),Ot=a("h2"),mo=a("a"),La=a("span"),v(On.$$.fragment),Lh=c(),qa=a("span"),qh=n("TFLEDForConditionalGeneration"),br=c(),he=a("div"),v(Cn.$$.fragment),$h=c(),jn=a("p"),Dh=n(`The LED Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xh=c(),An=a("p"),Mh=n("This model is also a "),Pn=a("a"),Sh=n("tf.keras.Model"),Oh=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ch=c(),v(fo.$$.fragment),jh=c(),Se=a("div"),v(Nn.$$.fragment),Ah=c(),Ct=a("p"),Ph=n("The "),ms=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),$a=a("code"),Bh=n("__call__"),Gh=n(" special method."),Qh=c(),v(_o.$$.fragment),Hh=c(),v(go.$$.fragment),this.h()},l(o){const _=Ru('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),p=r(o,"H1",{class:!0});var In=d(p);u=r(In,"A",{id:!0,class:!0,href:!0});var Da=d(u);T=r(Da,"SPAN",{});var Fa=d(T);k(i.$$.fragment,Fa),Fa.forEach(t),Da.forEach(t),f=h(In),D=r(In,"SPAN",{});var za=d(D);Pe=s(za,"LED"),za.forEach(t),In.forEach(t),pe=h(o),F=r(o,"H2",{class:!0});var Bn=d(F);Z=r(Bn,"A",{id:!0,class:!0,href:!0});var xa=d(Z);H=r(xa,"SPAN",{});var Ma=d(H);k(ee.$$.fragment,Ma),Ma.forEach(t),xa.forEach(t),Ne=h(Bn),W=r(Bn,"SPAN",{});var Sa=d(W);Ie=s(Sa,"Overview"),Sa.forEach(t),Bn.forEach(t),qe=h(o),I=r(o,"P",{});var Gn=d(I);R=s(Gn,"The LED model was proposed in "),te=r(Gn,"A",{href:!0,rel:!0});var Oa=d(te);Te=s(Oa,"Longformer: The Long-Document Transformer"),Oa.forEach(t),O=s(Gn,` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),Gn.forEach(t),j=h(o),ue=r(o,"P",{});var Ca=d(ue);oe=s(Ca,"The abstract from the paper is the following:"),Ca.forEach(t),$e=h(o),me=r(o,"P",{});var ja=d(me);U=r(ja,"EM",{});var Aa=d(U);Be=s(Aa,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
WikiHop and TriviaQA. We finally introduce the Longformer-Encoder-Decoder (LED), a Longformer variant for supporting
long document generative sequence-to-sequence tasks, and demonstrate its effectiveness on the arXiv summarization
dataset.`),Aa.forEach(t),ja.forEach(t),De=h(o),C=r(o,"P",{});var Pa=d(C);Ge=s(Pa,"Tips:"),Pa.forEach(t),K=h(o),M=r(o,"UL",{});var J=d(M);S=r(J,"LI",{});var Q=d(S);B=r(Q,"A",{href:!0});var Na=d(B);Qe=s(Na,"LEDForConditionalGeneration"),Na.forEach(t),He=s(Q,` is an extension of
`),P=r(Q,"A",{href:!0});var Ia=d(P);We=s(Ia,"BartForConditionalGeneration"),Ia.forEach(t),ne=s(Q," exchanging the traditional "),ve=r(Q,"EM",{});var Ba=d(ve);q=s(Ba,"self-attention"),Ba.forEach(t),z=s(Q,` layer with
`),se=r(Q,"EM",{});var Ga=d(se);nt=s(Ga,"Longformer"),Ga.forEach(t),st=s(Q,"\u2019s "),N=r(Q,"EM",{});var Uh=d(N);at=s(Uh,"chunked self-attention"),Uh.forEach(t),rt=s(Q," layer. "),Fe=r(Q,"A",{href:!0});var Vh=d(Fe);V=s(Vh,"LEDTokenizer"),Vh.forEach(t),ae=s(Q,` is an alias of
`),ze=r(Q,"A",{href:!0});var Xh=d(ze);dt=s(Xh,"BartTokenizer"),Xh.forEach(t),re=s(Q,"."),Q.forEach(t),it=h(J),de=r(J,"LI",{});var fs=d(de);Re=s(fs,"LED works very well on long-range "),Ue=r(fs,"EM",{});var Jh=d(Ue);rd=s(Jh,"sequence-to-sequence"),Jh.forEach(t),dd=s(fs," tasks where the "),qs=r(fs,"CODE",{});var Zh=d(qs);id=s(Zh,"input_ids"),Zh.forEach(t),ld=s(fs,` largely exceed a length of
...
`),Hn=r(ge,"A",{href:!0});var sp=d(Hn);qd=s(sp,"LongformerModel"),sp.forEach(t),$d=s(ge,"). For summarization, it is advised to put "),Ms=r(ge,"EM",{});var ap=d(Ms);Dd=s(ap,"global attention"),ap.forEach(t),Fd=s(ge,` only on the first
`),Ss=r(ge,"CODE",{});var rp=d(Ss);zd=s(rp,"<s>"),rp.forEach(t),xd=s(ge," token. For question answering, it is advised to put "),Os=r(ge,"EM",{});var dp=d(Os);Md=s(dp,"global attention"),dp.forEach(t),Sd=s(ge," on all tokens of the question."),ge.forEach(t),Od=h(J),Ve=r(J,"LI",{});var bo=d(Ve);Cd=s(bo,"To fine-tune LED on all 16384, "),Cs=r(bo,"EM",{});var ip=d(Cs);jd=s(ip,"gradient checkpointing"),ip.forEach(t),Ad=s(bo,` can be enabled in case training leads to out-of-memory (OOM)
...
Moreover, the `),As=r(bo,"CODE",{});var cp=d(As);Id=s(cp,"use_cache=False"),cp.forEach(t),Bd=s(bo,`
flag can be used to disable the caching mechanism to save memory.`),bo.forEach(t),Gd=h(J),$o=r(J,"LI",{});var vr=d($o);Qd=s(vr,"A notebook showing how to evaluate LED, can be accessed "),Do=r(vr,"A",{href:!0,rel:!0});var hp=d(Do);Hd=s(hp,"here"),hp.forEach(t),Wd=s(vr,"."),vr.forEach(t),Rd=h(J),Fo=r(J,"LI",{});var kr=d(Fo);Ud=s(kr,"A notebook showing how to fine-tune LED, can be accessed "),zo=r(kr,"A",{href:!0,rel:!0});var pp=d(zo);Vd=s(pp,"here"),pp.forEach(t),Xd=s(kr,"."),kr.forEach(t),J.forEach(t),Wa=h(o),jt=r(o,"P",{});var wr=d(jt);Jd=s(wr,"This model was contributed by "),xo=r(wr,"A",{href:!0,rel:!0});var up=d(xo);Zd=s(up,"patrickvonplaten"),up.forEach(t),Kd=s(wr,"."),wr.forEach(t),Ra=h(o),lt=r(o,"H2",{class:!0});var yr=d(lt);At=r(yr,"A",{id:!0,class:!0,href:!0});var mp=d(At);Ps=r(mp,"SPAN",{});var fp=d(Ps);k(Mo.$$.fragment,fp),fp.forEach(t),mp.forEach(t),Yd=h(yr),Ns=r(yr,"SPAN",{});var _p=d(Ns);ei=s(_p,"LEDConfig"),_p.forEach(t),yr.forEach(t),Ua=h(o),we=r(o,"DIV",{class:!0});var To=d(we);k(So.$$.fragment,To),ti=h(To),ct=r(To,"P",{});var _s=d(ct);oi=s(_s,"This is the configuration class to store the configuration of a "),Wn=r(_s,"A",{href:!0});var gp=d(Wn);ni=s(gp,"LEDModel"),gp.forEach(t),si=s(_s,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),Oo=r(_s,"A",{href:!0,rel:!0});var bp=d(Oo);ai=s(bp,"allenai/led-base-16384"),bp.forEach(t),ri=s(_s," architecture."),_s.forEach(t),di=h(To),ht=r(To,"P",{});var gs=d(ht);ii=s(gs,"Configuration objects inherit from "),Rn=r(gs,"A",{href:!0});var Tp=d(Rn);li=s(Tp,"PretrainedConfig"),Tp.forEach(t),ci=s(gs,` and can be used to control the model outputs. Read the
documentation from `),Un=r(gs,"A",{href:!0});var vp=d(Un);hi=s(vp,"PretrainedConfig"),vp.forEach(t),pi=s(gs," for more information."),gs.forEach(t),ui=h(To),k(Pt.$$.fragment,To),To.forEach(t),Va=h(o),pt=r(o,"H2",{class:!0});var Er=d(pt);Nt=r(Er,"A",{id:!0,class:!0,href:!0});var kp=d(Nt);Is=r(kp,"SPAN",{});var wp=d(Is);k(Co.$$.fragment,wp),wp.forEach(t),kp.forEach(t),mi=h(Er),Bs=r(Er,"SPAN",{});var yp=d(Bs);fi=s(yp,"LEDTokenizer"),yp.forEach(t),Er.forEach(t),Xa=h(o),A=r(o,"DIV",{class:!0});var Y=d(A);k(jo.$$.fragment,Y),_i=h(Y),Gs=r(Y,"P",{});var Ep=d(Gs);gi=s(Ep,"Construct a LED tokenizer."),Ep.forEach(t),bi=h(Y),It=r(Y,"P",{});var Qa=d(It);Vn=r(Qa,"A",{href:!0});var Lp=d(Vn);Ti=s(Lp,"LEDTokenizer"),Lp.forEach(t),vi=s(Qa," is identical to "),Xn=r(Qa,"A",{href:!0});var qp=d(Xn);ki=s(qp,"BartTokenizer"),qp.forEach(t),wi=s(Qa,` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),Dp.forEach(t),zi=h(bs),No=r(bs,"UL",{});var qr=d(No);Zn=r(qr,"LI",{});var Wh=d(Zn);xi=s(Wh,"single sequence: "),Hs=r(Wh,"CODE",{});var Fp=d(Hs);Mi=s(Fp,"<s> X </s>"),Fp.forEach(t),Wh.forEach(t),Si=h(qr),Kn=r(qr,"LI",{});var Rh=d(Kn);Oi=s(Rh,"pair of sequences: "),Ws=r(Rh,"CODE",{});var zp=d(Ws);Ci=s(zp,"<s> A </s></s> B </s>"),zp.forEach(t),Rh.forEach(t),qr.forEach(t),bs.forEach(t),ji=h(Y),Bt=r(Y,"DIV",{class:!0});var $r=d(Bt);k(Io.$$.fragment,$r),Ai=h($r),Bo=r($r,"P",{});var Dr=d(Bo);Pi=s(Dr,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Rs=r(Dr,"CODE",{});var xp=d(Rs);Ni=s(xp,"prepare_for_model"),xp.forEach(t),Ii=s(Dr," method."),Dr.forEach(t),$r.forEach(t),Bi=h(Y),Gt=r(Y,"DIV",{class:!0});var Fr=d(Gt);k(Go.$$.fragment,Fr),Gi=h(Fr),Us=r(Fr,"P",{});var Mp=d(Us);Qi=s(Mp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Mp.forEach(t),Fr.forEach(t),Hi=h(Y),Yn=r(Y,"DIV",{class:!0});var Sp=d(Yn);k(Qo.$$.fragment,Sp),Sp.forEach(t),Y.forEach(t),Ja=h(o),ut=r(o,"H2",{class:!0});var zr=d(ut);Qt=r(zr,"A",{id:!0,class:!0,href:!0});var Op=d(Qt);Vs=r(Op,"SPAN",{});var Cp=d(Vs);k(Ho.$$.fragment,Cp),Cp.forEach(t),Op.forEach(t),Wi=h(zr),Xs=r(zr,"SPAN",{});var jp=d(Xs);Ri=s(jp,"LEDTokenizerFast"),jp.forEach(t),zr.forEach(t),Za=h(o),ye=r(o,"DIV",{class:!0});var vo=d(ye);k(Wo.$$.fragment,vo),Ui=h(vo),Ro=r(vo,"P",{});var xr=d(Ro);Vi=s(xr,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Js=r(xr,"EM",{});var Ap=d(Js);Xi=s(Ap,"tokenizers"),Ap.forEach(t),Ji=s(xr," library)."),xr.forEach(t),Zi=h(vo),Ht=r(vo,"P",{});var Ha=d(Ht);es=r(Ha,"A",{href:!0});var Pp=d(es);Ki=s(Pp,"LEDTokenizerFast"),Pp.forEach(t),Yi=s(Ha," is identical to "),ts=r(Ha,"A",{href:!0});var Np=d(ts);el=s(Np,"BartTokenizerFast"),Np.forEach(t),tl=s(Ha,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Ha.forEach(t),ol=h(vo),Uo=r(vo,"P",{});var Mr=d(Uo);nl=s(Mr,"Refer to superclass "),os=r(Mr,"A",{href:!0});var Ip=d(os);sl=s(Ip,"BartTokenizerFast"),Ip.forEach(t),al=s(Mr," for usage examples and documentation concerning parameters."),Mr.forEach(t),vo.forEach(t),Ka=h(o),mt=r(o,"H2",{class:!0});var Sr=d(mt);Wt=r(Sr,"A",{id:!0,class:!0,href:!0});var Bp=d(Wt);Zs=r(Bp,"SPAN",{});var Gp=d(Zs);k(Vo.$$.fragment,Gp),Gp.forEach(t),Bp.forEach(t),rl=h(Sr),Ks=r(Sr,"SPAN",{});var Qp=d(Ks);dl=s(Qp,"LED specific outputs"),Qp.forEach(t),Sr.forEach(t),Ya=h(o),ft=r(o,"DIV",{class:!0});var Or=d(ft);k(Xo.$$.fragment,Or),il=h(Or),Ys=r(Or,"P",{});var Hp=d(Ys);ll=s(Hp,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Hp.forEach(t),Or.forEach(t),er=h(o),_t=r(o,"DIV",{class:!0});var Cr=d(_t);k(Jo.$$.fragment,Cr),cl=h(Cr),ea=r(Cr,"P",{});var Wp=d(ea);hl=s(Wp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Wp.forEach(t),Cr.forEach(t),tr=h(o),gt=r(o,"DIV",{class:!0});var jr=d(gt);k(Zo.$$.fragment,jr),pl=h(jr),ta=r(jr,"P",{});var Rp=d(ta);ul=s(Rp,"Base class for sequence-to-sequence language models outputs."),Rp.forEach(t),jr.forEach(t),or=h(o),bt=r(o,"DIV",{class:!0});var Ar=d(bt);k(Ko.$$.fragment,Ar),ml=h(Ar),oa=r(Ar,"P",{});var Up=d(oa);fl=s(Up,"Base class for outputs of sequence-to-sequence sentence classification models."),Up.forEach(t),Ar.forEach(t),nr=h(o),Tt=r(o,"DIV",{class:!0});var Pr=d(Tt);k(Yo.$$.fragment,Pr),_l=h(Pr),na=r(Pr,"P",{});var Vp=d(na);gl=s(Vp,"Base class for outputs of sequence-to-sequence question answering models."),Vp.forEach(t),Pr.forEach(t),sr=h(o),vt=r(o,"DIV",{class:!0});var Nr=d(vt);k(en.$$.fragment,Nr),bl=h(Nr),sa=r(Nr,"P",{});var Xp=d(sa);Tl=s(Xp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Xp.forEach(t),Nr.forEach(t),ar=h(o),kt=r(o,"DIV",{class:!0});var Ir=d(kt);k(tn.$$.fragment,Ir),vl=h(Ir),aa=r(Ir,"P",{});var Jp=d(aa);kl=s(Jp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Jp.forEach(t),Ir.forEach(t),rr=h(o),wt=r(o,"DIV",{class:!0});var Br=d(wt);k(on.$$.fragment,Br),wl=h(Br),ra=r(Br,"P",{});var Zp=d(ra);yl=s(Zp,"Base class for sequence-to-sequence language models outputs."),Zp.forEach(t),Br.forEach(t),dr=h(o),yt=r(o,"H2",{class:!0});var Gr=d(yt);Rt=r(Gr,"A",{id:!0,class:!0,href:!0});var Kp=d(Rt);da=r(Kp,"SPAN",{});var Yp=d(da);k(nn.$$.fragment,Yp),Yp.forEach(t),Kp.forEach(t),El=h(Gr),ia=r(Gr,"SPAN",{});var eu=d(ia);Ll=s(eu,"LEDModel"),eu.forEach(t),Gr.forEach(t),ir=h(o),Ee=r(o,"DIV",{class:!0});var ko=d(Ee);k(sn.$$.fragment,ko),ql=h(ko),an=r(ko,"P",{});var Qr=d(an);$l=s(Qr,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Qr.forEach(t),zl=h(ko),rn=r(ko,"P",{});var Hr=d(rn);xl=s(Hr,"This model is also a PyTorch "),dn=r(Hr,"A",{href:!0,rel:!0});var ou=d(dn);Ml=s(ou,"torch.nn.Module"),ou.forEach(t),Sl=s(Hr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Hr.forEach(t),Ol=h(ko),xe=r(ko,"DIV",{class:!0});var wo=d(xe);k(ln.$$.fragment,wo),Cl=h(wo),Et=r(wo,"P",{});var Ts=d(Et);jl=s(Ts,"The "),ss=r(Ts,"A",{href:!0});var nu=d(ss);Al=s(nu,"LEDModel"),nu.forEach(t),Pl=s(Ts," forward method, overrides the "),la=r(Ts,"CODE",{});var su=d(la);Nl=s(su,"__call__"),su.forEach(t),Il=s(Ts," special method."),Ts.forEach(t),Bl=h(wo),k(Ut.$$.fragment,wo),Gl=h(wo),k(Vt.$$.fragment,wo),wo.forEach(t),ko.forEach(t),lr=h(o),Lt=r(o,"H2",{class:!0});var Wr=d(Lt);Xt=r(Wr,"A",{id:!0,class:!0,href:!0});var au=d(Xt);ca=r(au,"SPAN",{});var ru=d(ca);k(cn.$$.fragment,ru),ru.forEach(t),au.forEach(t),Ql=h(Wr),ha=r(Wr,"SPAN",{});var du=d(ha);Hl=s(du,"LEDForConditionalGeneration"),du.forEach(t),Wr.forEach(t),cr=h(o),Le=r(o,"DIV",{class:!0});var yo=d(Le);k(hn.$$.fragment,yo),Wl=h(yo),pn=r(yo,"P",{});var Rr=d(pn);Rl=s(Rr,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),as=r(Rr,"A",{href:!0});var iu=d(as);Ul=s(iu,"PreTrainedModel"),iu.forEach(t),Vl=s(Rr,`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Rr.forEach(t),Xl=h(yo),un=r(yo,"P",{});var Ur=d(un);Jl=s(Ur,"This model is also a PyTorch "),mn=r(Ur,"A",{href:!0,rel:!0});var lu=d(mn);Zl=s(lu,"torch.nn.Module"),lu.forEach(t),Kl=s(Ur,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ur.forEach(t),Yl=h(yo),fe=r(yo,"DIV",{class:!0});var Ze=d(fe);k(fn.$$.fragment,Ze),ec=h(Ze),qt=r(Ze,"P",{});var vs=d(qt);tc=s(vs,"The "),rs=r(vs,"A",{href:!0});var cu=d(rs);oc=s(cu,"LEDForConditionalGeneration"),cu.forEach(t),nc=s(vs," forward method, overrides the "),pa=r(vs,"CODE",{});var hu=d(pa);sc=s(hu,"__call__"),hu.forEach(t),ac=s(vs," special method."),vs.forEach(t),rc=h(Ze),k(Jt.$$.fragment,Ze),dc=h(Ze),k(Zt.$$.fragment,Ze),ic=h(Ze),k(Kt.$$.fragment,Ze),Ze.forEach(t),yo.forEach(t),hr=h(o),$t=r(o,"H2",{class:!0});var Vr=d($t);Yt=r(Vr,"A",{id:!0,class:!0,href:!0});var pu=d(Yt);ua=r(pu,"SPAN",{});var uu=d(ua);k(_n.$$.fragment,uu),uu.forEach(t),pu.forEach(t),lc=h(Vr),ma=r(Vr,"SPAN",{});var mu=d(ma);cc=s(mu,"LEDForSequenceClassification"),mu.forEach(t),Vr.forEach(t),pr=h(o),ie=r(o,"DIV",{class:!0});var Ke=d(ie);k(gn.$$.fragment,Ke),hc=h(Ke),fa=r(Ke,"P",{});var fu=d(fa);pc=s(fu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Jr.forEach(t),kc=h(Ke),G=r(Ke,"DIV",{class:!0});var be=d(G);k(kn.$$.fragment,be),wc=h(be),Dt=r(be,"P",{});var ks=d(Dt);yc=s(ks,"The "),is=r(ks,"A",{href:!0});var bu=d(is);Ec=s(bu,"LEDForSequenceClassification"),bu.forEach(t),Lc=s(ks," forward method, overrides the "),_a=r(ks,"CODE",{});var Tu=d(_a);qc=s(Tu,"__call__"),Tu.forEach(t),$c=s(ks," special method."),ks.forEach(t),Dc=h(be),k(eo.$$.fragment,be),Fc=h(be),k(to.$$.fragment,be),zc=h(be),k(oo.$$.fragment,be),xc=h(be),k(no.$$.fragment,be),Mc=h(be),k(so.$$.fragment,be),be.forEach(t),Ke.forEach(t),ur=h(o),Ft=r(o,"H2",{class:!0});var Zr=d(Ft);ao=r(Zr,"A",{id:!0,class:!0,href:!0});var vu=d(ao);ga=r(vu,"SPAN",{});var ku=d(ga);k(wn.$$.fragment,ku),ku.forEach(t),vu.forEach(t),Sc=h(Zr),ba=r(Zr,"SPAN",{});var wu=d(ba);Oc=s(wu,"LEDForQuestionAnswering"),wu.forEach(t),Zr.forEach(t),mr=h(o),le=r(o,"DIV",{class:!0});var Ye=d(le);k(yn.$$.fragment,Ye),Cc=h(Ye),zt=r(Ye,"P",{});var ws=d(zt);jc=s(ws,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ta=r(ws,"CODE",{});var yu=d(Ta);Ac=s(yu,"span start logits"),yu.forEach(t),Pc=s(ws," and "),va=r(ws,"CODE",{});var Eu=d(va);Nc=s(Eu,"span end logits"),Eu.forEach(t),Ic=s(ws,")."),ws.forEach(t),Bc=h(Ye),En=r(Ye,"P",{});var Kr=d(En);Gc=s(Kr,"This model inherits from "),ls=r(Kr,"A",{href:!0});var Lu=d(ls);Qc=s(Lu,"PreTrainedModel"),Lu.forEach(t),Hc=s(Kr,`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Kr.forEach(t),Wc=h(Ye),Ln=r(Ye,"P",{});var Yr=d(Ln);Rc=s(Yr,"This model is also a PyTorch "),qn=r(Yr,"A",{href:!0,rel:!0});var qu=d(qn);Uc=s(qu,"torch.nn.Module"),qu.forEach(t),Vc=s(Yr,` subclass.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),od.forEach(t),fh=h(tt),k(ho.$$.fragment,tt),_h=h(tt),Me=r(tt,"DIV",{class:!0});var Eo=d(Me);k(Sn.$$.fragment,Eo),gh=h(Eo),St=r(Eo,"P",{});var Es=d(St);bh=s(Es,"The "),ps=r(Es,"A",{href:!0});var Ou=d(ps);Th=s(Ou,"TFLEDModel"),Ou.forEach(t),vh=s(Es," forward method, overrides the "),Ea=r(Es,"CODE",{});var Cu=d(Ea);kh=s(Cu,"__call__"),Cu.forEach(t),wh=s(Es," special method."),Es.forEach(t),yh=h(Eo),k(po.$$.fragment,Eo),Eh=h(Eo),k(uo.$$.fragment,Eo),Eo.forEach(t),tt.forEach(t),gr=h(o),Ot=r(o,"H2",{class:!0});var nd=d(Ot);mo=r(nd,"A",{id:!0,class:!0,href:!0});var ju=d(mo);La=r(ju,"SPAN",{});var Au=d(La);k(On.$$.fragment,Au),Au.forEach(t),ju.forEach(t),Lh=h(nd),qa=r(nd,"SPAN",{});var Pu=d(qa);qh=s(Pu,"TFLEDForConditionalGeneration"),Pu.forEach(t),nd.forEach(t),br=h(o),he=r(o,"DIV",{class:!0});var ot=d(he);k(Cn.$$.fragment,ot),$h=h(ot),jn=r(ot,"P",{});var sd=d(jn);Dh=s(sd,`The LED Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sd.forEach(t),xh=h(ot),An=r(ot,"P",{});var ad=d(An);Mh=s(ad,"This model is also a "),Pn=r(ad,"A",{href:!0,rel:!0});var Iu=d(Pn);Sh=s(Iu,"tf.keras.Model"),Iu.forEach(t),Oh=s(ad,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ad.forEach(t),Ch=h(ot),k(fo.$$.fragment,ot),jh=h(ot),Se=r(ot,"DIV",{class:!0});var Lo=d(Se);k(Nn.$$.fragment,Lo),Ah=h(Lo),Ct=r(Lo,"P",{});var Ls=d(Ct);Ph=s(Ls,"The "),ms=r(Ls,"A",{href:!0});var Bu=d(ms);Nh=s(Bu,"TFLEDForConditionalGeneration"),Bu.forEach(t),Ih=s(Ls," forward method, overrides the "),$a=r(Ls,"CODE",{});var Gu=d($a);Bh=s(Gu,"__call__"),Gu.forEach(t),Gh=s(Ls," special method."),Ls.forEach(t),Qh=h(Lo),k(_o.$$.fragment,Lo),Hh=h(Lo),k(go.$$.fragment,Lo),Lo.forEach(t),ot.forEach(t),this.h()},h(){m(l,"name","hf:doc:metadata"),m(l,"content",JSON.stringify(fm)),m(u,"id","led"),m(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(u,"href","#led"),m(p,"class","relative group"),m(Z,"id","overview"),m(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Z,"href","#overview"),m(F,"class","relative group"),m(te,"href","https://arxiv.org/abs/2004.05150"),m(te,"rel","nofollow"),m(B,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDForConditionalGeneration"),m(P,"href","/docs/transformers/pr_17973/en/model_doc/bart#transformers.BartForConditionalGeneration"),m(Fe,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDTokenizer"),m(ze,"href","/docs/transformers/pr_17973/en/model_doc/bart#transformers.BartTokenizer"),m(Qn,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDTokenizer"),m(Hn,"href","/docs/transformers/pr_17973/en/model_doc/longformer#transformers.LongformerModel"),m(Do,"href","https://colab.research.google.com/drive/12INTTR6n64TzS4RrXZxMSXfrOd9Xzamo?usp=sharing"),m(Do,"rel","nofollow"),m(zo,"href","https://colab.research.google.com/drive/12LjJazBl7Gam0XBPy_y0CTOJZeZ34c2v?usp=sharing"),m(zo,"rel","nofollow"),m(xo,"href","https://huggingface.co/patrickvonplaten"),m(xo,"rel","nofollow"),m(At,"id","transformers.LEDConfig"),m(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(At,"href","#transformers.LEDConfig"),m(lt,"class","relative group"),m(Wn,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDModel"),m(Oo,"href","https://huggingface.co/allenai/led-base-16384"),m(Oo,"rel","nofollow"),m(Rn,"href","/docs/transformers/pr_17973/en/main_classes/configuration#transformers.PretrainedConfig"),m(Un,"href","/docs/transformers/pr_17973/en/main_classes/configuration#transformers.PretrainedConfig"),m(we,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Nt,"id","transformers.LEDTokenizer"),m(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Nt,"href","#transformers.LEDTokenizer"),m(pt,"class","relative group"),m(Vn,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDTokenizer"),m(Xn,"href","/docs/transformers/pr_17973/en/model_doc/bart#transformers.BartTokenizer"),m(Jn,"href","/docs/transformers/pr_17973/en/model_doc/bart#transformers.BartTokenizer"),m(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Yn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Qt,"id","transformers.LEDTokenizerFast"),m(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Qt,"href","#transformers.LEDTokenizerFast"),m(ut,"class","relative group"),m(es,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDTokenizerFast"),m(ts,"href","/docs/transformers/pr_17973/en/model_doc/bart#transformers.BartTokenizerFast"),m(os,"href","/docs/transformers/pr_17973/en/model_doc/bart#transformers.BartTokenizerFast"),m(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Wt,"id","transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),m(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Wt,"href","#transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),m(mt,"class","relative group"),m(ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(_t,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(wt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Rt,"id","transformers.LEDModel"),m(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Rt,"href","#transformers.LEDModel"),m(yt,"class","relative group"),m(ns,"href","/docs/transformers/pr_17973/en/main_classes/model#transformers.PreTrainedModel"),m(dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(dn,"rel","nofollow"),m(ss,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDModel"),m(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Xt,"id","transformers.LEDForConditionalGeneration"),m(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Xt,"href","#transformers.LEDForConditionalGeneration"),m(Lt,"class","relative group"),m(as,"href","/docs/transformers/pr_17973/en/main_classes/model#transformers.PreTrainedModel"),m(mn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(mn,"rel","nofollow"),m(rs,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDForConditionalGeneration"),m(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Yt,"id","transformers.LEDForSequenceClassification"),m(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Yt,"href","#transformers.LEDForSequenceClassification"),m($t,"class","relative group"),m(ds,"href","/docs/transformers/pr_17973/en/main_classes/model#transformers.PreTrainedModel"),m(vn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(vn,"rel","nofollow"),m(is,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDForSequenceClassification"),m(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ao,"id","transformers.LEDForQuestionAnswering"),m(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ao,"href","#transformers.LEDForQuestionAnswering"),m(Ft,"class","relative group"),m(ls,"href","/docs/transformers/pr_17973/en/main_classes/model#transformers.PreTrainedModel"),m(qn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(qn,"rel","nofollow"),m(cs,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.LEDForQuestionAnswering"),m(_e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(co,"id","transformers.TFLEDModel"),m(co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(co,"href","#transformers.TFLEDModel"),m(Mt,"class","relative group"),m(hs,"href","/docs/transformers/pr_17973/en/main_classes/model#transformers.TFPreTrainedModel"),m(Mn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(Mn,"rel","nofollow"),m(ps,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.TFLEDModel"),m(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(mo,"id","transformers.TFLEDForConditionalGeneration"),m(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(mo,"href","#transformers.TFLEDForConditionalGeneration"),m(Ot,"class","relative group"),m(us,"href","/docs/transformers/pr_17973/en/main_classes/model#transformers.TFPreTrainedModel"),m(Pn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(Pn,"rel","nofollow"),m(ms,"href","/docs/transformers/pr_17973/en/model_doc/led#transformers.TFLEDForConditionalGeneration"),m(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,l),g(o,b,_),g(o,p,_),e(p,u),e(u,T),w(i,T,null),e(p,f),e(p,D),e(D,Pe),g(o,pe,_),g(o,F,_),e(F,Z),e(Z,H),w(ee,H,null),e(F,Ne),e(F,W),e(W,Ie),g(o,qe,_),g(o,I,_),e(I,R),e(I,te),e(te,Te),e(I,O),g(o,j,_),g(o,ue,_),e(ue,oe),g(o,$e,_),g(o,me,_),e(me,U),e(U,Be),g(o,De,_),g(o,C,_),e(C,Ge),g(o,K,_),g(o,M,_),e(M,S),e(S,B),e(B,Qe),e(S,He),e(S,P),e(P,We),e(S,ne),e(S,ve),e(ve,q),e(S,z),e(S,se),e(se,nt),e(S,st),e(S,N),e(N,at),e(S,rt),e(S,Fe),e(Fe,V),e(S,ae),e(S,ze),e(ze,dt),e(S,re),e(M,it),e(M,de),e(de,Re),e(de,Ue),e(Ue,rd),e(de,dd),e(de,qs),e(qs,id),e(de,ld),e(M,cd),e(M,ke),e(ke,hd),e(ke,$s),e($s,pd),e(ke,ud),e(ke,Ds),e(Ds,md),e(ke,fd),e(ke,Qn),e(Qn,_d),e(ke,gd),e(ke,Fs),e(Fs,bd),e(ke,Td),e(M,vd),e(M,X),e(X,kd),e(X,zs),e(zs,wd),e(X,yd),e(X,xs),e(xs,Ed),e(X,Ld),e(X,Hn),e(Hn,qd),e(X,$d),e(X,Ms),e(Ms,Dd),e(X,Fd),e(X,Ss),e(Ss,zd),e(X,xd),e(X,Os),e(Os,Md),e(X,Sd),e(M,Od),e(M,Ve),e(Ve,Cd),e(Ve,Cs),e(Cs,jd),e(Ve,Ad),e(Ve,js),e(js,Pd),e(Ve,Nd),e(Ve,As),e(As,Id),e(Ve,Bd),e(M,Gd),e(M,$o),e($o,Qd),e($o,Do),e(Do,Hd),e($o,Wd),e(M,Rd),e(M,Fo),e(Fo,Ud),e(Fo,zo),e(zo,Vd),e(Fo,Xd),g(o,Wa,_),g(o,jt,_),e(jt,Jd),e(jt,xo),e(xo,Zd),e(jt,Kd),g(o,Ra,_),g(o,lt,_),e(lt,At),e(At,Ps),w(Mo,Ps,null),e(lt,Yd),e(lt,Ns),e(Ns,ei),g(o,Ua,_),g(o,we,_),w(So,we,null),e(we,ti),e(we,ct),e(ct,oi),e(ct,Wn),e(Wn,ni),e(ct,si),e(ct,Oo),e(Oo,ai),e(ct,ri),e(we,di),e(we,ht),e(ht,ii),e(ht,Rn),e(Rn,li),e(ht,ci),e(ht,Un),e(Un,hi),e(ht,pi),e(we,ui),w(Pt,we,null),g(o,Va,_),g(o,pt,_),e(pt,Nt),e(Nt,Is),w(Co,Is,null),e(pt,mi),e(pt,Bs),e(Bs,fi),g(o,Xa,_),g(o,A,_),w(jo,A,null),e(A,_i),e(A,Gs),e(Gs,gi),e(A,bi),e(A,It),e(It,Vn),e(Vn,Ti),e(It,vi),e(It,Xn),e(Xn,ki),e(It,wi),e(A,yi),e(A,Ao),e(Ao,Ei),e(Ao,Jn),e(Jn,Li),e(Ao,qi),e(A,$i),e(A,Xe),w(Po,Xe,null),e(Xe,Di),e(Xe,Qs),e(Qs,Fi),e(Xe,zi),e(Xe,No),e(No,Zn),e(Zn,xi),e(Zn,Hs),e(Hs,Mi),e(No,Si),e(No,Kn),e(Kn,Oi),e(Kn,Ws),e(Ws,Ci),e(A,ji),e(A,Bt),w(Io,Bt,null),e(Bt,Ai),e(Bt,Bo),e(Bo,Pi),e(Bo,Rs),e(Rs,Ni),e(Bo,Ii),e(A,Bi),e(A,Gt),w(Go,Gt,null),e(Gt,Gi),e(Gt,Us),e(Us,Qi),e(A,Hi),e(A,Yn),w(Qo,Yn,null),g(o,Ja,_),g(o,ut,_),e(ut,Qt),e(Qt,Vs),w(Ho,Vs,null),e(ut,Wi),e(ut,Xs),e(Xs,Ri),g(o,Za,_),g(o,ye,_),w(Wo,ye,null),e(ye,Ui),e(ye,Ro),e(Ro,Vi),e(Ro,Js),e(Js,Xi),e(Ro,Ji),e(ye,Zi),e(ye,Ht),e(Ht,es),e(es,Ki),e(Ht,Yi),e(Ht,ts),e(ts,el),e(Ht,tl),e(ye,ol),e(ye,Uo),e(Uo,nl),e(Uo,os),e(os,sl),e(Uo,al),g(o,Ka,_),g(o,mt,_),e(mt,Wt),e(Wt,Zs),w(Vo,Zs,null),e(mt,rl),e(mt,Ks),e(Ks,dl),g(o,Ya,_),g(o,ft,_),w(Xo,ft,null),e(ft,il),e(ft,Ys),e(Ys,ll),g(o,er,_),g(o,_t,_),w(Jo,_t,null),e(_t,cl),e(_t,ea),e(ea,hl),g(o,tr,_),g(o,gt,_),w(Zo,gt,null),e(gt,pl),e(gt,ta),e(ta,ul),g(o,or,_),g(o,bt,_),w(Ko,bt,null),e(bt,ml),e(bt,oa),e(oa,fl),g(o,nr,_),g(o,Tt,_),w(Yo,Tt,null),e(Tt,_l),e(Tt,na),e(na,gl),g(o,sr,_),g(o,vt,_),w(en,vt,null),e(vt,bl),e(vt,sa),e(sa,Tl),g(o,ar,_),g(o,kt,_),w(tn,kt,null),e(kt,vl),e(kt,aa),e(aa,kl),g(o,rr,_),g(o,wt,_),w(on,wt,null),e(wt,wl),e(wt,ra),e(ra,yl),g(o,dr,_),g(o,yt,_),e(yt,Rt),e(Rt,da),w(nn,da,null),e(yt,El),e(yt,ia),e(ia,Ll),g(o,ir,_),g(o,Ee,_),w(sn,Ee,null),e(Ee,ql),e(Ee,an),e(an,$l),e(an,ns),e(ns,Dl),e(an,Fl),e(Ee,zl),e(Ee,rn),e(rn,xl),e(rn,dn),e(dn,Ml),e(rn,Sl),e(Ee,Ol),e(Ee,xe),w(ln,xe,null),e(xe,Cl),e(xe,Et),e(Et,jl),e(Et,ss),e(ss,Al),e(Et,Pl),e(Et,la),e(la,Nl),e(Et,Il),e(xe,Bl),w(Ut,xe,null),e(xe,Gl),w(Vt,xe,null),g(o,lr,_),g(o,Lt,_),e(Lt,Xt),e(Xt,ca),w(cn,ca,null),e(Lt,Ql),e(Lt,ha),e(ha,Hl),g(o,cr,_),g(o,Le,_),w(hn,Le,null),e(Le,Wl),e(Le,pn),e(pn,Rl),e(pn,as),e(as,Ul),e(pn,Vl),e(Le,Xl),e(Le,un),e(un,Jl),e(un,mn),e(mn,Zl),e(un,Kl),e(Le,Yl),e(Le,fe),w(fn,fe,null),e(fe,ec),e(fe,qt),e(qt,tc),e(qt,rs),e(rs,oc),e(qt,nc),e(qt,pa),e(pa,sc),e(qt,ac),e(fe,rc),w(Jt,fe,null),e(fe,dc),w(Zt,fe,null),e(fe,ic),w(Kt,fe,null),g(o,hr,_),g(o,$t,_),e($t,Yt),e(Yt,ua),w(_n,ua,null),e($t,lc),e($t,ma),e(ma,cc),g(o,pr,_),g(o,ie,_),w(gn,ie,null),e(ie,hc),e(ie,fa),e(fa,pc),e(ie,uc),e(ie,bn),e(bn,mc),e(bn,ds),e(ds,fc),e(bn,_c),e(ie,gc),e(ie,Tn),e(Tn,bc),e(Tn,vn),e(vn,Tc),e(Tn,vc),e(ie,kc),e(ie,G),w(kn,G,null),e(G,wc),e(G,Dt),e(Dt,yc),e(Dt,is),e(is,Ec),e(Dt,Lc),e(Dt,_a),e(_a,qc),e(Dt,$c),e(G,Dc),w(eo,G,null),e(G,Fc),w(to,G,null),e(G,zc),w(oo,G,null),e(G,xc),w(no,G,null),e(G,Mc),w(so,G,null),g(o,ur,_),g(o,Ft,_),e(Ft,ao),e(ao,ga),w(wn,ga,null),e(Ft,Sc),e(Ft,ba),e(ba,Oc),g(o,mr,_),g(o,le,_),w(yn,le,null),e(le,Cc),e(le,zt),e(zt,jc),e(zt,Ta),e(Ta,Ac),e(zt,Pc),e(zt,va),e(va,Nc),e(zt,Ic),e(le,Bc),e(le,En),e(En,Gc),e(En,ls),e(ls,Qc),e(En,Hc),e(le,Wc),e(le,Ln),e(Ln,Rc),e(Ln,qn),e(qn,Uc),e(Ln,Vc),e(le,Xc),e(le,_e),w($n,_e,null),e(_e,Jc),e(_e,xt),e(xt,Zc),e(xt,cs),e(cs,Kc),e(xt,Yc),e(xt,ka),e(ka,eh),e(xt,th),e(_e,oh),w(ro,_e,null),e(_e,nh),w(io,_e,null),e(_e,sh),w(lo,_e,null),g(o,fr,_),g(o,Mt,_),e(Mt,co),e(co,wa),w(Dn,wa,null),e(Mt,ah),e(Mt,ya),e(ya,rh),g(o,_r,_),g(o,ce,_),w(Fn,ce,null),e(ce,dh),e(ce,zn),e(zn,ih),e(zn,hs),e(hs,lh),e(zn,ch),e(ce,hh),e(ce,xn),e(xn,ph),e(xn,Mn),e(Mn,uh),e(xn,mh),e(ce,fh),w(ho,ce,null),e(ce,_h),e(ce,Me),w(Sn,Me,null),e(Me,gh),e(Me,St),e(St,bh),e(St,ps),e(ps,Th),e(St,vh),e(St,Ea),e(Ea,kh),e(St,wh),e(Me,yh),w(po,Me,null),e(Me,Eh),w(uo,Me,null),g(o,gr,_),g(o,Ot,_),e(Ot,mo),e(mo,La),w(On,La,null),e(Ot,Lh),e(Ot,qa),e(qa,qh),g(o,br,_),g(o,he,_),w(Cn,he,null),e(he,$h),e(he,jn),e(jn,Dh),e(jn,us),e(us,Fh),e(jn,zh),e(he,xh),e(he,An),e(An,Mh),e(An,Pn),e(Pn,Sh),e(An,Oh),e(he,Ch),w(fo,he,null),e(he,jh),e(he,Se),w(Nn,Se,null),e(Se,Ah),e(Se,Ct),e(Ct,Ph),e(Ct,ms),e(ms,Nh),e(Ct,Ih),e(Ct,$a),e($a,Bh),e(Ct,Gh),e(Se,Qh),w(_o,Se,null),e(Se,Hh),w(go,Se,null),Tr=!0},p(o,[_]){const In={};_&2&&(In.$$scope={dirty:_,ctx:o}),Pt.$set(In);const Da={};_&2&&(Da.$$scope={dirty:_,ctx:o}),Ut.$set(Da);const Fa={};_&2&&(Fa.$$scope={dirty:_,ctx:o}),Vt.$set(Fa);const za={};_&2&&(za.$$scope={dirty:_,ctx:o}),Jt.$set(za);const Bn={};_&2&&(Bn.$$scope={dirty:_,ctx:o}),Zt.$set(Bn);const xa={};_&2&&(xa.$$scope={dirty:_,ctx:o}),Kt.$set(xa);const Ma={};_&2&&(Ma.$$scope={dirty:_,ctx:o}),eo.$set(Ma);const Sa={};_&2&&(Sa.$$scope={dirty:_,ctx:o}),to.$set(Sa);const Gn={};_&2&&(Gn.$$scope={dirty:_,ctx:o}),oo.$set(Gn);const Oa={};_&2&&(Oa.$$scope={dirty:_,ctx:o}),no.$set(Oa);const Ca={};_&2&&(Ca.$$scope={dirty:_,ctx:o}),so.$set(Ca);const ja={};_&2&&(ja.$$scope={dirty:_,ctx:o}),ro.$set(ja);const Aa={};_&2&&(Aa.$$scope={dirty:_,ctx:o}),io.$set(Aa);const Pa={};_&2&&(Pa.$$scope={dirty:_,ctx:o}),lo.$set(Pa);const J={};_&2&&(J.$$scope={dirty:_,ctx:o}),ho.$set(J);const Q={};_&2&&(Q.$$scope={dirty:_,ctx:o}),po.$set(Q);const Na={};_&2&&(Na.$$scope={dirty:_,ctx:o}),uo.$set(Na);const Ia={};_&2&&(Ia.$$scope={dirty:_,ctx:o}),fo.$set(Ia);const Ba={};_&2&&(Ba.$$scope={dirty:_,ctx:o}),_o.$set(Ba);const Ga={};_&2&&(Ga.$$scope={dirty:_,ctx:o}),go.$set(Ga)},i(o){Tr||(y(i.$$.fragment,o),y(ee.$$.fragment,o),y(Mo.$$.fragment,o),y(So.$$.fragment,o),y(Pt.$$.fragment,o),y(Co.$$.fragment,o),y(jo.$$.fragment,o),y(Po.$$.fragment,o),y(Io.$$.fragment,o),y(Go.$$.fragment,o),y(Qo.$$.fragment,o),y(Ho.$$.fragment,o),y(Wo.$$.fragment,o),y(Vo.$$.fragment,o),y(Xo.$$.fragment,o),y(Jo.$$.fragment,o),y(Zo.$$.fragment,o),y(Ko.$$.fragment,o),y(Yo.$$.fragment,o),y(en.$$.fragment,o),y(tn.$$.fragment,o),y(on.$$.fragment,o),y(nn.$$.fragment,o),y(sn.$$.fragment,o),y(ln.$$.fragment,o),y(Ut.$$.fragment,o),y(Vt.$$.fragment,o),y(cn.$$.fragment,o),y(hn.$$.fragment,o),y(fn.$$.fragment,o),y(Jt.$$.fragment,o),y(Zt.$$.fragment,o),y(Kt.$$.fragment,o),y(_n.$$.fragment,o),y(gn.$$.fragment,o),y(kn.$$.fragment,o),y(eo.$$.fragment,o),y(to.$$.fragment,o),y(oo.$$.fragment,o),y(no.$$.fragment,o),y(so.$$.fragment,o),y(wn.$$.fragment,o),y(yn.$$.fragment,o),y($n.$$.fragment,o),y(ro.$$.fragment,o),y(io.$$.fragment,o),y(lo.$$.fragment,o),y(Dn.$$.fragment,o),y(Fn.$$.fragment,o),y(ho.$$.fragment,o),y(Sn.$$.fragment,o),y(po.$$.fragment,o),y(uo.$$.fragment,o),y(On.$$.fragment,o),y(Cn.$$.fragment,o),y(fo.$$.fragment,o),y(Nn.$$.fragment,o),y(_o.$$.fragment,o),y(go.$$.fragment,o),Tr=!0)},o(o){E(i.$$.fragment,o),E(ee.$$.fragment,o),E(Mo.$$.fragment,o),E(So.$$.fragment,o),E(Pt.$$.fragment,o),E(Co.$$.fragment,o),E(jo.$$.fragment,o),E(Po.$$.fragment,o),E(Io.$$.fragment,o),E(Go.$$.fragment,o),E(Qo.$$.fragment,o),E(Ho.$$.fragment,o),E(Wo.$$.fragment,o),E(Vo.$$.fragment,o),E(Xo.$$.fragment,o),E(Jo.$$.fragment,o),E(Zo.$$.fragment,o),E(Ko.$$.fragment,o),E(Yo.$$.fragment,o),E(en.$$.fragment,o),E(tn.$$.fragment,o),E(on.$$.fragment,o),E(nn.$$.fragment,o),E(sn.$$.fragment,o),E(ln.$$.fragment,o),E(Ut.$$.fragment,o),E(Vt.$$.fragment,o),E(cn.$$.fragment,o),E(hn.$$.fragment,o),E(fn.$$.fragment,o),E(Jt.$$.fragment,o),E(Zt.$$.fragment,o),E(Kt.$$.fragment,o),E(_n.$$.fragment,o),E(gn.$$.fragment,o),E(kn.$$.fragment,o),E(eo.$$.fragment,o),E(to.$$.fragment,o),E(oo.$$.fragment,o),E(no.$$.fragment,o),E(so.$$.fragment,o),E(wn.$$.fragment,o),E(yn.$$.fragment,o),E($n.$$.fragment,o),E(ro.$$.fragment,o),E(io.$$.fragment,o),E(lo.$$.fragment,o),E(Dn.$$.fragment,o),E(Fn.$$.fragment,o),E(ho.$$.fragment,o),E(Sn.$$.fragment,o),E(po.$$.fragment,o),E(uo.$$.fragment,o),E(On.$$.fragment,o),E(Cn.$$.fragment,o),E(fo.$$.fragment,o),E(Nn.$$.fragment,o),E(_o.$$.fragment,o),E(go.$$.fragment,o),Tr=!1},d(o){t(l),o&&t(b),o&&t(p),L(i),o&&t(pe),o&&t(F),L(ee),o&&t(qe),o&&t(I),o&&t(j),o&&t(ue),o&&t($e),o&&t(me),o&&t(De),o&&t(C),o&&t(K),o&&t(M),o&&t(Wa),o&&t(jt),o&&t(Ra),o&&t(lt),L(Mo),o&&t(Ua),o&&t(we),L(So),L(Pt),o&&t(Va),o&&t(pt),L(Co),o&&t(Xa),o&&t(A),L(jo),L(Po),L(Io),L(Go),L(Qo),o&&t(Ja),o&&t(ut),L(Ho),o&&t(Za),o&&t(ye),L(Wo),o&&t(Ka),o&&t(mt),L(Vo),o&&t(Ya),o&&t(ft),L(Xo),o&&t(er),o&&t(_t),L(Jo),o&&t(tr),o&&t(gt),L(Zo),o&&t(or),o&&t(bt),L(Ko),o&&t(nr),o&&t(Tt),L(Yo),o&&t(sr),o&&t(vt),L(en),o&&t(ar),o&&t(kt),L(tn),o&&t(rr),o&&t(wt),L(on),o&&t(dr),o&&t(yt),L(nn),o&&t(ir),o&&t(Ee),L(sn),L(ln),L(Ut),L(Vt),o&&t(lr),o&&t(Lt),L(cn),o&&t(cr),o&&t(Le),L(hn),L(fn),L(Jt),L(Zt),L(Kt),o&&t(hr),o&&t($t),L(_n),o&&t(pr),o&&t(ie),L(gn),L(kn),L(eo),L(to),L(oo),L(no),L(so),o&&t(ur),o&&t(Ft),L(wn),o&&t(mr),o&&t(le),L(yn),L($n),L(ro),L(io),L(lo),o&&t(fr),o&&t(Mt),L(Dn),o&&t(_r),o&&t(ce),L(Fn),L(ho),L(Sn),L(po),L(uo),o&&t(gr),o&&t(Ot),L(On),o&&t(br),o&&t(he),L(Cn),L(fo),L(Nn),L(_o),L(go)}}}const fm={local:"led",sections:[{local:"overview",title:"Overview"},{local:"transformers.LEDConfig",title:"LEDConfig"},{local:"transformers.LEDTokenizer",title:"LEDTokenizer"},{local:"transformers.LEDTokenizerFast",title:"LEDTokenizerFast"},{local:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",title:"LED specific outputs"},{local:"transformers.LEDModel",title:"LEDModel"},{local:"transformers.LEDForConditionalGeneration",title:"LEDForConditionalGeneration"},{local:"transformers.LEDForSequenceClassification",title:"LEDForSequenceClassification"},{local:"transformers.LEDForQuestionAnswering",title:"LEDForQuestionAnswering"},{local:"transformers.TFLEDModel",title:"TFLEDModel"},{local:"transformers.TFLEDForConditionalGeneration",title:"TFLEDForConditionalGeneration"}],title:"LED"};function _m($){return Uu(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ym extends Qu{constructor(l){super();Hu(this,l,_m,mm,Wu,{})}}export{ym as default,fm as metadata};
