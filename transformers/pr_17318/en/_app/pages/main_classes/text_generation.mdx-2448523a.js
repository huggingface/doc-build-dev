import{S as Qp,i as Yp,s as em,e as a,k as m,w as k,t,M as tm,c as r,d as o,m as g,a as i,x as v,h as n,b as h,F as e,g as x,y,q as j,o as M,B as L,v as nm,L as ue}from"../../chunks/vendor-6b77c823.js";import{T as Jp}from"../../chunks/Tip-39098574.js";import{D as ce}from"../../chunks/Docstring-1088f2fb.js";import{C as _e}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Cs}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as ge}from"../../chunks/ExampleCodeBlock-5212b321.js";function om(w){let d,f,u,c,_,s,p,C,q,I,S;return{c(){d=a("p"),f=t("Apart from "),u=a("code"),c=t("inputs"),_=t(`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),s=a("code"),p=t("config.json"),C=t(`) which in turn defaults to the
`),q=a("a"),I=t("PretrainedConfig"),S=t(" of the model."),this.h()},l(A){d=r(A,"P",{});var $=i(d);f=n($,"Apart from "),u=r($,"CODE",{});var Le=i(u);c=n(Le,"inputs"),Le.forEach(o),_=n($,`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),s=r($,"CODE",{});var we=i(s);p=n(we,"config.json"),we.forEach(o),C=n($,`) which in turn defaults to the
`),q=r($,"A",{href:!0});var he=i(q);I=n(he,"PretrainedConfig"),he.forEach(o),S=n($," of the model."),$.forEach(o),this.h()},h(){h(q,"href","/docs/transformers/pr_17318/en/main_classes/configuration#transformers.PretrainedConfig")},m(A,$){x(A,d,$),e(d,f),e(d,u),e(u,c),e(d,_),e(d,s),e(s,p),e(d,C),e(d,q),e(q,I),e(d,S)},d(A){A&&o(d)}}}function sm(w){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import AutoTokenizer, AutoModelForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){M(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),L(c,s)}}}function cm(w){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){M(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),L(c,s)}}}function pm(w){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){M(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),L(c,s)}}}function mm(w){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt sind Sie?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){M(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),L(c,s)}}}function gm(w){let d,f,u,c,_;return c=new _e({props:{code:`tokenizer = AutoTokenizer.from_pretrained("distilgpt2")  # Initialize tokenizer
...
)  <span class="hljs-comment"># generate sequences without allowing bad_words to be generated</span>`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){M(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),L(c,s)}}}function um(w){let d,f,u,c,_,s,p,C,q,I,S;return{c(){d=a("p"),f=t("Apart from "),u=a("code"),c=t("inputs"),_=t(`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),s=a("code"),p=t("config.json"),C=t(`) which in turn defaults to the
`),q=a("a"),I=t("PretrainedConfig"),S=t(" of the model."),this.h()},l(A){d=r(A,"P",{});var $=i(d);f=n($,"Apart from "),u=r($,"CODE",{});var Le=i(u);c=n(Le,"inputs"),Le.forEach(o),_=n($,`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),s=r($,"CODE",{});var we=i(s);p=n(we,"config.json"),we.forEach(o),C=n($,`) which in turn defaults to the
`),q=r($,"A",{href:!0});var he=i(q);I=n(he,"PretrainedConfig"),he.forEach(o),S=n($," of the model."),$.forEach(o),this.h()},h(){h(q,"href","/docs/transformers/pr_17318/en/main_classes/configuration#transformers.PretrainedConfig")},m(A,$){x(A,d,$),e(d,f),e(d,u),e(u,c),e(d,_),e(d,s),e(s,p),e(d,C),e(d,q),e(q,I),e(d,S)},d(A){A&&o(d)}}}function _m(w){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import AutoTokenizer, FlaxAutoModelForCausalLM
...
should be prefixed with *decoder</em>*.`,name:"exponential_decay_length_penalty"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_utils.py#L843",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17318/en/main_classes/output#transformers.utils.ModelOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
>SampleDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
>BeamSearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
>SampleEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_utils.py#L1524",returnDescription:`
<p><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
...
`}}),it=new ge({props:{anchor:"transformers.generation_utils.GenerationMixin.greedy_search.example",$$slots:{default:[im]},$$scope:{ctx:w}}}),Tt=new ce({props:{name:"sample",anchor:"transformers.generation_utils.GenerationMixin.sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_utils.py#L1757",returnDescription:`
<p><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
An derived instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_utils.py#L2014",returnDescription:`
...
<code>model.config.is_encoder_decoder=True</code>.</p>
`}}),dt=new ge({props:{anchor:"transformers.generation_utils.GenerationMixin.beam_search.example",$$slots:{default:[dm]},$$scope:{ctx:w}}}),qt=new ce({props:{name:"beam_sample",anchor:"transformers.generation_utils.GenerationMixin.beam_sample",parameters:[{name:"input_ids",val:": LongTensor"},{name:"beam_scorer",val:": BeamScorer"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"logits_warper",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
A derived instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_utils.py#L2327",returnDescription:`
<p><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
<code>model.config.is_encoder_decoder=True</code>.</p>
`}}),ct=new ge({props:{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.example",$$slots:{default:[cm]},$$scope:{ctx:w}}}),Ft=new ce({props:{name:"group_beam_search",anchor:"transformers.generation_utils.GenerationMixin.group_beam_search",parameters:[{name:"input_ids",val:": LongTensor"},{name:"beam_scorer",val:": BeamScorer"},{name:"logits_processor",val:": typing.Optional[transformers.generation_logits_process.LogitsProcessorList] = None"},{name:"stopping_criteria",val:": typing.Optional[transformers.generation_stopping_criteria.StoppingCriteriaList] = None"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_token_id",val:": typing.Optional[int] = None"},{name:"eos_token_id",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_scores",val:": typing.Optional[bool] = None"},{name:"return_dict_in_generate",val:": typing.Optional[bool] = None"},{name:"synced_gpus",val:": typing.Optional[bool] = False"},{name:"**model_kwargs",val:""}],parametersDescription:[{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
An derived instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_utils.py#L2650",returnDescription:`
<p><a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_utils.py#L3016",returnDescription:`
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_17318/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_tf_utils.py#L366",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17318/en/main_classes/output#transformers.utils.ModelOutput"
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If the model
is an encoder-decoder model, encoder specific kwargs should not be prefixed and decoder specific kwargs
should be prefixed with *decoder</em>*. Also accepts <code>encoder_outputs</code> to skip encoder part.`,name:"params"}],source:"https://github.com/huggingface/transformers/blob/vr_17318/src/transformers/generation_flax_utils.py#L162",returnDescription:`
<p><a
  href="/docs/transformers/pr_17318/en/main_classes/output#transformers.utils.ModelOutput"
>ModelOutput</a>.</p>
`}}),ht=new Jp({props:{warning:!0,$$slots:{default:[um]},$$scope:{ctx:w}}}),ft=new ge({props:{anchor:"transformers.generation_flax_utils.FlaxGenerationMixin.generate.example",$$slots:{default:[_m]},$$scope:{ctx:w}}}),{c(){d=a("meta"),f=m(),u=a("h1"),c=a("a"),_=a("span"),k(s.$$.fragment),p=m(),C=a("span"),q=t("Generation"),I=m(),S=a("p"),A=t("Each framework has a generate method for auto-regressive text generation implemented in their respective "),$=a("code"),Le=t("GenerationMixin"),we=t(" class:"),he=m(),fe=a("ul"),$e=a("li"),Is=t("PyTorch "),tn=a("a"),Bs=t("generate()"),Ws=t(" is implemented in "),nn=a("a"),Hs=t("GenerationMixin"),Rs=t("."),Us=m(),Te=a("li"),Vs=t("TensorFlow "),on=a("a"),Ks=t("generate()"),Zs=t(" is implemented in "),sn=a("a"),Xs=t("TFGenerationMixin"),Js=t("."),Qs=m(),Ee=a("li"),Ys=t("Flax/JAX "),an=a("a"),ea=t("generate()"),ta=t(" is implemented in "),rn=a("a"),na=t("FlaxGenerationMixin"),oa=t("."),_s=m(),Oe=a("h2"),nt=a("a"),An=a("span"),k(xt.$$.fragment),sa=m(),Pn=a("span"),aa=t("GenerationMixin"),hs=m(),T=a("div"),k(kt.$$.fragment),ra=m(),vt=a("p"),ia=t("A class containing all functions for auto-regressive text generation, to be used as a mixin in "),ln=a("a"),la=t("PreTrainedModel"),da=t("."),ca=m(),yt=a("p"),pa=t("The class exposes "),dn=a("a"),ma=t("generate()"),ga=t(", which can be used for:"),ua=m(),P=a("ul"),B=a("li"),Dn=a("em"),_a=t("greedy decoding"),ha=t(" by calling "),cn=a("a"),fa=t("greedy_search()"),ba=t(" if "),Nn=a("code"),xa=t("num_beams=1"),ka=t(` and
`),Cn=a("code"),va=t("do_sample=False"),ya=t("."),ja=m(),W=a("li"),In=a("em"),Ma=t("multinomial sampling"),La=t(" by calling "),pn=a("a"),wa=t("sample()"),$a=t(" if "),Bn=a("code"),Ta=t("num_beams=1"),Ea=t(` and
...
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),fr=m(),D=a("ul"),K=a("li"),oo=a("em"),br=t("greedy decoding"),xr=t(" by calling "),hn=a("a"),kr=t("greedy_search()"),vr=t(" if "),so=a("code"),yr=t("num_beams=1"),jr=t(` and
`),ao=a("code"),Mr=t("do_sample=False"),Lr=t("."),wr=m(),Z=a("li"),ro=a("em"),$r=t("multinomial sampling"),Tr=t(" by calling "),fn=a("a"),Er=t("sample()"),Or=t(" if "),io=a("code"),Gr=t("num_beams=1"),qr=t(` and
...
post`),vi=t("."),yi=m(),yo=a("p"),ji=t("Examples:"),Mi=m(),k(st.$$.fragment),Li=m(),k(at.$$.fragment),wi=m(),k(rt.$$.fragment),$i=m(),be=a("div"),k(wt.$$.fragment),Ti=m(),$t=a("p"),Ei=t("Generates sequences of token ids for models with a language modeling head using "),jo=a("strong"),Oi=t("greedy decoding"),Gi=t(` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),qi=m(),k(it.$$.fragment),Si=m(),xe=a("div"),k(Tt.$$.fragment),Fi=m(),Et=a("p"),zi=t("Generates sequences of token ids for models with a language modeling head using "),Mo=a("strong"),Ai=t("multinomial sampling"),Pi=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Di=m(),k(lt.$$.fragment),Ni=m(),ke=a("div"),k(Ot.$$.fragment),Ci=m(),Gt=a("p"),Ii=t("Generates sequences of token ids for models with a language modeling head using "),Lo=a("strong"),Bi=t("beam search decoding"),Wi=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Hi=m(),k(dt.$$.fragment),Ri=m(),ve=a("div"),k(qt.$$.fragment),Ui=m(),St=a("p"),Vi=t("Generates sequences of token ids for models with a language modeling head using "),wo=a("strong"),Ki=t(`beam search multinomial
sampling`),Zi=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Xi=m(),k(ct.$$.fragment),Ji=m(),ye=a("div"),k(Ft.$$.fragment),Qi=m(),zt=a("p"),Yi=t("Generates sequences of token ids for models with a language modeling head using "),$o=a("strong"),el=t(`diverse beam search
decoding`),tl=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),nl=m(),k(pt.$$.fragment),ol=m(),je=a("div"),k(At.$$.fragment),sl=m(),Pt=a("p"),al=t("Generates sequences of token ids for models with a language modeling head using "),To=a("strong"),rl=t(`constrained beam search
decoding`),il=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),ll=m(),k(mt.$$.fragment),fs=m(),Ge=a("h2"),gt=a("a"),Eo=a("span"),k(Dt.$$.fragment),dl=m(),Oo=a("span"),cl=t("TFGenerationMixin"),bs=m(),pe=a("div"),k(Nt.$$.fragment),pl=m(),Ct=a("p"),ml=t("A class containing all of the functions supporting generation, to be used as a mixin in "),yn=a("a"),gl=t("TFPreTrainedModel"),ul=t("."),_l=m(),F=a("div"),k(It.$$.fragment),hl=m(),Go=a("p"),fl=t(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),vl=t("."),yl=m(),me=a("p"),jl=t("Apart from "),qo=a("code"),Ml=t("input_ids"),Ll=t(" and "),So=a("code"),wl=t("attention_mask"),$l=t(`, all the arguments below will default to the value of the attribute
...
post`),Sl=t("."),Fl=m(),k(ut.$$.fragment),xs=m(),qe=a("h2"),_t=a("a"),Fo=a("span"),k(Ut.$$.fragment),zl=m(),zo=a("span"),Al=t("FlaxGenerationMixin"),ks=m(),N=a("div"),k(Vt.$$.fragment),Pl=m(),Kt=a("p"),Dl=t(`A class containing all functions for auto-regressive text generation, to be used as a mixin in
`),Mn=a("a"),Nl=t("FlaxPreTrainedModel"),Cl=t("."),Il=m(),Zt=a("p"),Bl=t("The class exposes "),Ln=a("a"),Wl=t("generate()"),Hl=t(", which can be used for:"),Rl=m(),Se=a("ul"),ee=a("li"),Ao=a("em"),Ul=t("greedy decoding"),Vl=t(" by calling "),Po=a("code"),Kl=t("_greedy_search()"),Zl=t(` if
...
and `),Vo=a("code"),hd=t("do_sample=False"),fd=t("."),bd=m(),z=a("div"),k(Xt.$$.fragment),xd=m(),Ko=a("p"),kd=t(`Generates sequences of token ids for models with a language modeling head. The method supports the following
...
`),Jo=a("code"),wd=t("num_beams=1"),$d=t(" and "),Qo=a("code"),Td=t("do_sample=False"),Ed=t("."),Od=m(),se=a("li"),Yo=a("em"),Gd=t("multinomial sampling"),qd=t(" by calling "),es=a("code"),Sd=t("_sample()"),Fd=t(" if "),ts=a("code"),zd=t("num_beams=1"),Ad=t(`
...
post`),Qd=t("."),Yd=m(),k(ft.$$.fragment),this.h()},l(l){const b=tm('[data-svelte="svelte-1phssyn"]',document.head);d=r(b,"META",{name:!0,content:!0}),b.forEach(o),f=g(l),u=r(l,"H1",{class:!0});var Yt=i(u);c=r(Yt,"A",{id:!0,class:!0,href:!0});var is=i(c);_=r(is,"SPAN",{});var ls=i(_);v(s.$$.fragment,ls),ls.forEach(o),is.forEach(o),p=g(Yt),C=r(Yt,"SPAN",{});var ds=i(C);q=n(ds,"Generation"),ds.forEach(o),Yt.forEach(o),I=g(l),S=r(l,"P",{});var en=i(S);A=n(en,"Each framework has a generate method for auto-regressive text generation implemented in their respective "),$=r(en,"CODE",{});var cs=i($);Le=n(cs,"GenerationMixin"),cs.forEach(o),we=n(en," class:"),en.forEach(o),he=g(l),fe=r(l,"UL",{});var ze=i(fe);$e=r(ze,"LI",{});var Ae=i($e);Is=n(Ae,"PyTorch "),tn=r(Ae,"A",{href:!0});var ps=i(tn);Bs=n(ps,"generate()"),ps.forEach(o),Ws=n(Ae," is implemented in "),nn=r(Ae,"A",{href:!0});var ms=i(nn);Hs=n(ms,"GenerationMixin"),ms.forEach(o),Rs=n(Ae,"."),Ae.forEach(o),Us=g(ze),Te=r(ze,"LI",{});var Pe=i(Te);Vs=n(Pe,"TensorFlow "),on=r(Pe,"A",{href:!0});var gs=i(on);Ks=n(gs,"generate()"),gs.forEach(o),Zs=n(Pe," is implemented in "),sn=r(Pe,"A",{href:!0});var us=i(sn);Xs=n(us,"TFGenerationMixin"),us.forEach(o),Js=n(Pe,"."),Pe.forEach(o),Qs=g(ze),Ee=r(ze,"LI",{});var wn=i(Ee);Ys=n(wn,"Flax/JAX "),an=r(wn,"A",{href:!0});var ec=i(an);ea=n(ec,"generate()"),ec.forEach(o),ta=n(wn," is implemented in "),rn=r(wn,"A",{href:!0});var tc=i(rn);na=n(tc,"FlaxGenerationMixin"),tc.forEach(o),oa=n(wn,"."),wn.forEach(o),ze.forEach(o),_s=g(l),Oe=r(l,"H2",{class:!0});var ys=i(Oe);nt=r(ys,"A",{id:!0,class:!0,href:!0});var nc=i(nt);An=r(nc,"SPAN",{});var oc=i(An);v(xt.$$.fragment,oc),oc.forEach(o),nc.forEach(o),sa=g(ys),Pn=r(ys,"SPAN",{});var sc=i(Pn);aa=n(sc,"GenerationMixin"),sc.forEach(o),ys.forEach(o),hs=g(l),T=r(l,"DIV",{class:!0});var O=i(T);v(kt.$$.fragment,O),ra=g(O),vt=r(O,"P",{});var js=i(vt);ia=n(js,"A class containing all functions for auto-regressive text generation, to be used as a mixin in "),ln=r(js,"A",{href:!0});var ac=i(ln);la=n(ac,"PreTrainedModel"),ac.forEach(o),da=n(js,"."),js.forEach(o),ca=g(O),yt=r(O,"P",{});var Ms=i(yt);pa=n(Ms,"The class exposes "),dn=r(Ms,"A",{href:!0});var rc=i(dn);ma=n(rc,"generate()"),rc.forEach(o),ga=n(Ms,", which can be used for:"),Ms.forEach(o),ua=g(O),P=r(O,"UL",{});var re=i(P);B=r(re,"LI",{});var De=i(B);Dn=r(De,"EM",{});var ic=i(Dn);_a=n(ic,"greedy decoding"),ic.forEach(o),ha=n(De," by calling "),cn=r(De,"A",{href:!0});var lc=i(cn);fa=n(lc,"greedy_search()"),lc.forEach(o),ba=n(De," if "),Nn=r(De,"CODE",{});var dc=i(Nn);xa=n(dc,"num_beams=1"),dc.forEach(o),ka=n(De,` and
`),Cn=r(De,"CODE",{});var cc=i(Cn);va=n(cc,"do_sample=False"),cc.forEach(o),ya=n(De,"."),De.forEach(o),ja=g(re),W=r(re,"LI",{});var Ne=i(W);In=r(Ne,"EM",{});var pc=i(In);Ma=n(pc,"multinomial sampling"),pc.forEach(o),La=n(Ne," by calling "),pn=r(Ne,"A",{href:!0});var mc=i(pn);wa=n(mc,"sample()"),mc.forEach(o),$a=n(Ne," if "),Bn=r(Ne,"CODE",{});var gc=i(Bn);Ta=n(gc,"num_beams=1"),gc.forEach(o),Ea=n(Ne,` and
...
post`),np.forEach(o),vi=n(Ls,"."),Ls.forEach(o),yi=g(G),yo=r(G,"P",{});var op=i(yo);ji=n(op,"Examples:"),op.forEach(o),Mi=g(G),v(st.$$.fragment,G),Li=g(G),v(at.$$.fragment,G),wi=g(G),v(rt.$$.fragment,G),G.forEach(o),$i=g(O),be=r(O,"DIV",{class:!0});var $n=i(be);v(wt.$$.fragment,$n),Ti=g($n),$t=r($n,"P",{});var ws=i($t);Ei=n(ws,"Generates sequences of token ids for models with a language modeling head using "),jo=r(ws,"STRONG",{});var sp=i(jo);Oi=n(sp,"greedy decoding"),sp.forEach(o),Gi=n(ws,` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),ws.forEach(o),qi=g($n),v(it.$$.fragment,$n),$n.forEach(o),Si=g(O),xe=r(O,"DIV",{class:!0});var Tn=i(xe);v(Tt.$$.fragment,Tn),Fi=g(Tn),Et=r(Tn,"P",{});var $s=i(Et);zi=n($s,"Generates sequences of token ids for models with a language modeling head using "),Mo=r($s,"STRONG",{});var ap=i(Mo);Ai=n(ap,"multinomial sampling"),ap.forEach(o),Pi=n($s,` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),$s.forEach(o),Di=g(Tn),v(lt.$$.fragment,Tn),Tn.forEach(o),Ni=g(O),ke=r(O,"DIV",{class:!0});var En=i(ke);v(Ot.$$.fragment,En),Ci=g(En),Gt=r(En,"P",{});var Ts=i(Gt);Ii=n(Ts,"Generates sequences of token ids for models with a language modeling head using "),Lo=r(Ts,"STRONG",{});var rp=i(Lo);Bi=n(rp,"beam search decoding"),rp.forEach(o),Wi=n(Ts,` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ts.forEach(o),Hi=g(En),v(dt.$$.fragment,En),En.forEach(o),Ri=g(O),ve=r(O,"DIV",{class:!0});var On=i(ve);v(qt.$$.fragment,On),Ui=g(On),St=r(On,"P",{});var Es=i(St);Vi=n(Es,"Generates sequences of token ids for models with a language modeling head using "),wo=r(Es,"STRONG",{});var ip=i(wo);Ki=n(ip,`beam search multinomial
sampling`),ip.forEach(o),Zi=n(Es," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Es.forEach(o),Xi=g(On),v(ct.$$.fragment,On),On.forEach(o),Ji=g(O),ye=r(O,"DIV",{class:!0});var Gn=i(ye);v(Ft.$$.fragment,Gn),Qi=g(Gn),zt=r(Gn,"P",{});var Os=i(zt);Yi=n(Os,"Generates sequences of token ids for models with a language modeling head using "),$o=r(Os,"STRONG",{});var lp=i($o);el=n(lp,`diverse beam search
decoding`),lp.forEach(o),tl=n(Os," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Os.forEach(o),nl=g(Gn),v(pt.$$.fragment,Gn),Gn.forEach(o),ol=g(O),je=r(O,"DIV",{class:!0});var qn=i(je);v(At.$$.fragment,qn),sl=g(qn),Pt=r(qn,"P",{});var Gs=i(Pt);al=n(Gs,"Generates sequences of token ids for models with a language modeling head using "),To=r(Gs,"STRONG",{});var dp=i(To);rl=n(dp,`constrained beam search
decoding`),dp.forEach(o),il=n(Gs," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Gs.forEach(o),ll=g(qn),v(mt.$$.fragment,qn),qn.forEach(o),O.forEach(o),fs=g(l),Ge=r(l,"H2",{class:!0});var qs=i(Ge);gt=r(qs,"A",{id:!0,class:!0,href:!0});var cp=i(gt);Eo=r(cp,"SPAN",{});var pp=i(Eo);v(Dt.$$.fragment,pp),pp.forEach(o),cp.forEach(o),dl=g(qs),Oo=r(qs,"SPAN",{});var mp=i(Oo);cl=n(mp,"TFGenerationMixin"),mp.forEach(o),qs.forEach(o),bs=g(l),pe=r(l,"DIV",{class:!0});var Sn=i(pe);v(Nt.$$.fragment,Sn),pl=g(Sn),Ct=r(Sn,"P",{});var Ss=i(Ct);ml=n(Ss,"A class containing all of the functions supporting generation, to be used as a mixin in "),yn=r(Ss,"A",{href:!0});var gp=i(yn);gl=n(gp,"TFPreTrainedModel"),gp.forEach(o),ul=n(Ss,"."),Ss.forEach(o),_l=g(Sn),F=r(Sn,"DIV",{class:!0});var le=i(F);v(It.$$.fragment,le),hl=g(le),Go=r(le,"P",{});var up=i(Go);fl=n(up,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),_p.forEach(o),vl=n(Fs,"."),Fs.forEach(o),yl=g(le),me=r(le,"P",{});var bt=i(me);jl=n(bt,"Apart from "),qo=r(bt,"CODE",{});var hp=i(qo);Ml=n(hp,"input_ids"),hp.forEach(o),Ll=n(bt," and "),So=r(bt,"CODE",{});var fp=i(So);wl=n(fp,"attention_mask"),fp.forEach(o),$l=n(bt,`, all the arguments below will default to the value of the attribute
...
post`),xp.forEach(o),Sl=n(zs,"."),zs.forEach(o),Fl=g(le),v(ut.$$.fragment,le),le.forEach(o),Sn.forEach(o),xs=g(l),qe=r(l,"H2",{class:!0});var As=i(qe);_t=r(As,"A",{id:!0,class:!0,href:!0});var kp=i(_t);Fo=r(kp,"SPAN",{});var vp=i(Fo);v(Ut.$$.fragment,vp),vp.forEach(o),kp.forEach(o),zl=g(As),zo=r(As,"SPAN",{});var yp=i(zo);Al=n(yp,"FlaxGenerationMixin"),yp.forEach(o),As.forEach(o),ks=g(l),N=r(l,"DIV",{class:!0});var Me=i(N);v(Vt.$$.fragment,Me),Pl=g(Me),Kt=r(Me,"P",{});var Ps=i(Kt);Dl=n(Ps,`A class containing all functions for auto-regressive text generation, to be used as a mixin in
`),Mn=r(Ps,"A",{href:!0});var jp=i(Mn);Nl=n(jp,"FlaxPreTrainedModel"),jp.forEach(o),Cl=n(Ps,"."),Ps.forEach(o),Il=g(Me),Zt=r(Me,"P",{});var Ds=i(Zt);Bl=n(Ds,"The class exposes "),Ln=r(Ds,"A",{href:!0});var Mp=i(Ln);Wl=n(Mp,"generate()"),Mp.forEach(o),Hl=n(Ds,", which can be used for:"),Ds.forEach(o),Rl=g(Me),Se=r(Me,"UL",{});var Fn=i(Se);ee=r(Fn,"LI",{});var Xe=i(ee);Ao=r(Xe,"EM",{});var Lp=i(Ao);Ul=n(Lp,"greedy decoding"),Lp.forEach(o),Vl=n(Xe," by calling "),Po=r(Xe,"CODE",{});var wp=i(Po);Kl=n(wp,"_greedy_search()"),wp.forEach(o),Zl=n(Xe,` if
...
and `),Vo=r(Qe,"CODE",{});var Ap=i(Vo);hd=n(Ap,"do_sample=False"),Ap.forEach(o),fd=n(Qe,"."),Qe.forEach(o),Fn.forEach(o),bd=g(Me),z=r(Me,"DIV",{class:!0});var de=i(z);v(Xt.$$.fragment,de),xd=g(de),Ko=r(de,"P",{});var Pp=i(Ko);kd=n(Pp,`Generates sequences of token ids for models with a language modeling head. The method supports the following
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),Pp.forEach(o),vd=g(de),Fe=r(de,"UL",{});var zn=i(Fe);oe=r(zn,"LI",{});var Ye=i(oe);Zo=r(Ye,"EM",{});var Dp=i(Zo);yd=n(Dp,"greedy decoding"),Dp.forEach(o),jd=n(Ye," by calling "),Xo=r(Ye,"CODE",{});var Np=i(Xo);Md=n(Np,"_greedy_search()"),Np.forEach(o),Ld=n(Ye,` if
`),Jo=r(Ye,"CODE",{});var Cp=i(Jo);wd=n(Cp,"num_beams=1"),Cp.forEach(o),$d=n(Ye," and "),Qo=r(Ye,"CODE",{});var Ip=i(Qo);Td=n(Ip,"do_sample=False"),Ip.forEach(o),Ed=n(Ye,"."),Ye.forEach(o),Od=g(zn),se=r(zn,"LI",{});var et=i(se);Yo=r(et,"EM",{});var Bp=i(Yo);Gd=n(Bp,"multinomial sampling"),Bp.forEach(o),qd=n(et," by calling "),es=r(et,"CODE",{});var Wp=i(es);Sd=n(Wp,"_sample()"),Wp.forEach(o),Fd=n(et," if "),ts=r(et,"CODE",{});var Hp=i(ts);zd=n(Hp,"num_beams=1"),Hp.forEach(o),Ad=n(et,`
...
and `),rs=r(tt,"CODE",{});var Zp=i(rs);Ud=n(Zp,"do_sample=False"),Zp.forEach(o),Vd=n(tt,"."),tt.forEach(o),zn.forEach(o),Kd=g(de),v(ht.$$.fragment,de),Zd=g(de),Jt=r(de,"P",{});var Ns=i(Jt);Xd=n(Ns,"Most of these parameters are explained in more detail in "),Qt=r(Ns,"A",{href:!0,rel:!0});var Xp=i(Qt);Jd=n(Xp,`this blog
post`),Xp.forEach(o),Qd=n(Ns,"."),Ns.forEach(o),Yd=g(de),v(ft.$$.fragment,de),de.forEach(o),Me.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(fm)),h(c,"id","generation"),h(c,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(c,"href","#generation"),h(u,"class","relative group"),h(tn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(nn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin"),h(on,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin.generate"),h(sn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin"),h(an,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(rn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin"),h(nt,"id","transformers.generation_utils.GenerationMixin"),h(nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(nt,"href","#transformers.generation_utils.GenerationMixin"),h(Oe,"class","relative group"),h(ln,"href","/docs/transformers/pr_17318/en/main_classes/model#transformers.PreTrainedModel"),h(dn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(cn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(pn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(mn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(gn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(un,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(_n,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(hn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(fn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(bn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(xn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(kn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(vn,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(Lt,"href","https://huggingface.co/blog/how-to-generate"),h(Lt,"rel","nofollow"),h(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(gt,"id","transformers.generation_tf_utils.TFGenerationMixin"),h(gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(gt,"href","#transformers.generation_tf_utils.TFGenerationMixin"),h(Ge,"class","relative group"),h(yn,"href","/docs/transformers/pr_17318/en/main_classes/model#transformers.TFPreTrainedModel"),h(Wt,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),h(Wt,"rel","nofollow"),h(jn,"href","/docs/transformers/pr_17318/en/main_classes/configuration#transformers.PretrainedConfig"),h(Rt,"href","https://huggingface.co/blog/how-to-generate"),h(Rt,"rel","nofollow"),h(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(_t,"id","transformers.generation_flax_utils.FlaxGenerationMixin"),h(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(_t,"href","#transformers.generation_flax_utils.FlaxGenerationMixin"),h(qe,"class","relative group"),h(Mn,"href","/docs/transformers/pr_17318/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(Ln,"href","/docs/transformers/pr_17318/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(Qt,"href","https://huggingface.co/blog/how-to-generate"),h(Qt,"rel","nofollow"),h(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(l,b){e(document.head,d),x(l,f,b),x(l,u,b),e(u,c),e(c,_),y(s,_,null),e(u,p),e(u,C),e(C,q),x(l,I,b),x(l,S,b),e(S,A),e(S,$),e($,Le),e(S,we),x(l,he,b),x(l,fe,b),e(fe,$e),e($e,Is),e($e,tn),e(tn,Bs),e($e,Ws),e($e,nn),e(nn,Hs),e($e,Rs),e(fe,Us),e(fe,Te),e(Te,Vs),e(Te,on),e(on,Ks),e(Te,Zs),e(Te,sn),e(sn,Xs),e(Te,Js),e(fe,Qs),e(fe,Ee),e(Ee,Ys),e(Ee,an),e(an,ea),e(Ee,ta),e(Ee,rn),e(rn,na),e(Ee,oa),x(l,_s,b),x(l,Oe,b),e(Oe,nt),e(nt,An),y(xt,An,null),e(Oe,sa),e(Oe,Pn),e(Pn,aa),x(l,hs,b),x(l,T,b),y(kt,T,null),e(T,ra),e(T,vt),e(vt,ia),e(vt,ln),e(ln,la),e(vt,da),e(T,ca),e(T,yt),e(yt,pa),e(yt,dn),e(dn,ma),e(yt,ga),e(T,ua),e(T,P),e(P,B),e(B,Dn),e(Dn,_a),e(B,ha),e(B,cn),e(cn,fa),e(B,ba),e(B,Nn),e(Nn,xa),e(B,ka),e(B,Cn),e(Cn,va),e(B,ya),e(P,ja),e(P,W),e(W,In),e(In,Ma),e(W,La),e(W,pn),e(pn,wa),e(W,$a),e(W,Bn),e(Bn,Ta),e(W,Ea),e(W,Wn),e(Wn,Oa),e(W,Ga),e(P,qa),e(P,H),e(H,Hn),e(Hn,Sa),e(H,Fa),e(H,mn),e(mn,za),e(H,Aa),e(H,Rn),e(Rn,Pa),e(H,Da),e(H,Un),e(Un,Na),e(H,Ca),e(P,Ia),e(P,R),e(R,Vn),e(Vn,Ba),e(R,Wa),e(R,gn),e(gn,Ha),e(R,Ra),e(R,Kn),e(Kn,Ua),e(R,Va),e(R,Zn),e(Zn,Ka),e(R,Za),e(P,Xa),e(P,U),e(U,Xn),e(Xn,Ja),e(U,Qa),e(U,un),e(un,Ya),e(U,er),e(U,Jn),e(Jn,tr),e(U,nr),e(U,Qn),e(Qn,or),e(U,sr),e(P,ar),e(P,V),e(V,Yn),e(Yn,rr),e(V,ir),e(V,_n),e(_n,lr),e(V,dr),e(V,eo),e(eo,cr),e(V,pr),e(V,to),e(to,mr),e(V,gr),e(T,ur),e(T,E),y(jt,E,null),e(E,_r),e(E,no),e(no,hr),e(E,fr),e(E,D),e(D,K),e(K,oo),e(oo,br),e(K,xr),e(K,hn),e(hn,kr),e(K,vr),e(K,so),e(so,yr),e(K,jr),e(K,ao),e(ao,Mr),e(K,Lr),e(D,wr),e(D,Z),e(Z,ro),e(ro,$r),e(Z,Tr),e(Z,fn),e(fn,Er),e(Z,Or),e(Z,io),e(io,Gr),e(Z,qr),e(Z,lo),e(lo,Sr),e(Z,Fr),e(D,zr),e(D,X),e(X,co),e(co,Ar),e(X,Pr),e(X,bn),e(bn,Dr),e(X,Nr),e(X,po),e(po,Cr),e(X,Ir),e(X,mo),e(mo,Br),e(X,Wr),e(D,Hr),e(D,J),e(J,go),e(go,Rr),e(J,Ur),e(J,xn),e(xn,Vr),e(J,Kr),e(J,uo),e(uo,Zr),e(J,Xr),e(J,_o),e(_o,Jr),e(J,Qr),e(D,Yr),e(D,Q),e(Q,ho),e(ho,ei),e(Q,ti),e(Q,kn),e(kn,ni),e(Q,oi),e(Q,fo),e(fo,si),e(Q,ai),e(Q,bo),e(bo,ri),e(Q,ii),e(D,li),e(D,Y),e(Y,xo),e(xo,di),e(Y,ci),e(Y,vn),e(vn,pi),e(Y,mi),e(Y,ko),e(ko,gi),e(Y,ui),e(Y,vo),e(vo,_i),e(Y,hi),e(E,fi),y(ot,E,null),e(E,bi),e(E,Mt),e(Mt,xi),e(Mt,Lt),e(Lt,ki),e(Mt,vi),e(E,yi),e(E,yo),e(yo,ji),e(E,Mi),y(st,E,null),e(E,Li),y(at,E,null),e(E,wi),y(rt,E,null),e(T,$i),e(T,be),y(wt,be,null),e(be,Ti),e(be,$t),e($t,Ei),e($t,jo),e(jo,Oi),e($t,Gi),e(be,qi),y(it,be,null),e(T,Si),e(T,xe),y(Tt,xe,null),e(xe,Fi),e(xe,Et),e(Et,zi),e(Et,Mo),e(Mo,Ai),e(Et,Pi),e(xe,Di),y(lt,xe,null),e(T,Ni),e(T,ke),y(Ot,ke,null),e(ke,Ci),e(ke,Gt),e(Gt,Ii),e(Gt,Lo),e(Lo,Bi),e(Gt,Wi),e(ke,Hi),y(dt,ke,null),e(T,Ri),e(T,ve),y(qt,ve,null),e(ve,Ui),e(ve,St),e(St,Vi),e(St,wo),e(wo,Ki),e(St,Zi),e(ve,Xi),y(ct,ve,null),e(T,Ji),e(T,ye),y(Ft,ye,null),e(ye,Qi),e(ye,zt),e(zt,Yi),e(zt,$o),e($o,el),e(zt,tl),e(ye,nl),y(pt,ye,null),e(T,ol),e(T,je),y(At,je,null),e(je,sl),e(je,Pt),e(Pt,al),e(Pt,To),e(To,rl),e(Pt,il),e(je,ll),y(mt,je,null),x(l,fs,b),x(l,Ge,b),e(Ge,gt),e(gt,Eo),y(Dt,Eo,null),e(Ge,dl),e(Ge,Oo),e(Oo,cl),x(l,bs,b),x(l,pe,b),y(Nt,pe,null),e(pe,pl),e(pe,Ct),e(Ct,ml),e(Ct,yn),e(yn,gl),e(Ct,ul),e(pe,_l),e(pe,F),y(It,F,null),e(F,hl),e(F,Go),e(Go,fl),e(F,bl),e(F,Bt),e(Bt,xl),e(Bt,Wt),e(Wt,kl),e(Bt,vl),e(F,yl),e(F,me),e(me,jl),e(me,qo),e(qo,Ml),e(me,Ll),e(me,So),e(So,wl),e(me,$l),e(me,jn),e(jn,Tl),e(me,El),e(F,Ol),e(F,Ht),e(Ht,Gl),e(Ht,Rt),e(Rt,ql),e(Ht,Sl),e(F,Fl),y(ut,F,null),x(l,xs,b),x(l,qe,b),e(qe,_t),e(_t,Fo),y(Ut,Fo,null),e(qe,zl),e(qe,zo),e(zo,Al),x(l,ks,b),x(l,N,b),y(Vt,N,null),e(N,Pl),e(N,Kt),e(Kt,Dl),e(Kt,Mn),e(Mn,Nl),e(Kt,Cl),e(N,Il),e(N,Zt),e(Zt,Bl),e(Zt,Ln),e(Ln,Wl),e(Zt,Hl),e(N,Rl),e(N,Se),e(Se,ee),e(ee,Ao),e(Ao,Ul),e(ee,Vl),e(ee,Po),e(Po,Kl),e(ee,Zl),e(ee,Do),e(Do,Xl),e(ee,Jl),e(ee,No),e(No,Ql),e(ee,Yl),e(Se,ed),e(Se,te),e(te,Co),e(Co,td),e(te,nd),e(te,Io),e(Io,od),e(te,sd),e(te,Bo),e(Bo,ad),e(te,rd),e(te,Wo),e(Wo,id),e(te,ld),e(Se,dd),e(Se,ne),e(ne,Ho),e(Ho,cd),e(ne,pd),e(ne,Ro),e(Ro,md),e(ne,gd),e(ne,Uo),e(Uo,ud),e(ne,_d),e(ne,Vo),e(Vo,hd),e(ne,fd),e(N,bd),e(N,z),y(Xt,z,null),e(z,xd),e(z,Ko),e(Ko,kd),e(z,vd),e(z,Fe),e(Fe,oe),e(oe,Zo),e(Zo,yd),e(oe,jd),e(oe,Xo),e(Xo,Md),e(oe,Ld),e(oe,Jo),e(Jo,wd),e(oe,$d),e(oe,Qo),e(Qo,Td),e(oe,Ed),e(Fe,Od),e(Fe,se),e(se,Yo),e(Yo,Gd),e(se,qd),e(se,es),e(es,Sd),e(se,Fd),e(se,ts),e(ts,zd),e(se,Ad),e(se,ns),e(ns,Pd),e(se,Dd),e(Fe,Nd),e(Fe,ae),e(ae,os),e(os,Cd),e(ae,Id),e(ae,ss),e(ss,Bd),e(ae,Wd),e(ae,as),e(as,Hd),e(ae,Rd),e(ae,rs),e(rs,Ud),e(ae,Vd),e(z,Kd),y(ht,z,null),e(z,Zd),e(z,Jt),e(Jt,Xd),e(Jt,Qt),e(Qt,Jd),e(Jt,Qd),e(z,Yd),y(ft,z,null),vs=!0},p(l,[b]){const Yt={};b&2&&(Yt.$$scope={dirty:b,ctx:l}),ot.$set(Yt);const is={};b&2&&(is.$$scope={dirty:b,ctx:l}),st.$set(is);const ls={};b&2&&(ls.$$scope={dirty:b,ctx:l}),at.$set(ls);const ds={};b&2&&(ds.$$scope={dirty:b,ctx:l}),rt.$set(ds);const en={};b&2&&(en.$$scope={dirty:b,ctx:l}),it.$set(en);const cs={};b&2&&(cs.$$scope={dirty:b,ctx:l}),lt.$set(cs);const ze={};b&2&&(ze.$$scope={dirty:b,ctx:l}),dt.$set(ze);const Ae={};b&2&&(Ae.$$scope={dirty:b,ctx:l}),ct.$set(Ae);const ps={};b&2&&(ps.$$scope={dirty:b,ctx:l}),pt.$set(ps);const ms={};b&2&&(ms.$$scope={dirty:b,ctx:l}),mt.$set(ms);const Pe={};b&2&&(Pe.$$scope={dirty:b,ctx:l}),ut.$set(Pe);const gs={};b&2&&(gs.$$scope={dirty:b,ctx:l}),ht.$set(gs);const us={};b&2&&(us.$$scope={dirty:b,ctx:l}),ft.$set(us)},i(l){vs||(j(s.$$.fragment,l),j(xt.$$.fragment,l),j(kt.$$.fragment,l),j(jt.$$.fragment,l),j(ot.$$.fragment,l),j(st.$$.fragment,l),j(at.$$.fragment,l),j(rt.$$.fragment,l),j(wt.$$.fragment,l),j(it.$$.fragment,l),j(Tt.$$.fragment,l),j(lt.$$.fragment,l),j(Ot.$$.fragment,l),j(dt.$$.fragment,l),j(qt.$$.fragment,l),j(ct.$$.fragment,l),j(Ft.$$.fragment,l),j(pt.$$.fragment,l),j(At.$$.fragment,l),j(mt.$$.fragment,l),j(Dt.$$.fragment,l),j(Nt.$$.fragment,l),j(It.$$.fragment,l),j(ut.$$.fragment,l),j(Ut.$$.fragment,l),j(Vt.$$.fragment,l),j(Xt.$$.fragment,l),j(ht.$$.fragment,l),j(ft.$$.fragment,l),vs=!0)},o(l){M(s.$$.fragment,l),M(xt.$$.fragment,l),M(kt.$$.fragment,l),M(jt.$$.fragment,l),M(ot.$$.fragment,l),M(st.$$.fragment,l),M(at.$$.fragment,l),M(rt.$$.fragment,l),M(wt.$$.fragment,l),M(it.$$.fragment,l),M(Tt.$$.fragment,l),M(lt.$$.fragment,l),M(Ot.$$.fragment,l),M(dt.$$.fragment,l),M(qt.$$.fragment,l),M(ct.$$.fragment,l),M(Ft.$$.fragment,l),M(pt.$$.fragment,l),M(At.$$.fragment,l),M(mt.$$.fragment,l),M(Dt.$$.fragment,l),M(Nt.$$.fragment,l),M(It.$$.fragment,l),M(ut.$$.fragment,l),M(Ut.$$.fragment,l),M(Vt.$$.fragment,l),M(Xt.$$.fragment,l),M(ht.$$.fragment,l),M(ft.$$.fragment,l),vs=!1},d(l){o(d),l&&o(f),l&&o(u),L(s),l&&o(I),l&&o(S),l&&o(he),l&&o(fe),l&&o(_s),l&&o(Oe),L(xt),l&&o(hs),l&&o(T),L(kt),L(jt),L(ot),L(st),L(at),L(rt),L(wt),L(it),L(Tt),L(lt),L(Ot),L(dt),L(qt),L(ct),L(Ft),L(pt),L(At),L(mt),l&&o(fs),l&&o(Ge),L(Dt),l&&o(bs),l&&o(pe),L(Nt),L(It),L(ut),l&&o(xs),l&&o(qe),L(Ut),l&&o(ks),l&&o(N),L(Vt),L(Xt),L(ht),L(ft)}}}const fm={local:"generation",sections:[{local:"transformers.generation_utils.GenerationMixin",title:"GenerationMixin"},{local:"transformers.generation_tf_utils.TFGenerationMixin",title:"TFGenerationMixin"},{local:"transformers.generation_flax_utils.FlaxGenerationMixin",title:"FlaxGenerationMixin"}],title:"Generation"};function bm(w){return nm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Lm extends Qp{constructor(d){super();Yp(this,d,bm,hm,em,{})}}export{Lm as default,fm as metadata};
