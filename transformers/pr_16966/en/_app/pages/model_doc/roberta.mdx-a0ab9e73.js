...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_16966/src/transformers/models/roberta/tokenization_roberta.py#L340",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_16966/src/transformers/models/roberta/tokenization_roberta.py#L365",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16966/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
refer to this superclass for more information regarding those methods.`),cf.forEach(t),Kg=h(Xe),Ll=s(Xe,"DIV",{class:!0});var K2=a(Ll);y(Ea.$$.fragment,K2),K2.forEach(t),Xe.forEach(t),gm=h(o),_o=s(o,"H2",{class:!0});var pf=a(_o);yn=s(pf,"A",{id:!0,class:!0,href:!0});var G2=a(yn);sc=s(G2,"SPAN",{});var X2=a(sc);y(za.$$.fragment,X2),X2.forEach(t),G2.forEach(t),Gg=h(pf),ac=s(pf,"SPAN",{});var Y2=a(ac);Xg=i(Y2,"RobertaModel"),Y2.forEach(t),pf.forEach(t),_m=h(o),Ae=s(o,"DIV",{class:!0});var Ye=a(Ae);y(qa.$$.fragment,Ye),Yg=h(Ye),rc=s(Ye,"P",{});var Z2=a(rc);Zg=i(Z2,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Z2.forEach(t),e_=h(Ye),Ca=s(Ye,"P",{});var hf=a(Ca);t_=i(hf,"This model inherits from "),Al=s(hf,"A",{href:!0});var e6=a(Al);o_=i(e6,"PreTrainedModel"),e6.forEach(t),n_=i(hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hf.forEach(t),s_=h(Ye),ja=s(Ye,"P",{});var mf=a(ja);a_=i(mf,"This model is also a PyTorch "),Pa=s(mf,"A",{href:!0,rel:!0});var t6=a(Pa);r_=i(t6,"torch.nn.Module"),t6.forEach(t),i_=i(mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),ic=s(ff,"EM",{});var o6=a(ic);c_=i(o6,`Attention is
all you need`),o6.forEach(t),p_=i(ff,`_ by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin.`),ff.forEach(t),h_=h(Ye),Ue=s(Ye,"P",{});var mt=a(Ue);m_=i(mt,"To behave as an decoder the model needs to be initialized with the "),lc=s(mt,"CODE",{});var n6=a(lc);f_=i(n6,"is_decoder"),n6.forEach(t),u_=i(mt,` argument of the configuration set
to `),dc=s(mt,"CODE",{});var s6=a(dc);g_=i(s6,"True"),s6.forEach(t),__=i(mt,". To be used in a Seq2Seq model, the model needs to initialized with both "),cc=s(mt,"CODE",{});var a6=a(cc);b_=i(a6,"is_decoder"),a6.forEach(t),k_=i(mt,` argument and
`),pc=s(mt,"CODE",{});var r6=a(pc);v_=i(r6,"add_cross_attention"),r6.forEach(t),T_=i(mt," set to "),hc=s(mt,"CODE",{});var i6=a(hc);y_=i(i6,"True"),i6.forEach(t),w_=i(mt,"; an "),mc=s(mt,"CODE",{});var l6=a(mc);$_=i(l6,"encoder_hidden_states"),l6.forEach(t),F_=i(mt," is then expected as an input to the forward pass."),mt.forEach(t),x_=h(Ye),wn=s(Ye,"P",{});var lm=a(wn);R_=i(lm,".. _"),fc=s(lm,"EM",{});var d6=a(fc);M_=i(d6,"Attention is all you need"),d6.forEach(t),E_=i(lm,": "),Aa=s(lm,"A",{href:!0,rel:!0});var c6=a(Aa);z_=i(c6,"https://arxiv.org/abs/1706.03762"),c6.forEach(t),lm.forEach(t),q_=h(Ye),yt=s(Ye,"DIV",{class:!0});var Hs=a(yt);y(Oa.$$.fragment,Hs),C_=h(Hs),bo=s(Hs,"P",{});var bd=a(bo);j_=i(bd,"The "),Ol=s(bd,"A",{href:!0});var p6=a(Ol);P_=i(p6,"RobertaModel"),p6.forEach(t),L_=i(bd," forward method, overrides the "),uc=s(bd,"CODE",{});var h6=a(uc);A_=i(h6,"__call__"),h6.forEach(t),O_=i(bd," special method."),bd.forEach(t),N_=h(Hs),y($n.$$.fragment,Hs),I_=h(Hs),y(Fn.$$.fragment,Hs),Hs.forEach(t),Ye.forEach(t),bm=h(o),ko=s(o,"H2",{class:!0});var uf=a(ko);xn=s(uf,"A",{id:!0,class:!0,href:!0});var m6=a(xn);gc=s(m6,"SPAN",{});var f6=a(gc);y(Na.$$.fragment,f6),f6.forEach(t),m6.forEach(t),D_=h(uf),_c=s(uf,"SPAN",{});var u6=a(_c);S_=i(u6,"RobertaForCausalLM"),u6.forEach(t),uf.forEach(t),km=h(o),et=s(o,"DIV",{class:!0});var Yt=a(et);y(Ia.$$.fragment,Yt),W_=h(Yt),Da=s(Yt,"P",{});var gf=a(Da);B_=i(gf,"RoBERTa Model with a "),bc=s(gf,"CODE",{});var g6=a(bc);U_=i(g6,"language modeling"),g6.forEach(t),H_=i(gf," head on top for CLM fine-tuning."),gf.forEach(t),Q_=h(Yt),Sa=s(Yt,"P",{});var _f=a(Sa);V_=i(_f,"This model inherits from "),Nl=s(_f,"A",{href:!0});var _6=a(Nl);J_=i(_6,"PreTrainedModel"),_6.forEach(t),K_=i(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_f.forEach(t),G_=h(Yt),Wa=s(Yt,"P",{});var bf=a(Wa);X_=i(bf,"This model is also a PyTorch "),Ba=s(bf,"A",{href:!0,rel:!0});var b6=a(Ba);Y_=i(b6,"torch.nn.Module"),b6.forEach(t),Z_=i(bf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bf.forEach(t),eb=h(Yt),wt=s(Yt,"DIV",{class:!0});var Qs=a(wt);y(Ua.$$.fragment,Qs),tb=h(Qs),vo=s(Qs,"P",{});var kd=a(vo);ob=i(kd,"The "),Il=s(kd,"A",{href:!0});var k6=a(Il);nb=i(k6,"RobertaForCausalLM"),k6.forEach(t),sb=i(kd," forward method, overrides the "),kc=s(kd,"CODE",{});var v6=a(kc);ab=i(v6,"__call__"),v6.forEach(t),rb=i(kd," special method."),kd.forEach(t),ib=h(Qs),y(Rn.$$.fragment,Qs),lb=h(Qs),y(Mn.$$.fragment,Qs),Qs.forEach(t),Yt.forEach(t),vm=h(o),To=s(o,"H2",{class:!0});var kf=a(To);En=s(kf,"A",{id:!0,class:!0,href:!0});var T6=a(En);vc=s(T6,"SPAN",{});var y6=a(vc);y(Ha.$$.fragment,y6),y6.forEach(t),T6.forEach(t),db=h(kf),Tc=s(kf,"SPAN",{});var w6=a(Tc);cb=i(w6,"RobertaForMaskedLM"),w6.forEach(t),kf.forEach(t),Tm=h(o),tt=s(o,"DIV",{class:!0});var Zt=a(tt);y(Qa.$$.fragment,Zt),pb=h(Zt),Va=s(Zt,"P",{});var vf=a(Va);hb=i(vf,"RoBERTa Model with a "),yc=s(vf,"CODE",{});var $6=a(yc);mb=i($6,"language modeling"),$6.forEach(t),fb=i(vf," head on top."),vf.forEach(t),ub=h(Zt),Ja=s(Zt,"P",{});var Tf=a(Ja);gb=i(Tf,"This model inherits from "),Dl=s(Tf,"A",{href:!0});var F6=a(Dl);_b=i(F6,"PreTrainedModel"),F6.forEach(t),bb=i(Tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tf.forEach(t),kb=h(Zt),Ka=s(Zt,"P",{});var yf=a(Ka);vb=i(yf,"This model is also a PyTorch "),Ga=s(yf,"A",{href:!0,rel:!0});var x6=a(Ga);Tb=i(x6,"torch.nn.Module"),x6.forEach(t),yb=i(yf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yf.forEach(t),wb=h(Zt),rt=s(Zt,"DIV",{class:!0});var eo=a(rt);y(Xa.$$.fragment,eo),$b=h(eo),yo=s(eo,"P",{});var vd=a(yo);Fb=i(vd,"The "),Sl=s(vd,"A",{href:!0});var R6=a(Sl);xb=i(R6,"RobertaForMaskedLM"),R6.forEach(t),Rb=i(vd," forward method, overrides the "),wc=s(vd,"CODE",{});var M6=a(wc);Mb=i(M6,"__call__"),M6.forEach(t),Eb=i(vd," special method."),vd.forEach(t),zb=h(eo),y(zn.$$.fragment,eo),qb=h(eo),y(qn.$$.fragment,eo),Cb=h(eo),y(Cn.$$.fragment,eo),eo.forEach(t),Zt.forEach(t),ym=h(o),wo=s(o,"H2",{class:!0});var wf=a(wo);jn=s(wf,"A",{id:!0,class:!0,href:!0});var E6=a(jn);$c=s(E6,"SPAN",{});var z6=a($c);y(Ya.$$.fragment,z6),z6.forEach(t),E6.forEach(t),jb=h(wf),Fc=s(wf,"SPAN",{});var q6=a(Fc);Pb=i(q6,"RobertaForSequenceClassification"),q6.forEach(t),wf.forEach(t),wm=h(o),ot=s(o,"DIV",{class:!0});var to=a(ot);y(Za.$$.fragment,to),Lb=h(to),xc=s(to,"P",{});var C6=a(xc);Ab=i(C6,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),C6.forEach(t),Ob=h(to),er=s(to,"P",{});var $f=a(er);Nb=i($f,"This model inherits from "),Wl=s($f,"A",{href:!0});var j6=a(Wl);Ib=i(j6,"PreTrainedModel"),j6.forEach(t),Db=i($f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f.forEach(t),Sb=h(to),tr=s(to,"P",{});var Ff=a(tr);Wb=i(Ff,"This model is also a PyTorch "),or=s(Ff,"A",{href:!0,rel:!0});var P6=a(or);Bb=i(P6,"torch.nn.Module"),P6.forEach(t),Ub=i(Ff,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ff.forEach(t),Hb=h(to),Be=s(to,"DIV",{class:!0});var ft=a(Be);y(nr.$$.fragment,ft),Qb=h(ft),$o=s(ft,"P",{});var Td=a($o);Vb=i(Td,"The "),Bl=s(Td,"A",{href:!0});var L6=a(Bl);Jb=i(L6,"RobertaForSequenceClassification"),L6.forEach(t),Kb=i(Td," forward method, overrides the "),Rc=s(Td,"CODE",{});var A6=a(Rc);Gb=i(A6,"__call__"),A6.forEach(t),Xb=i(Td," special method."),Td.forEach(t),Yb=h(ft),y(Pn.$$.fragment,ft),Zb=h(ft),y(Ln.$$.fragment,ft),ek=h(ft),y(An.$$.fragment,ft),tk=h(ft),y(On.$$.fragment,ft),ok=h(ft),y(Nn.$$.fragment,ft),ft.forEach(t),to.forEach(t),$m=h(o),Fo=s(o,"H2",{class:!0});var xf=a(Fo);In=s(xf,"A",{id:!0,class:!0,href:!0});var O6=a(In);Mc=s(O6,"SPAN",{});var N6=a(Mc);y(sr.$$.fragment,N6),N6.forEach(t),O6.forEach(t),nk=h(xf),Ec=s(xf,"SPAN",{});var I6=a(Ec);sk=i(I6,"RobertaForMultipleChoice"),I6.forEach(t),xf.forEach(t),Fm=h(o),nt=s(o,"DIV",{class:!0});var oo=a(nt);y(ar.$$.fragment,oo),ak=h(oo),zc=s(oo,"P",{});var D6=a(zc);rk=i(D6,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),D6.forEach(t),ik=h(oo),rr=s(oo,"P",{});var Rf=a(rr);lk=i(Rf,"This model inherits from "),Ul=s(Rf,"A",{href:!0});var S6=a(Ul);dk=i(S6,"PreTrainedModel"),S6.forEach(t),ck=i(Rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rf.forEach(t),pk=h(oo),ir=s(oo,"P",{});var Mf=a(ir);hk=i(Mf,"This model is also a PyTorch "),lr=s(Mf,"A",{href:!0,rel:!0});var W6=a(lr);mk=i(W6,"torch.nn.Module"),W6.forEach(t),fk=i(Mf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mf.forEach(t),uk=h(oo),$t=s(oo,"DIV",{class:!0});var Vs=a($t);y(dr.$$.fragment,Vs),gk=h(Vs),xo=s(Vs,"P",{});var yd=a(xo);_k=i(yd,"The "),Hl=s(yd,"A",{href:!0});var B6=a(Hl);bk=i(B6,"RobertaForMultipleChoice"),B6.forEach(t),kk=i(yd," forward method, overrides the "),qc=s(yd,"CODE",{});var U6=a(qc);vk=i(U6,"__call__"),U6.forEach(t),Tk=i(yd," special method."),yd.forEach(t),yk=h(Vs),y(Dn.$$.fragment,Vs),wk=h(Vs),y(Sn.$$.fragment,Vs),Vs.forEach(t),oo.forEach(t),xm=h(o),Ro=s(o,"H2",{class:!0});var Ef=a(Ro);Wn=s(Ef,"A",{id:!0,class:!0,href:!0});var H6=a(Wn);Cc=s(H6,"SPAN",{});var Q6=a(Cc);y(cr.$$.fragment,Q6),Q6.forEach(t),H6.forEach(t),$k=h(Ef),jc=s(Ef,"SPAN",{});var V6=a(jc);Fk=i(V6,"RobertaForTokenClassification"),V6.forEach(t),Ef.forEach(t),Rm=h(o),st=s(o,"DIV",{class:!0});var no=a(st);y(pr.$$.fragment,no),xk=h(no),Pc=s(no,"P",{});var J6=a(Pc);Rk=i(J6,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),J6.forEach(t),Mk=h(no),hr=s(no,"P",{});var zf=a(hr);Ek=i(zf,"This model inherits from "),Ql=s(zf,"A",{href:!0});var K6=a(Ql);zk=i(K6,"PreTrainedModel"),K6.forEach(t),qk=i(zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zf.forEach(t),Ck=h(no),mr=s(no,"P",{});var qf=a(mr);jk=i(qf,"This model is also a PyTorch "),fr=s(qf,"A",{href:!0,rel:!0});var G6=a(fr);Pk=i(G6,"torch.nn.Module"),G6.forEach(t),Lk=i(qf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qf.forEach(t),Ak=h(no),it=s(no,"DIV",{class:!0});var so=a(it);y(ur.$$.fragment,so),Ok=h(so),Mo=s(so,"P",{});var wd=a(Mo);Nk=i(wd,"The "),Vl=s(wd,"A",{href:!0});var X6=a(Vl);Ik=i(X6,"RobertaForTokenClassification"),X6.forEach(t),Dk=i(wd," forward method, overrides the "),Lc=s(wd,"CODE",{});var Y6=a(Lc);Sk=i(Y6,"__call__"),Y6.forEach(t),Wk=i(wd," special method."),wd.forEach(t),Bk=h(so),y(Bn.$$.fragment,so),Uk=h(so),y(Un.$$.fragment,so),Hk=h(so),y(Hn.$$.fragment,so),so.forEach(t),no.forEach(t),Mm=h(o),Eo=s(o,"H2",{class:!0});var Cf=a(Eo);Qn=s(Cf,"A",{id:!0,class:!0,href:!0});var Z6=a(Qn);Ac=s(Z6,"SPAN",{});var eF=a(Ac);y(gr.$$.fragment,eF),eF.forEach(t),Z6.forEach(t),Qk=h(Cf),Oc=s(Cf,"SPAN",{});var tF=a(Oc);Vk=i(tF,"RobertaForQuestionAnswering"),tF.forEach(t),Cf.forEach(t),Em=h(o),at=s(o,"DIV",{class:!0});var ao=a(at);y(_r.$$.fragment,ao),Jk=h(ao),zo=s(ao,"P",{});var $d=a(zo);Kk=i($d,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
