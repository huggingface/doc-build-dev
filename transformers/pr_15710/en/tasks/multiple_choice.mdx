...
Load BERT with [AutoModelForMultipleChoice](/docs/transformers/pr_15710/en/model_doc/auto#transformers.AutoModelForMultipleChoice):
...
1. Define your training hyperparameters in [TrainingArguments](/docs/transformers/pr_15710/en/main_classes/trainer#transformers.TrainingArguments).
2. Pass the training arguments to [Trainer](/docs/transformers/pr_15710/en/main_classes/trainer#transformers.Trainer) along with the model, dataset, tokenizer, and data collator.
3. Call [train()](/docs/transformers/pr_15710/en/main_classes/trainer#transformers.Trainer.train) to fine-tune your model.
...
Load BERT with [TFAutoModelForMultipleChoice](/docs/transformers/pr_15710/en/model_doc/auto#transformers.TFAutoModelForMultipleChoice):
