...
Use [DefaultDataCollator](/docs/transformers/pr_15710/en/main_classes/data_collator#transformers.DefaultDataCollator) to create a batch of examples. Unlike other data collators in 🤗 Transformers, the `DefaultDataCollator` does not apply additional preprocessing such as padding.
...
Load DistilBERT with [AutoModelForQuestionAnswering](/docs/transformers/pr_15710/en/model_doc/auto#transformers.AutoModelForQuestionAnswering):
...
Load DistilBERT with [TFAutoModelForQuestionAnswering](/docs/transformers/pr_15710/en/model_doc/auto#transformers.TFAutoModelForQuestionAnswering):
