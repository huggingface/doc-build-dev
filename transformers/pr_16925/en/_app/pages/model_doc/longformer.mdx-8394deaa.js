import{S as iT,i as lT,s as dT,e as r,k as c,w as v,t as n,Y as Ot,M as cT,c as a,d as o,m,a as i,x as T,h as s,Z as jt,b as _,F as e,g as f,y,q as $,o as L,B as x,v as mT,L as je}from"../../chunks/vendor-6b77c823.js";import{T as Ae}from"../../chunks/Tip-39098574.js";import{D as Q}from"../../chunks/Docstring-1088f2fb.js";import{C as qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ce}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Oe}from"../../chunks/ExampleCodeBlock-5212b321.js";function pT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerConfig, LongformerModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=r("p"),k=n("Example:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Example:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function hT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function fT(M){let d,k,p,h,b;return h=new qe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>pooled_output = outputs.pooler_output`}}),{c(){d=r("p"),k=n("Examples:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Examples:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function gT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function uT(M){let d,k,p,h,b;return h=new qe({props:{code:`import torch
...
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function wT(M){let d,k,p,h,b;return h=new qe({props:{code:`import torch
...
`}}),{c(){d=r("p"),k=n("Example of single-label classification:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Example of single-label classification:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function kT(M){let d,k;return d=new qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){v(d.$$.fragment)},l(p){T(d.$$.fragment,p)},m(p,h){y(d,p,h),k=!0},p:je,i(p){k||($(d.$$.fragment,p),k=!0)},o(p){L(d.$$.fragment,p),k=!1},d(p){x(d,p)}}}function bT(M){let d,k,p,h,b;return h=new qe({props:{code:`import torch
from transformers import LongformerTokenizer, LongformerForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=r("p"),k=n("Example of multi-label classification:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Example of multi-label classification:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function vT(M){let d,k;return d=new qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
model = LongformerForSequenceClassification.from_pretrained("allenai/longformer-base-4096", num_labels=num_labels)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(d.$$.fragment)},l(p){T(d.$$.fragment,p)},m(p,h){y(d,p,h),k=!0},p:je,i(p){k||($(d.$$.fragment,p),k=!0)},o(p){L(d.$$.fragment,p),k=!1},d(p){x(d,p)}}}function TT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function yT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerTokenizer, LongformerForMultipleChoice
import torch
...
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function LT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerTokenizer, LongformerForTokenClassification
import torch
...
`}}),{c(){d=r("p"),k=n("Example:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Example:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function xT(M){let d,k;return d=new qe({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(p){T(d.$$.fragment,p)},m(p,h){y(d,p,h),k=!0},p:je,i(p){k||($(d.$$.fragment,p),k=!0)},o(p){L(d.$$.fragment,p),k=!1},d(p){x(d,p)}}}function FT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function MT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerTokenizer, LongformerForQuestionAnswering
import torch
...
first positional argument :`),xe.forEach(o),X=m(w),q=a(w,"UL",{});var j=i(q);O=a(j,"LI",{});var V=i(O);ne=s(V,"a single Tensor with "),B=a(V,"CODE",{});var Fe=i(B);de=s(Fe,"input_ids"),Fe.forEach(o),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=m(j),C=a(j,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(I,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(o),I.forEach(o),_e=m(j),N=a(j,"LI",{});var te=i(N);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),j.forEach(o)},m(w,F){f(w,d,F),e(d,k),f(w,p,F),f(w,h,F),e(h,b),e(b,l),e(h,u),e(h,E),e(E,pe),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,oe),f(w,X,F),f(w,q,F),e(q,O),e(O,ne),e(O,B),e(B,de),e(O,se),e(O,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,U),e(U,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&o(d),w&&o(p),w&&o(h),w&&o(J),w&&o(z),w&&o(G),w&&o(P),w&&o(X),w&&o(q)}}}function zT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function qT(M){let d,k,p,h,b,l,u,E,pe,J,z,Z,S,ee,he,D,fe,le,G,P,oe,X,q,O,ne,B,de,se,W,ge,ce,C,ue,U,re,K,H,ae,_e,N,ie,R,we;return{c(){d=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),p=c(),h=r("ul"),b=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),E=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),z=r("p"),Z=n("This second option is useful when using "),S=r("code"),ee=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),fe=n("model(inputs)"),le=n("."),G=c(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),q=r("ul"),O=r("li"),ne=n("a single Tensor with "),B=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ge=n("model(inputs_ids)"),ce=c(),C=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=c(),N=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){d=a(w,"P",{});var F=i(d);k=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),p=m(w),h=a(w,"UL",{});var Y=i(h);b=a(Y,"LI",{});var Te=i(b);l=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(o),u=m(Y),E=a(Y,"LI",{});var me=i(E);pe=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(o),Y.forEach(o),J=m(w),z=a(w,"P",{});var A=i(z);Z=s(A,"This second option is useful when using "),S=a(A,"CODE",{});var be=i(S);ee=s(be,"tf.keras.Model.fit"),be.forEach(o),he=s(A,` method which currently requires having all the
...
first positional argument :`),xe.forEach(o),X=m(w),q=a(w,"UL",{});var j=i(q);O=a(j,"LI",{});var V=i(O);ne=s(V,"a single Tensor with "),B=a(V,"CODE",{});var Fe=i(B);de=s(Fe,"input_ids"),Fe.forEach(o),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=m(j),C=a(j,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(I,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(o),I.forEach(o),_e=m(j),N=a(j,"LI",{});var te=i(N);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),j.forEach(o)},m(w,F){f(w,d,F),e(d,k),f(w,p,F),f(w,h,F),e(h,b),e(b,l),e(h,u),e(h,E),e(E,pe),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,oe),f(w,X,F),f(w,q,F),e(q,O),e(O,ne),e(O,B),e(B,de),e(O,se),e(O,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,U),e(U,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&o(d),w&&o(p),w&&o(h),w&&o(J),w&&o(z),w&&o(G),w&&o(P),w&&o(X),w&&o(q)}}}function CT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function OT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMaskedLM
...
`}}),{c(){d=r("p"),k=n("Example:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Example:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function jT(M){let d,k;return d=new qe({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="tf")["input_ids"]
...
`}}),{c(){v(d.$$.fragment)},l(p){T(d.$$.fragment,p)},m(p,h){y(d,p,h),k=!0},p:je,i(p){k||($(d.$$.fragment,p),k=!0)},o(p){L(d.$$.fragment,p),k=!1},d(p){x(d,p)}}}function PT(M){let d,k,p,h,b,l,u,E,pe,J,z,Z,S,ee,he,D,fe,le,G,P,oe,X,q,O,ne,B,de,se,W,ge,ce,C,ue,U,re,K,H,ae,_e,N,ie,R,we;return{c(){d=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),p=c(),h=r("ul"),b=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),E=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),z=r("p"),Z=n("This second option is useful when using "),S=r("code"),ee=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),fe=n("model(inputs)"),le=n("."),G=c(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),q=r("ul"),O=r("li"),ne=n("a single Tensor with "),B=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ge=n("model(inputs_ids)"),ce=c(),C=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=c(),N=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){d=a(w,"P",{});var F=i(d);k=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),p=m(w),h=a(w,"UL",{});var Y=i(h);b=a(Y,"LI",{});var Te=i(b);l=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(o),u=m(Y),E=a(Y,"LI",{});var me=i(E);pe=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(o),Y.forEach(o),J=m(w),z=a(w,"P",{});var A=i(z);Z=s(A,"This second option is useful when using "),S=a(A,"CODE",{});var be=i(S);ee=s(be,"tf.keras.Model.fit"),be.forEach(o),he=s(A,` method which currently requires having all the
...
first positional argument :`),xe.forEach(o),X=m(w),q=a(w,"UL",{});var j=i(q);O=a(j,"LI",{});var V=i(O);ne=s(V,"a single Tensor with "),B=a(V,"CODE",{});var Fe=i(B);de=s(Fe,"input_ids"),Fe.forEach(o),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=m(j),C=a(j,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(I,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(o),I.forEach(o),_e=m(j),N=a(j,"LI",{});var te=i(N);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),j.forEach(o)},m(w,F){f(w,d,F),e(d,k),f(w,p,F),f(w,h,F),e(h,b),e(b,l),e(h,u),e(h,E),e(E,pe),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,oe),f(w,X,F),f(w,q,F),e(q,O),e(O,ne),e(O,B),e(B,de),e(O,se),e(O,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,U),e(U,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&o(d),w&&o(p),w&&o(h),w&&o(J),w&&o(z),w&&o(G),w&&o(P),w&&o(X),w&&o(q)}}}function NT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function AT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerTokenizer, TFLongformerForQuestionAnswering
import tensorflow as tf
...
`}}),{c(){d=r("p"),k=n("Example:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Example:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function IT(M){let d,k;return d=new qe({props:{code:`# target is "nice puppet"
...
`}}),{c(){v(d.$$.fragment)},l(p){T(d.$$.fragment,p)},m(p,h){y(d,p,h),k=!0},p:je,i(p){k||($(d.$$.fragment,p),k=!0)},o(p){L(d.$$.fragment,p),k=!1},d(p){x(d,p)}}}function ST(M){let d,k,p,h,b,l,u,E,pe,J,z,Z,S,ee,he,D,fe,le,G,P,oe,X,q,O,ne,B,de,se,W,ge,ce,C,ue,U,re,K,H,ae,_e,N,ie,R,we;return{c(){d=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),p=c(),h=r("ul"),b=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),E=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),z=r("p"),Z=n("This second option is useful when using "),S=r("code"),ee=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),fe=n("model(inputs)"),le=n("."),G=c(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),q=r("ul"),O=r("li"),ne=n("a single Tensor with "),B=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ge=n("model(inputs_ids)"),ce=c(),C=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=c(),N=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){d=a(w,"P",{});var F=i(d);k=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),p=m(w),h=a(w,"UL",{});var Y=i(h);b=a(Y,"LI",{});var Te=i(b);l=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(o),u=m(Y),E=a(Y,"LI",{});var me=i(E);pe=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(o),Y.forEach(o),J=m(w),z=a(w,"P",{});var A=i(z);Z=s(A,"This second option is useful when using "),S=a(A,"CODE",{});var be=i(S);ee=s(be,"tf.keras.Model.fit"),be.forEach(o),he=s(A,` method which currently requires having all the
...
first positional argument :`),xe.forEach(o),X=m(w),q=a(w,"UL",{});var j=i(q);O=a(j,"LI",{});var V=i(O);ne=s(V,"a single Tensor with "),B=a(V,"CODE",{});var Fe=i(B);de=s(Fe,"input_ids"),Fe.forEach(o),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=m(j),C=a(j,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(I,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(o),I.forEach(o),_e=m(j),N=a(j,"LI",{});var te=i(N);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),j.forEach(o)},m(w,F){f(w,d,F),e(d,k),f(w,p,F),f(w,h,F),e(h,b),e(b,l),e(h,u),e(h,E),e(E,pe),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,oe),f(w,X,F),f(w,q,F),e(q,O),e(O,ne),e(O,B),e(B,de),e(O,se),e(O,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,U),e(U,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&o(d),w&&o(p),w&&o(h),w&&o(J),w&&o(z),w&&o(G),w&&o(P),w&&o(X),w&&o(q)}}}function DT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function WT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=r("p"),k=n("Example:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Example:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function QT(M){let d,k;return d=new qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(p){T(d.$$.fragment,p)},m(p,h){y(d,p,h),k=!0},p:je,i(p){k||($(d.$$.fragment,p),k=!0)},o(p){L(d.$$.fragment,p),k=!1},d(p){x(d,p)}}}function UT(M){let d,k,p,h,b,l,u,E,pe,J,z,Z,S,ee,he,D,fe,le,G,P,oe,X,q,O,ne,B,de,se,W,ge,ce,C,ue,U,re,K,H,ae,_e,N,ie,R,we;return{c(){d=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),p=c(),h=r("ul"),b=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),E=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),z=r("p"),Z=n("This second option is useful when using "),S=r("code"),ee=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),fe=n("model(inputs)"),le=n("."),G=c(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),q=r("ul"),O=r("li"),ne=n("a single Tensor with "),B=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ge=n("model(inputs_ids)"),ce=c(),C=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=c(),N=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){d=a(w,"P",{});var F=i(d);k=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),p=m(w),h=a(w,"UL",{});var Y=i(h);b=a(Y,"LI",{});var Te=i(b);l=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(o),u=m(Y),E=a(Y,"LI",{});var me=i(E);pe=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(o),Y.forEach(o),J=m(w),z=a(w,"P",{});var A=i(z);Z=s(A,"This second option is useful when using "),S=a(A,"CODE",{});var be=i(S);ee=s(be,"tf.keras.Model.fit"),be.forEach(o),he=s(A,` method which currently requires having all the
...
first positional argument :`),xe.forEach(o),X=m(w),q=a(w,"UL",{});var j=i(q);O=a(j,"LI",{});var V=i(O);ne=s(V,"a single Tensor with "),B=a(V,"CODE",{});var Fe=i(B);de=s(Fe,"input_ids"),Fe.forEach(o),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=m(j),C=a(j,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(I,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(o),I.forEach(o),_e=m(j),N=a(j,"LI",{});var te=i(N);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),j.forEach(o)},m(w,F){f(w,d,F),e(d,k),f(w,p,F),f(w,h,F),e(h,b),e(b,l),e(h,u),e(h,E),e(E,pe),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,oe),f(w,X,F),f(w,q,F),e(q,O),e(O,ne),e(O,B),e(B,de),e(O,se),e(O,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,U),e(U,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&o(d),w&&o(p),w&&o(h),w&&o(J),w&&o(z),w&&o(G),w&&o(P),w&&o(X),w&&o(q)}}}function BT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function HT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_tokens_classes
`}}),{c(){d=r("p"),k=n("Example:"),p=c(),v(h.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Example:"),u.forEach(o),p=m(l),T(h.$$.fragment,l)},m(l,u){f(l,d,u),e(d,k),f(l,p,u),y(h,l,u),b=!0},p:je,i(l){b||($(h.$$.fragment,l),b=!0)},o(l){L(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(p),x(h,l)}}}function RT(M){let d,k;return d=new qe({props:{code:`labels = predicted_token_class_ids
loss = tf.math.reduce_mean(model(**inputs, labels=labels).loss)
round(float(loss), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = tf.math.reduce_mean(model(**inputs, labels=labels).loss)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(p){T(d.$$.fragment,p)},m(p,h){y(d,p,h),k=!0},p:je,i(p){k||($(d.$$.fragment,p),k=!0)},o(p){L(d.$$.fragment,p),k=!1},d(p){x(d,p)}}}function VT(M){let d,k,p,h,b,l,u,E,pe,J,z,Z,S,ee,he,D,fe,le,G,P,oe,X,q,O,ne,B,de,se,W,ge,ce,C,ue,U,re,K,H,ae,_e,N,ie,R,we;return{c(){d=r("p"),k=n("TF 2.0 models accepts two formats as inputs:"),p=c(),h=r("ul"),b=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),E=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),z=r("p"),Z=n("This second option is useful when using "),S=r("code"),ee=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),fe=n("model(inputs)"),le=n("."),G=c(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),q=r("ul"),O=r("li"),ne=n("a single Tensor with "),B=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ge=n("model(inputs_ids)"),ce=c(),C=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=c(),N=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){d=a(w,"P",{});var F=i(d);k=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),p=m(w),h=a(w,"UL",{});var Y=i(h);b=a(Y,"LI",{});var Te=i(b);l=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(o),u=m(Y),E=a(Y,"LI",{});var me=i(E);pe=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(o),Y.forEach(o),J=m(w),z=a(w,"P",{});var A=i(z);Z=s(A,"This second option is useful when using "),S=a(A,"CODE",{});var be=i(S);ee=s(be,"tf.keras.Model.fit"),be.forEach(o),he=s(A,` method which currently requires having all the
...
first positional argument :`),xe.forEach(o),X=m(w),q=a(w,"UL",{});var j=i(q);O=a(j,"LI",{});var V=i(O);ne=s(V,"a single Tensor with "),B=a(V,"CODE",{});var Fe=i(B);de=s(Fe,"input_ids"),Fe.forEach(o),se=s(V," only and nothing else: "),W=a(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=m(j),C=a(j,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(I,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(o),I.forEach(o),_e=m(j),N=a(j,"LI",{});var te=i(N);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),j.forEach(o)},m(w,F){f(w,d,F),e(d,k),f(w,p,F),f(w,h,F),e(h,b),e(b,l),e(h,u),e(h,E),e(E,pe),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,he),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,oe),f(w,X,F),f(w,q,F),e(q,O),e(O,ne),e(O,B),e(B,de),e(O,se),e(O,W),e(W,ge),e(q,ce),e(q,C),e(C,ue),e(C,U),e(U,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&o(d),w&&o(p),w&&o(h),w&&o(J),w&&o(z),w&&o(G),w&&o(P),w&&o(X),w&&o(q)}}}function GT(M){let d,k,p,h,b;return{c(){d=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(u,"CODE",{});var E=i(p);h=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(l,u){f(l,d,u),e(d,k),e(d,p),e(p,h),e(d,b)},d(l){l&&o(d)}}}function KT(M){let d,k,p,h,b;return h=new qe({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMultipleChoice
import tensorflow as tf
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.LongformerConfig"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_longformer.py#L1751",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_longformer.py#L1852",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_longformer.py#L2199",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_longformer.py#L2118",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
`}}),dn=new Ae({props:{$$slots:{default:[$T]},$$scope:{ctx:M}}}),cn=new Oe({props:{anchor:"transformers.LongformerForTokenClassification.forward.example",$$slots:{default:[LT]},$$scope:{ctx:M}}}),mn=new Oe({props:{anchor:"transformers.LongformerForTokenClassification.forward.example-2",$$slots:{default:[xT]},$$scope:{ctx:M}}}),Ys=new Ce({}),Zs=new Q({props:{name:"class transformers.LongformerForQuestionAnswering",anchor:"transformers.LongformerForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_longformer.py#L1978",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_tf_longformer.py#L2080",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_tf_longformer.py#L2174",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_tf_longformer.py#L2321",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_tf_longformer.py#L2561",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/longformer/modeling_tf_longformer.py#L2429",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
different `),wd=new Ot,kd=n(` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
...
that every \u201Clocally\u201D attending token not only attends to tokens within its window `),vd=new Ot,Td=n(`, but also to all \u201Cglobally\u201D
...
represents the memory and time bottleneck, can be reduced from `),Fd=new Ot,Md=n(` to
`),Ed=new Ot,zd=n(", with "),qd=new Ot,Cd=n(" being the sequence length and "),Od=new Ot,jd=n(` being the average window
size. It is assumed that the number of \u201Cglobally\u201D attending tokens is insignificant as compared to the number of
\u201Clocally\u201D attending tokens.`),Pd=c(),At=r("p"),cp=n("For more information, please refer to the official "),Vn=r("a"),mp=n("paper"),pp=n("."),Nd=c(),Oo=r("h2"),It=r("a"),ci=r("span"),v(Gn.$$.fragment),hp=c(),mi=r("span"),fp=n("Training"),Ad=c(),jo=r("p"),Kr=r("a"),gp=n("LongformerForMaskedLM"),up=n(" is trained the exact same way "),Jr=r("a"),_p=n("RobertaForMaskedLM"),wp=n(` is
...
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),Fp=c(),Ao=r("p"),Mp=n("This is the configuration class to store the configuration of a "),Zr=r("a"),Ep=n("LongformerModel"),zp=n(`. It is used to instantiate an
...
`),Yn=r("a"),qp=n("roberta-base"),Cp=n(" architecture with a sequence length 4,096."),Op=c(),Io=r("p"),jp=n("The "),ea=r("a"),Pp=n("LongformerConfig"),Np=n(" class directly inherits "),oa=r("a"),Ap=n("RobertaConfig"),Ip=n(`. It reuses the same defaults. Please check the
...
kernel to be memory and compute efficient.`),sf=c(),so=r("div"),v(xs.$$.fragment),rf=c(),st=r("p"),af=n("The "),la=r("a"),lf=n("LongformerModel"),df=n(" forward method, overrides the "),Di=r("code"),cf=n("__call__"),mf=n(" special method."),pf=c(),v(Vt.$$.fragment),hf=c(),v(Gt.$$.fragment),lc=c(),rt=r("h2"),Kt=r("a"),Wi=r("span"),v(Fs.$$.fragment),ff=c(),Qi=r("span"),gf=n("LongformerForMaskedLM"),dc=c(),He=r("div"),v(Ms.$$.fragment),uf=c(),Es=r("p"),_f=n("Longformer Model with a "),Ui=r("code"),wf=n("language modeling"),kf=n(" head on top."),bf=c(),zs=r("p"),vf=n("This model inherits from "),da=r("a"),Tf=n("PreTrainedModel"),yf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$f=c(),qs=r("p"),Lf=n("This model is also a PyTorch "),Cs=r("a"),xf=n("torch.nn.Module"),Ff=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mf=c(),ro=r("div"),v(Os.$$.fragment),Ef=c(),at=r("p"),zf=n("The "),ca=r("a"),qf=n("LongformerForMaskedLM"),Cf=n(" forward method, overrides the "),Bi=r("code"),Of=n("__call__"),jf=n(" special method."),Pf=c(),v(Jt.$$.fragment),Nf=c(),v(Xt.$$.fragment),cc=c(),it=r("h2"),Yt=r("a"),Hi=r("span"),v(js.$$.fragment),Af=c(),Ri=r("span"),If=n("LongformerForSequenceClassification"),mc=c(),Re=r("div"),v(Ps.$$.fragment),Sf=c(),Vi=r("p"),Df=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
behavior.`),Ou=c(),v(un.$$.fragment),ju=c(),_t=r("p"),Pu=n("This class copies code from "),ba=r("a"),Nu=n("TFRobertaModel"),Au=n(` and overwrites standard self-attention with longformer
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),lw=c(),v(En.$$.fragment),dw=c(),eo=r("div"),v(zr.$$.fragment),cw=c(),Lt=r("p"),mw=n("The "),Fa=r("a"),pw=n("TFLongformerForSequenceClassification"),hw=n(" forward method, overrides the "),Ll=r("code"),fw=n("__call__"),gw=n(" special method."),uw=c(),v(zn.$$.fragment),_w=c(),v(qn.$$.fragment),ww=c(),v(Cn.$$.fragment),xc=c(),xt=r("h2"),On=r("a"),xl=r("span"),v(qr.$$.fragment),kw=c(),Fl=r("span"),bw=n("TFLongformerForTokenClassification"),Fc=c(),We=r("div"),v(Cr.$$.fragment),vw=c(),Ml=r("p"),Tw=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qw=c(),v(jn.$$.fragment),Cw=c(),oo=r("div"),v(Nr.$$.fragment),Ow=c(),Ft=r("p"),jw=n("The "),Ea=r("a"),Pw=n("TFLongformerForTokenClassification"),Nw=n(" forward method, overrides the "),El=r("code"),Aw=n("__call__"),Iw=n(" special method."),Sw=c(),v(Pn.$$.fragment),Dw=c(),v(Nn.$$.fragment),Ww=c(),v(An.$$.fragment),Mc=c(),Mt=r("h2"),In=r("a"),zl=r("span"),v(Ar.$$.fragment),Qw=c(),ql=r("span"),Uw=n("TFLongformerForMultipleChoice"),Ec=c(),Qe=r("div"),v(Ir.$$.fragment),Bw=c(),Cl=r("p"),Hw=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ek=c(),v(Sn.$$.fragment),ok=c(),lo=r("div"),v(Qr.$$.fragment),tk=c(),Et=r("p"),nk=n("The "),qa=r("a"),sk=n("TFLongformerForMultipleChoice"),rk=n(" forward method, overrides the "),Ol=r("code"),ak=n("__call__"),ik=n(" special method."),lk=c(),v(Dn.$$.fragment),dk=c(),v(Wn.$$.fragment),this.h()},l(t){const g=cT('[data-svelte="svelte-1phssyn"]',document.head);d=a(g,"META",{name:!0,content:!0}),g.forEach(o),k=m(t),p=a(t,"H1",{class:!0});var Ur=i(p);h=a(Ur,"A",{id:!0,class:!0,href:!0});var jl=i(h);b=a(jl,"SPAN",{});var Pl=i(b);T(l.$$.fragment,Pl),Pl.forEach(o),jl.forEach(o),u=m(Ur),E=a(Ur,"SPAN",{});var Nl=i(E);pe=s(Nl,"Longformer"),Nl.forEach(o),Ur.forEach(o),J=m(t),z=a(t,"H2",{class:!0});var Br=i(z);Z=a(Br,"A",{id:!0,class:!0,href:!0});var Al=i(Z);S=a(Al,"SPAN",{});var Il=i(S);T(ee.$$.fragment,Il),Il.forEach(o),Al.forEach(o),he=m(Br),D=a(Br,"SPAN",{});var Sl=i(D);fe=s(Sl,"Overview"),Sl.forEach(o),Br.forEach(o),le=m(t),G=a(t,"P",{});var Hr=i(G);P=s(Hr,"The Longformer model was presented in "),oe=a(Hr,"A",{href:!0,rel:!0});var Dl=i(oe);X=s(Dl,"Longformer: The Long-Document Transformer"),Dl.forEach(o),q=s(Hr," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Hr.forEach(o),O=m(t),ne=a(t,"P",{});var Wl=i(ne);B=s(Wl,"The abstract from the paper is the following:"),Wl.forEach(o),de=m(t),se=a(t,"P",{});var Ql=i(se);W=a(Ql,"EM",{});var Ul=i(W);ge=s(Ul,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
`),w=a(_o,"CODE",{});var Gl=i(w);F=s(Gl,"</s>"),Gl.forEach(o),Y=s(_o,")."),_o.forEach(o),Hl.forEach(o),Te=m(t),me=a(t,"P",{});var zt=i(me);A=s(zt,"This model was contributed by "),be=a(zt,"A",{href:!0,rel:!0});var Kl=i(be);Le=s(Kl,"beltagy"),Kl.forEach(o),xe=s(zt,". The Authors\u2019 code can be found "),j=a(zt,"A",{href:!0,rel:!0});var Jl=i(j);V=s(Jl,"here"),Jl.forEach(o),Fe=s(zt,"."),zt.forEach(o),ye=m(t),I=a(t,"H2",{class:!0});var Rr=i(I);ke=a(Rr,"A",{id:!0,class:!0,href:!0});var Xl=i(ke);ve=a(Xl,"SPAN",{});var Yl=i(ve);T(te.$$.fragment,Yl),Yl.forEach(o),Xl.forEach(o),Me=m(Rr),ei=a(Rr,"SPAN",{});var Zl=i(ei);Sm=s(Zl,"Longformer Self Attention"),Zl.forEach(o),Rr.forEach(o),md=m(t),$e=a(t,"P",{});var ze=i($e);Dm=s(ze,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
attend \u201Clocally\u201D to each other meaning that each token attends to its `),pd=jt(ze),hd=s(ze,` previous tokens and
`),fd=jt(ze),gd=s(ze," succeding tokens with "),ud=jt(ze),_d=s(ze,` being the window length as defined in
`),oi=a(ze,"CODE",{});var ed=i(oi);Wm=s(ed,"config.attention_window"),ed.forEach(o),Qm=s(ze,". Note that "),ti=a(ze,"CODE",{});var od=i(ti);Um=s(od,"config.attention_window"),od.forEach(o),Bm=s(ze," can be of type "),ni=a(ze,"CODE",{});var td=i(ni);Hm=s(td,"List"),td.forEach(o),Rm=s(ze,` to define a
different `),wd=jt(ze),kd=s(ze,` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),si=a(ze,"CODE",{});var nd=i(si);Vm=s(nd,"BertSelfAttention"),nd.forEach(o),Gm=s(ze,"."),ze.forEach(o),bd=m(t),wo=a(t,"P",{});var qt=i(wo);Km=s(qt,`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
that every \u201Clocally\u201D attending token not only attends to tokens within its window `),vd=jt(qt),Td=s(qt,`, but also to all \u201Cglobally\u201D
attending tokens so that global attention is `),ri=a(qt,"EM",{});var sd=i(ri);Jm=s(sd,"symmetric"),sd.forEach(o),Xm=s(qt,"."),qt.forEach(o),yd=m(t),ko=a(t,"P",{});var Ct=i(ko);Ym=s(Ct,`The user can define which tokens attend \u201Clocally\u201D and which tokens attend \u201Cglobally\u201D by setting the tensor
...
`),ii=a(Ct,"CODE",{});var ad=i(ii);op=s(ad,"global_attention_mask"),ad.forEach(o),tp=s(Ct,":"),Ct.forEach(o),$d=m(t),Pt=a(t,"UL",{});var Vr=i(Pt);li=a(Vr,"LI",{});var id=i(li);np=s(id,"0: the token attends \u201Clocally\u201D,"),id.forEach(o),sp=m(Vr),di=a(Vr,"LI",{});var ck=i(di);rp=s(ck,"1: the token attends \u201Cglobally\u201D."),ck.forEach(o),Vr.forEach(o),Ld=m(t),Nt=a(t,"P",{});var qc=i(Nt);ap=s(qc,"For more information please also refer to "),Gr=a(qc,"A",{href:!0});var mk=i(Gr);ip=s(mk,"forward()"),mk.forEach(o),lp=s(qc," method."),qc.forEach(o),xd=m(t),Je=a(t,"P",{});var vo=i(Je);dp=s(vo,`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
represents the memory and time bottleneck, can be reduced from `),Fd=jt(vo),Md=s(vo,` to
`),Ed=jt(vo),zd=s(vo,", with "),qd=jt(vo),Cd=s(vo," being the sequence length and "),Od=jt(vo),jd=s(vo,` being the average window
size. It is assumed that the number of \u201Cglobally\u201D attending tokens is insignificant as compared to the number of
\u201Clocally\u201D attending tokens.`),vo.forEach(o),Pd=m(t),At=a(t,"P",{});var Cc=i(At);cp=s(Cc,"For more information, please refer to the official "),Vn=a(Cc,"A",{href:!0,rel:!0});var pk=i(Vn);mp=s(pk,"paper"),pk.forEach(o),pp=s(Cc,"."),Cc.forEach(o),Nd=m(t),Oo=a(t,"H2",{class:!0});var Oc=i(Oo);It=a(Oc,"A",{id:!0,class:!0,href:!0});var hk=i(It);ci=a(hk,"SPAN",{});var fk=i(ci);T(Gn.$$.fragment,fk),fk.forEach(o),hk.forEach(o),hp=m(Oc),mi=a(Oc,"SPAN",{});var gk=i(mi);fp=s(gk,"Training"),gk.forEach(o),Oc.forEach(o),Ad=m(t),jo=a(t,"P",{});var ld=i(jo);Kr=a(ld,"A",{href:!0});var uk=i(Kr);gp=s(uk,"LongformerForMaskedLM"),uk.forEach(o),up=s(ld," is trained the exact same way "),Jr=a(ld,"A",{href:!0});var _k=i(Jr);_p=s(_k,"RobertaForMaskedLM"),_k.forEach(o),wp=s(ld,` is
trained and should be used as follows:`),ld.forEach(o),Id=m(t),T(Kn.$$.fragment,t),Sd=m(t),Po=a(t,"H2",{class:!0});var jc=i(Po);St=a(jc,"A",{id:!0,class:!0,href:!0});var wk=i(St);pi=a(wk,"SPAN",{});var kk=i(pi);T(Jn.$$.fragment,kk),kk.forEach(o),wk.forEach(o),kp=m(jc),hi=a(jc,"SPAN",{});var bk=i(hi);bp=s(bk,"LongformerConfig"),bk.forEach(o),jc.forEach(o),Dd=m(t),Be=a(t,"DIV",{class:!0});var To=i(Be);T(Xn.$$.fragment,To),vp=m(To),No=a(To,"P",{});var Ca=i(No);Tp=s(Ca,"This is the configuration class to store the configuration of a "),Xr=a(Ca,"A",{href:!0});var vk=i(Xr);yp=s(vk,"LongformerModel"),vk.forEach(o),$p=s(Ca," or a "),Yr=a(Ca,"A",{href:!0});var Tk=i(Yr);Lp=s(Tk,"TFLongformerModel"),Tk.forEach(o),xp=s(Ca,`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),Ca.forEach(o),Fp=m(To),Ao=a(To,"P",{});var Oa=i(Ao);Mp=s(Oa,"This is the configuration class to store the configuration of a "),Zr=a(Oa,"A",{href:!0});var yk=i(Zr);Ep=s(yk,"LongformerModel"),yk.forEach(o),zp=s(Oa,`. It is used to instantiate an
Longformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the RoBERTa
`),Yn=a(Oa,"A",{href:!0,rel:!0});var $k=i(Yn);qp=s($k,"roberta-base"),$k.forEach(o),Cp=s(Oa," architecture with a sequence length 4,096."),Oa.forEach(o),Op=m(To),Io=a(To,"P",{});var ja=i(Io);jp=s(ja,"The "),ea=a(ja,"A",{href:!0});var Lk=i(ea);Pp=s(Lk,"LongformerConfig"),Lk.forEach(o),Np=s(ja," class directly inherits "),oa=a(ja,"A",{href:!0});var xk=i(oa);Ap=s(xk,"RobertaConfig"),xk.forEach(o),Ip=s(ja,`. It reuses the same defaults. Please check the
parent class for more information.`),ja.forEach(o),Sp=m(To),T(Dt.$$.fragment,To),To.forEach(o),Wd=m(t),So=a(t,"H2",{class:!0});var Pc=i(So);Wt=a(Pc,"A",{id:!0,class:!0,href:!0});var Fk=i(Wt);fi=a(Fk,"SPAN",{});var Mk=i(fi);T(Zn.$$.fragment,Mk),Mk.forEach(o),Fk.forEach(o),Dp=m(Pc),gi=a(Pc,"SPAN",{});var Ek=i(gi);Wp=s(Ek,"LongformerTokenizer"),Ek.forEach(o),Pc.forEach(o),Qd=m(t),go=a(t,"DIV",{class:!0});var Pa=i(go);T(es.$$.fragment,Pa),Qp=m(Pa),ui=a(Pa,"P",{});var zk=i(ui);Up=s(zk,"Construct a Longformer tokenizer."),zk.forEach(o),Bp=m(Pa),Qt=a(Pa,"P",{});var dd=i(Qt);ta=a(dd,"A",{href:!0});var qk=i(ta);Hp=s(qk,"LongformerTokenizer"),qk.forEach(o),Rp=s(dd," is identical to "),na=a(dd,"A",{href:!0});var Ck=i(na);Vp=s(Ck,"RobertaTokenizer"),Ck.forEach(o),Gp=s(dd,`. Refer to the superclass for usage examples and
documentation concerning parameters.`),dd.forEach(o),Pa.forEach(o),Ud=m(t),Do=a(t,"H2",{class:!0});var Nc=i(Do);Ut=a(Nc,"A",{id:!0,class:!0,href:!0});var Ok=i(Ut);_i=a(Ok,"SPAN",{});var jk=i(_i);T(os.$$.fragment,jk),jk.forEach(o),Ok.forEach(o),Kp=m(Nc),wi=a(Nc,"SPAN",{});var Pk=i(wi);Jp=s(Pk,"LongformerTokenizerFast"),Pk.forEach(o),Nc.forEach(o),Bd=m(t),uo=a(t,"DIV",{class:!0});var Na=i(uo);T(ts.$$.fragment,Na),Xp=m(Na),ns=a(Na,"P",{});var Ac=i(ns);Yp=s(Ac,"Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),ki=a(Ac,"EM",{});var Nk=i(ki);Zp=s(Nk,"tokenizers"),Nk.forEach(o),eh=s(Ac," library)."),Ac.forEach(o),oh=m(Na),Bt=a(Na,"P",{});var cd=i(Bt);sa=a(cd,"A",{href:!0});var Ak=i(sa);th=s(Ak,"LongformerTokenizerFast"),Ak.forEach(o),nh=s(cd," is identical to "),ra=a(cd,"A",{href:!0});var Ik=i(ra);sh=s(Ik,"RobertaTokenizerFast"),Ik.forEach(o),rh=s(cd,`. Refer to the superclass for usage examples
and documentation concerning parameters.`),cd.forEach(o),Na.forEach(o),Hd=m(t),Wo=a(t,"H2",{class:!0});var Ic=i(Wo);Ht=a(Ic,"A",{id:!0,class:!0,href:!0});var Sk=i(Ht);bi=a(Sk,"SPAN",{});var Dk=i(bi);T(ss.$$.fragment,Dk),Dk.forEach(o),Sk.forEach(o),ah=m(Ic),vi=a(Ic,"SPAN",{});var Wk=i(vi);ih=s(Wk,"Longformer specific outputs"),Wk.forEach(o),Ic.forEach(o),Rd=m(t),Qo=a(t,"DIV",{class:!0});var Sc=i(Qo);T(rs.$$.fragment,Sc),lh=m(Sc),Ti=a(Sc,"P",{});var Qk=i(Ti);dh=s(Qk,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Qk.forEach(o),Sc.forEach(o),Vd=m(t),Uo=a(t,"DIV",{class:!0});var Dc=i(Uo);T(as.$$.fragment,Dc),ch=m(Dc),yi=a(Dc,"P",{});var Uk=i(yi);mh=s(Uk,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Uk.forEach(o),Dc.forEach(o),Gd=m(t),Bo=a(t,"DIV",{class:!0});var Wc=i(Bo);T(is.$$.fragment,Wc),ph=m(Wc),$i=a(Wc,"P",{});var Bk=i($i);hh=s(Bk,"Base class for masked language models outputs."),Bk.forEach(o),Wc.forEach(o),Kd=m(t),Ho=a(t,"DIV",{class:!0});var Qc=i(Ho);T(ls.$$.fragment,Qc),fh=m(Qc),Li=a(Qc,"P",{});var Hk=i(Li);gh=s(Hk,"Base class for outputs of question answering Longformer models."),Hk.forEach(o),Qc.forEach(o),Jd=m(t),Ro=a(t,"DIV",{class:!0});var Uc=i(Ro);T(ds.$$.fragment,Uc),uh=m(Uc),xi=a(Uc,"P",{});var Rk=i(xi);_h=s(Rk,"Base class for outputs of sentence classification models."),Rk.forEach(o),Uc.forEach(o),Xd=m(t),Vo=a(t,"DIV",{class:!0});var Bc=i(Vo);T(cs.$$.fragment,Bc),wh=m(Bc),Fi=a(Bc,"P",{});var Vk=i(Fi);kh=s(Vk,"Base class for outputs of multiple choice Longformer models."),Vk.forEach(o),Bc.forEach(o),Yd=m(t),Go=a(t,"DIV",{class:!0});var Hc=i(Go);T(ms.$$.fragment,Hc),bh=m(Hc),Mi=a(Hc,"P",{});var Gk=i(Mi);vh=s(Gk,"Base class for outputs of token classification models."),Gk.forEach(o),Hc.forEach(o),Zd=m(t),Ko=a(t,"DIV",{class:!0});var Rc=i(Ko);T(ps.$$.fragment,Rc),Th=m(Rc),Ei=a(Rc,"P",{});var Kk=i(Ei);yh=s(Kk,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Kk.forEach(o),Rc.forEach(o),ec=m(t),Jo=a(t,"DIV",{class:!0});var Vc=i(Jo);T(hs.$$.fragment,Vc),$h=m(Vc),zi=a(Vc,"P",{});var Jk=i(zi);Lh=s(Jk,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Jk.forEach(o),Vc.forEach(o),oc=m(t),Xo=a(t,"DIV",{class:!0});var Gc=i(Xo);T(fs.$$.fragment,Gc),xh=m(Gc),qi=a(Gc,"P",{});var Xk=i(qi);Fh=s(Xk,"Base class for masked language models outputs."),Xk.forEach(o),Gc.forEach(o),tc=m(t),Yo=a(t,"DIV",{class:!0});var Kc=i(Yo);T(gs.$$.fragment,Kc),Mh=m(Kc),Ci=a(Kc,"P",{});var Yk=i(Ci);Eh=s(Yk,"Base class for outputs of question answering Longformer models."),Yk.forEach(o),Kc.forEach(o),nc=m(t),Zo=a(t,"DIV",{class:!0});var Jc=i(Zo);T(us.$$.fragment,Jc),zh=m(Jc),Oi=a(Jc,"P",{});var Zk=i(Oi);qh=s(Zk,"Base class for outputs of sentence classification models."),Zk.forEach(o),Jc.forEach(o),sc=m(t),et=a(t,"DIV",{class:!0});var Xc=i(et);T(_s.$$.fragment,Xc),Ch=m(Xc),ji=a(Xc,"P",{});var eb=i(ji);Oh=s(eb,"Base class for outputs of multiple choice models."),eb.forEach(o),Xc.forEach(o),rc=m(t),ot=a(t,"DIV",{class:!0});var Yc=i(ot);T(ws.$$.fragment,Yc),jh=m(Yc),Pi=a(Yc,"P",{});var ob=i(Pi);Ph=s(ob,"Base class for outputs of token classification models."),ob.forEach(o),Yc.forEach(o),ac=m(t),tt=a(t,"H2",{class:!0});var Zc=i(tt);Rt=a(Zc,"A",{id:!0,class:!0,href:!0});var tb=i(Rt);Ni=a(tb,"SPAN",{});var nb=i(Ni);T(ks.$$.fragment,nb),nb.forEach(o),tb.forEach(o),Nh=m(Zc),Ai=a(Zc,"SPAN",{});var sb=i(Ai);Ah=s(sb,"LongformerModel"),sb.forEach(o),Zc.forEach(o),ic=m(t),Pe=a(t,"DIV",{class:!0});var to=i(Pe);T(bs.$$.fragment,to),Ih=m(to),Ii=a(to,"P",{});var rb=i(Ii);Sh=s(rb,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),rb.forEach(o),Dh=m(to),vs=a(to,"P",{});var em=i(vs);Wh=s(em,"This model inherits from "),aa=a(em,"A",{href:!0});var ab=i(aa);Qh=s(ab,"PreTrainedModel"),ab.forEach(o),Uh=s(em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(o),Kf=m($o),Ne=a($o,"DIV",{class:!0});var no=i(Ne);T(Ss.$$.fragment,no),Jf=m(no),lt=a(no,"P",{});var Da=i(lt);Xf=s(Da,"The "),pa=a(Da,"A",{href:!0});var Fb=i(pa);Yf=s(Fb,"LongformerForSequenceClassification"),Fb.forEach(o),Zf=s(Da," forward method, overrides the "),Gi=a(Da,"CODE",{});var Mb=i(Gi);eg=s(Mb,"__call__"),Mb.forEach(o),og=s(Da," special method."),Da.forEach(o),tg=m(no),T(Zt.$$.fragment,no),ng=m(no),T(en.$$.fragment,no),sg=m(no),T(on.$$.fragment,no),rg=m(no),T(tn.$$.fragment,no),ag=m(no),T(nn.$$.fragment,no),no.forEach(o),$o.forEach(o),pc=m(t),dt=a(t,"H2",{class:!0});var cm=i(dt);sn=a(cm,"A",{id:!0,class:!0,href:!0});var Eb=i(sn);Ki=a(Eb,"SPAN",{});var zb=i(Ki);T(Ds.$$.fragment,zb),zb.forEach(o),Eb.forEach(o),ig=m(cm),Ji=a(cm,"SPAN",{});var qb=i(Ji);lg=s(qb,"LongformerForMultipleChoice"),qb.forEach(o),cm.forEach(o),hc=m(t),Ve=a(t,"DIV",{class:!0});var Lo=i(Ve);T(Ws.$$.fragment,Lo),dg=m(Lo),Xi=a(Lo,"P",{});var Cb=i(Xi);cg=s(Cb,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Cb.forEach(o),mg=m(Lo),Qs=a(Lo,"P",{});var mm=i(Qs);pg=s(mm,"This model inherits from "),ha=a(mm,"A",{href:!0});var Ob=i(ha);hg=s(Ob,"PreTrainedModel"),Ob.forEach(o),fg=s(mm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mm.forEach(o),gg=m(Lo),Us=a(Lo,"P",{});var pm=i(Us);ug=s(pm,"This model is also a PyTorch "),Bs=a(pm,"A",{href:!0,rel:!0});var jb=i(Bs);_g=s(jb,"torch.nn.Module"),jb.forEach(o),wg=s(pm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pm.forEach(o),kg=m(Lo),ao=a(Lo,"DIV",{class:!0});var Bn=i(ao);T(Hs.$$.fragment,Bn),bg=m(Bn),ct=a(Bn,"P",{});var Wa=i(ct);vg=s(Wa,"The "),fa=a(Wa,"A",{href:!0});var Pb=i(fa);Tg=s(Pb,"LongformerForMultipleChoice"),Pb.forEach(o),yg=s(Wa," forward method, overrides the "),Yi=a(Wa,"CODE",{});var Nb=i(Yi);$g=s(Nb,"__call__"),Nb.forEach(o),Lg=s(Wa," special method."),Wa.forEach(o),xg=m(Bn),T(rn.$$.fragment,Bn),Fg=m(Bn),T(an.$$.fragment,Bn),Bn.forEach(o),Lo.forEach(o),fc=m(t),mt=a(t,"H2",{class:!0});var hm=i(mt);ln=a(hm,"A",{id:!0,class:!0,href:!0});var Ab=i(ln);Zi=a(Ab,"SPAN",{});var Ib=i(Zi);T(Rs.$$.fragment,Ib),Ib.forEach(o),Ab.forEach(o),Mg=m(hm),el=a(hm,"SPAN",{});var Sb=i(el);Eg=s(Sb,"LongformerForTokenClassification"),Sb.forEach(o),hm.forEach(o),gc=m(t),Ge=a(t,"DIV",{class:!0});var xo=i(Ge);T(Vs.$$.fragment,xo),zg=m(xo),ol=a(xo,"P",{});var Db=i(ol);qg=s(Db,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Db.forEach(o),Cg=m(xo),Gs=a(xo,"P",{});var fm=i(Gs);Og=s(fm,"This model inherits from "),ga=a(fm,"A",{href:!0});var Wb=i(ga);jg=s(Wb,"PreTrainedModel"),Wb.forEach(o),Pg=s(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bm.forEach(o),Eu=m(Ue),ir=a(Ue,"P",{});var vm=i(ir);zu=s(vm,"This model is also a "),lr=a(vm,"A",{href:!0,rel:!0});var rv=i(lr);qu=s(rv,"tf.keras.Model"),rv.forEach(o),Cu=s(vm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vm.forEach(o),Ou=m(Ue),T(un.$$.fragment,Ue),ju=m(Ue),_t=a(Ue,"P",{});var Ha=i(_t);Pu=s(Ha,"This class copies code from "),ba=a(Ha,"A",{href:!0});var av=i(ba);Nu=s(av,"TFRobertaModel"),av.forEach(o),Au=s(Ha,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
TriviaQA (a linear layer on top of the hidden-states output to compute `),kl=a(Ka,"CODE",{});var Tv=i(kl);F_=s(Tv,"span start logits"),Tv.forEach(o),M_=s(Ka," and "),bl=a(Ka,"CODE",{});var yv=i(bl);E_=s(yv,"span end logits"),yv.forEach(o),z_=s(Ka,")."),Ka.forEach(o),q_=m(mo),vr=a(mo,"P",{});var Mm=i(vr);C_=s(Mm,"This model inherits from "),$a=a(Mm,"A",{href:!0});var $v=i($a);O_=s($v,"TFPreTrainedModel"),$v.forEach(o),j_=s(Mm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Em.forEach(o),S_=m(mo),T($n.$$.fragment,mo),D_=m(mo),Ze=a(mo,"DIV",{class:!0});var zo=i(Ze);T($r.$$.fragment,zo),W_=m(zo),yt=a(zo,"P",{});var Ja=i(yt);Q_=s(Ja,"The "),La=a(Ja,"A",{href:!0});var xv=i(La);U_=s(xv,"TFLongformerForQuestionAnswering"),xv.forEach(o),B_=s(Ja," forward method, overrides the "),vl=a(Ja,"CODE",{});var Fv=i(vl);H_=s(Fv,"__call__"),Fv.forEach(o),R_=s(Ja," special method."),Ja.forEach(o),V_=m(zo),T(Ln.$$.fragment,zo),G_=m(zo),T(xn.$$.fragment,zo),K_=m(zo),T(Fn.$$.fragment,zo),zo.forEach(o),mo.forEach(o),$c=m(t),$t=a(t,"H2",{class:!0});var zm=i($t);Mn=a(zm,"A",{id:!0,class:!0,href:!0});var Mv=i(Mn);Tl=a(Mv,"SPAN",{});var Ev=i(Tl);T(Lr.$$.fragment,Ev),Ev.forEach(o),Mv.forEach(o),J_=m(zm),yl=a(zm,"SPAN",{});var zv=i(yl);X_=s(zv,"TFLongformerForSequenceClassification"),zv.forEach(o),zm.forEach(o),Lc=m(t),De=a(t,"DIV",{class:!0});var po=i(De);T(xr.$$.fragment,po),Y_=m(po),$l=a(po,"P",{});var qv=i($l);Z_=s(qv,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),qv.forEach(o),ew=m(po),Fr=a(po,"P",{});var qm=i(Fr);ow=s(qm,"This model inherits from "),xa=a(qm,"A",{href:!0});var Cv=i(xa);tw=s(Cv,"TFPreTrainedModel"),Cv.forEach(o),nw=s(qm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qm.forEach(o),sw=m(po),Mr=a(po,"P",{});var Cm=i(Mr);rw=s(Cm,"This model is also a "),Er=a(Cm,"A",{href:!0,rel:!0});var Ov=i(Er);aw=s(Ov,"tf.keras.Model"),Ov.forEach(o),iw=s(Cm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cm.forEach(o),lw=m(po),T(En.$$.fragment,po),dw=m(po),eo=a(po,"DIV",{class:!0});var qo=i(eo);T(zr.$$.fragment,qo),cw=m(qo),Lt=a(qo,"P",{});var Xa=i(Lt);mw=s(Xa,"The "),Fa=a(Xa,"A",{href:!0});var jv=i(Fa);pw=s(jv,"TFLongformerForSequenceClassification"),jv.forEach(o),hw=s(Xa," forward method, overrides the "),Ll=a(Xa,"CODE",{});var Pv=i(Ll);fw=s(Pv,"__call__"),Pv.forEach(o),gw=s(Xa," special method."),Xa.forEach(o),uw=m(qo),T(zn.$$.fragment,qo),_w=m(qo),T(qn.$$.fragment,qo),ww=m(qo),T(Cn.$$.fragment,qo),qo.forEach(o),po.forEach(o),xc=m(t),xt=a(t,"H2",{class:!0});var Om=i(xt);On=a(Om,"A",{id:!0,class:!0,href:!0});var Nv=i(On);xl=a(Nv,"SPAN",{});var Av=i(xl);T(qr.$$.fragment,Av),Av.forEach(o),Nv.forEach(o),kw=m(Om),Fl=a(Om,"SPAN",{});var Iv=i(Fl);bw=s(Iv,"TFLongformerForTokenClassification"),Iv.forEach(o),Om.forEach(o),Fc=m(t),We=a(t,"DIV",{class:!0});var ho=i(We);T(Cr.$$.fragment,ho),vw=m(ho),Ml=a(ho,"P",{});var Sv=i(Ml);Tw=s(Sv,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Sv.forEach(o),yw=m(ho),Or=a(ho,"P",{});var jm=i(Or);$w=s(jm,"This model inherits from "),Ma=a(jm,"A",{href:!0});var Dv=i(Ma);Lw=s(Dv,"TFPreTrainedModel"),Dv.forEach(o),xw=s(jm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jm.forEach(o),Fw=m(ho),jr=a(ho,"P",{});var Pm=i(jr);Mw=s(Pm,"This model is also a "),Pr=a(Pm,"A",{href:!0,rel:!0});var Wv=i(Pr);Ew=s(Wv,"tf.keras.Model"),Wv.forEach(o),zw=s(Pm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pm.forEach(o),qw=m(ho),T(jn.$$.fragment,ho),Cw=m(ho),oo=a(ho,"DIV",{class:!0});var Co=i(oo);T(Nr.$$.fragment,Co),Ow=m(Co),Ft=a(Co,"P",{});var Ya=i(Ft);jw=s(Ya,"The "),Ea=a(Ya,"A",{href:!0});var Qv=i(Ea);Pw=s(Qv,"TFLongformerForTokenClassification"),Qv.forEach(o),Nw=s(Ya," forward method, overrides the "),El=a(Ya,"CODE",{});var Uv=i(El);Aw=s(Uv,"__call__"),Uv.forEach(o),Iw=s(Ya," special method."),Ya.forEach(o),Sw=m(Co),T(Pn.$$.fragment,Co),Dw=m(Co),T(Nn.$$.fragment,Co),Ww=m(Co),T(An.$$.fragment,Co),Co.forEach(o),ho.forEach(o),Mc=m(t),Mt=a(t,"H2",{class:!0});var Nm=i(Mt);In=a(Nm,"A",{id:!0,class:!0,href:!0});var Bv=i(In);zl=a(Bv,"SPAN",{});var Hv=i(zl);T(Ar.$$.fragment,Hv),Hv.forEach(o),Bv.forEach(o),Qw=m(Nm),ql=a(Nm,"SPAN",{});var Rv=i(ql);Uw=s(Rv,"TFLongformerForMultipleChoice"),Rv.forEach(o),Nm.forEach(o),Ec=m(t),Qe=a(t,"DIV",{class:!0});var fo=i(Qe);T(Ir.$$.fragment,fo),Bw=m(fo),Cl=a(fo,"P",{});var Vv=i(Cl);Hw=s(Vv,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Vv.forEach(o),Rw=m(fo),Sr=a(fo,"P",{});var Am=i(Sr);Vw=s(Am,"This model inherits from "),za=a(Am,"A",{href:!0});var Gv=i(za);Gw=s(Gv,"TFPreTrainedModel"),Gv.forEach(o),Kw=s(Am,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
