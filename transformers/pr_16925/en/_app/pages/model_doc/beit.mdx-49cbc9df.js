...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])`}}),{c(){c=a("p"),v=n("Example:"),u=p(),w(f.$$.fragment)},l(l){c=r(l,"P",{});var h=s(c);v=i(h,"Example:"),h.forEach(t),u=m(l),x(f.$$.fragment,l)},m(l,h){_(l,c,h),e(c,v),_(l,u,h),$(f,l,h),b=!0},p:xt,i(l){b||(y(f.$$.fragment,l),b=!0)},o(l){T(f.$$.fragment,l),b=!1},d(l){l&&t(c),l&&t(u),B(f,l)}}}function _h(F){let c,v,u,f,b,l,h,E,Qs,Yr,de,Ce,ja,yt,en,Pa,tn,Zr,V,on,Tt,an,rn,Bt,sn,nn,Ft,ln,dn,Qr,Xo,cn,es,Go,Ca,pn,ts,Ko,mn,os,C,k,hn,Yo,fn,un,Zo,gn,_n,Et,bn,vn,Qo,wn,xn,ea,$n,yn,ta,Tn,Bn,oa,Fn,En,kn,kt,Mn,Mt,In,jn,Pn,It,Cn,aa,zn,An,qn,ce,Ln,za,Sn,Nn,jt,On,Dn,Wn,pe,Vn,Pt,Un,Rn,Ct,Hn,Jn,Xn,N,Gn,Aa,Kn,Yn,qa,Zn,Qn,ra,ei,ti,La,oi,ai,as,U,ri,zt,si,ni,At,ii,li,qt,di,ci,rs,me,ze,Sa,Lt,pi,Na,mi,ss,he,St,hi,Nt,fi,sa,ui,gi,ns,fe,Ot,_i,Dt,bi,na,vi,wi,is,ue,Ae,Oa,Wt,xi,Da,$i,ls,Q,Vt,yi,ge,Ti,ia,Bi,Fi,Ut,Ei,ki,Mi,qe,ds,_e,Le,Wa,Rt,Ii,Va,ji,cs,O,Ht,Pi,Ua,Ci,zi,Jt,Ai,la,qi,Li,Si,ne,Xt,Ni,Ra,Oi,Di,Se,ps,be,Ne,Ha,Gt,Wi,Ja,Vi,ms,ee,Kt,Ui,Yt,Ri,Zt,Hi,Ji,Xi,R,Qt,Gi,ve,Ki,da,Yi,Zi,Xa,Qi,el,tl,Oe,ol,De,hs,we,We,Ga,eo,al,Ka,rl,fs,te,to,sl,oo,nl,ao,il,ll,dl,H,ro,cl,xe,pl,ca,ml,hl,Ya,fl,ul,gl,Ve,_l,Ue,us,$e,Re,Za,so,bl,Qa,vl,gs,D,no,wl,er,xl,$l,io,yl,lo,Tl,Bl,Fl,J,co,El,ye,kl,pa,Ml,Il,tr,jl,Pl,Cl,He,zl,Je,_s,Te,Xe,or,po,Al,ar,ql,bs,W,mo,Ll,rr,Sl,Nl,ho,Ol,fo,Dl,Wl,Vl,X,uo,Ul,Be,Rl,ma,Hl,Jl,sr,Xl,Gl,Kl,Ge,Yl,Ke,vs,Fe,Ye,nr,go,Zl,ir,Ql,ws,M,_o,ed,lr,td,od,bo,ad,ha,rd,sd,nd,vo,id,wo,ld,dd,cd,dr,pd,md,oe,cr,xo,hd,fd,pr,$o,ud,gd,mr,yo,_d,bd,hr,To,vd,wd,G,Bo,xd,Ee,$d,fr,yd,Td,ur,Bd,Fd,Ed,Ze,kd,Qe,xs,ke,et,gr,Fo,Md,_r,Id,$s,I,Eo,jd,br,Pd,Cd,ko,zd,fa,Ad,qd,Ld,Mo,Sd,Io,Nd,Od,Dd,vr,Wd,Vd,ae,wr,jo,Ud,Rd,xr,Po,Hd,Jd,$r,Co,Xd,Gd,yr,zo,Kd,Yd,A,Ao,Zd,Me,Qd,Tr,ec,tc,Br,oc,ac,rc,tt,sc,Ie,nc,Fr,ic,lc,Er,dc,cc,pc,ot,ys,je,at,kr,qo,mc,Mr,hc,Ts,j,Lo,fc,Ir,uc,gc,So,_c,ua,bc,vc,wc,No,xc,Oo,$c,yc,Tc,jr,Bc,Fc,re,Pr,Do,Ec,kc,Cr,Wo,Mc,Ic,zr,Vo,jc,Pc,Ar,Uo,Cc,zc,K,Ro,Ac,Pe,qc,qr,Lc,Sc,Lr,Nc,Oc,Dc,rt,Wc,st,Bs;return l=new Z({}),yt=new Z({}),Lt=new Z({}),St=new P({props:{name:"class transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",parameters:[{name:"last_hidden_state",val:": FloatTensor = None"},{name:"pooler_output",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/beit/feature_extraction_beit.py#L97",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_16925/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/beit/modeling_beit.py#L656",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/beit#transformers.models.beit.modeling_beit.BeitModelOutputWithPooling"
>transformers.models.beit.modeling_beit.BeitModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16925/en/model_doc/beit#transformers.BeitConfig"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/beit/modeling_beit.py#L751",returnDescription:`
<p>A <a
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/beit/modeling_beit.py#L850",returnDescription:`
<p>A <a
...
Ground truth semantic segmentation maps for computing the loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code>, a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/beit/modeling_beit.py#L1190",returnDescription:`
...
images and 1,000 classes).`),Xn=p(),N=a("li"),Gn=n(`BEiT uses relative position embeddings, inspired by the T5 model. During pre-training, the authors shared the
...
the main methods. Users should refer to this superclass for more information regarding those methods.`),Si=p(),ne=a("div"),w(Xt.$$.fragment),Ni=p(),Ra=a("p"),Oi=n("Main method to prepare for the model one or several image(s)."),Di=p(),w(Se.$$.fragment),ps=p(),be=a("h2"),Ne=a("a"),Ha=a("span"),w(Gt.$$.fragment),Wi=p(),Ja=a("span"),Vi=n("BeitModel"),ms=p(),ee=a("div"),w(Kt.$$.fragment),Ui=p(),Yt=a("p"),Ri=n(`The bare Beit Model transformer outputting raw hidden-states without any specific head on top.
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fl=p(),J=a("div"),w(co.$$.fragment),El=p(),ye=a("p"),kl=n("The "),pa=a("a"),Ml=n("BeitForImageClassification"),Il=n(" forward method, overrides the "),tr=a("code"),jl=n("__call__"),Pl=n(" special method."),Cl=p(),w(He.$$.fragment),zl=p(),w(Je.$$.fragment),_s=p(),Te=a("h2"),Xe=a("a"),or=a("span"),w(po.$$.fragment),Al=p(),ar=a("span"),ql=n("BeitForSemanticSegmentation"),bs=p(),W=a("div"),w(mo.$$.fragment),Ll=p(),rr=a("p"),Sl=n("Beit Model transformer with a semantic segmentation head on top e.g. for ADE20k, CityScapes."),Nl=p(),ho=a("p"),Ol=n("This model is a PyTorch "),fo=a("a"),Dl=n("torch.nn.Module"),Wl=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Ld=p(),Mo=a("p"),Sd=n("This model is also a Flax Linen "),Io=a("a"),Nd=n("flax.linen.Module"),Od=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
images and 1,000 classes).`),_a.forEach(t),Xn=m(Y),N=r(Y,"LI",{});var ie=s(N);Gn=i(ie,`BEiT uses relative position embeddings, inspired by the T5 model. During pre-training, the authors shared the
relative position bias among the several self-attention layers. During fine-tuning, each layer\u2019s relative position
bias is initialized with the shared relative position bias obtained after pre-training. Note that, if one wants to
...
contributed by `),At=r(nt,"A",{href:!0,rel:!0});var ip=s(At);ii=i(ip,"kamalkraj"),ip.forEach(t),li=i(nt,". The original code can be found "),qt=r(nt,"A",{href:!0,rel:!0});var lp=s(qt);di=i(lp,"here"),lp.forEach(t),ci=i(nt,"."),nt.forEach(t),rs=m(o),me=r(o,"H2",{class:!0});var ks=s(me);ze=r(ks,"A",{id:!0,class:!0,href:!0});var dp=s(ze);Sa=r(dp,"SPAN",{});var cp=s(Sa);x(Lt.$$.fragment,cp),cp.forEach(t),dp.forEach(t),pi=m(ks),Na=r(ks,"SPAN",{});var pp=s(Na);mi=i(pp,"BEiT specific outputs"),pp.forEach(t),ks.forEach(t),ss=m(o),he=r(o,"DIV",{class:!0});var Ms=s(he);x(St.$$.fragment,Ms),hi=m(Ms),Nt=r(Ms,"P",{});var Is=s(Nt);fi=i(Is,"Class for outputs of "),sa=r(Is,"A",{href:!0});var mp=s(sa);ui=i(mp,"BeitModel"),mp.forEach(t),gi=i(Is,"."),Is.forEach(t),Ms.forEach(t),ns=m(o),fe=r(o,"DIV",{class:!0});var js=s(fe);x(Ot.$$.fragment,js),_i=m(js),Dt=r(js,"P",{});var Ps=s(Dt);bi=i(Ps,"Class for outputs of "),na=r(Ps,"A",{href:!0});var hp=s(na);vi=i(hp,"FlaxBeitModel"),hp.forEach(t),wi=i(Ps,"."),Ps.forEach(t),js.forEach(t),is=m(o),ue=r(o,"H2",{class:!0});var Cs=s(ue);Ae=r(Cs,"A",{id:!0,class:!0,href:!0});var fp=s(Ae);Oa=r(fp,"SPAN",{});var up=s(Oa);x(Wt.$$.fragment,up),up.forEach(t),fp.forEach(t),xi=m(Cs),Da=r(Cs,"SPAN",{});var gp=s(Da);$i=i(gp,"BeitConfig"),gp.forEach(t),Cs.forEach(t),ls=m(o),Q=r(o,"DIV",{class:!0});var ba=s(Q);x(Vt.$$.fragment,ba),yi=m(ba),ge=r(ba,"P",{});var va=s(ge);Ti=i(va,"This is the configuration class to store the configuration of a "),ia=r(va,"A",{href:!0});var _p=s(ia);Bi=i(_p,"BeitModel"),_p.forEach(t),Fi=i(va,`. It is used to instantiate an BEiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BEiT
`),Ut=r(va,"A",{href:!0,rel:!0});var bp=s(Ut);Ei=i(bp,"microsoft/beit-base-patch16-224-in22k"),bp.forEach(t),ki=i(va," architecture."),va.forEach(t),Mi=m(ba),x(qe.$$.fragment,ba),ba.forEach(t),ds=m(o),_e=r(o,"H2",{class:!0});var zs=s(_e);Le=r(zs,"A",{id:!0,class:!0,href:!0});var vp=s(Le);Wa=r(vp,"SPAN",{});var wp=s(Wa);x(Rt.$$.fragment,wp),wp.forEach(t),vp.forEach(t),Ii=m(zs),Va=r(zs,"SPAN",{});var xp=s(Va);ji=i(xp,"BeitFeatureExtractor"),xp.forEach(t),zs.forEach(t),cs=m(o),O=r(o,"DIV",{class:!0});var it=s(O);x(Ht.$$.fragment,it),Pi=m(it),Ua=r(it,"P",{});var $p=s(Ua);Ci=i($p,"Constructs a BEiT feature extractor."),$p.forEach(t),zi=m(it),Jt=r(it,"P",{});var As=s(Jt);Ai=i(As,"This feature extractor inherits from "),la=r(As,"A",{href:!0});var yp=s(la);qi=i(yp,"FeatureExtractionMixin"),yp.forEach(t),Li=i(As,` which contains most of
the main methods. Users should refer to this superclass for more information regarding those methods.`),As.forEach(t),Si=m(it),ne=r(it,"DIV",{class:!0});var wa=s(ne);x(Xt.$$.fragment,wa),Ni=m(wa),Ra=r(wa,"P",{});var Tp=s(Ra);Oi=i(Tp,"Main method to prepare for the model one or several image(s)."),Tp.forEach(t),Di=m(wa),x(Se.$$.fragment,wa),wa.forEach(t),it.forEach(t),ps=m(o),be=r(o,"H2",{class:!0});var qs=s(be);Ne=r(qs,"A",{id:!0,class:!0,href:!0});var Bp=s(Ne);Ha=r(Bp,"SPAN",{});var Fp=s(Ha);x(Gt.$$.fragment,Fp),Fp.forEach(t),Bp.forEach(t),Wi=m(qs),Ja=r(qs,"SPAN",{});var Ep=s(Ja);Vi=i(Ep,"BeitModel"),Ep.forEach(t),qs.forEach(t),ms=m(o),ee=r(o,"DIV",{class:!0});var xa=s(ee);x(Kt.$$.fragment,xa),Ui=m(xa),Yt=r(xa,"P",{});var Ls=s(Yt);Ri=i(Ls,`The bare Beit Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Zt=r(Ls,"A",{href:!0,rel:!0});var kp=s(Zt);Hi=i(kp,"torch.nn.Module"),kp.forEach(t),Ji=i(Ls,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ls.forEach(t),Xi=m(xa),R=r(xa,"DIV",{class:!0});var lt=s(R);x(Qt.$$.fragment,lt),Gi=m(lt),ve=r(lt,"P",{});var $a=s(ve);Ki=i($a,"The "),da=r($a,"A",{href:!0});var Mp=s(da);Yi=i(Mp,"BeitModel"),Mp.forEach(t),Zi=i($a," forward method, overrides the "),Xa=r($a,"CODE",{});var Ip=s(Xa);Qi=i(Ip,"__call__"),Ip.forEach(t),el=i($a," special method."),$a.forEach(t),tl=m(lt),x(Oe.$$.fragment,lt),ol=m(lt),x(De.$$.fragment,lt),lt.forEach(t),xa.forEach(t),hs=m(o),we=r(o,"H2",{class:!0});var Ss=s(we);We=r(Ss,"A",{id:!0,class:!0,href:!0});var jp=s(We);Ga=r(jp,"SPAN",{});var Pp=s(Ga);x(eo.$$.fragment,Pp),Pp.forEach(t),jp.forEach(t),al=m(Ss),Ka=r(Ss,"SPAN",{});var Cp=s(Ka);rl=i(Cp,"BeitForMaskedImageModeling"),Cp.forEach(t),Ss.forEach(t),fs=m(o),te=r(o,"DIV",{class:!0});var ya=s(te);x(to.$$.fragment,ya),sl=m(ya),oo=r(ya,"P",{});var Ns=s(oo);nl=i(Ns,`Beit Model transformer with a \u2018language\u2019 modeling head on top (to predict visual tokens).
This model is a PyTorch `),ao=r(Ns,"A",{href:!0,rel:!0});var zp=s(ao);il=i(zp,"torch.nn.Module"),zp.forEach(t),ll=i(Ns,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ns.forEach(t),dl=m(ya),H=r(ya,"DIV",{class:!0});var dt=s(H);x(ro.$$.fragment,dt),cl=m(dt),xe=r(dt,"P",{});var Ta=s(xe);pl=i(Ta,"The "),ca=r(Ta,"A",{href:!0});var Ap=s(ca);ml=i(Ap,"BeitForMaskedImageModeling"),Ap.forEach(t),hl=i(Ta," forward method, overrides the "),Ya=r(Ta,"CODE",{});var qp=s(Ya);fl=i(qp,"__call__"),qp.forEach(t),ul=i(Ta," special method."),Ta.forEach(t),gl=m(dt),x(Ve.$$.fragment,dt),_l=m(dt),x(Ue.$$.fragment,dt),dt.forEach(t),ya.forEach(t),us=m(o),$e=r(o,"H2",{class:!0});var Os=s($e);Re=r(Os,"A",{id:!0,class:!0,href:!0});var Lp=s(Re);Za=r(Lp,"SPAN",{});var Sp=s(Za);x(so.$$.fragment,Sp),Sp.forEach(t),Lp.forEach(t),bl=m(Os),Qa=r(Os,"SPAN",{});var Np=s(Qa);vl=i(Np,"BeitForImageClassification"),Np.forEach(t),Os.forEach(t),gs=m(o),D=r(o,"DIV",{class:!0});var ct=s(D);x(no.$$.fragment,ct),wl=m(ct),er=r(ct,"P",{});var Op=s(er);xl=i(Op,`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xs.forEach(t),Ld=m(L),Mo=r(L,"P",{});var Gs=s(Mo);Sd=i(Gs,"This model is also a Flax Linen "),Io=r(Gs,"A",{href:!0,rel:!0});var vm=s(Io);Nd=i(vm,"flax.linen.Module"),vm.forEach(t),Od=i(Gs,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
