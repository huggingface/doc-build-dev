import{S as Gg,i as Yg,s as Zg,e as n,k as m,w as M,t as a,M as e_,c as s,d as t,m as h,a as r,x as $,h as i,b as v,F as e,g as _,y as T,q as w,o as P,B as N,v as t_,L as ve}from"../../chunks/vendor-6b77c823.js";import{T as Fe}from"../../chunks/Tip-39098574.js";import{D as J}from"../../chunks/Docstring-1088f2fb.js";import{C as Me}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Le}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as be}from"../../chunks/ExampleCodeBlock-5212b321.js";function o_(y){let l,g,c,p,b;return p=new Me({props:{code:`from transformers import MPNetModel, MPNetConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),g=a("Example:"),c=m(),M(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),$(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),T(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function r_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){l=n("p"),g=a("Example of single-label classification:"),c=m(),M(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example of single-label classification:"),f.forEach(t),c=h(d),$(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),T(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function c_(y){let l,g;return l=new Me({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){l=n("p"),g=a("Example of multi-label classification:"),c=m(),M(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example of multi-label classification:"),f.forEach(t),c=h(d),$(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),T(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function m_(y){let l,g;return l=new Me({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
model = MPNetForSequenceClassification.from_pretrained("microsoft/mpnet-base", num_labels=num_labels)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){M(l.$$.fragment)},l(c){$(l.$$.fragment,c)},m(c,p){T(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function h_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),g=a("Example:"),c=m(),M(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),$(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),T(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function u_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){l=n("p"),g=a("Example:"),c=m(),M(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),$(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),T(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function __(y){let l,g;return l=new Me({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
...
`}}),{c(){l=n("p"),g=a("Example:"),c=m(),M(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),$(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),T(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function v_(y){let l,g;return l=new Me({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){M(l.$$.fragment)},l(c){$(l.$$.fragment,c)},m(c,p){T(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function M_(y){let l,g,c,p,b,d,f,z,le,B,E,X,O,G,de,W,ce,se,U,I,Y,V,q,x,Z,H,re,ee,R,ae,te,C,pe,Q,oe,me,A,ne,j,he;return{c(){l=n("p"),g=a("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=a("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),E=n("p"),X=a("This second option is useful when using "),O=n("code"),G=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=a("model(inputs)"),se=a("."),U=m(),I=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
...
`),Q=n("code"),oe=a("model([input_ids, attention_mask])"),me=m(),A=n("li"),ne=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=r(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=r(p);b=s(K,"LI",{});var _e=r(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var $e=r(z);le=i($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),K.forEach(t),B=h(u),E=s(u,"P",{});var S=r(E);X=i(S,"This second option is useful when using "),O=s(S,"CODE",{});var ke=r(O);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(S,` method which currently requires having all the
tensors in the first argument of the model call function: `),W=s(S,"CODE",{});var Te=r(W);ce=i(Te,"model(inputs)"),Te.forEach(t),se=i(S,"."),S.forEach(t),U=h(u),I=s(u,"P",{});var we=r(I);Y=i(we,`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var L=r(q);x=s(L,"LI",{});var D=r(x);Z=i(D,"a single Tensor with "),H=s(D,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(D," only and nothing else: "),R=s(D,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=h(L),C=s(L,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(L),A=s(L,"LI",{});var ie=r(A);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),L.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,O),e(O,G),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,I,F),e(I,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,A),e(A,ne),e(A,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(I),u&&t(V),u&&t(q)}}}function $_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var L=r(q);x=s(L,"LI",{});var D=r(x);Z=i(D,"a single Tensor with "),H=s(D,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(D," only and nothing else: "),R=s(D,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=h(L),C=s(L,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(L),A=s(L,"LI",{});var ie=r(A);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),L.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,O),e(O,G),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,I,F),e(I,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,A),e(A,ne),e(A,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(I),u&&t(V),u&&t(q)}}}function P_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var L=r(q);x=s(L,"LI",{});var D=r(x);Z=i(D,"a single Tensor with "),H=s(D,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(D," only and nothing else: "),R=s(D,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=h(L),C=s(L,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(L),A=s(L,"LI",{});var ie=r(A);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),L.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,O),e(O,G),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,I,F),e(I,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,A),e(A,ne),e(A,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(I),u&&t(V),u&&t(q)}}}function z_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var L=r(q);x=s(L,"LI",{});var D=r(x);Z=i(D,"a single Tensor with "),H=s(D,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(D," only and nothing else: "),R=s(D,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=h(L),C=s(L,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(L),A=s(L,"LI",{});var ie=r(A);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),L.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,O),e(O,G),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,I,F),e(I,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,A),e(A,ne),e(A,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(I),u&&t(V),u&&t(q)}}}function C_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var L=r(q);x=s(L,"LI",{});var D=r(x);Z=i(D,"a single Tensor with "),H=s(D,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(D," only and nothing else: "),R=s(D,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=h(L),C=s(L,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(L),A=s(L,"LI",{});var ie=r(A);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),L.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,O),e(O,G),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,I,F),e(I,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,A),e(A,ne),e(A,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(I),u&&t(V),u&&t(q)}}}function L_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_tokens_classes
`}}),{c(){l=n("p"),g=a("Example:"),c=m(),M(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),$(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),T(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function S_(y){let l,g;return l=new Me({props:{code:`labels = predicted_token_class_ids
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var L=r(q);x=s(L,"LI",{});var D=r(x);Z=i(D,"a single Tensor with "),H=s(D,"CODE",{});var Pe=r(H);re=i(Pe,"input_ids"),Pe.forEach(t),ee=i(D," only and nothing else: "),R=s(D,"CODE",{});var ge=r(R);ae=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=h(L),C=s(L,"LI",{});var fe=r(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=r(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(L),A=s(L,"LI",{});var ie=r(A);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=r(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),L.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,O),e(O,G),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,I,F),e(I,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,re),e(x,ee),e(x,R),e(R,ae),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,A),e(A,ne),e(A,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(I),u&&t(V),u&&t(q)}}}function O_(y){let l,g,c,p,b;return{c(){l=n("p"),g=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=r(c);p=i(z,"Module"),z.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predict_answer_tokens = inputs.input_ids[<span class="hljs-number">0</span>, answer_start_index : answer_end_index + <span class="hljs-number">1</span>]
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predict_answer_tokens)
`}}),{c(){l=n("p"),g=a("Example:"),c=m(),M(p.$$.fragment)},l(d){l=s(d,"P",{});var f=r(l);g=i(f,"Example:"),f.forEach(t),c=h(d),$(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),T(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function Q_(y){let l,g;return l=new Me({props:{code:`# target is "nice puppet"
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/tokenization_mpnet.py#L231",returnDescription:`
...
Set to True if the token list is already formatted with special tokens for the model`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/tokenization_mpnet.py#L256",returnDescription:`
...
Optional second list of IDs for sequence pairs`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/tokenization_mpnet_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L481"}}),In=new J({props:{name:"forward",anchor:"transformers.MPNetModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16925/en/model_doc/mpnet#transformers.MPNetConfig"
...
`}}),mo=new Fe({props:{$$slots:{default:[n_]},$$scope:{ctx:y}}}),ho=new be({props:{anchor:"transformers.MPNetModel.forward.example",$$slots:{default:[s_]},$$scope:{ctx:y}}}),Sn=new Le({}),Dn=new J({props:{name:"class transformers.MPNetForMaskedLM",anchor:"transformers.MPNetForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L574"}}),On=new J({props:{name:"forward",anchor:"transformers.MPNetForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MPNetForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L593",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L683"}}),Bn=new J({props:{name:"forward",anchor:"transformers.MPNetForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L696",returnDescription:`
<p>A <a
...
`}}),bo=new Fe({props:{$$slots:{default:[l_]},$$scope:{ctx:y}}}),vo=new be({props:{anchor:"transformers.MPNetForSequenceClassification.forward.example",$$slots:{default:[d_]},$$scope:{ctx:y}}}),Mo=new be({props:{anchor:"transformers.MPNetForSequenceClassification.forward.example-2",$$slots:{default:[c_]},$$scope:{ctx:y}}}),$o=new be({props:{anchor:"transformers.MPNetForSequenceClassification.forward.example-3",$$slots:{default:[p_]},$$scope:{ctx:y}}}),To=new be({props:{anchor:"transformers.MPNetForSequenceClassification.forward.example-4",$$slots:{default:[m_]},$$scope:{ctx:y}}}),Vn=new Le({}),Kn=new J({props:{name:"class transformers.MPNetForMultipleChoice",anchor:"transformers.MPNetForMultipleChoice",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16925/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L778"}}),Yn=new J({props:{name:"forward",anchor:"transformers.MPNetForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L791",returnDescription:`
<p>A <a
...
`}}),Po=new Fe({props:{$$slots:{default:[h_]},$$scope:{ctx:y}}}),No=new be({props:{anchor:"transformers.MPNetForMultipleChoice.forward.example",$$slots:{default:[f_]},$$scope:{ctx:y}}}),Zn=new Le({}),es=new J({props:{name:"class transformers.MPNetForTokenClassification",anchor:"transformers.MPNetForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MPNetForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16925/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L869"}}),ss=new J({props:{name:"forward",anchor:"transformers.MPNetForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MPNetForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L884",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_mpnet.py#L983",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_tf_mpnet.py#L670",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_tf_mpnet.py#L786",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_tf_mpnet.py#L892",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_tf_mpnet.py#L983",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1095",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1178",returnDescription:`
<p>A <a
...
BERT, XLNet, RoBERTa) under the same model setting.`),Q=m(),oe=n("p"),me=a("Tips:"),A=m(),ne=n("ul"),j=n("li"),he=a("MPNet doesn\u2019t have "),u=n("code"),F=a("token_type_ids"),K=a(`, you don\u2019t need to indicate which token belongs to which segment. just
separate your segments with the separation token `),_e=n("code"),$e=a("tokenizer.sep_token"),S=a(" (or "),ke=n("code"),Te=a("[sep]"),we=a(")."),L=m(),D=n("p"),Pe=a("The original code can be found "),ge=n("a"),fe=a("here"),Ne=a("."),ie=m(),ue=n("h2"),no=n("a"),Kr=n("span"),M(un.$$.fragment),Gl=m(),Xr=n("span"),Yl=a("MPNetConfig"),qi=m(),Ge=n("div"),M(gn.$$.fragment),Zl=m(),dt=n("p"),ed=a("This is the configuration class to store the configuration of a "),tr=n("a"),td=a("MPNetModel"),od=a(" or a "),or=n("a"),nd=a("TFMPNetModel"),sd=a(`. It is used to
instantiate a MPNet model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the MPNet
`),_n=n("a"),rd=a("mpnet-base"),ad=a(" architecture."),id=m(),Nt=n("p"),ld=a("Configuration objects inherit from "),nr=n("a"),dd=a("PretrainedConfig"),cd=a(` and can be used to control the model outputs. Read the
documentation from `),sr=n("a"),pd=a("PretrainedConfig"),md=a(" for more information."),hd=m(),M(so.$$.fragment),xi=m(),yt=n("h2"),ro=n("a"),Jr=n("span"),M(kn.$$.fragment),fd=m(),Gr=n("span"),ud=a("MPNetTokenizer"),Ci=m(),ze=n("div"),M(bn.$$.fragment),gd=m(),vn=n("p"),_d=a("This tokenizer inherits from "),rr=n("a"),kd=a("BertTokenizer"),bd=a(` which contains most of the methods. Users should refer to the
superclass for more information regarding methods.`),vd=m(),ht=n("div"),M(Mn.$$.fragment),Md=m(),Yr=n("p"),$d=a(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A MPNet sequence has the following format:`),Td=m(),$n=n("ul"),ar=n("li"),wd=a("single sequence: "),Zr=n("code"),Pd=a("<s> X </s>"),Nd=m(),ir=n("li"),yd=a("pair of sequences: "),ea=n("code"),Fd=a("<s> A </s></s> B </s>"),zd=m(),ao=n("div"),M(Tn.$$.fragment),Ed=m(),wn=n("p"),qd=a(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ta=n("code"),xd=a("prepare_for_model"),Cd=a(" methods."),jd=m(),io=n("div"),M(Pn.$$.fragment),Ad=m(),oa=n("p"),Ld=a(`Creates a mask from the two sequences passed to be used in a sequence-pair classification task. MPNet does not
make use of token type ids, therefore a list of zeros is returned.`),Id=m(),lr=n("div"),M(Nn.$$.fragment),ji=m(),Ft=n("h2"),lo=n("a"),na=n("span"),M(yn.$$.fragment),Sd=m(),sa=n("span"),Dd=a("MPNetTokenizerFast"),Ai=m(),Ye=n("div"),M(Fn.$$.fragment),Od=m(),zn=n("p"),Wd=a("Construct a \u201Cfast\u201D MPNet tokenizer (backed by HuggingFace\u2019s "),ra=n("em"),Qd=a("tokenizers"),Hd=a(" library). Based on WordPiece."),Rd=m(),En=n("p"),Ud=a("This tokenizer inherits from "),dr=n("a"),Bd=a("PreTrainedTokenizerFast"),Vd=a(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Kd=m(),co=n("div"),M(qn.$$.fragment),Xd=m(),aa=n("p"),Jd=a(`Creates a mask from the two sequences passed to be used in a sequence-pair classification task. MPNet does not
make use of token type ids, therefore a list of zeros is returned`),Li=m(),zt=n("h2"),po=n("a"),ia=n("span"),M(xn.$$.fragment),Gd=m(),la=n("span"),Yd=a("MPNetModel"),Ii=m(),Ie=n("div"),M(Cn.$$.fragment),Zd=m(),da=n("p"),ec=a("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),tc=m(),jn=n("p"),oc=a("This model inherits from "),cr=n("a"),nc=a("PreTrainedModel"),sc=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rc=m(),An=n("p"),ac=a("This model is also a PyTorch "),Ln=n("a"),ic=a("torch.nn.Module"),lc=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dc=m(),Ze=n("div"),M(In.$$.fragment),cc=m(),Et=n("p"),pc=a("The "),pr=n("a"),mc=a("MPNetModel"),hc=a(" forward method, overrides the "),ca=n("code"),fc=a("__call__"),uc=a(" special method."),gc=m(),M(mo.$$.fragment),_c=m(),M(ho.$$.fragment),Si=m(),qt=n("h2"),fo=n("a"),pa=n("span"),M(Sn.$$.fragment),kc=m(),ma=n("span"),bc=a("MPNetForMaskedLM"),Di=m(),xt=n("div"),M(Dn.$$.fragment),vc=m(),He=n("div"),M(On.$$.fragment),Mc=m(),Ct=n("p"),$c=a("The "),mr=n("a"),Tc=a("MPNetForMaskedLM"),wc=a(" forward method, overrides the "),ha=n("code"),Pc=a("__call__"),Nc=a(" special method."),yc=m(),M(uo.$$.fragment),Fc=m(),M(go.$$.fragment),zc=m(),M(_o.$$.fragment),Oi=m(),jt=n("h2"),ko=n("a"),fa=n("span"),M(Wn.$$.fragment),Ec=m(),ua=n("span"),qc=a("MPNetForSequenceClassification"),Wi=m(),Se=n("div"),M(Qn.$$.fragment),xc=m(),ga=n("p"),Cc=a(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),jc=m(),Hn=n("p"),Ac=a("This model inherits from "),hr=n("a"),Lc=a("PreTrainedModel"),Ic=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sc=m(),Rn=n("p"),Dc=a("This model is also a PyTorch "),Un=n("a"),Oc=a("torch.nn.Module"),Wc=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc=m(),ye=n("div"),M(Bn.$$.fragment),Hc=m(),At=n("p"),Rc=a("The "),fr=n("a"),Uc=a("MPNetForSequenceClassification"),Bc=a(" forward method, overrides the "),_a=n("code"),Vc=a("__call__"),Kc=a(" special method."),Xc=m(),M(bo.$$.fragment),Jc=m(),M(vo.$$.fragment),Gc=m(),M(Mo.$$.fragment),Yc=m(),M($o.$$.fragment),Zc=m(),M(To.$$.fragment),Qi=m(),Lt=n("h2"),wo=n("a"),ka=n("span"),M(Vn.$$.fragment),ep=m(),ba=n("span"),tp=a("MPNetForMultipleChoice"),Hi=m(),De=n("div"),M(Kn.$$.fragment),op=m(),va=n("p"),np=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp=m(),et=n("div"),M(Yn.$$.fragment),hp=m(),It=n("p"),fp=a("The "),gr=n("a"),up=a("MPNetForMultipleChoice"),gp=a(" forward method, overrides the "),Ma=n("code"),_p=a("__call__"),kp=a(" special method."),bp=m(),M(Po.$$.fragment),vp=m(),M(No.$$.fragment),Ri=m(),St=n("h2"),yo=n("a"),$a=n("span"),M(Zn.$$.fragment),Mp=m(),Ta=n("span"),$p=a("MPNetForTokenClassification"),Ui=m(),Oe=n("div"),M(es.$$.fragment),Tp=m(),wa=n("p"),wp=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cp=m(),Re=n("div"),M(ss.$$.fragment),jp=m(),Dt=n("p"),Ap=a("The "),kr=n("a"),Lp=a("MPNetForTokenClassification"),Ip=a(" forward method, overrides the "),Pa=n("code"),Sp=a("__call__"),Dp=a(" special method."),Op=m(),M(Fo.$$.fragment),Wp=m(),M(zo.$$.fragment),Qp=m(),M(Eo.$$.fragment),Bi=m(),Ot=n("h2"),qo=n("a"),Na=n("span"),M(rs.$$.fragment),Hp=m(),ya=n("span"),Rp=a("MPNetForQuestionAnswering"),Vi=m(),We=n("div"),M(as.$$.fragment),Up=m(),Wt=n("p"),Bp=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rm=m(),Ue=n("div"),M(cs.$$.fragment),am=m(),Qt=n("p"),im=a("The "),vr=n("a"),lm=a("MPNetForQuestionAnswering"),dm=a(" forward method, overrides the "),Ea=n("code"),cm=a("__call__"),pm=a(" special method."),mm=m(),M(xo.$$.fragment),hm=m(),M(Co.$$.fragment),fm=m(),M(jo.$$.fragment),Ki=m(),Ht=n("h2"),Ao=n("a"),qa=n("span"),M(ps.$$.fragment),um=m(),xa=n("span"),gm=a("TFMPNetModel"),Xi=m(),Ee=n("div"),M(ms.$$.fragment),_m=m(),Ca=n("p"),km=a("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),bm=m(),hs=n("p"),vm=a("This model inherits from "),Mr=n("a"),Mm=a("TFPreTrainedModel"),$m=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tm=m(),fs=n("p"),wm=a("This model is also a "),us=n("a"),Pm=a("tf.keras.Model"),Nm=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ym=m(),M(Lo.$$.fragment),Fm=m(),tt=n("div"),M(gs.$$.fragment),zm=m(),Rt=n("p"),Em=a("The "),$r=n("a"),qm=a("TFMPNetModel"),xm=a(" forward method, overrides the "),ja=n("code"),Cm=a("__call__"),jm=a(" special method."),Am=m(),M(Io.$$.fragment),Lm=m(),M(So.$$.fragment),Ji=m(),Ut=n("h2"),Do=n("a"),Aa=n("span"),M(_s.$$.fragment),Im=m(),La=n("span"),Sm=a("TFMPNetForMaskedLM"),Gi=m(),qe=n("div"),M(ks.$$.fragment),Dm=m(),bs=n("p"),Om=a("MPNet Model with a "),Ia=n("code"),Wm=a("language modeling"),Qm=a(" head on top."),Hm=m(),vs=n("p"),Rm=a("This model inherits from "),Tr=n("a"),Um=a("TFPreTrainedModel"),Bm=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vm=m(),Ms=n("p"),Km=a("This model is also a "),$s=n("a"),Xm=a("tf.keras.Model"),Jm=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gm=m(),M(Oo.$$.fragment),Ym=m(),Be=n("div"),M(Ts.$$.fragment),Zm=m(),Bt=n("p"),eh=a("The "),wr=n("a"),th=a("TFMPNetForMaskedLM"),oh=a(" forward method, overrides the "),Sa=n("code"),nh=a("__call__"),sh=a(" special method."),rh=m(),M(Wo.$$.fragment),ah=m(),M(Qo.$$.fragment),ih=m(),M(Ho.$$.fragment),Yi=m(),Vt=n("h2"),Ro=n("a"),Da=n("span"),M(ws.$$.fragment),lh=m(),Oa=n("span"),dh=a("TFMPNetForSequenceClassification"),Zi=m(),xe=n("div"),M(Ps.$$.fragment),ch=m(),Wa=n("p"),ph=a(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vh=m(),M(Uo.$$.fragment),Mh=m(),Ve=n("div"),M(zs.$$.fragment),$h=m(),Kt=n("p"),Th=a("The "),Nr=n("a"),wh=a("TFMPNetForSequenceClassification"),Ph=a(" forward method, overrides the "),Qa=n("code"),Nh=a("__call__"),yh=a(" special method."),Fh=m(),M(Bo.$$.fragment),zh=m(),M(Vo.$$.fragment),Eh=m(),M(Ko.$$.fragment),el=m(),Xt=n("h2"),Xo=n("a"),Ha=n("span"),M(Es.$$.fragment),qh=m(),Ra=n("span"),xh=a("TFMPNetForMultipleChoice"),tl=m(),Ce=n("div"),M(qs.$$.fragment),Ch=m(),Ua=n("p"),jh=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Ah=m(),xs=n("p"),Lh=a("This model inherits from "),yr=n("a"),Ih=a("TFPreTrainedModel"),Sh=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dh=m(),Cs=n("p"),Oh=a("This model is also a "),js=n("a"),Wh=a("tf.keras.Model"),Qh=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hh=m(),M(Jo.$$.fragment),Rh=m(),ot=n("div"),M(As.$$.fragment),Uh=m(),Jt=n("p"),Bh=a("The "),Fr=n("a"),Vh=a("TFMPNetForMultipleChoice"),Kh=a(" forward method, overrides the "),Ba=n("code"),Xh=a("__call__"),Jh=a(" special method."),Gh=m(),M(Go.$$.fragment),Yh=m(),M(Yo.$$.fragment),ol=m(),Gt=n("h2"),Zo=n("a"),Va=n("span"),M(Ls.$$.fragment),Zh=m(),Ka=n("span"),ef=a("TFMPNetForTokenClassification"),nl=m(),je=n("div"),M(Is.$$.fragment),tf=m(),Xa=n("p"),of=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nf=m(),Ss=n("p"),sf=a("This model inherits from "),zr=n("a"),rf=a("TFPreTrainedModel"),af=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lf=m(),Ds=n("p"),df=a("This model is also a "),Os=n("a"),cf=a("tf.keras.Model"),pf=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mf=m(),M(en.$$.fragment),hf=m(),Ke=n("div"),M(Ws.$$.fragment),ff=m(),Yt=n("p"),uf=a("The "),Er=n("a"),gf=a("TFMPNetForTokenClassification"),_f=a(" forward method, overrides the "),Ja=n("code"),kf=a("__call__"),bf=a(" special method."),vf=m(),M(tn.$$.fragment),Mf=m(),M(on.$$.fragment),$f=m(),M(nn.$$.fragment),sl=m(),Zt=n("h2"),sn=n("a"),Ga=n("span"),M(Qs.$$.fragment),Tf=m(),Ya=n("span"),wf=a("TFMPNetForQuestionAnswering"),rl=m(),Ae=n("div"),M(Hs.$$.fragment),Pf=m(),eo=n("p"),Nf=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Af=m(),Us=n("p"),Lf=a("This model is also a "),Bs=n("a"),If=a("tf.keras.Model"),Sf=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Df=m(),M(rn.$$.fragment),Of=m(),Xe=n("div"),M(Vs.$$.fragment),Wf=m(),to=n("p"),Qf=a("The "),xr=n("a"),Hf=a("TFMPNetForQuestionAnswering"),Rf=a(" forward method, overrides the "),ti=n("code"),Uf=a("__call__"),Bf=a(" special method."),Vf=m(),M(an.$$.fragment),Kf=m(),M(ln.$$.fragment),Xf=m(),M(dn.$$.fragment),this.h()},l(o){const k=e_('[data-svelte="svelte-1phssyn"]',document.head);l=s(k,"META",{name:!0,content:!0}),k.forEach(t),g=h(o),c=s(o,"H1",{class:!0});var Ks=r(c);p=s(Ks,"A",{id:!0,class:!0,href:!0});var oi=r(p);b=s(oi,"SPAN",{});var ni=r(b);$(d.$$.fragment,ni),ni.forEach(t),oi.forEach(t),f=h(Ks),z=s(Ks,"SPAN",{});var si=r(z);le=i(si,"MPNet"),si.forEach(t),Ks.forEach(t),B=h(o),E=s(o,"H2",{class:!0});var Xs=r(E);X=s(Xs,"A",{id:!0,class:!0,href:!0});var ri=r(X);O=s(ri,"SPAN",{});var ai=r(O);$(G.$$.fragment,ai),ai.forEach(t),ri.forEach(t),de=h(Xs),W=s(Xs,"SPAN",{});var ii=r(W);ce=i(ii,"Overview"),ii.forEach(t),Xs.forEach(t),se=h(o),U=s(o,"P",{});var Js=r(U);I=i(Js,"The MPNet model was proposed in "),Y=s(Js,"A",{href:!0,rel:!0});var li=r(Y);V=i(li,"MPNet: Masked and Permuted Pre-training for Language Understanding"),li.forEach(t),q=i(Js," by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),Js.forEach(t),x=h(o),Z=s(o,"P",{});var di=r(Z);H=i(di,`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
...
down-streaming tasks (GLUE, SQuAD, etc). Experimental results show that MPNet outperforms MLM and PLM by a large
margin, and achieves better results on these tasks compared with previous state-of-the-art pre-trained methods (e.g.,
BERT, XLNet, RoBERTa) under the same model setting.`),mi.forEach(t),pi.forEach(t),Q=h(o),oe=s(o,"P",{});var hi=r(oe);me=i(hi,"Tips:"),hi.forEach(t),A=h(o),ne=s(o,"UL",{});var fi=r(ne);j=s(fi,"LI",{});var ct=r(j);he=i(ct,"MPNet doesn\u2019t have "),u=s(ct,"CODE",{});var ui=r(u);F=i(ui,"token_type_ids"),ui.forEach(t),K=i(ct,`, you don\u2019t need to indicate which token belongs to which segment. just
separate your segments with the separation token `),_e=s(ct,"CODE",{});var gi=r(_e);$e=i(gi,"tokenizer.sep_token"),gi.forEach(t),S=i(ct," (or "),ke=s(ct,"CODE",{});var _i=r(ke);Te=i(_i,"[sep]"),_i.forEach(t),we=i(ct,")."),ct.forEach(t),fi.forEach(t),L=h(o),D=s(o,"P",{});var Gs=r(D);Pe=i(Gs,"The original code can be found "),ge=s(Gs,"A",{href:!0,rel:!0});var ki=r(ge);fe=i(ki,"here"),ki.forEach(t),Ne=i(Gs,"."),Gs.forEach(t),ie=h(o),ue=s(o,"H2",{class:!0});var Ys=r(ue);no=s(Ys,"A",{id:!0,class:!0,href:!0});var bi=r(no);Kr=s(bi,"SPAN",{});var vi=r(Kr);$(un.$$.fragment,vi),vi.forEach(t),bi.forEach(t),Gl=h(Ys),Xr=s(Ys,"SPAN",{});var Mi=r(Xr);Yl=i(Mi,"MPNetConfig"),Mi.forEach(t),Ys.forEach(t),qi=h(o),Ge=s(o,"DIV",{class:!0});var pt=r(Ge);$(gn.$$.fragment,pt),Zl=h(pt),dt=s(pt,"P",{});var mt=r(dt);ed=i(mt,"This is the configuration class to store the configuration of a "),tr=s(mt,"A",{href:!0});var $i=r(tr);td=i($i,"MPNetModel"),$i.forEach(t),od=i(mt," or a "),or=s(mt,"A",{href:!0});var Ti=r(or);nd=i(Ti,"TFMPNetModel"),Ti.forEach(t),sd=i(mt,`. It is used to
instantiate a MPNet model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the MPNet
`),_n=s(mt,"A",{href:!0,rel:!0});var wi=r(_n);rd=i(wi,"mpnet-base"),wi.forEach(t),ad=i(mt," architecture."),mt.forEach(t),id=h(pt),Nt=s(pt,"P",{});var oo=r(Nt);ld=i(oo,"Configuration objects inherit from "),nr=s(oo,"A",{href:!0});var Pi=r(nr);dd=i(Pi,"PretrainedConfig"),Pi.forEach(t),cd=i(oo,` and can be used to control the model outputs. Read the
documentation from `),sr=s(oo,"A",{href:!0});var Ni=r(sr);pd=i(Ni,"PretrainedConfig"),Ni.forEach(t),md=i(oo," for more information."),oo.forEach(t),hd=h(pt),$(so.$$.fragment,pt),pt.forEach(t),xi=h(o),yt=s(o,"H2",{class:!0});var Zs=r(yt);ro=s(Zs,"A",{id:!0,class:!0,href:!0});var yi=r(ro);Jr=s(yi,"SPAN",{});var Fi=r(Jr);$(kn.$$.fragment,Fi),Fi.forEach(t),yi.forEach(t),fd=h(Zs),Gr=s(Zs,"SPAN",{});var zi=r(Gr);ud=i(zi,"MPNetTokenizer"),zi.forEach(t),Zs.forEach(t),Ci=h(o),ze=s(o,"DIV",{class:!0});var Qe=r(ze);$(bn.$$.fragment,Qe),gd=h(Qe),vn=s(Qe,"P",{});var er=r(vn);_d=i(er,"This tokenizer inherits from "),rr=s(er,"A",{href:!0});var Ei=r(rr);kd=i(Ei,"BertTokenizer"),Ei.forEach(t),bd=i(er,` which contains most of the methods. Users should refer to the
superclass for more information regarding methods.`),er.forEach(t),vd=h(Qe),ht=s(Qe,"DIV",{class:!0});var Cr=r(ht);$(Mn.$$.fragment,Cr),Md=h(Cr),Yr=s(Cr,"P",{});var Yf=r(Yr);$d=i(Yf,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A MPNet sequence has the following format:`),Yf.forEach(t),Td=h(Cr),$n=s(Cr,"UL",{});var il=r($n);ar=s(il,"LI",{});var Jf=r(ar);wd=i(Jf,"single sequence: "),Zr=s(Jf,"CODE",{});var Zf=r(Zr);Pd=i(Zf,"<s> X </s>"),Zf.forEach(t),Jf.forEach(t),Nd=h(il),ir=s(il,"LI",{});var Gf=r(ir);yd=i(Gf,"pair of sequences: "),ea=s(Gf,"CODE",{});var eu=r(ea);Fd=i(eu,"<s> A </s></s> B </s>"),eu.forEach(t),Gf.forEach(t),il.forEach(t),Cr.forEach(t),zd=h(Qe),ao=s(Qe,"DIV",{class:!0});var ll=r(ao);$(Tn.$$.fragment,ll),Ed=h(ll),wn=s(ll,"P",{});var dl=r(wn);qd=i(dl,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ta=s(dl,"CODE",{});var tu=r(ta);xd=i(tu,"prepare_for_model"),tu.forEach(t),Cd=i(dl," methods."),dl.forEach(t),ll.forEach(t),jd=h(Qe),io=s(Qe,"DIV",{class:!0});var cl=r(io);$(Pn.$$.fragment,cl),Ad=h(cl),oa=s(cl,"P",{});var ou=r(oa);Ld=i(ou,`Creates a mask from the two sequences passed to be used in a sequence-pair classification task. MPNet does not
make use of token type ids, therefore a list of zeros is returned.`),ou.forEach(t),cl.forEach(t),Id=h(Qe),lr=s(Qe,"DIV",{class:!0});var nu=r(lr);$(Nn.$$.fragment,nu),nu.forEach(t),Qe.forEach(t),ji=h(o),Ft=s(o,"H2",{class:!0});var pl=r(Ft);lo=s(pl,"A",{id:!0,class:!0,href:!0});var su=r(lo);na=s(su,"SPAN",{});var ru=r(na);$(yn.$$.fragment,ru),ru.forEach(t),su.forEach(t),Sd=h(pl),sa=s(pl,"SPAN",{});var au=r(sa);Dd=i(au,"MPNetTokenizerFast"),au.forEach(t),pl.forEach(t),Ai=h(o),Ye=s(o,"DIV",{class:!0});var cn=r(Ye);$(Fn.$$.fragment,cn),Od=h(cn),zn=s(cn,"P",{});var ml=r(zn);Wd=i(ml,"Construct a \u201Cfast\u201D MPNet tokenizer (backed by HuggingFace\u2019s "),ra=s(ml,"EM",{});var iu=r(ra);Qd=i(iu,"tokenizers"),iu.forEach(t),Hd=i(ml," library). Based on WordPiece."),ml.forEach(t),Rd=h(cn),En=s(cn,"P",{});var hl=r(En);Ud=i(hl,"This tokenizer inherits from "),dr=s(hl,"A",{href:!0});var lu=r(dr);Bd=i(lu,"PreTrainedTokenizerFast"),lu.forEach(t),Vd=i(hl,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),hl.forEach(t),Kd=h(cn),co=s(cn,"DIV",{class:!0});var fl=r(co);$(qn.$$.fragment,fl),Xd=h(fl),aa=s(fl,"P",{});var du=r(aa);Jd=i(du,`Creates a mask from the two sequences passed to be used in a sequence-pair classification task. MPNet does not
make use of token type ids, therefore a list of zeros is returned`),du.forEach(t),fl.forEach(t),cn.forEach(t),Li=h(o),zt=s(o,"H2",{class:!0});var ul=r(zt);po=s(ul,"A",{id:!0,class:!0,href:!0});var cu=r(po);ia=s(cu,"SPAN",{});var pu=r(ia);$(xn.$$.fragment,pu),pu.forEach(t),cu.forEach(t),Gd=h(ul),la=s(ul,"SPAN",{});var mu=r(la);Yd=i(mu,"MPNetModel"),mu.forEach(t),ul.forEach(t),Ii=h(o),Ie=s(o,"DIV",{class:!0});var ft=r(Ie);$(Cn.$$.fragment,ft),Zd=h(ft),da=s(ft,"P",{});var hu=r(da);ec=i(hu,"The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),hu.forEach(t),tc=h(ft),jn=s(ft,"P",{});var gl=r(jn);oc=i(gl,"This model inherits from "),cr=s(gl,"A",{href:!0});var fu=r(cr);nc=i(fu,"PreTrainedModel"),fu.forEach(t),sc=i(gl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gl.forEach(t),rc=h(ft),An=s(ft,"P",{});var _l=r(An);ac=i(_l,"This model is also a PyTorch "),Ln=s(_l,"A",{href:!0,rel:!0});var uu=r(Ln);ic=i(uu,"torch.nn.Module"),uu.forEach(t),lc=i(_l,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_l.forEach(t),dc=h(ft),Ze=s(ft,"DIV",{class:!0});var pn=r(Ze);$(In.$$.fragment,pn),cc=h(pn),Et=s(pn,"P",{});var jr=r(Et);pc=i(jr,"The "),pr=s(jr,"A",{href:!0});var gu=r(pr);mc=i(gu,"MPNetModel"),gu.forEach(t),hc=i(jr," forward method, overrides the "),ca=s(jr,"CODE",{});var _u=r(ca);fc=i(_u,"__call__"),_u.forEach(t),uc=i(jr," special method."),jr.forEach(t),gc=h(pn),$(mo.$$.fragment,pn),_c=h(pn),$(ho.$$.fragment,pn),pn.forEach(t),ft.forEach(t),Si=h(o),qt=s(o,"H2",{class:!0});var kl=r(qt);fo=s(kl,"A",{id:!0,class:!0,href:!0});var ku=r(fo);pa=s(ku,"SPAN",{});var bu=r(pa);$(Sn.$$.fragment,bu),bu.forEach(t),ku.forEach(t),kc=h(kl),ma=s(kl,"SPAN",{});var vu=r(ma);bc=i(vu,"MPNetForMaskedLM"),vu.forEach(t),kl.forEach(t),Di=h(o),xt=s(o,"DIV",{class:!0});var bl=r(xt);$(Dn.$$.fragment,bl),vc=h(bl),He=s(bl,"DIV",{class:!0});var ut=r(He);$(On.$$.fragment,ut),Mc=h(ut),Ct=s(ut,"P",{});var Ar=r(Ct);$c=i(Ar,"The "),mr=s(Ar,"A",{href:!0});var Mu=r(mr);Tc=i(Mu,"MPNetForMaskedLM"),Mu.forEach(t),wc=i(Ar," forward method, overrides the "),ha=s(Ar,"CODE",{});var $u=r(ha);Pc=i($u,"__call__"),$u.forEach(t),Nc=i(Ar," special method."),Ar.forEach(t),yc=h(ut),$(uo.$$.fragment,ut),Fc=h(ut),$(go.$$.fragment,ut),zc=h(ut),$(_o.$$.fragment,ut),ut.forEach(t),bl.forEach(t),Oi=h(o),jt=s(o,"H2",{class:!0});var vl=r(jt);ko=s(vl,"A",{id:!0,class:!0,href:!0});var Tu=r(ko);fa=s(Tu,"SPAN",{});var wu=r(fa);$(Wn.$$.fragment,wu),wu.forEach(t),Tu.forEach(t),Ec=h(vl),ua=s(vl,"SPAN",{});var Pu=r(ua);qc=i(Pu,"MPNetForSequenceClassification"),Pu.forEach(t),vl.forEach(t),Wi=h(o),Se=s(o,"DIV",{class:!0});var gt=r(Se);$(Qn.$$.fragment,gt),xc=h(gt),ga=s(gt,"P",{});var Nu=r(ga);Cc=i(Nu,`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),Nu.forEach(t),jc=h(gt),Hn=s(gt,"P",{});var Ml=r(Hn);Ac=i(Ml,"This model inherits from "),hr=s(Ml,"A",{href:!0});var yu=r(hr);Lc=i(yu,"PreTrainedModel"),yu.forEach(t),Ic=i(Ml,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ml.forEach(t),Sc=h(gt),Rn=s(gt,"P",{});var $l=r(Rn);Dc=i($l,"This model is also a PyTorch "),Un=s($l,"A",{href:!0,rel:!0});var Fu=r(Un);Oc=i(Fu,"torch.nn.Module"),Fu.forEach(t),Wc=i($l,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$l.forEach(t),Qc=h(gt),ye=s(gt,"DIV",{class:!0});var Je=r(ye);$(Bn.$$.fragment,Je),Hc=h(Je),At=s(Je,"P",{});var Lr=r(At);Rc=i(Lr,"The "),fr=s(Lr,"A",{href:!0});var zu=r(fr);Uc=i(zu,"MPNetForSequenceClassification"),zu.forEach(t),Bc=i(Lr," forward method, overrides the "),_a=s(Lr,"CODE",{});var Eu=r(_a);Vc=i(Eu,"__call__"),Eu.forEach(t),Kc=i(Lr," special method."),Lr.forEach(t),Xc=h(Je),$(bo.$$.fragment,Je),Jc=h(Je),$(vo.$$.fragment,Je),Gc=h(Je),$(Mo.$$.fragment,Je),Yc=h(Je),$($o.$$.fragment,Je),Zc=h(Je),$(To.$$.fragment,Je),Je.forEach(t),gt.forEach(t),Qi=h(o),Lt=s(o,"H2",{class:!0});var Tl=r(Lt);wo=s(Tl,"A",{id:!0,class:!0,href:!0});var qu=r(wo);ka=s(qu,"SPAN",{});var xu=r(ka);$(Vn.$$.fragment,xu),xu.forEach(t),qu.forEach(t),ep=h(Tl),ba=s(Tl,"SPAN",{});var Cu=r(ba);tp=i(Cu,"MPNetForMultipleChoice"),Cu.forEach(t),Tl.forEach(t),Hi=h(o),De=s(o,"DIV",{class:!0});var _t=r(De);$(Kn.$$.fragment,_t),op=h(_t),va=s(_t,"P",{});var ju=r(va);np=i(ju,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),ju.forEach(t),sp=h(_t),Xn=s(_t,"P",{});var wl=r(Xn);rp=i(wl,"This model inherits from "),ur=s(wl,"A",{href:!0});var Au=r(ur);ap=i(Au,"PreTrainedModel"),Au.forEach(t),ip=i(wl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wl.forEach(t),lp=h(_t),Jn=s(_t,"P",{});var Pl=r(Jn);dp=i(Pl,"This model is also a PyTorch "),Gn=s(Pl,"A",{href:!0,rel:!0});var Lu=r(Gn);cp=i(Lu,"torch.nn.Module"),Lu.forEach(t),pp=i(Pl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pl.forEach(t),mp=h(_t),et=s(_t,"DIV",{class:!0});var mn=r(et);$(Yn.$$.fragment,mn),hp=h(mn),It=s(mn,"P",{});var Ir=r(It);fp=i(Ir,"The "),gr=s(Ir,"A",{href:!0});var Iu=r(gr);up=i(Iu,"MPNetForMultipleChoice"),Iu.forEach(t),gp=i(Ir," forward method, overrides the "),Ma=s(Ir,"CODE",{});var Su=r(Ma);_p=i(Su,"__call__"),Su.forEach(t),kp=i(Ir," special method."),Ir.forEach(t),bp=h(mn),$(Po.$$.fragment,mn),vp=h(mn),$(No.$$.fragment,mn),mn.forEach(t),_t.forEach(t),Ri=h(o),St=s(o,"H2",{class:!0});var Nl=r(St);yo=s(Nl,"A",{id:!0,class:!0,href:!0});var Du=r(yo);$a=s(Du,"SPAN",{});var Ou=r($a);$(Zn.$$.fragment,Ou),Ou.forEach(t),Du.forEach(t),Mp=h(Nl),Ta=s(Nl,"SPAN",{});var Wu=r(Ta);$p=i(Wu,"MPNetForTokenClassification"),Wu.forEach(t),Nl.forEach(t),Ui=h(o),Oe=s(o,"DIV",{class:!0});var kt=r(Oe);$(es.$$.fragment,kt),Tp=h(kt),wa=s(kt,"P",{});var Qu=r(wa);wp=i(Qu,`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fl.forEach(t),Cp=h(kt),Re=s(kt,"DIV",{class:!0});var bt=r(Re);$(ss.$$.fragment,bt),jp=h(bt),Dt=s(bt,"P",{});var Sr=r(Dt);Ap=i(Sr,"The "),kr=s(Sr,"A",{href:!0});var Uu=r(kr);Lp=i(Uu,"MPNetForTokenClassification"),Uu.forEach(t),Ip=i(Sr," forward method, overrides the "),Pa=s(Sr,"CODE",{});var Bu=r(Pa);Sp=i(Bu,"__call__"),Bu.forEach(t),Dp=i(Sr," special method."),Sr.forEach(t),Op=h(bt),$(Fo.$$.fragment,bt),Wp=h(bt),$(zo.$$.fragment,bt),Qp=h(bt),$(Eo.$$.fragment,bt),bt.forEach(t),kt.forEach(t),Bi=h(o),Ot=s(o,"H2",{class:!0});var zl=r(Ot);qo=s(zl,"A",{id:!0,class:!0,href:!0});var Vu=r(qo);Na=s(Vu,"SPAN",{});var Ku=r(Na);$(rs.$$.fragment,Ku),Ku.forEach(t),Vu.forEach(t),Hp=h(zl),ya=s(zl,"SPAN",{});var Xu=r(ya);Rp=i(Xu,"MPNetForQuestionAnswering"),Xu.forEach(t),zl.forEach(t),Vi=h(o),We=s(o,"DIV",{class:!0});var vt=r(We);$(as.$$.fragment,vt),Up=h(vt),Wt=s(vt,"P",{});var Dr=r(Wt);Bp=i(Dr,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Fa=s(Dr,"CODE",{});var Ju=r(Fa);Vp=i(Ju,"span start logits"),Ju.forEach(t),Kp=i(Dr," and "),za=s(Dr,"CODE",{});var Gu=r(za);Xp=i(Gu,"span end logits"),Gu.forEach(t),Jp=i(Dr,")."),Dr.forEach(t),Gp=h(vt),is=s(vt,"P",{});var El=r(is);Yp=i(El,"This model inherits from "),br=s(El,"A",{href:!0});var Yu=r(br);Zp=i(Yu,"PreTrainedModel"),Yu.forEach(t),em=i(El,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ql.forEach(t),rm=h(vt),Ue=s(vt,"DIV",{class:!0});var Mt=r(Ue);$(cs.$$.fragment,Mt),am=h(Mt),Qt=s(Mt,"P",{});var Or=r(Qt);im=i(Or,"The "),vr=s(Or,"A",{href:!0});var eg=r(vr);lm=i(eg,"MPNetForQuestionAnswering"),eg.forEach(t),dm=i(Or," forward method, overrides the "),Ea=s(Or,"CODE",{});var tg=r(Ea);cm=i(tg,"__call__"),tg.forEach(t),pm=i(Or," special method."),Or.forEach(t),mm=h(Mt),$(xo.$$.fragment,Mt),hm=h(Mt),$(Co.$$.fragment,Mt),fm=h(Mt),$(jo.$$.fragment,Mt),Mt.forEach(t),vt.forEach(t),Ki=h(o),Ht=s(o,"H2",{class:!0});var xl=r(Ht);Ao=s(xl,"A",{id:!0,class:!0,href:!0});var og=r(Ao);qa=s(og,"SPAN",{});var ng=r(qa);$(ps.$$.fragment,ng),ng.forEach(t),og.forEach(t),um=h(xl),xa=s(xl,"SPAN",{});var sg=r(xa);gm=i(sg,"TFMPNetModel"),sg.forEach(t),xl.forEach(t),Xi=h(o),Ee=s(o,"DIV",{class:!0});var nt=r(Ee);$(ms.$$.fragment,nt),_m=h(nt),Ca=s(nt,"P",{});var rg=r(Ca);km=i(rg,"The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),rg.forEach(t),bm=h(nt),hs=s(nt,"P",{});var Cl=r(hs);vm=i(Cl,"This model inherits from "),Mr=s(Cl,"A",{href:!0});var ag=r(Mr);Mm=i(ag,"TFPreTrainedModel"),ag.forEach(t),$m=i(Cl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cl.forEach(t),Tm=h(nt),fs=s(nt,"P",{});var jl=r(fs);wm=i(jl,"This model is also a "),us=s(jl,"A",{href:!0,rel:!0});var ig=r(us);Pm=i(ig,"tf.keras.Model"),ig.forEach(t),Nm=i(jl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jl.forEach(t),ym=h(nt),$(Lo.$$.fragment,nt),Fm=h(nt),tt=s(nt,"DIV",{class:!0});var hn=r(tt);$(gs.$$.fragment,hn),zm=h(hn),Rt=s(hn,"P",{});var Wr=r(Rt);Em=i(Wr,"The "),$r=s(Wr,"A",{href:!0});var lg=r($r);qm=i(lg,"TFMPNetModel"),lg.forEach(t),xm=i(Wr," forward method, overrides the "),ja=s(Wr,"CODE",{});var dg=r(ja);Cm=i(dg,"__call__"),dg.forEach(t),jm=i(Wr," special method."),Wr.forEach(t),Am=h(hn),$(Io.$$.fragment,hn),Lm=h(hn),$(So.$$.fragment,hn),hn.forEach(t),nt.forEach(t),Ji=h(o),Ut=s(o,"H2",{class:!0});var Al=r(Ut);Do=s(Al,"A",{id:!0,class:!0,href:!0});var cg=r(Do);Aa=s(cg,"SPAN",{});var pg=r(Aa);$(_s.$$.fragment,pg),pg.forEach(t),cg.forEach(t),Im=h(Al),La=s(Al,"SPAN",{});var mg=r(La);Sm=i(mg,"TFMPNetForMaskedLM"),mg.forEach(t),Al.forEach(t),Gi=h(o),qe=s(o,"DIV",{class:!0});var st=r(qe);$(ks.$$.fragment,st),Dm=h(st),bs=s(st,"P",{});var Ll=r(bs);Om=i(Ll,"MPNet Model with a "),Ia=s(Ll,"CODE",{});var hg=r(Ia);Wm=i(hg,"language modeling"),hg.forEach(t),Qm=i(Ll," head on top."),Ll.forEach(t),Hm=h(st),vs=s(st,"P",{});var Il=r(vs);Rm=i(Il,"This model inherits from "),Tr=s(Il,"A",{href:!0});var fg=r(Tr);Um=i(fg,"TFPreTrainedModel"),fg.forEach(t),Bm=i(Il,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Il.forEach(t),Vm=h(st),Ms=s(st,"P",{});var Sl=r(Ms);Km=i(Sl,"This model is also a "),$s=s(Sl,"A",{href:!0,rel:!0});var ug=r($s);Xm=i(ug,"tf.keras.Model"),ug.forEach(t),Jm=i(Sl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sl.forEach(t),Gm=h(st),$(Oo.$$.fragment,st),Ym=h(st),Be=s(st,"DIV",{class:!0});var $t=r(Be);$(Ts.$$.fragment,$t),Zm=h($t),Bt=s($t,"P",{});var Qr=r(Bt);eh=i(Qr,"The "),wr=s(Qr,"A",{href:!0});var gg=r(wr);th=i(gg,"TFMPNetForMaskedLM"),gg.forEach(t),oh=i(Qr," forward method, overrides the "),Sa=s(Qr,"CODE",{});var _g=r(Sa);nh=i(_g,"__call__"),_g.forEach(t),sh=i(Qr," special method."),Qr.forEach(t),rh=h($t),$(Wo.$$.fragment,$t),ah=h($t),$(Qo.$$.fragment,$t),ih=h($t),$(Ho.$$.fragment,$t),$t.forEach(t),st.forEach(t),Yi=h(o),Vt=s(o,"H2",{class:!0});var Dl=r(Vt);Ro=s(Dl,"A",{id:!0,class:!0,href:!0});var kg=r(Ro);Da=s(kg,"SPAN",{});var bg=r(Da);$(ws.$$.fragment,bg),bg.forEach(t),kg.forEach(t),lh=h(Dl),Oa=s(Dl,"SPAN",{});var vg=r(Oa);dh=i(vg,"TFMPNetForSequenceClassification"),vg.forEach(t),Dl.forEach(t),Zi=h(o),xe=s(o,"DIV",{class:!0});var rt=r(xe);$(Ps.$$.fragment,rt),ch=h(rt),Wa=s(rt,"P",{});var Mg=r(Wa);ph=i(Mg,`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),Mg.forEach(t),mh=h(rt),Ns=s(rt,"P",{});var Ol=r(Ns);hh=i(Ol,"This model inherits from "),Pr=s(Ol,"A",{href:!0});var $g=r(Pr);fh=i($g,"TFPreTrainedModel"),$g.forEach(t),uh=i(Ol,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ol.forEach(t),gh=h(rt),ys=s(rt,"P",{});var Wl=r(ys);_h=i(Wl,"This model is also a "),Fs=s(Wl,"A",{href:!0,rel:!0});var Tg=r(Fs);kh=i(Tg,"tf.keras.Model"),Tg.forEach(t),bh=i(Wl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wl.forEach(t),vh=h(rt),$(Uo.$$.fragment,rt),Mh=h(rt),Ve=s(rt,"DIV",{class:!0});var Tt=r(Ve);$(zs.$$.fragment,Tt),$h=h(Tt),Kt=s(Tt,"P",{});var Hr=r(Kt);Th=i(Hr,"The "),Nr=s(Hr,"A",{href:!0});var wg=r(Nr);wh=i(wg,"TFMPNetForSequenceClassification"),wg.forEach(t),Ph=i(Hr," forward method, overrides the "),Qa=s(Hr,"CODE",{});var Pg=r(Qa);Nh=i(Pg,"__call__"),Pg.forEach(t),yh=i(Hr," special method."),Hr.forEach(t),Fh=h(Tt),$(Bo.$$.fragment,Tt),zh=h(Tt),$(Vo.$$.fragment,Tt),Eh=h(Tt),$(Ko.$$.fragment,Tt),Tt.forEach(t),rt.forEach(t),el=h(o),Xt=s(o,"H2",{class:!0});var Ql=r(Xt);Xo=s(Ql,"A",{id:!0,class:!0,href:!0});var Ng=r(Xo);Ha=s(Ng,"SPAN",{});var yg=r(Ha);$(Es.$$.fragment,yg),yg.forEach(t),Ng.forEach(t),qh=h(Ql),Ra=s(Ql,"SPAN",{});var Fg=r(Ra);xh=i(Fg,"TFMPNetForMultipleChoice"),Fg.forEach(t),Ql.forEach(t),tl=h(o),Ce=s(o,"DIV",{class:!0});var at=r(Ce);$(qs.$$.fragment,at),Ch=h(at),Ua=s(at,"P",{});var zg=r(Ua);jh=i(zg,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),zg.forEach(t),Ah=h(at),xs=s(at,"P",{});var Hl=r(xs);Lh=i(Hl,"This model inherits from "),yr=s(Hl,"A",{href:!0});var Eg=r(yr);Ih=i(Eg,"TFPreTrainedModel"),Eg.forEach(t),Sh=i(Hl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hl.forEach(t),Dh=h(at),Cs=s(at,"P",{});var Rl=r(Cs);Oh=i(Rl,"This model is also a "),js=s(Rl,"A",{href:!0,rel:!0});var qg=r(js);Wh=i(qg,"tf.keras.Model"),qg.forEach(t),Qh=i(Rl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rl.forEach(t),Hh=h(at),$(Jo.$$.fragment,at),Rh=h(at),ot=s(at,"DIV",{class:!0});var fn=r(ot);$(As.$$.fragment,fn),Uh=h(fn),Jt=s(fn,"P",{});var Rr=r(Jt);Bh=i(Rr,"The "),Fr=s(Rr,"A",{href:!0});var xg=r(Fr);Vh=i(xg,"TFMPNetForMultipleChoice"),xg.forEach(t),Kh=i(Rr," forward method, overrides the "),Ba=s(Rr,"CODE",{});var Cg=r(Ba);Xh=i(Cg,"__call__"),Cg.forEach(t),Jh=i(Rr," special method."),Rr.forEach(t),Gh=h(fn),$(Go.$$.fragment,fn),Yh=h(fn),$(Yo.$$.fragment,fn),fn.forEach(t),at.forEach(t),ol=h(o),Gt=s(o,"H2",{class:!0});var Ul=r(Gt);Zo=s(Ul,"A",{id:!0,class:!0,href:!0});var jg=r(Zo);Va=s(jg,"SPAN",{});var Ag=r(Va);$(Ls.$$.fragment,Ag),Ag.forEach(t),jg.forEach(t),Zh=h(Ul),Ka=s(Ul,"SPAN",{});var Lg=r(Ka);ef=i(Lg,"TFMPNetForTokenClassification"),Lg.forEach(t),Ul.forEach(t),nl=h(o),je=s(o,"DIV",{class:!0});var it=r(je);$(Is.$$.fragment,it),tf=h(it),Xa=s(it,"P",{});var Ig=r(Xa);of=i(Ig,`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Ig.forEach(t),nf=h(it),Ss=s(it,"P",{});var Bl=r(Ss);sf=i(Bl,"This model inherits from "),zr=s(Bl,"A",{href:!0});var Sg=r(zr);rf=i(Sg,"TFPreTrainedModel"),Sg.forEach(t),af=i(Bl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bl.forEach(t),lf=h(it),Ds=s(it,"P",{});var Vl=r(Ds);df=i(Vl,"This model is also a "),Os=s(Vl,"A",{href:!0,rel:!0});var Dg=r(Os);cf=i(Dg,"tf.keras.Model"),Dg.forEach(t),pf=i(Vl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vl.forEach(t),mf=h(it),$(en.$$.fragment,it),hf=h(it),Ke=s(it,"DIV",{class:!0});var wt=r(Ke);$(Ws.$$.fragment,wt),ff=h(wt),Yt=s(wt,"P",{});var Ur=r(Yt);uf=i(Ur,"The "),Er=s(Ur,"A",{href:!0});var Og=r(Er);gf=i(Og,"TFMPNetForTokenClassification"),Og.forEach(t),_f=i(Ur," forward method, overrides the "),Ja=s(Ur,"CODE",{});var Wg=r(Ja);kf=i(Wg,"__call__"),Wg.forEach(t),bf=i(Ur," special method."),Ur.forEach(t),vf=h(wt),$(tn.$$.fragment,wt),Mf=h(wt),$(on.$$.fragment,wt),$f=h(wt),$(nn.$$.fragment,wt),wt.forEach(t),it.forEach(t),sl=h(o),Zt=s(o,"H2",{class:!0});var Kl=r(Zt);sn=s(Kl,"A",{id:!0,class:!0,href:!0});var Qg=r(sn);Ga=s(Qg,"SPAN",{});var Hg=r(Ga);$(Qs.$$.fragment,Hg),Hg.forEach(t),Qg.forEach(t),Tf=h(Kl),Ya=s(Kl,"SPAN",{});var Rg=r(Ya);wf=i(Rg,"TFMPNetForQuestionAnswering"),Rg.forEach(t),Kl.forEach(t),rl=h(o),Ae=s(o,"DIV",{class:!0});var lt=r(Ae);$(Hs.$$.fragment,lt),Pf=h(lt),eo=s(lt,"P",{});var Br=r(eo);Nf=i(Br,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
