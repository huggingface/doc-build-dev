import{S as ta,i as oa,s as na,e as s,k as h,w as k,t as n,M as ra,c as a,d as o,m as p,a as i,x as T,h as r,b as l,F as e,g as m,y as w,q as y,o as $,B as E,v as sa,L as Qr}from"../../chunks/vendor-6b77c823.js";import{T as ea}from"../../chunks/Tip-39098574.js";import{D as Ve}from"../../chunks/Docstring-1088f2fb.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as kt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Kr}from"../../chunks/ExampleCodeBlock-5212b321.js";function aa(C){let u,v,_,f,b;return f=new Jt({props:{code:`from transformers import BertGenerationConfig, BertGenerationEncoder
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(d,g){m(d,u,g),e(u,v),e(u,_),e(_,f),e(u,b)},d(d){d&&o(u)}}}function da(C){let u,v,_,f,b;return f=new Jt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationEncoder
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){u=s("p"),v=n("Example:"),_=h(),k(f.$$.fragment)},l(d){u=a(d,"P",{});var g=i(u);v=r(g,"Example:"),g.forEach(o),_=p(d),T(f.$$.fragment,d)},m(d,g){m(d,u,g),e(u,v),m(d,_,g),w(f,d,g),b=!0},p:Qr,i(d){b||(y(f.$$.fragment,d),b=!0)},o(d){$(f.$$.fragment,d),b=!1},d(d){d&&o(u),d&&o(_),E(f,d)}}}function la(C){let u,v,_,f,b;return{c(){u=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=a(d,"P",{});var g=i(u);v=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(g,"CODE",{});var M=i(_);f=r(M,"Module"),M.forEach(o),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(d,g){m(d,u,g),e(u,v),e(u,_),e(_,f),e(u,b)},d(d){d&&o(u)}}}function ca(C){let u,v,_,f,b;return f=new Jt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationDecoder, BertGenerationConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("p"),v=n("Example:"),_=h(),k(f.$$.fragment)},l(d){u=a(d,"P",{});var g=i(u);v=r(g,"Example:"),g.forEach(o),_=p(d),T(f.$$.fragment,d)},m(d,g){m(d,u,g),e(u,v),m(d,_,g),w(f,d,g),b=!0},p:Qr,i(d){b||(y(f.$$.fragment,d),b=!0)},o(d){$(f.$$.fragment,d),b=!1},d(d){d&&o(u),d&&o(_),E(f,d)}}}function ha(C){let u,v,_,f,b,d,g,M,Co,Kt,O,Q,Tt,he,Do,wt,So,Qt,A,Mo,Je,Ao,No,pe,Lo,Fo,Xt,Ke,Oo,Yt,Qe,yt,Io,Zt,Xe,Ro,eo,Ye,ue,Wo,Ze,Uo,Ho,to,me,oo,et,fe,Vo,tt,Jo,Ko,no,ge,ro,ot,Qo,so,X,N,nt,Xo,Yo,rt,Zo,en,$t,tn,on,nn,Et,rn,ao,L,sn,_e,an,dn,be,ln,cn,io,I,Y,Bt,ve,hn,zt,pn,lo,P,ke,un,Te,mn,Gt,fn,gn,_n,R,bn,st,vn,kn,at,Tn,wn,yn,Z,co,W,ee,qt,we,$n,xt,En,ho,j,ye,Bn,$e,zn,Ee,Gn,qn,xn,Be,Pn,it,jn,Cn,Dn,dt,ze,po,U,te,Pt,Ge,Sn,jt,Mn,uo,B,qe,An,Ct,Nn,Ln,xe,Fn,lt,On,In,Rn,Pe,Wn,je,Un,Hn,Vn,Ce,Jn,De,Kn,Qn,Xn,H,Yn,ct,Zn,er,Se,tr,or,nr,z,rr,Dt,sr,ar,St,ir,dr,Mt,lr,cr,At,hr,pr,Nt,ur,mr,Lt,fr,gr,_r,D,Me,br,V,vr,ht,kr,Tr,Ft,wr,yr,$r,oe,Er,ne,mo,J,re,Ot,Ae,Br,It,zr,fo,q,Ne,Gr,Le,qr,Rt,xr,Pr,jr,Fe,Cr,pt,Dr,Sr,Mr,Oe,Ar,Ie,Nr,Lr,Fr,S,Re,Or,K,Ir,ut,Rr,Wr,Wt,Ur,Hr,Vr,se,Jr,ae,go;return d=new kt({}),he=new kt({}),me=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/bert_generation/configuration_bert_generation.py#L20"}}),Z=new Kr({props:{anchor:"transformers.BertGenerationConfig.example",$$slots:{default:[aa]},$$scope:{ctx:C}}}),we=new kt({}),ye=new Ve({props:{name:"class transformers.BertGenerationTokenizer",anchor:"transformers.BertGenerationTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"sep_token",val:" = '<::::>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BertGenerationTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/bert_generation/tokenization_bert_generation.py#L41"}}),ze=new Ve({props:{name:"save_vocabulary",anchor:"transformers.BertGenerationTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/bert_generation/tokenization_bert_generation.py#L155"}}),Ge=new kt({}),qe=new Ve({props:{name:"class transformers.BertGenerationEncoder",anchor:"transformers.BertGenerationEncoder",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BertGenerationEncoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16925/en/model_doc/bert-generation#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/bert_generation/modeling_bert_generation.py#L253"}}),Me=new Ve({props:{name:"forward",anchor:"transformers.BertGenerationEncoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BertGenerationEncoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16925/en/model_doc/bert-generation#transformers.BertGenerationConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/bert_generation/modeling_bert_generation.py#L461",returnDescription:`
<p>A <a
...
`}}),se=new ea({props:{$$slots:{default:[la]},$$scope:{ctx:C}}}),ae=new Kr({props:{anchor:"transformers.BertGenerationDecoder.forward.example",$$slots:{default:[ca]},$$scope:{ctx:C}}}),{c(){u=s("meta"),v=h(),_=s("h1"),f=s("a"),b=s("span"),k(d.$$.fragment),g=h(),M=s("span"),Co=n("BertGeneration"),Kt=h(),O=s("h2"),Q=s("a"),Tt=s("span"),k(he.$$.fragment),Do=h(),wt=s("span"),So=n("Overview"),Qt=h(),A=s("p"),Mo=n(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
found `),be=s("a"),ln=n("here"),cn=n("."),io=h(),I=s("h2"),Y=s("a"),Bt=s("span"),k(ve.$$.fragment),hn=h(),zt=s("span"),pn=n("BertGenerationConfig"),lo=h(),P=s("div"),k(ke.$$.fragment),un=h(),Te=s("p"),mn=n("This is the configuration class to store the configuration of a "),Gt=s("code"),fn=n("BertGenerationPreTrainedModel"),gn=n(`. It is used to
...
documentation from `),at=s("a"),Tn=n("PretrainedConfig"),wn=n(" for more information."),yn=h(),k(Z.$$.fragment),co=h(),W=s("h2"),ee=s("a"),qt=s("span"),k(we.$$.fragment),$n=h(),xt=s("span"),En=n("BertGenerationTokenizer"),ho=h(),j=s("div"),k(ye.$$.fragment),Bn=h(),$e=s("p"),zn=n("Construct a BertGeneration tokenizer. Based on "),Ee=s("a"),Gn=n("SentencePiece"),qn=n("."),xn=h(),Be=s("p"),Pn=n("This tokenizer inherits from "),it=s("a"),jn=n("PreTrainedTokenizer"),Cn=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Dn=h(),dt=s("div"),k(ze.$$.fragment),po=h(),U=s("h2"),te=s("a"),Pt=s("span"),k(Ge.$$.fragment),Sn=h(),jt=s("span"),Mn=n("BertGenerationEncoder"),uo=h(),B=s("div"),k(qe.$$.fragment),An=h(),Ct=s("p"),Nn=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Ln=h(),xe=s("p"),Fn=n("This model inherits from "),lt=s("a"),On=n("PreTrainedModel"),In=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rn=h(),Pe=s("p"),Wn=n("This model is also a PyTorch "),je=s("a"),Un=n("torch.nn.Module"),Hn=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vn=h(),Ce=s("p"),Jn=n(`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
...
`),At=s("code"),hr=n("add_cross_attention"),pr=n(" set to "),Nt=s("code"),ur=n("True"),mr=n("; an "),Lt=s("code"),fr=n("encoder_hidden_states"),gr=n(" is then expected as an input to the forward pass."),_r=h(),D=s("div"),k(Me.$$.fragment),br=h(),V=s("p"),vr=n("The "),ht=s("a"),kr=n("BertGenerationEncoder"),Tr=n(" forward method, overrides the "),Ft=s("code"),wr=n("__call__"),yr=n(" special method."),$r=h(),k(oe.$$.fragment),Er=h(),k(ne.$$.fragment),mo=h(),J=s("h2"),re=s("a"),Ot=s("span"),k(Ae.$$.fragment),Br=h(),It=s("span"),zr=n("BertGenerationDecoder"),fo=h(),q=s("div"),k(Ne.$$.fragment),Gr=h(),Le=s("p"),qr=n("BertGeneration Model with a "),Rt=s("code"),xr=n("language modeling"),Pr=n(" head on top for CLM fine-tuning."),jr=h(),Fe=s("p"),Cr=n("This model inherits from "),pt=s("a"),Dr=n("PreTrainedModel"),Sr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mr=h(),Oe=s("p"),Ar=n("This model is also a PyTorch "),Ie=s("a"),Nr=n("torch.nn.Module"),Lr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fr=h(),S=s("div"),k(Re.$$.fragment),Or=h(),K=s("p"),Ir=n("The "),ut=s("a"),Rr=n("BertGenerationDecoder"),Wr=n(" forward method, overrides the "),Wt=s("code"),Ur=n("__call__"),Hr=n(" special method."),Vr=h(),k(se.$$.fragment),Jr=h(),k(ae.$$.fragment),this.h()},l(t){const c=ra('[data-svelte="svelte-1phssyn"]',document.head);u=a(c,"META",{name:!0,content:!0}),c.forEach(o),v=p(t),_=a(t,"H1",{class:!0});var We=i(_);f=a(We,"A",{id:!0,class:!0,href:!0});var Ut=i(f);b=a(Ut,"SPAN",{});var Ht=i(b);T(d.$$.fragment,Ht),Ht.forEach(o),Ut.forEach(o),g=p(We),M=a(We,"SPAN",{});var Vt=i(M);Co=r(Vt,"BertGeneration"),Vt.forEach(o),We.forEach(o),Kt=p(t),O=a(t,"H2",{class:!0});var Ue=i(O);Q=a(Ue,"A",{id:!0,class:!0,href:!0});var Xr=i(Q);Tt=a(Xr,"SPAN",{});var Yr=i(Tt);T(he.$$.fragment,Yr),Yr.forEach(o),Xr.forEach(o),Do=p(Ue),wt=a(Ue,"SPAN",{});var Zr=i(wt);So=r(Zr,"Overview"),Zr.forEach(o),Ue.forEach(o),Qt=p(t),A=a(t,"P",{});var mt=i(A);Mo=r(mt,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
BERT checkpoints for subsequent fine-tuning.`),_o.forEach(o),as.forEach(o),to=p(t),T(me.$$.fragment,t),oo=p(t),et=a(t,"UL",{});var ds=i(et);fe=a(ds,"LI",{});var bo=i(fe);Vo=r(bo,"Pretrained "),tt=a(bo,"A",{href:!0});var ls=i(tt);Jo=r(ls,"EncoderDecoderModel"),ls.forEach(o),Ko=r(bo," are also directly available in the model hub, e.g.,"),bo.forEach(o),ds.forEach(o),no=p(t),T(ge.$$.fragment,t),ro=p(t),ot=a(t,"P",{});var cs=i(ot);Qo=r(cs,"Tips:"),cs.forEach(o),so=p(t),X=a(t,"UL",{});var vo=i(X);N=a(vo,"LI",{});var He=i(N);nt=a(He,"A",{href:!0});var hs=i(nt);Xo=r(hs,"BertGenerationEncoder"),hs.forEach(o),Yo=r(He," and "),rt=a(He,"A",{href:!0});var ps=i(rt);Zo=r(ps,"BertGenerationDecoder"),ps.forEach(o),en=r(He,` should be used in
...
found `),be=a(ft,"A",{href:!0,rel:!0});var gs=i(be);ln=r(gs,"here"),gs.forEach(o),cn=r(ft,"."),ft.forEach(o),io=p(t),I=a(t,"H2",{class:!0});var ko=i(I);Y=a(ko,"A",{id:!0,class:!0,href:!0});var _s=i(Y);Bt=a(_s,"SPAN",{});var bs=i(Bt);T(ve.$$.fragment,bs),bs.forEach(o),_s.forEach(o),hn=p(ko),zt=a(ko,"SPAN",{});var vs=i(zt);pn=r(vs,"BertGenerationConfig"),vs.forEach(o),ko.forEach(o),lo=p(t),P=a(t,"DIV",{class:!0});var ie=i(P);T(ke.$$.fragment,ie),un=p(ie),Te=a(ie,"P",{});var To=i(Te);mn=r(To,"This is the configuration class to store the configuration of a "),Gt=a(To,"CODE",{});var ks=i(Gt);fn=r(ks,"BertGenerationPreTrainedModel"),ks.forEach(o),gn=r(To,`. It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),To.forEach(o),_n=p(ie),R=a(ie,"P",{});var gt=i(R);bn=r(gt,"Configuration objects inherit from "),st=a(gt,"A",{href:!0});var Ts=i(st);vn=r(Ts,"PretrainedConfig"),Ts.forEach(o),kn=r(gt,` and can be used to control the model outputs. Read the
documentation from `),at=a(gt,"A",{href:!0});var ws=i(at);Tn=r(ws,"PretrainedConfig"),ws.forEach(o),wn=r(gt," for more information."),gt.forEach(o),yn=p(ie),T(Z.$$.fragment,ie),ie.forEach(o),co=p(t),W=a(t,"H2",{class:!0});var wo=i(W);ee=a(wo,"A",{id:!0,class:!0,href:!0});var ys=i(ee);qt=a(ys,"SPAN",{});var $s=i(qt);T(we.$$.fragment,$s),$s.forEach(o),ys.forEach(o),$n=p(wo),xt=a(wo,"SPAN",{});var Es=i(xt);En=r(Es,"BertGenerationTokenizer"),Es.forEach(o),wo.forEach(o),ho=p(t),j=a(t,"DIV",{class:!0});var de=i(j);T(ye.$$.fragment,de),Bn=p(de),$e=a(de,"P",{});var yo=i($e);zn=r(yo,"Construct a BertGeneration tokenizer. Based on "),Ee=a(yo,"A",{href:!0,rel:!0});var Bs=i(Ee);Gn=r(Bs,"SentencePiece"),Bs.forEach(o),qn=r(yo,"."),yo.forEach(o),xn=p(de),Be=a(de,"P",{});var $o=i(Be);Pn=r($o,"This tokenizer inherits from "),it=a($o,"A",{href:!0});var zs=i(it);jn=r(zs,"PreTrainedTokenizer"),zs.forEach(o),Cn=r($o,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),$o.forEach(o),Dn=p(de),dt=a(de,"DIV",{class:!0});var Gs=i(dt);T(ze.$$.fragment,Gs),Gs.forEach(o),de.forEach(o),po=p(t),U=a(t,"H2",{class:!0});var Eo=i(U);te=a(Eo,"A",{id:!0,class:!0,href:!0});var qs=i(te);Pt=a(qs,"SPAN",{});var xs=i(Pt);T(Ge.$$.fragment,xs),xs.forEach(o),qs.forEach(o),Sn=p(Eo),jt=a(Eo,"SPAN",{});var Ps=i(jt);Mn=r(Ps,"BertGenerationEncoder"),Ps.forEach(o),Eo.forEach(o),uo=p(t),B=a(t,"DIV",{class:!0});var G=i(B);T(qe.$$.fragment,G),An=p(G),Ct=a(G,"P",{});var js=i(Ct);Nn=r(js,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),js.forEach(o),Ln=p(G),xe=a(G,"P",{});var Bo=i(xe);Fn=r(Bo,"This model inherits from "),lt=a(Bo,"A",{href:!0});var Cs=i(lt);On=r(Cs,"PreTrainedModel"),Cs.forEach(o),In=r(Bo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bo.forEach(o),Rn=p(G),Pe=a(G,"P",{});var zo=i(Pe);Wn=r(zo,"This model is also a PyTorch "),je=a(zo,"A",{href:!0,rel:!0});var Ds=i(je);Un=r(Ds,"torch.nn.Module"),Ds.forEach(o),Hn=r(zo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zo.forEach(o),Vn=p(G),Ce=a(G,"P",{});var Go=i(Ce);Jn=r(Go,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
