...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L194",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L220",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L248",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Zs=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L305"}}),ea=new Me({}),ta=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L155",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L181",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L91"}}),La=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Wa=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),mi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Qi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),nl=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),V$=c(),sh=n("p"),J$=r("Finally, this model supports inherent JAX features such as:"),K$=c(),Qt=n("ul"),ah=n("li"),Di=n("a"),G$=r("Just-In-Time (JIT) compilation"),Y$=c(),rh=n("li"),Si=n("a"),Z$=r("Automatic Differentiation"),e2=c(),ih=n("li"),Wi=n("a"),t2=r("Vectorization"),o2=c(),lh=n("li"),Bi=n("a"),n2=r("Parallelization"),s2=c(),Ui=n("p"),a2=r("This class overrides "),Md=n("a"),r2=r("FlaxRobertaForTokenClassification"),i2=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),l2=c(),qt=n("div"),T(Qi.$$.fragment),d2=c(),Vo=n("p"),c2=r("The "),dh=n("code"),p2=r("FlaxRobertaPreTrainedModel"),h2=r(" forward method, overrides the "),ch=n("code"),m2=r("__call__"),u2=r(" special method."),f2=c(),T(vs.$$.fragment),g2=c(),T(Ts.$$.fragment),Dm=c(),Jo=n("h2"),ys=n("a"),ph=n("span"),T(Hi.$$.fragment),_2=c(),hh=n("span"),b2=r("FlaxXLMRobertaForQuestionAnswering"),Sm=c(),Pe=n("div"),T(Vi.$$.fragment),k2=c(),Ko=n("p"),v2=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),mh=n("code"),T2=r("span start logits"),y2=r(" and "),uh=n("code"),w2=r("span end logits"),$2=r(")."),M2=c(),Ji=n("p"),F2=r("This model inherits from "),Fd=n("a"),x2=r("FlaxPreTrainedModel"),R2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),L2=c(),Ki=n("p"),E2=r("This model is also a Flax Linen "),Gi=n("a"),z2=r("flax.linen.Module"),q2=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),C2=c(),fh=n("p"),j2=r("Finally, this model supports inherent JAX features such as:"),X2=c(),Ht=n("ul"),gh=n("li"),Yi=n("a"),P2=r("Just-In-Time (JIT) compilation"),A2=c(),_h=n("li"),Zi=n("a"),O2=r("Automatic Differentiation"),N2=c(),bh=n("li"),el=n("a"),I2=r("Vectorization"),D2=c(),kh=n("li"),tl=n("a"),S2=r("Parallelization"),W2=c(),ol=n("p"),B2=r("This class overrides "),xd=n("a"),U2=r("FlaxRobertaForQuestionAnswering"),Q2=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),H2=c(),Ct=n("div"),T(nl.$$.fragment),V2=c(),Go=n("p"),J2=r("The "),vh=n("code"),K2=r("FlaxRobertaPreTrainedModel"),G2=r(" forward method, overrides the "),Th=n("code"),Y2=r("__call__"),Z2=r(" special method."),eM=c(),T(ws.$$.fragment),tM=c(),T($s.$$.fragment),this.h()},l(o){const k=ER('[data-svelte="svelte-1phssyn"]',document.head);d=s(k,"META",{name:!0,content:!0}),k.forEach(t),g=p(o),h=s(o,"H1",{class:!0});var sl=a(h);m=s(sl,"A",{id:!0,class:!0,href:!0});var yh=a(m);_=s(yh,"SPAN",{});var wh=a(_);y(l.$$.fragment,wh),wh.forEach(t),yh.forEach(t),u=p(sl),R=s(sl,"SPAN",{});var $h=a(R);ue=i($h,"XLM-RoBERTa"),$h.forEach(t),sl.forEach(t),J=p(o),E=s(o,"H2",{class:!0});var al=a(E);Y=s(al,"A",{id:!0,class:!0,href:!0});var Mh=a(Y);D=s(Mh,"SPAN",{});var Fh=a(D);y(ee.$$.fragment,Fh),Fh.forEach(t),Mh.forEach(t),fe=p(al),S=s(al,"SPAN",{});var xh=a(S);ge=i(xh,"Overview"),xh.forEach(t),al.forEach(t),ce=p(o),V=s(o,"P",{});var rl=a(V);P=i(rl,"The XLM-RoBERTa model was proposed in "),te=s(rl,"A",{href:!0,rel:!0});var Rh=a(te);K=i(Rh,"Unsupervised Cross-lingual Representation Learning at Scale"),Rh.forEach(t),z=i(rl,` by Alexis Conneau, Kartikay Khandelwal, Naman Goyal, Vishrav Chaudhary, Guillaume
Wenzek, Francisco Guzm\xE1n, Edouard Grave, Myle Ott, Luke Zettlemoyer and Veselin Stoyanov. It is based on Facebook\u2019s
RoBERTa model released in 2019. It is a large multi-lingual language model, trained on 2.5TB of filtered CommonCrawl
...
not make use of token type ids, therefore a list of zeros is returned.`),Yh.forEach(t),bl.forEach(t),eg=p(et),Fl=s(et,"DIV",{class:!0});var Zh=a(Fl);y(Zs.$$.fragment,Zh),Zh.forEach(t),et.forEach(t),nm=p(o),lo=s(o,"H2",{class:!0});var kl=a(lo);nn=s(kl,"A",{id:!0,class:!0,href:!0});var sM=a(nn);lc=s(sM,"SPAN",{});var aM=a(lc);y(ea.$$.fragment,aM),aM.forEach(t),sM.forEach(t),tg=p(kl),dc=s(kl,"SPAN",{});var rM=a(dc);og=i(rM,"XLMRobertaTokenizerFast"),rM.forEach(t),kl.forEach(t),sm=p(o),at=s(o,"DIV",{class:!0});var Gt=a(at);y(ta.$$.fragment,Gt),ng=p(Gt),yt=s(Gt,"P",{});var Yt=a(yt);sg=i(Yt,"Construct a \u201Cfast\u201D XLM-RoBERTa tokenizer (backed by HuggingFace\u2019s "),cc=s(Yt,"EM",{});var iM=a(cc);ag=i(iM,"tokenizers"),iM.forEach(t),rg=i(Yt,` library). Adapted from
`),xl=s(Yt,"A",{href:!0});var lM=a(xl);ig=i(lM,"RobertaTokenizer"),lM.forEach(t),lg=i(Yt," and "),Rl=s(Yt,"A",{href:!0});var dM=a(Rl);dg=i(dM,"XLNetTokenizer"),dM.forEach(t),cg=i(Yt,`. Based on
`),oa=s(Yt,"A",{href:!0,rel:!0});var cM=a(oa);pg=i(cM,"BPE"),cM.forEach(t),hg=i(Yt,"."),Yt.forEach(t),mg=p(Gt),na=s(Gt,"P",{});var Bm=a(na);ug=i(Bm,"This tokenizer inherits from "),Ll=s(Bm,"A",{href:!0});var pM=a(Ll);fg=i(pM,"PreTrainedTokenizerFast"),pM.forEach(t),gg=i(Bm,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Bm.forEach(t),_g=p(Gt),Kt=s(Gt,"DIV",{class:!0});var Ed=a(Kt);y(sa.$$.fragment,Ed),bg=p(Ed),pc=s(Ed,"P",{});var hM=a(pc);kg=i(hM,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),hM.forEach(t),vg=p(Ed),aa=s(Ed,"UL",{});var Um=a(aa);El=s(Um,"LI",{});var oM=a(El);Tg=i(oM,"single sequence: "),hc=s(oM,"CODE",{});var mM=a(hc);yg=i(mM,"<s> X </s>"),mM.forEach(t),oM.forEach(t),wg=p(Um),zl=s(Um,"LI",{});var nM=a(zl);$g=i(nM,"pair of sequences: "),mc=s(nM,"CODE",{});var uM=a(mc);Mg=i(uM,"<s> A </s></s> B </s>"),uM.forEach(t),nM.forEach(t),Um.forEach(t),Ed.forEach(t),Fg=p(Gt),sn=s(Gt,"DIV",{class:!0});var Qm=a(sn);y(ra.$$.fragment,Qm),xg=p(Qm),uc=s(Qm,"P",{});var fM=a(uc);Rg=i(fM,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),fM.forEach(t),Qm.forEach(t),Gt.forEach(t),am=p(o),co=s(o,"H2",{class:!0});var Hm=a(co);an=s(Hm,"A",{id:!0,class:!0,href:!0});var gM=a(an);fc=s(gM,"SPAN",{});var _M=a(fc);y(ia.$$.fragment,_M),_M.forEach(t),gM.forEach(t),Lg=p(Hm),gc=s(Hm,"SPAN",{});var bM=a(gc);Eg=i(bM,"XLMRobertaModel"),bM.forEach(t),Hm.forEach(t),rm=p(o),He=s(o,"DIV",{class:!0});var jt=a(He);y(la.$$.fragment,jt),zg=p(jt),_c=s(jt,"P",{});var kM=a(_c);qg=i(kM,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),kM.forEach(t),Cg=p(jt),da=s(jt,"P",{});var Vm=a(da);jg=i(Vm,"This model inherits from "),ql=s(Vm,"A",{href:!0});var vM=a(ql);Xg=i(vM,"PreTrainedModel"),vM.forEach(t),Pg=i(Vm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vm.forEach(t),Ag=p(jt),ca=s(jt,"P",{});var Jm=a(ca);Og=i(Jm,"This model is also a PyTorch "),pa=s(Jm,"A",{href:!0,rel:!0});var TM=a(pa);Ng=i(TM,"torch.nn.Module"),TM.forEach(t),Ig=i(Jm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jm.forEach(t),Dg=p(jt),ha=s(jt,"P",{});var Km=a(ha);Sg=i(Km,"This class overrides "),Cl=s(Km,"A",{href:!0});var yM=a(Cl);Wg=i(yM,"RobertaModel"),yM.forEach(t),Bg=i(Km,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Km.forEach(t),Ug=p(jt),wt=s(jt,"DIV",{class:!0});var Ms=a(wt);y(ma.$$.fragment,Ms),Qg=p(Ms),po=s(Ms,"P",{});var zd=a(po);Hg=i(zd,"The "),jl=s(zd,"A",{href:!0});var wM=a(jl);Vg=i(wM,"RobertaModel"),wM.forEach(t),Jg=i(zd," forward method, overrides the "),bc=s(zd,"CODE",{});var $M=a(bc);Kg=i($M,"__call__"),$M.forEach(t),Gg=i(zd," special method."),zd.forEach(t),Yg=p(Ms),y(rn.$$.fragment,Ms),Zg=p(Ms),y(ln.$$.fragment,Ms),Ms.forEach(t),jt.forEach(t),im=p(o),ho=s(o,"H2",{class:!0});var Gm=a(ho);dn=s(Gm,"A",{id:!0,class:!0,href:!0});var MM=a(dn);kc=s(MM,"SPAN",{});var FM=a(kc);y(ua.$$.fragment,FM),FM.forEach(t),MM.forEach(t),e_=p(Gm),vc=s(Gm,"SPAN",{});var xM=a(vc);t_=i(xM,"XLMRobertaForCausalLM"),xM.forEach(t),Gm.forEach(t),lm=p(o),Ve=s(o,"DIV",{class:!0});var Xt=a(Ve);y(fa.$$.fragment,Xt),o_=p(Xt),ga=s(Xt,"P",{});var Ym=a(ga);n_=i(Ym,"XLM-RoBERTa Model with a "),Tc=s(Ym,"CODE",{});var RM=a(Tc);s_=i(RM,"language modeling"),RM.forEach(t),a_=i(Ym," head on top for CLM fine-tuning."),Ym.forEach(t),r_=p(Xt),_a=s(Xt,"P",{});var Zm=a(_a);i_=i(Zm,"This model inherits from "),Xl=s(Zm,"A",{href:!0});var LM=a(Xl);l_=i(LM,"PreTrainedModel"),LM.forEach(t),d_=i(Zm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zm.forEach(t),c_=p(Xt),ba=s(Xt,"P",{});var eu=a(ba);p_=i(eu,"This model is also a PyTorch "),ka=s(eu,"A",{href:!0,rel:!0});var EM=a(ka);h_=i(EM,"torch.nn.Module"),EM.forEach(t),m_=i(eu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eu.forEach(t),u_=p(Xt),va=s(Xt,"P",{});var tu=a(va);f_=i(tu,"This class overrides "),Pl=s(tu,"A",{href:!0});var zM=a(Pl);g_=i(zM,"RobertaForCausalLM"),zM.forEach(t),__=i(tu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),tu.forEach(t),b_=p(Xt),$t=s(Xt,"DIV",{class:!0});var Fs=a($t);y(Ta.$$.fragment,Fs),k_=p(Fs),mo=s(Fs,"P",{});var qd=a(mo);v_=i(qd,"The "),Al=s(qd,"A",{href:!0});var qM=a(Al);T_=i(qM,"RobertaForCausalLM"),qM.forEach(t),y_=i(qd," forward method, overrides the "),yc=s(qd,"CODE",{});var CM=a(yc);w_=i(CM,"__call__"),CM.forEach(t),$_=i(qd," special method."),qd.forEach(t),M_=p(Fs),y(cn.$$.fragment,Fs),F_=p(Fs),y(pn.$$.fragment,Fs),Fs.forEach(t),Xt.forEach(t),dm=p(o),uo=s(o,"H2",{class:!0});var ou=a(uo);hn=s(ou,"A",{id:!0,class:!0,href:!0});var jM=a(hn);wc=s(jM,"SPAN",{});var XM=a(wc);y(ya.$$.fragment,XM),XM.forEach(t),jM.forEach(t),x_=p(ou),$c=s(ou,"SPAN",{});var PM=a($c);R_=i(PM,"XLMRobertaForMaskedLM"),PM.forEach(t),ou.forEach(t),cm=p(o),Je=s(o,"DIV",{class:!0});var Pt=a(Je);y(wa.$$.fragment,Pt),L_=p(Pt),$a=s(Pt,"P",{});var nu=a($a);E_=i(nu,"XLM-RoBERTa Model with a "),Mc=s(nu,"CODE",{});var AM=a(Mc);z_=i(AM,"language modeling"),AM.forEach(t),q_=i(nu," head on top."),nu.forEach(t),C_=p(Pt),Ma=s(Pt,"P",{});var su=a(Ma);j_=i(su,"This model inherits from "),Ol=s(su,"A",{href:!0});var OM=a(Ol);X_=i(OM,"PreTrainedModel"),OM.forEach(t),P_=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),A_=p(Pt),Fa=s(Pt,"P",{});var au=a(Fa);O_=i(au,"This model is also a PyTorch "),xa=s(au,"A",{href:!0,rel:!0});var NM=a(xa);N_=i(NM,"torch.nn.Module"),NM.forEach(t),I_=i(au,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),au.forEach(t),D_=p(Pt),Ra=s(Pt,"P",{});var ru=a(Ra);S_=i(ru,"This class overrides "),Nl=s(ru,"A",{href:!0});var IM=a(Nl);W_=i(IM,"RobertaForMaskedLM"),IM.forEach(t),B_=i(ru,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),ru.forEach(t),U_=p(Pt),rt=s(Pt,"DIV",{class:!0});var Zt=a(rt);y(La.$$.fragment,Zt),Q_=p(Zt),fo=s(Zt,"P",{});var Cd=a(fo);H_=i(Cd,"The "),Il=s(Cd,"A",{href:!0});var DM=a(Il);V_=i(DM,"RobertaForMaskedLM"),DM.forEach(t),J_=i(Cd," forward method, overrides the "),Fc=s(Cd,"CODE",{});var SM=a(Fc);K_=i(SM,"__call__"),SM.forEach(t),G_=i(Cd," special method."),Cd.forEach(t),Y_=p(Zt),y(mn.$$.fragment,Zt),Z_=p(Zt),y(un.$$.fragment,Zt),eb=p(Zt),y(fn.$$.fragment,Zt),Zt.forEach(t),Pt.forEach(t),pm=p(o),go=s(o,"H2",{class:!0});var iu=a(go);gn=s(iu,"A",{id:!0,class:!0,href:!0});var WM=a(gn);xc=s(WM,"SPAN",{});var BM=a(xc);y(Ea.$$.fragment,BM),BM.forEach(t),WM.forEach(t),tb=p(iu),Rc=s(iu,"SPAN",{});var UM=a(Rc);ob=i(UM,"XLMRobertaForSequenceClassification"),UM.forEach(t),iu.forEach(t),hm=p(o),Ke=s(o,"DIV",{class:!0});var At=a(Ke);y(za.$$.fragment,At),nb=p(At),Lc=s(At,"P",{});var QM=a(Lc);sb=i(QM,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),QM.forEach(t),ab=p(At),qa=s(At,"P",{});var lu=a(qa);rb=i(lu,"This model inherits from "),Dl=s(lu,"A",{href:!0});var HM=a(Dl);ib=i(HM,"PreTrainedModel"),HM.forEach(t),lb=i(lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lu.forEach(t),db=p(At),Ca=s(At,"P",{});var du=a(Ca);cb=i(du,"This model is also a PyTorch "),ja=s(du,"A",{href:!0,rel:!0});var VM=a(ja);pb=i(VM,"torch.nn.Module"),VM.forEach(t),hb=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),mb=p(At),Xa=s(At,"P",{});var cu=a(Xa);ub=i(cu,"This class overrides "),Sl=s(cu,"A",{href:!0});var JM=a(Sl);fb=i(JM,"RobertaForSequenceClassification"),JM.forEach(t),gb=i(cu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),cu.forEach(t),_b=p(At),Qe=s(At,"DIV",{class:!0});var mt=a(Qe);y(Pa.$$.fragment,mt),bb=p(mt),_o=s(mt,"P",{});var jd=a(_o);kb=i(jd,"The "),Wl=s(jd,"A",{href:!0});var KM=a(Wl);vb=i(KM,"RobertaForSequenceClassification"),KM.forEach(t),Tb=i(jd," forward method, overrides the "),Ec=s(jd,"CODE",{});var GM=a(Ec);yb=i(GM,"__call__"),GM.forEach(t),wb=i(jd," special method."),jd.forEach(t),$b=p(mt),y(_n.$$.fragment,mt),Mb=p(mt),y(bn.$$.fragment,mt),Fb=p(mt),y(kn.$$.fragment,mt),xb=p(mt),y(vn.$$.fragment,mt),Rb=p(mt),y(Tn.$$.fragment,mt),mt.forEach(t),At.forEach(t),mm=p(o),bo=s(o,"H2",{class:!0});var pu=a(bo);yn=s(pu,"A",{id:!0,class:!0,href:!0});var YM=a(yn);zc=s(YM,"SPAN",{});var ZM=a(zc);y(Aa.$$.fragment,ZM),ZM.forEach(t),YM.forEach(t),Lb=p(pu),qc=s(pu,"SPAN",{});var eF=a(qc);Eb=i(eF,"XLMRobertaForMultipleChoice"),eF.forEach(t),pu.forEach(t),um=p(o),Ge=s(o,"DIV",{class:!0});var Ot=a(Ge);y(Oa.$$.fragment,Ot),zb=p(Ot),Cc=s(Ot,"P",{});var tF=a(Cc);qb=i(tF,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
alongside usage examples.`),yu.forEach(t),Qk=p(It),lt=s(It,"DIV",{class:!0});var to=a(lt);y(nr.$$.fragment,to),Hk=p(to),$o=s(to,"P",{});var Od=a($o);Vk=i(Od,"The "),Yl=s(Od,"A",{href:!0});var $F=a(Yl);Jk=i($F,"RobertaForQuestionAnswering"),$F.forEach(t),Kk=i(Od," forward method, overrides the "),Wc=s(Od,"CODE",{});var MF=a(Wc);Gk=i(MF,"__call__"),MF.forEach(t),Yk=i(Od," special method."),Od.forEach(t),Zk=p(to),y(En.$$.fragment,to),ev=p(to),y(zn.$$.fragment,to),tv=p(to),y(qn.$$.fragment,to),to.forEach(t),It.forEach(t),km=p(o),Mo=s(o,"H2",{class:!0});var wu=a(Mo);Cn=s(wu,"A",{id:!0,class:!0,href:!0});var FF=a(Cn);Bc=s(FF,"SPAN",{});var xF=a(Bc);y(sr.$$.fragment,xF),xF.forEach(t),FF.forEach(t),ov=p(wu),Uc=s(wu,"SPAN",{});var RF=a(Uc);nv=i(RF,"TFXLMRobertaModel"),RF.forEach(t),wu.forEach(t),vm=p(o),Oe=s(o,"DIV",{class:!0});var ut=a(Oe);y(ar.$$.fragment,ut),sv=p(ut),Qc=s(ut,"P",{});var LF=a(Qc);av=i(LF,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),LF.forEach(t),rv=p(ut),rr=s(ut,"P",{});var $u=a(rr);iv=i($u,"This model inherits from "),Zl=s($u,"A",{href:!0});var EF=a(Zl);lv=i(EF,"TFPreTrainedModel"),EF.forEach(t),dv=i($u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$u.forEach(t),cv=p(ut),ir=s(ut,"P",{});var Mu=a(ir);pv=i(Mu,"This model is also a "),lr=s(Mu,"A",{href:!0,rel:!0});var zF=a(lr);hv=i(zF,"tf.keras.Model"),zF.forEach(t),mv=i(Mu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mu.forEach(t),uv=p(ut),y(jn.$$.fragment,ut),fv=p(ut),dr=s(ut,"P",{});var Fu=a(dr);gv=i(Fu,"This class overrides "),ed=s(Fu,"A",{href:!0});var qF=a(ed);_v=i(qF,"TFRobertaModel"),qF.forEach(t),bv=i(Fu,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Fu.forEach(t),kv=p(ut),Ft=s(ut,"DIV",{class:!0});var Rs=a(Ft);y(cr.$$.fragment,Rs),vv=p(Rs),Fo=s(Rs,"P",{});var Nd=a(Fo);Tv=i(Nd,"The "),td=s(Nd,"A",{href:!0});var CF=a(td);yv=i(CF,"TFRobertaModel"),CF.forEach(t),wv=i(Nd," forward method, overrides the "),Hc=s(Nd,"CODE",{});var jF=a(Hc);$v=i(jF,"__call__"),jF.forEach(t),Mv=i(Nd," special method."),Nd.forEach(t),Fv=p(Rs),y(Xn.$$.fragment,Rs),xv=p(Rs),y(Pn.$$.fragment,Rs),Rs.forEach(t),ut.forEach(t),Tm=p(o),xo=s(o,"H2",{class:!0});var xu=a(xo);An=s(xu,"A",{id:!0,class:!0,href:!0});var XF=a(An);Vc=s(XF,"SPAN",{});var PF=a(Vc);y(pr.$$.fragment,PF),PF.forEach(t),XF.forEach(t),Rv=p(xu),Jc=s(xu,"SPAN",{});var AF=a(Jc);Lv=i(AF,"TFXLMRobertaForMaskedLM"),AF.forEach(t),xu.forEach(t),ym=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(hr.$$.fragment,ft),Ev=p(ft),mr=s(ft,"P",{});var Ru=a(mr);zv=i(Ru,"XLM-RoBERTa Model with a "),Kc=s(Ru,"CODE",{});var OF=a(Kc);qv=i(OF,"language modeling"),OF.forEach(t),Cv=i(Ru," head on top."),Ru.forEach(t),jv=p(ft),ur=s(ft,"P",{});var Lu=a(ur);Xv=i(Lu,"This model inherits from "),od=s(Lu,"A",{href:!0});var NF=a(od);Pv=i(NF,"TFPreTrainedModel"),NF.forEach(t),Av=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),Ov=p(ft),fr=s(ft,"P",{});var Eu=a(fr);Nv=i(Eu,"This model is also a "),gr=s(Eu,"A",{href:!0,rel:!0});var IF=a(gr);Iv=i(IF,"tf.keras.Model"),IF.forEach(t),Dv=i(Eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Eu.forEach(t),Sv=p(ft),y(On.$$.fragment,ft),Wv=p(ft),_r=s(ft,"P",{});var zu=a(_r);Bv=i(zu,"This class overrides "),nd=s(zu,"A",{href:!0});var DF=a(nd);Uv=i(DF,"TFRobertaForMaskedLM"),DF.forEach(t),Qv=i(zu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),zu.forEach(t),Hv=p(ft),dt=s(ft,"DIV",{class:!0});var oo=a(dt);y(br.$$.fragment,oo),Vv=p(oo),Ro=s(oo,"P",{});var Id=a(Ro);Jv=i(Id,"The "),sd=s(Id,"A",{href:!0});var SF=a(sd);Kv=i(SF,"TFRobertaForMaskedLM"),SF.forEach(t),Gv=i(Id," forward method, overrides the "),Gc=s(Id,"CODE",{});var WF=a(Gc);Yv=i(WF,"__call__"),WF.forEach(t),Zv=i(Id," special method."),Id.forEach(t),eT=p(oo),y(Nn.$$.fragment,oo),tT=p(oo),y(In.$$.fragment,oo),oT=p(oo),y(Dn.$$.fragment,oo),oo.forEach(t),ft.forEach(t),wm=p(o),Lo=s(o,"H2",{class:!0});var qu=a(Lo);Sn=s(qu,"A",{id:!0,class:!0,href:!0});var BF=a(Sn);Yc=s(BF,"SPAN",{});var UF=a(Yc);y(kr.$$.fragment,UF),UF.forEach(t),BF.forEach(t),nT=p(qu),Zc=s(qu,"SPAN",{});var QF=a(Zc);sT=i(QF,"TFXLMRobertaForSequenceClassification"),QF.forEach(t),qu.forEach(t),$m=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(vr.$$.fragment,gt),aT=p(gt),ep=s(gt,"P",{});var HF=a(ep);rT=i(HF,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),HF.forEach(t),iT=p(gt),Tr=s(gt,"P",{});var Cu=a(Tr);lT=i(Cu,"This model inherits from "),ad=s(Cu,"A",{href:!0});var VF=a(ad);dT=i(VF,"TFPreTrainedModel"),VF.forEach(t),cT=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),pT=p(gt),yr=s(gt,"P",{});var ju=a(yr);hT=i(ju,"This model is also a "),wr=s(ju,"A",{href:!0,rel:!0});var JF=a(wr);mT=i(JF,"tf.keras.Model"),JF.forEach(t),uT=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),fT=p(gt),y(Wn.$$.fragment,gt),gT=p(gt),$r=s(gt,"P",{});var Xu=a($r);_T=i(Xu,"This class overrides "),rd=s(Xu,"A",{href:!0});var KF=a(rd);bT=i(KF,"TFRobertaForSequenceClassification"),KF.forEach(t),kT=i(Xu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Xu.forEach(t),vT=p(gt),ct=s(gt,"DIV",{class:!0});var no=a(ct);y(Mr.$$.fragment,no),TT=p(no),Eo=s(no,"P",{});var Dd=a(Eo);yT=i(Dd,"The "),id=s(Dd,"A",{href:!0});var GF=a(id);wT=i(GF,"TFRobertaForSequenceClassification"),GF.forEach(t),$T=i(Dd," forward method, overrides the "),tp=s(Dd,"CODE",{});var YF=a(tp);MT=i(YF,"__call__"),YF.forEach(t),FT=i(Dd," special method."),Dd.forEach(t),xT=p(no),y(Bn.$$.fragment,no),RT=p(no),y(Un.$$.fragment,no),LT=p(no),y(Qn.$$.fragment,no),no.forEach(t),gt.forEach(t),Mm=p(o),zo=s(o,"H2",{class:!0});var Pu=a(zo);Hn=s(Pu,"A",{id:!0,class:!0,href:!0});var ZF=a(Hn);op=s(ZF,"SPAN",{});var e0=a(op);y(Fr.$$.fragment,e0),e0.forEach(t),ZF.forEach(t),ET=p(Pu),np=s(Pu,"SPAN",{});var t0=a(np);zT=i(t0,"TFXLMRobertaForMultipleChoice"),t0.forEach(t),Pu.forEach(t),Fm=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(xr.$$.fragment,_t),qT=p(_t),sp=s(_t,"P",{});var o0=a(sp);CT=i(o0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),o0.forEach(t),jT=p(_t),Rr=s(_t,"P",{});var Au=a(Rr);XT=i(Au,"This model inherits from "),ld=s(Au,"A",{href:!0});var n0=a(ld);PT=i(n0,"TFPreTrainedModel"),n0.forEach(t),AT=i(Au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Au.forEach(t),OT=p(_t),Lr=s(_t,"P",{});var Ou=a(Lr);NT=i(Ou,"This model is also a "),Er=s(Ou,"A",{href:!0,rel:!0});var s0=a(Er);IT=i(s0,"tf.keras.Model"),s0.forEach(t),DT=i(Ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ou.forEach(t),ST=p(_t),y(Vn.$$.fragment,_t),WT=p(_t),zr=s(_t,"P",{});var Nu=a(zr);BT=i(Nu,"This class overrides "),dd=s(Nu,"A",{href:!0});var a0=a(dd);UT=i(a0,"TFRobertaForMultipleChoice"),a0.forEach(t),QT=i(Nu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Nu.forEach(t),HT=p(_t),xt=s(_t,"DIV",{class:!0});var Ls=a(xt);y(qr.$$.fragment,Ls),VT=p(Ls),qo=s(Ls,"P",{});var Sd=a(qo);JT=i(Sd,"The "),cd=s(Sd,"A",{href:!0});var r0=a(cd);KT=i(r0,"TFRobertaForMultipleChoice"),r0.forEach(t),GT=i(Sd," forward method, overrides the "),ap=s(Sd,"CODE",{});var i0=a(ap);YT=i(i0,"__call__"),i0.forEach(t),ZT=i(Sd," special method."),Sd.forEach(t),e1=p(Ls),y(Jn.$$.fragment,Ls),t1=p(Ls),y(Kn.$$.fragment,Ls),Ls.forEach(t),_t.forEach(t),xm=p(o),Co=s(o,"H2",{class:!0});var Iu=a(Co);Gn=s(Iu,"A",{id:!0,class:!0,href:!0});var l0=a(Gn);rp=s(l0,"SPAN",{});var d0=a(rp);y(Cr.$$.fragment,d0),d0.forEach(t),l0.forEach(t),o1=p(Iu),ip=s(Iu,"SPAN",{});var c0=a(ip);n1=i(c0,"TFXLMRobertaForTokenClassification"),c0.forEach(t),Iu.forEach(t),Rm=p(o),Se=s(o,"DIV",{class:!0});var bt=a(Se);y(jr.$$.fragment,bt),s1=p(bt),lp=s(bt,"P",{});var p0=a(lp);a1=i(p0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),p0.forEach(t),r1=p(bt),Xr=s(bt,"P",{});var Du=a(Xr);i1=i(Du,"This model inherits from "),pd=s(Du,"A",{href:!0});var h0=a(pd);l1=i(h0,"TFPreTrainedModel"),h0.forEach(t),d1=i(Du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Du.forEach(t),c1=p(bt),Pr=s(bt,"P",{});var Su=a(Pr);p1=i(Su,"This model is also a "),Ar=s(Su,"A",{href:!0,rel:!0});var m0=a(Ar);h1=i(m0,"tf.keras.Model"),m0.forEach(t),m1=i(Su,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Su.forEach(t),u1=p(bt),y(Yn.$$.fragment,bt),f1=p(bt),Or=s(bt,"P",{});var Wu=a(Or);g1=i(Wu,"This class overrides "),hd=s(Wu,"A",{href:!0});var u0=a(hd);_1=i(u0,"TFRobertaForTokenClassification"),u0.forEach(t),b1=i(Wu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Wu.forEach(t),k1=p(bt),pt=s(bt,"DIV",{class:!0});var so=a(pt);y(Nr.$$.fragment,so),v1=p(so),jo=s(so,"P",{});var Wd=a(jo);T1=i(Wd,"The "),md=s(Wd,"A",{href:!0});var f0=a(md);y1=i(f0,"TFRobertaForTokenClassification"),f0.forEach(t),w1=i(Wd," forward method, overrides the "),dp=s(Wd,"CODE",{});var g0=a(dp);$1=i(g0,"__call__"),g0.forEach(t),M1=i(Wd," special method."),Wd.forEach(t),F1=p(so),y(Zn.$$.fragment,so),x1=p(so),y(es.$$.fragment,so),R1=p(so),y(ts.$$.fragment,so),so.forEach(t),bt.forEach(t),Lm=p(o),Xo=s(o,"H2",{class:!0});var Bu=a(Xo);os=s(Bu,"A",{id:!0,class:!0,href:!0});var _0=a(os);cp=s(_0,"SPAN",{});var b0=a(cp);y(Ir.$$.fragment,b0),b0.forEach(t),_0.forEach(t),L1=p(Bu),pp=s(Bu,"SPAN",{});var k0=a(pp);E1=i(k0,"TFXLMRobertaForQuestionAnswering"),k0.forEach(t),Bu.forEach(t),Em=p(o),We=s(o,"DIV",{class:!0});var kt=a(We);y(Dr.$$.fragment,kt),z1=p(kt),Po=s(kt,"P",{});var Bd=a(Po);q1=i(Bd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Bd,"CODE",{});var v0=a(hp);C1=i(v0,"span start logits"),v0.forEach(t),j1=i(Bd," and "),mp=s(Bd,"CODE",{});var T0=a(mp);X1=i(T0,"span end logits"),T0.forEach(t),P1=i(Bd,")."),Bd.forEach(t),A1=p(kt),Sr=s(kt,"P",{});var Uu=a(Sr);O1=i(Uu,"This model inherits from "),ud=s(Uu,"A",{href:!0});var y0=a(ud);N1=i(y0,"TFPreTrainedModel"),y0.forEach(t),I1=i(Uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uu.forEach(t),D1=p(kt),Wr=s(kt,"P",{});var Qu=a(Wr);S1=i(Qu,"This model is also a "),Br=s(Qu,"A",{href:!0,rel:!0});var w0=a(Br);W1=i(w0,"tf.keras.Model"),w0.forEach(t),B1=i(Qu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qu.forEach(t),U1=p(kt),y(ns.$$.fragment,kt),Q1=p(kt),Ur=s(kt,"P",{});var Hu=a(Ur);H1=i(Hu,"This class overrides "),up=s(Hu,"CODE",{});var $0=a(up);V1=i($0,"TFRobertaForQuestionAnsweringSimple"),$0.forEach(t),J1=i(Hu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Hu.forEach(t),K1=p(kt),ht=s(kt,"DIV",{class:!0});var ao=a(ht);y(Qr.$$.fragment,ao),G1=p(ao),Ao=s(ao,"P",{});var Ud=a(Ao);Y1=i(Ud,"The "),fd=s(Ud,"A",{href:!0});var M0=a(fd);Z1=i(M0,"TFRobertaForQuestionAnswering"),M0.forEach(t),ey=i(Ud," forward method, overrides the "),fp=s(Ud,"CODE",{});var F0=a(fp);ty=i(F0,"__call__"),F0.forEach(t),oy=i(Ud," special method."),Ud.forEach(t),ny=p(ao),y(ss.$$.fragment,ao),sy=p(ao),y(as.$$.fragment,ao),ay=p(ao),y(rs.$$.fragment,ao),ao.forEach(t),kt.forEach(t),zm=p(o),Oo=s(o,"H2",{class:!0});var Vu=a(Oo);is=s(Vu,"A",{id:!0,class:!0,href:!0});var x0=a(is);gp=s(x0,"SPAN",{});var R0=a(gp);y(Hr.$$.fragment,R0),R0.forEach(t),x0.forEach(t),ry=p(Vu),_p=s(Vu,"SPAN",{});var L0=a(_p);iy=i(L0,"FlaxXLMRobertaModel"),L0.forEach(t),Vu.forEach(t),qm=p(o),Be=s(o,"DIV",{class:!0});var vt=a(Be);y(Vr.$$.fragment,vt),ly=p(vt),Jr=s(vt,"P",{});var Ju=a(Jr);dy=i(Ju,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
