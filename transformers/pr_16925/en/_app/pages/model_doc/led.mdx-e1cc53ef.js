...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(u){k(l.$$.fragment,u)},m(u,m){w(l,u,m),b=!0},p:Pe,i(u){b||(y(l.$$.fragment,u),b=!0)},o(u){E(l.$$.fragment,u),b=!1},d(u){q(l,u)}}}function vf($){let l,b,u,m,v,i,f,D,je,fe,F,Z,W,oe,Ie,U,Ge,De,G,R,ne,we,C,A,_e,se,Fe,ge,V,Be,ze,O,Qe,Y,S,M,B,He,We,j,Ue,ae,ye;return{c(){l=n("p"),b=r("TF 2.0 models accepts two formats as inputs:"),u=c(),m=n("ul"),v=n("li"),i=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=n("li"),je=r("having all inputs as a list, tuple or dict in the first positional arguments."),fe=c(),F=n("p"),Z=r("This second option is useful when using "),W=n("code"),oe=r("tf.keras.Model.fit"),Ie=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),Ge=r("model(inputs)"),De=r("."),G=c(),R=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),we=c(),C=n("ul"),A=n("li"),_e=r("a single Tensor with "),se=n("code"),Fe=r("input_ids"),ge=r(" only and nothing else: "),V=n("code"),Be=r("model(input_ids)"),ze=c(),O=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
tensors in the first argument of the model call function: `),U=s(I,"CODE",{});var rt=a(U);Ge=d(rt,"model(inputs)"),rt.forEach(t),De=d(I,"."),I.forEach(t),G=h(L),R=s(L,"P",{});var xe=a(R);ne=d(xe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),xe.forEach(t),we=h(L),C=s(L,"UL",{});var K=a(C);A=s(K,"LI",{});var de=a(A);_e=d(de,"a single Tensor with "),se=s(de,"CODE",{});var Se=a(se);Fe=d(Se,"input_ids"),Se.forEach(t),ge=d(de," only and nothing else: "),V=s(de,"CODE",{});var dt=a(V);Be=d(dt,"model(input_ids)"),dt.forEach(t),de.forEach(t),ze=h(K),O=s(K,"LI",{});var ie=a(O);Qe=d(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=s(ie,"CODE",{});var it=a(Y);S=d(it,"model([input_ids, attention_mask])"),it.forEach(t),M=d(ie," or "),B=s(ie,"CODE",{});var le=a(B);He=d(le,"model([input_ids, attention_mask, token_type_ids])"),le.forEach(t),ie.forEach(t),We=h(K),j=s(K,"LI",{});var Re=a(j);Ue=d(Re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ae=s(Re,"CODE",{});var Ve=a(ae);ye=d(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),Re.forEach(t),K.forEach(t)},m(L,z){g(L,l,z),e(l,b),g(L,u,z),g(L,m,z),e(m,v),e(v,i),e(m,f),e(m,D),e(D,je),g(L,fe,z),g(L,F,z),e(F,Z),e(F,W),e(W,oe),e(F,Ie),e(F,U),e(U,Ge),e(F,De),g(L,G,z),g(L,R,z),e(R,ne),g(L,we,z),g(L,C,z),e(C,A),e(A,_e),e(A,se),e(se,Fe),e(A,ge),e(A,V),e(V,Be),e(C,ze),e(C,O),e(O,Qe),e(O,Y),e(Y,S),e(O,M),e(O,B),e(B,He),e(C,We),e(C,j),e(j,Ue),e(j,ae),e(ae,ye)},d(L){L&&t(l),L&&t(u),L&&t(m),L&&t(fe),L&&t(F),L&&t(G),L&&t(R),L&&t(we),L&&t(C)}}}function Tf($){let l,b,u,m,v;return{c(){l=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var D=a(u);m=d(D,"Module"),D.forEach(t),v=d(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),b=r("Example:"),u=c(),T(m.$$.fragment)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Example:"),f.forEach(t),u=h(i),k(m.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,u,f),w(m,i,f),v=!0},p:Pe,i(i){v||(y(m.$$.fragment,i),v=!0)},o(i){E(m.$$.fragment,i),v=!1},d(i){i&&t(l),i&&t(u),q(m,i)}}}function wf($){let l,b,u,m,v,i,f,D,je,fe,F,Z,W,oe,Ie,U,Ge,De,G,R,ne,we,C,A,_e,se,Fe,ge,V,Be,ze,O,Qe,Y,S,M,B,He,We,j,Ue,ae,ye;return{c(){l=n("p"),b=r("TF 2.0 models accepts two formats as inputs:"),u=c(),m=n("ul"),v=n("li"),i=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=n("li"),je=r("having all inputs as a list, tuple or dict in the first positional arguments."),fe=c(),F=n("p"),Z=r("This second option is useful when using "),W=n("code"),oe=r("tf.keras.Model.fit"),Ie=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),Ge=r("model(inputs)"),De=r("."),G=c(),R=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),we=c(),C=n("ul"),A=n("li"),_e=r("a single Tensor with "),se=n("code"),Fe=r("input_ids"),ge=r(" only and nothing else: "),V=n("code"),Be=r("model(input_ids)"),ze=c(),O=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=n("code"),S=r("model([input_ids, attention_mask])"),M=r(" or "),B=n("code"),He=r("model([input_ids, attention_mask, token_type_ids])"),We=c(),j=n("li"),Ue=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ae=n("code"),ye=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(L){l=s(L,"P",{});var z=a(l);b=d(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),u=h(L),m=s(L,"UL",{});var re=a(m);v=s(re,"LI",{});var nt=a(v);i=d(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(re),D=s(re,"LI",{});var st=a(D);je=d(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),re.forEach(t),fe=h(L),F=s(L,"P",{});var I=a(F);Z=d(I,"This second option is useful when using "),W=s(I,"CODE",{});var at=a(W);oe=d(at,"tf.keras.Model.fit"),at.forEach(t),Ie=d(I,` method which currently requires having all the
...
first positional argument :`),xe.forEach(t),we=h(L),C=s(L,"UL",{});var K=a(C);A=s(K,"LI",{});var de=a(A);_e=d(de,"a single Tensor with "),se=s(de,"CODE",{});var Se=a(se);Fe=d(Se,"input_ids"),Se.forEach(t),ge=d(de," only and nothing else: "),V=s(de,"CODE",{});var dt=a(V);Be=d(dt,"model(input_ids)"),dt.forEach(t),de.forEach(t),ze=h(K),O=s(K,"LI",{});var ie=a(O);Qe=d(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=s(ie,"CODE",{});var it=a(Y);S=d(it,"model([input_ids, attention_mask])"),it.forEach(t),M=d(ie," or "),B=s(ie,"CODE",{});var le=a(B);He=d(le,"model([input_ids, attention_mask, token_type_ids])"),le.forEach(t),ie.forEach(t),We=h(K),j=s(K,"LI",{});var Re=a(j);Ue=d(Re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ae=s(Re,"CODE",{});var Ve=a(ae);ye=d(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),Re.forEach(t),K.forEach(t)},m(L,z){g(L,l,z),e(l,b),g(L,u,z),g(L,m,z),e(m,v),e(v,i),e(m,f),e(m,D),e(D,je),g(L,fe,z),g(L,F,z),e(F,Z),e(F,W),e(W,oe),e(F,Ie),e(F,U),e(U,Ge),e(F,De),g(L,G,z),g(L,R,z),e(R,ne),g(L,we,z),g(L,C,z),e(C,A),e(A,_e),e(A,se),e(se,Fe),e(A,ge),e(A,V),e(V,Be),e(C,ze),e(C,O),e(O,Qe),e(O,Y),e(Y,S),e(O,M),e(O,B),e(B,He),e(C,We),e(C,j),e(j,Ue),e(j,ae),e(ae,ye)},d(L){L&&t(l),L&&t(u),L&&t(m),L&&t(fe),L&&t(F),L&&t(G),L&&t(R),L&&t(we),L&&t(C)}}}function yf($){let l,b,u,m,v;return{c(){l=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),m=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var D=a(u);m=d(D,"Module"),D.forEach(t),v=d(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=n("p"),b=r("Examples:"),u=c(),T(m.$$.fragment)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Examples:"),f.forEach(t),u=h(i),k(m.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,u,f),w(m,i,f),v=!0},p:Pe,i(i){v||(y(m.$$.fragment,i),v=!0)},o(i){E(m.$$.fragment,i),v=!1},d(i){i&&t(l),i&&t(u),q(m,i)}}}function qf($){let l,b,u,m,v,i,f,D,je,fe,F,Z,W,oe,Ie,U,Ge,De,G,R,ne,we,C,A,_e,se,Fe,ge,V,Be,ze,O,Qe,Y,S,M,B,He,We,j,Ue,ae,ye,L,z,re,nt,st,I,at,rt,xe,K,de,Se,dt,ie,it,le,Re,Ve,Nd,jd,As,Id,Gd,Bd,Ee,Qd,Ps,Hd,Wd,Ns,Ud,Rd,Zn,Vd,Kd,js,Xd,Jd,Zd,X,Yd,Is,ei,ti,Gs,oi,ni,Yn,si,ai,Bs,ri,di,Qs,ii,li,Hs,ci,hi,pi,lt,ui,Ws,mi,fi,Us,_i,gi,bi,So,vi,Mo,Ti,ki,wi,Co,yi,Oo,Ei,qi,vr,Pt,Li,Ao,$i,Di,Tr,ct,Nt,Rs,Po,Fi,Vs,zi,kr,P,No,xi,ht,Si,es,Mi,Ci,jo,Oi,Ai,Pi,pt,Ni,ts,ji,Ii,os,Gi,Bi,Qi,jt,Hi,Ks,Xs,Js,Zs,Wi,Ui,Ys,ea,ta,It,Gt,oa,Io,Ri,na,Vi,Ki,sa,aa,Go,Bt,Qt,ra,Bo,Xi,da,Ji,Zi,ia,Yi,el,la,ca,ha,Ht,Wt,pa,Qo,tl,ua,ol,wr,ut,Ut,ma,Ho,nl,fa,sl,yr,N,Wo,al,_a,rl,dl,Rt,ns,il,ll,ss,cl,hl,pl,Uo,ul,as,ml,fl,_l,Ke,Ro,gl,ga,bl,vl,Vo,rs,Tl,ba,kl,wl,ds,yl,va,El,ql,Vt,Ko,Ll,Xo,$l,Ta,Dl,Fl,zl,Kt,Jo,xl,ka,Sl,Ml,is,Zo,Er,mt,Xt,wa,Yo,Cl,ya,Ol,qr,qe,en,Al,tn,Pl,Ea,Nl,jl,Il,Jt,ls,Gl,Bl,cs,Ql,Hl,Wl,on,Ul,hs,Rl,Vl,Lr,ft,Zt,qa,nn,Kl,La,Xl,$r,_t,sn,Jl,$a,Zl,Dr,gt,an,Yl,Da,ec,Fr,bt,rn,tc,Fa,oc,zr,vt,dn,nc,za,sc,xr,Tt,ln,ac,xa,rc,Sr,kt,cn,dc,Sa,ic,Mr,wt,hn,lc,Ma,cc,Cr,yt,pn,hc,Ca,pc,Or,Et,Yt,Oa,un,uc,Aa,mc,Ar,Le,mn,fc,fn,_c,ps,gc,bc,vc,_n,Tc,gn,kc,wc,yc,Me,bn,Ec,qt,qc,us,Lc,$c,Pa,Dc,Fc,zc,eo,xc,to,Pr,Lt,oo,Na,vn,Sc,ja,Mc,Nr,$e,Tn,Cc,kn,Oc,ms,Ac,Pc,Nc,wn,jc,yn,Ic,Gc,Bc,be,En,Qc,$t,Hc,fs,Wc,Uc,Ia,Rc,Vc,Kc,no,Xc,so,Jc,ao,jr,Dt,ro,Ga,qn,Zc,Ba,Yc,Ir,ce,Ln,eh,Qa,th,oh,$n,nh,_s,sh,ah,rh,Dn,dh,Fn,ih,lh,ch,Q,zn,hh,Ft,ph,gs,uh,mh,Ha,fh,_h,gh,io,bh,lo,vh,co,Th,ho,kh,po,Gr,zt,uo,Wa,xn,wh,Ua,yh,Br,he,Sn,Eh,xt,qh,Ra,Lh,$h,Va,Dh,Fh,zh,Mn,xh,bs,Sh,Mh,Ch,Cn,Oh,On,Ah,Ph,Nh,ve,An,jh,St,Ih,vs,Gh,Bh,Ka,Qh,Hh,Wh,mo,Uh,fo,Rh,_o,Qr,Mt,go,Xa,Pn,Vh,Ja,Kh,Hr,pe,Nn,Xh,jn,Jh,Ts,Zh,Yh,ep,In,tp,Gn,op,np,sp,bo,ap,Ce,Bn,rp,Ct,dp,ks,ip,lp,Za,cp,hp,pp,vo,up,To,Wr,Ot,ko,Ya,Qn,mp,er,fp,Ur,ue,Hn,_p,Wn,gp,ws,bp,vp,Tp,Un,kp,Rn,wp,yp,Ep,wo,qp,Oe,Vn,Lp,At,$p,ys,Dp,Fp,tr,zp,xp,Sp,yo,Mp,Eo,Rr;return i=new me({}),oe=new me({}),Po=new me({}),No=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/configuration_led.py#L31"}}),jt=new Ae({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[sf]},$$scope:{ctx:$}}}),Io=new me({}),Bo=new me({}),Qo=new me({}),Ho=new me({}),Wo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/tokenization_led.py#L43"}}),Ro=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_tf_led.py#L1373"}}),pn=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_tf_led.py#L1441"}}),un=new me({}),mn=new x({props:{name:"class transformers.LEDModel",anchor:"transformers.LEDModel",parameters:[{name:"config",val:": LEDConfig"}],parametersDescription:[{anchor:"transformers.LEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16925/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_led.py#L2154"}}),bn=new x({props:{name:"forward",anchor:"transformers.LEDModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.LEDModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16925/en/model_doc/led#transformers.LEDConfig"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_led.py#L2277"}}),En=new x({props:{name:"forward",anchor:"transformers.LEDForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_led.py#L2321",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_led.py#L2481",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_led.py#L2608",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_tf_led.py#L2268",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_tf_led.py#L2363"}}),wo=new xo({props:{$$slots:{default:[wf]},$$scope:{ctx:$}}}),Vn=new x({props:{name:"call",anchor:"transformers.TFLEDForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/led/modeling_tf_led.py#L2396",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
`),Se=n("a"),dt=r("BartTokenizer"),ie=r("."),it=c(),le=n("li"),Re=r("LED works very well on long-range "),Ve=n("em"),Nd=r("sequence-to-sequence"),jd=r(" tasks where the "),As=n("code"),Id=r("input_ids"),Gd=r(` largely exceed a length of
1024 tokens.`),Bd=c(),Ee=n("li"),Qd=r("LED pads the "),Ps=n("code"),Hd=r("input_ids"),Wd=r(" to be a multiple of "),Ns=n("code"),Ud=r("config.attention_window"),Rd=r(` if required. Therefore a small speed-up is
gained, when `),Zn=n("a"),Vd=r("LEDTokenizer"),Kd=r(" is used with the "),js=n("code"),Xd=r("pad_to_multiple_of"),Jd=r(" argument."),Zd=c(),X=n("li"),Yd=r("LED makes use of "),Is=n("em"),ei=r("global attention"),ti=r(" by means of the "),Gs=n("code"),oi=r("global_attention_mask"),ni=r(` (see
...
`),Us=n("code"),_i=r("model.gradient_checkpointing_enable()"),gi=r("."),bi=c(),So=n("li"),vi=r("A notebook showing how to evaluate LED, can be accessed "),Mo=n("a"),Ti=r("here"),ki=r("."),wi=c(),Co=n("li"),yi=r("A notebook showing how to fine-tune LED, can be accessed "),Oo=n("a"),Ei=r("here"),qi=r("."),vr=c(),Pt=n("p"),Li=r("This model was contributed by "),Ao=n("a"),$i=r("patrickvonplaten"),Di=r("."),Tr=c(),ct=n("h2"),Nt=n("a"),Rs=n("span"),T(Po.$$.fragment),Fi=c(),Vs=n("span"),zi=r("LEDConfig"),kr=c(),P=n("div"),T(No.$$.fragment),xi=c(),ht=n("p"),Si=r("This is the configuration class to store the configuration of a "),es=n("a"),Mi=r("LEDModel"),Ci=r(`. It is used to instantiate an LED
...
on top of the hidden-states output to compute `),Ra=n("code"),Lh=r("span start logits"),$h=r(" and "),Va=n("code"),Dh=r("span end logits"),Fh=r(")."),zh=c(),Mn=n("p"),xh=r("This model inherits from "),bs=n("a"),Sh=r("PreTrainedModel"),Mh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ch=c(),Cn=n("p"),Oh=r("This model is also a PyTorch "),On=n("a"),Ah=r("torch.nn.Module"),Ph=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nh=c(),ve=n("div"),T(An.$$.fragment),jh=c(),St=n("p"),Ih=r("The "),vs=n("a"),Gh=r("LEDForQuestionAnswering"),Bh=r(" forward method, overrides the "),Ka=n("code"),Qh=r("__call__"),Hh=r(" special method."),Wh=c(),T(mo.$$.fragment),Uh=c(),T(fo.$$.fragment),Rh=c(),T(_o.$$.fragment),Qr=c(),Mt=n("h2"),go=n("a"),Xa=n("span"),T(Pn.$$.fragment),Vh=c(),Ja=n("span"),Kh=r("TFLEDModel"),Hr=c(),pe=n("div"),T(Nn.$$.fragment),Xh=c(),jn=n("p"),Jh=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp=c(),Un=n("p"),kp=r("This model is also a "),Rn=n("a"),wp=r("tf.keras.Model"),yp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ep=c(),T(wo.$$.fragment),qp=c(),Oe=n("div"),T(Vn.$$.fragment),Lp=c(),At=n("p"),$p=r("The "),ys=n("a"),Dp=r("TFLEDForConditionalGeneration"),Fp=r(" forward method, overrides the "),tr=n("code"),zp=r("__call__"),xp=r(" special method."),Sp=c(),T(yo.$$.fragment),Mp=c(),T(Eo.$$.fragment),this.h()},l(o){const _=of('[data-svelte="svelte-1phssyn"]',document.head);l=s(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),u=s(o,"H1",{class:!0});var Kn=a(u);m=s(Kn,"A",{id:!0,class:!0,href:!0});var or=a(m);v=s(or,"SPAN",{});var nr=a(v);k(i.$$.fragment,nr),nr.forEach(t),or.forEach(t),f=h(Kn),D=s(Kn,"SPAN",{});var sr=a(D);je=d(sr,"LED"),sr.forEach(t),Kn.forEach(t),fe=h(o),F=s(o,"H2",{class:!0});var Xn=a(F);Z=s(Xn,"A",{id:!0,class:!0,href:!0});var ar=a(Z);W=s(ar,"SPAN",{});var rr=a(W);k(oe.$$.fragment,rr),rr.forEach(t),ar.forEach(t),Ie=h(Xn),U=s(Xn,"SPAN",{});var dr=a(U);Ge=d(dr,"Overview"),dr.forEach(t),Xn.forEach(t),De=h(o),G=s(o,"P",{});var Jn=a(G);R=d(Jn,"The LED model was proposed in "),ne=s(Jn,"A",{href:!0,rel:!0});var ir=a(ne);we=d(ir,"Longformer: The Long-Document Transformer"),ir.forEach(t),C=d(Jn,` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),Jn.forEach(t),A=h(o),_e=s(o,"P",{});var lr=a(_e);se=d(lr,"The abstract from the paper is the following:"),lr.forEach(t),Fe=h(o),ge=s(o,"P",{});var cr=a(ge);V=s(cr,"EM",{});var hr=a(V);Be=d(hr,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
`),Se=s(H,"A",{href:!0});var Np=a(Se);dt=d(Np,"BartTokenizer"),Np.forEach(t),ie=d(H,"."),H.forEach(t),it=h(J),le=s(J,"LI",{});var Es=a(le);Re=d(Es,"LED works very well on long-range "),Ve=s(Es,"EM",{});var jp=a(Ve);Nd=d(jp,"sequence-to-sequence"),jp.forEach(t),jd=d(Es," tasks where the "),As=s(Es,"CODE",{});var Ip=a(As);Id=d(Ip,"input_ids"),Ip.forEach(t),Gd=d(Es,` largely exceed a length of
1024 tokens.`),Es.forEach(t),Bd=h(J),Ee=s(J,"LI",{});var Xe=a(Ee);Qd=d(Xe,"LED pads the "),Ps=s(Xe,"CODE",{});var Gp=a(Ps);Hd=d(Gp,"input_ids"),Gp.forEach(t),Wd=d(Xe," to be a multiple of "),Ns=s(Xe,"CODE",{});var Bp=a(Ns);Ud=d(Bp,"config.attention_window"),Bp.forEach(t),Rd=d(Xe,` if required. Therefore a small speed-up is
gained, when `),Zn=s(Xe,"A",{href:!0});var Qp=a(Zn);Vd=d(Qp,"LEDTokenizer"),Qp.forEach(t),Kd=d(Xe," is used with the "),js=s(Xe,"CODE",{});var Hp=a(js);Xd=d(Hp,"pad_to_multiple_of"),Hp.forEach(t),Jd=d(Xe," argument."),Xe.forEach(t),Zd=h(J),X=s(J,"LI",{});var Te=a(X);Yd=d(Te,"LED makes use of "),Is=s(Te,"EM",{});var Wp=a(Is);ei=d(Wp,"global attention"),Wp.forEach(t),ti=d(Te," by means of the "),Gs=s(Te,"CODE",{});var Up=a(Gs);oi=d(Up,"global_attention_mask"),Up.forEach(t),ni=d(Te,` (see
`),Yn=s(Te,"A",{href:!0});var Rp=a(Yn);si=d(Rp,"LongformerModel"),Rp.forEach(t),ai=d(Te,"). For summarization, it is advised to put "),Bs=s(Te,"EM",{});var Vp=a(Bs);ri=d(Vp,"global attention"),Vp.forEach(t),di=d(Te,` only on the first
...
`),Us=s(qs,"CODE",{});var Zp=a(Us);_i=d(Zp,"model.gradient_checkpointing_enable()"),Zp.forEach(t),gi=d(qs,"."),qs.forEach(t),bi=h(J),So=s(J,"LI",{});var Vr=a(So);vi=d(Vr,"A notebook showing how to evaluate LED, can be accessed "),Mo=s(Vr,"A",{href:!0,rel:!0});var Yp=a(Mo);Ti=d(Yp,"here"),Yp.forEach(t),ki=d(Vr,"."),Vr.forEach(t),wi=h(J),Co=s(J,"LI",{});var Kr=a(Co);yi=d(Kr,"A notebook showing how to fine-tune LED, can be accessed "),Oo=s(Kr,"A",{href:!0,rel:!0});var eu=a(Oo);Ei=d(eu,"here"),eu.forEach(t),qi=d(Kr,"."),Kr.forEach(t),J.forEach(t),vr=h(o),Pt=s(o,"P",{});var Xr=a(Pt);Li=d(Xr,"This model was contributed by "),Ao=s(Xr,"A",{href:!0,rel:!0});var tu=a(Ao);$i=d(tu,"patrickvonplaten"),tu.forEach(t),Di=d(Xr,"."),Xr.forEach(t),Tr=h(o),ct=s(o,"H2",{class:!0});var Jr=a(ct);Nt=s(Jr,"A",{id:!0,class:!0,href:!0});var ou=a(Nt);Rs=s(ou,"SPAN",{});var nu=a(Rs);k(Po.$$.fragment,nu),nu.forEach(t),ou.forEach(t),Fi=h(Jr),Vs=s(Jr,"SPAN",{});var su=a(Vs);zi=d(su,"LEDConfig"),su.forEach(t),Jr.forEach(t),kr=h(o),P=s(o,"DIV",{class:!0});var ee=a(P);k(No.$$.fragment,ee),xi=h(ee),ht=s(ee,"P",{});var Ls=a(ht);Si=d(Ls,"This is the configuration class to store the configuration of a "),es=s(Ls,"A",{href:!0});var au=a(es);Mi=d(au,"LEDModel"),au.forEach(t),Ci=d(Ls,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
...
on top of the hidden-states output to compute `),Ra=s(Ss,"CODE",{});var Mm=a(Ra);Lh=d(Mm,"span start logits"),Mm.forEach(t),$h=d(Ss," and "),Va=s(Ss,"CODE",{});var Cm=a(Va);Dh=d(Cm,"span end logits"),Cm.forEach(t),Fh=d(Ss,")."),Ss.forEach(t),zh=h(Ye),Mn=s(Ye,"P",{});var zd=a(Mn);xh=d(zd,"This model inherits from "),bs=s(zd,"A",{href:!0});var Om=a(bs);Sh=d(Om,"PreTrainedModel"),Om.forEach(t),Mh=d(zd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
