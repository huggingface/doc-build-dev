...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16925/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_distilbert.py#L627",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_distilbert.py#L725",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_distilbert.py#L1053",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_distilbert.py#L958",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_distilbert.py#L841",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_tf_distilbert.py#L543",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_tf_distilbert.py#L658",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_tf_distilbert.py#L759",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_tf_distilbert.py#L959",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_tf_distilbert.py#L854",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1086",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ih.forEach(t),p_=h($t),$($o.$$.fragment,$t),h_=h($t),ft=n($t,"DIV",{class:!0});var bn=r(ft);$(Cr.$$.fragment,bn),u_=h(bn),bs=n(bn,"P",{});var kl=r(bs);f_=i(kl,"The "),Ji=n(kl,"A",{href:!0});var m1=r(Ji);m_=i(m1,"TFDistilBertModel"),m1.forEach(t),g_=i(kl," forward method, overrides the "),md=n(kl,"CODE",{});var g1=r(md);__=i(g1,"__call__"),g1.forEach(t),b_=i(kl," special method."),kl.forEach(t),k_=h(bn),$(wo.$$.fragment,bn),v_=h(bn),$(yo.$$.fragment,bn),bn.forEach(t),$t.forEach(t),Jp=h(s),ks=n(s,"H2",{class:!0});var Wh=r(ks);Fo=n(Wh,"A",{id:!0,class:!0,href:!0});var _1=r(Fo);gd=n(_1,"SPAN",{});var b1=r(gd);$(qr.$$.fragment,b1),b1.forEach(t),_1.forEach(t),T_=h(Wh),_d=n(Wh,"SPAN",{});var k1=r(_d);$_=i(k1,"TFDistilBertForMaskedLM"),k1.forEach(t),Wh.forEach(t),Gp=h(s),Oe=n(s,"DIV",{class:!0});var wt=r(Oe);$(Pr.$$.fragment,wt),w_=h(wt),Ar=n(wt,"P",{});var Qh=r(Ar);y_=i(Qh,"DistilBert Model with a "),bd=n(Qh,"CODE",{});var v1=r(bd);F_=i(v1,"masked language modeling"),v1.forEach(t),D_=i(Qh," head on top."),Qh.forEach(t),x_=h(wt),Or=n(wt,"P",{});var Rh=r(Or);B_=i(Rh,"This model inherits from "),Gi=n(Rh,"A",{href:!0});var T1=r(Gi);M_=i(T1,"TFPreTrainedModel"),T1.forEach(t),E_=i(Rh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uh.forEach(t),P_=h(wt),$(Do.$$.fragment,wt),A_=h(wt),Xe=n(wt,"DIV",{class:!0});var Gt=r(Xe);$(Sr.$$.fragment,Gt),O_=h(Gt),vs=n(Gt,"P",{});var vl=r(vs);N_=i(vl,"The "),Xi=n(vl,"A",{href:!0});var w1=r(Xi);L_=i(w1,"TFDistilBertForMaskedLM"),w1.forEach(t),S_=i(vl," forward method, overrides the "),kd=n(vl,"CODE",{});var y1=r(kd);I_=i(y1,"__call__"),y1.forEach(t),W_=i(vl," special method."),vl.forEach(t),Q_=h(Gt),$(xo.$$.fragment,Gt),R_=h(Gt),$(Bo.$$.fragment,Gt),U_=h(Gt),$(Mo.$$.fragment,Gt),Gt.forEach(t),wt.forEach(t),Xp=h(s),Ts=n(s,"H2",{class:!0});var Hh=r(Ts);Eo=n(Hh,"A",{id:!0,class:!0,href:!0});var F1=r(Eo);vd=n(F1,"SPAN",{});var D1=r(vd);$(Ir.$$.fragment,D1),D1.forEach(t),F1.forEach(t),H_=h(Hh),Td=n(Hh,"SPAN",{});var x1=r(Td);K_=i(x1,"TFDistilBertForSequenceClassification"),x1.forEach(t),Hh.forEach(t),Yp=h(s),Ne=n(s,"DIV",{class:!0});var yt=r(Ne);$(Wr.$$.fragment,yt),V_=h(yt),$d=n(yt,"P",{});var B1=r($d);J_=i(B1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
a softmax) e.g. for RocStories/SWAG tasks.`),A1.forEach(t),kb=h(Ft),Jr=n(Ft,"P",{});var Gh=r(Jr);vb=i(Gh,"This model inherits from "),el=n(Gh,"A",{href:!0});var O1=r(el);Tb=i(O1,"TFPreTrainedModel"),O1.forEach(t),$b=i(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),xb=h(Ft),$(Ao.$$.fragment,Ft),Bb=h(Ft),mt=n(Ft,"DIV",{class:!0});var kn=r(mt);$(Yr.$$.fragment,kn),Mb=h(kn),ys=n(kn,"P",{});var $l=r(ys);Eb=i($l,"The "),tl=n($l,"A",{href:!0});var L1=r(tl);zb=i(L1,"TFDistilBertForMultipleChoice"),L1.forEach(t),jb=i($l," forward method, overrides the "),xd=n($l,"CODE",{});var S1=r(xd);Cb=i(S1,"__call__"),S1.forEach(t),qb=i($l," special method."),$l.forEach(t),Pb=h(kn),$(Oo.$$.fragment,kn),Ab=h(kn),$(No.$$.fragment,kn),kn.forEach(t),Ft.forEach(t),th=h(s),Fs=n(s,"H2",{class:!0});var Yh=r(Fs);Lo=n(Yh,"A",{id:!0,class:!0,href:!0});var I1=r(Lo);Bd=n(I1,"SPAN",{});var W1=r(Bd);$(Zr.$$.fragment,W1),W1.forEach(t),I1.forEach(t),Ob=h(Yh),Md=n(Yh,"SPAN",{});var Q1=r(Md);Nb=i(Q1,"TFDistilBertForTokenClassification"),Q1.forEach(t),Yh.forEach(t),sh=h(s),Se=n(s,"DIV",{class:!0});var Dt=r(Se);$(ea.$$.fragment,Dt),Lb=h(Dt),Ed=n(Dt,"P",{});var R1=r(Ed);Sb=i(R1,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jb=h(Dt),$(So.$$.fragment,Dt),Gb=h(Dt),Ze=n(Dt,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xb=h(Yt),Ds=n(Yt,"P",{});var wl=r(Ds);Yb=i(wl,"The "),ol=n(wl,"A",{href:!0});var K1=r(ol);Zb=i(K1,"TFDistilBertForTokenClassification"),K1.forEach(t),ek=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var V1=r(zd);tk=i(V1,"__call__"),V1.forEach(t),sk=i(wl," special method."),wl.forEach(t),ok=h(Yt),$(Io.$$.fragment,Yt),nk=h(Yt),$(Wo.$$.fragment,Yt),rk=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),oh=h(s),xs=n(s,"H2",{class:!0});var tu=r(xs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var J1=r(Ro);jd=n(J1,"SPAN",{});var G1=r(jd);$(ra.$$.fragment,G1),G1.forEach(t),J1.forEach(t),ak=h(tu),Cd=n(tu,"SPAN",{});var X1=r(Cd);ik=i(X1,"TFDistilBertForQuestionAnswering"),X1.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var xt=r(Ie);$(aa.$$.fragment,xt),lk=h(xt),Bs=n(xt,"P",{});var yl=r(Bs);dk=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),qd=n(yl,"CODE",{});var Y1=r(qd);ck=i(Y1,"span start logits"),Y1.forEach(t),pk=i(yl," and "),Pd=n(yl,"CODE",{});var Z1=r(Pd);hk=i(Z1,"span end logits"),Z1.forEach(t),uk=i(yl,")."),yl.forEach(t),fk=h(xt),ia=n(xt,"P",{});var su=r(ia);mk=i(su,"This model inherits from "),nl=n(su,"A",{href:!0});var e2=r(nl);gk=i(e2,"TFPreTrainedModel"),e2.forEach(t),_k=i(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),bk=h(xt),la=n(xt,"P",{});var ou=r(la);kk=i(ou,"This model is also a "),da=n(ou,"A",{href:!0,rel:!0});var t2=r(da);vk=i(t2,"tf.keras.Model"),t2.forEach(t),Tk=i(ou,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ou.forEach(t),$k=h(xt),$(Uo.$$.fragment,xt),wk=h(xt),et=n(xt,"DIV",{class:!0});var Zt=r(et);$(ca.$$.fragment,Zt),yk=h(Zt),Ms=n(Zt,"P",{});var Fl=r(Ms);Fk=i(Fl,"The "),rl=n(Fl,"A",{href:!0});var s2=r(rl);Dk=i(s2,"TFDistilBertForQuestionAnswering"),s2.forEach(t),xk=i(Fl," forward method, overrides the "),Ad=n(Fl,"CODE",{});var o2=r(Ad);Bk=i(o2,"__call__"),o2.forEach(t),Mk=i(Fl," special method."),Fl.forEach(t),Ek=h(Zt),$(Ho.$$.fragment,Zt),zk=h(Zt),$(Ko.$$.fragment,Zt),jk=h(Zt),$(Vo.$$.fragment,Zt),Zt.forEach(t),xt.forEach(t),rh=h(s),Es=n(s,"H2",{class:!0});var nu=r(Es);Jo=n(nu,"A",{id:!0,class:!0,href:!0});var n2=r(Jo);Od=n(n2,"SPAN",{});var r2=r(Od);$(pa.$$.fragment,r2),r2.forEach(t),n2.forEach(t),Ck=h(nu),Nd=n(nu,"SPAN",{});var a2=r(Nd);qk=i(a2,"FlaxDistilBertModel"),a2.forEach(t),nu.forEach(t),ah=h(s),Me=n(s,"DIV",{class:!0});var st=r(Me);$(ha.$$.fragment,st),Pk=h(st),Ld=n(st,"P",{});var i2=r(Ld);Ak=i(i2,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),i2.forEach(t),Ok=h(st),ua=n(st,"P",{});var ru=r(ua);Nk=i(ru,"This model inherits from "),al=n(ru,"A",{href:!0});var l2=r(al);Lk=i(l2,"FlaxPreTrainedModel"),l2.forEach(t),Sk=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),ru.forEach(t),Ik=h(st),fa=n(st,"P",{});var au=r(fa);Wk=i(au,"This model is also a Flax Linen "),ma=n(au,"A",{href:!0,rel:!0});var d2=r(ma);Qk=i(d2,"flax.linen.Module"),d2.forEach(t),Rk=i(au,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),au.forEach(t),Uk=h(st),Sd=n(st,"P",{});var c2=r(Sd);Hk=i(c2,"Finally, this model supports inherent JAX features such as:"),c2.forEach(t),Kk=h(st),Mt=n(st,"UL",{});var vn=r(Mt);Id=n(vn,"LI",{});var p2=r(Id);ga=n(p2,"A",{href:!0,rel:!0});var h2=r(ga);Vk=i(h2,"Just-In-Time (JIT) compilation"),h2.forEach(t),p2.forEach(t),Jk=h(vn),Wd=n(vn,"LI",{});var u2=r(Wd);_a=n(u2,"A",{href:!0,rel:!0});var f2=r(_a);Gk=i(f2,"Automatic Differentiation"),f2.forEach(t),u2.forEach(t),Xk=h(vn),Qd=n(vn,"LI",{});var m2=r(Qd);ba=n(m2,"A",{href:!0,rel:!0});var g2=r(ba);Yk=i(g2,"Vectorization"),g2.forEach(t),m2.forEach(t),Zk=h(vn),Rd=n(vn,"LI",{});var _2=r(Rd);ka=n(_2,"A",{href:!0,rel:!0});var b2=r(ka);ev=i(b2,"Parallelization"),b2.forEach(t),_2.forEach(t),vn.forEach(t),tv=h(st),gt=n(st,"DIV",{class:!0});var Tn=r(gt);$(va.$$.fragment,Tn),sv=h(Tn),zs=n(Tn,"P",{});var Dl=r(zs);ov=i(Dl,"The "),Ud=n(Dl,"CODE",{});var k2=r(Ud);nv=i(k2,"FlaxDistilBertPreTrainedModel"),k2.forEach(t),rv=i(Dl," forward method, overrides the "),Hd=n(Dl,"CODE",{});var v2=r(Hd);av=i(v2,"__call__"),v2.forEach(t),iv=i(Dl," special method."),Dl.forEach(t),lv=h(Tn),$(Go.$$.fragment,Tn),dv=h(Tn),$(Xo.$$.fragment,Tn),Tn.forEach(t),st.forEach(t),ih=h(s),js=n(s,"H2",{class:!0});var iu=r(js);Yo=n(iu,"A",{id:!0,class:!0,href:!0});var T2=r(Yo);Kd=n(T2,"SPAN",{});var $2=r(Kd);$(Ta.$$.fragment,$2),$2.forEach(t),T2.forEach(t),cv=h(iu),Vd=n(iu,"SPAN",{});var w2=r(Vd);pv=i(w2,"FlaxDistilBertForMaskedLM"),w2.forEach(t),iu.forEach(t),lh=h(s),Ee=n(s,"DIV",{class:!0});var ot=r(Ee);$($a.$$.fragment,ot),hv=h(ot),wa=n(ot,"P",{});var lu=r(wa);uv=i(lu,"DistilBert Model with a "),Jd=n(lu,"CODE",{});var y2=r(Jd);fv=i(y2,"language modeling"),y2.forEach(t),mv=i(lu," head on top."),lu.forEach(t),gv=h(ot),ya=n(ot,"P",{});var du=r(ya);_v=i(du,"This model inherits from "),il=n(du,"A",{href:!0});var F2=r(il);bv=i(F2,"FlaxPreTrainedModel"),F2.forEach(t),kv=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),du.forEach(t),vv=h(ot),Fa=n(ot,"P",{});var cu=r(Fa);Tv=i(cu,"This model is also a Flax Linen "),Da=n(cu,"A",{href:!0,rel:!0});var D2=r(Da);$v=i(D2,"flax.linen.Module"),D2.forEach(t),wv=i(cu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
