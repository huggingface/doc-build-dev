...
Argument used when doing sequence summary, used in the models <a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel">GPT2DoubleHeadsModel</a> and
<a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.TFGPT2DoubleHeadsModel">TFGPT2DoubleHeadsModel</a>.</p>
...
<a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel">GPT2DoubleHeadsModel</a>.</p>
...
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_tf_gpt2.py#L591"}}),es=new ze({}),ts=new N({props:{name:"class transformers.GPT2Model",anchor:"transformers.GPT2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L668"}}),as=new N({props:{name:"forward",anchor:"transformers.GPT2Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2Config"
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L691"}}),xo=new se({props:{anchor:"transformers.GPT2Model.parallelize.example",$$slots:{default:[jb]},$$scope:{ctx:G}}}),is=new N({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L711"}}),Fo=new se({props:{anchor:"transformers.GPT2Model.deparallelize.example",$$slots:{default:[zb]},$$scope:{ctx:G}}}),ls=new ze({}),ds=new N({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L946"}}),us=new N({props:{name:"forward",anchor:"transformers.GPT2LMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L1015",returnDescription:`
<p>A <a
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L961"}}),qo=new se({props:{anchor:"transformers.GPT2LMHeadModel.parallelize.example",$$slots:{default:[Cb]},$$scope:{ctx:G}}}),fs=new N({props:{name:"deparallelize",anchor:"transformers.GPT2LMHeadModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L973"}}),Co=new se({props:{anchor:"transformers.GPT2LMHeadModel.deparallelize.example",$$slots:{default:[Db]},$$scope:{ctx:G}}}),gs=new ze({}),_s=new N({props:{name:"class transformers.GPT2DoubleHeadsModel",anchor:"transformers.GPT2DoubleHeadsModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L1115"}}),ys=new N({props:{name:"forward",anchor:"transformers.GPT2DoubleHeadsModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"mc_token_ids",val:" = None"},{name:"labels",val:" = None"},{name:"mc_labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
where <em>num_choices</em> is the size of the second dimension of the input tensors. (see <em>input_ids</em> above)`,name:"mc_labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L1189",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L1331"}}),Gs=new N({props:{name:"forward",anchor:"transformers.GPT2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L1347",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L1457"}}),qs=new N({props:{name:"forward",anchor:"transformers.GPT2ForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_gpt2.py#L1479",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_tf_gpt2.py#L735",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_tf_gpt2.py#L941",returnDescription:`
<p>A <a
...
Index of the classification token in each input sequence. Selected in the range <code>[0, input_ids.size(-1) - 1[</code>.`,name:"mc_token_ids"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1084",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.models.gpt2.modeling_tf_gpt2.TFGPT2DoubleHeadsModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1259",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
<a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_flax_gpt2.py#L653"}}),fa=new N({props:{name:"__call__",anchor:"transformers.FlaxGPT2Model.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"encoder_hidden_states",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxGPT2Model.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_16925/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_flax_gpt2.py#L446",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_flax_gpt2.py#L731"}}),Pa=new N({props:{name:"__call__",anchor:"transformers.FlaxGPT2LMHeadModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"encoder_hidden_states",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxGPT2LMHeadModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code>. Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16925/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16925/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16925/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16925/src/transformers/models/gpt2/modeling_flax_gpt2.py#L446",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16925/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
refer to this superclass for more information regarding those methods.`),Gd.forEach(t),Qe.forEach(t),Vl=u(o),At=s(o,"H2",{class:!0});var xd=i(At);$o=s(xd,"A",{id:!0,class:!0,href:!0});var J_=i($o);Ir=s(J_,"SPAN",{});var X_=i(Ir);k(Yn.$$.fragment,X_),X_.forEach(t),J_.forEach(t),qp=u(xd),Ar=s(xd,"SPAN",{});var Y_=i(Ar);Cp=r(Y_,"GPT2 specific outputs"),Y_.forEach(t),xd.forEach(t),Kl=u(o),Ot=s(o,"DIV",{class:!0});var Fd=i(Ot);k(Qn.$$.fragment,Fd),Dp=u(Fd),Or=s(Fd,"P",{});var Q_=i(Or);Np=r(Q_,"Base class for outputs of models predicting if two sentences are consecutive or not."),Q_.forEach(t),Fd.forEach(t),Jl=u(o),Wt=s(o,"DIV",{class:!0});var jd=i(Wt);k(Zn.$$.fragment,jd),Hp=u(jd),Wr=s(jd,"P",{});var Z_=i(Wr);Lp=r(Z_,"Base class for outputs of models predicting if two sentences are consecutive or not."),Z_.forEach(t),jd.forEach(t),Xl=u(o),Ut=s(o,"H2",{class:!0});var zd=i(Ut);Po=s(zd,"A",{id:!0,class:!0,href:!0});var e2=i(Po);Ur=s(e2,"SPAN",{});var t2=i(Ur);k(es.$$.fragment,t2),t2.forEach(t),e2.forEach(t),Sp=u(zd),Rr=s(zd,"SPAN",{});var o2=i(Rr);Ip=r(o2,"GPT2Model"),o2.forEach(t),zd.forEach(t),Yl=u(o),Pe=s(o,"DIV",{class:!0});var Ze=i(Pe);k(ts.$$.fragment,Ze),Ap=u(Ze),Br=s(Ze,"P",{});var n2=i(Br);Op=r(n2,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),n2.forEach(t),Wp=u(Ze),os=s(Ze,"P",{});var Ed=i(os);Up=r(Ed,"This model inherits from "),Ia=s(Ed,"A",{href:!0});var s2=i(Ia);Rp=r(s2,"PreTrainedModel"),s2.forEach(t),Bp=r(Ed,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ed.forEach(t),Vp=u(Ze),ns=s(Ze,"P",{});var qd=i(ns);Kp=r(qd,"This model is also a PyTorch "),ss=s(qd,"A",{href:!0,rel:!0});var a2=i(ss);Jp=r(a2,"torch.nn.Module"),a2.forEach(t),Xp=r(qd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qd.forEach(t),Yp=u(Ze),lt=s(Ze,"DIV",{class:!0});var kn=i(lt);k(as.$$.fragment,kn),Qp=u(kn),Rt=s(kn,"P",{});var pr=i(Rt);Zp=r(pr,"The "),Aa=s(pr,"A",{href:!0});var r2=i(Aa);eh=r(r2,"GPT2Model"),r2.forEach(t),th=r(pr," forward method, overrides the "),Vr=s(pr,"CODE",{});var i2=i(Vr);oh=r(i2,"__call__"),i2.forEach(t),nh=r(pr," special method."),pr.forEach(t),sh=u(kn),k(Mo.$$.fragment,kn),ah=u(kn),k(Go.$$.fragment,kn),kn.forEach(t),rh=u(Ze),dt=s(Ze,"DIV",{class:!0});var wn=i(dt);k(rs.$$.fragment,wn),ih=u(wn),Kr=s(wn,"P",{});var l2=i(Kr);lh=r(l2,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),l2.forEach(t),dh=u(wn),Jr=s(wn,"P",{});var d2=i(Jr);ch=r(d2,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),d2.forEach(t),ph=u(wn),k(xo.$$.fragment,wn),wn.forEach(t),hh=u(Ze),xt=s(Ze,"DIV",{class:!0});var hr=i(xt);k(is.$$.fragment,hr),uh=u(hr),Xr=s(hr,"P",{});var c2=i(Xr);mh=r(c2,"Moves the model to cpu from a model parallel state."),c2.forEach(t),fh=u(hr),k(Fo.$$.fragment,hr),hr.forEach(t),Ze.forEach(t),Ql=u(o),Bt=s(o,"H2",{class:!0});var Cd=i(Bt);jo=s(Cd,"A",{id:!0,class:!0,href:!0});var p2=i(jo);Yr=s(p2,"SPAN",{});var h2=i(Yr);k(ls.$$.fragment,h2),h2.forEach(t),p2.forEach(t),gh=u(Cd),Qr=s(Cd,"SPAN",{});var u2=i(Qr);_h=r(u2,"GPT2LMHeadModel"),u2.forEach(t),Cd.forEach(t),Zl=u(o),Me=s(o,"DIV",{class:!0});var et=i(Me);k(ds.$$.fragment,et),Th=u(et),Zr=s(et,"P",{});var m2=i(Zr);bh=r(m2,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),m2.forEach(t),vh=u(et),cs=s(et,"P",{});var Dd=i(cs);yh=r(Dd,"This model inherits from "),Oa=s(Dd,"A",{href:!0});var f2=i(Oa);kh=r(f2,"PreTrainedModel"),f2.forEach(t),wh=r(Dd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dd.forEach(t),$h=u(et),ps=s(et,"P",{});var Nd=i(ps);Ph=r(Nd,"This model is also a PyTorch "),hs=s(Nd,"A",{href:!0,rel:!0});var g2=i(hs);Mh=r(g2,"torch.nn.Module"),g2.forEach(t),Gh=r(Nd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd.forEach(t),xh=u(et),ct=s(et,"DIV",{class:!0});var $n=i(ct);k(us.$$.fragment,$n),Fh=u($n),Vt=s($n,"P",{});var ur=i(Vt);jh=r(ur,"The "),Wa=s(ur,"A",{href:!0});var _2=i(Wa);zh=r(_2,"GPT2LMHeadModel"),_2.forEach(t),Eh=r(ur," forward method, overrides the "),ei=s(ur,"CODE",{});var T2=i(ei);qh=r(T2,"__call__"),T2.forEach(t),Ch=r(ur," special method."),ur.forEach(t),Dh=u($n),k(zo.$$.fragment,$n),Nh=u($n),k(Eo.$$.fragment,$n),$n.forEach(t),Hh=u(et),pt=s(et,"DIV",{class:!0});var Pn=i(pt);k(ms.$$.fragment,Pn),Lh=u(Pn),ti=s(Pn,"P",{});var b2=i(ti);Sh=r(b2,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),b2.forEach(t),Ih=u(Pn),oi=s(Pn,"P",{});var v2=i(oi);Ah=r(v2,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),v2.forEach(t),Oh=u(Pn),k(qo.$$.fragment,Pn),Pn.forEach(t),Wh=u(et),Ft=s(et,"DIV",{class:!0});var mr=i(Ft);k(fs.$$.fragment,mr),Uh=u(mr),ni=s(mr,"P",{});var y2=i(ni);Rh=r(y2,"Moves the model to cpu from a model parallel state."),y2.forEach(t),Bh=u(mr),k(Co.$$.fragment,mr),mr.forEach(t),et.forEach(t),ed=u(o),Kt=s(o,"H2",{class:!0});var Hd=i(Kt);Do=s(Hd,"A",{id:!0,class:!0,href:!0});var k2=i(Do);si=s(k2,"SPAN",{});var w2=i(si);k(gs.$$.fragment,w2),w2.forEach(t),k2.forEach(t),Vh=u(Hd),ai=s(Hd,"SPAN",{});var $2=i(ai);Kh=r($2,"GPT2DoubleHeadsModel"),$2.forEach(t),Hd.forEach(t),td=u(o),Ke=s(o,"DIV",{class:!0});var jt=i(Ke);k(_s.$$.fragment,jt),Jh=u(jt),ri=s(jt,"P",{});var P2=i(ri);Xh=r(P2,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),P2.forEach(t),Yh=u(jt),Ts=s(jt,"P",{});var Ld=i(Ts);Qh=r(Ld,"This model inherits from "),Ua=s(Ld,"A",{href:!0});var M2=i(Ua);Zh=r(M2,"PreTrainedModel"),M2.forEach(t),eu=r(Ld,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ld.forEach(t),tu=u(jt),bs=s(jt,"P",{});var Sd=i(bs);ou=r(Sd,"This model is also a PyTorch "),vs=s(Sd,"A",{href:!0,rel:!0});var G2=i(vs);nu=r(G2,"torch.nn.Module"),G2.forEach(t),su=r(Sd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sd.forEach(t),au=u(jt),ht=s(jt,"DIV",{class:!0});var Mn=i(ht);k(ys.$$.fragment,Mn),ru=u(Mn),Jt=s(Mn,"P",{});var fr=i(Jt);iu=r(fr,"The "),Ra=s(fr,"A",{href:!0});var x2=i(Ra);lu=r(x2,"GPT2DoubleHeadsModel"),x2.forEach(t),du=r(fr," forward method, overrides the "),ii=s(fr,"CODE",{});var F2=i(ii);cu=r(F2,"__call__"),F2.forEach(t),pu=r(fr," special method."),fr.forEach(t),hu=u(Mn),k(No.$$.fragment,Mn),uu=u(Mn),k(Ho.$$.fragment,Mn),Mn.forEach(t),jt.forEach(t),od=u(o),Xt=s(o,"H2",{class:!0});var Id=i(Xt);Lo=s(Id,"A",{id:!0,class:!0,href:!0});var j2=i(Lo);li=s(j2,"SPAN",{});var z2=i(li);k(ks.$$.fragment,z2),z2.forEach(t),j2.forEach(t),mu=u(Id),di=s(Id,"SPAN",{});var E2=i(di);fu=r(E2,"GPT2ForSequenceClassification"),E2.forEach(t),Id.forEach(t),nd=u(o),Ge=s(o,"DIV",{class:!0});var tt=i(Ge);k(ws.$$.fragment,tt),gu=u(tt),ci=s(tt,"P",{});var q2=i(ci);_u=r(q2,"The GPT2 Model transformer with a sequence classification head on top (linear layer)."),q2.forEach(t),Tu=u(tt),Ba=s(tt,"P",{});var M_=i(Ba);Va=s(M_,"A",{href:!0});var C2=i(Va);bu=r(C2,"GPT2ForSequenceClassification"),C2.forEach(t),vu=r(M_,` uses the last token in order to do the classification, as other causal models
...
`),pi=s(zt,"CODE",{});var D2=i(pi);wu=r(D2,"pad_token_id"),D2.forEach(t),$u=r(zt,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),hi=s(zt,"CODE",{});var N2=i(hi);Pu=r(N2,"pad_token_id"),N2.forEach(t),Mu=r(zt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),ui=s(zt,"CODE",{});var H2=i(ui);Gu=r(H2,"inputs_embeds"),H2.forEach(t),xu=r(zt," are passed instead of "),mi=s(zt,"CODE",{});var L2=i(mi);Fu=r(L2,"input_ids"),L2.forEach(t),ju=r(zt,`, it does the same (take the last value in
each row of the batch).`),zt.forEach(t),zu=u(tt),$s=s(tt,"P",{});var Ad=i($s);Eu=r(Ad,"This model inherits from "),Ka=s(Ad,"A",{href:!0});var S2=i(Ka);qu=r(S2,"PreTrainedModel"),S2.forEach(t),Cu=r(Ad,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ad.forEach(t),Du=u(tt),Ps=s(tt,"P",{});var Od=i(Ps);Nu=r(Od,"This model is also a PyTorch "),Ms=s(Od,"A",{href:!0,rel:!0});var I2=i(Ms);Hu=r(I2,"torch.nn.Module"),I2.forEach(t),Lu=r(Od,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Od.forEach(t),Su=u(tt),je=s(tt,"DIV",{class:!0});var ot=i(je);k(Gs.$$.fragment,ot),Iu=u(ot),Yt=s(ot,"P",{});var gr=i(Yt);Au=r(gr,"The "),Ja=s(gr,"A",{href:!0});var A2=i(Ja);Ou=r(A2,"GPT2ForSequenceClassification"),A2.forEach(t),Wu=r(gr," forward method, overrides the "),fi=s(gr,"CODE",{});var O2=i(fi);Uu=r(O2,"__call__"),O2.forEach(t),Ru=r(gr," special method."),gr.forEach(t),Bu=u(ot),k(So.$$.fragment,ot),Vu=u(ot),k(Io.$$.fragment,ot),Ku=u(ot),k(Ao.$$.fragment,ot),Ju=u(ot),k(Oo.$$.fragment,ot),Xu=u(ot),k(Wo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),sd=u(o),Qt=s(o,"H2",{class:!0});var Wd=i(Qt);Uo=s(Wd,"A",{id:!0,class:!0,href:!0});var W2=i(Uo);gi=s(W2,"SPAN",{});var U2=i(gi);k(xs.$$.fragment,U2),U2.forEach(t),W2.forEach(t),Yu=u(Wd),_i=s(Wd,"SPAN",{});var R2=i(_i);Qu=r(R2,"GPT2ForTokenClassification"),R2.forEach(t),Wd.forEach(t),ad=u(o),Je=s(o,"DIV",{class:!0});var Et=i(Je);k(Fs.$$.fragment,Et),Zu=u(Et),Ti=s(Et,"P",{});var B2=i(Ti);em=r(B2,`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),B2.forEach(t),tm=u(Et),js=s(Et,"P",{});var Ud=i(js);om=r(Ud,"This model inherits from "),Xa=s(Ud,"A",{href:!0});var V2=i(Xa);nm=r(V2,"PreTrainedModel"),V2.forEach(t),sm=r(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(t),am=u(Et),zs=s(Et,"P",{});var Rd=i(zs);rm=r(Rd,"This model is also a PyTorch "),Es=s(Rd,"A",{href:!0,rel:!0});var K2=i(Es);im=r(K2,"torch.nn.Module"),K2.forEach(t),lm=r(Rd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rd.forEach(t),dm=u(Et),Xe=s(Et,"DIV",{class:!0});var qt=i(Xe);k(qs.$$.fragment,qt),cm=u(qt),Zt=s(qt,"P",{});var _r=i(Zt);pm=r(_r,"The "),Ya=s(_r,"A",{href:!0});var J2=i(Ya);hm=r(J2,"GPT2ForTokenClassification"),J2.forEach(t),um=r(_r," forward method, overrides the "),bi=s(_r,"CODE",{});var X2=i(bi);mm=r(X2,"__call__"),X2.forEach(t),fm=r(_r," special method."),_r.forEach(t),gm=u(qt),k(Ro.$$.fragment,qt),_m=u(qt),k(Bo.$$.fragment,qt),Tm=u(qt),k(Vo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),rd=u(o),eo=s(o,"H2",{class:!0});var Bd=i(eo);Ko=s(Bd,"A",{id:!0,class:!0,href:!0});var Y2=i(Ko);vi=s(Y2,"SPAN",{});var Q2=i(vi);k(Cs.$$.fragment,Q2),Q2.forEach(t),Y2.forEach(t),bm=u(Bd),yi=s(Bd,"SPAN",{});var Z2=i(yi);vm=r(Z2,"TFGPT2Model"),Z2.forEach(t),Bd.forEach(t),id=u(o),Ne=s(o,"DIV",{class:!0});var Tt=i(Ne);k(Ds.$$.fragment,Tt),ym=u(Tt),ki=s(Tt,"P",{});var eT=i(ki);km=r(eT,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),eT.forEach(t),wm=u(Tt),Ns=s(Tt,"P",{});var Vd=i(Ns);$m=r(Vd,"This model inherits from "),Qa=s(Vd,"A",{href:!0});var tT=i(Qa);Pm=r(tT,"TFPreTrainedModel"),tT.forEach(t),Mm=r(Vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vd.forEach(t),Gm=u(Tt),Hs=s(Tt,"P",{});var Kd=i(Hs);xm=r(Kd,"This model is also a "),Ls=s(Kd,"A",{href:!0,rel:!0});var oT=i(Ls);Fm=r(oT,"tf.keras.Model"),oT.forEach(t),jm=r(Kd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kd.forEach(t),zm=u(Tt),k(Jo.$$.fragment,Tt),Em=u(Tt),ut=s(Tt,"DIV",{class:!0});var Gn=i(ut);k(Ss.$$.fragment,Gn),qm=u(Gn),to=s(Gn,"P",{});var Tr=i(to);Cm=r(Tr,"The "),Za=s(Tr,"A",{href:!0});var nT=i(Za);Dm=r(nT,"TFGPT2Model"),nT.forEach(t),Nm=r(Tr," forward method, overrides the "),wi=s(Tr,"CODE",{});var sT=i(wi);Hm=r(sT,"__call__"),sT.forEach(t),Lm=r(Tr," special method."),Tr.forEach(t),Sm=u(Gn),k(Xo.$$.fragment,Gn),Im=u(Gn),k(Yo.$$.fragment,Gn),Gn.forEach(t),Tt.forEach(t),ld=u(o),oo=s(o,"H2",{class:!0});var Jd=i(oo);Qo=s(Jd,"A",{id:!0,class:!0,href:!0});var aT=i(Qo);$i=s(aT,"SPAN",{});var rT=i($i);k(Is.$$.fragment,rT),rT.forEach(t),aT.forEach(t),Am=u(Jd),Pi=s(Jd,"SPAN",{});var iT=i(Pi);Om=r(iT,"TFGPT2LMHeadModel"),iT.forEach(t),Jd.forEach(t),dd=u(o),He=s(o,"DIV",{class:!0});var bt=i(He);k(As.$$.fragment,bt),Wm=u(bt),Mi=s(bt,"P",{});var lT=i(Mi);Um=r(lT,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),lT.forEach(t),Rm=u(bt),Os=s(bt,"P",{});var Xd=i(Os);Bm=r(Xd,"This model inherits from "),er=s(Xd,"A",{href:!0});var dT=i(er);Vm=r(dT,"TFPreTrainedModel"),dT.forEach(t),Km=r(Xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xd.forEach(t),Jm=u(bt),Ws=s(bt,"P",{});var Yd=i(Ws);Xm=r(Yd,"This model is also a "),Us=s(Yd,"A",{href:!0,rel:!0});var cT=i(Us);Ym=r(cT,"tf.keras.Model"),cT.forEach(t),Qm=r(Yd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yd.forEach(t),Zm=u(bt),k(Zo.$$.fragment,bt),ef=u(bt),mt=s(bt,"DIV",{class:!0});var xn=i(mt);k(Rs.$$.fragment,xn),tf=u(xn),no=s(xn,"P",{});var br=i(no);of=r(br,"The "),tr=s(br,"A",{href:!0});var pT=i(tr);nf=r(pT,"TFGPT2LMHeadModel"),pT.forEach(t),sf=r(br," forward method, overrides the "),Gi=s(br,"CODE",{});var hT=i(Gi);af=r(hT,"__call__"),hT.forEach(t),rf=r(br," special method."),br.forEach(t),lf=u(xn),k(en.$$.fragment,xn),df=u(xn),k(tn.$$.fragment,xn),xn.forEach(t),bt.forEach(t),cd=u(o),so=s(o,"H2",{class:!0});var Qd=i(so);on=s(Qd,"A",{id:!0,class:!0,href:!0});var uT=i(on);xi=s(uT,"SPAN",{});var mT=i(xi);k(Bs.$$.fragment,mT),mT.forEach(t),uT.forEach(t),cf=u(Qd),Fi=s(Qd,"SPAN",{});var fT=i(Fi);pf=r(fT,"TFGPT2DoubleHeadsModel"),fT.forEach(t),Qd.forEach(t),pd=u(o),Le=s(o,"DIV",{class:!0});var vt=i(Le);k(Vs.$$.fragment,vt),hf=u(vt),ji=s(vt,"P",{});var gT=i(ji);uf=r(gT,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),gT.forEach(t),mf=u(vt),Ks=s(vt,"P",{});var Zd=i(Ks);ff=r(Zd,"This model inherits from "),or=s(Zd,"A",{href:!0});var _T=i(or);gf=r(_T,"TFPreTrainedModel"),_T.forEach(t),_f=r(Zd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zd.forEach(t),Tf=u(vt),Js=s(vt,"P",{});var ec=i(Js);bf=r(ec,"This model is also a "),Xs=s(ec,"A",{href:!0,rel:!0});var TT=i(Xs);vf=r(TT,"tf.keras.Model"),TT.forEach(t),yf=r(ec,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ec.forEach(t),kf=u(vt),k(nn.$$.fragment,vt),wf=u(vt),ft=s(vt,"DIV",{class:!0});var Fn=i(ft);k(Ys.$$.fragment,Fn),$f=u(Fn),ao=s(Fn,"P",{});var vr=i(ao);Pf=r(vr,"The "),nr=s(vr,"A",{href:!0});var bT=i(nr);Mf=r(bT,"TFGPT2DoubleHeadsModel"),bT.forEach(t),Gf=r(vr," forward method, overrides the "),zi=s(vr,"CODE",{});var vT=i(zi);xf=r(vT,"__call__"),vT.forEach(t),Ff=r(vr," special method."),vr.forEach(t),jf=u(Fn),k(sn.$$.fragment,Fn),zf=u(Fn),k(an.$$.fragment,Fn),Fn.forEach(t),vt.forEach(t),hd=u(o),ro=s(o,"H2",{class:!0});var tc=i(ro);rn=s(tc,"A",{id:!0,class:!0,href:!0});var yT=i(rn);Ei=s(yT,"SPAN",{});var kT=i(Ei);k(Qs.$$.fragment,kT),kT.forEach(t),yT.forEach(t),Ef=u(tc),qi=s(tc,"SPAN",{});var wT=i(qi);qf=r(wT,"TFGPT2ForSequenceClassification"),wT.forEach(t),tc.forEach(t),ud=u(o),he=s(o,"DIV",{class:!0});var Ae=i(he);k(Zs.$$.fragment,Ae),Cf=u(Ae),Ci=s(Ae,"P",{});var $T=i(Ci);Df=r($T,"The GPT2 Model transformer with a sequence classification head on top (linear layer)."),$T.forEach(t),Nf=u(Ae),sr=s(Ae,"P",{});var G_=i(sr);ar=s(G_,"A",{href:!0});var PT=i(ar);Hf=r(PT,"TFGPT2ForSequenceClassification"),PT.forEach(t),Lf=r(G_,` uses the last token in order to do the classification, as other causal models
...
`),Di=s(Ct,"CODE",{});var MT=i(Di);Af=r(MT,"pad_token_id"),MT.forEach(t),Of=r(Ct,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),Ni=s(Ct,"CODE",{});var GT=i(Ni);Wf=r(GT,"pad_token_id"),GT.forEach(t),Uf=r(Ct,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Hi=s(Ct,"CODE",{});var xT=i(Hi);Rf=r(xT,"inputs_embeds"),xT.forEach(t),Bf=r(Ct," are passed instead of "),Li=s(Ct,"CODE",{});var FT=i(Li);Vf=r(FT,"input_ids"),FT.forEach(t),Kf=r(Ct,`, it does the same (take the last value in
each row of the batch).`),Ct.forEach(t),Jf=u(Ae),ea=s(Ae,"P",{});var oc=i(ea);Xf=r(oc,"This model inherits from "),rr=s(oc,"A",{href:!0});var jT=i(rr);Yf=r(jT,"TFPreTrainedModel"),jT.forEach(t),Qf=r(oc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),oc.forEach(t),Zf=u(Ae),ta=s(Ae,"P",{});var nc=i(ta);eg=r(nc,"This model is also a "),oa=s(nc,"A",{href:!0,rel:!0});var zT=i(oa);tg=r(zT,"tf.keras.Model"),zT.forEach(t),og=r(nc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),nc.forEach(t),ng=u(Ae),k(ln.$$.fragment,Ae),sg=u(Ae),Ye=s(Ae,"DIV",{class:!0});var Dt=i(Ye);k(na.$$.fragment,Dt),ag=u(Dt),io=s(Dt,"P",{});var yr=i(io);rg=r(yr,"The "),ir=s(yr,"A",{href:!0});var ET=i(ir);ig=r(ET,"TFGPT2ForSequenceClassification"),ET.forEach(t),lg=r(yr," forward method, overrides the "),Si=s(yr,"CODE",{});var qT=i(Si);dg=r(qT,"__call__"),qT.forEach(t),cg=r(yr," special method."),yr.forEach(t),pg=u(Dt),k(dn.$$.fragment,Dt),hg=u(Dt),k(cn.$$.fragment,Dt),ug=u(Dt),k(pn.$$.fragment,Dt),Dt.forEach(t),Ae.forEach(t),md=u(o),lo=s(o,"H2",{class:!0});var sc=i(lo);hn=s(sc,"A",{id:!0,class:!0,href:!0});var CT=i(hn);Ii=s(CT,"SPAN",{});var DT=i(Ii);k(sa.$$.fragment,DT),DT.forEach(t),CT.forEach(t),mg=u(sc),Ai=s(sc,"SPAN",{});var NT=i(Ai);fg=r(NT,"TFSequenceClassifierOutputWithPast"),NT.forEach(t),sc.forEach(t),fd=u(o),co=s(o,"DIV",{class:!0});var ac=i(co);k(aa.$$.fragment,ac),gg=u(ac),Oi=s(ac,"P",{});var HT=i(Oi);_g=r(HT,"Base class for outputs of sentence classification models."),HT.forEach(t),ac.forEach(t),gd=u(o),po=s(o,"H2",{class:!0});var rc=i(po);un=s(rc,"A",{id:!0,class:!0,href:!0});var LT=i(un);Wi=s(LT,"SPAN",{});var ST=i(Wi);k(ra.$$.fragment,ST),ST.forEach(t),LT.forEach(t),Tg=u(rc),Ui=s(rc,"SPAN",{});var IT=i(Ui);bg=r(IT,"FlaxGPT2Model"),IT.forEach(t),rc.forEach(t),_d=u(o),xe=s(o,"DIV",{class:!0});var nt=i(xe);k(ia.$$.fragment,nt),vg=u(nt),Ri=s(nt,"P",{});var AT=i(Ri);yg=r(AT,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),AT.forEach(t),kg=u(nt),la=s(nt,"P",{});var ic=i(la);wg=r(ic,"This model inherits from "),lr=s(ic,"A",{href:!0});var OT=i(lr);$g=r(OT,"FlaxPreTrainedModel"),OT.forEach(t),Pg=r(ic,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ic.forEach(t),Mg=u(nt),da=s(nt,"P",{});var lc=i(da);Gg=r(lc,`This model is also a Flax Linen
`),ca=s(lc,"A",{href:!0,rel:!0});var WT=i(ca);xg=r(WT,"flax.nn.Module"),WT.forEach(t),Fg=r(lc,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),lc.forEach(t),jg=u(nt),Bi=s(nt,"P",{});var UT=i(Bi);zg=r(UT,"Finally, this model supports inherent JAX features such as:"),UT.forEach(t),Eg=u(nt),wt=s(nt,"UL",{});var jn=i(wt);Vi=s(jn,"LI",{});var RT=i(Vi);pa=s(RT,"A",{href:!0,rel:!0});var BT=i(pa);qg=r(BT,"Just-In-Time (JIT) compilation"),BT.forEach(t),RT.forEach(t),Cg=u(jn),Ki=s(jn,"LI",{});var VT=i(Ki);ha=s(VT,"A",{href:!0,rel:!0});var KT=i(ha);Dg=r(KT,"Automatic Differentiation"),KT.forEach(t),VT.forEach(t),Ng=u(jn),Ji=s(jn,"LI",{});var JT=i(Ji);ua=s(JT,"A",{href:!0,rel:!0});var XT=i(ua);Hg=r(XT,"Vectorization"),XT.forEach(t),JT.forEach(t),Lg=u(jn),Xi=s(jn,"LI",{});var YT=i(Xi);ma=s(YT,"A",{href:!0,rel:!0});var QT=i(ma);Sg=r(QT,"Parallelization"),QT.forEach(t),YT.forEach(t),jn.forEach(t),Ig=u(nt),gt=s(nt,"DIV",{class:!0});var zn=i(gt);k(fa.$$.fragment,zn),Ag=u(zn),ho=s(zn,"P",{});var kr=i(ho);Og=r(kr,"The "),Yi=s(kr,"CODE",{});var ZT=i(Yi);Wg=r(ZT,"FlaxGPT2PreTrainedModel"),ZT.forEach(t),Ug=r(kr," forward method, overrides the "),Qi=s(kr,"CODE",{});var eb=i(Qi);Rg=r(eb,"__call__"),eb.forEach(t),Bg=r(kr," special method."),kr.forEach(t),Vg=u(zn),k(mn.$$.fragment,zn),Kg=u(zn),k(fn.$$.fragment,zn),zn.forEach(t),nt.forEach(t),Td=u(o),uo=s(o,"H2",{class:!0});var dc=i(uo);gn=s(dc,"A",{id:!0,class:!0,href:!0});var tb=i(gn);Zi=s(tb,"SPAN",{});var ob=i(Zi);k(ga.$$.fragment,ob),ob.forEach(t),tb.forEach(t),Jg=u(dc),el=s(dc,"SPAN",{});var nb=i(el);Xg=r(nb,"FlaxGPT2LMHeadModel"),nb.forEach(t),dc.forEach(t),bd=u(o),Fe=s(o,"DIV",{class:!0});var st=i(Fe);k(_a.$$.fragment,st),Yg=u(st),tl=s(st,"P",{});var sb=i(tl);Qg=r(sb,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
