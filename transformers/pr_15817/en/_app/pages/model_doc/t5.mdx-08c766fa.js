import{S as uy,i as my,s as fy,e as o,k as d,w as f,t as r,L as _y,c as s,d as t,m as l,a,x as _,h as i,b as c,J as e,g as p,y as g,q as T,o as k,B as v}from"../../chunks/vendor-9e2b328e.js";import{T as zt}from"../../chunks/Tip-76f97a76.js";import{D as M}from"../../chunks/Docstring-50fd6873.js";import{C as R}from"../../chunks/CodeBlock-88e23343.js";import{I as ke}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function gy(I){let u,x,b,y,z;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),y=r("Module"),z=r(`
...
the latter silently ignores them.`)},l($){u=s($,"P",{});var w=a(u);x=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var E=a(b);y=i(E,"Module"),E.forEach(t),z=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m($,w){p($,u,w),e(u,x),e(u,b),e(b,y),e(u,z)},d($){$&&t(u)}}}function qy(I){let u,x,b,y,z,$,w,E,Ee,oe,q,ee,O,se,qe,G,je,ve,B,L,ae,pe,F,C,he,K,be,ue,U,Fe,we,P,Me,H,V,me,A,Pe,fe,D,Ce,W,Ae,m,j,te,Oe,pt,S,Ge,ne,ht,N,Y,ut,Ne,J,mt,Ie,Le,ft,Vl,Xa,Sp,Kl,Be,di,li,To,Op,Gp,ci,pi,ko,Bp,Up,hi,ui,vo,Wp,Rp,mi,fi,bo,Hp,Vp,_i,Qa,wo,Kp,Yp,Yl,er,Jp,Jl,xt,gi,zn,Ti,Zp,Xp,tr,Qp,eh,th,ki,xn,vi,nh,oh,nr,sh,ah,rh,bi,En,wi,ih,dh,or,lh,ch,Zl,qn,ph,yo,hh,uh,Xl,Et,mh,$o,fh,_h,zo,gh,Th,Ql,sr,ec,Jt,jn,yi,xo,kh,$i,vh,tc,_t,bh,zi,wh,yh,xi,$h,zh,Ei,xh,Eh,nc,Fn,qh,ar,jh,Fh,oc,Mn,dt,qi,Mh,Ph,_e,Ch,ji,Ah,Nh,Fi,Ih,Lh,Mi,Dh,Sh,Pi,Oh,Gh,Ci,Bh,Uh,rr,Wh,Rh,Hh,Ai,Vh,Kh,Eo,Yh,qo,Jh,jo,Zh,Xh,Qh,ge,Ni,eu,tu,Ii,nu,ou,Fo,su,re,au,Li,ru,iu,Di,du,lu,Si,cu,pu,Oi,hu,uu,Gi,mu,fu,Bi,_u,gu,Ui,Tu,ku,vu,Zt,bu,Wi,wu,yu,Ri,$u,zu,xu,Te,Eu,Hi,qu,ju,Vi,Fu,Mu,Ki,Pu,Cu,Yi,Au,Nu,Mo,Iu,Lu,Ji,Du,Su,Ou,Po,sc,ir,Gu,ac,qt,Zi,Co,Bu,Xi,Uu,Wu,Ru,Qi,Xt,Hu,Ao,Vu,Ku,No,Yu,Ju,Zu,ed,Io,Xu,td,Qu,em,rc,dr,ic,Qt,Pn,nd,Lo,tm,od,nm,dc,gt,om,lr,sm,am,Do,rm,im,So,dm,lm,lc,Oo,cc,Ue,cm,sd,pm,hm,ad,um,mm,cr,fm,_m,rd,gm,Tm,pc,pr,km,hc,Go,uc,hr,mc,en,Cn,id,Bo,vm,dd,bm,fc,Tt,wm,Uo,ym,$m,ld,zm,xm,cd,Em,qm,_c,tn,An,pd,Wo,jm,hd,Fm,gc,ur,Mm,Tc,Nn,ud,nn,Pm,Ro,Cm,Am,Ho,Nm,Im,Lm,md,De,Dm,Vo,Sm,Om,Ko,Gm,Bm,Yo,Um,Wm,Jo,Rm,Hm,Zo,Vm,Km,kc,on,In,fd,Xo,Ym,_d,Jm,vc,yt,Qo,Zm,$t,Xm,mr,Qm,ef,fr,tf,nf,es,of,sf,af,sn,rf,_r,df,lf,gr,cf,pf,bc,an,Ln,gd,ts,hf,Td,uf,wc,ie,ns,mf,os,ff,ss,_f,gf,Tf,as,kf,Tr,vf,bf,wf,jt,rs,yf,kd,$f,zf,is,kr,xf,vd,Ef,qf,vr,jf,bd,Ff,Mf,Dn,ds,Pf,ls,Cf,wd,Af,Nf,If,Sn,cs,Lf,yd,Df,Sf,br,ps,yc,rn,On,$d,hs,Of,zd,Gf,$c,Se,us,Bf,dn,Uf,xd,Wf,Rf,ms,Hf,Vf,Kf,fs,Yf,wr,Jf,Zf,Xf,Ft,_s,Qf,Ed,e_,t_,gs,yr,n_,qd,o_,s_,$r,a_,jd,r_,i_,Gn,Ts,d_,Fd,l_,zc,ln,Bn,Md,ks,c_,Pd,p_,xc,Z,vs,h_,Cd,u_,m_,bs,f_,ws,__,g_,T_,ys,k_,zr,v_,b_,w_,$s,y_,zs,$_,z_,x_,We,xs,E_,cn,q_,xr,j_,F_,Ad,M_,P_,C_,Un,A_,Nd,N_,I_,Es,L_,Re,qs,D_,Id,S_,O_,Ld,G_,B_,Dd,U_,W_,js,R_,kt,Fs,H_,Sd,V_,K_,Od,Y_,J_,Ms,Ec,pn,Wn,Gd,Ps,Z_,Bd,X_,qc,X,Cs,Q_,As,eg,Ud,tg,ng,og,Ns,sg,Is,ag,rg,ig,Ls,dg,Er,lg,cg,pg,Ds,hg,Ss,ug,mg,fg,He,Os,_g,hn,gg,qr,Tg,kg,Wd,vg,bg,wg,Rn,yg,Rd,$g,zg,Gs,xg,Ve,Bs,Eg,Hd,qg,jg,Vd,Fg,Mg,Kd,Pg,Cg,Us,Ag,vt,Ws,Ng,Yd,Ig,Lg,Jd,Dg,Sg,Rs,jc,un,Hn,Zd,Hs,Og,Xd,Gg,Fc,Q,Vs,Bg,Qd,Ug,Wg,Ks,Rg,Ys,Hg,Vg,Kg,Js,Yg,jr,Jg,Zg,Xg,Zs,Qg,Xs,eT,tT,nT,Ke,Qs,oT,mn,sT,Fr,aT,rT,el,iT,dT,lT,Vn,cT,tl,pT,hT,ea,uT,Ye,ta,mT,nl,fT,_T,ol,gT,TT,sl,kT,vT,na,bT,bt,oa,wT,al,yT,$T,rl,zT,xT,sa,Mc,fn,Kn,il,aa,ET,dl,qT,Pc,de,ra,jT,ll,FT,MT,ia,PT,da,CT,AT,NT,la,IT,Mr,LT,DT,ST,ca,OT,pa,GT,BT,UT,Yn,WT,Je,ha,RT,_n,HT,Pr,VT,KT,cl,YT,JT,ZT,Jn,XT,pl,QT,ek,ua,Cc,gn,Zn,hl,ma,tk,ul,nk,Ac,le,fa,ok,_a,sk,ml,ak,rk,ik,ga,dk,Ta,lk,ck,pk,ka,hk,Cr,uk,mk,fk,va,_k,ba,gk,Tk,kk,Xn,vk,Ze,wa,bk,Tn,wk,Ar,yk,$k,fl,zk,xk,Ek,Qn,qk,_l,jk,Fk,ya,Nc,kn,eo,gl,$a,Mk,Tl,Pk,Ic,ce,za,Ck,kl,Ak,Nk,xa,Ik,Ea,Lk,Dk,Sk,qa,Ok,Nr,Gk,Bk,Uk,ja,Wk,Fa,Rk,Hk,Vk,to,Kk,Xe,Ma,Yk,vn,Jk,Ir,Zk,Xk,vl,Qk,ev,tv,no,nv,bl,ov,sv,Pa,Lc,bn,oo,wl,Ca,av,yl,rv,Dc,lt,Aa,iv,Qe,Na,dv,wn,lv,$l,cv,pv,zl,hv,uv,mv,so,fv,xl,_v,gv,Ia,Tv,Mt,La,kv,El,vv,bv,Da,wv,Pt,Sa,yv,ql,$v,zv,Oa,Sc,yn,ao,jl,Ga,xv,Fl,Ev,Oc,ct,Ba,qv,et,Ua,jv,$n,Fv,Ml,Mv,Pv,Pl,Cv,Av,Nv,ro,Iv,Cl,Lv,Dv,Wa,Sv,Ct,Ra,Ov,Al,Gv,Bv,Ha,Uv,At,Va,Wv,Nl,Rv,Hv,Ka,Gc;return $=new ke({}),se=new ke({}),xo=new ke({}),Eo=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
configuration. Check out the <a href="/docs/transformers/pr_15817/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xs=new M({props:{name:"forward",anchor:"transformers.T5Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15817/src/transformers/models/t5/modeling_t5.py#L1340",parametersDescription:[{anchor:"transformers.T5Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15817/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15817/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15817/src/transformers/models/t5/modeling_t5.py#L1308"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15817/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Os=new M({props:{name:"forward",anchor:"transformers.T5ForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15817/src/transformers/models/t5/modeling_t5.py#L1534",parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15817/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Ws=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15817/src/transformers/models/t5/modeling_t5.py#L1503"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15817/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15817/src/transformers/models/t5/modeling_t5.py#L1805",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15817/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_15817/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15817/src/transformers/models/t5/modeling_t5.py#L1779"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
`}}),Jn=new zt({props:{$$slots:{default:[by]},$$scope:{ctx:I}}}),ua=new R({props:{code:`from transformers import T5Tokenizer, TFT5Model
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15817/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[wy]},$$scope:{ctx:I}}}),wa=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15817/src/transformers/models/t5/modeling_tf_t5.py#L1355",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15817/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15817/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[$y]},$$scope:{ctx:I}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15817/src/transformers/models/t5/modeling_tf_t5.py#L1630",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15817/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15817/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15817/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15817/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15817/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15817/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
for summarization: `),W=o("em"),Ae=r("summarize: \u2026"),m=r("."),j=d(),te=o("li"),Oe=o("p"),pt=r("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),S=d(),Ge=o("li"),ne=o("p"),ht=r("See the "),N=o("a"),Y=r("training"),ut=r(", "),Ne=o("a"),J=r("inference"),mt=r(" and "),Ie=o("a"),Le=r("scripts"),ft=r(" sections below for all details regarding usage."),Vl=d(),Xa=o("p"),Sp=r("T5 comes in different sizes:"),Kl=d(),Be=o("ul"),di=o("li"),li=o("p"),To=o("a"),Op=r("t5-small"),Gp=d(),ci=o("li"),pi=o("p"),ko=o("a"),Bp=r("t5-base"),Up=d(),hi=o("li"),ui=o("p"),vo=o("a"),Wp=r("t5-large"),Rp=d(),mi=o("li"),fi=o("p"),bo=o("a"),Hp=r("t5-3b"),Vp=d(),_i=o("li"),Qa=o("p"),wo=o("a"),Kp=r("t5-11b"),Yp=r("."),Yl=d(),er=o("p"),Jp=r("Based on the original T5 model, Google has released some follow-up works:"),Jl=d(),xt=o("ul"),gi=o("li"),zn=o("p"),Ti=o("strong"),Zp=r("T5v1.1"),Xp=r(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),or=o("a"),lh=r("here"),ch=r("."),Zl=d(),qn=o("p"),ph=r("All checkpoints can be found on the "),yo=o("a"),hh=r("hub"),uh=r("."),Xl=d(),Et=o("p"),mh=r("This model was contributed by "),$o=o("a"),fh=r("thomwolf"),_h=r(". The original code can be found "),zo=o("a"),gh=r("here"),Th=r("."),Ql=d(),sr=o("a"),ec=d(),Jt=o("h2"),jn=o("a"),yi=o("span"),f(xo.$$.fragment),kh=d(),$i=o("span"),vh=r("Training"),tc=d(),_t=o("p"),bh=r(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
pre-training mixture (see Appendix D of the `),No=o("a"),Yu=r("paper"),Ju=r(` for the task prefixes
used).`),Zu=d(),ed=o("li"),Io=o("p"),Xu=r(`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
you to easily fine-tune T5 on custom data for summarization/translation.`),kc=d(),on=o("h2"),In=o("a"),fd=o("span"),f(Xo.$$.fragment),Ym=d(),_d=o("span"),Jm=r("T5Config"),vc=d(),yt=o("div"),f(Qo.$$.fragment),Zm=d(),$t=o("p"),Xm=r("This is the configuration class to store the configuration of a "),mr=o("a"),Qm=r("T5Model"),ef=r(" or a "),fr=o("a"),tf=r("TFT5Model"),nf=r(`. It is used to
...
`),ms=o("a"),Hf=r("Unigram"),Vf=r("."),Kf=d(),fs=o("p"),Yf=r("This tokenizer inherits from "),wr=o("a"),Jf=r("PreTrainedTokenizerFast"),Zf=r(` which contains most of the main methods. Users should
...
behavior.`),UT=d(),f(Yn.$$.fragment),WT=d(),Je=o("div"),f(ha.$$.fragment),RT=d(),_n=o("p"),HT=r("The "),Pr=o("a"),VT=r("TFT5Model"),KT=r(" forward method, overrides the "),cl=o("code"),YT=r("__call__"),JT=r(" special method."),ZT=d(),f(Jn.$$.fragment),XT=d(),pl=o("p"),QT=r("Examples:"),ek=d(),f(ua.$$.fragment),Cc=d(),gn=o("h2"),Zn=o("a"),hl=o("span"),f(ma.$$.fragment),tk=d(),ul=o("span"),nk=r("TFT5ForConditionalGeneration"),Ac=d(),le=o("div"),f(fa.$$.fragment),ok=d(),_a=o("p"),sk=r("T5 Model with a "),ml=o("code"),ak=r("language modeling"),rk=r(" head on top."),ik=d(),ga=o("p"),dk=r("The T5 model was proposed in "),Ta=o("a"),lk=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
for summarization: `),W=s(Dr,"EM",{});var o1=a(W);Ae=i(o1,"summarize: \u2026"),o1.forEach(t),m=i(Dr,"."),Dr.forEach(t),t1.forEach(t),j=l(Lr),te=s(Lr,"LI",{});var s1=a(te);Oe=s(s1,"P",{});var a1=a(Oe);pt=i(a1,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),a1.forEach(t),s1.forEach(t),S=l(Lr),Ge=s(Lr,"LI",{});var r1=a(Ge);ne=s(r1,"P",{});var io=a(ne);ht=i(io,"See the "),N=s(io,"A",{href:!0});var i1=a(N);Y=i(i1,"training"),i1.forEach(t),ut=i(io,", "),Ne=s(io,"A",{href:!0});var d1=a(Ne);J=i(d1,"inference"),d1.forEach(t),mt=i(io," and "),Ie=s(io,"A",{href:!0});var l1=a(Ie);Le=i(l1,"scripts"),l1.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),r1.forEach(t),Lr.forEach(t),Vl=l(n),Xa=s(n,"P",{});var c1=a(Xa);Sp=i(c1,"T5 comes in different sizes:"),c1.forEach(t),Kl=l(n),Be=s(n,"UL",{});var Nt=a(Be);di=s(Nt,"LI",{});var p1=a(di);li=s(p1,"P",{});var h1=a(li);To=s(h1,"A",{href:!0,rel:!0});var u1=a(To);Op=i(u1,"t5-small"),u1.forEach(t),h1.forEach(t),p1.forEach(t),Gp=l(Nt),ci=s(Nt,"LI",{});var m1=a(ci);pi=s(m1,"P",{});var f1=a(pi);ko=s(f1,"A",{href:!0,rel:!0});var _1=a(ko);Bp=i(_1,"t5-base"),_1.forEach(t),f1.forEach(t),m1.forEach(t),Up=l(Nt),hi=s(Nt,"LI",{});var g1=a(hi);ui=s(g1,"P",{});var T1=a(ui);vo=s(T1,"A",{href:!0,rel:!0});var k1=a(vo);Wp=i(k1,"t5-large"),k1.forEach(t),T1.forEach(t),g1.forEach(t),Rp=l(Nt),mi=s(Nt,"LI",{});var v1=a(mi);fi=s(v1,"P",{});var b1=a(fi);bo=s(b1,"A",{href:!0,rel:!0});var w1=a(bo);Hp=i(w1,"t5-3b"),w1.forEach(t),b1.forEach(t),v1.forEach(t),Vp=l(Nt),_i=s(Nt,"LI",{});var y1=a(_i);Qa=s(y1,"P",{});var Vv=a(Qa);wo=s(Vv,"A",{href:!0,rel:!0});var $1=a(wo);Kp=i($1,"t5-11b"),$1.forEach(t),Yp=i(Vv,"."),Vv.forEach(t),y1.forEach(t),Nt.forEach(t),Yl=l(n),er=s(n,"P",{});var z1=a(er);Jp=i(z1,"Based on the original T5 model, Google has released some follow-up works:"),z1.forEach(t),Jl=l(n),xt=s(n,"UL",{});var Sr=a(xt);gi=s(Sr,"LI",{});var x1=a(gi);zn=s(x1,"P",{});var Wl=a(zn);Ti=s(Wl,"STRONG",{});var E1=a(Ti);Zp=i(E1,"T5v1.1"),E1.forEach(t),Xp=i(Wl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
the documentation of mT5 which can be found `),nr=s(Rl,"A",{href:!0});var M1=a(nr);sh=i(M1,"here"),M1.forEach(t),ah=i(Rl,"."),Rl.forEach(t),j1.forEach(t),rh=l(Sr),bi=s(Sr,"LI",{});var P1=a(bi);En=s(P1,"P",{});var Hl=a(En);wi=s(Hl,"STRONG",{});var C1=a(wi);ih=i(C1,"byT5"),C1.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var A1=a(or);lh=i(A1,"here"),A1.forEach(t),ch=i(Hl,"."),Hl.forEach(t),P1.forEach(t),Sr.forEach(t),Zl=l(n),qn=s(n,"P",{});var Bc=a(qn);ph=i(Bc,"All checkpoints can be found on the "),yo=s(Bc,"A",{href:!0,rel:!0});var N1=a(yo);hh=i(N1,"hub"),N1.forEach(t),uh=i(Bc,"."),Bc.forEach(t),Xl=l(n),Et=s(n,"P",{});var Or=a(Et);mh=i(Or,"This model was contributed by "),$o=s(Or,"A",{href:!0,rel:!0});var I1=a($o);fh=i(I1,"thomwolf"),I1.forEach(t),_h=i(Or,". The original code can be found "),zo=s(Or,"A",{href:!0,rel:!0});var L1=a(zo);gh=i(L1,"here"),L1.forEach(t),Th=i(Or,"."),Or.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Jt=s(n,"H2",{class:!0});var Uc=a(Jt);jn=s(Uc,"A",{id:!0,class:!0,href:!0});var D1=a(jn);yi=s(D1,"SPAN",{});var S1=a(yi);_(xo.$$.fragment,S1),S1.forEach(t),D1.forEach(t),kh=l(Uc),$i=s(Uc,"SPAN",{});var O1=a($i);vh=i(O1,"Training"),O1.forEach(t),Uc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),zi=s(lo,"CODE",{});var G1=a(zi);wh=i(G1,"input_ids"),G1.forEach(t),yh=i(lo,`. The target sequence is shifted to the right, i.e., prepended by a
...
language modeling head on top of the decoder.`),Wc.forEach(t),oc=l(n),Mn=s(n,"UL",{});var Rc=a(Mn);dt=s(Rc,"LI",{});var It=a(dt);qi=s(It,"P",{});var R1=a(qi);Mh=i(R1,"Unsupervised denoising training"),R1.forEach(t),Ph=l(It),_e=s(It,"P",{});var tt=a(_e);Ch=i(tt,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=s(tt,"EM",{});var H1=a(ji);Ah=i(H1,"a.k.a"),H1.forEach(t),Nh=i(tt,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Fi=s(tt,"EM",{});var V1=a(Fi);Ih=i(V1,"real"),V1.forEach(t),Lh=i(tt,` masked tokens. Each
...
`),Pi=s(tt,"CODE",{});var Y1=a(Pi);Oh=i(Y1,"<extra_id_1>"),Y1.forEach(t),Gh=i(tt,", \u2026 up to "),Ci=s(tt,"CODE",{});var J1=a(Ci);Bh=i(J1,"<extra_id_99>"),J1.forEach(t),Uh=i(tt,`. As a default, 100 sentinel tokens are available in
`),rr=s(tt,"A",{href:!0});var Z1=a(rr);Wh=i(Z1,"T5Tokenizer"),Z1.forEach(t),Rh=i(tt,"."),tt.forEach(t),Hh=l(It),Ai=s(It,"P",{});var X1=a(Ai);Vh=i(X1,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
processed as follows:`),X1.forEach(t),Kh=l(It),_(Eo.$$.fragment,It),Yh=l(It),qo=s(It,"P",{});var Hc=a(qo);Jh=i(Hc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),jo=s(Hc,"A",{href:!0,rel:!0});var Q1=a(jo);Zh=i(Q1,"run_t5_mlm_flax.py"),Q1.forEach(t),Xh=i(Hc,` script in the Examples
...
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
during T5\u2019s pre-training.`),ye.forEach(t),vu=l(nt),Zt=s(nt,"P",{});var Gr=a(Zt);bu=i(Gr,`However, the example above only shows a single training example. In practice, one trains deep learning models in
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
...
`),Ji=s(ot,"CODE",{});var _5=a(Ji);Du=i(_5,"attention_mask"),_5.forEach(t),Su=i(ot,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),ot.forEach(t),Ou=l(nt),_(Po.$$.fragment,nt),nt.forEach(t),Rc.forEach(t),sc=l(n),ir=s(n,"P",{});var g5=a(ir);Gu=i(g5,"Additional training tips:"),g5.forEach(t),ac=l(n),qt=s(n,"UL",{});var Br=a(qt);Zi=s(Br,"LI",{});var T5=a(Zi);Co=s(T5,"P",{});var Vc=a(Co);Bu=i(Vc,"T5 models need a slightly higher learning rate than the default one set in the "),Xi=s(Vc,"CODE",{});var k5=a(Xi);Uu=i(k5,"Trainer"),k5.forEach(t),Wu=i(Vc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
...
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),No=s(Ur,"A",{href:!0,rel:!0});var w5=a(No);Yu=i(w5,"paper"),w5.forEach(t),Ju=i(Ur,` for the task prefixes
used).`),Ur.forEach(t),v5.forEach(t),Zu=l(Br),ed=s(Br,"LI",{});var y5=a(ed);Io=s(y5,"P",{});var Kc=a(Io);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
`),cr=s(Lt,"A",{href:!0});var C5=a(cr);fm=i(C5,"generate()"),C5.forEach(t),_m=i(Lt,", make sure you start it with the "),rd=s(Lt,"CODE",{});var A5=a(rd);gm=i(A5,"pad_token_id"),A5.forEach(t),Tm=i(Lt,"."),Lt.forEach(t),pc=l(n),pr=s(n,"P",{});var N5=a(pr);km=i(N5,"The example above only shows a single example. You can also do batched inference, like so:"),N5.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Jc=a(en);Cn=s(Jc,"A",{id:!0,class:!0,href:!0});var I5=a(Cn);id=s(I5,"SPAN",{});var L5=a(id);_(Bo.$$.fragment,L5),L5.forEach(t),I5.forEach(t),vm=l(Jc),dd=s(Jc,"SPAN",{});var D5=a(dd);bm=i(D5,"Performance"),D5.forEach(t),Jc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);wm=i(po,"If you\u2019d like a faster training and inference performance, install "),Uo=s(po,"A",{href:!0,rel:!0});var S5=a(Uo);ym=i(S5,"apex"),S5.forEach(t),$m=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var O5=a(ld);zm=i(O5,"apex.normalization.FusedRMSNorm"),O5.forEach(t),xm=i(po," instead of "),cd=s(po,"CODE",{});var G5=a(cd);Em=i(G5,"T5LayerNorm"),G5.forEach(t),qm=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Zc=a(tn);An=s(Zc,"A",{id:!0,class:!0,href:!0});var B5=a(An);pd=s(B5,"SPAN",{});var U5=a(pd);_(Wo.$$.fragment,U5),U5.forEach(t),B5.forEach(t),jm=l(Zc),hd=s(Zc,"SPAN",{});var W5=a(hd);Fm=i(W5,"Example scripts"),W5.forEach(t),Zc.forEach(t),gc=l(n),ur=s(n,"P",{});var R5=a(ur);Mm=i(R5,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),R5.forEach(t),Tc=l(n),Nn=s(n,"UL",{});var Xc=a(Nn);ud=s(Xc,"LI",{});var H5=a(ud);nn=s(H5,"P",{});var Wr=a(nn);Pm=i(Wr,"pre-training: the "),Ro=s(Wr,"A",{href:!0,rel:!0});var V5=a(Ro);Cm=i(V5,"run_t5_mlm_flax.py"),V5.forEach(t),Am=i(Wr,`
...
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Wr.forEach(t),H5.forEach(t),Lm=l(Xc),md=s(Xc,"LI",{});var Y5=a(md);De=s(Y5,"P",{});var wt=a(De);Dm=i(wt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(wt,"A",{href:!0,rel:!0});var J5=a(Vo);Sm=i(J5,"PyTorch"),J5.forEach(t),Om=i(wt,", "),Ko=s(wt,"A",{href:!0,rel:!0});var Z5=a(Ko);Gm=i(Z5,"Tensorflow"),Z5.forEach(t),Bm=i(wt,", and "),Yo=s(wt,"A",{href:!0,rel:!0});var X5=a(Yo);Um=i(X5,"Flax"),X5.forEach(t),Wm=i(wt,`) and translation scripts
(`),Jo=s(wt,"A",{href:!0,rel:!0});var Q5=a(Jo);Rm=i(Q5,"PyTorch"),Q5.forEach(t),Hm=i(wt," and "),Zo=s(wt,"A",{href:!0,rel:!0});var eb=a(Zo);Vm=i(eb,"Tensorflow"),eb.forEach(t),Km=i(wt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),wt.forEach(t),Y5.forEach(t),Xc.forEach(t),kc=l(n),on=s(n,"H2",{class:!0});var Qc=a(on);In=s(Qc,"A",{id:!0,class:!0,href:!0});var tb=a(In);fd=s(tb,"SPAN",{});var nb=a(fd);_(Xo.$$.fragment,nb),nb.forEach(t),tb.forEach(t),Ym=l(Qc),_d=s(Qc,"SPAN",{});var ob=a(_d);Jm=i(ob,"T5Config"),ob.forEach(t),Qc.forEach(t),vc=l(n),yt=s(n,"DIV",{class:!0});var Rr=a(yt);_(Qo.$$.fragment,Rr),Zm=l(Rr),$t=s(Rr,"P",{});var ho=a($t);Xm=i(ho,"This is the configuration class to store the configuration of a "),mr=s(ho,"A",{href:!0});var sb=a(mr);Qm=i(sb,"T5Model"),sb.forEach(t),ef=i(ho," or a "),fr=s(ho,"A",{href:!0});var ab=a(fr);tf=i(ab,"TFT5Model"),ab.forEach(t),nf=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),es=s(ho,"A",{href:!0,rel:!0});var rb=a(es);of=i(rb,"t5-small"),rb.forEach(t),sf=i(ho," architecture."),ho.forEach(t),af=l(Rr),sn=s(Rr,"P",{});var Hr=a(sn);rf=i(Hr,"Configuration objects inherit from "),_r=s(Hr,"A",{href:!0});var ib=a(_r);df=i(ib,"PretrainedConfig"),ib.forEach(t),lf=i(Hr,` and can be used to control the model outputs. Read the
documentation from `),gr=s(Hr,"A",{href:!0});var db=a(gr);cf=i(db,"PretrainedConfig"),db.forEach(t),pf=i(Hr," for more information."),Hr.forEach(t),Rr.forEach(t),bc=l(n),an=s(n,"H2",{class:!0});var ep=a(an);Ln=s(ep,"A",{id:!0,class:!0,href:!0});var lb=a(Ln);gd=s(lb,"SPAN",{});var cb=a(gd);_(ts.$$.fragment,cb),cb.forEach(t),lb.forEach(t),hf=l(ep),Td=s(ep,"SPAN",{});var pb=a(Td);uf=i(pb,"T5Tokenizer"),pb.forEach(t),ep.forEach(t),wc=l(n),ie=s(n,"DIV",{class:!0});var st=a(ie);_(ns.$$.fragment,st),mf=l(st),os=s(st,"P",{});var tp=a(os);ff=i(tp,"Construct a T5 tokenizer. Based on "),ss=s(tp,"A",{href:!0,rel:!0});var hb=a(ss);_f=i(hb,"SentencePiece"),hb.forEach(t),gf=i(tp,"."),tp.forEach(t),Tf=l(st),as=s(st,"P",{});var np=a(as);kf=i(np,"This tokenizer inherits from "),Tr=s(np,"A",{href:!0});var ub=a(Tr);vf=i(ub,"PreTrainedTokenizer"),ub.forEach(t),bf=i(np,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),np.forEach(t),wf=l(st),jt=s(st,"DIV",{class:!0});var Vr=a(jt);_(rs.$$.fragment,Vr),yf=l(Vr),kd=s(Vr,"P",{});var mb=a(kd);$f=i(mb,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),mb.forEach(t),zf=l(Vr),is=s(Vr,"UL",{});var op=a(is);kr=s(op,"LI",{});var Kv=a(kr);xf=i(Kv,"single sequence: "),vd=s(Kv,"CODE",{});var fb=a(vd);Ef=i(fb,"X </s>"),fb.forEach(t),Kv.forEach(t),qf=l(op),vr=s(op,"LI",{});var Yv=a(vr);jf=i(Yv,"pair of sequences: "),bd=s(Yv,"CODE",{});var _b=a(bd);Ff=i(_b,"A </s> B </s>"),_b.forEach(t),Yv.forEach(t),op.forEach(t),Vr.forEach(t),Mf=l(st),Dn=s(st,"DIV",{class:!0});var sp=a(Dn);_(ds.$$.fragment,sp),Pf=l(sp),ls=s(sp,"P",{});var ap=a(ls);Cf=i(ap,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),wd=s(ap,"CODE",{});var gb=a(wd);Af=i(gb,"prepare_for_model"),gb.forEach(t),Nf=i(ap," method."),ap.forEach(t),sp.forEach(t),If=l(st),Sn=s(st,"DIV",{class:!0});var rp=a(Sn);_(cs.$$.fragment,rp),Lf=l(rp),yd=s(rp,"P",{});var Tb=a(yd);Df=i(Tb,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Tb.forEach(t),rp.forEach(t),Sf=l(st),br=s(st,"DIV",{class:!0});var kb=a(br);_(ps.$$.fragment,kb),kb.forEach(t),st.forEach(t),yc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);On=s(ip,"A",{id:!0,class:!0,href:!0});var vb=a(On);$d=s(vb,"SPAN",{});var bb=a($d);_(hs.$$.fragment,bb),bb.forEach(t),vb.forEach(t),Of=l(ip),zd=s(ip,"SPAN",{});var wb=a(zd);Gf=i(wb,"T5TokenizerFast"),wb.forEach(t),ip.forEach(t),$c=l(n),Se=s(n,"DIV",{class:!0});var Dt=a(Se);_(us.$$.fragment,Dt),Bf=l(Dt),dn=s(Dt,"P",{});var Kr=a(dn);Uf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),xd=s(Kr,"EM",{});var yb=a(xd);Wf=i(yb,"tokenizers"),yb.forEach(t),Rf=i(Kr,` library). Based on
`),ms=s(Kr,"A",{href:!0,rel:!0});var $b=a(ms);Hf=i($b,"Unigram"),$b.forEach(t),Vf=i(Kr,"."),Kr.forEach(t),Kf=l(Dt),fs=s(Dt,"P",{});var dp=a(fs);Yf=i(dp,"This tokenizer inherits from "),wr=s(dp,"A",{href:!0});var zb=a(wr);Jf=i(zb,"PreTrainedTokenizerFast"),zb.forEach(t),Zf=i(dp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),dp.forEach(t),Xf=l(Dt),Ft=s(Dt,"DIV",{class:!0});var Yr=a(Ft);_(_s.$$.fragment,Yr),Qf=l(Yr),Ed=s(Yr,"P",{});var xb=a(Ed);e_=i(xb,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),xb.forEach(t),t_=l(Yr),gs=s(Yr,"UL",{});var lp=a(gs);yr=s(lp,"LI",{});var Jv=a(yr);n_=i(Jv,"single sequence: "),qd=s(Jv,"CODE",{});var Eb=a(qd);o_=i(Eb,"X </s>"),Eb.forEach(t),Jv.forEach(t),s_=l(lp),$r=s(lp,"LI",{});var Zv=a($r);a_=i(Zv,"pair of sequences: "),jd=s(Zv,"CODE",{});var qb=a(jd);r_=i(qb,"A </s> B </s>"),qb.forEach(t),Zv.forEach(t),lp.forEach(t),Yr.forEach(t),i_=l(Dt),Gn=s(Dt,"DIV",{class:!0});var cp=a(Gn);_(Ts.$$.fragment,cp),d_=l(cp),Fd=s(cp,"P",{});var jb=a(Fd);l_=i(jb,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),jb.forEach(t),cp.forEach(t),Dt.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Bn=s(pp,"A",{id:!0,class:!0,href:!0});var Fb=a(Bn);Md=s(Fb,"SPAN",{});var Mb=a(Md);_(ks.$$.fragment,Mb),Mb.forEach(t),Fb.forEach(t),c_=l(pp),Pd=s(pp,"SPAN",{});var Pb=a(Pd);p_=i(Pb,"T5Model"),Pb.forEach(t),pp.forEach(t),xc=l(n),Z=s(n,"DIV",{class:!0});var $e=a(Z);_(vs.$$.fragment,$e),h_=l($e),Cd=s($e,"P",{});var Cb=a(Cd);u_=i(Cb,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Cb.forEach(t),m_=l($e),bs=s($e,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ws=s(hp,"A",{href:!0,rel:!0});var Ab=a(ws);__=i(Ab,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Ab.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l($e),ys=s($e,"P",{});var up=a(ys);k_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var Nb=a(zr);v_=i(Nb,"PreTrainedModel"),Nb.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),w_=l($e),$s=s($e,"P",{});var mp=a($s);y_=i(mp,"This model is also a PyTorch "),zs=s(mp,"A",{href:!0,rel:!0});var Ib=a(zs);$_=i(Ib,"torch.nn.Module"),Ib.forEach(t),z_=i(mp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),x_=l($e),We=s($e,"DIV",{class:!0});var St=a(We);_(xs.$$.fragment,St),E_=l(St),cn=s(St,"P",{});var Jr=a(cn);q_=i(Jr,"The "),xr=s(Jr,"A",{href:!0});var Lb=a(xr);j_=i(Lb,"T5Model"),Lb.forEach(t),F_=i(Jr," forward method, overrides the "),Ad=s(Jr,"CODE",{});var Db=a(Ad);M_=i(Db,"__call__"),Db.forEach(t),P_=i(Jr," special method."),Jr.forEach(t),C_=l(St),_(Un.$$.fragment,St),A_=l(St),Nd=s(St,"P",{});var Sb=a(Nd);N_=i(Sb,"Example:"),Sb.forEach(t),I_=l(St),_(Es.$$.fragment,St),St.forEach(t),L_=l($e),Re=s($e,"DIV",{class:!0});var Ot=a(Re);_(qs.$$.fragment,Ot),D_=l(Ot),Id=s(Ot,"P",{});var Ob=a(Id);S_=i(Ob,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Ob.forEach(t),O_=l(Ot),Ld=s(Ot,"P",{});var Gb=a(Ld);G_=i(Gb,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Gb.forEach(t),B_=l(Ot),Dd=s(Ot,"P",{});var Bb=a(Dd);U_=i(Bb,"Example:"),Bb.forEach(t),W_=l(Ot),_(js.$$.fragment,Ot),Ot.forEach(t),R_=l($e),kt=s($e,"DIV",{class:!0});var uo=a(kt);_(Fs.$$.fragment,uo),H_=l(uo),Sd=s(uo,"P",{});var Ub=a(Sd);V_=i(Ub,"Moves the model to cpu from a model parallel state."),Ub.forEach(t),K_=l(uo),Od=s(uo,"P",{});var Wb=a(Od);Y_=i(Wb,"Example:"),Wb.forEach(t),J_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),$e.forEach(t),Ec=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Wn=s(fp,"A",{id:!0,class:!0,href:!0});var Rb=a(Wn);Gd=s(Rb,"SPAN",{});var Hb=a(Gd);_(Ps.$$.fragment,Hb),Hb.forEach(t),Rb.forEach(t),Z_=l(fp),Bd=s(fp,"SPAN",{});var Vb=a(Bd);X_=i(Vb,"T5ForConditionalGeneration"),Vb.forEach(t),fp.forEach(t),qc=l(n),X=s(n,"DIV",{class:!0});var ze=a(X);_(Cs.$$.fragment,ze),Q_=l(ze),As=s(ze,"P",{});var _p=a(As);eg=i(_p,"T5 Model with a "),Ud=s(_p,"CODE",{});var Kb=a(Ud);tg=i(Kb,"language modeling"),Kb.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l(ze),Ns=s(ze,"P",{});var gp=a(Ns);sg=i(gp,"The T5 model was proposed in "),Is=s(gp,"A",{href:!0,rel:!0});var Yb=a(Is);ag=i(Yb,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Yb.forEach(t),rg=i(gp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),gp.forEach(t),ig=l(ze),Ls=s(ze,"P",{});var Tp=a(Ls);dg=i(Tp,"This model inherits from "),Er=s(Tp,"A",{href:!0});var Jb=a(Er);lg=i(Jb,"PreTrainedModel"),Jb.forEach(t),cg=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l(ze),Ds=s(ze,"P",{});var kp=a(Ds);hg=i(kp,"This model is also a PyTorch "),Ss=s(kp,"A",{href:!0,rel:!0});var Zb=a(Ss);ug=i(Zb,"torch.nn.Module"),Zb.forEach(t),mg=i(kp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kp.forEach(t),fg=l(ze),He=s(ze,"DIV",{class:!0});var Gt=a(He);_(Os.$$.fragment,Gt),_g=l(Gt),hn=s(Gt,"P",{});var Zr=a(hn);gg=i(Zr,"The "),qr=s(Zr,"A",{href:!0});var Xb=a(qr);Tg=i(Xb,"T5ForConditionalGeneration"),Xb.forEach(t),kg=i(Zr," forward method, overrides the "),Wd=s(Zr,"CODE",{});var Qb=a(Wd);vg=i(Qb,"__call__"),Qb.forEach(t),bg=i(Zr," special method."),Zr.forEach(t),wg=l(Gt),_(Rn.$$.fragment,Gt),yg=l(Gt),Rd=s(Gt,"P",{});var ew=a(Rd);$g=i(ew,"Examples:"),ew.forEach(t),zg=l(Gt),_(Gs.$$.fragment,Gt),Gt.forEach(t),xg=l(ze),Ve=s(ze,"DIV",{class:!0});var Bt=a(Ve);_(Bs.$$.fragment,Bt),Eg=l(Bt),Hd=s(Bt,"P",{});var tw=a(Hd);qg=i(tw,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),tw.forEach(t),jg=l(Bt),Vd=s(Bt,"P",{});var nw=a(Vd);Fg=i(nw,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),nw.forEach(t),Mg=l(Bt),Kd=s(Bt,"P",{});var ow=a(Kd);Pg=i(ow,"Example:"),ow.forEach(t),Cg=l(Bt),_(Us.$$.fragment,Bt),Bt.forEach(t),Ag=l(ze),vt=s(ze,"DIV",{class:!0});var mo=a(vt);_(Ws.$$.fragment,mo),Ng=l(mo),Yd=s(mo,"P",{});var sw=a(Yd);Ig=i(sw,"Moves the model to cpu from a model parallel state."),sw.forEach(t),Lg=l(mo),Jd=s(mo,"P",{});var aw=a(Jd);Dg=i(aw,"Example:"),aw.forEach(t),Sg=l(mo),_(Rs.$$.fragment,mo),mo.forEach(t),ze.forEach(t),jc=l(n),un=s(n,"H2",{class:!0});var vp=a(un);Hn=s(vp,"A",{id:!0,class:!0,href:!0});var rw=a(Hn);Zd=s(rw,"SPAN",{});var iw=a(Zd);_(Hs.$$.fragment,iw),iw.forEach(t),rw.forEach(t),Og=l(vp),Xd=s(vp,"SPAN",{});var dw=a(Xd);Gg=i(dw,"T5EncoderModel"),dw.forEach(t),vp.forEach(t),Fc=l(n),Q=s(n,"DIV",{class:!0});var xe=a(Q);_(Vs.$$.fragment,xe),Bg=l(xe),Qd=s(xe,"P",{});var lw=a(Qd);Ug=i(lw,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),lw.forEach(t),Wg=l(xe),Ks=s(xe,"P",{});var bp=a(Ks);Rg=i(bp,"The T5 model was proposed in "),Ys=s(bp,"A",{href:!0,rel:!0});var cw=a(Ys);Hg=i(cw,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),cw.forEach(t),Vg=i(bp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),bp.forEach(t),Kg=l(xe),Js=s(xe,"P",{});var wp=a(Js);Yg=i(wp,"This model inherits from "),jr=s(wp,"A",{href:!0});var pw=a(jr);Jg=i(pw,"PreTrainedModel"),pw.forEach(t),Zg=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp.forEach(t),Xg=l(xe),Zs=s(xe,"P",{});var yp=a(Zs);Qg=i(yp,"This model is also a PyTorch "),Xs=s(yp,"A",{href:!0,rel:!0});var hw=a(Xs);eT=i(hw,"torch.nn.Module"),hw.forEach(t),tT=i(yp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ep.forEach(t),UT=l(at),_(Yn.$$.fragment,at),WT=l(at),Je=s(at,"DIV",{class:!0});var Rt=a(Je);_(ha.$$.fragment,Rt),RT=l(Rt),_n=s(Rt,"P",{});var Qr=a(_n);HT=i(Qr,"The "),Pr=s(Qr,"A",{href:!0});var qw=a(Pr);VT=i(qw,"TFT5Model"),qw.forEach(t),KT=i(Qr," forward method, overrides the "),cl=s(Qr,"CODE",{});var jw=a(cl);YT=i(jw,"__call__"),jw.forEach(t),JT=i(Qr," special method."),Qr.forEach(t),ZT=l(Rt),_(Jn.$$.fragment,Rt),XT=l(Rt),pl=s(Rt,"P",{});var Fw=a(pl);QT=i(Fw,"Examples:"),Fw.forEach(t),ek=l(Rt),_(ua.$$.fragment,Rt),Rt.forEach(t),at.forEach(t),Cc=l(n),gn=s(n,"H2",{class:!0});var qp=a(gn);Zn=s(qp,"A",{id:!0,class:!0,href:!0});var Mw=a(Zn);hl=s(Mw,"SPAN",{});var Pw=a(hl);_(ma.$$.fragment,Pw),Pw.forEach(t),Mw.forEach(t),tk=l(qp),ul=s(qp,"SPAN",{});var Cw=a(ul);nk=i(Cw,"TFT5ForConditionalGeneration"),Cw.forEach(t),qp.forEach(t),Ac=l(n),le=s(n,"DIV",{class:!0});var rt=a(le);_(fa.$$.fragment,rt),ok=l(rt),_a=s(rt,"P",{});var jp=a(_a);sk=i(jp,"T5 Model with a "),ml=s(jp,"CODE",{});var Aw=a(ml);ak=i(Aw,"language modeling"),Aw.forEach(t),rk=i(jp," head on top."),jp.forEach(t),ik=l(rt),ga=s(rt,"P",{});var Fp=a(ga);dk=i(Fp,"The T5 model was proposed in "),Ta=s(Fp,"A",{href:!0,rel:!0});var Nw=a(Ta);lk=i(Nw,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
