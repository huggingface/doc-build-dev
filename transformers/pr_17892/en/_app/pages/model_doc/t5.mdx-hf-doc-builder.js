import{S as Y1,i as Z1,s as J1,e as a,k as d,w as k,t as o,M as X1,c as r,d as t,m as c,a as i,x as v,h as s,b as h,G as e,g as m,y,q as w,o as $,B as x,v as Q1,L as ge}from"../../chunks/vendor-hf-doc-builder.js";import{T as wt}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as S}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ke}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _e}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function e5(j){let p,b,g,u,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17892/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17892/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17892/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17892/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17892/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17892/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17892/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_17892/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/modeling_tf_t5.py#L1137",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17892/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/modeling_tf_t5.py#L1313",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17892/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_17892/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17892/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_17892/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/modeling_tf_t5.py#L1619",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17892/src/transformers/models/t5/modeling_flax_t5.py#L956",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17892/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17892/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17892/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_17892/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
(`),cs=r(bt,"A",{href:!0,rel:!0});var Qv=i(cs);Sm=s(Qv,"PyTorch"),Qv.forEach(t),Gm=s(bt," and "),ps=r(bt,"A",{href:!0,rel:!0});var ey=i(ps);Um=s(ey,"Tensorflow"),ey.forEach(t),Bm=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),Yv.forEach(t),tp.forEach(t),wc=c(n),St=r(n,"H2",{class:!0});var np=i(St);yn=r(np,"A",{id:!0,class:!0,href:!0});var ty=i(yn);ll=r(ty,"SPAN",{});var ny=i(ll);v(hs.$$.fragment,ny),ny.forEach(t),ty.forEach(t),Wm=c(np),dl=r(np,"SPAN",{});var oy=i(dl);Rm=s(oy,"T5Config"),oy.forEach(t),np.forEach(t),$c=c(n),kt=r(n,"DIV",{class:!0});var Wr=i(kt);v(us.$$.fragment,Wr),Hm=c(Wr),vt=r(Wr,"P",{});var bo=i(vt);Vm=s(bo,"This is the configuration class to store the configuration of a "),_r=r(bo,"A",{href:!0});var sy=i(_r);Km=s(sy,"T5Model"),sy.forEach(t),Ym=s(bo," or a "),gr=r(bo,"A",{href:!0});var ay=i(gr);Zm=s(ay,"TFT5Model"),ay.forEach(t),Jm=s(bo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ms=r(bo,"A",{href:!0,rel:!0});var ry=i(ms);Xm=s(ry,"t5-small"),ry.forEach(t),Qm=s(bo," architecture."),bo.forEach(t),ef=c(Wr),Gt=r(Wr,"P",{});var Rr=i(Gt);tf=s(Rr,"Configuration objects inherit from "),Tr=r(Rr,"A",{href:!0});var iy=i(Tr);nf=s(iy,"PretrainedConfig"),iy.forEach(t),of=s(Rr,` and can be used to control the model outputs. Read the
documentation from `),br=r(Rr,"A",{href:!0});var ly=i(br);sf=s(ly,"PretrainedConfig"),ly.forEach(t),af=s(Rr," for more information."),Rr.forEach(t),Wr.forEach(t),xc=c(n),Ut=r(n,"H2",{class:!0});var op=i(Ut);wn=r(op,"A",{id:!0,class:!0,href:!0});var dy=i(wn);cl=r(dy,"SPAN",{});var cy=i(cl);v(fs.$$.fragment,cy),cy.forEach(t),dy.forEach(t),rf=c(op),pl=r(op,"SPAN",{});var py=i(pl);lf=s(py,"T5Tokenizer"),py.forEach(t),op.forEach(t),zc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);v(_s.$$.fragment,Ve),df=c(Ve),gs=r(Ve,"P",{});var sp=i(gs);cf=s(sp,"Construct a T5 tokenizer. Based on "),Ts=r(sp,"A",{href:!0,rel:!0});var hy=i(Ts);pf=s(hy,"SentencePiece"),hy.forEach(t),hf=s(sp,"."),sp.forEach(t),uf=c(Ve),bs=r(Ve,"P",{});var ap=i(bs);mf=s(ap,"This tokenizer inherits from "),kr=r(ap,"A",{href:!0});var uy=i(kr);ff=s(uy,"PreTrainedTokenizer"),uy.forEach(t),_f=s(ap,` which contains most of the main methods. Users should refer to
...
use of token type ids, therefore a list of zeros is returned.`),Ty.forEach(t),dp.forEach(t),Nf=c(Ve),wr=r(Ve,"DIV",{class:!0});var by=i(wr);v(xs.$$.fragment,by),by.forEach(t),Ve.forEach(t),jc=c(n),Bt=r(n,"H2",{class:!0});var cp=i(Bt);zn=r(cp,"A",{id:!0,class:!0,href:!0});var ky=i(zn);gl=r(ky,"SPAN",{});var vy=i(gl);v(zs.$$.fragment,vy),vy.forEach(t),ky.forEach(t),Of=c(cp),Tl=r(cp,"SPAN",{});var yy=i(Tl);Lf=s(yy,"T5TokenizerFast"),yy.forEach(t),cp.forEach(t),qc=c(n),Se=r(n,"DIV",{class:!0});var Nt=i(Se);v(js.$$.fragment,Nt),Af=c(Nt),Wt=r(Nt,"P",{});var Vr=i(Wt);If=s(Vr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),bl=r(Vr,"EM",{});var wy=i(bl);Df=s(wy,"tokenizers"),wy.forEach(t),Sf=s(Vr,` library). Based on
`),qs=r(Vr,"A",{href:!0,rel:!0});var $y=i(qs);Gf=s($y,"Unigram"),$y.forEach(t),Uf=s(Vr,"."),Vr.forEach(t),Bf=c(Nt),Es=r(Nt,"P",{});var pp=i(Es);Wf=s(pp,"This tokenizer inherits from "),$r=r(pp,"A",{href:!0});var xy=i($r);Rf=s(xy,"PreTrainedTokenizerFast"),xy.forEach(t),Hf=s(pp,` which contains most of the main methods. Users should
...
it will evenly distribute blocks across all devices.`),Xy.forEach(t),Tg=c(wo),v(Ln.$$.fragment,wo),wo.forEach(t),bg=c(ze),Mt=r(ze,"DIV",{class:!0});var Xr=i(Mt);v(Qs.$$.fragment,Xr),kg=c(Xr),Al=r(Xr,"P",{});var Qy=i(Al);vg=s(Qy,"Moves the model to cpu from a model parallel state."),Qy.forEach(t),yg=c(Xr),v(An.$$.fragment,Xr),Xr.forEach(t),ze.forEach(t),Pc=c(n),Yt=r(n,"H2",{class:!0});var wp=i(Yt);In=r(wp,"A",{id:!0,class:!0,href:!0});var e1=i(In);Il=r(e1,"SPAN",{});var t1=i(Il);v(ea.$$.fragment,t1),t1.forEach(t),e1.forEach(t),wg=c(wp),Dl=r(wp,"SPAN",{});var n1=i(Dl);$g=s(n1,"T5EncoderModel"),n1.forEach(t),wp.forEach(t),Nc=c(n),Q=r(n,"DIV",{class:!0});var je=i(Q);v(ta.$$.fragment,je),xg=c(je),Sl=r(je,"P",{});var o1=i(Sl);zg=s(o1,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),o1.forEach(t),jg=c(je),na=r(je,"P",{});var $p=i(na);qg=s($p,"The T5 model was proposed in "),oa=r($p,"A",{href:!0,rel:!0});var s1=i(oa);Eg=s(s1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zp.forEach(t),Dg=c(je),ht=r(je,"DIV",{class:!0});var $o=i(ht);v(ia.$$.fragment,$o),Sg=c($o),Zt=r($o,"P",{});var Qr=i(Zt);Gg=s(Qr,"The "),Cr=r(Qr,"A",{href:!0});var i1=i(Cr);Ug=s(i1,"T5EncoderModel"),i1.forEach(t),Bg=s(Qr," forward method, overrides the "),Gl=r(Qr,"CODE",{});var l1=i(Gl);Wg=s(l1,"__call__"),l1.forEach(t),Rg=s(Qr," special method."),Qr.forEach(t),Hg=c($o),v(Dn.$$.fragment,$o),Vg=c($o),v(Sn.$$.fragment,$o),$o.forEach(t),Kg=c(je),ut=r(je,"DIV",{class:!0});var xo=i(ut);v(la.$$.fragment,xo),Yg=c(xo),Ul=r(xo,"P",{});var d1=i(Ul);Zg=s(d1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),d1.forEach(t),Jg=c(xo),Bl=r(xo,"P",{});var c1=i(Bl);Xg=s(c1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),c1.forEach(t),Qg=c(xo),v(Gn.$$.fragment,xo),xo.forEach(t),eT=c(je),Ct=r(je,"DIV",{class:!0});var ei=i(Ct);v(da.$$.fragment,ei),tT=c(ei),Wl=r(ei,"P",{});var p1=i(Wl);nT=s(p1,"Moves the model to cpu from a model parallel state."),p1.forEach(t),oT=c(ei),v(Un.$$.fragment,ei),ei.forEach(t),je.forEach(t),Oc=c(n),Jt=r(n,"H2",{class:!0});var jp=i(Jt);Bn=r(jp,"A",{id:!0,class:!0,href:!0});var h1=i(Bn);Rl=r(h1,"SPAN",{});var u1=i(Rl);v(ca.$$.fragment,u1),u1.forEach(t),h1.forEach(t),sT=c(jp),Hl=r(jp,"SPAN",{});var m1=i(Hl);aT=s(m1,"TFT5Model"),m1.forEach(t),jp.forEach(t),Lc=c(n),le=r(n,"DIV",{class:!0});var Ke=i(le);v(pa.$$.fragment,Ke),rT=c(Ke),Vl=r(Ke,"P",{});var f1=i(Vl);iT=s(f1,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),f1.forEach(t),lT=c(Ke),ha=r(Ke,"P",{});var qp=i(ha);dT=s(qp,"The T5 model was proposed in "),ua=r(qp,"A",{href:!0,rel:!0});var _1=i(ua);cT=s(_1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),kT=c(Ke),v(Wn.$$.fragment,Ke),vT=c(Ke),mt=r(Ke,"DIV",{class:!0});var zo=i(mt);v(ga.$$.fragment,zo),yT=c(zo),Xt=r(zo,"P",{});var ti=i(Xt);wT=s(ti,"The "),Nr=r(ti,"A",{href:!0});var b1=i(Nr);$T=s(b1,"TFT5Model"),b1.forEach(t),xT=s(ti," forward method, overrides the "),Kl=r(ti,"CODE",{});var k1=i(Kl);zT=s(k1,"__call__"),k1.forEach(t),jT=s(ti," special method."),ti.forEach(t),qT=c(zo),v(Rn.$$.fragment,zo),ET=c(zo),v(Hn.$$.fragment,zo),zo.forEach(t),Ke.forEach(t),Ac=c(n),Qt=r(n,"H2",{class:!0});var Mp=i(Qt);Vn=r(Mp,"A",{id:!0,class:!0,href:!0});var v1=i(Vn);Yl=r(v1,"SPAN",{});var y1=i(Yl);v(Ta.$$.fragment,y1),y1.forEach(t),v1.forEach(t),FT=c(Mp),Zl=r(Mp,"SPAN",{});var w1=i(Zl);MT=s(w1,"TFT5ForConditionalGeneration"),w1.forEach(t),Mp.forEach(t),Ic=c(n),de=r(n,"DIV",{class:!0});var Ye=i(de);v(ba.$$.fragment,Ye),CT=c(Ye),ka=r(Ye,"P",{});var Cp=i(ka);PT=s(Cp,"T5 Model with a "),Jl=r(Cp,"CODE",{});var $1=i(Jl);NT=s($1,"language modeling"),$1.forEach(t),OT=s(Cp," head on top."),Cp.forEach(t),LT=c(Ye),va=r(Ye,"P",{});var Pp=i(va);AT=s(Pp,"The T5 model was proposed in "),ya=r(Pp,"A",{href:!0,rel:!0});var x1=i(ya);IT=s(x1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),x1.forEach(t),DT=s(Pp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Pp.forEach(t),ST=c(Ye),wa=r(Ye,"P",{});var Np=i(wa);GT=s(Np,"This model inherits from "),Or=r(Np,"A",{href:!0});var z1=i(Or);UT=s(z1,"TFPreTrainedModel"),z1.forEach(t),BT=s(Np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Np.forEach(t),WT=c(Ye),$a=r(Ye,"P",{});var Op=i($a);RT=s(Op,"This model is also a "),xa=r(Op,"A",{href:!0,rel:!0});var j1=i(xa);HT=s(j1,"tf.keras.Model"),j1.forEach(t),VT=s(Op,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Op.forEach(t),KT=c(Ye),v(Kn.$$.fragment,Ye),YT=c(Ye),ft=r(Ye,"DIV",{class:!0});var jo=i(ft);v(za.$$.fragment,jo),ZT=c(jo),en=r(jo,"P",{});var ni=i(en);JT=s(ni,"The "),Lr=r(ni,"A",{href:!0});var q1=i(Lr);XT=s(q1,"TFT5ForConditionalGeneration"),q1.forEach(t),QT=s(ni," forward method, overrides the "),Xl=r(ni,"CODE",{});var E1=i(Xl);eb=s(E1,"__call__"),E1.forEach(t),tb=s(ni," special method."),ni.forEach(t),nb=c(jo),v(Yn.$$.fragment,jo),ob=c(jo),v(Zn.$$.fragment,jo),jo.forEach(t),Ye.forEach(t),Dc=c(n),tn=r(n,"H2",{class:!0});var Lp=i(tn);Jn=r(Lp,"A",{id:!0,class:!0,href:!0});var F1=i(Jn);Ql=r(F1,"SPAN",{});var M1=i(Ql);v(ja.$$.fragment,M1),M1.forEach(t),F1.forEach(t),sb=c(Lp),ed=r(Lp,"SPAN",{});var C1=i(ed);ab=s(C1,"TFT5EncoderModel"),C1.forEach(t),Lp.forEach(t),Sc=c(n),ce=r(n,"DIV",{class:!0});var Ze=i(ce);v(qa.$$.fragment,Ze),rb=c(Ze),td=r(Ze,"P",{});var P1=i(td);ib=s(P1,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),P1.forEach(t),lb=c(Ze),Ea=r(Ze,"P",{});var Ap=i(Ea);db=s(Ap,"The T5 model was proposed in "),Fa=r(Ap,"A",{href:!0,rel:!0});var N1=i(Fa);cb=s(N1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
