...
This is the configuration class to store the configuration of a [RetriBertModel](/docs/transformers/pr_15509/en/model_doc/retribert#transformers.RetriBertModel). It is used to instantiate a
...
`RetroBertTokenizer` is identical to [BertTokenizer](/docs/transformers/pr_15509/en/model_doc/bert#transformers.BertTokenizer) and runs end-to-end tokenization: punctuation splitting
and wordpiece.
...
[RetriBertTokenizerFast](/docs/transformers/pr_15509/en/model_doc/retribert#transformers.RetriBertTokenizerFast) is identical to [BertTokenizerFast](/docs/transformers/pr_15509/en/model_doc/bert#transformers.BertTokenizerFast) and runs end-to-end tokenization: punctuation
...
<docstring><name>forward</name><anchor>transformers.RetriBertModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/pr_15509/src/transformers/models/retribert/modeling_retribert.py#L176</source><parameters>[{"name": "input_ids_query", "val": ""}, {"name": "attention_mask_query", "val": ""}, {"name": "input_ids_doc", "val": ""}, {"name": "attention_mask_doc", "val": ""}, {"name": "checkpoint_batch_size", "val": " = -1"}]</parameters><paramsdesc>- **input_ids_query** (`torch.LongTensor` of shape `(batch_size, sequence_length)`) --
  ...
  Indices can be obtained using [RetriBertTokenizer](/docs/transformers/pr_15509/en/model_doc/retribert#transformers.RetriBertTokenizer). See [PreTrainedTokenizer.encode()](/docs/transformers/pr_15509/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode) and
