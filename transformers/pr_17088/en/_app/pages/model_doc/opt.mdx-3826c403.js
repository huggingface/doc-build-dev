...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),T=i("Example:"),_=u(),b(m.$$.fragment)},l(s){p=a(s,"P",{});var g=r(p);T=l(g,"Example:"),g.forEach(o),_=f(s),P(m.$$.fragment,s)},m(s,g){h(s,p,g),t(p,T),h(s,_,g),y(m,s,g),v=!0},p:on,i(s){v||(w(m.$$.fragment,s),v=!0)},o(s){k(m.$$.fragment,s),v=!1},d(s){s&&o(p),s&&o(_),$(m,s)}}}function Kn(q){let p,T,_,m,v,s,g,H,jt,it,L,V,Ve,re,At,Ge,It,lt,G,Nt,se,St,Dt,dt,ze,Wt,ct,xe,Bt,pt,Ee,Ht,ht,z,Vt,Ue,Gt,Ut,Ze,Zt,Rt,Re,Yt,Jt,ut,O,Kt,ie,Qt,Xt,le,eo,to,de,oo,no,ce,ao,ro,ft,j,U,Ye,pe,so,Je,io,mt,M,he,lo,A,co,qe,po,ho,ue,uo,fo,mo,I,go,Fe,_o,vo,Le,To,bo,Po,Z,gt,N,R,Ke,fe,yo,Qe,wo,_t,C,me,ko,ge,$o,je,Oo,Mo,Co,_e,zo,ve,xo,Eo,qo,x,Te,Fo,S,Lo,Ae,jo,Ao,Xe,Io,No,So,Y,Do,J,vt,D,K,et,be,Wo,tt,Bo,Tt,E,Pe,Ho,ye,Vo,Ie,Go,Uo,Zo,we,Ro,ke,Yo,Jo,bt,W,Q,ot,$e,Ko,nt,Qo,Pt,B,Oe,Xo,X,Me,en,ee,yt;return s=new He({}),re=new He({}),pe=new He({}),he=new Be({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"max_position_embeddings",val:" = 2048"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"layerdrop",val:" = 0.0"},{name:"activation_function",val:" = 'relu'"},{name:"d_model",val:" = 768"},{name:"word_embed_proj_dim",val:" = 768"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"scale_embedding",val:" = False"},{name:"share_input_output_embed",val:" = True"},{name:"use_cache",val:" = False"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"decoder_start_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"do_layer_norm_before",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
...
`}}),ee=new tn({props:{anchor:"transformers.OPTForCausalLM.forward.example",$$slots:{default:[Jn]},$$scope:{ctx:q}}}),{c(){p=n("meta"),T=u(),_=n("h1"),m=n("a"),v=n("span"),b(s.$$.fragment),g=u(),H=n("span"),jt=i("OPT"),it=u(),L=n("h2"),V=n("a"),Ve=n("span"),b(re.$$.fragment),At=u(),Ge=n("span"),It=i("Overview"),lt=u(),G=n("p"),Nt=i("The OPT model was proposed in "),se=n("a"),St=i("Open Pre-trained Transformer Language Models"),Dt=i(` by Meta AI.
...
The original code can be found `),ce=n("a"),ao=i("here"),ro=i("."),ft=u(),j=n("h2"),U=n("a"),Ye=n("span"),b(pe.$$.fragment),so=u(),Je=n("span"),io=i("OPTConfig"),mt=u(),M=n("div"),b(he.$$.fragment),lo=u(),A=n("p"),co=i("This is the configuration class to store the configuration of a "),qe=n("a"),po=i("OPTModel"),ho=i(`. It is used to instantiate a OPT model
...
documentation from `),Le=n("a"),To=i("PretrainedConfig"),bo=i(" for more information."),Po=u(),b(Z.$$.fragment),gt=u(),N=n("h2"),R=n("a"),Ke=n("span"),b(fe.$$.fragment),yo=u(),Qe=n("span"),wo=i("OPTModel"),_t=u(),C=n("div"),b(me.$$.fragment),ko=u(),ge=n("p"),$o=i(`The bare OPT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),je=n("a"),Oo=i("PreTrainedModel"),Mo=i(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bt=u(),W=n("h2"),Q=n("a"),ot=n("span"),b($e.$$.fragment),Ko=u(),nt=n("span"),Qo=i("OPTForCausalLM"),Pt=u(),B=n("div"),b(Oe.$$.fragment),Xo=u(),X=n("div"),b(Me.$$.fragment),en=u(),b(ee.$$.fragment),this.h()},l(e){const c=Vn('[data-svelte="svelte-1phssyn"]',document.head);p=a(c,"META",{name:!0,content:!0}),c.forEach(o),T=f(e),_=a(e,"H1",{class:!0});var Ce=r(_);m=a(Ce,"A",{id:!0,class:!0,href:!0});var at=r(m);v=a(at,"SPAN",{});var rt=r(v);P(s.$$.fragment,rt),rt.forEach(o),at.forEach(o),g=f(Ce),H=a(Ce,"SPAN",{});var st=r(H);jt=l(st,"OPT"),st.forEach(o),Ce.forEach(o),it=f(e),L=a(e,"H2",{class:!0});var wt=r(L);V=a(wt,"A",{id:!0,class:!0,href:!0});var an=r(V);Ve=a(an,"SPAN",{});var rn=r(Ve);P(re.$$.fragment,rn),rn.forEach(o),an.forEach(o),At=f(wt),Ge=a(wt,"SPAN",{});var sn=r(Ge);It=l(sn,"Overview"),sn.forEach(o),wt.forEach(o),lt=f(e),G=a(e,"P",{});var kt=r(G);Nt=l(kt,"The OPT model was proposed in "),se=a(kt,"A",{href:!0,rel:!0});var ln=r(se);St=l(ln,"Open Pre-trained Transformer Language Models"),ln.forEach(o),Dt=l(kt,` by Meta AI.
...
The original code can be found `),ce=a(F,"A",{href:!0,rel:!0});var vn=r(ce);ao=l(vn,"here"),vn.forEach(o),ro=l(F,"."),F.forEach(o),ft=f(e),j=a(e,"H2",{class:!0});var $t=r(j);U=a($t,"A",{id:!0,class:!0,href:!0});var Tn=r(U);Ye=a(Tn,"SPAN",{});var bn=r(Ye);P(pe.$$.fragment,bn),bn.forEach(o),Tn.forEach(o),so=f($t),Je=a($t,"SPAN",{});var Pn=r(Je);io=l(Pn,"OPTConfig"),Pn.forEach(o),$t.forEach(o),mt=f(e),M=a(e,"DIV",{class:!0});var oe=r(M);P(he.$$.fragment,oe),lo=f(oe),A=a(oe,"P",{});var Ne=r(A);co=l(Ne,"This is the configuration class to store the configuration of a "),qe=a(Ne,"A",{href:!0});var yn=r(qe);po=l(yn,"OPTModel"),yn.forEach(o),ho=l(Ne,`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ct.forEach(o),qo=f(ne),x=a(ne,"DIV",{class:!0});var ae=r(x);P(Te.$$.fragment,ae),Fo=f(ae),S=a(ae,"P",{});var De=r(S);Lo=l(De,"The "),Ae=a(De,"A",{href:!0});var En=r(Ae);jo=l(En,"OPTModel"),En.forEach(o),Ao=l(De," forward method, overrides the "),Xe=a(De,"CODE",{});var qn=r(Xe);Io=l(qn,"__call__"),qn.forEach(o),No=l(De," special method."),De.forEach(o),So=f(ae),P(Y.$$.fragment,ae),Do=f(ae),P(J.$$.fragment,ae),ae.forEach(o),ne.forEach(o),vt=f(e),D=a(e,"H2",{class:!0});var zt=r(D);K=a(zt,"A",{id:!0,class:!0,href:!0});var Fn=r(K);et=a(Fn,"SPAN",{});var Ln=r(et);P(be.$$.fragment,Ln),Ln.forEach(o),Fn.forEach(o),Wo=f(zt),tt=a(zt,"SPAN",{});var jn=r(tt);Bo=l(jn,"OPTPretrainedModel"),jn.forEach(o),zt.forEach(o),Tt=f(e),E=a(e,"DIV",{class:!0});var We=r(E);P(Pe.$$.fragment,We),Ho=f(We),ye=a(We,"P",{});var xt=r(ye);Vo=l(xt,`The bare OPT Model outputting raw hidden-states without any specific head on top.
