import{S as el,i as tl,s as ol,e as n,k as c,w as b,t as d,M as nl,c as a,d as t,m as p,a as s,x as k,h as i,b as u,F as e,g as f,y as P,q as w,o as $,B as O,v as al,L as Dt}from"../../chunks/vendor-6b77c823.js";import{T as nn}from"../../chunks/Tip-39098574.js";import{D as oe}from"../../chunks/Docstring-1088f2fb.js";import{C as Rt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Re}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as St}from"../../chunks/ExampleCodeBlock-5212b321.js";function sl(M){let l,y,_,h,T;return h=new Rt({props:{code:`from transformers import OPTModel, OPTConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Example:"),m.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,m){f(r,l,m),e(l,y),f(r,_,m),P(h,r,m),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function rl(M){let l,y,_,h,T;return{c(){l=n("p"),y=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=d("Module"),T=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(m,"CODE",{});var F=s(_);h=i(F,"Module"),F.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(r,m){f(r,l,m),e(l,y),e(l,_),e(_,h),e(l,T)},d(r){r&&t(l)}}}function dl(M){let l,y,_,h,T;return h=new Rt({props:{code:`from transformers import GPT2Tokenizer, OPTModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Example:"),m.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,m){f(r,l,m),e(l,y),f(r,_,m),P(h,r,m),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function il(M){let l,y,_,h,T;return h=new Rt({props:{code:`from transformers import OPTTokenizer, OPTForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Example:"),m.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,m){f(r,l,m),e(l,y),f(r,_,m),P(h,r,m),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function ll(M){let l,y,_,h,T,r,m,F,$e,ie,x,Y,H,ne,Oe,U,xe,fe,X,B,_e,Q,j,q,le,G,Me,ge,D,Fe,Te,C,Ee,Z,ee,ze,A,je,Ce,R,V,N,pe;return{c(){l=n("p"),y=d("TF 2.0 models accepts two formats as inputs:"),_=c(),h=n("ul"),T=n("li"),r=d("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),F=n("li"),$e=d("having all inputs as a list, tuple or dict in the first positional arguments."),ie=c(),x=n("p"),Y=d("This second option is useful when using "),H=n("code"),ne=d("tf.keras.Model.fit"),Oe=d(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),xe=d("model(inputs)"),fe=d("."),X=c(),B=n("p"),_e=d(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),N=n("code"),pe=d('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=a(v,"P",{});var E=s(l);y=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),_=p(v),h=a(v,"UL",{});var ae=s(h);T=a(ae,"LI",{});var We=s(T);r=i(We,"having all inputs as keyword arguments (like PyTorch models), or"),We.forEach(t),m=p(ae),F=a(ae,"LI",{});var Le=s(F);$e=i(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),ae.forEach(t),ie=p(v),x=a(v,"P",{});var z=s(x);Y=i(z,"This second option is useful when using "),H=a(z,"CODE",{});var he=s(H);ne=i(he,"tf.keras.Model.fit"),he.forEach(t),Oe=i(z,` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a(z,"CODE",{});var He=s(U);xe=i(He,"model(inputs)"),He.forEach(t),fe=i(z,"."),z.forEach(t),X=p(v),B=a(v,"P",{});var se=s(B);_e=i(se,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),N=a(qe,"CODE",{});var re=s(N);pe=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),qe.forEach(t),K.forEach(t)},m(v,E){f(v,l,E),e(l,y),f(v,_,E),f(v,h,E),e(h,T),e(T,r),e(h,m),e(h,F),e(F,$e),f(v,ie,E),f(v,x,E),e(x,Y),e(x,H),e(H,ne),e(x,Oe),e(x,U),e(U,xe),e(x,fe),f(v,X,E),f(v,B,E),e(B,_e),f(v,Q,E),f(v,j,E),e(j,q),e(q,le),e(q,G),e(G,Me),e(q,ge),e(q,D),e(D,Fe),e(j,Te),e(j,C),e(C,Ee),e(C,Z),e(Z,ee),e(C,ze),e(C,A),e(A,je),e(j,Ce),e(j,R),e(R,V),e(R,N),e(N,pe)},d(v){v&&t(l),v&&t(_),v&&t(h),v&&t(ie),v&&t(x),v&&t(X),v&&t(B),v&&t(Q),v&&t(j)}}}function cl(M){let l,y,_,h,T;return{c(){l=n("p"),y=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=d("Module"),T=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(m,"CODE",{});var F=s(_);h=i(F,"Module"),F.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(r,m){f(r,l,m),e(l,y),e(l,_),e(_,h),e(l,T)},d(r){r&&t(l)}}}function pl(M){let l,y,_,h,T;return h=new Rt({props:{code:`from transformers import GPT2Tokenizer, TFOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Example:"),m.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,m){f(r,l,m),e(l,y),f(r,_,m),P(h,r,m),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function hl(M){let l,y,_,h,T,r,m,F,$e,ie,x,Y,H,ne,Oe,U,xe,fe,X,B,_e,Q,j,q,le,G,Me,ge,D,Fe,Te,C,Ee,Z,ee,ze,A,je,Ce,R,V,N,pe;return{c(){l=n("p"),y=d("TF 2.0 models accepts two formats as inputs:"),_=c(),h=n("ul"),T=n("li"),r=d("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),F=n("li"),$e=d("having all inputs as a list, tuple or dict in the first positional arguments."),ie=c(),x=n("p"),Y=d("This second option is useful when using "),H=n("code"),ne=d("tf.keras.Model.fit"),Oe=d(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),xe=d("model(inputs)"),fe=d("."),X=c(),B=n("p"),_e=d(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),j=n("ul"),q=n("li"),le=d("a single Tensor with "),G=n("code"),Me=d("input_ids"),ge=d(" only and nothing else: "),D=n("code"),Fe=d("model(input_ids)"),Te=c(),C=n("li"),Ee=d(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Z=n("code"),ee=d("model([input_ids, attention_mask])"),ze=d(" or "),A=n("code"),je=d("model([input_ids, attention_mask, token_type_ids])"),Ce=c(),R=n("li"),V=d(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),N=n("code"),pe=d('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=a(v,"P",{});var E=s(l);y=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),_=p(v),h=a(v,"UL",{});var ae=s(h);T=a(ae,"LI",{});var We=s(T);r=i(We,"having all inputs as keyword arguments (like PyTorch models), or"),We.forEach(t),m=p(ae),F=a(ae,"LI",{});var Le=s(F);$e=i(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),ae.forEach(t),ie=p(v),x=a(v,"P",{});var z=s(x);Y=i(z,"This second option is useful when using "),H=a(z,"CODE",{});var he=s(H);ne=i(he,"tf.keras.Model.fit"),he.forEach(t),Oe=i(z,` method which currently requires having all the
...
the latter silently ignores them.`)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(m,"CODE",{});var F=s(_);h=i(F,"Module"),F.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(r,m){f(r,l,m),e(l,y),e(l,_),e(_,h),e(l,T)},d(r){r&&t(l)}}}function ml(M){let l,y,_,h,T;return h=new Rt({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Example:"),m.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,m){f(r,l,m),e(l,y),f(r,_,m),P(h,r,m),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function fl(M){let l,y,_,h,T;return h=new Rt({props:{code:`from transformers import OPTTokenizer, FlaxOPTForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Example:"),m.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,m){f(r,l,m),e(l,y),f(r,_,m),P(h,r,m),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function _l(M){let l,y,_,h,T;return h=new Rt({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Example:"),m.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,m){f(r,l,m),e(l,y),f(r,_,m),P(h,r,m),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function gl(M){let l,y,_,h,T;return{c(){l=n("p"),y=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=d("Module"),T=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(m,"CODE",{});var F=s(_);h=i(F,"Module"),F.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(r,m){f(r,l,m),e(l,y),e(l,_),e(_,h),e(l,T)},d(r){r&&t(l)}}}function Tl(M){let l,y,_,h,T;return h=new Rt({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var m=s(l);y=i(m,"Example:"),m.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,m){f(r,l,m),e(l,y),f(r,_,m),P(h,r,m),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function vl(M){let l,y,_,h,T,r,m,F,$e,ie,x,Y,H,ne,Oe,U,xe,fe,X,B,_e,Q,j,q,le,G,Me,ge,D,Fe,Te,C,Ee,Z,ee,ze,A,je,Ce,R,V,N,pe,v,E,ae,We,Le,z,he,He,se,K,W,Ue,Be,L,Ge,Ve,qe,re,Wa,Do,Ha,Ua,Ro,Ba,Ga,Va,rt,ta,Ke,dt,an,Wt,Ka,sn,Ja,oa,ue,Ht,Ya,Ut,Xa,Wo,Qa,Za,es,Bt,ts,Gt,os,ns,as,ve,Vt,ss,Je,rs,Ho,ds,is,rn,ls,cs,ps,it,hs,lt,na,Ye,ct,dn,Kt,us,ln,ms,aa,Ie,Jt,fs,Yt,_s,Uo,gs,Ts,vs,Xt,ys,Qt,bs,ks,sa,Xe,pt,cn,Zt,Ps,pn,ws,ra,Qe,eo,$s,ht,to,Os,ut,da,Ze,mt,hn,oo,xs,un,Ms,ia,de,no,Fs,ao,Es,Bo,zs,js,Cs,so,qs,ro,Is,Ns,As,ft,Ls,ye,io,Ss,et,Ds,Go,Rs,Ws,mn,Hs,Us,Bs,_t,Gs,gt,la,tt,Tt,fn,lo,Vs,_n,Ks,ca,J,co,Js,po,Ys,Vo,Xs,Qs,Zs,ho,er,uo,tr,or,nr,vt,ar,gn,sr,rr,be,mo,dr,Tn,ir,lr,fo,cr,vn,pr,hr,ur,me,mr,yn,fr,_r,bn,gr,Tr,kn,vr,yr,Pn,br,kr,pa,ot,yt,wn,_o,Pr,$n,wr,ha,I,go,$r,To,Or,Ko,xr,Mr,Fr,vo,Er,yo,zr,jr,Cr,On,qr,Ir,Ne,xn,bo,Nr,Ar,Mn,ko,Lr,Sr,Fn,Po,Dr,Rr,En,wo,Wr,Hr,ke,$o,Ur,nt,Br,zn,Gr,Vr,jn,Kr,Jr,Yr,bt,Xr,kt,Qr,Pt,Oo,Zr,wt,ed,$t,xo,td,Ot,ua,at,xt,Cn,Mo,od,qn,nd,ma,S,Fo,ad,In,sd,rd,Eo,dd,Jo,id,ld,cd,zo,pd,jo,hd,ud,md,Nn,fd,_d,Ae,An,Co,gd,Td,Ln,qo,vd,yd,Sn,Io,bd,kd,Dn,No,Pd,wd,Pe,Ao,$d,st,Od,Rn,xd,Md,Wn,Fd,Ed,zd,Mt,jd,Ft,fa;return r=new Re({}),ne=new Re({}),v=new Re({}),he=new oe({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"max_position_embeddings",val:" = 2048"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 16"},{name:"ffn_dim",val:" = 4096"},{name:"layerdrop",val:" = 0.0"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"embed_dim",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"scale_embedding",val:" = False"},{name:"share_input_output_embed",val:" = True"},{name:"use_cache",val:" = False"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"decoder_start_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"output_projection",val:" = True"},{name:"decoder_layernorm",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17088/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17088/src/transformers/models/opt/modeling_opt.py#L879",returnDescription:`
<p>A <a
...
<li>1 indicates the head is <strong>not masked</strong>,</li>
<li>0 indicates the head is <strong>masked</strong>.</li>
</ul>`,name:"head_mask"},{anchor:"transformers.OPTForCausalLM.forward.cross_attn_head_mask",description:`<strong>cross_attn_head_mask</strong> (<code>torch.Tensor</code> of shape <code>(num_hidden_layers, num_attention_heads)</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17088/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17088/src/transformers/models/opt/modeling_flax_opt.py#L977",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17088/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17088/src/transformers/models/opt/modeling_flax_opt.py#L800",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17088/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17088/src/transformers/models/opt/modeling_flax_opt.py#L863",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17088/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17088/src/transformers/models/opt/modeling_flax_opt.py#L1116",returnDescription:`
<p>A <a
...
`}}),Mt=new nn({props:{$$slots:{default:[gl]},$$scope:{ctx:M}}}),Ft=new St({props:{anchor:"transformers.FlaxOPTForCausalLM.__call__.example",$$slots:{default:[Tl]},$$scope:{ctx:M}}}),{c(){l=n("meta"),y=c(),_=n("h1"),h=n("a"),T=n("span"),b(r.$$.fragment),m=c(),F=n("span"),$e=d("OPT"),ie=c(),x=n("h2"),Y=n("a"),H=n("span"),b(ne.$$.fragment),Oe=c(),U=n("span"),xe=d("Overview"),fe=c(),X=n("p"),B=d(`The OPT model was proposed in [<INSERT PAPER NAME HERE>](<INSERT PAPER LINK HERE>) by <INSERT AUTHORS HERE>.
...
and behavior.`),as=c(),ve=n("div"),b(Vt.$$.fragment),ss=c(),Je=n("p"),rs=d("The "),Ho=n("a"),ds=d("OPTModel"),is=d(" forward method, overrides the "),rn=n("code"),ls=d("__call__"),cs=d(" special method."),ps=c(),b(it.$$.fragment),hs=c(),b(lt.$$.fragment),na=c(),Ye=n("h2"),ct=n("a"),dn=n("span"),b(Kt.$$.fragment),us=c(),ln=n("span"),ms=d("OPTPretrainedModel"),aa=c(),Ie=n("div"),b(Jt.$$.fragment),fs=c(),Yt=n("p"),_s=d(`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa=c(),Xe=n("h2"),pt=n("a"),cn=n("span"),b(Zt.$$.fragment),Ps=c(),pn=n("span"),ws=d("OPTForCausalLM"),ra=c(),Qe=n("div"),b(eo.$$.fragment),$s=c(),ht=n("div"),b(to.$$.fragment),Os=c(),b(ut.$$.fragment),da=c(),Ze=n("h2"),mt=n("a"),hn=n("span"),b(oo.$$.fragment),xs=c(),un=n("span"),Ms=d("TFOPTModel"),ia=c(),de=n("div"),b(no.$$.fragment),Fs=c(),ao=n("p"),Es=d(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),As=c(),b(ft.$$.fragment),Ls=c(),ye=n("div"),b(io.$$.fragment),Ss=c(),et=n("p"),Ds=d("The "),Go=n("a"),Rs=d("TFOPTModel"),Ws=d(" forward method, overrides the "),mn=n("code"),Hs=d("__call__"),Us=d(" special method."),Bs=c(),b(_t.$$.fragment),Gs=c(),b(gt.$$.fragment),la=c(),tt=n("h2"),Tt=n("a"),fn=n("span"),b(lo.$$.fragment),Vs=c(),_n=n("span"),Ks=d("TFOPTPretrainedModel"),ca=c(),J=n("div"),b(co.$$.fragment),Js=c(),po=n("p"),Ys=d(`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),nr=c(),b(vt.$$.fragment),ar=c(),gn=n("p"),sr=d("TFOPT Pretrained Model that inheritates from transformers.TFPreTrainedModel"),rr=c(),be=n("div"),b(mo.$$.fragment),dr=c(),Tn=n("p"),ir=d("Calls the model on new inputs and returns the outputs as tensors."),lr=c(),fo=n("p"),cr=d("In this case "),vn=n("code"),pr=d("call()"),hr=d(` just reapplies
all ops in the graph to the new inputs
(e.g. build a new computational graph from the provided inputs).`),ur=c(),me=n("p"),mr=d(`Note: This method should not be called directly. It is only meant to be
overridden when subclassing `),yn=n("code"),fr=d("tf.keras.Model"),_r=d(`.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),md=c(),Nn=n("p"),fd=d("Finally, this model supports inherent JAX features such as:"),_d=c(),Ae=n("ul"),An=n("li"),Co=n("a"),gd=d("Just-In-Time (JIT) compilation"),Td=c(),Ln=n("li"),qo=n("a"),vd=d("Automatic Differentiation"),yd=c(),Sn=n("li"),Io=n("a"),bd=d("Vectorization"),kd=c(),Dn=n("li"),No=n("a"),Pd=d("Parallelization"),wd=c(),Pe=n("div"),b(Ao.$$.fragment),$d=c(),st=n("p"),Od=d("The "),Rn=n("code"),xd=d("FlaxOPTDecoderPreTrainedModel"),Md=d(" forward method, overrides the "),Wn=n("code"),Fd=d("__call__"),Ed=d(" special method."),zd=c(),b(Mt.$$.fragment),jd=c(),b(Ft.$$.fragment),this.h()},l(o){const g=nl('[data-svelte="svelte-1phssyn"]',document.head);l=a(g,"META",{name:!0,content:!0}),g.forEach(t),y=p(o),_=a(o,"H1",{class:!0});var Lo=s(_);h=a(Lo,"A",{id:!0,class:!0,href:!0});var Hn=s(h);T=a(Hn,"SPAN",{});var Un=s(T);k(r.$$.fragment,Un),Un.forEach(t),Hn.forEach(t),m=p(Lo),F=a(Lo,"SPAN",{});var Bn=s(F);$e=i(Bn,"OPT"),Bn.forEach(t),Lo.forEach(t),ie=p(o),x=a(o,"H2",{class:!0});var So=s(x);Y=a(So,"A",{id:!0,class:!0,href:!0});var Gn=s(Y);H=a(Gn,"SPAN",{});var Vn=s(H);k(ne.$$.fragment,Vn),Vn.forEach(t),Gn.forEach(t),Oe=p(So),U=a(So,"SPAN",{});var Kn=s(U);xe=i(Kn,"Overview"),Kn.forEach(t),So.forEach(t),fe=p(o),X=a(o,"P",{});var Jn=s(X);B=i(Jn,`The OPT model was proposed in [<INSERT PAPER NAME HERE>](<INSERT PAPER LINK HERE>) by <INSERT AUTHORS HERE>.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pa.forEach(t),Zo.forEach(t),sa=p(o),Xe=a(o,"H2",{class:!0});var wa=s(Xe);pt=a(wa,"A",{id:!0,class:!0,href:!0});var Zd=s(pt);cn=a(Zd,"SPAN",{});var ei=s(cn);k(Zt.$$.fragment,ei),ei.forEach(t),Zd.forEach(t),Ps=p(wa),pn=a(wa,"SPAN",{});var ti=s(pn);ws=i(ti,"OPTForCausalLM"),ti.forEach(t),wa.forEach(t),ra=p(o),Qe=a(o,"DIV",{class:!0});var $a=s(Qe);k(eo.$$.fragment,$a),$s=p($a),ht=a($a,"DIV",{class:!0});var Oa=s(ht);k(to.$$.fragment,Oa),Os=p(Oa),k(ut.$$.fragment,Oa),Oa.forEach(t),$a.forEach(t),da=p(o),Ze=a(o,"H2",{class:!0});var xa=s(Ze);mt=a(xa,"A",{id:!0,class:!0,href:!0});var oi=s(mt);hn=a(oi,"SPAN",{});var ni=s(hn);k(oo.$$.fragment,ni),ni.forEach(t),oi.forEach(t),xs=p(xa),un=a(xa,"SPAN",{});var ai=s(un);Ms=i(ai,"TFOPTModel"),ai.forEach(t),xa.forEach(t),ia=p(o),de=a(o,"DIV",{class:!0});var Se=s(de);k(no.$$.fragment,Se),Fs=p(Se),ao=a(Se,"P",{});var Ma=s(ao);Es=i(Ma,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fa.forEach(t),As=p(Se),k(ft.$$.fragment,Se),Ls=p(Se),ye=a(Se,"DIV",{class:!0});var Ct=s(ye);k(io.$$.fragment,Ct),Ss=p(Ct),et=a(Ct,"P",{});var en=s(et);Ds=i(en,"The "),Go=a(en,"A",{href:!0});var di=s(Go);Rs=i(di,"TFOPTModel"),di.forEach(t),Ws=i(en," forward method, overrides the "),mn=a(en,"CODE",{});var ii=s(mn);Hs=i(ii,"__call__"),ii.forEach(t),Us=i(en," special method."),en.forEach(t),Bs=p(Ct),k(_t.$$.fragment,Ct),Gs=p(Ct),k(gt.$$.fragment,Ct),Ct.forEach(t),Se.forEach(t),la=p(o),tt=a(o,"H2",{class:!0});var Ea=s(tt);Tt=a(Ea,"A",{id:!0,class:!0,href:!0});var li=s(Tt);fn=a(li,"SPAN",{});var ci=s(fn);k(lo.$$.fragment,ci),ci.forEach(t),li.forEach(t),Vs=p(Ea),_n=a(Ea,"SPAN",{});var pi=s(_n);Ks=i(pi,"TFOPTPretrainedModel"),pi.forEach(t),Ea.forEach(t),ca=p(o),J=a(o,"DIV",{class:!0});var we=s(J);k(co.$$.fragment,we),Js=p(we),po=a(we,"P",{});var za=s(po);Ys=i(za,`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ja.forEach(t),nr=p(we),k(vt.$$.fragment,we),ar=p(we),gn=a(we,"P",{});var mi=s(gn);sr=i(mi,"TFOPT Pretrained Model that inheritates from transformers.TFPreTrainedModel"),mi.forEach(t),rr=p(we),be=a(we,"DIV",{class:!0});var qt=s(be);k(mo.$$.fragment,qt),dr=p(qt),Tn=a(qt,"P",{});var fi=s(Tn);ir=i(fi,"Calls the model on new inputs and returns the outputs as tensors."),fi.forEach(t),lr=p(qt),fo=a(qt,"P",{});var Ca=s(fo);cr=i(Ca,"In this case "),vn=a(Ca,"CODE",{});var _i=s(vn);pr=i(_i,"call()"),_i.forEach(t),hr=i(Ca,` just reapplies
all ops in the graph to the new inputs
(e.g. build a new computational graph from the provided inputs).`),Ca.forEach(t),ur=p(qt),me=a(qt,"P",{});var De=s(me);mr=i(De,`Note: This method should not be called directly. It is only meant to be
overridden when subclassing `),yn=a(De,"CODE",{});var gi=s(yn);fr=i(gi,"tf.keras.Model"),gi.forEach(t),_r=i(De,`.
