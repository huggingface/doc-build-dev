...
first positional argument :`),Z=c(),j=n("ul"),q=n("li"),le=d("a single Tensor with "),G=n("code"),Me=d("input_ids"),ge=d(" only and nothing else: "),D=n("code"),Fe=d("model(input_ids)"),Te=c(),C=n("li"),Ee=d(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),ee=d("model([input_ids, attention_mask])"),ze=d(" or "),A=n("code"),je=d("model([input_ids, attention_mask, token_type_ids])"),Ce=c(),R=n("li"),V=d(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
first positional argument :`),se.forEach(t),Z=p(v),j=a(v,"UL",{});var K=s(j);q=a(K,"LI",{});var W=s(q);le=i(W,"a single Tensor with "),G=a(W,"CODE",{});var Ue=s(G);Me=i(Ue,"input_ids"),Ue.forEach(t),ge=i(W," only and nothing else: "),D=a(W,"CODE",{});var Be=s(D);Fe=i(Be,"model(input_ids)"),Be.forEach(t),W.forEach(t),Te=p(K),C=a(K,"LI",{});var L=s(C);Ee=i(L,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a(L,"CODE",{});var Ge=s(Q);ee=i(Ge,"model([input_ids, attention_mask])"),Ge.forEach(t),ze=i(L," or "),A=a(L,"CODE",{});var Ve=s(A);je=i(Ve,"model([input_ids, attention_mask, token_type_ids])"),Ve.forEach(t),L.forEach(t),Ce=p(K),R=a(K,"LI",{});var qe=s(R);V=i(qe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),N=a(qe,"CODE",{});var re=s(N);pe=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),qe.forEach(t),K.forEach(t)},m(v,E){m(v,l,E),e(l,y),m(v,_,E),m(v,h,E),e(h,T),e(T,r),e(h,f),e(h,F),e(F,$e),m(v,ie,E),m(v,x,E),e(x,Y),e(x,H),e(H,ne),e(x,Oe),e(x,U),e(U,xe),e(x,me),m(v,X,E),m(v,B,E),e(B,_e),m(v,Z,E),m(v,j,E),e(j,q),e(q,le),e(q,G),e(G,Me),e(q,ge),e(q,D),e(D,Fe),e(j,Te),e(j,C),e(C,Ee),e(C,Q),e(Q,ee),e(C,ze),e(C,A),e(A,je),e(j,Ce),e(j,R),e(R,V),e(R,N),e(N,pe)},d(v){v&&t(l),v&&t(_),v&&t(h),v&&t(ie),v&&t(x),v&&t(X),v&&t(B),v&&t(Z),v&&t(j)}}}function cl(M){let l,y,_,h,T;return{c(){l=n("p"),y=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=d("Module"),T=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=a(r,"P",{});var f=s(l);y=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(f,"CODE",{});var F=s(_);h=i(F,"Module"),F.forEach(t),T=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),y=d("Example:"),_=c(),b(h.$$.fragment)},l(r){l=a(r,"P",{});var f=s(l);y=i(f,"Example:"),f.forEach(t),_=p(r),k(h.$$.fragment,r)},m(r,f){m(r,l,f),e(l,y),m(r,_,f),P(h,r,f),T=!0},p:Dt,i(r){T||(w(h.$$.fragment,r),T=!0)},o(r){$(h.$$.fragment,r),T=!1},d(r){r&&t(l),r&&t(_),O(h,r)}}}function hl(M){let l,y,_,h,T,r,f,F,$e,ie,x,Y,H,ne,Oe,U,xe,me,X,B,_e,Z,j,q,le,G,Me,ge,D,Fe,Te,C,Ee,Q,ee,ze,A,je,Ce,R,V,N,pe;return{c(){l=n("p"),y=d("TF 2.0 models accepts two formats as inputs:"),_=c(),h=n("ul"),T=n("li"),r=d("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),F=n("li"),$e=d("having all inputs as a list, tuple or dict in the first positional arguments."),ie=c(),x=n("p"),Y=d("This second option is useful when using "),H=n("code"),ne=d("tf.keras.Model.fit"),Oe=d(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),xe=d("model(inputs)"),me=d("."),X=c(),B=n("p"),_e=d(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=c(),j=n("ul"),q=n("li"),le=d("a single Tensor with "),G=n("code"),Me=d("input_ids"),ge=d(" only and nothing else: "),D=n("code"),Fe=d("model(input_ids)"),Te=c(),C=n("li"),Ee=d(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),ee=d("model([input_ids, attention_mask])"),ze=d(" or "),A=n("code"),je=d("model([input_ids, attention_mask, token_type_ids])"),Ce=c(),R=n("li"),V=d(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),N=n("code"),pe=d('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=a(v,"P",{});var E=s(l);y=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),_=p(v),h=a(v,"UL",{});var ae=s(h);T=a(ae,"LI",{});var We=s(T);r=i(We,"having all inputs as keyword arguments (like PyTorch models), or"),We.forEach(t),f=p(ae),F=a(ae,"LI",{});var Le=s(F);$e=i(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),ae.forEach(t),ie=p(v),x=a(v,"P",{});var z=s(x);Y=i(z,"This second option is useful when using "),H=a(z,"CODE",{});var he=s(H);ne=i(he,"tf.keras.Model.fit"),he.forEach(t),Oe=i(z,` method which currently requires having all the
...
first positional argument :`),se.forEach(t),Z=p(v),j=a(v,"UL",{});var K=s(j);q=a(K,"LI",{});var W=s(q);le=i(W,"a single Tensor with "),G=a(W,"CODE",{});var Ue=s(G);Me=i(Ue,"input_ids"),Ue.forEach(t),ge=i(W," only and nothing else: "),D=a(W,"CODE",{});var Be=s(D);Fe=i(Be,"model(input_ids)"),Be.forEach(t),W.forEach(t),Te=p(K),C=a(K,"LI",{});var L=s(C);Ee=i(L,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a(L,"CODE",{});var Ge=s(Q);ee=i(Ge,"model([input_ids, attention_mask])"),Ge.forEach(t),ze=i(L," or "),A=a(L,"CODE",{});var Ve=s(A);je=i(Ve,"model([input_ids, attention_mask, token_type_ids])"),Ve.forEach(t),L.forEach(t),Ce=p(K),R=a(K,"LI",{});var qe=s(R);V=i(qe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),N=a(qe,"CODE",{});var re=s(N);pe=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),qe.forEach(t),K.forEach(t)},m(v,E){m(v,l,E),e(l,y),m(v,_,E),m(v,h,E),e(h,T),e(T,r),e(h,f),e(h,F),e(F,$e),m(v,ie,E),m(v,x,E),e(x,Y),e(x,H),e(H,ne),e(x,Oe),e(x,U),e(U,xe),e(x,me),m(v,X,E),m(v,B,E),e(B,_e),m(v,Z,E),m(v,j,E),e(j,q),e(q,le),e(q,G),e(G,Me),e(q,ge),e(q,D),e(D,Fe),e(j,Te),e(j,C),e(C,Ee),e(C,Q),e(Q,ee),e(C,ze),e(C,A),e(A,je),e(j,Ce),e(j,R),e(R,V),e(R,N),e(N,pe)},d(v){v&&t(l),v&&t(_),v&&t(h),v&&t(ie),v&&t(x),v&&t(X),v&&t(B),v&&t(Z),v&&t(j)}}}function ul(M){let l,y,_,h,T;return{c(){l=n("p"),y=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=d("Module"),T=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=a(r,"P",{});var f=s(l);y=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(f,"CODE",{});var F=s(_);h=i(F,"Module"),F.forEach(t),T=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<p>Indices can be obtained using <code>OPTTokenizer</code>. See <a href="/docs/transformers/pr_17088/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17088/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p>If <code>past_key_values</code> is used, optionally only the last <code>decoder_input_ids</code> have to be input (see <code>past_key_values</code>).</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17088/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17088/src/transformers/models/opt/modeling_opt.py#L762",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17088/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17088/src/transformers/models/opt/modeling_opt.py#L843",returnDescription:`
<p>A <a
...
<INSERT SHORT SUMMARY HERE>`),_e=c(),Z=n("p"),j=d("The abstract from the paper is the following:"),q=c(),le=n("p"),G=n("em"),Me=d("<INSERT PAPER ABSTRACT HERE>"),ge=c(),D=n("p"),Fe=d("Tips:"),Te=c(),C=n("p"),Ee=d("<INSERT TIPS ABOUT MODEL HERE>"),Q=c(),ee=n("p"),ze=d("This model was contributed by [INSERT YOUR HF USERNAME HERE]("),A=n("a"),je=d("https://huggingface.co/<INSERT"),Ce=d(` YOUR HF USERNAME HERE>).
...
This model inherits from `),Wo=n("a"),Za=d("PreTrainedModel"),Qa=d(`. Check the superclass documentation for the generic methods the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vs=c(),Xt=n("p"),ys=d("This model is also a PyTorch "),Zt=n("a"),bs=d("torch.nn.Module"),ks=d(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa=c(),Xe=n("h2"),pt=n("a"),cn=n("span"),b(Qt.$$.fragment),Ps=c(),pn=n("span"),ws=d("OPTForCausalLM"),ra=c(),Ze=n("div"),b(eo.$$.fragment),$s=c(),ht=n("div"),b(to.$$.fragment),Os=c(),b(ut.$$.fragment),da=c(),Qe=n("h2"),ft=n("a"),hn=n("span"),b(oo.$$.fragment),xs=c(),un=n("span"),Ms=d("TFOPTModel"),ia=c(),de=n("div"),b(no.$$.fragment),Fs=c(),ao=n("p"),Es=d(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
This model inherits from `),Vo=n("a"),Xs=d("TFPreTrainedModel"),Zs=d(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qs=c(),ho=n("p"),er=d("This model is also a "),uo=n("a"),tr=d("tf.keras.Model"),or=d(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
<INSERT SHORT SUMMARY HERE>`),Jn.forEach(t),_e=p(o),Z=a(o,"P",{});var Yn=s(Z);j=i(Yn,"The abstract from the paper is the following:"),Yn.forEach(t),q=p(o),le=a(o,"P",{});var Xn=s(le);G=a(Xn,"EM",{});var Zn=s(G);Me=i(Zn,"<INSERT PAPER ABSTRACT HERE>"),Zn.forEach(t),Xn.forEach(t),ge=p(o),D=a(o,"P",{});var Qn=s(D);Fe=i(Qn,"Tips:"),Qn.forEach(t),Te=p(o),C=a(o,"P",{});var ea=s(C);Ee=i(ea,"<INSERT TIPS ABOUT MODEL HERE>"),ea.forEach(t),Q=p(o),ee=a(o,"P",{});var _a=s(ee);ze=i(_a,"This model was contributed by [INSERT YOUR HF USERNAME HERE]("),A=a(_a,"A",{href:!0,rel:!0});var Cd=s(A);je=i(Cd,"https://huggingface.co/<INSERT"),Cd.forEach(t),Ce=i(_a,` YOUR HF USERNAME HERE>).
...
This model inherits from `),Wo=a(va,"A",{href:!0});var Ud=s(Wo);Za=i(Ud,"PreTrainedModel"),Ud.forEach(t),Qa=i(va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ya.forEach(t),as=p(zt),ve=a(zt,"DIV",{class:!0});var jt=s(ve);k(Vt.$$.fragment,jt),ss=p(jt),Je=a(jt,"P",{});var Zo=s(Je);rs=i(Zo,"The "),Ho=a(Zo,"A",{href:!0});var Gd=s(Ho);ds=i(Gd,"OPTModel"),Gd.forEach(t),is=i(Zo," forward method, overrides the "),rn=a(Zo,"CODE",{});var Vd=s(rn);ls=i(Vd,"__call__"),Vd.forEach(t),cs=i(Zo," special method."),Zo.forEach(t),ps=p(jt),k(it.$$.fragment,jt),hs=p(jt),k(lt.$$.fragment,jt),jt.forEach(t),zt.forEach(t),na=p(o),Ye=a(o,"H2",{class:!0});var ba=s(Ye);ct=a(ba,"A",{id:!0,class:!0,href:!0});var Kd=s(ct);dn=a(Kd,"SPAN",{});var Jd=s(dn);k(Kt.$$.fragment,Jd),Jd.forEach(t),Kd.forEach(t),us=p(ba),ln=a(ba,"SPAN",{});var Yd=s(ln);fs=i(Yd,"OPTPretrainedModel"),Yd.forEach(t),ba.forEach(t),aa=p(o),Ie=a(o,"DIV",{class:!0});var Qo=s(Ie);k(Jt.$$.fragment,Qo),ms=p(Qo),Yt=a(Qo,"P",{});var ka=s(Yt);_s=i(ka,`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ka.forEach(t),vs=p(Qo),Xt=a(Qo,"P",{});var Pa=s(Xt);ys=i(Pa,"This model is also a PyTorch "),Zt=a(Pa,"A",{href:!0,rel:!0});var Zd=s(Zt);bs=i(Zd,"torch.nn.Module"),Zd.forEach(t),ks=i(Pa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pa.forEach(t),Qo.forEach(t),sa=p(o),Xe=a(o,"H2",{class:!0});var wa=s(Xe);pt=a(wa,"A",{id:!0,class:!0,href:!0});var Qd=s(pt);cn=a(Qd,"SPAN",{});var ei=s(cn);k(Qt.$$.fragment,ei),ei.forEach(t),Qd.forEach(t),Ps=p(wa),pn=a(wa,"SPAN",{});var ti=s(pn);ws=i(ti,"OPTForCausalLM"),ti.forEach(t),wa.forEach(t),ra=p(o),Ze=a(o,"DIV",{class:!0});var $a=s(Ze);k(eo.$$.fragment,$a),$s=p($a),ht=a($a,"DIV",{class:!0});var Oa=s(ht);k(to.$$.fragment,Oa),Os=p(Oa),k(ut.$$.fragment,Oa),Oa.forEach(t),$a.forEach(t),da=p(o),Qe=a(o,"H2",{class:!0});var xa=s(Qe);ft=a(xa,"A",{id:!0,class:!0,href:!0});var oi=s(ft);hn=a(oi,"SPAN",{});var ni=s(hn);k(oo.$$.fragment,ni),ni.forEach(t),oi.forEach(t),xs=p(xa),un=a(xa,"SPAN",{});var ai=s(un);Ms=i(ai,"TFOPTModel"),ai.forEach(t),xa.forEach(t),ia=p(o),de=a(o,"DIV",{class:!0});var Se=s(de);k(no.$$.fragment,Se),Fs=p(Se),ao=a(Se,"P",{});var Ma=s(ao);Es=i(Ma,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
This model inherits from `),Vo=a(za,"A",{href:!0});var hi=s(Vo);Xs=i(hi,"TFPreTrainedModel"),hi.forEach(t),Zs=i(za,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),za.forEach(t),Qs=p(we),ho=a(we,"P",{});var ja=s(ho);er=i(ja,"This model is also a "),uo=a(ja,"A",{href:!0,rel:!0});var ui=s(uo);tr=i(ui,"tf.keras.Model"),ui.forEach(t),or=i(ja,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
