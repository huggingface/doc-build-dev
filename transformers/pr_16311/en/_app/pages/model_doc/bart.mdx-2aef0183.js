...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16311/en/model_doc/bart#transformers.BartConfig"
...
<p>A <a
  href="/docs/transformers/pr_16311/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),xs=new q({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16311/src/transformers/models/bart/modeling_flax_bart.py#L1320",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16311/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/pr_16311/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16311/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
Whether or not to return a <a href="/docs/transformers/pr_16311/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16311/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16311/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16311/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
`),$i=a(Jr,"CODE",{});var o1=s($i);kh=i(o1,"fairseq.encode"),o1.forEach(t),bh=i(Jr," starts with a space."),Jr.forEach(t),yh=l(qt),yr=a(qt,"LI",{});var jy=s(yr);Tr=a(jy,"A",{href:!0});var n1=s(Tr);Th=i(n1,"generate()"),n1.forEach(t),vh=i(jy,` should be used for conditional generation tasks like
...
mask-filling tasks.`),Xr.forEach(t),qt.forEach(t),ac=l(o),Xt=a(o,"H2",{class:!0});var Dc=s(Xt);Po=a(Dc,"A",{id:!0,class:!0,href:!0});var r1=s(Po);Pi=a(r1,"SPAN",{});var i1=s(Pi);f(jn.$$.fragment,i1),i1.forEach(t),r1.forEach(t),$h=l(Dc),Ei=a(Dc,"SPAN",{});var d1=s(Ei);jh=i(d1,"Mask Filling"),d1.forEach(t),Dc.forEach(t),sc=l(o),gt=a(o,"P",{});var Kr=s(gt);Mh=i(Kr,"The "),Ci=a(Kr,"CODE",{});var l1=s(Ci);Ph=i(l1,"facebook/bart-base"),l1.forEach(t),Eh=i(Kr," and "),Ai=a(Kr,"CODE",{});var c1=s(Ai);Ch=i(c1,"facebook/bart-large"),c1.forEach(t),Ah=i(Kr," checkpoints can be used to fill multi-token masks."),Kr.forEach(t),rc=l(o),f(Mn.$$.fragment,o),ic=l(o),Kt=a(o,"H2",{class:!0});var Gc=s(Kt);Eo=a(Gc,"A",{id:!0,class:!0,href:!0});var p1=s(Eo);Oi=a(p1,"SPAN",{});var h1=s(Oi);f(Pn.$$.fragment,h1),h1.forEach(t),p1.forEach(t),Oh=l(Gc),Si=a(Gc,"SPAN",{});var u1=s(Si);Sh=i(u1,"BartConfig"),u1.forEach(t),Gc.forEach(t),dc=l(o),we=a(o,"DIV",{class:!0});var $t=s(we);f(En.$$.fragment,$t),Ih=l($t),Zt=a($t,"P",{});var Zr=s(Zt);Nh=i(Zr,"This is the configuration class to store the configuration of a "),vr=a(Zr,"A",{href:!0});var m1=s(vr);Lh=i(m1,"BartModel"),m1.forEach(t),Dh=i(Zr,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),Cn=a(Zr,"A",{href:!0,rel:!0});var f1=s(Cn);Gh=i(f1,"facebook/bart-large"),f1.forEach(t),Wh=i(Zr," architecture."),Zr.forEach(t),Uh=l($t),Yt=a($t,"P",{});var Yr=s(Yt);Rh=i(Yr,"Configuration objects inherit from "),wr=a(Yr,"A",{href:!0});var _1=s(wr);Hh=i(_1,"PretrainedConfig"),_1.forEach(t),Qh=i(Yr,` and can be used to control the model outputs. Read the
documentation from `),xr=a(Yr,"A",{href:!0});var g1=s(xr);Vh=i(g1,"PretrainedConfig"),g1.forEach(t),Jh=i(Yr," for more information."),Yr.forEach(t),Xh=l($t),Ii=a($t,"P",{});var k1=s(Ii);Kh=i(k1,"Example:"),k1.forEach(t),Zh=l($t),f(An.$$.fragment,$t),$t.forEach(t),lc=l(o),eo=a(o,"H2",{class:!0});var Wc=s(eo);Co=a(Wc,"A",{id:!0,class:!0,href:!0});var b1=s(Co);Ni=a(b1,"SPAN",{});var y1=s(Ni);f(On.$$.fragment,y1),y1.forEach(t),b1.forEach(t),Yh=l(Wc),Li=a(Wc,"SPAN",{});var T1=s(Li);eu=i(T1,"BartTokenizer"),T1.forEach(t),Wc.forEach(t),cc=l(o),E=a(o,"DIV",{class:!0});var D=s(E);f(Sn.$$.fragment,D),tu=l(D),Di=a(D,"P",{});var v1=s(Di);ou=i(v1,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),v1.forEach(t),nu=l(D),Gi=a(D,"P",{});var w1=s(Gi);au=i(w1,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),w1.forEach(t),su=l(D),f(In.$$.fragment,D),ru=l(D),Nn=a(D,"P",{});var Uc=s(Nn);iu=i(Uc,"You can get around that behavior by passing "),Wi=a(Uc,"CODE",{});var x1=s(Wi);du=i(x1,"add_prefix_space=True"),x1.forEach(t),lu=i(Uc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Uc.forEach(t),cu=l(D),f(Ao.$$.fragment,D),pu=l(D),Ln=a(D,"P",{});var Rc=s(Ln);hu=i(Rc,"This tokenizer inherits from "),zr=a(Rc,"A",{href:!0});var z1=s(zr);uu=i(z1,"PreTrainedTokenizer"),z1.forEach(t),mu=i(Rc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Rc.forEach(t),fu=l(D),kt=a(D,"DIV",{class:!0});var ei=s(kt);f(Dn.$$.fragment,ei),_u=l(ei),Ui=a(ei,"P",{});var F1=s(Ui);gu=i(F1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),F1.forEach(t),ku=l(ei),Gn=a(ei,"UL",{});var Hc=s(Gn);Fr=a(Hc,"LI",{});var My=s(Fr);bu=i(My,"single sequence: "),Ri=a(My,"CODE",{});var B1=s(Ri);yu=i(B1,"<s> X </s>"),B1.forEach(t),My.forEach(t),Tu=l(Hc),Br=a(Hc,"LI",{});var Py=s(Br);vu=i(Py,"pair of sequences: "),Hi=a(Py,"CODE",{});var q1=s(Hi);wu=i(q1,"<s> A </s></s> B </s>"),q1.forEach(t),Py.forEach(t),Hc.forEach(t),ei.forEach(t),xu=l(D),Oo=a(D,"DIV",{class:!0});var Qc=s(Oo);f(Wn.$$.fragment,Qc),zu=l(Qc),Qi=a(Qc,"P",{});var $1=s(Qi);Fu=i($1,"Converts a sequence of tokens (string) in a single string."),$1.forEach(t),Qc.forEach(t),Bu=l(D),So=a(D,"DIV",{class:!0});var Vc=s(So);f(Un.$$.fragment,Vc),qu=l(Vc),Vi=a(Vc,"P",{});var j1=s(Vi);$u=i(j1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),j1.forEach(t),Vc.forEach(t),ju=l(D),Io=a(D,"DIV",{class:!0});var Jc=s(Io);f(Rn.$$.fragment,Jc),Mu=l(Jc),Hn=a(Jc,"P",{});var Xc=s(Hn);Pu=i(Xc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ji=a(Xc,"CODE",{});var M1=s(Ji);Eu=i(M1,"prepare_for_model"),M1.forEach(t),Cu=i(Xc," method."),Xc.forEach(t),Jc.forEach(t),D.forEach(t),pc=l(o),to=a(o,"H2",{class:!0});var Kc=s(to);No=a(Kc,"A",{id:!0,class:!0,href:!0});var P1=s(No);Xi=a(P1,"SPAN",{});var E1=s(Xi);f(Qn.$$.fragment,E1),E1.forEach(t),P1.forEach(t),Au=l(Kc),Ki=a(Kc,"SPAN",{});var C1=s(Ki);Ou=i(C1,"BartTokenizerFast"),C1.forEach(t),Kc.forEach(t),hc=l(o),G=a(o,"DIV",{class:!0});var me=s(G);f(Vn.$$.fragment,me),Su=l(me),Jn=a(me,"P",{});var Zc=s(Jn);Iu=i(Zc,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),Zi=a(Zc,"EM",{});var A1=s(Zi);Nu=i(A1,"tokenizers"),A1.forEach(t),Lu=i(Zc,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),Zc.forEach(t),Du=l(me),Yi=a(me,"P",{});var O1=s(Yi);Gu=i(O1,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),O1.forEach(t),Wu=l(me),f(Xn.$$.fragment,me),Uu=l(me),Kn=a(me,"P",{});var Yc=s(Kn);Ru=i(Yc,"You can get around that behavior by passing "),ed=a(Yc,"CODE",{});var S1=s(ed);Hu=i(S1,"add_prefix_space=True"),S1.forEach(t),Qu=i(Yc,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Yc.forEach(t),Vu=l(me),f(Lo.$$.fragment,me),Ju=l(me),Zn=a(me,"P",{});var ep=s(Zn);Xu=i(ep,"This tokenizer inherits from "),qr=a(ep,"A",{href:!0});var I1=s(qr);Ku=i(I1,"PreTrainedTokenizerFast"),I1.forEach(t),Zu=i(ep,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),ep.forEach(t),Yu=l(me),Do=a(me,"DIV",{class:!0});var tp=s(Do);f(Yn.$$.fragment,tp),em=l(tp),td=a(tp,"P",{});var N1=s(td);tm=i(N1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),N1.forEach(t),tp.forEach(t),me.forEach(t),uc=l(o),oo=a(o,"H2",{class:!0});var op=s(oo);Go=a(op,"A",{id:!0,class:!0,href:!0});var L1=s(Go);od=a(L1,"SPAN",{});var D1=s(od);f(ea.$$.fragment,D1),D1.forEach(t),L1.forEach(t),om=l(op),nd=a(op,"SPAN",{});var G1=s(nd);nm=i(G1,"BartModel"),G1.forEach(t),op.forEach(t),mc=l(o),Xe=a(o,"DIV",{class:!0});var gn=s(Xe);f(ta.$$.fragment,gn),am=l(gn),oa=a(gn,"P",{});var np=s(oa);sm=i(np,`The bare BART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),np.forEach(t),dm=l(gn),na=a(gn,"P",{});var ap=s(na);lm=i(ap,"This model is also a PyTorch "),aa=a(ap,"A",{href:!0,rel:!0});var U1=s(aa);cm=i(U1,"torch.nn.Module"),U1.forEach(t),pm=i(ap,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ap.forEach(t),hm=l(gn),Pe=a(gn,"DIV",{class:!0});var jt=s(Pe);f(sa.$$.fragment,jt),um=l(jt),no=a(jt,"P",{});var ti=s(no);mm=i(ti,"The "),jr=a(ti,"A",{href:!0});var R1=s(jr);fm=i(R1,"BartModel"),R1.forEach(t),_m=i(ti," forward method, overrides the "),ad=a(ti,"CODE",{});var H1=s(ad);gm=i(H1,"__call__"),H1.forEach(t),km=i(ti," special method."),ti.forEach(t),bm=l(jt),f(Wo.$$.fragment,jt),ym=l(jt),sd=a(jt,"P",{});var Q1=s(sd);Tm=i(Q1,"Example:"),Q1.forEach(t),vm=l(jt),f(ra.$$.fragment,jt),jt.forEach(t),gn.forEach(t),fc=l(o),ao=a(o,"H2",{class:!0});var sp=s(ao);Uo=a(sp,"A",{id:!0,class:!0,href:!0});var V1=s(Uo);rd=a(V1,"SPAN",{});var J1=s(rd);f(ia.$$.fragment,J1),J1.forEach(t),V1.forEach(t),wm=l(sp),id=a(sp,"SPAN",{});var X1=s(id);xm=i(X1,"BartForConditionalGeneration"),X1.forEach(t),sp.forEach(t),_c=l(o),Ke=a(o,"DIV",{class:!0});var kn=s(Ke);f(da.$$.fragment,kn),zm=l(kn),la=a(kn,"P",{});var rp=s(la);Fm=i(rp,`The BART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip.forEach(t),Em=l(kn),Z=a(kn,"DIV",{class:!0});var Ne=s(Z);f(ha.$$.fragment,Ne),Cm=l(Ne),so=a(Ne,"P",{});var oi=s(so);Am=i(oi,"The "),Pr=a(oi,"A",{href:!0});var Y1=s(Pr);Om=i(Y1,"BartForConditionalGeneration"),Y1.forEach(t),Sm=i(oi," forward method, overrides the "),dd=a(oi,"CODE",{});var eT=s(dd);Im=i(eT,"__call__"),eT.forEach(t),Nm=i(oi," special method."),oi.forEach(t),Lm=l(Ne),f(Ro.$$.fragment,Ne),Dm=l(Ne),ld=a(Ne,"P",{});var tT=s(ld);Gm=i(tT,"Summarization example:"),tT.forEach(t),Wm=l(Ne),f(ua.$$.fragment,Ne),Um=l(Ne),cd=a(Ne,"P",{});var oT=s(cd);Rm=i(oT,"Mask filling example:"),oT.forEach(t),Hm=l(Ne),f(ma.$$.fragment,Ne),Ne.forEach(t),kn.forEach(t),gc=l(o),ro=a(o,"H2",{class:!0});var dp=s(ro);Ho=a(dp,"A",{id:!0,class:!0,href:!0});var nT=s(Ho);pd=a(nT,"SPAN",{});var aT=s(pd);f(fa.$$.fragment,aT),aT.forEach(t),nT.forEach(t),Qm=l(dp),hd=a(dp,"SPAN",{});var sT=s(hd);Vm=i(sT,"BartForSequenceClassification"),sT.forEach(t),dp.forEach(t),kc=l(o),xe=a(o,"DIV",{class:!0});var Mt=s(xe);f(_a.$$.fragment,Mt),Jm=l(Mt),ud=a(Mt,"P",{});var rT=s(ud);Xm=i(rT,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cp.forEach(t),sf=l(Mt),Y=a(Mt,"DIV",{class:!0});var Le=s(Y);f(ya.$$.fragment,Le),rf=l(Le),io=a(Le,"P",{});var ni=s(io);df=i(ni,"The "),Cr=a(ni,"A",{href:!0});var lT=s(Cr);lf=i(lT,"BartForSequenceClassification"),lT.forEach(t),cf=i(ni," forward method, overrides the "),md=a(ni,"CODE",{});var cT=s(md);pf=i(cT,"__call__"),cT.forEach(t),hf=i(ni," special method."),ni.forEach(t),uf=l(Le),f(Qo.$$.fragment,Le),mf=l(Le),fd=a(Le,"P",{});var pT=s(fd);ff=i(pT,"Example of single-label classification:"),pT.forEach(t),_f=l(Le),f(Ta.$$.fragment,Le),gf=l(Le),_d=a(Le,"P",{});var hT=s(_d);kf=i(hT,"Example of multi-label classification:"),hT.forEach(t),bf=l(Le),f(va.$$.fragment,Le),Le.forEach(t),Mt.forEach(t),bc=l(o),lo=a(o,"H2",{class:!0});var pp=s(lo);Vo=a(pp,"A",{id:!0,class:!0,href:!0});var uT=s(Vo);gd=a(uT,"SPAN",{});var mT=s(gd);f(wa.$$.fragment,mT),mT.forEach(t),uT.forEach(t),yf=l(pp),kd=a(pp,"SPAN",{});var fT=s(kd);Tf=i(fT,"BartForQuestionAnswering"),fT.forEach(t),pp.forEach(t),yc=l(o),ze=a(o,"DIV",{class:!0});var Pt=s(ze);f(xa.$$.fragment,Pt),vf=l(Pt),co=a(Pt,"P",{});var ai=s(co);wf=i(ai,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up.forEach(t),Of=l(Pt),Ee=a(Pt,"DIV",{class:!0});var Et=s(Ee);f(qa.$$.fragment,Et),Sf=l(Et),po=a(Et,"P",{});var si=s(po);If=i(si,"The "),Or=a(si,"A",{href:!0});var yT=s(Or);Nf=i(yT,"BartForQuestionAnswering"),yT.forEach(t),Lf=i(si," forward method, overrides the "),Td=a(si,"CODE",{});var TT=s(Td);Df=i(TT,"__call__"),TT.forEach(t),Gf=i(si," special method."),si.forEach(t),Wf=l(Et),f(Jo.$$.fragment,Et),Uf=l(Et),vd=a(Et,"P",{});var vT=s(vd);Rf=i(vT,"Example:"),vT.forEach(t),Hf=l(Et),f($a.$$.fragment,Et),Et.forEach(t),Pt.forEach(t),Tc=l(o),ho=a(o,"H2",{class:!0});var mp=s(ho);Xo=a(mp,"A",{id:!0,class:!0,href:!0});var wT=s(Xo);wd=a(wT,"SPAN",{});var xT=s(wd);f(ja.$$.fragment,xT),xT.forEach(t),wT.forEach(t),Qf=l(mp),xd=a(mp,"SPAN",{});var zT=s(xd);Vf=i(zT,"BartForCausalLM"),zT.forEach(t),mp.forEach(t),vc=l(o),uo=a(o,"DIV",{class:!0});var fp=s(uo);f(Ma.$$.fragment,fp),Jf=l(fp),bt=a(fp,"DIV",{class:!0});var ri=s(bt);f(Pa.$$.fragment,ri),Xf=l(ri),zd=a(ri,"P",{});var FT=s(zd);Kf=i(FT,"Example:"),FT.forEach(t),Zf=l(ri),f(Ea.$$.fragment,ri),ri.forEach(t),fp.forEach(t),wc=l(o),mo=a(o,"H2",{class:!0});var _p=s(mo);Ko=a(_p,"A",{id:!0,class:!0,href:!0});var BT=s(Ko);Fd=a(BT,"SPAN",{});var qT=s(Fd);f(Ca.$$.fragment,qT),qT.forEach(t),BT.forEach(t),Yf=l(_p),Bd=a(_p,"SPAN",{});var $T=s(Bd);e_=i($T,"TFBartModel"),$T.forEach(t),_p.forEach(t),xc=l(o),Fe=a(o,"DIV",{class:!0});var Ct=s(Fe);f(Aa.$$.fragment,Ct),t_=l(Ct),Oa=a(Ct,"P",{});var gp=s(Oa);o_=i(gp,`The bare BART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gp.forEach(t),s_=l(Ct),Sa=a(Ct,"P",{});var kp=s(Sa);r_=i(kp,"This model is also a "),Ia=a(kp,"A",{href:!0,rel:!0});var MT=s(Ia);i_=i(MT,"tf.keras.Model"),MT.forEach(t),d_=i(kp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kp.forEach(t),l_=l(Ct),f(Zo.$$.fragment,Ct),c_=l(Ct),Ce=a(Ct,"DIV",{class:!0});var At=s(Ce);f(Na.$$.fragment,At),p_=l(At),fo=a(At,"P",{});var ii=s(fo);h_=i(ii,"The "),Ir=a(ii,"A",{href:!0});var PT=s(Ir);u_=i(PT,"TFBartModel"),PT.forEach(t),m_=i(ii," forward method, overrides the "),qd=a(ii,"CODE",{});var ET=s(qd);f_=i(ET,"__call__"),ET.forEach(t),__=i(ii," special method."),ii.forEach(t),g_=l(At),f(Yo.$$.fragment,At),k_=l(At),$d=a(At,"P",{});var CT=s($d);b_=i(CT,"Example:"),CT.forEach(t),y_=l(At),f(La.$$.fragment,At),At.forEach(t),Ct.forEach(t),zc=l(o),_o=a(o,"H2",{class:!0});var bp=s(_o);en=a(bp,"A",{id:!0,class:!0,href:!0});var AT=s(en);jd=a(AT,"SPAN",{});var OT=s(jd);f(Da.$$.fragment,OT),OT.forEach(t),AT.forEach(t),T_=l(bp),Md=a(bp,"SPAN",{});var ST=s(Md);v_=i(ST,"TFBartForConditionalGeneration"),ST.forEach(t),bp.forEach(t),Fc=l(o),Be=a(o,"DIV",{class:!0});var Ot=s(Be);f(Ga.$$.fragment,Ot),w_=l(Ot),Wa=a(Ot,"P",{});var yp=s(Wa);x_=i(yp,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),Nr=a(yp,"A",{href:!0});var IT=s(Nr);z_=i(IT,"TFPreTrainedModel"),IT.forEach(t),F_=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yp.forEach(t),B_=l(Ot),Ua=a(Ot,"P",{});var Tp=s(Ua);q_=i(Tp,"This model is also a "),Ra=a(Tp,"A",{href:!0,rel:!0});var NT=s(Ra);$_=i(NT,"tf.keras.Model"),NT.forEach(t),j_=i(Tp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp.forEach(t),M_=l(Ot),f(tn.$$.fragment,Ot),P_=l(Ot),ee=a(Ot,"DIV",{class:!0});var De=s(ee);f(Ha.$$.fragment,De),E_=l(De),go=a(De,"P",{});var di=s(go);C_=i(di,"The "),Lr=a(di,"A",{href:!0});var LT=s(Lr);A_=i(LT,"TFBartForConditionalGeneration"),LT.forEach(t),O_=i(di," forward method, overrides the "),Pd=a(di,"CODE",{});var DT=s(Pd);S_=i(DT,"__call__"),DT.forEach(t),I_=i(di," special method."),di.forEach(t),N_=l(De),f(on.$$.fragment,De),L_=l(De),Ed=a(De,"P",{});var GT=s(Ed);D_=i(GT,"Summarization example:"),GT.forEach(t),G_=l(De),f(Qa.$$.fragment,De),W_=l(De),Cd=a(De,"P",{});var WT=s(Cd);U_=i(WT,"Mask filling example:"),WT.forEach(t),R_=l(De),f(Va.$$.fragment,De),De.forEach(t),Ot.forEach(t),Bc=l(o),ko=a(o,"H2",{class:!0});var vp=s(ko);nn=a(vp,"A",{id:!0,class:!0,href:!0});var UT=s(nn);Ad=a(UT,"SPAN",{});var RT=s(Ad);f(Ja.$$.fragment,RT),RT.forEach(t),UT.forEach(t),H_=l(vp),Od=a(vp,"SPAN",{});var HT=s(Od);Q_=i(HT,"FlaxBartModel"),HT.forEach(t),vp.forEach(t),qc=l(o),W=a(o,"DIV",{class:!0});var fe=s(W);f(Xa.$$.fragment,fe),V_=l(fe),Ka=a(fe,"P",{});var wp=s(Ka);J_=i(wp,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Dr=a(wp,"A",{href:!0});var QT=s(Dr);X_=i(QT,"FlaxPreTrainedModel"),QT.forEach(t),K_=i(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
