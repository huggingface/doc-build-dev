...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16311/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16311/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16311/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16311/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16311/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16311/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[W2]},$$scope:{ctx:E}}}),Is=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16311/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16311/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_16311/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16311/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yb=d(),Fs=n("p"),e1=r("This model is also a "),$s=n("a"),t1=r("tf.keras.Model"),o1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),n1=d(),m(cn.$$.fragment),a1=d(),Oe=n("div"),m(js.$$.fragment),s1=d(),Mo=n("p"),r1=r("The "),xi=n("a"),i1=r("TFMBartModel"),d1=r(" forward method, overrides the "),oc=n("code"),l1=r("__call__"),c1=r(" special method."),p1=d(),m(pn.$$.fragment),h1=d(),nc=n("p"),u1=r("Example:"),m1=d(),m(Es.$$.fragment),eh=d(),wo=n("h2"),hn=n("a"),ac=n("span"),m(Ps.$$.fragment),f1=d(),sc=n("span"),_1=r("TFMBartForConditionalGeneration"),th=d(),$e=n("div"),m(Cs.$$.fragment),g1=d(),Ss=n("p"),k1=r(`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=n("a"),b1=r("TFPreTrainedModel"),y1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),v1=d(),As=n("p"),T1=r("This model is also a "),Os=n("a"),M1=r("tf.keras.Model"),w1=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),x1=d(),m(un.$$.fragment),z1=d(),ee=n("div"),m(Is.$$.fragment),q1=d(),xo=n("p"),B1=r("The "),qi=n("a"),F1=r("TFMBartForConditionalGeneration"),$1=r(" forward method, overrides the "),rc=n("code"),j1=r("__call__"),E1=r(" special method."),P1=d(),m(mn.$$.fragment),C1=d(),ic=n("p"),S1=r("Summarization example:"),A1=d(),m(Ns.$$.fragment),O1=d(),dc=n("p"),I1=r("Mask filling example:"),N1=d(),m(Ds.$$.fragment),oh=d(),zo=n("h2"),fn=n("a"),lc=n("span"),m(Ls.$$.fragment),D1=d(),cc=n("span"),L1=r("FlaxMBartModel"),nh=d(),W=n("div"),m(Gs.$$.fragment),G1=d(),Ws=n("p"),W1=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),J1=d(),pc=n("p"),K1=r("Finally, this model supports inherent JAX features such as:"),Z1=d(),mt=n("ul"),hc=n("li"),Xs=n("a"),Y1=r("Just-In-Time (JIT) compilation"),ey=d(),uc=n("li"),Hs=n("a"),ty=r("Automatic Differentiation"),oy=d(),mc=n("li"),Vs=n("a"),ny=r("Vectorization"),ay=d(),fc=n("li"),Qs=n("a"),sy=r("Parallelization"),ry=d(),Ie=n("div"),m(Js.$$.fragment),iy=d(),qo=n("p"),dy=r("The "),_c=n("code"),ly=r("FlaxMBartPreTrainedModel"),cy=r("forward method, overrides the "),gc=n("code"),py=r("__call__"),hy=r(" special method."),uy=d(),m(_n.$$.fragment),my=d(),kc=n("p"),fy=r("Example:"),_y=d(),m(Ks.$$.fragment),gy=d(),Mt=n("div"),m(Zs.$$.fragment),ky=d(),bc=n("p"),by=r("Example:"),yy=d(),m(Ys.$$.fragment),vy=d(),wt=n("div"),m(er.$$.fragment),Ty=d(),yc=n("p"),My=r("Example:"),wy=d(),m(tr.$$.fragment),ah=d(),Bo=n("h2"),gn=n("a"),vc=n("span"),m(or.$$.fragment),xy=d(),Tc=n("span"),zy=r("FlaxMBartForConditionalGeneration"),sh=d(),R=n("div"),m(nr.$$.fragment),qy=d(),ar=n("p"),By=r(`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Fi=n("a"),Fy=r("FlaxPreTrainedModel"),$y=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jy=d(),sr=n("p"),Ey=r(`This model is also a Flax Linen
`),rr=n("a"),Py=r("flax.nn.Module"),Cy=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sy=d(),Mc=n("p"),Ay=r("Finally, this model supports inherent JAX features such as:"),Oy=d(),ft=n("ul"),wc=n("li"),ir=n("a"),Iy=r("Just-In-Time (JIT) compilation"),Ny=d(),xc=n("li"),dr=n("a"),Dy=r("Automatic Differentiation"),Ly=d(),zc=n("li"),lr=n("a"),Gy=r("Vectorization"),Wy=d(),qc=n("li"),cr=n("a"),Ry=r("Parallelization"),Uy=d(),te=n("div"),m(pr.$$.fragment),Xy=d(),Fo=n("p"),Hy=r("The "),Bc=n("code"),Vy=r("FlaxMBartPreTrainedModel"),Qy=r("forward method, overrides the "),Fc=n("code"),Jy=r("__call__"),Ky=r(" special method."),Zy=d(),m(kn.$$.fragment),Yy=d(),$c=n("p"),ev=r("Summarization example:"),tv=d(),m(hr.$$.fragment),ov=d(),jc=n("p"),nv=r("Mask filling example:"),av=d(),m(ur.$$.fragment),sv=d(),xt=n("div"),m(mr.$$.fragment),rv=d(),Ec=n("p"),iv=r("Example:"),dv=d(),m(fr.$$.fragment),lv=d(),zt=n("div"),m(_r.$$.fragment),cv=d(),Pc=n("p"),pv=r("Example:"),hv=d(),m(gr.$$.fragment),rh=d(),$o=n("h2"),bn=n("a"),Cc=n("span"),m(kr.$$.fragment),uv=d(),Sc=n("span"),mv=r("FlaxMBartForSequenceClassification"),ih=d(),O=n("div"),m(br.$$.fragment),fv=d(),Ac=n("p"),_v=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),gv=d(),yr=n("p"),kv=r("This model inherits from "),$i=n("a"),bv=r("FlaxPreTrainedModel"),yv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vv=d(),vr=n("p"),Tv=r(`This model is also a Flax Linen
`),Tr=n("a"),Mv=r("flax.nn.Module"),wv=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xv=d(),Oc=n("p"),zv=r("Finally, this model supports inherent JAX features such as:"),qv=d(),_t=n("ul"),Ic=n("li"),Mr=n("a"),Bv=r("Just-In-Time (JIT) compilation"),Fv=d(),Nc=n("li"),wr=n("a"),$v=r("Automatic Differentiation"),jv=d(),Dc=n("li"),xr=n("a"),Ev=r("Vectorization"),Pv=d(),Lc=n("li"),zr=n("a"),Cv=r("Parallelization"),Sv=d(),Ne=n("div"),m(qr.$$.fragment),Av=d(),jo=n("p"),Ov=r("The "),Gc=n("code"),Iv=r("FlaxMBartPreTrainedModel"),Nv=r("forward method, overrides the "),Wc=n("code"),Dv=r("__call__"),Lv=r(" special method."),Gv=d(),m(yn.$$.fragment),Wv=d(),Rc=n("p"),Rv=r("Example:"),Uv=d(),m(Br.$$.fragment),Xv=d(),qt=n("div"),m(Fr.$$.fragment),Hv=d(),Uc=n("p"),Vv=r("Example:"),Qv=d(),m($r.$$.fragment),Jv=d(),Bt=n("div"),m(jr.$$.fragment),Kv=d(),Xc=n("p"),Zv=r("Example:"),Yv=d(),m(Er.$$.fragment),dh=d(),Eo=n("h2"),vn=n("a"),Hc=n("span"),m(Pr.$$.fragment),eT=d(),Vc=n("span"),tT=r("FlaxMBartForQuestionAnswering"),lh=d(),I=n("div"),m(Cr.$$.fragment),oT=d(),Po=n("p"),nT=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Nt),Fs=a(Nt,"P",{});var _u=s(Fs);e1=i(_u,"This model is also a "),$s=a(_u,"A",{href:!0,rel:!0});var Vx=s($s);t1=i(Vx,"tf.keras.Model"),Vx.forEach(t),o1=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),n1=l(Nt),f(cn.$$.fragment,Nt),a1=l(Nt),Oe=a(Nt,"DIV",{class:!0});var Dt=s(Oe);f(js.$$.fragment,Dt),s1=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);r1=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Qx=s(xi);i1=i(Qx,"TFMBartModel"),Qx.forEach(t),d1=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var Jx=s(oc);l1=i(Jx,"__call__"),Jx.forEach(t),c1=i(Ui," special method."),Ui.forEach(t),p1=l(Dt),f(pn.$$.fragment,Dt),h1=l(Dt),nc=a(Dt,"P",{});var Kx=s(nc);u1=i(Kx,"Example:"),Kx.forEach(t),m1=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Zx=s(hn);ac=a(Zx,"SPAN",{});var Yx=s(ac);f(Ps.$$.fragment,Yx),Yx.forEach(t),Zx.forEach(t),f1=l(gu),sc=a(gu,"SPAN",{});var ez=s(sc);_1=i(ez,"TFMBartForConditionalGeneration"),ez.forEach(t),gu.forEach(t),th=l(o),$e=a(o,"DIV",{class:!0});var Lt=s($e);f(Cs.$$.fragment,Lt),g1=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);k1=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),zi=a(ku,"A",{href:!0});var tz=s(zi);b1=i(tz,"TFPreTrainedModel"),tz.forEach(t),y1=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),v1=l(Lt),As=a(Lt,"P",{});var bu=s(As);T1=i(bu,"This model is also a "),Os=a(bu,"A",{href:!0,rel:!0});var oz=s(Os);M1=i(oz,"tf.keras.Model"),oz.forEach(t),w1=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),x1=l(Lt),f(un.$$.fragment,Lt),z1=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Is.$$.fragment,We),q1=l(We),xo=a(We,"P",{});var Xi=s(xo);B1=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var nz=s(qi);F1=i(nz,"TFMBartForConditionalGeneration"),nz.forEach(t),$1=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var az=s(rc);j1=i(az,"__call__"),az.forEach(t),E1=i(Xi," special method."),Xi.forEach(t),P1=l(We),f(mn.$$.fragment,We),C1=l(We),ic=a(We,"P",{});var sz=s(ic);S1=i(sz,"Summarization example:"),sz.forEach(t),A1=l(We),f(Ns.$$.fragment,We),O1=l(We),dc=a(We,"P",{});var rz=s(dc);I1=i(rz,"Mask filling example:"),rz.forEach(t),N1=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),oh=l(o),zo=a(o,"H2",{class:!0});var yu=s(zo);fn=a(yu,"A",{id:!0,class:!0,href:!0});var iz=s(fn);lc=a(iz,"SPAN",{});var dz=s(lc);f(Ls.$$.fragment,dz),dz.forEach(t),iz.forEach(t),D1=l(yu),cc=a(yu,"SPAN",{});var lz=s(cc);L1=i(lz,"FlaxMBartModel"),lz.forEach(t),yu.forEach(t),nh=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),G1=l(me),Ws=a(me,"P",{});var vu=s(Ws);W1=i(vu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Bi=a(vu,"A",{href:!0});var cz=s(Bi);R1=i(cz,"FlaxPreTrainedModel"),cz.forEach(t),U1=i(vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vu.forEach(t),X1=l(me),Rs=a(me,"P",{});var Tu=s(Rs);H1=i(Tu,`This model is also a Flax Linen
`),Us=a(Tu,"A",{href:!0,rel:!0});var pz=s(Us);V1=i(pz,"flax.nn.Module"),pz.forEach(t),Q1=i(Tu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tu.forEach(t),J1=l(me),pc=a(me,"P",{});var hz=s(pc);K1=i(hz,"Finally, this model supports inherent JAX features such as:"),hz.forEach(t),Z1=l(me),mt=a(me,"UL",{});var $n=s(mt);hc=a($n,"LI",{});var uz=s(hc);Xs=a(uz,"A",{href:!0,rel:!0});var mz=s(Xs);Y1=i(mz,"Just-In-Time (JIT) compilation"),mz.forEach(t),uz.forEach(t),ey=l($n),uc=a($n,"LI",{});var fz=s(uc);Hs=a(fz,"A",{href:!0,rel:!0});var _z=s(Hs);ty=i(_z,"Automatic Differentiation"),_z.forEach(t),fz.forEach(t),oy=l($n),mc=a($n,"LI",{});var gz=s(mc);Vs=a(gz,"A",{href:!0,rel:!0});var kz=s(Vs);ny=i(kz,"Vectorization"),kz.forEach(t),gz.forEach(t),ay=l($n),fc=a($n,"LI",{});var bz=s(fc);Qs=a(bz,"A",{href:!0,rel:!0});var yz=s(Qs);sy=i(yz,"Parallelization"),yz.forEach(t),bz.forEach(t),$n.forEach(t),ry=l(me),Ie=a(me,"DIV",{class:!0});var Gt=s(Ie);f(Js.$$.fragment,Gt),iy=l(Gt),qo=a(Gt,"P",{});var Hi=s(qo);dy=i(Hi,"The "),_c=a(Hi,"CODE",{});var vz=s(_c);ly=i(vz,"FlaxMBartPreTrainedModel"),vz.forEach(t),cy=i(Hi,"forward method, overrides the "),gc=a(Hi,"CODE",{});var Tz=s(gc);py=i(Tz,"__call__"),Tz.forEach(t),hy=i(Hi," special method."),Hi.forEach(t),uy=l(Gt),f(_n.$$.fragment,Gt),my=l(Gt),kc=a(Gt,"P",{});var Mz=s(kc);fy=i(Mz,"Example:"),Mz.forEach(t),_y=l(Gt),f(Ks.$$.fragment,Gt),Gt.forEach(t),gy=l(me),Mt=a(me,"DIV",{class:!0});var Vi=s(Mt);f(Zs.$$.fragment,Vi),ky=l(Vi),bc=a(Vi,"P",{});var wz=s(bc);by=i(wz,"Example:"),wz.forEach(t),yy=l(Vi),f(Ys.$$.fragment,Vi),Vi.forEach(t),vy=l(me),wt=a(me,"DIV",{class:!0});var Qi=s(wt);f(er.$$.fragment,Qi),Ty=l(Qi),yc=a(Qi,"P",{});var xz=s(yc);My=i(xz,"Example:"),xz.forEach(t),wy=l(Qi),f(tr.$$.fragment,Qi),Qi.forEach(t),me.forEach(t),ah=l(o),Bo=a(o,"H2",{class:!0});var Mu=s(Bo);gn=a(Mu,"A",{id:!0,class:!0,href:!0});var zz=s(gn);vc=a(zz,"SPAN",{});var qz=s(vc);f(or.$$.fragment,qz),qz.forEach(t),zz.forEach(t),xy=l(Mu),Tc=a(Mu,"SPAN",{});var Bz=s(Tc);zy=i(Bz,"FlaxMBartForConditionalGeneration"),Bz.forEach(t),Mu.forEach(t),sh=l(o),R=a(o,"DIV",{class:!0});var fe=s(R);f(nr.$$.fragment,fe),qy=l(fe),ar=a(fe,"P",{});var wu=s(ar);By=i(wu,`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Fi=a(wu,"A",{href:!0});var Fz=s(Fi);Fy=i(Fz,"FlaxPreTrainedModel"),Fz.forEach(t),$y=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),jy=l(fe),sr=a(fe,"P",{});var xu=s(sr);Ey=i(xu,`This model is also a Flax Linen
`),rr=a(xu,"A",{href:!0,rel:!0});var $z=s(rr);Py=i($z,"flax.nn.Module"),$z.forEach(t),Cy=i(xu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sy=l(fe),Mc=a(fe,"P",{});var jz=s(Mc);Ay=i(jz,"Finally, this model supports inherent JAX features such as:"),jz.forEach(t),Oy=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var Ez=s(wc);ir=a(Ez,"A",{href:!0,rel:!0});var Pz=s(ir);Iy=i(Pz,"Just-In-Time (JIT) compilation"),Pz.forEach(t),Ez.forEach(t),Ny=l(jn),xc=a(jn,"LI",{});var Cz=s(xc);dr=a(Cz,"A",{href:!0,rel:!0});var Sz=s(dr);Dy=i(Sz,"Automatic Differentiation"),Sz.forEach(t),Cz.forEach(t),Ly=l(jn),zc=a(jn,"LI",{});var Az=s(zc);lr=a(Az,"A",{href:!0,rel:!0});var Oz=s(lr);Gy=i(Oz,"Vectorization"),Oz.forEach(t),Az.forEach(t),Wy=l(jn),qc=a(jn,"LI",{});var Iz=s(qc);cr=a(Iz,"A",{href:!0,rel:!0});var Nz=s(cr);Ry=i(Nz,"Parallelization"),Nz.forEach(t),Iz.forEach(t),jn.forEach(t),Uy=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xy=l(Re),Fo=a(Re,"P",{});var Ji=s(Fo);Hy=i(Ji,"The "),Bc=a(Ji,"CODE",{});var Dz=s(Bc);Vy=i(Dz,"FlaxMBartPreTrainedModel"),Dz.forEach(t),Qy=i(Ji,"forward method, overrides the "),Fc=a(Ji,"CODE",{});var Lz=s(Fc);Jy=i(Lz,"__call__"),Lz.forEach(t),Ky=i(Ji," special method."),Ji.forEach(t),Zy=l(Re),f(kn.$$.fragment,Re),Yy=l(Re),$c=a(Re,"P",{});var Gz=s($c);ev=i(Gz,"Summarization example:"),Gz.forEach(t),tv=l(Re),f(hr.$$.fragment,Re),ov=l(Re),jc=a(Re,"P",{});var Wz=s(jc);nv=i(Wz,"Mask filling example:"),Wz.forEach(t),av=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),sv=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),rv=l(Ki),Ec=a(Ki,"P",{});var Rz=s(Ec);iv=i(Rz,"Example:"),Rz.forEach(t),dv=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),lv=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),cv=l(Zi),Pc=a(Zi,"P",{});var Uz=s(Pc);pv=i(Uz,"Example:"),Uz.forEach(t),hv=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),$o=a(o,"H2",{class:!0});var zu=s($o);bn=a(zu,"A",{id:!0,class:!0,href:!0});var Xz=s(bn);Cc=a(Xz,"SPAN",{});var Hz=s(Cc);f(kr.$$.fragment,Hz),Hz.forEach(t),Xz.forEach(t),uv=l(zu),Sc=a(zu,"SPAN",{});var Vz=s(Sc);mv=i(Vz,"FlaxMBartForSequenceClassification"),Vz.forEach(t),zu.forEach(t),ih=l(o),O=a(o,"DIV",{class:!0});var oe=s(O);f(br.$$.fragment,oe),fv=l(oe),Ac=a(oe,"P",{});var Qz=s(Ac);_v=i(Qz,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Qz.forEach(t),gv=l(oe),yr=a(oe,"P",{});var qu=s(yr);kv=i(qu,"This model inherits from "),$i=a(qu,"A",{href:!0});var Jz=s($i);bv=i(Jz,"FlaxPreTrainedModel"),Jz.forEach(t),yv=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),vv=l(oe),vr=a(oe,"P",{});var Bu=s(vr);Tv=i(Bu,`This model is also a Flax Linen
`),Tr=a(Bu,"A",{href:!0,rel:!0});var Kz=s(Tr);Mv=i(Kz,"flax.nn.Module"),Kz.forEach(t),wv=i(Bu,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bu.forEach(t),xv=l(oe),Oc=a(oe,"P",{});var Zz=s(Oc);zv=i(Zz,"Finally, this model supports inherent JAX features such as:"),Zz.forEach(t),qv=l(oe),_t=a(oe,"UL",{});var En=s(_t);Ic=a(En,"LI",{});var Yz=s(Ic);Mr=a(Yz,"A",{href:!0,rel:!0});var e2=s(Mr);Bv=i(e2,"Just-In-Time (JIT) compilation"),e2.forEach(t),Yz.forEach(t),Fv=l(En),Nc=a(En,"LI",{});var t2=s(Nc);wr=a(t2,"A",{href:!0,rel:!0});var o2=s(wr);$v=i(o2,"Automatic Differentiation"),o2.forEach(t),t2.forEach(t),jv=l(En),Dc=a(En,"LI",{});var n2=s(Dc);xr=a(n2,"A",{href:!0,rel:!0});var a2=s(xr);Ev=i(a2,"Vectorization"),a2.forEach(t),n2.forEach(t),Pv=l(En),Lc=a(En,"LI",{});var s2=s(Lc);zr=a(s2,"A",{href:!0,rel:!0});var r2=s(zr);Cv=i(r2,"Parallelization"),r2.forEach(t),s2.forEach(t),En.forEach(t),Sv=l(oe),Ne=a(oe,"DIV",{class:!0});var Wt=s(Ne);f(qr.$$.fragment,Wt),Av=l(Wt),jo=a(Wt,"P",{});var Yi=s(jo);Ov=i(Yi,"The "),Gc=a(Yi,"CODE",{});var i2=s(Gc);Iv=i(i2,"FlaxMBartPreTrainedModel"),i2.forEach(t),Nv=i(Yi,"forward method, overrides the "),Wc=a(Yi,"CODE",{});var d2=s(Wc);Dv=i(d2,"__call__"),d2.forEach(t),Lv=i(Yi," special method."),Yi.forEach(t),Gv=l(Wt),f(yn.$$.fragment,Wt),Wv=l(Wt),Rc=a(Wt,"P",{});var l2=s(Rc);Rv=i(l2,"Example:"),l2.forEach(t),Uv=l(Wt),f(Br.$$.fragment,Wt),Wt.forEach(t),Xv=l(oe),qt=a(oe,"DIV",{class:!0});var ed=s(qt);f(Fr.$$.fragment,ed),Hv=l(ed),Uc=a(ed,"P",{});var c2=s(Uc);Vv=i(c2,"Example:"),c2.forEach(t),Qv=l(ed),f($r.$$.fragment,ed),ed.forEach(t),Jv=l(oe),Bt=a(oe,"DIV",{class:!0});var td=s(Bt);f(jr.$$.fragment,td),Kv=l(td),Xc=a(td,"P",{});var p2=s(Xc);Zv=i(p2,"Example:"),p2.forEach(t),Yv=l(td),f(Er.$$.fragment,td),td.forEach(t),oe.forEach(t),dh=l(o),Eo=a(o,"H2",{class:!0});var Fu=s(Eo);vn=a(Fu,"A",{id:!0,class:!0,href:!0});var h2=s(vn);Hc=a(h2,"SPAN",{});var u2=s(Hc);f(Pr.$$.fragment,u2),u2.forEach(t),h2.forEach(t),eT=l(Fu),Vc=a(Fu,"SPAN",{});var m2=s(Vc);tT=i(m2,"FlaxMBartForQuestionAnswering"),m2.forEach(t),Fu.forEach(t),lh=l(o),I=a(o,"DIV",{class:!0});var ne=s(I);f(Cr.$$.fragment,ne),oT=l(ne),Po=a(ne,"P",{});var od=s(Po);nT=i(od,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
