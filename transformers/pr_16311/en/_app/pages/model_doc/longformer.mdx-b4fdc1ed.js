...
first positional argument :`),Fe.forEach(o),X=d(p),z=a(p,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var xe=i(U);de=s(xe,"input_ids"),xe.forEach(o),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=d(O),q=a(O,"LI",{});var A=i(q);ue=s(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(A,"CODE",{});var ke=i(W);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(A," or "),H=a(A,"CODE",{});var Te=i(H);ae=s(Te,"model([input_ids, attention_mask, token_type_ids])"),Te.forEach(o),A.forEach(o),_e=d(O),j=a(O,"LI",{});var te=i(j);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),O.forEach(o)},m(p,F){h(p,f,F),e(f,x),h(p,g,F),h(p,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,pe),h(p,J,F),h(p,E,F),e(E,Z),e(E,I),e(I,ee),e(E,me),e(E,S),e(S,fe),e(E,le),h(p,G,F),h(p,P,F),e(P,oe),h(p,X,F),h(p,z,F),e(z,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,H),e(H,ae),e(z,_e),e(z,j),e(j,ie),e(j,R),e(R,we)},d(p){p&&o(f),p&&o(g),p&&o(u),p&&o(J),p&&o(E),p&&o(G),p&&o(P),p&&o(X),p&&o(z)}}}function t1(Q){let f,x,g,u,$;return{c(){f=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){f=a(w,"P",{});var _=i(f);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(o),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(w,_){h(w,f,_),e(f,x),e(f,g),e(g,u),e(f,$)},d(w){w&&o(f)}}}function n1(Q){let f,x,g,u,$,w,_,M,pe,J,E,Z,I,ee,me,S,fe,le,G,P,oe,X,z,C,ne,U,de,se,D,ge,ce,q,ue,W,re,K,H,ae,_e,j,ie,R,we;return{c(){f=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),fe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){f=a(p,"P",{});var F=i(f);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),g=d(p),u=a(p,"UL",{});var Y=i(u);$=a(Y,"LI",{});var be=i($);w=s(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(o),_=d(Y),M=a(Y,"LI",{});var he=i(M);pe=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(o),Y.forEach(o),J=d(p),E=a(p,"P",{});var N=i(E);Z=s(N,"This second option is useful when using "),I=a(N,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(o),me=s(N,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(o),X=d(p),z=a(p,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var xe=i(U);de=s(xe,"input_ids"),xe.forEach(o),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=d(O),q=a(O,"LI",{});var A=i(q);ue=s(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(A,"CODE",{});var ke=i(W);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(A," or "),H=a(A,"CODE",{});var Te=i(H);ae=s(Te,"model([input_ids, attention_mask, token_type_ids])"),Te.forEach(o),A.forEach(o),_e=d(O),j=a(O,"LI",{});var te=i(j);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),O.forEach(o)},m(p,F){h(p,f,F),e(f,x),h(p,g,F),h(p,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,pe),h(p,J,F),h(p,E,F),e(E,Z),e(E,I),e(I,ee),e(E,me),e(E,S),e(S,fe),e(E,le),h(p,G,F),h(p,P,F),e(P,oe),h(p,X,F),h(p,z,F),e(z,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,H),e(H,ae),e(z,_e),e(z,j),e(j,ie),e(j,R),e(R,we)},d(p){p&&o(f),p&&o(g),p&&o(u),p&&o(J),p&&o(E),p&&o(G),p&&o(P),p&&o(X),p&&o(z)}}}function s1(Q){let f,x,g,u,$;return{c(){f=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){f=a(w,"P",{});var _=i(f);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(o),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(w,_){h(w,f,_),e(f,x),e(f,g),e(g,u),e(f,$)},d(w){w&&o(f)}}}function r1(Q){let f,x,g,u,$,w,_,M,pe,J,E,Z,I,ee,me,S,fe,le,G,P,oe,X,z,C,ne,U,de,se,D,ge,ce,q,ue,W,re,K,H,ae,_e,j,ie,R,we;return{c(){f=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),fe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){f=a(p,"P",{});var F=i(f);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),g=d(p),u=a(p,"UL",{});var Y=i(u);$=a(Y,"LI",{});var be=i($);w=s(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(o),_=d(Y),M=a(Y,"LI",{});var he=i(M);pe=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(o),Y.forEach(o),J=d(p),E=a(p,"P",{});var N=i(E);Z=s(N,"This second option is useful when using "),I=a(N,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(o),me=s(N,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(o),X=d(p),z=a(p,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var xe=i(U);de=s(xe,"input_ids"),xe.forEach(o),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=d(O),q=a(O,"LI",{});var A=i(q);ue=s(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(A,"CODE",{});var ke=i(W);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(A," or "),H=a(A,"CODE",{});var Te=i(H);ae=s(Te,"model([input_ids, attention_mask, token_type_ids])"),Te.forEach(o),A.forEach(o),_e=d(O),j=a(O,"LI",{});var te=i(j);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),O.forEach(o)},m(p,F){h(p,f,F),e(f,x),h(p,g,F),h(p,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,pe),h(p,J,F),h(p,E,F),e(E,Z),e(E,I),e(I,ee),e(E,me),e(E,S),e(S,fe),e(E,le),h(p,G,F),h(p,P,F),e(P,oe),h(p,X,F),h(p,z,F),e(z,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,H),e(H,ae),e(z,_e),e(z,j),e(j,ie),e(j,R),e(R,we)},d(p){p&&o(f),p&&o(g),p&&o(u),p&&o(J),p&&o(E),p&&o(G),p&&o(P),p&&o(X),p&&o(z)}}}function a1(Q){let f,x,g,u,$;return{c(){f=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){f=a(w,"P",{});var _=i(f);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(o),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(w,_){h(w,f,_),e(f,x),e(f,g),e(g,u),e(f,$)},d(w){w&&o(f)}}}function i1(Q){let f,x,g,u,$,w,_,M,pe,J,E,Z,I,ee,me,S,fe,le,G,P,oe,X,z,C,ne,U,de,se,D,ge,ce,q,ue,W,re,K,H,ae,_e,j,ie,R,we;return{c(){f=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),fe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){f=a(p,"P",{});var F=i(f);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),g=d(p),u=a(p,"UL",{});var Y=i(u);$=a(Y,"LI",{});var be=i($);w=s(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(o),_=d(Y),M=a(Y,"LI",{});var he=i(M);pe=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(o),Y.forEach(o),J=d(p),E=a(p,"P",{});var N=i(E);Z=s(N,"This second option is useful when using "),I=a(N,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(o),me=s(N,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(o),X=d(p),z=a(p,"UL",{});var O=i(z);C=a(O,"LI",{});var V=i(C);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var xe=i(U);de=s(xe,"input_ids"),xe.forEach(o),se=s(V," only and nothing else: "),D=a(V,"CODE",{});var ye=i(D);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=d(O),q=a(O,"LI",{});var A=i(q);ue=s(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a(A,"CODE",{});var ke=i(W);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(A," or "),H=a(A,"CODE",{});var Te=i(H);ae=s(Te,"model([input_ids, attention_mask, token_type_ids])"),Te.forEach(o),A.forEach(o),_e=d(O),j=a(O,"LI",{});var te=i(j);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(te,"CODE",{});var Me=i(R);we=s(Me,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me.forEach(o),te.forEach(o),O.forEach(o)},m(p,F){h(p,f,F),e(f,x),h(p,g,F),h(p,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,pe),h(p,J,F),h(p,E,F),e(E,Z),e(E,I),e(I,ee),e(E,me),e(E,S),e(S,fe),e(E,le),h(p,G,F),h(p,P,F),e(P,oe),h(p,X,F),h(p,z,F),e(z,C),e(C,ne),e(C,U),e(U,de),e(C,se),e(C,D),e(D,ge),e(z,ce),e(z,q),e(q,ue),e(q,W),e(W,re),e(q,K),e(q,H),e(H,ae),e(z,_e),e(z,j),e(j,ie),e(j,R),e(R,we)},d(p){p&&o(f),p&&o(g),p&&o(u),p&&o(J),p&&o(E),p&&o(G),p&&o(P),p&&o(X),p&&o(z)}}}function l1(Q){let f,x,g,u,$;return{c(){f=r("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){f=a(w,"P",{});var _=i(f);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(o),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(w,_){h(w,f,_),e(f,x),e(f,g),e(g,u),e(f,$)},d(w){w&&o(f)}}}function d1(Q){let f,x,g,u,$,w,_,M,pe,J,E,Z,I,ee,me,S,fe,le,G,P,oe,X,z,C,ne,U,de,se,D,ge,ce,q,ue,W,re,K,H,ae,_e,j,ie,R,we;return{c(){f=r("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=r("ul"),$=r("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=r("li"),pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=r("p"),Z=n("This second option is useful when using "),I=r("code"),ee=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r("code"),fe=n("model(inputs)"),le=n("."),G=l(),P=r("p"),oe=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=l(),z=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),D=r("code"),ge=n("model(inputs_ids)"),ce=l(),q=r("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r("code"),re=n("model([input_ids, attention_mask])"),K=n(" or "),H=r("code"),ae=n("model([input_ids, attention_mask, token_type_ids])"),_e=l(),j=r("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){f=a(p,"P",{});var F=i(f);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),g=d(p),u=a(p,"UL",{});var Y=i(u);$=a(Y,"LI",{});var be=i($);w=s(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(o),_=d(Y),M=a(Y,"LI",{});var he=i(M);pe=s(he,"having all inputs as a list, tuple or dict in the first positional arguments."),he.forEach(o),Y.forEach(o),J=d(p),E=a(p,"P",{});var N=i(E);Z=s(N,"This second option is useful when using "),I=a(N,"CODE",{});var ve=i(I);ee=s(ve,"tf.keras.Model.fit"),ve.forEach(o),me=s(N,` method which currently requires having all the
...
`}}),dn=new Pe({props:{$$slots:{default:[t1]},$$scope:{ctx:Q}}}),tr=new ao({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMaskedLM
...
`}}),pn=new Pe({props:{$$slots:{default:[s1]},$$scope:{ctx:Q}}}),dr=new ao({props:{code:`from transformers import LongformerTokenizer, TFLongformerForQuestionAnswering
import tensorflow as tf
...
`}}),gn=new Pe({props:{$$slots:{default:[a1]},$$scope:{ctx:Q}}}),ur=new ao({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
`}}),wn=new Pe({props:{$$slots:{default:[l1]},$$scope:{ctx:Q}}}),yr=new ao({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16311/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new Pe({props:{$$slots:{default:[d1]},$$scope:{ctx:Q}}}),Er=new B({props:{name:"call",anchor:"transformers.TFLongformerForMultipleChoice.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"global_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16311/src/transformers/models/longformer/modeling_tf_longformer.py#L2429",parametersDescription:[{anchor:"transformers.TFLongformerForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16311/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/pr_16311/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16311/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Tn=new Pe({props:{$$slots:{default:[c1]},$$scope:{ctx:Q}}}),zr=new ao({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMultipleChoice
import tensorflow as tf
