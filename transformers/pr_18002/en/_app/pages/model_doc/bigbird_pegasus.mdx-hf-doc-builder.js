...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18002/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18002/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2516",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18002/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2787",returnDescription:`
<p>A <a
