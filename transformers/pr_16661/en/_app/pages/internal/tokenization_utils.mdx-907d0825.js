...
PyTorch tensors, you will lose the specific device of your tensors however.`),W.forEach(t)},m(ge,W){$(ge,h,W),e(h,P),e(h,v),e(v,z),e(h,E),e(h,y),e(y,x),e(h,B)},d(ge){ge&&t(h)}}}function ah(M){let h,P;return{c(){h=r("p"),P=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(v){h=s(v,"P",{});var z=a(h);P=n(z,"This API is experimental and may have some slight breaking changes in the next releases."),z.forEach(t)},m(v,z){$(v,h,z),e(h,P)},d(v){v&&t(h)}}}function ih(M){let h,P,v,z,E,y,x,B,ge,W,D,ro,so,ks,bs,ao,vs,Ts,io,ys,ws,co,zs,xs,qr,lo,$s,Er,ke,De,So,ot,Ps,Co,qs,Br,p,nt,Es,be,Bs,po,Ls,Ds,mo,Is,Ns,As,Oo,Fs,Ss,Wo,Cs,Os,I,te,jo,Ws,js,Ro,Rs,Us,Uo,Ms,Vs,Gs,F,Mo,Hs,Xs,Vo,Ys,Js,Go,Ks,Qs,Ho,Zs,ea,Xo,ta,oa,na,V,Yo,ra,sa,Jo,aa,ia,Ko,da,ca,Qo,la,pa,ma,S,Zo,ha,ua,en,fa,_a,tn,ga,ka,on,ba,va,ho,Ta,ya,wa,Ie,nn,za,xa,rn,$a,Pa,qa,G,sn,Ea,Ba,an,La,Da,dn,Ia,Na,cn,Aa,Fa,Sa,H,ln,Ca,Oa,pn,Wa,ja,mn,Ra,Ua,hn,Ma,Va,Ga,Ne,rt,Ha,un,Xa,Ya,Ae,st,Ja,fn,Ka,Qa,Fe,at,Za,_n,ei,ti,oe,it,oi,gn,ni,ri,Se,si,ne,dt,ai,kn,ii,di,bn,ci,li,Ce,ct,pi,vn,mi,hi,Oe,lt,ui,pt,fi,Tn,_i,gi,ki,re,mt,bi,uo,vi,fo,Ti,yi,yn,wi,zi,se,ht,xi,wn,$i,Pi,ut,qi,zn,Ei,Bi,Li,ae,ft,Di,xn,Ii,Ni,_t,Ai,$n,Fi,Si,Ci,ie,gt,Oi,Pn,Wi,ji,We,Ri,C,kt,Ui,bt,Mi,_o,Vi,Gi,Hi,je,Xi,qn,Yi,Ji,vt,Ki,Re,Tt,Qi,ve,Zi,En,ed,td,Bn,od,nd,rd,de,yt,sd,Ln,ad,id,ce,Dn,dd,cd,In,ld,pd,Nn,md,hd,ud,X,wt,fd,An,_d,gd,Q,kd,Fn,bd,vd,Sn,Td,yd,Cn,wd,zd,xd,Ue,$d,Me,zt,Pd,j,qd,On,Ed,Bd,Wn,Ld,Dd,jn,Id,Nd,Rn,Ad,Fd,Sd,Ve,xt,Cd,Un,Od,Wd,Y,$t,jd,Pt,Rd,Mn,Ud,Md,Vd,Vn,Gd,Hd,qt,Xd,le,Et,Yd,Bt,Jd,Gn,Kd,Qd,Zd,Ge,ec,J,Lt,tc,Hn,oc,nc,Dt,rc,Xn,sc,ac,ic,It,dc,Yn,cc,lc,pc,pe,Nt,mc,Jn,hc,uc,At,fc,Kn,_c,gc,kc,He,Ft,bc,St,vc,Qn,Tc,yc,wc,Xe,Ct,zc,Zn,xc,Lr,Te,Ye,er,Ot,$c,tr,Pc,Dr,A,Wt,qc,ye,Ec,go,Bc,Lc,ko,Dc,Ic,Nc,q,jt,Ac,or,Fc,Sc,nr,Cc,Oc,Rt,Wc,bo,jc,Rc,Uc,Ut,Mc,rr,Vc,Gc,Hc,Mt,sr,Xc,Yc,Vt,Jc,ar,Kc,Qc,Zc,R,el,vo,tl,ol,ir,nl,rl,dr,sl,al,cr,il,dl,cl,lr,ll,pl,Gt,ml,N,Ht,hl,pr,ul,fl,mr,_l,gl,Xt,kl,To,bl,vl,Tl,hr,yl,wl,Yt,zl,me,Jt,xl,we,$l,ur,Pl,ql,fr,El,Bl,Ll,_r,Dl,Ir,ze,Je,gr,Kt,Il,kr,Nl,Nr,xe,Qt,Al,$e,Fl,br,Sl,Cl,Ke,Ol,vr,Wl,jl,Rl,Ar,Pe,Zt,Ul,Tr,Ml,Fr,qe,eo,Vl,yr,Gl,Sr;return y=new gs({}),ot=new gs({}),nt=new w({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16661/src/transformers/tokenization_utils_base.py#L1428",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
The maximum length (in number of tokens) for the inputs to the transformer model. When the tokenizer is
loaded with <a href="/docs/transformers/pr_16661/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained">from_pretrained()</a>, this will be set to the
...
using the <a href="/docs/transformers/pr_16661/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained">save_pretrained()</a> method, e.g.,
...
`}}),yt=new w({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16661/src/transformers/tokenization_utils_base.py#L1534",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
`}}),wt=new w({props:{name:"pad",anchor:"transformers.PreTrainedTokenizerBase.pad",parameters:[{name:"encoded_inputs",val:": typing.Union[transformers.tokenization_utils_base.BatchEncoding, typing.List[transformers.tokenization_utils_base.BatchEncoding], typing.Dict[str, typing.List[int]], typing.Dict[str, typing.List[typing.List[int]]], typing.List[typing.Dict[str, typing.List[int]]]]"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = True"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"verbose",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/pr_16661/src/transformers/tokenization_utils_base.py#L2695",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.pad.encoded_inputs",description:`<strong>encoded_inputs</strong> (<a href="/docs/transformers/pr_16661/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, list of <a href="/docs/transformers/pr_16661/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <code>Dict[str, List[int]]</code>, <code>Dict[str, List[List[int]]</code> or <code>List[Dict[str, List[int]]]</code>) &#x2014;
Tokenized inputs. Can represent one input (<a href="/docs/transformers/pr_16661/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> or <code>Dict[str, List[int]]</code>) or a batch of
tokenized inputs (list of <a href="/docs/transformers/pr_16661/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <em>Dict[str, List[List[int]]]</em> or <em>List[Dict[str,
...
the note above for the return type.`,name:"encoded_inputs"},{anchor:"transformers.PreTrainedTokenizerBase.pad.padding",description:`<strong>padding</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16661/en/internal/file_utils#transformers.utils.PaddingStrategy">PaddingStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16661/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16661/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Activates and controls truncation. Accepts the following values:</p>
<ul>
<li><code>True</code> or <code>&apos;longest_first&apos;</code>: Truncate to a maximum length specified with the argument <code>max_length</code> or
to the maximum acceptable input length for the model if that argument is not provided. This will
...
`}}),Ot=new gs({}),Wt=new w({props:{name:"class transformers.SpecialTokensMixin",anchor:"transformers.SpecialTokensMixin",parameters:[{name:"verbose",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16661/src/transformers/tokenization_utils_base.py#L748",parametersDescription:[{anchor:"transformers.SpecialTokensMixin.bos_token",description:`<strong>bos_token</strong> (<code>str</code> or <code>tokenizers.AddedToken</code>, <em>optional</em>) &#x2014;
...
A tuple or a list of additional special tokens.`,name:"additional_special_tokens"}]}}),jt=new w({props:{name:"add_special_tokens",anchor:"transformers.SpecialTokensMixin.add_special_tokens",parameters:[{name:"special_tokens_dict",val:": typing.Dict[str, typing.Union[str, tokenizers.AddedToken]]"}],source:"https://github.com/huggingface/transformers/blob/pr_16661/src/transformers/tokenization_utils_base.py#L828",parametersDescription:[{anchor:"transformers.SpecialTokensMixin.add_special_tokens.special_tokens_dict",description:`<strong>special_tokens_dict</strong> (dictionary <em>str</em> to <em>str</em> or <code>tokenizers.AddedToken</code>) &#x2014;
...
`),fr=r("code"),El=o("tokenizer.cls_token"),Bl=o(", etc.) are in the vocabulary."),Ll=d(),_r=r("p"),Dl=o("Add the missing ones to the vocabulary if needed."),Ir=d(),ze=r("h2"),Je=r("a"),gr=r("span"),u(Kt.$$.fragment),Il=d(),kr=r("span"),Nl=o("Enums and namedtuples"),Nr=d(),xe=r("div"),u(Qt.$$.fragment),Al=d(),$e=r("p"),Fl=o("Possible values for the "),br=r("code"),Sl=o("truncation"),Cl=o(" argument in "),Ke=r("a"),Ol=o("PreTrainedTokenizerBase."),vr=r("strong"),Wl=o("call"),jl=o("()"),Rl=o(`. Useful for tab-completion in
an IDE.`),Ar=d(),Pe=r("div"),u(Zt.$$.fragment),Ul=d(),Tr=r("p"),Ml=o("Character span in the original string."),Fr=d(),qe=r("div"),u(eo.$$.fragment),Vl=d(),yr=r("p"),Gl=o("Token span in an encoded string (list of tokens)."),this.h()},l(i){const T=eh('[data-svelte="svelte-1phssyn"]',document.head);h=s(T,"META",{name:!0,content:!0}),T.forEach(t),P=c(i),v=s(i,"H1",{class:!0});var to=a(v);z=s(to,"A",{id:!0,class:!0,href:!0});var wr=a(z);E=s(wr,"SPAN",{});var zr=a(E);f(y.$$.fragment,zr),zr.forEach(t),wr.forEach(t),x=c(to),B=s(to,"SPAN",{});var xr=a(B);ge=n(xr,"Utilities for Tokenizers"),xr.forEach(t),to.forEach(t),W=c(i),D=s(i,"P",{});var U=a(D);ro=n(U,`This page lists all the utility functions used by the tokenizers, mainly the class
...
adding special tokens.`),Sp.forEach(t),di=c(zo),bn=s(zo,"P",{});var Cp=a(bn);ci=n(Cp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Cp.forEach(t),zo.forEach(t),li=c(m),Ce=s(m,"DIV",{class:!0});var Rr=a(Ce);f(ct.$$.fragment,Rr),pi=c(Rr),vn=s(Rr,"P",{});var Op=a(vn);mi=n(Op,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Op.forEach(t),Rr.forEach(t),hi=c(m),Oe=s(m,"DIV",{class:!0});var Ur=a(Oe);f(lt.$$.fragment,Ur),ui=c(Ur),pt=s(Ur,"P",{});var Mr=a(pt);fi=n(Mr,"Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=s(Mr,"CODE",{});var Wp=a(Tn);_i=n(Wp,'" ".join(tokens)'),Wp.forEach(t),gi=n(Mr,` but we
...
vocab.`),no.forEach(t),Bo.forEach(t),ud=c(m),X=s(m,"DIV",{class:!0});var Qe=a(X);f(wt.$$.fragment,Qe),fd=c(Qe),An=s(Qe,"P",{});var om=a(An);_d=n(om,`Pad a single encoded input or a batch of encoded inputs up to predefined length or to the max sequence length
...
`),Sn=s(Ze,"CODE",{});var rm=a(Sn);Td=n(rm,"self.pad_token_id"),rm.forEach(t),yd=n(Ze," and "),Cn=s(Ze,"CODE",{});var sm=a(Cn);wd=n(sm,"self.pad_token_type_id"),sm.forEach(t),zd=n(Ze,")"),Ze.forEach(t),xd=c(Qe),f(Ue.$$.fragment,Qe),Qe.forEach(t),$d=c(m),Me=s(m,"DIV",{class:!0});var Yr=a(Me);f(zt.$$.fragment,Yr),Pd=c(Yr),j=s(Yr,"P",{});var ue=a(j);qd=n(ue,`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
adds special tokens, truncates sequences if overflowing while taking into account the special tokens and
