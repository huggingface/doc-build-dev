...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),v(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),k(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),y(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(L){let l,b,m,p,_,n,c,z,la,bn,ee,ge,fo,Ke,ca,_o,pa,vn,fe,ua,Ze,ha,ma,kn,Vt,ga,yn,Yt,To,fa,wn,Rt,_a,$n,E,O,Jt,Ta,ba,Kt,va,ka,bo,ya,wa,vo,$a,xa,ko,La,za,yo,qa,ja,Fa,Qe,Ma,wo,Ca,Ea,Oa,Xe,Ga,$o,Pa,Sa,Aa,j,Na,xo,Ia,Da,Lo,Wa,Ba,zo,Ua,Ha,qo,Va,Ya,jo,Ra,Ja,Fo,Ka,Za,Qa,q,Mo,Xa,es,Co,ts,os,Eo,ns,as,Oo,ss,rs,Go,ds,is,Po,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,Ln,Q,_s,nt,Ts,bs,at,vs,ks,zn,te,_e,Ao,st,ys,No,ws,qn,K,rt,$s,Z,xs,Zt,Ls,zs,Qt,qs,js,dt,Fs,Ms,Cs,oe,Es,Xt,Os,Gs,eo,Ps,Ss,jn,ne,Te,Io,it,As,Do,Ns,Fn,F,lt,Is,Wo,Ds,Ws,ct,Bs,pt,Us,Hs,Vs,ut,Ys,to,Rs,Js,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,oo,nr,ar,Bo,sr,rr,dr,be,ir,ve,Mn,se,ke,Uo,ft,lr,Ho,cr,Cn,M,_t,pr,Tt,ur,Vo,hr,mr,gr,bt,fr,vt,_r,Tr,br,kt,vr,no,kr,yr,wr,yt,$r,wt,xr,Lr,zr,W,$t,qr,re,jr,ao,Fr,Mr,Yo,Cr,Er,Or,ye,Gr,we,En,de,$e,Ro,xt,Pr,Jo,Sr,On,C,Lt,Ar,Ko,Nr,Ir,zt,Dr,qt,Wr,Br,Ur,jt,Hr,so,Vr,Yr,Rr,Ft,Jr,Mt,Kr,Zr,Qr,B,Ct,Xr,ie,ed,ro,td,od,Zo,nd,ad,sd,xe,rd,Le,Gn,le,ze,Qo,Et,dd,Xo,id,Pn,A,Ot,ld,U,Gt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,je,Td,Fe,Pt,bd,Me,vd,Ce,St,kd,Ee,Sn,pe,Oe,on,At,yd,nn,wd,An,N,Nt,$d,H,It,xd,ue,Ld,an,zd,qd,sn,jd,Fd,Md,Ge,Cd,Pe,Ed,Se,Dt,Od,Ae,Gd,Ne,Wt,Pd,Ie,Nn;return n=new Je({}),Ke=new Je({}),ot=new X({props:{code:`import evaluate
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17662/en/model_doc/longt5#transformers.LongT5Model">LongT5Model</a>.`,name:"vocab_size"},{anchor:"transformers.LongT5Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_17662/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_17662/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17662/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_17662/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17662/en/model_doc/longt5#transformers.LongT5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17662/src/transformers/models/longt5/modeling_longt5.py#L1928",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17662/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17662/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_17662/src/transformers/models/longt5/modeling_flax_longt5.py#L1694",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17662/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_17662/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17662/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_17662/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
and behavior.`),er=u(),D=r("div"),v(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),oo=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Bo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),v(be.$$.fragment),ir=u(),v(ve.$$.fragment),Mn=u(),se=r("h2"),ke=r("a"),Uo=r("span"),v(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),Cn=u(),M=r("div"),v(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Vo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),vt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
a few new parameters \u2014 global relative position biases and a layer normalization for global token\u2019s embedding.
The complexity of this mechanism is `),So=d(G,"CODE",{});var ni=i(So);ps=s(ni,"O(l(r + l/k))"),ni.forEach(o),us=s(G,"."),G.forEach(o),hs=h(V),et=d(V,"LI",{});var Wn=i(et);ms=s(Wn,"An example showing how to evaluate a fine-tuned LongT5 model on the "),tt=d(Wn,"A",{href:!0,rel:!0});var ai=i(tt);gs=s(ai,"pubmed dataset"),ai.forEach(o),fs=s(Wn," is below."),Wn.forEach(o),V.forEach(o),xn=h(t),k(ot.$$.fragment,t),Ln=h(t),Q=d(t,"P",{});var io=i(Q);_s=s(io,"This model was contributed by "),nt=d(io,"A",{href:!0,rel:!0});var si=i(nt);Ts=s(si,"stancld"),si.forEach(o),bs=s(io,`.
The original code can be found `),at=d(io,"A",{href:!0,rel:!0});var ri=i(at);vs=s(ri,"here"),ri.forEach(o),ks=s(io,"."),io.forEach(o),zn=h(t),te=d(t,"H2",{class:!0});var Bn=i(te);_e=d(Bn,"A",{id:!0,class:!0,href:!0});var di=i(_e);Ao=d(di,"SPAN",{});var ii=i(Ao);k(st.$$.fragment,ii),ii.forEach(o),di.forEach(o),ys=h(Bn),No=d(Bn,"SPAN",{});var li=i(No);ws=s(li,"LongT5Config"),li.forEach(o),Bn.forEach(o),qn=h(t),K=d(t,"DIV",{class:!0});var lo=i(K);k(rt.$$.fragment,lo),$s=h(lo),Z=d(lo,"P",{});var De=i(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Zt=d(De,"A",{href:!0});var ci=i(Zt);Ls=s(ci,"LongT5Model"),ci.forEach(o),zs=s(De," or a "),Qt=d(De,"A",{href:!0});var pi=i(Qt);qs=s(pi,"FlaxLongT5Model"),pi.forEach(o),js=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
`),dt=d(De,"A",{href:!0,rel:!0});var ui=i(dt);Fs=s(ui,"google/long-t5-local-base"),ui.forEach(o),Ms=s(De," architecture."),De.forEach(o),Cs=h(lo),oe=d(lo,"P",{});var co=i(oe);Es=s(co,"Configuration objects inherit from "),Xt=d(co,"A",{href:!0});var hi=i(Xt);Os=s(hi,"PretrainedConfig"),hi.forEach(o),Gs=s(co,` and can be used to control the model outputs. Read the
documentation from `),eo=d(co,"A",{href:!0});var mi=i(eo);Ps=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(co," for more information."),co.forEach(o),lo.forEach(o),jn=h(t),ne=d(t,"H2",{class:!0});var Un=i(ne);Te=d(Un,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);k(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),As=h(Un),Do=d(Un,"SPAN",{});var _i=i(Do);Ns=s(_i,"LongT5Model"),_i.forEach(o),Un.forEach(o),Fn=h(t),F=d(t,"DIV",{class:!0});var Y=i(F);k(lt.$$.fragment,Y),Is=h(Y),Wo=d(Y,"P",{});var Ti=i(Wo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Ws=h(Y),ct=d(Y,"P",{});var Hn=i(ct);Bs=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var bi=i(pt);Us=s(bi,`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),zr=h(R),W=d(R,"DIV",{class:!0});var Be=i(W);k($t.$$.fragment,Be),qr=h(Be),re=d(Be,"P",{});var uo=i(re);jr=s(uo,"The "),ao=d(uo,"A",{href:!0});var Mi=i(ao);Fr=s(Mi,"LongT5ForConditionalGeneration"),Mi.forEach(o),Mr=s(uo," forward method, overrides the "),Yo=d(uo,"CODE",{});var Ci=i(Yo);Cr=s(Ci,"__call__"),Ci.forEach(o),Er=s(uo," special method."),uo.forEach(o),Or=h(Be),k(ye.$$.fragment,Be),Gr=h(Be),k(we.$$.fragment,Be),Be.forEach(o),R.forEach(o),En=h(t),de=d(t,"H2",{class:!0});var Xn=i(de);$e=d(Xn,"A",{id:!0,class:!0,href:!0});var Ei=i($e);Ro=d(Ei,"SPAN",{});var Oi=i(Ro);k(xt.$$.fragment,Oi),Oi.forEach(o),Ei.forEach(o),Pr=h(Xn),Jo=d(Xn,"SPAN",{});var Gi=i(Jo);Sr=s(Gi,"LongT5EncoderModel"),Gi.forEach(o),Xn.forEach(o),On=h(t),C=d(t,"DIV",{class:!0});var J=i(C);k(Lt.$$.fragment,J),Ar=h(J),Ko=d(J,"P",{});var Pi=i(Ko);Nr=s(Pi,"The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Pi.forEach(o),Ir=h(J),zt=d(J,"P",{});var ea=i(zt);Dr=s(ea,"The LongT5 model was proposed in "),qt=d(ea,"A",{href:!0,rel:!0});var Si=i(qt);Wr=s(Si,`LongT5: Efficient Text-To-Text Transformer for Long
