import{S as wa,i as ba,s as va,e as n,k as d,w,t as a,M as Sa,c as s,d as o,m as c,a as i,x as b,h as r,b as l,N as $a,F as e,g as p,y as v,q as S,o as $,B as y,v as ya}from"../../chunks/vendor-6b77c823.js";import{T as bs}from"../../chunks/Tip-39098574.js";import{D as Le}from"../../chunks/Docstring-1088f2fb.js";import{C as fo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as lt}from"../../chunks/IconCopyLink-7a11ce68.js";function Ta(X){let m,k,f,_,x;return{c(){m=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=a("Module"),x=a(`
...
<p>Example &#x2014;`,name:"encoder_stride"}],source:"https://github.com/huggingface/transformers/blob/pr_16867/src/transformers/models/swin/configuration_swin.py#L29"}}),Se=new fo({props:{code:`from transformers import SwinModel, SwinConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),$e=new lt({}),ye=new Le({props:{name:"class transformers.SwinModel",anchor:"transformers.SwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],parametersDescription:[{anchor:"transformers.SwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16867/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16867/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16867/src/transformers/models/swin/modeling_swin.py#L885"}}),ke=new Le({props:{name:"forward",anchor:"transformers.SwinModel.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.SwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16867/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_16867/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/pr_16867/src/transformers/models/swin/modeling_swin.py#L912",returnDescription:`
<p>A <code>transformers.models.swin.modeling_swin.SwinModelOutput</code> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16867/en/model_doc/swin#transformers.SwinConfig"
...
`}}),ae=new bs({props:{$$slots:{default:[Ta]},$$scope:{ctx:X}}}),Me=new fo({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16867/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/pr_16867/src/transformers/models/swin/modeling_swin.py#L983"}}),Ce=new Le({props:{name:"forward",anchor:"transformers.SwinForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_16867/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/pr_16867/src/transformers/models/swin/modeling_swin.py#L998",returnDescription:`
...
`}}),ie=new bs({props:{$$slots:{default:[xa]},$$scope:{ctx:X}}}),Ie=new fo({props:{code:`from transformers import AutoFeatureExtractor, SwinForMaskedImageModeling
import torch
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16867/src/transformers/models/swin/modeling_swin.py#L1108",returnDescription:`
...
`}}),de=new bs({props:{$$slots:{default:[ka]},$$scope:{ctx:X}}}),De=new fo({props:{code:`from transformers import AutoFeatureExtractor, SwinForImageClassification
import torch
from datasets import load_dataset
...
tabby, tabby cat`}}),{c(){m=n("meta"),k=d(),f=n("h1"),_=n("a"),x=n("span"),w(u.$$.fragment),g=d(),E=n("span"),uo=a("Swin Transformer"),Nt=d(),H=n("h2"),ee=n("a"),dt=n("span"),w(pe.$$.fragment),go=d(),ct=n("span"),_o=a("Overview"),Lt=d(),W=n("p"),wo=a("The Swin Transformer was proposed in "),me=n("a"),bo=a("Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),vo=n("br"),So=a(`
...
documentation from `),Ye=n("a"),un=a("PretrainedConfig"),gn=a(" for more information."),_n=d(),w(Se.$$.fragment),Gt=d(),K=n("h2"),se=n("a"),$t=n("span"),w($e.$$.fragment),wn=d(),yt=n("span"),bn=a("SwinModel"),Jt=d(),P=n("div"),w(ye.$$.fragment),vn=d(),Te=n("p"),Sn=a(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ls=d(),C=n("div"),w(Oe.$$.fragment),ds=d(),Q=n("p"),cs=a("The "),Je=n("a"),hs=a("SwinForImageClassification"),ps=a(" forward method, overrides the "),Pt=n("code"),ms=a("__call__"),fs=a(" special method."),us=d(),w(de.$$.fragment),gs=d(),qt=n("p"),_s=a("Example:"),ws=d(),w(De.$$.fragment),this.h()},l(t){const h=Sa('[data-svelte="svelte-1phssyn"]',document.head);m=s(h,"META",{name:!0,content:!0}),h.forEach(o),k=c(t),f=s(t,"H1",{class:!0});var Ne=i(f);_=s(Ne,"A",{id:!0,class:!0,href:!0});var zt=i(_);x=s(zt,"SPAN",{});var Ot=i(x);b(u.$$.fragment,Ot),Ot.forEach(o),zt.forEach(o),g=c(Ne),E=s(Ne,"SPAN",{});var Ss=i(E);uo=r(Ss,"Swin Transformer"),Ss.forEach(o),Ne.forEach(o),Nt=c(t),H=s(t,"H2",{class:!0});var no=i(H);ee=s(no,"A",{id:!0,class:!0,href:!0});var $s=i(ee);dt=s($s,"SPAN",{});var ys=i(dt);b(pe.$$.fragment,ys),ys.forEach(o),$s.forEach(o),go=c(no),ct=s(no,"SPAN",{});var Ts=i(ct);_o=r(Ts,"Overview"),Ts.forEach(o),no.forEach(o),Lt=c(t),W=s(t,"P",{});var Dt=i(W);wo=r(Dt,"The Swin Transformer was proposed in "),me=s(Dt,"A",{href:!0,rel:!0});var xs=i(me);bo=r(xs,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),xs.forEach(o),vo=s(Dt,"BR",{}),So=r(Dt,`
...
documentation from `),Ye=s(tt,"A",{href:!0});var Ys=i(Ye);un=r(Ys,"PretrainedConfig"),Ys.forEach(o),gn=r(tt," for more information."),tt.forEach(o),_n=c(ce),b(Se.$$.fragment,ce),ce.forEach(o),Gt=c(t),K=s(t,"H2",{class:!0});var lo=i(K);se=s(lo,"A",{id:!0,class:!0,href:!0});var Zs=i(se);$t=s(Zs,"SPAN",{});var Gs=i($t);b($e.$$.fragment,Gs),Gs.forEach(o),Zs.forEach(o),wn=c(lo),yt=s(lo,"SPAN",{});var Js=i(yt);bn=r(Js,"SwinModel"),Js.forEach(o),lo.forEach(o),Jt=c(t),P=s(t,"DIV",{class:!0});var ot=i(P);b(ye.$$.fragment,ot),vn=c(ot),Te=s(ot,"P",{});var co=i(Te);Sn=r(co,`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),xe=s(co,"A",{href:!0,rel:!0});var Qs=i(xe);$n=r(Qs,"torch.nn.Module"),Qs.forEach(o),yn=r(co,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),Tn=c(ot),F=s(ot,"DIV",{class:!0});var D=i(F);b(ke.$$.fragment,D),xn=c(D),R=s(D,"P",{});var nt=i(R);kn=r(nt,"The "),Ze=s(nt,"A",{href:!0});var Xs=i(Ze);Mn=r(Xs,"SwinModel"),Xs.forEach(o),En=r(nt," forward method, overrides the "),Tt=s(nt,"CODE",{});var ea=i(Tt);Fn=r(ea,"__call__"),ea.forEach(o),jn=r(nt," special method."),nt.forEach(o),Cn=c(D),b(ae.$$.fragment,D),In=c(D),xt=s(D,"P",{});var ta=i(xt);An=r(ta,"Example:"),ta.forEach(o),Pn=c(D),b(Me.$$.fragment,D),D.forEach(o),ot.forEach(o),Qt=c(t),Y=s(t,"H2",{class:!0});var ho=i(Y);re=s(ho,"A",{id:!0,class:!0,href:!0});var oa=i(re);kt=s(oa,"SPAN",{});var na=i(kt);b(Ee.$$.fragment,na),na.forEach(o),oa.forEach(o),qn=c(ho),Mt=s(ho,"SPAN",{});var sa=i(Mt);zn=r(sa,"SwinForMaskedImageModeling"),sa.forEach(o),ho.forEach(o),Xt=c(t),q=s(t,"DIV",{class:!0});var st=i(q);b(Fe.$$.fragment,st),On=c(st),Z=s(st,"P",{});var at=i(Z);Dn=r(at,"Swin Model with a decoder on top for masked image modeling, as proposed in "),Et=s(at,"CODE",{});var aa=i(Et);Nn=r(aa,"SimMIM <https://arxiv.org/abs/2111.09886>"),aa.forEach(o),Ln=r(at,`__.
This model is a PyTorch `),je=s(at,"A",{href:!0,rel:!0});var ra=i(je);Hn=r(ra,"torch.nn.Module"),ra.forEach(o),Wn=r(at,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),at.forEach(o),Un=c(st),j=s(st,"DIV",{class:!0});var N=i(j);b(Ce.$$.fragment,N),Vn=c(N),G=s(N,"P",{});var rt=i(G);Bn=r(rt,"The "),Ge=s(rt,"A",{href:!0});var ia=i(Ge);Kn=r(ia,"SwinForMaskedImageModeling"),ia.forEach(o),Rn=r(rt," forward method, overrides the "),Ft=s(rt,"CODE",{});var la=i(Ft);Yn=r(la,"__call__"),la.forEach(o),Zn=r(rt," special method."),rt.forEach(o),Gn=c(N),b(ie.$$.fragment,N),Jn=c(N),jt=s(N,"P",{});var da=i(jt);Qn=r(da,"Examples:"),da.forEach(o),Xn=c(N),b(Ie.$$.fragment,N),N.forEach(o),st.forEach(o),eo=c(t),J=s(t,"H2",{class:!0});var po=i(J);le=s(po,"A",{id:!0,class:!0,href:!0});var ca=i(le);Ct=s(ca,"SPAN",{});var ha=i(Ct);b(Ae.$$.fragment,ha),ha.forEach(o),ca.forEach(o),es=c(po),It=s(po,"SPAN",{});var pa=i(It);ts=r(pa,"SwinForImageClassification"),pa.forEach(o),po.forEach(o),to=c(t),A=s(t,"DIV",{class:!0});var he=i(A);b(Pe.$$.fragment,he),os=c(he),At=s(he,"P",{});var ma=i(At);ns=r(ma,`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
