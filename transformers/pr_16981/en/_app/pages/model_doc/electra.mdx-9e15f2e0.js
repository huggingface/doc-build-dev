...
<p>Indices can be obtained using <a href="/docs/transformers/pr_16981/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16981/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16981/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_electra.py#L1064",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16981/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_electra.py#L1549",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_electra.py#L1178",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_electra.py#L967",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_electra.py#L1453",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_electra.py#L1265",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_electra.py#L1347",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16981/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16981/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_flax_electra.py#L674"}}),zi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16981/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16981/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16981/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16981/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_flax_electra.py#L576",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16981/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_flax_electra.py#L823"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16981/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16981/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16981/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16981/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_flax_electra.py#L760"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16981/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16981/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16981/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16981/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_16981/src/transformers/models/electra/modeling_flax_electra.py#L1133"}}),Ll=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16981/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_16981/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16981/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hT=c(),Wr=n("p"),mT=r("This model is also a "),Ur=n("a"),fT=r("tf.keras.Model"),uT=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gT=c(),b(as.$$.fragment),_T=c(),Mt=n("div"),b(Rr.$$.fragment),kT=c(),Uo=n("p"),vT=r("The "),$d=n("a"),TT=r("TFElectraForPreTraining"),bT=r(" forward method, overrides the "),fp=n("code"),yT=r("__call__"),ET=r(" special method."),wT=c(),b(rs.$$.fragment),$T=c(),b(is.$$.fragment),Tf=c(),Ro=n("h2"),ls=n("a"),up=n("span"),b(Hr.$$.fragment),FT=c(),gp=n("span"),xT=r("TFElectraForMaskedLM"),bf=c(),Le=n("div"),b(Qr.$$.fragment),MT=c(),_p=n("p"),zT=r("Electra model with a language modeling head on top."),CT=c(),kp=n("p"),jT=r(`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),qT=c(),Vr=n("p"),PT=r("This model inherits from "),Fd=n("a"),AT=r("TFPreTrainedModel"),OT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),LT=c(),Br=n("p"),NT=r("This model is also a "),Kr=n("a"),IT=r("tf.keras.Model"),ST=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),DT=c(),b(ds.$$.fragment),WT=c(),it=n("div"),b(Jr.$$.fragment),UT=c(),Ho=n("p"),RT=r("The "),xd=n("a"),HT=r("TFElectraForMaskedLM"),QT=r(" forward method, overrides the "),vp=n("code"),VT=r("__call__"),BT=r(" special method."),KT=c(),b(cs.$$.fragment),JT=c(),b(ps.$$.fragment),GT=c(),b(hs.$$.fragment),yf=c(),Qo=n("h2"),ms=n("a"),Tp=n("span"),b(Gr.$$.fragment),XT=c(),bp=n("span"),YT=r("TFElectraForSequenceClassification"),Ef=c(),Ke=n("div"),b(Xr.$$.fragment),ZT=c(),yp=n("p"),eb=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),db=c(),b(fs.$$.fragment),cb=c(),lt=n("div"),b(ti.$$.fragment),pb=c(),Vo=n("p"),hb=r("The "),zd=n("a"),mb=r("TFElectraForSequenceClassification"),fb=r(" forward method, overrides the "),Ep=n("code"),ub=r("__call__"),gb=r(" special method."),_b=c(),b(us.$$.fragment),kb=c(),b(gs.$$.fragment),vb=c(),b(_s.$$.fragment),wf=c(),Bo=n("h2"),ks=n("a"),wp=n("span"),b(oi.$$.fragment),Tb=c(),$p=n("span"),bb=r("TFElectraForMultipleChoice"),$f=c(),Je=n("div"),b(ni.$$.fragment),yb=c(),Fp=n("p"),Eb=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zy=c(),b(Ms.$$.fragment),Cy=c(),ct=n("div"),b(vi.$$.fragment),jy=c(),Zo=n("p"),qy=r("The "),Od=n("a"),Py=r("TFElectraForQuestionAnswering"),Ay=r(" forward method, overrides the "),Np=n("code"),Oy=r("__call__"),Ly=r(" special method."),Ny=c(),b(zs.$$.fragment),Iy=c(),b(Cs.$$.fragment),Sy=c(),b(js.$$.fragment),Cf=c(),en=n("h2"),qs=n("a"),Ip=n("span"),b(Ti.$$.fragment),Dy=c(),Sp=n("span"),Wy=r("FlaxElectraModel"),jf=c(),Ie=n("div"),b(bi.$$.fragment),Uy=c(),Dp=n("p"),Ry=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),Hy=c(),yi=n("p"),Qy=r("This model inherits from "),Ld=n("a"),Vy=r("FlaxPreTrainedModel"),By=r(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gu.forEach(t),Y1=p(St),at=s(St,"DIV",{class:!0});var lo=a(at);y($r.$$.fragment,lo),Z1=p(lo),Oo=s(lo,"P",{});var Jd=a(Oo);ev=i(Jd,"The "),vd=s(Jd,"A",{href:!0});var o0=a(vd);tv=i(o0,"ElectraForTokenClassification"),o0.forEach(t),ov=i(Jd," forward method, overrides the "),ep=s(Jd,"CODE",{});var n0=a(ep);nv=i(n0,"__call__"),n0.forEach(t),sv=i(Jd," special method."),Jd.forEach(t),av=p(lo),y(Bn.$$.fragment,lo),rv=p(lo),y(Kn.$$.fragment,lo),iv=p(lo),y(Jn.$$.fragment,lo),lo.forEach(t),St.forEach(t),ff=p(o),Lo=s(o,"H2",{class:!0});var _u=a(Lo);Gn=s(_u,"A",{id:!0,class:!0,href:!0});var s0=a(Gn);tp=s(s0,"SPAN",{});var a0=a(tp);y(Fr.$$.fragment,a0),a0.forEach(t),s0.forEach(t),lv=p(_u),op=s(_u,"SPAN",{});var r0=a(op);dv=i(r0,"ElectraForQuestionAnswering"),r0.forEach(t),_u.forEach(t),uf=p(o),nt=s(o,"DIV",{class:!0});var co=a(nt);y(xr.$$.fragment,co),cv=p(co),No=s(co,"P",{});var Gd=a(No);pv=i(Gd,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),np=s(Gd,"CODE",{});var i0=a(np);hv=i(i0,"span start logits"),i0.forEach(t),mv=i(Gd," and "),sp=s(Gd,"CODE",{});var l0=a(sp);fv=i(l0,"span end logits"),l0.forEach(t),uv=i(Gd,")."),Gd.forEach(t),gv=p(co),Mr=s(co,"P",{});var ku=a(Mr);_v=i(ku,"This model inherits from "),Td=s(ku,"A",{href:!0});var d0=a(Td);kv=i(d0,"PreTrainedModel"),d0.forEach(t),vv=i(ku,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku.forEach(t),Tv=p(co),zr=s(co,"P",{});var vu=a(zr);bv=i(vu,"This model is also a PyTorch "),Cr=s(vu,"A",{href:!0,rel:!0});var c0=a(Cr);yv=i(c0,"torch.nn.Module"),c0.forEach(t),Ev=i(vu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vu.forEach(t),wv=p(co),rt=s(co,"DIV",{class:!0});var po=a(rt);y(jr.$$.fragment,po),$v=p(po),Io=s(po,"P",{});var Xd=a(Io);Fv=i(Xd,"The "),bd=s(Xd,"A",{href:!0});var p0=a(bd);xv=i(p0,"ElectraForQuestionAnswering"),p0.forEach(t),Mv=i(Xd," forward method, overrides the "),ap=s(Xd,"CODE",{});var h0=a(ap);zv=i(h0,"__call__"),h0.forEach(t),Cv=i(Xd," special method."),Xd.forEach(t),jv=p(po),y(Xn.$$.fragment,po),qv=p(po),y(Yn.$$.fragment,po),Pv=p(po),y(Zn.$$.fragment,po),po.forEach(t),co.forEach(t),gf=p(o),So=s(o,"H2",{class:!0});var Tu=a(So);es=s(Tu,"A",{id:!0,class:!0,href:!0});var m0=a(es);rp=s(m0,"SPAN",{});var f0=a(rp);y(qr.$$.fragment,f0),f0.forEach(t),m0.forEach(t),Av=p(Tu),ip=s(Tu,"SPAN",{});var u0=a(ip);Ov=i(u0,"TFElectraModel"),u0.forEach(t),Tu.forEach(t),_f=p(o),Be=s(o,"DIV",{class:!0});var Dt=a(Be);y(Pr.$$.fragment,Dt),Lv=p(Dt),lp=s(Dt,"P",{});var g0=a(lp);Nv=i(g0,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),g0.forEach(t),Iv=p(Dt),Ar=s(Dt,"P",{});var bu=a(Ar);Sv=i(bu,"This model inherits from "),yd=s(bu,"A",{href:!0});var _0=a(yd);Dv=i(_0,"TFPreTrainedModel"),_0.forEach(t),Wv=i(bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yu.forEach(t),Vv=p(Dt),y(ts.$$.fragment,Dt),Bv=p(Dt),xt=s(Dt,"DIV",{class:!0});var aa=a(xt);y(Nr.$$.fragment,aa),Kv=p(aa),Do=s(aa,"P",{});var Yd=a(Do);Jv=i(Yd,"The "),Ed=s(Yd,"A",{href:!0});var v0=a(Ed);Gv=i(v0,"TFElectraModel"),v0.forEach(t),Xv=i(Yd," forward method, overrides the "),dp=s(Yd,"CODE",{});var T0=a(dp);Yv=i(T0,"__call__"),T0.forEach(t),Zv=i(Yd," special method."),Yd.forEach(t),eT=p(aa),y(os.$$.fragment,aa),tT=p(aa),y(ns.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),kf=p(o),Wo=s(o,"H2",{class:!0});var Eu=a(Wo);ss=s(Eu,"A",{id:!0,class:!0,href:!0});var b0=a(ss);cp=s(b0,"SPAN",{});var y0=a(cp);y(Ir.$$.fragment,y0),y0.forEach(t),b0.forEach(t),oT=p(Eu),pp=s(Eu,"SPAN",{});var E0=a(pp);nT=i(E0,"TFElectraForPreTraining"),E0.forEach(t),Eu.forEach(t),vf=p(o),Oe=s(o,"DIV",{class:!0});var ht=a(Oe);y(Sr.$$.fragment,ht),sT=p(ht),hp=s(ht,"P",{});var w0=a(hp);aT=i(w0,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),w0.forEach(t),rT=p(ht),mp=s(ht,"P",{});var $0=a(mp);iT=i($0,`Even though both the discriminator and generator may be loaded into this model, the discriminator is the only model
of the two to have the correct classification head to be used for this model.`),$0.forEach(t),lT=p(ht),Dr=s(ht,"P",{});var wu=a(Dr);dT=i(wu,"This model inherits from "),wd=s(wu,"A",{href:!0});var F0=a(wd);cT=i(F0,"TFPreTrainedModel"),F0.forEach(t),pT=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),hT=p(ht),Wr=s(ht,"P",{});var $u=a(Wr);mT=i($u,"This model is also a "),Ur=s($u,"A",{href:!0,rel:!0});var x0=a(Ur);fT=i(x0,"tf.keras.Model"),x0.forEach(t),uT=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),gT=p(ht),y(as.$$.fragment,ht),_T=p(ht),Mt=s(ht,"DIV",{class:!0});var ra=a(Mt);y(Rr.$$.fragment,ra),kT=p(ra),Uo=s(ra,"P",{});var Zd=a(Uo);vT=i(Zd,"The "),$d=s(Zd,"A",{href:!0});var M0=a($d);TT=i(M0,"TFElectraForPreTraining"),M0.forEach(t),bT=i(Zd," forward method, overrides the "),fp=s(Zd,"CODE",{});var z0=a(fp);yT=i(z0,"__call__"),z0.forEach(t),ET=i(Zd," special method."),Zd.forEach(t),wT=p(ra),y(rs.$$.fragment,ra),$T=p(ra),y(is.$$.fragment,ra),ra.forEach(t),ht.forEach(t),Tf=p(o),Ro=s(o,"H2",{class:!0});var Fu=a(Ro);ls=s(Fu,"A",{id:!0,class:!0,href:!0});var C0=a(ls);up=s(C0,"SPAN",{});var j0=a(up);y(Hr.$$.fragment,j0),j0.forEach(t),C0.forEach(t),FT=p(Fu),gp=s(Fu,"SPAN",{});var q0=a(gp);xT=i(q0,"TFElectraForMaskedLM"),q0.forEach(t),Fu.forEach(t),bf=p(o),Le=s(o,"DIV",{class:!0});var mt=a(Le);y(Qr.$$.fragment,mt),MT=p(mt),_p=s(mt,"P",{});var P0=a(_p);zT=i(P0,"Electra model with a language modeling head on top."),P0.forEach(t),CT=p(mt),kp=s(mt,"P",{});var A0=a(kp);jT=i(A0,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),A0.forEach(t),qT=p(mt),Vr=s(mt,"P",{});var xu=a(Vr);PT=i(xu,"This model inherits from "),Fd=s(xu,"A",{href:!0});var O0=a(Fd);AT=i(O0,"TFPreTrainedModel"),O0.forEach(t),OT=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),LT=p(mt),Br=s(mt,"P",{});var Mu=a(Br);NT=i(Mu,"This model is also a "),Kr=s(Mu,"A",{href:!0,rel:!0});var L0=a(Kr);IT=i(L0,"tf.keras.Model"),L0.forEach(t),ST=i(Mu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mu.forEach(t),DT=p(mt),y(ds.$$.fragment,mt),WT=p(mt),it=s(mt,"DIV",{class:!0});var ho=a(it);y(Jr.$$.fragment,ho),UT=p(ho),Ho=s(ho,"P",{});var ec=a(Ho);RT=i(ec,"The "),xd=s(ec,"A",{href:!0});var N0=a(xd);HT=i(N0,"TFElectraForMaskedLM"),N0.forEach(t),QT=i(ec," forward method, overrides the "),vp=s(ec,"CODE",{});var I0=a(vp);VT=i(I0,"__call__"),I0.forEach(t),BT=i(ec," special method."),ec.forEach(t),KT=p(ho),y(cs.$$.fragment,ho),JT=p(ho),y(ps.$$.fragment,ho),GT=p(ho),y(hs.$$.fragment,ho),ho.forEach(t),mt.forEach(t),yf=p(o),Qo=s(o,"H2",{class:!0});var zu=a(Qo);ms=s(zu,"A",{id:!0,class:!0,href:!0});var S0=a(ms);Tp=s(S0,"SPAN",{});var D0=a(Tp);y(Gr.$$.fragment,D0),D0.forEach(t),S0.forEach(t),XT=p(zu),bp=s(zu,"SPAN",{});var W0=a(bp);YT=i(W0,"TFElectraForSequenceClassification"),W0.forEach(t),zu.forEach(t),Ef=p(o),Ke=s(o,"DIV",{class:!0});var Wt=a(Ke);y(Xr.$$.fragment,Wt),ZT=p(Wt),yp=s(Wt,"P",{});var U0=a(yp);eb=i(U0,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),db=p(Wt),y(fs.$$.fragment,Wt),cb=p(Wt),lt=s(Wt,"DIV",{class:!0});var mo=a(lt);y(ti.$$.fragment,mo),pb=p(mo),Vo=s(mo,"P",{});var tc=a(Vo);hb=i(tc,"The "),zd=s(tc,"A",{href:!0});var Q0=a(zd);mb=i(Q0,"TFElectraForSequenceClassification"),Q0.forEach(t),fb=i(tc," forward method, overrides the "),Ep=s(tc,"CODE",{});var V0=a(Ep);ub=i(V0,"__call__"),V0.forEach(t),gb=i(tc," special method."),tc.forEach(t),_b=p(mo),y(us.$$.fragment,mo),kb=p(mo),y(gs.$$.fragment,mo),vb=p(mo),y(_s.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),wf=p(o),Bo=s(o,"H2",{class:!0});var qu=a(Bo);ks=s(qu,"A",{id:!0,class:!0,href:!0});var B0=a(ks);wp=s(B0,"SPAN",{});var K0=a(wp);y(oi.$$.fragment,K0),K0.forEach(t),B0.forEach(t),Tb=p(qu),$p=s(qu,"SPAN",{});var J0=a($p);bb=i(J0,"TFElectraForMultipleChoice"),J0.forEach(t),qu.forEach(t),$f=p(o),Je=s(o,"DIV",{class:!0});var Ut=a(Je);y(ni.$$.fragment,Ut),yb=p(Ut),Fp=s(Ut,"P",{});var G0=a(Fp);Eb=i(G0,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
