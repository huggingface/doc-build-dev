...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17914/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17914/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17914/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rm.forEach(t),bT=h(It),y(ms.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var uo=a(pt);y(ei.$$.fragment,uo),vT=h(uo),Uo=s(uo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);yT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(uo),y(gs.$$.fragment,uo),RT=h(uo),y(_s.$$.fragment,uo),MT=h(uo),y(bs.$$.fragment,uo),uo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mm=a(Ho);ks=s(Mm,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);y(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mm),Mp=s(Mm,"SPAN",{});var e4=a(Mp);zT=i(e4,"TFRobertaForMultipleChoice"),e4.forEach(t),Mm.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var t4=a(Ep);CT=i(t4,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t4.forEach(t),jT=h(Dt),ni=s(Dt,"P",{});var Em=a(ni);PT=i(Em,"This model inherits from "),xd=s(Em,"A",{href:!0});var o4=a(xd);LT=i(o4,"TFPreTrainedModel"),o4.forEach(t),AT=i(Em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Em.forEach(t),OT=h(Dt),si=s(Dt,"P",{});var zm=a(si);NT=i(zm,"This model is also a "),ai=s(zm,"A",{href:!0,rel:!0});var n4=a(ai);IT=i(n4,"tf.keras.Model"),n4.forEach(t),DT=i(zm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zm.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s4=a(Rd);HT=i(s4,"TFRobertaForMultipleChoice"),s4.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a4=a(zp);JT=i(a4,"__call__"),a4.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Jo=s(o,"H2",{class:!0});var qm=a(Jo);ws=s(qm,"A",{id:!0,class:!0,href:!0});var r4=a(ws);qp=s(r4,"SPAN",{});var i4=a(qp);y(ii.$$.fragment,i4),i4.forEach(t),r4.forEach(t),XT=h(qm),Cp=s(qm,"SPAN",{});var l4=a(Cp);YT=i(l4,"TFRobertaForTokenClassification"),l4.forEach(t),qm.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var d4=a(jp);ey=i(d4,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d4.forEach(t),ty=h(St),di=s(St,"P",{});var Cm=a(di);oy=i(Cm,"This model inherits from "),Md=s(Cm,"A",{href:!0});var c4=a(Md);ny=i(c4,"TFPreTrainedModel"),c4.forEach(t),sy=i(Cm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cm.forEach(t),ay=h(St),ci=s(St,"P",{});var jm=a(ci);ry=i(jm,"This model is also a "),pi=s(jm,"A",{href:!0,rel:!0});var p4=a(pi);iy=i(p4,"tf.keras.Model"),p4.forEach(t),ly=i(jm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jm.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),py=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h4=a(Ed);uy=i(h4,"TFRobertaForTokenClassification"),h4.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var u4=a(Pp);my=i(u4,"__call__"),u4.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),y(Fs.$$.fragment,fo),by=h(fo),y(xs.$$.fragment,fo),ky=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pm=a(Ko);Ms=s(Pm,"A",{id:!0,class:!0,href:!0});var f4=a(Ms);Lp=s(f4,"SPAN",{});var m4=a(Lp);y(ui.$$.fragment,m4),m4.forEach(t),f4.forEach(t),vy=h(Pm),Ap=s(Pm,"SPAN",{});var g4=a(Ap);Ty=i(g4,"TFRobertaForQuestionAnswering"),g4.forEach(t),Pm.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _4=a(Op);$y=i(_4,"span start logits"),_4.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var b4=a(Np);xy=i(b4,"span end logits"),b4.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),mi=s(Wt,"P",{});var Lm=a(mi);Ey=i(Lm,"This model inherits from "),zd=s(Lm,"A",{href:!0});var k4=a(zd);zy=i(k4,"TFPreTrainedModel"),k4.forEach(t),qy=i(Lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lm.forEach(t),Cy=h(Wt),gi=s(Wt,"P",{});var Am=a(gi);jy=i(Am,"This model is also a "),_i=s(Am,"A",{href:!0,rel:!0});var v4=a(_i);Py=i(v4,"tf.keras.Model"),v4.forEach(t),Ly=i(Am,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Am.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),ut=s(Wt,"DIV",{class:!0});var mo=a(ut);y(bi.$$.fragment,mo),Ny=h(mo),Xo=s(mo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),qd=s(nc,"A",{href:!0});var T4=a(qd);Dy=i(T4,"TFRobertaForQuestionAnswering"),T4.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var y4=a(Ip);Wy=i(y4,"__call__"),y4.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(mo),y(zs.$$.fragment,mo),Hy=h(mo),y(qs.$$.fragment,mo),Qy=h(mo),y(Cs.$$.fragment,mo),mo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Om=a(Yo);js=s(Om,"A",{id:!0,class:!0,href:!0});var w4=a(js);Dp=s(w4,"SPAN",{});var $4=a(Dp);y(ki.$$.fragment,$4),$4.forEach(t),w4.forEach(t),Jy=h(Om),Sp=s(Om,"SPAN",{});var F4=a(Sp);Vy=i(F4,"FlaxRobertaModel"),F4.forEach(t),Om.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var x4=a(Wp);Gy=i(x4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x4.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nm=a(Ti);Yy=i(Nm,"This model inherits from "),Cd=s(Nm,"A",{href:!0});var R4=a(Cd);Zy=i(R4,"FlaxPreTrainedModel"),R4.forEach(t),ew=i(Nm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nm.forEach(t),tw=h(gt),yi=s(gt,"P",{});var Im=a(yi);ow=i(Im,"This model is also a Flax Linen "),wi=s(Im,"A",{href:!0,rel:!0});var M4=a(wi);nw=i(M4,"flax.linen.Module"),M4.forEach(t),sw=i(Im,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Im.forEach(t),aw=h(gt),Bp=s(gt,"P",{});var E4=a(Bp);rw=i(E4,"Finally, this model supports inherent JAX features such as:"),E4.forEach(t),iw=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var z4=a(Up);$i=s(z4,"A",{href:!0,rel:!0});var q4=a($i);lw=i(q4,"Just-In-Time (JIT) compilation"),q4.forEach(t),z4.forEach(t),dw=h(ra),Hp=s(ra,"LI",{});var C4=a(Hp);Fi=s(C4,"A",{href:!0,rel:!0});var j4=a(Fi);cw=i(j4,"Automatic Differentiation"),j4.forEach(t),C4.forEach(t),pw=h(ra),Qp=s(ra,"LI",{});var P4=a(Qp);xi=s(P4,"A",{href:!0,rel:!0});var L4=a(xi);hw=i(L4,"Vectorization"),L4.forEach(t),P4.forEach(t),uw=h(ra),Jp=s(ra,"LI",{});var A4=a(Jp);Ri=s(A4,"A",{href:!0,rel:!0});var O4=a(Ri);fw=i(O4,"Parallelization"),O4.forEach(t),A4.forEach(t),ra.forEach(t),mw=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),gw=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_w=i(sc,"The "),Vp=s(sc,"CODE",{});var N4=a(Vp);bw=i(N4,"FlaxRobertaPreTrainedModel"),N4.forEach(t),kw=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var I4=a(Kp);vw=i(I4,"__call__"),I4.forEach(t),Tw=i(sc," special method."),sc.forEach(t),yw=h(ia),y(Ps.$$.fragment,ia),ww=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Dm=a(en);As=s(Dm,"A",{id:!0,class:!0,href:!0});var D4=a(As);Gp=s(D4,"SPAN",{});var S4=a(Gp);y(Ei.$$.fragment,S4),S4.forEach(t),D4.forEach(t),$w=h(Dm),Xp=s(Dm,"SPAN",{});var W4=a(Xp);Fw=i(W4,"FlaxRobertaForCausalLM"),W4.forEach(t),Dm.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),xw=h(_t),Yp=s(_t,"P",{});var B4=a(Yp);Rw=i(B4,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),B4.forEach(t),Mw=h(_t),qi=s(_t,"P",{});var Sm=a(qi);Ew=i(Sm,"This model inherits from "),jd=s(Sm,"A",{href:!0});var U4=a(jd);zw=i(U4,"FlaxPreTrainedModel"),U4.forEach(t),qw=i(Sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Sm.forEach(t),Cw=h(_t),Ci=s(_t,"P",{});var Wm=a(Ci);jw=i(Wm,"This model is also a Flax Linen "),ji=s(Wm,"A",{href:!0,rel:!0});var H4=a(ji);Pw=i(H4,"flax.linen.Module"),H4.forEach(t),Lw=i(Wm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
