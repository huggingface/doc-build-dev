...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16771/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16771/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16771/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16771/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16771/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
install `),wf=o("em"),e4=a("libaio-dev"),s4=a(" system-wide)."),vg=u(),zt=o("p"),t4=a("Edit "),yf=o("code"),a4=a("TORCH_CUDA_ARCH_LIST"),n4=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
of them like so `),qf=o("code"),u4=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),wg=u(),ti=o("p"),c4=a("If you need to use the same setup on multiple machines, make a binary wheel:"),yg=u(),f(vo.$$.fragment),bg=u(),Ie=o("p"),h4=a("it will generate something like "),$f=o("code"),f4=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),d4=a(` which now you can install
as `),kf=o("code"),m4=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_4=a(" locally or on any other machine."),Eg=u(),Ot=o("p"),v4=a("Again, remember to ensure to adjust "),Pf=o("code"),j4=a("TORCH_CUDA_ARCH_LIST"),g4=a(" to the target architectures."),qg=u(),Ue=o("p"),w4=a("You can find the complete list of NVIDIA GPUs and their corresponding "),Df=o("strong"),y4=a("Compute Capabilities"),b4=a(` (same as arch in this
context) `),jo=o("a"),E4=a("here"),q4=a("."),$g=u(),ai=o("p"),$4=a("You can check the archs pytorch was built with using:"),kg=u(),f(go.$$.fragment),Pg=u(),ni=o("p"),k4=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),Dg=u(),f(wo.$$.fragment),zg=u(),oi=o("p"),P4=a("If the output is:"),Og=u(),f(yo.$$.fragment),Tg=u(),Tt=o("p"),D4=a("then you know that this card\u2019s arch is "),zf=o("code"),z4=a("8.6"),O4=a("."),Ag=u(),At=o("p"),T4=a("You can also leave "),Of=o("code"),A4=a("TORCH_CUDA_ARCH_LIST"),S4=a(` out completely and then the build program will automatically query the
...
install `),wf=l(uh,"EM",{});var mL=r(wf);e4=n(mL,"libaio-dev"),mL.forEach(t),s4=n(uh," system-wide)."),uh.forEach(t),vg=c(e),zt=l(e,"P",{});var cE=r(zt);t4=n(cE,"Edit "),yf=l(cE,"CODE",{});var _L=r(yf);a4=n(_L,"TORCH_CUDA_ARCH_LIST"),_L.forEach(t),n4=n(cE,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
...
of them like so `),qf=l(Ap,"CODE",{});var gL=r(qf);u4=n(gL,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),gL.forEach(t),Ap.forEach(t),wg=c(e),ti=l(e,"P",{});var wL=r(ti);c4=n(wL,"If you need to use the same setup on multiple machines, make a binary wheel:"),wL.forEach(t),yg=c(e),d(vo.$$.fragment,e),bg=c(e),Ie=l(e,"P",{});var ch=r(Ie);h4=n(ch,"it will generate something like "),$f=l(ch,"CODE",{});var yL=r($f);f4=n(yL,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),yL.forEach(t),d4=n(ch,` which now you can install
as `),kf=l(ch,"CODE",{});var bL=r(kf);m4=n(bL,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),bL.forEach(t),_4=n(ch," locally or on any other machine."),ch.forEach(t),Eg=c(e),Ot=l(e,"P",{});var hE=r(Ot);v4=n(hE,"Again, remember to ensure to adjust "),Pf=l(hE,"CODE",{});var EL=r(Pf);j4=n(EL,"TORCH_CUDA_ARCH_LIST"),EL.forEach(t),g4=n(hE," to the target architectures."),hE.forEach(t),qg=c(e),Ue=l(e,"P",{});var hh=r(Ue);w4=n(hh,"You can find the complete list of NVIDIA GPUs and their corresponding "),Df=l(hh,"STRONG",{});var qL=r(Df);y4=n(qL,"Compute Capabilities"),qL.forEach(t),b4=n(hh,` (same as arch in this
