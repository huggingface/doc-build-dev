import{S as lf,i as df,s as cf,e as a,k as h,w as k,t as n,M as pf,c as r,d as t,m as u,a as i,x as b,h as s,b as f,F as e,g,y as w,q as $,o as P,B as F,v as hf,L as Ee}from"../../chunks/vendor-6b77c823.js";import{T as Be}from"../../chunks/Tip-39098574.js";import{D as ae}from"../../chunks/Docstring-1088f2fb.js";import{C as pe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as He}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Je}from"../../chunks/ExampleCodeBlock-5212b321.js";function uf(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJModel, GPTJConfig
...
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.13</span>`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Ff(j){let d,T,c,p,y,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
...
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),x=r(V,"LI",{});var Ce=i(x);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(v,G){g(v,d,G),e(d,T),g(v,c,G),g(v,p,G),e(p,y),e(y,l),e(p,m),e(p,x),e(x,he),g(v,K,G),g(v,J,G),e(J,X),e(J,D),e(D,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(v,I,G),g(v,L,G),e(L,ee),g(v,te,G),g(v,E,G),e(E,M),e(M,fe),e(M,B),e(B,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,O),e(O,U),e(E,Te),e(E,z),e(z,ye),e(z,R),e(R,ne)},d(v){v&&t(d),v&&t(c),v&&t(p),v&&t(K),v&&t(J),v&&t(I),v&&t(L),v&&t(te),v&&t(E)}}}function jf(j){let d,T,c,p,y;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function xf(j){let d,T,c,p,y;return p=new pe({props:{code:`from transformers import GPTJTokenizer, TFGPTJModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Gf(j){let d,T,c,p,y,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),x=r(V,"LI",{});var Ce=i(x);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Mf(j){let d,T,c,p,y,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),x=r(V,"LI",{});var Ce=i(x);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(j){let d,T,c,p,y,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var ze=i(y);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),x=r(V,"LI",{});var Ce=i(x);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Uf(j){let d,T,c,p,y,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ye,R,ne,v,G,V,ze,Ce,C,Ae,Le,Me,A,Q,ce,Pe,S,Ie,ve,ke,Ne,ta,ct,Ni,Ro,Oi,Si,oa,Di,Wi,na,Ui,Qi,Lr,bt,Ht,sa,Vo,Bi,aa,Hi,Ir,Rt,Ri,_s,Vi,Ki,Nr,Ko,Or,Ts,Xi,Sr,Xo,Dr,wt,Vt,ra,Yo,Yi,ia,Zi,Wr,pt,Zo,el,Re,tl,ys,ol,nl,en,sl,al,vs,rl,il,ks,ll,dl,cl,Kt,Ur,$t,Xt,la,tn,pl,da,hl,Qr,ht,on,ul,nn,ml,sn,fl,gl,_l,et,an,Tl,Pt,yl,bs,vl,kl,ca,bl,wl,$l,Yt,Pl,Zt,Br,Ft,eo,pa,rn,Fl,ha,jl,Hr,Ve,ln,xl,ua,Gl,Jl,dn,El,cn,Ml,ql,zl,tt,pn,Cl,jt,Al,ws,Ll,Il,ma,Nl,Ol,Sl,to,Dl,oo,Rr,xt,no,fa,hn,Wl,ga,Ul,Vr,Fe,un,Ql,_a,Bl,Hl,$s,Ps,Rl,Vl,Kl,Ke,Xl,Ta,Yl,Zl,ya,ed,td,va,od,nd,ka,sd,ad,rd,mn,id,fn,ld,dd,cd,$e,gn,pd,Gt,hd,Fs,ud,md,ba,fd,gd,_d,so,Td,ao,yd,ro,vd,io,kd,lo,Kr,Jt,co,wa,_n,bd,$a,wd,Xr,Xe,Tn,$d,Et,Pd,Pa,Fd,jd,Fa,xd,Gd,Jd,yn,Ed,vn,Md,qd,zd,Oe,kn,Cd,Mt,Ad,js,Ld,Id,ja,Nd,Od,Sd,po,Dd,ho,Wd,uo,Yr,qt,mo,xa,bn,Ud,Ga,Qd,Zr,je,wn,Bd,Ja,Hd,Rd,$n,Vd,xs,Kd,Xd,Yd,Pn,Zd,Fn,ec,tc,oc,fo,nc,ot,jn,sc,zt,ac,Gs,rc,ic,Ea,lc,dc,cc,go,pc,_o,ei,Ct,To,Ma,xn,hc,qa,uc,ti,xe,Gn,mc,za,fc,gc,Jn,_c,Js,Tc,yc,vc,En,kc,Mn,bc,wc,$c,yo,Pc,nt,qn,Fc,At,jc,Es,xc,Gc,Ca,Jc,Ec,Mc,vo,qc,ko,oi,Lt,bo,Aa,zn,zc,La,Cc,ni,se,Cn,Ac,Ia,Lc,Ic,Ms,qs,Nc,Oc,Sc,Ye,Dc,Na,Wc,Uc,Oa,Qc,Bc,Sa,Hc,Rc,Da,Vc,Kc,Xc,An,Yc,zs,Zc,ep,tp,Ln,op,In,np,sp,ap,wo,rp,Se,Nn,ip,It,lp,Cs,dp,cp,Wa,pp,hp,up,$o,mp,Po,fp,Fo,si,Nt,jo,Ua,On,gp,Qa,_p,ai,Ge,Sn,Tp,Ot,yp,Ba,vp,kp,Ha,bp,wp,$p,Dn,Pp,As,Fp,jp,xp,Wn,Gp,Un,Jp,Ep,Mp,xo,qp,De,Qn,zp,St,Cp,Ls,Ap,Lp,Ra,Ip,Np,Op,Go,Sp,Jo,Dp,Eo,ri,Dt,Mo,Va,Bn,Wp,Ka,Up,ii,be,Hn,Qp,Xa,Bp,Hp,Rn,Rp,Is,Vp,Kp,Xp,Vn,Yp,Kn,Zp,eh,th,Ya,oh,nh,ut,Za,Xn,sh,ah,er,Yn,rh,ih,tr,Zn,lh,dh,or,es,ch,ph,st,ts,hh,Wt,uh,nr,mh,fh,sr,gh,_h,Th,qo,yh,zo,li,Ut,Co,ar,os,vh,rr,kh,di,we,ns,bh,ir,wh,$h,ss,Ph,Ns,Fh,jh,xh,as,Gh,rs,Jh,Eh,Mh,lr,qh,zh,mt,dr,is,Ch,Ah,cr,ls,Lh,Ih,pr,ds,Nh,Oh,hr,cs,Sh,Dh,at,ps,Wh,Qt,Uh,ur,Qh,Bh,mr,Hh,Rh,Vh,Ao,Kh,Lo,ci;return l=new He({}),Z=new He({}),A=new pe({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_17335/en/model_doc/gptj#transformers.GPTJModel">GPTJModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTJConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 2048) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17335/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_gptj.py#L531",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17335/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17335/en/model_doc/gptj#transformers.GPTJConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_gptj.py#L785",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17335/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_gptj.py#L907",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_17335/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_gptj.py#L1018"}}),kn=new ae({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_17335/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_17335/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_gptj.py#L1034",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17335/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/pr_17335/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_17335/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_tf_gptj.py#L653",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17335/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_tf_gptj.py#L760",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17335/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_tf_gptj.py#L864",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17335/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17335/src/transformers/models/gptj/modeling_tf_gptj.py#L987",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17335/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_17335/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
...
<p><a
  href="/docs/transformers/pr_17335/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMaskedLMOutput"
>transformers.modeling_flax_outputs.FlaxMaskedLMOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Ao=new Be({props:{$$slots:{default:[Df]},$$scope:{ctx:j}}}),Lo=new Je({props:{anchor:"transformers.FlaxGPTJForCausalLM.__call__.example",$$slots:{default:[Wf]},$$scope:{ctx:j}}}),{c(){d=a("meta"),T=h(),c=a("h1"),p=a("a"),y=a("span"),k(l.$$.fragment),m=h(),x=a("span"),he=n("GPT-J"),K=h(),J=a("h2"),X=a("a"),D=a("span"),k(Z.$$.fragment),ue=h(),W=a("span"),me=n("Overview"),re=h(),I=a("p"),L=n("The GPT-J model was released in the "),ee=a("a"),te=n("kingoflolz/mesh-transformer-jax"),E=n(` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
causal language model trained on `),M=a("a"),fe=n("the Pile"),B=n(" dataset."),ie=h(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),ge=n("Stella Biderman"),q=n("."),le=h(),N=a("p"),_e=n("Tips:"),de=h(),O=a("ul"),U=a("li"),Te=n("To load "),z=a("a"),ye=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
RAM to just load the model. To reduce the CPU RAM usage there are a few options. The `),ne=a("code"),v=n("torch_dtype"),G=n(` argument can be
...
behavior.`),_l=h(),et=a("div"),k(an.$$.fragment),Tl=h(),Pt=a("p"),yl=n("The "),bs=a("a"),vl=n("GPTJModel"),kl=n(" forward method, overrides the "),ca=a("code"),bl=n("__call__"),wl=n(" special method."),$l=h(),k(Yt.$$.fragment),Pl=h(),k(Zt.$$.fragment),Br=h(),Ft=a("h2"),eo=a("a"),pa=a("span"),k(rn.$$.fragment),Fl=h(),ha=a("span"),jl=n("GPTJForCausalLM"),Hr=h(),Ve=a("div"),k(ln.$$.fragment),xl=h(),ua=a("p"),Gl=n("The GPT-J Model transformer with a language modeling head on top."),Jl=h(),dn=a("p"),El=n("This model is a PyTorch "),cn=a("a"),Ml=n("torch.nn.Module"),ql=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zl=h(),tt=a("div"),k(pn.$$.fragment),Cl=h(),jt=a("p"),Al=n("The "),ws=a("a"),Ll=n("GPTJForCausalLM"),Il=n(" forward method, overrides the "),ma=a("code"),Nl=n("__call__"),Ol=n(" special method."),Sl=h(),k(to.$$.fragment),Dl=h(),k(oo.$$.fragment),Rr=h(),xt=a("h2"),no=a("a"),fa=a("span"),k(hn.$$.fragment),Wl=h(),ga=a("span"),Ul=n("GPTJForSequenceClassification"),Vr=h(),Fe=a("div"),k(un.$$.fragment),Ql=h(),_a=a("p"),Bl=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Hl=h(),$s=a("p"),Ps=a("a"),Rl=n("GPTJForSequenceClassification"),Vl=n(` uses the last token in order to do the classification, as other causal models
...
SQuAD (a linear layers on top of the hidden-states output to compute `),Pa=a("code"),Fd=n("span start logits"),jd=n(" and "),Fa=a("code"),xd=n("span end logits"),Gd=n(")."),Jd=h(),yn=a("p"),Ed=n("This model is a PyTorch "),vn=a("a"),Md=n("torch.nn.Module"),qd=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zd=h(),Oe=a("div"),k(kn.$$.fragment),Cd=h(),Mt=a("p"),Ad=n("The "),js=a("a"),Ld=n("GPTJForQuestionAnswering"),Id=n(" forward method, overrides the "),ja=a("code"),Nd=n("__call__"),Od=n(" special method."),Sd=h(),k(po.$$.fragment),Dd=h(),k(ho.$$.fragment),Wd=h(),k(uo.$$.fragment),Yr=h(),qt=a("h2"),mo=a("a"),xa=a("span"),k(bn.$$.fragment),Ud=h(),Ga=a("span"),Qd=n("TFGPTJModel"),Zr=h(),je=a("div"),k(wn.$$.fragment),Bd=h(),Ja=a("p"),Hd=n("The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Rd=h(),$n=a("p"),Vd=n("This model inherits from "),xs=a("a"),Kd=n("TFPreTrainedModel"),Xd=n(`. Check the superclass documentation for the generic methods the
...
behavior.`),oc=h(),k(fo.$$.fragment),nc=h(),ot=a("div"),k(jn.$$.fragment),sc=h(),zt=a("p"),ac=n("The "),Gs=a("a"),rc=n("TFGPTJModel"),ic=n(" forward method, overrides the "),Ea=a("code"),lc=n("__call__"),dc=n(" special method."),cc=h(),k(go.$$.fragment),pc=h(),k(_o.$$.fragment),ei=h(),Ct=a("h2"),To=a("a"),Ma=a("span"),k(xn.$$.fragment),hc=h(),qa=a("span"),uc=n("TFGPTJForCausalLM"),ti=h(),xe=a("div"),k(Gn.$$.fragment),mc=h(),za=a("p"),fc=n("The GPT-J Model transformer with a language modeling head on top."),gc=h(),Jn=a("p"),_c=n("This model inherits from "),Js=a("a"),Tc=n("TFPreTrainedModel"),yc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vc=h(),En=a("p"),kc=n("This model is also a "),Mn=a("a"),bc=n("tf.keras.Model"),wc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$c=h(),k(yo.$$.fragment),Pc=h(),nt=a("div"),k(qn.$$.fragment),Fc=h(),At=a("p"),jc=n("The "),Es=a("a"),xc=n("TFGPTJForCausalLM"),Gc=n(" forward method, overrides the "),Ca=a("code"),Jc=n("__call__"),Ec=n(" special method."),Mc=h(),k(vo.$$.fragment),qc=h(),k(ko.$$.fragment),oi=h(),Lt=a("h2"),bo=a("a"),Aa=a("span"),k(zn.$$.fragment),zc=h(),La=a("span"),Cc=n("TFGPTJForSequenceClassification"),ni=h(),se=a("div"),k(Cn.$$.fragment),Ac=h(),Ia=a("p"),Lc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Ic=h(),Ms=a("p"),qs=a("a"),Nc=n("GPTJForSequenceClassification"),Oc=n(` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),k(wo.$$.fragment),rp=h(),Se=a("div"),k(Nn.$$.fragment),ip=h(),It=a("p"),lp=n("The "),Cs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Wa=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),k($o.$$.fragment),mp=h(),k(Po.$$.fragment),fp=h(),k(Fo.$$.fragment),si=h(),Nt=a("h2"),jo=a("a"),Ua=a("span"),k(On.$$.fragment),gp=h(),Qa=a("span"),_p=n("TFGPTJForQuestionAnswering"),ai=h(),Ge=a("div"),k(Sn.$$.fragment),Tp=h(),Ot=a("p"),yp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Ba=a("code"),vp=n("span start logits"),kp=n(" and "),Ha=a("code"),bp=n("span end logits"),wp=n(")."),$p=h(),Dn=a("p"),Pp=n("This model inherits from "),As=a("a"),Fp=n("TFPreTrainedModel"),jp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xp=h(),Wn=a("p"),Gp=n("This model is also a "),Un=a("a"),Jp=n("tf.keras.Model"),Ep=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mp=h(),k(xo.$$.fragment),qp=h(),De=a("div"),k(Qn.$$.fragment),zp=h(),St=a("p"),Cp=n("The "),Ls=a("a"),Ap=n("TFGPTJForQuestionAnswering"),Lp=n(" forward method, overrides the "),Ra=a("code"),Ip=n("__call__"),Np=n(" special method."),Op=h(),k(Go.$$.fragment),Sp=h(),k(Jo.$$.fragment),Dp=h(),k(Eo.$$.fragment),ri=h(),Dt=a("h2"),Mo=a("a"),Va=a("span"),k(Bn.$$.fragment),Wp=h(),Ka=a("span"),Up=n("FlaxGPTJModel"),ii=h(),be=a("div"),k(Hn.$$.fragment),Qp=h(),Xa=a("p"),Bp=n("The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),Hp=h(),Rn=a("p"),Rp=n("This model inherits from "),Is=a("a"),Vp=n("FlaxPreTrainedModel"),Kp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mh=h(),lr=a("p"),qh=n("Finally, this model supports inherent JAX features such as:"),zh=h(),mt=a("ul"),dr=a("li"),is=a("a"),Ch=n("Just-In-Time (JIT) compilation"),Ah=h(),cr=a("li"),ls=a("a"),Lh=n("Automatic Differentiation"),Ih=h(),pr=a("li"),ds=a("a"),Nh=n("Vectorization"),Oh=h(),hr=a("li"),cs=a("a"),Sh=n("Parallelization"),Dh=h(),at=a("div"),k(ps.$$.fragment),Wh=h(),Qt=a("p"),Uh=n("The "),ur=a("code"),Qh=n("FlaxGPTJPreTrainedModel"),Bh=n(" forward method, overrides the "),mr=a("code"),Hh=n("__call__"),Rh=n(" special method."),Vh=h(),k(Ao.$$.fragment),Kh=h(),k(Lo.$$.fragment),this.h()},l(o){const _=pf('[data-svelte="svelte-1phssyn"]',document.head);d=r(_,"META",{name:!0,content:!0}),_.forEach(t),T=u(o),c=r(o,"H1",{class:!0});var hs=i(c);p=r(hs,"A",{id:!0,class:!0,href:!0});var fr=i(p);y=r(fr,"SPAN",{});var gr=i(y);b(l.$$.fragment,gr),gr.forEach(t),fr.forEach(t),m=u(hs),x=r(hs,"SPAN",{});var _r=i(x);he=s(_r,"GPT-J"),_r.forEach(t),hs.forEach(t),K=u(o),J=r(o,"H2",{class:!0});var us=i(J);X=r(us,"A",{id:!0,class:!0,href:!0});var Tr=i(X);D=r(Tr,"SPAN",{});var yr=i(D);b(Z.$$.fragment,yr),yr.forEach(t),Tr.forEach(t),ue=u(us),W=r(us,"SPAN",{});var vr=i(W);me=s(vr,"Overview"),vr.forEach(t),us.forEach(t),re=u(o),I=r(o,"P",{});var Bt=i(I);L=s(Bt,"The GPT-J model was released in the "),ee=r(Bt,"A",{href:!0,rel:!0});var kr=i(ee);te=s(kr,"kingoflolz/mesh-transformer-jax"),kr.forEach(t),E=s(Bt,` repository by Ben Wang and Aran Komatsuzaki. It is a GPT-2-like
...
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
RAM to just load the model. To reduce the CPU RAM usage there are a few options. The `),ne=r(Ze,"CODE",{});var jr=i(ne);v=s(jr,"torch_dtype"),jr.forEach(t),G=s(Ze,` argument can be
used to initialize the model in half-precision. And the `),V=r(Ze,"CODE",{});var xr=i(V);ze=s(xr,"low_cpu_mem_usage"),xr.forEach(t),Ce=s(Ze,` argument can be used to keep the RAM
usage to 1x. There is also a `),C=r(Ze,"A",{href:!0,rel:!0});var Gr=i(C);Ae=s(Gr,"fp16 branch"),Gr.forEach(t),Le=s(Ze,` which stores
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
...
`),oa=r(ft,"CODE",{});var zr=i(oa);Di=s(zr,"<|extratoken_1|>... <|extratoken_143|>"),zr.forEach(t),Wi=s(ft,", so the "),na=r(ft,"CODE",{});var Cr=i(na);Ui=s(Cr,"vocab_size"),Cr.forEach(t),Qi=s(ft," of tokenizer also becomes 50400."),ft.forEach(t),Mr.forEach(t),fs.forEach(t),Lr=u(o),bt=r(o,"H3",{class:!0});var gs=i(bt);Ht=r(gs,"A",{id:!0,class:!0,href:!0});var Ar=i(Ht);sa=r(Ar,"SPAN",{});var Zh=i(sa);b(Vo.$$.fragment,Zh),Zh.forEach(t),Ar.forEach(t),Bi=u(gs),aa=r(gs,"SPAN",{});var eu=i(aa);Hi=s(eu,"Generation"),eu.forEach(t),gs.forEach(t),Ir=u(o),Rt=r(o,"P",{});var pi=i(Rt);Ri=s(pi,"The "),_s=r(pi,"A",{href:!0});var tu=i(_s);Vi=s(tu,"generate()"),tu.forEach(t),Ki=s(pi,` method can be used to generate text using GPT-J
...
no `),ya=r(_t,"CODE",{});var Gu=i(ya);ed=s(Gu,"pad_token_id"),Gu.forEach(t),td=s(_t,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ti.forEach(t),cd=u(rt),$e=r(rt,"DIV",{class:!0});var We=i($e);b(gn.$$.fragment,We),pd=u(We),Gt=r(We,"P",{});var Qs=i(Gt);hd=s(Qs,"The "),Fs=r(Qs,"A",{href:!0});var qu=i(Fs);ud=s(qu,"GPTJForSequenceClassification"),qu.forEach(t),md=s(Qs," forward method, overrides the "),ba=r(Qs,"CODE",{});var zu=i(ba);fd=s(zu,"__call__"),zu.forEach(t),gd=s(Qs," special method."),Qs.forEach(t),_d=u(We),b(so.$$.fragment,We),Td=u(We),b(ao.$$.fragment,We),yd=u(We),b(ro.$$.fragment,We),vd=u(We),b(io.$$.fragment,We),kd=u(We),b(lo.$$.fragment,We),We.forEach(t),rt.forEach(t),Kr=u(o),Jt=r(o,"H2",{class:!0});var yi=i(Jt);co=r(yi,"A",{id:!0,class:!0,href:!0});var Cu=i(co);wa=r(Cu,"SPAN",{});var Au=i(wa);b(_n.$$.fragment,Au),Au.forEach(t),Cu.forEach(t),bd=u(yi),$a=r(yi,"SPAN",{});var Lu=i($a);wd=s(Lu,"GPTJForQuestionAnswering"),Lu.forEach(t),yi.forEach(t),Xr=u(o),Xe=r(o,"DIV",{class:!0});var So=i(Xe);b(Tn.$$.fragment,So),$d=u(So),Et=r(So,"P",{});var Bs=i(Et);Pd=s(Bs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Pa=r(Bs,"CODE",{});var Iu=i(Pa);Fd=s(Iu,"span start logits"),Iu.forEach(t),jd=s(Bs," and "),Fa=r(Bs,"CODE",{});var Nu=i(Fa);xd=s(Nu,"span end logits"),Nu.forEach(t),Gd=s(Bs,")."),Bs.forEach(t),Jd=u(So),yn=r(So,"P",{});var vi=i(yn);Ed=s(vi,"This model is a PyTorch "),vn=r(vi,"A",{href:!0,rel:!0});var Ou=i(vn);Md=s(Ou,"torch.nn.Module"),Ou.forEach(t),qd=s(vi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vi.forEach(t),zd=u(So),Oe=r(So,"DIV",{class:!0});var Tt=i(Oe);b(kn.$$.fragment,Tt),Cd=u(Tt),Mt=r(Tt,"P",{});var Hs=i(Mt);Ad=s(Hs,"The "),js=r(Hs,"A",{href:!0});var Su=i(js);Ld=s(Su,"GPTJForQuestionAnswering"),Su.forEach(t),Id=s(Hs," forward method, overrides the "),ja=r(Hs,"CODE",{});var Du=i(ja);Nd=s(Du,"__call__"),Du.forEach(t),Od=s(Hs," special method."),Hs.forEach(t),Sd=u(Tt),b(po.$$.fragment,Tt),Dd=u(Tt),b(ho.$$.fragment,Tt),Wd=u(Tt),b(uo.$$.fragment,Tt),Tt.forEach(t),So.forEach(t),Yr=u(o),qt=r(o,"H2",{class:!0});var ki=i(qt);mo=r(ki,"A",{id:!0,class:!0,href:!0});var Wu=i(mo);xa=r(Wu,"SPAN",{});var Uu=i(xa);b(bn.$$.fragment,Uu),Uu.forEach(t),Wu.forEach(t),Ud=u(ki),Ga=r(ki,"SPAN",{});var Qu=i(Ga);Qd=s(Qu,"TFGPTJModel"),Qu.forEach(t),ki.forEach(t),Zr=u(o),je=r(o,"DIV",{class:!0});var it=i(je);b(wn.$$.fragment,it),Bd=u(it),Ja=r(it,"P",{});var Bu=i(Ja);Hd=s(Bu,"The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Bu.forEach(t),Rd=u(it),$n=r(it,"P",{});var bi=i($n);Vd=s(bi,"This model inherits from "),xs=r(bi,"A",{href:!0});var Hu=i(xs);Kd=s(Hu,"TFPreTrainedModel"),Hu.forEach(t),Xd=s(bi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
no `),Oa=r(yt,"CODE",{});var pm=i(Oa);Qc=s(pm,"pad_token_id"),pm.forEach(t),Bc=s(yt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
each row of the batch).`),yt.forEach(t),Xc=u(qe),An=r(qe,"P",{});var xi=i(An);Yc=s(xi,"This model inherits from "),zs=r(xi,"A",{href:!0});var mm=i(zs);Zc=s(mm,"TFPreTrainedModel"),mm.forEach(t),ep=s(xi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xi.forEach(t),tp=u(qe),Ln=r(qe,"P",{});var Gi=i(Ln);op=s(Gi,"This model is also a "),In=r(Gi,"A",{href:!0,rel:!0});var fm=i(In);np=s(fm,"tf.keras.Model"),fm.forEach(t),sp=s(Gi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gi.forEach(t),ap=u(qe),b(wo.$$.fragment,qe),rp=u(qe),Se=r(qe,"DIV",{class:!0});var vt=i(Se);b(Nn.$$.fragment,vt),ip=u(vt),It=r(vt,"P",{});var Ks=i(It);lp=s(Ks,"The "),Cs=r(Ks,"A",{href:!0});var gm=i(Cs);dp=s(gm,"TFGPTJForSequenceClassification"),gm.forEach(t),cp=s(Ks," forward method, overrides the "),Wa=r(Ks,"CODE",{});var _m=i(Wa);pp=s(_m,"__call__"),_m.forEach(t),hp=s(Ks," special method."),Ks.forEach(t),up=u(vt),b($o.$$.fragment,vt),mp=u(vt),b(Po.$$.fragment,vt),fp=u(vt),b(Fo.$$.fragment,vt),vt.forEach(t),qe.forEach(t),si=u(o),Nt=r(o,"H2",{class:!0});var Ji=i(Nt);jo=r(Ji,"A",{id:!0,class:!0,href:!0});var Tm=i(jo);Ua=r(Tm,"SPAN",{});var ym=i(Ua);b(On.$$.fragment,ym),ym.forEach(t),Tm.forEach(t),gp=u(Ji),Qa=r(Ji,"SPAN",{});var vm=i(Qa);_p=s(vm,"TFGPTJForQuestionAnswering"),vm.forEach(t),Ji.forEach(t),ai=u(o),Ge=r(o,"DIV",{class:!0});var dt=i(Ge);b(Sn.$$.fragment,dt),Tp=u(dt),Ot=r(dt,"P",{});var Xs=i(Ot);yp=s(Xs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Ba=r(Xs,"CODE",{});var km=i(Ba);vp=s(km,"span start logits"),km.forEach(t),kp=s(Xs," and "),Ha=r(Xs,"CODE",{});var bm=i(Ha);bp=s(bm,"span end logits"),bm.forEach(t),wp=s(Xs,")."),Xs.forEach(t),$p=u(dt),Dn=r(dt,"P",{});var Ei=i(Dn);Pp=s(Ei,"This model inherits from "),As=r(Ei,"A",{href:!0});var wm=i(As);Fp=s(wm,"TFPreTrainedModel"),wm.forEach(t),jp=s(Ei,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mi.forEach(t),Mp=u(dt),b(xo.$$.fragment,dt),qp=u(dt),De=r(dt,"DIV",{class:!0});var kt=i(De);b(Qn.$$.fragment,kt),zp=u(kt),St=r(kt,"P",{});var Ys=i(St);Cp=s(Ys,"The "),Ls=r(Ys,"A",{href:!0});var Pm=i(Ls);Ap=s(Pm,"TFGPTJForQuestionAnswering"),Pm.forEach(t),Lp=s(Ys," forward method, overrides the "),Ra=r(Ys,"CODE",{});var Fm=i(Ra);Ip=s(Fm,"__call__"),Fm.forEach(t),Np=s(Ys," special method."),Ys.forEach(t),Op=u(kt),b(Go.$$.fragment,kt),Sp=u(kt),b(Jo.$$.fragment,kt),Dp=u(kt),b(Eo.$$.fragment,kt),kt.forEach(t),dt.forEach(t),ri=u(o),Dt=r(o,"H2",{class:!0});var qi=i(Dt);Mo=r(qi,"A",{id:!0,class:!0,href:!0});var jm=i(Mo);Va=r(jm,"SPAN",{});var xm=i(Va);b(Bn.$$.fragment,xm),xm.forEach(t),jm.forEach(t),Wp=u(qi),Ka=r(qi,"SPAN",{});var Gm=i(Ka);Up=s(Gm,"FlaxGPTJModel"),Gm.forEach(t),qi.forEach(t),ii=u(o),be=r(o,"DIV",{class:!0});var Ue=i(be);b(Hn.$$.fragment,Ue),Qp=u(Ue),Xa=r(Ue,"P",{});var Jm=i(Xa);Bp=s(Jm,"The bare GPTJ Model transformer outputting raw hidden-states without any specific head on top."),Jm.forEach(t),Hp=u(Ue),Rn=r(Ue,"P",{});var zi=i(Rn);Rp=s(zi,"This model inherits from "),Is=r(zi,"A",{href:!0});var Em=i(Is);Vp=s(Em,"FlaxPreTrainedModel"),Em.forEach(t),Kp=s(zi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
