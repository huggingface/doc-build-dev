...
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L837",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hg.forEach(t),Vy=p(Ht),y(Ts.$$.fragment,Ht),Ky=p(Ht),dt=s(Ht,"DIV",{class:!0});var _o=a(dt);y(hi.$$.fragment,_o),Jy=p(_o),Go=s(_o,"P",{});var $c=a(Go);Gy=i($c,"The "),Yd=s($c,"A",{href:!0});var r4=a(Yd);Xy=i(r4,"TFElectraForSequenceClassification"),r4.forEach(t),Yy=i($c," forward method, overrides the "),Kp=s($c,"CODE",{});var i4=a(Kp);Zy=i(i4,"__call__"),i4.forEach(t),eE=i($c," special method."),$c.forEach(t),tE=p(_o),y(bs.$$.fragment,_o),oE=p(_o),y(ys.$$.fragment,_o),nE=p(_o),y(Es.$$.fragment,_o),_o.forEach(t),Ht.forEach(t),sf=p(o),Xo=s(o,"H2",{class:!0});var mg=a(Xo);ws=s(mg,"A",{id:!0,class:!0,href:!0});var l4=a(ws);Jp=s(l4,"SPAN",{});var d4=a(Jp);y(mi.$$.fragment,d4),d4.forEach(t),l4.forEach(t),sE=p(mg),Gp=s(mg,"SPAN",{});var c4=a(Gp);aE=i(c4,"TFElectraForMultipleChoice"),c4.forEach(t),mg.forEach(t),af=p(o),Ge=s(o,"DIV",{class:!0});var Bt=a(Ge);y(ui.$$.fragment,Bt),rE=p(Bt),Xp=s(Bt,"P",{});var p4=a(Xp);iE=i(p4,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),p4.forEach(t),lE=p(Bt),fi=s(Bt,"P",{});var ug=a(fi);dE=i(ug,"This model inherits from "),Zd=s(ug,"A",{href:!0});var h4=a(Zd);cE=i(h4,"TFPreTrainedModel"),h4.forEach(t),pE=i(ug,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ug.forEach(t),hE=p(Bt),gi=s(Bt,"P",{});var fg=a(gi);mE=i(fg,"This model is also a "),_i=s(fg,"A",{href:!0,rel:!0});var m4=a(_i);uE=i(m4,"tf.keras.Model"),m4.forEach(t),fE=i(fg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fg.forEach(t),gE=p(Bt),y($s.$$.fragment,Bt),_E=p(Bt),jt=s(Bt,"DIV",{class:!0});var ga=a(jt);y(ki.$$.fragment,ga),kE=p(ga),Yo=s(ga,"P",{});var Fc=a(Yo);vE=i(Fc,"The "),ec=s(Fc,"A",{href:!0});var u4=a(ec);TE=i(u4,"TFElectraForMultipleChoice"),u4.forEach(t),bE=i(Fc," forward method, overrides the "),Yp=s(Fc,"CODE",{});var f4=a(Yp);yE=i(f4,"__call__"),f4.forEach(t),EE=i(Fc," special method."),Fc.forEach(t),wE=p(ga),y(Fs.$$.fragment,ga),$E=p(ga),y(xs.$$.fragment,ga),ga.forEach(t),Bt.forEach(t),rf=p(o),Zo=s(o,"H2",{class:!0});var gg=a(Zo);Ms=s(gg,"A",{id:!0,class:!0,href:!0});var g4=a(Ms);Zp=s(g4,"SPAN",{});var _4=a(Zp);y(vi.$$.fragment,_4),_4.forEach(t),g4.forEach(t),FE=p(gg),eh=s(gg,"SPAN",{});var k4=a(eh);xE=i(k4,"TFElectraForTokenClassification"),k4.forEach(t),gg.forEach(t),lf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(Ti.$$.fragment,ft),ME=p(ft),th=s(ft,"P",{});var v4=a(th);zE=i(v4,"Electra model with a token classification head on top."),v4.forEach(t),CE=p(ft),oh=s(ft,"P",{});var T4=a(oh);jE=i(T4,"Both the discriminator and generator may be loaded into this model."),T4.forEach(t),qE=p(ft),bi=s(ft,"P",{});var _g=a(bi);PE=i(_g,"This model inherits from "),tc=s(_g,"A",{href:!0});var b4=a(tc);AE=i(b4,"TFPreTrainedModel"),b4.forEach(t),OE=i(_g,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),SE=p(ft),y(zs.$$.fragment,ft),WE=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),UE=p(ko),en=s(ko,"P",{});var xc=a(en);RE=i(xc,"The "),oc=s(xc,"A",{href:!0});var E4=a(oc);HE=i(E4,"TFElectraForTokenClassification"),E4.forEach(t),BE=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var w4=a(nh);QE=i(w4,"__call__"),w4.forEach(t),VE=i(xc," special method."),xc.forEach(t),KE=p(ko),y(Cs.$$.fragment,ko),JE=p(ko),y(js.$$.fragment,ko),GE=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $4=a(Ps);sh=s($4,"SPAN",{});var F4=a(sh);y($i.$$.fragment,F4),F4.forEach(t),$4.forEach(t),XE=p(vg),ah=s(vg,"SPAN",{});var x4=a(ah);YE=i(x4,"TFElectraForQuestionAnswering"),x4.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Qt=a(Xe);y(Fi.$$.fragment,Qt),ZE=p(Qt),on=s(Qt,"P",{});var Mc=a(on);ew=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var M4=a(rh);tw=i(M4,"span start logits"),M4.forEach(t),ow=i(Mc," and "),ih=s(Mc,"CODE",{});var z4=a(ih);nw=i(z4,"span end logits"),z4.forEach(t),sw=i(Mc,")."),Mc.forEach(t),aw=p(Qt),xi=s(Qt,"P",{});var Tg=a(xi);rw=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var C4=a(nc);iw=i(C4,"TFPreTrainedModel"),C4.forEach(t),lw=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dw=p(Qt),Mi=s(Qt,"P",{});var bg=a(Mi);cw=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var j4=a(zi);pw=i(j4,"tf.keras.Model"),j4.forEach(t),hw=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mw=p(Qt),y(As.$$.fragment,Qt),uw=p(Qt),pt=s(Qt,"DIV",{class:!0});var vo=a(pt);y(Ci.$$.fragment,vo),fw=p(vo),nn=s(vo,"P",{});var zc=a(nn);gw=i(zc,"The "),sc=s(zc,"A",{href:!0});var q4=a(sc);_w=i(q4,"TFElectraForQuestionAnswering"),q4.forEach(t),kw=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var P4=a(lh);vw=i(P4,"__call__"),P4.forEach(t),Tw=i(zc," special method."),zc.forEach(t),bw=p(vo),y(Os.$$.fragment,vo),yw=p(vo),y(Ls.$$.fragment,vo),Ew=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Qt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var A4=a(Is);dh=s(A4,"SPAN",{});var O4=a(dh);y(ji.$$.fragment,O4),O4.forEach(t),A4.forEach(t),ww=p(yg),ch=s(yg,"SPAN",{});var L4=a(ch);$w=i(L4,"FlaxElectraModel"),L4.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),Fw=p(gt),ph=s(gt,"P",{});var N4=a(ph);xw=i(N4,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),N4.forEach(t),Mw=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zw=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var I4=a(ac);Cw=i(I4,"FlaxPreTrainedModel"),I4.forEach(t),jw=i(Eg,`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$1=p(kt),Rh=s(kt,"P",{});var IM=a(Rh);F1=i(IM,"Finally, this model supports inherent JAX features such as:"),IM.forEach(t),x1=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var DM=a(Hh);ml=s(DM,"A",{href:!0,rel:!0});var SM=a(ml);M1=i(SM,"Just-In-Time (JIT) compilation"),SM.forEach(t),DM.forEach(t),z1=p(Ea),Bh=s(Ea,"LI",{});var WM=a(Bh);ul=s(WM,"A",{href:!0,rel:!0});var UM=a(ul);C1=i(UM,"Automatic Differentiation"),UM.forEach(t),WM.forEach(t),j1=p(Ea),Qh=s(Ea,"LI",{});var RM=a(Qh);fl=s(RM,"A",{href:!0,rel:!0});var HM=a(fl);q1=i(HM,"Vectorization"),HM.forEach(t),RM.forEach(t),P1=p(Ea),Vh=s(Ea,"LI",{});var BM=a(Vh);gl=s(BM,"A",{href:!0,rel:!0});var QM=a(gl);A1=i(QM,"Parallelization"),QM.forEach(t),BM.forEach(t),Ea.forEach(t),O1=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L1=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N1=i(Pc,"The "),Kh=s(Pc,"CODE",{});var VM=a(Kh);I1=i(VM,"FlaxElectraPreTrainedModel"),VM.forEach(t),D1=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var KM=a(Jh);S1=i(KM,"__call__"),KM.forEach(t),W1=i(Pc," special method."),Pc.forEach(t),U1=p(wa),y(Ks.$$.fragment,wa),R1=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var JM=a(Gs);Gh=s(JM,"SPAN",{});var GM=a(Gh);y(kl.$$.fragment,GM),GM.forEach(t),JM.forEach(t),H1=p(Og),Xh=s(Og,"SPAN",{});var XM=a(Xh);B1=i(XM,"FlaxElectraForSequenceClassification"),XM.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),Q1=p(vt),Yh=s(vt,"P",{});var YM=a(Yh);V1=i(YM,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
