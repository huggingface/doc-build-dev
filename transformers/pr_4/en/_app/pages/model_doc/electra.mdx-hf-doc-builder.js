...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_4/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fg.forEach(t),gE=p(Qt),y($s.$$.fragment,Qt),_E=p(Qt),Ct=s(Qt,"DIV",{class:!0});var ga=a(Ct);y(ki.$$.fragment,ga),kE=p(ga),Yo=s(ga,"P",{});var Fc=a(Yo);vE=i(Fc,"The "),ec=s(Fc,"A",{href:!0});var u4=a(ec);TE=i(u4,"TFElectraForMultipleChoice"),u4.forEach(t),bE=i(Fc," forward method, overrides the "),Yp=s(Fc,"CODE",{});var f4=a(Yp);yE=i(f4,"__call__"),f4.forEach(t),EE=i(Fc," special method."),Fc.forEach(t),wE=p(ga),y(Fs.$$.fragment,ga),$E=p(ga),y(xs.$$.fragment,ga),ga.forEach(t),Qt.forEach(t),rf=p(o),Zo=s(o,"H2",{class:!0});var gg=a(Zo);Ms=s(gg,"A",{id:!0,class:!0,href:!0});var g4=a(Ms);Zp=s(g4,"SPAN",{});var _4=a(Zp);y(vi.$$.fragment,_4),_4.forEach(t),g4.forEach(t),FE=p(gg),eh=s(gg,"SPAN",{});var k4=a(eh);xE=i(k4,"TFElectraForTokenClassification"),k4.forEach(t),gg.forEach(t),lf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(Ti.$$.fragment,ft),ME=p(ft),th=s(ft,"P",{});var v4=a(th);zE=i(v4,"Electra model with a token classification head on top."),v4.forEach(t),jE=p(ft),oh=s(ft,"P",{});var T4=a(oh);CE=i(T4,"Both the discriminator and generator may be loaded into this model."),T4.forEach(t),qE=p(ft),bi=s(ft,"P",{});var _g=a(bi);PE=i(_g,"This model inherits from "),tc=s(_g,"A",{href:!0});var b4=a(tc);AE=i(b4,"TFPreTrainedModel"),b4.forEach(t),OE=i(_g,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),SE=p(ft),y(zs.$$.fragment,ft),WE=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),UE=p(ko),en=s(ko,"P",{});var xc=a(en);RE=i(xc,"The "),oc=s(xc,"A",{href:!0});var E4=a(oc);HE=i(E4,"TFElectraForTokenClassification"),E4.forEach(t),QE=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var w4=a(nh);BE=i(w4,"__call__"),w4.forEach(t),VE=i(xc," special method."),xc.forEach(t),KE=p(ko),y(js.$$.fragment,ko),JE=p(ko),y(Cs.$$.fragment,ko),GE=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $4=a(Ps);sh=s($4,"SPAN",{});var F4=a(sh);y($i.$$.fragment,F4),F4.forEach(t),$4.forEach(t),XE=p(vg),ah=s(vg,"SPAN",{});var x4=a(ah);YE=i(x4,"TFElectraForQuestionAnswering"),x4.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Bt=a(Xe);y(Fi.$$.fragment,Bt),ZE=p(Bt),on=s(Bt,"P",{});var Mc=a(on);ew=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xg.forEach(t),f$=p(Ye),Eh=s(Ye,"P",{});var sM=a(Eh);g$=i(sM,"Finally, this model supports inherent JAX features such as:"),sM.forEach(t),_$=p(Ye),Jt=s(Ye,"UL",{});var va=a(Jt);wh=s(va,"LI",{});var aM=a(wh);Bi=s(aM,"A",{href:!0,rel:!0});var rM=a(Bi);k$=i(rM,"Just-In-Time (JIT) compilation"),rM.forEach(t),aM.forEach(t),v$=p(va),$h=s(va,"LI",{});var iM=a($h);Vi=s(iM,"A",{href:!0,rel:!0});var lM=a(Vi);T$=i(lM,"Automatic Differentiation"),lM.forEach(t),iM.forEach(t),b$=p(va),Fh=s(va,"LI",{});var dM=a(Fh);Ki=s(dM,"A",{href:!0,rel:!0});var cM=a(Ki);y$=i(cM,"Vectorization"),cM.forEach(t),dM.forEach(t),E$=p(va),xh=s(va,"LI",{});var pM=a(xh);Ji=s(pM,"A",{href:!0,rel:!0});var hM=a(Ji);w$=i(hM,"Parallelization"),hM.forEach(t),pM.forEach(t),va.forEach(t),$$=p(Ye),Pt=s(Ye,"DIV",{class:!0});var Ta=a(Pt);y(Gi.$$.fragment,Ta),F$=p(Ta),ln=s(Ta,"P",{});var Cc=a(ln);x$=i(Cc,"The "),Mh=s(Cc,"CODE",{});var mM=a(Mh);M$=i(mM,"FlaxElectraPreTrainedModel"),mM.forEach(t),z$=i(Cc," forward method, overrides the "),zh=s(Cc,"CODE",{});var uM=a(zh);j$=i(uM,"__call__"),uM.forEach(t),C$=i(Cc," special method."),Cc.forEach(t),q$=p(Ta),y(Us.$$.fragment,Ta),P$=p(Ta),y(Rs.$$.fragment,Ta),Ta.forEach(t),Ye.forEach(t),ff=p(o),dn=s(o,"H2",{class:!0});var Mg=a(dn);Hs=s(Mg,"A",{id:!0,class:!0,href:!0});var fM=a(Hs);jh=s(fM,"SPAN",{});var gM=a(jh);y(Xi.$$.fragment,gM),gM.forEach(t),fM.forEach(t),A$=p(Mg),Ch=s(Mg,"SPAN",{});var _M=a(Ch);O$=i(_M,"FlaxElectraForCausalLM"),_M.forEach(t),Mg.forEach(t),gf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),L$=p(_t),qh=s(_t,"P",{});var kM=a(qh);N$=i(kM,`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$1=p(kt),Rh=s(kt,"P",{});var IM=a(Rh);F1=i(IM,"Finally, this model supports inherent JAX features such as:"),IM.forEach(t),x1=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var DM=a(Hh);ml=s(DM,"A",{href:!0,rel:!0});var SM=a(ml);M1=i(SM,"Just-In-Time (JIT) compilation"),SM.forEach(t),DM.forEach(t),z1=p(Ea),Qh=s(Ea,"LI",{});var WM=a(Qh);ul=s(WM,"A",{href:!0,rel:!0});var UM=a(ul);j1=i(UM,"Automatic Differentiation"),UM.forEach(t),WM.forEach(t),C1=p(Ea),Bh=s(Ea,"LI",{});var RM=a(Bh);fl=s(RM,"A",{href:!0,rel:!0});var HM=a(fl);q1=i(HM,"Vectorization"),HM.forEach(t),RM.forEach(t),P1=p(Ea),Vh=s(Ea,"LI",{});var QM=a(Vh);gl=s(QM,"A",{href:!0,rel:!0});var BM=a(gl);A1=i(BM,"Parallelization"),BM.forEach(t),QM.forEach(t),Ea.forEach(t),O1=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L1=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N1=i(Pc,"The "),Kh=s(Pc,"CODE",{});var VM=a(Kh);I1=i(VM,"FlaxElectraPreTrainedModel"),VM.forEach(t),D1=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var KM=a(Jh);S1=i(KM,"__call__"),KM.forEach(t),W1=i(Pc," special method."),Pc.forEach(t),U1=p(wa),y(Ks.$$.fragment,wa),R1=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var JM=a(Gs);Gh=s(JM,"SPAN",{});var GM=a(Gh);y(kl.$$.fragment,GM),GM.forEach(t),JM.forEach(t),H1=p(Og),Xh=s(Og,"SPAN",{});var XM=a(Xh);Q1=i(XM,"FlaxElectraForSequenceClassification"),XM.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),B1=p(vt),Yh=s(vt,"P",{});var YM=a(Yh);V1=i(YM,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
