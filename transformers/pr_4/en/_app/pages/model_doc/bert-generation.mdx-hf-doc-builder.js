...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(d,g){f(d,u,g),e(u,v),e(u,_),e(_,m),e(u,b)},d(d){d&&o(u)}}}function ha(j){let u,v,_,m,b;return m=new Qt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationEncoder
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("p"),v=n("Example:"),_=p(),k(m.$$.fragment)},l(d){u=a(d,"P",{});var g=i(u);v=r(g,"Example:"),g.forEach(o),_=h(d),y(m.$$.fragment,d)},m(d,g){f(d,u,g),e(u,v),f(d,_,g),T(m,d,g),b=!0},p:Zr,i(d){b||(w(m.$$.fragment,d),b=!0)},o(d){$(m.$$.fragment,d),b=!1},d(d){d&&o(u),d&&o(_),E(m,d)}}}function ma(j){let u,v,_,m,b,d,g,A,Do,Xt,F,X,wt,he,So,$t,Ao,Yt,M,Mo,Ke,Oo,Lo,ue,No,Fo,Zt,Qe,Io,eo,Xe,Et,Ro,to,Ye,Wo,oo,Ze,fe,Uo,et,Ho,Vo,no,me,ro,tt,ge,Jo,ot,Ko,Qo,so,_e,ao,nt,Xo,io,Y,O,rt,Yo,Zo,st,en,tn,Bt,on,nn,rn,zt,sn,lo,L,an,be,dn,ln,ve,cn,pn,co,I,Z,Gt,ke,hn,qt,un,po,P,ye,fn,R,mn,xt,gn,_n,Te,bn,vn,kn,W,yn,at,Tn,wn,it,$n,En,Bn,ee,ho,U,te,Pt,we,zn,Ct,Gn,uo,C,$e,qn,Ee,xn,Be,Pn,Cn,jn,ze,Dn,dt,Sn,An,Mn,lt,Ge,fo,H,oe,jt,qe,On,Dt,Ln,mo,B,xe,Nn,St,Fn,In,Pe,Rn,ct,Wn,Un,Hn,Ce,Vn,je,Jn,Kn,Qn,De,Xn,Se,Yn,Zn,er,V,tr,pt,or,nr,Ae,rr,sr,ar,z,ir,At,dr,lr,Mt,cr,pr,Ot,hr,ur,Lt,fr,mr,Nt,gr,_r,Ft,br,vr,kr,D,Me,yr,J,Tr,ht,wr,$r,It,Er,Br,zr,ne,Gr,re,go,K,se,Rt,Oe,qr,Wt,xr,_o,q,Le,Pr,Ne,Cr,Ut,jr,Dr,Sr,Fe,Ar,ut,Mr,Or,Lr,Ie,Nr,Re,Fr,Ir,Rr,S,We,Wr,Q,Ur,ft,Hr,Vr,Ht,Jr,Kr,Qr,ae,Xr,ie,bo;return d=new Tt({}),he=new Tt({}),me=new Qt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/bert-generation#transformers.BertGenerationTokenizer">BertGenerationTokenizer</a>. See <a href="/docs/transformers/pr_4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
documentation from `),it=s("a"),$n=n("PretrainedConfig"),En=n(" for more information."),Bn=p(),k(ee.$$.fragment),ho=p(),U=s("h2"),te=s("a"),Pt=s("span"),k(we.$$.fragment),zn=p(),Ct=s("span"),Gn=n("BertGenerationTokenizer"),uo=p(),C=s("div"),k($e.$$.fragment),qn=p(),Ee=s("p"),xn=n("Construct a BertGeneration tokenizer. Based on "),Be=s("a"),Pn=n("SentencePiece"),Cn=n("."),jn=p(),ze=s("p"),Dn=n("This tokenizer inherits from "),dt=s("a"),Sn=n("PreTrainedTokenizer"),An=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Mn=p(),lt=s("div"),k(Ge.$$.fragment),fo=p(),H=s("h2"),oe=s("a"),jt=s("span"),k(qe.$$.fragment),On=p(),Dt=s("span"),Ln=n("BertGenerationEncoder"),mo=p(),B=s("div"),k(xe.$$.fragment),Nn=p(),St=s("p"),Fn=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=p(),Pe=s("p"),Rn=n("This model inherits from "),ct=s("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hn=p(),Ce=s("p"),Vn=n("This model is also a PyTorch "),je=s("a"),Jn=n("torch.nn.Module"),Kn=n(` subclass.
...
`),Lt=s("code"),fr=n("add_cross_attention"),mr=n(" set to "),Nt=s("code"),gr=n("True"),_r=n("; an "),Ft=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=p(),D=s("div"),k(Me.$$.fragment),yr=p(),J=s("p"),Tr=n("The "),ht=s("a"),wr=n("BertGenerationEncoder"),$r=n(" forward method, overrides the "),It=s("code"),Er=n("__call__"),Br=n(" special method."),zr=p(),k(ne.$$.fragment),Gr=p(),k(re.$$.fragment),go=p(),K=s("h2"),se=s("a"),Rt=s("span"),k(Oe.$$.fragment),qr=p(),Wt=s("span"),xr=n("BertGenerationDecoder"),_o=p(),q=s("div"),k(Le.$$.fragment),Pr=p(),Ne=s("p"),Cr=n("BertGeneration Model with a "),Ut=s("code"),jr=n("language modeling"),Dr=n(" head on top for CLM fine-tuning."),Sr=p(),Fe=s("p"),Ar=n("This model inherits from "),ut=s("a"),Mr=n("PreTrainedModel"),Or=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation from `),it=a(bt,"A",{href:!0});var Bs=i(it);$n=r(Bs,"PretrainedConfig"),Bs.forEach(o),En=r(bt," for more information."),bt.forEach(o),Bn=h(de),y(ee.$$.fragment,de),de.forEach(o),ho=h(t),U=a(t,"H2",{class:!0});var wo=i(U);te=a(wo,"A",{id:!0,class:!0,href:!0});var zs=i(te);Pt=a(zs,"SPAN",{});var Gs=i(Pt);y(we.$$.fragment,Gs),Gs.forEach(o),zs.forEach(o),zn=h(wo),Ct=a(wo,"SPAN",{});var qs=i(Ct);Gn=r(qs,"BertGenerationTokenizer"),qs.forEach(o),wo.forEach(o),uo=h(t),C=a(t,"DIV",{class:!0});var le=i(C);y($e.$$.fragment,le),qn=h(le),Ee=a(le,"P",{});var $o=i(Ee);xn=r($o,"Construct a BertGeneration tokenizer. Based on "),Be=a($o,"A",{href:!0,rel:!0});var xs=i(Be);Pn=r(xs,"SentencePiece"),xs.forEach(o),Cn=r($o,"."),$o.forEach(o),jn=h(le),ze=a(le,"P",{});var Eo=i(ze);Dn=r(Eo,"This tokenizer inherits from "),dt=a(Eo,"A",{href:!0});var Ps=i(dt);Sn=r(Ps,"PreTrainedTokenizer"),Ps.forEach(o),An=r(Eo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Eo.forEach(o),Mn=h(le),lt=a(le,"DIV",{class:!0});var Cs=i(lt);y(Ge.$$.fragment,Cs),Cs.forEach(o),le.forEach(o),fo=h(t),H=a(t,"H2",{class:!0});var Bo=i(H);oe=a(Bo,"A",{id:!0,class:!0,href:!0});var js=i(oe);jt=a(js,"SPAN",{});var Ds=i(jt);y(qe.$$.fragment,Ds),Ds.forEach(o),js.forEach(o),On=h(Bo),Dt=a(Bo,"SPAN",{});var Ss=i(Dt);Ln=r(Ss,"BertGenerationEncoder"),Ss.forEach(o),Bo.forEach(o),mo=h(t),B=a(t,"DIV",{class:!0});var G=i(B);y(xe.$$.fragment,G),Nn=h(G),St=a(G,"P",{});var As=i(St);Fn=r(As,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),As.forEach(o),In=h(G),Pe=a(G,"P",{});var zo=i(Pe);Rn=r(zo,"This model inherits from "),ct=a(zo,"A",{href:!0});var Ms=i(ct);Wn=r(Ms,"PreTrainedModel"),Ms.forEach(o),Un=r(zo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zo.forEach(o),Hn=h(G),Ce=a(G,"P",{});var Go=i(Ce);Vn=r(Go,"This model is also a PyTorch "),je=a(Go,"A",{href:!0,rel:!0});var Os=i(je);Jn=r(Os,"torch.nn.Module"),Os.forEach(o),Kn=r(Go,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
