import{S as P2,i as C2,s as S2,e as n,k as d,w as m,t as r,M as A2,c as a,d as t,m as l,a as s,x as f,h as i,b as c,F as e,g as h,y as _,q as g,o as k,B as b}from"../../chunks/vendor-6b77c823.js";import{T as at}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-abef54e3.js";import{C as F}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as U}from"../../chunks/IconCopyLink-7a11ce68.js";function I2(E){let u,z,v,M,x;return{c(){u=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),M=r("Module"),x=r(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_4/en/model_doc/mbart#transformers.MBartConfig"
...
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),kw.forEach(t),gw.forEach(t),xp=l(o),eo=a(o,"H3",{class:!0});var mh=s(eo);Ao=a(mh,"A",{id:!0,class:!0,href:!0});var bw=s(Ao);_d=a(bw,"SPAN",{});var vw=s(_d);f(Dn.$$.fragment,vw),vw.forEach(t),bw.forEach(t),am=l(mh),gd=a(mh,"SPAN",{});var yw=s(gd);sm=i(yw,"Training of MBart-50"),yw.forEach(t),mh.forEach(t),zp=l(o),et=a(o,"P",{});var wn=s(et);rm=i(wn,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
respectively.`),wn.forEach(t),qp=l(o),Io=a(o,"P",{});var fh=s(Io);um=i(fh,"MBart-50 has its own tokenizer "),ni=a(fh,"A",{href:!0});var xw=s(ni);mm=i(xw,"MBart50Tokenizer"),xw.forEach(t),fm=i(fh,"."),fh.forEach(t),Bp=l(o),ai=a(o,"UL",{});var zw=s(ai);yd=a(zw,"LI",{});var qw=s(yd);_m=i(qw,"Supervised training"),qw.forEach(t),zw.forEach(t),$p=l(o),f(Ln.$$.fragment,o),Fp=l(o),si=a(o,"UL",{});var Bw=s(si);Gn=a(Bw,"LI",{});var _h=s(Gn);Td=a(_h,"P",{});var $w=s(Td);gm=i($w,"Generation"),$w.forEach(t),km=l(_h),xe=a(_h,"P",{});var nt=s(xe);bm=i(nt,"To generate using the mBART-50 multilingual translation models, "),Md=a(nt,"CODE",{});var Fw=s(Md);vm=i(Fw,"eos_token_id"),Fw.forEach(t),ym=i(nt,` is used as the
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),qd=a(nt,"EM",{});var Cw=s(qd);Bm=i(Cw,"facebook/mbart-50-large-many-to-many"),Cw.forEach(t),$m=i(nt," checkpoint."),nt.forEach(t),_h.forEach(t),Bw.forEach(t),jp=l(o),f(Wn.$$.fragment,o),Ep=l(o),to=a(o,"H2",{class:!0});var gh=s(to);No=a(gh,"A",{id:!0,class:!0,href:!0});var Sw=s(No);Bd=a(Sw,"SPAN",{});var Aw=s(Bd);f(Rn.$$.fragment,Aw),Aw.forEach(t),Sw.forEach(t),Fm=l(gh),$d=a(gh,"SPAN",{});var Iw=s($d);jm=i(Iw,"MBartConfig"),Iw.forEach(t),gh.forEach(t),Pp=l(o),ze=a(o,"DIV",{class:!0});var Et=s(ze);f(Un.$$.fragment,Et),Em=l(Et),oo=a(Et,"P",{});var Si=s(oo);Pm=i(Si,"This is the configuration class to store the configuration of a "),ri=a(Si,"A",{href:!0});var Nw=s(ri);Cm=i(Nw,"MBartModel"),Nw.forEach(t),Sm=i(Si,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Xn=a(Si,"A",{href:!0,rel:!0});var Ow=s(Xn);Am=i(Ow,"facebook/mbart-large-cc25"),Ow.forEach(t),Im=i(Si," architecture."),Si.forEach(t),Nm=l(Et),no=a(Et,"P",{});var Ai=s(no);Om=i(Ai,"Configuration objects inherit from "),ii=a(Ai,"A",{href:!0});var Dw=s(ii);Dm=i(Dw,"PretrainedConfig"),Dw.forEach(t),Lm=i(Ai,` and can be used to control the model outputs. Read the
documentation from `),di=a(Ai,"A",{href:!0});var Lw=s(di);Gm=i(Lw,"PretrainedConfig"),Lw.forEach(t),Wm=i(Ai," for more information."),Ai.forEach(t),Rm=l(Et),Fd=a(Et,"P",{});var Gw=s(Fd);Um=i(Gw,"Example:"),Gw.forEach(t),Xm=l(Et),f(Hn.$$.fragment,Et),Et.forEach(t),Cp=l(o),ao=a(o,"H2",{class:!0});var kh=s(ao);Oo=a(kh,"A",{id:!0,class:!0,href:!0});var Ww=s(Oo);jd=a(Ww,"SPAN",{});var Rw=s(jd);f(Vn.$$.fragment,Rw),Rw.forEach(t),Ww.forEach(t),Hm=l(kh),Ed=a(kh,"SPAN",{});var Uw=s(Ed);Vm=i(Uw,"MBartTokenizer"),Uw.forEach(t),kh.forEach(t),Sp=l(o),L=a(o,"DIV",{class:!0});var he=s(L);f(Qn.$$.fragment,he),Qm=l(he),Pd=a(he,"P",{});var Xw=s(Pd);Jm=i(Xw,"Construct an MBART tokenizer."),Xw.forEach(t),Km=l(he),ut=a(he,"P",{});var xn=s(ut);Zm=i(xn,"Adapted from "),li=a(xn,"A",{href:!0});var Hw=s(li);Ym=i(Hw,"RobertaTokenizer"),Hw.forEach(t),ef=i(xn," and "),ci=a(xn,"A",{href:!0});var Vw=s(ci);tf=i(Vw,"XLNetTokenizer"),Vw.forEach(t),of=i(xn,`. Based on
`),Jn=a(xn,"A",{href:!0,rel:!0});var Qw=s(Jn);nf=i(Qw,"SentencePiece"),Qw.forEach(t),af=i(xn,"."),xn.forEach(t),sf=l(he),Kn=a(he,"P",{});var bh=s(Kn);rf=i(bh,"The tokenization method is "),Cd=a(bh,"CODE",{});var Jw=s(Cd);df=i(Jw,"<tokens> <eos> <language code>"),Jw.forEach(t),lf=i(bh," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),bh.forEach(t),cf=l(he),Sd=a(he,"P",{});var Kw=s(Sd);pf=i(Kw,"Examples:"),Kw.forEach(t),hf=l(he),f(Zn.$$.fragment,he),uf=l(he),Do=a(he,"DIV",{class:!0});var vh=s(Do);f(Yn.$$.fragment,vh),mf=l(vh),Ad=a(vh,"P",{});var Zw=s(Ad);ff=i(Zw,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Zw.forEach(t),vh.forEach(t),_f=l(he),tt=a(he,"DIV",{class:!0});var zn=s(tt);f(ea.$$.fragment,zn),gf=l(zn),ta=a(zn,"P",{});var yh=s(ta);kf=i(yh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Id=a(yh,"CODE",{});var Yw=s(Id);bf=i(Yw,"X"),Yw.forEach(t),vf=i(yh," represents the sequence:"),yh.forEach(t),yf=l(zn),oa=a(zn,"UL",{});var Th=s(oa);na=a(Th,"LI",{});var Mh=s(na);Nd=a(Mh,"CODE",{});var e1=s(Nd);Tf=i(e1,"input_ids"),e1.forEach(t),Mf=i(Mh," (for encoder) "),Od=a(Mh,"CODE",{});var t1=s(Od);wf=i(t1,"X [eos, src_lang_code]"),t1.forEach(t),Mh.forEach(t),xf=l(Th),aa=a(Th,"LI",{});var wh=s(aa);Dd=a(wh,"CODE",{});var o1=s(Dd);zf=i(o1,"decoder_input_ids"),o1.forEach(t),qf=i(wh,": (for decoder) "),Ld=a(wh,"CODE",{});var n1=s(Ld);Bf=i(n1,"X [eos, tgt_lang_code]"),n1.forEach(t),wh.forEach(t),Th.forEach(t),$f=l(zn),Gd=a(zn,"P",{});var a1=s(Gd);Ff=i(a1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sy=l(fe),Mc=a(fe,"P",{});var jz=s(Mc);Ay=i(jz,"Finally, this model supports inherent JAX features such as:"),jz.forEach(t),Iy=l(fe),ft=a(fe,"UL",{});var jn=s(ft);wc=a(jn,"LI",{});var Ez=s(wc);ir=a(Ez,"A",{href:!0,rel:!0});var Pz=s(ir);Ny=i(Pz,"Just-In-Time (JIT) compilation"),Pz.forEach(t),Ez.forEach(t),Oy=l(jn),xc=a(jn,"LI",{});var Cz=s(xc);dr=a(Cz,"A",{href:!0,rel:!0});var Sz=s(dr);Dy=i(Sz,"Automatic Differentiation"),Sz.forEach(t),Cz.forEach(t),Ly=l(jn),zc=a(jn,"LI",{});var Az=s(zc);lr=a(Az,"A",{href:!0,rel:!0});var Iz=s(lr);Gy=i(Iz,"Vectorization"),Iz.forEach(t),Az.forEach(t),Wy=l(jn),qc=a(jn,"LI",{});var Nz=s(qc);cr=a(Nz,"A",{href:!0,rel:!0});var Oz=s(cr);Ry=i(Oz,"Parallelization"),Oz.forEach(t),Nz.forEach(t),jn.forEach(t),Uy=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xy=l(Re),$o=a(Re,"P",{});var Ji=s($o);Hy=i(Ji,"The "),Bc=a(Ji,"CODE",{});var Dz=s(Bc);Vy=i(Dz,"FlaxMBartPreTrainedModel"),Dz.forEach(t),Qy=i(Ji,"forward method, overrides the "),$c=a(Ji,"CODE",{});var Lz=s($c);Jy=i(Lz,"__call__"),Lz.forEach(t),Ky=i(Ji," special method."),Ji.forEach(t),Zy=l(Re),f(kn.$$.fragment,Re),Yy=l(Re),Fc=a(Re,"P",{});var Gz=s(Fc);eT=i(Gz,"Summarization example:"),Gz.forEach(t),tT=l(Re),f(hr.$$.fragment,Re),oT=l(Re),jc=a(Re,"P",{});var Wz=s(jc);nT=i(Wz,"Mask filling example:"),Wz.forEach(t),aT=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),sT=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),rT=l(Ki),Ec=a(Ki,"P",{});var Rz=s(Ec);iT=i(Rz,"Example:"),Rz.forEach(t),dT=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),lT=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),cT=l(Zi),Pc=a(Zi,"P",{});var Uz=s(Pc);pT=i(Uz,"Example:"),Uz.forEach(t),hT=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(o),Fo=a(o,"H2",{class:!0});var zu=s(Fo);bn=a(zu,"A",{id:!0,class:!0,href:!0});var Xz=s(bn);Cc=a(Xz,"SPAN",{});var Hz=s(Cc);f(kr.$$.fragment,Hz),Hz.forEach(t),Xz.forEach(t),uT=l(zu),Sc=a(zu,"SPAN",{});var Vz=s(Sc);mT=i(Vz,"FlaxMBartForSequenceClassification"),Vz.forEach(t),zu.forEach(t),ih=l(o),I=a(o,"DIV",{class:!0});var oe=s(I);f(br.$$.fragment,oe),fT=l(oe),Ac=a(oe,"P",{});var Qz=s(Ac);_T=i(Qz,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Qz.forEach(t),gT=l(oe),vr=a(oe,"P",{});var qu=s(vr);kT=i(qu,"This model inherits from "),Fi=a(qu,"A",{href:!0});var Jz=s(Fi);bT=i(Jz,"FlaxPreTrainedModel"),Jz.forEach(t),vT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
