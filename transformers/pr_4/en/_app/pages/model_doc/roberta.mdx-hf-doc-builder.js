...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u1=h(bt),dh=s(bt,"P",{});var dR=a(dh);g1=i(dR,"Finally, this model supports inherent JAX features such as:"),dR.forEach(t),_1=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cR=a(ch);Hi=s(cR,"A",{href:!0,rel:!0});var pR=a(Hi);b1=i(pR,"Just-In-Time (JIT) compilation"),pR.forEach(t),cR.forEach(t),k1=h(ca),ph=s(ca,"LI",{});var hR=a(ph);Qi=s(hR,"A",{href:!0,rel:!0});var mR=a(Qi);v1=i(mR,"Automatic Differentiation"),mR.forEach(t),hR.forEach(t),T1=h(ca),hh=s(ca,"LI",{});var fR=a(hh);Ji=s(fR,"A",{href:!0,rel:!0});var uR=a(Ji);y1=i(uR,"Vectorization"),uR.forEach(t),fR.forEach(t),w1=h(ca),mh=s(ca,"LI",{});var gR=a(mh);Vi=s(gR,"A",{href:!0,rel:!0});var _R=a(Vi);$1=i(_R,"Parallelization"),_R.forEach(t),gR.forEach(t),ca.forEach(t),F1=h(bt),Ct=s(bt,"DIV",{class:!0});var pa=a(Ct);y(Ki.$$.fragment,pa),x1=h(pa),nn=s(pa,"P",{});var rc=a(nn);R1=i(rc,"The "),fh=s(rc,"CODE",{});var bR=a(fh);M1=i(bR,"FlaxRobertaPreTrainedModel"),bR.forEach(t),E1=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kR=a(uh);z1=i(kR,"__call__"),kR.forEach(t),q1=i(rc," special method."),rc.forEach(t),C1=h(pa),y(Ds.$$.fragment,pa),j1=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),Cf=h(o),sn=s(o,"H2",{class:!0});var Ju=a(sn);Ws=s(Ju,"A",{id:!0,class:!0,href:!0});var vR=a(Ws);gh=s(vR,"SPAN",{});var TR=a(gh);y(Gi.$$.fragment,TR),TR.forEach(t),vR.forEach(t),P1=h(Ju),_h=s(Ju,"SPAN",{});var yR=a(_h);L1=i(yR,"FlaxRobertaForSequenceClassification"),yR.forEach(t),Ju.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A1=h(kt),bh=s(kt,"P",{});var wR=a(bh);O1=i(wR,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wR.forEach(t),N1=h(kt),Yi=s(kt,"P",{});var Vu=a(Yi);I1=i(Vu,"This model inherits from "),Ld=s(Vu,"A",{href:!0});var $R=a(Ld);D1=i($R,"FlaxPreTrainedModel"),$R.forEach(t),S1=i(Vu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vu.forEach(t),W1=h(kt),Zi=s(kt,"P",{});var Ku=a(Zi);B1=i(Ku,"This model is also a Flax Linen "),el=s(Ku,"A",{href:!0,rel:!0});var FR=a(el);U1=i(FR,"flax.linen.Module"),FR.forEach(t),H1=i(Ku,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q1=h(kt),kh=s(kt,"P",{});var xR=a(kh);J1=i(xR,"Finally, this model supports inherent JAX features such as:"),xR.forEach(t),V1=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RR=a(vh);tl=s(RR,"A",{href:!0,rel:!0});var MR=a(tl);K1=i(MR,"Just-In-Time (JIT) compilation"),MR.forEach(t),RR.forEach(t),G1=h(ha),Th=s(ha,"LI",{});var ER=a(Th);ol=s(ER,"A",{href:!0,rel:!0});var zR=a(ol);X1=i(zR,"Automatic Differentiation"),zR.forEach(t),ER.forEach(t),Y1=h(ha),yh=s(ha,"LI",{});var qR=a(yh);nl=s(qR,"A",{href:!0,rel:!0});var CR=a(nl);Z1=i(CR,"Vectorization"),CR.forEach(t),qR.forEach(t),e2=h(ha),wh=s(ha,"LI",{});var jR=a(wh);sl=s(jR,"A",{href:!0,rel:!0});var PR=a(sl);t2=i(PR,"Parallelization"),PR.forEach(t),jR.forEach(t),ha.forEach(t),o2=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);y(al.$$.fragment,ma),n2=h(ma),an=s(ma,"P",{});var ic=a(an);s2=i(ic,"The "),$h=s(ic,"CODE",{});var LR=a($h);a2=i(LR,"FlaxRobertaPreTrainedModel"),LR.forEach(t),r2=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AR=a(Fh);i2=i(AR,"__call__"),AR.forEach(t),l2=i(ic," special method."),ic.forEach(t),d2=h(ma),y(Bs.$$.fragment,ma),c2=h(ma),y(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OR=a(Hs);xh=s(OR,"SPAN",{});var NR=a(xh);y(rl.$$.fragment,NR),NR.forEach(t),OR.forEach(t),p2=h(Gu),Rh=s(Gu,"SPAN",{});var IR=a(Rh);h2=i(IR,"FlaxRobertaForMultipleChoice"),IR.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);y(il.$$.fragment,vt),m2=h(vt),Mh=s(vt,"P",{});var DR=a(Mh);f2=i(DR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
