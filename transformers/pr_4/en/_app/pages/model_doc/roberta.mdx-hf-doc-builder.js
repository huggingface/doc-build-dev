...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=p(),Zp=n("p"),O$=r("Finally, this model supports inherent JAX features such as:"),N$=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),I$=r("Just-In-Time (JIT) compilation"),D$=p(),th=n("li"),Li=n("a"),S$=r("Automatic Differentiation"),W$=p(),oh=n("li"),Ai=n("a"),B$=r("Vectorization"),U$=p(),nh=n("li"),Oi=n("a"),H$=r("Parallelization"),Q$=p(),Ct=n("div"),T(Ni.$$.fragment),V$=p(),tn=n("p"),J$=r("The "),sh=n("code"),K$=r("FlaxRobertaPreTrainedModel"),G$=r(" forward method, overrides the "),ah=n("code"),X$=r("__call__"),Y$=r(" special method."),Z$=p(),T(Os.$$.fragment),e1=p(),T(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),T(Ii.$$.fragment),t1=p(),ih=n("span"),o1=r("FlaxRobertaForMaskedLM"),Cf=p(),Ie=n("div"),T(Di.$$.fragment),n1=p(),Si=n("p"),s1=r("RoBERTa Model with a "),lh=n("code"),a1=r("language modeling"),r1=r(" head on top."),i1=p(),Wi=n("p"),l1=r("This model inherits from "),Pd=n("a"),d1=r("FlaxPreTrainedModel"),c1=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),u1=p(),dh=n("p"),g1=r("Finally, this model supports inherent JAX features such as:"),_1=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),b1=r("Just-In-Time (JIT) compilation"),k1=p(),ph=n("li"),Qi=n("a"),v1=r("Automatic Differentiation"),T1=p(),hh=n("li"),Vi=n("a"),y1=r("Vectorization"),w1=p(),mh=n("li"),Ji=n("a"),$1=r("Parallelization"),F1=p(),qt=n("div"),T(Ki.$$.fragment),x1=p(),nn=n("p"),R1=r("The "),fh=n("code"),M1=r("FlaxRobertaPreTrainedModel"),E1=r(" forward method, overrides the "),uh=n("code"),z1=r("__call__"),C1=r(" special method."),q1=p(),T(Ds.$$.fragment),j1=p(),T(Ss.$$.fragment),qf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),T(Gi.$$.fragment),P1=p(),_h=n("span"),L1=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),T(Xi.$$.fragment),A1=p(),bh=n("p"),O1=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u1=h(bt),dh=s(bt,"P",{});var dR=a(dh);g1=i(dR,"Finally, this model supports inherent JAX features such as:"),dR.forEach(t),_1=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cR=a(ch);Hi=s(cR,"A",{href:!0,rel:!0});var pR=a(Hi);b1=i(pR,"Just-In-Time (JIT) compilation"),pR.forEach(t),cR.forEach(t),k1=h(ca),ph=s(ca,"LI",{});var hR=a(ph);Qi=s(hR,"A",{href:!0,rel:!0});var mR=a(Qi);v1=i(mR,"Automatic Differentiation"),mR.forEach(t),hR.forEach(t),T1=h(ca),hh=s(ca,"LI",{});var fR=a(hh);Vi=s(fR,"A",{href:!0,rel:!0});var uR=a(Vi);y1=i(uR,"Vectorization"),uR.forEach(t),fR.forEach(t),w1=h(ca),mh=s(ca,"LI",{});var gR=a(mh);Ji=s(gR,"A",{href:!0,rel:!0});var _R=a(Ji);$1=i(_R,"Parallelization"),_R.forEach(t),gR.forEach(t),ca.forEach(t),F1=h(bt),qt=s(bt,"DIV",{class:!0});var pa=a(qt);y(Ki.$$.fragment,pa),x1=h(pa),nn=s(pa,"P",{});var rc=a(nn);R1=i(rc,"The "),fh=s(rc,"CODE",{});var bR=a(fh);M1=i(bR,"FlaxRobertaPreTrainedModel"),bR.forEach(t),E1=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kR=a(uh);z1=i(kR,"__call__"),kR.forEach(t),C1=i(rc," special method."),rc.forEach(t),q1=h(pa),y(Ds.$$.fragment,pa),j1=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qf=h(o),sn=s(o,"H2",{class:!0});var Vu=a(sn);Ws=s(Vu,"A",{id:!0,class:!0,href:!0});var vR=a(Ws);gh=s(vR,"SPAN",{});var TR=a(gh);y(Gi.$$.fragment,TR),TR.forEach(t),vR.forEach(t),P1=h(Vu),_h=s(Vu,"SPAN",{});var yR=a(_h);L1=i(yR,"FlaxRobertaForSequenceClassification"),yR.forEach(t),Vu.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A1=h(kt),bh=s(kt,"P",{});var wR=a(bh);O1=i(wR,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
