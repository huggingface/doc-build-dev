...
`}}),As=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.RobertaTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/tokenization_roberta.py#L365",parametersDescription:[{anchor:"transformers.RobertaTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),or=new ye({}),nr=new j({props:{name:"class transformers.RobertaForCausalLM",anchor:"transformers.RobertaForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_roberta.py#L882",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lr=new j({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_roberta.py#L908",parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),br=new ye({}),kr=new j({props:{name:"class transformers.RobertaForSequenceClassification",anchor:"transformers.RobertaForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_roberta.py#L1163",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wr=new j({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_roberta.py#L1177",parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),Rr=new ye({}),Mr=new j({props:{name:"class transformers.RobertaForMultipleChoice",anchor:"transformers.RobertaForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_roberta.py#L1261",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),qr=new j({props:{name:"forward",anchor:"transformers.RobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_roberta.py#L1274",parametersDescription:[{anchor:"transformers.RobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithCrossAttentions"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),sa=new ye({}),ra=new j({props:{name:"class transformers.TFRobertaForMaskedLM",anchor:"transformers.TFRobertaForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1055",parametersDescription:[{anchor:"transformers.TFRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qn=new fe({props:{$$slots:{default:[zE]},$$scope:{ctx:q}}}),ca=new j({props:{name:"call",anchor:"transformers.TFRobertaForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1072",parametersDescription:[{anchor:"transformers.TFRobertaForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ha=new ye({}),ua=new j({props:{name:"class transformers.TFRobertaForSequenceClassification",anchor:"transformers.TFRobertaForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1319",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Kn=new fe({props:{$$slots:{default:[qE]},$$scope:{ctx:q}}}),_a=new j({props:{name:"call",anchor:"transformers.TFRobertaForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1330",parametersDescription:[{anchor:"transformers.TFRobertaForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),ka=new ye({}),Ta=new j({props:{name:"class transformers.TFRobertaForMultipleChoice",anchor:"transformers.TFRobertaForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1402",parametersDescription:[{anchor:"transformers.TFRobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Yn=new fe({props:{$$slots:{default:[PE]},$$scope:{ctx:q}}}),$a=new j({props:{name:"call",anchor:"transformers.TFRobertaForMultipleChoice.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",parametersDescription:[{anchor:"transformers.TFRobertaForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ra=new ye({}),Ma=new j({props:{name:"class transformers.TFRobertaForTokenClassification",anchor:"transformers.TFRobertaForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1524",parametersDescription:[{anchor:"transformers.TFRobertaForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ts=new fe({props:{$$slots:{default:[LE]},$$scope:{ctx:q}}}),qa=new j({props:{name:"call",anchor:"transformers.TFRobertaForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1542",parametersDescription:[{anchor:"transformers.TFRobertaForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
layers on top of the hidden-states output to compute `),lp=n("code"),Jv=a("span start logits"),Kv=a(" and "),dp=n("code"),Gv=a("span end logits"),Xv=a(")."),Yv=l(),La=n("p"),Zv=a("This model inherits from "),Dl=n("a"),ew=a("TFPreTrainedModel"),tw=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ow=l(),Aa=n("p"),nw=a("This model is also a "),Oa=n("a"),sw=a("tf.keras.Model"),rw=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),aw=l(),T(ss.$$.fragment),iw=l(),gt=n("div"),T(Na.$$.fragment),lw=l(),on=n("p"),dw=a("The "),Sl=n("a"),cw=a("TFRobertaForQuestionAnswering"),pw=a(" forward method, overrides the "),cp=n("code"),hw=a("__call__"),uw=a(" special method."),fw=l(),T(rs.$$.fragment),mw=l(),pp=n("p"),gw=a("Example:"),_w=l(),T(Ia.$$.fragment),Mu=l(),nn=n("h2"),as=n("a"),hp=n("span"),T(Da.$$.fragment),bw=l(),up=n("span"),kw=a("FlaxRobertaModel"),Eu=l(),Le=n("div"),T(Sa.$$.fragment),Tw=l(),fp=n("p"),yw=a("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),vw=l(),Wa=n("p"),ww=a("This model inherits from "),Wl=n("a"),$w=a("FlaxPreTrainedModel"),Fw=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Rw=l(),Ba=n("p"),Mw=a("This model is also a Flax Linen "),Ua=n("a"),Ew=a("flax.linen.Module"),zw=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),xw=l(),mp=n("p"),qw=a("Finally, this model supports inherent JAX features such as:"),Cw=l(),Nt=n("ul"),gp=n("li"),Ha=n("a"),Pw=a("Just-In-Time (JIT) compilation"),jw=l(),_p=n("li"),Qa=n("a"),Lw=a("Automatic Differentiation"),Aw=l(),bp=n("li"),Va=n("a"),Ow=a("Vectorization"),Nw=l(),kp=n("li"),Ja=n("a"),Iw=a("Parallelization"),Dw=l(),_t=n("div"),T(Ka.$$.fragment),Sw=l(),sn=n("p"),Ww=a("The "),Tp=n("code"),Bw=a("FlaxRobertaPreTrainedModel"),Uw=a("forward method, overrides the "),yp=n("code"),Hw=a("__call__"),Qw=a(" special method."),Vw=l(),T(is.$$.fragment),Jw=l(),vp=n("p"),Kw=a("Example:"),Gw=l(),T(Ga.$$.fragment),zu=l(),rn=n("h2"),ls=n("a"),wp=n("span"),T(Xa.$$.fragment),Xw=l(),$p=n("span"),Yw=a("FlaxRobertaForMaskedLM"),xu=l(),Ae=n("div"),T(Ya.$$.fragment),Zw=l(),Za=n("p"),e1=a("RoBERTa Model with a "),Fp=n("code"),t1=a("language modeling"),o1=a(" head on top."),n1=l(),ei=n("p"),s1=a("This model inherits from "),Bl=n("a"),r1=a("FlaxPreTrainedModel"),a1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),i1=l(),ti=n("p"),l1=a("This model is also a Flax Linen "),oi=n("a"),d1=a("flax.linen.Module"),c1=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),p1=l(),Rp=n("p"),h1=a("Finally, this model supports inherent JAX features such as:"),u1=l(),It=n("ul"),Mp=n("li"),ni=n("a"),f1=a("Just-In-Time (JIT) compilation"),m1=l(),Ep=n("li"),si=n("a"),g1=a("Automatic Differentiation"),_1=l(),zp=n("li"),ri=n("a"),b1=a("Vectorization"),k1=l(),xp=n("li"),ai=n("a"),T1=a("Parallelization"),y1=l(),bt=n("div"),T(ii.$$.fragment),v1=l(),an=n("p"),w1=a("The "),qp=n("code"),$1=a("FlaxRobertaPreTrainedModel"),F1=a("forward method, overrides the "),Cp=n("code"),R1=a("__call__"),M1=a(" special method."),E1=l(),T(ds.$$.fragment),z1=l(),Pp=n("p"),x1=a("Example:"),q1=l(),T(li.$$.fragment),qu=l(),ln=n("h2"),cs=n("a"),jp=n("span"),T(di.$$.fragment),C1=l(),Lp=n("span"),P1=a("FlaxRobertaForSequenceClassification"),Cu=l(),Oe=n("div"),T(ci.$$.fragment),j1=l(),Ap=n("p"),L1=a(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),A1=l(),pi=n("p"),O1=a("This model inherits from "),Ul=n("a"),N1=a("FlaxPreTrainedModel"),I1=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),D1=l(),hi=n("p"),S1=a("This model is also a Flax Linen "),ui=n("a"),W1=a("flax.linen.Module"),B1=a(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),U1=l(),Op=n("p"),H1=a("Finally, this model supports inherent JAX features such as:"),Q1=l(),Dt=n("ul"),Np=n("li"),fi=n("a"),V1=a("Just-In-Time (JIT) compilation"),J1=l(),Ip=n("li"),mi=n("a"),K1=a("Automatic Differentiation"),G1=l(),Dp=n("li"),gi=n("a"),X1=a("Vectorization"),Y1=l(),Sp=n("li"),_i=n("a"),Z1=a("Parallelization"),e$=l(),kt=n("div"),T(bi.$$.fragment),t$=l(),dn=n("p"),o$=a("The "),Wp=n("code"),n$=a("FlaxRobertaPreTrainedModel"),s$=a("forward method, overrides the "),Bp=n("code"),r$=a("__call__"),a$=a(" special method."),i$=l(),T(ps.$$.fragment),l$=l(),Up=n("p"),d$=a("Example:"),c$=l(),T(ki.$$.fragment),Pu=l(),cn=n("h2"),hs=n("a"),Hp=n("span"),T(Ti.$$.fragment),p$=l(),Qp=n("span"),h$=a("FlaxRobertaForMultipleChoice"),ju=l(),Ne=n("div"),T(yi.$$.fragment),u$=l(),Vp=n("p"),f$=a(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
layers on top of the hidden-states output to compute `),lp=s(ud,"CODE",{});var rR=r(lp);Jv=i(rR,"span start logits"),rR.forEach(t),Kv=i(ud," and "),dp=s(ud,"CODE",{});var aR=r(dp);Gv=i(aR,"span end logits"),aR.forEach(t),Xv=i(ud,")."),ud.forEach(t),Yv=d(Ot),La=s(Ot,"P",{});var Wf=r(La);Zv=i(Wf,"This model inherits from "),Dl=s(Wf,"A",{href:!0});var iR=r(Dl);ew=i(iR,"TFPreTrainedModel"),iR.forEach(t),tw=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),ow=d(Ot),Aa=s(Ot,"P",{});var Bf=r(Aa);nw=i(Bf,"This model is also a "),Oa=s(Bf,"A",{href:!0,rel:!0});var lR=r(Oa);sw=i(lR,"tf.keras.Model"),lR.forEach(t),rw=i(Bf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),aw=d(Ot),y(ss.$$.fragment,Ot),iw=d(Ot),gt=s(Ot,"DIV",{class:!0});var uo=r(gt);y(Na.$$.fragment,uo),lw=d(uo),on=s(uo,"P",{});var fd=r(on);dw=i(fd,"The "),Sl=s(fd,"A",{href:!0});var dR=r(Sl);cw=i(dR,"TFRobertaForQuestionAnswering"),dR.forEach(t),pw=i(fd," forward method, overrides the "),cp=s(fd,"CODE",{});var cR=r(cp);hw=i(cR,"__call__"),cR.forEach(t),uw=i(fd," special method."),fd.forEach(t),fw=d(uo),y(rs.$$.fragment,uo),mw=d(uo),pp=s(uo,"P",{});var pR=r(pp);gw=i(pR,"Example:"),pR.forEach(t),_w=d(uo),y(Ia.$$.fragment,uo),uo.forEach(t),Ot.forEach(t),Mu=d(o),nn=s(o,"H2",{class:!0});var Uf=r(nn);as=s(Uf,"A",{id:!0,class:!0,href:!0});var hR=r(as);hp=s(hR,"SPAN",{});var uR=r(hp);y(Da.$$.fragment,uR),uR.forEach(t),hR.forEach(t),bw=d(Uf),up=s(Uf,"SPAN",{});var fR=r(up);kw=i(fR,"FlaxRobertaModel"),fR.forEach(t),Uf.forEach(t),Eu=d(o),Le=s(o,"DIV",{class:!0});var Ft=r(Le);y(Sa.$$.fragment,Ft),Tw=d(Ft),fp=s(Ft,"P",{});var mR=r(fp);yw=i(mR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),mR.forEach(t),vw=d(Ft),Wa=s(Ft,"P",{});var Hf=r(Wa);ww=i(Hf,"This model inherits from "),Wl=s(Hf,"A",{href:!0});var gR=r(Wl);$w=i(gR,"FlaxPreTrainedModel"),gR.forEach(t),Fw=i(Hf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hf.forEach(t),Rw=d(Ft),Ba=s(Ft,"P",{});var Qf=r(Ba);Mw=i(Qf,"This model is also a Flax Linen "),Ua=s(Qf,"A",{href:!0,rel:!0});var _R=r(Ua);Ew=i(_R,"flax.linen.Module"),_R.forEach(t),zw=i(Qf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qf.forEach(t),xw=d(Ft),mp=s(Ft,"P",{});var bR=r(mp);qw=i(bR,"Finally, this model supports inherent JAX features such as:"),bR.forEach(t),Cw=d(Ft),Nt=s(Ft,"UL",{});var bs=r(Nt);gp=s(bs,"LI",{});var kR=r(gp);Ha=s(kR,"A",{href:!0,rel:!0});var TR=r(Ha);Pw=i(TR,"Just-In-Time (JIT) compilation"),TR.forEach(t),kR.forEach(t),jw=d(bs),_p=s(bs,"LI",{});var yR=r(_p);Qa=s(yR,"A",{href:!0,rel:!0});var vR=r(Qa);Lw=i(vR,"Automatic Differentiation"),vR.forEach(t),yR.forEach(t),Aw=d(bs),bp=s(bs,"LI",{});var wR=r(bp);Va=s(wR,"A",{href:!0,rel:!0});var $R=r(Va);Ow=i($R,"Vectorization"),$R.forEach(t),wR.forEach(t),Nw=d(bs),kp=s(bs,"LI",{});var FR=r(kp);Ja=s(FR,"A",{href:!0,rel:!0});var RR=r(Ja);Iw=i(RR,"Parallelization"),RR.forEach(t),FR.forEach(t),bs.forEach(t),Dw=d(Ft),_t=s(Ft,"DIV",{class:!0});var fo=r(_t);y(Ka.$$.fragment,fo),Sw=d(fo),sn=s(fo,"P",{});var md=r(sn);Ww=i(md,"The "),Tp=s(md,"CODE",{});var MR=r(Tp);Bw=i(MR,"FlaxRobertaPreTrainedModel"),MR.forEach(t),Uw=i(md,"forward method, overrides the "),yp=s(md,"CODE",{});var ER=r(yp);Hw=i(ER,"__call__"),ER.forEach(t),Qw=i(md," special method."),md.forEach(t),Vw=d(fo),y(is.$$.fragment,fo),Jw=d(fo),vp=s(fo,"P",{});var zR=r(vp);Kw=i(zR,"Example:"),zR.forEach(t),Gw=d(fo),y(Ga.$$.fragment,fo),fo.forEach(t),Ft.forEach(t),zu=d(o),rn=s(o,"H2",{class:!0});var Vf=r(rn);ls=s(Vf,"A",{id:!0,class:!0,href:!0});var xR=r(ls);wp=s(xR,"SPAN",{});var qR=r(wp);y(Xa.$$.fragment,qR),qR.forEach(t),xR.forEach(t),Xw=d(Vf),$p=s(Vf,"SPAN",{});var CR=r($p);Yw=i(CR,"FlaxRobertaForMaskedLM"),CR.forEach(t),Vf.forEach(t),xu=d(o),Ae=s(o,"DIV",{class:!0});var Rt=r(Ae);y(Ya.$$.fragment,Rt),Zw=d(Rt),Za=s(Rt,"P",{});var Jf=r(Za);e1=i(Jf,"RoBERTa Model with a "),Fp=s(Jf,"CODE",{});var PR=r(Fp);t1=i(PR,"language modeling"),PR.forEach(t),o1=i(Jf," head on top."),Jf.forEach(t),n1=d(Rt),ei=s(Rt,"P",{});var Kf=r(ei);s1=i(Kf,"This model inherits from "),Bl=s(Kf,"A",{href:!0});var jR=r(Bl);r1=i(jR,"FlaxPreTrainedModel"),jR.forEach(t),a1=i(Kf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Kf.forEach(t),i1=d(Rt),ti=s(Rt,"P",{});var Gf=r(ti);l1=i(Gf,"This model is also a Flax Linen "),oi=s(Gf,"A",{href:!0,rel:!0});var LR=r(oi);d1=i(LR,"flax.linen.Module"),LR.forEach(t),c1=i(Gf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Gf.forEach(t),p1=d(Rt),Rp=s(Rt,"P",{});var AR=r(Rp);h1=i(AR,"Finally, this model supports inherent JAX features such as:"),AR.forEach(t),u1=d(Rt),It=s(Rt,"UL",{});var ks=r(It);Mp=s(ks,"LI",{});var OR=r(Mp);ni=s(OR,"A",{href:!0,rel:!0});var NR=r(ni);f1=i(NR,"Just-In-Time (JIT) compilation"),NR.forEach(t),OR.forEach(t),m1=d(ks),Ep=s(ks,"LI",{});var IR=r(Ep);si=s(IR,"A",{href:!0,rel:!0});var DR=r(si);g1=i(DR,"Automatic Differentiation"),DR.forEach(t),IR.forEach(t),_1=d(ks),zp=s(ks,"LI",{});var SR=r(zp);ri=s(SR,"A",{href:!0,rel:!0});var WR=r(ri);b1=i(WR,"Vectorization"),WR.forEach(t),SR.forEach(t),k1=d(ks),xp=s(ks,"LI",{});var BR=r(xp);ai=s(BR,"A",{href:!0,rel:!0});var UR=r(ai);T1=i(UR,"Parallelization"),UR.forEach(t),BR.forEach(t),ks.forEach(t),y1=d(Rt),bt=s(Rt,"DIV",{class:!0});var mo=r(bt);y(ii.$$.fragment,mo),v1=d(mo),an=s(mo,"P",{});var gd=r(an);w1=i(gd,"The "),qp=s(gd,"CODE",{});var HR=r(qp);$1=i(HR,"FlaxRobertaPreTrainedModel"),HR.forEach(t),F1=i(gd,"forward method, overrides the "),Cp=s(gd,"CODE",{});var QR=r(Cp);R1=i(QR,"__call__"),QR.forEach(t),M1=i(gd," special method."),gd.forEach(t),E1=d(mo),y(ds.$$.fragment,mo),z1=d(mo),Pp=s(mo,"P",{});var VR=r(Pp);x1=i(VR,"Example:"),VR.forEach(t),q1=d(mo),y(li.$$.fragment,mo),mo.forEach(t),Rt.forEach(t),qu=d(o),ln=s(o,"H2",{class:!0});var Xf=r(ln);cs=s(Xf,"A",{id:!0,class:!0,href:!0});var JR=r(cs);jp=s(JR,"SPAN",{});var KR=r(jp);y(di.$$.fragment,KR),KR.forEach(t),JR.forEach(t),C1=d(Xf),Lp=s(Xf,"SPAN",{});var GR=r(Lp);P1=i(GR,"FlaxRobertaForSequenceClassification"),GR.forEach(t),Xf.forEach(t),Cu=d(o),Oe=s(o,"DIV",{class:!0});var Mt=r(Oe);y(ci.$$.fragment,Mt),j1=d(Mt),Ap=s(Mt,"P",{});var XR=r(Ap);L1=i(XR,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),XR.forEach(t),A1=d(Mt),pi=s(Mt,"P",{});var Yf=r(pi);O1=i(Yf,"This model inherits from "),Ul=s(Yf,"A",{href:!0});var YR=r(Ul);N1=i(YR,"FlaxPreTrainedModel"),YR.forEach(t),I1=i(Yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Yf.forEach(t),D1=d(Mt),hi=s(Mt,"P",{});var Zf=r(hi);S1=i(Zf,"This model is also a Flax Linen "),ui=s(Zf,"A",{href:!0,rel:!0});var ZR=r(ui);W1=i(ZR,"flax.linen.Module"),ZR.forEach(t),B1=i(Zf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zf.forEach(t),U1=d(Mt),Op=s(Mt,"P",{});var eM=r(Op);H1=i(eM,"Finally, this model supports inherent JAX features such as:"),eM.forEach(t),Q1=d(Mt),Dt=s(Mt,"UL",{});var Ts=r(Dt);Np=s(Ts,"LI",{});var tM=r(Np);fi=s(tM,"A",{href:!0,rel:!0});var oM=r(fi);V1=i(oM,"Just-In-Time (JIT) compilation"),oM.forEach(t),tM.forEach(t),J1=d(Ts),Ip=s(Ts,"LI",{});var nM=r(Ip);mi=s(nM,"A",{href:!0,rel:!0});var sM=r(mi);K1=i(sM,"Automatic Differentiation"),sM.forEach(t),nM.forEach(t),G1=d(Ts),Dp=s(Ts,"LI",{});var rM=r(Dp);gi=s(rM,"A",{href:!0,rel:!0});var aM=r(gi);X1=i(aM,"Vectorization"),aM.forEach(t),rM.forEach(t),Y1=d(Ts),Sp=s(Ts,"LI",{});var iM=r(Sp);_i=s(iM,"A",{href:!0,rel:!0});var lM=r(_i);Z1=i(lM,"Parallelization"),lM.forEach(t),iM.forEach(t),Ts.forEach(t),e$=d(Mt),kt=s(Mt,"DIV",{class:!0});var go=r(kt);y(bi.$$.fragment,go),t$=d(go),dn=s(go,"P",{});var _d=r(dn);o$=i(_d,"The "),Wp=s(_d,"CODE",{});var dM=r(Wp);n$=i(dM,"FlaxRobertaPreTrainedModel"),dM.forEach(t),s$=i(_d,"forward method, overrides the "),Bp=s(_d,"CODE",{});var cM=r(Bp);r$=i(cM,"__call__"),cM.forEach(t),a$=i(_d," special method."),_d.forEach(t),i$=d(go),y(ps.$$.fragment,go),l$=d(go),Up=s(go,"P",{});var pM=r(Up);d$=i(pM,"Example:"),pM.forEach(t),c$=d(go),y(ki.$$.fragment,go),go.forEach(t),Mt.forEach(t),Pu=d(o),cn=s(o,"H2",{class:!0});var em=r(cn);hs=s(em,"A",{id:!0,class:!0,href:!0});var hM=r(hs);Hp=s(hM,"SPAN",{});var uM=r(Hp);y(Ti.$$.fragment,uM),uM.forEach(t),hM.forEach(t),p$=d(em),Qp=s(em,"SPAN",{});var fM=r(Qp);h$=i(fM,"FlaxRobertaForMultipleChoice"),fM.forEach(t),em.forEach(t),ju=d(o),Ne=s(o,"DIV",{class:!0});var Et=r(Ne);y(yi.$$.fragment,Et),u$=d(Et),Vp=s(Et,"P",{});var mM=r(Vp);f$=i(mM,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
