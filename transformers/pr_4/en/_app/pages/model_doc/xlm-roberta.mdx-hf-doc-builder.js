...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ta=new X({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),oa=new Me({}),na=new X({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),Ua=new X({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),fi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),Vi=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),ys=new $e({props:{$$slots:{default:[q4]},$$scope:{ctx:x}}}),ws=new ie({props:{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.example",$$slots:{default:[C4]},$$scope:{ctx:x}}}),Ji=new Me({}),Ki=new X({props:{name:"class transformers.FlaxXLMRobertaForQuestionAnswering",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_4/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_4/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),al=new X({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
alongside usage examples.`),GT=c(),xt=n("div"),T(jr.$$.fragment),YT=c(),Co=n("p"),ZT=r("The "),cd=n("a"),ey=r("TFRobertaForMultipleChoice"),ty=r(" forward method, overrides the "),ap=n("code"),oy=r("__call__"),ny=r(" special method."),sy=c(),T(Gn.$$.fragment),ay=c(),T(Yn.$$.fragment),Rm=c(),jo=n("h2"),Zn=n("a"),rp=n("span"),T(Xr.$$.fragment),ry=c(),ip=n("span"),iy=r("TFXLMRobertaForTokenClassification"),Lm=c(),Se=n("div"),T(Pr.$$.fragment),ly=c(),lp=n("p"),dy=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),cy=c(),Ar=n("p"),py=r("This model inherits from "),pd=n("a"),hy=r("TFPreTrainedModel"),my=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uy=c(),Or=n("p"),fy=r("This model is also a "),Nr=n("a"),gy=r("tf.keras.Model"),_y=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),by=c(),T(es.$$.fragment),ky=c(),Ir=n("p"),vy=r("This class overrides "),hd=n("a"),Ty=r("TFRobertaForTokenClassification"),yy=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),wy=c(),pt=n("div"),T(Dr.$$.fragment),$y=c(),Xo=n("p"),My=r("The "),md=n("a"),Fy=r("TFRobertaForTokenClassification"),xy=r(" forward method, overrides the "),dp=n("code"),Ry=r("__call__"),Ly=r(" special method."),Ey=c(),T(ts.$$.fragment),zy=c(),T(os.$$.fragment),qy=c(),T(ns.$$.fragment),Em=c(),Po=n("h2"),ss=n("a"),cp=n("span"),T(Sr.$$.fragment),Cy=c(),pp=n("span"),jy=r("TFXLMRobertaForQuestionAnswering"),zm=c(),We=n("div"),T(Wr.$$.fragment),Xy=c(),Ao=n("p"),Py=r(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=n("code"),Ay=r("span start logits"),Oy=r(" and "),mp=n("code"),Ny=r("span end logits"),Iy=r(")."),Dy=c(),Br=n("p"),Sy=r("This model inherits from "),ud=n("a"),Wy=r("TFPreTrainedModel"),By=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uy=c(),Ur=n("p"),Qy=r("This model is also a "),Qr=n("a"),Hy=r("tf.keras.Model"),Vy=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jy=c(),T(as.$$.fragment),Ky=c(),Hr=n("p"),Gy=r("This class overrides "),up=n("code"),Yy=r("TFRobertaForQuestionAnsweringSimple"),Zy=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),ew=c(),ht=n("div"),T(Vr.$$.fragment),tw=c(),Oo=n("p"),ow=r("The "),fd=n("a"),nw=r("TFRobertaForQuestionAnswering"),sw=r(" forward method, overrides the "),fp=n("code"),aw=r("__call__"),rw=r(" special method."),iw=c(),T(rs.$$.fragment),lw=c(),T(is.$$.fragment),dw=c(),T(ls.$$.fragment),qm=c(),No=n("h2"),ds=n("a"),gp=n("span"),T(Jr.$$.fragment),cw=c(),_p=n("span"),pw=r("FlaxXLMRobertaModel"),Cm=c(),Be=n("div"),T(Kr.$$.fragment),hw=c(),Gr=n("p"),mw=r(`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=n("a"),uw=r("FlaxPreTrainedModel"),fw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),gw=c(),Yr=n("p"),_w=r("This model is also a Flax Linen "),Zr=n("a"),bw=r("flax.linen.Module"),kw=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),vw=c(),bp=n("p"),Tw=r("Finally, this model supports inherent JAX features such as:"),yw=c(),St=n("ul"),kp=n("li"),ei=n("a"),ww=r("Just-In-Time (JIT) compilation"),$w=c(),vp=n("li"),ti=n("a"),Mw=r("Automatic Differentiation"),Fw=c(),Tp=n("li"),oi=n("a"),xw=r("Vectorization"),Rw=c(),yp=n("li"),ni=n("a"),Lw=r("Parallelization"),Ew=c(),si=n("p"),zw=r("This class overrides "),_d=n("a"),qw=r("FlaxRobertaModel"),Cw=r(`. Please check the superclass for the appropriate documentation alongside
usage examples.`),jw=c(),Rt=n("div"),T(ai.$$.fragment),Xw=c(),Io=n("p"),Pw=r("The "),wp=n("code"),Aw=r("FlaxRobertaPreTrainedModel"),Ow=r(" forward method, overrides the "),$p=n("code"),Nw=r("__call__"),Iw=r(" special method."),Dw=c(),T(cs.$$.fragment),Sw=c(),T(ps.$$.fragment),jm=c(),Do=n("h2"),hs=n("a"),Mp=n("span"),T(ri.$$.fragment),Ww=c(),Fp=n("span"),Bw=r("FlaxXLMRobertaForMaskedLM"),Xm=c(),Ue=n("div"),T(ii.$$.fragment),Uw=c(),So=n("p"),Qw=r("XLM-RoBERTa Model with a "),xp=n("code"),Hw=r("language modeling"),Vw=r(` head on top.
This model inherits from `),bd=n("a"),Jw=r("FlaxPreTrainedModel"),Kw=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gw=c(),li=n("p"),Yw=r("This model is also a Flax Linen "),di=n("a"),Zw=r("flax.linen.Module"),e$=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t$=c(),Rp=n("p"),o$=r("Finally, this model supports inherent JAX features such as:"),n$=c(),Wt=n("ul"),Lp=n("li"),ci=n("a"),s$=r("Just-In-Time (JIT) compilation"),a$=c(),Ep=n("li"),pi=n("a"),r$=r("Automatic Differentiation"),i$=c(),zp=n("li"),hi=n("a"),l$=r("Vectorization"),d$=c(),qp=n("li"),mi=n("a"),c$=r("Parallelization"),p$=c(),ui=n("p"),h$=r("This class overrides "),kd=n("a"),m$=r("FlaxRobertaForMaskedLM"),u$=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),f$=c(),Lt=n("div"),T(fi.$$.fragment),g$=c(),Wo=n("p"),_$=r("The "),Cp=n("code"),b$=r("FlaxRobertaPreTrainedModel"),k$=r(" forward method, overrides the "),jp=n("code"),v$=r("__call__"),T$=r(" special method."),y$=c(),T(ms.$$.fragment),w$=c(),T(us.$$.fragment),Pm=c(),Bo=n("h2"),fs=n("a"),Xp=n("span"),T(gi.$$.fragment),$$=c(),Pp=n("span"),M$=r("FlaxXLMRobertaForSequenceClassification"),Am=c(),Ce=n("div"),T(_i.$$.fragment),F$=c(),Ap=n("p"),x$=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),R$=c(),bi=n("p"),L$=r("This model inherits from "),vd=n("a"),E$=r("FlaxPreTrainedModel"),z$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),q$=c(),ki=n("p"),C$=r("This model is also a Flax Linen "),vi=n("a"),j$=r("flax.linen.Module"),X$=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P$=c(),Op=n("p"),A$=r("Finally, this model supports inherent JAX features such as:"),O$=c(),Bt=n("ul"),Np=n("li"),Ti=n("a"),N$=r("Just-In-Time (JIT) compilation"),I$=c(),Ip=n("li"),yi=n("a"),D$=r("Automatic Differentiation"),S$=c(),Dp=n("li"),wi=n("a"),W$=r("Vectorization"),B$=c(),Sp=n("li"),$i=n("a"),U$=r("Parallelization"),Q$=c(),Mi=n("p"),H$=r("This class overrides "),Td=n("a"),V$=r("FlaxRobertaForSequenceClassification"),J$=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),K$=c(),Et=n("div"),T(Fi.$$.fragment),G$=c(),Uo=n("p"),Y$=r("The "),Wp=n("code"),Z$=r("FlaxRobertaPreTrainedModel"),e1=r(" forward method, overrides the "),Bp=n("code"),t1=r("__call__"),o1=r(" special method."),n1=c(),T(gs.$$.fragment),s1=c(),T(_s.$$.fragment),Om=c(),Qo=n("h2"),bs=n("a"),Up=n("span"),T(xi.$$.fragment),a1=c(),Qp=n("span"),r1=r("FlaxXLMRobertaForMultipleChoice"),Nm=c(),je=n("div"),T(Ri.$$.fragment),i1=c(),Hp=n("p"),l1=r(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),d1=c(),Li=n("p"),c1=r("This model inherits from "),yd=n("a"),p1=r("FlaxPreTrainedModel"),h1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),m1=c(),Ei=n("p"),u1=r("This model is also a Flax Linen "),zi=n("a"),f1=r("flax.linen.Module"),g1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_1=c(),Vp=n("p"),b1=r("Finally, this model supports inherent JAX features such as:"),k1=c(),Ut=n("ul"),Jp=n("li"),qi=n("a"),v1=r("Just-In-Time (JIT) compilation"),T1=c(),Kp=n("li"),Ci=n("a"),y1=r("Automatic Differentiation"),w1=c(),Gp=n("li"),ji=n("a"),$1=r("Vectorization"),M1=c(),Yp=n("li"),Xi=n("a"),F1=r("Parallelization"),x1=c(),Pi=n("p"),R1=r("This class overrides "),wd=n("a"),L1=r("FlaxRobertaForMultipleChoice"),E1=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),z1=c(),zt=n("div"),T(Ai.$$.fragment),q1=c(),Ho=n("p"),C1=r("The "),Zp=n("code"),j1=r("FlaxRobertaPreTrainedModel"),X1=r(" forward method, overrides the "),eh=n("code"),P1=r("__call__"),A1=r(" special method."),O1=c(),T(ks.$$.fragment),N1=c(),T(vs.$$.fragment),Im=c(),Vo=n("h2"),Ts=n("a"),th=n("span"),T(Oi.$$.fragment),I1=c(),oh=n("span"),D1=r("FlaxXLMRobertaForTokenClassification"),Dm=c(),Xe=n("div"),T(Ni.$$.fragment),S1=c(),nh=n("p"),W1=r(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),B1=c(),Ii=n("p"),U1=r("This model inherits from "),$d=n("a"),Q1=r("FlaxPreTrainedModel"),H1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),V1=c(),Di=n("p"),J1=r("This model is also a Flax Linen "),Si=n("a"),K1=r("flax.linen.Module"),G1=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Y1=c(),sh=n("p"),Z1=r("Finally, this model supports inherent JAX features such as:"),eM=c(),Qt=n("ul"),ah=n("li"),Wi=n("a"),tM=r("Just-In-Time (JIT) compilation"),oM=c(),rh=n("li"),Bi=n("a"),nM=r("Automatic Differentiation"),sM=c(),ih=n("li"),Ui=n("a"),aM=r("Vectorization"),rM=c(),lh=n("li"),Qi=n("a"),iM=r("Parallelization"),lM=c(),Hi=n("p"),dM=r("This class overrides "),Md=n("a"),cM=r("FlaxRobertaForTokenClassification"),pM=r(`. Please check the superclass for the appropriate
...
alongside usage examples.`),Du.forEach(t),GT=p(_t),xt=s(_t,"DIV",{class:!0});var zs=a(xt);y(jr.$$.fragment,zs),YT=p(zs),Co=s(zs,"P",{});var Sd=a(Co);ZT=i(Sd,"The "),cd=s(Sd,"A",{href:!0});var c0=a(cd);ey=i(c0,"TFRobertaForMultipleChoice"),c0.forEach(t),ty=i(Sd," forward method, overrides the "),ap=s(Sd,"CODE",{});var p0=a(ap);oy=i(p0,"__call__"),p0.forEach(t),ny=i(Sd," special method."),Sd.forEach(t),sy=p(zs),y(Gn.$$.fragment,zs),ay=p(zs),y(Yn.$$.fragment,zs),zs.forEach(t),_t.forEach(t),Rm=p(o),jo=s(o,"H2",{class:!0});var Su=a(jo);Zn=s(Su,"A",{id:!0,class:!0,href:!0});var h0=a(Zn);rp=s(h0,"SPAN",{});var m0=a(rp);y(Xr.$$.fragment,m0),m0.forEach(t),h0.forEach(t),ry=p(Su),ip=s(Su,"SPAN",{});var u0=a(ip);iy=i(u0,"TFXLMRobertaForTokenClassification"),u0.forEach(t),Su.forEach(t),Lm=p(o),Se=s(o,"DIV",{class:!0});var bt=a(Se);y(Pr.$$.fragment,bt),ly=p(bt),lp=s(bt,"P",{});var f0=a(lp);dy=i(f0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),f0.forEach(t),cy=p(bt),Ar=s(bt,"P",{});var Wu=a(Ar);py=i(Wu,"This model inherits from "),pd=s(Wu,"A",{href:!0});var g0=a(pd);hy=i(g0,"TFPreTrainedModel"),g0.forEach(t),my=i(Wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wu.forEach(t),uy=p(bt),Or=s(bt,"P",{});var Bu=a(Or);fy=i(Bu,"This model is also a "),Nr=s(Bu,"A",{href:!0,rel:!0});var _0=a(Nr);gy=i(_0,"tf.keras.Model"),_0.forEach(t),_y=i(Bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bu.forEach(t),by=p(bt),y(es.$$.fragment,bt),ky=p(bt),Ir=s(bt,"P",{});var Uu=a(Ir);vy=i(Uu,"This class overrides "),hd=s(Uu,"A",{href:!0});var b0=a(hd);Ty=i(b0,"TFRobertaForTokenClassification"),b0.forEach(t),yy=i(Uu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Uu.forEach(t),wy=p(bt),pt=s(bt,"DIV",{class:!0});var so=a(pt);y(Dr.$$.fragment,so),$y=p(so),Xo=s(so,"P",{});var Wd=a(Xo);My=i(Wd,"The "),md=s(Wd,"A",{href:!0});var k0=a(md);Fy=i(k0,"TFRobertaForTokenClassification"),k0.forEach(t),xy=i(Wd," forward method, overrides the "),dp=s(Wd,"CODE",{});var v0=a(dp);Ry=i(v0,"__call__"),v0.forEach(t),Ly=i(Wd," special method."),Wd.forEach(t),Ey=p(so),y(ts.$$.fragment,so),zy=p(so),y(os.$$.fragment,so),qy=p(so),y(ns.$$.fragment,so),so.forEach(t),bt.forEach(t),Em=p(o),Po=s(o,"H2",{class:!0});var Qu=a(Po);ss=s(Qu,"A",{id:!0,class:!0,href:!0});var T0=a(ss);cp=s(T0,"SPAN",{});var y0=a(cp);y(Sr.$$.fragment,y0),y0.forEach(t),T0.forEach(t),Cy=p(Qu),pp=s(Qu,"SPAN",{});var w0=a(pp);jy=i(w0,"TFXLMRobertaForQuestionAnswering"),w0.forEach(t),Qu.forEach(t),zm=p(o),We=s(o,"DIV",{class:!0});var kt=a(We);y(Wr.$$.fragment,kt),Xy=p(kt),Ao=s(kt,"P",{});var Bd=a(Ao);Py=i(Bd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Bd,"CODE",{});var $0=a(hp);Ay=i($0,"span start logits"),$0.forEach(t),Oy=i(Bd," and "),mp=s(Bd,"CODE",{});var M0=a(mp);Ny=i(M0,"span end logits"),M0.forEach(t),Iy=i(Bd,")."),Bd.forEach(t),Dy=p(kt),Br=s(kt,"P",{});var Hu=a(Br);Sy=i(Hu,"This model inherits from "),ud=s(Hu,"A",{href:!0});var F0=a(ud);Wy=i(F0,"TFPreTrainedModel"),F0.forEach(t),By=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hu.forEach(t),Uy=p(kt),Ur=s(kt,"P",{});var Vu=a(Ur);Qy=i(Vu,"This model is also a "),Qr=s(Vu,"A",{href:!0,rel:!0});var x0=a(Qr);Hy=i(x0,"tf.keras.Model"),x0.forEach(t),Vy=i(Vu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vu.forEach(t),Jy=p(kt),y(as.$$.fragment,kt),Ky=p(kt),Hr=s(kt,"P",{});var Ju=a(Hr);Gy=i(Ju,"This class overrides "),up=s(Ju,"CODE",{});var R0=a(up);Yy=i(R0,"TFRobertaForQuestionAnsweringSimple"),R0.forEach(t),Zy=i(Ju,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Ju.forEach(t),ew=p(kt),ht=s(kt,"DIV",{class:!0});var ao=a(ht);y(Vr.$$.fragment,ao),tw=p(ao),Oo=s(ao,"P",{});var Ud=a(Oo);ow=i(Ud,"The "),fd=s(Ud,"A",{href:!0});var L0=a(fd);nw=i(L0,"TFRobertaForQuestionAnswering"),L0.forEach(t),sw=i(Ud," forward method, overrides the "),fp=s(Ud,"CODE",{});var E0=a(fp);aw=i(E0,"__call__"),E0.forEach(t),rw=i(Ud," special method."),Ud.forEach(t),iw=p(ao),y(rs.$$.fragment,ao),lw=p(ao),y(is.$$.fragment,ao),dw=p(ao),y(ls.$$.fragment,ao),ao.forEach(t),kt.forEach(t),qm=p(o),No=s(o,"H2",{class:!0});var Ku=a(No);ds=s(Ku,"A",{id:!0,class:!0,href:!0});var z0=a(ds);gp=s(z0,"SPAN",{});var q0=a(gp);y(Jr.$$.fragment,q0),q0.forEach(t),z0.forEach(t),cw=p(Ku),_p=s(Ku,"SPAN",{});var C0=a(_p);pw=i(C0,"FlaxXLMRobertaModel"),C0.forEach(t),Ku.forEach(t),Cm=p(o),Be=s(o,"DIV",{class:!0});var vt=a(Be);y(Kr.$$.fragment,vt),hw=p(vt),Gr=s(vt,"P",{});var Gu=a(Gr);mw=i(Gu,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=s(Gu,"A",{href:!0});var j0=a(gd);uw=i(j0,"FlaxPreTrainedModel"),j0.forEach(t),fw=i(Gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gu.forEach(t),gw=p(vt),Yr=s(vt,"P",{});var Yu=a(Yr);_w=i(Yu,"This model is also a Flax Linen "),Zr=s(Yu,"A",{href:!0,rel:!0});var X0=a(Zr);bw=i(X0,"flax.linen.Module"),X0.forEach(t),kw=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),vw=p(vt),bp=s(vt,"P",{});var P0=a(bp);Tw=i(P0,"Finally, this model supports inherent JAX features such as:"),P0.forEach(t),yw=p(vt),St=s(vt,"UL",{});var qs=a(St);kp=s(qs,"LI",{});var A0=a(kp);ei=s(A0,"A",{href:!0,rel:!0});var O0=a(ei);ww=i(O0,"Just-In-Time (JIT) compilation"),O0.forEach(t),A0.forEach(t),$w=p(qs),vp=s(qs,"LI",{});var N0=a(vp);ti=s(N0,"A",{href:!0,rel:!0});var I0=a(ti);Mw=i(I0,"Automatic Differentiation"),I0.forEach(t),N0.forEach(t),Fw=p(qs),Tp=s(qs,"LI",{});var D0=a(Tp);oi=s(D0,"A",{href:!0,rel:!0});var S0=a(oi);xw=i(S0,"Vectorization"),S0.forEach(t),D0.forEach(t),Rw=p(qs),yp=s(qs,"LI",{});var W0=a(yp);ni=s(W0,"A",{href:!0,rel:!0});var B0=a(ni);Lw=i(B0,"Parallelization"),B0.forEach(t),W0.forEach(t),qs.forEach(t),Ew=p(vt),si=s(vt,"P",{});var Zu=a(si);zw=i(Zu,"This class overrides "),_d=s(Zu,"A",{href:!0});var U0=a(_d);qw=i(U0,"FlaxRobertaModel"),U0.forEach(t),Cw=i(Zu,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Zu.forEach(t),jw=p(vt),Rt=s(vt,"DIV",{class:!0});var Cs=a(Rt);y(ai.$$.fragment,Cs),Xw=p(Cs),Io=s(Cs,"P",{});var Qd=a(Io);Pw=i(Qd,"The "),wp=s(Qd,"CODE",{});var Q0=a(wp);Aw=i(Q0,"FlaxRobertaPreTrainedModel"),Q0.forEach(t),Ow=i(Qd," forward method, overrides the "),$p=s(Qd,"CODE",{});var H0=a($p);Nw=i(H0,"__call__"),H0.forEach(t),Iw=i(Qd," special method."),Qd.forEach(t),Dw=p(Cs),y(cs.$$.fragment,Cs),Sw=p(Cs),y(ps.$$.fragment,Cs),Cs.forEach(t),vt.forEach(t),jm=p(o),Do=s(o,"H2",{class:!0});var ef=a(Do);hs=s(ef,"A",{id:!0,class:!0,href:!0});var V0=a(hs);Mp=s(V0,"SPAN",{});var J0=a(Mp);y(ri.$$.fragment,J0),J0.forEach(t),V0.forEach(t),Ww=p(ef),Fp=s(ef,"SPAN",{});var K0=a(Fp);Bw=i(K0,"FlaxXLMRobertaForMaskedLM"),K0.forEach(t),ef.forEach(t),Xm=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(ii.$$.fragment,Tt),Uw=p(Tt),So=s(Tt,"P",{});var Hd=a(So);Qw=i(Hd,"XLM-RoBERTa Model with a "),xp=s(Hd,"CODE",{});var G0=a(xp);Hw=i(G0,"language modeling"),G0.forEach(t),Vw=i(Hd,` head on top.
This model inherits from `),bd=s(Hd,"A",{href:!0});var Y0=a(bd);Jw=i(Y0,"FlaxPreTrainedModel"),Y0.forEach(t),Kw=i(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hd.forEach(t),Gw=p(Tt),li=s(Tt,"P",{});var tf=a(li);Yw=i(tf,"This model is also a Flax Linen "),di=s(tf,"A",{href:!0,rel:!0});var Z0=a(di);Zw=i(Z0,"flax.linen.Module"),Z0.forEach(t),e$=i(tf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tf.forEach(t),t$=p(Tt),Rp=s(Tt,"P",{});var ex=a(Rp);o$=i(ex,"Finally, this model supports inherent JAX features such as:"),ex.forEach(t),n$=p(Tt),Wt=s(Tt,"UL",{});var js=a(Wt);Lp=s(js,"LI",{});var tx=a(Lp);ci=s(tx,"A",{href:!0,rel:!0});var ox=a(ci);s$=i(ox,"Just-In-Time (JIT) compilation"),ox.forEach(t),tx.forEach(t),a$=p(js),Ep=s(js,"LI",{});var nx=a(Ep);pi=s(nx,"A",{href:!0,rel:!0});var sx=a(pi);r$=i(sx,"Automatic Differentiation"),sx.forEach(t),nx.forEach(t),i$=p(js),zp=s(js,"LI",{});var ax=a(zp);hi=s(ax,"A",{href:!0,rel:!0});var rx=a(hi);l$=i(rx,"Vectorization"),rx.forEach(t),ax.forEach(t),d$=p(js),qp=s(js,"LI",{});var ix=a(qp);mi=s(ix,"A",{href:!0,rel:!0});var lx=a(mi);c$=i(lx,"Parallelization"),lx.forEach(t),ix.forEach(t),js.forEach(t),p$=p(Tt),ui=s(Tt,"P",{});var of=a(ui);h$=i(of,"This class overrides "),kd=s(of,"A",{href:!0});var dx=a(kd);m$=i(dx,"FlaxRobertaForMaskedLM"),dx.forEach(t),u$=i(of,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),of.forEach(t),f$=p(Tt),Lt=s(Tt,"DIV",{class:!0});var Xs=a(Lt);y(fi.$$.fragment,Xs),g$=p(Xs),Wo=s(Xs,"P",{});var Vd=a(Wo);_$=i(Vd,"The "),Cp=s(Vd,"CODE",{});var cx=a(Cp);b$=i(cx,"FlaxRobertaPreTrainedModel"),cx.forEach(t),k$=i(Vd," forward method, overrides the "),jp=s(Vd,"CODE",{});var px=a(jp);v$=i(px,"__call__"),px.forEach(t),T$=i(Vd," special method."),Vd.forEach(t),y$=p(Xs),y(ms.$$.fragment,Xs),w$=p(Xs),y(us.$$.fragment,Xs),Xs.forEach(t),Tt.forEach(t),Pm=p(o),Bo=s(o,"H2",{class:!0});var nf=a(Bo);fs=s(nf,"A",{id:!0,class:!0,href:!0});var hx=a(fs);Xp=s(hx,"SPAN",{});var mx=a(Xp);y(gi.$$.fragment,mx),mx.forEach(t),hx.forEach(t),$$=p(nf),Pp=s(nf,"SPAN",{});var ux=a(Pp);M$=i(ux,"FlaxXLMRobertaForSequenceClassification"),ux.forEach(t),nf.forEach(t),Am=p(o),Ce=s(o,"DIV",{class:!0});var tt=a(Ce);y(_i.$$.fragment,tt),F$=p(tt),Ap=s(tt,"P",{});var fx=a(Ap);x$=i(fx,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),fx.forEach(t),R$=p(tt),bi=s(tt,"P",{});var sf=a(bi);L$=i(sf,"This model inherits from "),vd=s(sf,"A",{href:!0});var gx=a(vd);E$=i(gx,"FlaxPreTrainedModel"),gx.forEach(t),z$=i(sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sf.forEach(t),q$=p(tt),ki=s(tt,"P",{});var af=a(ki);C$=i(af,"This model is also a Flax Linen "),vi=s(af,"A",{href:!0,rel:!0});var _x=a(vi);j$=i(_x,"flax.linen.Module"),_x.forEach(t),X$=i(af,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),af.forEach(t),P$=p(tt),Op=s(tt,"P",{});var bx=a(Op);A$=i(bx,"Finally, this model supports inherent JAX features such as:"),bx.forEach(t),O$=p(tt),Bt=s(tt,"UL",{});var Ps=a(Bt);Np=s(Ps,"LI",{});var kx=a(Np);Ti=s(kx,"A",{href:!0,rel:!0});var vx=a(Ti);N$=i(vx,"Just-In-Time (JIT) compilation"),vx.forEach(t),kx.forEach(t),I$=p(Ps),Ip=s(Ps,"LI",{});var Tx=a(Ip);yi=s(Tx,"A",{href:!0,rel:!0});var yx=a(yi);D$=i(yx,"Automatic Differentiation"),yx.forEach(t),Tx.forEach(t),S$=p(Ps),Dp=s(Ps,"LI",{});var wx=a(Dp);wi=s(wx,"A",{href:!0,rel:!0});var $x=a(wi);W$=i($x,"Vectorization"),$x.forEach(t),wx.forEach(t),B$=p(Ps),Sp=s(Ps,"LI",{});var Mx=a(Sp);$i=s(Mx,"A",{href:!0,rel:!0});var Fx=a($i);U$=i(Fx,"Parallelization"),Fx.forEach(t),Mx.forEach(t),Ps.forEach(t),Q$=p(tt),Mi=s(tt,"P",{});var rf=a(Mi);H$=i(rf,"This class overrides "),Td=s(rf,"A",{href:!0});var xx=a(Td);V$=i(xx,"FlaxRobertaForSequenceClassification"),xx.forEach(t),J$=i(rf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),rf.forEach(t),K$=p(tt),Et=s(tt,"DIV",{class:!0});var As=a(Et);y(Fi.$$.fragment,As),G$=p(As),Uo=s(As,"P",{});var Jd=a(Uo);Y$=i(Jd,"The "),Wp=s(Jd,"CODE",{});var Rx=a(Wp);Z$=i(Rx,"FlaxRobertaPreTrainedModel"),Rx.forEach(t),e1=i(Jd," forward method, overrides the "),Bp=s(Jd,"CODE",{});var Lx=a(Bp);t1=i(Lx,"__call__"),Lx.forEach(t),o1=i(Jd," special method."),Jd.forEach(t),n1=p(As),y(gs.$$.fragment,As),s1=p(As),y(_s.$$.fragment,As),As.forEach(t),tt.forEach(t),Om=p(o),Qo=s(o,"H2",{class:!0});var lf=a(Qo);bs=s(lf,"A",{id:!0,class:!0,href:!0});var Ex=a(bs);Up=s(Ex,"SPAN",{});var zx=a(Up);y(xi.$$.fragment,zx),zx.forEach(t),Ex.forEach(t),a1=p(lf),Qp=s(lf,"SPAN",{});var qx=a(Qp);r1=i(qx,"FlaxXLMRobertaForMultipleChoice"),qx.forEach(t),lf.forEach(t),Nm=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Ri.$$.fragment,ot),i1=p(ot),Hp=s(ot,"P",{});var Cx=a(Hp);l1=i(Cx,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Cx.forEach(t),d1=p(ot),Li=s(ot,"P",{});var df=a(Li);c1=i(df,"This model inherits from "),yd=s(df,"A",{href:!0});var jx=a(yd);p1=i(jx,"FlaxPreTrainedModel"),jx.forEach(t),h1=i(df,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),df.forEach(t),m1=p(ot),Ei=s(ot,"P",{});var cf=a(Ei);u1=i(cf,"This model is also a Flax Linen "),zi=s(cf,"A",{href:!0,rel:!0});var Xx=a(zi);f1=i(Xx,"flax.linen.Module"),Xx.forEach(t),g1=i(cf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cf.forEach(t),_1=p(ot),Vp=s(ot,"P",{});var Px=a(Vp);b1=i(Px,"Finally, this model supports inherent JAX features such as:"),Px.forEach(t),k1=p(ot),Ut=s(ot,"UL",{});var Os=a(Ut);Jp=s(Os,"LI",{});var Ax=a(Jp);qi=s(Ax,"A",{href:!0,rel:!0});var Ox=a(qi);v1=i(Ox,"Just-In-Time (JIT) compilation"),Ox.forEach(t),Ax.forEach(t),T1=p(Os),Kp=s(Os,"LI",{});var Nx=a(Kp);Ci=s(Nx,"A",{href:!0,rel:!0});var Ix=a(Ci);y1=i(Ix,"Automatic Differentiation"),Ix.forEach(t),Nx.forEach(t),w1=p(Os),Gp=s(Os,"LI",{});var Dx=a(Gp);ji=s(Dx,"A",{href:!0,rel:!0});var Sx=a(ji);$1=i(Sx,"Vectorization"),Sx.forEach(t),Dx.forEach(t),M1=p(Os),Yp=s(Os,"LI",{});var Wx=a(Yp);Xi=s(Wx,"A",{href:!0,rel:!0});var Bx=a(Xi);F1=i(Bx,"Parallelization"),Bx.forEach(t),Wx.forEach(t),Os.forEach(t),x1=p(ot),Pi=s(ot,"P",{});var pf=a(Pi);R1=i(pf,"This class overrides "),wd=s(pf,"A",{href:!0});var Ux=a(wd);L1=i(Ux,"FlaxRobertaForMultipleChoice"),Ux.forEach(t),E1=i(pf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),pf.forEach(t),z1=p(ot),zt=s(ot,"DIV",{class:!0});var Ns=a(zt);y(Ai.$$.fragment,Ns),q1=p(Ns),Ho=s(Ns,"P",{});var Kd=a(Ho);C1=i(Kd,"The "),Zp=s(Kd,"CODE",{});var Qx=a(Zp);j1=i(Qx,"FlaxRobertaPreTrainedModel"),Qx.forEach(t),X1=i(Kd," forward method, overrides the "),eh=s(Kd,"CODE",{});var Hx=a(eh);P1=i(Hx,"__call__"),Hx.forEach(t),A1=i(Kd," special method."),Kd.forEach(t),O1=p(Ns),y(ks.$$.fragment,Ns),N1=p(Ns),y(vs.$$.fragment,Ns),Ns.forEach(t),ot.forEach(t),Im=p(o),Vo=s(o,"H2",{class:!0});var hf=a(Vo);Ts=s(hf,"A",{id:!0,class:!0,href:!0});var Vx=a(Ts);th=s(Vx,"SPAN",{});var Jx=a(th);y(Oi.$$.fragment,Jx),Jx.forEach(t),Vx.forEach(t),I1=p(hf),oh=s(hf,"SPAN",{});var Kx=a(oh);D1=i(Kx,"FlaxXLMRobertaForTokenClassification"),Kx.forEach(t),hf.forEach(t),Dm=p(o),Xe=s(o,"DIV",{class:!0});var nt=a(Xe);y(Ni.$$.fragment,nt),S1=p(nt),nh=s(nt,"P",{});var Gx=a(nh);W1=i(Gx,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Gx.forEach(t),B1=p(nt),Ii=s(nt,"P",{});var mf=a(Ii);U1=i(mf,"This model inherits from "),$d=s(mf,"A",{href:!0});var Yx=a($d);Q1=i(Yx,"FlaxPreTrainedModel"),Yx.forEach(t),H1=i(mf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),mf.forEach(t),V1=p(nt),Di=s(nt,"P",{});var uf=a(Di);J1=i(uf,"This model is also a Flax Linen "),Si=s(uf,"A",{href:!0,rel:!0});var Zx=a(Si);K1=i(Zx,"flax.linen.Module"),Zx.forEach(t),G1=i(uf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Y1=p(nt),sh=s(nt,"P",{});var eR=a(sh);Z1=i(eR,"Finally, this model supports inherent JAX features such as:"),eR.forEach(t),eM=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var tR=a(ah);Wi=s(tR,"A",{href:!0,rel:!0});var oR=a(Wi);tM=i(oR,"Just-In-Time (JIT) compilation"),oR.forEach(t),tR.forEach(t),oM=p(Is),rh=s(Is,"LI",{});var nR=a(rh);Bi=s(nR,"A",{href:!0,rel:!0});var sR=a(Bi);nM=i(sR,"Automatic Differentiation"),sR.forEach(t),nR.forEach(t),sM=p(Is),ih=s(Is,"LI",{});var aR=a(ih);Ui=s(aR,"A",{href:!0,rel:!0});var rR=a(Ui);aM=i(rR,"Vectorization"),rR.forEach(t),aR.forEach(t),rM=p(Is),lh=s(Is,"LI",{});var iR=a(lh);Qi=s(iR,"A",{href:!0,rel:!0});var lR=a(Qi);iM=i(lR,"Parallelization"),lR.forEach(t),iR.forEach(t),Is.forEach(t),lM=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);dM=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var dR=a(Md);cM=i(dR,"FlaxRobertaForTokenClassification"),dR.forEach(t),pM=i(ff,`. Please check the superclass for the appropriate
