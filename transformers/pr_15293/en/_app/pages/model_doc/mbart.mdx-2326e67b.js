...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15293/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Na=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15293/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15293/en/model_doc/mbart#transformers.MBartConfig"
...
Whether or not to return a <a href="/docs/transformers/pr_15293/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15293/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15293/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15293/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Wz]},$$scope:{ctx:E}}}),Is=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15293/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15293/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15293/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15293/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15293/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15293/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15293/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15293/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15293/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_15293/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_15293/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_15293/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
adding special tokens. An MBART sequence has the following format, where `),Od=a(vh,"CODE",{});var YM=s(Od);bf=i(YM,"X"),YM.forEach(t),yf=i(vh," represents the sequence:"),vh.forEach(t),vf=l(zn),oa=a(zn,"UL",{});var Th=s(oa);na=a(Th,"LI",{});var Mh=s(na);Id=a(Mh,"CODE",{});var e2=s(Id);Tf=i(e2,"input_ids"),e2.forEach(t),Mf=i(Mh," (for encoder) "),Nd=a(Mh,"CODE",{});var t2=s(Nd);wf=i(t2,"X [eos, src_lang_code]"),t2.forEach(t),Mh.forEach(t),xf=l(Th),aa=a(Th,"LI",{});var wh=s(aa);Dd=a(wh,"CODE",{});var o2=s(Dd);zf=i(o2,"decoder_input_ids"),o2.forEach(t),qf=i(wh,": (for decoder) "),Ld=a(wh,"CODE",{});var n2=s(Ld);Bf=i(n2,"X [eos, tgt_lang_code]"),n2.forEach(t),wh.forEach(t),Th.forEach(t),Ff=l(zn),Gd=a(zn,"P",{});var a2=s(Gd);$f=i(a2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),a2.forEach(t),zn.forEach(t),he.forEach(t),Ap=l(o),so=a(o,"H2",{class:!0});var xh=s(so);Lo=a(xh,"A",{id:!0,class:!0,href:!0});var s2=s(Lo);Wd=a(s2,"SPAN",{});var r2=s(Wd);f(sa.$$.fragment,r2),r2.forEach(t),s2.forEach(t),jf=l(xh),Rd=a(xh,"SPAN",{});var i2=s(Rd);Ef=i(i2,"MBartTokenizerFast"),i2.forEach(t),xh.forEach(t),Op=l(o),C=a(o,"DIV",{class:!0});var H=s(C);f(ra.$$.fragment,H),Pf=l(H),ro=a(H,"P",{});var Oi=s(ro);Cf=i(Oi,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Ud=a(Oi,"EM",{});var d2=s(Ud);Sf=i(d2,"tokenizers"),d2.forEach(t),Af=i(Oi,` library). Based on
`),ia=a(Oi,"A",{href:!0,rel:!0});var l2=s(ia);Of=i(l2,"BPE"),l2.forEach(t),If=i(Oi,"."),Oi.forEach(t),Nf=l(H),vt=a(H,"P",{});var Kr=s(vt);pi=a(Kr,"A",{href:!0});var c2=s(pi);Df=i(c2,"MBartTokenizerFast"),c2.forEach(t),Lf=i(Kr," is a subclass of "),hi=a(Kr,"A",{href:!0});var p2=s(hi);Gf=i(p2,"XLMRobertaTokenizerFast"),p2.forEach(t),Wf=i(Kr,`. Refer to superclass
...
adding special tokens. The special tokens depend on calling set_lang.`),f2.forEach(t),o_=l(Pt),pa=a(Pt,"P",{});var qh=s(pa);n_=i(qh,"An MBART sequence has the following format, where "),Qd=a(qh,"CODE",{});var _2=s(Qd);a_=i(_2,"X"),_2.forEach(t),s_=i(qh," represents the sequence:"),qh.forEach(t),r_=l(Pt),ha=a(Pt,"UL",{});var Bh=s(ha);ua=a(Bh,"LI",{});var Fh=s(ua);Jd=a(Fh,"CODE",{});var g2=s(Jd);i_=i(g2,"input_ids"),g2.forEach(t),d_=i(Fh," (for encoder) "),Kd=a(Fh,"CODE",{});var k2=s(Kd);l_=i(k2,"X [eos, src_lang_code]"),k2.forEach(t),Fh.forEach(t),c_=l(Bh),ma=a(Bh,"LI",{});var $h=s(ma);Zd=a($h,"CODE",{});var b2=s(Zd);p_=i(b2,"decoder_input_ids"),b2.forEach(t),h_=i($h,": (for decoder) "),Yd=a($h,"CODE",{});var y2=s(Yd);u_=i(y2,"X [eos, tgt_lang_code]"),y2.forEach(t),$h.forEach(t),Bh.forEach(t),m_=l(Pt),el=a(Pt,"P",{});var v2=s(el);f_=i(v2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),v2.forEach(t),Pt.forEach(t),__=l(H),Go=a(H,"DIV",{class:!0});var jh=s(Go);f(fa.$$.fragment,jh),g_=l(jh),tl=a(jh,"P",{});var T2=s(tl);k_=i(T2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),T2.forEach(t),jh.forEach(t),b_=l(H),Wo=a(H,"DIV",{class:!0});var Eh=s(Wo);f(_a.$$.fragment,Eh),y_=l(Eh),ol=a(Eh,"P",{});var M2=s(ol);v_=i(M2,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),M2.forEach(t),Eh.forEach(t),T_=l(H),Ro=a(H,"DIV",{class:!0});var Ph=s(Ro);f(ga.$$.fragment,Ph),M_=l(Ph),nl=a(Ph,"P",{});var w2=s(nl);w_=i(w2,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),w2.forEach(t),Ph.forEach(t),H.forEach(t),Ip=l(o),io=a(o,"H2",{class:!0});var Ch=s(io);Uo=a(Ch,"A",{id:!0,class:!0,href:!0});var x2=s(Uo);al=a(x2,"SPAN",{});var z2=s(al);f(ka.$$.fragment,z2),z2.forEach(t),x2.forEach(t),x_=l(Ch),sl=a(Ch,"SPAN",{});var q2=s(sl);z_=i(q2,"MBart50Tokenizer"),q2.forEach(t),Ch.forEach(t),Np=l(o),S=a(o,"DIV",{class:!0});var V=s(S);f(ba.$$.fragment,V),q_=l(V),ya=a(V,"P",{});var Sh=s(ya);B_=i(Sh,"Construct a MBart50 tokenizer. Based on "),va=a(Sh,"A",{href:!0,rel:!0});var B2=s(va);F_=i(B2,"SentencePiece"),B2.forEach(t),$_=i(Sh,"."),Sh.forEach(t),j_=l(V),Ta=a(V,"P",{});var Ah=s(Ta);E_=i(Ah,"This tokenizer inherits from "),mi=a(Ah,"A",{href:!0});var F2=s(mi);P_=i(F2,"PreTrainedTokenizer"),F2.forEach(t),C_=i(Ah,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ah.forEach(t),S_=l(V),rl=a(V,"P",{});var $2=s(rl);A_=i($2,"Examples:"),$2.forEach(t),O_=l(V),f(Ma.$$.fragment,V),I_=l(V),ot=a(V,"DIV",{class:!0});var qn=s(ot);f(wa.$$.fragment,qn),N_=l(qn),xa=a(qn,"P",{});var Oh=s(xa);D_=i(Oh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),il=a(Oh,"CODE",{});var j2=s(il);L_=i(j2,"X"),j2.forEach(t),G_=i(Oh," represents the sequence:"),Oh.forEach(t),W_=l(qn),za=a(qn,"UL",{});var Ih=s(za);qa=a(Ih,"LI",{});var Nh=s(qa);dl=a(Nh,"CODE",{});var E2=s(dl);R_=i(E2,"input_ids"),E2.forEach(t),U_=i(Nh," (for encoder) "),ll=a(Nh,"CODE",{});var P2=s(ll);X_=i(P2,"[src_lang_code] X [eos]"),P2.forEach(t),Nh.forEach(t),H_=l(Ih),Ba=a(Ih,"LI",{});var Dh=s(Ba);cl=a(Dh,"CODE",{});var C2=s(cl);V_=i(C2,"labels"),C2.forEach(t),Q_=i(Dh,": (for decoder) "),pl=a(Dh,"CODE",{});var S2=s(pl);J_=i(S2,"[tgt_lang_code] X [eos]"),S2.forEach(t),Dh.forEach(t),Ih.forEach(t),K_=l(qn),hl=a(qn,"P",{});var A2=s(hl);Z_=i(A2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),A2.forEach(t),qn.forEach(t),Y_=l(V),Xo=a(V,"DIV",{class:!0});var Lh=s(Xo);f(Fa.$$.fragment,Lh),eg=l(Lh),ul=a(Lh,"P",{});var O2=s(ul);tg=i(O2,"Converts a sequence of tokens (strings for sub-words) in a single string."),O2.forEach(t),Lh.forEach(t),og=l(V),Ho=a(V,"DIV",{class:!0});var Gh=s(Ho);f($a.$$.fragment,Gh),ng=l(Gh),ja=a(Gh,"P",{});var Wh=s(ja);ag=i(Wh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ml=a(Wh,"CODE",{});var I2=s(ml);sg=i(I2,"prepare_for_model"),I2.forEach(t),rg=i(Wh," method."),Wh.forEach(t),Gh.forEach(t),ig=l(V),Vo=a(V,"DIV",{class:!0});var Rh=s(Vo);f(Ea.$$.fragment,Rh),dg=l(Rh),fl=a(Rh,"P",{});var N2=s(fl);lg=i(N2,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),N2.forEach(t),Rh.forEach(t),cg=l(V),Qo=a(V,"DIV",{class:!0});var Uh=s(Qo);f(Pa.$$.fragment,Uh),pg=l(Uh),_l=a(Uh,"P",{});var D2=s(_l);hg=i(D2,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),D2.forEach(t),Uh.forEach(t),V.forEach(t),Dp=l(o),lo=a(o,"H2",{class:!0});var Xh=s(lo);Jo=a(Xh,"A",{id:!0,class:!0,href:!0});var L2=s(Jo);gl=a(L2,"SPAN",{});var G2=s(gl);f(Ca.$$.fragment,G2),G2.forEach(t),L2.forEach(t),ug=l(Xh),kl=a(Xh,"SPAN",{});var W2=s(kl);mg=i(W2,"MBart50TokenizerFast"),W2.forEach(t),Xh.forEach(t),Lp=l(o),G=a(o,"DIV",{class:!0});var ue=s(G);f(Sa.$$.fragment,ue),fg=l(ue),co=a(ue,"P",{});var Ii=s(co);_g=i(Ii,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),bl=a(Ii,"EM",{});var R2=s(bl);gg=i(R2,"tokenizers"),R2.forEach(t),kg=i(Ii,` library). Based on
`),Aa=a(Ii,"A",{href:!0,rel:!0});var U2=s(Aa);bg=i(U2,"BPE"),U2.forEach(t),yg=i(Ii,"."),Ii.forEach(t),vg=l(ue),Oa=a(ue,"P",{});var Hh=s(Oa);Tg=i(Hh,"This tokenizer inherits from "),fi=a(Hh,"A",{href:!0});var X2=s(fi);Mg=i(X2,"PreTrainedTokenizerFast"),X2.forEach(t),wg=i(Hh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hh.forEach(t),xg=l(ue),yl=a(ue,"P",{});var H2=s(yl);zg=i(H2,"Examples:"),H2.forEach(t),qg=l(ue),f(Ia.$$.fragment,ue),Bg=l(ue),Ce=a(ue,"DIV",{class:!0});var Ct=s(Ce);f(Na.$$.fragment,Ct),Fg=l(Ct),vl=a(Ct,"P",{});var V2=s(vl);$g=i(V2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),V2.forEach(t),jg=l(Ct),Da=a(Ct,"P",{});var Vh=s(Da);Eg=i(Vh,"An MBART-50 sequence has the following format, where "),Tl=a(Vh,"CODE",{});var Q2=s(Tl);Pg=i(Q2,"X"),Q2.forEach(t),Cg=i(Vh," represents the sequence:"),Vh.forEach(t),Sg=l(Ct),La=a(Ct,"UL",{});var Qh=s(La);Ga=a(Qh,"LI",{});var Jh=s(Ga);Ml=a(Jh,"CODE",{});var J2=s(Ml);Ag=i(J2,"input_ids"),J2.forEach(t),Og=i(Jh," (for encoder) "),wl=a(Jh,"CODE",{});var K2=s(wl);Ig=i(K2,"[src_lang_code] X [eos]"),K2.forEach(t),Jh.forEach(t),Ng=l(Qh),Wa=a(Qh,"LI",{});var Kh=s(Wa);xl=a(Kh,"CODE",{});var Z2=s(xl);Dg=i(Z2,"labels"),Z2.forEach(t),Lg=i(Kh,": (for decoder) "),zl=a(Kh,"CODE",{});var Y2=s(zl);Gg=i(Y2,"[tgt_lang_code] X [eos]"),Y2.forEach(t),Kh.forEach(t),Qh.forEach(t),Wg=l(Ct),ql=a(Ct,"P",{});var ew=s(ql);Rg=i(ew,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),ew.forEach(t),Ct.forEach(t),Ug=l(ue),Ko=a(ue,"DIV",{class:!0});var Zh=s(Ko);f(Ra.$$.fragment,Zh),Xg=l(Zh),Bl=a(Zh,"P",{});var tw=s(Bl);Hg=i(tw,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),tw.forEach(t),Zh.forEach(t),Vg=l(ue),Zo=a(ue,"DIV",{class:!0});var Yh=s(Zo);f(Ua.$$.fragment,Yh),Qg=l(Yh),Fl=a(Yh,"P",{});var ow=s(Fl);Jg=i(ow,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),ow.forEach(t),Yh.forEach(t),ue.forEach(t),Gp=l(o),po=a(o,"H2",{class:!0});var eu=s(po);Yo=a(eu,"A",{id:!0,class:!0,href:!0});var nw=s(Yo);$l=a(nw,"SPAN",{});var aw=s($l);f(Xa.$$.fragment,aw),aw.forEach(t),nw.forEach(t),Kg=l(eu),jl=a(eu,"SPAN",{});var sw=s(jl);Zg=i(sw,"MBartModel"),sw.forEach(t),eu.forEach(t),Wp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);f(Ha.$$.fragment,Bn),Yg=l(Bn),Va=a(Bn,"P",{});var tu=s(Va);ek=i(tu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Ni=s(ho);lk=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var dw=s(gi);ck=i(dw,"MBartModel"),dw.forEach(t),pk=i(Ni," forward method, overrides the "),El=a(Ni,"CODE",{});var lw=s(El);hk=i(lw,"__call__"),lw.forEach(t),uk=i(Ni," special method."),Ni.forEach(t),mk=l(St),f(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var cw=s(Pl);_k=i(cw,"Example:"),cw.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var pw=s(tn);Cl=a(pw,"SPAN",{});var hw=s(Cl);f(Ya.$$.fragment,hw),hw.forEach(t),pw.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var uw=s(Sl);bk=i(uw,"MBartForConditionalGeneration"),uw.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var Fn=s(Je);f(es.$$.fragment,Fn),yk=l(Fn),ts=a(Fn,"P",{});var au=s(ts);vk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l(Fn),os=a(Fn,"P",{});var su=s(os);xk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var fw=s(ns);zk=i(fw,"torch.nn.Module"),fw.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l(Fn),Z=a(Fn,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),Fk=l(Le),mo=a(Le,"P",{});var Di=s(mo);$k=i(Di,"The "),bi=a(Di,"A",{href:!0});var _w=s(bi);jk=i(_w,"MBartForConditionalGeneration"),_w.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var gw=s(Al);Pk=i(gw,"__call__"),gw.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(on.$$.fragment,Le),Ak=l(Le),Ol=a(Le,"P",{});var kw=s(Ol);Ok=i(kw,"Translation example:"),kw.forEach(t),Ik=l(Le),f(ss.$$.fragment,Le),Nk=l(Le),Il=a(Le,"P",{});var bw=s(Il);Dk=i(bw,"Mask filling example:"),bw.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),Fn.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var yw=s(nn);Nl=a(yw,"SPAN",{});var vw=s(Nl);f(is.$$.fragment,vw),vw.forEach(t),yw.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var Tw=s(Dl);Wk=i(Tw,"MBartForQuestionAnswering"),Tw.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var Mw=s(Ll);Xk=i(Mw,"span start logits"),Mw.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var ww=s(Gl);Vk=i(ww,"span end logits"),ww.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(At),ls=a(At,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),yi=a(iu,"A",{href:!0});var xw=s(yi);Zk=i(xw,"PreTrainedModel"),xw.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var Ot=s(Ae);f(hs.$$.fragment,Ot),sb=l(Ot),go=a(Ot,"P",{});var Gi=s(go);rb=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var qw=s(vi);ib=i(qw,"MBartForQuestionAnswering"),qw.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var Bw=s(Wl);lb=i(Bw,"__call__"),Bw.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(Ot),f(an.$$.fragment,Ot),hb=l(Ot),Rl=a(Ot,"P",{});var Fw=s(Rl);ub=i(Fw,"Example:"),Fw.forEach(t),mb=l(Ot),f(us.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var $w=s(sn);Ul=a($w,"SPAN",{});var jw=s(Ul);f(ms.$$.fragment,jw),jw.forEach(t),$w.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var Ew=s(Xl);_b=i(Ew,"MBartForSequenceClassification"),Ew.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var It=s(Be);f(fs.$$.fragment,It),gb=l(It),Hl=a(It,"P",{});var Pw=s(Hl);kb=i(Pw,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Pw.forEach(t),bb=l(It),_s=a(It,"P",{});var cu=s(_s);yb=i(cu,"This model inherits from "),Ti=a(cu,"A",{href:!0});var Cw=s(Ti);vb=i(Cw,"PreTrainedModel"),Cw.forEach(t),Tb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(It),gs=a(It,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var Sw=s(ks);xb=i(Sw,"torch.nn.Module"),Sw.forEach(t),zb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(It),Y=a(It,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);Fb=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var Aw=s(Mi);$b=i(Aw,"MBartForSequenceClassification"),Aw.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var Ow=s(Vl);Eb=i(Ow,"__call__"),Ow.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var Iw=s(Ql);Ab=i(Iw,"Example of single-label classification:"),Iw.forEach(t),Ob=l(Ge),f(ys.$$.fragment,Ge),Ib=l(Ge),Jl=a(Ge,"P",{});var Nw=s(Jl);Nb=i(Nw,"Example of multi-label classification:"),Nw.forEach(t),Db=l(Ge),f(vs.$$.fragment,Ge),Ge.forEach(t),It.forEach(t),Jp=l(o),yo=a(o,"H2",{class:!0});var hu=s(yo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var Dw=s(dn);Kl=a(Dw,"SPAN",{});var Lw=s(Kl);f(Ts.$$.fragment,Lw),Lw.forEach(t),Dw.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var Gw=s(Zl);Gb=i(Gw,"MBartForCausalLM"),Gw.forEach(t),hu.forEach(t),Kp=l(o),vo=a(o,"DIV",{class:!0});var uu=s(vo);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var Ww=s(Yl);Ub=i(Ww,"Example:"),Ww.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var Rw=s(ln);ec=a(Rw,"SPAN",{});var Uw=s(ec);f(zs.$$.fragment,Uw),Uw.forEach(t),Rw.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var Xw=s(tc);Vb=i(Xw,"TFMBartModel"),Xw.forEach(t),mu.forEach(t),Yp=l(o),Fe=a(o,"DIV",{class:!0});var Nt=s(Fe);f(qs.$$.fragment,Nt),Qb=l(Nt),Bs=a(Nt,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Nt),Fs=a(Nt,"P",{});var _u=s(Fs);ey=i(_u,"This model is also a "),$s=a(_u,"A",{href:!0,rel:!0});var Vw=s($s);ty=i(Vw,"tf.keras.Model"),Vw.forEach(t),oy=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),ny=l(Nt),f(cn.$$.fragment,Nt),ay=l(Nt),Oe=a(Nt,"DIV",{class:!0});var Dt=s(Oe);f(js.$$.fragment,Dt),sy=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);ry=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Qw=s(xi);iy=i(Qw,"TFMBartModel"),Qw.forEach(t),dy=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var Jw=s(oc);ly=i(Jw,"__call__"),Jw.forEach(t),cy=i(Ui," special method."),Ui.forEach(t),py=l(Dt),f(pn.$$.fragment,Dt),hy=l(Dt),nc=a(Dt,"P",{});var Kw=s(nc);uy=i(Kw,"Example:"),Kw.forEach(t),my=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Zw=s(hn);ac=a(Zw,"SPAN",{});var Yw=s(ac);f(Ps.$$.fragment,Yw),Yw.forEach(t),Zw.forEach(t),fy=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_y=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),$e=a(o,"DIV",{class:!0});var Lt=s($e);f(Cs.$$.fragment,Lt),gy=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);ky=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
