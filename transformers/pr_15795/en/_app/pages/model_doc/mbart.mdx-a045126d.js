...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),wa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15795/src/transformers/models/mbart50/tokenization_mbart50.py#L287",parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">with</span> tokenizer.as_target_tokenizer():
<span class="hljs-meta">... </span>    labels = tokenizer(tgt_text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>).input_ids
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># model(**model_inputs, labels=labels) should work</span>`}}),Oa=new q({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15795/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15795/en/model_doc/mbart#transformers.MBartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ps=new U({}),Cs=new q({props:{name:"class transformers.TFMBartForConditionalGeneration",anchor:"transformers.TFMBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15795/src/transformers/models/mbart/modeling_tf_mbart.py#L1225",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15795/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15795/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),un=new at({props:{$$slots:{default:[Wz]},$$scope:{ctx:E}}}),Ns=new q({props:{name:"call",anchor:"transformers.TFMBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15795/src/transformers/models/mbart/modeling_tf_mbart.py#L1258",parametersDescription:[{anchor:"transformers.TFMBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15795/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_15795/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15795/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
adding special tokens. The special tokens depend on calling set_lang.`),Vw.forEach(t),jg=l(Ct),Da=a(Ct,"P",{});var Vh=s(Da);Eg=i(Vh,"An MBART-50 sequence has the following format, where "),Tl=a(Vh,"CODE",{});var Qw=s(Tl);Pg=i(Qw,"X"),Qw.forEach(t),Cg=i(Vh," represents the sequence:"),Vh.forEach(t),Sg=l(Ct),La=a(Ct,"UL",{});var Qh=s(La);Ga=a(Qh,"LI",{});var Jh=s(Ga);Ml=a(Jh,"CODE",{});var Jw=s(Ml);Ag=i(Jw,"input_ids"),Jw.forEach(t),Ig=i(Jh," (for encoder) "),wl=a(Jh,"CODE",{});var Kw=s(wl);Ng=i(Kw,"[src_lang_code] X [eos]"),Kw.forEach(t),Jh.forEach(t),Og=l(Qh),Wa=a(Qh,"LI",{});var Kh=s(Wa);xl=a(Kh,"CODE",{});var Zw=s(xl);Dg=i(Zw,"labels"),Zw.forEach(t),Lg=i(Kh,": (for decoder) "),zl=a(Kh,"CODE",{});var Yw=s(zl);Gg=i(Yw,"[tgt_lang_code] X [eos]"),Yw.forEach(t),Kh.forEach(t),Qh.forEach(t),Wg=l(Ct),ql=a(Ct,"P",{});var e5=s(ql);Rg=i(e5,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),e5.forEach(t),Ct.forEach(t),Ug=l(ue),Ko=a(ue,"DIV",{class:!0});var Zh=s(Ko);f(Ra.$$.fragment,Zh),Xg=l(Zh),Bl=a(Zh,"P",{});var t5=s(Bl);Hg=i(t5,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),t5.forEach(t),Zh.forEach(t),Vg=l(ue),Zo=a(ue,"DIV",{class:!0});var Yh=s(Zo);f(Ua.$$.fragment,Yh),Qg=l(Yh),$l=a(Yh,"P",{});var o5=s($l);Jg=i(o5,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),o5.forEach(t),Yh.forEach(t),ue.forEach(t),Gp=l(o),po=a(o,"H2",{class:!0});var eu=s(po);Yo=a(eu,"A",{id:!0,class:!0,href:!0});var n5=s(Yo);Fl=a(n5,"SPAN",{});var a5=s(Fl);f(Xa.$$.fragment,a5),a5.forEach(t),n5.forEach(t),Kg=l(eu),jl=a(eu,"SPAN",{});var s5=s(jl);Zg=i(s5,"MBartModel"),s5.forEach(t),eu.forEach(t),Wp=l(o),Qe=a(o,"DIV",{class:!0});var Bn=s(Qe);f(Ha.$$.fragment,Bn),Yg=l(Bn),Va=a(Bn,"P",{});var tu=s(Va);ek=i(tu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),_i=a(tu,"A",{href:!0});var r5=s(_i);tk=i(r5,"PreTrainedModel"),r5.forEach(t),ok=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tu.forEach(t),nk=l(Bn),Qa=a(Bn,"P",{});var ou=s(Qa);ak=i(ou,"This model is also a PyTorch "),Ja=a(ou,"A",{href:!0,rel:!0});var i5=s(Ja);sk=i(i5,"torch.nn.Module"),i5.forEach(t),rk=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),ik=l(Bn),Se=a(Bn,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),ho=a(St,"P",{});var Oi=s(ho);lk=i(Oi,"The "),gi=a(Oi,"A",{href:!0});var d5=s(gi);ck=i(d5,"MBartModel"),d5.forEach(t),pk=i(Oi," forward method, overrides the "),El=a(Oi,"CODE",{});var l5=s(El);hk=i(l5,"__call__"),l5.forEach(t),uk=i(Oi," special method."),Oi.forEach(t),mk=l(St),f(en.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var c5=s(Pl);_k=i(c5,"Example:"),c5.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bn.forEach(t),Rp=l(o),uo=a(o,"H2",{class:!0});var nu=s(uo);tn=a(nu,"A",{id:!0,class:!0,href:!0});var p5=s(tn);Cl=a(p5,"SPAN",{});var h5=s(Cl);f(Ya.$$.fragment,h5),h5.forEach(t),p5.forEach(t),kk=l(nu),Sl=a(nu,"SPAN",{});var u5=s(Sl);bk=i(u5,"MBartForConditionalGeneration"),u5.forEach(t),nu.forEach(t),Up=l(o),Je=a(o,"DIV",{class:!0});var $n=s(Je);f(es.$$.fragment,$n),vk=l($n),ts=a($n,"P",{});var au=s(ts);yk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),ki=a(au,"A",{href:!0});var m5=s(ki);Tk=i(m5,"PreTrainedModel"),m5.forEach(t),Mk=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l($n),os=a($n,"P",{});var su=s(os);xk=i(su,"This model is also a PyTorch "),ns=a(su,"A",{href:!0,rel:!0});var f5=s(ns);zk=i(f5,"torch.nn.Module"),f5.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l($n),Z=a($n,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),$k=l(Le),mo=a(Le,"P",{});var Di=s(mo);Fk=i(Di,"The "),bi=a(Di,"A",{href:!0});var _5=s(bi);jk=i(_5,"MBartForConditionalGeneration"),_5.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var g5=s(Al);Pk=i(g5,"__call__"),g5.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(on.$$.fragment,Le),Ak=l(Le),Il=a(Le,"P",{});var k5=s(Il);Ik=i(k5,"Translation example:"),k5.forEach(t),Nk=l(Le),f(ss.$$.fragment,Le),Ok=l(Le),Nl=a(Le,"P",{});var b5=s(Nl);Dk=i(b5,"Mask filling example:"),b5.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),$n.forEach(t),Xp=l(o),fo=a(o,"H2",{class:!0});var ru=s(fo);nn=a(ru,"A",{id:!0,class:!0,href:!0});var v5=s(nn);Ol=a(v5,"SPAN",{});var y5=s(Ol);f(is.$$.fragment,y5),y5.forEach(t),v5.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var T5=s(Dl);Wk=i(T5,"MBartForQuestionAnswering"),T5.forEach(t),ru.forEach(t),Hp=l(o),qe=a(o,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_o=a(At,"P",{});var Li=s(_o);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var M5=s(Ll);Xk=i(M5,"span start logits"),M5.forEach(t),Hk=i(Li," and "),Gl=a(Li,"CODE",{});var w5=s(Gl);Vk=i(w5,"span end logits"),w5.forEach(t),Qk=i(Li,")."),Li.forEach(t),Jk=l(At),ls=a(At,"P",{});var iu=s(ls);Kk=i(iu,"This model inherits from "),vi=a(iu,"A",{href:!0});var x5=s(vi);Zk=i(x5,"PreTrainedModel"),x5.forEach(t),Yk=i(iu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),iu.forEach(t),eb=l(At),cs=a(At,"P",{});var du=s(cs);tb=i(du,"This model is also a PyTorch "),ps=a(du,"A",{href:!0,rel:!0});var z5=s(ps);ob=i(z5,"torch.nn.Module"),z5.forEach(t),nb=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var It=s(Ae);f(hs.$$.fragment,It),sb=l(It),go=a(It,"P",{});var Gi=s(go);rb=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var q5=s(yi);ib=i(q5,"MBartForQuestionAnswering"),q5.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var B5=s(Wl);lb=i(B5,"__call__"),B5.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(It),f(an.$$.fragment,It),hb=l(It),Rl=a(It,"P",{});var $5=s(Rl);ub=i($5,"Example:"),$5.forEach(t),mb=l(It),f(us.$$.fragment,It),It.forEach(t),At.forEach(t),Vp=l(o),ko=a(o,"H2",{class:!0});var lu=s(ko);sn=a(lu,"A",{id:!0,class:!0,href:!0});var F5=s(sn);Ul=a(F5,"SPAN",{});var j5=s(Ul);f(ms.$$.fragment,j5),j5.forEach(t),F5.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var E5=s(Xl);_b=i(E5,"MBartForSequenceClassification"),E5.forEach(t),lu.forEach(t),Qp=l(o),Be=a(o,"DIV",{class:!0});var Nt=s(Be);f(fs.$$.fragment,Nt),gb=l(Nt),Hl=a(Nt,"P",{});var P5=s(Hl);kb=i(P5,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),P5.forEach(t),bb=l(Nt),_s=a(Nt,"P",{});var cu=s(_s);vb=i(cu,"This model inherits from "),Ti=a(cu,"A",{href:!0});var C5=s(Ti);yb=i(C5,"PreTrainedModel"),C5.forEach(t),Tb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),Mb=l(Nt),gs=a(Nt,"P",{});var pu=s(gs);wb=i(pu,"This model is also a PyTorch "),ks=a(pu,"A",{href:!0,rel:!0});var S5=s(ks);xb=i(S5,"torch.nn.Module"),S5.forEach(t),zb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(Nt),Y=a(Nt,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bo=a(Ge,"P",{});var Wi=s(bo);$b=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var A5=s(Mi);Fb=i(A5,"MBartForSequenceClassification"),A5.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var I5=s(Vl);Eb=i(I5,"__call__"),I5.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(rn.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var N5=s(Ql);Ab=i(N5,"Example of single-label classification:"),N5.forEach(t),Ib=l(Ge),f(vs.$$.fragment,Ge),Nb=l(Ge),Jl=a(Ge,"P",{});var O5=s(Jl);Ob=i(O5,"Example of multi-label classification:"),O5.forEach(t),Db=l(Ge),f(ys.$$.fragment,Ge),Ge.forEach(t),Nt.forEach(t),Jp=l(o),vo=a(o,"H2",{class:!0});var hu=s(vo);dn=a(hu,"A",{id:!0,class:!0,href:!0});var D5=s(dn);Kl=a(D5,"SPAN",{});var L5=s(Kl);f(Ts.$$.fragment,L5),L5.forEach(t),D5.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var G5=s(Zl);Gb=i(G5,"MBartForCausalLM"),G5.forEach(t),hu.forEach(t),Kp=l(o),yo=a(o,"DIV",{class:!0});var uu=s(yo);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var W5=s(Yl);Ub=i(W5,"Example:"),W5.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(o),To=a(o,"H2",{class:!0});var mu=s(To);ln=a(mu,"A",{id:!0,class:!0,href:!0});var R5=s(ln);ec=a(R5,"SPAN",{});var U5=s(ec);f(zs.$$.fragment,U5),U5.forEach(t),R5.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var X5=s(tc);Vb=i(X5,"TFMBartModel"),X5.forEach(t),mu.forEach(t),Yp=l(o),$e=a(o,"DIV",{class:!0});var Ot=s($e);f(qs.$$.fragment,Ot),Qb=l(Ot),Bs=a(Ot,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),wi=a(fu,"A",{href:!0});var H5=s(wi);Kb=i(H5,"TFPreTrainedModel"),H5.forEach(t),Zb=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Ot),$s=a(Ot,"P",{});var _u=s($s);ev=i(_u,"This model is also a "),Fs=a(_u,"A",{href:!0,rel:!0});var V5=s(Fs);tv=i(V5,"tf.keras.Model"),V5.forEach(t),ov=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),nv=l(Ot),f(cn.$$.fragment,Ot),av=l(Ot),Ie=a(Ot,"DIV",{class:!0});var Dt=s(Ie);f(js.$$.fragment,Dt),sv=l(Dt),Mo=a(Dt,"P",{});var Ui=s(Mo);rv=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Q5=s(xi);iv=i(Q5,"TFMBartModel"),Q5.forEach(t),dv=i(Ui," forward method, overrides the "),oc=a(Ui,"CODE",{});var J5=s(oc);lv=i(J5,"__call__"),J5.forEach(t),cv=i(Ui," special method."),Ui.forEach(t),pv=l(Dt),f(pn.$$.fragment,Dt),hv=l(Dt),nc=a(Dt,"P",{});var K5=s(nc);uv=i(K5,"Example:"),K5.forEach(t),mv=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Ot.forEach(t),eh=l(o),wo=a(o,"H2",{class:!0});var gu=s(wo);hn=a(gu,"A",{id:!0,class:!0,href:!0});var Z5=s(hn);ac=a(Z5,"SPAN",{});var Y5=s(ac);f(Ps.$$.fragment,Y5),Y5.forEach(t),Z5.forEach(t),fv=l(gu),sc=a(gu,"SPAN",{});var ex=s(sc);_v=i(ex,"TFMBartForConditionalGeneration"),ex.forEach(t),gu.forEach(t),th=l(o),Fe=a(o,"DIV",{class:!0});var Lt=s(Fe);f(Cs.$$.fragment,Lt),gv=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);kv=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
