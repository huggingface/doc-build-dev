import{S as xi,i as ji,s as $i,e as a,k as i,w as u,t as n,L as qi,c as s,d as o,m as c,a as d,x as g,h as r,b as l,J as e,g as m,y as _,q as b,o as v,B as y}from"../../chunks/vendor-9e2b328e.js";import{T as dd}from"../../chunks/Tip-76f97a76.js";import{D as O}from"../../chunks/Docstring-50fd6873.js";import{C as Me}from"../../chunks/CodeBlock-88e23343.js";import{I as Rt}from"../../chunks/IconCopyLink-fd0e58fd.js";import"../../chunks/CopyButton-4ae140ab.js";function Pi(Q){let h,x,f,w,P;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=n("Module"),P=n(`
...
the latter silently ignores them.`)},l(k){h=s(k,"P",{});var T=d(h);x=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){m(k,h,T),e(h,x),e(h,f),e(f,w),e(h,P)},d(k){k&&o(h)}}}function Ai(Q){let h,x,f,w,P,k,T,F,zn,Gt,he,Mn,wo,xn,jn,Ut,me,$n,xe,qn,Pn,Vt,fe,Fn,Eo,Cn,An,Ht,W,Sn,Do,Nn,In,je,Ln,Bn,Jt,R,On,Qo,Wn,Rn,Xo,Gn,Un,Yt,$e,Zt,G,Vn,qe,Hn,Jn,Pe,Yn,Zn,Kt,X,ue,et,Fe,Kn,ot,Qn,Qt,M,Ce,Xn,ge,zo,er,or,Mo,tr,nr,rr,ee,ar,xo,sr,dr,jo,ir,cr,lr,tt,pr,hr,Ae,mr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,oe,yr,nt,kr,Tr,rt,wr,Er,Xt,te,ve,at,Le,Dr,st,zr,en,E,Be,Mr,ne,xr,dt,jr,$r,it,qr,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ct,Ir,Lr,Re,Br,qo,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Jr,Yr,lt,Zr,Kr,pt,Qr,Xr,ea,C,Ve,oa,re,ta,Fo,na,ra,ht,aa,sa,da,ye,ia,mt,ca,la,He,pa,A,Je,ha,ft,ma,fa,ae,ua,ut,ga,_a,gt,ba,va,ya,_t,ka,Ta,Ye,on,se,ke,bt,Ze,wa,vt,Ea,tn,D,Ke,Da,de,za,yt,Ma,xa,kt,ja,$a,qa,Qe,Pa,Xe,Fa,Ca,Aa,Tt,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,to,Ra,Ga,Ua,V,Ao,Va,Ha,wt,Ja,Ya,Et,Za,Ka,Qa,S,no,Xa,ie,es,So,os,ts,Dt,ns,rs,as,Te,ss,zt,ds,is,ro,cs,L,ao,ls,Mt,ps,hs,xt,ms,fs,so,nn,ce,we,jt,io,us,$t,gs,rn,z,co,_s,le,bs,qt,vs,ys,Pt,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Ft,xs,js,ho,$s,No,qs,Ps,Fs,mo,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,Ct,Bs,Os,At,Ws,Rs,Gs,N,uo,Us,pe,Vs,Lo,Hs,Js,St,Ys,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,bo,an;return k=new Rt({}),$e=new Me({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),Fe=new Rt({}),Ce=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15297/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26",parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
Dictionary of keyword arguments. Notably:</p>
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/pr_15297/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/pr_15297/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
...
`,returnType:`
<p><a
  href="/docs/transformers/pr_15297/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),Ie=new O({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_15297/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
configuration. Check out the <a href="/docs/transformers/pr_15297/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ve=new O({props:{name:"forward",anchor:"transformers.EncoderDecoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15297/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L430",parametersDescription:[{anchor:"transformers.EncoderDecoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15297/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/pr_15297/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_15297/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15297/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>A <a
  href="/docs/transformers/pr_15297/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/pr_15297/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
and decoder for a summarization model as was shown in: `),je=a("a"),Ln=n("Text Summarization with Pretrained Encoders"),Bn=n(" by Yang Liu and Mirella Lapata."),Jt=i(),R=a("p"),On=n("The "),Qo=a("code"),Wn=n("from_pretrained()"),Rn=n(`currently doesn\u2019t support initializing the model from a
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Yt=i(),u($e.$$.fragment),Zt=i(),G=a("p"),Vn=n("This model was contributed by "),qe=a("a"),Hn=n("thomwolf"),Jn=n(`. This model\u2019s TensorFlow and Flax versions
...
:meth`),pt=a("em"),Qr=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xr=n(" class method for the decoder."),ea=i(),C=a("div"),u(Ve.$$.fragment),oa=i(),re=a("p"),ta=n("The "),Fo=a("a"),na=n("EncoderDecoderModel"),ra=n(" forward method, overrides the "),ht=a("code"),aa=n("__call__"),sa=n(" special method."),da=i(),u(ye.$$.fragment),ia=i(),mt=a("p"),ca=n("Examples:"),la=i(),u(He.$$.fragment),pa=i(),A=a("div"),u(Je.$$.fragment),ha=i(),ft=a("p"),ma=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Oo.forEach(o),Yt=c(t),g($e.$$.fragment,t),Zt=c(t),G=s(t,"P",{});var Wo=d(G);Vn=r(Wo,"This model was contributed by "),qe=s(Wo,"A",{href:!0,rel:!0});var gd=d(qe);Hn=r(gd,"thomwolf"),gd.forEach(o),Jn=r(Wo,`. This model\u2019s TensorFlow and Flax versions
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_n.forEach(o),Hr=c(j),U=s(j,"P",{});var yo=d(U);Po=s(yo,"A",{href:!0});var Id=d(Po);Jr=r(Id,"EncoderDecoderModel"),Id.forEach(o),Yr=r(yo,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
:meth`),pt=s(yo,"EM",{});var Bd=d(pt);Qr=r(Bd,"~transformers.AutoModelForCausalLM.from_pretrained"),Bd.forEach(o),Xr=r(yo," class method for the decoder."),yo.forEach(o),ea=c(j),C=s(j,"DIV",{class:!0});var J=d(C);g(Ve.$$.fragment,J),oa=c(J),re=s(J,"P",{});var Vo=d(re);ta=r(Vo,"The "),Fo=s(Vo,"A",{href:!0});var Od=d(Fo);na=r(Od,"EncoderDecoderModel"),Od.forEach(o),ra=r(Vo," forward method, overrides the "),ht=s(Vo,"CODE",{});var Wd=d(ht);aa=r(Wd,"__call__"),Wd.forEach(o),sa=r(Vo," special method."),Vo.forEach(o),da=c(J),g(ye.$$.fragment,J),ia=c(J),mt=s(J,"P",{});var Rd=d(mt);ca=r(Rd,"Examples:"),Rd.forEach(o),la=c(J),g(He.$$.fragment,J),J.forEach(o),pa=c(j),A=s(j,"DIV",{class:!0});var Y=d(A);g(Je.$$.fragment,Y),ha=c(Y),ft=s(Y,"P",{});var Gd=d(ft);ma=r(Gd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),gt=s(Ho,"CODE",{});var Vd=d(gt);ba=r(Vd,"model.train()"),Vd.forEach(o),va=r(Ho,"."),Ho.forEach(o),ya=c(Y),_t=s(Y,"P",{});var Hd=d(_t);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=c(Y),g(Ye.$$.fragment,Y),Y.forEach(o),j.forEach(o),on=c(t),se=s(t,"H2",{class:!0});var bn=d(se);ke=s(bn,"A",{id:!0,class:!0,href:!0});var Jd=d(ke);bt=s(Jd,"SPAN",{});var Yd=d(bt);g(Ze.$$.fragment,Yd),Yd.forEach(o),Jd.forEach(o),wa=c(bn),vt=s(bn,"SPAN",{});var Zd=d(vt);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),bn.forEach(o),tn=c(t),D=s(t,"DIV",{class:!0});var $=d(D);g(Ke.$$.fragment,$),Da=c($),de=s($,"P",{});var Jo=d(de);za=r(Jo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),yt=s(Jo,"CODE",{});var Kd=d(yt);Ma=r(Kd,"from_pretrained()"),Kd.forEach(o),xa=r(Jo,"function and the decoder is loaded via "),kt=s(Jo,"CODE",{});var Qd=d(kt);ja=r(Qd,"from_pretrained()"),Qd.forEach(o),$a=r(Jo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Jo.forEach(o),qa=c($),Qe=s($,"P",{});var vn=d(Qe);Pa=r(vn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
