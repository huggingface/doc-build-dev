...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_roberta.py#L738",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_17444/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_roberta.py#L905",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_roberta.py#L1060",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_roberta.py#L1176",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_roberta.py#L1275",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_roberta.py#L1373",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_roberta.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_17444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17444/src/transformers/models/roberta/modeling_flax_roberta.py#L789",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q$=p(),kh=n("p"),J$=r("Finally, this model supports inherent JAX features such as:"),V$=p(),Jt=n("ul"),vh=n("li"),tl=n("a"),K$=r("Just-In-Time (JIT) compilation"),G$=p(),yh=n("li"),ol=n("a"),X$=r("Automatic Differentiation"),Y$=p(),Th=n("li"),nl=n("a"),Z$=r("Vectorization"),e4=p(),wh=n("li"),sl=n("a"),t4=r("Parallelization"),o4=p(),jt=n("div"),y(al.$$.fragment),n4=p(),an=n("p"),s4=r("The "),$h=n("code"),a4=r("FlaxRobertaPreTrainedModel"),r4=r(" forward method, overrides the "),Fh=n("code"),i4=r("__call__"),l4=r(" special method."),d4=p(),y(Bs.$$.fragment),c4=p(),y(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),y(rl.$$.fragment),p4=p(),Rh=n("span"),h4=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),y(il.$$.fragment),m4=p(),Mh=n("p"),f4=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),u4=p(),ll=n("p"),g4=r("This model inherits from "),Ad=n("a"),_4=r("FlaxPreTrainedModel"),b4=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k4=p(),dl=n("p"),v4=r("This model is also a Flax Linen "),cl=n("a"),y4=r("flax.linen.Module"),T4=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w4=p(),Eh=n("p"),$4=r("Finally, this model supports inherent JAX features such as:"),F4=p(),Vt=n("ul"),zh=n("li"),pl=n("a"),x4=r("Just-In-Time (JIT) compilation"),R4=p(),qh=n("li"),hl=n("a"),M4=r("Automatic Differentiation"),E4=p(),Ch=n("li"),ml=n("a"),z4=r("Vectorization"),q4=p(),jh=n("li"),fl=n("a"),C4=r("Parallelization"),j4=p(),Pt=n("div"),y(ul.$$.fragment),P4=p(),ln=n("p"),L4=r("The "),Ph=n("code"),A4=r("FlaxRobertaPreTrainedModel"),O4=r(" forward method, overrides the "),Lh=n("code"),N4=r("__call__"),I4=r(" special method."),D4=p(),y(Qs.$$.fragment),S4=p(),y(Js.$$.fragment),Af=p(),dn=n("h2"),Vs=n("a"),Ah=n("span"),y(gl.$$.fragment),W4=p(),Oh=n("span"),B4=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),y(_l.$$.fragment),U4=p(),Nh=n("p"),H4=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Q4=p(),bl=n("p"),J4=r("This model inherits from "),Od=n("a"),V4=r("FlaxPreTrainedModel"),K4=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),G4=p(),kl=n("p"),X4=r("This model is also a Flax Linen "),vl=n("a"),Y4=r("flax.linen.Module"),Z4=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),e2=p(),Ih=n("p"),t2=r("Finally, this model supports inherent JAX features such as:"),o2=p(),Kt=n("ul"),Dh=n("li"),yl=n("a"),n2=r("Just-In-Time (JIT) compilation"),s2=p(),Sh=n("li"),Tl=n("a"),a2=r("Automatic Differentiation"),r2=p(),Wh=n("li"),wl=n("a"),i2=r("Vectorization"),l2=p(),Bh=n("li"),$l=n("a"),d2=r("Parallelization"),c2=p(),Lt=n("div"),y(Fl.$$.fragment),p2=p(),cn=n("p"),h2=r("The "),Uh=n("code"),m2=r("FlaxRobertaPreTrainedModel"),f2=r(" forward method, overrides the "),Hh=n("code"),u2=r("__call__"),g2=r(" special method."),_2=p(),y(Ks.$$.fragment),b2=p(),y(Gs.$$.fragment),Nf=p(),pn=n("h2"),Xs=n("a"),Qh=n("span"),y(xl.$$.fragment),k2=p(),Jh=n("span"),v2=r("FlaxRobertaForQuestionAnswering"),If=p(),Be=n("div"),y(Rl.$$.fragment),y2=p(),hn=n("p"),T2=r(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Uf.forEach(t),M_=h(Ye),T(Rn.$$.fragment,Ye),E_=h(Ye),Ia=s(Ye,"P",{});var Hf=a(Ia);z_=i(Hf,"This tokenizer inherits from "),nd=s(Hf,"A",{href:!0});var dF=a(nd);q_=i(dF,"PreTrainedTokenizerFast"),dF.forEach(t),C_=i(Hf,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Hf.forEach(t),j_=h(Ye),sd=s(Ye,"DIV",{class:!0});var cF=a(sd);T(Da.$$.fragment,cF),cF.forEach(t),Ye.forEach(t),Xm=h(o),yo=s(o,"H2",{class:!0});var Qf=a(yo);Mn=s(Qf,"A",{id:!0,class:!0,href:!0});var pF=a(Mn);Ec=s(pF,"SPAN",{});var hF=a(Ec);T(Sa.$$.fragment,hF),hF.forEach(t),pF.forEach(t),P_=h(Qf),zc=s(Qf,"SPAN",{});var mF=a(zc);L_=i(mF,"RobertaModel"),mF.forEach(t),Qf.forEach(t),Ym=h(o),Ae=s(o,"DIV",{class:!0});var Ze=a(Ae);T(Wa.$$.fragment,Ze),A_=h(Ze),qc=s(Ze,"P",{});var fF=a(qc);O_=i(fF,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),fF.forEach(t),N_=h(Ze),Ba=s(Ze,"P",{});var Jf=a(Ba);I_=i(Jf,"This model inherits from "),ad=s(Jf,"A",{href:!0});var uF=a(ad);D_=i(uF,"PreTrainedModel"),uF.forEach(t),S_=i(Jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
`),Ac=s(ft,"CODE",{});var yF=a(Ac);sb=i(yF,"add_cross_attention"),yF.forEach(t),ab=i(ft," set to "),Oc=s(ft,"CODE",{});var TF=a(Oc);rb=i(TF,"True"),TF.forEach(t),ib=i(ft,"; an "),Nc=s(ft,"CODE",{});var wF=a(Nc);lb=i(wF,"encoder_hidden_states"),wF.forEach(t),db=i(ft," is then expected as an input to the forward pass."),ft.forEach(t),cb=h(Ze),En=s(Ze,"P",{});var Bm=a(En);pb=i(Bm,".. _"),Ic=s(Bm,"EM",{});var $F=a(Ic);hb=i($F,"Attention is all you need"),$F.forEach(t),mb=i(Bm,": "),Ja=s(Bm,"A",{href:!0,rel:!0});var FF=a(Ja);fb=i(FF,"https://arxiv.org/abs/1706.03762"),FF.forEach(t),Bm.forEach(t),ub=h(Ze),$t=s(Ze,"DIV",{class:!0});var ea=a($t);T(Va.$$.fragment,ea),gb=h(ea),To=s(ea,"P",{});var Wd=a(To);_b=i(Wd,"The "),rd=s(Wd,"A",{href:!0});var xF=a(rd);bb=i(xF,"RobertaModel"),xF.forEach(t),kb=i(Wd," forward method, overrides the "),Dc=s(Wd,"CODE",{});var RF=a(Dc);vb=i(RF,"__call__"),RF.forEach(t),yb=i(Wd," special method."),Wd.forEach(t),Tb=h(ea),T(zn.$$.fragment,ea),wb=h(ea),T(qn.$$.fragment,ea),ea.forEach(t),Ze.forEach(t),Zm=h(o),wo=s(o,"H2",{class:!0});var Gf=a(wo);Cn=s(Gf,"A",{id:!0,class:!0,href:!0});var MF=a(Cn);Sc=s(MF,"SPAN",{});var EF=a(Sc);T(Ka.$$.fragment,EF),EF.forEach(t),MF.forEach(t),$b=h(Gf),Wc=s(Gf,"SPAN",{});var zF=a(Wc);Fb=i(zF,"RobertaForCausalLM"),zF.forEach(t),Gf.forEach(t),ef=h(o),tt=s(o,"DIV",{class:!0});var oo=a(tt);T(Ga.$$.fragment,oo),xb=h(oo),Xa=s(oo,"P",{});var Xf=a(Xa);Rb=i(Xf,"RoBERTa Model with a "),Bc=s(Xf,"CODE",{});var qF=a(Bc);Mb=i(qF,"language modeling"),qF.forEach(t),Eb=i(Xf," head on top for CLM fine-tuning."),Xf.forEach(t),zb=h(oo),Ya=s(oo,"P",{});var Yf=a(Ya);qb=i(Yf,"This model inherits from "),id=s(Yf,"A",{href:!0});var CF=a(id);Cb=i(CF,"PreTrainedModel"),CF.forEach(t),jb=i(Yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nu.forEach(t),ik=h(no),it=s(no,"DIV",{class:!0});var so=a(it);T(lr.$$.fragment,so),lk=h(so),xo=s(so,"P",{});var Ud=a(xo);dk=i(Ud,"The "),cd=s(Ud,"A",{href:!0});var WF=a(cd);ck=i(WF,"RobertaForMaskedLM"),WF.forEach(t),pk=i(Ud," forward method, overrides the "),Vc=s(Ud,"CODE",{});var BF=a(Vc);hk=i(BF,"__call__"),BF.forEach(t),mk=i(Ud," special method."),Ud.forEach(t),fk=h(so),T(An.$$.fragment,so),uk=h(so),T(On.$$.fragment,so),gk=h(so),T(Nn.$$.fragment,so),so.forEach(t),no.forEach(t),nf=h(o),Ro=s(o,"H2",{class:!0});var su=a(Ro);In=s(su,"A",{id:!0,class:!0,href:!0});var UF=a(In);Kc=s(UF,"SPAN",{});var HF=a(Kc);T(dr.$$.fragment,HF),HF.forEach(t),UF.forEach(t),_k=h(su),Gc=s(su,"SPAN",{});var QF=a(Gc);bk=i(QF,"RobertaForSequenceClassification"),QF.forEach(t),su.forEach(t),sf=h(o),nt=s(o,"DIV",{class:!0});var ao=a(nt);T(cr.$$.fragment,ao),kk=h(ao),Xc=s(ao,"P",{});var JF=a(Xc);vk=i(JF,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),JF.forEach(t),yk=h(ao),pr=s(ao,"P",{});var au=a(pr);Tk=i(au,"This model inherits from "),pd=s(au,"A",{href:!0});var VF=a(pd);wk=i(VF,"PreTrainedModel"),VF.forEach(t),$k=i(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru.forEach(t),Ek=h(ao),Ue=s(ao,"DIV",{class:!0});var ut=a(Ue);T(fr.$$.fragment,ut),zk=h(ut),Mo=s(ut,"P",{});var Hd=a(Mo);qk=i(Hd,"The "),hd=s(Hd,"A",{href:!0});var GF=a(hd);Ck=i(GF,"RobertaForSequenceClassification"),GF.forEach(t),jk=i(Hd," forward method, overrides the "),Yc=s(Hd,"CODE",{});var XF=a(Yc);Pk=i(XF,"__call__"),XF.forEach(t),Lk=i(Hd," special method."),Hd.forEach(t),Ak=h(ut),T(Dn.$$.fragment,ut),Ok=h(ut),T(Sn.$$.fragment,ut),Nk=h(ut),T(Wn.$$.fragment,ut),Ik=h(ut),T(Bn.$$.fragment,ut),Dk=h(ut),T(Un.$$.fragment,ut),ut.forEach(t),ao.forEach(t),af=h(o),Eo=s(o,"H2",{class:!0});var iu=a(Eo);Hn=s(iu,"A",{id:!0,class:!0,href:!0});var YF=a(Hn);Zc=s(YF,"SPAN",{});var ZF=a(Zc);T(ur.$$.fragment,ZF),ZF.forEach(t),YF.forEach(t),Sk=h(iu),ep=s(iu,"SPAN",{});var e0=a(ep);Wk=i(e0,"RobertaForMultipleChoice"),e0.forEach(t),iu.forEach(t),rf=h(o),st=s(o,"DIV",{class:!0});var ro=a(st);T(gr.$$.fragment,ro),Bk=h(ro),tp=s(ro,"P",{});var t0=a(tp);Uk=i(t0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),t0.forEach(t),Hk=h(ro),_r=s(ro,"P",{});var lu=a(_r);Qk=i(lu,"This model inherits from "),md=s(lu,"A",{href:!0});var o0=a(md);Jk=i(o0,"PreTrainedModel"),o0.forEach(t),Vk=i(lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lu.forEach(t),Kk=h(ro),br=s(ro,"P",{});var du=a(br);Gk=i(du,"This model is also a PyTorch "),kr=s(du,"A",{href:!0,rel:!0});var n0=a(kr);Xk=i(n0,"torch.nn.Module"),n0.forEach(t),Yk=i(du,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);T(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s0=a(fd);ov=i(s0,"RobertaForMultipleChoice"),s0.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a0=a(op);sv=i(a0,"__call__"),a0.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),T(Qn.$$.fragment,oa),iv=h(oa),T(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cu=a(qo);Vn=s(cu,"A",{id:!0,class:!0,href:!0});var r0=a(Vn);np=s(r0,"SPAN",{});var i0=a(np);T(yr.$$.fragment,i0),i0.forEach(t),r0.forEach(t),lv=h(cu),sp=s(cu,"SPAN",{});var l0=a(sp);dv=i(l0,"RobertaForTokenClassification"),l0.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);T(Tr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var d0=a(ap);pv=i(d0,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d0.forEach(t),hv=h(io),wr=s(io,"P",{});var pu=a(wr);mv=i(pu,"This model inherits from "),ud=s(pu,"A",{href:!0});var c0=a(ud);fv=i(c0,"PreTrainedModel"),c0.forEach(t),uv=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),gv=h(io),$r=s(io,"P",{});var hu=a($r);_v=i(hu,"This model is also a PyTorch "),Fr=s(hu,"A",{href:!0,rel:!0});var p0=a(Fr);bv=i(p0,"torch.nn.Module"),p0.forEach(t),kv=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);T(xr.$$.fragment,lo),yv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);Tv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h0=a(gd);wv=i(h0,"RobertaForTokenClassification"),h0.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var m0=a(rp);Fv=i(m0,"__call__"),m0.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),T(Kn.$$.fragment,lo),Mv=h(lo),T(Gn.$$.fragment,lo),Ev=h(lo),T(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var f0=a(Yn);ip=s(f0,"SPAN",{});var u0=a(ip);T(Rr.$$.fragment,u0),u0.forEach(t),f0.forEach(t),zv=h(mu),lp=s(mu,"SPAN",{});var g0=a(lp);qv=i(g0,"RobertaForQuestionAnswering"),g0.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);T(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _0=a(dp);Pv=i(_0,"span start logits"),_0.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var b0=a(cp);Av=i(b0,"span end logits"),b0.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fu=a(Er);Iv=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var k0=a(_d);Dv=i(k0,"PreTrainedModel"),k0.forEach(t),Sv=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Wv=h(co),zr=s(co,"P",{});var uu=a(zr);Bv=i(uu,"This model is also a PyTorch "),qr=s(uu,"A",{href:!0,rel:!0});var v0=a(qr);Uv=i(v0,"torch.nn.Module"),v0.forEach(t),Hv=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);T(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var y0=a(bd);Kv=i(y0,"RobertaForQuestionAnswering"),y0.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var T0=a(pp);Xv=i(T0,"__call__"),T0.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),T(Zn.$$.fragment,po),ey=h(po),T(es.$$.fragment,po),ty=h(po),T(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w0=a(os);hp=s(w0,"SPAN",{});var $0=a(hp);T(jr.$$.fragment,$0),$0.forEach(t),w0.forEach(t),oy=h(gu),mp=s(gu,"SPAN",{});var F0=a(mp);ny=i(F0,"TFRobertaModel"),F0.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);T(Pr.$$.fragment,Ot),sy=h(Ot),fp=s(Ot,"P",{});var x0=a(fp);ay=i(x0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x0.forEach(t),ry=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iy=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R0=a(kd);ly=i(R0,"TFPreTrainedModel"),R0.forEach(t),dy=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),cy=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);py=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var M0=a(Or);hy=i(M0,"tf.keras.Model"),M0.forEach(t),my=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fy=h(Ot),T(ns.$$.fragment,Ot),uy=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);T(Nr.$$.fragment,na),gy=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_y=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E0=a(vd);by=i(E0,"TFRobertaModel"),E0.forEach(t),ky=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z0=a(up);vy=i(z0,"__call__"),z0.forEach(t),yy=i(Gd," special method."),Gd.forEach(t),Ty=h(na),T(ss.$$.fragment,na),wy=h(na),T(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var q0=a(rs);gp=s(q0,"SPAN",{});var C0=a(gp);T(Ir.$$.fragment,C0),C0.forEach(t),q0.forEach(t),$y=h(ku),_p=s(ku,"SPAN",{});var j0=a(_p);Fy=i(j0,"TFRobertaForCausalLM"),j0.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);T(Dr.$$.fragment,vu),xy=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);T(Sr.$$.fragment,sa),Ry=h(sa),Do=s(sa,"P",{});var Xd=a(Do);My=i(Xd,"The "),yd=s(Xd,"A",{href:!0});var P0=a(yd);Ey=i(P0,"TFRobertaForCausalLM"),P0.forEach(t),zy=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L0=a(bp);qy=i(L0,"__call__"),L0.forEach(t),Cy=i(Xd," special method."),Xd.forEach(t),jy=h(sa),T(is.$$.fragment,sa),Py=h(sa),T(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var yu=a(So);ds=s(yu,"A",{id:!0,class:!0,href:!0});var A0=a(ds);kp=s(A0,"SPAN",{});var O0=a(kp);T(Wr.$$.fragment,O0),O0.forEach(t),A0.forEach(t),Ly=h(yu),vp=s(yu,"SPAN",{});var N0=a(vp);Ay=i(N0,"TFRobertaForMaskedLM"),N0.forEach(t),yu.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);T(Br.$$.fragment,Nt),Oy=h(Nt),Ur=s(Nt,"P",{});var Tu=a(Ur);Ny=i(Tu,"RoBERTa Model with a "),yp=s(Tu,"CODE",{});var I0=a(yp);Iy=i(I0,"language modeling"),I0.forEach(t),Dy=i(Tu," head on top."),Tu.forEach(t),Sy=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);Wy=i(wu,"This model inherits from "),Td=s(wu,"A",{href:!0});var D0=a(Td);By=i(D0,"TFPreTrainedModel"),D0.forEach(t),Uy=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),Hy=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);Qy=i($u,"This model is also a "),Jr=s($u,"A",{href:!0,rel:!0});var S0=a(Jr);Jy=i(S0,"tf.keras.Model"),S0.forEach(t),Vy=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),Ky=h(Nt),T(cs.$$.fragment,Nt),Gy=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);T(Vr.$$.fragment,ho),Xy=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Yy=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W0=a(wd);Zy=i(W0,"TFRobertaForMaskedLM"),W0.forEach(t),eT=i(Yd," forward method, overrides the "),Tp=s(Yd,"CODE",{});var B0=a(Tp);tT=i(B0,"__call__"),B0.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),T(ps.$$.fragment,ho),sT=h(ho),T(hs.$$.fragment,ho),aT=h(ho),T(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U0=a(fs);wp=s(U0,"SPAN",{});var H0=a(wp);T(Kr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),rT=h(Fu),$p=s(Fu,"SPAN",{});var Q0=a($p);iT=i(Q0,"TFRobertaForSequenceClassification"),Q0.forEach(t),Fu.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);T(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var J0=a(Fp);dT=i(J0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J0.forEach(t),cT=h(It),Xr=s(It,"P",{});var xu=a(Xr);pT=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var V0=a($d);hT=i(V0,"TFPreTrainedModel"),V0.forEach(t),mT=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),fT=h(It),Yr=s(It,"P",{});var Ru=a(Yr);uT=i(Ru,"This model is also a "),Zr=s(Ru,"A",{href:!0,rel:!0});var K0=a(Zr);gT=i(K0,"tf.keras.Model"),K0.forEach(t),_T=i(Ru,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),T(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);T(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);yT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G0=a(Fd);TT=i(G0,"TFRobertaForSequenceClassification"),G0.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X0=a(xp);$T=i(X0,"__call__"),X0.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),T(gs.$$.fragment,mo),RT=h(mo),T(_s.$$.fragment,mo),MT=h(mo),T(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y0=a(ks);Rp=s(Y0,"SPAN",{});var Z0=a(Rp);T(ti.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zT=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),yf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);T(oi.$$.fragment,Dt),qT=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);CT=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),T(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);T(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sx=a(Rd);HT=i(sx,"TFRobertaForMultipleChoice"),sx.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var ax=a(zp);JT=i(ax,"__call__"),ax.forEach(t),VT=i(ec," special method."),ec.forEach(t),KT=h(aa),T(ys.$$.fragment,aa),GT=h(aa),T(Ts.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),Tf=h(o),Jo=s(o,"H2",{class:!0});var qu=a(Jo);ws=s(qu,"A",{id:!0,class:!0,href:!0});var rx=a(ws);qp=s(rx,"SPAN",{});var ix=a(qp);T(ii.$$.fragment,ix),ix.forEach(t),rx.forEach(t),XT=h(qu),Cp=s(qu,"SPAN",{});var lx=a(Cp);YT=i(lx,"TFRobertaForTokenClassification"),lx.forEach(t),qu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);T(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var dx=a(jp);ew=i(dx,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dx.forEach(t),tw=h(St),di=s(St,"P",{});var Cu=a(di);ow=i(Cu,"This model inherits from "),Md=s(Cu,"A",{href:!0});var cx=a(Md);nw=i(cx,"TFPreTrainedModel"),cx.forEach(t),sw=i(Cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cu.forEach(t),aw=h(St),ci=s(St,"P",{});var ju=a(ci);rw=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var px=a(pi);iw=i(px,"tf.keras.Model"),px.forEach(t),lw=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dw=h(St),T($s.$$.fragment,St),cw=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);T(hi.$$.fragment,fo),pw=h(fo),Vo=s(fo,"P",{});var tc=a(Vo);hw=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hx=a(Ed);mw=i(hx,"TFRobertaForTokenClassification"),hx.forEach(t),fw=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mx=a(Pp);uw=i(mx,"__call__"),mx.forEach(t),gw=i(tc," special method."),tc.forEach(t),_w=h(fo),T(Fs.$$.fragment,fo),bw=h(fo),T(xs.$$.fragment,fo),kw=h(fo),T(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fx=a(Ms);Lp=s(fx,"SPAN",{});var ux=a(Lp);T(mi.$$.fragment,ux),ux.forEach(t),fx.forEach(t),vw=h(Pu),Ap=s(Pu,"SPAN",{});var gx=a(Ap);yw=i(gx,"TFRobertaForQuestionAnswering"),gx.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);T(fi.$$.fragment,Wt),Tw=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);ww=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _x=a(Op);$w=i(_x,"span start logits"),_x.forEach(t),Fw=i(oc," and "),Np=s(oc,"CODE",{});var bx=a(Np);xw=i(bx,"span end logits"),bx.forEach(t),Rw=i(oc,")."),oc.forEach(t),Mw=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ew=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var kx=a(zd);zw=i(kx,"TFPreTrainedModel"),kx.forEach(t),qw=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),Cw=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jw=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var vx=a(_i);Pw=i(vx,"tf.keras.Model"),vx.forEach(t),Lw=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Aw=h(Wt),T(Es.$$.fragment,Wt),Ow=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);T(bi.$$.fragment,uo),Nw=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iw=i(nc,"The "),qd=s(nc,"A",{href:!0});var yx=a(qd);Dw=i(yx,"TFRobertaForQuestionAnswering"),yx.forEach(t),Sw=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var Tx=a(Ip);Ww=i(Tx,"__call__"),Tx.forEach(t),Bw=i(nc," special method."),nc.forEach(t),Uw=h(uo),T(zs.$$.fragment,uo),Hw=h(uo),T(qs.$$.fragment,uo),Qw=h(uo),T(Cs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wx=a(js);Dp=s(wx,"SPAN",{});var $x=a(Dp);T(ki.$$.fragment,$x),$x.forEach(t),wx.forEach(t),Jw=h(Ou),Sp=s(Ou,"SPAN",{});var Fx=a(Sp);Vw=i(Fx,"FlaxRobertaModel"),Fx.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);T(vi.$$.fragment,gt),Kw=h(gt),Wp=s(gt,"P",{});var xx=a(Wp);Gw=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),Xw=h(gt),yi=s(gt,"P",{});var Nu=a(yi);Yw=i(Nu,"This model inherits from "),Cd=s(Nu,"A",{href:!0});var Rx=a(Cd);Zw=i(Rx,"FlaxPreTrainedModel"),Rx.forEach(t),e1=i(Nu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ku.forEach(t),Q$=h(kt),kh=s(kt,"P",{});var xR=a(kh);J$=i(xR,"Finally, this model supports inherent JAX features such as:"),xR.forEach(t),V$=h(kt),Jt=s(kt,"UL",{});var ha=a(Jt);vh=s(ha,"LI",{});var RR=a(vh);tl=s(RR,"A",{href:!0,rel:!0});var MR=a(tl);K$=i(MR,"Just-In-Time (JIT) compilation"),MR.forEach(t),RR.forEach(t),G$=h(ha),yh=s(ha,"LI",{});var ER=a(yh);ol=s(ER,"A",{href:!0,rel:!0});var zR=a(ol);X$=i(zR,"Automatic Differentiation"),zR.forEach(t),ER.forEach(t),Y$=h(ha),Th=s(ha,"LI",{});var qR=a(Th);nl=s(qR,"A",{href:!0,rel:!0});var CR=a(nl);Z$=i(CR,"Vectorization"),CR.forEach(t),qR.forEach(t),e4=h(ha),wh=s(ha,"LI",{});var jR=a(wh);sl=s(jR,"A",{href:!0,rel:!0});var PR=a(sl);t4=i(PR,"Parallelization"),PR.forEach(t),jR.forEach(t),ha.forEach(t),o4=h(kt),jt=s(kt,"DIV",{class:!0});var ma=a(jt);T(al.$$.fragment,ma),n4=h(ma),an=s(ma,"P",{});var ic=a(an);s4=i(ic,"The "),$h=s(ic,"CODE",{});var LR=a($h);a4=i(LR,"FlaxRobertaPreTrainedModel"),LR.forEach(t),r4=i(ic," forward method, overrides the "),Fh=s(ic,"CODE",{});var AR=a(Fh);i4=i(AR,"__call__"),AR.forEach(t),l4=i(ic," special method."),ic.forEach(t),d4=h(ma),T(Bs.$$.fragment,ma),c4=h(ma),T(Us.$$.fragment,ma),ma.forEach(t),kt.forEach(t),Pf=h(o),rn=s(o,"H2",{class:!0});var Gu=a(rn);Hs=s(Gu,"A",{id:!0,class:!0,href:!0});var OR=a(Hs);xh=s(OR,"SPAN",{});var NR=a(xh);T(rl.$$.fragment,NR),NR.forEach(t),OR.forEach(t),p4=h(Gu),Rh=s(Gu,"SPAN",{});var IR=a(Rh);h4=i(IR,"FlaxRobertaForMultipleChoice"),IR.forEach(t),Gu.forEach(t),Lf=h(o),Se=s(o,"DIV",{class:!0});var vt=a(Se);T(il.$$.fragment,vt),m4=h(vt),Mh=s(vt,"P",{});var DR=a(Mh);f4=i(DR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DR.forEach(t),u4=h(vt),ll=s(vt,"P",{});var Xu=a(ll);g4=i(Xu,"This model inherits from "),Ad=s(Xu,"A",{href:!0});var SR=a(Ad);_4=i(SR,"FlaxPreTrainedModel"),SR.forEach(t),b4=i(Xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k4=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v4=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var WR=a(cl);y4=i(WR,"flax.linen.Module"),WR.forEach(t),T4=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w4=h(vt),Eh=s(vt,"P",{});var BR=a(Eh);$4=i(BR,"Finally, this model supports inherent JAX features such as:"),BR.forEach(t),F4=h(vt),Vt=s(vt,"UL",{});var fa=a(Vt);zh=s(fa,"LI",{});var UR=a(zh);pl=s(UR,"A",{href:!0,rel:!0});var HR=a(pl);x4=i(HR,"Just-In-Time (JIT) compilation"),HR.forEach(t),UR.forEach(t),R4=h(fa),qh=s(fa,"LI",{});var QR=a(qh);hl=s(QR,"A",{href:!0,rel:!0});var JR=a(hl);M4=i(JR,"Automatic Differentiation"),JR.forEach(t),QR.forEach(t),E4=h(fa),Ch=s(fa,"LI",{});var VR=a(Ch);ml=s(VR,"A",{href:!0,rel:!0});var KR=a(ml);z4=i(KR,"Vectorization"),KR.forEach(t),VR.forEach(t),q4=h(fa),jh=s(fa,"LI",{});var GR=a(jh);fl=s(GR,"A",{href:!0,rel:!0});var XR=a(fl);C4=i(XR,"Parallelization"),XR.forEach(t),GR.forEach(t),fa.forEach(t),j4=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);T(ul.$$.fragment,ua),P4=h(ua),ln=s(ua,"P",{});var lc=a(ln);L4=i(lc,"The "),Ph=s(lc,"CODE",{});var YR=a(Ph);A4=i(YR,"FlaxRobertaPreTrainedModel"),YR.forEach(t),O4=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZR=a(Lh);N4=i(ZR,"__call__"),ZR.forEach(t),I4=i(lc," special method."),lc.forEach(t),D4=h(ua),T(Qs.$$.fragment,ua),S4=h(ua),T(Js.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Vs=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Vs);Ah=s(eM,"SPAN",{});var tM=a(Ah);T(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W4=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B4=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var yt=a(We);T(_l.$$.fragment,yt),U4=h(yt),Nh=s(yt,"P",{});var nM=a(Nh);H4=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nM.forEach(t),Q4=h(yt),bl=s(yt,"P",{});var eg=a(bl);J4=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sM=a(Od);V4=i(sM,"FlaxPreTrainedModel"),sM.forEach(t),K4=i(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),G4=h(yt),kl=s(yt,"P",{});var tg=a(kl);X4=i(tg,"This model is also a Flax Linen "),vl=s(tg,"A",{href:!0,rel:!0});var aM=a(vl);Y4=i(aM,"flax.linen.Module"),aM.forEach(t),Z4=i(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tg.forEach(t),e2=h(yt),Ih=s(yt,"P",{});var rM=a(Ih);t2=i(rM,"Finally, this model supports inherent JAX features such as:"),rM.forEach(t),o2=h(yt),Kt=s(yt,"UL",{});var ga=a(Kt);Dh=s(ga,"LI",{});var iM=a(Dh);yl=s(iM,"A",{href:!0,rel:!0});var lM=a(yl);n2=i(lM,"Just-In-Time (JIT) compilation"),lM.forEach(t),iM.forEach(t),s2=h(ga),Sh=s(ga,"LI",{});var dM=a(Sh);Tl=s(dM,"A",{href:!0,rel:!0});var cM=a(Tl);a2=i(cM,"Automatic Differentiation"),cM.forEach(t),dM.forEach(t),r2=h(ga),Wh=s(ga,"LI",{});var pM=a(Wh);wl=s(pM,"A",{href:!0,rel:!0});var hM=a(wl);i2=i(hM,"Vectorization"),hM.forEach(t),pM.forEach(t),l2=h(ga),Bh=s(ga,"LI",{});var mM=a(Bh);$l=s(mM,"A",{href:!0,rel:!0});var fM=a($l);d2=i(fM,"Parallelization"),fM.forEach(t),mM.forEach(t),ga.forEach(t),c2=h(yt),Lt=s(yt,"DIV",{class:!0});var _a=a(Lt);T(Fl.$$.fragment,_a),p2=h(_a),cn=s(_a,"P",{});var dc=a(cn);h2=i(dc,"The "),Uh=s(dc,"CODE",{});var uM=a(Uh);m2=i(uM,"FlaxRobertaPreTrainedModel"),uM.forEach(t),f2=i(dc," forward method, overrides the "),Hh=s(dc,"CODE",{});var gM=a(Hh);u2=i(gM,"__call__"),gM.forEach(t),g2=i(dc," special method."),dc.forEach(t),_2=h(_a),T(Ks.$$.fragment,_a),b2=h(_a),T(Gs.$$.fragment,_a),_a.forEach(t),yt.forEach(t),Nf=h(o),pn=s(o,"H2",{class:!0});var og=a(pn);Xs=s(og,"A",{id:!0,class:!0,href:!0});var _M=a(Xs);Qh=s(_M,"SPAN",{});var bM=a(Qh);T(xl.$$.fragment,bM),bM.forEach(t),_M.forEach(t),k2=h(og),Jh=s(og,"SPAN",{});var kM=a(Jh);v2=i(kM,"FlaxRobertaForQuestionAnswering"),kM.forEach(t),og.forEach(t),If=h(o),Be=s(o,"DIV",{class:!0});var Tt=a(Be);T(Rl.$$.fragment,Tt),y2=h(Tt),hn=s(Tt,"P",{});var cc=a(hn);T2=i(cc,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
