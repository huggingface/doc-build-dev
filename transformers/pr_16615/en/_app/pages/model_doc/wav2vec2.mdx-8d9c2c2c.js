...
instance of <a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.Wav2Vec2CTCTokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/pr_16615/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/pr_16615/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
<p>A <a
  href="/docs/transformers/pr_16615/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Whether or not <a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/pr_16615/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<a href="/docs/transformers/pr_16615/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/pr_16615/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/pr_16615/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
Tuple of <code>jnp.ndarray</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}]}}),Es=new V({props:{name:"replace",anchor:"transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput.replace",parameters:[{name:"**updates",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/flax/struct.py#L120"}}),Cs=new ee({}),qs=new V({props:{name:"class transformers.Wav2Vec2Model",anchor:"transformers.Wav2Vec2Model",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1237",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16615/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ls=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2Model.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"mask_time_indices",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",parametersDescription:[{anchor:"transformers.Wav2Vec2Model.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput"
>transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
<p>A <a
  href="/docs/transformers/pr_16615/en/main_classes/output#transformers.modeling_outputs.CausalLMOutput"
...
<span class="hljs-number">53.48</span>`}}),Js=new ee({}),Zs=new V({props:{name:"class transformers.Wav2Vec2ForSequenceClassification",anchor:"transformers.Wav2Vec2ForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16615/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),on=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),nn=new ee({}),rn=new V({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1900",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16615/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<span class="hljs-number">0.98</span>`}}),xn=new ee({}),Wn=new V({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1386",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16615/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),En=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"mask_time_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"sampled_negative_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<p>A <a
  href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(input_values, mask_time_indices=mask_time_indices).loss`}}),qn=new ee({}),Pn=new V({props:{name:"class transformers.TFWav2Vec2Model",anchor:"transformers.TFWav2Vec2Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1428",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16615/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[CT]},$$scope:{ctx:E}}}),On=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16615/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16615/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16615/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16615/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[PT]},$$scope:{ctx:E}}}),Hn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16615/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16615/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16615/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16615/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16615/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16615/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16615/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16615/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
`),Ja=s(ya,"A",{href:!0});var xb=n(Ja);pl=s(xb,"STRONG",{});var p1=n(pl);Vh=i(p1,"call"),p1.forEach(t),Fh=i(xb,"()"),xb.forEach(t),Eh=i(ya,". Please refer to the docstring of the above two methods for more information."),ya.forEach(t),Yd.forEach(t),Ch=c(R),Ao=s(R,"DIV",{class:!0});var ep=n(Ao);g(Za.$$.fragment,ep),qh=c(ep),ut=s(ep,"P",{});var ka=n(ut);Ph=i(ka,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
...
`),Xr=s(ka,"A",{href:!0});var f1=n(Xr);Lh=i(f1,"pad()"),f1.forEach(t),Dh=i(ka,". Please refer to the docstring of the above two methods for more information."),ka.forEach(t),ep.forEach(t),Sh=c(R),Gr=s(R,"DIV",{class:!0});var u1=n(Gr);g(Ka.$$.fragment,u1),u1.forEach(t),Nh=c(R),$t=s(R,"DIV",{class:!0});var ji=n($t);g(Qa.$$.fragment,ji),Ih=c(ji),Ya=s(ji,"P",{});var tp=n(Ya);Bh=i(tp,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Jr=s(tp,"A",{href:!0});var g1=n(Jr);Uh=i(g1,"from_pretrained()"),g1.forEach(t),Hh=i(tp," method."),tp.forEach(t),Rh=c(ji),g(Oo.$$.fragment,ji),ji.forEach(t),Xh=c(R),Lo=s(R,"DIV",{class:!0});var op=n(Lo);g(es.$$.fragment,op),Gh=c(op),ts=s(op,"P",{});var ap=n(ts);Jh=i(ap,"This method forwards all its arguments to PreTrainedTokenizer\u2019s "),Zr=s(ap,"A",{href:!0});var _1=n(Zr);Zh=i(_1,"batch_decode()"),_1.forEach(t),Kh=i(ap,`. Please
...
Wav2Vec2CTCTokenizer\u2019s `),ti=s(xa,"A",{href:!0});var F1=n(ti);Ff=i(F1,"pad()"),F1.forEach(t),Ef=i(xa,`. Please refer to the docstring of the above two methods
for more information.`),xa.forEach(t),cp.forEach(t),Cf=c(te),jt=s(te,"DIV",{class:!0});var Vi=n(jt);g(ps.$$.fragment,Vi),qf=c(Vi),ms=s(Vi,"P",{});var dp=n(ms);Pf=i(dp,"Instantiate a "),oi=s(dp,"A",{href:!0});var E1=n(oi);zf=i(E1,"Wav2Vec2ProcessorWithLM"),E1.forEach(t),Mf=i(dp," from a pretrained Wav2Vec2 processor."),dp.forEach(t),Af=c(Vi),g(Uo.$$.fragment,Vi),Vi.forEach(t),Of=c(te),ai=s(te,"DIV",{class:!0});var C1=n(ai);g(hs.$$.fragment,C1),C1.forEach(t),Lf=c(te),Vt=s(te,"DIV",{class:!0});var Fi=n(Vt);g(fs.$$.fragment,Fi),Df=c(Fi),vl=s(Fi,"P",{});var q1=n(vl);Sf=i(q1,"Batch decode output logits to audio transcription with language model support."),q1.forEach(t),Nf=c(Fi),g(Ho.$$.fragment,Fi),Fi.forEach(t),If=c(te),tt=s(te,"DIV",{class:!0});var Wa=n(tt);g(us.$$.fragment,Wa),Bf=c(Wa),wl=s(Wa,"P",{});var P1=n(wl);Uf=i(P1,"Decode output logits to audio transcription with language model support."),P1.forEach(t),Hf=c(Wa),bl=s(Wa,"P",{});var z1=n(bl);Rf=i(z1,"Example:"),z1.forEach(t),Xf=c(Wa),g(gs.$$.fragment,Wa),Wa.forEach(t),Gf=c(te),Ro=s(te,"DIV",{class:!0});var pp=n(Ro);g(_s.$$.fragment,pp),Jf=c(pp),yl=s(pp,"P",{});var M1=n(yl);Zf=i(M1,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Wav2Vec2.`),M1.forEach(t),pp.forEach(t),te.forEach(t),md=c(o),Qt=s(o,"H2",{class:!0});var mp=n(Qt);Xo=s(mp,"A",{id:!0,class:!0,href:!0});var A1=n(Xo);kl=s(A1,"SPAN",{});var O1=n(kl);g(vs.$$.fragment,O1),O1.forEach(t),A1.forEach(t),Kf=c(mp),Tl=s(mp,"SPAN",{});var L1=n(Tl);Qf=i(L1,"Wav2Vec2 specific outputs"),L1.forEach(t),mp.forEach(t),hd=c(o),Yt=s(o,"DIV",{class:!0});var hp=n(Yt);g(ws.$$.fragment,hp),Yf=c(hp),bs=s(hp,"P",{});var fp=n(bs);eu=i(fp,"Output type of "),xl=s(fp,"CODE",{});var D1=n(xl);tu=i(D1,"Wav2Vec2DecoderWithLM"),D1.forEach(t),ou=i(fp,", with transcription."),fp.forEach(t),hp.forEach(t),fd=c(o),eo=s(o,"DIV",{class:!0});var up=n(eo);g(ys.$$.fragment,up),au=c(up),ks=s(up,"P",{});var gp=n(ks);su=i(gp,"Output type of "),Wl=s(gp,"CODE",{});var S1=n(Wl);nu=i(S1,"Wav2Vec2BaseModelOutput"),S1.forEach(t),ru=i(gp,", with potential hidden states and attentions."),gp.forEach(t),up.forEach(t),ud=c(o),to=s(o,"DIV",{class:!0});var _p=n(to);g(Ts.$$.fragment,_p),iu=c(_p),xs=s(_p,"P",{});var vp=n(xs);lu=i(vp,"Output type of "),si=s(vp,"A",{href:!0});var N1=n(si);cu=i(N1,"Wav2Vec2ForPreTraining"),N1.forEach(t),du=i(vp,", with potential hidden states and attentions."),vp.forEach(t),_p.forEach(t),gd=c(o),vt=s(o,"DIV",{class:!0});var Ei=n(vt);g(Ws.$$.fragment,Ei),pu=c(Ei),$s=s(Ei,"P",{});var wp=n($s);mu=i(wp,"Output type of "),$l=s(wp,"CODE",{});var I1=n($l);hu=i(I1,"FlaxWav2Vec2BaseModelOutput"),I1.forEach(t),fu=i(wp,", with potential hidden states and attentions."),wp.forEach(t),uu=c(Ei),Go=s(Ei,"DIV",{class:!0});var bp=n(Go);g(js.$$.fragment,bp),gu=c(bp),jl=s(bp,"P",{});var B1=n(jl);_u=i(B1,"\u201CReturns a new object replacing the specified fields with new values."),B1.forEach(t),bp.forEach(t),Ei.forEach(t),_d=c(o),wt=s(o,"DIV",{class:!0});var Ci=n(wt);g(Vs.$$.fragment,Ci),vu=c(Ci),Fs=s(Ci,"P",{});var yp=n(Fs);wu=i(yp,"Output type of "),Vl=s(yp,"CODE",{});var U1=n(Vl);bu=i(U1,"FlaxWav2Vec2ForPreTrainingOutput"),U1.forEach(t),yu=i(yp,", with potential hidden states and attentions."),yp.forEach(t),ku=c(Ci),Jo=s(Ci,"DIV",{class:!0});var kp=n(Jo);g(Es.$$.fragment,kp),Tu=c(kp),Fl=s(kp,"P",{});var H1=n(Fl);xu=i(H1,"\u201CReturns a new object replacing the specified fields with new values."),H1.forEach(t),kp.forEach(t),Ci.forEach(t),vd=c(o),oo=s(o,"H2",{class:!0});var Tp=n(oo);Zo=s(Tp,"A",{id:!0,class:!0,href:!0});var R1=n(Zo);El=s(R1,"SPAN",{});var X1=n(El);g(Cs.$$.fragment,X1),X1.forEach(t),R1.forEach(t),Wu=c(Tp),Cl=s(Tp,"SPAN",{});var G1=n(Cl);$u=i(G1,"Wav2Vec2Model"),G1.forEach(t),Tp.forEach(t),wd=c(o),We=s(o,"DIV",{class:!0});var Ct=n(We);g(qs.$$.fragment,Ct),ju=c(Ct),Ps=s(Ct,"P",{});var xp=n(Ps);Vu=i(xp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Representations`),J1.forEach(t),Eu=i(xp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),xp.forEach(t),Cu=c(Ct),Ms=s(Ct,"P",{});var Wp=n(Ms);qu=i(Wp,"This model inherits from "),ni=s(Wp,"A",{href:!0});var Z1=n(ni);Pu=i(Z1,"PreTrainedModel"),Z1.forEach(t),zu=i(Wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Wp.forEach(t),Mu=c(Ct),As=s(Ct,"P",{});var $p=n(As);Au=i($p,"This model is a PyTorch "),Os=s($p,"A",{href:!0,rel:!0});var K1=n(Os);Ou=i(K1,"torch.nn.Module"),K1.forEach(t),Lu=i($p,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Du=c(Ct),Me=s(Ct,"DIV",{class:!0});var qt=n(Me);g(Ls.$$.fragment,qt),Su=c(qt),ao=s(qt,"P",{});var qi=n(ao);Nu=i(qi,"The "),ri=s(qi,"A",{href:!0});var Q1=n(ri);Iu=i(Q1,"Wav2Vec2Model"),Q1.forEach(t),Bu=i(qi," forward method, overrides the "),ql=s(qi,"CODE",{});var Y1=n(ql);Uu=i(Y1,"__call__"),Y1.forEach(t),Hu=i(qi," special method."),qi.forEach(t),Ru=c(qt),g(Ko.$$.fragment,qt),Xu=c(qt),Pl=s(qt,"P",{});var ey=n(Pl);Gu=i(ey,"Example:"),ey.forEach(t),Ju=c(qt),g(Ds.$$.fragment,qt),qt.forEach(t),Ct.forEach(t),bd=c(o),so=s(o,"H2",{class:!0});var jp=n(so);Qo=s(jp,"A",{id:!0,class:!0,href:!0});var ty=n(Qo);zl=s(ty,"SPAN",{});var oy=n(zl);g(Ss.$$.fragment,oy),oy.forEach(t),ty.forEach(t),Zu=c(jp),Ml=s(jp,"SPAN",{});var ay=n(Ml);Ku=i(ay,"Wav2Vec2ForCTC"),ay.forEach(t),jp.forEach(t),yd=c(o),$e=s(o,"DIV",{class:!0});var Pt=n($e);g(Ns.$$.fragment,Pt),Qu=c(Pt),no=s(Pt,"P",{});var Pi=n(no);Yu=i(Pi,"Wav2Vec2 Model with a "),Al=s(Pi,"CODE",{});var sy=n(Al);eg=i(sy,"language modeling"),sy.forEach(t),tg=i(Pi,` head on top for Connectionist Temporal Classification (CTC).
...
library implements for all its model (such as downloading or saving etc.).`),Vp.forEach(t),lg=c(Pt),Us=s(Pt,"P",{});var Fp=n(Us);cg=i(Fp,"This model is a PyTorch "),Hs=s(Fp,"A",{href:!0,rel:!0});var iy=n(Hs);dg=i(iy,"torch.nn.Module"),iy.forEach(t),pg=i(Fp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),mg=c(Pt),me=s(Pt,"DIV",{class:!0});var ot=n(me);g(Rs.$$.fragment,ot),hg=c(ot),ro=s(ot,"P",{});var zi=n(ro);fg=i(zi,"The "),li=s(zi,"A",{href:!0});var ly=n(li);ug=i(ly,"Wav2Vec2ForCTC"),ly.forEach(t),gg=i(zi," forward method, overrides the "),Ol=s(zi,"CODE",{});var cy=n(Ol);_g=i(cy,"__call__"),cy.forEach(t),vg=i(zi," special method."),zi.forEach(t),wg=c(ot),g(Yo.$$.fragment,ot),bg=c(ot),Ll=s(ot,"P",{});var dy=n(Ll);yg=i(dy,"Example:"),dy.forEach(t),kg=c(ot),g(Xs.$$.fragment,ot),Tg=c(ot),g(Gs.$$.fragment,ot),ot.forEach(t),Pt.forEach(t),kd=c(o),io=s(o,"H2",{class:!0});var Ep=n(io);ea=s(Ep,"A",{id:!0,class:!0,href:!0});var py=n(ea);Dl=s(py,"SPAN",{});var my=n(Dl);g(Js.$$.fragment,my),my.forEach(t),py.forEach(t),xg=c(Ep),Sl=s(Ep,"SPAN",{});var hy=n(Sl);Wg=i(hy,"Wav2Vec2ForSequenceClassification"),hy.forEach(t),Ep.forEach(t),Td=c(o),ne=s(o,"DIV",{class:!0});var at=n(ne);g(Zs.$$.fragment,at),$g=c(at),Nl=s(at,"P",{});var fy=n(Nl);jg=i(fy,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),fy.forEach(t),Vg=c(at),Ks=s(at,"P",{});var Cp=n(Ks);Fg=i(Cp,"Wav2Vec2 was proposed in "),Qs=s(Cp,"A",{href:!0,rel:!0});var uy=n(Qs);Eg=i(uy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),uy.forEach(t),Cg=i(Cp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Cp.forEach(t),qg=c(at),Ys=s(at,"P",{});var qp=n(Ys);Pg=i(qp,"This model inherits from "),ci=s(qp,"A",{href:!0});var gy=n(ci);zg=i(gy,"PreTrainedModel"),gy.forEach(t),Mg=i(qp,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Op.forEach(t),f_=c(nt),Ae=s(nt,"DIV",{class:!0});var zt=n(Ae);g(hn.$$.fragment,zt),u_=c(zt),po=s(zt,"P",{});var Ai=n(po);g_=i(Ai,"The "),mi=s(Ai,"A",{href:!0});var Vy=n(mi);__=i(Vy,"Wav2Vec2ForAudioFrameClassification"),Vy.forEach(t),v_=i(Ai," forward method, overrides the "),Xl=s(Ai,"CODE",{});var Fy=n(Xl);w_=i(Fy,"__call__"),Fy.forEach(t),b_=i(Ai," special method."),Ai.forEach(t),y_=c(zt),g(aa.$$.fragment,zt),k_=c(zt),Gl=s(zt,"P",{});var Ey=n(Gl);T_=i(Ey,"Example:"),Ey.forEach(t),x_=c(zt),g(fn.$$.fragment,zt),zt.forEach(t),nt.forEach(t),$d=c(o),mo=s(o,"H2",{class:!0});var Lp=n(mo);sa=s(Lp,"A",{id:!0,class:!0,href:!0});var Cy=n(sa);Jl=s(Cy,"SPAN",{});var qy=n(Jl);g(un.$$.fragment,qy),qy.forEach(t),Cy.forEach(t),W_=c(Lp),Zl=s(Lp,"SPAN",{});var Py=n(Zl);$_=i(Py,"Wav2Vec2ForXVector"),Py.forEach(t),Lp.forEach(t),jd=c(o),ie=s(o,"DIV",{class:!0});var rt=n(ie);g(gn.$$.fragment,rt),j_=c(rt),Kl=s(rt,"P",{});var zy=n(Kl);V_=i(zy,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),zy.forEach(t),F_=c(rt),_n=s(rt,"P",{});var Dp=n(_n);E_=i(Dp,"Wav2Vec2 was proposed in "),vn=s(Dp,"A",{href:!0,rel:!0});var My=n(vn);C_=i(My,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
Auli.`),Li.forEach(t),rv=c(At),jn=s(At,"P",{});var Bp=n(jn);iv=i(Bp,"This model inherits from "),ui=s(Bp,"A",{href:!0});var Ry=n(ui);lv=i(Ry,"PreTrainedModel"),Ry.forEach(t),cv=i(Bp,`. Check the superclass documentation for the generic methods the
