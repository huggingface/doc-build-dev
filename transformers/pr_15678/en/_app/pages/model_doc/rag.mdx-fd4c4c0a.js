import{S as eT,i as tT,s as oT,e as r,k as c,w as v,t,M as nT,c as s,d as n,m as l,a,x as b,h as o,b as i,F as e,g as _,y as T,q as w,o as k,B as q}from"../../chunks/vendor-4833417e.js";import{T as ge}from"../../chunks/Tip-fffd6df1.js";import{D as M}from"../../chunks/Docstring-6a25bf3b.js";import{C as rn}from"../../chunks/CodeBlock-90ffda97.js";import{I as _e}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function rT($){let p,y,u,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),f=t("Module"),x=t(`
...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(h,"CODE",{});var R=a(u);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,u),e(u,f),e(p,x)},d(g){g&&n(p)}}}function _T($){let p,y,u,f,x,g,h,R,Zd,La,$e,tt,Rr,Ct,ei,Fr,ti,Ia,sn,oi,Oa,ot,ni,St,ri,si,Wa,an,ai,Ha,dn,zr,di,Ba,nt,ii,Dt,ci,li,Qa,Ee,rt,$r,Lt,pi,Er,hi,Va,de,It,ui,me,cn,mi,gi,jr,_i,fi,ln,vi,bi,pn,Ti,wi,ki,st,Ot,qi,Wt,yi,hn,xi,Ri,Fi,at,Ht,zi,Bt,$i,un,Ei,ji,Ua,je,dt,Mr,Qt,Mi,Gr,Gi,Ka,Vt,it,Ut,Ai,Ar,Pi,Ya,Me,ct,Pr,Kt,Ni,Nr,Ci,Ja,Ge,Yt,Si,Cr,Di,Xa,Jt,Xt,Za,Ae,lt,Sr,Zt,Li,Dr,Ii,ed,X,eo,Oi,Lr,Wi,Hi,Ir,Bi,Qi,to,Vi,pt,oo,Ui,Or,Ki,Yi,ht,no,Ji,Pe,Xi,Wr,Zi,ec,Hr,tc,oc,nc,ut,ro,rc,so,sc,Br,ac,dc,td,Ne,mt,Qr,ao,ic,Vr,cc,od,D,io,lc,Ce,pc,mn,hc,uc,Ur,mc,gc,_c,gt,fc,Kr,vc,bc,ie,Tc,Yr,wc,kc,gn,qc,yc,Jr,xc,Rc,_n,Fc,zc,$c,G,Ec,fn,jc,Mc,Xr,Gc,Ac,Zr,Pc,Nc,es,Cc,Sc,ts,Dc,Lc,vn,Ic,Oc,os,Wc,Hc,bn,Bc,Qc,Tn,Vc,Uc,ns,Kc,Yc,Jc,co,Xc,wn,Zc,el,tl,lo,ol,po,nl,rl,sl,ee,ho,al,Se,dl,kn,il,cl,rs,ll,pl,hl,_t,ul,ss,ml,gl,uo,nd,De,ft,as,mo,_l,ds,fl,rd,E,go,vl,Le,bl,qn,Tl,wl,is,kl,ql,yl,vt,xl,cs,Rl,Fl,ls,zl,$l,ce,El,ps,jl,Ml,yn,Gl,Al,hs,Pl,Nl,xn,Cl,Sl,Dl,A,Ll,Rn,Il,Ol,us,Wl,Hl,ms,Bl,Ql,gs,Vl,Ul,_s,Kl,Yl,Fn,Jl,Xl,fs,Zl,ep,zn,tp,op,$n,np,rp,vs,sp,ap,dp,_o,ip,En,cp,lp,pp,fo,hp,vo,up,mp,gp,te,bo,_p,Ie,fp,jn,vp,bp,bs,Tp,wp,kp,bt,qp,Ts,yp,xp,To,Rp,Tt,wo,Fp,ko,zp,Mn,$p,Ep,sd,Oe,wt,ws,qo,jp,ks,Mp,ad,j,yo,Gp,We,Ap,Gn,Pp,Np,qs,Cp,Sp,Dp,kt,Lp,ys,Ip,Op,xs,Wp,Hp,le,Bp,Rs,Qp,Vp,An,Up,Kp,Fs,Yp,Jp,Pn,Xp,Zp,eh,P,th,Nn,oh,nh,zs,rh,sh,$s,ah,dh,Es,ih,ch,js,lh,ph,Cn,hh,uh,Ms,mh,gh,Sn,_h,fh,Dn,vh,bh,Gs,Th,wh,kh,xo,qh,Ln,yh,xh,Rh,Ro,Fh,Fo,zh,$h,Eh,oe,zo,jh,He,Mh,In,Gh,Ah,As,Ph,Nh,Ch,qt,Sh,Ps,Dh,Lh,$o,Ih,yt,Eo,Oh,Ns,Wh,dd,Be,xt,Cs,jo,Hh,Ss,Bh,id,N,Mo,Qh,Qe,Vh,On,Uh,Kh,Ds,Yh,Jh,Xh,Rt,Zh,Ls,eu,tu,pe,ou,Is,nu,ru,Wn,su,au,Os,du,iu,Hn,cu,lu,pu,L,hu,Bn,uu,mu,Ws,gu,_u,Hs,fu,vu,Bs,bu,Tu,Qs,wu,ku,Qn,qu,yu,Vs,xu,Ru,Vn,Fu,zu,Us,$u,Eu,ju,Go,Mu,Un,Gu,Au,Pu,Ao,Nu,Po,Cu,Su,Du,Ks,Lu,Iu,ne,No,Ou,Ve,Wu,Kn,Hu,Bu,Ys,Qu,Vu,Uu,Ft,Ku,Js,Yu,Ju,Co,cd,Ue,zt,Xs,So,Xu,Zs,Zu,ld,F,Do,em,Ke,tm,Yn,om,nm,ea,rm,sm,am,$t,dm,ta,im,cm,oa,lm,pm,he,hm,na,um,mm,Jn,gm,_m,ra,fm,vm,Xn,bm,Tm,wm,I,km,Zn,qm,ym,sa,xm,Rm,aa,Fm,zm,da,$m,Em,ia,jm,Mm,er,Gm,Am,ca,Pm,Nm,tr,Cm,Sm,la,Dm,Lm,Im,Lo,Om,or,Wm,Hm,Bm,Io,Qm,Oo,Vm,Um,Km,pa,Ym,Jm,re,Wo,Xm,Ye,Zm,nr,eg,tg,ha,og,ng,rg,Et,sg,ua,ag,dg,Ho,ig,jt,Bo,cg,Qo,lg,rr,pg,hg,pd,Je,Mt,ma,Vo,ug,ga,mg,hd,z,Uo,gg,Xe,_g,sr,fg,vg,_a,bg,Tg,wg,Gt,kg,fa,qg,yg,va,xg,Rg,ue,Fg,ba,zg,$g,ar,Eg,jg,Ta,Mg,Gg,dr,Ag,Pg,Ng,O,Cg,ir,Sg,Dg,wa,Lg,Ig,ka,Og,Wg,qa,Hg,Bg,ya,Qg,Vg,cr,Ug,Kg,xa,Yg,Jg,lr,Xg,Zg,Ra,e_,t_,o_,Ko,n_,pr,r_,s_,a_,Yo,d_,Jo,i_,c_,l_,Fa,p_,h_,se,Xo,u_,Ze,m_,hr,g_,__,za,f_,v_,b_,At,T_,$a,w_,k_,Zo,q_,Pt,en,y_,Ea,x_,ud;return g=new _e({}),Ct=new _e({}),Lt=new _e({}),It=new M({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
<a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"doc_sep"},{anchor:"transformers.RagConfig.n_docs",description:`<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to 5) &#x2014;
...
<a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"retrieval_batch_size"},{anchor:"transformers.RagConfig.dataset",description:`<strong>dataset</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;wiki_dpr&quot;</code>) &#x2014;
...
generator_tokenizer.`,name:"question_encoder_tokenizer"},{anchor:"transformers.RagRetriever.generator_tokenizer",description:`<strong>generator_tokenizer</strong> (<a href="/docs/transformers/pr_15678/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
...
`}}),ao=new _e({}),io=new M({props:{name:"class transformers.RagModel",anchor:"transformers.RagModel",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"question_encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"generator",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"retriever",val:": typing.Optional = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/rag/modeling_rag.py#L494",parametersDescription:[{anchor:"transformers.RagModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.RagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}]}}),gt=new ge({props:{$$slots:{default:[rT]},$$scope:{ctx:$}}}),ho=new M({props:{name:"forward",anchor:"transformers.RagModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"doc_scores",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"n_docs",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/rag/modeling_rag.py#L537",parametersDescription:[{anchor:"transformers.RagModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
...
<p>A <a
  href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(input_ids=inputs[<span class="hljs-string">&quot;input_ids&quot;</span>])`}}),mo=new _e({}),go=new M({props:{name:"class transformers.RagSequenceForGeneration",anchor:"transformers.RagSequenceForGeneration",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"question_encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"generator",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"retriever",val:": typing.Optional = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/rag/modeling_rag.py#L738",parametersDescription:[{anchor:"transformers.RagSequenceForGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
...
<p>A <a
  href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
...
<span class="hljs-meta">... </span>)`}}),wo=new M({props:{name:"generate",anchor:"transformers.RagSequenceForGeneration.generate",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"doc_scores",val:" = None"},{name:"do_deduplication",val:" = None"},{name:"num_return_sequences",val:" = None"},{name:"num_beams",val:" = None"},{name:"n_docs",val:" = None"},{name:"**model_kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/rag/modeling_rag.py#L909",parametersDescription:[{anchor:"transformers.RagSequenceForGeneration.generate.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_15678/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate)</code>
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],returnDescription:`
<p>The generated
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}]}}),kt=new ge({props:{$$slots:{default:[iT]},$$scope:{ctx:$}}}),zo=new M({props:{name:"forward",anchor:"transformers.RagTokenForGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"doc_scores",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"do_marginalize",val:" = None"},{name:"reduce_loss",val:" = None"},{name:"labels",val:" = None"},{name:"n_docs",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/rag/modeling_rag.py#L1234",parametersDescription:[{anchor:"transformers.RagTokenForGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
which generator to use, it also specifies a compatible generator tokenizer. Use that tokenizer class to
obtain the indices.</p>
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_15678/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
`,returnType:`
<p><code>torch.LongTensor</code> of shape <code>(batch_size * num_return_sequences, sequence_length)</code></p>
`}}),jo=new _e({}),Mo=new M({props:{name:"class transformers.TFRagModel",anchor:"transformers.TFRagModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/rag/modeling_tf_rag.py#L485",parametersDescription:[{anchor:"transformers.TFRagModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.TFRagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_15678/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
...
decoder model configuration.`),Fi=c(),at=r("div"),v(Ht.$$.fragment),zi=c(),Bt=r("p"),$i=t("Serializes this instance to a Python dictionary. Override the default "),un=r("a"),Ei=t("to_dict()"),ji=t("."),Ua=c(),je=r("h2"),dt=r("a"),Mr=r("span"),v(Qt.$$.fragment),Mi=c(),Gr=r("span"),Gi=t("RagTokenizer"),Ka=c(),Vt=r("div"),it=r("div"),v(Ut.$$.fragment),Ai=c(),Ar=r("p"),Pi=t(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Ya=c(),Me=r("h2"),ct=r("a"),Pr=r("span"),v(Kt.$$.fragment),Ni=c(),Nr=r("span"),Ci=t("Rag specific outputs"),Ja=c(),Ge=r("div"),v(Yt.$$.fragment),Si=c(),Cr=r("p"),Di=t("Base class for retriever augmented marginalized models outputs."),Xa=c(),Jt=r("div"),v(Xt.$$.fragment),Za=c(),Ae=r("h2"),lt=r("a"),Sr=r("span"),v(Zt.$$.fragment),Li=c(),Dr=r("span"),Ii=t("RagRetriever"),ed=c(),X=r("div"),v(eo.$$.fragment),Oi=c(),Lr=r("p"),Wi=t(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
any `),Jr=r("em"),xc=t("seq2seq"),Rc=t(" model, preferably "),_n=r("a"),Fc=t("BartForConditionalGeneration"),zc=t("."),$c=c(),G=r("p"),Ec=t("The model can be initialized with a "),fn=r("a"),jc=t("RagRetriever"),Mc=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),Xr=r("em"),Gc=t("autoencoding"),Ac=t(" model as the "),Zr=r("code"),Pc=t("question_encoder"),Nc=t(" and any "),es=r("em"),Cc=t("seq2seq"),Sc=t(" model with language model head as the "),ts=r("code"),Dc=t("generator"),Lc=t(`.
...
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),$l=c(),ce=r("p"),El=t("The question encoder can be any "),ps=r("em"),jl=t("autoencoding"),Ml=t(" model, preferably "),yn=r("a"),Gl=t("DPRQuestionEncoder"),Al=t(`, and the generator can be
...
It has been tested with `),Cn=r("a"),hh=t("DPRQuestionEncoder"),uh=t(" as the "),Ms=r("code"),mh=t("question_encoder"),gh=t(" and "),Sn=r("a"),_h=t("BartForConditionalGeneration"),fh=t(` or
`),Dn=r("a"),vh=t("T5ForConditionalGeneration"),bh=t(" as the "),Gs=r("code"),Th=t("generator"),wh=t("."),kh=c(),xo=r("p"),qh=t("This model inherits from "),Ln=r("a"),yh=t("PreTrainedModel"),xh=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rh=c(),Ro=r("p"),Fh=t("This model is also a PyTorch "),Fo=r("a"),zh=t("torch.nn.Module"),$h=t(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Eh=c(),oe=r("div"),v(zo.$$.fragment),jh=c(),He=r("p"),Mh=t("The "),In=r("a"),Gh=t("RagTokenForGeneration"),Ah=t(" forward method, overrides the "),As=r("code"),Ph=t("__call__"),Nh=t(" special method."),Ch=c(),v(qt.$$.fragment),Sh=c(),Ps=r("p"),Dh=t("Example:"),Lh=c(),v($o.$$.fragment),Ih=c(),yt=r("div"),v(Eo.$$.fragment),Oh=c(),Ns=r("p"),Wh=t("Implements RAG token decoding."),dd=c(),Be=r("h2"),xt=r("a"),Cs=r("span"),v(jo.$$.fragment),Hh=c(),Ss=r("span"),Bh=t("TFRagModel"),id=c(),N=r("div"),v(Mo.$$.fragment),Qh=c(),Qe=r("p"),Vh=t("The "),On=r("a"),Uh=t("TFRagModel"),Kh=t(" forward method, overrides the "),Ds=r("code"),Yh=t("__call__"),Jh=t(" special method."),Xh=c(),v(Rt.$$.fragment),Zh=c(),Ls=r("p"),eu=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
as the `),Us=r("code"),$u=t("generator"),Eu=t("."),ju=c(),Go=r("p"),Mu=t("This model inherits from "),Un=r("a"),Gu=t("TFPreTrainedModel"),Au=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),sa=r("em"),xm=t("autoencoding"),Rm=t(" model as the "),aa=r("code"),Fm=t("question_encoder"),zm=t(" and any "),da=r("em"),$m=t("seq2seq"),Em=t(" model with language model head as the "),ia=r("code"),jm=t("generator"),Mm=t(`.
It has been tested with `),er=r("a"),Gm=t("TFDPRQuestionEncoder"),Am=t(" as the "),ca=r("code"),Pm=t("question_encoder"),Nm=t(" and "),tr=r("a"),Cm=t("TFBartForConditionalGeneration"),Sm=t(`
...
SavedModel format.`),Jm=c(),re=r("div"),v(Wo.$$.fragment),Xm=c(),Ye=r("p"),Zm=t("The "),nr=r("a"),eg=t("TFRagSequenceForGeneration"),tg=t(" forward method, overrides the "),ha=r("code"),og=t("__call__"),ng=t(" special method."),rg=c(),v(Et.$$.fragment),sg=c(),ua=r("p"),ag=t("Example:"),dg=c(),v(Ho.$$.fragment),ig=c(),jt=r("div"),v(Bo.$$.fragment),cg=c(),Qo=r("p"),lg=t("Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),rr=r("a"),pg=t("generate()"),hg=t("`\ndocumentation for more information on how to set other generate input parameters"),pd=c(),Je=r("h2"),Mt=r("a"),ma=r("span"),v(Vo.$$.fragment),ug=c(),ga=r("span"),mg=t("TFRagTokenForGeneration"),hd=c(),z=r("div"),v(Uo.$$.fragment),gg=c(),Xe=r("p"),_g=t("The "),sr=r("a"),fg=t("TFRagTokenForGeneration"),vg=t(" forward method, overrides the "),_a=r("code"),bg=t("__call__"),Tg=t(" special method."),wg=c(),v(Gt.$$.fragment),kg=c(),fa=r("p"),qg=t("A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),yg=c(),va=r("p"),xg=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
...
any `),Ta=r("em"),Mg=t("seq2seq"),Gg=t(" model, preferably "),dr=r("a"),Ag=t("TFBartForConditionalGeneration"),Pg=t("."),Ng=c(),O=r("p"),Cg=t("The model can be initialized with a "),ir=r("a"),Sg=t("RagRetriever"),Dg=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
decoder model configuration.`),fd.forEach(n),_d.forEach(n),Fi=l(Nt),at=s(Nt,"DIV",{class:!0});var vd=a(at);b(Ht.$$.fragment,vd),zi=l(vd),Bt=s(vd,"P",{});var bd=a(Bt);$i=o(bd,"Serializes this instance to a Python dictionary. Override the default "),un=s(bd,"A",{href:!0});var C_=a(un);Ei=o(C_,"to_dict()"),C_.forEach(n),ji=o(bd,"."),bd.forEach(n),vd.forEach(n),Nt.forEach(n),Ua=l(d),je=s(d,"H2",{class:!0});var Td=a(je);dt=s(Td,"A",{id:!0,class:!0,href:!0});var S_=a(dt);Mr=s(S_,"SPAN",{});var D_=a(Mr);b(Qt.$$.fragment,D_),D_.forEach(n),S_.forEach(n),Mi=l(Td),Gr=s(Td,"SPAN",{});var L_=a(Gr);Gi=o(L_,"RagTokenizer"),L_.forEach(n),Td.forEach(n),Ka=l(d),Vt=s(d,"DIV",{class:!0});var I_=a(Vt);it=s(I_,"DIV",{class:!0});var wd=a(it);b(Ut.$$.fragment,wd),Ai=l(wd),Ar=s(wd,"P",{});var O_=a(Ar);Pi=o(O_,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),O_.forEach(n),wd.forEach(n),I_.forEach(n),Ya=l(d),Me=s(d,"H2",{class:!0});var kd=a(Me);ct=s(kd,"A",{id:!0,class:!0,href:!0});var W_=a(ct);Pr=s(W_,"SPAN",{});var H_=a(Pr);b(Kt.$$.fragment,H_),H_.forEach(n),W_.forEach(n),Ni=l(kd),Nr=s(kd,"SPAN",{});var B_=a(Nr);Ci=o(B_,"Rag specific outputs"),B_.forEach(n),kd.forEach(n),Ja=l(d),Ge=s(d,"DIV",{class:!0});var qd=a(Ge);b(Yt.$$.fragment,qd),Si=l(qd),Cr=s(qd,"P",{});var Q_=a(Cr);Di=o(Q_,"Base class for retriever augmented marginalized models outputs."),Q_.forEach(n),qd.forEach(n),Xa=l(d),Jt=s(d,"DIV",{class:!0});var V_=a(Jt);b(Xt.$$.fragment,V_),V_.forEach(n),Za=l(d),Ae=s(d,"H2",{class:!0});var yd=a(Ae);lt=s(yd,"A",{id:!0,class:!0,href:!0});var U_=a(lt);Sr=s(U_,"SPAN",{});var K_=a(Sr);b(Zt.$$.fragment,K_),K_.forEach(n),U_.forEach(n),Li=l(yd),Dr=s(yd,"SPAN",{});var Y_=a(Dr);Ii=o(Y_,"RagRetriever"),Y_.forEach(n),yd.forEach(n),ed=l(d),X=s(d,"DIV",{class:!0});var ae=a(X);b(eo.$$.fragment,ae),Oi=l(ae),Lr=s(ae,"P",{});var J_=a(Lr);Wi=o(J_,`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
any `),Jr=s(fe,"EM",{});var hf=a(Jr);xc=o(hf,"seq2seq"),hf.forEach(n),Rc=o(fe," model, preferably "),_n=s(fe,"A",{href:!0});var uf=a(_n);Fc=o(uf,"BartForConditionalGeneration"),uf.forEach(n),zc=o(fe,"."),fe.forEach(n),$c=l(Z),G=s(Z,"P",{});var W=a(G);Ec=o(W,"The model can be initialized with a "),fn=s(W,"A",{href:!0});var mf=a(fn);jc=o(mf,"RagRetriever"),mf.forEach(n),Mc=o(W,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),Xr=s(W,"EM",{});var gf=a(Xr);Gc=o(gf,"autoencoding"),gf.forEach(n),Ac=o(W," model as the "),Zr=s(W,"CODE",{});var _f=a(Zr);Pc=o(_f,"question_encoder"),_f.forEach(n),Nc=o(W," and any "),es=s(W,"EM",{});var ff=a(es);Cc=o(ff,"seq2seq"),ff.forEach(n),Sc=o(W," model with language model head as the "),ts=s(W,"CODE",{});var vf=a(ts);Dc=o(vf,"generator"),vf.forEach(n),Lc=o(W,`.
...
`),$n=s(B,"A",{href:!0});var Uf=a($n);np=o(Uf,"T5ForConditionalGeneration"),Uf.forEach(n),rp=o(B," as the "),vs=s(B,"CODE",{});var Kf=a(vs);sp=o(Kf,"generator"),Kf.forEach(n),ap=o(B,"."),B.forEach(n),dp=l(H),_o=s(H,"P",{});var Gd=a(_o);ip=o(Gd,"This model inherits from "),En=s(Gd,"A",{href:!0});var Yf=a(En);cp=o(Yf,"PreTrainedModel"),Yf.forEach(n),lp=o(Gd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gd.forEach(n),pp=l(H),fo=s(H,"P",{});var Ad=a(fo);hp=o(Ad,"This model is also a PyTorch "),vo=s(Ad,"A",{href:!0,rel:!0});var Jf=a(vo);up=o(Jf,"torch.nn.Module"),Jf.forEach(n),mp=o(Ad,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ad.forEach(n),gp=l(H),te=s(H,"DIV",{class:!0});var Te=a(te);b(bo.$$.fragment,Te),_p=l(Te),Ie=s(Te,"P",{});var fr=a(Ie);fp=o(fr,"The "),jn=s(fr,"A",{href:!0});var Xf=a(jn);vp=o(Xf,"RagSequenceForGeneration"),Xf.forEach(n),bp=o(fr," forward method, overrides the "),bs=s(fr,"CODE",{});var Zf=a(bs);Tp=o(Zf,"__call__"),Zf.forEach(n),wp=o(fr," special method."),fr.forEach(n),kp=l(Te),b(bt.$$.fragment,Te),qp=l(Te),Ts=s(Te,"P",{});var ev=a(Ts);yp=o(ev,"Example:"),ev.forEach(n),xp=l(Te),b(To.$$.fragment,Te),Te.forEach(n),Rp=l(H),Tt=s(H,"DIV",{class:!0});var Pd=a(Tt);b(wo.$$.fragment,Pd),Fp=l(Pd),ko=s(Pd,"P",{});var Nd=a(ko);zp=o(Nd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Mn=s(Nd,"A",{href:!0});var tv=a(Mn);$p=o(tv,"generate()"),tv.forEach(n),Ep=o(Nd,"`\ndocumentation for more information on how to set other generate input parameters."),Nd.forEach(n),Pd.forEach(n),H.forEach(n),sd=l(d),Oe=s(d,"H2",{class:!0});var Cd=a(Oe);wt=s(Cd,"A",{id:!0,class:!0,href:!0});var ov=a(wt);ws=s(ov,"SPAN",{});var nv=a(ws);b(qo.$$.fragment,nv),nv.forEach(n),ov.forEach(n),jp=l(Cd),ks=s(Cd,"SPAN",{});var rv=a(ks);Mp=o(rv,"RagTokenForGeneration"),rv.forEach(n),Cd.forEach(n),ad=l(d),j=s(d,"DIV",{class:!0});var Q=a(j);b(yo.$$.fragment,Q),Gp=l(Q),We=s(Q,"P",{});var vr=a(We);Ap=o(vr,"The "),Gn=s(vr,"A",{href:!0});var sv=a(Gn);Pp=o(sv,"RagTokenForGeneration"),sv.forEach(n),Np=o(vr," forward method, overrides the "),qs=s(vr,"CODE",{});var av=a(qs);Cp=o(av,"__call__"),av.forEach(n),Sp=o(vr," special method."),vr.forEach(n),Dp=l(Q),b(kt.$$.fragment,Q),Lp=l(Q),ys=s(Q,"P",{});var dv=a(ys);Ip=o(dv,"A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),dv.forEach(n),Op=l(Q),xs=s(Q,"P",{});var iv=a(xs);Wp=o(iv,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
It has been tested with `),Cn=s(V,"A",{href:!0});var vv=a(Cn);hh=o(vv,"DPRQuestionEncoder"),vv.forEach(n),uh=o(V," as the "),Ms=s(V,"CODE",{});var bv=a(Ms);mh=o(bv,"question_encoder"),bv.forEach(n),gh=o(V," and "),Sn=s(V,"A",{href:!0});var Tv=a(Sn);_h=o(Tv,"BartForConditionalGeneration"),Tv.forEach(n),fh=o(V,` or
`),Dn=s(V,"A",{href:!0});var wv=a(Dn);vh=o(wv,"T5ForConditionalGeneration"),wv.forEach(n),bh=o(V," as the "),Gs=s(V,"CODE",{});var kv=a(Gs);Th=o(kv,"generator"),kv.forEach(n),wh=o(V,"."),V.forEach(n),kh=l(Q),xo=s(Q,"P",{});var Sd=a(xo);qh=o(Sd,"This model inherits from "),Ln=s(Sd,"A",{href:!0});var qv=a(Ln);yh=o(qv,"PreTrainedModel"),qv.forEach(n),xh=o(Sd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd.forEach(n),Eh=l(Q),oe=s(Q,"DIV",{class:!0});var ke=a(oe);b(zo.$$.fragment,ke),jh=l(ke),He=s(ke,"P",{});var br=a(He);Mh=o(br,"The "),In=s(br,"A",{href:!0});var xv=a(In);Gh=o(xv,"RagTokenForGeneration"),xv.forEach(n),Ah=o(br," forward method, overrides the "),As=s(br,"CODE",{});var Rv=a(As);Ph=o(Rv,"__call__"),Rv.forEach(n),Nh=o(br," special method."),br.forEach(n),Ch=l(ke),b(qt.$$.fragment,ke),Sh=l(ke),Ps=s(ke,"P",{});var Fv=a(Ps);Dh=o(Fv,"Example:"),Fv.forEach(n),Lh=l(ke),b($o.$$.fragment,ke),ke.forEach(n),Ih=l(Q),yt=s(Q,"DIV",{class:!0});var Ld=a(yt);b(Eo.$$.fragment,Ld),Oh=l(Ld),Ns=s(Ld,"P",{});var zv=a(Ns);Wh=o(zv,"Implements RAG token decoding."),zv.forEach(n),Ld.forEach(n),Q.forEach(n),dd=l(d),Be=s(d,"H2",{class:!0});var Id=a(Be);xt=s(Id,"A",{id:!0,class:!0,href:!0});var $v=a(xt);Cs=s($v,"SPAN",{});var Ev=a(Cs);b(jo.$$.fragment,Ev),Ev.forEach(n),$v.forEach(n),Hh=l(Id),Ss=s(Id,"SPAN",{});var jv=a(Ss);Bh=o(jv,"TFRagModel"),jv.forEach(n),Id.forEach(n),id=l(d),N=s(d,"DIV",{class:!0});var U=a(N);b(Mo.$$.fragment,U),Qh=l(U),Qe=s(U,"P",{});var Tr=a(Qe);Vh=o(Tr,"The "),On=s(Tr,"A",{href:!0});var Mv=a(On);Uh=o(Mv,"TFRagModel"),Mv.forEach(n),Kh=o(Tr," forward method, overrides the "),Ds=s(Tr,"CODE",{});var Gv=a(Ds);Yh=o(Gv,"__call__"),Gv.forEach(n),Jh=o(Tr," special method."),Tr.forEach(n),Xh=l(U),b(Rt.$$.fragment,U),Zh=l(U),Ls=s(U,"P",{});var Av=a(Ls);eu=o(Av,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
...
as the `),Us=s(K,"CODE",{});var Vv=a(Us);$u=o(Vv,"generator"),Vv.forEach(n),Eu=o(K,"."),K.forEach(n),ju=l(U),Go=s(U,"P",{});var Od=a(Go);Mu=o(Od,"This model inherits from "),Un=s(Od,"A",{href:!0});var Uv=a(Un);Gu=o(Uv,"TFPreTrainedModel"),Uv.forEach(n),Au=o(Od,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),sa=s(Y,"EM",{});var hb=a(sa);xm=o(hb,"autoencoding"),hb.forEach(n),Rm=o(Y," model as the "),aa=s(Y,"CODE",{});var ub=a(aa);Fm=o(ub,"question_encoder"),ub.forEach(n),zm=o(Y," and any "),da=s(Y,"EM",{});var mb=a(da);$m=o(mb,"seq2seq"),mb.forEach(n),Em=o(Y," model with language model head as the "),ia=s(Y,"CODE",{});var gb=a(ia);jm=o(gb,"generator"),gb.forEach(n),Mm=o(Y,`.
It has been tested with `),er=s(Y,"A",{href:!0});var _b=a(er);Gm=o(_b,"TFDPRQuestionEncoder"),_b.forEach(n),Am=o(Y," as the "),ca=s(Y,"CODE",{});var fb=a(ca);Pm=o(fb,"question_encoder"),fb.forEach(n),Nm=o(Y," and "),tr=s(Y,"A",{href:!0});var vb=a(tr);Cm=o(vb,"TFBartForConditionalGeneration"),vb.forEach(n),Sm=o(Y,`
...
SavedModel format.`),kb.forEach(n),Jm=l(C),re=s(C,"DIV",{class:!0});var Re=a(re);b(Wo.$$.fragment,Re),Xm=l(Re),Ye=s(Re,"P",{});var qr=a(Ye);Zm=o(qr,"The "),nr=s(qr,"A",{href:!0});var qb=a(nr);eg=o(qb,"TFRagSequenceForGeneration"),qb.forEach(n),tg=o(qr," forward method, overrides the "),ha=s(qr,"CODE",{});var yb=a(ha);og=o(yb,"__call__"),yb.forEach(n),ng=o(qr," special method."),qr.forEach(n),rg=l(Re),b(Et.$$.fragment,Re),sg=l(Re),ua=s(Re,"P",{});var xb=a(ua);ag=o(xb,"Example:"),xb.forEach(n),dg=l(Re),b(Ho.$$.fragment,Re),Re.forEach(n),ig=l(C),jt=s(C,"DIV",{class:!0});var Vd=a(jt);b(Bo.$$.fragment,Vd),cg=l(Vd),Qo=s(Vd,"P",{});var Ud=a(Qo);lg=o(Ud,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),rr=s(Ud,"A",{href:!0});var Rb=a(rr);pg=o(Rb,"generate()"),Rb.forEach(n),hg=o(Ud,"`\ndocumentation for more information on how to set other generate input parameters"),Ud.forEach(n),Vd.forEach(n),C.forEach(n),pd=l(d),Je=s(d,"H2",{class:!0});var Kd=a(Je);Mt=s(Kd,"A",{id:!0,class:!0,href:!0});var Fb=a(Mt);ma=s(Fb,"SPAN",{});var zb=a(ma);b(Vo.$$.fragment,zb),zb.forEach(n),Fb.forEach(n),ug=l(Kd),ga=s(Kd,"SPAN",{});var $b=a(ga);mg=o($b,"TFRagTokenForGeneration"),$b.forEach(n),Kd.forEach(n),hd=l(d),z=s(d,"DIV",{class:!0});var S=a(z);b(Uo.$$.fragment,S),gg=l(S),Xe=s(S,"P",{});var yr=a(Xe);_g=o(yr,"The "),sr=s(yr,"A",{href:!0});var Eb=a(sr);fg=o(Eb,"TFRagTokenForGeneration"),Eb.forEach(n),vg=o(yr," forward method, overrides the "),_a=s(yr,"CODE",{});var jb=a(_a);bg=o(jb,"__call__"),jb.forEach(n),Tg=o(yr," special method."),yr.forEach(n),wg=l(S),b(Gt.$$.fragment,S),kg=l(S),fa=s(S,"P",{});var Mb=a(fa);qg=o(Mb,"A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Mb.forEach(n),yg=l(S),va=s(S,"P",{});var Gb=a(va);xg=o(Gb,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Gb.forEach(n),Rg=l(S),ue=s(S,"P",{});var Fe=a(ue);Fg=o(Fe,"The question encoder can be any "),ba=s(Fe,"EM",{});var Ab=a(ba);zg=o(Ab,"autoencoding"),Ab.forEach(n),$g=o(Fe," model, preferably "),ar=s(Fe,"A",{href:!0});var Pb=a(ar);Eg=o(Pb,"TFDPRQuestionEncoder"),Pb.forEach(n),jg=o(Fe,`, and the generator can be
any `),Ta=s(Fe,"EM",{});var Nb=a(Ta);Mg=o(Nb,"seq2seq"),Nb.forEach(n),Gg=o(Fe," model, preferably "),dr=s(Fe,"A",{href:!0});var Cb=a(dr);Ag=o(Cb,"TFBartForConditionalGeneration"),Cb.forEach(n),Pg=o(Fe,"."),Fe.forEach(n),Ng=l(S),O=s(S,"P",{});var J=a(O);Cg=o(J,"The model can be initialized with a "),ir=s(J,"A",{href:!0});var Sb=a(ir);Sg=o(Sb,"RagRetriever"),Sb.forEach(n),Dg=o(J,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
