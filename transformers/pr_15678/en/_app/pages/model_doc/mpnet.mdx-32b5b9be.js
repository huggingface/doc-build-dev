import{S as z_,i as E_,s as q_,e as n,k as l,w as M,t as a,M as C_,c as s,d as t,m as d,a as r,x as b,h as i,b as h,F as e,g as m,y as w,q as P,o as N,B as $}from"../../chunks/vendor-4833417e.js";import{T as Ne}from"../../chunks/Tip-fffd6df1.js";import{D as ne}from"../../chunks/Docstring-6a25bf3b.js";import{C as Ye}from"../../chunks/CodeBlock-90ffda97.js";import{I as xe}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function x_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=a("Module"),v=a(`
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function S_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
...
`),x=s(ie,"CODE",{});var fe=r(x);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),L.forEach(t)},m(c,T){m(c,p,T),e(p,y),m(c,f,T),m(c,g,T),e(g,v),e(v,k),e(g,_),e(g,F),e(F,le),m(c,U,T),m(c,z,T),e(z,X),e(z,S),e(S,J),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,R,T),m(c,A,T),e(A,G),m(c,V,T),m(c,E,T),e(E,q),e(q,Y),e(q,B),e(B,re),e(q,Z),e(q,H),e(H,ae),e(E,ee),e(E,C),e(C,pe),e(C,W),e(W,te),e(E,he),e(E,j),e(j,oe),e(j,x),e(x,me)},d(c){c&&t(p),c&&t(f),c&&t(g),c&&t(U),c&&t(z),c&&t(R),c&&t(A),c&&t(V),c&&t(E)}}}function O_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function W_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),te=a("model([input_ids, attention_mask])"),he=l(),j=n("li"),oe=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);v=s(K,"LI",{});var _e=r(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=r(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=r(S);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function B_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),te=a("model([input_ids, attention_mask])"),he=l(),j=n("li"),oe=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);v=s(K,"LI",{});var _e=r(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=r(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=r(S);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function V_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),te=a("model([input_ids, attention_mask])"),he=l(),j=n("li"),oe=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);v=s(K,"LI",{});var _e=r(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=r(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=r(S);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function X_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me;return{c(){p=n("p"),y=a("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=a("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=a("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=a("This second option is useful when using "),S=n("code"),J=a("tf.keras.Model.fit"),de=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=a("model(inputs)"),se=a("."),R=l(),A=n("p"),G=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Y=a("a single Tensor with "),B=n("code"),re=a("input_ids"),Z=a(" only and nothing else: "),H=n("code"),ae=a("model(inputs_ids)"),ee=l(),C=n("li"),pe=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),te=a("model([input_ids, attention_mask])"),he=l(),j=n("li"),oe=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),x=n("code"),me=a('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=r(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=r(g);v=s(K,"LI",{});var _e=r(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=r(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=r(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=r(S);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=r(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=r(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function G_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,J,de,O,ce,se,R,A,G,V,E,q,Y,B,re,Z,H,ae,ee,C,pe,W,te,he,j,oe,x,me,c,T,K,_e,ve,I,ke,Te,Me,L,D,be,ge,ue,we,ie,fe,oo,Er,Wo,Al,qr,Il,mi,je,Qo,Dl,it,Sl,Is,Ol,Wl,Ds,Ql,Bl,Bo,Hl,Rl,Ul,yt,Vl,Ss,Kl,Xl,Os,Jl,Gl,Yl,Cr,Zl,ed,Ho,ui,Ft,no,xr,Ro,td,jr,od,fi,$e,Uo,nd,Vo,sd,Ws,rd,ad,id,dt,Ko,ld,Lr,dd,cd,Xo,Qs,pd,Ar,hd,md,Bs,ud,Ir,fd,gd,so,Jo,_d,Go,kd,Dr,vd,Td,Md,ro,Yo,bd,Sr,wd,Pd,Or,gi,zt,ao,Wr,Zo,Nd,Qr,$d,_i,Ze,en,yd,tn,Fd,Br,zd,Ed,qd,on,Cd,Hs,xd,jd,Ld,io,nn,Ad,Hr,Id,ki,Et,lo,Rr,sn,Dd,Ur,Sd,vi,Le,rn,Od,Vr,Wd,Qd,an,Bd,Rs,Hd,Rd,Ud,ln,Vd,dn,Kd,Xd,Jd,Oe,cn,Gd,qt,Yd,Us,Zd,ec,Kr,tc,oc,nc,co,sc,Xr,rc,ac,pn,Ti,Ct,po,Jr,hn,ic,Gr,lc,Mi,mn,We,un,dc,xt,cc,Vs,pc,hc,Yr,mc,uc,fc,ho,gc,Zr,_c,kc,fn,bi,jt,mo,ea,gn,vc,ta,Tc,wi,Ae,_n,Mc,oa,bc,wc,kn,Pc,Ks,Nc,$c,yc,vn,Fc,Tn,zc,Ec,qc,Pe,Mn,Cc,Lt,xc,Xs,jc,Lc,na,Ac,Ic,Dc,uo,Sc,sa,Oc,Wc,bn,Qc,ra,Bc,Hc,wn,Pi,At,fo,aa,Pn,Rc,ia,Uc,Ni,Ie,Nn,Vc,la,Kc,Xc,$n,Jc,Js,Gc,Yc,Zc,yn,ep,Fn,tp,op,np,Qe,zn,sp,It,rp,Gs,ap,ip,da,lp,dp,cp,go,pp,ca,hp,mp,En,$i,Dt,_o,pa,qn,up,ha,fp,yi,De,Cn,gp,ma,_p,kp,xn,vp,Ys,Tp,Mp,bp,jn,wp,Ln,Pp,Np,$p,Be,An,yp,St,Fp,Zs,zp,Ep,ua,qp,Cp,xp,ko,jp,fa,Lp,Ap,In,Fi,Ot,vo,ga,Dn,Ip,_a,Dp,zi,Se,Sn,Sp,Wt,Op,ka,Wp,Qp,va,Bp,Hp,Rp,On,Up,er,Vp,Kp,Xp,Wn,Jp,Qn,Gp,Yp,Zp,He,Bn,eh,Qt,th,tr,oh,nh,Ta,sh,rh,ah,To,ih,Ma,lh,dh,Hn,Ei,Bt,Mo,ba,Rn,ch,wa,ph,qi,ye,Un,hh,Pa,mh,uh,Vn,fh,or,gh,_h,kh,Kn,vh,Xn,Th,Mh,bh,bo,wh,Re,Jn,Ph,Ht,Nh,nr,$h,yh,Na,Fh,zh,Eh,wo,qh,$a,Ch,xh,Gn,Ci,Rt,Po,ya,Yn,jh,Fa,Lh,xi,Fe,Zn,Ah,es,Ih,za,Dh,Sh,Oh,ts,Wh,sr,Qh,Bh,Hh,os,Rh,ns,Uh,Vh,Kh,No,Xh,Ue,ss,Jh,Ut,Gh,rr,Yh,Zh,Ea,em,tm,om,$o,nm,qa,sm,rm,rs,ji,Vt,yo,Ca,as,am,xa,im,Li,ze,is,lm,ja,dm,cm,ls,pm,ar,hm,mm,um,ds,fm,cs,gm,_m,km,Fo,vm,Ve,ps,Tm,Kt,Mm,ir,bm,wm,La,Pm,Nm,$m,zo,ym,Aa,Fm,zm,hs,Ai,Xt,Eo,Ia,ms,Em,Da,qm,Ii,Ee,us,Cm,Sa,xm,jm,fs,Lm,lr,Am,Im,Dm,gs,Sm,_s,Om,Wm,Qm,qo,Bm,Ke,ks,Hm,Jt,Rm,dr,Um,Vm,Oa,Km,Xm,Jm,Co,Gm,Wa,Ym,Zm,vs,Di,Gt,xo,Qa,Ts,eu,Ba,tu,Si,qe,Ms,ou,Ha,nu,su,bs,ru,cr,au,iu,lu,ws,du,Ps,cu,pu,hu,jo,mu,Xe,Ns,uu,Yt,fu,pr,gu,_u,Ra,ku,vu,Tu,Lo,Mu,Ua,bu,wu,$s,Oi,Zt,Ao,Va,ys,Pu,Ka,Nu,Wi,Ce,Fs,$u,eo,yu,Xa,Fu,zu,Ja,Eu,qu,Cu,zs,xu,hr,ju,Lu,Au,Es,Iu,qs,Du,Su,Ou,Io,Wu,Je,Cs,Qu,to,Bu,mr,Hu,Ru,Ga,Uu,Vu,Ku,Do,Xu,Ya,Ju,Gu,xs,Qi;return k=new xe({}),J=new xe({}),Wo=new xe({}),Qo=new ne({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/configuration_mpnet.py#L29",parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),gn=new xe({}),_n=new ne({props:{name:"class transformers.MPNetForSequenceClassification",anchor:"transformers.MPNetForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_mpnet.py#L684",parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Mn=new ne({props:{name:"forward",anchor:"transformers.MPNetForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_mpnet.py#L697",parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Pn=new xe({}),Nn=new ne({props:{name:"class transformers.MPNetForMultipleChoice",anchor:"transformers.MPNetForMultipleChoice",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_mpnet.py#L779",parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zn=new ne({props:{name:"forward",anchor:"transformers.MPNetForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_mpnet.py#L792",parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Dn=new xe({}),Sn=new ne({props:{name:"class transformers.MPNetForQuestionAnswering",anchor:"transformers.MPNetForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_mpnet.py#L970",parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Bn=new ne({props:{name:"forward",anchor:"transformers.MPNetForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_mpnet.py#L984",parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),Rn=new xe({}),Un=new ne({props:{name:"class transformers.TFMPNetModel",anchor:"transformers.TFMPNetModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_tf_mpnet.py#L678",parametersDescription:[{anchor:"transformers.TFMPNetModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bo=new Ne({props:{$$slots:{default:[S_]},$$scope:{ctx:Q}}}),Jn=new ne({props:{name:"call",anchor:"transformers.TFMPNetModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_tf_mpnet.py#L683",parametersDescription:[{anchor:"transformers.TFMPNetModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),No=new Ne({props:{$$slots:{default:[W_]},$$scope:{ctx:Q}}}),ss=new ne({props:{name:"call",anchor:"transformers.TFMPNetForMaskedLM.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_tf_mpnet.py#L812",parametersDescription:[{anchor:"transformers.TFMPNetForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),jo=new Ne({props:{$$slots:{default:[V_]},$$scope:{ctx:Q}}}),Ns=new ne({props:{name:"call",anchor:"transformers.TFMPNetForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1170",parametersDescription:[{anchor:"transformers.TFMPNetForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15678/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Do=new Ne({props:{$$slots:{default:[J_]},$$scope:{ctx:Q}}}),xs=new Ye({props:{code:`from transformers import MPNetTokenizer, TFMPNetForQuestionAnswering
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>answer = <span class="hljs-string">&quot; &quot;</span>.join(all_tokens[tf.math.argmax(start_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] : tf.math.argmax(end_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] + <span class="hljs-number">1</span>])`}}),{c(){p=n("meta"),y=l(),f=n("h1"),g=n("a"),v=n("span"),M(k.$$.fragment),_=l(),F=n("span"),le=a("MPNet"),U=l(),z=n("h2"),X=n("a"),S=n("span"),M(J.$$.fragment),de=l(),O=n("span"),ce=a("Overview"),se=l(),R=n("p"),A=a("The MPNet model was proposed in "),G=n("a"),V=a("MPNet: Masked and Permuted Pre-training for Language Understanding"),E=a(" by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),q=l(),Y=n("p"),B=a(`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
...
`),Bo=n("a"),Hl=a("mpnet-base"),Rl=a(" architecture."),Ul=l(),yt=n("p"),Vl=a("Configuration objects inherit from "),Ss=n("a"),Kl=a("PretrainedConfig"),Xl=a(` and can be used to control the model outputs. Read the
documentation from `),Os=n("a"),Jl=a("PretrainedConfig"),Gl=a(" for more information."),Yl=l(),Cr=n("p"),Zl=a("Examples:"),ed=l(),M(Ho.$$.fragment),ui=l(),Ft=n("h2"),no=n("a"),xr=n("span"),M(Ro.$$.fragment),td=l(),jr=n("span"),od=a("MPNetTokenizer"),fi=l(),$e=n("div"),M(Uo.$$.fragment),nd=l(),Vo=n("p"),sd=a("This tokenizer inherits from "),Ws=n("a"),rd=a("BertTokenizer"),ad=a(` which contains most of the methods. Users should refer to the
...
adding special tokens. A MPNet sequence has the following format:`),cd=l(),Xo=n("ul"),Qs=n("li"),pd=a("single sequence: "),Ar=n("code"),hd=a("<s> X </s>"),md=l(),Bs=n("li"),ud=a("pair of sequences: "),Ir=n("code"),fd=a("<s> A </s></s> B </s>"),gd=l(),so=n("div"),M(Jo.$$.fragment),_d=l(),Go=n("p"),kd=a(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xp=l(),Wn=n("p"),Jp=a("This model is also a PyTorch "),Qn=n("a"),Gp=a("torch.nn.Module"),Yp=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kh=l(),Kn=n("p"),vh=a("This model is also a "),Xn=n("a"),Th=a("tf.keras.Model"),Mh=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bh=l(),M(bo.$$.fragment),wh=l(),Re=n("div"),M(Jn.$$.fragment),Ph=l(),Ht=n("p"),Nh=a("The "),nr=n("a"),$h=a("TFMPNetModel"),yh=a(" forward method, overrides the "),Na=n("code"),Fh=a("__call__"),zh=a(" special method."),Eh=l(),M(wo.$$.fragment),qh=l(),$a=n("p"),Ch=a("Example:"),xh=l(),M(Gn.$$.fragment),Ci=l(),Rt=n("h2"),Po=n("a"),ya=n("span"),M(Yn.$$.fragment),jh=l(),Fa=n("span"),Lh=a("TFMPNetForMaskedLM"),xi=l(),Fe=n("div"),M(Zn.$$.fragment),Ah=l(),es=n("p"),Ih=a("MPNet Model with a "),za=n("code"),Dh=a("language modeling"),Sh=a(" head on top."),Oh=l(),ts=n("p"),Wh=a("This model inherits from "),sr=n("a"),Qh=a("TFPreTrainedModel"),Bh=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh=l(),os=n("p"),Rh=a("This model is also a "),ns=n("a"),Uh=a("tf.keras.Model"),Vh=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kh=l(),M(No.$$.fragment),Xh=l(),Ue=n("div"),M(ss.$$.fragment),Jh=l(),Ut=n("p"),Gh=a("The "),rr=n("a"),Yh=a("TFMPNetForMaskedLM"),Zh=a(" forward method, overrides the "),Ea=n("code"),em=a("__call__"),tm=a(" special method."),om=l(),M($o.$$.fragment),nm=l(),qa=n("p"),sm=a("Example:"),rm=l(),M(rs.$$.fragment),ji=l(),Vt=n("h2"),yo=n("a"),Ca=n("span"),M(as.$$.fragment),am=l(),xa=n("span"),im=a("TFMPNetForSequenceClassification"),Li=l(),ze=n("div"),M(is.$$.fragment),lm=l(),ja=n("p"),dm=a(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),km=l(),M(Fo.$$.fragment),vm=l(),Ve=n("div"),M(ps.$$.fragment),Tm=l(),Kt=n("p"),Mm=a("The "),ir=n("a"),bm=a("TFMPNetForSequenceClassification"),wm=a(" forward method, overrides the "),La=n("code"),Pm=a("__call__"),Nm=a(" special method."),$m=l(),M(zo.$$.fragment),ym=l(),Aa=n("p"),Fm=a("Example:"),zm=l(),M(hs.$$.fragment),Ai=l(),Xt=n("h2"),Eo=n("a"),Ia=n("span"),M(ms.$$.fragment),Em=l(),Da=n("span"),qm=a("TFMPNetForMultipleChoice"),Ii=l(),Ee=n("div"),M(us.$$.fragment),Cm=l(),Sa=n("p"),xm=a(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qm=l(),M(qo.$$.fragment),Bm=l(),Ke=n("div"),M(ks.$$.fragment),Hm=l(),Jt=n("p"),Rm=a("The "),dr=n("a"),Um=a("TFMPNetForMultipleChoice"),Vm=a(" forward method, overrides the "),Oa=n("code"),Km=a("__call__"),Xm=a(" special method."),Jm=l(),M(Co.$$.fragment),Gm=l(),Wa=n("p"),Ym=a("Example:"),Zm=l(),M(vs.$$.fragment),Di=l(),Gt=n("h2"),xo=n("a"),Qa=n("span"),M(Ts.$$.fragment),eu=l(),Ba=n("span"),tu=a("TFMPNetForTokenClassification"),Si=l(),qe=n("div"),M(Ms.$$.fragment),ou=l(),Ha=n("p"),nu=a(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hu=l(),M(jo.$$.fragment),mu=l(),Xe=n("div"),M(Ns.$$.fragment),uu=l(),Yt=n("p"),fu=a("The "),pr=n("a"),gu=a("TFMPNetForTokenClassification"),_u=a(" forward method, overrides the "),Ra=n("code"),ku=a("__call__"),vu=a(" special method."),Tu=l(),M(Lo.$$.fragment),Mu=l(),Ua=n("p"),bu=a("Example:"),wu=l(),M($s.$$.fragment),Oi=l(),Zt=n("h2"),Ao=n("a"),Va=n("span"),M(ys.$$.fragment),Pu=l(),Ka=n("span"),Nu=a("TFMPNetForQuestionAnswering"),Wi=l(),Ce=n("div"),M(Fs.$$.fragment),$u=l(),eo=n("p"),yu=a(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Xa=n("code"),Fu=a("span start logits"),zu=a(" and "),Ja=n("code"),Eu=a("span end logits"),qu=a(")."),Cu=l(),zs=n("p"),xu=a("This model inherits from "),hr=n("a"),ju=a("TFPreTrainedModel"),Lu=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Au=l(),Es=n("p"),Iu=a("This model is also a "),qs=n("a"),Du=a("tf.keras.Model"),Su=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ou=l(),M(Io.$$.fragment),Wu=l(),Je=n("div"),M(Cs.$$.fragment),Qu=l(),to=n("p"),Bu=a("The "),mr=n("a"),Hu=a("TFMPNetForQuestionAnswering"),Ru=a(" forward method, overrides the "),Ga=n("code"),Uu=a("__call__"),Vu=a(" special method."),Ku=l(),M(Do.$$.fragment),Xu=l(),Ya=n("p"),Ju=a("Example:"),Gu=l(),M(xs.$$.fragment),this.h()},l(o){const u=C_('[data-svelte="svelte-1phssyn"]',document.head);p=s(u,"META",{name:!0,content:!0}),u.forEach(t),y=d(o),f=s(o,"H1",{class:!0});var js=r(f);g=s(js,"A",{id:!0,class:!0,href:!0});var Za=r(g);v=s(Za,"SPAN",{});var ei=r(v);b(k.$$.fragment,ei),ei.forEach(t),Za.forEach(t),_=d(js),F=s(js,"SPAN",{});var ti=r(F);le=i(ti,"MPNet"),ti.forEach(t),js.forEach(t),U=d(o),z=s(o,"H2",{class:!0});var Ls=r(z);X=s(Ls,"A",{id:!0,class:!0,href:!0});var oi=r(X);S=s(oi,"SPAN",{});var ni=r(S);b(J.$$.fragment,ni),ni.forEach(t),oi.forEach(t),de=d(Ls),O=s(Ls,"SPAN",{});var si=r(O);ce=i(si,"Overview"),si.forEach(t),Ls.forEach(t),se=d(o),R=s(o,"P",{});var As=r(R);A=i(As,"The MPNet model was proposed in "),G=s(As,"A",{href:!0,rel:!0});var ri=r(G);V=i(ri,"MPNet: Masked and Permuted Pre-training for Language Understanding"),ri.forEach(t),E=i(As," by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),As.forEach(t),q=d(o),Y=s(o,"P",{});var ai=r(Y);B=i(ai,`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
...
instantiate a MPNet model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the MPNet
`),Bo=s(So,"A",{href:!0,rel:!0});var df=r(Bo);Hl=i(df,"mpnet-base"),df.forEach(t),Rl=i(So," architecture."),So.forEach(t),Ul=d(ct),yt=s(ct,"P",{});var ur=r(yt);Vl=i(ur,"Configuration objects inherit from "),Ss=s(ur,"A",{href:!0});var cf=r(Ss);Kl=i(cf,"PretrainedConfig"),cf.forEach(t),Xl=i(ur,` and can be used to control the model outputs. Read the
documentation from `),Os=s(ur,"A",{href:!0});var pf=r(Os);Jl=i(pf,"PretrainedConfig"),pf.forEach(t),Gl=i(ur," for more information."),ur.forEach(t),Yl=d(ct),Cr=s(ct,"P",{});var hf=r(Cr);Zl=i(hf,"Examples:"),hf.forEach(t),ed=d(ct),b(Ho.$$.fragment,ct),ct.forEach(t),ui=d(o),Ft=s(o,"H2",{class:!0});var Ri=r(Ft);no=s(Ri,"A",{id:!0,class:!0,href:!0});var mf=r(no);xr=s(mf,"SPAN",{});var uf=r(xr);b(Ro.$$.fragment,uf),uf.forEach(t),mf.forEach(t),td=d(Ri),jr=s(Ri,"SPAN",{});var ff=r(jr);od=i(ff,"MPNetTokenizer"),ff.forEach(t),Ri.forEach(t),fi=d(o),$e=s(o,"DIV",{class:!0});var et=r($e);b(Uo.$$.fragment,et),nd=d(et),Vo=s(et,"P",{});var Ui=r(Vo);sd=i(Ui,"This tokenizer inherits from "),Ws=s(Ui,"A",{href:!0});var gf=r(Ws);rd=i(gf,"BertTokenizer"),gf.forEach(t),ad=i(Ui,` which contains most of the methods. Users should refer to the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fl.forEach(t),Xp=d(vt),Wn=s(vt,"P",{});var gl=r(Wn);Jp=i(gl,"This model is also a PyTorch "),Qn=s(gl,"A",{href:!0,rel:!0});var Pg=r(Qn);Gp=i(Pg,"torch.nn.Module"),Pg.forEach(t),Yp=i(gl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wl.forEach(t),Kh=d(ot),b(No.$$.fragment,ot),Xh=d(ot),Ue=s(ot,"DIV",{class:!0});var bt=r(Ue);b(ss.$$.fragment,bt),Jh=d(bt),Ut=s(bt,"P",{});var Pr=r(Ut);Gh=i(Pr,"The "),rr=s(Pr,"A",{href:!0});var Bg=r(rr);Yh=i(Bg,"TFMPNetForMaskedLM"),Bg.forEach(t),Zh=i(Pr," forward method, overrides the "),Ea=s(Pr,"CODE",{});var Hg=r(Ea);em=i(Hg,"__call__"),Hg.forEach(t),tm=i(Pr," special method."),Pr.forEach(t),om=d(bt),b($o.$$.fragment,bt),nm=d(bt),qa=s(bt,"P",{});var Rg=r(qa);sm=i(Rg,"Example:"),Rg.forEach(t),rm=d(bt),b(rs.$$.fragment,bt),bt.forEach(t),ot.forEach(t),ji=d(o),Vt=s(o,"H2",{class:!0});var Pl=r(Vt);yo=s(Pl,"A",{id:!0,class:!0,href:!0});var Ug=r(yo);Ca=s(Ug,"SPAN",{});var Vg=r(Ca);b(as.$$.fragment,Vg),Vg.forEach(t),Ug.forEach(t),am=d(Pl),xa=s(Pl,"SPAN",{});var Kg=r(xa);im=i(Kg,"TFMPNetForSequenceClassification"),Kg.forEach(t),Pl.forEach(t),Li=d(o),ze=s(o,"DIV",{class:!0});var nt=r(ze);b(is.$$.fragment,nt),lm=d(nt),ja=s(nt,"P",{});var Xg=r(ja);dm=i(Xg,`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),Xg.forEach(t),cm=d(nt),ls=s(nt,"P",{});var Nl=r(ls);pm=i(Nl,"This model inherits from "),ar=s(Nl,"A",{href:!0});var Jg=r(ar);hm=i(Jg,"TFPreTrainedModel"),Jg.forEach(t),mm=i(Nl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
