import{S as iy,i as dy,s as ly,e as o,k as d,w as f,t as r,M as cy,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as p,y as g,q as T,o as k,B as v}from"../../chunks/vendor-4833417e.js";import{T as $t}from"../../chunks/Tip-fffd6df1.js";import{D as P}from"../../chunks/Docstring-6a25bf3b.js";import{C as R}from"../../chunks/CodeBlock-90ffda97.js";import{I as ke}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-04a16537.js";function py(L){let u,x,b,y,$;return{c(){u=o("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),y=r("Module"),$=r(`
...
the latter silently ignores them.`)},l(z){u=s(z,"P",{});var w=a(u);x=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var E=a(b);y=i(E,"Module"),E.forEach(t),$=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(z,w){p(z,u,w),e(u,x),e(u,b),e(b,y),e(u,$)},d(z){z&&t(u)}}}function wy(L){let u,x,b,y,$,z,w,E,Ee,oe,q,ee,O,se,qe,G,je,ve,B,I,ae,pe,F,C,he,K,be,ue,U,Fe,we,M,Me,H,V,me,A,Pe,fe,D,Ce,W,Ae,m,j,te,Oe,lt,S,Ge,ne,ct,N,Y,pt,Ne,Z,ht,Le,Ie,ut,Wl,Va,Lp,Rl,Be,si,ai,_o,Ip,Dp,ri,ii,go,Sp,Op,di,li,To,Gp,Bp,ci,pi,ko,Up,Wp,hi,Ka,vo,Rp,Hp,Hl,Ya,Vp,Vl,xt,ui,$n,mi,Kp,Yp,Za,Zp,Jp,Xp,fi,xn,_i,Qp,eh,Ja,th,nh,oh,gi,En,Ti,sh,ah,Xa,rh,ih,Kl,qn,dh,bo,lh,ch,Yl,Et,ph,wo,hh,uh,yo,mh,fh,Zl,Qa,Jl,Zt,jn,ki,zo,_h,vi,gh,Xl,mt,Th,bi,kh,vh,wi,bh,wh,yi,yh,zh,Ql,Fn,$h,er,xh,Eh,ec,Mn,dt,zi,qh,jh,_e,Fh,$i,Mh,Ph,xi,Ch,Ah,Ei,Nh,Lh,qi,Ih,Dh,ji,Sh,Oh,tr,Gh,Bh,Uh,Fi,Wh,Rh,$o,Hh,xo,Vh,Eo,Kh,Yh,Zh,ge,Mi,Jh,Xh,Pi,Qh,eu,qo,tu,re,nu,Ci,ou,su,Ai,au,ru,Ni,iu,du,Li,lu,cu,Ii,pu,hu,Di,uu,mu,Si,fu,_u,gu,Jt,Tu,Oi,ku,vu,Gi,bu,wu,yu,Te,zu,Bi,$u,xu,Ui,Eu,qu,Wi,ju,Fu,Ri,Mu,Pu,jo,Cu,Au,Hi,Nu,Lu,Iu,Fo,tc,nr,Du,nc,qt,Vi,Mo,Su,Ki,Ou,Gu,Bu,Yi,Xt,Uu,Po,Wu,Ru,Co,Hu,Vu,Ku,Zi,Ao,Yu,Ji,Zu,Ju,oc,or,sc,Qt,Pn,Xi,No,Xu,Qi,Qu,ac,ft,em,sr,tm,nm,Lo,om,sm,Io,am,rm,rc,Do,ic,Ue,im,ed,dm,lm,td,cm,pm,ar,hm,um,nd,mm,fm,dc,rr,_m,lc,So,cc,ir,pc,en,Cn,od,Oo,gm,sd,Tm,hc,_t,km,Go,vm,bm,ad,wm,ym,rd,zm,$m,uc,tn,An,id,Bo,xm,dd,Em,mc,dr,qm,fc,Nn,ld,nn,jm,Uo,Fm,Mm,Wo,Pm,Cm,Am,cd,De,Nm,Ro,Lm,Im,Ho,Dm,Sm,Vo,Om,Gm,Ko,Bm,Um,Yo,Wm,Rm,_c,on,Ln,pd,Zo,Hm,hd,Vm,gc,bt,Jo,Km,wt,Ym,lr,Zm,Jm,cr,Xm,Qm,Xo,ef,tf,nf,sn,of,pr,sf,af,hr,rf,df,Tc,an,In,ud,Qo,lf,md,cf,kc,ie,es,pf,ts,hf,ns,uf,mf,ff,os,_f,ur,gf,Tf,kf,jt,ss,vf,fd,bf,wf,as,mr,yf,_d,zf,$f,fr,xf,gd,Ef,qf,Dn,rs,jf,is,Ff,Td,Mf,Pf,Cf,Sn,ds,Af,kd,Nf,Lf,vd,vc,rn,On,bd,ls,If,wd,Df,bc,Se,cs,Sf,dn,Of,yd,Gf,Bf,ps,Uf,Wf,Rf,hs,Hf,_r,Vf,Kf,Yf,Ft,us,Zf,zd,Jf,Xf,ms,gr,Qf,$d,e_,t_,Tr,n_,xd,o_,s_,Gn,fs,a_,Ed,r_,wc,ln,Bn,qd,_s,i_,jd,d_,yc,J,gs,l_,Fd,c_,p_,Ts,h_,ks,u_,m_,f_,vs,__,kr,g_,T_,k_,bs,v_,ws,b_,w_,y_,We,ys,z_,cn,$_,vr,x_,E_,Md,q_,j_,F_,Un,M_,Pd,P_,C_,zs,A_,Re,$s,N_,Cd,L_,I_,Ad,D_,S_,Nd,O_,G_,xs,B_,gt,Es,U_,Ld,W_,R_,Id,H_,V_,qs,zc,pn,Wn,Dd,js,K_,Sd,Y_,$c,X,Fs,Z_,Ms,J_,Od,X_,Q_,eg,Ps,tg,Cs,ng,og,sg,As,ag,br,rg,ig,dg,Ns,lg,Ls,cg,pg,hg,He,Is,ug,hn,mg,wr,fg,_g,Gd,gg,Tg,kg,Rn,vg,Bd,bg,wg,Ds,yg,Ve,Ss,zg,Ud,$g,xg,Wd,Eg,qg,Rd,jg,Fg,Os,Mg,Tt,Gs,Pg,Hd,Cg,Ag,Vd,Ng,Lg,Bs,xc,un,Hn,Kd,Us,Ig,Yd,Dg,Ec,Q,Ws,Sg,Zd,Og,Gg,Rs,Bg,Hs,Ug,Wg,Rg,Vs,Hg,yr,Vg,Kg,Yg,Ks,Zg,Ys,Jg,Xg,Qg,Ke,Zs,eT,mn,tT,zr,nT,oT,Jd,sT,aT,rT,Vn,iT,Xd,dT,lT,Js,cT,Ye,Xs,pT,Qd,hT,uT,el,mT,fT,tl,_T,gT,Qs,TT,kt,ea,kT,nl,vT,bT,ol,wT,yT,ta,qc,fn,Kn,sl,na,zT,al,$T,jc,de,oa,xT,rl,ET,qT,sa,jT,aa,FT,MT,PT,ra,CT,$r,AT,NT,LT,ia,IT,da,DT,ST,OT,Yn,GT,Ze,la,BT,_n,UT,xr,WT,RT,il,HT,VT,KT,Zn,YT,dl,ZT,JT,ca,Fc,gn,Jn,ll,pa,XT,cl,QT,Mc,le,ha,ek,ua,tk,pl,nk,ok,sk,ma,ak,fa,rk,ik,dk,_a,lk,Er,ck,pk,hk,ga,uk,Ta,mk,fk,_k,Xn,gk,Je,ka,Tk,Tn,kk,qr,vk,bk,hl,wk,yk,zk,Qn,$k,ul,xk,Ek,va,Pc,kn,eo,ml,ba,qk,fl,jk,Cc,ce,wa,Fk,_l,Mk,Pk,ya,Ck,za,Ak,Nk,Lk,$a,Ik,jr,Dk,Sk,Ok,xa,Gk,Ea,Bk,Uk,Wk,to,Rk,Xe,qa,Hk,vn,Vk,Fr,Kk,Yk,gl,Zk,Jk,Xk,no,Qk,Tl,ev,tv,ja,Ac,bn,oo,kl,Fa,nv,vl,ov,Nc,yt,Qe,Ma,sv,wn,av,bl,rv,iv,wl,dv,lv,cv,so,pv,yl,hv,uv,Pa,mv,Mt,Ca,fv,zl,_v,gv,Aa,Tv,Pt,Na,kv,$l,vv,bv,La,Lc,yn,ao,xl,Ia,wv,El,yv,Ic,zt,et,Da,zv,zn,$v,ql,xv,Ev,jl,qv,jv,Fv,ro,Mv,Fl,Pv,Cv,Sa,Av,Ct,Oa,Nv,Ml,Lv,Iv,Ga,Dv,At,Ba,Sv,Pl,Ov,Gv,Ua,Dc;return z=new ke({}),se=new ke({}),zo=new ke({}),$o=new R({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`}}),Vn=new $t({props:{$$slots:{default:[uy]},$$scope:{ctx:L}}}),Js=new R({props:{code:`from transformers import T5Tokenizer, T5EncoderModel
...
`}}),Zn=new $t({props:{$$slots:{default:[fy]},$$scope:{ctx:L}}}),ca=new R({props:{code:`from transformers import T5Tokenizer, TFT5Model
...
for summarization: `),W=o("em"),Ae=r("summarize: \u2026"),m=r("."),j=d(),te=o("li"),Oe=o("p"),lt=r("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),S=d(),Ge=o("li"),ne=o("p"),ct=r("See the "),N=o("a"),Y=r("training"),pt=r(", "),Ne=o("a"),Z=r("inference"),ht=r(" and "),Le=o("a"),Ie=r("scripts"),ut=r(" sections below for all details regarding usage."),Wl=d(),Va=o("p"),Lp=r("T5 comes in different sizes:"),Rl=d(),Be=o("ul"),si=o("li"),ai=o("p"),_o=o("a"),Ip=r("t5-small"),Dp=d(),ri=o("li"),ii=o("p"),go=o("a"),Sp=r("t5-base"),Op=d(),di=o("li"),li=o("p"),To=o("a"),Gp=r("t5-large"),Bp=d(),ci=o("li"),pi=o("p"),ko=o("a"),Up=r("t5-3b"),Wp=d(),hi=o("li"),Ka=o("p"),vo=o("a"),Rp=r("t5-11b"),Hp=r("."),Hl=d(),Ya=o("p"),Vp=r("Based on the original T5 model, Google has released some follow-up works:"),Vl=d(),xt=o("ul"),ui=o("li"),$n=o("p"),mi=o("strong"),Kp=r("T5v1.1"),Yp=r(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),Za=o("a"),Zp=r("here"),Jp=r("."),Xp=d(),fi=o("li"),xn=o("p"),_i=o("strong"),Qp=r("mT5"),eh=r(`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),Ja=o("a"),th=r("here"),nh=r("."),oh=d(),gi=o("li"),En=o("p"),Ti=o("strong"),sh=r("byT5"),ah=r(`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),Xa=o("a"),rh=r("here"),ih=r("."),Kl=d(),qn=o("p"),dh=r("All checkpoints can be found on the "),bo=o("a"),lh=r("hub"),ch=r("."),Yl=d(),Et=o("p"),ph=r("This model was contributed by "),wo=o("a"),hh=r("thomwolf"),uh=r(". The original code can be found "),yo=o("a"),mh=r("here"),fh=r("."),Zl=d(),Qa=o("a"),Jl=d(),Zt=o("h2"),jn=o("a"),ki=o("span"),f(zo.$$.fragment),_h=d(),vi=o("span"),gh=r("Training"),Xl=d(),mt=o("p"),Th=r(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
directory.`),Zh=d(),ge=o("li"),Mi=o("p"),Jh=r("Supervised training"),Xh=d(),Pi=o("p"),Qh=r(`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
...
during T5\u2019s pre-training.`),gu=d(),Jt=o("p"),Tu=r(`However, the example above only shows a single training example. In practice, one trains deep learning models in
...
used).`),Ku=d(),Zi=o("li"),Ao=o("p"),Yu=r(`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
`),Ji=o("em"),Zu=r("pad_to_multiple_of"),Ju=r(` to have a small number of predefined bucket sizes to fit all examples in. Dynamically padding
...
you to easily fine-tune T5 on custom data for summarization/translation.`),_c=d(),on=o("h2"),Ln=o("a"),pd=o("span"),f(Zo.$$.fragment),Hm=d(),hd=o("span"),Vm=r("T5Config"),gc=d(),bt=o("div"),f(Jo.$$.fragment),Km=d(),wt=o("p"),Ym=r("This is the configuration class to store the configuration of a "),lr=o("a"),Zm=r("T5Model"),Jm=r(" or a "),cr=o("a"),Xm=r("TFT5Model"),Qm=r(`. It is used to
...
refer to this superclass for more information regarding those methods.`),Yf=d(),Ft=o("div"),f(us.$$.fragment),Zf=d(),zd=o("p"),Jf=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
use of token type ids, therefore a list of zeros is returned.`),wc=d(),ln=o("h2"),Bn=o("a"),qd=o("span"),f(_s.$$.fragment),i_=d(),jd=o("span"),d_=r("T5Model"),yc=d(),J=o("div"),f(gs.$$.fragment),l_=d(),Fd=o("p"),c_=r("The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),p_=d(),Ts=o("p"),h_=r("The T5 model was proposed in "),ks=o("a"),u_=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
it will evenly distribute blocks across all devices.`),qg=d(),Rd=o("p"),jg=r("Example:"),Fg=d(),f(Os.$$.fragment),Mg=d(),Tt=o("div"),f(Gs.$$.fragment),Pg=d(),Hd=o("p"),Cg=r("Moves the model to cpu from a model parallel state."),Ag=d(),Vd=o("p"),Ng=r("Example:"),Lg=d(),f(Bs.$$.fragment),xc=d(),un=o("h2"),Hn=o("a"),Kd=o("span"),f(Us.$$.fragment),Ig=d(),Yd=o("span"),Dg=r("T5EncoderModel"),Ec=d(),Q=o("div"),f(Ws.$$.fragment),Sg=d(),Zd=o("p"),Og=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Gg=d(),Rs=o("p"),Bg=r("The T5 model was proposed in "),Hs=o("a"),Ug=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yg=d(),Ks=o("p"),Zg=r("This model is also a PyTorch "),Ys=o("a"),Jg=r("torch.nn.Module"),Xg=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qg=d(),Ke=o("div"),f(Zs.$$.fragment),eT=d(),mn=o("p"),tT=r("The "),zr=o("a"),nT=r("T5EncoderModel"),oT=r(" forward method, overrides the "),Jd=o("code"),sT=r("__call__"),aT=r(" special method."),rT=d(),f(Vn.$$.fragment),iT=d(),Xd=o("p"),dT=r("Example:"),lT=d(),f(Js.$$.fragment),cT=d(),Ye=o("div"),f(Xs.$$.fragment),pT=d(),Qd=o("p"),hT=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),uT=d(),el=o("p"),mT=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
...
behavior.`),OT=d(),f(Yn.$$.fragment),GT=d(),Ze=o("div"),f(la.$$.fragment),BT=d(),_n=o("p"),UT=r("The "),xr=o("a"),WT=r("TFT5Model"),RT=r(" forward method, overrides the "),il=o("code"),HT=r("__call__"),VT=r(" special method."),KT=d(),f(Zn.$$.fragment),YT=d(),dl=o("p"),ZT=r("Examples:"),JT=d(),f(ca.$$.fragment),Fc=d(),gn=o("h2"),Jn=o("a"),ll=o("span"),f(pa.$$.fragment),XT=d(),cl=o("span"),QT=r("TFT5ForConditionalGeneration"),Mc=d(),le=o("div"),f(ha.$$.fragment),ek=d(),ua=o("p"),tk=r("T5 Model with a "),pl=o("code"),nk=r("language modeling"),ok=r(" head on top."),sk=d(),ma=o("p"),ak=r("The T5 model was proposed in "),fa=o("a"),rk=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
directory.`),Uc.forEach(t),Lt.forEach(t),Zh=l(Bc),ge=s(Bc,"LI",{});var nt=a(ge);Mi=s(nt,"P",{});var Y5=a(Mi);Jh=i(Y5,"Supervised training"),Y5.forEach(t),Xh=l(nt),Pi=s(nt,"P",{});var Z5=a(Pi);Qh=i(Z5,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),Z5.forEach(t),eu=l(nt),_(qo.$$.fragment,nt),tu=l(nt),re=s(nt,"P",{});var ye=a(re);nu=i(ye,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ci=s(ye,"CODE",{});var J5=a(Ci);ou=i(J5,"input_ids"),J5.forEach(t),su=i(ye,` (which are the
...
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
during T5\u2019s pre-training.`),ye.forEach(t),gu=l(nt),Jt=s(nt,"P",{});var Nr=a(Jt);Tu=i(Nr,`However, the example above only shows a single training example. In practice, one trains deep learning models in
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
...
used).`),Ir.forEach(t),fb.forEach(t),Ku=l(Lr),Zi=s(Lr,"LI",{});var Tb=a(Zi);Ao=s(Tb,"P",{});var Rc=a(Ao);Yu=i(Rc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
`),Ji=s(Rc,"EM",{});var kb=a(Ji);Zu=i(kb,"pad_to_multiple_of"),kb.forEach(t),Ju=i(Rc,` to have a small number of predefined bucket sizes to fit all examples in. Dynamically padding
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
...
you to easily fine-tune T5 on custom data for summarization/translation.`),vt.forEach(t),Wb.forEach(t),Yc.forEach(t),_c=l(n),on=s(n,"H2",{class:!0});var Zc=a(on);Ln=s(Zc,"A",{id:!0,class:!0,href:!0});var Zb=a(Ln);pd=s(Zb,"SPAN",{});var Jb=a(pd);_(Zo.$$.fragment,Jb),Jb.forEach(t),Zb.forEach(t),Hm=l(Zc),hd=s(Zc,"SPAN",{});var Xb=a(hd);Vm=i(Xb,"T5Config"),Xb.forEach(t),Zc.forEach(t),gc=l(n),bt=s(n,"DIV",{class:!0});var Sr=a(bt);_(Jo.$$.fragment,Sr),Km=l(Sr),wt=s(Sr,"P",{});var ho=a(wt);Ym=i(ho,"This is the configuration class to store the configuration of a "),lr=s(ho,"A",{href:!0});var Qb=a(lr);Zm=i(Qb,"T5Model"),Qb.forEach(t),Jm=i(ho," or a "),cr=s(ho,"A",{href:!0});var e1=a(cr);Xm=i(e1,"TFT5Model"),e1.forEach(t),Qm=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
documentation from `),hr=s(Or,"A",{href:!0});var o1=a(hr);rf=i(o1,"PretrainedConfig"),o1.forEach(t),df=i(Or," for more information."),Or.forEach(t),Sr.forEach(t),Tc=l(n),an=s(n,"H2",{class:!0});var Jc=a(an);In=s(Jc,"A",{id:!0,class:!0,href:!0});var s1=a(In);ud=s(s1,"SPAN",{});var a1=a(ud);_(Qo.$$.fragment,a1),a1.forEach(t),s1.forEach(t),lf=l(Jc),md=s(Jc,"SPAN",{});var r1=a(md);cf=i(r1,"T5Tokenizer"),r1.forEach(t),Jc.forEach(t),kc=l(n),ie=s(n,"DIV",{class:!0});var st=a(ie);_(es.$$.fragment,st),pf=l(st),ts=s(st,"P",{});var Xc=a(ts);hf=i(Xc,"Construct a T5 tokenizer. Based on "),ns=s(Xc,"A",{href:!0,rel:!0});var i1=a(ns);uf=i(i1,"SentencePiece"),i1.forEach(t),mf=i(Xc,"."),Xc.forEach(t),ff=l(st),os=s(st,"P",{});var Qc=a(os);_f=i(Qc,"This tokenizer inherits from "),ur=s(Qc,"A",{href:!0});var d1=a(ur);gf=i(d1,"PreTrainedTokenizer"),d1.forEach(t),Tf=i(Qc,` which contains most of the main methods. Users should refer to
...
refer to this superclass for more information regarding those methods.`),ap.forEach(t),Yf=l(Dt),Ft=s(Dt,"DIV",{class:!0});var Ur=a(Ft);_(us.$$.fragment,Ur),Zf=l(Ur),zd=s(Ur,"P",{});var v1=a(zd);Jf=i(v1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
use of token type ids, therefore a list of zeros is returned.`),y1.forEach(t),ip.forEach(t),Dt.forEach(t),wc=l(n),ln=s(n,"H2",{class:!0});var dp=a(ln);Bn=s(dp,"A",{id:!0,class:!0,href:!0});var z1=a(Bn);qd=s(z1,"SPAN",{});var $1=a(qd);_(_s.$$.fragment,$1),$1.forEach(t),z1.forEach(t),i_=l(dp),jd=s(dp,"SPAN",{});var x1=a(jd);d_=i(x1,"T5Model"),x1.forEach(t),dp.forEach(t),yc=l(n),J=s(n,"DIV",{class:!0});var ze=a(J);_(gs.$$.fragment,ze),l_=l(ze),Fd=s(ze,"P",{});var E1=a(Fd);c_=i(E1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),E1.forEach(t),p_=l(ze),Ts=s(ze,"P",{});var lp=a(Ts);h_=i(lp,"The T5 model was proposed in "),ks=s(lp,"A",{href:!0,rel:!0});var q1=a(ks);u_=i(q1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p.forEach(t),hg=l($e),He=s($e,"DIV",{class:!0});var Gt=a(He);_(Is.$$.fragment,Gt),ug=l(Gt),hn=s(Gt,"P",{});var Rr=a(hn);mg=i(Rr,"The "),wr=s(Rr,"A",{href:!0});var H1=a(wr);fg=i(H1,"T5ForConditionalGeneration"),H1.forEach(t),_g=i(Rr," forward method, overrides the "),Gd=s(Rr,"CODE",{});var V1=a(Gd);gg=i(V1,"__call__"),V1.forEach(t),Tg=i(Rr," special method."),Rr.forEach(t),kg=l(Gt),_(Rn.$$.fragment,Gt),vg=l(Gt),Bd=s(Gt,"P",{});var K1=a(Bd);bg=i(K1,"Examples:"),K1.forEach(t),wg=l(Gt),_(Ds.$$.fragment,Gt),Gt.forEach(t),yg=l($e),Ve=s($e,"DIV",{class:!0});var Bt=a(Ve);_(Ss.$$.fragment,Bt),zg=l(Bt),Ud=s(Bt,"P",{});var Y1=a(Ud);$g=i(Y1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Y1.forEach(t),xg=l(Bt),Wd=s(Bt,"P",{});var Z1=a(Wd);Eg=i(Z1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Z1.forEach(t),qg=l(Bt),Rd=s(Bt,"P",{});var J1=a(Rd);jg=i(J1,"Example:"),J1.forEach(t),Fg=l(Bt),_(Os.$$.fragment,Bt),Bt.forEach(t),Mg=l($e),Tt=s($e,"DIV",{class:!0});var mo=a(Tt);_(Gs.$$.fragment,mo),Pg=l(mo),Hd=s(mo,"P",{});var X1=a(Hd);Cg=i(X1,"Moves the model to cpu from a model parallel state."),X1.forEach(t),Ag=l(mo),Vd=s(mo,"P",{});var Q1=a(Vd);Ng=i(Q1,"Example:"),Q1.forEach(t),Lg=l(mo),_(Bs.$$.fragment,mo),mo.forEach(t),$e.forEach(t),xc=l(n),un=s(n,"H2",{class:!0});var gp=a(un);Hn=s(gp,"A",{id:!0,class:!0,href:!0});var ew=a(Hn);Kd=s(ew,"SPAN",{});var tw=a(Kd);_(Us.$$.fragment,tw),tw.forEach(t),ew.forEach(t),Ig=l(gp),Yd=s(gp,"SPAN",{});var nw=a(Yd);Dg=i(nw,"T5EncoderModel"),nw.forEach(t),gp.forEach(t),Ec=l(n),Q=s(n,"DIV",{class:!0});var xe=a(Q);_(Ws.$$.fragment,xe),Sg=l(xe),Zd=s(xe,"P",{});var ow=a(Zd);Og=i(ow,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),ow.forEach(t),Gg=l(xe),Rs=s(xe,"P",{});var Tp=a(Rs);Bg=i(Tp,"The T5 model was proposed in "),Hs=s(Tp,"A",{href:!0,rel:!0});var sw=a(Hs);Ug=i(sw,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kp.forEach(t),Yg=l(xe),Ks=s(xe,"P",{});var vp=a(Ks);Zg=i(vp,"This model is also a PyTorch "),Ys=s(vp,"A",{href:!0,rel:!0});var rw=a(Ys);Jg=i(rw,"torch.nn.Module"),rw.forEach(t),Xg=i(vp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vp.forEach(t),Qg=l(xe),Ke=s(xe,"DIV",{class:!0});var Ut=a(Ke);_(Zs.$$.fragment,Ut),eT=l(Ut),mn=s(Ut,"P",{});var Hr=a(mn);tT=i(Hr,"The "),zr=s(Hr,"A",{href:!0});var iw=a(zr);nT=i(iw,"T5EncoderModel"),iw.forEach(t),oT=i(Hr," forward method, overrides the "),Jd=s(Hr,"CODE",{});var dw=a(Jd);sT=i(dw,"__call__"),dw.forEach(t),aT=i(Hr," special method."),Hr.forEach(t),rT=l(Ut),_(Vn.$$.fragment,Ut),iT=l(Ut),Xd=s(Ut,"P",{});var lw=a(Xd);dT=i(lw,"Example:"),lw.forEach(t),lT=l(Ut),_(Js.$$.fragment,Ut),Ut.forEach(t),cT=l(xe),Ye=s(xe,"DIV",{class:!0});var Wt=a(Ye);_(Xs.$$.fragment,Wt),pT=l(Wt),Qd=s(Wt,"P",{});var cw=a(Qd);hT=i(cw,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),cw.forEach(t),uT=l(Wt),el=s(Wt,"P",{});var pw=a(el);mT=i(pw,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
