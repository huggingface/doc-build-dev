...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_15678/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vn=new U({props:{name:"forward",anchor:"transformers.DistilBertForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_15678/src/transformers/models/distilbert/modeling_distilbert.py#L934",parametersDescription:[{anchor:"transformers.DistilBertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_15678/en/model_doc/distilbert#transformers.DistilBertTokenizer">DistilBertTokenizer</a>. See <a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_15678/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
for Named-Entity-Recognition (NER) tasks.`),Jv=l(),Pr=s("p"),Vv=a("This model inherits from "),Si=s("a"),Kv=a("TFPreTrainedModel"),Gv=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ET=l(),b(Es.$$.fragment),xT=l(),st=s("div"),b(Hr.$$.fragment),zT=l(),Ao=s("p"),CT=a("The "),Wi=s("a"),jT=a("TFDistilBertForQuestionAnswering"),PT=a(" forward method, overrides the "),jd=s("code"),qT=a("__call__"),AT=a(" special method."),IT=l(),b(xs.$$.fragment),LT=l(),Pd=s("p"),ST=a("Example:"),NT=l(),b(Qr.$$.fragment),Hp=l(),Io=s("h2"),zs=s("a"),qd=s("span"),b(Ur.$$.fragment),OT=l(),Ad=s("span"),WT=a("FlaxDistilBertModel"),Qp=l(),Be=s("div"),b(Jr.$$.fragment),RT=l(),Id=s("p"),HT=a("The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),QT=l(),Vr=s("p"),UT=a("This model inherits from "),Ri=s("a"),JT=a("FlaxPreTrainedModel"),VT=a(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Pb=l(),Kd=s("p"),qb=a("Finally, this model supports inherent JAX features such as:"),Ab=l(),Mt=s("ul"),Gd=s("li"),da=s("a"),Ib=a("Just-In-Time (JIT) compilation"),Lb=l(),Xd=s("li"),ca=s("a"),Sb=a("Automatic Differentiation"),Nb=l(),Yd=s("li"),pa=s("a"),Ob=a("Vectorization"),Wb=l(),Zd=s("li"),ha=s("a"),Rb=a("Parallelization"),Hb=l(),rt=s("div"),b(ua.$$.fragment),Qb=l(),No=s("p"),Ub=a("The "),ec=s("code"),Jb=a("FlaxDistilBertPreTrainedModel"),Vb=a("forward method, overrides the "),tc=s("code"),Kb=a("__call__"),Gb=a(" special method."),Xb=l(),b(Ps.$$.fragment),Yb=l(),oc=s("p"),Zb=a("Example:"),e1=l(),b(fa.$$.fragment),Vp=l(),Oo=s("h2"),qs=s("a"),sc=s("span"),b(ma.$$.fragment),t1=l(),nc=s("span"),o1=a("FlaxDistilBertForSequenceClassification"),Kp=l(),Ee=s("div"),b(ga.$$.fragment),s1=l(),rc=s("p"),n1=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
for Named-Entity-Recognition (NER) tasks.`),WD.forEach(t),Jv=d(Dt),Pr=n(Dt,"P",{});var Wh=r(Pr);Vv=i(Wh,"This model inherits from "),Si=n(Wh,"A",{href:!0});var RD=r(Si);Kv=i(RD,"TFPreTrainedModel"),RD.forEach(t),Gv=i(Wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uh.forEach(t),ET=d(Ft),k(Es.$$.fragment,Ft),xT=d(Ft),st=n(Ft,"DIV",{class:!0});var Zt=r(st);k(Hr.$$.fragment,Zt),zT=d(Zt),Ao=n(Zt,"P",{});var dl=r(Ao);CT=i(dl,"The "),Wi=n(dl,"A",{href:!0});var tF=r(Wi);jT=i(tF,"TFDistilBertForQuestionAnswering"),tF.forEach(t),PT=i(dl," forward method, overrides the "),jd=n(dl,"CODE",{});var oF=r(jd);qT=i(oF,"__call__"),oF.forEach(t),AT=i(dl," special method."),dl.forEach(t),IT=d(Zt),k(xs.$$.fragment,Zt),LT=d(Zt),Pd=n(Zt,"P",{});var sF=r(Pd);ST=i(sF,"Example:"),sF.forEach(t),NT=d(Zt),k(Qr.$$.fragment,Zt),Zt.forEach(t),Ft.forEach(t),Hp=d(o),Io=n(o,"H2",{class:!0});var Jh=r(Io);zs=n(Jh,"A",{id:!0,class:!0,href:!0});var nF=r(zs);qd=n(nF,"SPAN",{});var rF=r(qd);k(Ur.$$.fragment,rF),rF.forEach(t),nF.forEach(t),OT=d(Jh),Ad=n(Jh,"SPAN",{});var aF=r(Ad);WT=i(aF,"FlaxDistilBertModel"),aF.forEach(t),Jh.forEach(t),Qp=d(o),Be=n(o,"DIV",{class:!0});var pt=r(Be);k(Jr.$$.fragment,pt),RT=d(pt),Id=n(pt,"P",{});var iF=r(Id);HT=i(iF,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),iF.forEach(t),QT=d(pt),Vr=n(pt,"P",{});var Vh=r(Vr);UT=i(Vh,"This model inherits from "),Ri=n(Vh,"A",{href:!0});var lF=r(Ri);JT=i(lF,"FlaxPreTrainedModel"),lF.forEach(t),VT=i(Vh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Vh.forEach(t),KT=d(pt),Kr=n(pt,"P",{});var Kh=r(Kr);GT=i(Kh,"This model is also a Flax Linen "),Gr=n(Kh,"A",{href:!0,rel:!0});var dF=r(Gr);XT=i(dF,"flax.linen.Module"),dF.forEach(t),YT=i(Kh,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Kh.forEach(t),ZT=d(pt),Ld=n(pt,"P",{});var cF=r(Ld);eb=i(cF,"Finally, this model supports inherent JAX features such as:"),cF.forEach(t),tb=d(pt),Bt=n(pt,"UL",{});var Us=r(Bt);Sd=n(Us,"LI",{});var pF=r(Sd);Xr=n(pF,"A",{href:!0,rel:!0});var hF=r(Xr);ob=i(hF,"Just-In-Time (JIT) compilation"),hF.forEach(t),pF.forEach(t),sb=d(Us),Nd=n(Us,"LI",{});var uF=r(Nd);Yr=n(uF,"A",{href:!0,rel:!0});var fF=r(Yr);nb=i(fF,"Automatic Differentiation"),fF.forEach(t),uF.forEach(t),rb=d(Us),Od=n(Us,"LI",{});var mF=r(Od);Zr=n(mF,"A",{href:!0,rel:!0});var gF=r(Zr);ab=i(gF,"Vectorization"),gF.forEach(t),mF.forEach(t),ib=d(Us),Wd=n(Us,"LI",{});var _F=r(Wd);ea=n(_F,"A",{href:!0,rel:!0});var vF=r(ea);lb=i(vF,"Parallelization"),vF.forEach(t),_F.forEach(t),Us.forEach(t),db=d(pt),nt=n(pt,"DIV",{class:!0});var eo=r(nt);k(ta.$$.fragment,eo),cb=d(eo),Lo=n(eo,"P",{});var cl=r(Lo);pb=i(cl,"The "),Rd=n(cl,"CODE",{});var TF=r(Rd);hb=i(TF,"FlaxDistilBertPreTrainedModel"),TF.forEach(t),ub=i(cl,"forward method, overrides the "),Hd=n(cl,"CODE",{});var bF=r(Hd);fb=i(bF,"__call__"),bF.forEach(t),mb=i(cl," special method."),cl.forEach(t),gb=d(eo),k(Cs.$$.fragment,eo),_b=d(eo),Qd=n(eo,"P",{});var kF=r(Qd);vb=i(kF,"Example:"),kF.forEach(t),Tb=d(eo),k(oa.$$.fragment,eo),eo.forEach(t),pt.forEach(t),Up=d(o),So=n(o,"H2",{class:!0});var Gh=r(So);js=n(Gh,"A",{id:!0,class:!0,href:!0});var wF=r(js);Ud=n(wF,"SPAN",{});var $F=r(Ud);k(sa.$$.fragment,$F),$F.forEach(t),wF.forEach(t),bb=d(Gh),Jd=n(Gh,"SPAN",{});var DF=r(Jd);kb=i(DF,"FlaxDistilBertForMaskedLM"),DF.forEach(t),Gh.forEach(t),Jp=d(o),Me=n(o,"DIV",{class:!0});var ht=r(Me);k(na.$$.fragment,ht),wb=d(ht),ra=n(ht,"P",{});var Xh=r(ra);$b=i(Xh,"DistilBert Model with a "),Vd=n(Xh,"CODE",{});var FF=r(Vd);Db=i(FF,"language modeling"),FF.forEach(t),Fb=i(Xh," head on top."),Xh.forEach(t),yb=d(ht),aa=n(ht,"P",{});var Yh=r(aa);Bb=i(Yh,"This model inherits from "),Hi=n(Yh,"A",{href:!0});var yF=r(Hi);Mb=i(yF,"FlaxPreTrainedModel"),yF.forEach(t),Eb=i(Yh,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zh.forEach(t),Pb=d(ht),Kd=n(ht,"P",{});var MF=r(Kd);qb=i(MF,"Finally, this model supports inherent JAX features such as:"),MF.forEach(t),Ab=d(ht),Mt=n(ht,"UL",{});var Js=r(Mt);Gd=n(Js,"LI",{});var EF=r(Gd);da=n(EF,"A",{href:!0,rel:!0});var xF=r(da);Ib=i(xF,"Just-In-Time (JIT) compilation"),xF.forEach(t),EF.forEach(t),Lb=d(Js),Xd=n(Js,"LI",{});var zF=r(Xd);ca=n(zF,"A",{href:!0,rel:!0});var CF=r(ca);Sb=i(CF,"Automatic Differentiation"),CF.forEach(t),zF.forEach(t),Nb=d(Js),Yd=n(Js,"LI",{});var jF=r(Yd);pa=n(jF,"A",{href:!0,rel:!0});var PF=r(pa);Ob=i(PF,"Vectorization"),PF.forEach(t),jF.forEach(t),Wb=d(Js),Zd=n(Js,"LI",{});var qF=r(Zd);ha=n(qF,"A",{href:!0,rel:!0});var AF=r(ha);Rb=i(AF,"Parallelization"),AF.forEach(t),qF.forEach(t),Js.forEach(t),Hb=d(ht),rt=n(ht,"DIV",{class:!0});var to=r(rt);k(ua.$$.fragment,to),Qb=d(to),No=n(to,"P",{});var pl=r(No);Ub=i(pl,"The "),ec=n(pl,"CODE",{});var IF=r(ec);Jb=i(IF,"FlaxDistilBertPreTrainedModel"),IF.forEach(t),Vb=i(pl,"forward method, overrides the "),tc=n(pl,"CODE",{});var LF=r(tc);Kb=i(LF,"__call__"),LF.forEach(t),Gb=i(pl," special method."),pl.forEach(t),Xb=d(to),k(Ps.$$.fragment,to),Yb=d(to),oc=n(to,"P",{});var SF=r(oc);Zb=i(SF,"Example:"),SF.forEach(t),e1=d(to),k(fa.$$.fragment,to),to.forEach(t),ht.forEach(t),Vp=d(o),Oo=n(o,"H2",{class:!0});var eu=r(Oo);qs=n(eu,"A",{id:!0,class:!0,href:!0});var NF=r(qs);sc=n(NF,"SPAN",{});var OF=r(sc);k(ma.$$.fragment,OF),OF.forEach(t),NF.forEach(t),t1=d(eu),nc=n(eu,"SPAN",{});var WF=r(nc);o1=i(WF,"FlaxDistilBertForSequenceClassification"),WF.forEach(t),eu.forEach(t),Kp=d(o),Ee=n(o,"DIV",{class:!0});var ut=r(Ee);k(ga.$$.fragment,ut),s1=d(ut),rc=n(ut,"P",{});var RF=r(rc);n1=i(RF,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ou.forEach(t),u1=d(ut),ac=n(ut,"P",{});var UF=r(ac);f1=i(UF,"Finally, this model supports inherent JAX features such as:"),UF.forEach(t),m1=d(ut),Et=n(ut,"UL",{});var Vs=r(Et);ic=n(Vs,"LI",{});var JF=r(ic);ba=n(JF,"A",{href:!0,rel:!0});var VF=r(ba);g1=i(VF,"Just-In-Time (JIT) compilation"),VF.forEach(t),JF.forEach(t),_1=d(Vs),lc=n(Vs,"LI",{});var KF=r(lc);ka=n(KF,"A",{href:!0,rel:!0});var GF=r(ka);v1=i(GF,"Automatic Differentiation"),GF.forEach(t),KF.forEach(t),T1=d(Vs),dc=n(Vs,"LI",{});var XF=r(dc);wa=n(XF,"A",{href:!0,rel:!0});var YF=r(wa);b1=i(YF,"Vectorization"),YF.forEach(t),XF.forEach(t),k1=d(Vs),cc=n(Vs,"LI",{});var ZF=r(cc);$a=n(ZF,"A",{href:!0,rel:!0});var e2=r($a);w1=i(e2,"Parallelization"),e2.forEach(t),ZF.forEach(t),Vs.forEach(t),$1=d(ut),at=n(ut,"DIV",{class:!0});var oo=r(at);k(Da.$$.fragment,oo),D1=d(oo),Wo=n(oo,"P",{});var hl=r(Wo);F1=i(hl,"The "),pc=n(hl,"CODE",{});var t2=r(pc);y1=i(t2,"FlaxDistilBertPreTrainedModel"),t2.forEach(t),B1=i(hl,"forward method, overrides the "),hc=n(hl,"CODE",{});var o2=r(hc);M1=i(o2,"__call__"),o2.forEach(t),E1=i(hl," special method."),hl.forEach(t),x1=d(oo),k(As.$$.fragment,oo),z1=d(oo),uc=n(oo,"P",{});var s2=r(uc);C1=i(s2,"Example:"),s2.forEach(t),j1=d(oo),k(Fa.$$.fragment,oo),oo.forEach(t),ut.forEach(t),Gp=d(o),Ro=n(o,"H2",{class:!0});var su=r(Ro);Is=n(su,"A",{id:!0,class:!0,href:!0});var n2=r(Is);fc=n(n2,"SPAN",{});var r2=r(fc);k(ya.$$.fragment,r2),r2.forEach(t),n2.forEach(t),P1=d(su),mc=n(su,"SPAN",{});var a2=r(mc);q1=i(a2,"FlaxDistilBertForMultipleChoice"),a2.forEach(t),su.forEach(t),Xp=d(o),xe=n(o,"DIV",{class:!0});var ft=r(xe);k(Ba.$$.fragment,ft),A1=d(ft),gc=n(ft,"P",{});var i2=r(gc);I1=i(i2,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
