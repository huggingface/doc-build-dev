...
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16551/en/model_doc/t5#transformers.T5Config"
...
model.parallelize(device_map)`}}),Fs=new M({props:{name:"deparallelize",anchor:"transformers.T5Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16551/src/transformers/models/t5/modeling_t5.py#L1311"}}),Ms=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
model.parallelize(device_map)`}}),Bs=new M({props:{name:"deparallelize",anchor:"transformers.T5ForConditionalGeneration.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16551/src/transformers/models/t5/modeling_t5.py#L1506"}}),Rs=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16551/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16551/src/transformers/models/t5/modeling_t5.py#L1808",parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16551/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16551/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_16551/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_16551/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
model.parallelize(device_map)`}}),oa=new M({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16551/src/transformers/models/t5/modeling_t5.py#L1782"}}),sa=new R({props:{code:`# On a 4 GPU machine with t5-3b:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
Whether or not to return a <a href="/docs/transformers/pr_16551/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16551/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new $t({props:{$$slots:{default:[ww]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_input_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"encoder_outputs",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16551/src/transformers/models/t5/modeling_tf_t5.py#L1311",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16551/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_16551/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16551/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_16551/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new $t({props:{$$slots:{default:[$w]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16551/src/transformers/models/t5/modeling_tf_t5.py#L1617",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16551/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_16551/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_16551/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16551/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_16551/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_16551/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],returnDescription:`
<p>A <a
  href="/docs/transformers/pr_16551/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
directory.`),Hc.forEach(t),Lt.forEach(t),Qh=l(Rc),ge=s(Rc,"LI",{});var nt=a(ge);Oi=s(nt,"P",{});var e1=a(Oi);eu=i(e1,"Supervised training"),e1.forEach(t),tu=l(nt),Li=s(nt,"P",{});var t1=a(Li);nu=i(t1,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),t1.forEach(t),ou=l(nt),_(Fo.$$.fragment,nt),su=l(nt),re=s(nt,"P",{});var we=a(re);au=i(we,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ai=s(we,"CODE",{});var n1=a(Ai);ru=i(n1,"input_ids"),n1.forEach(t),iu=i(we,` (which are the
`),Ii=s(we,"CODE",{});var o1=a(Ii);du=i(o1,"input_ids"),o1.forEach(t),lu=i(we," of the encoded input sequence) and "),Di=s(we,"CODE",{});var s1=a(Di);cu=i(s1,"labels"),s1.forEach(t),pu=i(we," (which are the "),Si=s(we,"CODE",{});var a1=a(Si);hu=i(a1,"input_ids"),a1.forEach(t),uu=i(we,` of the encoded
target sequence). The model will automatically create the `),Gi=s(we,"CODE",{});var r1=a(Gi);mu=i(r1,"decoder_input_ids"),r1.forEach(t),fu=i(we," based on the "),Ui=s(we,"CODE",{});var i1=a(Ui);_u=i(i1,"labels"),i1.forEach(t),gu=i(we,`, by
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Bi=s(Gr,"CODE",{});var l1=a(Bi);yu=i(l1,"max_source_length"),l1.forEach(t),wu=i(Gr," and "),Ri=s(Gr,"CODE",{});var c1=a(Ri);xu=i(c1,"max_target_length"),c1.forEach(t),$u=i(Gr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Gr.forEach(t),zu=l(nt),Te=s(nt,"P",{});var ot=a(Te);qu=i(ot,"In addition, we must make sure that padding token id\u2019s of the "),Hi=s(ot,"CODE",{});var p1=a(Hi);Eu=i(p1,"labels"),p1.forEach(t),ju=i(ot,` are not taken into account by the loss
...
of the `),Ki=s(ot,"CODE",{});var u1=a(Ki);Cu=i(u1,"CrossEntropyLoss"),u1.forEach(t),Pu=i(ot,". In Flax, one can use the "),Yi=s(ot,"CODE",{});var m1=a(Yi);Nu=i(m1,"decoder_attention_mask"),m1.forEach(t),Ou=i(ot,` to ignore padded tokens from
the loss (see the `),Mo=s(ot,"A",{href:!0,rel:!0});var f1=a(Mo);Lu=i(f1,"Flax summarization script"),f1.forEach(t),Au=i(ot,` for details). We also pass
`),Zi=s(ot,"CODE",{});var _1=a(Zi);Iu=i(_1,"attention_mask"),_1.forEach(t),Du=i(ot,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),ot.forEach(t),Su=l(nt),_(Co.$$.fragment,nt),nt.forEach(t),Rc.forEach(t),sc=l(n),ir=s(n,"P",{});var g1=a(ir);Gu=i(g1,"Additional training tips:"),g1.forEach(t),ac=l(n),Et=s(n,"UL",{});var Ur=a(Et);Ji=s(Ur,"LI",{});var T1=a(Ji);Po=s(T1,"P",{});var Vc=a(Po);Uu=i(Vc,"T5 models need a slightly higher learning rate than the default one set in the "),Xi=s(Vc,"CODE",{});var v1=a(Xi);Wu=i(v1,"Trainer"),v1.forEach(t),Bu=i(Vc,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Vc.forEach(t),T1.forEach(t),Ru=l(Ur),Qi=s(Ur,"LI",{});var k1=a(Qi);Xt=s(k1,"P",{});var Wr=a(Xt);Hu=i(Wr,"According to "),No=s(Wr,"A",{href:!0,rel:!0});var b1=a(No);Vu=i(b1,"this forum post"),b1.forEach(t),Ku=i(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
pre-training mixture (see Appendix D of the `),Oo=s(Wr,"A",{href:!0,rel:!0});var y1=a(Oo);Yu=i(y1,"paper"),y1.forEach(t),Zu=i(Wr,` for the task prefixes
used).`),Wr.forEach(t),k1.forEach(t),Ju=l(Ur),ed=s(Ur,"LI",{});var w1=a(ed);Lo=s(w1,"P",{});var Kc=a(Lo);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),Kc.forEach(t),w1.forEach(t),Ur.forEach(t),rc=l(n),dr=s(n,"A",{id:!0}),a(dr).forEach(t),ic=l(n),Qt=s(n,"H2",{class:!0});var Yc=a(Qt);Cn=s(Yc,"A",{id:!0,class:!0,href:!0});var $1=a(Cn);nd=s($1,"SPAN",{});var z1=a(nd);_(Ao.$$.fragment,z1),z1.forEach(t),$1.forEach(t),tm=l(Yc),od=s(Yc,"SPAN",{});var q1=a(od);nm=i(q1,"Inference"),q1.forEach(t),Yc.forEach(t),dc=l(n),gt=s(n,"P",{});var co=a(gt);om=i(co,"At inference time, it is recommended to use "),lr=s(co,"A",{href:!0});var E1=a(lr);sm=i(E1,"generate()"),E1.forEach(t),am=i(co,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),Io=s(co,"A",{href:!0,rel:!0});var j1=a(Io);rm=i(j1,"this blog post"),j1.forEach(t),im=i(co,` to know all the details about generating text with Transformers.
There\u2019s also `),Do=s(co,"A",{href:!0,rel:!0});var F1=a(Do);dm=i(F1,"this blog post"),F1.forEach(t),lm=i(co,` which explains how
generation works in general in encoder-decoder models.`),co.forEach(t),lc=l(n),_(So.$$.fragment,n),cc=l(n),We=s(n,"P",{});var At=a(We);cm=i(At,"Note that T5 uses the "),sd=s(At,"CODE",{});var M1=a(sd);pm=i(M1,"pad_token_id"),M1.forEach(t),hm=i(At," as the "),ad=s(At,"CODE",{});var C1=a(ad);um=i(C1,"decoder_start_token_id"),C1.forEach(t),mm=i(At,`, so when doing generation without using
`),cr=s(At,"A",{href:!0});var P1=a(cr);fm=i(P1,"generate()"),P1.forEach(t),_m=i(At,", make sure you start it with the "),rd=s(At,"CODE",{});var N1=a(rd);gm=i(N1,"pad_token_id"),N1.forEach(t),Tm=i(At,"."),At.forEach(t),pc=l(n),pr=s(n,"P",{});var O1=a(pr);vm=i(O1,"The example above only shows a single example. You can also do batched inference, like so:"),O1.forEach(t),hc=l(n),_(Go.$$.fragment,n),uc=l(n),hr=s(n,"A",{id:!0}),a(hr).forEach(t),mc=l(n),en=s(n,"H2",{class:!0});var Zc=a(en);Pn=s(Zc,"A",{id:!0,class:!0,href:!0});var L1=a(Pn);id=s(L1,"SPAN",{});var A1=a(id);_(Uo.$$.fragment,A1),A1.forEach(t),L1.forEach(t),km=l(Zc),dd=s(Zc,"SPAN",{});var I1=a(dd);bm=i(I1,"Performance"),I1.forEach(t),Zc.forEach(t),fc=l(n),Tt=s(n,"P",{});var po=a(Tt);ym=i(po,"If you\u2019d like a faster training and inference performance, install "),Wo=s(po,"A",{href:!0,rel:!0});var D1=a(Wo);wm=i(D1,"apex"),D1.forEach(t),xm=i(po," and then the model will automatically use "),ld=s(po,"CODE",{});var S1=a(ld);$m=i(S1,"apex.normalization.FusedRMSNorm"),S1.forEach(t),zm=i(po," instead of "),cd=s(po,"CODE",{});var G1=a(cd);qm=i(G1,"T5LayerNorm"),G1.forEach(t),Em=i(po,". The former uses an optimized fused kernel which is several times faster than the latter."),po.forEach(t),_c=l(n),tn=s(n,"H2",{class:!0});var Jc=a(tn);Nn=s(Jc,"A",{id:!0,class:!0,href:!0});var U1=a(Nn);pd=s(U1,"SPAN",{});var W1=a(pd);_(Bo.$$.fragment,W1),W1.forEach(t),U1.forEach(t),jm=l(Jc),hd=s(Jc,"SPAN",{});var B1=a(hd);Fm=i(B1,"Example scripts"),B1.forEach(t),Jc.forEach(t),gc=l(n),ur=s(n,"P",{});var R1=a(ur);Mm=i(R1,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),R1.forEach(t),Tc=l(n),On=s(n,"UL",{});var Xc=a(On);ud=s(Xc,"LI",{});var H1=a(ud);nn=s(H1,"P",{});var Br=a(nn);Cm=i(Br,"pre-training: the "),Ro=s(Br,"A",{href:!0,rel:!0});var V1=a(Ro);Pm=i(V1,"run_t5_mlm_flax.py"),V1.forEach(t),Nm=i(Br,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),Ho=s(Br,"A",{href:!0,rel:!0});var K1=a(Ho);Om=i(K1,"t5_tokenizer_model.py"),K1.forEach(t),Lm=i(Br,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Br.forEach(t),H1.forEach(t),Am=l(Xc),md=s(Xc,"LI",{});var Y1=a(md);Ie=s(Y1,"P",{});var yt=a(Ie);Im=i(yt,"fine-tuning: T5 is supported by the official summarization scripts ("),Vo=s(yt,"A",{href:!0,rel:!0});var Z1=a(Vo);Dm=i(Z1,"PyTorch"),Z1.forEach(t),Sm=i(yt,", "),Ko=s(yt,"A",{href:!0,rel:!0});var J1=a(Ko);Gm=i(J1,"Tensorflow"),J1.forEach(t),Um=i(yt,", and "),Yo=s(yt,"A",{href:!0,rel:!0});var X1=a(Yo);Wm=i(X1,"Flax"),X1.forEach(t),Bm=i(yt,`) and translation scripts
(`),Zo=s(yt,"A",{href:!0,rel:!0});var Q1=a(Zo);Rm=i(Q1,"PyTorch"),Q1.forEach(t),Hm=i(yt," and "),Jo=s(yt,"A",{href:!0,rel:!0});var eb=a(Jo);Vm=i(eb,"Tensorflow"),eb.forEach(t),Km=i(yt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),yt.forEach(t),Y1.forEach(t),Xc.forEach(t),vc=l(n),on=s(n,"H2",{class:!0});var Qc=a(on);Ln=s(Qc,"A",{id:!0,class:!0,href:!0});var tb=a(Ln);fd=s(tb,"SPAN",{});var nb=a(fd);_(Xo.$$.fragment,nb),nb.forEach(t),tb.forEach(t),Ym=l(Qc),_d=s(Qc,"SPAN",{});var ob=a(_d);Zm=i(ob,"T5Config"),ob.forEach(t),Qc.forEach(t),kc=l(n),wt=s(n,"DIV",{class:!0});var Rr=a(wt);_(Qo.$$.fragment,Rr),Jm=l(Rr),xt=s(Rr,"P",{});var ho=a(xt);Xm=i(ho,"This is the configuration class to store the configuration of a "),mr=s(ho,"A",{href:!0});var sb=a(mr);Qm=i(sb,"T5Model"),sb.forEach(t),ef=i(ho," or a "),fr=s(ho,"A",{href:!0});var ab=a(fr);tf=i(ab,"TFT5Model"),ab.forEach(t),nf=i(ho,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
...
adding special tokens. A sequence has the following format:`),mb.forEach(t),$f=l(Vr),is=s(Vr,"UL",{});var op=a(is);vr=s(op,"LI",{});var Kv=a(vr);zf=i(Kv,"single sequence: "),kd=s(Kv,"CODE",{});var fb=a(kd);qf=i(fb,"X </s>"),fb.forEach(t),Kv.forEach(t),Ef=l(op),kr=s(op,"LI",{});var Yv=a(kr);jf=i(Yv,"pair of sequences: "),bd=s(Yv,"CODE",{});var _b=a(bd);Ff=i(_b,"A </s> B </s>"),_b.forEach(t),Yv.forEach(t),op.forEach(t),Vr.forEach(t),Mf=l(st),In=s(st,"DIV",{class:!0});var sp=a(In);_(ds.$$.fragment,sp),Cf=l(sp),ls=s(sp,"P",{});var ap=a(ls);Pf=i(ap,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),yd=s(ap,"CODE",{});var gb=a(yd);Nf=i(gb,"prepare_for_model"),gb.forEach(t),Of=i(ap," method."),ap.forEach(t),sp.forEach(t),Lf=l(st),Dn=s(st,"DIV",{class:!0});var rp=a(Dn);_(cs.$$.fragment,rp),Af=l(rp),wd=s(rp,"P",{});var Tb=a(wd);If=i(Tb,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Tb.forEach(t),rp.forEach(t),Df=l(st),br=s(st,"DIV",{class:!0});var vb=a(br);_(ps.$$.fragment,vb),vb.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);Sn=s(ip,"A",{id:!0,class:!0,href:!0});var kb=a(Sn);xd=s(kb,"SPAN",{});var bb=a(xd);_(hs.$$.fragment,bb),bb.forEach(t),kb.forEach(t),Sf=l(ip),$d=s(ip,"SPAN",{});var yb=a($d);Gf=i(yb,"T5TokenizerFast"),yb.forEach(t),ip.forEach(t),xc=l(n),De=s(n,"DIV",{class:!0});var It=a(De);_(us.$$.fragment,It),Uf=l(It),dn=s(It,"P",{});var Kr=a(dn);Wf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),zd=s(Kr,"EM",{});var wb=a(zd);Bf=i(wb,"tokenizers"),wb.forEach(t),Rf=i(Kr,` library). Based on
`),ms=s(Kr,"A",{href:!0,rel:!0});var xb=a(ms);Hf=i(xb,"Unigram"),xb.forEach(t),Vf=i(Kr,"."),Kr.forEach(t),Kf=l(It),fs=s(It,"P",{});var dp=a(fs);Yf=i(dp,"This tokenizer inherits from "),yr=s(dp,"A",{href:!0});var $b=a(yr);Zf=i($b,"PreTrainedTokenizerFast"),$b.forEach(t),Jf=i(dp,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),dp.forEach(t),Xf=l(It),Ft=s(It,"DIV",{class:!0});var Yr=a(Ft);_(_s.$$.fragment,Yr),Qf=l(Yr),qd=s(Yr,"P",{});var zb=a(qd);e_=i(zb,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),zb.forEach(t),t_=l(Yr),gs=s(Yr,"UL",{});var lp=a(gs);wr=s(lp,"LI",{});var Zv=a(wr);n_=i(Zv,"single sequence: "),Ed=s(Zv,"CODE",{});var qb=a(Ed);o_=i(qb,"X </s>"),qb.forEach(t),Zv.forEach(t),s_=l(lp),xr=s(lp,"LI",{});var Jv=a(xr);a_=i(Jv,"pair of sequences: "),jd=s(Jv,"CODE",{});var Eb=a(jd);r_=i(Eb,"A </s> B </s>"),Eb.forEach(t),Jv.forEach(t),lp.forEach(t),Yr.forEach(t),i_=l(It),Gn=s(It,"DIV",{class:!0});var cp=a(Gn);_(Ts.$$.fragment,cp),d_=l(cp),Fd=s(cp,"P",{});var jb=a(Fd);l_=i(jb,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),jb.forEach(t),cp.forEach(t),It.forEach(t),$c=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Un=s(pp,"A",{id:!0,class:!0,href:!0});var Fb=a(Un);Md=s(Fb,"SPAN",{});var Mb=a(Md);_(vs.$$.fragment,Mb),Mb.forEach(t),Fb.forEach(t),c_=l(pp),Cd=s(pp,"SPAN",{});var Cb=a(Cd);p_=i(Cb,"T5Model"),Cb.forEach(t),pp.forEach(t),zc=l(n),J=s(n,"DIV",{class:!0});var xe=a(J);_(ks.$$.fragment,xe),h_=l(xe),Pd=s(xe,"P",{});var Pb=a(Pd);u_=i(Pb,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Pb.forEach(t),m_=l(xe),bs=s(xe,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var Nb=a(ys);__=i(Nb,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Nb.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l(xe),ws=s(xe,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),$r=s(up,"A",{href:!0});var Ob=a($r);k_=i(Ob,"PreTrainedModel"),Ob.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),y_=l(xe),xs=s(xe,"P",{});var mp=a(xs);w_=i(mp,"This model is also a PyTorch "),$s=s(mp,"A",{href:!0,rel:!0});var Lb=a($s);x_=i(Lb,"torch.nn.Module"),Lb.forEach(t),$_=i(mp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mp.forEach(t),z_=l(xe),Be=s(xe,"DIV",{class:!0});var Dt=a(Be);_(zs.$$.fragment,Dt),q_=l(Dt),cn=s(Dt,"P",{});var Zr=a(cn);E_=i(Zr,"The "),zr=s(Zr,"A",{href:!0});var Ab=a(zr);j_=i(Ab,"T5Model"),Ab.forEach(t),F_=i(Zr," forward method, overrides the "),Nd=s(Zr,"CODE",{});var Ib=a(Nd);M_=i(Ib,"__call__"),Ib.forEach(t),C_=i(Zr," special method."),Zr.forEach(t),P_=l(Dt),_(Wn.$$.fragment,Dt),N_=l(Dt),Od=s(Dt,"P",{});var Db=a(Od);O_=i(Db,"Example:"),Db.forEach(t),L_=l(Dt),_(qs.$$.fragment,Dt),Dt.forEach(t),A_=l(xe),Re=s(xe,"DIV",{class:!0});var St=a(Re);_(Es.$$.fragment,St),I_=l(St),Ld=s(St,"P",{});var Sb=a(Ld);D_=i(Sb,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),Sb.forEach(t),S_=l(St),Ad=s(St,"P",{});var Gb=a(Ad);G_=i(Gb,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Gb.forEach(t),U_=l(St),Id=s(St,"P",{});var Ub=a(Id);W_=i(Ub,"Example:"),Ub.forEach(t),B_=l(St),_(js.$$.fragment,St),St.forEach(t),R_=l(xe),vt=s(xe,"DIV",{class:!0});var uo=a(vt);_(Fs.$$.fragment,uo),H_=l(uo),Dd=s(uo,"P",{});var Wb=a(Dd);V_=i(Wb,"Moves the model to cpu from a model parallel state."),Wb.forEach(t),K_=l(uo),Sd=s(uo,"P",{});var Bb=a(Sd);Y_=i(Bb,"Example:"),Bb.forEach(t),Z_=l(uo),_(Ms.$$.fragment,uo),uo.forEach(t),xe.forEach(t),qc=l(n),pn=s(n,"H2",{class:!0});var fp=a(pn);Bn=s(fp,"A",{id:!0,class:!0,href:!0});var Rb=a(Bn);Gd=s(Rb,"SPAN",{});var Hb=a(Gd);_(Cs.$$.fragment,Hb),Hb.forEach(t),Rb.forEach(t),J_=l(fp),Ud=s(fp,"SPAN",{});var Vb=a(Ud);X_=i(Vb,"T5ForConditionalGeneration"),Vb.forEach(t),fp.forEach(t),Ec=l(n),X=s(n,"DIV",{class:!0});var $e=a(X);_(Ps.$$.fragment,$e),Q_=l($e),Ns=s($e,"P",{});var _p=a(Ns);eg=i(_p,"T5 Model with a "),Wd=s(_p,"CODE",{});var Kb=a(Wd);tg=i(Kb,"language modeling"),Kb.forEach(t),ng=i(_p," head on top."),_p.forEach(t),og=l($e),Os=s($e,"P",{});var gp=a(Os);sg=i(gp,"The T5 model was proposed in "),Ls=s(gp,"A",{href:!0,rel:!0});var Yb=a(Ls);ag=i(Yb,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),Yb.forEach(t),rg=i(gp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),gp.forEach(t),ig=l($e),As=s($e,"P",{});var Tp=a(As);dg=i(Tp,"This model inherits from "),qr=s(Tp,"A",{href:!0});var Zb=a(qr);lg=i(Zb,"PreTrainedModel"),Zb.forEach(t),cg=i(Tp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l($e),Is=s($e,"P",{});var vp=a(Is);hg=i(vp,"This model is also a PyTorch "),Ds=s(vp,"A",{href:!0,rel:!0});var Jb=a(Ds);ug=i(Jb,"torch.nn.Module"),Jb.forEach(t),mg=i(vp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vp.forEach(t),fg=l($e),He=s($e,"DIV",{class:!0});var Gt=a(He);_(Ss.$$.fragment,Gt),_g=l(Gt),hn=s(Gt,"P",{});var Jr=a(hn);gg=i(Jr,"The "),Er=s(Jr,"A",{href:!0});var Xb=a(Er);Tg=i(Xb,"T5ForConditionalGeneration"),Xb.forEach(t),vg=i(Jr," forward method, overrides the "),Bd=s(Jr,"CODE",{});var Qb=a(Bd);kg=i(Qb,"__call__"),Qb.forEach(t),bg=i(Jr," special method."),Jr.forEach(t),yg=l(Gt),_(Rn.$$.fragment,Gt),wg=l(Gt),Rd=s(Gt,"P",{});var ey=a(Rd);xg=i(ey,"Examples:"),ey.forEach(t),$g=l(Gt),_(Gs.$$.fragment,Gt),Gt.forEach(t),zg=l($e),Ve=s($e,"DIV",{class:!0});var Ut=a(Ve);_(Us.$$.fragment,Ut),qg=l(Ut),Hd=s(Ut,"P",{});var ty=a(Hd);Eg=i(ty,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),ty.forEach(t),jg=l(Ut),Vd=s(Ut,"P",{});var ny=a(Vd);Fg=i(ny,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),ny.forEach(t),Mg=l(Ut),Kd=s(Ut,"P",{});var oy=a(Kd);Cg=i(oy,"Example:"),oy.forEach(t),Pg=l(Ut),_(Ws.$$.fragment,Ut),Ut.forEach(t),Ng=l($e),kt=s($e,"DIV",{class:!0});var mo=a(kt);_(Bs.$$.fragment,mo),Og=l(mo),Yd=s(mo,"P",{});var sy=a(Yd);Lg=i(sy,"Moves the model to cpu from a model parallel state."),sy.forEach(t),Ag=l(mo),Zd=s(mo,"P",{});var ay=a(Zd);Ig=i(ay,"Example:"),ay.forEach(t),Dg=l(mo),_(Rs.$$.fragment,mo),mo.forEach(t),$e.forEach(t),jc=l(n),un=s(n,"H2",{class:!0});var kp=a(un);Hn=s(kp,"A",{id:!0,class:!0,href:!0});var ry=a(Hn);Jd=s(ry,"SPAN",{});var iy=a(Jd);_(Hs.$$.fragment,iy),iy.forEach(t),ry.forEach(t),Sg=l(kp),Xd=s(kp,"SPAN",{});var dy=a(Xd);Gg=i(dy,"T5EncoderModel"),dy.forEach(t),kp.forEach(t),Fc=l(n),Q=s(n,"DIV",{class:!0});var ze=a(Q);_(Vs.$$.fragment,ze),Ug=l(ze),Qd=s(ze,"P",{});var ly=a(Qd);Wg=i(ly,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),ly.forEach(t),Bg=l(ze),Ks=s(ze,"P",{});var bp=a(Ks);Rg=i(bp,"The T5 model was proposed in "),Ys=s(bp,"A",{href:!0,rel:!0});var cy=a(Ys);Hg=i(cy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
