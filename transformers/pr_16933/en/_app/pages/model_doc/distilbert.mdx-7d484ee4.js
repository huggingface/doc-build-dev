...
elements depending on the configuration (<a
  href="/docs/transformers/pr_16933/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_tf_distilbert.py#L527",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_tf_distilbert.py#L629",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_tf_distilbert.py#L716",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_tf_distilbert.py#L888",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_tf_distilbert.py#L797",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/pr_16933/src/transformers/models/distilbert/modeling_tf_distilbert.py#L998",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Yk=d(ht),nc=n(ht,"P",{});var H$=r(nc);Zk=i(H$,"Finally, this model supports inherent JAX features such as:"),H$.forEach(t),eT=d(ht),Pt=n(ht,"UL",{});var Vo=r(Pt);rc=n(Vo,"LI",{});var V$=r(rc);ba=n(V$,"A",{href:!0,rel:!0});var K$=r(ba);tT=i(K$,"Just-In-Time (JIT) compilation"),K$.forEach(t),V$.forEach(t),sT=d(Vo),ac=n(Vo,"LI",{});var J$=r(ac);va=n(J$,"A",{href:!0,rel:!0});var G$=r(va);oT=i(G$,"Automatic Differentiation"),G$.forEach(t),J$.forEach(t),nT=d(Vo),ic=n(Vo,"LI",{});var X$=r(ic);ka=n(X$,"A",{href:!0,rel:!0});var Y$=r(ka);rT=i(Y$,"Vectorization"),Y$.forEach(t),X$.forEach(t),aT=d(Vo),lc=n(Vo,"LI",{});var Z$=r(lc);Ta=n(Z$,"A",{href:!0,rel:!0});var e3=r(Ta);iT=i(e3,"Parallelization"),e3.forEach(t),Z$.forEach(t),Vo.forEach(t),lT=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);k(wa.$$.fragment,ts),dT=d(ts),Ls=n(ts,"P",{});var kl=r(Ls);cT=i(kl,"The "),dc=n(kl,"CODE",{});var t3=r(dc);pT=i(t3,"FlaxDistilBertPreTrainedModel"),t3.forEach(t),hT=i(kl," forward method, overrides the "),cc=n(kl,"CODE",{});var s3=r(cc);uT=i(s3,"__call__"),s3.forEach(t),mT=i(kl," special method."),kl.forEach(t),fT=d(ts),k(qo.$$.fragment,ts),gT=d(ts),pc=n(ts,"P",{});var o3=r(pc);_T=i(o3,"Example:"),o3.forEach(t),bT=d(ts),k(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ss=n(s,"H2",{class:!0});var du=r(Ss);Po=n(du,"A",{id:!0,class:!0,href:!0});var n3=r(Po);hc=n(n3,"SPAN",{});var r3=r(hc);k($a.$$.fragment,r3),r3.forEach(t),n3.forEach(t),vT=d(du),uc=n(du,"SPAN",{});var a3=r(uc);kT=i(a3,"FlaxDistilBertForSequenceClassification"),a3.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);k(Fa.$$.fragment,ut),TT=d(ut),mc=n(ut,"P",{});var i3=r(mc);wT=i(i3,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),i3.forEach(t),yT=d(ut),Da=n(ut,"P",{});var cu=r(Da);$T=i(cu,"This model inherits from "),el=n(cu,"A",{href:!0});var l3=r(el);FT=i(l3,"FlaxPreTrainedModel"),l3.forEach(t),DT=i(cu,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),zT=d(ut),fc=n(ut,"P",{});var c3=r(fc);jT=i(c3,"Finally, this model supports inherent JAX features such as:"),c3.forEach(t),CT=d(ut),At=n(ut,"UL",{});var Ko=r(At);gc=n(Ko,"LI",{});var p3=r(gc);Ea=n(p3,"A",{href:!0,rel:!0});var h3=r(Ea);qT=i(h3,"Just-In-Time (JIT) compilation"),h3.forEach(t),p3.forEach(t),PT=d(Ko),_c=n(Ko,"LI",{});var u3=r(_c);xa=n(u3,"A",{href:!0,rel:!0});var m3=r(xa);AT=i(m3,"Automatic Differentiation"),m3.forEach(t),u3.forEach(t),OT=d(Ko),bc=n(Ko,"LI",{});var f3=r(bc);za=n(f3,"A",{href:!0,rel:!0});var g3=r(za);NT=i(g3,"Vectorization"),g3.forEach(t),f3.forEach(t),LT=d(Ko),vc=n(Ko,"LI",{});var _3=r(vc);ja=n(_3,"A",{href:!0,rel:!0});var b3=r(ja);ST=i(b3,"Parallelization"),b3.forEach(t),_3.forEach(t),Ko.forEach(t),IT=d(ut),it=n(ut,"DIV",{class:!0});var ss=r(it);k(Ca.$$.fragment,ss),WT=d(ss),Is=n(ss,"P",{});var Tl=r(Is);RT=i(Tl,"The "),kc=n(Tl,"CODE",{});var v3=r(kc);UT=i(v3,"FlaxDistilBertPreTrainedModel"),v3.forEach(t),QT=i(Tl," forward method, overrides the "),Tc=n(Tl,"CODE",{});var k3=r(Tc);HT=i(k3,"__call__"),k3.forEach(t),VT=i(Tl," special method."),Tl.forEach(t),KT=d(ss),k(Ao.$$.fragment,ss),JT=d(ss),wc=n(ss,"P",{});var T3=r(wc);GT=i(T3,"Example:"),T3.forEach(t),XT=d(ss),k(qa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),rh=d(s),Ws=n(s,"H2",{class:!0});var hu=r(Ws);Oo=n(hu,"A",{id:!0,class:!0,href:!0});var w3=r(Oo);yc=n(w3,"SPAN",{});var y3=r(yc);k(Pa.$$.fragment,y3),y3.forEach(t),w3.forEach(t),YT=d(hu),$c=n(hu,"SPAN",{});var $3=r($c);ZT=i($3,"FlaxDistilBertForMultipleChoice"),$3.forEach(t),hu.forEach(t),ah=d(s),ze=n(s,"DIV",{class:!0});var mt=r(ze);k(Aa.$$.fragment,mt),ew=d(mt),Fc=n(mt,"P",{});var F3=r(Fc);tw=i(F3,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),F3.forEach(t),sw=d(mt),Oa=n(mt,"P",{});var uu=r(Oa);ow=i(uu,"This model inherits from "),tl=n(uu,"A",{href:!0});var D3=r(tl);nw=i(D3,"FlaxPreTrainedModel"),D3.forEach(t),rw=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),uu.forEach(t),aw=d(mt),Na=n(mt,"P",{});var mu=r(Na);iw=i(mu,"This model is also a Flax Linen "),La=n(mu,"A",{href:!0,rel:!0});var B3=r(La);lw=i(B3,"flax.linen.Module"),B3.forEach(t),dw=i(mu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),mu.forEach(t),cw=d(mt),Dc=n(mt,"P",{});var M3=r(Dc);pw=i(M3,"Finally, this model supports inherent JAX features such as:"),M3.forEach(t),hw=d(mt),Ot=n(mt,"UL",{});var Jo=r(Ot);Bc=n(Jo,"LI",{});var E3=r(Bc);Sa=n(E3,"A",{href:!0,rel:!0});var x3=r(Sa);uw=i(x3,"Just-In-Time (JIT) compilation"),x3.forEach(t),E3.forEach(t),mw=d(Jo),Mc=n(Jo,"LI",{});var z3=r(Mc);Ia=n(z3,"A",{href:!0,rel:!0});var j3=r(Ia);fw=i(j3,"Automatic Differentiation"),j3.forEach(t),z3.forEach(t),gw=d(Jo),Ec=n(Jo,"LI",{});var C3=r(Ec);Wa=n(C3,"A",{href:!0,rel:!0});var q3=r(Wa);_w=i(q3,"Vectorization"),q3.forEach(t),C3.forEach(t),bw=d(Jo),xc=n(Jo,"LI",{});var P3=r(xc);Ra=n(P3,"A",{href:!0,rel:!0});var A3=r(Ra);vw=i(A3,"Parallelization"),A3.forEach(t),P3.forEach(t),Jo.forEach(t),kw=d(mt),lt=n(mt,"DIV",{class:!0});var os=r(lt);k(Ua.$$.fragment,os),Tw=d(os),Rs=n(os,"P",{});var wl=r(Rs);ww=i(wl,"The "),zc=n(wl,"CODE",{});var O3=r(zc);yw=i(O3,"FlaxDistilBertPreTrainedModel"),O3.forEach(t),$w=i(wl," forward method, overrides the "),jc=n(wl,"CODE",{});var N3=r(jc);Fw=i(N3,"__call__"),N3.forEach(t),Dw=i(wl," special method."),wl.forEach(t),Bw=d(os),k(No.$$.fragment,os),Mw=d(os),Cc=n(os,"P",{});var L3=r(Cc);Ew=i(L3,"Example:"),L3.forEach(t),xw=d(os),k(Qa.$$.fragment,os),os.forEach(t),mt.forEach(t),ih=d(s),Us=n(s,"H2",{class:!0});var fu=r(Us);Lo=n(fu,"A",{id:!0,class:!0,href:!0});var S3=r(Lo);qc=n(S3,"SPAN",{});var I3=r(qc);k(Ha.$$.fragment,I3),I3.forEach(t),S3.forEach(t),zw=d(fu),Pc=n(fu,"SPAN",{});var W3=r(Pc);jw=i(W3,"FlaxDistilBertForTokenClassification"),W3.forEach(t),fu.forEach(t),lh=d(s),je=n(s,"DIV",{class:!0});var ft=r(je);k(Va.$$.fragment,ft),Cw=d(ft),Ac=n(ft,"P",{});var R3=r(Ac);qw=i(R3,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R3.forEach(t),Pw=d(ft),Ka=n(ft,"P",{});var gu=r(Ka);Aw=i(gu,"This model inherits from "),sl=n(gu,"A",{href:!0});var U3=r(sl);Ow=i(U3,"FlaxPreTrainedModel"),U3.forEach(t),Nw=i(gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),gu.forEach(t),Lw=d(ft),Ja=n(ft,"P",{});var _u=r(Ja);Sw=i(_u,"This model is also a Flax Linen "),Ga=n(_u,"A",{href:!0,rel:!0});var Q3=r(Ga);Iw=i(Q3,"flax.linen.Module"),Q3.forEach(t),Ww=i(_u,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_u.forEach(t),Rw=d(ft),Oc=n(ft,"P",{});var H3=r(Oc);Uw=i(H3,"Finally, this model supports inherent JAX features such as:"),H3.forEach(t),Qw=d(ft),Nt=n(ft,"UL",{});var Go=r(Nt);Nc=n(Go,"LI",{});var V3=r(Nc);Xa=n(V3,"A",{href:!0,rel:!0});var K3=r(Xa);Hw=i(K3,"Just-In-Time (JIT) compilation"),K3.forEach(t),V3.forEach(t),Vw=d(Go),Lc=n(Go,"LI",{});var J3=r(Lc);Ya=n(J3,"A",{href:!0,rel:!0});var G3=r(Ya);Kw=i(G3,"Automatic Differentiation"),G3.forEach(t),J3.forEach(t),Jw=d(Go),Sc=n(Go,"LI",{});var X3=r(Sc);Za=n(X3,"A",{href:!0,rel:!0});var Y3=r(Za);Gw=i(Y3,"Vectorization"),Y3.forEach(t),X3.forEach(t),Xw=d(Go),Ic=n(Go,"LI",{});var Z3=r(Ic);ei=n(Z3,"A",{href:!0,rel:!0});var eF=r(ei);Yw=i(eF,"Parallelization"),eF.forEach(t),Z3.forEach(t),Go.forEach(t),Zw=d(ft),dt=n(ft,"DIV",{class:!0});var ns=r(dt);k(ti.$$.fragment,ns),e1=d(ns),Qs=n(ns,"P",{});var yl=r(Qs);t1=i(yl,"The "),Wc=n(yl,"CODE",{});var tF=r(Wc);s1=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),o1=i(yl," forward method, overrides the "),Rc=n(yl,"CODE",{});var sF=r(Rc);n1=i(sF,"__call__"),sF.forEach(t),r1=i(yl," special method."),yl.forEach(t),a1=d(ns),k(So.$$.fragment,ns),i1=d(ns),Uc=n(ns,"P",{});var oF=r(Uc);l1=i(oF,"Example:"),oF.forEach(t),d1=d(ns),k(si.$$.fragment,ns),ns.forEach(t),ft.forEach(t),dh=d(s),Hs=n(s,"H2",{class:!0});var bu=r(Hs);Io=n(bu,"A",{id:!0,class:!0,href:!0});var nF=r(Io);Qc=n(nF,"SPAN",{});var rF=r(Qc);k(oi.$$.fragment,rF),rF.forEach(t),nF.forEach(t),c1=d(bu),Hc=n(bu,"SPAN",{});var aF=r(Hc);p1=i(aF,"FlaxDistilBertForQuestionAnswering"),aF.forEach(t),bu.forEach(t),ch=d(s),Ce=n(s,"DIV",{class:!0});var gt=r(Ce);k(ni.$$.fragment,gt),h1=d(gt),Vs=n(gt,"P",{});var $l=r(Vs);u1=i($l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
