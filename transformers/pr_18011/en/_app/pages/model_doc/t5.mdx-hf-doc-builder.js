...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_18011/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18011/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18011/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/modeling_tf_t5.py#L1136",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/modeling_tf_t5.py#L1312",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18011/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18011/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18011/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/modeling_tf_t5.py#L1559",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18011/src/transformers/models/t5/modeling_flax_t5.py#L956",returnDescription:`
<p>A <a
...
for summarization: `),R=r(un,"EM",{});var Dd=i(R);Oe=s(Dd,"summarize: \u2026"),Dd.forEach(t),z=s(un,"."),un.forEach(t),Ad.forEach(t),F=c(hn),te=r(hn,"LI",{});var Sd=i(te);Ge=r(Sd,"P",{});var Gd=i(Ge);et=s(Gd,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),Gd.forEach(t),Sd.forEach(t),D=c(hn),Ue=r(hn,"LI",{});var Ud=i(Ue);ne=r(Ud,"P",{});var wt=i(ne);tt=s(wt,"See the "),L=r(wt,"A",{href:!0});var Bd=i(L);Y=s(Bd,"training"),Bd.forEach(t),nt=s(wt,", "),Le=r(wt,"A",{href:!0});var Wd=i(Le);Z=s(Wd,"inference"),Wd.forEach(t),ot=s(wt," and "),Ae=r(wt,"A",{href:!0});var Rd=i(Ae);Ie=s(Rd,"scripts"),Rd.forEach(t),st=s(wt," sections below for all details regarding usage."),wt.forEach(t),Ud.forEach(t),hn.forEach(t),Xd=c(n),or=r(n,"P",{});var Hd=i(or);hh=s(Hd,"T5 comes in different sizes:"),Hd.forEach(t),Qd=c(n),Be=r(n,"UL",{});var Qe=i(Be);Ti=r(Qe,"LI",{});var Vd=i(Ti);bi=r(Vd,"P",{});var Kd=i(bi);Do=r(Kd,"A",{href:!0,rel:!0});var Gb=i(Do);uh=s(Gb,"t5-small"),Gb.forEach(t),Kd.forEach(t),Vd.forEach(t),mh=c(Qe),ki=r(Qe,"LI",{});var Ub=i(ki);vi=r(Ub,"P",{});var Bb=i(vi);So=r(Bb,"A",{href:!0,rel:!0});var Wb=i(So);fh=s(Wb,"t5-base"),Wb.forEach(t),Bb.forEach(t),Ub.forEach(t),_h=c(Qe),yi=r(Qe,"LI",{});var Rb=i(yi);wi=r(Rb,"P",{});var Hb=i(wi);Go=r(Hb,"A",{href:!0,rel:!0});var Vb=i(Go);gh=s(Vb,"t5-large"),Vb.forEach(t),Hb.forEach(t),Rb.forEach(t),Th=c(Qe),$i=r(Qe,"LI",{});var Kb=i($i);xi=r(Kb,"P",{});var Yb=i(xi);Uo=r(Yb,"A",{href:!0,rel:!0});var Zb=i(Uo);bh=s(Zb,"t5-3b"),Zb.forEach(t),Yb.forEach(t),Kb.forEach(t),kh=c(Qe),zi=r(Qe,"LI",{});var Jb=i(zi);sr=r(Jb,"P",{});var Lb=i(sr);Bo=r(Lb,"A",{href:!0,rel:!0});var Xb=i(Bo);vh=s(Xb,"t5-11b"),Xb.forEach(t),yh=s(Lb,"."),Lb.forEach(t),Jb.forEach(t),Qe.forEach(t),ec=c(n),ar=r(n,"P",{});var Qb=i(ar);wh=s(Qb,"Based on the original T5 model, Google has released some follow-up works:"),Qb.forEach(t),tc=c(n),$t=r(n,"UL",{});var Yr=i($t);ji=r(Yr,"LI",{});var ek=i(ji);mn=r(ek,"P",{});var Yd=i(mn);Ei=r(Yd,"STRONG",{});var tk=i(Ei);$h=s(tk,"T5v1.1"),tk.forEach(t),xh=s(Yd,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),lr=r(Jd,"A",{href:!0});var lk=i(lr);Lh=s(lk,"here"),lk.forEach(t),Ah=s(Jd,"."),Jd.forEach(t),rk.forEach(t),Yr.forEach(t),nc=c(n),gn=r(n,"P",{});var cp=i(gn);Ih=s(cp,"All checkpoints can be found on the "),Wo=r(cp,"A",{href:!0,rel:!0});var dk=i(Wo);Dh=s(dk,"hub"),dk.forEach(t),Sh=s(cp,"."),cp.forEach(t),oc=c(n),xt=r(n,"P",{});var Zr=i(xt);Gh=s(Zr,"This model was contributed by "),Ro=r(Zr,"A",{href:!0,rel:!0});var ck=i(Ro);Uh=s(ck,"thomwolf"),ck.forEach(t),Bh=s(Zr,". The original code can be found "),Ho=r(Zr,"A",{href:!0,rel:!0});var pk=i(Ho);Wh=s(pk,"here"),pk.forEach(t),Rh=s(Zr,"."),Zr.forEach(t),sc=c(n),dr=r(n,"A",{id:!0}),i(dr).forEach(t),ac=c(n),Lt=r(n,"H2",{class:!0});var pp=i(Lt);Tn=r(pp,"A",{id:!0,class:!0,href:!0});var hk=i(Tn);Pi=r(hk,"SPAN",{});var uk=i(Pi);v(Vo.$$.fragment,uk),uk.forEach(t),hk.forEach(t),Hh=c(pp),Ni=r(pp,"SPAN",{});var mk=i(Ni);Vh=s(mk,"Training"),mk.forEach(t),pp.forEach(t),rc=c(n),at=r(n,"P",{});var yo=i(at);Kh=s(yo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),hp.forEach(t),lc=c(n),pr=r(n,"UL",{});var bk=i(pr);Ii=r(bk,"LI",{});var kk=i(Ii);su=s(kk,"Unsupervised denoising training"),kk.forEach(t),bk.forEach(t),dc=c(n),me=r(n,"P",{});var Re=i(me);au=s(Re,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),Di=r(Re,"EM",{});var vk=i(Di);ru=s(vk,"a.k.a"),vk.forEach(t),iu=s(Re,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),Si=r(Re,"EM",{});var yk=i(Si);lu=s(yk,"real"),yk.forEach(t),du=s(Re,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Gi=r(Re,"CODE",{});var wk=i(Gi);cu=s(wk,"<extra_id_0>"),wk.forEach(t),pu=s(Re,`,
`),Ui=r(Re,"CODE",{});var $k=i(Ui);hu=s($k,"<extra_id_1>"),$k.forEach(t),uu=s(Re,", \u2026 up to "),Bi=r(Re,"CODE",{});var xk=i(Bi);mu=s(xk,"<extra_id_99>"),xk.forEach(t),fu=s(Re,`. As a default, 100 sentinel tokens are available in
`),hr=r(Re,"A",{href:!0});var zk=i(hr);_u=s(zk,"T5Tokenizer"),zk.forEach(t),gu=s(Re,"."),Re.forEach(t),cc=c(n),ur=r(n,"P",{});var jk=i(ur);Tu=s(jk,`For instance, the sentence \u201CThe cute dog walks in the park\u201D with the masks put on \u201Ccute dog\u201D and \u201Cthe\u201D should be
...
directory.`),up.forEach(t),uc=c(n),mr=r(n,"UL",{});var qk=i(mr);Wi=r(qk,"LI",{});var Fk=i(Wi);yu=s(Fk,"Supervised training"),Fk.forEach(t),qk.forEach(t),mc=c(n),fr=r(n,"P",{});var Mk=i(fr);wu=s(Mk,`In this setup, the input sequence and output sequence are a standard sequence-to-sequence input-output mapping.
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),Mk.forEach(t),fc=c(n),v(Zo.$$.fragment,n),_c=c(n),oe=r(n,"P",{});var $e=i(oe);$u=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Ri=r($e,"CODE",{});var Ck=i(Ri);xu=s(Ck,"input_ids"),Ck.forEach(t),zu=s($e,` (which are the
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),Xi=r(Jr,"CODE",{});var Dk=i(Xi);Su=s(Dk,"max_source_length"),Dk.forEach(t),Gu=s(Jr," and "),Qi=r(Jr,"CODE",{});var Sk=i(Qi);Uu=s(Sk,"max_target_length"),Sk.forEach(t),Bu=s(Jr,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),Jr.forEach(t),Tc=c(n),fe=r(n,"P",{});var He=i(fe);Wu=s(He,"In addition, we must make sure that padding token id\u2019s of the "),el=r(He,"CODE",{});var Gk=i(el);Ru=s(Gk,"labels"),Gk.forEach(t),Hu=s(He,` are not taken into account by the loss
...
of the `),nl=r(He,"CODE",{});var Bk=i(nl);Yu=s(Bk,"CrossEntropyLoss"),Bk.forEach(t),Zu=s(He,". In Flax, one can use the "),ol=r(He,"CODE",{});var Wk=i(ol);Ju=s(Wk,"decoder_attention_mask"),Wk.forEach(t),Xu=s(He,` to ignore padded tokens from
the loss (see the `),Jo=r(He,"A",{href:!0,rel:!0});var Rk=i(Jo);Qu=s(Rk,"Flax summarization script"),Rk.forEach(t),em=s(He,` for details). We also pass
...
documentation from `),Er=r(ti,"A",{href:!0});var Av=i(Er);xf=s(Av,"PretrainedConfig"),Av.forEach(t),zf=s(ti," for more information."),ti.forEach(t),ei.forEach(t),Gc=c(n),Bt=r(n,"H2",{class:!0});var vp=i(Bt);jn=r(vp,"A",{id:!0,class:!0,href:!0});var Iv=i(jn);yl=r(Iv,"SPAN",{});var Dv=i(yl);v(vs.$$.fragment,Dv),Dv.forEach(t),Iv.forEach(t),jf=c(vp),wl=r(vp,"SPAN",{});var Sv=i(wl);Ef=s(Sv,"T5Tokenizer"),Sv.forEach(t),vp.forEach(t),Uc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);v(ys.$$.fragment,Ve),qf=c(Ve),ws=r(Ve,"P",{});var yp=i(ws);Ff=s(yp,"Construct a T5 tokenizer. Based on "),$s=r(yp,"A",{href:!0,rel:!0});var Gv=i($s);Mf=s(Gv,"SentencePiece"),Gv.forEach(t),Cf=s(yp,"."),yp.forEach(t),Pf=c(Ve),xs=r(Ve,"P",{});var wp=i(xs);Nf=s(wp,"This tokenizer inherits from "),qr=r(wp,"A",{href:!0});var Uv=i(qr);Of=s(Uv,"PreTrainedTokenizer"),Uv.forEach(t),Lf=s(wp,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),wp.forEach(t),Af=c(Ve),Et=r(Ve,"DIV",{class:!0});var ni=i(Et);v(zs.$$.fragment,ni),If=c(ni),$l=r(ni,"P",{});var Bv=i($l);Df=s(Bv,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),Bv.forEach(t),Sf=c(ni),js=r(ni,"UL",{});var $p=i(js);Fr=r($p,"LI",{});var Ab=i(Fr);Gf=s(Ab,"single sequence: "),xl=r(Ab,"CODE",{});var Wv=i(xl);Uf=s(Wv,"X </s>"),Wv.forEach(t),Ab.forEach(t),Bf=c($p),Mr=r($p,"LI",{});var Ib=i(Mr);Wf=s(Ib,"pair of sequences: "),zl=r(Ib,"CODE",{});var Rv=i(zl);Rf=s(Rv,"A </s> B </s>"),Rv.forEach(t),Ib.forEach(t),$p.forEach(t),ni.forEach(t),Hf=c(Ve),En=r(Ve,"DIV",{class:!0});var xp=i(En);v(Es.$$.fragment,xp),Vf=c(xp),qs=r(xp,"P",{});var zp=i(qs);Kf=s(zp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
use of token type ids, therefore a list of zeros is returned.`),Vv.forEach(t),jp.forEach(t),e_=c(Ve),Cr=r(Ve,"DIV",{class:!0});var Kv=i(Cr);v(Ms.$$.fragment,Kv),Kv.forEach(t),Ve.forEach(t),Bc=c(n),Wt=r(n,"H2",{class:!0});var Ep=i(Wt);Fn=r(Ep,"A",{id:!0,class:!0,href:!0});var Yv=i(Fn);ql=r(Yv,"SPAN",{});var Zv=i(ql);v(Cs.$$.fragment,Zv),Zv.forEach(t),Yv.forEach(t),t_=c(Ep),Fl=r(Ep,"SPAN",{});var Jv=i(Fl);n_=s(Jv,"T5TokenizerFast"),Jv.forEach(t),Ep.forEach(t),Wc=c(n),Se=r(n,"DIV",{class:!0});var Ot=i(Se);v(Ps.$$.fragment,Ot),o_=c(Ot),Rt=r(Ot,"P",{});var oi=i(Rt);s_=s(oi,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),Ml=r(oi,"EM",{});var Xv=i(Ml);a_=s(Xv,"tokenizers"),Xv.forEach(t),r_=s(oi,` library). Based on
...
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),Jp.forEach(t),r1=c(Ye),qa=r(Ye,"P",{});var Xp=i(qa);i1=s(Xp,"This model inherits from "),Wr=r(Xp,"A",{href:!0});var t5=i(Wr);l1=s(t5,"TFPreTrainedModel"),t5.forEach(t),d1=s(Xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
