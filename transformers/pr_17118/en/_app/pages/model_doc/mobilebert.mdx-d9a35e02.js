...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_17118/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_17118/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_17118/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_mobilebert.py#L843",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_17118/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_mobilebert.py#L950",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_mobilebert.py#L1059",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_mobilebert.py#L1145",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_mobilebert.py#L1254",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_mobilebert.py#L1465",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_mobilebert.py#L1567",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_mobilebert.py#L1357",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
<a href="/docs/transformers/pr_17118/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_17118/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_tf_outputs.TFNextSentencePredictorOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_17118/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17118/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
`}}),Gn=new Pe({props:{$$slots:{default:[cy]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[py]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[hy]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=h(),c=r("h1"),p=r("a"),T=r("span"),v(l.$$.fragment),u=h(),x=r("span"),he=n("MobileBERT"),V=h(),z=r("h2"),J=r("a"),L=r("span"),v(X.$$.fragment),me=h(),D=r("span"),ue=n("Overview"),le=h(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),P=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
...
documentation from `),$a=r("a"),Ip=n("PretrainedConfig"),Lp=n(" for more information."),Dp=h(),v(Co.$$.fragment),Wp=h(),qi=r("p"),Rp=n(`Attributes: pretrained_config_archive_map (Dict[str, str]): A dictionary containing all the available pre-trained
...
splitting and wordpiece.`),uh=h(),us=r("p"),fh=n("Refer to superclass "),Pa=r("a"),gh=n("BertTokenizerFast"),_h=n(" for usage examples and documentation concerning parameters."),Wd=h(),Ht=r("h2"),Ao=r("a"),Ii=r("span"),v(fs.$$.fragment),bh=h(),Li=r("span"),Th=n("MobileBert specific outputs"),Rd=h(),Qt=r("div"),v(gs.$$.fragment),kh=h(),_s=r("p"),vh=n("Output type of "),qa=r("a"),yh=n("MobileBertForPreTraining"),wh=n("."),Ud=h(),Kt=r("div"),v(bs.$$.fragment),Mh=h(),Ts=r("p"),$h=n("Output type of "),Ca=r("a"),Fh=n("TFMobileBertForPreTraining"),Bh=n("."),Hd=h(),Vt=r("h2"),Io=r("a"),Di=r("span"),v(ks.$$.fragment),Eh=h(),Wi=r("span"),xh=n("MobileBertModel"),Qd=h(),je=r("div"),v(vs.$$.fragment),zh=h(),Ri=r("p"),Ph=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),qh=h(),ys=r("p"),Ch=n("This model inherits from "),ja=r("a"),jh=n("PreTrainedModel"),Nh=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bu=h(),Ce=r("div"),v(Zs.$$.fragment),Eu=h(),so=r("p"),xu=n("The "),Ra=r("a"),zu=n("MobileBertForSequenceClassification"),Pu=n(" forward method, overrides the "),ll=r("code"),qu=n("__call__"),Cu=n(" special method."),ju=h(),v(Xo.$$.fragment),Nu=h(),v(en.$$.fragment),Ou=h(),v(tn.$$.fragment),Su=h(),v(on.$$.fragment),Au=h(),v(nn.$$.fragment),tc=h(),ro=r("h2"),sn=r("a"),dl=r("span"),v(Xs.$$.fragment),Iu=h(),cl=r("span"),Lu=n("MobileBertForMultipleChoice"),oc=h(),Ke=r("div"),v(er.$$.fragment),Du=h(),pl=r("p"),Wu=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=h(),v(zn.$$.fragment),N_=h(),mt=r("div"),v(Wr.$$.fragment),O_=h(),vo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),L_=n("__call__"),D_=n(" special method."),W_=h(),v(Pn.$$.fragment),R_=h(),v(qn.$$.fragment),fc=h(),yo=r("h2"),Cn=r("a"),Il=r("span"),v(Rr.$$.fragment),U_=h(),Ll=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=h(),Ie=r("div"),v(Ur.$$.fragment),Q_=h(),Dl=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$b=h(),v(In.$$.fragment),Fb=h(),ut=r("div"),v(ea.$$.fragment),Bb=h(),$o=r("p"),Eb=n("The "),ii=r("a"),xb=n("TFMobileBertForMultipleChoice"),zb=n(" forward method, overrides the "),Ql=r("code"),Pb=n("__call__"),qb=n(" special method."),Cb=h(),v(Ln.$$.fragment),jb=h(),v(Dn.$$.fragment),Tc=h(),Fo=r("h2"),Wn=r("a"),Kl=r("span"),v(ta.$$.fragment),Nb=h(),Vl=r("span"),Ob=n("TFMobileBertForTokenClassification"),kc=h(),De=r("div"),v(oa.$$.fragment),Sb=h(),Gl=r("p"),Ab=n(`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kb=h(),v(Rn.$$.fragment),Vb=h(),tt=r("div"),v(aa.$$.fragment),Gb=h(),Bo=r("p"),Yb=n("The "),di=r("a"),Jb=n("TFMobileBertForTokenClassification"),Zb=n(" forward method, overrides the "),Yl=r("code"),Xb=n("__call__"),e1=n(" special method."),t1=h(),v(Un.$$.fragment),o1=h(),v(Hn.$$.fragment),n1=h(),v(Qn.$$.fragment),vc=h(),Eo=r("h2"),Kn=r("a"),Jl=r("span"),v(ia.$$.fragment),s1=h(),Zl=r("span"),r1=n("TFMobileBertForQuestionAnswering"),yc=h(),We=r("div"),v(la.$$.fragment),a1=h(),xo=r("p"),i1=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Xl=r("code"),l1=n("span start logits"),d1=n(" and "),ed=r("code"),c1=n("span end logits"),p1=n(")."),h1=h(),da=r("p"),m1=n("This model inherits from "),ci=r("a"),u1=n("TFPreTrainedModel"),f1=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),g1=h(),ca=r("p"),_1=n("This model is also a "),pa=r("a"),b1=n("tf.keras.Model"),T1=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),k1=h(),v(Vn.$$.fragment),v1=h(),ot=r("div"),v(ha.$$.fragment),y1=h(),zo=r("p"),w1=n("The "),pi=r("a"),M1=n("TFMobileBertForQuestionAnswering"),$1=n(" forward method, overrides the "),td=r("code"),F1=n("__call__"),B1=n(" special method."),E1=h(),v(Gn.$$.fragment),x1=h(),v(Yn.$$.fragment),z1=h(),v(Jn.$$.fragment),this.h()},l(o){const k=uv('[data-svelte="svelte-1phssyn"]',document.head);d=a(k,"META",{name:!0,content:!0}),k.forEach(t),_=m(o),c=a(o,"H1",{class:!0});var ma=i(c);p=a(ma,"A",{id:!0,class:!0,href:!0});var od=i(p);T=a(od,"SPAN",{});var nd=i(T);y(l.$$.fragment,nd),nd.forEach(t),od.forEach(t),u=m(ma),x=a(ma,"SPAN",{});var sd=i(x);he=s(sd,"MobileBERT"),sd.forEach(t),ma.forEach(t),V=m(o),z=a(o,"H2",{class:!0});var ua=i(z);J=a(ua,"A",{id:!0,class:!0,href:!0});var rd=i(J);L=a(rd,"SPAN",{});var ad=i(L);y(X.$$.fragment,ad),ad.forEach(t),rd.forEach(t),me=m(ua),D=a(ua,"SPAN",{});var id=i(D);ue=s(id,"Overview"),id.forEach(t),ua.forEach(t),le=m(o),K=a(o,"P",{});var fa=i(K);N=s(fa,"The MobileBERT model was proposed in "),ee=a(fa,"A",{href:!0,rel:!0});var ld=i(ee);G=s(ld,"MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),ld.forEach(t),P=s(fa,` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
Zhou. It\u2019s a bidirectional transformer based on the BERT model, which is compressed and accelerated using several
...
and wordpiece.`),Zn.forEach(t),Xp=m(Ft),cs=a(Ft,"P",{});var Ta=i(cs);eh=s(Ta,"Refer to superclass "),Ea=a(Ta,"A",{href:!0});var qd=i(Ea);th=s(qd,"BertTokenizer"),qd.forEach(t),oh=s(Ta," for usage examples and documentation concerning parameters."),Ta.forEach(t),Ft.forEach(t),Ld=m(o),Ut=a(o,"H2",{class:!0});var ka=i(Ut);Oo=a(ka,"A",{id:!0,class:!0,href:!0});var Cd=i(Oo);Oi=a(Cd,"SPAN",{});var jd=i(Oi);y(ps.$$.fragment,jd),jd.forEach(t),Cd.forEach(t),nh=m(ka),Si=a(ka,"SPAN",{});var Nd=i(Si);sh=s(Nd,"MobileBertTokenizerFast"),Nd.forEach(t),ka.forEach(t),Dd=m(o),rt=a(o,"DIV",{class:!0});var Bt=i(rt);y(hs.$$.fragment,Bt),rh=m(Bt),ms=a(Bt,"P",{});var va=i(ms);ah=s(va,"Construct a \u201Cfast\u201D MobileBERT tokenizer (backed by HuggingFace\u2019s "),Ai=a(va,"EM",{});var Od=i(Ai);ih=s(Od,"tokenizers"),Od.forEach(t),lh=s(va," library)."),va.forEach(t),dh=m(Bt),So=a(Bt,"P",{});var Sd=i(So);xa=a(Sd,"A",{href:!0});var P1=i(xa);ch=s(P1,"MobileBertTokenizerFast"),P1.forEach(t),ph=s(Sd," is identical to "),za=a(Sd,"A",{href:!0});var q1=i(za);hh=s(q1,"BertTokenizerFast"),q1.forEach(t),mh=s(Sd,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),Sd.forEach(t),uh=m(Bt),us=a(Bt,"P",{});var Mc=i(us);fh=s(Mc,"Refer to superclass "),Pa=a(Mc,"A",{href:!0});var C1=i(Pa);gh=s(C1,"BertTokenizerFast"),C1.forEach(t),_h=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=m(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var j1=i(Ao);Ii=a(j1,"SPAN",{});var N1=i(Ii);y(fs.$$.fragment,N1),N1.forEach(t),j1.forEach(t),bh=m($c),Li=a($c,"SPAN",{});var O1=i(Li);Th=s(O1,"MobileBert specific outputs"),O1.forEach(t),$c.forEach(t),Rd=m(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);y(gs.$$.fragment,Fc),kh=m(Fc),_s=a(Fc,"P",{});var Bc=i(_s);vh=s(Bc,"Output type of "),qa=a(Bc,"A",{href:!0});var S1=i(qa);yh=s(S1,"MobileBertForPreTraining"),S1.forEach(t),wh=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=m(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);y(bs.$$.fragment,Ec),Mh=m(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$h=s(xc,"Output type of "),Ca=a(xc,"A",{href:!0});var A1=i(Ca);Fh=s(A1,"TFMobileBertForPreTraining"),A1.forEach(t),Bh=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=m(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var I1=i(Io);Di=a(I1,"SPAN",{});var L1=i(Di);y(ks.$$.fragment,L1),L1.forEach(t),I1.forEach(t),Eh=m(zc),Wi=a(zc,"SPAN",{});var D1=i(Wi);xh=s(D1,"MobileBertModel"),D1.forEach(t),zc.forEach(t),Qd=m(o),je=a(o,"DIV",{class:!0});var ft=i(je);y(vs.$$.fragment,ft),zh=m(ft),Ri=a(ft,"P",{});var W1=i(Ri);Ph=s(W1,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),W1.forEach(t),qh=m(ft),ys=a(ft,"P",{});var Pc=i(ys);Ch=s(Pc,"This model inherits from "),ja=a(Pc,"A",{href:!0});var R1=i(ja);jh=s(R1,"PreTrainedModel"),R1.forEach(t),Nh=s(Pc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc.forEach(t),Oh=m(ft),ws=a(ft,"P",{});var qc=i(ws);Sh=s(qc,"This model is also a PyTorch "),Ms=a(qc,"A",{href:!0,rel:!0});var U1=i(Ms);Ah=s(U1,"torch.nn.Module"),U1.forEach(t),Ih=s(qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qc.forEach(t),Lh=m(ft),Ui=a(ft,"P",{});var H1=i(Ui);$s=a(H1,"A",{href:!0,rel:!0});var Q1=i($s);Dh=s(Q1,"https://arxiv.org/pdf/2004.02984.pdf"),Q1.forEach(t),H1.forEach(t),Wh=m(ft),it=a(ft,"DIV",{class:!0});var Xn=i(it);y(Fs.$$.fragment,Xn),Rh=m(Xn),Gt=a(Xn,"P",{});var hi=i(Gt);Uh=s(hi,"The "),Na=a(hi,"A",{href:!0});var K1=i(Na);Hh=s(K1,"MobileBertModel"),K1.forEach(t),Qh=s(hi," forward method, overrides the "),Hi=a(hi,"CODE",{});var V1=i(Hi);Kh=s(V1,"__call__"),V1.forEach(t),Vh=s(hi," special method."),hi.forEach(t),Gh=m(Xn),y(Lo.$$.fragment,Xn),Yh=m(Xn),y(Do.$$.fragment,Xn),Xn.forEach(t),ft.forEach(t),Kd=m(o),Yt=a(o,"H2",{class:!0});var Cc=i(Yt);Wo=a(Cc,"A",{id:!0,class:!0,href:!0});var G1=i(Wo);Qi=a(G1,"SPAN",{});var Y1=i(Qi);y(Bs.$$.fragment,Y1),Y1.forEach(t),G1.forEach(t),Jh=m(Cc),Ki=a(Cc,"SPAN",{});var J1=i(Ki);Zh=s(J1,"MobileBertForPreTraining"),J1.forEach(t),Cc.forEach(t),Vd=m(o),Re=a(o,"DIV",{class:!0});var Et=i(Re);y(Es.$$.fragment,Et),Xh=m(Et),Jt=a(Et,"P",{});var mi=i(Jt);em=s(mi,"MobileBert Model with two heads on top as done during the pretraining: a "),Vi=a(mi,"CODE",{});var Z1=i(Vi);tm=s(Z1,"masked language modeling"),Z1.forEach(t),om=s(mi,` head and a
`),Gi=a(mi,"CODE",{});var X1=i(Gi);nm=s(X1,"next sentence prediction (classification)"),X1.forEach(t),sm=s(mi," head."),mi.forEach(t),rm=m(Et),xs=a(Et,"P",{});var jc=i(xs);am=s(jc,"This model inherits from "),Oa=a(jc,"A",{href:!0});var eT=i(Oa);im=s(eT,"PreTrainedModel"),eT.forEach(t),lm=s(jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jc.forEach(t),dm=m(Et),zs=a(Et,"P",{});var Nc=i(zs);cm=s(Nc,"This model is also a PyTorch "),Ps=a(Nc,"A",{href:!0,rel:!0});var tT=i(Ps);pm=s(tT,"torch.nn.Module"),tT.forEach(t),hm=s(Nc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nc.forEach(t),mm=m(Et),lt=a(Et,"DIV",{class:!0});var es=i(lt);y(qs.$$.fragment,es),um=m(es),Zt=a(es,"P",{});var ui=i(Zt);fm=s(ui,"The "),Sa=a(ui,"A",{href:!0});var oT=i(Sa);gm=s(oT,"MobileBertForPreTraining"),oT.forEach(t),_m=s(ui," forward method, overrides the "),Yi=a(ui,"CODE",{});var nT=i(Yi);bm=s(nT,"__call__"),nT.forEach(t),Tm=s(ui," special method."),ui.forEach(t),km=m(es),y(Ro.$$.fragment,es),vm=m(es),y(Uo.$$.fragment,es),es.forEach(t),Et.forEach(t),Gd=m(o),Xt=a(o,"H2",{class:!0});var Oc=i(Xt);Ho=a(Oc,"A",{id:!0,class:!0,href:!0});var sT=i(Ho);Ji=a(sT,"SPAN",{});var rT=i(Ji);y(Cs.$$.fragment,rT),rT.forEach(t),sT.forEach(t),ym=m(Oc),Zi=a(Oc,"SPAN",{});var aT=i(Zi);wm=s(aT,"MobileBertForMaskedLM"),aT.forEach(t),Oc.forEach(t),Yd=m(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);y(js.$$.fragment,xt),Mm=m(xt),Ns=a(xt,"P",{});var Sc=i(Ns);$m=s(Sc,"MobileBert Model with a "),Xi=a(Sc,"CODE",{});var iT=i(Xi);Fm=s(iT,"language modeling"),iT.forEach(t),Bm=s(Sc," head on top."),Sc.forEach(t),Em=m(xt),Os=a(xt,"P",{});var Ac=i(Os);xm=s(Ac,"This model inherits from "),Aa=a(Ac,"A",{href:!0});var lT=i(Aa);zm=s(lT,"PreTrainedModel"),lT.forEach(t),Pm=s(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),qm=m(xt),Ss=a(xt,"P",{});var Ic=i(Ss);Cm=s(Ic,"This model is also a PyTorch "),As=a(Ic,"A",{href:!0,rel:!0});var dT=i(As);jm=s(dT,"torch.nn.Module"),dT.forEach(t),Nm=s(Ic,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Om=m(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sm=m(zt),eo=a(zt,"P",{});var fi=i(eo);Am=s(fi,"The "),Ia=a(fi,"A",{href:!0});var cT=i(Ia);Im=s(cT,"MobileBertForMaskedLM"),cT.forEach(t),Lm=s(fi," forward method, overrides the "),el=a(fi,"CODE",{});var pT=i(el);Dm=s(pT,"__call__"),pT.forEach(t),Wm=s(fi," special method."),fi.forEach(t),Rm=m(zt),y(Qo.$$.fragment,zt),Um=m(zt),y(Ko.$$.fragment,zt),Hm=m(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=m(o),to=a(o,"H2",{class:!0});var Lc=i(to);Go=a(Lc,"A",{id:!0,class:!0,href:!0});var hT=i(Go);tl=a(hT,"SPAN",{});var mT=i(tl);y(Ls.$$.fragment,mT),mT.forEach(t),hT.forEach(t),Qm=m(Lc),ol=a(Lc,"SPAN",{});var uT=i(ol);Km=s(uT,"MobileBertForNextSentencePrediction"),uT.forEach(t),Lc.forEach(t),Zd=m(o),He=a(o,"DIV",{class:!0});var Pt=i(He);y(Ds.$$.fragment,Pt),Vm=m(Pt),Ws=a(Pt,"P",{});var Dc=i(Ws);Gm=s(Dc,"MobileBert Model with a "),nl=a(Dc,"CODE",{});var fT=i(nl);Ym=s(fT,"next sentence prediction (classification)"),fT.forEach(t),Jm=s(Dc," head on top."),Dc.forEach(t),Zm=m(Pt),Rs=a(Pt,"P",{});var Wc=i(Rs);Xm=s(Wc,"This model inherits from "),La=a(Wc,"A",{href:!0});var gT=i(La);eu=s(gT,"PreTrainedModel"),gT.forEach(t),tu=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wc.forEach(t),ou=m(Pt),Us=a(Pt,"P",{});var Rc=i(Us);nu=s(Rc,"This model is also a PyTorch "),Hs=a(Rc,"A",{href:!0,rel:!0});var _T=i(Hs);su=s(_T,"torch.nn.Module"),_T.forEach(t),ru=s(Rc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(t),au=m(Pt),dt=a(Pt,"DIV",{class:!0});var ts=i(dt);y(Qs.$$.fragment,ts),iu=m(ts),oo=a(ts,"P",{});var gi=i(oo);lu=s(gi,"The "),Da=a(gi,"A",{href:!0});var bT=i(Da);du=s(bT,"MobileBertForNextSentencePrediction"),bT.forEach(t),cu=s(gi," forward method, overrides the "),sl=a(gi,"CODE",{});var TT=i(sl);pu=s(TT,"__call__"),TT.forEach(t),hu=s(gi," special method."),gi.forEach(t),mu=m(ts),y(Yo.$$.fragment,ts),uu=m(ts),y(Jo.$$.fragment,ts),ts.forEach(t),Pt.forEach(t),Xd=m(o),no=a(o,"H2",{class:!0});var Uc=i(no);Zo=a(Uc,"A",{id:!0,class:!0,href:!0});var kT=i(Zo);rl=a(kT,"SPAN",{});var vT=i(rl);y(Ks.$$.fragment,vT),vT.forEach(t),kT.forEach(t),fu=m(Uc),al=a(Uc,"SPAN",{});var yT=i(al);gu=s(yT,"MobileBertForSequenceClassification"),yT.forEach(t),Uc.forEach(t),ec=m(o),Qe=a(o,"DIV",{class:!0});var qt=i(Qe);y(Vs.$$.fragment,qt),_u=m(qt),il=a(qt,"P",{});var wT=i(il);bu=s(wT,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wT.forEach(t),Tu=m(qt),Gs=a(qt,"P",{});var Hc=i(Gs);ku=s(Hc,"This model inherits from "),Wa=a(Hc,"A",{href:!0});var MT=i(Wa);vu=s(MT,"PreTrainedModel"),MT.forEach(t),yu=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hc.forEach(t),wu=m(qt),Ys=a(qt,"P",{});var Qc=i(Ys);Mu=s(Qc,"This model is also a PyTorch "),Js=a(Qc,"A",{href:!0,rel:!0});var $T=i(Js);$u=s($T,"torch.nn.Module"),$T.forEach(t),Fu=s(Qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=m(qt),Ce=a(qt,"DIV",{class:!0});var nt=i(Ce);y(Zs.$$.fragment,nt),Eu=m(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var FT=i(Ra);zu=s(FT,"MobileBertForSequenceClassification"),FT.forEach(t),Pu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var BT=i(ll);qu=s(BT,"__call__"),BT.forEach(t),Cu=s(_i," special method."),_i.forEach(t),ju=m(nt),y(Xo.$$.fragment,nt),Nu=m(nt),y(en.$$.fragment,nt),Ou=m(nt),y(tn.$$.fragment,nt),Su=m(nt),y(on.$$.fragment,nt),Au=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var ET=i(sn);dl=a(ET,"SPAN",{});var xT=i(dl);y(Xs.$$.fragment,xT),xT.forEach(t),ET.forEach(t),Iu=m(Kc),cl=a(Kc,"SPAN",{});var zT=i(cl);Lu=s(zT,"MobileBertForMultipleChoice"),zT.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var Ct=i(Ke);y(er.$$.fragment,Ct),Du=m(Ct),pl=a(Ct,"P",{});var PT=i(pl);Wu=s(PT,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),PT.forEach(t),Ru=m(Ct),tr=a(Ct,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qT=i(Ua);Hu=s(qT,"PreTrainedModel"),qT.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),Ku=m(Ct),or=a(Ct,"P",{});var Gc=i(or);Vu=s(Gc,"This model is also a PyTorch "),nr=a(Gc,"A",{href:!0,rel:!0});var CT=i(nr);Gu=s(CT,"torch.nn.Module"),CT.forEach(t),Yu=s(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(t),Ju=m(Ct),ct=a(Ct,"DIV",{class:!0});var os=i(ct);y(sr.$$.fragment,os),Zu=m(os),ao=a(os,"P",{});var bi=i(ao);Xu=s(bi,"The "),Ha=a(bi,"A",{href:!0});var jT=i(Ha);ef=s(jT,"MobileBertForMultipleChoice"),jT.forEach(t),tf=s(bi," forward method, overrides the "),hl=a(bi,"CODE",{});var NT=i(hl);of=s(NT,"__call__"),NT.forEach(t),nf=s(bi," special method."),bi.forEach(t),sf=m(os),y(rn.$$.fragment,os),rf=m(os),y(an.$$.fragment,os),os.forEach(t),Ct.forEach(t),nc=m(o),io=a(o,"H2",{class:!0});var Yc=i(io);ln=a(Yc,"A",{id:!0,class:!0,href:!0});var OT=i(ln);ml=a(OT,"SPAN",{});var ST=i(ml);y(rr.$$.fragment,ST),ST.forEach(t),OT.forEach(t),af=m(Yc),ul=a(Yc,"SPAN",{});var AT=i(ul);lf=s(AT,"MobileBertForTokenClassification"),AT.forEach(t),Yc.forEach(t),sc=m(o),Ve=a(o,"DIV",{class:!0});var jt=i(Ve);y(ar.$$.fragment,jt),df=m(jt),fl=a(jt,"P",{});var IT=i(fl);cf=s(IT,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),IT.forEach(t),pf=m(jt),ir=a(jt,"P",{});var Jc=i(ir);hf=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var LT=i(Qa);mf=s(LT,"PreTrainedModel"),LT.forEach(t),uf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),ff=m(jt),lr=a(jt,"P",{});var Zc=i(lr);gf=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var DT=i(dr);_f=s(DT,"torch.nn.Module"),DT.forEach(t),bf=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tf=m(jt),Je=a(jt,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),kf=m(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vf=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var WT=i(Ka);yf=s(WT,"MobileBertForTokenClassification"),WT.forEach(t),wf=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var RT=i(gl);Mf=s(RT,"__call__"),RT.forEach(t),$f=s(Ti," special method."),Ti.forEach(t),Ff=m(Nt),y(dn.$$.fragment,Nt),Bf=m(Nt),y(cn.$$.fragment,Nt),Ef=m(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),jt.forEach(t),rc=m(o),co=a(o,"H2",{class:!0});var Xc=i(co);hn=a(Xc,"A",{id:!0,class:!0,href:!0});var UT=i(hn);_l=a(UT,"SPAN",{});var HT=i(_l);y(pr.$$.fragment,HT),HT.forEach(t),UT.forEach(t),xf=m(Xc),bl=a(Xc,"SPAN",{});var QT=i(bl);zf=s(QT,"MobileBertForQuestionAnswering"),QT.forEach(t),Xc.forEach(t),ac=m(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(hr.$$.fragment,Ot),Pf=m(Ot),po=a(Ot,"P",{});var ki=i(po);qf=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var KT=i(Tl);Cf=s(KT,"span start logits"),KT.forEach(t),jf=s(ki," and "),kl=a(ki,"CODE",{});var VT=i(kl);Nf=s(VT,"span end logits"),VT.forEach(t),Of=s(ki,")."),ki.forEach(t),Sf=m(Ot),mr=a(Ot,"P",{});var ep=i(mr);Af=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var GT=i(Va);If=s(GT,"PreTrainedModel"),GT.forEach(t),Lf=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep.forEach(t),Df=m(Ot),ur=a(Ot,"P",{});var tp=i(ur);Wf=s(tp,"This model is also a PyTorch "),fr=a(tp,"A",{href:!0,rel:!0});var YT=i(fr);Rf=s(YT,"torch.nn.Module"),YT.forEach(t),Uf=s(tp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp.forEach(t),Hf=m(Ot),Ze=a(Ot,"DIV",{class:!0});var St=i(Ze);y(gr.$$.fragment,St),Qf=m(St),ho=a(St,"P",{});var vi=i(ho);Kf=s(vi,"The "),Ga=a(vi,"A",{href:!0});var JT=i(Ga);Vf=s(JT,"MobileBertForQuestionAnswering"),JT.forEach(t),Gf=s(vi," forward method, overrides the "),vl=a(vi,"CODE",{});var ZT=i(vl);Yf=s(ZT,"__call__"),ZT.forEach(t),Jf=s(vi," special method."),vi.forEach(t),Zf=m(St),y(mn.$$.fragment,St),Xf=m(St),y(un.$$.fragment,St),eg=m(St),y(fn.$$.fragment,St),St.forEach(t),Ot.forEach(t),ic=m(o),mo=a(o,"H2",{class:!0});var op=i(mo);gn=a(op,"A",{id:!0,class:!0,href:!0});var XT=i(gn);yl=a(XT,"SPAN",{});var ek=i(yl);y(_r.$$.fragment,ek),ek.forEach(t),XT.forEach(t),tg=m(op),wl=a(op,"SPAN",{});var tk=i(wl);og=s(tk,"TFMobileBertModel"),tk.forEach(t),op.forEach(t),lc=m(o),Ne=a(o,"DIV",{class:!0});var gt=i(Ne);y(br.$$.fragment,gt),ng=m(gt),Ml=a(gt,"P",{});var ok=i(Ml);sg=s(ok,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),ok.forEach(t),rg=m(gt),Tr=a(gt,"P",{});var np=i(Tr);ag=s(np,"This model inherits from "),Ya=a(np,"A",{href:!0});var nk=i(Ya);ig=s(nk,"TFPreTrainedModel"),nk.forEach(t),lg=s(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),np.forEach(t),dg=m(gt),kr=a(gt,"P",{});var sp=i(kr);cg=s(sp,"This model is also a "),vr=a(sp,"A",{href:!0,rel:!0});var sk=i(vr);pg=s(sk,"tf.keras.Model"),sk.forEach(t),hg=s(sp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sp.forEach(t),mg=m(gt),y(_n.$$.fragment,gt),ug=m(gt),pt=a(gt,"DIV",{class:!0});var ns=i(pt);y(yr.$$.fragment,ns),fg=m(ns),uo=a(ns,"P",{});var yi=i(uo);gg=s(yi,"The "),Ja=a(yi,"A",{href:!0});var rk=i(Ja);_g=s(rk,"TFMobileBertModel"),rk.forEach(t),bg=s(yi," forward method, overrides the "),$l=a(yi,"CODE",{});var ak=i($l);Tg=s(ak,"__call__"),ak.forEach(t),kg=s(yi," special method."),yi.forEach(t),vg=m(ns),y(bn.$$.fragment,ns),yg=m(ns),y(Tn.$$.fragment,ns),ns.forEach(t),gt.forEach(t),dc=m(o),fo=a(o,"H2",{class:!0});var rp=i(fo);kn=a(rp,"A",{id:!0,class:!0,href:!0});var ik=i(kn);Fl=a(ik,"SPAN",{});var lk=i(Fl);y(wr.$$.fragment,lk),lk.forEach(t),ik.forEach(t),wg=m(rp),Bl=a(rp,"SPAN",{});var dk=i(Bl);Mg=s(dk,"TFMobileBertForPreTraining"),dk.forEach(t),rp.forEach(t),cc=m(o),Oe=a(o,"DIV",{class:!0});var _t=i(Oe);y(Mr.$$.fragment,_t),$g=m(_t),go=a(_t,"P",{});var wi=i(go);Fg=s(wi,"MobileBert Model with two heads on top as done during the pretraining: a "),El=a(wi,"CODE",{});var ck=i(El);Bg=s(ck,"masked language modeling"),ck.forEach(t),Eg=s(wi,` head and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip.forEach(t),Ig=m(_t),y(vn.$$.fragment,_t),Lg=m(_t),ht=a(_t,"DIV",{class:!0});var ss=i(ht);y(Er.$$.fragment,ss),Dg=m(ss),_o=a(ss,"P",{});var Mi=i(_o);Wg=s(Mi,"The "),Xa=a(Mi,"A",{href:!0});var uk=i(Xa);Rg=s(uk,"TFMobileBertForPreTraining"),uk.forEach(t),Ug=s(Mi," forward method, overrides the "),zl=a(Mi,"CODE",{});var fk=i(zl);Hg=s(fk,"__call__"),fk.forEach(t),Qg=s(Mi," special method."),Mi.forEach(t),Kg=m(ss),y(yn.$$.fragment,ss),Vg=m(ss),y(wn.$$.fragment,ss),ss.forEach(t),_t.forEach(t),pc=m(o),bo=a(o,"H2",{class:!0});var lp=i(bo);Mn=a(lp,"A",{id:!0,class:!0,href:!0});var gk=i(Mn);Pl=a(gk,"SPAN",{});var _k=i(Pl);y(xr.$$.fragment,_k),_k.forEach(t),gk.forEach(t),Gg=m(lp),ql=a(lp,"SPAN",{});var bk=i(ql);Yg=s(bk,"TFMobileBertForMaskedLM"),bk.forEach(t),lp.forEach(t),hc=m(o),Se=a(o,"DIV",{class:!0});var bt=i(Se);y(zr.$$.fragment,bt),Jg=m(bt),Pr=a(bt,"P",{});var dp=i(Pr);Zg=s(dp,"MobileBert Model with a "),Cl=a(dp,"CODE",{});var Tk=i(Cl);Xg=s(Tk,"language modeling"),Tk.forEach(t),e_=s(dp," head on top."),dp.forEach(t),t_=m(bt),qr=a(bt,"P",{});var cp=i(qr);o_=s(cp,"This model inherits from "),ei=a(cp,"A",{href:!0});var kk=i(ei);n_=s(kk,"TFPreTrainedModel"),kk.forEach(t),s_=s(cp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cp.forEach(t),r_=m(bt),Cr=a(bt,"P",{});var pp=i(Cr);a_=s(pp,"This model is also a "),jr=a(pp,"A",{href:!0,rel:!0});var vk=i(jr);i_=s(vk,"tf.keras.Model"),vk.forEach(t),l_=s(pp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pp.forEach(t),d_=m(bt),y($n.$$.fragment,bt),c_=m(bt),Xe=a(bt,"DIV",{class:!0});var At=i(Xe);y(Nr.$$.fragment,At),p_=m(At),To=a(At,"P",{});var $i=i(To);h_=s($i,"The "),ti=a($i,"A",{href:!0});var yk=i(ti);m_=s(yk,"TFMobileBertForMaskedLM"),yk.forEach(t),u_=s($i," forward method, overrides the "),jl=a($i,"CODE",{});var wk=i(jl);f_=s(wk,"__call__"),wk.forEach(t),g_=s($i," special method."),$i.forEach(t),__=m(At),y(Fn.$$.fragment,At),b_=m(At),y(Bn.$$.fragment,At),T_=m(At),y(En.$$.fragment,At),At.forEach(t),bt.forEach(t),mc=m(o),ko=a(o,"H2",{class:!0});var hp=i(ko);xn=a(hp,"A",{id:!0,class:!0,href:!0});var Mk=i(xn);Nl=a(Mk,"SPAN",{});var $k=i(Nl);y(Or.$$.fragment,$k),$k.forEach(t),Mk.forEach(t),k_=m(hp),Ol=a(hp,"SPAN",{});var Fk=i(Ol);v_=s(Fk,"TFMobileBertForNextSentencePrediction"),Fk.forEach(t),hp.forEach(t),uc=m(o),Ae=a(o,"DIV",{class:!0});var Tt=i(Ae);y(Sr.$$.fragment,Tt),y_=m(Tt),Ar=a(Tt,"P",{});var mp=i(Ar);w_=s(mp,"MobileBert Model with a "),Sl=a(mp,"CODE",{});var Bk=i(Sl);M_=s(Bk,"next sentence prediction (classification)"),Bk.forEach(t),$_=s(mp," head on top."),mp.forEach(t),F_=m(Tt),Ir=a(Tt,"P",{});var up=i(Ir);B_=s(up,"This model inherits from "),oi=a(up,"A",{href:!0});var Ek=i(oi);E_=s(Ek,"TFPreTrainedModel"),Ek.forEach(t),x_=s(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=m(Tt),Lr=a(Tt,"P",{});var fp=i(Lr);P_=s(fp,"This model is also a "),Dr=a(fp,"A",{href:!0,rel:!0});var xk=i(Dr);q_=s(xk,"tf.keras.Model"),xk.forEach(t),C_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),j_=m(Tt),y(zn.$$.fragment,Tt),N_=m(Tt),mt=a(Tt,"DIV",{class:!0});var rs=i(mt);y(Wr.$$.fragment,rs),O_=m(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zk=i(ni);A_=s(zk,"TFMobileBertForNextSentencePrediction"),zk.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Pk=i(Al);L_=s(Pk,"__call__"),Pk.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=m(rs),y(Pn.$$.fragment,rs),R_=m(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=m(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var qk=i(Cn);Il=a(qk,"SPAN",{});var Ck=i(Il);y(Rr.$$.fragment,Ck),Ck.forEach(t),qk.forEach(t),U_=m(gp),Ll=a(gp,"SPAN",{});var jk=i(Ll);H_=s(jk,"TFMobileBertForSequenceClassification"),jk.forEach(t),gp.forEach(t),gc=m(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=m(kt),Dl=a(kt,"P",{});var Nk=i(Dl);K_=s(Nk,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Nk.forEach(t),V_=m(kt),Hr=a(kt,"P",{});var _p=i(Hr);G_=s(_p,"This model inherits from "),si=a(_p,"A",{href:!0});var Ok=i(si);Y_=s(Ok,"TFPreTrainedModel"),Ok.forEach(t),J_=s(_p,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_p.forEach(t),Z_=m(kt),Qr=a(kt,"P",{});var bp=i(Qr);X_=s(bp,"This model is also a "),Kr=a(bp,"A",{href:!0,rel:!0});var Sk=i(Kr);eb=s(Sk,"tf.keras.Model"),Sk.forEach(t),tb=s(bp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bp.forEach(t),ob=m(kt),y(jn.$$.fragment,kt),nb=m(kt),et=a(kt,"DIV",{class:!0});var It=i(et);y(Vr.$$.fragment,It),sb=m(It),wo=a(It,"P",{});var Bi=i(wo);rb=s(Bi,"The "),ri=a(Bi,"A",{href:!0});var Ak=i(ri);ab=s(Ak,"TFMobileBertForSequenceClassification"),Ak.forEach(t),ib=s(Bi," forward method, overrides the "),Wl=a(Bi,"CODE",{});var Ik=i(Wl);lb=s(Ik,"__call__"),Ik.forEach(t),db=s(Bi," special method."),Bi.forEach(t),cb=m(It),y(Nn.$$.fragment,It),pb=m(It),y(On.$$.fragment,It),hb=m(It),y(Sn.$$.fragment,It),It.forEach(t),kt.forEach(t),_c=m(o),Mo=a(o,"H2",{class:!0});var Tp=i(Mo);An=a(Tp,"A",{id:!0,class:!0,href:!0});var Lk=i(An);Rl=a(Lk,"SPAN",{});var Dk=i(Rl);y(Gr.$$.fragment,Dk),Dk.forEach(t),Lk.forEach(t),mb=m(Tp),Ul=a(Tp,"SPAN",{});var Wk=i(Ul);ub=s(Wk,"TFMobileBertForMultipleChoice"),Wk.forEach(t),Tp.forEach(t),bc=m(o),Le=a(o,"DIV",{class:!0});var vt=i(Le);y(Yr.$$.fragment,vt),fb=m(vt),Hl=a(vt,"P",{});var Rk=i(Hl);gb=s(Rk,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Rk.forEach(t),_b=m(vt),Jr=a(vt,"P",{});var kp=i(Jr);bb=s(kp,"This model inherits from "),ai=a(kp,"A",{href:!0});var Uk=i(ai);Tb=s(Uk,"TFPreTrainedModel"),Uk.forEach(t),kb=s(kp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kp.forEach(t),vb=m(vt),Zr=a(vt,"P",{});var vp=i(Zr);yb=s(vp,"This model is also a "),Xr=a(vp,"A",{href:!0,rel:!0});var Hk=i(Xr);wb=s(Hk,"tf.keras.Model"),Hk.forEach(t),Mb=s(vp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),$b=m(vt),y(In.$$.fragment,vt),Fb=m(vt),ut=a(vt,"DIV",{class:!0});var as=i(ut);y(ea.$$.fragment,as),Bb=m(as),$o=a(as,"P",{});var Ei=i($o);Eb=s(Ei,"The "),ii=a(Ei,"A",{href:!0});var Qk=i(ii);xb=s(Qk,"TFMobileBertForMultipleChoice"),Qk.forEach(t),zb=s(Ei," forward method, overrides the "),Ql=a(Ei,"CODE",{});var Kk=i(Ql);Pb=s(Kk,"__call__"),Kk.forEach(t),qb=s(Ei," special method."),Ei.forEach(t),Cb=m(as),y(Ln.$$.fragment,as),jb=m(as),y(Dn.$$.fragment,as),as.forEach(t),vt.forEach(t),Tc=m(o),Fo=a(o,"H2",{class:!0});var yp=i(Fo);Wn=a(yp,"A",{id:!0,class:!0,href:!0});var Vk=i(Wn);Kl=a(Vk,"SPAN",{});var Gk=i(Kl);y(ta.$$.fragment,Gk),Gk.forEach(t),Vk.forEach(t),Nb=m(yp),Vl=a(yp,"SPAN",{});var Yk=i(Vl);Ob=s(Yk,"TFMobileBertForTokenClassification"),Yk.forEach(t),yp.forEach(t),kc=m(o),De=a(o,"DIV",{class:!0});var yt=i(De);y(oa.$$.fragment,yt),Sb=m(yt),Gl=a(yt,"P",{});var Jk=i(Gl);Ab=s(Jk,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
