...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),hp=new w({}),fp=new Hj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/deepspeed.py#L39",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),dp=new Hj({props:{name:"del_config_sub_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/deepspeed.py#L113"}}),mp=new Hj({props:{name:"get_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/deepspeed.py#L104"}}),vp=new Hj({props:{name:"is_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/deepspeed.py#L145"}}),jp=new Hj({props:{name:"is_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/deepspeed.py#L136"}}),gp=new w({}),wp=new g({props:{code:`#!/usr/bin/env python
...
completes.`),Ew=u(),Ei=o("a"),qw=u(),As=o("h3"),Vt=o("a"),ld=o("span"),f(Zo.$$.fragment),k8=u(),rd=o("span"),P8=a("Configuration"),$w=u(),Yt=o("p"),D8=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
...
to the console, so you can see exactly what was the final configuration passed to it.`),xw=u(),ki=o("a"),Rw=u(),Ss=o("h3"),ea=o("a"),hd=o("span"),f(Yo.$$.fragment),J8=u(),fd=o("span"),X8=a("Passing Configuration"),Iw=u(),G=o("p"),Q8=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
...
the file system before passing it to `),zi=o("a"),pk=a("TrainingArguments"),ik=a("."),Uw=u(),Oi=o("p"),uk=a("To summarize you can do:"),Gw=u(),f(Ko.$$.fragment),Lw=u(),Ti=o("p"),ck=a("or:"),Mw=u(),f(Jo.$$.fragment),Zw=u(),Ai=o("a"),Nw=u(),Cs=o("h3"),sa=o("a"),_d=o("span"),f(Xo.$$.fragment),hk=u(),vd=o("span"),fk=a("Shared Configuration"),Hw=u(),f(ta.$$.fragment),Bw=u(),Me=o("p"),dk=a("Some configuration values are required by both the "),Si=o("a"),mk=a("Trainer"),_k=a(` and DeepSpeed to function correctly,
...
`),Li=o("a"),Gk=a("Trainer"),Lk=a(" during "),yd=o("code"),Mk=a("train"),Zk=a(", but you can of course do the math yourself."),Xw=u(),Mi=o("a"),Qw=u(),xs=o("h3"),la=o("a"),bd=o("span"),f(el.$$.fragment),Nk=u(),Ed=o("span"),Hk=a("ZeRO"),ey=u(),sl=o("p"),tl=o("a"),Bk=a("Zero Redundancy Optimizer (ZeRO)"),Wk=a(` is the workhorse of DeepSpeed. It
...
going to use.`),ny=u(),Hi=o("a"),oy=u(),Rs=o("h4"),pa=o("a"),$d=o("span"),f(nl.$$.fragment),t7=u(),kd=o("span"),a7=a("ZeRO-2 Config"),ly=u(),Bi=o("p"),n7=a("The following is an example of configuration for ZeRO stage 2:"),ry=u(),f(ol.$$.fragment),py=u(),Wi=o("p"),Pd=o("strong"),o7=a("Performance tuning:"),iy=u(),He=o("ul"),Is=o("li"),l7=a("enabling "),Dd=o("code"),r7=a("offload_optimizer"),p7=a(" should reduce GPU RAM usage (it requires "),zd=o("code"),i7=a('"stage": 2'),u7=a(")"),c7=u(),L=o("li"),Od=o("code"),h7=a('"overlap_comm": true'),f7=a(" trades off increased GPU RAM usage to lower all-reduce latency. "),Td=o("code"),d7=a("overlap_comm"),m7=a(` uses 4.5x
