import{S as ci,i as ii,s as li,e as a,k as l,w as m,t as s,M as di,c as n,d as o,m as d,a as c,x as u,h as r,b as i,F as e,g as h,y as _,q as g,o as v,B as T,v as pi}from"../../chunks/vendor-6b77c823.js";import{T as ni}from"../../chunks/Tip-39098574.js";import{D as A}from"../../chunks/Docstring-abef54e3.js";import{C as Ps}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _t}from"../../chunks/IconCopyLink-7a11ce68.js";function hi(gt){let f,I,x,E,L,S,O,D;return{c(){f=a("p"),I=s(`This class method is simply calling the feature extractor
...
above for more information.`),b.forEach(o),this.h()},h(){i(x,"href","/docs/transformers/pr_16521/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){h(P,f,b),e(f,I),e(f,x),e(x,E),e(f,L),e(f,S),e(S,O),e(f,D)},d(P){P&&o(f)}}}function mi(gt){let f,I,x,E,L,S,O,D,P,b,j,q,so,ye,js,ro,Cs,Lo,H,qs,vt,Fs,Ms,$e,As,Ls,Do,w,Ds,ao,Ws,Is,no,Vs,Ns,Tt,Os,Us,xt,Rs,Bs,kt,Hs,Js,co,Gs,Ks,Wo,ce,Qs,Ee,Xs,Ys,Io,ie,Zs,ze,er,tr,Vo,bt,or,No,J,Pe,sr,je,rr,ar,nr,Ce,cr,St,ir,lr,dr,qe,pr,Fe,hr,fr,Oo,ee,le,io,Me,mr,lo,ur,Uo,G,_r,wt,gr,vr,yt,Tr,xr,Ro,z,kr,$t,br,Sr,Et,wr,yr,zt,$r,Er,Pt,zr,Pr,jt,jr,Cr,Bo,Ct,po,qr,Ho,Ae,Jo,qt,Le,ho,Fr,Mr,fo,Ar,Go,De,Ko,de,Lr,We,Dr,Wr,Qo,te,pe,mo,Ie,Ir,uo,Vr,Xo,C,Ve,Nr,oe,Or,Ft,Ur,Rr,Ne,Br,Hr,Jr,se,Gr,Mt,Kr,Qr,At,Xr,Yr,Zr,_o,ea,ta,Oe,Yo,re,he,go,Ue,oa,vo,sa,Zo,$,Re,ra,To,aa,na,Be,ca,Lt,ia,la,da,fe,He,pa,xo,ha,fa,K,Je,ma,ko,ua,_a,Ge,ga,bo,va,Ta,xa,Dt,Ke,es,ae,me,So,Qe,ka,wo,ba,ts,k,Xe,Sa,yo,wa,ya,F,Wt,$a,Ea,It,za,Pa,Vt,ja,Ca,Ye,$o,qa,Fa,Ma,Nt,Aa,La,Da,ue,Ze,Wa,U,Ia,Eo,Va,Na,Ot,Oa,Ua,et,zo,Ra,Ba,Ha,Ja,Q,tt,Ga,Po,Ka,Qa,_e,Xa,X,ot,Ya,st,Za,Ut,en,tn,on,ge,sn,ve,rt,rn,at,an,Rt,nn,cn,ln,Te,nt,dn,ct,pn,Bt,hn,fn,mn,xe,it,un,jo,_n,os,ne,ke,Co,lt,gn,qo,vn,ss,W,dt,Tn,R,xn,Ht,kn,bn,Fo,Sn,wn,Jt,yn,$n,En,pt,zn,ht,Pn,jn,Cn,Y,ft,qn,Mo,Fn,Mn,mt,rs;return S=new _t({}),ye=new _t({}),Me=new _t({}),Ae=new Ps({props:{code:`import torch
...
`}}),Je=new A({props:{name:"decode",anchor:"transformers.Speech2Text2Tokenizer.decode",parameters:[{name:"token_ids",val:": typing.Union[int, typing.List[int], ForwardRef('np.ndarray'), ForwardRef('torch.Tensor'), ForwardRef('tf.Tensor')]"},{name:"skip_special_tokens",val:": bool = False"},{name:"clean_up_tokenization_spaces",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/tokenization_utils_base.py#L3275",parametersDescription:[{anchor:"transformers.Speech2Text2Tokenizer.decode.token_ids",description:`<strong>token_ids</strong> (<code>Union[int, List[int], np.ndarray, torch.Tensor, tf.Tensor]</code>) &#x2014;
...
<a href="/docs/transformers/pr_16521/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both
<a href="/docs/transformers/pr_16521/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_16521/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}]}}),ge=new ni({props:{$$slots:{default:[fi]},$$scope:{ctx:gt}}}),rt=new A({props:{name:"batch_decode",anchor:"transformers.Speech2Text2Processor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L54"}}),nt=new A({props:{name:"decode",anchor:"transformers.Speech2Text2Processor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L61"}}),it=new A({props:{name:"as_target_processor",anchor:"transformers.Speech2Text2Processor.as_target_processor",parameters:[],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L68"}}),lt=new _t({}),dt=new A({props:{name:"class transformers.Speech2Text2ForCausalLM",anchor:"transformers.Speech2Text2ForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py#L741",parametersDescription:[{anchor:"transformers.Speech2Text2ForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_16521/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config">Speech2Text2Config</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_16521/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ft=new A({props:{name:"forward",anchor:"transformers.Speech2Text2ForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/pr_16521/src/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py#L772",parametersDescription:[{anchor:"transformers.Speech2Text2ForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_16521/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer">Speech2Text2Tokenizer</a>. See <a href="/docs/transformers/pr_16521/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_16521/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
>transformers.modeling_outputs.CausalLMOutputWithCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_16521/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("meta"),I=l(),x=a("h1"),E=a("a"),L=a("span"),m(S.$$.fragment),O=l(),D=a("span"),P=s("Speech2Text2"),b=l(),j=a("h2"),q=a("a"),so=a("span"),m(ye.$$.fragment),js=l(),ro=a("span"),Cs=s("Overview"),Lo=l(),H=a("p"),qs=s("The Speech2Text2 model is used together with "),vt=a("a"),Fs=s("Wav2Vec2"),Ms=s(` for Speech Translation models proposed in
...
`),Tt=a("a"),Os=s("Wav2Vec2"),Us=s(" or "),xt=a("a"),Rs=s("HuBERT"),Bs=s(` for Speech-to-Text tasks. Please refer to the
`),kt=a("a"),Hs=s("SpeechEncoderDecoder"),Js=s(" class on how to combine Speech2Text2 with any speech "),co=a("em"),Gs=s("encoder-only"),Ks=s(`
...
`),Ne=a("a"),Br=s("facebook/s2t-small-librispeech-asr"),Hr=s(" architecture."),Jr=l(),se=a("p"),Gr=s("Configuration objects inherit from "),Mt=a("a"),Kr=s("PretrainedConfig"),Qr=s(` and can be used to control the model outputs. Read the
documentation from `),At=a("a"),Xr=s("PretrainedConfig"),Yr=s(" for more information."),Zr=l(),_o=a("p"),ea=s("Example:"),ta=l(),m(Oe.$$.fragment),Yo=l(),re=a("h2"),he=a("a"),go=a("span"),m(Ue.$$.fragment),oa=l(),vo=a("span"),sa=s("Speech2TextTokenizer"),Zo=l(),$=a("div"),m(Re.$$.fragment),ra=l(),To=a("p"),aa=s("Constructs a Speech2Text2Tokenizer."),na=l(),Be=a("p"),ca=s("This tokenizer inherits from "),Lt=a("a"),ia=s("PreTrainedTokenizer"),la=s(` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),da=l(),fe=a("div"),m(He.$$.fragment),pa=l(),xo=a("p"),ha=s("Convert a list of lists of token ids into a list of strings by calling decode."),fa=l(),K=a("div"),m(Je.$$.fragment),ma=l(),ko=a("p"),ua=s(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
...
Speech2Text2Tokenizer\u2019s `),et=a("a"),zo=a("strong"),Ra=s("call"),Ba=s("()"),Ha=s(`. Please refer to the doctsring of the above two
...
refer to the docstring of this method for more information.`),ln=l(),Te=a("div"),m(nt.$$.fragment),dn=l(),ct=a("p"),pn=s("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Bt=a("a"),hn=s("decode()"),fn=s(`. Please refer
...
Changhan Wang, Anne Wu, Juan Pino, Alexei Baevski, Michael Auli, Alexis Conneau.`),Gt.forEach(o),Do=d(t),w=n(t,"P",{});var M=c(w);Ds=r(M,"Speech2Text2 is a "),ao=n(M,"EM",{});var Rn=c(ao);Ws=r(Rn,"decoder-only"),Rn.forEach(o),Is=r(M," transformer model that can be used with any speech "),no=n(M,"EM",{});var Bn=c(no);Vs=r(Bn,"encoder-only"),Bn.forEach(o),Ns=r(M,`, such as
`),Tt=n(M,"A",{href:!0});var Hn=c(Tt);Os=r(Hn,"Wav2Vec2"),Hn.forEach(o),Us=r(M," or "),xt=n(M,"A",{href:!0});var Jn=c(xt);Rs=r(Jn,"HuBERT"),Jn.forEach(o),Bs=r(M,` for Speech-to-Text tasks. Please refer to the
`),kt=n(M,"A",{href:!0});var Gn=c(kt);Hs=r(Gn,"SpeechEncoderDecoder"),Gn.forEach(o),Js=r(M," class on how to combine Speech2Text2 with any speech "),co=n(M,"EM",{});var Kn=c(co);Gs=r(Kn,"encoder-only"),Kn.forEach(o),Ks=r(M,`
...
a single processor.`),Wc.forEach(o),ya=d(y),F=n(y,"P",{});var B=c(F);Wt=n(B,"A",{href:!0});var Ic=c(Wt);$a=r(Ic,"Speech2Text2Processor"),Ic.forEach(o),Ea=r(B," offers all the functionalities of "),It=n(B,"A",{href:!0});var Vc=c(It);za=r(Vc,"AutoFeatureExtractor"),Vc.forEach(o),Pa=r(B," and "),Vt=n(B,"A",{href:!0});var Nc=c(Vt);ja=r(Nc,"Speech2Text2Tokenizer"),Nc.forEach(o),Ca=r(B,`.
See the `),Ye=n(B,"A",{href:!0});var An=c(Ye);$o=n(An,"STRONG",{});var Oc=c($o);qa=r(Oc,"call"),Oc.forEach(o),Fa=r(An,"()"),An.forEach(o),Ma=r(B," and "),Nt=n(B,"A",{href:!0});var Uc=c(Nt);Aa=r(Uc,"decode()"),Uc.forEach(o),La=r(B," for more information."),B.forEach(o),Da=d(y),ue=n(y,"DIV",{class:!0});var xs=c(ue);u(Ze.$$.fragment,xs),Wa=d(xs),U=n(xs,"P",{});var be=c(U);Ia=r(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
`),Eo=n(be,"CODE",{});var Rc=c(Eo);Va=r(Rc,"__call__()"),Rc.forEach(o),Na=r(be,`and returns its output. If used in the context
`),Ot=n(be,"A",{href:!0});var Bc=c(Ot);Oa=r(Bc,"as_target_processor()"),Bc.forEach(o),Ua=r(be,` this method forwards all its arguments to
Speech2Text2Tokenizer\u2019s `),et=n(be,"A",{href:!0});var Ln=c(et);zo=n(Ln,"STRONG",{});var Hc=c(zo);Ra=r(Hc,"call"),Hc.forEach(o),Ba=r(Ln,"()"),Ln.forEach(o),Ha=r(be,`. Please refer to the doctsring of the above two
...
refer to the docstring of this method for more information.`),Ss.forEach(o),bs.forEach(o),ln=d(y),Te=n(y,"DIV",{class:!0});var ws=c(Te);u(nt.$$.fragment,ws),dn=d(ws),ct=n(ws,"P",{});var ys=c(ct);pn=r(ys,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Bt=n(ys,"A",{href:!0});var Qc=c(Bt);hn=r(Qc,"decode()"),Qc.forEach(o),fn=r(ys,`. Please refer
