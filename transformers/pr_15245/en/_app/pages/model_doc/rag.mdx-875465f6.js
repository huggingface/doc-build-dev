...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(h,"CODE",{});var R=a(u);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,u),e(u,f),e(p,x)},d(g){g&&n(p)}}}function vT($){let p,y,u,f,x,g,h,R,ti,La,$e,ot,Fr,St,oi,zr,ni,Oa,an,ri,Wa,nt,si,Dt,ai,di,Ha,dn,ii,Ba,cn,$r,ci,Qa,rt,li,It,pi,hi,Ua,Ee,st,Er,Lt,ui,jr,mi,Va,de,Ot,gi,me,ln,_i,fi,Gr,vi,bi,pn,Ti,wi,hn,ki,qi,yi,at,Wt,xi,Ht,Ri,un,Fi,zi,$i,dt,Bt,Ei,Qt,ji,mn,Gi,Mi,Ka,je,it,Mr,Ut,Ai,Ar,Ni,Ya,Ge,Vt,Pi,ct,Kt,Ci,Nr,Si,Ja,Me,lt,Pr,Yt,Di,Cr,Ii,Xa,Ae,Jt,Li,Sr,Oi,Za,Xt,Zt,ed,Ne,pt,Dr,eo,Wi,Ir,Hi,td,X,to,Bi,Lr,Qi,Ui,Or,Vi,Ki,oo,Yi,ht,no,Ji,Wr,Xi,Zi,ut,ro,ec,Pe,tc,Hr,oc,nc,Br,rc,sc,ac,mt,so,dc,ao,ic,Qr,cc,lc,od,Ce,gt,Ur,io,pc,Vr,hc,nd,D,co,uc,Se,mc,gn,gc,_c,Kr,fc,vc,bc,_t,Tc,Yr,wc,kc,ie,qc,Jr,yc,xc,_n,Rc,Fc,Xr,zc,$c,fn,Ec,jc,Gc,M,Mc,vn,Ac,Nc,Zr,Pc,Cc,es,Sc,Dc,ts,Ic,Lc,os,Oc,Wc,bn,Hc,Bc,ns,Qc,Uc,Tn,Vc,Kc,wn,Yc,Jc,rs,Xc,Zc,el,lo,tl,kn,ol,nl,rl,po,sl,ho,al,dl,il,ee,uo,cl,De,ll,qn,pl,hl,ss,ul,ml,gl,ft,_l,as,fl,vl,mo,rd,Ie,vt,ds,go,bl,is,Tl,sd,E,_o,wl,Le,kl,yn,ql,yl,cs,xl,Rl,Fl,bt,zl,ls,$l,El,ps,jl,Gl,ce,Ml,hs,Al,Nl,xn,Pl,Cl,us,Sl,Dl,Rn,Il,Ll,Ol,A,Wl,Fn,Hl,Bl,ms,Ql,Ul,gs,Vl,Kl,_s,Yl,Jl,fs,Xl,Zl,zn,ep,tp,vs,op,np,$n,rp,sp,En,ap,dp,bs,ip,cp,lp,fo,pp,jn,hp,up,mp,vo,gp,bo,_p,fp,vp,te,To,bp,Oe,Tp,Gn,wp,kp,Ts,qp,yp,xp,Tt,Rp,ws,Fp,zp,wo,$p,wt,ko,Ep,qo,jp,Mn,Gp,Mp,ad,We,kt,ks,yo,Ap,qs,Np,dd,j,xo,Pp,He,Cp,An,Sp,Dp,ys,Ip,Lp,Op,qt,Wp,xs,Hp,Bp,Rs,Qp,Up,le,Vp,Fs,Kp,Yp,Nn,Jp,Xp,zs,Zp,eh,Pn,th,oh,nh,N,rh,Cn,sh,ah,$s,dh,ih,Es,ch,lh,js,ph,hh,Gs,uh,mh,Sn,gh,_h,Ms,fh,vh,Dn,bh,Th,In,wh,kh,As,qh,yh,xh,Ro,Rh,Ln,Fh,zh,$h,Fo,Eh,zo,jh,Gh,Mh,oe,$o,Ah,Be,Nh,On,Ph,Ch,Ns,Sh,Dh,Ih,yt,Lh,Ps,Oh,Wh,Eo,Hh,xt,jo,Bh,Cs,Qh,id,Qe,Rt,Ss,Go,Uh,Ds,Vh,cd,P,Mo,Kh,Ue,Yh,Wn,Jh,Xh,Is,Zh,eu,tu,Ft,ou,Ls,nu,ru,pe,su,Os,au,du,Hn,iu,cu,Ws,lu,pu,Bn,hu,uu,mu,I,gu,Qn,_u,fu,Hs,vu,bu,Bs,Tu,wu,Qs,ku,qu,Us,yu,xu,Un,Ru,Fu,Vs,zu,$u,Vn,Eu,ju,Ks,Gu,Mu,Au,Ao,Nu,Kn,Pu,Cu,Su,No,Du,Po,Iu,Lu,Ou,Ys,Wu,Hu,ne,Co,Bu,Ve,Qu,Yn,Uu,Vu,Js,Ku,Yu,Ju,zt,Xu,Xs,Zu,em,So,ld,Ke,$t,Zs,Do,tm,ea,om,pd,F,Io,nm,Ye,rm,Jn,sm,am,ta,dm,im,cm,Et,lm,oa,pm,hm,na,um,mm,he,gm,ra,_m,fm,Xn,vm,bm,sa,Tm,wm,Zn,km,qm,ym,L,xm,er,Rm,Fm,aa,zm,$m,da,Em,jm,ia,Gm,Mm,ca,Am,Nm,tr,Pm,Cm,la,Sm,Dm,or,Im,Lm,pa,Om,Wm,Hm,Lo,Bm,nr,Qm,Um,Vm,Oo,Km,Wo,Ym,Jm,Xm,ha,Zm,eg,re,Ho,tg,Je,og,rr,ng,rg,ua,sg,ag,dg,jt,ig,ma,cg,lg,Bo,pg,Gt,Qo,hg,Uo,ug,sr,mg,gg,hd,Xe,Mt,ga,Vo,_g,_a,fg,ud,z,Ko,vg,Ze,bg,ar,Tg,wg,fa,kg,qg,yg,At,xg,va,Rg,Fg,ba,zg,$g,ue,Eg,Ta,jg,Gg,dr,Mg,Ag,wa,Ng,Pg,ir,Cg,Sg,Dg,O,Ig,cr,Lg,Og,ka,Wg,Hg,qa,Bg,Qg,ya,Ug,Vg,xa,Kg,Yg,lr,Jg,Xg,Ra,Zg,e_,pr,t_,o_,Fa,n_,r_,s_,Yo,a_,hr,d_,i_,c_,Jo,l_,Xo,p_,h_,u_,za,m_,g_,se,Zo,__,et,f_,ur,v_,b_,$a,T_,w_,k_,Nt,q_,Ea,y_,x_,en,R_,Pt,tn,F_,ja,z_,md;return g=new _e({}),St=new _e({}),Lt=new _e({}),Ot=new G({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15245/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_15245/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate)</code>
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/pr_15245/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],returnDescription:`
<p>The generated
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_15245/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
`}}),Vo=new _e({}),Ko=new G({props:{name:"class transformers.TFRagTokenForGeneration",anchor:"transformers.TFRagTokenForGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15245/src/transformers/models/rag/modeling_tf_rag.py#L752",parametersDescription:[{anchor:"transformers.TFRagTokenForGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_15245/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
...
due to the <code>eos_token_id</code>.</p>
`}}),{c(){p=r("meta"),y=c(),u=r("h1"),f=r("a"),x=r("span"),v(g.$$.fragment),h=c(),R=r("span"),ti=t("RAG"),La=c(),$e=r("h2"),ot=r("a"),Fr=r("span"),v(St.$$.fragment),oi=c(),zr=r("span"),ni=t("Overview"),Oa=c(),an=r("p"),ri=t(`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
...
parametric-only seq2seq baseline.`),Qa=c(),rt=r("p"),li=t("This model was contributed by "),It=r("a"),pi=t("ola13"),hi=t("."),Ua=c(),Ee=r("h2"),st=r("a"),Er=r("span"),v(Lt.$$.fragment),ui=c(),jr=r("span"),mi=t("RagConfig"),Va=c(),de=r("div"),v(Ot.$$.fragment),gi=c(),me=r("p"),ln=r("a"),_i=t("RagConfig"),fi=t(" stores the configuration of a "),Gr=r("em"),vi=t("RagModel"),bi=t(". Configuration objects inherit from "),pn=r("a"),Ti=t("PretrainedConfig"),wi=t(` and
...
decoder model configuration.`),$i=c(),dt=r("div"),v(Bt.$$.fragment),Ei=c(),Qt=r("p"),ji=t("Serializes this instance to a Python dictionary. Override the default "),mn=r("a"),Gi=t("to_dict()"),Mi=t("."),Ka=c(),je=r("h2"),it=r("a"),Mr=r("span"),v(Ut.$$.fragment),Ai=c(),Ar=r("span"),Ni=t("RagTokenizer"),Ya=c(),Ge=r("div"),v(Vt.$$.fragment),Pi=c(),ct=r("div"),v(Kt.$$.fragment),Ci=c(),Nr=r("p"),Si=t(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Ja=c(),Me=r("h2"),lt=r("a"),Pr=r("span"),v(Yt.$$.fragment),Di=c(),Cr=r("span"),Ii=t("Rag specific outputs"),Xa=c(),Ae=r("div"),v(Jt.$$.fragment),Li=c(),Sr=r("p"),Oi=t("Base class for retriever augmented marginalized models outputs."),Za=c(),Xt=r("div"),v(Zt.$$.fragment),ed=c(),Ne=r("h2"),pt=r("a"),Dr=r("span"),v(eo.$$.fragment),Wi=c(),Ir=r("span"),Hi=t("RagRetriever"),td=c(),X=r("div"),v(to.$$.fragment),Bi=c(),Lr=r("p"),Qi=t(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
any `),Xr=r("em"),zc=t("seq2seq"),$c=t(" model, preferably "),fn=r("a"),Ec=t("BartForConditionalGeneration"),jc=t("."),Gc=c(),M=r("p"),Mc=t("The model can be initialized with a "),vn=r("a"),Ac=t("RagRetriever"),Nc=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),Zr=r("em"),Pc=t("autoencoding"),Cc=t(" model as the "),es=r("code"),Sc=t("question_encoder"),Dc=t(" and any "),ts=r("em"),Ic=t("seq2seq"),Lc=t(" model with language model head as the "),os=r("code"),Oc=t("generator"),Wc=t(`.
...
and behavior.`),il=c(),ee=r("div"),v(uo.$$.fragment),cl=c(),De=r("p"),ll=t("The "),qn=r("a"),pl=t("RagModel"),hl=t(" forward method, overrides the "),ss=r("code"),ul=t("__call__"),ml=t(" special method."),gl=c(),v(ft.$$.fragment),_l=c(),as=r("p"),fl=t("Example:"),vl=c(),v(mo.$$.fragment),rd=c(),Ie=r("h2"),vt=r("a"),ds=r("span"),v(go.$$.fragment),bl=c(),is=r("span"),Tl=t("RagSequenceForGeneration"),sd=c(),E=r("div"),v(_o.$$.fragment),wl=c(),Le=r("p"),kl=t("The "),yn=r("a"),ql=t("RagSequenceForGeneration"),yl=t(" forward method, overrides the "),cs=r("code"),xl=t("__call__"),Rl=t(" special method."),Fl=c(),v(bt.$$.fragment),zl=c(),ls=r("p"),$l=t("A RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),El=c(),ps=r("p"),jl=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),Gl=c(),ce=r("p"),Ml=t("The question encoder can be any "),hs=r("em"),Al=t("autoencoding"),Nl=t(" model, preferably "),xn=r("a"),Pl=t("DPRQuestionEncoder"),Cl=t(`, and the generator can be
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vp=c(),te=r("div"),v(To.$$.fragment),bp=c(),Oe=r("p"),Tp=t("The "),Gn=r("a"),wp=t("RagSequenceForGeneration"),kp=t(" forward method, overrides the "),Ts=r("code"),qp=t("__call__"),yp=t(" special method."),xp=c(),v(Tt.$$.fragment),Rp=c(),ws=r("p"),Fp=t("Example:"),zp=c(),v(wo.$$.fragment),$p=c(),wt=r("div"),v(ko.$$.fragment),Ep=c(),qo=r("p"),jp=t("Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Mn=r("a"),Gp=t("generate()"),Mp=t("`\ndocumentation for more information on how to set other generate input parameters."),ad=c(),We=r("h2"),kt=r("a"),ks=r("span"),v(yo.$$.fragment),Ap=c(),qs=r("span"),Np=t("RagTokenForGeneration"),dd=c(),j=r("div"),v(xo.$$.fragment),Pp=c(),He=r("p"),Cp=t("The "),An=r("a"),Sp=t("RagTokenForGeneration"),Dp=t(" forward method, overrides the "),ys=r("code"),Ip=t("__call__"),Lp=t(" special method."),Op=c(),v(qt.$$.fragment),Wp=c(),xs=r("p"),Hp=t("A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Bp=c(),Rs=r("p"),Qp=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
`),In=r("a"),wh=t("T5ForConditionalGeneration"),kh=t(" as the "),As=r("code"),qh=t("generator"),yh=t("."),xh=c(),Ro=r("p"),Rh=t("This model inherits from "),Ln=r("a"),Fh=t("PreTrainedModel"),zh=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$h=c(),Fo=r("p"),Eh=t("This model is also a PyTorch "),zo=r("a"),jh=t("torch.nn.Module"),Gh=t(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mh=c(),oe=r("div"),v($o.$$.fragment),Ah=c(),Be=r("p"),Nh=t("The "),On=r("a"),Ph=t("RagTokenForGeneration"),Ch=t(" forward method, overrides the "),Ns=r("code"),Sh=t("__call__"),Dh=t(" special method."),Ih=c(),v(yt.$$.fragment),Lh=c(),Ps=r("p"),Oh=t("Example:"),Wh=c(),v(Eo.$$.fragment),Hh=c(),xt=r("div"),v(jo.$$.fragment),Bh=c(),Cs=r("p"),Qh=t("Implements RAG token decoding."),id=c(),Qe=r("h2"),Rt=r("a"),Ss=r("span"),v(Go.$$.fragment),Uh=c(),Ds=r("span"),Vh=t("TFRagModel"),cd=c(),P=r("div"),v(Mo.$$.fragment),Kh=c(),Ue=r("p"),Yh=t("The "),Wn=r("a"),Jh=t("TFRagModel"),Xh=t(" forward method, overrides the "),Is=r("code"),Zh=t("__call__"),eu=t(" special method."),tu=c(),v(Ft.$$.fragment),ou=c(),Ls=r("p"),nu=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
any `),Ws=r("em"),lu=t("seq2seq"),pu=t(" model, preferably "),Bn=r("a"),hu=t("TFBartForConditionalGeneration"),uu=t("."),mu=c(),I=r("p"),gu=t("The model can be initialized with a "),Qn=r("a"),_u=t("RagRetriever"),fu=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
as the `),Ks=r("code"),Gu=t("generator"),Mu=t("."),Au=c(),Ao=r("p"),Nu=t("This model inherits from "),Kn=r("a"),Pu=t("TFPreTrainedModel"),Cu=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Su=c(),No=r("p"),Du=t("This model is also a Tensorflow "),Po=r("a"),Iu=t("tf.keras.Model"),Lu=t(`
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),aa=r("em"),zm=t("autoencoding"),$m=t(" model as the "),da=r("code"),Em=t("question_encoder"),jm=t(" and any "),ia=r("em"),Gm=t("seq2seq"),Mm=t(" model with language model head as the "),ca=r("code"),Am=t("generator"),Nm=t(`.
It has been tested with `),tr=r("a"),Pm=t("TFDPRQuestionEncoder"),Cm=t(" as the "),la=r("code"),Sm=t("question_encoder"),Dm=t(" and "),or=r("a"),Im=t("TFBartForConditionalGeneration"),Lm=t(`
as the `),pa=r("code"),Om=t("generator"),Wm=t("."),Hm=c(),Lo=r("p"),Bm=t("This model inherits from "),nr=r("a"),Qm=t("TFPreTrainedModel"),Um=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
any `),wa=r("em"),Ng=t("seq2seq"),Pg=t(" model, preferably "),ir=r("a"),Cg=t("TFBartForConditionalGeneration"),Sg=t("."),Dg=c(),O=r("p"),Ig=t("The model can be initialized with a "),cr=r("a"),Lg=t("RagRetriever"),Og=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
outperforming parametric seq2seq models and task-specific retrieve-and-extract architectures. For language generation
tasks, we find that RAG models generate more specific, diverse and factual language than a state-of-the-art
parametric-only seq2seq baseline.`),E_.forEach(n),$_.forEach(n),Qa=l(d),rt=s(d,"P",{});var gd=a(rt);li=o(gd,"This model was contributed by "),It=s(gd,"A",{href:!0,rel:!0});var j_=a(It);pi=o(j_,"ola13"),j_.forEach(n),hi=o(gd,"."),gd.forEach(n),Ua=l(d),Ee=s(d,"H2",{class:!0});var _d=a(Ee);st=s(_d,"A",{id:!0,class:!0,href:!0});var G_=a(st);Er=s(G_,"SPAN",{});var M_=a(Er);b(Lt.$$.fragment,M_),M_.forEach(n),G_.forEach(n),ui=l(_d),jr=s(_d,"SPAN",{});var A_=a(jr);mi=o(A_,"RagConfig"),A_.forEach(n),_d.forEach(n),Va=l(d),de=s(d,"DIV",{class:!0});var Ct=a(de);b(Ot.$$.fragment,Ct),gi=l(Ct),me=s(Ct,"P",{});var tt=a(me);ln=s(tt,"A",{href:!0});var N_=a(ln);_i=o(N_,"RagConfig"),N_.forEach(n),fi=o(tt," stores the configuration of a "),Gr=s(tt,"EM",{});var P_=a(Gr);vi=o(P_,"RagModel"),P_.forEach(n),bi=o(tt,". Configuration objects inherit from "),pn=s(tt,"A",{href:!0});var C_=a(pn);Ti=o(C_,"PretrainedConfig"),C_.forEach(n),wi=o(tt,` and
...
any `),Xr=s(fe,"EM",{});var mf=a(Xr);zc=o(mf,"seq2seq"),mf.forEach(n),$c=o(fe," model, preferably "),fn=s(fe,"A",{href:!0});var gf=a(fn);Ec=o(gf,"BartForConditionalGeneration"),gf.forEach(n),jc=o(fe,"."),fe.forEach(n),Gc=l(Z),M=s(Z,"P",{});var W=a(M);Mc=o(W,"The model can be initialized with a "),vn=s(W,"A",{href:!0});var _f=a(vn);Ac=o(_f,"RagRetriever"),_f.forEach(n),Nc=o(W,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),$s=s(U,"EM",{});var _v=a($s);dh=o(_v,"autoencoding"),_v.forEach(n),ih=o(U," model as the "),Es=s(U,"CODE",{});var fv=a(Es);ch=o(fv,"question_encoder"),fv.forEach(n),lh=o(U," and any "),js=s(U,"EM",{});var vv=a(js);ph=o(vv,"seq2seq"),vv.forEach(n),hh=o(U," model with language model head as the "),Gs=s(U,"CODE",{});var bv=a(Gs);uh=o(bv,"generator"),bv.forEach(n),mh=o(U,`.
It has been tested with `),Sn=s(U,"A",{href:!0});var Tv=a(Sn);gh=o(Tv,"DPRQuestionEncoder"),Tv.forEach(n),_h=o(U," as the "),Ms=s(U,"CODE",{});var wv=a(Ms);fh=o(wv,"question_encoder"),wv.forEach(n),vh=o(U," and "),Dn=s(U,"A",{href:!0});var kv=a(Dn);bh=o(kv,"BartForConditionalGeneration"),kv.forEach(n),Th=o(U,` or
`),In=s(U,"A",{href:!0});var qv=a(In);wh=o(qv,"T5ForConditionalGeneration"),qv.forEach(n),kh=o(U," as the "),As=s(U,"CODE",{});var yv=a(As);qh=o(yv,"generator"),yv.forEach(n),yh=o(U,"."),U.forEach(n),xh=l(Q),Ro=s(Q,"P",{});var Id=a(Ro);Rh=o(Id,"This model inherits from "),Ln=s(Id,"A",{href:!0});var xv=a(Ln);Fh=o(xv,"PreTrainedModel"),xv.forEach(n),zh=o(Id,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Id.forEach(n),$h=l(Q),Fo=s(Q,"P",{});var Ld=a(Fo);Eh=o(Ld,"This model is also a PyTorch "),zo=s(Ld,"A",{href:!0,rel:!0});var Rv=a(zo);jh=o(Rv,"torch.nn.Module"),Rv.forEach(n),Gh=o(Ld,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld.forEach(n),Mh=l(Q),oe=s(Q,"DIV",{class:!0});var ke=a(oe);b($o.$$.fragment,ke),Ah=l(ke),Be=s(ke,"P",{});var Tr=a(Be);Nh=o(Tr,"The "),On=s(Tr,"A",{href:!0});var Fv=a(On);Ph=o(Fv,"RagTokenForGeneration"),Fv.forEach(n),Ch=o(Tr," forward method, overrides the "),Ns=s(Tr,"CODE",{});var zv=a(Ns);Sh=o(zv,"__call__"),zv.forEach(n),Dh=o(Tr," special method."),Tr.forEach(n),Ih=l(ke),b(yt.$$.fragment,ke),Lh=l(ke),Ps=s(ke,"P",{});var $v=a(Ps);Oh=o($v,"Example:"),$v.forEach(n),Wh=l(ke),b(Eo.$$.fragment,ke),ke.forEach(n),Hh=l(Q),xt=s(Q,"DIV",{class:!0});var Od=a(xt);b(jo.$$.fragment,Od),Bh=l(Od),Cs=s(Od,"P",{});var Ev=a(Cs);Qh=o(Ev,"Implements RAG token decoding."),Ev.forEach(n),Od.forEach(n),Q.forEach(n),id=l(d),Qe=s(d,"H2",{class:!0});var Wd=a(Qe);Rt=s(Wd,"A",{id:!0,class:!0,href:!0});var jv=a(Rt);Ss=s(jv,"SPAN",{});var Gv=a(Ss);b(Go.$$.fragment,Gv),Gv.forEach(n),jv.forEach(n),Uh=l(Wd),Ds=s(Wd,"SPAN",{});var Mv=a(Ds);Vh=o(Mv,"TFRagModel"),Mv.forEach(n),Wd.forEach(n),cd=l(d),P=s(d,"DIV",{class:!0});var V=a(P);b(Mo.$$.fragment,V),Kh=l(V),Ue=s(V,"P",{});var wr=a(Ue);Yh=o(wr,"The "),Wn=s(wr,"A",{href:!0});var Av=a(Wn);Jh=o(Av,"TFRagModel"),Av.forEach(n),Xh=o(wr," forward method, overrides the "),Is=s(wr,"CODE",{});var Nv=a(Is);Zh=o(Nv,"__call__"),Nv.forEach(n),eu=o(wr," special method."),wr.forEach(n),tu=l(V),b(Ft.$$.fragment,V),ou=l(V),Ls=s(V,"P",{});var Pv=a(Ls);nu=o(Pv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
...
any `),Ws=s(qe,"EM",{});var Dv=a(Ws);lu=o(Dv,"seq2seq"),Dv.forEach(n),pu=o(qe," model, preferably "),Bn=s(qe,"A",{href:!0});var Iv=a(Bn);hu=o(Iv,"TFBartForConditionalGeneration"),Iv.forEach(n),uu=o(qe,"."),qe.forEach(n),mu=l(V),I=s(V,"P",{});var K=a(I);gu=o(K,"The model can be initialized with a "),Qn=s(K,"A",{href:!0});var Lv=a(Qn);_u=o(Lv,"RagRetriever"),Lv.forEach(n),fu=o(K,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
as the `),Ks=s(K,"CODE",{});var Kv=a(Ks);Gu=o(Kv,"generator"),Kv.forEach(n),Mu=o(K,"."),K.forEach(n),Au=l(V),Ao=s(V,"P",{});var Hd=a(Ao);Nu=o(Hd,"This model inherits from "),Kn=s(Hd,"A",{href:!0});var Yv=a(Kn);Pu=o(Yv,"TFPreTrainedModel"),Yv.forEach(n),Cu=o(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(n),Su=l(V),No=s(V,"P",{});var Bd=a(No);Du=o(Bd,"This model is also a Tensorflow "),Po=s(Bd,"A",{href:!0,rel:!0});var Jv=a(Po);Iu=o(Jv,"tf.keras.Model"),Jv.forEach(n),Lu=o(Bd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
It has been tested with `),tr=s(Y,"A",{href:!0});var vb=a(tr);Pm=o(vb,"TFDPRQuestionEncoder"),vb.forEach(n),Cm=o(Y," as the "),la=s(Y,"CODE",{});var bb=a(la);Sm=o(bb,"question_encoder"),bb.forEach(n),Dm=o(Y," and "),or=s(Y,"A",{href:!0});var Tb=a(or);Im=o(Tb,"TFBartForConditionalGeneration"),Tb.forEach(n),Lm=o(Y,`
as the `),pa=s(Y,"CODE",{});var wb=a(pa);Om=o(wb,"generator"),wb.forEach(n),Wm=o(Y,"."),Y.forEach(n),Hm=l(C),Lo=s(C,"P",{});var Ud=a(Lo);Bm=o(Ud,"This model inherits from "),nr=s(Ud,"A",{href:!0});var kb=a(nr);Qm=o(kb,"TFPreTrainedModel"),kb.forEach(n),Um=o(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
SavedModel format.`),yb.forEach(n),eg=l(C),re=s(C,"DIV",{class:!0});var Re=a(re);b(Ho.$$.fragment,Re),tg=l(Re),Je=s(Re,"P",{});var yr=a(Je);og=o(yr,"The "),rr=s(yr,"A",{href:!0});var xb=a(rr);ng=o(xb,"TFRagSequenceForGeneration"),xb.forEach(n),rg=o(yr," forward method, overrides the "),ua=s(yr,"CODE",{});var Rb=a(ua);sg=o(Rb,"__call__"),Rb.forEach(n),ag=o(yr," special method."),yr.forEach(n),dg=l(Re),b(jt.$$.fragment,Re),ig=l(Re),ma=s(Re,"P",{});var Fb=a(ma);cg=o(Fb,"Example:"),Fb.forEach(n),lg=l(Re),b(Bo.$$.fragment,Re),Re.forEach(n),pg=l(C),Gt=s(C,"DIV",{class:!0});var Kd=a(Gt);b(Qo.$$.fragment,Kd),hg=l(Kd),Uo=s(Kd,"P",{});var Yd=a(Uo);ug=o(Yd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),sr=s(Yd,"A",{href:!0});var zb=a(sr);mg=o(zb,"generate()"),zb.forEach(n),gg=o(Yd,"`\ndocumentation for more information on how to set other generate input parameters"),Yd.forEach(n),Kd.forEach(n),C.forEach(n),hd=l(d),Xe=s(d,"H2",{class:!0});var Jd=a(Xe);Mt=s(Jd,"A",{id:!0,class:!0,href:!0});var $b=a(Mt);ga=s($b,"SPAN",{});var Eb=a(ga);b(Vo.$$.fragment,Eb),Eb.forEach(n),$b.forEach(n),_g=l(Jd),_a=s(Jd,"SPAN",{});var jb=a(_a);fg=o(jb,"TFRagTokenForGeneration"),jb.forEach(n),Jd.forEach(n),ud=l(d),z=s(d,"DIV",{class:!0});var S=a(z);b(Ko.$$.fragment,S),vg=l(S),Ze=s(S,"P",{});var xr=a(Ze);bg=o(xr,"The "),ar=s(xr,"A",{href:!0});var Gb=a(ar);Tg=o(Gb,"TFRagTokenForGeneration"),Gb.forEach(n),wg=o(xr," forward method, overrides the "),fa=s(xr,"CODE",{});var Mb=a(fa);kg=o(Mb,"__call__"),Mb.forEach(n),qg=o(xr," special method."),xr.forEach(n),yg=l(S),b(At.$$.fragment,S),xg=l(S),va=s(S,"P",{});var Ab=a(va);Rg=o(Ab,"A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Ab.forEach(n),Fg=l(S),ba=s(S,"P",{});var Nb=a(ba);zg=o(Nb,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Nb.forEach(n),$g=l(S),ue=s(S,"P",{});var Fe=a(ue);Eg=o(Fe,"The question encoder can be any "),Ta=s(Fe,"EM",{});var Pb=a(Ta);jg=o(Pb,"autoencoding"),Pb.forEach(n),Gg=o(Fe," model, preferably "),dr=s(Fe,"A",{href:!0});var Cb=a(dr);Mg=o(Cb,"TFDPRQuestionEncoder"),Cb.forEach(n),Ag=o(Fe,`, and the generator can be
any `),wa=s(Fe,"EM",{});var Sb=a(wa);Ng=o(Sb,"seq2seq"),Sb.forEach(n),Pg=o(Fe," model, preferably "),ir=s(Fe,"A",{href:!0});var Db=a(ir);Cg=o(Db,"TFBartForConditionalGeneration"),Db.forEach(n),Sg=o(Fe,"."),Fe.forEach(n),Dg=l(S),O=s(S,"P",{});var J=a(O);Ig=o(J,"The model can be initialized with a "),cr=s(J,"A",{href:!0});var Ib=a(cr);Lg=o(Ib,"RagRetriever"),Ib.forEach(n),Og=o(J,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
