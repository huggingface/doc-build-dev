import{S as oT,i as nT,s as rT,e as r,k as c,w as v,t,M as sT,c as s,d as n,m as l,a,x as b,h as o,b as i,F as e,g as _,y as T,q as w,o as k,B as q}from"../../chunks/vendor-4833417e.js";import{T as ge}from"../../chunks/Tip-fffd6df1.js";import{D as G}from"../../chunks/Docstring-4f315ed9.js";import{C as sn}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as _e}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function aT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function dT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function iT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function cT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function lT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function pT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function hT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function mT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function uT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function gT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function _T($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function fT($){let p,y,m,f,x;return{c(){p=r("p"),y=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r("code"),f=t("Module"),x=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var h=a(p);y=o(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(n)},m(g,h){_(g,p,h),e(p,y),e(p,m),e(m,f),e(p,x)},d(g){g&&n(p)}}}function vT($){let p,y,m,f,x,g,h,R,ti,La,$e,ot,Fr,St,oi,zr,ni,Oa,an,ri,Wa,nt,si,Dt,ai,di,Ha,dn,ii,Ba,cn,$r,ci,Qa,rt,li,It,pi,hi,Ua,Ee,st,Er,Lt,mi,jr,ui,Va,de,Ot,gi,ue,ln,_i,fi,Gr,vi,bi,pn,Ti,wi,hn,ki,qi,yi,at,Wt,xi,Ht,Ri,mn,Fi,zi,$i,dt,Bt,Ei,Qt,ji,un,Gi,Mi,Ka,je,it,Mr,Ut,Ai,Ar,Ni,Ya,Ge,Vt,Pi,ct,Kt,Ci,Nr,Si,Ja,Me,lt,Pr,Yt,Di,Cr,Ii,Xa,Ae,Jt,Li,Sr,Oi,Za,Xt,Zt,ed,Ne,pt,Dr,eo,Wi,Ir,Hi,td,X,to,Bi,Lr,Qi,Ui,Or,Vi,Ki,oo,Yi,ht,no,Ji,Wr,Xi,Zi,mt,ro,ec,Pe,tc,Hr,oc,nc,Br,rc,sc,ac,ut,so,dc,ao,ic,Qr,cc,lc,od,Ce,gt,Ur,io,pc,Vr,hc,nd,D,co,mc,Se,uc,gn,gc,_c,Kr,fc,vc,bc,_t,Tc,Yr,wc,kc,ie,qc,Jr,yc,xc,_n,Rc,Fc,Xr,zc,$c,fn,Ec,jc,Gc,M,Mc,vn,Ac,Nc,Zr,Pc,Cc,es,Sc,Dc,ts,Ic,Lc,os,Oc,Wc,bn,Hc,Bc,ns,Qc,Uc,Tn,Vc,Kc,wn,Yc,Jc,rs,Xc,Zc,el,lo,tl,kn,ol,nl,rl,po,sl,ho,al,dl,il,ee,mo,cl,De,ll,qn,pl,hl,ss,ml,ul,gl,ft,_l,as,fl,vl,uo,rd,Ie,vt,ds,go,bl,is,Tl,sd,E,_o,wl,Le,kl,yn,ql,yl,cs,xl,Rl,Fl,bt,zl,ls,$l,El,ps,jl,Gl,ce,Ml,hs,Al,Nl,xn,Pl,Cl,ms,Sl,Dl,Rn,Il,Ll,Ol,A,Wl,Fn,Hl,Bl,us,Ql,Ul,gs,Vl,Kl,_s,Yl,Jl,fs,Xl,Zl,zn,ep,tp,vs,op,np,$n,rp,sp,En,ap,dp,bs,ip,cp,lp,fo,pp,jn,hp,mp,up,vo,gp,bo,_p,fp,vp,te,To,bp,Oe,Tp,Gn,wp,kp,Ts,qp,yp,xp,Tt,Rp,ws,Fp,zp,wo,$p,wt,ko,Ep,qo,jp,Mn,Gp,Mp,ad,We,kt,ks,yo,Ap,qs,Np,dd,j,xo,Pp,He,Cp,An,Sp,Dp,ys,Ip,Lp,Op,qt,Wp,xs,Hp,Bp,Rs,Qp,Up,le,Vp,Fs,Kp,Yp,Nn,Jp,Xp,zs,Zp,eh,Pn,th,oh,nh,N,rh,Cn,sh,ah,$s,dh,ih,Es,ch,lh,js,ph,hh,Gs,mh,uh,Sn,gh,_h,Ms,fh,vh,Dn,bh,Th,In,wh,kh,As,qh,yh,xh,Ro,Rh,Ln,Fh,zh,$h,Fo,Eh,zo,jh,Gh,Mh,oe,$o,Ah,Be,Nh,On,Ph,Ch,Ns,Sh,Dh,Ih,yt,Lh,Ps,Oh,Wh,Eo,Hh,xt,jo,Bh,Cs,Qh,id,Qe,Rt,Ss,Go,Uh,Ds,Vh,cd,P,Mo,Kh,Ue,Yh,Wn,Jh,Xh,Is,Zh,em,tm,Ft,om,Ls,nm,rm,pe,sm,Os,am,dm,Hn,im,cm,Ws,lm,pm,Bn,hm,mm,um,I,gm,Qn,_m,fm,Hs,vm,bm,Bs,Tm,wm,Qs,km,qm,Us,ym,xm,Un,Rm,Fm,Vs,zm,$m,Vn,Em,jm,Ks,Gm,Mm,Am,Ao,Nm,Kn,Pm,Cm,Sm,No,Dm,Po,Im,Lm,Om,Ys,Wm,Hm,ne,Co,Bm,Ve,Qm,Yn,Um,Vm,Js,Km,Ym,Jm,zt,Xm,Xs,Zm,eu,So,ld,Ke,$t,Zs,Do,tu,ea,ou,pd,F,Io,nu,Ye,ru,Jn,su,au,ta,du,iu,cu,Et,lu,oa,pu,hu,na,mu,uu,he,gu,ra,_u,fu,Xn,vu,bu,sa,Tu,wu,Zn,ku,qu,yu,L,xu,er,Ru,Fu,aa,zu,$u,da,Eu,ju,ia,Gu,Mu,ca,Au,Nu,tr,Pu,Cu,la,Su,Du,or,Iu,Lu,pa,Ou,Wu,Hu,Lo,Bu,nr,Qu,Uu,Vu,Oo,Ku,Wo,Yu,Ju,Xu,ha,Zu,eg,re,Ho,tg,Je,og,rr,ng,rg,ma,sg,ag,dg,jt,ig,ua,cg,lg,Bo,pg,Gt,Qo,hg,Uo,mg,sr,ug,gg,hd,Xe,Mt,ga,Vo,_g,_a,fg,md,z,Ko,vg,Ze,bg,ar,Tg,wg,fa,kg,qg,yg,At,xg,va,Rg,Fg,ba,zg,$g,me,Eg,Ta,jg,Gg,dr,Mg,Ag,wa,Ng,Pg,ir,Cg,Sg,Dg,O,Ig,cr,Lg,Og,ka,Wg,Hg,qa,Bg,Qg,ya,Ug,Vg,xa,Kg,Yg,lr,Jg,Xg,Ra,Zg,e_,pr,t_,o_,Fa,n_,r_,s_,Yo,a_,hr,d_,i_,c_,Jo,l_,Xo,p_,h_,m_,za,u_,g_,se,Zo,__,et,f_,mr,v_,b_,$a,T_,w_,k_,Nt,q_,Ea,y_,x_,en,R_,Pt,tn,F_,ja,z_,ud;return g=new _e({}),St=new _e({}),Lt=new _e({}),Ot=new G({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/pr_15245/src/transformers/models/rag/configuration_rag.py#L82",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
due to the <code>eos_token_id</code>.</p>
`}}),{c(){p=r("meta"),y=c(),m=r("h1"),f=r("a"),x=r("span"),v(g.$$.fragment),h=c(),R=r("span"),ti=t("RAG"),La=c(),$e=r("h2"),ot=r("a"),Fr=r("span"),v(St.$$.fragment),oi=c(),zr=r("span"),ni=t("Overview"),Oa=c(),an=r("p"),ri=t(`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
...
parametric-only seq2seq baseline.`),Qa=c(),rt=r("p"),li=t("This model was contributed by "),It=r("a"),pi=t("ola13"),hi=t("."),Ua=c(),Ee=r("h2"),st=r("a"),Er=r("span"),v(Lt.$$.fragment),mi=c(),jr=r("span"),ui=t("RagConfig"),Va=c(),de=r("div"),v(Ot.$$.fragment),gi=c(),ue=r("p"),ln=r("a"),_i=t("RagConfig"),fi=t(" stores the configuration of a "),Gr=r("em"),vi=t("RagModel"),bi=t(". Configuration objects inherit from "),pn=r("a"),Ti=t("PretrainedConfig"),wi=t(` and
can be used to control the model outputs. Read the documentation from `),hn=r("a"),ki=t("PretrainedConfig"),qi=t(" for more information."),yi=c(),at=r("div"),v(Wt.$$.fragment),xi=c(),Ht=r("p"),Ri=t("Instantiate a "),mn=r("a"),Fi=t("EncoderDecoderConfig"),zi=t(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),$i=c(),dt=r("div"),v(Bt.$$.fragment),Ei=c(),Qt=r("p"),ji=t("Serializes this instance to a Python dictionary. Override the default "),un=r("a"),Gi=t("to_dict()"),Mi=t("."),Ka=c(),je=r("h2"),it=r("a"),Mr=r("span"),v(Ut.$$.fragment),Ai=c(),Ar=r("span"),Ni=t("RagTokenizer"),Ya=c(),Ge=r("div"),v(Vt.$$.fragment),Pi=c(),ct=r("div"),v(Kt.$$.fragment),Ci=c(),Nr=r("p"),Si=t(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),$s=r("em"),dh=t("autoencoding"),ih=t(" model as the "),Es=r("code"),ch=t("question_encoder"),lh=t(" and any "),js=r("em"),ph=t("seq2seq"),hh=t(" model with language model head as the "),Gs=r("code"),mh=t("generator"),uh=t(`.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mh=c(),oe=r("div"),v($o.$$.fragment),Ah=c(),Be=r("p"),Nh=t("The "),On=r("a"),Ph=t("RagTokenForGeneration"),Ch=t(" forward method, overrides the "),Ns=r("code"),Sh=t("__call__"),Dh=t(" special method."),Ih=c(),v(yt.$$.fragment),Lh=c(),Ps=r("p"),Oh=t("Example:"),Wh=c(),v(Eo.$$.fragment),Hh=c(),xt=r("div"),v(jo.$$.fragment),Bh=c(),Cs=r("p"),Qh=t("Implements RAG token decoding."),id=c(),Qe=r("h2"),Rt=r("a"),Ss=r("span"),v(Go.$$.fragment),Uh=c(),Ds=r("span"),Vh=t("TFRagModel"),cd=c(),P=r("div"),v(Mo.$$.fragment),Kh=c(),Ue=r("p"),Yh=t("The "),Wn=r("a"),Jh=t("TFRagModel"),Xh=t(" forward method, overrides the "),Is=r("code"),Zh=t("__call__"),em=t(" special method."),tm=c(),v(Ft.$$.fragment),om=c(),Ls=r("p"),nm=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
the generator.`),rm=c(),pe=r("p"),sm=t("The question encoder can be any "),Os=r("em"),am=t("autoencoding"),dm=t(" model, preferably "),Hn=r("a"),im=t("TFDPRQuestionEncoder"),cm=t(`, and the generator can be
any `),Ws=r("em"),lm=t("seq2seq"),pm=t(" model, preferably "),Bn=r("a"),hm=t("TFBartForConditionalGeneration"),mm=t("."),um=c(),I=r("p"),gm=t("The model can be initialized with a "),Qn=r("a"),_m=t("RagRetriever"),fm=t(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
as the `),Ks=r("code"),Gm=t("generator"),Mm=t("."),Am=c(),Ao=r("p"),Nm=t("This model inherits from "),Kn=r("a"),Pm=t("TFPreTrainedModel"),Cm=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sm=c(),No=r("p"),Dm=t("This model is also a Tensorflow "),Po=r("a"),Im=t("tf.keras.Model"),Lm=t(`
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),aa=r("em"),zu=t("autoencoding"),$u=t(" model as the "),da=r("code"),Eu=t("question_encoder"),ju=t(" and any "),ia=r("em"),Gu=t("seq2seq"),Mu=t(" model with language model head as the "),ca=r("code"),Au=t("generator"),Nu=t(`.
It has been tested with `),tr=r("a"),Pu=t("TFDPRQuestionEncoder"),Cu=t(" as the "),la=r("code"),Su=t("question_encoder"),Du=t(" and "),or=r("a"),Iu=t("TFBartForConditionalGeneration"),Lu=t(`
as the `),pa=r("code"),Ou=t("generator"),Wu=t("."),Hu=c(),Lo=r("p"),Bu=t("This model inherits from "),nr=r("a"),Qu=t("TFPreTrainedModel"),Uu=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
outperforming parametric seq2seq models and task-specific retrieve-and-extract architectures. For language generation
tasks, we find that RAG models generate more specific, diverse and factual language than a state-of-the-art
parametric-only seq2seq baseline.`),E_.forEach(n),$_.forEach(n),Qa=l(d),rt=s(d,"P",{});var gd=a(rt);li=o(gd,"This model was contributed by "),It=s(gd,"A",{href:!0,rel:!0});var j_=a(It);pi=o(j_,"ola13"),j_.forEach(n),hi=o(gd,"."),gd.forEach(n),Ua=l(d),Ee=s(d,"H2",{class:!0});var _d=a(Ee);st=s(_d,"A",{id:!0,class:!0,href:!0});var G_=a(st);Er=s(G_,"SPAN",{});var M_=a(Er);b(Lt.$$.fragment,M_),M_.forEach(n),G_.forEach(n),mi=l(_d),jr=s(_d,"SPAN",{});var A_=a(jr);ui=o(A_,"RagConfig"),A_.forEach(n),_d.forEach(n),Va=l(d),de=s(d,"DIV",{class:!0});var Ct=a(de);b(Ot.$$.fragment,Ct),gi=l(Ct),ue=s(Ct,"P",{});var tt=a(ue);ln=s(tt,"A",{href:!0});var N_=a(ln);_i=o(N_,"RagConfig"),N_.forEach(n),fi=o(tt," stores the configuration of a "),Gr=s(tt,"EM",{});var P_=a(Gr);vi=o(P_,"RagModel"),P_.forEach(n),bi=o(tt,". Configuration objects inherit from "),pn=s(tt,"A",{href:!0});var C_=a(pn);Ti=o(C_,"PretrainedConfig"),C_.forEach(n),wi=o(tt,` and
...
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),pf.forEach(n),kc=l(Z),ie=s(Z,"P",{});var fe=a(ie);qc=o(fe,"The question encoder can be any "),Jr=s(fe,"EM",{});var hf=a(Jr);yc=o(hf,"autoencoding"),hf.forEach(n),xc=o(fe," model, preferably "),_n=s(fe,"A",{href:!0});var mf=a(_n);Rc=o(mf,"DPRQuestionEncoder"),mf.forEach(n),Fc=o(fe,`, and the generator can be
any `),Xr=s(fe,"EM",{});var uf=a(Xr);zc=o(uf,"seq2seq"),uf.forEach(n),$c=o(fe," model, preferably "),fn=s(fe,"A",{href:!0});var gf=a(fn);Ec=o(gf,"BartForConditionalGeneration"),gf.forEach(n),jc=o(fe,"."),fe.forEach(n),Gc=l(Z),M=s(Z,"P",{});var W=a(M);Mc=o(W,"The model can be initialized with a "),vn=s(W,"A",{href:!0});var _f=a(vn);Ac=o(_f,"RagRetriever"),_f.forEach(n),Nc=o(W,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
`),En=s(B,"A",{href:!0});var Yf=a(En);ap=o(Yf,"T5ForConditionalGeneration"),Yf.forEach(n),dp=o(B," as the "),bs=s(B,"CODE",{});var Jf=a(bs);ip=o(Jf,"generator"),Jf.forEach(n),cp=o(B,"."),B.forEach(n),lp=l(H),fo=s(H,"P",{});var Nd=a(fo);pp=o(Nd,"This model inherits from "),jn=s(Nd,"A",{href:!0});var Xf=a(jn);hp=o(Xf,"PreTrainedModel"),Xf.forEach(n),mp=o(Nd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nd.forEach(n),up=l(H),vo=s(H,"P",{});var Pd=a(vo);gp=o(Pd,"This model is also a PyTorch "),bo=s(Pd,"A",{href:!0,rel:!0});var Zf=a(bo);_p=o(Zf,"torch.nn.Module"),Zf.forEach(n),fp=o(Pd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
any `),zs=s(we,"EM",{});var mv=a(zs);Zp=o(mv,"seq2seq"),mv.forEach(n),eh=o(we," model, preferably "),Pn=s(we,"A",{href:!0});var uv=a(Pn);th=o(uv,"BartForConditionalGeneration"),uv.forEach(n),oh=o(we,"."),we.forEach(n),nh=l(Q),N=s(Q,"P",{});var U=a(N);rh=o(U,"The model can be initialized with a "),Cn=s(U,"A",{href:!0});var gv=a(Cn);sh=o(gv,"RagRetriever"),gv.forEach(n),ah=o(U,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),$s=s(U,"EM",{});var _v=a($s);dh=o(_v,"autoencoding"),_v.forEach(n),ih=o(U," model as the "),Es=s(U,"CODE",{});var fv=a(Es);ch=o(fv,"question_encoder"),fv.forEach(n),lh=o(U," and any "),js=s(U,"EM",{});var vv=a(js);ph=o(vv,"seq2seq"),vv.forEach(n),hh=o(U," model with language model head as the "),Gs=s(U,"CODE",{});var bv=a(Gs);mh=o(bv,"generator"),bv.forEach(n),uh=o(U,`.
...
as the `),Ks=s(K,"CODE",{});var Kv=a(Ks);Gm=o(Kv,"generator"),Kv.forEach(n),Mm=o(K,"."),K.forEach(n),Am=l(V),Ao=s(V,"P",{});var Hd=a(Ao);Nm=o(Hd,"This model inherits from "),Kn=s(Hd,"A",{href:!0});var Yv=a(Kn);Pm=o(Yv,"TFPreTrainedModel"),Yv.forEach(n),Cm=o(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(n),Sm=l(V),No=s(V,"P",{});var Bd=a(No);Dm=o(Bd,"This model is also a Tensorflow "),Po=s(Bd,"A",{href:!0,rel:!0});var Jv=a(Po);Im=o(Jv,"tf.keras.Model"),Jv.forEach(n),Lm=o(Bd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
SavedModel format.`),Xv.forEach(n),Hm=l(V),ne=s(V,"DIV",{class:!0});var ye=a(ne);b(Co.$$.fragment,ye),Bm=l(ye),Ve=s(ye,"P",{});var kr=a(Ve);Qm=o(kr,"The "),Yn=s(kr,"A",{href:!0});var Zv=a(Yn);Um=o(Zv,"TFRagModel"),Zv.forEach(n),Vm=o(kr," forward method, overrides the "),Js=s(kr,"CODE",{});var eb=a(Js);Km=o(eb,"__call__"),eb.forEach(n),Ym=o(kr," special method."),kr.forEach(n),Jm=l(ye),b(zt.$$.fragment,ye),Xm=l(ye),Xs=s(ye,"P",{});var tb=a(Xs);Zm=o(tb,"Example:"),tb.forEach(n),eu=l(ye),b(So.$$.fragment,ye),ye.forEach(n),V.forEach(n),ld=l(d),Ke=s(d,"H2",{class:!0});var Qd=a(Ke);$t=s(Qd,"A",{id:!0,class:!0,href:!0});var ob=a($t);Zs=s(ob,"SPAN",{});var nb=a(Zs);b(Do.$$.fragment,nb),nb.forEach(n),ob.forEach(n),tu=l(Qd),ea=s(Qd,"SPAN",{});var rb=a(ea);ou=o(rb,"TFRagSequenceForGeneration"),rb.forEach(n),Qd.forEach(n),pd=l(d),F=s(d,"DIV",{class:!0});var C=a(F);b(Io.$$.fragment,C),nu=l(C),Ye=s(C,"P",{});var qr=a(Ye);ru=o(qr,"The "),Jn=s(qr,"A",{href:!0});var sb=a(Jn);su=o(sb,"TFRagSequenceForGeneration"),sb.forEach(n),au=o(qr," forward method, overrides the "),ta=s(qr,"CODE",{});var ab=a(ta);du=o(ab,"__call__"),ab.forEach(n),iu=o(qr," special method."),qr.forEach(n),cu=l(C),b(Et.$$.fragment,C),lu=l(C),oa=s(C,"P",{});var db=a(oa);pu=o(db,"A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),db.forEach(n),hu=l(C),na=s(C,"P",{});var ib=a(na);mu=o(ib,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),ib.forEach(n),uu=l(C),he=s(C,"P",{});var xe=a(he);gu=o(xe,"The question encoder can be any "),ra=s(xe,"EM",{});var cb=a(ra);_u=o(cb,"autoencoding"),cb.forEach(n),fu=o(xe," model, preferably "),Xn=s(xe,"A",{href:!0});var lb=a(Xn);vu=o(lb,"TFDPRQuestionEncoder"),lb.forEach(n),bu=o(xe,`, and the generator can be
any `),sa=s(xe,"EM",{});var pb=a(sa);Tu=o(pb,"seq2seq"),pb.forEach(n),wu=o(xe," model, preferably "),Zn=s(xe,"A",{href:!0});var hb=a(Zn);ku=o(hb,"TFBartForConditionalGeneration"),hb.forEach(n),qu=o(xe,"."),xe.forEach(n),yu=l(C),L=s(C,"P",{});var Y=a(L);xu=o(Y,"The model can be initialized with a "),er=s(Y,"A",{href:!0});var mb=a(er);Ru=o(mb,"RagRetriever"),mb.forEach(n),Fu=o(Y,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
It has been tested with `),tr=s(Y,"A",{href:!0});var vb=a(tr);Pu=o(vb,"TFDPRQuestionEncoder"),vb.forEach(n),Cu=o(Y," as the "),la=s(Y,"CODE",{});var bb=a(la);Su=o(bb,"question_encoder"),bb.forEach(n),Du=o(Y," and "),or=s(Y,"A",{href:!0});var Tb=a(or);Iu=o(Tb,"TFBartForConditionalGeneration"),Tb.forEach(n),Lu=o(Y,`
as the `),pa=s(Y,"CODE",{});var wb=a(pa);Ou=o(wb,"generator"),wb.forEach(n),Wu=o(Y,"."),Y.forEach(n),Hu=l(C),Lo=s(C,"P",{});var Ud=a(Lo);Bu=o(Ud,"This model inherits from "),nr=s(Ud,"A",{href:!0});var kb=a(nr);Qu=o(kb,"TFPreTrainedModel"),kb.forEach(n),Uu=o(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
