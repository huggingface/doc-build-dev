import{S as Da,i as Oa,s as Ha,e as r,k as f,w as _,t as i,M as Ia,c as l,d as e,m as h,a as n,x as y,h as o,b as c,G as s,g as p,y as $,q as E,o as w,B as g,v as Ga}from"../chunks/vendor-hf-doc-builder.js";import{T as Ca}from"../chunks/Tip-hf-doc-builder.js";import{I as yt}from"../chunks/IconCopyLink-hf-doc-builder.js";import{C as nt}from"../chunks/CodeBlock-hf-doc-builder.js";function Fa(Ut){let u,D;return{c(){u=r("p"),D=i("The following examples use CSV files, but you can use any supported format (text, JSON, JSON Lines, CSV, Parquet).")},l(d){u=l(d,"P",{});var x=n(u);D=o(x,"The following examples use CSV files, but you can use any supported format (text, JSON, JSON Lines, CSV, Parquet)."),x.forEach(e)},m(d,x){p(d,u,x),s(u,D)},d(d){d&&e(u)}}}function Ja(Ut){let u,D,d,x,$t,Y,De,Et,Oe,zt,ot,He,Kt,O,Ie,pt,Ge,Ce,Qt,H,Xt,M,I,wt,W,Fe,gt,Je,Zt,b,Le,xt,qe,Ve,bt,Ye,We,te,A,Be,At,Ue,ze,ft,Ke,Qe,ee,B,se,P,G,jt,U,Xe,St,Ze,ae,C,ts,kt,es,ss,re,F,z,as,Mt,rs,ls,is,K,ns,Pt,os,ps,le,J,fs,Rt,hs,cs,ie,Q,ne,R,L,Nt,X,us,Tt,ds,oe,j,ms,Dt,vs,_s,Ot,ys,$s,pe,Z,fe,m,Es,Ht,ws,gs,It,xs,bs,Gt,As,js,Ct,Ss,ks,he,ht,Ms,ce,tt,ue,N,q,Ft,et,Ps,Jt,Rs,de,v,Ns,Lt,Ts,Ds,qt,Os,Hs,Vt,Is,Gs,Yt,Cs,Fs,me,st,ve,T,V,Wt,at,Js,Bt,Ls,_e,ct,qs,ye,ut,Vs,$e,rt,Ee,dt,Ys,we,lt,ge;return Y=new yt({}),H=new Ca({props:{$$slots:{default:[Fa]},$$scope:{ctx:Ut}}}),W=new yt({}),B=new nt({props:{code:`my_dataset_repository/
\u251C\u2500\u2500 README.md
\u251C\u2500\u2500 train.csv
...
A dataset with a supported structure can be loaded automatically with `),pt=r("a"),Ge=i("load_dataset()"),Ce=i(", and it will have a preview on its dataset page on the Hub."),Qt=f(),_(H.$$.fragment),Xt=f(),M=r("h2"),I=r("a"),wt=r("span"),_(W.$$.fragment),Fe=f(),gt=r("span"),Je=i("Main use-case"),Zt=f(),b=r("p"),Le=i("The simplest dataset structure has two files: "),xt=r("em"),qe=i("train.csv"),Ve=i(" and "),bt=r("em"),Ye=i("test.csv"),We=i("."),te=f(),A=r("p"),Be=i("Your repository will also contain a "),At=r("em"),Ue=i("README.md"),ze=i(" file, the "),ft=r("a"),Ke=i("dataset card"),Qe=i(" displayed on your dataset page."),ee=f(),_(B.$$.fragment),se=f(),P=r("h2"),G=r("a"),jt=r("span"),_(U.$$.fragment),Xe=f(),St=r("span"),Ze=i("Splits and file names"),ae=f(),C=r("p"),ts=i(`\u{1F917} Datasets automatically infers the train/validation/test splits of your dataset from the file names.
...
It doesn\u2019t matter if you add a prefix or suffix to `),Gt=r("strong"),As=i("train"),js=i(" in the file name (like "),Ct=r("em"),Ss=i("my_train_file_00001.csv"),ks=i(`, for example).
...
It doesn\u2019t matter if you add a prefix or suffix to `),Gt=l(S,"STRONG",{});var ya=n(Gt);As=o(ya,"train"),ya.forEach(e),js=o(S," in the file name (like "),Ct=l(S,"EM",{});var $a=n(Ct);Ss=o($a,"my_train_file_00001.csv"),$a.forEach(e),ks=o(S,`, for example).
