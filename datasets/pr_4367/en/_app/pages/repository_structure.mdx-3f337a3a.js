import{S as La,i as qa,s as Va,e as r,k as f,w as _,t as l,M as Ya,c as i,d as e,m as h,a as o,x as y,h as n,b as c,F as s,g as p,y as $,q as E,o as w,B as g,v as Wa}from"../chunks/vendor-8138ceec.js";import{T as Ba}from"../chunks/Tip-12722dfc.js";import{I as Et}from"../chunks/IconCopyLink-2dd3a6ac.js";import{C as ot}from"../chunks/CodeBlock-fc89709f.js";function Ua(Kt){let u,D;return{c(){u=r("p"),D=l("The following examples use CSV files, but you can use any supported format (text, JSON, JSON Lines, CSV, Parquet).")},l(d){u=i(d,"P",{});var x=o(u);D=n(x,"The following examples use CSV files, but you can use any supported format (text, JSON, JSON Lines, CSV, Parquet)."),x.forEach(e)},m(d,x){p(d,u,x),s(u,D)},d(d){d&&e(u)}}}function za(Kt){let u,D,d,x,wt,W,Ce,gt,Ge,Qt,pt,Fe,Xt,O,Je,ft,Le,qe,Zt,H,Ve,ht,Ye,We,te,I,ee,P,C,xt,B,Be,bt,Ue,se,b,ze,At,Ke,Qe,jt,Xe,Ze,ae,A,ts,St,es,ss,ct,as,rs,re,U,le,M,G,kt,z,ls,Pt,is,ie,F,ns,Mt,os,ps,ne,J,K,fs,Nt,hs,cs,us,Q,ds,Rt,ms,vs,oe,L,_s,Tt,ys,$s,pe,X,fe,N,q,Dt,Z,Es,Ot,ws,he,j,gs,Ht,xs,bs,It,As,js,ce,tt,ue,m,Ss,Ct,ks,Ps,Gt,Ms,Ns,Ft,Rs,Ts,Jt,Ds,Os,de,ut,Hs,me,et,ve,R,V,Lt,st,Is,qt,Cs,_e,v,Gs,Vt,Fs,Js,Yt,Ls,qs,Wt,Vs,Ys,Bt,Ws,Bs,ye,at,$e,T,Y,Ut,rt,Us,zt,zs,Ee,dt,Ks,we,mt,Qs,ge,lt,xe,vt,Xs,be,it,Ae;return W=new Et({}),I=new Ba({props:{$$slots:{default:[Ua]},$$scope:{ctx:Kt}}}),B=new Et({}),U=new ot({props:{code:`my_dataset_repository/
\u251C\u2500\u2500 README.md
\u251C\u2500\u2500 train.csv
...
\u2514\u2500\u2500 fr/
    ...
    \u2514\u2500\u2500 test/
        \u251C\u2500\u2500 shard_0<span class="hljs-selector-class">.csv</span>
        \u2514\u2500\u2500 shard_1.csv`}}),{c(){u=r("meta"),D=f(),d=r("h1"),x=r("a"),wt=r("span"),_(W.$$.fragment),Ce=f(),gt=r("span"),Ge=l("Structure your repository"),Qt=f(),pt=r("p"),Fe=l("To host and share your dataset, you can create a dataset repository on the Hugging Face Dataset Hub and upload your data files."),Xt=f(),O=r("p"),Je=l(`This guide will show you how to structure your dataset repository when you upload it.
A dataset with a supported structure can be loaded automatically with `),ft=r("a"),Le=l("load_dataset()"),qe=l(", and it will have a preview on its dataset page on the Hub."),Zt=f(),H=r("p"),Ve=l("Note that you can also include a "),ht=r("a"),Ye=l("python script"),We=l(" to define your dataset, for more flexibility."),te=f(),_(I.$$.fragment),ee=f(),P=r("h2"),C=r("a"),xt=r("span"),_(B.$$.fragment),Be=f(),bt=r("span"),Ue=l("Main use-case"),se=f(),b=r("p"),ze=l("The simplest dataset structure has two files: "),At=r("em"),Ke=l("train.csv"),Qe=l(" and "),jt=r("em"),Xe=l("test.csv"),Ze=l("."),ae=f(),A=r("p"),ts=l("Your repository will also contain a "),St=r("em"),es=l("README.md"),ss=l(" file, the "),ct=r("a"),as=l("dataset card"),rs=l(" displayed on your dataset page."),re=f(),_(U.$$.fragment),le=f(),M=r("h2"),G=r("a"),kt=r("span"),_(z.$$.fragment),ls=f(),Pt=r("span"),is=l("Splits and file names"),ie=f(),F=r("p"),ns=l(`\u{1F917} Datasets automatically infers the train/validation/test splits of your dataset from the file names.
...
For example, if your `),Ht=r("strong"),xs=l("train"),bs=l(" and "),It=r("strong"),As=l("test"),js=l(" splits span several files:"),ce=f(),_(tt.$$.fragment),ue=f(),m=r("p"),Ss=l("Just make sure that all the files of your "),Ct=r("strong"),ks=l("train"),Ps=l(" set have "),Gt=r("strong"),Ms=l("train"),Ns=l(` in their names (same for test and validation).
...
For example, if your `),Ht=i($t,"STRONG",{});var ga=o(Ht);xs=n(ga,"train"),ga.forEach(e),bs=n($t," and "),It=i($t,"STRONG",{});var xa=o(It);As=n(xa,"test"),xa.forEach(e),js=n($t," splits span several files:"),$t.forEach(e),ce=h(t),y(tt.$$.fragment,t),ue=h(t),m=i(t,"P",{});var S=o(m);Ss=n(S,"Just make sure that all the files of your "),Ct=i(S,"STRONG",{});var ba=o(Ct);ks=n(ba,"train"),ba.forEach(e),Ps=n(S," set have "),Gt=i(S,"STRONG",{});var Aa=o(Gt);Ms=n(Aa,"train"),Aa.forEach(e),Ns=n(S,` in their names (same for test and validation).
